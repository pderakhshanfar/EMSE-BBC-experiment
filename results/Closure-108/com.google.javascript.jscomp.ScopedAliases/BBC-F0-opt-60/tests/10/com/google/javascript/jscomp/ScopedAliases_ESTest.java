...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "*`AFref");
      ...
      Node node1 = compiler0.parseTestCode("f@W>R5!l}'R");
  ...
  public void test2()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("Exceeded max number of code motion iterations: {0}", "Exceeded max number of code motion iterations: {0}");
  ...
  public void test3()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((-1.0), Integer.MAX_VALUE, Integer.MAX_VALUE);
      // Undeclared exception!
      try { 
  ...
  public void test4()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "q;&L9LW=p9m|fr");
      Node node1 = new Node(37, node0, 1159, 4095);
