...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString("// Input %num%", 74, 74);
  ...
  public void test1()  throws Throwable  {
      ...
      Node node0 = Node.newString("", 3404, (-950));
      // Undeclared exception!
      try { 
  ...
  public void test3()  throws Throwable  {
      ...
      Node node1 = new Node(0, node0, node0, node0, 6105, 8);
      Compiler compiler0 = new Compiler();
  ...
  public void test5()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString((-2807), "%4C(5uo En:dJ|;", 781, (-28));
      Node node1 = new Node(37, node0, node0, node0, node0, 46, (-2807));
  ...
  public void test6()  throws Throwable  {
      ...
      ScopedAliases scopedAliases0 = new ScopedAliases(compiler0, (PreprocessorSymbolTable) null, (CompilerOptions.AliasTransformationHandler) null);
      scopedAliases0.process(node0, node0);
      assertEquals((-2807), node0.getType());
  }
