...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString("", 1262, 1262);
  ...
  public void test4()  throws Throwable  {
      Logger logger0 = Logger.getLogger("$jscomp");
      LoggerErrorManager loggerErrorManager0 = new LoggerErrorManager(logger0);
      Compiler compiler0 = new Compiler(loggerErrorManager0);
      Node node0 = new Node(0, 0, 0);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
  ...
  public void test5()  throws Throwable  {
      MockFile mockFile0 = new MockFile("JSC_GOOG_SCOPE_HAS_BAD_PARAMETERS", "?M<:B,^|7t6{^vpOtx5");
