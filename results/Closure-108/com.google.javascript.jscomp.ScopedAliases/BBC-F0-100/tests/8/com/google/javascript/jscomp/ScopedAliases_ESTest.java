...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test3()  throws Throwable  {
      Node node0 = Node.newNumber(0.0, 1237, Integer.MAX_VALUE);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
  ...
  public void test4()  throws Throwable  {
      CompilerOptions.AliasTransformationHandler compilerOptions_AliasTransformationHandler0 = CompilerOptions.NULL_ALIAS_TRANSFORMATION_HANDLER;
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseSyntheticCode("function JSCompiler_returnArg(JSCUmpiler_returnArg_valua) {  return function() {return JSCompiler_returnArg_value}}", "function JSCompiler_returnArg(JSCUmpiler_returnArg_valua) {  return function() {return JSCompiler_returnArg_value}}");
      Node node1 = new Node(0, node0, node0, node0, node0, (-726), (-620));
