...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString(100, "+j]uJe~7:^SdtTVR:", 100, (-8));
      Node node1 = new Node(37, node0, node0, node0, node0, 56, 1);
  ...
  public void test5()  throws Throwable  {
      MockFile mockFile0 = new MockFile("The body of a goog.scope function cannot reference 'this'.", "The body of a goog.scope function cannot reference 'this'.");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      Compiler compiler0 = new Compiler(mockPrintStream0);
      CompilerOptions.AliasTransformationHandler compilerOptions_AliasTransformationHandler0 = CompilerOptions.NULL_ALIAS_TRANSFORMATION_HANDLER;
      ScopedAliases scopedAliases0 = new ScopedAliases(compiler0, (PreprocessorSymbolTable) null, compilerOptions_AliasTransformationHandler0);
      Node node0 = Node.newString(105, "Y,9mYJ", 0, (-763));
      Node node1 = new Node((-598), node0, node0, node0, node0, Integer.MIN_VALUE, 29);
  ...
  public void test7()  throws Throwable  {
      ...
      CompilerOptions.AliasTransformationHandler compilerOptions_AliasTransformationHandler0 = CompilerOptions.NULL_ALIAS_TRANSFORMATION_HANDLER;
      ScopedAliases scopedAliases0 = new ScopedAliases(compiler0, (PreprocessorSymbolTable) null, compilerOptions_AliasTransformationHandler0);
      Node node0 = Node.newString("+j]uJe~7:^SdtTVR:");
      Node node1 = new Node(37, node0, node0, node0, node0, 56, 1);
