...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString(0, "The aliases {0} has a cycle.");
      nodeArray0[0] = node0;
      Node node1 = new Node(19, nodeArray0, 4815, (-2754));
  ...
  public void test3()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(0, "goog.scope", 0, 515);
