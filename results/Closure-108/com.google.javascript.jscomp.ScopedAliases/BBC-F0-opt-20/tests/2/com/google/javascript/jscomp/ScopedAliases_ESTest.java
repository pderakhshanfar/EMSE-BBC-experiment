...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString(Integer.MAX_VALUE, "com.google.javascript.jscomp.ScopedAliases$Traversal$1");
      Node node1 = new Node((-1933024532), node0, node0, node0, node0);
  ...
  public void test1()  throws Throwable  {
      Logger logger0 = Logger.getLogger("The body of a goog.scope function cannot use 'throw'.");
      LoggerErrorManager loggerErrorManager0 = new LoggerErrorManager(logger0);
      Compiler compiler0 = new Compiler(loggerErrorManager0);
      Node node0 = compiler0.parseSyntheticCode("The body of a goog.scope function cannot use 'throw'.", "com.google.javascript.jscomp.ScopedAliases$Traversal");
  ...
  public void test5()  throws Throwable  {
      ...
      nodeArray0[0] = node0;
      Node node1 = new Node(2, nodeArray0, 3109, (-1448288751));
  ...
  public void test7()  throws Throwable  {
      ...
      LoggerErrorManager loggerErrorManager0 = new LoggerErrorManager(logger0);
      Compiler compiler0 = new Compiler(loggerErrorManager0);
      Node node0 = compiler0.parseSyntheticCode("Y(Q)", "Y(Q)");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      CompilerOptions compilerOptions0 = new CompilerOptions();
      CompilerOptions.AliasTransformationHandler compilerOptions_AliasTransformationHandler0 = compilerOptions0.getAliasTransformationHandler();
      ScopedAliases scopedAliases0 = new ScopedAliases(compiler0, preprocessorSymbolTable0, compilerOptions_AliasTransformationHandler0);
