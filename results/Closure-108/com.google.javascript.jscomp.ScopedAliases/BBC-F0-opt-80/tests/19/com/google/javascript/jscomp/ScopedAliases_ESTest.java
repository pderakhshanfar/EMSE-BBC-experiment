...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test5()  throws Throwable  {
      ...
      Node node0 = compiler0.parseTestCode("goog.scope");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      Node node1 = new Node(105, node0, node0, node0, (-667), 55);
      ScopedAliases scopedAliases0 = new ScopedAliases(compiler0, preprocessorSymbolTable0, (CompilerOptions.AliasTransformationHandler) null);
  ...
  public void test6()  throws Throwable  {
      ...
      Node node0 = compiler0.parseTestCode("goog.scope");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      Node node1 = new Node(105, node0, node0, node0, 8, 55);
      ScopedAliases scopedAliases0 = new ScopedAliases(compiler0, preprocessorSymbolTable0, (CompilerOptions.AliasTransformationHandler) null);
  ...
  public void test7()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(1675.218314888, 500, 440);
      Node node1 = new Node(37, node0, node0, node0, 51, 14);
