...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = quotedPrintableCodec0.decode((Object) " {ZYLvsEfc-s=7F4E~@ek");
      assertEquals(" {ZYLvsEfc-s4E~@ek", object0);
  ...
  public void test03()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("[Q/(r!HPp td\"y");
      String string0 = quotedPrintableCodec0.getDefaultCharset();
      assertEquals("[Q/(r!HPp td\"y", string0);
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("p_fdv");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Ny'1cCCWD~G?^N");
      try { 
        quotedPrintableCodec0.decode("?O)", "Ny'1cCCWD~G?^N");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("O;.~k:tnrX65GUjR8");
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("U4nU|~U6%j");
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "TF-16");
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("}^{1R%G6&");
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("}^{1R%G6&", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.encode((String) null, "E");
      assertNull(string0);
  }
  ...
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode((String) null, "~a^6");
      assertNull(string0);
  }
  ...
  public void test44()  throws Throwable  {
      BitSet bitSet0 = new BitSet(3194);
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("~a^6");
      assertEquals("~a^6", string0);
      assertNotNull(string0);
  }

  @Test(timeout = 4000)
  public void test46()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("=u^,ON5OyXn2");
      try { 
        quotedPrintableCodec0.decode("=u^,ON5OyXn2", "=u^,ON5OyXn2");
        fail("Expecting exception: Exception");
