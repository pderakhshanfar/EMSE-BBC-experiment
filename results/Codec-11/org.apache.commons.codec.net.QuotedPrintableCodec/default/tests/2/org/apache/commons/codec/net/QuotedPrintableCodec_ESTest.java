...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("`G&K}Ws__s`yjnNp0t");
      try { 
        quotedPrintableCodec0.decode("N=688hA+qZ?vC");
        fail("Expecting exception: Exception");
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("?Ec~@hR%j_yL(UK");
      assertNotNull(string0);
      assertEquals("?Ec~@hR%j_yL(UK", string0);
  }
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("`g&bmS?");
      assertNotNull(string0);
      assertEquals("`g&bmS?", string0);
  }
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "YBHq: ![n {Iay'P");
      assertEquals("YBHq: ![n {Iay'P", object0);
  ...
  public void test19()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("/Ie9");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Xp_ZXI([fp*");
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("Xp_ZXI([fp*", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("ld ");
      try { 
        quotedPrintableCodec0.encode("ld ");
        fail("Expecting exception: Exception");
  ...
  public void test26()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)82, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "IB5>lECJc");
        fail("Expecting exception: NullPointerException");
  ...
  public void test42()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("y=O4^3Q", "y=O4^3Q");
        fail("Expecting exception: Exception");
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Xp_ZXI([fp*");
      try { 
        quotedPrintableCodec0.decode("Xp_ZXI([fp*", "Xp_ZXI([fp*");
        fail("Expecting exception: UnsupportedEncodingException");
