...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode("e=F8\"LWa=y*J909'#", "");
  ...
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("+ECuYhz|b");
      assertEquals("+ECuYhz|b", string0);
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("+ECuYhz|b");
      assertNotNull(string0);
      assertEquals("+ECuYhz|b", string0);
  }
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("`VWp:/Qb:M@x.~xRN)z", "`VWp:/Qb:M@x.~xRN)z");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("}Jpn/L]=:UUXV_(6");
      try { 
        quotedPrintableCodec0.decode("}Jpn/L]=:UUXV_(6");
        fail("Expecting exception: Exception");
  ...
  public void test27()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("z1XQ?");
      try { 
        quotedPrintableCodec0.encode("z1XQ?");
        fail("Expecting exception: Exception");
  ...
  public void test30()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)53, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable((BitSet) null, byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)56, (byte)48}, byteArray1);
  }
