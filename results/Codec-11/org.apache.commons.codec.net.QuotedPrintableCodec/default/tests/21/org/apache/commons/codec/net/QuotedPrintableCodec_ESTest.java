...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(":TB,/_");
      byte[] byteArray0 = new byte[2];
      byteArray0[0] = (byte) (-27);
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      byte[] byteArray2 = quotedPrintableCodec0.decode(byteArray1);
      assertArrayEquals(new byte[] {(byte)61, (byte)69, (byte)53, (byte)61, (byte)48, (byte)48}, byteArray1);
      assertArrayEquals(new byte[] {(byte) (-27), (byte)0}, byteArray2);
  }
  ...
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("}DVQa$B]8");
      assertEquals("=7F}DV=7FQa$B]8", string0);
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("%wCd,2KF5T+HYH");
      assertNotNull(string0);
      assertEquals("%wCd,2KF5T+HYH", string0);
  }
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "Q$~JGsY#gj_T;F+nw;");
      assertNotNull(object0);
      assertEquals("Q$~JGsY#gj_T;F+nw;", object0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "^jSOH]:d");
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("zV==P{[", "zV==P{[");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("^jSOH]:d");
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "%Pn");
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("Gpo|zj&z/5FT", "Gpo|zj&z/5FT");
  ...
  public void test27()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("^jSOH]:d");
      try { 
        quotedPrintableCodec0.encode("^jSOH]:d");
        fail("Expecting exception: Exception");
  ...
  public void test44()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("Jg ho,$0=FupXYZ!ff");
        fail("Expecting exception: Exception");
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("qSOH]:d");
      try { 
        quotedPrintableCodec0.decode((Object) "qSOH]:d");
        fail("Expecting exception: Exception");
