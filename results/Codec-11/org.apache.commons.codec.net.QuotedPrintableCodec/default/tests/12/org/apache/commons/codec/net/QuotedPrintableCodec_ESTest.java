...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte) (-89), (byte)0, (byte)0, (byte)0}, byteArray2);
  ...
  public void test03()  throws Throwable  {
      ByteBuffer byteBuffer0 = ByteBuffer.allocate(2397);
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "O+T2-<qCem;r~CF");
      assertNotNull(object0);
      assertEquals("O+T2-<qCem;r~CF", object0);
  }
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode(">3,wP!.A8", "UTF-8");
      assertEquals(">3,wP!.A8", string0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("C_#Ry@0;");
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("bItC*^v;VmosO", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("kr!Y@oCgyx");
      try { 
        quotedPrintableCodec0.decode("kr!Y@oCgyx");
        fail("Expecting exception: Exception");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("kr!@oCgyx");
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode(",Sjh{/cG6O");
      assertNotNull(string0);
      assertEquals(",Sjh{/cG6O", string0);
  }
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "[^@ZuX.m>%YIE$xA.*");
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("$RTFr~=<z|!oG", "$RTFr~=<z|!oG");
        fail("Expecting exception: Exception");
  ...
  public void test44()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "C_#Ry@0;");
        fail("Expecting exception: NullPointerException");
