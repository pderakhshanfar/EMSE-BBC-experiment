...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode((Object) "i{=");
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("WuNCq*,J\"{Q{R`|xam");
      assertEquals("WuNCq*,J\"{Q{R`|xam", string0);
      assertNotNull(string0);
  }
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "6}8x&");
      assertEquals("6}8x&", object0);
      assertNotNull(object0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("o]Kj?N.", (String) null);
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("*i_uhA");
      try { 
        quotedPrintableCodec0.encode("*i_uhA");
        fail("Expecting exception: Exception");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("TZ<bht");
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("`Px;.xk~{=;h7!E");
      try { 
        quotedPrintableCodec0.decode("`Px;.xk~{=;h7!E", "`Px;.xk~{=;h7!E");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode(",L#%\"oji\"<ni");
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "`@ZZ,>^v");
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(21, byteArray1.length);
      assertArrayEquals(new byte[] {(byte) (-46), (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
      assertEquals(7, byteArray2.length);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      BitSet bitSet0 = new BitSet(215);
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "u)6<dt88|x");
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("9V@SLB|T4I=`svtk");
      assertEquals("9V@SLB|T4I=3D`svtk", string0);
      assertNotNull(string0);
  }
  ...
  public void test46()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("F'");
      try { 
        quotedPrintableCodec0.decode("F'");
        fail("Expecting exception: Exception");
