...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("GQSV;=c!8R8Cb9zM%");
      assertNotNull(string0);
      assertEquals("GQSV;=3Dc!8R8Cb9zM%", string0);
  }
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("YL$kQZ_ldjxB37.0");
      byte[] byteArray1 = quotedPrintableCodec0.decode(byteArray0);
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("0%{");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("Ri!=KQjYz\"lZ\"[Z", "Ri!=KQjYz\"lZ\"[Z");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("|TSluHn#;", "|TSluHn#;");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("'/WNd");
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("}>7Ze)=");
        fail("Expecting exception: Exception");
  ...
  public void test28()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("UTF-16B");
      try { 
        quotedPrintableCodec0.encode("UTF-16B");
        fail("Expecting exception: Exception");
  ...
  public void test30()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)16, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)49, (byte)61, (byte)48, (byte)48}, byteArray1);
      assertEquals(10, byteArray1.length);
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      LongBuffer longBuffer0 = LongBuffer.allocate(2853);
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "xh0GwG#EZ$R?6Y+[~g(");
        fail("Expecting exception: NullPointerException");
