...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte) (-49), (byte)0, (byte)0}, byteArray2);
  ...
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("DnOfa={#*");
      assertEquals("DnOfa=3D{#*", string0);
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) " $MM/KPmRqk");
      assertNotNull(object0);
      assertEquals(" $MM/KPmRqk", object0);
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("6T9");
      byte[] byteArray0 = new byte[0];
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("J]iL('?BPAy5mW->P");
      assertNotNull(string0);
      assertEquals("J]iL('?BPAy5mW->P", string0);
  }
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "[KJ");
  ...
  public void test18()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("wHGd(;0[A1{'>|`dMQ", (String) null);
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("Invalid URL encoding: not a valid digit (radix 16): ", "Invalid URL encoding: not a valid digit (radix 16): ");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("z_k");
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("{dp>vLG`vBPI3{mR'/d", "{dp>vLG`vBPI3{mR'/d");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("US-|SC=I");
      try { 
        quotedPrintableCodec0.decode("US-|SC=I", "US-|SC=I");
        fail("Expecting exception: Exception");
  ...
  public void test42()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("z_k");
      try { 
        quotedPrintableCodec0.encode("z_k");
        fail("Expecting exception: Exception");
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "I<P3H^`6");
        fail("Expecting exception: NullPointerException");
