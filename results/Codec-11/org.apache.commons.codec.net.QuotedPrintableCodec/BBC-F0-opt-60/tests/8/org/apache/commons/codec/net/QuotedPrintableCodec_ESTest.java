...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte) (-24), (byte)0, (byte)0}, byteArray2);
  }
  ...
  public void test06()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("GMjZr'\"xZ@<.azNL2L", "UTF-8");
      assertEquals("GMjZr'\"xZ@<.azNL2L", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("&gA}yqSg]a(Q-D");
      assertNotNull(string0);
      assertEquals("&gA}yqSg]a(Q-D", string0);
  }
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("uP`y_Uw");
      byte[] byteArray0 = new byte[0];
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode(":<extR%8di]iQ", "UTF-8");
      assertEquals(":<extR%8di]iQ", string0);
  }
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("GMjZr'\"xZ@<.azNL2L");
      assertNotNull(string0);
      assertEquals("GMjZr'\"xZ@<.azNL2L", string0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("8m[", (String) null);
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("&gA}yqSg]a(Q-D");
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "95>n|z^5x}H");
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("/K~#ftY=", "r5w>no\"");
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("?0UDHk7ip8W\"1eLU:", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("B9@zHx");
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)70, (byte)49, (byte)0, (byte)0, (byte)0}, byteArray1);
  }
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "GMjZr'\"xZ@<.azNL2L");
      assertNotNull(object0);
      assertEquals("GMjZr'\"xZ@<.azNL2L", object0);
  }
