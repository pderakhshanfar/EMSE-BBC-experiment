...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)49, (byte)52, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48}, byteArray1);
      assertArrayEquals(new byte[] {(byte)20, (byte)0, (byte)0}, byteArray2);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("=8k6]P\"kT,");
      String string0 = quotedPrintableCodec0.getDefaultCharset();
      assertEquals("=8k6]P\"kT,", string0);
  }
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("v+foT");
      try { 
        quotedPrintableCodec0.encode("v+foT");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.decode("*U@_2M>|dqEM0Ti<|}", "*U@_2M>|dqEM0Ti<|}");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("w?w=");
        fail("Expecting exception: Exception");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      try { 
        quotedPrintableCodec0.encode("f~r!B8h", "Objects of type ");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("^1D-Xga)va.-?S:y1)");
      assertNotNull(string0);
      assertEquals("^1D-Xga)va.-?S:y1)", string0);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)88, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("=8k6]P\"kT,");
      try { 
        quotedPrintableCodec0.decode("&| ,m=w`Z#*T?", "=8k6]P\"kT,");
        fail("Expecting exception: Exception");
