...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ByteBuffer byteBuffer0 = ByteBuffer.allocate(148);
      ...
      assertArrayEquals(new byte[] {(byte)65, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  ...
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("*#y'?m@ztx4s=$n");
      assertEquals("*#y'?m@ztx4s=3D$n", string0);
  ...
  public void test14()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("rkqbmMR", (String) null);
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.decode("org.apache.commons.codec.DecoderException", "tG||D&%s,");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("*#y'?m@ztx4s=$n");
        fail("Expecting exception: Exception");
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("SY");
  ...
  public void test47()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("jUW{|m87) KC`<t(");
      try { 
        quotedPrintableCodec0.decode("$V?@PTaN4gw<}JD=", "jUW{|m87) KC`<t(");
        fail("Expecting exception: Exception");
