...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("a>of+HTA&Kp45H_#>");
      byte[] byteArray0 = new byte[3];
      byteArray0[2] = (byte) (-123);
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      byte[] byteArray2 = quotedPrintableCodec0.decode(byteArray1);
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte) (-123)}, byteArray2);
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("T|}QT(8}UOV;");
      assertNotNull(string0);
      assertEquals("T|}QT(8}UOV;", string0);
  }
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(";k$eNk4;8mU");
      try { 
        quotedPrintableCodec0.encode("r", ";k$eNk4;8mU");
  ...
  public void test18()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("O8=3g,$2v%%&[n!-F", "O8=3g,$2v%%&[n!-F");
        fail("Expecting exception: Exception");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("", "EyNl(D(s[");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("qevsASi/59oUekx5a");
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("a>of+HTA&Kp45H_#>");
      String string0 = quotedPrintableCodec0.encode("\"Y&9w'/I", "UTF-8");
      assertEquals("\"Y&9w'/I", string0);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("UczE");
      try { 
        quotedPrintableCodec0.decode("UczE");
        fail("Expecting exception: Exception");
  ...
  public void test26()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)70, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray1);
  ...
  public void test30()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("NjJ0EUh");
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = quotedPrintableCodec0.decode(byteArray0);
      assertNotSame(byteArray0, byteArray1);
  }
  ...
  public void test37()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "T|}QT(8}UOV;");
      assertNotNull(object0);
      assertEquals("T|}QT(8}UOV;", object0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode((String) null, "T|}QT(8}UOV;");
      assertNull(string0);
  }
  ...
  public void test43()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "T|}QT(8}UOV;");
      assertEquals("T|}QT(8}UOV;", object0);
      assertNotNull(object0);
  }
