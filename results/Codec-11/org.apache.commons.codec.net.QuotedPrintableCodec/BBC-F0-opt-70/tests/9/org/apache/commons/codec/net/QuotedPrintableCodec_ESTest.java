...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)61}, byteArray2);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)51, (byte)68}, byteArray1);
  }
  ...
  public void test02()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("xq5VmWg;");
      try { 
  ...
  public void test06()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("_0]`ev", "UTF-8");
      assertEquals("_0]`ev", string0);
  }
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) ",sX0");
      assertEquals(",sX0", object0);
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("i{v^YTl]`}OE", "UTF-16LE");
      assertEquals("\u7B69\u5E76\u5459\u5D6C\u7D60\u454F", string0);
  }
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode(">il");
      assertNotNull(string0);
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("[\rHd`49>IF^BW#SE", (String) null);
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("org.apache.commons.codec.DecoderException", " cannot be quoted-printable encoded");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("n!ohkr=aJkYp:]-T");
      try { 
        quotedPrintableCodec0.decode("n!ohkr=aJkYp:]-T");
        fail("Expecting exception: Exception");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("Objects of type ", "yE?@jH!~x");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("o?Pn,8Hi//y");
      assertEquals("o?Pn,8Hi//y", string0);
      assertNotNull(string0);
  }
  ...
  public void test30()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "E[VNVqy}");
      assertNotNull(object0);
      assertEquals("E[VNVqy}", object0);
  }
  ...
  public void test36()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.decode((String) null, "0mN{");
      assertNull(string0);
  }
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) " g9r+WZ:l()i#\"f1A");
        fail("Expecting exception: NullPointerException");
  ...
  public void test43()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode(" ==RglZ U}zX;", " ==RglZ U}zX;");
        fail("Expecting exception: Exception");
