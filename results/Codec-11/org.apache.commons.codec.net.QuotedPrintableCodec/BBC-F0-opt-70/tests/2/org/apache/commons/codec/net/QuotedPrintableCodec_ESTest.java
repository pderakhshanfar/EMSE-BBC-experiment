...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)0, (byte)16, (byte)0}, byteArray2);
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("$|7FjV)");
      assertNotNull(string0);
      assertEquals("$|7FjV)", string0);
  }
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("_.O:e)i~");
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = quotedPrintableCodec0.decode(byteArray0);
      assertNotSame(byteArray1, byteArray0);
  }
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("gCHzsL`^JSP");
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("$|7FjV)");
      assertNotNull(string0);
      assertEquals("$|7FjV)", string0);
  }
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("gCHzsL`^JSP");
      try { 
        quotedPrintableCodec0.encode("gCHzsL`^JSP", "");
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("a(I)/SPX~GhN$<h:Qh");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("_.O:e)i~");
      try { 
        quotedPrintableCodec0.decode("_.O:e)i~", "_.O:e)i~");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("k@hc%z$#dZvH");
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "b$%");
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      String string0 = quotedPrintableCodec0.encode((String) null, "j$+RAkG");
      assertNull(string0);
  }
  ...
  public void test33()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("UTF-8");
      try { 
        quotedPrintableCodec0.decode((Object) (byte)14);
        fail("Expecting exception: Exception");
  ...
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.decode((String) null, "Lc[5z@plIsAq#X\"\")");
      assertNull(string0);
  }
  ...
  public void test40()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("#d[o,p9Qt1{b{t}b=", "#d[o,p9Qt1{b{t}b=");
        fail("Expecting exception: Exception");
