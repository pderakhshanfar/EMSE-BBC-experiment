...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("ps#,4O1qSr!=i ;b]?'");
      String string0 = quotedPrintableCodec0.getDefaultCharset();
      assertEquals("ps#,4O1qSr!=i ;b]?'", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      BitSet bitSet0 = new BitSet(1862);
  ...
  public void test04()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.encode("ee6\"b?0Gjt'", "UTF-8");
      assertEquals("ee6\"b?0Gjt'", string0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("EyRWQfryB;9b)");
      assertEquals("EyRWQfryB;9b)", string0);
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("R3", "UTF-16");
      assertEquals("\u5233", string0);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode(",:h<:[,aW0");
      assertNotNull(string0);
      assertEquals(",:h<:[,aW0", string0);
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "k18Grb");
      assertEquals("k18Grb", object0);
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("\"SLzo|I5/");
      try { 
        quotedPrintableCodec0.encode("xVdf'EW", ",d#`PK");
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("'P D5BIsY5?UK");
      try { 
        quotedPrintableCodec0.encode("'P D5BIsY5?UK");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "aktK>NmuetK|GI");
        fail("Expecting exception: NullPointerException");
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("W&F`.WYw:=9RDV2z");
  ...
  public void test18()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("W&F`.WYw:=9RDV2z", ".\"_Pgq");
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("GyUXF)+>2");
      try { 
        quotedPrintableCodec0.decode("GyUXF)+>2");
        fail("Expecting exception: Exception");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("(E7?E_pcR6{Vtu6");
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)69, (byte)65}, byteArray1);
      assertArrayEquals(new byte[] {(byte) (-22)}, byteArray2);
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      BitSet bitSet0 = new BitSet(1258);
  ...
  public void test33()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode((String) null, "VTs5gIsrw(e{LmH");
      assertNull(string0);
  }
