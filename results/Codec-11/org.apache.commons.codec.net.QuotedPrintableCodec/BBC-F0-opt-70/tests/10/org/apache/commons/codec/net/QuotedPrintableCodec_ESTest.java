...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.encode("K;CsA8", "UTF-16BE");
      assertEquals("=00K=00;=00C=00s=00A=008", string0);
  }
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("[3CCF%iCb.[D=Z.Fp|-");
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = quotedPrintableCodec0.decode(byteArray0);
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(".`#]0&h^M");
      try { 
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("?$PD()k=X1FJPu$mTaU");
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("JCj{'<@ryC>J\"@c%");
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "=FE=FF=00U=00T=00F=00-=001=006");
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("%?<nT?T`Qd?hNmBW=3");
      try { 
        quotedPrintableCodec0.decode("%?<nT?T`Qd?hNmBW=3", (String) null);
        fail("Expecting exception: Exception");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("/sa2%s c.Tg[", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("", "bIe8`Z;!}o:\"!RaU");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Do)|A61ormhF");
      try { 
        quotedPrintableCodec0.decode("Do)|A61ormhF");
        fail("Expecting exception: Exception");
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.decode("K;CsA8", "UTF-16LE");
      assertEquals("\u3B4B\u7343\u3841", string0);
  }
  ...
  public void test34()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("WZjL");
  ...
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "Y&nbqB*ml");
      assertNotNull(object0);
      assertEquals("Y&nbqB*ml", object0);
  }
  ...
  public void test40()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("UTF-16LE");
      String string0 = quotedPrintableCodec0.decode((String) null, "eXK$`HcOwCX4^t");
      assertNull(string0);
  }
  ...
  public void test44()  throws Throwable  {
      ...
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      byte[] byteArray2 = QuotedPrintableCodec.decodeQuotedPrintable(byteArray1);
      assertArrayEquals(new byte[] {(byte) (-95), (byte)0, (byte)0, (byte)0}, byteArray2);
      assertEquals(4, byteArray2.length);
  }
