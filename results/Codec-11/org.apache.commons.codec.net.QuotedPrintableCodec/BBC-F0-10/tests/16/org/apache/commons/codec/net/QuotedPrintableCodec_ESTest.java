...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("TOshpS=");
      try { 
        quotedPrintableCodec0.decode("TOshpS=", "TOshpS=");
  ...
  public void test04()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("w{e<s6 e)kf{nZ}D)xC");
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("5-T");
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("=KfECJ&u'Xs6?1G.h");
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = quotedPrintableCodec0.decode(byteArray0);
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("f%x");
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "=3D3qDQq'");
      assertNotNull(object0);
      assertEquals("=3qDQq'", object0);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("ocHf~3;?-irNF");
      try { 
        quotedPrintableCodec0.encode("JWf29:ES", "JWf29:ES");
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("k&oA2hsujk!w");
      try { 
        quotedPrintableCodec0.encode("k&oA2hsujk!w");
        fail("Expecting exception: Exception");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "c5Jr%#2omp9a)");
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("", "tMHBicqaVK\"");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("JI");
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("=3qDQq'");
        fail("Expecting exception: Exception");
  ...
  public void test32()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Oph`OqFtrK@AO.");
  ...
  public void test37()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode((String) null, "RF#r");
      assertNull(string0);
  }
  ...
  public void test41()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)91}, byteArray1);
  }
  ...
  public void test42()  throws Throwable  {
      ...
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)65, (byte)50, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
