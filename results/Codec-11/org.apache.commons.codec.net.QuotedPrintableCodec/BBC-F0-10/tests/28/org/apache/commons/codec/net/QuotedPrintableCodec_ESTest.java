...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)65, (byte)55}, byteArray1);
  }
  ...
  public void test02()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Cen71Pq#h=V");
      try { 
        quotedPrintableCodec0.decode((Object) "m");
  ...
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("[:_3Ix0/Z#qh2ht");
      byte[] byteArray0 = new byte[0];
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("8`.D;g)_1C@bW*@6L");
      assertNotNull(string0);
  }
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "ekq+Lo?0d\"Y*8");
      assertEquals("ekq+Lo?0d\"Y*8", object0);
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("JzEQHV($R#sBl:EV");
      try { 
        quotedPrintableCodec0.encode("5>*9dH0kD3");
        fail("Expecting exception: Exception");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode(":%zL@");
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "r\"n;an<?T\"vqVqbvp5$");
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("r;Arb4r<");
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("kTzV}Ah8q", "kTzV}Ah8q");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("IM=):LtKH");
      try { 
        quotedPrintableCodec0.decode("IM=):LtKH");
        fail("Expecting exception: Exception");
  ...
  public void test27()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("$m^i7=", "uT0&r}$_n]5hf&%]b");
        fail("Expecting exception: Exception");
  ...
  public void test28()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("2?0?-G{\"?r&[");
      assertEquals("2?0?-G{\"?r&[", string0);
      assertNotNull(string0);
  }
  ...
  public void test33()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode((String) null, "^BeOp9T)");
      assertNull(string0);
  }
  ...
  public void test36()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode((Object) (byte)126);
        fail("Expecting exception: Exception");
  ...
  public void test43()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "org.apache.comkons.codec.net.QuotedPrinableCodec");
      assertEquals("org.apache.comkons.codec.net.QuotedPrinableCodec", object0);
      assertNotNull(object0);
  }
  ...
  public void test44()  throws Throwable  {
      ...
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)66, (byte)70, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "[;si$fl\"g");
        fail("Expecting exception: NullPointerException");
