...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte) (-41), (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)6, (byte)0, (byte)0, (byte)0}, byteArray2);
  }
  ...
  public void test04()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("hz4BgB:8F_");
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("M6'!_r.U-` <:Mf1g");
      assertNotNull(string0);
      assertEquals("M6'!_r.U-` <:Mf1g", string0);
  }
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode(" 9,>{Gl", "");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("iV#cXxa(m+.:5\",l=", "'");
        fail("Expecting exception: Exception");
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("*");
      try { 
        quotedPrintableCodec0.decode("b5{NrB;T&xHv9");
        fail("Expecting exception: Exception");
  ...
  public void test30()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      BitSet bitSet0 = new BitSet(2381);
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertEquals(0, byteArray1.length);
  }
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("UTF-16BE");
      String string0 = (String)quotedPrintableCodec0.encode((Object) "UTF-16BE");
      String string1 = quotedPrintableCodec0.encode(string0);
      assertEquals("=00=3D=000=000=00U=00=3D=000=000=00T=00=3D=000=000=00F=00=3D=000=000=00-=00=3D=000=000=001=00=3D=000=000=006=00=3D=000=000=00B=00=3D=000=000=00E", string1);
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("JxyGlQ<';:v>kQ2>ib", (String) null);
        fail("Expecting exception: NullPointerException");
