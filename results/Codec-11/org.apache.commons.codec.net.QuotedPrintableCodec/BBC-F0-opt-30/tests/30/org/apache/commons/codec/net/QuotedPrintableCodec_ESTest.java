...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48}, byteArray4);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48}, byteArray2);
      assertEquals(6, byteArray4.length);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("-6WG'E40%(t4!!@~");
      try { 
        quotedPrintableCodec0.decode((Object) "-6WG'E40%(t4!!@~");
  ...
  public void test06()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("6M,laSm(ozT4k$o?");
      assertEquals("6M,laSm(ozT4k$o?", string0);
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("p&!VN=", (String) null);
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("XddJ>6Jkp,O*_=7Y");
        fail("Expecting exception: NullPointerException");
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = quotedPrintableCodec0.encode((Object) "I=00=3D=000=000=00n=00=3D=000=000=00v=00=3D=000=000=00a=00=3D=000=000=00l=00=3D=000=000=00i=00=3D=000=000=00d=00=3D=000=000=00 =00=3D=000=000=00q=00=3D=000=000=00u=00=3D=000=000=00o=00=3D=000=000=00t=00=3D=000=000=00e=00=3D=000=000=00d=00=3D=000=000=00-=00=3D=000=000=00p=00=3D=000=000=00r=00=3D=000=000=00i=00=3D=000=000=00n=00=3D=000=000=00t=00=3D=000=000=00a=00=3D=000=000=00b=00=3D=000=000=00l=00=3D=000=000=00e=00=3D=000=000=00 =00=3D=000=000=00e=00=3D=000=000=00n=00=3D=000=000=00c=00=3D=000=000=00o=00=3D=000=000=00d=00=3D=000=000=00i=00=3D=000=000=00n=00=3D=000=000=00g=00=3D=000=000=00");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "_1g^");
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("PT-#[VE=vj", "");
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.decode("=PevM+q&\"Kl4V0^");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "# e.B}>M");
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("X<J6ZwO", "UTF-16LE");
      assertEquals("X=00<=00J=006=00=7F=00Z=00w=00O=00", string0);
  }
  ...
  public void test32()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "z4X3OJVc}^}LEtRc-");
      assertEquals("z4X3OJVc}^}LEtRc-", object0);
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("X<J6ZwO");
      assertEquals("X<J6ZwO", string0);
      assertNotNull(string0);
  }
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("+9?'OxQ24sB~g9sg_4Z");
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      assertNotSame(byteArray1, byteArray0);
  }
