...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)16}, byteArray2);
      assertEquals(9, byteArray2.length);
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("_`g%zc{}");
      try { 
        quotedPrintableCodec0.encode("an_;N*.E3ZBb9|");
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode((Object) "Y6k\">4r*Pizq)");
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("o BfMT");
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("", "@7%|/]i)^");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test18()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode(":dbc");
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("51yFR !/fsj6/F}]", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "Y6k\">4r*Pizq)");
      assertEquals("Y6k\">4r*Pizq)", object0);
  ...
  public void test33()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "Y6k\">4r*Pizq)");
      assertNotNull(object0);
      assertEquals("Y6k\">4r*Pizq)", object0);
  }
  ...
  public void test35()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("ET<g.xn#9mWGZaLPS");
      assertEquals("ET<g.xn#9mWGZaLPS", string0);
      assertNotNull(string0);
  }
  ...
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("%l p-(\"_/=p_{\"E(");
      try { 
        quotedPrintableCodec0.decode("%l p-(\"_/=p_{\"E(", "%l p-(\"_/=p_{\"E(");
        fail("Expecting exception: Exception");
  ...
  public void test42()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("^y,RO");
      assertEquals("^y,RO", string0);
      assertNotNull(string0);
  }
  ...
  public void test43()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("ET<g.xn#9mWGZaLPS", "UTF-8");
      assertEquals("ET<g.xn#9mWGZaLPS", string0);
      assertNotNull(string0);
  }
