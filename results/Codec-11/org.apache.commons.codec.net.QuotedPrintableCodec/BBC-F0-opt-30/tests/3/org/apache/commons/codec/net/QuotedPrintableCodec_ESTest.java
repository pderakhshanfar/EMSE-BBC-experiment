...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("E!B6WG=7F_");
      assertEquals("E!B6WG_", string0);
      assertNotNull(string0);
  }
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "_*uEXbO\"Y\"}h");
      assertNotNull(object0);
      assertEquals("_*uEXbO\"Y\"}h", object0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("h-.T3Mp%xg>", (String) null);
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "Jl+");
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("9=5>0K2]JH+^{vc");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("9=5>0K2]JH+^{vc");
      try { 
        quotedPrintableCodec0.decode("9=5>0K2]JH+^{vc", "J>5G7_ML7l~|");
        fail("Expecting exception: Exception");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("']tE|}AEmAp$", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("9=5>0K2]JH+^{vc");
      try { 
        quotedPrintableCodec0.decode("|8Np", "|8Np");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("?");
      try { 
        quotedPrintableCodec0.decode("FiSuQ&J6z;w5");
        fail("Expecting exception: Exception");
  ...
  public void test27()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48, (byte)61, (byte)53, (byte)70, (byte)16}, byteArray1);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      ByteBuffer byteBuffer0 = ByteBuffer.allocateDirect(819);
  ...
  public void test31()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode((String) null, "MqY[h)tppH{DI|");
      assertNull(string0);
  }
  ...
  public void test36()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) ":LC&[ai2>LKdRceJC8");
      assertEquals(":LC&[ai2>LKdRceJC8", object0);
      assertNotNull(object0);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("Object of tye ");
        fail("Expecting exception: NullPointerException");
