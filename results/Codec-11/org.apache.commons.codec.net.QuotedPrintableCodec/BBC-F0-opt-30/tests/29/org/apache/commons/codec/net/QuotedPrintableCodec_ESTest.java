...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte) (-13), (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  ...
  public void test03()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("fl");
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("{Q*2Mc", "UTF-8");
      assertEquals("{Q*2Mc", string0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("U`cK.UCzmx`${U", (String) null);
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("LGwv#");
        fail("Expecting exception: NullPointerException");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("\"f?[kK1*mf_M-$s");
      try { 
        quotedPrintableCodec0.decode("");
        fail("Expecting exception: Exception");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode(",9,o9k;^+");
      assertEquals(",9,o9k;^+", string0);
      assertNotNull(string0);
  }
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("P@f#[=o{jcs", "P@f#[=o{jcs");
        fail("Expecting exception: Exception");
  ...
  public void test33()  throws Throwable  {
      ByteBuffer byteBuffer0 = ByteBuffer.allocate(1147);
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("fl");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // Objects of type java.nio.HeapByteBuffer cannot be quoted-printable encoded
         //
         verifyException("org.apache.commons.codec.net.QuotedPrintableCodec", e);
      }
  }
