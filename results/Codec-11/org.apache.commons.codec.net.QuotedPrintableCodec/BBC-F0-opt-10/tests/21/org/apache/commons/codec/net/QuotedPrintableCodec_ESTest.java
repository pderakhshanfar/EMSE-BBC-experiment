...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      byte[] byteArray2 = QuotedPrintableCodec.decodeQuotedPrintable(byteArray1);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)52}, byteArray1);
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)4}, byteArray2);
  }
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("Dh;s6a}1.");
      assertNotNull(string0);
      assertEquals("Dh;s6a}1.", string0);
  }
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) ">aU?of5CJ(:");
      assertNotNull(object0);
      assertEquals(">aU?of5CJ(:", object0);
  }
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("@TK)e!AQ", "UTF-16BE");
      assertEquals("\u4054\u4B29\u6521\u4151", string0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("Th@Ua~K!", (String) null);
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode(";$d]jI*W<", "3I2' ^GN[#(");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode(":E!=", "n2FrDz~K");
        fail("Expecting exception: Exception");
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("6p)*/I?aE3o-ic{J {");
      try { 
        quotedPrintableCodec0.encode("6p)*/I?aE3o-ic{J {");
        fail("Expecting exception: Exception");
  ...
  public void test33()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode((String) null, "1Iq1;hO|'w2N$V");
      assertNull(string0);
  }
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      try { 
        quotedPrintableCodec0.decode("8 b=mB46'i)Y%v");
        fail("Expecting exception: Exception");
  ...
  public void test43()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)109}, byteArray1);
  }
  ...
  public void test44()  throws Throwable  {
      ...
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable((BitSet) null, byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)67, (byte)55, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "VlK%*[P|m");
        fail("Expecting exception: NullPointerException");
