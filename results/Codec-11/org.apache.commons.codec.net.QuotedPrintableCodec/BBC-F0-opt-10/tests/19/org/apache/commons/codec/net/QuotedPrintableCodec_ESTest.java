...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("!)is7m_+9r");
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(",5|y");
      String string0 = quotedPrintableCodec0.encode("8k;ntUV", "UTF-16LE");
      assertEquals("8=00k=00;=00n=00t=00U=00V=00", string0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      String string0 = quotedPrintableCodec0.decode("-tzv$6%mui,0'2x", "UTF-16LE");
      assertEquals("\u742D\u767A\u3624\u6D25\u6975\u302C\u3227\uFFFD", string0);
  }
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("':779mX");
      assertEquals("':779mX", string0);
      assertNotNull(string0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("W?S<z~zfhL<Tc)RF 8", (String) null);
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("3$$QL0Ws(n1BkFk~", "3$$QL0Ws(n1BkFk~");
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("2,90h");
      try { 
        quotedPrintableCodec0.encode("2,90h");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("MP:(:i=2DHWl");
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(" cannot be quoted-printable encoded");
      try { 
        quotedPrintableCodec0.decode("J=:nU", "J=:nU");
        fail("Expecting exception: Exception");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("U0", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode("Ro8<SQD?7_", "org.apache.commons.codec.EncoderException");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("ql22q}s}F!5+Y+?suv:");
      assertNotNull(string0);
      assertEquals("ql22q}s}F!5+Y+?suv:", string0);
  }
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "a5(9Z#Lltgb@=7F.9");
      assertEquals("a5(9Z#Lltgb@.9", object0);
  ...
  public void test46()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "a5(9Z#Lltgb@.9");
      assertNotNull(object0);
      assertEquals("a5(9Z#Lltgb@=7F.9", object0);
  }
}
