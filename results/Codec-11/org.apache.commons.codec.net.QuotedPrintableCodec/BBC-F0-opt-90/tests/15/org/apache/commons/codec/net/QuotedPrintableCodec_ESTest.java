...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)52}, byteArray1);
      assertArrayEquals(new byte[] {(byte)4}, byteArray2);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("X\"o`;u/rYM8\"+^");
      try { 
        quotedPrintableCodec0.decode((Object) "X\"o`;u/rYM8\"+^");
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("x[rQl:',|K}B``I<q");
      assertNotNull(string0);
      assertEquals("x[rQl:',|K}B``I<q", string0);
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("OfhYW2#", "US-ASCII");
      assertEquals("OfhYW2#", string0);
  }
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("n\"f %;&+x|<(");
      assertEquals("n\"f %;&+x|<(", string0);
      assertNotNull(string0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode(" 7");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("l+#o[eF :J=D");
        fail("Expecting exception: Exception");
  ...
  public void test29()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)70, (byte)70, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray1);
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "OC7#WHl ]:>2!");
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("g$F&[q<=5P", "spmxz#<87'+>v");
        fail("Expecting exception: Exception");
  ...
  public void test43()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte) (-71), (byte)0, (byte)0, (byte)0}, byteArray2);
  }
