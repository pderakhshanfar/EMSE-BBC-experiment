...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = quotedPrintableCodec0.decode((Object) "=3Djw!z4");
      assertEquals("=jw!z4", object0);
  ...
  public void test02()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("uz'N\"%hO#ps+puELM");
      String string0 = quotedPrintableCodec0.getDefaultCharset();
      assertEquals("uz'N\"%hO#ps+puELM", string0);
  }
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("METNUDYxvn;j0;O,dw", "UTF-8");
      assertEquals("METNUDYxvn;j0;O,dw", string0);
  }
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("{CS1 OGh;7Lt");
      assertNotNull(string0);
      assertEquals("{CS1 OGh;7Lt", string0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("zf2}e0O", (String) null);
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("&C#E", "");
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(" 7.~K");
      try { 
        quotedPrintableCodec0.encode(" 7.~K");
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = quotedPrintableCodec0.encode((Object) "`=00=3D=000=000=00|=00=3D=000=000=003=00=3D=000=000=005=00=3D=000=000=00q=00=3D=000=000=00]=00=3D=000=000=00?=00=3D=000=000=00]=00=3D=000=000=00v=00=3D=000=000=00A=00=3D=000=000=00G=00=3D=000=000=00t=00=3D=000=000=00]=00=3D=000=000=003=00=3D=000=000=00c=00=3D=000=000=00");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "4F4");
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode((String) null, "1");
      assertNull(string0);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // Objects of type java.nio.DirectLongBufferS cannot be quoted-printable decoded
         //
         verifyException("org.apache.commons.codec.net.QuotedPrintableCodec", e);
      }
  }
  ...
  public void test37()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("uz'N\"%hO#ps+puELM");
      String string0 = quotedPrintableCodec0.decode((String) null, "uz'N\"%hO#ps+puELM");
      assertNull(string0);
  }
  ...
  public void test39()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("]9|I-_hX67=e", "{`#[SM/");
        fail("Expecting exception: Exception");
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("4F4", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("4F4");
      assertEquals("4F4", string0);
      assertNotNull(string0);
  }
}
