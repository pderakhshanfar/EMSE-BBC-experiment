...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("LA{WaQ%VK8~");
      try { 
        quotedPrintableCodec0.decode("LA{WaQ%VK8~");
        fail("Expecting exception: Exception");
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("-*FIU;", "UTF-8");
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("zBKyT.+ $MI.~`k");
      assertNotNull(string0);
      assertEquals("zBKyT.+ $MI.~`k", string0);
  }
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("8ku|&C:GWpd{S");
      try { 
        quotedPrintableCodec0.encode("8ku|&C:GWpd{S");
        fail("Expecting exception: Exception");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("O'H|[M(2J'");
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.decode(")KS=/yOb", "%C.");
        fail("Expecting exception: Exception");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("oq=7e^hcMh}", "oq=7e^hcMh}");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("zBKyT.+ $MI.~`k");
      assertNotNull(string0);
      assertEquals("zBKyT.+ $MI.~`k", string0);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)100, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test30()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("yYkmKrpt1(J_K)/]");
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      assertArrayEquals(new byte[] {}, byteArray1);
  }
  ...
  public void test34()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "Bls;:\"hd7EI.rt5@/");
      assertEquals("Bls;:\"hd7EI.rt5@/", object0);
      assertNotNull(object0);
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) ">.+jZ!-7");
        fail("Expecting exception: NullPointerException");
  ...
  public void test42()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.encode(">.+jZ!-7", "UTF-8");
      assertNotNull(string0);
      assertEquals(">.+jZ!-7", string0);
  }

  @Test(timeout = 4000)
  public void test43()  throws Throwable  {
      ByteBuffer byteBuffer0 = ByteBuffer.allocateDirect(2747);
      BitSet bitSet0 = BitSet.valueOf(byteBuffer0);
      byte[] byteArray0 = new byte[3];
      byteArray0[1] = (byte) (-9);
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)70, (byte)55, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("gKXmqnxiRkeLhfaQ[");
        fail("Expecting exception: NullPointerException");
