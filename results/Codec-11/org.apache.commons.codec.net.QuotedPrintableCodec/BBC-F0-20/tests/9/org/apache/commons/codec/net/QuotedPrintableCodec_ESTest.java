...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode("IB\"4wg:[=");
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode((Object) "5Rg=31y.a");
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("PnHLd!\"@{@&)M2CX", "UTF-16LE");
      assertEquals("\u6E50\u4C48\u2164\u4022\u407B\u2926\u324D\u5843", string0);
  }
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("!|7xFri$`s4/jPz-_K");
      assertNotNull(string0);
      assertEquals("!|7xFri$`s4/jPz-_K", string0);
  }
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("xy@H\"hFMxX{?_bO");
      try { 
        quotedPrintableCodec0.encode("~{fEL9yE@:Yo");
        fail("Expecting exception: Exception");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("'Lku");
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "Z>c");
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Y5\u0007XMc[7pN.krwZD9%");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("yi)*.QEi[P");
      assertNotNull(string0);
      assertEquals("y=7Fi)*.QEi[P", string0);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)49, (byte)49, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray1);
  }
  ...
  public void test32()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode((String) null, "@i3|*o{");
      assertNull(string0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("QGb6w6j8NS5`w=2NA\"");
  ...
  public void test35()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "Z>c");
  ...
  public void test39()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode((String) null, ";y/,*Dg`e~+kquxYpG");
      assertNull(string0);
  }
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "u`)h~5s^");
      assertNotNull(object0);
      assertEquals("u`)h~5s^", object0);
  }

  @Test(timeout = 4000)
  public void test42()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("rL'_??\"bisyC?SwVnw");
      try { 
        quotedPrintableCodec0.decode("W{)~d,-NB=^MC", "");
        fail("Expecting exception: Exception");
  ...
  public void test47()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("PnHLd!\"@{@&)M2CX", "US-ASCII");
      assertNotNull(string0);
      assertEquals("PnHLd!\"@{@&)M2CX", string0);
  }
  ...
  public void test48()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("s?+ h<%3Tc5w:87FtUw");
        fail("Expecting exception: NullPointerException");
