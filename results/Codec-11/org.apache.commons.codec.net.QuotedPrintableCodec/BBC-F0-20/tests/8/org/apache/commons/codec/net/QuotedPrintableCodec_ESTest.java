...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode(" cannot be quoted-printable decoded", "US-ASCII");
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode(";=7Fs:I4`0Za}");
      assertNotNull(string0);
      assertEquals(";s:I4`0Za}", string0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode(",C", (String) null);
  ...
  public void test15()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("iV/h5q=3^6dSpvs");
        fail("Expecting exception: Exception");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("Y#G8(H*0");
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("kP%n_:Fgru", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("4}", "4}");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test40()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("wulhJ<{Es=':$z >&&", " cannot be quoted-printable encoded");
        fail("Expecting exception: Exception");
