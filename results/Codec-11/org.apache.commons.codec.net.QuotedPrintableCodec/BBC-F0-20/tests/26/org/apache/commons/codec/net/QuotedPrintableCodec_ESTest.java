...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = quotedPrintableCodec0.decode((Object) ";qw|8;q{=3D7Fjx");
      assertEquals(";qw|8;q{=7Fjx", object0);
  ...
  public void test04()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("%XN{U3x");
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("#q", "UTF-16BE");
      assertEquals("=00#=00q", string0);
  }
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("#_/idO");
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("%XN{U3x");
      try { 
        quotedPrintableCodec0.encode("JDXr-I%*I ");
        fail("Expecting exception: Exception");
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode(">Kd\"S<\"fZ=_]8(M8fI", ">Kd\"S<\"fZ=_]8(M8fI");
        fail("Expecting exception: Exception");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("%XN{U3x");
      try { 
        quotedPrintableCodec0.decode("%XN{U3x");
        fail("Expecting exception: Exception");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("9", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      BitSet bitSet0 = new BitSet(3506);
  ...
  public void test40()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode("YdkV*b}+j", "YdkV*b}+j");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("uI,/%z)h[r~Z");
      assertNotNull(string0);
      assertEquals("uI,/%z)h[r~Z", string0);
  }
}
