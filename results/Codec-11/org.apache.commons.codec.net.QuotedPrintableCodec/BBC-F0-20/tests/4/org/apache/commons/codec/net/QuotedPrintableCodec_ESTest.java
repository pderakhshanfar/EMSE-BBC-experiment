...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte) (-76), (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  ...
  public void test04()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("kLQAmn;|~8Z16q*e");
  ...
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode(",i+p4W~2.mmf`'");
      assertNotNull(string0);
      assertEquals(",i+p4W~2.mmf`'", string0);
  }
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("S4Er");
      assertNotNull(string0);
      assertEquals("S4Er", string0);
  }
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "9_xg_DP");
      assertEquals("9_xg_DP", object0);
  ...
  public void test18()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("S4Er", "S4Er");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("&x.K',ado");
      try { 
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      try { 
        quotedPrintableCodec0.decode("aG=ARWvOLzH3`", (String) null);
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("d}j0^qCg93&Fr5M-(", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode("(F@M|RHphOW#");
        fail("Expecting exception: Exception");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("`OhGC%%~P`)*?LL[");
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("", ",i+p4W~2.mmf`'");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("<gi4,WI;p!2");
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)116, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "j)rAne2GJIz|W#");
        fail("Expecting exception: NullPointerException");
  ...
  public void test46()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode((Object) "n_YO=");
        fail("Expecting exception: Exception");
