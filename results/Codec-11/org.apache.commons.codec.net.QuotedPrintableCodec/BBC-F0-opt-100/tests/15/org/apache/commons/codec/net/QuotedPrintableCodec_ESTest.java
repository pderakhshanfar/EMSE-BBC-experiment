...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)47, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  }
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("jY)=O5$llrh$ZDj");
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = quotedPrintableCodec0.decode(byteArray0);
  ...
  public void test10()  throws Throwable  {
      ...
      String string0 = quotedPrintableCodec0.decode("q_!/mu(<{!?x1K", "UTF-8");
      assertEquals("q_!/mu(<{!?x1K", string0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("zLPesWuA", (String) null);
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("x:tM]]^2rq_");
      try { 
        quotedPrintableCodec0.encode("x:tM]]^2rq_");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("($:e&E4/RpkR5yzL");
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "Kq+.nUnDWce Xk");
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("R hB}u:)");
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("y 2", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("org.apache.commons.codec.net.QuotedPrintableCodec", "+pG=1d-");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("KaQ`b_%6jdz?sha");
      try { 
        quotedPrintableCodec0.decode("KaQ`b_%6jdz?sha");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("#l-E0|1#X;Oe]1hnZG");
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("iasEr;FaM");
      String string0 = quotedPrintableCodec0.getDefaultCharset();
      assertEquals("iasEr;FaM", string0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.encode((String) null, "#&jjw\b8");
      assertNull(string0);
  }
  ...
  public void test39()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode((String) null, "=G31$#H");
      assertNull(string0);
  }
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("=G31$#H", "UTF-8");
        fail("Expecting exception: Exception");
  ...
  public void test46()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.encode("US-ASCII", "UTF-16BE");
      assertNotNull(string0);
      assertEquals("=00U=00S=00-=00A=00S=00C=00I=00I", string0);
  }
}
