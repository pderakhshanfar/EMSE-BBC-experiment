...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = quotedPrintableCodec0.decode((Object) "/N/20B=7FTpI<");
      assertEquals("/N/20BTpI<", object0);
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("gMOB", "UTF-16BE");
      assertEquals("=00g=00M=00O=00B", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("/N/20BTpI<");
      assertNotNull(string0);
      assertEquals("/N/20B=7FTpI<", string0);
  }
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "gMOB");
      assertNotNull(object0);
      assertEquals("gMOB", object0);
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("uqAy<;D.,m", "UTF-8");
      assertEquals("uqAy<;D.,m", string0);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("fq!Gv<v");
      assertEquals("fq!Gv<v", string0);
      assertNotNull(string0);
  }
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("PNgx$720j7Nzuz", "");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("_E6:s'}jgKKM$=", "_E6:s'}jgKKM$=");
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("2fY-dokCt:JHvdk8", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("2fY-dokCt:JHvdk8", "org.apache.commons.codec.EncoderException");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "uqAy<;D.,m");
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("]i3s=+[]N:{ekkI");
        fail("Expecting exception: NullPointerException");
