...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("TU55lo6Ay3JC", "UTF-16BE");
      assertEquals("=00T=00U=005=005=00l=00o=006=00A=00y=003=00J=00C", string0);
  }
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("%1vf*", "UTF-8");
      assertEquals("%1vf*", string0);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("\"?NV@,`Vv]QMmpq-DZ2");
      assertEquals("\"?NV@,`Vv]QMmpq-DZ2", string0);
      assertNotNull(string0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("M/pc5", (String) null);
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("U{@UuB#@GO*(gK\"", "u+=q1,&G@H5dXO*>BGt");
  ...
  public void test18()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("{t_2~=iu2vN`");
      try { 
        quotedPrintableCodec0.decode("{t_2~=iu2vN`", "");
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("d|Q");
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("(OI{.HWd_I,q");
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "org.apache.commons.codec.net.QuotvdPrintableCodec");
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("U{@UuB#@GO*(gK\"");
      assertNotNull(string0);
      assertEquals("U{@UuB#@GO*(gK\"", string0);
  }
  ...
  public void test29()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("jd!mp_8(eu");
  ...
  public void test35()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "org.apache.commons.codec.net.QuotvdPrintableCodec");
      assertEquals("org.apache.commons.codec.net.QuotvdPrintableCodec", object0);
      assertNotNull(object0);
  }
  ...
  public void test43()  throws Throwable  {
      ...
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      byte[] byteArray2 = QuotedPrintableCodec.decodeQuotedPrintable(byteArray1);
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte) (-55), (byte)0}, byteArray2);
      assertEquals(27, byteArray1.length);
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "*VqM(\"[oVv*CR");
        fail("Expecting exception: NullPointerException");
