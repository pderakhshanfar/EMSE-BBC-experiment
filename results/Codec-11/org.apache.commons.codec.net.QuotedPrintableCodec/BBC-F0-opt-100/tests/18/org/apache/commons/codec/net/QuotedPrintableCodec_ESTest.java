...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("<|zKva <eS@$s");
      try { 
        quotedPrintableCodec0.decode((Object) "<|zKva <eS@$s");
  ...
  public void test04()  throws Throwable  {
      ...
      LongBuffer longBuffer0 = LongBuffer.allocate(2859);
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("C", "UTF-16BE");
      assertEquals("\uFFFD", string0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "ei7yc:");
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("qB{pN)=&+RDVrN%");
      try { 
        quotedPrintableCodec0.decode("qB{pN)=&+RDVrN%", "");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("U=L");
        fail("Expecting exception: Exception");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("tNMk");
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("I_bPW5RB%QR=e,r7>", "UTF-8");
      assertEquals("I_bPW5RB%QR=3De,r7>", string0);
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("w0jSGlMQP5yD");
      assertNotNull(string0);
      assertEquals("w0jSGlMQP5yD", string0);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("-Wk1^(wb;:");
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("N.v");
      assertEquals("N.v", string0);
      assertNotNull(string0);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertArrayEquals(new byte[] {(byte) (-118), (byte)61, (byte)48, (byte)48}, byteArray1);
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.encode((String) null, "w0jSGlMQP5yD");
      assertNull(string0);
  }
  ...
  public void test42()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "dS+^b/5hDYe'G+}|>*");
      assertNotNull(object0);
      assertEquals("dS+^b/5hDYe'G+}|>*", object0);
  }
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "N.v");
