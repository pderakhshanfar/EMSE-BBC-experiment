...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("[VJB%AOwj");
      try { 
        quotedPrintableCodec0.decode((Object) "[VJB%AOwj");
  ...
  public void test06()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "nlsr:y:|tkA;sEaC6a");
      assertNotNull(object0);
      assertEquals("nlsr:y:|tkA;sEaC6a", object0);
  }
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("nlsr:y:|tkA;sEaC6a");
      assertEquals("nlsr:y:|tkA;sEaC6a", string0);
      assertNotNull(string0);
  }
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("NmmwYdEvBEY7", "NmmwYdEvBEY7");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      try { 
        quotedPrintableCodec0.decode("LDlX[Lu:~2OY", "LDlX[Lu:~2OY");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("Jsbg!U=");
        fail("Expecting exception: Exception");
  ...
  public void test34()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("`<4'GBok!Ej9lq.fl_R");
      Object object0 = new Object();
      try { 
  ...
  public void test37()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "thxwxie2]");
      assertEquals("thxwxie2]", object0);
      assertNotNull(object0);
  }
  ...
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode((String) null, "4BUO]+f");
      assertNull(string0);
  }
  ...
  public void test40()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("/T=CH=", "");
        fail("Expecting exception: Exception");
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("vul t", "UTF-16BE");
      assertEquals("\u7675\u6C7F\u2074", string0);
      assertNotNull(string0);
  }
  ...
  public void test43()  throws Throwable  {
      ...
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      byte[] byteArray2 = QuotedPrintableCodec.decodeQuotedPrintable(byteArray1);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)67, (byte)69, (byte)61, (byte)48, (byte)48}, byteArray1);
      assertArrayEquals(new byte[] {(byte)0, (byte) (-50), (byte)0}, byteArray2);
  }
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("AnL(~/:");
      assertNotNull(string0);
      assertEquals("AnL(~=7F/:", string0);
  }

  @Test(timeout = 4000)
  public void test46()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("caUz`^\")#_QX", "ISO-8859-1");
      assertEquals("caUz`^\")#_QX", string0);
      assertNotNull(string0);
  }
