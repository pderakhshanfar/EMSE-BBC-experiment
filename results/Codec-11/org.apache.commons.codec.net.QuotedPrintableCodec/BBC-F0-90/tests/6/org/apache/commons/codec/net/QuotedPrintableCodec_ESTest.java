...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      Object object0 = quotedPrintableCodec0.encode((Object) "iq(p8||zyU\"d");
      assertEquals("i=00q=00(=00p=008=00|=00|=00z=00y=00U=00\"=00d=00", object0);
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("l5XkK");
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("2ju7V]y;$|r#$N", "2ju7V]y;$|r#$N");
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("}mp aWH->UD !?L/");
      try { 
        quotedPrintableCodec0.encode("}mp aWH->UD !?L/");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("l9N{*Gp..f.(V");
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("y5;'~Mr^+OfRS. F ", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("eV{%yxl^2;S6\"I");
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("b7b0<RJJ1[Fd)OJH.");
      assertEquals("b7b0<RJJ1[Fd)OJH.", string0);
      assertNotNull(string0);
  }
  ...
  public void test30()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("UTF-16LE");
      Object object0 = quotedPrintableCodec0.decode((Object) "iq(p8||zyU\"d");
      assertNotNull(object0);
      assertEquals("\u7169\u7028\u7C38\u7A7C\u5579\u6422", object0);
  }
  ...
  public void test36()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("R5yqm");
      try { 
        quotedPrintableCodec0.decode("");
        fail("Expecting exception: Exception");
  ...
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("x=^e^X--h/cp", "x=^e^X--h/cp");
        fail("Expecting exception: Exception");
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "P]F5Z^OWygb(<");
        fail("Expecting exception: NullPointerException");
