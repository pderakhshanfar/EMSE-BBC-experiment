...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      byte[] byteArray2 = QuotedPrintableCodec.decodeQuotedPrintable(byteArray1);
      assertArrayEquals(new byte[] {(byte)11, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
      assertEquals(5, byteArray2.length);
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("APFnrRC fe*");
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("APFnrRC fe*", (String) null);
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("]sWX^Y&H=f}wrgjD/");
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("G7 K$");
        fail("Expecting exception: NullPointerException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "Kr|}?&,8FDou:J");
        fail("Expecting exception: NullPointerException");
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("lsVBD");
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("=[[fZ)g[g53j1", "=[[fZ)g[g53j1");
        fail("Expecting exception: Exception");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("%`u9lRg%`", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("shgrpL6gJ", "shgrpL6gJ");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "+_Stm8O0,%L_");
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Djslk");
      try { 
        quotedPrintableCodec0.encode("Djslk", "Djslk");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("ow9l", "US-ASCII");
      assertEquals("ow9l", string0);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)66, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray1);
  }
  ...
  public void test32()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "+_Stm8O0,%L_");
      assertNotNull(object0);
      assertEquals("+_Stm8O0,%L_", object0);
  }
  ...
  public void test44()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "Kr|}?&,8FDou:J");
      assertEquals("Kr|}?&,8FDou:J", object0);
      assertNotNull(object0);
  }
}
