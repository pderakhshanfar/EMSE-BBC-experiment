...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("L}DWwzdSkbVZ", "UTF-16BE");
      assertEquals("\u4C7D\u4457\u777A\u6453\u6B62\u565A", string0);
  }
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("U}nJLcrOX)nBgq");
      assertEquals("U}nJLcrOX)nBgq", string0);
      assertNotNull(string0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("t.\")", (String) null);
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("VNk>eI`N1#b2");
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("=;}tL{w_XO|&r,ag", "=;}tL{w_XO|&r,ag");
        fail("Expecting exception: Exception");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("Tw|97IokS6KDY", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode("gf");
        fail("Expecting exception: Exception");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("@$\"*dt:tf,8WB-Wb%");
      try { 
        quotedPrintableCodec0.decode("Xt{*ua~aS", "R4%yz),7fX8kn");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("U}nJLcrOX)nBgq");
      assertNotNull(string0);
      assertEquals("U}nJLcrOX)nBgq", string0);
  }
  ...
  public void test29()  throws Throwable  {
      BitSet bitSet0 = new BitSet(1429);
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "&cJcU+x)xbM");
        fail("Expecting exception: NullPointerException");
