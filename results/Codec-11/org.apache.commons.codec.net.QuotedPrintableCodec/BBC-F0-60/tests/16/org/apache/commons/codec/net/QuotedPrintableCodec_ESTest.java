...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "m08A2ie");
      assertNotNull(object0);
      assertEquals("m08A2ie", object0);
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("bs1xf]v;");
      assertEquals("bs1xf]v;", string0);
      assertNotNull(string0);
  }
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("cQJ.W!Wcc");
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("cQJ.W!Wcc", (String) null);
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "sSp&");
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("org.apache.commons.codec.EncoderException");
      try { 
        quotedPrintableCodec0.decode("|oWS7w=E8PV", "@3E$W=@<fB8)R#");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("S@8:");
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "-i44J}421]?G|f!&#");
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("|MpP8q*re$M4>");
      try { 
        quotedPrintableCodec0.encode("");
        fail("Expecting exception: Exception");
  ...
  public void test28()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.encode((String) null, "S@8:");
      assertNull(string0);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode("e3T<t-");
        fail("Expecting exception: Exception");
  ...
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("_SC<hi\"}XSaSy=", "_SC<hi\"}XSaSy=");
        fail("Expecting exception: Exception");
  ...
  public void test40()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("Xn8", "UTF-8");
      assertEquals("Xn8", string0);
      assertNotNull(string0);
  }
  ...
  public void test41()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)67, (byte)68, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
