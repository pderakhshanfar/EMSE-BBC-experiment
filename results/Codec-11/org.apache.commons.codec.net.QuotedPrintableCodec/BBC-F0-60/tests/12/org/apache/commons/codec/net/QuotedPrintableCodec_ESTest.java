...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte) (-94), (byte)0, (byte)0}, byteArray2);
      assertArrayEquals(new byte[] {(byte)61, (byte)65, (byte)50, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.decode("XEK!)+");
  ...
  public void test06()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("UTF-8");
      String string0 = quotedPrintableCodec0.encode("pqIQ^K%");
      assertEquals("pqIQ^K%", string0);
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("XEK!)+");
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = quotedPrintableCodec0.decode(byteArray0);
      assertNotSame(byteArray0, byteArray1);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("`Fr*blCch%", (String) null);
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("$6FFuig7;7qd");
      try { 
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("_=ho{R(U>[}N*T&Gi", (String) null);
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("Eir3`:tvNx$f", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("\"");
      try { 
        quotedPrintableCodec0.decode("", "#Wt$l +2xoGAKp!$1>8");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("nMX]");
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "Invalid URL encoding: not a valid digit (radix 16): ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("UTF-8");
      String string0 = quotedPrintableCodec0.decode("pqIQ^K%", "UTF-8");
      assertEquals("pqIQ^K%", string0);
  }
  ...
  public void test31()  throws Throwable  {
      BitSet bitSet0 = new BitSet(2566);
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "`6 =I)b_J+KuW?6RUH");
        fail("Expecting exception: NullPointerException");
