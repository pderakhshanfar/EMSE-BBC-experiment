...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("_hYxXs", "UTF-8");
      assertEquals("_hYxXs", string0);
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "h;+^6TB/b");
      assertNotNull(object0);
      assertEquals("h;+^6TB/b", object0);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("w9='r{N");
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("w9='r{N", (String) null);
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("->35?~d");
      try { 
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("'OmT");
        fail("Expecting exception: NullPointerException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "y?`/K+u\"eAn938Zj");
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.decode("WX9Axu*Pa5h|:|rM=w", "OKXXG`R5~V+");
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("org.apache.commons.codec.DecoderException", "i1%p");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("9P<fpGQGJLk4`\"kV1+");
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("y?`/K+u\"eAn938Zj");
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("~yFj9+");
      assertNotNull(string0);
      assertEquals("~yFj9+", string0);
  }
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("Lf*5sv`6<");
      assertNotNull(string0);
      assertEquals("Lf*5sv`6<", string0);
  }
  ...
  public void test37()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.decode((String) null, "D!j>$!");
      assertNull(string0);
  }
  ...
  public void test45()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)51, (byte)68, (byte)61, (byte)51, (byte)48, (byte)61, (byte)51, (byte)48}, byteArray2);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "N;8");
        fail("Expecting exception: NullPointerException");
