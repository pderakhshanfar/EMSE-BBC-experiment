...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte) (-1), (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  ...
  public void test01()  throws Throwable  {
      ...
      assertEquals(9, byteArray2.length);
      assertEquals(27, byteArray1.length);
      assertArrayEquals(new byte[] {(byte) (-128), (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  }
  ...
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("8/<CBo:{3k<#W");
      assertEquals("8/<CBo:{3k<#W", string0);
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("z9bxgC[MIpQ3", "UTF-8");
      assertEquals("z9bxgC[MIpQ3", string0);
  }
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "1");
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("[9m0>iF[HQe]TgW3", (String) null);
  ...
  public void test18()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("org.apache.commJns.codec.%ncoderException");
      try { 
        quotedPrintableCodec0.encode("");
        fail("Expecting exception: Exception");
         ...
         //
         // org.apache.commJns.codec.%ncoderException
         //
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "lV-uplM0)ZdO~");
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("au=_DDTlWZ^dcx*", "");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("S}|Gbt!l9:5");
      try { 
        quotedPrintableCodec0.decode("S}|Gbt!l9:5");
        fail("Expecting exception: Exception");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("pUn|(");
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("i#a_$mO`-{d`)");
      assertNotNull(string0);
      assertEquals("i#a_$mO`-{d`)", string0);
  }
  ...
  public void test31()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("org.apache.commJns.codec.%ncoderException");
      String string0 = quotedPrintableCodec0.encode((String) null, "org.apache.commJns.codec.%ncoderException");
      assertNull(string0);
  }
  ...
  public void test33()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("0PACho0:18]-]X$s;[l");
  ...
  public void test39()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Mf");
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "T3&1(g?");
        fail("Expecting exception: NullPointerException");
