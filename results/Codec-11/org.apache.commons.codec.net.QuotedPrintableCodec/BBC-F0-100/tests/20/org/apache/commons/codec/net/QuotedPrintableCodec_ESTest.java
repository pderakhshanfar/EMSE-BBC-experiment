...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("UTF-16LE", "UTF-16BE");
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("KqdJj,]krw#_R");
      assertEquals("KqdJj,]krw#_R", string0);
      assertNotNull(string0);
  }
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("\u5554\u462D\u3136\u4C45", "|w X$kl%");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("\"30f%zw#2Bi");
        fail("Expecting exception: NullPointerException");
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = quotedPrintableCodec0.encode((Object) "=00=3D=000=000=00:=00=3D=000=000=00)=00=3D=000=000=009=00=3D=000=000=00c=00=3D=000=000=00R=00=3D=000=000=00Q=00=3D=000=000=005=00=3D=000=000=00D=00=3D=000=000=00_=00=3D=000=000=006=00=3D=000=000=00a=00=3D=000=000=00T=00=3D=000=000=00A=00=3D=000=000=00Q=00=3D=000=000=00X=00=3D=000=000=00r=00=3D=000=000=00%=00=3D=000=000=00l=00=3D=000=000=009");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      try { 
        quotedPrintableCodec0.decode("jEQ?Q{1=6rs>lEd3", "Vc:|6aakA{9");
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("M'9UU8");
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "Vc:|6aakA{9");
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)37, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)68, (byte)68, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test29()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.encode((String) null, "_=O|<>**GlEWX~");
      assertNull(string0);
  }
  ...
  public void test32()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "jZ06KS3h!%hn:q~{");
      assertNotNull(object0);
      assertEquals("jZ06KS3h!%hn:q~{", object0);
  }
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("S:");
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)70, (byte)67, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test44()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("WhK)=D5DxN:ik>", "WhK)=D5DxN:ik>");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "/Mf_DLRA|f");
        fail("Expecting exception: NullPointerException");
