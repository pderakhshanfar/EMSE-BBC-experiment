...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode("_5muk#jz} IO#y;=");
  ...
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("53TNJ");
      try { 
        quotedPrintableCodec0.decode("53TNJ");
        fail("Expecting exception: Exception");
  ...
  public void test02()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(",O4=n^j@#9>m;B?,");
      String string0 = quotedPrintableCodec0.getDefaultCharset();
      assertEquals(",O4=n^j@#9>m;B?,", string0);
  }
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("C[gdxw8fd2Ij");
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("v>VA%]8BFx DUp[y6A2");
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("P]", "UTF-8");
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("M5945S*bR43d.m");
      assertEquals("M5945S*bR43d.m", string0);
      assertNotNull(string0);
  }
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("QAcu=h\"!F rM'cP", "");
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("C[gdxw8fd2Ij");
      try { 
        quotedPrintableCodec0.encode("C[gdxw8fd2Ij");
        fail("Expecting exception: Exception");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("ut +QKw/G8MAFR}");
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "vkA\"}q);<cg,mvky1t");
        fail("Expecting exception: NullPointerException");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("PwfiD)=!`OK");
      try { 
        quotedPrintableCodec0.decode("PwfiD)=!`OK", "");
        fail("Expecting exception: Exception");
  ...
  public void test28()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)86, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test31()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(",O4=n^j@#9>m;B?,");
      String string0 = quotedPrintableCodec0.encode((String) null, ",O4=n^j@#9>m;B?,");
      assertNull(string0);
  }
  ...
  public void test36()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) ".`*Sl9{|");
      assertNotNull(object0);
      assertEquals(".`*Sl9{|", object0);
  }
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "{Z7'#W");
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("v>VA%]8BFx DUp[y6A2");
      String string0 = quotedPrintableCodec0.decode((String) null, "79uAF");
      assertNull(string0);
  }
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("KYc)Im|eC54=3D]Mk~-O", "KYc)Im|eC54=3D]Mk~-O");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("KYc)Im|eC54=]Mk~-O");
      assertEquals("KYc)Im|eC54=3D]Mk~-O", string0);
      assertNotNull(string0);
  }
}
