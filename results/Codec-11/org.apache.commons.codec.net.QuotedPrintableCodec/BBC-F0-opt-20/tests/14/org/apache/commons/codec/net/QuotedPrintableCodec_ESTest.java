...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)82, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)49, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray1);
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(":JC+c!fZhPKf");
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("3d`Hl}qhX/-,");
      assertNotNull(string0);
      assertEquals("3d`Hl}qhX/-,", string0);
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      String string0 = quotedPrintableCodec0.decode("mXQLIj*E", "UTF-8");
      assertEquals("mXQLIj*E", string0);
  }
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "f:u1/");
      assertNotNull(object0);
      assertEquals("f:u1/", object0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("19py/o-O>", (String) null);
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "f:u1/");
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.decode("eLl~kBKV3Y=pK", "eLl~kBKV3Y=pK");
        fail("Expecting exception: Exception");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("}B2`|9ZBPX%<hK,H", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("lo~!b!fD3=4");
        fail("Expecting exception: Exception");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("$%,PrQQ0m");
      try { 
        quotedPrintableCodec0.encode("$%,PrQQ0m", "$%,PrQQ0m");
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("$%,PrQQ0m");
      try { 
        quotedPrintableCodec0.decode("", "zI/Y");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test27()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("0I_NM#2nmw^I\"~!6");
      try { 
        quotedPrintableCodec0.encode("GdG2");
        fail("Expecting exception: Exception");
  ...
  public void test40()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)108, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48}, byteArray1);
  ...
  public void test42()  throws Throwable  {
      LongBuffer longBuffer0 = LongBuffer.allocate(15);
  ...
  public void test43()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("s+zsu2eGRZ@$/p");
