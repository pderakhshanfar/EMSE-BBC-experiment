...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode((Object) "[cj.e'qP");
        fail("Expecting exception: Exception");
  ...
  public void test06()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("\"fi/ZmaDP+7L2e@6t");
      byte[] byteArray0 = new byte[0];
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("1DglJjU<)Lu");
      String string0 = quotedPrintableCodec0.decode("1DglJjU<)Lu", "UTF-16BE");
      assertEquals("\u3144\u676C\u4A6A\u553C\u294C\uFFFD", string0);
  }
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("G[gUy~EA");
      assertEquals("G[gUy~EA", string0);
      assertNotNull(string0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("Vf],{_U*@ +1DRuBN8");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("tl=KH![]/.T3]6n");
        fail("Expecting exception: Exception");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "\"^k07[F<-x(!fT pU");
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = QuotedPrintableCodec.decodeQuotedPrintable(byteArray0);
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("O\"K/@CV'W0hjs|");
  ...
  public void test32()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      String string0 = quotedPrintableCodec0.encode((String) null, "[cj.e'qP");
      assertNull(string0);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("g%drK5a");
        fail("Expecting exception: NullPointerException");
