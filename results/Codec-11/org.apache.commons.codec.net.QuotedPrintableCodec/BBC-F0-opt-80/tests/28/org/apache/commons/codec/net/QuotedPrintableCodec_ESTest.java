...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte) (-72), (byte)0, (byte)0, (byte)0}, byteArray2);
  ...
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("3+H<=@szqr7n|;Qwp}~");
      assertNotNull(string0);
      assertEquals("3+H<=3D@szqr7n|;Qwp}~", string0);
  }
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("^6& yh%^qx@");
      byte[] byteArray1 = quotedPrintableCodec0.decode(byteArray0);
      assertFalse(byteArray1.equals((Object)byteArray0));
  }
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("',vK]<*!N]t?P0", "',vK]<*!N]t?P0");
  ...
  public void test15()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("rNa}Lf)unq7;Cr");
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = quotedPrintableCodec0.encode((Object) ":=00=3D=000=000=00O=00=3D=000=000=00T=00=3D=000=000=00K=00=3D=000=000=00b=00=3D=000=000=00L=00=3D=000=000=00/=00=3D=000=000=00i=00=3D=000=000=00.=00=3D=000=000=00m=00=3D=000=000=00f=00=3D=000=000=00B=00=3D=000=000=00'=00=3D=000=000=00D=00=3D=000=000=00]=00=3D=000=000=00A=00=3D=000=000=00<=00=3D=000=000=00}=00=3D=000=000=00k=00=3D=000=000=00");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "I*F*_4E2");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Invalid quoted-printable encoding");
      try { 
        quotedPrintableCodec0.decode("Invalid quoted-printable encoding", "]nGy}cW|i5xl@N0'$D");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.decode("A<{gA");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("QC^&#0IweGR;Y");
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(".fRB#=,,t[[t-i/MT");
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("LHu0(GWa=", "LHu0(GWa=3D");
        fail("Expecting exception: Exception");
  ...
  public void test30()  throws Throwable  {
      BitSet bitSet0 = new BitSet(1490);
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("QC^&#0IweGR;Y");
      assertNotNull(string0);
      assertEquals("QC^&#0IweGR;Y", string0);
  }
