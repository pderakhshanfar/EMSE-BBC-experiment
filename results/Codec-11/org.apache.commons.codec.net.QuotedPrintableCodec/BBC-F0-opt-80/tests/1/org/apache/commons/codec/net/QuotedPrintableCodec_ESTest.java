...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("O|D:WEO[}c#l");
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("J>HWf!F'eMt-");
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = quotedPrintableCodec0.decode(byteArray0);
      assertArrayEquals(new byte[] {}, byteArray1);
  }
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("b?U[YTGBRAOZ4_,", "UTF-16");
      assertEquals("\u623F\u555B\u5954\u4742\u5241\u4F5A\u345F\uFFFD", string0);
  }
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "$71_|[");
      assertEquals("$71_|[", object0);
  ...
  public void test15()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("r*TyrY87V*hSr;5a?&", (String) null);
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("OH&L qN1_", "org.apache.commons.codec.EncoderException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("y0`>x`5Z;s(");
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "chL>FbD");
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("%T<$oUT-=", "%T<$oUT-=");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("org.apache.commons.codec.EncoderException");
      try { 
        quotedPrintableCodec0.decode("h9w5wMDaF4ycM0&H");
        fail("Expecting exception: Exception");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("zUS@pydykp)Q,*en]");
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertArrayEquals(new byte[] {(byte) (-87), (byte)61, (byte)48, (byte)48}, byteArray1);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.encode((String) null, ",@]bcV");
      assertNull(string0);
  }
  ...
  public void test35()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("ZsbUvYgDBZH*");
      assertEquals("ZsbUvYgDBZH*", string0);
      assertNotNull(string0);
  }
  ...
  public void test41()  throws Throwable  {
      ...
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)66, (byte)65}, byteArray1);
  }
