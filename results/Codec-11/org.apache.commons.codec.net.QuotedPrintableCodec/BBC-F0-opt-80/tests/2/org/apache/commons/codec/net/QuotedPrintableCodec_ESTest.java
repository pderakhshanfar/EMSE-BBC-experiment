...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("Yq]30i7_Qq/=t#paz7", "UTF-8");
      assertEquals("Yq]30i7_Qq/=3Dt#paz7", string0);
  }
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("u");
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("ZI~>42D'@k/A* F:(");
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "yKOntS`rGy6Kr_chm");
      assertEquals("yKOntS`rGy6Kr_chm", object0);
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("o|r=2,tb");
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("L|=G)!zzu", "8l(zIpG");
        fail("Expecting exception: Exception");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("`n|xj&Q]tR", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("X", "mm'S\"Vk=c,s");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("ug");
      try { 
        quotedPrintableCodec0.decode("ug");
        fail("Expecting exception: Exception");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.encode("m/o/qU]bO._:*?$");
        fail("Expecting exception: Exception");
  ...
  public void test26()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)67, (byte)53, (byte)0, (byte)0}, byteArray1);
  }
  ...
  public void test41()  throws Throwable  {
      ...
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      byte[] byteArray2 = QuotedPrintableCodec.decodeQuotedPrintable(byteArray1);
      assertArrayEquals(new byte[] {(byte) (-59), (byte)0, (byte)0}, byteArray2);
      assertArrayEquals(new byte[] {(byte)61, (byte)67, (byte)53, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test44()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "mm'S\"Vk=c,s");
      assertEquals("mm'S\"Vk=3Dc,s", object0);
      assertNotNull(object0);
  }
