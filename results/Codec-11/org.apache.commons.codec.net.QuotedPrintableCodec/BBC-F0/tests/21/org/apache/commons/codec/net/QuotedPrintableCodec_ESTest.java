...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)10, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  ...
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("BO3)E\"1~xS3N6:[w %");
      assertEquals("BO3)E\"1~xS3N6:[w %", string0);
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("BO3)E\"1~xS3N6:[w %");
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Yh Hey$<\"_]4<M");
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = quotedPrintableCodec0.decode(byteArray0);
      assertArrayEquals(new byte[] {}, byteArray1);
  }
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("Fx\nF");
      assertEquals("Fx\nF", string0);
      assertNotNull(string0);
  }
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("e3P3;ED_2Q [");
  ...
  public void test18()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("Z-&~)=aAv", "");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("|WIT))fk{0%iWCGcM[");
      try { 
        quotedPrintableCodec0.encode("EPjFr/hgEj@e-#>r");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("$w=N5@eY[eqY35", "$w=N5@eY[eqY35");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("BO3)E\"1~xS3N6:[w %");
      try { 
        quotedPrintableCodec0.decode("7^v");
        fail("Expecting exception: Exception");
  ...
  public void test27()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48, (byte)96, (byte)61, (byte)48, (byte)48}, byteArray1);
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "Vn80/n+73|_wQ3]&qjV");
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("V!\"%a@>d!A*/");
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode(" cannot be quoted-printable encoded", "org.apache.commons.codec.net.QuotedPrintableCodec");
        fail("Expecting exception: UnsupportedEncodingException");
