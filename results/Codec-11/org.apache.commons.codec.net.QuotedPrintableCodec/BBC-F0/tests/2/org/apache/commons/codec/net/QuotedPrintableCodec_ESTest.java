...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte) (-81), (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  ...
  public void test08()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("+yhu", "UTF-8");
      assertEquals("+yhu", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("<,K~T4^SYS:S", (String) null);
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("~2460y$C\"2xYBs1TYII");
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "I;6!n`");
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("0FU?^*K=G->Rbded");
      try { 
        quotedPrintableCodec0.decode("0FU?^*K=G->Rbded", "0FU?^*K=G->Rbded");
        fail("Expecting exception: Exception");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("N[,_z+9\"d|b", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("8_'m*u0[q");
      try { 
        quotedPrintableCodec0.decode("8_'m*u0[q", "");
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode("iG0");
        fail("Expecting exception: Exception");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("E't7J~ItgG", "E't7J~ItgG");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test30()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "~2460y$C\"2xYBs1TYII");
      assertNotNull(object0);
      assertEquals("~2460y$C\"2xYBs1TYII", object0);
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("{5WM");
  ...
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("Fc`:8q<ed`<_lMU");
      assertEquals("Fc`:8q<ed`<_lMU", string0);
      assertNotNull(string0);
  }
  ...
  public void test40()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("eBARFzWH@rM");
      assertNotNull(string0);
      assertEquals("eBARFzWH@rM", string0);
  }
