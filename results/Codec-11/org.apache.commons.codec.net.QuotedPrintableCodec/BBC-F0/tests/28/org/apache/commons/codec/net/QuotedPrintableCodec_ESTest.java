...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(">Ko#SN .@j-7Ufj");
      String string0 = quotedPrintableCodec0.getDefaultCharset();
      assertEquals(">Ko#SN .@j-7Ufj", string0);
  }
  ...
  public void test04()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("n1b");
      byte[] byteArray0 = new byte[0];
  ...
  public void test05()  throws Throwable  {
      ...
      String string0 = quotedPrintableCodec0.encode("Yo?MVu*F^HTGKG3f;", "UTF-8");
      assertEquals("Yo?MVu*F^HTGKG3f;", string0);
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("H~k&;w_$");
      assertNotNull(string0);
      assertEquals("H~k&;w_$", string0);
  }
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "r)d");
  ...
  public void test15()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("*A9[>Pw+", (String) null);
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("org.apache.commons.codec.net.QuotedPrintableCodec", "$_p.+6");
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(".PoLE~Wz.+ `g-~g");
      try { 
        quotedPrintableCodec0.encode(".PoLE~Wz.+ `g-~g");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("I~D\"_;\u0004(");
        fail("Expecting exception: NullPointerException");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("UTF-8");
      try { 
        quotedPrintableCodec0.decode("\u0005{,i+=-W", "");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("_Z@UVMH<9`CR[\"_=7F?=7FA", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("6ib?^#");
      try { 
        quotedPrintableCodec0.decode("6ib?^#");
        fail("Expecting exception: Exception");
  ...
  public void test29()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("_Z@UVMH<9`CR[\"_?A");
      assertNotNull(string0);
      assertEquals("_Z@UVMH<9`CR[\"_=7F?=7FA", string0);
  }
  ...
  public void test37()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("d_veM2Ev3')4/r4");
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("U{4b;^^N7.K74B(l");
