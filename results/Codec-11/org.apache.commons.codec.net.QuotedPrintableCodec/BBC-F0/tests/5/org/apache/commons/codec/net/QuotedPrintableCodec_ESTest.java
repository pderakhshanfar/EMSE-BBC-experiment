...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte) (-53), (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  ...
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("t>_~tjmD");
      try { 
        quotedPrintableCodec0.decode("t>_~tjmD");
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Tv&|</4<iFS#Y]abJi");
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("gTyraIdsBxo='!");
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "5S>l8hy6L");
      assertEquals("5S>l8hy6L", object0);
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("z9f_1b:mYsWk^A#=", "z9f_1b:mYsWk^A#=");
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("4FR=");
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "Z<z'V");
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("gTyraIdsBxo='!");
      try { 
        quotedPrintableCodec0.decode("gTyraIdsBxo='!", " cannot be quoted-printable encoded");
        fail("Expecting exception: Exception");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("-F{LU pryIzE!SWN");
      try { 
        quotedPrintableCodec0.decode("-F{LU pryIzE!SWN", "");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test23()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode("P{$!>nJU_D5C9=f");
        fail("Expecting exception: Exception");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("HlG%\u0004viZ[`x8`");
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("S|t|.iWH(gy");
      assertEquals("S|t|.iWH(gy", string0);
      assertNotNull(string0);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)38, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test34()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("%Nr}!775fY8TQT8V5");
      Object object0 = new Object();
      try { 
  ...
  public void test36()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "$)JlR0\"pNaf Dq");
      assertEquals("$=7F)JlR0\"pNaf Dq", object0);
      assertNotNull(object0);
  }
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("7H/A;gyPh@6(_a");
      assertNotNull(string0);
  }
