...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte) (-113), (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      byte[] byteArray2 = quotedPrintableCodec0.decode(byteArray1);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)70}, byteArray1);
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("EnM\"}&", "UTF-8");
      assertEquals("EnM\"}&", string0);
  }
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "X'AQ.!|[m}z");
      assertEquals("X'=7FAQ.!|[m}z", object0);
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("rymDx\"Xw7tU,@voG1g");
      assertEquals("rymDx\"Xw7tU,@voG1g", string0);
      assertNotNull(string0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("y8KOL", (String) null);
  ...
  public void test18()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("=pi?e^", "=pi?e^");
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.decode("XO*kkn<I");
        fail("Expecting exception: Exception");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("WmZv:Xncg%riaa:%]i");
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("{xNaQCid\"");
      try { 
        quotedPrintableCodec0.encode("{xNaQCid\"", "org.apache.commons.codec.EncoderException");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test28()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("]fF");
  ...
  public void test40()  throws Throwable  {
      ...
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)56, (byte)70, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray1);
  ...
  public void test44()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("org.apache.commons.codec.binary.StringUtils", "UTF-8");
      assertNotNull(string0);
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("F=US");
        fail("Expecting exception: NullPointerException");
