...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte) (-13), (byte)0, (byte)0, (byte)0}, byteArray2);
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("\r,ruQkp$rkpp");
      assertNotNull(string0);
      assertEquals("\r,ruQkp$rkpp", string0);
  }
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("5^MUQpAYQ@Shl", "");
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("q .55+ipPoIJg");
      try { 
        quotedPrintableCodec0.encode("na:fsI");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("={o4_Sgi>dMx", "={o4_Sgi>dMx");
        fail("Expecting exception: Exception");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode(".soOYDhj/_", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.decode("", "vh2w)|N");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("m= )fA\"I03|<j");
      try { 
        quotedPrintableCodec0.decode("m= )fA\"I03|<j");
        fail("Expecting exception: Exception");
  ...
  public void test27()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)66, (byte)70, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray1);
  }
  ...
  public void test29()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode((String) null, "-R 9");
      assertNull(string0);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("1Drw`9");
  ...
  public void test42()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(" cannot be quoted-printable encoded");
      String string0 = quotedPrintableCodec0.encode("ISO-8859-1", "UTF-16");
      assertEquals("=FE=FF=00I=00S=00O=00-=008=008=005=009=00-=001", string0);
      assertNotNull(string0);
  }
  ...
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("N'_S!zyh{7");
      assertEquals("N'_S!zyh{7", string0);
      assertNotNull(string0);
  }

  @Test(timeout = 4000)
  public void test46()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("N'_S!zyh{7");
