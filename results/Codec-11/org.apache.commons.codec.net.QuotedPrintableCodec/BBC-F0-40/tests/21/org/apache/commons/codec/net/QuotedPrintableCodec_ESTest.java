...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = quotedPrintableCodec0.decode((Object) " <9=3D`>MrQ${<JppbKi");
      assertNotNull(object0);
      assertEquals(" <9=`>MrQ${<JppbKi", object0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("44?Aj|:?/1n");
      try { 
        quotedPrintableCodec0.decode("44?Aj|:?/1n");
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("FlnK`Skoy");
      assertNotNull(string0);
      assertEquals("FlnK`Skoy", string0);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("hvy?^");
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("~@NN4SquR'^n[XY-iG9", (String) null);
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.encode("5!io^!^K;x!z.");
        fail("Expecting exception: Exception");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "{()$:{ihM0;t");
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("=2%6", "=2%6");
        fail("Expecting exception: Exception");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("w*g,^.MKtKLWiK7EP");
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode((String) null, "yy|[Xkm2Y`#g5");
      assertNull(string0);
  }
  ...
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      String string0 = quotedPrintableCodec0.decode((String) null, "IgR");
      assertNull(string0);
  }
