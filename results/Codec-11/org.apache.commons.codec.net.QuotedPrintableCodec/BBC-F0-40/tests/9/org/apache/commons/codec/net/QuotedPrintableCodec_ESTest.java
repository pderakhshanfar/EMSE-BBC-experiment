...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)68, (byte)70, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48}, byteArray1);
      assertArrayEquals(new byte[] {(byte) (-33), (byte)0, (byte)0}, byteArray2);
  }
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("]Z5G(HjJ", "UTF-16");
      assertEquals("=FE=FF=00]=00Z=005=00G=00(=00H=00j=00J", string0);
  }
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("Z[<}^Fl_w83NZI]]g");
      assertEquals("Z[<}^Fl_w83NZI]]g", string0);
      assertNotNull(string0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "P,sL=TD:f!");
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("$N'f!7uuJh=9!RI%I");
      try { 
        quotedPrintableCodec0.decode("$N'f!7uuJh=9!RI%I", "KBxE");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("A?Z1tx)i(c))c#UMG");
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("Ik_z]O7p");
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.encode("", "~2*EmMvxK'_W~s5");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test28()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("ld5s='JRl$&?D3*Z");
      assertNotNull(string0);
      assertEquals("ld5s=3D'JRl$&?D3*Z", string0);
  }
  ...
  public void test40()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("H.t4[FuLH=4Q|cNjic");
      String string0 = quotedPrintableCodec0.decode((String) null, "k4sDr");
      assertNull(string0);
  }
  ...
  public void test42()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode((Object) "N=");
        fail("Expecting exception: Exception");
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "5Pj_-x`uh;~vS");
        fail("Expecting exception: NullPointerException");
