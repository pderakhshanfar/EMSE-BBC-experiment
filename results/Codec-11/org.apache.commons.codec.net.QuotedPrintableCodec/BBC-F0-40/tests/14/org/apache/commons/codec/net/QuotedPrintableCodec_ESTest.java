...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("5h&:ES.1IPE.");
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      assertNotSame(byteArray0, byteArray1);
  }
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("R\"P");
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("z^i][VN*%qg)ln", "US-ASCII");
      assertEquals("z^i][VN*%qg)ln", string0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("}OS", (String) null);
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("P]4");
      try { 
        quotedPrintableCodec0.encode("P]4");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("`!FP;Td");
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.decode("t|RxM?`AHqkW=", "");
        fail("Expecting exception: Exception");
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("%3bK`K/h", "%3bK`K/h");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "`!FP;Td");
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "79x_j");
      assertEquals("79x_j", object0);
      assertNotNull(object0);
  }
  ...
  public void test44()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("pTL5G` sU;");
      assertNotNull(string0);
      assertEquals("pTL5G` sU;", string0);
  }

  @Test(timeout = 4000)
  public void test45()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode(",w:X=EeP$Cm,L7jX}d$");
      assertEquals(",w:X\uFFFDP$Cm,L7jX}d$", string0);
      assertNotNull(string0);
  }
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "LK2h(i^x%{");
        fail("Expecting exception: NullPointerException");
