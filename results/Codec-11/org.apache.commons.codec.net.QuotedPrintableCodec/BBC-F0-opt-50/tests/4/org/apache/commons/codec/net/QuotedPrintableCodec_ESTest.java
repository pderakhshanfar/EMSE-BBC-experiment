...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)127, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  ...
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("?7@$ zF");
      try { 
        quotedPrintableCodec0.decode("?7@$ zF");
  ...
  public void test06()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("rEtDH5");
      assertNotNull(string0);
      assertEquals("rEtDH5", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "%vw[P(,0h^[F*$");
      assertEquals("%vw[P(,0h^[F*$", object0);
  ...
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("+xMw]hT|#RksO t", "ISO-8859-1");
      assertEquals("+xMw]hT|#RksO t", string0);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("org.apache.commons.codec.binary.StringUtils");
  ...
  public void test14()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("lz#2<#`]qW", "lz#2<#`]qW");
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("fj_%pK,m={9u3");
      try { 
        quotedPrintableCodec0.encode("'qg.7[V3#tC");
        fail("Expecting exception: Exception");
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("[^]w5W#':\"NQP3rt");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode(":#zkg}=&XX", ":#zkg}=&XX");
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("PXH13`Q7![W", "PXH13`Q7![W");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "IJ>YN#?JewF$%|");
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode((String) null, "g-2^v/t6 3J5-&o");
      assertNull(string0);
  }
  ...
  public void test34()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "h: kZW}&_Q<q|NpT");
      assertNotNull(object0);
      assertEquals("h: kZW}&_Q<q|NpT", object0);
  }
  ...
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.decode((String) null, "?pDw");
      assertNull(string0);
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "yji[");
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      try { 
        quotedPrintableCodec0.decode("<ORQo$=");
        fail("Expecting exception: Exception");
