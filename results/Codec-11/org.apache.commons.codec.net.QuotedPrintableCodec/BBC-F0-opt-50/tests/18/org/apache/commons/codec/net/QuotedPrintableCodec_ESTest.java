...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)51, (byte)66}, byteArray1);
  }
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("I\"&*^F", "UTF-8");
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("79|1");
      assertNotNull(string0);
      assertEquals("79|1", string0);
  }
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("=u7n-jm>(EO*", "org.apache.commons.codec.EncoderException");
        fail("Expecting exception: Exception");
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.decode("5~vt_M");
        fail("Expecting exception: Exception");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("0L.,%!Yb:");
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
      try { 
        quotedPrintableCodec0.encode("", "vzi;+be");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test46()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)57, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48}, byteArray1);
  ...
  public void test49()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode((Object) "z)$Ut8\"^s3");
        fail("Expecting exception: NullPointerException");
