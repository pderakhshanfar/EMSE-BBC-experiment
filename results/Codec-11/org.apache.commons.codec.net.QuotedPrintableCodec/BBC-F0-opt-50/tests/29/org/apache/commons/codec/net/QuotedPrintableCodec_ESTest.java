...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = quotedPrintableCodec0.decode(":Xk1=3D6.T:H)l!Db");
      assertEquals(":Xk1=6.T:H)l!Db", string0);
      assertNotNull(string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("k*t</s@.");
      try { 
        quotedPrintableCodec0.decode((Object) "k*t</s@.");
  ...
  public void test07()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("k*t</s@.");
      String string0 = quotedPrintableCodec0.encode("xBOX|q7aQUe", "ISO-8859-1");
      assertEquals("xBOX|q7aQUe", string0);
  }
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("2^l6TW|6 Sh]8=");
      assertEquals("2^l6TW|6 Sh]8=3D", string0);
      assertNotNull(string0);
  }
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("k*t</s@.", "US-ASCII");
      assertEquals("k*t</s@.", string0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode("5e");
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("CdI", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      try { 
        quotedPrintableCodec0.decode("X:&H~]^L8u`WKpDR)j=");
        fail("Expecting exception: Exception");
  ...
  public void test27()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("k*t</s@.");
      try { 
        quotedPrintableCodec0.encode("k*t</s@.");
        fail("Expecting exception: Exception");
  ...
  public void test33()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
      String string0 = quotedPrintableCodec0.encode((String) null, "!+!Ur5b\"x]*F'{HmqI");
      assertNull(string0);
  }
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("(=up6Ih", "org.apache.commons.codec.binary.StringUtils");
        fail("Expecting exception: Exception");
