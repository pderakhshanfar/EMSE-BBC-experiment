...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("_*xb8'>jct-:@Ygu");
  ...
  public void test05()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("=^]RYxaF");
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("d-@A]s*/%6w%z=/P5@");
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("8Lie]]\".!T{j865jcG,");
      assertNotNull(string0);
      assertEquals("8Lie]]\".!T{j865jcG,", string0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("<<(Gjnak{", (String) null);
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("a'b}=dsVRmod}sNYl,");
      try { 
        quotedPrintableCodec0.encode("bn5L8", "L)w[UJ.P!_");
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("='~_,u4HAc");
      try { 
        quotedPrintableCodec0.encode("='~_,u4HAc");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("=^]RYxaF");
      try { 
        quotedPrintableCodec0.decode("=^]RYxaF", "AN-l@M)Qugz");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("H]J}^B", "H]J}^B");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("='~_,u4HAc");
      try { 
        quotedPrintableCodec0.decode("n|UB`'");
        fail("Expecting exception: Exception");
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "zMifNMJtpm");
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(" tW'");
  ...
  public void test43()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte) (-119), (byte)0, (byte)0, (byte)0}, byteArray2);
  ...
  public void test46()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("j.u");
      assertEquals("j.u", string0);
      assertNotNull(string0);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("8}~6vC/!6H.Bmd0");
        fail("Expecting exception: NullPointerException");
