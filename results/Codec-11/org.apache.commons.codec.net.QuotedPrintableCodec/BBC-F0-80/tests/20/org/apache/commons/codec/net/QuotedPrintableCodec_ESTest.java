...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)52, (byte)51}, byteArray1);
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("x&md1U1Y>G");
      assertNotNull(string0);
      assertEquals("x&md1U1Y>G", string0);
  }
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("G}=@ahE&L)h");
      try { 
        quotedPrintableCodec0.encode("G}=@ahE&L)h", "W");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.encode((Object) "AGk3r=H?#");
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("Invalid quoted-printable encoding", "T_&Iz");
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("Z=R,3@(Q");
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        quotedPrintableCodec0.decode("N?u<T03oI");
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      ...
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)54, (byte)55, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray1);
  ...
  public void test40()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("G}=@ahE&L)h");
      String string0 = quotedPrintableCodec0.decode("SbfKg6N(4{*/", "UTF-8");
      assertEquals("SbfKg6N(4{*/", string0);
      assertNotNull(string0);
  }
  ...
  public void test42()  throws Throwable  {
      ...
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("G}=@ahE&L)h");
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)67}, byteArray1);
  }
  ...
  public void test46()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("f`j{Tc]#`a^f]!y=\"4", "f`j{Tc]#`a^f]!y=\"4");
        fail("Expecting exception: Exception");
