...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("hv2/s/Zh5=Hf$0A1G");
      try { 
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("`(gQtnX+4GBv<RB");
      assertNotNull(string0);
      assertEquals("`(gQtnX+4GBv<RB", string0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("{Gwf}gBZ_HO SN'", (String) null);
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        quotedPrintableCodec0.encode("I:z,B,!/+Nzj?Q4#x}");
        fail("Expecting exception: Exception");
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("2jur|:70U5@I/XjXh", "UTF-16LE");
      assertEquals("2=00j=00u=00=7F=00r=00|=00:=007=000=00U=005=00@=00I=00/=00X=00j=00X=00h=00", string0);
  }
  ...
  public void test28()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      try { 
        quotedPrintableCodec0.decode("V=.p", "V=.p");
        fail("Expecting exception: Exception");
  ...
  public void test42()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("IOegE2i;Tz");
  ...
  public void test43()  throws Throwable  {
      ...
      BitSet bitSet0 = new BitSet();
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("IZu`%*");
