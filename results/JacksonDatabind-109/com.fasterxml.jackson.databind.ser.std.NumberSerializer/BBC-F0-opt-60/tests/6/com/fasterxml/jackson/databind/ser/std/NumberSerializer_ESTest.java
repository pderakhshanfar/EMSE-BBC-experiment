...
public class NumberSerializer_ESTest extends NumberSerializer_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonGenerator jsonGenerator0 = uTF8JsonGenerator0.overrideStdFeatures((byte)109, (-1417));
  ...
  public void test01()  throws Throwable  {
      ...
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      SimpleModule simpleModule0 = new SimpleModule("6%;|-4");
      ...
      MockPrintStream mockPrintStream0 = new MockPrintStream("=VoatrQ");
      FilterOutputStream filterOutputStream0 = new FilterOutputStream(mockPrintStream0);
      byte[] byteArray0 = new byte[8];
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 591, objectReader0, filterOutputStream0, byteArray0, 2212, true);
      // Undeclared exception!
      try { 
  ...
  public void test02()  throws Throwable  {
      ...
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      Long long0 = new Long((-800));
      IOContext iOContext0 = new IOContext(bufferRecycler0, long0, false);
      ObjectMapper objectMapper0 = new ObjectMapper();
      byte[] byteArray0 = new byte[5];
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 1731, objectMapper0, (OutputStream) null, byteArray0, 0, false);
  ...
  public void test12()  throws Throwable  {
      ...
      NumberSerializer numberSerializer0 = new NumberSerializer(class0);
      Short short0 = new Short((short) (-2422));
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      ByteArrayBuilder byteArrayBuilder0 = new ByteArrayBuilder(bufferRecycler0, 1709);
      JsonGenerator jsonGenerator0 = jsonFactory0.createGenerator((OutputStream) byteArrayBuilder0);
      NumberSerializer numberSerializer0 = new NumberSerializer(class0);
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
