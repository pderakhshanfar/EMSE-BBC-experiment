...
public class NumberSerializer_ESTest extends NumberSerializer_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, (-2891), (ObjectCodec) null, filterOutputStream0, byteArray0, 1, true);
  ...
  public void test01()  throws Throwable  {
      ...
      BufferedOutputStream bufferedOutputStream0 = new BufferedOutputStream((OutputStream) null, 3320);
      MockPrintStream mockPrintStream0 = new MockPrintStream(bufferedOutputStream0, false);
      FilterOutputStream filterOutputStream0 = new FilterOutputStream(mockPrintStream0);
      byte[] byteArray0 = new byte[6];
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 1, objectMapper0, filterOutputStream0, byteArray0, (byte)71, false);
  ...
  public void test02()  throws Throwable  {
      ...
      NumberSerializer numberSerializer0 = new NumberSerializer(class0);
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("&)a{1", true);
  ...
  public void test11()  throws Throwable  {
      Class<Integer> class0 = Integer.TYPE;
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("}*WiBI|EG=-hm9", true);
      DataOutputStream dataOutputStream0 = new DataOutputStream(mockFileOutputStream0);
      ...
      NumberSerializer numberSerializer0 = new NumberSerializer(class0);
      ShortNode shortNode0 = ShortNode.valueOf((short) (-567));
  ...
  public void test12()  throws Throwable  {
      Class<Short> class0 = Short.class;
      NumberSerializer numberSerializer0 = new NumberSerializer(class0);
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("}*WiBEG=-hm9", true);
      DataOutputStream dataOutputStream0 = new DataOutputStream(mockFileOutputStream0);
      JsonFactory jsonFactory0 = new JsonFactory();
      ObjectMapper objectMapper0 = new ObjectMapper(jsonFactory0);
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProvider();
      FloatNode floatNode0 = FloatNode.valueOf(2932.7734F);
      Number number0 = floatNode0.numberValue();
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      BigInteger bigInteger0 = BigInteger.ONE;
      IOContext iOContext0 = new IOContext(bufferRecycler0, bigInteger0, false);
      byte[] byteArray0 = new byte[2];
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 3022, objectMapper0, dataOutputStream0, byteArray0, (byte) (-102), false);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      JsonFactory jsonFactory0 = new JsonFactory();
      ObjectMapper objectMapper0 = new ObjectMapper(jsonFactory0);
      File file0 = MockFile.createTempFile("vO\"ok!Dn)1%Za8i\"L1i", "com.fasterxml.jackson.databind.ser.std.NumberSerializer$1");
