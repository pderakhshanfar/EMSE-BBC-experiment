...
public class NumberSerializer_ESTest extends NumberSerializer_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      ...
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      ObjectMapper objectMapper0 = new ObjectMapper((JsonFactory) null, defaultSerializerProvider_Impl0, (DefaultDeserializationContext) null);
      ByteArrayOutputStream byteArrayOutputStream0 = new ByteArrayOutputStream(3382);
      byte[] byteArray0 = new byte[1];
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 1800, objectMapper0, byteArrayOutputStream0, byteArray0, (-304), false);
      // Undeclared exception!
      try { 
        numberSerializer0.serialize((Number) byte0, (JsonGenerator) uTF8JsonGenerator0, (SerializerProvider) defaultSerializerProvider_Impl0);
  ...
  public void test08()  throws Throwable  {
      ...
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, (-1009), objectMapper0, bufferedOutputStream0);
  ...
  public void test09()  throws Throwable  {
      NumberSerializer numberSerializer0 = NumberSerializer.instance;
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      Float float0 = new Float(1767.16F);
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      ...
      ByteArrayOutputStream byteArrayOutputStream0 = new ByteArrayOutputStream();
      byte[] byteArray0 = new byte[6];
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 207, objectMapper0, byteArrayOutputStream0, byteArray0, 0, true);
      // Undeclared exception!
  ...
  public void test11()  throws Throwable  {
      ...
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProvider();
      Double double0 = new Double((-204.28005213394));
      BufferRecycler bufferRecycler0 = new BufferRecycler();
  ...
  public void test13()  throws Throwable  {
      Class<Short> class0 = Short.class;
      NumberSerializer numberSerializer0 = new NumberSerializer(class0);
      BigDecimal bigDecimal0 = new BigDecimal((-3502.4584464463));
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, bufferRecycler0, false);
      ...
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 0, objectReader0, filterOutputStream0, byteArray0, 439, false);
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProvider();
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      Double double0 = new Double(1822.7299727663585);
      IOContext iOContext0 = new IOContext(bufferRecycler0, double0, false);
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("Hj_", false);
      byte[] byteArray0 = new byte[4];
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 1, objectMapper0, mockFileOutputStream0, byteArray0, (-2359), true);
      // Undeclared exception!
      try { 
