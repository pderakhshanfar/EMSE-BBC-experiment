...
public class NumberSerializers_ESTest extends NumberSerializers_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Short short0 = new Short((short)3898);
      JsonFactoryBuilder jsonFactoryBuilder0 = new JsonFactoryBuilder();
      JsonFactory jsonFactory0 = new JsonFactory(jsonFactoryBuilder0);
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
  ...
  public void test04()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("com.fasterxml.jackson.databind.ser.std.NumberSerializers$DoubleSerializer", "2=`V%2n5+");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 0, objectMapper0, mockPrintStream0);
      Double double0 = new Double((-5354.18630993));
      objectMapper0.writeValue((JsonGenerator) uTF8JsonGenerator0, (Object) double0);
  ...
  public void test07()  throws Throwable  {
      ...
      JsonFactoryBuilder jsonFactoryBuilder0 = new JsonFactoryBuilder();
      JsonFactory jsonFactory0 = new JsonFactory(jsonFactoryBuilder0);
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("}o;:#80", true);
  ...
  public void test09()  throws Throwable  {
      ...
      Float float0 = new Float(355.93266);
      BufferRecycler bufferRecycler0 = new BufferRecycler();
  ...
  public void test10()  throws Throwable  {
      ...
      JsonFactory jsonFactory0 = new JsonFactory();
      MockFile mockFile0 = new MockFile("F5xnb~| Tl-", " P~");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      JsonEncoding jsonEncoding0 = JsonEncoding.UTF32_BE;
      JsonGenerator jsonGenerator0 = jsonFactory0.createGenerator((OutputStream) mockPrintStream0, jsonEncoding0);
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
