...
public class FromXmlParser_ESTest extends FromXmlParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        fromXmlParser0 = new FromXmlParser((IOContext) null, (-373), (-373), objectMapper0, streamReaderDelegate0);
  ...
  public void test3()  throws Throwable  {
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, "Multiple type ids specified with ", false);
      ObjectMapper objectMapper0 = new ObjectMapper();
      StreamReaderDelegate streamReaderDelegate0 = new StreamReaderDelegate((XMLStreamReader) null);
      FromXmlParser fromXmlParser0 = null;
      try {
        fromXmlParser0 = new FromXmlParser(iOContext0, 2, 0, objectMapper0, streamReaderDelegate0);
        fail("Expecting exception: NullPointerException");
