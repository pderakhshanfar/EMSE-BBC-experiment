...
public class FromXmlParser_ESTest extends FromXmlParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      IOContext iOContext0 = new IOContext(bufferRecycler0, "g`$2uzY!", false);
      FromXmlParser fromXmlParser0 = null;
      try {
        fromXmlParser0 = new FromXmlParser(iOContext0, 3, 2, (ObjectCodec) null, (XMLStreamReader) null);
  ...
  public void test2()  throws Throwable  {
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, "D<VI1A(C)\u0007WA?k", false);
