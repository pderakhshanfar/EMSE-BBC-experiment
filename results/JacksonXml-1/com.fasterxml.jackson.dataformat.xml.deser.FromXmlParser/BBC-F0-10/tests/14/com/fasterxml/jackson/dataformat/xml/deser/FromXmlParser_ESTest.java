...
public class FromXmlParser_ESTest extends FromXmlParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        fromXmlParser0 = new FromXmlParser(iOContext0, (-2646), 2156, objectMapper0, streamReaderDelegate0);
  ...
  public void test2()  throws Throwable  {
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, "sz^X [/MF]fj", false);
      ObjectMapper objectMapper0 = new ObjectMapper();
      FromXmlParser fromXmlParser0 = null;
      try {
