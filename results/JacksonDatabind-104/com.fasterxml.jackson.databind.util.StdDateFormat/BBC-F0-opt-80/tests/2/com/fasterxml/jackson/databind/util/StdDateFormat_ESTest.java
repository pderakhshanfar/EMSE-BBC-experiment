...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601(";f2Y00b", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \";f2Y00b\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? true)
         //
  ...
  public void test01()  throws Throwable  {
      ...
      Locale locale0 = new Locale("2.2250738585072012e-308", "q`mxv ");
  ...
  public void test04()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "yyyy-MM-dd'T'HH:mm:ss.SSSZ", 0, 0, 0, 0, 0, 0, (-1), 649);
  ...
  public void test13()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1507), "EEE, dd MMM yyyy HH:mm:ss zzz");
  ...
  public void test14()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-2270), (-2270), 2, 23, 2, 104);
      ...
      assertEquals("0561-11-02T23:03:44.000+0000", stringBuffer0.toString());
  }
  ...
  public void test23()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("q`mxv ", "q`mxv ");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
  ...
  public void test24()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      TimeZone timeZone0 = TimeZone.getTimeZone("Ap]");
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("M!x8C--um>H8g!", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("x>($*m=m", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"x>($*m=m\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2524, "");
      Locale locale0 = Locale.FRENCH;
      MockDate mockDate0 = new MockDate(2524);
      // Undeclared exception!
      try { 
  ...
  public void test52()  throws Throwable  {
      ...
      stdDateFormat0.parseObject("Cannot parse date \"%s\": invalid fractional seconds '%s'; can use at most 9 digits", parsePosition0);
      try { 
  ...
  public void test55()  throws Throwable  {
      ...
      stdDateFormat0.parseObject("0/77 rH1.~ip", parsePosition0);
      assertEquals(1910, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1910,errorIndex=1910]", parsePosition0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(11);
      stdDateFormat0._parseDate("9~-[R,68J", parsePosition0);
  ...
  public void test62()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      MockDate mockDate0 = new MockDate(53, 2175, 2175);
      Locale locale0 = Locale.CANADA;
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
  ...
  public void test63()  throws Throwable  {
      ...
      Locale locale0 = Locale.JAPANESE;
      Boolean boolean0 = Boolean.TRUE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(48, "S");
      MockDate mockDate0 = new MockDate(48, 1633, (-1443), (-769), 2, 2147483645);
      StringBuffer stringBuffer0 = new StringBuffer();
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      stdDateFormat1._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("2148-02-05T02:16:05.048+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2686), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.KOREAN;
      MockDate mockDate0 = new MockDate(3074, (-3610), 2147483645, 57, 49, (-4698));
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("\u172C283-09-08T08:30:39.314-0000", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      assertEquals(1665, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1665,errorIndex=1665]", parsePosition0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse(".xmjln7BBU@>(TBcb9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \".xmjln7BBU@>(TBcb9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test76()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("ufL");
      Locale locale0 = Locale.GERMAN;
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
