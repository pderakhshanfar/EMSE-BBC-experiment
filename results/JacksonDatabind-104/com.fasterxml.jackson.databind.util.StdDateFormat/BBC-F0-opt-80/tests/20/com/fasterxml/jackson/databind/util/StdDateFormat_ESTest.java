...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("~_ M]yegEIW|kFG9):9", parsePosition0);
      assertNull(date0);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(497, "G61dW!ebK>vTfF0E");
      Locale locale0 = Locale.UK;
      Boolean boolean0 = Boolean.FALSE;
      StringBuffer stringBuffer0 = new StringBuffer();
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate(2, 110, 2);
      stdDateFormat0._format(simpleTimeZone0, (Locale) null, mockDate0, stringBuffer0);
      assertEquals("1911-03-02T00:00:00.497+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(469, "G61dW!ebK>vTfF0E");
      Locale locale0 = Locale.UK;
      Boolean boolean0 = new Boolean("G61dW!ebK>vTfF0E");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3138), "G61dW!ebK>vTfF0E");
      Locale locale0 = Locale.UK;
      Boolean boolean0 = new Boolean("G61dW!ebK>vTfF0E");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test19()  throws Throwable  {
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(48, (-1124), 3);
  ...
  public void test24()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-1374));
      ...
      try { 
        stdDateFormat0.parseAsISO8601("J.T1 6hz_C=k", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"J.T1 6hz_C=k\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test36()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(246, "");
  ...
  public void test41()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(10, "7mg1^Y>m|Y");
      Locale locale0 = new Locale("7mg1^Y>m|Y", "7mg1^Y>m|Y", "7mg1^Y>m|Y");
  ...
  public void test47()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      stdDateFormat1._parseDate("M", parsePosition0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  ...
  public void test48()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(5342);
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00-0i", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-0i\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test50()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("Thu Mar 16 12:48:00 GMT 10", date0.toString());
  }
  ...
  public void test53()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0C00 -00T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0C00 -00T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      ...
      stdDateFormat0.parse("3\"K{Vy[-C>drrx\"", parsePosition0);
      assertEquals(2120, parsePosition0.getErrorIndex());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1752), (-1892), 318, 90, (-1752));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0010-03-16T12:48:00.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(3, (-689), 1);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1845-08-01T00:00:00.000+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test61()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(64, "KADX@");
      MockDate mockDate0 = new MockDate(27, 64, 64);
      Locale locale0 = Locale.GERMAN;
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1932-07-03T00:00:00.064+00:00", string0);
      assertFalse(stdDateFormat0.isLenient());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      Locale locale0 = Locale.UK;
      Boolean boolean0 = Boolean.FALSE;
      StringBuffer stringBuffer0 = new StringBuffer("QC_B>");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, (-1651));
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate(2, 75, 2);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("QC_B>1908-04-02T00:00:00.497+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2235), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat1 = stdDateFormat0.instance.withTimeZone(simpleTimeZone0);
      MockDate mockDate0 = new MockDate((-2235), (-3473), (-1484));
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("0630-07-07T23:59:57.765-0000", string0);
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-I0-Dw");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-I0-Dw\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      ...
      simpleTimeZone0.setRawOffset(3600);
      Locale locale0 = new Locale("", "' (");
      StdDateFormat.getRFC1123Format(stdDateFormat1._timezone, locale0);
      ParsePosition parsePosition0 = new ParsePosition(7);
      stdDateFormat1.parseAsRFC1123("yyyy-MM-dd'T'HH:mm:ss.SSSZ", parsePosition0);
      stdDateFormat1.parseObject(".IQ&{i9i_&s|>", parsePosition0);
      ...
      stdDateFormat1.parseAsRFC1123(" d]c?M7 oFj|(r:v", parsePosition0);
      StdDateFormat.getISO8601Format(simpleTimeZone0, locale0);
      ...
      stdDateFormat4.instance.withColonInTimeZone(true);
      StdDateFormat.getISO8601Format(stdDateFormat1._timezone, locale0);
      StdDateFormat stdDateFormat5 = stdDateFormat3.withColonInTimeZone(false);
      assertFalse(stdDateFormat0.isLenient());
  ...
  public void test79()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(326);
      stdDateFormat0.parse("0000-00-0i0", parsePosition0);
