...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("kVU2_g", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"kVU2_g\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test03()  throws Throwable  {
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1369), "p");
  ...
  public void test05()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("z#K?!h|=<7_z-;e>$");
      ...
      stdDateFormat0.parseObject(";2", parsePosition0);
      assertEquals(125, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=125,errorIndex=125]", parsePosition0.toString());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "", 0, 0, 0, 1765, (-1), 0, (-1), 2268, 2268);
      Locale locale0 = Locale.ROOT;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, (Boolean) null, false);
      try { 
        stdDateFormat0.parse("@C[i+.ms*9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"@C[i+.ms*9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(2898);
      stdDateFormat0.parse("0000-00-Z0", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test11()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.instance.parseAsRFC1123("wG>}o", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("z#K?!h|=<7_z-;e>$");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, false);
      stdDateFormat0.looksLikeISO8601("z#K?!h|=<7_z-;e>$");
      assertFalse(stdDateFormat0.isLenient());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition((-162));
      // Undeclared exception!
      try { 
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance._parseDate("P@BgoRZHF", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test49()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-492), 60000, (-345), 2974, (-345));
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      // Undeclared exception!
      try { 
  ...
  public void test55()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(1455);
      stdDateFormat1.parse(")", parsePosition0);
      assertEquals("java.text.ParsePosition[index=1455,errorIndex=1455]", parsePosition0.toString());
      assertEquals(1455, parsePosition0.getErrorIndex());
  }
  ...
  public void test57()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      try { 
        stdDateFormat0.parse("0000-N00-00T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-N00-00T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000\"00-00T00100");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000\"00-00T00100\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, false);
      ParsePosition parsePosition0 = new ParsePosition(125);
      stdDateFormat0.parseObject("2$FP)Se2", parsePosition0);
      assertEquals(125, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=125,errorIndex=125]", parsePosition0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Locale locale0 = Locale.CANADA;
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
      boolean boolean0 = stdDateFormat0.equals("z#K?!h|=<7_z-;e>$");
      assertFalse(boolean0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-2057), 833, 833, (-2057), 833);
      String string0 = stdDateFormat0.format((Object) mockDate0);
      assertEquals("0087-06-17T20:53:00.000+0000", string0);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate(732, 2175, (-492), 48, 9);
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("2811-11-27T00:09:00.010+00:00", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(339, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      MockDate mockDate0 = new MockDate(933, 0, 0, 0, 11);
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("2832-12-31T00:11:00.339+0000", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, (-107));
  ...
  public void test68()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, true);
      try { 
        stdDateFormat0._parseDate("0000-00-Z0", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-Z0\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test73()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(32, 11, (-1270), 3772, 9);
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat1._format(zoneInfo0, locale0, mockDate0, stringBuffer0);
      assertEquals(29, stringBuffer0.length());
      assertEquals("1929-11-13T04:09:00.000+00:00", stringBuffer0.toString());
  }
