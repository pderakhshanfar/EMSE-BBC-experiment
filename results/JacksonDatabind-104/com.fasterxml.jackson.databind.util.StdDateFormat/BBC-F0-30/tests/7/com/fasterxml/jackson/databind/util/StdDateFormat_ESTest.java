...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("kU5\"r-&4Cw&`", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"kU5\"r-&4Cw&`\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
  ...
  public void test04()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(3773);
      stdDateFormat0.parse("0000o00G00", parsePosition0);
      assertEquals("java.text.ParsePosition[index=3773,errorIndex=3773]", parsePosition0.toString());
      assertEquals(3773, parsePosition0.getErrorIndex());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("F\"u!<].;tYWe9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test11()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("0092-04-21T23:05:28.057+0000");
      assertTrue(boolean0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test13()  throws Throwable  {
      Locale locale0 = new Locale("", ":*,6N-a?)F`#");
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-673), "{J{-e+Pi)\b^@T/\"/+");
      Locale locale0 = Locale.JAPANESE;
      Boolean boolean0 = new Boolean("{J{-e+Pi)\b^@T/\"/+");
  ...
  public void test16()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("PH=EMJHBA'.P)ivu");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
  ...
  public void test17()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseAsISO8601("0009-00-00", parsePosition0);
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("yyyy-MM-dd'T'HH:mm:ss.SSSZ", "m0z");
  ...
  public void test26()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.instance.parseAsISO8601("", (ParsePosition) null);
        fail("Expecting exception: ParseException");
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("~d~%)b<tX+", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("Bx|z4k] ");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"Bx|z4k]\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-n'-h0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-n'-h0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000*0T-00T00:>0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000*0T-00T00:>0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("9<lzpe]?o-vX9{Y]");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9<lzpe]?o-vX9{Y]\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      ...
      boolean boolean1 = stdDateFormat0.equals("EEE, dd MMM yyyy HH:mm:ss zzz");
      assertFalse(boolean1);
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
      assertFalse(stdDateFormat0.isLenient());
  }
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1563), (-2881), (-1563), (-2881), 1, 268);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0092-04-21T23:05:28.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test62()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1286), (-1286), (-1286));
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(185, "OD3&Po5");
      Locale locale0 = Locale.CHINESE;
      Boolean boolean0 = Boolean.valueOf("0000-00[00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("0503-04-24T00:00:00.185+00:00", string0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test63()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-20), "YV#p95y6Uv.!d!{");
      Locale locale0 = Locale.UK;
      stdDateFormat0._format(simpleTimeZone0, locale0, date0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1582-10-04T23:59:59.980-0000", stringBuffer0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(10);
      Date date0 = stdDateFormat1._parseDate("7", parsePosition0);
      ...
      assertEquals("1970-01-01T00:00:00.007+00:00", stringBuffer0.toString());
      assertEquals("1970-01-01T00:00:00.007+00:00", stringWriter0.toString());
  }
