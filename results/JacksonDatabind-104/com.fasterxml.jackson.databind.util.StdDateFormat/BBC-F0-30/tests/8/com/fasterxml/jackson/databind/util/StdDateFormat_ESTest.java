...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1336, "y:|zWC8A<");
      Locale locale0 = Locale.JAPAN;
  ...
  public void test07()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("com.fasterxml.jac~son.core.io.Num`erInput");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test08()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(19, "wTvHW] Ip");
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3618), "U");
      Locale locale0 = Locale.CANADA_FRENCH;
  ...
  public void test18()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-701), (-701), 2, 2, (-701));
  ...
  public void test23()  throws Throwable  {
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-2028), 1103, 90, 1103, 15);
  ...
  public void test24()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("yyyy-MM-dd'T'HH:mm:ss.SSSZ", "Dt.EEG3eFv'/u");
      assertFalse(boolean0);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("RIP", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getDefault();
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(3607);
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(48);
      try { 
        stdDateFormat0._parseDate("1970-01-01T00:00:36.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"1970-01-01T00:00:36.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test42()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-560), "DateFormat %s: (timezone: %s, locale: %s, lenient: %s)");
  ...
  public void test48()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Boolean boolean0 = Boolean.valueOf("} K:=mk&--;U");
  ...
  public void test51()  throws Throwable  {
      ...
      assertEquals((-1), parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=3622,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test53()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(6059);
      // Undeclared exception!
      try { 
  ...
  public void test54()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("/Ca", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"/Ca\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? true)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-751), "com.fasterxml.jackson.databind.util.StdDateFormat");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      try { 
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-)00J0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-)00J0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("4W~<x;,y~@Ao", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      try { 
        stdDateFormat0.parse("gFsRT5Tv<)GE*qv9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"gFsRT5Tv<)GE*qv9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1850), 57, 650);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0056-07-11T00:00:00.000+0000", string0);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      Instant instant0 = MockInstant.ofEpochSecond(4790L);
      Date date0 = Date.from(instant0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format(date0);
      assertEquals("1970-01-01T01:19:50.000+00:00", string0);
  }
  ...
  public void test65()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate(19, 10, (-1304), 166, 8);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1916-04-11T22:08:00.019+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test66()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-621), "");
      Locale locale0 = Locale.KOREAN;
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate();
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("2014-02-14T20:21:20.699-0000", string0);
  }
  ...
  public void test69()  throws Throwable  {
      ...
      stdDateFormat0.parse(".", parsePosition0);
      assertEquals("java.text.ParsePosition[index=1387,errorIndex=1387]", parsePosition0.toString());
      assertEquals(1387, parsePosition0.getErrorIndex());
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("6_=0%1 PHzQc52");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"6_=0%1 PHzQc52\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test76()  throws Throwable  {
      ...
      stdDateFormat1.parseAsRFC1123("m PAB#fKPD", parsePosition0);
      assertNotSame(stdDateFormat1, stdDateFormat0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  }
  ...
  public void test79()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "yyyy-MM-dd'T'HH:mm:ss.SSSZ", 0, 0, (-714), 0, 0, 0, 0, 1526);
  ...
  public void test85()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "q4RRo)]%", 0, 0, 60000, 60000, 0, 0, 60000, 60);
