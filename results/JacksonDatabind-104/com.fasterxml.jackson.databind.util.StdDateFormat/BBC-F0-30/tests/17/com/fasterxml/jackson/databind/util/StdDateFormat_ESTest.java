...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Locale locale0 = new Locale("C7f,%0@T=", "C7f,%0@T=");
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      try { 
        stdDateFormat0.instance._parseAsISO8601("C7f,%0@T=", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"C7f,%0@T=\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat1._parseAsISO8601("-T`CQ@Y3;:]", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"-T`CQ@Y3;:]\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("\"BSf#(G9");
        fail("Expecting exception: ParseException");
  ...
  public void test07()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0000-0o-0w");
        fail("Expecting exception: ParseException");
  ...
  public void test11()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("U3:]J");
      Locale locale0 = Locale.ROOT;
  ...
  public void test12()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(".^~6JBbeN0]Z>DZ#uip");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1627, "@weui5>La");
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1479), "uN");
      Locale locale0 = Locale.CANADA;
  ...
  public void test19()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("5%2");
  ...
  public void test22()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(93, "0000-00-00T00:00");
      Boolean boolean0 = Boolean.FALSE;
  ...
  public void test24()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("yyyy-MM-dd'T'HH:mm:ss.SSSZ", "5P\"QGYpz5");
  ...
  public void test25()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.MIN;
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Boolean boolean0 = new Boolean("Bg4");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123(")uM(B#fM", parsePosition0);
  ...
  public void test29()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition((-3011));
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("-Qg:,Fo3");
      Locale locale0 = new Locale("-Qg:,Fo3", "X");
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test41()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3891, "3}=!RSku_AjD1t");
      Locale locale0 = new Locale("3}=!RSku_AjD1t", "3}=!RSku_AjD1t", "2.2250738585072012e-308");
      ...
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "3}=!RSku_AjD1t");
      FieldPosition fieldPosition0 = new FieldPosition(3891);
      // Undeclared exception!
      try { 
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate(";o/r", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("sP1I2w73>.\"YT", parsePosition0);
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-H900-0>");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-H900-0>\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("7qU8!%V^>2ke");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"7qU8!%V^>2ke\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("99?~OvEI~-", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer();
      MockDate mockDate0 = new MockDate((-1797), (-1797), 57, (-2776), 2758, 57);
      FieldPosition fieldPosition0 = new FieldPosition((-2904));
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals(28, stringBuffer0.length());
      assertEquals("0048-02-02T05:58:57.000+0000", stringBuffer0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(599, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      ...
      assertEquals("2014-02-14T20:21:21.919+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      StringBuffer stringBuffer0 = new StringBuffer();
      MockDate mockDate0 = new MockDate(69, 675, (-2776), 2409, 10, 675);
      FieldPosition fieldPosition0 = new FieldPosition(90);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-455), "RL>");
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("2017-12-02T09:21:14.545-0000", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(2758, (-5534), 126, 725, 2641, (-1797));
      FieldPosition fieldPosition0 = new FieldPosition(1269);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0000-00-00T00:004197-04-07T00:31:03.000+0000", stringBuffer0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("mhQBt7Q#^h5([w");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"mhQBt7Q#^h5([w\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test72()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(84, 9, 1277, 3966, 34, (-437));
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat1._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1988-09-11T06:26:43.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test83()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("FsfT\"y");
      Locale locale0 = Locale.ITALY;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
