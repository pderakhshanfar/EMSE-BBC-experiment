...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      Locale locale0 = new Locale("4uNz>=B");
  ...
  public void test10()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("z:a(k|l_@+Y)#ru9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1, "sRGSBy)iIeK*~");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123("UTC", parsePosition0);
  ...
  public void test35()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition((-1525));
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00900T00:m0", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00900T00:m0\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test42()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.equals("DateFormat %s: (timezone: %s, locale: %s, lenient: %s)");
      assertFalse(boolean0);
  }
  ...
  public void test52()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(4608);
      try { 
  ...
  public void test53()  throws Throwable  {
      ...
      stdDateFormat0.setCalendar((Calendar) null);
      ParsePosition parsePosition0 = new ParsePosition(12);
      try { 
        stdDateFormat2.instance.parseAsISO8601("Cannot parse date \"%s\": not compatible with any of standard forms (%s)", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"Cannot parse date \"%s\": not compatible with any of standard forms (%s)\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("0000-W0900T00:m0", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("0`i>\"SLYM$~EcG");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertFalse(boolean0);
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1889), 1, (-10), (-1889), (-1008), 1222);
      StringBuffer stringBuffer0 = new StringBuffer("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      FieldPosition fieldPosition0 = new FieldPosition((-1588));
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0010-11-02T14:32:22.000+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      FieldPosition fieldPosition0 = new FieldPosition((-740));
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate();
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-887), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.forLanguageTag("y}rc]'S\"B}=t{Ww`sl");
      MockDate mockDate0 = new MockDate(117, 434, 56, (-887), 117, 668);
      StringBuffer stringBuffer0 = new StringBuffer();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      stdDateFormat1._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("2053-03-19T03:08:07.113-00:00", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      Locale locale0 = new Locale("rgRcOj9pd3", "@UZGlN_l", "@UZGlN_l");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      MockDate mockDate0 = new MockDate(16, 2532, 16, 18, 46, (-60));
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, 43);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2127-01-16T18:44:58.159-0000", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("0401-00-00");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
