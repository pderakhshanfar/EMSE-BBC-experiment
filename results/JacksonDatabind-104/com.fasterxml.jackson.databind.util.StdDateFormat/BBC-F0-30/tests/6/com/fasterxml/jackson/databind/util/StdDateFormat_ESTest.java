...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("0*c000-0000");
  ...
  public void test03()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("ICK9");
  ...
  public void test04()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-7232), "=H");
      Locale locale0 = Locale.CANADA_FRENCH;
      Instant instant0 = MockInstant.ofEpochMilli(13);
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("1948-02-01T00:00:00.000+0000");
        fail("Expecting exception: ParseException");
  ...
  public void test10()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("tPIxl+pf*m");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(302, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test13()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "F.#TfGD4,.J#S", 415, 0, 415, 1000, 0, 28, 0, 0);
      StdDateFormat stdDateFormat0 = new StdDateFormat();
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4, "HBtJ");
  ...
  public void test15()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(1733, 90, (-1), (-647), (-3695));
      StringBuffer stringBuffer0 = new StringBuffer("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: en_US, lenient: null)");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: en_US, lenient: null)3640-05-30T11:25:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0._parseDate("+00:00", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("XNyn/5V&]a'iy{O}", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-318), "EEE, dd MMM yyyy HH:mm:ss zzz");
  ...
  public void test40()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(4);
      try { 
        stdDateFormat0._parseAsISO8601("TSM`}>Qnz$%Bv", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"TSM`}>Qnz$%Bv\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test48()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(212, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, (Locale) null, boolean0, false);
  ...
  public void test49()  throws Throwable  {
      ...
      stdDateFormat0.parseObject("/mTIo[#d)/l", parsePosition0);
  ...
  public void test51()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-539));
      try { 
  ...
  public void test53()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("/PZ", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"/PZ\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "F.#TfGD4,.J#S", 415, 0, 415, 1000, 0, 3, 0, 0);
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      ParsePosition parsePosition0 = new ParsePosition(0);
  ...
  public void test55()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=257,errorIndex=257]", parsePosition0.toString());
      assertEquals(257, parsePosition0.getErrorIndex());
  }
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("5.zz1L=|");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"5.zz1L=|\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.equals("HBtJ");
      assertFalse(boolean0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test59()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "', '", 0, 0, 2, 2998, 0, 0, 2, 0, 13, 0, 48);
      ...
      fieldPosition0.setBeginIndex(48);
      Locale locale1 = Locale.ENGLISH;
      MockSimpleDateFormat mockSimpleDateFormat0 = (MockSimpleDateFormat)StdDateFormat.getISO8601Format(simpleTimeZone0, locale1);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ", mockSimpleDateFormat0.toLocalizedPattern());
      
      String string1 = stdDateFormat0.toString();
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=', ',offset=0,dstSavings=48,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=2,startTime=2998,startTimeMode=0,endMode=1,endMonth=0,endDay=2,endDayOfWeek=0,endTime=13,endTimeMode=0], locale: en_US, lenient: true)", string1);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1781), (-1781), 1);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0031-08-01T00:00:00.000+0000", string0);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, (Locale) null, boolean0, false);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(3175, 9, 9);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("5075-10-09T00:00:00.004+00:00", string0);
  }
  ...
  public void test62()  throws Throwable  {
      ...
      Object object0 = stdDateFormat0.parseObject("00", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("4Bm9!oy=zH%v0x[m");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4Bm9!oy=zH%v0x[m\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test66()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parse("0000-07-00", (ParsePosition) null);
      // Undeclared exception!
      try { 
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(108, 108, (-1370));
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("2013-04-01T00:00:00.000+00:00", string0);
  }
  ...
  public void test75()  throws Throwable  {
      ...
      Date date0 = stdDateFormat1.instance.parseAsISO8601("0000-00-00", parsePosition0);
  ...
  public void test81()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1139), "6iP.c=ce\"C");
  ...
  public void test84()  throws Throwable  {
      ...
      stdDateFormat0.instance.parse("Timestmp value %s out of 64-bit valuerange", parsePosition0);
