...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("0000-00-20", parsePosition0);
  ...
  public void test01()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("3006-00-00");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3724), "F#i");
      ...
      try { 
        stdDateFormat0._parseAsISO8601("-Bx(U-PAYAKi", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"-Bx(U-PAYAKi\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("q6");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"q6\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      Locale locale0 = new Locale("$Lzd&/U4o#", "yyyy-MM-dd");
  ...
  public void test11()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.looksLikeISO8601("F)+>zqnrdmiiHaJq,c$");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123("k&7bF==", parsePosition0);
  ...
  public void test34()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(5695);
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(5760);
      try { 
  ...
  public void test36()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-83), "2.2250738585072012e-308");
  ...
  public void test45()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals((String) null, "?EEdn<Zh");
  ...
  public void test46()  throws Throwable  {
      ...
      stdDateFormat1.parse("}96l.X6sxaUi|:", parsePosition0);
  ...
  public void test47()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      try { 
        stdDateFormat0.parse(";|O0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \";|O0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test48()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(90);
      stdDateFormat0.parseObject("93m0wiY", parsePosition0);
      stdDateFormat0._parseDate("yyyy-MM-dd'T'HH:mm:ss.SSSZ", parsePosition0);
  ...
  public void test50()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("r6UBTc", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"r6UBTc\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test51()  throws Throwable  {
      Locale locale0 = new Locale("$Lzd&/U4o#", "$Lzd&/U4o#");
  ...
  public void test52()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-o|-00T0:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-o|-00T0:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("7Y[e@pi$9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test58()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3811), "");
      Locale locale0 = Locale.ITALIAN;
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-2059), 2473, 55, 214, 3837);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0047-04-07T13:57:00.000+0000", string0);
  }
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-305), "f(WF<\"o");
      Locale locale0 = Locale.PRC;
      MockDate mockDate0 = new MockDate(48, 27, 48, 2459, 1338, 1000);
      ...
      assertEquals("1950-08-29T09:34:39.695-00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1837, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.GERMANY;
      MockDate mockDate0 = new MockDate(1837, 1837, 1837, 2436, (-1985), (-576));
      StringBuffer stringBuffer0 = new StringBuffer(2436);
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("3895-05-22T02:45:25.837+0000", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-592), "dddd[-]dd[-]dd");
  ...
  public void test79()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("[one of: '");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      SimpleTimeZone simpleTimeZone1 = new SimpleTimeZone((-83), "2.2250738585072012e-308");
  ...
  public void test85()  throws Throwable  {
      ...
      stdDateFormat0.parse("1597-09-29T00:00:00.000+0000", parsePosition0);
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("java.text.ParsePosition[index=1403,errorIndex=-1]", parsePosition0.toString());
  }
}
