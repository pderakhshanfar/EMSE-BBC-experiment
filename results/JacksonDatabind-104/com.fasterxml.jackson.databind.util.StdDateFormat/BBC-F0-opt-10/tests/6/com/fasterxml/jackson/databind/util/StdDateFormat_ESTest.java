...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("000000q-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"000000q-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("9?(I+;9", (ParsePosition) null);
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-2162), (-2162), 4421);
      StringBuffer stringBuffer0 = new StringBuffer();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-7), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.forLanguageTag("=T=,zEa");
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("0432-12-07T23:59:59.993-0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-2289));
      stdDateFormat0.parse("0000-00-8HAV00T00:00", parsePosition0);
  ...
  public void test10()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("J_S{=VANAVMwO%d");
  ...
  public void test14()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("=r.W");
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2, "yyyy-MM-dd'T'HH:mm:ss.SSSZ", 4, 2, 4, 2, 2, 2, 4, 2);
  ...
  public void test19()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("=r.W", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test26()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-4022));
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("CXy_7]1", parsePosition0);
  ...
  public void test27()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2486), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test35()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      FieldPosition fieldPosition0 = new FieldPosition(1848);
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00-8HAV00T00:00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-8HAV00T00:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("!)V1=)K1*w[#GBJ2YJ", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseAsISO8601("lM_/yt9]|um(,dcDb=", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(2109);
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(69, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test48()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2261), "y1a");
      Locale locale0 = Locale.ROOT;
      Boolean boolean0 = Boolean.valueOf("oFjv(:F-U/$Q'");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, false);
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("CXy_7]1", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test49()  throws Throwable  {
      ...
      stdDateFormat1.parse("1?a):K|/:8s~\"-'2", parsePosition0);
      assertEquals("java.text.ParsePosition[index=69,errorIndex=69]", parsePosition0.toString());
      assertEquals(69, parsePosition0.getErrorIndex());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        stdDateFormat0.parseAsISO8601("4ih`&bjW", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4ih`&bjW\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getDefault();
      Boolean boolean0 = Boolean.valueOf("SqaMn6Rvs`Hs{K=");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-a00-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-a00-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("oH&@k&|$)L;TCA", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.equals("0000-00-8HAV00T00:00");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertFalse(boolean0);
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-2206), 4429, (-2206), 4429, 4429);
      String string0 = stdDateFormat0.format((Object) mockDate0);
      assertEquals("0057-07-22T14:49:00.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test61()  throws Throwable  {
      MockDate mockDate0 = new MockDate(17, 97, (-1000));
      StringBuffer stringBuffer0 = new StringBuffer();
      ...
      assertEquals("1922-05-07T00:00:00.000+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test62()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-3516), 864, 864);
      StringBuffer stringBuffer0 = new StringBuffer();
      ...
      assertEquals("1543-05-12T23:59:57.739-0000", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0n00!00-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0n00!00-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test67()  throws Throwable  {
      ...
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1969-12-31T23:59:57.425+00:00", stringBuffer0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1291, ">m*f");
