...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      stdDateFormat0.parse("0000-00-77");
  }
  ...
  public void test08()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1258, "");
  ...
  public void test09()  throws Throwable  {
      Locale locale0 = Locale.forLanguageTag("Fm<=D.bkQu3|6&");
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(788);
      stdDateFormat0.parseAsRFC1123("3,Hsc@,~2x&#o6UTd+", parsePosition0);
      assertEquals("java.text.ParsePosition[index=788,errorIndex=788]", parsePosition0.toString());
      assertEquals(788, parsePosition0.getErrorIndex());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      stdDateFormat0.parseAsISO8601("0073-00-00", parsePosition0);
  }
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1956), "yyyy-MM-dd");
      Locale locale0 = Locale.FRANCE;
  ...
  public void test23()  throws Throwable  {
      Locale locale0 = new Locale("ezaXljT['_");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("?.V&U{^7", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("{ 4:oC", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(4);
      try { 
        stdDateFormat0._parseAsISO8601("[r*O5,", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"[r*O5,\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      ...
      String string0 = "#@y:zz %A]E4DK";
      try { 
        stdDateFormat0.parse("#@y:zz %A]E4DK");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"#@y:zz %A]E4DK\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test53()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      ParsePosition parsePosition0 = new ParsePosition((-4366));
      // Undeclared exception!
      try { 
  ...
  public void test57()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      try { 
        stdDateFormat0.parse("0000$u0-0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000$u0-0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("6s7v't(");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"6s7v't(\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Boolean boolean0 = Boolean.valueOf("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: en_US, lenient: null)");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
  ...
  public void test63()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1883), 43, 61, (-3839), 48);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "Value \"");
      ...
      assertEquals("Value \"0020-04-23T01:48:00.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1258, "");
      Locale locale0 = Locale.ROOT;
      MockDate mockDate0 = new MockDate(1258, 1000, 1258, 1000, 2038);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "Value \"");
      ...
      assertEquals("Value \"3244-11-21T01:58:01.258+00:00", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer(1258);
      stdDateFormat0._format(simpleTimeZone0, locale0, date0, stringBuffer0);
      assertEquals("2014-02-14T20:21:22.578+0000", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1956));
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1956), "yyyy-MM-dd");
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1969-12-31T23:59:56.088-0000", string0);
      assertFalse(stdDateFormat0.isLenient());
  }
  ...
  public void test75()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      TimeZone timeZone0 = TimeZone.getTimeZone("ntVMw$3dJ");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(timeZone0);
      try { 
        stdDateFormat1.parse("yUr1}Tc");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"yUr1}Tc\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test78()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "AXm#brD:<qa-<5k)");
      Locale locale0 = new Locale("", "AXm#brD:<qa-<5k)");
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      Boolean boolean1 = Boolean.valueOf("#uEu#L%");
