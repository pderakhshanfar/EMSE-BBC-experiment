...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("7000-00-00", parsePosition0);
      assertNotNull(date0);
      assertEquals("java.text.ParsePosition[index=1996,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("}b=Mod50IwAV;:kn", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"}b=Mod50IwAV;:kn\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Locale locale0 = Locale.CHINA;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      stdDateFormat0._parseDate("5V,N69", parsePosition0);
  ...
  public void test09()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(58, "~nT-Ay-XTcq2pGBH`");
  ...
  public void test29()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-4158));
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("Oo]1$S");
      Locale locale0 = Locale.PRC;
  ...
  public void test37()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("3875-06-13T22:33:06.000+1800", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"3875-06-13T22:33:06.000+1800\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test45()  throws Throwable  {
      ...
      stdDateFormat0.instance.parseObject("I8~K9TJ`!{^Ugfh(", parsePosition0);
  ...
  public void test50()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseObject("1Xb[p/k$\"_/Z9#mAE");
        fail("Expecting exception: ParseException");
  ...
  public void test52()  throws Throwable  {
      ...
      stdDateFormat2.setNumberFormat((NumberFormat) null);
  ...
  public void test53()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("7Wz4-G'}");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"7Wz4-G'}\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      StringBuffer stringBuffer0 = new StringBuffer("[,drqc");
      MockDate mockDate0 = new MockDate((-3155), 17, (-3155), (-3155), 57, (-1587));
      ...
      assertEquals("[,drqc1264-05-31T13:30:33.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test60()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      MockDate mockDate0 = new MockDate((-2207), (-2207), 46800000, 1, 2, 6);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("\u00AF643-02-16T07:02:06.000-1800", string0);
  }

  @Test(timeout = 4000)
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1756), (-1756), (-1756), (-1756), (-3556), 2487);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0009-08-25T09:25:27.000+0000", string0);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      try { 
        stdDateFormat0.parse("}F=W@VY");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"}F=W@VY\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test65()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Boolean boolean0 = Boolean.TRUE;
      MockDate mockDate0 = new MockDate(45, 2, 45, 38, 16, 15);
      StringBuffer stringBuffer0 = new StringBuffer();
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      ...
      assertEquals("1945-04-16T08:16:15.000+18:00", stringBuffer0.toString());
  }
  ...
  public void test75()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag("0000-00-00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      TimeZone timeZone1 = TimeZone.getTimeZone("com.fasterxml.jackson.databind.util.StdDateFormat");
  ...
  public void test80()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(9, "Z}%WNhs/Iqx.{;P8>h");
  ...
  public void test85()  throws Throwable  {
      ...
      stdDateFormat0.parse("0009-08-25T09:25:27.000+0000", parsePosition0);
      assertTrue(stdDateFormat0.isLenient());
  }
