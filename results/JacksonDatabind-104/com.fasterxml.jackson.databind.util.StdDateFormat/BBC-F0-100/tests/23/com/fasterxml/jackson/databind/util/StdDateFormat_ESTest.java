...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.parse("3100-00-30");
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("X@byNdaxyKa/BGk_@g", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"X@byNdaxyKa/BGk_@g\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("`p8&Dl:-a!%{Qg9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"`p8&Dl:-a!%{Qg9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(57, 57, 4);
      StringWriter stringWriter0 = new StringWriter(4);
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1961-10-04T00:00:00.000+0000", stringBuffer0.toString());
      assertEquals("1961-10-04T00:00:00.000+0000", stringWriter0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("Wed Oct 30 01:10:00 GMT 743", date0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean((String) null);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition((-3364));
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(5999);
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("1931-06-07T05:29:00.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"1931-06-07T05:29:00.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("00,0!-0", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test49()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("Tue Aug 28 01:40:00 GMT 64", date0.toString());
  }
  ...
  public void test52()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      Boolean boolean1 = new Boolean("7[n]A^2i),}oqJ}.0V");
  ...
  public void test56()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("0S00-00-0X", parsePosition0);
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-u00-0!");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-u00-0!\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      try { 
        stdDateFormat0.parse("1{..dWVA5+wneg");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"1{..dWVA5+wneg\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(5999);
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1692), (-1692), (-855), 0, 100);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0064-08-28T01:40:00.000+0000", string0);
  }
  ...
  public void test68()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3364), "2.2250738585072012e-308");
      Locale locale0 = Locale.FRANCE;
      MockDate mockDate0 = new MockDate((-3087), 100, (-1692), 58, 100);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("1185-09-13T11:39:56.636-00:00", string0);
  }

  @Test(timeout = 4000)
  public void test69()  throws Throwable  {
      MockDate mockDate0 = new MockDate(4, 9, 151, 9, 4);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1562, "\"l-wjA<Mn+|H>");
      Locale locale0 = Locale.CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1905-02-28T09:04:01.562+0000", string0);
  }
  ...
  public void test70()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("64", parsePosition0);
      assertNotNull(date0);
  ...
  public void test77()  throws Throwable  {
      ...
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = new Boolean((String) null);
      SimpleTimeZone simpleTimeZone1 = new SimpleTimeZone((-3364), "2.2250738585072012e-308");
  ...
  public void test80()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("zrANs&Wuovt$GgmW");
      Locale locale0 = Locale.ROOT;
