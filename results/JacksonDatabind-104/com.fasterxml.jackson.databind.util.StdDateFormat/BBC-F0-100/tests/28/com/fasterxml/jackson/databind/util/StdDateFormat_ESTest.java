...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("HHj#[2oygcG_'w_", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"HHj#[2oygcG_'w_\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
         //
  ...
  public void test14()  throws Throwable  {
      ...
      stdDateFormat0.parse("0042-03-11T05:05:00.000+0000", parsePosition0);
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "Bp(-?h*rQkmv^");
  ...
  public void test29()  throws Throwable  {
      ...
      boolean boolean1 = StdDateFormat._equals((Object) boolean0, object0);
  ...
  public void test51()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Locale locale0 = new Locale("TE.G<rl_G/", "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(850, 27, 850, 9, 850, (-965));
      Date date0 = mockGregorianCalendar0.getGregorianChange();
  ...
  public void test56()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-6), "0000-00-04");
  ...
  public void test57()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat1.parse("nmst 1F *k@#mV9>", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test59()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(505);
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Locale locale0 = Locale.JAPANESE;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      stdDateFormat1._parseDate("TE.G<rl_G/", parsePosition0);
      assertEquals(505, parsePosition0.getErrorIndex());
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  }
  ...
  public void test60()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0S00-00-00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0S00-00-00\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-@0-0000:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-@0-0000:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(27);
      stdDateFormat0._parseDate("4~1?oVZ", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(27);
      stdDateFormat0._parseDate("TE.G<rl_G/", parsePosition0);
      stdDateFormat0.isLenient();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-10), "");
      String string0 = "0000-00-00";
      simpleTimeZone0.setID("0000-00-00");
      DateFormat.getDateTimeInstance();
      simpleTimeZone0.clone();
      Calendar calendar0 = stdDateFormat0._getCalendar(simpleTimeZone0);
      //  // Unstable assertion: assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=1392409281320,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=java.util.SimpleTimeZone[id=0000-00-00,offset=-10,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2014,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=45,DAY_OF_WEEK=6,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=8,HOUR_OF_DAY=20,MINUTE=21,SECOND=21,MILLISECOND=256,ZONE_OFFSET=-64,DST_OFFSET=0]", calendar0.toString());
  ...
  public void test69()  throws Throwable  {
      ...
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("2014-02-14T20:21:21.256-00:00", stringBuffer0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      ...
      assertEquals("2.2250738585072012e-3081582-10-15T00:00:00.003+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test71()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1787), (-1787), (-1787), 5, 5);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0042-03-11T05:05:00.000+0000", string0);
      assertTrue(stdDateFormat0.isLenient());
  }
  ...
  public void test74()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0KV9 Au9AkB/[1");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0KV9 Au9AkB/[1\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test86()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1027), "A}@7_HDO{\"!>,rBML");
