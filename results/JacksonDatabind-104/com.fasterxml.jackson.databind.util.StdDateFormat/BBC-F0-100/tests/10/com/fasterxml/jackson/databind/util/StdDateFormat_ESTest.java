...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      stdDateFormat0.parse("0000-90-02");
  ...
  public void test04()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("x~WjkpX5lrKORspg");
      ...
      try { 
        stdDateFormat0.parseAsISO8601("x~WjkpX5lrKORspg", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"x~WjkpX5lrKORspg\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      TimeZone timeZone0 = TimeZone.getTimeZone("3Zp-:!C-DBZi");
  ...
  public void test08()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("2.225073858507201e-308");
  ...
  public void test10()  throws Throwable  {
      Locale locale0 = Locale.forLanguageTag("strict");
  ...
  public void test12()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("{O{6-E\"g;,", parsePosition0);
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3705, "dddd[-]dd[-]dd[T]dd[:]dd(?:[:]dd)?(.d+)?(Z|[+-]dd(?:[:]?dd)?)?");
  ...
  public void test22()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(2, (-3144), (-858), (-858), 2, 2);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      FieldPosition fieldPosition0 = new FieldPosition((-3144));
  ...
  public void test28()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("", "?HK+P-");
      assertFalse(boolean0);
  }
  ...
  public void test44()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(2335);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0B00-0y-00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0B00-0y-00\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test50()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Locale locale0 = Locale.PRC;
      MockDate mockDate0 = new MockDate(4, 4, 4, 1, (-2420), 18);
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("0B00-0y-00", parsePosition0);
       //  fail("Expecting exception: NullPointerException");
       // Unstable assertion
      } catch(NullPointerException e) {
         //
  ...
  public void test57()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-6759));
      try { 
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0B00-Vy-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0B00-Vy-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0%:7'[Guy/;}bVzRS\"");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0%:7'[Guy/;}bVzRS\"\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("6?~s_/!<!IY0f@9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"6?~s_/!<!IY0f@9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1940), 58, (-1348), (-1940), (-1000), (-1348));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0041-12-01T10:57:32.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(2147483645, (-1097), (-1393), 46, (-1179), (-1348));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("\uE912253-09-26T11:41:58.464+0000", string0);
      assertTrue(stdDateFormat0.isLenient());
  }
  ...
  public void test68()  throws Throwable  {
      ...
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1970-01-01T00:00:00.052+0000", string0);
  }
  ...
  public void test71()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate((-2649), (-1449), (-1449), 1020, 3175, 2);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0875-05-26T16:55:02.000+00:00", string0);
  }
  ...
  public void test73()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = new StdDateFormat(timeZone0, locale0, boolean1, false);
      int int0 = 9;
  ...
  public void test84()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "0000-00-00T00:00", 18, 0, (-1890), 3659, 3659, 0, (-1890), 18);
      Locale locale0 = Locale.CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertNotNull(timeZone0);
  ...
  public void test90()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-979), "};c");
      Locale locale0 = new Locale("};c", "0000-00-00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      MockDate mockDate0 = new MockDate((-979));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1969-12-31T23:59:58.042-0000", string0);
      assertTrue(stdDateFormat0.isLenient());
  }
}
