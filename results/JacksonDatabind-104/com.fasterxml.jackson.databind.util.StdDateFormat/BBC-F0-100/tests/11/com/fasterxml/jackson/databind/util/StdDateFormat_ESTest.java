...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("0000-00-09", (ParsePosition) null);
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("!^r/N;.v", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"!^r/N;.v\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("8G'3!O$?\"*");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"8G'3!O$?\"*\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      ...
      stdDateFormat0.parse("!wOzK1%l0$G]wGp9", parsePosition0);
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals("1970-01-01T00:00:00.285+0000", stringBuffer0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("?;,HM", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test20()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(13, "R\">a`6L_$.q");
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-515), "0000-00-00");
  ...
  public void test22()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "Zk X^f&]J#");
  ...
  public void test24()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("Dr0Ob\"mH>fvs5n0el=;", parsePosition0);
  ...
  public void test29()  throws Throwable  {
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = Boolean.valueOf("@q.MZ(rl!'LZGR=1");
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("9!-B", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test43()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(1061);
      try { 
        stdDateFormat0._parseDate("0226-06-02T20:13:29.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"0226-06-02T20:13:29.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test51()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(12, 11, (-1960), (-528), 586, 10);
      Locale locale0 = new Locale("yyyy-MM-dd'T'HH:mm:ss.SSSZ", "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StringBuffer stringBuffer0 = new StringBuffer("#CbVt&3zR");
      // Undeclared exception!
      try { 
  ...
  public void test57()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(timeZone0);
      stdDateFormat1.parseObject("G", parsePosition0);
  ...
  public void test58()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0.parseObject(".T{C8", parsePosition0);
  ...
  public void test59()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("{2W5r:3S{e", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"{2W5r:3S{e\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000--#03T}j:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000--#03T}j:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      ...
      stdDateFormat0.parse("434\"|,k/`U$KO#5", parsePosition0);
      assertEquals(104, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=104,errorIndex=104]", parsePosition0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      boolean boolean1 = stdDateFormat0.equals(".T{C8");
      assertFalse(boolean1);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1960), 10, 125, (-528), 1090, (-528));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0060-02-11T18:01:12.000+0000", string0);
  }
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate((-1960), (-528), (-528), (-528), 1722, 10);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("0107-06-30T04:42:10.000+00:00", string0);
      assertTrue(stdDateFormat1.isLenient());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      assertEquals("2014-02-15T08:21:21.320+12:00", string0);
  }
  ...
  public void test72()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      try { 
        stdDateFormat0.parse("q!e7rgzGj");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"q!e7rgzGj\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test74()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(2554);
      Date date0 = stdDateFormat0._parseAsISO8601("8000-00-00", parsePosition0);
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test78()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null);
      TimeZone timeZone1 = TimeZone.getTimeZone("ZfR8S\u0002u(dd|0");
  ...
  public void test81()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate();
      StringBuffer stringBuffer0 = new StringBuffer(1557);
  ...
  public void test83()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("0070000");
  ...
  public void test84()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0._parseDate("0000-40-00", (ParsePosition) null);
