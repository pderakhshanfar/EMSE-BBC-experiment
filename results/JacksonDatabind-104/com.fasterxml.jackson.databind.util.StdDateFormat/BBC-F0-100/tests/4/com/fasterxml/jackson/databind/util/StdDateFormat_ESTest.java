...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Locale locale0 = Locale.forLanguageTag("yIs_`_dZ'dT");
      Boolean boolean0 = new Boolean("yIs_`_dZ'dT");
      ...
      try { 
        stdDateFormat0.parseAsISO8601("LDb$AI8U", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"LDb$AI8U\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test03()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("m1^{AWh{&h");
      ...
      try { 
        stdDateFormat0.parseAsISO8601("m1^{AWh{&h", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"m1^{AWh{&h\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test04()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("15 6('Lt`");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"15 6('Lt`\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("N`mvUzG");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"N`mvUzG\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      Locale locale0 = new Locale("Uu-(d6$nw+a|!Iy}^^F", "F03U");
  ...
  public void test11()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("CU]taXBb9*u");
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(270);
      stdDateFormat0.parseAsRFC1123("CU]taXBb9*u", parsePosition0);
      assertEquals("java.text.ParsePosition[index=270,errorIndex=270]", parsePosition0.toString());
      assertEquals(270, parsePosition0.getErrorIndex());
  }
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(516, "0000-00-00T00:00");
  ...
  public void test21()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("uot9@r|Rrq!(Fe ~!$", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test22()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-3640));
  ...
  public void test26()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("HC5r2ybQC 6YVpju3", "2.2250738585072012e-308");
  ...
  public void test27()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Boolean boolean0 = new Boolean(")U'c;X=>!_~Ibdi");
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("2014-02-14T20:21:21.320+0000", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      Locale locale0 = new Locale("yIs_`_dZ'dT");
  ...
  public void test40()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds(593);
  ...
  public void test45()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-314));
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      MockDate mockDate0 = new MockDate(3608, 30, 10);
  ...
  public void test51()  throws Throwable  {
      Locale locale0 = Locale.forLanguageTag("yIs_`_dZ'dT");
      Boolean boolean0 = Boolean.valueOf("yIs_`_dZ'dT");
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
  ...
  public void test53()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("m1^{AWh{&h");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null, boolean0);
      Boolean boolean1 = new Boolean("m1^{AWh{&h");
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("4K?V<A4{lRvo{y3,=;");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4K?V<A4{lRvo{y3,=;\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-2023), 1308, (-2023), (-2023), (-2023), 1308);
      // Undeclared exception!
      try { 
  ...
  public void test65()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null, boolean0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(10, 0, 1189);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat1._format(timeZone0, (Locale) null, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1913-04-03T00:00:00.000+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3952), "z,jgF{xkQ*2hMfw-(");
      Locale locale0 = Locale.US;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(2620, (-1665), (-3952));
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "z,jgF{xkQ*2hMfw-(");
      stdDateFormat1._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals(47, stringBuffer0.length());
      assertEquals("z,jgF{xkQ*2hMfw-(4370-06-04T23:59:56.048-00:00", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      assertEquals("z,jgF{xkQ*2hMfw-(4370-06-04T23:59:56.048-0000", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(4028, 4028, (-43), 4028, 2915, 28);
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, 4028);
      // Undeclared exception!
      try { 
  ...
  public void test72()  throws Throwable  {
      Locale locale0 = Locale.KOREAN;
      Boolean boolean0 = new Boolean("PW`H%jg");
