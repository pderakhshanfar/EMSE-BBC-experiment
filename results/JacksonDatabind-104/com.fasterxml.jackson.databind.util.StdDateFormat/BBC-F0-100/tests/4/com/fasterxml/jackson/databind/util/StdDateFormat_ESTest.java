...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0005-02-00");
  ...
  public void test03()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-378), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test06()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag("B%J!6d.");
  ...
  public void test07()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("g>@T9");
        fail("Expecting exception: ParseException");
  ...
  public void test12()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("`k/s^)!k4xsW");
  ...
  public void test13()  throws Throwable  {
      ...
      stdDateFormat1.parseAsISO8601("0000-00-00", parsePosition1);
      assertTrue(stdDateFormat1.isColonIncludedInTimeZone());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("c{fY");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(7, "SKZNos/x ");
      Locale locale0 = Locale.forLanguageTag("SKZNos/x ");
      Boolean boolean0 = Boolean.valueOf("SKZNos/x ");
  ...
  public void test20()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-349), "7I+ty;~qJZ'/-DN4d+c");
  ...
  public void test21()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-479), (-479), 1, 1, (-479));
  ...
  public void test25()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-2997));
  ...
  public void test45()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("{'_U2Zca^");
      Locale locale0 = new Locale("{'_U2Zca^");
  ...
  public void test51()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      MockDate mockDate0 = new MockDate((-305), (-1), 6359);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      // Undeclared exception!
      try { 
  ...
  public void test56()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("c9B");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"c9B\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      try { 
        stdDateFormat1.parse("#F_Te9F(");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"#F_Te9F(\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-3235));
      try { 
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("4Z<4 (~s&V),N");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4Z<4 (~s&V),N\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1698), (-2055), 265);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.JAPANESE;
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0031-06-22T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      StdDateFormat stdDateFormat2 = stdDateFormat1.clone();
      MockDate mockDate0 = new MockDate(641, 43, 57);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(641, "lenient");
      stdDateFormat2._format(simpleTimeZone0, (Locale) null, mockDate0, stringBuffer0);
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Locale locale0 = Locale.ENGLISH;
      MockDate mockDate0 = new MockDate(57, 496, 496);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-879), ":4vQdQ");
  ...
  public void test75()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("25xFA&yrQ");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"25xFA&yrQ\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test84()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("+0+t0:00");
      Locale locale0 = Locale.JAPANESE;
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
  ...
  public void test91()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0.parse("4000-00-04");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
