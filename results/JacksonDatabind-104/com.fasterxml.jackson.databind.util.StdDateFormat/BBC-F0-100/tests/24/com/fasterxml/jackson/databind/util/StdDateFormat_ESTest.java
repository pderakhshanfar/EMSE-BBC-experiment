...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("@z5o~~*QFO)u~", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"@z5o~~*QFO)u~\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("j7;?/$9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"j7;?/$9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      ...
      stdDateFormat0.parse("0000-03t0-0T00:00", parsePosition0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("xz@X('");
  ...
  public void test16()  throws Throwable  {
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(18, ")i]");
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1527), "0000-00-00T00:00");
  ...
  public void test20()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-1793));
  ...
  public void test26()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("DateFormat %s: (timezone: %s, locale: %s, lenient: %s)", "\" can not be represented as BigDecimal");
      assertFalse(boolean0);
  }
  ...
  public void test27()  throws Throwable  {
      Locale locale0 = Locale.CANADA_FRENCH;
      Boolean boolean0 = Boolean.valueOf("@z5o~~*QFO)u~");
  ...
  public void test38()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(551);
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("AkQYC|`o_LK^l", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test45()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = Locale.JAPAN;
      Boolean boolean0 = new Boolean("VK");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, false);
  ...
  public void test47()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer(3004);
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-4958));
  ...
  public void test54()  throws Throwable  {
      Locale locale0 = new Locale("8\"Y<LWHU~]i}", "8\"Y<LWHU~]i}");
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0, true);
  ...
  public void test56()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-1527));
      try { 
        stdDateFormat0.parseAsISO8601("jJ3", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"jJ3\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.looksLikeISO8601("7ql7#w'zRsAH#");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test60()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("4cZibdtZq#.K5#F", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test65()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-1527));
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition(3851);
  ...
  public void test66()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(340, "0000-00-00T00:00");
      Locale locale0 = Locale.JAPAN;
      Boolean boolean0 = Boolean.valueOf("0000-00-00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:21.660+00:00", string0);
  ...
  public void test69()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-n0-0T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-n0-0T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test70()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1527), "0000-00-00T00:00");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      Boolean boolean0 = new Boolean("L@Refg1;S\"6s");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition((-1527));
      MockDate mockDate0 = new MockDate((-1964), 301, 985, (-1527), 1384);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals(28, stringBuffer0.length());
      assertEquals("0038-08-11T08:03:58.473-0000", stringBuffer0.toString());
  }
  ...
  public void test82()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1165, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      // Undeclared exception!
      try { 
  ...
  public void test86()  throws Throwable  {
      ...
      stdDateFormat0.parseObject("0000-00-06", parsePosition0);
  }
  ...
  public void test88()  throws Throwable  {
      ...
      stdDateFormat1.instance.parse("M{8;xHEQZ{<hpb!R", parsePosition0);
      ParsePosition parsePosition1 = new ParsePosition(43);
      StdDateFormat stdDateFormat2 = StdDateFormat.instance;
      DateFormat.getInstance();
      ParsePosition parsePosition2 = new ParsePosition(43);
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsISO8601("", parsePosition2);
        fail("Expecting exception: StringIndexOutOfBoundsException");
