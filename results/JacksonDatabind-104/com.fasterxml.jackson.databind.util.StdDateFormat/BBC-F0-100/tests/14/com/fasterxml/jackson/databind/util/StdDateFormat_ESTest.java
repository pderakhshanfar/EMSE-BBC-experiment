...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601(";cm", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \";cm\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? true)
         //
  ...
  public void test16()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("6dje,xE:#WIT5");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test18()  throws Throwable  {
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(2, 10, 1249);
      Integer integer0 = new Integer(10);
      boolean boolean0 = StdDateFormat._equals((Object) mockGregorianCalendar0, (Object) integer0);
      assertFalse(boolean0);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition((-4111));
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00Aa-00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00Aa-00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test38()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=3901,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=null,firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=1970,MONTH=0,WEEK_OF_YEAR=1,WEEK_OF_MONTH=1,DAY_OF_MONTH=1,DAY_OF_YEAR=1,DAY_OF_WEEK=5,DAY_OF_WEEK_IN_MONTH=1,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=3,MILLISECOND=901,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(45, 45, 45, (-850), (-531), 791);
      ...
      int int0 = 3901;
      TimeZone timeZone0 = TimeZone.getDefault();
      MockDate mockDate1 = new MockDate(3901);
      stdDateFormat1.instance._format(timeZone0, (Locale) null, mockDate1, stringBuffer0);
      boolean boolean0 = true;
      stdDateFormat0.instance.setLenient(boolean0);
      ParsePosition parsePosition0 = new ParsePosition(int0);
      try { 
        stdDateFormat1.parseAsISO8601(stdDateFormat0.DATE_FORMAT_STR_ISO8601, parsePosition0);
        fail("Expecting exception: ParseException");
  ...
  public void test46()  throws Throwable  {
      ...
      stdDateFormat1._parseDate("MmE=M\"=(7X=/S", parsePosition0);
      assertNotSame(stdDateFormat1, stdDateFormat0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      Object object0 = stdDateFormat0.parseObject("yyyy-MM-dd'T'HH:mm:ss.SSSZ", parsePosition0);
      assertNull(object0);
  }
  ...
  public void test50()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-E0Aa-\u0000");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-E0Aa-\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test51()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("0000-00-0.0T00:00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null);
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("f4P$n:j$8iSsp-");
        fail("Expecting exception: NullPointerException");
  ...
  public void test56()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      MockDate mockDate0 = new MockDate(60000, 57, 77, 60000, (-4846));
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "");
      stdDateFormat1._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("m911-10-17T15:14:00.000+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(11, "AX-'wMdH*");
      Locale locale0 = Locale.ITALIAN;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(60000, 57, 77, 60000, (-4846));
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "");
      stdDateFormat1._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("m911-10-17T15:14:00.011+00:00", stringBuffer0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      Locale locale0 = Locale.ITALIAN;
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1742), (-1742), (-1742), 60000, 4503);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0014-12-01T03:02:58.258-0000", stringBuffer0.toString());
  }
  ...
  public void test59()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("2172-09-19T14:07:24.000+0000", string0);
  }
  ...
  public void test60()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = Locale.PRC;
      Boolean boolean0 = Boolean.valueOf("a=NWL3A");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      MockDate mockDate0 = new MockDate(0, 3270, 11, 1694, 0, 444);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "0000-00-00");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0000-00-002172-09-19T14:07:24.000+0000", stringBuffer0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000+00=0P");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000+00=0P\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test64()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("+el^F+)dZ)u='+");
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = Boolean.valueOf("mnL");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test69()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
      stdDateFormat1.parse("0800-00-00");
      assertFalse(stdDateFormat1.isLenient());
  }

  @Test(timeout = 4000)
  public void test70()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1757), "D*5F&l^L19x0%pB");
  ...
  public void test75()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3102, "0000-00-00");
  ...
  public void test81()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null, boolean0);
      ParsePosition parsePosition0 = new ParsePosition((-6161));
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("000-0-00T00:00", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test82()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("0000-00Aa-00");
        fail("Expecting exception: ParseException");
