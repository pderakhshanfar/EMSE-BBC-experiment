...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("R=l3kK=#yK9+Ez}", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"R=l3kK=#yK9+Ez}\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("kdzrK/'", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1072), "h}WwvvbDGVbrq");
  ...
  public void test26()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("yyyy-MM-dd'T'HH:mm:ss.SSSZ", ")B0ZP*}&V@}tP*pFx");
  ...
  public void test29()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-3652));
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3581), "h}WwvZvbDGVbrq");
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("h}WwvZvbDGVbrq", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test58()  throws Throwable  {
      ...
      stdDateFormat0.parse("4bS,X^~EwVXp&Vb;[*-", parsePosition0);
      assertEquals("java.text.ParsePosition[index=1226,errorIndex=1226]", parsePosition0.toString());
      assertEquals(1226, parsePosition0.getErrorIndex());
  }

  @Test(timeout = 4000)
  public void test59()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1072), "h}WwvZvbDGVbrq");
      Locale locale0 = Locale.US;
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1788), (-1788), (-1788));
  ...
  public void test64()  throws Throwable  {
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1916-04-15T00:00:00.000+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(60000, "qJ,NT1E(qth06/`n{");
      Locale locale0 = new Locale("&", "ZqDbH~C");
      MockDate mockDate0 = new MockDate();
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2014-02-14T20:22:21.320+0001", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate((-1072), (-1072), (-1072));
      ...
      assertEquals("0735-09-23T23:59:58.928-00:00", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000 4$-0aT00s00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000 4$-0aT00s00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test87()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.instance.parse("0000-20-00", parsePosition0);
      assertNotNull(date0);
