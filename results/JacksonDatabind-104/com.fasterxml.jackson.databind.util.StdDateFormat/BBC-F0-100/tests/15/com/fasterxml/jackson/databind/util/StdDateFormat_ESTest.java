...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsISO8601("0000-00-10", parsePosition0);
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("3L{'HgO&,=y", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"3L{'HgO&,=y\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
  ...
  public void test07()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0I00-00&00", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertNull(date0);
  ...
  public void test09()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("3{f:PN");
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "Q_jr=U`N%ahN!70ayQ{");
      Locale locale0 = Locale.forLanguageTag("Q_jr=U`N%ahN!70ayQ{");
      Boolean boolean0 = new Boolean(true);
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1651), "JA");
  ...
  public void test19()  throws Throwable  {
      ...
      assertNotNull(date0);
      assertEquals("java.text.ParsePosition[index=1717,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("JA", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test28()  throws Throwable  {
      ...
      int int0 = 1904;
      ParsePosition parsePosition0 = new ParsePosition(1904);
      stdDateFormat0.parseAsISO8601("0000-00-10", parsePosition0);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("+b0&;(0##9", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test35()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StringBuffer stringBuffer0 = new StringBuffer(">[o@z7*6L|NI_");
      FieldPosition fieldPosition0 = new FieldPosition((-822));
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-932));
      try { 
        stdDateFormat0._parseDate("2014-02-14T20:21:20.388-0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"2014-02-14T20:21:20.388-0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      ...
      stdDateFormat0.parse("a#lBIQf_N>Ru|", parsePosition0);
      assertEquals("java.text.ParsePosition[index=1470,errorIndex=1470]", parsePosition0.toString());
      assertEquals(1470, parsePosition0.getErrorIndex());
  }
  ...
  public void test50()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-189));
      try { 
        stdDateFormat0._parseAsISO8601("?rs\"`47", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"?rs\"`47\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      try { 
        stdDateFormat0.parse("6D3%@,_WWj*Va:t");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"6D3%@,_WWj*Va:t\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1980), 65, 48, 65, (-3404));
      // Undeclared exception!
      try { 
  ...
  public void test59()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1865), (-2018), (-1865));
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      ...
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("0140-09-22T00:00:00.000+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test60()  throws Throwable  {
      MockDate mockDate0 = new MockDate();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1724), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.JAPAN;
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:19.596-00:00", string0);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(1717);
      stdDateFormat0.parse("?rs\"`47", parsePosition0);
      assertEquals(1717, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1717,errorIndex=1717]", parsePosition0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(12, 12, 12, 12, 1, (-1));
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1913-01-12T12:00:59.000+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test67()  throws Throwable  {
      Locale locale0 = new Locale("{twwuJk#4x");
  ...
  public void test74()  throws Throwable  {
      ...
      stdDateFormat2.parseAsRFC1123("VYClIqD@^.AVgD{", parsePosition0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  ...
  public void test75()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "Value \"", 3, 3, 3, 3, (-2742), 3, 3, 3, 3, (-2791), 3);
  ...
  public void test79()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "yyyy-MM-dd'T'HH:mm:ss.SSSZ", 4, 0, 0, (-932), 45, 0, 90, 4, 1470);
      Locale locale0 = Locale.ITALIAN;
  ...
  public void test83()  throws Throwable  {
      ...
      stdDateFormat0.parse("0000-00-09", parsePosition0);
