...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("M2e{GfBxLEM,Tw#q2pV");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null, boolean0, false);
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        stdDateFormat0.parseAsISO8601("wrQwr`", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"wrQwr`\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test05()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("]H&Hlc>9kP<|R1#j@A9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0.parseAsRFC1123("[Cns%ci)7i_", parsePosition0);
  ...
  public void test11()  throws Throwable  {
      ...
      stdDateFormat0.parseAsISO8601("2000-00-00", parsePosition0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("Japan");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      stdDateFormat0.looksLikeISO8601("o(amsUDa]");
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(467, "Timestamp value %s out of 64-bit value range");
      Locale locale0 = Locale.US;
  ...
  public void test17()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(164, (-2020), 111);
      ...
      assertEquals("\" can not be represented as BigDecimal1895-12-20T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Locale locale0 = new Locale("/*jmD+", "/*jmD+", "/*jmD+");
  ...
  public void test20()  throws Throwable  {
      Locale locale0 = Locale.KOREAN;
      Boolean boolean0 = Boolean.valueOf("M2e{GfBxLEM,Tw#q2pV");
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1176), "M2e{GfBxLEM,Tw#q2pV");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      Calendar calendar0 = stdDateFormat0._getCalendar(simpleTimeZone0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=1392409281320,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=java.util.SimpleTimeZone[id=M2e{GfBxLEM,Tw#q2pV,offset=-1176,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2014,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=45,DAY_OF_WEEK=6,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=8,HOUR_OF_DAY=20,MINUTE=21,SECOND=21,MILLISECOND=320,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar1 = new MockGregorianCalendar(2, 3, 3, 118, 3);
      boolean boolean0 = StdDateFormat._equals((Calendar) mockGregorianCalendar0, (Calendar) mockGregorianCalendar1);
      assertFalse(boolean0);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123("~]ns=G_tq5%2?c", parsePosition0);
  ...
  public void test40()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("~jWA{#4Q W@:c^[2 h");
      Boolean boolean0 = Boolean.TRUE;
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("~jWA{#4Q W@:c^[2 h", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      ...
      Locale locale0 = new Locale("/*jmD+", "/*jmD+", "/*jmD+");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, (Boolean) null, true);
      Boolean boolean0 = new Boolean("*p\"c_1w~E");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
  ...
  public void test52()  throws Throwable  {
      ...
      stdDateFormat1.parse("0hj00-0-00T00:00", parsePosition0);
  ...
  public void test53()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(timeZone0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat1._parseDate("Cannot parse date \"%s\": not compatible with any of standard forms (%s)", parsePosition0);
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0Z00-;0-00T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0Z00-;0-00T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("7KX*=1`VeoD!Po", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test62()  throws Throwable  {
      ...
      Locale locale0 = new Locale("/*jmD+", "/*jmD+", "/*jmD+");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, (Boolean) null, true);
      MockDate mockDate0 = new MockDate((-1902), 45, (-1902));
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(zoneInfo0, locale0, mockDate0, stringBuffer0);
      assertEquals("0005-07-16T00:00:00.000+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test63()  throws Throwable  {
      Locale locale0 = Locale.CHINA;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2744), "<mhd}C");
      Boolean boolean0 = new Boolean("E");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate(4433, 54, 45);
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ6337-08-13T23:59:57.256-00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      Locale locale0 = Locale.CHINA;
      MockDate mockDate0 = new MockDate(48, (-2744), 3);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, ", ");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1719-05-03T00:00:00.003+0000", string0);
  }
  ...
  public void test66()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=1839,errorIndex=1839]", parsePosition0.toString());
      assertEquals(1839, parsePosition0.getErrorIndex());
  }
  ...
  public void test69()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Boolean boolean0 = Boolean.valueOf("M2e{GfBxLEM,Tw#q2pV");
      Locale locale0 = new Locale("M2e{GfBxLEM,Tw#q2pV");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      assertFalse(stdDateFormat0.isLenient());
  ...
  public void test82()  throws Throwable  {
      Locale locale0 = new Locale("D~9", "2.2250738585072012e-308", "[one of: '");
  ...
  public void test84()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3016), "yyyy-MM-dd");
  ...
  public void test87()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(9);
      Date date0 = stdDateFormat0.parse("0000-00-06", parsePosition0);
      assertNotNull(date0);
      assertEquals((-1), parsePosition0.getErrorIndex());
  }
}
