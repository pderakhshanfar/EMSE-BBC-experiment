...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("R2)>S\"N:wuwkyj>QE");
  ...
  public void test07()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.GERMANY;
      Boolean boolean0 = Boolean.valueOf("q@igB\"7$y/)b=QIF9'");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(1);
      stdDateFormat0._parseDate("hA[x8rcX9zB9", parsePosition0);
      assertFalse(stdDateFormat0.isLenient());
  }
  ...
  public void test14()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("e4pZQ?yg^");
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-144), "0000");
  ...
  public void test22()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(6643);
  ...
  public void test35()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.GERMANY;
      Boolean boolean0 = Boolean.valueOf("GQVGq\"q6H0");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
  ...
  public void test41()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00-@E", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-@E\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test44()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(":m!_7i)/Y(N");
  ...
  public void test51()  throws Throwable  {
      ...
      Locale locale0 = Locale.US;
      DateFormat dateFormat0 = StdDateFormat.getRFC1123Format(simpleTimeZone0, locale0);
  ...
  public void test52()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=2214,errorIndex=2214]", parsePosition0.toString());
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  }
  ...
  public void test54()  throws Throwable  {
      Locale locale0 = Locale.GERMANY;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-955), "Value \"");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(17);
      try { 
        stdDateFormat0.parseAsISO8601("@(td]7:t", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"@(td]7:t\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-)0-@E");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-)0-@E\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("q@igB\"7$y/)b=QIF9'");
      Boolean boolean0 = Boolean.valueOf("q@igB\"7$y/)b=QIF9'");
      Locale locale0 = Locale.FRANCE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(11);
      stdDateFormat0.parse("9o]4!S\"s{27G:A/H4", parsePosition0);
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0.instance.parse("1cG.XtYexiTSb.v", parsePosition0);
  ...
  public void test63()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1676), (-1676), 11);
      ...
      assertEquals("0084-05-11T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer(3903);
      ...
      assertEquals("1970-01-01T00:00:00.015+00:00", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("1970-01-01T18:00:00.223+1800", stringBuffer0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer(34);
      FieldPosition fieldPosition0 = new FieldPosition((-955));
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("1969-12-31T23:59:58.824-0000", stringBuffer0.toString());
  }
  ...
  public void test72()  throws Throwable  {
      ...
      Date date1 = stdDateFormat0.parse("0000-00-20");
