...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseAsISO8601("0000-07-00", parsePosition0);
  ...
  public void test03()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("ValueY/");
      Locale locale0 = Locale.FRENCH;
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      try { 
        stdDateFormat0.parseAsISO8601("H;KR5+CNoB~JVsL}-o", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"H;KR5+CNoB~JVsL}-o\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("Ok6$^Iiyq_*vM9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"Ok6$^Iiyq_*vM9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-1321), (-1321), 119);
      StringBuffer stringBuffer0 = new StringBuffer("ey@ ig[^k8");
      stdDateFormat0._format(zoneInfo0, locale0, mockDate0, stringBuffer0);
      assertEquals("ey@ ig[^k80469-03-29T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("&}(;}gu:-6R~1&~g\"[J", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      stdDateFormat0.looksLikeISO8601("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: zh_TW, lenient: true)");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2918), "]inaQ#0 ");
  ...
  public void test24()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-2217), 3320, 56, 18, (-2088));
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0042-10-25T07:12:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test26()  throws Throwable  {
      Locale locale0 = Locale.ROOT;
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0);
      ParsePosition parsePosition0 = new ParsePosition(4171);
  ...
  public void test30()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("0000-00-00", "");
  ...
  public void test42()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition((-2488));
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      MockDate mockDate0 = new MockDate(0, 0, 467);
      // Undeclared exception!
      try { 
  ...
  public void test52()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-1373));
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
  ...
  public void test55()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.instance.parseObject("jI?=]G.N\"!");
        fail("Expecting exception: ParseException");
  ...
  public void test56()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("~6#VQvT=_|", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"~6#VQvT=_|\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("8$<DD#6X\"0_");
        fail("Expecting exception: ParseException");
  ...
  public void test65()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate();
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:22.773+0000", string0);
  }
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-Ha-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-Ha-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test69()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0001,00-00?T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0001,00-00?T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test73()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-17), "2.2250738585072012e-308");
      Locale locale0 = Locale.JAPANESE;
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      stdDateFormat0.setTimeZone(simpleTimeZone0);
  ...
  public void test83()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("#TZB_^mX");
      // Undeclared exception!
      try { 
