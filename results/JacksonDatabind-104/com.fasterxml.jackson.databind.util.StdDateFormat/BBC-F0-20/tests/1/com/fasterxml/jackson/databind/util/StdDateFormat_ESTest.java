...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("}:ZOfh.p", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"}:ZOfh.p\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.instance.parse("Value \"");
        fail("Expecting exception: ParseException");
  ...
  public void test06()  throws Throwable  {
      ...
      Locale locale0 = Locale.JAPAN;
      MockDate mockDate0 = new MockDate((-2452L));
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1969-12-31T23:59:57.548+0000", stringBuffer0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("03", parsePosition0);
      assertNotNull(date0);
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4, "V$J_aOY", 4, 4, 4, 4, 4, 4, 4, 1345);
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2898), "");
  ...
  public void test19()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("0000-0-00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
  ...
  public void test39()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(3515);
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("00%0-00-00T00:00", parsePosition0);
        fail("Expecting exception: ParseException");
  ...
  public void test52()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-796), ":#t{;q!NYU@m>8s");
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      Boolean boolean0 = new Boolean("*QW\"]J6%]KE");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition((-796));
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate(":#t{;q!NYU@m>8s", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test53()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("6;O0+VJ@XrB L+{U");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"6;O0+VJ@XrB L+{U\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.instance._parseDate("8s'[x&*=Zgfx6)T9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test63()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1920), 2069, (-1920), (-6), 57, 57);
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.KOREAN;
      Boolean boolean0 = Boolean.valueOf("0000-0-00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ...
      assertFalse(stdDateFormat0.isLenient());
      assertEquals("0147-02-26T18:57:57.000+00:00", string0);
  }
  ...
  public void test64()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-796), ":#t{;q!NYU@m>8s");
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      MockDate mockDate0 = new MockDate((-796));
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      Boolean boolean0 = new Boolean("*QW\"]J6%]KE");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, (FieldPosition) null);
      assertEquals("1969-12-31T23:59:58.408-00:00", stringBuffer0.toString());
      assertEquals("1969-12-31T23:59:58.408-00:00", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test65()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(6, "dddd[-]dd[-]dd");
      Locale locale0 = Locale.GERMAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, (Boolean) null);
      MockDate mockDate0 = new MockDate();
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:21.326+0000", string0);
  }

  @Test(timeout = 4000)
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1920), 1229, 715, (-1211), 207, (-1920));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0084-03-25T15:55:00.000+0000", string0);
  }
  ...
  public void test76()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-789), "+0000");
      Locale locale0 = Locale.KOREA;
