...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=1106,errorIndex=1106]", parsePosition0.toString());
      assertEquals(1106, parsePosition0.getErrorIndex());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("KF*U9t4boa}&}9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"KF*U9t4boa}&}9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals("1969-12-31T23:59:59.013+0000", stringBuffer0.toString());
      assertEquals("1969-12-31T23:59:59.013+0000", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("DBX}");
  ...
  public void test12()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("QUi9hj`NA~j(:I*Mw;", "zL;ne5&fLozJ|A\"", "QUi9hj`NA~j(:I*Mw;");
  ...
  public void test15()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("J;OF-Sr >PUdz4!Tr&_");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test18()  throws Throwable  {
      ...
      Locale locale0 = Locale.ITALIAN;
      Boolean boolean0 = Boolean.valueOf("$ZxT9Esa!d2L");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertFalse(stdDateFormat0.isLenient());
  ...
  public void test22()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("$ZxT9Esa!d2L", parsePosition0);
  ...
  public void test31()  throws Throwable  {
      ...
      Locale locale0 = new Locale("", "QUi9hj`NA~j(:I*Mw;", "");
  ...
  public void test42()  throws Throwable  {
      ...
      Locale locale0 = Locale.KOREA;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-196));
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("/GI:)0YbQ%B4X`PF&{", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test44()  throws Throwable  {
      ...
      Locale locale0 = Locale.KOREA;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(4849);
      try { 
        stdDateFormat0._parseAsISO8601("])s}$vz", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"])s}$vz\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-3644));
      // Undeclared exception!
      try { 
  ...
  public void test54()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("5E|Z#)U", parsePosition0);
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-}3-09m");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-}3-09m\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("00B0)03-0m");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00B0)03-0m\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      ...
      stdDateFormat0.parse("5lsPJuWcy", parsePosition0);
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1962), 48, 45);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0059-02-14T00:00:00.000+0000", string0);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "0000-00-00T00:00");
      stdDateFormat0.setTimeZone(simpleTimeZone0);
      MockDate mockDate0 = new MockDate(9, 87, 3);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1916-04-03T00:00:00.003+00:00", string0);
  }
  ...
  public void test65()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, (-1489));
      MockDate mockDate0 = new MockDate(25, 2147483645, 45);
      StringBuffer stringBuffer0 = new StringBuffer("-");
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("-\uBB3E895-07-14T06:00:00.000-1800", stringBuffer0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, 616);
      MockDate mockDate0 = new MockDate((-4003), 889, 3018);
      StringBuffer stringBuffer0 = new StringBuffer("}ZXE'NK;e6*)");
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("}ZXE'NK;e6*)2022-05-07T00:00:00.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test80()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("#iy^<Wl*N:.6");
      // Undeclared exception!
      try { 
