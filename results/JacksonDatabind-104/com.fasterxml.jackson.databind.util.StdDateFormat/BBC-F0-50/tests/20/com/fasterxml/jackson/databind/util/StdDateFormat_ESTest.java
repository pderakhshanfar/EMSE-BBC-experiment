...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat1._parseAsISO8601("]0$Zmu", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"]0$Zmu\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test06()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("jv_R8oW,9", parsePosition0);
      assertNull(date0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1107, "kvDKOO+)");
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(1107);
      stdDateFormat0.parse("1970-01-01T00:00:02.214+00:00", parsePosition0);
      assertEquals((-1), parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1107,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "U>5I<P;", 3, 3, 3, 4, 3, 4, 4, 3);
  ...
  public void test19()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer("UOt nwQ]S7'*?");
      ...
      assertEquals("UOt nwQ]S7'*?2014-02-14T20:21:21.320+0000", stringBuffer0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = new Locale("", "B?oTEzZ J");
  ...
  public void test22()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-4946));
  ...
  public void test23()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("l}gv6ke:8S");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition((-1975));
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("[ne Lf: '", parsePosition0);
  ...
  public void test30()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = new Locale("", "9?zzZ J");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("Lbf-yzR,[bQoX-b");
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("`2kpbf2K4(?");
      Locale locale0 = Locale.CANADA;
      Boolean boolean0 = Boolean.valueOf("`2kpbf2K4(?");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00-A0T0:00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-A0T0:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate(" m?S", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test54()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0);
      ParsePosition parsePosition0 = new ParsePosition(60000);
      stdDateFormat0.parse("N+XHn[Y", parsePosition0);
      assertEquals(60000, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=60000,errorIndex=60000]", parsePosition0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-904), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
  ...
  public void test58()  throws Throwable  {
      ...
      stdDateFormat0.parse("2*O.FmQ[3?r?fmW!h", parsePosition0);
  ...
  public void test61()  throws Throwable  {
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      Boolean boolean0 = new Boolean(false);
      MockDate mockDate0 = new MockDate((-1995), 1600, 1107, (-2833), 14, 1107);
      StringBuffer stringBuffer0 = new StringBuffer();
      TimeZone timeZone0 = TimeZone.getDefault();
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("0041-01-12T23:32:27.000+0000", stringBuffer0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      TimeZone timeZone0 = TimeZone.getDefault();
      MockDate mockDate0 = new MockDate(0, 0, (-1139));
      StringBuffer stringBuffer0 = new StringBuffer("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat1._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1896-11-17T00:00:00.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(1107);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1970-01-01T00:00:02.214+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1336), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.ITALIAN;
      ...
      assertEquals("1582-10-04T23:59:58.664-0000", stringBuffer0.toString());
      assertEquals("1582-10-04T23:59:58.664-0000", stringWriter0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000*00-A00T0:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000*00-A00T0:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      ...
      stdDateFormat0.toString();
      StdDateFormat stdDateFormat1 = new StdDateFormat(zoneInfo0, locale0, boolean0, false);
      ...
      MockDate mockDate0 = new MockDate(23, 34, 34);
      NumberFormat numberFormat0 = NumberFormat.getPercentInstance(locale0);
      StringBuffer stringBuffer0 = new StringBuffer(34);
      FieldPosition fieldPosition0 = new FieldPosition(23);
      StringBuffer stringBuffer1 = numberFormat0.format(9223372036854775807L, stringBuffer0, fieldPosition0);
      stdDateFormat2.instance._format(zoneInfo0, locale0, mockDate0, stringBuffer1);
      stdDateFormat0._clearFormats();
      boolean boolean2 = stdDateFormat3.isColonIncludedInTimeZone();
  ...
  public void test70()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(1107);
      parsePosition0.setIndex(1107);
      stdDateFormat0.instance.parseObject("kvDKOO+)", parsePosition0);
  ...
  public void test74()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-296), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test83()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("'$:{8swJ=S>", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test85()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "vSVA)X");
      Locale locale0 = Locale.ITALIAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertNotNull(timeZone0);
