...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0._parseDate("=0BNi@w", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(3411, 2, 2);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1883), ":n");
      ...
      assertEquals("5311-03-01T23:59:58.117-0000", string0);
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("5J/3+d%(y9au-R#");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"5J/3+d%(y9au-R#\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test67()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(45, "0000-00-00T00:00");
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      Instant instant0 = MockInstant.ofEpochSecond((-1860L));
      Date date0 = Date.from(instant0);
      String string0 = stdDateFormat0.format(date0);
      assertEquals("1969-12-31T23:29:00.045+00:00", string0);
  }
  ...
  public void test68()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("Z _T2W*sDbS");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
