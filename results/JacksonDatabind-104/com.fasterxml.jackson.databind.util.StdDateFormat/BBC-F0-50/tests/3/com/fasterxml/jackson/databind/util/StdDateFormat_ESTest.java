...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(48, 48, 48, 181, 48, 48);
      Boolean boolean0 = new Boolean("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      stdDateFormat0.format((Date) mockDate0);
      Locale locale1 = Locale.ROOT;
      Locale.forLanguageTag("l@v|k");
      StdDateFormat.getISO8601Format(zoneInfo0, locale1);
      stdDateFormat0.toPattern();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(timeZone0);
      stdDateFormat1._clearFormats();
      try { 
        stdDateFormat0.parseAsISO8601("9BwZh~1Y((g}x", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9BwZh~1Y((g}x\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
  ...
  public void test03()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Boolean boolean0 = Boolean.valueOf("lR");
  ...
  public void test06()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("$N?\"\"{mEs", parsePosition0);
  ...
  public void test08()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.parse("0010-02-05T20:28:00.000+0000", (ParsePosition) null);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("{RtJo^!jYLjV");
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-195), "<6CDO]0HwJI7}e|f");
  ...
  public void test15()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate(1429, (-30), 1429, 1, 90, (-507));
  ...
  public void test19()  throws Throwable  {
      ...
      boolean boolean0 = StdDateFormat._equals((Object) mockDateFormat0, (Object) mockDateFormat0);
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("EKxh60hw;vyAZ  jHY", "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("_9#[|5dG;W^[m4", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0041-08-21T14:40:00.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"0041-08-21T14:40:00.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test37()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1, "", 2, 2, 2, 2, 1, 2, 1, 1, 1);
      Locale locale0 = Locale.US;
  ...
  public void test40()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-2013));
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      stdDateFormat0._getCalendar(timeZone0);
      MockDate mockDate0 = new MockDate((-1892), 27, 27, (-1892), (-1892));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0010-02-05T20:28:00.000+0000", string0);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("J!N", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"J!N\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-LF00-00T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-LF00-00T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseObject("9#^#f$&N>+qm`j4B", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test59()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("lR");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null, boolean0, true);
      MockDate mockDate0 = new MockDate((-3457), (-3457), (-505), (-1678), (-1678), 84);
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stdDateFormat0._format(timeZone0, (Locale) null, mockDate0, stringBuffer0);
      assertEquals(29, stringBuffer0.length());
      assertEquals("1848-05-02T22:03:24.000+00:00", stringWriter0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      ...
      Locale locale0 = Locale.US;
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-2980));
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.parse("0600-04-00");
  }
  ...
  public void test65()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      Date date0 = stdDateFormat0.parse("293");
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("6-`0$Qek56");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"6-`0$Qek56\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test79()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"UTC\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: en_US, lenient: false)", string0);
  }
