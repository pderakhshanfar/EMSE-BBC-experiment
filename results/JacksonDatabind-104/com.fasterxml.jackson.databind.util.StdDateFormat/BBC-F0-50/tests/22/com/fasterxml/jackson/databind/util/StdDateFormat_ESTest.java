...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("9000-00-08");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("r J&L3&r\nK-}9", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test07()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("2G\"");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(5, "+lj'+K3d1Q;jZ#", 5, 5, 5, 5, 5, 5, 5, 5, 2090, 1515, 2090);
  ...
  public void test21()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("m5jvaE");
      Locale locale0 = Locale.GERMANY;
      Boolean boolean0 = Boolean.valueOf("m5jvaE");
  ...
  public void test25()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("o{Ttb$?FKPDI");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("7ofoO_", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test27()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(773, "4+O#QZ.nblS");
      Boolean boolean0 = Boolean.TRUE;
  ...
  public void test28()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone("0+00:00");
  ...
  public void test31()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CHINESE;
      Boolean boolean0 = new Boolean("saW+Z,5s$eh}");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("saW+Z,5s$eh}", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0._parseAsISO8601("zA>9L$R4^E]uJ", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"zA>9L$R4^E]uJ\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test46()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("0000-00-00T00:00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      Boolean boolean1 = new Boolean("&L-%2_R_By_L((");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean1);
      assertSame(stdDateFormat1, stdDateFormat0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  }
  ...
  public void test47()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(45, "516GUlev2'~heean");
      boolean boolean0 = StdDateFormat._equals((Object) null, (Object) simpleTimeZone0);
      assertFalse(boolean0);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("o`*Ke", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"o`*Ke\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test51()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("1\"c2%{`N");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"1\"c2%{`N\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test52()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("751M^3G#ln;", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test57()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1986), 1485, 1485, (-2109), 1907, 4745);
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
  ...
  public void test58()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2601), "V");
      Locale locale0 = Locale.forLanguageTag("sF4o.XTLJ,*0RM");
      ...
      FieldPosition fieldPosition0 = new FieldPosition(357);
  ...
  public void test59()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(84, 1, 106);
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1984-05-16T00:00:00.045+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test60()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1243, "2.2250738585072012e-308");
      Locale locale0 = Locale.CHINA;
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      Instant instant0 = MockInstant.ofEpochMilli(1243);
      Date date0 = Date.from(instant0);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, 1243);
      stdDateFormat0.format(date0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1970-01-01T00:00:02.486+00:00", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate((-2601));
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition(357);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("1969-12-31T23:59:54.798-00:00", stringBuffer0.toString());
  ...
  public void test71()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat1._parseDate(".Rl0U?i7T~&ZUf..", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
