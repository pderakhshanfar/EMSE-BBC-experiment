...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("4000,-00-:0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4000,-00-:0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("i|9");
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      try { 
        stdDateFormat0.parse("i|9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"i|9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1747, "0000-00-00T00:00");
      Locale locale0 = Locale.ROOT;
      MockDate mockDate0 = new MockDate((-2054), 89, 89, (-879), (-1333));
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=0000-00-00T00:00,offset=1747,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0], locale: , lenient: false)");
  ...
  public void test11()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "-g$9x1Zv&");
      Locale locale0 = Locale.JAPAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0.instance.parseAsRFC1123("V2h'lh7;%aS~9n/@", parsePosition0);
  ...
  public void test20()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4, "FLS", 0, 4, 0, 4, 4, 4, 0, 2212, 3027);
  ...
  public void test22()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(4, (-680), 4);
  ...
  public void test26()  throws Throwable  {
      ...
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = new Boolean("M]VigHwy,%P9*M{");
  ...
  public void test28()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("[one of: 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', 'EEE, dd MMM yyyy HH:mm:ss zzz' (lenient)]", ")|K786/okn:C?");
  ...
  public void test31()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-2054));
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-2054));
      try { 
        stdDateFormat0.parseAsISO8601("[ftCK/}", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"[ftCK/}\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("liw'Gb1}mvmB!3Xv4o", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test42()  throws Throwable  {
      FieldPosition fieldPosition0 = new FieldPosition((-2054));
      MockDate mockDate0 = new MockDate((-1793), (-2054), (-2054), (-1793), (-1793));
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("i|9");
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = new Boolean("i|9");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      // Undeclared exception!
      try { 
  ...
  public void test51()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Locale locale0 = Locale.FRANCE;
      Instant instant0 = MockInstant.ofEpochMilli((-3065L));
  ...
  public void test53()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1747, "C1dc~K");
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test57()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat2.parseAsRFC1123((String) null, parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test60()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("0000->0uF0", parsePosition0);
  ...
  public void test62()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("9v\"ajAkj%", parsePosition0);
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-2107), 3225, (-2107));
  ...
  public void test69()  throws Throwable  {
      Locale locale0 = Locale.ROOT;
      Boolean boolean0 = Boolean.valueOf(true);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2054), "Wm!d@`oV&6tp!ZL|J0");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test88()  throws Throwable  {
      Boolean boolean0 = new Boolean(true);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-372), "0000-00-00T00:00");
  ...
  public void test91()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.parseObject("0400-00-00", parsePosition0);
  }
