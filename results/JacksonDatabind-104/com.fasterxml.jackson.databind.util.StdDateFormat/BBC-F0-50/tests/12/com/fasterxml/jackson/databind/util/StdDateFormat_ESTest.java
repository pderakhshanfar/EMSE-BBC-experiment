...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.parse("0900-00-90");
  }
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat1.parseAsISO8601("vV5_", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"vV5_\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test03()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("00000-0T00:");
        fail("Expecting exception: ParseException");
  ...
  public void test06()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(206, "aTye");
  ...
  public void test07()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0000-0-0T00:0");
        fail("Expecting exception: ParseException");
  ...
  public void test10()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Boolean boolean0 = Boolean.valueOf("Dp`?z\"");
  ...
  public void test12()  throws Throwable  {
      ...
      stdDateFormat0.parse("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: en, lenient: null)", parsePosition0);
  ...
  public void test14()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("00P0-00-00");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertTrue(boolean0);
  }
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2008), "._[S_Xgc");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      stdDateFormat0.looksLikeISO8601("._[S_Xgc");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test17()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4, "yyyy-MM-dd'T'HH:mm:ss.SSSZ", 4, 4, 4, 1, 1, 1, 1, 4);
  ...
  public void test20()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("}xaMIop~PyyL", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      boolean boolean0 = StdDateFormat._equals((Object) locale0, (Object) locale0);
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1000), "R{Q5-_sG", (-2451), 0, (-1000), 0, 0, 0, 0, 0);
      Boolean boolean0 = new Boolean("R{Q5-_sG");
  ...
  public void test26()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("x5ku");
  ...
  public void test27()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("fTO[[C}W", "fTO[[C}W", "fTO[[C}W");
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("%9", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("LQ!<F2=");
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-2183));
      Date date0 = stdDateFormat0._parseAsISO8601("0000-00-00", parsePosition0);
      FieldPosition fieldPosition0 = new FieldPosition((-3338));
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00-04T0:00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-04T0:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat1.parseAsRFC1123("7Hf'Koa9'*I=n[j", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test51()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("0000-i0-00T00:00");
        fail("Expecting exception: ParseException");
  ...
  public void test52()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("0%~&6!l^Jwt_u.");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0%~&6!l^Jwt_u.\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      ...
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      MockDate mockDate0 = new MockDate((-1846), 2, 3, 3, (-1846), (-1));
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("0054-03-01T20:13:59.000+0000", stringBuffer0.toString());
  }
  ...
  public void test59()  throws Throwable  {
      ...
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      stdDateFormat1._format(zoneInfo0, (Locale) null, mockDate0, stringBuffer0);
  ...
  public void test60()  throws Throwable  {
      ...
      assertEquals(29, stringBuffer0.length());
      assertEquals("1904-05-04T00:00:00.004+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-2265), (-2265), (-2265));
      StringBuffer stringBuffer0 = new StringBuffer();
      ...
      assertEquals("0561-01-17T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(23, "%9");
      Locale locale0 = Locale.CHINESE;
      ...
      assertEquals("2.2250738585072012e-3082014-02-14T20:21:21.343+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(2848);
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("1j(9\"&%LO'-^D a");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"1j(9\"&%LO'-^D a\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test75()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("h", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test79()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ZoneOffset.ofHours(761);
        fail("Expecting exception: DateTimeException");
      
      } catch(DateTimeException e) {
         //
         // Zone offset hours not in valid range: value 761 is not in the range -18 to 18
         //
