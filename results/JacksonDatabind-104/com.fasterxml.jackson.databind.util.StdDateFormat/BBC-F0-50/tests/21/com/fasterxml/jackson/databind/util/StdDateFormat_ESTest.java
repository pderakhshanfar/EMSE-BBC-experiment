...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("0000-00-20", parsePosition0);
      assertNotNull(date0);
      assertEquals("java.text.ParsePosition[index=2477,errorIndex=-1]", parsePosition0.toString());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, ">l5H%c[");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, (Locale) null);
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        stdDateFormat0.parseAsISO8601(">l5H%c[", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \">l5H%c[\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("aT[hFy83?pL9", parsePosition0);
  ...
  public void test06()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "oWD2c$b=ex}!");
  ...
  public void test07()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1967, "strict");
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(461, "0000-00-00T0:00");
      Locale locale0 = new Locale("0000-00-00T0:00");
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-5482), "0000-00-00");
      Boolean boolean0 = new Boolean("H$}T.QaM*UfVe\"");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, (Locale) null, boolean0, true);
      stdDateFormat0.getTimeZone();
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("g)*35[2eC')W E_]L");
  ...
  public void test18()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(5927);
      stdDateFormat0._parseAsISO8601("0000-02-00", parsePosition0);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("Ezu(.b;SeLA}CCQ", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("3dGTGS@89", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"3dGTGS@89\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("!XYna\"ZMrmO=|Pp:*");
  ...
  public void test37()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StringBuffer stringBuffer0 = new StringBuffer("u;OQCKrCL");
  ...
  public void test42()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(4906);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("oWD2c$b=ex}!");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
  ...
  public void test48()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("oWD2c$b=ex}!");
      Locale locale0 = new Locale("0000-00-00T00:00", "Ry c!>.zs4", "Ry c!>.zs4");
      Boolean boolean0 = new Boolean("0000-00-00");
      Boolean boolean1 = new Boolean("oWD2c$b=ex}!");
  ...
  public void test50()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
      ParsePosition parsePosition0 = new ParsePosition(5883);
  ...
  public void test51()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3872), "bN");
  ...
  public void test52()  throws Throwable  {
      ...
      assertEquals(5883, parsePosition0.getErrorIndex());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0000-X000");
        fail("Expecting exception: ParseException");
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("00-0'r0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00-0'r0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("6CB)Qsf1G;M]h`C9K,");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"6CB)Qsf1G;M]h`C9K,\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-4105), 3, (-251));
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = Locale.GERMAN;
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2207-07-23T00:00:00.000+00:00", string0);
      assertFalse(stdDateFormat0.isLenient());
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1683), (-1683), (-1683), (-1683), (-1683));
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1683), "Value \"");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      ...
      assertEquals("0071-12-11T16:56:58.317-00:00", string0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(100, "2.2250738585072012e-308");
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1969-12-31T23:59:59.766+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1897), 40, 40);
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(zoneInfo0);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("0006-06-09T00:00:00.000+0000", string0);
  }
  ...
  public void test71()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      TimeZone timeZone0 = TimeZone.getTimeZone("Ry c!>.zs4");
  ...
  public void test76()  throws Throwable  {
      ...
      TimeZone timeZone1 = TimeZone.getTimeZone(")Q,ztK0:9v|[w@!LL0G");
  ...
  public void test79()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(2477);
      Date date0 = stdDateFormat0._parseDate("435", parsePosition0);
      StringBuffer stringBuffer0 = new StringBuffer("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, 2477);
      stdDateFormat0.format(date0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1970-01-01T00:00:00.435+0000", stringBuffer0.toString());
  }
  ...
  public void test80()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.GERMAN;
      Boolean boolean0 = new Boolean("FaT5");
  ...
  public void test84()  throws Throwable  {
      ...
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: it, lenient: false)", string0);
  }
  ...
  public void test85()  throws Throwable  {
      ...
      stdDateFormat0.parseAsISO8601("0010-00-00", parsePosition0);
  ...
  public void test86()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(3573);
      // Undeclared exception!
      try { 
