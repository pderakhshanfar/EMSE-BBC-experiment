...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat1._parseAsISO8601("Cannot parse date \"%s\", problem: %s", (ParsePosition) null);
  ...
  public void test06()  throws Throwable  {
      ...
      boolean boolean1 = stdDateFormat0.looksLikeISO8601("ryJJXty");
  ...
  public void test07()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("v;x29");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"v;x29\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      stdDateFormat0.parse("0019-03-20T04:33:00.000+0000", parsePosition0);
      assertTrue(stdDateFormat0.isLenient());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(5, "0000-00-00", 5, 5, 5, 5, 5, 5, 5, 5);
  ...
  public void test19()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(3);
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0._parseDate("1XxT<EC+FPF%7=T[", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test27()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofHoursMinutesSeconds(2, 45, 45);
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("!U", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("M", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test42()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-0-D1", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-0-D1\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance._parseDate("-M?M8axj5X|", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test50()  throws Throwable  {
      Boolean boolean0 = Boolean.valueOf(")LJpJO0\"F/+mNZr_F");
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
  ...
  public void test51()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("VuL\"");
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
  ...
  public void test52()  throws Throwable  {
      ...
      try { 
        stdDateFormat1.parse("0000-.00000:M0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-.00000:M0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test53()  throws Throwable  {
      ...
      stdDateFormat1.parse("3cf.l9MkR&9|z", parsePosition0);
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(9);
      stdDateFormat0.parseAsRFC1123("(R", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0y4(RGQ");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0y4(RGQ\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(0, 1814, 1937, 57, 1814);
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1735), (-1735), (-325), (-2734), 1593);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0019-03-20T04:33:00.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(84, "yyyy-MM-dd'T'HH:mm:ss.SSS");
      ParsePosition parsePosition0 = new ParsePosition(3);
      ...
      assertEquals("2014-02-14T20:21:21.404+00:00", stringBuffer0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(9);
      Locale locale0 = Locale.PRC;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-4916), "(R");
      Date date0 = stdDateFormat0.parseAsISO8601("0000-00-00", parsePosition0);
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(simpleTimeZone0, locale0, date0, stringBuffer0);
      assertEquals("2014-02-14T20:21:16.404-0000", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("strict");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate((-1744), 21, 0, 3003, (-1744));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0158-01-31T21:56:00.000+00:00", string0);
      assertFalse(stdDateFormat0.isLenient());
  }
  ...
  public void test76()  throws Throwable  {
      int int0 = (-1885);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1885), "5.");
      ...
      try { 
        stdDateFormat3.parse("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
        fail("Expecting exception: ParseException");
  ...
  public void test80()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.instance.parse("5");
  ...
  public void test81()  throws Throwable  {
      ...
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"UTC\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: strict_STRICT, lenient: false)", string0);
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
  }
