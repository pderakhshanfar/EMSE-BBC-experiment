...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("!ls3{");
      Locale locale0 = Locale.TAIWAN;
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(5);
      stdDateFormat0.parse("6T!0TBw", parsePosition0);
  ...
  public void test02()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("96");
  ...
  public void test03()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(3, 0, 9);
  ...
  public void test12()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2574, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test13()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1894), "");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      TimeZone timeZone0 = stdDateFormat1.getTimeZone();
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
      assertNotNull(timeZone0);
  ...
  public void test16()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(2354);
      stdDateFormat0.instance._parseDate("d(5CJ`vGru", parsePosition0);
      assertFalse(stdDateFormat0.isLenient());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test18()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(395);
  ...
  public void test22()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("|3P", "");
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("I#>g7$i", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test44()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(0);
      Locale locale0 = Locale.forLanguageTag("Value g\"");
      Boolean boolean0 = Boolean.TRUE;
  ...
  public void test52()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat1.parse("K", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test58()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, true);
      try { 
        stdDateFormat0.parse("0000 00-0_00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000 00-0_00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, true);
      try { 
        stdDateFormat0.parse("4t`UjxE,+F3^");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4t`UjxE,+F3^\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-1894), 763, 2);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0000-00-00T00:000069-08-02T00:00:00.000+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test63()  throws Throwable  {
      Locale locale0 = new Locale("gw5;B", "0000-00-00");
      Boolean boolean0 = Boolean.valueOf("");
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0, true);
      Instant instant0 = MockInstant.ofEpochSecond(1L);
      Date date0 = Date.from(instant0);
      String string0 = stdDateFormat0.format(date0);
      assertEquals("1970-01-01T00:00:01.000+00:00", string0);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("1970-01-01T00:00:00.074-0000", string0);
  }
  ...
  public void test65()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsISO8601("3000-02-00", parsePosition0);
      String string0 = stdDateFormat0.format(date0);
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-+n-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-+n-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-758L));
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(10, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = new Locale("k\";^9^XOWjR");
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1969-12-31T23:59:59.252+00:00", string0);
  }
  ...
  public void test72()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "~9G<");
  ...
  public void test73()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Boolean boolean0 = new Boolean("0100-00-00");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
      stdDateFormat1.parse("0100-00-00");
      assertFalse(stdDateFormat1.isLenient());
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  }
