...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0000-50-70");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("N03:0", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"N03:0\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("4!\u0001<o]92");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4!\u0001<o]92\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1710), "N");
      Locale locale0 = Locale.FRENCH;
      Boolean boolean0 = Boolean.valueOf("V;XlITjG|u*e~3");
  ...
  public void test07()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(57, "hmnFiSlj7,&XgAs");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      Boolean boolean0 = Boolean.valueOf("hmnFiSlj7,&XgAs");
  ...
  public void test09()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("j_jx#98\"&nZw08k@", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1628), "");
      Locale locale0 = Locale.KOREA;
      Boolean boolean0 = new Boolean("2D$:X1TI1");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
  ...
  public void test16()  throws Throwable  {
      Boolean boolean0 = Boolean.TRUE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2897, "0000-00-00T00:00");
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=1392409281320,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=java.util.SimpleTimeZone[id=3d8K]9,offset=1688,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2014,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=45,DAY_OF_WEEK=6,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=8,HOUR_OF_DAY=20,MINUTE=21,SECOND=21,MILLISECOND=320,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
  ...
  public void test37()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = Locale.KOREA;
      Boolean boolean0 = new Boolean("t|J]'A]|v4zq");
  ...
  public void test38()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(46);
      try { 
        stdDateFormat0._parseDate("00B0-0CQ0-60", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00B0-0CQ0-60\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test39()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-4732));
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.instance._parseAsISO8601("NcJ69w`1(z::[t", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"NcJ69w`1(z::[t\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1710), 4, 4, 7, (-1710));
  ...
  public void test46()  throws Throwable  {
      Locale locale0 = Locale.KOREA;
      Boolean boolean0 = new Boolean(false);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-283), "t|J]'A]|v4zq");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, false);
  ...
  public void test53()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601(",]?@1f=klod+{Oy}\"}w", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \",]?@1f=klod+{Oy}\"}w\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = new Locale("KBl$L3$.T");
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("2.22,0738585072012e-30P");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"2.22,0738585072012e-30P\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer("VYoVgQ9@0EDz=Y[N#");
  ...
  public void test62()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1710), (-1710), (-1710));
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1710), "N");
      Locale locale0 = Locale.FRENCH;
      Boolean boolean0 = Boolean.valueOf("V;XlITjG|u*e~3");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      FieldPosition fieldPosition0 = new FieldPosition((-162));
      stdDateFormat0.format((Object) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0042-10-23T23:59:58.290-00:00", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition(330);
      MockDate mockDate0 = new MockDate((-1), (-1), 89, (-1), (-1));
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals(28, stringBuffer0.length());
      assertEquals("1899-02-26T22:59:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      assertEquals("1899-02-26T22:59:00.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      ...
      parsePosition0.setErrorIndex(42);
      stdDateFormat0.instance.parse("2aMYE>2\"WshpMf~kWq", parsePosition0);
      stdDateFormat1.equals(boolean0);
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test80()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: , lenient: true)", string0);
  }
  ...
  public void test81()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(2);
      stdDateFormat0.parse("0000-00-00T0000", parsePosition0);
      assertTrue(stdDateFormat0.isLenient());
