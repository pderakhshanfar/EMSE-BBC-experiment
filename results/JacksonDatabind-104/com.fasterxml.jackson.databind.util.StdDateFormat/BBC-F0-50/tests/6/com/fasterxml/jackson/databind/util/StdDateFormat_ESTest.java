...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("N$Yf!z", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"N$Yf!z\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test05()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(0);
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parse("Me;Ju4t", parsePosition0);
      assertEquals("java.text.ParsePosition[index=0,errorIndex=0]", parsePosition0.toString());
      assertEquals(0, parsePosition0.getErrorIndex());
  }
  ...
  public void test10()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1591), "?&B`)x$A^CH[");
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-386), "IpD8:Tm4u.v>5{b|");
      Locale locale0 = Locale.KOREAN;
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "#Z'JPMtjQqw9liu]9_H", 0, 3, 0, 0, 0, 3, 0, 3);
  ...
  public void test18()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, (-3224));
  ...
  public void test22()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("Timestampvalue %s out of 64-bit value range");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123("08{G2z=kW", parsePosition0);
  ...
  public void test40()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-0E-I0", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-0E-I0\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-2410));
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("+pu'e%PLf59;7 (&", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test54()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("*B6M$&0#qk${^M%", parsePosition0);
  ...
  public void test56()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(162);
      Date date0 = stdDateFormat0.parse("0000-0E-I0", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test58()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      try { 
        stdDateFormat0.parse("0 00-E-X`");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0 00-E-X`\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(0);
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parse("08{G2z=kW", parsePosition0);
      assertEquals("java.text.ParsePosition[index=0,errorIndex=0]", parsePosition0.toString());
      assertEquals(0, parsePosition0.getErrorIndex());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-1863), 15, (-1863), 48, (-1863), 1489);
      stdDateFormat0._format(zoneInfo0, locale0, mockDate0, stringBuffer0);
      assertEquals("0033-02-22T17:21:49.000+0000", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      assertEquals("\u75DD055-12-02T16:47:04.192+00:00", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Locale locale0 = Locale.KOREAN;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-447), "]i%9ybN5U4Y1i^Wy=4");
      MockDate mockDate0 = new MockDate(5, 5, 5, 9, 9, 10);
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1905-06-05T09:09:09.553-0000", stringBuffer0.toString());
  }
  ...
  public void test72()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(9, "}O{V|,P.");
  ...
  public void test80()  throws Throwable  {
      ...
      assertEquals(136, parsePosition0.getErrorIndex());
  ...
  public void test85()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1419, "5?$A+");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, (Boolean) null);
      try { 
        stdDateFormat0.parse("h@&C%?D~!3VTm9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"h@&C%?D~!3VTm9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test88()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0020-00-00", parsePosition0);
      assertNotNull(date0);
      assertEquals("java.text.ParsePosition[index=83,errorIndex=-1]", parsePosition0.toString());
  }
