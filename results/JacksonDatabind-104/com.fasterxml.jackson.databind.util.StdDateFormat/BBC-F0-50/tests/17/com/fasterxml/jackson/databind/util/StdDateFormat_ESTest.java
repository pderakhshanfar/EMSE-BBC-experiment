...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("<x</Ad$", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"<x</Ad$\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3145), "0000-00-00");
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(66, "Cannot parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)");
      Locale locale0 = Locale.ROOT;
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, 370);
      StringBuffer stringBuffer0 = new StringBuffer("erkx[}EAvAozK");
      MockDate mockDate0 = new MockDate(932, 0, 66);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals(41, stringBuffer0.length());
      assertEquals("erkx[}EAvAozK2832-03-06T00:00:00.066+0000", stringBuffer0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(1193);
      stdDateFormat0._parseDate("Kk[SN[CH24?6oy", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test25()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("Cannot parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)", "com.fasterxml.jackson.databind.util.StdDateFormat");
      assertFalse(boolean0);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("0", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(1193);
      try { 
        stdDateFormat0.parseAsISO8601("Kk[SN[CH24?6oy", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"Kk[SN[CH24?6oy\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("q2T9", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test34()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(51, "Cannot parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)");
      ParsePosition parsePosition0 = new ParsePosition(298);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, (Locale) null);
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-3487));
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.UK;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, (-405));
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1153), (-3749), (-1153));
  ...
  public void test53()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1700), ":.r60LDG");
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("3!l9(3bL@");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"3!l9(3bL@\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      stdDateFormat0.parse("99SPRFz`7Zh(uB<&", parsePosition0);
      assertEquals("java.text.ParsePosition[index=181,errorIndex=181]", parsePosition0.toString());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test63()  throws Throwable  {
      Locale locale0 = Locale.ENGLISH;
      Boolean boolean0 = Boolean.TRUE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-9), "Cannot parse date \"%s\": invalid fractional seconds '%s'; can use at most 9 digits");
  ...
  public void test66()  throws Throwable  {
      ...
      Locale locale0 = Locale.ROOT;
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
      MockDate mockDate0 = new MockDate((-1756), (-2445), 2903);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0053-03-12T00:00:00.000+0000", string0);
  }
  ...
  public void test67()  throws Throwable  {
      ...
      assertEquals("1969-12-31T23:59:59.999+00:00", stringBuffer0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      ...
      assertEquals("1970-01-01T00:00:00.270+00:00", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1969-12-31T23:59:59.991-00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(2, 19, 543, 43, 361, (-195));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1905-01-26T00:57:45.000+0000", string0);
  }
