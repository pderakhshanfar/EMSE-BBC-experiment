...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "1PpCN {mb1mu|4;A~", 0, 0, 0, 2467, 46, 0, 46, 2467);
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(2215);
      try { 
        stdDateFormat0._parseAsISO8601("1PpCN {mb1mu|4;A~", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"1PpCN {mb1mu|4;A~\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
  ...
  public void test10()  throws Throwable  {
      ...
      stdDateFormat0.parse("2167-11-15T06:30:41.000+0000", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test12()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("7{W%R@c.g5<+");
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-183), "9 ?y+LSR&");
      Locale locale0 = new Locale("9 ?y+LSR&", "dhn");
      Boolean boolean0 = Boolean.valueOf("9 ?y+LSR&");
  ...
  public void test16()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(1287, (-293), 90, 553, 90);
      StringWriter stringWriter0 = new StringWriter(294);
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      FieldPosition fieldPosition0 = new FieldPosition(1955);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("3162-11-21T02:30:00.000+0000", stringBuffer0.toString());
      assertEquals("3162-11-21T02:30:00.000+0000", stringWriter0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("Wed Nov 21 02:30:00 GMT 3162", date0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=java.util.SimpleTimeZone[id=yyyy-MM-dd'T'HH:mm:ss.SSSZ,offset=0,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=?,MONTH=?,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=?,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=?,HOUR=?,HOUR_OF_DAY=?,MINUTE=?,SECOND=?,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(3840);
      try { 
        stdDateFormat0.parseAsISO8601("H@I", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"H@I\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test39()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(1287, (-293), 90, 553, 90);
      FieldPosition fieldPosition0 = new FieldPosition(1287);
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(3430);
      // Undeclared exception!
      try { 
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(4111);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._format((TimeZone) null, (Locale) null, date0, (StringBuffer) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test46()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-2079), (-2079), (-2038));
      stdDateFormat0.format((Date) mockDate0);
      try { 
        stdDateFormat0._parseDate("0359-03-02T00:00:00.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"0359-03-02T00:00:00.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test51()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("vh0|jih^");
      Locale locale0 = Locale.ROOT;
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      Calendar calendar0 = stdDateFormat0._getCalendar(timeZone0);
      boolean boolean1 = StdDateFormat._equals((Object) null, (Object) calendar0);
  ...
  public void test52()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("x^1rcGLY%~}0", "");
      Boolean boolean0 = Boolean.TRUE;
      locale0.clone();
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      try { 
        stdDateFormat0.instance.parse("%n|f\"$4RP");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"%n|f\"$4RP\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseObject("5B+9*?'CgxWBp8'EC", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-4852));
      // Undeclared exception!
      try { 
        stdDateFormat0.instance._parseDate("0=%BV;9", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test62()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1848), (-3), (-3));
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.forLanguageTag("<");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("0051-09-27T00:00:00.000+0000", string0);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      Locale locale0 = new Locale("yyyy-MM-dd'T'HH:mm:ss.SSSZ", "J}tx");
      StringBuffer stringBuffer0 = new StringBuffer();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2475, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat1._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals(29, stringBuffer0.length());
      assertEquals("2014-02-14T20:21:23.795+00:00", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(10, (-4176), (-4176));
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1550-07-25T23:59:59.994-0000", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=207,errorIndex=207]", parsePosition0.toString());
      assertEquals(207, parsePosition0.getErrorIndex());
  }
  ...
  public void test78()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2158), "lenient");
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      SimpleTimeZone simpleTimeZone1 = new SimpleTimeZone((-2158), "lenient");
      StdDateFormat stdDateFormat2 = stdDateFormat1.withTimeZone(simpleTimeZone1);
      assertSame(stdDateFormat2, stdDateFormat1);
  ...
  public void test84()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, (Boolean) null);
      ParsePosition parsePosition0 = new ParsePosition(3840);
      Date date0 = stdDateFormat0.instance.parse("0", parsePosition0);
      StringBuffer stringBuffer0 = new StringBuffer();
  ...
  public void test86()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: 0_0, lenient: null)", string0);
  }
  ...
  public void test88()  throws Throwable  {
      ...
      AttributedCharacterIterator attributedCharacterIterator0 = stdDateFormat0.formatToCharacterIterator(date0);
