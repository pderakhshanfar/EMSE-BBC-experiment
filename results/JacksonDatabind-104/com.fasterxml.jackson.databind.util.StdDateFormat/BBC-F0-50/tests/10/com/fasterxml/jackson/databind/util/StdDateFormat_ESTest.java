...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      ...
      stdDateFormat0._parseDate(";sj*BHI%COAruY{ZUAf", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("252250738585070122308");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"252250738585070122308\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=1199,errorIndex=1199]", parsePosition0.toString());
      assertEquals(1199, parsePosition0.getErrorIndex());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      stdDateFormat1.parse("0000-00-20");
  }
