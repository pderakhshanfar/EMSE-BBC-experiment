...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0000-07-02");
  ...
  public void test08()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("00:0-00-00");
        fail("Expecting exception: ParseException");
  ...
  public void test17()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-316), ":s{c3J}");
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1882, "\" can not be represented as BigDecimal");
  ...
  public void test19()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("', '", "wwFy_");
  ...
  public void test26()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("`+:|:c F%j3{0", "`+:|:c F%j3{0");
      assertTrue(boolean0);
  }
  ...
  public void test31()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-710));
  ...
  public void test34()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Boolean boolean0 = new Boolean("\u0007UW5k@x@-");
  ...
  public void test39()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition((-3389));
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("0F=", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("\u0007UW5k@x@-");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null, boolean0, true);
      Boolean boolean1 = Boolean.valueOf("\u0007UW5k@x@-");
  ...
  public void test53()  throws Throwable  {
      ...
      stdDateFormat1.parseObject("X)sXWHh", parsePosition0);
      assertEquals(824, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=824,errorIndex=824]", parsePosition0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      ...
      stdDateFormat0.parse("j)^pa)48L>Rduknbn1", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test57()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = new Locale(",)S]JXd*/A", "0000-d-0i", ",)S]JXd*/A");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, false);
      try { 
        stdDateFormat0.parseObject("0000-d-0i");
        fail("Expecting exception: ParseException");
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("2,x8,}b");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"2,x8,}b\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(34);
      Date date0 = stdDateFormat0._parseDate("9y6C~Jb", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test62()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("000-00-00T00:00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test65()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(312, 312, 2060, 2060, (-382));
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2243-11-16T07:38:00.000+18:00", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-1914), 10, 10, (-269), 505);
      StringBuffer stringBuffer0 = new StringBuffer(1274);
      Locale locale0 = Locale.TAIWAN;
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0015-10-30T03:25:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse(" U!7%941");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"U!7%941\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test71()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat1._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2243-11-16T07:38:00.000+1800", stringBuffer0.toString());
  }
