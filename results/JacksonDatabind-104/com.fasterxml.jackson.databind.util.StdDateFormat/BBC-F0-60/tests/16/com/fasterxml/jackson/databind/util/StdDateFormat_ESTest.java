...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0.parse("3000-05-00");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("WXgD% ;c+:BZ~F]l_", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"WXgD% ;c+:BZ~F]l_\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-2911));
  ...
  public void test10()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-764), "2");
  ...
  public void test13()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("G;1j.q4ZzUZ029V ", parsePosition0);
      assertEquals(1438, parsePosition0.getErrorIndex());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test17()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("8ns-.3s^/TVUk*h^&");
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "wB~r?R4%S@7?FJdf");
  ...
  public void test27()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-861));
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123(">x[h#T?", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123("|U4lG+(giX", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      ...
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("%s^rV/!*_h");
      StdDateFormat.getRFC1123Format(timeZone0, locale0);
      StdDateFormat.getRFC1123Format(timeZone0, locale0);
      Locale locale1 = new Locale("Q/7\"q");
      NumberFormat numberFormat0 = NumberFormat.getCurrencyInstance();
      StringBuffer stringBuffer0 = new StringBuffer(1);
      FieldPosition fieldPosition0 = new FieldPosition(1);
      StringBuffer stringBuffer1 = numberFormat0.format(0L, stringBuffer0, fieldPosition0);
      stdDateFormat0._format(timeZone0, locale1, date0, stringBuffer1);
      assertEquals("\u00A40.002014-02-14T20:21:21.320+0000", stringBuffer1.toString());
      assertEquals("\u00A40.002014-02-14T20:21:21.320+0000", stringBuffer0.toString());
  }
  ...
  public void test52()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(107, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      ...
      try { 
        stdDateFormat0.parse("000-0000");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"000-0000\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("00U0-H-00T0:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00U0-H-00T0:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0QN5#.\"Aw");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0QN5#.\"Aw\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-2168), 2366, 565, 108, 6, 32);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0071-09-20T12:06:32.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test69()  throws Throwable  {
      Locale locale0 = Locale.CANADA;
      FieldPosition fieldPosition0 = new FieldPosition(723);
      MockDate mockDate0 = new MockDate(4, (-729), 45);
      ...
      assertEquals("1843-05-15T00:00:00.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-39), (-39), (-39), (-980), (-39));
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stdDateFormat0.instance._format(simpleTimeZone0, (Locale) null, mockDate0, stringBuffer0);
      assertEquals("1857-07-12T03:20:59.961-0000", stringBuffer0.toString());
      assertEquals("1857-07-12T03:20:59.961-0000", stringWriter0.toString());
  }
  ...
  public void test73()  throws Throwable  {
      MockDate mockDate0 = new MockDate(45, 45, (-2145), (-2145), 4, 3129);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(251, ".");
      Locale locale0 = Locale.CHINESE;
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1942-08-18T15:56:09.251+00:00", string0);
  }
