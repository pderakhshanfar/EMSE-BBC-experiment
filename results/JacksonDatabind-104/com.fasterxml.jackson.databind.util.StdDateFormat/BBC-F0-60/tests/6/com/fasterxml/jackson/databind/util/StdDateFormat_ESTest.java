...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("]0!(pZ", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test04()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-1530));
      // Undeclared exception!
      try { 
        stdDateFormat0.parse(")xjUI {89\"Ef9", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "?moA3vp;nT6U!*2");
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1635, "Cannot parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)");
  ...
  public void test17()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("&U6");
  ...
  public void test30()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(5064, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("4.f");
  ...
  public void test43()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-2243));
      try { 
        stdDateFormat0._parseAsISO8601("9U248YAj.G^wf", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9U248YAj.G^wf\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test44()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-1));
      Locale locale0 = Locale.ENGLISH;
      Boolean boolean0 = new Boolean("4.f");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      ...
      stdDateFormat0.equals(integer0);
      ParsePosition parsePosition1 = new ParsePosition(0);
      ParsePosition parsePosition2 = new ParsePosition(827);
      parsePosition2.setErrorIndex(38);
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("0000-00-00T00:00", parsePosition1);
       //  fail("Expecting exception: IllegalStateException");
       // Unstable assertion
      } catch(IllegalStateException e) {
         //
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("11&6%(21S,.6H&I");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"11&6%(21S,.6H&I\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("9,Tm+[>>36Ur", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1596), (-3029), (-1596), (-1810), 60000);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      FieldPosition fieldPosition0 = new FieldPosition((-1596));
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0047-02-12T06:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-158), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.ITALY;
      MockDate mockDate0 = new MockDate();
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2014-02-14T20:21:21.162-0000", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      assertEquals("1582-10-15T00:00:05.064+00:00", string0);
  }
  ...
  public void test70()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      MockDate mockDate0 = new MockDate((-194), 57, (-1226), 48, 2156, 758);
      FieldPosition fieldPosition0 = new FieldPosition(48);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1707-05-26T12:08:38.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test77()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      TimeZone timeZone1 = TimeZone.getTimeZone("`S$7");
  ...
  public void test81()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0.parse("24");
  ...
  public void test86()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parse("0000-00-0", (ParsePosition) null);
      assertTrue(stdDateFormat0.isLenient());
  }
}
