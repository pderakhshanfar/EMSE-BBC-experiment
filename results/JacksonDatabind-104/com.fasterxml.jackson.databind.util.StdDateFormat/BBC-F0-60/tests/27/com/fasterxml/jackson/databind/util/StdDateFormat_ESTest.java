...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("Mon May 10 00:00:00 GMT 2021", date0.toString());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("0080-00-70");
      //  // Unstable assertion: assertEquals("Mon May 10 00:00:00 GMT 2021", date0.toString());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("4y^", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4y^\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? true)
         //
  ...
  public void test06()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("mkCrGb44oTZBB4Wm9");
        fail("Expecting exception: ParseException");
  ...
  public void test07()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(7, "yyyy-MM-dd'T'HH:mm:ss.SSS");
      MockDate mockDate0 = new MockDate(0, 1456, 10);
      ...
      assertEquals("2021-05-10T00:00:00.007+0000", stringBuffer0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Locale locale0 = new Locale("{u12xc", "{u12xc");
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test10()  throws Throwable  {
      Locale locale0 = new Locale("zhH`Ut]x>w(9<B^r", "EEE, dd MMM yyyy HH:mm:ss zzz", "EEE, dd MMM yyyy HH:mm:ss zzz");
      Boolean boolean0 = Boolean.TRUE;
  ...
  public void test11()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.instance.parseAsRFC1123("mt}", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "h", 0, 0, 0, 0, 372, 0, 0, 469, 0, 0, 372);
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1676), "0000-00-00");
  ...
  public void test19()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1633), 0, (-1633));
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0262-07-12T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=sun.util.calendar.ZoneInfo[id=\"GMT+03:00\",offset=10800000,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=?,MONTH=?,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=?,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=?,HOUR=?,HOUR_OF_DAY=?,MINUTE=?,SECOND=?,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("h", parsePosition0);
  ...
  public void test29()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601(">nT", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \">nT\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Boolean boolean0 = Boolean.FALSE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1474), "yyyy-MM-dd'T'HH:mm:ss.SSS");
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("DL[e1Y", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test41()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StringBuffer stringBuffer0 = new StringBuffer("W&g=nek[pLu]:oREtq");
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("uT W", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test50()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = Boolean.valueOf("RY,i0H#m0P'w>6\"");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test51()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(43, "Cannot parse date \"%s\": invalid fractional seconds '%s'; can use at most 9 digits", 1, 0, 392, 43, 1, 0, 0, 3687);
  ...
  public void test53()  throws Throwable  {
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(0, 0, 2376, 1660, 0, 0);
  ...
  public void test55()  throws Throwable  {
      ...
      stdDateFormat1.parse("Cannot parse date \"%s\": invalid fractional seconds '%s'; can use at most 9 digits", parsePosition0);
      assertNotSame(stdDateFormat1, stdDateFormat0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("00|0-]0-00T00:0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00|0-]0-00T00:0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("4%O]\"mJ} ^{R3", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1850), 346, 43);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0078-12-13T00:00:00.000+0000", string0);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(339, 1712, 29);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("2381-09-29T00:00:00.000+00:00", string0);
  }
  ...
  public void test66()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("X&ba9y-'kmpyE=+");
      Locale locale0 = new Locale("yyyy-MM-dd'T'HH:mm:ss.SSS");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      try { 
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("00|0$00-00T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00|0$00-00T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test69()  throws Throwable  {
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=1392409281320,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=java.util.SimpleTimeZone[id=0000-00-00,offset=-1676,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2014,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=45,DAY_OF_WEEK=6,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=8,HOUR_OF_DAY=20,MINUTE=21,SECOND=21,MILLISECOND=320,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test70()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate(1514, (-8), 1277);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("3416-10-27T23:59:59.992-0000", string0);
  }
  ...
  public void test79()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(1569);
