...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("0002-06-00");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test02()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0._parseAsISO8601("0800-00-00", (ParsePosition) null);
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("1Oq0[(%]~XoX,E");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"1Oq0[(%]~XoX,E\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=2502,errorIndex=-1]", parsePosition0.toString());
  ...
  public void test12()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("kAu8_$L#4@");
      Locale locale0 = Locale.CHINESE;
  ...
  public void test15()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("0000-00-y0", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test20()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "!T')ThH");
  ...
  public void test21()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1438), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test22()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3273, "0000-00-00T00:00");
  ...
  public void test25()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(45);
      stdDateFormat0._parseDate("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"UTC\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: fr, lenient: null)", parsePosition0);
  ...
  public void test44()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("1970-01-01T00:00:00.003+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"1970-01-01T00:00:00.003+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test51()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-387), "1970-01-01T00:00:00.003+0000");
      MockGregorianCalendar mockGregorianCalendar0 = (MockGregorianCalendar)StdDateFormat.CALENDAR;
      Date date0 = mockGregorianCalendar0.getGregorianChange();
      // Undeclared exception!
      try { 
        stdDateFormat0._format(simpleTimeZone0, (Locale) null, date0, (StringBuffer) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test59()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(3800);
      try { 
  ...
  public void test60()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(45, "lenient");
      Locale locale0 = Locale.UK;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      Date date0 = stdDateFormat0.parse("0000-00-00");
      //  // Unstable assertion: assertEquals("Mon Mar 02 00:00:00 GMT 13", date0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0-00-A0-XT{0:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0-00-A0-XT{0:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("9%=8#~+IIRX *[");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9%=8#~+IIRX *[\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      try { 
        stdDateFormat0.parse("9a:/'*|}_");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9a:/'*|}_\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1765), (-1765), 93);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0013-03-02T00:00:00.000+0000", string0);
  }
  ...
  public void test70()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer("A\"<$v");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0);
      stdDateFormat3.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("A\"<$v\u75DD055-12-03T10:47:04.192+18:00", stringBuffer0.toString());
  }
  ...
  public void test71()  throws Throwable  {
      ...
      assertEquals("A\"<$v\u75DD055-12-03T10:47:04.192+1800", stringBuffer0.toString());
  }
  ...
  public void test72()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1438), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      MockDate mockDate0 = new MockDate((-1438), 1, 1, 1, (-1323), (-2500));
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("0462-01-31T02:15:18.562-0000", string0);
  }
  ...
  public void test74()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      String string0 = "3000-00-00";
      stdDateFormat0.parse("3000-00-00");
      // Undeclared exception!
      try { 
        ZoneOffset.ofHoursMinutes(786, 786);
        fail("Expecting exception: DateTimeException");
      
      } catch(DateTimeException e) {
         //
         // Zone offset hours not in valid range: value 786 is not in the range -18 to 18
         //
  ...
  public void test77()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1496, "\" can not be represented as BigDecimal");
      Boolean boolean0 = Boolean.valueOf(false);
  ...
  public void test86()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(38, "h,.*WMs~tM~l/GvT{f");
