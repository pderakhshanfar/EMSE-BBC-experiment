...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("4;e4j\"3hQUFKUAS");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4;e4j\"3hQUFKUAS\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("*#&t-lY#97m(uK9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"*#&t-lY#97m(uK9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(961, 961, 961, 961, (-720), 10);
      ...
      assertEquals("2943-10-28T13:00:10.000+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("'`@mr{upyb[!r}]r:Fu");
  ...
  public void test11()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "yyyy-MM-dd'T'HH:mm:ss.SSS", 0, 0, 0, 0, 0, 0, 266, 0);
      Boolean boolean0 = Boolean.FALSE;
  ...
  public void test12()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(186);
      stdDateFormat0.parse("0000-0\"10-00", parsePosition0);
  ...
  public void test13()  throws Throwable  {
      ...
      boolean boolean1 = stdDateFormat0.looksLikeISO8601("2277-08-03T06:17:00.000+00:00");
      assertTrue(boolean1);
  ...
  public void test19()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(48, 44, 16, (-1233), 13, 44);
      ...
      assertEquals("1951-07-26T15:13:44.000+0000", stringBuffer0.toString());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      boolean boolean0 = StdDateFormat._equals((Object) mockDateFormat0, (Object) timeZone0);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3605, "");
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("$thAY", parsePosition0);
  ...
  public void test35()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Boolean boolean0 = new Boolean("SA-");
  ...
  public void test36()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("A!e$,u.");
      Locale locale0 = Locale.KOREA;
  ...
  public void test42()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(1949);
      // Undeclared exception!
      try { 
  ...
  public void test44()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(5, "0000-00-00T00:00");
      Locale locale0 = Locale.JAPAN;
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test45()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("GI", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"GI\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test53()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("~o?=7}hHcAk!4^$FOq)");
  ...
  public void test58()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("00-0-(0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00-0-(0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(1633);
      stdDateFormat0.parseAsRFC1123("L7: .loa", parsePosition0);
      assertEquals(1633, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1633,errorIndex=1633]", parsePosition0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      try { 
        stdDateFormat0._parseDate("0086-05-09T07:54:26.000+0000", (ParsePosition) null);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"0086-05-09T07:54:26.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("2p(>kL$ ");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"2p(>kL$\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test67()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      MockDate mockDate0 = new MockDate(46, 3917, 1727, 3917, 77);
      Boolean boolean0 = new Boolean(true);
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2277-08-03T06:17:00.000+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test68()  throws Throwable  {
      Locale locale0 = Locale.JAPANESE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-432), "l?@f_rj&/++wvgW{^X");
      MockDate mockDate0 = new MockDate(58, 57, (-3067), 10, 1786);
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, false);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1954-05-09T15:45:59.568-0000", string0);
  }

  @Test(timeout = 4000)
  public void test69()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-47), "vV e|:ppS8");
      MockDate mockDate0 = new MockDate((-3067), (-47), 57, (-464), 20);
      Locale locale0 = Locale.GERMANY;
      Boolean boolean0 = Boolean.valueOf("ed");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1172-03-09T16:19:59.953-00:00", string0);
  }

  @Test(timeout = 4000)
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(3522);
  ...
  public void test71()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0.parse("170");
  ...
  public void test72()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseObject("X", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test73()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0Ur0)00-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0Ur0)00-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test76()  throws Throwable  {
      ...
      ParsePosition parsePosition1 = new ParsePosition(128);
      stdDateFormat0.parseAsISO8601("0000-90-00", parsePosition1);
      // Undeclared exception!
      try { 
  ...
  public void test81()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3950), ")]");
  ...
  public void test85()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      MockDate mockDate0 = new MockDate((-1794), (-2212), (-2212), (-2212), (-2212), 2786);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0086-05-09T07:54:26.000+0000", string0);
  }
