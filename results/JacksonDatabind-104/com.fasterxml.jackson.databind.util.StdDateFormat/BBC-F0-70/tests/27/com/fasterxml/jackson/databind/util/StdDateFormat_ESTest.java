...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("com.fasterxm.jackson.core.io.NumberInpu", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"com.fasterxm.jackson.core.io.NumberInpu\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("l(&]g|Q", parsePosition0);
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(960, parsePosition0.getErrorIndex());
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("T4:^9%!9", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test06()  throws Throwable  {
      ...
      Locale locale0 = Locale.ITALY;
      MockDate mockDate0 = new MockDate((-413), 3666, (-413));
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(zoneInfo0, locale0, mockDate0, stringBuffer0);
      assertEquals("1791-05-14T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition((-2297));
      StdDateFormat stdDateFormat0 = new StdDateFormat();
  ...
  public void test17()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("Qu4<");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      boolean boolean1 = stdDateFormat0.looksLikeISO8601("zM");
  ...
  public void test19()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3564), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=3092,errorIndex=3092]", parsePosition0.toString());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test29()  throws Throwable  {
      Integer integer0 = new Integer(11);
      Integer integer1 = new Integer(2795);
  ...
  public void test39()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Boolean boolean0 = new Boolean("x^k90q@C}%Rr/CW2");
  ...
  public void test42()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, 960);
      // Undeclared exception!
      try { 
  ...
  public void test56()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("CoXa;!~^g8?'e]/~:GZ", parsePosition0);
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-3564));
      try { 
        stdDateFormat0._parseAsISO8601("(.rav", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"(.rav\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-c00c");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-c00c\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("22JMD6$7[Y< <TnJ", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test62()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf((String) null);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      boolean boolean1 = stdDateFormat0.equals("^~?.STSlo");
      assertFalse(stdDateFormat0.isLenient());
      assertFalse(boolean1);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1717), (-1717), (-1717), (-1717), (-1717));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0035-01-05T06:23:00.000+0000", string0);
  }
  ...
  public void test66()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=java.util.SimpleTimeZone[id=yyyy-MM-dd'T'HH:mm:ss.SSSZ,offset=2,dstSavings=2,useDaylight=true,startYear=0,startMode=2,startMonth=2,startDay=2,startDayOfWeek=2,startTime=2,startTimeMode=2,endMode=2,endMonth=2,endDay=2,endDayOfWeek=2,endTime=2,endTimeMode=2],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=?,MONTH=?,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=?,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=?,HOUR=?,HOUR_OF_DAY=?,MINUTE=?,SECOND=?,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
  ...
  public void test72()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "yyyy-MM-dd'T'HH:mm:ss.SSSZ", 0, 0, 0, 0, (-768), 0, 0, (-768), (-768), 0, 1924);
      stdDateFormat0.setTimeZone(simpleTimeZone0);
      ParsePosition parsePosition0 = new ParsePosition((-1226));
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("T4:^9%!9", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test75()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      TimeZone timeZone1 = TimeZone.getTimeZone("bv2,!");
  ...
  public void test85()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: fr, lenient: true)", string0);
  }

  @Test(timeout = 4000)
  public void test86()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parse("0000-07-60", (ParsePosition) null);
  }
