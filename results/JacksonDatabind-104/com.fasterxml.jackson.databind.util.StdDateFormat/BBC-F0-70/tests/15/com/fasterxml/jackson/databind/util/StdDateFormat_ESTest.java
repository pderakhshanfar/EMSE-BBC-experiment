...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdDateFormat1._parseAsISO8601("YZ}", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"YZ}\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("o?BMVR$");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"o?BMVR$\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test04()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(3358);
  ...
  public void test07()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0000-00-i00T00:00");
        fail("Expecting exception: ParseException");
  ...
  public void test10()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("6/cIowY#` ");
  ...
  public void test11()  throws Throwable  {
      ...
      stdDateFormat2.parse("0000-00-00");
  }
  ...
  public void test12()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("6/cIowY#` ", parsePosition0);
      assertEquals(918, parsePosition0.getErrorIndex());
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test15()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("]%`jjQ^%[)70@");
  ...
  public void test16()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag("V3|bZa!0]");
      Boolean boolean0 = Boolean.TRUE;
  ...
  public void test29()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("*kwu'&\u000BBJz.");
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123("lenient", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("iI)~", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("1945-11-17T02:38:00.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"1945-11-17T02:38:00.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat1._parseDate("vS", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-&0-00T0Tm00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-&0-00T0Tm00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("9W>9+s:U}To9NQ");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9W>9+s:U}To9NQ\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("vM}t8I($R|");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(10);
      stdDateFormat0.parse("7^'C]he _,Y.Rj(G", parsePosition0);
  ...
  public void test67()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate((-1), (-1), 7, 1, 10);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("1898-12-07T01:10:00.000+00:00", string0);
  }
  ...
  public void test70()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("^S8Wnd");
      Locale locale0 = Locale.FRANCE;
      MockDate mockDate0 = new MockDate((-1330), 12, 12, 43, (-1642), 43);
      StringBuffer stringBuffer0 = new StringBuffer();
      ...
      assertEquals("0571-01-13T09:38:43.000+1800", stringBuffer0.toString());
  }
  ...
  public void test73()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "]%`jjQ^%[)70@");
  ...
  public void test74()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("R/+AZ");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test76()  throws Throwable  {
      ...
      assertEquals("1899-11-29T00:00:00.000+0000", string1);
  ...
  public void test87()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.instance.parseAsISO8601("0000-08-00", parsePosition0);
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
