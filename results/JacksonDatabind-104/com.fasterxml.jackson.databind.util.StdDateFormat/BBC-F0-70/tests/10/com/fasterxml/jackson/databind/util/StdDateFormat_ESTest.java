...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("e}G??EiQxp'>p/{", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"e}G??EiQxp'>p/{\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
         //
  ...
  public void test06()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("%-(2/h2", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(903, 3600, 3600, (-2136), (-2136));
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("3112-08-09T12:24:00.000+0000", stringBuffer0.toString());
      assertEquals("3112-08-09T12:24:00.000+0000", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Locale locale0 = Locale.ITALY;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      stdDateFormat0.looksLikeISO8601("iKs1pF/;](-ih");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test23()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: en_GB, lenient: false)", "Cannot parse date \"%s\": invalid fractional seconds '%s'; can use at most 9 digits");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123("3}u7|vw9%omd", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, 1995);
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("3112-08-09T12:24:00.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"3112-08-09T12:24:00.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test48()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1767), (-910), (-1767));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0052-04-28T00:00:00.000+0000", string0);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=899,errorIndex=899]", parsePosition0.toString());
      assertEquals(899, parsePosition0.getErrorIndex());
  }

  @Test(timeout = 4000)
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-14), "pd917D%D2");
      ...
      stdDateFormat1._parseDate("?,hAz[7!S%/AppF+tv%", parsePosition0);
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat1._parseDate("]HI-=a L}y0q}=a`Ht", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000--0ug0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000--0ug0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0vo2%aARX_F");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0vo2%aARX_F\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("6@i]Sz8*5!e`w", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.equals("4<i7B,{g$,");
      assertFalse(boolean0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-617), "0000-00-00");
      Locale locale0 = Locale.ITALIAN;
      Boolean boolean0 = Boolean.TRUE;
      ...
      assertEquals("2014-02-14T20:21:20.703-00:00", string0);
  }

  @Test(timeout = 4000)
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1594), (-353), 17, 114, 2008);
      StringBuffer stringBuffer0 = new StringBuffer();
      ...
      assertEquals("0276-08-23T03:28:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      ...
      assertNotNull(date0);
      assertEquals("java.text.ParsePosition[index=899,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("4<i7B,{g$,", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test71()  throws Throwable  {
      ...
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1901-03-02T00:00:00.000+00:00", string0);
  }
  ...
  public void test72()  throws Throwable  {
      ...
      String string0 = stdDateFormat1.format(date0);
      assertEquals("2014-02-14T20:21:20.703-0000", string0);
  }
  ...
  public void test77()  throws Throwable  {
      Locale locale0 = Locale.FRENCH;
      Boolean boolean0 = Boolean.FALSE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-6369), "|b@");
  ...
  public void test84()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3249), "");
      Locale locale0 = Locale.ITALIAN;
      Boolean boolean0 = Boolean.FALSE;
  ...
  public void test91()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(20, "Cannot parse date \"%s\", problem: %s");
      Locale locale0 = Locale.ITALY;
