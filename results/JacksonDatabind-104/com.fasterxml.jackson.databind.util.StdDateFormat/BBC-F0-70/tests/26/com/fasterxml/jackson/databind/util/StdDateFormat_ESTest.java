...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseAsISO8601("fgPxB(", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"fgPxB(\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test05()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("5z7*Y~sYB", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("~4>8-^5", (ParsePosition) null);
  ...
  public void test08()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofHoursMinutesSeconds(0, 36, 0);
      ...
      assertEquals("1970-01-01T00:36:00.000+0036", stringBuffer0.toString());
      assertEquals("1970-01-01T00:36:00.000+0036", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("$`8[V<");
  ...
  public void test13()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("Qd?Tlbl_M", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(69, "\" can not be represented as BigDecimal");
      Locale locale0 = Locale.TAIWAN;
  ...
  public void test17()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("2");
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-474), ")88Uv3");
      Locale locale0 = Locale.TAIWAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
  ...
  public void test20()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(15, "BdjMo5A50UGcn");
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(323, "7,fO*z7[");
  ...
  public void test22()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-2554), (-2554), (-2554), (-2554), (-2554));
      StringBuffer stringBuffer0 = new StringBuffer("");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0);
      stdDateFormat0.instance.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0876-11-14T19:26:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(765);
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("bu'K7On@&D7\"p");
  ...
  public void test39()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("}f7JzJzOW-Y:");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      // Undeclared exception!
      try { 
  ...
  public void test44()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("1224-02-07T00:00:00.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"1224-02-07T00:00:00.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test47()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("\"`T<ReiM,k", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"\"`T<ReiM,k\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test50()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-4826));
      // Undeclared exception!
      try { 
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("4j*", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-.0-00b00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-.0-00b00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("4FQqvNQ<9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4FQqvNQ<9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-2033), 1458, 1458, (-4826), 1924);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0010-12-10T06:04:00.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      MockDate mockDate0 = new MockDate(2279, (-847), 43, 43, 10, (-1481));
      TimeZone timeZone0 = TimeZone.getTimeZone("$`8[V<");
      Locale locale0 = Locale.ROOT;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("4108-07-14T18:45:19.000+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test65()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1000, ")88Uv3");
      MockDate mockDate0 = new MockDate();
      Locale locale0 = Locale.JAPAN;
      Boolean boolean0 = Boolean.valueOf(")88Uv3");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, false);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertFalse(stdDateFormat1.isLenient());
      assertEquals("2014-02-14T20:21:22.320+00:00", string0);
  }
  ...
  public void test66()  throws Throwable  {
      ...
      Locale locale0 = Locale.TAIWAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      MockDate mockDate0 = new MockDate(1074, (-847), 1458, 2014, 2014, 1074);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2907-08-21T07:51:53.526-0000", string0);
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(4);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4, "0000-0F-00", 4, 4, 4, 4, 4, 4, 4, 4, 4);
  ...
  public void test75()  throws Throwable  {
      ...
      StdDateFormat.getRFC1123Format(timeZone1, locale0);
