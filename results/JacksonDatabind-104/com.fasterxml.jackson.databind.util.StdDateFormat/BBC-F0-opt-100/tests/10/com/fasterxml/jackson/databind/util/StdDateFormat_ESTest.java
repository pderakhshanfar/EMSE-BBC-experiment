...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("DjG1HI--gI");
      ...
      try { 
        ...
        fail("Expecting exception: ParseException");
         ...
         //
         // Cannot parse date \"+0000\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("=}0BtbS7= Zf", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"=}0BtbS7= Zf\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("d90oPQs$6IJTz9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"d90oPQs$6IJTz9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("0000-00-00T00:L0");
        fail("Expecting exception: ParseException");
  ...
  public void test11()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("*(y/q.d\"^:,iIO~u");
  ...
  public void test12()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("g.t;|;`6rC49rM", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test38()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StringBuffer stringBuffer0 = new StringBuffer(270);
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("10R", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-2943), (-2943), (-2943), 3, 3);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0._parseDate("0000-00-00T00:L0", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-00T00:L0\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test46()  throws Throwable  {
      Locale locale0 = new Locale("nSDjG1HI--gI");
      Boolean boolean0 = new Boolean("nSDjG1HI--gI");
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0, false);
      ParsePosition parsePosition0 = new ParsePosition((-3398));
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("i -eI\"$-/t!A!Ye", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("00m0-u00-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00m0-u00-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(4514);
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parseObject("8jUq~yU`hJMf-", parsePosition0);
      assertEquals(4514, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=4514,errorIndex=4514]", parsePosition0.toString());
  }
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.equals("O&o'Q<P@=efeyP>");
      assertFalse(boolean0);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("Mon Nov 18 00:00:00 GMT 3535", date0.toString());
  }

  @Test(timeout = 4000)
  public void test61()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2041), "z");
      ...
      assertEquals("2014-02-14T20:21:19.279-00:00", stringBuffer0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      Locale locale0 = Locale.GERMANY;
      MockDate mockDate0 = new MockDate(1634, 1, 656);
      StringBuffer stringBuffer0 = new StringBuffer("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ3535-11-18T00:00:00.001+0000", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-5668));
      // Undeclared exception!
      try { 
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(9);
      Date date0 = stdDateFormat0._parseDate("M4T>K)bm%R!}E}n3%]", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000'Y-00-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000'Y-00-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test73()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      TimeZone timeZone0 = TimeZone.getTimeZone("IcjG+'K0;");
  ...
  public void test76()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("M4T>K)bm%R!}E}n3%]");
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(timeZone0);
      ParsePosition parsePosition0 = new ParsePosition(9);
      stdDateFormat1._parseDate("M4T>K)bm%R!}E}n3%]", parsePosition0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
      assertNotSame(stdDateFormat1, stdDateFormat0);
  }
  ...
  public void test78()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1791), "0000-00-00T00:00");
      stdDateFormat0.setTimeZone(simpleTimeZone0);
      MockDate mockDate0 = new MockDate((-1791), (-1791), (-1791), 10, (-1791));
      ...
      assertEquals("0047-11-03T04:08:58.209-0000", stringBuffer0.toString());
  }
