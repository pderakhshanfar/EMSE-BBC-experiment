...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("y", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test06()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(48);
      stdDateFormat0.parse("`47g[hyDc<*", parsePosition0);
  ...
  public void test07()  throws Throwable  {
      ...
      assertNotNull(date0);
      assertEquals("java.text.ParsePosition[index=2798,errorIndex=-1]", parsePosition0.toString());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("1403-08-11T15:23:00.000+0000");
      assertTrue(boolean0);
  }
  ...
  public void test12()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3467, "', '");
  ...
  public void test13()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("OjPq[pLe/gHU9wu");
  ...
  public void test15()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(93, "ol;");
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=1392409281320,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=java.util.SimpleTimeZone[id=ol;,offset=93,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2014,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=45,DAY_OF_WEEK=6,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=8,HOUR_OF_DAY=20,MINUTE=21,SECOND=21,MILLISECOND=320,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123("3Gac$~uY", parsePosition0);
  ...
  public void test40()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      TimeZone timeZone0 = TimeZone.getDefault();
      StringBuffer stringBuffer0 = new StringBuffer("W9'{sn.pw[%yx");
      Locale locale0 = Locale.CANADA_FRENCH;
      // Undeclared exception!
      try { 
  ...
  public void test44()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("&6h", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"&6h\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test47()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-l0-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-l0-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test48()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("8b*4# PC", parsePosition0);
      try { 
        stdDateFormat0.parse("8b*4# PC");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"8b*4# PC\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      ...
      Locale locale0 = new Locale("9h9P_-bp1/rJ8]sZUT", "9h9P_-bp1/rJ8]sZUT", "9h9P_-bp1/rJ8]sZUT");
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      try { 
        stdDateFormat0.parseObject("9h9P_-bp1/rJ8]sZUT");
        fail("Expecting exception: ParseException");
  ...
  public void test54()  throws Throwable  {
      ...
      Locale locale0 = Locale.JAPAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
      MockDate mockDate0 = new MockDate((-1684), (-1684), (-1684), 45, 0);
      StringBuffer stringBuffer0 = new StringBuffer("");
      stdDateFormat0._format(zoneInfo0, (Locale) null, mockDate0, stringBuffer0);
      assertEquals("0071-01-21T21:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Locale locale0 = Locale.CHINESE;
      MockDate mockDate0 = new MockDate(46, 43, 9, 2709, 1000);
      StringBuffer stringBuffer0 = new StringBuffer();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(21, "\" can not be represented as BigDecimal");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      stdDateFormat1._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1949-11-30T13:40:00.021+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(45, 57, (-1476), 48, (-3339));
      StringBuffer stringBuffer0 = new StringBuffer("XwoI\"# jD=");
      ...
      assertEquals("Fri Sep 14 16:21:00 GMT 1945", mockDate0.toString());
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("XYEkU+$SoNs]9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"XYEkU+$SoNs]9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test73()  throws Throwable  {
      Locale locale0 = new Locale(")[@gHpg%e^Al", "", "fzqc7=Vg!xU;*v/{ya");
  ...
  public void test74()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3580), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = new Locale("0000-00-00", "</|8(UKWdD^$sXx %W%");
  ...
  public void test75()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "com.fasterxml.jackson.databind.util.StdDateFormat", 2429, 0, 2429, 2429, (-854), 0, 45, 9);
  ...
  public void test78()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1684), "S?R6(657Hr");
  ...
  public void test81()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("0G00-00-00T00:00");
        fail("Expecting exception: ParseException");
