...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("dddd[-]dd[-]dd", (ParsePosition) null);
  ...
  public void test11()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("rTg");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1090), "");
  ...
  public void test16()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("9o!k;c", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test51()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(7, 2, (-1506));
      Locale locale0 = Locale.JAPANESE;
      TimeZone timeZone0 = TimeZone.getDefault();
      StringBuffer stringBuffer0 = new StringBuffer("*");
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      ParsePosition parsePosition0 = new ParsePosition((-2815));
      // Undeclared exception!
      try { 
  ...
  public void test53()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("%>.#N_BqKSZ4/", parsePosition0);
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test55()  throws Throwable  {
      ...
      try { 
        stdDateFormat1._parseAsISO8601("55bC", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"55bC\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parse("5LyZ|$&iwq``:(F\"jz", parsePosition0);
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("yT2mn:0", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1898), 188, (-1898));
      Locale locale0 = Locale.JAPANESE;
      TimeZone timeZone0 = TimeZone.getDefault();
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "*");
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("*0012-06-20T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate((-1898), (-1898), 10);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1660, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.JAPANESE;
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat1._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0158-11-10T00:00:01.660+00:00", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.FRENCH;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-409), "0000-00-00");
      MockDate mockDate0 = new MockDate((-409));
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1969-12-31T23:59:59.182-0000", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(48, 48, (-3765), 48, (-3765), 48);
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("U9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"U9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("00}0-I-00T030:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00}0-I-00T030:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test71()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(2);
      stdDateFormat0.parse("0000-0-00T0:00", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test85()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "', '", 0, 0, 48, 48, 48, 48, 0, 67, 67, 642, 9);
      Locale locale0 = Locale.JAPANESE;
      Boolean boolean0 = Boolean.FALSE;
  ...
  public void test86()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"UTC\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: fr_FR, lenient: false)", string0);
  }

  @Test(timeout = 4000)
  public void test87()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("0037-00-00");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }

  @Test(timeout = 4000)
  public void test88()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(2313);
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = new Boolean("?T");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
  ...
  public void test90()  throws Throwable  {
      ...
      Locale locale0 = new Locale("!k=%+`F1[");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
