...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0006-00-09");
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("h2 4Bb", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"h2 4Bb\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? true)
         //
  ...
  public void test03()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("<w{E4fS");
  ...
  public void test05()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "", 0, 0, 45, 0, 0, 0, 0, (-1236), (-1236), 0, 278);
  ...
  public void test06()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-442), "+0000");
  ...
  public void test08()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-6), "B)&R");
      Boolean boolean0 = Boolean.valueOf(true);
  ...
  public void test09()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.instance.parseAsRFC1123(",ZBYie04Fbk}V", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("SHTjbYo(*SP:Y8O");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
  ...
  public void test24()  throws Throwable  {
      Locale locale0 = new Locale("", "", "");
      Boolean boolean0 = Boolean.valueOf(true);
      TimeZone timeZone0 = TimeZone.getTimeZone("BTG3kXFqXlXwHPR");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition((-1));
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("UX`3TXWw", parsePosition0);
  ...
  public void test26()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1998, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("N~(qr/GM_%Qj<IQR\"X", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1870), (-18), (-10), (-1842), (-3269));
  ...
  public void test38()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0._parseDate("0000-0r0-00T00:00", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-0r0-00T00:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("0000-r0-00T6;0:0", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test44()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      MockDate mockDate0 = new MockDate((-1803), (-1241), 45, 56, (-1241));
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, false);
      ParsePosition parsePosition0 = new ParsePosition((-2797));
  ...
  public void test50()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      try { 
        stdDateFormat0.parse("a:=Dy");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"a:=Dy\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test53()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-3590));
      // Undeclared exception!
      try { 
  ...
  public void test57()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, (Boolean) null, true);
      try { 
        stdDateFormat0.parse("699n/DGHO3p1rm");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"699n/DGHO3p1rm\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("K]AO[#W9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"K]AO[#W9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      ...
      boolean boolean2 = stdDateFormat1.equals(stdDateFormat0);
  ...
  public void test69()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("6k!0$ ]uXp&q\"J");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"6k!0$ ]uXp&q\"J\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test71()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-1837), (-1837), 938, 8, 1619);
      ...
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0089-06-26T10:59:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test72()  throws Throwable  {
      ...
      Locale locale0 = new Locale("");
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(53, 53, (-2924), (-2924), (-1601), 2);
      stdDateFormat0.format((Date) mockDate0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(false);
      Boolean boolean0 = new Boolean("N7f,js2lut\"]:!zb");
      ...
      stdDateFormat4.setTimeZone(timeZone0);
      DateFormat.getDateInstance();
      stdDateFormat4.isColonIncludedInTimeZone();
      assertFalse(stdDateFormat1.isLenient());
  ...
  public void test75()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Locale locale0 = new Locale("]G~:D>BC}~", "]G~:D>BC}~", "]G~:D>BC}~");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      assertNotSame(stdDateFormat1, stdDateFormat0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  }
