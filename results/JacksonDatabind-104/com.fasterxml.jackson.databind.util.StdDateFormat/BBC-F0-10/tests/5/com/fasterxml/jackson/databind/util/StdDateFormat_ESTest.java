...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      Locale locale0 = new Locale("Y'-/5GLXE");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      MockDate mockDate0 = new MockDate(1, 43, 6, 3, 2004, 369);
  ...
  public void test15()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-2019));
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = new Locale("Y'-/5GLXE");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-948), "00L0-00-00");
      Locale locale0 = Locale.GERMAN;
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "Value \"", 0, 0, 0, 0, 0, 0, 4, (-994), 4);
  ...
  public void test20()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("F:Wb-B_$");
      Locale locale0 = new Locale("F:Wb-B_$");
  ...
  public void test21()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("z`7!3bN");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, true);
  ...
  public void test22()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("~.b!AnmM0!=t6Yvz#rVg", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      stdDateFormat2.equals(stdDateFormat1);
  ...
  public void test27()  throws Throwable  {
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(400, 1000, 57, (-1477), 400);
      boolean boolean0 = StdDateFormat._equals((Object) ".LVge2FD_q'crS", (Object) mockGregorianCalendar0);
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse(">\".#8ls", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test36()  throws Throwable  {
      Locale locale0 = Locale.PRC;
      Boolean boolean0 = Boolean.valueOf("&ZTLBXQ\"");
  ...
  public void test38()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("3J[;Ux=DHvVw4o'@w#");
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0._parseDate("0000-00-00T_0:00", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-00T_0:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("63o)ZE|*", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test41()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = Locale.KOREA;
      Boolean boolean0 = new Boolean("gPp2fBZPH;G<");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
  ...
  public void test44()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(57, (-761), 45, 4, 45);
      // Undeclared exception!
      try { 
  ...
  public void test50()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      try { 
        stdDateFormat0.parse("oj[8c'Z");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"oj[8c'Z\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-2496));
      try { 
  ...
  public void test55()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(3122);
      // Undeclared exception!
      try { 
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("00%0-S0-0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00%0-S0-0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      boolean boolean1 = stdDateFormat0.looksLikeISO8601("1RHaAWX|FdS_0C+");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertFalse(stdDateFormat0.isLenient());
      assertFalse(boolean1);
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("Pz=RAnb:XMU_:992");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"Pz=RAnb:XMU_:992\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-2019), 751, 6, 3, 2004, 369);
      // Undeclared exception!
      try { 
  ...
  public void test62()  throws Throwable  {
      ...
      Locale locale0 = Locale.KOREA;
      Boolean boolean0 = new Boolean("|KlI74#");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("1969-12-31T23:59:58.586+00:00", stringBuffer0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      zoneInfo0.setRawOffset(94);
      MockDate mockDate0 = new MockDate(751, 6, 94, 3231, 1, 11);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("2652-02-13T15:01:11.094+00:00", string0);
  }
  ...
  public void test65()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate((-948), (-1687), (-948));
      stdDateFormat0.format((Date) mockDate0);
  }
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("5-]4%V3=X2[*=N3 ^>j");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"5-]4%V3=X2[*=N3 ^>j\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test69()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(16, 16, 16, 90, (-54), 90);
      stdDateFormat0.format((Date) mockDate0);
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parse("0000-00-00T_0:00", (ParsePosition) null);
  }
  ...
  public void test75()  throws Throwable  {
      ...
      Locale locale0 = new Locale("Y'-/5GLXE");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      TimeZone timeZone1 = TimeZone.getTimeZone("Y'-/5GLXE");
