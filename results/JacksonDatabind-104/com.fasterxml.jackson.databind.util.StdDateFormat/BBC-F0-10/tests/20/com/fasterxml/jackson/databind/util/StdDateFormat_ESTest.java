...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("\uC138\uACC4 \uD45C\uC900\uC2DC", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"\uC138\uACC4 \uD45C\uC900\uC2DC\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0GC7)dO,Nu");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0GC7)dO,Nu\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("pO?5tb");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"pO?5tb\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(10, "&+HV -X,X");
  ...
  public void test08()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("D2!|R%_!)src9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test09()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0000-00-00:0");
        fail("Expecting exception: ParseException");
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(57, "5");
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      simpleTimeZone0.setRawOffset((-2059));
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals(2493, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=2493,errorIndex=2493]", parsePosition0.toString());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=1392409281320,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=java.util.SimpleTimeZone[id=yyyy-MM-dd'T'HH:mm:ss.SSSZ,offset=6,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2014,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=45,DAY_OF_WEEK=6,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=8,HOUR_OF_DAY=20,MINUTE=21,SECOND=21,MILLISECOND=320,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals((Object) "0000-00-00T00:00", (Object) "&+HV -X,X");
      assertFalse(boolean0);
  }
  ...
  public void test34()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("com.fasterxml.jackson.core.io.NumberInput", "'WGgHtRhU2");
  ...
  public void test42()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(2348, 1577, 41);
  ...
  public void test43()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.instance._parseDate("0000-00-00Tr00:00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-00Tr00:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("\uC138\uACC4 \uD45C\uC900\uC2DC", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test56()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(10, "&+HV.,6X");
      Locale locale0 = Locale.US;
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(36);
      stdDateFormat0.parseAsRFC1123("&+HV.,6X", parsePosition0);
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("9~E8-jSmN'}r");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9~E8-jSmN'}r\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(10);
      stdDateFormat0.parse("0|0.0[0-00", parsePosition0);
  ...
  public void test62()  throws Throwable  {
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "&+i# -m,X");
      ...
      assertEquals("&+i# -m,X2014-02-14T20:21:21.320+00:00", stringBuffer0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2289), "+0000");
      Locale locale0 = Locale.KOREAN;
      stdDateFormat0.instance._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("2014-02-14T20:21:19.031-0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1696), (-1696), (-3023));
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("0054-05-22T00:00:00.000+0000", string0);
  }
  ...
  public void test65()  throws Throwable  {
      ...
      assertEquals("2014-02-14T20:21:21.365+00:00", stringBuffer0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(10, "&+HV -X,X");
      Locale locale0 = Locale.CHINA;
      Boolean boolean0 = Boolean.valueOf("&+HV -X,X");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(10);
  ...
  public void test77()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      SimpleTimeZone simpleTimeZone1 = new SimpleTimeZone(10, "&+HV.,6X");
  ...
  public void test81()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(10, "&+i# -m,X");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
  ...
  public void test86()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.instance.parse("0000-01-00", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertNotNull(date0);
