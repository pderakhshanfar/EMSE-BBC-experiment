...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("WWD/BqY&fvx", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"WWD/BqY&fvx\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
  ...
  public void test04()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0PF0#P-00-00T00:00");
        fail("Expecting exception: ParseException");
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("w0V_%*eY+.|9", parsePosition0);
  ...
  public void test07()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-247), (-247), 12);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1119, "0000-00-00");
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(simpleTimeZone0, (Locale) null, mockDate0, stringBuffer0);
      assertEquals(28, stringBuffer0.length());
      assertEquals("1632-06-12T00:00:01.119+0000", stringBuffer0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("0040-00-00", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      stdDateFormat0.parse("0PF0-00-00T00:00", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test16()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("kYu]S;");
  ...
  public void test21()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer("oJh&JBQe:1hl#a'4");
      FieldPosition fieldPosition0 = new FieldPosition(94);
      stdDateFormat0.instance.format(date0, stringBuffer0, fieldPosition0);
      assertEquals("oJh&JBQe:1hl#a'42014-02-14T20:21:21.320+0000", stringBuffer0.toString());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("/P,XXYd$E.nn_", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"/P,XXYd$E.nn_\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StdDateFormat.getISO8601Format(stdDateFormat0._timezone, (Locale) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test42()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0PF0-00-00T00:0r", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0PF0-00-00T00:0r\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate(";Wrsnn]", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test44()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("j[SL@[q),v4", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test52()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      try { 
        stdDateFormat0.parse("VAj9+`k/8;W+");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"VAj9+`k/8;W+\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("3pS/lrhUgImXPSY");
        fail("Expecting exception: ParseException");
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(47);
      Date date0 = stdDateFormat0._parseDate("CBffJP5#^]jSkdsp", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.equals("0PF0-00-00T00:0r");
      assertFalse(boolean0);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      assertEquals("1969-12-31T23:59:59.836+00:00", string0);
  }
  ...
  public void test65()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0._timezone = (TimeZone) simpleTimeZone0;
      MockDate mockDate0 = new MockDate((-2200), 116, 3);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0292-09-03T00:00:00.003+0000", string0);
  }

  @Test(timeout = 4000)
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1766), (-1766), (-10), (-1766), 2391);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0015-08-10T01:51:00.000+0000", string0);
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0RN0--0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0RN0--0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test72()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2200), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      MockDate mockDate0 = new MockDate((-2200), (-2200), 948, (-2200), (-2200), 948);
      Locale locale0 = Locale.US;
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0482-01-02T19:35:45.800-00:00", string0);
  }
  ...
  public void test78()  throws Throwable  {
      Locale locale0 = Locale.UK;
      Boolean boolean0 = new Boolean("N?Yjw5iI");
  ...
  public void test85()  throws Throwable  {
      ...
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: en_GB, lenient: false)", string0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
