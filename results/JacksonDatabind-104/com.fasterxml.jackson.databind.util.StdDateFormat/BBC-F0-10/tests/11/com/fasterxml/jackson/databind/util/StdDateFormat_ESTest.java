...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("^:l1>`+H*5u$M|", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"^:l1>`+H*5u$M|\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
  ...
  public void test05()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, ";GocKsJb3pmM,", 0, 0, 0, 3, 0, 3, 0, 3);
  ...
  public void test08()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("l^=6");
  ...
  public void test10()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.parse("0#&0-00-00T00:00", (ParsePosition) null);
      assertTrue(stdDateFormat0.isLenient());
  }
  ...
  public void test12()  throws Throwable  {
      Locale locale0 = Locale.FRANCE;
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Boolean boolean0 = new Boolean(":?0g_]$5LkICi'");
  ...
  public void test13()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2885), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test19()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("5Yu", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test24()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("Cannot parse date \"%s\": not compatible with any of standard forms (%s)", "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123(":?0g_]$5LkICi'", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1263), " O;rJA};7RJ|5W0cJ%_");
      Locale locale0 = new Locale(" O;rJA};7RJ|5W0cJ%_", " O;rJA};7RJ|5W0cJ%_");
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse(" O;rJA};7RJ|5W0cJ%_", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test37()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1913), (-829), 45, 300, 5, 6);
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("m5", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("m5", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test52()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(184);
      try { 
        stdDateFormat1._parseAsISO8601("%Yz7pj!<m!|v ;)F\"\"", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"%Yz7pj!<m!|v ;)F\"\"\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test53()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
      try { 
        stdDateFormat0.parse("0000-l0-00T00:0 ");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-l0-00T00:0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("3!DBTmx^");
      assertFalse(boolean0);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      Object object0 = stdDateFormat0.parseObject("9CQKNX$2xREm", parsePosition0);
      boolean boolean1 = stdDateFormat0.equals(object0);
      assertEquals("java.text.ParsePosition[index=935,errorIndex=935]", parsePosition0.toString());
      assertFalse(boolean1);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag("Qv[Gw'HPN");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
  ...
  public void test60()  throws Throwable  {
      ...
      assertEquals("1970-01-01T00:00:00.012+00:00", stringBuffer0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1969-12-31T23:59:55.119-0000", stringBuffer0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-1913), (-829), (-2593), (-1913), 45, (-829));
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0091-08-06T07:31:11.000+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test63()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(9, "yyyy-MM-dd");
      Locale locale0 = Locale.ROOT;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      MockDate mockDate0 = new MockDate(6, 1027, 57, 1439, (-970), 117);
      FieldPosition fieldPosition0 = new FieldPosition(6);
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("1991-11-24T06:51:57.009+0000", stringBuffer0.toString());
      assertEquals("1991-11-24T06:51:57.009+0000", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("13", (ParsePosition) null);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("@d:&OC9 ");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"@d:&OC9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("4hd6+\"@+imt}f");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4hd6+\"@+imt}f\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test72()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(5, ";GocKsJb3pmM,", 5, 5, 5, 3, 5, 3, 5, 3);
      Locale locale0 = Locale.CANADA;
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-1681), 3, (-1681), 9, 9, 13);
      Date date0 = mockGregorianCalendar0.getGregorianChange();
      // Undeclared exception!
      try { 
        stdDateFormat1._format(simpleTimeZone0, locale0, date0, (StringBuffer) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test78()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"UTC\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: en_US, lenient: null)", parsePosition0);
