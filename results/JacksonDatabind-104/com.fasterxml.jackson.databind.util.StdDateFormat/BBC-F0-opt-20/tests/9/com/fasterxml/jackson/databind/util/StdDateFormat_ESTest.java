...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("OWzS&Sj", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"OWzS&Sj\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test02()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      ParsePosition parsePosition0 = new ParsePosition(96);
      stdDateFormat0.parseObject("OWzS&Sj", parsePosition0);
  ...
  public void test08()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0z00-00-00", parsePosition0);
  ...
  public void test10()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.JAPANESE;
      Boolean boolean0 = new Boolean("}(FI1EutE]FBt:");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test12()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2147483645, "H}Rj'");
      Locale locale0 = Locale.PRC;
      Boolean boolean0 = Boolean.valueOf("R.>d}g6+^hzgkS");
  ...
  public void test15()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("c 9", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test18()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = Locale.KOREA;
      Boolean boolean0 = Boolean.valueOf("f(<X>QwA[.>}");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, true);
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("7q={;`N", parsePosition0);
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance._parseDate("DateFormat %s: (timezone: %s, locale: %s, lenient: %s)", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test35()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(4905);
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      ...
      Locale locale0 = Locale.CANADA_FRENCH;
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(0, 48, 48, 15, 0, 4);
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-504), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.JAPANESE;
      StringBuffer stringBuffer0 = new StringBuffer();
      MockDate mockDate0 = new MockDate();
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("2014-02-14T20:21:20.816-0000", stringBuffer0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("t,lG", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test50()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-j0-b0:T00100");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-j0-b0:T00100\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test51()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0z00\"02-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0z00\"02-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test52()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0);
      try { 
        stdDateFormat0.parseObject("6N%%}v~'");
        fail("Expecting exception: ParseException");
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1805), (-1295), 3, 48, 912, (-1805));
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, (-599));
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0014-02-05T14:41:55.000+0000", stringBuffer0.toString());
  }
  ...
  public void test59()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(101, "DateFormat %s: (timezone: %s, locale: %s, lenient: %s)");
      Locale locale0 = Locale.KOREAN;
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, false);
      MockDate mockDate0 = new MockDate(112, 101, 112, 101, 112, (-5126));
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=DateFormat %s: (timezone: %s, locale: %s, lenient: %s),offset=101,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0], locale: zh_TW, lenient: false)");
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals(426, stringBuffer0.length());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=DateFormat %s: (timezone: %s, locale: %s, lenient: %s),offset=101,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0], locale: zh_TW, lenient: false)2020-09-24T05:26:34.101+0000", stringBuffer0.toString());
  }
  ...
  public void test60()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("z3", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test65()  throws Throwable  {
      ...
      try { 
        stdDateFormat2._parseAsISO8601("VSj", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"VSj\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test66()  throws Throwable  {
      ...
      ParsePosition parsePosition1 = new ParsePosition(61);
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(61, "Value \"");
      stdDateFormat0.instance.setTimeZone(simpleTimeZone0);
      try { 
        stdDateFormat0._parseAsISO8601("2.2250738585072012e-308", parsePosition1);
        fail("Expecting exception: ParseException");
  ...
  public void test68()  throws Throwable  {
      ...
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=DateFormat %s: (timezone: %s, locale: %s, lenient: %s),offset=101,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0], locale: zh_TW, lenient: false)2020-09-24T05:26:34.101+00:00", stringBuffer0.toString());
  }
  ...
  public void test75()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      Boolean boolean0 = new Boolean("5_bdYDxC");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
  ...
  public void test82()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("3000-00-22", parsePosition0);
      assertNotNull(date0);
      assertEquals((-1), parsePosition0.getErrorIndex());
  }
