...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("&q'qqR\",S");
      ...
      stdDateFormat0.instance.parse("lenient", parsePosition0);
  ...
  public void test03()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("+Czny;|.Z,CV6n]dF9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(218, 213, (-3075));
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals(28, stringBuffer0.length());
      assertEquals("2127-04-30T00:00:00.000+0000", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(87, "3|ns(c");
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1), "RS@#BKGt");
  ...
  public void test20()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.instance._parseDate("3|ns(c", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=java.util.SimpleTimeZone[id=3|ns(c,offset=87,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=?,MONTH=?,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=?,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=?,HOUR=?,HOUR_OF_DAY=?,MINUTE=?,SECOND=?,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("-}`BZbNN%OLU(zY)m");
      Locale locale0 = Locale.CHINESE;
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
  ...
  public void test25()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("Igt", "+k\"}f-Z8$vX-f=@R2[A");
  ...
  public void test27()  throws Throwable  {
      ...
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Boolean boolean0 = new Boolean(">yGi] wt;4Mkt");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(3360);
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      String string0 = "0000-00-00T0X:00";
      ParsePosition parsePosition0 = new ParsePosition(43);
      try { 
        stdDateFormat0._parseDate("0000-00-00T0X:00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-00T0X:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test47()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Locale locale0 = Locale.CANADA;
      MockDate mockDate0 = new MockDate((-1000), (-1000), 1853, (-1092), (-1092), 87);
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.instance.parse("Cannot parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)");
        fail("Expecting exception: ParseException");
  ...
  public void test56()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("5ax0#dZ8%[#");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"5ax0#dZ8%[#\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, (Locale) null, boolean0, false);
      try { 
        stdDateFormat0._parseAsISO8601("2;8(=ie7g", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"2;8(=ie7g\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? true)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("8Gaj3*MvLvTs?+)* ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.equals(";r],_lK&g'");
      assertFalse(boolean0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test64()  throws Throwable  {
      ...
      Locale locale0 = Locale.ITALIAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, (Boolean) null);
      Boolean boolean0 = Boolean.valueOf(";k9XmLOZFg@ wmH3EQL");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1879), 2, 16);
      // Undeclared exception!
      try { 
  ...
  public void test67()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(")]");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate(0, 1139, 2, 0, 545, 19);
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1994-12-02T09:05:19.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      ...
      assertEquals("2014-02-14T20:21:21.407+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test69()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-403), "&q'qqR\",S");
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, (Locale) null, boolean0, false);
      Date date0 = stdDateFormat0._parseAsISO8601("0000-00-00", (ParsePosition) null);
      String string0 = stdDateFormat0.format(date0);
      assertEquals("2014-02-14T20:21:20.917-0000", string0);
  }
  ...
  public void test72()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("&q'q\",S");
      Locale locale0 = Locale.ITALIAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, (Boolean) null);
      MockDate mockDate0 = new MockDate(0, 0, 0, 0, 0);
      String string0 = stdDateFormat0.instance.format((Date) mockDate0);
      Boolean boolean0 = Boolean.valueOf(stdDateFormat0.DATE_FORMAT_STR_ISO8601);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
      ParsePosition parsePosition0 = null;
      Date date0 = stdDateFormat1.parse(string0, parsePosition0);
      assertNull(date0);
  }
  ...
  public void test74()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.JAPAN;
      Boolean boolean0 = new Boolean("Greenwich Mean Time");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test81()  throws Throwable  {
      ...
      boolean boolean0 = stdDateFormat1.equals(stdDateFormat2);
  ...
  public void test88()  throws Throwable  {
      Locale locale0 = Locale.CHINESE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(43, ";r],_lK&g'");
  ...
  public void test90()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "o8n AOh&");
