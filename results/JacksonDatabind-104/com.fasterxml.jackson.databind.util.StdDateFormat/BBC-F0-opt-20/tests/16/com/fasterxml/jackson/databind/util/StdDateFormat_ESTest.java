...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("9005-00-00");
      //  // Unstable assertion: assertEquals("Wed Dec 31 23:59:59 GMT 1969", date0.toString());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601(";=,~Hjro__", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \";=,~Hjro__\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test06()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("~M8n=KOMzVnpaXL]9", parsePosition0);
      assertNull(date0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2227), "Value \"");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseObject("1970-01-01T00:00:00.321+0000");
        fail("Expecting exception: ParseException");
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2720, "balue s");
      Locale locale0 = new Locale("balue s", "balue s", "balue s");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
  ...
  public void test20()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1607), ">@t~H`F7(|{>R2FtJ");
  ...
  public void test25()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("balue s", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test44()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      MockDate mockDate0 = new MockDate(100, 19, 1268, 36, (-1605), (-214));
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(2720);
      try { 
        stdDateFormat0._parseDate("4842-10-25T00:00:02.720+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"4842-10-25T00:00:02.720+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test46()  throws Throwable  {
      ...
      Locale locale0 = Locale.CANADA_FRENCH;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-3854));
      // Undeclared exception!
      try { 
  ...
  public void test47()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(240, "Value \"");
      Locale locale0 = Locale.CHINA;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        stdDateFormat0._parseAsISO8601(".IBWnc-T", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \".IBWnc-T\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test51()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(240, "balue s");
      Locale locale0 = new Locale("balue s", "balue s", "balue s");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
  ...
  public void test53()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(604, 1008, 1503, (-1408), 90, 1008);
      // Undeclared exception!
      try { 
        stdDateFormat0.instance._format((TimeZone) null, locale0, mockDate0, (StringBuffer) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test60()  throws Throwable  {
      ...
      try { 
        stdDateFormat2.parse("yz=");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"yz=\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-2646));
      try { 
        stdDateFormat0.parseAsISO8601("", parsePosition0);
        fail("Expecting exception: ParseException");
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0000-[00g00");
        fail("Expecting exception: ParseException");
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("9|A9$yN");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9|A9$yN\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test66()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.instance.parse("5M9zT6lL;u ");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"5M9zT6lL;u\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test72()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2747, "balu s");
      MockDate mockDate0 = new MockDate(2747, 1026, (-838));
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      ...
      assertEquals("4730-03-15T00:00:02.747+00:00", string0);
  }
  ...
  public void test73()  throws Throwable  {
      ...
      assertEquals("1969-12-31T23:59:55.546-0000", string0);
  }

  @Test(timeout = 4000)
  public void test74()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1778), (-2185), (-1778));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0066-01-17T00:00:00.000+0000", string0);
  }
  ...
  public void test76()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("s", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test77()  throws Throwable  {
      ...
      assertNotNull(date0);
      assertEquals("java.text.ParsePosition[index=1719,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test82()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2720, "balue s");
      SimpleTimeZone simpleTimeZone1 = new SimpleTimeZone(2720, "balue s");
      Locale locale0 = Locale.CHINESE;
  ...
  public void test88()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "]TOV(Hm24@zBWbf", 3427, 0, 48, 0, (-1), 4, 1, 4, 1, 1984, 48);
      Locale locale0 = new Locale("]TOV(Hm24@zBWbf", "]TOV(Hm24@zBWbf");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertNotNull(timeZone0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
