...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("#Fh}~_Y,x]1|4?(y", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"#Fh}~_Y,x]1|4?(y\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
  ...
  public void test03()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("8Q.3muf3!((", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseObject("U?:$*#P", parsePosition0);
  ...
  public void test21()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(2687);
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("c&p?@O*>(5]+=#4KS", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1007), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.JAPANESE;
  ...
  public void test38()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer("lcp5p@|YY,t");
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("6zVCJe><oy1:+6(e;V", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test46()  throws Throwable  {
      ...
      assertEquals("1969-12-31T23:59:59.392-0000", stringBuffer0.toString());
  }
  ...
  public void test50()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, (Locale) null, boolean1, false);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
      assertSame(stdDateFormat1, stdDateFormat0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  }
  ...
  public void test52()  throws Throwable  {
      ...
      try { 
        stdDateFormat1.parseObject("Sw\"]y}k:");
        fail("Expecting exception: ParseException");
  ...
  public void test53()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("MJe9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"MJe9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-p-0T\"0p0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-p-0T\"0p0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      Locale locale0 = Locale.ITALIAN;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(57, "yyyy-MM-dd");
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1954), 32, (-1954));
      StringBuffer stringBuffer0 = new StringBuffer(0);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, (FieldPosition) null);
      assertEquals("0058-04-26T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("5B~1+#QS");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"5B~1+#QS\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1585, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.KOREA;
      Boolean boolean0 = new Boolean("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate();
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:22.905+00:00", string0);
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "K{O>4n^#508/");
  ...
  public void test72()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(84, 84, 60);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1991-03-01T00:00:00.000+00:00", string0);
  }
  ...
  public void test82()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(57, "Cannot parse date \"%s\", problem: %s");
      Locale locale0 = Locale.GERMANY;
  ...
  public void test85()  throws Throwable  {
      ...
      stdDateFormat0.parse("0000-00-0T\"0:0", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("java.text.ParsePosition[index=6161,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test87()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=Cannot parse date \"%s\", problem: %s,offset=57,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0], locale: de_DE, lenient: null)", string0);
  }
}
