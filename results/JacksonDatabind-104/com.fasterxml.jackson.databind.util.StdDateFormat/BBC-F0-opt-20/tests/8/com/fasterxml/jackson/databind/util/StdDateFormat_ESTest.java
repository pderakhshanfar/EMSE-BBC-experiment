...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("Coordinated Universal Time", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"Coordinated Universal Time\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
         //
  ...
  public void test04()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("j\"9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"j\"9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      ...
      stdDateFormat0.looksLikeISO8601("ZM/B/7r%");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test13()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3864, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0.setTimeZone(simpleTimeZone0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertEquals("java.util.SimpleTimeZone[id=yyyy-MM-dd'T'HH:mm:ss.SSSZ,offset=3864,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", timeZone0.toString());
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Instant instant0 = MockInstant.ofEpochSecond((-3787L));
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1969-12-31T22:56:53.000+0000", stringBuffer0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1000), "x,]ma6G8-r~`ZsJ$");
      Locale locale0 = Locale.CANADA_FRENCH;
      StdDateFormat.getISO8601Format(simpleTimeZone0, locale0);
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
      stdDateFormat1.instance._getCalendar(simpleTimeZone0);
      stdDateFormat1.toPattern();
      stdDateFormat0._clearFormats();
      simpleTimeZone0.setRawOffset(120);
      Locale locale1 = Locale.FRANCE;
      MockDate mockDate0 = new MockDate(2317L);
  ...
  public void test18()  throws Throwable  {
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=1392409281320,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=java.util.SimpleTimeZone[id=x,]ma6G8-r~`ZsJ$,offset=-1000,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2014,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=45,DAY_OF_WEEK=6,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=8,HOUR_OF_DAY=20,MINUTE=21,SECOND=21,MILLISECOND=320,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      Locale locale0 = new Locale("Ya/vM\"", "com.fasterxml.jackson.core.io.NumberInput");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsISO8601(stringArray0[1], parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test43()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("nqQSz3A>:c-IB!ujU}P");
  ...
  public void test48()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("J{Hfg$=.P");
  ...
  public void test51()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("Ba5$3", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test53()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-b%00-00T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-b%00-00T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("2\"mJOt?0B1kmh&c8C", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test56()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("Zti}.mdQE]|M11");
      Locale locale0 = Locale.CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1927), 0, (-1927), (-2326), 34, 2722);
  ...
  public void test58()  throws Throwable  {
      ...
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      Locale locale0 = Locale.forLanguageTag("DateFormat %s: (timezone: %s, locale: %s, lenient: %s)");
      stdDateFormat1._format(timeZone0, locale0, date0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1969-12-31T22:56:53.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test59()  throws Throwable  {
      ...
      assertEquals("1970-01-01T00:00:00.240+00:00", stringBuffer0.toString());
      assertEquals("1970-01-01T00:00:00.240+00:00", stringWriter0.toString());
  }
  ...
  public void test60()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1970-01-01T00:00:00.240+0000", stringBuffer0.toString());
      assertEquals("1970-01-01T00:00:00.240+0000", stringWriter0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Locale locale0 = Locale.CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      timeZone0.setRawOffset((-399));
      MockDate mockDate0 = new MockDate(867L);
      StringWriter stringWriter0 = new StringWriter(3);
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals(28, stringBuffer0.length());
      assertEquals("1970-01-01T00:00:00.468-0000", stringWriter0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=1208,errorIndex=1208]", parsePosition0.toString());
      assertEquals(1208, parsePosition0.getErrorIndex());
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0Y00&-00-00T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0Y00&-00-00T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test66()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition((-2828));
      try { 
        stdDateFormat0.parseAsISO8601("' (", parsePosition0);
        fail("Expecting exception: ParseException");
  ...
  public void test68()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("z1{L?D_gM^#");
  ...
  public void test81()  throws Throwable  {
      ...
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: zh, lenient: null)", string0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test84()  throws Throwable  {
      ...
      assertNotNull(date0);
      assertEquals("java.text.ParsePosition[index=659,errorIndex=-1]", parsePosition0.toString());
  }
}
