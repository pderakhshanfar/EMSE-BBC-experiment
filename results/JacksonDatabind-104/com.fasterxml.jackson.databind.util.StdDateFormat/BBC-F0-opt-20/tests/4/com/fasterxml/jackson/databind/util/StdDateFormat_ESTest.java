...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Locale locale0 = new Locale("", "y;}yue2\"y7D.3");
      ...
      try { 
        stdDateFormat0.parseAsISO8601("8=", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"8=\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("JiCR6] KTh", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"JiCR6] KTh\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test03()  throws Throwable  {
      ...
      stdDateFormat0.looksLikeISO8601("aGH\"Hk<");
  ...
  public void test04()  throws Throwable  {
      ...
      stdDateFormat0.parse("t", parsePosition0);
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=384,errorIndex=384]", parsePosition0.toString());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test11()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("aoKOM4A^`");
      Boolean boolean0 = new Boolean("aoKOM4A^`");
  ...
  public void test13()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("^QtkFbt+?W.E");
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-28), "h4Tsg).'Z");
      Locale locale0 = Locale.UK;
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "h4Tsg).'[", 3, 3, 3, 3, 3, 3, 3, 3);
      Locale locale0 = Locale.UK;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, (Boolean) null);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test23()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("Cr7fVv' `ca&^{*cQ");
      Locale locale0 = Locale.US;
      Boolean boolean0 = new Boolean("c`qQP(,XS6ho-9GF~");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      ParsePosition parsePosition0 = new ParsePosition((-3587));
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("c`qQP(,XS6ho-9GF~", parsePosition0);
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("Cannot parse date \"%s\": not compatible with any of standard forms (%s)", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("' (");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition((-2459));
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("9Bs}`M_45HoM?G8D%");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(3);
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(2932);
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition((-5378));
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00-u0T00:00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-u0T00:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("g2'xbYEmp FlyASfeM", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test53()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("' (");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      boolean boolean1 = stdDateFormat0.looksLikeISO8601("0000-<-0");
      assertFalse(stdDateFormat0.isLenient());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertFalse(boolean1);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(3);
      stdDateFormat0.parse("6RFpR,/d b)58Y?g", parsePosition0);
      assertEquals(3, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=3,errorIndex=3]", parsePosition0.toString());
  }
  ...
  public void test59()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone("6{wI%vHjSs>w!Vs");
      MockDate mockDate0 = new MockDate((-2015), 313, (-2917), 461, (-2917));
      Locale locale0 = Locale.GERMANY;
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("0098-02-22T04:23:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test60()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(7, 3841, 7, 7, 1, (-2558));
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat1._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2227-02-07T06:18:22.000+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1302, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StringBuffer stringBuffer0 = new StringBuffer("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      MockDate mockDate0 = new MockDate(1302, 1302, 1, 1302, 1302, 103);
      Locale locale0 = Locale.GERMANY;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      stdDateFormat1._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals(55, stringBuffer0.length());
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ3310-08-25T03:43:44.302+00:00", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(3365);
      stdDateFormat0.parseObject("Igqvlrd9", parsePosition0);
      assertEquals("java.text.ParsePosition[index=3365,errorIndex=3365]", parsePosition0.toString());
      assertEquals(3365, parsePosition0.getErrorIndex());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
      stdDateFormat1.parse("0000-00-00T0b:00", parsePosition0);
  ...
  public void test79()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(2084);
      assertEquals(2084, parsePosition0.getIndex());
  }
  ...
  public void test82()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("yyyy-MM-dd'T'HH:mm:ss.SSSZ", "yyyy-MM-dd", "");
  ...
  public void test84()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "E$UR(pl3", 0, 0, 1704, 0, 0, 9, 0, 9, (-1865), 9, 100);
      Locale locale0 = Locale.ENGLISH;
      Boolean boolean0 = Boolean.FALSE;
  ...
  public void test86()  throws Throwable  {
      ...
      Locale locale0 = new Locale("Y5C9a9@x4 zD_0Z", "Y5C9a9@x4 zD_0Z", "");
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseObject("yyyy-MM-dd'T'HH:mm:ss.SSSZ", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
