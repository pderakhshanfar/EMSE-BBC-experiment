...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("yjf.4UIi!'2=}^", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"yjf.4UIi!'2=}^\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("'K>xV#", parsePosition0);
  ...
  public void test03()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Instant instant0 = MockInstant.ofEpochSecond(1450L);
      Date date0 = Date.from(instant0);
      StringBuffer stringBuffer0 = new StringBuffer(0);
      stdDateFormat0._format(zoneInfo0, locale0, date0, stringBuffer0);
      assertEquals(28, stringBuffer0.length());
      assertEquals("1970-01-01T00:24:10.000+0000", stringBuffer0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(3998);
      stdDateFormat0.parseAsRFC1123("yyyy-MM-dd'T'HH:mm:ss.SSSZ", parsePosition0);
      assertEquals("java.text.ParsePosition[index=3998,errorIndex=3998]", parsePosition0.toString());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=1350,errorIndex=-1]", parsePosition0.toString());
  ...
  public void test14()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.looksLikeISO8601("5");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2159, "2014-02-14T20:21:21.320+0000");
  ...
  public void test28()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("dkq2D");
      Locale locale0 = Locale.UK;
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("dddd[-]dd[-]dd", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("R.LuJt~+lNgY");
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("1872-08-27T20:45:00.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"1872-08-27T20:45:00.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test37()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "6Bj@Y3ChY+`5");
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("'U^IWc'wjwl]?V=+q-", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test43()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("2.2250738585072012e-08");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"2.2250738585072012e-08\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test44()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      Boolean boolean0 = Boolean.valueOf("iKFA,G]'n|O.h#V9T");
  ...
  public void test50()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0._parseDate("nD2UM->,2=-?-13Z!", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertFalse(stdDateFormat0.isLenient());
  }
  ...
  public void test51()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition((-4051));
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Locale locale0 = Locale.ITALIAN;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      // Undeclared exception!
      try { 
        stdDateFormat1.parseAsRFC1123("eRsSXF7fD+g", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-QN00-00T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-QN00-00T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("5JMAd>kv", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1899), 1006, 1692, 1872, 90);
  ...
  public void test62()  throws Throwable  {
      Locale locale0 = Locale.ITALIAN;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1367, "0000-0-00T00:00");
      ZoneOffset zoneOffset0 = ZoneOffset.MIN;
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(84, 1, 1, 48, 34);
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000+0O-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000+0O-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test69()  throws Throwable  {
      ...
      stdDateFormat0.instance._parseDate("Mk%6PoT%k$\"T~9", parsePosition0);
      Locale locale0 = new Locale("0000-00-00", "0000-00-00T00:00", "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0.withLocale(locale0);
      DateFormat.getInstance();
      try { 
        stdDateFormat0._parseAsISO8601("0000-0-00T00:00", (ParsePosition) null);
        fail("Expecting exception: ParseException");
  ...
  public void test74()  throws Throwable  {
      ...
      TimeZone timeZone1 = TimeZone.getTimeZone("8<?Vf-");
  ...
  public void test78()  throws Throwable  {
      int int0 = (-5619);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-5619), "t2Xenv-'^OW+La~O8K3");
      ...
      int int1 = 12;
      MockDate mockDate0 = new MockDate((-5619), (-5619), (-5619), (-5619), 12);
      // Undeclared exception!
      try { 
