...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("512E@0HR", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"512E@0HR\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test04()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("rJZ]T-Qj0eeNt");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      try { 
        stdDateFormat0._parseAsISO8601("6yQ<o4M0+gDM.<uicEf", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"6yQ<o4M0+gDM.<uicEf\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(0);
      Date date0 = stdDateFormat0.parse("qTPn}|", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(43, "nf]$3;?Ee@w");
  ...
  public void test09()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1370, "0000-00-00TB00:00");
      Locale locale0 = Locale.FRANCE;
  ...
  public void test12()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(59983);
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1591), "|w#.PQ%,\"k(@PrMO");
  ...
  public void test19()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag("`j&#|{}+<mJ'oUgD+");
  ...
  public void test23()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat2 = stdDateFormat1.instance.withTimeZone(timeZone0);
      ...
      try {
        mockDate0 = new MockDate("0000-00-00");
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("DI", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-2200), 2267, 0, 0, (-2200));
  ...
  public void test41()  throws Throwable  {
      ...
      Locale locale0 = new Locale("pRIf40d(3UWXQP0");
  ...
  public void test43()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(920, "C/Z<1U$");
      Locale locale0 = Locale.US;
      Boolean boolean0 = Boolean.valueOf("C/Z<1U$");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test49()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2, "j>8(_WWK*,Ql6");
      Locale locale0 = Locale.PRC;
      Boolean boolean0 = new Boolean(" 6xJ7#f4YDs%0vfazz");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
  ...
  public void test52()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-2200));
      StringWriter stringWriter0 = new StringWriter(2);
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stdDateFormat0.instance._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1969-12-31T23:59:57.800+0000", stringBuffer0.toString());
      assertEquals("1969-12-31T23:59:57.800+0000", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test53()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-419), "lP $%CQ-tB=Ocqr\"'");
      Locale locale0 = Locale.JAPANESE;
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      try { 
        stdDateFormat0.parse("lP $%CQ-tB=Ocqr\"'");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"lP $%CQ-tB=Ocqr\"'\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(3490);
      stdDateFormat1.parseAsRFC1123("yyyy-MM-dd'T'HH:mm:ss.SSSZ", parsePosition0);
      assertEquals("java.text.ParsePosition[index=3490,errorIndex=3490]", parsePosition0.toString());
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("4'*4-F6F{52+r]*)2");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4'*4-F6F{52+r]*)2\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000!00-;0m_0:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000!00-;0m_0:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0._parseDate("8r_\"dLO_1nLBe>kg2", parsePosition0);
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1740), (-1740), (-1740), (-1740), (-3220), (-1740));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0010-01-11T05:51:00.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-2200), (-2200), 2267, 3234, 3234);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("0478-03-31T23:54:00.000+00:00", string0);
  }
  ...
  public void test63()  throws Throwable  {
      ...
      assertEquals("1582-10-15T18:00:00.000+18:00", stringBuffer0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:20.901-0000", string0);
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse(";]j?P~h26_9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \";]j?P~h26_9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test76()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "Y%FNq");
      Locale locale0 = Locale.CHINA;
  ...
  public void test79()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("[.$a!&:lyZMS)tc\"$", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"[.$a!&:lyZMS)tc\"$\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test84()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.parse("3080-00-00");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test87()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(90, "2.2250738585072012e-308", (-750), 0, 90, 90, 90, 0, (-750), 9);
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertNotNull(timeZone0);
