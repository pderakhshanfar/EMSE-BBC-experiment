...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsISO8601("0200-00-00", parsePosition0);
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("bvPRy");
      ...
      try { 
        stdDateFormat0._parseAsISO8601("bvPRy", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"bvPRy\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test03()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-3111));
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("7<q4&d{&lvJe7Gi", parsePosition0);
  ...
  public void test04()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("X+(gpcuF6@AsrB|+1^-");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(599);
      stdDateFormat0.instance.parse("|", parsePosition0);
      assertEquals(599, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=599,errorIndex=599]", parsePosition0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("C@gw//B_io(Z[D4h9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "Hi_+y./5uP]M", 3, 3, 3, 3, 3, 3, 3, 3, 3);
  ...
  public void test26()  throws Throwable  {
      ...
      Locale locale0 = Locale.CANADA_FRENCH;
      Boolean boolean0 = new Boolean("}<'*@^%;Xgu3Q");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, false);
      ParsePosition parsePosition0 = new ParsePosition((-2827));
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      ParsePosition parsePosition0 = new ParsePosition((-4534));
  ...
  public void test38()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, (Boolean) null);
      try { 
        stdDateFormat0._parseDate("0000-00-00T00:v00", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-00T00:v00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test41()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(3136);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("bvPRy");
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StringBuffer stringBuffer0 = new StringBuffer(2767);
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      // Undeclared exception!
      try { 
  ...
  public void test51()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("InJ:c_2H^T?eXJ");
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-R-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-R-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("2A6|wz<czpu");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"2A6|wz<czpu\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1810), (-1810), 3705, (-1810), (-1810));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0052-02-03T07:50:00.000+0000", string0);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      assertEquals("1970-01-01T00:00:02.404+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test62()  throws Throwable  {
      MockDate mockDate0 = new MockDate();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1802), "PG~iW@_(j\"");
      Locale locale0 = Locale.KOREA;
      Boolean boolean0 = Boolean.valueOf("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:19.518-00:00", string0);
      assertFalse(stdDateFormat0.isLenient());
  }
  ...
  public void test63()  throws Throwable  {
      ...
      assertEquals("2014-03-11T16:52:44.965+k631", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("mFW");
      Locale locale0 = new Locale("");
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      ParsePosition parsePosition0 = new ParsePosition((-2956));
      try { 
        stdDateFormat0._parseAsISO8601("h;H[[ /cWA", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"h;H[[ /cWA\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? true)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test70()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      Boolean boolean0 = new Boolean("x7a0kJ8>W'gk>c");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
  ...
  public void test73()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-775), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
  ...
  public void test77()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(19, "k}");
      // Undeclared exception!
      try { 
  ...
  public void test81()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0.parse("0010-00-20");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test83()  throws Throwable  {
      ...
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("java.text.ParsePosition[index=548,errorIndex=-1]", parsePosition0.toString());
  }
