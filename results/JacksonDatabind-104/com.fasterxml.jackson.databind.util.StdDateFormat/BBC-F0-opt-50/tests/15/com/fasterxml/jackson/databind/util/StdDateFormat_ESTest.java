...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0001-00-00", parsePosition0);
      assertNotNull(date0);
  ...
  public void test02()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("3C71qLdM3yx|E", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      stdDateFormat0.parse("1816-04-13T03:11:01.000+0000", parsePosition0);
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("java.text.ParsePosition[index=322,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      parsePosition0.setIndex(2539);
      Date date0 = stdDateFormat0.parse("`2.[}7VN9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test11()  throws Throwable  {
      Locale locale0 = new Locale("|KYr[", "|KYr[");
      Boolean boolean0 = Boolean.valueOf("|KYr[");
  ...
  public void test13()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(913, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "|+UX/");
  ...
  public void test18()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("FQMjU0t", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test24()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("L~}:d.nE", "UD{A6|");
  ...
  public void test25()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("`n-7Q&&j");
  ...
  public void test27()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-1749));
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-1662));
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-1044));
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("2544-02-08T02:53:48.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"2544-02-08T02:53:48.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test47()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Locale locale0 = Locale.ROOT;
      MockDate mockDate0 = new MockDate(0, 0, 2032, 0, 0, 0);
  ...
  public void test49()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      Boolean boolean0 = new Boolean(":').;]eW'B[AM");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
  ...
  public void test53()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat1.parse("UD{A6|", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-U0->00T0':00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-U0->00T0':00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("8Yn3%8Obn';hPux");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"8Yn3%8Obn';hPux\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(43);
      Object object0 = stdDateFormat0.parseObject("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: en_US, lenient: null)", parsePosition0);
      assertNull(object0);
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1912), 601, 601, 62, 601, 48);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0039-09-27T00:01:48.000+0000", string0);
  }
  ...
  public void test65()  throws Throwable  {
      MockDate mockDate0 = new MockDate(913, 43, 84);
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(9, "Value \"");
      Locale locale0 = Locale.KOREAN;
      Boolean boolean0 = Boolean.valueOf("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("2816-10-23T00:00:00.009+00:00", stringBuffer0.toString());
      assertEquals("2816-10-23T00:00:00.009+00:00", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(913, (-3129), 913);
      StringBuffer stringBuffer0 = new StringBuffer("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(913, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.KOREAN;
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2554-09-30T00:00:00.913+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(604, (-1911), 604, 43, 0, 601);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1911), "");
      Locale locale0 = Locale.ITALIAN;
      StringBuffer stringBuffer0 = new StringBuffer("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2346-05-28T19:09:59.089-0000", stringBuffer0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0Z+#jh$^V tlb|i2");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0Z+#jh$^V tlb|i2\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test76()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat1.parseObject("+00:00", parsePosition0);
      assertEquals(0, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=0,errorIndex=0]", parsePosition0.toString());
  }
  ...
  public void test78()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat1.parseAsRFC1123("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: , lenient: false)", parsePosition0);
      assertEquals(0, parsePosition0.getErrorIndex());
  ...
  public void test83()  throws Throwable  {
      Locale locale0 = Locale.ROOT;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "*Jl$<|4/4A");
  ...
  public void test86()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(10);
      Date date0 = stdDateFormat0.parse("0000-00-03", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertNotNull(date0);
  }
}
