...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0800-07-50");
  ...
  public void test02()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0f000-00-0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0f000-00-0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test04()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
      try { 
        stdDateFormat0.parse("XT1 b}2Fw0`~>r9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"XT1 b}2Fw0`~>r9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
      MockDate mockDate0 = new MockDate(108, 108, 3600);
      StringBuffer stringBuffer0 = new StringBuffer(13);
      stdDateFormat0._format(zoneInfo0, locale0, mockDate0, stringBuffer0);
      assertEquals("2026-11-09T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("PBM@`A<Z.0c}>CiJGMb", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("95*+|@([\"~*d6($p)+");
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(48, "'p");
  ...
  public void test20()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(45, ",m8)Y=>:GG}V");
      Locale locale0 = Locale.GERMANY;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
  ...
  public void test22()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("sqgR7xo", "sqgR7xo");
      assertTrue(boolean0);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601(",m8)Y=>:GG}V", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \",m8)Y=>:GG}V\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("EEE, dd MMM yyyy HH:mm:ss zzz");
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      ...
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(2480);
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(126, "9BpxF;M7O");
      Boolean boolean0 = new Boolean("9BpxF;M7O");
  ...
  public void test51()  throws Throwable  {
      ...
      Date date1 = stdDateFormat0.parse("0010-00-00", parsePosition0);
  ...
  public void test52()  throws Throwable  {
      ...
      try { 
        stdDateFormat1.parseObject("0zF/7OoC !xvf");
        fail("Expecting exception: ParseException");
  ...
  public void test53()  throws Throwable  {
      ...
      try { 
        stdDateFormat1.parse("an?<~v/~2");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"an?<~v/~2\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      ...
      stdDateFormat0.parse("?Z`m'4(THkKhb,?$ZO", parsePosition0);
  ...
  public void test58()  throws Throwable  {
      ...
      stdDateFormat0.parse("0000-00-0YT00:00", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test59()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
      try { 
        stdDateFormat0.parse("0000-*<-0YT00C00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-*<-0YT00C00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test65()  throws Throwable  {
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1), "4K{7_U;");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ\u75DD055-12-02T16:47:04.191-00:00", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(11);
      stdDateFormat0.format(date0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ\u75DD055-12-02T16:47:04.191-0000", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      Locale locale0 = Locale.GERMANY;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      Instant instant0 = MockInstant.ofEpochMilli(1000000000L);
      Date date0 = Date.from(instant0);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) ",m8)Y=:GG}V");
      FieldPosition fieldPosition0 = new FieldPosition(0);
      stdDateFormat0.format(date0, stringBuffer0, fieldPosition0);
      assertEquals(",m8)Y=:GG}V1970-01-12T13:46:40.045+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1839), (-1017), (-3973), (-1017), 3600, (-1839));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0036-04-05T02:29:21.000+0000", string0);
  }
  ...
  public void test71()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("9O{0%z]");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9O{0%z]\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test73()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-4865), "DateFormat %s: (timezone: %s, locale: %s, lenient: %s)");
  ...
  public void test74()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("!h5H*f");
  ...
  public void test75()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1334), "Cannot parse date \"%s\": not compatible with any of standard forms (%s)");
  ...
  public void test80()  throws Throwable  {
      Locale locale0 = new Locale("0l6K<+M3xJwPvl", "0l6K<+M3xJwPvl", "");
      Boolean boolean0 = Boolean.FALSE;
  ...
  public void test85()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3165), "0000-00-00");
