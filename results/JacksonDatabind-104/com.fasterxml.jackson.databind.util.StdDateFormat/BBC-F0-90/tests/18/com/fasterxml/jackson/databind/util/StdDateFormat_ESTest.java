...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2169), "sDc^1Dg");
      Locale locale0 = Locale.CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("sDc^1Dg");
  ...
  public void test07()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("#@C9vQvW6!9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"#@C9vQvW6!9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
  ...
  public void test09()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(":et_~N7");
  ...
  public void test10()  throws Throwable  {
      ...
      Locale locale0 = new Locale("Cannot parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)", "Cannot parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)", "Value \"");
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "(f}fC#", 0, 0, (-494), 0, 57, (-32), 0, 4, (-32), (-32), 48);
  ...
  public void test19()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(2840);
  ...
  public void test23()  throws Throwable  {
      ...
      boolean boolean0 = StdDateFormat._equals((Object) null, (Object) timeZone0);
      assertFalse(boolean0);
  }
  ...
  public void test26()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4, "E$:>I");
      Locale locale0 = Locale.PRC;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-624));
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("E$:>I", parsePosition0);
  ...
  public void test27()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-1727));
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "2.2250738585072012e-308", 0, 0, 0, 0, 500, 0, (-773), 0);
  ...
  public void test47()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("Cannot parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)");
      Locale locale0 = new Locale("Cannot parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)", "Cannot parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)", "Value \"");
      Boolean boolean0 = Boolean.valueOf("&hUJbun/(Cy9;;bO8NH");
  ...
  public void test49()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(0);
      Boolean boolean0 = Boolean.valueOf("0LIe{]b@yz U4._j}4");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
  ...
  public void test51()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00_\u0000", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00_\u0000\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test53()  throws Throwable  {
      ...
      ParsePosition parsePosition1 = new ParsePosition((-906));
      Date date0 = stdDateFormat0.parse("0000-00-00", parsePosition0);
      StringWriter stringWriter0 = new StringWriter(25);
      stringWriter0.append((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ+2014-02-14T20:21:21.320+0000", stringBuffer0.toString());
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ+2014-02-14T20:21:21.320+0000", stringWriter0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("0000)0-.0T00:00", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("2E1zj/zB");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"2E1zj/zB\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-447), "0000-0-00T00:00");
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-2081), 2013, 2013);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0009-04-04T00:00:00.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(5, 2775, 1809);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("2141-03-14T00:00:00.000+00:00", string0);
  }
  ...
  public void test63()  throws Throwable  {
      ...
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1969-12-31T23:59:59.552-00:00", string0);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-5822), (-5822), 3600, (-959), 3600);
      StringBuffer stringBuffer0 = new StringBuffer("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3600, "2E1zj/zB");
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ4399-08-02T13:00:03.600+0000", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      TimeZone timeZone0 = TimeZone.getTimeZone("~_'C`?EJ!@Ne!");
  ...
  public void test71()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      ParsePosition parsePosition0 = new ParsePosition(3);
      stdDateFormat1.parse("g-X\"oNAk^b F,S` $i", parsePosition0);
  ...
  public void test84()  throws Throwable  {
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1795, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertNotNull(timeZone0);
