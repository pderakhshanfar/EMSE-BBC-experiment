...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("0090-00-30");
  ...
  public void test04()  throws Throwable  {
      Locale locale0 = new Locale(",4*f`k|#8ym&XM]I@", ",4*f`k|#8ym&XM]I@");
  ...
  public void test06()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("g9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test11()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = Locale.forLanguageTag(" 2YK1e<e oD*");
      Boolean boolean0 = new Boolean(" 2YK1e<e oD*");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, true);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      assertSame(stdDateFormat1, stdDateFormat0);
      assertFalse(stdDateFormat1.isLenient());
  ...
  public void test16()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("wm");
      TimeZone timeZone0 = TimeZone.getDefault();
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      stdDateFormat0.looksLikeISO8601("wm");
  ...
  public void test48()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0.parse("v-u6", parsePosition0);
  ...
  public void test51()  throws Throwable  {
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(0, 1830, 0, 0, (-1));
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("4hJx,|^$VOcLV=G&", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1888), 116, 116, (-1), 3302);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, (FieldPosition) null);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0021-12-27T06:02:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1582-10-04T23:59:57.717-0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(476, "+00:00");
      Locale locale0 = Locale.ENGLISH;
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2014-02-14T20:21:21.796+00:00", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(459, "+00:00");
  ...
  public void test73()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(0, 2005, 0, 2005, 0);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat1.format((Date) mockDate0, stringBuffer0, (FieldPosition) null);
      //  // Unstable assertion: assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2067-04-24T13:00:00.009+00:00", stringBuffer0.toString());
  }
  ...
  public void test78()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("0000-D\"00}00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-D\"00}00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test83()  throws Throwable  {
      ...
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: 0000-00-00t00:00, lenient: true)", string0);
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test85()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.ITALY;
      Boolean boolean0 = Boolean.valueOf("M5AzZ7(zys[e");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.toPattern();
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test86()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("1970-01-01T00:00:00.117+0000");
        fail("Expecting exception: ParseException");
  ...
  public void test88()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(853, "");
