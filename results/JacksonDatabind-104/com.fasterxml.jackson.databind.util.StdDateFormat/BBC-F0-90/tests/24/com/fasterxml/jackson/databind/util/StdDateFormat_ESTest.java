...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-750), "|*IJ%Dq]_:d");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, false);
      // Undeclared exception!
      try { 
        stdDateFormat0.parseObject("P", (ParsePosition) null);
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("wcFbcKVL:9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"wcFbcKVL:9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
  ...
  public void test06()  throws Throwable  {
      ...
      Locale locale0 = new Locale("EEE, dd MMM yyyy HH:mm:ss zzz", "V%Ba#a/QNyb>*G", "V%Ba#a/QNyb>*G");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      MockDate mockDate0 = new MockDate(3090);
      StringBuffer stringBuffer0 = new StringBuffer(3090);
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1970-01-01T00:00:03.090+0000", stringBuffer0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-20), "2.2250738585072012e-308");
  ...
  public void test11()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Boolean boolean0 = Boolean.valueOf(")50d#Cs");
  ...
  public void test12()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("gqG<EWf", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test16()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("gqG<EWf");
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "0000-00-0", 0, 0, 0, 2788, 0, 0, 10, 8, 63);
      Locale locale0 = new Locale("yyyy-MM-dd'T'HH:mm:ss.SSSZ", "0000-00-0", "0000-00-0");
  ...
  public void test20()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(82, "mBU[u',");
  ...
  public void test25()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(76, "$X9J");
      Locale locale0 = Locale.KOREA;
      Boolean boolean0 = Boolean.TRUE;
  ...
  public void test26()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-4028));
  ...
  public void test30()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("", "ThI,K$;yDw");
      assertFalse(boolean0);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("1461-05-10T22:03:15.000+00:00", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, 2661);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00-0T0000", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-0T0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        stdDateFormat0._parseAsISO8601("n2", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"n2\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-B0!-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-B0!-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("8t.no!ghb6&", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test65()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(9, 90, 199);
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition((-798));
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("1917-01-15T00:00:00.000+00:00", stringBuffer0.toString());
  ...
  public void test66()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1590), (-3522), 108);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(76, "$X9J");
      Locale locale0 = Locale.KOREA;
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0016-10-16T00:00:00.076+00:00", string0);
  }
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1590), (-2586), 598);
      stdDateFormat0.format((Date) mockDate0);
      Date date0 = stdDateFormat0.parse("0000-00-00");
      assertEquals("Thu Feb 18 00:00:00 GMT 96", date0.toString());
  }
  ...
  public void test71()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("8]c3$uUQejKI/:>Q(");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"8]c3$uUQejKI/:>Q(\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test80()  throws Throwable  {
      ...
      Locale locale0 = Locale.CANADA;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      ParsePosition parsePosition0 = new ParsePosition((-3481));
      // Undeclared exception!
      try { 
  ...
  public void test81()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat1._parseDate("8t.no!ghb6&", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test87()  throws Throwable  {
      ...
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: eee, dd mmm yyyy hh:mm:ss zzz_V%BA#A/QNYB>*G_V%Ba#a/QNyb>*G, lenient: null)", string0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
