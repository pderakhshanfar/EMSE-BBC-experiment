...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("1%:9*'|l4qY");
        fail("Expecting exception: ParseException");
  ...
  public void test04()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag("lenient");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
  ...
  public void test06()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("F:Y!_j89", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test11()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(1760);
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.parse("0000-00-040T00:00", parsePosition0);
      assertEquals("java.text.ParsePosition[index=1760,errorIndex=-1]", parsePosition0.toString());
      assertTrue(stdDateFormat0.isLenient());
  }
  ...
  public void test13()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("0}");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3890, "zZ0vHbp8-/");
      Locale locale0 = Locale.GERMANY;
  ...
  public void test20()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(109, "|`i7lg4fG$m$S9zE");
  ...
  public void test22()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("+00:00", "{;");
      assertFalse(boolean0);
  }
  ...
  public void test35()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("o=6[]G3Rq-");
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      MockDate mockDate0 = new MockDate(23, (-1412), (-1412), (-1412), (-1412));
  ...
  public void test38()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.forLanguageTag("0000-00-040T00:00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(1760);
      try { 
        stdDateFormat0._parseDate("0000-00-040T00:00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-040T00:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test43()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1786), "0000-00-00T00:00");
      Locale locale0 = Locale.forLanguageTag("0000-00-00T00:00");
  ...
  public void test46()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("n:G^8=~V9%Dg", parsePosition0);
      String string0 = "\"_[BDn/{[U3_x-]Q ";
      ParsePosition parsePosition1 = new ParsePosition(60000);
      stdDateFormat0.parseAsRFC1123("\"_[BDn/{[U3_x-]Q ", parsePosition1);
      // Undeclared exception!
      try { 
        DateFormat.getDateTimeInstance(60000, 56);
  ...
  public void test51()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Locale locale0 = Locale.forLanguageTag("V2Jtx,?dN{G=s0+");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      ParsePosition parsePosition0 = new ParsePosition((-1));
      // Undeclared exception!
      try { 
        stdDateFormat1._parseDate("yyyy-MM-dd", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-2326));
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("4[lh'mTW>u.QG", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1888), 705, (-1888), 44, (-1903), (-24));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0065-07-30T12:16:36.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test59()  throws Throwable  {
      MockDate mockDate0 = new MockDate(19, 199, 215, 388, 388, 1);
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1936-03-18T10:28:01.000+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test60()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      timeZone0.setRawOffset(961);
      ...
      assertEquals("0000-00-00T00:001969-12-31T23:59:58.734+00:00", stringBuffer0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      assertEquals(1760, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1760,errorIndex=1760]", parsePosition0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-e0%0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-e0%0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test64()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=java.util.SimpleTimeZone[id=yyyy-MM-dd'T'HH:mm:ss.SSSZ,offset=97,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=?,MONTH=?,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=?,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=?,HOUR=?,HOUR_OF_DAY=?,MINUTE=?,SECOND=?,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
      ...
      MockDate mockDate0 = new MockDate(34, 71, 13, (-894), 1986, 50);
  ...
  public void test65()  throws Throwable  {
      MockDate mockDate0 = new MockDate(1000, (-1888), (-1598), (-1888), (-1598), (-1598));
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-250), "[one of: 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', 'EEE, dd MMM yyyy HH:mm:ss zzz' (lenient)]");
      Locale locale0 = Locale.ITALY;
      Boolean boolean0 = new Boolean("+0000");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertFalse(stdDateFormat0.isLenient());
      assertEquals("2738-01-26T04:55:21.750-0000", string0);
  }
  ...
  public void test78()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-585), "0000-00-00T00:00");
