...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2045, "\" can not be represented as BigDecimal");
  ...
  public void test10()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "", 403, 0, 0, 0, 0, 0, 1000, 0, 403);
      Boolean boolean0 = new Boolean(false);
  ...
  public void test14()  throws Throwable  {
      ...
      stdDateFormat0.looksLikeISO8601("f7ruy");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test17()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(225, "");
  ...
  public void test26()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("CBKI$A", "CBKI$A");
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("com.fasterxml.jackson.core.io.NumberInput", " thRYXVB*TaS[.qxx");
      assertFalse(boolean0);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("f7ruy", parsePosition0);
  ...
  public void test31()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("#HTZxm?oo(KKOou", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"#HTZxm?oo(KKOou\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test42()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      FieldPosition fieldPosition0 = new FieldPosition((-313));
      // Undeclared exception!
      try { 
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("Up])];D^.0~[Z[Z+", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test51()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      MockDate mockDate0 = new MockDate((-2365), 4167, (-2062));
      Locale locale0 = Locale.CHINA;
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("0125-08-07T00:00:00.000+00:00", string0);
      assertFalse(stdDateFormat1.isLenient());
  }
  ...
  public void test52()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(225, "");
      Locale locale0 = new Locale("", "yyyy-MM-dd'T'HH:mm:ss.SSSZ", "_W'");
      MockDate mockDate0 = new MockDate(45, 4, (-1386), 4, 45);
      ...
      assertEquals("1941-07-14T04:45:00.225+0000", stringBuffer0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("Tue Jul 21 00:00:00 GMT 125", date0.toString());
  }
  ...
  public void test59()  throws Throwable  {
      ...
      stdDateFormat1.parse("[one of: 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', 'EEE, dd MMM yyyy HH:mm:ss zzz' (lenient)]", parsePosition0);
  ...
  public void test60()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(743);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      stdDateFormat1._parseDate("-MY|zRAc+9", parsePosition0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
      assertNotSame(stdDateFormat1, stdDateFormat0);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("00!0-S0-00T00:0t");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00!0-S0-00T00:0t\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("cu", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"cu\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("00r6!0-00-00T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00r6!0-00-00T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test66()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(743);
      Date date0 = stdDateFormat0._parseDate("8/#}9*}W*PWD?V0r", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test71()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-2060), 2431, 4168);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0053-12-28T00:00:00.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test72()  throws Throwable  {
      StdDateFormat.getDefaultTimeZone();
      MockDate mockDate0 = new MockDate((-2365), 4167, (-2079));
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-1779), (-1779), 4167, 50, (-3079));
  ...
  public void test73()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-2048), 4147, (-2048));
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.format((Date) mockDate0);
      ParsePosition parsePosition0 = new ParsePosition((-2048));
      try { 
        stdDateFormat0._parseDate("0191-12-22T00:00:00.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"0191-12-22T00:00:00.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test79()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      TimeZone timeZone1 = TimeZone.getTimeZone("rB\"6'$pb");
      Locale locale0 = Locale.CHINA;
