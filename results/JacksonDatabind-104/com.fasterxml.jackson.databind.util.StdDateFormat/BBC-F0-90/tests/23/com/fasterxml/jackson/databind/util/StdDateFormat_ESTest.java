...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("njO:!~#G@egaUh`2z", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"njO:!~#G@egaUh`2z\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
         //
  ...
  public void test03()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag("$cXvoZ,3}+im");
  ...
  public void test04()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone("N=U");
      Boolean boolean0 = Boolean.valueOf("N=U");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      try { 
        stdDateFormat0.parse("_;K o'p@k#?.^P9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"_;K o'p@k#?.^P9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals("#9?2014-02-14T20:21:21.320+0000", stringBuffer0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      Locale locale0 = new Locale("yyyy-MM-dd", "@E \"`ri*UF5#&tK`", "0000-00-00T00:00");
      Boolean boolean0 = Boolean.FALSE;
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      ParsePosition parsePosition0 = new ParsePosition(2501);
      stdDateFormat0.parse("2019-07-12T00:00:00.000+0000", parsePosition0);
      assertEquals("java.text.ParsePosition[index=2501,errorIndex=-1]", parsePosition0.toString());
      assertFalse(stdDateFormat0.isLenient());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test08()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("Q'OZWI>z|V4t*>3>+/");
  ...
  public void test16()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "0000-00-00", 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3);
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(871, "");
      Locale locale0 = new Locale("mEWhg_dRmOj:>;", "%");
      Boolean boolean0 = new Boolean("Rtaw)>ov v77");
  ...
  public void test27()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(2021);
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      Locale locale0 = new Locale("1u;?U~;:Nq) e", "", "1u;?U~;:Nq) e");
      Boolean boolean0 = Boolean.FALSE;
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
  ...
  public void test33()  throws Throwable  {
      ...
      Locale locale0 = new Locale("0000-00-00T00:00", "0000-00-00T00:00", "com.fasterxml.jackson.databind.util.StdDateFormat");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0013-01-03T00:00:00.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"0013-01-03T00:00:00.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test45()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "N=U");
      // Undeclared exception!
      try { 
  ...
  public void test46()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("^Z9H$0(VevHkW3OT", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test53()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("Q'OZWI3>z|V4t*>3>+/");
      Locale locale0 = Locale.ROOT;
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      try { 
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0N00-j0-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0N00-j0-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("N=U");
      Locale locale0 = new Locale("1u;?U~;:Nq) e", "N=U", "N=U");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-1912));
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("1u;?U~;:Nq) e", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test60()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null);
      MockDate mockDate0 = new MockDate((-1912), 0, 3);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0013-01-03T00:00:00.000+0000", string0);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate(14, 64, 14);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1919-05-14T00:00:00.000+00:00", string0);
      assertTrue(stdDateFormat0.isLenient());
  }

  @Test(timeout = 4000)
  public void test62()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2558), "pGQ=)WyV  )q(;r)");
      Locale locale0 = Locale.US;
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate((-2558), 104, 27, 104, (-1811), (-1811));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertFalse(stdDateFormat0.isLenient());
      assertEquals("0651-09-30T01:18:46.442-00:00", string0);
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("9000\"-00-I00T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9000\"-00-I00T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      int int0 = 0;
      Integer integer0 = new Integer(0);
      StdDateFormat._equals((Integer) null, integer0);
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = null;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null);
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-905), "1899-12-31T00:00:00.000+0000");
      // Undeclared exception!
      try { 
  ...
  public void test73()  throws Throwable  {
      ...
      stdDateFormat1.parse("N=U", parsePosition0);
      assertEquals("java.text.ParsePosition[index=92,errorIndex=92]", parsePosition0.toString());
  ...
  public void test79()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2596), "yyyy-MM-dd");
