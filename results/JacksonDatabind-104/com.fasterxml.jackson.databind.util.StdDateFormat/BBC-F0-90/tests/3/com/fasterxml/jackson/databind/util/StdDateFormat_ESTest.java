...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.instance._parseDate("`({$Fst", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("s", (ParsePosition) null);
  ...
  public void test08()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("ai");
  ...
  public void test13()  throws Throwable  {
      ...
      stdDateFormat0.parse("0000-00-0Q0T00:00", parsePosition0);
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("java.text.ParsePosition[index=745,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.looksLikeISO8601("2[4=");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3275), "+iZDNp(Ldl;{>k$;");
      StdDateFormat stdDateFormat0 = new StdDateFormat();
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1, "+00:00", 1, 1, 1, 1, 1, 1, 1, 1, 1);
  ...
  public void test27()  throws Throwable  {
      Boolean boolean0 = Boolean.valueOf("f%S`]d)a<DH+7");
  ...
  public void test40()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1444, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00-0Q0T00:00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-0Q0T00:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test43()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("MG#dNky~xeSvg90");
      Boolean boolean0 = new Boolean("MG#dNky~xeSvg90");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("MG#dNky~xeSvg90", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test45()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        stdDateFormat0.instance._parseAsISO8601("ai", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"ai\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(48, 2666, 2666, (-20), 522);
  ...
  public void test55()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ParseException");
         ...
         //
         // Cannot parse date \"EEE, dd MMM yyyy HH:mm:ss zzz\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("3Ex2n~ Q[bdAzpbuE", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test57()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      ParsePosition parsePosition0 = new ParsePosition((-2734));
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0)j1%o^\"RchT*QRbi");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0)j1%o^\"RchT*QRbi\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("{%pNHeI.Px*l-}");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      try { 
        stdDateFormat0.parseAsISO8601("OHVn", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"OHVn\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0);
      try { 
        stdDateFormat0.parse("45wg4do4Tyzvqp>X");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"45wg4do4Tyzvqp>X\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StdDateFormat stdDateFormat1 = stdDateFormat0.clone();
      boolean boolean0 = StdDateFormat._equals((Object) stdDateFormat0, (Object) stdDateFormat1);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
      assertFalse(boolean0);
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-1584), (-1584), 2471, 56, 2);
      Date date0 = mockGregorianCalendar0.getGregorianChange();
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1970, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.TAIWAN;
      MockDate mockDate0 = new MockDate((-959), 9, (-959), (-959), 9, 89);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      ...
      assertEquals("0939-01-05T01:10:30.970+00:00", stringWriter0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      assertEquals("0939-01-05T01:10:30.970+0000", stringBuffer0.toString());
      assertEquals("0939-01-05T01:10:30.970+0000", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1758), (-1758), (-1758));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0011-09-06T00:00:00.000+0000", string0);
  }
  ...
  public void test71()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-87), "0000-00-0Q0T00:00");
      Boolean boolean0 = new Boolean("0000-00-0Q0T00:00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("1969-12-31T23:59:59.826-0000", stringBuffer0.toString());
  }
  ...
  public void test75()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "UVrg3QV.!");
      Locale locale0 = Locale.ROOT;
      Boolean boolean0 = new Boolean("P8`)ln2");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test84()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("003000");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
