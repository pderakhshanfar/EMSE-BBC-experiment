...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("W,X73r3");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"W,X73r3\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "J=R(PuAG\"r:n2qJ0");
      Locale locale0 = new Locale("J=R(PuAG\"r:n2qJ0", "M&of-m=^6%W", "J=R(PuAG\"r:n2qJ0");
  ...
  public void test11()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1658, "");
  ...
  public void test13()  throws Throwable  {
      ...
      stdDateFormat0.parse("0356-04-25T00:00:00.000+00:00", parsePosition0);
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1), "RZ2,.)");
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "?.'$(uT!b+VQSuu_r@");
      Locale locale0 = new Locale("?.'$(uT!b+VQSuu_r@", "");
  ...
  public void test23()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(57, "R$5-IAJdv0<j:");
      Locale locale0 = Locale.KOREAN;
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, false);
      Calendar calendar0 = stdDateFormat0._getCalendar(simpleTimeZone0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=1392409281320,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=java.util.SimpleTimeZone[id=R$5-IAJdv0<j:,offset=57,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2014,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=45,DAY_OF_WEEK=6,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=8,HOUR_OF_DAY=20,MINUTE=21,SECOND=21,MILLISECOND=320,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(43, 43, (-3798));
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123("2.2250738585072012e-308", parsePosition0);
  ...
  public void test31()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(1627);
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("fNvXa.cqE", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("[:3B$YfO+)Rk0T1", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test43()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(4058);
      // Undeclared exception!
      try { 
  ...
  public void test46()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0._parseDate("1930-05-26T00:00:00.000+0000", (ParsePosition) null);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"1930-05-26T00:00:00.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test48()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat3 = stdDateFormat2.instance.withLocale(locale1);
      ...
      assertSame(stdDateFormat0, stdDateFormat3);
  }
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-I0-500T00:0X");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-I0-500T00:0X\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0._parseDate("2`=AeXp]m-Y/5fpD3K", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("<5V>Zo8>o9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"<5V>Zo8>o9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1785), (-1785), (-2076));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0041-07-24T00:00:00.000+0000", string0);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      assertEquals("0356-04-25T00:00:00.000+00:00", string0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("1969-12-31T23:59:56.928-0000", stringBuffer0.toString());
      //  // Unstable assertion: assertEquals("1969-12-31T23:59:56.928-0000", stringWriter0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-2076), (-2076), (-2076));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0356-04-25T00:00:00.057+0000", string0);
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000$00-00v00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000$00-00v00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test67()  throws Throwable  {
      Locale locale0 = Locale.TAIWAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0);
      Boolean boolean0 = Boolean.valueOf("iC@.");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
  ...
  public void test69()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(58, "2.2250738585072012e-308");
      stdDateFormat0.instance.setTimeZone(simpleTimeZone0);
      String string0 = "0000-00-0IT0\\:00";
  ...
  public void test72()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-2076), (-2076), (-2076));
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("0356-04-25T00:00:00.057+00:00", string0);
  }
  ...
  public void test77()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(72, "Value \"");
  ...
  public void test80()  throws Throwable  {
      ...
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, 4856);
