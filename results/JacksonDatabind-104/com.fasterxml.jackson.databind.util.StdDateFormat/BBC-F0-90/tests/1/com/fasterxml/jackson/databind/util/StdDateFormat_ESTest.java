...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("F#Swlx", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"F#Swlx\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat2.parseAsISO8601("*^V5Vo97=_cUPS]>ne", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"*^V5Vo97=_cUPS]>ne\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject(",TmG95");
        fail("Expecting exception: ParseException");
  ...
  public void test12()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(3320);
  ...
  public void test19()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1821), "Value \"");
  ...
  public void test26()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("0000-00-00T00:00", (String) null);
      assertFalse(boolean0);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Locale locale0 = Locale.ITALY;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-2601));
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      Locale locale0 = new Locale("\"^WMZ;&P", "\"^WMZ;&P");
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0000-00-0a");
        fail("Expecting exception: ParseException");
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0000-N0a");
        fail("Expecting exception: ParseException");
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("25j1(K:");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"25j1(K:\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("9?tpY`$5;Cy", parsePosition0);
      assertEquals(3376, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=3376,errorIndex=3376]", parsePosition0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(9, "i9#)$YuqFR");
      Locale locale0 = Locale.ENGLISH;
      StringBuffer stringBuffer0 = new StringBuffer();
      MockDate mockDate0 = new MockDate((-1846), (-1530), 4, (-935), (-1121), (-1530));
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("0075-05-25T05:53:30.009+0000", stringBuffer0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.FALSE;
      Locale locale0 = Locale.ITALY;
      MockDate mockDate0 = new MockDate((-1121), (-1530), (-1846), 48, 412, (-1121));
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals(29, stringBuffer0.length());
      assertEquals("0646-06-12T06:33:19.057+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-554), "pG[SC]IvR`BC1h");
      Locale locale0 = Locale.ENGLISH;
      MockDate mockDate0 = new MockDate();
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals(28, stringBuffer0.length());
      assertEquals("2014-02-14T20:21:20.766-0000", stringBuffer0.toString());
  }
  ...
  public void test76()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "4X;*8");
      Locale locale0 = Locale.ROOT;
      Boolean boolean0 = Boolean.FALSE;
  ...
  public void test79()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      TimeZone timeZone1 = TimeZone.getTimeZone("dddd[-]dd[-]dd");
  ...
  public void test85()  throws Throwable  {
      ...
      stdDateFormat0.formatToCharacterIterator(date0);
