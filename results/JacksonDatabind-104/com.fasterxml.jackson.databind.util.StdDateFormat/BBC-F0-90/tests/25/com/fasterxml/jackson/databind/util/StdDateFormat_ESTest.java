...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("kJ7FwDvl's", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"kJ7FwDvl's\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.instance.parse("#Rv] r}");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"#Rv] r}\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("\" can not be represented as BigDecimal");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(4390);
      stdDateFormat0.parse("A", parsePosition0);
      assertEquals(4390, parsePosition0.getErrorIndex());
  ...
  public void test07()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(5770);
      stdDateFormat0.parse("+IeG=r79", parsePosition0);
      assertEquals(5770, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=5770,errorIndex=5770]", parsePosition0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Locale locale0 = new Locale("?p){{4No");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(1225);
      stdDateFormat0.parseAsRFC1123("?p){{4No", parsePosition0);
      assertEquals("java.text.ParsePosition[index=1225,errorIndex=1225]", parsePosition0.toString());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2659, " 4!vE)Dp#RZo;L");
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2153), "!>r3@jMmdc");
      Boolean boolean0 = Boolean.valueOf("!>r3@jMmdc");
  ...
  public void test28()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-3266));
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(4380);
      // Undeclared exception!
      try { 
  ...
  public void test52()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("\" can not be represented as BigDecimal");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(4380);
      try { 
  ...
  public void test53()  throws Throwable  {
      ...
      assertEquals(236, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=236,errorIndex=236]", parsePosition0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      ...
      stdDateFormat0.parse("7<Z^8Z6ZX?iBLj", parsePosition0);
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, (-2020));
      MockDate mockDate0 = new MockDate((-1732), (-2020), 2);
      ...
      assertEquals("0000-00-000002-09-02T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("\" can not be represented as BigDecimal");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      StringBuffer stringBuffer0 = new StringBuffer("nXW,Z;Mt%k?W->^");
      MockDate mockDate0 = new MockDate();
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("nXW,Z;Mt%k?W->^2014-02-14T20:21:21.320+00:00", stringBuffer0.toString());
  }
  ...
  public void test60()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(26, (-15), 10, (-1994), 48);
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      StringBuffer stringBuffer0 = new StringBuffer();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      stdDateFormat1._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1924-07-18T22:48:00.026+00:00", stringBuffer0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate();
      StringBuffer stringBuffer0 = new StringBuffer("UPiWB\"D=j");
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("UPiWB\"D=j2014-02-14T02:21:21.320-1800", stringBuffer0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("40", parsePosition0);
      assertNotNull(date0);
      assertEquals((-1), parsePosition0.getErrorIndex());
  }
  ...
  public void test64()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=1285,errorIndex=1285]", parsePosition0.toString());
      assertEquals(1285, parsePosition0.getErrorIndex());
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-a000");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-a000\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test70()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("6+n`jP=w}|M R?!Np");
  ...
  public void test79()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(304, "$`]CA+-UD!j-[ug]VW");
      // Undeclared exception!
      try { 
