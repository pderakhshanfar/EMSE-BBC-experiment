...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0000-18-00");
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("1k", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"1k\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test03()  throws Throwable  {
      ...
      stdDateFormat0.parse("h_`16,i", parsePosition0);
  ...
  public void test05()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("+=lM|u{9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-3281), 356, 0, (-925), 43);
  ...
  public void test07()  throws Throwable  {
      ...
      stdDateFormat0.parse("0000-00-0iT0s:00", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("java.text.ParsePosition[index=504,errorIndex=-1]", parsePosition0.toString());
  ...
  public void test12()  throws Throwable  {
      ...
      Locale locale0 = Locale.FRANCE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      stdDateFormat0.looksLikeISO8601("3h36K~ao  tP')bd");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test15()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1514, "zI:Z0~Wv^D]&D`");
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-125), "z/=)2H}UUHxeNZdD");
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "Y_p,Kr60|");
      ...
      stdDateFormat0._parseDate("Y_p,Kr60|", parsePosition0);
      assertEquals(1834, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1834,errorIndex=1834]", parsePosition0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("%2yd&1Mr*XY!ra", parsePosition0);
  ...
  public void test26()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "48nVM ^I\"[=%");
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, (Locale) null, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("48nVM ^I\"[=%", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test50()  throws Throwable  {
      ...
      stdDateFormat1.parse(">~ k1t\"rJjG$[){8", parsePosition0);
      assertEquals("java.text.ParsePosition[index=1514,errorIndex=1514]", parsePosition0.toString());
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0.parseAsRFC1123("1ly^_Y0,Ih", parsePosition0);
      try { 
        stdDateFormat0.parse("0000-00-30T00:0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-30T00:0\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-50), "pyVzLOf+^K{xht-");
      Locale locale0 = Locale.CANADA_FRENCH;
      Boolean boolean0 = Boolean.valueOf("pyVzLOf+^K{xht-");
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-P0-0W");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-P0-0W\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("3=~3 HpT#m`Kh'X.ca");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"3=~3 HpT#m`Kh'X.ca\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("9fs_YeQBa", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test61()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("X=:");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-3281), 43, 356, 43, 8);
      Date date0 = mockGregorianCalendar0.getGregorianChange();
      FieldPosition fieldPosition0 = new FieldPosition((-396));
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test62()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-5563), (-4942), 45);
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ENGLISH;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-5563), "");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      ...
      StdDateFormat stdDateFormat4 = stdDateFormat3.clone();
      String string0 = stdDateFormat4.format((Date) mockDate0);
      assertSame(stdDateFormat2, stdDateFormat1);
      assertEquals("4076-04-13T23:59:54.437-00:00", string0);
  }
  ...
  public void test66()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-1418), (-4839), 57, 80, (-2176));
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0078-11-27T19:44:00.000+0000", stringBuffer0.toString());
      assertEquals("0078-11-27T19:44:00.000+0000", stringWriter0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      stdDateFormat0.format(date0, stringBuffer0, fieldPosition0);
      assertEquals("2014-02-14T20:21:21.324+0000", stringBuffer0.toString());
  }
  ...
  public void test74()  throws Throwable  {
      ...
      Locale locale0 = Locale.CANADA_FRENCH;
      Boolean boolean0 = Boolean.valueOf("pyVzLOf+^K{xht-");
      SimpleTimeZone simpleTimeZone1 = new SimpleTimeZone((-50), "pyVzLOf+^K{xht-");
  ...
  public void test81()  throws Throwable  {
      ...
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=0000-00-00,offset=4,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0], locale: de_DE, lenient: true)", string0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
