...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("[one of: 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', 'EEE, dd MMM yyyy HH:mm:ss zzz' (strict)]", (ParsePosition) null);
        fail("Expecting exception: ParseException");
  ...
  public void test09()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-2312));
  ...
  public void test12()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("\" can not be represented as BigDecimal", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("(UF!/{^(");
  ...
  public void test14()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("llfZY26sV8d-Ot;Cc5");
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(730, "7XRUm5K~!G");
      Boolean boolean0 = Boolean.FALSE;
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-8), "0_40-00-00");
      Locale locale0 = Locale.FRENCH;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2757, "LJ*^Zvv@^P$KaVS");
  ...
  public void test24()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "00000");
      Locale locale0 = new Locale("00000", "U0E?;qYwh", "00000");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      Calendar calendar0 = stdDateFormat0._getCalendar(simpleTimeZone0);
      //  // Unstable assertion: assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=java.util.SimpleTimeZone[id=00000,offset=0,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=?,MONTH=?,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=?,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=?,HOUR=?,HOUR_OF_DAY=?,MINUTE=?,SECOND=?,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
      //  // Unstable assertion: assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-2292), 3, 3);
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123("YWU}ci:~$", parsePosition0);
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("Q9", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test38()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("2.2250738585072012e-30");
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0_00-00-00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0_00-00-00\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test40()  throws Throwable  {
      Locale locale0 = Locale.forLanguageTag("R_'bTmZav>[#k?");
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition((-1421));
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("R_'bTmZav>[#k?", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test43()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(1306);
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds(1306);
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
  ...
  public void test46()  throws Throwable  {
      String string0 = "0_00-00-00";
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.equals("0_00-00-00");
      TimeZone timeZone0 = TimeZone.getDefault();
      stdDateFormat0._getCalendar(timeZone0);
      int int0 = 707;
      ParsePosition parsePosition0 = new ParsePosition(int0);
      int int1 = 1148;
      parsePosition0.setIndex(int1);
      try { 
        stdDateFormat0._parseAsISO8601(string0, parsePosition0);
        fail("Expecting exception: ParseException");
  ...
  public void test47()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = new Locale("", "BM`?v", "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "BM`?v");
      // Undeclared exception!
      try { 
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Object object0 = stdDateFormat0.parseObject("0_00-00-00", (ParsePosition) null);
      assertTrue(stdDateFormat0.isLenient());
      assertNull(object0);
  }
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1803), 60, (-2962), 60, (-1803));
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-1125));
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.CANADA_FRENCH;
      StringBuffer stringBuffer0 = new StringBuffer(2301);
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("0093-11-22T05:57:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(2517, 2517, 35, 58, 41, 4);
      StringBuffer stringBuffer0 = new StringBuffer(10);
      FieldPosition fieldPosition0 = new FieldPosition(274);
      stdDateFormat1.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals(29, stringBuffer0.length());
      assertEquals("4626-11-06T10:41:04.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(4, 57, 2517, 4, 4, 57);
      StringBuffer stringBuffer0 = new StringBuffer(8);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(58, "}n");
      ...
      assertEquals(29, stringBuffer0.length());
      assertEquals("1915-08-22T04:04:57.058+00:00", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      assertEquals("1915-08-22T04:04:57.058+0000", stringBuffer0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-4716), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = new Locale("yyyy-MM-dd'T'HH:mm:ss.SSSZ", "', '");
      MockDate mockDate0 = new MockDate((-634), 43, (-345));
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1268-08-19T23:59:55.284-0000", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("(UF!/{^(");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate(3, 3, (-2309));
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, (-2309));
      // Undeclared exception!
      try { 
  ...
  public void test72()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("3x?1 50");
      Locale locale0 = new Locale("Cannot parse date \"%s\": not compatible with any of standard forms (%s)", "9&@92]jP5t");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, (Boolean) null, true);
      try { 
        stdDateFormat0.parse("3x?1 50");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"3x?1 50\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test73()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("1|':z_obqfiT_ZeD");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"1|':z_obqfiT_ZeD\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
