...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("8b7P{\"e%}", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"8b7P{\"e%}\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("B@{rxoB4}z9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"B@{rxoB4}z9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("1269-12-26T19:00:43.000+0000");
        fail("Expecting exception: ParseException");
  ...
  public void test16()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("Tue Dec 16 06:00:00 GMT 5519", date0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "~V+EhpHF", 10, 0, 90, 10, 1394, 0, 0, 90, 90, 798, 100);
  ...
  public void test22()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(58, ":,f~W&M'$CG");
      Locale locale0 = new Locale("%.6rG", "/s;]tPhU.'f>W7|.8", ":,f~W&M'$CG");
  ...
  public void test24()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(3341, 3341, 60, 3341, 60, 0);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ5519-12-16T06:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("C/]l ");
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0._parseDate("0p00-00-00T00:00", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0p00-00-00T00:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("}F*mB9Z}P;|F?`M5,", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test52()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CANADA_FRENCH;
      StringBuffer stringBuffer0 = new StringBuffer("AaAtS=4pG*xI");
      // Undeclared exception!
      try { 
  ...
  public void test57()  throws Throwable  {
      ...
      stdDateFormat0.setTimeZone(zoneInfo0);
      try { 
        stdDateFormat0.parse("JYA_\"N}Pk3$4d");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"JYA_\"N}Pk3$4d\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(2184);
      stdDateFormat0._parseDate("w@XBE5k % I/0`", parsePosition0);
      assertEquals("java.text.ParsePosition[index=2184,errorIndex=2184]", parsePosition0.toString());
      assertEquals(2184, parsePosition0.getErrorIndex());
  }
  ...
  public void test60()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(45);
      try { 
        stdDateFormat0._parseAsISO8601(",n6aFWX", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \",n6aFWX\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "=I8pb&|jC");
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-b0-00T00:0C");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-b0-00T00:0C\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("3X%8\"L0<1j##6^", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("8[H%~,x4atA3");
        fail("Expecting exception: ParseException");
  ...
  public void test69()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate((-32), (-32), (-255));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1864-08-18T00:00:00.000+00:00", string0);
  }
  ...
  public void test70()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.MAX;
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      MockDate mockDate0 = new MockDate(1170, 4, 2298);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("3076-08-14T18:00:00.000+1800", string0);
  }

  @Test(timeout = 4000)
  public void test71()  throws Throwable  {
      Boolean boolean0 = Boolean.valueOf(true);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3242), "Cannot parse date \"%s\": not compatible with any of standard forms (%s)");
      Locale locale0 = Locale.US;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate((-32), (-1), (-1002));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1865-03-02T23:59:56.758-00:00", string0);
  }
  ...
  public void test74()  throws Throwable  {
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=1392409281320,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=java.util.SimpleTimeZone[id=com.fasterxml.jackson.core.io.NumberInput,offset=-45,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2014,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=45,DAY_OF_WEEK=6,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=8,HOUR_OF_DAY=20,MINUTE=21,SECOND=21,MILLISECOND=320,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test84()  throws Throwable  {
      ...
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      stdDateFormat0.setTimeZone(zoneInfo0);
      MockDate mockDate0 = new MockDate((-1800), (-1800), 1);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0051-01-01T00:00:00.000+0000", string0);
  }
  ...
  public void test86()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("EEE, dd MMM yyyy HH:mm:ss zzz", mockSimpleDateFormat0.toPattern());
  ...
  public void test92()  throws Throwable  {
      ...
      stdDateFormat0.parse("ML\"93<IvY+5{E!", parsePosition0);
