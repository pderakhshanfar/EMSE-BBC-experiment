...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        stdDateFormat1._parseAsISO8601("eNfDE:(bep", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"eNfDE:(bep\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("w,~#j9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"w,~#j9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("java.text.ParsePosition[index=1404,errorIndex=-1]", parsePosition0.toString());
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-50), "^({,cEnUOrX8");
      Boolean boolean0 = Boolean.TRUE;
  ...
  public void test11()  throws Throwable  {
      Locale locale0 = new Locale("Cannot parse date \"%s\", problem: %s", "Cannot parse date \"%s\", problem: %s", "yyyy-MM-dd");
  ...
  public void test12()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "_Z=");
      ...
      stdDateFormat0.parseAsRFC1123("_Z=", parsePosition0);
      assertEquals("java.text.ParsePosition[index=463,errorIndex=463]", parsePosition0.toString());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      stdDateFormat0.parse("x]`z/R_E]", parsePosition0);
      assertEquals(2333, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=2333,errorIndex=2333]", parsePosition0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("xC$kUS<5K3Y'Q7f0iE");
  ...
  public void test26()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      boolean boolean1 = StdDateFormat._equals((Object) timeZone0, (Object) boolean0);
  ...
  public void test42()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00-00T0M0:00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-00T0M0:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test43()  throws Throwable  {
      ...
      parsePosition0.setIndex((-953));
      // Undeclared exception!
      try { 
        stdDateFormat0.instance._parseDate("EEE, dd MMM yyyy HH:mm:ss zzz", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test44()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("*8q[Nli.zC", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test50()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1233), (-1233), (-1233), (-1233), (-1233), (-1233));
      TimeZone timeZone0 = TimeZone.getDefault();
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("1c(4\" ni/c9d\"3#X5");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"1c(4\" ni/c9d\"3#X5\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0AID g");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0AID g\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1733), (-1733), (-1733), (-1733), (-1733), (-789));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0017-08-19T13:53:51.000+0000", string0);
  }
  ...
  public void test69()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-50), "^({,cEnUOrX8");
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      Boolean boolean0 = Boolean.valueOf("^({,cEnUOrX8");
      ...
      assertEquals("2014-02-14T20:21:21.270-00:00", string0);
  }

  @Test(timeout = 4000)
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(48, "com.fasterxml.jackson.core.io.NumberInput");
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      MockDate mockDate0 = new MockDate(594, 1386, (-1415), (-1695), 594, 1);
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      //  // Unstable assertion: assertEquals("2605-06-05T18:54:01.048+0000", stringBuffer0.toString());
  ...
  public void test75()  throws Throwable  {
      ...
      int int0 = 277;
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(277, 277, 277);
      Locale locale0 = Locale.CHINA;
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
