...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(5162);
      Date date0 = stdDateFormat0.parse("0000-00-00", parsePosition0);
      assertNotNull(date0);
      assertEquals("java.text.ParsePosition[index=5162,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Locale locale0 = Locale.ROOT;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("0000-0J-00");
      assertTrue(boolean0);
  ...
  public void test12()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      stdDateFormat0.looksLikeISO8601("RjXJvpmD e^X'LMtP");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test21()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("yyyy-MM-dd'T'HH:mm:ss.SSSZ", "dddd[-]dd[-]dd[T]dd[:]dd(?:[:]dd)?(.d+)?(Z|[+-]dd(?:[:]?dd)?)?");
  ...
  public void test26()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2, ";Z^HG2tu,^C>xUa");
      ...
      try { 
        stdDateFormat0.parseAsISO8601(";Z^HG2tu,^C>xUa", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \";Z^HG2tu,^C>xUa\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.forLanguageTag("qG6.5>uO%U");
  ...
  public void test31()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "", 0, 9, 0, 57, 9, 9, 0, 0);
  ...
  public void test40()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("H)QLuP736jrB82;OI");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test49()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.forLanguageTag("f4");
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("2Y-9\"16");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"2Y-9\"16\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.KOREA;
      MockDate mockDate0 = new MockDate(41, (-1857), (-805), (-1590), 41, (-805));
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1783-11-10T18:27:35.000+00:00", string0);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null);
      MockDate mockDate0 = new MockDate(3027L);
      StringBuffer stringBuffer0 = new StringBuffer();
      ...
      assertEquals("1970-01-01T00:00:03.072+00:00", stringBuffer0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("1970-01-01T00:00:03.072+0000", stringBuffer0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.ROOT;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-380), "0000-00-00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null);
      MockDate mockDate0 = new MockDate((-380), (-380), (-380), (-380), (-380), (-380));
      ...
      assertEquals("\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u00001487-03-30T21:33:39.620-0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1946), 28, 28, 28, 28, 28);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0045-05-29T04:28:28.000+0000", string0);
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-T00-3");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-T00-3\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0000-0J-00", parsePosition0);
      assertTrue(stdDateFormat0.isLenient());
  ...
  public void test69()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(5, "EEE, dd MMM yyyy HH:mm:ss zzz", 5, 5, 0, 5, 5, 5, 5, 5);
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = Boolean.valueOf(true);
  ...
  public void test78()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      try { 
        stdDateFormat0.parse("38X|NArhLQjT%SQ3w~~");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"38X|NArhLQjT%SQ3w~~\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test81()  throws Throwable  {
      ...
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=EEE, dd MMM yyyy HH:mm:ss zzz,offset=5,dstSavings=3600000,useDaylight=true,startYear=0,startMode=1,startMonth=5,startDay=5,startDayOfWeek=0,startTime=5,startTimeMode=0,endMode=2,endMonth=5,endDay=5,endDayOfWeek=5,endTime=5,endTimeMode=0], locale: fr_FR, lenient: true)", string0);
  }

  @Test(timeout = 4000)
  public void test82()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("0300-00-70");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
