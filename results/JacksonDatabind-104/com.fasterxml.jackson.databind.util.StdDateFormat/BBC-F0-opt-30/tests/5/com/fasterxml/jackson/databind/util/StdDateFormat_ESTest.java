...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("1(?9+hr\"RHbl");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"1(?9+hr\"RHbl\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("sHDCe{p");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"sHDCe{p\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse(":aj'F`\"&?l;jE9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \":aj'F`\"&?l;jE9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals("1970-01-01T00:00:00.043+0000", stringBuffer0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("%I40vRC0lGe`Y", "%I40vRC0lGe`Y");
      Boolean boolean0 = new Boolean("wAk3D/;3_EW=7Y\"KbH");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2421, "Y#&=`G'YAf");
  ...
  public void test22()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("/x\"?", "/x\"?");
      assertTrue(boolean0);
  }
  ...
  public void test27()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4, "6?=Z");
  ...
  public void test32()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("MRd]b ItIEER");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("F% ':wZ9{OA..H]~");
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0080-08-19T00:37:05.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"0080-08-19T00:37:05.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("/a{?N=V}cKVgk/_U#", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("2.2250738585072012e-308");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition((-3952));
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("2.2250738585072012e-308");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate((-1687), (-2458), 10, (-1687), 342, 3);
  ...
  public void test50()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(602, "ougH]Wr");
  ...
  public void test51()  throws Throwable  {
      Locale locale0 = new Locale("[one of: '", ".OVs>{JD#l0", "[one of: '");
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("7#|?%!(8bm");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"7#|?%!(8bm\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(43, (-2458), 10, 342, 260, 3893);
      StringBuffer stringBuffer0 = new StringBuffer(16);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, (FieldPosition) null);
      assertEquals("1738-03-24T11:24:53.000+00:00", stringBuffer0.toString());
  ...
  public void test63()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2147483645, "0000-00-00");
      Locale locale0 = Locale.FRENCH;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(false);
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, 2439);
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(48, 48, 7);
      Date date0 = mockGregorianCalendar0.getGregorianChange();
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat1.format(date0, stringBuffer0, fieldPosition0);
      assertEquals(28, stringBuffer0.length());
      assertEquals("1582-11-08T20:31:23.645+k631", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      Boolean boolean0 = Boolean.valueOf("0000-00-00");
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1331), "0000-00-00");
      Locale locale0 = Locale.FRENCH;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, 2439);
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(48, 48, 7);
      ...
      assertEquals("1582-10-04T23:59:58.669-00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1687), (-1687), (-1687), 180, 180, 180);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0067-10-25T15:03:00.000+0000", string0);
      
      ParsePosition parsePosition0 = new ParsePosition(2);
      stdDateFormat0.parse("0067-10-25T15:03:00.000+0000", parsePosition0);
  ...
  public void test86()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      try { 
        stdDateFormat0.parse("0000-i00-00T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-i00-00T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
