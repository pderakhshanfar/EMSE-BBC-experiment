...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      stdDateFormat0.parse("h|bq'Z'", parsePosition0);
  ...
  public void test09()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-1161));
  ...
  public void test16()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("CiJn>3HkH1Nf4");
  ...
  public void test17()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("bVi5", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test19()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      TimeZone timeZone0 = TimeZone.getTimeZone("c=k");
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("zKCp\"Kpmm=h@:ih", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test39()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("CiJn>3HkH1Nf4");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition((-631));
      try { 
        stdDateFormat0._parseAsISO8601("qJxx^", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"qJxx^\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test40()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("XWhz$>`~");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1599), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:19.721-0000", string0);
  ...
  public void test50()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds(585);
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.US;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      try { 
        stdDateFormat0.parse("[one of: '");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"[one of: '\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test52()  throws Throwable  {
      ...
      assertEquals(1651, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1651,errorIndex=1651]", parsePosition0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("H30K;Z)ugW%\"");
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.ENGLISH;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      try { 
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("6ReeT{DbhAk");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"6ReeT{DbhAk\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1947), 116, 740, 740, 12, 740);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0037-10-09T20:24:20.000+0000", string0);
      assertTrue(stdDateFormat0.isLenient());
  }
  ...
  public void test61()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(48, 356, 48, 356, 1000);
  ...
  public void test62()  throws Throwable  {
      ...
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:22.320+0000", string0);
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("5Q,9$eq{");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"5Q,9$eq{\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test80()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3379), "0000-00-00T00:00");
      // Undeclared exception!
      try { 
  ...
  public void test82()  throws Throwable  {
      ...
      assertEquals("41970-01-01T00:00:00.004+0000", stringBuffer0.toString());
  }
  ...
  public void test86()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(16);
      stdDateFormat0.parse("1970-01-01T00:00:01.690+0000", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
