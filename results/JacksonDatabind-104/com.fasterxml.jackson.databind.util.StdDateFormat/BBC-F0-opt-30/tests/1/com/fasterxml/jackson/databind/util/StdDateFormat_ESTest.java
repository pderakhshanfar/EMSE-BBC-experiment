...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("2.225038585072012e-308", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      stdDateFormat0.parseObject("SeZL~4~4M9", parsePosition0);
  ...
  public void test04()  throws Throwable  {
      ...
      stdDateFormat0.parse("0000-00-0T00:0", (ParsePosition) null);
  ...
  public void test07()  throws Throwable  {
      ...
      Locale locale0 = new Locale("%fZKrWvh94q\"2!l");
  ...
  public void test15()  throws Throwable  {
      Locale locale0 = new Locale("+00:00", "strict");
  ...
  public void test16()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, ". DPrDc[?b=IMXR");
  ...
  public void test17()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1316, ". DPrDc[?b=XR");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      TimeZone timeZone0 = stdDateFormat1.getTimeZone();
      assertNotNull(timeZone0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  ...
  public void test19()  throws Throwable  {
      ...
      parsePosition0.setIndex(79);
      Date date0 = stdDateFormat0._parseDate("$X^r\"^|pxK;[Zf*#bF!", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1), "JwL1f?0R2|f6)J{\"");
      Boolean boolean0 = Boolean.FALSE;
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=1392409281320,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=java.util.SimpleTimeZone[id=JwL1f?0R2|f6)J{\",offset=-1,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2014,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=45,DAY_OF_WEEK=6,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=8,HOUR_OF_DAY=20,MINUTE=21,SECOND=21,MILLISECOND=320,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("0", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, (-579));
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance._parseDate("kr\"-_}J=ZF,'", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(3712);
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("<9*q|_");
  ...
  public void test52()  throws Throwable  {
      ...
      Boolean boolean1 = new Boolean("lenient");
  ...
  public void test53()  throws Throwable  {
      ...
      stdDateFormat3.parse("M", parsePosition0);
      Locale locale0 = Locale.UK;
      parsePosition0.setErrorIndex((-1471));
      Boolean boolean0 = Boolean.TRUE;
      Boolean.valueOf("strict");
      Boolean boolean1 = Boolean.valueOf("0000-00-00");
      StdDateFormat stdDateFormat4 = stdDateFormat0.withLenient(boolean1);
      try { 
        stdDateFormat4.parse("QDK=<");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"QDK=<\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601(",@xP", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \",@xP\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("080-0F-0T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"080-0F-0T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      ...
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      MockDate mockDate0 = new MockDate((-1836), (-1836), (-1836), 13, (-1939), 13);
      StringBuffer stringBuffer0 = new StringBuffer("' (");
      stdDateFormat0.instance._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("' (0096-12-20T04:41:13.000+0000", stringBuffer0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-1000), (-1000), 84, (-1960), 57);
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0816-09-02T08:57:00.000+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(3, 45, 45);
      StringBuffer stringBuffer0 = new StringBuffer();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1271), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      stdDateFormat1._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1906-11-13T23:59:58.729-00:00", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(95, "dddd[-]dd[-]dd");
      Locale locale0 = Locale.ITALIAN;
      stdDateFormat0._format(simpleTimeZone0, locale0, date0, stringBuffer0);
      assertEquals("0000-00-002014-02-14T20:21:21.415+0000", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer();
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, (-2428));
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("77.2(A5iXt1.wk7t");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"77.2(A5iXt1.wk7t\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test78()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(stdDateFormat0.instance._timezone);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
      assertNotSame(stdDateFormat1, stdDateFormat0);
  }
  ...
  public void test87()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("/t:M|IO92");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      String string0 = stdDateFormat0.toString();
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: ja_JP, lenient: false)", string0);
  }
