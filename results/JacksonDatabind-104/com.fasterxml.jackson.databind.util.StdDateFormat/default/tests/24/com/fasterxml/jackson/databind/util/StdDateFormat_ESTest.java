...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        stdDateFormat1.parseAsISO8601("EfX053@}?C_6xv", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"EfX053@}?C_6xv\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
  ...
  public void test04()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("\u0005|(J(_9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test11()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-997), "yyyy-MM-dd'T'HH:mm:ss.SSS");
  ...
  public void test12()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("E");
  ...
  public void test15()  throws Throwable  {
      Locale locale0 = Locale.ENGLISH;
      Boolean boolean0 = Boolean.TRUE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(81, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test16()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(8, 8, (-441));
      FieldPosition fieldPosition0 = new FieldPosition(8);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1907-06-17T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      //  // Unstable assertion: assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      //  // Unstable assertion: assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=java.util.SimpleTimeZone[id=yyyy-MM-dd'T'HH:mm:ss.SSS,offset=-997,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=?,MONTH=?,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=?,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=?,HOUR=?,HOUR_OF_DAY=?,MINUTE=?,SECOND=?,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(79, 45, 581, 45, (-1343), 120);
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0._parseAsISO8601("Timestamp value %s out of 6-b1t value range", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"Timestamp value %s out of 6-b1t value range\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        stdDateFormat1.parseAsISO8601("xv'RK.", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"xv'RK.\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3464, "[one of: '");
  ...
  public void test58()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(107);
      stdDateFormat0._parseDate("?LNr", parsePosition0);
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000---0-0~00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000---0-0~00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("3z\"2,Td}gy");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"3z\"2,Td}gy\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("3kP,HPhH'g");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"3kP,HPhH'g\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test67()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1699), (-1699), (-1699), (-1699), (-1699), (-1699));
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1699), "Cannot parse date \"%s\": invalid fractional seconds '%s'; can use at most 9 digits");
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("0054-07-25T00:12:39.301-00:00", string0);
  }
  ...
  public void test68()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      MockDate mockDate0 = new MockDate(89, 1781, 9, 1, 18);
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2137-06-09T01:18:00.002+0000", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      assertEquals(1781, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1781,errorIndex=1781]", parsePosition0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      ...
      assertEquals("1970-01-01T00:00:00.006+00:00", string0);
  }
  ...
  public void test73()  throws Throwable  {
      Boolean boolean0 = Boolean.TRUE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3472), ")b,zrTN<ON");
      Locale locale0 = Locale.GERMAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test80()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4, "3Cr%oLowNTp");
