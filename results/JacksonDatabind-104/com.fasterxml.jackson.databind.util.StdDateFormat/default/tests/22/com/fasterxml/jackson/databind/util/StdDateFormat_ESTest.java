...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1800, "Value \"");
      ...
      try { 
        stdDateFormat0._parseAsISO8601("Ef:CSX/ @f", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"Ef:CSX/ @f\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test04()  throws Throwable  {
      ...
      stdDateFormat0.parse("0000-00-)0T00:8qa0", parsePosition0);
  }
  ...
  public void test06()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-20), "cV'Q8S");
      Locale locale0 = Locale.ENGLISH;
      Boolean boolean0 = new Boolean("cV'Q8S");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
  ...
  public void test07()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2127, "g]");
  ...
  public void test15()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(25, 25, 43, (-3840), 76, 3318);
  ...
  public void test18()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("60000", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test20()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(14, "cV'Q8S");
      Locale locale0 = Locale.ENGLISH;
      Boolean boolean0 = new Boolean("cV'Q8S");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
  ...
  public void test22()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("T'Oa YUa?rT)");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
  ...
  public void test23()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("J/Ao*E", "");
  ...
  public void test46()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("cV'Q8S");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      Boolean boolean1 = new Boolean("=<KL");
  ...
  public void test52()  throws Throwable  {
      ...
      TimeZone timeZone1 = TimeZone.getTimeZone("<V");
  ...
  public void test53()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0._parseDate("Y\"96+#[5T\"<91", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-*00-00TA0:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-*00-00TA0:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("10N}QTDB-]5Vs)<f(r");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"10N}QTDB-]5Vs)<f(r\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Boolean boolean0 = Boolean.valueOf("}ru[:NY");
  ...
  public void test58()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1767-04-02T17:12:53.000+0000", stringBuffer0.toString());
  }
  ...
  public void test59()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("0038-04-29T11:17:00.000+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test60()  throws Throwable  {
      MockDate mockDate0 = new MockDate(10, (-1711), 13, (-1711), 13, (-7));
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(10, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.GERMANY;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1767-04-02T17:12:53.010+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3307), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0.setTimeZone(simpleTimeZone0);
      MockDate mockDate0 = new MockDate();
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:18.013-0000", string0);
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("60000");
      String string0 = stdDateFormat0.format(date0);
      assertEquals("1970-01-01T00:01:00.000+0000", string0);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      stdDateFormat0.instance.parse("4)99,`64uwF5jKU>Iq", parsePosition0);
      assertEquals("java.text.ParsePosition[index=2750,errorIndex=2750]", parsePosition0.toString());
      assertEquals(2750, parsePosition0.getErrorIndex());
  }

  @Test(timeout = 4000)
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(618);
      try { 
        stdDateFormat0.parseAsISO8601("}Y@N;2`w.", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"}Y@N;2`w.\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test69()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3964), "Value \"");
      Locale locale0 = Locale.ENGLISH;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      assertSame(stdDateFormat1, stdDateFormat0);
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Locale locale0 = new Locale("yyyy-MM-dd'T'HH:mm:ss.SSSZ", "(+l79DP@No{zCeH");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
