...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("00005q-0-0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00005q-0-0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
  ...
  public void test01()  throws Throwable  {
      ...
      stdDateFormat0.parseObject("q,ycD~6", parsePosition0);
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("\"@ot9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"\"@ot9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      ...
      stdDateFormat0.parseObject("0000-0-0", parsePosition0);
  ...
  public void test06()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-3624), (-3624), (-3624), 17, 46);
      StringBuffer stringBuffer0 = new StringBuffer(17);
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("2037-01-29T17:46:00.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0.parseAsRFC1123("}A:1n", parsePosition0);
  ...
  public void test15()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      boolean boolean1 = stdDateFormat0.looksLikeISO8601("\"@ot9");
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(57, "8}M");
  ...
  public void test30()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-5034));
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("`E-F", parsePosition0);
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("!|i?,L'Jjz\"~!", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0._parseDate("0000-00-00T00E00", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-00T00E00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("Yu@\"jEL{JW'\"2-", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test53()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-3682), 90, (-3682), 82, 1064);
      StringBuffer stringBuffer0 = new StringBuffer(115);
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1786-06-04T09:44:00.000-1800", stringBuffer0.toString());
  }
  ...
  public void test60()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getDefault();
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      TimeZone timeZone1 = TimeZone.getTimeZone("[one of: 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', 'EEE, dd MMM yyyy HH:mm:ss zzz' (lenient)]");
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("1000#00-00TM0:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"1000#00-00TM0:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("7?gX}qh/eF");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"7?gX}qh/eF\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test69()  throws Throwable  {
      ...
      boolean boolean1 = stdDateFormat0.equals("0000-00-00");
      assertFalse(boolean1);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertFalse(stdDateFormat0.isLenient());
  }
  ...
  public void test71()  throws Throwable  {
      ...
      assertEquals("0064-04-03T10:53:00.000+0000", string0);
  }
  ...
  public void test85()  throws Throwable  {
      ...
      Locale locale0 = new Locale("![qPVg~b6=)@ jS.3a");
  ...
  public void test87()  throws Throwable  {
      ...
      stdDateFormat0.parse("K6", parsePosition0);
