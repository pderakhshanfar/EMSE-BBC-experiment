...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("jrUe");
      Locale locale0 = new Locale("EZO3B!1t2O(xG*VR&>");
  ...
  public void test04()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1419), "~s%3Se");
      ...
      assertEquals("1582-10-04T23:59:58.581-0000", stringBuffer0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("jzUe");
      Locale locale0 = new Locale("EZO3B!1t2O(xG*VR&>");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      stdDateFormat0.parse("0000-00", (ParsePosition) null);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("4&X6eF:!*9P tTv1R");
  ...
  public void test12()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123(".z3Na+@KU*", parsePosition0);
  ...
  public void test14()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, (Boolean) null, true);
      ParsePosition parsePosition0 = new ParsePosition(47);
      stdDateFormat0.parse("#I`K1m7WC>['?k%sp$q", parsePosition0);
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      boolean boolean0 = StdDateFormat._equals((Object) "2.2250738585072012e-308", (Object) calendar0);
      //  // Unstable assertion: assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test41()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0._parseDate("2000-00-A10", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"2000-00-A10\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("r]4^B[lfu&tfqrXl=", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test48()  throws Throwable  {
      ...
      Locale locale0 = new Locale("!p3faS");
      Boolean boolean0 = Boolean.valueOf("!p3faS");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("00x0--0D");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00x0--0D\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("97O8#jVX7f5e+,1!Ob");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"97O8#jVX7f5e+,1!Ob\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0Cjb:Y3");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0Cjb:Y3\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test65()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-3), (-1427), (-2600));
      Locale locale0 = new Locale("0000-00-00", "0000-00-00T00:00", "0000-00-00T00:00");
      ...
      assertEquals("0000-00-001770-12-19T00:00:00.000+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test66()  throws Throwable  {
      MockDate mockDate0 = new MockDate(9, 9, 11, 9, 29, 9);
      ...
      assertEquals("1909-10-11T09:29:09.446+00:00", string0);
      assertFalse(stdDateFormat0.isLenient());
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1658), (-1658), (-2429));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0097-03-07T00:00:00.000+0000", string0);
  }
  ...
  public void test70()  throws Throwable  {
      ...
      stdDateFormat0.parseObject("-v`cx})'QZ,w#6-S", parsePosition0);
      assertEquals(1142, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1142,errorIndex=1142]", parsePosition0.toString());
  }
  ...
  public void test84()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(10, "0000-00-00Ta00:00");
