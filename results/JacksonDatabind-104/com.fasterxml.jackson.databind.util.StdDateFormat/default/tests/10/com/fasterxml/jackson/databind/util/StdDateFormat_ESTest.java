...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("Chinese", parsePosition0);
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("5{@5f&ocbTBoq66F#");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"5{@5f&ocbTBoq66F#\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test04()  throws Throwable  {
      ...
      stdDateFormat0.parse("K.~^|u\"_8Y)ji/TP9", parsePosition0);
  ...
  public void test10()  throws Throwable  {
      ...
      stringArray0[5] = "yyyy-MM-dd'T'HH:mm:ss.SSSZ";
      stringArray0[6] = "yyyy-MM-dd'T'HH:mm:ss.SSSZ";
      stringArray0[7] = "yyyy-MM-dd'T'HH:mm:ss.SSSZ";
  ...
  public void test11()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("rDaT-", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test15()  throws Throwable  {
      Locale locale0 = Locale.GERMANY;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(51, "1Z,U$+' z.$a-~`f\"^'");
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "Vgzh209J$dB");
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2976), "dddd[-]dd[-]dd[T]dd[:]dd(?:[:]dd)?(.d+)?(Z|[+-]dd(?:[:]?dd)?)?");
      Boolean boolean0 = new Boolean(true);
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(110, "J1^wYBgv>Dv:");
  ...
  public void test21()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ITALIAN;
      MockDate mockDate0 = new MockDate((-1233), (-120), 97, 3480, (-8));
      StringBuffer stringBuffer0 = new StringBuffer("Evm(H_}JN");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, (-1233));
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals(39, stringBuffer0.length());
      assertEquals("Evm(H_}JN0657-08-29T23:52:00.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("Cannot parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test42()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(2118);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("9< e3~*2cj7/", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test55()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("grfq?RjK_H", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"grfq?RjK_H\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0o00-<0.-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0o00-<0.-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("4F]1#y.5|qY7aqO");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4F]1#y.5|qY7aqO\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(9, "0o00-00-00");
      Boolean boolean0 = Boolean.FALSE;
      ...
      assertEquals("1970-01-01T00:00:00.010+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1745), (-1745), (-1745), 3, 3);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0004-10-20T03:03:00.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1784), (-1784), (-1784), (-1784), (-1784), (-1784));
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1784), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.GERMAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("0039-03-27T09:46:14.216-0000", string0);
  }
  ...
  public void test77()  throws Throwable  {
      Locale locale0 = Locale.GERMAN;
      TimeZone timeZone0 = TimeZone.getDefault();
      Boolean boolean0 = new Boolean("~JRnlY8P7vL#D&JM");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      boolean boolean1 = stdDateFormat0.isColonIncludedInTimeZone();
      assertTrue(boolean1);
      assertFalse(stdDateFormat0.isLenient());
