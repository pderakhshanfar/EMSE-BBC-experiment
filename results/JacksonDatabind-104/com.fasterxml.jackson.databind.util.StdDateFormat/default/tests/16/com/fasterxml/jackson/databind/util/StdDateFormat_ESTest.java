...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("0003%0!00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0003%0!00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=1899,errorIndex=1899]", parsePosition0.toString());
      assertEquals(1899, parsePosition0.getErrorIndex());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-2255));
      // Undeclared exception!
      try { 
        stdDateFormat0.parseObject("u}L]9", parsePosition0);
  ...
  public void test11()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("ss%8_V|w", parsePosition0);
      assertNull(date0);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "!1T<n%kR0{{ieal/");
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(20, "2i#Oz;;<7#l");
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-4687), "b");
  ...
  public void test22()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=1739,errorIndex=1739]", parsePosition0.toString());
      assertEquals(1739, parsePosition0.getErrorIndex());
  }
  ...
  public void test27()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("Y", "\" can not be represented as BigDecimal");
  ...
  public void test53()  throws Throwable  {
      ...
      Locale locale0 = Locale.CANADA_FRENCH;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-3604));
      try { 
        stdDateFormat0._parseAsISO8601("|Pk,K2HjrwLp", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"|Pk,K2HjrwLp\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1730), (-1730), (-1730), (-1730), (-2878), (-1730));
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-536), "2.2250738585072012e-308");
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "0020-11-21T21:33:10.000+0000");
      Locale locale0 = Locale.ENGLISH;
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("0020-11-21T21:33:10.000+00000020-11-21T21:33:09.464-0000", stringBuffer0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1879), "!1T<n%kR0{{ieal/");
      Locale locale0 = Locale.ITALY;
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("9qX3PE!&Fcp-PCD");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9qX3PE!&Fcp-PCD\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("1!s,t]9%+JX4;t");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"1!s,t]9%+JX4;t\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test64()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      MockDate mockDate0 = new MockDate((-1896), 8, (-1896), (-1896), (-935), 9);
      ...
      assertEquals("0002-04-04T08:25:09.000+0000", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("58");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test69()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("00+0-I0-00T0%0:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00+0-I0-00T0%0:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
