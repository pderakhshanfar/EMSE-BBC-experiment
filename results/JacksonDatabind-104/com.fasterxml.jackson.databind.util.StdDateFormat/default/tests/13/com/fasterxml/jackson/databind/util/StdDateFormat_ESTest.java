...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("Nu[z[nkp#?=LQEa~d]a");
  ...
  public void test07()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("000000", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test11()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("3f33\"j%H:");
  ...
  public void test14()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-550), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test16()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, (-2440));
  ...
  public void test18()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("D,M)+4`$@W<s@X*T9", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test20()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition((-2440));
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.forLanguageTag("0000-00-00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
  ...
  public void test24()  throws Throwable  {
      ...
      boolean boolean0 = StdDateFormat._equals((Object) mockDateFormat0, (Object) "Value \"");
      assertFalse(boolean0);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("~K1", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(42, "|v7)/p-M811:IV-z_t^");
  ...
  public void test44()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isLenient());
      assertEquals("1970-01-01T00:00:00.084+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test45()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-839), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, (Locale) null);
      MockDate mockDate0 = new MockDate((-1845L));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1969-12-31T23:59:57.316-0000", string0);
  }
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("2SW8t0')r5{2");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"2SW8t0')r5{2\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("6\"MxIeJr*m'rIm[ ");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"6\"MxIeJr*m'rIm[\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-2026), 615, 2252, 2316, 48, 22);
      // Undeclared exception!
      try { 
  ...
  public void test80()  throws Throwable  {
      ...
      stdDateFormat0.parse("1276-02-21T18:24:00.000+0000", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
