...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(1, 1, 0, (-580), (-4134));
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1901-01-03T23:06:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parseObject("0012-01-07T00:00:00.000+0000", (ParsePosition) null);
  ...
  public void test12()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1279, "o9OQLr=`4^:");
  ...
  public void test20()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-384), "0000-00-00");
  ...
  public void test22()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, 2147483645);
      stdDateFormat0.instance.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1969-12-31T23:59:59.661+0000", stringBuffer0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("|C1Q~;]dsI59", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(3039);
  ...
  public void test31()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("(`CGaK^\"=%", "tacs");
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("413");
      // Undeclared exception!
      try { 
  ...
  public void test54()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("yyyy-{M-dd");
      Locale locale0 = Locale.KOREAN;
      Boolean boolean0 = Boolean.valueOf("yyyy-{M-dd");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
  ...
  public void test57()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone("Hcq3P");
      ...
      ParsePosition parsePosition1 = new ParsePosition(2272);
      StdDateFormat stdDateFormat3 = stdDateFormat1.clone();
      boolean boolean0 = stdDateFormat3.isLenient();
      assertTrue(boolean0);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      try { 
        stdDateFormat0.parse("Spy/J7q");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"Spy/J7q\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(45);
      stdDateFormat0.instance.parseAsRFC1123("<m3@H4A(Q", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("00Y0-z00-00T00:9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00Y0-z00-00T00:9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("8`}859w\"l'~~hR3z");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"8`}859w\"l'~~hR3z\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("5-)yCR.uL9BY4x");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"5-)yCR.uL9BY4x\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2147483645, "=AqP=_5/-xe\"o?bsj");
      ...
      assertEquals("2014-03-11T16:52:44.965+k6:31", string0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  ...
  public void test71()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-145), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0._timezone = (TimeZone) simpleTimeZone0;
      MockDate mockDate0 = new MockDate();
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:21.175-0000", string0);
  }
  ...
  public void test80()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1782), (-1782), (-1782), (-1782), (-1782));
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      stdDateFormat0.instance.setTimeZone(timeZone0);
      stdDateFormat0.format((Date) mockDate0);
      ParsePosition parsePosition0 = new ParsePosition((-1782));
      assertEquals((-1782), parsePosition0.getIndex());
  }
  ...
  public void test87()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(5174);
      // Undeclared exception!
      try { 
