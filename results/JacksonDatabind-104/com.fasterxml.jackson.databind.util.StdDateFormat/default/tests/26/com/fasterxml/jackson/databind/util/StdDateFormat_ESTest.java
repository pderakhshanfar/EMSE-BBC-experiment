...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("Fri Apr 03 03:03:00 GMT 1903", date0.toString());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, ";@rh!AOZ'Ytw4HS");
      ...
      try { 
        stdDateFormat0._parseAsISO8601("\"K+A}g{YFb-ci", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"\"K+A}g{YFb-ci\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
         //
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("0_,20^X");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0_,20^X\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Locale locale0 = new Locale("N<wJ)F");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      stdDateFormat0._parseDate("{;pgN,C9", parsePosition0);
      assertEquals("java.text.ParsePosition[index=343,errorIndex=343]", parsePosition0.toString());
      assertEquals(343, parsePosition0.getErrorIndex());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer(2935);
      stdDateFormat0.instance._format(zoneInfo0, locale0, mockDate0, stringBuffer0);
      assertEquals("1903-04-03T03:03:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      stdDateFormat0.parse("1138-05-11T16:34:38.000+0000", parsePosition0);
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(16, ";@rh!AOZ'Ytw4HS");
      Locale locale0 = Locale.PRC;
  ...
  public void test17()  throws Throwable  {
      ...
      Locale locale0 = Locale.UK;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      stdDateFormat0.looksLikeISO8601("V]AvVDA+|P");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Locale locale0 = new Locale("c&zZI*d");
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(57, "h`JGx#LY*O`?u-[aaPW");
  ...
  public void test22()  throws Throwable  {
      ...
      Boolean boolean1 = Boolean.valueOf("#e=G+");
  ...
  public void test23()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("[one of: '", parsePosition0);
      assertFalse(stdDateFormat0.isLenient());
  ...
  public void test28()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(60000, 60000, 3474, 3474, 60000);
      boolean boolean0 = StdDateFormat._equals((Calendar) mockGregorianCalendar0, calendar0);
  ...
  public void test56()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      MockDate mockDate0 = new MockDate();
      StringBuffer stringBuffer0 = new StringBuffer(3474);
      FieldPosition fieldPosition0 = new FieldPosition((-264));
  ...
  public void test57()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.MAX;
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      MockDate mockDate0 = new MockDate(100, 100, 4, 527, 45, 4);
      Locale locale0 = Locale.FRANCE;
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2008-05-26T17:45:04.000+18:00", string0);
      assertFalse(stdDateFormat0.isLenient());
  }
  ...
  public void test60()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "yyyy-MM-dd'T'HH:mm:ss.SSS", 0, 0, 0, 0, 0, 0, 1000, 12, 7);
      Locale locale0 = Locale.GERMAN;
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test61()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, ";@rh!AOZ'Ytw4HS");
      Locale locale0 = Locale.forLanguageTag("<Xr;:0~;\"04+h");
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      boolean boolean1 = stdDateFormat0.isLenient();
      assertTrue(boolean1);
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(832);
      Date date0 = stdDateFormat0.parseAsRFC1123("com.fasterxml.jackson.core.io.NumberInput", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0._parseDate("0700-0j-00", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0700-0j-00\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("000-00-00T0:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"000-00-00T0:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test71()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1707), (-1707), (-1707), (-1707), (-1707), (-1707));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0045-11-15T16:04:33.000+0000", string0);
  }
  ...
  public void test73()  throws Throwable  {
      ...
      assertEquals(718, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=718,errorIndex=718]", parsePosition0.toString());
  }
  ...
  public void test74()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("00v0$0T00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00v0$0T00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test83()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("0000-00-00800:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-00800:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test88()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-235), "0000-00-00T00:00");
      Locale locale0 = new Locale("<7O?_");
