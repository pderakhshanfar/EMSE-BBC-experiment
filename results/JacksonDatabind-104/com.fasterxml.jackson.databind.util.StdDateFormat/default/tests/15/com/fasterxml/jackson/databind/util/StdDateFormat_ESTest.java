...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("IO~66}~", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"IO~66}~\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test07()  throws Throwable  {
      ...
      stdDateFormat0.parse("0345-05-23T00:00:00.000+0000", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertTrue(stdDateFormat0.isLenient());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Locale locale0 = new Locale("}1y7`RWXX4/zW5aH", "}1y7`RWXX4/zW5aH");
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-55), "rQVff-m0a&kBJ<K,+F");
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, false);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
  ...
  public void test22()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("88");
      StringBuffer stringBuffer0 = new StringBuffer();
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, (-324));
      stdDateFormat0.format(date0, stringBuffer0, fieldPosition0);
      assertEquals("1970-01-01T00:00:00.088+0000", stringBuffer0.toString());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertNotNull(date0);
      assertEquals("java.text.ParsePosition[index=2360,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Locale locale0 = new Locale("]/blFvJ7", "");
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ...
      // Undeclared exception!
      try { 
        stdDateFormat1.instance.parseObject("");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test31()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("45ME8n>*'{VlEWS{p", "com.fasterxml.jackson.core.io.NumberInput");
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0._parseDate("0000-00-0K", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-0K\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test52()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(7, (-2071), (-1041), 40, 0);
      ZoneOffset zoneOffset0 = ZoneOffset.MIN;
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(timeZone0);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1731-07-25T22:00:00.000-1800", string0);
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("7RG6,U0-wCsZh:LEHq9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"7RG6,U0-wCsZh:LEHq9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("4SjQuG9`6");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4SjQuG9`6\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1790), (-1790), (-1790), (-1790), (-1790));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0046-09-22T04:10:00.000+0000", string0);
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      ZoneOffset zoneOffset0 = ZoneOffset.ofHoursMinutes(5, 14);
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.US;
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2014-02-15T01:35:21.320+05:14", stringBuffer0.toString());
  }
