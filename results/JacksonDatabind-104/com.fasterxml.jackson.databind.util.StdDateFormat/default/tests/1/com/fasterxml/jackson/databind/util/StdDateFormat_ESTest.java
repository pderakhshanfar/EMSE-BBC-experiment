...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test14()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("5");
  ...
  public void test40()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0._parseDate("00T0-00-M0", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00T0-00-M0\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test74()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(timeZone0);
      try { 
        stdDateFormat1.parse("Cannot parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)");
        fail("Expecting exception: ParseException");
