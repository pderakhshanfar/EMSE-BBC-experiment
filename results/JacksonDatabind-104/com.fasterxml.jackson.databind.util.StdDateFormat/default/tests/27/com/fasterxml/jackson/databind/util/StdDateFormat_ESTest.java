...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test28()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      TimeZone timeZone0 = TimeZone.getTimeZone("h]Zim!jv,l~FW");
      Calendar calendar0 = stdDateFormat0._getCalendar(timeZone0);
  ...
  public void test51()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.JAPAN;
      Boolean boolean0 = new Boolean("FnVQ)U5g1[H^4");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      try { 
        stdDateFormat0.parse("FnVQ)U5g1[H^4");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"FnVQ)U5g1[H^4\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1962), 48, 48);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1125), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.PRC;
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0059-02-16T23:59:58.875-00:00", string0);
  }
  ...
  public void test72()  throws Throwable  {
      ...
      assertEquals("1970-01-01T00:00:00.008+00:00", string0);
  }
