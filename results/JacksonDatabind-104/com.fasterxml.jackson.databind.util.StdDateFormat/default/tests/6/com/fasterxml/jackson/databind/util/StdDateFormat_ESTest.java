...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("0000$g0\u0000T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000$g0\u0000T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
  ...
  public void test03()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("!:PKhlud:pCxz97");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"!:PKhlud:pCxz97\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-4521), ":Nlea-?m_<CWt\"", (-4521), 0, 10, 651, 10, (-4074), 0, (-4074), 651, (-1), 16);
  ...
  public void test08()  throws Throwable  {
      ...
      stdDateFormat0.parseAsRFC1123("q0Zt!#'g[g/v+[>", parsePosition0);
      assertEquals(1718, parsePosition0.getErrorIndex());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test15()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("E<c_>=zOsOUJB9?Bm]");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("Z^Fw'x", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("l.'03M/!>");
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        stdDateFormat0._parseDate("0000-00-00T0D:00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-00T0D:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("n_@%S", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test45()  throws Throwable  {
      Locale locale0 = Locale.forLanguageTag("+00P1W00");
      Boolean boolean0 = Boolean.FALSE;
      TimeZone timeZone0 = TimeZone.getTimeZone("+00P1W00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      // Undeclared exception!
      try { 
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-&0-00T0D:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-&0-00T0D:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("8EhI?:I0JV@wa$H8u%{");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"8EhI?:I0JV@wa$H8u%{\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1615), (-2958), (-1615), (-68), 2474);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0034-01-25T21:14:00.000+0000", string0);
      assertTrue(stdDateFormat0.isLenient());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      assertEquals("1969-12-31T23:59:59.036+00:00", stringBuffer0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate();
      StringBuffer stringBuffer0 = new StringBuffer("}zr#23qr}]D");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("}zr#23qr}]D2014-02-14T20:21:20.320-0000", stringBuffer0.toString());
  }
  ...
  public void test81()  throws Throwable  {
      ...
      stdDateFormat0.parse("0000-00-00T0D:00", parsePosition0);
      assertEquals("java.text.ParsePosition[index=362,errorIndex=-1]", parsePosition0.toString());
      assertTrue(stdDateFormat0.isLenient());
  }
