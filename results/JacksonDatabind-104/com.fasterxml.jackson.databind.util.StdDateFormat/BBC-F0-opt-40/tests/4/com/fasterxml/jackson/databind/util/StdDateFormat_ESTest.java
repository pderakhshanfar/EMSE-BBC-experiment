...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag("6YSP=SVd%_oB9Q");
  ...
  public void test08()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(200, "com.fasterxml.jackson.core.io.NumberInput");
  ...
  public void test10()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("1989-12-21T00:00:00.000+0000");
      assertTrue(boolean0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3805, "3&)</C,7K-*4d{V");
  ...
  public void test15()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-4311), "=b <");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("FL\"G0v", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test34()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0090-00-0jH0", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0090-00-0jH0\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test35()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition((-2756));
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("xU", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      TimeZone timeZone0 = TimeZone.getTimeZone("r$q=.S8ylAb12Wjn");
  ...
  public void test50()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(43);
      try { 
        stdDateFormat0.parseAsISO8601(",o~Vfw^", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \",o~Vfw^\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? true)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test52()  throws Throwable  {
      ...
      stdDateFormat0.instance.parse("69l9 4R8kO9K00", parsePosition0);
  ...
  public void test53()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(2);
      stdDateFormat0._parseDate("6YSP=SVd%_oB9Q", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate((-1789), (-1789), 22, (-1089), (-1089));
      StringBuffer stringBuffer0 = new StringBuffer(9);
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals(28, stringBuffer0.length());
      assertEquals("0040-11-05T20:51:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag("Timestamp value %s out of 64-bit value range");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate(57, 1842, 4, 17, (-1000), (-5246));
      StringBuffer stringBuffer0 = new StringBuffer(0);
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals(29, stringBuffer0.length());
      assertEquals("2110-07-03T22:52:34.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-?0@00T0(:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-?0@00T0(:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test75()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      ParsePosition parsePosition0 = new ParsePosition(2);
      stdDateFormat1.parseAsRFC1123("NqA][ PIw&e*GKEi", parsePosition0);
  ...
  public void test81()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "Dyhuu");
      Locale locale0 = Locale.ROOT;
      Boolean boolean0 = Boolean.valueOf("Dyhuu");
  ...
  public void test85()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0000-00-00T0z:00");
        fail("Expecting exception: ParseException");
