...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Locale locale0 = new Locale("NkK!Q");
      ParsePosition parsePosition0 = new ParsePosition((-1765));
      Boolean boolean0 = Boolean.valueOf("\u0001bsr=5pie\"J\"!*E&A");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      try { 
        stdDateFormat0._parseAsISO8601("r9 s+KiNfeYb", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"r9 s+KiNfeYb\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
  ...
  public void test04()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("Quw|0*\u0000", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("@^+C7Dgs;|80]H\"l9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"@^+C7Dgs;|80]H\"l9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1973), 21, (-1554));
      ...
      assertEquals("0077-06-29T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("YklMAVLO.}R0/", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "PL/-e#0I");
  ...
  public void test18()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(506, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test21()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag(".,F?YV50");
      Boolean boolean0 = Boolean.valueOf("'P;~-S]i<pkNy");
  ...
  public void test25()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = Locale.forLanguageTag(".,F?YV50");
      Boolean boolean0 = Boolean.valueOf("'P;o~-S]i<pkNy");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
  ...
  public void test29()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2224, "Q>5@ZK:yvj=m");
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("KI3XpT*3p.|", parsePosition0);
  ...
  public void test42()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("'P;o~-S]i<pkNy");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      StringBuffer stringBuffer0 = new StringBuffer("'P;o~-S]i<pkNy");
      FieldPosition fieldPosition0 = new FieldPosition(1332);
      // Undeclared exception!
      try { 
  ...
  public void test43()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("1969-12-31T23:59:58.493+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"1969-12-31T23:59:58.493+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test53()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      try { 
        stdDateFormat0.parse(".,F?YV50");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \".,F?YV50\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("0000-F&-00T00:0i", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("8/92$yE0L}X>");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"8/92$yE0L}X>\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("2K?PNPEoB$j8");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"2K?PNPEoB$j8\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1973), 10, (-1554));
  ...
  public void test63()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = Locale.forLanguageTag(".,F?YV50");
      Boolean boolean0 = new Boolean("OtW3fy{=n~");
  ...
  public void test65()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, (-265));
  ...
  public void test68()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1973), 21, (-1554));
      StringBuffer stringBuffer0 = new StringBuffer();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1554), "+fXe0~v^m");
      ...
      assertEquals("0077-06-28T23:59:58.446-00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test69()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(13, "PL/-e#0I");
      Locale locale0 = Locale.UK;
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      StringBuffer stringBuffer0 = new StringBuffer();
      ...
      MockDate mockDate0 = new MockDate((-265), (-265), 12, (-492), (-2339));
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("1612-11-19T21:01:00.013+0000", stringBuffer0.toString());
  }
  ...
  public void test79()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("pmd");
  ...
  public void test80()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(56, "0000-00-00");
      stdDateFormat0.setTimeZone(simpleTimeZone0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test86()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-4940), "#9");
      Boolean boolean0 = Boolean.FALSE;
