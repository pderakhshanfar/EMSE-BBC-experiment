...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("dQY^\"Vu", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"dQY^\"Vu\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test02()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=1496,errorIndex=1496]", parsePosition0.toString());
      assertEquals(1496, parsePosition0.getErrorIndex());
  }
  ...
  public void test04()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("[Es  r6+!~9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"[Es  r6+!~9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(1007, 22, 22, 90, (-1136), (-1136));
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("2908-11-24T22:45:04.000+0000", stringBuffer0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1901, "0000-00-00T00:00");
  ...
  public void test15()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("].5[NKf.2&zq]&");
      Locale locale0 = Locale.PRC;
  ...
  public void test16()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, 59);
  ...
  public void test25()  throws Throwable  {
      Locale locale0 = Locale.forLanguageTag("\"\"LzO");
      Boolean boolean0 = new Boolean("\"\"LzO");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123("Cannot parse date \"%s\", problem: %s", parsePosition0);
  ...
  public void test38()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.instance._parseDate("0069-06-27T07:29:58.167-0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"0069-06-27T07:29:58.167-0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test41()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-729), "", 0, 0, 0, 0, 0, 0, 0, 48);
      Locale locale0 = Locale.ITALIAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
  ...
  public void test46()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, 0, 331);
      stdDateFormat0.format((Date) mockDate0);
      ZoneOffset zoneOffset0 = ZoneOffset.ofHours(0);
      TimeZone.getTimeZone((ZoneId) zoneOffset0);
      DateFormat.getTimeInstance(0);
      stdDateFormat0.looksLikeISO8601("b=8gAG867!-");
      stdDateFormat0.isLenient();
      boolean boolean0 = true;
      ParsePosition parsePosition0 = new ParsePosition(0);
      parsePosition0.setIndex((-1567));
      try { 
        stdDateFormat0.parseAsISO8601("b=8gAG867!-", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"b=8gAG867!-\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat2.parse("", parsePosition1);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test50()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(1018);
      stdDateFormat0.parseObject("\u0005eBDTU,sML6", parsePosition0);
      assertEquals("java.text.ParsePosition[index=1018,errorIndex=1018]", parsePosition0.toString());
      assertFalse(stdDateFormat0.isLenient());
  }
  ...
  public void test51()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(0);
      ParsePosition parsePosition1 = new ParsePosition((-188));
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("1eoZ-'qk", parsePosition1);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test58()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("HL^,%#");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:21.185-00:00", string0);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      Boolean boolean0 = new Boolean("YlA");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar();
      Date date0 = mockGregorianCalendar0.getGregorianChange();
      String string0 = stdDateFormat0.format(date0);
      assertFalse(stdDateFormat0.isLenient());
      assertEquals("1582-10-15T00:00:00.307+0000", string0);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate((-1833), 90, (-1833), 102, 90);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertTrue(stdDateFormat0.isLenient());
      assertEquals("0069-06-27T07:29:58.167-0000", string0);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, 0, 331);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1900-11-27T00:00:00.000+0000", string0);
      ...
      ParsePosition parsePosition1 = new ParsePosition(483);
      stdDateFormat0.parse("1900-11-27T00:00:00.000+0000", parsePosition1);
      assertEquals("java.text.ParsePosition[index=483,errorIndex=-1]", parsePosition1.toString());
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-V0-00T0g0:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-V0-00T0g0:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("7<w9 ^zG%w_0=*");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"7<w9 ^zG%w_0=*\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0.parse("0800-70-00");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(0, 43, 43, 45, 45);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1903-09-13T21:45:00.000+00:00", string0);
  }
  ...
  public void test73()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      TimeZone timeZone0 = TimeZone.getTimeZone("dB");
  ...
  public void test76()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.setLenient(false);
      MockDate mockDate0 = new MockDate((-2575), (-2575), 45, 45, 5818, (-465));
      stdDateFormat0.instance.format((Date) mockDate0);
      ParsePosition parsePosition0 = new ParsePosition(1018);
      parsePosition0.setIndex(1018);
      TimeZone timeZone0 = TimeZone.getTimeZone("].5[NKf.2&zq]&");
  ...
  public void test83()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.parse("8000-30-00");
      assertTrue(stdDateFormat0.isLenient());
  }

  @Test(timeout = 4000)
  public void test84()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4, "[one of: '", 4, 4, 4, 57, 4, 20, (-1), 3, 3);
      Locale locale0 = Locale.US;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
