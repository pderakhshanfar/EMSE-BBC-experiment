...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(2800);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
      try { 
        stdDateFormat0._parseAsISO8601("Il}8, u~", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"Il}8, u~\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test05()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(4834);
      stdDateFormat0._parseDate("w", parsePosition0);
      assertEquals("java.text.ParsePosition[index=4834,errorIndex=4834]", parsePosition0.toString());
  ...
  public void test06()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("XDtU7g9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"XDtU7g9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      ...
      stdDateFormat0.parse("1969-12-31T23:59:56.702+0000", parsePosition0);
  ...
  public void test09()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("(W\"U>H# K)=XU~OSx");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
  ...
  public void test15()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("0069-05-04T00:00:00.000+0000");
      assertTrue(boolean0);
  }
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1), "ka.=?CnBoC@v");
      Locale locale0 = Locale.UK;
      Boolean boolean0 = new Boolean("ka.=?CnBoC@v");
  ...
  public void test19()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.JAPAN;
      Boolean boolean0 = Boolean.valueOf("$9[-F");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
  ...
  public void test28()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2369, "Value \"");
  ...
  public void test39()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, (-3581));
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("!O)", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test53()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00-0X", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-0X\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "i${R-@Y7$I");
      Locale locale0 = Locale.UK;
      Boolean boolean0 = new Boolean("yyyy-MM-dd'T'HH:mm:ss.SSS");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, false);
      ParsePosition parsePosition0 = new ParsePosition(5475);
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("2sh3 uE^W3I\f_-");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"2sh3 uE^W3I\f_-\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("4;nVJ0Rsi:=!-");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"4;nVJ0Rsi:=!-\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test65()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1673), (-1673), (-1673));
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2369, "Value \"");
      Locale locale0 = Locale.ENGLISH;
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0082-12-31T00:00:02.369+00:00", string0);
  }
  ...
  public void test66()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-1968), 4, 4);
      ...
      stdDateFormat2.looksLikeISO8601("[one of: 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', 'EEE, dd MMM yyyy HH:mm:ss zzz' (strict)]");
      stdDateFormat3.withColonInTimeZone(true);
      stdDateFormat1.withTimeZone(timeZone0);
      Locale locale1 = Locale.US;
      // Undeclared exception!
      try { 
        DateFormat.getDateInstance(17, locale1);
  ...
  public void test79()  throws Throwable  {
      ...
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=i${R-@Y7$I,offset=0,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0], locale: en_GB, lenient: false)", string0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
