...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("}Y2'wnM}", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"}Y2'wnM}\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("9}>GI#}");
        fail("Expecting exception: ParseException");
  ...
  public void test06()  throws Throwable  {
      ...
      stdDateFormat0.parseObject("y", parsePosition0);
  ...
  public void test07()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("9", (ParsePosition) null);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test08()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("/m+B.x&P&Z$W4{&%^v");
  ...
  public void test12()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1570, "9no<FbLf!zOcA:;");
      Boolean boolean0 = Boolean.valueOf("9no<FbLf!zOcA:;");
  ...
  public void test15()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0.parse("A)zfrG&m i+b@_R9FC", parsePosition0);
  ...
  public void test17()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("3685-01-31T00:00:00.000+0000");
      assertTrue(boolean0);
  }
  ...
  public void test20()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1642), "0000-00-00");
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "", 3, 3, 3, 43, 3, 3, 1, 1, 1, 1, 43);
  ...
  public void test24()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-3720), (-3720), (-1), (-3720), (-3720), 19);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, 584);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2132-07-25T10:00:19.000+0000", stringBuffer0.toString());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      boolean boolean0 = StdDateFormat._equals(object0, (Object) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123("G EDuX@b3M~x", parsePosition0);
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"UTC\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: null, lenient: null)", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ParseException");
         ...
         //
         // Cannot parse date \"dddd[-]dd[-]dd[T]dd[:]dd(?:[:]dd)?(.d+)?(Z|[+-]dd(?:[:]?dd)?)?\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test46()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0._parseDate("0g00-00-00T0:00", (ParsePosition) null);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0g00-00-00T0:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"UTC\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: zh_CN, lenient: false)", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test55()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2022), "Timestamp value %s out of 64-bit value range");
  ...
  public void test61()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("T32m8vY>~8. e*(");
      Locale locale0 = Locale.ITALY;
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      try { 
  ...
  public void test62()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("0000-70-00");
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-p00.0$0T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-p00.0$0T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("20[6&{S:3]|");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"20[6&{S:3]|\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test65()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      boolean boolean1 = stdDateFormat0.looksLikeISO8601("6[xGj7/4WMB");
      assertFalse(boolean1);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertFalse(stdDateFormat0.isLenient());
  }
  ...
  public void test70()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1757), (-1757), (-1000));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0008-11-04T00:00:00.000+0000", string0);
      assertTrue(stdDateFormat0.isLenient());
  }
  ...
  public void test71()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(813, 130, 51, 130, (-149), 28);
      stdDateFormat1._format(timeZone0, (Locale) null, mockDate0, stringBuffer0);
      assertEquals("2723-12-26T07:31:28.000+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test72()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4474, "%|Ajgy@^Hxa^A");
      Locale locale0 = new Locale("%|Ajgy@^Hxa^A", "0000-00-00", "DateFormat %s: (timezone: %s, locale: %s, lenient: %s)");
      MockDate mockDate0 = new MockDate(84, 4474, (-1358), 1128, 3, 1128);
      StringBuffer stringBuffer0 = new StringBuffer();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      stdDateFormat1._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("2353-03-30T00:21:52.474+00:00", stringBuffer0.toString());
  }
  ...
  public void test73()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(45, (-17), (-745), 45, (-745));
      Date date0 = mockGregorianCalendar0.getGregorianChange();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1513), "V8Vz*T=:=C*xABA]@.9");
      Locale locale0 = Locale.FRENCH;
      stdDateFormat0._format(simpleTimeZone0, locale0, date0, stringBuffer0);
      //  // Unstable assertion: assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1582-10-04T23:59:58.487-0000", stringBuffer0.toString());
  ...
  public void test74()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(")]");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      FieldPosition fieldPosition0 = new FieldPosition((-2158));
      // Undeclared exception!
      try { 
  ...
  public void test78()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        DateFormat.getDateTimeInstance(2458, (-2341));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -2341
         //
  ...
  public void test79()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("eC$r!{g=+w!H");
      Locale locale0 = new Locale("eC$r!{g=+w!H", "9", "R-z{<QlLW+8g&qDE1d");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test90()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "Vp6*?t?::*|QoFw");
  ...
  public void test92()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parse("8800-00-00");
  }
  ...
  public void test93()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("1970-01-01T00:00:00.000+0000");
        fail("Expecting exception: ParseException");
