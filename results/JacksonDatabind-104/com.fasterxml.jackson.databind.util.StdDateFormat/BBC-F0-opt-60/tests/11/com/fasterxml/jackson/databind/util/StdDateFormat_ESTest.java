...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(5, "", 10, 10, 0, 5, 12, 0, 0, 10);
      Locale locale0 = Locale.GERMAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(10);
      try { 
        stdDateFormat0._parseAsISO8601("Jr", parsePosition0);
  ...
  public void test06()  throws Throwable  {
      ...
      stdDateFormat0.looksLikeISO8601("3F5,X^ra%|Q6*");
  ...
  public void test09()  throws Throwable  {
      ...
      stdDateFormat0.parse("0000-00-00T00:S00", parsePosition0);
      assertTrue(stdDateFormat0.isLenient());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("X5%3PAFq-{i:@");
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(90, ";I-5(NQr9q@Qwikh/{");
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      Boolean boolean0 = new Boolean("`go^X^YCCkgL?>");
  ...
  public void test15()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("|.o &7C", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test20()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2324), "0000-00-00T00:00");
      Locale locale0 = Locale.TAIWAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1, "&BDqy.%X");
      Locale locale0 = Locale.forLanguageTag("&BDqy.%X");
  ...
  public void test23()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(5, "", 5, 5, 4, 4, 4, 5, 6, 1175);
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
  ...
  public void test27()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=java.util.SimpleTimeZone[id=;I-5(NQr9q@Qwikh/{,offset=90,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=?,MONTH=?,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=?,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=?,HOUR=?,HOUR_OF_DAY=?,MINUTE=?,SECOND=?,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
  ...
  public void test34()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(6);
      try { 
        stdDateFormat0.parseAsISO8601("Y$D j-m", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"Y$D j-m\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test39()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("7cW");
      Locale locale0 = Locale.FRANCE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parse("!'tMFJ#PuN#J[EG{", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "cq|RPyg#$jc");
  ...
  public void test45()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00-00T00:S00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-00T00:S00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test48()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "Cannot parse date \"%s\", problem: %s", 40, 0, 0, 449, 449, 0, 449, 48, 48);
      ParsePosition parsePosition0 = new ParsePosition(449);
      Boolean boolean0 = Boolean.valueOf("\"BPx`Ny~");
  ...
  public void test53()  throws Throwable  {
      Locale locale0 = Locale.JAPAN;
      Boolean boolean0 = new Boolean("H='d1~awKsE[");
  ...
  public void test55()  throws Throwable  {
      ...
      Boolean boolean1 = new Boolean("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: en_US, lenient: null)");
  ...
  public void test58()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("0-/b", parsePosition0);
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("0g00-B0|-00T00:S00");
      assertFalse(boolean0);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Locale locale0 = Locale.TAIWAN;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-2324));
      // Undeclared exception!
      try { 
  ...
  public void test63()  throws Throwable  {
      ...
      StringWriter stringWriter1 = new StringWriter(3146);
      stringWriter0.getBuffer();
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, 3146);
  ...
  public void test64()  throws Throwable  {
      ...
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      MockDate mockDate0 = new MockDate((-1708), (-1708), 17);
      String string0 = stdDateFormat0.instance.format((Date) mockDate0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("0049-09-17T00:00:00.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(20, 20, 4, (-222), 57);
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      Locale locale0 = Locale.FRENCH;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1002), "E5X0dk");
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("1921-08-25T18:56:58.998-0000", stringBuffer0.toString());
      assertEquals("1921-08-25T18:56:58.998-0000", stringWriter0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      assertEquals("1970-01-01T18:00:00.000+18:00", stringBuffer0.toString());
      assertEquals("1970-01-01T18:00:00.000+18:00", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test67()  throws Throwable  {
      Boolean boolean0 = new Boolean("cq|RPyg#$jc");
      ...
      assertEquals("cq|RPyg#$jc2014-02-14T20:21:21.320+0000", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      try { 
        stdDateFormat0.parse("=T``k{DP`V");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"=T``k{DP`V\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test70()  throws Throwable  {
      ...
      stdDateFormat1.equals(stdDateFormat0);
      MockDate mockDate0 = new MockDate(84, 84, 17);
  ...
  public void test72()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "Cannot parse date \"%s\", problem: %s", 40, 0, 0, 449, 449, 0, 449, 48, 48);
      Locale locale0 = new Locale("Cannot parse date \"%s\", problem: %s", "Cannot parse date \"%s\", problem: %s");
      ...
      ParsePosition parsePosition0 = new ParsePosition(449);
      Boolean boolean0 = Boolean.valueOf("\"BPx`Ny~");
      StdDateFormat stdDateFormat3 = new StdDateFormat(simpleTimeZone0, (Locale) null, boolean0, false);
  ...
  public void test75()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(34, 34, 34, 2313, 34);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1937-03-10T09:34:00.000+00:00", string0);
  }
  ...
  public void test84()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(100, "%g@p");
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      Boolean boolean0 = Boolean.FALSE;
  ...
  public void test89()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(6);
      stdDateFormat0.parse("0?qnV-!1MEgS=@", parsePosition0);
      assertEquals(6, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=6,errorIndex=6]", parsePosition0.toString());
  }
