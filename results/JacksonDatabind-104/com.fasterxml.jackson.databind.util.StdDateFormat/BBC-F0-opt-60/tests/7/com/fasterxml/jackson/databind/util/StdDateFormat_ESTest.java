...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseAsISO8601("0009-00-00", (ParsePosition) null);
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test03()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(45, "&`M/+bQF N }?%)A{8");
      Locale locale0 = new Locale("EUH@|!0LqtW", "&`M/+bQF N }?%)A{8", "@w&b5^_E0&]");
      ParsePosition parsePosition0 = new ParsePosition(4);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, (Boolean) null);
      try { 
        stdDateFormat0._parseAsISO8601("@w&b5^_E0&]", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"@w&b5^_E0&]\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
  ...
  public void test04()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(923, "CaXC=1tc19>y\"}`[");
      Locale locale0 = new Locale("@w&b5^_E0&]", "rlXf$YgO=OTN", "Zxg");
      Boolean boolean0 = Boolean.valueOf("3REy8Figj");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(923);
      stdDateFormat0.parseObject("]", parsePosition0);
      assertEquals(923, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=923,errorIndex=923]", parsePosition0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(6065);
      stdDateFormat0.parseAsRFC1123("", parsePosition0);
      assertEquals("java.text.ParsePosition[index=6065,errorIndex=6065]", parsePosition0.toString());
  ...
  public void test10()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4198, "0000-00-00T00:00");
  ...
  public void test13()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "lQv8}W{!?ZnL6", 0, 0, 2, 0, 0, 2, 0, 60000, 57, 2495, 57);
  ...
  public void test15()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1000), (-1000), (-1000), (-1000), (-1000), (-1000));
      StringBuffer stringBuffer0 = new StringBuffer();
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0813-10-23T15:03:20.000+0000", stringBuffer0.toString());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("iG47vdu{%d,+*x*", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-75), "W_wn?$po9");
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("15.9(CH", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test38()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4198, "ol<*RjuTP%q", 0, 0, 4198, 2984, 2407, 2984, 0, 4198, (-428), (-428), 2561);
      Locale locale0 = Locale.CANADA;
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("ol<*RjuTP%q", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("15.9(CH", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"15.9(CH\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test42()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.CANADA;
      Boolean boolean0 = new Boolean("bvj");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test44()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(81, 81, 3109, 81, 81, 43);
      StringBuffer stringBuffer0 = new StringBuffer();
      // Undeclared exception!
      try { 
  ...
  public void test52()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        stdDateFormat0.parseAsISO8601("W_wn?$po9", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"W_wn?$po9\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=1853,errorIndex=1853]", parsePosition0.toString());
      assertEquals(1853, parsePosition0.getErrorIndex());
  }
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0.parseObject("9<C)TtiD9vb:RC}dS", parsePosition0);
  ...
  public void test61()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate(93, 32, 111, 257, 32, 32);
      StringBuffer stringBuffer0 = new StringBuffer();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      stdDateFormat1._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals(29, stringBuffer0.length());
      assertEquals("1995-12-30T17:32:32.000+00:00", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1004), "&Lju");
      MockDate mockDate0 = new MockDate(3298, 32, 901, 32, 2176, 2176);
      StringBuffer stringBuffer0 = new StringBuffer();
      Locale locale0 = Locale.KOREAN;
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("5203-02-20T20:52:14.996-0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1771), (-2164), (-1));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0053-08-30T00:00:00.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(406, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.TAIWAN;
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate(406, 0, 0, (-221), 0, 0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2305-12-21T19:00:00.406+00:00", string0);
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-~0-0000:ly00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-~0-0000:ly00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test77()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getDefault();
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      TimeZone timeZone1 = TimeZone.getTimeZone("_ux! 9f3@7");
  ...
  public void test82()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("0000-03-00");
  ...
  public void test88()  throws Throwable  {
      ...
      stdDateFormat0.parse("0053-08-30T00:00:00.000+0000", parsePosition0);
  ...
  public void test89()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2989), "");
