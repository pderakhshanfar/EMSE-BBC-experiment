...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("ZxuVXOBsJ\"x9", parsePosition0);
  ...
  public void test07()  throws Throwable  {
      ...
      stdDateFormat0.parse("1866-02-27T12:55:54.000+0000", parsePosition0);
  ...
  public void test26()  throws Throwable  {
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(35, 35, 58);
  ...
  public void test41()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, 699);
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        stdDateFormat0._parseDate("1866-02-27T12:55:54.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"1866-02-27T12:55:54.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test45()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("1866-02-27T12:55:54.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
  ...
  public void test56()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(699);
      stdDateFormat0.parse("Zhjxs", parsePosition0);
      assertEquals(699, parsePosition0.getErrorIndex());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test59()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        stdDateFormat0.parseAsISO8601("Rv", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"Rv\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("54H~amnX||?w*");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"54H~amnX||?w*\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test66()  throws Throwable  {
      ...
      assertEquals("0098-10-20T00:00:00.000+0000", string0);
  }
  ...
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(16, 0, 3657, 16, 107, 26);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1926-01-04T17:47:26.000+00:00", string0);
  ...
  public void test68()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2083), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      String string0 = stdDateFormat1.format(date0);
      assertEquals("1582-10-04T23:59:57.917-0000", string0);
  }

  @Test(timeout = 4000)
  public void test69()  throws Throwable  {
      MockDate mockDate0 = new MockDate();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3669, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.ENGLISH;
      Boolean boolean0 = Boolean.valueOf("E:QS3`mC?L\"~v{t");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:24.989+00:00", string0);
  }
  ...
  public void test74()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat((TimeZone) null, locale0, boolean0);
      MockDate mockDate0 = new MockDate((-585), (-581), 3082);
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1275-01-07T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test75()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("0000-00-OH\u0000:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-OH\u0000:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test82()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(49);
      assertEquals(49, parsePosition0.getIndex());
  }
  ...
  public void test90()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3957), "");
