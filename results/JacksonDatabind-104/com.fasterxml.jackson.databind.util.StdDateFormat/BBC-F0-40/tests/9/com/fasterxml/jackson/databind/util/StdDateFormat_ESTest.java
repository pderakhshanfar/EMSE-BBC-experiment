...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0000-78-00");
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("o\u0000n&#*", parsePosition0);
  ...
  public void test28()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("pyth~^", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"pyth~^\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("tsIdn.wv4i[BVx", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test39()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-225), "{D+do#1\"SK/H+");
      // Undeclared exception!
      try { 
  ...
  public void test46()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.forLanguageTag("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: en_US, lenient: null)");
  ...
  public void test53()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = new Locale("", "P&lv7(2lqaXoii sCyT", "P&lv7(2lqaXoii sCyT");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.instance.withTimeZone(timeZone0);
      // Undeclared exception!
      try { 
        stdDateFormat1._parseDate("com.fasterxml.jackson.databind.util.StdDateFormat", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("00w0-x00-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00w0-x00-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("9w-0(-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9w-0(-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test65()  throws Throwable  {
      ...
      Locale locale0 = Locale.PRC;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      MockDate mockDate0 = new MockDate((-2183), 4095, 4, 3, 19, 43);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0058-04-04T03:19:43.000+0000", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2, "[i]{x\"Z7#S y`4Km");
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(14, 2, 3, 14, 3, (-2314));
      Date date0 = mockGregorianCalendar0.getGregorianChange();
      stdDateFormat1._format(simpleTimeZone0, (Locale) null, date0, stringBuffer0);
      assertEquals(29, stringBuffer0.length());
      assertEquals("1582-10-15T00:00:00.002+00:00", stringWriter0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      ...
      Locale locale0 = Locale.PRC;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      MockDate mockDate0 = new MockDate(43, 4095, 33, 3, 19, 43);
      ...
      assertEquals("2284-05-03T03:19:43.019+0000", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StringWriter stringWriter0 = new StringWriter();
      MockDate mockDate0 = new MockDate((-2183), 3, (-2183), (-4122), 4, (-1189));
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2183), "com.fasterxml.jackson.core.io.NumberInput");
      Locale locale0 = Locale.KOREA;
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("0291-10-19T05:44:08.817-0000", stringBuffer0.toString());
      assertEquals("0291-10-19T05:44:08.817-0000", stringWriter0.toString());
  }
  ...
  public void test71()  throws Throwable  {
      ...
      assertEquals("1946-09-13T19:43:43.000+0000", stringBuffer0.toString());
  }
  ...
  public void test79()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "0000-0000T00:00");
  ...
  public void test84()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(1255);
      stdDateFormat0.parse("939E;QJP_QJz->N", parsePosition0);
      assertEquals("java.text.ParsePosition[index=1255,errorIndex=1255]", parsePosition0.toString());
      assertEquals(1255, parsePosition0.getErrorIndex());
  }
  ...
  public void test92()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(18);
      Date date0 = stdDateFormat0._parseDate("36", parsePosition0);
      assertNotNull(date0);
