...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.instance._parseAsISO8601("0000-40-00", parsePosition0);
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test03()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("d`'+T2m");
      Locale locale0 = Locale.PRC;
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(9);
      try { 
        stdDateFormat0._parseAsISO8601("d`'+T2m", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"d`'+T2m\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=177,errorIndex=177]", parsePosition0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(9);
      Date date0 = stdDateFormat0.instance.parseAsRFC1123("xqBLgc',;MRk#f$F` w", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test12()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("1970-01-01T00:00:03.075+0000");
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3059, "r%?Y];7gOE[>XjLI\f");
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2163), "0000-00-00");
  ...
  public void test15()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("Sr`Mw&D'`", "S='n_/Tfv/Pz");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
  ...
  public void test16()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("OC[TPsAVI&G9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("Heure de Greenwich", parsePosition0);
  ...
  public void test27()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-4104));
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("H$2)t\bBM!d`6rX", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("=XTWT9hv8@", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(683, "\" can not be represented as BigDecimal");
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      ...
      stdDateFormat0.parse("byZ&IHb", parsePosition0);
      assertEquals("java.text.ParsePosition[index=3046,errorIndex=3046]", parsePosition0.toString());
      assertEquals(3046, parsePosition0.getErrorIndex());
  }
  ...
  public void test49()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat1._parseDate("*we<9?x", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test52()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0006-z-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0006-z-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test53()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("56wN;GVwlCY");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"56wN;GVwlCY\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-2102), 1741, 16, (-18), 48);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0058-02-15T06:48:00.000+0000", string0);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-979), "lMrA");
      Locale locale0 = Locale.UK;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1969-12-31T23:59:58.803-00:00", string0);
  }
  ...
  public void test62()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1969-12-31T23:59:58.803-0000", string0);
  }

  @Test(timeout = 4000)
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-18), (-18), 45, 45, (-18));
      ...
      assertEquals("1880-08-16T04:42:00.000+0800", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.instance.parseObject("F7");
        fail("Expecting exception: ParseException");
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000*00|0/0Ty00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000*00|0/0Ty00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test87()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-1));
      Object object0 = stdDateFormat0.parseObject("0030-00-00", parsePosition0);
