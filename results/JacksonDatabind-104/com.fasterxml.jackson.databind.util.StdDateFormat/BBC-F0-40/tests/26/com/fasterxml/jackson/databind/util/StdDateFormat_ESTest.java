...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdDateFormat1._parseAsISO8601("vu$M`<{s)]pli", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"vu$M`<{s)]pli\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-633), 48, (-2370), 48, 48);
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stdDateFormat0._format(timeZone0, (Locale) null, mockDate0, stringBuffer0);
      assertEquals("1264-07-07T00:48:00.000+0000", stringBuffer0.toString());
      assertEquals("1264-07-07T00:48:00.000+0000", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      stdDateFormat0.parse("1915-11-12T02:09:15.000+00:00", parsePosition0);
      assertTrue(stdDateFormat0.isLenient());
  ...
  public void test08()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(75, "0000-00-00");
      Locale locale0 = new Locale("(spO_Hydd,5nt6", "2.2250738585072012e-308");
  ...
  public void test12()  throws Throwable  {
      ...
      assertEquals(1216, parsePosition0.getErrorIndex());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test14()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(1474);
  ...
  public void test20()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2, "yyyy-MM-dd'T'HH:mm:ss.SSSZ", 2, 0, 0, 0, 2, 0, 0, 0);
  ...
  public void test21()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StringBuffer stringBuffer0 = new StringBuffer(1692);
  ...
  public void test22()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("~>k?Xx^lr_GL_0Gb;J");
  ...
  public void test27()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("yG+w2;");
      Boolean boolean0 = Boolean.valueOf(false);
  ...
  public void test28()  throws Throwable  {
      Locale locale0 = new Locale("^hX$r(", "^hX$r(", "^hX$r(");
  ...
  public void test31()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "Qt3Z]", 0, 0, 0, 1, 0, 0, 1, 1, 1);
      Locale locale0 = Locale.JAPANESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-8));
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("Qt3Z]", parsePosition0);
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("+00:00", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition((-3072));
      // Undeclared exception!
      try { 
  ...
  public void test43()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(520, (-1), 520);
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("P;[&H+8x1zm", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test47()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-3895));
      // Undeclared exception!
      try { 
  ...
  public void test54()  throws Throwable  {
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(45, 43, 43);
  ...
  public void test55()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("8j UM");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"8j UM\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat1.parse("@<3B0vn:LGo6GwL", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test59()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("1lCr~&J6}t,hhMiL", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1790), (-1790), 888, 89, (-446), 116);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0038-04-10T09:35:56.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(15, 13, 10, (-2158), 9, 15);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1915-11-12T02:09:15.000+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test65()  throws Throwable  {
      MockDate mockDate0 = new MockDate(1692, 1756, 857, 1756, 404, 1756);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(404, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertTrue(stdDateFormat1.isLenient());
      assertEquals("3740-11-15T11:13:16.404+00:00", string0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }

  @Test(timeout = 4000)
  public void test66()  throws Throwable  {
      MockDate mockDate0 = new MockDate(926, (-769), 926, (-769), 404, 43);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1961), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = StdDateFormat.DEFAULT_LOCALE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2764-05-12T05:44:41.039-0000", string0);
  }

  @Test(timeout = 4000)
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.parse("69");
  ...
  public void test68()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-g20000");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-g20000\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test69()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("6d.8\"1*");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"6d.8\"1*\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test70()  throws Throwable  {
      ...
      try { 
       ...
       // Unstable assertion
         ...
         //
         // Cannot parse date \"2014-02-14T20:21:21.320+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test74()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "UTC", 0, 0, 0, 23, 23, 0, 23, 23, 57);
  ...
  public void test77()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-344), "");
  ...
  public void test86()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=UTC,offset=0,dstSavings=57,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=23,startTimeMode=0,endMode=0,endMonth=23,endDay=0,endDayOfWeek=23,endTime=23,endTimeMode=0], locale: zh_TW, lenient: false)", string0);
  }

  @Test(timeout = 4000)
  public void test87()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      Date date0 = stdDateFormat0.instance.parse("0000-00-03");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test89()  throws Throwable  {
      ...
      assertEquals(2330, parsePosition0.getErrorIndex());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
