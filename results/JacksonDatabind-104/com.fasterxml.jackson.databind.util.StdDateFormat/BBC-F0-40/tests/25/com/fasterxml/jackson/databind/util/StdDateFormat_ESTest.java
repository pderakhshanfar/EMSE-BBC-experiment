...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1, "K$va@:[/5~/,47>=L");
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseObject("99w7&518-S;[Ol#", (ParsePosition) null);
  ...
  public void test05()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse(":.)ZzvY/(2h<.DdP9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \":.)ZzvY/(2h<.DdP9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals("java.text.ParsePosition[index=211,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Locale locale0 = new Locale("W]E+5^:ZkMMe<H%dce&", "?*r=", "K/8Rm");
  ...
  public void test10()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2481), "dddd[-]dd[-]dd[T]dd[:]dd(?:[:]dd)?(.d+)?(Z|[+-]dd(?:[:]?dd)?)?");
  ...
  public void test13()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: it_IT, lenient: true)", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test18()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "yyyy-MM-dd'T'HH:mm:ss.SSSZ", 0, 0, (-1230), 0, 9, 0, 9, 11);
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(28, " :#gg<WE-");
      ...
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertEquals("java.util.SimpleTimeZone[id= :#gg<WE-,offset=28,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", timeZone0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("I&YUdeq9c2Pm");
      Locale locale0 = Locale.JAPANESE;
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test25()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(">IB>");
  ...
  public void test28()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null], locale: it_IT, lenient: true)", (String) null);
      assertFalse(boolean0);
  }
  ...
  public void test30()  throws Throwable  {
      Locale locale0 = new Locale("02L.8$@Uq/k89+iK)7n", "", "02L.8$@Uq/k89+iK)7n");
      Boolean boolean0 = new Boolean(")XFF=aqa_Ta!*4x+");
  ...
  public void test33()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.forLanguageTag("MwT~]gG*8,Wxp");
      Boolean boolean0 = new Boolean("MwT~]gG*8,Wxp");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test35()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(557, "c_]Wr[$wS9+oQ1");
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("W]E+5^:ZkMMe<H%dce&", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test38()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("%])wQYuG ,8F:z");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, 3600);
      // Undeclared exception!
      try { 
  ...
  public void test46()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition(3883);
      // Undeclared exception!
      try { 
  ...
  public void test47()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, ";W%Xl-v<]O::5~h$t");
  ...
  public void test52()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      Boolean boolean1 = new Boolean("Cannot parse date \"%s\": not compatible with any of standard forms (%s)");
  ...
  public void test55()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition((-1869));
      try { 
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000--00T0:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000--00T0:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("7e%nQNr5{R/c_ow!P", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1860), (-1183), (-1860));
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0065-04-27T00:00:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate((-1074), (-2043), 24);
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition(3600);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0655-10-24T00:00:00.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StringBuffer stringBuffer0 = new StringBuffer();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-481), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.CANADA;
      ...
      assertEquals("1969-12-31T23:59:58.823-00:00", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      assertEquals("1969-12-31T23:59:58.823-0000", stringBuffer0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("I&YUdeq9c2Pm");
      Locale locale0 = Locale.FRENCH;
      Boolean boolean0 = Boolean.valueOf("?AXp#{1p3a3-[%n%-");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      stdDateFormat0.setLenient(false);
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
      assertFalse(stdDateFormat0.isLenient());
  ...
  public void test78()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone((TimeZone) null);
      try { 
        stdDateFormat1.parse("q.}6#x\"2ggO2");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"q.}6#x\"2ggO2\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
