...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("OjpU?r>L7,I0_", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"OjpU?r>L7,I0_\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
  ...
  public void test03()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0000\"-00-00eT00:00");
        fail("Expecting exception: ParseException");
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("1w(]kS:");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"1w(]kS:\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("'[rhKWl#CE>9");
        fail("Expecting exception: ParseException");
  ...
  public void test10()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = new Locale("p<.R2.");
      Boolean boolean0 = Boolean.valueOf("p<.R2.");
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2410), "0000-00-00");
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4, "!F<)sde.gUd", 4, 4, 4, 4, 4, 4, 4, 4);
  ...
  public void test21()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(2147483645);
  ...
  public void test23()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("=LEoQ.I$MT", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test26()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = Locale.FRENCH;
      Boolean boolean0 = Boolean.valueOf("1[x0N6");
  ...
  public void test29()  throws Throwable  {
      ...
      boolean boolean0 = StdDateFormat._equals((Object) "[one of: 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', 'EEE, dd MMM yyyy HH:mm:ss zzz' (lenient)]", (Object) mockDateFormat0);
      assertFalse(boolean0);
  }
  ...
  public void test44()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("00A0-0-00T00:00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"00A0-0-00T00:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test50()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("?A:qhTy4o['v{DU8gAD");
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0, true);
      // Undeclared exception!
      try { 
  ...
  public void test53()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      TimeZone timeZone0 = TimeZone.getTimeZone("O5U*v3*;wIx");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(timeZone0);
      try { 
        stdDateFormat1.parse("O5U*v3*;wIx");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"O5U*v3*;wIx\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      ...
      stdDateFormat0.instance.parse("Timestamp value %s out of 64-bit value range", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0.parseAsISO8601("4000-00-00", (ParsePosition) null);
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      String string0 = "4000-00-00";
      ParsePosition parsePosition0 = null;
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("00000-00T0:00", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test61()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parseAsRFC1123("n*jbL", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test63()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("auH.,74C", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"auH.,74C\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test66()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("&zFkPD?G9-F~fD");
      Boolean boolean0 = Boolean.valueOf(false);
  ...
  public void test70()  throws Throwable  {
      MockDate mockDate0 = new MockDate(15, (-4689), 15);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-4689), "0000-00-00T00:00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, (Locale) null);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertTrue(stdDateFormat1.isLenient());
      assertEquals("1524-04-14T23:59:55.311-00:00", string0);
  }

  @Test(timeout = 4000)
  public void test71()  throws Throwable  {
      MockDate mockDate0 = new MockDate(15, (-4689), 15);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2593, "0000-00-00T00:00");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, (Locale) null);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1524-04-15T00:00:02.593+0000", string0);
  }
  ...
  public void test74()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-p0-40Tx&00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-p0-40Tx&00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test83()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, (Locale) null, boolean0, false);
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-624));
  ...
  public void test85()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(zoneInfo0);
      ParsePosition parsePosition0 = new ParsePosition(4594);
      try { 
  ...
  public void test94()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(4);
      stdDateFormat0.parse("1904-05-04T00:00:00.000+0000", parsePosition0);
