...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("0000-32-00");
  ...
  public void test06()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("4|^;&m~H!buS&)o$;");
  ...
  public void test07()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3652), ")~T[<oCf[bw");
      Locale locale0 = Locale.forLanguageTag("8VrEC|{uOs;v\"VJ\"cWT");
  ...
  public void test08()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.CANADA_FRENCH;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(841, "0000-00-00");
  ...
  public void test10()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Boolean boolean0 = new Boolean("\"q\"B(64");
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(969, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=969,errorIndex=969]", parsePosition0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "F0%=`Yp[U", 0, 0, 0, 0, 0, 0, 0, 0);
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-170), "Value \"");
      Locale locale0 = Locale.CHINESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertNotNull(timeZone0);
  ...
  public void test23()  throws Throwable  {
      ...
      Locale locale0 = new Locale("S6x.>SSYq_~", "F2", "\" can not be represented as BigDecimal");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("!eZR&", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("q+lm2wfQ.yi", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"q+lm2wfQ.yi\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2571), "A=@EG$f_n*dFA)l?]");
  ...
  public void test40()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3652), "8VrEC|{uOs;v\"VJ\"cWT");
      Locale locale0 = Locale.forLanguageTag("8VrEC|{uOs;v\"VJ\"cWT");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
  ...
  public void test47()  throws Throwable  {
      Locale locale0 = Locale.FRANCE;
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-501), 858, (-2512));
      StringBuffer stringBuffer0 = new StringBuffer();
      // Undeclared exception!
      try { 
  ...
  public void test53()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals((String) null, "8VrEC|{uOs;v\"VJ\"cWT");
  ...
  public void test55()  throws Throwable  {
      ...
      stdDateFormat1._parseDate("M|`9", parsePosition0);
      assertNotSame(stdDateFormat1, stdDateFormat0);
      assertFalse(stdDateFormat1.isColonIncludedInTimeZone());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(12);
      try { 
        stdDateFormat0._parseAsISO8601("JCP", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"JCP\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0d00-f000");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0d00-f000\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("8VrEC|{uOs;v\"VJ\"cWT", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1691), (-1691), (-1782));
      StringWriter stringWriter0 = new StringWriter(35);
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      FieldPosition fieldPosition0 = new FieldPosition((Format.Field) null, (-1691));
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0063-03-16T00:00:00.000+0000", stringBuffer0.toString());
      assertEquals("0063-03-16T00:00:00.000+0000", stringWriter0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1501, "0D88H");
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      MockDate mockDate0 = new MockDate();
      StringBuffer stringBuffer0 = new StringBuffer("0D88H");
      FieldPosition fieldPosition0 = new FieldPosition((-1));
      stdDateFormat1.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0D88H2014-02-14T20:21:22.821+00:00", stringBuffer0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      MockDate mockDate0 = new MockDate(841, 841, (-120));
      StringBuffer stringBuffer0 = new StringBuffer("Cannot parse date \"%s\", problem: %s");
      FieldPosition fieldPosition0 = new FieldPosition(1);
      stdDateFormat1.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      //  // Unstable assertion: assertEquals("Cannot parse date \"%s\", problem: %s2810-10-02T23:59:59.880-0000", stringBuffer0.toString());
  ...
  public void test72()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("9l53$bqIzID| V!u^T");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9l53$bqIzID| V!u^T\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test86()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(841, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.FRANCE;
  ...
  public void test89()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(79, "yyyy-MM-dd");
  ...
  public void test92()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("0000-00-00T000o0");
        fail("Expecting exception: ParseException");
