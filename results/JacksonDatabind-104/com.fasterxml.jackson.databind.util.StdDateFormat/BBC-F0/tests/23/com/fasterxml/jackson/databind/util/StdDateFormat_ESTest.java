...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Locale locale0 = new Locale("Qy,|R\"-p {^nl", "Qy,|R\"-p {^nl", "$%9}~m*m");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(914);
      try { 
        stdDateFormat0._parseAsISO8601("$%9}~m*m", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"$%9}~m*m\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseObject("-EQz|9-");
        fail("Expecting exception: ParseException");
  ...
  public void test03()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("}tvUL3AoN/rX9", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test12()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4021, "0000-00-00T00:00");
      Locale locale0 = new Locale("_7~T.dcmEf=cd/", "A$KLc");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      stdDateFormat0.looksLikeISO8601("p");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("fvL,et+", parsePosition0);
  ...
  public void test24()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("hKHO\"!U[(UWH;@2", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"hKHO\"!U[(UWH;@2\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      ParsePosition parsePosition0 = new ParsePosition((-1668));
      Locale locale0 = new Locale("}L5", "}L5", "");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(832, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "lenient");
      FieldPosition fieldPosition0 = new FieldPosition(3459);
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00700", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00700\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test44()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(1487, 1487, 1487, (-2686), (-2686));
  ...
  public void test49()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("<I![fqn");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
  ...
  public void test52()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0N00-00-00");
        fail("Expecting exception: ParseException");
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0I00)-00-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0I00)-00-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(3304);
      Date date0 = stdDateFormat0.parse("3LE>m~I-!t*6$yM<t=", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: zh_TW, lenient: false)", parsePosition0);
  ...
  public void test60()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer("-s6");
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, (FieldPosition) null);
      assertEquals("-s60088-03-28T08:12:00.000+0000", stringBuffer0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-600), ") Bi'Gd{|~^MO");
      stdDateFormat0._format(simpleTimeZone0, locale0, date0, stringBuffer0);
      assertEquals("2014-02-14T20:21:20.720-0000", stringBuffer0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      stdDateFormat0._format(simpleTimeZone0, locale0, date0, stringBuffer0);
      assertEquals("2014-02-14T20:21:21.321+00:00", stringBuffer0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      ...
      stdDateFormat0.format(date0, stringBuffer1, (FieldPosition) null);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1969-12-31T23:59:59.994+00001969-12-31T23:59:59.994+0000", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-B0-00T00:00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-B0-00T00:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test81()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("<I![fqn");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      TimeZone timeZone1 = TimeZone.getTimeZone("pY%$8Z#aXy");
  ...
  public void test82()  throws Throwable  {
      Locale locale0 = Locale.CHINA;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(5, "~^-jZXIy`>tY9\"8KA.");
  ...
  public void test84()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: zh_TW, lenient: false)", string0);
  }
  ...
  public void test85()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0._parseDate("0000-00-03", parsePosition0);
