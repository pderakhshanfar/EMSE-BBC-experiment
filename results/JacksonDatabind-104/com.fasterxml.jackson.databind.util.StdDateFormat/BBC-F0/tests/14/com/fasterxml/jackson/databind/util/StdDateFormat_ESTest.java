...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parseAsISO8601("5qh^C4cP fI[u16tx[", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"5qh^C4cP fI[u16tx[\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
  ...
  public void test03()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.instance.parse("2.2250738585072012e-308");
        fail("Expecting exception: ParseException");
  ...
  public void test04()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.looksLikeISO8601("~0Y[8_?");
  }
  ...
  public void test06()  throws Throwable  {
      ...
      stdDateFormat0.parse("1265-04-09T00:00:00.000+0000", parsePosition0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-5858), "`V");
  ...
  public void test09()  throws Throwable  {
      ...
      Locale locale0 = new Locale("[one of: '", "", "[one of: '");
      Boolean boolean0 = Boolean.valueOf("U_AjF]j8ukyM");
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-611), ">x;w_?2]M,[9r5k;MV");
  ...
  public void test16()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(0);
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0._parseDate("F|{\"gUny%1", parsePosition0);
  ...
  public void test19()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=java.util.SimpleTimeZone[id=yyyy-MM-dd'T'HH:mm:ss.SSSZ,offset=-1317,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=?,MONTH=?,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=?,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=?,HOUR=?,HOUR_OF_DAY=?,MINUTE=?,SECOND=?,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
  ...
  public void test20()  throws Throwable  {
      ...
      boolean boolean0 = StdDateFormat._equals((Object) thaiBuddhistDate0, (Object) thaiBuddhistDate0);
      assertTrue(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance.parseAsRFC1123(" d'Z", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(2064, 2064, (-3710));
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.instance._parseDate("F|{\"gUny%1", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test40()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1168, "i_H;C4");
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Instant instant0 = MockInstant.ofEpochSecond((-1328L), (-1328L));
      Date date0 = Date.from(instant0);
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      // Undeclared exception!
      try { 
        stdDateFormat0._format(zoneInfo0, (Locale) null, date0, (StringBuffer) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test45()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Instant instant0 = MockInstant.ofEpochSecond((-1623L), (-1623L));
      Date date0 = Date.from(instant0);
      ZoneOffset zoneOffset0 = ZoneOffset.MAX;
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = new Locale("yyyy-MM-dd'T'HH:mm:ss.SSSZ", "ien");
      StringWriter stringWriter0 = new StringWriter(77);
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stdDateFormat0._format(timeZone0, locale0, date0, stringBuffer0);
      assertEquals("1970-01-01T17:32:56.999+1800", stringBuffer0.toString());
      assertEquals("1970-01-01T17:32:56.999+1800", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      ...
      try { 
       ...
       // Unstable assertion
         ...
         //
         // Cannot parse date \"0727-01-10T00:00:00.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test52()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseAsISO8601("'u~t", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"'u~t\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("9fW5,&)L5/");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"9fW5,&)L5/\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test57()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      try { 
        stdDateFormat0.parseObject("19K&O&f-kQ5");
        fail("Expecting exception: ParseException");
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("x^:Q~( 9");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"x^:Q~( 9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1712), (-1712), (-882), 45, (-1712), (-882));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0042-11-30T16:13:18.000+0000", string0);
  ...
  public void test64()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      FieldPosition fieldPosition0 = new FieldPosition(793);
      stdDateFormat1.format(date0, stringBuffer0, fieldPosition0);
      assertEquals("1969-12-31T23:32:56.999+00:00", stringBuffer0.toString());
      assertEquals("1969-12-31T23:32:56.999+00:00", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test65()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1706), (-912), (-912), 673, 73, (-1706));
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1553), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.FRANCE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, (Boolean) null, false);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0115-07-31T01:44:32.447-0000", string0);
  }
  ...
  public void test66()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      MockDate mockDate0 = new MockDate((-1317), 9, (-1317));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertFalse(stdDateFormat0.isLenient());
      assertEquals("0580-02-20T23:59:58.683-00:00", string0);
  }
  ...
  public void test69()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(1);
      ParsePosition parsePosition1 = new ParsePosition(2147483645);
      parsePosition1.setErrorIndex(2147483645);
      stdDateFormat0.parse("0000-04-00", parsePosition1);
      try { 
        stdDateFormat0.parse("k-]4X");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"k-]4X\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
