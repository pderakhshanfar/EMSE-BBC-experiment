...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("\"<q[}<~a[3M.=W79");
        fail("Expecting exception: ParseException");
  ...
  public void test05()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-831), "0000-00-00");
  ...
  public void test10()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1630), "eb>9A[lR:");
  ...
  public void test11()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2, "lenient");
  ...
  public void test12()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2, "lenient", 2, 2, 2, 2, 2, 2, 2, 2);
  ...
  public void test14()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("j 0{m]&eGjiq", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "yyyy-MM-dd'T'HH:mm:ss.SSSZ", 4, (-1), 4, 46, 3972, 0, 46, 0, 894);
      ...
      ParsePosition parsePosition0 = new ParsePosition(2851);
      int int0 = DateFormat.DATE_FIELD;
      stdDateFormat1.parseAsRFC1123("yyyy-MM-dd'T'HH:mm:ss.SSSZ", parsePosition0);
      Locale locale0 = Locale.CANADA_FRENCH;
      StdDateFormat stdDateFormat3 = stdDateFormat0.withLocale(locale0);
      stdDateFormat2.setTimeZone(simpleTimeZone0);
      stdDateFormat0._getCalendar(simpleTimeZone0);
      ParsePosition parsePosition1 = new ParsePosition(2851);
      try { 
        stdDateFormat3.parseAsISO8601("GMT+00:00", parsePosition0);
        fail("Expecting exception: ParseException");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("fv/P6nZMDbSWfmA`l", parsePosition0);
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parseAsRFC1123("3Drb%STitWA", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("67W4qewS~X4XPZ%|%2", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("0000-00-0I0Th0:00", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-00-0I0Th0:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test40()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-2177));
      // Undeclared exception!
      try { 
  ...
  public void test43()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      Boolean boolean1 = Boolean.valueOf("cq)'%G$");
  ...
  public void test45()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      stdDateFormat0.parse("K<ks~t", parsePosition0);
  ...
  public void test48()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("0000-J0-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-J0-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0.parse("7I;J[k-$MA6YI}?CD", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test52()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "");
      Locale locale0 = Locale.forLanguageTag("~,0|*H*");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1535), (-4369), 48, (-4369), (-4369), 29);
      StringBuffer stringBuffer0 = new StringBuffer();
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, (FieldPosition) null);
      assertEquals("0001-07-15T22:11:29.000+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test55()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(8, 3, 5, (-3850), 2748);
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition(800);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      stdDateFormat1.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals(29, stringBuffer0.length());
      assertEquals("1907-10-29T11:48:00.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(1, 1, 2798, 2798, 1207, 1207);
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1909-01-24T10:27:07.001+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test57()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1630), "eb>9A[lR:");
      MockDate mockDate0 = new MockDate((-1630), (-1630), (-1630), (-1630), (-679), (-679));
      StringBuffer stringBuffer0 = new StringBuffer("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ0129-07-05T14:29:39.370-00:00", stringBuffer0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(false);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLenient(boolean0);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1691, "");
      // Undeclared exception!
      try { 
  ...
  public void test64()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(2851);
      try { 
        stdDateFormat0.parseAsISO8601("c-:O5s6Jp", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"c-:O5s6Jp\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      Locale locale0 = Locale.ITALIAN;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(45, "c}F4JJC6CQiZGQR [)");
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      assertSame(stdDateFormat1, stdDateFormat0);
  ...
  public void test76()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("1909-10-10T07:03:09.000+0000");
        fail("Expecting exception: ParseException");
  ...
  public void test77()  throws Throwable  {
      ...
      Locale locale0 = Locale.ITALY;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-2993));
