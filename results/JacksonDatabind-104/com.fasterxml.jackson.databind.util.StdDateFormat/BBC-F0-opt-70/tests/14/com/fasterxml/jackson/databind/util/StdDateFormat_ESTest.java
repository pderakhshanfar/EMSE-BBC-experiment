...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("^4EmF\"oV=93");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"^4EmF\"oV=93\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(5, "un/rxZ[LK} )");
      ...
      assertEquals("2014-02-14T20:21:21.325+0000", stringBuffer0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      stdDateFormat0.parse("0814-10-15T07:01:00.000+00:00", parsePosition0);
      assertTrue(stdDateFormat0.isLenient());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test12()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("01'Z%FMbzG77");
      Locale locale0 = new Locale("d{e@T:~D:H{", "$<f");
  ...
  public void test16()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("0814-10-15T07:01:00.000+00:00");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertTrue(boolean0);
  }
  ...
  public void test17()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.looksLikeISO8601("hc");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("?5acleLs8#29JRnf");
  ...
  public void test25()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(15, "au");
      ...
      assertEquals("2014-02-14T20:21:21.335+0000", stringBuffer0.toString());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1), "2bOAB");
      Calendar calendar0 = stdDateFormat1._getCalendar(simpleTimeZone0);
      //  // Unstable assertion: assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=java.util.SimpleTimeZone[id=2bOAB,offset=-1,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=?,MONTH=?,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=?,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=?,HOUR=?,HOUR_OF_DAY=?,MINUTE=?,SECOND=?,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
  }
  ...
  public void test29()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("0000-00-00", "com.fasterxml.jackson.core.io.NumberInput");
  ...
  public void test43()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1455, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      try { 
        stdDateFormat0._parseDate("3986-05-22T23:00:11.000+0000", parsePosition0);
       //  fail("Expecting exception: ParseException");
       // Unstable assertion
      } catch(ParseException e) {
         //
         // Cannot parse date \"3986-05-22T23:00:11.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("$2", parsePosition0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test48()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-3019));
  ...
  public void test51()  throws Throwable  {
      ...
      Locale locale0 = new Locale("WDz[lu=bZgZ/", "yyyy-MM-dd'T'HH:mm:ss.SSSZ", "\" can not be represented as BigDecimal");
  ...
  public void test52()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(353, 0, 353, 353, 89);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2254-01-02T18:29:00.000+0000", string0);
      
      ParsePosition parsePosition0 = new ParsePosition(0);
      Date date0 = stdDateFormat0._parseDate("0000-00-00", parsePosition0);
      assertEquals("Mon Jan 02 18:29:00 GMT 2254", date0.toString());
      assertNotNull(date0);
  }
  ...
  public void test57()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        stdDateFormat0._parseAsISO8601("\u4E2D\u56FD", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"\u4E2D\u56FD\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parse("0000-Ok00-00");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"0000-Ok00-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition((-1843));
      // Undeclared exception!
      try { 
        stdDateFormat0._parseDate("01'Z%FMbzG77", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(0, 0, 1455, 1455, 340);
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate((-1724), (-896), (-896), (-1724), 89);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0098-09-05T05:29:00.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test66()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-624), (-1724), (-624), (-1724), 12, (-1724));
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1130-06-04T03:43:16.012+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test67()  throws Throwable  {
      MockDate mockDate0 = new MockDate(1455, 1455, 340, 340, 46);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-218), "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      LinkedList<Locale.LanguageRange> linkedList0 = new LinkedList<Locale.LanguageRange>();
      LinkedHashSet<Locale> linkedHashSet0 = new LinkedHashSet<Locale>();
      Locale locale0 = Locale.lookup(linkedList0, linkedHashSet0);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("3477-03-20T04:45:59.782-0000", string0);
  }
  ...
  public void test69()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2810, "U=eW-H3>zqM&");
      stdDateFormat1.instance._timezone = (TimeZone) simpleTimeZone0;
      ParsePosition parsePosition0 = new ParsePosition(0);
      Object object0 = stdDateFormat0.parseObject("0000-00-00", parsePosition0);
      AttributedCharacterIterator attributedCharacterIterator0 = stdDateFormat0.instance.formatToCharacterIterator(object0);
  ...
  public void test72()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parse("7)f8*\"}0#B");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"7)f8*\"}0#B\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test75()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "O*>j/>SIa$r2#}X");
      Locale locale0 = Locale.UK;
      Boolean boolean0 = new Boolean("O*>j/>SIa$r2#}X");
  ...
  public void test76()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      MockDate mockDate0 = new MockDate(2, 36, 0, 4949, 57);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1905-07-25T05:57:00.000+00:00", string0);
  }
  ...
  public void test88()  throws Throwable  {
      ...
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: null, locale: en_CA, lenient: null)", string0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test89()  throws Throwable  {
      ...
      int int0 = (-185);
      ParsePosition parsePosition0 = new ParsePosition((-185));
      // Undeclared exception!
      try { 
  ...
  public void test90()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      try { 
        stdDateFormat0.parseObject("0900-00-00");
        fail("Expecting exception: ParseException");
