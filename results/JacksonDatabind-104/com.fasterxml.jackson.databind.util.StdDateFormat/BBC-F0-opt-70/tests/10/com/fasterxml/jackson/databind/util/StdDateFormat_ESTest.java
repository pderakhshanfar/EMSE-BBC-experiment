...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0.parse("0060-00-01");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("1000-00-30");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(1871, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1871,errorIndex=1871]", parsePosition0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1163), "YM");
      Locale locale0 = Locale.GERMANY;
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      try { 
        stdDateFormat0.parseObject("Q");
        fail("Expecting exception: ParseException");
  ...
  public void test10()  throws Throwable  {
      ...
      assertEquals(1254, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1254,errorIndex=1254]", parsePosition0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate(1, 1, 1, 1217, 1, 0);
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, (FieldPosition) null);
      assertEquals("1901-03-23T17:01:00.000+0000", stringBuffer0.toString());
      assertEquals("1901-03-23T17:01:00.000+0000", stringWriter0.toString());
  }
  ...
  public void test34()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1163), "YM");
      Locale locale0 = Locale.US;
      Boolean boolean0 = new Boolean("YM");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      ParsePosition parsePosition0 = new ParsePosition((-1163));
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition((-1809));
      // Undeclared exception!
      try { 
  ...
  public void test51()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(34);
      stdDateFormat1._parseDate("[one of: 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', 'EEE, dd MMM yyyy HH:mm:ss zzz' (lenient)]", parsePosition0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test53()  throws Throwable  {
      ...
      stdDateFormat1.instance._parseDate("81x (<:\"7u9", parsePosition0);
      ParsePosition parsePosition1 = new ParsePosition(8);
      try { 
        stdDateFormat1._parseAsISO8601("81x (<:\"7u9", parsePosition1);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"81x (<:\"7u9\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(371);
      try { 
  ...
  public void test56()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      try { 
        stdDateFormat0.parseObject("0000-H00");
        fail("Expecting exception: ParseException");
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1803), (-1803), 943, 2209, (-2659), (-1803));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0052-07-29T04:10:57.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test61()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(84, 0, 84);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertTrue(stdDateFormat1.isLenient());
      assertEquals("1984-03-24T00:00:00.000+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test62()  throws Throwable  {
      MockDate mockDate0 = new MockDate(8, 89, 8, 8, 89, (-2));
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1915-06-09T03:28:58.000+18:00", string0);
  }
  ...
  public void test64()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1163), "YM");
      Locale locale0 = Locale.GERMANY;
      MockDate mockDate0 = new MockDate((-2781), 45, 45, 45, 45, (-1163));
      Boolean boolean0 = new Boolean("Q");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0879-11-15T21:25:35.837-0000", string0);
  }
  ...
  public void test66()  throws Throwable  {
      ...
      try { 
        stdDateFormat0.parse("3x 5*_`3ETB7/");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Cannot parse date \"3x 5*_`3ETB7/\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
         //
         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
      }
  }
  ...
  public void test72()  throws Throwable  {
      ...
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-1496));
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      assertSame(stdDateFormat1, stdDateFormat0);
  ...
  public void test74()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1163), "YM");
      Locale locale0 = Locale.GERMAN;
      SimpleTimeZone simpleTimeZone1 = new SimpleTimeZone((-1163), "YM");
      Boolean boolean0 = new Boolean(false);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone1, locale0, boolean0, false);
  ...
  public void test82()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1163), "Y");
      Locale locale0 = Locale.GERMAN;
  ...
  public void test85()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=YM,offset=-1163,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0], locale: de_DE, lenient: false)", string0);
  }
  ...
  public void test88()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1189), "YM");
