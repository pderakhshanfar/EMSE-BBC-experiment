...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("com.ctc.wstx.dtd.DefaultAttrValue$UndeclaredEntity");
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance("com.ctc.wstx.lazyParsing", systemId0, stringReader0, "v^5s`?/");
      XMLStreamReader2 xMLStreamReader2_0 = wstxInputFactory0.createSR(readerConfig0, "yN ", (InputBootstrapper) readerBootstrapper0, true, true);
      XmlTokenStream xmlTokenStream0 = null;
      try {
        xmlTokenStream0 = new XmlTokenStream(xMLStreamReader2_0, "com.ctc.wstx.lazyParsing");
