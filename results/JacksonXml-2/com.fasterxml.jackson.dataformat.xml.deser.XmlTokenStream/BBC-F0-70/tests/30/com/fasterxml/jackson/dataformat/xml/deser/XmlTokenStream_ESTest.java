...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      SystemId systemId0 = SystemId.construct("Empty NMTOKENS value", uRL0);
      StringReader stringReader0 = new StringReader("");
      BranchingReaderSource branchingReaderSource0 = new BranchingReaderSource(readerConfig0, "Empty NMTOKENS value", systemId0, stringReader0, true);
      WstxInputFactory wstxInputFactory0 = new WstxInputFactory();
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance("org.codehaus.stax2.reportPrologWhitespace", systemId0, stringReader0, "");
