...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      XMLStreamReader xMLStreamReader0 = wstxInputFactory0.createXMLStreamReader("gXo}tHr(p``$$F]).", reader0);
      XmlTokenStream xmlTokenStream0 = null;
      try {
        xmlTokenStream0 = new XmlTokenStream(xMLStreamReader0, "gXo}tHr(p``$$F]).");
