...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("=&09yD5l4`n2M^aa");
      BranchingReaderSource branchingReaderSource0 = new BranchingReaderSource(readerConfig0, ">:f5", systemId0, stringReader0, true);
      WstxInputFactory wstxInputFactory0 = new WstxInputFactory();
      byte[] byteArray0 = new byte[8];
      StreamBootstrapper streamBootstrapper0 = StreamBootstrapper.getInstance("org.codehaus.stax2.closeInputSource", systemId0, byteArray0, 1683, 1738);
      ...
      XmlTokenStream xmlTokenStream0 = null;
      try {
        xmlTokenStream0 = new XmlTokenStream(typedStreamReader0, ">:f5");
