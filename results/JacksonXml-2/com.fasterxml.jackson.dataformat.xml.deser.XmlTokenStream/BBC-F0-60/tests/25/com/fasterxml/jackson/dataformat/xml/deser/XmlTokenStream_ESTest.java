...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      SystemId systemId0 = SystemId.construct("GxHtVI0}");
      StringReader stringReader0 = new StringReader("");
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance("", systemId0, stringReader0, "y/?Qrk0(k^o7?olC]");
      XMLStreamReader2 xMLStreamReader2_0 = wstxInputFactory0.createSR(readerConfig0, "y/?Qrk0(k^o7?olC]", (InputBootstrapper) readerBootstrapper0, false, true);
      XmlTokenStream xmlTokenStream0 = null;
      try {
        xmlTokenStream0 = new XmlTokenStream(xMLStreamReader2_0, "Unexpected end of input block");
