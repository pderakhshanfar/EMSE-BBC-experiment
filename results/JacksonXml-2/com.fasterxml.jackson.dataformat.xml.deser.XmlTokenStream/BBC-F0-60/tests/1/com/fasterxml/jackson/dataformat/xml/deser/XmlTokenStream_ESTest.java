...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      xmlTokenStream0._nextLocalName = "\"V h0AK<";
      String string0 = xmlTokenStream0.toString();
      assertEquals("(Token stream: state=1 attr#=0 nextAttr#=0 name= text=null repeat?=0 wrapper=[null] repeatElement=0 nextName=\"V h0AK<)", string0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttribute("Internal error: no handler for property with internal id ", "Internal error: no handler for property with internal id ");
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, dOMSource0);
      xmlTokenStream0.next();
      String string0 = xmlTokenStream0.toString();
      assertEquals("(Token stream: state=3 attr#=1 nextAttr#=0 name=Internal error: no handler for property with internal id  text=Internal error: no handler for property with internal id  repeat?=0 wrapper=[null] repeatElement=0 nextName=null)", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode("Z?B8E<");
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0);
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      ...
      String string0 = xmlTokenStream0.toString();
      assertEquals("(Token stream: state=1 attr#=0 nextAttr#=0 name=Z?B8E< text=null repeat?=1 wrapper=[Wrapper: ROOT, matching: Z?B8E<] repeatElement=1 nextName=null)", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      ElementWrapper elementWrapper1 = ElementWrapper.matchingWrapper(elementWrapper0, "0Um'L", (String) null);
  ...
  public void test06()  throws Throwable  {
      ...
      xmlTokenStream0.repeatStartElement();
      xmlTokenStream0._localName = "9JE~6";
      xmlTokenStream0.next();
      try { 
        xmlTokenStream0.skipEndElement();
  ...
  public void test07()  throws Throwable  {
      ...
      iIOMetadataNode0.appendChild(iIOMetadataNode0);
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, iIOMetadataNode0);
      xmlTokenStream0._namespaceURI = "\"q";
      xmlTokenStream0.repeatStartElement();
      xmlTokenStream0.next();
      try { 
        xmlTokenStream0.skipEndElement();
  ...
  public void test10()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, dOMSource0);
      xmlTokenStream0._nextNamespaceURI = "Internal error: no handler for property with internal id ";
      int int0 = xmlTokenStream0.next();
      assertEquals(2, xmlTokenStream0.getCurrentToken());
      assertEquals(2, int0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttribute("}gwO8!K fIoJ^.", "}gwO8!K fIoJ^.");
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, wstxDOMWrappingReader0);
      xmlTokenStream0.next();
      xmlTokenStream0._nextAttributeIndex = (-4510);
      xmlTokenStream0.next();
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Illegal attribute index -4509; element <null> has 1 attributes
         //
  ...
  public void test13()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode();
      IIOMetadataNode iIOMetadataNode1 = new IIOMetadataNode("kiJ9iHQTqdY");
      Node node0 = iIOMetadataNode0.replaceChild(iIOMetadataNode1, iIOMetadataNode1);
      DOMSource dOMSource0 = new DOMSource(node0);
      ReaderConfig readerConfig0 = ReaderConfig.createFullDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode1.setAttribute("kiJ9iHQTqdY", "kiJ9iHQTqdY");
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, dOMSource0);
      xmlTokenStream0.next();
  ...
  public void test14()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode();
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "^<ag&8<5y[oW5n");
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttribute("^<ag&8<5y[oW5n", "^<ag&8<5y[oW5n");
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, readerConfig0);
      xmlTokenStream0._nextLocalName = "^<ag&8<5y[oW5n";
      xmlTokenStream0.next();
      xmlTokenStream0.convertToString();
      assertFalse(xmlTokenStream0.hasAttributes());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttribute("Uty", "Uty");
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, wstxDOMWrappingReader0);
      xmlTokenStream0.next();
      xmlTokenStream0._nextNamespaceURI = "/xg>eqW8\"aII(u6%7:P";
      xmlTokenStream0.convertToString();
  ...
  public void test16()  throws Throwable  {
      ...
      xmlTokenStream0.convertToString();
      assertEquals(1773, xmlTokenStream0.getCurrentToken());
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode("fYnw)M");
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0);
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
  ...
  public void test19()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, readerConfig0);
      xmlTokenStream0._attributeCount = (-735);
  ...
  public void test20()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode("?B8E<");
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "@KR");
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, "?B8E<");
  ...
  public void test21()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, readerConfig0);
      xmlTokenStream0._repeatElement = (-2796);
      // Undeclared exception!
      try { 
        xmlTokenStream0.next();
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Unrecognized type to repeat: -2796
         //
         verifyException("com.fasterxml.jackson.dataformat.xml.deser.XmlTokenStream", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, readerConfig0);
      xmlTokenStream0._textValue = "Current state DOCTYPE, but not DTDInfo Object returned -- reader doesn't support DTDs?";
      String string0 = xmlTokenStream0.getText();
      assertNotNull(string0);
      assertEquals("Current state DOCTYPE, but not DTDInfo Object returned -- reader doesn't support DTDs?", string0);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttribute("'wMEhr3sU", "'wMEhr3sU");
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, readerConfig0);
      xmlTokenStream0.next();
      xmlTokenStream0.convertToString();
  ...
  public void test24()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, "Internal error: no handler for property with internal id ");
      xmlTokenStream0._namespaceURI = "Internal error: no handler for property with internal id ";
      String string0 = xmlTokenStream0.getNamespaceURI();
      assertNotNull(string0);
      assertEquals("Internal error: no handler for property with internal id ", xmlTokenStream0.getNamespaceURI());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Object object0 = new Object();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, object0);
      xmlTokenStream0._attributeCount = 531;
      // Undeclared exception!
      try { 
        xmlTokenStream0.next();
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test32()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttribute(" ^:6{ww@0:QW=X*}m=!", " ^:6{ww@0:QW=X*}m=!");
  ...
  public void test42()  throws Throwable  {
      ...
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, dOMSource0);
      xmlTokenStream0.repeatStartElement();
      IIOMetadataNode iIOMetadataNode1 = new IIOMetadataNode(" in DOCTYPE declaration; expected '[' or white space.");
      iIOMetadataNode0.appendChild(iIOMetadataNode1);
      xmlTokenStream0._repeatElement = 0;
      xmlTokenStream0.skipEndElement();
      int int0 = xmlTokenStream0._handleRepeatElement();
      assertEquals(" in DOCTYPE declaration; expected '[' or white space.", xmlTokenStream0.getLocalName());
      assertEquals(1, int0);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.appendChild(iIOMetadataNode0);
      iIOMetadataNode0.setAttribute("Current state not XML_START_ELEMENT (1) but ", "");
  ...
  public void test48()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttribute("7\"r", "7\"r");
      iIOMetadataNode0.setAttribute("a@Gxc+h", "Trying to write a namespace declaration when there is no open start element.");
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, "Trying to write a namespace declaration when there is no open start element.");
      xmlTokenStream0.next();
      xmlTokenStream0.next();
      xmlTokenStream0.next();
      xmlTokenStream0.convertToString();
  ...
  public void test52()  throws Throwable  {
      ...
      xmlTokenStream0.next();
      xmlTokenStream0.skipAttributes();
      assertEquals("Internal error: no handler for property with internal id ", xmlTokenStream0.getLocalName());
  }
  ...
  public void test59()  throws Throwable  {
      ...
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance("=L!IuX&v", systemId0, stringReader0, "95F");
