...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      SystemId systemId0 = SystemId.construct("Invalid XMLStreamReader passed: should be pointing to START_ELEMENT (1), instead got ");
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 613, 742);
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(byteArrayInputStream0);
      StreamBootstrapper streamBootstrapper0 = StreamBootstrapper.getInstance("jk2G/JcZptEYh%!", systemId0, (InputStream) bufferedInputStream0);
