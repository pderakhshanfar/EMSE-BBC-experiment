...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      SystemId systemId0 = SystemId.construct("-IH");
      StringReader stringReader0 = new StringReader("x+QN's!l>O");
      BranchingReaderSource branchingReaderSource0 = new BranchingReaderSource(readerConfig0, "-IH", systemId0, stringReader0, true);
      WstxInputFactory wstxInputFactory0 = new WstxInputFactory();
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance("jO51Wu>,My`>}!hGi;7", systemId0, stringReader0, "");
      ...
      XmlTokenStream xmlTokenStream0 = null;
      try {
        xmlTokenStream0 = new XmlTokenStream(typedStreamReader0, "x+QN's!l>O");
