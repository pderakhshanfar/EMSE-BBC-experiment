...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("vsom{2p9dxX^Ks&Ia5J");
      BranchingReaderSource branchingReaderSource0 = new BranchingReaderSource(readerConfig0, "vsom{2p9dxX^Ks&Ia5J", systemId0, stringReader0, true);
      WstxInputFactory wstxInputFactory0 = new WstxInputFactory();
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance("vsom{2p9dxX^Ks&Ia5J", systemId0, stringReader0, (String) null);
