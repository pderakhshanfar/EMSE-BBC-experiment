...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttributeNS("-VQ})adz1CdE_sU5", "-VQ})adz1CdE_sU5", (String) null);
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, dOMSource0);
      xmlTokenStream0.next();
      xmlTokenStream0._nextLocalName = "|xv:JQ-lyP~%vh";
  ...
  public void test12()  throws Throwable  {
      ...
      xmlTokenStream0._currentState = 796;
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Current state not XML_START_ELEMENT or XML_ATTRIBUTE_NAME (1) but 796
         //
         verifyException("com.fasterxml.jackson.dataformat.xml.deser.XmlTokenStream", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode();
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "Expected non-null local name, but current token not a START_ELEMENT, END_ELEMENT or ENTITY_REFERENCE (was ");
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, "Expected non-null local name, but current token not a START_ELEMENT, END_ELEMENT or ENTITY_REFERENCE (was ");
      xmlTokenStream0._localName = "*X9H,p56fG%.=";
      xmlTokenStream0.repeatStartElement();
      xmlTokenStream0.repeatStartElement();
  ...
  public void test15()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttributeNS("", ";Ao3BVO.:a8P", ";Ao3BVO.:a8P");
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, "");
      xmlTokenStream0.next();
      xmlTokenStream0.getNamespaceURI();
      assertEquals(";Ao3BVO.:a8P", xmlTokenStream0.getLocalName());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttributeNS("-V})adz1CdE_sU85", "-V})adz1CdE_sU85", (String) null);
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, dOMSource0);
      xmlTokenStream0.next();
  ...
  public void test26()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode();
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "G7X,9,>:aR {-H@%d");
      ReaderConfig readerConfig0 = ReaderConfig.createFullDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, iIOMetadataNode0);
  ...
  public void test38()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttributeNS("(Token stream:", "mT-%c", "(Token stream:");
      StreamFilter streamFilter0 = mock(StreamFilter.class, new ViolatedAssumptionAnswer());
      doReturn(false, false).when(streamFilter0).accept(any(javax.xml.stream.XMLStreamReader.class));
      Stax2FilteredStreamReader stax2FilteredStreamReader0 = new Stax2FilteredStreamReader(wstxDOMWrappingReader0, streamFilter0);
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(stax2FilteredStreamReader0, "mT-%c");
      xmlTokenStream0.next();
      xmlTokenStream0.convertToString();
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode();
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "P+G'?6DT'FeN+pE8h0");
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttributeNS("P+G'?6DT'FeN+pE8h0", "", "");
  ...
  public void test48()  throws Throwable  {
      ...
      XmlTokenStream xmlTokenStream0 = null;
      try {
        xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, " attr#=");
        fail("Expecting exception: IllegalArgumentException");
