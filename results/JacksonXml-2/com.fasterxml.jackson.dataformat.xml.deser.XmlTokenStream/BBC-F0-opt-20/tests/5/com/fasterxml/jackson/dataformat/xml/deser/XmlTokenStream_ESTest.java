...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("p^2oKD;#`)22/Xm``{");
      BranchingReaderSource branchingReaderSource0 = new BranchingReaderSource(readerConfig0, "p^2oKD;#`)22/Xm``{", (SystemId) null, stringReader0, true);
      WstxInputFactory wstxInputFactory0 = new WstxInputFactory();
      byte[] byteArray0 = new byte[9];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)0, 3541);
      StreamBootstrapper streamBootstrapper0 = StreamBootstrapper.getInstance("", (SystemId) null, (InputStream) byteArrayInputStream0);
