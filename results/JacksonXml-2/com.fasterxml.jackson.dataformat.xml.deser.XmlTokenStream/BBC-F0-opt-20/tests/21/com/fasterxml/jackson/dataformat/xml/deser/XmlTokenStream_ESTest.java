...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      StreamBootstrapper streamBootstrapper0 = StreamBootstrapper.getInstance("http://java.sun.com/xml/stream/properties/report-cdata-event", (SystemId) null, (InputStream) byteArrayInputStream0);
      XMLStreamReader2 xMLStreamReader2_0 = wstxInputFactory0.createSR(readerConfig0, "`>)4s!_2^", (InputBootstrapper) streamBootstrapper0, true, false);
      XmlTokenStream xmlTokenStream0 = null;
      try {
