...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode("m>8C;?E1}j&s");
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "m>8C;?E1}j&s");
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      iIOMetadataNode0.setAttributeNS("Internal error (unrecognized error type: ", "Internal error (unrecognized error type: ", "JY^QtW");
      ...
      assertEquals("(Token stream: state=3 attr#=1 nextAttr#=0 name=Internal error (unrecognized error type:  text=JY^QtW repeat?=0 wrapper=[null] repeatElement=0 nextName=null)", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode();
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "Zm^X%';`]\"BQ.J8");
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.nextTag();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, iIOMetadataNode0);
      xmlTokenStream0._nextNamespaceURI = "FslOR";
      String string0 = xmlTokenStream0.toString();
  ...
  public void test02()  throws Throwable  {
      ...
      String string0 = xmlTokenStream0.toString();
      assertEquals("(Token stream: state=1 attr#=0 nextAttr#=0 name=m>8C;?E1}j&s text=null repeat?=1 wrapper=[Wrapper: ROOT, matching: m>8C;?E1}j&s] repeatElement=1 nextName=null)", string0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      xmlTokenStream0.next();
      String string0 = xmlTokenStream0.toString();
      assertEquals("(Token stream: state=2 attr#=0 nextAttr#=0 name=m>8C;?E1}j&s text=null repeat?=0 wrapper=[null] repeatElement=0 nextName=null)", string0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      xmlTokenStream0._nextLocalName = " 2Bl8(&h(\"F>";
      xmlTokenStream0.skipEndElement();
      assertEquals("m>8C;?E1}j&s", xmlTokenStream0.getLocalName());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode("Zm^X1';`]\"BQ.e8");
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "Zts;v.<dg>0N6VR#");
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.nextTag();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, wstxDOMWrappingReader0);
  ...
  public void test06()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode("Zm^X%';`]\"BQ.J8");
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "Zm^X%';`]\"BQ.J8");
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      iIOMetadataNode0.setAttributeNS("Zm^X%';`]\"BQ.J8", "Zm^X%';`]\"BQ.J8", "Zm^X%';`]\"BQ.J8");
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.nextTag();
      iIOMetadataNode0.setAttributeNS("Tz@Nw9aj", "Tz@Nw9aj", "F");
      Object object0 = new Object();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, object0);
      xmlTokenStream0.next();
      xmlTokenStream0.next();
  ...
  public void test07()  throws Throwable  {
      ...
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, iIOMetadataNode0);
      xmlTokenStream0.next();
      xmlTokenStream0._nextAttributeIndex = 2501;
      xmlTokenStream0.next();
      int int0 = xmlTokenStream0.next();
  ...
  public void test09()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode("Zm^X1';`]\"BQ.e8");
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "Zm^X1';`]\"BQ.e8");
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.nextTag();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, "Zm^X1';`]\"BQ.e8");
      xmlTokenStream0.next();
      xmlTokenStream0.next();
  ...
  public void test11()  throws Throwable  {
      ...
      xmlTokenStream0._attributeCount = (-1040);
  ...
  public void test13()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.nextTag();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, dOMSource0);
      xmlTokenStream0._repeatElement = (-654);
      // Undeclared exception!
      try { 
        xmlTokenStream0.next();
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Unrecognized type to repeat: -654
         //
         verifyException("com.fasterxml.jackson.dataformat.xml.deser.XmlTokenStream", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode("Undeclared namespace prefix \"{0}\" (for attribute \"{1}\")");
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "Undeclared namespace prefix \"{0}\" (for attribute \"{1}\")");
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals("m>8C;?E1}j&s", string0);
  }
  ...
  public void test19()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode("m>8C;?E1}j&s");
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "3n <tHGel4t");
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.nextTag();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, readerConfig0);
  ...
  public void test21()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.nextTag();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, (Object) null);
      xmlTokenStream0._attributeCount = 38;
      // Undeclared exception!
      try { 
        xmlTokenStream0.next();
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Illegal attribute index 0; element <m>8C;?E1}j&s> has no attributes
         //
         verifyException("org.codehaus.stax2.ri.dom.DOMWrappingReader", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.nextTag();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, "m>8C;?E1}j&s");
      xmlTokenStream0._repeatElement = 87;
      // Undeclared exception!
      try { 
        xmlTokenStream0.next();
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Unrecognized type to repeat: 87
         //
         verifyException("com.fasterxml.jackson.dataformat.xml.deser.XmlTokenStream", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode();
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "Cg`r2a- u8,{M`");
      iIOMetadataNode0.setAttributeNS("Cg`r2a- u8,{M`", "Cg`r2a- u8,{M`", "BAIu");
  ...
  public void test34()  throws Throwable  {
      ...
      xmlTokenStream0.next();
      xmlTokenStream0.skipAttributes();
      assertEquals("Internal error (unrecognized error type: ", xmlTokenStream0.getLocalName());
  }
  ...
  public void test46()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode();
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "XyHQm84dD\"\"%K~Cv");
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.nextTag();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, "*RFl>(<(KO9");
      String string0 = xmlTokenStream0.getLocalName();
      assertEquals(1, xmlTokenStream0.getCurrentToken());
      assertNotNull(string0);
  }
