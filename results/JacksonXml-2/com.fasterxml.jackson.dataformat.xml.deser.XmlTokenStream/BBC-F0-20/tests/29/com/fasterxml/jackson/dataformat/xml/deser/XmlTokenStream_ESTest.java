...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader(" repeat?=");
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance("", (SystemId) null, stringReader0, "http://java.sun.com/xml/stream/properties/report-cdata-event");
      Reader reader0 = readerBootstrapper0.bootstrapInput((ReaderConfig) null, false, 5);
      XMLStreamReader xMLStreamReader0 = wstxInputFactory0.createXMLStreamReader("&XB#", reader0);
      XmlTokenStream xmlTokenStream0 = null;
      try {
        xmlTokenStream0 = new XmlTokenStream(xMLStreamReader0, "]/L/U,xBlr{[6Zef\"");
