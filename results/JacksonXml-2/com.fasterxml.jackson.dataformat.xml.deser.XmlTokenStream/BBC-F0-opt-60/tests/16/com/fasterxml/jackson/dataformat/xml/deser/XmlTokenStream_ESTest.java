...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      SystemId systemId0 = SystemId.construct("(sp2PWjTi", uRL0);
      StringReader stringReader0 = new StringReader("(sp2PWjTi");
      BranchingReaderSource branchingReaderSource0 = new BranchingReaderSource(readerConfig0, "org.codehaus.stax2.attrValueEscaper", systemId0, stringReader0, false);
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance("(sp2PWjTi", systemId0, stringReader0, "Sy',Bt2ec=!T");
