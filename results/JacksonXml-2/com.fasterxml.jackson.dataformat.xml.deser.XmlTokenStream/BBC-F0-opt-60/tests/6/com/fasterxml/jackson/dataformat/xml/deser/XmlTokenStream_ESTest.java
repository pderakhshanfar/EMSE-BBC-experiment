...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      SystemId systemId0 = SystemId.construct("%KNzG1YN9", uRL0);
      StringReader stringReader0 = new StringReader("%KNzG1YN9");
      BranchingReaderSource branchingReaderSource0 = new BranchingReaderSource(readerConfig0, "%KNzG1YN9", systemId0, stringReader0, false);
      WstxInputFactory wstxInputFactory0 = new WstxInputFactory();
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance((String) null, systemId0, stringReader0, (String) null);
      ...
      XmlTokenStream xmlTokenStream0 = null;
      try {
        xmlTokenStream0 = new XmlTokenStream(validatingStreamReader0, "%KNzG1YN9");
