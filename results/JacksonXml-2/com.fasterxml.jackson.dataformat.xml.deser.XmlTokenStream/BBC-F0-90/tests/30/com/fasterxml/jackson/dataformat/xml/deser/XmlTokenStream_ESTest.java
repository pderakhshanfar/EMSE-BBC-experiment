...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance("org.codehaus.stax2.closeInputSource", systemId0, stringReader0, "B[f`=zI5;\"43y4<3};");
      XMLStreamReader2 xMLStreamReader2_0 = wstxInputFactory0.createSR(readerConfig0, " text=", (InputBootstrapper) readerBootstrapper0, true, true);
