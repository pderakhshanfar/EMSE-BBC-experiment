...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      SystemId systemId0 = SystemId.construct("h0\"HNgpo]{{ ");
      StringReader stringReader0 = new StringReader(" in DOCTYPE declaration; expected a space between public and system identifiers");
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance(" in DOCTYPE declaration; expected a space between public and system identifiers", systemId0, stringReader0, "org.codehaus.stax2.preserveLocation");
      ReaderConfig readerConfig0 = ReaderConfig.createFullDefaults();
      Reader reader0 = readerBootstrapper0.bootstrapInput(readerConfig0, true, (-1188));
      XMLStreamReader xMLStreamReader0 = wstxInputFactory0.createXMLStreamReader(" in DOCTYPE declaration; expected a space between public and system identifiers", reader0);
      XmlTokenStream xmlTokenStream0 = null;
      try {
