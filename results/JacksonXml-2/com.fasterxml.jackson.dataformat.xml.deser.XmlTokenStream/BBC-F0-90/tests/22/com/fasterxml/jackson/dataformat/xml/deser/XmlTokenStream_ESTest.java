...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      ReaderConfig readerConfig0 = ReaderConfig.createFullDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      iIOMetadataNode0.setAttributeNS((String) null, "/Tdx*f5", "QP&bg'X~&lw'fah6Fk");
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, dOMSource0);
      xmlTokenStream0.next();
      String string0 = xmlTokenStream0.toString();
      assertEquals("(Token stream: state=3 attr#=1 nextAttr#=0 name=/Tdx*f5 text=QP&bg'X~&lw'fah6Fk repeat?=0 wrapper=[null] repeatElement=0 nextName=null)", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, iIOMetadataNode0);
      xmlTokenStream0.repeatStartElement();
      xmlTokenStream0._namespaceURI = "Q2B~:eu#$-G>EW*UU(";
      xmlTokenStream0.next();
      try { 
        xmlTokenStream0.skipEndElement();
        fail("Expecting exception: IOException");
  ...
  public void test08()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode();
      IIOMetadataNode iIOMetadataNode1 = new IIOMetadataNode("xFy");
  ...
  public void test11()  throws Throwable  {
      ...
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0);
      ReaderConfig readerConfig0 = ReaderConfig.createFullDefaults();
      iIOMetadataNode0.setAttributeNS("Empty IDREFS value", "Empty IDREFS value", "Empty IDREFS value");
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, readerConfig0);
      xmlTokenStream0.next();
  ...
  public void test12()  throws Throwable  {
      ...
      ReaderConfig readerConfig0 = ReaderConfig.createFullDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      iIOMetadataNode0.setAttributeNS("Mk`#d3(*GjcT`!", "Mk`#d3(*GjcT`!", "Mk`#d3(*GjcT`!");
      IIOMetadataNode iIOMetadataNode1 = new IIOMetadataNode("v,!C|W`~0St|kjG~");
  ...
  public void test13()  throws Throwable  {
      ...
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      iIOMetadataNode0.setAttributeNS("mMk##d3t*GEcT`!", "mMk##d3t*GEcT`!", "mMk##d3t*GEcT`!");
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, wstxDOMWrappingReader0);
      xmlTokenStream0._nextLocalName = "8a46a9";
      xmlTokenStream0.next();
      xmlTokenStream0.convertToString();
      assertFalse(xmlTokenStream0.hasAttributes());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      iIOMetadataNode0.setAttributeNS("sz+r/SmyZ", "sz+r/SmyZ", "sz+r/SmyZ");
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, wstxDOMWrappingReader0);
      xmlTokenStream0._nextNamespaceURI = "sz+r/SmyZ";
      xmlTokenStream0.next();
      xmlTokenStream0.convertToString();
      assertFalse(xmlTokenStream0.hasAttributes());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      ReaderConfig readerConfig0 = ReaderConfig.createFullDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      iIOMetadataNode0.setAttributeNS("/g;X <pjh", "", "U%4YJ");
      wstxDOMWrappingReader0.next();
  ...
  public void test20()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, wstxDOMWrappingReader0);
      xmlTokenStream0._attributeCount = (-2231);
  ...
  public void test21()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, wstxDOMWrappingReader0);
      xmlTokenStream0._repeatElement = (-1178);
      // Undeclared exception!
      try { 
        xmlTokenStream0.next();
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Unrecognized type to repeat: -1178
         //
         verifyException("com.fasterxml.jackson.dataformat.xml.deser.XmlTokenStream", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, dOMSource0);
      xmlTokenStream0._textValue = ")QuP7Oq|^u%";
      String string0 = xmlTokenStream0.getText();
      assertNotNull(string0);
      assertEquals(")QuP7Oq|^u%", string0);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, wstxDOMWrappingReader0);
      xmlTokenStream0._namespaceURI = "ZrG272}2B\"`";
      String string0 = xmlTokenStream0.getNamespaceURI();
      assertNotNull(string0);
      assertEquals("ZrG272}2B\"`", xmlTokenStream0.getNamespaceURI());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      ReaderConfig readerConfig0 = ReaderConfig.createFullDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      iIOMetadataNode0.setAttributeNS("hqW%1.sw*", "': expected Long value.", "hqW%1.sw*");
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, iIOMetadataNode0);
      xmlTokenStream0.next();
      xmlTokenStream0.getLocalName();
  ...
  public void test28()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, iIOMetadataNode0);
      xmlTokenStream0._currentState = (-4555);
  ...
  public void test30()  throws Throwable  {
      ...
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(stax2FilteredStreamReader0, "#=Cr7ZYd#=_U~A<i0gb");
      xmlTokenStream0.repeatStartElement();
      xmlTokenStream0.next();
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      ...
      ReaderConfig readerConfig0 = ReaderConfig.createFullDefaults();
      DOMSource dOMSource0 = new DOMSource(node0, " state=");
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      StreamFilter streamFilter0 = mock(StreamFilter.class, new ViolatedAssumptionAnswer());
  ...
  public void test35()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode();
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "Unrecognized XML directive; expected CDATA or comment ('<![CDATA[' or '<!--').");
      ReaderConfig readerConfig0 = ReaderConfig.createFullDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      Object object0 = new Object();
  ...
  public void test36()  throws Throwable  {
      ...
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      iIOMetadataNode0.setAttributeNS((String) null, "g|", "g|");
      Stax2FilteredStreamReader stax2FilteredStreamReader0 = new Stax2FilteredStreamReader(wstxDOMWrappingReader0, (StreamFilter) null);
  ...
  public void test38()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode();
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0, "G$w?U%=G2[.{E^C");
      ReaderConfig readerConfig0 = ReaderConfig.createFullDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      iIOMetadataNode0.setAttributeNS("G$w?U%=G2[.{E^C", "QP&bg'X~&lw'fah6Fk", "G$w?U%=G2[.{E^C");
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, "QP&bg'X~&lw'fah6Fk");
      xmlTokenStream0.next();
      xmlTokenStream0.next();
      int int0 = xmlTokenStream0.next();
      assertEquals("QP&bg'X~&lw'fah6Fk", xmlTokenStream0.getLocalName());
      assertEquals(2, int0);
  }
  ...
  public void test39()  throws Throwable  {
      ...
      ReaderConfig readerConfig0 = ReaderConfig.createFullDefaults();
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      iIOMetadataNode0.setAttributeNS("RCa/$:K`|W_]P{r", "RCa/$:K`|W_]P{r", "RCa/$:K`|W_]P{r");
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, "RCa/$:K`|W_]P{r");
      xmlTokenStream0.next();
      xmlTokenStream0.convertToString();
      int int0 = xmlTokenStream0.next();
      assertTrue(wstxDOMWrappingReader0.hasName());
  ...
  public void test42()  throws Throwable  {
      ...
      xmlTokenStream1._currentWrapper = elementWrapper2;
      xmlTokenStream1.skipEndElement();
      xmlTokenStream1.skipEndElement();
  ...
  public void test45()  throws Throwable  {
      ...
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, wstxDOMWrappingReader0);
      xmlTokenStream0._currentState = 78;
      int int0 = xmlTokenStream0.next();
      assertEquals(2, int0);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      DOMSource dOMSource0 = new DOMSource(iIOMetadataNode0);
      ReaderConfig readerConfig0 = ReaderConfig.createJ2MEDefaults();
      iIOMetadataNode0.setAttributeNS("|", "|", "4LsD:BE=,z|U.ZY~");
      WstxDOMWrappingReader wstxDOMWrappingReader0 = WstxDOMWrappingReader.createFrom(dOMSource0, readerConfig0);
      wstxDOMWrappingReader0.next();
      XmlTokenStream xmlTokenStream0 = new XmlTokenStream(wstxDOMWrappingReader0, dOMSource0);
      xmlTokenStream0.next();
  ...
  public void test53()  throws Throwable  {
      ...
      xmlTokenStream0.skipAttributes();
      xmlTokenStream0.repeatStartElement();
      assertEquals("': expected Long value.", xmlTokenStream0.getLocalName());
  }
