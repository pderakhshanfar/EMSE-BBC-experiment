...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("1(Ck/P/7X2yyblb4");
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance("'; empty String is not a valid name value", systemId0, stringReader0, (String) null);
      XMLStreamReader2 xMLStreamReader2_0 = wstxInputFactory0.createSR(readerConfig0, "x(L[f2[#!+O%", (InputBootstrapper) readerBootstrapper0, false, true);
      XmlTokenStream xmlTokenStream0 = null;
      try {
