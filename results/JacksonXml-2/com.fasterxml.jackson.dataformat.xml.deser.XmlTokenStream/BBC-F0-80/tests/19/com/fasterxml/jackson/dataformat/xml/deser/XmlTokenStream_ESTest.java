...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance("Current state not XML_START_ELEMENT (1) but ", (SystemId) null, stringReader0, "] repeatElement=");
      XMLStreamReader2 xMLStreamReader2_0 = wstxInputFactory0.createSR(readerConfig0, "XH%A)=^Ri9xJd~gxa ", (InputBootstrapper) readerBootstrapper0, true, true);
      XmlTokenStream xmlTokenStream0 = null;
      try {
