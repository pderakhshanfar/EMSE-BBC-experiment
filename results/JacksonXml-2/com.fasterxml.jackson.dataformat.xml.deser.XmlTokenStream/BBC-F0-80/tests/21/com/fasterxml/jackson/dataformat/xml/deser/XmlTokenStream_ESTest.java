...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      BranchingReaderSource branchingReaderSource0 = new BranchingReaderSource(readerConfig0, " repeat?=", (SystemId) null, stringReader0, false);
      WstxInputFactory wstxInputFactory0 = new WstxInputFactory();
      byte[] byteArray0 = new byte[8];
      StreamBootstrapper streamBootstrapper0 = StreamBootstrapper.getInstance("com.ctc.wstx.util.BaseNsContext", (SystemId) null, byteArray0, 1000, (int) (byte)8);
