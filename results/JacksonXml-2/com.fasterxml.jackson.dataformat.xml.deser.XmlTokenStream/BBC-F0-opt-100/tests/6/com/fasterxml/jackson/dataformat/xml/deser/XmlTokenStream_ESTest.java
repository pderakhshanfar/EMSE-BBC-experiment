...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      SystemId systemId0 = SystemId.construct("9T3h=m? tP'Gq=.t");
      byte[] byteArray0 = new byte[0];
      StreamBootstrapper streamBootstrapper0 = StreamBootstrapper.getInstance("org.codehaus.stax2.closeInputSource", systemId0, byteArray0, 7, 0);
      XMLStreamReader2 xMLStreamReader2_0 = wstxInputFactory0.createSR(readerConfig0, (String) null, (InputBootstrapper) streamBootstrapper0, true, true);
      XmlTokenStream xmlTokenStream0 = null;
      try {
