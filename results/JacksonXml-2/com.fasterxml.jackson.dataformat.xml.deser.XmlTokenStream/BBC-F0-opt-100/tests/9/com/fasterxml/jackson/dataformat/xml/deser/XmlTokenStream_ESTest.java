...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      SystemId systemId0 = SystemId.construct("ih&CKAaiaLf$");
      StringReader stringReader0 = new StringReader("2\"UM");
      BranchingReaderSource branchingReaderSource0 = new BranchingReaderSource(readerConfig0, "[#LP/a Db", systemId0, stringReader0, false);
      WstxInputFactory wstxInputFactory0 = new WstxInputFactory();
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance("{UFHk/4VbzK!5YOj", systemId0, stringReader0, "org.codehaus.stax2.propDtdOverride");
      ...
      XmlTokenStream xmlTokenStream0 = null;
      try {
        xmlTokenStream0 = new XmlTokenStream(validatingStreamReader0, readerConfig0);
