...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      SystemId systemId0 = SystemId.construct("http://java.sun.com/xml/stream/properties/report-cdata-event", (URL) null);
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1897), (byte)0);
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(byteArrayInputStream0, 492);
      StreamBootstrapper streamBootstrapper0 = StreamBootstrapper.getInstance("http://java.sun.com/xml/stream/properties/report-cdata-event", systemId0, (InputStream) pushbackInputStream0);
      ...
      XMLStreamReader xMLStreamReader0 = wstxInputFactory0.createXMLStreamReader("O", reader0);
      XmlTokenStream xmlTokenStream0 = null;
      try {
        xmlTokenStream0 = new XmlTokenStream(xMLStreamReader0, "GEnTv7+B|");
