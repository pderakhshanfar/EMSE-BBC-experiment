...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      SystemId systemId0 = SystemId.construct("TSDi@fJdOu!");
      byte[] byteArray0 = new byte[5];
      StreamBootstrapper streamBootstrapper0 = StreamBootstrapper.getInstance("@[xoOu/yAq{^NZso", systemId0, byteArray0, 0, (-1172));
      XMLStreamReader2 xMLStreamReader2_0 = wstxInputFactory0.createSR(readerConfig0, "n~?u}5%#A", (InputBootstrapper) streamBootstrapper0, true, false);
      XmlTokenStream xmlTokenStream0 = null;
      try {
