...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("com.ctc.wstx.sr.AttributeCollector");
      BranchingReaderSource branchingReaderSource0 = new BranchingReaderSource(readerConfig0, "i", systemId0, stringReader0, false);
      WstxInputFactory wstxInputFactory0 = new WstxInputFactory();
      byte[] byteArray0 = new byte[2];
      StreamBootstrapper streamBootstrapper0 = StreamBootstrapper.getInstance(" name=", systemId0, byteArray0, (-816), (-282));
      ...
      XmlTokenStream xmlTokenStream0 = null;
      try {
        xmlTokenStream0 = new XmlTokenStream(typedStreamReader0, "com.ctc.wstx.sr.AttributeCollector");
