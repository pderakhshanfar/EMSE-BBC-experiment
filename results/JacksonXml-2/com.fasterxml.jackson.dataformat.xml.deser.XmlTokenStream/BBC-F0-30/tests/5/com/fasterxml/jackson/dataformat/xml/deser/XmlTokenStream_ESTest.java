...
public class XmlTokenStream_ESTest extends XmlTokenStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("(;%BvMj6");
      XMLStreamReader xMLStreamReader0 = wstxInputFactory0.createXMLStreamReader("(;%BvMj6", (Reader) stringReader0);
      XmlTokenStream xmlTokenStream0 = null;
      try {
        xmlTokenStream0 = new XmlTokenStream(xMLStreamReader0, "(;%BvMj6");
