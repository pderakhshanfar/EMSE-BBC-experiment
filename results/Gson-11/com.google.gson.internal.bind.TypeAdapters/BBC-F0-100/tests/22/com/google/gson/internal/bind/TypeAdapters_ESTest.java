...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Locale locale0 = gson0.fromJson("UmwxbA)FB", class0);
      assertEquals("umwxba)fb", locale0.getLanguage());
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("kSSA?K");
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"kSSA?K\"
         //
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("[_~BXOdplJ {uSDCY5", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"_~BXOdplJ\"
         //
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("1i8'tSo<qP)T5>Y*-");
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.net.URISyntaxException: Illegal character in path at index 7: 1i8'tSo<qP)T5>Y*-
         //
  ...
  public void test07()  throws Throwable  {
      Gson gson0 = new Gson();
      Double double0 = new Double(48.579);
  ...
  public void test16()  throws Throwable  {
      ...
      jsonObject0.addProperty(",adapter=", (Number) byte0);
      ObjectTypeAdapter objectTypeAdapter0 = new ObjectTypeAdapter(gson0);
  ...
  public void test26()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson(")'_oOTS1GJIjBw$", class0);
      assertEquals(")'_OOTS1GJIJBW$", locale0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("23udR>6k{:**RN", "23udR>6k{:**RN");
  ...
  public void test38()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("WnW,a%*B", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: WnW
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test45()  throws Throwable  {
      ...
      String string0 = gson0.fromJson("cU4LglUCG|dd-", class0);
      assertEquals("cU4LglUCG|dd-", string0);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("irB=$Z93", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"irB\"
         //
  ...
  public void test60()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("1,1-ee7{;", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test66()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("]bYW+NFXn1+yeW~e-");
      // Undeclared exception!
      try { 
        gson0.fromJson((JsonElement) jsonPrimitive0, (Type) class0);
  ...
  public void test69()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("G^Xp^.fjnVv{3", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"G^Xp^.fjnVv\"
         //
  ...
  public void test71()  throws Throwable  {
      ...
      try { 
        gson0.fromJson(".DDlz_Kee2-", class0);
        fail("Expecting exception: RuntimeException");
