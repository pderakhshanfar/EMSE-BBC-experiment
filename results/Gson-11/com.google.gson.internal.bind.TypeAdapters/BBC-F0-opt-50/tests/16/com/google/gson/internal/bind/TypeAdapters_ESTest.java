...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("`E'm$8YtaJn'yj*njp", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 0: `E'm$8YtaJn'yj*njp
         //
  ...
  public void test09()  throws Throwable  {
      ...
      Double double0 = new Double(474.57);
  ...
  public void test11()  throws Throwable  {
      ...
      Float float0 = new Float(2370.625F);
  ...
  public void test15()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("1[7!|'O");
      Class<JsonNull> class0 = JsonNull.class;
      try { 
        gson0.fromJson((Reader) stringReader0, class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test23()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // org.evosuite.runtime.mock.java.lang.MockThrowable: Expected BEGIN_OBJECT but was BEGIN_ARRAY at line 1 column 3 path $
         //
  ...
  public void test24()  throws Throwable  {
      Gson gson0 = new Gson();
      ObjectTypeAdapter objectTypeAdapter0 = new ObjectTypeAdapter(gson0);
      UUID uUID0 = MockUUID.fromString("iX%CS<gx23W_Kxqt:");
  ...
  public void test29()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<InetAddress> class0 = InetAddress.class;
      InetAddress inetAddress0 = gson0.fromJson("<wWF$Fvp.?$", class0);
      assertEquals("<wWF$Fvp.?$/200.42.42.0", inetAddress0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("^!nW>eoPH~", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: ^!nW>eoPH~
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test38()  throws Throwable  {
      ...
      Class<StringBuffer> class0 = StringBuffer.class;
      try { 
        gson0.fromJson("xC&)7Y~Gv[BS3@XIN=", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test49()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("[$lEJcT?Y9", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"$lEJcT?Y9\"
         //
  ...
  public void test51()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("7WdM");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"7WdM\"
         //
  ...
  public void test53()  throws Throwable  {
      ...
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson("Z:^bBB:RP", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test56()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("0 YW!B`Bp_G", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test58()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("30M\"e/a.S", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test59()  throws Throwable  {
      ...
      assertEquals("[0,1,0,0,0,1,0,1]", string0);
  }
  ...
  public void test73()  throws Throwable  {
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=-742,MONTH=-742,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=-742,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
  }
}
