...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      ArrayTypeAdapter<Short> arrayTypeAdapter0 = new ArrayTypeAdapter<Short>(gson0, reflectiveTypeAdapterFactory_Adapter0, class2);
  ...
  public void test05()  throws Throwable  {
      HashMap<String, ReflectiveTypeAdapterFactory.BoundField> hashMap0 = new HashMap<String, ReflectiveTypeAdapterFactory.BoundField>();
      Gson gson0 = new Gson();
      JsonObject jsonObject0 = (JsonObject)gson0.toJsonTree((Object) hashMap0);
      Float float0 = new Float(1.0F);
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(float0);
      jsonObject0.add("@pD%&", jsonPrimitive0);
  ...
  public void test11()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-263), 12, 13);
      JsonElement jsonElement0 = gson0.toJsonTree((Object) mockGregorianCalendar0);
      treeTypeAdapter0.fromJsonTree(jsonElement0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=-263,MONTH=12,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=13,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Locale locale0 = gson0.fromJson("xgd0OcI$_XxfzWC", class0);
      assertEquals("xgd0oci$_XXFZWC", locale0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Class<Locale> class0 = Locale.class;
      try { 
        gson0.fromJson("qHon]{p>GU", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test21()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("\"e_~7#:~s#gM", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test24()  throws Throwable  {
      ...
      Class<InetAddress> class0 = InetAddress.class;
      try { 
        gson0.fromJson("WsI3qpXK,yz:j", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test35()  throws Throwable  {
      ...
      Class<StringBuilder> class0 = StringBuilder.class;
      try { 
        gson0.fromJson("!;m^zBgBzX9K).,)", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test42()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Character> class0 = Character.class;
      StringReader stringReader0 = new StringReader("1F=pMB!aE");
      stringReader0.read();
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test44()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("*Igu4ogy)Yy_#wiJP");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"*Igu4ogy)Yy_\"
         //
  ...
  public void test45()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicIntegerArray atomicIntegerArray0 = new AtomicIntegerArray(2306);
      ...
      assertEquals(2306, atomicIntegerArray1.length());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"qHon\"
         //
  ...
  public void test54()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("Epeting c*asa(te, got: ");
