...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Vs&v|oL=+4*");
      Gson gson0 = new Gson();
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"Vs&v|oL\"
         //
  ...
  public void test07()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Ycg/q`hl[j6h|-");
  ...
  public void test12()  throws Throwable  {
      ...
      jsonObject0.addProperty("K3-uvC6T", (Number) atomicInteger0);
  ...
  public void test13()  throws Throwable  {
      Gson gson0 = new Gson();
      MockFileWriter mockFileWriter0 = new MockFileWriter("8CP~`!H<c'x[g_{", false);
  ...
  public void test21()  throws Throwable  {
      ...
      Class<Calendar> class0 = Calendar.class;
      Calendar calendar0 = gson0.fromJson((JsonElement) jsonObject0, class0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=0,MONTH=0,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=0,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=136,HOUR_OF_DAY=136,MINUTE=0,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Class<Calendar> class0 = Calendar.class;
      Calendar calendar0 = gson0.fromJson((JsonElement) jsonObject0, class0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=-1759,MONTH=0,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=0,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      Gson gson0 = new Gson();
      InetAddress inetAddress0 = MockInetAddress.getByName("8CP~`!H<c'x[g_{");
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("Av<m(yh,,XoI`Plhk/M");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.net.URISyntaxException: Illegal character in path at index 2: Av<m(yh
         //
  ...
  public void test37()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("j7d%=voEeUzcf+#e");
      Class<URL> class0 = URL.class;
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.net.MalformedURLException: no protocol: j7d%=voEeUzcf+#e
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test40()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuffer> class0 = StringBuffer.class;
      StringBuffer stringBuffer0 = gson0.fromJson("com.google.gson.stream.MalformedJsonExceptiJn", class0);
  ...
  public void test43()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("PX}", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test46()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("?Ul1K3mDFO '!)T|9", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: ?Ul1K3mDFO
         //
  ...
  public void test48()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("5#5PC[l$o%6mW", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test51()  throws Throwable  {
      AtomicIntegerArray atomicIntegerArray0 = new AtomicIntegerArray(507);
      Gson gson0 = new Gson();
      ...
      assertEquals(507, atomicIntegerArray1.length());
  }
  ...
  public void test55()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"?Ul1K3mDFO\"
         //
  ...
  public void test58()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("KMR/AO,xE", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test61()  throws Throwable  {
      ...
      StringBuilder stringBuilder0 = new StringBuilder(".]P{d=@= jD6G");
  ...
  public void test65()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("This is not a JSON Null.", (Type) class1);
  ...
  public void test67()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicInteger atomicInteger0 = new AtomicInteger((-1093146254));
  ...
  public void test68()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("z1gu=6zLzO!*|21L{", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"z1gu\"
         //
  ...
  public void test70()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("8CP~`!H<c'x[g_{");
