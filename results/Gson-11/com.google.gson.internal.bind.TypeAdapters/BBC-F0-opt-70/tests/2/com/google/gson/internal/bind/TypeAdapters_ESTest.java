...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("0=2", (Type) class0);
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Oa25^fEWi(", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 4: Oa25^fEWi(
         //
  ...
  public void test15()  throws Throwable  {
      ...
      Float float0 = new Float((-1561.8496419870905));
      String string0 = treeTypeAdapter0.toJson((Object) float0);
  ...
  public void test16()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("0,X!v'13G4", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test18()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("L@nAC:a");
  ...
  public void test20()  throws Throwable  {
      ...
      TypeAdapterRuntimeTypeWrapper<Calendar> typeAdapterRuntimeTypeWrapper0 = new TypeAdapterRuntimeTypeWrapper<Calendar>(gson0, typeAdapter0, class0);
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(1380, (-2096443640), 44);
      typeAdapterRuntimeTypeWrapper0.toJsonTree(mockGregorianCalendar0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=-5513246098790400000,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=0,YEAR=174702258,MONTH=5,WEEK_OF_YEAR=24,WEEK_OF_MONTH=3,DAY_OF_MONTH=13,DAY_OF_YEAR=164,DAY_OF_WEEK=3,DAY_OF_WEEK_IN_MONTH=2,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=0,ZONE_OFFSET=0,DST_OFFSET=0]", mockGregorianCalendar0.toString());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Class<UUID> class0 = UUID.class;
      try { 
        gson0.fromJson("&/~^J'TR=gTir7$h@", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test28()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("w-Q!YI-}zGPe&_", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test31()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Oa25^fEWi(/");
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.net.MalformedURLException: no protocol: Oa25^fEWi(
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test34()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("69:@_Two]<@hw");
      Class<StringBuffer> class0 = StringBuffer.class;
      StringBuffer stringBuffer0 = gson0.fromJson((JsonElement) jsonPrimitive0, class0);
      assertEquals("69:@_Two]<@hw", stringBuffer0.toString());
  }
  ...
  public void test37()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("[4i4");
      Class<StringBuilder> class0 = StringBuilder.class;
      TypeToken<StringBuilder> typeToken0 = TypeToken.get(class0);
      Class<? super StringBuilder> class1 = typeToken0.getRawType();
      try { 
  ...
  public void test45()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Long> class0 = Long.class;
      StringReader stringReader0 = new StringReader("36%6na.~v?xB.n'EigU");
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"36%6na.~v?xB.n'EigU\"
         //
  ...
  public void test50()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("$sE|4Nw/jB9]");
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"$sE|4Nw\"
         //
  ...
  public void test52()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("dRIC@<rJD");
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"dRIC@<rJD\"
         //
  ...
  public void test56()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("{[ELlUqZq9P", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test64()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"Oa25^fEWi(\"
         //
