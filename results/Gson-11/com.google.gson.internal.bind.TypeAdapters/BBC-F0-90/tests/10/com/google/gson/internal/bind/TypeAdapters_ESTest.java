...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("QxN", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"QxN\"
         //
  ...
  public void test03()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("h&R5{");
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      jsonObject0.addProperty("@98n~AtC-'WfFB", (Number) null);
  ...
  public void test19()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicIntegerArray atomicIntegerArray0 = new AtomicIntegerArray(1089);
      ...
      assertEquals(1089, jsonArray0.size());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Type type0 = typeToken0.getType();
      try { 
        gson0.fromJson("BX_@H#NFP}%M", type0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test24()  throws Throwable  {
      ...
      Type type0 = typeToken0.getType();
      try { 
        gson0.fromJson("yHSnq7B{d4q", type0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test27()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Calendar> class0 = Calendar.class;
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(10, 10, 10, 5, 723);
      gson0.toJsonTree((Object) mockGregorianCalendar0, (Type) class0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=-61824668220000,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=10,MONTH=10,WEEK_OF_YEAR=46,WEEK_OF_MONTH=3,DAY_OF_MONTH=10,DAY_OF_YEAR=314,DAY_OF_WEEK=2,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=5,HOUR_OF_DAY=17,MINUTE=3,SECOND=0,MILLISECOND=0,ZONE_OFFSET=0,DST_OFFSET=0]", mockGregorianCalendar0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Calendar> class0 = Calendar.class;
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(111, 111, 111, 4774, 4774);
  ...
  public void test32()  throws Throwable  {
      Gson gson0 = new Gson();
      UUID uUID0 = MockUUID.fromString("02z/@'<PL0]ef@+[");
  ...
  public void test34()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<UUID> class0 = UUID.class;
      UUID uUID0 = gson0.fromJson("Ac4Y", class0);
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("<x9w0<", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 0: <x9w0<
         //
  ...
  public void test42()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("<x9w0<");
      Class<URL> class0 = URL.class;
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.net.MalformedURLException: no protocol: <x9w0<
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test50()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuilder> class0 = StringBuilder.class;
      StringBuilder stringBuilder0 = gson0.fromJson("k$%r", class0);
      assertEquals("k$%r", stringBuilder0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      try { 
        gson0.fromJson("02z/@'<PL0]ef@+[", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test57()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("m=rmWcBRyOM=;C>7W", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test59()  throws Throwable  {
      ...
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson("yHSnq7B{d4q", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"yHSnq7B\"
         //
  ...
  public void test61()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson("XO)#c|#mS_", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"XO)\"
         //
  ...
  public void test65()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("8 }f_>~MY", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test66()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("[Gs6;eTRz)DL2UAy", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test71()  throws Throwable  {
      ...
      Class<BitSet> class0 = BitSet.class;
      try { 
        gson0.fromJson("uq$e-o^(p!}", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test76()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Bc0`a %rZAU&5JXkS", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"Bc0`a\"
         //
