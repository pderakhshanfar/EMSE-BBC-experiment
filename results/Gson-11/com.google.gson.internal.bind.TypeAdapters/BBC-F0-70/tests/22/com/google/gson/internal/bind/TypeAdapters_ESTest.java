...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("1 A\u0006,@N&{?C.z;\"+u", class0);
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("V4<W-1:Esl{", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 2: V4<W-1
         //
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("-TPrj{w$xXOiv;;");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"-TPrj\"
         //
  ...
  public void test16()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson("a_<@R$?>", class0);
      assertEquals("a_<@R$?>", locale0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("olXod0");
  ...
  public void test20()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      TypeAdapterRuntimeTypeWrapper<Calendar> typeAdapterRuntimeTypeWrapper0 = new TypeAdapterRuntimeTypeWrapper<Calendar>(gson0, typeAdapter0, class0);
      MockFile mockFile0 = new MockFile(")>npb+3K");
  ...
  public void test25()  throws Throwable  {
      Gson gson0 = new Gson();
      InetAddress inetAddress0 = MockInetAddress.getByName("FV*FA'_3y4TU9SfoLM");
  ...
  public void test27()  throws Throwable  {
      ...
      Class<InetAddress> class0 = InetAddress.class;
      try { 
        gson0.fromJson("Y;smD&(h$=]wR", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test31()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("`bkS]7pyv),T)({", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: `bkS
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test33()  throws Throwable  {
      Gson gson0 = new Gson();
      StringBuffer stringBuffer0 = new StringBuffer("/lV6=>`P-{X~Rw.");
  ...
  public void test37()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-2), (-2), 229, 3739, 229, 2484);
  ...
  public void test41()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("FV*FA'_3y4TU9SfoLM");
      JsonReader jsonReader0 = gson0.newJsonReader(stringReader0);
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson(jsonReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Expecting character, got: FV*FA'_3y4TU9SfoLM
         //
  ...
  public void test49()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("Wx%XRWzD)[:k");
      JsonReader jsonReader0 = gson0.newJsonReader(stringReader0);
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson(jsonReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"Wx%XRWzD)\"
         //
  ...
  public void test59()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicInteger atomicInteger0 = new AtomicInteger((-2679));
  ...
  public void test68()  throws Throwable  {
      ...
      TypeAdapterFactory typeAdapterFactory1 = TypeAdapters.newFactoryForMultipleTypes(class2, (Class<? extends AtomicBoolean>) class2, (TypeAdapter<? super AtomicBoolean>) typeAdapter1);
      assertFalse(typeAdapterFactory1.equals((Object)typeAdapterFactory0));
  }
