...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("-o6W?~N}^;|(", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"-o6W?~N\"
         //
  ...
  public void test08()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("-o6W?~NH}^;|(", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"-o6W?~NH\"
         //
  ...
  public void test14()  throws Throwable  {
      ...
      Class<JsonNull> class0 = JsonNull.class;
      try { 
        gson0.fromJson("czZ[O<w{#LvPUL", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test15()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.io.EOFException: End of input at line 1 column 4 path $[0].h
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Class<UUID> class0 = UUID.class;
      try { 
        gson0.fromJson("&x|;{& tU", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("_<A1@ro)", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 1: _<A1@ro)
         //
  ...
  public void test33()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("hSw'Xl^*.QP[*M_c%", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: hSw'Xl^*.QP
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test35()  throws Throwable  {
      Gson gson0 = new Gson();
      StringBuffer stringBuffer0 = new StringBuffer("*T<)l_ggR#u");
  ...
  public void test37()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("q@/l ^=wyRatN85%", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test44()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Expecting character, got: Unable
         //
  ...
  public void test46()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("S[y5", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test49()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("N*B4^:J0", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"N*B4^\"
         //
  ...
  public void test52()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("6#wIU12o|BSF-4ovy'#", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test59()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("_<A1@ro)");
  ...
  public void test65()  throws Throwable  {
      Gson gson0 = new Gson();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(8, "com.google.gson.internal.bind.TypeAdapters$26$1");
  ...
  public void test71()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(2054, 2054, 2054, 4984, 4984, 264);
      JsonElement jsonElement0 = gson0.toJsonTree((Object) mockGregorianCalendar0);
      Class<Calendar> class0 = Calendar.class;
      try { 
        gson0.fromJson(jsonElement0, class0);
