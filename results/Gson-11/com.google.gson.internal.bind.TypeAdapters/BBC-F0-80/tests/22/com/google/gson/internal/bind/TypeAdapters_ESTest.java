...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("g@RD9RX4v`Xj:xm3K", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"g@RD9RX4v`Xj\"
         //
  ...
  public void test15()  throws Throwable  {
      ...
      Class<JsonNull> class0 = JsonNull.class;
      try { 
        gson0.fromJson("bXtc0mZ%6", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test21()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson("__hS2yu(", class0);
      assertEquals("hs2yu(", locale0.getLanguage());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // org.evosuite.runtime.mock.java.lang.MockThrowable: Expected NUMBER but was NULL at path $.H 
         //
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("2n'|,{(*F%8}0fGTQ[4", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 3: 2n'|
         //
  ...
  public void test38()  throws Throwable  {
      ...
      try { 
        gson0.fromJson(".!>yDYQ{!t#E8++P;", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: .!>yDYQ
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test42()  throws Throwable  {
      ...
      Class<? super StringBuffer> class1 = typeToken0.getRawType();
      try { 
        gson0.fromJson("8.3xxBoDA=8xb.R/e,5", (Type) class1);
        fail("Expecting exception: RuntimeException");
  ...
  public void test45()  throws Throwable  {
      ...
      Class<StringBuilder> class0 = StringBuilder.class;
      try { 
        gson0.fromJson("(k2}\ti6$V=", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test47()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("HP-lvB$yV~*vd`v");
      Class<String> class0 = String.class;
      String string0 = gson0.fromJson((Reader) stringReader0, class0);
      assertEquals("HP-lvB$yV~*vd`v", string0);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson(" R[Wg&j.%It#?9heTJ", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test54()  throws Throwable  {
      ...
      try { 
        gson0.fromJson(">lba.", type0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \">lba.\"
         //
  ...
  public void test55()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicIntegerArray atomicIntegerArray0 = new AtomicIntegerArray(983);
  ...
  public void test56()  throws Throwable  {
      ...
      assertEquals("[107]", atomicIntegerArray0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("P|D*", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"P|D*\"
         //
  ...
  public void test60()  throws Throwable  {
      ...
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson("HZ/J9XTI^p", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"HZ\"
         //
  ...
  public void test63()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("v+]K!YM", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test71()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("65`8{", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"65`8\"
         //
  ...
  public void test73()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("uQ*+BSQJvs", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test75()  throws Throwable  {
      Gson gson0 = new Gson();
      String string0 = gson0.toJson((Object) "com.google.gson.internal.bind.TypeAdapters$24");
