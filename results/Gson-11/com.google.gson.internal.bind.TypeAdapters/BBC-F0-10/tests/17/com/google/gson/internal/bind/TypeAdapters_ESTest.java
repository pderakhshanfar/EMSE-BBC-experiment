...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("$u@NyVkUOG4&Rqi'$");
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"$u@NyVkUOG4&Rqi'$\"
         //
  ...
  public void test07()  throws Throwable  {
      ...
      Float float0 = new Float(2213.44222945468);
  ...
  public void test08()  throws Throwable  {
      ...
      JsonPrimitive jsonPrimitive0 = gson0.fromJson("P6b9", class0);
  ...
  public void test21()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("END_]ROBJECT");
      Class<Locale> class0 = Locale.class;
      try { 
        gson0.fromJson((Reader) stringReader0, class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test23()  throws Throwable  {
      ...
      MockFileWriter mockFileWriter0 = new MockFileWriter("=G!lnFYeW?w^", false);
  ...
  public void test26()  throws Throwable  {
      Gson gson0 = new Gson();
      UUID uUID0 = MockUUID.fromString("\f");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("A(f&^}SGc[", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 4: A(f&^
         //
  ...
  public void test39()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("HfeC3*", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: HfeC3*
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test40()  throws Throwable  {
      StringBuffer stringBuffer0 = new StringBuffer(8233);
      Gson gson0 = new Gson();
  ...
  public void test46()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("K/\"tx7e}K-6{`R#w1", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test51()  throws Throwable  {
      ...
      try { 
        gson0.fromJson(">35tEYYy3FlO;", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: >35tEYYy3FlO
         //
  ...
  public void test53()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("Q[46hRx12{w-<_", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test58()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson("Ev=[-Sr+x", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"Ev\"
         //
  ...
  public void test62()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("4,&wY2]IN%3qz8{", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test66()  throws Throwable  {
      ...
      assertEquals(1092, jsonArray0.size());
  }
  ...
  public void test72()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicInteger atomicInteger0 = new AtomicInteger(1120);
  ...
  public void test77()  throws Throwable  {
      Gson gson0 = new Gson();
      Locale locale0 = new Locale("q]5n)50Dua_J");
