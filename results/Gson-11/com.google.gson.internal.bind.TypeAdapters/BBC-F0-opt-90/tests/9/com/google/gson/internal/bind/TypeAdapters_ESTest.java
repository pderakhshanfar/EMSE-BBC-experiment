...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      TypeAdapter<StringBuffer> typeAdapter0 = gson0.getAdapter(class2);
  ...
  public void test03()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("[z#8O", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("w4euB%_", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Malformed escape pair at index 5: w4euB%_
         //
  ...
  public void test07()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<JsonPrimitive> class0 = JsonPrimitive.class;
      JsonPrimitive jsonPrimitive0 = gson0.fromJson("1I%2", class0);
  ...
  public void test10()  throws Throwable  {
      ...
      Class<InetAddress> class0 = InetAddress.class;
      try { 
        gson0.fromJson("*sJ:Z", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("u0#`Bp#b-\"=l:", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test20()  throws Throwable  {
      ...
      Class<Locale> class0 = Locale.class;
      try { 
        gson0.fromJson("zd-|_>FYK6#", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test22()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("_QfQ}am!G", type0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test32()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<URI> class0 = URI.class;
      MockFile mockFile0 = new MockFile("\"Y 3h3`wa");
  ...
  public void test38()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("uH`NR$\r+KVKC%&!uG<", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: uH`NR$
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test47()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("t_O<W/x);k", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test48()  throws Throwable  {
      ...
      MockFileWriter mockFileWriter0 = new MockFileWriter("com.google.gson.internal.UnsafeAllocator$1", false);
  ...
  public void test50()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("GDLQY.)N74X6_", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: GDLQY.)N74X6_
         //
  ...
  public void test52()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("x[P]~, M{EU", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test57()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson("@@:Vxwu5J_w", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test59()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("zdu__i>EK6#", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"zdu__i>EK6\"
         //
  ...
  public void test61()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("6,i4$'-MDMgWMus>A. ", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test62()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("[czIT'^8Kst0/", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test73()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("m$'(3:Y%", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"m$'(3\"
         //
  ...
  public void test77()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<JsonPrimitive> class0 = JsonPrimitive.class;
      JsonPrimitive jsonPrimitive0 = gson0.fromJson("3", class0);
      JsonPrimitive jsonPrimitive1 = (JsonPrimitive)gson0.toJsonTree((Object) jsonPrimitive0);
