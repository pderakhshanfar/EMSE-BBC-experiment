...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Gson gson0 = new Gson();
      ObjectTypeAdapter objectTypeAdapter0 = new ObjectTypeAdapter(gson0);
      AtomicInteger atomicInteger0 = new AtomicInteger(281);
  ...
  public void test06()  throws Throwable  {
      ...
      TreeTypeAdapter<Float> treeTypeAdapter0 = new TreeTypeAdapter<Float>(jsonSerializer0, jsonDeserializer0, gson0, typeToken0, (TypeAdapterFactory) null);
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(2, 6, 9, 3675, 10, 10);
  ...
  public void test07()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("f.#T;*XvQ=td5l");
  ...
  public void test08()  throws Throwable  {
      ...
      TypeAdapterFactory typeAdapterFactory0 = TypeAdapters.newFactory(class0, (TypeAdapter<UUID>) typeAdapterRuntimeTypeWrapper0);
      JsonSerializer<Float> jsonSerializer0 = (JsonSerializer<Float>) mock(JsonSerializer.class, new ViolatedAssumptionAnswer());
      JsonDeserializer<Float> jsonDeserializer0 = (JsonDeserializer<Float>) mock(JsonDeserializer.class, new ViolatedAssumptionAnswer());
      Class<Float> class1 = Float.class;
      TypeToken<Float> typeToken0 = TypeToken.get(class1);
  ...
  public void test14()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson("_KP^)DG9-", class0);
      assertEquals("kp^)dg9-", locale0.getLanguage());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("J/Qo _H-;)hT\"z&7Ww^", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test27()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("N|wq", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 1: N|wq
         //
  ...
  public void test29()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("PZmSQ>:lJ", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: PZmSQ>
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test32()  throws Throwable  {
      ...
      Type type0 = typeToken0.getType();
      try { 
        gson0.fromJson("Failed to invoke ", type0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test33()  throws Throwable  {
      Gson gson0 = new Gson();
      ObjectTypeAdapter objectTypeAdapter0 = new ObjectTypeAdapter(gson0);
      StringBuilder stringBuilder0 = new StringBuilder(1845);
  ...
  public void test35()  throws Throwable  {
      ...
      Class<StringBuilder> class0 = StringBuilder.class;
      try { 
        gson0.fromJson("f nZnD%X", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test36()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("(Yfr-^3d[;~D,", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test38()  throws Throwable  {
      Gson gson0 = new Gson();
      Boolean boolean0 = new Boolean("iG-TauWspy@FP");
  ...
  public void test41()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("4J/o _H--)hT\"z&7Ww^", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: 4J
         //
  ...
  public void test50()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("5QYJ\"", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"5QYJ\"\"
         //
  ...
  public void test52()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("_4mFog:MUpJNx%iq", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"_4mFog\"
         //
  ...
  public void test71()  throws Throwable  {
      Gson gson0 = new Gson();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2478), "\"file:///tmp/foo.bar\"");
