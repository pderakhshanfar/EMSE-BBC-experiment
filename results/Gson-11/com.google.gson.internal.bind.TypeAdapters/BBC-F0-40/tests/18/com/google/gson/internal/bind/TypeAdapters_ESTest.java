...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("1[*U<|%[2H9+l|", (Type) class0);
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Wbyq:Q|G#AN", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test07()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("\"xs|~a+14dE");
  ...
  public void test11()  throws Throwable  {
      ...
      Float float0 = new Float((-3198.4336F));
      jsonObject0.addProperty("null", (Number) float0);
      Gson gson0 = new Gson();
  ...
  public void test15()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicInteger atomicInteger0 = new AtomicInteger((-3312));
  ...
  public void test19()  throws Throwable  {
      ...
      Type type0 = typeToken0.getType();
      try { 
        gson0.fromJson("AxC+'_:gQ\"L=ToA/hls", type0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test26()  throws Throwable  {
      Class<InetAddress> class0 = InetAddress.class;
      Gson gson0 = new Gson();
      MockFile mockFile0 = new MockFile("O#", "Ck+=");
  ...
  public void test29()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<InetAddress> class0 = InetAddress.class;
      Inet4Address inet4Address0 = (Inet4Address)gson0.fromJson("1txg", class0);
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("Goe1>~LV", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 4: Goe1>~LV
         //
  ...
  public void test33()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Z;o @]Q~Yt", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test47()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("$H-mg<f8H.5 1", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"$H-mg<f8H.5\"
         //
  ...
  public void test51()  throws Throwable  {
      ...
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson("uESnc(C]nfO[xq", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"uESnc(C\"
         //
  ...
  public void test61()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonArray jsonArray0 = new JsonArray();
      Boolean boolean0 = new Boolean("0z`'aFv^l_p");
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(boolean0);
      jsonArray0.add((JsonElement) jsonPrimitive0);
      Class<BitSet> class0 = BitSet.class;
      BitSet bitSet0 = gson0.fromJson((JsonElement) jsonArray0, class0);
  ...
  public void test63()  throws Throwable  {
      AtomicIntegerArray atomicIntegerArray0 = new AtomicIntegerArray(3526);
      Gson gson0 = new Gson();
  ...
  public void test69()  throws Throwable  {
      ...
      try { 
        gson0.fromJson(".)6qW*G", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \".)6qW*G\"
         //
  ...
  public void test71()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("2?}R*m/911>(L", (Type) class0);
        fail("Expecting exception: RuntimeException");
