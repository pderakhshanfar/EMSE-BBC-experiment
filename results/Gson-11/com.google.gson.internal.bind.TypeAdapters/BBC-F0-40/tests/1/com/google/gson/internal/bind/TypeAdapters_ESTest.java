...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      TypeAdapterFactory typeAdapterFactory0 = TypeAdapters.newFactoryForMultipleTypes(class0, (Class<? extends BitSet>) null, (TypeAdapter<? super BitSet>) objectTypeAdapter0);
  ...
  public void test03()  throws Throwable  {
      ...
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("Q0shM[):E");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.net.URISyntaxException: Illegal character in scheme name at index 5: Q0shM[):E
         //
  ...
  public void test23()  throws Throwable  {
      ...
      TypeAdapterRuntimeTypeWrapper<Calendar> typeAdapterRuntimeTypeWrapper0 = new TypeAdapterRuntimeTypeWrapper<Calendar>(gson0, typeAdapter0, class0);
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(257, 257, 257, 47, 10, (-369));
      typeAdapterRuntimeTypeWrapper0.toJsonTree(mockGregorianCalendar0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=-53359001769000,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=279,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=13,DAY_OF_YEAR=44,DAY_OF_WEEK=5,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=11,HOUR_OF_DAY=23,MINUTE=3,SECOND=51,MILLISECOND=0,ZONE_OFFSET=0,DST_OFFSET=0]", mockGregorianCalendar0.toString());
  }
  ...
  public void test26()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<UUID> class0 = UUID.class;
      UUID uUID0 = gson0.fromJson("com.google.gson.JsonElement", class0);
  ...
  public void test27()  throws Throwable  {
      Class<InetAddress> class0 = InetAddress.class;
      Gson gson0 = new Gson();
      MockPrintStream mockPrintStream0 = new MockPrintStream("monF*th");
  ...
  public void test32()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("&>k4Vq0qJ~8Ws", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: &>k4Vq0qJ~8Ws
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test35()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuffer> class0 = StringBuffer.class;
      StringBuffer stringBuffer0 = gson0.fromJson("java.util.concurrent.atomic.AtomicBoolean", class0);
  ...
  public void test39()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      try { 
        gson0.fromJson("s1pyIL:T`3n", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test44()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("K Z2nMA86gDS{nH:z(", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test50()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.class;
      try { 
        gson0.fromJson("Expected nul3 but was ", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test56()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("L^i%2:y\"}lF~d.'um", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test62()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Ms=-;03t!", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"Ms\"
         //
  ...
  public void test66()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("x[8c{cWSLod_");
  ...
  public void test70()  throws Throwable  {
      Gson gson0 = new Gson();
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter("Expected nul3 but was ");
      mockPrintWriter0.println((Object) gson0);
      assertTrue(gson0.htmlSafe());
  }
  ...
  public void test71()  throws Throwable  {
      Gson gson0 = new Gson();
      TimeZone timeZone0 = TimeZone.getTimeZone("'o+SZEN*.Tf2vF");
      Locale locale0 = Locale.GERMANY;
