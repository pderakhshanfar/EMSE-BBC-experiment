...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("QJ3)Mqd6Rn/*xjL@S", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"QJ3)Mqd6Rn\"
         //
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("8<NJ(F\"6M2{Zz", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 1: 8<NJ(F\"6M2
         //
  ...
  public void test06()  throws Throwable  {
      ...
      TypeAdapter<JsonPrimitive> typeAdapter1 = gson0.getDelegateAdapter(typeAdapterFactory0, typeToken0);
      TypeAdapterFactory typeAdapterFactory1 = TypeAdapters.newFactory(class1, class1, (TypeAdapter<? super JsonPrimitive>) typeAdapter1);
      assertFalse(typeAdapterFactory1.equals((Object)typeAdapterFactory0));
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("D]GAA]s&j4J6", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test21()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("ky[*3luL", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test26()  throws Throwable  {
      ...
      Class<Calendar> class0 = Calendar.class;
      Calendar calendar0 = gson0.fromJson((JsonElement) jsonObject0, class0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=0,MONTH=1425,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=0,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      jsonObject0.addProperty("eDOokgi*z s@ZM+7s5", (Number) double0);
      Class<Calendar> class0 = Calendar.class;
      Calendar calendar0 = gson0.fromJson((JsonElement) jsonObject0, class0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=0,MONTH=0,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=0,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", calendar0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<InetAddress> class0 = InetAddress.class;
      MockFile mockFile0 = new MockFile(")%9%t", "com.google.gson.internal.bind.TypeAdapters");
  ...
  public void test36()  throws Throwable  {
      Gson gson0 = new Gson();
      MockFile mockFile0 = new MockFile("f_!fxE{EY");
  ...
  public void test38()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson(".-sp} v", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: .-sp
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test42()  throws Throwable  {
      ...
      Class<StringBuffer> class0 = StringBuffer.class;
      try { 
        gson0.fromJson("QB)\u0004s-%2P,pV", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test57()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("lRYS%s`(aQyUp=", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"lRYS%s`(aQyUp\"
         //
  ...
  public void test62()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("2z]W}X", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test64()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Error: Expecting: bitset number value (1, 0), Found: T++d
         //
  ...
  public void test65()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("NEYA");
      jsonArray0.add(boolean0);
      Class<BitSet> class0 = BitSet.class;
      gson0.fromJson((JsonElement) jsonArray0, class0);
  ...
  public void test72()  throws Throwable  {
      ...
      try { 
        gson0.fromJson(".gEF#OYx ,YV:STxx", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \".gEF\"
         //
