...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      ...
      Class<Locale> class0 = Locale.class;
      try { 
        gson0.fromJson("ZY_~C\"j]dr.-=o\"%tT", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test17()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson("com.google.gson.internal.bind.TypeAdapters$5", class0);
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("lVuyDCA\".Ln4o", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 7: lVuyDCA\".Ln4o
         //
  ...
  public void test32()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("Zt'-0)f^zLB]9&M", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: Zt'-0)f^zLB
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test42()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("8#*_'=_yH}V", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test44()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("Dw", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: Dw
         //
  ...
  public void test46()  throws Throwable  {
      ...
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson("?61bq|CE6^", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"?61bq|CE6^\"
         //
  ...
  public void test50()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson("ujd^kRt", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"ujd^kRt\"
         //
  ...
  public void test52()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"Zt'-0)f^zLB\"
         //
  ...
  public void test58()  throws Throwable  {
      ...
      assertEquals("[1,1,1,0,1]", string0);
  }
  ...
  public void test63()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("f9 -/?]y!7'k8");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"f9 -/?]y!7'k8\"
         //
  ...
  public void test67()  throws Throwable  {
      Gson gson0 = new Gson();
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("62");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFileOutputStream0, true);
      gson0.toJson((Object) "62", (Appendable) mockPrintStream0);
      assertTrue(gson0.htmlSafe());
  }
