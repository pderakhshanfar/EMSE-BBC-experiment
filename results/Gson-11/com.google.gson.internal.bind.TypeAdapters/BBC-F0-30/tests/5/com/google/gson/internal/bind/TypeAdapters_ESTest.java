...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("+Q<5Bf'.7hun%", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 2: +Q<5Bf'.7hun%
         //
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("^Gi~s", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"^Gi~s\"
         //
  ...
  public void test43()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("h,K<>+$", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test45()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("K7g0LnCYY", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: K7g0LnCYY
         //
  ...
  public void test47()  throws Throwable  {
      ...
      Class<Long> class0 = Long.class;
      try { 
        gson0.fromJson("N/i42NRfHE", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test48()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicIntegerArray atomicIntegerArray0 = new AtomicIntegerArray(361);
      JsonArray jsonArray0 = (JsonArray)gson0.toJsonTree((Object) atomicIntegerArray0);
      assertEquals(361, jsonArray0.size());
  }
  ...
  public void test53()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("1/ \"cAn#r");
  ...
  public void test54()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("o]jYx^", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test58()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      LocalDate localDate0 = MockLocalDate.ofEpochDay((-2864L));
