...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("~3|EJmkxELM}*&");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"~3|EJmkxELM\"
         //
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \")'0rP\"
         //
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("B{!K=ezGL &%bV.vH1;");
      try { 
  ...
  public void test21()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson("_@U3nWw5.", class0);
      assertEquals("@u3nww5.", locale0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("{om.google.gson.internal.bind.T5peAdapters$36", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.io.EOFException: End of input at line 1 column 46 path $.om.google.gson.internal.bind.T5peAdapters$36
         //
  ...
  public void test25()  throws Throwable  {
      ...
      Class<UUID> class0 = UUID.class;
      try { 
        gson0.fromJson("olH(JKbx]DXGS=Y3>", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test29()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("R1`6", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 2: R1`6
         //
  ...
  public void test32()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.net.MalformedURLException: no protocol: ~3|EJmkxELM
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test33()  throws Throwable  {
      Gson gson0 = new Gson();
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "~3|EJmkxELM}*&");
  ...
  public void test35()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuffer> class0 = StringBuffer.class;
      StringBuffer stringBuffer0 = gson0.fromJson("rror", class0);
      assertEquals("rror", stringBuffer0.toString());
  }
  ...
  public void test37()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuilder> class0 = StringBuilder.class;
      StringBuilder stringBuilder0 = gson0.fromJson("3''", class0);
  ...
  public void test40()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("Z\bt?Vg,E\"<wE=rH3w", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: Z\bt?Vg
         //
  ...
  public void test43()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson(" sZ-Bcf1$d&GOdf-4", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"sZ-Bcf1$d&GOdf-4\"
         //
  ...
  public void test47()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("dg7UUDt;WGv&", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"dg7UUDt\"
         //
  ...
  public void test49()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("U|=fNS%i\"+a", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test52()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      Double double0 = new Double(832.466569549255);
  ...
  public void test54()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("~3|EJmkxELM}*&", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test65()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("23Q", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"23Q\"
         //
  ...
  public void test73()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(7, 216, 7, 216, 682, 7);
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=7,MONTH=216,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=7,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=216,HOUR_OF_DAY=216,MINUTE=682,SECOND=7,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
  }
}
