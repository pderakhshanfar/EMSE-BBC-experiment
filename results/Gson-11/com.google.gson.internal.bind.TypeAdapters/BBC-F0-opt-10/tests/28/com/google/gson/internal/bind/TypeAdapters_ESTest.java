...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("closed", (Type) class1);
  ...
  public void test06()  throws Throwable  {
      Gson gson0 = new Gson();
      Float float0 = new Float((-2680.4463217438824));
  ...
  public void test15()  throws Throwable  {
      ...
      Class<Locale> class0 = Locale.class;
      try { 
        gson0.fromJson(".&Z_-{QVw^X4bN", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test19()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson("92ip", class0);
      assertEquals("92ip", locale0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      try { 
        gson0.fromJson(".56TDD_>-Y{3W:V6p:@", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test27()  throws Throwable  {
      ...
      Class<InetAddress> class0 = InetAddress.class;
      try { 
        gson0.fromJson("vX0P>7629{|*{w`+m", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test29()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("+>QPU");
      Class<URI> class0 = URI.class;
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.net.URISyntaxException: Illegal character in path at index 1: +>QPU
         //
  ...
  public void test32()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("i(1gOC8>T$aXKN", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: i(1gOC8>T$aXKN
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test38()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuilder> class0 = StringBuilder.class;
      StringBuilder stringBuilder0 = gson0.fromJson("|PV", class0);
      assertEquals("|PV", stringBuilder0.toString());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      try { 
        gson0.fromJson("bk30*HOL4066yX]", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test47()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("0v{}:f(y1");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"0v\"
         //
  ...
  public void test49()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("3Q: s]cmeTib%A7ym", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"3Q\"
         //
  ...
  public void test51()  throws Throwable  {
      ...
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson("e>_@<7?sox|", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"e>_@<7?sox|\"
         //
  ...
  public void test53()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("7#G1%nN;QlEf(:a'5U!", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test56()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("qu/eN&kMhAQuP+t", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test72()  throws Throwable  {
      Gson gson0 = new Gson();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3032, "");
