...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"ND|uIe\u0003-tz(\"
         //
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("L|>Tz>.jTTYlV", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 1: L|>Tz>.jTTYlV
         //
  ...
  public void test05()  throws Throwable  {
      ...
      ArrayTypeAdapter<StringBuilder> arrayTypeAdapter0 = new ArrayTypeAdapter<StringBuilder>(gson0, typeAdapter0, class1);
      TypeAdapterFactory typeAdapterFactory0 = TypeAdapters.newFactory(class0, class0, (TypeAdapter<? super Byte>) arrayTypeAdapter0);
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("0Pw 5/VMZv}aKM", (Type) class1);
        fail("Expecting exception: RuntimeException");
  ...
  public void test09()  throws Throwable  {
      ...
      Class<Calendar> class0 = Calendar.class;
      try { 
        gson0.fromJson("ZhXK#,9jk5mgO.v", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Not a JSON Object: [java.lang.Long@0000000034,java.lang.Long@0000000035,java.lang.Long@0000000034,java.lang.Long@0000000035]
         //
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("{.mWYr}tuz", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // org.evosuite.runtime.mock.java.lang.MockThrowable: Expected ':' at line 1 column 8 path $..mWYr
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicIntegerArray atomicIntegerArray0 = new AtomicIntegerArray(100);
  ...
  public void test23()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("L_MzvK`S$[L%uofL+O%", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test26()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson("M", class0);
  ...
  public void test28()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(2301, 117, 2301, 81, 81, 117);
      typeAdapterRuntimeTypeWrapper0.toJsonTree(mockGregorianCalendar0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=10951928577000,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2317,MONTH=0,WEEK_OF_YEAR=3,WEEK_OF_MONTH=3,DAY_OF_MONTH=20,DAY_OF_YEAR=20,DAY_OF_WEEK=7,DAY_OF_WEEK_IN_MONTH=3,AM_PM=0,HOUR=10,HOUR_OF_DAY=10,MINUTE=22,SECOND=57,MILLISECOND=0,ZONE_OFFSET=0,DST_OFFSET=0]", mockGregorianCalendar0.toString());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      jsonObject0.addProperty("OQuRuMR%D!mrA'wt", (Number) short0);
      GregorianCalendar gregorianCalendar0 = gson0.fromJson((JsonElement) jsonObject0, class0);
  ...
  public void test31()  throws Throwable  {
      Float float0 = new Float((-2451.5669));
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("dayOfMonth", (Number) float0);
      Gson gson0 = new Gson();
      Class<GregorianCalendar> class0 = GregorianCalendar.class;
      GregorianCalendar gregorianCalendar0 = gson0.fromJson((JsonElement) jsonObject0, class0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=0,MONTH=0,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=-2451,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", gregorianCalendar0.toString());
  }
  ...
  public void test32()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonObject jsonObject0 = new JsonObject();
      Float float0 = new Float(43.66F);
      jsonObject0.addProperty("minute", (Number) float0);
      Class<GregorianCalendar> class0 = GregorianCalendar.class;
      GregorianCalendar gregorianCalendar0 = gson0.fromJson((JsonElement) jsonObject0, class0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=0,MONTH=0,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=0,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=43,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", gregorianCalendar0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      JsonElement jsonElement0 = gson0.toJsonTree(objectArray0[1], (Type) class0);
      assertFalse(jsonElement0.isJsonPrimitive());
  }
  ...
  public void test49()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuffer> class0 = StringBuffer.class;
      StringBuffer stringBuffer0 = gson0.fromJson("ibP&", class0);
  ...
  public void test50()  throws Throwable  {
      Gson gson0 = new Gson();
      StringBuilder stringBuilder0 = new StringBuilder(971);
  ...
  public void test53()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Y>5jK$W v;7-EjADoqT", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test60()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Y/(*[sR7WstAi}F[Uu", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test62()  throws Throwable  {
      ...
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson("!cZJLD)sQ u", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"!cZJLD)sQ\"
         //
  ...
  public void test65()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson("^qeKgUc4Xt#>_Q4<", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"^qeKgUc4Xt\"
         //
  ...
  public void test69()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("l3TO.r\";*KH", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"l3TO.r\"\"
         //
  ...
  public void test70()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("[ZPvJ4`kr%Cf%r0R", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test82()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("Q~@Mx9ohyC");
