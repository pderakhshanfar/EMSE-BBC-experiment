...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("OxxUU*=>", (Type) class0);
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("0='AS", (Type) class1);
        fail("Expecting exception: RuntimeException");
  ...
  public void test03()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("S|1uE%HdJ9sOqW");
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("A`*G{bRM!P;", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 1: A`*G
         //
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("p:G-d8%K6", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("mGk06xpnuA:03S+#", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals(3555, stringBuffer0.length());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      jsonObject0.addProperty("", "(Kbt?v");
      String string0 = gson0.toJson((JsonElement) jsonObject0);
      assertEquals("{\"\":\"(Kbt?v\"}", string0);
  }
  ...
  public void test18()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("i1-D:/%`&%5]I=", "552");
  ...
  public void test22()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("35_E==rf", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test29()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("d m;X8!LjO7", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test33()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<URI> class0 = URI.class;
      MockPrintStream mockPrintStream0 = new MockPrintStream("com.google.gson.internal.bind.TypeAdapters$6");
  ...
  public void test39()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("swvU", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: swvU
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test42()  throws Throwable  {
      ...
      Class<StringBuffer> class0 = StringBuffer.class;
      try { 
        gson0.fromJson("r% P'\"8d:N7", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test46()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      Boolean boolean0 = new Boolean("CJ3hh(+v\"BaiMQZnz");
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(boolean0);
  ...
  public void test51()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("Q;}s$c(=BH8>Q?Q7", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test55()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("1`M0jW*Yj/%^K1s:^");
      JsonReader jsonReader0 = gson0.newJsonReader(stringReader0);
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson(jsonReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"1`M0jW*Yj\"
         //
  ...
  public void test58()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson("Bw3'", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"Bw3'\"
         //
  ...
  public void test62()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("&5Mos0:rI", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test68()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("L-f0/B_tq`Y4", class0);
