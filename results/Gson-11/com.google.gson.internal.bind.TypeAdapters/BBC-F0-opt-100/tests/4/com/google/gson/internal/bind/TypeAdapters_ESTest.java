...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Q_Ggq2W", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"Q_Ggq2W\"
         //
  ...
  public void test10()  throws Throwable  {
      ...
      URI uRI0 = MockURI.URI("hI$2Qqdbw+");
      String string0 = objectTypeAdapter0.toJson((Object) uRI0);
      assertEquals("\"hI$2Qqdbw+\"", string0);
  }
  ...
  public void test19()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson("8!1Gc>hhNH2$f", class0);
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("8!1Gc>hhNH2$f", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 5: 8!1Gc>hhNH2$f
         //
  ...
  public void test33()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("yTzx,FPG", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: yTzx
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test43()  throws Throwable  {
      ...
      Class<Character> class0 = Character.class;
      try { 
        gson0.fromJson("<BNH'.>pEnn1D#@IV", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: <BNH'.>pEnn1D
         //
  ...
  public void test49()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.class;
      try { 
        gson0.fromJson("\"yTdx\"", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"yTdx\"
         //
  ...
  public void test51()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("?,eBIv(,?$");
  ...
  public void test53()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("1,:q", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test56()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("yTzx,FPG", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test58()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("java.lang.Float@0000000027");
  ...
  public void test63()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("9q=", (Type) class1);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"9q\"
         //
  ...
  public void test71()  throws Throwable  {
      Gson gson0 = new Gson();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1895, "~mL;l!5~fQZn8/Ic}");
      Locale locale0 = new Locale("JsonReader is closed");
