...
public class FromXmlParser_ESTest extends FromXmlParser_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      TextNode textNode0 = new TextNode("qe+S]{tg:J2");
      IOContext iOContext0 = new IOContext(bufferRecycler0, textNode0, true);
      ObjectMapper objectMapper0 = new ObjectMapper();
      StreamReaderDelegate streamReaderDelegate0 = new StreamReaderDelegate();
      FromXmlParser fromXmlParser0 = null;
      try {
        fromXmlParser0 = new FromXmlParser(iOContext0, 17, 0, objectMapper0, streamReaderDelegate0);
