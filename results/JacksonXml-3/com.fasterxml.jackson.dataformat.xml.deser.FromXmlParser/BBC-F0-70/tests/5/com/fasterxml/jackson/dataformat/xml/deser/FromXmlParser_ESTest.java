...
public class FromXmlParser_ESTest extends FromXmlParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      IOContext iOContext0 = new IOContext(bufferRecycler0, "#;D6@v?#^{_h", true);
      ...
      try {
        fromXmlParser0 = new FromXmlParser(iOContext0, 6, 2112, objectMapper0, streamReaderDelegate0);
  ...
  public void test1()  throws Throwable  {
      ...
      FromXmlParser fromXmlParser0 = null;
      try {
        fromXmlParser0 = new FromXmlParser(iOContext0, 2664, 256, (ObjectCodec) null, streamReaderDelegate0);
