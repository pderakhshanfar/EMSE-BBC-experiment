...
public class FromXmlParser_ESTest extends FromXmlParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      IOContext iOContext0 = new IOContext(bufferRecycler0, "2&^=HN@C", true);
      JsonFactory jsonFactory0 = new JsonFactory();
      ObjectMapper objectMapper0 = new ObjectMapper(jsonFactory0);
      StreamReaderDelegate streamReaderDelegate0 = new StreamReaderDelegate();
      FromXmlParser fromXmlParser0 = null;
      try {
        fromXmlParser0 = new FromXmlParser(iOContext0, 4, 855, objectMapper0, streamReaderDelegate0);
  ...
  public void test1()  throws Throwable  {
      ...
      FromXmlParser fromXmlParser0 = null;
      try {
        fromXmlParser0 = new FromXmlParser(iOContext0, 56319, 56319, objectReader0, streamReaderDelegate0);
