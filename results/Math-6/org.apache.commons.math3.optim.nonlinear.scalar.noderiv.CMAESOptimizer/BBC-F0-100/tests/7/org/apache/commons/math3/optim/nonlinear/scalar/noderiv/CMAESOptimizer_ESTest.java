...
public class CMAESOptimizer_ESTest extends CMAESOptimizer_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      SimplePointChecker<PointValuePair> simplePointChecker0 = new SimplePointChecker<PointValuePair>(2147056523, 2147056523);
      CMAESOptimizer cMAESOptimizer0 = new CMAESOptimizer(2147056523, 2147056523, true, 2147056523, 2147056523, well19937c0, true, simplePointChecker0);
      double[] doubleArray0 = new double[6];
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      CMAESOptimizer.Sigma cMAESOptimizer_Sigma0 = new CMAESOptimizer.Sigma(doubleArray0);
      double[] doubleArray1 = new double[6];
      doubleArray1[0] = (double) 2147056523;
  ...
  public void test01()  throws Throwable  {
      SimplePointChecker<PointValuePair> simplePointChecker0 = new SimplePointChecker<PointValuePair>((-2077.91), 579, 579);
      Well44497a well44497a0 = new Well44497a();
      CMAESOptimizer cMAESOptimizer0 = new CMAESOptimizer(0, 0, false, 138, 866, well44497a0, false, simplePointChecker0);
  ...
  public void test03()  throws Throwable  {
      ...
      SimplePointChecker<PointValuePair> simplePointChecker0 = new SimplePointChecker<PointValuePair>((-2819.200499633), (-662.214730153382), 4);
      Well1024a well1024a0 = new Well1024a((long) 4);
      CMAESOptimizer cMAESOptimizer0 = new CMAESOptimizer(4, 4, true, 4688, 4, well1024a0, true, simplePointChecker0);
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[5];
  ...
  public void test07()  throws Throwable  {
      ...
      CMAESOptimizer cMAESOptimizer0 = new CMAESOptimizer(2147056523, 2147056523, true, 2147056523, 2147056523, well19937c0, true, simplePointChecker0);
      double[] doubleArray0 = new double[6];
      doubleArray0[4] = (double) 2147056523;
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      CMAESOptimizer.Sigma cMAESOptimizer_Sigma0 = new CMAESOptimizer.Sigma(doubleArray0);
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // 2,147,056,523 out of [0, 0] range
         //
         verifyException("org.apache.commons.math3.optim.nonlinear.scalar.noderiv.CMAESOptimizer", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      ...
      SimplePointChecker<PointValuePair> simplePointChecker0 = new SimplePointChecker<PointValuePair>(138, 1.0E-13, 138);
      CMAESOptimizer cMAESOptimizer0 = new CMAESOptimizer(138, (-6.663542893624021E-14), false, 138, 138, well19937c0, false, simplePointChecker0);
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      CMAESOptimizer.Sigma cMAESOptimizer_Sigma0 = new CMAESOptimizer.Sigma(doubleArray0);
