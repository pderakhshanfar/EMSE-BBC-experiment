...
public class NonLinearConjugateGradientOptimizer_ESTest extends NonLinearConjugateGradientOptimizer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      SimplePointChecker<PointValuePair> simplePointChecker0 = new SimplePointChecker<PointValuePair>(257.28436512547574, 257.28436512547574);
      PegasusSolver pegasusSolver0 = new PegasusSolver(257.28436512547574);
      NonLinearConjugateGradientOptimizer.IdentityPreconditioner nonLinearConjugateGradientOptimizer_IdentityPreconditioner0 = new NonLinearConjugateGradientOptimizer.IdentityPreconditioner();
  ...
  public void test02()  throws Throwable  {
      SimplePointChecker<PointValuePair> simplePointChecker0 = new SimplePointChecker<PointValuePair>(568.9664053062766, 568.9664053062766);
  ...
  public void test03()  throws Throwable  {
      SimplePointChecker<PointValuePair> simplePointChecker0 = new SimplePointChecker<PointValuePair>(568.754352865137, 568.754352865137);
      NonLinearConjugateGradientOptimizer.Formula nonLinearConjugateGradientOptimizer_Formula0 = NonLinearConjugateGradientOptimizer.Formula.FLETCHER_REEVES;
      RegulaFalsiSolver regulaFalsiSolver0 = new RegulaFalsiSolver(2031.07684836571, 2031.07684836571, 2031.07684836571);
  ...
  public void test04()  throws Throwable  {
      NonLinearConjugateGradientOptimizer.Formula nonLinearConjugateGradientOptimizer_Formula0 = NonLinearConjugateGradientOptimizer.Formula.POLAK_RIBIERE;
      SimpleValueChecker simpleValueChecker0 = new SimpleValueChecker((-4574.28335), 0.0);
  ...
  public void test05()  throws Throwable  {
      NonLinearConjugateGradientOptimizer.Formula nonLinearConjugateGradientOptimizer_Formula0 = NonLinearConjugateGradientOptimizer.Formula.POLAK_RIBIERE;
      SimpleValueChecker simpleValueChecker0 = new SimpleValueChecker(1.0E-15, 1.0E-15, 2587);
      BisectionSolver bisectionSolver0 = new BisectionSolver(2587, 1.0E-15);
      NonLinearConjugateGradientOptimizer.IdentityPreconditioner nonLinearConjugateGradientOptimizer_IdentityPreconditioner0 = new NonLinearConjugateGradientOptimizer.IdentityPreconditioner();
      ...
      SimpleBounds simpleBounds0 = SimpleBounds.unbounded(2587);
  ...
  public void test07()  throws Throwable  {
      NonLinearConjugateGradientOptimizer.IdentityPreconditioner nonLinearConjugateGradientOptimizer_IdentityPreconditioner0 = new NonLinearConjugateGradientOptimizer.IdentityPreconditioner();
      NonLinearConjugateGradientOptimizer.Formula nonLinearConjugateGradientOptimizer_Formula0 = NonLinearConjugateGradientOptimizer.Formula.POLAK_RIBIERE;
      SimpleValueChecker simpleValueChecker0 = new SimpleValueChecker((-540.2), (-540.2));
      BrentSolver brentSolver0 = new BrentSolver((-540.2), Double.NEGATIVE_INFINITY);
