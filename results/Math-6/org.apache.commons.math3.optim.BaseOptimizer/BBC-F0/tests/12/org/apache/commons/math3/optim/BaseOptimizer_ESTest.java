...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(0, 1766, 935.492785886114);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[6];
      double[] doubleArray0 = new double[1];
      SimpleBounds simpleBounds0 = SimpleBounds.unbounded(1766);
  ...
  public void test3()  throws Throwable  {
      ...
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(713.0, 713.0, convergenceChecker0);
  ...
  public void test4()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(0.0, 3147);
  ...
  public void test5()  throws Throwable  {
      ConvergenceChecker<UnivariatePointValuePair> convergenceChecker0 = (ConvergenceChecker<UnivariatePointValuePair>) mock(ConvergenceChecker.class, new ViolatedAssumptionAnswer());
      doReturn(":!{;K//a}").when(convergenceChecker0).toString();
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(713.0, 713.0, convergenceChecker0);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[8];
      try { 
        brentOptimizer0.optimize(optimizationDataArray0);
