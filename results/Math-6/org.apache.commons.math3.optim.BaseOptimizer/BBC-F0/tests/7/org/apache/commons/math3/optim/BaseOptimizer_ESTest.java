...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        multiStartUnivariateOptimizer0 = new MultiStartUnivariateOptimizer(brentOptimizer0, (-30), well1024a0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // -30 is smaller than, or equal to, the minimum (0)
         //
  ...
  public void test1()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(3020.601341321868, 3020.601341321868);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[9];
      MaxIter maxIter0 = new MaxIter(819);
