...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(0.0, 1309);
      double[] doubleArray0 = new double[5];
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      SimpleBounds simpleBounds0 = SimpleBounds.unbounded(1309);
  ...
  public void test3()  throws Throwable  {
      ...
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(1.0, 2651.6, convergenceChecker0);
      try { 
  ...
  public void test4()  throws Throwable  {
      ConvergenceChecker<UnivariatePointValuePair> convergenceChecker0 = (ConvergenceChecker<UnivariatePointValuePair>) mock(ConvergenceChecker.class, new ViolatedAssumptionAnswer());
      doReturn((String) null).when(convergenceChecker0).toString();
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(991, 55, convergenceChecker0);
  ...
  public void test5()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(1465.77186, 55);
  ...
  public void test6()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(991, 1.0, (ConvergenceChecker<UnivariatePointValuePair>) null);
  ...
  public void test8()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(0.0, 72, 0.0);
