...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(1646.106, 4776.953495, convergenceChecker0);
      int[] intArray0 = new int[8];
      Well44497a well44497a0 = new Well44497a(intArray0);
      MultiStartUnivariateOptimizer multiStartUnivariateOptimizer0 = new MultiStartUnivariateOptimizer(brentOptimizer0, 974, well44497a0);
  ...
  public void test1()  throws Throwable  {
      ConvergenceChecker<UnivariatePointValuePair> convergenceChecker0 = (ConvergenceChecker<UnivariatePointValuePair>) mock(ConvergenceChecker.class, new ViolatedAssumptionAnswer());
      doReturn((String) null).when(convergenceChecker0).toString();
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(Double.NaN, 793.746, convergenceChecker0);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[7];
      MaxEval maxEval0 = new MaxEval(3896);
  ...
  public void test4()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-2488.8445002798), 840);
