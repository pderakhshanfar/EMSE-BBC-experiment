...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        multiStartUnivariateOptimizer0 = new MultiStartUnivariateOptimizer(brentOptimizer0, (-2452), (RandomGenerator) null);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // -2,452 is smaller than, or equal to, the minimum (0)
         //
  ...
  public void test2()  throws Throwable  {
      ...
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(2128.0, 2128.0, convergenceChecker0);
  ...
  public void test3()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(1914.42634936855, (-633066204));
  ...
  public void test4()  throws Throwable  {
      ConvergenceChecker<UnivariatePointValuePair> convergenceChecker0 = (ConvergenceChecker<UnivariatePointValuePair>) mock(ConvergenceChecker.class, new ViolatedAssumptionAnswer());
      doReturn("ty").when(convergenceChecker0).toString();
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(2128.0, 2128.0, convergenceChecker0);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[1];
      try { 
        brentOptimizer0.optimize(optimizationDataArray0);
