...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(658.0, 312.88026453836);
      int[] intArray0 = new int[0];
      Well19937a well19937a0 = new Well19937a(intArray0);
      MultiStartUnivariateOptimizer multiStartUnivariateOptimizer0 = null;
      try {
        multiStartUnivariateOptimizer0 = new MultiStartUnivariateOptimizer(brentOptimizer0, (-650), well19937a0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // -650 is smaller than, or equal to, the minimum (0)
         //
  ...
  public void test1()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(0.0, 6);
  ...
  public void test2()  throws Throwable  {
      ...
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(0.5, 1130.201, convergenceChecker0);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[5];
  ...
  public void test3()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-4138.12828406));
