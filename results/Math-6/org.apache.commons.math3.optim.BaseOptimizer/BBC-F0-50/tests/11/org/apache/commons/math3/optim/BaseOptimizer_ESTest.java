...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-4395.761363674));
      OptimizationData[] optimizationDataArray0 = new OptimizationData[3];
      double[] doubleArray0 = new double[0];
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      optimizationDataArray0[0] = (OptimizationData) initialGuess0;
      SimpleBounds simpleBounds0 = SimpleBounds.unbounded(1943);
  ...
  public void test3()  throws Throwable  {
      ...
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(Double.POSITIVE_INFINITY, 2151.659282, convergenceChecker0);
  ...
  public void test4()  throws Throwable  {
      ConvergenceChecker<UnivariatePointValuePair> convergenceChecker0 = (ConvergenceChecker<UnivariatePointValuePair>) mock(ConvergenceChecker.class, new ViolatedAssumptionAnswer());
      doReturn("{}1bTH|6(e%n").when(convergenceChecker0).toString();
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, convergenceChecker0);
