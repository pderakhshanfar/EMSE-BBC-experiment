...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(2349.034986791318, 2349.034986791318);
      MersenneTwister mersenneTwister0 = new MersenneTwister();
      MultiStartUnivariateOptimizer multiStartUnivariateOptimizer0 = new MultiStartUnivariateOptimizer(brentOptimizer0, 2787, mersenneTwister0);
  ...
  public void test2()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(676.246107878, 676.246107878);
      int[] intArray0 = new int[3];
      Well1024a well1024a0 = new Well1024a(intArray0);
      MultiStartUnivariateOptimizer multiStartUnivariateOptimizer0 = new MultiStartUnivariateOptimizer(brentOptimizer0, 924, well1024a0);
  ...
  public void test3()  throws Throwable  {
      ConvergenceChecker<UnivariatePointValuePair> convergenceChecker0 = (ConvergenceChecker<UnivariatePointValuePair>) mock(ConvergenceChecker.class, new ViolatedAssumptionAnswer());
      doReturn("org.apache.commons.math3.optim.BaseOptimizer$1").when(convergenceChecker0).toString();
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(3.0, 3.0, convergenceChecker0);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[5];
      try { 
        brentOptimizer0.optimize(optimizationDataArray0);
  ...
  public void test5()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-79.0), 308, 3.0);
