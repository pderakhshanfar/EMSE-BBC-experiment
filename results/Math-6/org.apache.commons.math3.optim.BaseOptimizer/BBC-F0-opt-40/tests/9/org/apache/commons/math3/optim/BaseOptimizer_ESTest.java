...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(517.0259292964275, Double.NaN);
      int[] intArray0 = new int[7];
      Well19937a well19937a0 = new Well19937a(intArray0);
      MultiStartUnivariateOptimizer multiStartUnivariateOptimizer0 = null;
      try {
        multiStartUnivariateOptimizer0 = new MultiStartUnivariateOptimizer(brentOptimizer0, (-1285), well19937a0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // -1,285 is smaller than, or equal to, the minimum (0)
         //
  ...
  public void test1()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(1233, 1233);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[9];
      MaxIter maxIter0 = new MaxIter(1233);
  ...
  public void test2()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(1233, 1233);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[9];
      MaxEval maxEval0 = new MaxEval(1633);
  ...
  public void test3()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(2, 746);
  ...
  public void test4()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-1.0), (-1620));
  ...
  public void test6()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(1849.7958740387, 4265.953292548);
