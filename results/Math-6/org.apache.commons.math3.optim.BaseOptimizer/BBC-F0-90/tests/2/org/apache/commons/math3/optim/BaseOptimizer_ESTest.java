...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(715.00302, 715.00302);
      Well44497a well44497a0 = new Well44497a((-2811));
      MultiStartUnivariateOptimizer multiStartUnivariateOptimizer0 = null;
      try {
        multiStartUnivariateOptimizer0 = new MultiStartUnivariateOptimizer(brentOptimizer0, (-2811), well44497a0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // -2,811 is smaller than, or equal to, the minimum (0)
         //
  ...
  public void test1()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(52.6, 52.6);
  ...
  public void test2()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(52.6, 52.6);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[6];
      MaxEval maxEval0 = new MaxEval(1939);
