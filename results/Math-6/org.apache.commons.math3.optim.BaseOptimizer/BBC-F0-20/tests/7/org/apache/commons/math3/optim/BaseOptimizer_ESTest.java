...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(1.0E-12, 236.57, convergenceChecker0);
  ...
  public void test1()  throws Throwable  {
      ...
      doReturn((String) null).when(convergenceChecker0).toString();
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(1.0E-12, 236.57, convergenceChecker0);
      Well44497a well44497a0 = new Well44497a((-3464));
      MultiStartUnivariateOptimizer multiStartUnivariateOptimizer0 = new MultiStartUnivariateOptimizer(brentOptimizer0, 2033, well44497a0);
      assertEquals(0.0, multiStartUnivariateOptimizer0.getMin(), 0.01);
  }

  @Test(timeout = 4000)
  public void test2()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(2239.75, 0, 0);
  ...
  public void test4()  throws Throwable  {
      OptimizationData[] optimizationDataArray0 = new OptimizationData[5];
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(898.9, 1174.0, (ConvergenceChecker<UnivariatePointValuePair>) null);
      try { 
        brentOptimizer0.optimize(optimizationDataArray0);
