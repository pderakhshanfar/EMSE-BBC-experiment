...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(2.1983272709242607E-8, 2.1983272709242607E-8, convergenceChecker0);
  ...
  public void test1()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-4030.391268319741), 1154, (-310.943050659));
      OptimizationData[] optimizationDataArray0 = new OptimizationData[6];
      double[] doubleArray0 = new double[6];
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      optimizationDataArray0[0] = (OptimizationData) initialGuess0;
      SimpleBounds simpleBounds0 = SimpleBounds.unbounded(3523);
