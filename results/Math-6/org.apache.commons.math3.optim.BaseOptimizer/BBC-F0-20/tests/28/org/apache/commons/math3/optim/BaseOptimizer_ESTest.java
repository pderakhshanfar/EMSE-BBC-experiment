...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(Double.NaN, 1.0, convergenceChecker0);
      JDKRandomGenerator jDKRandomGenerator0 = new JDKRandomGenerator();
      MultiStartUnivariateOptimizer multiStartUnivariateOptimizer0 = null;
      try {
        multiStartUnivariateOptimizer0 = new MultiStartUnivariateOptimizer(brentOptimizer0, (-2036), jDKRandomGenerator0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // -2,036 is smaller than, or equal to, the minimum (0)
         //
  ...
  public void test1()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(568.16896813281, 568.16896813281);
  ...
  public void test2()  throws Throwable  {
      ConvergenceChecker<UnivariatePointValuePair> convergenceChecker0 = (ConvergenceChecker<UnivariatePointValuePair>) mock(ConvergenceChecker.class, new ViolatedAssumptionAnswer());
      doReturn((String) null).when(convergenceChecker0).toString();
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(3142.1306311062, 3142.1306311062, convergenceChecker0);
  ...
  public void test6()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(1.0, 2901, 1147.7987371835);
