...
public class BaseOptimizer_ESTest extends BaseOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(2852.7993, 2852.7993);
      int[] intArray0 = new int[3];
      Well1024a well1024a0 = new Well1024a(intArray0);
      MultiStartUnivariateOptimizer multiStartUnivariateOptimizer0 = null;
      try {
        multiStartUnivariateOptimizer0 = new MultiStartUnivariateOptimizer(brentOptimizer0, (-93), well1024a0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // -93 is smaller than, or equal to, the minimum (0)
         //
  ...
  public void test1()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-1.0), 2756, (-1.0));
      OptimizationData[] optimizationDataArray0 = new OptimizationData[4];
      MaxIter maxIter0 = new MaxIter(2756);
  ...
  public void test2()  throws Throwable  {
      BrentOptimizer brentOptimizer0 = new BrentOptimizer(471.2, 2556.0);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[1];
      MaxEval maxEval0 = new MaxEval(1174);
  ...
  public void test3()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(0.0, 815, 815);
  ...
  public void test7()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(2328.47);
