...
public class SimplexOptimizer_ESTest extends SimplexOptimizer_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer((-2352.1449896977465), (-2352.1449896977465));
  ...
  public void test01()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer((-2384.200132106973), (-2384.200132106973));
      // Undeclared exception!
      try { 
  ...
  public void test02()  throws Throwable  {
      ...
      doubleArray0[0] = (-1454.1409362923919);
  ...
  public void test03()  throws Throwable  {
      double[] doubleArray0 = new double[2];
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(0.0, 9);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[2];
      NelderMeadSimplex nelderMeadSimplex0 = new NelderMeadSimplex(5, 374.0, 710.2530306106399, 1425.6639, 0.0, 1425.6639);
      optimizationDataArray0[0] = (OptimizationData) nelderMeadSimplex0;
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
  ...
  public void test06()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer((-2352.1449896977465), (-2352.1449896977465));
      OptimizationData[] optimizationDataArray0 = new OptimizationData[2];
      MultiDirectionalSimplex multiDirectionalSimplex0 = new MultiDirectionalSimplex(15, 1078.8377218361, (-2352.1449896977465), 1078.8377218361);
  ...
  public void test07()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(1193.8854825623475, 1193.8854825623475);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[4];
      double[] doubleArray0 = new double[6];
      doubleArray0[0] = 1193.8854825623475;
      doubleArray0[1] = 1193.8854825623475;
      doubleArray0[2] = 1193.8854825623475;
      doubleArray0[3] = 1193.8854825623475;
      doubleArray0[4] = 1193.8854825623475;
      doubleArray0[5] = 1193.8854825623475;
      SimpleBounds simpleBounds0 = new SimpleBounds(doubleArray0, doubleArray0);
      optimizationDataArray0[0] = (OptimizationData) simpleBounds0;
      NelderMeadSimplex nelderMeadSimplex0 = new NelderMeadSimplex(doubleArray0, 0.6409968137741089, 1193.8854825623475, 1193.8854825623475, 1193.8854825623475);
  ...
  public void test08()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(2677.697, (-1324.6));
      OptimizationData[] optimizationDataArray0 = new OptimizationData[4];
      double[] doubleArray0 = new double[1];
      doubleArray0[0] = 2677.697;
  ...
  public void test11()  throws Throwable  {
      ...
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      optimizationDataArray0[0] = (OptimizationData) initialGuess0;
      MultiDirectionalSimplex multiDirectionalSimplex0 = new MultiDirectionalSimplex(12, 1.289655833023, 0.0, 0.0);
