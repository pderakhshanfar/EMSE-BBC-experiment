...
public class SimplexOptimizer_ESTest extends SimplexOptimizer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(57.43893122, 0.0);
      // Undeclared exception!
      try { 
  ...
  public void test02()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer((-2286.09131), (-2286.09131));
      OptimizationData[] optimizationDataArray0 = new OptimizationData[3];
      MultiDirectionalSimplex multiDirectionalSimplex0 = new MultiDirectionalSimplex(3, (-1572.132255118), (-1572.132255118), (-2286.09131));
  ...
  public void test05()  throws Throwable  {
      ...
      OptimizationData[] optimizationDataArray0 = new OptimizationData[3];
      double[] doubleArray0 = new double[7];
      MultiDirectionalSimplex multiDirectionalSimplex0 = new MultiDirectionalSimplex(29, 29.0);
      optimizationDataArray0[0] = (OptimizationData) multiDirectionalSimplex0;
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      optimizationDataArray0[1] = (OptimizationData) initialGuess0;
      simplexOptimizer0.parseOptimizationData(optimizationDataArray0);
  ...
  public void test07()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(57.43893122, 57.43893122);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[5];
      double[] doubleArray0 = new double[3];
      doubleArray0[0] = 57.43893122;
      doubleArray0[1] = 57.43893122;
      doubleArray0[2] = 57.43893122;
      NelderMeadSimplex nelderMeadSimplex0 = new NelderMeadSimplex(doubleArray0, 57.43893122, 0.19999998807907104, 57.43893122, 2.7553817452272217E-6);
  ...
  public void test08()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer((-2286.585857218286), (-2286.585857218286));
      OptimizationData[] optimizationDataArray0 = new OptimizationData[3];
      MultiDirectionalSimplex multiDirectionalSimplex0 = new MultiDirectionalSimplex(3, (-1572.132255118), (-1572.132255118), (-2286.585857218286));
      optimizationDataArray0[0] = (OptimizationData) multiDirectionalSimplex0;
      double[] doubleArray0 = new double[8];
      SimpleBounds simpleBounds0 = new SimpleBounds(doubleArray0, doubleArray0);
      optimizationDataArray0[1] = (OptimizationData) simpleBounds0;
  ...
  public void test09()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(18.366892872365625, 18.366892872365625);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[2];
      double[] doubleArray0 = new double[1];
      doubleArray0[0] = 18.366892872365625;
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
