...
public class SimplexOptimizer_ESTest extends SimplexOptimizer_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer((-1912L), (-1912L));
      OptimizationData[] optimizationDataArray0 = new OptimizationData[4];
      double[] doubleArray0 = new double[4];
      doubleArray0[0] = (-1566.39608032188);
      doubleArray0[1] = (double) (-1912L);
      doubleArray0[2] = (double) (-1912L);
      doubleArray0[3] = (double) (-1912L);
      NelderMeadSimplex nelderMeadSimplex0 = new NelderMeadSimplex(doubleArray0, 1.0, 0.0, 1054.00344407284, 1651.9225237824544);
      optimizationDataArray0[0] = (OptimizationData) nelderMeadSimplex0;
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      optimizationDataArray0[1] = (OptimizationData) initialGuess0;
      simplexOptimizer0.parseOptimizationData(optimizationDataArray0);
