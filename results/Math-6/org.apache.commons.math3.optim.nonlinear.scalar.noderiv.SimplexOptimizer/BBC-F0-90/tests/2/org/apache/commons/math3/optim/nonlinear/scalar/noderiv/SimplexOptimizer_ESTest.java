...
public class SimplexOptimizer_ESTest extends SimplexOptimizer_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(0.0, (-715.183235));
  ...
  public void test01()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer((-2604.21598), (-2.0));
      // Undeclared exception!
      try { 
  ...
  public void test02()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer((-124.4), (-124.4));
  ...
  public void test04()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(2.604843948430821, 4808.68175195);
  ...
  public void test05()  throws Throwable  {
      SimplePointChecker<PointValuePair> simplePointChecker0 = new SimplePointChecker<PointValuePair>(1605L, 1605L, 51);
  ...
  public void test06()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(2848.5, (-1.0));
      OptimizationData[] optimizationDataArray0 = new OptimizationData[3];
      double[] doubleArray0 = new double[6];
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      optimizationDataArray0[0] = (OptimizationData) initialGuess0;
      MultiDirectionalSimplex multiDirectionalSimplex0 = new MultiDirectionalSimplex(10, 2848.5, (-1.0), 2.85040095144011776E17);
  ...
  public void test08()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(582.4235, (-1.0));
      OptimizationData[] optimizationDataArray0 = new OptimizationData[4];
      NelderMeadSimplex nelderMeadSimplex0 = new NelderMeadSimplex(20, 582.4235, 0.0, 20, (-1.0));
  ...
  public void test09()  throws Throwable  {
      SimplePointChecker<PointValuePair> simplePointChecker0 = new SimplePointChecker<PointValuePair>(1100.382369571914, 1100.382369571914, 1735);
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(simplePointChecker0);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[2];
      double[] doubleArray0 = new double[5];
      doubleArray0[0] = (double) 1735;
      doubleArray0[1] = 1100.382369571914;
      doubleArray0[2] = 1100.382369571914;
      doubleArray0[3] = 1100.382369571914;
      doubleArray0[4] = 1100.382369571914;
      MultiDirectionalSimplex multiDirectionalSimplex0 = new MultiDirectionalSimplex(doubleArray0, 1629.814045, 1.0);
      optimizationDataArray0[0] = (OptimizationData) multiDirectionalSimplex0;
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
