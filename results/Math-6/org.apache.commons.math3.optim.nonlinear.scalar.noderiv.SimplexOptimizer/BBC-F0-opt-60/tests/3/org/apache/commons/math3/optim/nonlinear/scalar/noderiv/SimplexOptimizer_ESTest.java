...
public class SimplexOptimizer_ESTest extends SimplexOptimizer_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer((-1096.129425), (-1096.129425));
      double[] doubleArray0 = new double[8];
      doubleArray0[0] = (-1096.129425);
      doubleArray0[1] = (-1096.129425);
      doubleArray0[2] = (-1096.129425);
      doubleArray0[3] = (-1096.129425);
      doubleArray0[4] = (-1096.129425);
      doubleArray0[5] = (-1096.129425);
      doubleArray0[6] = (-1096.129425);
      doubleArray0[7] = (-1096.129425);
      ...
      SimpleBounds simpleBounds0 = SimpleBounds.unbounded(1099);
  ...
  public void test03()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(562.097, 562.097);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[2];
      double[] doubleArray0 = new double[4];
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      optimizationDataArray0[0] = (OptimizationData) initialGuess0;
      double[] doubleArray1 = new double[2];
      doubleArray1[0] = 562.097;
      doubleArray1[1] = 562.097;
      NelderMeadSimplex nelderMeadSimplex0 = new NelderMeadSimplex(doubleArray1, 562.097, (-2055.9507556522), 562.097, 2087.75);
  ...
  public void test05()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(1016.479357, 1016.479357);
      // Undeclared exception!
      try { 
        simplexOptimizer0.doOptimize();
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(1174.2432118891, 0.366272509098053);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[3];
      double[] doubleArray0 = new double[0];
      double[] doubleArray1 = new double[7];
      SimpleBounds simpleBounds0 = new SimpleBounds(doubleArray0, doubleArray1);
      optimizationDataArray0[0] = (OptimizationData) simpleBounds0;
      MultiDirectionalSimplex multiDirectionalSimplex0 = new MultiDirectionalSimplex(9, (-5268.0960344));
  ...
  public void test11()  throws Throwable  {
      SimplexOptimizer simplexOptimizer0 = new SimplexOptimizer(568.7556613055087, 568.7556613055087);
      OptimizationData[] optimizationDataArray0 = new OptimizationData[3];
      double[] doubleArray0 = new double[1];
      doubleArray0[0] = 568.7556613055087;
      MultiDirectionalSimplex multiDirectionalSimplex0 = new MultiDirectionalSimplex(doubleArray0, 568.7556613055087, 568.7556613055087);
      optimizationDataArray0[0] = (OptimizationData) multiDirectionalSimplex0;
      InitialGuess initialGuess0 = new InitialGuess(doubleArray0);
      optimizationDataArray0[1] = (OptimizationData) initialGuess0;
      simplexOptimizer0.parseOptimizationData(optimizationDataArray0);
