...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1336.49), (-1336.49), (-1336.49));
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.0, (-300.603537928), 3.0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2625.7366518643), vector3D0, (-2625.7366518643), vector3D0, (-2625.7366518643), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-7877.2099555929), vector1D0.getX(), 0.01);
      assertEquals(7877.209955592898, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector1D vector1D1 = new Vector1D((-504.39235), vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals(357.15925106361846, vector3D2.getY(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.pointAt((-83.3268859));
      assertEquals((-83.3268859), vector3D2.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1289.549456);
      assertEquals((-0.7848498271494453), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(606.2197);
      assertEquals((-428.1620607588744), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1207.467752493), 2.0, 2.0);
      Vector3D vector3D1 = new Vector3D((-1400.96758145), (-2104.327853244));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(8.729267675213153E-4, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1217.8984493601429, vector3D0, 1217.8984493601429, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(9.51942398282332E-34, vector3D2.getNormSq(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-2611.35742408), vector3D0, (-2611.35742408), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(9.62801189531591E-26, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(281.62305, 281.62305);
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.6365560787496354, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-359.95804747117), (-359.95804747117), (-359.95804747117));
      line0.reset(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.getDirection();
      assertEquals((-0.5784180765819601), vector3D3.getZ(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1.7976931348623157E308), (-4006.462953), (-1164.0145));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test24()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D((-2868.0043115657045), (-2868.0043115657045), (-2868.0043115657045));
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D(4.440892098500626E-16, (-3498.26344513083));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(3.48407022259922E-13, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(1870.82, 0.19454771280288696);
      Line line1 = new Line(vector3D2, vector3D1);
      double double0 = line0.distance(line1);
      assertEquals(8.730394760605441E-20, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(221.2241937, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(2.45664318966236E-28, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.9999114882565401, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test46()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.999999947932352, (-2762.4771334));
      Vector3D vector3D1 = new Vector3D(0.999999947932352, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = Vector3D.POSITIVE_INFINITY;
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-4.503599627370496E15));
      assertFalse(vector3D1.isInfinite());
  }
  ...
  public void test55()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1192.47, 0.9985313415527344, 1192.47);
      Vector3D vector3D1 = new Vector3D(1192.47, vector3D0, 0.9985313415527344, vector3D0, 1403.0668036798147, vector3D0);
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1192.47, 0.9985313415527344, 1192.47);
      Vector3D vector3D1 = new Vector3D(0.9985313415527344, vector3D0);
      Vector3D vector3D2 = Vector3D.crossProduct(vector3D0, vector3D1);
