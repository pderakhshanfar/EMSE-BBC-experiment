...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.36512319681200983, 0.36512319681200983);
      Vector3D vector3D1 = new Vector3D(0.36512319681200983, vector3D0, 0.36512319681200983, vector3D0);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-397.93009654), 3.141592653489793);
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(795.6297294285082, vector3D0, 795.6297294285082, vector3D0, 795.6297294285082, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line1.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2386.8891882855246), vector3D2.getZ(), 0.01);
      assertEquals(2386.8891882855246, vector1D0.getX(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1279.1227119));
      assertEquals((-1279.1227119), vector3D2.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.36512319681200983, vector3D0, 0.36512319681200983, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.36512319681200983);
      assertEquals((-0.13037248527800385), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1473.0749, 2576.56556659);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-0.27820936628177756), vector3D2.getZ(), 0.01);
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1473.0749, 1473.0749);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.44686655773715145, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals((-0.3335266104902968), vector3D2.getY(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals(0.0, double0, 0.01);
      assertEquals(0.9379629977733824, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(8.481888128285233E-34, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2412.8279256732185), (-2412.8279256732185));
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.49641581429232917, vector3D2.getX(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-8.0E298), (-8.0E298), 1706.6646714553);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test48()  throws Throwable  {
      ...
      assertEquals(0.3335266104902968, vector3D0.getY(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.125, (-397.93009654));
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D1);
      assertEquals(1.1850118071913106E-16, double0, 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(5.172957211009158E-11, vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.0);
      Vector3D vector3D1 = new Vector3D(0.0, (-1.0), (-1.0));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.816496580927726, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      assertEquals(0.9999999999999999, vector3D3.getNormSq(), 0.01);
      assertEquals((-0.06179966511714877), vector3D3.getY(), 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Line line1 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(line1);
      assertEquals(2.462351354365699E-17, double0, 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(635.6936, vector3D1, 5.6250075852137985E10, vector3D0, (-97.0), vector3D1);
  ...
  public void test60()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-0.5040735816248555), double0, 0.01);
  }
  ...
  public void test63()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.6867493641103064), vector3D2.getDelta(), 0.01);
  }
