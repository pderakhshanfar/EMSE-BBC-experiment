...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(25011.48576003994, 25011.48576003994, 0.16666666666745392);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653589793, 1834.6318189193);
      Vector3D vector3D1 = new Vector3D(3.141592653589793, vector3D0, 143.2937162609, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-4388.36387), 2231.96507628, 0.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D(2231.96507628);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(2.671191968532486, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1.0000000000000218), vector1D0.getX(), 0.01);
      assertEquals(1.056559346180464, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(490.811268278, (-160.53401997), 2061.120120284);
      Vector3D vector3D1 = new Vector3D(1.0E-10, vector3D0);
      Vector3D vector3D2 = new Vector3D(490.811268278, vector3D1, (-160.53401997), vector3D0, (-160.53401997), vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D3 = line0.toSpace(vector1D0);
      assertEquals(1.2765591920093937, vector3D3.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2879.789661847377), (-2879.789661847377), (-2879.789661847377));
      Vector3D vector3D1 = new Vector3D((-4388.36387), 2231.96507628, 0.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1626.3131347206));
      assertEquals((-0.5413631455026767), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-2879.789661847377), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1626.3131347206));
      assertEquals(1626.3131347205997, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(1388.711222362402);
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(22.232418701611408, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.3110996182432376E-15, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals(5.341181445444039E-30, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      assertEquals(2.124892172440613E-7, double0, 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(1105.93519092, 1105.93519092);
      double double0 = line0.distance(vector3D2);
      assertEquals(0.9955708861976983, double0, 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-455.975), vector3D0, 1725.70437, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.9099574870550724E-13, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-481.0), (-735.276), (-8.0E298));
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test40()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2879.789661847377), (-2879.789661847377), (-2879.789661847377));
      Vector3D vector3D1 = new Vector3D((-2879.789661847377), vector3D0);
      Vector3D vector3D2 = new Vector3D((-4388.36387), 2231.96507628, 0.0);
      Line line0 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.closestPoint(line0);
      assertEquals(0.1516748185722772, vector3D3.getDelta(), 0.01);
  }
  ...
  public void test46()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2147.76), (-515.52915344087), 1505.0499037072);
      Vector3D vector3D1 = new Vector3D((-2147.76), vector3D0, (-515.52915344087), vector3D0, (-2741.9641259), vector3D0, 1505.0499037072, vector3D0);
  ...
  public void test47()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1475.1184128838343), 1612213.673040597, (-1475.1184128838343));
      Vector3D vector3D1 = new Vector3D((-1475.1184128838343), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-1.7742797341208263E-10), vector3D2.getZ(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2147.76), (-515.52915344087), 1505.0499037072);
      Vector3D vector3D1 = new Vector3D((-515.52915344087), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      Line line1 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.intersection(line1);
      assertNotNull(vector3D3);
      assertEquals(0.7193335739351563, vector3D3.getDelta(), 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      assertEquals(4.347154567287234E-10, double0, 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2147.76), (-515.52915344087), 1505.0499037072);
      Vector3D vector3D1 = new Vector3D((-2147.76), vector3D0, (-515.52915344087), vector3D0, (-2741.9641259), vector3D0, 1505.0499037072, vector3D0);
      Vector3D vector3D2 = new Vector3D((-515.52915344087), vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
  ...
  public void test55()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.8035641307189636, vector3D2.getX(), 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(6.243131310025646E-13, vector3D2.getNorm(), 0.01);
  }
