...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.49999999999999994, 0.49999999999999994);
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line0.intersection(line1);
      assertEquals(0.38507557646703494, vector3D2.getNormInf(), 0.01);
  ...
  public void test01()  throws Throwable  {
      ...
      assertEquals(0.23971276930210147, vector3D2.getZ(), 0.01);
  }
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.49999999999999994, 0.49999999999999994);
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Vector3D vector3D2 = new Vector3D(0.0, vector3D0, 4778.8879, vector3D0, 0.0, vector3D0, 585.38404973, vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Line line1 = line0.revert();
      line1.reset(vector3D0, vector3D1);
      double double0 = line0.distance(line1);
      assertEquals(2.2415236183042274E-14, double0, 0.01);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D4 = vector3D1.add(1.0E-10, (Vector<Euclidean3D>) vector3D3);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.006939601696975411, 0.006939601696975411);
      Vector3D vector3D1 = new Vector3D(0.006939601696975411, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = Vector3D.POSITIVE_INFINITY;
      Vector3D vector3D3 = new Vector3D(0.75, vector3D2, 0.75, vector3D2);
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals(Double.NEGATIVE_INFINITY, vector3D4.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 947.82727374021);
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2268.879631), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.9999999999995588, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.49999999999999994, 448.5355);
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.POSITIVE_INFINITY;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(0.8335689999999999);
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals(20.0, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-0.1658936111868359), 947.82727374021);
      Vector3D vector3D1 = new Vector3D(0.031, (-20.0), 4085.19229853331);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.0);
      assertEquals((-0.10214429234105067), vector3D2.getY(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D((-1087.1449519007558), vector3D0, (-1087.1449519007558), vector3D0, (-1087.1449519007558), vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals(2.5149627219749104E-14, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D3 = line0.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals(0.6718988947982406, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.49999999999999994, 0.49999999999999994);
      Vector3D vector3D1 = new Vector3D((-1018.697331), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.2745581378307676E-13, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals(2.5149627219749104E-14, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-1087.1449519007558), vector3D0, (-1087.1449519007558), vector3D0, (-1087.1449519007558), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.9708296528581495E-13, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-955.6362975742207), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.8128968366076806E-27, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals((-0.4568823248390983), vector3D2.getX(), 0.01);
  ...
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(4093.006642371187, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test31()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals(0.8428331662921043, double0, 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.49999999999999994, 448.5355);
      Vector3D vector3D1 = new Vector3D(1802.55106740143, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
      double double0 = line1.distance(line0);
      assertEquals(1.3588658668823945E-32, double0, 0.01);
  }
  ...
  public void test36()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.49999999999999994, (-1.0));
      Vector3D vector3D1 = new Vector3D(1.674451815100811E7, 1.0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.386641284956275, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test37()  throws Throwable  {
      ...
      assertEquals(0.013547086353645932, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      assertEquals((-955.6362975742207), double0, 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(67.6819, 67.6819, (-1945.0));
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = new Vector3D(951367.4329263455, vector3D2, (-1945.0), vector3D1);
  ...
  public void test63()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(2.2837770560766406E7, vector3D0, 989.0768724, vector3D0, 2.2837770560766406E7, vector3D0, 854.904404515, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-4.567738510280973E7), vector1D0.getX(), 0.01);
      assertEquals((-4.567738510280973E7), vector3D2.getZ(), 0.01);
  }
