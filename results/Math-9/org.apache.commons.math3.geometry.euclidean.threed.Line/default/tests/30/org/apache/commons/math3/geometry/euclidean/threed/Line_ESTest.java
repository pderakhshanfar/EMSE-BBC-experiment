...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3891.296314217329), (-3891.296314217329), (-3891.296314217329));
      Vector3D vector3D1 = new Vector3D((-3891.296314217329), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1.0E-10, vector3D0, 1071.8728176236, vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-6.730119551185594E-14), vector3D2.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.6931470632553101, 1.0E-10, 0.6931470632553101);
      Vector3D vector3D1 = new Vector3D((-3891.296314217329), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-2052.85224));
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(3282.107419381837, vector3D0, (-419.242), vector3D0);
      Vector3D vector3D2 = new Vector3D((-419.242), 2005.0, 2005.0);
      Line line0 = new Line(vector3D1, vector3D2);
      line0.reset(vector3D0, vector3D1);
      Vector3D vector3D3 = line0.pointAt((-3809.730996));
      assertEquals((-3809.730996), vector3D3.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.6931470632553101, 0.6931470632553101, 0.6931470632553101);
      Vector3D vector3D1 = new Vector3D((-3891.296314217329), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(4.324625895316444E-13, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2.957007209750105E-8), (-1082.4126));
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.4955223318138645), vector3D2.getZ(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      assertEquals((-1.0201396192399299E-10), vector3D2.getY(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals((-3814.4742551187232), double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals(3.619962672148627E-29, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-6737.3545906819845), 1.0E-10, (-6737.3545906819845));
      Vector3D vector3D1 = new Vector3D((-3891.296314217329), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.closestPoint(line0);
      assertEquals((-8.6918221807377E-26), vector3D2.getZ(), 0.01);
  }
  ...
  public void test46()  throws Throwable  {
      ...
      assertEquals(1.4505301985124996E-12, double0, 0.01);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals(6739.922923531632, double0, 0.01);
  }
  ...
  public void test48()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(1.7106375963109865E-9, vector3D2.getNorm(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line0.pointAt((-1955.297614));
      line1.reset(vector3D2, vector3D1);
      assertEquals((-1.9946765634467033E-7), vector3D2.getY(), 0.01);
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(9.8322589125506E-27, 1.3753733212236625E15, 1.3753733212236625E15);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D((-3914.73164016), vector3D1, (-3914.73164016), vector3D0, 3.141592653489793, vector3D0);
  ...
  public void test55()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(6739.922923531632, vector1D0.getX(), 0.01);
      assertEquals((-3891.29631421733), vector3D2.getZ(), 0.01);
  }
