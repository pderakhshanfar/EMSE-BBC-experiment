...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-259.03086193), vector3D0, 1.1974215507507324, vector3D0, (-259.03086193), vector3D0, 4.440892098500626E-16, vector3D0);
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(4.440892098500626E-16, vector3D2, (-259.03086193), vector3D1, 1.0E-10, vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(869.0, 0.7249995199969751);
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, (-1776.336157), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector1D vector1D0 = new Vector1D((-5292.168487));
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-0.09088450866185192), vector3D0, 231.0, vector3D0, (-1776.336157), vector3D0, 427.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D((-559.14760003135));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(312646.03862081823, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(614.87935641796, 614.87935641796);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.4130389675123834, vector3D2.getX(), 0.01);
      assertEquals(0.5417384204981296, vector1D0.getX(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = new Vector3D((-1.0), 2.0, (-3120.585988007608));
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.ZERO;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D((-1.0), 2.0, (-3120.585988007608));
      line0.reset(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.pointAt(1.375);
      assertEquals((-1.3749996470036365), vector3D3.getZ(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D((-1.0), 2.0, (-3120.585988007608));
      line0.reset(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.pointAt((-3120.585988007608));
      assertEquals(0.999999743275372, vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1.5830993332061267E-10, 1.5830993332061267E-10, 3.141592653489793);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.30816907107942976, vector3D2.getDelta(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.008333333333329196, vector3D0, 2435452.245511828, vector3D0, 2435452.245511828, vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      ...
      assertEquals(2.0356679280358928E-10, vector3D2.getNormInf(), 0.01);
      assertEquals(2.0356679280358928E-10, vector3D2.getZ(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(4.316099123496515E-34, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(964633.2479777725, 0.0);
      Vector3D vector3D1 = new Vector3D(964633.2479777725, vector3D0, 964633.2479777725, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.1816827588681355E-20, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      assertEquals(1.871505781424299E-54, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals(1.0961914204746172E-10, vector3D2.getNormInf(), 0.01);
      assertFalse(vector1D0.isNaN());
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0E-10, 8.0E298, (-1613.4656));
  ...
  public void test23()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.5417384204981296), vector3D2.getX(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals((-2.07752235210515E-17), vector3D2.getX(), 0.01);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(291.246, vector3D0, 1842.141899323, vector3D0, 1842.141899323, vector3D0, 291.246, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(427.0, vector3D0, 427.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-853.9999999999999), double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(1.1225128006598622E-10, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(1.1974215507507324, (-3934.299888987946));
      Line line1 = new Line(vector3D0, vector3D2);
      double double0 = line0.distance(line1);
      assertEquals(3.592523487312045E-18, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-0.4731979929340881), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0E-10, 8.0E298, 8.0E298);
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-8.0E298), vector3D0, 869.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test47()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(2.07752235210515E-17, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-1904.0363675), 1.0);
      Vector3D vector3D2 = new Vector3D(1.0, vector3D0, 1.1447751942335461E14, vector3D0);
  ...
  public void test52()  throws Throwable  {
      ...
      Line line1 = new Line(vector3D2, vector3D0);
      boolean boolean0 = line1.isSimilarTo(line0);
      assertEquals(4.1439439132339447E-20, vector3D2.getNormSq(), 0.01);
      assertTrue(boolean0);
  }
  ...
  public void test59()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(1.1537869203462652E-14);
      assertTrue(vector3D1.isNaN());
  }
