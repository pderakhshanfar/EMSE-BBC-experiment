...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(14.864748057802794, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = Vector3D.PLUS_J;
      Vector3D vector3D3 = new Vector3D(1.0E-10, vector3D2, 3.5752533198516354E7, vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = new Vector3D((-905.182266413378), (-328.03471), (-1.0));
      Vector3D vector3D2 = new Vector3D(362.3, vector3D1);
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2011.538793265395), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      line0.toSubSpace(vector3D2);
      assertEquals(9.364020646069917E-18, vector3D2.getNormInf(), 0.01);
      assertEquals(9.364020646069917E-18, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-3198.25173942), (-3198.25173942));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1557.1039326826299), (-1557.1039326826299), (-1557.1039326826299));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(5047.1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2913.9445436269607), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-4126.2), vector3D0, (-1365.997984), vector3D0, 4226.0, vector3D0, 14.864748057802794, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1365.997984));
      assertEquals((-1365.997984), vector3D2.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-3198.25173942));
      assertEquals((-0.7851770717426078), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.1102230246251565E-16, vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.intersection(line0);
      assertEquals(1.5707963267948968, vector3D3.getAlpha(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(4.057581611213029E-14, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1.0, vector3D0, (-679.9), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-678.9000000000001), double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1739.086588121844), 3862.577100711782, 3862.577100711782);
      Vector3D vector3D1 = new Vector3D((-1739.086588121844), vector3D0, (-1739.086588121844), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(4.614907366531043E-10, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1615.351234), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      double double0 = line0.distance(line1);
      assertEquals(3.821044207203067E-29, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1.0, (-679.9));
      Vector3D vector3D2 = new Vector3D(1.0, vector3D0, (-679.9), vector3D1);
      Vector3D vector3D3 = vector3D2.scalarMultiply(1470.8);
      Vector3D vector3D4 = new Vector3D((-4126.2), vector3D1, 1470.8, vector3D0, (-910.90989353137), vector3D2, 4054665.3011341426, vector3D2);
      Line line0 = new Line(vector3D2, vector3D1);
      Line line1 = new Line(vector3D3, vector3D4);
      Vector3D vector3D5 = line0.closestPoint(line1);
      assertEquals(261104.96182167792, vector3D5.getNorm1(), 0.01);
  }
  ...
  public void test44()  throws Throwable  {
      ...
      assertEquals(1.646396853165412E-27, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test45()  throws Throwable  {
      ...
      assertEquals(4.057581611213029E-14, vector3D3.getNormInf(), 0.01);
  ...
  public void test50()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(14.864748057802794, double0, 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(6.117342418929361E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      assertEquals(0.9999999999999546, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(14.864748057802794, vector3D0);
      Vector3D vector3D2 = new Vector3D(1.0, vector3D0, (-679.9), vector3D1);
      Vector3D vector3D3 = new Vector3D((-4126.2), vector3D1, 1470.8, vector3D0, (-910.90989353137), vector3D2, 4054665.3011341426, vector3D2);
      Line line0 = new Line(vector3D2, vector3D1);
  ...
  public void test59()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.991894986963887), vector3D2.getZ(), 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-678.9000000000001), vector1D0.getX(), 0.01);
      assertEquals(460905.20999999996, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test62()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0, vector3D0, (-679.9), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-4126.2));
      assertEquals((-4126.2), vector3D2.getZ(), 0.01);
  }
}
