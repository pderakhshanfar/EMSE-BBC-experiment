...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 3623.2520502949146, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line1);
      assertNotNull(vector3D2);
      assertEquals(1.0104616266535258E-13, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = vector3D0.add(3413.693389618, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3623.2520502949146, 3413.693389618);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 3623.2520502949146, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = Vector3D.POSITIVE_INFINITY;
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.1415926535897176, vector3D0, 4.983191803254889E-7, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(3.1415931519088978, vector3D2.getNormInf(), 0.01);
      assertEquals((-3.141593151908898), vector1D0.getX(), 0.01);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.0000000000000855, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals((-8.554809453571221E-14), vector3D2.getZ(), 0.01);
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.837903646481021E-17, vector3D0, 3623.2520502949146, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(3.837903646481021E-17);
      assertEquals(1.0218084571066459E-26, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(5.632566973392775E-14, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3413.693389618, 3413.693389618);
      Vector3D vector3D1 = vector3D0.normalize();
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(0.0);
      assertEquals((-4.2830770514536154E-4), vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 3623.2520502949146, vector3D0);
      Vector3D vector3D2 = vector3D1.add(3413.693389618, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals(1.0410418213560736E-26, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.0104616266535258E-13, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals(8.572984895409842E-27, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3256.7257155367083), (-3256.7257155367083));
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3623.2520502949146, 0.0);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 3623.2520502949146, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(9.726938925634688E-14, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-1.0), vector3D0, 328.9908712337715, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test22()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.18801889613303277), vector3D2.getX(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals(7.034129603122339E-14, vector3D2.getNormInf(), 0.01);
      assertEquals(5.632566973392775E-14, vector3D2.getY(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals(3623.2520502949146, double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(7.544686459599524E-14, double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(2.3827301660246976E-29, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.0104616266535258E-13, vector3D2.getX(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.08451937632745452, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-8.0E298), vector3D0, 1564.52286, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.744044161828129E-17, 3413.693389618);
      Vector3D vector3D1 = new Vector3D(333.2360408929, vector3D0, 3.141592653489793, vector3D0);
  ...
  public void test47()  throws Throwable  {
      ...
      assertEquals((-1.0000000000001008), double0, 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3413.693389618, 3413.693389618);
      Vector3D vector3D1 = new Vector3D(3623.2520502949146, vector3D0, 8.021042512045107E-11, vector3D0);
      Vector3D vector3D2 = vector3D1.add(7.698241726722549E11, (Vector<Euclidean3D>) vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
