...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1467.181, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line0.intersection(line1);
      assertEquals(3.544322437106817E-13, vector3D2.getY(), 0.01);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.0, 2584.62);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector1D vector1D0 = new Vector1D(376.383);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4415.2188, (-1851.441061567647), 3.141592653489793);
      Vector3D vector3D1 = new Vector3D((-1851.441061567647), vector3D0, 3.141592653489793, vector3D0, 1275.8762158, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.toSpace(vector1D0);
      assertEquals(4787.692651574049, vector1D0.getX(), 0.01);
      assertEquals(6269.801454221011, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, 0.5, 0.5);
  ...
  public void test09()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(0.4200675581974639);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1467.181, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1827.630552981));
      assertEquals(1827.6305529809995, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, 2584.62);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-2322.482805));
      assertEquals((-0.5924804022922331), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      assertNotNull(vector3D2);
      assertEquals(0.39498311045063406, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(409.368298, 409.368298, 409.368298);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.33360365045172463, vector3D2.getY(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2584.62, vector3D0, 2584.62, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.3755644316210433E-16, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1805.21616853938, 1008.317);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(Double.NaN, vector3D2.getDelta(), 0.01);
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.0, 2583.716774152318);
      Vector3D vector3D2 = new Vector3D(2722.423, vector3D1, (-39.873), vector3D1, 2.5696410601000027E10, vector3D1, 1178.42, vector3D0);
      Line line0 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals((-1.5707963378281562), vector3D3.getAlpha(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1.315780541321587E-16, vector3D0, 0.7057132573806629, vector3D0, 1.315780541321587E-16, vector3D0, (-143.753), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test23()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(4.0, vector3D0, 1241.611019145864, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-1.0), vector3D2.getY(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.5782893509944677), vector3D2.getX(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(2157.89506);
      double double0 = line0.getAbscissa(vector3D2);
      assertEquals(2157.89506, vector3D2.getZ(), 0.01);
      assertEquals(2157.89506, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(2.5379482741745564E-17, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(1.3755644316210433E-16, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(5189437.540082579, 5189437.540082579);
      Vector3D vector3D1 = new Vector3D((-8.0E298), (-8.0E298), 5189437.540082579);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.7040177640276026E-11, 3.7040177640276026E-11, 4.0);
      Vector3D vector3D1 = new Vector3D(1239.956786, vector3D0, 6.838155000468399E12, vector3D0, (-1543.5303726509685), vector3D0, (-1543.5303726509685), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(9.554821513794638E-15, double0, 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1239.956786, vector3D0, 6.838155000468399E12, vector3D0, (-1543.5303726509685), vector3D0, (-1543.5303726509685), vector3D0);
  ...
  public void test61()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1412.152550152082);
      assertEquals(1994175.7660774998, vector3D2.getNormSq(), 0.01);
  }
