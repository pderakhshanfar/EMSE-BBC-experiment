...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, 2507.24742214, vector3D0);
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2310.84, vector3D0, (-3962.899248006955), vector3D0, 5.041914939880371, vector3D0, 1.0E-10, vector3D0);
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(2507.24742214, 1.0, 1.0);
      Vector3D vector3D2 = new Vector3D(5.041914939880371, vector3D1, 785.1547434555424, vector3D0, 785.1547434555424, vector3D0, 1.0, vector3D0);
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals(4.485569664152616E-26, vector3D2.getNormSq(), 0.01);
      assertEquals(2.117916349658932E-13, vector3D2.getZ(), 0.01);
  }
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(2507.24742214, 2507.24742214);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(2507.24742214, 1.0, 1.0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D2);
      Line line1 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line1.toSpace(vector1D0);
      assertEquals((-3.1411938098465932), vector3D3.getAlpha(), 0.01);
      assertEquals((-1919.7239351241253), vector1D0.getX(), 0.01);
      assertEquals(5.209081843775079E-4, vector3D3.getDelta(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2507.24742214), vector1D0.getX(), 0.01);
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1771.7899, 5.041914939880371);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2310.84, vector3D0, (-3962.899248006955), vector3D0, 5.041914939880371, vector3D0, 2310.84, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2507.24742214, 2507.24742214);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(4364.361);
      assertEquals(0.6573372843678845, vector3D2.getDelta(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(1.5874010519681994);
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2310.84, vector3D0, (-3962.899248006955), vector3D0, 5.041914939880371, vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1418.31));
      assertEquals((-1418.31), vector3D2.getY(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(3.7896194332857995E-17, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(0.3333333333333333, 2507.24742214);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.6268408496038429, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0E-10, 1.0E-10, 2433.0);
      Vector3D vector3D1 = new Vector3D((-392.5477182287), vector3D0, 709.09, vector3D0, 2433.0, vector3D0);
      Vector3D vector3D2 = new Vector3D(1.0E-10, vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.intersection(line0);
      assertEquals(3.373245552337321E-20, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals(3.7896194332857995E-17, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      line0.reset(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.0255279003144843E-17, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(981.8901112, 0.3333333333333333);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.1438133590601234, vector3D2.getDelta(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals(4.485569664152616E-26, vector3D2.getNormSq(), 0.01);
      assertEquals(2.117916349658932E-13, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, 2507.24742214, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(0.0, 1.0, 1543.515810193754);
  ...
  public void test29()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = new Vector3D(2507.24742214, 1.0, (-3204.901088458));
      line0.reset(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.closestPoint(line1);
      assertEquals(2507.2474221399993, vector3D3.getNorm1(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(3.7896194332857995E-17, vector3D2.getY(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.1614194027495271, vector3D2.getX(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0, vector3D0, 1.0, vector3D0, (-1.7976931348623157E308), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2310.84, vector3D0, 2310.84, vector3D0, 5.041914939880371, vector3D0, 2310.84, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(2.117916349658932E-13, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      assertEquals((-2507.24742214), double0, 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      assertEquals(3.5476586721264467E-17, double0, 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(2507.24742214, 1.0, 1.0);
      Vector3D vector3D4 = Vector3D.crossProduct(vector3D2, vector3D3);
      line0.reset(vector3D4, vector3D1);
      assertEquals(5.310140730349364E-10, vector3D4.getNorm(), 0.01);
  ...
  public void test58()  throws Throwable  {
      ...
      assertEquals((-4364.361), vector3D2.getZ(), 0.01);
      assertEquals(4364.361, double0, 0.01);
  }
