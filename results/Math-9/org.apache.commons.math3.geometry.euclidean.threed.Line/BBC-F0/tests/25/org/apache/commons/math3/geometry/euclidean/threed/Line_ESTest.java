...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(7.850462293418876E-17, 7.850462293418876E-17, 11.01459083276444);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(197.535, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      assertEquals((-197.53500000000003), vector1D0.getX(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(197.535, 197.535);
      Vector3D vector3D1 = new Vector3D(197.535, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(892.76295);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-335.56424712127074), vector3D2.getZ(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals(892.76295, vector3D2.getX(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1537.0), vector3D0, (-1537.0), vector3D0, (-1537.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(197.535, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(197.535);
      assertEquals(39020.07622500001, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, (-257.005));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-293.07248089479));
      assertEquals((-166.83253470849684), vector3D2.getZ(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-1307.7));
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals(0.8678720715352595, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(3.415236843329339E-17, vector3D2.getNormInf(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0682640795006817, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(6.189579878977658E-17, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.090581796470643E-28, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.9999999999999997, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test30()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-2341.565), 3.141592653489793, 3785.2700780343357);
      Line line1 = new Line(vector3D1, vector3D2);
      double double0 = line0.distance(line1);
      assertEquals(2.6205070539107967E-20, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      assertEquals((-1.445884433995554E-14), vector3D2.getX(), 0.01);
  }
  ...
  public void test43()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(0.1256551444530487, vector3D0, 0.1256551444530487, vector3D0, (-346.0), vector3D0, 0.1256551444530487, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(183.88593153869246, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.063210269956081E-29, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.8330899416834334E-14, vector3D2.getX(), 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Vector3D vector3D2 = new Vector3D(9.672101746681023E20, vector3D1, 9.672101746681023E20, vector3D1, 9.672101746681023E20, vector3D0, 9.672101746681023E20, vector3D1);
  ...
  public void test56()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1929.3616692060418, vector3D0, 8.124785583970729E34, vector3D0, -0.0, vector3D0, -0.0, vector3D0);
      Vector3D vector3D2 = new Vector3D((-1333.497462765579), vector3D1, (-1333.497462765579), vector3D1, 4.440892098500626E-16, vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1947.0911687827156), (-307.41319407604));
      Vector3D vector3D1 = new Vector3D(1427.03777, vector3D0, 1427.03777, vector3D0, (-307.41319407604), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test58()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.375871609727163), vector3D2.getZ(), 0.01);
  }
  ...
  public void test62()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.588565603670437E-33, vector3D2.getNormSq(), 0.01);
  }
}
