...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-141.0867227049133), (-141.0867227049133));
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2403.146), (-2403.146), (-2403.146));
      Vector3D vector3D1 = new Vector3D((-2403.146), vector3D0, (-2403.146), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(4162.370970008128, vector1D0.getX(), 0.01);
      assertEquals(4162.370970005916, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(5.2240336371356666E-9, 5.2240336371356666E-9);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-0.16624879837036133), (-0.16624879837036133), (-0.16624879837036133));
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1.0));
      assertEquals(0.9412247838982939, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(394.763865968521);
      assertEquals(394.763865968521, vector3D2.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(5232657.354482832, 3595.19782013);
      Vector3D vector3D1 = new Vector3D(5232657.354482832, vector3D0, 5232657.354482832, vector3D0, 35.20439062, vector3D0, (-7.44321345601866E-11), vector3D0);
      Vector3D vector3D2 = new Vector3D(3.141592653489793, vector3D1, (-7.44321345601866E-11), vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals((-3.8972950201261967E-10), vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2286.500241417), 0.0);
      Vector3D vector3D1 = new Vector3D((-2286.500241417), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.035722248125526E-13, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.7658662796966758), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals(1.9428377143756173E-9, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(324.6920562621, vector3D0, 324.6920562621, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(3.8727036243090107E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals((-0.7071067830335223), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(8.0, vector3D0, 9.94818777380963E29, vector3D0, 1.7976931348623157E308, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test25()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-2286.5002414170003), double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.0, 1685.8537284270333);
      Vector3D vector3D1 = new Vector3D(273.85876298024, vector3D0, (-2056.24053323917), vector3D0, (-2056.24053323917), vector3D0, 2684.3489891, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(2.811032960264623E-17, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = Vector3D.crossProduct(vector3D0, vector3D1);
      Vector3D vector3D3 = vector3D0.subtract(4.440892098500626E-16, (Vector<Euclidean3D>) vector3D2);
      line0.reset(vector3D2, vector3D3);
      Vector3D vector3D4 = line0.closestPoint(line0);
      assertEquals(0.5000000026120166, vector3D4.getNormInf(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(5228083.35611151, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test45()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-0.4999999973879832), vector3D2.getZ(), 0.01);
  }
  ...
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-3341.5311171443), vector3D0, 0.0, vector3D0, (-3341.5311171443), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      try { 
  ...
  public void test49()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D1);
      assertEquals(1.8578295707663003E-13, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(422999.4938238912, vector3D0, 1.2247448681925348, vector3D0, 422999.4938238912, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(846000.2123926507, double0, 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-3.8727036243090107E-14), vector3D2.getY(), 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.9999999999999611), vector1D0.getX(), 0.01);
  ...
  public void test58()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(7.820120488232571E-10, vector3D2.getNormInf(), 0.01);
  }
}
