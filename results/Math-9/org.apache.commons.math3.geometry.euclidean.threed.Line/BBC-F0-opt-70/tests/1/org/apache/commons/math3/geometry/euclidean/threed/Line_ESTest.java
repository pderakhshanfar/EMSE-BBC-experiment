...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-110.0), vector3D0);
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1.0), vector3D0, (-1.0), vector3D0, 1.0E-10, vector3D0, 2572.569640271, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(1.0E-10, 0.0, 0.0);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1989.90785519157), (-1989.90785519157));
  ...
  public void test05()  throws Throwable  {
      ...
      Vector1D vector1D0 = new Vector1D(418.717184677566);
      Vector3D vector3D2 = line1.toSpace(vector1D0);
      assertEquals((-0.9179064412458153), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals(2.1094237467877974E-15, vector1D0.getX(), 0.01);
  ...
  public void test09()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-3314.024527755675));
      assertTrue(vector3D1.isNaN());
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.5850973129272461, 0.5850973129272461);
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-3735.6951699), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-3735.6951699));
      assertEquals(3735.6951699, vector3D2.getY(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Vector3D vector3D2 = vector3D1.subtract((-1710.069887), (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals(3.4235757676215506E-7, vector3D3.getY(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.643373398059803, vector3D2.getDelta(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      assertEquals(8.673617379884035E-18, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.1974215507507324, 0.0);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.931101667639659, vector3D2.getY(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(274.97957488, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-102.34717662247006), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test31()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.526540159664574E-33, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      doubleArray0[0] = (-545.32019);
      doubleArray0[1] = (-545.32019);
      doubleArray0[2] = (-545.32019);
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D((-545.32019), vector3D0, (-296.70106183464395), vector3D0, (-1983.0), vector3D0, 2.028240960365167E31, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test46()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(5672.629302392447, 5672.629302392447);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-0.6035591636016776), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      assertEquals((-0.4999999999999999), vector3D2.getX(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-0.9999999999998315), double0, 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(1.2537167179050217E-16, vector3D1, 3.141592653589793, vector3D1, 3.141592653589793, vector3D1);
  ...
  public void test53()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-1.6852912651779664E-13), vector3D2.getZ(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      Vector3D vector3D3 = new Vector3D(1.2537167179050217E-16, vector3D2, 3.141592653589793, vector3D2, 3.141592653589793, vector3D2);
      Line line1 = new Line(vector3D2, vector3D3);
      boolean boolean0 = line0.isSimilarTo(line1);
      assertEquals(4.442882938158366, vector3D3.getX(), 0.01);
      assertFalse(boolean0);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1.0), vector3D0, (-1.0), vector3D0, 1.0E-10, vector3D0, 2572.569640271, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(2572.569640271, vector3D1);
      Line line1 = new Line(line0);
  ...
  public void test61()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.8402066484851505E-26, vector3D2.getNormSq(), 0.01);
  }
}
