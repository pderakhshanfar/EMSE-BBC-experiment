...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      doubleArray0[0] = 3.999947209610299;
      doubleArray0[1] = 3.999947209610299;
      doubleArray0[2] = 3.999947209610299;
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.188222931214247E-29, 2.188222931214247E-29);
      Vector3D vector3D1 = new Vector3D(2.188222931214247E-29, vector3D0, 2.188222931214247E-29, vector3D0, 2.188222931214247E-29, vector3D0);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0, vector3D0, (-239.38524569), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector1D vector1D1 = new Vector1D(0.0, vector1D0, 1.0, vector1D0, (-1864.4838450288), vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals((-1863.4838450288), vector3D2.getX(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector1D vector1D1 = new Vector1D(0.0, vector1D0, 1.0, vector1D0, (-1864.4838450288), vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals(1318.1820634514459, vector3D2.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(281.12254);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(636.34865321076);
      assertEquals((-636.34865321076), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2502.446806465797, 2502.446806465797);
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(4.0);
      assertEquals((-0.07278904301532521), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1.2537167179050217E-16, (-0.1428571423679182));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test14()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(4.930380657631324E-32, vector3D2.getNorm1(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0E-10, 938.78585359139);
      Vector3D vector3D1 = new Vector3D((-1072.867770075), vector3D0, 938.78585359139, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.351517854538133E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(234.0805308697277, vector3D0, (-219.8682036270388), vector3D1);
      Line line0 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(1.0281741916219298, vector3D3.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1.0, vector3D0, 1.4027296307003151E233, vector3D0, 0.4958051833270594, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1423.4647, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals(0.9999999999999968, double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals((-134.08191648360994), double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1380.3148704334576));
      ...
      assertEquals((-976.5300050561285), vector3D2.getX(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.7905175636414186, vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3725.5882953618, 3725.5882953618);
      Vector3D vector3D1 = new Vector3D(3725.5882953618, vector3D0, (-239.38524569), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-3.595860456544182E-14), vector3D2.getZ(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.9634198961428728E-25, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.0);
      Vector3D vector3D1 = new Vector3D(21.210834937687743, vector3D0, 0.0, vector3D0, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(688.243503262792, (-813.51944724));
      Vector3D vector3D1 = new Vector3D((-813.51944724), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.2537167179050217E-16, (-0.1428571423679182));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D((-2440.429699623111), (-1617.5636929909197), (-1785.247205495));
      Vector3D vector3D3 = vector3D2.add((-2639.8710103640365), (Vector<Euclidean3D>) vector3D2);
  ...
  public void test56()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-824.02), (-824.02), 1.4600115517807785E10);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D((-824.02), vector3D0, 1.4600115517807785E10, vector3D1, (-824.02), vector3D1);
  ...
  public void test59()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.6461036499856359), vector3D2.getY(), 0.01);
  }
