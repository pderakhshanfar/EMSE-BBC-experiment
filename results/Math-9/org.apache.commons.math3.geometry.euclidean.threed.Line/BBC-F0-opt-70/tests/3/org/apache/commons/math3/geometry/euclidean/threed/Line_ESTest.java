...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1.9987994582857286E-8, vector3D0, 1.9987994582857286E-8, vector3D0, 1.9987994582857286E-8, vector3D0, 1.9987994582857286E-8, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.1013539060986659, 0.1013539060986659, 93.378463504);
      Vector3D vector3D1 = new Vector3D(0.1013539060986659, vector3D0, (-1599.726567708), vector3D0, 1200297.5862045486, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, (-4086.416), 3299.0);
      Vector3D vector3D1 = new Vector3D((-4086.416), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test10()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(2788213.5669956394);
      assertEquals((-2788213.5669956394), vector3D2.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-2441.5677638693));
      assertEquals((-0.785687775167345), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(2435.6981117781);
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals(6.184176842261413E-47, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.2599210498948732, vector3D0, 1.2599210498948732, vector3D0, 1.2599210498948732, vector3D1);
      Line line0 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals((-0.8786318227347438), vector3D3.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(227.73907, vector3D0, 3.141592653489793, vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(3.400981329807555E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Vector3D vector3D2 = new Vector3D(1.0E-10, 0.19454771280288696, (-1159.198941));
      line0.reset(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals((-0.0010304937726695205), vector3D3.getDelta(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals(0.8418901651837978, vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-711.0786), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(1.266892696367325E-34, vector3D2.getNormSq(), 0.01);
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals((-93.37857352097944), double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1947.59), vector3D0);
      ...
      assertEquals(4.671664190746223E-33, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(2.6428822651129788E-33, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.68164, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.00645756799625E-33, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Vector3D vector3D2 = new Vector3D(121856.63909559275, vector3D1);
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Vector3D vector3D2 = new Vector3D(121856.63909559275, vector3D1);
      Vector3D vector3D3 = vector3D2.scalarMultiply(121856.63909559275);
      Line line0 = new Line(vector3D2, vector3D3);
      Line line1 = new Line(line0);
      line0.reset(vector3D2, vector3D0);
      Vector3D vector3D4 = line0.getDirection();
      line0.reset(vector3D2, vector3D4);
      assertEquals(0.9999999999663276, vector3D4.getX(), 0.01);
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(121856.63909559275, vector3D0);
      Vector3D vector3D2 = vector3D1.scalarMultiply(121856.63909559275);
      Line line0 = new Line(vector3D1, vector3D2);
      Line line1 = new Line(line0);
  ...
  public void test59()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = vector3D0.scalarMultiply(121856.63909559275);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
  ...
  public void test63()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-3.172471541237604E-17), vector3D2.getX(), 0.01);
  }
}
