...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      assertEquals(1.5707963266948965, vector3D3.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(2.5076096730460963E-15, 2.5076096730460963E-15, 2.5076096730460963E-15);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(5121.4159, 5121.4159);
      Vector3D vector3D1 = new Vector3D(2122.014, vector3D0, (-2181.5768), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(0.0);
      line0.toSubSpace(vector3D2);
      assertEquals(8.469167260531625E-15, vector3D2.getX(), 0.01);
      assertEquals(1.1190587331041513E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(3547.7271438399657, vector3D2.getNormSq(), 0.01);
      assertEquals((-59.56279999999972), vector1D0.getX(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2.800552834259E-8, 5.650007086920087E-9, (-2829.539));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test09()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-2222.6787103882257));
      assertEquals((-1572.1711885144846), vector3D2.getY(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2122.014, vector3D0, (-2181.5768), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(138.811);
      assertEquals((-80.63990943008201), vector3D2.getZ(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      assertEquals((-4.095873661379688E-13), vector3D2.getZ(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(4.0, vector3D0, 4.0, vector3D0, 4389.268235, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-4.216685930289319E-13), vector3D2.getY(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(6.523205016325644E-17, vector3D2.getY(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(683.096377624679, 3338.0, 88209.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.9999402939572042, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals((-0.58093313519881), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1466.1), vector3D0, 1.0000000000605972E-10, vector3D0, 8.0E298, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D(0.0, vector3D0, 2921.08, vector3D0, 0.0, vector3D0, 3609.440301040992, vector3D1);
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals(1.748819648439637E-14, double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals(2.57361734449476E-15, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1052.16671784266, vector3D0, (-1849.3471682575685), vector3D0, (-1849.3471682575685), vector3D0, 2.5076096730460963E-15, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-2.0904093423093155E-13), vector3D2.getX(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(3.2849501009785654E-16, vector3D2.getZ(), 0.01);
  }
  ...
  public void test41()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-4624.0), vector3D0, (-4624.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test44()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(136.61424735314952, (-2026.35897351));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.4992419552223947, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test45()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0000000000000002, 1.0000000000000002);
      Vector3D vector3D1 = new Vector3D(2122.014, vector3D0, (-2181.5768), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test47()  throws Throwable  {
      ...
      assertEquals(0.5809331351988098, vector3D0.getZ(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(1.570796326794899, vector3D2.getAlpha(), 0.01);
      assertNotNull(vector3D2);
  }
