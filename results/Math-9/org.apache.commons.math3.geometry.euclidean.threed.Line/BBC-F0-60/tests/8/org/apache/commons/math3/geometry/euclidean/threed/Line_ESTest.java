...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Vector3D vector3D1 = new Vector3D(1992.125, 0.041666663879186654);
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.1795268640216787E-8, vector3D0, (-3766.87788463344), vector3D0, 0.25, vector3D0, (-3766.87788463344), vector3D0);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1330.7, (-1194.8524));
      Vector3D vector3D1 = new Vector3D(1330.7, vector3D0, 0.0, vector3D0, 1164.53, vector3D0, 0.4794255495071411, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-7.611067241974907E-14), vector3D2.getZ(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1368.78);
      assertEquals(2.3567110865177474, vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1330.7, 1330.7);
      Vector3D vector3D1 = new Vector3D(1330.7, vector3D0, 0.0, vector3D0, 1164.53, vector3D0, 1330.7, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-349.056985355));
      assertEquals((-79.20061047223096), vector3D2.getY(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1355589.4559839123, vector3D0, 1355589.4559839123, vector3D0, 0.5039018405998233, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.5642791217808178E-10, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1330.7, 1330.7);
      Vector3D vector3D1 = new Vector3D(1330.7, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.2984823119506678E-26, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      assertNotNull(vector3D2);
      assertEquals(1.302620418717787E-29, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals((-1.087212847158362), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(434.149, vector3D0, 294.2268861247, vector3D0, 294.2268861247, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.1663503046685384E-28, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1330.7, (-1194.8524));
      Vector3D vector3D1 = Vector3D.ZERO;
      Vector3D vector3D2 = vector3D1.scalarMultiply((-1378.294977123));
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1330.7, (-1194.8524));
      Vector3D vector3D1 = Vector3D.ZERO;
      Vector3D vector3D2 = new Vector3D(1330.7, vector3D0, 0.0, vector3D0, 1164.53, vector3D0, 1330.7, vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(5.160441917738829E-14, double0, 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      assertEquals((-1.0000000000000147), double0, 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(7.229430217255047E-14, double0, 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals(7.236576529875952E-14, double0, 0.01);
  }
  ...
  public void test44()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1331.6961791464544, 1331.6961791464544);
      Vector3D vector3D1 = Vector3D.ZERO;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
  ...
  public void test47()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-2.0045025114232518E-14), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1331.6961791464544, 1331.6961791464544);
      Vector3D vector3D1 = new Vector3D(8.649254397186506E7, vector3D0, 1331.6961791464544, vector3D0, 423.6127, vector3D0);
      Vector3D vector3D2 = vector3D0.add(795.1246667, (Vector<Euclidean3D>) vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
  ...
  public void test52()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.9723951838302929), vector3D2.getZ(), 0.01);
  }
