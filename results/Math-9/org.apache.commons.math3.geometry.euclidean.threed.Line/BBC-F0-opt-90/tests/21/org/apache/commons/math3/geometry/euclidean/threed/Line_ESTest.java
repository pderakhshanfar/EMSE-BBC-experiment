...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.9315965175628662, 0.9315965175628662, (-4396.40567142384));
      Vector3D vector3D1 = new Vector3D(0.9315965175628662, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line1.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-1.213790657271978E-16), vector3D2.getY(), 0.01);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      assertEquals((-1.213790657271978E-16), vector3D2.getX(), 0.01);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = new Vector3D(1542.136, (-1.5707963267948966));
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2432.0), vector3D0, (-2432.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test08()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector1D vector1D1 = new Vector1D((-4396.40567142384), vector1D0, 0.07073719799518585, vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals((-1.932807270616735E7), vector1D1.getX(), 0.01);
      assertEquals((-4095.6103147647705), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(4.983191803254889E-7, vector3D0);
      Vector3D vector3D2 = new Vector3D(4.983191803254889E-7, vector3D1, 4.983191803254889E-7, vector3D1, 4.983191803254889E-7, vector3D1);
      Vector3D vector3D3 = new Vector3D(4.983191803254889E-7, vector3D2, 4.983191803254889E-7, vector3D2);
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = vector3D0.scalarMultiply(4.983191803254889E-7);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(4.983191803254888E-7, vector1D0.getX(), 0.01);
      assertEquals(4.983191803254888E-7, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1717.3087429485668), 1560.263597416, 3.669500303428619E-13);
      Vector3D vector3D1 = new Vector3D(1560.263597416, vector3D0, 3.141592653489793, vector3D0, 1560.263597416, vector3D0, (-1442.3893519234), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(1351.330092);
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.4896289949727798E-16, 1.4896289949727798E-16);
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1.4896289949727798E-16);
  ...
  public void test16()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(2.3668225E7);
      assertEquals((-1.6735961896148972E7), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1717.3087429485668), 1560.263597416, 0.0);
      Vector3D vector3D1 = new Vector3D(1560.263597416, vector3D0, 3.141592653489793, vector3D0, 1560.263597416, vector3D0, (-1442.3893519234), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1442.3893519234));
      assertEquals(2.4040729533426646, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-346.5909592826), vector3D0, 3.7358645494109506E14, vector3D0, 0.0, vector3D0, (-346.5909592826), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(0.004565718488988124, vector3D2.getY(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(90438.21510982963, 1.0, 1.0E-10);
      Vector3D vector3D2 = new Vector3D((-1093.4), vector3D0, 4709.580235766862, vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.intersection(line0);
      assertEquals(2.5535135832168066E-6, vector3D3.getX(), 0.01);
  ...
  public void test22()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1458.0812543934842, vector3D0, (-1489.357325), vector3D0, 1458.0812543934842, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(4.7407270824544845E-17, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals((-0.4272499830956933), vector3D2.getX(), 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.9999999999999999, 0.9999999999999999, (-8.0E298));
      Vector3D vector3D1 = new Vector3D(3.1359833278813765E-13, vector3D0, 0.9999999999999999, vector3D0, 0.9999999999999999, vector3D0, 0.9999999999999999, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test31()  throws Throwable  {
      ...
      assertEquals(4095.676397193808, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-442.0727), vector3D0, 1221.16569, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test33()  throws Throwable  {
      ...
      assertEquals(7.071067811865477E-11, double0, 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      assertEquals(2.3845607237787664E-58, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test40()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1458.306, 1458.306, (-8.0E298));
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test52()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.9315965175628662, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D0.scalarMultiply((-4395.317625424157));
      boolean boolean0 = line0.contains(vector3D2);
      assertFalse(boolean0);
  }
  ...
  public void test55()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2929.36101, 2929.36101, 2929.36101);
      Vector3D vector3D1 = new Vector3D(2929.36101, vector3D0, 2929.36101, vector3D0, 2929.36101, vector3D0, (-2455.091943732296), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(8.705723917500507E-13, double0, 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      assertEquals((-5073.80210303229), double0, 0.01);
  }
  ...
  public void test57()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(3.5605129210295296E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.9315965175628662, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D0.scalarMultiply((-4396.40567142384));
  ...
  public void test65()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.7458126656028054E-9, vector3D2.getNorm1(), 0.01);
  }
