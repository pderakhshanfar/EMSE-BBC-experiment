...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals(1.0008877888391339, vector3D2.getNorm1(), 0.01);
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0708593250394448E-7, vector3D0, 1.0708593250394448E-7, vector3D0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.0624671188120985E-18, 3512.2206384429514, 3512.2206384429514);
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 1429.087536);
      Vector3D vector3D1 = new Vector3D(1.0708593250394448E-7, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      line0.toSubSpace(vector3D2);
      assertEquals(1.8211383314333828E-24, vector3D2.getX(), 0.01);
      assertEquals(8.735889682690551E-48, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1632.5604114616447), 1561.930852);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1061.6648237, 1.0708593250394448E-7);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(9.999999999999752E-11, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1125.392196919);
      assertEquals(1125.3926412081178, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(0.6299605249474366);
  ...
  public void test15()  throws Throwable  {
      double[] doubleArray0 = new double[3];
      doubleArray0[1] = (-1460.177249106);
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(4.122408825144661E-30);
      assertEquals((-6.848480426766869E-4), vector3D2.getY(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(4.094189840915568E-24, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.8330604869872256, 1429.087536);
      Vector3D vector3D1 = new Vector3D(1.0708593250394448E-7, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.4162578279545004, vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3770.732676, 3770.732676);
      Vector3D vector3D1 = new Vector3D(3770.732676, vector3D0, 3770.732676, vector3D0, 0.036, vector3D0, 1.0168721239313498E-13, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-5.051656558175141E-17), vector3D2.getY(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals(4.094189840915568E-24, vector3D2.getX(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-2.6249432327998043), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(134.32, 134.32);
      Vector3D vector3D1 = new Vector3D(134.32, vector3D0, 1.7976931348623157E308, vector3D0, (-1864.9911), vector3D0, 2340.6059935452886, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test25()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.7070060959120227), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1241.6354363525, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-1.0), vector3D2.getX(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1769.6589, 1769.6589, 1769.6589);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(9.034406266127194E-17, double0, 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0708593250394448E-7, 1429.087536);
      Vector3D vector3D1 = new Vector3D(1.0708593250394448E-7, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.693528337099456E-17, vector3D2.getZ(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1.7976931348623157E308, (-6.663542893624021E-14), (-6.663542893624021E-14));
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test47()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-0.6664155433823448), vector3D2.getZ(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D4 = new Vector3D(1.0E-10, vector3D2, 1.0E-10, vector3D3);
      Line line2 = new Line(vector3D0, vector3D4);
      boolean boolean0 = line2.isSimilarTo(line1);
      assertEquals(1.6762390453456245E-47, vector3D2.getNormSq(), 0.01);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(5382.91963, (-595.0002311580783));
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0);
      Vector3D vector3D2 = new Vector3D(1.0E-10, 0.0, 0.0);
      Vector3D vector3D3 = vector3D0.subtract(5382.91963, (Vector<Euclidean3D>) vector3D2);
  ...
  public void test57()  throws Throwable  {
      ...
      assertEquals(2.1417186500788895E-7, double0, 0.01);
  }
  ...
  public void test63()  throws Throwable  {
      ...
      assertEquals(1.2258124344528104E-38, double0, 0.01);
  }
}
