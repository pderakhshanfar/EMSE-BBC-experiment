...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 2.0919157430548814, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line1.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(7.465549821667228E-17, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(2.0919157430548814, vector1D0.getX(), 0.01);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.9260723472437067E-29, 2.2204460492495607E-16);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(1400.124791);
      assertTrue(vector3D1.isNaN());
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1288.9, (-2053.7538638), (-1.0));
      Vector3D vector3D1 = new Vector3D((-1.0), vector3D0, 1.1102230246251565E-16, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1652.61763);
      assertEquals((-1652.61763), vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1863.3875777407), (-1863.3875777407));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.6450777439689026, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-1215.5), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(3.095397202446115E-17, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0, 1.7976931348623157E308, 1.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.0, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2031.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test26()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(505.0449, vector3D0, 0.0, vector3D0, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test27()  throws Throwable  {
      ...
      doubleArray0[2] = (-1915.787352426573);
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D(2156.00617, vector3D0, 2156.00617, vector3D0, 1.148542766809911E-29, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.7345587541740864E-14, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(4077086.25705616, 5.376111476040856, 5.376111476040856);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.9999999999994239, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test38()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1863.3875777407), vector3D0, (-1863.3875777407), vector3D0, (-1863.3875777407), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test44()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(7.465549821667228E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(1.5576577473674367E-16, double0, 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      double double0 = line0.distance(line1);
      assertEquals(4.111218582652364E-17, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-1119.0), vector3D0, (-1119.0), vector3D0);
      Vector3D vector3D2 = new Vector3D((-1119.0), vector3D1, 6659993.507605707, vector3D1, 6659993.507605707, vector3D0, 3019.5424, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test58()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals(1.000000000000076, double0, 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D(1.8598200211421523);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1.1487214333943838), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(3242.16617814611);
      assertEquals((-0.7856162604138015), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test62()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(7.605027718682322E-14, vector3D2.getNorm1(), 0.01);
  }
