...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(13230.824859727087, vector3D0, 13230.824859727087, vector3D0, 13230.824859727087, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line0.intersection(line1);
      assertNotNull(vector3D2);
      assertEquals(6.398749323993066E-17, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1258.22, 1906.69007, 1258.22);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(1906.69007, vector3D0);
      ...
      assertEquals(1258.2200000000018, vector3D4.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(9599711.544027455, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(2.1626096739733273E11, vector3D1, 0.0, vector3D1, 1.0E-10, vector3D2, 3.0095696449279785, vector3D1);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector1D vector1D0 = new Vector1D(2724.5372);
  ...
  public void test07()  throws Throwable  {
      ...
      assertEquals((-445.0963207925873), vector3D3.getX(), 0.01);
      assertEquals((-920.4337968243918), vector1D0.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1906.69007, vector3D0, 1906.69007, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.9361387424334485E-13, vector3D2.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-783.27727088821));
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals((-0.28422391446684003), vector3D2.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1906.69007, vector3D0, 1906.69007, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1906.69007);
      assertEquals((-1906.69007), vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1906.69007);
      assertEquals((-921.2007598118244), vector3D2.getX(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1997.827415407716, 0.0, 1.7455558976757265E-20);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.0005002930674274, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1906.69007, vector3D0, 1906.69007, vector3D0);
      Vector3D vector3D2 = new Vector3D(9599711.544027455, vector3D1);
      Line line0 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(5.518000859326077E-17, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-681.437623989624), vector3D0, (-716.6218531), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals(3813.38014, double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals(0.0, double0, 0.01);
      assertEquals(0.26912111187461324, vector3D2.getDelta(), 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(0.6827330077733128, vector3D3.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1441.4222978345394, vector3D0, (-681.437623989624), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(5.857399067808941E-14, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(3.141592653489793, vector3D0, (-1.7976931348623157E308), vector3D1, (-654.785), vector3D0, 2.093113148661685E-17, vector3D0);
  ...
  public void test51()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(1.352675720519518, vector3D2.getNorm1(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      assertEquals(0.2328519479938665, vector3D3.getZ(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      assertEquals(8.349314848592747E-18, double0, 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D4 = vector3D2.subtract((Vector<Euclidean3D>) vector3D1);
      Line line1 = new Line(vector3D3, vector3D4);
      boolean boolean0 = line1.isSimilarTo(line0);
      assertFalse(boolean0);
      assertEquals(2.414213562373095, vector3D4.getNorm1(), 0.01);
  }
