...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(3.141592653489793, 13.07, 4.440892098500626E-16);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0E-10, vector3D0, 7632.301845, vector3D0, 2.4629226301098272E7, vector3D0, 2.4629226301098272E7, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.pointAt(2544.100615);
      assertEquals((-2544.100615), vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-330.049329805759));
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(2.587961635451351E7);
      assertEquals(2.5879616354513515E7, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-4.440892098500626E-16), vector3D0, (-4.440892098500626E-16), vector3D0, 1023.6416334679499, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
  ...
  public void test16()  throws Throwable  {
      ...
      assertNotNull(vector3D2);
      assertEquals(0.2726756432935795, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-805.6674), 1023.6416334679499);
      ...
      assertEquals(0.49568435481442963, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.9368958122305596), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1.494140625, 1.494140625);
      Vector3D vector3D2 = Vector3D.crossProduct(vector3D1, vector3D0);
      Line line0 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(0.0029322476369166165, vector3D3.getX(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals(0.7101518465691478, vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(2481.8920639984663, vector3D0, 2481.8920639984663, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.getDirection();
      assertEquals(1.0, vector3D2.getX(), 0.01);
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(0.7519387491033487, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D(1022.65, 8264372.340287862, 8264372.340287862);
      Vector3D vector3D2 = Vector3D.crossProduct(vector3D0, vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(1.16875874928765E7, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D(1022.65, 8264372.340287862, 8264372.340287862);
      Vector3D vector3D2 = new Vector3D(8264372.340287862, vector3D1, 1022.65, vector3D0, 1022.65, vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      double double0 = line0.getAbscissa(vector3D2);
      assertEquals((-9.660252711217252E13), double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(8.098816762257917E-7, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      assertEquals(4.875352659858561E-17, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.2733647914762246E-13, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(0.9999999999999999, vector3D0, 0.9999999999999999, vector3D1, 0.9999999999999999, vector3D1, (-1.0), vector3D0);
      Line line1 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line1.closestPoint(line0);
      assertEquals(9.30957127530195E-18, vector3D3.getX(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-4.440892098500626E-16), vector3D0, 8.0E298, vector3D0, 1.0750306896081219E-16, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test37()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-388.6), (-8.0E298), (-8.0E298));
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(2544.100615, vector3D0, 2544.100615, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      boolean boolean0 = line0.contains(vector3D0);
      assertTrue(boolean0);
  }
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1610.0, vector3D0, 1.0E-10, vector3D0, 587.20663291, vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      try { 
        line0.reset(vector3D0, vector3D0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(2544.100615, vector3D0, 2544.100615, vector3D0, 2544.100615, vector3D0);
      Vector3D vector3D2 = new Vector3D(2.4629226301098272E7, 2.4629226301098272E7);
      Line line0 = new Line(vector3D1, vector3D2);
  ...
  public void test55()  throws Throwable  {
      ...
      assertEquals(3.716639249218706E-17, double0, 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(2544.100615, vector3D0, 2544.100615, vector3D0, 2544.100615, vector3D0);
      Vector3D vector3D2 = new Vector3D(1.0E-10, vector3D0, 7632.301845, vector3D0, 2.4629226301098272E7, vector3D0, 2.4629226301098272E7, vector3D1);
      Vector3D vector3D3 = new Vector3D(2.4629226301098272E7, 2.4629226301098272E7);
  ...
  public void test65()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(8.151511464512183E-33, vector3D2.getNormSq(), 0.01);
  }
}
