...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1411.0, vector3D1, 0.9999999134339712, vector3D0, 0.9999999134339712, vector3D1);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line1.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals((-2.0427098774345814E-16), vector3D3.getDelta(), 0.01);
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, (-1800.85864), vector3D0);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2645.33492932442, 2645.33492932442);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector1D vector1D1 = new Vector1D((-915.89807999034), vector1D0, 0.0, vector1D0, 3111.7204690344147, vector1D0);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3965.48691206, 0.0, 0.0);
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.9999999999994793, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = line0.pointAt(559.3658);
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1082.431397988684);
      assertEquals(873.7636929185542, vector3D2.getY(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      assertEquals(0.6659834577732995, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.9999999999999996, (-1179.16), 0.9996219046104808);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D((-1179.16), vector3D1, 0.0, vector3D1, 0.9996219046104808, vector3D1);
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals(2.0426081367425436E-13, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(7.444883400972854E12, 1.9999999999999996, 0.9996219046104808);
      line0.reset(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals((-3.141592651408946), vector3D3.getAlpha(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1127.842973397), (-139.2498140195358), (-139.2498140195358));
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.getDirection();
      assertEquals((-0.12152093462072046), vector3D2.getZ(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2645.33492932442, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      double double0 = line1.getAbscissa(vector3D1);
      assertEquals(2645.33492932442, double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-1501.037354005), vector3D0, (-1501.037354005), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = vector3D0.scalarMultiply(1.2223503758382524E-18);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.0, vector3D1, 3.0, vector3D1, 1.0, vector3D1);
  ...
  public void test40()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2645.33492932442, vector3D0);
      Vector3D vector3D2 = new Vector3D(2645.33492932442, 2645.33492932442);
  ...
  public void test43()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2645.33492932442, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(2645.33492932442);
      assertEquals(2645.3349293244205, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test44()  throws Throwable  {
      ...
      assertEquals((-1.0000000000002556), double0, 0.01);
  }
  ...
  public void test45()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.556835095733984E-13, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      assertEquals(4.808639153571844E-19, double0, 0.01);
  }
  ...
  public void test48()  throws Throwable  {
      ...
      assertFalse(boolean0);
      assertEquals(0.7459665099535768, vector3D2.getY(), 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-5.523836042140859E-19), vector3D2.getDelta(), 0.01);
      assertEquals((-0.7459665099535768), vector1D0.getX(), 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D0);
      assertEquals(4.8844184972481025E-17, double0, 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(6.537405706777013E-26, vector3D2.getNormSq(), 0.01);
  }
