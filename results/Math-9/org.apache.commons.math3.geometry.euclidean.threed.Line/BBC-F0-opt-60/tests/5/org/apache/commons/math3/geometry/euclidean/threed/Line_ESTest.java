...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2323.7, vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = new Vector3D(3.141592653489793, 2323.7);
      line0.reset(vector3D0, vector3D2);
      double double0 = line1.distance(line0);
      assertEquals(4.263797769337235E-18, double0, 0.01);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 3.141592653489793, vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D1.add(3.141592653489793, (Vector<Euclidean3D>) vector3D0);
      Vector3D vector3D3 = Vector3D.PLUS_I;
      Vector3D vector3D4 = vector3D3.scalarMultiply(1.0E-10);
      Line line1 = new Line(vector3D2, vector3D4);
      line1.reset(vector3D2, vector3D1);
      Vector3D vector3D5 = line1.getDirection();
      line1.reset(vector3D4, vector3D5);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, (-1902.5856));
      Vector3D vector3D1 = vector3D0.scalarMultiply((-1902.5856));
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, 0.9999999999999644);
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 0.9999999999999644, vector3D0, 2320.69, vector3D0, 0.9999999999999644, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals(1.787487639794434E-15, vector1D0.getX(), 0.01);
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1659.0), (-8.0E298));
      Vector3D vector3D1 = new Vector3D(2151.6541717, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.042338395486962485), vector3D2.getZ(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.0000000000004272, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2151.6541717, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1.4130008790293347E-17);
      assertEquals(8.638237736400533E-33, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1464.6828, vector3D0, 3.141592653489793, vector3D0, 3.141592653489793, vector3D0, 2965.9996315113, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(2965.9996315113);
      assertEquals((-2965.9996315113), vector3D2.getY(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.141592653489793, 2363.75705135);
      Vector3D vector3D2 = new Vector3D((-1617.47224), vector3D0, (-1617.47224), vector3D0, (-1617.47224), vector3D0, (-1617.47224), vector3D1);
      ...
      assertEquals(2.9711474363675574, vector3D4.getNorm(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      assertEquals(0.00524055767829577, vector3D3.getZ(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      assertEquals(6.314971667888688E-33, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.1369174389553074E-13, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(3.141592653489793, 977.6919859503, (-8.0E298));
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Vector3D vector3D2 = new Vector3D(1.0, (-1902.5856));
      Line line0 = new Line(vector3D2, vector3D1);
  ...
  public void test26()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-2326.8415926534894), double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1464.6828, vector3D0, 3.141592653489793, vector3D0, 3.141592653489793, vector3D0, 2965.9996315113, vector3D0);
      Vector3D vector3D2 = new Vector3D(1464.6828, vector3D1, 1464.6828, vector3D1);
      Line line0 = new Line(vector3D0, vector3D2);
      double double0 = line0.distance(vector3D1);
      assertEquals(1.4020968404991094E-12, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(4.174030550510792E-32, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-1785.927024398), vector3D0, (-33.139506207665), vector3D0, 1028.67887977, vector3D0, (-1230.142612), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals((-0.49999999997637024), vector3D3.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1457.55819062, vector3D0, 286.477449111, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D2);
      Vector3D vector3D3 = line0.toSpace(vector1D0);
      assertEquals(1.784347457412708E-14, vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-1104.0), vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(8.219522178902586E12, 3.141592653489793, 0.027638671615773644);
      Vector3D vector3D1 = new Vector3D(8.219522178902586E12, vector3D0, 3006.4024, vector3D0);
      Vector3D vector3D2 = new Vector3D(8.219522178902586E12, vector3D1, (-952.134113), vector3D1, (-952.134113), vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test47()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1464.6828, vector3D0, 1464.6828, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      boolean boolean0 = line0.contains(vector3D0);
      assertTrue(boolean0);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(0.9789183602677468, vector3D2.getNormSq(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = vector3D0.add(3.141592653489793, (Vector<Euclidean3D>) vector3D0);
      Vector3D vector3D2 = Vector3D.PLUS_I;
      Vector3D vector3D3 = vector3D2.scalarMultiply(1.0E-10);
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1.0, (-1902.5856));
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test54()  throws Throwable  {
      ...
      assertEquals((-0.6096776800862613), vector3D2.getZ(), 0.01);
  ...
  public void test59()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.9999999999999982), vector1D0.getX(), 0.01);
