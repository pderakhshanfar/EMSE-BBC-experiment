...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.494140625, 1.494140625, 1.494140625);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4.0, 1.0);
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1022.5198, vector3D0, 1022.5198, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(0.0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2.2404404394050724E-13), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = vector3D0.add((-99.153), (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.0, vector3D2.getAlpha(), 0.01);
      assertEquals(98.15299999999999, vector1D0.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1022.5198, vector3D0, 1022.5198, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1022.5198);
      assertEquals(1022.5198000000003, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-262.0), vector3D0, (-262.0), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(497.11977975444154);
      assertEquals(497.11977975444154, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-1944.5061997593805), (-2459.86347262));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1944.5061997593805));
      assertEquals(1944.5063104303506, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-1944.5061997593805), vector3D0, 0.5, vector3D0, 0.3333333134651184, vector3D0, (-1944.5061997593805), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(6.134336612983966E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(5.019573362521594E-26, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.7155754330491328), vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2301.99498363744, 1.0E-10, 1.0E-10);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-636.0), vector3D0, (-636.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(3.141592653589778, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(818.7797, 1.7456501955915525E13, 4493.490991);
      Vector3D vector3D1 = new Vector3D(4493.490991, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals((-1.000000000000224), double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      double double0 = line1.distance(line0);
      assertEquals(6.188107150298392E-17, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.9238795325112867, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
  ...
  public void test33()  throws Throwable  {
      ...
      assertEquals(0.6560493783900441, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test46()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.2340293033615203E-16, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(6.941359302568767, vector3D2.getY(), 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(818.7797, 1.7456501955915525E13, 4493.490991);
      Vector3D vector3D1 = new Vector3D(4493.490991, vector3D0, 1.7456501955915525E13, vector3D0, 2277.0, vector3D0, 1.7456501955915525E13, vector3D0);
      Vector3D vector3D2 = new Vector3D(4493.490991, vector3D1);
  ...
  public void test57()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-7.8440634273280288E16), vector1D0.getX(), 0.01);
      assertEquals(7.8440634273280288E16, vector3D2.getY(), 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(1859.43589496941);
  ...
  public void test60()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2301.99498363744, vector3D0, 2301.99498363744, vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.573037587262029E-17, vector3D2.getNorm1(), 0.01);
  }
}
