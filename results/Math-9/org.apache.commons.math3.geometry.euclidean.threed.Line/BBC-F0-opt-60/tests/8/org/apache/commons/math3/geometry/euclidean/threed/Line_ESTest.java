...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1755.31978623), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line1.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.5365495370067614E-16, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1009.106968, (-17.439659), (-17.439659));
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line1.closestPoint(line0);
      assertEquals((-0.01725487370993869), vector3D2.getZ(), 0.01);
  }
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, 2271.94346316688, 2271.94346316688);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1009.106968, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D((-300.27));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(90162.07289999996, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, (-17.439659), (-17.439659));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(0.0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.02862322960783809), vector3D2.getY(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(434.67732504);
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-92.4));
      assertEquals(92.4, vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1009.106968, (-17.439659), (-17.439659));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-17.439659));
      assertEquals(17.433866992744225, vector3D2.getX(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      assertEquals(1.0004400548884531, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, 2271.94346316688, 2271.94346316688);
      Vector3D vector3D2 = new Vector3D((-18.34473335543588), vector3D0, 3.141592653489793, vector3D1, (-18.34473335543588), vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      Line line1 = line0.revert();
      Vector3D vector3D3 = line1.getDirection();
      assertEquals(0.005331947194367359, vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(2909.4321, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, 2271.94346316688, 2271.94346316688);
      Vector3D vector3D2 = new Vector3D((-17.439659), vector3D0, 3.141592653489793, vector3D1, (-17.439659), vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.getDirection();
      assertEquals((-0.005068891778594204), vector3D3.getX(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-1009.1069680000002), double0, 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(8.0E298, 589.7288700357785, 589.7288700357785);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test44()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(5.4405437372337366E-27, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-18.34473335543588), (-18.34473335543588), 1009.106968);
      Vector3D vector3D1 = new Vector3D(2.2279067761147533, 2271.94346316688, 2271.94346316688);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D1);
      assertEquals(6.364549600500306E-13, double0, 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-18.34473335543588), (-18.34473335543588), 1009.106968);
      Vector3D vector3D1 = new Vector3D(1009.106968, vector3D0);
      Vector3D vector3D2 = new Vector3D(2.2279067761147533, 2271.94346316688, 2271.94346316688);
      Vector3D vector3D3 = new Vector3D((-18.34473335543588), vector3D1, 2.2279067761147533, vector3D2, (-18.34473335543588), vector3D0);
      Line line0 = new Line(vector3D3, vector3D2);
      Vector3D vector3D4 = vector3D3.normalize();
      Vector3D vector3D5 = vector3D4.add((Vector<Euclidean3D>) vector3D2);
      Line line1 = new Line(vector3D5, vector3D3);
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, 2271.94346316688, 2271.94346316688);
      Vector3D vector3D2 = new Vector3D((-18.3447333554359), vector3D0, 3.141592653489793, vector3D1, (-18.3447333554359), vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
  ...
  public void test58()  throws Throwable  {
      ...
      assertEquals(471.02530302531255, double0, 0.01);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(2.200758900586652E-4, vector3D2.getDelta(), 0.01);
      assertNotNull(vector3D2);
  }
