...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3643.92966123, 3643.92966123);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-916.696196404), 1.0);
      Vector3D vector3D1 = new Vector3D(391.8372326327675, vector3D0);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.1666666505023083, (-0.5014267242476973));
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-916.696196404), 1.0);
      Vector3D vector3D1 = new Vector3D(392.9, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      Vector1D vector1D0 = line0.toSubSpace(vector3D2);
      assertEquals(6.915108718951938E-28, vector3D2.getNormSq(), 0.01);
      assertEquals(0.0, vector1D0.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(391.8372326327675, 1.0);
      Vector3D vector3D1 = new Vector3D(391.8372326327675, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.0, vector1D0.getX(), 0.01);
      assertEquals(0.16666665050230828, vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1.4614225456677048E-30, vector3D0, 1.4614225456677048E-30, vector3D0, 1.4614225456677048E-30, vector3D0, 1.4614225456677048E-30, vector3D0);
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(153585.61000000004);
      assertEquals(2.3561990941834425, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2261.6192744836117, 2261.6192744836117);
      Vector3D vector3D1 = new Vector3D(2261.6192744836117, vector3D0, 7.918700990841E-22, vector3D0);
      Vector3D vector3D2 = new Vector3D(1.8567844333658543, vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.pointAt(0.0);
      assertEquals(6.010657362724636E-13, vector3D3.getX(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-1806.9));
  ...
  public void test17()  throws Throwable  {
      ...
      assertEquals(1.9201233834585047E-16, vector3D2.getX(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals(3.0918003925716576E-12, vector3D3.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(391.8372326327675, 8.0E298);
      Vector3D vector3D1 = new Vector3D(8.0E298, vector3D0, 0.0, vector3D0, 391.8372326327675, vector3D0);
      Vector3D vector3D2 = new Vector3D(391.8372326327675, vector3D1);
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2775.229543381974, 619054.24, 2775.229543381974);
      Vector3D vector3D1 = new Vector3D(2775.229543381974, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.448244586284044E-7, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals(0.8647466954249098, vector3D2.getX(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(838790.1699992456, vector3D0, 838790.1699992456, vector3D0, 838790.1699992456, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.05627215793730857, (-0.5014267242476973));
      Vector3D vector3D1 = Vector3D.ZERO;
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-522.975932348633), 840331.9165015611);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-0.7410014339008022), double0, 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      assertEquals(3.4123488109227076E-14, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      assertEquals(1.26123438832217E-30, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = vector3D0.scalarMultiply(0.19999954104423523);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.1910271410033635E-34, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(153585.61000000004, 5.650007086920087E-9);
      Vector3D vector3D1 = Vector3D.ZERO;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(3589.0, vector3D0);
      Line line1 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line1.closestPoint(line0);
      assertEquals(2.4528917446677414E-17, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test39()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = vector3D0.orthogonal();
      Vector3D vector3D2 = new Vector3D((-1029.654), vector3D0, 3.2796464540988908E38, vector3D1, (-1029.654), vector3D0);
  ...
  public void test41()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(391.8372326327675, 8.0E298);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 8.0E298, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.0913418992246946E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-1.0020584322748507), vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test56()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.19999954104423523, vector3D0, 0.3333333333333333, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(line0);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test58()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(391.8372326327675, (-2163.5621));
      Vector3D vector3D1 = new Vector3D(391.8372326327675, vector3D0, (-2163.5621), vector3D0);
      Vector3D vector3D2 = new Vector3D(391.8372326327675, vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
