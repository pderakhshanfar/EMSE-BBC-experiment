...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.0E-10, vector3D1, 1.0E-10, vector3D0, 0.0, vector3D0, (-1659.702513), vector3D1);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D((-0.2499999997677497));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.2499999997677497), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1.0E-10, vector3D0, 1.0E-10, vector3D0, 4.220295738321944E-6, vector3D0, (-2692.1572902), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2692.157285979504), vector1D0.getX(), 0.01);
      assertEquals((-2692.157285979504), vector3D2.getZ(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2.4), (-1588.004077267));
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-1431.65409));
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(21.470295872);
      assertEquals((-6.637428887693926), vector3D2.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(993.9239815234812);
      assertEquals(993.9239815234812, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.231976159816321), (-1431.65409));
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1431.65409));
      assertEquals(1.241252290793615, vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.231976159816321), (-1430.266235587664));
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.12715220755555712), vector3D2.getZ(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals(0.5934199821846137, vector3D3.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(994.94957, 994.94957);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-2.5060975147593587), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-2267.870681539009), vector3D0, (-2267.870681539009), vector3D0, 1.0E-10, vector3D0, (-2267.870681539009), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.4829619416023792E-24, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.32931814492458833), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1.5574076175689697, vector3D0, 398.56869297, vector3D0, (-1.7976931348623157E308), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D(1.0E-10, vector3D1, 1.0E-10, vector3D0, 4.220295738321944E-6, vector3D1, (-2692.1572902), vector3D1);
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(0.0, double0, 0.01);
      assertEquals(0.30601948088696057, vector3D2.getX(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      double double0 = line0.distance(vector3D2);
      assertEquals(8.976094571602652E-18, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(3.590437828641061E-17, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.3565840820277275, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(1.0E-10, vector3D1, 1.0E-10, vector3D2, 0.0, vector3D2, (-1659.702513), vector3D1);
      Line line0 = new Line(vector3D3, vector3D2);
      Vector3D vector3D4 = line0.closestPoint(line0);
      assertEquals((-7.608097019941558E-27), vector3D4.getY(), 0.01);
  }
  ...
  public void test39()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.7976931348623157E308, 0.1111111111111111);
  ...
  public void test51()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-0.9462630739748337), double0, 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D4 = vector3D0.scalarMultiply(0.0);
