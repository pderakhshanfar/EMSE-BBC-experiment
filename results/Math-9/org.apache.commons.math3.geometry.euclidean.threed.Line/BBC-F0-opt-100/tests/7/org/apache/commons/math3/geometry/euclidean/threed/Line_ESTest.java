...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(604.34265, vector3D0, 1.9999999998, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      assertEquals((-0.9999999999999909), vector1D0.getX(), 0.01);
  }
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1303.77853, 1303.77853, 1303.77853);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1303.77853, 1303.77853, 1303.77853);
      Vector3D vector3D1 = vector3D0.subtract((Vector<Euclidean3D>) vector3D0);
      Vector3D vector3D2 = new Vector3D((-3720.47183754535), vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D3 = line0.toSpace(vector1D0);
      assertEquals(4.988436770839037E-10, vector1D0.getX(), 0.01);
      assertEquals(5.1245747876847024E-26, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1472.95219998), vector3D0, (-1472.95219998), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.0000000000001545, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-104.004577593622));
      assertEquals(104.004577593622, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-1825.04456966472), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.0);
      assertEquals((-1.0057488344763556E-16), vector3D2.getZ(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(350.0);
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1303.77853, 1303.77853, 1303.77853);
      Vector3D vector3D1 = new Vector3D((-3720.47183754535), (-3720.47183754535), 1303.77853);
      Vector3D vector3D2 = vector3D0.subtract((Vector<Euclidean3D>) vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals(1.327894963784828, vector3D3.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1303.77853, 1303.77853, 1303.77853);
      Vector3D vector3D1 = new Vector3D((-3720.450390556567), 1303.77853, (-3720.450390556567));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-1.8136709704466498E-17), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-1993.13534), vector3D0, 2917298.3245255942, vector3D0, 5099515.365866883, vector3D0, 2917298.3245255942, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.2542668671957154E-9, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D(238.73752946963887, vector3D1, (-1.7976931348623157E308), vector3D0, (-1.7976931348623157E308), vector3D1, (-942.1378729018), vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-1472.95219998), vector3D0, (-1472.95219998), vector3D0, 1.187890022336666E21, vector3D0, (-1086.592623111146), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals(6896.779579092262, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(3334438.7704020124, vector3D0, 1.0E-10, vector3D0, 1.0E-10, vector3D0, (-969.039), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-3333469.731402012), double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-4.503599627370496E15), vector3D0, 0.167, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(1.4693520598355382E-28, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals((-3.918821963750863E-17), vector3D2.getY(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1303.77853, 1303.77853, 1303.77853);
      Vector3D vector3D1 = new Vector3D((-3720.47183754535), (-3720.47183754535), 1303.77853);
      Vector3D vector3D2 = new Vector3D(1303.77853, vector3D0, 1303.77853, vector3D0, (-3720.47183754535), vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
      Line line1 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.closestPoint(line1);
      assertEquals(1450994.3925609782, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Vector3D vector3D3 = line0.closestPoint(line1);
      assertEquals(8744.722205090693, vector3D3.getNorm1(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.2254188692450494E49, 1.2254188692450494E49, 1564.1419252);
      Vector3D vector3D1 = new Vector3D(1770.7711322, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test47()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0, 1.0, (-411.1756444207216));
      Line line0 = new Line(vector3D0, vector3D1);
      try { 
  ...
  public void test48()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3720.47183754535), (-3720.47183754535), 1303.77853);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(3719.2);
      assertEquals(0.3371678187276179, vector3D2.getDelta(), 0.01);
  ...
  public void test49()  throws Throwable  {
      ...
      assertEquals(6.380097618012502E-13, double0, 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(3.918821963750863E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test67()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1303.77853, 1303.77853, 1303.77853);
      Vector3D vector3D1 = new Vector3D((-3720.47183754535), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-2.880075312479346E-10), vector3D2.getZ(), 0.01);
  }
}
