...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0E-10, 1.0E-10, 7784434.425083005);
      Vector3D vector3D1 = new Vector3D((-3953.525), vector3D0, 2.220446049250313E-16, vector3D0);
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-361.9227328), vector3D0, (-361.9227328), vector3D0, 0.0, vector3D0, (-361.9227328), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1855.2554003121, 2.9114904850562004E50, 1855.2554003121);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(2273.258826849, vector3D0, (-4696.7667), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.9999999999997897), vector3D2.getX(), 0.01);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D2 = vector3D0.add(5878238.426971187, (Vector<Euclidean3D>) vector3D1);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1439.213502508148), 2502.58231);
      Vector3D vector3D1 = new Vector3D(561.31106832534, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.3640671640226352), vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = vector3D0.add((-0.05417713522911072), (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1.883511811213715E-8);
      assertEquals(1.883511807843858E-8, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.4735323265378706E12, 3.4735323265378706E12, (-2152.5609));
      Vector3D vector3D1 = new Vector3D((-2152.5609), vector3D0, 3.4735323265378706E12, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-2152.5609));
      assertEquals(8.310045215460932E8, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(0.2);
  ...
  public void test11()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-2539.72540182508));
      assertEquals((-2539.72540182508), vector3D2.getY(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(3.36985705318019E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(4.381967018640392E-10, vector3D2.getZ(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(8.476776844572788E100, 385.2314491);
      Vector3D vector3D1 = new Vector3D(8.476776844572788E100, vector3D0);
      Vector3D vector3D2 = new Vector3D(8.476776844572788E100, vector3D1, 3197.478021162524, vector3D1, 385.2314491, vector3D0, 3197.478021162524, vector3D0);
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals((-2423.5078731510002), double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.11111095942313305, 0.11111095942313305, 1475.5156216206917);
      Vector3D vector3D1 = new Vector3D(0.11111095942313305, vector3D0, (-1088.786), vector3D0);
      Vector3D vector3D2 = Vector3D.MINUS_J;
      Vector3D vector3D3 = new Vector3D(0.11111095942313305, vector3D0, 3.141592653489793, vector3D2, 1.72952015625E7, vector3D2);
      Line line0 = new Line(vector3D1, vector3D3);
      Line line1 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(line1);
      assertEquals(4.554318694647262E-15, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2273.258826849, vector3D0, (-4696.7667), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D((-1893.03), 0.0, 1.0725488523384831E-39);
      Line line1 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line1.closestPoint(line0);
      assertEquals(1.0758703986231338E-17, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      assertEquals(4.419334827451142E-26, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      assertEquals((-7.039595705287054E-17), vector3D2.getY(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1855.2554003121, 2.9114904850562004E50, 1855.2554003121);
      Vector3D vector3D2 = new Vector3D((-2461.7), vector3D0, (-2461.7), vector3D1, 1855.2554003121, vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test37()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = vector3D0.scalarMultiply((-1386.25));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-801.83054685), (-1.7976931348623157E308), (-1.7976931348623157E308));
  ...
  public void test38()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(2273.258826849, vector3D0, 2273.258826849, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test47()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2273.258826849, vector3D0, (-4696.7667), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(0.0, 1.0725488523384831E-39, 1.0E-10);
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(4484.61454167691, 4484.61454167691);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(0.7071352354636672, double0, 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.49995975876574406, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.11111095942313305, vector3D0, (-1088.786), vector3D0);
      Vector3D vector3D2 = Vector3D.MINUS_J;
      Vector3D vector3D3 = new Vector3D(3.141592653589793, vector3D2, 1475.5156216206917, vector3D0, 1475.5156216206917, vector3D0, 0.11111095942313305, vector3D0);
      Line line0 = new Line(vector3D1, vector3D3);
  ...
  public void test55()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.49997987897801655, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D0.scalarMultiply(107.2);
  ...
  public void test57()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2273.258826849, vector3D0, (-4696.7667), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(2273.258826849, 0.0, 5.2240336371356666E-9);
  ...
  public void test64()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(3.132621331070394, vector3D2.getAlpha(), 0.01);
  }
}
