...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1101.3507618805622), vector3D0, (-1101.3507618805622), vector3D0, (-1101.3507618805622), vector3D0);
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.9999999999998157, (-135.694));
      Vector3D vector3D1 = new Vector3D((-135.694), vector3D0, 0.9999999999998157, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = vector3D0.scalarMultiply((-2874.578352182267));
      Vector3D vector3D2 = new Vector3D((-1101.3507618805622), vector3D0, (-1101.3507618805622), vector3D0, (-1101.3507618805622), vector3D0);
      ...
      assertEquals((-0.7850502560502576), vector3D4.getDelta(), 0.01);
      assertEquals(0.9999999999999079, vector1D0.getX(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = new Vector3D(3305.0522856416865, (-2874.578352182267));
      line0.reset(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.toSpace(vector1D0);
      assertEquals((-3304.0522856416865), vector1D0.getX(), 0.01);
      assertEquals(3304.0522811973633, vector3D3.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2874.578352182267), 381.87634069);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(3.141592653489793);
      assertEquals(3.219905655570839, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-135.694), vector3D0, 0.9999999999998157, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(0.9999999999998157);
      assertEquals(0.6918646520159796, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-1101.3507618805622), (-2874.578352182267), (-1101.3507618805622));
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals((-1.7977955210334127E-15), vector3D2.getX(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(3.5407543030818845E-26, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.10670255614839037), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-3732.5), vector3D0, (-3732.5), vector3D0, 0.003, vector3D0, (-1.7976931348623157E308), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1101.3507618805622), (-1101.3507618805622), (-1101.3507618805622));
      Vector3D vector3D1 = vector3D0.scalarMultiply((-2874.578352182267));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = vector3D0.scalarMultiply((-1101.3507618805622));
      Vector3D vector3D2 = new Vector3D((-2874.578352182267), vector3D0, (-1101.3507618805622), vector3D1, (-1101.3507618805622), vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-0.9999999997437969), double0, 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals(1.6554928452073927E-29, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-0.2963885028521428), vector3D2.getY(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.8648908021759085E28, 1.8648908021759085E28, 1.8648908021759085E28);
      Vector3D vector3D1 = new Vector3D(1.8648908021759085E28, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test42()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(9.211965989010221E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test46()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1703.7423023123138), (-1703.7423023123138), 1528.095);
      Vector3D vector3D1 = new Vector3D((-1703.7423023123138), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      try { 
  ...
  public void test48()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals(0.9999999999998118, double0, 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = vector3D0.scalarMultiply((-2874.578352182267));
      Vector3D vector3D2 = new Vector3D((-1101.3507618805622), (-2874.578352182267), (-1101.3507618805622));
      Line line0 = new Line(vector3D2, vector3D0);
      line0.reset(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals((-2.6480828167880084), vector3D3.getAlpha(), 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-1101.3507618805622), vector3D0, (-1101.3507618805622), vector3D0, (-1101.3507618805622), vector3D0);
      Vector3D vector3D2 = new Vector3D((-2874.578352182267), vector3D1, (-1101.3507618805622), vector3D1, (-2874.578352182267), vector3D1);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D3 = new Vector3D(2923.595111, vector3D2, 2923.595111, vector3D2);
  ...
  public void test58()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(3.141592653489793);
      assertEquals(3.1415926534899814, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      assertNotNull(vector3D2);
      assertEquals(9.211965989010221E-14, vector3D2.getX(), 0.01);
  }
