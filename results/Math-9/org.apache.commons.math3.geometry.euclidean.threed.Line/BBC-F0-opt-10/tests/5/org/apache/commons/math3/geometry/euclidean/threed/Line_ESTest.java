...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(771.9, vector3D1);
      ...
      assertEquals((-0.0012955024247579539), vector3D3.getZ(), 0.01);
  }
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(771.9, vector3D0);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.3333333134651184, vector3D0, 7.9133303705571152E16, vector3D0, 5.26300938620879E-17, vector3D0, (-748.570395086989), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(7.9133303705571152E16, vector3D1, (-1230.43240021), vector3D0, (-1.7976931348623157E308), vector3D1, (-2086.791182379594), vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D2);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1274.580297406219), 1.7827257129423813E-8, 3.1390016458412338);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(3453.556, vector3D0, 3453.556, vector3D0, 0.9315965175628662, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.POSITIVE_INFINITY;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector1D vector1D0 = new Vector1D(1.2537167179050217E-16);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector1D vector1D0 = new Vector1D(1.2537167179050217E-16);
      Vector3D vector3D3 = line0.toSpace(vector1D0);
      assertEquals((-0.4999999999999999), vector3D3.getY(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1.2802904187634228E15, 1.2802904187634228E15);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-2905.117474574));
      assertEquals(5014.42867911227, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D2 = vector3D0.subtract(686.96, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      line0.reset(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.pointAt(0.0);
      assertEquals((-7.966195853469288E-17), vector3D3.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Vector3D vector3D2 = new Vector3D((-1960.3209), vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.intersection(line0);
      assertEquals(3.1410825330717107, vector3D3.getAlpha(), 0.01);
      assertNotNull(vector3D3);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-1960.3209), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(8.851675252503964E-27, vector3D2.getNormSq(), 0.01);
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.36030353336835585, vector3D2.getDelta(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals(1.0012938240954086, vector3D3.getNorm1(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      line0.reset(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(7.966195853469288E-17, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      double double0 = line0.distance(line1);
      assertEquals(2.044423172446817E-17, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1025.341207123989), 474.7431, (-204.7455284));
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.9841284551392346, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = vector3D0.scalarMultiply(3.2358114313709E29);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test34()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3871.1), 8.0E298, (-2169.6888123898657));
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test36()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-3871.1), 8.0E298, (-3871.1));
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test46()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(8.181453224061086E-35, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-114.415490728), (-114.415490728));
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      try { 
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(771.6751838835656, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test56()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(3453.556, vector3D0, 3453.556, vector3D0, 2.050020877723049, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
