...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(8.961604069439733, 8.961604069439733);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line1.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.40018941971759103, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3660.6287904, 2560.781535976, 3660.6287904);
      Vector3D vector3D1 = Vector3D.NEGATIVE_INFINITY;
      Vector3D vector3D2 = new Vector3D(2560.781535976, vector3D0, 3660.6287904, vector3D0);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, 4.116164446561962E-8, (-3672.001953000914));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2.723309997427073E-4), vector1D0.getX(), 0.01);
      assertEquals((-2.3338891635882343E-31), vector3D2.getY(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-68.438), vector3D0, (-68.438), vector3D0, (-68.438), vector3D0, 8.961604069439733, vector3D0);
  ...
  public void test10()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(1560.65389);
  ...
  public void test12()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(90.42331859);
      assertEquals(90.42331859, vector3D2.getY(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-68.438), vector3D0, (-68.438), vector3D0, (-68.438), vector3D0, 8.961604069439733, vector3D0);
      Vector3D vector3D2 = new Vector3D(8.961604069439733, 8.961604069439733);
      Vector3D vector3D3 = vector3D2.negate();
      Line line0 = new Line(vector3D1, vector3D3);
      Vector3D vector3D4 = line0.pointAt((-68.438));
      assertEquals(69.22136051941516, vector3D4.getNorm1(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals(0.7298452841920512, vector3D4.getDelta(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals(2.118302346140917E-17, vector3D2.getY(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(254.10754, vector3D0, 0.0, vector3D1, 0.0, vector3D1);
  ...
  public void test24()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D((-4.440892098500626E-16), (-4.440892098500626E-16), (-4.440892098500626E-16));
      Vector3D vector3D3 = vector3D0.add((-3415.5319), (Vector<Euclidean3D>) vector3D1);
      line0.reset(vector3D2, vector3D3);
      Vector3D vector3D4 = line0.getDirection();
      assertEquals(1.3002050744024675E-19, vector3D4.getY(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Vector3D vector3D2 = new Vector3D(1.7976931348623157E308, 1.5718056087545397E-32, (-1.0));
  ...
  public void test35()  throws Throwable  {
      ...
      doubleArray0[0] = 1688.6;
      doubleArray0[1] = 1688.6;
      doubleArray0[2] = 1688.6;
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D(1688.6, vector3D0, 5.782829146112E76, vector3D0, 0.008333333333333333, vector3D0, 109.17, vector3D0);
  ...
  public void test37()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(8.0E298, vector3D0, (-3960.833386222668), vector3D0, 394.459487062035, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-1103.5468029437), (-1103.5468029437), (-721.08));
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test47()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-2.7233100310890794E-4), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(254.10754, vector3D0, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(254.10753999999997, double0, 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      assertEquals(4.9352589356390025E-17, double0, 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(1.5707963267948966, vector3D0, 1.304E19, vector3D0, 1.304E19, vector3D2, (-1822.27), vector3D1);
  ...
  public void test59()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.8505262604325079), vector1D0.getX(), 0.01);
