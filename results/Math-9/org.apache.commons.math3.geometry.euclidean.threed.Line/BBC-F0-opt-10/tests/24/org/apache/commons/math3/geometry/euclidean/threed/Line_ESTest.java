...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1303.0, 1303.0, 0.0);
      Vector3D vector3D1 = new Vector3D(1303.0, vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      assertEquals((-1842.720271772361), vector1D0.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2012.10509871), 12647.268565275674, (-2012.10509871));
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      line0.toSubSpace(vector3D2);
      assertEquals((-2.833557023605276), vector3D2.getAlpha(), 0.01);
      assertEquals(0.35101075895507566, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals((-1.5440969808334978E-10), vector3D2.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-1355.4634));
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1303.0, 1303.0, 0.0);
      Vector3D vector3D1 = new Vector3D(1303.0, vector3D0, 1303.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.1457235160605705E-10, vector3D2.getY(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-1.5440969808334978E-10), vector3D2.getY(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-5405.5876), vector3D0, 3.141592653489793, vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(2.6665230814413475E-14, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.1836828919140815E-10, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, 5.669184079525E-24, (-297.066));
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-1.9018838817583514E-26), vector3D2.getY(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2678.3022116614748), vector3D0, (-2678.3022116614748), vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(4.584164406190528E-26, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      Vector3D vector3D3 = new Vector3D(5.650007086920087E-9, vector3D0, 1.7976931348623157E308, vector3D2);
  ...
  public void test33()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      Vector3D vector3D3 = new Vector3D(5.650007086920087E-9, vector3D2, 1.7976931348623157E308, vector3D2);
      Line line1 = new Line(vector3D2, vector3D3);
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.4794255495071411, (-2041.10708));
  ...
  public void test46()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1303.0, 1303.0, 1303.0);
      Vector3D vector3D1 = new Vector3D(1303.0, vector3D0, 1303.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D0);
      assertEquals(1.0652716058261603E-13, double0, 0.01);
  }
  ...
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1750.6815771853444, (-1282.8461586));
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Vector3D vector3D2 = vector3D1.add((Vector<Euclidean3D>) vector3D0);
      Vector3D vector3D3 = new Vector3D(1750.6815771853444, vector3D0);
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1303.0, 1303.0, (-1299.67894534934));
      Vector3D vector3D1 = new Vector3D(1303.0, vector3D0, 1303.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.1457235160605705E-10, vector3D2.getY(), 0.01);
  ...
  public void test50()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-6.350155861215012E-14), vector3D2.getY(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1303.0, 1303.0, 1303.0);
      Vector3D vector3D1 = new Vector3D(1303.0, vector3D0, 1303.0, vector3D0);
      Vector3D vector3D2 = new Vector3D(Double.NEGATIVE_INFINITY, vector3D1);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test56()  throws Throwable  {
      ...
      assertEquals(0.9756149445520714, double0, 0.01);
  }
  ...
  public void test57()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      Vector3D vector3D3 = vector3D2.add((Vector<Euclidean3D>) vector3D2);
