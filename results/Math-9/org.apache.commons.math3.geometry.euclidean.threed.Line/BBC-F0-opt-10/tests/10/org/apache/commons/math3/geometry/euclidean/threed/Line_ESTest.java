...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-3.7999795083850525E-8), vector3D0, 634.418, vector3D0, 784.1393400500756, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-1296.0745226146123), (-1.0), (-1296.0745226146123));
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals(0.5003860779386718, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.222582846166832E7, 2925.82351145);
  ...
  public void test07()  throws Throwable  {
      ...
      assertEquals(9.130134650913154E-18, vector1D0.getX(), 0.01);
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.7068337301383276), vector1D0.getX(), 0.01);
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1519.94420412), vector3D0, 1.0E-10, vector3D0, (-987.80050695075), vector3D0, (-987.80050695075), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.9999999999997534, vector1D0.getX(), 0.01);
      assertEquals(1.0, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(61876.17043440376, 218.3594665, 1.0E-10);
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-6.032174644509064E-23), vector3D0, (-0.2499999997677497), vector3D0, (-0.2499999997677497), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2044.672763597395, 2044.672763597395);
      Vector3D vector3D1 = new Vector3D(2044.672763597395, vector3D0, 2044.672763597395, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.0);
      assertEquals(4.652016729904378E-17, vector3D2.getX(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(1.840782337152947E-17, vector3D2.getNorm(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(569.6837525554491, (-3104.218191674784));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.1594885101888726), vector3D2.getZ(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(3.6785235502116727E-26, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = new Vector3D(691612.3347276091, (-690.8), (-8.0E298));
      Vector3D vector3D2 = new Vector3D(4136.5248831, vector3D1);
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(8.335935874380506E-35, vector3D2.getNormSq(), 0.01);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(351.1004406626, 351.1004406626, 351.1004406626);
      Line line1 = new Line(vector3D1, vector3D2);
      double double0 = line0.distance(line1);
      assertEquals(2.3889854597352982E-17, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-1.9179477443902565E-13), vector3D2.getY(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1.0, 1.0, (-716.514));
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1013.55429, vector3D0, 1013.55429, vector3D0, (-1.7976931348623157E308), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test47()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(344.3509, vector3D0, (-3.9986783938944604E-8), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      try { 
  ...
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1.2095448632017272, vector3D0, 2359.718, vector3D0, 0.0, vector3D0, (-588.1565956935298), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1.5792142359152094E14, vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(3.9968028906918186E-17, vector3D0, 3.9968028906918186E-17, vector3D0, 3.9968028906918186E-17, vector3D0, 3.9968028906918186E-17, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      boolean boolean0 = line0.isSimilarTo(line0);
      assertTrue(boolean0);
  }
