...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.24740394949913025, (-1830.3845642167));
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector1D vector1D0 = new Vector1D((-4.813899778443457E-9));
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1224.28047477, (-853.8886853467775));
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1455.961399734477), 0.0);
      Vector3D vector3D1 = vector3D0.scalarMultiply(0.0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1455.961399734477));
      assertEquals((-1435.7554211120041), vector3D2.getY(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(0.22720946900712652, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-2.603914), vector3D0, (-2.603914), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.0737652271365782E-32, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1455.961399734477), 0.0);
      Vector3D vector3D1 = new Vector3D((-1455.961399734477), vector3D0, (-1455.961399734477), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(4.0715488878078916E-14, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1455.961399734477), (-1455.961399734477));
      Vector3D vector3D1 = vector3D0.add((-1455.961399734477), (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.getDirection();
      assertEquals(1.1774043044291225, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1.7976931348623157E308, 1653.282, 1.7976931348623157E308);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1148.289565269, vector3D0, 0.8775825500488281, vector3D0, (-744.3), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1455.961399734477), 0.0);
      Vector3D vector3D1 = vector3D0.scalarMultiply(0.0);
      Vector3D vector3D2 = new Vector3D(0.0, (-1455.961399734477));
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals(4.5880864335525034E-17, double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(4.65399449261964E-16, vector3D2.getY(), 0.01);
  }
  ...
  public void test45()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-382.3), vector3D0, (-382.3), vector3D0, (-382.3), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      try { 
  ...
  public void test47()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1455.961399734477), (-2.836292920090233));
      Vector3D vector3D1 = vector3D0.scalarMultiply((-2.836292920090233));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-6.174771826746245E-17), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1523.0, 0.027756200990160684);
      Vector3D vector3D1 = new Vector3D(1523.0, vector3D0, 2.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(3821.68946979);
      Vector1D vector1D1 = new Vector1D(522.259, vector1D0, 2749.763, vector1D0, 0.027756200990160684, vector1D0);
      ...
      assertEquals((-347040.0147682295), vector3D2.getZ(), 0.01);
      assertNull(vector3D3);
      assertEquals(1.5636897508705225E14, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      assertEquals(2.778768478840832E-15, vector3D2.getX(), 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      assertFalse(boolean0);
      assertEquals((-7786142.425113728), vector3D2.getY(), 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.1637188056073936), vector3D2.getY(), 0.01);
  }
  ...
  public void test58()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1455.961399734477), (-1455.961399734477));
      Vector3D vector3D1 = vector3D0.scalarMultiply((-1455.961399734477));
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test59()  throws Throwable  {
      ...
      Line line1 = line0.revert();
      double double0 = line1.distance(line0);
      assertEquals(1.4033076483541662E-30, double0, 0.01);
  }
}
