...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(3.5426277887704553E24);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2.505016132659493E24), vector3D2.getX(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.356045642498627, 1106.67872684);
      Vector3D vector3D1 = new Vector3D(2.356045642498627, vector3D0, 1106.67872684, vector3D0, 1106.67872684, vector3D0, 2.356045642498627, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2945.727), vector3D0, (-2945.727), vector3D0);
      Vector3D vector3D2 = Vector3D.crossProduct(vector3D1, vector3D1);
      Line line0 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.pointAt((-2945.727));
      assertEquals((-2945.727), vector3D3.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-837.34938318415));
      assertEquals((-837.34938318415), vector3D2.getZ(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(593.2567);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1449.18552384));
      assertEquals((-1449.18552384), vector3D2.getY(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(0.0, vector3D0, (-1274.1882), vector3D1, (-1274.1882), vector3D1, 0.0, vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.intersection(line0);
      assertEquals(3.348596250465864E-13, vector3D3.getNormInf(), 0.01);
      assertNotNull(vector3D3);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-157.5478518029), 0.0);
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.395384600569944E-14, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-261.510686238), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.5847369205353634E-18, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.8582047383804682), vector3D2.getY(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-361.44200920133), (-170.7428));
      Vector3D vector3D1 = new Vector3D((-361.44200920133), vector3D0, (-361.44200920133), vector3D0, (-170.7428), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      line1.reset(vector3D0, vector3D1);
      double double0 = line1.distance(line0);
      assertEquals(1.9918149203827093E-14, double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.395384600569944E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(656.8861808, 656.8861808);
      double[] doubleArray0 = new double[3];
      doubleArray0[0] = 8.06113481346517E264;
  ...
  public void test47()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-157.5478518029), double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1.264177376505397E-12, 3359.7342044, 3359.7342044);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.7852493199510308), vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(789.0338069772289, 789.0338069772289, 789.0338069772289);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
  ...
  public void test52()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(4.508345179373445E12, vector3D0, 4.508345179373445E12, vector3D0, 4.508345179373445E12, vector3D1, 4.508345179373445E12, vector3D0);
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.264177376505397E-12, 3359.7342044, 3359.7342044);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(0.0, vector3D1, 8.124785583970729E34, vector3D0, 8.124785583970729E34, vector3D1);
