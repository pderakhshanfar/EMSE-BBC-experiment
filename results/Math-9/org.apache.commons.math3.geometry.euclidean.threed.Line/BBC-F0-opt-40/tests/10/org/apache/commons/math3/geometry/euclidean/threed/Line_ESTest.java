...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1820.98486346173, vector3D0, 1820.98486346173, vector3D0, 1820.98486346173, vector3D0, 1820.98486346173, vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = vector3D0.scalarMultiply(269.74779);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = Vector3D.MINUS_I;
      Vector3D vector3D3 = new Vector3D(269.74779, vector3D1, 0.0, vector3D0, 1.0E-10, vector3D2);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1125.0), (-1125.0), (-1125.0));
  ...
  public void test05()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector1D vector1D0 = new Vector1D(1631.1890498);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1820.98486346173, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(5.298519075416287E-14);
      Vector1D vector1D1 = new Vector1D(1820.98486346173, vector1D0, 0.0, vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals((-9.629753187273811E-11), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(953.163598704, vector3D0, 953.163598704, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1906.327197408), vector1D0.getX(), 0.01);
      assertEquals((-1906.327197408), vector3D2.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-942.3582931635855));
      assertEquals(Double.NaN, vector3D1.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1125.0), (-1125.0));
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(2314.453048);
      assertEquals((-2314.453048), vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(2314.453048);
      assertEquals((-2314.453048), vector3D2.getZ(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D2 = line1.pointAt(3.7369748964031624);
      assertEquals(3.743188799709139, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals(1.4551915228155094E-11, vector3D2.getX(), 0.01);
      assertNotNull(vector3D2);
      assertEquals(1.4551915228155094E-11, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-914.55238982295), (-914.55238982295));
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.44155552718120156, vector3D2.getX(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(4.924046970629374E-18, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(953.163598704, vector3D0, 953.163598704, vector3D0, 953.163598704, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-7.119086546715352E-14), vector3D2.getX(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.2158851904353427E-32, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-0.7853981633974483), vector3D0, (-0.7853981633974483), vector3D0, (-0.7853981633974483), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(8.114124940690094E-33, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.7976931348623157E308, (-832.157879315434), 0.0);
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(632.148062, 0.92065294205611);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.38433316418734803), vector3D2.getY(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(4.083781388919913E-17, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-0.7853981633974483), vector3D0, (-0.7853981633974483), vector3D0, 222.818967, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D1);
      assertEquals(5.298519075416287E-14, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-1.1026718416806256E-16), vector3D2.getZ(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-6.813705485171633E-17), vector3D2.getY(), 0.01);
  }
  ...
  public void test39()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-8.0E298), (-8.0E298), (-672.2418));
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(5.3041207088400066E7, 5.3041207088400066E7, 9.007199254740992E15);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test55()  throws Throwable  {
      ...
      Line line1 = line0.revert();
      double double0 = line0.distance(line1);
      assertEquals(2.1909518584936744E-18, double0, 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      assertEquals((-0.9764829676340931), double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test60()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = vector3D0.scalarMultiply(953.163598704);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
