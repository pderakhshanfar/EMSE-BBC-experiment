...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(8.645474865428562E11, vector3D0, 8.645474865428562E11, vector3D0, 8.645474865428562E11, vector3D0, (-794.4797390574), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line1.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(3.4579530851605307E-4, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D(5.041914939880371, 5.041914939880371, 5.041914939880371);
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(8.645474865428562E11, vector3D0, 0.9999999999999998, vector3D0, 0.9999999999999998, vector3D0, (-794.4797390574), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1313.4616420946174, 1732.469503242892);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals((-3.4579530851605307E-4), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(8.645474865428562E11, 8.645474865428562E11);
      Vector3D vector3D1 = new Vector3D(8.645474865428562E11, vector3D0, 8.645474865428562E11, vector3D0, 8.645474865428562E11, vector3D0, (-794.4797390574), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1.7991587467521756E-5), vector3D2.getY(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(482.6336581594, vector3D0, 482.6336581594, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1151.010586);
      assertEquals(1151.0105859999999, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.036);
      assertEquals((-0.47454415587728427), vector3D2.getZ(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1201.933202), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1152.0);
      assertEquals((-1152.0), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1311.597489, 1732.469503242892);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.059273802733561275, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1464.1), 6.942032835046159E14, 6.942032835046159E14);
      Vector3D vector3D1 = new Vector3D((-1464.1), vector3D0, 6.942032835046159E14, vector3D0);
      Vector3D vector3D2 = new Vector3D((-1464.1), vector3D1, (-603.37097435437), vector3D1, 3658.33581, vector3D1, 1.0, vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals(2.6427693122887648E16, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals(1.4547749844540617E-9, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(524.07947, 524.07947);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.23165762320653577), vector3D2.getZ(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1630.0286, vector3D0, 1630.0286, vector3D0, 4.378854472088278, vector3D0, 1630.0286, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1630.0286, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-1.0), vector3D2.getZ(), 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(4478632.15984286, 2280.16839577516);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(0.8909048534534992, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(1.3819748867026097E-16, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1311.597489, 1732.469503242892);
      Vector3D vector3D2 = new Vector3D(3824.3, vector3D0, 1311.597489, vector3D1, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D2);
      Line line1 = line0.revert();
      double double0 = line1.distance(line0);
      assertEquals(1.3776372115420734E-20, double0, 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      assertEquals(1.1957439539171233E-7, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.9964731080426488, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test58()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.40611963315756583), vector3D2.getX(), 0.01);
  }
