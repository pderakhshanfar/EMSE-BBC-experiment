...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.633123935319537E16, vector3D0);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, 1.0E-10, 3972.581733431622);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4.9E-324, 4.9E-324, 4.9E-324);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 0.036, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(3.177592653489793, vector3D2.getY(), 0.01);
      assertEquals((-3.177592653489793), vector1D0.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3892.6814398054, 3892.6814398054);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0E-10, (-3571.95634));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.03450713159473009), vector3D2.getDelta(), 0.01);
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(356.427178231, vector3D0, 356.427178231, vector3D0, 996.55, vector3D0, (-8.0E298), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test10()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(373.5);
      assertEquals((-263.6043827731755), vector3D2.getZ(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D3 = line0.pointAt(1.0000000000000002);
      assertEquals((-0.2380805763245958), vector3D3.getY(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals(1.6262635901163893, vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1.9396790183496917, vector3D0, 1.9396790183496917, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-7.978518183003709E-17), vector3D2.getY(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1.9396790183496917, 1.9396790183496917, 1.9396790183496917);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.23120756116246302), vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1.0, vector3D0, 1.0, vector3D0, 56.82913162397, vector3D0, 56.82913162397, vector3D0);
      Vector3D vector3D2 = new Vector3D(2.9440793561604686, 56.82913162397);
      Vector3D vector3D3 = new Vector3D(1.0, vector3D1, 1.0, vector3D2);
      Line line0 = new Line(vector3D0, vector3D3);
      Vector3D vector3D4 = line0.intersection(line0);
      assertEquals((-0.9727755870814807), vector3D4.getDelta(), 0.01);
  ...
  public void test19()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.8840853178147458E-32, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals(1.0916438199272414, vector3D4.getNorm1(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(2.6670937881135707E32, vector3D0, 2.6670937881135707E32, vector3D0, (-3000.835), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test23()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.24560330138316241), vector3D2.getZ(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      line0.reset(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.9396790183496916), vector3D2.getX(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals(0.7891778321085694, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D((-1509.1230244273088), (-1.0));
      Line line1 = new Line(vector3D3, vector3D2);
      double double0 = line1.distance(line0);
      assertEquals(1.4371004450772678E-18, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.3726198737504662E-16, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1.0E-10, vector3D0, 2.0, vector3D0, 5362.1610036, vector3D0, (-0.49999999999999994), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      Line line1 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line1.closestPoint(line0);
      assertEquals(1.1934676635088688E-26, vector3D3.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-231.6230734897634), 1.0E-10);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.12278579125811458, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test38()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(356.427178231, vector3D0, 356.427178231, vector3D0, 45.3616, vector3D0, (-8.0E298), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = new Vector3D((-933.0), (-933.0));
      try { 
  ...
  public void test62()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(2.956488736578828E7);
