...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, 2.2626057175524457E13, vector3D0, 2.2626057175524457E13, vector3D0);
      ...
      assertEquals((-7.526930265513447E-17), vector3D3.getZ(), 0.01);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2.0, 0.6299605249474366, 2.0477538532403167E27);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3253.301), (-3253.301));
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 1254.38, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.19999954120254515, 0.19999954120254515, 0.0);
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.007241448157653874), vector3D2.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 2.2626057175524457E13, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1.5707963267948966), vector3D2.getDelta(), 0.01);
      assertEquals(2.2626057175524457E13, vector1D0.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(5.70246872052391E33, vector3D0, 5.70246872052391E33, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.814697265625E-6, 1.0E-10);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 2.2626057175524457E13, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(2.2626057175524457E13);
      assertEquals((-2.2626057175524457E13), vector3D2.getZ(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(3744.25);
      assertEquals(2647.08456545773, vector3D2.getY(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals(1.0163306129070365E-16, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(7.526930265513447E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      assertEquals(5.665467922190232E-33, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-1.0), vector3D0, 2.356194490192345, vector3D0, (-1.0), vector3D0, 944.62842924, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.949351282025492E164, (-1649.7), (-1649.7));
      Vector3D vector3D1 = new Vector3D((-1649.7), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(213.244241262689, 944.62842924);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.4959966778612012), vector3D2.getX(), 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(5.665467922190232E-33, vector3D2.getNormSq(), 0.01);
      assertEquals((-7.526930265513447E-17), vector3D2.getZ(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals((-7.526930265513447E-17), double0, 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-616.666), (-616.666), (-616.666));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = Vector3D.PLUS_K;
      Line line1 = new Line(vector3D0, vector3D2);
      double double0 = line0.distance(line1);
      assertEquals(2.88007924476662E-17, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      assertEquals(7.526930265513447E-17, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test43()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1841.85358353289, 1922.7450972, 2.356194490192345);
      Line line0 = null;
      try {
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(2.2626057175524457E13, vector3D0, 721.91654406032, vector3D0);
      Vector3D vector3D2 = Vector3D.MINUS_I;
      Vector3D vector3D3 = vector3D2.add(721.91654406032, (Vector<Euclidean3D>) vector3D1);
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 4.23719669792332E-8, vector3D0, 4.23719669792332E-8, vector3D0, (-649.307408), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-467.20300896946), (-244.3249001013));
      Line line1 = new Line(vector3D0, vector3D2);
  ...
  public void test56()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = new Vector3D(115.0, 115.0);
      try { 
  ...
  public void test58()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = vector3D0.add(2.0477538532403167E27, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test60()  throws Throwable  {
      ...
      assertEquals(1.0790143111824809E-16, double0, 0.01);
  }
