...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      assertEquals((-1.0E-10), vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(2508.991929265068, 0.0, 0.0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.220446049250313E-16, 4320.04441);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1939.9910756), 2376.4902186);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1628.4614167348143), 2508.991929265068, (-1628.4614167348143));
      Vector3D vector3D1 = new Vector3D(2508.991929265068, vector3D0, (-1628.4614167348143), vector3D0, 2508.991929265068, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line1.toSpace(vector1D0);
      assertEquals(1.6930174405718814, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D(599.309, vector3D1, 599.309, vector3D1);
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-4547.2238), vector3D0, (-72.30964), vector3D0, 0.0, vector3D0, (-3952.5755297367823), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector1D vector1D1 = new Vector1D((-3952.5755297367823), vector1D0, (-868.26053102), vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals(4.132473203804375E7, vector1D1.getX(), 0.01);
      assertEquals((-4.132473203804375E7), vector3D2.getY(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(3.497936522962391E-10);
      assertEquals((-0.4999999997526585), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, (-1.0), vector3D0);
      Vector3D vector3D2 = new Vector3D((-1717.2843683619308), vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.pointAt((-2833.8));
      assertEquals(2833.8, vector3D3.getX(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1626.0842420553352), 2508.991929265068, (-1626.0842420553352));
      Vector3D vector3D1 = new Vector3D((-1626.0842420553352), vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(4.685174205821644E-11, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(726.48812103, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(6.01483347578103E-27, vector3D2.getNormSq(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Vector3D vector3D2 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = new Vector3D(0.0, 2508.991929265068, 1.0E-10);
      Line line1 = new Line(vector3D3, vector3D2);
      Vector3D vector3D4 = line1.intersection(line0);
      assertEquals((-9.218467556321624E-20), vector3D4.getY(), 0.01);
  ...
  public void test22()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-6.332582348589612E-13), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1626.0842420553352), 2508.991929265068, (-1626.0842420553352));
      Vector3D vector3D1 = new Vector3D((-1626.0842420553352), vector3D0, 8.0E298, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test24()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.7371949546483697, vector3D2.getY(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1626.0842420553352), 2508.991929265068, (-1626.0842420553352));
      Vector3D vector3D1 = new Vector3D(2508.991929265068, vector3D0, (-1626.0842420553352), vector3D0, 2508.991929265068, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.7371949546483697), vector3D2.getY(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals((-1.863647294492333E-10), vector3D2.getZ(), 0.01);
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(1.1544095234172905E7, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-1717.2843683619308), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test31()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.0E-10, vector3D1, 0.0, vector3D1);
      Line line0 = new Line(vector3D0, vector3D2);
      Line line1 = line0.revert();
  ...
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(726.48812103, vector3D0);
      Vector3D vector3D2 = vector3D0.add(726.48812103, (Vector<Euclidean3D>) vector3D1);
      Line line0 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.closestPoint(line0);
      assertEquals(5.262413040738121E-17, vector3D3.getX(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(2.1650274269049097E-13, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-2210.02032656), vector3D0, 0.9489846229553223, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(3.6250789546741863E-13, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-249.30719632451), vector3D0, (-249.30719632451), vector3D0, (-249.30719632451), vector3D0, (-249.30719632451), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      boolean boolean0 = line0.contains(vector3D0);
      assertTrue(boolean0);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      assertEquals((-2508.991929265068), double0, 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2508.991929265068, 0.0, 0.0);
      Vector3D vector3D2 = Vector3D.PLUS_J;
      Vector3D vector3D3 = new Vector3D(1.0E-10, vector3D2, 0.0, vector3D2);
  ...
  public void test60()  throws Throwable  {
      ...
      Vector3D vector3D5 = Vector3D.crossProduct(vector3D0, vector3D4);
      Line line1 = new Line(vector3D1, vector3D5);
  ...
  public void test67()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.0324290590759934E-36, vector3D2.getNormSq(), 0.01);
  }
}
