...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1479.3859, vector3D0);
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2.6909780040863134, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-3.5997360512765566E-9), vector3D0, 0.0, vector3D0, (-1134.1154277), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      assertEquals(1.0000000000000955, vector1D0.getNormSq(), 0.01);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Vector1D vector1D0 = new Vector1D((-1034.06937485));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2.3568782998942575), vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(830.037741, 2381.249075457889);
      Vector3D vector3D1 = Vector3D.ZERO;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1.0), vector1D0.getX(), 0.01);
      assertEquals(0.6572804522945678, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2622.185752), (-2622.185752), (-0.5));
      Vector3D vector3D1 = new Vector3D((-2622.185752), vector3D0, (-2622.185752), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test09()  throws Throwable  {
      ...
      doubleArray0[0] = (-446.98675030645705);
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D(6246190.435952741, vector3D0, (-446.98675030645705), vector3D0, (-4070.307054), vector3D0, 4.2519047192896E10, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(5.005895325639933E-15);
      assertEquals(4.2107580999515624E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = vector3D0.scalarMultiply((-5.7618793749770706E-8));
      line0.reset(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.pointAt((-5.7618793749770706E-8));
      assertEquals(5.7618793749770706E-8, vector3D3.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1716.396));
      assertEquals((-1214.1752508014654), vector3D2.getZ(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1479.3859, 1479.3859);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.9551295028012055, vector3D2.getX(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      assertEquals(4.768025109769361E-14, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      double[] doubleArray0 = new double[3];
      doubleArray0[2] = (-4070.307054);
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D(6246190.435952741, vector3D0, (-446.98675030645705), vector3D0, (-4070.307054), vector3D0, 4.2519047192896E10, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-9.007169490813223E-14), vector3D2.getZ(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.1485169492308377), vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.0), (-8.0E298), 1.0E-10);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test26()  throws Throwable  {
      ...
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-1134.1154277035998), double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1.159375057472038E-31, 1.159375057472038E-31, 1479.3859);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D1);
      assertEquals(3.2469948175745735E-49, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D((-5.7618793749770706E-8), vector3D2, (-5.7618793749770706E-8), vector3D0);
      Line line1 = new Line(vector3D3, vector3D2);
      double double0 = line0.distance(line1);
      assertEquals(0.7071068219291843, double0, 0.01);
  }
  ...
  public void test37()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3.7999795083850525E-8), (-1486.433716), 8.0E298);
      Vector3D vector3D1 = new Vector3D(3954.2, 1.0000001152375941);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(1827.47443);
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(6.29507505615861E-9, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test58()  throws Throwable  {
      ...
      assertEquals(3708.3306872522335, double0, 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.7071067747591064), vector3D2.getX(), 0.01);
  }
