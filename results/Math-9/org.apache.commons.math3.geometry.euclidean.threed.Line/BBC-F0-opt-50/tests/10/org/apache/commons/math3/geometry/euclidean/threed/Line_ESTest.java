...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(53136.950385237156, 53136.950385237156, 271.7320687676972);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector1D vector1D0 = new Vector1D((-1345.5508492));
  ...
  public void test06()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D((-418.7457039744));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-296.5979268730328), vector3D2.getX(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      assertEquals(4.53646148736883E-17, vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, (-1761.57451264));
      Vector3D vector3D1 = new Vector3D((-1761.57451264), vector3D0, (-1761.57451264), vector3D0, (-1761.57451264), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(1.0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.7571675531429503, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1885.477804218), 5077.46649510326, (-1885.477804218));
  ...
  public void test11()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(3276.88118318);
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.008336750013465571, (-359.522299243111), 761.1);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(5.876659157362492E-49, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = vector3D1.subtract((-361.0052901), (Vector<Euclidean3D>) vector3D0);
      Vector3D vector3D3 = line0.pointAt(1.01);
      Line line1 = new Line(vector3D2, vector3D3);
      Vector3D vector3D4 = line0.intersection(line1);
      assertEquals((-1.2141778489984127), vector3D4.getY(), 0.01);
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals((-0.7853756783262318), vector3D3.getAlpha(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1.7976931348623157E308), vector3D0, 1.1042241471950991E7, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test35()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-1.7976931348623157E308), vector3D0, 1.1042241471950991E7, vector3D0);
      Line line1 = new Line(vector3D0, vector3D2);
      // Undeclared exception!
      try { 
  ...
  public void test47()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      Vector3D vector3D3 = vector3D1.subtract((-361.0052901), (Vector<Euclidean3D>) vector3D2);
      try { 
  ...
  public void test48()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(225.53063171568, 225.53063171568);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-0.4357919533686036), double0, 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.pointAt(1.01);
      Line line1 = new Line(vector3D0, vector3D2);
      line1.closestPoint(line1);
      assertEquals(0.21417784899841294, vector3D2.getX(), 0.01);
      assertEquals(1.428355697996826, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      assertEquals(0.5000159474038881, vector3D3.getX(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      assertEquals((-1.3961950799315972), vector3D2.getAlpha(), 0.01);
      assertEquals(0.0, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1512121.8960730864, 1512121.8960730864, 677.5);
      Vector3D vector3D1 = new Vector3D(1512121.8960730864, vector3D0, 1512121.8960730864, vector3D0, 764.288255181325, vector3D0, 2641.0023092686, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(vector3D0, vector3D1);
  ...
  public void test58()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.7070955048778678), vector3D2.getY(), 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(3276.88118318);
      assertEquals(1.0737950788676204E7, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test62()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D0);
      assertEquals(5.059048280405371E-12, double0, 0.01);
  }
}
