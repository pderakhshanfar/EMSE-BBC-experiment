...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2292.5, 1.0, 3.141592653489793);
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1.0), vector3D0, 6.476576146883813E13, vector3D0);
      Vector3D vector3D2 = Vector3D.MINUS_I;
      Vector3D vector3D3 = new Vector3D(0.9305076599121094, vector3D2);
      Line line0 = new Line(vector3D3, vector3D1);
      Vector3D vector3D4 = new Vector3D(0.9305076599121094, 0.0, 1.0E-10);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.7168146928204135), (-2022.62419137), (-1652.188913793313));
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.7168146928204135), (-2022.62419137), (-1652.188913793313));
      Vector3D vector3D1 = vector3D0.subtract((-2022.62419137), (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      assertEquals((-5285007.437410534), vector1D0.getX(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.0E-10, vector3D2.getNormInf(), 0.01);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.9974949359893799, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-6.272109567828643E-17), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D(1793.964655307351, 1793.964655307351, 1793.964655307351);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1857.9478235676927), (-461.09991552));
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1.0));
      assertEquals((-0.6913080176821802), vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.5850973129272461, 3059.693070195036, 3539.840183035117);
      Vector3D vector3D1 = new Vector3D((-2109.608), 0.5850973129272461);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.20378608076380195, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.7168146928204135), (-2022.62419137), (-1652.188913793313));
      Vector3D vector3D1 = new Vector3D(1.683588168177366E7, vector3D0, 1.683588168177366E7, vector3D0, 800877.7796511966, vector3D0, (-3299.0674346349), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(4.453273231815231E-6, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.2948464536692464), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.9999990610327403, vector3D2.getX(), 0.01);
      assertEquals(0.0013703776169774523, vector3D2.getDelta(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals(2292.5021525844636, double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.7168146928204135), (-2022.62419137), (-1652.188913793313));
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Vector3D vector3D2 = vector3D0.subtract((-2022.62419137), (Vector<Euclidean3D>) vector3D1);
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(5.894544790565399E-23, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.4678548129369675E58, 2.4678548129369675E58, 0.0);
      Vector3D vector3D1 = vector3D0.subtract(3811.71088866, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test35()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1.7976931348623157E308), 1.7976931348623157E308, 10.0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2018.5067650051549), (-1.7168146928204135), (-1.7168146928204135));
  ...
  public void test42()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(687.220835, vector3D0, (-1010.45), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      ...
      assertEquals(1.3759387461470868E-5, double0, 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.7742735220160722, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.6328510986834319), vector3D2.getZ(), 0.01);
  }
