...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2900.223480803), (-2900.223480803));
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(662.8822084619344, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2900.223480802989), (-1.417188054118154));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.13174517879812372), vector3D2.getX(), 0.01);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2900.223480802989), 108.140346529);
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D(108.140346529);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(11694.772974077565, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(662.8822084619344, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(662.8822084619344);
      assertEquals((-662.8822084619344), vector3D2.getZ(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-2577.050506), (-2577.050506), (-2577.050506));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.6668391402647877, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2273.9362645257706, 2273.9362645257706);
      Vector3D vector3D1 = new Vector3D(2273.9362645257706, vector3D0, 2273.9362645257706, vector3D0, (-2577.05), vector3D0, (-2577.05), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(2.998190643425018E-14, vector3D2.getZ(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(939.61050459, vector3D0, 939.61050459, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-3.3336330923108804E-15), vector3D2.getZ(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals(0.08937274999009223, vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2273.9362645257706, vector3D0, 2273.9362645257706, vector3D0, (-2577.050506), vector3D0, (-2577.050506), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.243864307457924E-14, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2900.223480802989), (-1.417188054118154));
      Vector3D vector3D1 = vector3D0.scalarMultiply((-2900.223480802989));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-2.2517565270712707E-14), vector3D2.getX(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.13912762595906972, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.7976931348623157E308), (-75.28));
      Vector3D vector3D1 = new Vector3D((-1.7976931348623157E308), vector3D0, (-2900.223480802989), vector3D0, 1.0E-10, vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test23()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.077805588537626, vector3D2.getY(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2900.223480802989), 0.0);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test27()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2273.9362645257706, vector3D0, 2273.9362645257706, vector3D0, (-2577.050506), vector3D0, (-2577.050506), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(0.0, 866.301749419);
      Line line1 = new Line(vector3D1, vector3D2);
      double double0 = line0.distance(line1);
      assertEquals(3.5903593108233386E-17, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(5.034927030283629E-28, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D0.scalarMultiply((-2900.223480802989));
      Vector3D vector3D3 = Vector3D.PLUS_I;
      Line line1 = new Line(vector3D2, vector3D3);
      Vector3D vector3D4 = line1.closestPoint(line0);
      assertEquals(2866.074585281514, vector3D4.getNormInf(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(6.596147186388166E20, (-156.11));
      Vector3D vector3D1 = new Vector3D(6.596147186388166E20, vector3D0);
      Vector3D vector3D2 = new Vector3D(6.596147186388166E20, vector3D1, 6.596147186388166E20, vector3D0, 0.9999999999999998, vector3D0);
  ...
  public void test46()  throws Throwable  {
      ...
      assertEquals(2.6081311139800647, vector3D3.getAlpha(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-701.8469721389));
      assertEquals((-701.8469721389), vector3D2.getX(), 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1.3282379287788853E7, vector3D0, (-354.749), vector3D0, (-354.749), vector3D0);
      Vector3D vector3D2 = new Vector3D(2273.9362645257706, vector3D0, 2273.9362645257706, vector3D0, 1.3282379287788853E7, vector3D1, 1.3282379287788853E7, vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      Line line1 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line1.intersection(line0);
      assertEquals((-6.529367997323932E-17), vector3D3.getY(), 0.01);
  ...
  public void test62()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      assertEquals((-4463.582335365333), vector1D0.getX(), 0.01);
  }
