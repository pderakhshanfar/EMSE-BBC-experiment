...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.0, (-2458.738));
      Vector3D vector3D1 = new Vector3D((-785.2140569724835), 0.0);
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(25519.060207649243, 1.2653931004431999E9, (-1034.31334));
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      assertEquals((-1.000000047718794), vector1D0.getX(), 0.01);
  }
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-321.637499), (-2381.65));
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-85.28991459323443), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(0.0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-4.3581984393154825E-15), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-158.6), (-158.6));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1520.53);
      assertEquals(1520.5300000479226, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D((-2871.47266721929), vector3D0, (-448.240138), vector3D1);
      Line line1 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line1.intersection(line0);
      assertEquals(2.3663548257391065E-14, vector3D3.getY(), 0.01);
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-13.127445714897663), (-158.6), (-158.6));
      Vector3D vector3D1 = new Vector3D((-13.127445714897663), vector3D0, (-158.6), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(2.6516748902860264E-13, vector3D2.getX(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.8993893636451908E-29, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2.925681159240093E-8, 2.925681159240093E-8, 2.925681159240093E-8);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-2.9256810736439906E-8), vector3D2.getX(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals(1241.9810906256935, double0, 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2705.44914), (-158.6), (-158.6));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(1.3747785856521258E-14, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2705.44914), (-158.6), (-158.6));
      Vector3D vector3D1 = new Vector3D((-2705.44914), vector3D0, (-158.6), vector3D0);
      ...
      assertEquals(1.789332688054812E-14, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D((-2871.47266721929), vector3D1, (-2871.47266721929), vector3D1);
      Line line1 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line1.closestPoint(line0);
      assertEquals(3.34554203423846E-14, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-158.6), (-158.6));
      Vector3D vector3D1 = new Vector3D(1.633123935319537E16, vector3D0, (-8.0E298), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test45()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-158.6), (-158.6));
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-158.6), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      try { 
  ...
  public void test46()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-0.9999999999998572), double0, 0.01);
  }
  ...
  public void test48()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-7.634156249882479E-10), vector3D2.getX(), 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.7071067811886285, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test58()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-158.6), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1429.333182);
      assertEquals((-1010.6911855671477), vector3D2.getY(), 0.01);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-2.0810242974681625E-12), vector3D2.getZ(), 0.01);
  }
