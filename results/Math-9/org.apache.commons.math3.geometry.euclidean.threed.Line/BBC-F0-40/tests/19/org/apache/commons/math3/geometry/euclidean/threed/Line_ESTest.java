...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(162947.1033457213, 162947.1033457213, 162947.1033457213);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.0, 2.0, 0.0);
      Vector3D vector3D1 = new Vector3D(2.0, vector3D0, 0.0, vector3D0);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.0, (-492.64), 0.0);
      Vector3D vector3D1 = new Vector3D((-492.64), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(242696.16959175922, vector1D0.getX(), 0.01);
      assertEquals(242694.16959999994, vector3D2.getY(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(3245.0, vector3D0, (-560.389533), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(2.0007591285917644E-17, vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-534.94), (-534.94));
      Vector3D vector3D1 = new Vector3D((-534.94), vector3D0, (-534.94), vector3D0, (-534.94), vector3D0, (-534.94), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3807.82), vector3D0, 8.0E298, vector3D0, (-3807.82), vector3D0);
      Vector3D vector3D2 = Vector3D.crossProduct(vector3D1, vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.pointAt((-703.4945414305056));
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-660.0266361), vector3D0, (-660.0266361), vector3D0, (-660.0266361), vector3D0, (-660.0266361), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-660.0266361));
      assertEquals(660.0266360999999, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-404.66583128340363), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-404.66583128340363));
      assertEquals(404.66583128340363, vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.0, (-492.64), 0.6028448241656774);
      Vector3D vector3D1 = new Vector3D((-492.64), vector3D0, 0.6028448241656774, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.113144176750547E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(8.405638906990773E-17, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.96409853510999E-16, vector3D2.getX(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1.5830993332061267E-10, vector3D0, 0.0, vector3D0, 2.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.5061995849077116E-20, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.9999910105729933, vector3D2.getY(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(22.127999639558862, vector3D0, 7207134.359525958, vector3D0, (-80.045414), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-7207076.442111596), double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(2.0, vector3D1, 2.0, vector3D2);
      Line line1 = new Line(vector3D1, vector3D3);
      double double0 = line1.distance(line0);
      assertEquals(4.293140648960098E-32, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.1502554523133996E-32, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-3807.82), vector3D0, 8.0E298, vector3D0, (-3807.82), vector3D0);
      Vector3D vector3D2 = new Vector3D((-3807.82), vector3D1);
      Line line0 = new Line(vector3D1, vector3D2);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.3910999796380414, 2.3910999796380414, 0.0);
      Vector3D vector3D1 = new Vector3D(2.3910999796380414, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.8544491181822106E-16, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-1765.9312146), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      try { 
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.0, 2.0, (-18.574112673413808));
      Vector3D vector3D1 = new Vector3D(2.0, vector3D0, (-18.574112673413808), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.10644961166276296);
      assertEquals(0.12789950262443775, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D0);
      assertEquals(2.19446815676698E-15, double0, 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(311.3982740664443, double0, 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = vector3D0.add((-404.66583128340363), (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(6.862743801334825E-29, vector3D2.getNormSq(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D((-2118.7198), vector3D0, (-3576.0), vector3D1);
  ...
  public void test60()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-2118.7198), vector3D0, (-3576.0), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test62()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.3805303725938785E-17, vector3D2.getNormInf(), 0.01);
  }
}
