...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-68.415), (-68.415), 1.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.0);
      line0.toSubSpace(vector3D2);
      assertEquals((-0.5074151392909502), vector3D2.getX(), 0.01);
      assertEquals(1.0146135091807178, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-40.677573), 2955.0180980662685, 475.43702150692);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3248.0), (-3248.0), (-337.2));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-1.7976931348623157E308), vector3D0, 1.9987994582857286E-8, vector3D0, 1.3637075143546158E-15, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
  ...
  public void test14()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(0.5025261742982119, vector3D2.getNormSq(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-5.260702167285445), 0.0, 0.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(1.1485860176246045, vector3D2.getNorm1(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(34.79291, vector3D0, 34.79291, vector3D0, 0.625, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(5.335055061404412E-15, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = vector3D0.negate();
      Vector3D vector3D2 = new Vector3D((-4092.116941408), 3.141592653589724, (-4092.116941408));
      Line line0 = new Line(vector3D0, vector3D2);
      line0.reset(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(0.9999997439183067, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.1867447421339147, vector3D2.getY(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-1268.660743225), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-168.0), 5.865827662008209E-8, 0.0);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D0);
      assertEquals(4.162390609580703E-18, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, (-1.0), vector3D0, 3.141592653489793, vector3D0, (-1.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      double double0 = line0.distance(line1);
      assertEquals(2.143008219673712E-32, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(226.43, 226.43);
      Vector3D vector3D1 = new Vector3D(1179.664, vector3D0, 226.43, vector3D0, 226.43, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(3.083781807109818E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1.839648752373909E-7, 0.0, 0.0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test44()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-1268.660743225), vector3D0, (-4285.691798873418), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(2.2729627465642825E-13, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1010.6949347, vector3D0, 1010.6949347, vector3D0, 1.0E-10, vector3D0, 1010.6949347, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(1.1713303170580505E-16, vector3D2.getX(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = vector3D0.scalarMultiply((-75.7335));
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test51()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(2661870.5625760006, vector3D1, (-4285.691798873418), vector3D0, 0.0, vector3D2);
  ...
  public void test56()  throws Throwable  {
      ...
      assertEquals((-3032.0848041001), vector1D0.getX(), 0.01);
  }
