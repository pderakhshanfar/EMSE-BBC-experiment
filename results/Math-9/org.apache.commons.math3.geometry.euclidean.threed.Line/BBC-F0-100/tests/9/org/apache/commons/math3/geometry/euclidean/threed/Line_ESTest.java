...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-188.61748730937836), (-188.61748730937836));
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line0.intersection(line1);
      assertNotNull(vector3D2);
      assertEquals(0.7286443520883187, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(5476.6329919472, vector1D0.getX(), 0.01);
  }
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-2738.3164959736), (-2738.3164959736), (-2738.3164959736));
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(590.03538469, 590.03538469);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector1D vector1D1 = vector1D0.negate();
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals(0.5513939131726224, vector3D2.getZ(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.45999762583221165), vector3D2.getY(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D((-5121.69538474), 2905.590074450692, 0.19999998807907104);
      Line line0 = new Line(vector3D2, vector3D3);
      Vector3D vector3D4 = line0.pointAt((-764.1869444615484));
      assertEquals((-2.331539837104877), vector3D4.getAlpha(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D3 = line0.pointAt((-1127.0));
      assertEquals((-0.7847707395390635), vector3D3.getDelta(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D(2721.0, vector3D1, 2721.0, vector3D0, 2721.0, vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
  ...
  public void test16()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.intersection(line0);
      assertEquals(4.73933984300338E-17, vector3D3.getNorm1(), 0.01);
      assertNotNull(vector3D3);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-0.3058015757857271), (-2973.61891), 2522.9415386);
      Vector3D vector3D1 = new Vector3D((-2973.61891), vector3D0);
      ...
      assertEquals(1.7855086836262757E-9, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-2738.3164959736), vector3D0, (-983.07576687), vector3D0, (-983.07576687), vector3D0, 1403.88436218305, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.getOrigin();
      assertEquals(2.5836157246564423E-66, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(501.5, vector3D0, 8.0E298, vector3D0, 8.0E298, vector3D0, 501.5, vector3D0);
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-115.746694589014), vector3D0, 2041.6, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals(1.5303004211007607E-28, vector3D3.getNormSq(), 0.01);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 1854.9806109399, vector3D0, 489.6317653510682, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-0.9999999999998008), double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-2738.3164959736), (-2738.3164959736), (-2738.3164959736));
      Line line1 = new Line(vector3D2, vector3D0);
      double double0 = line0.distance(line1);
      assertEquals(7.33702500474832E-18, double0, 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.8014398509481984E16, 4122056.564018383, 1607.46539551888);
      Vector3D vector3D1 = new Vector3D((-1381.7), vector3D0, 1.8014398509481984E16, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-6429.861582075027), vector3D2.getZ(), 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-604.002844047), vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(3.106560712570939E-28, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Vector3D vector3D2 = new Vector3D(1.1102230246251565E-16, vector3D0, 2.3456412698181777E13, vector3D0, 1.1102230246251565E-16, vector3D0);
      Line line0 = new Line(vector3D0, vector3D2);
  ...
  public void test61()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-8.923225466966224E-14), vector3D2.getZ(), 0.01);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      assertEquals(1.7625438186243595E-14, vector3D2.getNormInf(), 0.01);
  }
}
