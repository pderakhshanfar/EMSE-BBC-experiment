...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2.7755575615628914E-17, vector3D0);
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-8.0E298), vector3D0, 1.0, vector3D0, 1.0, vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-491.89395), 2683.370195684786, (-491.89395));
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      assertEquals((-2772.074119352261), vector1D0.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2.2250738585072014E-308, vector3D0, 1.0, vector3D0, 1.0E-10, vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      Vector1D vector1D0 = line0.toSubSpace(vector3D2);
      assertEquals(0.0, vector1D0.getNormSq(), 0.01);
      assertEquals(7.841492212501411E-17, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.9999999999999999, (-1678.63));
      Vector3D vector3D1 = new Vector3D(2278.6802795636336, vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.9680008831480301, vector3D2.getY(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-491.89395), 2683.370195684786, (-491.89395));
      Vector3D vector3D1 = new Vector3D((-491.89395), vector3D0, (-491.89395), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-491.89395));
      assertEquals((-87.28470005814286), vector3D2.getX(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      assertEquals(1.1231995693770924E-16, vector3D2.getY(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals(1.000000000286178, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-491.89395), 2683.370195684786, (-491.89395));
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0);
      Vector3D vector3D2 = new Vector3D(2683.370195684786, (-491.89395));
      Vector3D vector3D3 = vector3D2.add(3055.6644, (Vector<Euclidean3D>) vector3D1);
      Line line0 = new Line(vector3D3, vector3D0);
      Vector3D vector3D4 = line0.intersection(line0);
      assertEquals((-0.9528457811076595), vector3D4.getZ(), 0.01);
  ...
  public void test16()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.1231995693770924E-16, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-254.87132860025454), (-1354.7104));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test18()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D((-3181.209648), vector3D0, (-3181.209648), vector3D1);
      Line line0 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(0.7069956518864268, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-258.53666), vector3D0, (-202.9), vector3D0, (-258.53666), vector3D0);
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2.2250738585072014E-308, vector3D0, 1.0, vector3D0, 1.0E-10, vector3D0, 1.0E-10, vector3D0);
      Vector3D vector3D2 = new Vector3D(1.0, vector3D0, 2.2250738585072014E-308, vector3D0, 2.2250738585072014E-308, vector3D1);
      Line line0 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.getDirection();
  ...
  public void test25()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D2);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-1.0000000001999998), double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals(4.5386762637779565E-11, double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Line line1 = new Line(vector3D0, vector3D2);
      double double0 = line0.distance(line1);
      assertEquals(2.2226904156742484E-17, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(0.4998428517863135, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-2.656710812765738E-10), vector3D2.getY(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(356738.5597069441, vector3D0, (-2084.7559620876195), vector3D0, 8.0E298, vector3D0, (-1705.50240711), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test45()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(2927.753654553, vector3D1);
      line0.reset(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.closestPoint(line0);
      assertEquals(5.836501115446521E-17, vector3D3.getNorm1(), 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Vector3D vector3D2 = new Vector3D(580.34, vector3D1);
      Line line0 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = new Vector3D(4.992732680136987E13, vector3D1);
