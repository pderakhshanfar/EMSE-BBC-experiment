...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 431.03, vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(line1);
      assertEquals(1.8095499068695787E-24, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-946.59731809312), (-1039.17469840155), (-946.59731809312));
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(320.5626682852, 1.0E-10);
      Vector3D vector3D1 = new Vector3D(320.5626682852, vector3D0, (-2676.693826109), vector3D0, 320.5626682852, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, 0.0, vector3D0, 661.378758339, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D(661.378758339);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(661.378758339, vector3D2.getX(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D(1978.6886110430917);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1398.644134725161, vector3D2.getX(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4.732144806239165E12, (-395.288262075492), 4.732144806239165E12);
      Vector3D vector3D1 = new Vector3D(4.732144806239165E12, vector3D0, (-395.288262075492), vector3D0, 4.732144806239165E12, vector3D0, (-395.288262075492), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-0.16624882440418567), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-4185.493245973223));
      assertEquals((-4185.493245973223), vector3D2.getX(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals(5.6363064614899687E-36, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.787487639794434E-15, vector3D2.getX(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(3786.220241735, vector3D0, 191242.82204333664, vector3D0, 3.141592653489793, vector3D0, 0.06666666666666667, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.0350373028638548E-23, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(5.34849060184297E-28, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(697.26, 393.0);
      Vector3D vector3D1 = new Vector3D(697.26, vector3D0, 393.0, vector3D0, 2205.0, vector3D0, (-254.875097513), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.1739996391155934E-13, vector3D2.getX(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D((-2772.452591), (-2772.452591));
      Line line0 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.getDirection();
      assertEquals((-0.0029257762953086588), vector3D3.getY(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, 3.141592653489793);
      Vector3D vector3D1 = Vector3D.ZERO;
      Vector3D vector3D2 = new Vector3D(431.03, vector3D0, 3.141592653489793, vector3D1, 431.03, vector3D0);
  ...
  public void test28()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(661.378758339, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-1.5524170684922034E-10), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.50000000005, vector3D2.getZ(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(4.478638893444207E25, vector3D0, 4.478638893444207E25, vector3D0);
      Vector3D vector3D2 = new Vector3D(4.478638893444207E25, 4.478638893444207E25, 4.478638893444207E25);
      Line line0 = new Line(vector3D1, vector3D2);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test37()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.7976931348623157E308, vector3D0, (-2906.0623642), vector3D0, (-5.7618793749770706E-8), vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test51()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 3.141592653489793, vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-7.878));
      assertEquals(62.06288400000003, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(1.8155657810276536E-24, double0, 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-437.31318530697956), double0, 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.07257202492682066, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test57()  throws Throwable  {
      ...
      double double0 = line0.distance(line1);
      assertEquals(0.13579394969533704, double0, 0.01);
  }
  ...
  public void test58()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 431.03, vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(300836.5516543453, vector3D1, 300836.5516543453, vector3D1);
  ...
  public void test63()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2035.5684895386003), vector1D0.getX(), 0.01);
      assertEquals(2020.8768975031428, vector3D2.getNormInf(), 0.01);
  }
