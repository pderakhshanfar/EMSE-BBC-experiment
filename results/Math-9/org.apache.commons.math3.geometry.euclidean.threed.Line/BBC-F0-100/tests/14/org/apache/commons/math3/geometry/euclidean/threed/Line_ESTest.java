...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-535.2515756784), 0.4311765432357788);
      ...
      assertEquals(7.630214355567043E-17, double0, 0.01);
  }
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(5.0614674548127384E-8, 5.0614674548127384E-8, 5.0614674548127384E-8);
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals((-1238.57468009), vector1D0.getX(), 0.01);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D((-1238.57468009), vector3D0);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1238.57468009), (-1238.57468009), (-1238.57468009));
      Vector3D vector3D1 = new Vector3D((-1238.57468009), vector3D0, 1698.5, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-861.030440814214), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D((-861.030440814214));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-861.0304408142139), vector3D2.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Vector1D vector1D0 = new Vector1D((-1802.60421646384));
      Vector3D vector3D3 = line0.toSpace(vector1D0);
      assertEquals((-1.0), vector3D3.getY(), 0.01);
      assertEquals(1.5702415739054734, vector3D3.getDelta(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-535.2515756784), 0.4311765432357788);
      Vector3D vector3D1 = new Vector3D(0.4311765432357788, vector3D0, 0.4311765432357788, vector3D0, 525.110772852, vector3D0, (-2032.120136884538), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.4311765432357788);
      assertEquals(0.43117654323577875, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.4311765432357788, vector3D0, 0.4311765432357788, vector3D0, 525.110772852, vector3D0, (-2032.120136884538), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(2433.05682127);
      assertEquals(5919765.495528475, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals(2.219027800254939E-14, vector3D2.getX(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.4311765432357788, vector3D0, 0.4311765432357788, vector3D0, 525.110772852, vector3D0, (-2032.120136884538), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D1.subtract((-535.2515756784), (Vector<Euclidean3D>) vector3D0);
      Line line1 = new Line(vector3D0, vector3D1);
      line0.reset(vector3D2, vector3D0);
      Vector3D vector3D3 = line1.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals(1.961711950996031, vector3D3.getAlpha(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      assertEquals((-1.2681868381391245E-14), vector3D2.getX(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.893485277253286E-8, (-3.28351761686));
      Vector3D vector3D1 = new Vector3D(2.893485277253286E-8, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-2.8643928637741692E-8), vector3D2.getY(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals((-1.7976931348623157E308), vector3D2.getZ(), 0.01);
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-861.030440814214), vector3D0, 1703.8107548103012, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
  ...
  public void test28()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(837.469559185786, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Line line1 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(line1);
      assertEquals(5.288293151531283E-14, double0, 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      assertEquals(2.4880364937007853E-13, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test36()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1.0708593250394448E-7, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1.7976931348623157E308));
      line0.reset(vector3D1, vector3D2);
      // Undeclared exception!
  ...
  public void test38()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-1.7976931348623157E308), vector3D0, 2633874.3125851536, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-535.2515756784), 0.4311765432357788);
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Vector3D vector3D2 = new Vector3D(0.4311765432357788, vector3D0, 0.4311765432357788, vector3D0, 525.110772852, vector3D0, (-2032.120136884538), vector3D0);
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.7675435543060303, 1.0E-10);
  ...
  public void test50()  throws Throwable  {
      ...
      assertEquals(2.0725424865154351E-13, double0, 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-1238.57468009), double0, 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(0.9999999999999998, vector3D0, (-559.179821), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(6.825976106781337E-24, (-1236.0920788), 1968.461831);
      Vector3D vector3D1 = new Vector3D((-1236.0920788), vector3D0, 2.092571258544922, vector3D0, 201986.5518811396, vector3D0, (-1236.0920788), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(vector3D0, vector3D1);
  ...
  public void test60()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.9999999999999998, vector3D0, (-559.179821), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D((-1792.09));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1792.09), vector3D2.getZ(), 0.01);
  }
