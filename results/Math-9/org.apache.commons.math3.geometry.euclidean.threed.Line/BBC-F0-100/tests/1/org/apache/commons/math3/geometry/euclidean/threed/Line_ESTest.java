...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.997844754509471E-9, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line0.intersection(line1);
      assertNotNull(vector3D2);
      assertEquals(7.629314555117541E-50, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2608.1623236438, vector3D0, 2608.1623236438, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.997844754509471E-9, 1.997844754509471E-9);
      Vector3D vector3D1 = new Vector3D(1.997844754509471E-9, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-0.1055621450263321), vector3D0, (-0.1055621450263321), vector3D0, (-0.1055621450263321), vector3D0, (-0.1055621450263321), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = vector3D1.subtract((-721.6095), (Vector<Euclidean3D>) vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D2);
      Vector3D vector3D3 = line0.toSpace(vector1D0);
      assertEquals((-360.80474999999996), vector3D3.getX(), 0.01);
      assertEquals((-509.54786403744737), vector1D0.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.9978447545094707E-9, vector1D0.getX(), 0.01);
      assertEquals(3.991383663121009E-18, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.592245296808908E-17, 520720.27049025, 520720.27049025);
      Vector3D vector3D1 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(520720.27049025);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2.540286734499126, 0.097);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.3649283163741366);
      assertEquals(1.214163887270047, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-0.1055621450263321), vector3D0, (-0.1055621450263321), vector3D0, (-0.1055621450263321), vector3D0, (-0.1055621450263321), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(926.889362763498);
      assertEquals((-926.889362763498), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4302.6023, (-9.007199254740992E15), 0.0);
      Vector3D vector3D1 = new Vector3D(3.99138375898265E-18, vector3D0, (-302.86758662704), vector3D0, 0.5000000000042687, vector3D0, 2.000000007991379, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-1.213991541888858E-10), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-88.08518745), vector3D0);
      Vector3D vector3D2 = new Vector3D((-88.08518745), (-88.08518745), (-88.08518745));
  ...
  public void test17()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.4515760203107637, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.762121386745619E-25, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.997844754509471E-9, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(1.997844754509471E-9, 1.997844754509471E-9);
      line0.reset(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.getDirection();
      assertEquals((-0.7071067804802027), vector3D3.getX(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = vector3D0.subtract((-2312.6500357), (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-0.9999999999996926), double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-7.7202392454059), 1271.583943613037, (-7.7202392454059));
      Vector3D vector3D1 = new Vector3D(1271.583943613037, vector3D0, 1271.583943613037, vector3D0, (-814.676897391), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(9.268694112027352E-13, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(2.762121386745619E-25, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.762121386745619E-25, vector3D2.getX(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      line0.reset(vector3D2, vector3D1);
      double double0 = line1.distance(line0);
      assertEquals(8.559964537137558E-19, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-7.7202392454059), 1271.583943613037, (-7.7202392454059));
      Vector3D vector3D1 = new Vector3D(1271.583943613037, vector3D0, (-7.7202392454059), vector3D0);
