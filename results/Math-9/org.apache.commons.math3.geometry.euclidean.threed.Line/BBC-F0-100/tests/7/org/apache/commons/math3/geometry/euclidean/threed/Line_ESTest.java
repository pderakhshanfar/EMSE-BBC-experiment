...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3703.2832135980057), (-860.014228));
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(line1);
      assertEquals(8.40433146988121E-17, double0, 0.01);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Vector1D vector1D1 = new Vector1D(603.0171152389833, vector1D0, 5.0, vector1D0, 2.00387068971678E13, vector1D0);
      Vector1D vector1D2 = vector1D0.subtract(0.036, (Vector<Euclidean1D>) vector1D1);
      Vector3D vector3D2 = line0.toSpace(vector1D2);
      assertEquals((-7.213934483189293E11), vector3D2.getZ(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2.536477005571527), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(9.007199254740992E15);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D2 = line1.pointAt((-921.238264804644));
      assertEquals(921.238264804644, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.0, 0.9375, 0.9375);
      Vector3D vector3D1 = new Vector3D((-150.730763), vector3D0, 2.0, vector3D0, 0.9375, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1273.10055690208));
      assertEquals((-497.3993637579526), vector3D2.getZ(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(0.6098575924982921, (-1439.2487170814), (-191.3626));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(0.9999999638977682, vector3D2.getNorm(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(740084.7754112399, (-3920.31163421), (-3920.31163421));
      Vector3D vector3D1 = new Vector3D((-615.094142759773), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.1059104675583907E-7, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(427.1996316, (-2581.508355784026), (-2581.508355784026));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.5065601900778626, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, (-1.0), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.0, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.8537115312848483, vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(64.4, 2.800552834259E-8, 8.0E298);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test21()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1222.2271165154234), vector3D0, (-1222.2271165154234), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test28()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.5065601900778625, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-710.373212), 1.1916632912439276E60, 749.866);
      Vector3D vector3D1 = new Vector3D(1.2830701674616564E7, vector3D0, 1541.80840051, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test44()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-0.7792474651598557), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = vector3D0.scalarMultiply(144.443747934);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(5.471379516483101E-29, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(103.4, (-3204.474281492118));
      Vector3D vector3D1 = vector3D0.negate();
      Vector3D vector3D2 = new Vector3D(1.0E-10, vector3D0, 854.629821658806, vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
      Line line1 = new Line(line0);
      line0.reset(vector3D0, vector3D1);
      double double0 = line1.distance(line0);
      assertEquals(1.6992998835644607E-15, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(7.387940557239994E14, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.5704920307610945E13, 5980246.405848487, (-2.356194490192345));
      Vector3D vector3D1 = new Vector3D((-2.356194490192345), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(6.599075057142921E-14, vector3D2.getZ(), 0.01);
  }
  ...
  public void test61()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(427.1996316, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.9366912185997453E-14, vector3D2.getNorm(), 0.01);
  }
