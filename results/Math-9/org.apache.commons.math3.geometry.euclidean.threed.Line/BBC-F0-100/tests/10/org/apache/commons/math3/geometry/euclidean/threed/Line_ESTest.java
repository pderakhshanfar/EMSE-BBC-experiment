...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(126.3791, 126.3791);
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line1);
      assertNotNull(vector3D2);
      assertEquals((-0.725096256985606), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      assertEquals(1.3135494962344181E-17, double0, 0.01);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(4.744376493387209E-15, 3.141592653489793, 169.0);
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D2 = vector3D1.subtract(3.4439717236742845E-8, (Vector<Euclidean3D>) vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D2);
      assertEquals((-3.4439717236742845E-8), vector1D0.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-1608.25116));
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(1.213022594634197, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      assertNotNull(vector3D2);
      assertEquals(0.2848879110845575, vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(3.4439717236742845E-8);
      Line line1 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line1.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals(3.5151164956654116E-17, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.286190183203161, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(596871.5115108112, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(8.72164798515256E-11, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.25244630146136776, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(0.01745329052209854, vector3D0, (-2585.520528284), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.1358333459435218E-33, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.32949803088726076), vector3D2.getX(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D1.subtract(3.4439717236742845E-8, (Vector<Euclidean3D>) vector3D0);
      Vector3D vector3D3 = line0.pointAt(3.4439717236742845E-8);
      Line line1 = new Line(vector3D1, vector3D2);
      double double0 = line1.getAbscissa(vector3D3);
  ...
  public void test29()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D0);
      assertEquals(1.7562525287605887E-16, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(126.3791, 126.3791);
      Vector3D vector3D1 = new Vector3D(126.3791, vector3D0, (-20.0), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-4.676425893518736E-18), vector3D2.getX(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(3.3702126727307905E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(82.005601805361, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test36()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(8.0E298, 1196.2, 1196.2);
  ...
  public void test52()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-0.16666666666666666), vector3D0, (-0.16666666666666666), vector3D0, (-1.0), vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.0, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(4.744376493387209E-15, 3.141592653489793, 169.0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test55()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, 1.0);
      Vector3D vector3D1 = new Vector3D(1022.706, (-1.0), 1022.706);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
      double double0 = line0.distance(line1);
      assertEquals(2.11036668579952E-20, double0, 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0E-10, 1.0E-10);
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Vector3D vector3D2 = new Vector3D(596871.5115108112, vector3D1);
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, 1.0);
      Vector3D vector3D1 = new Vector3D(1022.706, (-1.0), 1022.706);
      Vector3D vector3D2 = new Vector3D((-0.16666666666666666), vector3D0, (-0.16666666666666666), vector3D1, (-1.0), vector3D1, 1.0, vector3D0);
