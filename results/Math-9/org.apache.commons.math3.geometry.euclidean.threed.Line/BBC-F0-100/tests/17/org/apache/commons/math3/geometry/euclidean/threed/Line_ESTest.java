...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1371.4165059857803), (-1371.4165059857803));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1371.1995968271867), (-1371.1995968271867));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D(0.0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.5524066182968832), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-4299.294754561423), 980.6997143069606);
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-3078.642551643809), 1.7903735268124668, (-3078.642551643809));
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test10()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(131.1);
      assertEquals((-131.1), vector3D2.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-2482.82906824663));
      assertEquals((-0.7856829622066422), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1374.906944513946, (-2520.46), 0.9999999999999998);
      Vector3D vector3D1 = new Vector3D(0.9999999999999998, vector3D0, 1374.906944513946, vector3D0, 3.855743695173901E-17, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1374.906944513946);
      assertEquals(1374.9069445139457, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertNotNull(vector3D2);
      assertEquals(1.0551761691021717, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-1814.594289), 1893.11, 1893.11);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.3284549225472153), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(Double.NEGATIVE_INFINITY, (-896.5320274162253));
      Line line0 = new Line(vector3D0, vector3D0);
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, 0.0, vector3D0, (-18.430862426757812), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(6.272300150241775E-17, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.6366197723675814, vector3D0, 0.0, vector3D0, 1084.60204244178, vector3D0, 0.6366197723675814, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test22()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.7431942449753636, vector3D2.getZ(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-1372.5716170484889), (-1372.5716170484889));
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
      double double0 = line0.distance(line1);
      assertEquals(1.360676397840591E-17, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.5524066182968833, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test39()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-302.38041590087136), 1.0E-10, (-302.38041590087136));
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Vector3D vector3D2 = vector3D0.scalarMultiply(551.72);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test48()  throws Throwable  {
      ...
      assertEquals(4.701126531754759E-16, double0, 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1882023.513362147, vector3D0, (-584.95), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(Double.NEGATIVE_INFINITY, (-896.5320274162253));
      Vector3D vector3D2 = new Vector3D((-3078.642551643809), 1.7903735268124668, (-3078.642551643809));
      Vector3D vector3D3 = vector3D1.add(1.9987994582857286E-8, (Vector<Euclidean3D>) vector3D2);
  ...
  public void test59()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.49999988903766024, vector3D2.getX(), 0.01);
  }
}
