...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(0.0, 1.2537167179050217E-16, 1.0E-10);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(1188.415294, vector3D1, 1.0E-10, vector3D2);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(447.3320162, 1.0E-10, 1652.270359358886);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.2537167179050217E-16, 1.2537167179050217E-16, 1.2537167179050217E-16);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(447.3320162, 1.0E-10, 1652.270359358886);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D((-1084.925), vector3D0, 1.0E-10, vector3D1, 743.7047477, vector3D0, 1.0E-10, vector3D0);
      ...
      assertEquals((-1.2969298588766603E-10), vector1D0.getX(), 0.01);
      assertEquals(3.019179604694796E-51, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3412592.367734828, (-3641.128));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D((-3641.128), vector3D1);
      Vector3D vector3D3 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D2, vector3D3);
      Vector3D vector3D4 = line0.pointAt(3412592.367734828);
      assertEquals(3412592.367734828, vector3D4.getX(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(447.3320162, 1.0E-10, 1652.270359358886);
      Vector3D vector3D1 = new Vector3D((-1084.925), vector3D0, 1652.270359358886, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-20.0));
      assertEquals(399.99999999999727, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(6.656130418439938, 1129.1452284);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.016463603090784075, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(447.3320162, 1.0E-10, 1652.270359358886);
      Vector3D vector3D1 = new Vector3D((-1084.925), vector3D0, 1.0E-10, vector3D0, 743.7047477, vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-1.1882847012895451E-24), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(2645.4, vector3D0, (-1276.8248), vector3D0, 2.85040095144011776E17, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(4.676449064407966E-18, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.0, 348.831, (-2447.075704882));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.1200677293393453, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(0.0, 1129.1452284);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.12831057279423266), vector3D2.getX(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(0.9917340353689672, double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(3.9341455876368636, 0.0, 0.0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(line1);
      assertEquals(1.3675227317523032E-17, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-529.52891351), (-529.52891351), 324.167887257);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-0.8413676508128364), vector3D2.getZ(), 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 3.141592653489793, vector3D0, 3.141592653489793, vector3D0, (-1.7976931348623157E308), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(3.9341455876368636, 0.0, 0.0);
  ...
  public void test54()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      Vector3D vector3D3 = new Vector3D(1.6927473142098455, vector3D2);
      Line line1 = new Line(vector3D2, vector3D3);
      boolean boolean0 = line0.isSimilarTo(line1);
      assertFalse(boolean0);
      assertEquals(1.196953104713097, vector3D3.getY(), 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(2.356194490192345);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2.356194490192345), vector3D2.getY(), 0.01);
  }
