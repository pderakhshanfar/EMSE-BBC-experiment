...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(3513880.777314484, vector3D0, (-1050.896029885782), vector3D0, (-1050.896029885782), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Vector3D vector3D1 = new Vector3D(1.0, 3.141592653489793, 652.585);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D2 = vector3D0.add((-3588.244734), (Vector<Euclidean3D>) vector3D1);
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.0E-6), 3034.983, 0.9999999999999999);
      Vector3D vector3D1 = new Vector3D(0.9999999999999999, vector3D0, 1.3748764056667082, vector3D0, (-424.64), vector3D0, (-2113.473826818), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.NEGATIVE_INFINITY;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D2 = vector3D0.add((-3588.244734), (Vector<Euclidean3D>) vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.pointAt((-407.9796493));
      assertEquals((-0.0024510977424689003), vector3D3.getDelta(), 0.01);
      assertEquals((-407.97964929999995), vector3D3.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(3513880.777314484, vector3D0, (-1049.905636280273), vector3D0, (-1049.905636280273), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-512.9119828103));
      assertEquals(512.9119828102913, vector3D2.getX(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.254589191043175, 2.254589191043175, 2.0282409603651652E31);
      Vector3D vector3D1 = new Vector3D((-2126.3641726956616), vector3D0, 3.141592653489793, vector3D0, 2.254589191043175, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(8.301814857895917E-15, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(9.524662627258283E-4, vector3D0, 9.524662627258283E-4, vector3D0, 1889883.4756667705, vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1.109266781963504, vector3D0, 1.109266781963504, vector3D0, 1.109266781963504, vector3D0, 1.109266781963504, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.3970280175115117E-32, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-2.7846366862560553E-16), vector3D2.getX(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals((-8.59921453696339E-12), vector3D2.getX(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(5.408314852641153E-17, 1226.7495);
      Vector3D vector3D1 = new Vector3D(5.408314852641153E-17, vector3D0, 1226.7495, vector3D0, 5.408314852641153E-17, vector3D0, 1226.7495, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-1.5462183913137442), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      line0.reset(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-1.1115982938423933E-31), vector3D2.getY(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-3511778.985254713), double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(162.9659273, vector3D0);
      Vector3D vector3D2 = new Vector3D(612.83679, vector3D1, (-2539.490926), vector3D0, 0.0, vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(7.505618388848313E-14, double0, 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      line0.reset(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(6.30835838700625E14, vector3D2.getZ(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1947.61101), 804.11, 2426.0405);
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1064.3530383573486, 965.8073881461, (-332.292));
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D1);
      assertEquals(4.810467249787867E-14, double0, 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(1475.1436210329255, double0, 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      double[] doubleArray0 = new double[3];
      doubleArray0[0] = (-407.9796493);
      Vector3D vector3D1 = new Vector3D(doubleArray0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(3.141592653589793, vector3D2.getAlpha(), 0.01);
      assertEquals(1.0024450800571014, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, 3.141592653489793, 652.585);
      Line line0 = null;
      try {
  ...
  public void test58()  throws Throwable  {
      ...
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.2261812436760455, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1064.3530383573486, 965.8073881461, (-332.292));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1.633123935319537E16);
      Line line1 = new Line(vector3D2, vector3D0);
      boolean boolean0 = line1.isSimilarTo(line0);
      assertFalse(boolean0);
      assertEquals(2.6670937881135714E32, vector3D2.getNormSq(), 0.01);
  }
