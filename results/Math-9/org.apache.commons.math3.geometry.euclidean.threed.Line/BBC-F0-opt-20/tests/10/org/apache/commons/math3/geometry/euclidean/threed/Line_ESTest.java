...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.177180825437198E-32, 2.177180825437198E-32, 2.177180825437198E-32);
      Vector3D vector3D1 = new Vector3D(2.177180825437198E-32, 2.177180825437198E-32);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = new Vector3D(2.177180825437198E-32, 1.0E-10);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1825.8506589421381), (-1825.8506589421381), (-1825.8506589421381));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2615.261342273, 2615.261342273, 2615.261342273);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
      Vector1D vector1D0 = Vector1D.ONE;
      Vector1D vector1D1 = new Vector1D(2224.7, vector1D0, 2224.7, vector1D0, (-2691.197509654), vector1D0, 2615.261342273, vector1D0);
      Vector3D vector3D2 = line1.toSpace(vector1D1);
      assertEquals(1.912718656172321E7, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D((-2765.89));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.785653815923681), vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2334.107642793873, vector3D0, 2334.107642793873, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(8.872590743182145E-17, vector3D2.getY(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.2853089077608792, 0.2853089077608792, 0.2853089077608792);
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(130.0039017, 0.0);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.5403022766113281, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(0.0);
      assertEquals((-2.2438426396978765E-17), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(130.0039017, 130.0039017);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.5403022766113281, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(0.0);
      assertEquals(2.3291876537838553E-17, vector3D2.getX(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(9279652.464049965);
      assertEquals((-9279652.464049965), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2614.7270257310474, 2614.7270257310474, 2614.7270257310474);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.666496700128643, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(4.062396624355371E-27, vector3D0, 8.0E298, vector3D0, (-3490.45987835381), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
  ...
  public void test19()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-2.4213703438265832), vector3D2.getAlpha(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.9551363896968583), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-78.499), vector3D0, 2.479773539153719E-5, vector3D0, (-1246.3365924), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.397653076871358E-21, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals((-0.5772766818657252), vector3D2.getX(), 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D((-78.499), vector3D1, (-2250.1934413616127), vector3D0, 0.7214844226837158, vector3D0, 1.0, vector3D1);
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals((-2.4797735391537192E-5), double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      double double0 = line0.distance(line1);
      assertEquals(2.177180825437198E-32, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      double[] doubleArray0 = new double[3];
      doubleArray0[2] = (-1246.3365924);
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D((-78.499), vector3D0, 2.479773539153719E-5, vector3D0, (-1246.3365924), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-1.0667360791348081E-13), vector3D2.getZ(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(2.397653076871358E-21, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = vector3D0.add(2570.905656, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test47()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2880.958386922, 1575.6);
      Line line0 = null;
      try {
  ...
  public void test61()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(0.5403022766113281, double0, 0.01);
  }
