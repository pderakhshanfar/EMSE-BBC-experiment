...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1952.28), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = Vector3D.PLUS_I;
      Vector3D vector3D3 = new Vector3D(2504.265332, vector3D0, 1.0E-10, vector3D2);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-30.97), (-30.97));
      Vector3D vector3D1 = new Vector3D((-30.97), (-30.97), (-30.97));
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(5.047714442519177E-28, vector3D2.getNormSq(), 0.01);
      assertEquals((-2.246711918007998E-14), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D((-764.2513979733931), 1585.643020538273, 813.7356317);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.14285714285714285, 0.14285714285714285, 1736.845974274);
      Vector3D vector3D1 = new Vector3D(1736.845974274, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test11()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1952.28));
      assertEquals((-0.7857603587537833), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1952.28));
      assertEquals(1952.28, vector3D2.getX(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals(5.954590250324027E-15, vector3D3.getNorm(), 0.01);
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-1354.7), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.3060409341795093E-26, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.246711918007998E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(2.246711918007998E-14, vector3D2.getNormInf(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(132.826776782841, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(9.76454907200436E-15, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-2176.167408), vector3D0, (-2176.167408), vector3D0, 2092.4, vector3D0, 2.693402095745164E161, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-1952.28), (-1952.28), (-1952.28));
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.getDirection();
      assertEquals((-0.5771530645018902), vector3D2.getX(), 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(0.9999999999999776, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(890.016591, vector3D0, 1.0000000000000001E-20, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D1);
      assertEquals(2.124985288842751E-13, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-1354.7), vector3D0);
      Vector3D vector3D2 = new Vector3D(3.141592653489793, vector3D1, 3.141592653489793, vector3D1);
      ...
      assertEquals(3.4878615121295076E-17, double0, 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0000000000000002, vector3D0, 1.0000000000000002, vector3D0, 4318.808309736, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(0.0, vector3D0, (-172.32667286308921), vector3D1, 3.141592653489793, vector3D1);
  ...
  public void test51()  throws Throwable  {
      ...
      assertEquals((-1952.28), double0, 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.5771530645014277), vector1D0.getX(), 0.01);
  ...
  public void test63()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      Vector3D vector3D3 = vector3D2.add(1.0E-10, (Vector<Euclidean3D>) vector3D1);
      Line line1 = new Line(vector3D3, vector3D0);
      boolean boolean0 = line0.isSimilarTo(line1);
      assertEquals((-2.356194490292345), vector3D3.getAlpha(), 0.01);
      assertFalse(boolean0);
  }
}
