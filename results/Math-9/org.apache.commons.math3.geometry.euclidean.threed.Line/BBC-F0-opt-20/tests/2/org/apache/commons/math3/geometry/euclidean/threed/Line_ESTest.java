...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.2797269575317875, vector3D0);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(631.175917562, 1146.9502654491, 631.175917562);
      Vector3D vector3D1 = new Vector3D(283.1986715883955, vector3D0, 0.5000000000000001, vector3D0, 2.076850914402338E-32, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, 4.0, 4.0);
      Vector3D vector3D1 = new Vector3D(30.5823772734, vector3D0, 0.0, vector3D0, 1.0, vector3D0, 1.0, vector3D0);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-0.16624882440418567), vector3D0, 1.0, vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.NEGATIVE_INFINITY;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-0.16624882440418567), vector3D0, 1.0, vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1.1306923225337035E-17));
  ...
  public void test12()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-2392.12220346184));
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.ZERO;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1672.33396));
      assertEquals(1672.33396, vector3D2.getX(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals((-1.1306923225337035E-17), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D((-119.83182145016), (-119.83182145016));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
  ...
  public void test17()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(2.7156608087536713E-17, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-0.16624882440418567), 1.0, 1.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.3607830982333395, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(1.1306923225337035E-17, vector3D2.getX(), 0.01);
      assertEquals(1.1306923225337035E-17, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1530.891011338421), (-4246.99));
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Vector3D vector3D2 = new Vector3D((-2489.040219), vector3D0, 200.4876664260691, vector3D0, (-4246.99), vector3D1, 475.1012718394, vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-0.0022109579364609634), double0, 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D((-119.83182145016), (-119.83182145016));
      Vector3D vector3D2 = vector3D0.add((-119.83182145016), (Vector<Euclidean3D>) vector3D1);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
      line0.reset(vector3D2, vector3D1);
      double double0 = line1.distance(line0);
      assertEquals(3.7083030721313225E-15, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      assertEquals(1.1306923225337035E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1520.782970093, vector3D0);
      Vector3D vector3D2 = new Vector3D(2133.939404987978, vector3D1, 4913.21416426008, vector3D1);
      Line line0 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.closestPoint(line0);
      assertEquals(1.7690653894741509E-13, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test38()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1022.0), (-1022.0), 0.9999999999999998);
      Vector3D vector3D1 = new Vector3D((-877.090104), vector3D0, (-383.277699366), vector3D0, (-1022.0), vector3D0, 4.42536434760941E61, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test39()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1102.20468833108), (-1102.20468833108), 0.0);
  ...
  public void test40()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(8.0E298, vector3D0, 3.141592653489793, vector3D0, 8.0E298, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test50()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(7.374813628200644E-34, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(19.73207017053869);
      assertEquals((-2.320374410251875), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test58()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Vector3D vector3D2 = new Vector3D(1.0E-10, vector3D0, 1.0E-10, vector3D1);
      Vector3D vector3D3 = new Vector3D(1.0E-10, vector3D2, 1.5, vector3D0, (-2977.082769167401), vector3D1, 1245.3267492297, vector3D1);
  ...
  public void test64()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.7891704175203786), vector3D2.getY(), 0.01);
  }
  ...
  public void test66()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.38684376293922984, vector3D2.getDelta(), 0.01);
  }
