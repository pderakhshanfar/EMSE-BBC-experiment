...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3002.113745), (-3002.113745));
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line1);
      assertEquals(0.025692188801973163, vector3D2.getNormSq(), 0.01);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(2.0000000002, 1.2246467991473532E-16, 2.0000000002);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(117711.879522963, 117711.879522963, 117711.879522963);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.19454771280288696, 0.19454771280288696, (-1519.526272));
      Vector3D vector3D1 = new Vector3D(0.19454771280288696, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(4.590327267925429E10, vector3D0, (-1180.218469102042), vector3D0, (-1180.218469102042), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.000007161742202, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1321.0));
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(2594.89, (-1337.0));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test12()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(3258.7214615105713);
      assertEquals((-0.7856151524155158), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-176.9389111111), 0.1666666505023083, (-176.9389111111));
      Vector3D vector3D1 = new Vector3D(2589.9891541298, vector3D0, 0.0, vector3D0);
      Vector3D vector3D2 = new Vector3D(0.1666666505023083, vector3D1, 0.1666666505023083, vector3D1, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.pointAt((-305.0));
      assertEquals(0.20314685461455614, vector3D3.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-176.9389111111), 0.1666666505023083, (-176.9389111111));
      Vector3D vector3D1 = new Vector3D(0.1666666505023083, vector3D0, 0.1666666505023083, vector3D0, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(2.733075342954956E-15, vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-176.9389111111), 0.1666666505023083, (-176.9389111111));
      Vector3D vector3D1 = new Vector3D(2571.6484933002394, vector3D0, 0.0, vector3D0);
      Vector3D vector3D2 = new Vector3D(0.1666666505023083, vector3D1, 0.1666666505023083, vector3D1, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.intersection(line0);
      assertEquals((-0.785381278477254), vector3D3.getDelta(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.15008556248863117, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(221.9588108855802, vector3D0, 221.9588108855802, vector3D0, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test27()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D2, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-643502.2222990772), double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(1.291395287594394E-17, double0, 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      assertEquals(0.7853981607564583, vector3D3.getDelta(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      assertEquals(4.590327031881735E10, vector3D1.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = vector3D0.scalarMultiply(2023.53);
      Line line0 = new Line(vector3D0, vector3D1);
      try { 
  ...
  public void test51()  throws Throwable  {
      ...
      assertEquals(3.5807902575774124E-6, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      assertEquals(3.3306730494338957E-16, double0, 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      assertEquals(0.8320502943293099, double0, 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-3.5808646897119727E-6), vector3D2.getY(), 0.01);
  }
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2.1071102258706115E21, 2.1071102258706115E21, 2.1071102258706115E21);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.6666666666666666, vector3D2.getY(), 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.19454771280288696, 0.19454771280288696, (-1519.526272));
      Vector3D vector3D1 = new Vector3D(0.19454771280288696, vector3D0);
      Vector3D vector3D2 = new Vector3D(4.6561129922967865E10, vector3D1);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(vector3D2, vector3D1);
  ...
  public void test62()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2.1071102258706115E21, vector3D0, 2.1071102258706115E21, vector3D0);
      Vector3D vector3D2 = new Vector3D(2.1071102258706115E21, 2.1071102258706115E21, 2.1071102258706115E21);
  ...
  public void test63()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.55470019623803), vector3D2.getX(), 0.01);
  }
