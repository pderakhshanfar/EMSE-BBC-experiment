...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3008.568, 8.0E298, 723.40325);
      Vector3D vector3D1 = new Vector3D(1.2537167179050217E-16, vector3D0, (-1122.85842), vector3D0, (-1122.85842), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(2758.99, 1.0E-10, 1.0E-10);
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-4138.650955261057), 1.7976931348623157E308);
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.81, (-7.7937176016655565), 4.440892098500626E-16);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(5.4140164E7);
      assertEquals(1.7737901272565235, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-9.42684814944145), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-9.803793248453479E-16), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-0.1666666567325592), (-0.1666666567325592), 4.0);
      Vector3D vector3D1 = new Vector3D(1.5700924586837752E-16, 534.780591);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.020400682809168062, vector3D2.getY(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2705.0), vector3D0, (-2254.0002), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.166463218550392E-25, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-2429.0328725889), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(3.0895221037358626E-35, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3627.286477), (-3627.286477), (-3627.286477));
      Vector3D vector3D1 = new Vector3D((-3627.286477), 1.0E-10);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.46891093400792483, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-875.8259930641698));
      double double0 = line0.getAbscissa(vector3D2);
      assertEquals(875.8259930641698, vector3D2.getX(), 0.01);
      assertEquals((-875.8259930641698), double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      assertEquals(0.201602563512306, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(6.801663999999998E38, vector3D0, (-3909.5447352614524), vector3D0);
      Vector3D vector3D2 = new Vector3D(2.6769918730316222E-15, vector3D1, 3.141592653489793, vector3D0, 0.30650699440774565, vector3D1);
  ...
  public void test37()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-0.16624882440418567), vector3D0, (-8.0E298), vector3D0, (-602.3002917807464), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D((-1511.533), 3984.5, 0.9984583358384465);
      Line line1 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line1.closestPoint(line0);
      assertEquals(1.2894436788621618E-17, vector3D3.getAlpha(), 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      assertEquals(8.72376015389407E-21, double0, 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(274.7, vector3D2, 274.7, vector3D0, 9.47082368638036E14, vector3D1, (-1635.914997891739), vector3D1);
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Vector3D vector3D2 = new Vector3D((-75.0544737442), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(vector3D2, vector3D1);
  ...
  public void test58()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(6.801663999999998E38, vector3D0, (-3909.5447352614524), vector3D0);
      Vector3D vector3D2 = vector3D1.add((-1.0), (Vector<Euclidean3D>) vector3D0);
      Line line0 = null;
      try {
        line0 = new Line(vector3D2, vector3D1);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test59()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.getDirection();
      Line line1 = new Line(vector3D2, vector3D1);
      Vector1D vector1D0 = new Vector1D(3008.568);
  ...
  public void test62()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-4138.650955261057), 1.7976931348623157E308);
      Line line0 = new Line(vector3D1, vector3D0);
