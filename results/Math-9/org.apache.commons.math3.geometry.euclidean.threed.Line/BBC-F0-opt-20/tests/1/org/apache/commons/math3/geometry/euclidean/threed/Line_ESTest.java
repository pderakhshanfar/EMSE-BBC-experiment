...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(53.0, vector3D0, 53.0, vector3D0);
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(321.22, 321.22);
      Vector3D vector3D1 = new Vector3D(321.22, vector3D0, 321.22, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test04()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(806.191257250322);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-569.563304935011), vector3D2.getX(), 0.01);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.26247697E8, vector3D0, 3.141592653489793, vector3D0, (-830.4634133059728), vector3D0, 3.141592653489793, vector3D1);
      Vector3D vector3D3 = new Vector3D((-2588.2999), vector3D2, (-0.49999999999999994), vector3D2);
      Line line0 = new Line(vector3D3, vector3D2);
      Vector1D vector1D0 = new Vector1D((-169.4903));
      Vector3D vector3D4 = line0.toSpace(vector1D0);
      assertEquals(28726.980772949326, vector3D4.getNormSq(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.036, 1021.559);
      Vector3D vector3D1 = new Vector3D(834.486, 2292.5279189269986, (-98.92488476267933));
      Vector3D vector3D2 = new Vector3D(3.141592653489793, vector3D0, (-98.92488476267933), vector3D0, 2367.687356896, vector3D0, 3.141592653489793, vector3D1);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(504.04, vector3D0, (-194.98277863), vector3D0);
      line0.reset(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.pointAt((-194.98277863));
      assertEquals((-194.98277863), vector3D3.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(3.29495194289187E-17, vector3D3.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = line0.pointAt(0.9985313415527344);
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.036, 1021.559);
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, (-98.92488476267933), vector3D0, 2367.687356896, vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-1.4364875700907805E-13), vector3D2.getZ(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      assertEquals(3.29495194289187E-17, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D((-194.98277863), vector3D0);
      line0.reset(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.getDirection();
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1.7976931348623157E308), vector3D0, 3.141592653589793, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(3.925231146709437E-17, vector3D0, (-4.440892098500626E-16), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(11235.999999998077, vector3D0, 53.0, vector3D0);
      Vector3D vector3D2 = new Vector3D(11235.999999998077, 53.0);
      Line line0 = new Line(vector3D2, vector3D1);
      Line line1 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(line1);
      assertEquals(7.852442943944206E-18, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(3.925231146709437E-17, vector3D0, (-4.440892098500626E-16), vector3D0, 1.0E-10, vector3D0, 1.5223258195730109E7, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(4.105323910238373E-18, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      assertEquals((-6.963950700501293E-16), vector3D3.getY(), 0.01);
  }
  ...
  public void test41()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1.0), 490.47);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test46()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(3.552713678800501E-15, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(53.0, vector3D0, 53.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(164.18616141794618);
      assertEquals((-164.18616141794618), vector3D2.getY(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(11235.999999998077, 53.0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.20707533077475332, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      assertFalse(boolean0);
      assertEquals(0.9999999999999978, vector3D4.getZ(), 0.01);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.817006694418319), vector3D2.getDelta(), 0.01);
  }
}
