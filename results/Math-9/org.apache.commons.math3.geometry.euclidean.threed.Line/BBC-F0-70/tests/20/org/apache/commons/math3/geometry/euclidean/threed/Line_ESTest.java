...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Vector3D vector3D1 = new Vector3D(9.73158036476648E-15, 0.0);
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-22.91), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.9999999999999983, vector1D0.getX(), 0.01);
      assertEquals(1.0, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1566.5093), 0.0);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-22.91), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.4126507197005265), vector3D2.getX(), 0.01);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(2.6876931599074986E-14);
      assertEquals((-2.6876931599074986E-14), vector3D2.getZ(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-22.91), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1517.63));
      assertEquals((-1382.3929839034663), vector3D2.getY(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals(1.467336348155901E-16, vector3D2.getNorm(), 0.01);
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(4.385602401429251E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-22.91), vector3D0, (-22.91), vector3D0, (-22.91), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(2.3497037211075087E-17, vector3D2.getNorm(), 0.01);
      assertNotNull(vector3D2);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1566.5093), (-4.079548411126242));
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 1768790.93794509, vector3D0, 0.0, vector3D0);
      Vector3D vector3D2 = new Vector3D(1768790.93794509, vector3D1, (-4.079548411126242), vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals(1.0984747458725448E-7, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.5326608331389897, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-2.3497037211075087E-17), vector3D2.getZ(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(5725.740171, 498.403837141);
      Vector3D vector3D1 = new Vector3D(5.828356776924191E-15, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(6.073124291424151E-31, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-1329.95491214578), 3.141592653489793, 0.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(7.519028790030844E-4, vector3D2.getZ(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals(22.91, double0, 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D0);
      assertEquals(1.0646729015026394E-17, double0, 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals(4.092672084562571E-16, double0, 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1566.5093), 0.0);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-22.91), vector3D0, 0.0, vector3D0);
      Vector3D vector3D2 = new Vector3D((-22.91), vector3D1, 0.0, vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      line0.reset(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.closestPoint(line0);
      assertEquals((-2.2185860748386643), vector3D3.getAlpha(), 0.01);
  }
  ...
  public void test40()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.5874010519681994, 0.0, 1.5874010519681994);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, (-4492.235750156403), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      try { 
  ...
  public void test42()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(9.73158036476648E-15, 0.0);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D1, vector3D0);
