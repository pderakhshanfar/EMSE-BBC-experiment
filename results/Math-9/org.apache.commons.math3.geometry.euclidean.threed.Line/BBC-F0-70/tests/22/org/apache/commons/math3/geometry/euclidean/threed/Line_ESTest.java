...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(5118070.995652535, (-1.0));
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Vector3D vector3D1 = new Vector3D((-1292.4840511695968), (-1073.360728046741), (-1793.450935148875));
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.0), 0.008333333333329196);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(2019.389413691, vector3D0, (-958.1), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.0, vector3D2.getNormSq(), 0.01);
      assertEquals((-1.0000000000000042), vector1D0.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1.0, vector3D0, 379.893, vector3D0, 0.2, vector3D0, 5.888305599538689E14, vector3D0);
      Vector3D vector3D2 = new Vector3D(2318.61661, vector3D1, 379.893, vector3D0);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D3 = line0.pointAt((-2607.88));
      assertEquals(2607.880043322968, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(3.682941969615793);
      assertEquals(3.682941969615793, vector3D2.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-2556.97699057302));
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1586.6408110013347, vector3D0, (-522.7796569305482), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(1.0984641458964186E-16, vector3D2.getNorm(), 0.01);
      assertNotNull(vector3D2);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.19999954104423523, 1.0E-10);
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.49003333451078657, vector3D2.getX(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.19999954104423523, 1.0E-10);
      Vector3D vector3D1 = new Vector3D((-2111.0833), vector3D0, (-2111.0833), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-1.6476539459642145E-26), vector3D2.getZ(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, 3.141592653489793, (-4926.0339403));
      Vector3D vector3D1 = vector3D0.subtract(3.141592653489793, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(6.377526857890421E-4, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-3544.8559352366), vector3D0, (-3544.8559352366), vector3D0, 1.1102230246251565E-16, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test22()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.9999995931062445, vector3D2.getZ(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1.5, vector3D0, 2661.345499345714, vector3D0, 2661.345499345714, vector3D0, (-4713.127097), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-0.9999999999999918), double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals(6.024130908314824E-21, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals((-0.4356007010328746), vector3D3.getX(), 0.01);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(5118070.995652535, (-1.0));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-2607.88));
      assertEquals(3868.113233800072, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test48()  throws Throwable  {
      ...
      assertEquals(1.8438425924595885E-17, double0, 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1793.450935148875), (-1793.450935148875), 9850810.208899766);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(6.629258815147348E-8, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      assertEquals((-0.8414709848078964), vector3D3.getZ(), 0.01);
      assertEquals((-1.0), vector3D3.getDelta(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1793.450935148875), (-1793.450935148875), 9850810.208899766);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Vector3D vector3D2 = new Vector3D(18625.0, vector3D0, (-1073.360728046741), vector3D1, 0.25534194707870483, vector3D1, 1.25, vector3D1);
