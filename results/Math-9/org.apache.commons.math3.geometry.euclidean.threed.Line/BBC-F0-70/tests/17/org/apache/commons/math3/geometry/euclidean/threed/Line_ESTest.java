...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(1.1730463525082348E-7);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1.1730463525082348E-7), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 121.81945146680384, vector3D0, 121.81945146680384, vector3D0, 121.81945146680384, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      ...
      assertEquals(1.000000000000001, vector1D0.getX(), 0.01);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-5.207000323380292E-8), vector3D0, (-5.207000323380292E-8), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      Vector1D vector1D0 = new Vector1D(444.5);
      Vector3D vector3D2 = line1.toSpace(vector1D0);
      assertEquals((-444.5), vector3D2.getY(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 128.9077, vector3D0, 128.9077, vector3D0, 128.9077, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(14.101419448852539);
      assertEquals(14.101419448852582, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(14840.978755672977, 1.1102230246251565E-16, 14840.978755672977);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-44.5));
      assertEquals((-0.7694763063787325), vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, 3176.3767500308);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.9872204999289933, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(0.9999999999996483, vector3D0, 450.55464, vector3D0, 0.5850973129272461, vector3D0, 444.5, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(8.264947158011685E-35, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, 3176.3767500308);
      Vector3D vector3D2 = new Vector3D(3176.3767500308, vector3D0, 3176.3767500308, vector3D1, 0.902267575263977, vector3D0);
      Line line0 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(0.11304819010668887, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = Vector3D.ZERO;
      Vector3D vector3D2 = new Vector3D(0.0, vector3D0, 128.90765082699355, vector3D1, 128.90765082699355, vector3D0, 128.90765082699355, vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(7.816000266993245E-29, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.9872204999289933, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(2.4568539694112244E8, vector3D0, 2.4568539694112244E8, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(3176.3767500308, vector3D0, 3176.3767500308, vector3D0, 0.902267575263977, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(1.6148921941502151E-12, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2504866.9579667686, vector3D0, (-1401.490309126), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(line1);
      assertEquals(4.955425973420881E-26, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      assertEquals(4.016952219691166E-18, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.closestPoint(line0);
      double double0 = line0.getAbscissa(vector3D2);
      assertEquals((-7.356799202360665E-17), vector3D2.getX(), 0.01);
  ...
  public void test33()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(3.011470354064531E-48, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test43()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 121.819451, vector3D0, 121.819451, vector3D0, 121.819451, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1318.0, 14.101419448852539);
      Vector3D vector3D1 = new Vector3D((-637.093), vector3D0, 635.651065258833, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.817994660383025E-18, vector3D2.getY(), 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1.1730463525082348E-7, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-1.0463584488059002E-16), vector3D2.getZ(), 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1304.0), 3.141592653489793, 3.141592653489793);
      Vector3D vector3D1 = new Vector3D((-1304.0), vector3D0, 3.141592653589793, vector3D0, (-4143.0), vector3D0);
      Vector3D vector3D2 = new Vector3D((-1304.0), vector3D1, (-32.97416562867224), vector3D0, (-4143.0), vector3D1, 2047.62872, vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
  ...
  public void test55()  throws Throwable  {
      ...
      Vector3D vector3D2 = vector3D1.scalarMultiply(1.0E-10);
      Line line0 = new Line(vector3D0, vector3D2);
