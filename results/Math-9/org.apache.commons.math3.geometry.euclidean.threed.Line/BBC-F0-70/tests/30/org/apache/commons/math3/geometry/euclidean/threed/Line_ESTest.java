...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(465733.9353419251, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line1.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(4.029270727310031E-11, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.36938209828962004, 507.8615677918, 0.36938209828962004);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1155.61), (-1155.61), 1045.612935089);
      Vector3D vector3D1 = new Vector3D((-1155.61), vector3D0, 1045.612935089, vector3D0, 1.5707963267948966, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.POSITIVE_INFINITY;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.9999999999597073), vector1D0.getX(), 0.01);
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.36938209828962004, 507.8615677918, 0.36938209828962004);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.36938209828962004);
      assertEquals(0.9995397923731564, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D3 = line0.pointAt(809.8114398583);
      assertEquals((-572.1231606062458), vector3D3.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.pointAt(809.8114398583);
      assertEquals((-809.8114398583), vector3D2.getZ(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1841.6646));
      assertEquals((-1841.6646), vector3D2.getY(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertNotNull(vector3D2);
      assertEquals(0.49818070618639815, vector3D2.getDelta(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0136183963787653, 1.0136183963787653, 1.0E-10);
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.6726510964506428, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(643.56230118263, vector3D0, (-2896.815662815), vector3D0, (-4.440892098500626E-16), vector3D0, (-4.440892098500626E-16), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-1.1191201285259303E-13), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-1319.7725176), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.1101288070275797E-26, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(4.029270727310031E-11, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(0.820153093300661, vector3D0, 0.820153093300661, vector3D0, 0.820153093300661, vector3D0, (-1.7976931348623157E308), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(530858.7864290434, vector3D0, 530858.7864290434, vector3D0, 530858.7864290434, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test29()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(224.0, 224.0, 1099.8780697231657);
      Line line1 = new Line(vector3D0, vector3D2);
      double double0 = line1.distance(line0);
      assertEquals(1.2537924368257968E-18, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-2.6033824355191673E-8), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.1107547485056938E-48, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2118774.2359260907, 1.1921056801463227E-8);
      Vector3D vector3D1 = new Vector3D(2118774.2359260907, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.7023852539727114E63, 3.7023852539727114E63);
      Vector3D vector3D1 = new Vector3D(3.7023852539727114E63, vector3D0, 504.734501, vector3D0, 0.7071067811865475, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test46()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-4.029270727310031E-11), vector3D2.getY(), 0.01);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(9.219544613762692E-9, 0.0, 1.0E-10);
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1008.81, vector3D0, (-4458.4822094628), vector3D0, 0.9804951158072761, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.7627265839560258E-17, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.7023852539727114E63, 3.7023852539727114E63);
      Vector3D vector3D1 = new Vector3D(3.7023852539727114E63, vector3D0, 3.7023852539727114E63, vector3D0, 3.7023852539727114E63, vector3D0, 3.7023852539727114E63, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      boolean boolean0 = line0.isSimilarTo(line0);
      assertTrue(boolean0);
  }
