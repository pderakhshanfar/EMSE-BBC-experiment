...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.008336750013465571, vector3D0, 0.008336750013465571, vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2681.3167603311053), (-2681.3167603311053), (-2681.3167603311053));
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals((-5.900300712116067E-17), vector3D2.getX(), 0.01);
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals((-7.26647086991672E-18), vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(609.18, 0.0, 0.0875862700108075);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-574.601329), (-574.601329));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.35468969319573196), vector3D2.getY(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-615.641));
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.008336750013465571, vector3D0, 0.008336750013465571, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.577350787782253);
      assertEquals(0.5773507877822531, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2681.3167603311053), (-2681.3167603311053), (-2681.3167603311053));
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-2681.3167603311053));
      assertEquals((-2.356331010511047), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3.356118100840571E-7), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(2.316233480819126E-30, vector3D2.getNorm(), 0.01);
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, 1509.786, 1509.786);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(1.0003311726895414, vector3D2.getNorm1(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1664.3841983814998, vector3D0, 1664.3841983814998, vector3D0, 0.0, vector3D0);
      ...
      assertEquals(7.141268703726841E-14, vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1093.01872284, 1093.01872284);
      Vector3D vector3D1 = new Vector3D(1093.01872284, vector3D0, 1093.01872284, vector3D0, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.7903217251310966), vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-124.52090610253), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 6.310744267302042E54, 1124.0);
      Vector3D vector3D1 = new Vector3D(6.310744267302042E54, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals(6.310744267302042E54, double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.008336750013465571, vector3D0, 0.008336750013465571, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(715.345256, vector3D0, 1.3853284555555567E7, vector3D1);
      line0.reset(vector3D0, vector3D2);
  ...
  public void test43()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(952879.4875093388, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.2133591972488365E-22, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(5.9299845314003136E10, 5.9299845314003136E10, 615.2523);
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1952.248));
      Line line1 = new Line(line0);
  ...
  public void test50()  throws Throwable  {
      ...
      line1.reset(vector3D0, vector3D2);
      double double0 = line1.distance(line0);
      assertEquals(1.6454720150850828E-8, double0, 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-124.52090610253002), double0, 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-7.336428470776387E-9), vector3D2.getZ(), 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Line line1 = new Line(line0);
      line1.reset(vector3D0, vector3D2);
      assertEquals(3811272.761826139, vector3D2.getNormSq(), 0.01);
  ...
  public void test60()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.4999984928552339), vector3D2.getX(), 0.01);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.707106781195722, vector3D2.getNorm(), 0.01);
  }
}
