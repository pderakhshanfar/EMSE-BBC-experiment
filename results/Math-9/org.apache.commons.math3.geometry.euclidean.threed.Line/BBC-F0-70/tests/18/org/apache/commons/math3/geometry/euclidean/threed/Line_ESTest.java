...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0E-10, 5.650007086920087E-9, 2.346362687340978E-17);
      Vector3D vector3D1 = new Vector3D(2.346362687340978E-17, vector3D0);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2.346362687340978E-17, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D((-2345.0));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2344.632791397902), vector3D2.getY(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(0.8216152268497459);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.16666666666666666, (-1.0));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals((-0.4), vector3D2.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.16666666666666666, (-1.0));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(5186.017654871);
      assertEquals((-0.6734616036372796), vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0017378074186778, (-771.52794766435), (-771.52794766435));
      Vector3D vector3D1 = new Vector3D((-255.823261322015), vector3D0, (-2915.7), vector3D0, (-255.823261322015), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-4.102347264156056E-13), vector3D2.getX(), 0.01);
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals(0.20000000000000004, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1009.1469, 1009.1469, 423.30975);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.9187841591618625, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-8.0E298), vector3D0, (-8.0E298), vector3D0, (-2298.062220720751), vector3D0, (-4.440892098500626E-16), vector3D0);
      Vector3D vector3D2 = new Vector3D(1236.36512, vector3D1);
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals(0.9585322942717488, vector3D2.getNorm(), 0.01);
      assertEquals(0.1931577438715464, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-3609.17988878398), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals(1.000000000000218, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1594.04, 1594.04, 1.844567339161);
      Vector3D vector3D1 = new Vector3D(1594.04, vector3D0, (-255.823261322015), vector3D0, 1643.8791, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-6722579.627941018), double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = vector3D0.subtract(3.141592653489793, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals(0.6000000000000001, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-0.606520162002699), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(6.991586174013996E-83, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test44()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(0.16666666666666666, 0.16666666666666666);
      Line line0 = new Line(vector3D0, vector3D1);
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      assertEquals(2.235516168650144E-17, double0, 0.01);
  }
  ...
  public void test47()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1594.04, 1594.04, 1.844567339161);
      Vector3D vector3D1 = new Vector3D(1594.04, vector3D0, (-255.823261322015), vector3D0, 1643.8791, vector3D0);
      Vector3D vector3D2 = vector3D0.subtract((-255.823261322015), (Vector<Euclidean3D>) vector3D1);
  ...
  public void test48()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(8.423441768541885E-42, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      assertEquals(0.9999999999999998, vector3D3.getNorm1(), 0.01);
  ...
  public void test52()  throws Throwable  {
      ...
      assertFalse(boolean0);
      assertEquals((-0.7071065444772092), vector3D3.getX(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(0.0, vector3D1, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      Line line1 = new Line(vector3D2, vector3D0);
      boolean boolean0 = line0.isSimilarTo(line1);
      assertTrue(boolean0);
  ...
  public void test58()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(8.361570530716102E-42, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      double double0 = line1.distance(line0);
      assertEquals(1.415629037440065E-57, double0, 0.01);
  }
}
