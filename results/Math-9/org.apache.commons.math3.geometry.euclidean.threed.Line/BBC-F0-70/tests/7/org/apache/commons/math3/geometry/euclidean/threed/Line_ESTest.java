...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(234432.90413872522, vector3D0, (-12.744804), vector3D0, (-12.744804), vector3D0);
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.405921641363291E-8, 0.0);
      Vector3D vector3D1 = new Vector3D(0.04564794284855391, 1.0E-10, 1.0E-10);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(2.405921641363291E-8, 1.0E-10);
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1424.4342837430843, vector3D0, 1424.4342837430843, vector3D0, (-8.0E298), vector3D0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-215.72350220342446), (-215.72350220342446));
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(3253.83070461, vector3D0, 3253.83070461, vector3D0, 3253.83070461, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-4.805385463478524E-26), vector3D2.getDelta(), 0.01);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D((-1872.753063));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1872.753063), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(0.375, (-1.0), 0.8775825500488281);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(3315.088968);
      assertEquals(1.929566997065469, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(940.94162);
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = vector3D0.scalarMultiply(1.1102230246251565E-16);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.3936265707015991);
      Line line1 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line1.intersection(line1);
      assertNotNull(vector3D3);
      assertEquals(0.39362657070159923, vector3D2.getNormInf(), 0.01);
      assertEquals(0.39362657070159923, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1063.962122), (-1063.962122));
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(0.2188203669484441, vector3D2.getY(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = vector3D0.scalarMultiply(1.055405169E7);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals((-0.6120870402017788), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1738.0, vector3D0, 1738.0, vector3D0, 8.0E298, vector3D0, (-1453.97803394), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.0, vector3D2.getZ(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-238.9659789), (-238.9659789));
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.6923096957387239), vector3D2.getY(), 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(0.6090184410379215, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 485.18271772, 0.0);
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(2.232353142334844E-28, double0, 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      assertEquals((-0.1013813280114753), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1738.0, vector3D0, 1738.0, vector3D0, 8.0E298, vector3D0, (-1453.97803394), vector3D0);
      Vector3D vector3D2 = new Vector3D(1.1102230246251565E-16, vector3D1);
      Vector3D vector3D3 = new Vector3D(1738.0, vector3D0, 0.5039018405998233, vector3D0, 1738.0, vector3D0);
  ...
  public void test40()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.1102230246251565E-16, Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY);
      Line line0 = new Line(vector3D0, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1500.902466), vector3D0, (-1500.902466), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      try { 
        line0.reset(vector3D0, vector3D0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test51()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3.940510424527919E-20), vector3D0, (-3.940510424527919E-20), vector3D0, (-3.940510424527919E-20), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
  ...
  public void test53()  throws Throwable  {
      ...
      doubleArray0[0] = 4.746266440129268E12;
      doubleArray0[1] = 4.746266440129268E12;
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D(4.746266440129268E12, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D((-3.940510424527919E-20), (-3.940510424527919E-20));
  ...
  public void test57()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-4.742231952636278E12), double0, 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-3.940510424527919E-20), (-3.940510424527919E-20));
      Line line0 = new Line(vector3D1, vector3D0);
