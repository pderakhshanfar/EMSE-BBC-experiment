...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.155051459970688, vector3D1, 2453.4, vector3D0, 1.155051459970688, vector3D1, 436.27, vector3D0);
      ...
      assertEquals((-1.1102230246251565E-16), vector3D3.getY(), 0.01);
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.3936265707015991, vector3D0, 0.3936265707015991, vector3D0);
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D((-3479.975847), (-3479.975847), (-3479.975847));
      Vector3D vector3D3 = new Vector3D(243.0408536325119, vector3D2, 243.0408536325119, vector3D1, 243.0408536325119, vector3D2);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(52.492000811406726, (-1669.558240743), 299.34595663);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.30525444309409855, 0.30525444309409855);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.9096781936949074, vector3D2.getX(), 0.01);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D((-844.2825));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-844.2825), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.3936265707015991, 0.3936265707015991);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.30525444309409855, 0.30525444309409855);
      Vector3D vector3D1 = new Vector3D(0.30525444309409855, vector3D0, 0.30525444309409855, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector1D vector1D1 = new Vector1D((-1833.0), vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals((-1667.4401290427654), vector3D2.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals(0.7853981635388696, vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(2926.360472, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1010.69473073));
      assertEquals(1010.6947307300003, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1783.0));
      assertEquals((-1783.0), vector3D2.getY(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals(1.0056314231889361E-16, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(366248.8043405845, vector3D0, 366248.8043405845, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(3.511355416581685E-11, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      assertEquals((-5.883635064706356E-18), vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-3647.0), vector3D0, (-3647.0), vector3D0, (-3647.0), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(4.168541005621873E-33, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-2959.8), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(4.873708809909685E-13, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1775.1, vector3D0, 1775.1, vector3D0, 8.008359383085333E-21, vector3D0, (-8.0E298), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, 1968.38534);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test28()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D1);
      assertEquals(1.9219356685321526E-17, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D((-3647.0), vector3D0, (-3647.0), vector3D1, (-3647.0), vector3D1);
      Line line0 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.closestPoint(line0);
      assertEquals(0.7999122542449789, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1.700416E38, vector3D0, 1.700416E38, vector3D0);
      Vector3D vector3D2 = new Vector3D(3524.4312424264, vector3D1, 1.0, vector3D0, 1.0, vector3D1, (-189.8990174327), vector3D0);
  ...
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(366247.67303108383, 366247.67303108383, 366247.67303108383);
      Vector3D vector3D1 = new Vector3D(366247.67303108383, vector3D0, 366247.67303108383, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      boolean boolean0 = line0.contains(vector3D0);
      assertTrue(boolean0);
  }
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1026.79539), (-1026.79539));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.6999401858599579E-16, vector3D2.getX(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.5464033001404815E-4, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      assertEquals(2.0607757123315044E-18, double0, 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.42363263381629), vector3D2.getY(), 0.01);
  }
