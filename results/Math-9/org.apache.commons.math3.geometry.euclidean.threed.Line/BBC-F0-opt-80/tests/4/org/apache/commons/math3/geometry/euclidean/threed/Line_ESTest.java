...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0414775064582216E-7, vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      assertEquals(1.370039756104591E-47, vector3D2.getNormSq(), 0.01);
      assertEquals(3.701404809129354E-24, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1.0414775064582216E-7, 1.0414775064582216E-7, 1.0414775064582216E-7);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, 3921.4);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1.0));
      assertEquals((-0.7697363297713153), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(471.0506649789, vector3D0, 471.0506649789, vector3D0, 471.0506649789, vector3D0, 322.0187018788, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(471.0506649789);
      assertEquals(471.0506649789001, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3286.96698), (-3286.96698), 0.0);
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(2330.36288);
      assertEquals(0.4986820618866976, vector3D2.getZ(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(1.000304185543662, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1.0E-10, vector3D0, 184.9583576340459, vector3D0, 184.9583576340459, vector3D0, (-4328.708623020195), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.2139039964969918E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3286.96698), (-3286.96698), 0.0);
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Vector3D vector3D2 = new Vector3D((-3286.96698), vector3D0, (-3171.3197021324618), vector3D0, 0.0, vector3D1, (-3171.3197021324618), vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals((-1.570690698442486), vector3D3.getDelta(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(3.343054359532344E-17, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals((-2.151243894834093E-4), vector3D2.getZ(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3286.96698), (-3286.96698), 0.0);
      Vector3D vector3D1 = new Vector3D((-3286.96698), vector3D0, (-3286.96698), vector3D0, 0.0, vector3D0, (-3286.96698), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-4648.473282188533), double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3286.96698), (-3286.96698), 0.0);
      Vector3D vector3D1 = new Vector3D((-3286.96698), vector3D0, (-3171.78), vector3D0, 0.0, vector3D0, (-3171.78), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D1);
      assertEquals(8.176643781941021E-9, double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3286.96698), (-3286.96698), 0.0);
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Vector3D vector3D2 = new Vector3D((-3286.96698), vector3D0, (-3171.78), vector3D0, 0.0, vector3D1, (-3171.78), vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.closestPoint(line0);
      assertEquals(0.4910068419756401, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(8.1279234956778E29, 1935.1673874941177, 1.1102230246239645E-16);
      Vector3D vector3D1 = new Vector3D(8.1279234956778E29, vector3D0, 8.1279234956778E29, vector3D0, 8.1279234956778E29, vector3D0, 8.1279234956778E29, vector3D0);
      Vector3D vector3D2 = new Vector3D((-315.2), vector3D1, 1664.92, vector3D1);
  ...
  public void test32()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.7976931348623157E308, vector3D0, 0.9305076599121094, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3534.0), (-3534.0));
  ...
  public void test48()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(4.58381345578978E7, double0, 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      assertEquals(2.2080607635934386E-17, vector3D3.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(9.015499706437686E14, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test57()  throws Throwable  {
      ...
      Line line1 = new Line(line0);
      Vector3D vector3D2 = Vector3D.MINUS_J;
      Vector3D vector3D3 = new Vector3D(9.015499706437686E14, 0.0, 9.015499706437686E14);
