...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1715.013929, 1715.013929, 1715.013929);
      Vector3D vector3D1 = new Vector3D(1715.013929, vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      doubleArray0[0] = (-3660.786);
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D((-3660.786), vector3D0, (-3660.786), vector3D0, (-3660.786), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      Vector1D vector1D0 = line1.toSubSpace(vector3D0);
      assertEquals(1.3401354137796E7, vector1D0.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(0.9999999999999999, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.176509110665607E7, 1.176509110665607E7);
      Vector3D vector3D1 = new Vector3D(1.0740205170822794E12, 1.0, 1.0740205170822794E12);
  ...
  public void test05()  throws Throwable  {
      double[] doubleArray0 = new double[3];
      doubleArray0[2] = (-3660.786);
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D((-3660.786), vector3D0, (-3660.786), vector3D0, (-3660.786), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(3660.785999997941, vector1D0.getX(), 0.01);
      assertEquals((-3660.786), vector3D2.getZ(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.000000000000123, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1715.013929, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1715.013929);
      assertEquals(2941272.77666453, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1715.013929);
      assertEquals(2941272.7766640177, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1715.013929);
      assertEquals(1715.0139290000002, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1716.0773521129022, 10.0, 1715.013929);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-1.5675893673671992), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-8.644857437724902E-11), vector3D2.getZ(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(8.644857437724902E-11, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-8.0E298), vector3D0, (-2951.91695968686), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(-0.0, vector3D2.getY(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals(7.002507799180997E-10, double0, 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1361.493645, 8.0E298, 1361.493645);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1313.1889097716, vector3D0, 1313.1889097716, vector3D0, (-588.6), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-2037.7778195432002), double0, 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(4.001181866620231E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4.479623112221665E8, 4.479623112221665E8);
      Vector3D vector3D1 = new Vector3D(4.479623112221665E8, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.47576493665670333), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.176509110665607E7, 1.176509110665607E7);
      Vector3D vector3D1 = vector3D0.subtract(1.176509110665607E7, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test61()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(5.206150291559893E-8, vector3D0, 2.2250738585072014E-308, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(4.5864962420627245E-17, vector3D2.getNorm(), 0.01);
  }
}
