...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(254.9601, vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1438.31507299127), (-0.3058015757857271), (-0.3058015757857271));
      Vector3D vector3D2 = new Vector3D((-1390.948333614792), vector3D1, (-0.3058015757857271), vector3D1, (-1438.31507299127), vector3D1, (-0.3058015757857271), vector3D0);
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals((-0.3144522306373157), vector3D2.getX(), 0.01);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1.0000000000000346), vector1D0.getX(), 0.01);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-0.3058015757857271), vector3D0, (-0.3058015757857271), vector3D0, (-0.3058015757857271), vector3D0, (-1438.31507299127), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1439.2324777186273), vector1D0.getX(), 0.01);
      assertEquals(1439.232477718627, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(1.5);
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.pointAt(2880.88502993);
      assertEquals(2036.593340482313, vector3D2.getY(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals((-1.6151536457864465E-13), vector3D2.getZ(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(254.9601, vector3D0);
      Vector3D vector3D2 = vector3D1.subtract(254.9601, (Vector<Euclidean3D>) vector3D0);
  ...
  public void test13()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(4217.03580163723);
      assertEquals((-4217.03580163723), vector3D2.getY(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals((-0.9382989512903119), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.1991313810085704E-27, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D3 = vector3D1.add((-0.3058015757857271), (Vector<Euclidean3D>) vector3D2);
      Line line0 = new Line(vector3D3, vector3D0);
      Vector3D vector3D4 = line0.getOrigin();
      assertEquals(0.08551747130955895, vector3D4.getNormSq(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-0.3058015757857271), vector3D0, (-0.3058015757857271), vector3D0, (-0.3058015757857271), vector3D0, (-1438.31507299127), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-1439.2324777186273), 0.0, 0.0);
      line0.reset(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.getDirection();
      assertEquals(0.9999997586162969, vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1.7976931348623157E308), vector3D0, (-1272.78), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(812.1502894156, 812.1502894156);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.024263172689013342, vector3D2.getY(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(3.871605788983853E-13, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-0.3058015757857271), (-0.3058015757857271));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-1438.31507299127), vector3D0, (-1438.31507299127), vector3D1, 3.141592653489793, vector3D1);
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(254.9601, vector3D0, 4217.03580163723, vector3D0, 0.0, vector3D0, (-1.0), vector3D0);
      Vector3D vector3D2 = vector3D0.add((Vector<Euclidean3D>) vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.closestPoint(line0);
      assertEquals(1.864139792398694E-13, vector3D3.getNorm1(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(463.922035064, 463.922035064, 463.922035064);
      Vector3D vector3D1 = new Vector3D(463.922035064, vector3D0, 463.922035064, vector3D0, 463.922035064, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2.5857668567479893E-8), vector3D0, 891.49267872022, vector3D0, 3.141592653489793, vector3D0, (-1.7976931348623157E308), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test39()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-1.0), vector3D0, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-1390.948333614792), vector3D0, (-0.3058015757857271), vector3D0, (-1438.31507299127), vector3D0, (-0.3058015757857271), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals(1.00000000000001, double0, 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-1.0261601811626358E-7), vector3D2.getY(), 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Line line1 = new Line(vector3D0, vector3D2);
      double double0 = line0.distance(line1);
      assertEquals(1.0452808490796141E-23, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test55()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-0.3058015757857271), (-0.3058015757857271));
      Vector3D vector3D1 = new Vector3D((-0.3058015757857271), vector3D0, (-0.3058015757857271), vector3D0, (-0.3058015757857271), vector3D0, (-1438.31507299127), vector3D0);
      Vector3D vector3D2 = new Vector3D((-1390.948333614792), vector3D1, (-0.3058015757857271), vector3D1, (-1438.31507299127), vector3D1, (-0.3058015757857271), vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
      Line line1 = new Line(vector3D1, vector3D0);
  ...
  public void test58()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(149.65735482, vector3D0, (-0.3058015757857271), vector3D0, 149.65735482, vector3D0, (-0.3058015757857271), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test63()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(9.936667547060226E-15, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(7.111418674534732E-33, vector3D2.getNormSq(), 0.01);
  }
