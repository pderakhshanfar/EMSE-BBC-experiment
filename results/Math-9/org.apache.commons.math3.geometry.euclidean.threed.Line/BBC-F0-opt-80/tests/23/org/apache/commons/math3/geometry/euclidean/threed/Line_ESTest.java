...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2637.395787804336), vector3D0, (-1.0), vector3D0, (-1374.528), vector3D0, (-2637.395787804336), vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0E-10, vector3D0, 8.0E298, vector3D0, 8.0E298, vector3D0, (-1870.0), vector3D0);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Vector3D vector3D1 = new Vector3D((-819.34387), (-819.34387), (-1445.70077108));
      Vector3D vector3D2 = new Vector3D((-1.0), 3419.070565);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2637.395787804336), vector3D0, (-3955.0), vector3D0, (-3955.0), vector3D0, (-3955.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      
      line0.toSubSpace(vector3D2);
      assertEquals(3.7735467425849575E-26, vector3D2.getNormSq(), 0.01);
      assertEquals(1.942561901866954E-13, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(4.0948714882423984E13, 4.0948714882423984E13, 4.0948714882423984E13);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(4.094871488242397E13, vector3D2.getNormInf(), 0.01);
      assertEquals((-7.092525468101016E13), vector1D0.getX(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2637.395787804336), vector3D0, (-3955.0), vector3D0, (-3955.0), vector3D0, (-3955.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(1.151481898350792);
      Vector1D vector1D1 = new Vector1D((-2637.395787804336), vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals((-3036.9135084433196), vector3D2.getX(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals(1.942561901866954E-13, vector1D0.getX(), 0.01);
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-2637.395787804336), (-2637.395787804336));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector1D vector1D1 = new Vector1D((-399.0), vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals(572.2525509555926, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.49999999999999994, 3.141592653489793);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-819.34387));
  ...
  public void test13()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-2757.63650634579));
      assertEquals((-0.7856545810812373), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.694087704574292E-33, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.942561901866954E-13, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1430.18264), (-2937.033776013528));
      Vector3D vector3D1 = new Vector3D(1.2537167179050217E-16, vector3D0, (-2937.033776013528), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.37928991634898E-14, vector3D2.getX(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(0.0, 0.07073719799518585, 0.0);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(0.004991279202809109, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2637.395787804336), vector3D0, (-3955.0), vector3D0, (-3955.0), vector3D0, (-3955.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-2637.395787804336), (-2637.395787804336));
  ...
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 1.1102230246251565E-16, vector3D0, (-1075.429480231718), vector3D0, (-1.7976931348623157E308), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test43()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.942561901866954E-13, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test48()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2637.395787804336), vector3D0, (-3955.0), vector3D0, (-3955.0), vector3D0, (-3955.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-3955.0));
      assertEquals((-3955.0), vector3D2.getX(), 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-0.7853981633974482), vector3D2.getAlpha(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.3364203250754566), vector3D2.getX(), 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2637.395787804336), vector3D0, (-3955.0), vector3D0, (-3955.0), vector3D0, (-3955.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(1712.918231107, 0.3929057389240073, (-3955.0));
      Line line1 = new Line(vector3D2, vector3D0);
      double double0 = line0.distance(line1);
      assertEquals(7.629660177423587E-22, double0, 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(4.0948714882423984E13, 4.0948714882423984E13, 4.0948714882423984E13);
  ...
  public void test58()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.4082482904638631), vector3D2.getZ(), 0.01);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.33333333333333337, vector3D2.getX(), 0.01);
  }
}
