...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.8109631538391113, 0.0);
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.8109631538391113, 1.3684520713988955, 1.3684520713988955);
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-28.661083883744947), (-28.661083883744947));
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.8624754656911027, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2.092571258544922, vector3D0, 2.220446049250313E-16, vector3D0, 2362.8540382, vector3D0, (-193.6), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals(1.5201367025757808, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-101.818));
      assertEquals((-101.818), vector3D2.getZ(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1450.077));
      assertEquals(1450.077, vector3D2.getZ(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(3121.3137125172843, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-8.255576332559385E-17), vector3D2.getX(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = vector3D0.scalarMultiply((-501.6838540178963));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-5.365438935153976E-17), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, (-4014.9901));
      Vector3D vector3D1 = new Vector3D(1054.677126, vector3D0, 78.333621311, vector3D0, (-4014.9901), vector3D0, (-4014.9901), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(4.5414144410535864E-13, vector3D2.getX(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.190879740317004, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.ZERO;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D((-2771.06008423));
      Vector1D vector1D1 = new Vector1D(8.0E298, vector1D0, (-2771.06008423), vector1D0, 3.141592653489793, vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      Line line1 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line1.getDirection();
      assertEquals(2.216848067384E302, vector3D2.getZ(), 0.01);
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.8109631538391113, 0.0, 0.0);
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.7766978608201343), vector3D2.getY(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals(0.37084300493456435, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D((-294.115280863), vector3D0);
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(1.8485539123496412E-28, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(0.48922128104002305, vector3D2.getX(), 0.01);
  }
  ...
  public void test46()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D((-28.661083883744947), (-28.661083883744947));
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.8109631538391113, 0.9442268752444128, 0.9442268752444128);
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      try { 
  ...
  public void test50()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D1);
      assertEquals(7.234481761551024E-18, double0, 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-1.2011635466758153), double0, 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, (-4014.9901));
      Vector3D vector3D1 = new Vector3D((-2047.43358211905), vector3D0, 78.333621311, vector3D0, (-4014.9901), vector3D0, (-4014.9901), vector3D0);
      ...
      assertEquals(9.752523369275361E-13, vector3D4.getNormInf(), 0.01);
  ...
  public void test54()  throws Throwable  {
      ...
      assertEquals(1.3597709983793614E-14, double0, 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      assertEquals((-9999.080160808055), vector1D0.getX(), 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(9.993997135507854E-11, vector3D2.getY(), 0.01);
  }
