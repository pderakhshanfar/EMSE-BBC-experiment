...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-7.44321345601866E-11), 0.0);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-7.44321345601866E-11), vector3D0, 0.0, vector3D0, (-396.8266169913333), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line0.intersection(line1);
      assertEquals(3.141592652015796, vector3D2.getAlpha(), 0.01);
      assertNotNull(vector3D2);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-365.8388333), (-365.8388333));
      ...
      assertEquals(2.4782236316089926E-17, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1658.575859182), 1.0000000002977285);
      Vector3D vector3D1 = new Vector3D(1.0000000002977285, vector3D0, 1.0000000002977285, vector3D0, 1.0000000002977285, vector3D0);
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals(3.141592652015796, vector3D2.getAlpha(), 0.01);
      assertEquals(3.4012216025055524E-18, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-365.8388333), (-365.8388333));
      Vector3D vector3D1 = new Vector3D((-365.8388333), vector3D0, (-365.8388333), vector3D0, (-365.8388333), vector3D0, (-365.8388333), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(877.307);
      Vector1D vector1D0 = line0.toSubSpace(vector3D2);
      line0.toSpace(vector1D0);
      assertEquals((-571.1107665430058), vector3D2.getY(), 0.01);
      assertEquals(0.8615654056836106, vector3D2.getDelta(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.6503238748639001), vector1D0.getX(), 0.01);
      assertEquals((-0.9877459648114479), vector3D2.getZ(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D1 = line0.pointAt((-5.7618793749770706E-8));
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D3 = line0.pointAt(2.3083154311280083);
      assertEquals(2.3083154311280083, vector3D3.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-365.8388333));
      assertEquals((-0.864505662968311), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.012178954499350766, vector3D2.getX(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals((-3.4012215971520396E-18), vector3D2.getX(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.7077505516428696), vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D((-8.0E298), 4.7376187914285714E-27, 1850.0040327459);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1402.373750566926, vector3D0, (-2759.018732739045), vector3D0, 1402.373750566926, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test21()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(986.414837471536, vector3D0, (-1178.9331291), vector3D0, (-1178.9331291), vector3D0, 986.414837471536, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = vector3D0.scalarMultiply(986.414837471536);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test23()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.7594261897721066, vector3D2.getZ(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals(0.6503238748639002, double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      double double0 = line1.distance(line0);
      assertEquals(3.8774091213423333E-26, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(877.307);
      Vector3D vector3D3 = new Vector3D(877.307, vector3D0, 1757.5751763642675, vector3D2);
      Line line1 = new Line(vector3D3, vector3D1);
      Vector3D vector3D4 = line1.closestPoint(line0);
      assertEquals(1.881505881414203E-11, vector3D4.getZ(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(8.0E298, vector3D0, 8.0E298, vector3D0, 1.000000000595457, vector3D0, 0.16666666666745392, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test43()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-0.493872982405724), vector3D2.getZ(), 0.01);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      assertEquals(1.9902819056069948E-24, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.0);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, 0.0, vector3D0, (-396.8266169913333), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-7.44321345601866E-11), (-7.44321345601866E-11));
      Vector3D vector3D1 = new Vector3D((-7.44321345601866E-11), vector3D0, (-7.44321345601866E-11), vector3D0, (-7.44321345601866E-11), vector3D0, (-396.8266169913333), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.80838686044946E-9, vector3D2.getDelta(), 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      assertEquals(3.4012215971520396E-18, vector3D2.getNormInf(), 0.01);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = new Vector3D(0.0, (-7.44321345601866E-11));
