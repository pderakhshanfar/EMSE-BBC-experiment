...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-122.01), vector3D0, 2.8017995244226306, vector3D0, 1334.876, vector3D0, 1334.876, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line1.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.7758103255218507E-13, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, 1.0);
      Vector3D vector3D1 = new Vector3D(1.0, vector3D0, 1826.513503174, vector3D0, 1.0, vector3D0, 1826.513503174, vector3D0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(9.696516989909082E19, 79.09589, 9.696516989909082E19);
      Vector3D vector3D1 = new Vector3D(79.09589, vector3D0, 9.696516989909082E19, vector3D0, 79.09589, vector3D0, 1349.643834954699, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.toSpace(vector1D0);
      assertEquals(1.3296781226991328E40, vector1D0.getX(), 0.01);
      assertEquals((-9.402244173559551E39), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-3461.2887505), vector3D0, (-3461.2887505), vector3D0, (-3461.2887505), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      line0.reset(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(1809.183109700955);
      Vector1D vector1D1 = new Vector1D(0.0, vector1D0, 0.0, vector1D0, (-4891.399432643735), vector1D0, 330.0, vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals(8252406.810138563, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(5160.38842821, 5160.38842821);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-171.806577731446), (-171.806577731446), 0.375);
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.375);
      assertEquals((-0.2385302586260915), vector3D2.getX(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(7006241.964206431);
      assertEquals((-4954160.703524123), vector3D2.getY(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-122.01), vector3D0, 2.8017995244226306, vector3D0, 1334.876, vector3D0, 1137.429119043689, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.8580718583893407E-13, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-9.609452392222583E-15), vector3D2.getY(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.8580718583893407E-13, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals(2.1951410186629236E8, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(292.83375, vector3D0, 2.8017995244226306, vector3D0, 1334.876, vector3D0, 1137.429119043689, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D1.negate();
      double double0 = line0.getAbscissa(vector3D2);
      assertEquals(2767.9406685681115, double0, 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-122.01), vector3D0, 2.8017995244226306, vector3D0, 1334.876, vector3D0, 1334.876, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(2.8017995244226306, (-122.01));
      double double0 = line0.distance(vector3D2);
      assertEquals(0.5696757409114513, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D1.negate();
      Vector3D vector3D3 = line0.pointAt(292.83375);
      Line line1 = new Line(vector3D3, vector3D2);
      Vector3D vector3D4 = line0.closestPoint(line1);
      assertEquals(6.89585001865176E-14, vector3D4.getNorm(), 0.01);
      assertEquals(292.83374999999984, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D1.negate();
      Vector3D vector3D3 = new Vector3D(2.8017995244226306, (-122.01));
      Line line1 = new Line(vector3D2, vector3D3);
      Vector3D vector3D4 = line1.closestPoint(line0);
      assertEquals(2550.543790734554, vector3D4.getNorm1(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(4.06347616349024E16, vector3D0, 703.055454066, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test34()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-122.01), vector3D0, 2.8017995244226306, vector3D0, 1334.876, vector3D0, 1334.876, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-2054.5561), vector3D1, (-1.7976931348623157E308), vector3D0, (-22.2508), vector3D0);
  ...
  public void test45()  throws Throwable  {
      ...
      assertEquals((-1.7758103255218507E-13), vector3D2.getX(), 0.01);
  }
  ...
  public void test48()  throws Throwable  {
      ...
      assertEquals((-2550.5437995244224), double0, 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      assertEquals(1.2060333434720697E-17, double0, 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Vector3D vector3D1 = new Vector3D(2119.21112, 2119.21112, 3.141592653489793);
      Line line0 = new Line(vector3D0, vector3D1);
      try { 
