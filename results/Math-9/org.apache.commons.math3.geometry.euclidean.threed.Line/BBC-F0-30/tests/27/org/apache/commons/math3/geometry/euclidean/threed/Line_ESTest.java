...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(5.206150291559893E-8, 5.206150291559893E-8, 5.206150291559893E-8);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-5.7618793749770706E-8));
      Vector3D vector3D1 = new Vector3D(93.67541006629179, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      assertEquals((-0.9999999999999895), vector1D0.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(58.920196853, 1282.0);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(5.206150291559893E-8, 17363.81408204326);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.6147119006493431), vector3D2.getZ(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0708593250394448E-7, (-1724.814751029583), (-4.9E-324));
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Vector1D vector1D0 = Vector1D.ONE;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.000000000124099, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.5857864376269049, 763.141572229333, 0.0);
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.9999999999999967, 0.0);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.15);
      assertEquals((-0.08104534588022137), vector3D2.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1.1102230246252317E-16);
      assertEquals((-7.513400069827383E-8), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-180.7641566133));
      assertEquals(180.7641566133, vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2231.94122777368), (-993.0), 0.0);
      Vector3D vector3D1 = new Vector3D((-554.9475576744), vector3D0, 0.0, vector3D0, (-4.440892098500626E-16), vector3D0, (-1134.460226923302), vector3D0);
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.5857864376269049, 763.141572229333, 0.0);
      Vector3D vector3D1 = new Vector3D((-5.7618793749770706E-8), vector3D0, 0.5857864376269049, vector3D0, (-5.7618793749770706E-8), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.5687300022562953, vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(93.67541006629179, (-5.7618793749770706E-8));
      Vector3D vector3D1 = new Vector3D(93.67541006629179, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(8.278271772720962E-15, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-1.5702165544527618), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.0842565420723654E-28, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals((-0.9999999999999973), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-0.44122373353956706), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals((-0.9999999999999895), double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals(2.4292408202860418E-14, double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      double double0 = line1.distance(line0);
      assertEquals(9.46931598113325E-30, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(1.0005402397843512, vector3D2.getNorm1(), 0.01);
      assertEquals((-2.7229844798091456), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-5.7618793749770706E-8));
      Vector3D vector3D1 = new Vector3D(93.67541006629179, vector3D0, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, 2.1045259478536007E-17, (-1389.0));
      Vector3D vector3D1 = new Vector3D(8.0E298, vector3D0, (-685.445), vector3D0, 4.503599627370496E15, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.5857864376269049, 763.141572229333, 0.0);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.5857864376269049, vector3D0, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(6.83314236349462E-27, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4794.08282026309, 763.141572229333, 0.0);
      Vector3D vector3D1 = new Vector3D(4794.08282026309, vector3D0, 0.5857864376269049, vector3D0, 763.141572229333, vector3D0, 1.997844754509471E-9, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
