...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-596.0), vector3D0, (-596.0), vector3D0, (-268.87928), vector3D0, 1.0E-10, vector3D0);
  ...
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.0, (-1603.2));
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-604.8), (-596.0));
      Vector3D vector3D2 = vector3D0.subtract((-596.0), (Vector<Euclidean3D>) vector3D1);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1968.4062817431), (-1328.54839), (-1968.4062817431));
      Vector3D vector3D1 = new Vector3D(4.0, vector3D0, (-1968.4062817431), vector3D0, 4.0, vector3D0, (-1968.4062817431), vector3D0);
      Vector3D vector3D2 = new Vector3D(4.0, vector3D1, 4.0, vector3D1);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3426.0, vector3D0, 3426.0, vector3D0, 3426.0, vector3D0, 3426.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.9999999999997463), vector1D0.getX(), 0.01);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-596.0), (-596.0), (-596.0));
      Vector3D vector3D1 = new Vector3D((-596.0), vector3D0, (-596.0), vector3D0, 3.427403341777837E-11, vector3D0, (-596.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line1.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1845756.4789841233, vector1D0.getX(), 0.01);
      assertEquals(1065647.9999999795, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals(3.141592653489707, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(927.4321072129047);
      assertEquals((-0.7861605983386928), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(8.635284813166825E-14, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-2.230458486064971E-11), vector3D2.getX(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(8.635284813166825E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D((-1584.5335537640178), (-1584.5335537640178), (-1584.5335537640178));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-596.0), vector3D0, (-596.0), vector3D0, (-268.87928), vector3D0, (-23.866023896105073), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.8043666067855905E-13, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1400.9301047508004, 1.0E-10);
      Vector3D vector3D1 = new Vector3D(1.7976931348623157E308, vector3D0, 0.9984618869545061, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-670.8708583633704), vector3D0, (-469.372370745), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals((-1460.8792799999), double0, 0.01);
  }
  ...
  public void test41()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(5.562092176076562E-15, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test45()  throws Throwable  {
      ...
      line0.reset(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(1140.2432291083705, double0, 0.01);
  }
  ...
  public void test47()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-581.1936917604547), vector3D0, (-581.1936917604547), vector3D0, (-268.87928), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D((-1311.693390564), 651928.1379863688);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D((-1311.693390564), 651928.1379863688);
      Vector3D vector3D2 = vector3D0.subtract(2273.601333139303, (Vector<Euclidean3D>) vector3D1);
  ...
  public void test50()  throws Throwable  {
      ...
      assertEquals((-0.026889587655725664), vector3D3.getX(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      assertEquals(1.705955786439703E-15, double0, 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = vector3D0.subtract((-596.0), (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(vector3D0, vector3D1);
      boolean boolean0 = line1.isSimilarTo(line0);
      assertTrue(boolean0);
  ...
  public void test59()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.509903313490213E-14, vector3D2.getNorm(), 0.01);
  }
