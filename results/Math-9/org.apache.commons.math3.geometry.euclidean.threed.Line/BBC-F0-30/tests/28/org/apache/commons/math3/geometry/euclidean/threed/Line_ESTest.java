...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1587.0, 1892.949);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line1);
      assertEquals(0.49514795067319467, vector3D2.getNormInf(), 0.01);
      assertNotNull(vector3D2);
      assertEquals(0.438876659983474, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 1143.0, vector3D0, 288.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = Vector3D.MINUS_J;
      Vector3D vector3D3 = new Vector3D(1.0E-10, vector3D2, (-2353.133324562), vector3D0, 3.141592653489793, vector3D1);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(2759.625, 4841.179008875354, 2056763.1077786884);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-443.86), 1314.556717973, (-4.440892098500626E-16));
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.POSITIVE_INFINITY;
      Vector1D vector1D1 = new Vector1D((-76.46766187914), vector1D0, 1333.3, vector1D0, 1333.3, vector1D0);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(731.86, vector3D0, 731.86, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D(731.86);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-731.8599999999999), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(731.86, 731.86);
      Vector3D vector3D1 = new Vector3D((-276.891606028925), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(298.99194);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1071399.3547070024, 1071399.3547070024, 1071399.3547070024);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(731.86, vector3D0, 731.86, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1463.72));
      assertEquals((-1438.7109788137027), vector3D2.getX(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertNotNull(vector3D2);
      assertEquals((-0.6416848483165134), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.5647958398646805, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-1.9908664955217434), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      assertEquals(0.12959167972936095, vector3D2.getY(), 0.01);
      assertEquals((-0.1307131689847862), vector3D2.getZ(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.9829140674539547, vector3D2.getX(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals(0.6597000531569778, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-80.83071), vector3D0, 1.5874010519681994, vector3D0, 1.3213128808830023E-17, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(1.1938025570966456E-33, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(6.017233916947296E-17, vector3D2.getY(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(3.712002280939183E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-0.8980737057891771), vector3D2.getX(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 3.141592653489793, vector3D0, (-8.0E298), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test47()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.pointAt((-3208.99960896));
      assertEquals(4064.9710717922003, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D1);
      assertEquals(8.271678211858202E-14, double0, 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.1135941150808666E-13, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.1102230246251565E-16, 1.0E-10);
      Line line0 = null;
      try {
  ...
  public void test57()  throws Throwable  {
      ...
      assertEquals((-0.9999999999998886), double0, 0.01);
  }
  ...
  public void test58()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.6666670814928579, vector3D2.getY(), 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 1143.0, vector3D0, 288.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-0.9999999999998886));
  ...
  public void test62()  throws Throwable  {
      ...
      assertEquals(0.0, double0, 0.01);
      assertEquals(1.1135941150808666E-13, vector3D2.getNorm1(), 0.01);
  }
}
