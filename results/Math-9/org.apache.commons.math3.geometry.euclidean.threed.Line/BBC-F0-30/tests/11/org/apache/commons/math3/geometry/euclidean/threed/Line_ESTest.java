...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1156.3, 1156.3);
      Vector3D vector3D1 = new Vector3D(1156.3, vector3D0);
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals((-1156.3), vector1D0.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-2546.5), 304.911161888);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-517.125284449), vector3D0, 2.220446049250313E-16, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.49999999999999967), vector3D2.getZ(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1280.937169659), vector3D0, (-1.0), vector3D0, (-1.0), vector3D0, 2.859947526443203E11, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector1D vector1D1 = new Vector1D((-1280.937169659), vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals(1280.9371786024456, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(2567.7822265);
      assertEquals((-2567.7822265), vector3D2.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(267418.55981645914);
      assertEquals(267418.55981645914, vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(186.99786655564367);
      assertEquals((-0.7816168185938807), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals(0.01856484893969337, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(3022.6440201434616, (-616.77916302), 0.9111288546676481);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(1.5934200254710337E-14, vector3D0, 0.9111288546676481, vector3D1, 3022.6440201434616, vector3D0);
      Line line1 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line1.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals((-0.20128948790091963), vector3D3.getAlpha(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals(0.9999962605577517, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(494.1478987, 494.1478987);
      Vector3D vector3D1 = new Vector3D((-7.677052686493877), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.36908983504357123), vector3D2.getX(), 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(0.9906740892242548, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D1);
      assertEquals(1.9669258345644485E-13, double0, 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1156.3, 1156.3);
      Vector3D vector3D1 = new Vector3D(1156.3, vector3D0);
      Vector3D vector3D2 = vector3D1.subtract(656.55065602, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(vector3D0, vector3D2);
      double double0 = line1.distance(line0);
      assertEquals(1.3227887166975871E-14, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      assertEquals((-0.018564848939693453), vector3D2.getX(), 0.01);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(8.94344566028015E-6, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test37()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-1271.67), vector3D0, 1799.65, vector3D0, (-4558.96888042892), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-517.125284449), (-517.125284449), 2.220446049250313E-16);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1.7976931348623157E308, vector3D0, 2.220446049250313E-16, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test52()  throws Throwable  {
      ...
      assertEquals(0.19269067927480754, vector3D0.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-3947.6840358278246), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      try { 
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Vector3D vector3D2 = new Vector3D((-134.02674116782), vector3D1, 1.0, vector3D1, 0.0, vector3D0, 6.690094490041178E45, vector3D1);
      Vector3D vector3D3 = new Vector3D(1.0, vector3D1, 1.0, vector3D2, 6.690094490041178E45, vector3D0);
  ...
  public void test55()  throws Throwable  {
      ...
      assertEquals((-0.49999999999999994), vector3D4.getZ(), 0.01);
  }
