...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.1102230246251565E-16, 887.0);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-494.5051), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-5.1701684546127625E-14), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(5.865827662008209E-8, vector3D0, (-3353.75), vector3D0, 0.0, vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
      Vector1D vector1D0 = new Vector1D(5.865827662008209E-8);
      Vector3D vector3D2 = line1.toSpace(vector1D0);
      assertEquals((-5.865827662008209E-8), vector3D2.getZ(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-296.6018062));
      assertEquals(296.6018062, vector3D2.getY(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(3559.1759562982697);
      assertEquals(2516.217454134621, vector3D2.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(5.865827662008209E-8, vector3D0, (-3353.75), vector3D0, (-3353.75), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
  ...
  public void test13()  throws Throwable  {
      ...
      assertNotNull(vector3D2);
      assertEquals(2.66097922499844E-17, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-1.0), vector3D0, 1850.75, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.3877787807814457E-17, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.673064184907292E-27, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-6.032174644509064E-23), 1.0E-10);
      Vector3D vector3D1 = new Vector3D((-6.032174644509064E-23), vector3D0, 2412.473210736, vector3D0, 2412.473210736, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.943352083334396E-25, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(0.19999954104423523, vector3D0, 0.19999954104423523, vector3D0, 0.19999954104423523, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.1102230246251565E-16, 887.0);
      Vector3D vector3D1 = new Vector3D((-1622.74594559), vector3D0, 815.800465338, vector3D0, 887.0, vector3D0);
      Vector3D vector3D2 = new Vector3D((-1622.74594559), vector3D0);
      Line line0 = new Line(vector3D1, vector3D2);
      Line line1 = line0.revert();
      double double0 = line0.distance(line1);
      assertEquals(5.910245179228021E-31, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(5.865827662008209E-8, vector3D0, (-3353.75), vector3D0, (-3353.75), vector3D0);
      Vector3D vector3D2 = new Vector3D(5.865827662008209E-8, vector3D1, (-3353.75), vector3D1);
      Vector3D vector3D3 = new Vector3D(5.865827662008209E-8, vector3D1, (-3353.75), vector3D0, 0.0, vector3D1, 1.0, vector3D1);
      Line line0 = new Line(vector3D2, vector3D3);
      Vector3D vector3D4 = line0.closestPoint(line0);
      assertEquals(7.489142440742388E-19, vector3D4.getNormSq(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(0.2348990685465778, vector3D3.getZ(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      Vector3D vector3D2 = vector3D1.add((-1.7976931348623157E308), (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test44()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1254.42, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.4304587873350245E-26, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.1102230246251565E-16, 887.0);
      Vector3D vector3D1 = new Vector3D((-1594.4042566338528), vector3D0, 815.800465338, vector3D0, 887.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1.0);
      assertEquals((-0.4793594018457556), vector3D2.getX(), 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D0);
      assertEquals(5.3663991483158357E-17, double0, 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.1102230246251565E-16, 887.0);
      Vector3D vector3D1 = new Vector3D((-1622.74594559), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1622.74594559), 887.0);
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      ...
      assertFalse(boolean0);
      assertEquals(0.24736745003087388, vector3D3.getZ(), 0.01);
  }
  ...
  public void test58()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.4793594018457444), vector3D2.getX(), 0.01);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(5.065467649787219E-17, vector3D2.getNormInf(), 0.01);
  }
}
