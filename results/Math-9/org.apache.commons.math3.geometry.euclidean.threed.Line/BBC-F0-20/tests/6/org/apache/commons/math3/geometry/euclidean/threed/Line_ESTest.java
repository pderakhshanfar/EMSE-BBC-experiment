...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.7214844226837158, 0.7214844226837158, 1.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      assertEquals((-0.8907754115261014), vector1D0.getX(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(336.82789141590627, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D(1.046781316E7);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.046781316E7, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(0.7214844226837158, 0.7214844226837158, 1.0192434078534955);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line1.toSpace(vector1D0);
      assertEquals((-0.03427400381574719), vector3D2.getX(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.pointAt(1296.66926701);
      assertEquals((-1296.66926701), vector3D2.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals((-0.035098261127883), vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-2625.56377699711));
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-733.0), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(3.599551212651875E-17, vector3D2.getNorm1(), 0.01);
  ...
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(336.08710421168, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(8.854098015324338E-15, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(7.839505166497039E-29, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(0.72, 0.72, 1.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.getDirection();
      assertEquals((-0.32081535260978356), vector3D2.getX(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(1.354459441301217, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(5.0486544464870975E-62, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Vector3D vector3D2 = new Vector3D(0.9999999999999998, vector3D0, 2.0, vector3D0);
  ...
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-912.15353), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(8.955388059643328E-15, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test37()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2.0857864376269046, vector3D0, 1.9868161777724352E-8, vector3D0, 1012.049603018, vector3D0, 1012.049603018, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test51()  throws Throwable  {
      ...
      assertEquals(1.309119368789445E-16, double0, 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      assertEquals((-0.8907754115261014), double0, 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.7790032274904973, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      assertFalse(boolean0);
      assertEquals(0.8907754115261014, vector3D3.getZ(), 0.01);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.47174771338739446), vector3D2.getDelta(), 0.01);
  }
}
