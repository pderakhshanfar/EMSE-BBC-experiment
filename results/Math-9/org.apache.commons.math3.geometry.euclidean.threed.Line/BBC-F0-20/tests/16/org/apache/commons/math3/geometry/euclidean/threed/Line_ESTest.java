...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.414213562373095, 3.141592653589793, 3.141592653589793);
      Vector3D vector3D2 = new Vector3D(1.414213562373095, vector3D0, 1.414213562373095, vector3D0, 1238.738517485504, vector3D1);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Vector3D vector3D2 = vector3D0.subtract(1028.89006384, (Vector<Euclidean3D>) vector3D1);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D2);
      assertEquals((-728.2422480179104), vector1D0.getX(), 0.01);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Vector3D vector3D2 = new Vector3D(0.7853981633974483, vector3D1, 1241.0630454, vector3D0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2752.9093545), (-2752.9093545));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D((-2752.9093545));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.34864462564970916), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      doubleArray0[1] = 1.821358983562234E7;
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D((-1371.87), vector3D0, 1.0E-10, vector3D0, 5.669184079525E-24, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.9999999985237138, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1959.72863, 1959.72863, 1959.72863);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D2 = line1.pointAt(373.4355596);
      assertEquals((-373.4355596), vector3D2.getX(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(2515.33061283, vector3D0, 3028.187, vector3D0, 2515.33061283, vector3D0, 0.9166666666666666, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.074686369891641E-24, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1014.26272, vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(6.261989177902683E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1397.1278240591823), vector3D0, (-1397.1278240591823), vector3D0, (-8.0E298), vector3D0, 4477432.30083136, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test27()  throws Throwable  {
      double[] doubleArray0 = new double[3];
      doubleArray0[0] = (-693.584);
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D((-1371.87), vector3D0, 1.0E-10, vector3D0, 5.669184079525E-24, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-693.584), double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2074.658), 1541.927);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = vector3D1.negate();
      Line line1 = new Line(vector3D2, vector3D0);
      double double0 = line0.distance(line1);
      assertEquals(1.5251843642317034E-17, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(0.8492893399663034, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1959.72863, vector3D0, 1959.72863, vector3D0, 1959.72863, vector3D0, (-3.940510424527919E-20), vector3D0);
      Vector3D vector3D2 = new Vector3D(1959.72863, vector3D1, 1959.72863, vector3D0, 0.0, vector3D1);
  ...
  public void test35()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(6.149326400956233E-10, 6.149326400956233E-10, 1.3943684044160303E22);
      Vector3D vector3D2 = new Vector3D(812.29976535, vector3D0, 6.149326400956233E-10, vector3D0, 1.3943684044160303E22, vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test43()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = vector3D0.subtract(1.414213562373095, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test52()  throws Throwable  {
      ...
      assertEquals(2.0007045385340458E-16, double0, 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      assertEquals(0.8833184264622618, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1.414213562373095, vector3D0, 1.414213562373095, vector3D0, 1238.738517485504, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(9.594819596216974E-17, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Vector3D vector3D2 = new Vector3D((-2752.9093545), (-2752.9093545));
      Line line0 = new Line(vector3D0, vector3D2);
  ...
  public void test62()  throws Throwable  {
      ...
      assertEquals((-0.4999999999999999), vector3D2.getY(), 0.01);
  }
