...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(771.484271328, 0.3333333333332802);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = vector3D1.add(Double.POSITIVE_INFINITY, (Vector<Euclidean3D>) vector3D0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.041666666666621166, 3735.0986136749);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3552.5049170762636), vector3D0, 171.59499, vector3D0, (-4.813899778443457E-9), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.7076304958466593, 0.7076304958466593, (-945.0));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.POSITIVE_INFINITY;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, (-2238.47424), vector3D0, 0.9921976327896118, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(2234.340449713721, vector3D2.getNorm(), 0.01);
      assertEquals((-2234.3404497137203), vector1D0.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.041666666666621166, 3736.094004526685);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2982.714446383721), vector3D0, 1958.05022, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-2082.5564653949555));
      assertEquals(2082.5564653949555, vector3D2.getX(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals(0.10461825585533488, vector3D2.getX(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(3.0841596661615585E-14, vector3D2.getNorm(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-1.0733752390672466E-16), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-292.7048152989512), 199.517132973, (-314.8971));
      Vector3D vector3D1 = new Vector3D((-292.7048152989512), vector3D0, (-292.7048152989512), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.8052939240555095E-12, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2097.0, vector3D0, 2159.904927, vector3D0, 1.5, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(3.64159202042722E-13, vector3D2.getY(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.6187314967308083), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals(0.8146148466594818, vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1.0, vector3D0, 0.087, vector3D0, 0.6299605249474366, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test25()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.6632070836785736), vector3D2.getZ(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.041666666666621166, 0.041666666666621166);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(2.222613395836815E-16, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      double double0 = line0.distance(line1);
      assertEquals(1.1510071308958803E-32, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      assertEquals(9.441432767220744E-14, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(810.1776401303, 810.1776401303);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
  ...
  public void test46()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(810.1776401303, 810.1776401303);
      Vector3D vector3D1 = vector3D0.scalarMultiply(810.1776401303);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-1.3870005499437913E-16), vector3D2.getX(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(8.004371657497269E11, 1434.681908345);
      Vector3D vector3D1 = new Vector3D(1.7999524759166556E24, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.0, vector3D2.getNorm(), 0.01);
  ...
  public void test57()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1.130786199112931), vector3D2.getAlpha(), 0.01);
      assertEquals(0.6632070836785736, vector1D0.getX(), 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.7999524759166556E24, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1.7999524759166556E24);
      assertEquals((-1.539317258744883E24), vector3D2.getZ(), 0.01);
  }
