...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(1.0E-10, vector3D0, 1.0E-10, vector3D1, 1.0E-10, vector3D2, 1.1576183923921224E-32, vector3D2);
      Line line0 = new Line(vector3D3, vector3D1);
      Vector3D vector3D4 = line0.pointAt(1.1576183923921224E-32);
      Line line1 = new Line(vector3D4, vector3D3);
      boolean boolean0 = line0.isSimilarTo(line1);
      assertEquals((-1.0000000000011577E-10), vector3D4.getDelta(), 0.01);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2434.276468533745, (-0.16666666666666666));
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals((-1.4999999999999998), vector3D3.getX(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2875.159, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2434.276468533745, (-0.16666666666666666));
      Vector3D vector3D1 = new Vector3D(2434.276468533745, vector3D0, 3473.8, vector3D0, 3473.8, vector3D0, 5.744798797308873E-13, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(2434.276468533745);
      assertEquals(2434.2764685337456, vector3D2.getNorm(), 0.01);
      assertEquals(403.8370520363319, vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(4933.0049477885, vector3D0, (-3179.58), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-1.5281421204609478E-13), vector3D2.getX(), 0.01);
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2434.276468533745, (-0.16666666666666666));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D(2434.276468533745, vector3D0, 3473.8, vector3D0, 3473.8, vector3D1, 5.744798797308873E-13, vector3D0);
      ...
      assertEquals((-9.209085310624976E-18), vector3D3.getZ(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.954407506138771E-26, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-2986.8515546444073), 3.141592653489793);
      Vector3D vector3D1 = new Vector3D((-2986.8515546444073), vector3D0, 0.0, vector3D0, 0.0, vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-1.2038683039763818E-13), vector3D2.getY(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2434.276468533745, (-0.16666666666666666));
      Vector3D vector3D1 = new Vector3D((-0.16666666666666666), vector3D0, 3473.8, vector3D0, (-0.16666666666666666), vector3D0, (-0.16666666666666666), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(3.82895195764584E-33, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-582.3753533883), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-3.201205729318578E-14), vector3D2.getX(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(604.9454848572, 159.5538157);
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.4893552405105114E7, 3.4893552405105114E7, 3.4893552405105114E7);
      Vector3D vector3D1 = Vector3D.ZERO;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals(1.1229383412164349E-13, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(3.128044388088465E-17, vector3D2.getX(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1.5707963267948966, 0.0, 8.0E298);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2434.276468533745, (-0.16666666666666666));
      Vector3D vector3D1 = new Vector3D((-0.16666666666666666), vector3D0, (-569.9548950393058), vector3D0, 1.7976931348623157E308, vector3D0, (-1461.07911017173), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1275.1188, 1275.1188, 1275.1188);
      Vector3D vector3D1 = new Vector3D(1275.1188, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(25.6247125820625, 25.6247125820625, (-1674.6392765));
      Vector3D vector3D1 = new Vector3D((-1674.6392765), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      try { 
  ...
  public void test49()  throws Throwable  {
      ...
      assertEquals(4.2204295034192763E-13, double0, 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      assertEquals((-0.9999999999998471), double0, 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.0E-10, vector3D0, 1.0E-10, vector3D0, 1.0E-10, vector3D1, 1.1576183923921224E-32, vector3D1);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D3 = line0.pointAt((-1570.636635067));
      Line line1 = new Line(vector3D2, vector3D3);
      Vector3D vector3D4 = line1.intersection(line0);
      assertEquals((-0.784947959500744), vector3D3.getDelta(), 0.01);
      assertNull(vector3D4);
      assertEquals(1111.1078154358963, vector3D3.getX(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(6.9593369190759E7, vector3D0, (-3122.760845905), vector3D0, 6.9593369190759E7, vector3D0, (-2940.9221907861274), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(line0);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.999999996217069), vector1D0.getX(), 0.01);
