...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1841.5), (-1841.5), (-1841.5));
  ...
  public void test03()  throws Throwable  {
      ...
      doubleArray0[0] = 960.96178;
      doubleArray0[1] = 960.96178;
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.0, (-2714.5933756207));
      Vector3D vector3D1 = new Vector3D((-2714.5933756207), vector3D0, 2506.067345, vector3D0, 1.0, vector3D0);
      Vector3D vector3D2 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D2);
      Vector3D vector3D3 = line0.toSpace(vector1D0);
      assertEquals((-1.4555294283712853E-12), vector1D0.getX(), 0.01);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D3 = line0.toSpace(vector1D0);
      assertEquals((-1.4555294283712853E-12), vector3D3.getZ(), 0.01);
  ...
  public void test07()  throws Throwable  {
      ...
      doubleArray0[0] = 960.96178;
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D(960.96178, vector3D0, 960.96178, vector3D0, 1.0E-10, vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.NEGATIVE_INFINITY;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2595.00133), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.0, vector3D2.getNormSq(), 0.01);
      assertEquals(0.9999999999996996, vector1D0.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(2215.3728);
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-2595.00133), vector3D0, (-2595.00133), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-3482.82));
      assertEquals(3482.8200000000006, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2705.7, 2705.7, 2705.7);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(9.596360276104415E-17);
      assertEquals(0.4206445081229959, vector3D2.getDelta(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals(6.314782928629507E-13, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-6.663542893624021E-14), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(8.568403925739798E-30, vector3D2.getX(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals(0.9999999999999998, vector3D4.getNormInf(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.3332125714318561, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-647.8695), (-647.8695));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.8898287582605949, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-2595.00133), vector3D0, (-2595.00133), vector3D0);
      Vector3D vector3D2 = new Vector3D((-2595.00133), vector3D1);
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.0, (-2715.0587453250373));
      Vector3D vector3D1 = new Vector3D((-2715.0587453250373), vector3D0, 2506.067345, vector3D0, 5.2573593128807135, vector3D0);
      Vector3D vector3D2 = Vector3D.MINUS_I;
  ...
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(7.94210510652938E-12, vector3D0, 7.94210510652938E-12, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.7742924536980614E-27, vector3D2.getY(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D3 = line0.pointAt(2795.010437779138);
      Line line1 = new Line(vector3D2, vector3D3);
      Vector3D vector3D4 = line1.closestPoint(line0);
      assertEquals((-1975.8708257777803), vector3D4.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2705.7, 2705.7, 254.08899521608);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-0.5020102783901407), vector3D2.getY(), 0.01);
  }
  ...
  public void test44()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3266.27200419442, 3266.27200419442);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2705.7, 2705.7, 2705.7);
      Vector3D vector3D2 = vector3D1.subtract(2.1936996626282603E7, (Vector<Euclidean3D>) vector3D1);
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2.3386449807563848E18, vector3D0, 2.3386449807563848E18, vector3D0, (-1.0), vector3D0);
      Vector3D vector3D2 = new Vector3D(2.3386449807563848E18, vector3D1);
  ...
  public void test59()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.5775592269332207), vector3D2.getZ(), 0.01);
  }
