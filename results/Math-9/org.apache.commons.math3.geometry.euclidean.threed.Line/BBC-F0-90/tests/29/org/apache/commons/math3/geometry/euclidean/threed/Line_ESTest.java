...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(749.0, 659.0, 659.0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(749.0, 659.0, 659.0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      assertEquals((-0.6259324370910745), vector1D0.getX(), 0.01);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals(9.836805925934815E-26, vector3D2.getNormInf(), 0.01);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1.0), 0.75);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1494.0, 502.191615);
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 3.141592653489793, vector3D0, 3.141592653489793, vector3D0, (-1392.4), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1.0178741514238234E-17), vector3D2.getZ(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1.0129027912496858E-9), vector3D0, (-1.0129027912496858E-9), vector3D0, (-1.0129027912496858E-9), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1030.319715));
      assertEquals(1030.319715, vector3D2.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.814697265625E-6, 1.0);
      Vector3D vector3D1 = new Vector3D(3.814697265625E-6, vector3D0, 818.71856797571, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(818.71856797571);
      assertEquals(818.71856797571, vector3D2.getNorm(), 0.01);
      assertEquals((-0.0016874524312334618), vector3D2.getY(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals(8.947273025699271E-18, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1494.0, 502.191615);
      Vector3D vector3D1 = new Vector3D(3407.0, 3407.0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.814697265625E-6, 1.0);
      Vector3D vector3D1 = new Vector3D(3.814697265625E-6, vector3D0, 3.814697265625E-6, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-1.3658944527268539E-27), vector3D2.getY(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      assertEquals(7.642943033479919E-28, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(502.191615, 502.191615);
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.699868512876908, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(8.0E298, 2.0);
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals(9.836805925934815E-26, vector3D2.getNorm(), 0.01);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(690.8576222, vector3D0, 0.125, vector3D0, (-2615.2708), vector3D0, 945.744905096, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      line0.reset(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals(1.0000000000000133, double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-0.9999999999999739), double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(8.766954791564585E-15, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Vector3D vector3D3 = line0.closestPoint(line0);
      assertEquals((-0.9073065267574626), vector3D3.getDelta(), 0.01);
  }
  ...
  public void test36()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2044.3369968), 0.5);
  ...
  public void test41()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(5.998560602328726E-17, 5.998560602328726E-17);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-1298.9292089964));
  ...
  public void test53()  throws Throwable  {
      ...
      assertEquals(2.4900200945287868E-17, double0, 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Line line1 = new Line(vector3D1, vector3D2);
      boolean boolean0 = line0.isSimilarTo(line1);
      assertEquals((-0.8988033581001547), vector3D2.getY(), 0.01);
      assertFalse(boolean0);
  }
  ...
  public void test58()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(659.0, 659.0, 659.0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.5767657588536707), vector3D2.getX(), 0.01);
  }
