...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(1.0E-10, vector3D2, 1.0E-10, vector3D1);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D2 = vector3D0.subtract(1.0, (Vector<Euclidean3D>) vector3D1);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(5828361.639999999, (-223.46963517394), (-2311.63589509));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.NEGATIVE_INFINITY;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-1.9841269659586505E-4), vector3D0, 0.0, vector3D0, (-4.068233003401932E-9), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(0.0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-9.092849310531849E-21), vector3D2.getZ(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals((-3.0000000000000005E-10), vector3D2.getY(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-3620.0));
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(0.4546487134128409, vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(8.267990858403952E-41, 3.7918321493528775E-20);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1049.009491342093);
      assertEquals((-741.2617248570448), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.1795268640216787E-8, 1.1795268640216787E-8, 1184.7476129124266);
      Vector3D vector3D1 = Vector3D.ZERO;
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals((-0.7853981631974483), vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2390.98052008973, 2390.98052008973, 2390.98052008973);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.4204096180671892), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.902267575263977, (-2732.8), (-2732.8));
      Vector3D vector3D1 = new Vector3D(550.1489, vector3D0, 550.1489, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-1.5703027482648606), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-8.440613381926662E-4), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-8.0E298), vector3D0, (-8.0E298), vector3D0, 1.0E-10, vector3D0, 2210.075, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-1.9841269659586505E-4), vector3D0, 0.0, vector3D0, (-1.9841269659586505E-4), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-3.9682539319173005E-4), double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(3.541460430669496E-17, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals((-0.3332868299939864), vector3D2.getZ(), 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      Vector3D vector3D4 = new Vector3D((-1.9841269659586505E-4), vector3D2, 1054.6137285, vector3D2, 6.620207907987481E-17, vector3D3, 1054.6137285, vector3D1);
      Line line0 = new Line(vector3D3, vector3D4);
      Vector3D vector3D5 = line0.closestPoint(line0);
      assertEquals(0.500474237944877, vector3D5.getNormInf(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Vector3D vector3D2 = new Vector3D((-1.9841269659586505E-4), vector3D0, 1054.6137285, vector3D0, 6.620207907987481E-17, vector3D1, 1054.6137285, vector3D0);
      Line line0 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.closestPoint(line0);
      assertEquals(4.7410717415633365E-4, vector3D3.getZ(), 0.01);
      assertEquals(1.0004738823964932, vector3D3.getNorm1(), 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-950.81));
      Vector3D vector3D1 = new Vector3D((-112.61393068), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      try { 
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = Vector3D.ZERO;
      Vector3D vector3D2 = new Vector3D(5828361.639999999, (-223.46963517394), (-2311.63589509));
      Line line0 = new Line(vector3D2, vector3D1);
  ...
  public void test63()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0E-10, vector3D0, 1.0E-10, vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(375.68874257525084);
      assertEquals(375.68874257525084, vector3D2.getY(), 0.01);
  }
  ...
  public void test65()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(3.49067033732267E-26, vector3D2.getNorm(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test66()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(3.49067033732267E-26, vector3D2.getNormInf(), 0.01);
  }
