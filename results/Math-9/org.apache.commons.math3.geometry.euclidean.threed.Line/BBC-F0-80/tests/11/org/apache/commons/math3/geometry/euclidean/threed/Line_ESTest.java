...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1759.0, vector3D0, (-2857.53936223), vector3D0);
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1633.673), (-1.0), (-1.0));
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-942.027323314521), 0.0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.5041309376180977E12, 1.5041309376180977E12);
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-942.7936880394453), (-942.7936880394453));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(959.899435039);
      assertEquals(283.45123841222915, vector3D2.getY(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(959.899435039);
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(2.1544905707995434E13, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1716.0);
      assertEquals(1715.9998413859005, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals((-0.3082787438316994), vector3D3.getY(), 0.01);
  ...
  public void test16()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.15533221129636665, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.5195691800755656E-33, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(959.899435039, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(6.7954627768762304E-15, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals((-1.5316938601654162E-32), vector3D2.getZ(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-942.027323314521), 0.0);
      Vector3D vector3D1 = new Vector3D((-942.027323314521), 2.893485277253286E-8);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(5.7554622794507385E-9, vector3D2.getY(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.7976931348623157E308, 2665.978867994364, 1.0000000000002065);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(2.5892603246830954E-18, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(0.26757490832961706, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-0.04825619173243832), vector3D2.getX(), 0.01);
  }
  ...
  public void test37()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-428.8518573878348), (-428.8518573878348), 0.8109631538391113);
      Vector3D vector3D1 = new Vector3D((-428.8518573878348), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.5041309376180977E12, 1.5041309376180977E12);
      Vector3D vector3D1 = new Vector3D(1.5041309376180977E12, vector3D0, 826.25572174, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D1);
      assertEquals(3.005131874514263E-4, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test51()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = vector3D0.scalarMultiply((-2438.0403144317975));
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-942.027323314521), 0.0);
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Vector3D vector3D2 = vector3D1.add(959.899435039, (Vector<Euclidean3D>) vector3D0);
      Vector3D vector3D3 = Vector3D.crossProduct(vector3D1, vector3D2);
      Vector3D vector3D4 = new Vector3D(959.899435039, vector3D1);
  ...
  public void test53()  throws Throwable  {
      ...
      assertEquals(0.43539118303547997, vector3D3.getY(), 0.01);
      assertNotNull(vector3D3);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D1 = vector3D0.add(790.3117786799, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(1.004012487753724E13, vector3D1, (-1581.99476906), vector3D1);
      Vector3D vector3D3 = new Vector3D((-2088.352648904), 3.141592653489793);
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = new Vector3D(0.49999999999999994, 0.49999999999999994);
      try { 
  ...
  public void test61()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1.836028788869248, vector3D0, 381.351, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(765.58462);
      assertEquals(765.58462, vector3D2.getY(), 0.01);
  }
