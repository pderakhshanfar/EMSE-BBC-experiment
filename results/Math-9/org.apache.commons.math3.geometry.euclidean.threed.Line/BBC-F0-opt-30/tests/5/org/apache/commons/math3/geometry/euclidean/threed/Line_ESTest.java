...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-4.503599627370496E15), vector3D0, (-4.503599627370496E15), vector3D0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.7675435543060303, 3.141592653489793);
      Vector3D vector3D1 = new Vector3D(0.7675435543060303, vector3D0, 3.141592653489793, vector3D0, 0.6409968137741089, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.POSITIVE_INFINITY;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals(1.0000013073871703E-10, vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(2277.9044905007, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-852.969), vector3D0, (-852.969), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(2.97867857649943E-14, vector3D2.getX(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Vector1D vector1D0 = new Vector1D(0.0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-7.273578988967404E-15), vector3D2.getZ(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-1027.8868387709));
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-852.969), vector3D0, (-852.969), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1208.331651119);
      assertEquals((-1208.331651119), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-74.52639876), (-550.059255), 551.5028335);
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D3 = line0.pointAt((-7.800414592973399E-9));
      assertEquals((-0.5000000055157261), vector3D3.getZ(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      assertNotNull(vector3D2);
      assertEquals(7.85732740736193E-35, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0091402924511395E7, 3177.6968575096043);
      Vector3D vector3D1 = new Vector3D((-1.0), vector3D0, 1.0091402924511395E7, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(4.754951142708092E-11, vector3D2.getY(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(7.273578988967404E-15, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, 0.0, vector3D0, 3177.6968575096043, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(6.118024645404671E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(4157.94064, vector3D0, 4157.94064, vector3D0, (-8.0E298), vector3D0);
      Vector3D vector3D2 = new Vector3D(4157.94064, vector3D1);
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals((-550.5028335), double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1359.923412016408, vector3D0, 3.141592653489793, vector3D0, 3.141592653489793, vector3D1, 0.0, vector3D1);
      Line line0 = new Line(vector3D0, vector3D2);
      double double0 = line0.distance(vector3D2);
      assertEquals(3.813723557090295E-14, double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(2.4325226975380603E-11, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(2.97867857649943E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test44()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(56.37106400902509, 1.0);
  ...
  public void test45()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1359.923412016408, vector3D0, 3.141592653489793, vector3D0, 3.141592653489793, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test47()  throws Throwable  {
      ...
      assertEquals(7.800463371553964E15, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test48()  throws Throwable  {
      double[] doubleArray0 = new double[3];
      doubleArray0[0] = 6.190137379338916;
      doubleArray0[1] = 6.190137379338916;
      doubleArray0[2] = 6.190137379338916;
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D(6.190137379338916, vector3D0, 5.5351917700392624E10, vector3D0, 2033.7583444, vector3D0, 4.586419093481453, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(3.29073509070088E-5, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(6.190137379338916, vector3D0, 5.5351917700392624E10, vector3D0, 2033.7583444, vector3D0, 4.586419093481453, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(6.190137379338916, 0.087);
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector1D vector1D0 = new Vector1D(2.029899906353724E11);
  ...
  public void test59()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-878.9), (-775.15));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.3667256260599285, vector3D2.getNormInf(), 0.01);
  }
}
