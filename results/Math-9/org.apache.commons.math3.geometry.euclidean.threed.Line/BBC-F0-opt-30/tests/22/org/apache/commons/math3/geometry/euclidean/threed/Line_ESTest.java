...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, 5.7725251239547624E-11);
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line1.intersection(line0);
      assertEquals(1.0251713321616829E-10, vector3D2.getDelta(), 0.01);
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.0E-10, 316.345422150767);
      Line line0 = new Line(vector3D1, vector3D2);
      Line line1 = new Line(vector3D0, vector3D2);
      double double0 = line1.distance(line0);
      assertEquals(3.2576363703184114E-27, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1193.420244237, 2.2250738585072014E-308, 2.2250738585072014E-308);
      Vector3D vector3D1 = new Vector3D((-513.600656835), 316.345422150767);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(864.5637396667734, vector3D0);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, 5.7725251239547624E-11);
      Vector3D vector3D1 = new Vector3D(5.7725251239547624E-11, vector3D0, 0.7675435543060303, vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1.0E-10, 316.345422150767);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D((-1.0));
      Vector1D vector1D1 = new Vector1D((-671.722053133), vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals(843.8041028972605, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-2331.44));
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-198.9893791), 2.2028572026531233E-17);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(3550.83185, vector3D0, 3550.83185, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-303.546));
      assertEquals(303.546, vector3D2.getX(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals(1.3817732907337616, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(2.241393159111801E-17, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-216.0), vector3D0, 226.51, vector3D0, (-1201.6203501), vector3D0, (-5.7618793749770706E-8), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.6330743044523982E-13, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(628.613713376501, (-467.9770707), (-1003.2532));
      Vector3D vector3D1 = new Vector3D(32.92128293, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.1174771019743365E-12, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-5.7618793749770706E-8), (-216.0), (-1201.6203501));
      Vector3D vector3D1 = new Vector3D((-216.0), vector3D0, 226.51, vector3D0, (-1201.6203501), vector3D0, (-5.7618793749770706E-8), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      Line line1 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line1.getOrigin();
      assertEquals(1.5707963269907737, vector3D3.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.577252902820364, 1.0E-10, 1.0E-10);
      Vector3D vector3D1 = new Vector3D((-312.5313078602), vector3D0, 3.141592653489793, vector3D0, 0.577252902820364, vector3D0, (-1.7976931348623157E308), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(1.000000000000163, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1193.420244237, 2.2250738585072014E-308, 2.2250738585072014E-308);
      Vector3D vector3D1 = new Vector3D(1193.420244237, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test31()  throws Throwable  {
      ...
      assertEquals((-0.09171728975398175), vector3D2.getZ(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3105.93522), vector3D0, (-3105.93522), vector3D0, (-3105.93522), vector3D0, (-1375.5633031799675), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.2516856466601208E-12, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2.241393159111801E-17), vector3D2.getX(), 0.01);
  }
