...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2422.973089090437, vector3D0, 3.141592653489793, vector3D0, 134.3732800658602, vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = Vector3D.PLUS_K;
      Vector3D vector3D3 = new Vector3D(1.0E-10, vector3D2, 1863.53, vector3D1, (-2416.432297769871), vector3D0, 1.0E-10, vector3D1);
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1245.7839912206161, (-1650.373389622));
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(2.356194490192345, 1.0E-10, 1.0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.9999999999996019, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1845.0), (-1845.0));
      Vector3D vector3D1 = new Vector3D((-1845.0), vector3D0, 1.0, vector3D0, (-1845.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1479.0878537352799), vector3D2.getX(), 0.01);
      assertEquals(2855.2348252938054, vector3D2.getNormInf(), 0.01);
      assertEquals((-3688.9999999999995), vector1D0.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-141.621078224234));
      assertEquals((-0.7804052561678715), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2422.973089090437, vector3D0, 3.141592653489793, vector3D0, 134.3732800658602, vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-2528.60156380828));
      assertEquals((-2528.60156380828), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(134.3732800658602, vector3D0, 1.0, vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(6.9992855907863145E-28, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(0.0, 1157.215905756876);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.22845804439910647, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(3.962003518543874E-26, vector3D2.getNormSq(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      doubleArray0[0] = (-1519.309355470742);
      Vector3D vector3D1 = new Vector3D(doubleArray0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.0006577602972473, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2645.586244424, vector3D0, 2645.586244424, vector3D0, 1.0E-10, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.23574410779345573), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D(8.0E298, (-211.15816), (-211.15816));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(-0.0, vector3D2.getZ(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals((-3688.9999999999995), double0, 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(2.356194490192345, 1.0E-10, 1.0);
      Line line1 = new Line(vector3D0, vector3D2);
      double double0 = line0.distance(line1);
      assertEquals(2.4964764121191767E-27, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.ZERO;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(0.0, 1157.215905756876);
      Line line1 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line1.closestPoint(line0);
      assertEquals(1.0000000000000022, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals(1.9904782135315809E-13, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D(2.0, (-966.98538423), (-1076.95246716074));
      Vector3D vector3D2 = new Vector3D((-1076.95246716074), vector3D1, 1592.516481671355, vector3D0, 8.0E298, vector3D1);
  ...
  public void test40()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-103.98307909819), (-103.98307909819), 0.0);
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4.503599627370496E15, 4.503599627370496E15);
      Vector3D vector3D1 = new Vector3D(2645.586244424, vector3D0, 5614.420018088, vector3D0, 5614.420018088, vector3D0, (-1710.00984656902), vector3D0);
      Vector3D vector3D2 = new Vector3D(2645.586244424, vector3D0, 2645.586244424, vector3D1, 1.0E-10, vector3D1);
      Line line0 = new Line(vector3D0, vector3D1);
