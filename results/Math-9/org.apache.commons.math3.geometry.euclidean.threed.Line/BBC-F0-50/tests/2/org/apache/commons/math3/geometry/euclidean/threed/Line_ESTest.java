...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2739.26429, 0.0, (-3222.5));
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 2739.26429, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line0.intersection(line1);
      assertNotNull(vector3D2);
      assertEquals(8.58050256743727E-10, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3136.99659, 3136.99659, 3136.99659);
      Vector3D vector3D1 = new Vector3D(1017.4669515794, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2578.4537440000004), vector1D0.getX(), 0.01);
      assertEquals(919.2703227994581, vector3D2.getY(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(9.869604401089344, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, (-1199.2446350293485));
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(3.141592653489793);
      assertEquals(2.6984706354694237, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(2241.2357341, vector3D0, 2241.2357341, vector3D0, 2241.2357341, vector3D0, 0.1246747374534607, vector3D0);
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1289.226872), vector3D0, (-1289.226872), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1289.226872));
      assertEquals(1289.226872, vector3D2.getY(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1289.226872), vector3D0, (-1289.226872), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(5.0614674548127384E-8);
      assertEquals(5.061467242769911E-8, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.120428271188512E-15, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2739.26429, 0.0, (-3222.5));
      Vector3D vector3D1 = new Vector3D(2739.26429, vector3D0, (-3222.5), vector3D0, 1.0E-10, vector3D0, (-3222.5), vector3D0);
      Vector3D vector3D2 = new Vector3D(0.0, vector3D1, 2739.26429, vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.intersection(line0);
      assertEquals(2.6630195667038454E-9, vector3D3.getNorm1(), 0.01);
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(0.1246747374534607, vector3D0, 2241.2357341, vector3D0, 0.1246747374534607, vector3D0, 0.1246747374534607, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-2.747465334057846E-17), vector3D2.getZ(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals(4.8680065099808356E-14, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.6476675394960761), vector3D2.getX(), 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(2241.2357341, vector3D0, 2241.2357341, vector3D0, 2241.2357341, vector3D0, 0.1246747374534607, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(0.0);
      double double0 = line0.getAbscissa(vector3D2);
      assertEquals(4.620617945070849E-13, vector3D2.getZ(), 0.01);
  ...
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-1289.226872), vector3D0, (-1289.226872), vector3D0);
      Vector3D vector3D2 = vector3D1.scalarMultiply((-1289.226872));
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D2);
      assertEquals(3324211.8549738084, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1289.226872), vector3D0, (-1289.226872), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(4.0, 5.0614674548127384E-8, 1.0E-10);
  ...
  public void test32()  throws Throwable  {
      ...
      assertEquals(1.8810400789626316E-14, double0, 0.01);
  }
  ...
  public void test36()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(2.120428271188512E-15, vector3D2.getY(), 0.01);
  }
  ...
  public void test39()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3101.39, vector3D0, 3101.39, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.13757054290892E14, 4.0, 4.0);
      Vector3D vector3D1 = new Vector3D(2482.0, vector3D0, (-1.0), vector3D0, 1.13757054290892E14, vector3D0, 1.13757054290892E14, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-1286.250580322392), vector3D0, (-1286.250580322392), vector3D0);
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Vector3D vector3D2 = new Vector3D((-3376.1876219134483), vector3D0, (-3376.1876219134483), vector3D0, 4.520991511066501E7, vector3D1);
      Vector3D vector3D3 = new Vector3D(4.520991511066501E7, vector3D1, 4.520991511066501E7, vector3D2, 3079487.32147461, vector3D0, 4.519646844691093E7, vector3D2);
  ...
  public void test62()  throws Throwable  {
      ...
      assertEquals((-1.000000000000462), double0, 0.01);
  }
  ...
  public void test65()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2241.2357341, vector3D0, 2241.2357341, vector3D0, 2241.2357341, vector3D0, 0.1246747374534607, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-6.70362890354882));
      assertEquals(6.703628903548358, vector3D2.getNorm(), 0.01);
  }
