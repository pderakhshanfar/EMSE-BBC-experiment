...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0E-10, 3.100940631915145E-16);
      Vector3D vector3D1 = Vector3D.PLUS_K;
      ...
      Vector3D vector3D4 = line1.pointAt(1.0E-10);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.8625398401734626), vector1D0.getX(), 0.01);
      assertEquals((-0.4879499517729242), vector3D2.getZ(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(35.72668011203346, 3624.040000000001);
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test08()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1.1270996630229943E7);
      assertEquals((-1.1270996630229943E7), vector3D2.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D2 = line1.pointAt(1.1270996630229943E7);
      assertEquals(4798911.1197288595, vector3D2.getY(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(0.3672480659207726, vector3D2.getY(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(9651914.390882436, (-1418.36));
      Line line1 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.intersection(line1);
      assertNotNull(vector3D3);
      assertEquals(7.719666847800676E-34, vector3D3.getY(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(3459.984452986, 3459.984452986, (-117.71189592));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.7858320521610768), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals(0.859080361378203, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(2018.434344956, vector3D0, 2018.434344956, vector3D0, 608.3384023789757, vector3D0, 1.997844754509471E-9, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(4.148452327488562E-13, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(682.1635579257193, 2516.11);
      Vector3D vector3D1 = new Vector3D((-49.285101), vector3D0, (-653.98861297527), vector3D0, 2516.11, vector3D0);
      Vector3D vector3D2 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(0.3493803757613432, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.21444074514317174), vector3D2.getY(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals(0.5139968177490087, double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D0);
      assertEquals(1.1912402344906373E-16, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Line line1 = line0.revert();
      double double0 = line0.distance(line1);
      assertEquals(7.377514747495956E-18, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(13.07, vector3D0, 13.07, vector3D0, 13.07, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.9472207730623604E-15, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(35.72668011203346, 3624.040000000001);
      Vector3D vector3D1 = new Vector3D(35.72668011203346, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.181712119104925E-17, vector3D2.getX(), 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(-0.0, 3624.040000000001);
