...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-814.6080583210859), (-814.6080583210859));
  ...
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-112.29603), (-112.29603), (-112.29603));
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, 0.0, vector3D0, (-1.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0, vector3D0, 93.489, vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(1.6613582585289647E-15, vector3D2.getY(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      assertEquals(109.1544373465102, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.0036);
      assertEquals((-0.4974544155877284), vector3D2.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      doubleArray0[2] = (-510.8);
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-1642.6376534089));
      assertEquals((-1642.6376534089), vector3D2.getZ(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      assertEquals(3.141592653489801, vector3D2.getZ(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals(6.4105367001082215E-15, vector3D4.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(3.6725170580355583E-9, 25.8512023199766, 1.0E-10);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line1);
      assertNotNull(vector3D2);
      assertEquals(1.6991736971709197E-15, vector3D2.getY(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-3.4269011274529426E-17), vector3D2.getZ(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(6.08449611365966E-29, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-112.29603), vector3D0, 3.141592653489793, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-109.1544373465102), (-2328.29), (-2328.29));
      Line line1 = new Line(vector3D1, vector3D2);
      double double0 = line1.distance(line0);
      assertEquals(1.1639050943137154E-16, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(0.9999961673729687, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test38()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Vector3D vector3D2 = new Vector3D(520.995669, vector3D0, 520.995669, vector3D0, (-8.0E298), vector3D1, 767.957, vector3D0);
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1680.0, vector3D0, 1680.0, vector3D0, 1680.0, vector3D0, 3.141592653589793, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      try { 
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-753.03), (-2245.4291578182));
      Vector3D vector3D1 = new Vector3D(0.99, vector3D0, (-2245.4291578182), vector3D0);
      Vector3D vector3D2 = new Vector3D((-2245.4291578182), vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Line line1 = new Line(vector3D1, vector3D0);
  ...
  public void test55()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-753.03), (-2245.4291578182));
      Vector3D vector3D1 = new Vector3D((-2245.4291578182), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      boolean boolean0 = line0.isSimilarTo(line0);
      assertTrue(boolean0);
  }
  ...
  public void test57()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.5619866335478343), vector3D2.getY(), 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      assertEquals(4.4206000822797205E-13, double0, 0.01);
  }
}
