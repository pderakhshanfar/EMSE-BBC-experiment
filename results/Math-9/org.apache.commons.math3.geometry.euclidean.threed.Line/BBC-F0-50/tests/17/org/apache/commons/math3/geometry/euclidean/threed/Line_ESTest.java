...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2144.146), vector3D0, (-2144.146), vector3D0, (-2144.146), vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-5495.2), (-5495.2), (-528.7117507236));
      ...
      assertEquals(0.04779531522029412, vector3D2.getX(), 0.01);
  }
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-2144.146), vector3D0, (-2144.146), vector3D0, 2.2250738585072014E-308, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(2.912214416685121E-17, vector3D2.getX(), 0.01);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(891.0, 891.0);
      ...
      assertEquals((-0.6248151254568685), vector1D0.getX(), 0.01);
      assertEquals((-0.08558379457498345), vector3D3.getDelta(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(0.0);
      assertEquals((-2.6562829738180926E-17), vector3D2.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(2.9062329317442315E-17, vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-149.0), vector3D0, 1.0E-10, vector3D0, (-877.552), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(4.871812458327111E-14, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(891.0, 891.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.4384508058998814), vector3D2.getX(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(9.179246928075425E-11, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D((-646.0), vector3D0);
      ...
      assertEquals((-1.0931048387745392E-10), vector3D3.getY(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Vector3D vector3D1 = vector3D0.scalarMultiply((-149.0));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test19()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.0661910706043052E-16, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D(1619.5600714648267, 2.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.9092974268256817, vector3D2.getZ(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals((-2144.146), double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-596.4484), 3294198.0, 752.70423);
      Vector3D vector3D2 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D3 = line0.pointAt(1153.48015565835);
      Line line1 = new Line(vector3D3, vector3D2);
      Vector3D vector3D4 = line0.closestPoint(line1);
      assertEquals(0.2086683030926037, vector3D4.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-5495.2), (-5495.2));
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-2144.146), vector3D0, 0.0, vector3D0, (-1.0), vector3D0);
      Vector3D vector3D2 = new Vector3D((-2144.146), vector3D1, 0.0, vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.closestPoint(line0);
      assertEquals((-2.2710992552180386E-10), vector3D3.getZ(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1537.4853379136, (-8.0E298), (-8.0E298));
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test50()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(0.3333333134651184, 0.3333333134651184, 6.067398219535321E7);
      Vector3D vector3D3 = new Vector3D(6.067398219535321E7, vector3D2, 3.141592653589793, vector3D2);
  ...
  public void test54()  throws Throwable  {
      ...
      assertEquals(0.9999999573863793, double0, 0.01);
  }
  ...
  public void test58()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-596.4484), 3294198.0, 752.70423);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1153.48015565835);
      Line line1 = new Line(vector3D2, vector3D0);
      double double0 = line1.distance(line0);
      assertEquals(5.704340924405134E-21, double0, 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.915342835412041E-4, vector3D2.getNorm(), 0.01);
  }
}
