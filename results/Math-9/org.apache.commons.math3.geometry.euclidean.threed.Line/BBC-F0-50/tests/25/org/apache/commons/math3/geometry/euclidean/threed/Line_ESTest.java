...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(438.80639316, 3.141592653489793);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1658.9437928224), vector3D0, 0.0, vector3D0, (-670.392007), vector3D0, 0.0, vector3D0);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.5850043984645552, 0.5850043984645552);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.POSITIVE_INFINITY;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(Double.POSITIVE_INFINITY, vector3D2.getZ(), 0.01);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(41.0451678255, vector3D0, 0.0, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1.100406823568023E-17), vector3D2.getY(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(439.7351972167158, 439.7351972167158);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.675203840070928), vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(0.041666666666621166, 2407.743);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test10()  throws Throwable  {
      ...
      assertEquals((-0.4557705535770972), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D(438.80639316, 438.80639316);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-1891.90337821), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(954.7263);
      assertEquals(954.7263, vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(438.80639316, 3.141592653489793);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-113.0));
      assertEquals((-96.08528519061028), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(1.0E-10, 0.7316888570785522);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(1.1512425919367244, vector3D2.getDelta(), 0.01);
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals(1.8276475635798358E-10, vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2118.907926970409), (-2118.907926970409));
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.9976825091658441, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-113.0), vector3D0, 438.80639316, vector3D0, 438.80639316, vector3D0, (-113.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(8.862403740999276E-27, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals(1.0000000000001048, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(9.414034066753357E-14, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test41()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(425605.35009321454, vector3D0, 425605.35009321454, vector3D0, 425605.35009321454, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(6.237114710108631E-11, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test44()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1532.926662, vector3D0, (-3240.205), vector3D0, (-3240.205), vector3D0, 41.0451678255, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      line0.reset(vector3D1, vector3D0);
      assertEquals(4906.4381701745, vector3D1.getNormInf(), 0.01);
  }
  ...
  public void test46()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1605.414720912, 1.7045442607256353E7, 1.7045442607256353E7);
      Vector3D vector3D1 = new Vector3D(1.7045442607256353E7, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(1.405701343917739E-7, double0, 0.01);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.2427416931266958E-5, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D(0.7316888570785522, 0.7316888570785522);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
  ...
  public void test49()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.0E-10, 0.7316888570785522);
      Line line0 = new Line(vector3D0, vector3D2);
      Line line1 = new Line(vector3D1, vector3D0);
      double double0 = line1.distance(line0);
      assertEquals(3.671275721512824E-27, double0, 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = new Vector3D(3962.537594133, vector3D1, 0.0, vector3D1, 1488871.6248170333, vector3D0, 6.93477364037843E13, vector3D2);
  ...
  public void test55()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      assertEquals((-2.410589616881844E7), vector1D0.getX(), 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-2.410589616881844E7), double0, 0.01);
  }
  ...
  public void test57()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.7071067796184144), vector3D2.getY(), 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(0.7937005259840998);
