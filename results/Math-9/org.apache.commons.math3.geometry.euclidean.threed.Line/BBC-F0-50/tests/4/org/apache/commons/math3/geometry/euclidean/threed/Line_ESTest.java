...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.800552834259E-8, 2.800552834259E-8);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.9529574313759446, (-292.45224));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test06()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D((-1330.4));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1.0735856648125264E-13), vector3D2.getY(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(2957.874439);
      assertEquals((-2957.874439), vector3D2.getZ(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1973.9199177);
      assertEquals((-2.3565527148318552), vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2962.7284149583), (-2962.7284149583));
      Vector3D vector3D1 = new Vector3D((-1882.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D1.negate();
      Line line1 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.intersection(line1);
      assertEquals((-0.05970849157765159), vector3D3.getDelta(), 0.01);
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals(2.0203148232530754, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D((-1330.4), vector3D0, (-1330.4), vector3D0, 0.0, vector3D0, (-1330.4), vector3D0);
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(5.16588720236473E-27, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(7.187410661959375E-14, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      assertEquals(0.9999998837608502, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.1525861796909542E-26, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(365.0, 365.0);
      Vector3D vector3D1 = new Vector3D((-1835.140237), (-8.0E298), 0.2);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(267584.0402132676, (-350.64078107187));
      Vector3D vector3D1 = new Vector3D(267584.0402132676, vector3D0, 1.5929677440000001E7, vector3D0, 1.3833874944527747E-31, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.getDirection();
      assertEquals((-0.15255142350596962), vector3D2.getX(), 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals((-0.778025260604199), vector3D2.getX(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(267584.0402132676, (-350.64078107187));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D(267584.0402132676, vector3D1, 1.5929677440000001E7, vector3D0, 1.3833874944527747E-31, vector3D0);
  ...
  public void test32()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(4.1667320991337244E-14, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      line0.reset(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.closestPoint(line0);
      assertEquals(1.0004819274867853, vector3D3.getNorm1(), 0.01);
  }
  ...
  public void test38()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1388.1628534526603), 1626.0);
      Vector3D vector3D1 = new Vector3D((-1388.1628534526603), vector3D0, 1626.0, vector3D0, (-1.7976931348623157E308), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
      try { 
  ...
  public void test52()  throws Throwable  {
      ...
      assertEquals(0.9999999999999282, double0, 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.800552834259E-8, 2.800552834259E-8);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D(2.800552834259E-8, vector3D1, 59309.54932745866, vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      Line line1 = new Line(vector3D0, vector3D2);
      double double0 = line1.distance(line0);
      assertEquals(2.6137637040692633E-25, double0, 0.01);
  }
  ...
  public void test56()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D(634.0, 620.34);
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(vector3D0, vector3D2);
      boolean boolean0 = line1.isSimilarTo(line0);
      assertFalse(boolean0);
  ...
  public void test58()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-2.8005528342590004E-8), vector3D2.getZ(), 0.01);
  }
