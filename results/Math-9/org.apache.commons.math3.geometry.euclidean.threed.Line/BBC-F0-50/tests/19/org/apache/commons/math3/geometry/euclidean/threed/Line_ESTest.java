...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(1.0E-10, vector3D0, 2836.73211, vector3D1, 1.0E-10, vector3D2);
  ...
  public void test06()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D((-17.012194));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.743857372258579), vector3D2.getDelta(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(0.008333333333329196, vector3D0, 0.008333333333329196, vector3D0, 0.008333333333329196, vector3D0, 0.008333333333329196, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D(0.0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1.5568644712841537E-17), vector3D2.getY(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-2679.33));
      assertEquals(2453.0441055445463, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(943.2590619841);
      assertEquals((-943.2590619841), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(0.8908987181403394, vector3D0, 1285.35665719, vector3D0, 1285.35665719, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1285.35665719);
      assertEquals((-1285.35665719), vector3D2.getY(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.8379687380020462, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.5568644712841537E-17, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(doubleArray0);
      Vector3D vector3D2 = vector3D0.add(0.6299605249474366, (Vector<Euclidean3D>) vector3D1);
      Line line0 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(1.58402389737069, vector3D3.getAlpha(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, (-4430.47420184));
      Vector3D vector3D2 = new Vector3D((-4430.47420184), vector3D0, (-4430.47420184), vector3D1, 0.0, vector3D1, 0.0, vector3D0);
      Vector3D vector3D3 = new Vector3D(0.0, vector3D0, (-4430.47420184), vector3D2, 0.0, vector3D1);
      Line line0 = new Line(vector3D3, vector3D2);
      Vector3D vector3D4 = line0.getOrigin();
      assertEquals(4.3487256106052537E-10, vector3D4.getX(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.985614761651186E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(8.0E298, 3750.3364, 1.037289928037655E15);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test28()  throws Throwable  {
      ...
      assertEquals(2.981653542882315E-17, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-4430.47420184));
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D1, vector3D0);
      line0.reset(vector3D0, vector3D1);
      Line line1 = line0.revert();
      double double0 = line0.distance(line1);
      assertEquals(3.868217930598579E-17, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(1.0130510692710073, vector3D3.getNorm1(), 0.01);
      assertEquals(0.9998250415810974, vector3D3.getY(), 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      assertEquals(0.9154063239906344, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(1.5568644712841537E-17, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test36()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.7976931348623157E308, vector3D0, 0.9985313415527344, vector3D0, 0.9985313415527344, vector3D0, 2.0192960700884288E14, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
      try { 
        line0.revert();
  ...
  public void test38()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2836.73211, vector3D0, 1.0, vector3D0, 0.6299605249474366, vector3D0, 0.008333333333329196, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(2836.73211, vector3D0, (-1.7976931348623157E308), vector3D0, 0.008333333333329196, vector3D0);
  ...
  public void test52()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(2836.73211, vector3D0, 1.0, vector3D0, 0.6299605249474366, vector3D0, 0.008333333333329196, vector3D0);
      Vector3D vector3D3 = vector3D2.add(0.6299605249474366, (Vector<Euclidean3D>) vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Line line1 = new Line(vector3D2, vector3D3);
      Vector3D vector3D4 = line0.pointAt(0.0);
      Line line2 = new Line(vector3D4, vector3D1);
      boolean boolean0 = line1.isSimilarTo(line2);
      assertEquals(7.196129097880032E-14, vector3D4.getY(), 0.01);
      assertFalse(boolean0);
  }
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(0.9999652789833666, 0.9999652789833666);
      Line line0 = new Line(vector3D1, vector3D0);
