...
public class DateTimeZone_ESTest extends DateTimeZone_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.convertLocalToUTC((long) (-2415), false);
  ...
  public void test003()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1068), "Asia/Yerevan");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
      int int0 = dateTimeZone0.getOffsetFromLocal((-1068));
  ...
  public void test010()  throws Throwable  {
      ...
      TimeZone timeZone0 = dateTimeZone0.toTimeZone();
      assertEquals("java.util.SimpleTimeZone[id=-00:00:02.422,offset=-2422,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", timeZone0.toString());
      assertEquals("-00:00:02.422", dateTimeZone0.toString());
  }
  ...
  public void test012()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      dateTimeZone0.UTC.previousTransition(3183L);
  ...
  public void test013()  throws Throwable  {
      ...
      long long0 = fixedDateTimeZone0.previousTransition((-4208L));
      assertEquals((-4208L), long0);
  }
  ...
  public void test015()  throws Throwable  {
      ...
      dateTimeZone0.nextTransition(2047L);
      assertEquals("+00:00:00.001", dateTimeZone0.getID());
  }
  ...
  public void test016()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      long long0 = fixedDateTimeZone0.nextTransition((-1709L));
  ...
  public void test020()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(578);
      int int0 = dateTimeZone0.getStandardOffset((-2037L));
  ...
  public void test021()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      int int0 = dateTimeZone0.getStandardOffset(2215019776L);
  ...
  public void test024()  throws Throwable  {
      ...
      dateTimeZone0.getOffset(1022L);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
  }

  @Test(timeout = 4000)
  public void test025()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(208800000, "CAT");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
  ...
  public void test026()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("America/Denver");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      int int0 = dateTimeZone0.getOffset((-2150L));
      assertEquals((-25200000), int0);
  }
  ...
  public void test027()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(1);
      dateTimeZone0.getNameKey(179261312L);
  ...
  public void test032()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      dateTimeZone0.equals("'A LH [/66P*v8r");
      assertEquals("Etc/UTC", dateTimeZone0.toString());
  }
  ...
  public void test034()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(578);
      long long0 = dateTimeZone0.convertUTCToLocal(2080800000L);
  ...
  public void test035()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHours(0);
      long long0 = dateTimeZone0.convertLocalToUTC((long) 0, true, (-755L));
      assertEquals(0L, long0);
  }
  ...
  public void test036()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      long long0 = dateTimeZone0.convertLocalToUTC((-151L), false, (-151L));
      assertEquals(25199849L, long0);
  }
  ...
  public void test037()  throws Throwable  {
      GJChronology gJChronology0 = GJChronology.getInstance((DateTimeZone) null);
      DateTimeZone dateTimeZone0 = gJChronology0.getZone();
      long long0 = dateTimeZone0.UTC.convertLocalToUTC((-2542L), false, (-3482L));
  ...
  public void test038()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      long long0 = fixedDateTimeZone0.convertLocalToUTC(2991667746L, true);
      assertEquals(2991667746L, long0);
  }
  ...
  public void test044()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dateTimeZone0.convertLocalToUTC((-9223372036847575767L), true, (-1L));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal instant due to time zone offset transition (daylight savings time 'gap'): -292275055-05-16T18:47:04.233 (Africa/Harare)
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test048()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      long long0 = dateTimeZone0.convertUTCToLocal(2169L);
      assertEquals((-25197831L), long0);
  }
  ...
  public void test051()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      int int0 = dateTimeZone0.getOffsetFromLocal((-169L));
      assertEquals((-25200000), int0);
  }
  ...
  public void test054()  throws Throwable  {
      GJChronology gJChronology0 = GJChronology.getInstance((DateTimeZone) null);
      DateTimeZone dateTimeZone0 = gJChronology0.getZone();
      String string0 = dateTimeZone0.getShortName((-3482L), (Locale) null);
  ...
  public void test055()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes((-1193), 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test057()  throws Throwable  {
      // Undeclared exception!
      try { 
        DateTimeZone.forID("T*1z$5Gr");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The datetime zone id 'T*1z$5Gr' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test058()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        MutableDateTime.parse("Subtracting time zone offset caused overflow", dateTimeFormatter0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test061()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("Asia/Dhaka");
      long long0 = dateTimeZone0.adjustOffset(1262278740006L, true);
      assertEquals(1262278740006L, long0);
  }
  ...
  public void test067()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("Asia/Dhaka");
      long long0 = dateTimeZone0.convertLocalToUTC(3368L, false);
      assertEquals((-21596632L), long0);
  }
  ...
  public void test070()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2252), "America/Anchorage");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
      // Undeclared exception!
      try { 
  ...
  public void test080()  throws Throwable  {
      ...
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(4345);
      String string0 = dateTimeZone0.getName((-323L), locale0);
      assertEquals("+00:00:04.345", string0);
  }

  @Test(timeout = 4000)
  public void test081()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("ConverterManager.alterPartialConverters");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      Locale locale0 = Locale.ITALIAN;
      String string0 = dateTimeZone0.getName((-323L), locale0);
      assertNotNull(string0);
  ...
  public void test083()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getShortName((-9223372036843587809L), locale0);
  ...
  public void test094()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(0, (-1441144234));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: -1441144234
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test102()  throws Throwable  {
      GJChronology gJChronology0 = GJChronology.getInstance((DateTimeZone) null);
      DateTimeZone dateTimeZone0 = gJChronology0.getZone();
      dateTimeZone0.getMillisKeepLocal((DateTimeZone) null, (-3482L));
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  }
