...
public class DateTimeZone_ESTest extends DateTimeZone_ESTest_scaffolding {
  ...
  public void test014()  throws Throwable  {
      ...
      dateTimeZone0.previousTransition((-56));
      assertEquals("-56:00", dateTimeZone0.getID());
  }
  ...
  public void test017()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-35));
      dateTimeZone0.UTC.nextTransition((-35));
      assertEquals("-00:00:00.035", dateTimeZone0.toString());
  ...
  public void test020()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      dateTimeZone0.getStandardOffset((-480L));
      assertEquals("Etc/UTC", dateTimeZone0.toString());
  }
  ...
  public void test022()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHours((-56));
      int int0 = dateTimeZone0.getStandardOffset(26607895200000L);
      assertEquals((-201600000), int0);
  ...
  public void test025()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(1);
      int int0 = dateTimeZone0.getOffset((-49L));
      assertEquals("+00:00:00.001", dateTimeZone0.getID());
      assertEquals(1, int0);
  }
  ...
  public void test026()  throws Throwable  {
      ...
      TimeZone timeZone0 = dateTimeZone0.toTimeZone();
      DateTimeZone dateTimeZone1 = DateTimeZone.forTimeZone(timeZone0);
      int int0 = dateTimeZone1.getOffset((-1L));
  ...
  public void test030()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.UTC.getMillisKeepLocal((DateTimeZone) null, 1483L);
      assertEquals((-1313998517L), long0);
  ...
  public void test036()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      long long0 = dateTimeZone0.convertLocalToUTC((long) 0, false, 337L);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
      assertEquals(0L, long0);
  }
  ...
  public void test037()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("MET");
      long long0 = dateTimeZone0.convertLocalToUTC(9223372036854775807L, true, 2750L);
      assertEquals(9223372036847575807L, long0);
  }

  @Test(timeout = 4000)
  public void test038()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4978125, "NST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
      long long0 = dateTimeZone0.convertLocalToUTC((long) 4978125, false, 212280000L);
      assertEquals((-38221875L), long0);
  }

  @Test(timeout = 4000)
  public void test039()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHours((-56));
      long long0 = dateTimeZone0.convertLocalToUTC((-56L), false);
      assertEquals(201599944L, long0);
      assertEquals("-56:00", dateTimeZone0.getID());
  }
  ...
  public void test044()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dateTimeZone0.convertLocalToUTC((-9223372036854775782L), true, 1009L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test045()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("Pacific/Honolulu");
      long long0 = dateTimeZone0.adjustOffset(9223372036847575820L, true);
      assertEquals(9223372036847575820L, long0);
  }
  ...
  public void test048()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHoursMinutes(1, 3);
      long long0 = dateTimeZone0.convertUTCToLocal((-1055L));
      assertEquals(3778945L, long0);
  ...
  public void test050()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("Pacific/Guadalcanal");
      int int0 = dateTimeZone0.getOffsetFromLocal(9223372036847575784L);
      assertEquals(38388000, int0);
  }
  ...
  public void test052()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.UTC.getName((long) 3, (Locale) null);
  ...
  public void test054()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(1);
      String string0 = dateTimeZone0.getShortName(2051L, (Locale) null);
      assertEquals("+00:00:00.001", string0);
  }

  @Test(timeout = 4000)
  public void test055()  throws Throwable  {
      DateTimeZone.forOffsetMillis((-35));
  ...
  public void test057()  throws Throwable  {
      // Undeclared exception!
      try { 
        DateTimeZone.forID("(L|.n");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The datetime zone id '(L|.n' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test059()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("MET");
      long long0 = dateTimeZone0.adjustOffset(1382835600032L, false);
      assertEquals(1382832000032L, long0);
  }
  ...
  public void test064()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.UTC.getMillisKeepLocal(dateTimeZone0, 1576L);
  ...
  public void test075()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4978125, "NST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
      boolean boolean0 = dateTimeZone0.isStandardOffset(4978125);
      assertFalse(boolean0);
  }
  ...
  public void test078()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHours((-56));
      Locale locale0 = Locale.KOREA;
      String string0 = dateTimeZone0.getName((long) (-56), locale0);
  ...
  public void test084()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "+1O&HS-3u");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The datetime zone id '+1O&HS-3u' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test085()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3526, "PRT");
      // Undeclared exception!
      try { 
        DateTimeZone.forTimeZone(simpleTimeZone0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test086()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(46, "Pacific/Honolulu");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
  ...
  public void test089()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHoursMinutes((-19), 8);
      TimeZone timeZone0 = dateTimeZone0.toTimeZone();
      DateTimeZone dateTimeZone1 = DateTimeZone.forTimeZone(timeZone0);
      assertNotNull(dateTimeZone1);
      assertEquals("-19:08", dateTimeZone0.toString());
      assertEquals("-19:08", dateTimeZone1.toString());
  }

  @Test(timeout = 4000)
  public void test090()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(0, 2361);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: 2361
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test103()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getName(2862L);
      assertEquals("+00:00", string0);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
      assertNotNull(string0);
  }
  ...
  public void test106()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getShortName(21260793600063L);
      assertEquals("+00:00", string0);
      assertNotNull(string0);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
  }
