...
public class DateTimeZone_ESTest extends DateTimeZone_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals("+00:00:00.058", timeZone0.getID());
  ...
  public void test08()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.UTC.previousTransition(45);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
      assertTrue(dateTimeZone0.isFixed());
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  ...
  public void test09()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-14400000), "America/Puerto_Rico");
      assertEquals((-14400000), simpleTimeZone0.getRawOffset());
      assertFalse(simpleTimeZone0.useDaylightTime());
      assertEquals(0, simpleTimeZone0.getDSTSavings());
      assertEquals("java.util.SimpleTimeZone[id=America/Puerto_Rico,offset=-14400000,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", simpleTimeZone0.toString());
  ...
  public void test12()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.UTC.nextTransition((-3435L));
      assertEquals("Etc/UTC", dateTimeZone0.toString());
      assertEquals("Etc/UTC", dateTimeZone0.getID());
      assertTrue(dateTimeZone0.isFixed());
  ...
  public void test17()  throws Throwable  {
      ...
      int int0 = dateTimeZone0.getStandardOffset(282);
      assertTrue(dateTimeZone0.isFixed());
      assertEquals("EST", dateTimeZone0.getID());
      assertEquals("EST", dateTimeZone0.toString());
  ...
  public void test18()  throws Throwable  {
      ...
      int int0 = cachedDateTimeZone0.getOffsetFromLocal((-3060L));
      assertTrue(dateTimeZone0.isFixed());
      assertEquals("Etc/UTC", dateTimeZone0.toString());
      assertEquals("Etc/UTC", dateTimeZone0.getID());
      assertEquals("Etc/UTC", cachedDateTimeZone0.toString());
  ...
  public void test20()  throws Throwable  {
      ...
      int int0 = fixedDateTimeZone0.getOffset(747L);
      assertEquals("UTC", fixedDateTimeZone0.toString());
      assertTrue(fixedDateTimeZone0.isFixed());
      assertEquals("UTC", fixedDateTimeZone0.getID());
      assertEquals(0, int0);
  ...
  public void test23()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getNameKey(1960L);
      assertEquals("+00:00:00.365", dateTimeZone0.toString());
      assertTrue(dateTimeZone0.isFixed());
      assertEquals("+00:00:00.365", dateTimeZone0.getID());
      assertNull(string0);
  ...
  public void test31()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-97266133));
      assertEquals("-27:01:06.133", dateTimeZone0.getID());
      assertEquals("-27:01:06.133", dateTimeZone0.toString());
      assertTrue(dateTimeZone0.isFixed());
      assertNotNull(dateTimeZone0);
      
      long long0 = dateTimeZone0.convertLocalToUTC((long) (-97266133), true, 342L);
      assertEquals("-27:01:06.133", dateTimeZone0.getID());
      assertEquals("-27:01:06.133", dateTimeZone0.toString());
      assertTrue(dateTimeZone0.isFixed());
      assertEquals(0L, long0);
  ...
  public void test32()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.convertLocalToUTC((-1359L), false, (-2091L));
      assertEquals("Etc/UTC", dateTimeZone0.toString());
      assertTrue(dateTimeZone0.isFixed());
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  ...
  public void test36()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHours((-2211));
  ...
  public void test38()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.convertUTCToLocal(1685L);
      assertEquals(1, BuddhistChronology.BE);
      assertEquals("UTC", dateTimeZone0.toString());
      assertTrue(dateTimeZone0.isFixed());
      assertEquals("UTC", dateTimeZone0.getID());
  ...
  public void test39()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.convertUTCToLocal(1318L);
      assertTrue(dateTimeZone0.isFixed());
      assertEquals("-27:01:06.133", dateTimeZone0.toString());
      assertEquals("-27:01:06.133", dateTimeZone0.getID());
      assertEquals((-97264815L), long0);
  }
  ...
  public void test41()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getShortName((long) 58, (Locale) null);
      assertEquals("+00:00:00.058", dateTimeZone0.toString());
      assertEquals("+00:00:00.058", dateTimeZone0.getID());
      assertTrue(dateTimeZone0.isFixed());
  ...
  public void test42()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes((-931), 6);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test47()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.adjustOffset(9223372036847575780L, true);
      assertEquals("Africa/Harare", dateTimeZone0.toString());
      assertEquals("Africa/Harare", dateTimeZone0.getID());
      assertEquals(9223372036847575780L, long0);
  }
  ...
  public void test50()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2035, "SST");
      assertEquals("java.util.SimpleTimeZone[id=SST,offset=2035,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", simpleTimeZone0.toString());
      assertEquals(0, simpleTimeZone0.getDSTSavings());
      assertEquals("SST", simpleTimeZone0.getID());
      assertEquals(2035, simpleTimeZone0.getRawOffset());
      assertFalse(simpleTimeZone0.useDaylightTime());
      assertNotNull(simpleTimeZone0);
      ...
      assertTrue(dateTimeZone1.isFixed());
      assertEquals("+57:00", dateTimeZone1.toString());
      assertEquals("+57:00", dateTimeZone1.getID());
      assertNotNull(dateTimeZone1);
  ...
  public void test57()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.getMillisKeepLocal(dateTimeZone1, (-3176L));
      assertEquals("Africa/Harare", dateTimeZone0.toString());
      assertEquals("Africa/Harare", dateTimeZone0.getID());
      assertEquals("Etc/UTC", dateTimeZone1.toString());
      assertEquals("Etc/UTC", dateTimeZone1.getID());
      assertTrue(dateTimeZone1.isFixed());
      assertEquals(7196824L, long0);
  }
  ...
  public void test59()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3531, "America/Puerto_Rico");
      assertEquals(0, simpleTimeZone0.getDSTSavings());
      assertEquals(3531, simpleTimeZone0.getRawOffset());
      assertFalse(simpleTimeZone0.useDaylightTime());
      assertEquals("java.util.SimpleTimeZone[id=America/Puerto_Rico,offset=3531,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", simpleTimeZone0.toString());
      assertEquals("America/Puerto_Rico", simpleTimeZone0.getID());
      assertNotNull(simpleTimeZone0);
      ...
      int int0 = dateTimeZone0.getOffsetFromLocal((-11));
      assertEquals(0, simpleTimeZone0.getDSTSavings());
      assertEquals(3531, simpleTimeZone0.getRawOffset());
      assertFalse(simpleTimeZone0.useDaylightTime());
      assertEquals("java.util.SimpleTimeZone[id=America/Puerto_Rico,offset=3531,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", simpleTimeZone0.toString());
  ...
  public void test62()  throws Throwable  {
      ...
      int int0 = dateTimeZone0.getOffsetFromLocal((-1916));
      assertEquals("Africa/Harare", dateTimeZone0.getID());
      assertEquals("Africa/Harare", dateTimeZone0.toString());
      assertEquals(7200000, int0);
  }
  ...
  public void test63()  throws Throwable  {
      ...
      boolean boolean0 = dateTimeZone0.isStandardOffset(4541L);
      assertEquals("+00:00:00.001", dateTimeZone0.toString());
      assertEquals("+00:00:00.001", dateTimeZone0.getID());
      assertTrue(dateTimeZone0.isFixed());
      assertTrue(boolean0);
  ...
  public void test66()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getName(2154L, locale0);
      assertEquals("GMT+18:00", timeZone0.getID());
      assertEquals("+18:00", dateTimeZone0.toString());
      assertTrue(dateTimeZone0.isFixed());
      assertEquals("+18:00", dateTimeZone0.getID());
  ...
  public void test67()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getShortName((-417L), locale0);
  ...
  public void test74()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-572), "+18:00");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The datetime zone id '+18:00' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test75()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      long long0 = dateTimeZone0.convertLocalToUTC(851L, true, 531L);
      assertEquals("-18:00", dateTimeZone0.getID());
      assertEquals(64800851L, long0);
  }
  ...
  public void test80()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("-00:00:01.884");
      assertEquals("-00:00:01.884", dateTimeZone0.toString());
      assertNotNull(dateTimeZone0);
  }
  ...
  public void test86()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      long long0 = dateTimeZone0.getMillisKeepLocal((DateTimeZone) null, 595L);
  ...
  public void test87()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(578, "JST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
      TimeZone timeZone0 = dateTimeZone0.toTimeZone();
  ...
  public void test89()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3600, "CET");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
      DateTime dateTime0 = DateTime.now(dateTimeZone0);
      MutablePeriod mutablePeriod0 = new MutablePeriod((-776), 3, (-359), 35, 409, (-1251), (-1239), 14);
      Duration duration0 = mutablePeriod0.toDurationFrom(dateTime0);
      assertEquals((-24693192698986L), duration0.getMillis());
  }
  ...
  public void test96()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getShortName((-3435L));
      assertEquals("+00:00", string0);
      assertEquals("Etc/UTC", dateTimeZone0.getID());
      assertNotNull(string0);
  }
