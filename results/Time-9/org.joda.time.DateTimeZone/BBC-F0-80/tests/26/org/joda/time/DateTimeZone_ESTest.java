...
public class DateTimeZone_ESTest extends DateTimeZone_ESTest_scaffolding {
  ...
  public void test010()  throws Throwable  {
      ...
      TimeZone timeZone0 = dateTimeZone0.toTimeZone();
      assertEquals("-00:00:00.570", dateTimeZone0.toString());
  ...
  public void test012()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      long long0 = fixedDateTimeZone0.previousTransition(151L);
  ...
  public void test013()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      dateTimeZone0.UTC.previousTransition((-917L));
  ...
  public void test015()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      dateTimeZone0.UTC.nextTransition(30585600000L);
      assertEquals("Etc/UTC", dateTimeZone0.getID());
      assertEquals("Etc/UTC", dateTimeZone0.toString());
  }
  ...
  public void test016()  throws Throwable  {
      ...
      dateTimeZone0.UTC.nextTransition((-181));
      assertEquals("-181:00", dateTimeZone0.toString());
      assertEquals("-181:00", dateTimeZone0.getID());
  }
  ...
  public void test019()  throws Throwable  {
      ...
      int int0 = cachedDateTimeZone0.getStandardOffset(0);
      assertEquals(0, int0);
  }
  ...
  public void test020()  throws Throwable  {
      ...
      int int0 = dateTimeZone0.getStandardOffset((-1489L));
  ...
  public void test022()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      CachedDateTimeZone cachedDateTimeZone0 = CachedDateTimeZone.forZone(fixedDateTimeZone0);
      int int0 = cachedDateTimeZone0.getOffsetFromLocal(12032481321L);
      assertEquals(0, int0);
  }
  ...
  public void test025()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHoursMinutes(4, 4);
      int int0 = dateTimeZone0.getOffset(900L);
      assertEquals(14640000, int0);
      assertEquals("+04:04", dateTimeZone0.getID());
  }
  ...
  public void test026()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-1614770617));
      int int0 = dateTimeZone0.getOffset((-2424L));
      assertEquals("-448:32:50.617", dateTimeZone0.getID());
      assertEquals((-1614770617), int0);
  }

  @Test(timeout = 4000)
  public void test027()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHoursMinutes(4, 4);
      dateTimeZone0.getNameKey((-942L));
      assertEquals("+04:04", dateTimeZone0.getID());
  }
  ...
  public void test028()  throws Throwable  {
      GJChronology gJChronology0 = GJChronology.getInstanceUTC();
      DateTimeZone dateTimeZone0 = gJChronology0.getZone();
      String string0 = dateTimeZone0.getNameKey(3475L);
  ...
  public void test034()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-570));
      long long0 = dateTimeZone0.convertUTCToLocal(100000000000000000L);
      assertEquals(99999999999999430L, long0);
      assertEquals("-00:00:00.570", dateTimeZone0.getID());
  }

  @Test(timeout = 4000)
  public void test035()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      long long0 = fixedDateTimeZone0.convertLocalToUTC(0L, false, 2629800000L);
      assertEquals(0L, long0);
  }
  ...
  public void test037()  throws Throwable  {
      ...
      LocalDateTime localDateTime1 = localDateTime0.withLocalMillis((-9223372036854775791L));
      // Undeclared exception!
      try { 
  ...
  public void test043()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-1909965611));
      long long0 = dateTimeZone0.convertLocalToUTC((long) (-1909965611), false);
      assertEquals(0L, long0);
      assertEquals("-530:32:45.611", dateTimeZone0.getID());
  }

  @Test(timeout = 4000)
  public void test044()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHoursMinutes(1, 1);
      long long0 = dateTimeZone0.convertLocalToUTC((-1489L), false, (-1489L));
      assertEquals("+01:01", dateTimeZone0.toString());
      assertEquals((-3661489L), long0);
  }

  @Test(timeout = 4000)
  public void test045()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("CET");
      long long0 = dateTimeZone0.convertUTCToLocal((-766623600000L));
      assertEquals((-766620000000L), long0);
  }

  @Test(timeout = 4000)
  public void test046()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-1976400000));
      long long0 = dateTimeZone0.convertUTCToLocal(97L);
      assertEquals("-549:00", dateTimeZone0.getID());
      assertEquals((-1976399903L), long0);
  }

  @Test(timeout = 4000)
  public void test047()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("Australia/Sydney");
      int int0 = dateTimeZone0.getOffsetFromLocal((-2435L));
  ...
  public void test048()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      String string0 = fixedDateTimeZone0.getShortName(65026L, (Locale) null);
  ...
  public void test049()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes((-1264), 12);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test052()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4, "Asia/Kolkata");
  ...
  public void test054()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("CET");
      long long0 = dateTimeZone0.adjustOffset((-766620000004L), true);
      assertEquals((-766620000004L), long0);
  }
  ...
  public void test060()  throws Throwable  {
      ...
      DateTimeZone dateTimeZone0 = buddhistChronology0.getZone();
      long long0 = dateTimeZone0.getMillisKeepLocal((DateTimeZone) null, 1666L);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
  ...
  public void test062()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Illegal instant due to time zone offset transition (daylight savings time 'gap'): -292275055-05-16T16:47:04.292 (America/Anchorage)
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test066()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("Pacific/Apia");
      long long0 = dateTimeZone0.convertLocalToUTC((-1517L), true, 9223372036854775807L);
      assertEquals(39598483L, long0);
  }
  ...
  public void test067()  throws Throwable  {
      GJChronology gJChronology0 = GJChronology.getInstanceUTC();
      DateTimeZone dateTimeZone0 = gJChronology0.getZone();
      DateTimeZone dateTimeZone1 = DateTimeZone.forOffsetMillis((-2189));
      long long0 = dateTimeZone1.getMillisKeepLocal(dateTimeZone0, 0L);
      assertEquals("-00:00:02.189", dateTimeZone1.toString());
  ...
  public void test074()  throws Throwable  {
      ...
      boolean boolean0 = dateTimeZone0.isStandardOffset((-4334L));
  ...
  public void test084()  throws Throwable  {
      ...
      DateTimeZone dateTimeZone1 = DateTimeZone.forOffsetMillis((-1313));
      assertSame(dateTimeZone1, dateTimeZone0);
      assertEquals("-00:00:01.313", dateTimeZone1.toString());
  }
  ...
  public void test086()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "m*b0=z&j");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The datetime zone id 'm*b0=z&j' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test087()  throws Throwable  {
      UTCProvider uTCProvider0 = new UTCProvider();
      DateTimeZone.setProvider(uTCProvider0);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3552, "IET");
      // Undeclared exception!
      try { 
        DateTimeZone.forTimeZone(simpleTimeZone0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test090()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(578, 398);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test092()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(0, (-199750818));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: -199750818
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test109()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      String string0 = fixedDateTimeZone0.getShortName(151L);
      assertEquals("+00:00", string0);
  }
}
