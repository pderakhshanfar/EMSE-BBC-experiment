...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("yy8wHd^KDH$k4", timeZone0, locale1);
      try { 
        fastDateParser0.parseObject("yy8wHd^KDH$k4");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // (The ja_JP_JP_#u-ca-japanese locale does not support dates before 1868 AD)
         // Unparseable date: \"yy8wHd^KDH$k4\" does not match (\\p{IsNd}{2}+)8(\\p{IsNd}{1}+)(\\p{IsNd}{1}+)(\\p{IsNd}++)\\^(\\p{IsNd}{1}+)(\\p{IsNd}{1}+)(\\p{IsNd}++)\\$(\\p{IsNd}{1}+)4
         //
  ...
  public void test06()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-989), "/yyN");
      Locale locale0 = Locale.US;
      FastDateParser fastDateParser0 = new FastDateParser("/yyN", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
      assertEquals("java.util.SimpleTimeZone[id=/yyN,offset=-989,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", timeZone0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(27, ">;n|z\"5;+XUd");
      Locale locale0 = Locale.JAPANESE;
      FastDateParser fastDateParser0 = new FastDateParser(">;n|z\"5;+XUd", simpleTimeZone0, locale0);
      // Undeclared exception!
      try { 
        fastDateParser0.parse(">;n|z\"5;+XUd", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test13()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("6+`WZ", timeZone0, locale1);
      FastDateParser fastDateParser1 = new FastDateParser("41j", timeZone0, locale1);
      LinkedList<Locale.LanguageRange> linkedList0 = new LinkedList<Locale.LanguageRange>();
      ParsePosition parsePosition0 = new ParsePosition((-1));
      FastDateParser fastDateParser2 = new FastDateParser("6+`WZ", timeZone0, locale0);
  }
  ...
  public void test16()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ITALIAN;
      FastDateParser fastDateParser0 = new FastDateParser("ySrEJc?", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("34]=4FKTJb^GHSi%i/");
  ...
  public void test24()  throws Throwable  {
      ...
      Locale locale0 = Locale.US;
      FastDateParser fastDateParser0 = new FastDateParser("/yyN", simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-2944));
      // Undeclared exception!
      try { 
        fastDateParser0.parseObject("/yyN", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test27()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.US;
      FastDateParser fastDateParser0 = new FastDateParser("GMj?TE", timeZone0, locale0);
  ...
  public void test30()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2704, "D+|E+|F+|G+|H+|K+|M+|S+|W+|Z+|a+|d+|h+|k+|m+|s+|w+|y+|z+|''|'[^']++(''[^']*+)*+'|[^'A-Za-z]++");
  ...
  public void test35()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1712, "GMTNT");
      Locale locale0 = Locale.CHINA;
      FastDateParser fastDateParser0 = new FastDateParser("GMTNT", simpleTimeZone0, locale0);
      TimeZone timeZone0 = TimeZone.getTimeZone("");
      FastDateParser fastDateParser1 = new FastDateParser("GMTNT", timeZone0, locale0);
      boolean boolean0 = fastDateParser0.equals(fastDateParser1);
      assertFalse(boolean0);
  }
  ...
  public void test36()  throws Throwable  {
      ...
      Locale locale0 = Locale.FRANCE;
      FastDateParser fastDateParser0 = new FastDateParser("37&n[w*", timeZone0, locale0);
      FastDateParser fastDateParser1 = new FastDateParser("ZS0{-D<JonC&?o`3G0", timeZone0, locale0);
  ...
  public void test37()  throws Throwable  {
      ...
      Locale locale0 = Locale.US;
      FastDateParser fastDateParser0 = new FastDateParser("GMj?TE", timeZone0, locale0);
      boolean boolean0 = fastDateParser0.equals("GMj?TE");
      assertFalse(boolean0);
  }
  ...
  public void test39()  throws Throwable  {
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      TimeZone timeZone0 = TimeZone.getTimeZone("D+|E+|F+|G+|H+|K+|M+|S+|G+|Z+|a+|d+|h+|k+|m+|sU|w+|y+|z+|''|'[^']++(''[^']*I)*+'|[^'A-=az]++");
      FastDateParser fastDateParser0 = null;
      try {
  ...
  public void test43()  throws Throwable  {
      ...
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
      assertEquals("_e", timeZone0.getID());
  }
  ...
  public void test49()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser("du].OoMHM", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      fastDateParser0.parse("1H:\"(Xh_\"", parsePosition0);
  ...
  public void test51()  throws Throwable  {
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      TimeZone timeZone0 = TimeZone.getTimeZone("D+|E+|F+|G+|H+|K+|M+|S+|G+|Z+|a+|d+|h+|k+|m+|sU|w+|y+|z+|''|'[^']++(''[^']*I)*+'|[^'A-=az]++");
      FastDateParser fastDateParser0 = new FastDateParser("D+|E+|F+|G+|H+|K+|M+|S+|G+|Z+|a+|d+|h+|k+|m+|sU|w+|y+|z+|''|'[^']++(''[^']*I)*+'|[^'A-=az]++", timeZone0, locale0);
      assertEquals("D+|E+|F+|G+|H+|K+|M+|S+|G+|Z+|a+|d+|h+|k+|m+|sU|w+|y+|z+|''|'[^']++(''[^']*I)*+'|[^'A-=az]++", fastDateParser0.getPattern());
  }
}
