...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser(": MA_L)gI&s", simpleTimeZone0, locale0);
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        fastDateParser0.parseObject("ZA4Zd+i", parsePosition0);
  ...
  public void test02()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("8i7+d", timeZone0, locale0);
      // Undeclared exception!
      try { 
  ...
  public void test05()  throws Throwable  {
      ...
      try {
        fastDateParser0 = new FastDateParser("GMTCTT", (TimeZone) null, locale0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test06()  throws Throwable  {
      ...
      Locale locale0 = Locale.GERMAN;
      FastDateParser fastDateParser0 = new FastDateParser("Z?`drNv0&%", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(527);
      parsePosition0.setIndex(1);
      Object object0 = fastDateParser0.parseObject("Z\"c|^_cS7ar)h)47", parsePosition0);
      assertNull(object0);
  }
  ...
  public void test07()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("ZTOQ");
      FastDateParser fastDateParser0 = new FastDateParser("ZTOQ", timeZone0, locale0);
  ...
  public void test09()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("yJ!%W5gT!L]lQ", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("2w(o^Uq1*");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("yJ7pWP5\"0CmlQ", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("760<?;a[e,");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ITALIAN;
      FastDateParser fastDateParser0 = new FastDateParser("Zn,o~ltmh$LvQ$", timeZone0, locale0);
      try { 
  ...
  public void test12()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("FKyyy!");
      FastDateParser fastDateParser0 = new FastDateParser("FKyyy!", timeZone0, locale0);
      assertEquals("FKyyy!", fastDateParser0.getPattern());
  }
  ...
  public void test13()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.GERMANY;
      FastDateParser fastDateParser0 = new FastDateParser("(M(S`,(,R", timeZone0, locale0);
      assertEquals("(M(S`,(,R", fastDateParser0.getPattern());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone(zoneId0);
      Locale locale0 = Locale.GERMANY;
      FastDateParser fastDateParser0 = new FastDateParser("_0zBfvr//NbX/l)", timeZone0, locale0);
  ...
  public void test15()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("?cJ%e8+6:TXjXZoe", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
      assertEquals("", timeZone0.getID());
  }
  ...
  public void test16()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.UK;
      FastDateParser fastDateParser0 = new FastDateParser("=JF=j[uT", timeZone0, locale0);
      assertEquals("=JF=j[uT", fastDateParser0.getPattern());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone(zoneId0);
      Locale locale0 = Locale.GERMANY;
      FastDateParser fastDateParser0 = new FastDateParser("9`0d;Jx.]g5", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-1133));
      // Undeclared exception!
      try { 
        fastDateParser0.parse("FastDateParser[9`0d;Jx.]g5,de_DE,GMT]", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test19()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.GERMAN;
      FastDateParser fastDateParser0 = new FastDateParser("5 ;yyh", timeZone0, locale0);
      assertEquals("5 ;yyh", fastDateParser0.getPattern());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("M1*pIhqrJTDSD", timeZone0, locale0);
      assertEquals("M1*pIhqrJTDSD", fastDateParser0.getPattern());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.TAIWAN;
      FastDateParser fastDateParser0 = new FastDateParser("7y/O%w!l]*Hyj&fH0", timeZone0, locale0);
      assertEquals("7y/O%w!l]*Hyj&fH0", fastDateParser0.getPattern());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone(zoneId0);
      Locale locale0 = Locale.ITALIAN;
      FastDateParser fastDateParser0 = new FastDateParser("-HP0%m6`W8I", timeZone0, locale0);
      // Undeclared exception!
      try { 
        fastDateParser0.parse("z7<", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("2w(o^Uq1*", timeZone0, locale0);
      assertEquals("2w(o^Uq1*", fastDateParser0.getPattern());
  }
  ...
  public void test25()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ITALIAN;
      FastDateParser fastDateParser0 = new FastDateParser("*%)H3=Ho", timeZone0, locale0);
  ...
  public void test26()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getDefault();
      FastDateParser fastDateParser0 = new FastDateParser(" s6yex~8u-}", timeZone0, locale0);
  ...
  public void test28()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("aw[\"ah+0?I5i7z(", timeZone0, locale0);
      assertEquals("aw[\"ah+0?I5i7z(", fastDateParser0.getPattern());
  }
  ...
  public void test29()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.KOREAN;
      FastDateParser fastDateParser0 = new FastDateParser("$}=)=j&[c", timeZone0, locale0);
      // Undeclared exception!
      try { 
        fastDateParser0.parseObject("c$,0i^", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("*hv^t1e*2", timeZone0, locale0);
      try { 
        fastDateParser0.parse("*hv^t1e*2");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // (The ja_JP_JP_#u-ca-japanese locale does not support dates before 1868 AD)
         // Unparseable date: \"*hv^t1e*2\" does not match \\*(\\p{IsNd}++)
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      ...
      try { 
        fastDateParser0.parseObject("i%>Z>R>bu7");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Unparseable date: \"i%>Z>R>bu7\" does not match \\}\\+\\)
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test34()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.UK;
      FastDateParser fastDateParser0 = new FastDateParser(".|aPqiVD", timeZone0, locale0);
      FastDateParser fastDateParser1 = new FastDateParser("@Dkk2fre`BLI", timeZone0, locale0);
      boolean boolean0 = fastDateParser1.equals(fastDateParser0);
      assertFalse(boolean0);
  }
  ...
  public void test35()  throws Throwable  {
      Locale locale0 = Locale.KOREAN;
      TimeZone timeZone0 = TimeZone.getDefault();
      FastDateParser fastDateParser0 = new FastDateParser("^k>-&8y@k&uep", timeZone0, locale0);
      boolean boolean0 = fastDateParser0.equals("^k>-&8y@k&uep");
      assertFalse(boolean0);
  }
  ...
  public void test38()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("hV2(4<q'uVb1c", timeZone0, locale0);
  ...
  public void test39()  throws Throwable  {
      ...
      assertEquals("(n\\. Chr\\.|n\\. Chr\\.|v\\. Chr\\.|v\\. Chr\\.)(\\p{IsNd}++)", pattern0.pattern());
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(749, "4y@.^]:uXV7@TQ+9");
      Locale locale0 = Locale.KOREAN;
      FastDateParser fastDateParser0 = new FastDateParser("4y@.^]:uXV7@TQ+9", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
  ...
  public void test41()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("MrDh@", timeZone0, locale0);
      Object object0 = fastDateParser0.parseObject("31z]<oQD*");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", object0.toString());
  }

  @Test(timeout = 4000)
  public void test42()  throws Throwable  {
      Locale locale0 = new Locale("2w(o^Uq1*", "2w(o^Uq1*");
      TimeZone timeZone0 = TimeZone.getDefault();
      FastDateParser fastDateParser0 = new FastDateParser("wQn5`#z$<WFJ~4<", timeZone0, locale0);
      Locale locale1 = fastDateParser0.getLocale();
      assertEquals("2w(o^uq1*", locale1.getLanguage());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      assertEquals("FastDateParser[: MA_L)gI&s,it,]]", string0);
  }
  ...
  public void test46()  throws Throwable  {
      ...
      Date date0 = fastDateParser0.parse("37 @_#CI9_lYM&{f");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone(zoneId0);
      Locale locale0 = Locale.GERMANY;
      FastDateParser fastDateParser0 = new FastDateParser("WEm)8!d8j%X*j89", timeZone0, locale0);
      assertEquals("WEm)8!d8j%X*j89", fastDateParser0.getPattern());
  }
  ...
  public void test48()  throws Throwable  {
      Locale locale0 = Locale.ITALIAN;
      TimeZone timeZone0 = TimeZone.getDefault();
      FastDateParser fastDateParser0 = new FastDateParser("~HFz7oW#", timeZone0, locale0);
      String string0 = fastDateParser0.getPattern();
      assertEquals("~HFz7oW#", string0);
  }
}
