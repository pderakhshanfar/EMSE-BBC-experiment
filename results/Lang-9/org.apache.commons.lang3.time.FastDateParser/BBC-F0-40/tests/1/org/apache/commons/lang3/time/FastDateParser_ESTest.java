...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("4VI> z82[|tnf");
      FastDateParser fastDateParser0 = new FastDateParser("4VI> z82[|tnf", timeZone0, locale0);
      Object object0 = fastDateParser0.parseObject("4VI> z82[|tnf");
  ...
  public void test02()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1442, "");
      FastDateParser fastDateParser0 = new FastDateParser("6buRXtrk'v}<:", simpleTimeZone0, locale0);
  ...
  public void test03()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-44), "GMTECT");
  ...
  public void test04()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getDefault();
      FastDateParser fastDateParser0 = new FastDateParser("74}|`a2X", timeZone0, locale0);
  ...
  public void test07()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("=Z`51L1~%[VM8<)");
      Locale locale0 = Locale.CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("D+|E+|F+|G+|H+|K+|M+|S+|W+|Z+|a+|d+|h+|k+|m+|s+|w+|y+|z+|''|'[^']++(''[^']*+)*+'|[^'A-Za-z]++", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(93);
      // Undeclared exception!
      try { 
        fastDateParser0.parse("fW]uIr}~&g%_}M", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test08()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("(Fa9@3j/LI_r>@d", timeZone0, locale0);
      // Undeclared exception!
      try { 
        fastDateParser0.parse("(Fa9@3j/LI_r>@d", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("=Z`51L1~%[VM8<)", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(93);
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("4VI> z82[|tnf", timeZone0, locale0);
      fastDateParser0.parseObject("4VI> z82[|tnf", parsePosition0);
      fastDateParser0.parse("4VI> z82[|tnf", parsePosition0);
  ...
  public void test12()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("mAd71$}3`9.F&/", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      fastDateParser0.parse("6@SS!-dp2,", parsePosition0);
      assertEquals("java.text.ParsePosition[index=1,errorIndex=-1]", parsePosition0.toString());
      assertEquals(1, parsePosition0.getIndex());
  }
  ...
  public void test13()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("Gh{`l", timeZone0, locale0);
      try { 
        fastDateParser0.parse("Gh{`l");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // (The ja_JP_JP_#u-ca-japanese locale does not support dates before 1868 AD)
         // Unparseable date: \"Gh{`l\" does not match (\u7D00\u5143\u524D|\u7D00\u5143\u524D|\u897F\u66A6|\u897F\u66A6)(\\p{IsNd}++)\\{`
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("4VI> z82[|Mtnf");
      FastDateParser fastDateParser0 = new FastDateParser("@U$qaC&zcn", timeZone0, locale0);
      assertEquals("@U$qaC&zcn", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone(">=f_<*-C w8oEs");
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser(">=f_<*-C w8oEs", timeZone0, locale0);
      assertEquals(">=f_<*-C w8oEs", fastDateParser0.getPattern());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag("_\"G=!!73I");
      FastDateParser fastDateParser0 = new FastDateParser("_\"G=!!73I", timeZone0, locale0);
      assertEquals("_\"G=!!73I", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      ZoneOffset zoneOffset0 = ZoneOffset.MAX;
      Locale locale0 = new Locale("0eD|kP9qV8v'aDG3");
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      FastDateParser fastDateParser0 = new FastDateParser("D#a<potk<ThM'eum_", timeZone0, locale0);
      assertEquals("D#a<potk<ThM'eum_", fastDateParser0.getPattern());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser(";+vxz@SFptemmR4", timeZone0, locale0);
      assertEquals(";+vxz@SFptemmR4", fastDateParser0.getPattern());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser(":0Y{ZHZh3#O4??", timeZone0, locale0);
      assertEquals(":0Y{ZHZh3#O4??", fastDateParser0.getPattern());
  }
  ...
  public void test22()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CANADA_FRENCH;
      FastDateParser fastDateParser0 = new FastDateParser("5U88", timeZone0, locale0);
      try { 
        fastDateParser0.parse("6\"OIW7\".h&e[izL");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Unparseable date: \"6\"OIW7\".h&e[izL\" does not match 5
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("4VI> z82[|tnf");
      FastDateParser fastDateParser0 = new FastDateParser("S3u\u0006,38^j/f9y", timeZone0, locale0);
      assertEquals("S3u\u0006,38^j/f9y", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("otFdr");
      Locale locale0 = new Locale("(The ");
      FastDateParser fastDateParser0 = new FastDateParser("0eD|kP9qV8v'aDG3", timeZone0, locale0);
      assertEquals("0eD|kP9qV8v'aDG3", fastDateParser0.getPattern());
  }
  ...
  public void test25()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CANADA_FRENCH;
      FastDateParser fastDateParser0 = new FastDateParser("/E2cwS", timeZone0, locale0);
      assertEquals("/E2cwS", fastDateParser0.getPattern());
  }
  ...
  public void test27()  throws Throwable  {
      Locale locale0 = new Locale("0eD|kP9qV8v'aDG3");
      TimeZone timeZone0 = TimeZone.getTimeZone("-gS5+9%9OZdAKp*A}<");
      FastDateParser fastDateParser0 = new FastDateParser("-gS5+9%9OZdAKp*A}<", timeZone0, locale0);
      assertEquals("-gS5+9%9OZdAKp*A}<", fastDateParser0.getPattern());
  }
  ...
  public void test29()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CANADA_FRENCH;
      FastDateParser fastDateParser0 = new FastDateParser("*s7uckBI-(w", timeZone0, locale0);
      assertEquals("*s7uckBI-(w", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      Locale locale0 = Locale.CHINESE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "/O}he/Zf[U");
  ...
  public void test31()  throws Throwable  {
      ...
      int int0 = fastDateParser0.adjustYear((-4207));
  ...
  public void test32()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.GERMAN;
      FastDateParser fastDateParser0 = new FastDateParser("8'5;~R^a;ZO?`(v |]\"z", timeZone0, locale0);
  ...
  public void test33()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser("D+|E+|E+|G+|H+|K+|M+|S+|W+|Z+|a+|d+|h+|k+|m+|s+|w+]y+|z+|''|'[^']++(<'[^']*+)*&'|[^'A-Za-z]++", timeZone0, locale0);
      // Undeclared exception!
      try { 
  ...
  public void test34()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("yy?%RQaML;u)Ps", timeZone0, locale0);
      int int0 = fastDateParser0.adjustYear(748);
  ...
  public void test35()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("{\"u9-I]~f", timeZone0, locale0);
      ZoneOffset zoneOffset0 = ZoneOffset.ofHours(0);
      TimeZone timeZone1 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      FastDateParser fastDateParser1 = new FastDateParser("{\"u9-I]~f", timeZone1, locale0);
  ...
  public void test40()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("WzmiN;ds;}Ye", timeZone0, locale0);
  ...
  public void test43()  throws Throwable  {
      ...
      fastDateParser0.parseObject("mAd71$}3`9.F&/", parsePosition0);
  ...
  public void test44()  throws Throwable  {
      ...
      assertEquals("FastDateParser[mAd71$}3`9.F&/,de,GMT]", string0);
  }
  ...
  public void test45()  throws Throwable  {
      ...
      Locale locale0 = Locale.GERMAN;
      FastDateParser fastDateParser0 = new FastDateParser("mAd71$}3`9.F&/", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("6=`t_@SS!-p2,");
  ...
  public void test46()  throws Throwable  {
      ...
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("MIT", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("4LIwn'5cBqi-");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CANADA_FRENCH;
      FastDateParser fastDateParser0 = new FastDateParser("1DWPmUQn@NNa", timeZone0, locale0);
      assertEquals("1DWPmUQn@NNa", fastDateParser0.getPattern());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      FastDateParser fastDateParser1 = new FastDateParser("kG", timeZone0, locale1);
      boolean boolean0 = fastDateParser0.equals(fastDateParser1);
      assertFalse(boolean0);
  }
