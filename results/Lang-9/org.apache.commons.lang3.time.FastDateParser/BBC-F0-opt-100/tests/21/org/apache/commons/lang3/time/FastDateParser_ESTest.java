...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "}+)", 0, 0, 0, 0, 0, 0, 0, 2588, 14);
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("}+)", simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(1);
      Object object0 = fastDateParser0.parseObject("kQ}6NzgyeiK~T>J", parsePosition0);
      assertNull(object0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("{Jk+h4NfuucVL1![5", timeZone0, locale0);
  ...
  public void test03()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("D{Jl$$OpC@?Ll^O0", timeZone0, locale0);
  ...
  public void test04()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "+O", 0, 0, 0, 0, 0, 0, 0, 2588, 14);
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
  ...
  public void test07()  throws Throwable  {
      ...
      Locale locale0 = new Locale("%[/Zp's:kTA", "mSNDy~b7e&5");
      FastDateParser fastDateParser0 = new FastDateParser("%[/Zp's:kTA", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(43);
      // Undeclared exception!
      try { 
        fastDateParser0.parse("mSNDy~b7e&5", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test11()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "GMTAET", 0, 0, 0, 0, 92, 0, 92, 108);
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("^`yz9x2k/p/X:", simpleTimeZone0, locale0);
      Date date0 = fastDateParser0.parse("GWazV 5x`s9GH=f<&", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getDefault();
      FastDateParser fastDateParser0 = new FastDateParser("`t.l.#b>", timeZone0, locale0);
      assertEquals("`t.l.#b>", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      TimeZone timeZone0 = TimeZone.getTimeZone("D{Jl$$OpC@?Ll^O0");
      FastDateParser fastDateParser0 = new FastDateParser("_9**Y*N84z", timeZone0, locale0);
      assertEquals("_9**Y*N84z", fastDateParser0.getPattern());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("@\"pHFaB0[Co", timeZone0, locale0);
      assertEquals("@\"pHFaB0[Co", fastDateParser0.getPattern());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser(">Gy>:;b_iV)mfzYs,-X", timeZone0, locale0);
      assertEquals(">Gy>:;b_iV)mfzYs,-X", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(87, "M(<P-\"tm");
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser("<V+87lD9L16-K= &#`", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
  ...
  public void test17()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CANADA;
      FastDateParser fastDateParser0 = new FastDateParser(":1Sl_ ,ZH|M}u", timeZone0, locale0);
      assertEquals(":1Sl_ ,ZH|M}u", fastDateParser0.getPattern());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone(zoneId0);
      Locale locale0 = new Locale("%[/Zp's:kTA", "mSNDy~b7e&5");
      FastDateParser fastDateParser0 = new FastDateParser("^0>H7C.ZNBw(", timeZone0, locale0);
      try { 
        fastDateParser0.parseObject("dM01kp,A'>@/|qT{F");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Unparseable date: \"dM01kp,A'>@/|qT{F\" does not match \\^0>(\\p{IsNd}{1}+)7
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(94, "gDd5*oe:nepf~})'>O");
      FastDateParser fastDateParser0 = new FastDateParser("4sG6`R-]!}", simpleTimeZone0, locale0);
      assertEquals("4sG6`R-]!}", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("mSNDy~b7e&5", "=!z^`>\"i");
      FastDateParser fastDateParser0 = new FastDateParser("5!k3`i(7", timeZone0, locale0);
      assertEquals("5!k3`i(7", fastDateParser0.getPattern());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("2'z1[$!oI", simpleTimeZone0, locale0);
      assertEquals("2'z1[$!oI", fastDateParser0.getPattern());
  }
  ...
  public void test22()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("069H/q|v", timeZone0, locale0);
      assertEquals("069H/q|v", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("#tA>O@Z4z!+xAR");
      Locale locale0 = Locale.FRENCH;
  ...
  public void test24()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("EG-~K$y8V+Cez3", timeZone0, locale0);
      assertEquals("EG-~K$y8V+Cez3", fastDateParser0.getPattern());
  }
  ...
  public void test25()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CANADA;
      FastDateParser fastDateParser0 = new FastDateParser(",F[>6~?7V ", timeZone0, locale0);
      int int0 = fastDateParser0.adjustYear(1111);
  ...
  public void test26()  throws Throwable  {
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      TimeZone timeZone0 = TimeZone.getTimeZone("=!z^`>\"i");
      FastDateParser fastDateParser0 = new FastDateParser("Em)B(p^", timeZone0, locale0);
      assertEquals("Em)B(p^", fastDateParser0.getPattern());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("yyb@I(NY", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("5=}KI\"76vuc8e2");
  ...
  public void test31()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CANADA;
      FastDateParser fastDateParser0 = new FastDateParser("z[a?& d;BW:%PZ9%", timeZone0, locale0);
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.TAIWAN;
      FastDateParser fastDateParser0 = new FastDateParser("a$[ab", timeZone0, locale0);
      assertEquals("a$[ab", fastDateParser0.getPattern());
  }
  ...
  public void test34()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("Ezyyqh_", timeZone0, locale0);
      try { 
  ...
  public void test35()  throws Throwable  {
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      TimeZone timeZone0 = TimeZone.getTimeZone("6nS=f*gHfD");
  ...
  public void test36()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("1wP4G", timeZone1, locale0);
      FastDateParser fastDateParser1 = new FastDateParser("1wP4G", timeZone0, locale0);
      boolean boolean0 = fastDateParser0.equals(fastDateParser1);
      assertFalse(boolean0);
  }
  ...
  public void test38()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("ZByt([P5h6v#ds", timeZone0, locale0);
  ...
  public void test40()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = null;
      try {
        fastDateParser0 = new FastDateParser("LR)x*8ZOmPS}Mi", timeZone0, locale0);
  ...
  public void test45()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("ZByLt([P5h64Wv#ds", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(1);
  ...
  public void test46()  throws Throwable  {
      ...
      assertEquals("FastDateParser[}+),zh_CN,}+)]", string0);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      Date date0 = fastDateParser0.parse("5,T");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      fastDateParser0.parse("9P*v;{'eH", parsePosition0);
  ...
  public void test50()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1658), "GWazV 5x`s9GH=f<&");
      Locale locale0 = new Locale("GWazV 5x`s9GH=f<&", "GWazV 5x`s9GH=f<&");
      FastDateParser fastDateParser0 = new FastDateParser("GWazV 5x`s9GH=f<&", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
