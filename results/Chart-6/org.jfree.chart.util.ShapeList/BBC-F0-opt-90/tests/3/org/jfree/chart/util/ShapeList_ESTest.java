...
public class ShapeList_ESTest extends ShapeList_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ShapeList shapeList0 = new ShapeList();
      Rectangle2D.Double rectangle2D_Double0 = new Rectangle2D.Double((-3104), 0.0, (-693.86), (-693.86));
      // Undeclared exception!
      try { 
        shapeList0.setShape((-3104), rectangle2D_Double0);
  ...
  public void test2()  throws Throwable  {
      ShapeList shapeList0 = new ShapeList();
      shapeList0.set(2754, shapeList0);
      // Undeclared exception!
      try { 
        shapeList0.getShape(2754);
