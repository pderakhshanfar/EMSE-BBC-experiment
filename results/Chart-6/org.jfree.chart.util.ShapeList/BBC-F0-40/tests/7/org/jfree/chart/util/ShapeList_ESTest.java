...
public class ShapeList_ESTest extends ShapeList_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ShapeList shapeList0 = new ShapeList();
      Point point0 = new Point(8, 17);
      Dimension dimension0 = new Dimension((-1471), 8);
      Rectangle rectangle0 = new Rectangle(point0, dimension0);
      // Undeclared exception!
      try { 
        shapeList0.setShape((-459), rectangle0);
  ...
  public void test6()  throws Throwable  {
      ShapeList shapeList0 = new ShapeList();
      Rectangle rectangle0 = new Rectangle(0, 8, 8, 8);
