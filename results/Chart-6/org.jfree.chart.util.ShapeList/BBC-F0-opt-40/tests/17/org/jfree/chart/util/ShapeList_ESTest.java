...
public class ShapeList_ESTest extends ShapeList_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Rectangle2D.Double rectangle2D_Double0 = new Rectangle2D.Double(1.0, 0, 1536.0, (-1.0));
  ...
  public void test1()  throws Throwable  {
      ShapeList shapeList0 = new ShapeList();
      Rectangle2D.Float rectangle2D_Float0 = new Rectangle2D.Float(8, (-1055.12F), (-499), 1.0F);
      Rectangle rectangle0 = new Rectangle(0, 8);
      Rectangle2D rectangle2D0 = rectangle0.createUnion(rectangle2D_Float0);
      // Undeclared exception!
      try { 
        shapeList0.setShape((-499), rectangle2D0);
  ...
  public void test3()  throws Throwable  {
      ...
      Rectangle2D.Float rectangle2D_Float0 = new Rectangle2D.Float(8, 8, 8, 65535);
      Point point0 = new Point();
      Dimension dimension0 = new Dimension(65535, 0);
