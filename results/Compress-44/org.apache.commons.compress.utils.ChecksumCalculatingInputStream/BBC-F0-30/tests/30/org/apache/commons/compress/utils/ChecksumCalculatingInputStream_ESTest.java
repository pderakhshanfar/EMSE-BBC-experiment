...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[3];
      cRC32_0.update((int) (byte) (-13));
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      long long0 = checksumCalculatingInputStream0.getValue();
      assertEquals(4139142187L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip(5078L);
  ...
  public void test06()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 3905);
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip((-3156L));
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)45, 1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 3797, (int) (byte) (-37));
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-3964), (-1));
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-5176), 2910);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0);
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-1), (-1301));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test18()  throws Throwable  {
      ...
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (-4853), (int) (byte) (-128));
      assertEquals((-1), int0);
  }
  ...
  public void test25()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[3];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1988), (byte)21);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read();
