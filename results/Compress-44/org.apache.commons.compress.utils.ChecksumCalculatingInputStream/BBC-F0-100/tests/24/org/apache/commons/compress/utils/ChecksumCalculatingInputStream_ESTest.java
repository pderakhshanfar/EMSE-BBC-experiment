...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      File file0 = MockFile.createTempFile("u,[j)pmib<,RyB{b", (String) null);
  ...
  public void test09()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[9];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-5), 1679);
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.skip((-468L));
  ...
  public void test10()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, pipedInputStream0);
      try { 
        checksumCalculatingInputStream0.skip((byte) (-102));
  ...
  public void test13()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[9];
      File file0 = MockFile.createTempFile("org.apache.commons.compress.utils.ChecksumCalculatingInputStream", "!F76V`ZS{_\".EF(b?`");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 3866, (-3912));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test14()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-60), 2982);
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[9];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 1, (int) (byte) (-31));
      assertEquals(0, int0);
      assertEquals(1L, checksumCalculatingInputStream0.getValue());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[9];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (-1), (int) (byte)15);
      assertEquals((-1), int0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 566, 1611);
