...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals(2555943L, checksumCalculatingInputStream0.getValue());
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 1, (-1245));
  ...
  public void test06()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-51), 400);
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.skip(222L);
  ...
  public void test09()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[9];
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-1), (int) (byte)105);
        fail("Expecting exception: IOException");
  ...
  public void test11()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 433);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0);
  ...
  public void test14()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 3611);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read();
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-682), (-682));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test20()  throws Throwable  {
      ...
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 85, (int) (byte)66);
      assertEquals((-1), int0);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-109), 1);
