...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals(3484811241L, checksumCalculatingInputStream0.getValue());
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals(1507351L, checksumCalculatingInputStream0.getValue());
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip((byte) (-10));
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 453, (int) (byte)47);
  ...
  public void test13()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[6];
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-74), 146);
        fail("Expecting exception: IOException");
  ...
  public void test19()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[3];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1136, (byte) (-124));
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
  ...
  public void test21()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[5];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 1, 16);
      assertEquals((-1), int0);
  }
  ...
  public void test24()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[3];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-99), 6);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      long long0 = checksumCalculatingInputStream0.getValue();
      assertEquals(0L, long0);
  }
  ...
  public void test26()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-538), (byte)1);
