...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals(1073898489L, checksumCalculatingInputStream0.getValue());
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip((-394L));
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)44, (int) (byte)44);
        fail("Expecting exception: NullPointerException");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-571), 2340);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-1039), (int) (byte)0);
  ...
  public void test10()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[6];
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 1, (-3589));
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-1), 2858);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read();
  ...
  public void test21()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      checksumCalculatingInputStream0.read(byteArray0);
      long long0 = checksumCalculatingInputStream0.skip(1802L);
      assertEquals(0, byteArrayInputStream0.available());
