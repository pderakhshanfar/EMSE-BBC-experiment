...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      File file0 = MockFile.createTempFile("O_3`a%kY?}`\"bitR\"w", "org.apache.commons.compress.utils.ChecksumCalculatingInputStream");
  ...
  public void test04()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      PipedInputStream pipedInputStream0 = new PipedInputStream(2990);
  ...
  public void test08()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, pipedInputStream0);
      try { 
        checksumCalculatingInputStream0.skip((-872L));
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-302), 0);
  ...
  public void test11()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[5];
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-54), 37);
        fail("Expecting exception: IOException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-38), (int) (byte)0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test18()  throws Throwable  {
      ...
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (int) (byte)25, 861);
      assertEquals((-1), int0);
  }
  ...
  public void test25()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[8];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-60), (byte)8);
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(byteArrayInputStream0, 859);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, pushbackInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0);
