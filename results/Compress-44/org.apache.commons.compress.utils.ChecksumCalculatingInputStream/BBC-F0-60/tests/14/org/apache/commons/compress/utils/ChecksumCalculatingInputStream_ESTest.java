...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals(4151131437L, checksumCalculatingInputStream0.getValue());
  ...
  public void test02()  throws Throwable  {
      ...
      assertEquals(1404893504L, checksumCalculatingInputStream0.getValue());
  ...
  public void test03()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      File file0 = MockFile.createTempFile("Im/3{]M", "Im/3{]M");
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip((-450L));
  ...
  public void test06()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, mockFileInputStream0);
      try { 
        checksumCalculatingInputStream0.skip((-1070L));
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 1012, 1831);
        fail("Expecting exception: NullPointerException");
  ...
  public void test08()  throws Throwable  {
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 0, 826);
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 826, (int) (byte) (-111));
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-2834), (int) (byte)0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test10()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, mockFileInputStream0);
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)0, 7);
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 2798);
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-111), 826);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream((Checksum) null, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read();
  ...
  public void test18()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[4];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 0, (-499));
      assertEquals(0, int0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[4];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 4370, 1);
      assertEquals((-1), int0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 0, 826);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream((Checksum) null, byteArrayInputStream0);
      byteArrayInputStream0.skip(1279L);
      int int0 = checksumCalculatingInputStream0.read();
      assertEquals((-1), int0);
  }
