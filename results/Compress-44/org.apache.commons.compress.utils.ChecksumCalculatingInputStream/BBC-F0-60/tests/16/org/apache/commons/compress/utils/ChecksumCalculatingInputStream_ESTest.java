...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip(2241L);
  ...
  public void test07()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-3674), 1);
  ...
  public void test08()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, pipedInputStream0);
      try { 
        checksumCalculatingInputStream0.skip(1963L);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)0, (int) (byte) (-3));
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-77), (int) (byte) (-77));
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[3];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 1487, (int) (byte) (-122));
      assertEquals((-1), int0);
  }
  ...
  public void test21()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-136), (-1));
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      int int0 = checksumCalculatingInputStream0.read();
      assertEquals((-1), int0);
  ...
  public void test23()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1, 528);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      byteArrayInputStream0.skip(528);
      int int0 = checksumCalculatingInputStream0.read(byteArray0);
      assertEquals((-1), int0);
  }
