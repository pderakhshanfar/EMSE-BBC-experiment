...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-3043), 1302);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip(1494L);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-918), (int) (byte)0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 0, 1301);
  ...
  public void test12()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      MockFile mockFile0 = new MockFile("/p.JL<", "/p.JL<");
      File file0 = MockFile.createTempFile("h7Sj?OwTF", "", (File) mockFile0);
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-121), (-983));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test21()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[5];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (int) (byte)17, (int) (byte)0);
      assertEquals((-1), int0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      checksumCalculatingInputStream0.read();
      long long0 = checksumCalculatingInputStream0.skip(131073L);
