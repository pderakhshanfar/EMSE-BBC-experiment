...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals(3527620255L, checksumCalculatingInputStream0.getValue());
  ...
  public void test05()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      checksumCalculatingInputStream0.read(byteArray0, (int) (byte)1, 6);
      checksumCalculatingInputStream0.skip(0L);
      int int0 = checksumCalculatingInputStream0.read();
      assertEquals(589826L, checksumCalculatingInputStream0.getValue());
      assertEquals(1, int0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(dataInputStream0, 1458);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, bufferedInputStream0);
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 2447, (-741));
  ...
  public void test12()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("@%z*", "4", (File) mockFile0);
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-5072), (int) (byte)0);
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 6, (-335));
        fail("Expecting exception: IOException");
  ...
  public void test17()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[9];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 273);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read();
  ...
  public void test20()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, sequenceInputStream0);
      byte[] byteArray0 = new byte[8];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (-1), (int) (byte) (-114));
      assertEquals((-1), int0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(sequenceInputStream0, 5492);
  ...
  public void test23()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-115), 222);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0);
  ...
  public void test24()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-58), 169);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.skip(2436L);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
