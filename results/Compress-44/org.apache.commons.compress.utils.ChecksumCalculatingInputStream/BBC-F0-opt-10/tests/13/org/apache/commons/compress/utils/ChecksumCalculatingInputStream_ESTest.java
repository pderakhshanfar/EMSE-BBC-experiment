...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(10158233L, checksumCalculatingInputStream0.getValue());
  ...
  public void test07()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[8];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 3214);
  ...
  public void test09()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      File file0 = MockFile.createTempFile("fxXp=NlJPABK(wY", "fxXp=NlJPABK(wY");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 544, (-1));
  ...
  public void test15()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 3109);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read();
  ...
  public void test16()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      PipedInputStream pipedInputStream0 = new PipedInputStream(4189);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, pipedInputStream0);
      try { 
        checksumCalculatingInputStream0.read();
        fail("Expecting exception: IOException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 4231, (int) (byte)0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test19()  throws Throwable  {
      ...
      int int0 = checksumCalculatingInputStream0.read((byte[]) null, (-1689), (-3052));
      assertEquals((-1), int0);
  }
  ...
  public void test24()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-128), 1296);
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(byteArrayInputStream0);
