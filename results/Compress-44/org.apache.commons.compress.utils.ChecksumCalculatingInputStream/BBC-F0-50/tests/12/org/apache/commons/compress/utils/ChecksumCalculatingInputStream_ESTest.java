...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)1, 620);
      ...
      long long0 = checksumCalculatingInputStream0.skip((byte) (-23));
      assertEquals(252678980L, checksumCalculatingInputStream0.getValue());
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals(2830809034L, checksumCalculatingInputStream0.getValue());
      assertEquals(6, int0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-1), 1776);
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.skip(1776);
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip(484);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-2598), 0);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 2406, (-457));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test12()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream((InputStream) null, 554);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, pushbackInputStream0);
      byte[] byteArray0 = new byte[0];
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 1, (-1566));
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      File file0 = MockFile.createTempFile("Yn+Hp!)NAuHTq", "Yn+Hp!)NAuHTq");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, mockFileInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read((byte[]) null, 4387, 0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      MockFile mockFile0 = new MockFile("y*^uT]FRJF OuV(5K=&");
      File file0 = MockFile.createTempFile("rJSf", "rJSf", (File) mockFile0);
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
  ...
  public void test22()  throws Throwable  {
      ...
      long long0 = checksumCalculatingInputStream0.skip((-6190));
  ...
  public void test23()  throws Throwable  {
      ...
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(enumeration0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, sequenceInputStream0);
      long long0 = checksumCalculatingInputStream0.skip((-985L));
  ...
  public void test25()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[9];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-88), 2137);
