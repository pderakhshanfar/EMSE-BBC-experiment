...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1, 481);
      ...
      long long0 = checksumCalculatingInputStream0.skip((-1961L));
  ...
  public void test01()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-252), 876);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(16318713L, checksumCalculatingInputStream0.getValue());
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.skip(65537L);
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip((-624L));
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 0, (-3713));
  ...
  public void test11()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[7];
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-209), 58);
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 1079);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0);
  ...
  public void test18()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 0, (-1312));
  ...
  public void test19()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[1];
      File file0 = MockFile.createTempFile("^JJ;LC\u0005o*Q='i*@u7`", "");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-1), (-4057));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test20()  throws Throwable  {
      ...
      int int0 = checksumCalculatingInputStream0.read((byte[]) null, 3104, (-1885));
      assertEquals((-1), int0);
  }
