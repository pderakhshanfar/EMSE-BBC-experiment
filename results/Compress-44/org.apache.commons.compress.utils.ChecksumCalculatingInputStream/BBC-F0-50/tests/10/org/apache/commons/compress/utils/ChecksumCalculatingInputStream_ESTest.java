...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-59), 75);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.skip((-313L));
  ...
  public void test09()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      MockFile mockFile0 = new MockFile("", "vd*bT=~WW8[~");
      File file0 = MockFile.createTempFile(" alcxCYOS/t", "K:qZ_f</QrjEUK", (File) mockFile0);
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read((byte[]) null, (int) (byte) (-88), (-1));
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 6, (-2102));
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-5164), (-2039));
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-5014), (-5014));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test12()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[3];
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-92), 119);
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-304), (byte)96);
  ...
  public void test18()  throws Throwable  {
      ...
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (-59), (int) (byte)66);
      assertEquals((-1), int0);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1736), 1082);
