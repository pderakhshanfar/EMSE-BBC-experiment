...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("ukD?O_Y*B+", "");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/ukD?O_Y*B+0");
      ...
      long long0 = checksumCalculatingInputStream0.skip(27);
      assertEquals(1483155041L, checksumCalculatingInputStream0.getValue());
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip(909L);
  ...
  public void test07()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 3106);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.skip(71L);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read((byte[]) null, (int) (byte)1, (-703));
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)78, (int) (byte)0);
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-32), 1324);
  ...
  public void test19()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream((Checksum) null, mockFileInputStream0);
      byte[] byteArray0 = new byte[6];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (-1), 1035);
      assertEquals((-1), int0);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-1343), 0);
        fail("Expecting exception: IOException");
