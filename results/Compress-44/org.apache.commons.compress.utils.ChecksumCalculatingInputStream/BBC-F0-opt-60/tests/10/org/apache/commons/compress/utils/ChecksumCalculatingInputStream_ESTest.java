...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals(2094237127L, checksumCalculatingInputStream0.getValue());
  ...
  public void test01()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-701), 766);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.skip(1249L);
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip(3596L);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read((byte[]) null, (int) (byte) (-27), (-1));
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      MockFile mockFile0 = new MockFile((File) null, "M, [^E$3@QJ!");
      File file0 = MockFile.createTempFile("y;Zw9Xo]2t", "y;Zw9Xo]2t", (File) mockFile0);
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 2041, (-2008));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test12()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[7];
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-542), 1);
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      long long0 = checksumCalculatingInputStream0.skip((-612L));
  ...
  public void test21()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[1];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (int) (byte)0, (-1279));
      assertEquals(0, int0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      byteArrayInputStream0.skip(745L);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
  ...
  public void test26()  throws Throwable  {
      ...
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      long long0 = checksumCalculatingInputStream0.skip(1421L);
      assertEquals(0L, long0);
      assertEquals(1L, checksumCalculatingInputStream0.getValue());
  }
}
