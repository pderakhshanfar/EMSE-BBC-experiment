...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      MockFile mockFile0 = new MockFile("zY^J6A.~cz");
      File file0 = MockFile.createTempFile("zY^J6A.~cz", "zY^J6A.~cz", (File) mockFile0);
      ...
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 6, 0);
      assertEquals(0, int0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals(1908338681L, checksumCalculatingInputStream0.getValue());
  ...
  public void test08()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-79), (byte)1);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      try { 
        checksumCalculatingInputStream0.skip((byte)41);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-55), (int) (byte)105);
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)98, 164);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-1), (-1287));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test13()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[6];
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("zY^J6A.~cz/zY^J6A.~cz0zY^J6A.~cz");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 0, 2116);
        fail("Expecting exception: IOException");
  ...
  public void test19()  throws Throwable  {
      ...
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0, 481);
  ...
  public void test23()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[6];
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 1, 164);
