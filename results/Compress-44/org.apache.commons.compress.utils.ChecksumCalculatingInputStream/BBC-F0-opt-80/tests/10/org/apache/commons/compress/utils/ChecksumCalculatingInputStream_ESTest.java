...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-813), 0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-1679), (-1625));
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)0, 169);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-537), 2288);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0);
  ...
  public void test22()  throws Throwable  {
      ...
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 1951, (-1));
      assertEquals((-1), int0);
  }
  ...
  public void test27()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      File file0 = MockFile.createTempFile("pH5D0S=?4@X/SmZ", "pH5D0S=?4@X/SmZ");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[5];
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-122), (int) (byte) (-34));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
