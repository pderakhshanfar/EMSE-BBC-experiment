...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("$UBb e#^wG-5P*gdK8`", "");
      ...
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 1, (-557));
  ...
  public void test05()  throws Throwable  {
      ...
      checksumCalculatingInputStream0.skip((-86L));
      int int0 = checksumCalculatingInputStream0.read();
      assertEquals(362061355L, checksumCalculatingInputStream0.getValue());
  ...
  public void test08()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-1), 4608);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip((-1395L));
  ...
  public void test21()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      File file0 = MockFile.createTempFile("$UBb e#^wG-5P*gdK8`", (String) null);
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[3];
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 132, (int) (byte)0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test23()  throws Throwable  {
      ...
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      long long0 = checksumCalculatingInputStream0.skip(991L);
      assertEquals(0L, long0);
      assertEquals(1L, checksumCalculatingInputStream0.getValue());
  }
