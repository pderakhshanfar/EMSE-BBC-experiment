...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      MockFile mockFile0 = new MockFile("=9<XLD@F", "S^qhh;");
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip((-1492L));
  ...
  public void test07()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[0];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-3637), 8);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.skip((-3637));
  ...
  public void test10()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1545, 0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 1545, (int) (byte) (-1));
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)15, (-348));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 5, 3);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2524), 34);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read();
  ...
  public void test17()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[4];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 1424, (int) (byte)0);
      assertEquals((-1), int0);
  }
