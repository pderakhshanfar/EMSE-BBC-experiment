...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals(2359332L, checksumCalculatingInputStream0.getValue());
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-7), (-862));
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      File file0 = MockFile.createTempFile("zix$#;aAX$_6", "zix$#;aAX$_6");
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-2823), (int) (byte)0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 0, 1676);
        fail("Expecting exception: IOException");
  ...
  public void test18()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      MockFile mockFile0 = new MockFile("^RO5$*6LZo");
      File file0 = MockFile.createTempFile("^RO5$*6LZo", "d4:u{(}q$@7`bH++`j", (File) mockFile0);
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
  ...
  public void test20()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[9];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (int) (byte)0, (int) (byte)10);
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)72, (int) (byte) (-18));
