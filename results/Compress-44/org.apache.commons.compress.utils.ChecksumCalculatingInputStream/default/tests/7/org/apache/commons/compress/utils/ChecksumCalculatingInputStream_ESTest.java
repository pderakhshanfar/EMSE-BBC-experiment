...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[1];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 1, (-806));
      assertEquals(0, int0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals(16711935L, checksumCalculatingInputStream0.getValue());
  ...
  public void test07()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, dataInputStream0);
      try { 
        checksumCalculatingInputStream0.skip(160L);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 247, (int) (byte)0);
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.read((byte[]) null, 1760, 1760);
        fail("Expecting exception: IOException");
  ...
  public void test18()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[1];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 3549, (-3787));
      assertEquals((-1), int0);
  }
  ...
  public void test22()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      File file0 = MockFile.createTempFile("izt@mp", "izt@mp");
  ...
  public void test24()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-2), 32);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0);
