...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      long long0 = checksumCalculatingInputStream0.skip((-806L));
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("r5(IA!\",", "Tc$01'");
  ...
  public void test04()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      File file0 = MockFile.createTempFile("r5(IA!\",", "]EHR1J@CCc!p|R");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, mockFileInputStream0);
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip((-1102L));
  ...
  public void test06()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1771), (byte)4);
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.skip((-1771));
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read((byte[]) null, (int) (byte) (-124), (int) (byte) (-124));
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 1752, (-2334));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test11()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, mockFileInputStream0);
      try { 
        checksumCalculatingInputStream0.read((byte[]) null, 218, 218);
        fail("Expecting exception: IOException");
  ...
  public void test18()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[5];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (-435), (int) (byte)51);
      assertEquals((-1), int0);
  }
  ...
  public void test23()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[0];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-978), (-2237));
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      long long0 = checksumCalculatingInputStream0.skip((-2237));
      assertEquals(0L, long0);
      assertEquals(0L, checksumCalculatingInputStream0.getValue());
  }
