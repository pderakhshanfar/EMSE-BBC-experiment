...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      long long0 = checksumCalculatingInputStream0.skip((-2129));
  ...
  public void test03()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-528), (byte) (-2));
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(byteArrayInputStream0, byteArrayInputStream0);
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip((-1256L));
  ...
  public void test07()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[9];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1250), (byte)10);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip(2817L);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 0, (int) (byte) (-27));
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 2304, (-198));
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-88), 865);
  ...
  public void test11()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      MockFile mockFile0 = new MockFile("]l{Pou");
      File file0 = MockFile.createTempFile("'A&75Fo2/HtFs ,V\"F", "r:*+wgIzM)", (File) mockFile0);
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 725, (-1760));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test22()  throws Throwable  {
      ...
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(byteArrayInputStream0, byteArrayInputStream0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, sequenceInputStream0);
      long long0 = checksumCalculatingInputStream0.skip((-528));
      assertEquals(0L, long0);
  ...
  public void test24()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, sequenceInputStream0);
      int int0 = checksumCalculatingInputStream0.read();
      int int1 = checksumCalculatingInputStream0.read(byteArray0, (-5464), (-1));
      assertEquals(0L, checksumCalculatingInputStream0.getValue());
