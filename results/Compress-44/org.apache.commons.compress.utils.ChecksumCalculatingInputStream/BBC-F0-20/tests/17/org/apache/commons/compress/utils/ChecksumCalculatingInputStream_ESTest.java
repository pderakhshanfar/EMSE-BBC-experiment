...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-344), 3);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
  ...
  public void test04()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      File file0 = MockFile.createTempFile("MdeEi$|n'#2/!", "_0u");
  ...
  public void test06()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-1), 2574);
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.skip(2473L);
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        checksumCalculatingInputStream0.skip(1053);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, 2, 93);
  ...
  public void test10()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      File file0 = MockFile.createTempFile("tR`AqR6CTn9JiRuM", "org.apache.commons.compress.utils.ChecksumCalculatingInputStream");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)42, (-1737));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test19()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[7];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 1, (-2101));
      assertEquals(0, int0);
  ...
  public void test20()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[7];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (int) (byte)42, 2744);
      assertEquals((-1), int0);
  }
  ...
  public void test23()  throws Throwable  {
      byte[] byteArray0 = new byte[2];
      CRC32 cRC32_0 = new CRC32();
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1240), (byte) (-125));
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      int int0 = checksumCalculatingInputStream0.read(byteArray0);
      assertEquals((-1), int0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      long long0 = checksumCalculatingInputStream0.skip(3935L);
