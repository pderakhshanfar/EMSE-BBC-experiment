...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals(1048591L, checksumCalculatingInputStream0.getValue());
  ...
  public void test08()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 108);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.skip(3735L);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-1), (int) (byte) (-29));
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-1986), (int) (byte) (-98));
  ...
  public void test12()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[2];
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)86, (int) (byte)86);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = new byte[3];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-125), (byte)10);
  ...
  public void test19()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      File file0 = MockFile.createTempFile("-U-W)", "");
      ...
      // Undeclared exception!
      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-4147), (-4147));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test21()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      checksumCalculatingInputStream0.read();
      checksumCalculatingInputStream0.skip(1186L);
      int int0 = checksumCalculatingInputStream0.read(byteArray0);
      assertEquals(131073L, checksumCalculatingInputStream0.getValue());
      assertEquals((-1), int0);
  }
