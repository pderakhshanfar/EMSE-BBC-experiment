...
public class Week_ESTest extends Week_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals(1635, week0.getYearValue());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      MockDate mockDate0 = new MockDate(3, 366, 2958465, 91, (-2305), 3);
      Year year0 = new Year(mockDate0);
      Week week0 = new Week(91, year0);
      RegularTimePeriod regularTimePeriod0 = week0.next();
      assertEquals(1392409281319L, week0.getLastMillisecond());
      assertNull(regularTimePeriod0);
      assertEquals(531840L, week0.getSerialIndex());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      assertEquals((-277L), week0.getLastMillisecond());
  }
  ...
  public void test47()  throws Throwable  {
      Year year0 = new Year();
      MockDate mockDate0 = new MockDate(32, 32, 855);
      Locale locale0 = Locale.FRANCE;
      Week week0 = new Week(mockDate0, year0.DEFAULT_TIME_ZONE, locale0);
      assertEquals((-1041292800001L), week0.getLastMillisecond());
  ...
  public void test52()  throws Throwable  {
      MockDate mockDate0 = new MockDate(0, 0, 2958408, 0, 0, 0);
      Year year0 = new Year(mockDate0);
      Week week0 = new Week(2958408, year0);
      RegularTimePeriod regularTimePeriod0 = week0.next();
      assertEquals(1392409281319L, week0.getLastMillisecond());
      assertNull(regularTimePeriod0);
