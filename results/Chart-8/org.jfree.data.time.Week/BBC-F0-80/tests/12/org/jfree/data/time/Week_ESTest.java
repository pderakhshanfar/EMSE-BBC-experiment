...
public class Week_ESTest extends Week_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      Week week0 = new Week((-2215), (-2215));
      int int0 = week0.getYearValue();
      assertEquals((-117306L), week0.getSerialIndex());
      assertEquals(1392409281319L, week0.getLastMillisecond());
  ...
  public void test08()  throws Throwable  {
      ...
      System.setCurrentTimeMillis((-1858L));
      week0.getYear();
  ...
  public void test17()  throws Throwable  {
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=-1858,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=2,minimalDaysInFirstWeek=4,ERA=1,YEAR=1969,MONTH=11,WEEK_OF_YEAR=1,WEEK_OF_MONTH=5,DAY_OF_MONTH=31,DAY_OF_YEAR=365,DAY_OF_WEEK=4,DAY_OF_WEEK_IN_MONTH=5,AM_PM=1,HOUR=11,HOUR_OF_DAY=23,MINUTE=59,SECOND=58,MILLISECOND=142,ZONE_OFFSET=0,DST_OFFSET=0]", mockGregorianCalendar0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals((-1262L), week0.getLastMillisecond());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Year constructor: year (388) outside valid range.
         //
  ...
  public void test33()  throws Throwable  {
      // Undeclared exception!
      try { 
        Week.parseWeek("ZAx`%I=bVQ,zQdA2h");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test40()  throws Throwable  {
      Week week0 = new Week();
      Locale locale0 = Locale.CANADA_FRENCH;
      MockDate mockDate0 = new MockDate((-2067L));
      ...
      assertEquals((-2068L), week2.getLastMillisecond());
  }
  ...
  public void test43()  throws Throwable  {
      Week week0 = new Week((-4238), 10009);
      RegularTimePeriod regularTimePeriod0 = week0.next();
      assertEquals(530591L, week0.getSerialIndex());
      assertEquals(1392409281319L, week0.getLastMillisecond());
      assertNull(regularTimePeriod0);
  }
  ...
  public void test44()  throws Throwable  {
      MockDate mockDate0 = new MockDate(46, 0, (-2919), 46, 1614);
  ...
  public void test46()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-4583), (-4583), (-4583), (-4583), (-4583));
      TimeZone timeZone0 = TimeZone.getTimeZone(" ");
      Locale locale0 = Locale.ITALIAN;
      Week week0 = new Week(mockDate0, timeZone0, locale0);
      Calendar calendar0 = MockCalendar.getInstance(timeZone0);
      week0.getFirstMillisecond(calendar0);
      assertEquals((-159301567380001L), week0.getLastMillisecond());
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=1392409281320,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2014,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=45,DAY_OF_WEEK=6,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=8,HOUR_OF_DAY=20,MINUTE=21,SECOND=21,MILLISECOND=320,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
      assertEquals(163186L, week0.getSerialIndex());
  }
  ...
  public void test48()  throws Throwable  {
      Week week0 = new Week();
      MockDate mockDate0 = new MockDate(9, 1, (-1269), 1, 22);
      Week week1 = null;
      try {
  ...
  public void test51()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(53, (-1098), 0);
      week0.getFirstMillisecond((Calendar) mockGregorianCalendar0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=53,MONTH=-1098,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=0,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
  ...
  public void test52()  throws Throwable  {
      ...
      RegularTimePeriod regularTimePeriod0 = week0.previous();
      assertNotNull(regularTimePeriod0);
      assertEquals((-117307L), regularTimePeriod0.getSerialIndex());
      assertEquals(1392409281319L, regularTimePeriod0.getLastMillisecond());
  }
