...
public class UnionContext_ESTest extends UnionContext_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        jXPathContextReferenceImpl0.removeAll("", (Expression) coreOperationDivide0);
  ...
  public void test02()  throws Throwable  {
      ...
      AncestorContext ancestorContext1 = new AncestorContext(evalContextArray0[1], true, nodeNameTest0);
      evalContextArray0[2] = (EvalContext) ancestorContext1;
      DescendantContext descendantContext1 = new DescendantContext(ancestorContext1, true, nodeNameTest0);
      evalContextArray0[3] = (EvalContext) descendantContext1;
      descendantContext1.getSingleNodePointer();
      UnionContext unionContext0 = new UnionContext(initialContext0, evalContextArray0);
      // Undeclared exception!
      try { 
        unionContext0.setPosition(1573);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Undefined variable: }j/(`_0Y
         //
  ...
  public void test05()  throws Throwable  {
      ...
      QName qName0 = new QName("h_pnt+", "h_pnt+");
      NodeNameTest nodeNameTest0 = new NodeNameTest(qName0);
  ...
  public void test07()  throws Throwable  {
      BasicNodeSet basicNodeSet0 = new BasicNodeSet();
      NodeSetContext nodeSetContext0 = new NodeSetContext((EvalContext) null, basicNodeSet0);
      QName qName0 = new QName("<82f,o+G~W%pn", "<82f,o+G~W%pn");
      NodeNameTest nodeNameTest0 = new NodeNameTest(qName0);
      DescendantContext descendantContext0 = new DescendantContext(nodeSetContext0, false, nodeNameTest0);
      AncestorContext ancestorContext0 = new AncestorContext(descendantContext0, true, nodeNameTest0);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        unionContext0.setPosition((-2368));
        fail("Expecting exception: NullPointerException");
