...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("kAYVh`BktZ--]'?}F#");
      Locale locale0 = Locale.CANADA_FRENCH;
      FastDateParser fastDateParser0 = new FastDateParser("kAYVh`BktZ--]'?}F#", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(1);
      fastDateParser0.parseObject("30E_d|9re{}D+", parsePosition0);
  ...
  public void test03()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(382, "GMTJST");
      FastDateParser fastDateParser0 = new FastDateParser("sE7>[~X{_PX|DY=", simpleTimeZone0, locale0);
  ...
  public void test04()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3362), "30E_d|9re{}D+");
      FastDateParser fastDateParser0 = new FastDateParser("30E_d|9re{}D+", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
  ...
  public void test05()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("D>k/@{\"$S|hUIhuK", timeZone0, locale0);
  ...
  public void test06()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("$y7rCY>sDCl$O6[", timeZone0, locale0);
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("Z~6SpjKGy93Y7!M", timeZone0, locale0);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      String string0 = "DVp&";
      Locale locale1 = new Locale("", "DVp&", "");
      String string1 = "Gze1eou";
      FastDateParser fastDateParser0 = new FastDateParser("Gze1eou", timeZone0, locale0);
      FastDateParser fastDateParser1 = new FastDateParser("Gze1eou", timeZone0, locale1);
      try { 
  ...
  public void test11()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("Z'RBw@$0`", timeZone0, locale0);
      assertEquals("Z'RBw@$0`", fastDateParser0.getPattern());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Locale locale0 = Locale.JAPAN;
      FastDateParser fastDateParser0 = new FastDateParser("`aL/Hg:Y", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(3);
      Date date0 = fastDateParser0.parse("`aL/Hg:Y", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("zB3e*.%K?>n9ZeBL{", timeZone0, locale0);
  ...
  public void test14()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3362), "30E_d|9re{}D+");
      FastDateParser fastDateParser0 = new FastDateParser("30E_d|9re{}D+", simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-3362));
      // Undeclared exception!
      try { 
        fastDateParser0.parse("kAYVh`BktZ--]'?}F#", parsePosition0);
  ...
  public void test16()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("<Pd|yq.eCaO", timeZone0, locale0);
      assertEquals("<Pd|yq.eCaO", fastDateParser0.getPattern());
  }
  ...
  public void test17()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.JAPAN;
      FastDateParser fastDateParser0 = new FastDateParser(":k2wkE%y\"_Bt`", timeZone0, locale0);
      assertEquals(":k2wkE%y\"_Bt`", fastDateParser0.getPattern());
  }
  ...
  public void test18()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("6TX0m4WAeR4", timeZone0, locale0);
      assertEquals("6TX0m4WAeR4", fastDateParser0.getPattern());
  }
  ...
  public void test19()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("");
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("5[m;ywEz*JZ_l", timeZone0, locale0);
      assertEquals("5[m;ywEz*JZ_l", fastDateParser0.getPattern());
  }
  ...
  public void test20()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CANADA;
      FastDateParser fastDateParser0 = new FastDateParser(".)m4:t`m)", timeZone0, locale0);
      assertEquals(".)m4:t`m)", fastDateParser0.getPattern());
  }
  ...
  public void test21()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("Km");
      Locale locale0 = Locale.ITALY;
      FastDateParser fastDateParser0 = new FastDateParser("(a2tH(e1c", timeZone0, locale0);
      assertEquals("(a2tH(e1c", fastDateParser0.getPattern());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getDefault();
      FastDateParser fastDateParser0 = new FastDateParser("1C`<0|}v|Btl~VI", timeZone0, locale0);
      assertEquals("1C`<0|}v|Btl~VI", fastDateParser0.getPattern());
  }
  ...
  public void test23()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("Km");
      Locale locale0 = Locale.ITALY;
      FastDateParser fastDateParser0 = new FastDateParser("E0>f${)~Ftk?uakc@", timeZone0, locale0);
      assertEquals("E0>f${)~Ftk?uakc@", fastDateParser0.getPattern());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("}MH8!y-&", timeZone0, locale0);
      assertEquals("}MH8!y-&", fastDateParser0.getPattern());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser(",yyu`{[lI;B,_A'2?", timeZone0, locale0);
      assertEquals(",yyu`{[lI;B,_A'2?", fastDateParser0.getPattern());
  }
  ...
  public void test27()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("z/0_E#!)EBVV3^_", timeZone0, locale0);
      assertEquals("z/0_E#!)EBVV3^_", fastDateParser0.getPattern());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      int int0 = fastDateParser0.adjustYear((-2608));
  ...
  public void test29()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.JAPAN;
      FastDateParser fastDateParser0 = new FastDateParser("?SX2-|x&m0`;J\"4;/{6", timeZone0, locale0);
      assertEquals("?SX2-|x&m0`;J\"4;/{6", fastDateParser0.getPattern());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fastDateParser0.parse("|Qn\"g]34+{4&3Xwq", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ITALY;
      FastDateParser fastDateParser0 = new FastDateParser(";-hyW;D  L/", timeZone0, locale0);
      int int0 = fastDateParser0.adjustYear((-61));
  ...
  public void test34()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("d@^1``,aTP=,Fn0VPTy");
      FastDateParser fastDateParser0 = new FastDateParser("d@^1``,aTP=,Fn0VPTy", timeZone0, locale0);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3332, "d@^1``,aTP=,Fn0VPTy");
      FastDateParser fastDateParser1 = new FastDateParser("d@^1``,aTP=,Fn0VPTy", simpleTimeZone0, locale0);
      boolean boolean0 = fastDateParser0.equals(fastDateParser1);
      assertFalse(boolean0);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      Locale locale0 = Locale.JAPAN;
      FastDateParser fastDateParser0 = new FastDateParser("^)", timeZone0, locale0);
      FastDateParser fastDateParser1 = new FastDateParser("[g%a[Oaga+wm", timeZone0, locale0);
      boolean boolean0 = fastDateParser0.equals(fastDateParser1);
      assertFalse(boolean0);
  }
  ...
  public void test39()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.forLanguageTag("hIj+]Ca");
      FastDateParser fastDateParser0 = new FastDateParser("hIj+]Ca", timeZone0, locale0);
      Object object0 = fastDateParser0.parseObject("5m|)CE5~iL.zYYJ");
  ...
  public void test41()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("9i7wa`kS9/A", timeZone0, locale0);
      try { 
        ...
        fail("Expecting exception: ParseException");
         ...
         //
         // Unparseable date: \"PNT\" does not match 9
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test44()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag("hIj+]Ca");
      FastDateParser fastDateParser0 = new FastDateParser("hIj+]Ca", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(4056);
      // Undeclared exception!
      try { 
        fastDateParser0.parseObject("35@#JO@+N.7", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test45()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.FRANCE;
      FastDateParser fastDateParser0 = new FastDateParser(" #D.l7_hO|;)lIKb*@", timeZone0, locale0);
      String string0 = fastDateParser0.toString();
      assertEquals("FastDateParser[ #D.l7_hO|;)lIKb*@,fr_FR,GMT]", string0);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      fastDateParser0.parse("9NM0qU2o2<:06:di=", parsePosition0);
  ...
  public void test48()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.JAPAN;
      FastDateParser fastDateParser0 = new FastDateParser("GFZ/f!", timeZone0, locale0);
      assertEquals("GFZ/f!", fastDateParser0.getPattern());
  }
