...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("5gI<MJ^t~JU$E7lNi[:", timeZone0, locale0);
  ...
  public void test01()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("5gI<MJ^t~JU$E7lNi[:", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      fastDateParser0.parseObject("5gI<MJ^t~JU$E7lNi[:", parsePosition0);
  ...
  public void test03()  throws Throwable  {
      ...
      Locale locale0 = Locale.KOREA;
      FastDateParser fastDateParser0 = new FastDateParser("+:KA*Za~OkTrD", timeZone0, locale0);
  ...
  public void test04()  throws Throwable  {
      Locale locale0 = Locale.KOREA;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "GMT", 3, 0, 0, 0, 0, 3, 0, 0, 3);
  ...
  public void test05()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1, ".LYy_;ZF");
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser(".LYy_;ZF", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
  ...
  public void test06()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3178), "GMTCNT");
      Locale locale0 = Locale.JAPAN;
      FastDateParser fastDateParser0 = new FastDateParser("zxQdG!", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
  ...
  public void test07()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("?`nwsb]=z8\"6uw");
      Locale locale0 = Locale.UK;
      FastDateParser fastDateParser0 = new FastDateParser("?`nwsb]=z8\"6uw", timeZone0, locale0);
  ...
  public void test08()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("");
      Locale locale0 = Locale.ITALY;
      FastDateParser fastDateParser0 = new FastDateParser("+Wcb]H}[F", timeZone0, locale0);
  ...
  public void test09()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("M%4J-|3");
      Locale locale0 = Locale.KOREA;
      FastDateParser fastDateParser0 = new FastDateParser("M%4J-|3", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(1401);
      // Undeclared exception!
      try { 
        fastDateParser0.parse("r9L=N", parsePosition0);
  ...
  public void test13()  throws Throwable  {
      TimeZone.getTimeZone("Z-9L1otj9MZ9HTK!");
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.US;
      Locale locale1 = locale0.stripExtensions();
      FastDateParser fastDateParser0 = new FastDateParser("Z-9L1otj9MZ9HTK!", timeZone0, locale1);
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ParseException");
         ...
         //
         // Unparseable date: \"GMT\" does not match (\uAE30\uC6D0\uC804|\uAE30\uC6D0\uC804|\uC11C\uAE30|\uC11C\uAE30)(\\p{IsNd}++)
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.US;
      FastDateParser fastDateParser0 = new FastDateParser("D0Hm`AyYWe9HMus", timeZone0, locale0);
      assertEquals("D0Hm`AyYWe9HMus", fastDateParser0.getPattern());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Locale locale0 = Locale.KOREA;
      FastDateParser fastDateParser0 = new FastDateParser("k5s@7", timeZone0, locale0);
  }
  ...
  public void test21()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("");
      Locale locale0 = Locale.KOREA;
      FastDateParser fastDateParser0 = new FastDateParser("=w_]X", timeZone0, locale0);
      assertEquals("=w_]X", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("Z-9L1otj9MZ9HTK!");
      Locale locale0 = Locale.US;
      FastDateParser fastDateParser0 = new FastDateParser("<vNN:w.", timeZone0, locale0);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("");
      Locale locale0 = Locale.KOREA;
      FastDateParser fastDateParser0 = new FastDateParser(":7ANP", timeZone0, locale0);
      assertEquals(":7ANP", fastDateParser0.getPattern());
  }
  ...
  public void test24()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.US;
      FastDateParser fastDateParser0 = new FastDateParser("9o?H,lE'OI", timeZone0, locale0);
      assertEquals("9o?H,lE'OI", fastDateParser0.getPattern());
  }
  ...
  public void test28()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.JAPAN;
      FastDateParser fastDateParser0 = new FastDateParser("ZH2k7^N8GR", timeZone0, locale0);
      assertEquals("ZH2k7^N8GR", fastDateParser0.getPattern());
  }
  ...
  public void test29()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("");
      Locale locale0 = Locale.KOREA;
      FastDateParser fastDateParser0 = new FastDateParser("1]f//06>q+YOuCg]y2", timeZone0, locale0);
      assertEquals("1]f//06>q+YOuCg]y2", fastDateParser0.getPattern());
  }
  ...
  public void test30()  throws Throwable  {
      Locale locale0 = Locale.KOREA;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "GMT", 3, 0, 0, 0, 0, 3, 0, 0, 3);
      FastDateParser fastDateParser0 = new FastDateParser("7S.|=k^U3j", simpleTimeZone0, locale0);
      assertEquals("7S.|=k^U3j", fastDateParser0.getPattern());
  }
  ...
  public void test31()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("Z-9L1otj9MZ9HTK!");
      Locale locale0 = Locale.US;
      FastDateParser fastDateParser0 = new FastDateParser("Z-9L1otj9MZ9HTK!", timeZone0, locale0);
  ...
  public void test35()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(28, "D+|E+|F+|G+|H+|K+|M+|S+|W+|Z+|a+|d+|h+|k+|m+|s+|w+|y+|z+|''|'[^']++(''v^']*+)6+'|[^'A-Za-z]++");
      Locale locale1 = Locale.UK;
      FastDateParser fastDateParser1 = new FastDateParser("D+|E+|F+|G+|H+|K+|M+|S+|W+|Z+|a+|d+|h+|k+|m+|s+|w+|y+|z+|''|'[^']++(''v^']*+)6+'|[^'A-Za-z]++", simpleTimeZone0, locale1);
  }
  ...
  public void test36()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ParseException");
         ...
         // Unparseable date: \"BET\" does not match ,
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test38()  throws Throwable  {
      Locale locale0 = Locale.JAPAN;
      TimeZone timeZone0 = TimeZone.getTimeZone("$/yyG/[&!~3d");
      FastDateParser fastDateParser0 = new FastDateParser("$/yyG/[&!~3d", timeZone0, locale0);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(92, "$/yyG/[&!~3d");
      FastDateParser fastDateParser1 = new FastDateParser("$/yyG/[&!~3d", simpleTimeZone0, locale0);
      boolean boolean0 = fastDateParser0.equals(fastDateParser1);
      assertFalse(boolean0);
  }
  ...
  public void test42()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = null;
      try {
        fastDateParser0 = new FastDateParser("Jn$KeOK)uCxUc", simpleTimeZone0, locale0);
  ...
  public void test43()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("Mv-ECT", timeZone0, locale0);
  ...
  public void test44()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("E?sE5,*/y", timeZone0, locale0);
  ...
  public void test45()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser("z>  WcL5-8Yg[tW", timeZone0, locale0);
      try { 
  ...
  public void test47()  throws Throwable  {
      ...
      Locale locale0 = Locale.KOREA;
      ParsePosition parsePosition0 = new ParsePosition((-1));
      FastDateParser fastDateParser0 = new FastDateParser("3E_}$C5U7l*4rpgNS", timeZone0, locale0);
      // Undeclared exception!
      try { 
        fastDateParser0.parseObject("3E_}$C5U7l*4rpgNS", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test48()  throws Throwable  {
      ...
      assertEquals("FastDateParser[GMTECT,en_US,GMT]", string0);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(0);
      FastDateParser fastDateParser0 = new FastDateParser("dgDo-GqC)@", timeZone0, locale0);
      fastDateParser0.parse("9o?H,lE'OI", parsePosition0);
      assertEquals(1, parsePosition0.getIndex());
      assertEquals("java.text.ParsePosition[index=1,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("Mv-ECT", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      fastDateParser0.parse("8^4brkB", parsePosition0);
      assertEquals(1, parsePosition0.getIndex());
      assertEquals("java.text.ParsePosition[index=1,errorIndex=-1]", parsePosition0.toString());
  }
