...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("Ko:i", simpleTimeZone0, locale0);
  ...
  public void test02()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "Ko:i", 3, 3, 3, 3, 3, 3, 3, 3);
      Locale locale0 = new Locale(">");
      FastDateParser fastDateParser0 = new FastDateParser("Ko:i", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
      assertEquals("java.util.SimpleTimeZone[id=Ko:i,offset=3,dstSavings=3600000,useDaylight=true,startYear=0,startMode=2,startMonth=3,startDay=3,startDayOfWeek=3,startTime=3,startTimeMode=0,endMode=2,endMonth=3,endDay=3,endDayOfWeek=3,endTime=3,endTimeMode=0]", timeZone0.toString());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      int int0 = fastDateParser0.adjustYear((-3897));
  ...
  public void test05()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("h6aDc`wQAt{7\"x*0", timeZone0, locale0);
      try { 
        fastDateParser0.parseObject("h6aDc`wQAt{7\"x*0");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Unparseable date: \"h6aDc`wQAt{7\"x*0\" does not match (\\p{IsNd}{1}+)6(AM|PM)(\\p{IsNd}++)
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fastDateParser0.parse("IST", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("1>4G+%st^!9.=R*", timeZone0, locale0);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("GM~zTC-AT", timeZone0, locale0);
      Locale locale1 = Locale.ROOT;
      FastDateParser fastDateParser1 = new FastDateParser("GM~zTC-AT", timeZone0, locale1);
      String string0 = "T!d3qCumQ8Rv";
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("1W`{0Q7#r{E<$mN-9", timeZone0, locale0);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser("^#Anhg=@#k3eZI,0>bR", timeZone0, locale0);
      assertEquals("^#Anhg=@#k3eZI,0>bR", fastDateParser0.getPattern());
  }
  ...
  public void test13()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1), "Ko:i");
      Locale locale0 = new Locale("]");
      FastDateParser fastDateParser0 = new FastDateParser("?oM|M41_z`/&fOH*", simpleTimeZone0, locale0);
      assertEquals("?oM|M41_z`/&fOH*", fastDateParser0.getPattern());
  }
  ...
  public void test14()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("dn!");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("w>Z{lk60Bj8,V", timeZone0, locale0);
      assertEquals("w>Z{lk60Bj8,V", fastDateParser0.getPattern());
  }
  ...
  public void test15()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("dn!");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("KdM<FZbjRI:r%<", timeZone0, locale0);
      assertEquals("KdM<FZbjRI:r%<", fastDateParser0.getPattern());
  }
  ...
  public void test16()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CANADA_FRENCH;
      FastDateParser fastDateParser0 = new FastDateParser("_s;M6jnCsexv7S2", timeZone0, locale0);
      assertEquals("_s;M6jnCsexv7S2", fastDateParser0.getPattern());
  }
  ...
  public void test18()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("ddE!G4(tnbBjX-VBV");
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser("9w[=_XDmO5?", timeZone0, locale0);
      assertEquals("9w[=_XDmO5?", fastDateParser0.getPattern());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("w5B9phh7*9it[Jk*}d", timeZone0, locale0);
      assertEquals("w5B9phh7*9it[Jk*}d", fastDateParser0.getPattern());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("ddE!G4(tnbBjX-VBV", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-1033));
      // Undeclared exception!
      try { 
        fastDateParser0.parseObject("ddE!G4(tnbBjX-VBV", parsePosition0);
  ...
  public void test22()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("dn!");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("2s[%qcF4", timeZone0, locale0);
      assertEquals("2s[%qcF4", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("{5WZ&g7");
      Locale locale0 = Locale.PRC;
  ...
  public void test24()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("*nX*/_)~`;2*", timeZone0, locale0);
      assertEquals("*nX*/_)~`;2*", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1), "1>4G+%st^!9.=R*");
      Locale locale0 = new Locale("]");
      FastDateParser fastDateParser0 = new FastDateParser("-; $k)kO)+9k6!j5z~$", simpleTimeZone0, locale0);
      assertEquals("-; $k)kO)+9k6!j5z~$", fastDateParser0.getPattern());
  }
  ...
  public void test26()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.KOREAN;
      FastDateParser fastDateParser0 = new FastDateParser("(.O!GD&1VF<wrKX=#}", timeZone0, locale0);
      assertEquals("(.O!GD&1VF<wrKX=#}", fastDateParser0.getPattern());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Locale locale0 = Locale.CANADA_FRENCH;
      FastDateParser fastDateParser0 = new FastDateParser("1>4G+%st^!9.=R*", timeZone0, locale0);
      int int0 = fastDateParser0.adjustYear((-887));
  ...
  public void test28()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("MMMTIzhjrUR}~", timeZone0, locale0);
      assertEquals("MMMTIzhjrUR}~", fastDateParser0.getPattern());
  }
  ...
  public void test29()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.GERMAN;
      FastDateParser fastDateParser0 = new FastDateParser("=E0%E7^", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      Date date0 = fastDateParser0.parse("=E0%E7^", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("7Kw0@ }ic%ll@I", timeZone0, locale0);
      assertEquals("7Kw0@ }ic%ll@I", fastDateParser0.getPattern());
  }
  ...
  public void test31()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser("&yHy85Aww", timeZone0, locale0);
  ...
  public void test32()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("@?qC0RDq u6:7R[l", timeZone0, locale0);
  ...
  public void test34()  throws Throwable  {
      TimeZone.getDefault();
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("Z", "PLT");
  ...
  public void test35()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(98, "Ko:i");
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("@47/>WU@y~o", simpleTimeZone0, locale0);
      try { 
        fastDateParser0.parse("@47/>WU@y~o");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // (The ja_JP_JP_#u-ca-japanese locale does not support dates before 1868 AD)
         // Unparseable date: \"@47/>WU@y~o\" does not match @47/>(\\p{IsNd}++)
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test37()  throws Throwable  {
      ...
      Locale locale1 = new Locale("GMTVST");
  ...
  public void test38()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(8, "7i=F");
  ...
  public void test39()  throws Throwable  {
      ...
      Locale locale0 = new Locale(">");
      FastDateParser fastDateParser0 = new FastDateParser("Ko:i", simpleTimeZone0, locale0);
      FastDateParser fastDateParser1 = new FastDateParser("FastDateParser[Ko:i,>,Ko:i]", simpleTimeZone0, locale0);
      boolean boolean0 = fastDateParser1.equals(fastDateParser0);
      assertFalse(boolean0);
  }
  ...
  public void test40()  throws Throwable  {
      ...
      boolean boolean0 = fastDateParser0.equals("vEe");
      assertFalse(boolean0);
  }
  ...
  public void test44()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ITALIAN;
      FastDateParser fastDateParser0 = new FastDateParser("/^+]RI,w'", timeZone0, locale0);
  ...
  public void test45()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(24, "B!&~");
      Locale locale0 = new Locale("$Ke|_.2fwq](q[");
      FastDateParser fastDateParser0 = new FastDateParser("$Ke|_.2fwq](q[", simpleTimeZone0, locale0);
  ...
  public void test47()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ITALY;
      FastDateParser fastDateParser0 = new FastDateParser("MT#ET", timeZone0, locale0);
      String string0 = fastDateParser0.toString();
      assertEquals("FastDateParser[MT#ET,it_IT,GMT]", string0);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("dn!", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("2;P");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test50()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("MT#ET", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      fastDateParser0.parse("98z~y(VIx>]", parsePosition0);
  ...
  public void test51()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(34, "Kso:&");
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("Kso:&", simpleTimeZone0, locale0);
  ...
  public void test52()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("{5WZ&g7");
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser("{5WZ&g7", timeZone0, locale0);
      String string0 = fastDateParser0.getPattern();
      assertEquals("{5WZ&g7", string0);
  }
