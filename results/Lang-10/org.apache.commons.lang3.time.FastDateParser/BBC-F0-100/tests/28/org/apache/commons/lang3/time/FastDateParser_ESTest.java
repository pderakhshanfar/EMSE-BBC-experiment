...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser(">?g8y[4]<QvjO<cr", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      fastDateParser0.parseObject(">?g8y[4]<QvjO<cr", parsePosition0);
  ...
  public void test02()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("{bAMh;L t8!tf@1fzl", timeZone0, locale0);
  ...
  public void test03()  throws Throwable  {
      ...
      Locale locale0 = new Locale("", "hFA=Sz@jKR", "");
      FastDateParser fastDateParser0 = new FastDateParser("hFA=Sz@jKR", simpleTimeZone0, locale0);
  ...
  public void test05()  throws Throwable  {
      ...
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser("y@Aw|K&D|C8$m'O@Z", simpleTimeZone0, locale0);
      // Undeclared exception!
      try { 
        fastDateParser0.parseObject("MJT8G> ov", (ParsePosition) null);
  ...
  public void test06()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1591), "", 111, 0, (-666), 0, (-666), 0, 327, 111);
      Locale locale0 = Locale.GERMANY;
  ...
  public void test08()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1832), "/&ti/*?.");
  ...
  public void test10()  throws Throwable  {
      ...
      FastDateParser fastDateParser1 = new FastDateParser("5Z<&cn_mYf)IK^\"|b", timeZone0, locale2);
      String string0 = "&9x{r";
  }
  ...
  public void test12()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser(">?g8y[4]<QvjO<cr", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(4);
      Date date0 = fastDateParser0.parse("!.H;(o#-W''/x:<S{{", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test14()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1832), "/&ti/*?.");
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("^&l0K#GEOx", simpleTimeZone0, locale0);
      assertEquals("^&l0K#GEOx", fastDateParser0.getPattern());
  }
  ...
  public void test15()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("=Q@'|22V_27?KR", timeZone0, locale0);
      assertEquals("=Q@'|22V_27?KR", fastDateParser0.getPattern());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser("<P:5y", timeZone0, locale0);
      assertEquals("<P:5y", fastDateParser0.getPattern());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      assertEquals(";Ms*!`~", fastDateParser0.getPattern());
  }
  ...
  public void test18()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser("D%a88:1;kv'g]h2<", timeZone0, locale0);
      assertEquals("D%a88:1;kv'g]h2<", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale(">?g8y[4]<QvjO<cr", "CNT", "S|R R");
      FastDateParser fastDateParser0 = new FastDateParser("7I}U]+", timeZone0, locale0);
      assertEquals("7I}U]+", fastDateParser0.getPattern());
  }
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1591), "", 111, 0, (-666), 0, (-666), 0, 327, 111);
      Locale locale0 = new Locale(".K[M2I", "*\u0006{eQ", "*\u0006{eQ");
      FastDateParser fastDateParser0 = new FastDateParser("3LguydJVJfi@M", simpleTimeZone0, locale0);
      assertEquals("3LguydJVJfi@M", fastDateParser0.getPattern());
  }
  ...
  public void test23()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("?Y-kZ>GA");
      Locale locale0 = Locale.KOREA;
      FastDateParser fastDateParser0 = new FastDateParser("1|@O/5Q*#q#9}$p@", timeZone0, locale0);
      assertEquals("1|@O/5Q*#q#9}$p@", fastDateParser0.getPattern());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser("5W0O$=Pgk)c@*k7-Z", timeZone0, locale0);
      assertEquals("5W0O$=Pgk)c@*k7-Z", fastDateParser0.getPattern());
  }
  ...
  public void test27()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1832), "k,A9uh&(rlG~v%,?");
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("k,A9uh&(rlG~v%,?", simpleTimeZone0, locale0);
      assertEquals("k,A9uh&(rlG~v%,?", fastDateParser0.getPattern());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("/&ti/*?.", simpleTimeZone0, locale0);
      int int0 = fastDateParser0.adjustYear((-4369));
      assertEquals((-2369), int0);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2, "4,=%;H_w'p#m", 1, 1, 0, 0, 1, (-1), 1, 0);
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser("4,=%;H_w'p#m", simpleTimeZone0, locale0);
      int int0 = fastDateParser0.adjustYear(1936);
  ...
  public void test31()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale(">?g8y[4]<QvjO<cr", "CNT", "S|R R");
      FastDateParser fastDateParser0 = new FastDateParser("}u!vH$ES", timeZone0, locale0);
      assertEquals("}u!vH$ES", fastDateParser0.getPattern());
  }
  ...
  public void test34()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1832), "/&ti/*?.");
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("d!$ij5OKP9T:<P6]H", simpleTimeZone0, locale0);
      assertEquals("d!$ij5OKP9T:<P6]H", fastDateParser0.getPattern());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser("  pvOmR[op=`C", timeZone0, locale0);
      assertEquals("  pvOmR[op=`C", fastDateParser0.getPattern());
  }
  ...
  public void test36()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1832), "/&ti/*?.");
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("s)z!{L", simpleTimeZone0, locale0);
      assertEquals("s)z!{L", fastDateParser0.getPattern());
  }
  ...
  public void test38()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.KOREA;
      FastDateParser fastDateParser0 = new FastDateParser("yyJ[lw%qyL6dVb/N5", timeZone0, locale0);
      try { 
  ...
  public void test39()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("?Y-kU>GA");
      Locale locale0 = Locale.JAPAN;
      FastDateParser fastDateParser0 = new FastDateParser("?Y-kU>GA", timeZone0, locale0);
      Locale locale1 = Locale.US;
      FastDateParser fastDateParser1 = new FastDateParser("?Y-kU>GA", timeZone0, locale1);
  ...
  public void test40()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(438, "yw|K&C8$m'O@h[");
      FastDateParser fastDateParser0 = new FastDateParser("yw|K&C8$m'O@h[", simpleTimeZone0, locale0);
      FastDateParser fastDateParser1 = new FastDateParser("yw|K&C8$m'O@h[", timeZone0, locale0);
      boolean boolean0 = fastDateParser0.equals(fastDateParser1);
      assertFalse(boolean0);
  }
  ...
  public void test43()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = null;
      try {
        fastDateParser0 = new FastDateParser("tCBL&7A,UCtosU=", timeZone0, locale0);
  ...
  public void test44()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("k=XiiX84:vO*ci\"");
      Locale locale0 = Locale.KOREA;
      FastDateParser fastDateParser0 = new FastDateParser("M", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("7$qfpqP%nr73wIq");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("hAh.Y(3_", timeZone0, locale0);
      Object object0 = fastDateParser0.parseObject("1YIMb");
  ...
  public void test49()  throws Throwable  {
      ...
      assertEquals(">?g8y[4]<QvjO<cr", string0);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      Date date0 = fastDateParser0.parse("1|@O/5Q*#q#9}$p@");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("HPz@", timeZone0, locale0);
      Object object0 = fastDateParser0.parseObject("3W*h(H3F>Y]ZF");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", object0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1591), "", 111, 0, (-666), 0, (-666), 0, 327, 111);
      Locale locale0 = new Locale(".K[M2I", "*\u0006{eQ", "*\u0006{eQ");
      FastDateParser fastDateParser0 = new FastDateParser(":|sa9'b$!o[rnq", simpleTimeZone0, locale0);
  ...
  public void test57()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1591), "", 111, 0, (-666), 0, (-666), 0, 327, 111);
      Locale locale0 = Locale.JAPANESE;
      FastDateParser fastDateParser0 = new FastDateParser("_WZN4URmHXSg", simpleTimeZone0, locale0);
      assertEquals("_WZN4URmHXSg", fastDateParser0.getPattern());
  }
