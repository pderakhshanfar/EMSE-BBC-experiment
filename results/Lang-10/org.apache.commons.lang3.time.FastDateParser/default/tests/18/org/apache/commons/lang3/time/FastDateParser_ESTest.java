...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-382), "(SMMMld");
      Locale locale0 = Locale.CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("(SMMMld", simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(7);
      Object object0 = fastDateParser0.parseObject("(SMMMld", parsePosition0);
      assertNull(object0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      fastDateParser0.parseObject("7]0oD3v_c)", parsePosition0);
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals("java.util.SimpleTimeZone[id=E([c:<)[952<j?cv9\" ,offset=18,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", timeZone0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
      assertEquals("java.util.SimpleTimeZone[id=Greenwich Mean Time,offset=-381,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", timeZone0.toString());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "KM_1[<Au<");
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("KM_1[<Au<", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
  ...
  public void test20()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone("D@K4[[t|r");
      FastDateParser fastDateParser0 = new FastDateParser("Dyy?)\"HG[W.-c", timeZone0, locale0);
      try { 
        fastDateParser0.parse("D@K4[[t|r");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Unparseable date: \"D@K4[[t|r\" does not match (\\p{IsNd}{1}+)(\\p{IsNd}++)\\?\\)\"(\\p{IsNd}++)(ap\\.\\s*+J\\.-C\\.|ap\\.\\s*+J\\.-C\\.|BC|BC)\\[(\\p{IsNd}++)\\.-
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser(" W7k[A", timeZone0, locale0);
      assertEquals(" W7k[A", fastDateParser0.getPattern());
  }
  ...
  public void test27()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("0:wY1");
      FastDateParser fastDateParser0 = new FastDateParser("0:wY1", timeZone0, locale0);
      assertEquals("0:wY1", fastDateParser0.getPattern());
  }
  ...
  public void test31()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.SIMPLIFIED_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("Dyy)06HGWGBc", timeZone0, locale0);
      assertEquals("Dyy)06HGWGBc", fastDateParser0.getPattern());
  }
