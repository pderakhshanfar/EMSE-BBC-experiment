...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      Locale locale0 = Locale.JAPANESE;
      FastDateParser fastDateParser0 = new FastDateParser("^w#+htH>4", timeZone0, locale0);
      assertEquals("^w#+htH>4", fastDateParser0.getPattern());
  }
  ...
  public void test11()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("");
      Locale locale0 = Locale.KOREAN;
      FastDateParser fastDateParser0 = new FastDateParser("#8~m8\\,)\"]-<b8W", timeZone0, locale0);
      assertEquals("#8~m8\\,)\"]-<b8W", fastDateParser0.getPattern());
  }
  ...
  public void test15()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CANADA_FRENCH;
      FastDateParser fastDateParser0 = new FastDateParser("zqXXWMn/U!Q", timeZone0, locale0);
  ...
  public void test16()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("yNz/~t(K", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("2U4;=DP=>");
  ...
  public void test17()  throws Throwable  {
      ...
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
      assertEquals(21069, timeZone0.getRawOffset());
  }
  ...
  public void test19()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.GERMANY;
      FastDateParser fastDateParser0 = new FastDateParser(",y $8-7z7FioR", timeZone0, locale0);
      assertEquals(",y $8-7z7FioR", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("D|E>F+|G+|H^|K+|M+|S+|W+|Z+|a+|d|h+k+|m+ys+|w+y+|z+|''|'^']++(''[^']*+)*+'|[^'A-Za-z]+", "D|E>F+|G+|H^|K+|M+|S+|W+|Z+|a+|d|h+k+|m+ys+|w+y+|z+|''|'^']++(''[^']*+)*+'|[^'A-Za-z]+");
      FastDateParser fastDateParser0 = new FastDateParser("D|E>F+|G+|H^|K+|M+|S+|W+|Z+|a+|d|h+k+|m+ys+|w+y+|z+|''|'^']++(''[^']*+)*+'|[^'A-Za-z]+", timeZone0, locale0);
      assertEquals("D|E>F+|G+|H^|K+|M+|S+|W+|Z+|a+|d|h+k+|m+ys+|w+y+|z+|''|'^']++(''[^']*+)*+'|[^'A-Za-z]+", fastDateParser0.getPattern());
  }
  ...
  public void test22()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ROOT;
      FastDateParser fastDateParser0 = new FastDateParser("<0wYQihj/[z=jhc|O", timeZone0, locale0);
      assertEquals("<0wYQihj/[z=jhc|O", fastDateParser0.getPattern());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("D|E+%F+|G+|H^|K+|M+|S+|W+|Z+|a+|d|h+k+|m+y4+|w+y+|z+|''|'[^']++(''[^']*+)*+'|[^'A-Za-z]+", timeZone0, locale0);
      assertEquals("D|E+%F+|G+|H^|K+|M+|S+|W+|Z+|a+|d|h+k+|m+y4+|w+y+|z+|''|'[^']++(''[^']*+)*+'|[^'A-Za-z]+", fastDateParser0.getPattern());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.ITALIAN;
      FastDateParser fastDateParser0 = new FastDateParser("1sYp+u96B_", timeZone0, locale0);
      assertEquals("1sYp+u96B_", fastDateParser0.getPattern());
  }
  ...
  public void test37()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ITALIAN;
      FastDateParser fastDateParser0 = new FastDateParser("{<?CM8Y", timeZone0, locale0);
      assertEquals("{<?CM8Y", fastDateParser0.getPattern());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("FastDateParser[", timeZone0, locale0);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-994), "(GMT[+-]d{0,1}d{2}|[+-]d{2}:?d{2}|");
  ...
  public void test54()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.FRENCH;
      FastDateParser fastDateParser0 = new FastDateParser("KNz=to", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("24=DPY0_=.>");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }

  @Test(timeout = 4000)
  public void test55()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("Dz5");
      Locale locale0 = Locale.TAIWAN;
      FastDateParser fastDateParser0 = new FastDateParser("Dz5", timeZone0, locale0);
      assertEquals("Dz5", fastDateParser0.getPattern());
  }
}
