...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("$O?nX3Ff7crO0?WJE9c", timeZone0, locale0);
  ...
  public void test02()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("9d\"F+", timeZone0, locale0);
  ...
  public void test03()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "GMTJST", 0, 0, 0, 0, 300, 0, (-1438), 300, 98);
      Locale locale0 = Locale.JAPANESE;
      FastDateParser fastDateParser0 = new FastDateParser("GMTJST", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
      assertEquals("java.util.SimpleTimeZone[id=GMTJST,offset=0,dstSavings=98,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=300,endDay=0,endDayOfWeek=-1438,endTime=300,endTimeMode=0]", timeZone0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Locale locale0 = Locale.GERMAN;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2778), "GMT");
      FastDateParser fastDateParser0 = new FastDateParser("{au:/USUk<!j =", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
      assertEquals((-2778), timeZone0.getRawOffset());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Locale locale0 = Locale.PRC;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(11, "vL#Omn2kyfx5n\"q");
      FastDateParser fastDateParser0 = new FastDateParser(")}Z%.=/;D^4*hI cD", simpleTimeZone0, locale0);
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
  ...
  public void test08()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("azMMT", timeZone0, locale0);
  ...
  public void test10()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("zV@D", timeZone0, locale0);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("wYS4A'jv", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(0);
      fastDateParser0.parse("6YW9&y%", parsePosition0);
  ...
  public void test17()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser(")}Z%.=/;D`^4*hI cD", timeZone0, locale0);
      assertEquals(")}Z%.=/;D`^4*hI cD", fastDateParser0.getPattern());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("@tT)]g]s0h8", timeZone0, locale0);
      assertEquals("@tT)]g]s0h8", fastDateParser0.getPattern());
  }
  ...
  public void test20()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser(">i96", timeZone0, locale0);
      assertEquals(">i96", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2, ")}Z%.=/;D^4*hI cD");
      FastDateParser fastDateParser0 = new FastDateParser("E=y^lJ6s'o dGhNQ0", simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(2);
      Object object0 = fastDateParser0.parseObject("E=y^lJ6s'o dGhNQ0", parsePosition0);
      assertNull(object0);
  }
  ...
  public void test22()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser("<0LK0\"", timeZone0, locale0);
      assertEquals("<0LK0\"", fastDateParser0.getPattern());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser(";MT4WJ4|", timeZone0, locale0);
      assertEquals(";MT4WJ4|", fastDateParser0.getPattern());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.FRENCH;
      FastDateParser fastDateParser0 = new FastDateParser("8k:e]<R9.", timeZone0, locale0);
      assertEquals("8k:e]<R9.", fastDateParser0.getPattern());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser("7#3sUp-tT", timeZone0, locale0);
      assertEquals("7#3sUp-tT", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("9u\">+");
  ...
  public void test27()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser("}{D0L!Nsc", timeZone0, locale0);
      assertEquals("}{D0L!Nsc", fastDateParser0.getPattern());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser(".Ej1S=:)kFB\"4jV*", timeZone0, locale0);
      assertEquals(".Ej1S=:)kFB\"4jV*", fastDateParser0.getPattern());
  }
  ...
  public void test31()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("G,S#26^G)4V\"k$", timeZone0, locale0);
      assertEquals("G,S#26^G)4V\"k$", fastDateParser0.getPattern());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser("?mAq/SFgDYf", timeZone0, locale0);
      assertEquals("?mAq/SFgDYf", fastDateParser0.getPattern());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fastDateParser0.parseObject("k,p", (ParsePosition) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(96, "Kk(\"yy");
      Locale locale0 = Locale.forLanguageTag("Kk(\"yy");
      FastDateParser fastDateParser0 = new FastDateParser("Kk(\"yy", simpleTimeZone0, locale0);
      FastDateParser fastDateParser1 = new FastDateParser("Kk(\"yy", timeZone0, locale0);
  ...
  public void test40()  throws Throwable  {
      ...
      FastDateParser fastDateParser1 = new FastDateParser("5!FS3", timeZone0, locale0);
      boolean boolean0 = fastDateParser0.equals(fastDateParser1);
      assertFalse(boolean0);
  }
  ...
  public void test43()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = null;
      try {
        fastDateParser0 = new FastDateParser("rB", timeZone0, locale0);
  ...
  public void test44()  throws Throwable  {
      ...
      Date date0 = fastDateParser0.parse("4*1=CD");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.GERMAN;
      FastDateParser fastDateParser0 = new FastDateParser("/m4jnyiHe Gnew", timeZone0, locale0);
  ...
  public void test46()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("  pWU6.AA#|", timeZone0, locale0);
  ...
  public void test47()  throws Throwable  {
      ...
      try { 
        fastDateParser0.parseObject(".U*IAOZP0b3jC]wz8Ri");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // (The ja_JP_JP_#u-ca-japanese locale does not support dates before 1868 AD)
         // Unparseable date: \".U*IAOZP0b3jC]wz8Ri\" does not match -\\)
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test50()  throws Throwable  {
      ...
      assertEquals("FastDateParser[  pWU6.AA#|,de_DE,GMT]", string0);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser("9u\">+", timeZone0, locale0);
  ...
  public void test52()  throws Throwable  {
      ...
      Date date0 = fastDateParser0.parse("5\"3-G5K`L>zW");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }

  @Test(timeout = 4000)
  public void test53()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("(8yydW");
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser("(8yydW", timeZone0, locale0);
  ...
  public void test54()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("68[FG2LaiJZ", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition((-1109));
      // Undeclared exception!
      try { 
        fastDateParser0.parseObject("68[FG2LaiJZ", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test55()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      Locale locale0 = Locale.PRC;
      FastDateParser fastDateParser0 = new FastDateParser(")dZ%.=/;6^4*hI cD", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(13);
      Date date0 = fastDateParser0.parse(")dZ%.=/;6^4*hI cD", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test56()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ITALY;
      FastDateParser fastDateParser0 = new FastDateParser("az9MMMT", timeZone0, locale0);
      assertEquals("az9MMMT", fastDateParser0.getPattern());
  }
}
