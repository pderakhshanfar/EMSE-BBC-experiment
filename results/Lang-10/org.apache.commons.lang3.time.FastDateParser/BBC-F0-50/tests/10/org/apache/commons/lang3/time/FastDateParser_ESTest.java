...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2361), "MIT");
      Locale locale0 = Locale.GERMAN;
  ...
  public void test14()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("zx1f`f34", timeZone0, locale0);
  ...
  public void test32()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ENGLISH;
      FastDateParser fastDateParser0 = new FastDateParser("yyR2.52\"ac B$vJ2UgA", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("3\"LdrJ'8");
  ...
  public void test34()  throws Throwable  {
      ...
      assertEquals("a!zacy7ku&", fastDateParser0.getPattern());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("w/  3", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(969);
      // Undeclared exception!
      try { 
        fastDateParser0.parse("w/  3", parsePosition0);
  ...
  public void test43()  throws Throwable  {
      ...
      FastDateParser fastDateParser1 = new FastDateParser("zx1f`f34", timeZone0, locale0);
  ...
  public void test44()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ROOT;
      FastDateParser fastDateParser0 = new FastDateParser("6aob<R-@Dj;bg1OUKcF", timeZone0, locale0);
      FastDateParser fastDateParser1 = new FastDateParser("zx1f`f34", timeZone0, locale0);
      Object object0 = fastDateParser1.parseObject("SST");
  ...
  public void test47()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("D+;E+|F+|G+|H+|K+|M+|S@|W+|Z+|a+|d+|h+|k+|m+|s+|w+y+z+|''|'[^']++(''[^']*+)*+'[^'A-Za-z]+V");
      Locale locale0 = Locale.FRANCE;
      FastDateParser fastDateParser0 = new FastDateParser("MIT", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("6L");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("D+;E+|F+|G+|H+|K+|M+|S@|W+|Z+|a+|d+|h+|k+|m+|s+w+y&z+|''|'[^']+('%[']*+)*+'[^A-Za-z]+V", "D+;E+|F+|G+|H+|K+|M+|S@|W+|Z+|a+|d+|h+|k+|m+|s+w+y&z+|''|'[^']+('%[']*+)*+'[^A-Za-z]+V", "D+;E+|F+|G+|H+|K+|M+|S@|W+|Z+|a+|d+|h+|k+|m+|s+w+y&z+|''|'[^']+('%[']*+)*+'[^A-Za-z]+V");
      FastDateParser fastDateParser0 = new FastDateParser("yyR2.52\"ac B$vJ2UgA", timeZone0, locale0);
      try { 
        fastDateParser0.parseObject("yyR2.52\"ac B$vJ2UgA");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Unparseable date: \"yyR2.52\"ac B$vJ2UgA\" does not match (\\p{IsNd}++)
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test53()  throws Throwable  {
      ...
      assertEquals("FastDateParser[[I'\",de,GMT]", string0);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      fastDateParser0.parse("9YT[+Yu9{\fdQ,-", parsePosition0);
      assertEquals(1, parsePosition0.getIndex());
      assertEquals("java.text.ParsePosition[index=1,errorIndex=-1]", parsePosition0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.ROOT;
      FastDateParser fastDateParser0 = new FastDateParser("Hhx+EKjOP1]v2mXSj", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("28cn:Eg");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
