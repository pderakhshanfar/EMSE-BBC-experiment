...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("zfO4p", timeZone0, locale0);
      int int0 = fastDateParser0.adjustYear(352);
  ...
  public void test14()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getDefault();
      FastDateParser fastDateParser0 = new FastDateParser("zf*O4p", timeZone0, locale0);
      Locale locale1 = new Locale("zf*O4p", "zf*O4p");
      FastDateParser fastDateParser1 = new FastDateParser("zf*O4p", timeZone0, locale1);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Date date0 = fastDateParser0.parse("456P4(A4B&_J,`x]ut");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("g. )m");
      Locale locale0 = Locale.CANADA_FRENCH;
      FastDateParser fastDateParser0 = new FastDateParser("^:R|8X!H(.1fmW", timeZone0, locale0);
      assertEquals("^:R|8X!H(.1fmW", fastDateParser0.getPattern());
  }
  ...
  public void test25()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("");
      Locale locale0 = Locale.CANADA_FRENCH;
      FastDateParser fastDateParser0 = new FastDateParser("=Ktx-=CXQ)5z", timeZone0, locale0);
      assertEquals("=Ktx-=CXQ)5z", fastDateParser0.getPattern());
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("!k{78,T`%L");
      Locale locale0 = Locale.CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser(";?10<.PTcVc-TKL7", timeZone0, locale0);
      assertEquals(";?10<.PTcVc-TKL7", fastDateParser0.getPattern());
  }
  ...
  public void test37()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("+|E+|F+|G+|H+|K+|M+|S|W+|Z+|a+d+|h+|k+|E+|s+|w|y+|z+U''|[']+('1[^']*+)*+'|[^'A-Za-z]++");
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("+|E+|F+|G+|H+|K+|M+|S|W+|Z+|a+d+|h+|k+|E+|s+|w|y+|z+U''|[']+('1[^']*+)*+'|[^'A-Za-z]++", timeZone0, locale0);
      assertEquals("+|E+|F+|G+|H+|K+|M+|S|W+|Z+|a+d+|h+|k+|E+|s+|w|y+|z+U''|[']+('1[^']*+)*+'|[^'A-Za-z]++", fastDateParser0.getPattern());
  }
  ...
  public void test42()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2519), "(GMT[+-]d{0,1}d{2}|[+-]d{2}:?d{2}|");
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
  ...
  public void test43()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3449), "j#78>au");
      Locale locale0 = Locale.TAIWAN;
      FastDateParser fastDateParser0 = new FastDateParser("2MyyxF@", simpleTimeZone0, locale0);
      try { 
        fastDateParser0.parse("2MyyxF@");
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Unparseable date: \"2MyyxF@\" does not match 2(\\p{IsNd}{1}+)(\\p{IsNd}++)
         //
         verifyException("org.apache.commons.lang3.time.FastDateParser", e);
      }
  }
  ...
  public void test45()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("+|E6F+|G+|H+|K+|M+|S+|W+|Z+|a+d+|h+|k+|m+|s+|w|y+|z+|''|[']+(''[^']*+)*+'|[^'A*Zaz]++");
      Locale locale0 = Locale.forLanguageTag("CE");
      OffsetDateTime offsetDateTime0 = MockOffsetDateTime.now();
      ZoneOffset zoneOffset0 = ZoneOffset.from(offsetDateTime0);
      TimeZone timeZone1 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      FastDateParser fastDateParser0 = new FastDateParser("GMTPST", timeZone1, locale0);
  ...
  public void test49()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("i <m");
      Locale locale0 = Locale.ITALIAN;
      FastDateParser fastDateParser0 = null;
      try {
        fastDateParser0 = new FastDateParser("i <m", timeZone0, locale0);
  ...
  public void test54()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("~rA,j", "~rA,j");
      FastDateParser fastDateParser0 = new FastDateParser("~rA,j", timeZone0, locale0);
      String string0 = fastDateParser0.toString();
      assertEquals("FastDateParser[~rA,j,~ra,j_~RA,J,GMT]", string0);
  }
  ...
  public void test56()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = FastDateParser.JAPANESE_IMPERIAL;
      FastDateParser fastDateParser0 = new FastDateParser("KQbu", timeZone0, locale0);
      Object object0 = fastDateParser0.parseObject("5Xc");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", object0.toString());
  }
  ...
  public void test57()  throws Throwable  {
      Locale locale0 = Locale.KOREAN;
      TimeZone timeZone0 = TimeZone.getTimeZone("MyU");
      FastDateParser fastDateParser0 = new FastDateParser("MyU", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("47V");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      FastDateParser fastDateParser0 = new FastDateParser("sWE(_oIywi[G", timeZone0, locale0);
      assertEquals("sWE(_oIywi[G", fastDateParser0.getPattern());
  }
