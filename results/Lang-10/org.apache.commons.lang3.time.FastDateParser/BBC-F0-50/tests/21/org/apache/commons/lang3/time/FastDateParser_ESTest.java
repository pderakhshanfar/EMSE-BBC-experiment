...
public class FastDateParser_ESTest extends FastDateParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      fastDateParser0.parseObject("53Vm]+]OtyY=t", parsePosition0);
  ...
  public void test11()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("yl", timeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(1);
      fastDateParser0.parse("53Vm]F+tyY=@t", parsePosition0);
      assertEquals("java.text.ParsePosition[index=2,errorIndex=-1]", parsePosition0.toString());
      assertEquals(2, parsePosition0.getIndex());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Locale locale0 = Locale.TRADITIONAL_CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("yl", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("53Vm]+]OtyY=t");
  ...
  public void test14()  throws Throwable  {
      ...
      Object object0 = fastDateParser0.parseObject("992Eu}!U");
  ...
  public void test24()  throws Throwable  {
      ...
      FastDateParser fastDateParser0 = new FastDateParser("+$yy_7,DM/_O<',ivh", timeZone0, locale0);
      assertEquals("+$yy_7,DM/_O<',ivh", fastDateParser0.getPattern());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      TimeZone timeZone0 = fastDateParser0.getTimeZone();
      assertEquals("java.util.SimpleTimeZone[id=GD(?uVp?E>,offset=-3054,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", timeZone0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.FRANCE;
      FastDateParser fastDateParser0 = new FastDateParser("  $}kS(w^so>H", timeZone0, locale0);
      assertEquals("  $}kS(w^so>H", fastDateParser0.getPattern());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-378), "GMTECT");
  ...
  public void test41()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.JAPANESE;
      FastDateParser fastDateParser0 = new FastDateParser("HVTf-t#^", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("71!QB=rqwzj4<F");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = Locale.CHINESE;
      FastDateParser fastDateParser0 = new FastDateParser("hWfC8", timeZone0, locale0);
      Date date0 = fastDateParser0.parse("99EueU}!");
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fastDateParser0.parseObject("+d>u5Q", parsePosition0);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test51()  throws Throwable  {
      ...
      assertEquals("D+|E+|+|G+|H+K+|M+|S+|W+|Z+|a+|d+|h+|k+|m+|s+|w+|y+|z|''|'[^']++(''[^'+)*+'|[^'A-Za-z]++", fastDateParser0.getPattern());
  }
}
