...
public class StringCollectionDeserializer_ESTest extends StringCollectionDeserializer_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      AsExternalTypeDeserializer asExternalTypeDeserializer0 = new AsExternalTypeDeserializer(referenceType0, classNameIdResolver0, "JSON", true, simpleType0);
      try { 
  ...
  public void test12()  throws Throwable  {
      ...
      JsonParser jsonParser0 = arrayNode0.traverse();
      arrayNode0.insert(3692, "com.fasterxml.jackson.databind.deser.std.StringCollectionDeserializer");
      ArrayDeque<String> arrayDeque0 = new ArrayDeque<String>(798);
      TokenFilter tokenFilter0 = TokenFilter.INCLUDE_ALL;
  ...
  public void test13()  throws Throwable  {
      JsonNodeFactory jsonNodeFactory0 = JsonNodeFactory.instance;
      ArrayNode arrayNode0 = jsonNodeFactory0.arrayNode(750);
      arrayNode0.insertPOJO(750, (Object) null);
      JsonParser jsonParser0 = arrayNode0.traverse();
      TokenFilter tokenFilter0 = TokenFilter.INCLUDE_ALL;
      FilteringParserDelegate filteringParserDelegate0 = new FilteringParserDelegate(jsonParser0, tokenFilter0, true, true);
      filteringParserDelegate0.nextBooleanValue();
  ...
  public void test21()  throws Throwable  {
      ...
      arrayNode0.insertPOJO((-1822), (Object) null);
      JsonParser jsonParser0 = arrayNode0.traverse();
      ArrayDeque<String> arrayDeque0 = new ArrayDeque<String>();
      TokenFilter tokenFilter0 = TokenFilter.INCLUDE_ALL;
      FilteringParserDelegate filteringParserDelegate0 = new FilteringParserDelegate(jsonParser0, tokenFilter0, true, true);
  ...
  public void test22()  throws Throwable  {
      JsonDeserializer<ClassNameIdResolver> jsonDeserializer0 = (JsonDeserializer<ClassNameIdResolver>) mock(JsonDeserializer.class, new ViolatedAssumptionAnswer());
      doReturn((ClassNameIdResolver) null).when(jsonDeserializer0).deserialize(any(com.fasterxml.jackson.core.JsonParser.class) , any(com.fasterxml.jackson.databind.DeserializationContext.class));
