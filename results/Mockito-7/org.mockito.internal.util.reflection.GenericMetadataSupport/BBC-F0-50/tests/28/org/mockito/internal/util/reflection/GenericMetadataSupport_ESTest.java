...
public class GenericMetadataSupport_ESTest extends GenericMetadataSupport_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      TypeVariable<Class<String>>[] typeVariableArray0 = (TypeVariable<Class<String>>[]) Array.newInstance(TypeVariable.class, 4);
      TypeVariable<Class<String>> typeVariable0 = (TypeVariable<Class<String>>) mock(TypeVariable.class, new ViolatedAssumptionAnswer());
  ...
  public void test03()  throws Throwable  {
      TypeVariable<Class<String>> typeVariable0 = (TypeVariable<Class<String>>) mock(TypeVariable.class, new ViolatedAssumptionAnswer());
      doReturn((String) null, " implementation declared in ").when(typeVariable0).toString();
      GenericMetadataSupport.TypeVarBoundedType genericMetadataSupport_TypeVarBoundedType0 = new GenericMetadataSupport.TypeVarBoundedType(typeVariable0);
  ...
  public void test11()  throws Throwable  {
      TypeVariable<Class<String>> typeVariable0 = (TypeVariable<Class<String>>) mock(TypeVariable.class, new ViolatedAssumptionAnswer());
      doReturn("4.NRp~2U").when(typeVariable0).toString();
      GenericMetadataSupport.TypeVarBoundedType genericMetadataSupport_TypeVarBoundedType0 = new GenericMetadataSupport.TypeVarBoundedType(typeVariable0);
      TypeVariable typeVariable1 = genericMetadataSupport_TypeVarBoundedType0.typeVariable();
  ...
  public void test14()  throws Throwable  {
      TypeVariable<Class<String>>[] typeVariableArray0 = (TypeVariable<Class<String>>[]) Array.newInstance(TypeVariable.class, 4);
      GenericMetadataSupport.TypeVarBoundedType genericMetadataSupport_TypeVarBoundedType0 = new GenericMetadataSupport.TypeVarBoundedType(typeVariableArray0[3]);
  ...
  public void test17()  throws Throwable  {
      TypeVariable<Class<String>>[] typeVariableArray0 = (TypeVariable<Class<String>>[]) Array.newInstance(TypeVariable.class, 4);
      TypeVariable<Class<String>> typeVariable0 = (TypeVariable<Class<String>>) mock(TypeVariable.class, new ViolatedAssumptionAnswer());
      doReturn((Object) typeVariableArray0, (Object) typeVariableArray0, (Object) typeVariableArray0).when(typeVariable0).getBounds();
      GenericMetadataSupport.TypeVarBoundedType genericMetadataSupport_TypeVarBoundedType0 = new GenericMetadataSupport.TypeVarBoundedType(typeVariable0);
      Type[] typeArray0 = genericMetadataSupport_TypeVarBoundedType0.interfaceBounds();
