...
public class BaseNCodecInputStream_ESTest extends BaseNCodecInputStream_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        baseNCodecInputStream0.read(byteArray0, (int) (byte)0, 24);
  ...
  public void test05()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32();
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1555), 64);
  ...
  public void test08()  throws Throwable  {
      ...
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream((InputStream) null, base32_0, false);
      byte[] byteArray0 = new byte[24];
      int int0 = baseNCodecInputStream0.read(byteArray0, 24, (int) (byte)0);
      assertEquals(0, int0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, 2092, 64);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test11()  throws Throwable  {
      ...
      doReturn(false).when(enumeration0).hasMoreElements();
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(enumeration0);
      Base32 base32_0 = new Base32((-670));
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(sequenceInputStream0, base32_0, true);
      byte[] byteArray0 = new byte[5];
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, 1258, (int) (byte) (-19));
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read((byte[]) null, 0, (-3496));
        fail("Expecting exception: NullPointerException");
