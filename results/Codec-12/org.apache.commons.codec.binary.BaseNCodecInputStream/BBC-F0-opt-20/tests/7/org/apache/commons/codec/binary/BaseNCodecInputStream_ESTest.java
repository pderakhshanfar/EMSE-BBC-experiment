...
public class BaseNCodecInputStream_ESTest extends BaseNCodecInputStream_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32(1193, byteArray0, false);
  ...
  public void test04()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-286), 38);
      Base64 base64_0 = new Base64();
  ...
  public void test06()  throws Throwable  {
      byte[] byteArray0 = new byte[8];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 643, (-541));
  ...
  public void test08()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)0, (byte) (-68));
  ...
  public void test10()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[0];
      Base32 base32_0 = new Base32(3340, byteArray0);
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(pipedInputStream0, base32_0, true);
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, 0, 2023);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (int) (byte)37, (int) (byte)104);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-286), 0);
      Base64 base64_0 = new Base64();
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(byteArrayInputStream0, base64_0, true);
      byte[] byteArray1 = new byte[8];
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray1, 2023, (-3894));
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (-1942), 0);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = new byte[8];
      Base64 base64_0 = new Base64();
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 0, 68);
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read((byte[]) null, 8, 76);
        fail("Expecting exception: NullPointerException");
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-906), 4096);
