...
public class BaseNCodecInputStream_ESTest extends BaseNCodecInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32(116, byteArray0, false);
  ...
  public void test04()  throws Throwable  {
      byte[] byteArray0 = new byte[4];
      Base32 base32_0 = new Base32((-2029), byteArray0);
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-7), 705);
  ...
  public void test06()  throws Throwable  {
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream((InputStream) null, 2312);
      Base64 base64_0 = new Base64(2312);
  ...
  public void test08()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 64, (-15));
      byte[] byteArray1 = new byte[9];
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(byteArrayInputStream0, base64_0, false);
      int int0 = baseNCodecInputStream0.read(byteArray1, 1, 8);
      assertEquals((-1), int0);
  }
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      Base32 base32_0 = new Base32((-3226), byteArray0);
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(byteArrayInputStream0, base32_0, true);
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, 2, 102);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, 76, (int) (byte)65);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, 3066, (int) (byte) (-19));
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (-1), 1430);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read((byte[]) null, (int) (byte)0, (int) (byte)66);
        fail("Expecting exception: NullPointerException");
