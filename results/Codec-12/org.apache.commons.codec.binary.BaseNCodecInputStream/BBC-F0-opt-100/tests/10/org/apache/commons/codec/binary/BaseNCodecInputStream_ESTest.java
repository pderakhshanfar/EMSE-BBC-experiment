...
public class BaseNCodecInputStream_ESTest extends BaseNCodecInputStream_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      base32_0.ensureBufferSize((-3004));
      base32_0.pos = (int) (byte)1;
  ...
  public void test07()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(bufferedInputStream0, 6395);
      byte[] byteArray0 = new byte[9];
      Base32 base32_0 = new Base32((-503), byteArray0);
  ...
  public void test08()  throws Throwable  {
      ...
      int int0 = baseNCodecInputStream0.read(byteArray0, 3, (int) (byte)1);
      assertEquals(0, byteArrayInputStream0.available());
      assertEquals((-1), int0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (int) (byte)0, 73);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, 55, 436);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, 4096, (-102));
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test14()  throws Throwable  {
      ...
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(enumeration0);
      byte[] byteArray0 = new byte[9];
      Base64 base64_0 = new Base64((-314), byteArray0, true);
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(sequenceInputStream0, base64_0, true);
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (int) (byte) (-38), (int) (byte)1);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read((byte[]) null, 123, 76);
        fail("Expecting exception: NullPointerException");
