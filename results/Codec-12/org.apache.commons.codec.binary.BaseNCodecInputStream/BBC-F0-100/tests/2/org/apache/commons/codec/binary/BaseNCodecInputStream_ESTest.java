...
public class BaseNCodecInputStream_ESTest extends BaseNCodecInputStream_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Base64 base64_0 = new Base64(3849, byteArray0);
  ...
  public void test03()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1266), 69);
      DataInputStream dataInputStream0 = new DataInputStream(byteArrayInputStream0);
      Base64 base64_0 = new Base64(2908);
  ...
  public void test06()  throws Throwable  {
      ...
      Base64 base64_0 = new Base64(false);
      byte[] byteArray0 = new byte[3];
      base64_0.currentLinePos = 64;
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(sequenceInputStream0, base64_0, true);
      int int0 = baseNCodecInputStream0.read();
      assertEquals(13, int0);
      
      int int1 = baseNCodecInputStream0.read(byteArray0, (int) (byte)0, (int) (byte)3);
      assertEquals(1, int1);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(sequenceInputStream0, base64_0, true);
      byte[] byteArray0 = new byte[7];
      int int0 = baseNCodecInputStream0.read(byteArray0, (int) (byte)6, (int) (byte)0);
      assertEquals(0, int0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (int) (byte)75, 79);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test10()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)79, (byte)0);
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(byteArrayInputStream0, base64_0, false);
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (int) (byte)11, (int) (byte) (-63));
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (-1575), (int) (byte)0);
        fail("Expecting exception: IndexOutOfBoundsException");
