...
public class BaseNCodecInputStream_ESTest extends BaseNCodecInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      base64_0.currentLinePos = 1020;
      int int0 = baseNCodecInputStream0.read(byteArray0, (int) (byte)0, 5);
      assertArrayEquals(new byte[] {(byte)13, (byte)10, (byte)0, (byte)0, (byte)0}, byteArray0);
      assertEquals(2, int0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-47), 1090);
  ...
  public void test09()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32(1587, byteArray0);
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1587, 64);
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(byteArrayInputStream0, base32_0, false);
      byte[] byteArray1 = new byte[9];
      int int0 = baseNCodecInputStream0.read(byteArray1, 9, (int) (byte)0);
      assertEquals(0, int0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, 0, (int) (byte)38);
  ...
  public void test11()  throws Throwable  {
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 4140, (byte)48);
      Base64 base64_0 = new Base64();
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(byteArrayInputStream0, base64_0, true);
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (int) (byte)45, (int) (byte)0);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test12()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32((-1383), byteArray0, true);
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(pipedInputStream0, base32_0, true);
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, 64, (-1383));
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test13()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32((-2517), byteArray0);
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(pipedInputStream0, base32_0, true);
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (-1), (int) (byte) (-127));
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read((byte[]) null, (-679), (int) (byte)0);
        fail("Expecting exception: NullPointerException");
