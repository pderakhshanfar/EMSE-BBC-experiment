...
public class BaseNCodecInputStream_ESTest extends BaseNCodecInputStream_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-4), (byte) (-3));
      Base32 base32_0 = new Base32();
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 423, 907);
      Base32 base32_0 = new Base32();
      base32_0.ensureBufferSize(907);
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(byteArrayInputStream0, base32_0, true);
      int int0 = baseNCodecInputStream0.read(byteArray0);
      assertEquals((-1), int0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, 1181, (-1689));
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test07()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(byteArrayInputStream0, 1350);
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (-1), (-1532));
        fail("Expecting exception: IndexOutOfBoundsException");
