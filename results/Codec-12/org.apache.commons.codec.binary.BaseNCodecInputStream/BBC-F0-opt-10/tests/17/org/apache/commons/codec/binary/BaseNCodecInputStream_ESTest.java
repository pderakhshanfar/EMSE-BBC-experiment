...
public class BaseNCodecInputStream_ESTest extends BaseNCodecInputStream_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Base64 base64_0 = new Base64((-2432), byteArray0);
  ...
  public void test02()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32((-805), byteArray0);
  ...
  public void test04()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-92), 977);
  ...
  public void test07()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      Base32 base32_0 = new Base32((-631), byteArray0, false);
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(byteArrayInputStream0, base32_0, true);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (int) (byte)0, (int) (byte)23);
  ...
  public void test10()  throws Throwable  {
      ...
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0, 1939);
      Base64 base64_0 = new Base64();
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(pipedInputStream0, base64_0, true);
      byte[] byteArray0 = new byte[6];
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (int) (byte)29, (int) (byte)40);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test11()  throws Throwable  {
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 513, (-869));
      Base64 base64_0 = new Base64();
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(byteArrayInputStream0, base64_0, true);
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, 0, (-869));
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read(byteArray0, (-5814), 0);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        baseNCodecInputStream0.read((byte[]) null, (-230), (int) (byte)123);
        fail("Expecting exception: NullPointerException");
