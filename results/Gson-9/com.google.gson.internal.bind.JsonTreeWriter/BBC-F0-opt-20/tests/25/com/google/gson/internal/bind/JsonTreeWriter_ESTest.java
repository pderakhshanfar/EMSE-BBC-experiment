...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-1947L));
      assertFalse(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("^vwD&[ckp[)up[sF?'G");
  ...
  public void test23()  throws Throwable  {
      ...
      jsonTreeWriter0.setLenient(true);
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("2bM'$e]Y7U|f");
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test31()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      Double double0 = new Double(584.5353006928);
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      Short short0 = Short.valueOf((short)994);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((Number) short0);
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test40()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(3247.1937729441283);
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("^vwD&[ckp[)up[sF?'G");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("^vwD&[ckp[)up[sF?'G");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test54()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonWriter0.name("L?/5");
      Float float0 = new Float((-2940.8));
      JsonWriter jsonWriter1 = jsonTreeWriter0.value((Number) float0);
      JsonWriter jsonWriter2 = jsonTreeWriter0.name("tM:d y)zT[uarc");
