...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("2fmUj");
  ...
  public void test05()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("dayOfMonth");
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test09()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(687L);
  ...
  public void test11()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(2708L);
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test12()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-2861.3739785018856));
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("com.google.gson.JsonIOException");
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value((-450.89591145631));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("}Xj#f9P).0ig");
      // Undeclared exception!
      try { 
        jsonWriter0.name("VN?9Rj_E{<NU");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("}Xj#f9P).0ig");
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("}Xj#f9P).0ig");
