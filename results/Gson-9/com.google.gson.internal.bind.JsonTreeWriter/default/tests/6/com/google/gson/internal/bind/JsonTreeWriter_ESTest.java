...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("|^AU$KgNps,rq)&};}_");
  ...
  public void test04()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("5@Z'Crruik~!(t=");
  ...
  public void test06()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-1108L));
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test09()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(2549.1014756524);
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("tDpVCdTy[s{oCAV");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test36()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("[ FFX(*Id,.Wk\"");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("[ FFX(*Id,.Wk\"");
        fail("Expecting exception: IllegalStateException");
