...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonTreeWriter0.name(" but was ");
  ...
  public void test11()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((double) (short) (-1528));
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter2 = jsonWriter0.value((double) (short) (-1528));
      assertSame(jsonWriter2, jsonWriter1);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("@I");
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonWriter0.setHtmlSafe(true);
      jsonTreeWriter0.name(" but was ");
      jsonTreeWriter0.value((-800.941));
      jsonTreeWriter0.name(" but was ");
  ...
  public void test17()  throws Throwable  {
      ...
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("% B#O#K<4F*3Rs");
      JsonWriter jsonWriter2 = jsonWriter1.nullValue();
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value(".Ycvk>VCD<[lyLJ-P5u");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test39()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((double) 858L);
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test41()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("IZxv>'4<*.LM9;{XWH");
      // Undeclared exception!
      try { 
        jsonWriter0.name("IZxv>'4<*.LM9;{XWH");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("no];6{PQD0T;669v%");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("IZxv>'4<*.LM9;{XWH");
      // Undeclared exception!
      try { 
  ...
  public void test53()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.jsonValue("X?{{]ayZ6");
