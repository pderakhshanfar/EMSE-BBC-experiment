...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      Float float0 = new Float((-762.17452701));
  ...
  public void test09()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      Float float0 = new Float((-2338.304659));
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((Number) float0);
  ...
  public void test10()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-1434L));
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test13()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(3114.26032520376);
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("FQ{$}*/OM>'@=K");
  ...
  public void test17()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("{xCK)j<BQOp,");
  ...
  public void test18()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.value(2035.532883207431);
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value("8=5O-LY&Z;BKcM:");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(2035.532883207431);
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test42()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("{xCK)j<BQOp,");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("{xCK)j<BQOp,");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test52()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("{xCK)j<BQOp,");
  ...
  public void test53()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("'");
      JsonWriter jsonWriter1 = jsonWriter0.value(2913.57185209);
