...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("aR`bp0p%TlEhEV&lb&");
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test07()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("0rp");
  ...
  public void test10()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(1333L);
  ...
  public void test12()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(298L);
      assertFalse(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test14()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(1299.544009235962);
      assertFalse(jsonWriter0.isLenient());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter1 = jsonWriter0.name(">3-#dG.!lnbn\u0006H");
  ...
  public void test39()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-267.34));
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("aR`bp0p%TlEhEV&lb&");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonWriter0.name(">3-#dG.!lnbn\u0006H");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("mEmJwZHX_[9oe");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test52()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("?_[9k&Y{");
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-2215L));
      assertTrue(jsonWriter0.getSerializeNulls());
  }
