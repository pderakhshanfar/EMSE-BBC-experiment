...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("I)0$7-%%(");
  ...
  public void test11()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(2161L);
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("-gfN/t|f");
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      jsonTreeWriter0.setLenient(true);
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("io\"A");
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value("iF~ yC11w3kc");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test29()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.close();
      Float float0 = Float.valueOf(2023.0116F);
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value((-1647.886264539822));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test34()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      Double double0 = new Double(415.05158);
      jsonTreeWriter0.setLenient(true);
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("faVukU[j.:N");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("c>C[vY[wBO");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("c>C[vY[wBO");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("l;)T8j?${DXv(~BJA");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.endObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonTreeWriter0.setSerializeNulls(false);
      jsonTreeWriter0.name("ZC>Vo=:H4*aM`yC+");
