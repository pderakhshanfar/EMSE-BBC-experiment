...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("v}R*e1T3j");
  ...
  public void test04()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("5[8#6^HhKf$@QUd");
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test07()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      Double double0 = new Double(2144.1728062);
  ...
  public void test08()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(1262L);
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test09()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-1118L));
  ...
  public void test10()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-1369L));
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("qHnP_!i2!Prceu|9");
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value((-1318.2384179));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test39()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-20.30444));
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("s\"%s3]trVX%e~mN3X");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonWriter0.name("I-xoT}YqLM&*;");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("I-xoT}YqLM&*;");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test52()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonTreeWriter0.setSerializeNulls(false);
      jsonTreeWriter0.name("0$>?I8N|)Y-N@i8");
  ...
  public void test54()  throws Throwable  {
      ...
      Float float0 = new Float(6569.39697211);
  ...
  public void test59()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonWriter0.name("lN8s+HoO'.`*BA-S`");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.endObject();
        fail("Expecting exception: IllegalStateException");
