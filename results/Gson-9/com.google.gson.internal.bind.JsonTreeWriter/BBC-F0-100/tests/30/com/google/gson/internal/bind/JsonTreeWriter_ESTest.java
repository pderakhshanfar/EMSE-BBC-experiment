...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      jsonTreeWriter0.beginArray();
      jsonTreeWriter0.beginArray();
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(1294.9180038);
  ...
  public void test06()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("f5a-~759");
  ...
  public void test25()  throws Throwable  {
      ...
      jsonTreeWriter0.setHtmlSafe(true);
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("|Gl]HQI3(\"6H");
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test30()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonWriter0.name("zCm(Z\"j Mh3R");
      jsonTreeWriter0.nullValue();
      // Undeclared exception!
      try { 
        jsonWriter0.value("zCm(Z\"j Mh3R");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test31()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      Double double0 = new Double(415.2840627206255);
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-914.76684));
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test43()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonWriter0.name("I8.2K{FI^ mOG1]");
      // Undeclared exception!
      try { 
        jsonWriter0.name("I8.2K{FI^ mOG1]");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("]_f;S9% e\"ga");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test48()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("zCm(Z\"j Mh3R");
      // Undeclared exception!
      try { 
  ...
  public void test52()  throws Throwable  {
      ...
      jsonTreeWriter0.setSerializeNulls(false);
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("o-Un?!o_@Y-Vuq");
      JsonWriter jsonWriter0 = jsonTreeWriter0.nullValue();
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
