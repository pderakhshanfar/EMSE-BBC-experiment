...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("CO@(!7");
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test07()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("p/Kf");
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test08()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("I1[SROIz");
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test09()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      Float float0 = new Float((-3748.159708131777));
  ...
  public void test15()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-830.032544797));
  ...
  public void test16()  throws Throwable  {
      ...
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.setLenient(true);
      jsonTreeWriter0.name("0}(]MTy9mZIpXZ.");
  ...
  public void test17()  throws Throwable  {
      ...
      jsonTreeWriter0.setHtmlSafe(true);
      jsonTreeWriter0.name("L-~K$rU`{+,GN-/RFG9");
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("YRJMsGMP@r_bT");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("L-~K$rU`{+,GN-/RFG9");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name(")<95?=|");
      // Undeclared exception!
      try { 
        jsonWriter0.endArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test49()  throws Throwable  {
      ...
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name(")<95?=|");
      Double double0 = new Double(2594.933859847006);
