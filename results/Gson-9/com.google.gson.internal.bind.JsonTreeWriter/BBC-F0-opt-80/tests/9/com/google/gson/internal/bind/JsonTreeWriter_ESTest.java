...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      Float float0 = new Float(312.12387F);
      jsonTreeWriter0.setHtmlSafe(true);
  ...
  public void test12()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-2001L));
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test13()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(912.5230049373084);
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test14()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-740.916492));
      assertFalse(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("[`X1Z^9e5kiUda.:E+");
  ...
  public void test37()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      Float float0 = new Float(452.45447F);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((Number) float0);
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("[`X1Z^9e5kiUda.:E+");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("|wJ'6{b]zMfjn7T3?~");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test53()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.jsonValue("93&wdq");
  ...
  public void test55()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("[`X1Z^9e5kiUda.:E+");
      jsonWriter0.value((-2602L));
      // Undeclared exception!
      try { 
