...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("1Un*\"A+");
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test12()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-1047.96));
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      jsonTreeWriter0.setLenient(true);
      jsonTreeWriter0.name("}Vsrc bgp=_7U~");
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value("hourOfDay");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test30()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("X;K.gaU,|s+@Diu");
      JsonWriter jsonWriter0 = jsonTreeWriter0.nullValue();
      // Undeclared exception!
      try { 
        jsonWriter0.value((-3629L));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test35()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      Double double0 = new Double(4.1670304488855);
  ...
  public void test36()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-909.883189));
      assertFalse(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("rS~8.5Y[m5w<");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("}Vsrc bgp=_7U~");
      // Undeclared exception!
      try { 
