...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(1813L);
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test10()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(2357L);
      assertFalse(jsonWriter0.isLenient());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("L@E$~p*/&.v&pU");
      JsonWriter jsonWriter2 = jsonTreeWriter0.value((-2518L));
  ...
  public void test13()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(1742.0707487738);
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("P^Y@DVpT8\be");
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("P^Y@DVpT8\be");
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value(",FruiOXCZ!^*=9lK!_");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test35()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("L@E$~p*/&.v&pU");
      jsonTreeWriter0.value((-2518L));
      // Undeclared exception!
      try { 
        jsonTreeWriter0.beginArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("vaqLP4|3V=ETq!!>~@");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("P^Y@DVpT8\be");
      // Undeclared exception!
      try { 
        jsonWriter0.name("_");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test50()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value((-2562.269214360133));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.jsonValue("YUc2S@o9I_-]I");
