...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("a]*3s`'_a2#{M");
  ...
  public void test08()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      Float float0 = new Float((-295.54420180411074));
  ...
  public void test10()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-675L));
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test11()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(76L);
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test16()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("|FQJBi5t+k8NzbP");
      jsonWriter0.setLenient(true);
      jsonTreeWriter0.nullValue();
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("|FQJBi5t+k8NzbP");
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("yeaZkr");
      assertSame(jsonWriter1, jsonWriter0);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value(1932.29882534);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test34()  throws Throwable  {
      ...
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("|FQJBi5t+k8NzbP");
      jsonWriter0.value("|FQJBi5t+k8NzbP");
      // Undeclared exception!
      try { 
  ...
  public void test43()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("|FQJBi5t+k8NzbP");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("|FQJBi5t+k8NzbP");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("E2YMsjIaE/5");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("enz]A~!I^g&*1");
      // Undeclared exception!
      try { 
        jsonWriter0.endObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test52()  throws Throwable  {
      ...
      jsonTreeWriter0.name("|FQJBit+k8zbP");
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.jsonValue("A7[RD@Dvog[x");
