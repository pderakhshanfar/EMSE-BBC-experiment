...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("owCJ`wY9}cqt8kI");
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test11()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(3482L);
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("{V;Q-y0Vs|,MN~[p");
  ...
  public void test17()  throws Throwable  {
      ...
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("es*]c53gArBl5j_^sv");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test38()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-634.1561196189));
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("dqkIrSr<$ ]Ig");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("es*]c53gArBl5j_^sv");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("es*]c53gArBl5j_^sv");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonWriter0.name("{V;Q-y0Vs|,MN~[p");
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("GipgcDkZW");
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("Ui(ZP;.Pg\"u/F;");
      jsonWriter0.setSerializeNulls(false);
  ...
  public void test49()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("GipgcDkZW");
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-3830.478));
      assertFalse(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test50()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("Ui(ZP;.Pg\"u/F;");
      jsonTreeWriter0.nullValue();
      // Undeclared exception!
      try { 
        jsonTreeWriter0.beginObject();
