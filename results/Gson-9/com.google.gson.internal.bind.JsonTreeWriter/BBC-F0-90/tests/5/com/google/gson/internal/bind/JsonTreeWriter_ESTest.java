...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("2XnjWD");
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test05()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("oD8R.6isdu\"z}");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test06()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("<`V.R76=O");
      assertFalse(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test07()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      Float float0 = new Float((-2253.529F));
  ...
  public void test09()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-1569L));
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test11()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(2823.0);
  ...
  public void test16()  throws Throwable  {
      ...
      jsonTreeWriter1.value("JSON must have only one top-level value.");
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("q.He'sKO`:N#%");
      assertSame(jsonWriter1, jsonWriter0);
  }
  ...
  public void test27()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      Long long0 = Long.getLong("Pr2wGd^HcB 5[hx{DI", (-1933L));
      jsonTreeWriter0.beginObject();
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonWriter0.name("uaDsZO/].Vrj-pA`");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("");
        fail("Expecting exception: IllegalStateException");
