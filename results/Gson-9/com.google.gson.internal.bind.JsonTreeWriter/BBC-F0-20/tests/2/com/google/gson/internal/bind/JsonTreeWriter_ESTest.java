...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("]-l-J24:/w#D^HF");
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("%=r`bHdIA|xjc");
  ...
  public void test10()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(233L);
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      jsonWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter1 = jsonTreeWriter0.endObject();
      JsonWriter jsonWriter2 = jsonWriter1.value(829L);
      assertSame(jsonWriter2, jsonWriter1);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("^T@n-z5");
  ...
  public void test30()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("o^96C:3it|Q");
      jsonTreeWriter0.value(false);
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value("o^96C:3it|Q");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("Oy.h-9OMTq}");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("OEx");
      // Undeclared exception!
      try { 
  ...
  public void test53()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("d4YY([@c<cp)z");
        fail("Expecting exception: IllegalStateException");
