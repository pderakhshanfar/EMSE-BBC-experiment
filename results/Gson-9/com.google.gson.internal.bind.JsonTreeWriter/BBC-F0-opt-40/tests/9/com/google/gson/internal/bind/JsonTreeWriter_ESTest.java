...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("ezD99 N(O`");
  ...
  public void test08()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      Double double0 = new Double((-1775.55));
  ...
  public void test12()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(1165.3726);
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("IGJPN~=");
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonTreeWriter0.endObject();
      JsonWriter jsonWriter2 = jsonWriter1.value("|-@0evy\"5J");
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value("quf<&1M5?=KoUA");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-2357.06852249));
      assertFalse(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test39()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonWriter0.name("[F42}iqb");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("[F42}iqb");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test45()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("Js_yd_utbt");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.endArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("O?(^LLyMEa$:=c?2");
      JsonWriter jsonWriter2 = jsonWriter1.nullValue();
  ...
  public void test51()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("Js_yd_utbt");
      jsonTreeWriter0.nullValue();
      jsonTreeWriter0.setHtmlSafe(true);
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("4[rLI}oFN|3`");
        fail("Expecting exception: IllegalStateException");
