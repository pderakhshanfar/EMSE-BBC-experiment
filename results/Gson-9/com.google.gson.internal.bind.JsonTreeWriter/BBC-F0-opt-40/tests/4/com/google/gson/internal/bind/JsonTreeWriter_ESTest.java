...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("+]TYeiM");
      assertFalse(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test08()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      Float float0 = new Float(420.04636F);
  ...
  public void test10()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-3445L));
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test11()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-423L));
      assertFalse(jsonWriter0.isLenient());
  }
  ...
  public void test12()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(1384L);
      assertFalse(jsonWriter0.isLenient());
  }
  ...
  public void test13()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-5303.37953));
      assertFalse(jsonWriter0.isLenient());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value("><{s$624L:<Qd");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test32()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.close();
      Float float0 = new Float((double) (-5784L));
      // Undeclared exception!
      try { 
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value(1243.502997507);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-2405.94549131));
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test43()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("K,K7s#o(Wy8,l");
      // Undeclared exception!
      try { 
        jsonWriter0.name("K,K7s#o(Wy8,l");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test49()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("K,K7s#o(Wy8,l");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.endArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test51()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("&@o.ejt>j#%z%");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test53()  throws Throwable  {
      ...
      jsonTreeWriter0.name("K,#o(Wy8,9l");
  ...
  public void test54()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("43sY");
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-1718.2474931));
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
