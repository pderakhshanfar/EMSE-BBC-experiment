...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("/^#XY, $qZ>a,2");
      assertEquals("\"/^#XY, $qZ>a,2\"", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter0.name("$[^b?@(!o#si~");
      jsonWriter2.value(0.0);
      assertEquals("{\"$[^b?@(!o#si~\":0.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(1578.43);
      assertEquals("1578.43", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("$[^b?@(!o#si~");
      assertTrue(jsonWriter1.getSerializeNulls());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("ww,");
      assertFalse(jsonWriter1.getSerializeNulls());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("6uPTd2/ [rKc-{m|YH");
      assertEquals("6uPTd2/ [rKc-{m|YH", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("/^#XY, $qZ>a,2");
      assertEquals("/^#XY, $qZ>a,2", stringWriter0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("`_KT-r%KtyjG%-0A\"N");
      // Undeclared exception!
      try { 
        jsonWriter1.value("`_KT-r%KtyjG%-0A\"N");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test35()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("2B^J:+jZ|F");
      // Undeclared exception!
      try { 
        jsonWriter1.value(856.171474);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("$[^b?@(!o#si~");
      jsonWriter2.beginObject();
      assertEquals("{\"$[^b?@(!o#si~\":null,\"$[^b?@(!o#si~\":{", stringWriter0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      JsonWriter jsonWriter19 = jsonWriter16.name("false");
  ...
  public void test69()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("]0XNa!wxg]b['%");
      assertEquals("\"]0XNa!wxg]b[\\u0027%\"", stringWriter0.toString());
  }
}
