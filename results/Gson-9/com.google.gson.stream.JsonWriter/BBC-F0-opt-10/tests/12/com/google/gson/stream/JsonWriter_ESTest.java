...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("O*Iay$[v>^QL0j");
      assertEquals("\"O*Iay$[v>^QL0j\"", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("VNEz#YRl]rC>Bq=W");
      assertEquals("\"VNEz#YRl]rC>Bq=W\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      String string0 = "\\uMf27";
      jsonWriter0.value(string0);
      assertEquals("\"\\\\uMf27\"", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("jbdKip4'1+");
      assertEquals("jbdKip4'1+", stringWriter0.toString());
  }
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(412L);
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("kS#+z?W':]j-]^Cv");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      ...
      jsonWriter2.jsonValue("jbdKip4'1+");
      assertEquals("[null,jbdKip4'1+", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("JSON must have only one top-level value.");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name(".");
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-2544.757));
      jsonWriter0.value((-2544.757));
      assertEquals("-2544.757-2544.757", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("gK_");
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("7E10g$7");
      JsonWriter jsonWriter3 = jsonWriter2.value(2816L);
      jsonWriter3.name(",+>~1ii.1w");
      jsonWriter0.value(",+>~1ii.1w");
      assertEquals("{\"7E10g$7\":2816,\",+>~1ii.1w\":\",+>~1ii.1w\"", stringWriter0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("<:x}hc5m\"jCh<");
      // Undeclared exception!
      try { 
        jsonWriter1.name("$bK?G");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test60()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.name("(uIsCb2K`$b,6zg");
      // Undeclared exception!
      try { 
        jsonWriter1.endArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test62()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("Y7");
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.nullValue();
      assertEquals("[\nY7null", stringWriter0.toString());
  }
