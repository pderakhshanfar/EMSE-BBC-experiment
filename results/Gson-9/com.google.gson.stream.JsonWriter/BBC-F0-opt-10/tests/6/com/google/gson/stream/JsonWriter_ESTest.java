...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("Y}];<\"3o;EpED:");
      assertEquals("\"Y}];<\\\"3o;EpED:\"", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("s@Tx_WS.iYcB");
      assertEquals("\"s@Tx_WS.iYcB\"", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) 181L);
      assertEquals("181.0", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((double) 864);
      assertEquals("864.0", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("^f&:i");
      assertEquals("^f&:i", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("x+l/X-'moP(?=\"tj");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test38()  throws Throwable  {
      ...
      jsonWriter1.jsonValue("s~Lvu");
      assertEquals("[true,s~Lvu", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      jsonWriter1.beginObject();
      jsonWriter6.name("Dangling name: ");
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("3&dy");
      JsonWriter jsonWriter2 = jsonWriter1.jsonValue("3&dy");
      // Undeclared exception!
      try { 
  ...
  public void test44()  throws Throwable  {
      ...
      jsonWriter2.value((long) 34);
      JsonWriter jsonWriter3 = jsonWriter2.name("{,h{#");
      jsonWriter3.value((-148L));
      assertEquals("{\"{,h{#\":34,\"{,h{#\":-148", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.setIndent("(q$7");
      jsonWriter1.nullValue();
      assertEquals("[\n(q$7null", stringWriter0.toString());
  }
  ...
  public void test52()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("_jHNtlX'v)5");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test59()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.name(":=SGn");
      // Undeclared exception!
      try { 
        jsonWriter1.endArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test68()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("(q$7");
      assertEquals("\"(q$7\"", stringWriter0.toString());
  }
}
