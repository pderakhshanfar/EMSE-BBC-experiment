...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Float float0 = new Float(1409.2543F);
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(2622L);
      assertEquals("2622", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-472.4888742158479));
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      jsonWriter0.value(4023.891083);
      assertEquals("{\"\":4023.891083", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name(";3{zd~wb#MYTlrv");
      assertTrue(jsonWriter1.getSerializeNulls());
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(5559);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("\b");
      assertTrue(jsonWriter0.isHtmlSafe());
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("P)K3%");
      assertEquals("P)K3%", stringWriter0.toString());
  ...
  public void test26()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("J{c~T");
      jsonWriter0.setLenient(true);
      jsonWriter1.beginObject();
      jsonWriter0.endObject();
      assertEquals("{\"J{c~T\":{}", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("J{c~T");
      jsonWriter0.beginArray();
      jsonWriter0.name("J{c~T");
      // Undeclared exception!
      try { 
        jsonWriter1.value((double) 13);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test45()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(5559);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("<?%$a^c:W$\"Ae}n\"y_");
      assertEquals("\"<?%$a^c:W$\\\"Ae}n\\\"y_\"", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("h-A");
      jsonWriter1.close();
      jsonWriter1.close();
      assertEquals("h-A", stringWriter0.toString());
  }
  ...
  public void test52()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name(" PG(a-mp+V5|mAVl@U");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(5564);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      // Undeclared exception!
      try { 
  ...
  public void test59()  throws Throwable  {
      ...
      jsonWriter7.name("java.lang.Double@0000000002");
      JsonWriter jsonWriter16 = jsonWriter8.beginObject();
      JsonWriter jsonWriter17 = jsonWriter16.name("javalang.Byte@0000000003");
      ...
      jsonWriter19.name("javalang.Byte@0000000003");
  ...
  public void test66()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value("A");
