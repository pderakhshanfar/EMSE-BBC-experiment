...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        jsonWriter0.value((-450.5949778944232));
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals("[{\"t\":\"Infinity\"},true", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float(228.216F);
      jsonWriter0.setSerializeNulls(false);
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((long) 1021);
      assertEquals("1021", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-4433L));
      assertEquals("-4433", stringWriter0.toString());
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("uJX]ol{C_gYjZ{%t|n~");
      jsonWriter0.setSerializeNulls(false);
      jsonWriter1.value(548L);
      assertEquals("{\"uJX]ol{C_gYjZ{%t|n~\":548", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(2685.498592137287);
      assertEquals("2685.498592137287", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((double) (-1777.3008F));
      assertEquals("-1777.30078125", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("2tq`pwM2r&lI2JU~5");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      jsonWriter1.name("7^c|+f<CkK)2WR?");
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals("[{\"t\":\"Infinity\"},Infinity", stringWriter0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter0.beginObject();
      JsonWriter jsonWriter3 = jsonWriter2.name("t");
      JsonWriter jsonWriter4 = jsonWriter1.value("Infinity");
  ...
  public void test32()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((double) 8);
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value("zcgdy7PVlk'&->");
      jsonWriter1.beginObject();
      assertEquals("[\"zcgdy7PVlk'&->\",{", stringWriter0.toString());
  }
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      String string0 = "\\u\"*kH<ygC=GUlv`.";
      jsonWriter0.value(string0);
      assertEquals("\"\\\\u\\\"*kH<ygC=GUlv`.\"", stringWriter0.toString());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      JsonWriter jsonWriter5 = jsonWriter4.name("OuJX]ol{C_gYjZ{%t|n~");
      ...
      jsonWriter12.beginArray();
      jsonWriter0.beginArray();
      assertEquals("[[[{\"OuJX]ol{C_gYjZ{%t|n~\":[[[[[[[[[[[[[[[[[[[[[[[[[[[[", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test37()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(3003);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter3 = jsonWriter2.value((-441L));
      jsonWriter3.name("Numeric values must be finite, but was ");
      jsonWriter2.beginArray();
      assertEquals("{\"Numeric values must be finite, but was \":-441,\"Numeric values must be finite, but was \":[", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-359.0194000183416));
      jsonWriter0.close();
      jsonWriter1.close();
      assertEquals("-359.0194000183416", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test44()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("Iu\"*kH<ygC=GUlv`.");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float((-218.5674F));
      jsonWriter0.setLenient(true);
  ...
  public void test51()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("Iu\"*kH<ygC=GUlv`.");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name("Iu\"*kH<ygC=GUlv`.");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value((-359.0194000183416));
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter0.value((double) 3017L);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("salT^");
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value("salT^");
      assertEquals("[\nsalT^\"salT^\"", stringWriter0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("salT^");
      assertEquals("\"salT^\"", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
}
