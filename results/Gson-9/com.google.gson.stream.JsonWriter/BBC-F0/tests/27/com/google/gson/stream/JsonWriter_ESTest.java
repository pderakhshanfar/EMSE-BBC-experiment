...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter1.name("eMA0jasM?#N'opl[[*");
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("L\"EYA31e3|'/BhHvcB");
      assertEquals("\"L\\\"EYA31e3|'/BhHvcB\"", stringWriter0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      jsonWriter0.value("$9<{]m");
      assertEquals("\"$9<{]m\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float((double) 1609);
      jsonWriter0.setHtmlSafe(true);
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-189L));
      assertEquals("-189", stringWriter0.toString());
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(172L);
      assertEquals("172", stringWriter0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("eMA0jasM?#N'opl[[*");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("(x|OF|enbI${8V ");
      assertEquals("(x|OF|enbI${8V ", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("oD+xP I%EM`[Sog(B!I");
      assertEquals("oD+xP I%EM`[Sog(B!I", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("C2z82^");
      jsonWriter1.setSerializeNulls(false);
  ...
  public void test52()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("oD+xP I%EM`[Sog(B!I");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test53()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("D$.HkfgO*V_SjW}U+");
      // Undeclared exception!
      try { 
        jsonWriter1.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("\u0006^@Uj~dfOf$O");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
  ...
  public void test64()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("=Qd+#zv.~$w~K");
      JsonWriter jsonWriter2 = jsonWriter1.jsonValue("?Rw'/8T%@fRRPs");
      jsonWriter2.name("Infinity");
      jsonWriter1.beginArray();
      assertEquals("{\"=Qd+#zv.~$w~K\":?Rw'/8T%@fRRPs,\"Infinity\":[", stringWriter0.toString());
  }
  ...
  public void test71()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("XAKY74mZS1S3=");
      assertEquals("\"XAKY74mZS1S3\\u003d\"", stringWriter0.toString());
  }
}
