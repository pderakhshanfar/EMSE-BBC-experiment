...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("MW,wPCX^]>4");
      // Undeclared exception!
      try { 
        jsonWriter2.jsonValue("MW,wPCX^]>4");
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("o1m\"n\"hr");
      assertEquals("\"o1m\\\"n\\\"hr\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-3151L));
      assertEquals("-3151", stringWriter0.toString());
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(456.93393);
      assertEquals("456.93393", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-328.9883144888));
      assertEquals("-328.9883144888", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      jsonWriter0.setLenient(true);
      jsonWriter1.endObject();
      jsonWriter0.jsonValue("P9.zQh4opb(g]MZ %z");
      assertEquals("{}P9.zQh4opb(g]MZ %z", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      jsonWriter1.jsonValue("P9.zQh4opb(g]MZ %z");
      assertEquals("[{},P9.zQh4opb(g]MZ %z", stringWriter0.toString());
  }
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("MW,wPCX^]>4");
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("MW,wPCX^]>4");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("jaya.lang.Float@000^000002");
      jsonWriter0.beginArray();
      assertEquals("[", stringWriter0.toString());
  ...
  public void test51()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("wo5k+<I}773V");
      // Undeclared exception!
      try { 
        jsonWriter1.nullValue();
        fail("Expecting exception: IllegalStateException");
