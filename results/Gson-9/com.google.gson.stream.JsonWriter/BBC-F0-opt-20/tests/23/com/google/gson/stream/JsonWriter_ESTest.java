...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((long) 3124);
      assertEquals("3124", stringWriter0.toString());
      assertFalse(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-1436.9));
      assertEquals("-1436.9", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.name("o?nBHxr&sWW/K");
      assertFalse(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test35()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(958.19387);
      // Undeclared exception!
      try { 
        jsonWriter1.value((-1625.2683930549));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.value("bduT.");
      jsonWriter1.beginObject();
      assertEquals("[\"bduT.\",{", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("h4G/-h4(k\"");
      Short short0 = new Short((short)446);
      JsonWriter jsonWriter2 = jsonWriter1.value((Number) short0);
      JsonWriter jsonWriter3 = jsonWriter2.name("h4G/-h4(k\"");
      JsonWriter jsonWriter4 = jsonWriter3.beginArray();
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("bduT.");
      jsonWriter0.value("bduT.");
      assertEquals("[\nbduT.\"bduT.\"", stringWriter0.toString());
  }
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("iB;.~%\"M`p<t-2dwZu");
      // Undeclared exception!
      try { 
        jsonWriter0.name("iB;.~%\"M`p<t-2dwZu");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test68()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.value(";^_Kxo,eZe851");
      jsonWriter1.value(775L);
      assertEquals("\";^_Kxo,eZe851\"775", stringWriter0.toString());
  }
