...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-1190L));
      assertEquals("-1190", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-3136.5679));
      assertEquals("-3136.5679", stringWriter0.toString());
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-1206.0875623292723));
      assertEquals("-1206.0875623292723", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("Qr%*CW9I@");
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("dS/fMmkf *(2");
      assertEquals("dS/fMmkf *(2", stringWriter0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      assertEquals("{\"%y\":false}", stringWriter0.toString());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      jsonWriter0.endObject();
      jsonWriter0.value(654L);
      assertEquals("{}654", stringWriter0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("8DC}/@");
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value(";c>GU?2O7*9.Bn^j");
      // Undeclared exception!
      try { 
        jsonWriter0.value(0L);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test33()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(1986);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test36()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("?p");
      JsonWriter jsonWriter3 = jsonWriter2.nullValue();
      jsonWriter3.name("[fC?yv)G1'B5");
      jsonWriter3.beginArray();
      assertEquals("{\"?p\":null,\"[fC?yv)G1'B5\":[", stringWriter0.toString());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("HAF=iT_A5xu{a@F?");
      jsonWriter0.value(0L);
      assertEquals("[\nHAF=iT_A5xu{a@F?0", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("c>GU?2O7*.Bn^j");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test51()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(";c>GU?2O7*9.Bn^j");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name(";c>GU?2O7*9.Bn^j");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test52()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("J)p}~$<");
      // Undeclared exception!
      try { 
        jsonWriter1.name("Dy9^P>'Q`");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test55()  throws Throwable  {
      ...
      jsonWriter0.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[[[[[[[[[[[[[{\"yt\":[[", stringWriter0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("tBozmoHE\"]");
      // Undeclared exception!
      try { 
  ...
  public void test65()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(">u|ns$0&G4");
      assertEquals("\"\\u003eu|ns$0\\u0026G4\"", stringWriter0.toString());
  }
}
