...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      jsonWriter0.value("JsonWriter is cl&sed.");
      assertEquals("\"JsonWriter is cl&sed.\"", stringWriter0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("gQ`+rhxM");
      assertEquals("\"gQ`+rhxM\"", stringWriter0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(1198L);
      assertEquals("1198", stringWriter0.toString());
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-2565L));
      assertEquals("-2565", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("O>K0ML|II");
      assertEquals("O>K0ML|II", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("zo5S^mEh\">rinzN ");
      JsonWriter jsonWriter2 = jsonWriter1.beginArray();
      jsonWriter2.endArray();
      jsonWriter2.setHtmlSafe(true);
      jsonWriter2.endObject();
      assertTrue(jsonWriter1.isHtmlSafe());
      assertEquals("{\"zo5S^mEh\\\">rinzN \":[]}", stringWriter0.toString());
  }
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float(3113.0F);
      JsonWriter jsonWriter1 = jsonWriter0.value((Number) float0);
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("S#v,<B8qVRX]jn[");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test35()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("D`k'[O7=~4<m]Q#U,{");
      JsonWriter jsonWriter3 = jsonWriter2.value(4908.53906);
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      ...
      jsonWriter0.name("#<");
      jsonWriter1.value((-1.0));
      JsonWriter jsonWriter2 = jsonWriter1.name("aHG3O^x)=)y{@]Z@(\"");
      jsonWriter2.value((double) 62);
      assertEquals("{\"#<\":-1.0,\"aHG3O^x)=)y{@]Z@(\\\"\":62.0", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("+zoz/M`OrCCD-");
      jsonWriter1.close();
      jsonWriter1.close();
      assertEquals("+zoz/M`OrCCD-", stringWriter0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-327L));
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.value("U>&]$\"4|Y?J}(=<c");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(3702L);
      // Undeclared exception!
      try { 
        jsonWriter1.value(true);
        fail("Expecting exception: IllegalStateException");
