...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("<{SpCRUk9");
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("ed$Cc");
      assertEquals("\"ed$Cc\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("^8yz%/dV5@z?");
      assertEquals("\"^8yz%/dV5@z?\"", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Short short0 = new Short((short) (-4575));
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-0.7520973486381252));
      assertEquals("-0.7520973486381252", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(2975.59589233843);
      assertEquals("2975.59589233843", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("^8yz%/dV5@z?");
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("q8cj!/\u0001 xA}");
      assertEquals("q8cj!/\u0001 xA}", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test33()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("FP\"f5yW|p'Wu*~W");
      // Undeclared exception!
      try { 
        jsonWriter0.value(true);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value(1031.395754253824);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(1);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("$;93");
      jsonWriter1.setLenient(true);
      jsonWriter0.value(1L);
      assertEquals("\"$;93\"1", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("q8cj!/\u0001 xA}");
      // Undeclared exception!
      try { 
        jsonWriter1.value("z'p&&V1D");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      ...
      jsonWriter1.name("");
      JsonWriter jsonWriter2 = jsonWriter0.beginObject();
      jsonWriter2.name("Uv!aKU*");
      jsonWriter2.value((-1119.92));
      // Undeclared exception!
      try { 
        jsonWriter0.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("r'BxO S!A~");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test62()  throws Throwable  {
      ...
      JsonWriter jsonWriter5 = jsonWriter1.name("]");
  ...
  public void test73()  throws Throwable  {
      ...
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("FP\"f5yW|p'Wu*~W");
      assertEquals("\"FP\\\"f5yW|p\\u0027Wu*~W\"", stringWriter0.toString());
  }
}
