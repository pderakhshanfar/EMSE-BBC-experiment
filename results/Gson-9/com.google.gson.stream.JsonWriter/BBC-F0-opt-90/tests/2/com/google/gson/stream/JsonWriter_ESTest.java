...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-1128L));
      assertEquals("-1128", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("zkE");
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("Pj>.PTE\"99KQ^9C=EC");
      assertEquals("Pj>.PTE\"99KQ^9C=EC", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("zkE");
      jsonWriter0.beginObject();
      assertEquals("{\"zkE\":{", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("WN%W _)R\"&[t;-YR=K\"");
      assertEquals("\"WN%W _)R\\\"&[t;-YR=K\\\"\"", stringWriter0.toString());
  }
  ...
  public void test50()  throws Throwable  {
      ...
      assertEquals("{\"\\n\":[],\"Infinity\":null", stringWriter0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("n;%? 9~D_%_/fm\"+#m");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("O#*>O?j'r_F");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("O#*>O?j'r_F");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test62()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("D[O-g7_#P>DFkJrrp");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test75()  throws Throwable  {
      ...
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-2508L));
      assertEquals("-2508", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
}
