...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      jsonWriter0.endObject();
      jsonWriter1.value("X{:$h1Ow{=qK|m+d");
      assertEquals("{}\"X{:$h1Ow{=qK|m+d\"", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-1022.2330168));
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("p18`<WYlxF;V[Yk");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      jsonWriter1.jsonValue("NsrG8%j]>I8U/_`^3hy");
      assertEquals("{}NsrG8%j]>I8U/_`^3hy", stringWriter0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("$s(iUa:{!%RY,P&");
      assertEquals("$s(iUa:{!%RY,P&", stringWriter0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("Yf]");
      // Undeclared exception!
      try { 
        jsonWriter1.value((-1063L));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value((-2453.036251441966));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test36()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((long) 31);
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("2Ha1&Pa{o.CI<28l7");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("``H5Y%T]^axJ9");
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("m%w1UKnF,U{");
      JsonWriter jsonWriter3 = jsonWriter2.value(1304.3169733000575);
      jsonWriter2.name("&");
      jsonWriter3.jsonValue("m%w1UKnF,U{");
      assertEquals("{\"m%w1UKnF,U{\":1304.3169733000575,\"&\":m%w1UKnF,U{", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent(",Ii(");
      jsonWriter1.nullValue();
      assertEquals("[\n,Ii(null", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("2DW7\"b_3<\"\"F2");
      assertEquals("\"2DW7\\\"b_3<\\\"\\\"F2\"", stringWriter0.toString());
  }
