...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        jsonWriter0.value("}oy+x4M9_!*exy");
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("\"!L8A;o(");
      assertEquals("\"\\\"!L8A;o(\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Short short0 = new Short((short) (-5489));
      jsonWriter0.setSerializeNulls(false);
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(5971L);
      assertEquals("5971", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-15.210709931521036));
      assertEquals("-15.210709931521036", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      jsonWriter1.name("");
      jsonWriter0.setSerializeNulls(false);
      jsonWriter1.jsonValue("3~-ZetA*");
      assertEquals("{\"\":3~-ZetA*", stringWriter0.toString());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      jsonWriter2.value("`Co;$n`Tk\u0006ms^-V");
      jsonWriter0.endObject();
      assertEquals("{\"\":\"`Co;$n`Tk\\u0006ms^-V\"}", stringWriter0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(")y*BN");
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter15 = jsonWriter6.beginObject();
      JsonWriter jsonWriter16 = jsonWriter12.name("@mQ;KWBa<YjWNZ}:@");
      ...
      jsonWriter7.name("@mQ;KWBa<YjWNZ}:@");
      jsonWriter16.beginArray();
      jsonWriter15.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[[{\"@mQ;KWBa<YjWNZ}:@\":[[[[[[[[[[{\"@mQ;KWBa<YjWNZ}:@\":[[", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("");
      JsonWriter jsonWriter2 = jsonWriter1.value("~U$O-0?vmV/MX`(i");
      jsonWriter2.name("");
      jsonWriter1.nullValue();
      assertEquals("{\"\":\"~U$O-0?vmV/MX`(i\",\"\":null", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("\"!L8A;o(");
      Long long0 = Long.getLong("\"!L8A;o(", 0L);
      // Undeclared exception!
      try { 
  ...
  public void test57()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.name("(voqzJP]0lk;b{l?6");
      // Undeclared exception!
      try { 
        jsonWriter0.endArray();
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Dangling name: (voqzJP]0lk;b{l?6
         //
         verifyException("com.google.gson.stream.JsonWriter", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(",`NY#O");
      assertEquals("\",`NY#O\"", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
}
