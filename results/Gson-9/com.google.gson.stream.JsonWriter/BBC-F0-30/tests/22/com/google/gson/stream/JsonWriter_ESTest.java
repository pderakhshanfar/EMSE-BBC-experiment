...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(5208);
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(233L);
      assertEquals("233", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("l2g!ShODvUm:^");
      assertEquals("l2g!ShODvUm:^", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      Double double0 = new Double((-1352.3288403389497));
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter14 = jsonWriter7.name("q,@p\"[_#_H[ {");
      jsonWriter3.beginArray();
      jsonWriter4.beginArray();
      ...
      jsonWriter7.name("q,@p\"[_#_H[ {");
      jsonWriter14.beginObject();
      jsonWriter6.name("q,@p\"[_#_H[ {");
      jsonWriter4.beginArray();
      jsonWriter9.beginObject();
      jsonWriter10.name("q,@p\"[_#_H[ {");
      jsonWriter12.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[{\"q,@p\\\"[_#_H[ {\":[[[[[[[[[{\"q,@p\\\"[_#_H[ {\":{\"q,@p\\\"[_#_H[ {\":[{\"q,@p\\\"[_#_H[ {\":[", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter2.jsonValue("_-lnbE8V`x7MAPc2.");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      jsonWriter0.name("");
      jsonWriter2.jsonValue("_-lnbE8V`x7MAPc2.");
      assertEquals("{\"com.google.gson.stream.JsonWriter\":0.0,\"\":_-lnbE8V`x7MAPc2.", stringWriter0.toString());
  }
