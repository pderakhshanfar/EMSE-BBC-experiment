...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      jsonWriter0.value("{<o]6e)");
      assertEquals("\"{\\u003co]6e)\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(1644L);
      assertEquals("1644", stringWriter0.toString());
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("2iH");
      assertEquals("2iH", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(2045);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("T6|rb");
      // Undeclared exception!
      try { 
        jsonWriter1.value((-67L));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value((double) (short) (-495));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("B.dA (bML");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("T6|rb");
      jsonWriter0.beginObject();
      assertEquals("{\"T6|rb\":{", stringWriter0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-2876.5770519));
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("dI<9t+.s}O&A[C|FiK");
        fail("Expecting exception: IllegalStateException");
