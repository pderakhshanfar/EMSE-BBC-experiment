...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("8sDXWoT:.{3%WD");
      // Undeclared exception!
      try { 
        jsonWriter2.jsonValue("(M%+U");
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("[7u]VcjK Jae-/");
      assertEquals("\"[7u]VcjK Jae-/\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-1522L));
      assertEquals("-1522", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(3812.242767);
      assertEquals("3812.242767", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-21.925662321933686));
      assertEquals("-21.925662321933686", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("{]},Lm<i;");
      assertEquals("{]},Lm<i;", stringWriter0.toString());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      JsonWriter jsonWriter3 = jsonWriter2.jsonValue("#)2*a_ilUy`yYo");
      jsonWriter3.setLenient(true);
      jsonWriter1.endObject();
      assertEquals("{\"NaN\":#)2*a_ilUy`yYo}", stringWriter0.toString());
  }
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-693.68989200355));
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(1427);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("8sDXWoT:.{3%WD");
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("(M%+U");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("8sDXWoT:.{3%WD");
      jsonWriter0.value("8sDXWoT:.{3%WD");
      // Undeclared exception!
      try { 
        jsonWriter0.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test43()  throws Throwable  {
      ...
      jsonWriter1.name("8sDXWoT:.{3%WD");
      jsonWriter0.beginObject();
      assertEquals("{\"8sDXWoT:.{3%WD\":{", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter3 = jsonWriter2.value((long) 357);
      jsonWriter3.name("");
      assertEquals("{\"\":357", stringWriter0.toString());
  ...
  public void test48()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("[7u]VcjK Jae-/");
      jsonWriter0.value("[7u]VcjK Jae-/");
      assertEquals("[\n[7u]VcjK Jae-/\"[7u]VcjK Jae-/\"", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("rI?<A1\"hO'FnQ&\"H");
      assertEquals("\"rI?<A1\\\"hO'FnQ&\\\"H\"", stringWriter0.toString());
  }
  ...
  public void test50()  throws Throwable  {
      ...
      jsonWriter2.jsonValue("#)2*a_ilUy`yYo");
      jsonWriter1.endObject();
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value(114.94002163);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test63()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("#)2*a_ilUy`yYo");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.nullValue();
