...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      String string0 = "d^\\ustDBF4y'#R)\\";
      jsonWriter0.value(string0);
      assertEquals("\"d^\\\\ustDBF4y'#R)\\\\\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("c|j=SN ");
      assertEquals("\"c|j=SN \"", stringWriter0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      jsonWriter0.endObject();
      jsonWriter0.setHtmlSafe(true);
      Float float0 = new Float((float) (-917L));
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-4471L));
      assertEquals("-4471", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-1.1980547821671779));
      assertEquals("-1.1980547821671779", stringWriter0.toString());
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(1209.7);
      assertEquals("1209.7", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(170.233144099992);
      assertEquals("170.233144099992", stringWriter0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("c|j=SN ");
  ...
  public void test32()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("X\"mpo");
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("v/e8tV:DDb+RuXsMR,");
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.value((-6404L));
      jsonWriter1.beginObject();
      assertEquals("[-6404,{", stringWriter0.toString());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      jsonWriter1.name("L171");
      jsonWriter0.beginObject();
      assertEquals("{\"L171\":{", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      JsonWriter jsonWriter8 = jsonWriter4.name("java.lang.Integer@0000000002");
      ...
      JsonWriter jsonWriter22 = jsonWriter19.beginArray();
      assertFalse(jsonWriter22.isHtmlSafe());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value(":/:I%G.)3tS662@N");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("B-.5]A`|FB");
  ...
  public void test44()  throws Throwable  {
      ...
      jsonWriter0.name("");
      JsonWriter jsonWriter1 = jsonWriter0.value(0L);
      jsonWriter1.name("BY2eR5$>L?3yhs{");
      jsonWriter1.beginArray();
      assertEquals("{\"\":0,\"BY2eR5$>L?3yhs{\":[", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent(" .cUX-B(}g)");
      jsonWriter0.value(false);
      assertEquals("[\n .cUX-B(}g)false", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("Y-#1");
      jsonWriter1.close();
      jsonWriter1.close();
      assertEquals("\"Y-#1\"", stringWriter0.toString());
  }
  ...
  public void test50()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("lO7s_Ae5?\n:");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test52()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Double double0 = new Double(1276.57);
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("d'VM FxJ,&*Tm\"0");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("v/e8tV:DDb+RuXsMR,");
      // Undeclared exception!
      try { 
        jsonWriter0.name("v/e8tV:DDb+RuXsMR,");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test60()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.name("Wm/yU,cK9sdQW");
      // Undeclared exception!
      try { 
  ...
  public void test63()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value((-1.1980547821671779));
      jsonWriter0.endArray();
      assertEquals("[-1.1980547821671779]", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
