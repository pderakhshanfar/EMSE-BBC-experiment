...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("S)`O2Rr\"Zu");
      // Undeclared exception!
      try { 
        jsonWriter2.value((double) 31);
  ...
  public void test04()  throws Throwable  {
      ...
      jsonWriter0.value("QvkUX!X./1i,`a");
      assertEquals("\"QvkUX!X./1i,`a\"", stringWriter0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("0z}gZ");
      assertEquals("\"0z}gZ\"", stringWriter0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(1524L);
      assertEquals("1524", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.name("r2t`,75t8vFT,HcjiG3");
      assertFalse(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("~xT^H,Q()`g");
      assertEquals("~xT^H,Q()`g", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("cTMyp%%%2uo7l5*B");
      jsonWriter2.jsonValue("cTMyp%%%2uo7l5*B");
      assertEquals("{\"cTMyp%%%2uo7l5*B\":cTMyp%%%2uo7l5*B", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue(";uhVDlB+dr_}X9tV//");
      assertEquals(";uhVDlB+dr_}X9tV//", stringWriter0.toString());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.nullValue();
      Double double0 = new Double((-526.823));
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("r2t`,75t8vFT,HcjiG3");
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("r2t`,75t8vFT,HcjiG3");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("fH$Qm.6[_jq(l");
      jsonWriter1.beginObject();
      assertEquals("{\"fH$Qm.6[_jq(l\":{", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("fH$Qm.6[_jq(l");
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("0z}gZ");
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value(0L);
      assertEquals("[\n0z}gZ0", stringWriter0.toString());
  }
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("~9\"XI42(^gh]&~t");
      assertEquals("\"~9\\\"XI42(^gh]&~t\"", stringWriter0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.name("Kc/`aW$T(v~`1N#G3Y");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test59()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("Y}q0/0]lS/.,u+[sY(");
      // Undeclared exception!
      try { 
        jsonWriter0.name("~RU6YITRN");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test69()  throws Throwable  {
      ...
      jsonWriter2.name(">L<8pO|-n@X");
      jsonWriter0.value(78L);
      assertEquals("{\"i^\":0.0,\">L<8pO|-n@X\":78", stringWriter0.toString());
  }
  ...
  public void test73()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("Y}q0/0]lS/.,u+[sY(");
      assertEquals("\"Y}q0/0]lS/.,u+[sY(\"", stringWriter0.toString());
  }
}
