...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("Bx{- VG.WX");
      // Undeclared exception!
      try { 
        jsonWriter2.value("Bx{- VG.WX");
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("([nMfSxTi`)Lsg0Pf");
      assertEquals("\"([nMfSxTi`)Lsg0Pf\"", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(2483);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-1261.8618));
      assertEquals("-1261.8618", stringWriter0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("VL#1?");
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("#Q0aGs1{}bWczaQ+V\"");
      assertEquals("#Q0aGs1{}bWczaQ+V\"", stringWriter0.toString());
  }
  ...
  public void test32()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("Bx{- VG.WX");
      // Undeclared exception!
      try { 
        jsonWriter1.value("Bx{- VG.WX");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test33()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("'lQ\"T*Tc6#w*TJSniW");
  ...
  public void test37()  throws Throwable  {
      ...
      jsonWriter1.name("FY\"pKo([B8hcN^.8");
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("HmX})mEOq%Uii");
      jsonWriter1.beginObject();
      assertEquals("{\"HmX})mEOq%Uii\":{", stringWriter0.toString());
  }
  ...
  public void test40()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("Rep `5'uy");
      jsonWriter0.setLenient(true);
      jsonWriter1.value((-1.0));
      assertEquals("Rep `5'uy-1.0", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(2);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("pfV*'4=uA(X],\"K");
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("pfV*'4=uA(X],\"K");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("6,az\"STWF`R8k4");
      JsonWriter jsonWriter3 = jsonWriter2.value(1390L);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      jsonWriter2.value(1414L);
      jsonWriter1.name("AMTR4");
      jsonWriter1.nullValue();
      assertEquals("{\"\":1414,\"AMTR4\":null", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("#Q0aGs1{}bWczaQ+V\"");
      jsonWriter1.beginArray();
      assertEquals("[\n#Q0aGs1{}bWczaQ+V\"[", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("1,[PLWd}lh");
      jsonWriter1.close();
      jsonWriter0.close();
      assertEquals("\"1,[PLWd}lh\"", stringWriter0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("java.lang.Sort0000000002");
      jsonWriter1.setSerializeNulls(false);
      jsonWriter0.nullValue();
      jsonWriter0.value((-1721L));
      assertEquals("-1721", stringWriter0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("java.lang.Sort0000000002");
      // Undeclared exception!
      try { 
        jsonWriter0.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("r-'L/K0`!7vKa}$X$r3");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name("`GZNgT`");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test71()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("r-'L/K0`!7vKa}$X$r3");
      assertEquals("\"r-\\u0027L/K0`!7vKa}$X$r3\"", stringWriter0.toString());
  }
}
