...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(",5pAT>UOme3rZ6*A");
      assertEquals("\",5pAT>UOme3rZ6*A\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Double double0 = new Double(2417.544268812913);
      jsonWriter0.setHtmlSafe(true);
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-76L));
      assertEquals("-76", stringWriter0.toString());
  ...
  public void test10()  throws Throwable  {
      ...
      jsonWriter2.value(3878L);
      assertEquals("{\"\":3878", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(1523.366014);
      assertEquals("1523.366014", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(2417.544268812913);
      assertEquals("2417.544268812913", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((double) (-923L));
      assertEquals("-923.0", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("U5");
      assertEquals("U5", stringWriter0.toString());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("#0W{8^Y");
      jsonWriter0.setSerializeNulls(false);
      jsonWriter1.beginObject();
      jsonWriter0.endObject();
      assertEquals("{\"#0W{8^Y\":{}", stringWriter0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.setLenient(true);
      JsonWriter jsonWriter2 = jsonWriter0.name("A#<7RuK`O");
      jsonWriter2.beginObject();
      assertEquals("{\"A#<7RuK`O\":{", stringWriter0.toString());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("");
      jsonWriter1.jsonValue("xcS;x@*Urd'ug!<E");
      // Undeclared exception!
      try { 
        jsonWriter0.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      ...
      jsonWriter1.nullValue();
      jsonWriter0.jsonValue("U5");
      assertEquals("[null,U5", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.setIndent("WXHNHY{^f&-m]5=KYJ");
      jsonWriter1.value("WXHNHY{^f&-m]5=KYJ");
      assertEquals("[\nWXHNHY{^f&-m]5=KYJ\"WXHNHY{^f&-m]5=KYJ\"", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("bC'\"hcEt0^U]6u\t");
      assertEquals("\"bC'\\\"hcEt0^U]6u\\t\"", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("m00d");
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("m00d");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test45()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("^Y2V!YOjI3");
      jsonWriter1.close();
      jsonWriter1.close();
      assertEquals("\"^Y2V!YOjI3\"", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("8hbf-}I!IS");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
  ...
  public void test57()  throws Throwable  {
      ...
      JsonWriter jsonWriter15 = jsonWriter4.name("#0W{8^Y");
      jsonWriter13.beginArray();
      ...
      jsonWriter5.name("#0W{8^Y");
      jsonWriter14.beginArray();
      jsonWriter8.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[[[[{\"#0W{8^Y\":[[[[[[[[{\"#0W{8^Y\":[[", stringWriter0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.value("rMVNtc");
      jsonWriter1.endArray();
      assertEquals("[\"rMVNtc\"]", stringWriter0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("m00d");
      assertEquals("\"m00d\"", stringWriter0.toString());
  }
}
