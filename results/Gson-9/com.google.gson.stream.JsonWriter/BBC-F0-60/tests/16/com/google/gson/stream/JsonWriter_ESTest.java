...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("I]SMF;6xq@MHM!");
      // Undeclared exception!
      try { 
        jsonWriter2.value((double) 84);
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-1190.9254));
      assertEquals("-1190.9254", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-560.45051335));
      assertEquals("-560.45051335", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("Ininity");
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("mKvY*CEaDr");
      assertFalse(jsonWriter1.getSerializeNulls());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("'rS+7LxglreVI4N>=");
      assertEquals("'rS+7LxglreVI4N>=", stringWriter0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("+MAAF^~n~1%F0$vrS\"");
      // Undeclared exception!
      try { 
        jsonWriter1.value("+MAAF^~n~1%F0$vrS\"");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("xAbf");
      JsonWriter jsonWriter2 = jsonWriter1.value((-2266.5));
      jsonWriter2.name("xAbf");
      jsonWriter0.beginObject();
      assertEquals("{\"xAbf\":-2266.5,\"xAbf\":{", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((double) 4677);
      jsonWriter1.close();
      jsonWriter0.close();
      assertEquals("4677.0", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(4678);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("(mH!Nv*m");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.flush();
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(1538);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(14);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value(48.19137);
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name("java.lang.Inteer@0000000002");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("Fd_I#Q=K'(^] fNkkU%");
      // Undeclared exception!
      try { 
        jsonWriter1.name("Fd_I#Q=K'(^] fNkkU%");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test71()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("\"I)=EEY{ EI4reUudk");
      assertEquals("\"\\\"I)\\u003dEEY{ EI4reUudk\"", stringWriter0.toString());
  }
}
