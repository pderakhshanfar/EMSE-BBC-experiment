...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Float float0 = new Float((-2552.58));
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-1152L));
      assertEquals("-1152", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(658L);
      assertEquals("658", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(1445.09034434523);
      assertEquals("1445.09034434523", stringWriter0.toString());
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("i^%qPm\"nXe97");
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("l4^&,54/K");
      assertEquals("l4^&,54/K", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("YtgEn");
      assertEquals("YtgEn", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test31()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name(";fKwD");
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("j255I%");
      // Undeclared exception!
      try { 
        jsonWriter0.value(1165.2015320106748);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      ...
      jsonWriter0.jsonValue("l4^&,54/K");
      assertEquals("[null,l4^&,54/K", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("&ava.lang.Double@0000000003");
      assertEquals("[", stringWriter0.toString());
      
      jsonWriter1.jsonValue("YtgEn");
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test44()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("+J;Ha1Fd#F,|{%|hv");
      jsonWriter1.close();
      jsonWriter1.close();
      assertEquals("\"+J;Ha1Fd#F,|{%|hv\"", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("l4^&,54/K");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test49()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("*^d]GBV<~c;|!f");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("h,uwM>zfBdJ");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.endObject();
  ...
  public void test66()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.value("ys#c=Re4i");
      jsonWriter1.beginObject();
      assertEquals("\"ys#c=Re4i\"{", stringWriter0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("h,uwM>zfBdJ");
      assertEquals("\"h,uwM\\u003ezfBdJ\"", stringWriter0.toString());
  }
}
