...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("KB.[Ngw$*(Jt[6#b");
      assertEquals("\"KB.[Ngw$*(Jt[6#b\"", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-3250L));
      assertEquals("-3250", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((double) 110);
      assertEquals("110.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("uZ");
      assertEquals("uZ", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("ORq?]s9 2QNZe8");
      assertEquals("ORq?]s9 2QNZe8", stringWriter0.toString());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      jsonWriter1.name("&ZsXmGHY~P~X4'.eUHo");
  ...
  public void test27()  throws Throwable  {
      ...
      jsonWriter0.name("+rVOG@s?|");
      jsonWriter0.beginObject();
      jsonWriter0.endObject();
      assertEquals("{\"+rVOG@s?|\":{}", stringWriter0.toString());
  }
  ...
  public void test32()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("KB.[Ngw$*(Jt[6#b");
      // Undeclared exception!
      try { 
        jsonWriter1.value("KB.[Ngw$*(Jt[6#b");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("F\u0001szF)03v7$-h|");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("^W,5%ByB`V\"fPEV/v");
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value(1637L);
      jsonWriter2.beginObject();
      assertEquals("[1637,{", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      jsonWriter0.nullValue();
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-3986.9212694472726));
      assertEquals("null-3986.9212694472726", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("");
      JsonWriter jsonWriter2 = jsonWriter0.value(1810.0);
      jsonWriter2.name("})Y0A\"P");
      jsonWriter0.beginObject();
      assertEquals("{\"\":1810.0,\"})Y0A\\\"P\":{", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("W!T");
      jsonWriter0.jsonValue("W!T");
      assertEquals("[\nW!TW!T", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("7j5_caXe");
      jsonWriter1.close();
      jsonWriter1.close();
      assertEquals("\"7j5_caXe\"", stringWriter0.toString());
  }
  ...
  public void test50()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("*'(p=BaSS;W1");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("3F xGl[k,8-`?=!!dl7");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test57()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("[6yB@&i(T&8efI'Q=");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test60()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("V)%jO<OhC%DM6&q ");
      // Undeclared exception!
      try { 
        jsonWriter0.endObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test66()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.jsonValue("ORq?]s9 2QNZe8");
      jsonWriter0.endArray();
      assertEquals("[ORq?]s9 2QNZe8]", stringWriter0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("*'(p=BaSS;W1");
      assertEquals("\"*\\u0027(p\\u003dBaSS;W1\"", stringWriter0.toString());
  }
}
