...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-1542L));
      assertEquals("-1542", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(3011L);
      assertEquals("3011", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-3138.605991740059));
      assertEquals("-3138.605991740059", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("sS%9a8>@q1");
      jsonWriter1.setLenient(true);
      jsonWriter0.beginArray();
      jsonWriter1.name("JNULoTU3K\"j+1T");
      assertEquals("{\"sS%9a8>@q1\":[", stringWriter0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("sS%9a8>@q1");
      jsonWriter1.setLenient(true);
      jsonWriter0.jsonValue("sS%9a8>@q1");
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("(}bPwGjRQy1WdT1");
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.beginObject();
      jsonWriter0.endObject();
      assertEquals("{\"(}bPwGjRQy1WdT1\":{}", stringWriter0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter2.value("JSON must have only one top-level value.");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("]VV");
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("sS%9a8>@q1");
      jsonWriter1.value("sS%9a8>@q1");
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value((-2766L));
      jsonWriter2.jsonValue("-Infinity");
      assertEquals("[-2766,-Infinity", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      jsonWriter3.name("`+h{'s T}&W/j");
      jsonWriter3.jsonValue("`+h{'s T}&W/j");
      assertEquals("{\"sS%9a8>@q1\":[],\"`+h{'s T}&W/j\":`+h{'s T}&W/j", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter12 = jsonWriter1.beginObject();
      jsonWriter11.name("");
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("sS%9a8>@q1");
      jsonWriter2.setIndent("sS%9a8>@q1");
      jsonWriter2.beginArray();
      assertEquals("{\nsS%9a8>@q1\"sS%9a8>@q1\": [", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("Eg\\iFRM%+bCM[0");
      assertEquals("\"Eg\\\\iFRM%+bCM[0\"", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((long) 'T');
      jsonWriter1.close();
      jsonWriter0.close();
      assertEquals("84", stringWriter0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Float float0 = new Float((float) (-1542L));
  ...
  public void test69()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("t Dp?ZVIa3 F0DwU'");
      assertEquals("\"t Dp?ZVIa3 F0DwU\\u0027\"", stringWriter0.toString());
  }
}
