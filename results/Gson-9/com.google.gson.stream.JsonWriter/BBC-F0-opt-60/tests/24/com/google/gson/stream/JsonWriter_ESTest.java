...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("XJHQp\".F'v}KS)*");
      jsonWriter1.value((double) (byte)0);
      assertEquals("{\"XJHQp\\\".F\\u0027v}KS)*\":0.0", stringWriter0.toString());
  }
  ...
  public void test03()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(4472);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("5O=BWOUUQ<");
      assertEquals("\"5O=BWOUUQ<\"", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-1390L));
      assertEquals("-1390", stringWriter0.toString());
      assertFalse(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) (-414L));
      assertEquals("-414.0", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(1378.34309192239);
      assertEquals("1378.34309192239", stringWriter0.toString());
      assertFalse(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("-I^k,Hnity");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter0.name("XJHQp\".F'v}KS)*");
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("$dm@r>R6G(`%");
      jsonWriter1.beginObject();
      assertEquals("{\"$dm@r>R6G(`%\":{", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("$dm@r>R6G(`%");
      jsonWriter1.value("$dm@r>R6G(`%");
      JsonWriter jsonWriter2 = jsonWriter0.name("$dm@r>R6G(`%");
      jsonWriter2.nullValue();
      assertEquals("{\"$dm@r>R6G(`%\":\"$dm@r>R6G(`%\",\"$dm@r>R6G(`%\":null", stringWriter0.toString());
  }
  ...
  public void test40()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float((-1203.5F));
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.value((-1142.348223095834));
      jsonWriter1.jsonValue("-I^k,Hnity");
      assertEquals("[-1142.348223095834,-I^k,Hnity", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent("3?h@");
      jsonWriter0.beginObject();
      assertEquals("[\n3?h@{", stringWriter0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.name("QKWOHt~#4KWa xyM8");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.name("o2N@\"x.^*E8gO4`-[3{");
        fail("Expecting exception: IllegalStateException");
