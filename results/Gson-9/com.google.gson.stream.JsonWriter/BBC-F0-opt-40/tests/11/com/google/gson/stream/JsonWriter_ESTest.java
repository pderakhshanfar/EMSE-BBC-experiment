...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-2866.10146));
      assertEquals("-2866.10146", stringWriter0.toString());
      assertFalse(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("V=2*~ a>#B#");
      assertEquals("V=2*~ a>#B#", stringWriter0.toString());
      assertFalse(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter3 = jsonWriter0.value((double) 2857);
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("8I");
  ...
  public void test35()  throws Throwable  {
      ...
      jsonWriter1.jsonValue("V=2*~ a>#B#");
      assertEquals("[true,V=2*~ a>#B#", stringWriter0.toString());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("\t");
      jsonWriter2.nullValue();
      jsonWriter1.name("Uxl q~1Z]>;");
      jsonWriter2.beginArray();
      assertEquals("{\"\\t\":null,\"Uxl q~1Z]>;\":[", stringWriter0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.name(":kpCLgz\"/rd94~X");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name(" \":Zf`C\"$g`/';j");
      // Undeclared exception!
      try { 
        jsonWriter1.name("java.lang.Double@0000000002");
        fail("Expecting exception: IllegalStateException");
