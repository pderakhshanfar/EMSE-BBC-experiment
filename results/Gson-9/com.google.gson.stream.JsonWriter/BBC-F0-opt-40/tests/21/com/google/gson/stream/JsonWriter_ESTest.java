...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Double double0 = new Double(1470.668833381);
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Double double0 = new Double(1974.51022423);
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(3455L);
      assertEquals("3455", stringWriter0.toString());
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-1499.1601444276903));
      assertEquals("-1499.1601444276903", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("u5-0r7");
  ...
  public void test28()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("J|-TMURI-9},ai");
      jsonWriter1.value("4RyMI<)B^HB6i6}");
      assertEquals("{\"J|-TMURI-9},ai\":\"4RyMI<)B^HB6i6}\"", stringWriter0.toString());
  }
  ...
  public void test35()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-2202.48049645477));
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("J|-TMURI-9},ai");
      JsonWriter jsonWriter2 = jsonWriter1.value("4RyMI<)B^HB6i6}");
      jsonWriter1.name("4RyMI<)B^HB6i6}");
      jsonWriter2.beginObject();
      assertEquals("{\"J|-TMURI-9},ai\":\"4RyMI<)B^HB6i6}\",\"4RyMI<)B^HB6i6}\":{", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      jsonWriter2.value((double) (-1930L));
      assertEquals("[]-1930.0", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent("er7``Tv6e");
      jsonWriter0.beginObject();
      assertEquals("[\ner7``Tv6e{", stringWriter0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("+8oSKNqyTErfY");
      // Undeclared exception!
      try { 
        jsonWriter1.name("+8oSKNqyTErfY");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test69()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("<u^7}*zcR>]");
      assertEquals("\"\\u003cu^7}*zcR\\u003e]\"", stringWriter0.toString());
  }
}
