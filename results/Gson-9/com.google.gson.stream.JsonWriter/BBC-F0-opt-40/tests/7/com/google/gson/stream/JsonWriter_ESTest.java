...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter1.name("PJ6 &23lA.>Q)eDi(");
      // Undeclared exception!
      try { 
        jsonWriter0.value("OdDm2\"/U-/+=Em");
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("[M|*cV");
      assertEquals("\"[M|*cV\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(927L);
      assertEquals("927", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) (short)3111);
      assertEquals("3111.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((double) 927L);
      assertEquals("927.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-1177.19));
      assertEquals("-1177.19", stringWriter0.toString());
  }
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter3 = jsonWriter2.value("X.f8:F{K,.[FihEl|");
      jsonWriter3.name("3");
      jsonWriter0.jsonValue("\"");
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value((-2196L));
      jsonWriter2.beginObject();
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("\"");
      jsonWriter2.value("X.f8:F{K,.[FihEl|");
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("\"");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("\"");
      JsonWriter jsonWriter3 = jsonWriter2.value("X.f8:F{K,.[FihEl|");
      JsonWriter jsonWriter4 = jsonWriter3.name("3");
      jsonWriter2.beginObject();
      // Undeclared exception!
      try { 
        jsonWriter4.value((-2184.56842093));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent(">Q%g!");
      jsonWriter1.beginObject();
      assertEquals("[\n>Q%g!{", stringWriter0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Float float0 = new Float((float) (short)3111);
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(1);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("[M|*cV");
      // Undeclared exception!
      try { 
  ...
  public void test61()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.name("j@=A{\"e{b9");
      // Undeclared exception!
      try { 
  ...
  public void test70()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("+u=+;Y>)+Z-DX8tz");
      assertEquals("\"+u\\u003d+;Y\\u003e)+Z-DX8tz\"", stringWriter0.toString());
  }
}
