...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("!gZWkw#>&2R\"x");
      assertEquals("\"!gZWkw#>&2R\\\"x\"", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-2767L));
      assertEquals("-2767", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      jsonWriter1.name("$a}M-b.+ W#'o(O");
      jsonWriter0.value((double) 1186);
      assertEquals("{\"$a}M-b.+ W#'o(O\":1186.0", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("B4YA&H]F\"NoUQ,Qw");
      assertEquals("B4YA&H]F\"NoUQ,Qw", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("$WyWi/{;K");
      jsonWriter1.setLenient(true);
      jsonWriter0.value("$WyWi/{;K");
      assertEquals("\"$WyWi/{;K\"\"$WyWi/{;K\"", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("\f");
      Double double0 = Double.valueOf((-2997.7));
      jsonWriter1.value((Number) double0);
      // Undeclared exception!
      try { 
        jsonWriter1.value((-2997.7));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("di");
      JsonWriter jsonWriter3 = jsonWriter2.value(false);
      jsonWriter3.name("di");
      jsonWriter2.value(false);
      assertEquals("{\"di\":false,\"di\":false", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("eR)pv^ i(l,WB&>)");
      jsonWriter0.beginArray();
      jsonWriter0.value("eR)pv^ i(l,WB&>)");
      assertEquals("[\neR)pv^ i(l,WB&>)\"eR)pv^ i(l,WB&>)\"", stringWriter0.toString());
  }
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("!gZWkw#>R2R\"xi");
      jsonWriter1.close();
      Float float0 = new Float((-642.26324867));
      // Undeclared exception!
      try { 
  ...
  public void test61()  throws Throwable  {
      ...
      jsonWriter18.beginArray();
      JsonWriter jsonWriter19 = jsonWriter11.beginArray();
  ...
  public void test62()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("P&KK %lO80+-/;##6");
      // Undeclared exception!
      try { 
  ...
  public void test70()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.value((-952.2796190211413));
      jsonWriter0.endArray();
      assertEquals("[-952.2796190211413]", stringWriter0.toString());
  }
