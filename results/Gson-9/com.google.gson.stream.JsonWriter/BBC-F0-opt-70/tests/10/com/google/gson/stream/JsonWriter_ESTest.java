...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("OEj%Z?X");
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("*=O}[m_*j/UjZ.due");
      jsonWriter2.beginArray();
      assertEquals("{\"*=O}[m_*j/UjZ.due\":[", stringWriter0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      jsonWriter0.value("^Agcm|o");
      assertEquals("\"^Agcm|o\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Float float0 = new Float(2142.3F);
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(583L);
      assertEquals("583", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(1353L);
      assertEquals("1353", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue(">shto.Q2{s");
      assertEquals(">shto.Q2{s", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("Ft2UjFmx9(W]9`(\"BIY");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("JS0e]|K]$ieYh=P<N=");
      assertEquals("JS0e]|K]$ieYh=P<N=", stringWriter0.toString());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      jsonWriter2.value(true);
      JsonWriter jsonWriter3 = jsonWriter1.name("RN:Gp]`.xnI-Pa>");
      jsonWriter3.beginObject();
      assertEquals("{\"l(\":true,\"RN:Gp]`.xnI-Pa>\":{", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-3651.7319573));
      jsonWriter1.setLenient(true);
      jsonWriter0.value(true);
      assertEquals("-3651.7319573true", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("Nv0l7W_");
      jsonWriter1.jsonValue("N%0h0yb&h]");
      // Undeclared exception!
      try { 
        jsonWriter0.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test45()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("4izx<7?G^rS6{");
      jsonWriter0.beginArray();
      jsonWriter0.beginArray();
      assertEquals("[\n4izx<7?G^rS6{[", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(1727);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("gS'kPpi(b}RDb\"rkV");
      jsonWriter1.close();
      jsonWriter1.close();
      assertEquals("\"gS'kPpi(b}RDb\\\"rkV\"", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("rUYUf~]'lS. 4w");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.flush();
  ...
  public void test52()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("8oc^G");
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("X?y$-f@4CK1");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("X?y$-f@4CK1");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test59()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("ZQ9KAB!z$U+Y Nmx");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test72()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("$4AnSVNV");
      assertEquals("\"$4AnSVNV\"", stringWriter0.toString());
  }
}
