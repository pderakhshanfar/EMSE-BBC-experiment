...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("QWq2kF=zSMW");
      assertEquals("\"QWq2kF=zSMW\"", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-185.56029513278));
      assertEquals("-185.56029513278", stringWriter0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("Ab5,-c,o5& |6xM");
      assertTrue(jsonWriter1.getSerializeNulls());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("92rB4C_ns~");
      assertEquals("92rB4C_ns~", stringWriter0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      jsonWriter0.name("/86C!5!p");
      jsonWriter0.beginObject();
      assertEquals("{\"/86C!5!p\":{", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-2131L));
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("/86C!5!p");
      jsonWriter1.nullValue();
      // Undeclared exception!
      try { 
        jsonWriter0.beginObject();
  ...
  public void test38()  throws Throwable  {
      ...
      jsonWriter2.value("{EI7Rd");
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("{EI7Rd");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent("92rB4C_ns~");
      jsonWriter0.jsonValue("92rB4C_ns~");
      assertEquals("[\n92rB4C_ns~92rB4C_ns~", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("");
      jsonWriter2.value("{EI7Rd");
      JsonWriter jsonWriter3 = jsonWriter2.name("{EI7Rd");
      jsonWriter3.jsonValue("{EI7Rd");
      assertEquals("{\"\":\"{EI7Rd\",\"{EI7Rd\":{EI7Rd", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value((double) 3279L);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test51()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("saq~_|!)VLW6=ElQc");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test66()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("\"y{y}@4V&*>oJ@zjsGB");
      assertEquals("\"\\\"y{y}@4V\\u0026*\\u003eoJ@zjsGB\"", stringWriter0.toString());
  }
}
