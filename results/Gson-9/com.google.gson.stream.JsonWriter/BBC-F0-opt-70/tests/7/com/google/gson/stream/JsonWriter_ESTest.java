...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("wv;KtDf");
  ...
  public void test04()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("]6;qI%e =2R${");
      assertEquals("\"]6;qI%e =2R${\"", stringWriter0.toString());
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-481L));
      assertEquals("-481", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(4201L);
      assertEquals("4201", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-2197.6105044618694));
      assertEquals("-2197.6105044618694", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("java.lang.FloaI@0000000002");
      assertTrue(jsonWriter1.getSerializeNulls());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("^~I%,%:RoZ>VD:X-Q@X");
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("Y=_4GrZ*K}");
      assertEquals("Y=_4GrZ*K}", stringWriter0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("%y`E<jo");
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("^~I%,%:RoZ>VD:X-Q@X");
      // Undeclared exception!
      try { 
        jsonWriter0.value("^~I%,%:RoZ>VD:X-Q@X");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test33()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter0.name("JH,7Q90iR8{fBA");
      jsonWriter1.value(true);
      // Undeclared exception!
      try { 
        jsonWriter2.value((-1915L));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value((-3281.320696850675));
      jsonWriter0.setLenient(true);
      jsonWriter0.value(0.0);
      assertEquals("-3281.3206968506750.0", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("|P");
      jsonWriter1.setIndent("\"s`k;\"d7z0`s~@WP,");
      jsonWriter1.beginObject();
      assertEquals("{\n\"s`k;\"d7z0`s~@WP,\"|P\": {", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("|P");
      jsonWriter1.value((-203L));
      jsonWriter1.name("\"s`k;\"d7z0`s~@WP,");
      jsonWriter1.beginObject();
      assertEquals("{\"|P\":-203,\"\\\"s`k;\\\"d7z0`s~@WP,\":{", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("c>$A&!N|W7;^)UN");
      assertEquals("\"c\\u003e$A\\u0026!N|W7;^)UN\"", stringWriter0.toString());
  }
  ...
  public void test50()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(2065);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((long) 2065);
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.flush();
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("java.lang.FloaI@0000000002");
      // Undeclared exception!
      try { 
        jsonWriter0.nullValue();
        fail("Expecting exception: IllegalStateException");
