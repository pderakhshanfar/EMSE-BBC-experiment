...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("b4O*|KbxrFJLV$");
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals("{\"b4O*|KbxrFJLV$\":false", stringWriter0.toString());
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("\\0f 3d");
      assertEquals("\"\\\\0f 3d\"", stringWriter0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-930L));
      assertEquals("-930", stringWriter0.toString());
  ...
  public void test09()  throws Throwable  {
      ...
      jsonWriter1.setHtmlSafe(true);
      jsonWriter1.value(0L);
      assertEquals("{\"b4O*|KbxrFJLV$\":0", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-1050.2047143));
      assertEquals("-1050.2047143", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("b4O*|KbxrFJLV$");
      jsonWriter1.setHtmlSafe(true);
      jsonWriter1.jsonValue("CjASfQ");
      assertEquals("{\"b4O*|KbxrFJLV$\":CjASfQ", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test40()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("0U2/C1\"m%H12[*B~O");
      // Undeclared exception!
      try { 
        jsonWriter0.beginArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("b4O*|KbxrFJLV$");
      jsonWriter1.value("b4O*|KbxrFJLV$");
      jsonWriter0.name("b4O*|KbxrFJLV$");
      jsonWriter1.beginArray();
      assertEquals("{\"b4O*|KbxrFJLV$\":\"b4O*|KbxrFJLV$\",\"b4O*|KbxrFJLV$\":[", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent("\\0f 3d");
      jsonWriter0.value("\\0f 3d");
      assertEquals("[\n\\0f 3d\"\\\\0f 3d\"", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("#hFA[|$mE!k.8sM1<j");
      jsonWriter0.close();
      jsonWriter0.close();
      assertEquals("\"#hFA[|$mE!k.8sM1<j\"", stringWriter0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("\"W%]4}I5[?wdJ';F");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("L[M#u*CV{Bja#9*b");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test70()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("8 <U;");
      assertEquals("\"8 \\u003cU;\"", stringWriter0.toString());
  }
}
