...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("[4Uz>%kNw");
      assertEquals("\"[4Uz>%kNw\"", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(2540L);
      assertEquals("2540", stringWriter0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("kt'y.l");
  ...
  public void test20()  throws Throwable  {
      ...
      jsonWriter3.jsonValue("s_cAMt#+V0");
  ...
  public void test33()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(" f+kS*");
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("N$|N");
      // Undeclared exception!
      try { 
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter3.jsonValue("JsonWriter is closed.");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("e:~33Q!RFQ}");
      JsonWriter jsonWriter1 = jsonWriter0.value(0L);
      JsonWriter jsonWriter2 = jsonWriter1.name("e:~33Q!RFQ}");
      jsonWriter2.beginObject();
      assertEquals("{\"e:~33Q!RFQ}\":0,\"e:~33Q!RFQ}\":{", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      jsonWriter0.setIndent("P75h@");
      jsonWriter2.endArray();
      assertEquals("[[null\nP75h@]", stringWriter0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("ZYBG\"<\"_:#x");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name("^Nqsx,L,Ivqy:");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(1612);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("6h'r#2;[P$z+v,45{");
      // Undeclared exception!
      try { 
        jsonWriter0.name("6h'r#2;[P$z+v,45{");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test60()  throws Throwable  {
      ...
      jsonWriter3.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[[[[[[[[[[[{\"8\\n>h5s?>X$6 \":[[[[", stringWriter0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.name("6h'r#2;[P$z+v,45{");
      // Undeclared exception!
      try { 
        jsonWriter0.endArray();
        fail("Expecting exception: IllegalStateException");
