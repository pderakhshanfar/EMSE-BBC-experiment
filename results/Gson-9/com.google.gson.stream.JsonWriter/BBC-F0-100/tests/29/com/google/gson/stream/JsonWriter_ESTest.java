...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name(".0DpJ|xPef^z*");
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("9)H&\"{c{$#PbA&*+`l");
      assertEquals("\"9)H&\\\"{c{$#PbA&*+`l\"", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(1210.928);
      assertEquals("1210.928", stringWriter0.toString());
      assertFalse(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      jsonWriter0.name("");
      JsonWriter jsonWriter1 = jsonWriter0.value(2749.9);
      // Undeclared exception!
      try { 
        jsonWriter1.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("77]");
  ...
  public void test42()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("0O)f0o");
      jsonWriter1.setLenient(true);
      jsonWriter1.value(false);
      assertEquals("\"0O)f0o\"false", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value(1210.928);
      jsonWriter2.value("\u2029");
      assertEquals("[1210.928,\"\\u2029\"", stringWriter0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name(".+X;v");
      jsonWriter1.setSerializeNulls(false);
  ...
  public void test64()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.name("HF'lQ5n+z2PM(7,%@>");
      // Undeclared exception!
      try { 
        jsonWriter2.endArray();
        fail("Expecting exception: IllegalStateException");
