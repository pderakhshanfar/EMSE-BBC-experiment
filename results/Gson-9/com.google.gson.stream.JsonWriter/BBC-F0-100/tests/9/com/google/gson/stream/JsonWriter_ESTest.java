...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("3q;");
      // Undeclared exception!
      try { 
        jsonWriter2.value(813.7);
  ...
  public void test06()  throws Throwable  {
      ...
      jsonWriter1.value("\"");
      assertEquals("{\"3q;\":\"\\\"\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("i/AQFz");
      jsonWriter2.setSerializeNulls(false);
      JsonWriter jsonWriter3 = jsonWriter2.beginObject();
      jsonWriter3.name("z:MjU>w',0yy^o");
      jsonWriter1.value(0L);
      assertEquals("{\"i/AQFz\":{\"z:MjU>w',0yy^o\":0", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("J)E0(]iex_}+a?<NC");
      assertEquals("J)E0(]iex_}+a?<NC", stringWriter0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("JBzB+pWyt]");
      assertEquals("JBzB+pWyt]", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter0.name("3q;");
      jsonWriter1.beginArray();
      jsonWriter2.setSerializeNulls(false);
      jsonWriter0.endArray();
      assertEquals("{\"3q;\":[]", stringWriter0.toString());
  ...
  public void test29()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("3q;");
      // Undeclared exception!
      try { 
        jsonWriter0.value("'U{y65xu_}dqdH30a)b");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test35()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("vf~T8L>nH^p7 d");
      jsonWriter1.setSerializeNulls(false);
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("k3te3Ro[$&0B");
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value("k3te3Ro[$&0B");
      jsonWriter2.nullValue();
      assertEquals("[\"k3te3Ro[$&0B\",null", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("3q;");
      jsonWriter1.setIndent("3q;");
      jsonWriter1.beginArray();
      assertEquals("{\n3q;\"3q;\": [", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value("k3te3Ro[$&0B");
      jsonWriter1.setIndent("K |v\b==4g&->8'");
      jsonWriter2.endArray();
      assertEquals("[\"k3te3Ro[$&0B\"\n]", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Short short0 = new Short((short)4229);
  ...
  public void test50()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("^K)SO");
      jsonWriter0.setSerializeNulls(false);
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("java.lang.Float@0000000004");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("{");
  ...
  public void test59()  throws Throwable  {
      ...
      jsonWriter1.name("3q;");
      jsonWriter1.beginArray();
      JsonWriter jsonWriter2 = jsonWriter0.name("z'z)kM1xxN@");
      // Undeclared exception!
      try { 
        jsonWriter2.endArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test63()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-2241L));
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("c.w^U");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test66()  throws Throwable  {
      ...
      jsonWriter1.name("3q;");
      jsonWriter0.value((Number) null);
      assertEquals("{\"\":[],\"3q;\":null", stringWriter0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      jsonWriter1.value((double) 4331);
      assertEquals("null4331.0", stringWriter0.toString());
  }
