...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("i1iopErc\"{|$?z;B<");
      assertEquals("\"i1iopErc\\\"{|$?z;B<\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-3309L));
      assertEquals("-3309", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(887.9872577195105);
      assertEquals("887.9872577195105", stringWriter0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("^V]RT .;-y");
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("39UXr,vs25[ 56");
      assertEquals("39UXr,vs25[ 56", stringWriter0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      jsonWriter0.name("!@C<m{DR&WV|4A$");
      jsonWriter0.setLenient(true);
      jsonWriter0.beginObject();
      jsonWriter0.endObject();
      assertTrue(jsonWriter0.isLenient());
  ...
  public void test26()  throws Throwable  {
      ...
      assertTrue(jsonWriter0.isHtmlSafe());
      assertEquals("{\"!@C\\u003cm{DR\\u0026WV|4A$\":{}", stringWriter0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("!@C<m{DR&W/M;V|4A$");
      jsonWriter1.setSerializeNulls(false);
      JsonWriter jsonWriter2 = jsonWriter0.beginObject();
      jsonWriter2.endObject();
      assertEquals("{\"!@C<m{DR&W/M;V|4A$\":{}", stringWriter0.toString());
  }
  ...
  public void test32()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("eJ;>'");
      // Undeclared exception!
      try { 
        jsonWriter1.value("");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter10 = jsonWriter8.name("!@C<m{Ds&WV|4A$");
      ...
      jsonWriter12.name("!@C<m{Ds&WV|4A$");
      ...
      jsonWriter11.beginArray();
      jsonWriter0.beginArray();
      assertEquals("[[[[[[[[[[[{\"!@C<m{Ds&WV|4A$\":[[[[[[[[[[[[[{\"!@C<m{Ds&WV|4A$\":[[[[[[", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name(",M(#am@wWErJ|PY");
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent(".4r?EH");
      jsonWriter1.nullValue();
      assertEquals("[\n.4r?EHnull", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float((-248.545));
  ...
  public void test51()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float(2380.708F);
      JsonWriter jsonWriter1 = jsonWriter0.value((Number) float0);
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("H,%N");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test52()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("+ZeFLB=7B&EJ]MF/");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("+ZeFLB=7B&EJ]MF/");
      // Undeclared exception!
      try { 
        jsonWriter0.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("i1iopErc\"{|$?z;B<");
      // Undeclared exception!
      try { 
        jsonWriter1.name("");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test59()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(16);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((double) 16);
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.endArray();
  ...
  public void test63()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("xgFk5;i^V");
      JsonWriter jsonWriter1 = jsonWriter0.value(false);
      jsonWriter1.name("xgFk5;i^V");
      jsonWriter0.jsonValue("Dl:p3JPRJ>oSO");
      assertEquals("{\"xgFk5;i^V\":false,\"xgFk5;i^V\":Dl:p3JPRJ>oSO", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("61N@l]Qz3>`");
      assertEquals("\"61N@l]Qz3\\u003e`\"", stringWriter0.toString());
  }
}
