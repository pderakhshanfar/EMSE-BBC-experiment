...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-3412L));
      assertEquals("-3412", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-1829.326));
      assertEquals("-1829.326", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("ZCk`p9P-|??[G XVG");
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value("f81)");
      jsonWriter2.jsonValue("f81)");
      assertEquals("[\"f81)\",f81)", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("q&W59o]J;3'{");
      jsonWriter1.beginObject();
      assertEquals("{\"q&W59o]J;3'{\":{", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue(":k8l@r?");
      // Undeclared exception!
      try { 
        jsonWriter1.value(":k8l@r?");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("RM$Wca\u0006-ssruk");
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.nullValue();
      assertEquals("[\nRM$Wca\u0006-ssruknull", stringWriter0.toString());
  }
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(" |`yAC0WwW:(");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name(" |`yAC0WwW:(");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test61()  throws Throwable  {
      ...
      JsonWriter jsonWriter13 = jsonWriter3.name("Tja");
      jsonWriter5.beginArray();
      jsonWriter13.beginArray();
      jsonWriter8.beginObject();
      jsonWriter5.name("Tja");
      jsonWriter10.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[[[[[[[[[[[{\"Tja\":[[{\"Tja\":[", stringWriter0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("kW>cm;#@Z9l&|@");
