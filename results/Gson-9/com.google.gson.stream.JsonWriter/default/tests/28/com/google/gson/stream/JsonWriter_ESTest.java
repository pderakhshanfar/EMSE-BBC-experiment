...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("gw;`M}(ee1^'/Ca8");
      assertEquals("\"gw;`M}(ee1^'/Ca8\"", stringWriter0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("rpJ-d8?gq/");
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-434L));
      assertEquals("-434", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-1000.5315765021635));
      assertEquals("-1000.5315765021635", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(3358.422899471456);
      assertEquals("3358.422899471456", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("SyZ\"{,");
      assertEquals("SyZ\"{,", stringWriter0.toString());
      assertFalse(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test39()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-70.81787));
      // Undeclared exception!
      try { 
        jsonWriter1.value((-70.81787));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("^B<}`3M^G#");
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("^B<}`3M^G#");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test48()  throws Throwable  {
      ...
      jsonWriter0.beginArray();
      assertEquals("{\"NaN\":false,\"NaN\":[", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("_PCsp");
      jsonWriter0.nullValue();
      assertEquals("[\n_PCspnull", stringWriter0.toString());
  }
  ...
  public void test50()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("&zl!~A\"I/YN1h]cYE");
      assertEquals("\"&zl!~A\\\"I/YN1h]cYE\"", stringWriter0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("~l:{?KNd:{92my<n");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name("~l:{?KNd:{92my<n");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test62()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("java.lng.Bye@0000000002");
      // Undeclared exception!
      try { 
        jsonWriter1.name("java.lng.Bye@0000000002");
        fail("Expecting exception: IllegalStateException");
