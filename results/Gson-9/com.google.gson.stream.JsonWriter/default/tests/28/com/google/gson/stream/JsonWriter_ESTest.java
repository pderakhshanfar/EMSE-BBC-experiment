...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter0.name("pI#_gs%f~j+.JQ7'>eb");
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("@FYO");
      assertEquals("\"@FYO\"", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) (byte) (-105));
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("<3|$Jq&/~5~uQiSY");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((double) 444);
      // Undeclared exception!
      try { 
        jsonWriter1.value((long) 444);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("?35h");
      jsonWriter1.beginObject();
      assertEquals("{\"?35h\":{", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("g\"l#!b=Lj1");
      jsonWriter1.setLenient(true);
      jsonWriter0.nullValue();
      assertEquals("\"g\\\"l#!b=Lj1\"null", stringWriter0.toString());
  }
  ...
  public void test59()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("s +h7t*Y*M2(Sy@");
      // Undeclared exception!
      try { 
        jsonWriter1.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test64()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.name("*{/|1=t%u5]HgU{y2");
      // Undeclared exception!
      try { 
        jsonWriter1.endArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test73()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("ioDv f2'NIMjN%P");
      assertEquals("\"ioDv f2\\u0027NIMjN%P\"", stringWriter0.toString());
  }
}
