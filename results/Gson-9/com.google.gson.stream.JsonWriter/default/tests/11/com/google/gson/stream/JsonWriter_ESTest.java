...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      jsonWriter0.value("a|c'i]qM4CY#,><j]j");
      assertEquals("\"a|c\\u0027i]qM4CY#,\\u003e\\u003cj]j\"", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(")9u'CnfXu^]fe`nZ7");
      assertEquals("\")9u'CnfXu^]fe`nZ7\"", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue(")9u'CnfXu^]fe`nZ7");
      assertEquals(")9u'CnfXu^]fe`nZ7", stringWriter0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("%?oK.d`1Ku >#'-");
      assertEquals("%?oK.d`1Ku >#'-", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("lR");
      // Undeclared exception!
      try { 
        jsonWriter1.value("lR");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value(2731.583201256);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test48()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("E9)U=$;4C@[&-;*m+K");
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("e}NT!");
      jsonWriter1.beginArray();
      assertEquals("[\ne}NT![", stringWriter0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.name("w tR");
      // Undeclared exception!
      try { 
