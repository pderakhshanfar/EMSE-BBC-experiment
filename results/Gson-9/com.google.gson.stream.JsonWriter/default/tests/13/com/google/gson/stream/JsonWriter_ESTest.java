...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("[O\"Q L\"cN{>$$QmFPe");
      assertEquals("\"[O\\\"Q L\\\"cN{>$$QmFPe\"", stringWriter0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("vhUga:`(,x<;N");
      jsonWriter1.setSerializeNulls(false);
      jsonWriter1.beginObject();
      jsonWriter1.name("\">{[2");
      jsonWriter2.value(true);
      assertEquals("{\"vhUga:`(,x<;N\":{\"\\\">{[2\":true", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("vhUga:`(,x<;N");
      jsonWriter1.setLenient(true);
      jsonWriter1.value(0L);
      assertEquals("{\"vhUga:`(,x<;N\":0", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-2219.9371813722555));
      assertEquals("-2219.9371813722555", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-787.350721831));
      assertEquals("-787.350721831", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals("{\"vhUga:`(,x<;N\":1.0", stringWriter0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter0.name("eJZYR;!");
      jsonWriter2.jsonValue("");
      assertTrue(jsonWriter0.isHtmlSafe());
      assertEquals("{\"eJZYR;!\":", stringWriter0.toString());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("OaSh5c");
      jsonWriter0.setHtmlSafe(true);
      jsonWriter1.beginObject();
      jsonWriter1.name("OaSh5c");
  ...
  public void test24()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("+m}OT8h*]zK{'");
      JsonWriter jsonWriter3 = jsonWriter2.nullValue();
      jsonWriter3.endObject();
      jsonWriter3.setLenient(true);
      jsonWriter3.jsonValue("t9RPuFk1ab6~&]");
      assertEquals("{\"+m}OT8h*]zK{'\":null}t9RPuFk1ab6~&]", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("OaSR5c");
      ...
      JsonWriter jsonWriter15 = jsonWriter10.name("OaSR5c");
      jsonWriter15.beginArray();
      jsonWriter8.beginArray();
      jsonWriter4.beginArray();
      jsonWriter9.beginArray();
      jsonWriter0.beginArray();
      assertEquals("{\"OaSR5c\":[[[[[[[[[[[[[[[[[[[[[[[[[{\"OaSR5c\":[[[[[", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name(" Dx6{O}@m@6(0'@");
      jsonWriter0.value(" Dx6{O}@m@6(0'@");
      // Undeclared exception!
      try { 
        jsonWriter2.value(" Dx6{O}@m@6(0'@");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent(">]Nz");
      jsonWriter0.beginArray();
      assertEquals("[\n>]Nz[", stringWriter0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name(",W:fpDhy;,OmcU");
      // Undeclared exception!
      try { 
        jsonWriter1.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test58()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("s<NC]fyN~mC?]ZFE");
      // Undeclared exception!
      try { 
        jsonWriter1.name("s<NC]fyN~mC?]ZFE");
        fail("Expecting exception: IllegalStateException");
