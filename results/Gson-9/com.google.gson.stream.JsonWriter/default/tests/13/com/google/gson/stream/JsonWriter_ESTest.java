...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("{0$Tc0rt|#RdKWBiF");
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("p4EH8Hr!\".p!a=|2r");
      assertEquals("\"p4EH8Hr!\\\".p!a=|2r\"", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-931.478129));
      assertEquals("-931.478129", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("+R#Ng");
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.beginObject();
      assertEquals("[\n+R#Ng{", stringWriter0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("l:!Y");
      // Undeclared exception!
      try { 
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.name("csb7J)pCsI0peqR/I/");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test59()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("java.l7g.Double|00000w03");
      // Undeclared exception!
      try { 
        jsonWriter0.name("java.l7g.Double|00000w03");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test63()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.name("IUF8@gP|XZotBCX`F");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Dangling name: IUF8@gP|XZotBCX`F
         //
         verifyException("com.google.gson.stream.JsonWriter", e);
      }
  }
