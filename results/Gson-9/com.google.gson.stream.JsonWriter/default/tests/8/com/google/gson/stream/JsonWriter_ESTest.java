...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter0.name("2/[_S(K2~nV/orp");
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("'A,&g6ip:e");
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("Riu^REwBQ\"8");
      assertEquals("\"Riu^REwBQ\\\"8\"", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("#B~ps");
      assertEquals("\"#B~ps\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("gk9$VL^dhm<zvl");
      assertEquals("\"gk9$VL^dhm<zvl\"", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals("161", stringWriter0.toString());
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((long) (short) (-583));
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-2692L));
      assertEquals("-2692", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("5iTQ|6`H5");
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("J_(O~EZ1B85e'{");
      jsonWriter0.beginObject();
      assertEquals("{\"J_(O~EZ1B85e'{\":{", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("-ITbi3ity");
      JsonWriter jsonWriter2 = jsonWriter0.value((Number) short0);
      jsonWriter0.name("T;V1Dv");
      JsonWriter jsonWriter3 = jsonWriter2.jsonValue("MG");
  ...
  public void test63()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("#M|[,hOnjO2y:rOu>");
      // Undeclared exception!
      try { 
        jsonWriter0.name("#M|[,hOnjO2y:rOu>");
        fail("Expecting exception: IllegalStateException");
