...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter1.name("fu?{w1G`^Tbk|}J[<&1");
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("fu?{w1G`^Tbk|}J[<&1");
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("B_\" RELilc=$2ps");
      assertEquals("\"B_\\\" RELilc=$2ps\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("7.v7Q2r");
      assertEquals("\"7.v7Q2r\"", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Float float0 = new Float((-1544.7487721226407));
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-567.3));
      assertEquals("-567.3", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("fu?{w1G`^Tbk|}J[<&1");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue(":N}Ti&H-z.gHPj!_X");
      assertEquals(":N}Ti&H-z.gHPj!_X", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test35()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float(1240.53762194693);
      JsonWriter jsonWriter1 = jsonWriter0.value((Number) float0);
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("$HAkr");
      JsonWriter jsonWriter3 = jsonWriter2.value(false);
      jsonWriter3.name("$HAkr");
      jsonWriter0.beginObject();
      assertEquals("{\"$HAkr\":false,\"$HAkr\":{", stringWriter0.toString());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      jsonWriter14.beginArray();
      jsonWriter3.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[{\"d\":[[[[[[[[{\"d\":[{\"d\":[[[", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter0.name("tIcM:OXD3wYX*s>~9");
      jsonWriter2.value((Number) null);
      jsonWriter1.name("tIcM:OXD3wYX*s>~9");
      jsonWriter2.value("tIcM:OXD3wYX*s>~9");
      assertEquals("{\"tIcM:OXD3wYX*s>~9\":null,\"tIcM:OXD3wYX*s>~9\":\"tIcM:OXD3wYX*s>~9\"", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.setIndent("PD_AG,^iGDAFXji$}");
      jsonWriter1.beginObject();
      assertEquals("[\nPD_AG,^iGDAFXji$}{", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("fuw1G`^Tk|}J<&1");
      jsonWriter0.close();
      jsonWriter1.close();
      assertEquals("\"fuw1G`^Tk|}J<&1\"", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("fuw1G`^Tk|}J<&1");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter0.flush();
  ...
  public void test50()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(7419);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
  ...
  public void test51()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("|u_s5");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.name("ava.lang.Double@00000002");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test65()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value("2V8Y");
      jsonWriter0.endArray();
      assertEquals("[\"2V8Y\"]", stringWriter0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("fu?{w1G`^Tbk|}J[<&1");
      assertEquals("\"fu?{w1G`^Tbk|}J[\\u003c\\u00261\"", stringWriter0.toString());
  }
}
