...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((double) 783);
      assertEquals("783.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(3512.466);
      assertEquals("3512.466", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("@@8:|yRHY$kK_5';7");
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("?x8a0>+RoopH$BTf");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("g|CKLDnp%= 2@r3{S%O");
      assertEquals("g|CKLDnp%= 2@r3{S%O", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("Z'r t++");
      assertEquals("Z'r t++", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      jsonWriter1.jsonValue("=Jry");
      assertEquals("=Jry", stringWriter0.toString());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(3520L);
      jsonWriter0.value((-553.05104502));
      assertEquals("3520-553.05104502", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("java.lang.Doubl@0000000002");
      jsonWriter0.nullValue();
      // Undeclared exception!
      try { 
        jsonWriter1.beginObject();
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value("Z'r t++");
      jsonWriter2.jsonValue("Z'r t++");
      assertEquals("[\"Z'r t++\",Z'r t++", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("PHLja$3~& JIo0");
      JsonWriter jsonWriter2 = jsonWriter1.value(true);
      jsonWriter2.name("|^4LR*pG");
      jsonWriter0.beginArray();
      assertEquals("{\"PHLja$3~& JIo0\":true,\"|^4LR*pG\":[", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("\")4Q$Z%J^");
      jsonWriter1.value("S`=zyL,L`");
      assertEquals("[\n\")4Q$Z%J^\"S`=zyL,L`\"", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("\")4Q$Z%J^");
      assertEquals("\"\\\")4Q$Z%J^\"", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-3645.843721));
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      Float float0 = new Float((-1658.88131046));
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("nNr,.xFd'`ECp6z");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test58()  throws Throwable  {
      ...
      jsonWriter12.beginArray();
      jsonWriter11.beginArray();
      JsonWriter jsonWriter19 = jsonWriter4.beginObject();
      jsonWriter16.name("2");
      jsonWriter3.beginArray();
      jsonWriter19.beginObject();
      jsonWriter9.name("2");
  ...
  public void test70()  throws Throwable  {
      ...
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("7=K\".q8]_N~>");
      assertEquals("\"7\\u003dK\\\".q8]_N~\\u003e\"", stringWriter0.toString());
  }
}
