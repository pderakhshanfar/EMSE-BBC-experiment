...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Float float0 = new Float(1378.514F);
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(4154.7798);
      assertEquals("4154.7798", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(0.6413737248006876);
      assertEquals("0.6413737248006876", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-2945.7062156087445));
      assertEquals("-2945.7062156087445", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("Lgy29i|");
      assertEquals("Lgy29i|", stringWriter0.toString());
  }
  ...
  public void test32()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("KR 2VV");
      // Undeclared exception!
      try { 
        jsonWriter1.value("dZs%p)?TdcAU2m4 .1B");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("w]4jT=%iJ/2QzJ0");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("?Blw^z2O");
      jsonWriter2.value("~v3^20=QV{iu,u'");
      jsonWriter2.name("?Blw^z2O");
      jsonWriter1.beginObject();
      assertEquals("{\"?Blw^z2O\":\"~v3^20=QV{iu,u'\",\"?Blw^z2O\":{", stringWriter0.toString());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name(",eA`.");
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("?Blw^z2O");
      JsonWriter jsonWriter3 = jsonWriter2.value("~v3^20=QV{iu,u'");
      jsonWriter2.name("?Blw^z2O");
      jsonWriter3.value("");
      assertEquals("{\"?Blw^z2O\":\"~v3^20=QV{iu,u'\",\"?Blw^z2O\":\"\"", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("CSBw&}e:sq%y");
      jsonWriter0.value(4154.7798);
      assertEquals("[\nCSBw&}e:sq%y4154.7798", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("R,G\"UV2,-9#n9fL");
      assertEquals("\"R,G\\\"UV2,-9#n9fL\"", stringWriter0.toString());
  }
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("?Blw^z2O");
      // Undeclared exception!
      try { 
  ...
  public void test62()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(38);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("$[kg{<;[");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.value(3899.78304);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test66()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value(0.6413737248006876);
      jsonWriter0.endArray();
      assertEquals("[0.6413737248006876]", stringWriter0.toString());
  }
