...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("u+L22WD");
  ...
  public void test02()  throws Throwable  {
      ...
      jsonWriter1.name("-D$xUey4Al");
      jsonWriter0.value(true);
      assertEquals("{\"-D$xUey4Al\":true", stringWriter0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("my`}2~I2V");
      assertEquals("\"my`}2~I2V\"", stringWriter0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-2226L));
      assertEquals("-2226", stringWriter0.toString());
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(3319L);
      assertEquals("3319", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(2487.65);
      assertEquals("2487.65", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("uG{6&gYO2");
      assertEquals("uG{6&gYO2", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.beginObject();
      jsonWriter0.name("$:5b!$?c!=a oM@C)");
      jsonWriter0.beginObject();
      jsonWriter0.endObject();
      assertEquals("{\"$:5b!$?c!=a oM@C)\":{}", stringWriter0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value((-1223.94677406));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test33()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("O");
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue(":Qmcbh+Jc`!X=tYC9$I");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test34()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-1223.94677406));
      // Undeclared exception!
      try { 
        jsonWriter1.value("eGK3%0)[ex4so}@");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test35()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name(",p$oN");
      jsonWriter0.value(",p$oN");
      // Undeclared exception!
      try { 
        jsonWriter0.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test38()  throws Throwable  {
      ...
      jsonWriter12.name(",p$oN");
      jsonWriter16.beginArray();
      jsonWriter14.beginArray();
      jsonWriter0.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[[[[[[[[[[[[{\",p$oN\":[[[", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      assertEquals("null\"out == null\"", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("jaa.lang.Long@0000000002");
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent(">(-+:{4[9 K+ .F0-");
      jsonWriter0.beginArray();
      assertEquals("[\n>(-+:{4[9 K+ .F0-[", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(2466.132246761051);
      jsonWriter1.close();
      jsonWriter0.close();
      assertEquals("2466.132246761051", stringWriter0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("87T#1");
      // Undeclared exception!
      try { 
        jsonWriter1.name("");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test57()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.name("S,uO7T`1^");
      // Undeclared exception!
      try { 
        jsonWriter1.endArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test60()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.value((-62.66139));
      jsonWriter1.endArray();
      assertEquals("[-62.66139]", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("6L#!}e0oBQ9]|\"Q\"nym");
      assertEquals("\"6L#!}e0oBQ9]|\\\"Q\\\"nym\"", stringWriter0.toString());
  }
}
