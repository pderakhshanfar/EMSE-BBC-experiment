...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value(2671.7773440144333);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test56()  throws Throwable  {
      ...
      JsonWriter jsonWriter17 = jsonWriter4.name("NaN");
      ...
      jsonWriter18.name("NaN");
      jsonWriter4.beginArray();
      jsonWriter13.beginObject();
      jsonWriter15.name("NaN");
      jsonWriter2.beginArray();
      assertEquals("[[{\"NaN\":[[[[[[[[[[[[[[[[[[[[{\"NaN\":{\"NaN\":[[[{\"NaN\":[{\"NaN\":[", stringWriter0.toString());
  }
