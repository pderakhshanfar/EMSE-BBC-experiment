...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      jsonWriter0.name("7@f7:#63^r\"IuKm`=BD");
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals("1967", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test12()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(8229);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-1629.217367887203));
      assertEquals("-1629.217367887203", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-8.46546408974597));
      assertEquals("-8.46546408974597", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("QwP");
      assertEquals("QwP", stringWriter0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter0.name("7@f7:#63^r\"IuKm`=BD");
      jsonWriter1.setSerializeNulls(false);
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      String string0 = " \\%0E3Ka&\\uCm*FAQ>Z";
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name(",aTZ");
  ...
  public void test42()  throws Throwable  {
      ...
      jsonWriter0.name("eeX1,");
      JsonWriter jsonWriter2 = jsonWriter1.value((-658L));
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("-=q6GGv!");
      // Undeclared exception!
      try { 
        jsonWriter1.value("-=q6GGv!");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("o \"m;G3ns");
      // Undeclared exception!
      try { 
        jsonWriter1.name("o \"m;G3ns");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test59()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.name("_lYMUOgPnA2$RI");
      // Undeclared exception!
      try { 
        jsonWriter0.endArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test63()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("-=q6GGv!");
      jsonWriter1.setHtmlSafe(true);
      JsonWriter jsonWriter2 = jsonWriter1.value("-=q6GGv!");
      jsonWriter2.endObject();
      assertTrue(jsonWriter1.isHtmlSafe());
      assertEquals("{\"-\\u003dq6GGv!\":\"-\\u003dq6GGv!\"}", stringWriter0.toString());
  }
