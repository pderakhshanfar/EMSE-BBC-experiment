...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name(":iKQZX<Su;-G.?a1");
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("!9/7y");
      jsonWriter0.setSerializeNulls(false);
      jsonWriter1.value((long) 53);
      assertEquals("{\"!9/7y\":53", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("!h@JN~");
      assertEquals("!h@JN~", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("r^Zo");
  ...
  public void test26()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("r^Zo");
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("r^Zo");
      jsonWriter1.endObject();
      assertEquals("{\"r^Zo\":\"r^Zo\"}", stringWriter0.toString());
  }
  ...
  public void test32()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("GR=t[.=qSWfk?");
      // Undeclared exception!
      try { 
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("aEp#/3e");
      // Undeclared exception!
      try { 
        jsonWriter1.value(4240L);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test38()  throws Throwable  {
      ...
      jsonWriter2.value((-1937.54178844898));
      assertEquals("[]-1937.54178844898", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("yNX|q6)Ms<oDV(");
      jsonWriter0.value((-3945L));
      // Undeclared exception!
      try { 
        jsonWriter0.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("yNX|q6)Ms<oDV(");
      JsonWriter jsonWriter2 = jsonWriter1.value((long) 4);
      JsonWriter jsonWriter3 = jsonWriter2.name("yNX|q6)Ms<oDV(");
      jsonWriter3.beginObject();
      assertEquals("{\"yNX|q6)Ms<oDV(\":4,\"yNX|q6)Ms<oDV(\":{", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("-!::bO8CTyOTf\";sn");
      assertEquals("\"-!::bO8CTyOTf\\\";sn\"", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("o+O7{#LSt(qjD3d");
      jsonWriter1.close();
      jsonWriter1.close();
      assertEquals("\"o+O7{#LSt(qjD3d\"", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test48()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("o+O7{#LS4(qj3d");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.flush();
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("!h@JN~");
      jsonWriter0.beginArray();
      jsonWriter0.jsonValue("!h@JN~");
      assertEquals("[\n!h@JN~!h@JN~", stringWriter0.toString());
  }
