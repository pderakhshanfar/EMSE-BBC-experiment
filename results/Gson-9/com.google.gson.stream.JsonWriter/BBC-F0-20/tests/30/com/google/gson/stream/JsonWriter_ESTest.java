...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      jsonWriter0.name(".r2VYa\". *34");
      jsonWriter1.beginArray();
      assertEquals("{\".r2VYa\\\". *34\":[", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name(".r2VYa\". *34");
      jsonWriter1.value(".r2VYa\". *34");
      assertEquals("{\".r2VYa\\\". *34\":\".r2VYa\\\". *34\"", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      jsonWriter1.endObject();
      jsonWriter0.setSerializeNulls(false);
      jsonWriter1.value(1847L);
      assertEquals("[{},1847", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      jsonWriter2.value((double) (-3062.5813F));
      assertEquals("[{},-3062.581298828125", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("7;IlbqQ,O{U");
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("7&i'");
      assertEquals("7&i'", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name(".r2VYa\". *34");
  ...
  public void test28()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("S\"ns.@Q^t+H9YE2Z]");
      jsonWriter1.jsonValue("S\"ns.@Q^t+H9YE2Z]");
      assertEquals("{\"S\\\"ns.@Q^t+H9YE2Z]\":S\"ns.@Q^t+H9YE2Z]", stringWriter0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value("e-9cyFC1z.?IEn");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test35()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("R6nURq-clLdWq");
      jsonWriter0.nullValue();
      // Undeclared exception!
      try { 
        jsonWriter0.beginObject();
  ...
  public void test37()  throws Throwable  {
      ...
      jsonWriter2.value(1709L);
      assertEquals("[]1709", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("Sw+FLHbw(#V2");
      Float float0 = Float.valueOf((float) 1411);
      jsonWriter0.value((Number) float0);
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      ...
      jsonWriter1.value((double) 1411);
      jsonWriter1.name("NaN");
      jsonWriter0.value(0L);
      assertEquals("{\"\":1411.0,\"NaN\":0", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("[`BmMGs>Kd^{'%");
      jsonWriter1.nullValue();
      assertEquals("[\n[`BmMGs>Kd^{'%null", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(1683.41216422);
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.flush();
  ...
  public void test50()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("@nI<!%vc#?~]rn5}n]*");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("KJ*GYZ i=F_sst.vEuc");
      // Undeclared exception!
      try { 
  ...
  public void test58()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      JsonWriter jsonWriter6 = jsonWriter2.name("!'*;T;Y");
      jsonWriter1.beginArray();
      ...
      assertEquals("[[[[[[{\"!'*;T;Y\":[[[[[[[[[[[[[[[[[[[[[[[[[", stringWriter0.toString());
  }
  ...
  public void test70()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(".abxsdS4{Farh");
      assertEquals("\".abxsdS4{Farh\"", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
}
