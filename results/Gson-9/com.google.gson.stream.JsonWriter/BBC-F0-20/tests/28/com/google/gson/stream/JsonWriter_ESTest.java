...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      jsonWriter0.setLenient(true);
      jsonWriter0.value(">:Q'<DAGG&'D");
      assertEquals("\">:Q'<DAGG&'D\"", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((long) 1278);
      assertEquals("1278", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) 1278);
      assertEquals("1278.0", stringWriter0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name(">:Q'<DAGG&'D");
      assertTrue(jsonWriter1.getSerializeNulls());
  }
  ...
  public void test31()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float((-1774.315933772));
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.jsonValue("JZ{H\"");
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("1*_k?\"^m7[Rbdfz0-");
      jsonWriter1.jsonValue("-Infinity");
      assertEquals("[JZ{H\",{\"1*_k?\\\"^m7[Rbdfz0-\":-Infinity", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("Ww$SZG9j(Y?+my");
      JsonWriter jsonWriter1 = jsonWriter0.value(true);
      JsonWriter jsonWriter2 = jsonWriter1.name("von`2V1q\"G)MGO");
      jsonWriter2.value(0L);
      assertEquals("{\"Ww$SZG9j(Y?+my\":true,\"von`2V1q\\\"G)MGO\":0", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent(">:Q'<DAGG&'D");
      jsonWriter0.nullValue();
      assertEquals("[\n>:Q'<DAGG&'Dnull", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("yOY}:V%/%YS,w-\"V/sE");
      // Undeclared exception!
      try { 
        jsonWriter1.value(13.723693974654951);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("1=<r`");
      // Undeclared exception!
      try { 
        jsonWriter1.name("E");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test57()  throws Throwable  {
      ...
      jsonWriter8.name("c!pL#b_");
      jsonWriter16.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[{\"c!pL#b_\":[", stringWriter0.toString());
  }
