...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      jsonWriter0.value("f2k>~^FxwXS*vL(7U2");
      assertEquals("\"f2k>~^FxwXS*vL(7U2\"", stringWriter0.toString());
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("xcWYVO._F}]Uu^u");
      assertEquals("\"xcWYVO._F}]Uu^u\"", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(1485L);
      assertEquals("1485", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("wM4L9i_1K");
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("sJLI!F}3 zpJX");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value(3651.38962994);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("x< H#frG");
      JsonWriter jsonWriter2 = jsonWriter1.beginObject();
      jsonWriter2.setLenient(true);
      jsonWriter0.name("~)T1@~&oSG-}uP0K");
      assertEquals("{\"x< H#frG\":{", stringWriter0.toString());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      jsonWriter1.beginArray();
      assertEquals("[[[[[[[[[{\"U4C]r:K>BQ~#K@G~)e\":[[[{\"iI-!:84|}p]<Q\":[[[[[[[[[[[[[[[[[[", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.value(1773.0566412590983);
      assertEquals("1773.0566412590983", stringWriter0.toString());
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("Z:J;\"M@E7p`_;n Wg!");
      JsonWriter jsonWriter1 = jsonWriter0.value("Z:J;\"M@E7p`_;n Wg!");
      JsonWriter jsonWriter2 = jsonWriter1.name("Z:J;\"M@E7p`_;n Wg!");
      jsonWriter2.nullValue();
      assertEquals("{\"Z:J;\\\"M@E7p`_;n Wg!\":\"Z:J;\\\"M@E7p`_;n Wg!\",\"Z:J;\\\"M@E7p`_;n Wg!\":null", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("sJLI!F}3 zpJX");
      jsonWriter0.jsonValue("sJLI!F}3 zpJX");
      assertEquals("[\nsJLI!F}3 zpJXsJLI!F}3 zpJX", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("=n'C\"(YPI");
      jsonWriter0.close();
      jsonWriter0.close();
      assertEquals("\"=n'C\\\"(YPI\"", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("f2k>~^FxwXS*vL(7U2");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("y_QAna3@");
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("{WO23MVDfnRJFL:aIhQ");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value(829L);
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name("`t|mo#");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("(V/HP['I)iu");
      // Undeclared exception!
      try { 
        jsonWriter1.name("(V/HP['I)iu");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test60()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("_`>9duU6SZ|9d@T0");
      // Undeclared exception!
      try { 
        jsonWriter1.endObject();
        fail("Expecting exception: IllegalStateException");
