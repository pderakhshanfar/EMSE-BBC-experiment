...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("u1$\"2-xm_RgVq`w37P;");
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("/X~_w4'j[1{.rZG@(t_");
      assertEquals("\"/X~_w4'j[1{.rZG@(t_\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-2567L));
      assertEquals("-2567", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      jsonWriter0.name("TvM^gpcSXI*x`05+qD");
      jsonWriter0.value(418L);
      assertEquals("{\"TvM^gpcSXI*x`05+qD\":418", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-2275.53));
      assertEquals("-2275.53", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("DpeAou#r.w=jON=:+");
      assertTrue(jsonWriter1.getSerializeNulls());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("DpeAou#r.w=jON=:+");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("F0s<&r&A?3 bI=");
      assertEquals("F0s<&r&A?3 bI=", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("/X~_w4'j[1{.rZG@(t_");
      assertEquals("/X~_w4'j[1{.rZG@(t_", stringWriter0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(373L);
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.jsonValue(">QB)=_M]\"pSL");
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value("u1$\"2-xm_RgVq`w37P;");
      jsonWriter2.beginArray();
      assertEquals("[\"u1$\\\"2-xm_RgVq`w37P;\",[", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent("|o7");
      jsonWriter0.value(0L);
      assertEquals("[\n|o70", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("Vjz:<>DOS1\"{YNo\"sBg");
      // Undeclared exception!
      try { 
        jsonWriter0.beginArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("IshY%K+~:z_:Xa:6lk3");
      // Undeclared exception!
      try { 
        jsonWriter0.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test58()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("u1$\"2-xm_RgVq`w37P;");
      // Undeclared exception!
      try { 
        jsonWriter0.name("<Np3w uKCoRGsjh\"MF");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test61()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Dangling name: u1$\"2-xm_RgVq`w37P;
         //
         verifyException("com.google.gson.stream.JsonWriter", e);
      }
  }
  ...
  public void test68()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.value("XjD");
  ...
  public void test72()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("Pt4:GwEF{");
      assertEquals("\"Pt4:GwEF{\"", stringWriter0.toString());
  }
}
