...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-2405.1));
      assertEquals("-2405.1", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("6;trBi^=*H");
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("h_Tb<+k]kAmlB");
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("nQx");
      assertEquals("nQx", stringWriter0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("java.ag.Shrt@0000000002");
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value((long) (byte)21);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      ...
      jsonWriter1.value((long) (byte)21);
      assertTrue(jsonWriter0.isHtmlSafe());
      assertEquals("{\"6;trBi^\\u003d*H\":21", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("KAEXg!uBYI.v0");
      JsonWriter jsonWriter1 = jsonWriter0.nullValue();
      JsonWriter jsonWriter2 = jsonWriter1.name("");
      jsonWriter2.beginArray();
      assertEquals("{\"KAEXg!uBYI.v0\":null,\"\":[", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent("javaslng.Float@0000000003");
      assertEquals("[", stringWriter0.toString());
  ...
  public void test51()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("java.ag.Shrt@0000000002");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("IS-9+8Tyi,8N8z");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("IS-9+8Tyi,8N8z");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.name("Ih@Pg[ud[0A'7M");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("\"]M@|oK|weU>t.A4h!C");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.nullValue();
  ...
  public void test68()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Float float0 = new Float(2345.0F);
