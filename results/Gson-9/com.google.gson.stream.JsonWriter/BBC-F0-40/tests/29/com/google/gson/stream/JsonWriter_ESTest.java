...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("<r;RdOe*");
  ...
  public void test03()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name(";86 9P_GH@sNmzbv'!");
  ...
  public void test05()  throws Throwable  {
      ...
      jsonWriter0.value("_LMce&|$X'G$");
      assertEquals("\"_LMce&|$X'G$\"", stringWriter0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-2364L));
      assertEquals("-2364", stringWriter0.toString());
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((double) (short)35);
      assertEquals("35.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-358.0101694301279));
      assertEquals("-358.0101694301279", stringWriter0.toString());
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("IbQ[4!U1 LVE");
      assertEquals("IbQ[4!U1 LVE", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("z6wf?-Q");
      assertEquals("z6wf?-Q", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test32()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(968);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("]VoyP");
      // Undeclared exception!
      try { 
        jsonWriter1.value((double) 968);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test35()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("=s7d&JI");
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("y:vG>pry");
      jsonWriter0.beginObject();
      assertEquals("{\"y:vG>pry\":{", stringWriter0.toString());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("PZ]H1YS6D8bYYft^1");
      jsonWriter2.jsonValue("PZ]H1YS6D8bYYft^1");
      JsonWriter jsonWriter3 = jsonWriter0.name("PZ]H1YS6D8bYYft^1");
      jsonWriter3.jsonValue("PZ]H1YS6D8bYYft^1");
      assertEquals("{\"PZ]H1YS6D8bYYft^1\":PZ]H1YS6D8bYYft^1,\"PZ]H1YS6D8bYYft^1\":PZ]H1YS6D8bYYft^1", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("e-sJ#");
      jsonWriter1.value("e-sJ#");
      // Undeclared exception!
      try { 
        jsonWriter1.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("V|Lub5#$'\fI");
      assertEquals("\"V|Lub5#$'\\fI\"", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(" Uvs=");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test51()  throws Throwable  {
      ...
      assertEquals("{\"PZ]H1YS6D8bYYft^1\":PZ]H1YS6D8bYYft^1,\"PZ]H1YS6D8bYYft^1\":null", stringWriter0.toString());
  }
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("e-sJ#");
      // Undeclared exception!
      try { 
        jsonWriter0.value("e-sJ#");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name(";86 9P_GH@sNmzbv'!");
      // Undeclared exception!
      try { 
        jsonWriter0.name(";86 9P_GH@sNmzbv'!");
        fail("Expecting exception: IllegalStateException");
