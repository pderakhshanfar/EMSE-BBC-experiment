...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-3523L));
      assertEquals("-3523", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("e7nh;f\"b");
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("y{mx");
      assertFalse(jsonWriter1.getSerializeNulls());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("C~9 cHS1)qY");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue(">P<=d:zL}l5}Yw");
      assertEquals(">P<=d:zL}l5}Yw", stringWriter0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("i|I7Gy!19ix&65.s.");
      // Undeclared exception!
      try { 
        jsonWriter0.value(false);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value("c8^0|,8cFYHE>wr1O");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test33()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.jsonValue("T`c6t#5)?='qB>-4Q#6");
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-2432.59946545));
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value((-2432.59946545));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("MtODh?a^q");
      JsonWriter jsonWriter3 = jsonWriter1.value((Number) null);
      jsonWriter3.name("java.lang.Integer@0000000004");
      assertEquals("{\"MtODh?a^q\":null", stringWriter0.toString());
      
      jsonWriter2.jsonValue("MtODh?a^q");
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.setIndent("{0c'}oWzH");
      jsonWriter1.nullValue();
      assertEquals("[\n{0c'}oWzHnull", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      jsonWriter0.close();
      jsonWriter0.close();
      assertEquals("C~9 cHS1)qY", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test52()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Double double0 = new Double(1292.80658392827);
      jsonWriter0.setLenient(true);
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("-{!i#sZ6m");
      // Undeclared exception!
      try { 
        jsonWriter0.name("(J5l#nIU'<");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test58()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("C~9 cHS1)qY");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.nullValue();
  ...
  public void test68()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("UQP*}");
      jsonWriter0.beginArray();
      assertEquals("\"UQP*}\"[", stringWriter0.toString());
  }
