...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      ...
      jsonWriter1.endObject();
      jsonWriter0.setLenient(true);
      jsonWriter1.value((double) (-4369));
      assertEquals("{}-4369.0", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(428.8813);
      assertEquals("428.8813", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(268.15829);
      assertEquals("268.15829", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("2V]hvd`5G4jY");
      assertEquals("2V]hvd`5G4jY", stringWriter0.toString());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      jsonWriter0.jsonValue("Dangling name: ");
      assertEquals("[Dangling name: ,Dangling name: ", stringWriter0.toString());
  }
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.value("wr%*,O*");
      jsonWriter1.beginArray();
      assertEquals("\"wr%*,O*\"[", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("usRl(/1xFre");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("!HOA,i]s");
      jsonWriter1.value((-3612.6));
      JsonWriter jsonWriter2 = jsonWriter0.name("java.lang.Integer@0000000003");
      assertEquals("{\"!HOA,i]s\":-3612.6", stringWriter0.toString());
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.setIndent("P/O,nU`}]@tgN-b|}");
      assertEquals("[", stringWriter0.toString());
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value("m]");
      jsonWriter0.setIndent("[\"e68pr!FErTN+");
      jsonWriter1.endArray();
  ...
  public void test43()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(800);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("LA)S6:%bShoIXyO<\"T");
      assertEquals("\"LA)S6:%bShoIXyO<\\\"T\"", stringWriter0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("oj:+Dt9,SiS+0fF&GY!");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("Udw");
      // Undeclared exception!
      try { 
        jsonWriter1.name("Udw");
        fail("Expecting exception: IllegalStateException");
