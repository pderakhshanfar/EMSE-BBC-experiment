...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Double double0 = new Double(216.423906128);
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("+?8@'cg *C");
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("m0A)j3ANBD#i`");
      assertEquals("m0A)j3ANBD#i`", stringWriter0.toString());
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("l{z#B%eSt");
      assertEquals("l{z#B%eSt", stringWriter0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("@wC#+;3^*");
      // Undeclared exception!
      try { 
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("Zt?#Qr/\"oZ#{~nTrKt/");
      // Undeclared exception!
      try { 
        jsonWriter1.value((-631.0));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.value((-681L));
      jsonWriter1.jsonValue("l{z#B%eSt");
      assertEquals("[-681,l{z#B%eSt", stringWriter0.toString());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.value(">s@k8R7&piL$UY@u+");
      jsonWriter1.value(1.0);
      assertEquals("\">s@k8R7&piL$UY@u+\"1.0", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test50()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(1925.7348);
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("juhAaE.U3Y(q");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("_4y");
      // Undeclared exception!
      try { 
        jsonWriter1.name("_4y");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test60()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("sdQB4t*OeY|Z:(_`6o");
      // Undeclared exception!
      try { 
        jsonWriter2.endObject();
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Dangling name: sdQB4t*OeY|Z:(_`6o
         //
         verifyException("com.google.gson.stream.JsonWriter", e);
      }
  }
  ...
  public void test69()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Float float0 = new Float(1547.6931333);
  ...
  public void test70()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("V)[<>tdMO-i-U3<");
      assertEquals("\"V)[\\u003c\\u003etdMO-i-U3\\u003c\"", stringWriter0.toString());
  }
}
