...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("2[w", (Type) class0);
  ...
  public void test09()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("5#:p$LbJk.jQ4|?kp", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test13()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("_3/mcL4>`rgO_y]|", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("bG'~.<Fo$> _?^LeKy", (Type) class1);
        fail("Expecting exception: RuntimeException");
  ...
  public void test19()  throws Throwable  {
      ...
      TypeToken<Locale> typeToken0 = TypeToken.get(class0);
      Class<? super Locale> class1 = typeToken0.getRawType();
      Boolean boolean0 = gson0.fromJson("null", (Type) class1);
      assertNull(boolean0);
  }
  ...
  public void test22()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<GregorianCalendar> class0 = GregorianCalendar.class;
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-2803), 32, 32);
      gson0.toJsonTree((Object) mockGregorianCalendar0, (Type) class0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=-150536534400000,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=0,YEAR=2802,MONTH=9,WEEK_OF_YEAR=40,WEEK_OF_MONTH=1,DAY_OF_MONTH=2,DAY_OF_YEAR=275,DAY_OF_WEEK=5,DAY_OF_WEEK_IN_MONTH=1,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=0,ZONE_OFFSET=0,DST_OFFSET=0]", mockGregorianCalendar0.toString());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("\"U8q>2b05", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test25()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("&YXA9(lU}/(");
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("G!<'2Y3", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 2: G!<'2Y3
         //
  ...
  public void test38()  throws Throwable  {
      Gson gson0 = new Gson();
      Boolean boolean0 = Boolean.valueOf("X9");
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(boolean0);
  ...
  public void test40()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<String> class0 = String.class;
      String string0 = gson0.fromJson("com.google.gson.internal.ConstructorConstructor$8", class0);
  ...
  public void test43()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("O aD2(B#pjL", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test45()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("@46@J#U|.K,'", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: @46@J
         //
  ...
  public void test47()  throws Throwable  {
      Class<Object> class0 = Object.class;
      Gson gson0 = new Gson();
      AtomicIntegerArray atomicIntegerArray0 = new AtomicIntegerArray(3310);
      JsonArray jsonArray0 = (JsonArray)gson0.toJsonTree((Object) atomicIntegerArray0, (Type) class0);
      assertEquals(3310, jsonArray0.size());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      JsonElement jsonElement0 = gson0.toJsonTree((Object) null, (Type) class0);
      Class<InetAddress> class2 = gson0.fromJson(jsonElement0, (Type) class1);
      assertNull(class2);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson("sEp<`xy]1~1ro8]+", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"sEp<`xy\"
         //
  ...
  public void test53()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("a2!w", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"a2!w\"
         //
  ...
  public void test57()  throws Throwable  {
      Class<Boolean> class0 = Boolean.TYPE;
      Gson gson0 = new Gson();
      Boolean boolean0 = gson0.fromJson("-eZ3Ap7@LZq.JH", (Type) class0);
  ...
  public void test59()  throws Throwable  {
      ...
      Class<BitSet> class0 = BitSet.class;
      try { 
        gson0.fromJson("[]Lg;{@leNohn\"<p", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test61()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("[T}QI[Wn", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test63()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      Boolean boolean0 = Boolean.valueOf("dayOfMonth");
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(boolean0);
      try { 
        gson0.fromJson((JsonElement) jsonPrimitive0, (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test65()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicInteger atomicInteger0 = new AtomicInteger(3328);
  ...
  public void test66()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("$tZ^~`YI7", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"$tZ^~`YI7\"
         //
  ...
  public void test68()  throws Throwable  {
      StringReader stringReader0 = new StringReader("p1)Fa5");
      Gson gson0 = new Gson();
