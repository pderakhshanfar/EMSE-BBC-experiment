...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("BhoPg:0n=Z.\"", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"BhoPg\"
         //
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("X0x7-<$OE0<*", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test07()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("c<DEX");
      String string0 = gson0.toJson((JsonElement) jsonPrimitive0);
      assertEquals("\"c\\u003cDEX\"", string0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("GE$H<]w@pt~[b$/", type0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test28()  throws Throwable  {
      Gson gson0 = new Gson();
      InetAddress inetAddress0 = MockInetAddress.getByName("$A,<.~wd");
  ...
  public void test29()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      Inet4Address inet4Address0 = (Inet4Address)gson0.fromJson("6$t)rFL\"", (Type) class0);
  ...
  public void test33()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("o`LO;Dm", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 1: o`LO
         //
  ...
  public void test37()  throws Throwable  {
      ...
      Class<StringBuffer> class0 = StringBuffer.class;
      try { 
        gson0.fromJson("&PizrK!l2~]r%;", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test40()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuilder> class0 = StringBuilder.class;
      StringBuilder stringBuilder0 = gson0.fromJson("com.google.gson.JsonObject", class0);
      assertEquals("com.google.gson.JsonObject", stringBuilder0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("Ql#tiC2m\"4f1", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: Ql
         //
  ...
  public void test50()  throws Throwable  {
      ...
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson("`=b%66", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test53()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson("||p3Xq6]mU_L$L=y", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"||p3Xq6\"
         //
  ...
  public void test54()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("FW475zN--'B+3_#(", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"FW475zN--'B+3_\"
         //
  ...
  public void test68()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("zLDIww,)@Y6iR{ln=", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"zLDIww\"
         //
