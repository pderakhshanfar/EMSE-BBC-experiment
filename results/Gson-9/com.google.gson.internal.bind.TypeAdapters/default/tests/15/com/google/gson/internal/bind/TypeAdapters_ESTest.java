...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("1d3}w&23GIOe9gn;o-W", class0);
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"G?I\"
         //
  ...
  public void test10()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("fX`foZz", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"fX`foZz\"
         //
  ...
  public void test15()  throws Throwable  {
      ...
      Class<JsonArray> class0 = JsonArray.class;
      try { 
        gson0.fromJson("{\"F!Dvm\":\"t\"}", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test22()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("$T'(_Zh8H");
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson((JsonElement) jsonPrimitive0, class0);
      assertEquals("$t'(_ZH8H", locale0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("<B^QIF}>", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("O9-kmyR)e0i>Rz4D", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 11: O9-kmyR)e0i>Rz4D
         //
  ...
  public void test38()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("eG+'MI", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: eG+'MI
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test44()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("l/MVC^EZ6BXm B5", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test47()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      try { 
        gson0.fromJson(")!/oJEgo[Zui_^uOu", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test50()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("_}J", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test58()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("v6FDBkc08[", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test62()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("L)eo}fUG\"7", class0);
  ...
  public void test72()  throws Throwable  {
      ...
      TypeAdapterFactory typeAdapterFactory0 = TypeAdapters.newTypeHierarchyFactory(class1, (TypeAdapter<AtomicBoolean>) typeAdapterRuntimeTypeWrapper0);
      assertNotNull(typeAdapterFactory0);
  }
  ...
  public void test74()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-1685), (-2850), 7);
