...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Q'wQzS\"._41k", class0);
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("U`5.;X07t3j", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 1: U`5.
         //
  ...
  public void test06()  throws Throwable  {
      ...
      JsonPrimitive jsonPrimitive1 = (JsonPrimitive)treeTypeAdapter0.toJsonTree(uRI0);
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("<v|xIE5?v4LDiKr?r", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"<v|xIE5?v4LDiKr?r\"
         //
  ...
  public void test13()  throws Throwable  {
      ...
      Type type0 = typeToken0.getType();
      try { 
        gson0.fromJson("?_jA)d)/2S0KG<D1]", type0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test16()  throws Throwable  {
      ...
      Class<Locale> class0 = Locale.class;
      try { 
        gson0.fromJson("wOjS{", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test18()  throws Throwable  {
      ...
      jsonObject0.addProperty("mq,~O(*Q", (Number) float0);
      Class<Calendar> class0 = Calendar.class;
      Calendar calendar0 = gson0.fromJson((JsonElement) jsonObject0, class0);
  ...
  public void test20()  throws Throwable  {
      Gson gson0 = new Gson();
      UUID uUID0 = MockUUID.fromString("rD5=a'9!");
  ...
  public void test24()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      TreeTypeAdapter<Object> treeTypeAdapter0 = new TreeTypeAdapter<Object>(jsonSerializer0, jsonDeserializer0, gson0, typeToken0, (TypeAdapterFactory) null);
      JsonElement jsonElement0 = treeTypeAdapter0.toJsonTree((Object) null);
  ...
  public void test27()  throws Throwable  {
      Gson gson0 = new Gson();
      URI uRI0 = MockURI.URI("theUnsafe");
  ...
  public void test31()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("FXQ", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: FXQ
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test35()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("j|k(6+#,KERo-A<g48<", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test40()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("rD5=a'9!", (Type) class1);
        fail("Expecting exception: RuntimeException");
  ...
  public void test42()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("Z=3H }ND9-;Wj%{", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test44()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("FXQ", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: FXQ
         //
  ...
  public void test57()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("[Ks_5M", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Error: Expecting: bitset number value (1, 0), Found: Ks_5M
         //
  ...
  public void test62()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("k,9CiUQ", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test71()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(382, 184, 184);
      gson0.toJsonTree((Object) mockGregorianCalendar0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=382,MONTH=184,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=184,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
  }
}
