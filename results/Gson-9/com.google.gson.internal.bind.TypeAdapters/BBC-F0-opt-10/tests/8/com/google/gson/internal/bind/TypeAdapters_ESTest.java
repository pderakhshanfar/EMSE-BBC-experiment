...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("-41U=[l[s@{ky", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"-41U\"
         //
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("`o>'E~CK}%d5^*", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"`o>'E~CK\"
         //
  ...
  public void test11()  throws Throwable  {
      Gson gson0 = new Gson();
      InetAddress inetAddress0 = MockInetAddress.getByName("com.google.gson.internal.Excluder");
  ...
  public void test14()  throws Throwable  {
      ...
      UUID uUID0 = MockUUID.fromString("{nvW^4OxNLvv2_");
      String string0 = treeTypeAdapter0.toJson((Object) uUID0);
  ...
  public void test17()  throws Throwable  {
      StringBuilder stringBuilder0 = new StringBuilder();
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(9, 14, 14, (-182), 9, (-641));
      stringBuilder0.append((Object) mockGregorianCalendar0);
      JsonElement jsonElement0 = gson0.toJsonTree((Object) stringBuilder0);
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson(jsonElement0, class0);
      assertNotNull(locale0);
      assertEquals("org.evosuite.runtime.mock.java.util.mockgregoriancalendar[time=?,arefieldsset=false,areallfieldsset=false,lenient=true,zone=sun.util.calendar.zoneinfo[id=\"gmt\",offset=0,dstsavings=0,usedaylight=false,transitions=0,lastrule=null],firstdayofweek=1,minimaldaysinfirstweek=1,era=?,year=9,month=14,week_OF_YEAR=?,WEEK", locale0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      Class<GregorianCalendar> class0 = GregorianCalendar.class;
      Gson gson0 = new Gson();
      TimeZone timeZone0 = TimeZone.getTimeZone("RU");
  ...
  public void test21()  throws Throwable  {
      ...
      jsonObject0.addProperty("31G$]2", "31G$]2");
      Class<GregorianCalendar> class0 = GregorianCalendar.class;
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<InetAddress> class0 = InetAddress.class;
      Inet4Address inet4Address0 = (Inet4Address)gson0.fromJson("oRk@s6WZo5&F", class0);
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("a$cki`qFCFNNz", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 5: a$cki`qFCFNNz
         //
  ...
  public void test34()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.net.MalformedURLException: no protocol: com.google.gson.internal.bind.ReflectiveTypeAdapterFactory$BoundField
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test46()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("wKRdfj", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: wKRdfj
         //
  ...
  public void test50()  throws Throwable  {
      ...
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson("^vccT;R<l]\"G", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"^vccT\"
         //
  ...
  public void test61()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("LVQ3}I(I7D%j$}oe", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test67()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("-41U=[s@{ky", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test73()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(65279, 65279, (-3526), 2, 1512, (-3617));
