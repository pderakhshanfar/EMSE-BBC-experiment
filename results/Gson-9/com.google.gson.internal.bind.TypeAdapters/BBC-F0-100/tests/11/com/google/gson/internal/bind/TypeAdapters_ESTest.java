...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson(")aszI~", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \")aszI~\"
         //
  ...
  public void test03()  throws Throwable  {
      ...
      TreeTypeAdapter<Boolean> treeTypeAdapter0 = new TreeTypeAdapter<Boolean>(jsonSerializer0, jsonDeserializer0, gson0, typeToken0, (TypeAdapterFactory) null);
      TypeAdapterFactory typeAdapterFactory0 = TypeAdapters.newFactoryForMultipleTypes(class0, (Class<? extends Boolean>) class0, (TypeAdapter<? super Boolean>) treeTypeAdapter0);
      JsonSerializer<AtomicIntegerArray> jsonSerializer1 = (JsonSerializer<AtomicIntegerArray>) mock(JsonSerializer.class, new ViolatedAssumptionAnswer());
      Class<AtomicIntegerArray> class1 = AtomicIntegerArray.class;
      TypeToken<AtomicIntegerArray> typeToken1 = TypeToken.get(class1);
      TreeTypeAdapter<AtomicIntegerArray> treeTypeAdapter1 = new TreeTypeAdapter<AtomicIntegerArray>(jsonSerializer1, (JsonDeserializer<AtomicIntegerArray>) null, gson0, typeToken1, typeAdapterFactory0);
      // Undeclared exception!
      try { 
        treeTypeAdapter1.fromJsonTree(jsonPrimitive0);
  ...
  public void test10()  throws Throwable  {
      ...
      TreeTypeAdapter<AtomicIntegerArray> treeTypeAdapter0 = new TreeTypeAdapter<AtomicIntegerArray>(jsonSerializer0, jsonDeserializer0, (Gson) null, (TypeToken<AtomicIntegerArray>) null, typeAdapterFactory0);
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Atv5FU12dc7F5$:(", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test12()  throws Throwable  {
      ...
      Class<JsonArray> class0 = JsonArray.class;
      try { 
        gson0.fromJson("[U0v:F5rQ,4Ltqa&vo", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test13()  throws Throwable  {
      ...
      JsonSerializer<AtomicIntegerArray> jsonSerializer0 = (JsonSerializer<AtomicIntegerArray>) mock(JsonSerializer.class, new ViolatedAssumptionAnswer());
      JsonDeserializer<AtomicIntegerArray> jsonDeserializer0 = (JsonDeserializer<AtomicIntegerArray>) mock(JsonDeserializer.class, new ViolatedAssumptionAnswer());
      TreeTypeAdapter<AtomicIntegerArray> treeTypeAdapter0 = new TreeTypeAdapter<AtomicIntegerArray>(jsonSerializer0, jsonDeserializer0, gson0, (TypeToken<AtomicIntegerArray>) null, objectTypeAdapter0.FACTORY);
  ...
  public void test19()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-1930), (-3432), 47);
      typeAdapterRuntimeTypeWrapper0.toJsonTree(mockGregorianCalendar0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=-132095059200000,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=0,YEAR=2217,MONTH=1,WEEK_OF_YEAR=8,WEEK_OF_MONTH=3,DAY_OF_MONTH=16,DAY_OF_YEAR=47,DAY_OF_WEEK=4,DAY_OF_WEEK_IN_MONTH=3,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=0,ZONE_OFFSET=0,DST_OFFSET=0]", mockGregorianCalendar0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Type type0 = typeToken0.getType();
      try { 
        gson0.fromJson("com.google.gson.internal.bind.TypeAdapters$36", type0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test30()  throws Throwable  {
      ...
      TypeToken<GregorianCalendar> typeToken0 = TypeToken.get(class1);
      Type type0 = typeToken0.getType();
      TypeAdapterRuntimeTypeWrapper<URI> typeAdapterRuntimeTypeWrapper0 = new TypeAdapterRuntimeTypeWrapper<URI>(gson0, typeAdapter0, type0);
      JsonNull jsonNull0 = JsonNull.INSTANCE;
  ...
  public void test31()  throws Throwable  {
      ...
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("?3{,cPFN");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.net.URISyntaxException: Illegal character in query at index 2: ?3{,cPFN
         //
  ...
  public void test34()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("+0uyDw{=rX9", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: +0uyDw
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test37()  throws Throwable  {
      Gson gson0 = new Gson();
      Float float0 = new Float((-4672.0713F));
  ...
  public void test43()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("?~$*_H4!:", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test46()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("m,2$tT6mm!Z[d", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test49()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("RSes", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"RSes\"
         //
  ...
  public void test55()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("22=IF4:oe", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test65()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicInteger atomicInteger0 = new AtomicInteger((-1081));
  ...
  public void test66()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("This is not a JSON Array.");
  ...
  public void test74()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(1559, 1553, 1553, 1559, 1553);
