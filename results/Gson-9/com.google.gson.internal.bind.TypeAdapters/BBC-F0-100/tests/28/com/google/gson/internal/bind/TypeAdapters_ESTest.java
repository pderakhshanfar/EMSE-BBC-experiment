...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("fV'_;/0bpX", (Type) class0);
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("PrO`+7[s={$`77PM", (Type) class1);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"PrO`+7\"
         //
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("E/0$;<MZ_YfX%T", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("XE/0$;<MZ_YfX%T", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: XE
         //
  ...
  public void test12()  throws Throwable  {
      ...
      jsonObject0.addProperty("|f+BnASS]Vy{l@!", "");
  ...
  public void test18()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      Gson gson0 = new Gson();
      Double double0 = new Double((-914.63991));
      jsonObject0.addProperty("!b#IINj|4=+(;WMmP", (Number) double0);
      Class<JsonObject> class0 = JsonObject.class;
  ...
  public void test30()  throws Throwable  {
      Gson gson0 = new Gson();
      URI uRI0 = MockURI.URI("com.google.gson.internal.bind.TypeAdapters$26$1");
  ...
  public void test49()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("[lK(PV*NTNprs<", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"lK(PV*NTNprs<\"
         //
  ...
  public void test52()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson("3E|!:7n^zFz", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"3E|!\"
         //
  ...
  public void test56()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("9{L :\"7^yM@|h?", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test60()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("s65#z%<xP(f", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test68()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("7+R*i");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"7+R*i\"
         //
  ...
  public void test70()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("com.google.gson.internal.bind.TypeAdapters$20", type0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test71()  throws Throwable  {
      Gson gson0 = new Gson();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(43, "37t3]T|hK]v}oSNxcj0");
  ...
  public void test76()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(7, 837, 7, 85, 46);
