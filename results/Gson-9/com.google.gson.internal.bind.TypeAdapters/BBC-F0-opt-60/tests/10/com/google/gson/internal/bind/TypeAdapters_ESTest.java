...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StringReader stringReader0 = new StringReader("0)_X 1OvQy<@|'U]PE");
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("<,jGVV1L-^Z[4rS>P", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test12()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("{Y~B<{v");
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
         ...
         //
         // org.evosuite.runtime.mock.java.lang.MockThrowable: Expected ':' at line 1 column 7 path $.Y~B<
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonArray jsonArray0 = new JsonArray();
      jsonArray0.add("com.\"oog>e.gson.internaM.Streams$AppendapleWriter$CurrentWrqte");
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader("0_X 1OvQy<@|'U]PE");
      Gson gson0 = new Gson();
  ...
  public void test26()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicInteger atomicInteger0 = new AtomicInteger((-4402));
  ...
  public void test29()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("m{>+(-\u0000$wL` y+@+hY");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.net.MalformedURLException: no protocol: m{>+(-\u0000$wL` y+@+hY
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test41()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("cKL");
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test46()  throws Throwable  {
      StringReader stringReader0 = new StringReader("f|MPkMPOrMhk17");
      Gson gson0 = new Gson();
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"f|MPkMPOrMhk17\"
         //
  ...
  public void test48()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("W:p4q_6");
  ...
  public void test50()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("Ss[KMkq#K|p~i");
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test51()  throws Throwable  {
      ...
      Boolean boolean0 = gson0.fromJson("Fo", class0);
  ...
  public void test64()  throws Throwable  {
      Gson gson0 = new Gson();
      InetAddress inetAddress0 = MockInetAddress.getByName("6)^z");
