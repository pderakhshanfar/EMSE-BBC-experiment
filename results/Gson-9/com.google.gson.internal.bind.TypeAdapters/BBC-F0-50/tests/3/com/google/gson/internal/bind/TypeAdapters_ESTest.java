...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("o%M>%9/Aw[TsMA^", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Malformed escape pair at index 1: o%M>%9
         //
  ...
  public void test17()  throws Throwable  {
      ...
      JsonArray jsonArray1 = (JsonArray)gson0.fromJson((JsonElement) jsonArray0, (Type) class1);
  ...
  public void test19()  throws Throwable  {
      Gson gson0 = new Gson();
      TimeZone timeZone0 = TimeZone.getTimeZone("''[O_79&X+i4r<i\")");
  ...
  public void test25()  throws Throwable  {
      ...
      Class<UUID> class0 = UUID.class;
      UUID uUID0 = (UUID)gson0.fromJson(jsonElement0, (Type) class0);
  ...
  public void test27()  throws Throwable  {
      ...
      InetAddress inetAddress0 = MockInetAddress.getByAddress("{KM507 0", byteArray0);
  ...
  public void test35()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<URL> class0 = URL.class;
      StringReader stringReader0 = new StringReader("j=:xMLsA8YF!|");
      JsonReader jsonReader0 = gson0.newJsonReader(stringReader0);
      try { 
  ...
  public void test38()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuffer> class0 = StringBuffer.class;
      StringReader stringReader0 = new StringReader("<Z#tT}1Oq:<{");
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test41()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("%XFnE[");
      Class<StringBuilder> class0 = StringBuilder.class;
      try { 
  ...
  public void test44()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<String> class0 = String.class;
      Boolean boolean0 = Boolean.valueOf("W/~o/9_jj");
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(boolean0);
  ...
  public void test48()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("s{Yu#~0Qc-");
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test50()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("<Z#tT}WOq:<{");
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test56()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("TVD=u4bgY");
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"TVD\"
         //
  ...
  public void test68()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("`R>'Ms-#t~$-]", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"`R>'Ms-\"
         //
  ...
  public void test70()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("p,AMn0SYNR", class0);
        fail("Expecting exception: RuntimeException");
