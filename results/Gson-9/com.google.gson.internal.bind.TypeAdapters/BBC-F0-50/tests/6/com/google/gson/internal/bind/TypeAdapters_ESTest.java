...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      ...
      ArrayTypeAdapter<String> arrayTypeAdapter0 = new ArrayTypeAdapter<String>((Gson) null, typeAdapter0, class0);
      JsonElement jsonElement0 = arrayTypeAdapter0.toJsonTree((Object) null);
      jsonObject0.add("mUX8V", jsonElement0);
  ...
  public void test18()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("{FaTf<`^aMmBx?", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test20()  throws Throwable  {
      ...
      Class<JsonPrimitive> class0 = JsonPrimitive.class;
      try { 
        gson0.fromJson("K{FaTf<`^aMmBx?", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test22()  throws Throwable  {
      ...
      Class<JsonPrimitive> class0 = JsonPrimitive.class;
      try { 
        gson0.fromJson("5{a", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test25()  throws Throwable  {
      ...
      Class<Locale> class0 = Locale.class;
      try { 
        gson0.fromJson("O4_9GaT;_", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test28()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("?g4& B%~7+[kRB!:e", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test29()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      Gson gson0 = new Gson();
      Float float0 = new Float(1327.8);
      jsonObject0.addProperty("@qr{Dg", (Number) float0);
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("l_<1mi}K/. w-IEi~CY", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 2: l_<1mi
         //
  ...
  public void test45()  throws Throwable  {
      ...
      Class<? super URL> class1 = typeToken0.getRawType();
      try { 
        gson0.fromJson("+\")J5.>{u6Xx>/W", (Type) class1);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: +\")J5.>
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      ...
      Class<StringBuffer> class0 = StringBuffer.class;
      try { 
        gson0.fromJson("V'5g3D0Ym2;X:`IwG", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test52()  throws Throwable  {
      ...
      Class<StringBuilder> class0 = StringBuilder.class;
      try { 
        gson0.fromJson("(PyX*-Gn2=_]/c_Q15", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test53()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      try { 
        gson0.fromJson("K{FaTf<`^aMmBx?", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test58()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Expecting character, got: V'5g3D0Ym2
         //
  ...
  public void test60()  throws Throwable  {
      ...
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson("+\")J5.>{u6Xx>/W", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"+\")J5.>\"
         //
  ...
  public void test61()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      TypeAdapterRuntimeTypeWrapper<Object> typeAdapterRuntimeTypeWrapper0 = new TypeAdapterRuntimeTypeWrapper<Object>(gson0, (TypeAdapter<Object>) null, class0);
      AtomicIntegerArray atomicIntegerArray0 = new AtomicIntegerArray(1177);
  ...
  public void test62()  throws Throwable  {
      JsonArray jsonArray0 = new JsonArray();
      Gson gson0 = new Gson();
      Float float0 = new Float((-182.82919));
      ...
      assertEquals("[-182]", atomicIntegerArray0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson("d ]L0R>(?MMmo%-6L", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test67()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("|Fh7VEF^BkxLyX8", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"|Fh7VEF^BkxLyX8\"
         //
  ...
  public void test69()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("SGB;pZ5lf", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"SGB\"
         //
  ...
  public void test71()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("{rRx#|wVq8w)S[", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test76()  throws Throwable  {
      ...
      Class<BitSet> class0 = BitSet.class;
      try { 
        gson0.fromJson("q3Th)zW`$O&='DAU", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test77()  throws Throwable  {
      ...
      ReflectiveTypeAdapterFactory.Adapter<Object> reflectiveTypeAdapterFactory_Adapter0 = new ReflectiveTypeAdapterFactory.Adapter<Object>(objectConstructor1, hashMap0);
      TypeAdapterRuntimeTypeWrapper<Object> typeAdapterRuntimeTypeWrapper0 = new TypeAdapterRuntimeTypeWrapper<Object>(gson0, reflectiveTypeAdapterFactory_Adapter0, class0);
      // Undeclared exception!
      try { 
  ...
  public void test81()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("m\"dkh(=.NPo_D", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"m\"dkh(\"
         //
  ...
  public void test83()  throws Throwable  {
      Class<InetAddress> class0 = InetAddress.class;
      Gson gson0 = new Gson();
      StringBuilder stringBuilder0 = new StringBuilder("XWi$H.Jyj");
      gson0.toJson((Object) null, (Type) class0, (Appendable) stringBuilder0);
      assertEquals("XWi$H.Jyjnull", stringBuilder0.toString());
  }
  ...
  public void test86()  throws Throwable  {
      Gson gson0 = new Gson();
      StringBuilder stringBuilder0 = new StringBuilder(4172);
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(4172, 43, (byte)0);
      gson0.toJson((Object) mockGregorianCalendar0, (Appendable) stringBuilder0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=4172,MONTH=43,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=0,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
  }
}
