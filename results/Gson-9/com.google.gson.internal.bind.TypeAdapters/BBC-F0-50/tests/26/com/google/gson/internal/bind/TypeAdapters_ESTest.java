...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("aJ2k,{hmu;5,8", class0);
  ...
  public void test04()  throws Throwable  {
      ...
      ArrayTypeAdapter<Float> arrayTypeAdapter0 = new ArrayTypeAdapter<Float>((Gson) null, (TypeAdapter<Float>) null, class1);
      TypeAdapterFactory typeAdapterFactory0 = TypeAdapters.newFactory(class0, class0, (TypeAdapter<? super Currency>) arrayTypeAdapter0);
      assertNotNull(typeAdapterFactory0);
  }
  ...
  public void test21()  throws Throwable  {
      Gson gson0 = new Gson();
      UUID uUID0 = MockUUID.fromString("yHnH");
  ...
  public void test23()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<UUID> class0 = UUID.class;
      UUID uUID0 = gson0.fromJson("dO9x", class0);
  ...
  public void test28()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<URI> class0 = URI.class;
      URI uRI0 = gson0.fromJson("79", class0);
  ...
  public void test30()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("p.lgz'T|.xgCtMF; ", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 7: p.lgz'T|.xgCtMF
         //
  ...
  public void test36()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("khmSoi\"v<Qo>bD,aqT", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test39()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuilder> class0 = StringBuilder.class;
      StringBuilder stringBuilder0 = gson0.fromJson("dO9x", class0);
      assertEquals("dO9x", stringBuilder0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("i4vW3MC~MwjY");
      Class<String> class0 = String.class;
      String string0 = gson0.fromJson((JsonElement) jsonPrimitive0, class0);
      assertEquals("i4vW3MC~MwjY", string0);
  }
  ...
  public void test45()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("dN=;G!C]A8.", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: dN
         //
  ...
  public void test50()  throws Throwable  {
      ...
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson("JYV:%msQB", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"JYV\"
         //
  ...
  public void test51()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicIntegerArray atomicIntegerArray0 = new AtomicIntegerArray(274);
  ...
  public void test52()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("[eqM_l{!I", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"eqM_l\"
         //
  ...
  public void test54()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Ns'*^7|hoSHf)zg?N}", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"Ns'*^7|hoSHf)zg?N\"
         //
  ...
  public void test56()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("JYV:%msQ}", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test58()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("N%_ky", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"N%_ky\"
         //
  ...
  public void test64()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("[CSQ", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Error: Expecting: bitset number value (1, 0), Found: CSQ
         //
  ...
  public void test70()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("5F@Cw[ =q} N`");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"5F@Cw\"
         //
  ...
  public void test73()  throws Throwable  {
      Gson gson0 = new Gson();
      Double double0 = new Double(1932.3103738179086);
      Class<Byte> class0 = Byte.TYPE;
  ...
  public void test75()  throws Throwable  {
      Gson gson0 = new Gson();
      Period period0 = Period.ofYears(2212);
  ...
  public void test77()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(70, 527, 70, 3280, 2212, 70);
      gson0.toJsonTree((Object) mockGregorianCalendar0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=70,MONTH=527,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=70,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=3280,HOUR_OF_DAY=3280,MINUTE=2212,SECOND=70,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
  }
}
