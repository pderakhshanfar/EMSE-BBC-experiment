...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("vz/8A3S6o6K", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"vz\"
         //
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Z)~V?&a%d^", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Malformed escape pair at index 7: Z)~V?&a%d^
         //
  ...
  public void test07()  throws Throwable  {
      Gson gson0 = new Gson();
      Locale locale0 = Locale.forLanguageTag("r/g`]sJolHq-");
  ...
  public void test09()  throws Throwable  {
      ...
      typeAdapterRuntimeTypeWrapper0.toJson((Writer) charArrayWriter0, (Object) gson0);
  ...
  public void test11()  throws Throwable  {
      Gson gson0 = new Gson();
      Boolean boolean0 = new Boolean("E(I!,<%qa^mMp`8cq#");
  ...
  public void test15()  throws Throwable  {
      ...
      ReflectiveTypeAdapterFactory.Adapter<GregorianCalendar> reflectiveTypeAdapterFactory_Adapter0 = new ReflectiveTypeAdapterFactory.Adapter<GregorianCalendar>((ObjectConstructor<GregorianCalendar>) null, hashMap0);
      TimeZone timeZone0 = TimeZone.getTimeZone("FALSE");
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(timeZone0);
      JsonElement jsonElement0 = reflectiveTypeAdapterFactory_Adapter0.toJsonTree(mockGregorianCalendar0);
      Gson gson0 = new Gson();
  ...
  public void test18()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("E8>XJ$Wg5KMgn?-]", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test23()  throws Throwable  {
      ...
      Class<Locale> class0 = Locale.class;
      try { 
        gson0.fromJson("O(Vm_Y#281z/}zms", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test27()  throws Throwable  {
      ...
      jsonObject0.add("com.google.gson.internal.LinkedTreeMap$1", jsonPrimitive0);
      Class<Calendar> class0 = Calendar.class;
  ...
  public void test30()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("fQxlHD!d3m");
      Class<UUID> class0 = UUID.class;
  ...
  public void test31()  throws Throwable  {
      Class<InetAddress> class0 = InetAddress.class;
      Gson gson0 = new Gson();
      MockFile mockFile0 = new MockFile("Rkb+?!kkjxMl!B");
  ...
  public void test34()  throws Throwable  {
      ...
      Class<InetAddress> class0 = InetAddress.class;
      try { 
        gson0.fromJson("Odj/]%Dds,]8\f!i", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test40()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("n+oEBj`I+yN V6_|", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: n+oEBj`I+yN
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      try { 
        gson0.fromJson("ExpecteA ':'", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test56()  throws Throwable  {
      ...
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson("aqR8oeBZ7Yma1md#", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"aqR8oeBZ7Yma1md\"
         //
  ...
  public void test58()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"m}I\"
         //
  ...
  public void test61()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson("vz/83S6o6K", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test63()  throws Throwable  {
      ...
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson("F[%S[", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test76()  throws Throwable  {
      ...
      Type type0 = typeToken0.getType();
      try { 
        gson0.fromJson("8*o5N=|vun", type0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"8*o5N\"
         //
