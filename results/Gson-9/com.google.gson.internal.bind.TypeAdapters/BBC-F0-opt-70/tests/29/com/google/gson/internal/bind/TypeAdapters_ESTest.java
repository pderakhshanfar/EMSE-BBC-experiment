...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("1;*LL}\"aKA`(w(", (Type) class0);
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("1FCA+g$-JbC\"T&o_", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 11: 1FCA+g$-JbC\"T&o_
         //
  ...
  public void test12()  throws Throwable  {
      ...
      Class<JsonArray> class0 = JsonArray.class;
      try { 
        gson0.fromJson("[c:#qwo36<Y", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("~VhP{eUp?6t=& l", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: ~VhP
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      jsonObject0.addProperty("f$n<AY!-})+(a~", "~VhP");
      String string0 = gson0.toJson((Object) jsonObject0);
      assertEquals("{\"f$n\\u003cAY!-})+(a~\":\"~VhP\"}", string0);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      Type type0 = typeToken0.getType();
      try { 
        gson0.fromJson("<x96D_D,I?WUFl'4", type0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test26()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson("b", class0);
  ...
  public void test31()  throws Throwable  {
      ...
      jsonObject0.addProperty("kN'TV3( -#-NU>SRgh", (Number) float0);
      Gson gson0 = new Gson();
      Class<GregorianCalendar> class0 = GregorianCalendar.class;
  ...
  public void test37()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("G=72ju3", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test48()  throws Throwable  {
      ...
      Class<StringBuffer> class0 = StringBuffer.class;
      try { 
        gson0.fromJson("%%N[vm4wwB", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test51()  throws Throwable  {
      ...
      Class<StringBuilder> class0 = StringBuilder.class;
      try { 
        gson0.fromJson("K&eUhl>><B_[F", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test53()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<String> class0 = String.class;
      String string0 = gson0.fromJson("WR'hB5B*tD", class0);
      assertEquals("WR'hB5B*tD", string0);
  }
  ...
  public void test57()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("%Y4E/VDo0hn@c.i%", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: %Y4E
         //
  ...
  public void test62()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("*TS>b]!>", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"*TS>b\"
         //
  ...
  public void test66()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"n!l\"
         //
  ...
  public void test68()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("1,\"zRw]P");
  ...
  public void test70()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("\"H]wnSe5Nx.:v:GNj");
      JsonReader jsonReader0 = gson0.newJsonReader(stringReader0);
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson(jsonReader0, (Type) class0);
  ...
  public void test79()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("Lki", (Type) class0);
  ...
  public void test81()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicInteger atomicInteger0 = new AtomicInteger((-2709));
      String string0 = gson0.toJson((Object) atomicInteger0);
      assertEquals("-2709", string0);
  }
  ...
  public void test91()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-1725), (-1746), (-1725), (-3933), 3269, (-3933));
      gson0.toJson((Object) mockGregorianCalendar0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=-1725,MONTH=-1746,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=-1725,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=-3933,HOUR_OF_DAY=-3933,MINUTE=3269,SECOND=-3933,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
  }
}
