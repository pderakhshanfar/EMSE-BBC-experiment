...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("(!w<8}ZIk-Py[", class0);
  ...
  public void test14()  throws Throwable  {
      Gson gson0 = new Gson();
      ObjectTypeAdapter objectTypeAdapter0 = new ObjectTypeAdapter(gson0);
      StringBuilder stringBuilder0 = new StringBuilder("com.google.gson.internal.bind.CollectionTypeAdapterFactory");
  ...
  public void test20()  throws Throwable  {
      ...
      Class<Locale> class0 = Locale.class;
      try { 
        gson0.fromJson("fVi/;zb*CV98aVo,", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test22()  throws Throwable  {
      ...
      Class<Calendar> class0 = Calendar.class;
      try { 
        gson0.fromJson("y?/u?^C:8Rj@69t[G?e", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test28()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("<.P3}1ZE");
      Class<InetAddress> class0 = InetAddress.class;
      try { 
  ...
  public void test40()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("av>o-p0Z-~", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: av>o-p0Z-~
         //
  ...
  public void test42()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("p:12kN!v. 3Dwr2>z<_", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test44()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Long> class0 = Long.class;
      StringReader stringReader0 = new StringReader("_H^Q|Pw4v3iGK.X}Z~g");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        gson0.fromJson(jsonReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"_H^Q|Pw4v3iGK.X\"
         //
  ...
  public void test49()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("WMq2[oX7j0[v");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"WMq2\"
         //
  ...
  public void test54()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("54Ex[K=r0i|'aZ", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test59()  throws Throwable  {
      ...
      try { 
        gson0.fromJson(" fY;(XAxF^<H_k", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"fY\"
         //
  ...
  public void test65()  throws Throwable  {
      Gson gson0 = new Gson();
      ObjectTypeAdapter objectTypeAdapter0 = new ObjectTypeAdapter(gson0);
      Short short0 = new Short((short)3100);
