...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("41 UA62zJQ'", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Error: Expecting: bitset number value (1, 0), Found: DOX
         //
  ...
  public void test11()  throws Throwable  {
      ...
      TypeAdapterRuntimeTypeWrapper<Byte> typeAdapterRuntimeTypeWrapper0 = new TypeAdapterRuntimeTypeWrapper<Byte>(gson0, treeTypeAdapter0, class1);
      JsonArray jsonArray0 = new JsonArray();
      Byte byte1 = typeAdapterRuntimeTypeWrapper0.fromJsonTree(jsonArray0);
  ...
  public void test20()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson(">o_*)zA&MBI'F;hK[_", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test26()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("{Yx,V7H*~/7;K@");
      Class<Calendar> class0 = Calendar.class;
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // org.evosuite.runtime.mock.java.lang.MockThrowable: Expected ':' at line 1 column 5 path $.Yx
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("x^^Q", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 1: x^^Q
         //
  ...
  public void test39()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("))MPA,A-|", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: ))MPA
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test43()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("{c{gYe`{243@");
      Class<StringBuffer> class0 = StringBuffer.class;
      TypeToken<StringBuffer> typeToken0 = TypeToken.get(class0);
      Class<? super StringBuffer> class1 = typeToken0.getRawType();
      try { 
  ...
  public void test47()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuilder> class0 = StringBuilder.class;
      StringBuilder stringBuilder0 = gson0.fromJson("dayOfMonth", class0);
      assertEquals("dayOfMonth", stringBuilder0.toString());
  }

  @Test(timeout = 4000)
  public void test48()  throws Throwable  {
      Gson gson0 = new Gson();
      Boolean boolean0 = new Boolean(")Wk]YC>/V!CI1,x7");
  ...
  public void test53()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("BPG{!!XJGD");
      stringReader0.read();
      Class<Character> class0 = Character.TYPE;
      try { 
  ...
  public void test58()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("[Ic6yBQ\"CPSjEv/", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"Ic6yBQ\"CPSjEv\"
         //
  ...
  public void test64()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("y>PE", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"y>PE\"
         //
  ...
  public void test66()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("Ngj@[m.zGv", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test68()  throws Throwable  {
      Gson gson0 = new Gson();
      BitSet bitSet0 = new BitSet(1351);
      bitSet0.flip(1351);
  ...
  public void test76()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("H~te7f<", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"H~te7f<\"
         //
  ...
  public void test80()  throws Throwable  {
      Gson gson0 = new Gson();
      Short short0 = new Short((short)4383);
  ...
  public void test83()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(1, (-1), 1, 116, (-1), (-238449324));
      gson0.toJson((Object) mockGregorianCalendar0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=1,MONTH=-1,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=1,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=116,HOUR_OF_DAY=116,MINUTE=-1,SECOND=-238449324,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
  }
}
