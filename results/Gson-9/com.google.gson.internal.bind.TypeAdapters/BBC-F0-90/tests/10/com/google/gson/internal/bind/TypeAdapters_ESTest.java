...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("AeD^]_)>]:L|*", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"AeD^\"
         //
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals(2, atomicInteger0.intValue());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      File file0 = MockFile.createTempFile("{BeJm3/uTQ", "3|\"5*56");
      MockPrintStream mockPrintStream0 = new MockPrintStream(file0);
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter(mockPrintStream0);
      gson0.toJson((Object) atomicIntegerArray0, (Appendable) mockPrintWriter0);
      assertEquals(1036, atomicIntegerArray0.length());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Class<JsonObject> class0 = JsonObject.class;
      try { 
        gson0.fromJson("{BeJm3/uTQ", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // org.evosuite.runtime.mock.java.lang.MockThrowable: Expected ':' at line 1 column 8 path $.BeJm3
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Class<JsonObject> class0 = JsonObject.class;
      try { 
        gson0.fromJson("4}0MunU[q:,ul0mT|", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test22()  throws Throwable  {
      ...
      StringBuilder stringBuilder0 = new StringBuilder(812);
  ...
  public void test23()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Locale> class0 = Locale.class;
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("Q%-N_BN1r7Y\u0005-_G");
      Locale locale0 = gson0.fromJson((JsonElement) jsonPrimitive0, class0);
      assertEquals("q%-n_BN1R7Y\u0005-_G", locale0.toString());
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("iM^/3q4WV_Oh+");
      Gson gson0 = new Gson();
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson((JsonElement) jsonPrimitive0, class0);
      assertEquals("im^/3q4wv_OH+", locale0.toString());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Class<GregorianCalendar> class0 = GregorianCalendar.class;
      try { 
        gson0.fromJson("{FXL/&@3", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // org.evosuite.runtime.mock.java.lang.MockThrowable: Expected ':' at line 1 column 6 path $.FXL
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test36()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<InetAddress> class0 = InetAddress.class;
      Inet4Address inet4Address0 = (Inet4Address)gson0.fromJson("OkATd~bl", class0);
  ...
  public void test45()  throws Throwable  {
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("M^/3q4WpV_Oh");
      Gson gson0 = new Gson();
      Class<StringBuffer> class0 = StringBuffer.class;
  ...
  public void test48()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("f0g6p-0{", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test49()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      try { 
        gson0.fromJson("i2GP w3RJ?3\"KNj6g_#", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test53()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("exkovP+*Z", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: exkovP+*Z
         //
  ...
  public void test55()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("T:g!NdP", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test57()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Sy+:+'SjA2Ls?", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"Sy+\"
         //
  ...
  public void test61()  throws Throwable  {
      ...
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson("E$EgHAZv(8s", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"E$EgHAZv(8s\"
         //
  ...
  public void test63()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("4[cHh)7FCUz*", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test65()  throws Throwable  {
      ...
      Type type0 = typeToken0.getType();
      try { 
        gson0.fromJson("A:~*$OhMSgo5}/R", type0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test74()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("0/XG\";E?mbSK@");
