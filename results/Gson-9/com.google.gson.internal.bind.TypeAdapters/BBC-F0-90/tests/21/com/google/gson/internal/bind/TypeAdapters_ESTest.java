...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson(">!#Nfk@w|r~^A", class0);
  ...
  public void test10()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(3418, 3, 3, 10, 3418, 10);
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=3418,MONTH=3,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=3,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=10,HOUR_OF_DAY=10,MINUTE=3418,SECOND=10,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
  ...
  public void test12()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(7, 9, 7, (-1973), (-353));
  ...
  public void test13()  throws Throwable  {
      ...
      jsonObject0.addProperty("Ba2gw8&", "UNw*&j|lGfD,83s");
  ...
  public void test18()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("9/x3xN8^!L{u5C6t{{", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test20()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("-X/.i[)0N+hDUNb");
  ...
  public void test23()  throws Throwable  {
      ...
      Class<Calendar> class0 = Calendar.class;
      try { 
        gson0.fromJson("com.g2ogte.gson.internalbind.TypeAdapter$7", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test27()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("0jyz)E$nn6k ;~s'Dg/", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test28()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile((File) null, "_uJdtZy");
  ...
  public void test30()  throws Throwable  {
      ...
      Class<? super InetAddress> class1 = typeToken0.getRawType();
      try { 
        gson0.fromJson("9/x3xN8^!L{u5C6t{{", (Type) class1);
        fail("Expecting exception: RuntimeException");
  ...
  public void test38()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<JsonPrimitive> class0 = JsonPrimitive.class;
      JsonPrimitive jsonPrimitive0 = gson0.fromJson("NYMStCxK4`?N_@Cm", class0);
  ...
  public void test46()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("1=*u-`@'u", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test50()  throws Throwable  {
      ...
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson("WeJ%dCr", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"WeJ%dCr\"
         //
  ...
  public void test51()  throws Throwable  {
      ...
      gson0.toJson((Object) atomicIntegerArray0, (Type) class0, (Appendable) stringWriter0);
      assertEquals("[0,0,0,0,0,0,0,0,0]", stringWriter0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("rj|XPpVI~gYpWMy)", type0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"rj|XPpVI~gYpWMy)\"
         //
  ...
  public void test56()  throws Throwable  {
      ...
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson("Dx(To[I~WW;3Oma", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"Dx(To\"
         //
  ...
  public void test59()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("Se[$')M#E1inK", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test61()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("{xb{,bf'~C ", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test62()  throws Throwable  {
      ...
      BitSet bitSet0 = new BitSet(2165);
      bitSet0.flip(3);
      gson0.toJson((Object) bitSet0, (Type) class0, (Appendable) charArrayWriter0);
      assertEquals("[0,0,0,1]", charArrayWriter0.toString());
