...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      TypeAdapterRuntimeTypeWrapper<Long> typeAdapterRuntimeTypeWrapper0 = new TypeAdapterRuntimeTypeWrapper<Long>(gson0, typeAdapter0, class0);
      TypeAdapterFactory typeAdapterFactory1 = TypeAdapters.newTypeHierarchyFactory(class0, (TypeAdapter<Long>) typeAdapterRuntimeTypeWrapper0);
  ...
  public void test03()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("+3 A", (Type) class0);
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("x<B06_RU", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 1: x<B06_RU
         //
  ...
  public void test06()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("Unexpected", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test09()  throws Throwable  {
      ...
      TypeAdapterFactory typeAdapterFactory1 = TypeAdapters.newFactory(class0, (TypeAdapter<AtomicIntegerArray>) treeTypeAdapter0);
      assertFalse(typeAdapterFactory1.equals((Object)typeAdapterFactory0));
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("[Hz1))&#pPcDC3_", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test22()  throws Throwable  {
      Gson gson0 = new Gson();
      Locale locale0 = new Locale("k)", "com.google.gson.internal.bind.TypeAdapters$31", "com.google.gson.internal.bind.TypeAdapters$31");
      JsonElement jsonElement0 = gson0.toJsonTree((Object) locale0);
      Class<Locale> class0 = Locale.class;
      Locale locale1 = gson0.fromJson(jsonElement0, class0);
      assertNotNull(locale1);
      assertEquals("k)_COM.GOOGLE.GSON.INTERNAL.BIND.TYPEADAPTERS$31_com.google.gson.internal.bind.TypeAdapters$31", locale1.toString());
  }
  ...
  public void test42()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("ibETh>");
      Class<StringBuffer> class0 = StringBuffer.class;
      StringBuffer stringBuffer0 = gson0.fromJson((Reader) stringReader0, class0);
      assertEquals("ibETh>", stringBuffer0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      StringBuilder stringBuilder0 = typeAdapterRuntimeTypeWrapper0.fromJson("3:Z]9%6M:iiBQq");
  ...
  public void test47()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<String> class0 = String.class;
      String string0 = gson0.fromJson("x<B06_RU", class0);
      assertEquals("x<B06_RU", string0);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson(" J]J^&__1K2G", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test55()  throws Throwable  {
      ...
      Class<AtomicIntegerArray> class0 = AtomicIntegerArray.class;
      try { 
        gson0.fromJson("[`i5QGlO5yg", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"`i5QGlO5yg\"
         //
  ...
  public void test59()  throws Throwable  {
      ...
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson("&*|{r^@N{2j", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test61()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("8k~aD!CC8jG", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"8k~aD!CC8jG\"
         //
  ...
  public void test63()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("\"q;y < $AEp@", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test69()  throws Throwable  {
      ...
      Class<BitSet> class0 = BitSet.class;
      try { 
        gson0.fromJson("[Hz1))&#pPcDC3_", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Error: Expecting: bitset number value (1, 0), Found: Hz1))&
         //
  ...
  public void test73()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicInteger atomicInteger0 = new AtomicInteger((-2319));
  ...
  public void test80()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(1, 1, 270);
      gson0.toJsonTree((Object) mockGregorianCalendar0);
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=1,MONTH=1,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=270,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
  }
}
