...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("i?Tw@n[pD_.", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"i?Tw@n\"
         //
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("1\"5Q", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 1: 1\"5Q
         //
  ...
  public void test06()  throws Throwable  {
      ...
      TypeAdapterFactory typeAdapterFactory0 = TypeAdapters.newFactory(class0, class0, (TypeAdapter<? super JsonPrimitive>) reflectiveTypeAdapterFactory_Adapter0);
      assertNotNull(typeAdapterFactory0);
  }
  ...
  public void test15()  throws Throwable  {
      Gson gson0 = new Gson();
      Double double0 = new Double((-1099.9902233));
  ...
  public void test16()  throws Throwable  {
      Gson gson0 = new Gson();
      StringBuilder stringBuilder0 = new StringBuilder(2452);
  ...
  public void test29()  throws Throwable  {
      ...
      UUID uUID0 = gson0.fromJson(")nD", class0);
  ...
  public void test37()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("rv\"n,h", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: rv\"n
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test46()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      try { 
        gson0.fromJson("nTU._=dAI e,p", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test50()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("Taao&nC[vs`W,;", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: Taao&nC
         //
  ...
  public void test56()  throws Throwable  {
      ...
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson("pXW", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"pXW\"
         //
  ...
  public void test60()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("(crq{*-t{BOcXO+W59u", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test65()  throws Throwable  {
      ...
      Type type0 = typeToken0.getType();
      try { 
        gson0.fromJson("com.google.gson.internal.bind.TypeAdapters$EnumTypeAdapter", type0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test76()  throws Throwable  {
      Gson gson0 = new Gson();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4, "mU<.,Tt+,3/");
