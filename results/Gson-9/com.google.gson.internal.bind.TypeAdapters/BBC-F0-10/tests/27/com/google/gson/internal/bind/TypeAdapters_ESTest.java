...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("2*Sp`yurc{Jz9*a\"8;", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"2*Sp`yurc\"
         //
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("q(NI~+g1.gM|o_)-B", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 11: q(NI~+g1.gM|o_)-B
         //
  ...
  public void test14()  throws Throwable  {
      ...
      TypeAdapterRuntimeTypeWrapper<MockGregorianCalendar> typeAdapterRuntimeTypeWrapper0 = new TypeAdapterRuntimeTypeWrapper<MockGregorianCalendar>(gson0, treeTypeAdapter0, (Type) null);
  ...
  public void test21()  throws Throwable  {
      ...
      JsonObject jsonObject0 = new JsonObject();
      Class<Calendar> class0 = Calendar.class;
      Integer integer0 = Integer.getInteger("END_OBJECT", 2069);
      jsonObject0.addProperty("z", (Number) integer0);
  ...
  public void test36()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuilder> class0 = StringBuilder.class;
      StringBuilder stringBuilder0 = gson0.fromJson("0bWN7zU^uN", class0);
      assertEquals("0bWN7zU^uN", stringBuilder0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      Gson gson0 = new Gson();
      Float float0 = new Float(1457.855F);
  ...
  public void test43()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("*+Q>av", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: *+Q>av
         //
  ...
  public void test45()  throws Throwable  {
      ...
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson("@)^dx%z[%~l)2dm", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"@)^dx%z\"
         //
  ...
  public void test49()  throws Throwable  {
      Gson gson0 = new Gson();
      UUID uUID0 = MockUUID.fromString("@x>H");
  ...
  public void test57()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("`Oyf!Q-ku=$H 58z", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test61()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("B7;!}r*YV%zWX9i49J", (Type) class0);
  ...
  public void test64()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("n8z:vhxR7t$lZB", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"n8z\"
         //
  ...
  public void test66()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("name == null", (Type) class1);
        fail("Expecting exception: RuntimeException");
  ...
  public void test67()  throws Throwable  {
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "~*4<c#L");
      Gson gson0 = new Gson();
  ...
  public void test69()  throws Throwable  {
      Gson gson0 = new Gson();
      Short short0 = Short.valueOf((short)2669);
