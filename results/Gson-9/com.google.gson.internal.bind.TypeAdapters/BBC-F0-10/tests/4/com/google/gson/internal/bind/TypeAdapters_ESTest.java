...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("?M[jK3C Aq#0", (Type) class0);
  ...
  public void test06()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("Qbm|I");
      String string0 = gson0.toJson((JsonElement) jsonPrimitive0);
      assertEquals("\"Qbm|I\"", string0);
  }
  ...
  public void test08()  throws Throwable  {
      Gson gson0 = new Gson();
      Float float0 = new Float(1967.3486F);
  ...
  public void test12()  throws Throwable  {
      ...
      Class<JsonArray> class0 = JsonArray.class;
      try { 
        gson0.fromJson("{W[6O{N<1O?2", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // org.evosuite.runtime.mock.java.lang.MockThrowable: Expected ':' at line 1 column 4 path $.W
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      BufferedWriter bufferedWriter0 = new BufferedWriter(mockPrintWriter0, 152);
  ...
  public void test22()  throws Throwable  {
      ...
      jsonObject0.addProperty("(\"?'<C", character0);
      Gson gson0 = new Gson();
      // Undeclared exception!
      try { 
        gson0.fromJson((JsonElement) jsonObject0, class0);
  ...
  public void test29()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("Hh<'GQi1sb>!\",HW33y}", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("o5i(h4Th\"+J@x", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 8: o5i(h4Th\"+J@x
         //
  ...
  public void test35()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("o5ie(h4Th\"D+J4@x}", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: o5ie(h4Th\"D+J4@x
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test36()  throws Throwable  {
      Gson gson0 = new Gson();
      StringBuffer stringBuffer0 = new StringBuffer("?M[jK3C Aq#0");
  ...
  public void test41()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<StringBuilder> class0 = StringBuilder.class;
      StringBuilder stringBuilder0 = gson0.fromJson("(~ouYsd7", class0);
      assertEquals("(~ouYsd7", stringBuilder0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("T.i>',<3P", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expecting character, got: T.i>'
         //
  ...
  public void test46()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("a#_=N]@Ee .B", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test49()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicIntegerArray atomicIntegerArray0 = new AtomicIntegerArray((byte)9);
  ...
  public void test51()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("p(1:;b9{`whG:>", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"p(1\"
         //
  ...
  public void test53()  throws Throwable  {
      ...
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson("*0x7%7J2Y3PF|z", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"*0x7%7J2Y3PF|z\"
         //
  ...
  public void test55()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("7a>2R9h}J`>SY.", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"7a>2R9h\"
         //
  ...
  public void test56()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("", "_7o 5lO'");
  ...
  public void test57()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("SO%.:DoR", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test59()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<Boolean> class0 = Boolean.TYPE;
      Float float0 = new Float((-3724.155709));
  ...
  public void test68()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("Q@\u0004LQ5");
  ...
  public void test70()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonElement jsonElement0 = gson0.toJsonTree((Object) "Y");
      Class<Locale> class0 = Locale.class;
