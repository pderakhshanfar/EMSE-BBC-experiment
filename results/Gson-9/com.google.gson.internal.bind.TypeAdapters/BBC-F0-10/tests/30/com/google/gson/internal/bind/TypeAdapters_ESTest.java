...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("D'<zw?(C7=]eGu .", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 2: D'<zw?(C7
         //
  ...
  public void test08()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("8'+3=vTFM");
  ...
  public void test09()  throws Throwable  {
      Gson gson0 = new Gson();
      Boolean boolean0 = new Boolean("JsonReader");
  ...
  public void test10()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("q{@:?=Sp");
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals("com.google.gson.internal.bind.typeadapters$enumtypeadapter", locale0.toString());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Class<Calendar> class0 = Calendar.class;
      try { 
        gson0.fromJson("yA|3pu[Lg2BVHU", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test26()  throws Throwable  {
      Gson gson0 = new Gson();
      UUID uUID0 = MockUUID.fromString("@JsonAdapter value must be TypeAdapter or TypeAdapterFactory reference.");
  ...
  public void test35()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("jC`-", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: jC`-
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test41()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonElement jsonElement0 = gson0.toJsonTree((Object) "com.google.gson.internal.bind.TypeAdapters$23");
      Class<StringBuilder> class0 = StringBuilder.class;
  ...
  public void test49()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader(".\"y7(V(>VaQ[Mvk,eJc");
      Class<Character> class0 = Character.class;
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Expecting character, got: .\"y7(V(>VaQ
         //
  ...
  public void test51()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("(`ANr", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"(`ANr\"
         //
  ...
  public void test54()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("iKck!", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"iKck!\"
         //
  ...
  public void test56()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("fWGR:RF][fH;");
      Class<Short> class0 = Short.TYPE;
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"fWGR:RF][fH;\"
         //
  ...
  public void test66()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("JD97e_?", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test77()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(1015, 4434, 1106, 4434, (-929));
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=?,areFieldsSet=false,areAllFieldsSet=false,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=?,YEAR=1015,MONTH=4434,WEEK_OF_YEAR=?,WEEK_OF_MONTH=?,DAY_OF_MONTH=1106,DAY_OF_YEAR=?,DAY_OF_WEEK=?,DAY_OF_WEEK_IN_MONTH=?,AM_PM=0,HOUR=4434,HOUR_OF_DAY=4434,MINUTE=-929,SECOND=0,MILLISECOND=?,ZONE_OFFSET=?,DST_OFFSET=?]", mockGregorianCalendar0.toString());
