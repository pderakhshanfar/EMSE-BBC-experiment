...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("30{B40!eWRRg)H", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test12()  throws Throwable  {
      Class<JsonNull> class0 = JsonNull.class;
      Gson gson0 = new Gson();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2846, "qm\"iODEMTg");
  ...
  public void test13()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("qtpI*.qNaa:`9`Bt 'e", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test16()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonElement jsonElement0 = gson0.toJsonTree((Object) "p/Te@RN#rx_B");
      Class<Locale> class0 = Locale.class;
      Locale locale0 = gson0.fromJson(jsonElement0, class0);
      assertEquals("p/te@rn#rx_B", locale0.toString());
  }
  ...
  public void test26()  throws Throwable  {
      Gson gson0 = new Gson();
      Class<UUID> class0 = UUID.class;
      UUID uUID0 = gson0.fromJson("Go", class0);
  ...
  public void test30()  throws Throwable  {
      Gson gson0 = new Gson();
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("JCF23bi@aGb{bp)=,3");
      Class<InetAddress> class0 = InetAddress.class;
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("!62nd%su9{h8NeGx", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Malformed escape pair at index 5: !62nd%su9
         //
  ...
  public void test40()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("e7h");
      Class<StringBuffer> class0 = StringBuffer.class;
      StringBuffer stringBuffer0 = gson0.fromJson((Reader) stringReader0, class0);
      assertEquals("e7h", stringBuffer0.toString());
  }
  ...
  public void test52()  throws Throwable  {
      ...
      Class<Long> class0 = Long.TYPE;
      try { 
        gson0.fromJson("mvcseRKfsgk", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"mvcseRKfsgk\"
         //
  ...
  public void test55()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson("DJ%^9(", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"DJ%^9(\"
         //
  ...
  public void test57()  throws Throwable  {
      ...
      Class<Short> class0 = Short.TYPE;
      try { 
        gson0.fromJson("gO]K7", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test59()  throws Throwable  {
      ...
      Class<Byte> class0 = Byte.TYPE;
      try { 
        gson0.fromJson("4=[(>PBs=", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test61()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("ihQvn[*${L2d", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test67()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("wjz(.]u|vZ_#>");
      Class<Currency> class0 = Currency.class;
      // Undeclared exception!
      try { 
        gson0.fromJson((Reader) stringReader0, class0);
  ...
  public void test69()  throws Throwable  {
      Gson gson0 = new Gson();
      AtomicInteger atomicInteger0 = new AtomicInteger((-793));
  ...
  public void test70()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("%5?0>4 P@t5X");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"%5?0>4\"
         //
