...
public class TypeAdapters_ESTest extends TypeAdapters_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("^Gt;CDl/S", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.URISyntaxException: Illegal character in path at index 0: ^Gt
         //
  ...
  public void test07()  throws Throwable  {
      ...
      Double double0 = new Double(3192.93138);
      jsonObject0.addProperty("com.google.gson.internal.bind.TypeAdapters$EnumTypeAdapter", (Number) double0);
  ...
  public void test10()  throws Throwable  {
      Gson gson0 = new Gson();
      Boolean boolean0 = Boolean.valueOf("_{axC");
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(boolean0);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      MockCalendar mockCalendar0 = typeAdapterRuntimeTypeWrapper0.fromJsonTree(jsonPrimitive0);
  ...
  public void test16()  throws Throwable  {
      ...
      Locale locale0 = gson0.fromJson("5x`_Z+T", class0);
      assertEquals("5x`_Z+T", locale0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Class<Locale> class0 = Locale.class;
      try { 
        gson0.fromJson("4O<2m!(_]jZxJI>(.,", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test20()  throws Throwable  {
      Gson gson0 = new Gson();
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(2, (-637), 2, 2, 728);
      Class<GregorianCalendar> class0 = GregorianCalendar.class;
      ...
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=-63779305920000,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=0,YEAR=53,MONTH=11,WEEK_OF_YEAR=49,WEEK_OF_MONTH=1,DAY_OF_MONTH=2,DAY_OF_YEAR=337,DAY_OF_WEEK=3,DAY_OF_WEEK_IN_MONTH=1,AM_PM=1,HOUR=2,HOUR_OF_DAY=14,MINUTE=8,SECOND=0,MILLISECOND=0,ZONE_OFFSET=0,DST_OFFSET=0]", mockGregorianCalendar0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      Gson gson0 = new Gson();
      UUID uUID0 = MockUUID.fromString("dwj?h9z7(h!~");
  ...
  public void test27()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("emvzTI|6AR%%IC#K[(k");
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test30()  throws Throwable  {
      ...
      Class<InetAddress> class0 = InetAddress.class;
      try { 
        gson0.fromJson("r_KTOK%|3,", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test35()  throws Throwable  {
      ...
      Class<URL> class0 = URL.class;
      try { 
        gson0.fromJson("Rk2XwH~8", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.net.MalformedURLException: no protocol: Rk2XwH~8
         //
         verifyException("com.google.gson.Gson", e);
      }
  }
  ...
  public void test39()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("QeTI/$y_vC\"6>zz}", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test43()  throws Throwable  {
      ...
      Gson gson0 = new Gson();
      try { 
        gson0.fromJson("()axse_57[Hx/d/LM", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test44()  throws Throwable  {
      Gson gson0 = new Gson();
      Boolean boolean0 = Boolean.valueOf("second");
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(boolean0);
      Class<String> class0 = String.class;
  ...
  public void test46()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      try { 
        gson0.fromJson("U=bcFsA)p", class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test47()  throws Throwable  {
      ...
      MockPrintStream mockPrintStream0 = new MockPrintStream("com.google.gson.internal.bind.TypeAdapters$22");
  ...
  public void test49()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("@:.x$p]$kf", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test51()  throws Throwable  {
      ...
      Class<Character> class0 = Character.TYPE;
      try { 
        gson0.fromJson("cw}%zDs*,}4kc}{mu", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test55()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("[JrBK,]yF%.nL", (Type) class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"JrBK\"
         //
  ...
  public void test57()  throws Throwable  {
      Gson gson0 = new Gson();
      StringReader stringReader0 = new StringReader("|R1y{i7{W$)a");
      Class<Integer> class0 = Integer.TYPE;
      try { 
        gson0.fromJson((Reader) stringReader0, (Type) class0);
        fail("Expecting exception: RuntimeException");
         ...
         //
         // java.lang.NumberFormatException: For input string: \"|R1y\"
         //
  ...
  public void test60()  throws Throwable  {
      ...
      Class<Float> class1 = Float.class;
      ArrayTypeAdapter<Float> arrayTypeAdapter0 = new ArrayTypeAdapter<Float>(gson0, typeAdapterRuntimeTypeWrapper0, class1);
      JsonElement jsonElement0 = arrayTypeAdapter0.toJsonTree((Object) null);
  ...
  public void test65()  throws Throwable  {
      ...
      Class<Boolean> class0 = Boolean.TYPE;
      try { 
        gson0.fromJson("{p>b7d(Rp[", (Type) class0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test66()  throws Throwable  {
      ...
      ByteBuffer byteBuffer0 = charset0.encode("+M*&7D$jY4XLQVcV");
  ...
  public void test69()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gson0.fromJson("AA3Ycc/|+{:5;?EX", class0);
  ...
  public void test72()  throws Throwable  {
      ...
      try { 
        gson0.fromJson("!Bc$@UXEYCX%rCP", class0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.NumberFormatException: For input string: \"!Bc$@UXEYCX%rCP\"
         //
  ...
  public void test78()  throws Throwable  {
      ...
      TreeTypeAdapter<MockCalendar> treeTypeAdapter0 = new TreeTypeAdapter<MockCalendar>(jsonSerializer0, jsonDeserializer0, gson0, typeToken0, typeAdapterFactory0);
      TypeAdapterRuntimeTypeWrapper<MockCalendar> typeAdapterRuntimeTypeWrapper0 = new TypeAdapterRuntimeTypeWrapper<MockCalendar>(gson0, treeTypeAdapter0, class0);
      TypeAdapterFactory typeAdapterFactory1 = TypeAdapters.newTypeHierarchyFactory(class1, (TypeAdapter<MockCalendar>) typeAdapterRuntimeTypeWrapper0);
