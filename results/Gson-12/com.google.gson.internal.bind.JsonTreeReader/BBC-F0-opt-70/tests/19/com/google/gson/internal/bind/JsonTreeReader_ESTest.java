...
public class JsonTreeReader_ESTest extends JsonTreeReader_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("?nZ%hJde=AWT;NH2");
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonObject0.add("?nZ%hJde=AWT;NH2", jsonPrimitive0);
      jsonTreeReader0.beginObject();
      String string0 = jsonTreeReader0.nextName();
      assertEquals("?nZ%hJde=AWT;NH2", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Short short0 = new Short((short) (-4162));
  ...
  public void test02()  throws Throwable  {
      Float float0 = new Float(0.3939607520446789);
  ...
  public void test05()  throws Throwable  {
      Float float0 = new Float((-1415.108031));
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(float0);
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonPrimitive0);
      double double0 = jsonTreeReader0.nextDouble();
      assertEquals((-1415.1080322265625), double0, 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonObject0.add("(tb@h5L|}}Or1;Cz", jsonObject0);
      jsonTreeReader0.beginObject();
      Double double0 = new Double(0.0);
      jsonObject0.addProperty("Mblr!hXE", (Number) double0);
      // Undeclared exception!
      try { 
        jsonTreeReader0.skipValue();
        fail("Expecting exception: ConcurrentModificationException");
  ...
  public void test12()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonObject0.add("?nZ%hJde=AWT;NH2", (JsonElement) null);
      jsonTreeReader0.beginObject();
      jsonObject0.add("Bz", (JsonElement) null);
      // Undeclared exception!
      try { 
        jsonTreeReader0.promoteNameToValue();
        fail("Expecting exception: ConcurrentModificationException");
  ...
  public void test26()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: NumberFormatException");
         ...
         //
         // For input string: \"?nZ%hJde=AWT;NH2\"
         //
  ...
  public void test63()  throws Throwable  {
      Float float0 = new Float((-1309.154F));
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(float0);
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonPrimitive0);
      jsonTreeReader0.nextString();
      // Undeclared exception!
  ...
  public void test74()  throws Throwable  {
      Float float0 = new Float((-24.839677694948215));
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(float0);
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonPrimitive0);
      jsonTreeReader0.nextString();
      JsonToken jsonToken0 = jsonTreeReader0.peek();
