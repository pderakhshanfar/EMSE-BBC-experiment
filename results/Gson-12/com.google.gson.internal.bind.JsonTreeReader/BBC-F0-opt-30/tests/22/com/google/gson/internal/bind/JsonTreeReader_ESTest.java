...
public class JsonTreeReader_ESTest extends JsonTreeReader_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Float float0 = new Float((-729.2917));
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(float0);
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonPrimitive0);
      double double0 = jsonTreeReader0.nextDouble();
      assertEquals((-729.2916870117188), double0, 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("JSON must have only one top-level value.", "JSON must have only one top-level value.");
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonTreeReader0.beginObject();
      jsonObject0.remove("JSON must have only one top-level value.");
      // Undeclared exception!
      try { 
        jsonTreeReader0.skipValue();
        fail("Expecting exception: ConcurrentModificationException");
  ...
  public void test19()  throws Throwable  {
      Float float0 = new Float(1535.6117701852033);
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(float0);
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonPrimitive0);
      // Undeclared exception!
      try { 
  ...
  public void test54()  throws Throwable  {
      ...
      jsonObject0.addProperty("S1Mqj_jg", (Number) byte0);
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonTreeReader0.beginObject();
      JsonToken jsonToken0 = jsonTreeReader0.peek();
  ...
  public void test71()  throws Throwable  {
      Float float0 = new Float(4423.45781824);
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(float0);
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonPrimitive0);
      jsonTreeReader0.setLenient(true);
      double double0 = jsonTreeReader0.nextDouble();
      assertEquals(4423.4580078125, double0, 0.01);
  }
