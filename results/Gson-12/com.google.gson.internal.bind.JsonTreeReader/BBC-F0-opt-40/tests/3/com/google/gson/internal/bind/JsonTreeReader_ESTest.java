...
public class JsonTreeReader_ESTest extends JsonTreeReader_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonObject0.add("Hxy]r ')&g<(m*ea[w", (JsonElement) null);
  ...
  public void test02()  throws Throwable  {
      Float float0 = new Float((-2089.2144163));
  ...
  public void test09()  throws Throwable  {
      ...
      jsonObject0.addProperty("JBPy(N^4.LpbIRW`", character0);
      // Undeclared exception!
      try { 
        jsonTreeReader0.skipValue();
        fail("Expecting exception: ConcurrentModificationException");
  ...
  public void test12()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("c0qUz<.*kl)P", "c0qUz<.*kl)P");
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonTreeReader0.beginObject();
      jsonObject0.addProperty("hjE!k{N/BNvh'm$x;SS", "hjE!k{N/BNvh'm$x;SS");
      // Undeclared exception!
      try { 
        jsonTreeReader0.promoteNameToValue();
        fail("Expecting exception: ConcurrentModificationException");
  ...
  public void test23()  throws Throwable  {
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("AwF#$=vtAf mZ#Z");
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonPrimitive0);
      // Undeclared exception!
      try { 
        jsonTreeReader0.nextLong();
        fail("Expecting exception: NumberFormatException");
         ...
         //
         // For input string: \"AwF#$=vtAf mZ#Z\"
         //
  ...
  public void test60()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonObject0.addProperty("Hxy]r ')&g<(m*ea[w", "Hxy]r ')&g<(m*ea[w");
      jsonTreeReader0.beginObject();
      JsonToken jsonToken0 = jsonTreeReader0.peek();
  ...
  public void test64()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("Hxy]r ')&g<(m*ea[w", "");
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonTreeReader0.beginObject();
      jsonTreeReader0.nextName();
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Expected NAME but was STRING at path $.Hxy]r ')&g<(m*ea[w
         //
         verifyException("com.google.gson.internal.bind.JsonTreeReader", e);
      }
  }
  ...
  public void test87()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("Zt|v<!Uj^}@0nP@!;", (String) null);
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonTreeReader0.beginObject();
      jsonTreeReader0.skipValue();
      jsonTreeReader0.nextNull();
