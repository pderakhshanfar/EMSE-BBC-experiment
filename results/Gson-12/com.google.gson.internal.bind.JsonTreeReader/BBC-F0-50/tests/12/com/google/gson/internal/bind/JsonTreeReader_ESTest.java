...
public class JsonTreeReader_ESTest extends JsonTreeReader_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      jsonObject0.addProperty("e1'W_tEbF", character0);
      jsonTreeReader0.beginObject();
      String string0 = jsonTreeReader0.nextName();
      assertEquals("e1'W_tEbF", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      jsonObject0.addProperty("S($1[8t/8'", boolean0);
      // Undeclared exception!
      try { 
        jsonTreeReader0.skipValue();
        fail("Expecting exception: ConcurrentModificationException");
  ...
  public void test10()  throws Throwable  {
      ...
      jsonObject0.addProperty("Z |UFE|#xbV-4]0q", character0);
      jsonTreeReader0.beginObject();
      jsonObject0.remove("Z |UFE|#xbV-4]0q");
      // Undeclared exception!
      try { 
        jsonTreeReader0.promoteNameToValue();
        fail("Expecting exception: ConcurrentModificationException");
  ...
  public void test19()  throws Throwable  {
      ...
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      Character character0 = Character.valueOf('^');
      jsonObject0.addProperty(">yG", character0);
      jsonTreeReader0.beginObject();
      Boolean boolean0 = Boolean.FALSE;
  ...
  public void test22()  throws Throwable  {
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("CharokW(eBZ=K");
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonPrimitive0);
      // Undeclared exception!
      try { 
        jsonTreeReader0.nextLong();
        fail("Expecting exception: NumberFormatException");
         ...
         //
         // For input string: \"CharokW(eBZ=K\"
         //
  ...
  public void test38()  throws Throwable  {
      Boolean boolean0 = Boolean.valueOf("%@.iWW0F8m@");
  ...
  public void test41()  throws Throwable  {
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("%O4~ui ]Rn}B.RLnehS");
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonPrimitive0);
      // Undeclared exception!
      try { 
        jsonTreeReader0.beginObject();
  ...
  public void test61()  throws Throwable  {
      ...
      jsonObject0.addProperty("`#b8u8W_2", boolean0);
      jsonTreeReader0.beginObject();
      // Undeclared exception!
      try { 
        jsonTreeReader0.endObject();
  ...
  public void test64()  throws Throwable  {
      ...
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      Character character0 = Character.valueOf('6');
      jsonObject0.addProperty("u( 6 h&~,_&", character0);
      jsonTreeReader0.beginObject();
      jsonTreeReader0.skipValue();
      int int0 = jsonTreeReader0.nextInt();
      assertEquals(6, int0);
  ...
  public void test73()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonObject0.addProperty("+>M<ePsA`-51eVX@`I", (Character) null);
      jsonTreeReader0.beginObject();
      jsonTreeReader0.skipValue();
      jsonTreeReader0.nextNull();
  ...
  public void test85()  throws Throwable  {
      Float float0 = new Float((-274.34099205));
      JsonArray jsonArray0 = new JsonArray();
