...
public class JsonTreeReader_ESTest extends JsonTreeReader_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonObject0.addProperty("{`h:9TEt%Dr*`++H", "{`h:9TEt%Dr*`++H");
      ...
      assertEquals("{`h:9TEt%Dr*`++H", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("", "com.goole.gson.internal.bind.JsonTreReader");
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonTreeReader0.beginObject();
      String string0 = jsonTreeReader0.nextName();
  ...
  public void test03()  throws Throwable  {
      Float float0 = new Float((-2273.528));
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals((-2273.528076171875), double0, 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("qx0@f^fSgL", "qx0@f^fSgL");
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonTreeReader0.beginObject();
  ...
  public void test12()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("x%#$h&1L", "x%#$h&1L");
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonTreeReader0.beginObject();
      jsonObject0.addProperty("key == null", "q(.k2sZ5I}..Z]%xKu");
      // Undeclared exception!
      try { 
        jsonTreeReader0.promoteNameToValue();
        fail("Expecting exception: ConcurrentModificationException");
  ...
  public void test20()  throws Throwable  {
      ...
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonTreeReader0.beginObject();
      Boolean boolean0 = Boolean.valueOf("qx0@f^fSgL");
      jsonObject0.addProperty("", boolean0);
      // Undeclared exception!
      try { 
        jsonTreeReader0.nextName();
  ...
  public void test23()  throws Throwable  {
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("LeEu6x%jccH\"6/.R$");
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonPrimitive0);
      // Undeclared exception!
      try { 
        jsonTreeReader0.nextLong();
        fail("Expecting exception: NumberFormatException");
         ...
         //
         // For input string: \"LeEu6x%jccH\"6/.R$\"
         //
  ...
  public void test44()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonObject0.addProperty("{nh:9TEt%Dr*`++H", "{nh:9TEt%Dr*`++H");
      jsonTreeReader0.beginObject();
      jsonTreeReader0.skipValue();
      String string0 = jsonTreeReader0.getPath();
  ...
  public void test56()  throws Throwable  {
      ...
      jsonObject0.addProperty(";)w5Y&1DQWapF`L", boolean0);
      jsonTreeReader0.beginObject();
      JsonToken jsonToken0 = jsonTreeReader0.peek();
  ...
  public void test61()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("&==y^>mPS9UEl$$/W3", (String) null);
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonTreeReader0.beginObject();
      jsonTreeReader0.skipValue();
      // Undeclared exception!
  ...
  public void test62()  throws Throwable  {
      JsonArray jsonArray0 = new JsonArray();
      Boolean boolean0 = Boolean.valueOf("VEOe6.#$|}O");
      jsonArray0.add(boolean0);
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonArray0);
      jsonTreeReader0.beginArray();
      // Undeclared exception!
  ...
  public void test65()  throws Throwable  {
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("N*\"M[^;|O4)/Pd?%p<b");
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonPrimitive0);
      // Undeclared exception!
      try { 
        jsonTreeReader0.nextInt();
        fail("Expecting exception: NumberFormatException");
         ...
         //
         // For input string: \"N*\"M[^;|O4)/Pd?%p<b\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test66()  throws Throwable  {
      ...
      jsonObject0.addProperty("name == null", (Number) short0);
      jsonTreeReader0.beginObject();
      jsonTreeReader0.skipValue();
      int int0 = jsonTreeReader0.nextInt();
      assertEquals(4, int0);
  ...
  public void test77()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      jsonObject0.addProperty("com.google.gson.internal.LinkedTreeMap$Node", "V`h:9TEt%Dr*++H");
      jsonTreeReader0.beginObject();
      jsonTreeReader0.skipValue();
      String string0 = jsonTreeReader0.nextString();
      assertEquals("V`h:9TEt%Dr*++H", string0);
  }
  ...
  public void test91()  throws Throwable  {
      ...
      JsonTreeReader jsonTreeReader0 = new JsonTreeReader(jsonObject0);
      JsonArray jsonArray0 = new JsonArray();
      jsonObject0.add("year", jsonArray0);
      jsonTreeReader0.beginObject();
      jsonTreeReader0.skipValue();
      jsonTreeReader0.beginArray();
      jsonTreeReader0.endArray();
