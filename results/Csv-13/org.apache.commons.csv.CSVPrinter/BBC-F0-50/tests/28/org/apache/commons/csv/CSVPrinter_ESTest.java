...
public class CSVPrinter_ESTest extends CSVPrinter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "4$eD4<Gz$7D");
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockPrintStream mockPrintStream0 = new MockPrintStream("xO[Z");
      CSVPrinter cSVPrinter0 = cSVFormat0.print(mockPrintStream0);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      MockFileWriter mockFileWriter0 = new MockFileWriter("y<N~4%+d8");
      mockFileWriter0.close();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker('H');
      CSVPrinter cSVPrinter0 = new CSVPrinter(mockFileWriter0, cSVFormat1);
      try { 
        cSVPrinter0.printComment("y<N~4%+d8");
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      ...
      CharBuffer charBuffer0 = CharBuffer.wrap(charArray0);
      CSVPrinter cSVPrinter0 = new CSVPrinter(charBuffer0, cSVFormat0);
      SQLDataException sQLDataException0 = new SQLDataException("xO[", "Fz", 2191);
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockPrintStream mockPrintStream0 = new MockPrintStream("4xO[");
      CSVPrinter cSVPrinter0 = new CSVPrinter(mockPrintStream0, cSVFormat0);
      cSVPrinter0.printComment("RQ~k]=@Hph}n=yu%");
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("iFcqsw");
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      CSVPrinter cSVPrinter0 = cSVFormat1.print(stringBuffer0);
      cSVPrinter0.print((Object) null);
      assertEquals(6, stringBuffer0.length());
      assertEquals("iFcqsw", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      CSVPrinter cSVPrinter0 = new CSVPrinter(charArrayWriter0, cSVFormat1);
      cSVPrinter0.printRecords(objectArray0);
      assertEquals(640, charArrayWriter0.size());
  ...
  public void test42()  throws Throwable  {
      ...
      SQLDataException sQLDataException0 = new SQLDataException(".V!{l/b?Dd_>_", "");
      cSVPrinter0.print(sQLDataException0);
      assertEquals("java.sql.SQLDataException: .V!{l/b?Dd_>_", sQLDataException0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("0in{/ ");
      CSVPrinter cSVPrinter0 = new CSVPrinter(charArrayWriter0, cSVFormat1);
      cSVPrinter0.printRecord(objectArray0);
      assertEquals("\"0in{/ \",\"0in{/ \",\"0in{/ \",\"0in{/ \",\"0in{/ \",\"0in{/ \",\"0in{/ \",\"0in{/ \",\"0in{/ \",\"0in{/ \",\"0in{/ \"\r\n", charArrayWriter0.toString());
