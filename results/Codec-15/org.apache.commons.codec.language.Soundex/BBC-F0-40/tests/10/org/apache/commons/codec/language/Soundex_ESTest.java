...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = soundex0.encode((Object) "PVz:Vhy)H;>K%k%pj");
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("Y4K(.m;d^>H1\"H");
      assertEquals("Yo.c", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("PXVz:Vhy)H;>K%hk%pj");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "PXVz:Vhy)H;>K%hk%pj");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("*0", "org.apache.commons.codec.EncoderException");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("?},ZZA<`mh6[uJv[");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("[USUdH|WVjmB");
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("=TE1;$9r04W]+R@r");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("T660", string0);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("isC:Wf2WA?6AJ)rl", "isC:Wf2WA?6AJ)rl");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(4, int0);
  }
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex("em`d&gY`Q");
      // Undeclared exception!
      try { 
        soundex0.soundex("7JQ.kY");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("&:pAWhlU|Z", "&:pAWhlU|Z");
      assertEquals(4, int0);
  }
