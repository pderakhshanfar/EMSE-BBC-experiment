...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.difference("2h@)", "-%Bwnx`qOE");
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.encode("B6jnsdF)+");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("Bem.", string0);
  }
  ...
  public void test04()  throws Throwable  {
      Soundex soundex0 = new Soundex("q}R^s{H^v6)^(");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "q}R^s{H^v6)^(");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("ff{'+LNQ_L", "VpCijvn");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("j&Yq7w^`wwfN");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("J250", string0);
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("86DtU0U.hw1N%");
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("9&Rn*+j%H.gdI[p<l");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode("y,+wr&");
      assertEquals("Y600", string0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      soundex0.setMaxLength((-2281));
      assertEquals((-2281), soundex0.getMaxLength());
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex("g~SB`G+j Y");
      // Undeclared exception!
      try { 
        soundex0.encode("g~SB`G+j Y");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("12:tHk1x=Vf#xk\"/'O~", "12:tHk1x=Vf#xk\"/'O~");
      assertEquals(4, int0);
