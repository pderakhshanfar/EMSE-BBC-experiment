...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Soundex soundex0 = new Soundex("`p #aT_etE^KT>4+qj");
      // Undeclared exception!
      try { 
        soundex0.difference("`p #aT_etE^KT>4+qj", "`p #aT_etE^KT>4+qj");
  ...
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.EncoderException");
      int int0 = soundex0.difference("c>-JK(c", "#}pHB");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.US_ENGLISH.difference("g`3e, en=", "O621");
      assertEquals(2, int0);
  }
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("7+,K");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "7+,K");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("&Zj3hc2'a`");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("p:'A}<whzRP>)?wQ_t<", "01230120022455012623010202");
      assertEquals(0, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("&Zj3hc2'a`");
      assertEquals("Z000", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("nY~w]7v|+M^}8kNK4");
      assertEquals("N152", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex("FhHD&VdF_V |kSur:n");
      // Undeclared exception!
      try { 
        soundex0.encode("FhHD&VdF_V |kSur:n");
        fail("Expecting exception: IllegalArgumentException");
