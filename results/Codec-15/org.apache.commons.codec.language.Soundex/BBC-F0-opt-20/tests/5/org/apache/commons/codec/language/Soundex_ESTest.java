...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        soundex0.difference(";(ig&sp&9", ";(ig&sp&9");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("", "DBghpd");
      assertEquals(0, int0);
  ...
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("?yzG2/L\">");
      assertEquals("Y240", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      int int0 = soundex0.US_ENGLISH.difference("<_/2LZ\"A.}U[D~", "mEgd~47o");
      assertEquals(3, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "^$8z6qNl=");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("XFJ,~jK%O$?Hi/ZJkfG");
      assertEquals("Xpe.", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode("9F#nZwSwj0");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex("Parameter supplied to Soundex encode is not of type java.lang.String");
      int int0 = soundex0.difference("org.apache.commons.codec.language.SoundexUtils", "@q$s>5w|.#%,pw ~X");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      Object object0 = soundex0.US_ENGLISH.encode((Object) "{!X2H8r");
      assertEquals("X600", object0);
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("O!JW6HLbi>", "");
      assertEquals(0, int0);
  }
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("rX(h'5WT]eKc");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("R220", string0);
  }
