...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.difference("org.apache.commons.codec.EncoderException", "RI/(z`S&HfdmT /:~");
  ...
  public void test03()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("&1p", "yT]MZIz@2NC%ghdUk.S");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test04()  throws Throwable  {
      Soundex soundex0 = new Soundex("G-^NyT?BDt$rW|?L]WF");
      // Undeclared exception!
      try { 
        soundex0.soundex("TCt`;");
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("{SX5*+}|;@WQ");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("&FHz4|$0{w(NnB");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.encode("CjG{#vpi=X('[hHs");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.encode((Object) "ji'$X]x7i5h^#nSK*br");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("J252", object0);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("pwwV?O;+O\"", "pwwV?O;+O\"");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex("E\"k_rb#YIwTsk@ASGoH");
      String string0 = soundex0.soundex("E\"k_rb#YIwTsk@ASGoH");
      assertEquals("ETo\"", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
