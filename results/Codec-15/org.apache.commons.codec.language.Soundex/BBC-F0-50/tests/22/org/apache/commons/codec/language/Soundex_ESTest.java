...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.US_ENGLISH.difference("01230120022455012623010202", "qE1:VO$~fwtZl0");
      assertEquals(0, int0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      soundex0.difference("{pX/ZkB3Ohb5", "");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        soundex0.soundex("u:sGcl--DIy47wrmW");
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("YMG crBw");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex("vZF'@T{~5(Go'dD;'");
      // Undeclared exception!
      try { 
        soundex0.encode("1r4DD x#'w|[z");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("W:w@%N.qI/^,k");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference(".HhL.Q#_U9N!@(_cLp", ".HhL.Q#_U9N!@(_cLp");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(4, int0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      soundex0.difference("", "2\"[^SG\"$NuT!TKF`H");
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("ixwPC~3|TP", "yf0LOdR!Mcuy J");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
