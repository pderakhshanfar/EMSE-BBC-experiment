...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("cvx6=J.dT!W");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex("GTtxKs1_0}uwN<0 *");
      // Undeclared exception!
      try { 
        soundex0.encode("i'[`oRz5n<C*&q#)U&");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("hdwwFOcb)5*]S\"A", "hdwwFOcb)5*]S\"A");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
