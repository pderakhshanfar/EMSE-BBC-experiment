...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("cCs2cjRh*q.Bb", "The character is not mapped: ");
      assertEquals(0, int0);
  ...
  public void test04()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("*,Fo_{t&%nOA*g");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex(".f/(=j#ZH-'");
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("r+g1w+A4W;Hr2P");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      soundex0.difference("", "=kHHSyD[^X_7b_4");
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("S=fZHQ|c#9h06KwC*r", ";MI");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("e9`uG1:#[/:yh;ko#Q", "e9`uG1:#[/:yh;ko#Q");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(4, int0);
  }
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.encode((Object) "S412");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex("S412");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "D(nvJMdF5_;o]J");
        fail("Expecting exception: IllegalArgumentException");
