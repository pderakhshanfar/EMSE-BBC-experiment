...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Soundex soundex0 = new Soundex("U$uOKJA[~;8+QBCdw&1");
      // Undeclared exception!
      try { 
        soundex0.soundex("?t>j%A9*i+I >H\"2w");
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("=._W[C$/#'4Xw[v{(i");
  ...
  public void test02()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("EG]QA `C+o");
      assertEquals("Ea T", string0);
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("", "G");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("|J<e^(%b:");
      // Undeclared exception!
      try { 
        soundex0.encode("bz-FM{ht");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("/.eb_vR", "org.apache.commons.codec.EncoderException");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("( 5X^_BwN{Kb V9B2h^", "Xq[l3c$A)y(E");
      assertEquals(1, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode("guz`H!+J0u");
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("-(Ozhwre`_Eq<)>=KB#");
  ...
  public void test20()  throws Throwable  {
      ...
      Soundex soundex0 = new Soundex(charArray0);
      String string0 = soundex0.US_ENGLISH.soundex("Tw_^!+W+XR^");
      assertEquals(4, soundex0.getMaxLength());
