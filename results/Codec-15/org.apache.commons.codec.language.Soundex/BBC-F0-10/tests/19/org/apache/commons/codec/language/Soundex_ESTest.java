...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.encode("b^Ds8xHMWbaVZw");
  ...
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex("{},`g5J66iml!TvSR");
      Object object0 = soundex0.encode((Object) "{},`g5J66iml!TvSR");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("imkc2NV+=$th0/");
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("[L}yY iLD~");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "[L}yY iLD~");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("*0O_n@I#_>FV", "Q130");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex(" 18D ]wJ~xD^'(RW\"~6");
      assertEquals("D236", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("O621", (String) null);
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      soundex0.difference("", "vXJzHC7]N(< QKKm>");
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("N2Pq~W!+Wv/F]");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.encode((Object) "d1Kowhh0H;lQD");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test22()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("d1Kowhh0H;lQD", "d1Kowhh0H;lQD");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(4, int0);
  }
