...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("Ry`wf0oa:0{H>``PFA");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("|5{N%zCNDr", "p<KK{8^UU");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("\"\"N?Xk`l60O@eqj");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("mh`36WW@8n)");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("]o `ZwJa&", "y,hqOV");
      assertEquals(2, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("TWGMH/w93%S)");
      assertEquals("T250", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.encode((Object) "Parameter supplied to Soundex encode is not of type ja#a.lang.String");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.encode((Object) ".Ti^TvK:Xs1");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("Parameter supplied to Soundex encode is not of type ja#a.lang.String");
      assertEquals(4, soundex0.getMaxLength());
