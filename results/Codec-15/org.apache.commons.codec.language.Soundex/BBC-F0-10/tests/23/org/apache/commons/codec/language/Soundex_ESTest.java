...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.US_ENGLISH.difference("H!e,y+=$w<;b3dou])", "");
      assertEquals(0, int0);
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("w5mWG aIZ~-:ybd", "C|f2bQ");
      assertEquals(1, int0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      int int0 = soundex0.difference("Dpy8_", "-^&,Fyz'/)+O73S");
      assertEquals(1, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test03()  throws Throwable  {
      Soundex soundex0 = new Soundex("The character is not mapped: ");
      int int0 = soundex0.difference((String) null, "pUCNS=)b*W59.p>]D");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        soundex0.encode((Object) "Wh-&[=A{eLS4U1_/-");
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex("L,^}_?\"W\"R9");
      // Undeclared exception!
      try { 
        soundex0.difference("L,^}_?\"W\"R9", "L");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("I,J", "!W\"WjbG457i[w%-6");
      assertEquals(1, int0);
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("(9E0W;|(C&3W-<G%<&");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("", "hW(j62@)G");
      assertEquals(0, int0);
  }
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.US_ENGLISH.difference("EejS:^", "k@ph]N");
      assertEquals(1, int0);
  }
  ...
  public void test22()  throws Throwable  {
      Soundex soundex0 = new Soundex("8Hm$a8XH1<&^w%oz7v");
      // Undeclared exception!
      try { 
        soundex0.soundex("8Hm$a8XH1<&^w%oz7v");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("+u%d&d");
      assertEquals("U300", string0);
