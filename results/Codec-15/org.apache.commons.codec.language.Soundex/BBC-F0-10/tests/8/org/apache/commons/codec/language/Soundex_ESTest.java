...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Soundex soundex0 = new Soundex("D|=~$aH<oP)g84H7YMk");
      String string0 = soundex0.encode("D|=~$aH<oP)g84H7YMk");
      assertEquals("DD<H", string0);
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.US_ENGLISH.difference("TIyhvNzk>K", "9juizT|)6@$[:P");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        soundex0.soundex("M#VUO{Q PuyZ&y");
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("|qd*ZS@lI=N");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "|qd*ZS@lI=N");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex(">N>L:LFyPH1FBxM");
      assertEquals("N411", string0);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.SoundexUtils");
      String string0 = soundex0.soundex("e1wEKT}(");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("Ee.c", string0);
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("tg9leB9`g@x{&V&$ ");
      // Undeclared exception!
      try { 
        soundex0.difference("Parameter supplied to Soundex encode is not of type java.lang.String", "tg9leB9`g@x{&V&$ ");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      String string0 = soundex0.encode("WhDm74*Y");
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.SoundexUtils");
      String string0 = soundex0.encode("[+$*MhH!!NtJ");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("Mce0", string0);
  }
