...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.difference("The character is not mapped: ", "F6aHPMpXPd");
      assertEquals(0, int0);
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("", "<XB<{|ZWv[ZTG?a");
      assertEquals(0, int0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      int int0 = soundex0.difference("\"`.u2%b3s}2XLw{1", "Oo");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("F/Sm", "/uAqy{;CcxKm<[SE6O");
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("c(K*?'N/+TXQ[");
      // Undeclared exception!
      try { 
        soundex0.encode("c(K*?'N/+TXQ[");
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex("$G&*?ke}H'");
      // Undeclared exception!
      try { 
        soundex0.difference(":ze,/\"i>", "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("6");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex(")`gwzRtdJ_WUT;_X");
      assertEquals("G632", string0);
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex("JH}HmSEWf0*rkow{");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "JH}HmSEWf0*rkow{");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("AIyJsF]{wHv");
      assertEquals(4, soundex0.getMaxLength());
