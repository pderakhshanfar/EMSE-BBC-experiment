...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.difference("", "Y|0H|%bU");
      assertEquals(0, int0);
  ...
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex("$Xq=KT#%~??");
      // Undeclared exception!
      try { 
        soundex0.soundex("hEg)osX[=GJ[#F4amD");
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = new Soundex("7C1oQ>;Yh$0s$O*e");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "7C1oQ>;Yh$0s$O*e");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("JHe8xl{>jXPhicVTM<1", "*M~D3t?");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex("7+9m+EX(;H5Q)9");
      String string0 = soundex0.US_ENGLISH.soundex("7+9m+EX(;H5Q)9");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("(6VF>0h9ghij#");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test11()  throws Throwable  {
      ...
      String string0 = soundex0.US_ENGLISH.soundex("tSHf<cOy9p#YBAT");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.US_ENGLISH.encode("q3wwR");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("$6#jD", ".FA;b9t$63[)Wdfi");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("hWkD", "buy>#");
      assertEquals(2, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      Object object0 = soundex0.encode((Object) ")8V+v!V{H;zCq_");
