...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.US_ENGLISH.encode("35c-7Q.Z)sHbR#aQ<");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("C162", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.SoundexUtils");
      int int0 = soundex0.difference("AF:;|4<.=.K", "S!ddhIwW'ptL'9S~)e");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("@FH8");
      // Undeclared exception!
      try { 
        soundex0.soundex("@FH8");
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("2'%@)+");
      // Undeclared exception!
      try { 
        soundex0.difference("euK+],[P6$-^$fe_", "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("r=]k|kQ Ozlc1L");
      assertEquals("R224", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      int int0 = soundex0.difference("AVu2`-(h@W7dITf", "S!ddhIwW'ptL'9S)e");
      assertEquals(1, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("AVu2`-(h@W7dITf");
      assertEquals("A131", string0);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("AFH*F\"");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("DpA!ey1wcacS38Cwz");
      assertEquals("D122", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
