...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = soundex0.US_ENGLISH.encode((Object) "LHq&l-FjDeyg<=1(");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("L241", object0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        soundex0.soundex("^M)CYB*v0oBl 9Qp_uF");
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "LHq&l-FjDeyg<=1(");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("j[CZ");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("S,ia;:WmalF*dx_S");
      assertEquals("S541", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("o*o}YufVhH r/|c");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("[B`wFOMzR+/+");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("EwWgAsm[K(]");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("?gA;IzhDzt}N$:h\"", "/cwhC]c+IL[\"S=l:");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(2, int0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      int int0 = soundex0.difference("org.apache.commons.codec.language.Soundex", "aJ?45Odzej^Vp]Ou*B");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("", "FDBy>_PUvN96^2");
        fail("Expecting exception: IllegalArgumentException");
