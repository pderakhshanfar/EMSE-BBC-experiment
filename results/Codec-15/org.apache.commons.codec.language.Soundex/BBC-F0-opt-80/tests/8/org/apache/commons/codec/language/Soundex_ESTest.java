...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.difference("7<=xPq3^` K{WpX", "BY&.|hr>b(*NT/f");
      assertEquals(0, int0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("org.apache.commons.codec.language.Soundex", "^!dw#:mz, ");
  ...
  public void test04()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode("'k\"(K/)xy=K-#bgO");
      assertEquals("K212", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        soundex0.encode("?umztB@6RFHZfWo'`GK");
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("WtSrgc}zEmG0o`.r");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "WtSrgc}zEmG0o`.r");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("^tv_-h0B`qC");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.US_ENGLISH.difference("01230120022455012623010202", "b$si0h5W:v");
      assertEquals(0, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("7<=xPq3^` K{WpX");
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      int int0 = soundex0.difference("K}ZK3+", "org.apache.commons.codec.language.Soundex");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.US_ENGLISH.difference("GKWhBJh~Z5T]oY", "GKWhBJh~Z5T]oY");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
