...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Soundex soundex0 = new Soundex("Cb/#~{axkaz=4^J}z3R");
      // Undeclared exception!
      try { 
        soundex0.difference("l_A&0-7J[tw,;L-c.s", "{W{tae%pxW2:ZAG");
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("gWm7|");
  ...
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.US_ENGLISH.difference("", "W.ZgY5n5Mw}BKCPb;-");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("org.apache.commons.codec.EncoderException", "H?nd=8&op_(xYW");
      assertEquals(1, int0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("H?nd=8&op_(xYW", "{W{tae%pxW2:ZAG");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("1( |tkWWd|");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex(";^_!UR9");
      String string0 = soundex0.US_ENGLISH.soundex("_|*Z6Wt=pyjcVIEW");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("NHn?qcyQ");
      assertEquals("N220", string0);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("PHwz", "-{~");
      assertEquals(0, int0);
  }
  ...
  public void test22()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode(",}}@i(&^](dl^^");
      assertNotNull(string0);
