...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.US_ENGLISH.difference("", "2G.6EN:mY)HJLNHl?K");
      assertEquals(0, int0);
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("0]%sz&X8}deUD*Hm9", "sqS");
      assertEquals(1, int0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("RS{EN]");
      assertEquals("Roc ", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference((String) null, "\"q<rhE0qy8N'E]T4");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("O w? %WXX3Ke=/eH");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("mOmn}Qh6-wd([dzXZBr");
      assertEquals("M523", string0);
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex("The character is not mapped: ");
      int int0 = soundex0.difference("", ",\"jba]");
      assertEquals(0, int0);
  }
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("S,^vVH>3V.a");
      assertEquals(4, soundex0.getMaxLength());
