...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("NZ[6q7z9(wvbJNS^Ca");
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.encode("NZ[6q7z9(wvbJNS^Ca");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("Nnen", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex("The character is not mapped: ");
      int int0 = soundex0.difference("\"fCNYzf-T!(&9J", "\"fCNYzf-T!(&9J");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("qKp'JB|UzQD^Pg|");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "qKp'JB|UzQD^Pg|");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("`&dt!");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      soundex0.difference((String) null, ":COg84^P)NvB<}]=jL");
      assertEquals(4, soundex0.getMaxLength());
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("IKCP");
      // Undeclared exception!
      try { 
        soundex0.encode("2-Fk!`U&fZ#n");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex("Parameter supplied to Soundex encode is not of type java.lang.String");
      int int0 = soundex0.difference("W>1w![]=N", "P653");
      assertEquals(3, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex("Parameter supplied to Soundex encode is not of type java.lang.String");
      String string0 = soundex0.US_ENGLISH.soundex("kh9w{*$C+fD&");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("K130", string0);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("zfwp\"h{8goTfab~+o", "{MIC4}bW$+6)S[2*w");
      assertEquals(0, int0);
  }
