...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        soundex0.difference("ae|Cc6 L'/k", "ae|Cc6 L'/k");
  ...
  public void test02()  throws Throwable  {
      ...
      int int0 = soundex0.difference("h#d`kq2K}N5A2csl{h", "org.apache.commons.codec.EncoderException");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      String string0 = soundex0.encode("o$heHh@GmHUF5.?");
      assertEquals("O510", string0);
  }
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex("The character is not mapped: ");
      String string0 = soundex0.soundex(" }WI:<z$llb?at~!");
      assertEquals("WehT", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "/d)*w$\"4,%Nt(#~%");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("SlV}Ww`58+?)-G", "SlV}Ww`58+?)-G");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("@Hh>G8~oltT`8 (");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("H430", string0);
      assertNotNull(string0);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex("w&]Z/w>|OoFV@");
      int int0 = soundex0.US_ENGLISH.difference("", "J&fHvnUn]G)aJ5W)F|u");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex("The character is not mapped: ");
      Object object0 = soundex0.encode((Object) "WehT");
      assertEquals("Wcrt", object0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("hs*", "mxw D=MGD|ICS");
      assertEquals(1, int0);
  }
