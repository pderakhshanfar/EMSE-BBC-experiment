...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("#:iKZwT!l");
      assertEquals("I234", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("(<z'wXx-R]>0eY9");
      assertEquals("Z260", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex("The character is not mapped: ");
      String string0 = soundex0.soundex("giDAq4J:`&mx:)");
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex("u,mYB|CN#|/n{Z");
      // Undeclared exception!
      try { 
        soundex0.soundex("xgt<nuR4&x8s)g?mTlD");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex("H6(|6WP`E(N>Ch/ea");
      // Undeclared exception!
      try { 
        soundex0.encode("H6(|6WP`E(N>Ch/ea");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex("K;q&1%PtVKrfs5bt75k");
      // Undeclared exception!
      try { 
        soundex0.difference("", "qy]JuJ1.d%V,");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("&G[c<H1L*kf0el2");
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex("C,$){4_EH5n}y");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "C,$){4_EH5n}y");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode("H6(|6WP`E(N>Ch/ea");
      assertEquals("H520", string0);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("A]nM+HGhq~m1[");
      assertNotNull(string0);
      assertEquals("A525", string0);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.encode("hwW)k(._");
