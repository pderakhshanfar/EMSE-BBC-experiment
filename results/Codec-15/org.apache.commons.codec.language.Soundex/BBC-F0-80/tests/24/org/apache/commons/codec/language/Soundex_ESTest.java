...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        soundex0.soundex("w\"WT$HY{30NCZ~W");
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("hQY=H['m/-<Cs0");
  ...
  public void test03()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.EncoderException");
      int int0 = soundex0.difference("htNs1}HP2v", "Parameter supplied to Soundex encode is not of type java.lang.String");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("v;cn2Hse5I");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "v;cn2Hse5I");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("pT=?Sz");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("KJ@.w_^Jj,# '<");
      // Undeclared exception!
      try { 
        soundex0.difference(",(Z(4}30-SL?GGZ,", "KJ@.w_^Jj,# '<");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("HwzL*Q(D#8E6U-K");
      assertEquals("H423", string0);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("[vCn~h;m");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("%>FWjtn7Xqewc");
      assertNotNull(string0);
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("F235", string0);
  }
  ...
  public void test22()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("[vC~h;m", "/.t]u z#wHRWo");
      assertEquals(2, int0);
  }
