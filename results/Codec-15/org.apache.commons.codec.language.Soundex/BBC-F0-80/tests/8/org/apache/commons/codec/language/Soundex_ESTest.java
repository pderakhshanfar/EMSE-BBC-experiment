...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.encode(".TDW9X$)");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("", "?6]-v2bJ\"!,yp@E@E");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex("=TN9T=nx%Ip7!");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = new Soundex("X?h u!(]9@MQ");
      // Undeclared exception!
      try { 
        soundex0.encode("X?h u!(]9@MQ");
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("jI/)lup|\"[:&Es1");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "GnpQn/5xlM");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("!V3u~Btwk)NQe?<c%", "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("TheXhracter is not mpped: ");
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("JJhQhD8Q~W");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("h~H6,|pV=eE;p%Y8`");
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("6W\u0001wHfekK#X)e_", "W200");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(3, int0);
  }
