...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.US_ENGLISH.soundex(")aL|#X41`>pMUA` j");
      assertEquals("A421", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.EncoderException");
      String string0 = soundex0.encode("GfF4Di'(7DS>");
      assertEquals("Gp.h", string0);
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("\"W]o@&k D*");
      // Undeclared exception!
      try { 
        soundex0.soundex("\"W]o@&k D*");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("2X3? Qu");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "2X3? Qu");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("[BSq");
      // Undeclared exception!
      try { 
        soundex0.difference("", "[BSq");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex("[BSq");
      String string0 = soundex0.US_ENGLISH.soundex("=&VFM6\"gb|)r'");
      assertEquals("V521", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("[BSq");
      int int0 = soundex0.US_ENGLISH.difference("ik/{Eh}p+!vET`[D", (String) null);
      assertEquals(0, int0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      String string0 = soundex0.encode("@E-WwOf$");
      assertNotNull(string0);
      assertEquals("Eah0", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode("z+%Sz6w]p)SP^");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("43h$H[dVm:.Ic%VOuK");
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      Object object0 = soundex0.encode((Object) "g:(0LQ0`yV");
      assertEquals("G421", object0);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("g:(0LQ0`yV", "S0i?_>d?>cqK");
      assertEquals(1, int0);
  }
  ...
  public void test22()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("`}E{wZ:2.15HGTj");
      assertNotNull(string0);
      assertEquals(4, soundex0.getMaxLength());
