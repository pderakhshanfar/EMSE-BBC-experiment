...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.US_ENGLISH.encode("x:wm;");
  ...
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.EncoderException");
      int int0 = soundex0.difference("The character is not mapped: ", "_g(`WTDg>_2");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test03()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      String string0 = soundex0.soundex("iMyv}R^`.44y#M");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("Io.d", string0);
  }
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex(";b^pL<");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("B400", string0);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.US_ENGLISH.soundex("wZ/$Dw9t^RyXeyt");
      assertEquals("W236", string0);
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("+b%3:mjPaf!|3");
      // Undeclared exception!
      try { 
        soundex0.difference("", "(Fo{S!G-");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.encode("1Ae\"hWzk(x");
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("Z|Q\"w{W1r<[!5oLO&");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("O621", "ZoIz)");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(2, int0);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "I{K!a 7pE>~");
        fail("Expecting exception: IllegalArgumentException");
