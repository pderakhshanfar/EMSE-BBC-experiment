...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("org.apache.commons.codec.EncoderException", "qkU{m/xhn-]ryTH'p");
      assertEquals(1, int0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      int int0 = soundex0.difference("JA[T}^KuVZkfSka$", "Osao");
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("x|VLFlW]Ne^BXA5k");
      // Undeclared exception!
      try { 
        soundex0.soundex("x|VLFlW]Ne^BXA5k");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex("5 {qZRbrM+jCp");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "T000");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("xSnED~$%");
      assertEquals("X530", string0);
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("IZWHJwx]Mb)BX(.}N");
      assertEquals("I251", string0);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      String string0 = soundex0.US_ENGLISH.encode(">P;AQ*%kDt^ ?w#*8s");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      soundex0.difference("/[h|hIB\"00fq-", (String) null);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("<,NAW(BTb~Q\"$UzoM]", "v[<`\"E<_");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
}
