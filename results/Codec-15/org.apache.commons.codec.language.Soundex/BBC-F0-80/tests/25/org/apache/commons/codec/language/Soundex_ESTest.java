...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.US_ENGLISH.difference("t2W{j`yN{", "t2W{j`yN{");
      assertEquals(4, int0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = soundex0.encode((Object) "JtYwkga/CZ7t]\"");
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = new Soundex(">FR4Ly!&a^");
      // Undeclared exception!
      try { 
        soundex0.soundex(")u*MSpTAgQ(l\"EuH");
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("|fB4Ry6XyuOq?ru3");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "|fB4Ry6XyuOq?ru3");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex("|fB4Ry6XyuOq?ru3");
      String string0 = soundex0.US_ENGLISH.soundex("|fB4Ry6XyuOq?ru3");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("F622", string0);
  }
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("e(78/0&YmLw;wk");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("CMHhQ5),A5Z@~R");
      assertEquals("C526", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("!zCDOfhBd{`Fl*@");
      assertEquals("Z313", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("", "nGH@D2ETaHpy#?-_}Y");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex("E540");
      // Undeclared exception!
      try { 
        soundex0.difference("]<c%G|z(iQ6)Z!I", "2yMCJzX_(OgaW=:");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      ...
      Soundex soundex0 = new Soundex(charArray0);
      soundex0.US_ENGLISH.difference("01230120022455012623010202", "2}Vx]WR:Ep1a^#6L3n");
      assertEquals(4, soundex0.getMaxLength());
  }
}
