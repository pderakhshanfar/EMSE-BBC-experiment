...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.encode("AW=2;\"buozdGMwe{>^ ");
  ...
  public void test04()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.encode("oSWZhNS~)HE},py-");
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("=IXl(!", "=IXl(!");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("$5{+yocO}");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "$5{+yocO}");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("Parameter supplied to Soundex encode is not of type java.lang.String", "5");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("{GgS[;w@");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("oSWZhNS~)HE},py-");
      assertEquals("O252", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex("Parameter supplied to Soundex encode is not of type java.lang.String");
      int int0 = soundex0.difference("}U,w/WX/%b", "The character is not mapped: ");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      soundex0.difference("9CIw5D ,u)K1x", (String) null);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      soundex0.difference("JHw[PUk;1>'6:bNr", "");
      assertEquals(4, soundex0.getMaxLength());
  }
