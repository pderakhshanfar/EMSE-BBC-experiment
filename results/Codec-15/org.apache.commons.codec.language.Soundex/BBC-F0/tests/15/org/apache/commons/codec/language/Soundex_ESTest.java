...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.difference("RT6^Xhf{1", "C000");
      assertEquals(0, int0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("s`lF1QWz-");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        soundex0.soundex("ArBK7F?v:4@hD2>n2");
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex(">AL}?*");
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("C100");
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode(";CHBY");
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("$.ZhwGi71LK.c='tzw");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("", ";CHK]BY");
      assertEquals(0, int0);
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference(":q+wvOE]eP@?", ":q+wvOE]eP@?");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("w5}_hRvBa=]zz[", ";CHBY");
      assertEquals(2, int0);
  }
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex("R_s_$>j8(S");
      // Undeclared exception!
      try { 
        soundex0.difference("KkF{.Aq,", "R_s_$>j8(S");
        fail("Expecting exception: IllegalArgumentException");
