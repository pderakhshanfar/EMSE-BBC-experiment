...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.difference("org.apache.commons.codec.language.SoundexUtils", "b`dwm?F@IbECQ");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("Parameter supplied to Soundex encode is not of type java.lang.String", "nMJ~A5");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("--LX7pwiev*");
      // Undeclared exception!
      try { 
        soundex0.soundex("--LX7pwiev*");
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex(">Y&1_UA<#2w");
      // Undeclared exception!
      try { 
        soundex0.encode(">Y&1_UA<#2w");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("{.O\"ZZw<:BkL<4W\"p_$");
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex("zWx_m7");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "Z500");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("JM'B ,PWQ4");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.US_ENGLISH.soundex("H;HRyH8");
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("ao2wWwb/z!%$lGkZ <?", "T@D?5hDi<l:]px");
      assertEquals(1, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
