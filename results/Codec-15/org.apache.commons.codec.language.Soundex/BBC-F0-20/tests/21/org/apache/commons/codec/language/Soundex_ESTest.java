...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.US_ENGLISH.encode("\u0002(:YW6)p'VA[k");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("", "5OesGRhT");
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("$d+'", "$d+'");
      assertEquals(4, int0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        soundex0.soundex("<xNy[G5!taMsHCR");
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("kaK{#MQ;e]");
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("pY|7H*lu{pv#n@\"u*", "pY|7H*lu{pv#n@\"u*");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("PWX9AV7(/B8d{rXVZ");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("O>dHT@]q");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex("NCicNx0cU=?NY");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "NCicNx0cU=?NY");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      int int0 = soundex0.difference("p;xjmB@?9Mj$", "hw2J3");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      String string0 = soundex0.soundex(";b&;,w1%:F)l`j|p");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("Bepc", string0);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("", "&fx/Wh,S88p");
      assertEquals(0, int0);
  }
