...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.encode("K{\"0Ywj");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("KK~uLD)?Hp5E", "KK~uLD)?Hp5E");
      assertEquals(4, int0);
  }
  ...
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("oAkRh>N#NJJ(3C7");
  ...
  public void test03()  throws Throwable  {
      ...
      int int0 = soundex0.difference("ij^ODkM1e", "");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("b6KdsE G8jO0YK1vUa");
      // Undeclared exception!
      try { 
        soundex0.soundex("b6KdsE G8jO0YK1vUa");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("}%7K']KREe}42", "V450");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("xh(7|wLGqR=B*k");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("X261", string0);
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("]##f#C/bK9pZ%i>Us3h");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "G!u$U9$FOV-SgY%p");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("3l`uB,(p[ef$SR`=p", "H'xV%=wQ`E)m(*U");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(2, int0);
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("G%$$%BW0F!:\"%Vz");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("E}W}H:dj5@^", "6v,4Ll&ezVa}Y");
      assertEquals(0, int0);
  }
