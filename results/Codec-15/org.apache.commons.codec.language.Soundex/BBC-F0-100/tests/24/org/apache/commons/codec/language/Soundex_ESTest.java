...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("h1W@hBa\\csA");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("h1W@hBa\\csA");
      assertEquals("H200", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("=@#1dHwD~");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("The character is not mapped: ", "sWS9C\"?*h6?");
      assertEquals(1, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("#]pS`<()u%8$!D-l?", ":GzKw,dTqhnG");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.encode((Object) "S4HfE]&h#_m>cY|xq");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("S152", object0);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex("hwqYK");
      // Undeclared exception!
      try { 
        soundex0.difference((String) null, "F345");
        fail("Expecting exception: IllegalArgumentException");
