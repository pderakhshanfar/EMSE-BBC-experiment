...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        soundex0.difference((String) null, "!cgaENW");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("", "N<j.z wpV");
      assertEquals(0, int0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("kJ!'q>DPds@p");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("Kc s", string0);
  }
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("E0K!'#8R+Wh+T[", "E0K!'#8R+Wh+T[");
      assertEquals(4, int0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("Z0)PW,E");
      // Undeclared exception!
      try { 
        soundex0.soundex("Z0)PW,E");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex(").UF]vCWhW!b");
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("Eboghv&uH}");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.US_ENGLISH.difference("The character is not mapped: ", "01230120022455012623010202");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex("|no~Kr$");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "|no~Kr$");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode(").UF]vCWhW!b");
      assertEquals("U120", string0);
  }
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("FHVv@@HszS;%^B1a", "%yZQvad");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
