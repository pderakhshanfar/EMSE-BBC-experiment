...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Soundex soundex0 = new Soundex("d>w");
      // Undeclared exception!
      try { 
        soundex0.difference("d>w", "d>w");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.US_ENGLISH.difference("$8M;G*,UD*`", "^8)(K,m@yD{HK");
      assertEquals(1, int0);
  ...
  public void test04()  throws Throwable  {
      ...
      String string0 = soundex0.encode("l0FH<iwD");
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = new Soundex("RoZ;4dcDO5*");
      // Undeclared exception!
      try { 
        soundex0.soundex(";y");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("nMBV9;YkUsd,6w{,");
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("s=:hLi", "");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("8b+ uIWHrt");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference((String) null, "TUby<$1zq,WcKIW#IE6");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("MHw!Cv]");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.encode((Object) "WlRIYh={t3}-!p\"W67");
      assertEquals(4, soundex0.getMaxLength());
      assertNotNull(object0);
      assertEquals("W463", object0);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex("dDD.<uH");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "dDD.<uH");
        fail("Expecting exception: IllegalArgumentException");
