...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Soundex soundex0 = new Soundex("ucEt6H?RYn?P;'uX");
      // Undeclared exception!
      try { 
        soundex0.encode("qi1z9+>n(sl");
  ...
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex("The chracter is not mapped: ");
      String string0 = soundex0.encode("Z ${(wS^TL");
      assertEquals("Zpt ", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex("01230120022455012623010202");
      String string0 = soundex0.soundex("The chracter is not mapped: ");
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("The chracter is not mapped: ");
      int int0 = soundex0.difference("The chracter is not mapped: ", "The chracter is not mapped: ");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("\"(A42cTalQ@");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "\"(A42cTalQ@");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex("");
      String string0 = soundex0.US_ENGLISH.soundex("=vDn0 <mG0)-k<zl7");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("V352", string0);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("(J1h >'=$ccl ^I%a");
      assertEquals("J240", string0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("-Dw*5.d!\",F[?FA4bO!", "01230120022455012623010202");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("K.<CX hHs'");
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex("The chracter is not mapped: ");
      String string0 = soundex0.encode("WW5TAYpG{");
      assertEquals("WTe ", string0);
      assertEquals(4, soundex0.getMaxLength());
