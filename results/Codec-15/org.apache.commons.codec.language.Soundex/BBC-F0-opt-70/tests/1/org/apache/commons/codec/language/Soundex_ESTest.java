...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = soundex0.encode((Object) ">U8ScJWIfyhs\"A");
  ...
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.encode("/M4Ymvq");
      assertEquals("M512", string0);
      assertEquals(4, soundex0.getMaxLength());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Soundex soundex0 = new Soundex("i%P,ioSd+e_NLe]96j");
      soundex0.difference("i%P,ioSd+e_NLe]96j", "i%P,ioSd+e_NLe]96j");
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("3q%[H2\"TL b/");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "3q%[H2\"TL b/");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("01230120022455012623010202", ":/6Aajvnq8fynQK");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("iIQFX");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("zfwf,t8(H;52Qsu@");
      assertEquals("Z132", string0);
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.encode("^wWc|pEJcR*A");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("0r/=UO=/hwMf", "x/[E");
      assertEquals(2, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.encode("L(b]3T+1+KqaF7w");
        fail("Expecting exception: IllegalArgumentException");
