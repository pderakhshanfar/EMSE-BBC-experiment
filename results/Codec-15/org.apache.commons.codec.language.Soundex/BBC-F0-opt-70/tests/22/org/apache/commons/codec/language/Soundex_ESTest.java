...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = soundex0.encode((Object) "Cosa");
      assertEquals("Cl P", object0);
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.US_ENGLISH.difference("Xfvs]N;~1Q<T", ";SftzHU");
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("WH*@\u0000LNti~\\Q-");
      // Undeclared exception!
      try { 
        soundex0.soundex("WH*@\u0000LNti~\\Q-");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "WH*@\u0000LNti~\\Q-");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.US_ENGLISH.soundex("~Oyff*\"w-xt8ov,%'X");
      assertEquals("O123", string0);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("WH*@\u0000LNti~\\Q-");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.encode("WH*@\u0000LNti~\\Q-");
      assertEquals("W532", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference((String) null, "5=D{zujG&{hZW*v");
      assertEquals(0, int0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("", "A:Ld~Q8=l#b0FI");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("^", "G&Wp3hw\"nC*#6j");
      assertEquals(0, int0);
  }
