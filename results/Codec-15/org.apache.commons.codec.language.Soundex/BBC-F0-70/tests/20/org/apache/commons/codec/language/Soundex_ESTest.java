...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.difference(";b~l/!}&V8R-%%", ":;y)y4&Wq^g5{");
      assertEquals(0, int0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.US_ENGLISH.difference("F\"Gb+W+D@x6iY1{_{", ">l_$27$");
      assertEquals(0, int0);
  ...
  public void test02()  throws Throwable  {
      ...
      int int0 = soundex0.difference("l(;Dd)YMRt;_Z8 '3M", "org.apache.commons.codec.EncoderException");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex(";+fvBD0oq^:bBW>W#m");
      // Undeclared exception!
      try { 
        soundex0.soundex(";+fvBD0oq^:bBW>W#m");
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("+{~]a[&?DO`koE");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "+{~]a[&?DO`koE");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex("VW`RX(");
      // Undeclared exception!
      try { 
        soundex0.difference("Parameter supplied to Soundex encode is not of type java.lang.String", "VW`RX(");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex("?kR`%");
      // Undeclared exception!
      try { 
        soundex0.encode("?kR`%");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("01230120022455012623010202");
      String string0 = soundex0.soundex("@w[O:s~8Hq`8MNJ:");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("|5h+#WB>", "");
      assertEquals(0, int0);
  }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex("01230120022455012623010202");
      Object object0 = soundex0.encode((Object) "iIw.hPULzz-");
      assertEquals("I420", object0);
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex("01230120022455012623010202");
      int int0 = soundex0.difference("iIw.hPULzz-", "iIw.hPULzz-");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
