...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("zHH-U#WY1W vx,6357|");
  ...
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("`tDH7jHH_w");
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference((String) null, "S642");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex("7[9");
      // Undeclared exception!
      try { 
        soundex0.difference("6#)cdMTF4/w*pHCR", "7[9");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("A@}l5xpUV<^N?mbw", ")h#HC?tq/76XEO");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(1, int0);
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("@t%~J8Q;w+/%Qe!_@");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test19()  throws Throwable  {
      ...
      String string0 = soundex0.encode("zcn4y;|O");
      assertEquals("Z pi", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.US_ENGLISH.difference("s~R^_5iwLS(vmR", ":W9HT3!}`");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
