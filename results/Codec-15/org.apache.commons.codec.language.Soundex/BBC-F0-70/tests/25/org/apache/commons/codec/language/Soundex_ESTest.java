...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Soundex soundex0 = new Soundex("X\"H,8S");
      // Undeclared exception!
      try { 
        soundex0.soundex("X\"H,8S");
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = new Soundex("p*OH&_] /_E");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "p*OH&_] /_E");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("+y v$f#&(-l-y2QM");
  ...
  public void test08()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("f&T>Etf$*Ulgp@3uF");
      assertEquals("F331", string0);
  }
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("W8%h R1}>3IF+sd+");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("W123", string0);
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("K$q<Hi{Z=@.x:fWt_2I", "ap~hwdl'j");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.SoundexUtils");
      int int0 = soundex0.difference("[Dt3", "ChC[sXtVS3 E");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(1, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode(" =w/4/tAKXwFHtw<?");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.encode((Object) "B");
      assertNotNull(object0);
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("B000", object0);
  }
