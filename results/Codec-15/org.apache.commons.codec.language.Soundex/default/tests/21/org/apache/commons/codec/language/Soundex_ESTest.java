...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        soundex0.difference("b~$aFAjTy4.LzTp(F ", "b~$aFAjTy4.LzTp(F ");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("", "nIQ,^tDWG8f9wM.w&");
  ...
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("P653");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test04()  throws Throwable  {
      Soundex soundex0 = new Soundex(";{{jhj0S");
      // Undeclared exception!
      try { 
        soundex0.soundex(";{{jhj0S");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = new Soundex("x|'VKkL:<46}NRTuPj");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "x|'VKkL:<46}NRTuPj");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("Qqc?,{hK");
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex("No3NMthqw");
      // Undeclared exception!
      try { 
        soundex0.encode("{{jh9jTS");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("_o$BCXg%*k'W,WW5mx$", "{{jh9jTS");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(1, int0);
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("u\"hw`;QA`u");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.US_ENGLISH.difference("Parameter supplied to Soundex encode is not of type java.lang.String", "!y*]w}q9gZOkk");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
