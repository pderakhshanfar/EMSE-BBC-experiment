...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Soundex soundex0 = new Soundex("HFK+NJ3");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "HFK+NJ3");
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.encode("t[EPwO&t'HV");
      assertEquals("T131", string0);
  ...
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("=JH4&zx");
  ...
  public void test03()  throws Throwable  {
      ...
      int int0 = soundex0.difference("org.apache.commons.codec.EncoderException", "}.JqF!d");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("_W;", "2;,z");
      assertEquals(3, int0);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("X{<;Xe[j;R=[s");
      // Undeclared exception!
      try { 
        soundex0.soundex("X{<;Xe[j;R=[s");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex("QZ:7#{8");
      // Undeclared exception!
      try { 
        soundex0.difference("QZ:7#{8", "QZ:7#{8");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("WgL&lpx&-'|._TX");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("{])]_?GHlWhB H`HI#");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("G400", string0);
      assertNotNull(string0);
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex(")JBh;w2*6<bkJ");
      assertNotNull(string0);
  ...
  public void test22()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      soundex0.difference("01230120022455012623010202", "*Y~wQ+hLX!\"xQ-");
      assertEquals(4, soundex0.getMaxLength());
  }
