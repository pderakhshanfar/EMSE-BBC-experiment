...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Soundex soundex0 = new Soundex("Do}");
      // Undeclared exception!
      try { 
        soundex0.difference("Do}", "cA6;A0");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.US_ENGLISH.difference("(` u($xh&{P?] ?(s{", "org.apache.commons.codec.EncoderException");
      assertEquals(0, int0);
  ...
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      int int0 = soundex0.difference("org.apache.commons.codec.language.SoundexUtils", "4!IJy");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      int int0 = soundex0.difference("D>}/Kp", "O200");
      assertEquals(2, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("U1PG+\b^=>7");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "U1PG+\b^=>7");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      String string0 = soundex0.soundex("mAlC[H&(bwLnQDEXbg");
      assertEquals("Mcgc", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      int int0 = soundex0.US_ENGLISH.difference("mAlC[H&(bwLnQDEXbg", "");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("ui8&kh>2)HBPO'\\");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("org.apache.commons.codec.language.SoundexUtils", "2~3%Lw\"hTx-LCG;:RA");
      assertEquals(0, int0);
  }
  ...
  public void test22()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      soundex0.difference("1S:z}g8Jwj'u}~<D", "01230120022455012623010202");
      assertEquals(4, soundex0.getMaxLength());
  }
