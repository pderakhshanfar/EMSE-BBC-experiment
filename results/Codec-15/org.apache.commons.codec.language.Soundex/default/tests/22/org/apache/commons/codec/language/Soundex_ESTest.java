...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.difference("'V(`K=y.'2wg\"w%$N", "");
      assertEquals(0, int0);
  }
  ...
  public void test04()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("bsuhz*\"=[;(~dG", "org.apache.commons.codec.language.Soundex");
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Soundex soundex0 = new Soundex("a&!Ut%5t4ZpE[1b");
      // Undeclared exception!
      try { 
        soundex0.soundex("a&!Ut%5t4ZpE[1b");
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("{:is&[EUH59#/~q'.c`");
      // Undeclared exception!
      try { 
        soundex0.encode("{:is&[EUH59#/~q'.c`");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("2CK?w");
      // Undeclared exception!
      try { 
        soundex0.difference("2CK?w", "2CK?w");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode("QQ(@a#rQS:vM[%y/.");
      assertEquals("Q621", string0);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("#VH\"#WP`H7%H");
  ...
  public void test15()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("jH?0QUoz\"2CE");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "5e!`[9H6<R^p(O2Q");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex("Parameter supplied to Soundex encode is not of type java.lang.String");
      int int0 = soundex0.difference("Parameter supplied to Soundex encode is not of type java.lang.String", "c6QWw#2V@kAk2");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.encode((Object) "5e!`[9H6<R^p(O2Q");
      assertEquals("E612", object0);
      assertEquals(4, soundex0.getMaxLength());
  }
