...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = soundex0.encode((Object) "=EF0Ym`A'");
      assertEquals("Ep.o", object0);
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("JNfPXidQ'|");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "JNfPXidQ'|");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("$7GBV'>MH;Vm");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("w^W(!'[VT ");
      assertNotNull(string0);
      assertEquals("W300", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      int int0 = soundex0.difference(":^yhHB7=O{.A\"W+N2\"", ":^yhHB7=O{.A\"W+N2\"");
      assertEquals(4, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("0M W5-vs<w75j", "E150");
      assertEquals(1, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("zN&{9'K{QV{v!jB", ")c!.oBfVYhv8p<djNv");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("ov6|wQy");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference((String) null, "9[#sbiM,dv6M");
        fail("Expecting exception: IllegalArgumentException");
