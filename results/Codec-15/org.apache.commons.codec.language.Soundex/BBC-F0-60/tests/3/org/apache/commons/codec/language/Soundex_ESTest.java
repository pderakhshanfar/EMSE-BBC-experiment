...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("S*\u0001TXw~'R^L");
      assertEquals("S326", string0);
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("iag>", "iag>");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.soundex("?pSt6 t`Be`QMU");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.encode("^/J3#w.{y^\"ygtKTD");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      soundex0.difference("M ECOT*", (String) null);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("t8Ea+o| $W)H%GA5p", "01230120022455012623010202");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("FF2q4w$Z.DQbpT,9UC");
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex("The character is not mapped: ");
      String string0 = soundex0.soundex("AW{0NN?%N");
      assertEquals(4, soundex0.getMaxLength());
      assertNotNull(string0);
      assertEquals("Aa 0", string0);
  }
