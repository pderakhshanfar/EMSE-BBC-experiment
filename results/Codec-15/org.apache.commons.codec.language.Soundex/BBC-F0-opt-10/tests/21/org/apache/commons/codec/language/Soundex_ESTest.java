...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.US_ENGLISH.difference("", "CwbNw*\"Osw.BUA");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex("=B}d^J]~d+k9Ok");
      String string0 = soundex0.soundex("=B}d^J]~d+k9Ok");
      assertEquals("Bd+k", string0);
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("p?aH8mjTL_Fv{y0|");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("jssh8aPy+,");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("|-?u84~E?h0hb^1;Lo@", "=]45p#/iu*IE5p@bu4");
      assertEquals(2, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex("");
      String string0 = soundex0.US_ENGLISH.soundex("d[Z/k&cipH8Bq-d%o4l");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("W{wMRc|27wnA");
      assertEquals(4, soundex0.getMaxLength());
      assertNotNull(string0);
      assertEquals("W625", string0);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex(",!A OzHDTbdR");
