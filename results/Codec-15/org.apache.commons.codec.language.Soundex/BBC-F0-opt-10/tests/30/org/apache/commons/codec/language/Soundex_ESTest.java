...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.encode("'Z[hpE+L6\"d/oMubrp");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("Z143", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("k^n@&%i43Fh t%nC<", "");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex("DN4El'1yMTo\"i4!R");
      String string0 = soundex0.soundex("DN4El'1yMTo\"i4!R");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("D4l\"", string0);
  }
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("`+y", "`+y");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(4, int0);
  }
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("}1Gz?^&(^Sf`401x5");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("WWct*m5bl7+p<");
      assertEquals("W351", string0);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.US_ENGLISH.encode("GMCHHgoy]u5a_");
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("?7,_nh(XWqF|0+Kx)s=");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("", "d_J\"jWs%OHG~ky/C");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.encode((Object) "N212");
