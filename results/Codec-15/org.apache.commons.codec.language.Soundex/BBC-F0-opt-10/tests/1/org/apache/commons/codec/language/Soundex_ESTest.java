...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.difference("o*#K^H\"Z#Jh*G'&=", "K622");
      assertEquals(1, int0);
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = soundex0.encode((Object) "xa0k1piR;!iqjC.");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("Xo.o", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      soundex0.US_ENGLISH.difference("01230120022455012623010202", "01230120022455012623010202");
      soundex0.getMaxLength();
      soundex0.US_ENGLISH.encode("z567@fiDWQz_");
      soundex0.soundex("");
      soundex0.difference("", "");
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = new Soundex("/ghfS{r;Mm6");
      // Undeclared exception!
      try { 
        soundex0.soundex("/ghfS{r;Mm6");
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("UbeXe,2@])Z07vo'");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "UbeXe,2@])Z07vo'");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("XQ.a%usMJ36^");
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex("tqLCgc3>i4*KqqKw)$H");
      // Undeclared exception!
      try { 
        soundex0.difference("01230120022455012623010202", "tqLCgc3>i4*KqqKw)$H");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("WHrL{qrva{ZmD[l%|");
      assertEquals("W426", string0);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("", "@W_nRuH>$wq*TY'z|QZ");
      assertEquals(0, int0);
  }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.US_ENGLISH.encode((Object) "F?Z\"wQ&1XHdR'WIX");
      assertEquals("F223", object0);
      assertEquals(4, soundex0.getMaxLength());
  }
}
