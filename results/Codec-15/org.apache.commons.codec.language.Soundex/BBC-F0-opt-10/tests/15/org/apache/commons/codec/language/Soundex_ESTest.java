...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.US_ENGLISH.encode("%$;u}&y(/h(sX");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("B-Wd>P8cu%", "VH&W0^Tm");
  ...
  public void test02()  throws Throwable  {
      ...
      int int0 = soundex0.difference("1Jl>Qi:u'M8Rg5w,Mb", "Trce");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("3M.TKNzWK\"", "3M.TKNzWK\"");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("f-eq3/J{o43P1xr");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "f-eq3/J{o43P1xr");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("Bv20dJp^BHX\"-");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex(",c@ek;H");
      // Undeclared exception!
      try { 
        soundex0.difference("", "a=aE{3H>e5s\"h");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("Mwh#s7[wBwb:ZplQ");
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("VH&W0^Tm");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.soundex("XMI>?[C__*is`LFTS[");
        fail("Expecting exception: IllegalArgumentException");
