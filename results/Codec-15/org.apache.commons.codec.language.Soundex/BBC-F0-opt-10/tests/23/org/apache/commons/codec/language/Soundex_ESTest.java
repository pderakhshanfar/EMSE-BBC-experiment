...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("YW(+}7 ]9sPt-&XV");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("Y213", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.EncoderException");
      int int0 = soundex0.difference("Z;i;d=OKn", "org.apache.commons.codec.language.SoundexUtils");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode("bYE+dw]FM{_G");
      assertEquals("B315", string0);
  }
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("/C&:V`]&L]8tzbTD_");
      // Undeclared exception!
      try { 
        soundex0.encode("Q>3$qm%BX':DW");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("#3KXf");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex("p|");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "|pvKTJ1~SDBb=v+");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("whZUF-u6", "]k1'5k3fOT#y{K");
      assertEquals(1, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      soundex0.difference("", "om ]hW<pi4|:{IO");
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("qWqJTS\"C`l\"OdQ:$");
