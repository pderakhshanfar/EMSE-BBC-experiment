...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        soundex0.soundex("A/jp8shkw2=#WKm");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("", "-fQa!X w;,M)");
      assertEquals(0, int0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("HT)yG");
      assertEquals("H.a0", string0);
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.soundex("gF4>6<(@m6k}Zju");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("Ph");
      // Undeclared exception!
      try { 
        soundex0.encode("Ph");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("fkUP,sew 8TPW");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "fkUP,sew 8TPW");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("o9Zx!+W5XWxs 0&K]N");
      assertEquals("O225", string0);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex("]e~,hO(^{Ma1s_U");
      String string0 = soundex0.soundex("]e~,hO(^{Ma1s_U");
      assertEquals("E^Us", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode("cQ$");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("[h\u0006h&rKE");
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("#v(WwC)VylXl7IS,NH", "#v(WwC)VylXl7IS,NH");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(4, int0);
  }
