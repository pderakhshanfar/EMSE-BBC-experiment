...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Soundex soundex0 = new Soundex("&9 <*,[]");
      // Undeclared exception!
      try { 
        soundex0.soundex("Gi3x");
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("4~M|{jY wc#Q'");
  ...
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("$C74>sT *WQ*GOg5F:");
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("P[8Ys~9A?%#Qq");
      // Undeclared exception!
      try { 
        soundex0.encode("P[8Ys~9A?%#Qq");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("*'u)Tv6>N-*#T3s");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "*'u)Tv6>N-*#T3s");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("v$53&F{&[+*WWG");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.US_ENGLISH.difference("01230120022455012623010202", "z!");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      soundex0.difference("fzVoCq$h0ROM", (String) null);
      assertEquals(4, soundex0.getMaxLength());
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("y<KELVl&&");
      // Undeclared exception!
      try { 
        soundex0.difference("H-hch(o/", "y<KELVl&&");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.US_ENGLISH.difference("N=0zc.", "cHxa()]fi=Ot;");
      assertEquals(1, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("eY-b@aHR9\nm:gW$&XC");
      assertNotNull(string0);
      assertEquals("E165", string0);
  }
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.US_ENGLISH.encode((Object) "z!");
