...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      soundex0.difference("", "o @\"Ywq&8Ib<[n}<[");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("U;. `}Z;J9n2", "Parameter supplied to Soundex encode is not of type java.lang.String");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("h'oI[bW");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "h'oI[bW");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("w3}&XYh", "w3}&XYh");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("GQPmH/P@O(hnM8");
      assertEquals("G151", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("GW#?pO3)C9:P4");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("j]bGhz)'F3'VKZ49J)w");
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode("T/.LLV8HRm~$EE^02F");
      assertNotNull(string0);
      assertEquals("T416", string0);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("org.apache.commons.codec.EncoderException", "qh[-WdG8");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      Object object0 = soundex0.encode((Object) "T416");
  ...
  public void test22()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.US_ENGLISH.encode("[C9A-WHV#{wu");
      assertNotNull(string0);
