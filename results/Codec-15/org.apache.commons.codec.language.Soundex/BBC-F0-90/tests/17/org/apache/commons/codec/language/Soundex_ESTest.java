...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.difference(")i!4yw~~&m;5.-uG", "");
      assertEquals(0, int0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = soundex0.encode((Object) "v@Lh+!_K:X9\"!1OG");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("V422", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex("Parameter supplied to Soundex encode is not of type java.lang.String");
      String string0 = soundex0.soundex("%e?-'$6KLJ{hZ");
      assertEquals("Esu ", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = new Soundex("7u&|Faq1r~zh:/E:w(%");
      // Undeclared exception!
      try { 
        soundex0.soundex("7u&|Faq1r~zh:/E:w(%");
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("N$icwk<W;-=");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("y|=Z_^qy[gKfiqD");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("^/c#+'3L'%dW,LOD", "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex("i,");
      String string0 = soundex0.US_ENGLISH.encode("!1f|wZ'}k@BS#\u0006op2");
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("p^>'vQuW|}w%nw*", "Parameter supplied to Soundex encode is not of type java.lang.String");
      assertEquals(1, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.US_ENGLISH.difference("rY'P2BltsL", "pUX)k6WHHP/\u0005._)");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "2~g;*7~3Ww{Qb+");
        fail("Expecting exception: IllegalArgumentException");
