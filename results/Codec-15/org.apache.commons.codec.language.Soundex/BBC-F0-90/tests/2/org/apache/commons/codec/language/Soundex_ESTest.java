...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.difference("/(ChRUo*|>vP", "/(ChRUo*|>vP");
      assertEquals(4, int0);
  ...
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("EQhF ");
  ...
  public void test02()  throws Throwable  {
      ...
      int int0 = soundex0.difference("Y*ts:", "Parameter supplied to Soundex encode is not of type java.lang.String");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.US_ENGLISH.difference("7-jB2(. !9;Vl.!e@", "cxUN)y3Q_cH|{G.!^");
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex("'u/'/%9(maJ a");
      // Undeclared exception!
      try { 
        soundex0.soundex("'u/'/%9(maJ a");
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex("HHfn)&JUwF MK");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "?t\"Av)_$ODP,y{Pqw");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex("\"'z+d");
      // Undeclared exception!
      try { 
        soundex0.difference("\"'z+d", "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("lL\">8+bydT");
      // Undeclared exception!
      try { 
        soundex0.encode("k3t");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("WH\"!qG.^rJm!");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.encode("/$hw%9M");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex("lL\">8+bydT");
      String string0 = soundex0.US_ENGLISH.soundex("$VF1A^6Y-W[J{/<L");
      assertEquals("V240", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
