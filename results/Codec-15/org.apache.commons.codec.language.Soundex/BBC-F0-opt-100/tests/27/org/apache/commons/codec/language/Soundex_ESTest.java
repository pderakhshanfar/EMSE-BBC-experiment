...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Soundex soundex0 = new Soundex("kQz4a)U>?g,6<YQd");
      // Undeclared exception!
      try { 
        soundex0.difference("qC-xY}P%g-", "");
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = soundex0.difference("m%cxWDUa\"", "");
      assertEquals(0, int0);
  }
  ...
  public void test02()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("M@rD&{6ewTfo&");
      assertEquals("M633", string0);
  }
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("jXl8_\b");
  ...
  public void test14()  throws Throwable  {
      ...
      int int0 = soundex0.difference("A4p?qg'%:y%O^Apg", "(x8A");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.EncoderException");
      String string0 = soundex0.US_ENGLISH.soundex("{Y4:?0A*^w<WrbkrL{O");
      assertEquals("Y126", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("Fn!wMJ=e|b{=9");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("org.apache.commons.codec.language.Soundex", "hwcC[#=!:d<");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
