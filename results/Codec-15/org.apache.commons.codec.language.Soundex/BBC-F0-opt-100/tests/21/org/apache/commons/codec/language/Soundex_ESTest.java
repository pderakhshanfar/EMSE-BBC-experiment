...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = soundex0.US_ENGLISH.difference("xHma}z#Rr{L{4", "org.apache.commons.codec.language.SoundexUtils");
      assertEquals(1, int0);
  ...
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("", "+\"K7A-|5Wb");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("7)lwYL_*&@l");
      // Undeclared exception!
      try { 
        soundex0.difference("", "$mLkQ*. Crh*cF>");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("{uus|gk");
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.EncoderException");
      String string0 = soundex0.US_ENGLISH.soundex("7:");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("", string0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "X3m 63*l\"A19:");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.EncoderException");
      int int0 = soundex0.difference("V^i4hHv|s5tjPnp ", "");
      assertEquals(0, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex(";v;[*dc|hC)F}_lI(<");
      assertNotNull(string0);
      assertEquals("V321", string0);
  }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      Object object0 = soundex0.encode((Object) "V^i4hHv|s5tjPnp ");
      assertNotNull(object0);
      assertEquals("V232", object0);
  }
  ...
  public void test19()  throws Throwable  {
      char[] charArray0 = new char[0];
      Soundex soundex0 = new Soundex(charArray0);
      String string0 = soundex0.US_ENGLISH.encode("QWh:3x2f=lOzj");
      assertEquals(4, soundex0.getMaxLength());
      assertNotNull(string0);
      assertEquals("Q142", string0);
  }
