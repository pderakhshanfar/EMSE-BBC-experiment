...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("~DC@xWN%[l~yE.pTq8 ");
      assertEquals("D254", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        soundex0.soundex("P:k5\"zd>8TbyPTZ");
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("0zHQ1p>6cr0?^\"z");
      assertEquals("Z126", string0);
  }
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex("+>e^L^fz;6}");
      // Undeclared exception!
      try { 
        soundex0.encode((Object) "+>e^L^fz;6}");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("#hHL+#I;#lIjY(", "#hHL+#I;#lIjY(");
      assertEquals(4, int0);
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference((String) null, "0zHQ1p>6cr0?^\"z");
      assertEquals(0, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.US_ENGLISH.encode("j+v^|c3WRCY,G)a");
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.SoundexUtils");
      String string0 = soundex0.soundex("5|-'>O<YkH@");
      assertEquals(4, soundex0.getMaxLength());
      assertNotNull(string0);
      assertEquals("O.c0", string0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        soundex0.difference("skYIg;aQ?rR8M", "01230120022455012623010202");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.encode("wH<_d].H*");
