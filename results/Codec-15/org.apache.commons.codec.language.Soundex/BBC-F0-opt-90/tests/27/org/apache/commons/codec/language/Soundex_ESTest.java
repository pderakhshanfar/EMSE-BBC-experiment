...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      soundex0.difference("UepaW?_KEJ@`!\"", "");
  ...
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      soundex0.US_ENGLISH.difference("$Yx;].hF>^jU &#,Ar", "");
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("v*+XrHUzOe", "v*+XrHUzOe");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(4, int0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      String string0 = soundex0.encode("9NG*nUJx5");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("Na c", string0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      soundex0.setMaxLength((-1505));
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex("=kD/Js3Z]<bF6,]@iL");
      // Undeclared exception!
      try { 
        soundex0.difference("=kD/Js3Z]<bF6,]@iL", "yH>=XL?C^!");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("*/#,Q8%]hgujGW");
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("7Z:\n6d6*>8V[Oi", " ,1XhHC|wl9(");
      assertEquals(1, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("|xB&`$5w4WwJ");
      assertEquals(4, soundex0.getMaxLength());
