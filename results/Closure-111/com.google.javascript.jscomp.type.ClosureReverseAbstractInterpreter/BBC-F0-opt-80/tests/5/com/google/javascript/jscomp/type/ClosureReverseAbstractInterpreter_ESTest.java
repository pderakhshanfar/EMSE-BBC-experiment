...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node2 = Node.newString(4095, "Object#Element");
      Node node3 = new Node(37, node0, node0, node2, node1, 1, 49);
  ...
  public void test4()  throws Throwable  {
      ...
      SimpleErrorReporter simpleErrorReporter0 = new SimpleErrorReporter();
      JSTypeRegistry jSTypeRegistry0 = new JSTypeRegistry(simpleErrorReporter0, true);
      Node node0 = Node.newString("6A");
      Node node1 = Node.newString(4095, "Object#Element");
      Node node2 = new Node(37, node0, node0, node1, node1, 0, 49);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, jSTypeRegistry0);
