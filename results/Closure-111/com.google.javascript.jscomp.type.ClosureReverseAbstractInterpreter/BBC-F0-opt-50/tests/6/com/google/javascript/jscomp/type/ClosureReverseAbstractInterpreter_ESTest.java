...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(3424.553576, 655, 655);
      Node node1 = Node.newString(46, "(?VRoup", 2, 732);
      Node[] nodeArray0 = new Node[0];
      Node node2 = new Node((-2015), nodeArray0, 43, (-2015));
      SimpleErrorReporter simpleErrorReporter0 = new SimpleErrorReporter();
      JSTypeRegistry jSTypeRegistry0 = new JSTypeRegistry(simpleErrorReporter0);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, jSTypeRegistry0);
      Node node3 = new Node(37, node0, node0, node2, node1, (-2167), 50);
      FlowScope flowScope0 = mock(FlowScope.class, new ViolatedAssumptionAnswer());
      doReturn((String) null).when(flowScope0).toString();
      FlowScope flowScope1 = closureReverseAbstractInterpreter0.nextPreciserScopeKnowingConditionOutcome(node2, flowScope0, true);
  ...
  public void test1()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((double) 1983, 1983, 2);
      FlowScope flowScope0 = mock(FlowScope.class, new ViolatedAssumptionAnswer());
      doReturn((String) null).when(flowScope0).toString();
  ...
  public void test5()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((double) 1983, 1983, 2);
      nodeArray0[0] = node0;
      Node node1 = Node.newString(0, "(?VRoup", (-83), 46);
      nodeArray0[1] = node1;
      Node node2 = new Node(37, nodeArray0, 43, 54);
