...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("aT").when(flowScope0).toString();
      Node node2 = Node.newString("aT");
      Node node3 = new Node(37, node0, node0, node2, node1, 56, 8);
  ...
  public void test5()  throws Throwable  {
      ...
      Node node1 = Node.newNumber((double) 30);
      Node node2 = new Node(37, node0, node0, node0, node1, 56, 8);
      SimpleErrorReporter simpleErrorReporter0 = new SimpleErrorReporter();
  ...
  public void test6()  throws Throwable  {
      ClosureCodingConvention closureCodingConvention0 = new ClosureCodingConvention();
      Node node0 = new Node(716, 716, 716);
      Node node1 = new Node(37, node0, node0, node0, node0, 56, 8);
      SimpleErrorReporter simpleErrorReporter0 = new SimpleErrorReporter();
      JSTypeRegistry jSTypeRegistry0 = new JSTypeRegistry(simpleErrorReporter0, false);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, jSTypeRegistry0);
