...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      Node node0 = Node.newString("^B5yWlHC_\"Ln[AK)PN2");
      Node node1 = Node.newString("^B5yWlHC_\"Ln[AK)PN2");
      Node node2 = new Node(37, node0, node1);
      FlowScope flowScope0 = mock(FlowScope.class, new ViolatedAssumptionAnswer());
      doReturn("^B5yWlHC_\"Ln[AK)PN2").when(flowScope0).toString();
      Node node3 = Node.newString((-1807), "^B5yWlHC_\"Ln[AK)PN2");
