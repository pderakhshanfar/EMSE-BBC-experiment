...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString(4326, "");
      FlowScope flowScope0 = mock(FlowScope.class, new ViolatedAssumptionAnswer());
      doReturn("THROW").when(flowScope0).toString();
      Node node1 = new Node(37, node0, 30, 37);
      Node node2 = Node.newString("AyzkJcVuq&:");
  ...
  public void test1()  throws Throwable  {
      ...
      Node node1 = new Node(39, 2, 8);
      Node node2 = new Node(37, node1, 30, 37);
