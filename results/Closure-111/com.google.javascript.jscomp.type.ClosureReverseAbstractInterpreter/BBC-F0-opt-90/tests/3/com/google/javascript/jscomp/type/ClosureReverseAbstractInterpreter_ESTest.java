...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node1 = Node.newNumber((double) 42, (-1824), 48);
      Node node2 = Node.newString("Object#Key", 48, 49);
      Node node3 = new Node(37, node1, node2, node0, 2, 55);
  ...
  public void test2()  throws Throwable  {
      ...
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, jSTypeRegistry0);
      Node node0 = Node.newNumber((double) 37, 37, 37);
      Node node1 = Node.newNumber((double) 37, 37, 37);
      Node node2 = new Node(37, node0, node0, node1, 2, 54);
  ...
  public void test3()  throws Throwable  {
      ...
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, jSTypeRegistry0);
      Node node0 = Node.newNumber((double) 37, 37, 37);
      Node node1 = new Node(37, node0, node0, node0, 2, 54);
