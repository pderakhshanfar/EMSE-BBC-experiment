...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node1 = new Node(12, 0, 51);
      Node node2 = Node.newNumber((double) 57);
      Node node3 = new Node(37, node1, node2, node0, node0, 2, 46);
  ...
  public void test1()  throws Throwable  {
      ...
      Node node0 = Node.newString(0, "!;", (-1163), 998);
  ...
  public void test4()  throws Throwable  {
      JqueryCodingConvention jqueryCodingConvention0 = new JqueryCodingConvention();
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, (JSTypeRegistry) null);
      Node node0 = new Node((-2008), (-2466), (-2466));
      Node node1 = new Node((-74), (-3486), 3642);
      Node node2 = new Node(37, node0, node0, node0, node1, 122, 1610612705);
  ...
  public void test5()  throws Throwable  {
      ...
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, (JSTypeRegistry) null);
      Node node0 = new Node((-2008), (-2466), (-2466));
      Node node1 = new Node(37, node0, node0, node0, node0, 122, 1610612705);
