...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node1 = new Node(42, 33, 8);
      Node node2 = new Node(33);
      node0.addChildToFront(node2);
      Node node3 = new Node(37, node0, node1, node1, node1, 52, 50);
  ...
  public void test1()  throws Throwable  {
      ...
      Node node1 = new Node(42, 18, 8);
      Node node2 = new Node(37, node0, node1, node1, node1, 52, 50);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, (JSTypeRegistry) null);
  ...
  public void test2()  throws Throwable  {
      ...
      doReturn(">v").when(flowScope0).toString();
  ...
  public void test3()  throws Throwable  {
      JqueryCodingConvention jqueryCodingConvention0 = new JqueryCodingConvention();
      Node node0 = new Node(33);
      Node node1 = new Node(38, 37, 8);
      Node node2 = new Node(37, node0, node1, node1, node1, 52, 46);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, (JSTypeRegistry) null);
  ...
  public void test6()  throws Throwable  {
      JqueryCodingConvention jqueryCodingConvention0 = new JqueryCodingConvention();
      Node node0 = new Node(33);
      Node node1 = Node.newString(47, ">v", 51, 30);
      Node node2 = new Node(37, node0, node1, node1, node1, 52, 50);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, (JSTypeRegistry) null);
  ...
  public void test8()  throws Throwable  {
      JqueryCodingConvention jqueryCodingConvention0 = new JqueryCodingConvention();
      Node node0 = new Node(33);
      Node node1 = new Node(37, node0, node0, node0, node0, 52, 50);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, (JSTypeRegistry) null);
  ...
  public void test9()  throws Throwable  {
      ...
      Node node1 = Node.newString(47, ">v", 51, 30);
      Node node2 = new Node(37, node0, node1, node1, node1, 859, 688);
      FlowScope flowScope0 = closureReverseAbstractInterpreter0.getPreciserScopeKnowingConditionOutcome(node2, (FlowScope) null, false);
      assertNull(flowScope0);
  }
}
