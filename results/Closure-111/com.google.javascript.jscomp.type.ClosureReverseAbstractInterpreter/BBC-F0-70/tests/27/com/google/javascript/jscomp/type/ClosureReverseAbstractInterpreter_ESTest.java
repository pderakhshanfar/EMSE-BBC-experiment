...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((-756.3264628182));
      Node node1 = new Node(37, node0, node0, 30, 57);
      node1.addChildrenToBack(node1);
      Node node2 = new Node((-239), 16, 57);
  ...
  public void test4()  throws Throwable  {
      JqueryCodingConvention jqueryCodingConvention0 = new JqueryCodingConvention();
      Node node0 = Node.newNumber((-756.3264628181564));
      Node node1 = new Node(37, node0, node0, 30, 57);
      Node node2 = new Node(8, node1, node1, node1, 40, 1);
