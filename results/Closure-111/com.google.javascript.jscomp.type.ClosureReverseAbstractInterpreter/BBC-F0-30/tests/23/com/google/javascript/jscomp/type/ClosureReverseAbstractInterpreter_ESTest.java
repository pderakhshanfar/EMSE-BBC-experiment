...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node1 = Node.newString("goog.asserts.assertNumber", (-654), 1415);
      Node node2 = Node.newString(0, "");
      Node node3 = new Node(37, node0, node1, node1, node2, 0, 57);
  ...
  public void test4()  throws Throwable  {
      ...
      Vector<JSType> vector0 = new Vector<JSType>();
      Node node0 = jSTypeRegistry0.createParameters((List<JSType>) vector0);
      Node node1 = Node.newString("e", 29, (-2789));
      Node node2 = new Node(37, node0, node0, node0, node1, 2, (-2499));
  ...
  public void test5()  throws Throwable  {
      ...
      Vector<JSType> vector0 = new Vector<JSType>();
      Node node0 = jSTypeRegistry0.createParameters((List<JSType>) vector0);
      Node node1 = new Node(37, node0, node0, node0, node0, 2, (-2499));
