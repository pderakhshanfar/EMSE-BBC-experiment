...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node1 = Node.newString("isNull", 0, 15);
      Node node2 = new Node(1109, node1);
      node0.addChildrenToFront(node2);
      Node node3 = new Node(42, 16, 39);
      Node node4 = new Node(37, node0, node3, node3);
