...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node1 = Node.newString("Object#Element", 4, 49);
      Node node2 = Node.newString("Object#Key");
      Node node3 = new Node(37, node2, node0, node1, 2, 42);
  ...
  public void test3()  throws Throwable  {
      ...
      Node node2 = new Node(37, node0, node0, node1, 29, 42);
      GoogleCodingConvention googleCodingConvention0 = new GoogleCodingConvention();
  ...
  public void test4()  throws Throwable  {
      ...
      JSTypeRegistry jSTypeRegistry0 = new JSTypeRegistry(simpleErrorReporter0);
      Node node0 = Node.newString("Object#Key");
      Node node1 = new Node(37, node0, node0, node0, 29, 42);
      GoogleCodingConvention googleCodingConvention0 = new GoogleCodingConvention();
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(googleCodingConvention0, jSTypeRegistry0);
  ...
  public void test5()  throws Throwable  {
      ...
      SimpleErrorReporter simpleErrorReporter0 = new SimpleErrorReporter();
      JSTypeRegistry jSTypeRegistry0 = new JSTypeRegistry(simpleErrorReporter0);
      Node node0 = Node.newString("BITXOR", 37, 37);
  ...
  public void test6()  throws Throwable  {
      ...
      JSTypeRegistry jSTypeRegistry0 = new JSTypeRegistry(simpleErrorReporter0);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, jSTypeRegistry0);
      Node node0 = Node.newString("l~:u/u%6YU9^w_j3X'}");
