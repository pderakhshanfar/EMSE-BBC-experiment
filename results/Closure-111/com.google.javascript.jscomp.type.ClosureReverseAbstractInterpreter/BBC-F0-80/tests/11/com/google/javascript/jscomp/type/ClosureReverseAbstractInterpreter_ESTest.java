...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node2 = new Node((-1824), (-1824), (-1824));
      Node node3 = new Node(37, node0, node2, node1, 43, 48);
  ...
  public void test1()  throws Throwable  {
      ...
      Node node0 = Node.newString("Object#Key", (-220), (-220));
  ...
  public void test4()  throws Throwable  {
      Node node0 = new Node((-1843), 33, 0);
      Node node1 = new Node(33);
      Node node2 = new Node(37, node1, node0, node0, 3, 39);
      ClosureCodingConvention closureCodingConvention0 = new ClosureCodingConvention();
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, (JSTypeRegistry) null);
  ...
  public void test5()  throws Throwable  {
      ClosureCodingConvention closureCodingConvention0 = new ClosureCodingConvention();
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, (JSTypeRegistry) null);
      Node node0 = Node.newString((-1762), "");
      Node node1 = new Node(305, (-66), 0);
      Node node2 = new Node(37, node0, node0, node1, 43, 52);
