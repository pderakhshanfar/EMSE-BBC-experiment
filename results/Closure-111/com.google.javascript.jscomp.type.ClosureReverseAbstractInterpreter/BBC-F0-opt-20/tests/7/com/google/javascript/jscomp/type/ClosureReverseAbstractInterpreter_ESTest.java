...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((-2945.511180813847));
      Node node1 = Node.newNumber((double) 4095, 37, 2);
      Node node2 = new Node(37, node0, node1, node1, 54, 30);
      ...
      Node node3 = Node.newString("Dib", 12, 2);
  ...
  public void test4()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((-2927.6));
      Node[] nodeArray0 = new Node[0];
      Node node1 = new Node(2, nodeArray0, 414, (-2286));
      Node node2 = new Node(37, node0, node1, node1, 54, 0);
