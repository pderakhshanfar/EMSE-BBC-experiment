...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((-1174.66710854396));
      Node node1 = Node.newNumber((double) 43);
      Node node2 = Node.newNumber((-1174.66710854396));
      Node node3 = new Node(37, node1, node0, node2, 32, 39);
  ...
  public void test1()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((double) (-386), 0, (-1));
  ...
  public void test4()  throws Throwable  {
      JqueryCodingConvention jqueryCodingConvention0 = new JqueryCodingConvention();
      Node node0 = Node.newNumber((-1174.244872749));
      Node node1 = Node.newNumber((-1174.244872749));
      Node node2 = new Node(37, node1, node0, node0, 32, 39);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, (JSTypeRegistry) null);
  ...
  public void test5()  throws Throwable  {
      JqueryCodingConvention jqueryCodingConvention0 = new JqueryCodingConvention();
      Node node0 = Node.newNumber((-1174.244872749));
      Node node1 = new Node(37, node0, node0, node0, 32, 39);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, (JSTypeRegistry) null);
