...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString((-6), "Object#Key", (-6), 0);
      FlowScope flowScope0 = mock(FlowScope.class, new ViolatedAssumptionAnswer());
      doReturn("Object#Key", "dZ6Bd85|#N^8n").when(flowScope0).toString();
      FlowScope flowScope1 = closureReverseAbstractInterpreter0.firstPreciserScopeKnowingConditionOutcome(node0, flowScope0, true);
      Node node1 = Node.newNumber((-386.05187), 48, 261);
      Node node2 = new Node(37, node0, node1, node1, node1, 66, 0);
  ...
  public void test1()  throws Throwable  {
      ...
      FlowScope flowScope0 = mock(FlowScope.class, new ViolatedAssumptionAnswer());
      Node node1 = new Node(38, 56, 1);
      Node node2 = new Node(37, node0, node1, node1, node1, 0, 33);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(googleCodingConvention0, jSTypeRegistry0);
      // Undeclared exception!
      try { 
        closureReverseAbstractInterpreter0.getPreciserScopeKnowingConditionOutcome(node2, flowScope0, false);
  ...
  public void test4()  throws Throwable  {
      ...
      SimpleErrorReporter simpleErrorReporter0 = new SimpleErrorReporter();
      JSTypeRegistry jSTypeRegistry0 = new JSTypeRegistry(simpleErrorReporter0, true);
      Node node0 = Node.newString(33, "Object#Key", 33, 33);
      Node node1 = Node.newString("Object#Element", 4095, 2423);
      Node node2 = new Node(37, node0, node1, node0, node1, 4095, 0);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(googleCodingConvention0, jSTypeRegistry0);
  ...
  public void test5()  throws Throwable  {
      ...
      JSTypeRegistry jSTypeRegistry0 = new JSTypeRegistry(simpleErrorReporter0, true);
      Node node0 = Node.newString(33, "Object#Key", 33, 33);
      Node node1 = new Node(37, node0, node0, node0, node0, 4095, 0);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(googleCodingConvention0, jSTypeRegistry0);
  ...
  public void test6()  throws Throwable  {
      ...
      Node node1 = Node.newNumber((-386.05187), 48, 261);
      Node node2 = new Node(37, node0, node1, node1, node1, 64, 0);
      FlowScope flowScope0 = closureReverseAbstractInterpreter0.getPreciserScopeKnowingConditionOutcome(node2, (FlowScope) null, true);
      assertNull(flowScope0);
  }
}
