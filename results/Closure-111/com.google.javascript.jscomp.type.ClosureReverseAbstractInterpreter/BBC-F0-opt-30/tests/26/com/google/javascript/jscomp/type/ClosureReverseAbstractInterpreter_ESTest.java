...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = new Node((-3031));
      Node node1 = new Node(57, 4, 15);
      Node[] nodeArray0 = new Node[1];
      Node node2 = Node.newString("v\"qk`6&f7Jh");
      nodeArray0[0] = node0;
      Node node3 = new Node(37, nodeArray0, 12, 51);
  ...
  public void test4()  throws Throwable  {
      ...
      Node node1 = new Node(39, 12, 42);
      Node[] nodeArray0 = new Node[1];
      nodeArray0[0] = node0;
      Node node2 = new Node(37, nodeArray0, 12, 51);
  ...
  public void test5()  throws Throwable  {
      JqueryCodingConvention jqueryCodingConvention0 = new JqueryCodingConvention();
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, (JSTypeRegistry) null);
      Node node0 = new Node((-3042), (-3042), (-3042));
      Node node1 = new Node(57, 4, 15);
      Node[] nodeArray0 = new Node[1];
      nodeArray0[0] = node0;
      Node node2 = new Node(37, nodeArray0, 12, 51);
  ...
  public void test6()  throws Throwable  {
      ...
      Node[] nodeArray0 = new Node[1];
      nodeArray0[0] = node0;
      Node node1 = new Node(37, nodeArray0, 12, 51);
