...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node2 = new Node(42, 33, 50);
      Node node3 = new Node(37, node0, node0, node0, node2, 57, 4095);
  ...
  public void test1()  throws Throwable  {
      ...
      Node node1 = new Node(1, 36, 50);
      Node node2 = new Node(0);
      Node node3 = new Node(37, node0, node0, node2, node1, 57, 4095);
      GoogleCodingConvention googleCodingConvention0 = new GoogleCodingConvention();
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(googleCodingConvention0, (JSTypeRegistry) null);
  ...
  public void test3()  throws Throwable  {
      Node node0 = new Node(33, 33, 33);
      Node node1 = new Node(38, 33, 50);
      Node node2 = new Node(37, node0, node0, node0, node1, 57, 4095);
      GoogleCodingConvention googleCodingConvention0 = new GoogleCodingConvention();
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(googleCodingConvention0, (JSTypeRegistry) null);
  ...
  public void test9()  throws Throwable  {
      Node node0 = new Node(33, 33, 33);
      Node node1 = new Node(37, node0, node0, node0, node0, 57, 4095);
      GoogleCodingConvention googleCodingConvention0 = new GoogleCodingConvention();
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(googleCodingConvention0, (JSTypeRegistry) null);
