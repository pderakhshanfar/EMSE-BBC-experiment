...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString("isString");
      Node node1 = new Node((-2684), 2, 38);
      Node node2 = Node.newString(1543, "mVkfc/Z[8,Q>vwHTp");
      Node node3 = new Node(37, node0, node1, node2, (-3147), 16);
  ...
  public void test4()  throws Throwable  {
      ...
      Node node2 = new Node(37, node0, node0, node1, 37, 15);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, jSTypeRegistry0);
  ...
  public void test5()  throws Throwable  {
      ...
      JSTypeRegistry jSTypeRegistry0 = new JSTypeRegistry((ErrorReporter) null, false);
      Node node0 = Node.newString("Object#Key");
      Node node1 = new Node(37, node0, node0, node0, 37, 15);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, jSTypeRegistry0);
