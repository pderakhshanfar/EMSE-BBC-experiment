...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node1 = new Node(2, 32, 0);
      Node node2 = new Node((-1556), (-1556), (-1556));
      Node node3 = new Node(37, node0, node0, node2, node1, 56, 56);
  ...
  public void test1()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(924.5974);
  ...
  public void test2()  throws Throwable  {
      ClosureCodingConvention closureCodingConvention0 = new ClosureCodingConvention();
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, (JSTypeRegistry) null);
      Node node0 = new Node(38, 2090, 57);
      ...
      try { 
        ...
        fail("Expecting exception: UnsupportedOperationException");
         ...
         //
         // NAME 2090 is not a string node
         //
  ...
  public void test5()  throws Throwable  {
      ...
      Node node1 = new Node((-1), 32, 8);
      Node node2 = new Node(37, node0, node0, node0, node1, 16384, 300);
  ...
  public void test6()  throws Throwable  {
      ...
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, (JSTypeRegistry) null);
      Node node0 = new Node(1);
      Node node1 = new Node(37, node0, node0, node0, node0, 16384, 300);
