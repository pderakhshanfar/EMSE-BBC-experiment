...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      Node node0 = Node.newNumber((-9.338));
      Node node1 = Node.newString(48, "eG\u0007YFX&");
      Node node2 = Node.newString(48, "eG\u0007YFX&");
      Node node3 = new Node(37, node2, node1, node0);
      FlowScope flowScope0 = mock(FlowScope.class, new ViolatedAssumptionAnswer());
      doReturn("eG\u0007YFX&").when(flowScope0).toString();
  ...
  public void test4()  throws Throwable  {
      ...
      Node node1 = Node.newString(48, "eGK\u0007YFX&");
