...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString("V%p`=ju*!T'x6dH");
      Node node1 = Node.newString((-1), "Object#Element", 0, 2);
      Node node2 = Node.newNumber(0.0);
      Node node3 = new Node(37, node0, node1, node2, node2, 0, 1134);
  ...
  public void test4()  throws Throwable  {
      ...
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(jqueryCodingConvention0, jSTypeRegistry0);
      Node node0 = Node.newString("V%p`=ju*!T'x6dH");
      Node node1 = new Node(37, node0, node0, node0, node0, 0, 1134);
