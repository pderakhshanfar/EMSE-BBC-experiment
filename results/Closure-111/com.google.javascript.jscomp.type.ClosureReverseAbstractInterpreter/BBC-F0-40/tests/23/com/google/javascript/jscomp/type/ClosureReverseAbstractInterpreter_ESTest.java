...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString("Object#Key", 64, 64);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, jSTypeRegistry0);
      Node node1 = new Node(37, 51, 57);
      node1.addChildrenToFront(node0);
      Node node2 = new Node(4, 0, 4);
  ...
  public void test1()  throws Throwable  {
      ...
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, jSTypeRegistry0);
      Node node0 = Node.newString(3209, "Object#Element", 3209, 3209);
      Node node1 = Node.newString(55, "Object#Element");
      Node node2 = Node.newString("com.google.javascript.jscomp.type.ClosureReverseAbstractInterpreter", 43, (-754));
  ...
  public void test2()  throws Throwable  {
      ...
      Node node0 = Node.newString(3671, "\"BD:''hN", (-685), (-685));
      FlowScope flowScope0 = mock(FlowScope.class, new ViolatedAssumptionAnswer());
      doReturn((String) null).when(flowScope0).toString();
