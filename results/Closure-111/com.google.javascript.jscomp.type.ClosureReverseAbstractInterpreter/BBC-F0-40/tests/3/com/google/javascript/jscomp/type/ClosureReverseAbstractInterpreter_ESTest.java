...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node3 = new Node(37, node1, node2, node0, node0, 30, 57);
  ...
  public void test2()  throws Throwable  {
      ...
      Node node0 = Node.newString("com.google.javascript.jscomp.type.ClosureReverseAbstractInterpreter$3");
      Node node1 = new Node(38, node0, node0, node0, node0, 40, (-730));
  ...
  public void test5()  throws Throwable  {
      ClosureCodingConvention closureCodingConvention0 = new ClosureCodingConvention();
      Node node0 = Node.newNumber(0.0);
      Node node1 = Node.newString("com.googe.javacript.jscomp.type.ClouureRmverseAbstractInterpreter$X");
      Node node2 = new Node(37, node0, node0, node0, node1, 30, 57);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, (JSTypeRegistry) null);
  ...
  public void test6()  throws Throwable  {
      ClosureCodingConvention closureCodingConvention0 = new ClosureCodingConvention();
      Node node0 = Node.newNumber(0.0);
      Node node1 = new Node(37, node0, node0, node0, node0, 30, 57);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, (JSTypeRegistry) null);
