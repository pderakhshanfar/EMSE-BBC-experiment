...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node1 = new Node(37, node0, 48, 32);
      node1.addChildToBack(node1);
      Node[] nodeArray0 = new Node[0];
      Node node2 = new Node((-1791), nodeArray0, 57, (-543));
  ...
  public void test1()  throws Throwable  {
      ...
      SimpleErrorReporter simpleErrorReporter0 = new SimpleErrorReporter();
      Node node0 = Node.newNumber(1112.11, 0, 0);
  ...
  public void test4()  throws Throwable  {
      ...
      Node node0 = Node.newString("Object#Key");
      Node node1 = new Node(37, node0, 48, 32);
      Node node2 = Node.newString(1, "23V>Mb;");
      Node node3 = new Node(15, node2, node1, 2, 51);
