...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node1 = new Node(8, 4095, 57);
      Node node2 = new Node(8, 4095, 57);
      Node node3 = new Node(37, node0, node1, node2, 46, 49);
  ...
  public void test6()  throws Throwable  {
      ...
      Node node0 = new Node(37, 37, 37);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(googleCodingConvention0, (JSTypeRegistry) null);
      Node node1 = new Node(1, 4095, 160);
      Node node2 = new Node(37, node0, node1, node1, 46, 49);
      FlowScope flowScope0 = closureReverseAbstractInterpreter0.firstPreciserScopeKnowingConditionOutcome(node2, (FlowScope) null, true);
      assertNull(flowScope0);
  }
