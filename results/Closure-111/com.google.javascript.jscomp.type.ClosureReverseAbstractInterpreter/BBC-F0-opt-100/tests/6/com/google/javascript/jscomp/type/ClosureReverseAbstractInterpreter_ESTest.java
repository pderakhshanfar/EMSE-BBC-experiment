...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node1 = new Node(42, 2, 31);
      Node node2 = new Node(37, node0, node0, node1, 47, 48);
      ...
      Node node3 = Node.newString("RANGE_ERROR_FUNCTION_TYPE", 1714, 23);
  ...
  public void test1()  throws Throwable  {
      ...
      Node node2 = Node.newString(52, "n3~-");
      Node node3 = new Node(37, node2, node0, node1, 0, 2);
  ...
  public void test2()  throws Throwable  {
      ...
      Node node0 = new Node((-399), (-2411), (-399));
  ...
  public void test6()  throws Throwable  {
      ...
      Node node2 = new Node(37, node0, node0, node1, 2147, (-2210));
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, (JSTypeRegistry) null);
  ...
  public void test7()  throws Throwable  {
      ClosureCodingConvention closureCodingConvention0 = new ClosureCodingConvention();
      Node node0 = new Node(949);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, (JSTypeRegistry) null);
      Node node1 = Node.newString((-1825), "goog", 37, (-3343));
      Node node2 = new Node(37, node1, node0, node0, 0, 46);
      FlowScope flowScope0 = closureReverseAbstractInterpreter0.getPreciserScopeKnowingConditionOutcome(node2, (FlowScope) null, true);
      assertNull(flowScope0);
  }
  ...
  public void test8()  throws Throwable  {
      ClosureCodingConvention closureCodingConvention0 = new ClosureCodingConvention();
      Node node0 = new Node(33, 33, 33);
      Node node1 = new Node(37, node0, node0, node0, 47, 48);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, (JSTypeRegistry) null);
