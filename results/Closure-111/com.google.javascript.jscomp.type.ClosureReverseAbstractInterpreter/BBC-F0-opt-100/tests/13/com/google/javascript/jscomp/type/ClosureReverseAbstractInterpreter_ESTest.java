...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString(1, "ml)FTq&oy_Dz|@*", 1151, 1151);
      Node node1 = Node.newString("ml)FTq&oy_Dz|@*");
      Node node2 = new Node(32, 1054, 16);
      Node node3 = new Node(37, node1, node0, node2, 52, 4095);
  ...
  public void test4()  throws Throwable  {
      ...
      Node node1 = Node.newString("l!'p[+RH!Rf3z");
