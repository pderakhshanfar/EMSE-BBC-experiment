...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString("goog", 37, 37);
      Node node1 = Node.newString((-1), "Object#Element", 2465, 1);
      Node node2 = Node.newString("goog", 37, 37);
      Node node3 = new Node(37, node2, node0, node1, (-2108), 40);
  ...
  public void test4()  throws Throwable  {
      ...
      JSTypeRegistry jSTypeRegistry0 = new JSTypeRegistry(simpleErrorReporter0, true);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(closureCodingConvention0, jSTypeRegistry0);
      Node node0 = Node.newString(37, "goog");
      Node node1 = Node.newString((-1), "Object#Element", 2507, 1);
      Node node2 = new Node(37, node0, node0, node1, (-2088), 40);
