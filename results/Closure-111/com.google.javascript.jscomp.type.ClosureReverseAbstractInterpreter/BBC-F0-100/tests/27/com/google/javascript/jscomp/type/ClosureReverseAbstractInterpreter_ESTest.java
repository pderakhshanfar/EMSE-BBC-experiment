...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      Node node0 = Node.newString(37, "Lf", 37, 37);
      FlowScope flowScope0 = mock(FlowScope.class, new ViolatedAssumptionAnswer());
      doReturn("Lf").when(flowScope0).toString();
      ClosureCodingConvention closureCodingConvention0 = new ClosureCodingConvention();
      Node node1 = Node.newString((-1326), "");
      node0.addChildToBack(node1);
      node0.addChildrenToBack(node0);
      Node node2 = Node.newString(4, "Lf", 42, 43);
  ...
  public void test1()  throws Throwable  {
      ...
      Node node0 = Node.newString(37, "", (-1193), (-1193));
      FlowScope flowScope0 = mock(FlowScope.class, new ViolatedAssumptionAnswer());
  ...
  public void test4()  throws Throwable  {
      ...
      ClosureCodingConvention closureCodingConvention0 = new ClosureCodingConvention();
      node0.addChildrenToBack(node0);
      Node node1 = Node.newString(47, "Lf", 0, (-1));
