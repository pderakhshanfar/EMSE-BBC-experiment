...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(3416.923673983556);
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-2601.08585));
      assertEquals("-2601.08585", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value("jK F}HI~!X``0(BK>");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test38()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("EU%oGAu'mB{UJW");
      // Undeclared exception!
      try { 
        jsonWriter1.value(185L);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("java.lang.Long@0000000004");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test45()  throws Throwable  {
      ...
      jsonWriter0.endArray();
      jsonWriter1.value((-3942L));
      assertEquals("[]-3942", stringWriter0.toString());
  }
  ...
  public void test50()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value((-2601.08585));
      jsonWriter2.setIndent("4L;(M^kq4^Jj");
      jsonWriter0.endArray();
      assertEquals("[-2601.08585\n]", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test51()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("\"2ea>s H\"a");
      assertEquals("\"\\\"2ea>s H\\\"a\"", stringWriter0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("\b");
      jsonWriter1.close();
      jsonWriter0.close();
  ...
  public void test64()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("EE^Gi3");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name("EE^Gi3");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test72()  throws Throwable  {
      ...
      jsonWriter2.name("name == null");
      jsonWriter0.beginArray();
      assertEquals("{\"name == null\":true,\"name == null\":[", stringWriter0.toString());
  }
