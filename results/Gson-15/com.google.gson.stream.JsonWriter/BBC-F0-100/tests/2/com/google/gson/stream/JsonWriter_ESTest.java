...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(2684L);
      assertEquals("2684", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(1614.9);
      assertEquals("1614.9", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("gsn eXS3n=BT.");
      Integer integer0 = Integer.valueOf((-3104));
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter3 = jsonWriter2.name("Q*VoV+0uJ]3)");
      Float float0 = new Float(1.0);
      JsonWriter jsonWriter4 = jsonWriter3.value((Number) float0);
      // Undeclared exception!
      try { 
        jsonWriter4.jsonValue("Q*VoV+0uJ]3)");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test48()  throws Throwable  {
      ...
      assertEquals("[null,K~", stringWriter0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("Yk;^#$ry@k\"q\"(Q");
      assertEquals("\"Yk;^#$ry@k\\\"q\\\"(Q\"", stringWriter0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.name("Pr[cnKX']z~B*m!Bt");
      // Undeclared exception!
      try { 
        jsonWriter1.endArray();
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Dangling name: Pr[cnKX']z~B*m!Bt
         //
         verifyException("com.google.gson.stream.JsonWriter", e);
      }
  }
