...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("t]|F\"idC\"4m,");
      assertEquals("\"t]|F\\\"idC\\\"4m,\"", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(2772L);
      assertEquals("2772", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-695.61));
      assertEquals("-695.61", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-4531.053088));
      assertEquals("-4531.053088", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue(",1h pDFc");
      assertEquals(",1h pDFc", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("-m!VN@V");
      ...
      assertEquals("{\"-m!VN@V\":true}", stringWriter0.toString());
  }
  ...
  public void test40()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("B)w=GlE,OrnpZ=h");
      Byte byte0 = new Byte((byte)0);
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("J#ls,dcX{&(");
      Boolean boolean0 = Boolean.FALSE;
      JsonWriter jsonWriter2 = jsonWriter1.value(boolean0);
      jsonWriter2.name("jljZ2oQ}");
      jsonWriter1.beginArray();
      assertEquals("{\"J#ls,dcX{&(\":false,\"jljZ2oQ}\":[", stringWriter0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("(NT,M {}\"@}");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.beginArray();
  ...
  public void test65()  throws Throwable  {
      ...
      JsonWriter jsonWriter4 = jsonWriter3.name("Te?^Mk0w%YUpdt2QU");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Dangling name: Te?^Mk0w%YUpdt2QU
         //
         verifyException("com.google.gson.stream.JsonWriter", e);
      }
  }
