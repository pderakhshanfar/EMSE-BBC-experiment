...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name(")12]iXA_");
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("P7i|lj0RQ)v7J0\f-5");
      assertEquals("\"P7i|lj0RQ)v7J0\\f-5\"", stringWriter0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Float float0 = new Float(1214.0F);
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(2601L);
      assertEquals("2601", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test37()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name(")12]iXA_");
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("Y]8VeX");
      jsonWriter2.beginObject();
      // Undeclared exception!
      try { 
        jsonWriter2.value((double) 1117);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("x^=V.i^P2#K55");
      JsonWriter jsonWriter2 = jsonWriter1.jsonValue("x^=V.i^P2#K55");
      // Undeclared exception!
      try { 
        jsonWriter2.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent("!959P/@pv$");
      jsonWriter0.jsonValue((String) null);
      assertEquals("[\n!959P/@pv$null", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      assertEquals("\"\\r\"-1.0", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("~sV%I:cVjzdl");
      jsonWriter1.beginArray();
      jsonWriter0.endArray();
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("UIw{/wiTYt&''");
      jsonWriter1.value((double) 1);
      JsonWriter jsonWriter2 = jsonWriter0.name("UIw{/wiTYt&''");
      jsonWriter2.nullValue();
      assertEquals("{\"UIw{/wiTYt&''\":1.0", stringWriter0.toString());
  }
  ...
  public void test52()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter0.name("UIw{/wiTYt&''");
      jsonWriter2.nullValue();
      assertEquals("{\"UIw{/wiTYt&''\":1.0,\"UIw{/wiTYt&''\":null", stringWriter0.toString());
  }
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("7NLd'|{cA-\u0001HQ \"Q~T");
      assertEquals("\"7NLd'|{cA-\\u0001HQ \\\"Q~T\"", stringWriter0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      JsonWriter jsonWriter7 = jsonWriter6.name("");
