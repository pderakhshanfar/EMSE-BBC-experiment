...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("p>,/ Z9D:;nrn");
      assertEquals("\"p>,/ Z9D:;nrn\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Boolean boolean0 = new Boolean(".=pqnZ%15eRuGYRxUU");
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Boolean boolean0 = Boolean.valueOf("(cwK>D1(oMSu2r");
      jsonWriter0.value(boolean0);
      assertEquals("false", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-1837L));
      assertEquals("-1837", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(1820L);
      assertEquals("1820", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("'$Me<y4~1c.IMyck");
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("CDzVB0&*zbgLNX");
      assertEquals("CDzVB0&*zbgLNX", stringWriter0.toString());
  }
  ...
  public void test37()  throws Throwable  {
      ...
      Double double0 = new Double(792.8134107384);
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter3 = jsonWriter2.name("@{gIrhz+/d<:{G#K%");
      jsonWriter3.beginArray();
      assertEquals("{\"\\n\":false,\"@{gIrhz+/d<:{G#K%\":[", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("?Ej'u8qSYx%W 4");
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.endArray();
      jsonWriter0.name("?Ej'u8qSYx%W 4");
      jsonWriter0.beginObject();
      assertEquals("{\"?Ej'u8qSYx%W 4\":[],\"?Ej'u8qSYx%W 4\":{", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("h=k>zv(/5cF@4R");
      JsonWriter jsonWriter2 = jsonWriter1.value("h=k>zv(/5cF@4R");
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("'.dbG%b-S|y7Fl}");
      jsonWriter0.setHtmlSafe(true);
      jsonWriter1.value(1387.0);
      assertTrue(jsonWriter1.isHtmlSafe());
  }
  ...
  public void test62()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("lu-(O1jz+vc)0'");
      // Undeclared exception!
      try { 
        jsonWriter1.name(".yL%_`%U");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test64()  throws Throwable  {
      ...
      JsonWriter jsonWriter12 = jsonWriter3.name("@{gIrhz+/d<:{G#K%");
      ...
      jsonWriter6.name("@{gIrhz+/d<:{G#K%");
      jsonWriter2.beginObject();
      jsonWriter10.name("0YRAH>Q;S");
      ...
      assertEquals("[[[[[[[[[[[[[[[[[[[{\"@{gIrhz+/d<:{G#K%\":[[[{\"@{gIrhz+/d<:{G#K%\":{\"0YRAH>Q;S\":[[[[[[[", stringWriter0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("_AU33)");
      // Undeclared exception!
      try { 
        jsonWriter2.endArray();
        fail("Expecting exception: IllegalStateException");
