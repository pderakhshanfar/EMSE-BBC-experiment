...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter0.name("3%9lD@<*AT&|WS");
      // Undeclared exception!
      try { 
        jsonWriter1.value(4860L);
  ...
  public void test04()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("!UuseUDiouD-;)o8");
      assertEquals("\"!UuseUDiouD-;)o8\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      jsonWriter0.value(boolean0);
      assertEquals("{\"Dangling name: \":true,\"\\b\":false", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(4864L);
      assertEquals("4864", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(4860L);
      assertEquals("4860", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(3931.18932);
      assertEquals("3931.18932", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(740.826);
      assertEquals("740.826", stringWriter0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("~MX");
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("=z8oK~?I8d|%s*&sq^");
      assertEquals("=z8oK~?I8d|%s*&sq^", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test35()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(762L);
      // Undeclared exception!
      try { 
        jsonWriter1.value((-3475.24451941));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("&ybX!4\"Q5jC,");
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("q$Fp{Z+VEn{!p");
      jsonWriter1.setLenient(true);
      jsonWriter0.value(0.0);
      assertEquals("\"q$Fp{Z+VEn{!p\"0.0", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(3931.18932);
      // Undeclared exception!
      try { 
        jsonWriter1.value("{");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("B9l6~2P");
      JsonWriter jsonWriter2 = jsonWriter1.jsonValue("B9l6~2P");
      // Undeclared exception!
      try { 
  ...
  public void test57()  throws Throwable  {
      ...
      jsonWriter13.name(";5$t@9}}:");
      assertEquals("[[[[[[[[[[[[[[[[[[[[[[[[[[[{\"\":[{", stringWriter0.toString());
      
      jsonWriter4.beginObject();
      jsonWriter9.name("java.lang.Short@0000000002");
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("!UuseUDiouD-;)o8");
      jsonWriter0.beginArray();
      jsonWriter0.value("!UuseUDiouD-;)o8");
      assertEquals("[\n!UuseUDiouD-;)o8\"!UuseUDiouD-;)o8\"", stringWriter0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("x?6&S=f@`(|z>/");
      assertEquals("\"x?6\\u0026S\\u003df@`(|z\\u003e/\"", stringWriter0.toString());
  }
}
