...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(",!KIS2*`m`;f");
      assertEquals("\",!KIS2*`m`;f\"", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-575L));
      assertEquals("-575", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) 311L);
      assertEquals("311.0", stringWriter0.toString());
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("d85m/\"%6T2;=sg6Ia");
      assertEquals("d85m/\"%6T2;=sg6Ia", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("<BzY89");
      jsonWriter1.beginObject();
      assertEquals("{\"<BzY89\":{", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("bNZ)T!T\"sb:*");
      assertEquals("\"bNZ)T!T\\\"sb:*\"", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("D+h");
  ...
  public void test48()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value((long) 438);
      jsonWriter0.jsonValue((String) null);
      assertEquals("[438,null", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter4 = jsonWriter3.name("nLH(");
      assertEquals("{\"\":false", stringWriter0.toString());
      
      Integer integer0 = new Integer(973);
      jsonWriter4.value((Number) integer0);
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test52()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("\"r2");
      assertEquals("\"\\\"r2\"", stringWriter0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-3011L));
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("\u2029");
  ...
  public void test65()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("D+h");
      // Undeclared exception!
      try { 
        jsonWriter1.name("D+h");
        fail("Expecting exception: IllegalStateException");
