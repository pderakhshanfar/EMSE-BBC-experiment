...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("20UW$({o2");
      // Undeclared exception!
      try { 
        jsonWriter1.value((long) (byte)12);
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-3929.0));
      assertEquals("-3929.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-2169.71227675358));
      assertEquals("-2169.71227675358", stringWriter0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("i3:K\u0000= DbE");
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("bHE");
      assertEquals("bHE", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue(",L.P]TiNv^=z=$W#*");
      assertEquals(",L.P]TiNv^=z=$W#*", stringWriter0.toString());
  }
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float(1603.5670891887);
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("fm8 T:xjF)/[rjKj%");
      jsonWriter1.beginObject();
      assertEquals("{\"fm8 T:xjF)/[rjKj%\":{", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("NaC-e#@");
      jsonWriter0.setLenient(true);
      jsonWriter1.value((double) 115);
      assertEquals("\"NaC-e#@\"115.0", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("fJCh*&c6SO[<wuR");
      jsonWriter0.nullValue();
      // Undeclared exception!
      try { 
  ...
  public void test50()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("C+t+v0B4}");
      jsonWriter0.beginObject();
      assertEquals("[\nC+t+v0B4}{", stringWriter0.toString());
  }
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("*J_E\"P\"f+gODU");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("*J_E\"P\"f+gODU");
        fail("Expecting exception: IllegalStateException");
