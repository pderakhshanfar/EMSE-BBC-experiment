...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("Ig^8qy\"0LGo+o5*}");
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(2556L);
      assertEquals("2556", stringWriter0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) 574);
      assertEquals("574.0", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("}I6Xz*N/3H!Z$.");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value("Ya&#rj`29i'Kv_Kms");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test39()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(350.61765837681);
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("Ig^8qy\"0LGo+o5*}");
      jsonWriter0.beginObject();
      assertEquals("{\"Ig^8qy\\\"0LGo+o5*}\":{", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(574);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((long) 574);
      jsonWriter0.setLenient(true);
      jsonWriter1.nullValue();
      assertEquals("574null", stringWriter0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("q;w7TYwo");
      assertEquals("{", stringWriter0.toString());
      
      Float float0 = new Float((-3488.14F));
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("\"Jz0gG6R]\\4ADoo07S");
      assertEquals("\"\\\"Jz0gG6R]\\\\4ADoo07S\"", stringWriter0.toString());
  }
  ...
  public void test57()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("Ig^8qy\"0LGo+o5*}");
      JsonWriter jsonWriter3 = jsonWriter1.value("Ig^8qy\"0LGo+o5*}");
      jsonWriter3.endObject();
      jsonWriter1.close();
      jsonWriter2.close();
      assertEquals("{\"Ig^8qy\\\"0LGo+o5*}\":\"Ig^8qy\\\"0LGo+o5*}\"}", stringWriter0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("VC/DEfKNap\"D=W*,:");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test65()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(579);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.jsonValue("cJTM@%BhyQv1s!\t");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name("");
  ...
  public void test75()  throws Throwable  {
      ...
      jsonWriter15.name(",G|k 0e~i3;O/bF");
      jsonWriter14.beginArray();
      jsonWriter6.beginArray();
      jsonWriter3.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[[[[[[[[[[[[{\",G|k 0e~i3;O/bF\":[[[", stringWriter0.toString());
  }
