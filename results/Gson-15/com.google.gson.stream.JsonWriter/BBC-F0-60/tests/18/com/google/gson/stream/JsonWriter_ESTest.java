...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("wbH@2\"/&3t!Sad[z]");
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("=jn_aMLan$a");
      assertEquals("\"=jn_aMLan$a\"", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-679L));
      assertEquals("-679", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-1711L));
      assertEquals("-1711", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) (-1454.96F));
      assertEquals("-1454.9599609375", stringWriter0.toString());
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(1053.536412746);
      assertEquals("1053.536412746", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("wbH@2\"/&3t!Sad[z]");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("L\"/;S,bpX&8T[5*uV0");
      assertEquals("L\"/;S,bpX&8T[5*uV0", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test37()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("=jn_aMLan$a");
      Boolean boolean0 = Boolean.FALSE;
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("FzWdz_Y>IJZ+h_");
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("FzWdz_Y>IJZ+h_");
      jsonWriter1.beginObject();
      assertEquals("{\"FzWdz_Y>IJZ+h_\":{", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value((-1711L));
      jsonWriter1.jsonValue("NaN");
      assertEquals("[-1711,NaN", stringWriter0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("$^kwV$G&\"`g");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.flush();
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float((-1489.5631));
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("$^k_V$G=q`g");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name("$^k_V$G=q`g");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test70()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("Uj9u 4K9*p{");
      jsonWriter0.nullValue();
      jsonWriter0.name("Maz`6/0_0?w8");
      jsonWriter0.jsonValue("Uj9u 4K9*p{");
      assertEquals("{\"Uj9u 4K9*p{\":null,\"Maz`6/0_0?w8\":Uj9u 4K9*p{", stringWriter0.toString());
  }
