...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(4702);
  ...
  public void test01()  throws Throwable  {
      ...
      jsonWriter0.name("g;\"d_S6XFm)DY~I-.");
      jsonWriter1.nullValue();
      assertEquals("{\"g;\\\"d_S6XFm)DY~I-.\":null", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      jsonWriter0.name("c)!aI2B_WE^t>m1 @");
      jsonWriter0.setHtmlSafe(true);
  ...
  public void test11()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("l1\u0003TA4FWg,$M9*~^y-");
      Boolean boolean0 = new Boolean(false);
      jsonWriter1.value(boolean0);
      assertEquals("{\"l1\\u0003TA4FWg,$M9*~^y-\":false", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("l1\u0003TA4FWg,$M9*~^y-");
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((long) (byte)121);
      assertEquals("{\"l1\\u0003TA4FWg,$M9*~^y-\":121", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(2569.0);
      assertEquals("2569.0", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("I[DZ5P");
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals("{\"l1\\u0003TA4FWg,$M9*~^y-\":", stringWriter0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      jsonWriter0.jsonValue("b@}$=^ho\"MXe(I6x");
      jsonWriter1.endObject();
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("b@}$=^ho\"MXe(I6x");
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter0.name("l1\u0003TA4FWg,$M9*~^y-");
      Boolean boolean0 = new Boolean(false);
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter0.name("l1\u0003TA4FWg,$M9*~^y-");
      jsonWriter1.setIndent(",9d5']:CLv");
      jsonWriter2.beginArray();
      assertEquals("{\n,9d5']:CLv\"l1\\u0003TA4FWg,$M9*~^y-\": [", stringWriter0.toString());
  }
