...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Boolean boolean0 = new Boolean("ggNaToJ%5y.");
  ...
  public void test13()  throws Throwable  {
      ...
      jsonWriter1.name("");
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-2185L));
      assertEquals("{\"\":-2185", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("mMMva|ro");
      assertEquals("mMMva|ro", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      jsonWriter0.name(">;5fAG[TIa>");
      jsonWriter0.jsonValue(">;5fAG[TIa>");
      assertEquals("{\"\\u003e;5fAG[TIa\\u003e\":>;5fAG[TIa>", stringWriter0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("pDw#{:D");
      assertEquals("pDw#{:D", stringWriter0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      jsonWriter0.setLenient(true);
      jsonWriter0.beginObject();
      assertEquals("{\">;5fAG[TIa>\":{", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("9TXk");
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value(2454.3946012515444);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("lse");
      jsonWriter0.value("lse");
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("B.ubq2dA22+");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test45()  throws Throwable  {
      ...
      jsonWriter1.jsonValue("pDw#{:D");
      assertEquals("[\"-Infinity\",pDw#{:D", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value(1401.080670663335);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("\n");
      assertEquals("1401.080670663335\"\\n\"", stringWriter0.toString());
  }
  ...
  public void test50()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("lsf");
      JsonWriter jsonWriter3 = jsonWriter2.value(0.0);
      jsonWriter3.name("\u2028");
      jsonWriter1.value((-2069.71217));
      assertEquals("{\"lsf\":0.0,\"\\u2028\":-2069.71217", stringWriter0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      jsonWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("lsf");
      jsonWriter1.value("lsf");
      assertTrue(jsonWriter0.isHtmlSafe());
      assertEquals("{\"lsf\":\"lsf\"", stringWriter0.toString());
  }
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("]@fCy*j~");
      jsonWriter1.close();
      jsonWriter0.close();
      assertEquals("\"]@fCy*j~\"", stringWriter0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("cjHFys48)r%Hp(M,(");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name("\u2029");
  ...
  public void test64()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("8b8{lV\"RGJb)Rno+x,");
      // Undeclared exception!
      try { 
        jsonWriter0.name("8b8{lV\"RGJb)Rno+x,");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test67()  throws Throwable  {
      ...
      JsonWriter jsonWriter3 = jsonWriter1.name("').'Wf");
      // Undeclared exception!
      try { 
  ...
  public void test70()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("lsf");
      JsonWriter jsonWriter2 = jsonWriter1.value("lsf");
      jsonWriter2.endObject();
      assertEquals("{\"lsf\":\"lsf\"}", stringWriter0.toString());
  }
  ...
  public void test74()  throws Throwable  {
      ...
      JsonWriter jsonWriter9 = jsonWriter5.name("Infinity");
  ...
  public void test77()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Double double0 = new Double((-1581.4221));
