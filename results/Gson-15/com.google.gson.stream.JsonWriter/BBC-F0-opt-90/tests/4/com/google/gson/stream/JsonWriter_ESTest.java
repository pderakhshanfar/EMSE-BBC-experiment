...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        jsonWriter0.value((double) 1488L);
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("lwAZ rSs~BT\"$w\"<x2");
      assertEquals("\"lwAZ rSs~BT\\\"$w\\\"<x2\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Boolean boolean0 = Boolean.valueOf("U:N/+y-$kfk;Sd_6");
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(boolean0);
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(894L);
      assertEquals("894", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(3212.7845);
      assertEquals("3212.7845", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-2905.733142526));
      assertEquals("-2905.733142526", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("<NlxZ\"*1");
      assertEquals("<NlxZ\"*1", stringWriter0.toString());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      jsonWriter0.name("4ZZ[~r-e-z`[*.0QUl7H");
      jsonWriter1.setLenient(true);
      jsonWriter1.value(true);
      jsonWriter0.endObject();
      assertEquals("{\"4ZZ[~r-e-z`[*.0QUl7H\":true}", stringWriter0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("4ZZ[~o-e-z`[*.0QUl7H");
      jsonWriter2.value(true);
      jsonWriter0.endObject();
      assertEquals("{\"4ZZ[~o-e-z`[*.0QUl7H\":true}", stringWriter0.toString());
  }
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("pp&mCA<v#g6\"");
      // Undeclared exception!
      try { 
        jsonWriter1.value("pp&mCA<v#g6\"");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      Integer integer0 = new Integer(5357);
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("|c:v\"kB=/d;#/sS;");
      // Undeclared exception!
      try { 
  ...
  public void test50()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value(false);
      jsonWriter0.value(857L);
      assertEquals("[false,857", stringWriter0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("4ZZ[~o-e-z`[*.0QUl7H");
      jsonWriter2.value(true);
      jsonWriter1.name("4ZZ[~o-e-z`[*.0QUl7H");
      jsonWriter1.value(false);
      assertEquals("{\"4ZZ[~o-e-z`[*.0QUl7H\":true,\"4ZZ[~o-e-z`[*.0QUl7H\":false", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test52()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("!Wy3fHv}Vs>F!");
      assertEquals("[", stringWriter0.toString());
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("lwAZ rSs~BT\"$w\"<x2");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.flush();
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("XY%0z`E]u-C}LoJ");
      // Undeclared exception!
      try { 
        jsonWriter0.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test63()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("lwAZ rSs~BT\"$w\"<x2");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test66()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Dangling name: 4ZZ[~o-e-z`[*.0QUl7H
         //
         verifyException("com.google.gson.stream.JsonWriter", e);
      }
  }
