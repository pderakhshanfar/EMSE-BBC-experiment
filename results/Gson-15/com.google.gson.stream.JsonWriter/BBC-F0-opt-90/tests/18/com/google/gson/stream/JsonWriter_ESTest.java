...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Boolean boolean0 = new Boolean("B9\"&sv/!>jnz QTK_w4");
      jsonWriter0.value(boolean0);
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(1977.74334933621);
      assertEquals("1977.74334933621", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("Lr");
      assertEquals("Lr", stringWriter0.toString());
  }
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("Er|XS-Xdw");
      Float float0 = new Float((-2276.9));
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("\f003");
      jsonWriter2.value(0.0);
      jsonWriter1.name("\f003");
      assertEquals("{\"\\f003\":0.0", stringWriter0.toString());
      
      Float float0 = new Float(4265.0F);
  ...
  public void test43()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.jsonValue("C66 8e7RV");
      // Undeclared exception!
      try { 
        jsonWriter0.value(0.0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("=kDVAWNc;@H/G<");
      jsonWriter2.value("=kDVAWNc;@H/G<");
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      jsonWriter2.name("#Yv>6@+");
      jsonWriter2.beginObject();
      assertEquals("{\"-\":-,\"#Yv>6@+\":{", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("JsonWriter is closed.");
      jsonWriter0.beginArray();
      jsonWriter0.beginObject();
      assertEquals("[\nJsonWriter is closed.{", stringWriter0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("wqy~Lo=");
      jsonWriter1.setSerializeNulls(false);
  ...
  public void test66()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("e,);b,hcjJE");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test72()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Float float0 = new Float(223.437);
      jsonWriter0.value((Number) float0);
  ...
  public void test73()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("B9\"&sv/!>jnz QTK_w4");
      assertEquals("\"B9\\\"\\u0026sv/!\\u003ejnz QTK_w4\"", stringWriter0.toString());
  }
}
