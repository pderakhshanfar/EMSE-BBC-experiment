...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("2.(GNc\"MuR[zd=-");
      assertEquals("\"2.(GNc\\\"MuR[zd=-\"", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Boolean boolean0 = Boolean.valueOf("( ODdH]F,&B:c6n");
      jsonWriter0.setLenient(true);
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-2132.6769994));
      assertEquals("-2132.6769994", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("E-{{W=Cer3t5pFc)@hA");
  ...
  public void test25()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("bA'?ly(~[a");
      assertEquals("bA'?ly(~[a", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("%&~DT");
      jsonWriter1.value((-2896L));
      // Undeclared exception!
      try { 
        jsonWriter0.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.beginArray();
      jsonWriter1.endArray();
      JsonWriter jsonWriter3 = jsonWriter2.name("A<)De;l");
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("oe[8fO^<Q_)`!ZA}");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test58()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("vbg3<d}sY");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test64()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value(3559.20479042);
        fail("Expecting exception: IllegalStateException");
