...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter0.name("kIF:v'NO8]YUTl<");
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-5016L));
      assertEquals("-5016", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(11.933792966666942);
      assertEquals("11.933792966666942", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(870.785574246);
      assertEquals("870.785574246", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("t*#YgQ$oJw<'S0N*\"");
      assertEquals("t*#YgQ$oJw<'S0N*\"", stringWriter0.toString());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("=@X o\"");
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("'XR9gP>kH$Z");
      // Undeclared exception!
      try { 
        jsonWriter1.value("'XR9gP>kH$Z");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("<[u]9^o./`RN_n!n");
      Float float0 = new Float(1836.113805242);
      jsonWriter2.value((Number) float0);
      // Undeclared exception!
      try { 
        jsonWriter2.jsonValue("<[u]9^o./`RN_n!n");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("<[u]9^o./`RN_n!n");
      jsonWriter2.jsonValue("<[u]9^o./`RN_n!n");
      assertEquals("[,{\"<[u]9^o./`RN_n!n\":<[u]9^o./`RN_n!n", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("q</n04ni& DP.F#.sgY");
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value("p\"7$TJ.Ij");
      jsonWriter2.beginArray();
      assertEquals("[\"p\\\"7$TJ.Ij\",[", stringWriter0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value(4956.23080603697);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("IH}q)");
      // Undeclared exception!
      try { 
  ...
  public void test64()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(32);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((long) 32);
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.value((long) 32);
