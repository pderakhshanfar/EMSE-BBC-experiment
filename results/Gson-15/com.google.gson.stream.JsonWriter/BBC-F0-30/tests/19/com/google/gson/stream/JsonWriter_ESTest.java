...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Double double0 = new Double(903);
      jsonWriter1.name("R=YrZvC!R?Z");
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("^6||\"lP\"+_;7KF^/G");
      assertEquals("\"^6||\\\"lP\\\"+_;7KF^/G\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("XDbn->[/IKUA");
      assertEquals("\"XDbn->[/IKUA\"", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((long) 903);
      assertEquals("903", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-677.58));
      assertEquals("-677.58", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((double) (-2040948333));
      assertEquals("-2.040948333E9", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("=YrZvC!R?Z");
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value("b8'(#?z)Qhh.N%T6J");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test38()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("x:V");
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name(".[3~x,r%^H2`mP9w\"V");
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("fq+e@SDA39zRPB:");
      jsonWriter2.beginObject();
      assertEquals("{\"fq+e@SDA39zRPB:\":{", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(903);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float((float) 903);
  ...
  public void test45()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("9=34WMk_u)");
      jsonWriter1.setLenient(true);
      jsonWriter1.nullValue();
      assertEquals("\"9=34WMk_u)\"null", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(934);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((double) (-2040948335));
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(934);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("1|aW[@]O(jy*,");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name("1|aW[@]O(jy*,");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test65()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.name("b8' #?z)Qhh.J%T6#");
      // Undeclared exception!
      try { 
        jsonWriter1.endArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test72()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("r;F;2V?u=K(T");
      jsonWriter2.beginArray();
      assertEquals("{\"}\":0.0,\"r;F;2V?u=K(T\":[", stringWriter0.toString());
  }
