...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("h'N*;x{GxhbD2");
      assertEquals("\"h'N*;x{GxhbD2\"", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals("777", stringWriter0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-4566.465));
      assertEquals("-4566.465", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-928.0));
      assertEquals("-928.0", stringWriter0.toString());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("jY%TVZ{mW{");
      assertEquals("jY%TVZ{mW{", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("~3*D>{a7b^wt_~M");
      assertEquals("~3*D>{a7b^wt_~M", stringWriter0.toString());
  }
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float(2641.2309799);
  ...
  public void test39()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Boolean boolean0 = new Boolean("LC_nIemb c");
  ...
  public void test44()  throws Throwable  {
      ...
      jsonWriter2.jsonValue("~3*D>{a7b^wt_~M");
      assertEquals("[false,~3*D>{a7b^wt_~M", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("CW&I`");
      JsonWriter jsonWriter3 = jsonWriter2.beginArray();
      jsonWriter2.endArray();
      jsonWriter2.name("CW&I`");
      jsonWriter3.beginArray();
      assertEquals("{\"CW&I`\":[],\"CW&I`\":[", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name(" v_p>w=A,Nwk%U#M!P");
      ...
      jsonWriter11.beginArray();
      assertEquals("{\" v_p>w=A,Nwk%U#M!P\":[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("?=R.]yt$O}yCi2![");
      jsonWriter1.setLenient(true);
      assertTrue(jsonWriter0.isLenient());
      
      Double double0 = new Double((-2712.721499797));
      jsonWriter1.value((Number) double0);
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("java.lang.Long@00)000002");
      assertEquals("[", stringWriter0.toString());
  ...
  public void test52()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("~B]\"rZ&O[");
      assertEquals("\"~B]\\\"rZ&O[\"", stringWriter0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(2593);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("j&Y5A9pwrX2kw|");
      // Undeclared exception!
      try { 
        jsonWriter0.name("j&Y5A9pwrX2kw|");
        fail("Expecting exception: IllegalStateException");
