...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("'eGXr'M(~AD:a1");
      assertEquals("\"'eGXr'M(~AD:a1\"", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-1458L));
      assertEquals("-1458", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) (-1458L));
      assertEquals("-1458.0", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("Lcc");
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name(":\"1$kz!<");
  ...
  public void test37()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(2270);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("!+a>[X");
  ...
  public void test38()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value((-578L));
      Boolean boolean0 = new Boolean(",-)Zl^<04");
      // Undeclared exception!
      try { 
        jsonWriter0.value(boolean0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("*HmfFq");
      jsonWriter1.value((-1427.79));
      jsonWriter0.name("*HmfFq");
      jsonWriter0.beginArray();
      assertEquals("{\"*HmfFq\":-1427.79,\"*HmfFq\":[", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.setIndent(":\"1$kz!<");
      jsonWriter1.beginArray();
      assertEquals("[\n:\"1$kz!<[", stringWriter0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("Zo8\"g6sci^=y3@q)");
      jsonWriter0.value(true);
      // Undeclared exception!
      try { 
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("zL~)Q8I,^31Wzg;oR");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test62()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("&Yx&");
      // Undeclared exception!
      try { 
        jsonWriter1.name("");
        fail("Expecting exception: IllegalStateException");
