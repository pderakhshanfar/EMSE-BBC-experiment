...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Float float0 = new Float((-502.3912307488));
  ...
  public void test11()  throws Throwable  {
      ...
      jsonWriter0.name("(ylGI'gzX?K4/7W(B0");
      Boolean boolean0 = Boolean.FALSE;
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(boolean0);
      assertEquals("{\"(ylGI'gzX?K4/7W(B0\":false", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-163L));
      assertEquals("-163", stringWriter0.toString());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("e5N\"f{=ObR5:");
      assertEquals("e5N\"f{=ObR5:", stringWriter0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter0.name("(ylGI'gzX?K4/7W(B0");
      jsonWriter0.setLenient(true);
      jsonWriter1.beginObject();
      jsonWriter2.endObject();
      assertEquals("{\"(ylGI'gzX?K4/7W(B0\":{}", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Boolean boolean0 = Boolean.valueOf("O}1R?q[Lc;s9<");
      JsonWriter jsonWriter1 = jsonWriter0.value(boolean0);
      // Undeclared exception!
      try { 
        jsonWriter1.value(3427.320111);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("e5N\"f{=ObR5:");
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("l3bgH^ri ,");
      JsonWriter jsonWriter2 = jsonWriter0.value((-1883.8384481247608));
      // Undeclared exception!
      try { 
  ...
  public void test44()  throws Throwable  {
      ...
      jsonWriter1.setLenient(true);
      jsonWriter1.value(0L);
      assertEquals("false0", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("N\\r&]F-,t/");
      assertEquals("\"N\\\\r&]F-,t/\"", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("j<V7HrL-LRYLT");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("<9KWdR");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("(^9z!V");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
  ...
  public void test62()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("OK&4$3PGI !][zj'l*");
      // Undeclared exception!
      try { 
        jsonWriter0.name("OK&4$3PGI !][zj'l*");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test65()  throws Throwable  {
      ...
      jsonWriter2.name("(ylGI'gzX?K4/7W(B0");
  ...
  public void test68()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("|Yp!Kb\"");
      jsonWriter0.beginArray();
      jsonWriter0.beginObject();
      assertEquals("[\n|Yp!Kb\"{", stringWriter0.toString());
  }
