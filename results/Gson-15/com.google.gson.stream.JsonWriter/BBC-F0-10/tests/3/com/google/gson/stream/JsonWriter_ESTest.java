...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter0.name("e.K_c2ocN![[ARl");
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("!>(!>=p1*#aLa");
      assertEquals("\"!>(!>=p1*#aLa\"", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("bp+sEIG?}n!1sLa_J/");
      assertEquals("\"bp+sEIG?}n!1sLa_J/\"", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Double double0 = new Double(414.801865);
  ...
  public void test11()  throws Throwable  {
      ...
      jsonWriter1.name("java.lang.Sh#rt@0000000002");
      Boolean boolean0 = Boolean.valueOf("}L[0>$^");
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(3642.4);
      assertEquals("3642.4", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(102.05384948897661);
      assertEquals("102.05384948897661", stringWriter0.toString());
  }
  ...
  public void test35()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(33);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("S}}-Br4ojaO=<");
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float((-816.8421F));
      JsonWriter jsonWriter1 = jsonWriter0.value((Number) float0);
      // Undeclared exception!
      try { 
        jsonWriter1.value((double) (-816.8421F));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.setIndent("java.lang.Sh#rt@0000000002");
      jsonWriter1.name("java.lang.Sh#rt@0000000002");
      assertEquals("{", stringWriter0.toString());
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("java.lag.Short@0000000004");
      // Undeclared exception!
      try { 
        jsonWriter1.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test59()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("fq4i*LB|~%f");
      // Undeclared exception!
      try { 
        jsonWriter0.value("fq4i*LB|~%f");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test60()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("'LHl^NK;>`$4`XOdy");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test68()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("bg\"p QF0Y6}^`");
      Boolean boolean0 = Boolean.TRUE;
      jsonWriter1.value(boolean0);
      assertEquals("{\"bg\\\"p QF0Y6}^`\":true", stringWriter0.toString());
  }
