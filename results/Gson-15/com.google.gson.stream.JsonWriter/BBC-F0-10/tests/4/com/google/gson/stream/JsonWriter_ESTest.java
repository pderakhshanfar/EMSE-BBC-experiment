...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("*)aq,'N2wWY\"GG^3O");
      assertEquals("\"*)aq,'N2wWY\\\"GG^3O\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("8':}ZTeLjYP}fNg=aU");
      assertEquals("\"8':}ZTeLjYP}fNg=aU\"", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-4745L));
      assertEquals("-4745", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((double) (-4745L));
      assertEquals("-4745.0", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("qs\"{A(cX,V2Y/@K>FwW");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("_r");
      assertEquals("_r", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("GPp?JWa qv*Eh~7B'x");
      assertEquals("GPp?JWa qv*Eh~7B'x", stringWriter0.toString());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("MFAC 9-!dH1s*G=");
      jsonWriter0.value((-1501.3724961075));
      jsonWriter0.endObject();
      assertEquals("{\"MFAC 9-!dH1s*G=\":-1501.3724961075}", stringWriter0.toString());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue(">mhgGJBzc$j{.6?bO ");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      jsonWriter0.beginArray();
      jsonWriter0.value("<");
      jsonWriter0.jsonValue("+|#CL\"a vEU0K");
      assertEquals("[\"<\",+|#CL\"a vEU0K", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      jsonWriter2.value(2950L);
      assertEquals("[]2950", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("`m4KpA{#");
      JsonWriter jsonWriter1 = jsonWriter0.value((-271.5872189));
      // Undeclared exception!
      try { 
        jsonWriter1.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("qs\"{A(cX,V2Y/@K>FwW");
      // Undeclared exception!
      try { 
  ...
  public void test58()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("49(Jh^");
      // Undeclared exception!
      try { 
        jsonWriter1.name("49(Jh^");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test60()  throws Throwable  {
      ...
      JsonWriter jsonWriter16 = jsonWriter10.name("MRACu 9-!dH1s*G=");
      ...
      JsonWriter jsonWriter19 = jsonWriter11.name("MRACu 9-!dH1s*G=");
      jsonWriter19.beginArray();
      jsonWriter18.beginArray();
      jsonWriter12.beginObject();
      jsonWriter17.name("MRACu 9-!dH1s*G=");
      jsonWriter10.beginObject();
      jsonWriter18.name("MRACu 9-!dH1s*G=");
      jsonWriter6.beginArray();
      jsonWriter14.beginArray();
      jsonWriter7.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[[[{\"MRACu 9-!dH1s*G=\":[[[[{\"MRACu 9-!dH1s*G=\":[[{\"MRACu 9-!dH1s*G=\":{\"MRACu 9-!dH1s*G=\":[[[", stringWriter0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("d7TN?lE,S?P-E");
      jsonWriter2.value(3517L);
      jsonWriter2.name("d7TN?lE,S?P-E");
      jsonWriter2.beginObject();
      assertEquals("{\"d7TN?lE,S?P-E\":3517,\"d7TN?lE,S?P-E\":{", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test71()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Double double0 = Double.valueOf((-2620.1629));
