...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter1.name("M|31OS6q0%>;iUM?,F^");
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("9|I[m'Za|M;qcP");
      assertEquals("\"9|I[m'Za|M;qcP\"", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("P$d~#wXVOaq{&#aIM");
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("M|31OS6q0%>;iUM?,F^");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test27()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(2846);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("Ln0gD =uM:,XVU");
      jsonWriter2.jsonValue("Ln0gD =uM:,XVU");
      jsonWriter1.setHtmlSafe(true);
      jsonWriter0.endObject();
      assertEquals("{\"Ln0gD =uM:,XVU\":Ln0gD =uM:,XVU}", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test40()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(2846);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("Ln0gD =uM:,XVU");
      // Undeclared exception!
      try { 
        jsonWriter0.value((double) 2846);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("Ln0gD =uM:,XVU");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("Ln0gD =uM:,XVU");
      JsonWriter jsonWriter2 = jsonWriter1.value((double) 2846);
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value("Qk{");
      assertEquals("[\"Qk{\"", stringWriter0.toString());
  ...
  public void test46()  throws Throwable  {
      ...
      assertEquals("falseb", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("Ln0gD =uM:,XVU");
      JsonWriter jsonWriter3 = jsonWriter2.jsonValue("Ln0gD =uM:,XVU");
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.value("n(6Sk\t!$ wwh");
  ...
  public void test50()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.value(3143.77);
      jsonWriter2.name("'Q>:)C:$");
      jsonWriter1.beginObject();
      assertEquals("{\"'Q>:)C:$\":3143.77,\"'Q>:)C:$\":{", stringWriter0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("Qk{");
      jsonWriter1.value("Qk{");
      assertEquals("[\nQk{\"Qk{\"", stringWriter0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value("Adt7uSitj?3vR*O");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test64()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("RQQ=<Cnf:9hN}ESI.");
        fail("Expecting exception: IllegalStateException");
