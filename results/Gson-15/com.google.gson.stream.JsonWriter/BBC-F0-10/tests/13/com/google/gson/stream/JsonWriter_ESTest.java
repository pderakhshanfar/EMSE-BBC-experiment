...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("rfaa!/*x(");
      jsonWriter1.value(true);
      assertTrue(jsonWriter0.isHtmlSafe());
      assertEquals("{\"rfaa!/*x(\":true", stringWriter0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.value("java.lang.Fl`at@000r000002");
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(")X}8a N7$");
      assertEquals("\")X}8a N7$\"", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      jsonWriter1.value(5491L);
      assertEquals("[{},5491", stringWriter0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      jsonWriter1.name("~");
      jsonWriter0.value((-2738.162578));
      jsonWriter1.endObject();
      assertEquals("{\"~\":-2738.162578}", stringWriter0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.setLenient(true);
      jsonWriter0.name("SU?\"%5KfA.y]KvD\" f");
      jsonWriter0.beginObject();
      assertEquals("{\"SU?\\\"%5KfA.y]KvD\\\" f\":{", stringWriter0.toString());
  }
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(5145);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test38()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-677L));
      // Undeclared exception!
      try { 
        jsonWriter1.value(true);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      jsonWriter0.value(495.70168);
      assertEquals("null495.70168", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("rfaa!/*x(");
      JsonWriter jsonWriter2 = jsonWriter1.value((long) 18);
      JsonWriter jsonWriter3 = jsonWriter2.name("%kc");
      jsonWriter3.beginObject();
      assertEquals("{\"rfaa!/*x(\":18,\"%kc\":{", stringWriter0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(3813);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value(696.3077129721213);
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter0.value("#Nkz\"r/jPT-~T3bC");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test62()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("");
      jsonWriter1.value("\"FVpf_.BvsrlDK\"");
      assertEquals("{\"\":\"\\\"FVpf_.BvsrlDK\\\"\"", stringWriter0.toString());
  }
  ...
  public void test69()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("( ^aY3IB3qSkU");
      assertEquals("\"( ^aY3IB3qSkU\"", stringWriter0.toString());
  }
}
