...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("!HO[P:W|C7E>{^OK;\"");
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Boolean boolean0 = new Boolean("G7{ yXpv7");
      jsonWriter0.value(boolean0);
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((double) (byte)23);
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-2094.211290978415));
      assertEquals("-2094.211290978415", stringWriter0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("7*],\"|>U/0");
      assertEquals("7*],\"|>U/0", stringWriter0.toString());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter2.value(2710.4173817508645);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test43()  throws Throwable  {
      ...
      jsonWriter0.endArray();
      jsonWriter0.setLenient(true);
      jsonWriter1.value((-2094.211290978415));
      assertEquals("[]-2094.211290978415", stringWriter0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("*(DN@;@[RzbJ|Z");
      // Undeclared exception!
      try { 
        jsonWriter1.name("*(DN@;@[RzbJ|Z");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test64()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(413);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("*(DN@;@[RzbJ|Z");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.beginArray();
