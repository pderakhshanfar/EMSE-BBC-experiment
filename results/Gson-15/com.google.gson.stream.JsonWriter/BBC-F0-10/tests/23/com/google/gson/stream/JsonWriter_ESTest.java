...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter1.name("_eV.2hm1U DXU;f6=");
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("C12;REcg[u`%6(");
      assertEquals("\"C12;REcg[u`%6(\"", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Boolean boolean0 = new Boolean("%pYK;#C[?$W.8");
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(1263.4464563969);
      assertEquals("1263.4464563969", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(1670.144271057267);
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("fu1{/30N3");
      assertEquals("fu1{/30N3", stringWriter0.toString());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      jsonWriter0.name(" $U]exYp{1N0X#9/!");
      jsonWriter0.value(boolean0);
      // Undeclared exception!
      try { 
        jsonWriter0.beginObject();
  ...
  public void test40()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("`DKmB)ll;r7_`#C");
      jsonWriter1.setLenient(true);
      jsonWriter0.beginArray();
      assertEquals("\"`DKmB)ll;r7_`#C\"[", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("(8#vJ8B,.SE=B");
  ...
  public void test43()  throws Throwable  {
      ...
      jsonWriter0.value("C12;REcg[u`%6(");
      jsonWriter0.jsonValue("fu1{/30N3");
      assertEquals("[\"C12;REcg[u`%6(\",fu1{/30N3", stringWriter0.toString());
  }
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value(":YDBM~\fvj\n");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter0.name(":YDBM~\fvj\n");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.name("VI6}t)TP%Pz1yC");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test72()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("dI,MTamT42$J%kZ'Qt(");
