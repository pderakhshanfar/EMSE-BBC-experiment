...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("lAV[!1");
      assertEquals("\"lAV[!1\"", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      jsonWriter0.setLenient(true);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("GG{nKfS3j+/C.Kv");
      Boolean boolean0 = new Boolean("qrXYPaB{^P/2");
      ...
      jsonWriter2.value((-2396.82706));
      assertTrue(jsonWriter1.isHtmlSafe());
      assertEquals("{\"GG{nKfS3j+/C.Kv\":false}-2396.82706", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("m*x");
      assertEquals("m*x", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test32()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("$P(DOVV%6nc p:NWl");
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("7rTJ]Ed't");
      jsonWriter2.beginObject();
      assertEquals("{\"7rTJ]Ed't\":{", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("qrXYPaB{^P/2");
      JsonWriter jsonWriter2 = jsonWriter1.value(boolean0);
      jsonWriter2.name("GG{nKfS3j+/C.Kv");
      jsonWriter2.value((-2396.82706));
      assertEquals("{\"GG{nKfS3j+/C.Kv\":false,\"GG{nKfS3j+/C.Kv\":-2396.82706", stringWriter0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("R>H1RzHU;");
      // Undeclared exception!
      try { 
        jsonWriter0.name("/(f7-IQwx_)");
        fail("Expecting exception: IllegalStateException");
