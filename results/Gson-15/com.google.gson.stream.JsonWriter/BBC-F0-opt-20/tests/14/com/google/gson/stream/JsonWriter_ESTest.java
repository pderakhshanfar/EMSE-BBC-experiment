...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("~WbN~6btO-F");
      assertEquals("\"~WbN~6btO-F\"", stringWriter0.toString());
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(2190L);
      assertEquals("2190", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(3575.3626834753422);
      assertEquals("3575.3626834753422", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-2156.16855200296));
      assertEquals("-2156.16855200296", stringWriter0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name(" 2n(oz3J o");
      jsonWriter2.nullValue();
      assertEquals("{\" 2n(oz3J o\":null", stringWriter0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name(")i't*%|vO");
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("Yf");
      assertEquals("Yf", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue(",g5T");
      assertEquals(",g5T", stringWriter0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("IQeu6R1/I2S_LS");
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value(3575.3626834753422);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test38()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(3231L);
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("U`<w mf L");
      Boolean boolean0 = new Boolean(true);
  ...
  public void test40()  throws Throwable  {
      ...
      assertEquals("[true,name == null", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.value("}\"[M<H]{HLDmBb");
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("=] 'T{m`tFm~*Ri");
      JsonWriter jsonWriter3 = jsonWriter2.value(true);
      // Undeclared exception!
      try { 
        jsonWriter3.value((-3845L));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      ...
      jsonWriter3.name("^d2Su4*9_=P>egW(");
      jsonWriter3.beginArray();
      assertEquals("{\" 2n(oz3J o\":null,\"^d2Su4*9_=P>egW(\":[", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("~VE1+l]=cc}pH7");
      jsonWriter1.close();
      jsonWriter1.close();
      assertEquals("\"~VE1+l]=cc}pH7\"", stringWriter0.toString());
  }
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("+[A|sw3*u~1XUXj");
  ...
  public void test60()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.name("~VE1+l]=cc}pH7");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("H1`*og");
      // Undeclared exception!
      try { 
        jsonWriter1.name("H1`*og");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test67()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.jsonValue("N!l)KI");
      jsonWriter2.endArray();
      assertEquals("[N!l)KI]", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test70()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(3644);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.isLenient();
      assertTrue(jsonWriter0.getSerializeNulls());
  }
