...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        jsonWriter2.value("R)Pr2{`]94'-J;x");
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(",ME5[yj]@0dQ!4");
      assertEquals("\",ME5[yj]@0dQ!4\"", stringWriter0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Float float0 = new Float(470.1214);
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-1086L));
      assertEquals("-1086", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((double) (-1086L));
      assertEquals("-1086.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(868.0347725638305);
      assertEquals("868.0347725638305", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("\"hv'-u*(MAAbrK5J?,");
      assertFalse(jsonWriter1.getSerializeNulls());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("ddS");
      assertEquals("ddS", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("-a,e");
      assertEquals("-a,e", stringWriter0.toString());
  }
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("xkL/sq\rQ");
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.endArray();
      Boolean boolean0 = new Boolean("V'4Y[rjjw");
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Double double0 = new Double(1401.54234453482);
      jsonWriter0.value((Number) double0);
      // Undeclared exception!
      try { 
        jsonWriter0.value(59.5);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      String string0 = "\\u003u";
      jsonWriter0.value(string0);
      assertEquals("\"\\\\u003u\"", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      assertEquals("0.00", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("iGwx]#]d]r\u0005pZ><z");
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value("iGwx]#]d]r\u0005pZ><z");
      jsonWriter2.beginObject();
      assertEquals("[\"iGwx]#]d]r\\u0005pZ><z\",{", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("]_w`");
      assertEquals("{", stringWriter0.toString());
      
      Double double0 = new Double(0.0);
      JsonWriter jsonWriter3 = jsonWriter2.value((Number) double0);
      JsonWriter jsonWriter4 = jsonWriter3.name(",&7Nj`");
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.setIndent("rx<");
      jsonWriter1.value("");
      assertEquals("[\nrx<\"\"", stringWriter0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.jsonValue("Wue'zEQ0<gEpX/");
      jsonWriter0.close();
      jsonWriter0.close();
      assertEquals("Wue'zEQ0<gEpX/", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("FWue'zEQ0N<gEpX/");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.flush();
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(623.4);
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("r7WB5X>J+`<");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test63()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("Wue'zEQ0<gEpX/");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
  ...
  public void test64()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Dangling name: java.lang.Double@0000000003
         //
         verifyException("com.google.gson.stream.JsonWriter", e);
      }
  }
