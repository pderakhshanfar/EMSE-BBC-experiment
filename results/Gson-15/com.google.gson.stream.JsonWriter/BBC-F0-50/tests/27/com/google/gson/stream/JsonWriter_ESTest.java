...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("S\u0001humRyY~L4(p%N");
      assertEquals("\"S\\u0001humRyY~L4(p%N\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Float float0 = new Float(2193.43035065);
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) (-936L));
      assertEquals("-936.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-221.45131764390288));
      assertEquals("-221.45131764390288", stringWriter0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("NC}@2U5ED$1cD`)_+c");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("d*-2kW58");
      jsonWriter2.beginObject();
      // Undeclared exception!
      try { 
        jsonWriter0.beginArray();
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value(3461L);
      jsonWriter1.beginObject();
      assertEquals("[3461,{", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      String string0 = "\\u00ve";
      jsonWriter0.value(string0);
      assertEquals("null\"\\\\u00ve\"", stringWriter0.toString());
  }
  ...
  public void test50()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter0.name("NM)U8k");
      jsonWriter2.nullValue();
      jsonWriter1.name("NM)U8k");
      jsonWriter0.beginArray();
      assertEquals("{\"NM)U8k\":null,\"NM)U8k\":[", stringWriter0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("cE>6_7:bl5Va!j");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("@<Bkp7`mUh(1");
      // Undeclared exception!
      try { 
  ...
  public void test63()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("~!(I{bOdN3U(oX{^^H");
      // Undeclared exception!
      try { 
        jsonWriter0.name("~!(I{bOdN3U(oX{^^H");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test74()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.value((-17L));
      jsonWriter1.endArray();
  ...
  public void test76()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("`^& !:{f_`*9r");
