...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(6243);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-1060L));
      assertEquals("-1060", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((long) 278);
      assertEquals("278", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.name("MDwQtyk9bmk[=v>");
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals("{\":)Xl4_MaG\":Nesting problem.", stringWriter0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      jsonWriter0.jsonValue("");
      assertEquals("{\":)Xl4_MaG\":", stringWriter0.toString());
  }
  ...
  public void test38()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("#tatY42|-k");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("#tatY42|-k");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      jsonWriter1.setIndent("*~Cu-e ]");
      jsonWriter0.name("*~Cu-e ]");
      jsonWriter0.beginObject();
      assertEquals("{\"\":0.0,\n*~Cu-e ]\"*~Cu-e ]\": {", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("w!})!NhKEUCoNX+\"");
      jsonWriter1.beginArray();
      assertEquals("{\"w!})!NhKEUCoNX+\\\"\":[", stringWriter0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(1121);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("zK:O B<3% !+:8");
      // Undeclared exception!
      try { 
        jsonWriter0.name("`IrvrgAg`^%`rD\"");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test59()  throws Throwable  {
      ...
      JsonWriter jsonWriter10 = jsonWriter6.name("L@%;Mb{c*N!%A+");
      ...
      jsonWriter0.beginObject();
      JsonWriter jsonWriter16 = jsonWriter6.name("L@%;Mb{c*N!%A+");
      jsonWriter16.beginArray();
      JsonWriter jsonWriter17 = jsonWriter16.beginArray();
      jsonWriter10.beginObject();
      jsonWriter17.name("L@%;Mb{c*N!%A+");
      jsonWriter11.beginArray();
      jsonWriter6.beginArray();
      assertEquals("[[[[[[[[[[[{\"L@%;Mb{c*N!%A+\":[[[[[[[[[[[[[[{\"L@%;Mb{c*N!%A+\":[[{\"L@%;Mb{c*N!%A+\":[[", stringWriter0.toString());
  }
