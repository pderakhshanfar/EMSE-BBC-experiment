...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("$Z\"_BAjV,H*~");
      assertEquals("\"$Z\\\"_BAjV,H*~\"", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      jsonWriter0.endObject();
      jsonWriter0.value((-3490.664628486));
      assertEquals("{}-3490.664628486", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      jsonWriter1.name("{4:m");
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-264.0859684500095));
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("}`)}JIW>P=DS=:~}H");
      assertEquals("}`)}JIW>P=DS=:~}H", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("MWmBt9");
      assertEquals("MWmBt9", stringWriter0.toString());
  }
  ...
  public void test32()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("{4:m");
      jsonWriter0.setHtmlSafe(true);
  ...
  public void test37()  throws Throwable  {
      ...
      Float float0 = new Float((-1939.6628694645804));
      // Undeclared exception!
      try { 
  ...
  public void test65()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("LbJ~Zf");
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value((-1900L));
      assertEquals("[\nLbJ~Zf-1900", stringWriter0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.value("$Z\"_BAjV,H*~");
      jsonWriter1.endArray();
      assertEquals("[\"$Z\\\"_BAjV,H*~\"]", stringWriter0.toString());
  }
  ...
  public void test73()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Float float0 = new Float(2230.9973F);
