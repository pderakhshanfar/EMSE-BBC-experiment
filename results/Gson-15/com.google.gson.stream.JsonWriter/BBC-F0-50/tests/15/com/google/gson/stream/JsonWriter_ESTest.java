...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      jsonWriter0.value("$8{bfBkcc92AEOpiT");
      assertEquals("\"$8{bfBkcc92AEOpiT\"", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      jsonWriter0.name("xHPr&V\"A#RN");
      jsonWriter1.setHtmlSafe(true);
      jsonWriter0.value(boolean0);
      assertEquals("{\"xHPr\\u0026V\\\"A#RN\":false", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Boolean boolean0 = new Boolean("\"iT!nxN~FRg");
      jsonWriter0.value(boolean0);
      assertEquals("false", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.setHtmlSafe(true);
      JsonWriter jsonWriter2 = jsonWriter1.name("!%JMz}Z5x|yg");
      jsonWriter2.value((-1087L));
      assertTrue(jsonWriter1.isHtmlSafe());
      assertEquals("{\"!%JMz}Z5x|yg\":-1087", stringWriter0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-2312.58));
      assertEquals("-2312.58", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("Q_L{3T^aApb>;X");
      assertEquals("Q_L{3T^aApb>;X", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("(qRwYBjz;-[x#;)=y");
      jsonWriter1.setHtmlSafe(true);
      jsonWriter1.jsonValue("(qRwYBjz;-[x#;)=y");
      assertTrue(jsonWriter1.isHtmlSafe());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.setSerializeNulls(false);
      JsonWriter jsonWriter2 = jsonWriter1.name("xHPr&V\"A#RN");
      jsonWriter2.jsonValue("xHPr&V\"A#RN");
      assertEquals("{\"xHPr&V\\\"A#RN\":xHPr&V\"A#RN", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("vu;xmG,p69");
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("vu;xmG,p69");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("xHPr&V\"A#RN");
      jsonWriter2.jsonValue("xHPr&V\"A#RN");
      assertEquals("{\n\n\"xHPr&V\\\"A#RN\": xHPr&V\"A#RN", stringWriter0.toString());
  }
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("%)\"xc{(H");
  ...
  public void test65()  throws Throwable  {
      ...
      jsonWriter2.name("QWO(QR0s3'ha0XDw");
      jsonWriter17.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[{\"QWO(QR0s3'ha0XDw\":[", stringWriter0.toString());
  }
