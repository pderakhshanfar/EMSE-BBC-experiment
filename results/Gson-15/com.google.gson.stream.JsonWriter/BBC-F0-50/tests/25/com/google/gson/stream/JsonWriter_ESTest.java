...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("qrM7e'`MwG~>Q'}Q<#");
      // Undeclared exception!
      try { 
        jsonWriter2.value((long) 40);
  ...
  public void test05()  throws Throwable  {
      ...
      jsonWriter0.value("n\".OZ|eB\".$p%rU(R");
      assertEquals("\"n\\\".OZ|eB\\\".$p%rU(R\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Double double0 = new Double(4099.06763020968);
  ...
  public void test09()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(4725);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Boolean boolean0 = new Boolean("Yen1l/3|iUB$");
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("xQX)R2vnR");
      assertEquals("xQX)R2vnR", stringWriter0.toString());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value("FD@S\"~;D_fc8p(C=9");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("!5hZzVV@C1");
  ...
  public void test38()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("6`z6%/h(<Lt9u8Pg");
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("9{4L\"du'");
      JsonWriter jsonWriter3 = jsonWriter2.jsonValue("|Hwx]");
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("MH&o1=_,i*]");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.value("@H)s:H\"10E[a");
      jsonWriter0.jsonValue("tS");
      assertEquals("[\"@H)s:H\\\"10E[a\",tS", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("e7I_?9#XG");
      jsonWriter0.nullValue();
      // Undeclared exception!
      try { 
        jsonWriter1.beginObject();
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("e7I_?9#XG");
      jsonWriter0.nullValue();
      jsonWriter1.name("e7I_?9#XG");
      jsonWriter1.beginObject();
      assertEquals("{\"e7I_?9#XG\":null,\"e7I_?9#XG\":{", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("7'wsQypY");
      jsonWriter0.beginArray();
      jsonWriter0.nullValue();
      assertEquals("[\n7'wsQypYnull", stringWriter0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value((-1892L));
      jsonWriter0.close();
      jsonWriter0.close();
      assertEquals("-1892", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-1892L));
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test58()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Boolean boolean0 = Boolean.valueOf("boB[_q0&SH`Ki5");
      jsonWriter0.value(boolean0);
      jsonWriter0.setLenient(true);
      jsonWriter0.nullValue();
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("E_-L*@ttJ");
      // Undeclared exception!
      try { 
        jsonWriter1.beginArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test63()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.name("/@XaXq:&0J[yt@lv");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test65()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.name("\"bToXJn:7Z[e4OD");
      // Undeclared exception!
      try { 
        jsonWriter1.endArray();
        fail("Expecting exception: IllegalStateException");
