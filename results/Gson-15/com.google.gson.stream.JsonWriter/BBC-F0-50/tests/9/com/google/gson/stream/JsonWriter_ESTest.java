...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("^}x:-AB3");
  ...
  public void test02()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("!E`[}=Tb'p~X-1b*8");
      jsonWriter1.value(true);
      assertEquals("{\"!E`[}=Tb'p~X-1b*8\":true", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("+hb<");
      assertEquals("\"+hb<\"", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(121L);
      assertEquals("121", stringWriter0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      jsonWriter0.name("!E`[}=Tb'p~X-1b*8");
      jsonWriter1.nullValue();
      assertEquals("{\"!E`[}=Tb'p~X-1b*8\":null", stringWriter0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      jsonWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("Zo=VX2(g|&)Jc|");
      jsonWriter0.beginObject();
      jsonWriter1.endObject();
      assertTrue(jsonWriter0.isHtmlSafe());
      assertEquals("{\"Zo\\u003dVX2(g|\\u0026)Jc|\":{}", stringWriter0.toString());
  }
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("Zd dp");
      // Undeclared exception!
      try { 
        jsonWriter1.value(372L);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("-h6~6jmx]32");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("cv r");
      jsonWriter0.beginArray();
      jsonWriter1.endArray();
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("&<VP5{l[");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.value((Boolean) null);
  ...
  public void test44()  throws Throwable  {
      ...
      assertEquals("{\"\":true,\"VW\":null", stringWriter0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter0.name("!E`[}=Tb'p~X-1b*8");
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("Beq#W]@c[3bNJ1N^");
      // Undeclared exception!
      try { 
        jsonWriter1.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("%bjdsbqGx|7$]/");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("\u0004:LgS;j$)p;8Kr\"\"");
      assertEquals("\"\\u0004:LgS;j$)p;8Kr\\\"\\\"\"", stringWriter0.toString());
  }
