...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter1.name("D3JgvRjXjG'/=Q|s&");
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("Hu_V5$TlGypT#c");
      assertEquals("\"Hu_V5$TlGypT#c\"", stringWriter0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float((float) 3513);
      jsonWriter0.setHtmlSafe(true);
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Float float0 = new Float(3008.872703);
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-1396.9150738926));
      assertEquals("-1396.9150738926", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("Srf~y,f'YuuAf,");
  ...
  public void test41()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("w:~9Rug1*opC\"N");
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("w:~9Rug1*opC\"N");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test50()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent("uhkQ--'");
      jsonWriter0.beginObject();
      assertEquals("[\nuhkQ--'{", stringWriter0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("N>f+W");
      assertEquals("\"N\\u003ef+W\"", stringWriter0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("KL/g!9+(WX$N");
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("e^H8K#2eDRDy*))!u*B");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("XU6bCGUr'TUWA");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test62()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("11Q$4rpo4lP+3EFS");
      // Undeclared exception!
      try { 
        jsonWriter0.name("11Q$4rpo4lP+3EFS");
        fail("Expecting exception: IllegalStateException");
