...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test67()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("`}:K#1cI>=X]#n");
      JsonWriter jsonWriter3 = jsonWriter2.value("`}:K#1cI>=X]#n");
      JsonWriter jsonWriter4 = jsonWriter3.name("kJD{Npd)OZYhh{?Ow");
      jsonWriter3.nullValue();
      jsonWriter4.endObject();
      assertEquals("{\"`}:K#1cI>=X]#n\":\"`}:K#1cI>=X]#n\",\"kJD{Npd)OZYhh{?Ow\":null}", stringWriter0.toString());
  }
