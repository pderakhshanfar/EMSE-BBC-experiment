...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Float float0 = new Float(4533.0215F);
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Boolean boolean0 = new Boolean("XKx");
      jsonWriter0.value(boolean0);
      assertEquals("false", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-4257.113322));
      assertEquals("-4257.113322", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(624.8860256512033);
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("U#dJ}0?)X");
      // Undeclared exception!
      try { 
        jsonWriter0.value("U#dJ}0?)X");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test39()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-942L));
      // Undeclared exception!
      try { 
        jsonWriter1.value((-942L));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value(390.949464049);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("");
      jsonWriter2.value("");
      JsonWriter jsonWriter3 = jsonWriter1.name("In}finity");
      jsonWriter3.value("In}finity");
      // Undeclared exception!
      try { 
        jsonWriter1.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter16 = jsonWriter11.name("NaN");
  ...
  public void test50()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("\"MDu]%j|W'0:tM\f}Q{");
      assertEquals("\"\\\"MDu]%j|W'0:tM\\f}Q{\"", stringWriter0.toString());
  }
