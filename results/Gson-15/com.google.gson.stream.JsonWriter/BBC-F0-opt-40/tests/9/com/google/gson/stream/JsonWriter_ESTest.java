...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(1157);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Float float0 = new Float((float) (-1073L));
  ...
  public void test09()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(2945);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Boolean boolean0 = new Boolean("java.lang.Double@0000000002");
      jsonWriter0.value(boolean0);
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals("-803", stringWriter0.toString());
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((long) (short)366);
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) 1157);
      assertEquals("1157.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((double) (-803L));
      assertEquals("-803.0", stringWriter0.toString());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("X>*R}RL=(h#dla^Rc1");
      assertEquals("X>*R}RL=(h#dla^Rc1", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("ez,");
      assertEquals("ez,", stringWriter0.toString());
  }
  ...
  public void test37()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(1157);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("07Bs{0}*zD_ OL");
      // Undeclared exception!
      try { 
        jsonWriter0.value((Boolean) null);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test38()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value(815.358368411117);
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("G{=&GN/\"$");
      jsonWriter2.beginObject();
      jsonWriter0.name("G{=&GN/\"$");
      jsonWriter0.nullValue();
      JsonWriter jsonWriter3 = jsonWriter0.name("G{=&GN/\"$");
      jsonWriter3.beginArray();
      assertEquals("{\"G{=&GN/\\\"$\":{\"G{=&GN/\\\"$\":null,\"G{=&GN/\\\"$\":[", stringWriter0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("Al");
  ...
  public void test67()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("f}lse");
      jsonWriter0.beginArray();
      jsonWriter0.value("f}lse");
      assertEquals("[\nf}lse\"f}lse\"", stringWriter0.toString());
  }
