...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter0.name("ylfL");
      // Undeclared exception!
      try { 
        jsonWriter1.value(3782L);
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Boolean boolean0 = Boolean.valueOf("Hwd_aM'|}");
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-1651L));
      assertEquals("-1651", stringWriter0.toString());
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(894.9951416);
      assertEquals("894.9951416", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("t/b^@ VFvM@[9rMkV4U");
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("m{?8/^t(s(7j");
      assertFalse(jsonWriter1.isLenient());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      jsonWriter0.setLenient(true);
      jsonWriter0.endObject();
      JsonWriter jsonWriter1 = jsonWriter0.value((-1994.7552706333));
  ...
  public void test33()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      Double double0 = new Double((-534.615500576));
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      // Undeclared exception!
      try { 
  ...
  public void test34()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(1702.83);
      Boolean boolean0 = new Boolean("p4#[[jV`Ix*~nm");
      // Undeclared exception!
      try { 
        jsonWriter1.value(boolean0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("H$ZS'w2JE}Km5At=");
      jsonWriter2.beginObject();
      assertEquals("{\"H$ZS'w2JE}Km5At=\":{", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("t*u?(+]R|5gB");
      JsonWriter jsonWriter3 = jsonWriter2.value("X%cH^'E]{Q");
      // Undeclared exception!
      try { 
        jsonWriter3.value((-2469.56));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("t*u?(+]R|5gB");
      jsonWriter2.value("X%cH^'E]{Q");
      JsonWriter jsonWriter3 = jsonWriter1.name("t*u?(+]R|5gB");
      jsonWriter3.value((-2469.56));
      assertEquals("{\"t*u?(+]R|5gB\":\"X%cH^'E]{Q\",\"t*u?(+]R|5gB\":-2469.56", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("8|h`wU~kAW-5)+oIBa^");
      jsonWriter0.beginObject();
      assertEquals("[\n8|h`wU~kAW-5)+oIBa^{", stringWriter0.toString());
  }
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("S=G1sqQ(3");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("t*u?(+]R|5gB");
      // Undeclared exception!
      try { 
        jsonWriter1.value("X%cH^'E]{Q");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test64()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("B<;Xlq1~M=LI");
      // Undeclared exception!
      try { 
        jsonWriter1.endObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test73()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Integer integer0 = Integer.getInteger("/O;pkS9{,o", 11);
  ...
  public void test74()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("7<-r|n7b^,k1");
      assertEquals("7<-r|n7b^,k1", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
}
