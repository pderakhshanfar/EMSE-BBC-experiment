...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("0b%f14R.>oB#cXkpiE");
      assertEquals("\"0b%f14R.>oB#cXkpiE\"", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-4302L));
      assertEquals("-4302", stringWriter0.toString());
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(3484.2742008955);
      assertEquals("3484.2742008955", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("]s#wn0.");
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(1982L);
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("OZZu-\"#^ kN+k|h'");
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value((-1798.80606473));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-372L));
      // Undeclared exception!
      try { 
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("\b");
      JsonWriter jsonWriter2 = jsonWriter1.value((-4162.348));
      jsonWriter2.name("\b");
      assertEquals("{\"\\b\":-4162.348", stringWriter0.toString());
  ...
  public void test50()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent("javaP!ang.Intege!@0000000002");
      jsonWriter0.value("javaP!ang.Intege!@0000000002");
      assertEquals("[\njavaP!ang.Intege!@0000000002\"javaP!ang.Intege!@0000000002\"", stringWriter0.toString());
  }
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("G7#_YWK|U__nfg:Wz,");
      // Undeclared exception!
      try { 
        jsonWriter0.name(".wY|;K!R");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test75()  throws Throwable  {
      ...
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("javaP!ang.Intege!@0000000002");
      assertEquals("\"javaP!ang.Intege!@0000000002\"", stringWriter0.toString());
  }
}
