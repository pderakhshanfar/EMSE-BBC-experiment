...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("'cHexo9Oo~");
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("q\"(K%boa%@'a");
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("Ik(uas}K]1sq");
      assertEquals("\"Ik(uas}K]1sq\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Float float0 = new Float(1270.251F);
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Integer integer0 = Integer.getInteger("\"'", 29);
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-4069L));
      assertEquals("-4069", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((long) 29);
      assertEquals("29", stringWriter0.toString());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("R40{8@oHNxzryT_");
      assertEquals("R40{8@oHNxzryT_", stringWriter0.toString());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter2.jsonValue("I0\"`F~4\"~K-1");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.nullValue();
      jsonWriter1.jsonValue("8F=4e<8C1iN^`z0HA");
      assertEquals("[null,8F=4e<8C1iN^`z0HA", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("?'vfA");
      JsonWriter jsonWriter3 = jsonWriter2.value(578L);
      jsonWriter3.name("xb^:vvuO%J2_U52");
      assertEquals("{\"?'vfA\":578", stringWriter0.toString());
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("Ik(uas}K]1sq");
      jsonWriter1.value("Ik(uas}K]1sq");
      assertEquals("[\nIk(uas}K]1sq\"Ik(uas}K]1sq\"", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("SC=BuO");
      jsonWriter1.beginObject();
      assertEquals("{\"SC=BuO\":{", stringWriter0.toString());
  }
  ...
  public void test51()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value((-1546.7883376));
      jsonWriter0.close();
      jsonWriter0.close();
      assertEquals("-1546.7883376", stringWriter0.toString());
  }
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-1546.7883376));
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float(925.4754);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((Number) float0);
  ...
  public void test63()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("aCWf");
      // Undeclared exception!
      try { 
        jsonWriter1.name("aCWf");
        fail("Expecting exception: IllegalStateException");
