...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("W/(}_jMBe*%f!f#7N");
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Boolean boolean0 = Boolean.valueOf("H*5");
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((long) (byte)102);
      assertEquals("102", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("0>X:g");
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("W/(}_jMBe*%f!f#7N");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("x^#~m");
      assertEquals("x^#~m", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-1143.3506437868912));
      // Undeclared exception!
      try { 
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.value("W/(}_jMBe*%f!f#7N");
      jsonWriter0.beginObject();
      assertEquals("[\"W/(}_jMBe*%f!f#7N\",{", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value((-2866.63391595));
      // Undeclared exception!
      try { 
        jsonWriter0.beginArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("0>X:g");
      jsonWriter2.value("");
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter0.name("=?gQb+a8u`nlt");
      jsonWriter2.value("=?gQb+a8u`nlt");
      jsonWriter0.name("=?gQb+a8u`nlt");
      jsonWriter1.beginObject();
      assertEquals("{\"=?gQb+a8u`nlt\":\"=?gQb+a8u`nlt\",\"=?gQb+a8u`nlt\":{", stringWriter0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("m.(ECg^");
      // Undeclared exception!
      try { 
  ...
  public void test59()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(2085);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("9ikwCnt\"; =(>");
      assertEquals("\"9ikwCnt\\\"; =(>\"", stringWriter0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Boolean boolean0 = new Boolean("E1j:5=}(@94{");
      JsonWriter jsonWriter1 = jsonWriter0.value(boolean0);
      jsonWriter1.close();
      // Undeclared exception!
      try { 
  ...
  public void test67()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("7=w+|EA`b)");
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.beginObject();
      assertEquals("[\n7=w+|EA`b){", stringWriter0.toString());
  }
  ...
  public void test74()  throws Throwable  {
      ...
      assertEquals("527", stringWriter0.toString());
  }
  ...
  public void test75()  throws Throwable  {
      ...
      jsonWriter0.value((-2866.63391595));
      jsonWriter0.beginArray();
      assertEquals("-2866.63391595[", stringWriter0.toString());
  }
