...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value(",(B9SE2<1Y\u0007tJ");
      assertEquals("\",(B9SE2<1Y\\u0007tJ\"", stringWriter0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      jsonWriter0.value("iaMv>A*9B y");
      assertEquals("\"iaMv>A*9B y\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Boolean boolean0 = Boolean.valueOf("/4.c^-t9wtQ9?");
      jsonWriter0.value(boolean0);
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(259L);
      assertEquals("259", stringWriter0.toString());
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-148L));
      assertEquals("-148", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(373.401);
      assertEquals("373.401", stringWriter0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(57.01149246785494);
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(306.17450754581836);
      assertEquals("306.17450754581836", stringWriter0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("VU;e ,;`r(i!@");
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("5ec{pEX6~R$NTP");
  ...
  public void test41()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-3459L));
  ...
  public void test44()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(1504L);
      // Undeclared exception!
      try { 
  ...
  public void test51()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("S#@.9m/Y8 0'X");
      jsonWriter0.beginArray();
      assertEquals("[\nS#@.9m/Y8 0'X[", stringWriter0.toString());
  }
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(564);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      try { 
        jsonWriter0.close();
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(1584L);
      jsonWriter1.close();
      jsonWriter0.close();
      assertEquals("1584", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value(1157.339664297);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test66()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(1266);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("I$fb 7U^g0=)");
      // Undeclared exception!
      try { 
        jsonWriter1.name("|");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test68()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("bqPhTyIYj1>4#~dnM");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.nullValue();
  ...
  public void test72()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("1^!lu[sck");
      jsonWriter2.nullValue();
      jsonWriter0.name("1^!lu[sck");
      Boolean boolean0 = new Boolean("");
      jsonWriter2.value(boolean0);
      jsonWriter0.name("");
      jsonWriter0.beginArray();
      assertEquals("{\"1^!lu[sck\":null,\"1^!lu[sck\":false,\"\":[", stringWriter0.toString());
  }
  ...
  public void test78()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("bqPhTyIYj1>4#~dnM");
      assertEquals("\"bqPhTyIYj1\\u003e4#~dnM\"", stringWriter0.toString());
  }
}
