...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("3dDgga^\"Td2i\"`Q0S");
      assertEquals("\"3dDgga^\\\"Td2i\\\"`Q0S\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.name("JSON must have only one top-evl value.");
      Boolean boolean0 = Boolean.valueOf("");
      jsonWriter0.value(boolean0);
      assertEquals("{\"JSON must have only one top-evl value.\":false", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter0.name("{V)0%!}gfh&$7#e.:");
      jsonWriter2.value(166L);
      assertEquals("{\"{V)0%!}gfh&$7#e.:\":166", stringWriter0.toString());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.name("E|djqo)g;'Vu~ZS):w");
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      jsonWriter1.setSerializeNulls(false);
      jsonWriter0.name("JSON must have only one top-evl value.");
      jsonWriter0.jsonValue("JSON must have only one top-evl value.");
      assertEquals("{\"JSON must have only one top-evl value.\":JSON must have only one top-evl value.", stringWriter0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("JSON must have only one top-evl vaue.");
      JsonWriter jsonWriter2 = jsonWriter0.beginObject();
      jsonWriter1.name("czZ2Bfxa-");
  ...
  public void test30()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("JSON must have only one top-evl vaue.");
      JsonWriter jsonWriter2 = jsonWriter1.beginObject();
      jsonWriter0.name("czZ2Bfxa-");
      jsonWriter0.beginArray();
      jsonWriter2.setLenient(true);
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.value(981.14598);
      jsonWriter2.name("Infinity");
      jsonWriter0.beginArray();
      assertEquals("{\"czZ2Bfxa-\":[],\"\":981.14598,\"Infinity\":[", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter0.beginObject();
      JsonWriter jsonWriter3 = jsonWriter1.name(" xE,<8X^} oQUd_y\"x");
      ...
      JsonWriter jsonWriter11 = jsonWriter2.name(" xE,<8X^} oQUd_y\"x");
  ...
  public void test46()  throws Throwable  {
      ...
      jsonWriter1.value("%!Mk}Va");
      assertEquals("false\"%!Mk}Va\"", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.value(" :g6M4|!m*x");
      jsonWriter1.beginObject();
      assertEquals("[\" :g6M4|!m*x\",{", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("[1!omRqt'/Mn/^g9A[J");
      jsonWriter0.beginArray();
      jsonWriter0.beginArray();
      assertEquals("[\n[1!omRqt'/Mn/^g9A[J[", stringWriter0.toString());
  }
  ...
  public void test57()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("G2|N$!sIFe@QX1&b4");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test62()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value(2572.0092504205018);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test66()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name(")BQPa.f\"9:/63-<9-4");
      jsonWriter1.beginArray();
