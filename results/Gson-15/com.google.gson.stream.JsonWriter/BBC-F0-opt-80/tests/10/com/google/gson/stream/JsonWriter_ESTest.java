...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(431);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      // Undeclared exception!
      try { 
  ...
  public void test02()  throws Throwable  {
      ...
      jsonWriter0.name("|z-0V@AIX<");
      jsonWriter0.value(true);
      assertEquals("{\"|z-0V@AIX<\":true", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value("c|zF!D;6tO^/cO$T,");
      assertEquals("\"c|zF!D;6tO^/cO$T,\"", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      jsonWriter0.setLenient(true);
      jsonWriter0.beginObject();
      jsonWriter0.name("-iNM#Gr");
      Boolean boolean0 = new Boolean(true);
      jsonWriter0.value(boolean0);
      assertEquals("{\"-iNM#Gr\":true", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("-iNM#Gr");
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(729L);
      assertEquals("729", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-3294L));
      assertEquals("-3294", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(121.66);
      assertEquals("121.66", stringWriter0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-1252.007437819));
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-1805.0));
      assertEquals("-1805.0", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name(",WGJNx!p+$l0rg4|");
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("Fm@V");
      assertEquals("Fm@V", stringWriter0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter0.name("-iNM#Gr");
      jsonWriter2.setSerializeNulls(false);
      jsonWriter0.beginObject();
      jsonWriter1.endObject();
      assertEquals("{\"-iNM#Gr\":{}", stringWriter0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("d#m8");
      // Undeclared exception!
      try { 
        jsonWriter1.value("d#m8");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test35()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      Boolean boolean0 = new Boolean("VMkQp(&Dv\"}BOw1F");
      // Undeclared exception!
      try { 
        jsonWriter0.value(boolean0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value((double) (-3203L));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.jsonValue("Y8gvX:fM+-Q");
  ...
  public void test42()  throws Throwable  {
      ...
      jsonWriter0.beginObject();
      jsonWriter0.name("|z-0V@AIX<");
      jsonWriter0.jsonValue("|z-0V@AIX<");
      // Undeclared exception!
      try { 
        jsonWriter0.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value("%vO2E*T~r9')1!l/");
      jsonWriter0.beginObject();
      assertEquals("[\"%vO2E*T~r9')1!l/\",{", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent("|z-0V@AIX<");
      jsonWriter0.beginObject();
      assertEquals("[\n|z-0V@AIX<{", stringWriter0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Long long0 = new Long((-3286L));
      JsonWriter jsonWriter1 = jsonWriter0.value((Number) long0);
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("c~m}FnS>9`WN\"9:C");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("c~m}FnS>9`WN\"9:C");
      // Undeclared exception!
      try { 
        jsonWriter0.name("c~m}FnS>9`WN\"9:C");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test58()  throws Throwable  {
      ...
      JsonWriter jsonWriter7 = jsonWriter2.beginObject();
      JsonWriter jsonWriter8 = jsonWriter6.name("7tL'");
      jsonWriter0.beginArray();
      ...
      assertEquals("[[[[[[{\"7tL'\":[[[[[[[[[[[[[[[[[[[[[[[[[", stringWriter0.toString());
  }
  ...
  public void test63()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("#d1E)#Q_1l*A'W");
      jsonWriter0.value("#d1E)#Q_1l*A'W");
      JsonWriter jsonWriter3 = jsonWriter2.name("~Rv\".Ed;&J9--m+\"YV@");
      jsonWriter3.value(true);
      assertEquals("{\"#d1E)#Q_1l*A'W\":\"#d1E)#Q_1l*A'W\",\"~Rv\\\".Ed;&J9--m+\\\"YV@\":true", stringWriter0.toString());
  }
