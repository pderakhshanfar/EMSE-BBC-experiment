...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter2.name("7ei?Ql_[B3:");
      // Undeclared exception!
      try { 
        jsonWriter2.jsonValue("vYw{Mbp.vVu%T!#rV+#");
  ...
  public void test04()  throws Throwable  {
      ...
      jsonWriter0.value(".skG,]Mj=WGrPi`m");
      assertEquals("\".skG,]Mj=WGrPi`m\"", stringWriter0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      jsonWriter3.name("Vdw");
      jsonWriter1.beginObject();
      Boolean boolean0 = Boolean.TRUE;
      JsonWriter jsonWriter4 = jsonWriter0.name("grSOB<X<^LW);I0oY");
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.endObject();
      jsonWriter0.setLenient(true);
      jsonWriter2.value((-2667.4248895));
      assertEquals("{}-2667.4248895", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((double) 61);
      assertEquals("61.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      jsonWriter2.value((-491.9));
      assertEquals("[{},-491.9", stringWriter0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("=ZmI@<kTMYg}-");
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("$6Y*8}<{a\"-*");
  ...
  public void test32()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(3275);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value(1016.7902106068502);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("\u0002v{u(.");
      jsonWriter0.nullValue();
      assertEquals("\"\\u0002v{u(.\"null", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      jsonWriter2.name("Vdw");
      JsonWriter jsonWriter3 = jsonWriter0.value((Number) null);
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("$6Y*8}<{a\"-*");
      jsonWriter2.setIndent("java.ang.Long@000000004");
      JsonWriter jsonWriter3 = jsonWriter0.value("java.lang.Float@0000000002");
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("\u0002v{u(.");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test53()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("$6Y*8s{a\"-*");
      // Undeclared exception!
      try { 
        jsonWriter0.name("|B'|Q-WI7LgLYcsQI,");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(0);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(".skG,]Mj=WGrPi`m");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter0.value(".skG,]Mj=WGrPi`m");
  ...
  public void test56()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.name("|7");
      // Undeclared exception!
      try { 
        jsonWriter2.endArray();
        fail("Expecting exception: IllegalStateException");
