...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("FP69[F1&bwmZ\"");
      // Undeclared exception!
      try { 
        jsonWriter2.value("FP69[F1&bwmZ\"");
  ...
  public void test04()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(4506);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("TNM~|/XsApfL,;v}");
      assertEquals("\"TNM~|/XsApfL,;v}\"", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(" _M_w0@#^A8");
      assertEquals("\" _M_w0@#^A8\"", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-2941L));
      assertEquals("-2941", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(1145.7052449987534);
      assertEquals("1145.7052449987534", stringWriter0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("s5{kT,^aPE^,F'z@");
      assertEquals("s5{kT,^aPE^,F'z@", stringWriter0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("FP69[F1&bwmZ\"");
      assertEquals("FP69[F1&bwmZ\"", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      jsonWriter0.jsonValue("FP69[F1&bwmZ\"");
      assertEquals("[0.0,FP69[F1&bwmZ\"", stringWriter0.toString());
  }
  ...
  public void test37()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("FP69[F1&bwmZ\"");
      assertEquals("\"FP69[F1&bwmZ\\\"\"", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue("P,cPub5-=");
      jsonWriter1.setLenient(true);
      jsonWriter1.beginArray();
      assertEquals("P,cPub5-=[", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("+DL\"+0q{");
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("TjNy(,44.c+3oK>y");
      // Undeclared exception!
      try { 
        jsonWriter0.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("TNM~|/XsApfL,;v}");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("TNM~|/XsApfL,;v}");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test62()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.value((-1026.35567248719));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test65()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      String string0 = "v*,Z]CK-AahLm\\u@";
      JsonWriter jsonWriter1 = jsonWriter0.name(string0);
      jsonWriter1.value("NUS@o0|Z<^EEL");
      JsonWriter jsonWriter2 = jsonWriter0.name(")XYYB;$_pwU");
      jsonWriter2.beginArray();
      assertEquals("{\"v*,Z]CK-AahLm\\\\u@\":\"NUS@o0|Z<^EEL\",\")XYYB;$_pwU\":[", stringWriter0.toString());
  }
  ...
  public void test73()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) 2291);
      assertEquals("2291.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
