...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter0.name("fn.>~)");
      Integer integer0 = Integer.getInteger("Fmjtxo1??qk`h:G_", (-2041062002));
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("Lwf~f *Ps49I2B$");
      assertEquals("\"Lwf~f *Ps49I2B$\"", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Float float0 = new Float(1865.483F);
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Boolean boolean0 = new Boolean("@=]S.jY]^j");
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-37.99095326482));
      assertEquals("-37.99095326482", stringWriter0.toString());
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(3965.468626813212);
      assertEquals("3965.468626813212", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test35()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(5241);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test37()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("NJN@g2EE;FO~...:V");
      // Undeclared exception!
      try { 
        jsonWriter0.beginArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test38()  throws Throwable  {
      ...
      jsonWriter3.name("=v~E[l[");
      JsonWriter jsonWriter4 = jsonWriter1.value(true);
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter0.endObject();
      JsonWriter jsonWriter3 = jsonWriter2.beginObject();
      JsonWriter jsonWriter4 = jsonWriter3.name("=v~E[l[");
      jsonWriter4.beginObject();
      assertEquals("[{},{\"=v~E[l[\":{", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.value((-1676L));
      JsonWriter jsonWriter3 = jsonWriter2.name("8GL-Y&D@3w e6+f");
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("@=]S.jY]^j");
      jsonWriter1.jsonValue("@=]S.jY]^j");
      assertEquals("[\n@=]S.jY]^j@=]S.jY]^j", stringWriter0.toString());
  }
  ...
  public void test52()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("wohYOGn");
      jsonWriter1.setSerializeNulls(false);
      jsonWriter0.nullValue();
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("@LWr");
      // Undeclared exception!
      try { 
  ...
  public void test58()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("EaGIN!5!jVv[3");
      // Undeclared exception!
      try { 
        jsonWriter0.name("EaGIN!5!jVv[3");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test71()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("@=]S.jY]^j");
      assertEquals("\"@\\u003d]S.jY]^j\"", stringWriter0.toString());
  }
}
