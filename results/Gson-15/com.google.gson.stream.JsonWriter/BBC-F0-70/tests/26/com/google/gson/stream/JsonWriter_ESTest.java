...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      Boolean boolean0 = new Boolean("{N\"[AX%`6PF");
      jsonWriter1.value(boolean0);
      assertEquals("{\"JSON must have only one top-level value.\":false", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-2243L));
      assertEquals("-2243", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("u}GR2?d");
      jsonWriter0.value(1056.3062);
      assertEquals("{\"u}GR2?d\":1056.3062", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("3)'jOGrzT)f<CsQaM");
      assertEquals("3)'jOGrzT)f<CsQaM", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("name`$ == nul");
      assertEquals("name`$ == nul", stringWriter0.toString());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.beginObject();
      jsonWriter0.name("{n?j/");
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.endObject();
      assertTrue(jsonWriter0.isHtmlSafe());
      assertEquals("{\"{n?j/\":{}", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("5).E{,:!x2DmPi(");
      jsonWriter1.setLenient(true);
      jsonWriter1.nullValue();
      assertEquals("\"5).E{,:!x2DmPi(\"null", stringWriter0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.jsonValue("name`$ == nul");
      jsonWriter0.value((-913L));
      assertEquals("[name`$ == nul,-913", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("name`$ == nul");
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.jsonValue("name`$ == nul");
      assertEquals("[\nname`$ == nulname`$ == nul", stringWriter0.toString());
  }
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("DpkHKdl\"jY;CJ%I");
      assertEquals("\"DpkHKdl\\\"jY;CJ%I\"", stringWriter0.toString());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      assertEquals("[[[[[[[[[[[[[[[[{\"o1g%ezxDDa\":[[[[[[[[[[[[[[[", stringWriter0.toString());
  }
  ...
  public void test73()  throws Throwable  {
      ...
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("~L02");
      assertEquals("\"~L02\"", stringWriter0.toString());
  }
}
