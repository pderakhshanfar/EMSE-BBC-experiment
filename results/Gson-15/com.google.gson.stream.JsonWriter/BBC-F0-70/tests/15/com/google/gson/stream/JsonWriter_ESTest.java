...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter0.name("(F2N.m#ixs+uyn}b=%c");
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter0.name("wg^:mPO");
      jsonWriter2.setLenient(true);
      jsonWriter1.value(0.0);
      jsonWriter2.endObject();
      Boolean boolean0 = Boolean.FALSE;
      jsonWriter0.value(boolean0);
      assertEquals("{\"wg^:mPO\":0.0}false", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-317L));
      assertEquals("-317", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value(376L);
      assertEquals("376", stringWriter0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("@I<fi]A`07?bdpRp-GZ");
      assertEquals("@I<fi]A`07?bdpRp-GZ", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      jsonWriter1.value(0.0);
      jsonWriter2.endObject();
      assertEquals("{\"wg^:mPO\":0.0}", stringWriter0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter0.name("!aYp_KIY]uMA!{");
      jsonWriter1.nullValue();
      jsonWriter2.endObject();
      assertEquals("{\"!aYp_KIY]uMA!{\":null}", stringWriter0.toString());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("I!aYp_KIY]uMA!{");
      jsonWriter0.beginObject();
      assertEquals("{\"I!aYp_KIY]uMA!{\":{", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value((long) 2308);
      jsonWriter2.beginObject();
      assertEquals("[2308,{", stringWriter0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("I!aYp_KIY]uMA!{");
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("tm*FD");
      jsonWriter1.nullValue();
      assertEquals("[\ntm*FDnull", stringWriter0.toString());
  }
  ...
  public void test50()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("lde`@I-5hi\"mC$~y");
      jsonWriter1.close();
      // Undeclared exception!
      try { 
        jsonWriter1.flush();
  ...
  public void test55()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("z2~x]");
      Float float0 = new Float(1.0F);
      JsonWriter jsonWriter3 = jsonWriter2.value((Number) float0);
      jsonWriter3.name("BM/.}:1<t3d5");
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(916);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test59()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("\"ym-92\"Ar/Zv_3");
      // Undeclared exception!
      try { 
        jsonWriter0.name("\"ym-92\"Ar/Zv_3");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test62()  throws Throwable  {
      ...
      jsonWriter4.beginArray();
      jsonWriter3.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[[[[[{\"+,@zB!HT7\\\"\":[[[[[[[[[[", stringWriter0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("!aYp_KIY]uMA!{");
      // Undeclared exception!
      try { 
        jsonWriter1.endObject();
        fail("Expecting exception: IllegalStateException");
