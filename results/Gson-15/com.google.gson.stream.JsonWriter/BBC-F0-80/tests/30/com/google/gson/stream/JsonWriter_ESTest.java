...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-2275L));
      assertEquals("-2275", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(1173L);
      assertEquals("1173", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(1088.5936210542468);
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("><r6JBq)/94:t2$[");
      assertEquals("><r6JBq)/94:t2$[", stringWriter0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("Ea*g=$$$X=`i2;g2");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      JsonWriter jsonWriter3 = jsonWriter2.name("}JCP");
      jsonWriter3.jsonValue("}JCP");
      assertEquals("[,{\"}JCP\":}JCP", stringWriter0.toString());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("U7#B/<`MK`on+)[W");
      jsonWriter1.value("%poO{x/ 3:");
      // Undeclared exception!
      try { 
        jsonWriter2.value("(OK@S00&^%Xt|U,p");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("DrA6W&oJLb\u0006*\"");
      assertEquals("\"DrA6W&oJLb\\u0006*\\\"\"", stringWriter0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.name("5ht5Q6%EUr^Co`giQS");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test59()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(1);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name(".350id]\"_(ErC<b;kV");
      // Undeclared exception!
      try { 
        jsonWriter1.name(".350id]\"_(ErC<b;kV");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test61()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter1.value((double) (byte) (-54));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test62()  throws Throwable  {
      ...
      jsonWriter5.name("java.lang.Double@0000000002");
      assertEquals("[[[[[[[[[[[[[[[[[[[[[[[[[[{", stringWriter0.toString());
  ...
  public void test63()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.name("&n`vu>:& ");
      // Undeclared exception!
      try { 
  ...
  public void test72()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.value((-1183.14900694676));
      jsonWriter1.beginArray();
      assertEquals("-1183.14900694676[", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test73()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("@{v=#i}");
      assertEquals("\"@{v\\u003d#i}\"", stringWriter0.toString());
  }
}
