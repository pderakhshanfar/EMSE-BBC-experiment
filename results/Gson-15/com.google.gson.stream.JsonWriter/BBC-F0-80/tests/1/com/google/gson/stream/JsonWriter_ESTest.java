...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("} fy\"}2$<w`/D/zek");
      jsonWriter1.setSerializeNulls(false);
      Float float0 = new Float((-2203.3438F));
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Boolean boolean0 = Boolean.valueOf("?1A<0WU");
      jsonWriter0.value(boolean0);
      assertEquals("false", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-5780L));
      assertEquals("-5780", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-1219.515762));
      assertEquals("-1219.515762", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.name("WKJnJ>U+C\"i\"PPs%@");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("22B");
      assertEquals("22B", stringWriter0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("} fy\"}2$<w`/D/zek");
      jsonWriter1.setSerializeNulls(false);
      jsonWriter1.beginObject();
      jsonWriter1.endObject();
      assertEquals("{\"} fy\\\"}2$<w`/D/zek\":{}", stringWriter0.toString());
  }
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("uwbc.9z,^?v");
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.value(1115L);
      jsonWriter1.beginObject();
  ...
  public void test44()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((-2582L));
      // Undeclared exception!
      try { 
        jsonWriter1.value("^@Lu ka[Mjoms?fLr-");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("J;I5\"&eng@6`.@_<!AG");
      jsonWriter1.value("J;I5\"&eng@6`.@_<!AG");
      jsonWriter0.name("J;I5\"&eng@6`.@_<!AG");
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("%830");
      jsonWriter0.value("%830");
      assertEquals("[\n%830\"%830\"", stringWriter0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("ZKJnJ>U+S\"i\"PPs%@");
      assertEquals("\"ZKJnJ>U+S\\\"i\\\"PPs%@\"", stringWriter0.toString());
  }
  ...
  public void test57()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.jsonValue(">4F%5vOwxMl{]0%");
      jsonWriter0.close();
      // Undeclared exception!
      try { 
        jsonWriter1.name("a=9@zg0ge~HO");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test61()  throws Throwable  {
      ...
      JsonWriter jsonWriter15 = jsonWriter14.name("T'FWeV{xbx+");
      ...
      jsonWriter15.beginArray();
      assertEquals("[{\": \":[[[[[[[[[[[[[[[[[{\"T'FWeV{xbx+\":[[[[[[[[[[[[", stringWriter0.toString());
  }
  ...
  public void test72()  throws Throwable  {
      ...
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("%830");
      assertEquals("\"%830\"", stringWriter0.toString());
  }
}
