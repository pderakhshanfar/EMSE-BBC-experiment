...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      ...
      capturingMatcher0.captureFrom(isEventFrom0);
      List<InvocationImpl> list0 = capturingMatcher0.getAllValues();
      ArrayList<Invocation> arrayList0 = new ArrayList<Invocation>(list0);
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: ClassCastException");
         ...
         //
         // org.hamcrest.object.IsEventFrom cannot be cast to org.mockito.invocation.Invocation
         //
         verifyException("org.mockito.internal.invocation.InvocationMatcher", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      IsEventFrom isEventFrom0 = new IsEventFrom(class0, isInstanceOf0);
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(roundingMode0, isEventFrom0, (Object) null, (Object) null).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
