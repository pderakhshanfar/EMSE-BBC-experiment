...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      AnyOf<StringEndsWith> anyOf0 = AnyOf.anyOf((Matcher<? super StringEndsWith>[]) matcherArray0);
      ...
      doReturn(accessibleObjectArray0).when(invocation0).getArguments();
  ...
  public void test02()  throws Throwable  {
      AccessibleObject[] accessibleObjectArray0 = new AccessibleObject[19];
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(accessibleObjectArray0).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
  ...
  public void test03()  throws Throwable  {
      AccessibleObject[] accessibleObjectArray0 = new AccessibleObject[14];
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(accessibleObjectArray0).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
      List<Matcher> list0 = (List<Matcher>)invocationMatcher0.getMatchers();
  ...
  public void test10()  throws Throwable  {
      AccessibleObject[] accessibleObjectArray0 = new AccessibleObject[1];
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("<init>").when(invocation0).toString();
      doReturn(accessibleObjectArray0).when(invocation0).getArguments();
      doReturn((Method) null, (Method) null).when(invocation0).getMethod();
      doReturn("<init>", "<init>").when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
  ...
  public void test11()  throws Throwable  {
      AccessibleObject[] accessibleObjectArray0 = new AccessibleObject[1];
      StringContains stringContains0 = new StringContains("JWMvo{03QiM.i'd");
      IsEmptyString isEmptyString0 = new IsEmptyString();
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("JWMvo{03QiM.i'd").when(invocation0).toString();
      doReturn(accessibleObjectArray0).when(invocation0).getArguments();
