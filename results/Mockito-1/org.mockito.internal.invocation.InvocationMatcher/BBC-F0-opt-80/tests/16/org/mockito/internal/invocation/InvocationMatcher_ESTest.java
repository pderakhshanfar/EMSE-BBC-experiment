...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Matcher<BigDecimalCloseTo> matcher0 = AllOf.allOf((Matcher<? super BigDecimalCloseTo>[]) matcherArray0);
      AnyOf<BigDecimalCloseTo> anyOf0 = AnyOf.anyOf(matcher0, (Matcher<? super BigDecimalCloseTo>) matcher0, (Matcher<? super BigDecimalCloseTo>) matcher0, (Matcher<? super BigDecimalCloseTo>) matcher0, (Matcher<? super BigDecimalCloseTo>) matcher0);
  ...
  public void test03()  throws Throwable  {
      ...
      InvocationImpl invocationImpl0 = new InvocationImpl(arrayList0, mockitoMethod0, objectArray0, (-11), cleanTraceRealMethod0);
  ...
  public void test04()  throws Throwable  {
      ...
      MockitoMethodProxy mockitoMethodProxy0 = mock(MockitoMethodProxy.class, new ViolatedAssumptionAnswer());
      CleanTraceRealMethod cleanTraceRealMethod0 = new CleanTraceRealMethod(mockitoMethodProxy0);
      InvocationImpl invocationImpl0 = new InvocationImpl(arrayList0, mockitoMethod0, objectArray0, 21, cleanTraceRealMethod0);
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocationImpl0);
      Invocation invocation0 = invocationMatcher0.getInvocation();
      assertSame(invocationImpl0, invocation0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((Method) null).when(invocation0).getMethod();
      doReturn(treeSet0).when(invocation0).getMock();
      Invocation invocation1 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(objectArray0).when(invocation1).getArguments();
      doReturn((Method) null).when(invocation1).getMethod();
      doReturn(treeSet0).when(invocation1).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation1);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      HasXPath hasXPath0 = new HasXPath(" or ", matcher0);
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(hasXPath0).when(invocation0).getMock();
      Invocation invocation1 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(objectArray0).when(invocation1).getArguments();
      doReturn(" or ").when(invocation1).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation1);
