...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Object[] objectArray0 = new Object[8];
      StringEndsWith stringEndsWith0 = new StringEndsWith("DOnL6wR#5Y");
      Matcher<StringEndsWith> matcher0 = IsSame.sameInstance(stringEndsWith0);
      AnyOf<StringEndsWith> anyOf0 = AnyOf.anyOf(matcher0, (Matcher<? super StringEndsWith>) matcher0, (Matcher<? super StringEndsWith>) matcher0, (Matcher<? super StringEndsWith>) matcher0, (Matcher<? super StringEndsWith>) matcher0, (Matcher<? super StringEndsWith>) matcher0);
  ...
  public void test03()  throws Throwable  {
      Object[] objectArray0 = new Object[8];
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("DOnL6wR#5Y").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
  ...
  public void test10()  throws Throwable  {
      ...
      StringEndsWith stringEndsWith0 = new StringEndsWith("DOnL6wR#5Y");
      Matcher<StringEndsWith> matcher0 = IsSame.sameInstance(stringEndsWith0);
      IsAnything<StringEndsWith> isAnything0 = new IsAnything<StringEndsWith>("DOnL6wR#5Y");
      AnyOf<StringEndsWith> anyOf0 = AnyOf.anyOf(matcher0, (Matcher<? super StringEndsWith>) matcher0, (Matcher<? super StringEndsWith>) matcher0, (Matcher<? super StringEndsWith>) matcher0, (Matcher<? super StringEndsWith>) matcher0, (Matcher<? super StringEndsWith>) isAnything0);
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(anyOf0);
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((Object[]) null).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = null;
  ...
  public void test11()  throws Throwable  {
      Object[] objectArray0 = new Object[1];
      StringContains stringContains0 = new StringContains(">5yi");
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((Object[]) null).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = null;
      try {
