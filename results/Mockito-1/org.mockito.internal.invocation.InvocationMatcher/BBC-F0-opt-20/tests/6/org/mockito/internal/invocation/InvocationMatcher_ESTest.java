...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      InvocationImpl invocationImpl0 = new InvocationImpl(isEmptyString0, mockitoMethod0, objectArray0, 781, cleanTraceRealMethod0);
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocationImpl0);
      List<Matcher> list0 = (List<Matcher>)invocationMatcher0.getMatchers();
  ...
  public void test03()  throws Throwable  {
      ...
      InvocationImpl invocationImpl0 = new InvocationImpl(cleanTraceRealMethod0, mockitoMethod0, objectArray0, (-39), cleanTraceRealMethod0);
  ...
  public void test04()  throws Throwable  {
      IsEqualIgnoringWhiteSpace[] isEqualIgnoringWhiteSpaceArray0 = new IsEqualIgnoringWhiteSpace[5];
      MockitoMethodProxy mockitoMethodProxy0 = mock(MockitoMethodProxy.class, new ViolatedAssumptionAnswer());
      CleanTraceRealMethod cleanTraceRealMethod0 = new CleanTraceRealMethod(mockitoMethodProxy0);
      MockitoMethod mockitoMethod0 = mock(MockitoMethod.class, new ViolatedAssumptionAnswer());
      doReturn(false).when(mockitoMethod0).isVarArgs();
      StringEndsWith stringEndsWith0 = new StringEndsWith("");
      InvocationImpl invocationImpl0 = new InvocationImpl(stringEndsWith0, mockitoMethod0, isEqualIgnoringWhiteSpaceArray0, 1, cleanTraceRealMethod0);
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocationImpl0);
      Invocation invocation0 = invocationMatcher0.getInvocation();
  ...
  public void test05()  throws Throwable  {
      ...
      doReturn(false).when(mockitoMethod0).isVarArgs();
      Object[] objectArray0 = new Object[1];
      InvocationImpl invocationImpl0 = new InvocationImpl(cleanTraceRealMethod0, mockitoMethod0, objectArray0, (-2), cleanTraceRealMethod0);
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocationImpl0);
      List<Matcher> list0 = (List<Matcher>)invocationMatcher0.getMatchers();
      InvocationMatcher invocationMatcher1 = new InvocationMatcher((Invocation) null, list0);
  ...
  public void test06()  throws Throwable  {
      ...
      doReturn(false).when(mockitoMethod0).isVarArgs();
      InvocationImpl invocationImpl0 = new InvocationImpl("", mockitoMethod0, isEqualIgnoringWhiteSpaceArray0, 1, cleanTraceRealMethod0);
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocationImpl0);
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      Stack<InvocationImpl> stack1 = new Stack<InvocationImpl>();
      stack1.add((InvocationImpl) null);
      stack0.addAll((Collection<? extends Invocation>) stack1);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      doReturn(false).when(mockitoMethod0).isVarArgs();
      StringEndsWith stringEndsWith0 = new StringEndsWith("");
      InvocationImpl invocationImpl0 = new InvocationImpl(stringEndsWith0, mockitoMethod0, isEqualIgnoringWhiteSpaceArray0, 13, cleanTraceRealMethod0);
  ...
  public void test15()  throws Throwable  {
      ...
      doReturn(false).when(mockitoMethod0).isVarArgs();
      Object[] objectArray0 = new Object[6];
      InvocationImpl invocationImpl0 = new InvocationImpl(cleanTraceRealMethod0, mockitoMethod0, objectArray0, 2899, cleanTraceRealMethod0);
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocationImpl0);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      MockitoMethod mockitoMethod0 = mock(MockitoMethod.class, new ViolatedAssumptionAnswer());
      doReturn(false).when(mockitoMethod0).isVarArgs();
      InvocationImpl invocationImpl0 = new InvocationImpl(isEqualIgnoringWhiteSpaceArray0[2], mockitoMethod0, isEqualIgnoringWhiteSpaceArray0, 158, cleanTraceRealMethod0);
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocationImpl0);
