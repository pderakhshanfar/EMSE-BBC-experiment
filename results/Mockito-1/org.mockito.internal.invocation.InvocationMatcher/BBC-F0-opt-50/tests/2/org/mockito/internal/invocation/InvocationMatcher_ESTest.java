...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      InvocationImpl invocationImpl0 = new InvocationImpl(isEmptyString0, mockitoMethod0, objectArray0, 2198, defaultRealMethod0);
  ...
  public void test12()  throws Throwable  {
      StringEndsWith stringEndsWith0 = new StringEndsWith("g$`edY_]");
      ...
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("g$`edY_]", "g$`edY_]").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(objectArray0[0], anyVararg0, (Object) null, (Object) null).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
      Answer<StringEndsWith> answer0 = (Answer<StringEndsWith>) mock(Answer.class, new ViolatedAssumptionAnswer());
      StubbedInvocationMatcher stubbedInvocationMatcher0 = new StubbedInvocationMatcher(invocationMatcher0, answer0);
      Invocation invocation1 = stubbedInvocationMatcher0.getInvocation();
