...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      isInstanceOfArray0[0] = isInstanceOf0;
      Matcher<IsInstanceOf> matcher0 = IsIn.isOneOf(isInstanceOfArray0);
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(matcher0);
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(":FnC.9-6h=k").when(invocation0).toString();
  ...
  public void test11()  throws Throwable  {
      IsCloseTo isCloseTo0 = new IsCloseTo(1.0, 3342.44);
      Object[] objectArray0 = new Object[6];
      objectArray0[2] = (Object) isCloseTo0;
      objectArray0[5] = (Object) isCloseTo0;
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(":Kn7.956_h=k").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn((Method) null, (Method) null).when(invocation0).getMethod();
      doReturn(objectArray0[2], objectArray0[5]).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
      Invocation invocation1 = invocationMatcher0.getInvocation();
      // Undeclared exception!
      try { 
