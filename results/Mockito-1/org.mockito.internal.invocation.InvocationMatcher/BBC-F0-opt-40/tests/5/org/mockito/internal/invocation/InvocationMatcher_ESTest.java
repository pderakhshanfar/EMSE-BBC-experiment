...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      InvocationImpl invocationImpl0 = new InvocationImpl(locale_FilteringMode0, mockitoMethod0, objectArray0, (-1798), defaultRealMethod0);
  ...
  public void test13()  throws Throwable  {
      ...
      AnyOf<String> anyOf0 = AnyOf.anyOf(matcher1, (Matcher<? super String>) matcher0, (Matcher<? super String>) matcher0, (Matcher<? super String>) matcher0, (Matcher<? super String>) matcher0);
      HasXPath hasXPath0 = new HasXPath("*", anyOf0);
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((String) null).when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(hasXPath0, "*", (Object) null, (Object) null).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
