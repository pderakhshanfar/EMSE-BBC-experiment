...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      AnyOf<BigDecimalCloseTo> anyOf0 = AnyOf.anyOf((Matcher<BigDecimalCloseTo>) capturingMatcher0, (Matcher<? super BigDecimalCloseTo>) capturingMatcher0);
  ...
  public void test01()  throws Throwable  {
      ...
      StubbedInvocationMatcher stubbedInvocationMatcher1 = new StubbedInvocationMatcher(invocationMatcher1, answers0);
  ...
  public void test11()  throws Throwable  {
      ...
      doReturn((String) null, (String) null).when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(list0, (String) null).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
      Answers answers0 = Answers.RETURNS_DEFAULTS;
      StubbedInvocationMatcher stubbedInvocationMatcher0 = new StubbedInvocationMatcher(invocationMatcher0, answers0);
      Invocation invocation1 = stubbedInvocationMatcher0.getInvocation();
