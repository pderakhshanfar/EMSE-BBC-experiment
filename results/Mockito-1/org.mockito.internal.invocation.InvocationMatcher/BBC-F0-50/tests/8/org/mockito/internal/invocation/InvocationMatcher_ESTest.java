...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      ...
      doReturn("{Y5Q_}T", "{Y5Q_}T").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn("*jFLt9>u", (Object) null).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
      Answer<IsInstanceOf> answer0 = (Answer<IsInstanceOf>) mock(Answer.class, new ViolatedAssumptionAnswer());
      StubbedInvocationMatcher stubbedInvocationMatcher0 = new StubbedInvocationMatcher(invocationMatcher0, answer0);
      Invocation invocation1 = stubbedInvocationMatcher0.getInvocation();
  ...
  public void test14()  throws Throwable  {
      ...
      Matcher<StringEndsWith> matcher0 = AllOf.allOf((Matcher<? super StringEndsWith>) anyOf0, (Matcher<? super StringEndsWith>) anyOf0, (Matcher<? super StringEndsWith>) anyOf0, (Matcher<? super StringEndsWith>) anyOf0);
