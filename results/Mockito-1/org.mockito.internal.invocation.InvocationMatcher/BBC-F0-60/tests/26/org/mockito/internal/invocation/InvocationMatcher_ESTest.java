...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Matcher<IsCloseTo> matcher0 = AllOf.allOf((Matcher<? super IsCloseTo>) varargCapturingMatcher0, (Matcher<? super IsCloseTo>) varargCapturingMatcher0, (Matcher<? super IsCloseTo>) varargCapturingMatcher0);
  ...
  public void test09()  throws Throwable  {
      ...
      IsEqualIgnoringCase isEqualIgnoringCase0 = new IsEqualIgnoringCase("r$[_~c~`PG");
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((String) null, (String) null).when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(isInstanceOf0, isEmptyString0, (Object) null, (Object) null).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
