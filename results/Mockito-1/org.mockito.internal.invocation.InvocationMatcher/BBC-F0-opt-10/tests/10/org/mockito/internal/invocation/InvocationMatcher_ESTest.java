...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      IsEmptyCollection<OrderingComparison<Integer>>[] isEmptyCollectionArray0 = (IsEmptyCollection<OrderingComparison<Integer>>[]) Array.newInstance(IsEmptyCollection.class, 8);
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((Object[]) null).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = null;
      try {
  ...
  public void test02()  throws Throwable  {
      IsEmptyCollection<OrderingComparison<Integer>>[] isEmptyCollectionArray0 = (IsEmptyCollection<OrderingComparison<Integer>>[]) Array.newInstance(IsEmptyCollection.class, 2);
      ...
      InvocationImpl invocationImpl0 = new InvocationImpl((Object) null, mockitoMethod0, isEmptyCollectionArray0, (-5437), cleanTraceRealMethod0);
      ...
      assertEquals((-5437), invocation0.getSequenceNumber());
  }
  ...
  public void test04()  throws Throwable  {
      IsEmptyCollection<OrderingComparison<Integer>>[] isEmptyCollectionArray0 = (IsEmptyCollection<OrderingComparison<Integer>>[]) Array.newInstance(IsEmptyCollection.class, 9);
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((Object[]) null).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = null;
      try {
  ...
  public void test05()  throws Throwable  {
      IsEmptyCollection<OrderingComparison<Integer>>[] isEmptyCollectionArray0 = (IsEmptyCollection<OrderingComparison<Integer>>[]) Array.newInstance(IsEmptyCollection.class, 1);
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((Object[]) null).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = null;
      try {
  ...
  public void test12()  throws Throwable  {
      ...
      HasXPath hasXPath0 = new HasXPath("org.mockito.internal.invocation.InvocationMatcher", varargCapturingMatcher0);
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(vector0, hasXPath0).when(invocation0).getMock();
  ...
  public void test14()  throws Throwable  {
      IsEmptyCollection<OrderingComparison<Integer>>[] isEmptyCollectionArray0 = (IsEmptyCollection<OrderingComparison<Integer>>[]) Array.newInstance(IsEmptyCollection.class, 8);
      IsEmptyCollection<OrderingComparison<Integer>> isEmptyCollection0 = new IsEmptyCollection<OrderingComparison<Integer>>();
