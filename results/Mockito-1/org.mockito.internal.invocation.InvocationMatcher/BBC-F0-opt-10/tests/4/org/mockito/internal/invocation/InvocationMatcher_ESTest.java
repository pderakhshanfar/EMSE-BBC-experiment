...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      AnyOf<StringStartsWith> anyOf0 = AnyOf.anyOf((Matcher<StringStartsWith>) isAnything0, (Matcher<? super StringStartsWith>) isAnything0, (Matcher<? super StringStartsWith>) isAnything0, (Matcher<? super StringStartsWith>) isAnything0, (Matcher<? super StringStartsWith>) matcher0);
  ...
  public void test02()  throws Throwable  {
      ...
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("/@}8p:@N").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
