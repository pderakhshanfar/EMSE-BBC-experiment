...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      Object[] objectArray0 = new Object[6];
      StringEndsWith stringEndsWith0 = new StringEndsWith(":t1!(\"@#");
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("", "").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(stringEndsWith0, ":t1!(\"@#").when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
  ...
  public void test14()  throws Throwable  {
      Object[] objectArray0 = new Object[5];
      IsEqualIgnoringWhiteSpace isEqualIgnoringWhiteSpace0 = new IsEqualIgnoringWhiteSpace("<Rdm%b7G;},*Jr_XaG");
      Matcher<Object> matcher0 = IsNot.not((Object) isEqualIgnoringWhiteSpace0);
      CombinableMatcher<IsEqualIgnoringCase> combinableMatcher0 = new CombinableMatcher<IsEqualIgnoringCase>(matcher0);
