...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      DescribedAs<LocalizedMatcher> describedAs0 = new DescribedAs<LocalizedMatcher>((String) null, localizedMatcherArray0[2], localizedMatcherArray0);
  ...
  public void test09()  throws Throwable  {
      ...
      IsEmptyString isEmptyString0 = new IsEmptyString();
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("_qh`{x;pw").when(invocation0).toString();
  ...
  public void test11()  throws Throwable  {
      ...
      localizedMatcherArray0[5] = localizedMatcher0;
      localizedMatcherArray0[5].getLocation();
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((Object[]) null).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = null;
      try {
