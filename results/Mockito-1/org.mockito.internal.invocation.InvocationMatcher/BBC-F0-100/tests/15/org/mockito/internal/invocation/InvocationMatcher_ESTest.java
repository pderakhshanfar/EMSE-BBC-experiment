...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StringContains[] stringContainsArray0 = new StringContains[7];
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
  ...
  public void test02()  throws Throwable  {
      StringContains[] stringContainsArray0 = new StringContains[6];
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((Object[]) null).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = null;
      try {
  ...
  public void test03()  throws Throwable  {
      ...
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("#sOtc(Sc5qzJa", (String) null).when(invocation0).toString();
      doReturn(stringContainsArray0).when(invocation0).getArguments();
  ...
  public void test11()  throws Throwable  {
      StringContains[] stringContainsArray0 = new StringContains[7];
      StringContains stringContains0 = new StringContains("A()-'PQ!8");
      stringContainsArray0[6] = stringContainsArray0[2];
      Answers answers0 = Answers.RETURNS_MOCKS;
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("#sOtc(Sc5qzJa", (String) null).when(invocation0).toString();
      doReturn(stringContainsArray0).when(invocation0).getArguments();
  ...
  public void test13()  throws Throwable  {
      StringContains[] stringContainsArray0 = new StringContains[6];
      StringContains stringContains0 = new StringContains("&Tgd]t,c[R");
