...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      ...
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(",(~g U)u5ZJR", isEmptyString0).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
  ...
  public void test13()  throws Throwable  {
      Object[] objectArray0 = new Object[1];
      StringStartsWith stringStartsWith0 = mock(StringStartsWith.class, new ViolatedAssumptionAnswer());
      Matcher<StringStartsWith> matcher0 = SamePropertyValuesAs.samePropertyValuesAs(stringStartsWith0);
      AnyOf<StringStartsWith> anyOf0 = AnyOf.anyOf(matcher0, (Matcher<? super StringStartsWith>) matcher0, (Matcher<? super StringStartsWith>) matcher0);
