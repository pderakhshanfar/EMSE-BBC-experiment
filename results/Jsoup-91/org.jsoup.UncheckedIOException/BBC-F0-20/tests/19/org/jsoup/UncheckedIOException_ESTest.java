...
public class UncheckedIOException_ESTest extends UncheckedIOException_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      MockThrowable mockThrowable0 = new MockThrowable("h[#@MhN(q");
      MockIOException mockIOException0 = new MockIOException("?'s2+F.@KR", mockThrowable0);
