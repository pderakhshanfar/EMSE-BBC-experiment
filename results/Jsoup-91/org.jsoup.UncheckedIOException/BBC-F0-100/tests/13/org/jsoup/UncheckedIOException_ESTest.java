...
public class UncheckedIOException_ESTest extends UncheckedIOException_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      MockThrowable mockThrowable0 = new MockThrowable("`Nmzb;^$a,^<A");
      MockIOException mockIOException0 = new MockIOException("8T.m,PSb8.O. .57<*", mockThrowable0);
