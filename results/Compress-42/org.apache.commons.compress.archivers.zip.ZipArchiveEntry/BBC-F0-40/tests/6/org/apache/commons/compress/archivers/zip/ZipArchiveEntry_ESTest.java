...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setPlatform(1183);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(1183, zipArchiveEntry0.getPlatform());
      assertFalse(boolean0);
  }
  ...
  public void test002()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      zipArchiveEntry1.setInternalAttributes((-1452));
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals((-1452), zipArchiveEntry1.getInternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test004()  throws Throwable  {
      ...
      zipArchiveEntry0.setName("/R,rn#Y/", byteArray0);
  ...
  public void test006()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("P@}/1]");
  ...
  public void test007()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setMethod(678);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry((ZipEntry) zipArchiveEntry0);
      assertEquals(678, zipArchiveEntry0.getMethod());
      assertEquals(0, zipArchiveEntry0.getPlatform());
  }

  @Test(timeout = 4000)
  public void test008()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("</LZyt\"[/");
  ...
  public void test014()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("E/pU{:=?9");
      byte[] byteArray0 = new byte[0];
      zipArchiveEntry0.setName("+t\"gB'=@.E(F", byteArray0);
  ...
  public void test015()  throws Throwable  {
      ...
      zipArchiveEntry0.setRawFlag(28789);
  ...
  public void test021()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("E/pU{:=?9");
      zipArchiveEntry0.setMethod(298);
      int int0 = zipArchiveEntry0.getMethod();
  ...
  public void test023()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setInternalAttributes((-337));
      int int0 = zipArchiveEntry0.getInternalAttributes();
  ...
  public void test024()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("xb&K5Ap");
  ...
  public void test029()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("E/pU{:=?9");
      zipArchiveEntry0.setExternalAttributes((-150L));
      long long0 = zipArchiveEntry0.getExternalAttributes();
  ...
  public void test030()  throws Throwable  {
      ...
      UnicodeCommentExtraField unicodeCommentExtraField0 = new UnicodeCommentExtraField("D{Z'ib5//", byteArray0);
  ...
  public void test031()  throws Throwable  {
      UnicodePathExtraField unicodePathExtraField0 = new UnicodePathExtraField();
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("q:Fiog");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Error parsing extra fields for entry: q:Fiog - UniCode path extra data must have at least 5 bytes.
         //
  ...
  public void test033()  throws Throwable  {
      File file0 = MockFile.createTempFile("C,fAe@Kl/6[y{}l", "6$&rP;Q");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "C,fAe@Kl/6[y{}l");
  ...
  public void test037()  throws Throwable  {
      MockFile mockFile0 = new MockFile("VE>[TL,k=");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "<LZyt\"[");
      byte[] byteArray0 = new byte[8];
  ...
  public void test044()  throws Throwable  {
      UnicodePathExtraField unicodePathExtraField0 = new UnicodePathExtraField();
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("D{Z'ib5");
      zipArchiveEntry0.addExtraField(unicodePathExtraField0);
      ZipArchiveEntry zipArchiveEntry1 = null;
      try {
  ...
  public void test049()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = null;
      try {
        zipArchiveEntry0 = new ZipArchiveEntry((File) null, "{/-^lAS>Er|HzG");
        fail("Expecting exception: NullPointerException");
  ...
  public void test050()  throws Throwable  {
      ...
      zipArchiveEntry0.setName("Error parsing extra fields for entry: ", (byte[]) null);
  ...
  public void test054()  throws Throwable  {
      ...
      UnicodeCommentExtraField unicodeCommentExtraField0 = new UnicodeCommentExtraField("6tn{r", byteArray0);
  ...
  public void test056()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("E/pU{:=?9");
      byte[] byteArray0 = new byte[0];
      UnicodeCommentExtraField unicodeCommentExtraField0 = new UnicodeCommentExtraField("bgj2FSta]:)8=bcK", byteArray0);
      zipArchiveEntry0.addExtraField(unicodeCommentExtraField0);
  ...
  public void test060()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveEntry0.setMethod((-1612));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // ZIP compression method can not be negative: -1612
         //
         verifyException("org.apache.commons.compress.archivers.zip.ZipArchiveEntry", e);
      }
  }
  ...
  public void test061()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Q_", "V/");
  ...
  public void test076()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = (ZipArchiveEntry)zipArchiveEntry0.clone();
      zipArchiveEntry1.setUnixMode(1135);
      zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(74383361L, zipArchiveEntry1.getExternalAttributes());
      assertEquals(0, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test077()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setComment("Xj j");
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(0L, zipArchiveEntry1.getExternalAttributes());
      assertEquals((-1L), zipArchiveEntry1.getSize());
  ...
  public void test089()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setPlatform(1652);
      zipArchiveEntry0.setName("(h<i");
      assertEquals(1652, zipArchiveEntry0.getPlatform());
  }

  @Test(timeout = 4000)
  public void test090()  throws Throwable  {
      MockFile mockFile0 = new MockFile(",LiwbnB!A Q");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, ",LiwbnB!A Q");
  ...
  public void test091()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("8zoOl");
      byte[] byteArray0 = new byte[9];
  ...
  public void test104()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("[ZX.+~{");
      ...
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals("[ZX.+~{", zipArchiveEntry0.toString());
  }
  ...
  public void test114()  throws Throwable  {
      MockFile mockFile0 = new MockFile("O/tc`|UQx[`SI8G{D");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "8IqcLc(^wGOh)qYv:");
      int int0 = zipArchiveEntry0.getVersionMadeBy();
      assertEquals(0, int0);
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0, zipArchiveEntry0.getPlatform());
  ...
  public void test115()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionMadeBy(1652);
      int int0 = zipArchiveEntry0.getVersionMadeBy();
      assertEquals(1652, int0);
  }
