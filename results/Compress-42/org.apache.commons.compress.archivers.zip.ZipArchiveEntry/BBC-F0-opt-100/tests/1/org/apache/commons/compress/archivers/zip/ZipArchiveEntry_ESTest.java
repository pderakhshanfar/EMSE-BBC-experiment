...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      ...
      zipArchiveEntry1.setTime((-1315L));
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertFalse(boolean0);
  }
  ...
  public void test004()  throws Throwable  {
      ...
      zipArchiveEntry0.setPlatform((-4078));
      zipArchiveEntry0.setName("+{.b", byteArray0);
      assertEquals((-4078), zipArchiveEntry0.getPlatform());
  }

  @Test(timeout = 4000)
  public void test005()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(" is not a concreie class");
  ...
  public void test007()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setMethod(26131);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry((ZipEntry) zipArchiveEntry0);
      assertEquals(26131, zipArchiveEntry0.getMethod());
  }

  @Test(timeout = 4000)
  public void test008()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setName("L1tgr_7P#^");
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
  ...
  public void test010()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionRequired(1514);
  ...
  public void test011()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionRequired((-1524));
      int int0 = zipArchiveEntry0.getVersionRequired();
  ...
  public void test012()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("0`#p*JTQt:");
  ...
  public void test014()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "gcnE{>8\"!=i`F");
  ...
  public void test017()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setRawFlag((-70537784));
  ...
  public void test019()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setPlatform((-3028));
      int int0 = zipArchiveEntry0.getPlatform();
  ...
  public void test020()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("b,$Aw{De[kbVR4NR;");
      String string0 = zipArchiveEntry0.getName();
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals("b,$Aw{De[kbVR4NR;", string0);
      assertEquals(0, zipArchiveEntry0.getPlatform());
  }

  @Test(timeout = 4000)
  public void test021()  throws Throwable  {
      MockFile mockFile0 = new MockFile("e=fQV 8N$|ai0/", "e=fQV 8N$|ai0/");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "e=fQV 8N$|ai0/");
      assertEquals((-1), zipArchiveEntry0.getMethod());
  ...
  public void test023()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("JzpY`Tw|#~");
      zipArchiveEntry0.setInternalAttributes(399);
  ...
  public void test029()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setUnixMode(524);
      long long0 = zipArchiveEntry0.getExternalAttributes();
      assertEquals(34340865L, long0);
  }
  ...
  public void test032()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("TO*$dh.xOE*3");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Error parsing extra fields for entry: TO*$dh.xOE*3 - UniCode path extra data must have at least 5 bytes.
         //
  ...
  public void test033()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("-C/9Nc!c'*(Q'}9%");
      try { 
  ...
  public void test034()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("}`@k@y//d?g1DuvK/");
      UnicodePathExtraField unicodePathExtraField0 = new UnicodePathExtraField();
  ...
  public void test035()  throws Throwable  {
      MockFile mockFile0 = new MockFile(" is not a concrete class", " is not a concrete class");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, " =%^8+dE.F/R3mp&`o#/");
      // Undeclared exception!
      try { 
  ...
  public void test047()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("{Na4he-wg a0^zVie[//");
      X0017_StrongEncryptionHeader x0017_StrongEncryptionHeader0 = new X0017_StrongEncryptionHeader();
  ...
  public void test061()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(" =%^8+dE.F/R3mp&`o#");
  ...
  public void test068()  throws Throwable  {
      File file0 = MockFile.createTempFile(" is not a concreie class", (String) null);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, " is not a concreie class");
      int int0 = zipArchiveEntry0.getPlatform();
      assertEquals(0L, zipArchiveEntry0.getSize());
      assertEquals(0, int0);
      assertEquals((-1), zipArchiveEntry0.getMethod());
  ...
  public void test077()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      zipArchiveEntry1.setExternalAttributes(652L);
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(652L, zipArchiveEntry1.getExternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test081()  throws Throwable  {
      ...
      zipArchiveEntry1.setComment(" =%^8+dE.F/R3mp&`o#/");
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertFalse(zipArchiveEntry1.equals((Object)zipArchiveEntry0));
      assertFalse(boolean0);
  }
  ...
  public void test083()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      byte[] byteArray0 = new byte[0];
      zipArchiveEntry1.setName("n+", byteArray0);
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
  ...
  public void test091()  throws Throwable  {
      MockFile mockFile0 = new MockFile("COBeBTd:P1'N$4T_>S");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "c!diEydoxC!4Y}");
      // Undeclared exception!
      try { 
  ...
  public void test092()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[8];
      zipArchiveEntry0.setName("<u$q~^-H\"2", byteArray0);
      assertEquals("<u$q~^-H\"2", zipArchiveEntry0.toString());
  }
  ...
  public void test098()  throws Throwable  {
      ...
      zipArchiveEntry0.addAsFirstExtraField(x0017_StrongEncryptionHeader0);
      byte[] byteArray0 = new byte[4];
      UnicodeCommentExtraField unicodeCommentExtraField0 = new UnicodeCommentExtraField("g^~/=DbTJ[K|", byteArray0);
  ...
  public void test107()  throws Throwable  {
      MockFile mockFile0 = new MockFile("~{[{v)7EEK:?$DJr", "~{[{v)7EEK:?$DJr");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "~{[{v)7EEK:?$DJr");
  ...
  public void test108()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "JT-0,2~ZQoF9+Z23}FQ");
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals(0, zipArchiveEntry0.getPlatform());
  ...
  public void test117()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionMadeBy((-1394));
      int int0 = zipArchiveEntry0.getVersionMadeBy();
