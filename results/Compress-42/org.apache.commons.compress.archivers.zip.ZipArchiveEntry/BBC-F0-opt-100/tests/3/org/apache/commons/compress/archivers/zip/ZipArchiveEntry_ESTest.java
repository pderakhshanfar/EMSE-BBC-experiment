...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      zipArchiveEntry1.setUnixMode(7);
      zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(7, zipArchiveEntry1.getUnixMode());
  }
  ...
  public void test002()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = (ZipArchiveEntry)zipArchiveEntry0.clone();
      zipArchiveEntry1.setInternalAttributes((-368));
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals((-368), zipArchiveEntry1.getInternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test004()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setPlatform((-4205));
      zipArchiveEntry0.setName("z;n*jD`V^Zo!6lc");
      assertEquals((-4205), zipArchiveEntry0.getPlatform());
  }
  ...
  public void test006()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("ZIP compression method can not be negative: ");
      zipArchiveEntry0.setMethod((byte)113);
  ...
  public void test009()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("ZIP compression method can not be negative: ");
      zipArchiveEntry0.setVersionRequired((-696));
      int int0 = zipArchiveEntry0.getVersionRequired();
  ...
  public void test010()  throws Throwable  {
      ...
      zipArchiveEntry0.setVersionMadeBy(113);
  ...
  public void test015()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("CZdyhiHs[l`*");
      assertEquals("CZdyhiHs[l`*", zipArchiveEntry0.getName());
  ...
  public void test017()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("CZdyhiHs[l`*");
      zipArchiveEntry0.setRawFlag((-2214));
      int int0 = zipArchiveEntry0.getRawFlag();
  ...
  public void test019()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("Iw:c _`bc");
      assertEquals((-1), zipArchiveEntry0.getMethod());
  ...
  public void test020()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setInternalAttributes(2139095040);
  ...
  public void test025()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("/{i>6~@");
      zipArchiveEntry0.setUnixMode(279);
      long long0 = zipArchiveEntry0.getExternalAttributes();
      assertEquals(279, zipArchiveEntry0.getUnixMode());
      assertEquals(18284545L, long0);
  }
  ...
  public void test054()  throws Throwable  {
      ...
      assertEquals(62629, int0);
  }

  @Test(timeout = 4000)
  public void test055()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("11");
      // Undeclared exception!
      try { 
  ...
  public void test056()  throws Throwable  {
      MockFile mockFile0 = new MockFile("#O{L#_>e\"");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "#O{L#_>e\"");
      long long0 = zipArchiveEntry0.getSize();
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
  ...
  public void test058()  throws Throwable  {
      File file0 = MockFile.createTempFile(">g))3)T5", "Ps\"=EwF<", (File) null);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, ">g))3)T5");
      boolean boolean0 = zipArchiveEntry0.isDirectory();
      assertEquals(0L, zipArchiveEntry0.getSize());
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1), zipArchiveEntry0.getMethod());
  ...
  public void test065()  throws Throwable  {
      ...
      zipArchiveEntry1.setCompressedSize((-368L));
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertFalse(boolean0);
  }
  ...
  public void test072()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry(mockFile0, string0);
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(0L, zipArchiveEntry1.getExternalAttributes());
      ...
      assertEquals(0, zipArchiveEntry1.getInternalAttributes());
      assertEquals(0, zipArchiveEntry1.getPlatform());
      assertEquals("/\\u}", zipArchiveEntry1.getName());
      assertFalse(boolean0);
  }
  ...
  public void test074()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("ZIP compression method can not be negative: ");
      byte[] byteArray0 = zipArchiveEntry0.getCentralDirectoryExtra();
      zipArchiveEntry0.setName(" ?k!kO8@*K@:(xGyu", byteArray0);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("ZIP compression method can not be negative: ");
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(" ?k!kO8@*K@:(xGyu", zipArchiveEntry0.getName());
      assertFalse(boolean0);
  }
  ...
  public void test083()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveEntry0.setSize((-2360L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test084()  throws Throwable  {
      ...
      zipArchiveEntry0.setUnixMode(1);
      byte[] byteArray0 = zipArchiveEntry0.getCentralDirectoryExtra();
      zipArchiveEntry0.setName("$VALUES", byteArray0);
  ...
  public void test111()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("");
      zipArchiveEntry0.setPlatform((-1178));
      int int0 = zipArchiveEntry0.getPlatform();
