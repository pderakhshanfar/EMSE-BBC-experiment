...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      zipArchiveEntry1.setInternalAttributes(771);
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(771, zipArchiveEntry1.getInternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test005()  throws Throwable  {
      File file0 = MockFile.createTempFile("x2E@Y", "");
  ...
  public void test006()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, " 8pmTi\ttLOA,$L(@<");
  ...
  public void test008()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("q+v");
      zipArchiveEntry0.setMethod(771);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry((ZipEntry) zipArchiveEntry0);
      assertEquals(771, zipArchiveEntry0.getMethod());
  }

  @Test(timeout = 4000)
  public void test009()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("AEz");
      zipArchiveEntry0.setName("AEz");
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals(0, zipArchiveEntry0.getPlatform());
  ...
  public void test011()  throws Throwable  {
      ...
      zipArchiveEntry0.setVersionRequired(2362);
  ...
  public void test012()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionRequired((-1298));
      int int0 = zipArchiveEntry0.getVersionRequired();
  ...
  public void test013()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("h9v+p_iy~EX");
      zipArchiveEntry0.setVersionMadeBy(1351);
  ...
  public void test017()  throws Throwable  {
      ...
      zipArchiveEntry0.setName(" $Oq?'qn!P%r)@m~-K", byteArray0);
  ...
  public void test019()  throws Throwable  {
      File file0 = MockFile.createTempFile("x2E@Y", "");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "");
      zipArchiveEntry0.setUnixMode(2402);
      int int0 = zipArchiveEntry0.getPlatform();
      assertEquals(2402, zipArchiveEntry0.getUnixMode());
      assertEquals(3, int0);
  }
  ...
  public void test023()  throws Throwable  {
      File file0 = MockFile.createTempFile("B)pv}Vu1t9KM/", "Vrc1t)WS@]Kh");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "B)pv}Vu1t9KM/");
  ...
  public void test024()  throws Throwable  {
      ...
      zipArchiveEntry0.setInternalAttributes((-824));
      int int0 = zipArchiveEntry0.getInternalAttributes();
  ...
  public void test029()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setUnixMode(4566);
      long long0 = zipArchiveEntry0.getExternalAttributes();
      assertEquals(3, zipArchiveEntry0.getPlatform());
      assertEquals(299237376L, long0);
  }
  ...
  public void test033()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("V#}-]{./ak/");
  ...
  public void test043()  throws Throwable  {
      ...
      Zip64ExtendedInformationExtraField zip64ExtendedInformationExtraField0 = new Zip64ExtendedInformationExtraField();
      ZipEightByteInteger zipEightByteInteger0 = new ZipEightByteInteger(1953L);
      zip64ExtendedInformationExtraField0.setCompressedSize(zipEightByteInteger0);
      // Undeclared exception!
      try { 
        zipArchiveEntry0.addAsFirstExtraField(zip64ExtendedInformationExtraField0);
  ...
  public void test057()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("Y");
      ZipShort zipShort0 = new ZipShort(2);
  ...
  public void test060()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "~US!J#aOrA;");
  ...
  public void test065()  throws Throwable  {
      File file0 = MockFile.createTempFile("G7WX-7#pYPE%'jJh", "Zip64 extended information must contain both size values in the local file header.");
  ...
  public void test070()  throws Throwable  {
      ...
      zipArchiveEntry0.setCompressedSize(1984L);
      zipArchiveEntry0.equals(object0);
      assertEquals((-1), zipArchiveEntry0.getMethod());
  }
  ...
  public void test077()  throws Throwable  {
      ...
      zipArchiveEntry1.setComment("1/3+yC,Z1,_#/");
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertFalse(boolean0);
  }
  ...
  public void test078()  throws Throwable  {
      ...
      zipArchiveEntry1.setTime(1171L);
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
  ...
  public void test079()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setComment("s<-veYQ]*D]");
      ZipArchiveEntry zipArchiveEntry1 = (ZipArchiveEntry)zipArchiveEntry0.clone();
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals((-1L), zipArchiveEntry1.getSize());
      assertEquals(0, zipArchiveEntry1.getPlatform());
  ...
  public void test080()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry(" 8pmTi\ttLOA,$L(@</");
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(0L, zipArchiveEntry1.getExternalAttributes());
      assertEquals((-1), zipArchiveEntry1.getMethod());
      assertEquals(0, zipArchiveEntry1.getInternalAttributes());
  ...
  public void test081()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("7l[PB\"+7uQ`y+))<s");
      boolean boolean0 = zipArchiveEntry0.equals("7l[PB\"+7uQ`y+))<s");
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertFalse(boolean0);
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals("7l[PB\"+7uQ`y+))<s", zipArchiveEntry0.getName());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
  }
  ...
  public void test085()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("*jo6r:v(U");
      Zip64ExtendedInformationExtraField zip64ExtendedInformationExtraField0 = new Zip64ExtendedInformationExtraField();
      zipArchiveEntry0.addAsFirstExtraField(zip64ExtendedInformationExtraField0);
      byte[] byteArray0 = new byte[8];
  ...
  public void test088()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(")=]5yjC2XTrvMfztmmM");
      // Undeclared exception!
      try { 
        zipArchiveEntry0.setSize((-139L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test089()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setPlatform((-3409));
      byte[] byteArray0 = new byte[3];
      zipArchiveEntry0.setName("", byteArray0);
      assertEquals((-3409), zipArchiveEntry0.getPlatform());
  }
  ...
  public void test092()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "c;]H");
      // Undeclared exception!
      try { 
  ...
  public void test099()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("CA%");
      X0016_CertificateIdForCentralDirectory x0016_CertificateIdForCentralDirectory0 = new X0016_CertificateIdForCentralDirectory();
      zipArchiveEntry0.addExtraField(x0016_CertificateIdForCentralDirectory0);
  ...
  public void test101()  throws Throwable  {
      ...
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(")=]5yjC2XTrvMfztmmM", zipArchiveEntry0.toString());
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
  }
  ...
  public void test111()  throws Throwable  {
      ...
      boolean boolean0 = zipArchiveEntry0.isUnixSymlink();
      assertEquals((-851968L), zipArchiveEntry0.getExternalAttributes());
      assertTrue(boolean0);
  }
  ...
  public void test114()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("*jo6r:v(U");
      zipArchiveEntry0.setVersionMadeBy((-863));
      int int0 = zipArchiveEntry0.getVersionMadeBy();
  ...
  public void test115()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("7l[PB\"+7uQ`y+))<s");
      zipArchiveEntry0.setRawFlag(4611);
      int int0 = zipArchiveEntry0.getRawFlag();
  ...
  public void test117()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "z8)R4*4Y/4*mJU");
  ...
  public void test120()  throws Throwable  {
      ...
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals("7l[PB\"+7uQ`y+))<s", zipArchiveEntry0.toString());
  }
