...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      zipArchiveEntry0.setUnixMode((-1234567));
  ...
  public void test002()  throws Throwable  {
      ...
      zipArchiveEntry1.setInternalAttributes((-492));
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals((-492), zipArchiveEntry1.getInternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test004()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setUnixMode((-2712));
      byte[] byteArray0 = new byte[2];
      zipArchiveEntry0.setName("BsSYR$tY", byteArray0);
      assertEquals(3, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test006()  throws Throwable  {
      MockFile mockFile0 = new MockFile("K}q#.b?ZsQ");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "K}q#.b?ZsQ");
  ...
  public void test009()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("C\"E");
  ...
  public void test011()  throws Throwable  {
      MockFile mockFile0 = new MockFile("hAy");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "hAy");
      zipArchiveEntry0.setVersionMadeBy(1663);
  ...
  public void test012()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionMadeBy((-1612));
      int int0 = zipArchiveEntry0.getVersionMadeBy();
  ...
  public void test016()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("@cP^^Sxk*`1Q4");
      byte[] byteArray0 = new byte[6];
      zipArchiveEntry0.setName("@cP^^Sxk*`1Q4", byteArray0);
  ...
  public void test017()  throws Throwable  {
      File file0 = MockFile.createTempFile("{Xn7e6f", "{Xn7e6f");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "{Xn7e6f");
  ...
  public void test019()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("F7#P(");
  ...
  public void test020()  throws Throwable  {
      MockFile mockFile0 = new MockFile("1Jv~-Xp_NFKk5U:,", "/");
  ...
  public void test024()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("SW`wJEC ]bm \"d>=MP");
  ...
  public void test025()  throws Throwable  {
      MockFile mockFile0 = new MockFile("hAy");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "hAy");
      zipArchiveEntry0.setInternalAttributes((-2752));
      int int0 = zipArchiveEntry0.getInternalAttributes();
  ...
  public void test027()  throws Throwable  {
      File file0 = MockFile.createTempFile("pi[hzp%<AP,?:-_LfMG", "pi[hzp%<AP,?:-_LfMG");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "pi[hzp%<AP,?:-_LfMG");
      ...
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals("pi[hzp%<AP,?:-_LfMG", zipArchiveEntry0.toString());
  }
  ...
  public void test039()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("(@T-M:,{LV");
      // Undeclared exception!
      try { 
  ...
  public void test040()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("Ou");
  ...
  public void test050()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = null;
      try {
        zipArchiveEntry0 = new ZipArchiveEntry((File) null, "6{%>UGs1L52;FDX{SI%");
        fail("Expecting exception: NullPointerException");
  ...
  public void test057()  throws Throwable  {
      File file0 = MockFile.createTempFile("invalid entry size", "*Z]ni/");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "*Z]ni/");
      UnicodePathExtraField unicodePathExtraField0 = new UnicodePathExtraField();
  ...
  public void test062()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // ZIP compression method can not be negative: -1580
         //
         verifyException("org.apache.commons.compress.archivers.zip.ZipArchiveEntry", e);
      }
  }
  ...
  public void test069()  throws Throwable  {
      ...
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals("SW`wJEC ]bm \"d>=MP", zipArchiveEntry0.toString());
      assertEquals((-1), zipArchiveEntry0.getMethod());
  }
  ...
  public void test072()  throws Throwable  {
      ...
      UnicodeCommentExtraField unicodeCommentExtraField0 = new UnicodeCommentExtraField(")PK", byteArray0);
  ...
  public void test079()  throws Throwable  {
      ...
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(21589, zipArchiveEntry0.getInternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test080()  throws Throwable  {
      ...
      UnicodePathExtraField unicodePathExtraField0 = new UnicodePathExtraField("p8bYm3a", byteArray0);
  ...
  public void test082()  throws Throwable  {
      ...
      zipArchiveEntry1.setComment("Cd*~q;YQ`)myX;W");
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertFalse(boolean0);
  }
  ...
  public void test083()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("SW`wJEC ]bm \"d>=MP");
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("NsBT%83Db*,vR4=9t?");
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals("SW`wJEC ]bm \"d>=MP", zipArchiveEntry0.getName());
      assertEquals(0L, zipArchiveEntry1.getExternalAttributes());
      assertEquals(0, zipArchiveEntry1.getInternalAttributes());
      assertEquals((-1), zipArchiveEntry1.getMethod());
      assertFalse(boolean0);
  ...
  public void test084()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry0.equals("@fZq:!cCmK*T-");
      assertFalse(boolean0);
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
  ...
  public void test090()  throws Throwable  {
      ...
      zipArchiveEntry0.setName("hAy", byteArray0);
      zipArchiveEntry0.getRawName();
      assertEquals(0L, zipArchiveEntry0.getSize());
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1), zipArchiveEntry0.getMethod());
  ...
  public void test092()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("c>6!}V#dkpEj");
      // Undeclared exception!
      try { 
  ...
  public void test093()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setPlatform((-1715));
      byte[] byteArray0 = new byte[4];
      zipArchiveEntry0.setName("w9!/0C7j+2-/", byteArray0);
      assertEquals((-1715), zipArchiveEntry0.getPlatform());
  }

  @Test(timeout = 4000)
  public void test094()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("lW`wJEC ]bm \"dI=MP");
      assertEquals("lW`wJEC ]bm \"dI=MP", zipArchiveEntry0.toString());
  ...
  public void test106()  throws Throwable  {
      ...
      assertEquals((-177733631L), zipArchiveEntry0.getExternalAttributes());
      assertTrue(boolean0);
  }
  ...
  public void test113()  throws Throwable  {
      ...
      zipExtraFieldArray0[4] = (ZipExtraField) jarMarker0;
      byte[] byteArray0 = new byte[9];
      UnicodeCommentExtraField unicodeCommentExtraField0 = new UnicodeCommentExtraField("o!+z10hf", byteArray0);
  ...
  public void test115()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionRequired((-707));
      int int0 = zipArchiveEntry0.getVersionRequired();
  ...
  public void test119()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("<hEX\"`oF;W-");
