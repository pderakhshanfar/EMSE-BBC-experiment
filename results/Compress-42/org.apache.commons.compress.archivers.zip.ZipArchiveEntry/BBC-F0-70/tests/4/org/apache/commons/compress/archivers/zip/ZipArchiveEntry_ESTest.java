...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      zipArchiveEntry1.setExternalAttributes((-324L));
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals((-324L), zipArchiveEntry1.getExternalAttributes());
  ...
  public void test002()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      Object object0 = zipArchiveEntry0.clone();
      zipArchiveEntry0.setInternalAttributes(1014);
      Object object1 = zipArchiveEntry0.clone();
      boolean boolean0 = object0.equals(object1);
      assertEquals(1014, zipArchiveEntry0.getInternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test003()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      File file0 = MockFile.createTempFile("s<R=eh", "s<R=eh");
  ...
  public void test005()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("~Er{X=;B0V");
  ...
  public void test006()  throws Throwable  {
      File file0 = MockFile.createTempFile("AE)<aUx-\"q", "AE)<aUx-\"q", (File) null);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "AE)<aUx-\"q");
  ...
  public void test007()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionRequired(2695);
  ...
  public void test009()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionMadeBy((-2960));
  ...
  public void test011()  throws Throwable  {
      MockFile mockFile0 = new MockFile("z[i)DCxE#(<3L]W", "z[i)DCxE#(<3L]W");
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("z[i)DCxE#(<3L]W/z[i)DCxE#(<3L]W");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "z[i)DCxE#(<3L]W");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "z[i)DCxE#(<3L]W");
      long long0 = zipArchiveEntry0.getSize();
      assertEquals(15L, long0);
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals("z[i)DCxE#(<3L]W", zipArchiveEntry0.getName());
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
  }
  ...
  public void test014()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("n");
      zipArchiveEntry0.setRawFlag(1263);
  ...
  public void test015()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setRawFlag((-2622));
      int int0 = zipArchiveEntry0.getRawFlag();
  ...
  public void test017()  throws Throwable  {
      File file0 = MockFile.createTempFile("AE)<aUx-\"q", "AE)<aUx-\"q", (File) null);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "AE)<aUx-\"q");
      zipArchiveEntry0.setPlatform((-1232));
      int int0 = zipArchiveEntry0.getPlatform();
  ...
  public void test018()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("$OS+)TyljA5jLk&m^0");
  ...
  public void test022()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setInternalAttributes((-2145905775));
      int int0 = zipArchiveEntry0.getInternalAttributes();
      assertEquals((-2145905775), int0);
  }

  @Test(timeout = 4000)
  public void test023()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Ve(*i3q{7mjnC$", "cx;ow^E2xyFn:^SY");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "cx;ow^E2xyFn:^SY");
  ...
  public void test027()  throws Throwable  {
      MockFile mockFile0 = new MockFile("z[i)DCxE#(<3L]W", "z[i)DCxE#(<3L]W");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "z[i)DCxE#(<3L]W");
      zipArchiveEntry0.setUnixMode(1421);
      long long0 = zipArchiveEntry0.getExternalAttributes();
      assertEquals(1421, zipArchiveEntry0.getUnixMode());
      assertEquals(93126656L, long0);
  }
  ...
  public void test051()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = null;
      try {
        zipArchiveEntry0 = new ZipArchiveEntry((File) null, "5R6aDN");
        fail("Expecting exception: NullPointerException");
  ...
  public void test052()  throws Throwable  {
      ...
      zipArchiveEntry0.setName("`.O]Hi|}VyBT8if\"", byteArray0);
      assertEquals(65453, zipArchiveEntry0.getUnixMode());
  }
  ...
  public void test059()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setUnixMode((-6178));
      int int0 = zipArchiveEntry0.getUnixMode();
      assertEquals((-404881408L), zipArchiveEntry0.getExternalAttributes());
      assertEquals(59358, int0);
  }
  ...
  public void test061()  throws Throwable  {
      MockFile mockFile0 = new MockFile("xo&*hVPFxLoP4#");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "invalid entry size");
      // Undeclared exception!
      try { 
        zipArchiveEntry0.setMethod((-6178));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // ZIP compression method can not be negative: -6178
         //
         verifyException("org.apache.commons.compress.archivers.zip.ZipArchiveEntry", e);
      }
  }
  ...
  public void test062()  throws Throwable  {
      MockFile mockFile0 = new MockFile(" - ", ",{'L'Ts,5~Y_s");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, " - ");
      long long0 = zipArchiveEntry0.getSize();
      assertEquals(0, zipArchiveEntry0.getPlatform());
  ...
  public void test072()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setCompressedSize(691L);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(0, zipArchiveEntry1.getPlatform());
      assertEquals((-1L), zipArchiveEntry1.getSize());
  ...
  public void test080()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("$OS+)TyljA5jLk&m^0");
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(0, zipArchiveEntry1.getPlatform());
      assertEquals(0, zipArchiveEntry1.getInternalAttributes());
      assertEquals((-1), zipArchiveEntry1.getMethod());
  ...
  public void test086()  throws Throwable  {
      ...
      zipArchiveEntry0.setName("Lrv/", byteArray0);
      zipArchiveEntry0.getRawName();
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals((-1), zipArchiveEntry0.getMethod());
  ...
  public void test088()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveEntry0.setSize((-3155L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test089()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setPlatform((-419));
      zipArchiveEntry0.setName("y");
      assertEquals((-419), zipArchiveEntry0.getPlatform());
  }
  ...
  public void test097()  throws Throwable  {
      ...
      UnicodePathExtraField unicodePathExtraField0 = new UnicodePathExtraField("!vp-@Iq 1R]S(Q[", byteArray0, (byte)0, 3);
      zipArchiveEntry0.addAsFirstExtraField(unicodePathExtraField0);
      zipArchiveEntry0.addExtraField(unicodePathExtraField0);
      assertEquals(0, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test100()  throws Throwable  {
      File file0 = MockFile.createTempFile("ZIP compression method can not be negative: ", "4");
  ...
  public void test105()  throws Throwable  {
      File file0 = MockFile.createTempFile("<%1{'b\"", "<%1{'b\"");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "//");
      zipArchiveEntry0.setUnixMode((-947));
      assertEquals(3, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test113()  throws Throwable  {
      ...
      zipArchiveEntry0.setUnixMode((-1862));
      boolean boolean0 = zipArchiveEntry0.isUnixSymlink();
      assertEquals((-122028032L), zipArchiveEntry0.getExternalAttributes());
      assertTrue(boolean0);
  }
  ...
  public void test114()  throws Throwable  {
      ...
      zipArchiveEntry1.setComment("8oQ");
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(0, zipArchiveEntry0.getMethod());
      assertFalse(boolean0);
  }
  ...
  public void test115()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("J$Iu}PPo1:;\"X:!3Ldk");
      int int0 = zipArchiveEntry0.getVersionMadeBy();
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
