...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("X[;gN+Ib<k3[");
      zipArchiveEntry0.setUnixMode((-1));
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("X[;gN+Ib<k3[");
  ...
  public void test004()  throws Throwable  {
      MockFile mockFile0 = new MockFile("0DIDDxv9'", "0DIDDxv9'");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "0DIDDxv9'");
  ...
  public void test005()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Jn~Ss75tpm^hm7C-Hv~");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "Jn~Ss75tpm^hm7C-Hv~");
      zipArchiveEntry0.setPlatform(2163);
      zipArchiveEntry0.getUnixMode();
      assertEquals(2163, zipArchiveEntry0.getPlatform());
  }

  @Test(timeout = 4000)
  public void test006()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("X[;gN+Ib<k3[");
      zipArchiveEntry0.setMethod(3354);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry((ZipEntry) zipArchiveEntry0);
      assertEquals(3354, zipArchiveEntry0.getMethod());
  }
  ...
  public void test009()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionRequired((-3854));
      int int0 = zipArchiveEntry0.getVersionRequired();
  ...
  public void test010()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(">^7DD<@X");
  ...
  public void test011()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("X[;gN+Ib<k3[");
      zipArchiveEntry0.setVersionMadeBy((-834));
      int int0 = zipArchiveEntry0.getVersionMadeBy();
  ...
  public void test014()  throws Throwable  {
      MockFile mockFile0 = new MockFile("s=L7^?=K@a", "s=L7^?=K@a");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "s=L7^?=K@a");
  ...
  public void test016()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setRawFlag(955);
  ...
  public void test019()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setPlatform((-626));
      int int0 = zipArchiveEntry0.getPlatform();
  ...
  public void test021()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setMethod(554);
      int int0 = zipArchiveEntry0.getMethod();
  ...
  public void test023()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("7OX81 3vF5T _z");
      zipArchiveEntry0.setInternalAttributes((-3191));
      int int0 = zipArchiveEntry0.getInternalAttributes();
  ...
  public void test027()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(")4=ahmYAHqkXg0(j47");
  ...
  public void test054()  throws Throwable  {
      ...
      zipArchiveEntry0.setName("X[;gN+Ib<k3[", byteArray0);
      assertEquals(3, zipArchiveEntry0.getPlatform());
  }

  @Test(timeout = 4000)
  public void test055()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("X[;gN+Ib<k3l");
      String string0 = zipArchiveEntry0.getName();
      assertEquals("X[;gN+Ib<k3l", string0);
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
  ...
  public void test064()  throws Throwable  {
      ...
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals("X[;gN+Ib<k3[", zipArchiveEntry0.getName());
  }
  ...
  public void test078()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setMethod(526);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(526, zipArchiveEntry0.getMethod());
      assertFalse(boolean0);
  }
  ...
  public void test079()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = (ZipArchiveEntry)zipArchiveEntry0.clone();
      zipArchiveEntry1.setExternalAttributes(961L);
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(961L, zipArchiveEntry1.getExternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test081()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = (ZipArchiveEntry)zipArchiveEntry0.clone();
      zipArchiveEntry1.setInternalAttributes((-743));
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals((-743), zipArchiveEntry1.getInternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test083()  throws Throwable  {
      MockFile mockFile0 = new MockFile("0DIDDxv9'");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "0DIDDxv9'");
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("0DIDDxv9'");
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertFalse(boolean0);
      assertEquals(0, zipArchiveEntry1.getPlatform());
      assertEquals((-1), zipArchiveEntry1.getMethod());
  ...
  public void test084()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setComment("y%dn");
      ZipArchiveEntry zipArchiveEntry1 = (ZipArchiveEntry)zipArchiveEntry0.clone();
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertTrue(boolean0);
  ...
  public void test085()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("oC\"");
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("xj[$");
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertFalse(boolean0);
      assertEquals(0, zipArchiveEntry1.getPlatform());
      assertEquals((-1L), zipArchiveEntry1.getSize());
      assertEquals((-1), zipArchiveEntry1.getMethod());
      assertEquals("xj[$", zipArchiveEntry1.toString());
      assertEquals(0L, zipArchiveEntry1.getExternalAttributes());
      assertEquals(0, zipArchiveEntry1.getInternalAttributes());
  }
  ...
  public void test093()  throws Throwable  {
      ...
      assertEquals((-626), zipArchiveEntry0.getPlatform());
  }
  ...
  public void test095()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[7];
      UnicodePathExtraField unicodePathExtraField0 = new UnicodePathExtraField("4g*^hmYeu_ %Uo", byteArray0);
  ...
  public void test116()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("[@WX>fg17l9=$9Oz,&");
      ...
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals("[@WX>fg17l9=$9Oz,&", zipArchiveEntry0.getName());
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
  }
  ...
  public void test117()  throws Throwable  {
      ...
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals("X[;gN+Ib<k3[", zipArchiveEntry0.toString());
      assertEquals(0, int0);
  }
  ...
  public void test118()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      byte[] byteArray0 = new byte[3];
      zipArchiveEntry0.setName(",M9E", byteArray0);
  ...
  public void test124()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setGeneralPurposeBit((GeneralPurposeBit) null);
      zipArchiveEntry0.setMethod(1170);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry(zipArchiveEntry0);
      assertEquals(1170, zipArchiveEntry0.getMethod());
  }
