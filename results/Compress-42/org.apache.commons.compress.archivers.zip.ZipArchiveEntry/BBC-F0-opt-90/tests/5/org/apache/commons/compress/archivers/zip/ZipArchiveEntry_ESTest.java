...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      zipArchiveEntry0.setExternalAttributes(1983L);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(1983L, zipArchiveEntry0.getExternalAttributes());
  ...
  public void test004()  throws Throwable  {
      MockFile mockFile0 = new MockFile("}C?d9u@7~", "}C?d9u@7~");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "}C?d9u@7~");
      zipArchiveEntry0.setUnixMode((-3976));
      byte[] byteArray0 = new byte[0];
      zipArchiveEntry0.setName("/experiment/}C?d9u@7~/}C?d9u@7~", byteArray0);
      assertEquals(3, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test009()  throws Throwable  {
      MockFile mockFile0 = new MockFile("1fPW3k/$v*1aLuN", "d-}Hl=rE.{$y5Q+Y:'l/");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "d-}Hl=rE.{$y5Q+Y:'l/");
  ...
  public void test010()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionRequired(2751);
  ...
  public void test011()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionRequired((-898));
      int int0 = zipArchiveEntry0.getVersionRequired();
  ...
  public void test014()  throws Throwable  {
      MockFile mockFile0 = new MockFile("}C?d9u@7~", "}C?d9u@7~");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "}C?d9u@7~");
      zipArchiveEntry0.setSize(1256L);
  ...
  public void test016()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("sv[H");
      byte[] byteArray0 = new byte[7];
      zipArchiveEntry0.setName("sv[H", byteArray0);
      zipArchiveEntry0.getRawName();
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals("sv[H", zipArchiveEntry0.getName());
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1L), zipArchiveEntry0.getSize());
  }
  ...
  public void test017()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("sv[H");
      zipArchiveEntry0.setRawFlag(789);
  ...
  public void test018()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setRawFlag((-1636));
      int int0 = zipArchiveEntry0.getRawFlag();
  ...
  public void test020()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("<: yz52?tH/Hl;/");
      assertEquals(0, zipArchiveEntry0.getPlatform());
  ...
  public void test025()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("MVFlVc3");
      zipArchiveEntry0.setInternalAttributes((-1180));
      int int0 = zipArchiveEntry0.getInternalAttributes();
  ...
  public void test027()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("I8lXKEa");
  ...
  public void test031()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setUnixMode((-97266133));
      long long0 = zipArchiveEntry0.getExternalAttributes();
      assertEquals((-701825023L), long0);
  }
  ...
  public void test062()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveEntry0.setMethod((-3976));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // ZIP compression method can not be negative: -3976
         //
         verifyException("org.apache.commons.compress.archivers.zip.ZipArchiveEntry", e);
      }
  }
  ...
  public void test071()  throws Throwable  {
      ...
      zipArchiveEntry1.setCompressedSize((-4130L));
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertFalse(boolean0);
  }
  ...
  public void test075()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      zipArchiveEntry0.setExternalAttributes(255);
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
  ...
  public void test077()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = (ZipArchiveEntry)zipArchiveEntry0.clone();
      zipArchiveEntry1.setInternalAttributes((-3056));
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals((-3056), zipArchiveEntry1.getInternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test078()  throws Throwable  {
      ...
      zipArchiveEntry1.setComment("\"v[L8L?0&,S\"q}0ZG");
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
  ...
  public void test079()  throws Throwable  {
      ...
      zipArchiveEntry1.setTime((-2965L));
  ...
  public void test081()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("04s<RyV");
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertFalse(boolean0);
      assertEquals((-1), zipArchiveEntry1.getMethod());
      assertEquals(0, zipArchiveEntry1.getPlatform());
  ...
  public void test091()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("8v=@@D~qmc({4");
      // Undeclared exception!
      try { 
  ...
  public void test095()  throws Throwable  {
      File file0 = MockFile.createTempFile(" Modify:[", "'%Xm[");
  ...
  public void test106()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setUnixMode((-1926));
      boolean boolean0 = zipArchiveEntry0.isUnixSymlink();
      assertEquals(3, zipArchiveEntry0.getPlatform());
      assertTrue(boolean0);
  }
  ...
  public void test107()  throws Throwable  {
      MockFile mockFile0 = new MockFile("&4$zuG9RQ?<0Uf", "d-}Hl=rE.{$y5Q+Y:'l/");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "d-}Hl=rE.{$y5Q+Y:'l/");
  ...
  public void test109()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, ">");
      zipArchiveEntry0.setExternalAttributes(1256L);
      long long0 = zipArchiveEntry0.getExternalAttributes();
      assertEquals(1256L, long0);
  }
  ...
  public void test110()  throws Throwable  {
      MockFile mockFile0 = new MockFile("-xp2&7{fvI5EpK>m8K/", "Error parsing extra fields for entry: ");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "5N(aq;=jgLR-R`wS");
      X0017_StrongEncryptionHeader x0017_StrongEncryptionHeader0 = new X0017_StrongEncryptionHeader();
  ...
  public void test115()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("%cO+");
      zipArchiveEntry0.setPlatform((-2146401245));
      byte[] byteArray0 = new byte[0];
      zipArchiveEntry0.setName("%cO+", byteArray0);
      assertEquals((-2146401245), zipArchiveEntry0.getPlatform());
  }
  ...
  public void test117()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionMadeBy(1593);
      int int0 = zipArchiveEntry0.getVersionMadeBy();
