...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      zipArchiveEntry0.setExternalAttributes((-53L));
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals((-53L), zipArchiveEntry0.getExternalAttributes());
  ...
  public void test004()  throws Throwable  {
      ...
      zipArchiveEntry0.setName(",VJ(K", byteArray0);
  ...
  public void test006()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setPlatform(1578);
      boolean boolean0 = zipArchiveEntry0.isUnixSymlink();
      assertEquals(1578, zipArchiveEntry0.getPlatform());
      assertFalse(boolean0);
  }
  ...
  public void test008()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(".1H}>JR5o3j?x");
  ...
  public void test009()  throws Throwable  {
      MockFile mockFile0 = new MockFile("IW|CgI", "IW|CgI");
  ...
  public void test012()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("ZipShort vualue: /ZipShort vualue: ");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "q3J%C");
      MockFile mockFile0 = new MockFile("ZipShort vualue: ", "ZipShort vualue: ");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "ZipShort vualue: ");
  ...
  public void test013()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(">(geF(f?YR");
      long long0 = zipArchiveEntry0.getSize();
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0, zipArchiveEntry0.getPlatform());
  ...
  public void test014()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("V_D]D_v");
      byte[] byteArray0 = new byte[2];
      zipArchiveEntry0.setName("V_D]D_v", byteArray0);
      ...
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals("V_D]D_v", zipArchiveEntry0.toString());
  }

  @Test(timeout = 4000)
  public void test015()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setRawFlag((-954));
  ...
  public void test018()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(">(geF(f4Y(R");
  ...
  public void test019()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("\"k97nS~;vJ|a:#y3h");
      assertEquals((-1), zipArchiveEntry0.getMethod());
  ...
  public void test022()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setInternalAttributes(780);
  ...
  public void test028()  throws Throwable  {
      ...
      assertEquals(3, zipArchiveEntry0.getPlatform());
      assertEquals(1900545L, long0);
  }

  @Test(timeout = 4000)
  public void test029()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setUnixMode((-1320));
      long long0 = zipArchiveEntry0.getExternalAttributes();
      assertEquals(3, zipArchiveEntry0.getPlatform());
      assertEquals((-86507520L), long0);
  }
  ...
  public void test031()  throws Throwable  {
      ...
      ZipEightByteInteger zipEightByteInteger0 = new ZipEightByteInteger((-1166L));
  ...
  public void test035()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("p6xS|");
  ...
  public void test050()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = null;
      try {
        zipArchiveEntry0 = new ZipArchiveEntry((File) null, "\u0006o`c2cq;Q#[DahRJ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test052()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(" )'c0[^@W(9IWz");
      byte[] byteArray0 = zipArchiveEntry0.getLocalFileDataExtra();
      assertNotNull(byteArray0);
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals(" )'c0[^@W(9IWz", zipArchiveEntry0.getName());
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals((-1L), zipArchiveEntry0.getSize());
  }
  ...
  public void test059()  throws Throwable  {
      File file0 = MockFile.createTempFile("\"k97nS~;vJ|a:#y3h", "~");
  ...
  public void test061()  throws Throwable  {
      ...
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals(" )'c0[^@W(9IWz", zipArchiveEntry0.toString());
      assertEquals((-1), int0);
  }
  ...
  public void test069()  throws Throwable  {
      MockFile mockFile0 = new MockFile("q_n4LVJS'{;<E=_BX`w/", "Ck}3mJHgg");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "q_n4LVJS'{;<E=_BX`w/");
      zipArchiveEntry0.setMethod(65535);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry((ZipEntry) zipArchiveEntry0);
      zipArchiveEntry1.setCompressedSize(65535);
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
  ...
  public void test071()  throws Throwable  {
      MockFile mockFile0 = new MockFile("q_n4LVJS'{;<E=_BX`w/", "Ck}3mJHgg");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "q_n4LVJS'{;<E=_BX`w/");
      zipArchiveEntry0.setMethod(65505);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry((ZipEntry) zipArchiveEntry0);
      zipArchiveEntry1.setSize(2046L);
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(65505, zipArchiveEntry0.getMethod());
      assertFalse(boolean0);
  }
  ...
  public void test074()  throws Throwable  {
      ...
      zipArchiveEntry0.setUnixMode(1369);
      zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(3, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test075()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setInternalAttributes((-261));
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals((-261), zipArchiveEntry0.getInternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test078()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setComment("zCvaOF-/");
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals((-1), zipArchiveEntry1.getMethod());
  ...
  public void test089()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("O5@b|']");
      zipArchiveEntry0.setUnixMode((-55));
      zipArchiveEntry0.setName("O5@b|']", (byte[]) null);
  ...
  public void test104()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(">(geF(f4Y(R");
      zipArchiveEntry0.setUnixMode((-2662));
      boolean boolean0 = zipArchiveEntry0.isUnixSymlink();
      assertEquals(62874, zipArchiveEntry0.getUnixMode());
      assertTrue(boolean0);
  }
  ...
  public void test106()  throws Throwable  {
      ...
      mockFile1.mkdir();
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile1, "Gq%@:vXnU_[ufMn_h5");
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals((-1L), zipArchiveEntry0.getSize());
