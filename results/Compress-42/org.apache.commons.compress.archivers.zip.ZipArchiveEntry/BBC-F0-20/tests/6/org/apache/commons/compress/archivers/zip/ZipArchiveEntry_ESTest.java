...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      zipArchiveEntry0.setExternalAttributes((-1550L));
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals((-1550L), zipArchiveEntry0.getExternalAttributes());
  ...
  public void test004()  throws Throwable  {
      ...
      zipArchiveEntry0.setName(".?co+", byteArray0);
      assertEquals(3, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test010()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(".?co+");
      zipArchiveEntry0.setVersionRequired((-3320));
      int int0 = zipArchiveEntry0.getVersionRequired();
  ...
  public void test016()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      byte[] byteArray0 = new byte[1];
      zipArchiveEntry0.setName("9n#UvIu?`tB@Dr", byteArray0);
  ...
  public void test021()  throws Throwable  {
      ...
      zipArchiveEntry0.setMethod(3638);
      int int0 = zipArchiveEntry0.getMethod();
  ...
  public void test023()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setInternalAttributes(1255);
  ...
  public void test024()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("I~jS7Z]U5");
      zipArchiveEntry0.setInternalAttributes((-2085));
      int int0 = zipArchiveEntry0.getInternalAttributes();
  ...
  public void test027()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(".?co+");
      zipArchiveEntry0.setExternalAttributes(3533L);
  ...
  public void test030()  throws Throwable  {
      ...
      UnicodeCommentExtraField unicodeCommentExtraField0 = new UnicodeCommentExtraField("org.apache.commons.compress.archivers.zip.Zip64ExtendedInformationExtraField", byteArray0);
      ...
      ZipEightByteInteger zipEightByteInteger0 = new ZipEightByteInteger((-1816L));
  ...
  public void test043()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("KZf$MK");
      UnrecognizedExtraField unrecognizedExtraField0 = new UnrecognizedExtraField();
      // Undeclared exception!
      try { 
  ...
  public void test054()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("mw<VY>FH");
  ...
  public void test067()  throws Throwable  {
      ...
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals("I~jS7Z]U5", zipArchiveEntry0.getName());
      assertEquals(0, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test071()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setCompressedSize((-6917L));
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
  ...
  public void test073()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("H");
      ZipArchiveEntry zipArchiveEntry1 = (ZipArchiveEntry)zipArchiveEntry0.clone();
      zipArchiveEntry1.setSize(1023L);
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(1023L, zipArchiveEntry1.getSize());
      assertFalse(boolean0);
  }
  ...
  public void test074()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setMethod(2146468289);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(2146468289, zipArchiveEntry0.getMethod());
      assertFalse(boolean0);
  }
  ...
  public void test076()  throws Throwable  {
      ...
      assertEquals(3, zipArchiveEntry0.getPlatform());
      assertEquals((-20774912L), zipArchiveEntry0.getExternalAttributes());
  }
  ...
  public void test081()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("q}J>1[mu8|?j(4UE");
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(0, zipArchiveEntry1.getPlatform());
      assertFalse(boolean0);
      assertEquals(0, zipArchiveEntry1.getInternalAttributes());
      assertEquals(0L, zipArchiveEntry1.getExternalAttributes());
      assertEquals((-1), zipArchiveEntry1.getMethod());
      assertEquals("q}J>1[mu8|?j(4UE", zipArchiveEntry1.getName());
      assertEquals((-1L), zipArchiveEntry1.getSize());
  }
  ...
  public void test082()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("I~jS7Z]U5");
      boolean boolean0 = zipArchiveEntry0.equals("I~jS7Z]U5");
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertFalse(boolean0);
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals("I~jS7Z]U5", zipArchiveEntry0.toString());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test084()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("IG9oBCHWd");
  ...
  public void test091()  throws Throwable  {
      ...
      zipArchiveEntry0.setPlatform((-18548323));
      byte[] byteArray0 = new byte[0];
      zipArchiveEntry0.setName("6/h;B~59gp.2", byteArray0);
      assertEquals((-18548323), zipArchiveEntry0.getPlatform());
  }
  ...
  public void test104()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("SR+\"|(yAcfKmg1H");
  ...
  public void test107()  throws Throwable  {
      MockFile mockFile0 = new MockFile("$!p\"a>Z2 {,QR!DZQ/");
  ...
  public void test110()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "v6ZzR`*");
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
  ...
  public void test119()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("SR+\"|(yAcfKmg1H");
      zipArchiveEntry0.setRawFlag((-2514));
      int int0 = zipArchiveEntry0.getRawFlag();
