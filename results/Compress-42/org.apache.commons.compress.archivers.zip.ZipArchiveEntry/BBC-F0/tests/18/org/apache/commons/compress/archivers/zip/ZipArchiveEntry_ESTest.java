...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      MockFile mockFile0 = new MockFile("=:$`U.TvK'CwM4/", "QM>{7\"Ms*_z;GjfU]{i");
  ...
  public void test003()  throws Throwable  {
      File file0 = MockFile.createTempFile("f.0isGGf 2{$#P9", "f.0isGGf 2{$#P9");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "f.0isGGf 2{$#P9");
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("f.0isGGf 2{$#P9");
  ...
  public void test005()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(".XV");
  ...
  public void test006()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setMethod(2146915957);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry((ZipEntry) zipArchiveEntry0);
      assertEquals(2146915957, zipArchiveEntry0.getMethod());
      assertEquals(0, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test007()  throws Throwable  {
      ...
      zipArchiveEntry0.setName(";v18Zd/", byteArray0);
      boolean boolean0 = zipArchiveEntry0.isDirectory();
      assertEquals(";v18Zd/", zipArchiveEntry0.getName());
      assertTrue(boolean0);
  }
  ...
  public void test008()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionRequired(4766);
  ...
  public void test009()  throws Throwable  {
      File file0 = MockFile.createTempFile("f.0isGGf 2{$#P9", "f.0isGGf 2{$#P9");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "f.0isGGf 2{$#P9");
      zipArchiveEntry0.setVersionMadeBy(3865);
  ...
  public void test011()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "(ilrNkDJ)7tUo/");
  ...
  public void test013()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("O$n#76M");
      byte[] byteArray0 = new byte[2];
      zipArchiveEntry0.setName("O$n#76M", byteArray0);
  ...
  public void test014()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setRawFlag((-2146765425));
  ...
  public void test015()  throws Throwable  {
      ...
      assertEquals(64, zipArchiveEntry0.getUnixMode());
      assertEquals(3, int0);
  }

  @Test(timeout = 4000)
  public void test016()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("g JvQ `LFad'\u0002q)*|");
  ...
  public void test028()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setUnixMode((-1574));
      long long0 = zipArchiveEntry0.getExternalAttributes();
      assertEquals(63962, zipArchiveEntry0.getUnixMode());
      assertEquals((-103153664L), long0);
  }
  ...
  public void test029()  throws Throwable  {
      ...
      UnicodeCommentExtraField unicodeCommentExtraField0 = new UnicodeCommentExtraField("@n!rez[ ;[i", byteArray0);
  ...
  public void test031()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("f.0isGGf 2{$#P9");
  ...
  public void test036()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("]sS_=^U5JG");
  ...
  public void test037()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipEightByteInteger zipEightByteInteger0 = new ZipEightByteInteger(946L);
  ...
  public void test045()  throws Throwable  {
      ZipEntry zipEntry0 = new ZipEntry("mhW`ibGe6Z7Ia$u9");
      ZipArchiveEntry zipArchiveEntry0 = null;
      try {
  ...
  public void test047()  throws Throwable  {
      MockFile mockFile0 = new MockFile("yoNJYseb+5", "o");
      ZipArchiveEntry zipArchiveEntry0 = null;
      try {
  ...
  public void test052()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("?.L|[&");
      ZipShort zipShort0 = new ZipShort((-1369));
  ...
  public void test056()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveEntry0.setMethod((-3765));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // ZIP compression method can not be negative: -3765
         //
         verifyException("org.apache.commons.compress.archivers.zip.ZipArchiveEntry", e);
      }
  }
  ...
  public void test063()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("C]u$>y|a;G");
      int int0 = zipArchiveEntry0.getInternalAttributes();
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0, int0);
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals("C]u$>y|a;G", zipArchiveEntry0.getName());
      assertEquals(0, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test068()  throws Throwable  {
      ...
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(4294967295L, zipArchiveEntry1.getSize());
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test069()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("S<o3ZSk&U");
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("S<o3ZSk&U");
  ...
  public void test070()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("%`9");
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("%`9");
      zipArchiveEntry1.setExternalAttributes((-1130L));
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals((-1130L), zipArchiveEntry1.getExternalAttributes());
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test071()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("ZIP compression meth?d can not be negative: ");
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("ZIP compression meth?d can not be negative: ");
  ...
  public void test074()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("$u,G/g6H1S0[%b;");
      FileTime fileTime0 = FileTime.fromMillis(67);
      zipArchiveEntry0.setLastModifiedTime(fileTime0);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("$u,G/g6H1S0[%b;");
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(0L, zipArchiveEntry1.getExternalAttributes());
      assertFalse(zipArchiveEntry0.equals((Object)zipArchiveEntry1));
      assertEquals(0, zipArchiveEntry1.getInternalAttributes());
  ...
  public void test081()  throws Throwable  {
      ...
      zipArchiveEntry0.setName("=:$`U.TvK'CwM4//", byteArray0);
      zipArchiveEntry0.getRawName();
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
  ...
  public void test083()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(" 1&=|Lb}/");
      // Undeclared exception!
      try { 
        zipArchiveEntry0.setSize((-2989L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test090()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("vL|[&");
      ZipExtraField[] zipExtraFieldArray0 = new ZipExtraField[6];
      Zip64ExtendedInformationExtraField zip64ExtendedInformationExtraField0 = new Zip64ExtendedInformationExtraField();
      zipExtraFieldArray0[0] = (ZipExtraField) zip64ExtendedInformationExtraField0;
      zipExtraFieldArray0[1] = (ZipExtraField) zip64ExtendedInformationExtraField0;
      byte[] byteArray0 = new byte[1];
      UnicodeCommentExtraField unicodeCommentExtraField0 = new UnicodeCommentExtraField("vL|[&", byteArray0);
      zipExtraFieldArray0[2] = (ZipExtraField) unicodeCommentExtraField0;
      UnicodePathExtraField unicodePathExtraField0 = new UnicodePathExtraField("]96]=W}Ov/", byteArray0);
  ...
  public void test100()  throws Throwable  {
      MockFile mockFile0 = new MockFile("n!reyN ;[///");
      mockFile0.mkdirs();
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "n!reyN ;[///");
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals((-1L), zipArchiveEntry0.getSize());
  ...
  public void test101()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setMethod(2146915981);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry(zipArchiveEntry0);
      assertEquals(2146915981, zipArchiveEntry0.getMethod());
      assertTrue(zipArchiveEntry1.equals((Object)zipArchiveEntry0));
  }
  ...
  public void test105()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(">");
      zipArchiveEntry0.setVersionRequired((-2926));
      int int0 = zipArchiveEntry0.getVersionRequired();
  ...
  public void test106()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("f.0isGGf 2{$#P9//");
      zipArchiveEntry0.setUnixMode((byte)56);
      assertEquals(3, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test107()  throws Throwable  {
      ...
      zipArchiveEntry0.setPlatform((-1570));
      zipArchiveEntry0.setName("o");
      assertEquals((-1570), zipArchiveEntry0.getPlatform());
  }
  ...
  public void test110()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setRawFlag(3563);
      int int0 = zipArchiveEntry0.getRawFlag();
