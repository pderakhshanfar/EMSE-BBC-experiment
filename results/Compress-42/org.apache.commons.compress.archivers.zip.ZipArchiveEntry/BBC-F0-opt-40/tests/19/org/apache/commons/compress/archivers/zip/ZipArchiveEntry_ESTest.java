...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      ...
      zipArchiveEntry0.setTime(513L);
      zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(499, zipArchiveEntry0.getMethod());
  ...
  public void test004()  throws Throwable  {
      ...
      zipArchiveEntry0.setName("YP=]'1N<gm");
  ...
  public void test006()  throws Throwable  {
      File file0 = MockFile.createTempFile("=>[iyzXB>@|i{NB", "=>[iyzXB>@|i{NB");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "=>[iyzXB>@|i{NB");
  ...
  public void test010()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionRequired((-231));
      int int0 = zipArchiveEntry0.getVersionRequired();
  ...
  public void test011()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("Z+Iw Jwu=b]ijNJ..A");
      zipArchiveEntry0.setVersionMadeBy((-2850));
  ...
  public void test013()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "dc87b8yr38fn");
  ...
  public void test015()  throws Throwable  {
      ...
      zipArchiveEntry0.setName("Fm]zAByW[", byteArray0);
      zipArchiveEntry0.getRawName();
      assertEquals("Fm]zAByW[", zipArchiveEntry0.getName());
  }
  ...
  public void test016()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile(uRI0);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "dc87b8yr38fn");
      zipArchiveEntry0.setRawFlag(1517);
  ...
  public void test020()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("klciTZP**");
  ...
  public void test022()  throws Throwable  {
      File file0 = MockFile.createTempFile("`|i:~<u`CD2/", "`|i:~<u`CD2/", (File) null);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "`|i:~<u`CD2/");
      zipArchiveEntry0.setInternalAttributes((-2116));
      int int0 = zipArchiveEntry0.getInternalAttributes();
  ...
  public void test023()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("|j/O {F[$|");
  ...
  public void test024()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("!Or-gVt:$^");
  ...
  public void test026()  throws Throwable  {
      MockFile mockFile0 = new MockFile("VIQ", "VIQ");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "VIQ");
      GeneralPurposeBit generalPurposeBit0 = new GeneralPurposeBit();
  ...
  public void test029()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setUnixMode((-695));
      long long0 = zipArchiveEntry0.getExternalAttributes();
      assertEquals(3, zipArchiveEntry0.getPlatform());
      assertEquals((-45547519L), long0);
  }
  ...
  public void test035()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("eu:#rv~.p]_aqW`>%E");
      // Undeclared exception!
      try { 
  ...
  public void test041()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "{e?*)T");
      // Undeclared exception!
      try { 
  ...
  public void test052()  throws Throwable  {
      ...
      assertEquals(0L, zipArchiveEntry0.getSize());
      assertEquals("=>[iyzXB>@|i{NB", string0);
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals((-1), zipArchiveEntry0.getMethod());
  ...
  public void test055()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("b,R(F}");
      zipArchiveEntry0.getExtraField((ZipShort) null);
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
  ...
  public void test059()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("@_ 7[gi'W");
      UnparseableExtraFieldData unparseableExtraFieldData0 = new UnparseableExtraFieldData();
  ...
  public void test060()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("=AZz)VOv");
      // Undeclared exception!
      try { 
        zipArchiveEntry0.setMethod((-1645));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // ZIP compression method can not be negative: -1645
         //
         verifyException("org.apache.commons.compress.archivers.zip.ZipArchiveEntry", e);
      }
  }
  ...
  public void test072()  throws Throwable  {
      ...
      zipArchiveEntry1.setCompressedSize((-237L));
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertFalse(boolean0);
  }
  ...
  public void test074()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(568L, zipArchiveEntry0.getSize());
      assertFalse(boolean0);
  }
  ...
  public void test075()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setMethod(1867);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(1867, zipArchiveEntry0.getMethod());
      assertFalse(boolean0);
  }
  ...
  public void test076()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setExternalAttributes((-703L));
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals((-703L), zipArchiveEntry0.getExternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test078()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setInternalAttributes((-2145771140));
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals((-2145771140), zipArchiveEntry0.getInternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test086()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      byte[] byteArray0 = zipArchiveEntry0.getLocalFileDataExtra();
      zipArchiveEntry0.setName("aOp8m<uG{X>)/", byteArray0);
  ...
  public void test088()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "LS/MR:UH#R");
      // Undeclared exception!
      try { 
        zipArchiveEntry0.setSize((-590L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test089()  throws Throwable  {
      ...
      zipArchiveEntry0.setName("aOp8m<uG{X>)/", (byte[]) null);
      assertEquals("aOp8m<uG{X>)/", zipArchiveEntry0.toString());
  }
  ...
  public void test092()  throws Throwable  {
      ...
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals("=>[iyzXB>@|i{NB", zipArchiveEntry0.toString());
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(0L, zipArchiveEntry0.getSize());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
  }
  ...
  public void test102()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(" gWn+?Dk|'Qx{'>Bk/a");
      boolean boolean0 = zipArchiveEntry0.isUnixSymlink();
      assertFalse(boolean0);
      assertEquals((-1L), zipArchiveEntry0.getSize());
  ...
  public void test103()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile(uRI0);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "TripleDES192/");
      zipArchiveEntry0.setUnixMode(1517);
      assertEquals(99418128L, zipArchiveEntry0.getExternalAttributes());
  }
  ...
  public void test105()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "0i,IcnV#2");
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
