...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      zipArchiveEntry0.setExternalAttributes(3044L);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(3044L, zipArchiveEntry0.getExternalAttributes());
  ...
  public void test001()  throws Throwable  {
      ...
      zipArchiveEntry1.setUnixMode((byte)3);
  ...
  public void test004()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("*=s4]cs\"p");
      ...
      assertEquals("*=s4]cs\"p", zipArchiveEntry0.toString());
  ...
  public void test008()  throws Throwable  {
      File file0 = MockFile.createTempFile("uY#EGe8iK2bmr:h", "m0");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "c|UeNijSf?##m/");
  ...
  public void test014()  throws Throwable  {
      ...
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals("*=s4]cs\"p", zipArchiveEntry0.getName());
  }
  ...
  public void test016()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setRawFlag((-3617));
      int int0 = zipArchiveEntry0.getRawFlag();
  ...
  public void test018()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setPlatform((-1412));
      int int0 = zipArchiveEntry0.getPlatform();
  ...
  public void test024()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("4PL1mF!U");
  ...
  public void test025()  throws Throwable  {
      MockFile mockFile0 = new MockFile("T", "uKu2Il9NJDU/A9A;sD");
  ...
  public void test031()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Error parsing extra fields for entry: *=s4]cs\"p - Zip64 extended information must contain both size values in the local file header.
         //
  ...
  public void test041()  throws Throwable  {
      File file0 = MockFile.createTempFile("3%.`S", "3%.`S", (File) null);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "=sz5~R!*");
      // Undeclared exception!
      try { 
  ...
  public void test051()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = null;
      try {
        zipArchiveEntry0 = new ZipArchiveEntry((File) null, "*vuT*E");
        fail("Expecting exception: NullPointerException");
  ...
  public void test059()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("ME?");
  ...
  public void test063()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveEntry0.setMethod((-3617));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // ZIP compression method can not be negative: -3617
         //
         verifyException("org.apache.commons.compress.archivers.zip.ZipArchiveEntry", e);
      }
  }
  ...
  public void test064()  throws Throwable  {
      MockFile mockFile0 = new MockFile("gd/~xw4BJGZ:le{");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "gd/~xw4BJGZ:le{");
      long long0 = zipArchiveEntry0.getSize();
      assertEquals(0, zipArchiveEntry0.getPlatform());
  ...
  public void test074()  throws Throwable  {
      ...
      zipArchiveEntry0.setCompressedSize((-4735L));
  ...
  public void test080()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = (ZipArchiveEntry)zipArchiveEntry0.clone();
      zipArchiveEntry1.setInternalAttributes(2147483632);
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(2147483632, zipArchiveEntry1.getInternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test084()  throws Throwable  {
      ...
      zipArchiveEntry1.setName("invalid entry size", byteArray0);
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals(0, zipArchiveEntry0.getMethod());
      assertFalse(boolean0);
  }
  ...
  public void test085()  throws Throwable  {
      MockFile mockFile0 = new MockFile("T", "uKu2Il9NJDU/A9A;sD");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, ";2/");
      boolean boolean0 = zipArchiveEntry0.equals("uKu2Il9NJDU/A9A;sD");
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertFalse(boolean0);
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(0L, zipArchiveEntry0.getSize());
  ...
  public void test090()  throws Throwable  {
      ...
      zipArchiveEntry0.setName("W_7kH:=5'km&yS*k^/h", byteArray0);
      zipArchiveEntry0.getRawName();
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
  ...
  public void test093()  throws Throwable  {
      MockFile mockFile0 = new MockFile("dj0mj)C^8Gz_L", "dj0mj)C^8Gz_L");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "dj0mj)C^8Gz_L");
      zipArchiveEntry0.setPlatform((-1408));
      zipArchiveEntry0.setName("dj0mj)C^8Gz_L");
  ...
  public void test109()  throws Throwable  {
      File file0 = MockFile.createTempFile("uY#EGe8iK2bmr:h", "m0");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "c|UeNijSf?##m/");
      zipArchiveEntry0.setUnixMode((-3556));
      long long0 = zipArchiveEntry0.getExternalAttributes();
      assertTrue(zipArchiveEntry0.isUnixSymlink());
      assertEquals((-233045999L), long0);
  }
  ...
  public void test115()  throws Throwable  {
      MockFile mockFile0 = new MockFile("{T|E&");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, " - ");
      zipArchiveEntry0.setVersionRequired((-2269));
      int int0 = zipArchiveEntry0.getVersionRequired();
