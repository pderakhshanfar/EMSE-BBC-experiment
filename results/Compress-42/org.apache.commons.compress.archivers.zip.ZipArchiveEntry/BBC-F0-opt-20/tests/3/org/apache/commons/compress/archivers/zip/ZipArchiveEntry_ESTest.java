...
public class ZipArchiveEntry_ESTest extends ZipArchiveEntry_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      zipArchiveEntry1.setExternalAttributes((-2771L));
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals((-2771L), zipArchiveEntry1.getExternalAttributes());
  ...
  public void test003()  throws Throwable  {
      MockFile mockFile0 = new MockFile("-{hFc<E~");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "-{hFc<E~");
      File file0 = MockFile.createTempFile("-{hFc<E~", "g_am(TnoHwp3%rw#B^'/", (File) mockFile0);
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry(file0, "-{hFc<E~");
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
  ...
  public void test004()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("e0ybVE,Mt");
      zipArchiveEntry0.setUnixMode(0);
      byte[] byteArray0 = new byte[2];
      zipArchiveEntry0.setName("e0ybVE,Mt", byteArray0);
      assertEquals(3, zipArchiveEntry0.getPlatform());
  }
  ...
  public void test010()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("BhZ");
      zipArchiveEntry0.setVersionRequired((-1999));
      int int0 = zipArchiveEntry0.getVersionRequired();
  ...
  public void test011()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionMadeBy(341);
  ...
  public void test012()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setVersionMadeBy((-1791422435));
      int int0 = zipArchiveEntry0.getVersionMadeBy();
      assertEquals((-1791422435), int0);
  }
  ...
  public void test016()  throws Throwable  {
      ...
      zipArchiveEntry0.setName("B{YMN9@Yd@EyG/", byteArray0);
  ...
  public void test018()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("DYqk`kj={rKo@Q_pZ5>");
      zipArchiveEntry0.setRawFlag((-3059));
      int int0 = zipArchiveEntry0.getRawFlag();
  ...
  public void test020()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("mfbo><4");
  ...
  public void test021()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("_)([Zc:\"&[W");
      String string0 = zipArchiveEntry0.getName();
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1), zipArchiveEntry0.getMethod());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals("_)([Zc:\"&[W", string0);
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
  }
  ...
  public void test022()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "iLOk=>fY'1");
      assertEquals((-1), zipArchiveEntry0.getMethod());
  ...
  public void test023()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Can only convert non-negative integers between [0,255] to byte: [", "2!");
  ...
  public void test024()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setInternalAttributes((byte)78);
  ...
  public void test026()  throws Throwable  {
      ...
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals("_)([Zc:\"&[W", zipArchiveEntry0.getName());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
      assertEquals(0L, zipArchiveEntry0.getExternalAttributes());
      assertEquals((-1), zipArchiveEntry0.getMethod());
  }
  ...
  public void test027()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(")ISAK>N?KRK@P`B|E]");
  ...
  public void test030()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setUnixMode((-737));
      long long0 = zipArchiveEntry0.getExternalAttributes();
      assertEquals(64799, zipArchiveEntry0.getUnixMode());
      assertEquals((-48300031L), long0);
  }
  ...
  public void test032()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[2];
      UnicodePathExtraField unicodePathExtraField0 = new UnicodePathExtraField("U", byteArray0);
      ...
      ZipEightByteInteger zipEightByteInteger0 = new ZipEightByteInteger((byte) (-52));
  ...
  public void test033()  throws Throwable  {
      File file0 = MockFile.createTempFile("invalid entry size", "4");
  ...
  public void test034()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("2GSw,6V+&,{6|wUl");
      try { 
  ...
  public void test038()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipEightByteInteger zipEightByteInteger0 = new ZipEightByteInteger(555L);
  ...
  public void test057()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "YR7Y;qHx5&");
  ...
  public void test063()  throws Throwable  {
      MockFile mockFile0 = new MockFile("UPr@f@s:[Z+X");
  ...
  public void test065()  throws Throwable  {
      MockFile mockFile0 = new MockFile("CT?(Dn3/");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "CT?(Dn3/");
  ...
  public void test077()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry();
      zipArchiveEntry1.setInternalAttributes((-903));
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals((-903), zipArchiveEntry1.getInternalAttributes());
      assertFalse(boolean0);
  }
  ...
  public void test078()  throws Throwable  {
      MockFile mockFile0 = new MockFile("-{hFc<E~");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "-{hFc<E~");
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry("-{hFc<E~");
      boolean boolean0 = zipArchiveEntry0.equals(zipArchiveEntry1);
      assertEquals(0L, zipArchiveEntry1.getExternalAttributes());
      assertFalse(boolean0);
      assertEquals(0, zipArchiveEntry1.getInternalAttributes());
  ...
  public void test081()  throws Throwable  {
      MockFile mockFile0 = new MockFile("-{hFc<E~");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "-{hFc<E~");
      ZipArchiveEntry zipArchiveEntry1 = new ZipArchiveEntry(mockFile0, "2=");
      boolean boolean0 = zipArchiveEntry1.equals(zipArchiveEntry0);
      assertEquals((-1), zipArchiveEntry1.getMethod());
      assertEquals(0L, zipArchiveEntry1.getExternalAttributes());
      assertFalse(boolean0);
  ...
  public void test083()  throws Throwable  {
      File file0 = MockFile.createTempFile("i\"%j>?B", "O|");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "__ALP+rs>yqG7");
  ...
  public void test087()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      byte[] byteArray0 = new byte[0];
      zipArchiveEntry0.setName("=RwKqSw54,w@Mcj<tu", byteArray0);
      zipArchiveEntry0.getRawName();
      assertEquals((-1L), zipArchiveEntry0.getSize());
      assertEquals(0, zipArchiveEntry0.getPlatform());
      assertEquals(0, zipArchiveEntry0.getInternalAttributes());
  ...
  public void test090()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setPlatform((-4117));
      byte[] byteArray0 = new byte[2];
      zipArchiveEntry0.setName("/", byteArray0);
      assertEquals((-4117), zipArchiveEntry0.getPlatform());
  }
  ...
  public void test099()  throws Throwable  {
      ...
      ZipExtraField[] zipExtraFieldArray0 = new ZipExtraField[8];
      byte[] byteArray0 = new byte[6];
      UnicodeCommentExtraField unicodeCommentExtraField0 = new UnicodeCommentExtraField("w:F1Ah|", byteArray0);
  ...
  public void test109()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("+^2e_EI<mntb6K]SI");
      UnicodePathExtraField unicodePathExtraField0 = new UnicodePathExtraField();
