...
public class JDOMAttributeIterator_ESTest extends JDOMAttributeIterator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      QName qName0 = new QName("n.7", "n.7");
      Namespace namespace0 = Namespace.getNamespace("");
      Element element0 = new Element("n.7", namespace0);
  ...
  public void test01()  throws Throwable  {
      QName qName0 = new QName("n.7");
      Element element0 = new Element("n.7", "n.7");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, (Locale) null);
  ...
  public void test04()  throws Throwable  {
      QName qName0 = new QName("nW7", "nW7");
      Namespace namespace0 = Namespace.getNamespace("");
      Element element0 = new Element("nW7", namespace0);
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, (Locale) null);
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
      jDOMAttributeIterator0.setPosition((-1983058443));
      // Undeclared exception!
      try { 
        jDOMAttributeIterator0.getNodePointer();
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test05()  throws Throwable  {
      ...
      try {
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Undefined variable: null filter not allowed
         //
  ...
  public void test07()  throws Throwable  {
      ...
      assertEquals(943, jDOMAttributeIterator0.getPosition());
  ...
  public void test08()  throws Throwable  {
      QName qName0 = new QName("nW7", "nW7");
      Element element0 = new Element("nW7", "nW7", "nW7");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, (Locale) null);
      JXPathContext jXPathContext0 = JXPathContext.newContext((Object) "GlUIz[`;0{n_OO");
      NodePointer nodePointer1 = nodePointer0.createAttribute(jXPathContext0, qName0);
      assertNotNull(nodePointer1);
      
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer1, qName0);
      boolean boolean0 = jDOMAttributeIterator0.setPosition((-3497));
      assertFalse(boolean0);
      assertEquals(0, jDOMAttributeIterator0.getPosition());
  }
  ...
  public void test09()  throws Throwable  {
      QName qName0 = new QName("orgYsjdom.NameRspace", "orgYsjdom.NameRspace");
      Element element0 = new Element("orgYsjdom.NameRspace", "orgYsjdom.NameRspace", "orgYsjdom.NameRspace");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, (Locale) null);
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
      boolean boolean0 = jDOMAttributeIterator0.setPosition((-1174));
      assertEquals((-1174), jDOMAttributeIterator0.getPosition());
      assertFalse(boolean0);
  }
