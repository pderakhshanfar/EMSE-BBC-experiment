...
public class JDOMAttributeIterator_ESTest extends JDOMAttributeIterator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      QName qName0 = new QName("Om(*Y=*(rn", "Om(*Y=*(rn");
      Element element0 = new Element("http", "gol`^JzC");
  ...
  public void test01()  throws Throwable  {
      QName qName0 = new QName("Om(*Y=*(rn");
  ...
  public void test05()  throws Throwable  {
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // No such variable: 'org.apache.commons.jxpath.ri.parser.SimpleCharStream:org.apache.commons.jxpath.ri.parser.SimpleCharStream'
         //
  ...
  public void test06()  throws Throwable  {
      ...
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, (Locale) null);
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
      boolean boolean0 = jDOMAttributeIterator0.setPosition(3185);
      assertEquals(3185, jDOMAttributeIterator0.getPosition());
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      QName qName0 = new QName("ealme");
      Element element0 = new Element("ealme", "ealme", "ealme");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, (Locale) null);
  ...
  public void test08()  throws Throwable  {
      QName qName0 = new QName("valme");
      Element element0 = new Element("valme", "valme");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, (Locale) null);
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
      jDOMAttributeIterator0.setPosition(Integer.MIN_VALUE);
  ...
  public void test09()  throws Throwable  {
      ...
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nullPointer0, qName0);
  ...
  public void test10()  throws Throwable  {
      QName qName0 = new QName("Om(*Y=*(rn", "Om(*Y=*(rn");
      Element element0 = new Element("http", "xml");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, (Locale) null);
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
      jDOMAttributeIterator0.getNodePointer();
      // Undeclared exception!
  ...
  public void test11()  throws Throwable  {
      QName qName0 = new QName("Om(*Y=*(rn");
      Element element0 = new Element("on", "Om(*Y=*(rn");
      Element element1 = element0.setAttribute("ll", "ll");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element1, (Locale) null);
  ...
  public void test12()  throws Throwable  {
      QName qName0 = new QName("Om(*Y=*(rn", "Om(*Y=*(rn");
      Element element0 = new Element("htt1", "Om(*Y=*(rn");
      Element element1 = element0.setAttribute("ll", "ll");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element1, (Locale) null);
      QName qName1 = new QName("", "*");
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName1);
  ...
  public void test14()  throws Throwable  {
      QName qName0 = new QName("Om(*Y=*(rn");
      QName qName1 = new QName("xml", "<b}A");
      Element element0 = new Element("xml", "@ol`^dzC");
