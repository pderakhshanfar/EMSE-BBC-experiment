...
public class JDOMAttributeIterator_ESTest extends JDOMAttributeIterator_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      QName qName0 = new QName("l@g%xZ`;`GNl`ir", "");
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // No such variable: 'l@g%xZ`;`GNl`ir:'
         //
  ...
  public void test10()  throws Throwable  {
      QName qName0 = new QName("yml", "yml");
      Element element0 = new Element("yml", "yml", "yml");
      Attribute attribute0 = new Attribute("tq", "wm");
      Namespace namespace0 = Namespace.getNamespace("tq", "yml");
  ...
  public void test13()  throws Throwable  {
      QName qName0 = new QName("{Vw", "U");
      Element element0 = new Element("U", "U");
      JXPathContext jXPathContext0 = JXPathContext.newContext((Object) "{Vw");
      Locale locale0 = jXPathContext0.getLocale();
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, locale0);
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
      assertEquals(0, jDOMAttributeIterator0.getPosition());
