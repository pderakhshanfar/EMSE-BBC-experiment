...
public class JDOMAttributeIterator_ESTest extends JDOMAttributeIterator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Locale locale0 = new Locale("sCo<%gdXeR^i_qx9*");
      Namespace namespace0 = Namespace.NO_NAMESPACE;
      Element element0 = new Element("namespace", namespace0);
      ...
      jDOMAttributeIterator0.setPosition((-1284));
  ...
  public void test01()  throws Throwable  {
      ...
      Element element0 = new Element("xmj", "xmj", "xmj");
      element0.setAttribute("xmj", "UfN\"@!o=tJI%C~");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, locale0);
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
  ...
  public void test03()  throws Throwable  {
      ...
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, locale0);
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
      jDOMAttributeIterator0.setPosition((-1388));
      int int0 = jDOMAttributeIterator0.getPosition();
  ...
  public void test04()  throws Throwable  {
      QName qName0 = new QName("");
      Locale locale0 = new Locale("Co<%gdXeR^i_qx9*");
      Namespace namespace0 = Namespace.NO_NAMESPACE;
      Element element0 = new Element("namespace", namespace0);
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, locale0);
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
      jDOMAttributeIterator0.setPosition(858);
      // Undeclared exception!
      try { 
        jDOMAttributeIterator0.getNodePointer();
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test05()  throws Throwable  {
      QName qName0 = new QName("x", "@(#) $RCSfile: CDATA.java,v $ $Revision: 1.30 $ $Date: 2004/02/27 11:32:57 $ $Name: jdom_1_0 $");
      ...
      try {
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Undefined variable: x:@(#) $RCSfile: CDATA.java,v $ $Revision: 1.30 $ $Date: 2004/02/27 11:32:57 $ $Name: jdom_1_0 $
         //
  ...
  public void test06()  throws Throwable  {
      ...
      Locale locale0 = new Locale("sCo<%gdXeR^i_qx9*");
      Element element0 = new Element("g", "[?s9sW]#k!(-i=b(");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, locale0);
      JDOMAttributeIterator jDOMAttributeIterator0 = null;
      try {
  ...
  public void test12()  throws Throwable  {
      QName qName0 = new QName("", "");
      Locale locale0 = new Locale("sCo_%gdXeR^i_qx9*");
      Namespace namespace0 = Namespace.NO_NAMESPACE;
      Element element0 = new Element("namespace", namespace0);
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, locale0);
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
  ...
  public void test14()  throws Throwable  {
      QName qName0 = new QName("xmj", "xmj");
      Locale locale0 = Locale.FRANCE;
      Element element0 = new Element("xmj", "xmj", "xmj");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, locale0);
