...
public class JDOMAttributeIterator_ESTest extends JDOMAttributeIterator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Element element1 = element0.setAttribute("ZE", "z");
      element0.setAttribute("z", "ZE");
  ...
  public void test01()  throws Throwable  {
      QName qName0 = new QName("aU.O]i)#-|uo!Y", "aU.O]i)#-|uo!Y");
      Locale locale0 = Locale.forLanguageTag("aU.O]i)#-|uo!Y");
      Element element0 = new Element("p", "p", ".0");
  ...
  public void test04()  throws Throwable  {
      QName qName0 = new QName("kJ{3-Yu'=", "kJ{3-Yu'=");
      ...
      try {
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Undefined variable: kJ{3-Yu'=:kJ{3-Yu'=
         //
  ...
  public void test06()  throws Throwable  {
      ...
      QName qName0 = new QName("<:kkxXP6K0yxxrJ. ", "r0uu}%i5O8,*x7a2)yw");
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // No such variable: '<:kkxXP6K0yxxrJ. :r0uu}%i5O8,*x7a2)yw'
         //
  ...
  public void test07()  throws Throwable  {
      ...
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
      jDOMAttributeIterator0.setPosition(4441);
      // Undeclared exception!
      try { 
        jDOMAttributeIterator0.getNodePointer();
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test08()  throws Throwable  {
      ...
      element0.setAttribute("ZE", "z", namespace0);
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, locale0);
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
      assertEquals(0, jDOMAttributeIterator0.getPosition());
  }
  ...
  public void test11()  throws Throwable  {
      QName qName0 = new QName("aU.O]i)#-|uo!Y");
      Locale locale0 = Locale.forLanguageTag("aU.O]i)#-|uo!Y");
      Element element0 = new Element("http", "http", ".0");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, element0, locale0);
  ...
  public void test12()  throws Throwable  {
      QName qName0 = new QName("Eg4u^&qP{5_G");
      Locale locale0 = new Locale("Eg4u^&qP{5_G", "");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, qName0, locale0);
      JDOMAttributeIterator jDOMAttributeIterator0 = new JDOMAttributeIterator(nodePointer0, qName0);
      boolean boolean0 = jDOMAttributeIterator0.setPosition((-2671));
      assertEquals(0, jDOMAttributeIterator0.getPosition());
