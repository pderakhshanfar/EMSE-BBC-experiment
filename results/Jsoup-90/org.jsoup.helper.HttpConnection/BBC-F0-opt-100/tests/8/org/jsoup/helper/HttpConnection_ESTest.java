...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("1lI&", "W53");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test022()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("application/x-www-form-urlencoded", "Content-Encoding", 187, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", uRLStreamHandler0);
  ...
  public void test023()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("{wz8=", "{wz8=", 0, "{wz8=", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertNull(uRL1.getRef());
  }
  ...
  public void test024()  throws Throwable  {
      MockFile mockFile0 = new MockFile("accept-encoding", "accept-encoding");
  ...
  public void test025()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("org.jsoup.Connection$Method", "=]R.|<P| -lcs5h4");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("org.jsoup.Connection$Method");
      assertNotNull(connection_KeyVal0);
      assertEquals("=]R.|<P| -lcs5h4", connection_KeyVal0.value());
  }
  ...
  public void test041()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("zm`P>uDI0", "zm`P>uDI0");
        fail("Expecting exception: NullPointerException");
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header((String) null, "p_&M");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test046()  throws Throwable  {
      ...
      hashMap0.put("ers&x)umm", "ers&x)umm");
      // Undeclared exception!
      try { 
  ...
  public void test047()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>(400);
      hashMap0.put((String) null, "szY]oT,~RXoBU45-J|Z");
      // Undeclared exception!
      try { 
        httpConnection0.data((Map<String, String>) hashMap0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test049()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("A)=*a-@1:;", ",hr+6S3#bxrC7fQ:a", (InputStream) sequenceInputStream0, "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test051()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "yKrdgaU!");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test053()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("aPO?pEMN;t", "D_Ye;o4pFqIj#-");
      httpConnection0.request((Connection.Request) null);
      // Undeclared exception!
      try { 
  ...
  public void test055()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "J;r", (InputStream) null);
      ...
      assertEquals("J;r", httpConnection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test056()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.header("1li&", (String) null);
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test058()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("user-agent", "1li&", (InputStream) mockFileInputStream0);
      ...
      assertEquals("1li&", httpConnection_KeyVal1.value());
  }
  ...
  public void test059()  throws Throwable  {
      ...
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("user-agent", "1li&", (InputStream) mockFileInputStream0);
      assertEquals("1li&", httpConnection_KeyVal0.value());
      
      httpConnection_KeyVal0.value(":U `r&r");
  ...
  public void test061()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("p", "R5-`d!TtA4MmG7Z", 2180, "org.jsoup.safety.Cleaner$CleaningVisitor", uRLStreamHandler0);
  ...
  public void test064()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("table", "table", (InputStream) null);
  ...
  public void test066()  throws Throwable  {
      ...
      connection0.cookie("d'[k8kod2<t", "Content-Encoding");
  ...
  public void test067()  throws Throwable  {
      ...
      httpConnection0.data("s\"^\u0000K&ijqIjxc1{.", "Referer", (InputStream) pipedInputStream0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test069()  throws Throwable  {
      ...
      hashMap0.put("Data key must not be empty", list0);
      httpConnection_Response0.processResponseHeaders(hashMap0);
      assertEquals(0, httpConnection_Response0.statusCode());
  }
  ...
  public void test071()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      httpConnection0.proxy("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", 32768);
      try { 
        httpConnection0.execute();
        fail("Expecting exception: IOException");
  ...
  public void test076()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "l6", (-1), "https", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
        httpConnection0.get();
  ...
  public void test084()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Key val must not be null", ">5_Kn [d<'iTs{Vu*");
  ...
  public void test086()  throws Throwable  {
      ...
      PipedOutputStream pipedOutputStream0 = new PipedOutputStream();
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0);
      httpConnection0.data("0t/&OnEaRt", "0t/&OnEaRt", (InputStream) pipedInputStream0, "0t/&OnEaRt");
  ...
  public void test089()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>(4665);
      hashMap0.put("{<kd\"}-y!6m*~]", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
  ...
  public void test090()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("0dCCJRsmew", "multipart/form-data", (InputStream) null);
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("0dCCJRsmew=multipart/form-data", string0);
  }

  @Test(timeout = 4000)
  public void test091()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded", "version");
      httpConnection_KeyVal0.contentType();
      assertEquals("version", httpConnection_KeyVal0.value());
  ...
  public void test100()  throws Throwable  {
      ...
      PipedOutputStream pipedOutputStream0 = new PipedOutputStream();
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0);
      Connection connection0 = httpConnection0.data("0t/&OnEaRt", "0t/&OnEaRt", (InputStream) pipedInputStream0, "0t/&OnEaRt");
      Connection.KeyVal connection_KeyVal0 = connection0.data("0t/&OnEaRt");
      assertEquals("0t/&OnEaRt", connection_KeyVal0.value());
      assertNotNull(connection_KeyVal0);
      assertEquals("0t/&OnEaRt", connection_KeyVal0.contentType());
  }
  ...
  public void test105()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("$W]A<w_x -4", (String) null, (InputStream) mockFileInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test111()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-3343));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test114()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie((String) null, "TJl");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test115()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.removeCookie("71<N.]~IB");
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test124()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("`%q0", 1024);
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
