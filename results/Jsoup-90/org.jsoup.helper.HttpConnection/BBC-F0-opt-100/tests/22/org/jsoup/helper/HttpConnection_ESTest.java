...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test006()  throws Throwable  {
      ...
      InetSocketAddress inetSocketAddress0 = MockInetSocketAddress.createUnresolved("user-agent", 1);
  ...
  public void test007()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("user-agent", 1);
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test014()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("i=o[X\"ULg>v)^", "user-agent");
  ...
  public void test017()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http:/");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, ":containsown(%s");
      HttpConnection httpConnection0 = new HttpConnection();
  ...
  public void test023()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "N`8~;Z-@", 125, "application/x-www-form-urlencoded", uRLStreamHandler0);
  ...
  public void test024()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("Ixv!^DY.m Vl(", "Ixv!^DY.m Vl(", 0, "Ixv!^DY.m Vl(", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test026()  throws Throwable  {
      ...
      httpConnection0.data("http:/", "/-vg'p(%ev&Z{Y=X", (InputStream) sequenceInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("http:/");
      assertEquals("/-vg'p(%ev&Z{Y=X", connection_KeyVal0.value());
  ...
  public void test036()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.referrer("mvupd");
        fail("Expecting exception: NullPointerException");
  ...
  public void test039()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("\"O;tsLq", (-2602));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test041()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("audio");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test053()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("} 9v t>o\"`TQ", "ZUH`G9et");
        fail("Expecting exception: NullPointerException");
  ...
  public void test054()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header((String) null, "GET");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test063()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)19, (byte)41);
      DataInputStream dataInputStream0 = new DataInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        connection0.data("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "multipart/form-data", (InputStream) dataInputStream0, "/3xcs?*(n<~");
        fail("Expecting exception: NullPointerException");
  ...
  public void test064()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("org.jsoup.helper.HttpConnection$Request", (String) null, (InputStream) null, ";)@3GK4_N~(y!h|");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("", "+5a#)*phUvu^M", (InputStream) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test070()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      CDataNode cDataNode0 = new CDataNode("Uz4kW`Z3xx0i`ck3({F");
  ...
  public void test073()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpConnection.connect("_uzmsq7y|qeah&%");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: _uzmsq7y|qeah&%
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test074()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("basefont", "r>o}@nbk=8[3ev0l");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("Content-Type");
      assertEquals("r>o}@nbk=8[3ev0l", httpConnection_KeyVal1.value());
  }

  @Test(timeout = 4000)
  public void test075()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.header("*sZ3V$IQwjU7q:'}Y", (String) null);
  ...
  public void test076()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(pipedInputStream0, 400);
  ...
  public void test077()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("!sv/4v");
      assertEquals("!sv/4v", httpConnection_KeyVal1.value());
  }

  @Test(timeout = 4000)
  public void test078()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("r%4x2_d[fws", "");
  ...
  public void test080()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Jfbv[no4amG<@poZ{i", "multipart/form-data");
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("multipart/form-data", string0);
      assertEquals("Jfbv[no4amG<@poZ{i", httpConnection_KeyVal0.key());
  }
  ...
  public void test083()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("u_Lt", "Content-Encoding");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("nth-child");
      assertEquals("Content-Encoding", connection_KeyVal0.value());
      assertEquals("u_Lt", connection_KeyVal0.key());
  }

  @Test(timeout = 4000)
  public void test084()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("wE3 <=|{r^Flvi\"ldB", "uhkgze&xm,");
      Connection connection0 = httpConnection0.url("http:/");
      connection0.data("Cannot set a request body for HTTP method ", "a]zn' I@v~eyN)", (InputStream) null, "+0(:u_");
      try { 
        connection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test085()  throws Throwable  {
      ...
      Connection connection1 = httpConnection0.url("http:/");
      connection1.cookie("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "B5iz8_jbigNWRn=DI#");
      try { 
        connection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test086()  throws Throwable  {
      ...
      httpConnection0.data("Content-Encoding", "http:/", (InputStream) bufferedInputStream0);
      httpConnection0.url("http:/");
      try { 
        httpConnection0.post();
  ...
  public void test096()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.requestBody("{D7`Si5_MWX2m#6<j");
  ...
  public void test099()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.postDataCharset("oK");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test100()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.maxBodySize((-4578));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test101()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("3LSEK", "y('q");
      try { 
        HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
        fail("Expecting exception: IOException");
  ...
  public void test105()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "application/x-www-form-urlencoded; charset=");
  ...
  public void test108()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("mozilla/5.0 (macintosh; intel mac os x 10_11_6) applewebkit/537.36 (khtml, like gecko) chrome/53.0.2785.143 safari/537.36", "m?fbV$u73lLTB=AbT9", (InputStream) null);
      ...
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals("m?fbV$u73lLTB=AbT9", httpConnection_KeyVal0.value());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
  ...
  public void test112()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("multipart/form-data", "\"ch.fy1");
  ...
  public void test114()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("p{m)dAQ!WQ2FAD8<t<", ":containsOwn(%s)");
      httpConnection_KeyVal0.contentType();
      assertEquals(":containsOwn(%s)", httpConnection_KeyVal0.value());
      assertEquals("p{m)dAQ!WQ2FAD8<t<", httpConnection_KeyVal0.key());
  }
  ...
  public void test120()  throws Throwable  {
      ...
      httpConnection0.url("http:/");
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http:/");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "6Wf4@=R'kqoyL0fI|P");
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(connection_Request0);
  ...
  public void test121()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer(":containsown(%s)");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test124()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.timeout((-80773204));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test139()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("!sv/4v", 24576);
      assertSame(httpConnection0, connection0);
  }
}
