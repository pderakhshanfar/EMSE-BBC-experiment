...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.header("org.jsoup.helper.HttpConnection$Response", "%20");
  ...
  public void test004()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.timeout(1481);
      assertEquals(1481, httpConnection_Request0.timeout());
  }
  ...
  public void test007()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("{`Kw4PPZ0s\"|p|-nT@%");
  ...
  public void test011()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.postDataCharset(":%s(%dn)");
  ...
  public void test019()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Header map must not be null", "Header map must not be null", (InputStream) null);
  ...
  public void test020()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "itle");
      HttpConnection httpConnection0 = new HttpConnection();
  ...
  public void test022()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "AttributeValue_doubleQuoted");
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
  ...
  public void test027()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("org.jsoup.helper.httpconnection$response", "dU", 142, "beforeattributevalue", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals("beforeattributevalue", uRL1.getFile());
  }

  @Test(timeout = 4000)
  public void test028()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("Xet-CookQe", "()}zr", 0, "Xet-CookQe", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test030()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("multipart/form-data", "X", (InputStream) null);
  ...
  public void test032()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.userAgent("S!Q QJO%'Y/%Zh#u0");
  ...
  public void test037()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.timeout(1048576);
        fail("Expecting exception: NullPointerException");
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("URL must be specified to connect", 573);
        fail("Expecting exception: NullPointerException");
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("&.rhrY+OEf%-i{", (-1491));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-1491
         //
  ...
  public void test044()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("Px~&;VHO}Q\"=Wv(^d8y");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test052()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-1275));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test055()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("lQbsBidatX", "lQbsBidatX");
        fail("Expecting exception: NullPointerException");
  ...
  public void test057()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      MockFile mockFile0 = new MockFile("h8//h8AO[N6<|;Z3&", "Content-Encoding");
  ...
  public void test060()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      MockFile mockFile0 = new MockFile("@)1le52:]p=w1vn", "org.jsoup.parser.Token$StartTag");
      URL uRL0 = mockFile0.toURL();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.execute();
  ...
  public void test064()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.data("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "Content-Type", (InputStream) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "org.jsoup.helper.HttpConnection$Response", (InputStream) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test066()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("math", "file");
        fail("Expecting exception: NullPointerException");
  ...
  public void test071()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpConnection.connect("b:\"q@?@m]t");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: b:\"q@?@m]t
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test072()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("{;tMRhOyi9kr", "", (InputStream) null);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("Xif:kH$,*?v");
  ...
  public void test075()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("{;tMRhOyi9kr", "", (InputStream) null);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("Z<3$H=~n=9JE>3");
      assertNull(httpConnection_KeyVal1.contentType());
  }

  @Test(timeout = 4000)
  public void test076()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("i*fdp3,f#xlcw~", "SmBSBx");
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("i*fdp3,f#xlcw~", string0);
      assertEquals("SmBSBx", httpConnection_KeyVal0.value());
  }
  ...
  public void test077()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("Content-Type", "application/x-www-form-urlencoded", 23, "Ku(H_|", uRLStreamHandler0);
  ...
  public void test078()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded", "Must supply an even number of key value pairs");
  ...
  public void test083()  throws Throwable  {
      ...
      httpConnection0.cookie("UhXtG!R", "Content-Type");
      URL uRL0 = MockURL.getHttpExample();
  ...
  public void test084()  throws Throwable  {
      ...
      httpConnection0.data("Content-Type", "boundary", (InputStream) dataInputStream0);
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
  ...
  public void test087()  throws Throwable  {
      LinkedList<String> linkedList0 = new LinkedList<String>();
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      hashMap0.put("uA{6AKSz7|", linkedList0);
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.processResponseHeaders(hashMap0);
  ...
  public void test095()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.requestBody("&X :F90ZUtzQ&}/n^B^");
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.data("LMk3r7'UmR(8Sz;B[", "LMk3r7'UmR(8Sz;B[");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test097()  throws Throwable  {
      MockFile mockFile0 = new MockFile("uA{6AKSz7|", "uA{6AKSz7|");
      URL uRL0 = mockFile0.toURL();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      try { 
  ...
  public void test098()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "https", 2729, "itle", uRLStreamHandler0);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test101()  throws Throwable  {
      ...
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("application/x-www-form-urlencoded", "BDB");
      try { 
  ...
  public void test103()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.header("Input stream already read and parsed, cannot re-read.", (String) null);
      assertSame(httpConnection_Response0, connection_Response0);
  }
  ...
  public void test104()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.header("Content-Type", "org.jsoup.select.Collector");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test105()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put(":parent%s", "Content-Encoding");
  ...
  public void test106()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("F@0fm8\"5d!NK", "user-agent");
  ...
  public void test107()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      DataInputStream dataInputStream0 = new DataInputStream((InputStream) null);
      httpConnection0.data("org.jsup.odes.Entities$EscapeMode", "multipart/form-data", (InputStream) dataInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("org.jsup.odes.Entities$EscapeMode");
      assertEquals("multipart/form-data", connection_KeyVal0.value());
      assertNotNull(connection_KeyVal0);
  }
  ...
  public void test108()  throws Throwable  {
      ...
      httpConnection0.data("kmw3$,L{{3@~WAWs", "D0xO8^Pn{'~6#_L{", (InputStream) pipedInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("E:pV2<di");
  ...
  public void test112()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("multipart/form-data", "lmk3r7'umr(8sz;b[");
  ...
  public void test113()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("org.jsoup.select.StructuralEvaluator$Not", "4cI1", (InputStream) byteArrayInputStream0);
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("org.jsoup.select.StructuralEvaluator$Not=4cI1", string0);
  }

  @Test(timeout = 4000)
  public void test114()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("application/x-www-form-urlencoded", "0O[upb", (InputStream) null, "deflate");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test116()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("F1`k:cMMQzv", "hf#lA1(S<", (InputStream) null);
      httpConnection_KeyVal0.inputStream();
      assertEquals("hf#lA1(S<", httpConnection_KeyVal0.value());
      assertEquals("F1`k:cMMQzv", httpConnection_KeyVal0.key());
  }
  ...
  public void test120()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "Header name must not be empty", (InputStream) null, "Header name must not be empty");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test123()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("2DB}S4w8[", "2DB}S4w8[");
        fail("Expecting exception: NullPointerException");
  ...
  public void test126()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data(">mJfjnN", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test132()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("~=Q7^SL", 1063);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test143()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("^rP'*0U8hfxU*C`AVn", 1481);
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertFalse(httpConnection_Request1.ignoreContentType());
