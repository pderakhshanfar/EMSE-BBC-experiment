...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.userAgent("pq}");
  ...
  public void test008()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("Input stream already read and parsed, cannot re-read.", 2299);
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test010()  throws Throwable  {
      ...
      try { 
        httpConnection_Request0.postDataCharset("Fu/Z3!kN)yRgD~");
  ...
  public void test013()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize(2299);
      assertEquals(2299, httpConnection_Request0.maxBodySize());
  }
  ...
  public void test018()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("9M{M", "jp]H_.No#o'A@");
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.data((Connection.KeyVal) httpConnection_KeyVal0);
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertEquals("jp]H_.No#o'A@", httpConnection_KeyVal0.value());
      assertTrue(httpConnection_Request1.followRedirects());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
  }
  ...
  public void test019()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("VD", "VD", (InputStream) sequenceInputStream0);
  ...
  public void test030()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Content-Type", "G;sa>4", 8249, "G;sa>4", uRLStreamHandler0);
  ...
  public void test032()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("US-ASCII", "US-ASCII");
  ...
  public void test034()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.userAgent("eoM!!t0~}UI");
  ...
  public void test039()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.requestBody("encoding");
        fail("Expecting exception: NullPointerException");
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("multipart/form-data", (-1834));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-1834
         //
  ...
  public void test044()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("org.jsoup.select.Evaluator$MatchText");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test055()  throws Throwable  {
      ...
      Attributes attributes1 = attributes0.put("", "pq}");
  ...
  public void test056()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("userlagent", "userlagent");
        fail("Expecting exception: NullPointerException");
  ...
  public void test057()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header((String) null, "org.jsoup.select.Evaluator$MatchText");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test065()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>(1471);
      httpConnection0.request((Connection.Request) null);
      hashMap0.put("(``;1qm", "nth-of-type");
      // Undeclared exception!
      try { 
  ...
  public void test068()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("user-agent", "user-agent", (InputStream) pipedInputStream0, "application/x-www-form-urlencoded");
        fail("Expecting exception: NullPointerException");
  ...
  public void test069()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 240, 1337);
      // Undeclared exception!
      try { 
        httpConnection0.data("Content-Type", (String) null, (InputStream) byteArrayInputStream0, "org.jsoup.select.Evaluator$IsFirstChild");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test070()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("content-type", "i1UQ%5", (InputStream) bufferedInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test071()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("-_X=GP`Vw4o@Xf`gT", (String) null, (InputStream) pipedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test073()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("5wgpN\"t-", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test074()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("sGt-cookie");
        fail("Expecting exception: NullPointerException");
  ...
  public void test077()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("?pg|;", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test080()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("SiG^r ", "1NCFP@4$VGlj");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("4Js");
  ...
  public void test081()  throws Throwable  {
      ...
      Connection.Response connection_Response0 = httpConnection_Response0.header("sGt-cookie", "set-cookie");
  ...
  public void test082()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("c(v5hayb!_'wy`l)x");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: c(v5hayb!_'wy`l)x
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test083()  throws Throwable  {
      ...
      assertEquals("jp]H_.No#o'A@", httpConnection_KeyVal1.value());
  }

  @Test(timeout = 4000)
  public void test084()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("ul", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("#doctype");
      assertFalse(httpConnection_KeyVal1.hasInputStream());
  }

  @Test(timeout = 4000)
  public void test085()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("script", "");
  ...
  public void test086()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      MockFile mockFile0 = new MockFile("application/x-www-form-urlencoded", ",.qbe&e]!q0m");
  ...
  public void test087()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("83= S", "accept-encoding", (InputStream) byteArrayInputStream0);
  ...
  public void test089()  throws Throwable  {
      ...
      assertEquals("SiG^r ", connection_KeyVal0.key());
  }
  ...
  public void test090()  throws Throwable  {
      ...
      connection1.data("Content-Encoding", "set-cookie");
      try { 
        httpConnection0.execute();
        fail("Expecting exception: IOException");
  ...
  public void test091()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.cookie("%20", "userlagent");
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      httpConnection0.cookie(".sm.?]mvythirc", "InTable");
      try { 
        httpConnection0.execute();
        fail("Expecting exception: IOException");
  ...
  public void test092()  throws Throwable  {
      ...
      httpConnection0.data("url must not be null", "multipart/form-data", (InputStream) pipedInputStream0);
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
  ...
  public void test093()  throws Throwable  {
      ...
      linkedList0.offerLast("^-3znI7JRe5[ ");
  ...
  public void test099()  throws Throwable  {
      ...
      httpConnection0.data("accept-encoding", "org.jsoup.select.evaluator$containstext");
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
  ...
  public void test102()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "https", 200, "P>", uRLStreamHandler0);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test106()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.timeout(2638);
      assertEquals(2638, httpConnection_Request0.timeout());
  }
  ...
  public void test107()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("ftp", "multipart/form-data");
      try { 
        HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
        fail("Expecting exception: IOException");
  ...
  public void test111()  throws Throwable  {
      ...
      hashMap0.put("Referrer must not be null", "Content-Type");
  ...
  public void test112()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("org.jsoup.select.Evaluator$IsLastChild", "org.jsoup.select.Evaluator$IsLastChild");
      HttpConnection httpConnection0 = new HttpConnection();
  ...
  public void test113()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      LinkedHashSet<Connection.KeyVal> linkedHashSet0 = new LinkedHashSet<Connection.KeyVal>(255);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("article", "Content-Encoding");
  ...
  public void test120()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("comment", "", (InputStream) pipedInputStream0);
  ...
  public void test125()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("]y 7^CCX", "\r\n\r\n", (InputStream) null, ",C.Fg W0");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test129()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("org.jsoup.helper.HttpConnection$1", "u_,QdW5nE~DU", 0, "j}yfo}qxgouc\u0000", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test131()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("=5", ",A");
      Connection.KeyVal connection_KeyVal0 = connection0.data("]z85*n");
  ...
  public void test132()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      File file0 = MockFile.createTempFile("%20", "http:/");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      httpConnection0.data("D1", "\"", (InputStream) mockFileInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("D1");
      assertNotNull(connection_KeyVal0);
  ...
  public void test141()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.removeCookie("Request must be executed (with .execute(), .get(), or .post() before parsing response");
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertFalse(httpConnection_Request1.ignoreContentType());
  ...
  public void test146()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection_Response0.cookie("IF[nCF,{nr", "IF[nCF,{nr");
