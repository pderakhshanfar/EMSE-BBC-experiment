...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      httpConnection_Request0.timeout(1721);
  ...
  public void test011()  throws Throwable  {
      ...
      try { 
        httpConnection_Request0.postDataCharset("?e`wuhrihe@");
  ...
  public void test014()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize(5104);
      assertEquals(5104, httpConnection_Request0.maxBodySize());
  }
  ...
  public void test020()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("N:w_M=$J06IpX~-", "<NDg}J");
  ...
  public void test021()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "formnovalidate");
  ...
  public void test030()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("application/x-www-form-urlencoded", "multipart/form-data", 0, ":7<aH5T", uRLStreamHandler0);
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.proxy("multipart/form-data", 97);
        fail("Expecting exception: NullPointerException");
  ...
  public void test045()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("JpFEq]5jYb+4{x7");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test046()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("bNaean#6Nr Y\"wl");
        fail("Expecting exception: NullPointerException");
  ...
  public void test050()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.proxy("Request must not be null", 117);
  ...
  public void test057()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("https", "bUpdo");
        fail("Expecting exception: NullPointerException");
  ...
  public void test067()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)35, 120);
      // Undeclared exception!
      try { 
        httpConnection0.data("", "@GU.72'[Tn@", (InputStream) byteArrayInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test068()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("", "LN%]5 3$V0I]4_X%Ld");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test072()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("D:", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test073()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 0, 30000);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "URL must not be null", (InputStream) byteArrayInputStream0);
  ...
  public void test074()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("8/kK#)H$${&", "8/kK#)H$${&");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("8/kK#)H$${&");
      assertEquals("8/kK#)H$${&", httpConnection_KeyVal1.value());
  }
  ...
  public void test076()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("mTB\"?S~k:eyL[N4Yks7");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: mTB\"?S~k:eyL[N4Yks7
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test077()  throws Throwable  {
      ...
      PipedInputStream pipedInputStream0 = new PipedInputStream(5774);
  ...
  public void test078()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("8/kK#)H$${&", "8/kK#)H$${&");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("8/kK#)H$${&");
      assertFalse(httpConnection_KeyVal1.hasInputStream());
  }

  @Test(timeout = 4000)
  public void test079()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("User-Agent", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
  ...
  public void test083()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("8/kK#)H$${&", "8/kK#)H$${&");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("8/kK#)H$${&");
      assertEquals("8/kK#)H$${&", connection_KeyVal0.value());
  }
  ...
  public void test084()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      httpConnection0.data("%20", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      connection0.data("Content-Encoding", "Content-Type");
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test085()  throws Throwable  {
      ...
      connection0.data("application/x-www-form-urlencoded", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", (InputStream) mockFileInputStream0);
      Connection.Request connection_Request0 = connection1.request();
      // Undeclared exception!
      try { 
  ...
  public void test086()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.cookie(";&a&(!Kb$", "commenkend");
  ...
  public void test087()  throws Throwable  {
      ...
      httpConnection0.data("HEAD", "Content-Type", (InputStream) byteArrayInputStream0, "org.jsoup.select.Evaluator$IsEmpty");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test098()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.data("b7ng", "Content-Type");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test102()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-3834));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test103()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "org.jsoup.helper.HttpConnection$1");
      try { 
  ...
  public void test104()  throws Throwable  {
      ...
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.addHeader("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "Content-Encoding");
  ...
  public void test106()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      httpConnection0.header("Content-Type", "}kpw*sp");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test108()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("multipart/form-data", "TagName");
  ...
  public void test110()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(",UyTNM={GT`]AE/4", ",UyTNM={GT`]AE/4");
  ...
  public void test115()  throws Throwable  {
      ...
      assertEquals("8/kK#)H$${&=8/kK#)H$${&", string0);
  }
  ...
  public void test116()  throws Throwable  {
      ...
      httpConnection0.data("'WnJ.5R3`>6", "'WnJ.5R3`>6", (InputStream) sequenceInputStream0, "&p['a<eicwXr");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("'WnJ.5R3`>6");
      assertNotNull(connection_KeyVal0);
      assertEquals("&p['a<eicwXr", connection_KeyVal0.contentType());
      assertEquals("'WnJ.5R3`>6", connection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test117()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Z[b\u0000WI", "Key val must not be null");
      httpConnection_KeyVal0.contentType();
      assertEquals("Key val must not be null", httpConnection_KeyVal0.value());
      assertEquals("Z[b\u0000WI", httpConnection_KeyVal0.key());
  }
  ...
  public void test127()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("Content-Type", "Content-Encoding", 30000, "%*6|XF^*", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test134()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("StartTag", 2);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test140()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.URL("https", ".i`", 2315, "referer");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
