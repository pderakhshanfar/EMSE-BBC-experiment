...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.header("Eam", "Eam");
  ...
  public void test003()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("multipart/form-data", "Content-Encoding", (InputStream) null);
  ...
  public void test004()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.timeout(1127);
      assertEquals(1127, httpConnection_Request0.timeout());
  }
  ...
  public void test005()  throws Throwable  {
      ...
      try { 
        httpConnection_Request0.timeout((-424));
  ...
  public void test020()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("<1=p%/Rq_", "org.jsoup.nodes.Element");
      httpConnection_KeyVal0.hasInputStream();
      assertEquals("org.jsoup.nodes.Element", httpConnection_KeyVal0.value());
      assertEquals("<1=p%/Rq_", httpConnection_KeyVal0.key());
  }
  ...
  public void test021()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "xmp");
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      httpConnection0.data("multipart/form-data", "Content-Encoding", (InputStream) null, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      Connection.Request connection_Request0 = httpConnection0.request();
  ...
  public void test023()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      Connection connection0 = httpConnection0.data("multipart/form-data", "Content-Encoding", (InputStream) null, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
  ...
  public void test031()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("application/x-www-form-urlencoded", "multipart/form-data", 78, "a {n'l", uRLStreamHandler0);
  ...
  public void test033()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      PipedInputStream pipedInputStream0 = new PipedInputStream(301);
      httpConnection0.data("&p]qe#x fwt*", "&p]qe#x fwt*", (InputStream) pipedInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("&p]qe#x fwt*");
      assertEquals("&p]qe#x fwt*", connection_KeyVal0.value());
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("set-cuokie", (-69));
        fail("Expecting exception: NullPointerException");
  ...
  public void test050()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header((String) null, "Eam");
        fail("Expecting exception: NullPointerException");
  ...
  public void test057()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.proxy("content-type", 1444);
      Connection connection0 = httpConnection0.url(uRL0);
      try { 
        connection0.execute();
        fail("Expecting exception: IOException");
  ...
  public void test062()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.data("Xno'", "bqX2m8.J.Y)8.g", (InputStream) pipedInputStream0, "B:]?uP}`n1");
        fail("Expecting exception: NullPointerException");
  ...
  public void test063()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      PipedInputStream pipedInputStream0 = new PipedInputStream(8221);
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, (String) null, (InputStream) pipedInputStream0, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test069()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("org.jsoup.helper.HttpConnection$Base", "org.jsoup.helper.HttpConnection$Base");
        fail("Expecting exception: NullPointerException");
  ...
  public void test071()  throws Throwable  {
      ...
      httpConnection_KeyVal0.key("C[npseErk:t(Z2{FE(%");
      assertEquals("org.jsoup.nodes.Element", httpConnection_KeyVal0.value());
  }
  ...
  public void test074()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("org.jsoup.nodes.Element");
      assertEquals("<1=p%/Rq_", httpConnection_KeyVal1.key());
  }
  ...
  public void test076()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("`LDEx", "I]u");
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("`LDEx", httpConnection_KeyVal0.key());
  ...
  public void test079()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("<1=p%/Rq_", "org.jsoup.nodes.Element");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("<1=p%/Rq_");
      assertEquals("org.jsoup.nodes.Element", connection_KeyVal0.value());
      assertEquals("<1=p%/Rq_", connection_KeyVal0.key());
  }
  ...
  public void test080()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample?multipart%2Fform-data=Content-Encoding");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "jk");
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      Connection connection0 = httpConnection0.data("multipart/form-data", "Content-Encoding", (InputStream) null, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      connection0.get();
      httpConnection0.data("}", "Content-Type", (InputStream) null, ",L|KMhK");
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test082()  throws Throwable  {
      ...
      FileDescriptor fileDescriptor0 = new FileDescriptor();
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      httpConnection0.data(")r/'y8oH5_", "checkbox", (InputStream) mockFileInputStream0, "PATCH");
      try { 
        connection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test086()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.proxy("Header name must not be null", 43);
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
  ...
  public void test087()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(connection_Request0, (HttpConnection.Response) null);
      httpConnection_Response0.charset("*6>");
      // Undeclared exception!
      try { 
        httpConnection_Response0.body();
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test094()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "GkSMP", 1489, "ftp", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
        httpConnection0.post();
  ...
  public void test101()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.header("application/x-www-form-urlencoded", (String) null);
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test102()  throws Throwable  {
      ...
      hashMap0.put("Content-Encoding", "%22");
  ...
  public void test103()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("#comment", "application/x-www-form-urlencoded");
  ...
  public void test105()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("plaintext", "Content-Type");
  ...
  public void test109()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "org.jsoup.helper.HttpConnection$KeyVal");
  ...
  public void test110()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Referer", "\"OT", (InputStream) pipedInputStream0);
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("Referer=\"OT", string0);
  }

  @Test(timeout = 4000)
  public void test111()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("^u&f,iO", "Content-Encoding");
      httpConnection_KeyVal0.contentType();
      assertEquals("^u&f,iO", httpConnection_KeyVal0.key());
      assertEquals("Content-Encoding", httpConnection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test112()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("+ZP.WTx]>", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      httpConnection_KeyVal0.inputStream();
      assertEquals("+ZP.WTx]>", httpConnection_KeyVal0.key());
  ...
  public void test127()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-3492));
        fail("Expecting exception: IllegalArgumentException");
