...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.header("multipart/form-data", "%20");
  ...
  public void test003()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 830, (-2364));
      // Undeclared exception!
      try { 
        httpConnection0.data("org.jsoup.select.StructuralEvaluator$Has", "?7lcIY`,dn=:*o", (InputStream) byteArrayInputStream0, (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test004()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("application/x-www-form-urlencoded", 239);
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals(30000, httpConnection_Request1.timeout());
  ...
  public void test016()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize(1673);
  ...
  public void test022()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "`}U");
  ...
  public void test023()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("dA-~r{", "#%s");
      httpConnection_KeyVal0.hasInputStream();
      assertEquals("#%s", httpConnection_KeyVal0.value());
      assertEquals("dA-~r{", httpConnection_KeyVal0.key());
  }
  ...
  public void test035()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("application/x-www-form-urlencoded", 50);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test038()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("multipart/form-data", "Content-Encoding", 0, "application/x-www-form-urlencoded", uRLStreamHandler0);
  ...
  public void test039()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("multipart/form-data", "application/x-www-form-urlencoded", 1928, "multipart/form-data", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test041()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("org.jsoup.helper.httpconnection", "org.jsoup.helper.httpconnection", (InputStream) pipedInputStream0, "org.jsoup.helper.httpconnection");
  ...
  public void test044()  throws Throwable  {
      ...
      httpConnection0.request((Connection.Request) null);
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("htt|p", "Content-Encoding", 25, "Content-Type", uRLStreamHandler0);
      // Undeclared exception!
      try { 
        httpConnection0.url(uRL0);
  ...
  public void test047()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.requestBody("efert*#er");
        fail("Expecting exception: NullPointerException");
  ...
  public void test061()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("summary", "summary");
        fail("Expecting exception: NullPointerException");
  ...
  public void test066()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL1 = MockURL.URL(uRL0, "datalist", uRLStreamHandler0);
      httpConnection0.url(uRL1);
      // Undeclared exception!
      try { 
        httpConnection0.execute();
  ...
  public void test069()  throws Throwable  {
      ...
      httpConnection0.request((Connection.Request) null);
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)96, 402);
      // Undeclared exception!
      try { 
        httpConnection0.data("xmkc(!Jr?", "xmkc(!Jr?", (InputStream) byteArrayInputStream0, "($X5q5%h~xL7 (wZ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test070()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "https", (InputStream) pipedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test071()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("lV&NW", "lV&NW");
        fail("Expecting exception: NullPointerException");
  ...
  public void test080()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "doctypename");
      ...
      assertEquals("doctypename", httpConnection_KeyVal1.value());
  }

  @Test(timeout = 4000)
  public void test081()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "doctypename");
      assertEquals("doctypename", httpConnection_KeyVal0.value());
      
      httpConnection_KeyVal0.value("&pbj39UtO8sy+");
      assertEquals("multipart/form-data", httpConnection_KeyVal0.key());
  }

  @Test(timeout = 4000)
  public void test082()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("i", "{y(^d|ul+", (InputStream) null);
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("i", string0);
      assertEquals("{y(^d|ul+", httpConnection_KeyVal0.value());
  }
  ...
  public void test087()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded", "[%s]");
  ...
  public void test088()  throws Throwable  {
      ...
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
      httpConnection0.data("application/x-www-form-urlencoded", "V7T%QTVoU");
      try { 
  ...
  public void test089()  throws Throwable  {
      ...
      httpConnection0.cookie("};", "BYeF9$UQu;*x");
      try { 
        connection0.post();
  ...
  public void test090()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      httpConnection0.data("org.jsoup.select.Evaluator$AttributeWithValueStarting", "S#O*Y/_W[>np$D+", (InputStream) pipedInputStream0);
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
  ...
  public void test103()  throws Throwable  {
      URL uRL0 = MockURL.URL("https", "set-cookie", 77, "qZDg~tqwubh", (URLStreamHandler) null);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
  ...
  public void test119()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("8h;b:tkg<o7a", "8h;b:tkg<o7a");
  ...
  public void test120()  throws Throwable  {
      ...
      assertEquals("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36=`}U", string0);
  }

  @Test(timeout = 4000)
  public void test121()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("STOP", ":last-of-type");
      httpConnection_KeyVal0.contentType();
      assertEquals(":last-of-type", httpConnection_KeyVal0.value());
      assertEquals("STOP", httpConnection_KeyVal0.key());
  }
  ...
  public void test131()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpConnection.connect("@< f:u=B4]ZOH{!");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: @< f:u=B4]ZOH{!
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test133()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-3530));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test144()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("Content-Type", (-2874));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-2874
         //
