...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      httpConnection0.requestBody("[ pBC9/sB");
  ...
  public void test002()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("Content-Encoding", "application/x-www-form-urlencoded", (InputStream) pipedInputStream0);
  ...
  public void test005()  throws Throwable  {
      ...
      httpConnection_Request0.timeout(3932);
      assertEquals(3932, httpConnection_Request0.timeout());
  }
  ...
  public void test011()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("u&(<tY&", 200);
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
  ...
  public void test022()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("l=%:x{;-Y@", "l=%:x{;-Y@");
  ...
  public void test026()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "8tq*~+1.ZcN-Bm)xf]9");
  ...
  public void test033()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("<&;]GL21750O$Bq", "GyQ}/n,83~Tnbs", 0, "Data collection must not be null", uRLStreamHandler0);
  ...
  public void test034()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("Content-Type", "location", 104, "ScriptDataDoubleEscapedDash", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test036()  throws Throwable  {
      ...
      httpConnection0.data("s*m>y@5ay],}|", "s*m>y@5ay],}|", (InputStream) pushbackInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("s*m>y@5ay],}|");
  ...
  public void test040()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("inXrt", "inXrt", 68, "inXrt", uRLStreamHandler0);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.request((Connection.Request) null);
      // Undeclared exception!
      try { 
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.referrer("JKdomlf o");
        fail("Expecting exception: NullPointerException");
  ...
  public void test045()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("open", 118);
        fail("Expecting exception: NullPointerException");
  ...
  public void test053()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("Content-Type", "referer");
        fail("Expecting exception: NullPointerException");
  ...
  public void test067()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.header("must supply an even number of key value pairs", "must supply an even number of key value pairs");
  ...
  public void test071()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("UD;Oi+,(~BS", "");
  ...
  public void test077()  throws Throwable  {
      ...
      httpConnection0.cookie("q! {\"CZCBgX#]H[[B{Q", "template");
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
  ...
  public void test078()  throws Throwable  {
      ...
      httpConnection0.data("@", ";", (InputStream) bufferedInputStream0, "video");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test079()  throws Throwable  {
      ...
      httpConnection_Response0.addHeader("org.jsoup.select.Evaluator$Attribute", "org.jsoup.select.Evaluator$Attribute");
  ...
  public void test081()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.proxy("multipart/form-data", 2353);
      try { 
        httpConnection0.post();
        fail("Expecting exception: IOException");
  ...
  public void test082()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.requestBody("9,^<pd< \"");
      httpConnection0.url(uRL0);
      try { 
        connection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test084()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "application/x-www-form-urlencoded", 111, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
        httpConnection0.post();
  ...
  public void test088()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.maxBodySize(32793);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test089()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Map<String, List<String>> map0 = httpConnection_Response0.headers;
      httpConnection_Response0.addHeader("domg?lf o", "domg?lf o");
      // Undeclared exception!
      try { 
  ...
  public void test091()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>(45);
  ...
  public void test092()  throws Throwable  {
      ...
      hashMap0.put("LYqO+0", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
  ...
  public void test098()  throws Throwable  {
      ...
      assertEquals("l=%:x{;-Y@=l=%:x{;-Y@", string0);
  }
  ...
  public void test099()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(sequenceInputStream0, 8364);
  ...
  public void test100()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("CdataSection", "CdataSection");
  ...
  public void test108()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("multipart/form-data", "multipart/form-data", (InputStream) null, (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test132()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("5?-\"~+G", (-1151));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-1151
         //
