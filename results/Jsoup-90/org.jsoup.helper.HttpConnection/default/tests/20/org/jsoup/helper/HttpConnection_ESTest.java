...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test007()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("Lv2VW5H(K");
      assertFalse(httpConnection_Request0.ignoreHttpErrors());
      assertTrue(httpConnection_Request0.followRedirects());
      assertEquals(30000, httpConnection_Request0.timeout());
      assertEquals("Lv2VW5H(K", httpConnection_Request0.requestBody());
      assertEquals(1048576, httpConnection_Request0.maxBodySize());
      assertEquals("UTF-8", httpConnection_Request0.postDataCharset());
      assertFalse(httpConnection_Request0.ignoreContentType());
      assertFalse(connection_Request0.ignoreHttpErrors());
      assertEquals(30000, connection_Request0.timeout());
      assertEquals("Lv2VW5H(K", connection_Request0.requestBody());
      assertEquals("UTF-8", connection_Request0.postDataCharset());
      assertFalse(connection_Request0.ignoreContentType());
      assertTrue(connection_Request0.followRedirects());
      assertEquals(1048576, connection_Request0.maxBodySize());
  ...
  public void test010()  throws Throwable  {
      ...
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("Timeout milliseconds must be 0 (infinite) or greater", 0);
      assertNull(httpConnection_Request0.requestBody());
      assertFalse(httpConnection_Request0.ignoreHttpErrors());
      assertEquals("UTF-8", httpConnection_Request0.postDataCharset());
      assertFalse(httpConnection_Request0.ignoreContentType());
  ...
  public void test020()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("dYkkHe`}}Yvm*lV", "dYkkHe`}}Yvm*lV");
      assertFalse(httpConnection_KeyVal0.hasInputStream());
      assertEquals("dYkkHe`}}Yvm*lV", httpConnection_KeyVal0.key());
      assertEquals("dYkkHe`}}Yvm*lV", httpConnection_KeyVal0.value());
  ...
  public void test027()  throws Throwable  {
      ...
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "DhMu}lr`zrq{:p'l ");
      assertTrue(boolean0);
  ...
  public void test029()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Content-Encoding", "mUwp9[d?bM))~PRq", 128, "multipart/form-data", uRLStreamHandler0);
      assertEquals("multipart/form-data", uRL0.getPath());
      assertEquals("mUwp9[d?bM))~PRq:128", uRL0.getAuthority());
      assertEquals(0, uRL0.getDefaultPort());
      assertNull(uRL0.toString());
      assertEquals("multipart/form-data", uRL0.getFile());
      assertNull(uRL0.getRef());
      assertEquals("mUwp9[d?bM))~PRq", uRL0.getHost());
      assertNull(uRL0.getQuery());
      ...
      assertEquals("mUwp9[d?bM))~PRq:128", uRL1.getAuthority());
      assertEquals("multipart/form-data", uRL1.getPath());
      assertEquals("mUwp9[d?bM))~PRq", uRL1.getHost());
  ...
  public void test030()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("StF]22hQ.y*", "StF]22hQ.y*", (InputStream) pushbackInputStream0);
      assertNotNull(connection0);
      assertSame(httpConnection0, connection0);
      assertSame(connection0, httpConnection0);
      
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("StF]22hQ.y*");
      assertEquals("StF]22hQ.y*", connection_KeyVal0.key());
      assertNull(connection_KeyVal0.contentType());
      assertEquals("StF]22hQ.y*", connection_KeyVal0.value());
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("Key val must not be null", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test048()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "ja/\"arw9f]", (InputStream) null, "ja/\"arw9f]");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test055()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Wf.ST", "Wf.ST");
      assertEquals("Wf.ST", httpConnection_KeyVal0.key());
      assertNull(httpConnection_KeyVal0.contentType());
      assertFalse(httpConnection_KeyVal0.hasInputStream());
      assertEquals("Wf.ST", httpConnection_KeyVal0.value());
      assertNotNull(httpConnection_KeyVal0);
      
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("0+;rp%z/*}r[MLzoJ}");
      assertEquals("0+;rp%z/*}r[MLzoJ}", httpConnection_KeyVal0.key());
      assertNull(httpConnection_KeyVal0.contentType());
      assertFalse(httpConnection_KeyVal0.hasInputStream());
      assertEquals("Wf.ST", httpConnection_KeyVal0.value());
      assertEquals("Wf.ST", httpConnection_KeyVal1.value());
      assertFalse(httpConnection_KeyVal1.hasInputStream());
      assertNull(httpConnection_KeyVal1.contentType());
      assertEquals("0+;rp%z/*}r[MLzoJ}", httpConnection_KeyVal1.key());
  ...
  public void test056()  throws Throwable  {
      ...
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.header(";>$_B2qiud%", "         ");
      assertNull(httpConnection_Response0.statusMessage());
      assertEquals(0, httpConnection_Response0.statusCode());
      assertNull(httpConnection_Response0.charset());
      assertNull(httpConnection_Response0.contentType());
  ...
  public void test059()  throws Throwable  {
      ...
      assertNull(httpConnection_KeyVal0.contentType());
      assertEquals("Wf.ST", httpConnection_KeyVal1.value());
      assertEquals("Wf.ST", httpConnection_KeyVal1.key());
  ...
  public void test060()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("Wf.ST");
      assertEquals("Wf.ST", httpConnection_KeyVal0.key());
      assertNull(httpConnection_KeyVal0.contentType());
      assertFalse(httpConnection_KeyVal0.hasInputStream());
      assertEquals("Wf.ST", httpConnection_KeyVal0.value());
  ...
  public void test065()  throws Throwable  {
      ...
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("UTF-8");
      assertEquals("   ", httpConnection_KeyVal0.value());
      assertEquals("   ", httpConnection_KeyVal0.key());
      assertFalse(httpConnection_KeyVal0.hasInputStream());
      assertEquals("UTF-8", httpConnection_KeyVal0.contentType());
      assertEquals("   ", connection_KeyVal0.key());
      assertEquals("UTF-8", connection_KeyVal0.contentType());
  ...
  public void test066()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("0q[iSfCS9=`8x]", "0q[iSfCS9=`8x]");
      assertNotNull(connection0);
      assertSame(httpConnection0, connection0);
      assertSame(connection0, httpConnection0);
      
      Connection connection1 = httpConnection0.data("0q[iSfCS9=`8x]", "<QUU_#Fg^RDe{f4`", (InputStream) null);
      assertNotNull(connection1);
      assertSame(httpConnection0, connection0);
      assertSame(httpConnection0, connection1);
      assertSame(connection1, connection0);
  ...
  public void test067()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("s!KgCuUS~-2HT=", "s!KgCuUS~-2HT=", (InputStream) mockFileInputStream0);
      assertFalse(fileDescriptor0.valid());
      assertNotNull(connection0);
      assertSame(httpConnection0, connection0);
      assertSame(connection0, httpConnection0);
  ...
  public void test072()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.proxy("i", 402);
      assertNotNull(connection0);
      assertSame(httpConnection0, connection0);
      assertSame(connection0, httpConnection0);
  ...
  public void test078()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.maxBodySize(8364);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test082()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("B", "B", (InputStream) null);
  ...
  public void test087()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(">Wy*%ixzh_3", ">Wy*%ixzh_3");
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals(">Wy*%ixzh_3=>Wy*%ixzh_3", string0);
  }
  ...
  public void test098()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("Cannot set a request body for HTTP method ", "Content-Encoding", (InputStream) null, "application/x-www-form-urlencoded");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test101()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("471bj\" /^/", (String) null);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test105()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("Content-Encoding", "org.jsoup.safety.Cleaner$CleaningVisitor");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test112()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.removeCookie("multipart/form-data; boundary=");
      assertNull(httpConnection_Response1.contentType());
  }
  ...
  public void test118()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "DhMu}lr`zrq{:p'l ");
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      httpConnection0.get();
  ...
  public void test119()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("2Qy$\"#Q(`M;,", (-1289));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-1289
         //
