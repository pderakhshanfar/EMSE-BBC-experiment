...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test009()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("Content-Encoding", 112);
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertTrue(httpConnection_Request1.followRedirects());
  ...
  public void test022()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("nv5,LZJ+Wn1X", "I]");
      boolean boolean0 = httpConnection_KeyVal0.hasInputStream();
      assertFalse(boolean0);
      assertEquals("I]", httpConnection_KeyVal0.value());
      assertEquals("nv5,LZJ+Wn1X", httpConnection_KeyVal0.key());
  }
  ...
  public void test031()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("\"i", "multipart/form-data", 240, "Content-Encoding", uRLStreamHandler0);
  ...
  public void test032()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("F^fX", "application/x-www-form-urlencoded", 0, "M7", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test033()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("2Qs|hB))}oe@1!Zf", "2Qs|hB))}oe@1!Zf", (InputStream) byteArrayInputStream0, "2Qs|hB))}oe@1!Zf");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("2Qs|hB))}oe@1!Zf");
  ...
  public void test049()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.proxy("Content-Type", 8217);
      try { 
        httpConnection0.post();
  ...
  public void test061()  throws Throwable  {
      ...
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress(inetAddress0, 815);
  ...
  public void test064()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      LinkedList<Connection.KeyVal> linkedList0 = new LinkedList<Connection.KeyVal>();
      PipedInputStream pipedInputStream0 = new PipedInputStream(8211);
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("4<%J+9-k", "Content-Type", (InputStream) byteArrayInputStream0, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
        fail("Expecting exception: NullPointerException");
  ...
  public void test067()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("%,^RU!f5{uQT5", (String) null, (InputStream) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test075()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("JU>/F", "JU>/F");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("JU>/F");
  ...
  public void test076()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.header("Wef", "Wef");
  ...
  public void test078()  throws Throwable  {
      ...
      assertEquals("nv5,LZJ+Wn1X", httpConnection_KeyVal1.key());
  }

  @Test(timeout = 4000)
  public void test079()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("JU>/F", "JU>/F");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("JU>/F");
  ...
  public void test082()  throws Throwable  {
      ...
      assertEquals("org.jsoup.helper.HttpConnection$1", string0);
  }
  ...
  public void test084()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("JU>/F", "JU>/F");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("JU>/F");
  ...
  public void test087()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      Connection connection0 = httpConnection0.data("Ak ", "Data collection must not be null", (InputStream) pipedInputStream0);
      connection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test091()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.proxy("Content-Encoding", 1493);
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test093()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "BogusComment");
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(connection_Request0);
      HttpConnection.Response httpConnection_Response1 = httpConnection_Response0.charset("default");
  ...
  public void test098()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "Content-Type", 92, "multipart/form-data", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
        httpConnection0.get();
  ...
  public void test102()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.maxBodySize(458);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test104()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.addHeader("set-cookie", "Cannot set a request body for HTTP method ");
  ...
  public void test105()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("application/x-www-form-urlencoded", "|PgfbUVaehTD0");
  ...
  public void test106()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Content-Type", "(t5]FrzNH@ P'");
  ...
  public void test107()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("nYL", "nYL", (InputStream) null, "nYL");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("nYL");
      assertEquals("nYL", connection_KeyVal0.value());
      assertEquals("nYL", connection_KeyVal0.contentType());
  ...
  public void test112()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("UTF-16", "Content-Encoding");
  ...
  public void test113()  throws Throwable  {
      ...
      assertEquals("JU>/F=JU>/F", string0);
  }
  ...
  public void test123()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("?zlmwrrjg}gfoxst4+k", (String) null);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test128()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpConnection.connect("rawtextlessthansign");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: rawtextlessthansign
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test140()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("Content-Type", (-4345));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-4345
         //
