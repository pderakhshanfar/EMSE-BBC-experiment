...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.timeout(115);
  ...
  public void test003()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.userAgent("_;u");
  ...
  public void test004()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("Content-Encoding", "9JImA", (InputStream) pipedInputStream0);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test011()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("Op", 1935);
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test016()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize(2300);
      assertEquals(2300, httpConnection_Request0.maxBodySize());
  }
  ...
  public void test021()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("details", "olb}{");
      boolean boolean0 = httpConnection_KeyVal0.hasInputStream();
      assertFalse(boolean0);
      assertEquals("olb}{", httpConnection_KeyVal0.value());
  }
  ...
  public void test030()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Referer", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", 2, "Referer", uRLStreamHandler0);
  ...
  public void test031()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 994, (byte) (-128));
      httpConnection0.data("&&y_z`s", "&&y_z`s", (InputStream) byteArrayInputStream0, "QxFQh.gsL");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("&&y_z`s");
      assertEquals("QxFQh.gsL", connection_KeyVal0.contentType());
      assertEquals("&&y_z`s", connection_KeyVal0.value());
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("multipart/form-data", 50);
        fail("Expecting exception: NullPointerException");
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("Content-Type", (-101));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-101
         //
  ...
  public void test051()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("'", "org.jsoup.helper.HttpConnection");
        fail("Expecting exception: NullPointerException");
  ...
  public void test057()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      httpConnection0.proxy("BhPoreHead", 98);
      try { 
        httpConnection0.execute();
  ...
  public void test060()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, (String) null, (InputStream) null, "novalidate");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test061()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 2931, 2931);
      // Undeclared exception!
      try { 
  ...
  public void test062()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("PKc?zQxYs", "PKc?zQxYs");
        fail("Expecting exception: NullPointerException");
  ...
  public void test069()  throws Throwable  {
      ...
      assertEquals("olb}{", httpConnection_KeyVal1.value());
  }
  ...
  public void test072()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("There is an unread token pending!", "There is an unread token pending!");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.inputStream((InputStream) null);
      assertEquals("There is an unread token pending!", httpConnection_KeyVal1.key());
  }

  @Test(timeout = 4000)
  public void test073()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("details", "olb}{");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("BeforeDoctypeName");
      assertSame(httpConnection_KeyVal0, httpConnection_KeyVal1);
  }

  @Test(timeout = 4000)
  public void test074()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Timeout milliseconds must be 0 (infinite) or greater", "org.jsoup.select.StructuralEvaluator$Has");
      httpConnection_KeyVal0.key();
      assertEquals("org.jsoup.select.StructuralEvaluator$Has", httpConnection_KeyVal0.value());
  }
  ...
  public void test076()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("ScriptDataDoubleEscapeStart", "$TQ}ff=");
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("$TQ}ff=", string0);
  }
  ...
  public void test078()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("AOflPT\"?e,@F", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("AOflPT\"?e,@F");
  ...
  public void test081()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("W^A", "multipart/form-data", (InputStream) byteArrayInputStream0, "multipart/form-data");
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
  ...
  public void test085()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.addHeader("BeforeHead", "BeforeHead");
      Map<String, List<String>> map0 = httpConnection_Response0.headers;
      // Undeclared exception!
      try { 
        httpConnection_Response0.processResponseHeaders(map0);
  ...
  public void test087()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.proxy("BeforeDoctypePublicIdentifier", 96);
      Connection connection0 = httpConnection0.url(uRL0);
      try { 
        connection0.post();
        fail("Expecting exception: IOException");
  ...
  public void test089()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.requestBody("V{OW+p{gqb.1");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test091()  throws Throwable  {
      URL uRL0 = MockURL.URL("https", "https", 1933, "V:n&tN1}S", (URLStreamHandler) null);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.get();
  ...
  public void test098()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.header("Content-Type", "`+ d|#H\"x6r");
      try { 
        connection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test099()  throws Throwable  {
      ...
      hashMap0.put("Content-Encoding", "4x");
  ...
  public void test101()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "multipart/form-data", (InputStream) null, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
  ...
  public void test106()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("multipart/form-data", "org.jsoup.helper.HttpConnection");
  ...
  public void test127()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-232));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test129()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.removeCookie("4:;?es\"6vS_eG-<_");
      assertNull(httpConnection_Response1.contentType());
  }
