...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      httpConnection0.requestBody("ur+rrt<i_ted;+c*");
  ...
  public void test001()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.maxBodySize(53);
  ...
  public void test003()  throws Throwable  {
      ...
      httpConnection_Request0.timeout(1006);
      assertEquals(1006, httpConnection_Request0.timeout());
  }
  ...
  public void test008()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("O<ze\"1.O");
      assertTrue(connection_Request0.followRedirects());
      assertFalse(connection_Request0.ignoreContentType());
      assertEquals(1048576, connection_Request0.maxBodySize());
      assertEquals("UTF-8", connection_Request0.postDataCharset());
  ...
  public void test010()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("https", 103);
  ...
  public void test033()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("-BGRj", "set-cookie", 89, "Content-Encoding", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals(89, uRL1.getPort());
  }

  @Test(timeout = 4000)
  public void test034()  throws Throwable  {
      URL uRL0 = MockURL.URL("http", "ys.", 0, "b6N,BiH,KZ#k");
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test035()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("JX-NlBV", "9Qz'C{fH/IA5YQcD", (InputStream) null, "[%s=%s]");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("JX-NlBV");
      assertEquals("[%s=%s]", connection_KeyVal0.contentType());
      assertEquals("9Qz'C{fH/IA5YQcD", connection_KeyVal0.value());
  ...
  public void test043()  throws Throwable  {
      ...
      InetAddress inetAddress0 = MockInetAddress.getByName("K <#pJvtG");
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress(inetAddress0, 109);
  ...
  public void test044()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("Content-Encoding", 3213227);
        fail("Expecting exception: NullPointerException");
  ...
  public void test045()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("(6Jh>kcw&x%27INC", (-1819));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-1819
         //
  ...
  public void test046()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("D!=-KjbeU#<6qU\"");
  ...
  public void test047()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("[%s=%s]");
        fail("Expecting exception: NullPointerException");
  ...
  public void test052()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize(1666);
        fail("Expecting exception: NullPointerException");
  ...
  public void test056()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.header("https", "Content-Type");
        fail("Expecting exception: NullPointerException");
  ...
  public void test067()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("org.jsoup.select.Evaluator$ContainsData", "unF7AeHXwk", (InputStream) mockFileInputStream0, "Content-Type");
        fail("Expecting exception: NullPointerException");
  ...
  public void test068()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("l,4dd9", "", (InputStream) pushbackInputStream0, "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test069()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(pipedInputStream0, 1688);
      // Undeclared exception!
      try { 
  ...
  public void test070()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "org.jsoup.nodes.Document", (InputStream) sequenceInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test071()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("Uhq3%gkmlK", "7d_J1Y5Vs}(@");
        fail("Expecting exception: NullPointerException");
  ...
  public void test076()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("", "Ru:sP+dVR}2 8-Yw~");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test078()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpConnection.connect("1Z3Efr`+/F:sdBys-Z");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: 1Z3Efr`+/F:sdBys-Z
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test080()  throws Throwable  {
      File file0 = MockFile.createTempFile("d3{bHHIg&", "Content-Encoding");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "", (InputStream) mockFileInputStream0);
  ...
  public void test081()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.header("`#", "#");
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
  ...
  public void test082()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("1k^OB~x#q");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: 1k^OB~x#q
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test084()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("i>CP,4YPP:b", "i>CP,4YPP:b");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("i>CP,4YPP:b");
  ...
  public void test087()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)38, (-808));
  ...
  public void test090()  throws Throwable  {
      ...
      connection0.cookie("ch.k", "\"7(y31m174?S;l");
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test091()  throws Throwable  {
      ...
      connection0.data("Content-Encoding", ", state=", (InputStream) mockFileInputStream0);
      try { 
        connection0.post();
  ...
  public void test096()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.proxy("Content-Encoding", 4090);
      try { 
        httpConnection0.post();
        fail("Expecting exception: IOException");
  ...
  public void test097()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "pv1>ph$2EM$[");
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
      HttpConnection.Response httpConnection_Response2 = httpConnection_Response1.charset(")2aG=Y88}tg$dA(7)");
      // Undeclared exception!
      try { 
  ...
  public void test100()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "pv>h2EMR");
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
  ...
  public void test104()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "Cw[m<ngEnd", 78, "Cw[m<ngEnd", uRLStreamHandler0);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test106()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("Rhhi");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test107()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-1971));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test108()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("multipart/form-data", "F8]&RwQ9xpDNj]Y^");
      try { 
  ...
  public void test113()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("U}>|#NiI-<::;`-\"0$", "accept-encoding");
  ...
  public void test114()  throws Throwable  {
      ...
      httpConnection0.data("VOOmG", "set-cookie", (InputStream) pushbackInputStream0, "VOOmG");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("F8]&RwQ9xpDNj]Y^");
  ...
  public void test118()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.putIfAbsent("3uU)=v#Kqm?}SQ", "multipart/form-data");
  ...
  public void test119()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("org.jsoup.helper.HttpConnection$1", "Content-Encoding", (InputStream) pipedInputStream0);
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("org.jsoup.helper.HttpConnection$1=Content-Encoding", string0);
  }
  ...
  public void test120()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.requestBody(":matchesOwn(");
      httpConnection0.url(uRL0);
      httpConnection0.data("Content-Type", "multipart/form-data");
      try { 
        httpConnection0.post();
  ...
  public void test121()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "Unexpectedly reached end of file (EOF) in input state [%s]");
  ...
  public void test122()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("org.jsoup.helper.HttpConnection$Response", "content-type", (InputStream) null);
  ...
  public void test126()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(sequenceInputStream0, 200);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data(":xe,# 8oyjrb`", "Data key must not be empty", (InputStream) pushbackInputStream0, "Zg2*|'&;!LR");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data(":xe,# 8oyjrb`");
      assertEquals("Data key must not be empty", connection_KeyVal0.value());
      assertEquals("Zg2*|'&;!LR", connection_KeyVal0.contentType());
      assertNotNull(connection_KeyVal0);
  }
  ...
  public void test129()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("7d_J1Y5Vs}(@", "Uh3%gkmlK");
        fail("Expecting exception: NullPointerException");
  ...
  public void test133()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("formnovalidate");
      assertSame(httpConnection0, connection0);
  }
