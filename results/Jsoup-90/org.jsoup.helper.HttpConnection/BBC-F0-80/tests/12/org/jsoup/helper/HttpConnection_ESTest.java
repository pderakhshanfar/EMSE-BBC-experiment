...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "*brb&", (InputStream) null, "J&hZW5N*");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test005()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("d(}EnP", "");
  ...
  public void test009()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("%|QBXBy|'V,U@9");
  ...
  public void test011()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("application/x-www-form-urlencoded", 192);
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertTrue(httpConnection_Request1.followRedirects());
  ...
  public void test022()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(".", "-Kv9");
  ...
  public void test026()  throws Throwable  {
      ...
      Connection connection1 = httpConnection0.data("Content-Type", "multipart/form-data");
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample?Content-Type=multipart%2Fform-data");
  ...
  public void test031()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("application/x-www-form-urlencoded", 94);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test034()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("application/x-www-form-urlencoded", "application/x-www-form-urlencoded", 1907, "NkFs(F.Hbox", uRLStreamHandler0);
  ...
  public void test036()  throws Throwable  {
      ...
      httpConnection0.data(")", "extended", (InputStream) pushbackInputStream0);
  ...
  public void test037()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.userAgent("?u|RtD8qPwCvy`=");
  ...
  public void test048()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      MockFile mockFile0 = new MockFile((File) null, "5`t-2w|v");
  ...
  public void test056()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("", "4bb[7Z}h`/~xW+=");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("wbr", "wbr", (InputStream) pipedInputStream0, "wbr");
        fail("Expecting exception: NullPointerException");
  ...
  public void test066()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("xk.c\nZ[", (String) null, (InputStream) null, "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test067()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("n", "5z8r8jY[", (InputStream) pipedInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test068()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data(", state=", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test070()  throws Throwable  {
      ...
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      httpConnection0.request((Connection.Request) null);
      hashMap0.put("WDR`|3{Tc", " 4v%}\"rluo)");
      // Undeclared exception!
      try { 
  ...
  public void test075()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.header("Content-Type", ";9|-On_l,aCX");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test077()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.header("application/x-www-form-urlencoded", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
  ...
  public void test079()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("user-agent", "%|QBXBy|'V,U@9");
  ...
  public void test080()  throws Throwable  {
      ...
      assertEquals("\n7Ti>|+G`L&q1sy", httpConnection_KeyVal1.value());
  }

  @Test(timeout = 4000)
  public void test081()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("referer", "+rwx");
  ...
  public void test085()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "%|QBXBy|'V,U@9");
      // Undeclared exception!
      try { 
  ...
  public void test087()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.cookie("Content-Type", "I.`b4Q%");
      connection0.cookie("multipart/form-data", "hzj~0o.fjxn");
      try { 
        connection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test088()  throws Throwable  {
      ...
      connection0.data("multipart/form-data", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", (InputStream) byteArrayInputStream0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test093()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = connection0.request();
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(connection_Request0);
      HttpConnection.Response httpConnection_Response1 = httpConnection_Response0.charset("ep&|+");
      // Undeclared exception!
      try { 
  ...
  public void test098()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.data("\"", "oid}ws{!r1xkl4lk");
      try { 
        connection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test099()  throws Throwable  {
      ...
      URL uRL0 = MockURI.toURL(uRI0);
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.requestBody(":only-of-type");
      // Undeclared exception!
      try { 
        httpConnection0.get();
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test101()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.maxBodySize((-1361));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test102()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.timeout(2688);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test107()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("!@<d}eQHGkb,\"", "Content-Type");
  ...
  public void test108()  throws Throwable  {
      ...
      httpConnection0.data(stringArray0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("QmP");
  ...
  public void test113()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Content-Encoding", "s(A~6q");
  ...
  public void test114()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(";fxwO:HD+h{gQdH", "extended");
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals(";fxwO:HD+h{gQdH=extended", string0);
  }
  ...
  public void test116()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", ":empty");
      httpConnection_KeyVal0.inputStream();
      assertEquals(":empty", httpConnection_KeyVal0.value());
      assertEquals("multipart/form-data", httpConnection_KeyVal0.key());
  }
  ...
  public void test125()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("request has already been read (with .parse())", (String) null, (InputStream) pipedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test133()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.removeCookie("ascii");
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test135()  throws Throwable  {
      ...
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress("pubSysKey", 0);
  ...
  public void test142()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("http", (-4488));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-4488
         //
