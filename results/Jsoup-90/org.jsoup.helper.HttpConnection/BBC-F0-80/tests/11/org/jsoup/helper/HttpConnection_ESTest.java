...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      httpConnection_Request0.requestBody("R4%");
  ...
  public void test006()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("XZf+Yz<p", "P,0n$:`O-M^Y*v;i#");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("XZf+Yz<p");
      assertEquals("XZf+Yz<p", connection_KeyVal0.key());
      assertEquals("P,0n$:`O-M^Y*v;i#", connection_KeyVal0.value());
  }
  ...
  public void test010()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("", 47);
  ...
  public void test015()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.maxBodySize((-1219));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test021()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("pplication/x-www-form-urlencoded", "7GaX$&S");
      boolean boolean0 = httpConnection_KeyVal0.hasInputStream();
      assertEquals("pplication/x-www-form-urlencoded", httpConnection_KeyVal0.key());
      assertEquals("7GaX$&S", httpConnection_KeyVal0.value());
      assertFalse(boolean0);
  }
  ...
  public void test022()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "M7>woYD;y2");
      httpConnection_Request0.url = uRL0;
  ...
  public void test024()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "M7>wo/DR2");
      HttpConnection httpConnection0 = new HttpConnection();
  ...
  public void test027()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("org.jsoup.parser.TreeBuilder", 113);
  ...
  public void test030()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Content-Type", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", 0, "Content-Type", uRLStreamHandler0);
  ...
  public void test031()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("$ZyclChh(*", "Content-Encoding", 7, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals("$zyclchh(*", uRL1.getProtocol());
  }
  ...
  public void test032()  throws Throwable  {
      ...
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL1 = MockURL.URL(uRL0, ":prev%s", uRLStreamHandler0);
  ...
  public void test034()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("uhsmwX", "uhsmwX", (InputStream) pushbackInputStream0);
  ...
  public void test035()  throws Throwable  {
      ...
      httpConnection0.data("rawtKx]", "InputStream data not supported in URL query string.", (InputStream) pipedInputStream0, "rawtKx]");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("rawtKx]");
      assertEquals("rawtKx]", connection_KeyVal0.contentType());
  ...
  public void test036()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.userAgent("S<Lktlky/gQ\"bMnTO@");
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("Ga<_Cm2Fz81");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: Ga<_Cm2Fz81
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.requestBody("6f!S+");
        fail("Expecting exception: NullPointerException");
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.referrer("uu?*`o/.)m");
        fail("Expecting exception: NullPointerException");
  ...
  public void test045()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("Content-Encoding", 117);
        fail("Expecting exception: NullPointerException");
  ...
  public void test046()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("Data collectionmust not be null");
        fail("Expecting exception: IllegalCharsetNameException");
      
      } catch(IllegalCharsetNameException e) {
         //
         // Data collectionmust not be null
         //
  ...
  public void test048()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      MockFile mockFile0 = new MockFile("Xi1znGRnZY(F.");
  ...
  public void test052()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize(104);
        fail("Expecting exception: NullPointerException");
  ...
  public void test055()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.request((Connection.Request) null);
      HashMap<String, String> hashMap0 = new HashMap<String, String>(74);
      hashMap0.put((String) null, "!`O");
      // Undeclared exception!
      try { 
  ...
  public void test057()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("compact", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test069()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "/d^19l", (InputStream) pipedInputStream0, "Reques6 must not b null");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test070()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("_^`*-x_~Ljw.t,.wRv", "Content-Encoding", (InputStream) pipedInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test071()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "?Cx#H*");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test077()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpConnection.connect("Content-Disposition: form-data; name=\"");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test080()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.header("org.jsoup.helper.HttpConnection$Request", "org.jsoup.helper.HttpConnection$Request");
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test082()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("V^l-!=h1H", "Zc \"8g/42LxI> {i{+", (InputStream) bufferedInputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.inputStream((InputStream) bufferedInputStream0);
      assertEquals("Zc \"8g/42LxI> {i{+", httpConnection_KeyVal1.value());
      assertEquals("V^l-!=h1H", httpConnection_KeyVal1.key());
  }
  ...
  public void test083()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("t1gOgqUmF[!xW&JnBL");
  ...
  public void test085()  throws Throwable  {
      ...
      assertEquals("Zc \"8g/42LxI> {i{+", string0);
      assertEquals("V^l-!=h1H", httpConnection_KeyVal0.key());
  }
  ...
  public void test088()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      URL uRL0 = MockURL.getHttpExample();
      httpConnection_Request0.cookie("lc#YYrZZgh>U!", "lc#YYrZZgh>U!");
      httpConnection_Request0.cookie("M7>woYD;y2", "set-conkie");
      httpConnection_Request0.url = uRL0;
      try { 
        HttpConnection.Response.execute(httpConnection_Request0);
        fail("Expecting exception: IOException");
  ...
  public void test089()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 4234, 92);
      connection0.data("hykr", "aua5pnz+0uphu/)", (InputStream) byteArrayInputStream0, "hykr");
      try { 
        httpConnection0.post();
  ...
  public void test092()  throws Throwable  {
      LinkedList<String> linkedList0 = new LinkedList<String>();
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      hashMap0.put("set-coNkie", linkedList0);
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.processResponseHeaders(hashMap0);
      assertNull(httpConnection_Response0.charset());
  }
  ...
  public void test095()  throws Throwable  {
      ...
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress("set-conkie", 96);
  ...
  public void test096()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "M7>nwoYD;y2");
      httpConnection_Request0.url = uRL0;
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(httpConnection_Request0);
      httpConnection_Response0.charset("M7>nwoYD;y2");
      // Undeclared exception!
      try { 
  ...
  public void test099()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("boundary", "boundary", (InputStream) null, "boundary");
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
  ...
  public void test101()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      File file0 = MockFile.createTempFile("application/x-www-form-urlencoded", (String) null);
  ...
  public void test102()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("IomJent");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test105()  throws Throwable  {
      ...
      httpConnection_Request0.url = uRL0;
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(httpConnection_Request0);
      httpConnection_Response0.cookie("{U#0m!S?*]r*R?|e ", "User agent must not be null");
      HttpConnection.Response.execute(httpConnection_Request0, httpConnection_Response0);
      assertFalse(httpConnection_Request0.ignoreHttpErrors());
      assertEquals(1048576, httpConnection_Request0.maxBodySize());
      assertEquals("UTF-8", httpConnection_Request0.postDataCharset());
  ...
  public void test108()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.putIfAbsent("5~,m+>$[C", "Content-Encoding");
  ...
  public void test109()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      PipedInputStream pipedInputStream0 = new PipedInputStream(2436);
      httpConnection0.data("> oM{:eZUBJ[C", "Request must not be null", (InputStream) pipedInputStream0, "> oM{:eZUBJ[C");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("\"ALG3_*b&*Am~b~A:H");
  ...
  public void test110()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("A8+.aw_|]/EKS'nY", "-KcYXxx[OeDtxD?");
      httpConnection_Request0.data((Connection.KeyVal) httpConnection_KeyVal0);
      assertEquals("A8+.aw_|]/EKS'nY", httpConnection_KeyVal0.key());
      assertEquals("-KcYXxx[OeDtxD?", httpConnection_KeyVal0.value());
  ...
  public void test115()  throws Throwable  {
      FileDescriptor fileDescriptor0 = new FileDescriptor();
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("7U4wCm", "#/EELzQ", (InputStream) mockFileInputStream0);
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("7U4wCm=#/EELzQ", string0);
  }

  @Test(timeout = 4000)
  public void test116()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("!\"K~sd7jU?", "D~}{o_");
      httpConnection_KeyVal0.contentType();
      assertEquals("!\"K~sd7jU?", httpConnection_KeyVal0.key());
      assertEquals("D~}{o_", httpConnection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test117()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded", "2|9*Yi]f7:");
      httpConnection_KeyVal0.inputStream();
      assertEquals("2|9*Yi]f7:", httpConnection_KeyVal0.value());
  ...
  public void test125()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("Content-Type", "8r +Rb!j_L\".s5cP");
        fail("Expecting exception: NullPointerException");
  ...
  public void test133()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("5zkr~|bzheec");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test134()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-2535));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test135()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.cookie("j^eZ<TUCte", "[X]3q=1");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test137()  throws Throwable  {
      ...
      httpConnection_Request0.url = uRL0;
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(httpConnection_Request0);
      httpConnection_Response0.removeCookie("M7>nwoYD;y2");
      assertEquals(1048576, httpConnection_Request0.maxBodySize());
      assertEquals("UTF-8", httpConnection_Request0.postDataCharset());
      assertEquals(30000, httpConnection_Request0.timeout());
  }
  ...
  public void test141()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("Data key value pairs must not be null", "Data key value pairs must not be null", (InputStream) null, "@a5`vgF~ae");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("Data key value pairs must not be null");
      assertEquals("@a5`vgF~ae", connection_KeyVal0.contentType());
  ...
  public void test145()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("'F#eQ[~'j/Sew=KG", (-701));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-701
         //
