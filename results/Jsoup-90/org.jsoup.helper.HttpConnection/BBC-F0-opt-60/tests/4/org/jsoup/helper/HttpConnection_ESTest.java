...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.addHeader("6i;", "T:C");
  ...
  public void test004()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy(".?.h5/s;S:Vjap{{U", 31);
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
  ...
  public void test005()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Type", "y.", (InputStream) pushbackInputStream0);
  ...
  public void test009()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody(":matchesOwn(%s)");
  ...
  public void test024()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>(77, 77);
  ...
  public void test028()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("HrVme", "HrVme", 0, "HrVme", uRLStreamHandler0);
  ...
  public void test030()  throws Throwable  {
      ...
      httpConnection0.data("K8&pxf}6^Z&f9", "RA(OO:GG)Qw<e", (InputStream) pipedInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("K8&pxf}6^Z&f9");
      assertNotNull(connection_KeyVal0);
      assertEquals("RA(OO:GG)Qw<e", connection_KeyVal0.value());
  }
  ...
  public void test032()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.userAgent("&iE4I36CrTJGec`");
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("W)fm JSG'i{", 121);
        fail("Expecting exception: NullPointerException");
  ...
  public void test041()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("", (-1755));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-1755
         //
  ...
  public void test053()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("= DB", ",VZ^yli%iuV");
        fail("Expecting exception: NullPointerException");
  ...
  public void test062()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.data("Content-Encoding", "multipart/form-data", (InputStream) pipedInputStream0, "Zh}gy\u0002@8V%uAlN}S");
        fail("Expecting exception: NullPointerException");
  ...
  public void test063()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)0, (-4881));
      HttpConnection httpConnection0 = new HttpConnection();
      // Undeclared exception!
      try { 
        httpConnection0.data("7s6u*u*dm", (String) null, (InputStream) byteArrayInputStream0, (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test064()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("w-Ca^LGRcWkZ", "", (InputStream) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", (InputStream) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test071()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("T06= Z26{Vm{ZVK}", "T06= Z26{Vm{ZVK}");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("(HfOdNt");
  ...
  public void test072()  throws Throwable  {
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 2, (-1971453008));
  ...
  public void test073()  throws Throwable  {
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream((InputStream) null);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Type", "y.", (InputStream) pushbackInputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("y.");
  ...
  public void test074()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(dataInputStream0, (byte)52);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("(application|text)/w*+?xml.*", "Content-Encoding", (InputStream) pushbackInputStream0);
  ...
  public void test077()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Kv-3%SBsf]8[\">", "lRiWMus[}4ttE", (InputStream) sequenceInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("lRiWMus[}4ttE");
      assertEquals("lRiWMus[}4ttE", connection_KeyVal0.value());
  }
  ...
  public void test078()  throws Throwable  {
      ...
      stringArray0[3] = "method must not be null";
  ...
  public void test086()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("x`(xZJ&D*itT>cV Q", "x`(xZJ&D*itT>cV Q", (InputStream) null);
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.requestBody("x`(xZJ&D*itT>cV Q");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test087()  throws Throwable  {
      ...
      httpConnection0.data("QrVme", "hD/#oDDp", (InputStream) pipedInputStream0);
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
  ...
  public void test089()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "scriptdataendtagname", 2, "", uRLStreamHandler0);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test092()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-3304));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test097()  throws Throwable  {
      ...
      hashMap0.put("0b.gg;AsOQ=h", "multipart/form-data");
  ...
  public void test104()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("%Q{k", "%Q{k", (InputStream) null);
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("%Q{k=%Q{k", string0);
  }
  ...
  public void test107()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("w-Ca^LGRcWkZ", "Content-Type", (InputStream) null);
      httpConnection_KeyVal0.inputStream();
      assertEquals("w-Ca^LGRcWkZ", httpConnection_KeyVal0.key());
  ...
  public void test114()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = httpConnection_Response0.charset("%20");
  ...
  public void test115()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("MnK{@", "MnK{@", (InputStream) dataInputStream0, "a2R");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test119()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("&()@zWqo", "!)jE?/EccW&~%F:pq+[", 578, "Content-Type", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test122()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("'KNiOo_OAs", "%]SDrTV");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test131()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("", "NK!D,<V),Q");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test137()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("K8&pxkf}6^Z&f9", "K8&pxkf}6^Z&f9", (InputStream) null);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("K8&pxkf}6^Z&f9");
      assertNotNull(connection_KeyVal0);
      assertEquals("K8&pxkf}6^Z&f9", connection_KeyVal0.value());
  }
  ...
  public void test141()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("SYSTEM", 121);
      assertSame(httpConnection0, connection0);
  }
