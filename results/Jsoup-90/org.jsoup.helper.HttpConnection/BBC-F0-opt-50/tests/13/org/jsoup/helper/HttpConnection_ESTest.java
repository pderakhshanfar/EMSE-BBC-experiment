...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      linkedList0.add("l6z{xhlb=el%jlh");
  ...
  public void test001()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.header("a|Q", "a|Q");
  ...
  public void test002()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("http:/", "0[r*Bi<dP{Yi?yV<&", (InputStream) null);
  ...
  public void test003()  throws Throwable  {
      ...
      httpConnection_Request0.timeout(294);
      assertEquals(294, httpConnection_Request0.timeout());
  }
  ...
  public void test016()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded", "user-agent", (InputStream) pipedInputStream0);
  ...
  public void test024()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "^so");
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
  ...
  public void test026()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("TJ:dyjg$", ":only-child", 762, "multipart/form-data", uRLStreamHandler0);
  ...
  public void test028()  throws Throwable  {
      ...
      httpConnection0.data("CHjVI<2F/M6", "CHjVI<2F/M6", (InputStream) pipedInputStream0, "CHjVI<2F/M6");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("CHjVI<2F/M6");
      assertNotNull(connection_KeyVal0);
      assertEquals("CHjVI<2F/M6", connection_KeyVal0.value());
      assertEquals("CHjVI<2F/M6", connection_KeyVal0.contentType());
  }
  ...
  public void test030()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.userAgent("Request has already been read");
  ...
  public void test032()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.request((Connection.Request) null);
      MockFile mockFile0 = new MockFile("section", "tn`SpeHke1>");
  ...
  public void test036()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.requestBody("k@'>A88#HjRB+c");
        fail("Expecting exception: NullPointerException");
  ...
  public void test039()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("d]d4X Rz @d\"j2", 105);
        fail("Expecting exception: NullPointerException");
  ...
  public void test041()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("l{N7&]+I3`x");
  ...
  public void test055()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.proxy("so", 32768);
  ...
  public void test061()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection.Request connection_Request0 = httpConnection0.request();
      httpConnection0.data("application/x-www-form-urlencoded", "InputStream data not supported in URL query string.");
  ...
  public void test062()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "n+;WzrIfH[#S'8pDyX", (InputStream) byteArrayInputStream0, "O#UA?(");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test071()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("nKW=RDn@L<I Atf", "U144UDO$", (InputStream) sequenceInputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("U144UDO$");
      assertEquals("U144UDO$", httpConnection_KeyVal1.value());
  }
  ...
  public void test073()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data; boundary=", "", (InputStream) null);
  ...
  public void test074()  throws Throwable  {
      ...
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(enumeration0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("nKW=RDn@L<I Atf", "U144UDO$", (InputStream) sequenceInputStream0);
      assertEquals("U144UDO$", httpConnection_KeyVal0.value());
      
      httpConnection_KeyVal0.value("0,;Fb");
      assertEquals("nKW=RDn@L<I Atf", httpConnection_KeyVal0.key());
  }
  ...
  public void test075()  throws Throwable  {
      ...
      doReturn(false).when(enumeration0).hasMoreElements();
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(enumeration0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "%MsBxc'5m:UkV", (InputStream) sequenceInputStream0);
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("multipart/form-data", string0);
      assertEquals("%MsBxc'5m:UkV", httpConnection_KeyVal0.value());
  }
  ...
  public void test077()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("+rf<g+c{'", "[^-a-za-z0-9_:.]");
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("[^-a-za-z0-9_:.]", string0);
      assertEquals("+rf<g+c{'", httpConnection_KeyVal0.key());
  }
  ...
  public void test079()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Type", "\"GXj-sZfUOZ:-LO");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("Content-Encoding");
      assertEquals("\"GXj-sZfUOZ:-LO", connection_KeyVal0.value());
  ...
  public void test080()  throws Throwable  {
      ...
      connection0.data("ta", "h9_HkuOpp3t");
      URL uRL0 = MockURL.getHttpExample();
  ...
  public void test082()  throws Throwable  {
      ...
      httpConnection0.data("Et~^{", "Content-Encoding", (InputStream) pushbackInputStream0, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test087()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "by0jgcWrlX");
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(connection_Request0);
  ...
  public void test092()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.requestBody("Z%\"u=Is");
  ...
  public void test095()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.URL("https", "org.jsoup.safety.Cleaner$CleaningVisitor", 101, "Content-Type");
      httpConnection0.url(uRL0);
      Connection.Request connection_Request0 = httpConnection0.request();
      try { 
        HttpConnection.Response.execute(connection_Request0);
  ...
  public void test100()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "fr@dle");
      try { 
        HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
        fail("Expecting exception: IOException");
  ...
  public void test103()  throws Throwable  {
      ...
      hashMap0.put("W9ilqC^i&VD`x^~CEc", "JX<&,1OG%=mLNoA");
  ...
  public void test105()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("id", "application/x-www-form-urlencoded");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("ascii");
  ...
  public void test112()  throws Throwable  {
      ...
      assertEquals("nKW=RDn@L<I Atf=U144UDO$", string0);
  }

  @Test(timeout = 4000)
  public void test113()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Type", "Gj9N#@r*+'+bxm");
      httpConnection_KeyVal0.contentType();
      assertEquals("Content-Type", httpConnection_KeyVal0.key());
      assertEquals("Gj9N#@r*+'+bxm", httpConnection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test114()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("xzV`{vRG|e#", "xzV`{vRG|e#");
  ...
  public void test120()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer("^[0{#t5-4");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test123()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("9VMVm", "9VMVm", 0, "9VMVm", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals("9VMVm", uRL1.getFile());
  }
  ...
  public void test124()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpConnection.connect("org.jsoup.internal.ConstrainableInputStream");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: org.jsoup.internal.ConstrainableInputStream
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test134()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "Key val must not be null");
  ...
  public void test144()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.proxy("2|\"E]ISv^nbJQ#", 10);
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
