...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.addHeader("set-cookie", "!=4");
  ...
  public void test001()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("application/x-www-form-urlencoded", "%22", (InputStream) pipedInputStream0, "Cookie name must not be empty");
  ...
  public void test019()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("j{3k:*uA3/", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      boolean boolean0 = httpConnection_KeyVal0.hasInputStream();
      assertEquals("j{3k:*uA3/", httpConnection_KeyVal0.key());
  ...
  public void test021()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("ISO-8859-1", "xig7~<kg[fnb", (InputStream) null);
  ...
  public void test022()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "x{X702.,u");
  ...
  public void test026()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("mark", 0);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test029()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("InColumnGroup", "org.jsoup.select.evaluator$attributestarting", 80, "InColumnGroup", uRLStreamHandler0);
  ...
  public void test030()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("multipart/form-data", "pi_f{X@m!aa", 0, "c./d0:8", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("Si_/JQ/*,q>p[BNh");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test045()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("application/x-www-form-urlencoded", 2257);
  ...
  public void test050()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("d5wk", "d5wk");
        fail("Expecting exception: NullPointerException");
  ...
  public void test058()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("o-)`]'-Fe7wBT", (String) null, (InputStream) pipedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test065()  throws Throwable  {
      ...
      httpConnection_KeyVal0.key("}7c-'a");
      assertEquals("xig7~<kg[fnb", httpConnection_KeyVal0.value());
  }
  ...
  public void test067()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("EIgV3");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: EIgV3
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test068()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Zf;,.]", "Zf;,.]");
      ...
      assertEquals("Zf;,.]", httpConnection_KeyVal1.value());
  }

  @Test(timeout = 4000)
  public void test069()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("wbr", "wbr");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("x*ymx@9");
      assertNull(httpConnection_KeyVal1.contentType());
  }

  @Test(timeout = 4000)
  public void test070()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("on)ctj\"nxp)3i", ".YRpTglzT{`");
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("on)ctj\"nxp)3i", string0);
      assertEquals(".YRpTglzT{`", httpConnection_KeyVal0.value());
  }
  ...
  public void test071()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Response0.url(httpConnection_Response0.url);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test072()  throws Throwable  {
      PipedOutputStream pipedOutputStream0 = new PipedOutputStream();
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("LCMLK'cA\"sS(KW", "x4+?~2P0XHu7iNhaoO`", (InputStream) pipedInputStream0);
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("x4+?~2P0XHu7iNhaoO`", string0);
      assertEquals("LCMLK'cA\"sS(KW", httpConnection_KeyVal0.key());
  }
  ...
  public void test074()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Zf;,.]", "Zf;,.]");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("QV1,Mb^Vz^NR");
  ...
  public void test077()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.cookie("5S;w!", "5S;w!");
      httpConnection0.cookie("RB>}5B3j+KKrA9x(", "org.jsoup.UnsupportedMimeTypeException");
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.get();
  ...
  public void test078()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.addHeader("5xTz%9eZv9hmLVYM6", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
  ...
  public void test082()  throws Throwable  {
      ...
      connection0.data("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", " />", (InputStream) pipedInputStream0);
      // Undeclared exception!
      try { 
        httpConnection0.post();
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test084()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.requestBody(":K}n@;rJiF$~VJ");
      // Undeclared exception!
      try { 
        connection0.get();
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test086()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("area");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test087()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-3947));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test090()  throws Throwable  {
      ...
      hashMap0.put("Data collection must not be null", "boundary");
  ...
  public void test096()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "+{fP(+yNZ!9IbY>5", (InputStream) byteArrayInputStream0);
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36=+{fP(+yNZ!9IbY>5", string0);
  }
  ...
  public void test097()  throws Throwable  {
      ...
      httpConnection0.url(uRL0);
      httpConnection0.data("https", "Content-Encoding");
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test098()  throws Throwable  {
      ...
      httpConnection0.data("Ty", "2r", (InputStream) sequenceInputStream0, "Ty");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("Ty");
      assertEquals("2r", connection_KeyVal0.value());
      assertNotNull(connection_KeyVal0);
      assertEquals("Ty", connection_KeyVal0.contentType());
  }

  @Test(timeout = 4000)
  public void test099()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(pipedInputStream0, (byte)98);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("SX.2$(GI'nzA2k", "SX.2$(GI'nzA2k", (InputStream) bufferedInputStream0);
  ...
  public void test100()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(":u_=rK?I_!-9", ":u_=rK?I_!-9");
  ...
  public void test109()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("", "wVhhUll(", (InputStream) pushbackInputStream0, "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test111()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("cUqgPBzP,", (String) null);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test113()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("yyb`i\"l{0ho@0kf");
  ...
  public void test115()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.timeout(1291);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test121()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("WQcjBkt;1", (-1634));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-1634
         //
  ...
  public void test127()  throws Throwable  {
      ...
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress(inetAddress0, 15);
  ...
  public void test130()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("$'XP`)P|G<'o!P:;dtY", "aside");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("yyb`i\"l{0ho@0kf");
      assertNull(connection_KeyVal0);
  }
