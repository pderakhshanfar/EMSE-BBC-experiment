...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      httpConnection_Response0.header("Set-Cookie", "n!s>=:ryftn;5j$0");
  ...
  public void test008()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.postDataCharset(";SzL3,ew");
  ...
  public void test018()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("ins", "ins");
  ...
  public void test021()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("pwKAK", "multipart/form-data");
  ...
  public void test026()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "q/.93", 191, "q/.93", uRLStreamHandler0);
  ...
  public void test027()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("%20", "d", 0, "%20", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals("d:0", uRL1.getAuthority());
  }

  @Test(timeout = 4000)
  public void test028()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Jm|_{{WZTOs_", "Jm|_{{WZTOs_");
  ...
  public void test029()  throws Throwable  {
      ...
      httpConnection0.data("0#0EN", "AG=R7~vg6^@G3o9#", (InputStream) pipedInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("0#0EN");
      assertNotNull(connection_KeyVal0);
      assertEquals("AG=R7~vg6^@G3o9#", connection_KeyVal0.value());
  }
  ...
  public void test036()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.referrer("~<(r\"nto%fz2");
        fail("Expecting exception: NullPointerException");
  ...
  public void test039()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("application/x-www-form-urlencoded", 81);
        fail("Expecting exception: NullPointerException");
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("multipart/form-data", (-254));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-254
         //
  ...
  public void test044()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      MockFile mockFile0 = new MockFile("<&}7INy+y\"MBfA1L[B|", "<&}7INy+y\"MBfA1L[B|");
      URL uRL0 = mockFile0.toURL();
      httpConnection0.url(uRL0);
      try { 
  ...
  public void test046()  throws Throwable  {
      ...
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress(3501);
  ...
  public void test059()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("http", "http", 103, "http", uRLStreamHandler0);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test064()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, (String) null, (InputStream) bufferedInputStream0, "boundary");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("<aw3text", "<aw3text");
        fail("Expecting exception: NullPointerException");
  ...
  public void test066()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("", "<)1D'g0t&6-#(KX1%");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test067()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("9%lXV,Al-4e");
        fail("Expecting exception: NullPointerException");
  ...
  public void test069()  throws Throwable  {
      ...
      hashMap0.put("]mZrZ-AC[", (String) null);
      // Undeclared exception!
      try { 
  ...
  public void test073()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 827, (-563));
      DataInputStream dataInputStream0 = new DataInputStream(byteArrayInputStream0);
      httpConnection0.data("URL must not be null", "URL must not be null", (InputStream) dataInputStream0);
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test075()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("Must supply an even number of key value pairs");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test078()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("g5g<-p{G`lZKUu", "", (InputStream) null);
  ...
  public void test082()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Type", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("Request must be executed (with .execute(), .get(), or .post() before parsing response");
  ...
  public void test083()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.URL("https", "*snJZk3v:^5r", 12, "https");
      httpConnection0.url(uRL0);
  ...
  public void test084()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      httpConnection0.cookie("Cookie name must not be empty", "id");
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      try { 
        HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
        fail("Expecting exception: IOException");
  ...
  public void test091()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "org.jsoup.helper.HttpConnection$Request");
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(connection_Request0);
  ...
  public void test094()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 114, (byte)46);
      Connection connection0 = httpConnection0.data("URL must not be null", "LYn)~Y0{gwB?q", (InputStream) byteArrayInputStream0);
      connection0.requestBody("gWNu|E");
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
        httpConnection0.post();
  ...
  public void test098()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("applet");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test099()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-1194));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test101()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "p`");
      try { 
        HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
        fail("Expecting exception: IOException");
  ...
  public void test104()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("accept-encoding", "Charset must not be null");
  ...
  public void test105()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("open", "open");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("image");
  ...
  public void test111()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("xA*", "xA*");
  ...
  public void test118()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream((InputStream) null, 294);
      Connection connection0 = httpConnection0.data("\r\n", "o)lrihcowv", (InputStream) bufferedInputStream0, "org.jsoup.helper.W3CDom");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test120()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer("O^R/,Njxn.");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test121()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("-Y0", "-Y0");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test122()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("content-encoding", ">MOo");
        fail("Expecting exception: NullPointerException");
  ...
  public void test123()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("A ojR)jkEY", (String) null, (InputStream) mockFileInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test128()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("application/x-www-form-urlencoded", 1126);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test129()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.maxBodySize(403);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test136()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("maxSize must be 0 (unlimited) or larger", "beforedoctypesystemidentifier");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("maxSize must be 0 (unlimited) or larger");
      assertNotNull(connection_KeyVal0);
      assertEquals("beforedoctypesystemidentifier", connection_KeyVal0.value());
  }
