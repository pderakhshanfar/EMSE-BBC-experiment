...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      httpConnection0.requestBody(".=(Ot[A:!ORJ$B");
  ...
  public void test003()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("3U", "3U");
  ...
  public void test009()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("tzpI*70%");
      assertEquals(30000, connection_Request0.timeout());
  ...
  public void test014()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize(47);
      assertEquals(47, httpConnection_Request0.maxBodySize());
  }
  ...
  public void test019()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("](/<", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", (InputStream) byteArrayInputStream0);
  ...
  public void test026()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("f", "0Em^Qo.+:", (int) (byte)0, "0Em^Qo.+:", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals("[0Em^Qo.+:]", uRL1.getHost());
  }

  @Test(timeout = 4000)
  public void test027()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("multipart/form-data", ">A|N;_8T,\"Zpeai<e", 2199, "", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals(">A|N;_8T,\"Zpeai<e:2199", uRL1.getAuthority());
  }
  ...
  public void test030()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.userAgent("NAk0");
  ...
  public void test034()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.requestBody("section");
        fail("Expecting exception: NullPointerException");
  ...
  public void test035()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.referrer("LglY<jvx:,;$l2+u");
        fail("Expecting exception: NullPointerException");
  ...
  public void test037()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("2d?jAzop", 105);
        fail("Expecting exception: NullPointerException");
  ...
  public void test038()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("5.vw&nn8u=omwkb", 1048576);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.postDataCharset("lOJZ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test049()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("request has already been read (with .parse())", "~lq<6.QGwJ};E.9/U");
        fail("Expecting exception: NullPointerException");
  ...
  public void test050()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("", "hTBuUwq\"`dgym@?6s");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test052()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL1 = MockURL.URL(uRL0, "=o", uRLStreamHandler0);
  ...
  public void test061()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(pushbackInputStream0, 32768);
      // Undeclared exception!
      try { 
        httpConnection0.data("Referer", "#&g@dL}RJ:o", (InputStream) bufferedInputStream0, "y#I#(oH=6&y");
        fail("Expecting exception: NullPointerException");
  ...
  public void test062()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 709, (byte)1);
      // Undeclared exception!
      try { 
        httpConnection0.data("W", "Content-Type", (InputStream) byteArrayInputStream0, (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test069()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("Tag name must not be empty.", "Tag name must not be empty.");
        fail("Expecting exception: NullPointerException");
  ...
  public void test072()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "h2");
  ...
  public void test074()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("{OW'u*},(#; tcPm=,>");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: {OW'u*},(#; tcPm=,>
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test076()  throws Throwable  {
      ...
      httpConnection_KeyVal0.value("71");
      assertEquals("Content-Encoding", httpConnection_KeyVal0.key());
  }
  ...
  public void test077()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("org.jsoup.select.Evaluator$IsFirstOfType", "org.jsoup.helper.DataUtil", (InputStream) bufferedInputStream0);
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("org.jsoup.helper.DataUtil", httpConnection_KeyVal0.value());
  ...
  public void test079()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("HTTP error fetching URL", "Content-Encoding");
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("Content-Encoding", string0);
      assertEquals("HTTP error fetching URL", httpConnection_KeyVal0.key());
  }
  ...
  public void test081()  throws Throwable  {
      FileDescriptor fileDescriptor0 = new FileDescriptor();
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Cookie", ";[gio'myzkifx", (InputStream) mockFileInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("xG c:Boe>+1~AI*B");
      assertEquals(";[gio'myzkifx", connection_KeyVal0.value());
      assertEquals("Cookie", connection_KeyVal0.key());
  }
  ...
  public void test082()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.data("m((l'8gmh7-; *aj?z", "m((l'8gmh7-; *aj?z");
      connection0.data("QR6Cy1{", "Content-Type");
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test083()  throws Throwable  {
      ...
      connection0.cookie("fallback", "m:Dq{awmB");
      URL uRL0 = MockURL.getHttpExample();
      connection0.url(uRL0);
      try { 
        httpConnection0.post();
  ...
  public void test084()  throws Throwable  {
      ...
      connection0.data("multipart/form-data", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", (InputStream) byteArrayInputStream0, " fk(");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test087()  throws Throwable  {
      ...
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      hashMap0.put("5.vw&nn8u=omwkb", linkedList0);
      httpConnection_Response0.processResponseHeaders(hashMap0);
      assertNull(httpConnection_Response0.contentType());
  }
  ...
  public void test094()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("Content-Type", "Content-Type");
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.requestBody("pVrXBajIn ?");
      connection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test096()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "ScrQ0GDana", 117, "blockquote", uRLStreamHandler0);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test099()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-2623));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test101()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("multipart/form-data", "Pp_");
      try { 
        HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
        fail("Expecting exception: IOException");
  ...
  public void test102()  throws Throwable  {
      ...
      linkedList0.offerLast("aBQ`N@E~WXd2.^;?}");
      hashMap0.put("set-cookie", linkedList0);
      httpConnection_Response0.processResponseHeaders(hashMap0);
      assertEquals(0, httpConnection_Response0.statusCode());
  }
  ...
  public void test105()  throws Throwable  {
      ...
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("tgvj~wA#Q");
  ...
  public void test108()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("application/x-www-form-urlencoded", "uD!|xQc<a^lYqw=");
  ...
  public void test109()  throws Throwable  {
      ...
      assertEquals("HTTP error fetching URL=Content-Encoding", string0);
  }
  ...
  public void test111()  throws Throwable  {
      ...
      connection_KeyVal0.inputStream();
  ...
  public void test116()  throws Throwable  {
      ...
      httpConnection0.data("UOHSz", "UOHSz", (InputStream) pipedInputStream0, "RawtextEndTagName");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("UOHSz");
      assertNotNull(connection_KeyVal0);
      assertEquals("RawtextEndTagName", connection_KeyVal0.contentType());
      assertEquals("UOHSz", connection_KeyVal0.value());
  }
  ...
  public void test118()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer(":{FRdoUV>E#:/77z");
  ...
  public void test119()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("F,vtp|C6X8", "Content-Encoding", (InputStream) null);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test122()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("lOJZ");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test125()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("NAk0");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test126()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.proxy("Content-Encoding", 965);
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
  ...
  public void test127()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.maxBodySize(834);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test131()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.removeCookie("hG");
  ...
  public void test137()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("InputStream data not supported in URL query string.", 0);
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
