...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test011()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HttpConnection.Request httpConnection_Request0 = (HttpConnection.Request)httpConnection0.request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", 4066);
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
  ...
  public void test015()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection.Request connection_Request0 = httpConnection0.request();
      connection_Request0.maxBodySize(22);
  ...
  public void test021()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("(application|text)/w*+?xml.*", "T59j.qaGIEl~&");
      ...
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals("T59j.qaGIEl~&", httpConnection_KeyVal0.value());
  ...
  public void test022()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("GBUa#", "u(!$", (InputStream) mockFileInputStream0);
  ...
  public void test027()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("multipart/form-data", "", 8224, "org.jsoup.select.Evaluator$Id", uRLStreamHandler0);
  ...
  public void test028()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "Content-Encoding", 0, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test030()  throws Throwable  {
      ...
      httpConnection0.data("J^08VA<tMuWd", "J^08VA<tMuWd", (InputStream) pipedInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("J^08VA<tMuWd");
      assertEquals("J^08VA<tMuWd", connection_KeyVal0.value());
  ...
  public void test038()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.requestBody("zw3_A t3Y]4NgXlS");
        fail("Expecting exception: NullPointerException");
  ...
  public void test039()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.referrer("Malformed URL: ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test041()  throws Throwable  {
      ...
      InetSocketAddress inetSocketAddress0 = MockInetSocketAddress.createUnresolved("multipart/form-data", 9);
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("/AY@wY|D", 3266);
        fail("Expecting exception: NullPointerException");
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("E>B[L", (-2960));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-2960
         //
  ...
  public void test054()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("set-cookie", "set-cookie");
        fail("Expecting exception: NullPointerException");
  ...
  public void test064()  throws Throwable  {
      ...
      httpConnection0.data("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "Content-Type", (InputStream) pipedInputStream0, "Content-Encoding");
  ...
  public void test066()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("pI", "pI", (InputStream) sequenceInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test067()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1657, (byte)120);
      // Undeclared exception!
      try { 
  ...
  public void test068()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "URL must be specified to connect");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test073()  throws Throwable  {
      ...
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("GBUa#", "u(!$", (InputStream) mockFileInputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("u(!$");
  ...
  public void test076()  throws Throwable  {
      ...
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("GBUa#", "u(!$", (InputStream) mockFileInputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("GBUa#");
  ...
  public void test079()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded", "w/`^x{w", (InputStream) bufferedInputStream0);
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("w/`^x{w", string0);
  }
  ...
  public void test081()  throws Throwable  {
      ...
      stringArray0[3] = "Accept-EncodyPing";
      httpConnection0.data(stringArray0);
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test082()  throws Throwable  {
      ...
      connection0.cookie("3k<smh$[;R*9wWn", "label");
      try { 
        httpConnection0.post();
  ...
  public void test083()  throws Throwable  {
      ...
      httpConnection0.url(uRL0);
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)40, 6);
      httpConnection0.data("8fYG:_5?ntu.$K(", "Request must be executed (with .execute(), .get(), or .post() before getting response body", (InputStream) byteArrayInputStream0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test087()  throws Throwable  {
      ...
      InetSocketAddress inetSocketAddress0 = MockInetSocketAddress.createUnresolved("Y\"k~e@.y4hNKqn", 2241);
      Proxy proxy0 = new Proxy(proxy_Type0, inetSocketAddress0);
  ...
  public void test089()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.requestBody("#c>,xK/gQ[");
  ...
  public void test098()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.header("(application|text)/w*+?xml.*", (String) null);
  ...
  public void test099()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      Connection connection1 = connection0.header("Content-Type", "g4NmI1Qx");
      try { 
        connection1.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test100()  throws Throwable  {
      ...
      hashMap0.put("mf^tRoX$+", "Content-Type");
  ...
  public void test101()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("{7+&3g5a0% u(G]41O", "{7+&3g5a0% u(G]41O");
      HttpConnection httpConnection0 = new HttpConnection();
  ...
  public void test103()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("g7J`");
  ...
  public void test104()  throws Throwable  {
      ...
      PipedOutputStream pipedOutputStream0 = new PipedOutputStream();
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("eof", "Content-Encoding", (InputStream) pipedInputStream0);
  ...
  public void test108()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)0, 200);
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("org.jsoup.helper.W3CDom$W3CBuilder", "", (InputStream) pushbackInputStream0);
  ...
  public void test109()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("org.jsoup.nodes.CDataNode", "W%u8\"&D_Q`e>");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("accept-encoding");
      assertEquals("org.jsoup.nodes.CDataNode", connection_KeyVal0.key());
      assertEquals("W%u8\"&D_Q`e>", connection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test110()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("]\"Es9", "|^^r5~*<pw");
      httpConnection_KeyVal0.contentType();
      assertEquals("|^^r5~*<pw", httpConnection_KeyVal0.value());
      assertEquals("]\"Es9", httpConnection_KeyVal0.key());
  }

  @Test(timeout = 4000)
  public void test111()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("org.jsoup.nodes.attributes$dataset", "org.jsoup.nodes.attributes$dataset");
  ...
  public void test119()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, (String) null, (InputStream) null, "@00XRFvm+Kz");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test133()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.removeCookie("@}KmTVk");
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
  ...
  public void test140()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.URL("https", "Content-Encoding", 67, "^`vc3D1@", (URLStreamHandler) null);
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test142()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("Charset must not be null", 1837);
      assertSame(connection0, httpConnection0);
  }
