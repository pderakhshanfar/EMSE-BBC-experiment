...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test007()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("v\"3)qV");
  ...
  public void test010()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("", 320);
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
  ...
  public void test012()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.postDataCharset(".9T{mV");
  ...
  public void test022()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("5V/pe[n7]+", "5V/pe[n7]+");
  ...
  public void test029()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("k:3(6E)F<%->", 4484);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test031()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("multipart/form-data", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", 0, " ", uRLStreamHandler0);
  ...
  public void test032()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("application/x-www-form-urlencoded", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", 119, "Content-Type", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test034()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 101, (-279));
      httpConnection0.data("l_|>", "l_|>", (InputStream) byteArrayInputStream0, "?");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("l_|>");
      assertNotNull(connection_KeyVal0);
      assertEquals("l_|>", connection_KeyVal0.value());
  ...
  public void test036()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.userAgent("` sKYN~n*);;b5#\"k");
  ...
  public void test044()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("<Vcn_AH", 1183);
        fail("Expecting exception: NullPointerException");
  ...
  public void test045()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("A OKXBk");
        fail("Expecting exception: NullPointerException");
  ...
  public void test055()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header((String) null, "Data collection must not be null");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test058()  throws Throwable  {
      ...
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress(382);
  ...
  public void test064()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("qPnB~gj.jfOZ#+S?9", (String) null, (InputStream) null, "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test065()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("org.jsoup.select.CombiningEvaluator", "T5D@L~N-D\"G?Vz", (File) mockFile0);
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      // Undeclared exception!
      try { 
        httpConnection0.data("set-gookie", "set-gookie", (InputStream) mockFileInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test066()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "~|&sg1", (InputStream) pipedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test067()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("Accept-Encoding", "|QZz8");
        fail("Expecting exception: NullPointerException");
  ...
  public void test071()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("k:3(6E)F<%->", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test072()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("L:O#A?#EHk", "L:O#A?#EHk", (InputStream) pipedInputStream0);
      assertEquals("L:O#A?#EHk", httpConnection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test073()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Type", "OMX_ /{)W4Riq]f");
      assertEquals("Content-Type", httpConnection_KeyVal0.key());
      
      httpConnection_KeyVal0.key("user-agent");
      assertEquals("OMX_ /{)W4Riq]f", httpConnection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test074()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.header("; ", "; ");
  ...
  public void test079()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Key val must not be null", "Key val must not be null");
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("Key val must not be null", string0);
  }
  ...
  public void test081()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Type", "OMX_ /{)W4Riq]f");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("maxSize must be 0 (unlimited) or larger");
      assertEquals("OMX_ /{)W4Riq]f", connection_KeyVal0.value());
  ...
  public void test083()  throws Throwable  {
      ...
      Connection connection1 = httpConnection0.cookie("Content-Type", "Content-Type");
      connection1.cookie("file", "org.jsoup.helper.HttpConnection$Request");
      try { 
        connection0.post();
  ...
  public void test084()  throws Throwable  {
      ...
      httpConnection0.data("y~0", "/`}t},}n6dzkdj", (InputStream) pushbackInputStream0, "application/x-www-form-urlencoded");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test086()  throws Throwable  {
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      hashMap0.putIfAbsent("Content-Type", linkedList0);
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.processResponseHeaders(hashMap0);
  ...
  public void test098()  throws Throwable  {
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.add("                    ");
      linkedList0.push("Content-Encoding");
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      hashMap0.putIfAbsent("set-cookie", linkedList0);
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.processResponseHeaders(hashMap0);
  ...
  public void test099()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("referer", (String) null);
  ...
  public void test100()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>(8221, 8221);
      hashMap0.put("application/x-www-form-urlencoded", ")poMG`T|");
  ...
  public void test101()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("P]4;C@~", "Cannot set a request body for HTTP method ");
  ...
  public void test102()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("maxsize must be 0 (unlimited) or larger", "#JcvbjHhx");
      Connection.KeyVal connection_KeyVal0 = connection0.data("maxsize must be 0 (unlimited) or larger");
      assertNotNull(connection_KeyVal0);
      assertEquals("#JcvbjHhx", connection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test103()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("maxsize must be 0 (unlimited) or larger", "#JcvbjHhx");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data(")f0.(tn");
  ...
  public void test110()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("DoctypeName", "multipart/form-data");
      httpConnection_KeyVal0.inputStream();
      assertEquals("DoctypeName", httpConnection_KeyVal0.key());
      assertEquals("multipart/form-data", httpConnection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test111()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "IQ83A@}S");
      ...
      assertEquals("IQ83A@}S", httpConnection_KeyVal0.value());
  }
  ...
  public void test120()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("[%s=%s]", "\"IQ@]]%cg2~cC`0n{0");
        fail("Expecting exception: NullPointerException");
  ...
  public void test123()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("org.jsoup.select.CombiningEvaluator", "T5D@L~N-D\"G?Vz", (File) mockFile0);
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      Connection connection0 = httpConnection0.data("set-gookie", "set-gookie", (InputStream) mockFileInputStream0);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test124()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.timeout(2954);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test128()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("Ly#8|");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test131()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.removeCookie("h.UZS");
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
  ...
  public void test138()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("Ly#8|", (-1138));
        fail("Expecting exception: IllegalArgumentException");
