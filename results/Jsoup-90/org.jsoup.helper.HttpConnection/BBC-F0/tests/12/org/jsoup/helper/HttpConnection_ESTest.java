...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test009()  throws Throwable  {
      ...
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("multipart/form-data", 2103);
      assertSame(httpConnection_Request0, httpConnection_Request1);
      assertSame(httpConnection_Request1, httpConnection_Request0);
      assertFalse(httpConnection_Request0.ignoreContentType());
      assertEquals("UTF-8", httpConnection_Request0.postDataCharset());
  ...
  public void test017()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("%ipk8<4w.6M|", "%ipk8<4w.6M|");
      assertEquals("%ipk8<4w.6M|", httpConnection_KeyVal0.key());
      assertNull(httpConnection_KeyVal0.contentType());
      assertFalse(httpConnection_KeyVal0.hasInputStream());
      assertEquals("%ipk8<4w.6M|", httpConnection_KeyVal0.value());
  ...
  public void test018()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "1l u0?h)vga7,~");
      assertEquals("1l u0?h)vga7,~", httpConnection_KeyVal0.value());
      assertFalse(httpConnection_KeyVal0.hasInputStream());
  ...
  public void test021()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.referrer("td");
      assertSame(httpConnection0, connection0);
      assertSame(connection0, httpConnection0);
      assertNotNull(connection0);
  }
  ...
  public void test022()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.maxBodySize(1114111);
      assertSame(httpConnection0, connection0);
      assertSame(connection0, httpConnection0);
      assertNotNull(connection0);
  }
  ...
  public void test025()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("text/", "yCmtS(6Ds=8wV#'", (InputStream) byteArrayInputStream0);
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0}, byteArray0);
      assertSame(httpConnection0, connection0);
      assertSame(connection0, httpConnection0);
      assertEquals(3, byteArray0.length);
  ...
  public void test030()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("  Wl", (-645));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-645
         //
  ...
  public void test036()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Content-Encoding", "yY='To*", 26, "U5F\"=33#5|?", uRLStreamHandler0);
      assertEquals("content-encoding", uRL0.getProtocol());
      assertNull(uRL0.getUserInfo());
      assertEquals("U5F\"=33", uRL0.getPath());
      assertEquals(0, uRL0.getDefaultPort());
      assertEquals("U5F\"=33", uRL0.getFile());
      assertEquals("5|?", uRL0.getRef());
      assertEquals("yY='To*:26", uRL0.getAuthority());
      assertNull(uRL0.getQuery());
      assertEquals("yY='To*", uRL0.getHost());
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("Data value must not be null", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("{~ajhfb", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test045()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("%ipk8<4w.6M|");
      ...
      assertNull(httpConnection_KeyVal0.contentType());
      assertEquals("%ipk8<4w.6M|", httpConnection_KeyVal0.key());
      assertEquals("%ipk8<4w.6M|", httpConnection_KeyVal1.value());
      assertEquals("%ipk8<4w.6M|", httpConnection_KeyVal1.key());
  ...
  public void test046()  throws Throwable  {
      ...
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.header("%22", (String) null);
      assertSame(httpConnection_Request0, httpConnection_Request1);
      assertSame(httpConnection_Request1, httpConnection_Request0);
      assertFalse(httpConnection_Request0.ignoreHttpErrors());
      assertNull(httpConnection_Request0.requestBody());
  ...
  public void test048()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("org.jsoup.select.Evaluator$CssNthEvaluator", "application/x-www-form-urlencoded");
  ...
  public void test050()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(":last-of-type", "Content-Type", (InputStream) pipedInputStream0);
      assertEquals(0, pipedInputStream0.available());
  ...
  public void test052()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("user-agent", "V+k");
      assertFalse(httpConnection_KeyVal0.hasInputStream());
      assertEquals("V+k", httpConnection_KeyVal0.value());
  ...
  public void test055()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("1^;aB]m\"I<'e_l@", "1^;aB]m\"I<'e_l@");
      assertFalse(httpConnection_KeyVal0.hasInputStream());
      assertEquals("1^;aB]m\"I<'e_l@", httpConnection_KeyVal0.value());
      assertNull(httpConnection_KeyVal0.contentType());
      assertEquals("1^;aB]m\"I<'e_l@", httpConnection_KeyVal0.key());
      assertNotNull(httpConnection_KeyVal0);
      
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("_w(");
      assertSame(httpConnection_KeyVal0, connection_KeyVal0);
      assertSame(connection_KeyVal0, httpConnection_KeyVal0);
      assertFalse(httpConnection_KeyVal0.hasInputStream());
      assertEquals("1^;aB]m\"I<'e_l@", httpConnection_KeyVal0.value());
      assertEquals("1^;aB]m\"I<'e_l@", httpConnection_KeyVal0.key());
      assertEquals("_w(", httpConnection_KeyVal0.contentType());
      assertEquals("1^;aB]m\"I<'e_l@", connection_KeyVal0.value());
      assertEquals("_w(", connection_KeyVal0.contentType());
      assertEquals("1^;aB]m\"I<'e_l@", connection_KeyVal0.key());
  ...
  public void test056()  throws Throwable  {
      ...
      Connection connection2 = connection1.data("Content-Type", "0t}z/w=q");
  ...
  public void test057()  throws Throwable  {
      ...
      boolean boolean0 = linkedList0.add("application/octet-stream");
      assertTrue(boolean0);
      assertTrue(linkedList0.contains("application/octet-stream"));
  ...
  public void test059()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.proxy("InputStream data not supported in URL query string.", 8192);
      assertSame(httpConnection0, connection0);
      assertSame(connection0, httpConnection0);
      assertNotNull(connection0);
  ...
  public void test061()  throws Throwable  {
      ...
      Connection connection1 = connection0.requestBody("T");
      assertSame(httpConnection0, connection0);
      assertSame(httpConnection0, connection1);
      assertSame(connection0, connection1);
      assertSame(connection0, httpConnection0);
  ...
  public void test066()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("CTq", (String) null);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test067()  throws Throwable  {
      ...
      hashMap0.putIfAbsent("Content-Type", "n");
  ...
  public void test070()  throws Throwable  {
      ...
      stringArray0[7] = "Content-Type";
      httpConnection0.data(stringArray0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("Rn9");
  ...
  public void test071()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("@8IO%((O", "D", (InputStream) null);
  ...
  public void test075()  throws Throwable  {
      ...
      assertEquals("user-agent=V+k", string0);
  }
  ...
  public void test077()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("object", "./a");
      httpConnection_KeyVal0.inputStream();
      assertEquals("./a", httpConnection_KeyVal0.value());
      assertEquals("object", httpConnection_KeyVal0.key());
  }
  ...
  public void test085()  throws Throwable  {
      ...
      FileDescriptor fileDescriptor0 = new FileDescriptor();
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      httpConnection0.data("/$", "multipart/form-data", (InputStream) mockFileInputStream0, "ISO-8859-1");
      URL uRL0 = MockURL.getHttpExample();
  ...
  public void test090()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("E(<j84", "Content-Type", 4632, "application/x-www-form-urlencoded", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test093()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("T$QkdYEv4OVC|UGn\"", (String) null, (InputStream) byteArrayInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test097()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("&[hp!jm3k(|");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test100()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-625));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test102()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.cookie("X$J>7u<", "v:*<z<R7+F2 ");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test104()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.removeCookie("%22");
      assertTrue(httpConnection_Request1.followRedirects());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertFalse(httpConnection_Request1.ignoreContentType());
