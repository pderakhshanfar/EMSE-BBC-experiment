...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.referrer("wZH");
  ...
  public void test005()  throws Throwable  {
      ...
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("id", 191);
      assertEquals(1048576, httpConnection_Request0.maxBodySize());
      assertTrue(httpConnection_Request0.followRedirects());
      assertEquals(30000, httpConnection_Request0.timeout());
      assertFalse(httpConnection_Request0.ignoreHttpErrors());
  ...
  public void test009()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection_Request0.maxBodySize(38);
      assertNull(httpConnection_Request0.requestBody());
      ...
      assertEquals(38, connection_Request0.maxBodySize());
  ...
  public void test016()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.proxy("mQKtf", 2);
      assertSame(httpConnection0, connection0);
      assertSame(connection0, httpConnection0);
      assertNotNull(connection0);
  }
  ...
  public void test018()  throws Throwable  {
      MockFile mockFile0 = new MockFile("CommentStartDash", "CommentStartDash");
      ...
      assertEquals("/experiment/CommentStartDash/CommentStartDash", mockFile0.toString());
      assertTrue(mockFile0.isAbsolute());
      assertEquals("CommentStartDash", mockFile0.getName());
      assertEquals(0L, mockFile0.getUsableSpace());
      assertFalse(mockFile0.isHidden());
      assertEquals("/experiment/CommentStartDash", mockFile0.getParent());
  ...
  public void test019()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("vWG{O8t:<M:BE;1", "", (InputStream) pipedInputStream0);
      assertEquals(0, pipedInputStream0.available());
      assertSame(httpConnection0, connection0);
      assertSame(connection0, httpConnection0);
      assertNotNull(connection0);
  ...
  public void test024()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.referrer("U|fGW<YwMo");
        fail("Expecting exception: NullPointerException");
  ...
  public void test026()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy((String) null, 95);
        fail("Expecting exception: NullPointerException");
  ...
  public void test032()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("]kxi?o;", "Content-Encoding");
        fail("Expecting exception: NullPointerException");
  ...
  public void test033()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header((String) null, "marquee");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("Zwm", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test052()  throws Throwable  {
      ...
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("EndTag");
      assertEquals("EndTag", httpConnection_KeyVal0.contentType());
      assertEquals("Content-Encoding", httpConnection_KeyVal0.value());
      assertEquals("Content-Type", httpConnection_KeyVal0.key());
      assertFalse(httpConnection_KeyVal0.hasInputStream());
      assertFalse(connection_KeyVal0.hasInputStream());
      assertEquals("EndTag", connection_KeyVal0.contentType());
  ...
  public void test053()  throws Throwable  {
      ...
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0, 1374);
      assertEquals(0, pipedInputStream0.available());
      assertNotNull(pipedInputStream0);
      
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("L+ea5d=P", "multipart/form-data", (InputStream) pipedInputStream0);
      assertEquals(0, pipedInputStream0.available());
      assertEquals("L+ea5d=P", httpConnection_KeyVal0.key());
      assertTrue(httpConnection_KeyVal0.hasInputStream());
      assertNull(httpConnection_KeyVal0.contentType());
  ...
  public void test054()  throws Throwable  {
      ...
      Connection connection1 = httpConnection0.cookie("ZNS;.$$>o^55=3~", "org.jsoup.examples.HtmlToPlainText$FormattingVisitor");
      ...
      Connection connection2 = httpConnection0.cookie("Content-Type", "Content-Encoding");
  ...
  public void test062()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-822));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test063()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.timeout(81);
      assertEquals(81, httpConnection_Request0.timeout());
  }

  @Test(timeout = 4000)
  public void test064()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.addHeader("output", (String) null);
  ...
  public void test065()  throws Throwable  {
      ...
      hashMap0.put("Content-Encoding", "W=Ja7T?9l4y7;&");
  ...
  public void test067()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("qS|27t,@xtm+B6{=", ";;/PG");
      ...
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(";;/PG", httpConnection_KeyVal0.value());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertEquals("qS|27t,@xtm+B6{=", httpConnection_KeyVal0.key());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals(1048576, httpConnection_Request0.maxBodySize());
  ...
  public void test071()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "f!pf.O");
  ...
  public void test072()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("org.jsoup.helper.HttpConnection$Base", "Must supply an even number of key value pairs", (InputStream) pipedInputStream0);
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("org.jsoup.helper.HttpConnection$Base=Must supply an even number of key value pairs", string0);
  }
  ...
  public void test073()  throws Throwable  {
      FileDescriptor fileDescriptor0 = new FileDescriptor();
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded; charset=", "contenttype", (InputStream) mockFileInputStream0);
      ...
      assertEquals("contenttype", string0);
  }
  ...
  public void test074()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("org.jsoup.helper.DataUtil", "Must supply an even number of key value pairs", (InputStream) sequenceInputStream0, "Tf_dC3quZj");
      assertSame(connection0, httpConnection0);
  }

  @Test(timeout = 4000)
  public void test075()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Type", "\"p,2h)pP:O");
      httpConnection_KeyVal0.contentType();
      assertEquals("\"p,2h)pP:O", httpConnection_KeyVal0.value());
      assertEquals("Content-Type", httpConnection_KeyVal0.key());
  }
  ...
  public void test076()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("PF$um#>/ ", "!G8W5,A9R;tN", (InputStream) pipedInputStream0);
      httpConnection_KeyVal0.inputStream();
      assertEquals("!G8W5,A9R;tN", httpConnection_KeyVal0.value());
      assertEquals("PF$um#>/ ", httpConnection_KeyVal0.key());
  }
  ...
  public void test085()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = httpConnection_Response0.charset("accept-encoding");
      assertNull(httpConnection_Response1.statusMessage());
  }
  ...
  public void test086()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "BeforeHead", (InputStream) pushbackInputStream0, "BeforeHead");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test088()  throws Throwable  {
      ...
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress(inetAddress0, 94);
  ...
  public void test089()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("]kxi?o;", "Content-Encoding");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test091()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("q%ixKfC~/T6g", "q%ixKfC~/T6g", 1427, "'k)/T;y^(AnU#", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals("q%ixKfC~/T6g:1427", uRL1.getAuthority());
  }
  ...
  public void test094()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "locqu|ote", (InputStream) bufferedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test100()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("accept-encoding");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test111()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("X|9{I`D", "(6?<ivt#iw?*ow");
      assertSame(connection0, httpConnection0);
  }
