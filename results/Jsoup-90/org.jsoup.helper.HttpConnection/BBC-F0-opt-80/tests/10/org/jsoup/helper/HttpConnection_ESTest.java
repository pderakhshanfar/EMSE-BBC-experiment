...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test016()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("org.jsoup.select.StructuralEvaluator$Has", "", (InputStream) mockFileInputStream0);
  ...
  public void test017()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Cookie", "r f*Dl4<-");
      boolean boolean0 = httpConnection_KeyVal0.hasInputStream();
      assertEquals("Cookie", httpConnection_KeyVal0.key());
      assertFalse(boolean0);
      assertEquals("r f*Dl4<-", httpConnection_KeyVal0.value());
  }
  ...
  public void test020()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.removeCookie("RcdataLessthanSign");
  ...
  public void test024()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("oy*/>$nN", 102);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test028()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Tg!SL:JIVb:]Zget0K0", "ScriptDataEscaped", 94, "mozilla/5.0 (macintosh; intel mac os x 10_11_6) applewebkit/537.36 (khtml, like gecko) chrome/53.0.2785.143 safari/537.36", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals("tg!sl:jivb:]zget0k0", uRL1.getProtocol());
  }

  @Test(timeout = 4000)
  public void test029()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("font", "wP*", 0, "wP*", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals("wP*:0", uRL1.getAuthority());
  }
  ...
  public void test031()  throws Throwable  {
      ...
      httpConnection0.data("LzW\"H%euPa(B HmR,", "LzW\"H%euPa(B HmR,", (InputStream) byteArrayInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("LzW\"H%euPa(B HmR,");
      assertEquals("LzW\"H%euPa(B HmR,", connection_KeyVal0.value());
  ...
  public void test036()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("{-vXJJ{:hG-w|5Zc");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: {-vXJJ{:hG-w|5Zc
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test041()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("*XCf4AC0In_x('pPa");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test051()  throws Throwable  {
      ...
      hashMap0.put("*=", ":has(el) subselect must not be empty");
      // Undeclared exception!
      try { 
  ...
  public void test052()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("", "Insert position out of bounds.");
      HttpConnection httpConnection0 = new HttpConnection();
      // Undeclared exception!
      try { 
        httpConnection0.headers(hashMap0);
  ...
  public void test053()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("YtiS{[f*uL", "YtiS{[f*uL");
        fail("Expecting exception: NullPointerException");
  ...
  public void test061()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("Content-Type", "file", (InputStream) null, "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test062()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1495), (byte) (-110));
      // Undeclared exception!
      try { 
        connection0.data("application/x-www-form-urlencoded", "application/x-www-form-urlencoded", (InputStream) byteArrayInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test066()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("-|[fb%JN^a!6@!d\"L");
        fail("Expecting exception: NullPointerException");
  ...
  public void test073()  throws Throwable  {
      File file0 = MockFile.createTempFile("]?e", "#document");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(",u`k/Ufyxl?M", "]?e", (InputStream) mockFileInputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("kQ.");
  ...
  public void test076()  throws Throwable  {
      ...
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(",u`k/Ufyxl?M", "]?e", (InputStream) mockFileInputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("#document");
  ...
  public void test080()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("@_.M VPo9~{<D/<a#Q", "Content-Type", (InputStream) null);
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("@_.M VPo9~{<D/<a#Q", httpConnection_KeyVal0.key());
  ...
  public void test082()  throws Throwable  {
      ...
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("%/%tdz2jI");
  ...
  public void test085()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.url(uRL0);
      httpConnection0.cookie("b3;9jz", "multipart/form-data");
      try { 
        connection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test090()  throws Throwable  {
      ...
      httpConnection_Response1.charset("http");
      // Undeclared exception!
      try { 
  ...
  public void test093()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.url(uRL0);
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)70, 61);
      connection0.data("^+", "", (InputStream) byteArrayInputStream0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test095()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "https", 1341, "T_P+{u", uRLStreamHandler0);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test098()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize(505);
      assertEquals(505, httpConnection_Request0.maxBodySize());
  }
  ...
  public void test100()  throws Throwable  {
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.add("EiG$ H~n1iDt|y");
      linkedList0.add((String) null);
      hashMap0.put("tJt~7&^$@u", linkedList0);
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.processResponseHeaders(hashMap0);
      assertEquals(1, hashMap0.size());
  }
  ...
  public void test101()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("$=bY!w-vS`+Jy", (String) null);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test104()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("]|GkgmzbSjM", "Content-Encoding");
  ...
  public void test105()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("sub", "LzW\"H%euPa(B HmR,", (InputStream) null);
  ...
  public void test106()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("KNma");
  ...
  public void test107()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Type", "hv0jd>yg{4i");
  ...
  public void test110()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("Jv0hVe+", "Jv0hVe+");
      HttpConnection httpConnection0 = new HttpConnection();
  ...
  public void test112()  throws Throwable  {
      ...
      assertEquals(",u`k/Ufyxl?M", httpConnection_KeyVal0.key());
      assertEquals("]?e", httpConnection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test113()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("accept-encoding", "l?d<$z]ap");
      httpConnection_KeyVal0.inputStream();
      assertEquals("l?d<$z]ap", httpConnection_KeyVal0.value());
  ...
  public void test119()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("m]<\"aX<N,+t`Bb8", "\n * ", (InputStream) null, "x8ur*/");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test120()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL(", state=", ", state=", 29, ", state=", uRLStreamHandler0);
  ...
  public void test123()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("o#r?", "o#r?");
        fail("Expecting exception: NullPointerException");
  ...
  public void test126()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("application/x-www-form-urlencoded", "]*xg$S=IkG7Z`=[#!", (InputStream) null);
      Connection.KeyVal connection_KeyVal0 = connection0.data("KNma");
      assertNull(connection_KeyVal0);
  }
  ...
  public void test131()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("-|[fb%JN^a!6@!d\"L", (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test132()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-3171));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test141()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("Content-Type", 8204);
      assertEquals(30000, httpConnection_Request1.timeout());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
