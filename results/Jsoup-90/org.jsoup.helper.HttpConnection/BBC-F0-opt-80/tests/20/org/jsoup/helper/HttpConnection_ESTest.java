...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      httpConnection_Response0.header("Set-Cookie", ">2yWRw?G`y={_\r");
  ...
  public void test003()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("7)/jp", "]ja");
  ...
  public void test005()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("PUBLIC", "PUBLIC");
  ...
  public void test010()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("", 1960);
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals(30000, httpConnection_Request1.timeout());
  ...
  public void test021()  throws Throwable  {
      File file0 = MockFile.createTempFile("set-cookie", "application/x-www-form-urlencoded", (File) null);
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("location", "multipart/form-data", (InputStream) mockFileInputStream0);
  ...
  public void test022()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "30B");
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      Connection.Request connection_Request0 = httpConnection0.request();
  ...
  public void test024()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("J]5-BGyq;FGiNGR?>s", "application/x-www-form-urlencoded", (InputStream) sequenceInputStream0);
  ...
  public void test031()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("multipart/form-data", "htp", 94, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", uRLStreamHandler0);
  ...
  public void test033()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-112), (byte)6);
      httpConnection0.data("n^maM1WAQsLy0GUu\"Z", "n^maM1WAQsLy0GUu\"Z", (InputStream) byteArrayInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("n^maM1WAQsLy0GUu\"Z");
      assertEquals("n^maM1WAQsLy0GUu\"Z", connection_KeyVal0.value());
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.requestBody("canvas");
        fail("Expecting exception: NullPointerException");
  ...
  public void test042()  throws Throwable  {
      ...
      InetSocketAddress inetSocketAddress0 = MockInetSocketAddress.createUnresolved("application/x-www-form-urlencoded", 106);
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy(",e+`)9!)l6m,{+", 104);
        fail("Expecting exception: NullPointerException");
  ...
  public void test044()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("q?", (int) (byte) (-3));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test046()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset(" \t<9+)R4BLyuBV2;");
        fail("Expecting exception: NullPointerException");
  ...
  public void test061()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.data("Content-Encoding", "\"Th)Mj7n#", (InputStream) bufferedInputStream0, "name");
        fail("Expecting exception: NullPointerException");
  ...
  public void test062()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(pipedInputStream0, 2117);
      // Undeclared exception!
      try { 
        httpConnection0.data("rTW?8", (String) null, (InputStream) bufferedInputStream0, "rTW?8");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test063()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("; ", "9(", (InputStream) pipedInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test064()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 92, 92);
      // Undeclared exception!
      try { 
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.data("content-type", "~^X");
        fail("Expecting exception: NullPointerException");
  ...
  public void test071()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("`%e#>?Bjc&&g{3I", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      assertEquals("`%e#>?Bjc&&g{3I", httpConnection_KeyVal0.key());
      
      httpConnection_KeyVal0.key("1 ^6xa,\"(^$#cgg9m");
  ...
  public void test072()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("^:RJWPCQM,i%9kwS");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: ^:RJWPCQM,i%9kwS
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test073()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "b}v8Ty8xGKS-]GWTr");
      byte[] byteArray0 = new byte[8];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-526), 767);
      ...
      assertEquals("b}v8Ty8xGKS-]GWTr", httpConnection_KeyVal1.value());
  }
  ...
  public void test074()  throws Throwable  {
      ...
      httpConnection_KeyVal0.value("'\"RCF*");
      assertEquals("application/x-www-form-urlencoded", httpConnection_KeyVal0.key());
  }

  @Test(timeout = 4000)
  public void test075()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("W'lR0' oCE)", "request must not be null");
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("W'lR0' oCE)", string0);
  ...
  public void test079()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("PUBLIC", "PUBLIC");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("PUBLIC");
      assertEquals("PUBLIC", connection_KeyVal0.contentType());
  }
  ...
  public void test081()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("inputstream data not supported in url query string.", ",/![.FFC'");
      httpConnection0.data("V", "O.K\"n0", (InputStream) null, "V");
      Connection connection0 = httpConnection0.url(uRL0);
      try { 
        connection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test082()  throws Throwable  {
      ...
      Connection connection1 = connection0.cookie("$j=562Ie3/`K8lei", "multipart/form-data");
      httpConnection0.url(uRL0);
  ...
  public void test083()  throws Throwable  {
      ...
      httpConnection_Response1.header("application/x-www-form-urlencoded", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
  ...
  public void test085()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>(98, 98);
  ...
  public void test086()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.proxy("Request has already been read (with .parse())", 117);
      try { 
        httpConnection0.execute();
        fail("Expecting exception: IOException");
  ...
  public void test087()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(connection_Request0);
      HttpConnection.Response httpConnection_Response1 = httpConnection_Response0.charset("maxSize must be 0 (unlimited) or larger");
      // Undeclared exception!
      try { 
  ...
  public void test092()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      Connection connection0 = httpConnection0.data("application/x-www-form-urlencoded", "Content-Encoding", (InputStream) pipedInputStream0, "Content-Encoding");
      httpConnection0.url(uRL0);
  ...
  public void test093()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      Connection connection0 = httpConnection0.data("]@K`]_:YXQ,fb}r# ~R", "FXD9V8CY\n=|lbM", (InputStream) pipedInputStream0, "FXD9V8CY\n=|lbM");
  ...
  public void test095()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "VvNoe", 81, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
        httpConnection0.get();
  ...
  public void test097()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-2452));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test098()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "30.B");
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      Connection.Request connection_Request0 = connection0.request();
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(connection_Request0);
      httpConnection_Response0.cookie("[j|8zod", "AvS*`]E_p;L0 wh+");
      HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
      assertEquals(30000, connection_Request0.timeout());
      assertFalse(connection_Request0.ignoreHttpErrors());
      assertEquals(1048576, connection_Request0.maxBodySize());
  ...
  public void test099()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.header("Content-Type", "va3{5'");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test100()  throws Throwable  {
      ...
      hashMap0.put("Referer", "mi(j<y%M?r:u");
  ...
  public void test102()  throws Throwable  {
      ...
      httpConnection0.data("Jn|NV&na4o.gh", "Jn|NV&na4o.gh", (InputStream) byteArrayInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("ACECJW!@C.HdM!\"?)[B");
  ...
  public void test103()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      LinkedHashSet<Connection.KeyVal> linkedHashSet0 = new LinkedHashSet<Connection.KeyVal>(2143);
  ...
  public void test107()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("jn|nv&na4o.gh", "multipart/form-data");
  ...
  public void test108()  throws Throwable  {
      ...
      assertEquals("multipart/form-data=b}v8Ty8xGKS-]GWTr", string0);
  }
  ...
  public void test110()  throws Throwable  {
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-246), (byte) (-3));
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(";", "org.jsoup.select.Evaluator$IndexEquals", (InputStream) byteArrayInputStream0);
      httpConnection_KeyVal0.inputStream();
      assertEquals("org.jsoup.select.Evaluator$IndexEquals", httpConnection_KeyVal0.value());
  ...
  public void test117()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("?", "request must not be null");
        fail("Expecting exception: NullPointerException");
  ...
  public void test119()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("9(", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", (InputStream) null);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("9(");
      assertNotNull(connection_KeyVal0);
  ...
  public void test124()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("Content-Disposition: form-data; name=\"");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test125()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.maxBodySize(2829);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test129()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("open");
      assertEquals("UTF-8", connection_Request0.postDataCharset());
      assertFalse(connection_Request0.ignoreContentType());
      assertTrue(connection_Request0.followRedirects());
      assertEquals(1048576, connection_Request0.maxBodySize());
