...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("application/x-www-form-urlencoded", "eOo");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test012()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("InHeadNoscript", 31);
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test014()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.postDataCharset("?{~0nz}fg");
  ...
  public void test022()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("bnH-c:7DpW4p'A=^V;", "application/x-www-form-urlencoded");
  ...
  public void test027()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer("KhUY}:");
  ...
  public void test029()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Cannot set a request body for HTTP method ", "Cannot set a request body for HTTP method ", 0, "eb=pDcg3", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals("cannot set a request body for http method ", uRL1.getProtocol());
  }

  @Test(timeout = 4000)
  public void test030()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("Content-Type", "Content-Encoding", 259, "application/x-www-form-urlencoded", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test032()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("qPX:o>r@s$m", "qPX:o>r@s$m");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("qPX:o>r@s$m");
      assertEquals("qPX:o>r@s$m", connection_KeyVal0.value());
  ...
  public void test041()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("p-*gH{", (-870));
        fail("Expecting exception: NullPointerException");
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("*.GV?*sU5c?", (-3015));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-3015
         //
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("T7dh^8Ak-'xi\"9HJN");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test051()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-1526));
        fail("Expecting exception: NullPointerException");
  ...
  public void test058()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.proxy("Too many redirects occurred trying to load URL %s", 198);
      Connection connection0 = httpConnection0.url(uRL0);
      try { 
        connection0.get();
  ...
  public void test064()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      Connection connection1 = connection0.proxy("Content-Type", 16);
      try { 
        connection1.execute();
        fail("Expecting exception: IOException");
  ...
  public void test068()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("RawtextEndTagName", ">#v$F-?&%n", (InputStream) pipedInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test077()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("|[ROx>up!,FK[T}8%i", "http");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test078()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("qPX:o>r@s$m", "qPX:o>r@s$m");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("5a)pbx9a?=dc");
      assertNull(connection_KeyVal0);
  }

  @Test(timeout = 4000)
  public void test079()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "I^wc[bfCp -xPi*");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("multipart/form-data");
      assertEquals("I^wc[bfCp -xPi*", httpConnection_KeyVal1.value());
  }

  @Test(timeout = 4000)
  public void test080()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.header("(-EV", "(-EV");
  ...
  public void test086()  throws Throwable  {
      FileDescriptor fileDescriptor0 = new FileDescriptor();
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(" ", "Content-Encoding", (InputStream) mockFileInputStream0);
  ...
  public void test088()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "Z=|R)xSjey2~9Eo");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("d/I");
  ...
  public void test089()  throws Throwable  {
      ...
      httpConnection0.data("multipart/form-data", "application/x-www-form-urlencoded");
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.data("Content-Encoding", "multipart/form-data", (InputStream) null, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      try { 
        connection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test090()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.cookie("ScriptDataEscapedEndTagOpen", "^1L2='/\"3Z");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test091()  throws Throwable  {
      ...
      connection0.data("Content-Type", "oO_:E", (InputStream) sequenceInputStream0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test093()  throws Throwable  {
      ...
      hashMap0.put("#:tt t%N|W:G[g", linkedList0);
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
  ...
  public void test095()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.proxy("Content-Type", 16);
      try { 
        httpConnection0.post();
        fail("Expecting exception: IOException");
  ...
  public void test103()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      MockFile mockFile0 = new MockFile("CVOW{Gl$");
      URL uRL0 = mockFile0.toURL();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.execute();
  ...
  public void test107()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.addHeader("Set-Cookie", "multipart/form-data; boundary=");
      Map<String, List<String>> map0 = httpConnection_Response0.headers;
      // Undeclared exception!
      try { 
        httpConnection_Response0.processResponseHeaders(map0);
  ...
  public void test110()  throws Throwable  {
      ...
      hashMap0.put("+vr ,?mfnzl+fy$e!", "Must supply an even number of key value pairs");
  ...
  public void test116()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("|w5\"/a&,bh9|lz,a", "#UuQprLQ");
  ...
  public void test117()  throws Throwable  {
      ...
      assertEquals("multipart/form-data=I^wc[bfCp -xPi*", string0);
  }
  ...
  public void test118()  throws Throwable  {
      ...
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0, 3241);
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(pipedInputStream0, 3241);
      httpConnection0.data("content-type", "content-type", (InputStream) pushbackInputStream0, "content-type");
  ...
  public void test119()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("eOo", "Z=|R)xSjey2~9Eo");
      httpConnection_KeyVal0.contentType();
      assertEquals("eOo", httpConnection_KeyVal0.key());
  }

  @Test(timeout = 4000)
  public void test120()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("accept-encoding", "Jtht}!n (");
  ...
  public void test125()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("NHa=\"'>2Q72aZbK$_M7", (String) null, (InputStream) byteArrayInputStream0, "NHa=\"'>2Q72aZbK$_M7");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test127()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header((String) null, "class");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test144()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.URL("https", "I`E+-f", "https");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
