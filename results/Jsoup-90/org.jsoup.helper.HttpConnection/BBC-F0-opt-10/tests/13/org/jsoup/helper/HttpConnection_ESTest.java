...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      httpConnection_Request0.requestBody("Hm o&1A3AH&Kt7F}");
  ...
  public void test003()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.timeout(120);
  ...
  public void test009()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize(8220);
      assertEquals(8220, httpConnection_Request0.maxBodySize());
  }
  ...
  public void test020()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer("37tZ9,e*)MIM-o<S");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test022()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("application/x-www-form-urlencoded", "9.|<vBLx]#C2+{B(DjL", 120, "multipart/form-data", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals(120, uRL1.getPort());
  }

  @Test(timeout = 4000)
  public void test023()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("II", "(4(D|4mN<LwVz*z~8", 0, "II", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals("II", uRL1.getPath());
  }
  ...
  public void test025()  throws Throwable  {
      ...
      httpConnection0.data("6hx]kVj#7[-F[u", "6hx]kVj#7[-F[u", (InputStream) pipedInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("6hx]kVj#7[-F[u");
      assertEquals("6hx]kVj#7[-F[u", connection_KeyVal0.value());
  ...
  public void test034()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("text/", (-488));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-488
         //
  ...
  public void test039()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.URL("https", "Content-Type", 881, "multipart/form-data");
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL1 = MockURL.URL(uRL0, "$)X\"J4d.dP`", uRLStreamHandler0);
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize(20);
        fail("Expecting exception: NullPointerException");
  ...
  public void test049()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL1 = MockURL.URL(uRL0, "vuCXb\"me.0R@V%w", uRLStreamHandler0);
      httpConnection0.url(uRL1);
      // Undeclared exception!
      try { 
  ...
  public void test054()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("?9<=rcfy", "?9<=rcfy", (InputStream) null, "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test063()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpConnection.connect("x#ZkAMv&");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: x#ZkAMv&
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test064()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("GaAIe+(<x*rz$ZlX?}`", "GaAIe+(<x*rz$ZlX?}`");
  ...
  public void test065()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.header(";u,3", "x\"a9p2q!3!2 k(@az");
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
  ...
  public void test067()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("YL+", "$#Q4{(B2[f;u;]i");
  ...
  public void test068()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("YL+", "$#Q4{(B2[f;u;]i");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("$#Q4{(B2[f;u;]i");
      assertSame(httpConnection_KeyVal1, httpConnection_KeyVal0);
  }

  @Test(timeout = 4000)
  public void test069()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("sf'_ 3m:%VP(\u0007/h", "sf'_ 3m:%VP(\u0007/h");
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("sf'_ 3m:%VP(\u0007/h", string0);
  }

  @Test(timeout = 4000)
  public void test070()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded", "blockquote");
  ...
  public void test072()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("InHeadNoscript", "org.jsoup.helper.HttpConnection$1");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("`f(T");
      assertEquals("`f(T", connection_KeyVal0.contentType());
  }
  ...
  public void test074()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "application/x-www-form-urlencoded");
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample?Mozilla%2F5.0+%28Macintosh%3B+Intel+Mac+OS+X+10_11_6%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F53.0.2785.143+Safari%2F537.36=application%2Fx-www-form-urlencoded");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "\"iJ[?k-5");
      URL uRL0 = MockURL.getHttpExample();
      ...
      connection1.data("M", "Content-Type", (InputStream) dataInputStream0);
      // Undeclared exception!
      try { 
  ...
  public void test076()  throws Throwable  {
      ...
      httpConnection0.data("M!-S.UlowE%F`N3Z", "Content-Type", (InputStream) pipedInputStream0, "[%s*=%s]");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test078()  throws Throwable  {
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      hashMap0.putIfAbsent("iu4xd3'1g", linkedList0);
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.processResponseHeaders(hashMap0);
  ...
  public void test080()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.proxy("2\"", 5239);
      URL uRL0 = MockURL.getHttpExample();
  ...
  public void test088()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-1934));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test092()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Cookie value must not be null", "Cookie value must not be null");
  ...
  public void test093()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put(",)c8H@SmP&#%Ws", "8MDdf^T3viO");
  ...
  public void test094()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("c)pcdv}>@nw@*", "c)pcdv}>@nw@*");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("\"G4_mMkUoMSy");
  ...
  public void test095()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("us^-adcii", "us^-adcii");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("us^-adcii");
      assertEquals("us^-adcii", connection_KeyVal0.value());
      assertNotNull(connection_KeyVal0);
  }
  ...
  public void test096()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("tbGQ@['*", "ZOtfL");
      ...
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals("tbGQ@['*", httpConnection_KeyVal0.key());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
  }
  ...
  public void test100()  throws Throwable  {
      ...
      assertEquals("YL+=$#Q4{(B2[f;u;]i", string0);
  }

  @Test(timeout = 4000)
  public void test101()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded", "\"#+fi~~oBz B$_O");
  ...
  public void test132()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("Too many redirects occurred trying to load URL %s", 5120);
      assertSame(httpConnection0, connection0);
  }
