...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize((int) (byte)70);
  ...
  public void test009()  throws Throwable  {
      ...
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress("-|c0", 118);
  ...
  public void test020()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "Data key must not be empty");
  ...
  public void test027()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("org.jsoup.helper.HttpConnection$KeyVal", "V8u`z^$i", 0, "Content-Encoding", uRLStreamHandler0);
  ...
  public void test028()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("*VAvC'^", "application/x-www-form-urlencoded", 95, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test037()  throws Throwable  {
      ...
      httpConnection0.request((Connection.Request) null);
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress((InetAddress) null, 107);
      Proxy proxy0 = new Proxy(proxy_Type0, mockInetSocketAddress0);
      // Undeclared exception!
      try { 
  ...
  public void test056()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      MockFile mockFile0 = new MockFile("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "i]");
  ...
  public void test062()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.data("multipart/form-data", "-/gz", (InputStream) mockFileInputStream0, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
        fail("Expecting exception: NullPointerException");
  ...
  public void test063()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "Content-Type", (InputStream) bufferedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test064()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("Request must be executed (with .execute(), .get(), or .post() before parsing response", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test070()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("checkbox", "=", (InputStream) sequenceInputStream0);
      assertEquals("checkbox", httpConnection_KeyVal0.key());
      
      httpConnection_KeyVal0.key(":eq(%d)");
  ...
  public void test071()  throws Throwable  {
      ...
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.header("Content-Type", "multipart/form-data");
  ...
  public void test072()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("J-kl`3%raU}AN.=fbN");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: J-kl`3%raU}AN.=fbN
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test073()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("fMcbjGOzE7DE", "Content-Encoding");
      ...
      assertEquals("fMcbjGOzE7DE", httpConnection_KeyVal1.key());
  }

  @Test(timeout = 4000)
  public void test074()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("zl t<&(_&^c", "6yx@");
      assertEquals("6yx@", httpConnection_KeyVal0.value());
      
      httpConnection_KeyVal0.value("application/x-www-form-urlencoded");
      assertEquals("zl t<&(_&^c", httpConnection_KeyVal0.key());
  }
  ...
  public void test076()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      MockFile mockFile0 = new MockFile("accept-encoding", "org.jsoup.select.Evaluator$IsRoot");
      URL uRL0 = mockFile0.toURL();
  ...
  public void test077()  throws Throwable  {
      ...
      assertEquals("multipart/form-data", httpConnection_KeyVal0.key());
      assertEquals("Data key must not be empty", string0);
  }
  ...
  public void test079()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_KeyVal0.contentType((String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test081()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      connection0.cookie("Content-Type", "replacementchar");
  ...
  public void test082()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 121, (byte) (-104));
      httpConnection0.data("0{3*f 1", "+n5[8RN%", (InputStream) byteArrayInputStream0, "wm");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test086()  throws Throwable  {
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      hashMap0.put("n]l;sf1o4gdl_avl[ad", (List<String>) null);
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      // Undeclared exception!
      try { 
        httpConnection_Response0.processResponseHeaders(hashMap0);
  ...
  public void test093()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      httpConnection0.data("c:Z2!`DI~", "c:Z2!`DI~");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test099()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("autofocus", "application/x-www-form-urlencoded");
  ...
  public void test100()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("zl t<&(_&^c", (String) null);
  ...
  public void test101()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("content-encoding", "Ia");
  ...
  public void test105()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("zl t<&(_&^c", "%3mZkzo\"?|.$'%klI");
  ...
  public void test106()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("                    ", "details", (InputStream) byteArrayInputStream0);
  ...
  public void test107()  throws Throwable  {
      ...
      assertEquals("details", httpConnection_KeyVal0.value());
  }
  ...
  public void test108()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("-w+VwEu_]", "E8|khrB6B)6;H,8F>S", (InputStream) byteArrayInputStream0);
      httpConnection_KeyVal0.inputStream();
      assertEquals("-w+VwEu_]", httpConnection_KeyVal0.key());
      assertEquals("E8|khrB6B)6;H,8F>S", httpConnection_KeyVal0.value());
  }
  ...
  public void test109()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      Connection connection0 = httpConnection0.data("c:Z2!`DI~", "c:Z2!`DI~");
  ...
  public void test116()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("ayv{BXSn[w`+rfo8-d", "(application|text)/w*+?xml.*", (InputStream) null, "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test117()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer("H?0");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test118()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("GDP.MpI}pi]t-SH0e", "GDP.MpI}pi]t-SH0e");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test119()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("B0", "Method must not be null");
        fail("Expecting exception: NullPointerException");
  ...
  public void test120()  throws Throwable  {
      ...
      httpConnection0.data("!d", "!d", (InputStream) pipedInputStream0);
  ...
  public void test121()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.timeout(2361);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test128()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.removeCookie("h3");
  ...
  public void test130()  throws Throwable  {
      ...
      Connection connection0 = HttpConnection.connect(uRL0);
      Proxy.Type proxy_Type0 = Proxy.Type.SOCKS;
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress("Content-Type", 192);
      Proxy proxy0 = new Proxy(proxy_Type0, mockInetSocketAddress0);
  ...
  public void test134()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("L<KPP", "L<KPP");
      Connection.KeyVal connection_KeyVal0 = connection0.data("L<KPP");
      assertEquals("L<KPP", connection_KeyVal0.value());
      assertNotNull(connection_KeyVal0);
  }
  ...
  public void test139()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("L<KPP", 20);
      assertSame(connection0, httpConnection0);
  }
