...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      linkedList0.add("r=&V`Ot!czMn~s5\"#tl");
  ...
  public void test003()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("_\"!");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test011()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("application/x-www-form-urlencoded", 255);
  ...
  public void test019()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("section", "2R!|Ls8dPv", (InputStream) null);
      boolean boolean0 = httpConnection_KeyVal0.hasInputStream();
      assertFalse(boolean0);
      assertEquals("2R!|Ls8dPv", httpConnection_KeyVal0.value());
  ...
  public void test020()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "!Z%drF");
  ...
  public void test029()  throws Throwable  {
      ...
      assertEquals("Nt=`Tw", uRL1.getPath());
  }

  @Test(timeout = 4000)
  public void test030()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("Request must be executed (with .execute(), .get(), or .post() before parsing response", "N*jF5/+3ra#", 0, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.referrer("81_<T@WZFc?qBNxY");
        fail("Expecting exception: NullPointerException");
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.proxy("Content-Encoding", (-433));
        fail("Expecting exception: NullPointerException");
  ...
  public void test044()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("yRd%Fo3-3}");
  ...
  public void test051()  throws Throwable  {
      ...
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress("bfockqtote", 1003);
  ...
  public void test058()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("rfxs<ss34a6e.", "v;b[.)icm*5]tp#n<|");
        fail("Expecting exception: NullPointerException");
  ...
  public void test059()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("", "s!!FK1kmhDl");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test066()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.data("multipart/form-data", "rfxs<ss34a6e.", (InputStream) pipedInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test067()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      File file0 = MockFile.createTempFile("attributevalue_singlequoted", "content-encoding");
  ...
  public void test074()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("e#XOqJ+BY", "\"0+(Z[k%)pyqtq.8/");
      assertEquals("e#XOqJ+BY", httpConnection_KeyVal0.key());
      
      httpConnection_KeyVal0.key("auxncbwe'oy");
      assertEquals("\"0+(Z[k%)pyqtq.8/", httpConnection_KeyVal0.value());
  }
  ...
  public void test077()  throws Throwable  {
      ...
      httpConnection_KeyVal0.value("auxncbwe'oy");
      assertEquals("e#XOqJ+BY", httpConnection_KeyVal0.key());
  }
  ...
  public void test082()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("auxncbwe'oy", "auxncbwe'oy", (InputStream) pipedInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("8tO=~oV&] #YkSf36v");
      assertEquals("auxncbwe'oy", connection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test083()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("_-8y5a|pzNmvGgH*am", "_-8y5a|pzNmvGgH*am");
      URL uRL0 = MockURL.getHttpExample();
      URL uRL1 = MockURL.URL(uRL0, "r[`?norb^$h)=#un]{)");
  ...
  public void test084()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.cookie("54+meh^|H0\"S)3N@!SG", "54+meh^|H0\"S)3N@!SG");
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.cookie("S8n,Ct)M<4sC", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test085()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("multipart/form-data", "Content-Type", (InputStream) sequenceInputStream0);
      try { 
        connection0.post();
  ...
  public void test086()  throws Throwable  {
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.add("=&V`Ot!cRzMn,s5\"#tl");
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      hashMap0.put("set-cookie", linkedList0);
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.processResponseHeaders(hashMap0);
  ...
  public void test087()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.header("(H0.NURvAqT", "(H0.NURvAqT");
  ...
  public void test089()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("label", 43);
      URL uRL0 = MockURL.getHttpExample();
      connection0.url(uRL0);
      try { 
        httpConnection0.get();
  ...
  public void test090()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      connection0.requestBody("oPK\\EF$0oj");
      connection0.url(uRL0);
      try { 
        connection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test092()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.requestBody("2OD&");
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
        httpConnection0.get();
  ...
  public void test095()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-2625));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test100()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("multipart/form-data", "org.jsoup.helper.HttpConnection$1");
  ...
  public void test101()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("Ze[J`<2(", "[%s*=%s]");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("Ze[J`<2(");
  ...
  public void test103()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("dNOI\"mhf#>B.VY>F", "-J(I2!", (InputStream) mockFileInputStream0);
      httpConnection_Request0.data((Connection.KeyVal) httpConnection_KeyVal0);
      assertEquals("-J(I2!", httpConnection_KeyVal0.value());
      assertEquals("dNOI\"mhf#>B.VY>F", httpConnection_KeyVal0.key());
  ...
  public void test108()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.data("EndTag", "multipart/form-data", (InputStream) byteArrayInputStream0, "PKr| $");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test111()  throws Throwable  {
      ...
      assertEquals("e#XOqJ+BY", string0);
      assertEquals("\"0+(Z[k%)pyqtq.8/", httpConnection_KeyVal0.value());
  }
  ...
  public void test117()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = httpConnection_Response0.charset("8%x>x");
  ...
  public void test118()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("auxnhbwe'oy", (String) null, (InputStream) mockFileInputStream0, "QJ0mTl\"A$jkLv?");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test120()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer("XpGjY3kEvN");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test122()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.cookie("multipart/form-data", "treebuilder{currenttoken=");
        fail("Expecting exception: NullPointerException");
  ...
  public void test132()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("s!!\fk1kmhdl", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test133()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.removeCookie("=&V`Ot!cRzMn,s5\"#tl");
  ...
  public void test138()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("Yy", "Xp?jY3kEvN");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("Xp?jY3kEvN");
      assertNull(connection_KeyVal0);
  }
  ...
  public void test141()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "XqP$E", 61, ". Status=", uRLStreamHandler0);
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL1 = MockURL.URL(uRL0, "mk`9q");
      httpConnection0.url(uRL1);
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test143()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("http:/", (-2822));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-2822
         //
