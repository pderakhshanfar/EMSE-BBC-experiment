...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test007()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("Charset must not be null");
  ...
  public void test010()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("~0S((0 j", 91);
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test021()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("h1+{8$,z", "h1+{8$,z");
  ...
  public void test027()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "q~JTy^u0");
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.getHttpExample();
  ...
  public void test029()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("k8mtPR=TkE", "K2ok/1)0P AMI]S@", 97, ">qMu-$/lu,H<!QK=", uRLStreamHandler0);
  ...
  public void test030()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("multipart/form-data", "Content-Type", 0, "application/x-www-form-urlencoded", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test032()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-36), 41);
      httpConnection0.data("> ?b_J<|dT", "> ?b_J<|dT", (InputStream) byteArrayInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("> ?b_J<|dT");
      assertNotNull(connection_KeyVal0);
      assertEquals("> ?b_J<|dT", connection_KeyVal0.value());
  }
  ...
  public void test033()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.userAgent("W{QVl $E}A`IbG");
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("application/x-www-form-urlencoded", 61);
        fail("Expecting exception: NullPointerException");
  ...
  public void test045()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("THzvNmi");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test046()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("j{oP[OP3G");
        fail("Expecting exception: NullPointerException");
  ...
  public void test047()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", ":Foy^98A8*k/XY", 4093, "org.jsoup.nodes.Node", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test050()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize(800);
        fail("Expecting exception: NullPointerException");
  ...
  public void test063()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("body", "body", (InputStream) pipedInputStream0, (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test064()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(byteArrayInputStream0, 23);
      // Undeclared exception!
      try { 
        httpConnection0.data("`cac+s", "org.jsoup.helper.HttpConnection$1", (InputStream) pushbackInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test069()  throws Throwable  {
      ...
      hashMap0.put("I|{;~#`6R=7n/4=;Te", stringArray0[2]);
      // Undeclared exception!
      try { 
  ...
  public void test073()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("vYsq>d?_LhFY z-.'~}", "vYsq>d?_LhFY z-.'~}", (InputStream) pipedInputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("vYsq>d?_LhFY z-.'~}");
  ...
  public void test074()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("AfterDoctypePublicKeyword");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test076()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream(11);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("vYsq>d?_LhFY z-.'~}", "vYsq>d?_LhFY z-.'~}", (InputStream) pipedInputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("vYsq>d?_LhFY z-.'~}");
      assertTrue(httpConnection_KeyVal1.hasInputStream());
  }
  ...
  public void test077()  throws Throwable  {
      ...
      assertEquals("vYsq>d?_LhFY z-.'~}", string0);
  }
  ...
  public void test082()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("(2*Fxb<<YnalJA", " g;``p}:g");
  ...
  public void test084()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 2034, 2034);
      httpConnection0.data("source", "Content-Type", (InputStream) byteArrayInputStream0, "e9hs8?");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test089()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.proxy("'m$Uyz\"T AFH1&s1", 1659);
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.execute();
        fail("Expecting exception: IOException");
  ...
  public void test097()  throws Throwable  {
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.addFirst("iCk");
      hashMap0.put("bfUQI8XU#}EN", linkedList0);
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.header("bfUQI8XU#}EN", "bFoGD0L|ED2J+S");
      httpConnection_Response0.processResponseHeaders(hashMap0);
      assertEquals(1, hashMap0.size());
  }
  ...
  public void test099()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("application/x-www-form-urlencoded", "Xy1");
  ...
  public void test102()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1466), 2688);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "!k[:;:;4T`h<1", (InputStream) byteArrayInputStream0);
  ...
  public void test107()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("1=jq0e", "dt");
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("1=jq0e=dt", string0);
  }
  ...
  public void test110()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("4|i=#c`gP ", "4|i=#c`gP ");
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.get();
  ...
  public void test116()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = httpConnection_Response0.charset("VCLbH2~ugD");
  ...
  public void test117()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("xsA7S,jbvmDhtQ[Ge", "xsA7S,jbvmDhtQ[Ge", 821, "}v\u0003#", uRLStreamHandler0);
  ...
  public void test119()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("Rcdata", (String) null);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test123()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("Accept-Encoding", (String) null, (InputStream) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test124()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.timeout(945);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test131()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.removeCookie("*.TU=UL");
