...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("Content-Type", "HTTP error fetching URL", (InputStream) null, "!.]hw/");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test018()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "~H5cX}w$sJZ~83Cvrw+");
      boolean boolean0 = httpConnection_KeyVal0.hasInputStream();
      assertFalse(boolean0);
      assertEquals("~H5cX}w$sJZ~83Cvrw+", httpConnection_KeyVal0.value());
  ...
  public void test025()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("ZLnebk-=", "=*1(o7X#mCM&|^Z", 77, "L5b(;69KM~.", uRLStreamHandler0);
  ...
  public void test039()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy((String) null, (-1795));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-1795
         //
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset(":last-child");
  ...
  public void test055()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      httpConnection0.proxy("center", 104);
      try { 
        httpConnection0.execute();
        fail("Expecting exception: IOException");
  ...
  public void test057()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("w|K3h~\"4K+1", (String) null);
      // Undeclared exception!
      try { 
  ...
  public void test059()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("u", "u", (InputStream) pipedInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test061()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("Referer", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie((String) null, "jec(yO,Sdv");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test067()  throws Throwable  {
      ...
      httpConnection_KeyVal0.key("w7VK6");
      assertEquals("~H5cX}w$sJZ~83Cvrw+", httpConnection_KeyVal0.value());
  }
  ...
  public void test068()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.header("Content-Encoding", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test070()  throws Throwable  {
      ...
      httpConnection_KeyVal0.value("Charset must not be null");
      assertEquals("multipart/form-data", httpConnection_KeyVal0.key());
  }
  ...
  public void test073()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("\"", "}qkf<B)O*Msm9)6", (InputStream) pipedInputStream0);
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("\"", httpConnection_KeyVal0.key());
      assertEquals("}qkf<B)O*Msm9)6", string0);
  }
  ...
  public void test075()  throws Throwable  {
      ...
      assertEquals("}qkf<B)O*Msm9)6", connection_KeyVal0.value());
  ...
  public void test077()  throws Throwable  {
      ...
      connection1.cookie("application/x-www-form-urlencoded", "Content-Encoding");
      try { 
        connection1.get();
        fail("Expecting exception: IOException");
  ...
  public void test085()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.requestBody("z3Xvy");
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
  ...
  public void test087()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.requestBody("Jv|j}R dE W'w9&0");
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test088()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "multipart/form-data", 104, "Sd9uFzv*;-yi7fig,", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
        httpConnection0.get();
  ...
  public void test092()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("#F", "Content-Type");
      try { 
  ...
  public void test096()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Content-Type", "8^|iloC5+eqZt,\"Vl@");
  ...
  public void test097()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      httpConnection0.data("u", "#teJ?xt", (InputStream) pipedInputStream0);
  ...
  public void test098()  throws Throwable  {
      ...
      doReturn(false).when(enumeration0).hasMoreElements();
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(enumeration0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "org.jsoup.nodes.PseudoTextElement", (InputStream) sequenceInputStream0);
  ...
  public void test101()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("qz 1fk", "Input stream already read and parsed, cannot re-read.");
  ...
  public void test103()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      httpConnection0.data("^pW", "^pW", (InputStream) pipedInputStream0, "^pW");
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
  ...
  public void test104()  throws Throwable  {
      ...
      httpConnection0.data("#text", "org.jsoup.parser.Tokeniser", (InputStream) pipedInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("#text");
      assertEquals("org.jsoup.parser.Tokeniser", connection_KeyVal0.value());
      assertNotNull(connection_KeyVal0);
  }

  @Test(timeout = 4000)
  public void test105()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("encoding", "blockquote");
      httpConnection_KeyVal0.contentType();
      assertEquals("blockquote", httpConnection_KeyVal0.value());
  ...
  public void test116()  throws Throwable  {
      ...
      httpConnection0.data("Content-Type", "<]DshTv EgKl)i,b:{L", (InputStream) dataInputStream0);
  ...
  public void test118()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("", "#text", (InputStream) pipedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test123()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("aet-coQkie");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test135()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("V3[T[#6", 1017);
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals(30000, httpConnection_Request1.timeout());
