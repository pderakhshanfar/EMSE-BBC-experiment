...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.addHeader("application/x-www-form-urlencoded", "^s+");
  ...
  public void test008()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("cookie map must not be null", 95);
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
  ...
  public void test015()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("2(Wq52{/Z=N$M[", "Content-Encoding");
  ...
  public void test017()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("!$R+]l=~>1 uKg^}s", "&amp;");
  ...
  public void test018()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, ".ck9!`;");
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
  ...
  public void test022()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.maxBodySize(3994);
  ...
  public void test024()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("referer", "%0&fYg%&[6z", 0, "User agent must not be null", uRLStreamHandler0);
  ...
  public void test025()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("r>~qY(d?[ifl", "Content-Encoding", 37, "application/x-www-form-urlencoded", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test036()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.proxy("Content-Encoding", (-1771));
        fail("Expecting exception: NullPointerException");
  ...
  public void test037()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("user-agent", (-3019));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-3019
         //
  ...
  public void test038()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("w|[\"|Yl@\"g");
  ...
  public void test039()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("-y>sGK%D;4Gyg.p'");
        fail("Expecting exception: NullPointerException");
  ...
  public void test041()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "Ocx", 79, "g", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test045()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-1771));
        fail("Expecting exception: NullPointerException");
  ...
  public void test050()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("PCx Fp9(|P$k", "fG");
        fail("Expecting exception: NullPointerException");
  ...
  public void test061()  throws Throwable  {
      ...
      InetSocketAddress inetSocketAddress0 = MockInetSocketAddress.createUnresolved("Content-Encoding", 107);
  ...
  public void test064()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("multipart/form-data", "AttributeName", (InputStream) pipedInputStream0, "NX!LQ<(5(~a$OuZTI/k");
        fail("Expecting exception: NullPointerException");
  ...
  public void test065()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(mockFileInputStream0, 307);
      // Undeclared exception!
      try { 
        httpConnection0.data("r8%bb 9?\">nav@uk)d", "q[i+hh)a%^-[m3wg|o", (InputStream) pushbackInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test066()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("Set-Cookie", (String) null, (InputStream) bufferedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test067()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data(":nth-child(", "&0iYJ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test068()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("]x,us{ziynn", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test071()  throws Throwable  {
      ...
      Attributes attributes1 = attributes0.put("", "Cookie value must not be null");
  ...
  public void test075()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("uCE^\"?oMgg|zlf=", ";AR:3JC7/BIxO", (InputStream) pipedInputStream0);
      assertEquals("uCE^\"?oMgg|zlf=", httpConnection_KeyVal0.key());
      
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("uCE^\"?oMgg|zlf=");
      assertEquals(";AR:3JC7/BIxO", httpConnection_KeyVal1.value());
  }

  @Test(timeout = 4000)
  public void test076()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.header("Content-Encoding", "multipart/form-data");
      assertTrue(httpConnection_Request1.followRedirects());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertEquals(30000, httpConnection_Request1.timeout());
  ...
  public void test078()  throws Throwable  {
      FileDescriptor fileDescriptor0 = new FileDescriptor();
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded; charset=", "multipart/form-data", (InputStream) mockFileInputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.inputStream((InputStream) mockFileInputStream0);
      assertEquals("application/x-www-form-urlencoded; charset=", httpConnection_KeyVal1.key());
  ...
  public void test084()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("lYb%u'(\"c#7Ec+U4", "application/x-www-form-urlencoded");
      ...
      assertEquals("lYb%u'(\"c#7Ec+U4", connection_KeyVal0.key());
  ...
  public void test085()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      httpConnection0.data("application/x-www-form-urlencoded", "}f!jAQhVTNRUd0Cb@/z");
  ...
  public void test086()  throws Throwable  {
      ...
      Connection connection1 = httpConnection0.cookie("n6.vZ]xl{[lA:", "%jj7s/X-6tz(");
      try { 
        connection1.post();
  ...
  public void test087()  throws Throwable  {
      ...
      connection0.data("T69fgYEUnt9^4", "Content-Encoding", (InputStream) bufferedInputStream0, "[^-a-zA-Z0-9_:.]");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test088()  throws Throwable  {
      Document document0 = new Document("Ek:;");
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>(120);
      LinkedList<Locale.LanguageRange> linkedList0 = new LinkedList<Locale.LanguageRange>();
      Set<String> set0 = document0.classNames();
      Locale.FilteringMode locale_FilteringMode0 = Locale.FilteringMode.MAP_EXTENDED_RANGES;
      List<String> list0 = Locale.filterTags((List<Locale.LanguageRange>) linkedList0, (Collection<String>) set0, locale_FilteringMode0);
      hashMap0.put("application/x-www-form-urlencoded; charset=", list0);
  ...
  public void test089()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.addHeader("Q0.)mr<oJA%", "Q0.)mr<oJA%");
  ...
  public void test090()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>(353);
      LinkedList<Locale.LanguageRange> linkedList0 = new LinkedList<Locale.LanguageRange>();
  ...
  public void test107()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("application/x-www-form-urlencoded", "Zu6Ce7,dBK");
  ...
  public void test109()  throws Throwable  {
      ...
      httpConnection0.data(stringArray0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("yp{KJB+h ");
  ...
  public void test115()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("49`3f;dz*[vs-,", "application/x-www-form-urlencoded", (InputStream) sequenceInputStream0);
      httpConnection_KeyVal0.inputStream();
      assertEquals("49`3f;dz*[vs-,", httpConnection_KeyVal0.key());
      assertEquals("application/x-www-form-urlencoded", httpConnection_KeyVal0.value());
  }
  ...
  public void test119()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("multipart/form-data", (String) null, (InputStream) null, (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test122()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("multipart/form-data", "Content-Encoding");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test123()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.cookie("I@lv&i_lxLF,m<|6i>", "r76@fJ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test124()  throws Throwable  {
      ...
      httpConnection0.data("6n", "<&", (InputStream) pushbackInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("6n");
  ...
  public void test128()  throws Throwable  {
      Connection connection0 = HttpConnection.connect("http:t/");
      assertNotNull(connection0);
  }
  ...
  public void test130()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("jTdKkafw^hYO5fg7");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test144()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("multipart/form-data", 240);
      assertSame(httpConnection0, connection0);
  }
