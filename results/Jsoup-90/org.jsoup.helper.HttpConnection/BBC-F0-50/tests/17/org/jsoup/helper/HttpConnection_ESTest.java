...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      httpConnection_Response0.addHeader("Set-Cookie", "3=(S7Efr!89$O0");
  ...
  public void test003()  throws Throwable  {
      ...
      httpConnection_Request0.timeout(6);
  ...
  public void test011()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize(2080);
      assertEquals(2080, httpConnection_Request0.maxBodySize());
  }
  ...
  public void test015()  throws Throwable  {
      ...
      hashMap0.put("j", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
  ...
  public void test023()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("", "WWZrQryMe~=", 39, "application/x-www-form-urlencoded", uRLStreamHandler0);
  ...
  public void test024()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("text/", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", 0, "deflate", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test034()  throws Throwable  {
      ...
      InetSocketAddress inetSocketAddress0 = MockInetSocketAddress.createUnresolved("request has already been read", 41);
  ...
  public void test035()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy((String) null, 2392);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test045()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("jz!yse*i", "jz!yse*i");
        fail("Expecting exception: NullPointerException");
  ...
  public void test052()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("z>y[,", "https", (InputStream) mockFileInputStream0, "http");
        fail("Expecting exception: NullPointerException");
  ...
  public void test053()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "mozilla/5.0 (macintosh; intel mac os x 10_11_6) applewebkit/537.36 (khtml, like gecko) chrome/53.0.2785.143 safari/537.36", (InputStream) dataInputStream0, "mozilla/5.0 (macintosh; intel mac os x 10_11_6) applewebkit/537.36 (khtml, like gecko) chrome/53.0.2785.143 safari/537.36");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test054()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.data("JopHdkn", "JopHdkn");
        fail("Expecting exception: NullPointerException");
  ...
  public void test055()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "Data collection must not be null");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test056()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("$PNyBNMDB}W");
        fail("Expecting exception: NullPointerException");
  ...
  public void test062()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.header("nL-", "+K3C");
  ...
  public void test064()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Type", "Jy<wVk}ZdjirwD1w1;2");
  ...
  public void test065()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(",vi`", ",vi`", (InputStream) pipedInputStream0);
  ...
  public void test066()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("ftp", "ftp", (InputStream) bufferedInputStream0);
  ...
  public void test068()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded", "4phc`=s{;+%", (InputStream) pipedInputStream0);
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("4phc`=s{;+%", string0);
  ...
  public void test071()  throws Throwable  {
      ...
      connection0.data("|r7W3 \"^=Ht@", "Content-Encoding");
      try { 
        httpConnection0.get();
  ...
  public void test072()  throws Throwable  {
      ...
      connection0.data("_0$D;xBSq|Y", "P>i%Bw.", (InputStream) bufferedInputStream0);
      // Undeclared exception!
      try { 
        httpConnection0.execute();
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test073()  throws Throwable  {
      ...
      connection0.cookie("Content-Type", "org.jsoup.select.NodeTraversor");
      try { 
        connection0.post();
  ...
  public void test074()  throws Throwable  {
      ...
      httpConnection0.data("user-agent", "!8", (InputStream) pushbackInputStream0, "!8");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test076()  throws Throwable  {
      ...
      hashMap0.put("?=6zwfl", linkedList0);
  ...
  public void test083()  throws Throwable  {
      ...
      httpConnection0.method(connection_Method0);
      httpConnection0.requestBody("table");
      Connection connection0 = httpConnection0.url(uRL0);
      httpConnection0.data("multipart/form-data", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      try { 
        connection0.execute();
  ...
  public void test085()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "content-encoding", 85, "Gj", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
        httpConnection0.execute();
  ...
  public void test089()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-433));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test091()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("multipart/form-data", "`aB6 UOe?I5c@R@U");
      try { 
  ...
  public void test093()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("*1&^Jyc8", (String) null);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test097()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("%Ax5m#B", "application/x-www-form-urlencoded; charset=", (InputStream) pipedInputStream0);
      assertEquals("%Ax5m#B", httpConnection_KeyVal0.key());
  ...
  public void test098()  throws Throwable  {
      ...
      httpConnection0.data(stringArray0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("hx_bZ|d}f]");
  ...
  public void test103()  throws Throwable  {
      FileDescriptor fileDescriptor0 = new FileDescriptor();
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("=^zhg*(+ jq]oi", "d5.@!F(7OUIoXb", (InputStream) mockFileInputStream0);
      httpConnection_KeyVal0.contentType();
      assertEquals("=^zhg*(+ jq]oi", httpConnection_KeyVal0.key());
      assertEquals("d5.@!F(7OUIoXb", httpConnection_KeyVal0.value());
  }
  ...
  public void test109()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer("inv");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test111()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "(^Z}", (InputStream) pipedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test115()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("Timeout milliseconds must be 0 (infinite) or greater", 2);
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        connection0.execute();
  ...
  public void test129()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("7ne!", 20);
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertFalse(httpConnection_Request1.ignoreContentType());
