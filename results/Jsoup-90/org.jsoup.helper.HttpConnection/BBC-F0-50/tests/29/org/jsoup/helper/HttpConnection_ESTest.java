...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("fhqi", "ins");
  ...
  public void test003()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("application/x-www-form-urlencoded", 61);
  ...
  public void test030()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("&P$frpOYz>w)*d", "&P$frpOYz>w)*d", 1845, "", uRLStreamHandler0);
  ...
  public void test031()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("X$0%5Fo", "X$0%5Fo", 0, "unhandled content type. must be text/*, application/xml, or application/xhtml+xml", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test039()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.referrer("fNsm!08OsV353lUVBuF");
        fail("Expecting exception: NullPointerException");
  ...
  public void test041()  throws Throwable  {
      ...
      InetSocketAddress inetSocketAddress0 = MockInetSocketAddress.createUnresolved("application/x-www-form-urlencoded", 1383);
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.proxy("application/x-www-form-urlencoded", 3128);
        fail("Expecting exception: NullPointerException");
  ...
  public void test049()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.proxy("application/x-www-form-urlencoded", 92);
      try { 
        httpConnection0.post();
  ...
  public void test052()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize(117);
        fail("Expecting exception: NullPointerException");
  ...
  public void test056()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("}VEr0LYQya", "truespeed");
        fail("Expecting exception: NullPointerException");
  ...
  public void test065()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("sK)DsDP", "ZklUG!f09;<kK");
      httpConnection0.request((Connection.Request) null);
      // Undeclared exception!
      try { 
  ...
  public void test069()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.data("Content-Encoding", "Content-Encoding", (InputStream) null, "application/x-www-form-urlencoded");
        fail("Expecting exception: NullPointerException");
  ...
  public void test070()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("f7'e?|#T&Uo8-", "i", (InputStream) pipedInputStream0, (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test071()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("*rkl", (String) null, (InputStream) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test072()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.data("Content-Encoding", "xTeX");
        fail("Expecting exception: NullPointerException");
  ...
  public void test074()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("& fbrz!ki-^zxrzmu(");
        fail("Expecting exception: NullPointerException");
  ...
  public void test077()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("", "tB*Zo9t'@Z:,,");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test081()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.header("compact", "compact");
  ...
  public void test086()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("^>x!", "6a^", (InputStream) sequenceInputStream0);
  ...
  public void test089()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("0&p=?k%r/*gznij9=)", "j");
      Connection connection0 = httpConnection0.cookies(hashMap0);
      connection0.cookie("application/x-www-form-urlencoded", "ftp");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test090()  throws Throwable  {
      ...
      httpConnection0.data("Content-Encoding", "ygpp3p", (InputStream) byteArrayInputStream0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test093()  throws Throwable  {
      ...
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.add("$5npfni**hp:-s=<%rt");
      hashMap0.put("Set-Cookie", linkedList0);
      httpConnection_Response0.processResponseHeaders(hashMap0);
  ...
  public void test095()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.proxy("Content-Type", 8216);
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.execute();
        fail("Expecting exception: IOException");
  ...
  public void test097()  throws Throwable  {
      ...
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "O5x*D{");
      HttpConnection.Response httpConnection_Response1 = HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
      httpConnection_Response1.body();
  ...
  public void test100()  throws Throwable  {
      ...
      httpConnection0.data((Map<String, String>) hashMap0);
      httpConnection0.url(uRL0);
      httpConnection0.requestBody("itI");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test102()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.URL("https", "Could not parse attribute query '%s': unexpected token at '%s'", "Content-Encoding");
      httpConnection0.url(uRL0);
      Connection.Request connection_Request0 = httpConnection0.request();
      try { 
  ...
  public void test104()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("dM0m1");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test106()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-1800));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test109()  throws Throwable  {
      ...
      LinkedList<String> linkedList0 = new LinkedList<String>();
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      hashMap0.put("bheqi", linkedList0);
      linkedList0.add((String) null);
      linkedList0.add("");
      httpConnection_Response0.processResponseHeaders(hashMap0);
      assertNull(httpConnection_Response0.contentType());
  ...
  public void test110()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.header("Content-Type", "l^{}V@H/");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test113()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)28, (byte)85);
      DataInputStream dataInputStream0 = new DataInputStream(byteArrayInputStream0);
      httpConnection0.data("Fhqi", "Fhqi", (InputStream) dataInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("Fhqi");
      assertNotNull(connection_KeyVal0);
      assertEquals("Fhqi", connection_KeyVal0.value());
  }
  ...
  public void test124()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("Content-Encoding", "Content-Encoding", (InputStream) null, "application/x-www-form-urlencoded");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test127()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("deflate", "deflate");
        fail("Expecting exception: NullPointerException");
  ...
  public void test128()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("Content-Encoding", "xTeX");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test138()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Proxy.Type proxy_Type0 = Proxy.Type.HTTP;
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress("application/x-www-form-urlencoded", 224);
