...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      linkedList0.push("Content-Disposition: form-data; name=\"");
  ...
  public void test023()  throws Throwable  {
      ...
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
      HttpConnection.Response httpConnection_Response2 = httpConnection_Response1.charset("sarcasm");
  ...
  public void test030()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("r7?u0`M3", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", 398, "STOP", uRLStreamHandler0);
  ...
  public void test031()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("<+2TiM$gc\"`8<{3GV", "Did not find balanced marker at '", 0, "W@ot", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test033()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("mvx~p`g&m", "http", (InputStream) null);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("mvx~p`g&m");
  ...
  public void test041()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.referrer("isindex");
        fail("Expecting exception: NullPointerException");
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("; filename=\"", 32768);
        fail("Expecting exception: NullPointerException");
  ...
  public void test050()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-1167));
        fail("Expecting exception: NullPointerException");
  ...
  public void test055()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "~>_1(U");
        fail("Expecting exception: NullPointerException");
  ...
  public void test068()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("qui^8ks", "maxSize must be 0 (unlimited) or larger", (InputStream) dataInputStream0, "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test069()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("data", "data", (InputStream) mockFileInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test070()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "multipart/form-data", (InputStream) mockFileInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test071()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("e-LB@`R#n[Dc<Q", "action");
        fail("Expecting exception: NullPointerException");
  ...
  public void test076()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie((String) null, "=*F,&Fty;(nEV*");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test079()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.header(",<`a?NJfvQZz1a<Yk*", ", ");
  ...
  public void test082()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(",8,(^8vofclw~sj", ",8,(^8vofclw~sj");
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value(",8,(^8vofclw~sj");
      assertNull(httpConnection_KeyVal1.contentType());
  }

  @Test(timeout = 4000)
  public void test083()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("PRo|XdM~y=#Ds/-poP", "Content-Encoding");
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("Content-Encoding", httpConnection_KeyVal0.value());
      assertEquals("PRo|XdM~y=#Ds/-poP", string0);
  }
  ...
  public void test085()  throws Throwable  {
      ...
      assertEquals(",8,(^8vofclw~sj", string0);
  }
  ...
  public void test087()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded", "Wc");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("Wc");
      assertEquals("application/x-www-form-urlencoded", connection_KeyVal0.key());
      assertEquals("Wc", connection_KeyVal0.value());
  }
  ...
  public void test088()  throws Throwable  {
      ...
      URL uRL0 = MockURI.toURL(uRI0);
      Connection connection0 = httpConnection0.url(uRL0);
      httpConnection0.data("y'lqnj5jz9h", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      try { 
        connection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test089()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.data("wO!z!8Y06P*cJDKhy", "Content-Encoding");
  ...
  public void test090()  throws Throwable  {
      ...
      connection1.cookie("set-cookpe", "Qi:y7");
      try { 
        connection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test098()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.url(uRL0);
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      connection0.data(":parent%s", "Set-Cookie", (InputStream) pipedInputStream0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test099()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.requestBody("org.jsoup.select.StructuralEvaluator$ImmediateParent");
      // Undeclared exception!
      try { 
        httpConnection0.get();
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test103()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.maxBodySize(104);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test107()  throws Throwable  {
      ...
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.addLast("BeforeDoctypePublicIdentifier");
      linkedList0.add("qd7");
      hashMap0.put("bDoundary", linkedList0);
      httpConnection_Response0.processResponseHeaders(hashMap0);
  ...
  public void test112()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      httpConnection0.data(":parent%s", "Set-Cookie", (InputStream) pipedInputStream0);
  ...
  public void test113()  throws Throwable  {
      ...
      httpConnection0.data("CLId09.", "CLId09.", (InputStream) pipedInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("CLId09.");
      assertNotNull(connection_KeyVal0);
      assertEquals("CLId09.", connection_KeyVal0.value());
  }
  ...
  public void test118()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("ftp", "selected");
  ...
  public void test120()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("qui^8ks", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", (InputStream) null);
      httpConnection_KeyVal0.contentType();
      assertEquals("qui^8ks", httpConnection_KeyVal0.key());
  ...
  public void test125()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      DataInputStream dataInputStream0 = new DataInputStream((InputStream) null);
      Connection connection0 = httpConnection0.data("ftp", "set-cookie", (InputStream) dataInputStream0, "ftp");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test128()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("gb4'zC59C6Gu`.JsSc", "aN@WG");
        fail("Expecting exception: NullPointerException");
  ...
  public void test134()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("; filename=\"", 32768);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test137()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.removeCookie("org.jsoup.select.Collector$FirstFinder");
      assertSame(httpConnection_Response0, connection_Response0);
  }
  ...
  public void test142()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "Content-Type", 116, "Too many redirects occurred trying to load URL %s", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
        httpConnection0.post();
  ...
  public void test146()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("application/x-www-form-urlencoded", 12);
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertFalse(httpConnection_Request1.ignoreContentType());
