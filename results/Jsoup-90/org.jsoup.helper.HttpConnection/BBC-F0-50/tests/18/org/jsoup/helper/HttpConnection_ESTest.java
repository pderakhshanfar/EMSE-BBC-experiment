...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("=d", 520);
  ...
  public void test006()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.timeout(2271);
      assertEquals(2271, httpConnection_Request0.timeout());
  }
  ...
  public void test009()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("ISO-8859-1");
  ...
  public void test016()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize(50);
      assertEquals(50, httpConnection_Request0.maxBodySize());
  }
  ...
  public void test033()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("8-Hgg1", "Content-Type", 1793, "org.jsoup.parser.Token$CData", uRLStreamHandler0);
  ...
  public void test036()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.userAgent("H?2]=85ObFS*.i@_Uu#");
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.referrer("Data input stream must not be null");
        fail("Expecting exception: NullPointerException");
  ...
  public void test044()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("user-agent", (int) (byte) (-92));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test048()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.proxy("multipart/form-data", 36);
      try { 
        httpConnection0.post();
  ...
  public void test054()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("beforehead", "beforehead");
        fail("Expecting exception: NullPointerException");
  ...
  public void test062()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.request((Connection.Request) null);
      LinkedHashSet<Connection.KeyVal> linkedHashSet0 = new LinkedHashSet<Connection.KeyVal>(3871, 3871);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", ":%s(%d)");
  ...
  public void test064()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("[f(2&", "l0", (InputStream) null, "R9-u;Mq@/3(#?");
        fail("Expecting exception: NullPointerException");
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("", "Content-Encoding", (InputStream) byteArrayInputStream0, "content-type");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test066()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("; ", "FbZq", (InputStream) pipedInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test069()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("~\"F{", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test073()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("", "org.jsoup.select.CombiningEvaluator$And");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test076()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("i!6");
  ...
  public void test077()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.header("location", "t#*72b(pga7");
      assertEquals(30000, httpConnection_Request1.timeout());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
  ...
  public void test078()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("Request must be executed (with .execute(), .get(), or .post() before getting response body");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test081()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("8vPf@)61l", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("8vPf@)61l", string0);
  ...
  public void test086()  throws Throwable  {
      ...
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "j+", (InputStream) null);
  ...
  public void test087()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.cookie("application/x-www-form-urlencoded", "Accept-Encoding");
      connection0.cookie("$x:(IP7pyf(j", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      URL uRL0 = MockURL.getHttpExample();
  ...
  public void test088()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.url(uRL0);
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      connection0.data("P1-vlZ\"V5D:WM", "=6y", (InputStream) pipedInputStream0, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      try { 
        httpConnection0.post();
  ...
  public void test089()  throws Throwable  {
      ...
      linkedList0.add("}w3ib4ir6q=z=de");
  ...
  public void test093()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.proxy("Acept-Encoding", 32768);
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.get();
  ...
  public void test099()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "Referrer must not be null", 78, "-?$Q0\u0002cj\"*-NQ", uRLStreamHandler0);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test102()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-162));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test104()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = connection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("multipart/form-data", "Data input stream must not be null");
      try { 
        HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
        fail("Expecting exception: IOException");
  ...
  public void test105()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.addHeader("Content-Type", ", gjjwka>");
  ...
  public void test106()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("RllrnD:O7y-B9-T/+k", (String) null);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test107()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      Connection connection0 = httpConnection0.header("Content-Type", "lNyXCYm.]i{F.*OT#u");
      try { 
        connection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test108()  throws Throwable  {
      ...
      hashMap0.put("xy(2e2Bu+)", "Yh1P\"cco:nPb:");
  ...
  public void test109()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Content-Type", "multipart/form-data; boundary=");
  ...
  public void test110()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("ISO-8859-1", "application/x-www-form-urlencoded; charset=");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("ISO-8859-1");
      assertEquals("application/x-www-form-urlencoded; charset=", connection_KeyVal0.value());
  ...
  public void test117()  throws Throwable  {
      FileDescriptor fileDescriptor0 = new FileDescriptor();
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("^}PaQu#pAp&IJN", "", (InputStream) mockFileInputStream0);
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("^}PaQu#pAp&IJN=", string0);
  }

  @Test(timeout = 4000)
  public void test118()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("anHd&[$&", "Content-Encoding");
      httpConnection_KeyVal0.contentType();
      assertEquals("anHd&[$&", httpConnection_KeyVal0.key());
      assertEquals("Content-Encoding", httpConnection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test119()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("{_h4LF7l/;KA", "x");
      httpConnection_KeyVal0.inputStream();
      assertEquals("x", httpConnection_KeyVal0.value());
      assertEquals("{_h4LF7l/;KA", httpConnection_KeyVal0.key());
  }
  ...
  public void test125()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("|gGnfMB}/", "multipart/form-data");
        fail("Expecting exception: NullPointerException");
  ...
  public void test126()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      httpConnection0.data("G", "G", (InputStream) pipedInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("G");
      assertNotNull(connection_KeyVal0);
  ...
  public void test136()  throws Throwable  {
      ...
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress(inetAddress0, 128);
