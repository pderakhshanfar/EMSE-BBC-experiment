...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      linkedList0.offerLast("4XF&9-RZ=");
  ...
  public void test010()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded", "|", (InputStream) bufferedInputStream0);
  ...
  public void test011()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "g7u'B\"9|2~yEMXt");
  ...
  public void test019()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("J", "value", 4030, ".xbB", uRLStreamHandler0);
  ...
  public void test020()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("7eS>|", "Content-Encoding", 0, "Content-Type", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test033()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("+VnJf)7j{fLQu*K");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test041()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-1224));
        fail("Expecting exception: NullPointerException");
  ...
  public void test049()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL1 = MockURL.URL(uRL0, "muted", uRLStreamHandler0);
  ...
  public void test056()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("yph", "yph", (InputStream) pipedInputStream0, "Content-Encoding");
        fail("Expecting exception: NullPointerException");
  ...
  public void test057()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 41, 98688);
      // Undeclared exception!
      try { 
        httpConnection0.data("{q*-^", "{q*-^", (InputStream) byteArrayInputStream0, (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test058()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("6f", "`", (InputStream) pushbackInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test059()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)101, 1681);
      // Undeclared exception!
      try { 
  ...
  public void test060()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("e{ee]5<jnx^e", "e{ee]5<jnx^e");
        fail("Expecting exception: NullPointerException");
  ...
  public void test061()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("", "allowfullscreen");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test062()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("e{ee]5<jnx^e");
        fail("Expecting exception: NullPointerException");
  ...
  public void test067()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("eowxyymedy>m-m8ea", "Data key must not be empty");
      assertEquals("eowxyymedy>m-m8ea", httpConnection_KeyVal0.key());
      
      httpConnection_KeyVal0.key("PI!Be}#)DqU1P");
  ...
  public void test068()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.header("multipart/form-data", "#7S>y82_#NF?");
  ...
  public void test069()  throws Throwable  {
      ...
      httpConnection_KeyVal0.value("PI!Be}#)DqU1P");
      assertEquals("eowxyymedy>m-m8ea", httpConnection_KeyVal0.key());
  }

  @Test(timeout = 4000)
  public void test070()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("muted", "a");
  ...
  public void test076()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.cookie("multipart/form-data", "Content-Type");
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.cookie("Content-Encoding", "Content-Type");
      httpConnection_Request0.url(uRL0);
      try { 
  ...
  public void test080()  throws Throwable  {
      ...
      assertEquals("UTF-8", httpConnection_Request0.postDataCharset());
      assertEquals(30000, httpConnection_Request0.timeout());
      assertEquals("g7u'B\"9|2~yEMXt", string0);
  }
  ...
  public void test084()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.requestBody("maxSize must be 0 (unlimited) or larger");
      // Undeclared exception!
      try { 
        httpConnection0.get();
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test085()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("small");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test086()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-267));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test088()  throws Throwable  {
      ...
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.url(uRL0);
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("0`lc1pHgGCc'OXon", "c:*.\u0006");
      try { 
        HttpConnection.Response.execute(httpConnection_Request1, httpConnection_Response0);
        fail("Expecting exception: IOException");
  ...
  public void test089()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.addHeader("Content-Type", "aOB");
  ...
  public void test090()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header(">\"3^2:z@ASSQc{", (String) null);
  ...
  public void test092()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("~cPV9=b 8P=PSR/;", "Content-Encoding");
  ...
  public void test093()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("jce", "Must supply an even number of key value pairs", (InputStream) null, "e_aZ@w7f/O=MH");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("jce");
      assertNotNull(connection_KeyVal0);
      assertEquals("Must supply an even number of key value pairs", connection_KeyVal0.value());
      assertEquals("e_aZ@w7f/O=MH", connection_KeyVal0.contentType());
  }

  @Test(timeout = 4000)
  public void test094()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "Content-Encoding", (InputStream) null, "Ll@?oeI9p^4$");
  ...
  public void test095()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("application/x-www-form-urlencoded", "EsY:&sB<WN>~caFsV");
  ...
  public void test099()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("mozilla/5.0 (macintosh; intel mac os x 10_11_6) applewebkit/537.36 (khtml, like gecko) chrome/53.0.2785.143 safari/537.36", "KtDo<2[b{V|");
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("mozilla/5.0 (macintosh; intel mac os x 10_11_6) applewebkit/537.36 (khtml, like gecko) chrome/53.0.2785.143 safari/537.36=KtDo<2[b{V|", string0);
  }
  ...
  public void test109()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer("K5,Ta2HORhn(=1I=?%h");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test115()  throws Throwable  {
      ...
      httpConnection0.data("epru~9D23)xL2o", "`", (InputStream) bufferedInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("epru~9D23)xL2o");
      assertEquals("`", connection_KeyVal0.value());
      assertNotNull(connection_KeyVal0);
  }
  ...
  public void test123()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.proxy("F;1kM;#Do:YpfYQ", 117);
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.get();
  ...
  public void test126()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.cookie("%22", "HZEU$X56~Z)Z_@D");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test127()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.removeCookie(":t1qdd");
      assertEquals(30000, httpConnection_Request1.timeout());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
  ...
  public void test132()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("f>w#t,skP", "f>w#t,skP");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test136()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.URL("https", "Content-Type", "multipart/form-data");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
