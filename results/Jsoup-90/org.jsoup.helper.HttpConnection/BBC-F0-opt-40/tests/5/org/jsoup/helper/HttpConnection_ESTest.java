...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize(225);
      assertEquals(225, httpConnection_Request0.maxBodySize());
  }

  @Test(timeout = 4000)
  public void test003()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("+j+50?>|m=+{.$~eqj", "basefont");
      assertEquals("+j+50?>|m=+{.$~eqj", httpConnection_KeyVal0.key());
      
      httpConnection_KeyVal0.key("Header name must not be null");
      assertEquals("basefont", httpConnection_KeyVal0.value());
  }
  ...
  public void test008()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("83tJFb[Mu");
  ...
  public void test010()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("Content-Disposition: form-data; name=\"", 2);
  ...
  public void test012()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.postDataCharset("org.jsoup.HttpStatusException");
  ...
  public void test017()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("/99O`~I>-U.+YY5", "/99O`~I>-U.+YY5", (InputStream) dataInputStream0);
  ...
  public void test020()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "z/7r");
      HttpConnection httpConnection0 = new HttpConnection();
  ...
  public void test023()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("~@F", "https", 239, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", uRLStreamHandler0);
  ...
  public void test024()  throws Throwable  {
      ...
      httpConnection0.data(":#_EaZ{3Qgl#w9;'?", "org.jsoup.select.Evaluator$IsFirstOfType", (InputStream) byteArrayInputStream0, "a%INW7ZCV]4G$;C3):");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data(":#_EaZ{3Qgl#w9;'?");
      assertEquals("a%INW7ZCV]4G$;C3):", connection_KeyVal0.contentType());
      assertEquals("org.jsoup.select.Evaluator$IsFirstOfType", connection_KeyVal0.value());
  ...
  public void test031()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.requestBody("tLew1d");
        fail("Expecting exception: NullPointerException");
  ...
  public void test034()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("I6vBY8ky", 94);
        fail("Expecting exception: NullPointerException");
  ...
  public void test035()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy((String) null, 8);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test036()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("~rk7");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-2857));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test048()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.header("multipart/form-data", "Content-Type");
        fail("Expecting exception: NullPointerException");
  ...
  public void test049()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("", "Data key value pairs must not be null");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test056()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Q>>v6,Q", (String) null);
      // Undeclared exception!
      try { 
  ...
  public void test058()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("", "https", (InputStream) pipedInputStream0, "7Lb_|:(%&AS]");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test059()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("&quot;", (String) null, (InputStream) dataInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test061()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("basefont", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("IYY3PxR\";lg4w8{MV|", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test068()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.header("application/x-www-form-urlencoded", "Content-Type");
  ...
  public void test072()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("kZKoW]", "kZKoW]", (InputStream) byteArrayInputStream0);
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("kZKoW]", string0);
  }
  ...
  public void test074()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "OL7)WS$bldzhDT(w2", (InputStream) pushbackInputStream0);
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("OL7)WS$bldzhDT(w2", string0);
  ...
  public void test077()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("_M{XA0XNb-i!", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("v`Ui");
      ...
      assertEquals("_M{XA0XNb-i!", connection_KeyVal0.key());
  }
  ...
  public void test079()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.cookie("multipart/form-data", "multipart/form-data; boundary=");
      Connection connection0 = httpConnection0.url(uRL0);
  ...
  public void test080()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      connection0.data("multipart/form-data", "org.jsoup.parser.Token$CData", (InputStream) byteArrayInputStream0, "D`JSow");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test082()  throws Throwable  {
      ...
      hashMap0.merge("blockquote", linkedList0, biFunction0);
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.processResponseHeaders(hashMap0);
  ...
  public void test088()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "l!@", 255, "org.jsoup.select.Evaluator$AttributeStarting", uRLStreamHandler0);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test090()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("command");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test095()  throws Throwable  {
      ...
      httpConnection0.data(stringArray0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("o3");
  ...
  public void test096()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("text/", "text/", (InputStream) bufferedInputStream0);
  ...
  public void test098()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("K\"i3WiY1hF_>Bg", "SS+aA'DwXclK%");
  ...
  public void test099()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("2j(g_5~-", "{jYwHTH[tj`");
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("2j(g_5~-={jYwHTH[tj`", string0);
  }
  ...
  public void test101()  throws Throwable  {
      ...
      assertEquals("2j(g_5~-", httpConnection_KeyVal0.key());
      assertEquals("{jYwHTH[tj`", httpConnection_KeyVal0.value());
  }
  ...
  public void test102()  throws Throwable  {
      ...
      assertEquals("a-", connection_KeyVal0.value());
      assertNotNull(connection_KeyVal0);
  }
  ...
  public void test108()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = httpConnection_Response0.charset("'`*4RC(H");
      assertEquals("'`*4RC(H", httpConnection_Response1.charset());
  }
  ...
  public void test110()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("User agent must not be null", "User agent must not be null");
  ...
  public void test114()  throws Throwable  {
      ...
      doReturn(false).when(enumeration0).hasMoreElements();
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(enumeration0);
      Connection connection0 = httpConnection0.data("k\"i3wiy1hf_>bg", "k\"i3wiy1hf_>bg", (InputStream) sequenceInputStream0);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test120()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("9k1B}T2");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test125()  throws Throwable  {
      ...
      connection0.requestBody("org.jsoup.parser.Token$Doctype");
      // Undeclared exception!
      try { 
        connection0.get();
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test132()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("_m{xa0xnb-i!", 833);
      assertSame(connection0, httpConnection0);
  }
