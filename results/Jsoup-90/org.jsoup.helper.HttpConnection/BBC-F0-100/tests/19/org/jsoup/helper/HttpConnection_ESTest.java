...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test006()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("Content-Encoding", 1427);
  ...
  public void test008()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection_Request0.postDataCharset("Content-Encoding");
  ...
  public void test014()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(byteArrayInputStream0, 337);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("eR\"D.|", "eR\"D.|", (InputStream) bufferedInputStream0);
  ...
  public void test015()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("%q;dfN3[", ";5wDnW\")NTUWT$zL", (InputStream) pipedInputStream0);
      boolean boolean0 = httpConnection_KeyVal0.hasInputStream();
      assertEquals(";5wDnW\")NTUWT$zL", httpConnection_KeyVal0.value());
      assertEquals("%q;dfN3[", httpConnection_KeyVal0.key());
      assertTrue(boolean0);
  }
  ...
  public void test019()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer("@Z~<dt8<C7");
  ...
  public void test022()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Accept-Encoding", "multipart/form-data", 44, "Content-Encoding", uRLStreamHandler0);
  ...
  public void test035()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("data input stream must not be null", (-2948));
        fail("Expecting exception: NullPointerException");
  ...
  public void test036()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("q=Ii)uOmy'i mA,rZ");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test037()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("*XzYFEX,}DB33!");
        fail("Expecting exception: NullPointerException");
  ...
  public void test046()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-795));
        fail("Expecting exception: NullPointerException");
  ...
  public void test051()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("Content-Type", "Method must not be null");
        fail("Expecting exception: NullPointerException");
  ...
  public void test059()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(mockFileInputStream0, 114);
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(pushbackInputStream0, pushbackInputStream0);
      // Undeclared exception!
      try { 
        httpConnection0.data("xlE]<w`@-UK~NBVBf/h", "Content-Encoding", (InputStream) sequenceInputStream0, "-OD6bT$o/s|");
        fail("Expecting exception: NullPointerException");
  ...
  public void test060()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("6i#1(zTpigs&FODAo~", (String) null, (InputStream) pipedInputStream0, "org.jsoup.safety.Cleaner$CleaningVisitor");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test061()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("tAcxF", "uppRt!:F}", (InputStream) mockFileInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test062()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1706, 46);
      // Undeclared exception!
      try { 
  ...
  public void test063()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("= $lD~/N6Wub}3xWTuK", "file");
        fail("Expecting exception: NullPointerException");
  ...
  public void test069()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "[W>x%d_!0");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("RcdataLessthanSign");
  ...
  public void test071()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.header("i", "Content-Type");
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertEquals(30000, httpConnection_Request1.timeout());
  ...
  public void test076()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "i", (InputStream) null);
  ...
  public void test079()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "nullChar");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("D.0k-RCBSoR");
      assertEquals("nullChar", connection_KeyVal0.value());
  ...
  public void test081()  throws Throwable  {
      ...
      connection0.cookie("501V9DZC{hv!cXp7n", "GJ*Qt)]Tn)");
  ...
  public void test082()  throws Throwable  {
      ...
      httpConnection0.data("iK^GU5", "Content-Encoding", (InputStream) dataInputStream0, "multipart/form-data");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test083()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.addHeader("OqmK6#/K[]", "YT@^TCY7P!49");
  ...
  public void test086()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.proxy("9+~B~kBv@ J9jW", 120);
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.get();
  ...
  public void test090()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "Content-Type", 20, "Content-Encoding", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
        httpConnection0.get();
  ...
  public void test091()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("title");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test094()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.addHeader("set-cookie", "W_Q=I");
      Map<String, List<String>> map0 = httpConnection_Response0.headers;
      // Undeclared exception!
      try { 
        httpConnection_Response0.processResponseHeaders(map0);
  ...
  public void test096()  throws Throwable  {
      ...
      hashMap0.put("t|;m0T{kZ:l+NUk98", "Unexpected token type: ");
  ...
  public void test098()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      httpConnection0.data("http:/", "", (InputStream) pipedInputStream0);
  ...
  public void test103()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("multipart/form-data", "=fas@W8");
  ...
  public void test104()  throws Throwable  {
      ...
      assertEquals("multipart/form-data=nullChar", string0);
  }
  ...
  public void test105()  throws Throwable  {
      ...
      connection1.requestBody("0[$w!n1ifG&0");
      try { 
        connection1.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test106()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("details", "P");
      httpConnection_KeyVal0.contentType();
      assertEquals("details", httpConnection_KeyVal0.key());
      assertEquals("P", httpConnection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test107()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Must set charset arg to character set of file to parse. Set to null to attempt to detect from HTML", "bGabe");
      httpConnection_KeyVal0.inputStream();
      assertEquals("bGabe", httpConnection_KeyVal0.value());
      assertEquals("Must set charset arg to character set of file to parse. Set to null to attempt to detect from HTML", httpConnection_KeyVal0.key());
  }
  ...
  public void test117()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("org.jsoup.select.Evaluator$Tag", (String) null);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test121()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.timeout(9);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test130()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("F4X;&Y\"+9");
      assertEquals(30000, connection_Request0.timeout());
      assertTrue(connection_Request0.followRedirects());
      assertEquals(1048576, connection_Request0.maxBodySize());
      assertFalse(connection_Request0.ignoreContentType());
  ...
  public void test131()  throws Throwable  {
      ...
      InetSocketAddress inetSocketAddress0 = MockInetSocketAddress.createUnresolved("Content-Type", 2571);
  ...
  public void test140()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy((String) null, 3684);
        fail("Expecting exception: IllegalArgumentException");
