...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("di u,-cdh4lzf", "9EKWwt1an>5CMl=", (InputStream) null, "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test003()  throws Throwable  {
      ...
      httpConnection_Request0.timeout(2584);
      assertEquals(2584, httpConnection_Request0.timeout());
  }
  ...
  public void test007()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("", 1177);
  ...
  public void test009()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.postDataCharset("I8%L_*k0%a&ikN '|O");
  ...
  public void test017()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("String input must not be null", "Content-Type", (InputStream) pipedInputStream0);
      boolean boolean0 = httpConnection_KeyVal0.hasInputStream();
      assertEquals("String input must not be null", httpConnection_KeyVal0.key());
  ...
  public void test018()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "[^-a-zA-Z0-H_:.7]");
      HttpConnection httpConnection0 = new HttpConnection();
  ...
  public void test019()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpConnection.connect("x':\"tM6N7V+}D(PJl");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: x':\"tM6N7V+}D(PJl
         //
  ...
  public void test025()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "}3z", 36, "Doctype", uRLStreamHandler0);
  ...
  public void test026()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("87}}:2@}incn8xm1^", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", 0, "application/x-www-form-urlencoded", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test028()  throws Throwable  {
      ...
      httpConnection0.data("uru eq!x;yog", "ftp", (InputStream) sequenceInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("uru eq!x;yog");
  ...
  public void test036()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.referrer("s(ulln[yovqt");
        fail("Expecting exception: NullPointerException");
  ...
  public void test038()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("Content-Encoding", (-1637));
        fail("Expecting exception: NullPointerException");
  ...
  public void test039()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy((String) null, 2012);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("/I6|b,");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test047()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-1637));
        fail("Expecting exception: NullPointerException");
  ...
  public void test050()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("0KMo", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test051()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header((String) null, "SSPs{Wr^!");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test059()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL1 = MockURL.URL(uRL0, "K4}n>kL\"!Qq6b/", uRLStreamHandler0);
  ...
  public void test061()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("noresize", "_39KQ8*`JIs2::zTfmU>");
  ...
  public void test063()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)9, (byte)18);
      // Undeclared exception!
      try { 
        connection0.data("<vWQeQ rp!^GW'z_", "multipart/form-data", (InputStream) byteArrayInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test064()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("0#ayq)v9AL\"a,p*RNi", "accept-encoding");
        fail("Expecting exception: NullPointerException");
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "2");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test069()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("={$b", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test070()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Type", "<vWQeQ rp!^GW'z_");
      assertEquals("Content-Type", httpConnection_KeyVal0.key());
      
      httpConnection_KeyVal0.key("!");
      assertEquals("<vWQeQ rp!^GW'z_", httpConnection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test071()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.header("xmp", "cite");
  ...
  public void test074()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "pHMf");
      assertEquals("pHMf", httpConnection_KeyVal0.value());
  ...
  public void test075()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("3W", "3W");
  ...
  public void test076()  throws Throwable  {
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream((InputStream) null, 906);
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(pushbackInputStream0, (InputStream) null);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("pe9Lxd/a<o>Ab;", "pe9Lxd/a<o>Ab;", (InputStream) sequenceInputStream0);
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("pe9Lxd/a<o>Ab;", string0);
  }
  ...
  public void test078()  throws Throwable  {
      ...
      assertEquals("pHMf", connection_KeyVal0.value());
  }
  ...
  public void test080()  throws Throwable  {
      ...
      httpConnection0.cookie("w.b+9Z(", "multipart/form-data; boundary=");
  ...
  public void test081()  throws Throwable  {
      ...
      httpConnection0.data("pqQy#/R'Q6ys$RYwzxv", "pqQy#/R'Q6ys$RYwzxv", (InputStream) byteArrayInputStream0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test083()  throws Throwable  {
      ...
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      hashMap0.put("Set-bookie", linkedList0);
      httpConnection_Response0.processResponseHeaders(hashMap0);
  ...
  public void test085()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.proxy("Cookie", 764);
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: IOException");
  ...
  public void test086()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "\fTD'v1=PD");
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(connection_Request0);
  ...
  public void test090()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      httpConnection0.requestBody("/gnYLp:sQUF734]v\"?g");
      httpConnection0.data("application/x-www-form-urlencoded", "AfterAttributeValue_quoted");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test091()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.data("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "referer");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test092()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "https", 1192721831, "https", uRLStreamHandler0);
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test095()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-880));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test096()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = connection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("[^-a-zA-Z0-G_:.7]", "AfterAttributeName");
      try { 
        HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
        fail("Expecting exception: IOException");
  ...
  public void test099()  throws Throwable  {
      ...
      hashMap0.put("Content-Type", "2\u0005aTuD");
  ...
  public void test100()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("application/x-www-form-urlencoded", "iZ;&;p,rhADx_P+_=(O");
  ...
  public void test102()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("multipart/form-data", "A(,g34;Ml8");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("multipart/form-data");
      assertEquals("A(,g34;Ml8", connection_KeyVal0.value());
      assertNotNull(connection_KeyVal0);
  }
  ...
  public void test103()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "_/9,=5L^Xr");
  ...
  public void test107()  throws Throwable  {
      ...
      assertEquals("String input must not be null=Content-Type", string0);
  }
  ...
  public void test109()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("vQL]~%FdttLva?P;_%<", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      ...
      assertEquals("vQL]~%FdttLva?P;_%<", httpConnection_KeyVal0.key());
  }

  @Test(timeout = 4000)
  public void test110()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("limitedQuirks", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", (InputStream) pipedInputStream0);
      httpConnection_KeyVal0.inputStream();
      assertEquals("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", httpConnection_KeyVal0.value());
      assertEquals("limitedQuirks", httpConnection_KeyVal0.key());
  }
  ...
  public void test117()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer("s(ulln[yovqt");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test119()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("multipart/form-data", "rw_");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test120()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("application/x-www-form-urlencoded", "4%");
        fail("Expecting exception: NullPointerException");
  ...
  public void test122()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("C 4gBW|.p~?Ft", "i<");
  ...
  public void test131()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.removeCookie("Data key must not be empty");
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
      assertFalse(httpConnection_Request1.ignoreContentType());
  ...
  public void test135()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("<FXXKu}&T", "<FXXKu}&T", (InputStream) null, "option");
      assertSame(httpConnection0, connection0);
  }
