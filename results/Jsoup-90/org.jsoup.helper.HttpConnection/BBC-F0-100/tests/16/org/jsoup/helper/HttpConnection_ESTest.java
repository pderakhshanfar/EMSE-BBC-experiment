...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      httpConnection_Response0.header("set-cookie", "^+pOYsYD,5J=m=)B~F(");
  ...
  public void test003()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("Header map must not be null", "+--");
  ...
  public void test005()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.timeout(4297);
      assertEquals(4297, httpConnection_Request0.timeout());
  }
  ...
  public void test007()  throws Throwable  {
      ...
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("cite");
  ...
  public void test013()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.postDataCharset("L[Dk,.9F_z@]");
  ...
  public void test029()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("BnSd", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", 0, "application/x-www-form-urlencoded", uRLStreamHandler0);
  ...
  public void test030()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("'yy6Oi>w-,;|u<~", "multipart/form-data", 598, "'yy6Oi>w-,;|u<~", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test032()  throws Throwable  {
      ...
      stringArray0[3] = "Content-Disposition: form-data; name=\"";
      Connection connection0 = httpConnection0.data(stringArray0);
      Connection.KeyVal connection_KeyVal0 = connection0.data("Request must be executed (with .execute(), .get(), or .post() before parsing response");
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.requestBody("ScriptDataEscapedDashDash");
        fail("Expecting exception: NullPointerException");
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("multipart/form-data", (-2595));
        fail("Expecting exception: NullPointerException");
  ...
  public void test046()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "", 1018, "N6Yra-?*}N@EDoLEy", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
  ...
  public void test053()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("comment", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
        fail("Expecting exception: NullPointerException");
  ...
  public void test054()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header((String) null, "L>BIO@9q");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test060()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL1 = MockURL.URL(uRL0, "y", uRLStreamHandler0);
  ...
  public void test062()  throws Throwable  {
      ...
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("Request must not be null", 97);
      URL uRL0 = MockURL.getHttpExample();
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("Sqollar,r_.", ".f.m4?'{r.-PMG", (InputStream) pipedInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test066()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("", "H#/", (InputStream) pipedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test075()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("w(c//li/ehmg", "*Y$2vt", (InputStream) pipedInputStream0);
      assertEquals("w(c//li/ehmg", httpConnection_KeyVal0.key());
      
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.key("w(c//li/ehmg");
      assertEquals("*Y$2vt", httpConnection_KeyVal1.value());
  }
  ...
  public void test077()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("w(c//li/ehmg", "*Y$2vt", (InputStream) pipedInputStream0);
      assertEquals("*Y$2vt", httpConnection_KeyVal0.value());
      
      httpConnection_KeyVal0.value("SI&#Si");
      assertEquals("w(c//li/ehmg", httpConnection_KeyVal0.key());
  }
  ...
  public void test081()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.data("yI95!LqDZL)^s!h+>-", "u'p&z^|qI", (InputStream) null);
      httpConnection0.data("u'p&z^|qI", "referer", (InputStream) null);
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test082()  throws Throwable  {
      ...
      connection0.cookie("o;=TZ^1", "Content-Type");
  ...
  public void test083()  throws Throwable  {
      ...
      httpConnection0.data("org.jsoup.helper.HttpConnection", "org.jsoup.select.Evaluator$Class", (InputStream) sequenceInputStream0, "org.jsoup.helper.HttpConnection");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test097()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.header("My](RZbpDWFg", "InHead");
      Map<String, List<String>> map0 = httpConnection_Response0.headers;
      // Undeclared exception!
      try { 
        httpConnection_Response0.processResponseHeaders(map0);
  ...
  public void test098()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.header("Content-Type", "!*z]0L=mW;pC86Iu=");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test101()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("dd", "dd", (InputStream) null);
  ...
  public void test102()  throws Throwable  {
      ...
      httpConnection0.data("/d", "/d", (InputStream) bufferedInputStream0);
  ...
  public void test107()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 684, 107);
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("z{(iZk*.&e(@m_", "Content-Disposition: form-data; name=\"", (InputStream) byteArrayInputStream0);
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("z{(iZk*.&e(@m_=Content-Disposition: form-data; name=\"", string0);
  }
  ...
  public void test111()  throws Throwable  {
      ...
      assertEquals("*Y$2vt", httpConnection_KeyVal0.value());
      assertEquals("w(c//li/ehmg", string0);
  }
  ...
  public void test117()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data(",6", "~um3 (dxe:t|)=p)<'", (InputStream) null, (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test121()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("summary", "summary");
        fail("Expecting exception: NullPointerException");
  ...
  public void test126()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("G|,WM4/%Xb,%{");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test140()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy((String) null, 442);
        fail("Expecting exception: IllegalArgumentException");
