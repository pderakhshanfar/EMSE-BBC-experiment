...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      httpConnection_Response0.addHeader("set-cookie", " $zDPnURk/Z");
  ...
  public void test002()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("F4/");
  ...
  public void test004()  throws Throwable  {
      ...
      httpConnection_Request0.timeout(111);
      assertEquals(111, httpConnection_Request0.timeout());
  }
  ...
  public void test012()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize(908);
      assertEquals(908, httpConnection_Request0.maxBodySize());
  }
  ...
  public void test018()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "Iyk bk~");
      ...
      assertEquals("Iyk bk~", httpConnection_KeyVal0.value());
  }
  ...
  public void test026()  throws Throwable  {
      ...
      Connection connection0 = httpConnection0.url(uRL0);
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "v3#resxVy)S]}H|%+3C");
  ...
  public void test028()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("seamless", "nB/k\"d9I@P=133%", 116, "gzip", uRLStreamHandler0);
  ...
  public void test030()  throws Throwable  {
      ...
      stringArray0[4] = "D0h9&F$j~6vmzhd";
      ...
      assertEquals("seamless", connection_KeyVal0.value());
  }
  ...
  public void test031()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.userAgent("+NY(qYL");
  ...
  public void test040()  throws Throwable  {
      ...
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress("g8a((drvLm1", 248);
  ...
  public void test041()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("org.jsoup.helper.HttpConnection$KeyVal", (-1690));
        fail("Expecting exception: NullPointerException");
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("7xb", (-1730));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-1730
         //
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("ud=+P}wq");
  ...
  public void test044()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("deflate");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test054()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header((String) null, "BAR0V0#=a:");
        fail("Expecting exception: NullPointerException");
  ...
  public void test062()  throws Throwable  {
      ...
      hashMap0.put("%?+V>09T", "application/x-www-form-urlencoded");
      // Undeclared exception!
      try { 
  ...
  public void test065()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(bufferedInputStream0, 55);
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "+ ", (InputStream) pushbackInputStream0, "org.jsoup.select.Evaluator$IsOnlyChild");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test066()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("Content-Encoding", "r~v:[%KZ=[ ", (InputStream) pushbackInputStream0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test067()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("user-agent", "Content-Encoding");
        fail("Expecting exception: NullPointerException");
  ...
  public void test068()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("};P- ", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test077()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("ud=+p}wq", "multipart/form-data", (InputStream) pipedInputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.inputStream((InputStream) pipedInputStream0);
      assertEquals("ud=+p}wq", httpConnection_KeyVal1.key());
  ...
  public void test083()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("`*", "Mi'vRk|lyZEN9KO8aFC");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("select");
      assertEquals("`*", connection_KeyVal0.key());
      assertEquals("Mi'vRk|lyZEN9KO8aFC", connection_KeyVal0.value());
  }
  ...
  public void test084()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      httpConnection0.data("Request must be executed (with .execute(), .get(), or .post() before getting response body", "Request must be executed (with .execute(), .get(), or .post() before getting response body", (InputStream) null);
      try { 
        httpConnection0.post();
  ...
  public void test086()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.cookie(":YvN$Y", "&nbsp;");
      connection0.cookie("d)uE", "application/x-www-form-urlencoded");
      try { 
        connection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test087()  throws Throwable  {
      ...
      hashMap0.put("])d0Ofwp7", linkedList0);
  ...
  public void test090()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.proxy("xP#p`s|`yOqUm", 951);
      try { 
        connection0.post();
        fail("Expecting exception: IOException");
  ...
  public void test095()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1101, 1101);
      Connection connection1 = connection0.data("Content-Encoding", "Content-Encoding", (InputStream) byteArrayInputStream0);
      // Undeclared exception!
      try { 
        connection1.post();
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test096()  throws Throwable  {
      ...
      httpConnection0.data("\"vB(`g6UZ", "qQgw@?%u[9H", (InputStream) byteArrayInputStream0, "user agent must not be null");
      try { 
        connection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test098()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("https", "", 383, "Content-Type", uRLStreamHandler0);
      httpConnection0.url(uRL0);
      // Undeclared exception!
      try { 
        httpConnection0.post();
  ...
  public void test102()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("ZbeMRUnw6.$+$u{[/B", "enngopeen");
      try { 
        HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
        fail("Expecting exception: IOException");
  ...
  public void test106()  throws Throwable  {
      ...
      stringArray0[5] = "Content-Encoding";
      stringArray0[6] = "D0h9&F$j~6vmzhd";
      stringArray0[7] = "Content-Type";
      httpConnection0.data(stringArray0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("OM<C");
  ...
  public void test107()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("q6!CC}Er3l", "PATCH", (InputStream) sequenceInputStream0);
  ...
  public void test110()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("org.jsoup.helper.HttpConnection$Base", "Content-Encoding");
      String string0 = httpConnection_KeyVal0.toString();
      assertEquals("org.jsoup.helper.HttpConnection$Base=Content-Encoding", string0);
  }

  @Test(timeout = 4000)
  public void test111()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Type", "OM<C");
      httpConnection_KeyVal0.contentType();
      assertEquals("OM<C", httpConnection_KeyVal0.value());
  ...
  public void test113()  throws Throwable  {
      ...
      httpConnection0.data("application/x-www-form-urlencoded", "Content-Encoding", (InputStream) byteArrayInputStream0);
  ...
  public void test118()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer("&i{1.");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test120()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, httpConnection0.CONTENT_ENCODING, (InputStream) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test125()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-1842));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test131()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("D/QGbrO#&", "ud=+p}wq");
      assertSame(httpConnection0, connection0);
  }
