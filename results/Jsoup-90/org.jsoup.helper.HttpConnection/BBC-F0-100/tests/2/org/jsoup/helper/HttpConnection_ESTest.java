...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      httpConnection0.requestBody(")529{7.Ol/+Y KI|-");
  ...
  public void test003()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("z{", ")K@");
  ...
  public void test009()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("BsTuc8H`|Y'xC*C");
  ...
  public void test012()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("l2<jwJ", 13);
      assertEquals(30000, httpConnection_Request1.timeout());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test015()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.maxBodySize((-1941));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test020()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("^IM%7^{,qHhYpKRk", "^IM%7^{,qHhYpKRk");
  ...
  public void test023()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "x#P|lTu*U{1l\"r;n@");
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.getHttpExample();
  ...
  public void test028()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Content-Type", "accept-encoding", 106, "file", uRLStreamHandler0);
  ...
  public void test035()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.requestBody("Puz?]tZbydMvb");
        fail("Expecting exception: NullPointerException");
  ...
  public void test039()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.proxy("Content-Type", 947);
        fail("Expecting exception: NullPointerException");
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy((String) null, (-1644953643));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test046()  throws Throwable  {
      ...
      InetSocketAddress inetSocketAddress0 = MockInetSocketAddress.createUnresolved("http", 841);
  ...
  public void test051()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("blockquote", "Data ke value pairs must not be null");
        fail("Expecting exception: NullPointerException");
  ...
  public void test058()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("zq NLo=O)", "jXety", (InputStream) mockFileInputStream0);
  ...
  public void test060()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data(">yhs!cftw", ">yhs!cftw", (InputStream) byteArrayInputStream0, "multipart/form-data");
        fail("Expecting exception: NullPointerException");
  ...
  public void test061()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 255, (-110));
      // Undeclared exception!
      try { 
        httpConnection0.data("ixM~AD\u0003p=$xY", "8lIl)B", (InputStream) byteArrayInputStream0, "");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test062()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "/a08V", (InputStream) byteArrayInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test063()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "]Im+M-0#2=[?QIF'dM");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test064()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("blockquoe");
        fail("Expecting exception: NullPointerException");
  ...
  public void test067()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie(">yhs!cftw", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test070()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("`*", "Mi'vRk|lyZEN9KO8aFC");
      assertEquals("`*", httpConnection_KeyVal0.key());
      
      httpConnection_KeyVal0.key("Mi'vRk|lyZEN9KO8aFC");
      assertEquals("Mi'vRk|lyZEN9KO8aFC", httpConnection_KeyVal0.value());
  }

  @Test(timeout = 4000)
  public void test071()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      Connection.Response connection_Response0 = httpConnection_Response0.header("URL must not be null", "URL must not be null");
  ...
  public void test073()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "S25N_}`yIj/{@<z", (InputStream) null);
      ...
      assertEquals("S25N_}`yIj/{@<z", httpConnection_KeyVal1.value());
  }

  @Test(timeout = 4000)
  public void test074()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("cqB=?3UIph:maDI", "GXu%^NTRf)>1VWd'");
      assertEquals("GXu%^NTRf)>1VWd'", httpConnection_KeyVal0.value());
      
      httpConnection_KeyVal0.value("-KIbCU+5");
      assertEquals("cqB=?3UIph:maDI", httpConnection_KeyVal0.key());
  }

  @Test(timeout = 4000)
  public void test075()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(" ", "Vw(?4bWX,WHpJd5x", (InputStream) null);
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("Vw(?4bWX,WHpJd5x", httpConnection_KeyVal0.value());
  ...
  public void test077()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "/:2VC");
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("/:2VC", string0);
  ...
  public void test080()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("y`|jCilz*R$e", "ScriptDataDoubleEscaped");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("Key val must not be null");
      assertEquals("ScriptDataDoubleEscaped", connection_KeyVal0.value());
      assertEquals("y`|jCilz*R$e", connection_KeyVal0.key());
  }
  ...
  public void test081()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      Connection connection1 = connection0.data("application/x-www-form-urlencoded", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", (InputStream) null, "-l9::Q5mttQ1F[W28E");
      connection1.requestBody("multipart/form-data");
      connection1.data("Content-Type", "to");
      try { 
        httpConnection0.post();
  ...
  public void test082()  throws Throwable  {
      ...
      httpConnection0.cookie("Charset must not be null", "0T(EE`ikW ;UVgq:");
      try { 
        connection1.get();
        fail("Expecting exception: IOException");
  ...
  public void test083()  throws Throwable  {
      ...
      connection0.data("application/x-www-form-urlencoded", "application/x-www-form-urlencoded", (InputStream) pipedInputStream0, "fBVP[|2;K");
      try { 
        connection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test086()  throws Throwable  {
      ...
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      hashMap0.put("1&Vk(Im9l[d49RG", linkedList0);
      httpConnection_Response0.processResponseHeaders(hashMap0);
  ...
  public void test089()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(connection_Request0);
      HttpConnection.Response httpConnection_Response1 = httpConnection_Response0.charset("|cuowy;'pb");
      // Undeclared exception!
      try { 
  ...
  public void test092()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      httpConnection0.data("application/x-www-form-urlencoded", "multipart/form-data", (InputStream) null, "##Q8L");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test093()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.URL("https", ">yhs!cftw", 8218, ">yhs!cftw");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test096()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-3641));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test098()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "open");
      try { 
        HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
        fail("Expecting exception: IOException");
  ...
  public void test101()  throws Throwable  {
      ...
      hashMap0.put("application/x-www-form-urlencoded", "/XU/L$HISE[");
  ...
  public void test102()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("URL must not be null", "application/x-www-form-urlencoded");
  ...
  public void test103()  throws Throwable  {
      ...
      httpConnection0.data("Content-Encoding", "referer", (InputStream) sequenceInputStream0);
  ...
  public void test105()  throws Throwable  {
      ...
      stringArray0[1] = "User agent must not be null";
  ...
  public void test108()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("multipart/form-data", ">yhs!cftw");
  ...
  public void test110()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      Connection connection0 = httpConnection0.url(uRL0);
      httpConnection0.data("application/x-www-form-urlencoded", "multipart/form-data", (InputStream) null, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
      try { 
        connection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test112()  throws Throwable  {
      ...
      assertEquals("y`|jCilz*R$e", httpConnection_KeyVal0.key());
      assertEquals("ScriptDataDoubleEscaped", httpConnection_KeyVal0.value());
  }
  ...
  public void test117()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      httpConnection0.data("j;UUzF\"", "j;UUzF\"", (InputStream) byteArrayInputStream0, "2_CV|JZ:5!");
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("j;UUzF\"");
      assertEquals("j;UUzF\"", connection_KeyVal0.value());
      assertEquals("2_CV|JZ:5!", connection_KeyVal0.contentType());
      assertNotNull(connection_KeyVal0);
  }
  ...
  public void test127()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("org.jsoup.select.StructuralEvaluator$Has");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test130()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.removeCookie(">yhs!cftw");
  ...
  public void test137()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("Gk`s`Wx*-P]0%&b>/;", 187);
      assertSame(connection0, httpConnection0);
  }
