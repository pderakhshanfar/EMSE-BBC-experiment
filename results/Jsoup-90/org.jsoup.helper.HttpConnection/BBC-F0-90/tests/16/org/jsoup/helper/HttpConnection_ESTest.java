...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("", 77);
  ...
  public void test007()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("t+^TpQ>|WZq}a");
  ...
  public void test010()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.postDataCharset("FG?!X");
  ...
  public void test014()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.maxBodySize(1912);
      assertEquals(1912, httpConnection_Request0.maxBodySize());
  }
  ...
  public void test018()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "org.jsoup.select.CombiningEvaluator$And");
      httpConnection_KeyVal0.hasInputStream();
      assertEquals("org.jsoup.select.CombiningEvaluator$And", httpConnection_KeyVal0.value());
  ...
  public void test021()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.timeout(1701);
  ...
  public void test023()  throws Throwable  {
      ...
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample?Content-Encoding=m%21%60Q9Y%7Dqyd3Wq8&g%23VC%28P=g%23VC%28P");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "g#VC(P");
      stringArray0[1] = "m!`Q9Y}qyd3Wq8";
      stringArray0[2] = "g#VC(P";
      stringArray0[3] = "g#VC(P";
  ...
  public void test027()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "8c`$|\"y");
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.url(uRL0);
  ...
  public void test029()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("", "qEcO(", 2236, "|D:'", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals("qEcO(", uRL1.getHost());
  }

  @Test(timeout = 4000)
  public void test030()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("", "{!B916&ex", 0, "]OBvpk{3sW'W", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
      assertEquals("{!B916&ex", uRL1.getHost());
  }
  ...
  public void test040()  throws Throwable  {
      ...
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress(inetAddress0, 93);
  ...
  public void test041()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("%wMkMQGj.q3/Y$]s", 1824);
        fail("Expecting exception: NullPointerException");
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("Content-Type", (-2365));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-2365
         //
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("\"kZ6vb>9*43zh&.F(j");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test044()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("6:Ym<OqzM^4yI7v{");
        fail("Expecting exception: NullPointerException");
  ...
  public void test053()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.header("https", "';Hq]k7!hg_eliz*7");
        fail("Expecting exception: NullPointerException");
  ...
  public void test064()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "accept-encoding", (InputStream) pipedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test065()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("%20", "Referer");
        fail("Expecting exception: NullPointerException");
  ...
  public void test074()  throws Throwable  {
      ...
      Connection.Response connection_Response0 = httpConnection_Response0.header("n", "n");
  ...
  public void test075()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "org.jsoup.select.CombiningEvaluator$And");
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream((InputStream) null, 1203);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.inputStream((InputStream) bufferedInputStream0);
      assertEquals("org.jsoup.select.CombiningEvaluator$And", httpConnection_KeyVal1.value());
  ...
  public void test077()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("`cd)<Npxz", "`cd)<Npxz");
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("`cd)<Npxz", string0);
  }
  ...
  public void test079()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("!cN!HL/[,", "!cN!HL/[,");
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("!cN!HL/[,", string0);
  }
  ...
  public void test081()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "application/x-www-form-urlencoded", (InputStream) sequenceInputStream0);
  ...
  public void test083()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.cookie("G", "G");
      URL uRL0 = MockURL.getHttpExample();
      httpConnection0.url(uRL0);
      httpConnection0.cookie("7riF", "7riF");
      try { 
        httpConnection0.post();
  ...
  public void test084()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 376, (byte)113);
      httpConnection0.data("i,l)i`", "9sz~_\"GTD[2", (InputStream) byteArrayInputStream0, "i,l)i`");
      httpConnection0.url(uRL0);
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test092()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.URL("https", "Vx^2TrVUz!wXQoU", 20, "https");
      httpConnection0.url(uRL0);
      httpConnection0.data("&Z<p~?ax<*(Bf.'T", "g#VC(P");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test095()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-2365));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test096()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = httpConnection0.request();
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      httpConnection_Response0.cookie("Ec&.l~S~6;agU^ru)", "olush");
      try { 
        HttpConnection.Response.execute(connection_Request0, httpConnection_Response0);
        fail("Expecting exception: IOException");
  ...
  public void test097()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.header("Referrer must not be null", (String) null);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test099()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Content-Encoding", "6^ y^LtsY");
  ...
  public void test100()  throws Throwable  {
      ...
      httpConnection0.data(stringArray0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("Yk`*OUo>4H+B");
  ...
  public void test101()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "7pioK=&sGsJ", (InputStream) pipedInputStream0);
  ...
  public void test102()  throws Throwable  {
      ...
      stringArray0[1] = "Cookie map must not be null";
      httpConnection0.data(stringArray0);
  ...
  public void test105()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("multipart/form-data", "ruby");
  ...
  public void test106()  throws Throwable  {
      ...
      assertEquals("(>[S=Content-Encoding", string0);
  }

  @Test(timeout = 4000)
  public void test107()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("amkAH<g|UZT$:", "Content-Type", (InputStream) null, "Content-Type");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test109()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "jZQ<?a.!L\")^`");
      httpConnection_KeyVal0.inputStream();
      assertEquals("multipart/form-data", httpConnection_KeyVal0.key());
      assertEquals("jZQ<?a.!L\")^`", httpConnection_KeyVal0.value());
  }
  ...
  public void test116()  throws Throwable  {
      ...
      Connection.Request connection_Request0 = connection0.request();
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(connection_Request0);
      httpConnection_Response0.charset("AfterAttributeValue_quoted");
      // Undeclared exception!
      try { 
        httpConnection_Response0.body();
  ...
  public void test117()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "x:", (InputStream) byteArrayInputStream0, "qg2 @ g0*q0bw_'#");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test118()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("fib", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", 578, "Content-Type", uRLStreamHandler0);
  ...
  public void test121()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.cookie("set-coofie", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36");
        fail("Expecting exception: NullPointerException");
  ...
  public void test124()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[0];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      httpConnection0.data("Content-Type", "Queue not long enough to consume sequence", (InputStream) byteArrayInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("Content-Type");
      assertEquals("Queue not long enough to consume sequence", connection_KeyVal0.value());
      assertNotNull(connection_KeyVal0);
  }
  ...
  public void test129()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.Request httpConnection_Request1 = (HttpConnection.Request)httpConnection_Request0.removeCookie(":-?Z*5p,");
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertTrue(httpConnection_Request1.followRedirects());
      assertEquals(30000, httpConnection_Request1.timeout());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test133()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("UD`OeZ,NsE~X", "GUH'Mp@");
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.data((Connection.KeyVal) httpConnection_KeyVal0);
      assertEquals("GUH'Mp@", httpConnection_KeyVal0.value());
      assertEquals("UD`OeZ,NsE~X", httpConnection_KeyVal0.key());
      assertFalse(httpConnection_Request1.ignoreHttpErrors());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
      assertFalse(httpConnection_Request1.ignoreContentType());
      assertEquals("UTF-8", httpConnection_Request1.postDataCharset());
