...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      httpConnection_Response0.header("set-cookie", "t; U$DO}= ~F{Yr'*k");
  ...
  public void test001()  throws Throwable  {
      ...
      httpConnection0.requestBody("referer");
      // Undeclared exception!
      try { 
        connection0.get();
  ...
  public void test002()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.maxBodySize(187);
  ...
  public void test003()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.referrer("gi5");
  ...
  public void test007()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.requestBody("Referrer must not be null");
  ...
  public void test011()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.postDataCharset("gi5");
  ...
  public void test022()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "Method must not be null");
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.getHttpExample();
  ...
  public void test028()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("multipart/form-data", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", 1322, "accept-encoding", uRLStreamHandler0);
  ...
  public void test029()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL(" KH^6gJb)hDgbBEgt", "Data key value pairs must not be null", 0, "^riZb@^ze?M", uRLStreamHandler0);
      URL uRL1 = HttpConnection.encodeUrl(uRL0);
  ...
  public void test031()  throws Throwable  {
      ...
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0, 986);
      httpConnection0.data("aOJo", "aOJo", (InputStream) pipedInputStream0);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("aOJo");
      assertNotNull(connection_KeyVal0);
      assertEquals("aOJo", connection_KeyVal0.value());
  }
  ...
  public void test042()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy("3i[wp[g-2!!t re7aa", 1048576);
        fail("Expecting exception: NullPointerException");
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.proxy((String) null, (-26));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-26
         //
  ...
  public void test044()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.postDataCharset("1]xYxdVr+fj9");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test055()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.header("Us4r-Agent", "Us4r-Agent");
        fail("Expecting exception: NullPointerException");
  ...
  public void test062()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      httpConnection_Request0.proxy("Content-Type", 1910);
  ...
  public void test067()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data((String) null, "Location", (InputStream) pipedInputStream0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test069()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.data("<bGZLLf;nq8");
        fail("Expecting exception: NullPointerException");
  ...
  public void test073()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("v1/", "UTF-16");
      assertEquals("v1/", httpConnection_KeyVal0.key());
      
      httpConnection_KeyVal0.key("UTF-16");
      assertEquals("UTF-16", httpConnection_KeyVal0.value());
  }
  ...
  public void test074()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.url("Dc43)aUx8}Q!");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Malformed URL: Dc43)aUx8}Q!
         //
         verifyException("org.jsoup.helper.HttpConnection", e);
      }
  }
  ...
  public void test075()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Location", "aU*U5XD:tl*R,");
      ...
      assertEquals("aU*U5XD:tl*R,", httpConnection_KeyVal1.value());
  }
  ...
  public void test076()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("|iOd@E", "|iOd@E", (InputStream) pipedInputStream0);
      HttpConnection.KeyVal httpConnection_KeyVal1 = httpConnection_KeyVal0.value("|iOd@E");
      assertTrue(httpConnection_KeyVal1.hasInputStream());
  }

  @Test(timeout = 4000)
  public void test077()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("gus%zD4LY!,+", "gus%zD4LY!,+");
      String string0 = httpConnection_KeyVal0.key();
      assertEquals("gus%zD4LY!,+", string0);
  }
  ...
  public void test079()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("org.jsoup.internal.Normalizer", "8e7*U37CDe", 106, "_+1#XJ", uRLStreamHandler0);
  ...
  public void test082()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("v1/", "UTF-16");
      Connection.KeyVal connection_KeyVal0 = httpConnection_KeyVal0.contentType("UTF-16");
      assertEquals("v1/", connection_KeyVal0.key());
  ...
  public void test083()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      URL uRL0 = MockURL.getHttpExample();
      URL uRL1 = MockURL.URL(uRL0, "zn*?T[{<T+plQ");
      httpConnection0.url(uRL1);
      httpConnection0.data("zn*?T[{<T+plQ", "zn*?T[{<T+plQ");
      try { 
        httpConnection0.get();
        fail("Expecting exception: IOException");
  ...
  public void test085()  throws Throwable  {
      ...
      httpConnection0.url(uRL0);
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      httpConnection0.data("Content-Type", "Content-Encoding", (InputStream) pipedInputStream0, "Content-Type");
      try { 
        httpConnection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test086()  throws Throwable  {
      ...
      Document document0 = Document.createShell("RNW`<r(na:{]#n");
      Set<String> set0 = document0.classNames();
      List<String> list0 = Locale.filterTags((List<Locale.LanguageRange>) linkedList0, (Collection<String>) set0);
      hashMap0.put("file", list0);
  ...
  public void test092()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      httpConnection0.requestBody("isindex");
  ...
  public void test097()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.header("5@6G}CFanS6", (String) null);
  ...
  public void test098()  throws Throwable  {
      ...
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.url(uRL0);
      connection0.header("Content-Type", "!gZD,qc^5Y");
      try { 
        connection0.post();
        fail("Expecting exception: UnknownServiceException");
  ...
  public void test100()  throws Throwable  {
      ...
      hashMap0.put("multipart/form-data; boundary=", "Content-Type");
  ...
  public void test101()  throws Throwable  {
      ...
      httpConnection0.data("Unhandled content type. Must be text/*, application/xml, or application/xhtml+xml", "vcjx4yhi", (InputStream) mockFileInputStream0);
  ...
  public void test102()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "!PZIp>6PE4mL!");
      ...
      assertEquals("!PZIp>6PE4mL!", httpConnection_KeyVal0.value());
      assertEquals(1048576, httpConnection_Request1.maxBodySize());
  ...
  public void test107()  throws Throwable  {
      ...
      assertEquals("gus%zD4LY!,+=gus%zD4LY!,+", string0);
  }

  @Test(timeout = 4000)
  public void test108()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("Content-Encoding", "kI-AZY9en3<bEr");
      String string0 = httpConnection_KeyVal0.value();
      assertEquals("kI-AZY9en3<bEr", string0);
      assertEquals("Content-Encoding", httpConnection_KeyVal0.key());
  }
  ...
  public void test116()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = httpConnection_Response0.charset("TR3\"<<h8[jY${Fsr");
  ...
  public void test118()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        connection0.cookie("name", "bet]fXCL^nKuqXP1sR");
        fail("Expecting exception: NullPointerException");
  ...
  public void test121()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      httpConnection0.data("InSelectInTable", "Jsd*", (InputStream) null);
      Connection.KeyVal connection_KeyVal0 = httpConnection0.data("InSelectInTable");
      assertNotNull(connection_KeyVal0);
      assertEquals("Jsd*", connection_KeyVal0.value());
  }
  ...
  public void test126()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection0.maxBodySize((-4155));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test127()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HttpConnection.Response httpConnection_Response1 = (HttpConnection.Response)httpConnection_Response0.removeCookie("InCaption");
      assertNull(httpConnection_Response1.contentType());
  }
  ...
  public void test133()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("dPlq`FXKlRF67S!3", 61);
      assertSame(connection0, httpConnection0);
  }
