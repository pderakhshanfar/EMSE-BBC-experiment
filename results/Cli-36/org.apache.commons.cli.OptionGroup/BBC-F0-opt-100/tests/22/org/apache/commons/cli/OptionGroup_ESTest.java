...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("yKs5", true, "~Zwv.Djm(V$j(.#Onv");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("yKs5", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option("yKs5", true, "~Zwv.Djm(V$j(.#Onv");
      optionGroup1.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[--null, -yKs5 ~Zwv.Djm(V$j(.#Onv]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'null' was specified but an option from this group has already been selected: 'yKs5'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
