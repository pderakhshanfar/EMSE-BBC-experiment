...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("0bvd", "", false, "-");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("0bvd", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Option option1 = new Option("m", true, "Ps4c,V5v]rjZG=D/=");
      optionGroup1.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[- , -m Ps4c,V5v]rjZG=D/=]", string0);
  }
  ...
  public void test10()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "");
      Option option1 = new Option("Dz", (String) null, false, " ");
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'Dz'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
