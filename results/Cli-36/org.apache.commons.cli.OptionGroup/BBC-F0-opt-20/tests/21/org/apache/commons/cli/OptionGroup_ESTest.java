...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("N7Z", "");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("N7Z", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "p.FxwKw+g*Dbz");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test06()  throws Throwable  {
      ...
      Option option0 = new Option("N7Z", "");
      optionGroup0.addOption(option0);
      Option option1 = new Option("", "p.FxwKw+g*Dbz");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[-N7Z , - p.FxwKw+g*Dbz]", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Option option0 = new Option("N7Z", "");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("iP1N", "iP1N", false, "N7Z");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'iP1N' was specified but an option from this group has already been selected: 'N7Z'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
