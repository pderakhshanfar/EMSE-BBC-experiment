...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", (String) null, false, "X(vGP\"?V");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "PHs3$?Q>Z!y1");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option("5Wq", true, " ");
      optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- PHs3$?Q>Z!y1, -5Wq  ]", string0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Option option0 = new Option((String) null, "", true, "");
      optionGroup0.setSelected(option0);
      option0.setLongOpt("L]Aop+]pA4^T");
      try { 
        optionGroup0.setSelected(option0);
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'L]Aop+]pA4^T' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
