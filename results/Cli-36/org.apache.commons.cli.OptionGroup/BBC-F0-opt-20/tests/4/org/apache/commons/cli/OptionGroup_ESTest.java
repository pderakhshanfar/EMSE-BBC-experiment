...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("mo41IVl", true, "org.apache.commons.cli.OptionGroup");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("mo41IVl", string0);
  }
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "5C^I8\"");
      optionGroup0.setRequired(true);
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "g%O(k^WD)P!0", true, "");
      optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, (String) null, true, "y?Bqt<yC}xk7iXkDKL");
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[- , --null y?Bqt<yC}xk7iXkDKL]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", false, (String) null);
      Option option1 = new Option((String) null, false, "~1_0sD<)2");
      optionGroup0.setSelected(option0);
      try { 
