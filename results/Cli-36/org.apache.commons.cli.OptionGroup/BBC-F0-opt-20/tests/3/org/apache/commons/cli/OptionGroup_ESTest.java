...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("O7c", true, (String) null);
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("O7c", string0);
  }
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "a A(%aC");
      optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, "e5 XN6xwWS5`j1", true, (String) null);
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[- a A(%aC, --e5 XN6xwWS5`j1]", string0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'e5 XN6xwWS5`j1' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
