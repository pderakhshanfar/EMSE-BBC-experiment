...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("W8J", (String) null, false, "-");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("W8J", string0);
  }
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "g%rR,mman{]-", true, "g%rR,mman{]-");
      optionGroup0.setRequired(true);
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "z{W]foRJ3=GYPp;#");
      optionGroup0.setSelected(option0);
  ...
  public void test09()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "Pd8a,+E/L|", false, "");
      optionGroup0.setSelected(option0);
      optionGroup0.setSelected(option0);
