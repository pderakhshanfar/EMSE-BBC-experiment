...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("uu", "uu", true, (String) null);
  ...
  public void test05()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("uu", "uu", true, (String) null);
      Option option1 = new Option((String) null, "T{CSfRx7;f;J", true, "uu");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      optionGroup1.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[-uu, --T{CSfRx7;f;J uu]", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'T{CSfRx7;f;J' was specified but an option from this group has already been selected: 'uu'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
