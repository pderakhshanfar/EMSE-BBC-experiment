...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "UZe>BC3TXTX");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("TSR", "TSR", false, "TSR");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, false, "[]");
      OptionGroup optionGroup2 = optionGroup1.addOption(option1);
      String string0 = optionGroup2.toString();
      assertEquals("[--null [], -TSR TSR]", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("iJK", "iJK", false, (String) null);
      optionGroup0.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[-iJK]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      optionGroup0.setSelected(option0);
      Option option1 = new Option("iJK", "nl{wuTw=7]");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'iJK' was specified but an option from this group has already been selected: 'd'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
