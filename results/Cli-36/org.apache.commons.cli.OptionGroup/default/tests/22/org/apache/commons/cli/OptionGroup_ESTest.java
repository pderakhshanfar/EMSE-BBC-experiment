...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("8UO4Q", false, "--");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("8UO4Q", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option("F", "G");
      OptionGroup optionGroup0 = new OptionGroup();
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      optionGroup1.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[-F G, -G G]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("OI", false, "OI");
      optionGroup0.setSelected(option0);
      optionGroup0.setSelected(option0);
  ...
  public void test09()  throws Throwable  {
      ...
      Option option0 = new Option("OI", false, "OI");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("r", "r", true, "");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'r' was specified but an option from this group has already been selected: 'OI'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
