...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("b2H", true, "b2H");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("b2H", string0);
  }
  ...
  public void test08()  throws Throwable  {
      Option option0 = new Option("S", "M");
      Option option1 = new Option("M", "S");
      OptionGroup optionGroup0 = new OptionGroup();
      optionGroup0.setSelected(option0);
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'M' was specified but an option from this group has already been selected: 'S'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
