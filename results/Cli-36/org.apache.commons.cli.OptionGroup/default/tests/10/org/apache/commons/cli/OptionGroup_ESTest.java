...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      ...
      Option option0 = new Option("", false, "");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "The addValue method is not intended for client use. Subclasses should use the addValueForProcessing method instead. ", false, "y)&");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'The addValue method is not intended for client use. Subclasses should use the addValueForProcessing method instead. ' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
