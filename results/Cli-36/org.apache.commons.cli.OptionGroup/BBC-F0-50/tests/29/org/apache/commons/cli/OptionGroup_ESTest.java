...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("9l19s1", "The option '");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("9l19s1", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[-9l19s1 The option ']", string0);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "}e8&i*Z34j/&");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("_PoaZq7rapxe6", "");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '_PoaZq7rapxe6' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Option option0 = new Option("", false, "");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option("hV", "[- ]", false, "");
