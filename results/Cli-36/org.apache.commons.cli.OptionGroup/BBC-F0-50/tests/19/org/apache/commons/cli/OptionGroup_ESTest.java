...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("px", "px", true, "");
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      optionGroup0.setRequired(true);
      Option option0 = new Option("tr3tykUY1R", "tr3tykUY1R", true, "tr3tykUY1R");
  ...
  public void test06()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, false, "u<LsYxYg");
      OptionGroup optionGroup2 = optionGroup1.addOption(option1);
      String string0 = optionGroup2.toString();
      assertEquals("[- , --null u<LsYxYg]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("px", "px", true, "px");
      optionGroup0.setSelected(option0);
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'px'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
