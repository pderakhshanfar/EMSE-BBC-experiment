...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "", false, "5QI/.ui=`49");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("", string0);
  }
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "[]", true, "M6jNf\".f");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[--[] M6jNf\".f]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Option option0 = new Option((String) null, "", true, (String) null);
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "D7\"4", true, "");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'D7\"4' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
