...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "!]SKh|.T.@*'xQLk", false, "]");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("!]SKh|.T.@*'xQLk", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "", false, "`:YXeje`OC!");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "", true, "");
      Option option1 = new Option((String) null, false, "' contains an illegal ");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[-- , --null ' contains an illegal ]", string0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      optionGroup0.setSelected(option0);
      optionGroup0.setSelected(option0);
      assertEquals("`:YXeje`OC!", option0.getDescription());
  }
