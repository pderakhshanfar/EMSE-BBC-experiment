...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("w", "NO_ARGS_ALLOWED", true, "w");
  ...
  public void test05()  throws Throwable  {
      ...
      optionGroup0.addOption(option0);
      Option option1 = new Option("NO_ARGS_ALLOWED", (String) null, false, "<s~r1p{$vi65}^WYB");
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[--null, -NO_ARGS_ALLOWED <s~r1p{$vi65}^WYB]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'null' was specified but an option from this group has already been selected: 'NO_ARGS_ALLOWED'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
