...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("b$u", "'", true, (String) null);
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "", true, "3Wt~5W`S*e<UrbC");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "", false, "Tss#+ WA;*ZguQi&lH");
      optionGroup0.setRequired(true);
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("b$u", false, "V");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option("V", "b$u", false, "b$u");
      optionGroup1.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[-b$u V, -V b$u]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Option option0 = new Option("b$u", "'", true, (String) null);
      optionGroup0.setSelected(option0);
      Option option1 = new Option("", true, ")Lk");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'b$u'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
