...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, true, "_qkS:f>");
      optionGroup0.addOption(option0);
      Option option1 = new Option("", true, "");
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[--null _qkS:f>, - ]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'null' was specified but an option from this group has already been selected: '$ReaC'Bh]`p'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      optionGroup0.setSelected(option0);
      optionGroup0.setSelected(option0);
      assertEquals("$ReaC'Bh]`p", optionGroup0.getSelected());
  }
