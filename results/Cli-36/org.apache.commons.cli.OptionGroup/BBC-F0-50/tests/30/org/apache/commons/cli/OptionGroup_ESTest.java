...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "$ReaC'Bh]`p", false, (String) null);
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("$ReaC'Bh]`p", string0);
  }
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", false, "$ReaC'Bh]`p");
      optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, "$ReaC'Bh]`p", false, (String) null);
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- $ReaC'Bh]`p, --$ReaC'Bh]`p]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: '$ReaC'Bh]`p'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
