...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("Fv", "Ax#,~gu^`9-w[ E");
  ...
  public void test08()  throws Throwable  {
      ...
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "Ax#,~gu^`9-w[ E", false, "Ax#,~gu^`9-w[ E");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'Ax#,~gu^`9-w[ E' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
