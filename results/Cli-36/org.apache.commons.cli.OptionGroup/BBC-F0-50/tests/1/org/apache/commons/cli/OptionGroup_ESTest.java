...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("SNRevc0Ch$", true, "(xzP}");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("SNRevc0Ch$", string0);
  }
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("9AfNCU", false, "9AfNCU");
  ...
  public void test05()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "R*KQu4B", true, "");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, "'a", true, "R*KQu4B");
      optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- , --'a R*KQu4B]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Option option0 = new Option("9AfNCU", false, "9AfNCU");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("AHD", "(ua4*`_j<");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'AHD' was specified but an option from this group has already been selected: '9AfNCU'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
