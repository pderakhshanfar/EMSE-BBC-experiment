...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, true, "`Z.6zx5U");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      option0.setLongOpt("");
      optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[-- `Z.6zx5U, -- `Z.6zx5U]", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "9 06_O!]sd3^2|N", true, (String) null);
      optionGroup0.addOption(option0);
  ...
  public void test08()  throws Throwable  {
      ...
      optionGroup0.setSelected(option0);
      Option option1 = new Option("NO_ARGS_ALLOWED", "9 06_O!]sd3^2|N", true, (String) null);
      try { 
