...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("e5S", "O%K %xKW5g^qtt", false, "e5S");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("e5S", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Option option0 = new Option("", false, "6a#3LtN{$K%8j`^");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "6a#3LtN{$K%8j`^");
      try { 
