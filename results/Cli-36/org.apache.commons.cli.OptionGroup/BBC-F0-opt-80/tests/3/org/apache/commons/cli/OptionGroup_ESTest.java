...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("36FcyblfYdM3IU", "");
      optionGroup0.addOption(option0);
      Option option1 = new Option("", "");
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[- , -36FcyblfYdM3IU ]", string0);
  }
  ...
  public void test12()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "3:Sz ]", false, "3:Sz ]");
      Option option1 = new Option("36FcyblfYdM3IU", true, "+_O");
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: '36FcyblfYdM3IU'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
