...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("XX", "", true, (String) null);
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "O*3q@3sIi)j6eyY2c%", false, "O*3q@3sIi)j6eyY2c%");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, " ]", false, "8)t_BwdOg!2");
      optionGroup0.addOption(option1);
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[--null, -- ] 8)t_BwdOg!2]", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "p7|LwK|-NJ~`h", true, "");
      optionGroup0.setSelected(option0);
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option ' ]' was specified but an option from this group has already been selected: 'p7|LwK|-NJ~`h'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
