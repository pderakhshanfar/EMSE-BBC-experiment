...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "yvKk%%8sRWZc::h2");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test05()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", false, "xPTPLK}C9?x:th4V]<");
      optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, false, "r");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- xPTPLK}C9?x:th4V]<, --null r]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "<vw|,)", false, "@n{2gcv!,vD4r%E]z3");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("5r2", "", false, "");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '5r2' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
