...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "NchYxj");
      option0.setLongOpt("_:+Kc;n\"zrs,");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("_:+Kc;n\"zrs,", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      optionGroup0.addOption(option0);
      Option option1 = new Option("A", true, (String) null);
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[-A, -L L]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      optionGroup0.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[--null NchYxj]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'A' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
