...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "^-dnd6}rF|", true, "^-dnd6}rF|");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "9+ew*H", false, "eWq_zyN>");
      optionGroup0.addOption(option0);
      Option option1 = new Option("", false, (String) null);
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[-, --9+ew*H eWq_zyN>]", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "Go170)vRxp(p");
      optionGroup0.setSelected(option0);
      optionGroup0.setSelected(option0);
  ...
  public void test09()  throws Throwable  {
      ...
      Option option0 = new Option("", "Go170)vRxp(p");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "Ktw^T~mDG#l~_|v", true, "");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'Ktw^T~mDG#l~_|v' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
