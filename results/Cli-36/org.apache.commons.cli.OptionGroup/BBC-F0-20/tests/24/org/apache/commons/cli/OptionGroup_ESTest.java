...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("cPNJC", "cPNJC");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("cPNJC", string0);
  }
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "Tlxo");
      optionGroup0.setRequired(true);
  ...
  public void test11()  throws Throwable  {
      ...
      Option option0 = new Option("", "");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("ve_wXi", true, "ve_wXi");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 've_wXi' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
