...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "Cn<I", false, ">Fq4[?91a1emL.%");
      optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, ".8>TefKqyZpVgRIU0");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- >Fq4[?91a1emL.%, --null .8>TefKqyZpVgRIU0]", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Option option0 = new Option("", "");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("$dG", (String) null, false, "0;r'x~-Pl1");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '$dG' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
