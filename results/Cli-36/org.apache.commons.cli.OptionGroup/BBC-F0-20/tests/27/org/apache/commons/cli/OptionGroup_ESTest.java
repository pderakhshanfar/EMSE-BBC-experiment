...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option((String) null, "xfjSQqL:TBF2%~>fN9", true, " ");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("xfjSQqL:TBF2%~>fN9", string0);
  }
  ...
  public void test05()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "cK(>a}", false, "");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, "cK(>a}", false, "[]");
      OptionGroup optionGroup2 = optionGroup1.addOption(option1);
      String string0 = optionGroup2.toString();
      assertEquals("[- , --cK(>a} []]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, true, "}HL1<\"LtJZ");
      try { 
