...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("ZZSp", "ZZSp", true, "s=~f27|d{*ft:u%w");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("ZZSp", string0);
  }
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("K0ay", "sg+iw42t\"XZC]qu", true, "");
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option("", "[-K0ay ]", true, "jg=PbHW");
      OptionGroup optionGroup2 = optionGroup1.addOption(option1);
      String string0 = optionGroup2.toString();
      assertEquals("[- jg=PbHW, -K0ay ]", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "mY<l`:?jr");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[--null mY<l`:?jr]", string0);
  }
