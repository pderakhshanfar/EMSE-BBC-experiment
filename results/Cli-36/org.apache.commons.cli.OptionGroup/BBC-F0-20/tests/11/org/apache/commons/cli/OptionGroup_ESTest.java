...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("Nkd", "gm[6T'2H>", true, "gm[6T'2H>");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("Nkd", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Option option0 = new Option("Nkd", "gm[6T'2H>", true, "gm[6T'2H>");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "Z=0jJXVl7l'");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'null' was specified but an option from this group has already been selected: 'Nkd'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      String string0 = optionGroup1.toString();
      assertEquals("[-Nkd gm[6T'2H>]", string0);
  }
