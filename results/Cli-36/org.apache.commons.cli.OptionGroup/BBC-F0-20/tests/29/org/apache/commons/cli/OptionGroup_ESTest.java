...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("Q0d", "Q0d", false, "Q0d");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("Q0d", string0);
  }
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "=Icy9{=$.g", true, "");
      optionGroup0.setRequired(true);
  ...
  public void test05()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("Q0d", "Q0d", false, "Q0d");
      Option option1 = new Option("", "1oZz", false, "-");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      optionGroup1.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[- -, -Q0d Q0d]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Option option0 = new Option("Q0d", "Q0d", false, "Q0d");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("", "YKQ:IE5,I|");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'Q0d'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
