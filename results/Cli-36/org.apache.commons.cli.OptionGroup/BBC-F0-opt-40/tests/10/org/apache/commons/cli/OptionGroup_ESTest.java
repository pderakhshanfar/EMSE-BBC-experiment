...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("G4Px", "G4Px", true, "G4Px");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("G4Px", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals("[-, -G4Px G4Px]", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "", true, ">pCGZ h'QEN?t4'/");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[-- >pCGZ h'QEN?t4'/]", string0);
  }
  ...
  public void test10()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "8Ngk3{8", true, "");
      optionGroup0.setSelected(option0);
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'i\"' was specified but an option from this group has already been selected: '8Ngk3{8'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
