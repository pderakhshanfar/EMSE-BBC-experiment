...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "uS");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option("mn", "1v2");
      optionGroup1.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[- , -mn 1v2]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, true, "ka>R*wybjK:G R\"^jg ");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[--null ka>R*wybjK:G R\"^jg ]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Option option0 = new Option("", true, "uS");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("ELWwN", "uS", false, "");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'ELWwN' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
