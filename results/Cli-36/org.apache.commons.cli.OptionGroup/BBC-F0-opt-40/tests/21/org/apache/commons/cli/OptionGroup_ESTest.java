...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("d", true, "u'Y,<8'L`NI");
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("fY_", "fY_");
      optionGroup0.setRequired(true);
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "2.)]#vEZz");
      Option option1 = new Option("Y", "-", false, "Y");
      optionGroup0.setSelected(option0);
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'Y' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
