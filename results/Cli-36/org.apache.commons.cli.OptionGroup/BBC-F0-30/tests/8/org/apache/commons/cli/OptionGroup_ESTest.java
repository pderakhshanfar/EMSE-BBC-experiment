...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("oaqr", "oaqr");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("oaqr", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, "", false, "oI/9dxJv ");
      ...
      assertEquals("[--null , -- oI/9dxJv ]", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("rf_DH$", true, (String) null);
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[-rf_DH$]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Option option0 = new Option("oaqr", "oaqr");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("", "iEns");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'oaqr'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
