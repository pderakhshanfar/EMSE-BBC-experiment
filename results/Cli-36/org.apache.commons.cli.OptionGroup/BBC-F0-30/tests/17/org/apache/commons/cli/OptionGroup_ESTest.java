...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("wba", true, "");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("wba", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "L>-+Ue#; bkQF", true, "");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test04()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "H)5");
      optionGroup0.addOption(option0);
      Option option1 = new Option("", "", false, ":FDq=:[$z98");
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[--null H)5, - :FDq=:[$z98]", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Option option1 = new Option("wba", true, "");
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'wba'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
