...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("ydz", false, "[]");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("ydz", string0);
  }
  ...
  public void test05()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", false, "z>=qN");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, "-", false, ";49,i<#");
      optionGroup1.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- z>=qN, --- ;49,i<#]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("ydz", false, "[]");
      Option option1 = new Option("yd", false, "[]");
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'ydz' was specified but an option from this group has already been selected: 'yd'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
