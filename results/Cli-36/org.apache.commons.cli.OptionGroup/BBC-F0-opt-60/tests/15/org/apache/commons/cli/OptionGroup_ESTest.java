...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("n0e", false, "n0e");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("n0e", string0);
  }
  ...
  public void test11()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("8", "8", true, "CMC_`wV.x2G#!5nR@/0");
      Option option1 = new Option("", true, "[-8 CMC_`wV.x2G#!5nR@/0]");
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '8' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
