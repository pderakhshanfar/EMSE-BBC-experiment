...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "xeuQ`-<#Cz9)_#)oj)|");
      option0.setLongOpt("e:.ov:(qot");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("e:.ov:(qot", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "V-[D(G:-Q[dh");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "xeuQ`-<#Cz9)_#)oj)|");
      Option option1 = new Option("", true, "V-[D(G:-Q[dh");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      OptionGroup optionGroup2 = optionGroup1.addOption(option0);
      String string0 = optionGroup2.toString();
      assertEquals("[- V-[D(G:-Q[dh, --null xeuQ`-<#Cz9)_#)oj)|]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "Hy0<IbCRW=3.% XXIk");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "1/;L8!Ev_Py+");
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      optionGroup0.setSelected(option0);
      optionGroup0.setSelected(option0);
      assertEquals("xeuQ`-<#Cz9)_#)oj)|", option0.getDescription());
  }
