...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("ZwOXkP", "ZwOXkP", false, "ZwOXkP");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("ZwOXkP", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Option option0 = new Option("ZwOXkP", "ZwOXkP", false, "ZwOXkP");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("x", false, (String) null);
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'x' was specified but an option from this group has already been selected: 'ZwOXkP'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
