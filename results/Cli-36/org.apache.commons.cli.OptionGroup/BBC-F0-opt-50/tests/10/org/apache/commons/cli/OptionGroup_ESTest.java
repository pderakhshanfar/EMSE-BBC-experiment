...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("ft8", false, "]LL|EK~c");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("ft8", string0);
  }
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("ft8", false, "]LaL|EK~c");
      Option option1 = new Option("@", false, "@");
      optionGroup0.addOption(option0);
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[-@ @, -ft8 ]LaL|EK~c]", string0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'ft8' was specified but an option from this group has already been selected: '@'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
