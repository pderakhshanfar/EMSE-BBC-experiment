...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("tgHIg", "tgHIg");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("tgHIg", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      optionGroup0.addOption(option0);
      Option option1 = new Option("tgHIg", (String) null, true, "-~\"~Q1dy_`BmJ:;M8i8");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- ', -tgHIg -~\"~Q1dy_`BmJ:;M8i8]", string0);
  }
  ...
  public void test09()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "", false, "2)*u2.Mt'x~^Y2");
      optionGroup0.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[-- 2)*u2.Mt'x~^Y2]", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      optionGroup0.setSelected(option0);
      optionGroup0.setSelected(option0);
      assertEquals("tgHIg", optionGroup0.getSelected());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'tgHIg' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
