...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, false, "' was specified but an option from this group ");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[-- --, --null ' was specified but an option from this group ]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Option option0 = new Option("7", true, "7");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("", "has already been selected: '");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: '7'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
