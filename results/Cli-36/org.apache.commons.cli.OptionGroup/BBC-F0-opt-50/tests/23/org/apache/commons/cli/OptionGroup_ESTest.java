...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      Option option1 = new Option("oqMB", true, "[--null]");
      optionGroup1.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[--null, -oqMB [--null]]", string0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Option option0 = new Option("", "", false, "]");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("oqMB", (String) null);
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'oqMB' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
