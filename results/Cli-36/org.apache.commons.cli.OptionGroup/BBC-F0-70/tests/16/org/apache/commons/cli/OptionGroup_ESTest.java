...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("$tWi", "$tWi");
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "KKY", true, (String) null);
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[--KKY]", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "[", true, "ScPd!EKQ4>'");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "ScPd!EKQ4>'", true, "KKY");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'ScPd!EKQ4>'' was specified but an option from this group has already been selected: '['
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
