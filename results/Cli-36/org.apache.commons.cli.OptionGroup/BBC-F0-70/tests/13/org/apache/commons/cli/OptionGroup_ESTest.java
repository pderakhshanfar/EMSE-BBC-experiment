...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option("NO_ARGS_ALLOWED", "2_@");
      optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- , -NO_ARGS_ALLOWED 2_@]", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "VV", false, (String) null);
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "L)tlet*V");
      try { 
