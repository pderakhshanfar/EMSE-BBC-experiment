...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("yR", false, "yR");
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "-6K]GufDig,x_]%.");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, true, "ZD+#}m^a");
      optionGroup1.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[--, --null ZD+#}m^a]", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "9rU_yL~,", true, (String) null);
      optionGroup0.setSelected(option0);
      Option option1 = new Option("", true, ")q).u1`");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: '9rU_yL~,'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals("[- -6K]GufDig,x_]%.]", string0);
  }
