...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("9kt1ngX", "9kt1ngX", true, "9kt1ngX");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("9kt1ngX", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      optionGroup0.addOption(option0);
      option0.setLongOpt("{O%qN((LM ");
      optionGroup0.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[--{O%qN((LM , --{O%qN((LM ]", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Option option0 = new Option("9kt1ngX", "9kt1ngX", true, "9kt1ngX");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("CIwgMy8tbCp", true, "");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'CIwgMy8tbCp' was specified but an option from this group has already been selected: '9kt1ngX'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      optionGroup0.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[-9kt1ngX 9kt1ngX]", string0);
  }
