...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      Option option1 = new Option("kWebuI", false, "}d<ZVId|Lj9oTVM");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      optionGroup1.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[- , -kWebuI }d<ZVId|Lj9oTVM]", string0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'kWebuI' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
