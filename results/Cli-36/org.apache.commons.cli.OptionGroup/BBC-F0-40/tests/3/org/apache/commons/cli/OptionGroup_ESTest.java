...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "Y;.+pIr");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test06()  throws Throwable  {
      ...
      option0.setLongOpt("b9$=!KgQ>}9rL");
      OptionGroup optionGroup2 = optionGroup1.addOption(option0);
      String string0 = optionGroup2.toString();
      assertEquals("[--b9$=!KgQ>}9rL, --b9$=!KgQ>}9rL]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, false, (String) null);
      Option option1 = new Option((String) null, (String) null, true, "=\" v`6e\"|gaV@dnx^I");
      option1.setLongOpt("b9$=!KgQ>}9rL");
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'null' was specified but an option from this group has already been selected: 'b9$=!KgQ>}9rL'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
