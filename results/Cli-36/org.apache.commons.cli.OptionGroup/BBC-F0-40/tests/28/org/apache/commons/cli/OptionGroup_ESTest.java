...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "326w_HVs", true, "u3vM]2");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option("NO_ARGSQALLOWED", (String) null);
      optionGroup1.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- u3vM]2, -NO_ARGSQALLOWED]", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, false, "L>I$1T6;xWx9^4O");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[--null L>I$1T6;xWx9^4O]", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'NO_ARGSQALLOWED'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
