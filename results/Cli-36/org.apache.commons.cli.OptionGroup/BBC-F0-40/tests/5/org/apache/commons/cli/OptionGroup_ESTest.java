...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "W(=<_P9p,wcUc3YI`$Y", false, "W(=<_P9p,wcUc3YI`$Y");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("W(=<_P9p,wcUc3YI`$Y", string0);
  }
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "k7,qP", false, "k7,qP");
      optionGroup0.setSelected(option0);
      optionGroup0.setSelected(option0);
