...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("0", false, "Dgg'Ffy[MLrF%Yi  y[");
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "", true, "fkbM4H^09$y`K^]E");
      optionGroup0.setRequired(true);
  ...
  public void test07()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, true, "KO=tk xX3/Lh9DS]^j");
      optionGroup1.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[- , --null KO=tk xX3/Lh9DS]^j]", string0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Option option0 = new Option("", "", true, "fkbM4H^09$y`K^]E");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("v", true, "fkbM4H^09$y`K^]E");
      try { 
