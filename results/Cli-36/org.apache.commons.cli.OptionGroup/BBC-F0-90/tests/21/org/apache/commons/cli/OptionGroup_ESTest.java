...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("56f", "56f", false, "56f");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("56f", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "obD='Wc^u%m]");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test07()  throws Throwable  {
      ...
      Option option0 = new Option("56f", "56f", false, "56f");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, false, "[-56f 56f]");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'null' was specified but an option from this group has already been selected: '56f'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
