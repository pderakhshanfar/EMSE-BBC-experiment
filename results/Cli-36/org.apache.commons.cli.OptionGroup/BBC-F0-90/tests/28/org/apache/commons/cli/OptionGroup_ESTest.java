...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("RZHob", true, "RZHob");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("RZHob", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Option option0 = new Option("RZHob", true, "RZHob");
      optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, "c)VI|`u`AucY<2&A66");
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[--null c)VI|`u`AucY<2&A66, -RZHob RZHob]", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "[5Woitd2,}AJOBlSvW3", false, (String) null);
      optionGroup0.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[-]", string0);
  }
