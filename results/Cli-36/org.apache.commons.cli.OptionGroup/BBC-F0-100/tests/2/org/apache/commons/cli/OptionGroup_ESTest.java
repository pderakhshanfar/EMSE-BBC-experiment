...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, "Vx4j6T3iNP%`", false, "Vx4j6T3iNP%`");
      optionGroup1.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[-A A, --Vx4j6T3iNP%` Vx4j6T3iNP%`]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'Vx4j6T3iNP%`' was specified but an option from this group has already been selected: 'A'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
