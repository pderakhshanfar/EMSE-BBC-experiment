...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, (String) null, true, "pd4DD:P,kBT s6^`P<");
      optionGroup0.setRequired(true);
  ...
  public void test06()  throws Throwable  {
      ...
      Option option0 = new Option("", "");
      optionGroup0.addOption(option0);
      Option option1 = new Option("yB", "yB");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- , -yB yB]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals("[--null pd4DD:P,kBT s6^`P<]", string0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Option option1 = new Option("yB", (String) null);
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'yB'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
