...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "G)KmH~8RshAi6!DCU", true, "G)KmH~8RshAi6!DCU");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, false, (String) null);
      optionGroup1.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[--null, --G)KmH~8RshAi6!DCU G)KmH~8RshAi6!DCU]", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Option option0 = new Option((String) null, "The option '", true, "The option '");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("D", (String) null, true, (String) null);
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'D' was specified but an option from this group has already been selected: 'The option ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
