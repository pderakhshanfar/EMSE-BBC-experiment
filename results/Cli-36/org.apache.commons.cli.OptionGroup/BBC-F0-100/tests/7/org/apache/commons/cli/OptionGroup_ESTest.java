...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "he\"?O%({&#~Q", false, "Y=le:-O");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("he\"?O%({&#~Q", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, ".y2)W:%~,.~TrkR", true, (String) null);
      optionGroup1.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[--null, --.y2)W:%~,.~TrkR]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'he\"?O%({&#~Q'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, ".y2)W:%~,.~TrkR", true, (String) null);
      optionGroup0.setSelected(option0);
      optionGroup0.setSelected(option0);
