...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "x]*O^e`m#w");
      Option option1 = new Option("NO_ARGS_ALLOWED", "W!{Eq 8-xmypM:", true, "NO_ARGS_ALLOWED");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[- x]*O^e`m#w, -NO_ARGS_ALLOWED NO_ARGS_ALLOWED]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("NO_ARGS_ALLOWED", ".5'JjoA0U9", false, (String) null);
      optionGroup0.setSelected(option0);
