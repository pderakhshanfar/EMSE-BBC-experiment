...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("NO_ARGS_ALLOWED", true, "_/)eV0");
  ...
  public void test07()  throws Throwable  {
      ...
      Option option1 = new Option("", "[-NO_ARGS_ALLOWED _/)eV0]");
      optionGroup1.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- [-NO_ARGS_ALLOWED _/)eV0], -NO_ARGS_ALLOWED _/)eV0]", string0);
  }
  ...
  public void test09()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "It");
      optionGroup0.setSelected(option0);
      optionGroup0.setSelected(option0);
  ...
  public void test11()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "It");
      Option option1 = new Option("It", true, "'GA=RB1Gk");
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'It'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
