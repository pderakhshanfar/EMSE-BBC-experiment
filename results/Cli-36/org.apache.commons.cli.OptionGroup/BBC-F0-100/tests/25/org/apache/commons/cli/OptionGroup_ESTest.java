...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, "", true, "|{bFqqd<Wz");
      optionGroup0.addOption(option1);
      optionGroup0.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[-- |{bFqqd<Wz, -NO_ARGS_ALLOWED  ]", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("jJX4", "8bTWu'");
      option0.setDescription((String) null);
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[-jJX4]", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("b0", false, (String) null);
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'b0' was specified but an option from this group has already been selected: 'E'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
