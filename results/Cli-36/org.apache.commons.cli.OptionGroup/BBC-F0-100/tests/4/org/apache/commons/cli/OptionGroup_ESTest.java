...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      Option option0 = new Option("c", (String) null);
      optionGroup0.addOption(option0);
      Option option1 = new Option("4", true, "c");
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[-c, -4 c]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '4' was specified but an option from this group has already been selected: 'c'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
