...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("rgo", "rgo", false, (String) null);
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("rgo", string0);
  }
  ...
  public void test04()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "");
      Option option1 = new Option((String) null, "!`NF*Cx`X|", true, "!`NF*Cx`X|");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[- , --!`NF*Cx`X| !`NF*Cx`X|]", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Option option0 = new Option("rgo", "rgo", false, (String) null);
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, (String) null, true, "LIDB}q`/1Tof66h");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'null' was specified but an option from this group has already been selected: 'rgo'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
