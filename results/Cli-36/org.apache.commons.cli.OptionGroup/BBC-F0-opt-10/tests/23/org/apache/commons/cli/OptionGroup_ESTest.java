...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      Option option1 = new Option("U0", true, "org.apache.commons.cli.OptionGroup");
      optionGroup1.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[- , -U0 org.apache.commons.cli.OptionGroup]", string0);
  }
  ...
  public void test10()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "_Es`:^N8w#i*L#@");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "_Es`:^N8w#i*L#@", true, (String) null);
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '_Es`:^N8w#i*L#@' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
