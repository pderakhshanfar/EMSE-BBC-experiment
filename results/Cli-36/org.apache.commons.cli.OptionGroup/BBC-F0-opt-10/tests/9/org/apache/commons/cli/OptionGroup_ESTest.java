...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("1e6wh", true, "1e6wh");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("1e6wh", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Option option0 = new Option("", "", true, "");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, false, "d2NB$$k'kgM}veAn");
      try { 
  ...
  public void test12()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      optionGroup0.setRequired(true);
      Option option0 = new Option((String) null, (String) null, true, "S)MS)sYkac");
      optionGroup0.addOption(option0);
