...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "wnJ`", true, "Am(#G>VAr{f9l/ySe$");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("wnJ`", string0);
  }
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      optionGroup0.setRequired(true);
      Option option0 = new Option("", "3\"8wPntz.'kW", false, ">r\"4QL{@bxnDn.w]");
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals("[--null , - >r\"4QL{@bxnDn.w]]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("K3DD0DVoY", "", true, "K3DD0DVoY");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("", "-", true, "K3DD0DVoY");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'K3DD0DVoY'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
