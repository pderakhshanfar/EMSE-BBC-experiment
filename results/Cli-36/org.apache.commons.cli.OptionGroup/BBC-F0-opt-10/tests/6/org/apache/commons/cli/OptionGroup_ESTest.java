...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("4Aql", true, "");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("4Aql", string0);
  }
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      optionGroup0.setRequired(true);
      Option option0 = new Option("", "", false, "~>B?x_M<dc=;R.");
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("1X6", true, "{{89Hj");
      optionGroup0.addOption(option0);
      Option option1 = new Option("JoPXqpo", "JoPXqpo");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[-JoPXqpo JoPXqpo, -1X6 {{89Hj]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Option option0 = new Option("", "4Aql", true, "");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("4Aql", "", false, " :: ");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '4Aql' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
