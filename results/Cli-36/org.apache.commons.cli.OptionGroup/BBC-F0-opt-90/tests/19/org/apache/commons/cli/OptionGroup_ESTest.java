...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "toJeLLtkt");
      optionGroup0.setRequired(true);
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", ", ", false, "o>oQN:U_Zlz^XHi}8d");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, "");
      optionGroup1.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- o>oQN:U_Zlz^XHi}8d, --null ]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", false, "xdu");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("xdu", false, "");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'xdu' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
