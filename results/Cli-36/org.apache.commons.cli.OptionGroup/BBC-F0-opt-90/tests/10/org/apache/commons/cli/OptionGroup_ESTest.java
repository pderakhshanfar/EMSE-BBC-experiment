...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("ZD", true, "");
  ...
  public void test06()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, true, "=O);iH");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      optionGroup1.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- , --null =O);iH]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "Bx_a#Lkq@:L[\"KrQ", true, "Bx_a#Lkq@:L[\"KrQ");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "1xIdTi.vY`vrk<9");
      try { 
