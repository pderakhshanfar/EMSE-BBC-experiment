...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("9Ow_", true, "pcZF=1jwcun{QIXO");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("9Ow_", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Option option1 = new Option("NO_ARGS_ALLOWED", "VI]CS-noo~q");
      optionGroup1.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- , -NO_ARGS_ALLOWED VI]CS-noo~q]", string0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      optionGroup0.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[--null has already been selected: ']", string0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'NO_ARGS_ALLOWED' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
