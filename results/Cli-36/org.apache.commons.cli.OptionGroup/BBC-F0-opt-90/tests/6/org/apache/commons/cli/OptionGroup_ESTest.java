...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, "ChfxDDNhOM7`+", true, (String) null);
      OptionGroup optionGroup2 = optionGroup1.addOption(option1);
      String string0 = optionGroup2.toString();
      assertEquals("[- , --ChfxDDNhOM7`+]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'ChfxDDNhOM7`+' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
