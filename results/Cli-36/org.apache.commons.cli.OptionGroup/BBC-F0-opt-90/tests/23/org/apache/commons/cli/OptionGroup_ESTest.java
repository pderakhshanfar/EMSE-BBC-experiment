...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option("$", "[--null ]", false, "+r'TY");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[--null , -$ +r'TY]", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'null' was specified but an option from this group has already been selected: 'h8Z'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
