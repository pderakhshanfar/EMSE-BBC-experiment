...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("sB", "sB", false, "sB");
      Option option1 = new Option("", "v. ", true, "sB");
      optionGroup0.addOption(option0);
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[- sB, -sB sB]", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Option option0 = new Option("", "", false, ", ");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("s", (String) null, true, "`o^6K%SR2");
      try { 
