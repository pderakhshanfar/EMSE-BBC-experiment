...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", " IIxF", true, " IIxF");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test05()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", " IIxF", true, " IIxF");
      Option option1 = new Option((String) null, "<n(MpvN'Y.!Zgs", false, " IIxF");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      optionGroup1.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[-  IIxF, --<n(MpvN'Y.!Zgs  IIxF]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", false, "Ce,rwQjstkls(D]kIn");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "org.apache.commons.cli.ParseException", false, "");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'org.apache.commons.cli.ParseException' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
