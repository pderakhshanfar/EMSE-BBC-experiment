...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("gzpqLdoasG", "gzpqLdoasG");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("gzpqLdoasG", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "hRc7G:%", true, "");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, "[- ]", true, "[ option:   [ARG] ::  :: class java.lang.String ]");
  ...
  public void test07()  throws Throwable  {
      ...
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "$lm(,.GMxMV37.F ");
      try { 
