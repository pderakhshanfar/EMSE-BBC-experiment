...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("5d", true, "5d");
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option("NO_ARGS_ALLOWED", "[--null []]", true, "NO_ARGS_ALLOWED");
      optionGroup1.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[--null [], -NO_ARGS_ALLOWED NO_ARGS_ALLOWED]", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("nl", "", false, (String) null);
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
