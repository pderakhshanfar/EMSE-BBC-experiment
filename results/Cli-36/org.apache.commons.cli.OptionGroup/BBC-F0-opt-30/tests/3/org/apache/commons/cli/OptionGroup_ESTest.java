...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("wGL", "wGL");
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "");
      Option option1 = new Option((String) null, ">y%XsF1>@T1|(;Z`,", false, "");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      optionGroup1.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[- , -->y%XsF1>@T1|(;Z`, ]", string0);
  }
  ...
  public void test09()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "0VQ!U)_");
      optionGroup0.setSelected(option0);
      optionGroup0.setSelected(option0);
  ...
  public void test11()  throws Throwable  {
      ...
      Option option0 = new Option("", "0VQ!U)_");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "BEJ");
      try { 
