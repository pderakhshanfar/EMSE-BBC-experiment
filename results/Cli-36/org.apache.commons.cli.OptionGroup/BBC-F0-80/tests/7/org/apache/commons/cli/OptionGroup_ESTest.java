...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("ZZF", "ZZF");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("ZZF", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", false, "]c8Z|H??},");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test06()  throws Throwable  {
      ...
      Option option0 = new Option("ZZF", "ZZF");
      optionGroup0.addOption(option0);
      Option option1 = new Option("ScE", false, "ScE");
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[-ScE ScE, -ZZF ZZF]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Option option0 = new Option("ZZF", "ZZF");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "$T{hhV7z", false, "ooLoqNl.%$(k");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '$T{hhV7z' was specified but an option from this group has already been selected: 'ZZF'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
