...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      Option option0 = new Option("", false, "");
      optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, "1M!Vs<<");
      optionGroup0.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[- , --null 1M!Vs<<]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'cy' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
