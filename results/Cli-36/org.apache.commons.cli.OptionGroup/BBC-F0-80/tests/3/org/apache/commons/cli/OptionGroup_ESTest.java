...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("B", "qE%{ T$", true, "[");
  ...
  public void test07()  throws Throwable  {
      ...
      Option option1 = new Option("", "$)@U`*lf~xH#/Q%", true, "B");
  ...
  public void test11()  throws Throwable  {
      ...
      Option option0 = new Option("B", "qE%{ T$", true, "[");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("", "B", true, "W?");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'B'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
