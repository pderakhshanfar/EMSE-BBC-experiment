...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("cTZY", false, "Either opt or longOpt must be specified");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("cTZY", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, true, "LYdx8DeE>Hm]FY");
      optionGroup1.addOption(option1);
      String string0 = optionGroup0.toString();
      assertEquals("[- , --null LYdx8DeE>Hm]FY]", string0);
  }
