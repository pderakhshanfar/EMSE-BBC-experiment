...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "V+s%M$taq6gJVyj9:");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("", string0);
  }
  ...
  public void test05()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("I", true, "!p_b\"/U");
      optionGroup0.addOption(option0);
      Option option1 = new Option("", true, "V+s%M$taq6gJVyj9:");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- V+s%M$taq6gJVyj9:, -I !p_b\"/U]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      optionGroup0.setSelected(option0);
      Option option1 = new Option("SRH", "", false, "");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'SRH' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
