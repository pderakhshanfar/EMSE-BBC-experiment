...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("I", true, "P:<Rk,L8");
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, false, "'Tc");
      optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- , --null 'Tc]", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "n2my c-{fH", true, (String) null);
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      String string0 = optionGroup1.toString();
      assertEquals("[--n2my c-{fH]", string0);
  }
