...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("0vo", "[--null]");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("0vo", string0);
  }
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, (String) null, true, "`w");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      option0.setLongOpt("[ option: ");
      OptionGroup optionGroup2 = optionGroup1.addOption(option0);
      String string0 = optionGroup2.toString();
      assertEquals("[--[ option:  `w, --[ option:  `w]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("UV1dA", "(@zibC*_", false, "jYI..Z+6Q5{$]M<u3V");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("", "1[Z<s<G$|||6{+", true, ",q&fOPr9$+Bo");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '' was specified but an option from this group has already been selected: 'UV1dA'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
