...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      option0.setLongOpt("aionZkjfC$PW-Lg_");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("aionZkjfC$PW-Lg_", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals("[--aionZkjfC$PW-Lg_ [], --aionZkjfC$PW-Lg_ []]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, (String) null, true, "[]");
      Option option1 = new Option((String) null, "K7Yfm:e`B'}", true, "[--null []]");
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'null' was specified but an option from this group has already been selected: 'K7Yfm:e`B'}'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
