...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      Option option1 = new Option("HsJ", "c8");
      optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- q, -HsJ c8]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Option option0 = new Option("", false, "");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("q", false, "Oo& >h-Si5+y&");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'q' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
