...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("gYe", "gYe");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("gYe", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Option option0 = new Option("", "");
      optionGroup0.addOption(option0);
      Option option1 = new Option("m", "m", true, "[]");
  ...
  public void test09()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "N%-9ea", true, "");
      optionGroup0.setSelected(option0);
      optionGroup0.setSelected(option0);
  ...
  public void test11()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("_bq", "_bq");
      Option option1 = new Option("", "_bq", true, "[-_bq _bq]");
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '_bq' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
