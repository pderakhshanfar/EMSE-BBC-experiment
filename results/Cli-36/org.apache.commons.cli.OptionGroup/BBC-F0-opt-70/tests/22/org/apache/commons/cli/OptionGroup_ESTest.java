...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("xznJu", "xznJu", true, "xznJu");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("xznJu", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      optionGroup0.addOption(option0);
      Option option1 = new Option("", false, "8;uo ZZQ\"{>oe2*2");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[--null, - 8;uo ZZQ\"{>oe2*2]", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '0' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
