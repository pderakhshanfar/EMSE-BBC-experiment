...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("soIp", "");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("soIp", string0);
  }
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "");
      Option option1 = new Option("9j", true, "9j");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      OptionGroup optionGroup2 = optionGroup1.addOption(option0);
      String string0 = optionGroup2.toString();
      assertEquals("[- , -9j 9j]", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Option option0 = new Option("soIp", "");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "PMl&2AJ");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'null' was specified but an option from this group has already been selected: 'soIp'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
