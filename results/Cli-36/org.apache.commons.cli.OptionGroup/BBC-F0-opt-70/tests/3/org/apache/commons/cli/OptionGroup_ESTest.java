...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("27", true, "27");
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "fA)[~$d+^+H", true, "");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test06()  throws Throwable  {
      ...
      Option option1 = new Option("h", false, "h");
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, (String) null, false, "uCup8h[isNIb>{,M");
      optionGroup0.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[--null uCup8h[isNIb>{,M]", string0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Option option0 = new Option("", "");
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, "LsC*}tObbiD;?W[{6!");
      try { 
