...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("d", "[ Options: [ short ", true, "TFv0e");
      options0.addOption(option0);
  ...
  public void test10()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption((String) null, "xk.5~#XMATOa'", true, "xk.5~#XMATOa'");
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("P5:-eU C;cM.", true, "^/,peK%RPg*]dM{");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'P5:-eU C;cM.' contains an illegal character : ':'
         //
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("wWw9:P3eg`j)Rv{r", "", false, "U@/e_CEww#G7+@393");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'wWw9:P3eg`j)Rv{r' contains an illegal character : ':'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("&?i7jX4h_\nCtF", "");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '&?i7jX4h_
         // CtF' contains an illegal character : '&'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("d", "[ Options: [ short ", false, "TFv0e");
      Options options1 = options0.addOption(option0);
  ...
  public void test21()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("p4SEE", "p4SEE", true, "p4SEE");
      options0.addOption(option0);
      boolean boolean0 = options0.hasOption("p4SEE");
      assertTrue(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option((String) null, "'", false, "xk.5~#XMATOa'");
      Options options1 = options0.addOption(option0);
      List<String> list0 = options1.getMatchingOptions("A=b]xz\"");
      assertEquals(0, list0.size());
  }
