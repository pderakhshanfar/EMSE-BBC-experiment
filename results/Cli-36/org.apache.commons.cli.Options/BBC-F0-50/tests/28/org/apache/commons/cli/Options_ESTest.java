...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "q8;Ee");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
  ...
  public void test08()  throws Throwable  {
      ...
      Option option0 = new Option("", true, "");
      options0.addOption(option0);
      option0.setArgName("zkgsd#Q*{!FNA[");
      Option option1 = options0.getOption("");
  ...
  public void test09()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "vJBUJ6fq");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      option0.setArgs(0);
      Options options1 = options0.addOptionGroup(optionGroup1);
  ...
  public void test10()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("", " ] [ long ", true, "6gsy?$");
      Option option0 = options0.getOption("");
      assertEquals(1, option0.getArgs());
      assertEquals("6gsy?$", option0.getDescription());
  ...
  public void test11()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption((String) null, "RCT");
  ...
  public void test13()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("J", "C?Kua4tHp@b 6;uKMY", false, "C?Kua4tHp@b 6;uKMY");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("zkgsd#Q*{!FNA[", "zkgsd#Q*{!FNA[", false, "zkgsd#Q*{!FNA[");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'zkgsd#Q*{!FNA[' contains an illegal character : '#'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasLongOption("[%\"%@(3!J");
      assertFalse(boolean0);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      boolean boolean0 = options0.hasOption("C?Kua4tHp@b 6;uKMY");
      assertTrue(boolean0);
  }
  ...
  public void test26()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("J", "C?Kua4tHp@b 6;uKMY", false, "");
      optionGroup0.addOption(option0);
      options0.addOptionGroup(optionGroup0);
  ...
  public void test29()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = options0.getOption("C?Kua4tHp@b 6;uKMY");
      assertNull(option0);
  }
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("KIeAr=5", "[%\"%@(3!J");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'KIeAr=5' contains an illegal character : '='
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test39()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("K", false, "KIeAr=5");
      assertSame(options1, options0);
  }
}
