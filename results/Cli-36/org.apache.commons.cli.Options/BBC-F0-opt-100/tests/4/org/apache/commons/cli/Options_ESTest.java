...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option((String) null, "bN?;|E");
  ...
  public void test08()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("niR", "niR");
      Options options1 = options0.addOption(option0);
      Option option1 = options1.getOption("niR");
      assertFalse(option1.isRequired());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      option0.setArgs(619);
      Option option1 = options1.getOption((String) null);
      assertEquals("bN?;|E", option1.getDescription());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("`p ", false, "org.apache.commons.cli.Options");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption(" [ARG]", "", false, "[ Options: [ short ");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("", "org.apache.commons.cli.Options", true, "Either opt or longOpt must be specified");
  ...
  public void test20()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasLongOption("bN?;|E");
      assertFalse(boolean0);
  }
  ...
  public void test21()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("", "bN?;|E", true, "");
      boolean boolean0 = options0.hasOption("bN?;|E");
      assertTrue(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("", "bN?;|E", true, "");
  ...
  public void test25()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("", "", true, "Ms5B0b2j");
      Options options1 = options0.addOption(option0);
  ...
  public void test26()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = options0.getOption("LO?g");
      assertNull(option0);
  }
  ...
  public void test29()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("", "org.apache.commons.cli.Options", true, "Either opt or longOpt must be specified");
      List<String> list0 = options1.getMatchingOptions("");
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("[ Options: [ short java.util.LinkedHashMap@0000000003 ] [ long {} ]", "bN?;|E");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test37()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption((String) null, true, "mccG?He]|t5H");
