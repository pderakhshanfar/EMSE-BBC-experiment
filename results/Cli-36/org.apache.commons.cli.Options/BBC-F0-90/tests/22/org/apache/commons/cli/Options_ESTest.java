...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("su_j1zL", false, "su_j1zL");
      OptionGroup optionGroup0 = new OptionGroup();
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
  ...
  public void test07()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("NO_ARGS_ALLOWED", "has already been selected: '", false, (String) null);
      option0.setArgName("`m%d4wwc");
      options0.addOption(option0);
  ...
  public void test10()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption((String) null, true, "]6|GE");
  ...
  public void test11()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("L", "AH{", false, "");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("org.apache.commons.cli.AlreadySelectedException", " ] [ long ", true, "org.apache.commons.cli.Util");
  ...
  public void test21()  throws Throwable  {
      ...
      Option option0 = new Option("su_j1zL", false, "su_j1zL");
      options0.addOption(option0);
      boolean boolean0 = options0.hasOption("su_j1zL");
      assertTrue(boolean0);
  }
  ...
  public void test23()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption((String) null, "has already been selected: '", true, "]6|G");
  ...
  public void test24()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("lzTpn", "lzTpn", true, "");
      List<String> list0 = options0.getMatchingOptions("]6|GEither opt or longOpt mustbe specified");
  ...
  public void test27()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("lzTpn", "lzTpn", true, "");
      List<String> list0 = options0.getMatchingOptions("lzTpn");
      assertTrue(list0.contains("lzTpn"));
  }
  ...
  public void test34()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("su_j1zL", "U&p#]OH]y:j4J<n'Iw");
      assertSame(options0, options1);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("6nF:Km_XW->R", true, "su_j1zL");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '6nF:Km_XW->R' contains an illegal character : ':'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
