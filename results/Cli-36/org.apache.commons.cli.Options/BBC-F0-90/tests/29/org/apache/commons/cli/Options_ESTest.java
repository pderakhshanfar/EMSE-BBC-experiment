...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Option option0 = new Option("us", (String) null);
  ...
  public void test03()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("_", "*g`S }?j", true, "kW_");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
  ...
  public void test10()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("", false, "V;@a(&quW~eq|q`z");
  ...
  public void test12()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("A", "[ARG...]", true, "A");
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("~hUhWcUN@R&qh", "org.apache.commons.cli.Util", false, " ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '~hUhWcUN@R&qh' contains an illegal character : '~'
         //
  ...
  public void test17()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption((String) null, "[ARG...]", false, "*p,'$f$P=I_");
  ...
  public void test20()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasLongOption("GC7*Zu$3t^/+js>+v");
      assertFalse(boolean0);
  }
  ...
  public void test21()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("s", "u\"Z", false, "7B7!8-jZ:l/y+sPqbzd");
      optionGroup0.addOption(option0);
      options0.addOptionGroup(optionGroup0);
      boolean boolean0 = options0.hasOption("u\"Z");
      assertTrue(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "RAWyQHFNE=OUF", false, "P|Xs[QB;KcdQW@PD-Y");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Options options1 = options0.addOptionGroup(optionGroup1);
  ...
  public void test26()  throws Throwable  {
      Options options0 = new Options();
      List<String> list0 = options0.getMatchingOptions("GC7*Zu$3t^/+js>+v");
      assertFalse(list0.contains("GC7*Zu$3t^/+js>+v"));
  }
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("V;@a(&'uW~eq|q]z", false, (String) null);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'V;@a(&'uW~eq|q]z' contains an illegal character : ';'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
