...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("__tB7Ir", false, "W9rg|#nFe3{}pxMr:;");
  ...
  public void test04()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("", "`eSe6wB%)pt4;u]", true, "`eSe6wB%)pt4;u]");
  ...
  public void test08()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("x", false, "51;@p");
      options0.addOption(option0);
  ...
  public void test09()  throws Throwable  {
      ...
      Options options1 = options0.addOption(option0);
      option0.setArgs(0);
      Option option1 = options1.getOption("__tB7Ir");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("org.apache.commons.cli.AlreadySelectedException", "O^06-C?", true, "[");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("jvlGB:m{dO(4HNK9x=r", (String) null);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'jvlGB:m{dO(4HNK9x=r' contains an illegal character : ':'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasShortOption("W9rg|#nFe3{}pxMr:;");
  ...
  public void test21()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("ZMDfrQva", "org.apache.commons.cli.Options", true, "");
      Options options1 = options0.addOption(option0);
  ...
  public void test24()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("", "$4%FP8z%}~O", false, "");
  ...
  public void test25()  throws Throwable  {
      ...
      List<String> list0 = options1.getMatchingOptions("51;@p");
      assertEquals(0, list0.size());
  }
  ...
  public void test26()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption((String) null, "", true, "*YEF.19RTdcT?p4+");
      List<String> list0 = options0.getMatchingOptions("");
