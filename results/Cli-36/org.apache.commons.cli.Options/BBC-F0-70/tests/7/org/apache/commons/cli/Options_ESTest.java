...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, ":CZ%<Y@JLAC", false, "");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      options0.addOptionGroup(optionGroup1);
      OptionGroup optionGroup2 = options0.getOptionGroup(option0);
      assertFalse(option0.isRequired());
  ...
  public void test04()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("wyD", "wyD");
      option0.setValueSeparator('q');
      Options options1 = options0.addOption(option0);
      Option option1 = options1.getOption("wyD");
  ...
  public void test08()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("wyD", "d=epbYivQP5<", true, "Illegl option name '");
      Option option0 = options0.getOption("wyD");
      assertNotNull(option0);
      assertEquals("d=epbYivQP5<", option0.getLongOpt());
      assertEquals("Illegl option name '", option0.getDescription());
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("u{_tDGZ;8F", "u{_tDGZ;8F", false, "wyD");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'u{_tDGZ;8F' contains an illegal character : '{'
         //
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("~kcSG", "Z9;fsl5Q$rea@KmTp&");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '~kcSG' contains an illegal character : '~'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasShortOption("4$$Ox#1/Rr$s6");
  ...
  public void test18()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("wyD", "wyD", false, "wyD");
      boolean boolean0 = options1.hasLongOption("wyD");
      assertTrue(boolean0);
  }
  ...
  public void test20()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("wyD", "qAk", true, "qAk");
      boolean boolean0 = options0.hasOption("qAk");
      assertTrue(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("", "wyD", false, "wyD");
      Options options1 = options0.addOption(option0);
      List<String> list0 = options1.getMatchingOptions("--");
      assertTrue(list0.contains("wyD"));
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("", "[ Options: [ short ", false, "[ Options: [ short ");
