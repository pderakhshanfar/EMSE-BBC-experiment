...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("s", true, "+A) .VG%;|8t$.V[O");
  ...
  public void test08()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("C", "C", true, ")[6LO#n0Uv5'");
      Option option0 = options0.getOption("C");
      assertEquals(1, option0.getArgs());
      assertEquals("C", option0.getLongOpt());
      assertEquals(")[6LO#n0Uv5'", option0.getDescription());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("%oT-Ue_&JnpyX~28", (String) null, true, "jbi\"MLvv");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '%oT-Ue_&JnpyX~28' contains an illegal character : '%'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option((String) null, "{Ro.q", false, "n9QAJP;/[}@!#");
      Options options1 = options0.addOption(option0);
  ...
  public void test18()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption((String) null, "C");
  ...
  public void test20()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("w", ")[6LO#n0Uv5'", false, ")^m.+pxg`OZF.!");
      boolean boolean0 = options1.hasLongOption(")[6LO#n0Uv5'");
      assertTrue(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("", ")[6LO#n0Uv5'", false, ")^m.+pxg`ZF!");
  ...
  public void test25()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("w", ")[6LO#n0Uv5'", false, ")^m.+pxg`OZF.!");
  ...
  public void test26()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("C", "C", true, ")[6LO#n0Uv5'");
  ...
  public void test29()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("M", "J< ./0cvp',zL$", false, "M");
      boolean boolean0 = options1.hasOption("J< ./0cvp',zL$");
      assertTrue(boolean0);
  }
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("r\"8dLz|iL*?N%M><ELP*Bp", "ivky6`#A");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'r\"8dLz|iL*?N%M><ELP*Bp' contains an illegal character : '\"'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
