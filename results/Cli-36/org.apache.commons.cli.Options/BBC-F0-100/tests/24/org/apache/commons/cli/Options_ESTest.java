...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("N5S9%m|b", "F* #15|<H.ej52A", false, "a");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'N5S9%m|b' contains an illegal character : '%'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("05`f0%", "[");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '05`f0%' contains an illegal character : '`'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("Gvb", " ] [ long ", false, "Gvb");
  ...
  public void test24()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("Gvb", "Gvb", true, "5J3`BP`kjOx");
