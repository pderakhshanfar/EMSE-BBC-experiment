...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("[ Options: [ short java.util.LinkedHashMap@0000000003 ] [ long {Z=[ option: Z Z  [ARG] ::  :: class java.lang.String ]} ]", "$");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '[ Options: [ short java.util.LinkedHashMap@0000000003 ] [ long {Z=[ option: Z Z  [ARG] ::  :: class java.lang.String ]} ]' contains an illegal character : '['
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Option option0 = new Option("_GW2", "Pe<4dxi(6iIF\"f!n", true, "Pe<4dxi(6iIF\"f!n");
      Options options1 = options0.addOption(option0);
      List<String> list0 = options1.getMatchingOptions("Pe<4dxi(6iIF\"f!n");
