...
public class DeserializationContext_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.annotation.JsonInclude", false, DeserializationContext_ESTest_scaffolding.class.getClassLoader()));
