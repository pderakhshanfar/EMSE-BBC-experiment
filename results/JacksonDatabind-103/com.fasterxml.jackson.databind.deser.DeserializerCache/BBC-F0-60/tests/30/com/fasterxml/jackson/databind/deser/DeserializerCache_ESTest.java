...
public class DeserializerCache_ESTest extends DeserializerCache_ESTest_scaffolding {
  ...
  public void test18()  throws Throwable  {
      ...
      ReferenceType referenceType1 = referenceType0.withContentTypeHandler("hl7WnllF%6&N8T[cO4");
      POJOPropertiesCollector pOJOPropertiesCollector0 = mock(POJOPropertiesCollector.class, new ViolatedAssumptionAnswer());
      doReturn((AnnotatedClass) null).when(pOJOPropertiesCollector0).getClassDef();
      doReturn((MapperConfig) null).when(pOJOPropertiesCollector0).getConfig();
      doReturn((ObjectIdInfo) null).when(pOJOPropertiesCollector0).getObjectIdInfo();
  ...
  public void test29()  throws Throwable  {
      ...
      MappingIterator<DOMDeserializer.DocumentDeserializer> mappingIterator0 = objectMapper0.readValues((JsonParser) jsonParserSequence0, (ResolvedType) arrayType0);
  ...
  public void test36()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      IntNode intNode0 = IntNode.valueOf((-132));
      TypeFactory typeFactory0 = TypeFactory.defaultInstance();
      Class<BeanDeserializer> class0 = BeanDeserializer.class;
      Class<Integer> class1 = Integer.class;
      MapLikeType mapLikeType0 = typeFactory0.constructMapLikeType(class0, class1, class0);
      try { 
        objectMapper0.convertValue((Object) intNode0, (JavaType) mapLikeType0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Cannot find a Value deserializer for type [map-like type; class com.fasterxml.jackson.databind.deser.BeanDeserializer, [simple type, class java.lang.Integer] -> [simple type, class com.fasterxml.jackson.databind.deser.BeanDeserializer]]
