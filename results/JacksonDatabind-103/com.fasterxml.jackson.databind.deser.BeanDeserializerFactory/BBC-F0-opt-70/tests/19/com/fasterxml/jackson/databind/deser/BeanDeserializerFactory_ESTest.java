...
public class BeanDeserializerFactory_ESTest extends BeanDeserializerFactory_ESTest_scaffolding {
  ...
  public void test14()  throws Throwable  {
      ...
      SQLNonTransientConnectionException sQLNonTransientConnectionException0 = new SQLNonTransientConnectionException("&+", "/_", sQLTransientConnectionException0);
      SQLDataException sQLDataException0 = new SQLDataException("), cannot call with() on it", "), cannot call with() on it", (-3248), sQLNonTransientConnectionException0);
      SQLRecoverableException sQLRecoverableException0 = new SQLRecoverableException("), cannot call with() on it", sQLDataException0);
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        beanDeserializerFactory0._validateSubType(defaultDeserializationContext_Impl1, (JavaType) null, (BeanDescription) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      Version version0 = new Version(0, 0, 0, "O6f", "O6f", "O6f");
      SimpleModule simpleModule0 = new SimpleModule(version0);
      Class<DOMDeserializer.NodeDeserializer> class0 = DOMDeserializer.NodeDeserializer.class;
      JsonSerializer<DOMDeserializer.NodeDeserializer> jsonSerializer0 = (JsonSerializer<DOMDeserializer.NodeDeserializer>) mock(JsonSerializer.class, new ViolatedAssumptionAnswer());
      SimpleModule simpleModule1 = simpleModule0.addSerializer((Class<? extends DOMDeserializer.NodeDeserializer>) class0, jsonSerializer0);
