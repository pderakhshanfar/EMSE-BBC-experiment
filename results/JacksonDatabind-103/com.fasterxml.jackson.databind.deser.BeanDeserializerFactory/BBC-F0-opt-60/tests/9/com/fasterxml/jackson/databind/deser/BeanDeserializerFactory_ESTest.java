...
public class BeanDeserializerFactory_ESTest extends BeanDeserializerFactory_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      ObjectMapper objectMapper1 = objectMapper0.enableDefaultTypingAsProperty(objectMapper_DefaultTyping0, "%:]+y1kdMnTZ");
  ...
  public void test05()  throws Throwable  {
      ...
      typeFactory0.constructCollectionLikeType(class2, class2);
      Class<VirtualAnnotatedMember> class3 = VirtualAnnotatedMember.class;
      MapLikeType mapLikeType0 = typeFactory0.constructMapLikeType(class0, class1, class3);
      mapLikeType0.isTypeOrSuperTypeOf(class1);
      BasicClassIntrospector basicClassIntrospector0 = new BasicClassIntrospector();
      mapLikeType0.containedTypeOrUnknown((-429));
      POJOPropertiesCollector pOJOPropertiesCollector0 = mock(POJOPropertiesCollector.class, new ViolatedAssumptionAnswer());
      doReturn((AnnotatedClass) null).when(pOJOPropertiesCollector0).getClassDef();
      doReturn((MapperConfig) null).when(pOJOPropertiesCollector0).getConfig();
      doReturn((ObjectIdInfo) null).when(pOJOPropertiesCollector0).getObjectIdInfo();
  ...
  public void test09()  throws Throwable  {
      ...
      List<BeanPropertyDefinition> list0 = beanDeserializerFactory0.filterBeanProps(deserializationContext0, (BeanDescription) null, beanDeserializerBuilder0, linkedList0, (Set<String>) null);
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        beanDeserializerFactory0.filterBeanProps(defaultDeserializationContext_Impl0, basicBeanDescription0, beanDeserializerBuilder0, linkedList0, treeSet0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      ...
      JavaType javaType0 = beanDeserializerFactory1.materializeAbstractType(defaultDeserializationContext_Impl0, collectionLikeType0, basicBeanDescription0);
