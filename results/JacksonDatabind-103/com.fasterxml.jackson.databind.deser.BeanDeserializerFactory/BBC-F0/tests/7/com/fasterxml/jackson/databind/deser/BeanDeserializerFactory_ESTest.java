...
public class BeanDeserializerFactory_ESTest extends BeanDeserializerFactory_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      typeFactory0.constructMapType((Class<? extends Map>) class0, (JavaType) mapLikeType0, javaType0);
      POJOPropertiesCollector pOJOPropertiesCollector0 = mock(POJOPropertiesCollector.class, new ViolatedAssumptionAnswer());
      doReturn((AnnotatedClass) null).when(pOJOPropertiesCollector0).getClassDef();
      doReturn((MapperConfig) null).when(pOJOPropertiesCollector0).getConfig();
      doReturn((ObjectIdInfo) null).when(pOJOPropertiesCollector0).getObjectIdInfo();
  ...
  public void test07()  throws Throwable  {
      ...
      JsonDeserializer<?> jsonDeserializer0 = beanDeserializerFactory0.findStdDeserializer((DeserializationContext) null, mapType0, (BeanDescription) null);
  ...
  public void test20()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Cannot construct instance of `com.fasterxml.jackson.databind.deser.impl.PropertyBasedObjectIdGenerator` (no Creators, like default construct, exist): no boolean/Boolean-argument constructor/factory method to deserialize from boolean value (true)
