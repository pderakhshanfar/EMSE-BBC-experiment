...
public class SerializerProvider_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.fasterxml.jackson.databind.SerializerProvider"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SerializerProvider_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.annotation.ObjectIdGenerator", false, SerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.io.InputDecorator", false, SerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.io.OutputDecorator", false, SerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.type.TypeReference", false, SerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.JsonSerializer", false, SerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.introspect.POJOPropertiesCollector", false, SerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.ser.BeanSerializerModifier", false, SerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.type.TypeModifier", false, SerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Function", false, SerializerProvider_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SerializerProvider_ESTest_scaffolding.class.getClassLoader()); 
