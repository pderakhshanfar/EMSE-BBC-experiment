...
public class StdValueInstantiator_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.annotation.JsonInclude", false, StdValueInstantiator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.JsonDeserializer", false, StdValueInstantiator_ESTest_scaffolding.class.getClassLoader()));
