...
public class DefaultSerializerProvider_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("com.fasterxml.jackson.core.io.InputDecorator", false, DefaultSerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.io.OutputDecorator", false, DefaultSerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.deser.DeserializationProblemHandler", false, DefaultSerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("java.util.Comparator", false, DefaultSerializerProvider_ESTest_scaffolding.class.getClassLoader()));
  }
