...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        defaultSerializerProvider_Impl0.resolveSubType(resolvedRecursiveType0, "<sYdni:|>");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id '<sYdni:|>' as a subtype of [recursive type; UNRESOLVED: problem: (java.lang.NullPointerException) null
         //
  ...
  public void test03()  throws Throwable  {
      ...
      ResolvedRecursiveType resolvedRecursiveType0 = new ResolvedRecursiveType(class0, (TypeBindings) null);
      JavaType javaType0 = serializerProvider0.resolveSubType(resolvedRecursiveType0, ";QaYm*dns'x");
  ...
  public void test04()  throws Throwable  {
      ...
      JavaType javaType0 = serializerProvider0.resolveSubType(resolvedRecursiveType0, "com.fasterxml.jackson.databind.introspect.AnnotatedClassResolver");
  ...
  public void test11()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      Object object0 = serializerProvider0.getAttribute("Should not call set() on ObjectIdProperty that has no SettableBeanProperty");
      assertNull(object0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      ArrayType arrayType1 = arrayType0.withTypeHandler(defaultDeserializationContext0);
  ...
  public void test23()  throws Throwable  {
      ...
      CollectionLikeType collectionLikeType1 = collectionLikeType0.withValueHandler(pipedReader0);
  ...
  public void test27()  throws Throwable  {
      ...
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._truncate("\"CannoG handle managed/back rjference|'%>': bgck refer*ice type (%) not compatible with manRged type (KFW\"");
      assertEquals("\"CannoG handle managed/back rjference|'%>': bgck refer*ice type (%) not compatible with manRged type (KFW\"", string0);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      try { 
        defaultDeserializationContext_Impl0.setAttribute("", simpleType0);
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.resolveSubType(resolvedRecursiveType0, "TE<");
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      ...
      SimpleType simpleType0 = SimpleType.constructUnsafe(class0);
      try { 
        defaultDeserializationContext_Impl0.reportBadDefinition((JavaType) simpleType0, ".GJ+<");
        fail("Expecting exception: IOException");
  ...
  public void test49()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultSerializerProvider_Impl0)._format("com.fasterxml.jackson.databind.deser.std.AtomicBooleanDeserializer", (Object[]) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test54()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProvider();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._quotedString("CannoG handle managed/back rjference|'%>': bgck refer*ice type (%) not compatible with manRged type (KFW");
      assertEquals("\"CannoG handle managed/back rjference|'%>': bgck refer*ice type (%) not compatible with manRged type (KFW\"", string0);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultSerializerProvider_Impl0)._format("CannoG handle managed/back rjference|'%>': bgck refer*ice type (%) not compatible with manRged type (KFW", objectArray0);
  ...
  public void test57()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultDeserializationContext_Impl0.converterInstance((Annotated) null, object0);
  ...
  public void test63()  throws Throwable  {
      ...
      ResolvedRecursiveType resolvedRecursiveType0 = new ResolvedRecursiveType(class0, (TypeBindings) null);
      try { 
        serializerProvider0.resolveSubType(resolvedRecursiveType0, "com.fasterxml.jackson.databind.introspect.AnnotatedClassResolver");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.introspect.AnnotatedClassResolver' as a subtype of [recursive type; UNRESOLVED: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test64()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType(resolvedRecursiveType0, "R<k8EY^Qri% R_+'%*");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type 'R<k8EY^Qri% R_+'%*' (remaining: '<k8EY^Qri% R_+'%*'): Cannot locate class 'R', problem: R
         //
