...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      try { 
        defaultSerializerProvider_Impl0.resolveSubType(simpleType0, "<B$S^QlJ");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id '<B$S^QlJ' as a subtype of [simple type, class java.util.Locale$Category]: problem: (java.lang.NullPointerException) null
         //
  ...
  public void test03()  throws Throwable  {
      ...
      DatabindContext databindContext0 = serializerProvider0.setAttribute(locale_Category0, "\"org.apache.commons.collections.functors.InvokerTransformer\"");
  ...
  public void test04()  throws Throwable  {
      ...
      ObjectMapper objectMapper0 = new ObjectMapper();
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      JavaType javaType0 = serializerProvider0.resolveSubType(simpleType0, "\"org.apache.commons.collections.functors.InvokerTransformer\"");
  ...
  public void test31()  throws Throwable  {
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._colonConcat("Jb6@S_1", "Jb6@S_1");
      assertEquals("Jb6@S_1: Jb6@S_1", string0);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      try { 
        serializerProvider0.reportBadDefinition((JavaType) simpleType0, "i)A#=1'*3/ip");
        fail("Expecting exception: IOException");
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultSerializerProvider_Impl0)._format("Duplicatedfield '%'' for Ob3ePtNode:bnoc allowed/whee FAIL_ON_READHNG_DUP_bR<E_KE; enabled", objectArray0);
  ...
  public void test53()  throws Throwable  {
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._quotedString("Duplicate field '%s' for ObjectNode:bnot allowed when FAIL_ON_READING_DUP_TREE_KY enabled");
      assertEquals("\"Duplicate field '%s' for ObjectNode:bnot allowed when FAIL_ON_READING_DUP_TREE_KY enabled\"", string0);
  }
  ...
  public void test55()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProviderInstance();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._truncate("qPT2");
      assertEquals("qPT2", string0);
  }
  ...
  public void test62()  throws Throwable  {
      ...
      ArrayType arrayType0 = typeFactory0.constructArrayType(class0);
      try { 
        serializerProvider0.resolveSubType(arrayType0, "com.fasterxml.jackson.databind.util.Converter$None");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.util.Converter$None' as a subtype of [array type, component type: [simple type, class java.time.chrono.ChronoLocalDate]]: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType((JavaType) null, "o<Z");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type 'o<Z' (remaining: '<Z'): Cannot locate class 'o', problem: Class 'o.class' should be in target project, but could not be found!
         //
  ...
  public void test64()  throws Throwable  {
      ...
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      TypeFactory typeFactory0 = TypeFactory.defaultInstance();
      JavaType javaType0 = typeFactory0.constructFromCanonical("com.fasterxml.jackson.databind.util.Converter$None");
      JavaType javaType1 = serializerProvider0.resolveSubType(javaType0, "com.fasterxml.jackson.databind.util.Converter$None");
