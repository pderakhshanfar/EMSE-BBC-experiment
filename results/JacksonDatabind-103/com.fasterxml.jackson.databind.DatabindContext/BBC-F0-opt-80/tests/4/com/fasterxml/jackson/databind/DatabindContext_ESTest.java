...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        defaultSerializerProvider_Impl0.resolveSubType((JavaType) null, "<(;\"ruaHxmK");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id '<(;\"ruaHxmK' as a subtype of null: problem: (java.lang.NullPointerException) null
         //
  ...
  public void test29()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProviderInstance();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._colonConcat("2@Fgf9o%p_rk*%s^']#", "com.fasterxml.jackson.databind.util.SimpleBeanPropertyDefinition");
      assertEquals("2@Fgf9o%p_rk*%s^']#: com.fasterxml.jackson.databind.util.SimpleBeanPropertyDefinition", string0);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.resolveSubType((JavaType) null, "Z@C<mGdZqepm$RGk$");
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      ...
      Class<ObjectIdGenerators.StringIdGenerator> class0 = ObjectIdGenerators.StringIdGenerator.class;
      try { 
        serializerProvider0.reportBadDefinition((Class<?>) class0, "2@Fgfo%p_rk*%s^']#");
        fail("Expecting exception: IOException");
  ...
  public void test33()  throws Throwable  {
      ...
      SimpleType simpleType0 = SimpleType.constructUnsafe(class0);
      try { 
        defaultSerializerProvider_Impl0.reportBadDefinition((JavaType) simpleType0, "expected a digit for number exponent");
        fail("Expecting exception: IOException");
  ...
  public void test34()  throws Throwable  {
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      PropertyName propertyName0 = PropertyName.construct("com.fasterxml.jackson.databind.deser.std.StringArrayDeserializer", "");
  ...
  public void test44()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Class java.time.chrono.MinguoEra not subtype of [simple type, class com.fasterxml.jackson.databind.util.SimpleBeanPropertyDefinition]
         //
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultDeserializationContext_Impl0)._format(":`+EFI", (Object[]) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Class<Object> class0 = Object.class;
      JsonMappingException jsonMappingException0 = defaultDeserializationContext_Impl0.weirdKeyException(class0, (String) null, "Invalid type definition for type %s: %s");
  ...
  public void test52()  throws Throwable  {
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._quotedString("com.fasterxml.jackson.databind.deser.std.StringArrayDeserializer");
      assertEquals("\"com.fasterxml.jackson.databind.deser.std.StringArrayDeserializer\"", string0);
  }
  ...
  public void test54()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProviderInstance();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._truncate("2@Fgf9o%p_rk*%s^']#: com.fasterxml.jackson.databind.util.SimpleBeanPropertyDefinition");
      assertEquals("2@Fgf9o%p_rk*%s^']#: com.fasterxml.jackson.databind.util.SimpleBeanPropertyDefinition", string0);
  }
  ...
  public void test62()  throws Throwable  {
      ...
      JavaType javaType1 = serializerProvider0.resolveSubType(referenceType0, "com.fasterxml.jackson.databind.cfg.ConfigOverride$Empty");
  ...
  public void test63()  throws Throwable  {
      ...
      MapLikeType mapLikeType0 = typeFactory0.constructRawMapLikeType(class0);
      try { 
        serializerProvider0.resolveSubType(mapLikeType0, "com.fasterxml.jackson.databind.util.SimpleBeanPropertyDefinition");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.util.SimpleBeanPropertyDefinition' as a subtype of [map-like type; class java.lang.Integer, [simple type, class java.lang.Object] -> [simple type, class java.lang.Object]]: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test64()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType(collectionLikeType0, "ZnC<mGdZqepm$RGk$");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type 'ZnC<mGdZqepm$RGk$' (remaining: '<mGdZqepm$RGk$'): Cannot locate class 'ZnC', problem: ZnC
         //
