...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        defaultSerializerProvider_Impl0.resolveSubType((JavaType) null, "<r6VGe0{0s+M&;JA?Ny");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id '<r6VGe0{0s+M&;JA?Ny' as a subtype of null: problem: (java.lang.NullPointerException) null
         //
  ...
  public void test02()  throws Throwable  {
      ...
      DatabindContext databindContext0 = serializerProvider0.setAttribute(collectionType0, objectIdGenerators_IntSequenceGenerator0);
  ...
  public void test14()  throws Throwable  {
      ...
      JsonParser jsonParser0 = jsonFactory0.createParser(charArray0, 2382, 2382);
  ...
  public void test29()  throws Throwable  {
      ...
      ObjectMapper objectMapper0 = new ObjectMapper(jsonFactory0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = (DefaultDeserializationContext.Impl)objectMapper0.getDeserializationContext();
      String string0 = ((DatabindContext)defaultDeserializationContext_Impl0)._colonConcat("wybQ+av!n+}&.<", "dFS");
      assertEquals("wybQ+av!n+}&.<: dFS", string0);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      try { 
        serializerProvider0.reportBadDefinition((Class<?>) class0, "hKI{ g<w,7^TWms");
        fail("Expecting exception: IOException");
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        deserializationContext0.getAttribute("n 2r%qX[{uS+aa\"zg");
        fail("Expecting exception: NullPointerException");
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultDeserializationContext_Impl0)._format(";UjFy3JUA", (Object[]) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test52()  throws Throwable  {
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._truncate("Des9rializationProblemHandler.handleMissingInstantiator() for type %s returned value of type %s");
      assertEquals("Des9rializationProblemHandler.handleMissingInstantiator() for type %s returned value of type %s", string0);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultSerializerProvider_Impl0)._format("(OnO'){%[D~w66%", objectArray0);
  ...
  public void test60()  throws Throwable  {
      ...
      try { 
        serializerProvider0.resolveSubType(resolvedRecursiveType0, "com.fasterxml.jackson.databind.ser.impl.PropertyBasedObjectIdGenerator");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.ser.impl.PropertyBasedObjectIdGenerator' as a subtype of [recursive type; UNRESOLVED: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType((JavaType) null, "R<4uL>MLE1*g`eoB\ryp");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type 'R<4uL>MLE1*g`eoB\ryp' (remaining: '<4uL>MLE1*g`eoB\ryp'): Cannot locate class 'R', problem: Class 'R.class' should be in target project, but could not be found!
         //
  ...
  public void test62()  throws Throwable  {
      ...
      Class<Object> class0 = Object.class;
      ResolvedRecursiveType resolvedRecursiveType0 = new ResolvedRecursiveType(class0, typeBindings0);
      JavaType javaType0 = serializerProvider0.resolveSubType(resolvedRecursiveType0, "com.fasterxml.jackson.databind.annotation.JsonPOJOBuilder$Value");
