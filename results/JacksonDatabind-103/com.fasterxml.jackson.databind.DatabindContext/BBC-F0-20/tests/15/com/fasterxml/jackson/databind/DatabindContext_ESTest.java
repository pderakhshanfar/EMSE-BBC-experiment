...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      JavaType javaType0 = TypeFactory.unknownType();
      JavaType javaType1 = serializerProvider0.resolveSubType(javaType0, "FjjzW");
  ...
  public void test27()  throws Throwable  {
      ...
      try { 
        defaultDeserializationContext_Impl0.setAttribute(objectIdGenerators_IntSequenceGenerator0, objectIdGenerators_IntSequenceGenerator0);
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType((JavaType) null, "vh<$lsM");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type 'vh<$lsM' (remaining: '<$lsM'): Cannot locate class 'vh', problem: Class 'vh.class' should be in target project, but could not be found!
         //
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.reportBadDefinition((Class<?>) class0, "_LF,0");
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Class com.fasterxml.jackson.databind.SerializationFeature not subtype of [map type; class java.util.HashMap, [simple type, class java.lang.Object] -> [simple type, class com.fasterxml.jackson.databind.SerializationFeature]]
         //
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultSerializerProvider_Impl0)._format("!6%{P0OE", objectArray0);
  ...
  public void test47()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = (DefaultDeserializationContext.Impl)objectMapper0.getDeserializationContext();
      String string0 = ((DatabindContext)defaultDeserializationContext_Impl0)._colonConcat("j\"nCmE ,Iq", (String) null);
      assertNotNull(string0);
      assertEquals("j\"nCmE ,Iq", string0);
  }
  ...
  public void test50()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProvider();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._quotedString("`r-ou");
      assertEquals("\"`r-ou\"", string0);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      String string0 = ((DatabindContext)defaultDeserializationContext_Impl0)._format("WEAK_MATCH", objectArray0);
      assertEquals("WEAK_MATCH", string0);
  }
  ...
  public void test58()  throws Throwable  {
      ...
      try { 
        serializerProvider0.resolveSubType(mapLikeType0, "com.fasterxml.jackson.databind.jsonFormatVisitors.JsonFormatTypes");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.jsonFormatVisitors.JsonFormatTypes' as a subtype of [map-like type; class com.fasterxml.jackson.databind.type.ResolvedRecursiveType, [simple type, class com.fasterxml.jackson.databind.type.ResolvedRecursiveType] -> [simple type, class com.fasterxml.jackson.databind.type.ResolvedRecursiveType]]: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.resolveSubType(javaType0, "vh<$lsM");
        fail("Expecting exception: NullPointerException");
