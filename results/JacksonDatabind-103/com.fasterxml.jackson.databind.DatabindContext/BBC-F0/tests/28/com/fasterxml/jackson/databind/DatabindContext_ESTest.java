...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        defaultSerializerProvider_Impl0.resolveSubType(referenceType0, "vZL65y&LghtTfTrN>o");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'vZL65y&LghtTfTrN>o' as a subtype of [reference type, class java.lang.String<[Lcom.fasterxml.jackson.annotation.ObjectIdGenerators$IntSequenceGenerator;><[array type, component type: [simple type, class com.fasterxml.jackson.annotation.ObjectIdGenerators$IntSequenceGenerator]]>]: problem: (java.lang.NullPointerException) null
         //
  ...
  public void test04()  throws Throwable  {
      ...
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      JavaType javaType0 = TypeFactory.unknownType();
      JavaType javaType1 = serializerProvider0.resolveSubType(javaType0, "com.fasterxml.jackson.databind.deser.impl.TypeWrappedDeserializer");
  ...
  public void test08()  throws Throwable  {
      ...
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, (-3158), pipedReader0, objectReader0, charsToNameCanonicalizer0, charArray0, 0, 2, true);
  ...
  public void test11()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      IntNode intNode0 = new IntNode(3037);
      ObjectReader objectReader0 = objectMapper0.readerForUpdating(intNode0);
      JsonFactory jsonFactory0 = new JsonFactory();
      char[] charArray0 = new char[7];
      JsonParser jsonParser0 = jsonFactory0.createParser(charArray0, 2366, 27);
  ...
  public void test22()  throws Throwable  {
      ...
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._format("Q oI", objectArray0);
      assertEquals("Q oI", string0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType(collectionLikeType0, " Qk+ p<^");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type 'Qk+ p<^' (remaining: '<^'): Cannot locate class 'Qk+ p', problem: Class 'Qk+ p.class' should be in target project, but could not be found!
         //
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultDeserializationContext_Impl0.reportBadDefinition((Class<?>) class0, "$yqf6M3kOQ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      try { 
        defaultSerializerProvider_Impl0.reportBadDefinition((JavaType) null, "com.fasterxml.jackson.databind.ext.NioPathDeserializer");
        fail("Expecting exception: IOException");
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultSerializerProvider_Impl0)._format("H<<5%83P*pv3%", objectArray0);
  ...
  public void test51()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      PropertyName propertyName0 = PropertyName.construct("x'z~TuR!3e(L}", "com.fasterxml.jackson.databind.PropertyNamingStrategy$PropertyNamingStrategyBase");
  ...
  public void test53()  throws Throwable  {
      ...
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      JavaType javaType0 = TypeFactory.unknownType();
      JavaType javaType1 = serializerProvider0.resolveSubType(javaType0, "com.fasterxml.jackson.databind.util.JSONPObject");
      Class<IsoEra> class0 = IsoEra.class;
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Class java.time.chrono.IsoEra not subtype of [simple type, class com.fasterxml.jackson.databind.util.JSONPObject]
         //
  ...
  public void test54()  throws Throwable  {
      ...
      try { 
        serializerProvider0.resolveSubType(arrayType0, "com.fasterxml.jackson.databind.util.JSONPObject");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.util.JSONPObject' as a subtype of [array type, component type: [recursive type; UNRESOLVED]: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.resolveSubType(collectionLikeType0, " Qk+ p<^");
        fail("Expecting exception: NullPointerException");
  ...
  public void test56()  throws Throwable  {
      ...
      Class<TypeIdResolver> class0 = TypeIdResolver.class;
      JavaType javaType0 = serializerProvider0.constructType(class0);
      JavaType javaType1 = serializerProvider0.resolveSubType(javaType0, "=z ;ga");
