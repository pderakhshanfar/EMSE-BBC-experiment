...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      DatabindContext databindContext0 = serializerProvider0.setAttribute("", objectIdGenerators_StringIdGenerator0);
  ...
  public void test13()  throws Throwable  {
      ...
      CollectionType collectionType2 = collectionType1.withContentTypeHandler("^!Y-O .YLc_X");
  ...
  public void test24()  throws Throwable  {
      ...
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._truncate("Invalid definition for property %s (of type %s): %s");
      assertEquals("Invalid definition for property %s (of type %s): %s", string0);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType((JavaType) null, "FQ<");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type 'FQ<' (remaining: '<'): Cannot locate class 'FQ', problem: Class 'FQ.class' should be in target project, but could not be found!
         //
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultSerializerProvider_Impl0)._format("ip%tHu$Z5ebO7j", objectArray0);
        fail("Expecting exception: IllegalFormatConversionException");
      
      } catch(IllegalFormatConversionException e) {
         //
         // H != com.fasterxml.jackson.databind.deser.std.StdKeyDeserializers
         //
  ...
  public void test60()  throws Throwable  {
      ...
      try { 
        serializerProvider0.resolveSubType(mapType0, "com.fasterxml.jackson.databind.introspect.AnnotationCollector$TwoAnnotations");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.introspect.AnnotationCollector$TwoAnnotations' as a subtype of [map type; class java.util.HashMap, [simple type, class com.fasterxml.jackson.databind.deser.SettableBeanProperty] -> [simple type, class com.fasterxml.jackson.databind.deser.SettableBeanProperty]]: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.resolveSubType(simpleType0, "'}6=(Eb*(\"<zAJX{F");
        fail("Expecting exception: NullPointerException");
