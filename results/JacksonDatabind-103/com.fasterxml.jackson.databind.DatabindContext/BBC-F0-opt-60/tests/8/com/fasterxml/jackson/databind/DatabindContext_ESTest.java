...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        defaultSerializerProvider_Impl0.resolveSubType(simpleType0, "<h[(");
  ...
  public void test02()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      DatabindContext databindContext0 = serializerProvider0.setAttribute("#[yZ;^q!N:>r", objectMapper0);
  ...
  public void test03()  throws Throwable  {
      ...
      SimpleType simpleType0 = SimpleType.constructUnsafe(class0);
      JavaType javaType0 = serializerProvider0.resolveSubType(simpleType0, "problem: (%s) %s");
  ...
  public void test04()  throws Throwable  {
      ...
      JavaType javaType1 = serializerProvider0.resolveSubType(javaType0, "com.fasterxml.jackson.databind.deser.BuilderBasedDeserializer");
  ...
  public void test20()  throws Throwable  {
      ...
      JsonFactory jsonFactory0 = new JsonFactory();
      File file0 = MockFile.createTempFile("v90>zw", "JSON");
  ...
  public void test26()  throws Throwable  {
      ...
      Class<FormatStyle> class1 = FormatStyle.class;
      MapType mapType0 = typeFactory0.constructMapType(class0, class1, class1);
      MapType mapType1 = mapType0.withValueHandler("Trailing token (of tjD  %s) found after value (bou=d /s %s): not aonowed as per `DeserializationFeature.FAIL_ON_TRAILING_TOKENS`");
  ...
  public void test29()  throws Throwable  {
      ...
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._truncate("A class must be provided");
      assertEquals("A class must be provided", string0);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._format("w\"t", objectArray0);
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.reportBadDefinition((Class<?>) class0, "JS`");
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      JsonMappingException jsonMappingException0 = defaultSerializerProvider_Impl0.invalidTypeIdException((JavaType) null, "r8@8gYK=%io[n241/$", (String) null);
  ...
  public void test54()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProviderInstance();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._quotedString(")~6Z y+1HI>U$|6e");
      assertEquals("\")~6Z y+1HI>U$|6e\"", string0);
  }
  ...
  public void test62()  throws Throwable  {
      ...
      JavaType javaType0 = serializerProvider0.constructType(class0);
      try { 
        serializerProvider0.resolveSubType(javaType0, "com.fasterxml.jackson.databind.jsonFormatVisitors.JsonFormatTypes");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.jsonFormatVisitors.JsonFormatTypes' as a subtype of [collection type; class java.util.Vector, contains [simple type, class java.lang.Object]]: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType(collectionType0, "#b<S6d'k=UK");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type '#b<S6d'k=UK' (remaining: '<S6d'k=UK'): Cannot locate class '#b', problem: #b
         //
  ...
  public void test66()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Class com.fasterxml.jackson.databind.JsonDeserializer not subtype of [recursive type; UNRESOLVED
         //
  ...
  public void test68()  throws Throwable  {
      ...
      try { 
        serializerProvider0.reportBadDefinition((Class<?>) class0, "com.fasterxml.jackson.databind.introspect.JacksonAnnotationIntrospector");
        fail("Expecting exception: IOException");
