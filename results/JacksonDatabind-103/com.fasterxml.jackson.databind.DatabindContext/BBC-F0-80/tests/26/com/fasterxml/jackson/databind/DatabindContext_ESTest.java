...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        defaultSerializerProvider_Impl0.resolveSubType((JavaType) null, "</A5:;L4a2Z5Y");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id '</A5:;L4a2Z5Y' as a subtype of null: problem: (java.lang.NullPointerException) null
         //
  ...
  public void test18()  throws Throwable  {
      ...
      ArrayType arrayType0 = ArrayType.construct((JavaType) placeholderForType0, typeBindings0, (Object) namedType0, (Object) classNameIdResolver0);
      ...
      Class<?> class2 = valueInstantiator_Base0.getValueClass();
  ...
  public void test20()  throws Throwable  {
      ...
      MapLikeType mapLikeType0 = mapType0.withTypeHandler(objectIdResolver0);
  ...
  public void test22()  throws Throwable  {
      ...
      ReferenceType referenceType1 = ReferenceType.construct((Class<?>) class0, typeBindings0, (JavaType) arrayType0, javaTypeArray0, javaTypeArray0[5]);
  ...
  public void test24()  throws Throwable  {
      ...
      javaTypeArray0[5] = (JavaType) referenceType0;
      ReferenceType referenceType1 = ReferenceType.construct((Class<?>) class0, typeBindings0, (JavaType) arrayType0, javaTypeArray0, javaTypeArray0[5]);
      SimpleType simpleType1 = referenceType1.withValueHandler(arrayType0);
  ...
  public void test28()  throws Throwable  {
      ...
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._format("~fGK}o>=~~V0!_l@KK", objectArray0);
      assertEquals("~fGK}o>=~~V0!_l@KK", string0);
  }
  ...
  public void test32()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProvider();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._colonConcat((String) null, "; expected Class<Converter>");
      assertEquals("null: ; expected Class<Converter>", string0);
  ...
  public void test48()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Class com.fasterxml.jackson.databind.Module not subtype of [array type, component type: [simple type, class com.fasterxml.jackson.databind.module.SimpleModule]]
         //
  ...
  public void test55()  throws Throwable  {
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._quotedString("Argumentz#%d of factory method %s has no property name annotation; mu$t have name when multiple-parameter constructor annotated as Creator");
      assertEquals("\"Argumentz#%d of factory method %s has no property name annotation; mu$t have name when multiple-parameter constructor annotated as Creator\"", string0);
  }
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultSerializerProvider_Impl0)._format("Argumentz#%= of factoryDmethLd %sUhas no S(ope^>y(nLSk annotation; mu$t have naml when \"=l$iple>parameUer crnstruc+Pr vnnotj ed s CreatoB", objectArray0);
  ...
  public void test59()  throws Throwable  {
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Float float0 = new Float(1417.42F);
      Class<String> class0 = String.class;
      Object[] objectArray0 = new Object[0];
      // Undeclared exception!
      try { 
        defaultDeserializationContext_Impl0.handleWeirdNumberValue(class0, float0, "com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$DelegatingKD", objectArray0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test64()  throws Throwable  {
      ...
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      JavaType javaType0 = TypeFactory.unknownType();
      JavaType javaType1 = serializerProvider0.resolveSubType(javaType0, "com.fasterxml.jackson.databind.deser.std.MapEntryDeserializer");
  ...
  public void test65()  throws Throwable  {
      ...
      try { 
        serializerProvider0.resolveSubType(mapType0, "com.fasterxml.jackson.core.filter.TokenFilter");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.core.filter.TokenFilter' as a subtype of [map type; class java.lang.String, [array type, component type: [simple type, class java.lang.String]] -> [array type, component type: [simple type, class java.lang.String]]]: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test66()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType(resolvedRecursiveType0, "3]u<=O9)/TE?2QVy>@)");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type '3]u<=O9)/TE?2QVy>@)' (remaining: '<=O9)/TE?2QVy>@)'): Cannot locate class '3]u', problem: Class '3]u.class' should be in target project, but could not be found!
         //
