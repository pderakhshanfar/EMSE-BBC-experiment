...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        defaultDeserializationContext_Impl0.resolveSubType((JavaType) null, "<=K5O;Zl\"LX@I.t8");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id '<=K5O;Zl\"LX@I.t8' as a subtype of null: problem: (java.lang.NullPointerException) null
         //
  ...
  public void test03()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl1 = (DefaultDeserializationContext.Impl)defaultDeserializationContext_Impl0.setAttribute(objectReader0, objectIdGenerators_StringIdGenerator0);
  ...
  public void test19()  throws Throwable  {
      ...
      MapLikeType mapLikeType0 = mapType1.withKeyType(javaType0);
      MapLikeType mapLikeType1 = mapLikeType0.withValueHandler(mapType1);
  ...
  public void test23()  throws Throwable  {
      ...
      MapLikeType mapLikeType1 = mapLikeType0.withKeyTypeHandler(defaultSerializerProvider_Impl0);
  ...
  public void test28()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProvider();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._colonConcat("Lk,.FSSCDll0", "[N/A]");
      assertEquals("Lk,.FSSCDll0: [N/A]", string0);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.resolveSubType((JavaType) null, "QKt<*gL*`unZ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.reportBadDefinition((Class<?>) class0, "P-oblem detemining whether filter of type '%s' should filter out `null` values: (%s) %s");
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultSerializerProvider_Impl0)._format("`O@%zpyzKSU7b|ZIa", objectArray0);
  ...
  public void test53()  throws Throwable  {
      ...
      ObjectMapper objectMapper0 = new ObjectMapper(jsonFactory0);
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProvider();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._truncate("com.fasterxml.jackson.databind.type.SimpleType");
  ...
  public void test61()  throws Throwable  {
      ...
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      JavaType javaType0 = TypeFactory.unknownType();
      JavaType javaType1 = serializerProvider0.resolveSubType(javaType0, "com.fasterxml.jackson.databind.PropertyNamingStrategy$LowerCaseStrategy");
      assertFalse(javaType1.isArrayType());
  }
  ...
  public void test62()  throws Throwable  {
      ...
      try { 
        serializerProvider0.resolveSubType(arrayType0, "com.fasterxml.jackson.databind.util.TokenBuffer");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.util.TokenBuffer' as a subtype of [array type, component type: [simple type, class com.fasterxml.jackson.annotation.SimpleObjectIdResolver]]: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType((JavaType) null, "d<c-Zp@(q#4#}");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type 'd<c-Zp@(q#4#}' (remaining: '<c-Zp@(q#4#}'): Cannot locate class 'd', problem: Class 'd.class' should be in target project, but could not be found!
         //
  ...
  public void test66()  throws Throwable  {
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      try { 
        defaultSerializerProvider_Impl0.reportBadDefinition((Class<?>) null, "oW`G\"}mMk;q$|vS$*");
        fail("Expecting exception: IOException");
