...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        deserializationContext0.resolveSubType((JavaType) null, "<kIz99d)[");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id '<kIz99d)[' as a subtype of null: problem: (java.lang.NullPointerException) null
         //
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        defaultSerializerProvider_Impl0.resolveSubType((JavaType) null, "com.fasterxml.jackson.databind.deser.impl.ExternalTypeHandler");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.deser.impl.ExternalTypeHandler' as a subtype of null: problem: (java.lang.NullPointerException) null
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      ...
      JavaType javaType0 = serializerProvider0.resolveSubType(collectionLikeType0, "com.fasterxml.jackson.core.json.UTF8DataInputJsonParser");
  ...
  public void test20()  throws Throwable  {
      ...
      JavaType javaType0 = TypeFactory.unknownType();
      ArrayType arrayType0 = ArrayType.construct(javaType0, typeBindings0, (Object) class0, (Object) "BiC");
  ...
  public void test31()  throws Throwable  {
      ...
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProviderInstance();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._format("AnnotationIntrospector returned Class ", jsonParser_FeatureArray0);
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType((JavaType) null, "(<Bv<$,#a");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type '(<Bv<$,#a' (remaining: '<Bv<$,#a'): Cannot locate class '(', problem: Class '(.class' should be in target project, but could not be found!
         //
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.reportBadDefinition((Class<?>) class0, "H$&SUnO?p]vLaIn");
        fail("Expecting exception: NullPointerException");
  ...
  public void test47()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Class com.fasterxml.jackson.databind.type.ResolvedRecursiveType not subtype of [simple type, class byte]
         //
  ...
  public void test52()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProvider();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._colonConcat("11BMt$Z{)*/-u[gs*", (String) null);
      assertNotNull(string0);
      assertEquals("11BMt$Z{)*/-u[gs*", string0);
  }
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.converterInstance((Annotated) null, baseSettings0);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // AnnotationIntrospector returned Converter definition of type com.fasterxml.jackson.databind.cfg.BaseSettings; expected type Converter or Class<Converter> instead
         //
         verifyException("com.fasterxml.jackson.databind.DatabindContext", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      ...
      CollectionLikeType collectionLikeType0 = typeFactory0.constructRawCollectionLikeType(class0);
      try { 
        serializerProvider0.resolveSubType(collectionLikeType0, "com.fasterxml.jackson.core.json.UTF8DataInputJsonParser");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.core.json.UTF8DataInputJsonParser' as a subtype of [collection-like type; class com.fasterxml.jackson.databind.Module, contains [simple type, class java.lang.Object]]: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test64()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.resolveSubType((JavaType) null, "n(<Bv<B,#a");
        fail("Expecting exception: NullPointerException");
