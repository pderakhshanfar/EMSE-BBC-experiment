...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      PropertyName propertyName0 = new PropertyName("z:Cv5m", "z:Cv5m");
  ...
  public void test15()  throws Throwable  {
      ...
      ReferenceType referenceType0 = ReferenceType.construct(class3, (TypeBindings) null, javaTypeArray0[0], javaTypeArray0, javaTypeArray0[0]);
  ...
  public void test21()  throws Throwable  {
      ...
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      JavaType javaType0 = defaultSerializerProvider_Impl0.constructSpecializedType(javaTypeArray0[0], class1);
  ...
  public void test22()  throws Throwable  {
      ...
      SimpleType simpleType0 = SimpleType.constructUnsafe(class0);
      SimpleType simpleType1 = simpleType0.withValueHandler("com.fasterxml.jackson.databind.PropertyNamingStrat{8y$LowerCaseWithUnderscoresStrategy");
  ...
  public void test24()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProviderInstance();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._truncate("nSYL~dp>P\"(Tdsb");
      assertEquals("nSYL~dp>P\"(Tdsb", string0);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._format("Failed to specialize base type ", objectArray0);
      assertEquals("Failed to specialize base type ", string0);
  }
  ...
  public void test28()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProviderInstance();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._colonConcat("wUQ)zhlY$", (String) null);
      assertNotNull(string0);
      assertEquals("wUQ)zhlY$", string0);
  }
  ...
  public void test32()  throws Throwable  {
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      try { 
        defaultSerializerProvider_Impl0.reportBadDefinition((JavaType) null, "dZh G8>-x&Gl'e[o5{b");
        fail("Expecting exception: IOException");
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultSerializerProvider_Impl0)._format("#d!L0%6Gf@j0`X", objectArray0);
  ...
  public void test53()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultSerializerProvider_Impl0)._format("J2%{',L9j_g", objectArray0);
  ...
  public void test60()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.ser.std.StaticListSerializerBase' as a subtype of [collection type; class java.util.List, contains [simple type, class java.lang.Object]]: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType(javaType0, "+<n()");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type '+<n()' (remaining: '<n()'): Cannot locate class '+', problem: Class '+.class' should be in target project, but could not be found!
         //
  ...
  public void test62()  throws Throwable  {
      ...
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      JavaType javaType0 = TypeFactory.unknownType();
      JavaType javaType1 = serializerProvider0.resolveSubType(javaType0, "com.fasterxml.jackson.databind.ser.std.StaticListSerializerBase");
      assertFalse(javaType1.isPrimitive());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      try { 
        serializerProvider0.reportBadDefinition((Class<?>) class0, "Mc");
        fail("Expecting exception: IOException");
