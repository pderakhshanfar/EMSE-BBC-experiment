...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        defaultSerializerProvider_Impl0.resolveSubType(javaType0, "<KauC)_hw$>9rENuy");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id '<KauC)_hw$>9rENuy' as a subtype of [simple type, class java.lang.Object]: problem: (java.lang.NullPointerException) null
         //
  ...
  public void test02()  throws Throwable  {
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      try { 
        defaultSerializerProvider_Impl0.resolveSubType((JavaType) null, "Failed to narrow value type of %s with concrete-type }nnotation (value %s), from '%s': %s");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'Failed to narrow value type of %s with concrete-type }nnotation (value %s), from '%s': %s' as a subtype of null: problem: (java.lang.NullPointerException) null
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test03()  throws Throwable  {
      ...
      DatabindContext databindContext0 = serializerProvider0.setAttribute(floatNode0, jsonFactory0);
  ...
  public void test04()  throws Throwable  {
      ...
      JavaType javaType0 = serializerProvider0.resolveSubType(mapLikeType0, "v8vG6]~[^\"f']m24\"B");
  ...
  public void test16()  throws Throwable  {
      ...
      SimpleType simpleType0 = referenceType1.withValueHandler(hijrahEra0);
  ...
  public void test18()  throws Throwable  {
      ...
      MapLikeType mapLikeType0 = mapType0.withContentTypeHandler(namedType0);
  ...
  public void test28()  throws Throwable  {
      ...
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._format("Internal error: this code path should never get eecuted", objectArray0);
      assertEquals("Internal error: this code path should never get eecuted", string0);
  }
  ...
  public void test31()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = (DefaultDeserializationContext.Impl)objectMapper0.getDeserializationContext();
      String string0 = ((DatabindContext)defaultDeserializationContext_Impl0)._colonConcat("JSON", "^D");
      assertEquals("JSON: ^D", string0);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.resolveSubType(javaType0, "3s<NT8ID");
        fail("Expecting exception: NullPointerException");
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ((DatabindContext)defaultSerializerProvider_Impl0)._format("n1ux1K {gt<%vJ K+Cs", objectArray0);
  ...
  public void test61()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType(javaType0, "t<j[iB.#-`Rm>V ]8v");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type 't<j[iB.#-`Rm>V ]8v' (remaining: '<j[iB.#-`Rm>V ]8v'): Cannot locate class 't', problem: Class 't.class' should be in target project, but could not be found!
         //
  ...
  public void test62()  throws Throwable  {
      ...
      try { 
        serializerProvider0.resolveSubType(resolvedRecursiveType0, "com.fasterxml.jackson.databind.ser.std.StdArraySerializers$TypedPrimitiveArraySerializer");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.ser.std.StdArraySerializers$TypedPrimitiveArraySerializer' as a subtype of [recursive type; UNRESOLVED: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test64()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Class java.lang.String not subtype of [map type; class java.util.HashMap, [simple type, class java.lang.Object] -> [simple type, class java.lang.Object]]
         //
  ...
  public void test66()  throws Throwable  {
      ...
      try { 
        serializerProvider0.reportBadDefinition((Class<?>) class0, "com.fasterxml.jackson.databind.JsonNode");
        fail("Expecting exception: IOException");
