...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      PropertyName propertyName0 = new PropertyName("", "3CY?4F/ShFxJ");
  ...
  public void test11()  throws Throwable  {
      ...
      serializerProvider0.setAttribute("com.fasterxml.jackson.annotation.JsonTypeInfo$None", placeholderForType0);
      PlaceholderForType placeholderForType1 = (PlaceholderForType)serializerProvider0.getAttribute("com.fasterxml.jackson.annotation.JsonTypeInfo$None");
  ...
  public void test18()  throws Throwable  {
      ...
      ArrayType arrayType1 = ArrayType.construct((JavaType) collectionType0, typeBindings0, (Object) objectIdGenerators_UUIDGenerator0, (Object) objectMapper0);
      JavaType javaType0 = serializerProvider0.constructType(arrayType1);
  ...
  public void test26()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProviderInstance();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._truncate("com.fasterxml.jackson.annotation.JsonTypeInfo$None");
  ...
  public void test30()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProviderInstance();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._colonConcat("e>mVTSF:yIQNee%aV", "JSON");
      assertEquals("e>mVTSF:yIQNee%aV: JSON", string0);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      try { 
        serializerProvider0.setAttribute("##default", objectMapper0);
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.resolveSubType(placeholderForType0, "/dd8)A@^d60<r+k QJ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      try { 
        defaultDeserializationContext_Impl0.reportBadDefinition((JavaType) null, "tA+,q P*n");
        fail("Expecting exception: IOException");
  ...
  public void test45()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Class com.fasterxml.jackson.annotation.ObjectIdGenerators$UUIDGenerator not subtype of [collection type; class java.util.TreeSet, contains [simple type, class com.fasterxml.jackson.databind.node.DoubleNode]]
         //
  ...
  public void test60()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Could not resolve type id 'com.fasterxml.jackson.annotation.JsonTypeInfo$None' as a subtype of [collection type; class java.util.TreeSet, contains [simple type, class com.fasterxml.jackson.databind.Module]]: Not a subtype
         //
  ...
  public void test61()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType(placeholderForType0, "%I=$x<Pthu");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type '%I=$x<Pthu' (remaining: '<Pthu'): Cannot locate class '%I=$x', problem: Class '%I=$x.class' should be in target project, but could not be found!
         //
  ...
  public void test62()  throws Throwable  {
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      try { 
        defaultSerializerProvider_Impl0.resolveSubType((JavaType) null, "<cv}{Rojm='a3lZ&");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id '<cv}{Rojm='a3lZ&' as a subtype of null: problem: (java.lang.NullPointerException) null
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test66()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.reportBadDefinition((Class<?>) class0, "Could not resolve Object Id [");
        fail("Expecting exception: NullPointerException");
