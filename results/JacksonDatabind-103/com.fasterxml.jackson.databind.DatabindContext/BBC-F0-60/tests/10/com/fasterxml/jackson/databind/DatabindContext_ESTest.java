...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        defaultDeserializationContext_Impl0.resolveSubType((JavaType) null, "<5<wmanxHaAv}4+V.@");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id '<5<wmanxHaAv}4+V.@' as a subtype of null: problem: (java.lang.NullPointerException) null
         //
  ...
  public void test02()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        defaultDeserializationContext_Impl0.resolveSubType((JavaType) null, "U27pyxaFcoPek(Sl");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'U27pyxaFcoPek(Sl' as a subtype of null: problem: (java.lang.NullPointerException) null
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      ...
      JavaType javaType0 = serializerProvider0.resolveSubType(placeholderForType0, "com.fasterxml.jackson.databind.jsontype.TypeDeserializer");
  ...
  public void test30()  throws Throwable  {
      ...
      String string0 = ((DatabindContext)defaultDeserializationContext_Impl0)._format("[;sL7c4j NC`F", objectArray0);
      assertEquals("[;sL7c4j NC`F", string0);
  }
  ...
  public void test36()  throws Throwable  {
      ...
      try { 
        defaultDeserializationContext_Impl0.reportBadDefinition((JavaType) resolvedRecursiveType0, "Invalid input: JSON Pointer expression must start with '/': \"");
        fail("Expecting exception: IOException");
  ...
  public void test50()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProviderInstance();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._colonConcat("hF1}*(dZxR=E1x&PXj|", (String) null);
      assertNotNull(string0);
      assertEquals("hF1}*(dZxR=E1x&PXj|", string0);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Class<Proxy.Type> class0 = Proxy.Type.class;
      JsonMappingException jsonMappingException0 = defaultDeserializationContext_Impl0.weirdKeyException(class0, (String) null, "N^ZFA");
  ...
  public void test52()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProviderInstance();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._quotedString("l%N.ZG)OuucR");
      assertEquals("\"l%N.ZG)OuucR\"", string0);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      try { 
        defaultSerializerProvider_Impl0.reportMappingProblem("1?O&}Y@R5(W-_", objectArray0);
        fail("Expecting exception: IOException");
  ...
  public void test59()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // AnnotationIntrospector returned Class java.net.Proxy$Type; expected Class<Converter>
         //
         verifyException("com.fasterxml.jackson.databind.DatabindContext", e);
      }
  }
  ...
  public void test62()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Could not resolve type id 'com.fasterxml.jackson.core.io.CharTypes' as a subtype of [map type; class java.util.Map, [simple type, class java.lang.Integer] -> [simple type, class java.lang.String]]: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType((JavaType) null, "F<*8@\"");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type 'F<*8@\"' (remaining: '<*8@\"'): Cannot locate class 'F', problem: Class 'F.class' should be in target project, but could not be found!
         //
  ...
  public void test64()  throws Throwable  {
      ...
      JavaType javaType0 = serializerProvider0.resolveSubType(placeholderForType0, "com.fasterxml.jackson.core.io.CharTypes");
      assertFalse(javaType0.isJavaLangObject());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Class com.fasterxml.jackson.annotation.ObjectIdGenerators$UUIDGenerator not subtype of [collection-like type; class com.fasterxml.jackson.databind.JavaType, contains [simple type, class java.lang.Object]]
         //
