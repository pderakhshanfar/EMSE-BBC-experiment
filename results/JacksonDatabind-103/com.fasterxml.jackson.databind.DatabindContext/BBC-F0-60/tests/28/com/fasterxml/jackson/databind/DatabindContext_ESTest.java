...
public class DatabindContext_ESTest extends DatabindContext_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        defaultSerializerProvider_Impl0.resolveSubType((JavaType) null, "<W-BQFk`6[P:");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id '<W-BQFk`6[P:' as a subtype of null: problem: (java.lang.NullPointerException) null
         //
  ...
  public void test02()  throws Throwable  {
      ...
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl1 = (DefaultSerializerProvider.Impl)defaultSerializerProvider_Impl0.setAttribute(jsonParser_Feature0, typeFactory0);
  ...
  public void test05()  throws Throwable  {
      ...
      ObjectNode objectNode0 = arrayNode0.insertObject(2633);
  ...
  public void test25()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProviderInstance();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._truncate("=R");
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.resolveSubType((JavaType) null, "; expected Class<JsonDeserializer>");
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      JavaType javaType0 = beanProperty_Bogus0.getType();
      try { 
        deserializationContext0.reportBadDefinition(javaType0, "ED'.64{5w(");
        fail("Expecting exception: IOException");
  ...
  public void test47()  throws Throwable  {
      ObjectMapper objectMapper0 = new ObjectMapper();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = (DefaultSerializerProvider.Impl)objectMapper0.getSerializerProvider();
      String string0 = ((DatabindContext)defaultSerializerProvider_Impl0)._colonConcat("u+ql\"c_6Z`Dh%NA$,", (String) null);
      assertEquals("u+ql\"c_6Z`Dh%NA$,", string0);
  ...
  public void test53()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultSerializerProvider_Impl0.converterInstance((Annotated) null, "\"s~dMC!Gu*eT{@DC");
  ...
  public void test58()  throws Throwable  {
      ...
      try { 
        serializerProvider0.resolveSubType(mapLikeType0, "com.fasterxml.jackson.databind.jsontype.impl.AsExistingPropertyTypeSerializer");
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Could not resolve type id 'com.fasterxml.jackson.databind.jsontype.impl.AsExistingPropertyTypeSerializer' as a subtype of [map-like type; class org.evosuite.runtime.mock.java.io.MockFileInputStream, [simple type, class org.evosuite.runtime.mock.java.io.MockFileInputStream] -> [simple type, class java.lang.String]]: Not a subtype
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidTypeIdException", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        serializerProvider0.resolveSubType(mapType0, "Wdy{ikU<j?jGtB");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Failed to parse type 'Wdy{ikU<j?jGtB' (remaining: '<j?jGtB'): Cannot locate class 'Wdy{ikU', problem: Class 'Wdy{ikU.class' should be in target project, but could not be found!
         //
  ...
  public void test60()  throws Throwable  {
      ...
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      TypeFactory typeFactory0 = serializerProvider0.getTypeFactory();
      JavaType javaType0 = typeFactory0.constructFromCanonical("com.fasterxml.jackson.databind.jsontype.impl.AsExistingPropertyTypeSerializer");
      JavaType javaType1 = serializerProvider0.resolveSubType(javaType0, "com.fasterxml.jackson.databind.jsontype.impl.AsExistingPropertyTypeSerializer");
  ...
  public void test62()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Class com.fasterxml.jackson.annotation.ObjectIdGenerators$StringIdGenerator not subtype of [map-like type; class java.lang.annotation.Annotation, [simple type, class com.fasterxml.jackson.annotation.ObjectIdGenerators$UUIDGenerator] -> [simple type, class com.fasterxml.jackson.annotation.SimpleObjectIdResolver]]
         //
  ...
  public void test64()  throws Throwable  {
      ...
      SerializerProvider serializerProvider0 = objectMapper0.getSerializerProviderInstance();
      try { 
        serializerProvider0.reportBadDefinition((Class<?>) null, "\"com.fasterxml.jackson.databind.introspect.TypeResolutionContext$Basic\"");
        fail("Expecting exception: IOException");
