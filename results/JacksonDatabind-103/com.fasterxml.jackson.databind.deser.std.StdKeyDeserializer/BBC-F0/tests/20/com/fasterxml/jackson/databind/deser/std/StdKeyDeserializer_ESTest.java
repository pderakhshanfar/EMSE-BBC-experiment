...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("j:.%?kEt-dphBz ", defaultDeserializationContext_Impl0);
  ...
  public void test01()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-1994919731), class0, fromStringDeserializer0);
  ...
  public void test02()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-32768), class0, (FromStringDeserializer<?>) null);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
  ...
  public void test05()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0._parse("Cannot access contents of TextNode as binary due to broken Base64 encoding: %s", (DeserializationContext) null);
      assertNull(object0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-2073620586), class0);
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      ...
      BatchUpdateException batchUpdateException0 = new BatchUpdateException("@n+ZTGd~N UH", "@n+ZTGd~N UH", (-1000), intArray0);
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, "@n+ZTGd~N UH", batchUpdateException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.net.URL` from String \"@n+ZTGd~N UH\": problem: @n+ZTGd~N UH
         //
  ...
  public void test07()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(17, class0, fromStringDeserializer0);
      try { 
        stdKeyDeserializer0._parseInt("g&,sZv");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"g&,sZv\"
         //
  ...
  public void test08()  throws Throwable  {
      Class<Double> class0 = Double.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(2243, class0);
      try { 
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey(";^]Si", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("9hvJ$>rBN", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      ...
      Class<Locale> class0 = Locale.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Locale locale0 = (Locale)stdKeyDeserializer0.deserializeKey("d|iwG8W5UAH5vD*\"J", defaultDeserializationContext_Impl0);
      assertEquals("d|iwg8w5uah5vd*\"j", locale0.getLanguage());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      DeserializationContext deserializationContext0 = objectMapper0.getDeserializationContext();
      try { 
        stdKeyDeserializer0._parse("*s<8V Si1", deserializationContext0);
        fail("Expecting exception: NumberFormatException");
  ...
  public void test24()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("f*-/w", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"f*-/w\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("cB$,", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("xc)Sobc(*uyd", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("3", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("ZP+)JKY", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("KE$,=o^m` ", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Object object0 = stdKeyDeserializer0.deserializeKey(";^]Si", (DeserializationContext) null);
