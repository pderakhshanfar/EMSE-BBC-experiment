...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-415), class0, fromStringDeserializer0);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
      assertFalse(class1.isArray());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0._parse("8qHYLeR({i$IagIe", (DeserializationContext) null);
      assertNull(object0);
  }
  ...
  public void test13()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      UUID uUID0 = (UUID)stdKeyDeserializer0._parse("cannot deserialize from Object value (no delegate- or property-based Creator)", (DeserializationContext) null);
  ...
  public void test14()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(4111, class0, fromStringDeserializer0);
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("\u0001kZ[#{(nh31QGx;f", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.time.chrono.IsoEra` from String \"\u0001kZ[#{(nh31QGx;f\": not a valid representation, problem: (org.evosuite.runtime.mock.java.lang.MockIllegalStateException) Internal error: unknown key type class java.time.chrono.IsoEra
         //
  ...
  public void test15()  throws Throwable  {
      ...
      SQLNonTransientConnectionException sQLNonTransientConnectionException0 = new SQLNonTransientConnectionException("Cannot parse date \"%s\": not compatible with any of standard forms (%s)", sQLSyntaxErrorException0);
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, "A#[a;={~aU39", sQLNonTransientConnectionException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"A#[a;={~aU39\": problem: Cannot parse date \"%s\": not compatible with any of standard forms (%s)
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(7, class0);
      try { 
        stdKeyDeserializer0._parseInt("com.fasterxml.jackson.annotation.ObjectIdGenerator$IdKey");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"com.fasterxml.jackson.annotation.ObjectIdGenerator$IdKey\"
         //
  ...
  public void test17()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(17, class0, fromStringDeserializer0);
      try { 
        stdKeyDeserializer0._parseDouble("!^:n!q*yQlOJ8b!'");
        fail("Expecting exception: NumberFormatException");
  ...
  public void test18()  throws Throwable  {
      ...
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, (JsonParser) null, injectableValues_Std0);
      try { 
        stdKeyDeserializer0._parse("com.fasterxml.jackson.databind.type.PlaceholderForType", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"com.fasterxml.jackson.databind.type.PlaceholderForType\": value not 'true' or 'false'
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer_EnumKD0.deserializeKey("Qi1r`*Nwm5", defaultDeserializationContext_Impl0);
  ...
  public void test23()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Cannot deserialize Map key of type `java.io.SequenceInputStream` from String \"JSON\": not a valid representation: Cannot deserialize Map key of type `java.io.SequenceInputStream` from String \"JSON\": not a valid representation
  ...
  public void test24()  throws Throwable  {
      ...
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey(".,H{TjaM", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.io.InputStream` from String \".,H{TjaM\": not a valid representation: Cannot deserialize Map key of type `java.io.InputStream` from String \".,H{TjaM\": not a valid representation
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
  ...
  public void test26()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("cannot deserialize from Object value (no delegate- or property-based Creator)", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      Class<String> class0 = String.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(143, class0);
      DeserializerFactoryConfig deserializerFactoryConfig0 = new DeserializerFactoryConfig();
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("5!$Y", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(7, class0);
      try { 
        stdKeyDeserializer0._parse("com.fasterxml.jackson.databind.util.NameTransformer$1", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("k<6-%GHh;Zu;q91l4", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("Ds&NY<wQcxOmaeF@@R", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test53()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("Bmky`4I+|n+-", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test58()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("9", defaultDeserializationContext_Impl0);
  ...
  public void test61()  throws Throwable  {
      ...
      JsonMappingException jsonMappingException0 = defaultDeserializationContext_Impl0.weirdKeyException(class1, "", "9");
      BatchUpdateException batchUpdateException0 = new BatchUpdateException("", intArray0, jsonMappingException0);
      // Undeclared exception!
      try { 
        stdKeyDeserializer_StringKD0._weirdKey(defaultDeserializationContext_Impl0, "9", batchUpdateException0);
        fail("Expecting exception: NullPointerException");
