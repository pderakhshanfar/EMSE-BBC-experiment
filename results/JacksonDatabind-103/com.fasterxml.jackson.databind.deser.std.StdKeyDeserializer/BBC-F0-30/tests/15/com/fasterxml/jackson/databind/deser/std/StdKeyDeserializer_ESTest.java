...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("v7", defaultDeserializationContext_Impl0);
  ...
  public void test05()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(3552, class0, fromStringDeserializer0);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
  ...
  public void test06()  throws Throwable  {
      Class<ResolverStyle> class0 = ResolverStyle.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(1855, class0, (FromStringDeserializer<?>) null);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("pste", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"pste\": not a valid representation, problem: (com.fasterxml.jackson.databind.exc.InvalidFormatException) Cannot deserialize Map key of type `java.lang.Boolean` from String \"pste\": value not 'true' or 'false'
         //
  ...
  public void test15()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("c", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.nio.CharBuffer` from String \"c\": value not 'true' or 'false'
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Cannot deserialize Map key of type `com.fasterxml.jackson.databind.jsontype.TypeIdResolver` from String \"not a valid representation, problem: (%s) %s\": not a valid representation: Cannot deserialize Map key of type `com.fasterxml.jackson.databind.jsontype.TypeIdResolver` from String \"not a valid representation, problem: (%s) %s\": not a valid representation
         //  at [Source: (String)\"not a valid representation, problem: (%s) %s\"; line: 1, column: 0]
         //  at [Source: (String)\"not a valid representation, problem: (%s) %s\"; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("DEFAULT", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("g9R'r'P3O}", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("}lE", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("<|eU}uW\"R'_!]J6+g1", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("phone", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Locale locale0 = (Locale)stdKeyDeserializer0._parse("BZsx:ez", defaultDeserializationContext_Impl0);
      assertEquals("bzsx:ez", locale0.getLanguage());
  }
  ...
  public void test49()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer_EnumKD0.deserializeKey("e2.GAEAL*gqj+|NC", deserializationContext0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseDouble("bXM4O!Z'h");
        fail("Expecting exception: NumberFormatException");
  ...
  public void test52()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parseLong("eJQN`BUs06_km~");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"eJQN`BUs06_km~\"
         //
  ...
  public void test53()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseInt("S[@dZ}NlT6)Y~yJNclK");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"S[@dZ}NlT6)Y~yJNclK\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0._weirdKey((DeserializationContext) null, "E@(5dqYaF$:[M@;", (Exception) null);
        fail("Expecting exception: NullPointerException");
