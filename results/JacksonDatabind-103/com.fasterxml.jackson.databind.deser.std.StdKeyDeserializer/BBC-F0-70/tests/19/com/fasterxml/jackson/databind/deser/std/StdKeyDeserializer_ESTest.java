...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("Cannot narrow or widen array types", (DeserializationContext) null);
  ...
  public void test07()  throws Throwable  {
      ...
      int int0 = stdKeyDeserializer0._parseInt("262");
  ...
  public void test12()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0._parse("com.fasterxml.jackson.databind.JsonNode", (DeserializationContext) null);
      assertNull(object0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Cannot deserialize Map key of type `long` from String \"not a valid representation, problem: (%s) %s\": not a valid representation, problem: (java.lang.NumberFormatException) For input string: \"not a valid representation, problem: (%s) %s\"
  ...
  public void test15()  throws Throwable  {
      Class<Short> class0 = Short.class;
      FromStringDeserializer.Std fromStringDeserializer_Std0 = new FromStringDeserializer.Std(class0, (-1287));
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(9, class0, fromStringDeserializer_Std0);
      DeserializerFactoryConfig deserializerFactoryConfig0 = new DeserializerFactoryConfig();
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("V0r o", defaultDeserializationContext_Impl0);
  ...
  public void test18()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("com.fasterxml.jackson.databind.deser.std.NullifyingDeserializer", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.nio.CharBuffer` from String \"com.fasterxml.jackson.databind.deser.std.NullifyingDeserializer\": not a valid representation: Cannot deserialize Map key of type `java.nio.CharBuffer` from String \"com.fasterxml.jackson.databind.deser.std.NullifyingDeserializer\": not a valid representation
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
  ...
  public void test25()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("xO+[{8##-K1M", (DeserializationContext) null);
  ...
  public void test29()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("o{sqY]", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("ppZ*mGJ", defaultDeserializationContext_Impl0);
  ...
  public void test32()  throws Throwable  {
      Class<Long> class0 = Long.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(4, class0);
      Object object0 = stdKeyDeserializer0._parse("R", (DeserializationContext) null);
  ...
  public void test33()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(1, class0, uUIDDeserializer0);
      try { 
        stdKeyDeserializer0._parse("4Gk", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("!QhC:gN,dl;-1+F'", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      Class<Locale> class0 = Locale.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Locale locale0 = (Locale)stdKeyDeserializer0._parse("com.fasterxml.jackson.databind.ser.std.ObjectArraySerializer", (DeserializationContext) null);
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("-670", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test58()  throws Throwable  {
      Class<Object> class0 = Object.class;
      FromStringDeserializer<CharBuffer> fromStringDeserializer0 = (FromStringDeserializer<CharBuffer>) mock(FromStringDeserializer.class, new ViolatedAssumptionAnswer());
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(682, class0, fromStringDeserializer0);
      try { 
        stdKeyDeserializer0._parseLong("aK>&Ep2e9s,R4#");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"aK>&Ep2e9s,R4#\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      Class<String> class0 = String.class;
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      BatchUpdateException batchUpdateException0 = new BatchUpdateException("1H5", "{", 16, (int[]) null);
      SQLInvalidAuthorizationSpecException sQLInvalidAuthorizationSpecException0 = new SQLInvalidAuthorizationSpecException("1H5", "1H5", batchUpdateException0);
      // Undeclared exception!
      try { 
        stdKeyDeserializer_StringKD0._weirdKey((DeserializationContext) null, ",tSAb@H", sQLInvalidAuthorizationSpecException0);
        fail("Expecting exception: NullPointerException");
