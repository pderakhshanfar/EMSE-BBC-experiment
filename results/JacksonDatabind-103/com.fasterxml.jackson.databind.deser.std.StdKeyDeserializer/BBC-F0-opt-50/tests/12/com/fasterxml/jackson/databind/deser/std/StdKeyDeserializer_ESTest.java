...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("QzFi2(vxrL}'U~ZZ", defaultDeserializationContext_Impl0);
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("Illegal unquoted character (", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Short` from String \"Illegal unquoted character (\": not a valid representation, problem: (java.lang.NumberFormatException) For input string: \"Illegal unquoted character (\"
  ...
  public void test14()  throws Throwable  {
      ...
      SQLNonTransientException sQLNonTransientException0 = new SQLNonTransientException("ZL(>.RK\":R.pD&4V<", "ZL(>.RK\":R.pD&4V<", sQLClientInfoException0);
      try { 
        stdKeyDeserializer_StringKD0._weirdKey(defaultDeserializationContext0, "[collection type; class ", sQLNonTransientException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"[collection type; class \": problem: ZL(>.RK\":R.pD&4V<
         //  at [Source: UNKNOWN; line: -1, column: -1]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  ...
  public void test15()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parseLong("^,@O[tw");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"^,@O[tw\"
         //
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer_EnumKD0._parse("UkEz", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Cannot deserialize Map key of type `java.lang.Character` from String \"JSON\": not a valid representation: Cannot deserialize Map key of type `java.lang.Character` from String \"JSON\": not a valid representation
  ...
  public void test21()  throws Throwable  {
      ...
      JsonDeserializer<JsonSerializer<URI>> jsonDeserializer0 = (JsonDeserializer<JsonSerializer<URI>>) mock(JsonDeserializer.class, new ViolatedAssumptionAnswer());
      doReturn((Object) null).when(jsonDeserializer0).deserialize(any(com.fasterxml.jackson.core.JsonParser.class) , any(com.fasterxml.jackson.databind.DeserializationContext.class));
      StdKeyDeserializer.DelegatingKD stdKeyDeserializer_DelegatingKD0 = new StdKeyDeserializer.DelegatingKD(class0, jsonDeserializer0);
      DeserializerFactoryConfig deserializerFactoryConfig0 = new DeserializerFactoryConfig();
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      ...
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, (InjectableValues) null);
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("' (expected type: ", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.net.URL` from String \"' (expected type: \": not a valid representation: Cannot deserialize Map key of type `java.net.URL` from String \"' (expected type: \": not a valid representation
         //  at [Source: (byte[])\"\u0000\u0000\u0000\u0000\u0000\"; line: 1, column: 0]
         //  at [Source: (byte[])\"\u0000\u0000\u0000\u0000\u0000\"; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey(".5\\ac&k}", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("2154", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("*f$Y$", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(16, class0, fromStringDeserializer0);
      Object object0 = stdKeyDeserializer0._parse("s_v<,^MlmQf\"\"xC\"zyi", (DeserializationContext) null);
      assertNull(object0);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("mx5)P0<Q.CG?,A$", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("Illegal character (code 0x", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("D`/} C2TQXk", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      Class<Locale> class0 = Locale.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Object object0 = stdKeyDeserializer0._parse("eQ 4!tP", (DeserializationContext) null);
      assertEquals("eq 4!tp", object0.toString());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("OSZz'", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      UUID uUID0 = (UUID)stdKeyDeserializer0.deserializeKey("LHV}Sneau8/", (DeserializationContext) null);
  ...
  public void test55()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer_StringKD0._parseDouble("Invalid input: JSON Pointer expression must start with '/': \"");
        fail("Expecting exception: NumberFormatException");
  ...
  public void test57()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(2298, class0, coreXMLDeserializers_Std0);
      try { 
        stdKeyDeserializer0._parseInt("tFct;#@Rr");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"tFct;#@Rr\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(2878, class0);
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      SQLFeatureNotSupportedException sQLFeatureNotSupportedException0 = new SQLFeatureNotSupportedException("com.fasterxml.jackson.databind.introspect.POJOPropertyBuilder");
      // Undeclared exception!
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext_Impl0, "com.fasterxml.jackson.databind.introspect.POJOPropertyBuilder", sQLFeatureNotSupportedException0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test59()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("RY\u0003Q*.){i3dY:jNQ", defaultDeserializationContext_Impl0);
      assertEquals("RY\u0003Q*.){i3dY:jNQ", object0);
  }
