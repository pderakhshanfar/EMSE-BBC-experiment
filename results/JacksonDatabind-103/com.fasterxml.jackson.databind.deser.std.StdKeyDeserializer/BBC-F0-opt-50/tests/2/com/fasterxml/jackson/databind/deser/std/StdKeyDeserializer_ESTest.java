...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, 3, pipedReader0, objectMapper0, charsToNameCanonicalizer0, (char[]) null, 1, (-1355), true);
      ...
      SQLWarning sQLWarning0 = new SQLWarning("com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$StringCtorKeyDeserializer", sQLSyntaxErrorException0);
      Object object0 = stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, "Za.u-9-", sQLWarning0);
      assertNull(object0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0._parse("b[c$db[MjKy5", (DeserializationContext) null);
      assertNull(object0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(15711167, class0, fromStringDeserializer0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      StdSubtypeResolver stdSubtypeResolver0 = new StdSubtypeResolver();
      SimpleMixInResolver simpleMixInResolver0 = new SimpleMixInResolver((ClassIntrospector.MixInResolver) null);
      RootNameLookup rootNameLookup0 = new RootNameLookup();
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("1w-fY@_uu?m[Kqw ", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.nio.CharBuffer` from String \"1w-fY@_uu?m[Kqw \": not a valid representation, problem: (org.evosuite.runtime.mock.java.lang.MockIllegalStateException) Internal error: unknown key type class java.nio.CharBuffer
         //
  ...
  public void test15()  throws Throwable  {
      ...
      BatchUpdateException batchUpdateException0 = new BatchUpdateException("No enum constants for class ", intArray0);
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, "No enum constants for class ", batchUpdateException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Integer` from String \"No enum constants for class \": problem: No enum constants for class 
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer_DelegatingKD0.deserializeKey("com.fasterx)l.jackson.databin.nod.POJONode", defaultDeserializationContext0);
      assertEquals((-1355.0), object0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      CharsToNameCanonicalizer charsToNameCanonicalizer0 = CharsToNameCanonicalizer.createRoot();
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, 11, pipedReader0, objectMapper0, charsToNameCanonicalizer0, (char[]) null, 0, (-2082), false);
      ...
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey(")]Zjd@G,0WW}D", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Double` from String \")]Zjd@G,0WW}D\": not a valid representation: Cannot deserialize Map key of type `java.lang.Double` from String \")]Zjd@G,0WW}D\": not a valid representation
  ...
  public void test21()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("507", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test22()  throws Throwable  {
      ...
      CoreXMLDeserializers.Std coreXMLDeserializers_Std0 = new CoreXMLDeserializers.Std(class1, (-3526));
  ...
  public void test24()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer_StringKD0._parse("X", defaultDeserializationContext_Impl0);
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("h_t4 <QP ,'1s?X;aW", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("M}x+)ihg", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      Class<Locale> class0 = Locale.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(12, class0, (FromStringDeserializer<?>) null);
      UUID uUID0 = (UUID)stdKeyDeserializer0.deserializeKey("com.fasterxml.jackson.databind.node.MissingNode", (DeserializationContext) null);
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("l`b'0,oBPTarw/T&", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      Class<Locale> class0 = Locale.class;
      Class<Boolean> class1 = Boolean.class;
      CoreXMLDeserializers.Std coreXMLDeserializers_Std0 = new CoreXMLDeserializers.Std(class1, 1317);
  ...
  public void test33()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("l`b'0,oBPTarw/T&", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"l`b'0,oBPTarw/T&\"
         //
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("LWDU;!12;", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      Class<String> class0 = String.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(1474, class0, (FromStringDeserializer<?>) null);
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
  ...
  public void test39()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("Y?-,I]$@z (IzO9Cd<", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey(",}msDBhs", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test46()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Object object0 = stdKeyDeserializer0._parse("u", (DeserializationContext) null);
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("-437", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test48()  throws Throwable  {
      ...
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, readerBasedJsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer0._parse("Unexpected token (%s), expected %s", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"Unexpected token (%s), expected %s\": value not 'true' or 'false'
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  ...
  public void test55()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      SQLWarning sQLWarning0 = new SQLWarning("xoL+)=");
      SQLTransientConnectionException sQLTransientConnectionException0 = new SQLTransientConnectionException("problem: %s", "com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$DelegatingKD", sQLWarning0);
      // Undeclared exception!
      try { 
        stdKeyDeserializer_StringKD0._weirdKey(defaultDeserializationContext_Impl0, "Could not find JsonDeserializer for type %s (via property %s)", sQLTransientConnectionException0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test61()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseInt("\"m7p");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"\"m7p\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("WHv{4Ys3n&rb(J", defaultDeserializationContext_Impl0);
      assertEquals("WHv{4Ys3n&rb(J", object0);
  }
