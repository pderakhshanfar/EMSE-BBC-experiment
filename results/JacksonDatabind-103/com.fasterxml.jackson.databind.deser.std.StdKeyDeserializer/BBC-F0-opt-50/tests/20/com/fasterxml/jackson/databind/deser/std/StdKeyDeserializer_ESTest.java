...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("OG{L", defaultDeserializationContext_Impl0);
      assertEquals("OG{L", object0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer_EnumKD0._parse("wtC>_v'D5Y~Yj,Wz", (DeserializationContext) null);
  ...
  public void test14()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0._parse("_/_eHiGSQ-F5)$dW#{", (DeserializationContext) null);
      assertNull(object0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonParser jsonParser0 = jsonFactory0.createParser(byteArray0, (int) (byte)73, (int) (byte) (-72));
  ...
  public void test16()  throws Throwable  {
      ...
      BatchUpdateException batchUpdateException0 = new BatchUpdateException("0I8/m<>AuR+", intArray0);
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, "not one of values excepted for Enum class: %s", batchUpdateException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"not one of values excepted for Enum class: %s\": problem: 0I8/m<>AuR+
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("fMK/RJg", (DeserializationContext) null);
  ...
  public void test20()  throws Throwable  {
      ...
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, 1264, pipedReader0, (ObjectCodec) null, charsToNameCanonicalizer0);
      ...
      try { 
        stdKeyDeserializer0._parse("USE_STATIC_TYPING", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"USE_STATIC_TYPING\": value not 'true' or 'false'
  ...
  public void test23()  throws Throwable  {
      ...
      DeserializationConfig deserializationConfig0 = new DeserializationConfig((BaseSettings) null, stdSubtypeResolver0, simpleMixInResolver0, rootNameLookup0, configOverrides0);
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, stdKeyDeserializer0.TYPE_URL, true);
      ...
      InjectableValues.Std injectableValues_Std0 = new InjectableValues.Std(hashMap0);
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, readerBasedJsonParser0, injectableValues_Std0);
      Object object0 = stdKeyDeserializer_DelegatingKD0.deserializeKey("iaA*3AHn18=v+0k)Ki|", defaultDeserializationContext0);
      assertSame(currency0, object0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      DeserializationConfig deserializationConfig0 = new DeserializationConfig((BaseSettings) null, stdSubtypeResolver0, simpleMixInResolver0, rootNameLookup0, configOverrides0);
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, stdKeyDeserializer0.TYPE_CLASS, true);
      PipedReader pipedReader0 = new PipedReader(10);
      JsonFactory jsonFactory0 = new JsonFactory();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      ObjectMapper objectMapper0 = new ObjectMapper(jsonFactory0, defaultSerializerProvider_Impl0, defaultDeserializationContext_Impl0);
      ...
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, readerBasedJsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("b9u)S_tgYW", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.net.URL` from String \"b9u)S_tgYW\": not a valid representation: Cannot deserialize Map key of type `java.net.URL` from String \"b9u)S_tgYW\": not a valid representation
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
  ...
  public void test26()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("362", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parse("-Z08~Aa283>", (DeserializationContext) null);
  ...
  public void test29()  throws Throwable  {
      ...
      FromStringDeserializer.Std fromStringDeserializer_Std0 = new FromStringDeserializer.Std(class0, (-2589));
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("-Z068~Aa283>", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("com.fasterxml.jackson.databind.deser.std.StdKeybeserializer$StringKD", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("}Ww[7s~{[P9>|>}", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      Class<Locale> class0 = Locale.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Locale locale0 = (Locale)stdKeyDeserializer0._parse("9", (DeserializationContext) null);
  ...
  public void test41()  throws Throwable  {
      Class<URI> class0 = URI.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      URI uRI0 = (URI)stdKeyDeserializer0.deserializeKey("WdL*~jQ8", (DeserializationContext) null);
  ...
  public void test42()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("Nl", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
  ...
  public void test51()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      UUID uUID0 = (UUID)stdKeyDeserializer0.deserializeKey("com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer", (DeserializationContext) null);
  ...
  public void test57()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-1166), class0);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("-Ht-cNGM*]uBYUNCl0a", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test60()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      SQLWarning sQLWarning0 = new SQLWarning("Dqij3s(^eL<(Y(zL", "Multiple 'any-setter' fields defined (%s vs %s)");
      SQLIntegrityConstraintViolationException sQLIntegrityConstraintViolationException0 = new SQLIntegrityConstraintViolationException("\"+", (String) null, 377, sQLWarning0);
      // Undeclared exception!
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext_Impl0, "Dqij3s(^eL<(Y(zL", sQLIntegrityConstraintViolationException0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test61()  throws Throwable  {
      Class<DeserializationFeature> class0 = DeserializationFeature.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-2476), class0);
      try { 
        stdKeyDeserializer0._parseInt("com.fasterxml.jackson.databind.ser.std.ArraySerializerBase");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"com.fasterxml.jackson.databind.ser.std.ArraySerializerBase\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
