...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("h_)!Fa_%O\"Js:r", (DeserializationContext) null);
  ...
  public void test06()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-1731620456), class0, (FromStringDeserializer<?>) null);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
  ...
  public void test07()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-1135750691), class0);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
  ...
  public void test13()  throws Throwable  {
      Class<Currency> class0 = Currency.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-1984101793), class0);
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0._parse(" MUST implement ", deserializationContext0);
      assertNull(object0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      FromStringDeserializer<Module> fromStringDeserializer0 = (FromStringDeserializer<Module>) mock(FromStringDeserializer.class, new ViolatedAssumptionAnswer());
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-1452), class0, fromStringDeserializer0);
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Cannot deserialize Map key of type `com.fasterxml.jackson.databind.JsonDeserializer` from String \"\": not a valid representation, problem: (org.evosuite.runtime.mock.java.lang.MockIllegalStateException) Internal error: unknown key type class com.fasterxml.jackson.databind.JsonDeserializer
  ...
  public void test18()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(4, class0);
      try { 
        stdKeyDeserializer0._parseDouble(", problem: ");
  ...
  public void test19()  throws Throwable  {
      ...
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer0._parse("FIELD", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"FIELD\": value not 'true' or 'false'
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer_EnumKD0.deserializeKey("'<50Xh}-bp$", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("Z}$b#V?yHlP)_lbS", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `com.fasterxml.jackson.databind.JsonDeserializer` from String \"Z}$b#V?yHlP)_lbS\": not a valid representation: Cannot deserialize Map key of type `com.fasterxml.jackson.databind.JsonDeserializer` from String \"Z}$b#V?yHlP)_lbS\": not a valid representation
  ...
  public void test25()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("0l2*ohbg", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("!Pi$!]jg8^[~Ga(N", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("Lq7Km", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("e!(:Qat'Y&B73C.21+", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NumberFormatException");
  ...
  public void test31()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("' has value that is not of type ArrayNode (but ", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"' has value that is not of type ArrayNode (but \"
         //
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("h~^$\"[^vq%T|%a. 6", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      SQLInvalidAuthorizationSpecException sQLInvalidAuthorizationSpecException0 = new SQLInvalidAuthorizationSpecException("]D*[S*F89");
      // Undeclared exception!
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext_Impl0, "]D*[S*F89", sQLInvalidAuthorizationSpecException0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      Class<Locale> class0 = Locale.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Locale locale0 = (Locale)stdKeyDeserializer0.deserializeKey("6", (DeserializationContext) null);
  ...
  public void test40()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0.deserializeKey("434", (DeserializationContext) null);
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("434", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test46()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("tT", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NumberFormatException");
  ...
  public void test47()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      UUID uUID0 = (UUID)stdKeyDeserializer0._parse("!Pi$!]jg8^[~Ga(N", (DeserializationContext) null);
  ...
  public void test54()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parseInt("No current event to copy");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"No current event to copy\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
