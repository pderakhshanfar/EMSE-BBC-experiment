...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("[ObjectId: key=%s, type=%s, scope=%s]", deserializationContext0);
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("HUVvY0^k!?xfl", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test05()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(179, class0, fromStringDeserializer0);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
      assertFalse(class1.isArray());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      ObjectMapper objectMapper0 = new ObjectMapper();
      DeserializationContext deserializationContext0 = objectMapper0.getDeserializationContext();
      URI uRI0 = (URI)stdKeyDeserializer0._parse("true", deserializationContext0);
  ...
  public void test16()  throws Throwable  {
      ...
      UTF8StreamJsonParser uTF8StreamJsonParser0 = new UTF8StreamJsonParser(iOContext0, 68, mockFileInputStream0, objectMapper0, byteQuadsCanonicalizer0, byteArray0, (-3202), 1, true);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl1 = (DefaultDeserializationContext.Impl)defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, uTF8StreamJsonParser0, (InjectableValues) null);
      try { 
        stdKeyDeserializer0.deserializeKey("ipvM", defaultDeserializationContext_Impl1);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"ipvM\": not a valid representation, problem: (com.fasterxml.jackson.databind.exc.InvalidFormatException) Cannot deserialize Map key of type `java.lang.Boolean` from String \"ipvM\": value not 'true' or 'false'
  ...
  public void test20()  throws Throwable  {
      ...
      JsonParser jsonParser0 = jsonFactory0.createParser("icone");
      HashMap<String, Object> hashMap0 = new HashMap<String, Object>();
      InjectableValues.Std injectableValues_Std0 = new InjectableValues.Std(hashMap0);
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer0._parse("icone", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"icone\": value not 'true' or 'false'
         //  at [Source: (String)\"icone\"; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, (-2013), (Reader) null, objectMapper0, charsToNameCanonicalizer0);
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Cannot deserialize Map key of type `com.fasterxml.jackson.annotation.ObjectIdResolver` from String \"|a\": not a valid representation: Cannot deserialize Map key of type `com.fasterxml.jackson.annotation.ObjectIdResolver` from String \"|a\": not a valid representation
         //  at [Source: (com.fasterxml.jackson.annotation.ObjectIdResolver); line: 1, column: 0]
         //  at [Source: (com.fasterxml.jackson.annotation.ObjectIdResolver); line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("du`%3cgGlf4|<d", deserializationContext0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("-717", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      Class<URL> class0 = URL.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(1657, class0);
      DeserializerFactoryConfig deserializerFactoryConfig0 = new DeserializerFactoryConfig();
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("com.fasterxml.jackson.databind.ser.impl.SimpleBeanPropertyFilter$FilterExceptFilter", defaultDeserializationContext_Impl0);
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("FkKQ", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("%bE}Jq/hJ_=-L/", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("du`%3cgGlf4|<d", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("METADATA_PROPERTY", deserializationContext0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      ...
      DeserializationContext deserializationContext0 = objectMapper0.getDeserializationContext();
      try { 
        stdKeyDeserializer0._parse("Ie@", deserializationContext0);
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("HOH[]R", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test48()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse(" 3yBP&S#X#@", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \" 3yBP&S#X#@\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("j6Y#On4s2{@t)6!H", deserializationContext0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test50()  throws Throwable  {
      ...
      ObjectMapper objectMapper0 = new ObjectMapper();
      DeserializationContext deserializationContext0 = objectMapper0.getDeserializationContext();
      UUID uUID0 = (UUID)stdKeyDeserializer0.deserializeKey("bR", deserializationContext0);
  ...
  public void test55()  throws Throwable  {
      ...
      DeserializationContext deserializationContext0 = objectMapper0.getDeserializationContext();
      try { 
        stdKeyDeserializer_EnumKD0._parse("1oD:0 .r", deserializationContext0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test56()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("2hcE)Q; ;e`wB5i>>a9", defaultDeserializationContext_Impl0);
      assertEquals("2hcE)Q; ;e`wB5i>>a9", object0);
  }
  ...
  public void test57()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseDouble("J773bMp;O1>");
        fail("Expecting exception: NumberFormatException");
  ...
  public void test59()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parseInt("&bD)~^TjHs=O");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"&bD)~^TjHs=O\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      ...
      ObjectMapper objectMapper0 = new ObjectMapper();
      DeserializationContext deserializationContext0 = objectMapper0.getDeserializationContext();
      SQLException sQLException0 = new SQLException("com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$DelegatingKD", "com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$EnumKD");
      // Undeclared exception!
      try { 
        stdKeyDeserializer0._weirdKey(deserializationContext0, "", sQLException0);
        fail("Expecting exception: NullPointerException");
