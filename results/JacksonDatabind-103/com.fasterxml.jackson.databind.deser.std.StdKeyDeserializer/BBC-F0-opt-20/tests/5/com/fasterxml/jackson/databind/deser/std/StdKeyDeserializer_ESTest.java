...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(23, class0, fromStringDeserializer0);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
  ...
  public void test03()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-1389), class0, fromStringDeserializer0);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
  ...
  public void test14()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      UUID uUID0 = (UUID)stdKeyDeserializer0._parse("?Zj4vfF\"B", (DeserializationContext) null);
  ...
  public void test15()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("c^gue", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Short` from String \"c^gue\": not a valid representation, problem: (java.lang.NumberFormatException) For input string: \"c^gue\"
         //
  ...
  public void test16()  throws Throwable  {
      ...
      SQLRecoverableException sQLRecoverableException0 = new SQLRecoverableException("K'S$?.7xeju\"~", "JSON");
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Cannot deserialize Map key of type `java.util.Calendar` from String \"JSON\": problem: K'S$?.7xeju\"~
  ...
  public void test17()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parseLong("f#}O %}#XQgp.");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"f#}O %}#XQgp.\"
         //
  ...
  public void test18()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parseInt("t:-5'#(BkcZx/fYu");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"t:-5'#(BkcZx/fYu\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar((-3041), 0, 2);
      ...
      UTF8StreamJsonParser uTF8StreamJsonParser0 = new UTF8StreamJsonParser(iOContext0, 25, byteArrayInputStream0, objectMapper0, byteQuadsCanonicalizer0, byteArray0, 3144, 16, false);
      ...
      try { 
        stdKeyDeserializer0._parse("UNWRAP_SINGLE_VALUE_ARRAYS", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"UNWRAP_SINGLE_VALUE_ARRAYS\": value not 'true' or 'false'
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("Ialue not 'true' or 'faks8'", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      Class<CharBuffer> class0 = CharBuffer.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(805, class0);
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("94509", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("Gr^pNFKeW3", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test52()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer_EnumKD0._parse("fVB+Q+N@-7 &@cLc", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
