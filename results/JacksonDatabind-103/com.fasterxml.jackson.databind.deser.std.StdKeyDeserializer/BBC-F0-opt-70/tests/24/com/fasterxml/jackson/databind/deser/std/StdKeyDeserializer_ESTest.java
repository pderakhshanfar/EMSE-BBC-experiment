...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      long long0 = stdKeyDeserializer0._parseLong("81");
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0._parse(",W1I(A5w3+", (DeserializationContext) null);
      assertNull(object0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(15, (-537), 3);
      IOContext iOContext0 = new IOContext(bufferRecycler0, mockGregorianCalendar0, true);
      PipedReader pipedReader0 = new PipedReader();
      ObjectMapper objectMapper0 = new ObjectMapper();
      CharsToNameCanonicalizer charsToNameCanonicalizer0 = CharsToNameCanonicalizer.createRoot();
      char[] charArray0 = new char[8];
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, (-1139), pipedReader0, objectMapper0, charsToNameCanonicalizer0, charArray0, 1404, 1561, false);
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("N2')<CH:CqBR(+pl", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Byte` from String \"N2')<CH:CqBR(+pl\": not a valid representation, problem: (java.lang.NumberFormatException) For input string: \"N2')<CH:CqBR(+pl\"
         //  at [Source: (org.evosuite.runtime.mock.java.util.MockGregorianCalendar); line: 1, column: 0]
         //
  ...
  public void test17()  throws Throwable  {
      ...
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, stdKeyDeserializer0.TYPE_BOOLEAN, true);
      JsonFactory jsonFactory0 = new JsonFactory((ObjectCodec) null);
      ObjectMapper objectMapper0 = new ObjectMapper(jsonFactory0);
      CharsToNameCanonicalizer charsToNameCanonicalizer0 = CharsToNameCanonicalizer.createRoot();
      char[] charArray0 = new char[9];
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, 14, (Reader) null, objectMapper0, charsToNameCanonicalizer0, charArray0, 12, 0, true);
      HashMap<String, Object> hashMap0 = new HashMap<String, Object>();
      InjectableValues.Std injectableValues_Std0 = new InjectableValues.Std(hashMap0);
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, readerBasedJsonParser0, injectableValues_Std0);
      SQLException sQLException0 = new SQLException("problem: %s", "JSON", 3186);
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"JSON\": problem: problem: %s
  ...
  public void test20()  throws Throwable  {
      ...
      JsonParser jsonParser0 = jsonFactory0.createParser("value not 'true' or 'false'");
      HashMap<String, Object> hashMap0 = new HashMap<String, Object>();
      InjectableValues.Std injectableValues_Std0 = new InjectableValues.Std(hashMap0);
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("^_FxFm<r", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `org.evosuite.runtime.mock.java.util.MockGregorianCalendar` from String \"^_FxFm<r\": not a valid representation: Cannot deserialize Map key of type `org.evosuite.runtime.mock.java.util.MockGregorianCalendar` from String \"^_FxFm<r\": not a valid representation
         //  at [Source: (String)\"value not 'true' or 'false'\"; line: 1, column: 0]
         //  at [Source: (String)\"value not 'true' or 'false'\"; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  ...
  public void test27()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("Nqyj1pL8gH!gB", defaultDeserializationContext_Impl0);
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("871", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("]av{pq2`iL}TT", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("utql", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test49()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Object object0 = stdKeyDeserializer0.deserializeKey("2,EBwg:UQE?df|1", (DeserializationContext) null);
  ...
  public void test51()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer_StringKD0._parse("INTERN_FIELD_NAMES", defaultDeserializationContext_Impl0);
  ...
  public void test55()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("OT9-6Z5;-", defaultDeserializationContext_Impl0);
      assertEquals("OT9-6Z5;-", object0);
  }
  ...
  public void test56()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseDouble("k(<N`v3k)S8QUh");
        fail("Expecting exception: NumberFormatException");
  ...
  public void test57()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseLong("com.fasterxml.jackson.core.json.JsonGeneratorImpl");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"com.fasterxml.jackson.core.json.JsonGeneratorImpl\"
         //
  ...
  public void test58()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      MockException mockException0 = new MockException(".%j^~RA[246jdWV5#");
      MockThrowable mockThrowable0 = new MockThrowable(mockException0);
      SQLSyntaxErrorException sQLSyntaxErrorException0 = new SQLSyntaxErrorException("", "", 2440, mockThrowable0);
      // Undeclared exception!
      try { 
  ...
  public void test59()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parseInt("@hJ4)");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"@hJ4)\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
