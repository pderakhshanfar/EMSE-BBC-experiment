...
public class StdKeyDeserializer_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.core.FormatFeature", false, StdKeyDeserializer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.io.InputDecorator", false, StdKeyDeserializer_ESTest_scaffolding.class.getClassLoader()));
