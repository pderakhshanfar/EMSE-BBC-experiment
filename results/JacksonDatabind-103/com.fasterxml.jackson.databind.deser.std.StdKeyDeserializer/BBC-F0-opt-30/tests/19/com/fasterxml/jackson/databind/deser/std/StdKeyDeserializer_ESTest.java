...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-2296), class0);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
  ...
  public void test08()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(1427, class0, fromStringDeserializer0);
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("\"pc", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"\"pc\": not a valid representation, problem: (com.fasterxml.jackson.databind.exc.InvalidFormatException) Cannot deserialize Map key of type `java.lang.Boolean` from String \"\"pc\": value not 'true' or 'false'
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext_Impl0, "8~cd43-Ju@9", mockException0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      ...
      JsonMappingException jsonMappingException0 = defaultDeserializationContext_Impl0.weirdKeyException(class1, "Value returned by 'any-getter' %s() not java.util.Map but %s", "Value returned by 'any-getter' %s() not java.util.Map but %s");
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, "Value returned by 'any-getter' %s() not java.util.Map but %s", jsonMappingException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"Value returned by 'any-getter' %s() not java.util.Map but %s\": problem: Cannot deserialize Map key of type `java.util.Currency` from String \"Value returned by 'any-getter' %s() not java.util.Map but %s\": Value returned by 'any-getter' %s() not java.util.Map but %s
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("m`{.K.8?xAE1[", (DeserializationContext) null);
  ...
  public void test22()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("5_\u0005XW", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"5_\u0005XW\": value not 'true' or 'false'
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  ...
  public void test25()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer_EnumKD0._parse("com.fasterxml.jackson.annotation.ObjectIdGenerators$None", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      ...
      InjectableValues.Std injectableValues_Std0 = new InjectableValues.Std();
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, readerBasedJsonParser0, injectableValues_Std0);
      Object object0 = stdKeyDeserializer_DelegatingKD0.deserializeKey("<:l/i7xf/q*_", defaultDeserializationContext0);
  ...
  public void test27()  throws Throwable  {
      ...
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, readerBasedJsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("\"pc", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"\"pc\": not a valid representation: Cannot deserialize Map key of type `java.lang.Boolean` from String \"\"pc\": not a valid representation
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
  ...
  public void test33()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer_StringKD0._parse("com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$StringKD", defaultDeserializationContext_Impl0);
  ...
  public void test34()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(17, class0);
      try { 
        stdKeyDeserializer0._parse("RZAH:.5tD!Vp", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("No native support for writing Object Ids", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("'hK9NWpq`#0d<+0", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("dcNI", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("class to register value instantiator for", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test42()  throws Throwable  {
      Class<Locale> class0 = Locale.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Object object0 = stdKeyDeserializer0._parse("S=^^5@\"@4", (DeserializationContext) null);
      assertEquals("s=^^5@\"@4", object0.toString());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("dcNI", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("xMOl\"|lQ65!&_v4@4", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test46()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("S=^^5@\"@4", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("-267", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test49()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("k}qm'T%&3[$N)I,/F", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test53()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      UUID uUID0 = (UUID)stdKeyDeserializer0.deserializeKey("Kc", (DeserializationContext) null);
  ...
  public void test58()  throws Throwable  {
      Class<Calendar> class0 = Calendar.class;
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("bKj)t,y4f9Q[$q|b", (DeserializationContext) null);
      assertEquals("bKj)t,y4f9Q[$q|b", object0);
  }
  ...
  public void test59()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(487, class0, uUIDDeserializer0);
      try { 
  ...
  public void test60()  throws Throwable  {
      ...
      UUIDDeserializer uUIDDeserializer0 = new UUIDDeserializer();
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(1531, class0, uUIDDeserializer0);
      try { 
        stdKeyDeserializer0._parseLong("T^&/pL1Vi#~p[0WDi$N");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"T^&/pL1Vi#~p[0WDi$N\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
