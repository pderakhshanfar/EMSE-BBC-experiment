...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-1288), (Class<?>) null, fromStringDeserializer0);
  ...
  public void test13()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0._parse("=KXIswGm610u&*=MH", (DeserializationContext) null);
      assertNull(object0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(4221);
      JsonFactory jsonFactory0 = new JsonFactory();
      ObjectMapper objectMapper0 = new ObjectMapper(jsonFactory0);
      CharsToNameCanonicalizer charsToNameCanonicalizer0 = CharsToNameCanonicalizer.createRoot();
      char[] charArray0 = new char[0];
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, 3, pipedReader0, objectMapper0, charsToNameCanonicalizer0, charArray0, 1031, 4, true);
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Cannot deserialize Map key of type `java.lang.String` from String \"false\": not a valid representation, problem: (com.fasterxml.jackson.databind.exc.InvalidFormatException) Cannot deserialize Map key of type `java.lang.String` from String \"false\": can only convert 1-character Strings
  ...
  public void test16()  throws Throwable  {
      ...
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, (Object) null, true);
      StringReader stringReader0 = new StringReader("9S6");
      ObjectMapper objectMapper0 = new ObjectMapper();
      CharsToNameCanonicalizer charsToNameCanonicalizer0 = CharsToNameCanonicalizer.createRoot();
      char[] charArray0 = new char[8];
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, 487, stringReader0, objectMapper0, charsToNameCanonicalizer0, charArray0, 17, 1, true);
      ...
      try { 
        stdKeyDeserializer_StringKD0._weirdKey(defaultDeserializationContext0, "can only instantiate non-static inner class by using default, no-argument constructor", sQLClientInfoException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `com.fasterxml.jackson.core.JsonFactory$Feature` from String \"can only instantiate non-static inner class by using default, no-argument constructor\": problem: null
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  ...
  public void test18()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("sourceRef", (DeserializationContext) null);
  ...
  public void test20()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("}m6|),e>((E}j1@>X:", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `com.fasterxml.jackson.databind.deser.CreatorProperty` from String \"}m6|),e>((E}j1@>X:\": not a valid representation: Cannot deserialize Map key of type `com.fasterxml.jackson.databind.deser.CreatorProperty` from String \"}m6|),e>((E}j1@>X:\": not a valid representation
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //  at [Source: UNKNOWN; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
  ...
  public void test21()  throws Throwable  {
      Class<CreatorProperty> class0 = CreatorProperty.class;
      JsonDeserializer<Float> jsonDeserializer0 = (JsonDeserializer<Float>) mock(JsonDeserializer.class, new ViolatedAssumptionAnswer());
      doReturn((Float) null).when(jsonDeserializer0).deserialize(any(com.fasterxml.jackson.core.JsonParser.class) , any(com.fasterxml.jackson.databind.DeserializationContext.class));
      StdKeyDeserializer.DelegatingKD stdKeyDeserializer_DelegatingKD0 = new StdKeyDeserializer.DelegatingKD(class0, jsonDeserializer0);
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      StdSubtypeResolver stdSubtypeResolver0 = new StdSubtypeResolver();
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("681", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("-881", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("(dYqUW2?wIK>f", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      UUID uUID0 = (UUID)stdKeyDeserializer0._parse("Unexpected end-of-String in base64 content", defaultDeserializationContext_Impl0);
  ...
  public void test33()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse(";aM1#Bw", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \";aM1#Bw\"
         //
  ...
  public void test34()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      URI uRI0 = (URI)stdKeyDeserializer0.deserializeKey("5Rx),=Yrz", defaultDeserializationContext_Impl0);
  ...
  public void test39()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("Z%qK|RLxvH9", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("5Rx),=Yrz", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("Ios@Fr1e)eq*>", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test52()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("xc1FnjM~I7%iADiO", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
