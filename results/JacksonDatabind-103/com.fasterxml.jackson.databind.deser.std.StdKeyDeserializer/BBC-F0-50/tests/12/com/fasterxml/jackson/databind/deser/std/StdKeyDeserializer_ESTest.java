...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("gh,zFuqauH:F6", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `com.fasterxml.jackson.databind.Module` from String \"gh,zFuqauH:F6\": not a valid representation: null
  ...
  public void test11()  throws Throwable  {
      ...
      CoreXMLDeserializers.Std coreXMLDeserializers_Std0 = new CoreXMLDeserializers.Std(class0, 297);
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(297, class0, coreXMLDeserializers_Std0);
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      RootNameLookup rootNameLookup0 = new RootNameLookup();
      ConfigOverrides configOverrides0 = new ConfigOverrides();
      ...
      File file0 = MockFile.createTempFile("JSON", "value not 'true' or 'false'", (File) mockFile0);
      JsonParser jsonParser0 = jsonFactory0.createParser(file0);
      InjectableValues.Std injectableValues_Std0 = new InjectableValues.Std();
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer0.deserializeKey("(P''VJU?O*", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `org.evosuite.runtime.mock.java.util.MockGregorianCalendar` from String \"(P''VJU?O*\": not a valid representation, problem: (org.evosuite.runtime.mock.java.lang.MockIllegalStateException) Internal error: unknown key type class org.evosuite.runtime.mock.java.util.MockGregorianCalendar
  ...
  public void test12()  throws Throwable  {
      ...
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, injectableValues_Std0);
      SQLException sQLException0 = new SQLException("&;rg@+$", "&;rg@+$");
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Cannot deserialize Map key of type `java.lang.Short` from String \"JSON\": problem: &;rg@+$
  ...
  public void test16()  throws Throwable  {
      ...
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, 27, pipedReader0, objectMapper0, charsToNameCanonicalizer0, (char[]) null, (-1615), (-2), true);
      HashMap<String, Object> hashMap0 = new HashMap<String, Object>();
      InjectableValues.Std injectableValues_Std0 = new InjectableValues.Std(hashMap0);
      ...
      try { 
        stdKeyDeserializer0._parse("kpa\"J3x;M=v", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"kpa\"J3x;M=v\": value not 'true' or 'false'
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("639", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("0<TA0?nn<z.", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("char[]", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("CxXPI'#2!&bM1*/", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey(".VB/sNuLKSo1C{5_", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("D*nyL:oRJ1|m`vVB", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      Class<Locale> class0 = Locale.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Object object0 = stdKeyDeserializer0.deserializeKey("com.fasterxml.jackson.databind.type.TypeFactory", (DeserializationContext) null);
      assertEquals("com.fasterxml.jackson.databind.type.typefactory", object0.toString());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("w*{(%^S~>b", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("274639", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("-539", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("*;$n$w", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test42()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("OKjlBo3J7H17}Xy@[LW", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"OKjlBo3J7H17}Xy@[LW\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test43()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      UUID uUID0 = (UUID)stdKeyDeserializer0._parse("59", (DeserializationContext) null);
  ...
  public void test44()  throws Throwable  {
      ...
      int int0 = stdKeyDeserializer_StringKD0._parseInt("59");
      assertEquals(59, int0);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer_EnumKD0._parse("fAs", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("com.fasterxml.jackson.databind.deser.std.SdKeyDeserializer$tringFactoryKeyDserializer", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"com.fasterxml.jackson.databind.deser.std.SdKeyDeserializer$tringFactoryKeyDserializer\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test52()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = (StdKeyDeserializer.StringKD)StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseInt("*;$n$w");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"*;$n$w\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test54()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("~1H46^</l6`KsmnB+", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
