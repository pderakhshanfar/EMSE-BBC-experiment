...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      FromStringDeserializer<JsonDeserializer<MockGregorianCalendar>> fromStringDeserializer0 = (FromStringDeserializer<JsonDeserializer<MockGregorianCalendar>>) mock(FromStringDeserializer.class, new ViolatedAssumptionAnswer());
  ...
  public void test08()  throws Throwable  {
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType((Class<?>) null);
      double double0 = stdKeyDeserializer_StringKD0._parseDouble("3F");
  ...
  public void test11()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      UUID uUID0 = (UUID)stdKeyDeserializer0._parse("NULL", defaultDeserializationContext_Impl0);
  ...
  public void test13()  throws Throwable  {
      ...
      BatchUpdateException batchUpdateException0 = new BatchUpdateException("com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$DelegatingKD", intArray0);
      SQLDataException sQLDataException0 = new SQLDataException((String) null, "com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$DelegatingKD", batchUpdateException0);
      // Undeclared exception!
      try { 
        stdKeyDeserializer0._weirdKey((DeserializationContext) null, "0", sQLDataException0);
  ...
  public void test14()  throws Throwable  {
      ...
      SQLClientInfoException sQLClientInfoException0 = new SQLClientInfoException("not a valid representation, problem: (%s) %s", "not a valid representation, problem: (%s) %s", hashMap1);
      SQLTransientException sQLTransientException0 = new SQLTransientException(sQLClientInfoException0);
      try { 
        stdKeyDeserializer_StringKD0._weirdKey(defaultDeserializationContext0, "N@7]L~if#6qz3O~m", sQLTransientException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `com.fasterxml.jackson.databind.type.ReferenceType` from String \"N@7]L~if#6qz3O~m\": problem: java.sql.SQLClientInfoException: not a valid representation, problem: (%s) %s
         //  at [Source: UNKNOWN; line: -1, column: -1]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  ...
  public void test15()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parseLong("com.fasterxml.jackson.databind.JsonSerializable$Base");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"com.fasterxml.jackson.databind.JsonSerializable$Base\"
         //
  ...
  public void test17()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("y~#lw4$}D>", defaultDeserializationContext_Impl0);
  ...
  public void test20()  throws Throwable  {
      ...
      JsonParser jsonParser0 = jsonFactory0.createParser(byteArray0, (-1876), (-887));
      HashMap<String, Object> hashMap0 = new HashMap<String, Object>();
      InjectableValues.Std injectableValues_Std0 = new InjectableValues.Std(hashMap0);
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("!aV", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Double` from String \"!aV\": not a valid representation: Cannot deserialize Map key of type `java.lang.Double` from String \"!aV\": not a valid representation
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("Unsupported serialization shape (%s) for Enum %s, not supported as %s annotation", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("fle", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("L#bwMS#]WSMBM.5G7", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("pd=JIuoR`h\"", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("fzle", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("V<)>rb&<iGOaotKezb", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      Class<Locale> class0 = Locale.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Locale locale0 = (Locale)stdKeyDeserializer0.deserializeKey("),types (", (DeserializationContext) null);
  ...
  public void test43()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("~j+bHLI!YQh[O", deserializationContext0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("CX&>Pf==1/D_B", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test50()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer_EnumKD0._parse("dv#Tv[@|T~", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("WNu8", defaultDeserializationContext_Impl0);
      assertEquals("WNu8", object0);
  }

  @Test(timeout = 4000)
  public void test52()  throws Throwable  {
      Class<Character> class0 = Character.TYPE;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-1730590154), class0);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
  ...
  public void test53()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-1730590154), class0);
      try { 
        stdKeyDeserializer0._parseDouble("FW-j7m");
        fail("Expecting exception: NumberFormatException");
  ...
  public void test54()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(65, class0, (FromStringDeserializer<?>) null);
  ...
  public void test55()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parseInt("b>7A6+_%ixUU");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"b>7A6+_%ixUU\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("P'dnj}ZP", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
