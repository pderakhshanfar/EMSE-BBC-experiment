...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("d.I", (DeserializationContext) null);
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("Default constructor for ", defaultDeserializationContext_Impl0);
  ...
  public void test03()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("tJrue", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(3076, class0, fromStringDeserializer0);
  ...
  public void test14()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("fatre", "$[[+-o)j}r2)T%:X,y");
      ...
      UTF8StreamJsonParser uTF8StreamJsonParser0 = new UTF8StreamJsonParser(iOContext0, 12, bufferedInputStream0, objectMapper0, byteQuadsCanonicalizer0, (byte[]) null, (-1840), 1104, true);
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("Unsupported container type (", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"Unsupported container type (\": not a valid representation, problem: (com.fasterxml.jackson.databind.exc.InvalidFormatException) Cannot deserialize Map key of type `java.lang.Boolean` from String \"Unsupported container type (\": value not 'true' or 'false'
  ...
  public void test15()  throws Throwable  {
      ...
      SQLTransientException sQLTransientException0 = new SQLTransientException(">{f5D`V/hBl,P3", "8:+M");
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, ">{f5D`V/hBl,P3", sQLTransientException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Long` from String \">{f5D`V/hBl,P3\": problem: >{f5D`V/hBl,P3
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      Class<CharBuffer> class0 = CharBuffer.class;
      Class<MockGregorianCalendar> class1 = MockGregorianCalendar.class;
      FromStringDeserializer.Std fromStringDeserializer_Std0 = new FromStringDeserializer.Std(class0, (-2461));
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(9, class1, fromStringDeserializer_Std0);
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      JsonParser jsonParser0 = jsonFactory0.createParser("Y_1`ZrfPD[|xML");
      ...
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("com.fasterxml.jackson.core.JsonGenerator$Feature", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `org.evosuite.runtime.mock.java.util.MockGregorianCalendar` from String \"com.fasterxml.jackson.core.JsonGenerator$Feature\": not a valid representation: Cannot deserialize Map key of type `org.evosuite.runtime.mock.java.util.MockGregorianCalendar` from String \"com.fasterxml.jackson.core.JsonGenerator$Feature\": not a valid representation
         //  at [Source: (String)\"Y_1`ZrfPD[|xML\"; line: 1, column: 0]
         //  at [Source: (String)\"Y_1`ZrfPD[|xML\"; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("}qfF5n<&#&367|h-", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer_StringKD0._parse("Cannot construct SimpleType for a Map (class: ", defaultDeserializationContext_Impl0);
  ...
  public void test35()  throws Throwable  {
      ...
      URI uRI0 = (URI)stdKeyDeserializer0.deserializeKey("com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$StringKD", (DeserializationContext) null);
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("AZ17znG_! V<jZ8", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("Lc5AZ]O6ws^9#", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test58()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseInt("b]7XA-e|\",xMA");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"b]7XA-e|\",xMA\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      Class<MockCalendar> class0 = MockCalendar.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-583), class0);
      ObjectMapper objectMapper0 = new ObjectMapper();
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0._weirdKey(deserializationContext0, "Tf)((8AEq3<nO7mR", batchUpdateException0);
        fail("Expecting exception: NullPointerException");
