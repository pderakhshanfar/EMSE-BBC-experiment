...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey(".%em", (DeserializationContext) null);
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("com.fasterxml.jackson.databind.ser.std.StdScalarSerializer", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test16()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("N-+N8.}gw");
      JsonFactory jsonFactory0 = new JsonFactory();
      ObjectMapper objectMapper0 = new ObjectMapper(jsonFactory0);
      CharsToNameCanonicalizer charsToNameCanonicalizer0 = CharsToNameCanonicalizer.createRoot();
      char[] charArray0 = new char[3];
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, 17, stringReader0, objectMapper0, charsToNameCanonicalizer0, charArray0, 12, 0, false);
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("N-+N8.}gw", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"N-+N8.}gw\": not a valid representation, problem: (com.fasterxml.jackson.databind.exc.InvalidFormatException) Cannot deserialize Map key of type `java.lang.Boolean` from String \"N-+N8.}gw\": value not 'true' or 'false'
  ...
  public void test17()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("q3!", defaultDeserializationContext_Impl0);
  ...
  public void test18()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType((Class<?>) null);
      try { 
        stdKeyDeserializer_StringKD0._parse("'Wcb;'hQ)!ot", defaultDeserializationContext_Impl0);
  ...
  public void test19()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("\":J)=^/nYB", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"\":J)=^/nYB\": value not 'true' or 'false'
  ...
  public void test21()  throws Throwable  {
      ...
      JsonParser jsonParser0 = jsonFactory0.createParser("|n)iN#BY");
      InjectableValues.Std injectableValues_Std0 = new InjectableValues.Std();
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("eeS|)", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.nio.CharBuffer` from String \"eeS|)\": not a valid representation: Cannot deserialize Map key of type `java.nio.CharBuffer` from String \"eeS|)\": not a valid representation
         //  at [Source: (String)\"|n)iN#BY\"; line: 1, column: 0]
         //  at [Source: (String)\"|n)iN#BY\"; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  ...
  public void test24()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("8o&x#: CIqIG&", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("483", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("(z Ri$VX9", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("X%zQ[qW<)i}XfM", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("%s!dMXXs", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("[3Gq", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test53()  throws Throwable  {
      ...
      SQLTimeoutException sQLTimeoutException0 = new SQLTimeoutException(" with 2 type parameters: class expects ", "QQenoY!C)5Q7LhdQ");
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, "QQenoY!C)5Q7LhdQ", sQLTimeoutException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.util.UUID` from String \"QQenoY!C)5Q7LhdQ\": problem:  with 2 type parameters: class expects 
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer_EnumKD0._parse("MoW", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test59()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("lU{", defaultDeserializationContext_Impl0);
  ...
  public void test60()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parseDouble("?cK7(9sl}b2B%3");
        fail("Expecting exception: NumberFormatException");
  ...
  public void test61()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseLong("szmjxHH6T'[#aU");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"szmjxHH6T'[#aU\"
         //
  ...
  public void test62()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parseInt("Qi=WowFJWPLZqb;");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"Qi=WowFJWPLZqb;\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test63()  throws Throwable  {
      Class<Boolean> class0 = Boolean.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(222, class0);
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      HashMap<String, ClientInfoStatus> hashMap0 = new HashMap<String, ClientInfoStatus>();
      SQLClientInfoException sQLClientInfoException0 = new SQLClientInfoException("\"5I`[;OJR!`&=nD", hashMap0);
      SQLRecoverableException sQLRecoverableException0 = new SQLRecoverableException("\"5I`[;OJR!`&=nD", "XUYD*XN", sQLClientInfoException0);
      // Undeclared exception!
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext_Impl0, "unable to parse key as Class", sQLRecoverableException0);
        fail("Expecting exception: NullPointerException");
