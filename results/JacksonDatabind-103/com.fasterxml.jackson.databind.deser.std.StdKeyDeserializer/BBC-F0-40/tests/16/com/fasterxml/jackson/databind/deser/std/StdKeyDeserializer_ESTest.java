...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("l|3", defaultDeserializationContext_Impl0);
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("xeofW", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test03()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-160), class0);
  ...
  public void test12()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Locale locale0 = (Locale)stdKeyDeserializer0._parse("a", defaultDeserializationContext_Impl0);
  ...
  public void test13()  throws Throwable  {
      ...
      IOContext iOContext0 = new IOContext(bufferRecycler0, stdKeyDeserializer0.TYPE_CLASS, false);
      StringReader stringReader0 = new StringReader("{,GVN3uzNzpY:{k");
      JsonFactory jsonFactory0 = new JsonFactory();
      DefaultSerializerProvider.Impl defaultSerializerProvider_Impl0 = new DefaultSerializerProvider.Impl();
      ObjectMapper objectMapper0 = new ObjectMapper(jsonFactory0, defaultSerializerProvider_Impl0, defaultDeserializationContext_Impl0);
      CharsToNameCanonicalizer charsToNameCanonicalizer0 = CharsToNameCanonicalizer.createRoot();
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, (-3278), stringReader0, objectMapper0, charsToNameCanonicalizer0);
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("{,GVN3uzNzpY:{k", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.util.Locale` from String \"{,GVN3uzNzpY:{k\": not a valid representation
  ...
  public void test14()  throws Throwable  {
      ...
      JsonParser jsonParser0 = jsonFactory0.createParser(charArray0, 2, 1019);
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(2108, class0, fromStringDeserializer0);
      SQLTransientException sQLTransientException0 = new SQLTransientException();
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, ")z%?ci0DqditcN( n", sQLTransientException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.util.Currency` from String \")z%?ci0DqditcN( n\": problem: null
  ...
  public void test16()  throws Throwable  {
      ...
      FromStringDeserializer.Std fromStringDeserializer_Std0 = new FromStringDeserializer.Std(class1, (-1993));
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(16, class0, fromStringDeserializer_Std0);
      try { 
        stdKeyDeserializer0._parse("SU3Q3pTla(T2?*", (DeserializationContext) null);
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer_EnumKD0.deserializeKey("com.fasterxml.jackson.databind.ObjectMapper$DefaultTyping", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      ...
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey(")z%?ci0DqditcN( n", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Object` from String \")z%?ci0DqditcN( n\": not a valid representation: Cannot deserialize Map key of type `java.lang.Object` from String \")z%?ci0DqditcN( n\": not a valid representation
         //  at [Source: (char[])\"\u0000\"; line: 1, column: 0]
         //  at [Source: (char[])\"\u0000\"; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("F!PT.K&", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0._parse("MhjNUM2IP", defaultDeserializationContext_Impl0);
      assertNull(object0);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("2`*tN", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("MhjNUM2IP", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("com.fasterxml.jackson.databind.introspect.VirtualAnnotatedMember", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("4]zW}3.jsR+", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      URI uRI0 = (URI)stdKeyDeserializer0.deserializeKey("com.fasterxml.jackson.annotation.ObjectIdGenerators", defaultDeserializationContext_Impl0);
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("_rFj", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("+>UC[KSm\"", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test43()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("WDR", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test48()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("com.fasterxml.jackson.core.util.TextBuffer", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test54()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("[5217pgd^", defaultDeserializationContext_Impl0);
      assertEquals("[5217pgd^", object0);
  }
  ...
  public void test55()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseDouble(":e-><4~('}");
        fail("Expecting exception: NumberFormatException");
  ...
  public void test56()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parseLong("1NZ73|6h+>NG 8LQ");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"1NZ73|6h+>NG 8LQ\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test58()  throws Throwable  {
      Class<Locale> class0 = Locale.class;
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-1618), class0);
      MockException mockException0 = new MockException();
      SQLInvalidAuthorizationSpecException sQLInvalidAuthorizationSpecException0 = new SQLInvalidAuthorizationSpecException("problem: %s", mockException0);
      // Undeclared exception!
      try { 
        stdKeyDeserializer0._weirdKey((DeserializationContext) null, "EHE#brvhRnknHcUQ", sQLInvalidAuthorizationSpecException0);
        fail("Expecting exception: NullPointerException");
