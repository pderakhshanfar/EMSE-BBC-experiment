...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-2076104699), class0);
      Class<?> class1 = stdKeyDeserializer0.getKeyClass();
  ...
  public void test05()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, ")[bW/$^", sQLTransientException0);
      assertNull(object0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Object object0 = stdKeyDeserializer0._parse("BSt<CpXS4]", defaultDeserializationContext_Impl0);
      assertNull(object0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      IOContext iOContext0 = new IOContext(bufferRecycler0, "$Qksu:0m", false);
      StringReader stringReader0 = new StringReader("nR{Z");
      CharsToNameCanonicalizer charsToNameCanonicalizer0 = CharsToNameCanonicalizer.createRoot();
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, (-1798313825), stringReader0, (ObjectCodec) null, charsToNameCanonicalizer0);
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("H`>C\"c/u+0V?\u0000H1u", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"H`>C\"c/u+0V?\u0000H1u\": not a valid representation, problem: (com.fasterxml.jackson.databind.exc.InvalidFormatException) Cannot deserialize Map key of type `java.lang.Boolean` from String \"H`>C\"c/u+0V?\u0000H1u\": value not 'true' or 'false'
         //  at [Source: (String)\"$Qksu:0m\"; line: 1, column: 0]
         //  at [Source: (String)\"$Qksu:0m\"; line: 1, column: 0]
         //
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, "type", sQLClientInfoException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.util.Locale` from String \"type\": problem: null
  ...
  public void test15()  throws Throwable  {
      ...
      DeserializationConfig deserializationConfig0 = new DeserializationConfig((BaseSettings) null, stdSubtypeResolver0, (SimpleMixInResolver) null, rootNameLookup0, configOverrides0);
      JsonFactory jsonFactory0 = new JsonFactory();
      JsonParser jsonParser0 = jsonFactory0.createParser("~5AQzksUCtkr");
      InjectableValues.Std injectableValues_Std0 = new InjectableValues.Std();
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("XEQHZZ3[^[(k[", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"XEQHZZ3[^[(k[\": not a valid representation: Cannot deserialize Map key of type `java.lang.Boolean` from String \"XEQHZZ3[^[(k[\": not a valid representation
         //  at [Source: (String)\"~5AQzksUCtkr\"; line: 1, column: 0]
         //  at [Source: (String)\"~5AQzksUCtkr\"; line: 1, column: 0]
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  ...
  public void test20()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parse("dddd[-]dd[-]dd[T]dd[:]dd(?:[:]dd)?(.d+)?(Z|[+-]dd(?:[:]?dd)?)?", (DeserializationContext) null);
  ...
  public void test21()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("j(g\"Pe#;?", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("e8M-", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      UUID uUID0 = (UUID)stdKeyDeserializer0.deserializeKey("com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$DelegatingKD", defaultDeserializationContext_Impl0);
  ...
  public void test25()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("qXo,!#y2*", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("]$]U;V;s", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      Class<Locale> class0 = Locale.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Locale locale0 = (Locale)stdKeyDeserializer0._parse("com.fasterxml.jackson.databind.ser.std.NumberSerializers$IntLikeSerializer", defaultDeserializationContext_Impl0);
  ...
  public void test28()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("com.fasterxml.jackson.databind.ser.std.NumberSerializers$IntLikeSerializer", defaultDeserializationContext_Impl0);
  ...
  public void test31()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0.deserializeKey("W", defaultDeserializationContext_Impl0);
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("*[Q%'", deserializationContext0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Class<Locale> class0 = Locale.class;
      CoreXMLDeserializers.Std coreXMLDeserializers_Std0 = new CoreXMLDeserializers.Std(class0, 4502);
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(1422, class0, coreXMLDeserializers_Std0);
  ...
  public void test36()  throws Throwable  {
      ...
      FromStringDeserializer.Std fromStringDeserializer_Std0 = new FromStringDeserializer.Std(class1, 84);
  ...
  public void test39()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("fTFmV>dpD4%;36", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NumberFormatException");
  ...
  public void test41()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("com.fasterxml.jackson.databind.JsonSerializer", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test42()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0.deserializeKey("82", (DeserializationContext) null);
  ...
  public void test43()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("[a?[2lq");
      ObjectMapper objectMapper0 = new ObjectMapper();
      CharsToNameCanonicalizer charsToNameCanonicalizer0 = CharsToNameCanonicalizer.createRoot();
      char[] charArray0 = new char[0];
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, (-32768), stringReader0, objectMapper0, charsToNameCanonicalizer0, charArray0, (-1624833180), 3, false);
      ...
      try { 
        stdKeyDeserializer0._parse("[a?[2lq", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"[a?[2lq\": value not 'true' or 'false'
  ...
  public void test50()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("R0lfd_6>By?c", defaultDeserializationContext_Impl0);
      assertEquals("R0lfd_6>By?c", object0);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseLong("com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$DelegatingKD");
        fail("Expecting exception: NumberFormatException");
  ...
  public void test53()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer_StringKD0._weirdKey((DeserializationContext) null, "not a valid representation, problem: (%s) %s", sQLTimeoutException0);
        fail("Expecting exception: NullPointerException");
