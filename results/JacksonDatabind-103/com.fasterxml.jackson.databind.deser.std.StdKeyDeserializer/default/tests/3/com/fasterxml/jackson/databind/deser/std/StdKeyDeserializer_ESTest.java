...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      doReturn(7).when(fromStringDeserializer0)._deserialize(anyString() , any(com.fasterxml.jackson.databind.DeserializationContext.class));
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("falTe", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.util.UUID` from String \"falTe\": not a valid representation, problem: (java.lang.NullPointerException) null
  ...
  public void test12()  throws Throwable  {
      ...
      ReaderBasedJsonParser readerBasedJsonParser0 = new ReaderBasedJsonParser(iOContext0, (-821), pipedReader0, objectMapper0, charsToNameCanonicalizer0);
      ...
      SQLRecoverableException sQLRecoverableException0 = new SQLRecoverableException("]Olo?.~|Tw'ix?3@ F", "+'mBqwWfg9A4Li9");
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, "Trailing token (of type %s) found after value (bound as %s): not allowed as per `DeserializationFeature.FAIL_ON_TRAILING_TOKENS`", sQLRecoverableException0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"Trailing token (of type %s) found after value (bound as %s): not allowed as per `DeserializationFeature.FAIL_ON_TRAILING_TOKENS`\": problem: ]Olo?.~|Tw'ix?3@ F
  ...
  public void test14()  throws Throwable  {
      ...
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, jsonParser0, injectableValues_Std0);
      try { 
        stdKeyDeserializer0._parse("falTe", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"falTe\": value not 'true' or 'false'
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer_EnumKD0.deserializeKey("}|EH[p*J V@x)`", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("571", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parse("[parameter #", (DeserializationContext) null);
  ...
  public void test23()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      UUID uUID0 = (UUID)stdKeyDeserializer0.deserializeKey("*9pr8~P>2*oqy|x_e", (DeserializationContext) null);
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("Oqqi", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      Class<Locale> class0 = Locale.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Locale locale0 = (Locale)stdKeyDeserializer0._parse("@Uv6-U=", (DeserializationContext) null);
      assertEquals("@uv6", locale0.getLanguage());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("falke", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("lqqi", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("hIqW#I|", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("A`}wc+l/BLdt;C", (DeserializationContext) null);
  ...
  public void test33()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0._parse("371", (DeserializationContext) null);
      assertEquals((short)371, object0);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("b#<tOXJBSkdQI=%b", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0.deserializeKey("51", (DeserializationContext) null);
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("tnNK6N", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("T,q[3ePf!}(]i$oR", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"T,q[3ePf!}(]i$oR\"
         //
  ...
  public void test39()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("u]`'M=&IU1-mfH{", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"u]`'M=&IU1-mfH{\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test47()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseInt("F+N");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"F+N\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test48()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = BeanDeserializerFactory.instance;
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      SQLDataException sQLDataException0 = new SQLDataException("not a valid representation: %s");
      // Undeclared exception!
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext_Impl0, "not a valid representation: %s", sQLDataException0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test49()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("7", defaultDeserializationContext_Impl0);
