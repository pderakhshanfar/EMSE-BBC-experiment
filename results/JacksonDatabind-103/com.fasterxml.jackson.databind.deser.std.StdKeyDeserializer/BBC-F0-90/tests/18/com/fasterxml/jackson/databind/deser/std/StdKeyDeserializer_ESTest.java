...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = stdKeyDeserializer0.deserializeKey("5", deserializationContext0);
  ...
  public void test02()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("tq$&O\"X@jf4|{:*.", defaultDeserializationContext_Impl0);
      assertEquals("tq$&O\"X@jf4|{:*.", object0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey(".w{$\"_b^pcKrm", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test06()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-1026), class0);
  ...
  public void test15()  throws Throwable  {
      ...
      FromStringDeserializer<ClientInfoStatus> fromStringDeserializer0 = (FromStringDeserializer<ClientInfoStatus>) mock(FromStringDeserializer.class, new ViolatedAssumptionAnswer());
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer(2561, class0, fromStringDeserializer0);
  ...
  public void test17()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      UUID uUID0 = (UUID)stdKeyDeserializer0._parse("zlW+o1S9pjc", (DeserializationContext) null);
  ...
  public void test18()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0.deserializeKey("LhYkBQ", defaultDeserializationContext0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.lang.Boolean` from String \"LhYkBQ\": not a valid representation, problem: (com.fasterxml.jackson.databind.exc.InvalidFormatException) Cannot deserialize Map key of type `java.lang.Boolean` from String \"LhYkBQ\": value not 'true' or 'false'
         //
  ...
  public void test19()  throws Throwable  {
      ...
      DefaultDeserializationContext defaultDeserializationContext0 = defaultDeserializationContext_Impl0.createInstance(deserializationConfig0, (JsonParser) null, injectableValues_Std0);
      DataTruncation dataTruncation0 = new DataTruncation(1, true, false, (-1468578549), 1565);
      try { 
        stdKeyDeserializer0._weirdKey(defaultDeserializationContext0, "com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$StringKD", dataTruncation0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Cannot deserialize Map key of type `java.util.UUID` from String \"com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer$StringKD\": problem: Data truncation
         //
         verifyException("com.fasterxml.jackson.databind.exc.InvalidFormatException", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseLong("com.fasterxml.jackson.databind.deser.impl.ObjectIdReader");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"com.fasterxml.jackson.databind.deser.impl.ObjectIdReader\"
         //
  ...
  public void test24()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer_EnumKD0._parse("Internal error: unknown key type ", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("3D$ixgNQ@8-", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer0._parse("@3b%QLZ2Ujm~e|pm~", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("Qxb{(", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
  ...
  public void test37()  throws Throwable  {
      ...
      try { 
        stdKeyDeserializer0._parse("|#PI2", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"|#PI2\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("5*xaMbVfm", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("z//v$l_", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("Tm*yo#^073,WK`acA-", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test45()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("C96y)W(iswh0J3EMS", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
  ...
  public void test49()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("pZ?", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
  ...
  public void test50()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("qym?", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("LGQ1xsV&V7{G!", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test53()  throws Throwable  {
      Class<UUID> class0 = UUID.class;
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      UUID uUID0 = (UUID)stdKeyDeserializer0.deserializeKey("34", (DeserializationContext) null);
      assertEquals((-9079256848728588288L), uUID0.getLeastSignificantBits());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-686), class0);
      try { 
        stdKeyDeserializer0._parseDouble("0'pSySs+Fx^Z<H_`G");
        fail("Expecting exception: NumberFormatException");
  ...
  public void test59()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("UGj45<r", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"UGj45<r\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      ...
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      try { 
        stdKeyDeserializer_StringKD0._parseInt("fh<[FgWT3/d");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"fh<[FgWT3/d\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      BeanDeserializerFactory beanDeserializerFactory0 = new BeanDeserializerFactory(deserializerFactoryConfig0);
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      SQLWarning sQLWarning0 = new SQLWarning("<7", "<7");
      // Undeclared exception!
      try { 
        stdKeyDeserializer_StringKD0._weirdKey(defaultDeserializationContext_Impl0, "CIgV", sQLWarning0);
        fail("Expecting exception: NullPointerException");
