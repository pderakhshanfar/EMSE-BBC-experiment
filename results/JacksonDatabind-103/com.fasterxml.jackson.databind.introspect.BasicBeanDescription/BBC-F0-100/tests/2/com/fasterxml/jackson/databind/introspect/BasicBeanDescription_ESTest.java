...
public class BasicBeanDescription_ESTest extends BasicBeanDescription_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      BasicBeanDescription basicBeanDescription0 = BasicClassIntrospector.LONG_DESC;
      Vector<BeanPropertyDefinition> vector0 = new Vector<BeanPropertyDefinition>(60);
  ...
  public void test18()  throws Throwable  {
      ...
      PropertyName.construct("forSerialization");
      propertyName0.withNamespace("forSerialization");
      Class<TypeNameIdResolver>[] classArray0 = (Class<TypeNameIdResolver>[]) Array.newInstance(Class.class, 0);
      PropertyName.construct("XEP,SAjW5t^>lx", "XEP,SAjW5t^>lx");
      // Undeclared exception!
      try { 
        basicBeanDescription0.findDefaultViews();
        fail("Expecting exception: NullPointerException");
  ...
  public void test57()  throws Throwable  {
      BasicBeanDescription basicBeanDescription0 = BasicClassIntrospector.LONG_DESC;
      Vector<BeanPropertyDefinition> vector0 = new Vector<BeanPropertyDefinition>(60, 60);
      basicBeanDescription0._properties = (List<BeanPropertyDefinition>) vector0;
      vector0.add((BeanPropertyDefinition) null);
      // Undeclared exception!
      try { 
        basicBeanDescription0.removeProperty(" AhLFjQ<5g6t8ko");
        fail("Expecting exception: NullPointerException");
