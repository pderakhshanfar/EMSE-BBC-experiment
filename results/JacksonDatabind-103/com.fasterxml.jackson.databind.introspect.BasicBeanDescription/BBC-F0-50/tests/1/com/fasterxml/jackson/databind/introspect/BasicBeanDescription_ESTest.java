...
public class BasicBeanDescription_ESTest extends BasicBeanDescription_ESTest_scaffolding {
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        basicBeanDescription0._createConverter(atomicReference0);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // AnnotationIntrospector returned Converter definition of type java.util.concurrent.atomic.AtomicReference; expected type Converter or Class<Converter> instead
         //
         verifyException("com.fasterxml.jackson.databind.introspect.BasicBeanDescription", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      BasicBeanDescription basicBeanDescription0 = BasicClassIntrospector.BOOLEAN_DESC;
      boolean boolean0 = basicBeanDescription0.removeProperty("]~(1/?Dk");
      assertFalse(boolean0);
  }
