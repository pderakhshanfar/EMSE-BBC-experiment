...
public class BasicBeanDescription_ESTest extends BasicBeanDescription_ESTest_scaffolding {
  ...
  public void test34()  throws Throwable  {
      BasicBeanDescription basicBeanDescription0 = BasicClassIntrospector.INT_DESC;
      PropertyName propertyName0 = PropertyName.construct("AO3^EGcvA(SwxZ<zi", "AO3^EGcvA(SwxZ<zi");
      Vector<BeanPropertyDefinition> vector0 = new Vector<BeanPropertyDefinition>();
      basicBeanDescription0._properties = (List<BeanPropertyDefinition>) vector0;
      vector0.add((BeanPropertyDefinition) null);
      // Undeclared exception!
  ...
  public void test44()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Cannot deserialize value of type `com.fasterxml.jackson.databind.DeserializationFeature` from String \"com.fasterxml.jackson.databind.DeserializationFeature\": value not one of declared Enum instance names: [READ_ENUMS_USING_TO_STRING, USE_LONG_FOR_INTS, ACCEPT_EMPTY_STRING_AS_NULL_OBJECT, FAIL_ON_MISSING_EXTERNAL_TYPE_ID_PROPERTY, USE_BIG_DECIMAL_FOR_FLOATS, FAIL_ON_INVALID_SUBTYPE, READ_UNKNOWN_ENUM_VALUES_AS_NULL, WRAP_EXCEPTIONS, FAIL_ON_NULL_FOR_PRIMITIVES, FAIL_ON_MISSING_CREATOR_PROPERTIES, FAIL_ON_NULL_CREATOR_PROPERTIES, USE_JAVA_ARRAY_FOR_JSON_ARRAY, FAIL_ON_UNKNOWN_PROPERTIES, FAIL_ON_NUMBERS_FOR_ENUMS, FAIL_ON_READING_DUP_TREE_KEY, ADJUST_DATES_TO_CONTEXT_TIME_ZONE, EAGER_DESERIALIZER_FETCH, READ_DATE_TIMESTAMPS_AS_NANOSECONDS, ACCEPT_SINGLE_VALUE_AS_ARRAY, READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE, ACCEPT_FLOAT_AS_INT, FAIL_ON_TRAILING_TOKENS, UNWRAP_ROOT_VALUE, USE_BIG_INTEGER_FOR_INTS, ACCEPT_EMPTY_ARRAY_AS_NULL_OBJECT, FAIL_ON_IGNORED_PROPERTIES, UNWRAP_SINGLE_VALUE_ARRAYS, FAIL_ON_UNRESOLVED_OBJECT_IDS]
  ...
  public void test57()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        basicBeanDescription0.removeProperty("com.fasterxml.jackson.databind.introspect.BasicBeanDescription");
        fail("Expecting exception: NullPointerException");
  ...
  public void test61()  throws Throwable  {
      ...
      AnnotatedMethod annotatedMethod0 = basicBeanDescription0.findMethod("Can not use ObjectMapper with non-blocking parser", classArray0);
      assertNull(annotatedMethod0);
  }
