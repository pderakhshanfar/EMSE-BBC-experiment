...
public class BasicDeserializerFactory_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.databind.JsonDeserializer", false, BasicDeserializerFactory_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("com.fasterxml.jackson.databind.deser.DefaultDeserializationContext$Impl", false, BasicDeserializerFactory_ESTest_scaffolding.class.getClassLoader()));
