...
public class BasicDeserializerFactory_ESTest extends BasicDeserializerFactory_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      AsPropertyTypeDeserializer asPropertyTypeDeserializer0 = new AsPropertyTypeDeserializer(simpleType0, classNameIdResolver0, "java.com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer", false, simpleType0);
  ...
  public void test32()  throws Throwable  {
      ...
      VirtualAnnotatedMember virtualAnnotatedMember0 = new VirtualAnnotatedMember(typeResolutionContext_Basic0, class1, "Failed to parse type '%s' (remaining: '%s'): %s", simpleType0);
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      AsExternalTypeDeserializer asExternalTypeDeserializer0 = new AsExternalTypeDeserializer(collectionType0, classNameIdResolver0, "uPT06lI-P", false, referenceType0);
  ...
  public void test51()  throws Throwable  {
      ...
      AsPropertyTypeDeserializer asPropertyTypeDeserializer0 = new AsPropertyTypeDeserializer(collectionType0, classNameIdResolver0, "java.java.io.InputStream", true, (JavaType) null, jsonTypeInfo_As0);
      POJOPropertiesCollector pOJOPropertiesCollector0 = mock(POJOPropertiesCollector.class, new ViolatedAssumptionAnswer());
      doReturn((AnnotatedClass) null).when(pOJOPropertiesCollector0).getClassDef();
      doReturn((MapperConfig) null).when(pOJOPropertiesCollector0).getConfig();
      doReturn((ObjectIdInfo) null).when(pOJOPropertiesCollector0).getObjectIdInfo();
      ...
      JsonDeserializer<?> jsonDeserializer0 = beanDeserializerFactory1._findCustomCollectionLikeDeserializer(collectionType0, (DeserializationConfig) null, basicBeanDescription0, asPropertyTypeDeserializer0, (JsonDeserializer<?>) null);
      assertNull(jsonDeserializer0);
  }
