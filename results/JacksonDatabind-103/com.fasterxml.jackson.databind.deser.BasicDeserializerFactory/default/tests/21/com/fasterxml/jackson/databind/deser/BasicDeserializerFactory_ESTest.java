...
public class BasicDeserializerFactory_ESTest extends BasicDeserializerFactory_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      ...
      JsonDeserializer<?> jsonDeserializer0 = beanDeserializerFactory0.findDefaultDeserializer(deserializationContext0, javaTypeArray0[0], basicBeanDescription0);
  ...
  public void test53()  throws Throwable  {
      ...
      CollectionType collectionType0 = CollectionType.construct(class0, typeBindings0, javaTypeArray0[1], javaTypeArray0, javaTypeArray0[2]);
      ...
      MapType mapType0 = MapType.construct((Class<?>) class2, typeBindings0, javaTypeArray0[1], javaTypeArray0, (JavaType) referenceType0, javaTypeArray0[1]);
      TypeFactory typeFactory0 = TypeFactory.defaultInstance();
      ClassNameIdResolver classNameIdResolver0 = new ClassNameIdResolver(referenceType0, typeFactory0);
      AsExternalTypeDeserializer asExternalTypeDeserializer0 = new AsExternalTypeDeserializer(collectionType0, classNameIdResolver0, "QU]HOUIYyksY>7]+~", true, javaTypeArray0[1]);
