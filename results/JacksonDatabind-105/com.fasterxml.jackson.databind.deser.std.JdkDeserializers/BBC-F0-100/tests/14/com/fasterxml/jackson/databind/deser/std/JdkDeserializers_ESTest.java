...
public class JdkDeserializers_ESTest extends JdkDeserializers_ESTest_scaffolding {
  ...
  public void test5()  throws Throwable  {
      Class<String> class0 = String.class;
      JsonDeserializer<?> jsonDeserializer0 = JdkDeserializers.find(class0, "DeserializationProblemHandler.handleWeirdNativeValue() for type %s returned value of type %s");
      assertNull(jsonDeserializer0);
  }
