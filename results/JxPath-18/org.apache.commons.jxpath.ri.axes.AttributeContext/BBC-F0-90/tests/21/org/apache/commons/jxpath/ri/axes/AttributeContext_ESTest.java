...
public class AttributeContext_ESTest extends AttributeContext_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      QName qName0 = new QName("8-R; %`/C`p", "Factory did not assign a collection to variable '");
      InitialContext initialContext0 = (InitialContext)jXPathContextReferenceImpl0.getAbsoluteRootContext();
      NodeNameTest nodeNameTest0 = new NodeNameTest(qName0, "nD`EtJp8OzYB*LbQ@)c");
  ...
  public void test02()  throws Throwable  {
      ...
      attributeContext0.setPosition(2821);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      JXPathContextReferenceImpl jXPathContextReferenceImpl0 = (JXPathContextReferenceImpl)JXPathContext.newContext((Object) null);
      QName qName0 = new QName("8-R; %`F|/C`p");
  ...
  public void test05()  throws Throwable  {
      JXPathContextReferenceImpl jXPathContextReferenceImpl0 = (JXPathContextReferenceImpl)JXPathContext.newContext((Object) null);
      QName qName0 = new QName("8-R; %`F|/C`p", "8-R; %`F|/C`p");
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // No such variable: '8-R; %`F|/C`p:8-R; %`F|/C`p'
         //
  ...
  public void test06()  throws Throwable  {
      JXPathContextReferenceImpl jXPathContextReferenceImpl0 = (JXPathContextReferenceImpl)JXPathContext.newContext((Object) null);
      QName qName0 = new QName("8-R; %`/C`p", "Factory did not Jssign a collection to variable '");
      BeanPointer beanPointer0 = (BeanPointer)NodePointer.newNodePointer(qName0, "Factory did not Jssign a collection to variable '", (Locale) null);
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Undefined variable: 8-R; %`/C`p:Factory did not Jssign a collection to variable '
         //
  ...
  public void test08()  throws Throwable  {
      ...
      NodeNameTest nodeNameTest0 = new NodeNameTest(qName0, "s.woP_%\"");
      AttributeContext attributeContext0 = new AttributeContext(unionContext0, nodeNameTest0);
      // Undeclared exception!
      try { 
        attributeContext0.nextNode();
  ...
  public void test11()  throws Throwable  {
      ...
      BasicNodeSet basicNodeSet0 = new BasicNodeSet();
      NodeSetContext nodeSetContext0 = new NodeSetContext((EvalContext) null, basicNodeSet0);
      nodeSetContext0.setPosition((-2121));
      AttributeContext attributeContext0 = new AttributeContext(nodeSetContext0, nodeNameTest0);
      // Undeclared exception!
      try { 
        attributeContext0.nextNode();
  ...
  public void test14()  throws Throwable  {
      ...
      QName qName0 = new QName(",jf!4Rd'o1rHKCg+HwJ", " but object was null.  Terminating to avoid stack recursion.");
      NodeNameTest nodeNameTest0 = new NodeNameTest(qName0);
      AttributeContext attributeContext0 = new AttributeContext(unionContext0, nodeNameTest0);
  ...
  public void test15()  throws Throwable  {
      ProcessingInstructionTest processingInstructionTest0 = new ProcessingInstructionTest("[@p|6C2zNNE$,Qg dT");
  ...
  public void test17()  throws Throwable  {
      ...
      NodeNameTest nodeNameTest0 = new NodeNameTest(qName0, (String) null);
      AttributeContext attributeContext0 = new AttributeContext(evalContext0, nodeNameTest0);
      boolean boolean0 = attributeContext0.setPosition(2911);
  ...
  public void test18()  throws Throwable  {
      JXPathContextReferenceImpl jXPathContextReferenceImpl0 = (JXPathContextReferenceImpl)JXPathContext.newContext((Object) null);
      QName qName0 = new QName(" 6(", "bd/';lX:9(B'!R.@n*=");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      RootContext rootContext0 = new RootContext(jXPathContextReferenceImpl0, variablePointer0);
      InitialContext initialContext0 = (InitialContext)rootContext0.getVariableContext(qName0);
      NodeNameTest nodeNameTest0 = new NodeNameTest(qName0, "bd/';lX:9(B'!R.@n*=");
      DescendantContext descendantContext0 = new DescendantContext(initialContext0, false, nodeNameTest0);
      AttributeContext attributeContext0 = new AttributeContext(descendantContext0, nodeNameTest0);
      // Undeclared exception!
      try { 
        attributeContext0.setPosition(1561);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Undefined variable:  6(:bd/';lX:9(B'!R.@n*=
         //
         verifyException("org.apache.commons.jxpath.ri.model.VariablePointer$1", e);
      }
  }
