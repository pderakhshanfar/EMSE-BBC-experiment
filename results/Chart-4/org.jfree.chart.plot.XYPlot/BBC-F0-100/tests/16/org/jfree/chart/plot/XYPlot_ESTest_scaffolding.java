...
public class XYPlot_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.event.HierarchyBoundsListener", false, XYPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Connection", false, XYPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Statement", false, XYPlot_ESTest_scaffolding.class.getClassLoader()));
  }
