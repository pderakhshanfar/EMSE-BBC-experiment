...
public class FormElement_ESTest extends FormElement_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Document document0 = Parser.parseBodyFragment("", "iRc");
  ...
  public void test02()  throws Throwable  {
      ...
      Document document0 = Parser.parse("QcJ`RZM2~r-)&9cRa0X", "M");
  ...
  public void test03()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.htmlDefault;
      Tag tag0 = Tag.valueOf("+2Xjhb4!li%", parseSettings0);
      Attributes attributes0 = new Attributes();
      FormElement formElement0 = new FormElement(tag0, "+2Xjhb4!li%", attributes0);
      Document document0 = new Document("+2Xjhb4!li%");
  ...
  public void test04()  throws Throwable  {
      Attributes attributes0 = new Attributes();
      Tag tag0 = Tag.valueOf("O,_sqg9v;yASNO$7x");
      FormElement formElement0 = new FormElement(tag0, "O,_sqg9v;yASNO$7x", attributes0);
      Document document0 = Parser.parse("O,_sqg9v;yASNO$7x", "O,_sqg9v;yASNO$7x");
  ...
  public void test06()  throws Throwable  {
      ...
      FormElement formElement1 = formElement0.addElement(document0);
      assertEquals("JMvy", formElement1.nodeName());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Tag tag0 = Tag.valueOf("a!a;>/X(kQxH ?(aci");
      Attributes attributes0 = new Attributes();
      FormElement formElement0 = new FormElement(tag0, "POST", attributes0);
      Document document0 = Parser.parse("a!a;>/X(kQxH ?(aci", "POST");
  ...
  public void test09()  throws Throwable  {
      Attributes attributes0 = new Attributes();
      Attributes attributes1 = attributes0.put("[X^BRL", "select");
      Tag tag0 = Tag.valueOf("[X^BRL");
      String[] stringArray0 = new String[0];
      attributes1.keys = stringArray0;
      FormElement formElement0 = new FormElement(tag0, "e;,E%B^ 6}'zRGW", attributes1);
      // Undeclared exception!
      try { 
        formElement0.submit();
  ...
  public void test11()  throws Throwable  {
      ...
      Attributes attributes0 = new Attributes();
      FormElement formElement0 = new FormElement(tag0, "+2Xjhb4!li%", attributes0);
      CDataNode cDataNode0 = new CDataNode("+2Xjhb4!li%");
  ...
  public void test12()  throws Throwable  {
      ...
      CDataNode cDataNode0 = new CDataNode("oPamL8bH8;wUoBG+6x_");
      Attributes attributes0 = cDataNode0.attributes();
      FormElement formElement0 = new FormElement(tag0, "if%k)", attributes0);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      Tag tag0 = Tag.valueOf("5SC=F#wj4");
  ...
  public void test18()  throws Throwable  {
      ...
      attributes1.put("checked", "select");
      attributes1.putIgnoreCase("type", "radio");
      List<Connection.KeyVal> list0 = formElement0.formData();
