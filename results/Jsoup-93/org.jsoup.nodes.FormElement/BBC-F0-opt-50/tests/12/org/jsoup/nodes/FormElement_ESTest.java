...
public class FormElement_ESTest extends FormElement_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Tag tag0 = Tag.valueOf("che{wcked");
      CDataNode cDataNode0 = new CDataNode("select");
      Attributes attributes0 = cDataNode0.attributes();
      FormElement formElement0 = new FormElement(tag0, "select", attributes0);
      formElement0.prependChild(cDataNode0);
      formElement0.removeChild(cDataNode0);
      assertEquals("che{wcked", formElement0.normalName());
  }
  ...
  public void test03()  throws Throwable  {
      Tag tag0 = Tag.valueOf("che{wcked");
      Attributes attributes0 = new Attributes();
      FormElement formElement0 = new FormElement(tag0, "che{wcked", attributes0);
      formElement0.setSiblingIndex((-1207));
      FormElement formElement1 = formElement0.addElement(formElement0);
  ...
  public void test04()  throws Throwable  {
      ...
      Document document0 = new Document("`Tg+9AE<KxT(&Q");
  ...
  public void test05()  throws Throwable  {
      Tag tag0 = Tag.valueOf("(P`pWu1FVL]+%rTi.");
      Attributes attributes0 = new Attributes();
      FormElement formElement0 = new FormElement(tag0, "option[selected]", attributes0);
      Document document0 = Parser.parse("(P`pWu1FVL]+%rTi.", "(P`pWu1FVL]+%rTi.");
  ...
  public void test07()  throws Throwable  {
      Attributes attributes0 = new Attributes();
      Tag tag0 = Tag.valueOf("QMWv");
      FormElement formElement0 = new FormElement(tag0, "QMWv", attributes0);
      attributes0.put("method", "QMWv");
  ...
  public void test08()  throws Throwable  {
      ...
      Attribute attribute1 = new Attribute("METHOD", "name", attributes1);
  ...
  public void test09()  throws Throwable  {
      Tag tag0 = Tag.valueOf("hecPe<");
      Attributes attributes0 = new Attributes();
      FormElement formElement0 = new FormElement(tag0, "hecPe<", attributes0);
      CDataNode cDataNode0 = new CDataNode("ryYGR:?");
  ...
  public void test10()  throws Throwable  {
      ...
      Document document0 = Parser.parseBodyFragment("@d7ivs`p:$y(W|", "noframes");
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      cDataNode1.setSiblingIndex((-1969141442));
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      Tag tag0 = Tag.valueOf("select");
      Element element0 = new Element(tag0, "select", attributes0);
      attributes0.add("disabled", "PNNC9M=U`CNSa)7T");
  ...
  public void test19()  throws Throwable  {
      ...
      Tag tag0 = Tag.valueOf("9A](+YMl*", parseSettings0);
      Attributes attributes0 = new Attributes();
      FormElement formElement0 = new FormElement(tag0, "", attributes0);
      Parser parser0 = Parser.htmlParser();
      Document document0 = parser0.parseInput("checkbox", "");
  ...
  public void test21()  throws Throwable  {
      String string0 = "Imj@*Y4j\\u";
      Tag tag0 = Tag.valueOf(string0);
      Attributes attributes0 = new Attributes();
      Attributes attributes1 = attributes0.add("action", "5;");
      FormElement formElement0 = new FormElement(tag0, "T?KKL7a^l\"?#jS`K", attributes1);
      // Undeclared exception!
      try { 
        formElement0.submit();
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      Attributes attributes0 = new Attributes();
      FormElement formElement0 = new FormElement(tag0, "G4Z&-p6Ev", attributes0);
      // Undeclared exception!
      try { 
