...
public class FormElement_ESTest extends FormElement_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      CDataNode cDataNode0 = new CDataNode("qc%{gG+t^'$G");
      Attributes attributes0 = cDataNode0.attributes();
      FormElement formElement0 = new FormElement(tag0, "qc%{gG+t^'$G", attributes0);
      PseudoTextElement pseudoTextElement0 = new PseudoTextElement(tag0, "action", attributes0);
      formElement0.setSiblingIndex((-3232));
      FormElement formElement1 = formElement0.addElement(pseudoTextElement0);
      assertEquals((-3232), formElement1.siblingIndex());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Tag tag0 = Tag.valueOf("dd\"nDv>0IZ{4}");
      Attributes attributes0 = new Attributes();
      Attributes attributes1 = attributes0.add(":containsOwn(", "[%S*=%S]");
      Attributes attributes2 = attributes1.put("0!@>", false);
      FormElement formElement0 = new FormElement(tag0, "Attributes incorrectly present on end tag", attributes2);
  ...
  public void test06()  throws Throwable  {
      ...
      CDataNode cDataNode0 = new CDataNode("POT");
      Attributes attributes0 = cDataNode0.attributes();
      Attributes attributes1 = attributes0.put("method", "=h");
      Attributes attributes2 = attributes1.add("option", "option");
      String[] stringArray0 = new String[1];
      attributes2.vals = stringArray0;
      FormElement formElement0 = new FormElement(tag0, "%v!J6Ia", attributes2);
      // Undeclared exception!
      try { 
        formElement0.submit();
  ...
  public void test09()  throws Throwable  {
      Tag tag0 = Tag.valueOf("0\"%h}Jj,$^^-XisR");
      CDataNode cDataNode0 = new CDataNode((String) null);
      Attributes attributes0 = cDataNode0.attributes();
      FormElement formElement0 = new FormElement(tag0, "0\"%h}Jj,$^^-XisR", attributes0);
  ...
  public void test12()  throws Throwable  {
      Attributes attributes0 = new Attributes();
      Attributes attributes1 = attributes0.add("method", "pDTt");
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      Tag tag0 = Tag.valueOf("select", parseSettings0);
      Attributes attributes2 = attributes0.put("PFUQUT", false);
      FormElement formElement0 = new FormElement(tag0, "JQC-BU12Z%|HXBB8L", attributes1);
  ...
  public void test18()  throws Throwable  {
      ...
      Tag tag0 = Tag.valueOf("select");
      FormElement formElement0 = new FormElement(tag0, "select", attributes0);
      attributes0.put("name", "ryRy%]asi_(tEL.");
      formElement0.addElement(formElement0);
  ...
  public void test22()  throws Throwable  {
      Tag tag0 = Tag.valueOf("Nm@fc}Zf6jmV8\"*@");
      Attributes attributes0 = new Attributes();
      Attributes attributes1 = attributes0.put("action", "option[selected]");
