...
public class FormElement_ESTest extends FormElement_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Tag tag0 = Tag.valueOf("EM+|a`");
      Attributes attributes0 = new Attributes();
      FormElement formElement0 = new FormElement(tag0, "EM+|a`", attributes0);
      Parser parser0 = Parser.xmlParser();
      Document document0 = parser0.parseInput("mq0H&\"x'xz.R", "EM+|a`");
      formElement0.prependChild(document0);
      formElement0.removeChild(document0);
      assertEquals("em+|a`", formElement0.normalName());
  }
  ...
  public void test03()  throws Throwable  {
      Tag tag0 = Tag.valueOf("aep|Lt8VBio!");
      Attributes attributes0 = new Attributes();
      FormElement formElement0 = new FormElement(tag0, "option[selected]", attributes0);
      Document document0 = Parser.parseBodyFragment("[%s!=%s]", "ScriptDataEscapedEndTagOpen");
  ...
  public void test04()  throws Throwable  {
      ...
      formElement0.siblingIndex = (-2869);
  ...
  public void test07()  throws Throwable  {
      Tag tag0 = Tag.valueOf("O*aSG`");
      Attributes attributes0 = new Attributes();
      Attributes attributes1 = attributes0.add("org.jsoup.nodes.Document$OutputSettings", "V*U)d");
      FormElement formElement0 = new FormElement(tag0, "org.jsoup.nodes.Document$OutputSettings", attributes1);
  ...
  public void test08()  throws Throwable  {
      ...
      Attributes attributes0 = new Attributes();
      Attribute attribute0 = Attribute.createFromEncoded("method", "HwS`");
      Attributes attributes1 = attributes0.put(attribute0);
      FormElement formElement0 = new FormElement(tag0, "==kSr[Ja:'", attributes1);
  ...
  public void test10()  throws Throwable  {
      Tag tag0 = Tag.valueOf("&e.FOD.'1]ZY~t");
      Attributes attributes0 = new Attributes();
      FormElement formElement0 = new FormElement(tag0, "&e.FOD.'1]ZY~t", attributes0);
  ...
  public void test16()  throws Throwable  {
      ...
      FormElement formElement0 = new FormElement(tag0, "select", attributes1);
      PseudoTextElement pseudoTextElement0 = new PseudoTextElement(tag0, "~Q($Yg^", attributes1);
      formElement0.addElement(pseudoTextElement0);
  ...
  public void test17()  throws Throwable  {
      ...
      PseudoTextElement pseudoTextElement0 = new PseudoTextElement(tag0, "UGl1Z^}(L/:t_Ekg", attributes0);
      formElement0.addElement(pseudoTextElement0);
      List<Connection.KeyVal> list0 = formElement0.formData();
  ...
  public void test20()  throws Throwable  {
      ...
      Attributes attributes0 = new Attributes();
      Attribute attribute0 = new Attribute("action", "4(");
      attributes0.put(attribute0);
      FormElement formElement0 = new FormElement(tag0, "bE.K`NnX|V", attributes0);
      // Undeclared exception!
      try { 
        formElement0.submit();
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      Attributes attributes0 = new Attributes();
      FormElement formElement0 = new FormElement(tag0, "POST", attributes0);
      Document document0 = Document.createShell("f[`0T[");
      FormElement formElement1 = formElement0.addElement(document0);
      List<Connection.KeyVal> list0 = formElement1.formData();
      assertTrue(list0.isEmpty());
  }
