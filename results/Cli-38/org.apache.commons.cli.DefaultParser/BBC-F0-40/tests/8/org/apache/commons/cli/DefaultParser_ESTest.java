...
public class DefaultParser_ESTest extends DefaultParser_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addRequiredOption("true", "O", false, ",4");
      DefaultParser defaultParser0 = new DefaultParser();
      String[] stringArray0 = new String[9];
      stringArray0[0] = "true";
      stringArray0[1] = "-O=c2,";
  ...
  public void test16()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("1Nfar", "O", true, "O");
      DefaultParser defaultParser0 = new DefaultParser();
      String[] stringArray0 = new String[9];
      stringArray0[0] = "-O=c2,";
      // Undeclared exception!
  ...
  public void test18()  throws Throwable  {
      DefaultParser defaultParser0 = new DefaultParser();
      Options options0 = new Options();
      Options options1 = options0.addRequiredOption("$", "tr", false, "tr");
  ...
  public void test19()  throws Throwable  {
      DefaultParser defaultParser0 = new DefaultParser();
      Options options0 = new Options();
      options0.addOption("sz", "'  (could be: ", true, "sz");
  ...
  public void test20()  throws Throwable  {
      Options options0 = new Options();
      options0.addRequiredOption("SC", "SC", true, "SC");
      DefaultParser defaultParser0 = new DefaultParser();
      String[] stringArray0 = new String[2];
      stringArray0[0] = "-SC";
      // Undeclared exception!
  ...
  public void test22()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("n", "n", true, "---We(r=;(TAaX");
      DefaultParser defaultParser0 = new DefaultParser();
      String[] stringArray0 = new String[2];
      stringArray0[0] = "--=";
      // Undeclared exception!
  ...
  public void test23()  throws Throwable  {
      ...
      DefaultParser defaultParser0 = new DefaultParser();
      Options options2 = options1.addOption("$", "i", true, "--UXLjcg|=7A`-8F");
      String[] stringArray0 = new String[9];
      stringArray0[0] = "i";
      stringArray0[1] = "--=";
      try { 
  ...
  public void test26()  throws Throwable  {
      DefaultParser defaultParser0 = new DefaultParser();
      Options options0 = new Options();
      Options options1 = options0.addOption("h4", "'  (could be: ", true, "h4");
      String[] stringArray0 = new String[5];
      stringArray0[0] = "--'  (could be: ";
      stringArray0[1] = "-O=c2,";
      // Undeclared exception!
  ...
  public void test27()  throws Throwable  {
      DefaultParser defaultParser0 = new DefaultParser();
      Options options0 = new Options();
      options0.addOption("", "'  (could be: ", true, "");
      Properties properties0 = new Properties();
      String[] stringArray0 = new String[8];
      stringArray0[0] = "nWf:fUaZRhSJ";
      stringArray0[1] = "nWf:fUaZRhSJ";
  ...
  public void test32()  throws Throwable  {
      DefaultParser defaultParser0 = new DefaultParser();
      Options options0 = new Options();
      Options options1 = options0.addOption("", "'  (could be: ", true, "");
  ...
  public void test33()  throws Throwable  {
      DefaultParser defaultParser0 = new DefaultParser();
      Options options0 = new Options();
      Options options1 = options0.addRequiredOption("", "?%w|OdKx$r6U*FK!C%", true, "");
      Properties properties0 = new Properties();
      try { 
  ...
  public void test35()  throws Throwable  {
      DefaultParser defaultParser0 = new DefaultParser();
      Options options0 = new Options();
      Options options1 = options0.addOption("i", "'  (could be: ", true, "i");
      String[] stringArray0 = new String[1];
      stringArray0[0] = "-iTivGTaJRQCRI";
      Properties properties0 = new Properties();
  ...
  public void test38()  throws Throwable  {
      DefaultParser defaultParser0 = new DefaultParser();
      Options options0 = new Options();
      Options options1 = options0.addRequiredOption("$", "tr", true, "tr");
      String[] stringArray0 = new String[8];
      stringArray0[0] = "-true";
      stringArray0[1] = "tr";
      stringArray0[2] = "tr";
