...
public class BaseSingleFieldPeriod_ESTest extends BaseSingleFieldPeriod_ESTest_scaffolding {
  ...
  public void test20()  throws Throwable  {
      DateMidnight dateMidnight0 = new DateMidnight(984L, (DateTimeZone) null);
      DateTime dateTime0 = dateMidnight0.toDateTime((DateTimeZone) null);
      Duration duration0 = Duration.standardMinutes(2991);
      DateTime dateTime1 = dateTime0.withDurationAdded((ReadableDuration) duration0, (-1010));
      DurationFieldType durationFieldType0 = DurationFieldType.weeks();
  ...
  public void test21()  throws Throwable  {
      DateMidnight dateMidnight0 = new DateMidnight(984L, (DateTimeZone) null);
      DateTime dateTime0 = dateMidnight0.toDateTime((DateTimeZone) null);
      DateMidnight dateMidnight1 = dateMidnight0.withWeekyear((-2605));
      DurationFieldType durationFieldType0 = DurationFieldType.weeks();
      int int0 = BaseSingleFieldPeriod.between(dateTime0, dateMidnight1, durationFieldType0);
      assertEquals((-238712), int0);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      LocalDateTime localDateTime1 = localDateTime0.plusYears((-581));
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: ArithmeticException");
         ...
         //
         // Value cannot fit in an int: 18334944000
         //
         verifyException("org.joda.time.field.FieldUtils", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      ...
      DateMidnight dateMidnight0 = new DateMidnight(984L, (DateTimeZone) null);
      DateTime dateTime0 = dateMidnight0.toDateTime((DateTimeZone) null);
      DateTime dateTime1 = dateTime0.minusYears(4100);
      ...
      try { 
        ...
        fail("Expecting exception: ArithmeticException");
         ...
         //
         // Value cannot fit in an int: 129383481600
         //
         verifyException("org.joda.time.field.FieldUtils", e);
      }
  }
