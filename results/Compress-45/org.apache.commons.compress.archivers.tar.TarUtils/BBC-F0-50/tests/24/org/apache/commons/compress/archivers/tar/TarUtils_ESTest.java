...
public class TarUtils_ESTest extends TarUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = TarUtils.formatLongOctalOrBinaryBytes((-60L), byteArray0, (byte)0, 2);
      assertArrayEquals(new byte[] {(byte) (-1), (byte) (-60)}, byteArray0);
      assertEquals(2, int0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TarUtils.formatOctalBytes((-1851L), byteArray0, (-1414), (byte)0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // -1851=1777777777777777774305 will not fit in octal number buffer of length -2
         //
         verifyException("org.apache.commons.compress.archivers.tar.TarUtils", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TarUtils.formatLongOctalOrBinaryBytes(1396L, byteArray0, (byte)48, 15);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TarUtils.formatUnsignedOctalString((-2300L), byteArray0, (byte)1, (byte)1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // -2300=1777777777777777773404 will not fit in octal number buffer of length 1
         //
         verifyException("org.apache.commons.compress.archivers.tar.TarUtils", e);
      }
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TarUtils.parseOctalOrBinary(byteArray0, 0, 2527);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test46()  throws Throwable  {
      byte[] byteArray0 = new byte[16];
      int int0 = TarUtils.formatLongOctalOrBinaryBytes(281474976710656L, byteArray0, 1, 10);
  ...
  public void test48()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TarUtils.formatLongOctalBytes(0L, byteArray0, (byte)48, (byte)1);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test57()  throws Throwable  {
      ZipEncoding zipEncoding0 = TarUtils.FALLBACK_ENCODING;
      byte[] byteArray0 = new byte[2];
      int int0 = TarUtils.formatNameBytes(")*x*{^_=]<W3PfTv", byteArray0, 2, (int) (byte)0, zipEncoding0);
      assertEquals(2, int0);
  }
