...
public class TarUtils_ESTest extends TarUtils_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TarUtils.formatLongOctalOrBinaryBytes((-2605L), byteArray0, 1337, 9);
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TarUtils.formatUnsignedOctalString((-5L), byteArray0, 0, 6);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Invalid byte 104 at offset 0 in 'h{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}' len=9
         //
         verifyException("org.apache.commons.compress.archivers.tar.TarUtils", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      byte[] byteArray0 = new byte[9];
      int int0 = TarUtils.formatCheckSumOctalBytes(0, byteArray0, 6, 0);
      assertEquals(6, int0);
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TarUtils.parseOctal(byteArray0, 0, 24);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TarUtils.formatNameBytes(".#d%rQSM*?z", byteArray0, (int) (byte)97, (int) (byte) (-44));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test45()  throws Throwable  {
      byte[] byteArray0 = new byte[3];
      ZipEncoding zipEncoding0 = TarUtils.DEFAULT_ENCODING;
      String string0 = TarUtils.parseName(byteArray0, (int) (byte)60, (int) (byte)0, zipEncoding0);
      assertEquals("", string0);
  }
  ...
  public void test48()  throws Throwable  {
      byte[] byteArray0 = new byte[9];
      int int0 = TarUtils.formatLongOctalBytes(0, byteArray0, 6, 2);
  ...
  public void test51()  throws Throwable  {
      byte[] byteArray0 = new byte[28];
      int int0 = TarUtils.formatLongOctalOrBinaryBytes(70368744177663L, byteArray0, 7, 11);
  ...
  public void test53()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TarUtils.parseOctalOrBinary(byteArray0, 2, 156);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test65()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TarUtils.parseName(byteArray0, (int) (byte) (-1), 10);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test66()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TarUtils.parseOctal(byteArray0, 2, 17);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid byte -1 at offset 0 in '\uFFFD\uFFFD{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}' len=17
         //
         verifyException("org.apache.commons.compress.archivers.tar.TarUtils", e);
      }
  }
  ...
  public void test67()  throws Throwable  {
      // Undeclared exception!
      try { 
        TarUtils.formatCheckSumOctalBytes((byte) (-28), (byte[]) null, (byte) (-108), (byte)82);
        fail("Expecting exception: NullPointerException");
  ...
  public void test68()  throws Throwable  {
      byte[] byteArray0 = new byte[21];
      TarUtils.formatNameBytes("czp7", byteArray0, 2, 2);
      // Undeclared exception!
      try { 
        TarUtils.parseOctal(byteArray0, 2, 17);
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Invalid byte 99 at offset 0 in 'cz{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}{NUL}' len=17
         //
         verifyException("org.apache.commons.compress.archivers.tar.TarUtils", e);
      }
  }
