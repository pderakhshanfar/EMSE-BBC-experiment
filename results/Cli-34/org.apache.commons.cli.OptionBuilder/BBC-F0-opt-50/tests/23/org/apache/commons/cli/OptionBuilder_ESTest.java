...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.withArgName("Y'AV)QOk!D%^&oPx");
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("M8XV0T4`X");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'M8XV0T4`X' contains an illegal character : '`'
         //
  ...
  public void test24()  throws Throwable  {
      OptionBuilder.withLongOpt("c[4:@!Av4FuX");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
