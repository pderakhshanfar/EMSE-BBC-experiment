...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Option option0 = OptionBuilder.create("E6");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName(")omb'?^>v");
      Option option0 = OptionBuilder.create('L');
      assertEquals((-1), option0.getArgs());
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.hasOptionalArgs((-266));
      OptionBuilder.withLongOpt("");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("#kfo#wVrJ;{up`i");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '#kfo#wVrJ;{up`i' contains an illegal character : '#'
         //
  ...
  public void test27()  throws Throwable  {
      OptionBuilder.withLongOpt("");
      OptionBuilder.withArgName("=kAj4t1Rf!HBfcXx");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
