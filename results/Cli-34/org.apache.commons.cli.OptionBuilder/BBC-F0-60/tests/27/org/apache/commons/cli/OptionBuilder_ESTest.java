...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName(",[Dgg?pn6L-^9");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("E2+f1>A#Jix'(~,| fO");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create(":z lGn-O^`f");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ':z lGn-O^`f' contains an illegal character : ':'
         //
