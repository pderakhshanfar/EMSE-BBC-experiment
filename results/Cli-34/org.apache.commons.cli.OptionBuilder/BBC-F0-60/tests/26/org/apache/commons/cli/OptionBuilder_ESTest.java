...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("^lGE9g$X-^i)}+6+");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withArgName("`r%qz2");
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2599);
      Option option0 = OptionBuilder.create('n');
      assertEquals(2599, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("oy]#9.");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'oy]#9.' contains an illegal character : ']'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("-sRqCe|-|Lo");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("oy]#9.");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
}
