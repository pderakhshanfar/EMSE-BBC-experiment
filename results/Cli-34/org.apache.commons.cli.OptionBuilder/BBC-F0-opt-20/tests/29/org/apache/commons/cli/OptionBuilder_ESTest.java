...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Option option0 = OptionBuilder.create("1nNx");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.hasArgs(360);
      Option option0 = OptionBuilder.create('A');
      assertEquals(360, option0.getArgs());
      assertEquals(65, option0.getId());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("bf4{h~@@XJ%");
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("I;#LJ[j,<fo=p");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'I;#LJ[j,<fo=p' contains an illegal character : ';'
         //
