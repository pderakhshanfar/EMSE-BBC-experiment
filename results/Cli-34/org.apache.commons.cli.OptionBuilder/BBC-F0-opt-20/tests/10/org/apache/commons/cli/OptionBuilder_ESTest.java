...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2613);
      Option option0 = OptionBuilder.create((String) null);
      assertEquals(2613, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withArgName("poT@d");
      OptionBuilder.withLongOpt("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("tlrGI?");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'tlrGI?' contains an illegal character : '?'
         //
  ...
  public void test24()  throws Throwable  {
      OptionBuilder.withArgName("cXB|+CRm5+~G@g[%Qe:");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
