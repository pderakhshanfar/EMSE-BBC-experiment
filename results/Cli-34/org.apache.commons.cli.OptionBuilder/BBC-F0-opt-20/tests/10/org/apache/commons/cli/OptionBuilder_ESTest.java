...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("$\"!~>1d|cL");
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withArgName("C?Fm-, g{9i9b");
      OptionBuilder.withLongOpt("JtM3Uga!?");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("j#S-dF!+i4OnCoxS");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create(".1:h<#uC%hVB/e|-J,9");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '.1:h<#uC%hVB/e|-J,9' contains an illegal character : '.'
         //
