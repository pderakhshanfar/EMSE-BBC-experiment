...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("Z9");
      assertEquals((-1), option0.getArgs());
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("FzXFn!H*(I{[R:><'F");
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("~yU Y(SJ;<;7+.i-+e");
      Option option0 = OptionBuilder.create("Z9");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("~yU Y(SJ;<;7+.i-+e");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '~yU Y(SJ;<;7+.i-+e' contains an illegal character : '~'
         //
