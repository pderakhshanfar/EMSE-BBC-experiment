...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("hdQ");
      assertEquals((-1), option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1860);
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("vHLN6!BHT3Ty'2S");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(3936);
      OptionBuilder.withLongOpt(" :: ");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(3936, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("m)X{KO4%ZhfZg");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'm)X{KO4%ZhfZg' contains an illegal character : ')'
         //
  ...
  public void test24()  throws Throwable  {
      OptionBuilder.withArgName("-^goNjh");
      OptionBuilder.withLongOpt("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
