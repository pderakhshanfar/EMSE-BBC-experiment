...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Option option0 = OptionBuilder.create("qIQhkC");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withArgName("3*uEr5o\"sqg}p=`$@");
      OptionBuilder.withLongOpt("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("W#1I)feLbvYB30");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create(">v4=LBP");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '>v4=LBP' contains an illegal character : '>'
         //
