...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2612);
      Option option0 = OptionBuilder.create("");
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("'E*VV>,@0vav8fz");
      Option option0 = OptionBuilder.create("Cj");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("%vCU00IA{{>");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertTrue(option0.isRequired());
  ...
  public void test17()  throws Throwable  {
      try { 
        OptionBuilder.create("d;ajau.Zx[[>}|[LZ|");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'd;ajau.Zx[[>}|[LZ|' contains an illegal character : ';'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
