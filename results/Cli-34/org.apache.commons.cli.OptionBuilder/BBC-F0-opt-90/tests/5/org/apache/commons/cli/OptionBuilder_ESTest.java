...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("ajqCM");
      assertEquals((-1), option0.getArgs());
  ...
  public void test03()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("a3MZ9Fv");
      assertEquals((-2), option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("L0VR+f<xKq3;`QZbYbR");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("_e^z[");
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.hasArgs(6114);
      OptionBuilder.withLongOpt("");
      Option option0 = OptionBuilder.create();
      assertEquals(6114, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("");
      OptionBuilder.withArgName("$qk[|.+(LOIAYjw7");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("_e^z[");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '_e^z[' contains an illegal character : '^'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("ajqCM");
      assertNotNull(optionBuilder0);
  }
