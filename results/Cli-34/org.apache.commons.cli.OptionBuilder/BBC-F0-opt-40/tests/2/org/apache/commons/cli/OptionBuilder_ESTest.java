...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withArgName("JmUs\"5 @");
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("must specify longopt");
      OptionBuilder.withArgName("F8N6T$o08");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("&BRLTms7$k.5E");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '&BRLTms7$k.5E' contains an illegal character : '&'
         //
  ...
  public void test21()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2711);
      Option option0 = OptionBuilder.create("");
      assertEquals(2711, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
