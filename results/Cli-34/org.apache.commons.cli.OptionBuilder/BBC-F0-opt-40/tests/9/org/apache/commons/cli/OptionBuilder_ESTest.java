...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("x?o2*naSP");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("PP}b_]{i4{");
  ...
  public void test10()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt(" PB;|5A");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(95);
      OptionBuilder.withLongOpt("~<mXRz`(ri|-=ds");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("[V0p,l$8aD=A0n Fy!");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '[V0p,l$8aD=A0n Fy!' contains an illegal character : '['
         //
  ...
  public void test19()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("rD+QgX2%vV?ceAO-/");
      assertNotNull(optionBuilder0);
  }
