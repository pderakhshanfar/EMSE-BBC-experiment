...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(3708);
      Option option0 = OptionBuilder.create((String) null);
      assertTrue(option0.hasOptionalArg());
      assertEquals(3708, option0.getArgs());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("YYcCk");
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("erd^n1g:4");
      Option option0 = OptionBuilder.create('@');
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withArgName("erd^n1g:4");
      Option option0 = OptionBuilder.create('@');
      assertEquals((-1), option0.getArgs());
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("_^CZ~=czRu}S2SpV1");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('=', option0.getValueSeparator());
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("_^CZ~=czRu}S2SpV1");
      OptionBuilder.withArgName("_^CZ~=czRu}S2SpV1");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt(">kslU>IF21");
      OptionBuilder.hasOptionalArgs(0);
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create(")_/EAOs(lzx\"");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ')_/EAOs(lzx\"' contains an illegal character : ')'
         //
  ...
  public void test20()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("%*eK9a~|w=-F");
      assertNotNull(optionBuilder0);
  }
