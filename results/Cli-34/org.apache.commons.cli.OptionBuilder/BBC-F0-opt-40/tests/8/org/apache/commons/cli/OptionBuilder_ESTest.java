...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("ca");
      assertEquals((-1), option0.getArgs());
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("K?f)s:7>EblRUkA");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("]kpOC'_g7!P]x^B~!");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("te<@+eS|");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'te<@+eS|' contains an illegal character : '<'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
