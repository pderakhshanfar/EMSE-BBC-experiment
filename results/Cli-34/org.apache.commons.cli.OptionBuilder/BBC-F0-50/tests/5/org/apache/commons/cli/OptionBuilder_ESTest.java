...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withArgName(";&#_5jWmVd>%\"&jW");
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("Dg]tr|*J0");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals('=', option0.getValueSeparator());
      assertEquals((-1), option0.getArgs());
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("6P$$)");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '6P$$)' contains an illegal character : ')'
         //
  ...
  public void test29()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.hasArgs((-1150));
      assertNotNull(optionBuilder0);
  }
}
