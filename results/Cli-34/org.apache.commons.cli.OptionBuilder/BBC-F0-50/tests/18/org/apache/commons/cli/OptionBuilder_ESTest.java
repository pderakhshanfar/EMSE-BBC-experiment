...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("#clB[f8");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(446);
      Option option0 = OptionBuilder.create('@');
      assertTrue(option0.hasOptionalArg());
      assertEquals(446, option0.getArgs());
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.isRequired(true);
      OptionBuilder.withLongOpt("6mcX+,~j(");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("4Ak\"7*&[;");
      OptionBuilder.withArgName("]SPdrwR|");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("4Ak\"7*&[;");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '4Ak\"7*&[;' contains an illegal character : '\"'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.withArgName("QuK/%2Pi=>#H8");
      Option option0 = OptionBuilder.create('?');
      assertEquals((-1), option0.getArgs());
