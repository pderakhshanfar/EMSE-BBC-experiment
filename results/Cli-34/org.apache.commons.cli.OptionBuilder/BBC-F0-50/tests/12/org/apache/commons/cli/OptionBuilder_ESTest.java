...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("Hx\"\"|w>7(iCvR$k.q");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("Unq5");
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("U2NJ_x");
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("o'(Z~g$^$s1mb");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'o'(Z~g$^$s1mb' contains an illegal character : '''
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.withLongOpt("");
      OptionBuilder.withArgName("Bz&7\"\no9u");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
