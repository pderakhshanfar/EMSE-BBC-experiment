...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(748);
      Option option0 = OptionBuilder.create("");
      assertTrue(option0.hasOptionalArg());
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1950);
      Option option0 = OptionBuilder.create('t');
      assertEquals("t", option0.getOpt());
      assertTrue(option0.hasOptionalArg());
      assertEquals(1950, option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create(">v&Kwd>uw]pDVdk1[");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '>v&Kwd>uw]pDVdk1[' contains an illegal character : '>'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      OptionBuilder.withLongOpt("AP");
      OptionBuilder.withArgName("AP");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
