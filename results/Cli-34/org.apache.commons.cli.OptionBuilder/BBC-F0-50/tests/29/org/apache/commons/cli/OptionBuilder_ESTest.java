...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("XA~`(1i[-(m");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt(",Z')EN");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("LAZQIjH^vk");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'LAZQIjH^vk' contains an illegal character : '^'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      OptionBuilder.withArgName("uuu3!3vt:q#(m{:");
      OptionBuilder.withLongOpt("org.apache.commons.cli.OptionBuilder");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
