...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("]/l1do.2tM?aTtREB");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("ZKso(*+2{m7-//8");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("E&{s090x");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals('=', option0.getValueSeparator());
      assertEquals((-1), option0.getArgs());
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("aHI$8'.Ea/zCn3EvaC");
      OptionBuilder.withArgName("aHI$8'.Ea/zCn3EvaC");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("1O<iHL\"");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '1O<iHL\"' contains an illegal character : '<'
         //
  ...
  public void test17()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("ZKso(*+2{m7-//8");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test19()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(550);
      OptionBuilder.withLongOpt("]/l1do.2tM?aTtREB");
      Option option0 = OptionBuilder.create();
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.isRequired(true);
      OptionBuilder.withLongOpt("{muNEDvs");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
