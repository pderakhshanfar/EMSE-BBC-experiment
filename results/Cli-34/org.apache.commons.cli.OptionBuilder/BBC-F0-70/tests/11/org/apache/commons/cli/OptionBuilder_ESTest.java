...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("aAKm[-~3Ksj*SuR");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("aAKm[-~3Ksj*SuR");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        OptionBuilder.create("wid*aYnz;Z9OPP<HDVJ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'wid*aYnz;Z9OPP<HDVJ' contains an illegal character : '*'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("uzaG[F_<#b(EeHN|X");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
}
