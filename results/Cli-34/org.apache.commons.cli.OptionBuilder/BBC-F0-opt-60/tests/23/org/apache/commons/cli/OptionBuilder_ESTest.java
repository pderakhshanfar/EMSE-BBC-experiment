...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("VX");
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("1x6Y,&F<(Wc");
      Option option0 = OptionBuilder.create("t$");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("N6H:Uv1.0l");
      Option option0 = OptionBuilder.create("t$");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withArgName("JF>#L\"9r[?4_w");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("-1EuM\"9H*|MFi(<W Q");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '-1EuM\"9H*|MFi(<W Q' contains an illegal character : '-'
         //
  ...
  public void test18()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("/8,UL(R!<Bm4eOmWb~");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test24()  throws Throwable  {
      OptionBuilder.withValueSeparator();
      OptionBuilder.withLongOpt("e5&27>Yw'XOh;a3");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('=', option0.getValueSeparator());
  }
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.withArgName("R0c(Lsy%|yYrhM.H8b");
      OptionBuilder.withLongOpt("' contains an illegal character : '");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
