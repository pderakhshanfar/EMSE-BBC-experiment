...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.withLongOpt("h{u^T:7%b5Z");
      Option option0 = OptionBuilder.create('?');
      assertEquals((-1), option0.getArgs());
      assertEquals("?", option0.getOpt());
  }
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(3068);
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withArgName(";U!o=R@=r");
      Option option0 = OptionBuilder.create('?');
      assertEquals((-1), option0.getArgs());
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withArgName("{~U:f7KMKgYM1k]");
      OptionBuilder.withLongOpt("{~U:f7KMKgYM1k]");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create(" /;(E)Nh%S");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ' /;(E)Nh%S' contains an illegal character : ' '
         //
  ...
  public void test18()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("sBcjoYu");
      assertNotNull(optionBuilder0);
  }
