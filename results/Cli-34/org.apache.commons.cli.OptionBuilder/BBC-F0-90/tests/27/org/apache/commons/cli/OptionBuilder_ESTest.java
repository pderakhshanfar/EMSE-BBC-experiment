...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("\" p'xBPV+5uw");
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withArgName("4pa3Z.`%?U.");
      Option option0 = OptionBuilder.create('d');
      assertEquals((-1), option0.getArgs());
      assertEquals("d", option0.getOpt());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      OptionBuilder.hasOptionalArgs(3633);
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(3633, option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("5A}&<>hi9mXNFfd");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '5A}&<>hi9mXNFfd' contains an illegal character : '}'
         //
  ...
  public void test29()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.hasArgs((-3193));
      assertNotNull(optionBuilder0);
  }
}
