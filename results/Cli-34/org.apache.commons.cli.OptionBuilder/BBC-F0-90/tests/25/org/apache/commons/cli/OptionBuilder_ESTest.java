...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("i~%SaEg^Q/r");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("NO1l");
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("{qgX7B1ZpTCc>h^o");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '{qgX7B1ZpTCc>h^o' contains an illegal character : '{'
         //
  ...
  public void test20()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("%7Ch");
      assertNotNull(optionBuilder0);
  }
