...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionBuilder.withLongOpt("Xys-M7x~:]N:0");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("l&h(+|Ev!L<[vBp");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withArgName("eOZP*@JvzEqOisb(yE");
      Option option0 = OptionBuilder.create('7');
      assertEquals((-1), option0.getArgs());
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("Uq2'168");
      OptionBuilder.isRequired(true);
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("Uq2'168");
      OptionBuilder.hasOptionalArgs((-1014));
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withArgName("g*7ya^{`J");
      OptionBuilder.withLongOpt("Uq2'168");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        OptionBuilder.create("g*7ya^{`J");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'g*7ya^{`J' contains an illegal character : '*'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
