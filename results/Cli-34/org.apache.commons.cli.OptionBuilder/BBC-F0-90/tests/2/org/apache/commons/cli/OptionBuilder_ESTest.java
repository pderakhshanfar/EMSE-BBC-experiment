...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withArgName("e0");
      Option option0 = OptionBuilder.create("e0");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("|E7g#S}Lk`m!b+;");
      Option option0 = OptionBuilder.create();
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("NO_ARGS_ALLOWED");
      OptionBuilder.withArgName("O<mktG=ppt;Cy|:E%*");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create(".4sXGxPT**#wy");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '.4sXGxPT**#wy' contains an illegal character : '.'
         //
