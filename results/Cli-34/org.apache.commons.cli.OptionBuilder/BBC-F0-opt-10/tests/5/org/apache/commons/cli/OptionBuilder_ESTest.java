...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("zZsSpZ");
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("Lh\"H7p>)T&w(Z|Nj");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals('=', option0.getValueSeparator());
      assertEquals((-1), option0.getArgs());
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("d0hgoNMbfe`BwENUc");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'd0hgoNMbfe`BwENUc' contains an illegal character : '`'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
