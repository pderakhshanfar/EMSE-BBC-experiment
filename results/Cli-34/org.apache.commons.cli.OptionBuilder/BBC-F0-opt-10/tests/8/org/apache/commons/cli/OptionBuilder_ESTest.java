...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(901);
      Option option0 = OptionBuilder.create("T");
      assertEquals(901, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("IXYIOP.;A0");
      Option option0 = OptionBuilder.create("T");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("-?PX@Us8");
      Option option0 = OptionBuilder.create('K');
      assertEquals((-1), option0.getArgs());
      assertEquals("K", option0.getOpt());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withArgName("H.-us@ToP");
      OptionBuilder.withLongOpt("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("sj?Z_5L@(Bp");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("y\"O8'qx)W,]GWKq~O");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'y\"O8'qx)W,]GWKq~O' contains an illegal character : '\"'
         //
  ...
  public void test20()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("+;kWp1U");
      assertNotNull(optionBuilder0);
  }
