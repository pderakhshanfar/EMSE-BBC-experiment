...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionBuilder.withArgName("^a &!@<ve|u0%.K7Zs%");
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("#7}WAH1e!f,\"c");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("uBM]R");
      Option option0 = OptionBuilder.create('H');
      assertEquals("H", option0.getOpt());
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withArgName("e/\"iS#k)4#cmuY");
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.hasArgs(2363);
      Option option0 = OptionBuilder.create('H');
      assertEquals(2363, option0.getArgs());
      assertEquals("H", option0.getOpt());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(150);
      OptionBuilder.withLongOpt("@# uW$HQZ*,");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("7t,");
      OptionBuilder.withArgName("7t,");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("uBM]R");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'uBM]R' contains an illegal character : ']'
         //
