...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("pn");
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName(":(:gIt).K1$n7e_&U");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.hasArgs(1832);
      Option option0 = OptionBuilder.create('y');
      assertEquals(1832, option0.getArgs());
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.isRequired(true);
      OptionBuilder.withLongOpt("+95<a^2A[");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withArgName("+95<a^2A[");
      OptionBuilder.withLongOpt("+95<a^2A[");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("e>!)BJCI!1t#&tj[");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'e>!)BJCI!1t#&tj[' contains an illegal character : '>'
         //
  ...
  public void test17()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("nJV!K|)B@%");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test19()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(0);
      OptionBuilder.withLongOpt("nJV!K|)B@%");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
