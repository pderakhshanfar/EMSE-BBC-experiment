...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(417);
      Option option0 = OptionBuilder.create("");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("krj^x2WkvWk : ");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("!(*<nq13/Z*|C");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '!(*<nq13/Z*|C' contains an illegal character : '!'
         //
