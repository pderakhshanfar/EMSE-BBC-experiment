...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("fnk");
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("n.q1u4dS{+Y%({4");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("p&SYEB.<lxCvZG7@");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("vQBS#");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'vQBS#' contains an illegal character : '#'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      OptionBuilder.withLongOpt("vQBS#");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test18()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("^Qu5a67^S^NCVO_Rx");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test23()  throws Throwable  {
      OptionBuilder.hasOptionalArg();
      OptionBuilder.withLongOpt("&mY&y%,ZR;_>Bi");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(1, option0.getArgs());
  }
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.withLongOpt("=PgKhlXNsT_*m$");
      OptionBuilder.hasOptionalArgs(0);
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(0, option0.getArgs());
