...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("/-}W}661S|ZsHLY/],");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test04()  throws Throwable  {
      Option option0 = OptionBuilder.create("C2XH");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withArgName("10Pm'}]}C");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt(";P4\"GW_oot#");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('=', option0.getValueSeparator());
  ...
  public void test11()  throws Throwable  {
      ...
      OptionBuilder.hasArgs(2831);
      Option option0 = OptionBuilder.create();
      assertEquals(2831, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      OptionBuilder.withArgName("?S1xI*|1_<o");
      OptionBuilder.withLongOpt("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("?S1xI*|1_<o");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '?S1xI*|1_<o' contains an illegal character : '?'
         //
  ...
  public void test19()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("_WP+UrS6no(_-");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.withLongOpt("{24`S0HNk~g>\"");
      OptionBuilder.hasOptionalArgs(0);
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(0, option0.getArgs());
