...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withArgName("%^B'9#uJ");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("NO_ARGS_ALLOMWED");
  ...
  public void test11()  throws Throwable  {
      try { 
        OptionBuilder.create(" gNtLj\"(*g%~[[-9;[(");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ' gNtLj\"(*g%~[[-9;[(' contains an illegal character : ' '
         //
  ...
  public void test23()  throws Throwable  {
      OptionBuilder.withArgName(" Ui>`<Y?%bM");
