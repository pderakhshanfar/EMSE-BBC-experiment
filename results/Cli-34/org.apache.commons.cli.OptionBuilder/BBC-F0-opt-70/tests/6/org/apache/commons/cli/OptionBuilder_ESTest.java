...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("IMcWh");
      Option option0 = OptionBuilder.create("IMcWh");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.hasArgs(1362);
      Option option0 = OptionBuilder.create('o');
      assertEquals(1362, option0.getArgs());
      assertEquals(111, option0.getId());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("x'Kd");
      Option option0 = OptionBuilder.create('o');
      assertEquals((-1), option0.getArgs());
      assertEquals(111, option0.getId());
  }
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("IMcWh");
      OptionBuilder.hasOptionalArgs(138);
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
