...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("fc!n<");
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withLongOpt("dYPKBl$-=$6");
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1647);
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withArgName("`K'WZ5e^e,TczySm4Y");
      Option option0 = OptionBuilder.create('0');
      assertEquals((-1), option0.getArgs());
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("e6h-4\"cVB_gB");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  ...
  public void test09()  throws Throwable  {
      ...
      OptionBuilder.hasOptionalArgs(2460);
      Option option0 = OptionBuilder.create();
      assertEquals(2460, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("e6h-4\"cVB_gB");
      OptionBuilder.withArgName("Uu6pp;");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("mW79V");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("tUlR'{u9zt_&N7");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'tUlR'{u9zt_&N7' contains an illegal character : '''
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("fc!n<");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test23()  throws Throwable  {
      OptionBuilder.withArgName("%*,j(@3X6lU6n/+(");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test28()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.hasArgs(3445);
      assertNotNull(optionBuilder0);
  }
}
