...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(565);
      Option option0 = OptionBuilder.create("");
      assertTrue(option0.hasOptionalArg());
      assertEquals(565, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("<8UV>CU");
      Option option0 = OptionBuilder.create("45w5j7");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("vW>y&\"");
      Option option0 = OptionBuilder.create('e');
      assertEquals((-1), option0.getArgs());
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("Ea=#TJCT_W]0L");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("t]2Nj1Up.%'z:TY~Yo");
  ...
  public void test11()  throws Throwable  {
      try { 
        OptionBuilder.create("Ea=#TJCT_W]0L");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'Ea=#TJCT_W]0L' contains an illegal character : '='
         //
  ...
  public void test16()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("3/Cj)@7..dYZ0UYs%eF");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test23()  throws Throwable  {
      OptionBuilder.withArgName("Ea=#TJCT_W]0L");
      OptionBuilder.withLongOpt("Ea=#TJCT_W]0L");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.withLongOpt("3/Cj)@7..dYZ0UYs%eF");
      OptionBuilder.hasOptionalArgs();
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
      assertTrue(option0.hasOptionalArg());
