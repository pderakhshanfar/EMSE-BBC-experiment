...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("SE");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.hasArgs(2718);
      OptionBuilder.withLongOpt("[ option: ");
      Option option0 = OptionBuilder.create();
      assertEquals(2718, option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("]?Yf_/`0+YJ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ']?Yf_/`0+YJ' contains an illegal character : ']'
         //
