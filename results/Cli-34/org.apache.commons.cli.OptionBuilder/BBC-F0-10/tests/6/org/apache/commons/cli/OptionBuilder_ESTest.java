...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("gSJg_.istR\"Y`IMm?");
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("b-c/PkR");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1883);
      Option option0 = OptionBuilder.create('F');
      assertEquals(1883, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
      assertEquals(70, option0.getId());
  }
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withArgName("!_iDYga<+=");
      Option option0 = OptionBuilder.create('F');
      assertEquals((-1), option0.getArgs());
      assertEquals(70, option0.getId());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt(";?(Oc,S26 b\"");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('=', option0.getValueSeparator());
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("d?>4cM.|3CV/ARt}g%+");
      OptionBuilder.withArgName("fMj(U");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("w)o hp.$hxas,2A");
      OptionBuilder.hasArgs(0);
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test19()  throws Throwable  {
      OptionBuilder.hasOptionalArgs();
      OptionBuilder.withLongOpt("i?_@S}A");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals((-2), option0.getArgs());
  }
