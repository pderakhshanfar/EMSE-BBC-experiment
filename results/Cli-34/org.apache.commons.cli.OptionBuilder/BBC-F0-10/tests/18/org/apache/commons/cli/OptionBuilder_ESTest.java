...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("mst speciy longoSrpt");
  ...
  public void test06()  throws Throwable  {
      Option option0 = OptionBuilder.create("yz5");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("N\"!PL%!H%^t2kG8DJ%");
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("bdm[v[Kq4%]!|b{Oo");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'bdm[v[Kq4%]!|b{Oo' contains an illegal character : '['
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
