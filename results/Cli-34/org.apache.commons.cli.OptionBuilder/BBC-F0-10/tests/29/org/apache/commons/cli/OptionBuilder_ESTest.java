...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("!yQbWb3OK4PB5wBp");
      Option option0 = OptionBuilder.create('h');
      assertEquals((-1), option0.getArgs());
      assertEquals(104, option0.getId());
  }
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withArgName("8aPdm 5)viL7.X");
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("-34?a.OU.-6QSv");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("-34?a.OU.-6QSv");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '-34?a.OU.-6QSv' contains an illegal character : '-'
         //
