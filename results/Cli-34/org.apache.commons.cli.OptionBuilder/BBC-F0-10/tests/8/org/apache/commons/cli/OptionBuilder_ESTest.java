...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Option option0 = OptionBuilder.create("qp9X");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("|TS8}vOUwWb9]{ql\"E");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withLongOpt("w?AP`1GYkSoZ3%F");
      OptionBuilder.hasOptionalArgs(0);
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(0, option0.getArgs());
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("r,Qy7");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'r,Qy7' contains an illegal character : ','
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
