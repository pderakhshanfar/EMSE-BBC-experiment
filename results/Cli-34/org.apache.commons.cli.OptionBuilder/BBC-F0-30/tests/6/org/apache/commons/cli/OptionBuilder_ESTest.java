...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1008);
      Option option0 = OptionBuilder.create("");
      assertTrue(option0.hasOptionalArg());
      assertEquals(1008, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("-IfQv7:Ib49o");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test03()  throws Throwable  {
      Option option0 = OptionBuilder.create("RQPg$F8R");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.hasArgs(3487);
      Option option0 = OptionBuilder.create('1');
      assertEquals(3487, option0.getArgs());
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withValueSeparator('`');
      OptionBuilder.withLongOpt("hY26hp*+<\"60R,W9");
      Option option0 = OptionBuilder.create();
      assertEquals('`', option0.getValueSeparator());
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withArgName("@G4l2lFnX<");
      OptionBuilder.withLongOpt("hY26hp*+<\"60R,W9");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("c]?-2Y~!2vLUm.]I2");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'c]?-2Y~!2vLUm.]I2' contains an illegal character : ']'
         //
  ...
  public void test21()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("el\"'a=^4:");
      Option option0 = OptionBuilder.create();
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.withArgName("xbO1~z,x}bi");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
