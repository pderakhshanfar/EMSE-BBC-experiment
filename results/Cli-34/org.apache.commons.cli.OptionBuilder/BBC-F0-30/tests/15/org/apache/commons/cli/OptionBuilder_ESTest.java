...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("7uY kbK$B!jK");
      Option option0 = OptionBuilder.create("NO_ARGS_ALLOWED");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.hasArgs(1385);
      Option option0 = OptionBuilder.create('D');
      assertEquals(1385, option0.getArgs());
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("NO_ARG_=S_ALLOWED");
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("[G<q6`DIY(?&onSNJlW");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '[G<q6`DIY(?&onSNJlW' contains an illegal character : '['
         //
