...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withArgName("_{u%c|\"{1N3 -");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withLongOpt("(2SI(x0\")l");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("&`{/oJX_U-2");
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2194);
      Option option0 = OptionBuilder.create('Y');
      assertTrue(option0.hasOptionalArg());
      assertEquals(2194, option0.getArgs());
      assertEquals(89, option0.getId());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("&`{/oJX_U-2");
      Option option0 = OptionBuilder.create('o');
      assertEquals((-1), option0.getArgs());
      assertEquals(111, option0.getId());
  }
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("5A[pUX|ar^TU,F");
      OptionBuilder.isRequired(true);
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withArgName("xSW[`z='/&-`");
      OptionBuilder.withLongOpt("xSW[`z='/&-`");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("(2SI(x0\")l");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '(2SI(x0\")l' contains an illegal character : '('
         //
