...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("z'MWD*.]f1");
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("?E&gn/QqG>`|y%");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test05()  throws Throwable  {
      Option option0 = OptionBuilder.create("MB");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("*;:a5H BzFdl");
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withLongOpt("");
      OptionBuilder.withArgName("J1Vc:^RW5m4Tj");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("Y'V-YX1/Kf_',");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'Y'V-YX1/Kf_',' contains an illegal character : '''
         //
  ...
  public void test22()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(0);
      OptionBuilder.withLongOpt("LW-@1,^!Wn$*w# $:");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("HKR0~p@6");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
