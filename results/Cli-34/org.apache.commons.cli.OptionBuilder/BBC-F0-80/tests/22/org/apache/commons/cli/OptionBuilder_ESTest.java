...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withLongOpt("[\"#zIw1iKV#");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("UU+i@+RunE/T");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("+p,wD%6NwK");
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("");
      OptionBuilder.withArgName("eCsRyAF'mKmQAXiB");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("uG6eogOd`fWp,t4+#^");
      OptionBuilder.hasArgs(0);
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("r47H~wj1t[#-");
      OptionBuilder.hasArg();
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("oX'gQ|\"5a)O_4cE");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'oX'gQ|\"5a)O_4cE' contains an illegal character : '''
         //
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.withArgName("fO_K-^L");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
