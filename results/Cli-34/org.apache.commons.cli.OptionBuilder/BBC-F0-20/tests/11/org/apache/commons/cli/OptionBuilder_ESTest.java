...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("r2hcWVQqQ3T");
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withArgName("%G;3p");
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("08YYcOx7!E/vkoUc6hx");
      Option option0 = OptionBuilder.create('u');
      assertEquals((-1), option0.getArgs());
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("08YYcOx7!E/vkoUc6hx");
      Option option0 = OptionBuilder.create('u');
      assertEquals((-1), option0.getArgs());
      assertEquals("u", option0.getOpt());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("vfb~m");
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("");
      OptionBuilder.withArgName(":(u4v|BT+LtFp");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create(":(u4v|BT+LtFp");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ':(u4v|BT+LtFp' contains an illegal character : ':'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      OptionBuilder.hasOptionalArg();
      OptionBuilder.withLongOpt("lsjKImuL]GOdD");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
