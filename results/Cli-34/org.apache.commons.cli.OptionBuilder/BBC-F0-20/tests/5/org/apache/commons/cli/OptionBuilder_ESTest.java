...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("Pt{|lZ?[DRgiiAl");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("[B(J6y|^ab:fa$P+");
      OptionBuilder.withArgName("k(x*>!tw[E$6bA");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("<@*{pM");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '<@*{pM' contains an illegal character : '<'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("Pt{|lZ?[DRgiiAl");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test28()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("y#U3xwK8w!W?6");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
}
