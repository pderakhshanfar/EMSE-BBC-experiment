...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("\u0004lBdmg [");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("wgAm2mJ!_b8");
      OptionBuilder.hasArgs(2873);
      Option option0 = OptionBuilder.create();
      assertEquals(2873, option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("K8g'zTAMA2UUWH} ^");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'K8g'zTAMA2UUWH} ^' contains an illegal character : '''
         //
  ...
  public void test19()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("sI7");
      assertNotNull(optionBuilder0);
  }
