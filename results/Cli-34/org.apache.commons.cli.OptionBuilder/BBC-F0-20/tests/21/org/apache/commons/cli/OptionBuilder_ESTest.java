...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withValueSeparator('Z');
      OptionBuilder.withLongOpt("7s1X0[R\"j>L&x4:=6Lr");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('Z', option0.getValueSeparator());
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("wS=;Vi(\"CA:@(N");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'wS=;Vi(\"CA:@(N' contains an illegal character : '='
         //
  ...
  public void test16()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("rjie8Q");
      assertNotNull(optionBuilder0);
  }
