...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionBuilder.withLongOpt("*__u8~n\"fXP(,y1oT[");
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withArgName("-n*x11})'gv");
      Option option0 = OptionBuilder.create('f');
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("{pG_Y");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '{pG_Y' contains an illegal character : '{'
         //
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.withArgName(",>R9lx[OzOCLaZ");
      Option option0 = OptionBuilder.create("s");
      assertEquals((-1), option0.getArgs());
  }
