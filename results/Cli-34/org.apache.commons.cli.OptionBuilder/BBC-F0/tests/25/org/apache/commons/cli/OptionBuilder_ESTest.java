...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("41Sf");
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("vQG:VR^ \" 7V");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("gM&;Xe0<HFV;");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("/FxH5;IpLB&zYTY2");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertTrue(option0.isRequired());
  ...
  public void test11()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("Eemj5rFwP");
      Option option0 = OptionBuilder.create();
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("HdXtDm@l#.C7`r");
      OptionBuilder.withArgName("HdXtDm@l#.C7`r");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      OptionBuilder.withLongOpt("`qNR2y~{^!_m|");
  ...
  public void test17()  throws Throwable  {
      try { 
        OptionBuilder.create("qf|V%ib Kp");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'qf|V%ib Kp' contains an illegal character : '|'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
