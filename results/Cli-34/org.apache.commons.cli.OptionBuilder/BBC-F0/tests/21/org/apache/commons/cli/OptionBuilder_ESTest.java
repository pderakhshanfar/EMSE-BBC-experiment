...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withArgName("Bw9Qx9Kj}_vdsb");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("BD@V*'");
      Option option0 = OptionBuilder.create('Q');
      assertEquals((-1), option0.getArgs());
  ...
  public void test11()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("F2S;7Q");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.hasOptionalArgs((-2618));
      OptionBuilder.withLongOpt("F2S;7Q");
      Option option0 = OptionBuilder.create();
  ...
  public void test14()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("BXc'bhS~");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("5y>AdkFiRS4Kg");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("\"[|^e6*->|DI#jucx");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '\"[|^e6*->|DI#jucx' contains an illegal character : '\"'
         //
