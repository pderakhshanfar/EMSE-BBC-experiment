...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1379);
      Option option0 = OptionBuilder.create((String) null);
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withLongOpt("q@9~0({9jxZuEi)[\"");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("f`)-bqq4=;");
      Option option0 = OptionBuilder.create('s');
      assertEquals((-1), option0.getArgs());
      assertEquals(115, option0.getId());
  }
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(572);
      Option option0 = OptionBuilder.create('0');
      assertEquals(572, option0.getArgs());
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withArgName("v(i62w");
      OptionBuilder.withLongOpt("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("S,t>v");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'S,t>v' contains an illegal character : ','
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      OptionBuilder.withLongOpt("gUnr^/*c\"dn#ge7\\y");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
