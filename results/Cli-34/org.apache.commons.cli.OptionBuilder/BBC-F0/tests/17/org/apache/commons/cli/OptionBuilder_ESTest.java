...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Option option0 = OptionBuilder.create("SK7xokJL");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withArgName("XQ!r0G#>");
      Option option0 = OptionBuilder.create('9');
      assertEquals((-1), option0.getArgs());
      assertEquals("9", option0.getOpt());
  }
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withLongOpt("UU;PHMR0y)$/%'!");
      OptionBuilder.withValueSeparator('*');
      Option option0 = OptionBuilder.create();
      assertEquals('*', option0.getValueSeparator());
      assertEquals((-1), option0.getArgs());
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("UU;PHMR0y)$/%'!");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'UU;PHMR0y)$/%'!' contains an illegal character : ';'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("~M*8:PGr*>DKn|2");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test23()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.hasOptionalArgs(1231);
      assertNotNull(optionBuilder0);
  }
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.hasOptionalArg();
      OptionBuilder.withLongOpt("&Cmcth5kSTYid?6dA`r");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(1, option0.getArgs());
  }
  ...
  public void test28()  throws Throwable  {
      OptionBuilder.withArgName("~M*8:PGr*>DKn|2");
      OptionBuilder.withLongOpt("~M*8:PGr*>DKn|2");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test30()  throws Throwable  {
      OptionBuilder.isRequired();
      OptionBuilder.withLongOpt("\"}Pm4^M8KZp(FO");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test31()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("t)t[Teg[");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
}
