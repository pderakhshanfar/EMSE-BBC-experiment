...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("`2PXwo|84");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("Ku>U");
      Option option0 = OptionBuilder.create('S');
      assertEquals((-1), option0.getArgs());
      assertEquals("S", option0.getOpt());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(255);
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("e1zA(,E29wtI");
      Option option0 = OptionBuilder.create('f');
      assertEquals((-1), option0.getArgs());
      assertEquals(102, option0.getId());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.hasArgs(5435);
      OptionBuilder.withLongOpt("org.apache.commons.cli.Option");
      Option option0 = OptionBuilder.create();
      assertEquals(5435, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("org.apache.commons.cli.Option");
      OptionBuilder.withArgName("&ZVB\"B(^B");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("BSm}@tF(35|m?-lu");
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("vbZar@=<u");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'vbZar@=<u' contains an illegal character : '@'
         //
  ...
  public void test28()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("Y/(j[sx*D");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
}
