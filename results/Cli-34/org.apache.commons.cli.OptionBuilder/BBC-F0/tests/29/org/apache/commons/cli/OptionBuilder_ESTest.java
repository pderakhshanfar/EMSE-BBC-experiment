...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.withArgName("_Y#|C^fT$#SRC_ZGJ\"~");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("Be{ 1cO'Q^Ouy2");
      OptionBuilder.isRequired(true);
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("RO");
      OptionBuilder.withArgName("RO");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("<|!t-qPz");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '<|!t-qPz' contains an illegal character : '<'
         //
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.withLongOpt(",bU+\u0006&1.~1i[UU");
      Option option0 = OptionBuilder.create('5');
      assertEquals((-1), option0.getArgs());
      assertEquals("5", option0.getOpt());
  }
