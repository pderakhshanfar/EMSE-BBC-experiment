...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("/N4cG&)<Ka");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withArgName("h4Z!O).M|Bx,d");
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("{L=d1do");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '{L=d1do' contains an illegal character : '{'
         //
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.isRequired();
      OptionBuilder.withLongOpt("adx3x'O*m(ON;#");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertTrue(option0.isRequired());
  }
