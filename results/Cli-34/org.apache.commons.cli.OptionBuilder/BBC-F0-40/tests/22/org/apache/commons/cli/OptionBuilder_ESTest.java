...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2943);
      Option option0 = OptionBuilder.create((String) null);
      assertTrue(option0.hasOptionalArg());
      assertEquals(2943, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("aEm[GO(6D~");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt(",zD\"ApSVdeR");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("'qvXa>");
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("{S6Fel3;");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '{S6Fel3;' contains an illegal character : '{'
         //
