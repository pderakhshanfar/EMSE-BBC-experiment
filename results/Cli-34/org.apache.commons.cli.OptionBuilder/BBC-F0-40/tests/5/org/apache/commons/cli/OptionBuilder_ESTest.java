...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("mMpbDP\"*1'{");
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withArgName("O(m#h7HG$`a");
      Option option0 = OptionBuilder.create('2');
      assertEquals((-1), option0.getArgs());
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("uh32 w");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertTrue(option0.isRequired());
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("~*]_<p@-y7<ptAt{?");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '~*]_<p@-y7<ptAt{?' contains an illegal character : '~'
         //
  ...
  public void test20()  throws Throwable  {
      OptionBuilder.hasArgs();
      OptionBuilder.withLongOpt("T_;Rd#");
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
  }
  ...
  public void test24()  throws Throwable  {
      OptionBuilder.withArgName("rbC/\"WB,a.v");
      OptionBuilder.withLongOpt("Cannot add value, list full.");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
