...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withArgName("mGmw");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withLongOpt("WHUA7<aWT$zqCZ+0a/");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1335);
      Option option0 = OptionBuilder.create('b');
      assertTrue(option0.hasOptionalArg());
      assertEquals(98, option0.getId());
      assertEquals(1335, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      OptionBuilder.withArgName(";!{`u/Q_x#gMP_r5~r");
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withArgName("u?(P8Mgv5NC9A|");
      OptionBuilder.withLongOpt("/");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("u?(P8Mgv5NC9A|");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'u?(P8Mgv5NC9A|' contains an illegal character : '?'
         //
