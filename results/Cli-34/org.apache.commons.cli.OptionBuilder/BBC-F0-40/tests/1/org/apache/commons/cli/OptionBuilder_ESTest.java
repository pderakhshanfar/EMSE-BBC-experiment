...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("NlN");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.hasArgs(887);
      OptionBuilder.withLongOpt("must specify longopt");
      Option option0 = OptionBuilder.create();
      assertEquals(887, option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("urk#+y+-nf`0jO?");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'urk#+y+-nf`0jO?' contains an illegal character : '#'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      OptionBuilder.isRequired(true);
      OptionBuilder.withLongOpt("i4Y;`OODbm(LU");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
