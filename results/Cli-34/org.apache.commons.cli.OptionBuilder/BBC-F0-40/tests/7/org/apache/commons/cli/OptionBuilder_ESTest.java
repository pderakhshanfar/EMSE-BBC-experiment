...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      OptionBuilder.withLongOpt("m'vT");
  ...
  public void test01()  throws Throwable  {
      OptionBuilder.withArgName("X>Y Nkg5,");
  ...
  public void test02()  throws Throwable  {
      Option option0 = OptionBuilder.create("_cS86O");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("CeZ\"H}%fgii`5(/");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("e<)b0Et}\"SOkw`%");
      Option option0 = OptionBuilder.create('V');
      assertEquals((-1), option0.getArgs());
      assertEquals(86, option0.getId());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.isRequired(true);
      OptionBuilder.withLongOpt("8i=N(p4B-a&|%,1?J");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("AAsSgXs%S;");
      OptionBuilder.withValueSeparator('j');
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('j', option0.getValueSeparator());
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(313);
      OptionBuilder.withLongOpt("AAsSgXs%S;");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(313, option0.getArgs());
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("8i=N(p4B-a&|%,1?J");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '8i=N(p4B-a&|%,1?J' contains an illegal character : '='
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      OptionBuilder.hasOptionalArgs((-1888));
      Option option0 = OptionBuilder.create('j');
      assertEquals((-1888), option0.getArgs());
      assertTrue(option0.hasOptionalArg());
      assertEquals(106, option0.getId());
  }
