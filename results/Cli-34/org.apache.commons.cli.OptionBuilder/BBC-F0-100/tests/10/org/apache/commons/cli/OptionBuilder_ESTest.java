...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("Y}7X");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("/-}_/Zu(qS");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '/-}_/Zu(qS' contains an illegal character : '/'
         //
  ...
  public void test22()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("#e1y4tK6_%PBPY7L;@");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("Xt{IjCF}~q3");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
}
