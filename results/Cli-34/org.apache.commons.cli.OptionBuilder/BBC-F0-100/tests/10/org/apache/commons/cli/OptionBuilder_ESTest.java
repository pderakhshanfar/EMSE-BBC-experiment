...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withLongOpt("xtAyg`#AnK9H=x9");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("");
      OptionBuilder.hasOptionalArgs((-2680));
      Option option0 = OptionBuilder.create();
  ...
  public void test17()  throws Throwable  {
      try { 
        OptionBuilder.create("gY`Md$g>AT7#");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'gY`Md$g>AT7#' contains an illegal character : '`'
         //
