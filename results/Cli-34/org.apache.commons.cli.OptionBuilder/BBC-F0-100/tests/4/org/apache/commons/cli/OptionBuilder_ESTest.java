...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionBuilder.withLongOpt("v4bC[<)D#Q m,");
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("V<'H/=V%q");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test04()  throws Throwable  {
      Option option0 = OptionBuilder.create("19");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("qV8sob^rb");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.hasArgs(3766);
      Option option0 = OptionBuilder.create('R');
      assertEquals(82, option0.getId());
      assertEquals(3766, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("cFIQ)dO(");
  ...
  public void test15()  throws Throwable  {
      OptionBuilder.withArgName("\"3kX>2#sY<&dF");
      OptionBuilder.withLongOpt("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("\"3kX>2#sY<&dF");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '\"3kX>2#sY<&dF' contains an illegal character : '\"'
         //
