...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("@Vn~Js?gwIl^=)p!(");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("Cb4)?V<SuY.Tv(f");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals('=', option0.getValueSeparator());
      assertEquals((-1), option0.getArgs());
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("hs=TiS6(zFldx*W");
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("hs=TiS6(zFldx*W");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'hs=TiS6(zFldx*W' contains an illegal character : '='
         //
