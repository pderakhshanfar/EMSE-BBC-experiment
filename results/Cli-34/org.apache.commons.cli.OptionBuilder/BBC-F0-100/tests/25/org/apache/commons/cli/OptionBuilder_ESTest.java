...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("}j'<2B#&pg+'");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("}j'<2B#&pg+'");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '}j'<2B#&pg+'' contains an illegal character : '}'
         //
  ...
  public void test18()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("}j'<2B#&pg+'");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test24()  throws Throwable  {
      OptionBuilder.withArgName("}j'<2B#&pg+'");
      Option option0 = OptionBuilder.create('W');
