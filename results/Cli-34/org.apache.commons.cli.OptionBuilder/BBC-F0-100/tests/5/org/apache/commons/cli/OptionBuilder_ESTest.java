...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Option option0 = OptionBuilder.create("III");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName(">c/W[Nl#^jS o");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("_baAKs>$lI`jZ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '_baAKs>$lI`jZ' contains an illegal character : '>'
         //
