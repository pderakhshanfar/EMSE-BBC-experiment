...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt(" SJ)b`l^!eP[:E");
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withArgName("&m(L,;6");
      OptionBuilder.withLongOpt(" SJ)b`l^!eP[:E");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create(" SJ)b`l^!eP[:E");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ' SJ)b`l^!eP[:E' contains an illegal character : ' '
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("&m(L,;6");
      assertNotNull(optionBuilder0);
  }
