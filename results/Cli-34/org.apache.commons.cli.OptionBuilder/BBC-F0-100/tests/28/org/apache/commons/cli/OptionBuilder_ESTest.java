...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withArgName(")ls^?e7C(n;A9e");
      Option option0 = OptionBuilder.create('1');
      assertEquals((-1), option0.getArgs());
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("A]WQmbb-i!3d");
      OptionBuilder.hasArgs(1431);
      Option option0 = OptionBuilder.create();
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("4[xF}E");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '4[xF}E' contains an illegal character : '['
         //
