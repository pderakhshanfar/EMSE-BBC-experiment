...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withArgName("_1q4V\bwPi");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test03()  throws Throwable  {
      Option option0 = OptionBuilder.create("kS");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2575);
      Option option0 = OptionBuilder.create((String) null);
      assertTrue(option0.hasOptionalArg());
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("7{kOCAZaZRnhXAIrC*");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("iaZmve");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(0);
      OptionBuilder.withLongOpt(",wTV?$1I>:W^7=");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("PR1g(1]1zBM1q;j`$");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'PR1g(1]1zBM1q;j`$' contains an illegal character : '('
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("uUu+>w#>%p'");
      Option option0 = OptionBuilder.create();
  ...
  public void test24()  throws Throwable  {
      OptionBuilder.withLongOpt("uUu+>w#>%p'");
      OptionBuilder.withArgName("E~r$T");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
