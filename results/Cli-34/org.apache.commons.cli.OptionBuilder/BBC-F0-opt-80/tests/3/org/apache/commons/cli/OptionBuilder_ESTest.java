...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Option option0 = OptionBuilder.create("xrkGR$fHV");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withArgName("{>4#Z~i");
      Option option0 = OptionBuilder.create('n');
      assertEquals((-1), option0.getArgs());
      assertEquals(110, option0.getId());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.hasArgs(2590);
      OptionBuilder.withLongOpt("");
      Option option0 = OptionBuilder.create();
      assertEquals(2590, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("`c5Oe");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("m1|.9Y}q]!#-AC#");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'm1|.9Y}q]!#-AC#' contains an illegal character : '|'
         //
