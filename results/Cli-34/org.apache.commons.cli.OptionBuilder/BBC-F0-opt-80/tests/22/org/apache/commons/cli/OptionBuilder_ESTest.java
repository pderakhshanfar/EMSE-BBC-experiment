...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("voqTGWQ");
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("oi=!W^qN1):kw");
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("A&FPa'C(D{");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("T.hVH+aK' c,zA");
  ...
  public void test09()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("'SPV&k6', A&A5CJ--");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1055);
      OptionBuilder.withLongOpt("voqTGWQ");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(1055, option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("z~X0ZPK9<(f;OG$nK");
      OptionBuilder.withArgName("cC/fQgLI(Q ,L<X6");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("TCz^v");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'TCz^v' contains an illegal character : '^'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("Hy");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.withLongOpt("ze^_");
