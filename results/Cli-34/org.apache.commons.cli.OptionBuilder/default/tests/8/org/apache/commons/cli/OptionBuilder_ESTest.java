...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("in_");
      assertEquals((-1), option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      OptionBuilder.hasArgs(807);
      Option option0 = OptionBuilder.create("");
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("oP&/%z*n_y5&\rB");
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withArgName("oP&/%z*n_y5&\rB");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("?WayM7['XgF3");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '?WayM7['XgF3' contains an illegal character : '?'
         //
