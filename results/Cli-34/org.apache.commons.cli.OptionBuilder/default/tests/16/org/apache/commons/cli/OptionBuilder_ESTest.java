...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withArgName(">Uoc@ROdGPzm5");
      Option option0 = OptionBuilder.create('t');
      assertEquals((-1), option0.getArgs());
      assertEquals("t", option0.getOpt());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withArgName("@j3II}am4V@z*Yx=Egg");
      OptionBuilder.withLongOpt("w)LL-K3bLhy!!f~kVd");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("Fv(WE!=kYxq#%BjIrZ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'Fv(WE!=kYxq#%BjIrZ' contains an illegal character : '('
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      OptionBuilder.withValueSeparator();
      OptionBuilder.withLongOpt("Fv(WE!=kYxq#%BjIrZ");
      Option option0 = OptionBuilder.create();
      assertEquals('=', option0.getValueSeparator());
      assertEquals((-1), option0.getArgs());
  }
