...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withLongOpt(";DK+7HSSmI%xXb&FcC");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName(";DK+7HSSmI%xXb&FcC");
      Option option0 = OptionBuilder.create('b');
      assertEquals((-1), option0.getArgs());
      assertEquals(98, option0.getId());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("AkAAZ}lq#+");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('=', option0.getValueSeparator());
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("* !4g>lv'G");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '* !4g>lv'G' contains an illegal character : '*'
         //
