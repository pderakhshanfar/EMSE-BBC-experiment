...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("r|;7S(]7,@HV");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2915);
      Option option0 = OptionBuilder.create("NO_ARGS_ALLOWED");
      assertEquals(2915, option0.getArgs());
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("DJl}fkSUCV->i");
      Option option0 = OptionBuilder.create('?');
      assertEquals((-1), option0.getArgs());
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("/x9IBlvu/d(T^lVGv");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '/x9IBlvu/d(T^lVGv' contains an illegal character : '/'
         //
  ...
  public void test27()  throws Throwable  {
      OptionBuilder.isRequired();
      OptionBuilder.withLongOpt("b2 m&zCq");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertTrue(option0.isRequired());
  }
