...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("WZObd(R#B~W");
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withArgName(":?yBePG`REVq[46CT)");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("bf}Oh:");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'bf}Oh:' contains an illegal character : '}'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("6S?1~H");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(0, option0.getArgs());
  }
