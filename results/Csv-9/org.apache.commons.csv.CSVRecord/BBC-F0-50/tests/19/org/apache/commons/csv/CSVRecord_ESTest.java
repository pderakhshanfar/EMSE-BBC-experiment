...
public class CSVRecord_ESTest extends CSVRecord_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      ...
      stringArray0[2] = "^:E";
      HashMap<String, Integer> hashMap0 = new HashMap<String, Integer>();
      Integer integer0 = Integer.getInteger("K0I^q*#2", 2);
      CSVRecord cSVRecord0 = new CSVRecord(stringArray0, hashMap0, "^:E", 0L);
      hashMap0.put("6B!a)|xXGa4{ c", integer0);
      String string0 = cSVRecord0.get("6B!a)|xXGa4{ c");
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cSVRecord0.get("6B!a)|xXGa4{ c");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Mapping for 6B!a)|xXGa4{ c not found, expected one of []
         //
         verifyException("org.apache.commons.csv.CSVRecord", e);
      }
  }
