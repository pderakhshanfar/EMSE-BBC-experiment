...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("Y`Lq-_>GW,NWq+~E");
      File file0 = MockFile.createTempFile("d>`#~67V", "", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Y`Lq-_>GW,NWq+~E/d>`#~67V0");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Y`Lq-_>GW,NWq+~E");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "FU&RCUMP@~(L|=";
      stringArray0[1] = "ZqOx2Ym=tebB8";
      stringArray0[2] = "fASrGH=RO";
      stringArray0[3] = "7D";
      stringArray0[4] = "";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("]ees`T5!SKV\",\"2lg#,", cSVFormat1);
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("P;9KF,Em;BGd7) NdZ~", "P;9KF,Em;BGd7) NdZ~");
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("$NDvj R'&wq", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("]ees`T5!SKV\",\"2lg#,", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("org.apache.commonslcsv.CSVParser", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("@,Q'R`H]ARO/|\u0002+");
      CSVParser cSVParser0 = CSVParser.parse("@,Q'R`H]ARO/|\u0002+", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[@, Q'R`H]ARO/|\u0002+]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("eB;(cK}d>3");
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("]ees`T5!SKV\",\"2lg#,", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
