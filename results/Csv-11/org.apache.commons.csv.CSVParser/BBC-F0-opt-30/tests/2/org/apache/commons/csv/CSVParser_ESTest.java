...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "{CX>Rg!w-w");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "F ,g60'#jf";
      stringArray0[1] = "COMMENT";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("F ,g60'#jf", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test09()  throws Throwable  {
      MockFile mockFile0 = new MockFile("g.EF;p8.^tq7ZE", "g.EF;p8.^tq7ZE");
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"-kB\"$[(57EmeD~\"2", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("F:E[KV{2eF.", "reader");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("zuL+o", "Unexpected Token type: ");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("'Wxh3L)A", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("[#Kl=~", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("org.apache.commons.csv.CSVFormat@0000000003\torg.apache.commons.csv.CSVFormat@0000000001\torg.apache.commons.csv.CSVFormat@0000000001\tjava.lang.Object@0000000004", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"org.apache.commons.csv.CSVFormat@0000000001\" in [org.apache.commons.csv.CSVFormat@0000000003, org.apache.commons.csv.CSVFormat@0000000001, org.apache.commons.csv.CSVFormat@0000000001, java.lang.Object@0000000004]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("\"\"\torg.apache.commons.csv.CSVFormat@0000000001\t\tjava.lang.Object@0000000003", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [, org.apache.commons.csv.CSVFormat@0000000001, , java.lang.Object@0000000003]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("kwp^MX", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("2^{T<", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("+UGeWU=Bmhgoh=J`L.", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile(" Surro]jdingSpace):ignored", (String) null);
      Charset charset0 = Charset.defaultCharset();
