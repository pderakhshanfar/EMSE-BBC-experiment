...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "]/dP/&c14PCB5";
      stringArray0[1] = "*ZZ](P7_U.'A`";
      stringArray0[2] = "xHQ@T'3,2P%";
      stringArray0[3] = "J";
      stringArray0[4] = "OMpUw-Qm\u0006hDm*s:";
      stringArray0[5] = "(startline ";
      stringArray0[6] = "ac@)%Qi^NHr#";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("ac@)%Qi^NHr#", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("J`GxZ,1");
      CSVFormat cSVFormat0 = CSVFormat.newFormat('I');
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
  ...
  public void test15()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("J`GxZ,1", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("+0$HMzH'M!%ng?8", cSVFormat0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("P6HO}NHg22", cSVFormat2);
        fail("Expecting exception: NullPointerException");
