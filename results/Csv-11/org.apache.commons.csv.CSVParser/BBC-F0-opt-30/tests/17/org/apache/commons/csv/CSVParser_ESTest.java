...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "~,Z_CD C";
      stringArray0[1] = "T'CCL[#Qs5S_D]s";
      stringArray0[2] = ">^YBm4Q$3";
      stringArray0[3] = "(line ";
      stringArray0[4] = "The escape character and the delimiter cannot be the same ('";
      stringArray0[5] = "x$";
      stringArray0[6] = "LMp:z2rO\"YBc!x}Jo";
      stringArray0[7] = "5ppp 52^fy2";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("~,Z_CD C", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("|xmm*z1zn6##@y", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("+I)$S^sSr1XEJ?8#{", cSVFormat0);
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("R/u~*9W4pcg|cQbh^Y");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("JG\u0007\",*Y\"", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("j,w,\"{e", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("l(\"Xn$o_%7V", (String) null, (File) null);
      // Undeclared exception!
      try { 
