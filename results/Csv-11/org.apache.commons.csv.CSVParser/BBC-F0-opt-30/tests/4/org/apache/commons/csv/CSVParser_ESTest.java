...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("{A']fH!r+@:?Q", "B/7z?.$~");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[1] = "s";
      stringArray0[2] = "{PpK!pq";
      stringArray0[3] = "_D[Zekv";
      stringArray0[4] = "ml_qa";
      stringArray0[5] = "If4[K^YW]6zk\"z^_>";
      stringArray0[6] = ">Pt*U5@~Q";
      stringArray0[7] = "kr ";
      stringArray0[8] = "q'^4";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("ml_qa", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[ml_qa]", cSVRecord0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("qkj^cLozA&d", cSVFormat1);
  ...
  public void test08()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("rR  ~PrX", "org.apache.commons.csv.CSVRecord", (-1), "TOKEN", uRLStreamHandler0);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("out", ": A0&OIRl;r");
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("*Rk+)e 7a%WaFvC/p", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test23()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("qkj^cLozA&d", cSVFormat2);
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("HTf&9M", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("Ok\f`|]s<,,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [Ok\f`|]s<, , ]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[0] = "(line ";
      stringArray0[1] = "OE=7Kk";
      stringArray0[2] = "pN$ m]P";
      stringArray0[3] = "</xJK)";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("n@kr9#o-", cSVFormat2);
        fail("Expecting exception: NullPointerException");
