...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("j.5e!g/\",8/", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("m<#!I,xoJlEhb+g<", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("CxRFs", cSVFormat2);
  ...
  public void test12()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("%QVAwf@", "");
      File file0 = MockFile.createTempFile("8o!cR", "8o!cR", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("#WHxFIOHL0wQg#Pt\r", "No more CSV records available");
      MockFile mockFile0 = new MockFile(file0, "#WHxFIOHL0wQg#Pt\r");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("P~'O0Dl]>by", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test21()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      PipedReader pipedReader0 = new PipedReader(2789);
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("'r'j r@MvuKfHJ", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("o|rM7dlj/3b{", cSVFormat1);
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(")k6vg7*;ze3SJ43;\"", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("'r'j r@MvuKfHJ");
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("f^[wZ");
      // Undeclared exception!
      try { 
        CSVParser.parse("f^[wZ", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      StringReader stringReader0 = new StringReader("U|VQ&cAh_@C)eE<");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
