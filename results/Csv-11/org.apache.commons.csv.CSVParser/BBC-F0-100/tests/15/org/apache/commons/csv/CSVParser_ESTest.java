...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "iUT/OMyq";
      stringArray0[1] = "`%(c!t=HrTM70*.";
      stringArray0[2] = "unexpected token type: ";
      stringArray0[3] = "xOHRcPW/9GI^I6~a";
      stringArray0[4] = "\"]t'cC[%";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("`%(c!t=HrTM70*.", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(".P4", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("2N94=t$.td4<{VCiQ", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(",dg)z&2XB|d@0!", cSVFormat0);
  ...
  public void test09()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("P7w+Q&#8+uW1", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"b+F_JA_o_W:}bm}", cSVFormat1);
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("Zi052^#v:k+KC#(*", "#X#(vV2?|}h#gBe");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("sMS", cSVFormat0);
      cSVParser0.close();
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("N6#", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("H_j\rQUs", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("`0QiTj6~LLOY)Dr+w", cSVFormat2);
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("`0QiTj6~LLOY)Dr+w", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("P7w+Q&#8+uW1", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
