...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[2] = "')";
      stringArray0[3] = "1rk[3Ggn:D";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("0Zf;5Jyg", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("0Zf;5Jyg", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test16()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/WIRlm]^j8e0WIRlm]^j8e");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      File file0 = MockFile.createTempFile("WIRlm]^j8e", "WIRlm]^j8e");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("TTN@q'o6wB\"ue|~JjV|");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("4Yyw6\"w/cznw]", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[0] = "G !=Tm1[{homR5#3";
      stringArray0[1] = "4s";
      stringArray0[2] = "C!Lk.L*qXrF]b5\"";
      stringArray0[4] = "v\":)o9bWWkvw<";
      stringArray0[5] = "4<!RC^(L``3)";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      // Undeclared exception!
      try { 
        CSVParser.parse("7;|7P.?uO$cB`zgiw^T", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("`mwv:`zwXS/byM'");
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("@MR=zi>x2i_NAI);<w5");
      CSVParser cSVParser0 = CSVParser.parse("@MR=zi>x2i_NAI);<w5", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("WIRlm]^j8e");
      CSVFormat cSVFormat3 = cSVFormat2.withIgnoreEmptyLines(false);
      CSVParser cSVParser0 = CSVParser.parse("FQGIDQM$iJr", cSVFormat3);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("FQGIDQM$iJr", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("@MR=zi>x2i_NAI);<w5", cSVFormat0);
