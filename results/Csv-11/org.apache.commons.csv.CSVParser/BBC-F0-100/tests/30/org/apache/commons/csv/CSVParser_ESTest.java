...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "x";
      stringArray0[1] = "#Q)/zR3W~";
      stringArray0[2] = "\"ibDG?i{w4_";
      stringArray0[3] = "py4x{rf@_hww32";
      stringArray0[4] = " SkipHeaderRecord:";
      stringArray0[5] = "12l";
      stringArray0[6] = ") EOF reached before encapsulated token finished";
      stringArray0[7] = "*+w/<.";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("j%,i>bSQqHI1", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[j%,i>bSQqHI1]", cSVRecord0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("P7J)4GNYJ", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("Uow;");
      File file0 = MockFile.createTempFile("Uow;", "$wjWXG*%'/", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("9{o", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("t2:");
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("gMA|7sH'w,8H[ bnLB");
      Character character0 = Character.valueOf('/');
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat3 = cSVFormat2.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("oxut", cSVFormat3);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
