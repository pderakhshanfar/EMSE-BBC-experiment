...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "{WQ[v6AXj";
      stringArray0[1] = "xnf+2";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("1L?8", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("{WQ[v6AXj", cSVFormat1);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"lRHfaa>D(fh}", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("~B-ykea^w_", "url");
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("odw/uBV'8qK", "FyL7BNNc;^JCzA%+$<O");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      StringReader stringReader0 = new StringReader("]7M?U(H!Z^C2\"*sC");
      CSVFormat cSVFormat0 = CSVFormat.newFormat(']');
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("{2an=$UP6aYJ", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("> 3I:]qW3h#2", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("H4Q}fwj", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(']');
      CSVParser cSVParser0 = CSVParser.parse("O;ER:", cSVFormat0);
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(']');
      MockFile mockFile0 = new MockFile("]7M?U(H!Z^C2\"*sC", "The quoteChar character and the delimiter cannot be the same ('");
      Charset charset0 = Charset.defaultCharset();
      try { 
