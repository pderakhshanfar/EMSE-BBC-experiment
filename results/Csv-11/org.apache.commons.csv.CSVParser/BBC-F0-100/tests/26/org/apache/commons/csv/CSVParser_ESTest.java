...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[1] = "=k";
      stringArray0[2] = "asdCv;g";
      stringArray0[3] = "b#(s%+k";
      stringArray0[4] = "')";
  ...
  public void test10()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("`~gawPO 0==X6~uog;0", "`~gawPO 0==X6~uog;0");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("ed78zUz0`cOVi5)k;W", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("QLO5_SN6I(CF9f, )", cSVFormat0);
  ...
  public void test25()  throws Throwable  {
      ...
      stringArray0[0] = "Jm>I9-!>";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("0(-GnZ'erOY:Nd#56f", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("H}R{x_aO9T;yH", "a@l{H0*oyoA^S!WzOZA");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("sVH{Pu%R83~6ZF");
      CSVParser cSVParser0 = CSVParser.parse("K-8", cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(")~?y*6jt.sdhB%Eu^H");
      CSVParser cSVParser0 = CSVParser.parse(")~?y*6jt.sdhB%Eu^H", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
