...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      File file0 = MockFile.createTempFile("(line ", "Na*V*9$a(");
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("w03(", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("knbbpPtA5.,!r{", "\" in ");
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"r!_JEKFrr9['P", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("%;Y{", "url");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("f!$GdWa", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("rpz2rJ5hN", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("{iXM#V^%RTN/)yx", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("lLz,BTK:v9x}{Xc", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("{X3wsB~pT?}*o", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("w03(");
      CSVParser cSVParser0 = CSVParser.parse("w03(", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("[sSn>vi*V.WOh=");
      CSVParser cSVParser0 = CSVParser.parse("rpz2rJ5hN", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[rpz2rJ5hN]", cSVRecord0.toString());
  }
