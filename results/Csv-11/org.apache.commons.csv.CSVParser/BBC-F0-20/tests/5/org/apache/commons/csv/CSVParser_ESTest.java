...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("qY9l#e^IC2>MZ,l3[J>C");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "vs/EuP.Ha*YK2c)U";
      stringArray0[1] = "";
      stringArray0[2] = "org.apache.commons.csv.CSVParser";
      stringArray0[3] = "@2vg_m}kd'q";
      stringArray0[4] = " `^:Y=M3r|l3jQXTG";
      stringArray0[5] = "k]).)7zt";
      stringArray0[6] = "e&*l";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("@2vg_m}kd'q");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Y9l#s^IC2OMZ,l3[JC", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertNull(cSVRecord0.getComment());
  }
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Y9l#s^IC2>MZ,l3[JC", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"9S9At'@", cSVFormat2);
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("slT=<To8WuaCSC!{q)", "NONE");
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(",b\"o(fke2Au,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [, b\"o(fke2Au, ]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("qy9l#e^ic2>mz,l3[jc", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile(":aztvq[<vm#n?+#", "' must not be null!");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[1] = "Y@o\"st.`xokj";
      stringArray0[2] = "@|%Y4";
      stringArray0[3] = "*`Hl}NF~&{v%.\"";
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("w?&y]${tvj@ra", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("qY9l#e^IC2>MZ,l3[JC", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("u<y0H#kGn@");
      CSVParser cSVParser0 = CSVParser.parse("u<y0H#kGn@", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("A8g", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
