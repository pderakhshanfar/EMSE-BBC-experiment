...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "dm>I}";
      stringArray0[1] = "&lZTboXP";
      stringArray0[2] = "org.apache.commons.csv.CSVPrinter";
      stringArray0[3] = "=5RV9z7=m2gp-5";
      stringArray0[4] = "@dads5rwr6X}GKTxW";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("S_U`^", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test03()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("mment start character cannot be a line break", "");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("KTc2l\">#^z(", cSVFormat0);
      cSVParser0.close();
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("veH", (CSVFormat) null);
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("{{pJUaW${D:");
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("7z/pMt", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("A-8n>Q; ##yFpX[:");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("c+Q,|#%<Pq('@Is]q", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("mment start character cannot be a line break", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("mment start character cannot be a line break", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("The comment start character cannot be a line break");
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("7.W%#X@QpTu\"P");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("A-8n>Q; ##yFpX[:");
      try { 
