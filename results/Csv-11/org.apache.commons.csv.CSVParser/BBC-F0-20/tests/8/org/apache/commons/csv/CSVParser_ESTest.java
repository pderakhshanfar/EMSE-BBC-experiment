...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "GmEI8@DdlJuO ";
      stringArray0[1] = "";
      stringArray0[2] = "LU";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("GmEI8@DdlJuO ", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[GmEI8@DdlJuO ]", cSVRecord0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("e`rJa7)'", "gkMqj?9G*.90yZ@{bGN");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("'uIQ", cSVFormat0);
      cSVParser0.close();
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(",harses", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      stringArray0[0] = "fyRB]d";
      stringArray0[1] = "[B&gE87ym7p|=|7$l";
      stringArray0[2] = "url";
      stringArray0[3] = ")&lqUMLS-|`(m{GPXfu";
      stringArray0[4] = "H";
      stringArray0[5] = "{JcgO3`l\"SNlrG6";
      stringArray0[6] = "$VALUES";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      // Undeclared exception!
      try { 
        CSVParser.parse("'AAO`_r4@sZ", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("#f1>e]$", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Td3GA6}1%eP&(pQRtT");
      StringReader stringReader0 = new StringReader("Td3GA6}1%eP&(pQRtT");
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("#f1>e]$");
      CSVParser cSVParser0 = CSVParser.parse("Q77>gbyU", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("P8.FQ5>&5+", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("charset", "{AWGQvmp6X50Wqk|iW?");
      Charset charset0 = Charset.defaultCharset();
