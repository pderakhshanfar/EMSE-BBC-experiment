...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("1j6NAw$tBtW}u3v[/,cc-UzTR[c%X/Go0l6");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      String[] stringArray0 = new String[5];
      stringArray0[0] = "WK*";
      stringArray0[1] = "i";
      stringArray0[2] = "1j6NAw$tBtW}u3v[";
      stringArray0[3] = ",cc-UzTR[c%X/Go";
      stringArray0[4] = "l6";
      MockFile mockFile0 = new MockFile("1j6NAw$tBtW}u3v[");
      File file0 = MockFile.createTempFile(",cc-UzTR[c%X/Go", "l6", (File) mockFile0);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[1] = "j|\"7dEh<e_la9;^Q2 ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("x@7X`=s5_eE", cSVFormat1);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("x@7X`=s5_eE", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"I#t&;2_XpJw0Qt2", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("^pSZE&n", ",*jI");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("^L&pZ", "h|(H7FI");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("x@7X`=s5_eE", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("`anncy_o<+j5.", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("HYp29lqJI-|.Z*K/#b8", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test29()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("2XK>kR1LP_1Tp");
      CSVParser cSVParser0 = CSVParser.parse("2XK>kR1LP_1Tp", cSVFormat1);
      // Undeclared exception!
      try { 
