...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("P<AT1+h", "p<a31+h");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "/b2)QvZ:<>$!&.;4P";
      stringArray0[1] = ") invalid parse sequence";
      stringArray0[2] = "7z#O7N;+_Kl#";
      stringArray0[3] = "t?4";
      stringArray0[4] = "]";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("7z#O7N;+_Kl#", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("7?5$$", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertNull(cSVRecord0.getComment());
  }
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("!@4z+OXkhw0''n>w", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("P<AT1+h", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("nc2^dQDj(++(uT", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("P<A31+h", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(";?,F0Ggu=d*y(U &C", cSVFormat0);
      cSVParser0.close();
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("I'\"dwQCp", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<,> QuoteChar=<\"> NullString=<The header contains a duplicate name: \"> RecordSeparator=<\r\n> SkipHeaderRecord:false", cSVFormat0);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("7?5$$");
      CSVParser cSVParser0 = CSVParser.parse("7?5$$", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("P<AT1+h", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
