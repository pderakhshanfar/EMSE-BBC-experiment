...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("VLge=4<h Mzc**", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("=c|n=$&#y/ZGB,o", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("~F1Z!.&b8b5/y", cSVFormat0);
      cSVParser0.close();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("8rs-bk|-1nF*(?@zw", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("9b[|p'BzpQ=P}+", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\" inv ", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("XiWe", "XiWe");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('4');
      File file0 = MockFile.createTempFile("format", "CSVParser has been closed", (File) null);
      MockFile mockFile0 = new MockFile(file0, "CSVParser has been closed");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("/@bZTMIp", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("KqThCq Nj*_Klzh", cSVFormat0);
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("ba$*TA9;_vBS&x4`|:w", "ba$*TA9;_vBS&x4`|:w");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("VLge=4<h Mzc**", cSVFormat0);
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("# ?}HI^Oowqo9wwf", cSVFormat1);
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("VLge=4<h Mzc**", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("R9?a", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
