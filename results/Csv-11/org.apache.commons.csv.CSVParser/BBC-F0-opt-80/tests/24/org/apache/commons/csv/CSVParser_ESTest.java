...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      MockFile mockFile0 = new MockFile("0O3Qor;]hMP>pg~", "u;1//");
      File file0 = MockFile.createTempFile("0O3Qor;]hMP>pg~", "vyc$b0u]BPF< xo&Uy", (File) mockFile0);
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("(P^lU%_#S", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("x=.V#9]", cSVFormat0);
      cSVParser0.close();
  ...
  public void test05()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("x=.V#9]", cSVFormat1);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("L1'3x[w4_", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      stringArray0[0] = "(P^lU%_#S";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("(P^lU%_#S", cSVFormat1);
  ...
  public void test18()  throws Throwable  {
      ...
      stringArray0[0] = "bkoB{4HZlFhKX";
      stringArray0[1] = "oZEK";
      stringArray0[2] = "/{TCHuf";
      stringArray0[5] = "]";
      stringArray0[4] = "RTYzPosq";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse(";|[0v@+9", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("(P^lU%_#S", cSVFormat3);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("4J");
      CSVParser cSVParser0 = CSVParser.parse("]", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVPrinter", "^Q I^");
      // Undeclared exception!
      try { 
