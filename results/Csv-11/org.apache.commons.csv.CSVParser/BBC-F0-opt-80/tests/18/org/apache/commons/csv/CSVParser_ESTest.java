...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "TxW";
      stringArray0[1] = "pSvB\")wL.qV)MlKp";
      stringArray0[2] = "xm:r6eu},$hw^";
      stringArray0[3] = ") EOF reached before encapsulated token finished";
      stringArray0[4] = "{Eq-Me";
  ...
  public void test04()  throws Throwable  {
      File file0 = MockFile.createTempFile("xm:r6eU},$hW^", "xm:r6eU},$hW^");
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("B'E=?X:TTtl<p", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("CK.?UWKH,QbQ^", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("ny[bC?", cSVFormat0);
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("1FTANdmUYVw.T+", "r#]r()");
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("aNNW_", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      File file0 = MockFile.createTempFile("=MZ", "=MZ");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("DDcEc/sCP`4u)2z#&", cSVFormat0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[1] = "Q^`t(Fna|p>t";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("Q5*HC*=\"7swc;\"");
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("xm:r6eU},$hW^", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("|$l=n_");
      CSVParser cSVParser0 = CSVParser.parse("xm:r6eU},$hW^", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("xm:r6eU},$hW^");
      CSVParser cSVParser0 = CSVParser.parse("xm:r6eU},$hW^", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
