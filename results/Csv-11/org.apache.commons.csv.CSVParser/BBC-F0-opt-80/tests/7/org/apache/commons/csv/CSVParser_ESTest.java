...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      MockFile mockFile0 = new MockFile(";LSIK=xB|wVL*-", ";LSIK=xB|wVL*-");
      File file0 = MockFile.createTempFile(";LSIK=xB|wVL*-", ";LSIK=xB|wVL*-", (File) mockFile0);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "H'|vcQ2D5uxTvxlqXf";
      stringArray0[1] = "\" in ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      Quote quote0 = Quote.MINIMAL;
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      StringReader stringReader0 = new StringReader("@i2\fn!}63=et-");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("a$1WM.$nm", cSVFormat0);
      cSVParser0.close();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("B9Zw!q$GCd;");
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("B9Zw!q$GCd;", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("B2IQLIiB{{U;)@}(4", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("O!1K9Yc:}FX@n`m", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("*sE_KN", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(",o67Nw45I:", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("B9Zw!q$GCd;", cSVFormat1);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("'f,2p");
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      StringReader stringReader0 = new StringReader("'f,2p");
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("B2IQLIiB{{U;)@}(4", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
