...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("NON", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("", "_gXpM2PB]t !+", 0, "", uRLStreamHandler0);
  ...
  public void test11()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.csv.Constants", "ALL");
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("$\",=Gbv", "string");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("tb", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test26()  throws Throwable  {
      File file0 = MockFile.createTempFile("No header mapping was specified, the record values can't be accessed by name", "xj%S6;");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("JP(hux.'^yJ", cSVFormat2);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Bmwo&3dwK4`");
      CSVParser cSVParser0 = CSVParser.parse("Bmwo&3dwK4`", cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("JP(hux.'^yJ", cSVFormat0);
