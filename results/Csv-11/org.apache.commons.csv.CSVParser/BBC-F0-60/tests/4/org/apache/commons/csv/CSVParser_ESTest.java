...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(3628);
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("HL-Zs", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("sd$[we)sr", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("5Zp'xG", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("mq*w\rv2s0t`7k", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("HL-Zs", cSVFormat2);
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("AauzXJ_A8!D27K", "_3zR8*-6-8 @I-QG");
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("m{g7kcbzv>2)nyEQY", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("i8%CD!", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords((LinkedList<CSVRecord>) null);
        fail("Expecting exception: IOException");
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("m{g7kcbzv>2)nyEQY");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("qSs,", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("o9/b9 e%2cex", cSVFormat0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("wFKS@!yn6", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile(" th record values can't be accesedby nme", (String) null);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(" th record values can't be accesedby nme", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test29()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("A+9DS]Kz");
      CSVParser cSVParser0 = CSVParser.parse("A+9DS]Kz", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('p');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("A+9DS]Kz");
      StringReader stringReader0 = new StringReader("kh\"`!`x5");
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("HL-Zs", "HL-Zs");
      Charset charset0 = Charset.defaultCharset();
