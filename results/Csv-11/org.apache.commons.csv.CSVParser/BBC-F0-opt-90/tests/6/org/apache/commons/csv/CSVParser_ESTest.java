...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/0@=CPyRL0@S)<$CQP");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "");
      URL uRL1 = MockURL.URL(uRL0, "0@=CPyRL0@S)<$CQP");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "A'fyI(, 5";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("A'fyI(, 5", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\u0090');
      CSVParser cSVParser0 = CSVParser.parse("aGeGfLHzsKmC:\u0005", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("A'fyI(, 5", cSVFormat0);
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("]iB-^_X<[6S2", "]iB-^_X<[6S2");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\u0090');
      StringReader stringReader0 = new StringReader("aGeGfLHzsKmC:\u0005");
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('~');
      CSVParser cSVParser0 = CSVParser.parse("Mq", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("r )3)>xuu.x", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("A'fyI(, 5");
      CSVParser cSVParser0 = CSVParser.parse("A'fyI(, 5", cSVFormat1);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("r )3)>xuu.x");
      CSVParser cSVParser0 = CSVParser.parse("r )3)>xuu.x", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("+/_EAfK", "ySt#.!bvd'd");
      Charset charset0 = Charset.defaultCharset();
