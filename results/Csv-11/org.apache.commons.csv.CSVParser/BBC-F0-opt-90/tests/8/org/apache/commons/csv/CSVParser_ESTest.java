...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("The comment start and the escape character cannot be the same ('", "N3|");
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "0gi!`";
      stringArray0[1] = "RcHU\"WUxk+%7";
      stringArray0[2] = "";
      stringArray0[3] = "12Nvqr 3&d";
      stringArray0[4] = "(line ";
      ...
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[Record separator can only by CR, LF or CRLF]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader(";Y&qGH");
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("ZpY!0y`2R11Y/", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("j&KCmQjfd::oGD", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("ALL", "a+\"%{w|^=~+;u");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("j&KimQjfd::#G-", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("6r\ne)>-n", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("M\"\",\"!f93'[q", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
  ...
  public void test28()  throws Throwable  {
      StringReader stringReader0 = new StringReader("j&KimQjfd::#G-");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      char[] charArray0 = new char[2];
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("j&KimQjfd::#G-");
