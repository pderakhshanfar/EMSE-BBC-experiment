...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("cD7h)))", cSVFormat1);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"%ob%:s9d5% B", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("cE)~>QRR0b%1M=Uqd(", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("]*ynJ6y|m,`", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test26()  throws Throwable  {
      ...
      stringArray0[0] = "v";
      stringArray0[1] = "enPt^R3_y1)LbLoxi";
      stringArray0[2] = "|W~3QN8z";
      stringArray0[3] = "4mlwt#'pf";
      stringArray0[4] = ") invalid parse sequence";
      stringArray0[5] = "7YuU#@oS;A9*";
      stringArray0[6] = "RY/6#^@@i>C3=";
      stringArray0[7] = "CSVParser has been closed";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      // Undeclared exception!
      try { 
        CSVParser.parse("I}X}{-z", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("eg", "`AjWl(VLqMw[");
      File file0 = MockFile.createTempFile("`AjWl(VLqMw[", "jIJ!CzzXu:<*", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("8U3Z<WSmmH8])l_)E$", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("@Q4AS}=W]hr1z<@ph\"*", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("]*ynJ6y|m,`", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[]*ynJ6y|m,`]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("cD7h)))", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
