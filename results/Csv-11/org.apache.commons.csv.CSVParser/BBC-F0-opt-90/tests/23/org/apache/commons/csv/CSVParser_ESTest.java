...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("1;ttVzfi");
      File file0 = MockFile.createTempFile("1;ttVzfi", "Unexpected Quote value: ", (File) mockFile0);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "E2lwv4H";
      stringArray0[1] = "Nnx4lbbyYns!~?OQSf";
      stringArray0[2] = "";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("E2lwv4H", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('G');
      StringReader stringReader0 = new StringReader("\"<THMO;IIfX'n*dLIY");
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("yD01ervOMjCYA@]jK");
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("2^K Yi8>Q", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("/|G'~p@7w\u0000");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      String[] stringArray0 = new String[3];
      stringArray0[0] = "E2lwv4H";
      stringArray0[2] = "";
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('G');
      StringReader stringReader0 = new StringReader("f}V.cl(i/[@>es2fm");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"<THMO;IIfX'n*dLIY", cSVFormat0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader("/|G'~p@7w\u0000");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("l4wd@q@}(Qcj}OL");
  ...
  public void test32()  throws Throwable  {
      StringReader stringReader0 = new StringReader("/|G'~p@7w\u0000");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("/|G'~p@7w\u0000");
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("The header contains a duplicate name: \"", ",8lM!FgZ*tCwz+");
      // Undeclared exception!
      try { 
