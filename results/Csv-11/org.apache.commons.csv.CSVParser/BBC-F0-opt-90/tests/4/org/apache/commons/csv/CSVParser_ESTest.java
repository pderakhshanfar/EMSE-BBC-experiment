...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "fcck5NG>Y");
  ...
  public void test05()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("C!'fT~", cSVFormat1);
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Gk&LkQpE1t?`!");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("/AG9[R%_ R?l;q^", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("[v^JfLg", "[v^JfLg", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("cQRw[T4}#3", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("i1*k:)", cSVFormat0);
      cSVParser0.close();
  ...
  public void test24()  throws Throwable  {
      ...
      stringArray0[0] = "k\"Bvj;DWM?UbC";
      stringArray0[1] = "z1:.l5";
      stringArray0[2] = " EmptyLines:ignored";
      stringArray0[3] = "^LjW^wN<b:3";
      stringArray0[4] = "^1\"ly 6bJJB-ewHf";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      // Undeclared exception!
      try { 
        CSVParser.parse("^1\"ly 6bJJB-ewHf", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("D9Z$Ee<~1Z1/1Z");
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(":;gHA");
      // Undeclared exception!
      try { 
        CSVParser.parse(":;gHA", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("K.q^g(idku4a");
      CSVParser cSVParser0 = CSVParser.parse(":;gHA", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("C!'fT~", cSVFormat0);
