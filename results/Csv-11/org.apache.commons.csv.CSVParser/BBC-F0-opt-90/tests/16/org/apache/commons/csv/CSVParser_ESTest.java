...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[1] = "(PxW!zBF#m+lV";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("<3^~[?9SsaD+Tr", cSVFormat1);
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("&3t%p -pXrS;S&9!?g1", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("l(76`hz>HNT,~Stn", cSVFormat1);
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("l(76`hz>HNT,~Stn");
      CSVFormat cSVFormat0 = CSVFormat.newFormat('d');
      String[] stringArray0 = new String[1];
      stringArray0[0] = "l(76`hz>HNT,~Stn";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("|d:/eaY~fZ", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("8*,dfwNyz+CdA!~pgm", "8*,dfwNyz+CdA!~pgm");
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("l(76`hz>HNT,~Stn", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("wSI7H>VF=0tx+O3ny", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("l5+SG`ek3}|\"", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test24()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/l(76`hz>HNT,~Stn0l(76`hz>HNT,~Stn");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "tGv9{Zt/<");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("l(76`hz>HNT,~Stn", "l(76`hz>HNT,~Stn");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("k#V8=_oYjVT V4-");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("k#V8=_oYjVT V4-", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("l(76`hz>HNT,~Stn");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("l(76`hz>HNT,~Stn", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("f0\"e(V_rm!q(=8aB", cSVFormat0);
