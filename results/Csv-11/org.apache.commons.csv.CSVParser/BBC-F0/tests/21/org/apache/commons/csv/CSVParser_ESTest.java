...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "Nk,dAR$`M=6m-LuyO";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Nk,dAR$`M=6m-LuyO", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("l_yOETHzg}=j3!4nS", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("ce;ih9EA;ysZH", cSVFormat0);
      cSVParser0.close();
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("yY(h/<']<}");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("tgfm#n3");
  ...
  public void test15()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(650);
      CSVParser cSVParser0 = cSVFormat0.parse(pipedReader0);
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("Nk,dAR$`M=6m-LuyO", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("Nk,dAR$`M=6m-LuyO", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("HP&k>mH.B Mumq");
      CSVParser cSVParser0 = CSVParser.parse("HP&k>mH.B Mumq", cSVFormat1);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("tgfm#n3");
      CSVParser cSVParser0 = CSVParser.parse("org.apache.cAmmons.csvUCSVParser$2", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("tgfm#n3", "x=oeXhc>xE,/)84");
      Charset charset0 = Charset.defaultCharset();
