...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      File file0 = MockFile.createTempFile("EoU]c9`", "EoU]c9`");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("!)aH394+^v3$W", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("bG~Z", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("!)394+C^v36R$6W", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("OF?g>]=m", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("@Aq/}x48a");
      File file0 = MockFile.createTempFile(">YG9).x", ">YG9).x", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      ...
      stringArray0[3] = "]qv+oL;q@9";
      stringArray0[4] = "A";
      stringArray0[5] = "eM";
      stringArray0[6] = "8qsTR<=o_0704.";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test22()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("!)394+C^v36R$6W", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[!)394+C^v36R$6, ]", cSVRecord0.toString());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("JPr dM{e/-U<UfG*U$h", cSVFormat1);
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[0] = "\u2028";
      stringArray0[1] = "JPr dM{e/-U<UfG*U$h";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("JPr dM{e/-U<UfG*U$h", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
