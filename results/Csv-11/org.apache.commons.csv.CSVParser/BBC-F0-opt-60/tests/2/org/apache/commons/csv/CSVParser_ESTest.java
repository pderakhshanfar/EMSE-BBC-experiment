...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(358);
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[1] = "X5$=DZ.Y<8]'8Gmh";
      stringArray0[2] = "NH<H&%#C<r5b}^";
      stringArray0[3] = "eo?|dnzg%jp^>";
      stringArray0[4] = "{B";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("X5$=DZ.Y<8]'8Gmh", cSVFormat1);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("WSV>/}F('`*?T{<`?'}", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      ...
      stringArray0[0] = "";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("M~2uRG", cSVFormat1);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"MKf/7/N@[\"i]2$", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("Pu3Ky#P", "Pu3Ky#P");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("I-ZD", "");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(":h3d7b7]mfn4>~:C_", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("G`#`+UHzK", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader(",(g]N{iMs");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(":h3d7b7]mfn4>~:C_", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("X5$=DZ.Y<8]'8Gmh", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("WSV>/}F('`*?T{<`?'}");
  ...
  public void test35()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("9';+", "9';+", 1885, "9';+", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
  ...
  public void test37()  throws Throwable  {
      File file0 = MockFile.createTempFile("parameter '", "The escape character and the delimiter cannot be the same ('", (File) null);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
