...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[0] = "B}WoS~$(e/ux4ATHx";
      stringArray0[1] = "org.apache.commons.csv.Token$Type";
      stringArray0[2] = "0n";
      stringArray0[3] = "xi,`";
      stringArray0[4] = "?tK";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("B}WoS~$(e/ux4ATHx", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(2162);
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("&/e-*kU@", cSVFormat0);
      cSVParser0.close();
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("[Z^0K/:(VS5m~'?L#y", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("&/e-*k@", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile((String) null, "ALL");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      PipedReader pipedReader0 = new PipedReader(1030);
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0);
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("*H?;dNkfc[>->b0R@B", "*H?;dNkfc[>->b0R@B");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("fn_0; xcb/p_/", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("0e#:L", cSVFormat1);
  ...
  public void test29()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("&/E-*k@");
      Quote quote0 = Quote.NON_NUMERIC;
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      CSVParser cSVParser0 = CSVParser.parse("f2>{q< v.vcR3Tk?", cSVFormat2);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[f2>{q< v.vcR3Tk?]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('x');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("[Z^0K/:(VSm~'L#y");
      Quote quote0 = Quote.NON_NUMERIC;
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      CSVParser cSVParser0 = CSVParser.parse("[Z^0K/:(VSm~'L#y", cSVFormat2);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("The header contains a duplicate entry: '", "Mtyz':qraGL?P");
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
