...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("v+oIv", cSVFormat1);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"?I/A>sd+ x", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("gdm0d-0GJ", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("V[.:!)_C1aO]W^HD", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("\" in ", "", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[1] = "";
      stringArray0[2] = "G-:";
      stringArray0[3] = "V[.:!)_C1aO]W^HD";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("V[.:!)_C1aO]W^HD", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test30()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("g9:h Hl");
      StringReader stringReader0 = new StringReader("5j@]0^8E");
  ...
  public void test31()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("g9:h Hl");
      CSVParser cSVParser0 = CSVParser.parse("g9:h Hl", cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("g9:h Hl", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("%,_WUbzQ5Yz&X;[O", "\"QluEi#?a*lJ~");
      Charset charset0 = Charset.defaultCharset();
      try { 
