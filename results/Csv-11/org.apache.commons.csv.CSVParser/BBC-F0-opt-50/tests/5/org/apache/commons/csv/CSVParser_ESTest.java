...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "&jvs,hq'a@3~<h";
      stringArray0[1] = "^c}@gzw~ubx";
      stringArray0[2] = "@XMcmtiM.np19c>B";
      stringArray0[3] = "4EqsArmHfG}L(;";
      stringArray0[4] = "_3-2e]h\u0004bt?";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("LFY_{C", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[LFY_{C]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("~5K._G*ehDC", cSVFormat0);
      cSVParser0.close();
  ...
  public void test11()  throws Throwable  {
      MockFile mockFile0 = new MockFile("01]4w.tzz");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      try { 
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("3>@fh'k", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("P5Dd+;e3gX~r\"D", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test19()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("9!wWwCvk'9Naz", cSVFormat1);
      cSVParser0.getRecords();
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("The header contains a duplicate entry: '", "0BD-F ");
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/The header contains a duplicate entry: '00BD-F ");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "4EqsArmHfG}L(;");
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("V;b,P{~&C6C8BJ.H]d[", cSVFormat0);
  ...
  public void test23()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("&2bS|wQr>uG*ET");
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("~5K._G*ehDC");
      File file0 = MockFile.createTempFile("~5k._g*ehdc", (String) null, (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("LFY_{C", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("+xr!)4~AlhU{H", cSVFormat2);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("9!W}B~'|9A>");
      CSVParser cSVParser0 = CSVParser.parse("9!W}B~'|9A>", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
      assertFalse(list0.isEmpty());
  }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("<,h1LSY-V", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("+xr!)4~AlhU{H", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
