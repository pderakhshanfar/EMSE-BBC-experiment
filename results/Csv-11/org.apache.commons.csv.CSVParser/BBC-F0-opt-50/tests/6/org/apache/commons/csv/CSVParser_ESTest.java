...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("(TVcwjx=qoj.bty", "F}");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "QA|tFn";
      stringArray0[1] = "`j%S#Dd#=?ax!mJF@";
      stringArray0[2] = "Z2T&]";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(",L_Nm^e] 56Y7_EPf", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("QA|tFn", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"e`da", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Olc4{j", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("f9yiLe", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("S*Sv~P.~MHPFm");
      CSVParser cSVParser0 = CSVParser.parse("')", cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("5-<F@#q%uatJM2");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat3 = cSVFormat2.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("5-<F@#q%uatJM2", cSVFormat3);
        fail("Expecting exception: NullPointerException");
