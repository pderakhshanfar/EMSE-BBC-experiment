...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("T_F", "org.apache.commons.csv.CSVParser");
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("w{0?yy^S/", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      MockFile mockFile0 = new MockFile("ryy+x^^zX.!^|`", "");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('g');
      CSVParser cSVParser0 = CSVParser.parse("wARWK?Fr", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("OX", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("\"}*lzu{xuz", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('g');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("]e$B$");
      String[] stringArray0 = new String[2];
      stringArray0[0] = "]e$B$";
      stringArray0[1] = "";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("y1=v|`dy", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("Z9m1Wod", "Z9m1Wod");
      // Undeclared exception!
      try { 
