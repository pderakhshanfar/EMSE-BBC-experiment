...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "B;*'BjIn]|xN+oI:@4";
      stringArray0[1] = "\" in ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("<n8@aIC", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("K3\"5f,pcq@,Ye-H8i", "");
      File file0 = MockFile.createTempFile("K3\"5f,pcq@,Ye-H8i", "K3\"5f,pcq@,Ye-H8i", (File) mockFile0);
  ...
  public void test12()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(":s,y<~?/6}pvenv(1n", "@'<q%Vvl4b0(DS{", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("x0t=.4+9o", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(":S,y<~?/6}pvEnv(1N");
      CSVParser cSVParser0 = CSVParser.parse(":S,y<~?/6}pvEnv(1N", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
