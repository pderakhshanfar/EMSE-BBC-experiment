...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[1] = "";
      stringArray0[2] = "l\"u=\"?D)HXrdR<uUr";
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("jX&]%l]vN#b");
      File file0 = MockFile.createTempFile("jX&]%l]vN#b", "jX&]%l]vN#b", (File) mockFile0);
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("jX&]%l]vN#b", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("Unexpected Token type: ", "|#e/", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("jm=tojmoy[", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("q?w6[6!NZ*;P");
  ...
  public void test18()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("NG/u\"!g8<r}DF\"", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("h*(+B%sXKE^iM", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("}35|@fx", cSVFormat0);
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(":W!!cfYGtEN&X", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile(",7P&S,LC", ",7P&S,LC");
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("oTVjO=$Zt}-B3Cc79", cSVFormat1);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("u'8-T,)%w[{goNq^$");
      CSVParser cSVParser0 = CSVParser.parse("u'8-T,)%w[{goNq^$", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("^]O&N{'I8");
      CSVParser cSVParser0 = CSVParser.parse("^]O&N{'I8", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
