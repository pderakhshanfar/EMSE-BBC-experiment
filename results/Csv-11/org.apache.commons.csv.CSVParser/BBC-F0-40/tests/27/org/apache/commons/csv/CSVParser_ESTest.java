...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[1] = "Qbb";
      stringArray0[2] = "A;W^$XxJi/Qu\"";
      stringArray0[3] = "jd4\"e qT6 ;Lu~[O#F";
      stringArray0[4] = "U1?=um~-'d";
      stringArray0[5] = "i1JCk/|D\"S%N/_PD fP";
      stringArray0[6] = "kp;FY)/YZ~r";
      stringArray0[7] = "$m8";
      stringArray0[8] = " |*^.kRC";
  ...
  public void test16()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("pcz$");
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("&%qHgC-v", cSVFormat0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("Record separator can only by CR, LF or CRLF", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("pEzPg:|Rnz> /");
      CSVParser cSVParser0 = CSVParser.parse("pEzPg:|Rnz> /", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("iw`+L1KXztiA", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[iw`+L1KXztiA]", cSVRecord0.toString());
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("No header mapping was specified, the record values can't be accessed by name", "76'?]qt;{IQ9c63]");
      Charset charset0 = Charset.defaultCharset();
      try { 
