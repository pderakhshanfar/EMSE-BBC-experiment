...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("V8~PJn'2");
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("#h_dtp3$:B$", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"ST$8", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("c0W@36u 3F@lT", "c0W@36u 3F@lT");
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('%');
      CSVParser cSVParser0 = CSVParser.parse("A4;,KqS*`-^", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("c0W@3u 3F@lT", cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("\"kq*I(uh+T");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("-Yqdm6nf?N`LAbYv", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("V8~PJn'2");
      StringReader stringReader0 = new StringReader("V8~PJn'2");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      cSVParser0.nextRecord();
  ...
  public void test32()  throws Throwable  {
      File file0 = MockFile.createTempFile("U#)WWy", "U#)WWy", (File) null);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('X');
      CSVParser cSVParser0 = CSVParser.parse("t;TbjDs!vR)WUd6o", cSVFormat0);
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("V8~PJn'2$", "CSVParser has been closed");
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("V8~PJn'2$", "V8~PJn'2$");
      Charset charset0 = Charset.defaultCharset();
      try { 
