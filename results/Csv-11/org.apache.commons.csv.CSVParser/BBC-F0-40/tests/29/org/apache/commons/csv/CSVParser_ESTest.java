...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      MockFile mockFile0 = new MockFile("nyh", "R&(')I.{^q+\"R0qE");
      File file0 = MockFile.createTempFile("P6;|xk`!49gjXEhXN%", ")3H,WYyT *ldw", (File) mockFile0);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "wl29w+.QB4y=aV~";
      stringArray0[1] = "Z]DA[fML";
      stringArray0[2] = "k)HJ:;~><";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Z]DA[fML", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("w_nBOt", cSVFormat0);
      cSVParser0.close();
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("-lHa\"!tH", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      PipedReader pipedReader0 = new PipedReader(3788);
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("N+_KOD3<o:", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('N');
      CSVParser cSVParser0 = CSVParser.parse("/0)5F~% `JF@pwqj", cSVFormat0);
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("(}k0ctV eaks F^je", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('L');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("w_nBOt");
      CSVParser cSVParser0 = CSVParser.parse("gnwgrY\"UC@n8\"#;8Du", cSVFormat1);
      cSVParser0.getRecords();
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('L');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("w_nBOt");
      CSVParser cSVParser0 = CSVParser.parse("w_nBOt", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("mh>&d", "mh>&d");
      // Undeclared exception!
      try { 
