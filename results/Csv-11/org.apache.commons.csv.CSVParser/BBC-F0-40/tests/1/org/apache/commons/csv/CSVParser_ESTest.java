...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("!0g4cdVEON", "!0g4cdVEON");
      File file0 = MockFile.createTempFile("!0g4cdVEON", "!0g4cdVEON", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("!0g4cdVEON", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\ra@x", cSVFormat2);
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("Xr;J#m-nda", "Unexpected Token type: ");
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      MockFile mockFile0 = new MockFile("&JF-3)@4", "&JF-3)@4");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      stringArray0[0] = ")mwqa(:r?7";
      stringArray0[1] = "*5{z!oX";
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("wj[y9A}mA\rc-`Hm!J.", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      cSVParser0.nextRecord();
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("\ra@x", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(")MWQa(:r6?7");
      CSVParser cSVParser0 = CSVParser.parse(")MWQa(:r6?7", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(")MWQa(:r6?7");
      CSVParser cSVParser0 = CSVParser.parse("6rw<!T:$-i.", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("\ra@x", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
