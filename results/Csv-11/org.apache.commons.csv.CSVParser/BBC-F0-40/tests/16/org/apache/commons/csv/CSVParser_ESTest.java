...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(308);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("rReW9fg'kofH>T?<YL", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      ...
      stringArray0[0] = "Q]M+(/a|%nq3";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("PC^6g0 xu}B<n)", cSVFormat2);
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("DP6:FIhmQ3>[BLl2>_", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      File file0 = MockFile.createTempFile("J7#!Ly&,I8Mf nF", "J7#!Ly&,I8Mf nF", (File) null);
  ...
  public void test11()  throws Throwable  {
      MockFile mockFile0 = new MockFile("),~0?+$RDuoWUrAJ'd36");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      try { 
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("xer@Y5\"=!8Y$E", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("4.@}Xg", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(",%2QS!,", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("PC^6g0 xu}B<n)", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("ar -7", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("X\"Hm>ce", cSVFormat2);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("XpGnZttG$zwBM):e");
      CSVParser cSVParser0 = CSVParser.parse("XpGnZttG$zwBM):e", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("yOH@XBWa~p!%o");
      CSVParser cSVParser0 = CSVParser.parse("org.apache.commons.csv.CSVParser$1", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("5ud7f3,IU*f!v", ";T");
      Charset charset0 = Charset.defaultCharset();
