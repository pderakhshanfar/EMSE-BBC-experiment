...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(")`|) ?dm^", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("f)nIW\r%r8yF", cSVFormat0);
      cSVParser0.close();
  ...
  public void test09()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("~cjBS@", "charset", 244, "hn7yFp>Lh[j>bE{,/t", uRLStreamHandler0);
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile(":^Q;r63sJigf7", "0U?Ug|L~72FA`f@s");
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("2EC-f;?LLKwk:3..,\"");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("O' #N./_Qr", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("8:mEu&v");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[, :mEu&v]", cSVRecord0.toString());
  }
  ...
  public void test36()  throws Throwable  {
      File file0 = MockFile.createTempFile("YhL&=tP?", "r/`B8vj\"x.z");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
