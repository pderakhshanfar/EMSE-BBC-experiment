...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("EORECORD", "", (File) mockFile0);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "=6";
      stringArray0[1] = "Uy|r";
      stringArray0[2] = "9Sj`]3%s)Rkl1#Ju]BU";
      stringArray0[3] = "P+@;q'^c9X2#oErb";
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("N,vC%kNT}Z~wt'hN;d");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("X7", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"dO]O}oC9yvN", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser", "org.apache.commons.csv.CSVParser$2");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("7i{dVbaaW=&RL3d\"zy", "7i{dVbaaW=&RL3d\"zy");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("[7!8", cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
        cSVParser0.getRecords(linkedList0);
  ...
  public void test25()  throws Throwable  {
      ...
      stringArray0[0] = "5m4#=)h9O+=Zt,tVH>(";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("~\"rHIorMVL\"y:g", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("kofCAor0", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("X7", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("%ZQ/iK:()k#X,,", cSVFormat2);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [%ZQ/iK:()k#X, , ]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
