...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = ")r}-[wq,\"0i__";
      stringArray0[1] = "iMaHk(/E}6wA";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      CSVParser cSVParser0 = CSVParser.parse("Nsnj98t`vKp", cSVFormat2);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[3] = "xz";
      stringArray0[4] = "url";
      stringArray0[5] = "ml:ah1k<ifn\"k";
      stringArray0[6] = "sk7>ipheaderrecor:";
      stringArray0[7] = " SkipHeaderRecord:";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("ml:ah1k<ifn\"k", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[ml:ah1k<ifn\"k]", cSVRecord0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      CSVParser cSVParser0 = CSVParser.parse("@o-t[T:", cSVFormat0);
      cSVParser0.getRecords(linkedList0);
  ...
  public void test09()  throws Throwable  {
      File file0 = MockFile.createTempFile("format", "PsI.H`6");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      String[] stringArray0 = new String[2];
      stringArray0[0] = ":<&2Pbb-p-8D<.";
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("s2ndUe", "tQr,2yRW{");
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("wFwc,6nrXSLUjY:>>Uf", cSVFormat0);
      cSVParser0.close();
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("Nsnj98t`vKp", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("c)&_(OI|UIE,,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [c)&_(OI|UIE, , ]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("oTiP7-!WtL?c2n}P", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("wF,6nrXSLUjY:>h>Bf");
      CSVParser cSVParser0 = CSVParser.parse("wF,6nrXSLUjY:>h>Bf", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("oTiP7-!WtL?c2n}P");
      CSVParser cSVParser0 = CSVParser.parse("oTiP7-!WtL?c2n}P", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("s2ndUe", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("C aMz", cSVFormat0);
