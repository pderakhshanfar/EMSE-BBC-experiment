...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = ")d*7Y!.zwN%~G_ 0F!s";
      stringArray0[1] = "s`2a=m IEvN2PKK{4vT";
      stringArray0[2] = "=+>zhxMZ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("=+>zhxMZ", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("pnS}aSdK-,vE|U!B/m", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("kBm<_Pud^hAPF", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"Yj$i_?A]y", cSVFormat1);
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("CSVParser has been closed", "mK)Y1>F.F-]xTL1?");
      MockFile mockFile0 = new MockFile(file0, "mK)Y1>F.F-]xTL1?");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      try { 
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("~^>Px1?/%?oBQ%oW|w");
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      StringReader stringReader0 = new StringReader("2&/4Yr:O.F|V\"");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.getRecords(linkedList0);
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("4~#d", "string");
      File file0 = MockFile.createTempFile("4~#d", "EORECORD", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(",_V,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [, _V, ]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("sS");
      String[] stringArray0 = new String[1];
      stringReader0.read();
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("yd&I", "`G(,`w#s(&N^;ScW");
      // Undeclared exception!
      try { 
