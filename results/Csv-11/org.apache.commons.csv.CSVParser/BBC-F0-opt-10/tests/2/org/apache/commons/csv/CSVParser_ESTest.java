...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "G<";
      stringArray0[1] = "ON{a@qUd_nS-^guxwaC";
      stringArray0[2] = " 1g0qxoH8KS";
      ...
      CSVParser cSVParser0 = CSVParser.parse(" 1g0qxoH8KS", cSVFormat3);
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(' ');
      CSVParser cSVParser0 = CSVParser.parse(" 1g0qxoH8KS", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("h3m\"o 6E/P:*Q{X /", cSVFormat0);
      cSVParser0.close();
  ...
  public void test08()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Unexpected Token type: ", "", 0, "", uRLStreamHandler0);
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("CSVParser has been closed", "No quotes mode set but no escape character is set");
      File file0 = MockFile.createTempFile("No quotes mode set but no escape character is set", "@", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("bS1", "bS1");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      StringReader stringReader0 = new StringReader("7][e%{c'7>iu");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("{?*k7j8.V?~gQqy", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("y>9ufLu)~Q-5U S{n", cSVFormat1);
  ...
  public void test26()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$1", "22$FZck&gN1SjP", (File) mockFile0);
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[0] = "peMul+=E`^S\"}ryE";
      stringArray0[1] = "00HsdhB2i_c";
      stringArray0[2] = "bS1";
      stringArray0[3] = "nBu^n>gHN";
      stringArray0[4] = "MINIMAL";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("peMul+=E`^S\"}ryE", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
      assertNotNull(map0);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("]taJxVu^uxIhJaA.");
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<\t> QuoteChar=<\"> CommentStart=<M> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", cSVFormat1);
      cSVParser0.getRecords();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("bS1");
      CSVParser cSVParser0 = CSVParser.parse("bS1", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("bS1", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
