...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[0] = "url";
      stringArray0[1] = "1u";
      stringArray0[2] = "'a@Xd'n+";
      stringArray0[3] = "21Uxfv #";
      stringArray0[4] = "Qs(K/$R,OlY:s*iE";
      stringArray0[5] = "string";
      stringArray0[6] = "";
      stringArray0[7] = "Vhn&ug9Qm<-cm{{[";
      stringArray0[8] = ".{E";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("XNNo<qP", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[XNNo<qP]", cSVRecord0.toString());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(",Q(N`'qw8#P", cSVFormat0);
      cSVParser0.close();
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("ka!?YnpV(", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      ...
      URL uRL1 = MockURL.URL(uRL0, "p;Ukm<$H-", uRLStreamHandler0);
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("/experiment/]*<*)y/2F_Z%}eDI", "f3H_O{2n#$I1l5_%");
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Q877Q1+4:(Y9NQ'Yp", "Q877Q1+4:(Y9NQ'Yp");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("ile", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      File file0 = MockFile.createTempFile("cg47k", "i@Aofiq(cL/`hpj+f");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test22()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("K4y)", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("JDF", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test25()  throws Throwable  {
      ...
      stringArray0[0] = "8y(ta";
      stringArray0[1] = "yu:";
      stringArray0[2] = "o";
      stringArray0[3] = "u!:%b";
      stringArray0[4] = "<|lP,g7u";
      stringArray0[5] = "%A}hjkm\"E7C5G|WY~";
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("XNNo<qP", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("JDF", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("e2j ^)NeRgUt?#2n");
      CSVParser cSVParser0 = CSVParser.parse("e2j ^)NeRgUt?#2n", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("S.{b.Gj");
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile(",Q(N`'qw8#P");
      try { 
