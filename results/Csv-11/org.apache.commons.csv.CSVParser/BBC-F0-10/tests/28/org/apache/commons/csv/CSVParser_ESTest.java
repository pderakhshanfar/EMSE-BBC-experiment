...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"4D+tdk{>", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("@7Z(x");
      File file0 = MockFile.createTempFile("@7Z(x", "format", (File) mockFile0);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "(line ";
      stringArray0[1] = "I@A{y<CCs9301hqF";
  ...
  public void test07()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("lrcsl>r@gM");
  ...
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile("tq~<");
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("0XnYqR>", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"bD/ju>9bBpqtMUyPU(", cSVFormat1);
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("xtQ", (String) null);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("&6AY0=Y");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("<)bE8P|\"i>DMu9R", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test25()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(")5G&8+/'OS{|Y]B.", cSVFormat2);
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("MsYVC>yf_|{_m$OU;", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("!A] oe[jb1\"M&L0,", cSVFormat0);
      cSVParser0.close();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("GT $!;lP=QH,");
      CSVParser cSVParser0 = CSVParser.parse("GT $!;lP=QH,", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("W+=_>L-Q29#[");
      CSVParser cSVParser0 = CSVParser.parse("W+=_>L-Q29#[", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
