...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"[AVYw3-bUm+.", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[1] = "V;";
      stringArray0[2] = "zLqe-f";
      stringArray0[3] = "The header contains a duplicate entry: '";
      stringArray0[4] = " ZqL";
      stringArray0[5] = "]\\d\"zL%%*73pX>";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("}Evsjy\"Ubh*O_", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("dcB");
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("YOTgN#A", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test06()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("wJmfc5#X<.jk");
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("", "*;h6\"cQ");
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse(".ds*jL]", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The header contains a duplicate name: \"\" in [, z7, ]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("dcB", "0|kuz^-v4");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("E<Ll;9I+@|CN1", "PHv+A8ZY|Up.", (File) null);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("}Evsjy\"Ubh*O_", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("84P");
      CSVParser cSVParser0 = CSVParser.parse("!KwD", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("84P", cSVFormat3);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("!KwD", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
