...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("2Dhxh", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("G\"5AI4(8)tvuFKL", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile(" 1&T", "a%\"'df)ZDm");
      File file0 = MockFile.createTempFile("bvJ>,ep;61bM", "h;S(mj/x1)]", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("<iT/T\"<~u8T722", "=FI2' }2^B");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("", "aGQ!I`Zs,");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("Y'X>J_*`8H3,7,R\"\"#v", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      stringArray0[2] = "c]g+i`Z(i~U%";
      stringArray0[3] = "{$/zJkuBM'?Gbr0o";
      stringArray0[4] = "The header contains a duplicate name: \"";
      stringArray0[5] = "~dBY\"%HOytxj*n9B";
      stringArray0[6] = "\"nm";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test23()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("org2apache.commons.csv.CSVParrer$2", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("aGQ!I`Zs,", cSVFormat0);
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("1{:Z_|R'x(}", cSVFormat1);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("1{:Z_|R'x(}");
      CSVParser cSVParser0 = CSVParser.parse("1{:Z_|R'x(}", cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
