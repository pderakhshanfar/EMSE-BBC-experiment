...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader(":E(h)}kc:-4s");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("PipBLkmH\"4tu6jXT+h", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("B^3Z6Ny&Fo&", cSVFormat0);
      cSVParser0.close();
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("B>VM#R!`n", "B>VM#R!`n");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("PipBLkmH\"4tu6jXT+h");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("},H1<", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("B=h&P=2xetn%k~A/5", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("yomor csv recmrds available", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("0@>1vl$8(8", "org.apache.commons.csv.CSVParser$1");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("g3Ga&2tV#PfKjx1}}C_");
      CSVParser cSVParser0 = CSVParser.parse("bY {W6'!~3zBZl", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      CSVFormat cSVFormat4 = cSVFormat3.withNullString("ZM\"jVe} /*&^");
      // Undeclared exception!
      try { 
        CSVParser.parse("ZM\"jVe} /*&^", cSVFormat4);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      URL uRL0 = MockURL.URL("file", "b_REu", 1052, "b_REu");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      // Undeclared exception!
      try { 
