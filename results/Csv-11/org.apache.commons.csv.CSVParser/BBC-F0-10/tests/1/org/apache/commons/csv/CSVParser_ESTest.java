...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("P`j3b5SEvvVHYGxhiY");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('y');
      CSVParser cSVParser0 = CSVParser.parse("P`j3b5SEvvVHYGxhiY", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("D9bCaf&[v\"5w$", "d");
      File file0 = MockFile.createTempFile("'6p?lX;)YyF%", "d", (File) mockFile0);
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("3)!;$5i", "&Jw");
      File file0 = MockFile.createTempFile("3)!;$5i", "3)!;$5i", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("%SL@2y%DbHykQr9D]", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test23()  throws Throwable  {
      ...
      stringArray0[0] = ",Wxb=F";
      stringArray0[1] = "\"ag";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("y~xtDjP}", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("}62,", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[}62, ]", cSVRecord0.toString());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("0O0^`.c\"", "0O0^`.c\"");
      try { 
