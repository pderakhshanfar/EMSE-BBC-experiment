...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile(" the record values can't be accessed by name");
      File file0 = MockFile.createTempFile("No header mapping was specified, the record values can't be accessed by name", "N", (File) mockFile0);
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "Y0Ci1.Nl:C .gV^Z<*|";
      stringArray0[1] = "has3et";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("(8Hg>Jfb+~r-W", cSVFormat0);
      cSVParser0.close();
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("9m)6av_k-M", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile("No more CSV records available", "`Oj+cs");
      File file0 = MockFile.createTempFile("No more CSV records available", "c3VHb", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("k>Hh8QWKY2", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      PipedReader pipedReader0 = new PipedReader(1179);
  ...
  public void test22()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("~:4yXPtUl?}", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("!#$jjqhFiZ]ZcW", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("V|Fbz@i!", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("VUM,d ho2X7,", "6?C$1;+iI*y4");
      Charset charset0 = Charset.defaultCharset();
      try { 
