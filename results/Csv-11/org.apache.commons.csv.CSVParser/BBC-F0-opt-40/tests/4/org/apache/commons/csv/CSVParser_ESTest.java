...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"[}DI?|>XEb", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[1] = "url";
      stringArray0[2] = "1m]@l$#";
      stringArray0[3] = ":X:OXDYks2*:Y^.aS";
      stringArray0[4] = "g";
      stringArray0[5] = ",>fE#(}$eb4OB#@+Z";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(",>fE#(}$eb4OB#@+Z", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("y'lK", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("EwgKn=V4)LB=", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile("t:!>absvh");
      File file0 = MockFile.createTempFile("t:!>absvh", "t:!>absvh", (File) mockFile0);
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("<^n7F3I}mz", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("n<n", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("n<n*LB;gA2", cSVFormat3);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      stringArray0[2] = "EOF";
      stringArray0[3] = "VuA-%4W)gOM!,H.";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("2psG[X9~i4w]8U", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("E(an'", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
