...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/foo.bar/v7fL`079YFTKU@");
      ...
      File file0 = MockFile.createTempFile("v7fL`", "79YFTKU@", (File) mockFile0);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("H^0p{wf~_lyvzt", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("h2.|fKDgJhM]q?4V");
      File file0 = MockFile.createTempFile("3 bv>GRT", "string", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("+xMpC4h", (String) null);
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile(") EOF reached before encapsulated token finished", "No header mapping was specified, the record values can't be accessed by name");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      StringReader stringReader0 = new StringReader("hB3R?B\"5_");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      stringReader0.close();
  ...
  public void test26()  throws Throwable  {
      ...
      stringArray0[0] = "The comment start character and the quoteChar cannot be the same ('";
      stringArray0[1] = "(line ";
      stringArray0[2] = "F6/36gzJ!E}p&ukqA";
      stringArray0[3] = "string";
      stringArray0[4] = "p3!cly";
      stringArray0[5] = "pr]mOsTzR-hx=P+$:";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      // Undeclared exception!
      try { 
        CSVParser.parse("?+?0a+uN", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("java.lang.String@0000000002,,,,,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [java.lang.String@0000000002, , , , , ]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("5yvx?~#16_8r");
      CSVParser cSVParser0 = CSVParser.parse("The comment start character and the quoteChar cannot be the same ('", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
