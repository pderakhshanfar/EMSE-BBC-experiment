...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"O~WM`!yGVa&/IN", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "$#o3VZE%i:wtxz<");
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("<db+E'Al", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[1] = "X;;zpX%cGd";
      stringArray0[2] = "url";
      stringArray0[3] = "<db+E'Al";
      stringArray0[4] = "string";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("<db+E'Al", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("M6]", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile("RP^gS_(>)kKGE");
      File file0 = MockFile.createTempFile("RP^gS_(>)kKGE", "RP^gS_(>)kKGE", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("J\"%p3y]Z9-3%s#G%e\"", "J\"%p3y]Z9-3%s#G%e\"");
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("]su[qn/zi\"0eh", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("=[d(oq@Z:#X,c!:", cSVFormat0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test27()  throws Throwable  {
      ...
      stringArray0[5] = "non_mumeric";
      stringArray0[6] = "S_";
      stringArray0[7] = "I\"k&`Sq.2Ao";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      // Undeclared exception!
      try { 
        CSVParser.parse("eDys", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      String[] stringArray0 = new String[1];
      stringArray0[0] = "]su[qn/zi\"0eh";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("(oIkx8t44n", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("(oIkx8t44n");
      String[] stringArray0 = new String[1];
      stringArray0[0] = "]su[qn/zi\"0eh";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("(oIkx8t44n", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("M6]");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("@ZnVZr,+Bh");
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("G^nofc", "M6]");
      try { 
