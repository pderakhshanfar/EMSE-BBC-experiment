...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "YqPG^]ei}oHAH";
      stringArray0[1] = "org.apache.commons.csv.CSVParser$1";
      stringArray0[2] = ",p3p.\tg%A5";
      stringArray0[3] = ":p=";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("YqPG^]ei}oHAH", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("W+G;s@.qEm[jM&Y?<", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("YqPG^]ei}oHAH", cSVFormat0);
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("r3P=*TXV~#hb", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader(">d\"Qu8!)Kjf}BL]*B(");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("o,o4=$ez_1vi`50md<d", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test21()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("W+G;s@.qEm[jM&Y?<", cSVFormat1);
      cSVParser0.getRecords();
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("34m]", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("8Q:gf`Zphc9");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(">d\"Qu8!)Kjf}BL]*B(");
      CSVParser cSVParser0 = CSVParser.parse(">d\"Qu8!)Kjf}BL]*B(", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(";111K[X9/!0");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("r3P=*TXV~#hb", "_bu*Vo_5jzE89");
      Charset charset0 = Charset.defaultCharset();
