...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("No quotes mode set but no escape character s et", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[1] = "5^IUg [\"HaLA0}";
      stringArray0[2] = "";
      stringArray0[3] = ",~7R_";
      stringArray0[4] = "y[?|`<k8^m5g)2";
      stringArray0[5] = "yOc1|,<";
      stringArray0[6] = "ra)J%;ni4a&PT=iTR";
      stringArray0[7] = "{|rFyQB\"bU7^,Y|5=";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(",~7R_", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[, ~7R_]", cSVRecord0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("the quotechar character and the delimiter cannotbe the same ('", "(line ");
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("L\"=#x'fLY89V2h7!v", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("mOq)Y.-y*ANvs");
      File file0 = MockFile.createTempFile("~Jo l1?Ug5T4X;", "Unexpected Token type: ", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test17()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("bqbhhjr'l\"q7fg:f1o");
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(",~7R_", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("No quotes mode set but no escape character s et");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("l", "+23}P&3_/*a3E");
      Charset charset0 = Charset.defaultCharset();
      try { 
