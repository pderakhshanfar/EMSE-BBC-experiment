...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("3*1FMsCZ#URT", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("2HbM!+QxKEe=y.", "2HbM!+QxKEe=y.");
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("ZkCJlXXbM_%aIJG");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      File file0 = MockFile.createTempFile("FI liYyN~kdspTi[w,Z", "FI liYyN~kdspTi[w,Z");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test24()  throws Throwable  {
      ...
      stringArray0[0] = ",V]\"[H>`K5<;6aZP9";
      stringArray0[1] = "$:g6L$yq_#7vwr'";
      stringArray0[2] = "";
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("?", "P/.IQ=J=sk$");
      File file0 = MockFile.createTempFile("P/.IQ=J=sk$", "P/.IQ=J=sk$", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(" EmptyLines:ignored", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("eW[]Z/&B@ey(S,}", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("P=J=sk$");
      // Undeclared exception!
      try { 
        CSVParser.parse("P=J=sk$", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("P/.IQ=J=sk$");
      CSVParser cSVParser0 = CSVParser.parse("WaTXVQ|<n0-2I6!(", cSVFormat2);
