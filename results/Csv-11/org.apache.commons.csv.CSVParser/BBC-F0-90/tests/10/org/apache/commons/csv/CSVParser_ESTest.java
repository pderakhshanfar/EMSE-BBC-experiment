...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/8-b,k~<4bVL08-b,k~<4bVL");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "agx}V,Ef}sYLa`qU*I");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("8-b,k~<4bVL", "8-b,k~<4bVL");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "46bL(PI *3#uU{=eE0";
      stringArray0[1] = "H.d/";
      stringArray0[2] = "|@g]-ku64h_psmll#";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("|@g]-ku64h_psmll#", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("%7Dm_/{_5hB?l\"C'5=H", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("znhhM=L=-m#{igR_sPp", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(" SkipHeaderRecord:", cSVFormat4);
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<,> QuoteChar=<\"> NullString=<org.apache.commons.csv.CSVParser$2> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"4PL-@", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("org.apache.commons.csv.lexer", (String) null);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("znhhM=G=#m#%igR_sPp", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("C{K[d(|whr:{=Zl$3P", cSVFormat0);
      cSVParser0.close();
  ...
  public void test21()  throws Throwable  {
      File file0 = MockFile.createTempFile(" SurroundingSpaces:ignored", "> quotechar=<\"> recordseparator=<");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("8-b,k~<4bVL", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("spCmrzng", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("zYIc;U@G6\"WaCw^7f%", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("zB_J[.$t*(l^N$!", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("(qpeiz5p(<\"/dh]8 '");
      CSVParser cSVParser0 = CSVParser.parse("(qpeiz5p(<\"/dh]8 '", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
