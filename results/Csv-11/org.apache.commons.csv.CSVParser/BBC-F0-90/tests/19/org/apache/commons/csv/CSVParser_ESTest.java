...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile((String) null, "<o!VqK{HAW980");
      File file0 = MockFile.createTempFile("Index for header '%s' is %d but CSVRecord only has %d values!", (String) null, (File) mockFile0);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "";
      stringArray0[1] = "sib/7jy6t9?g'sjx";
      stringArray0[2] = "aRCP878XELG)/2cr^Y";
      stringArray0[3] = "vA31/X[]d/\"uNvZM";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("sib/7jy6t9?g'sjx", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("}i=0+CZ;)");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("}r#7`3N=", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("E#EmK,MoE3 }J>J>~z", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"7yUK+Uwwp2;!wiLX", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("E#EmK,MPE3 }J>J6~z", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("r8N1^d<#bq5FeBi2", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("ng,9cWh%trrMkY", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("sib/7jy6t9?g'sjx", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("i#oo");
      CSVParser cSVParser0 = CSVParser.parse("i#oo", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("sib/7jy6t9?g'sjx", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
