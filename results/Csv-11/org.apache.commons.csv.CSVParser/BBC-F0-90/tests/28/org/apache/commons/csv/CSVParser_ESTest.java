...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("ix{A1MwZ 8Wn0F`", "");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[2] = "lQ51:PWu6w}:";
      stringArray0[3] = "^8#-;h|X2#i";
      stringArray0[4] = "DlD9y]x!. yl{'^";
      stringArray0[5] = ") invalid parse sequence";
      stringArray0[6] = "zj;/Eb83yr>";
      stringArray0[7] = "org.apache.commons.csv.csvprinter$1";
      stringArray0[8] = "CaqI6<+1W\"2fv";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("CaqI6<+1W\"2fv", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[CaqI6<+1W\"2fv]", cSVRecord0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("dyy@nvtd1$", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("m|h{pz\"IH,t", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("NoDkj", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("string", ")&LuY2&S]");
      File file0 = MockFile.createTempFile("b7kdo%&u]7at!s,twa", "", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("uL{}", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Fr+mb:!z^", cSVFormat0);
      cSVParser0.close();
  ...
  public void test18()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("Delimiteir=<");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("^ACCQ^", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("[hz`4");
      CSVParser cSVParser0 = CSVParser.parse("[hz`4", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("[hz`4,dYY@nVTD1$");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('o');
      CSVParser cSVParser0 = CSVParser.parse("[hz`4,dYY@nVTD1$", cSVFormat2);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("[hz`4,dYY@nVTD1$", cSVFormat0);
