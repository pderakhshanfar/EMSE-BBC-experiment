...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("%]Lk", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      ...
      stringArray0[0] = "gdKO9,mJ;`&GIz";
      stringArray0[1] = "N|co?l";
      stringArray0[2] = "E.VZMKA:\";HCRuIKH";
      stringArray0[3] = "GRhu";
      stringArray0[4] = "|&\"HR0";
      stringArray0[5] = "";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      ...
      StringReader stringReader0 = new StringReader("{Wmf1]?>8]`xZ");
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("The header contains a duplicate entry: '", "j<t^XBXv!GWV7Xh3cP");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("h&&*ZvtBK.],'(g", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(",ko$mhDERN^~,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [, ko$mhDERN^~, ]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("org.apache.commons.csv.CSVRecord", cSVFormat3);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("2$i8", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("3fqiyf^c", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("charset");
      CSVParser cSVParser0 = CSVParser.parse("|I2p", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("|I2p", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("3fqiyf^c", "3fqiyf^c");
      Charset charset0 = Charset.defaultCharset();
      try { 
