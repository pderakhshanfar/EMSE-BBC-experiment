...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("GQB!)O");
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("}2x3{$Bb", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("|I2p");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test06()  throws Throwable  {
      ...
      stringArray0[0] = "L\"c$M7J3%WNbapFQ";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVFormat cSVFormat3 = cSVFormat2.withQuoteChar('=');
      CSVParser cSVParser0 = CSVParser.parse("L\"c$M7J3%WNbapFQ", cSVFormat3);
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("3{)/v;GItw4EN<", "3{)/v;GItw4EN<");
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("Vf%Qx%uA");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("L\"c$M7J3%WNbapFQ", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      String[] stringArray0 = new String[0];
      MockFile mockFile0 = new MockFile("N'^K", "B\"");
      File file0 = MockFile.createTempFile("N'^K", "unexpected token type: ", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("dO^mTcHP%3jP:d-;@X", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      String[] stringArray0 = new String[1];
      stringArray0[0] = "|~lf0j/]6,GQB!)O";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("~k#NV}[", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("|i2p");
      StringReader stringReader0 = new StringReader("GQB!)O");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[GQB!)O]", cSVRecord0.toString());
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("|~lf0j/]6,GQB!)O", cSVFormat0);
