...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "R[s_`cm?+2,4Wk";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("R[s_`cm?+2,4Wk", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("R[s_`cm?+2,4Wk", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      File file0 = MockFile.createTempFile("5dIfB4Xgs,aNBw5[", "E&OF ~Casg");
  ...
  public void test12()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("vhZn1LiQ;X!", "V6fe8Ny");
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("\"gJ", cSVFormat0);
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("`}mL.-U", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("6\"g", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("R[s_`cm?+2,4Wk");
      CSVParser cSVParser0 = CSVParser.parse("R[s_`cm?+2,4Wk", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[R[s_`cm?+2, 4Wk]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("pLt]R]uc^j7li.o.8");
      CSVParser cSVParser0 = CSVParser.parse("pLt]R]uc^j7li.o.8", cSVFormat1);
      cSVParser0.nextRecord();
