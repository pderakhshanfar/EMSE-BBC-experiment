...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile((File) null, ",dpozlA$]DFJl,:\"f0");
      File file0 = MockFile.createTempFile("yptu0rof\"w2}9ms", "yptu0rof\"w2}9ms", (File) mockFile0);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("rqJ", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Mn,I=+,0d", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("sHP;9Zm|ayi= EO3zv;", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"[` dB[8?_pj!64-", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("Ntvk6;yoc\"%}6^k,T&", "Ntvk6;yoc\"%}6^k,T&");
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("Stf[$jI(]lGGwyS4o%", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("N&}vOg6__45&4\"", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("K 6EL~6>IU");
      CSVParser cSVParser0 = CSVParser.parse("k 6el~6>iu", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Q>K%-G2jI+'w");
      String[] stringArray0 = new String[0];
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("8C*>yV.:X>~J^", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
