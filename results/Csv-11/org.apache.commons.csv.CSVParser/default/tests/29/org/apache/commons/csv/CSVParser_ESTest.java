...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[2] = "rzg&6>}x$Rjv6mG5o5s";
      stringArray0[3] = "Index for header '%s' is %d but CSVRecord only has %d values!";
      stringArray0[4] = "NON_NUMERIC";
      stringArray0[5] = "$";
      stringArray0[6] = "qWRJNzb%KID:VB";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("nwO>X*TD;g`", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("nwO>X*TD;g`", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals(1L, cSVRecord0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("z'+%8$0/@", "ej3B^h~=");
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("Iu%>vhJuC0DRNv`U(", "Iu%>vhJuC0DRNv`U(");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("\"Hdk%/e[@EpMH g", cSVFormat0);
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("ej3B^h~=", cSVFormat0);
      cSVParser0.close();
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("F~`H<hy4nc[}*d", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(",HbS`C6OZZj,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [, HbS`C6OZZj, ]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("AIWv,", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      StringReader stringReader0 = new StringReader("BB_jT51`");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("BB_jT51`");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("\"^sGJ[encA!1M..]H");
      CSVParser cSVParser0 = CSVParser.parse("Iu%>vhJuC0DRNv`U(", cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Iu%>vhJuC0DRNv`U(", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test30()  throws Throwable  {
      StringReader stringReader0 = new StringReader(") dnvalid parse sequence");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
