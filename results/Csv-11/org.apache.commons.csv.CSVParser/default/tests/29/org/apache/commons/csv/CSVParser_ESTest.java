...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("f;c`su");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[1] = "ZiWE2";
      stringArray0[2] = "' must not be null!";
      stringArray0[3] = "(line ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("{dvc", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("*'ZV)|:AH2NziT'");
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("<1O <VNuVBePO<u ", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"fBO)R6el-^b!>B9", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("The header contains a duplicate name: \"", "0_?ej0ul");
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("0_?ej0u", cSVFormat0);
      // Undeclared exception!
      try { 
        cSVParser0.getRecords((LinkedList<CSVRecord>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("mMz2pXs,LFO-ocSM", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("n;8>pg$k8_ewjdi#e^", cSVFormat0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("{dvc", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[0] = "e?+1 h";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      // Undeclared exception!
      try { 
        CSVParser.parse("td)/1{!eiI5", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("a,?teGN", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("oIOo(Hi+ap8E", cSVFormat0);
      cSVParser0.close();
      boolean boolean0 = cSVParser0.isClosed();
      assertTrue(boolean0);
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("<1O <VNuVBeZPO<u ");
      CSVParser cSVParser0 = CSVParser.parse("<1O <VNuVBeZPO<u ", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("AZA>vKq&!{nI7I$+");
      String[] stringArray0 = new String[0];
  ...
  public void test36()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("LW0]Zhi", "org.apache.commons.csv.Lexer", 90, "<1o <vnuvbpo<u ", uRLStreamHandler0);
      // Undeclared exception!
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("x%(k-Gjvs#3/=W", cSVFormat0);
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("<1O <VNuVBePO<u ", "=m");
      Charset charset0 = Charset.defaultCharset();
