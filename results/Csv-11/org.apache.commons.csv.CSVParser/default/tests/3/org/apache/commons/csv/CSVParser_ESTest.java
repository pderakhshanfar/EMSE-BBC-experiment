...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "Z$%Hh]W(h");
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[4] = "py${g&tO^m";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Q? DAp^nNhi0", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"UU]9Ke:$zD!]Q) g", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.csv.Token$Type", "fo$$A~iW<@%n+");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("\"aJjTs", cSVFormat0);
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("\"q(EHm", cSVFormat0);
      try { 
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("@B^ug7", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("The comment start character and the delimiter cannor be the same ('", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("Fee4%]", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("=mo=!D=j?[US#v(wl", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("F{!");
      CSVParser cSVParser0 = CSVParser.parse("Fee4%]", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("C=6D4", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test39()  throws Throwable  {
      File file0 = MockFile.createTempFile("pCFXaoHYu50#(5", "pCFXaoHYu50#(5");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
