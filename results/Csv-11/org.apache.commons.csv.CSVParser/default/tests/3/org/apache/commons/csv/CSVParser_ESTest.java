...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("`8'R", "`8'R");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "7\"w,:hxniW|s<'c3Z&";
      stringArray0[1] = "No more CSV records available";
      stringArray0[2] = "H^a'@b";
      stringArray0[3] = "RL{6";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("2DRl[u<K", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[2DRl[u<K]", cSVRecord0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<\t> Escape=<> QuoteChar=<S> RecordSeparator=<\n> SkipHeaderRecord:false", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("0oG(>", "0oG(>");
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("p}18'K");
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("Js\"N#G", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("{=c,g/'.h%Q$*</");
      CSVParser cSVParser0 = CSVParser.parse("{=c,g/'.h%Q$*</", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("zvd_@A7m};{<}cW");
      CSVParser cSVParser0 = CSVParser.parse("zvd_@A7m};{<}cW", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
