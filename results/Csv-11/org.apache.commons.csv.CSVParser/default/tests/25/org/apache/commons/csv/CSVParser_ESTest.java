...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("M!!,O2", cSVFormat1);
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("a.Fs'(J+?2)");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"fg>9>n&9vh+_p6ic", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("a.Fzs'(J+?2)", "a.Fzs'(J+?2)");
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/file0file");
  ...
  public void test23()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("hE-.zlj_%*%=A", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse(";1_lgT7Df#", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("M!!,O2", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("n;^]1f", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("EOF", "org.apache.commons.csv.Constants");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(";1_lgT7Df#");
      CSVParser cSVParser0 = CSVParser.parse(";1_lgT7Df#", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Vh'oiv}'");
      CSVParser cSVParser0 = CSVParser.parse("'5&/U&", cSVFormat1);
