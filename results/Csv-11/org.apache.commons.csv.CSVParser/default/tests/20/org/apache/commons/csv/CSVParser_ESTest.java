...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "file";
      stringArray0[1] = "pN!5&l(i4i";
      stringArray0[2] = "$VALUES";
      stringArray0[3] = "n7{n[_=}%e=OT5;j";
      stringArray0[4] = "format";
      stringArray0[5] = "K_W3`BwCDP<ic'#cFN";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("K_W3`BwCDP<ic'#cFN", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test09()  throws Throwable  {
      File file0 = MockFile.createTempFile("7e=", "mp|e");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("-pZW'.pQ(]MEQeQ%Y", "-pZW'.pQ(]MEQeQ%Y");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("8Z", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords((LinkedList<CSVRecord>) null);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("\"s%WY\"c[u]S0", cSVFormat0);
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test19()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("k `u |", cSVFormat1);
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("nT;*FCYB%/p+6vYMGp", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("K_W3`BwCDP<ic'#cFN", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("K/&3yS>aC_", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("6G9bpvl@orXL", cSVFormat0);
      cSVParser0.close();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("K_W3`BwCDP<ic'#cFN", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("MINIMAL", ";U");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("charset", "Delimiter=<\t> Escape=<> RecordSeparator=<\n> SkipHeaderRecord:false");
      Charset charset0 = Charset.defaultCharset();
