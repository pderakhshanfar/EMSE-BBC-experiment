...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[1] = "?K~>A";
      stringArray0[2] = "&";
      stringArray0[3] = "-pt.#[4>3=UC=K6]O";
      stringArray0[4] = "No more CSV records available";
      stringArray0[5] = ":.+,a#AIw8yl2M@8/q7";
      stringArray0[6] = "";
      stringArray0[7] = "?Q3n7U>~wE66F1&J";
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("ned+{eX`KREo>U8nb(", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("mO$^Aew|i8FsY'b", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("m)-d", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("(lin ", (CSVFormat) null);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"Jk3~{o*", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse(" $!y^nktaA=", cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("NullString=H<", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("eC$4!/aGyzcn=s)21f", "eC$4!/aGyzcn=s)21f");
      File file0 = MockFile.createTempFile("eC$4!/aGyzcn=s)21f", "eC$4!/aGyzcn=s)21f", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("DY%;&,?6f&xFF:'cVO", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[DY%;&, ?6f&xFF:'cVO]", cSVRecord0.toString());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("LcK", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Z3Hj+](u^J", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(" $!y^nktaA=");
      CSVParser cSVParser0 = CSVParser.parse(" $!y^nktaA=", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test36()  throws Throwable  {
      File file0 = MockFile.createTempFile("INVALID", "The comment start character and the delimiter cannot be the same ('");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      // Undeclared exception!
      try { 
