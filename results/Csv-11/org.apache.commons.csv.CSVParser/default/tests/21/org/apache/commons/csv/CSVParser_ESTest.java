...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "{c,cgQ]8=";
      stringArray0[1] = "X74%";
      stringArray0[2] = "`xqv!sC,P90t50x";
      stringArray0[3] = "')";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("{c,cgQ]8=", cSVFormat1);
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("F3B|$|-|S>0\"/", (CSVFormat) null);
  ...
  public void test11()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("p#*p|iep4tp~'ya", "p#*p|iep4tp~'ya");
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("iqTXIk*J'!V+_", "iqTXIk*J'!V+_");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("no header mapping was specified", cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("\"^ZV(9>*zoILQh,dN", cSVFormat0);
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("B\bI4WH]<zFTCy", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(") invalid parse 5equence", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test23()  throws Throwable  {
      ...
      stringArray0[0] = "O|/`u;RwIp1nw";
      stringArray0[1] = "";
      stringArray0[2] = "q&kN5PS_\u0003y,";
      stringArray0[3] = "TOKEN";
      stringArray0[4] = "D`R5q{q&";
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("V*H[F3^}0!0I(gUB", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("DI),4rVao", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("iqTXX|Ik*t'!V+_");
  ...
  public void test29()  throws Throwable  {
      StringReader stringReader0 = new StringReader("iqtxx|ik*t'!v+_");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("iqtxx|ik*t'!v+_");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("DW),4rVao", "DW),4rVao");
      Charset charset0 = Charset.defaultCharset();
