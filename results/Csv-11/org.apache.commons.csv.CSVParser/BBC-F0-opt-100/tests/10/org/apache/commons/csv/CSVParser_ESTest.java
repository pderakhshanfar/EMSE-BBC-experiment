...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"gKf]N@p$fG(eM~F", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("I-6hFX{", "out");
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("vFq~%lRmojuX?p", "e< ~.vxGFWW");
      try { 
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("<j?N-r@o6n+T", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      File file0 = MockFile.createTempFile(">q.pR0e.zU8utv,]~", ">q.pR0e.zU8utv,]~");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test21()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("}0Ar9+8,V", cSVFormat1);
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("clI/q", cSVFormat0);
      cSVParser0.close();
  ...
  public void test26()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("?)FMiE");
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      StringReader stringReader0 = new StringReader("9%b^pVW]*Pb");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(",:h's*.qz", cSVFormat1);
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("DUF", cSVFormat1);
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(",:h's*.qz", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
