...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "Record separator can only by CR, LF or CRLF");
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("IScB.6G6Fg<4x7HYQB%");
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Tp?Aqi`|", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("IScB.6G6Fg<427HYQ>%");
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("{P2!z1 (tT<YlZV/k", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("H79coQHNXBx#", "-Y]Z=Y!");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("A`Q<Dx&2V\"]o^&'Vy.", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("IScB.p6G6Fg<4x7HYQB%", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("o.apache.commons.csv.CSVPrin3er", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("dy8+{", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test26()  throws Throwable  {
      File file0 = MockFile.createTempFile("pO>Z", "pO>Z");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      String[] stringArray0 = new String[1];
      stringArray0[0] = "pO>Z";
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[0] = "${/,(PD3?y'";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("mcqAW^<d2K$hI?!c5N");
      CSVFormat cSVFormat3 = cSVFormat2.withSkipHeaderRecord(true);
      // Undeclared exception!
      try { 
        CSVParser.parse("${/,(PD3?y'", cSVFormat3);
        fail("Expecting exception: NullPointerException");
