...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("#2ri'Tamq@bA", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[1] = "@A";
      stringArray0[2] = "<fm&~t`0&vP";
      stringArray0[3] = "the quotechar character and the delimiter cannot be the same ('";
      stringArray0[4] = "`xgHmvF`Jm3Sa5";
      stringArray0[5] = "EOF whilst processing escape sequence";
      stringArray0[6] = "U_r0*zNw7v`!h~'+";
      stringArray0[7] = "^%m'i2,yr48yl#";
      stringArray0[8] = "(+}DS`rDdt";
  ...
  public void test04()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "S)^0.8?TTKVph`/u'");
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Fce`K", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("YH@l~SbOQ!j", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("NMfV>ev`aR^r8EH\"", "NMfV>ev`aR^r8EH\"");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"NrlLz_-bm>I_f3x?P", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile(")jDd\"", "EORECORD");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("The quoteChar character and the delimiter cannot be the same ('", "hrf+");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("9zXX.&h<P<0^", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[0] = "7F\"Ea82lRY}7PZtU;KJ";
      stringArray0[1] = "*1yT1{e.C5I$GelPs&";
      stringArray0[2] = "6bH#M[EE'8a~0 Y(g";
      stringArray0[3] = "Dy{XG'P ";
      stringArray0[4] = "D>DnxZ2";
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("SOv#rfl-p%r~", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("&-hm", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("#2ri'Tamq@bA");
      CSVParser cSVParser0 = CSVParser.parse("YH@l~SbOQ!j", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("{;phl");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("{;phl");
      // Undeclared exception!
      try { 
