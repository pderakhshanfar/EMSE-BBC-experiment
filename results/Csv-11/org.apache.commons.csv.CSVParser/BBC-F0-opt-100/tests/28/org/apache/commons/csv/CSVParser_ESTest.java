...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StringReader stringReader0 = new StringReader("eug[OwC {w!`P\u0000-s");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      String[] stringArray0 = new String[2];
      stringArray0[0] = "h}vJmvwsjImu+";
      stringArray0[1] = "eug[OwC {w!`P\u0000-s";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[eug[OwC {w!`P\u0000-s]", cSVRecord0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("f*ile", cSVFormat0);
      cSVParser0.close();
  ...
  public void test11()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("The escape character and the delimiter cannot be the same ('", "(line ");
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("#*{V~50Luw`^,(eQA9G");
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("h}vJmvwsjImu+");
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(",|iAufG!BU5p", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[, |iAufG!BU5p]", cSVRecord0.toString());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      stringArray0[0] = "vWy#/K=";
      stringArray0[1] = "-5og";
      stringArray0[2] = "CommentStart=<";
      stringArray0[3] = "xJG2(mMA^C6";
      stringArray0[4] = "$V~6iTeVJ<cj";
      stringArray0[5] = "$wpe";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      // Undeclared exception!
      try { 
        CSVParser.parse("q8", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("format", "24yk0-vWi`7=)Y#V");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("h}vJmvwsjImu+");
      CSVParser cSVParser0 = CSVParser.parse("$IpHVb!:=owc", cSVFormat2);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("$IpHVb!:=owc", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
