...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "GF\"#5){d?+";
      stringArray0[1] = "Unexpected Token type: ";
      stringArray0[2] = "SPxn|PY4uDa";
      stringArray0[3] = "M>!t:v~AF`+6f";
      stringArray0[4] = "7{SDnNqP7MtI/";
      stringArray0[5] = "ms,";
  ...
  public void test03()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("W%mC-t");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[W%mC-t]", cSVRecord0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = MockFile.createTempFile("Q;pp", "Q;pp");
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("+*nPy&~e)cdn5X@");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"=g<GaI~e", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test11()  throws Throwable  {
      File file0 = MockFile.createTempFile("Q;pfp", "Q;pfp");
  ...
  public void test26()  throws Throwable  {
      ...
      stringArray0[0] = "S?";
      stringArray0[1] = "7r0H$XVdTIh";
      stringArray0[2] = "The comment start character cannot be a line break";
      stringArray0[3] = "Y4B3NznmhRUT";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("7r0H$XVdTIh", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[7r0H$XVdTIh]", cSVRecord0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("e~2C-C2,,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [e~2C-C2, , ]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("h`2#)L]67>DsP");
      CSVParser cSVParser0 = CSVParser.parse("h`2#)L]67>DsP", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
      assertEquals(1, list0.size());
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("h`2#)L]67>DsP");
      CSVParser cSVParser0 = CSVParser.parse("u$'KQn,HszZ(LY", cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("u$'KQn,HszZ(LY", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  ...
  public void test36()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Q;pp", "Q;pp", 158, "org.apache.commons.csv.CSVParser$1", uRLStreamHandler0);
      // Undeclared exception!
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
        fail("Expecting exception: NullPointerException");
