...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[2] = "9X9FmlNW}4wr=ps>'l?";
      stringArray0[3] = ">z1&>z9";
      stringArray0[4] = "l0!9.NYyu<Yf";
      stringArray0[5] = "org.apache.commons.csv.Assertions";
      stringArray0[6] = "Record separator can only by CR, LF or CRLF";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("c1ZxBN~", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[c1ZxBN~]", cSVRecord0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("Lk6(", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("|;=}%wQC", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test13()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("kP+eZqx", "s(K+HlT|.", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("kP+eZqx", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("M6H*]", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      CSVParser cSVParser0 = CSVParser.parse("oe(!QB,]1a >+(", cSVFormat0);
  ...
  public void test25()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("8>G.%Mv+!");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("c1ZxBN~", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Ror@aAt", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("ooa7&", cSVFormat3);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("f2(8&3qn 2Nzo/", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("f2(8&3qn 2Nzo/", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
