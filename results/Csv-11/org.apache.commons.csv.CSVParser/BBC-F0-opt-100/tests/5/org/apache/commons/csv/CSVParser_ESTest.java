...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("file", "y7lLv}/");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "[ [%1:;A";
      stringArray0[1] = "fh";
      stringArray0[2] = "@sd?4(V7T";
      stringArray0[3] = "org.apache.commons.csv.CSVParser$1";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("@sd?4(V7T", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[@sd?4(V7T]", cSVRecord0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("U0PU\"qRQ|7", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("k8^*0l9rzLPq Q)", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("Xj)z", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("mM_R&?7B", "mM_R&?7B", (File) null);
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("L:O?N", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test17()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("KX,QD%");
  ...
  public void test24()  throws Throwable  {
      ...
      stringArray0[0] = "/lV!.3)cgfs}Z#";
      stringArray0[1] = "org.apache.commons.csv.ExtendedBufferedReader";
      stringArray0[2] = "]";
      stringArray0[3] = "8a4";
      stringArray0[4] = "Vsbw/1zR=Q";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("Vsbw/1zR=Q", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("fLNOm");
      CSVParser cSVParser0 = CSVParser.parse("fLNOm", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("L\"P|6dvKd.1}fVVw/K6");
      CSVParser cSVParser0 = CSVParser.parse("k8^*0l9rzLPq Q)", cSVFormat1);
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile((File) null, "yv6VVh");
      Charset charset0 = Charset.defaultCharset();
      try { 
