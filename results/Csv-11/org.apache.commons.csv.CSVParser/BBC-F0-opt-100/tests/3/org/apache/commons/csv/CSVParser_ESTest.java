...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("q!b,CL=()sSm\"", "delimiter=<\t> escape=<> quotechar=<i> nullstring=<q-wqz]b9}b(et> recordseparator=<");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "\u2028";
      stringArray0[1] = "TeEjR9WrFX<kwVMM";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("> skipheaderrecord:false", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<\t> Escape=<> QuoteChar=<i> NullString=<q-wQz]b9}B(eT> RecordSeparator=<\n> SkipHeaderRecord:false", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("YI;LpFhYnUhzS", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"?x-K9Qf", cSVFormat1);
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("`ioG+s*M+c:~I =");
      File file0 = MockFile.createTempFile("The header contains a duplicate name: \"", "QTBB.pY)<rh|m!W8=&g", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("B$}`d u");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("java.lang.Object@0000000002", cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
        cSVParser0.getRecords(linkedList0);
  ...
  public void test20()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("mvB`~;^a", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(";Nfw3$XR4rP", cSVFormat0);
      cSVParser0.close();
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("i;p-WI@}aOdrap", cSVFormat3);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("q-w'Qz]b9}B(eT");
      CSVParser cSVParser0 = CSVParser.parse("q-w'Qz]b9}B(eT", cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("q-w'Qz]b9}B(eT", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
