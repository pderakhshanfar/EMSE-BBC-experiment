...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "0@sx_O$R_ r{";
      stringArray0[1] = "HF_T;o{y";
      stringArray0[2] = "9+LAIkev[";
      stringArray0[3] = "[u!s`J_b]xXOzj";
      stringArray0[4] = "Unexpected Token type: ";
      stringArray0[5] = "{";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("PaPg2XvOw96t2oXa", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("Eo KNT,B,:5BSw=", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("*U=oMIo]',D71", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("E1@Fa)RLA(#:<R", "iCVG[IQ3$)04S");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("SVarser has been closed", "");
      MockFile mockFile0 = new MockFile(file0, "frZQADC.2 ");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("F!@\"`P[';y>!O");
      String[] stringArray0 = new String[0];
      stringReader0.close();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = null;
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("<G^/#s-nkg@;0", cSVFormat2);
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("PaPg2XvOw96t2oXa", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Eo KNT,B,:5BSw=");
      // Undeclared exception!
      try { 
        CSVParser.parse("Eo KNT,B,:5BSw=", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("C(riD");
      CSVParser cSVParser0 = CSVParser.parse("W+ 7gUiK`7vuKW}v", cSVFormat2);
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("PaPg2XvOw96t2oXa", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
