...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(".oFwkq$F", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("charset", "\"x$Cs~Gc;_k%PCFx", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(3025);
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("UAHk0L?pK=F0$)0Kn,,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [UAHk0L?pK=F0$)0Kn, , ]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("formW", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("formW");
      CSVParser cSVParser0 = CSVParser.parse("org.apache.commons.csv.ExtendedBufferedReader", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("formW");
      CSVParser cSVParser0 = CSVParser.parse("formW", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("RPYEGs^Q*", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
