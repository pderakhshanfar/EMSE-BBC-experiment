...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("TOKEN", "TOKEN", (File) null);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "2\"4XQtajj%wt& ";
      stringArray0[1] = ") invalid parse sequence";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("{Bvr2@T3D@-@fMC7Tg1", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("Hf,Z ");
      File file0 = MockFile.createTempFile("Hf,Z ", "Hf,Z ", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("@m;rt/b@", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[Q, Eh]", cSVRecord0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      stringArray0[1] = ":`=eu3B";
      stringArray0[2] = "`kTxtf}sJ1";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      // Undeclared exception!
      try { 
        CSVParser.parse("CRg0FcGZLn3Y) '&(", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(',');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("C");
      CSVParser cSVParser0 = CSVParser.parse("dam9TR", cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
