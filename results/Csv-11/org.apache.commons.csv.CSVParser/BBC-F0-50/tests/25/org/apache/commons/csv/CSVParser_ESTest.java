...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(2923);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(";[r?a7m!}11", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(";[r?a7m!}11", cSVFormat1);
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\".'13=X}'V@f;`S", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("ALL", "QuoteChar=<");
      File file0 = MockFile.createTempFile("ALL", "QuoteChar=<", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("(`<xz?n\"po&cf8");
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("+[0E+GmlGz");
      try { 
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('/');
      CSVParser cSVParser0 = CSVParser.parse("B=7_/YlG5Ux'B#Xal-~", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[B=7_, YlG5Ux'B#Xal-~]", cSVRecord0.toString());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(";[r?a7m!}11", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
