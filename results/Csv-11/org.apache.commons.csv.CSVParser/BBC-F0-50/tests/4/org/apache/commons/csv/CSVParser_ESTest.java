...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("EOF whilst processing escape sequence", "No more CSV records available", (File) mockFile0);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("^;wS &iR6pjiWeZ", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test18()  throws Throwable  {
      ...
      stringArray0[1] = "cffM+2ENX[&'`{d";
      stringArray0[0] = "b`qWW(~T(]\u0002|M6_VP";
      stringArray0[3] = "Vp/&1G";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("RdA&;K2/98G", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("'92~i6{sY'](6m{", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[4];
      stringArray0[0] = "Vp/&1G";
      stringArray0[1] = "cffM+2ENX[&'`{d";
      stringArray0[2] = "b`qWW(~T(]\u0002|M6_VP";
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("^;wS &iR6pjiWeZ", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("M\"c,:KmSj:", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("d,_t_b", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
