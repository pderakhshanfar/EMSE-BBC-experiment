...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = MockFile.createTempFile("INVALID", "7uCG-");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("!@@@q_T", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "'*HZp?$F^BE~N~??";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(false);
      CSVParser cSVParser0 = CSVParser.parse("KaJQ6|!|X2,.gZ}tVh", cSVFormat2);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("KaJQ6|!|X2,.gZ}tVh", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("RecordSeparator=<", "oWR&");
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("'*HZp?$F^BE~N~??", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("}CDAZ8=LRAuE=", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("mZE4-v5k", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("gwnE#&(\u0001G", cSVFormat0);
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("' must not be null!", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("gwnE#&(\u0001G", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("`3f!pu_");
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("KaJQ6|!|X2,.guZ}tVh", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile("'*HZp?$F^BE~N~??");
      Charset charset0 = Charset.defaultCharset();
      try { 
