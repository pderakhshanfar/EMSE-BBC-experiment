...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("!5am,es* A:x%-&", "!5am,es* A:x%-&");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("9'7h[$9*7<5(J[", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "yU,?0)O?|s";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("yU,?0)O?|s", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("yU,?0)O?|s", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(")$j}k,/{->K", cSVFormat0);
      cSVParser0.close();
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("8fcc+3+\"PFV-A%", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("8fcc+3+FV-A%", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("4`a?|GULd.=ITKn", "4`a?|GULd.=ITKn", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("L>uq!1s[%Vl9");
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(";e>I04&O7|a*.\"", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("[~9SpS;s*1lG*[]8@", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("org.apache.commons.csv.CSVFormat@0000000003,org.apache.commons.csv.CSVFormat@0000000001,org.apache.commons.csv.CSVFormat@0000000003,java.lang.String@0000000004", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"org.apache.commons.csv.CSVFormat@0000000003\" in [org.apache.commons.csv.CSVFormat@0000000003, org.apache.commons.csv.CSVFormat@0000000001, org.apache.commons.csv.CSVFormat@0000000003, java.lang.String@0000000004]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("<Kyq\"3BsmL,", cSVFormat2);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("8fcc+3+FV-A%", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
