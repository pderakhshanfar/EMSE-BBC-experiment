...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("The quoteChar cannot be a line break", "org.apache.commons.csv.Quote", (File) mockFile0);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("a!uko", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("y W\tY6CT/r{!,R", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("yMP?|tVAL4?o_!Uib", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile(" )?N)^8up", " )?N)^8up");
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      stringArray0[0] = "(line ";
      stringArray0[1] = "xHN\"u0FC5";
      stringArray0[2] = "pi*.LD$";
      stringArray0[3] = "ka_;]~";
      stringArray0[4] = "N2";
      stringArray0[6] = "url";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("g7<@mhcc4oh!:", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("au&x[(>UQ2 \"", cSVFormat2);
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("org.apache.commons.csv.CSVPrinter", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("2eb!$f");
      CSVParser cSVParser0 = CSVParser.parse("E=rz]!n`&Qx?+lpv", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("yMP?|tVAL4?o_!Uib", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("au&x[(>UQ2 \"", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
