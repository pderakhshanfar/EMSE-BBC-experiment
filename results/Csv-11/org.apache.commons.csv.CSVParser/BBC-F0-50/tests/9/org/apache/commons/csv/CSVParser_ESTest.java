...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "T@%G+!T`nxc8C";
      stringArray0[1] = "F&[qHq5I-i j";
      stringArray0[2] = "'3!w6xj7@fg^~c";
      stringArray0[3] = "A&y@5n|.";
      stringArray0[4] = "P\"#%1}1_MM";
      stringArray0[5] = "x,GAJ]H##pr'bqLsJ";
      stringArray0[6] = "XrT`Om_?b2\"N";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("'3!w6xj7@fg^~c", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("g,8Y%upCf@ {", cSVFormat1);
  ...
  public void test11()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("format", "$'", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("r{/", "\" in ", (File) null);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("D~tlA", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("v:=RJuR2", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      File file0 = MockFile.createTempFile("wXMnn5g);[6*4?", "wXMnn5g);[6*4?");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test20()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{nb1a\"e#aub]+7{yi");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(" Gf>A{X8<\"", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ABc/?Yx%L1L?");
      CSVParser cSVParser0 = CSVParser.parse("qaiYbITAX/l\"|", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("g,8Y%upCf@ {", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
