...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "U]nOv .7;DVWIkICZ";
      stringArray0[1] = "L=g5Qz\rd";
      stringArray0[2] = "5HB=DfQrnjArRo=&v";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("L=g5Qz\rd", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("U\"vx.sv`9J&AX\"", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Q3f>AFmM,noj(\"?s2", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("U]nOv .7;DVWIkICZ", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("5HB=DfQrnjArRo=&v", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("8m5l]", "frqW+H~Xz_#l]");
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("^t0eE+,TatA&&;Om");
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('W');
      CSVParser cSVParser0 = CSVParser.parse(">{{owepwj@ffr2*", cSVFormat0);
      cSVParser0.close();
  ...
  public void test20()  throws Throwable  {
      ...
      stringArray0[0] = "5HB=DfQrnjArRo=&v";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test26()  throws Throwable  {
      ...
      stringArray0[0] = "ALL";
      stringArray0[1] = "Gwq]{:V(";
      stringArray0[2] = "'qAY001gS^lO`\"";
      stringArray0[3] = "q<3UHl7";
      stringArray0[4] = "x5m)I#7hgVw>`~2j";
      stringArray0[5] = "|hW";
      stringArray0[6] = "ddfbn=(r&i3iq\"{:u5i";
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("U]nOv .7;DVWIkICZ", cSVFormat1);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('W');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(">{{owepwj@ffr2*");
      CSVParser cSVParser0 = CSVParser.parse(">{{owepwj@ffr2*", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("cd^g_{");
      CSVParser cSVParser0 = CSVParser.parse("5HB=DfQrnjArRo=&v", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
