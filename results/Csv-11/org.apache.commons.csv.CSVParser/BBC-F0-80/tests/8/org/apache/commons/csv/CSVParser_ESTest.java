...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "Y1Ju");
  ...
  public void test02()  throws Throwable  {
      ...
      Charset charset0 = Charset.defaultCharset();
      File file0 = MockFile.createTempFile("wEQpo3?r`s0H|!%S51`", "wEQpo3?r`s0H|!%S51`");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = ",wE";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(",wE", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[, wE]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("Y1Ju", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("5hCLjh'sb,#o=_Z", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"HsNABqCEzX5{:/4", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("z~OO~OnHl+Q1hn", "z~OO~OnHl+Q1hn");
      File file0 = MockFile.createTempFile("z~OO~OnHl+Q1hn", "z~OO~OnHl+Q1hn", (File) mockFile0);
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Y1Ju", "Y1Ju");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("k@iPg#", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("9T`g!-k1}x:");
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(",wE");
      CSVParser cSVParser0 = CSVParser.parse(",wE", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
