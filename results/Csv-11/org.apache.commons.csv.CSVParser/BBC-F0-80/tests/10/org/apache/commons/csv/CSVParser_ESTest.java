...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("]kd'ne", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("F411[OKeda63n#gF8!w", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      stringArray0[0] = "uF";
      stringArray0[1] = " O(^nTU4%q*UM|)SNU";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(" O(^nTU4%q*UM|)SNU", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("H6/7*3or`p!(5]&a!>", "Acc9/7k/~.d");
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("G?I-6X@J", "");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("{lHx mefp", "");
      MockFile mockFile0 = new MockFile(file0, "{lHx mefp");
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("uF", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[2];
      stringArray0[0] = "uF";
      stringArray0[1] = "Q<GRxPl0 P)i";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("uF", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("]KD'inE", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("]KD'inE", cSVFormat0);
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("217Pt~aR=z=yytUd", "217Pt~aR=z=yytUd", (File) null);
      Charset charset0 = Charset.defaultCharset();
