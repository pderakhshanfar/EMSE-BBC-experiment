...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "heiip@osc*gl}p";
      stringArray0[1] = "The delimiter cannot be a line break";
      stringArray0[2] = "reader";
      stringArray0[3] = " [";
      stringArray0[4] = "~c83du7pl@hm";
      stringArray0[5] = "+-Z.'d)P.F";
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("s{(OzDW4S\"TO/Q~", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("+xB&3/D~m'duP", cSVFormat0);
  ...
  public void test09()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("x/'i0NEf(_=nxx");
      File file0 = MockFile.createTempFile("p]9v@eb8_sah~", "x/'i0NEf(_=nxx");
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("I.Cb-P,pNwe6D");
      File file0 = MockFile.createTempFile("I.Cb-P,pNwe6D", "I.Cb-P,pNwe6D", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("p]9v@eb8_sah~", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("I.Cb-P,pNwe6D", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      Charset charset0 = Charset.defaultCharset();
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/p]9v@eb8_sah~0x/'i0NEf(_=nxx");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "6Jx'-GhO");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("p]9v@eb8_sah~", "x/'i0NEf(_=nxx");
  ...
  public void test28()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("X&Ii");
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("p]9v@eb8_sah~", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("x/'i0NEf(_=nxx");
      CSVParser cSVParser0 = CSVParser.parse("x/'i0NEf(_=nxx", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("x/'i0NEf(_=nxx");
      CSVParser cSVParser0 = CSVParser.parse("p]9v@eb8_sah~", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
