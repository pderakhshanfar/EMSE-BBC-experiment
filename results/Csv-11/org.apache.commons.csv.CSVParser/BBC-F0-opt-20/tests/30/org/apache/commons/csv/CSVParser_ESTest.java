...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[1] = "m.fMvU~*gLM=zy_:0c";
      stringArray0[2] = ":&ZAnX";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(":&ZAnX", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse(":&ZAnX", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("reader", ") invalid char between encapsulated token and delimiter", 2642, ") invalid char between encapsulated token and delimiter", uRLStreamHandler0);
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("AxJn.^2&Wk.|Ed0u12", cSVFormat2);
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("!4j}S{S*w]>", "!4j}S{S*w]>");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[3];
      stringArray0[0] = ")mOC'7}jnWYdf>wj";
      stringArray0[2] = "S>y#=G&9";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("x1)Kwo=)f%p+;y,hf", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(";n}B}Ki( ^dVz> w6,,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [;n}B}Ki( ^dVz> w6, , ]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[3];
      stringArray0[0] = "WM<NfKwD_z`+i#BJA2)";
      stringArray0[1] = "format";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("p93I(H7", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("4ejFN", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('D');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("5q!#*?NI8S");
      StringReader stringReader0 = new StringReader("5q!#*?NI8S");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      cSVParser0.nextRecord();
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('D');
      File file0 = MockFile.createTempFile("5q!#*?NI8S", " }&Fp?");
      Charset charset0 = Charset.defaultCharset();
