...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, ";CKNj-b1S7j};,Gz");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = " W&!`l('8@b";
      stringArray0[1] = "X&cx#VSr/jyRLP'G,NG";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("M)d:QC|Q", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test04()  throws Throwable  {
      File file0 = MockFile.createTempFile("vm7*1ysI+G", "vm7*1ysI+G");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("Ty6g4cf_", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("M)d:QC|Q", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("7B'", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("X&cx#VSr/jyRLP'G,NG", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test25()  throws Throwable  {
      ...
      stringArray0[0] = "VC3U.X/<iAbgldrLlWT";
      stringArray0[1] = "reader";
      stringArray0[2] = "format";
      stringArray0[3] = "\u0085";
      stringArray0[4] = "HwDdfa#;[%P*";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("format");
      File file0 = MockFile.createTempFile("HwDdfa#;[%P*", "BYe+Rjj", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("+B-6j", cSVFormat1);
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("_#nH");
      // Undeclared exception!
      try { 
        CSVParser.parse("_#nH", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("_#nH");
      CSVParser cSVParser0 = CSVParser.parse("_#nH", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
      assertEquals(1, linkedList0.size());
      assertEquals(1L, cSVParser0.getRecordNumber());
