...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      File file0 = MockFile.createTempFile("%161r`Av{T1tQ3+~Qny", (String) null);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[1] = "rgsK!{Pk9h'zb5";
      stringArray0[2] = "q#Gb=";
      stringArray0[3] = "x";
      stringArray0[4] = "";
      stringArray0[5] = "l|(i(!-^wN %Qg&_8";
      stringArray0[6] = "c%x'nb<!l;[x33m4";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("z&qLH", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[z&qLH]", cSVRecord0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("HDCu?");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test14()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile((String) null, "%161r`Av{T1tQ3+~Qny");
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("c)zt_>", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test19()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("+Eq}QZ\"");
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("V,`}T^0_<%B$<S");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test26()  throws Throwable  {
      ...
      stringArray0[0] = "`}t^0_<%b$<s";
      stringArray0[1] = "i4S]c.Z5J^?$`IN";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("2|", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("C046#R:_[", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader("TRdj[<VRb}CN+ykb)");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("V,`}T^0_<%B$<S");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
      assertEquals(1, linkedList0.size());
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("The header contains a duplicate name: \"", ") invalid parse sequence");
      // Undeclared exception!
      try { 
