...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "vjd9.Y@GU";
      stringArray0[1] = "8~5BW\"YwsSUG(>";
      stringArray0[2] = "l;";
      stringArray0[3] = "<7(";
      stringArray0[4] = "a.gqHE*eQ?!l1/;CzA";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(":ApG^C", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[:ApG^C]", cSVRecord0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(" 0xq#(", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("cZ;erP!}Xvo+eA[l", ".Cj(m/MFhW");
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("p[MqjJt.BY]K,", "p[MqjJt.BY]K,");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(" SkipHeaderRecord:", "EOF");
      MockFile mockFile0 = new MockFile(file0, "e#@[ci2p%$9");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      stringArray0[0] = "gwyvh9t|:'j_";
      stringArray0[1] = "wJ-OsR4";
      stringArray0[2] = "GX?~iCtYYa%)_E=UB";
      stringArray0[3] = "ITP1,S}{PZ6v=C?";
      stringArray0[4] = "@D~hMj=<x[tL9xN4z";
      stringArray0[5] = "k(p]cbfLhkMbP.N";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("?5D`b4&.", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("3cw,F{06TJog", cSVFormat1);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("2u!l:g");
      CSVParser cSVParser0 = CSVParser.parse("2u!l:g", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("2u!l:g");
      CSVParser cSVParser0 = CSVParser.parse("iGsR1b", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
