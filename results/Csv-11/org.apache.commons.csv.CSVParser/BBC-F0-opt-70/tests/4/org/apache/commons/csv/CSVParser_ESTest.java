...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(";N<R7L$p?NX&<", (String) null, (File) mockFile0);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "s\"<Ep";
      stringArray0[1] = "=jxd=5k1l";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("=jxd=5k1l", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(":B.K", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("sg70TGqdC&=Xhx,VI", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("org.apache.commons.csv.Quote", "j z_pTw#qPpg`WHO");
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("=X,m", "8cICz@@PHTj@f%Y");
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("TZ}B.K");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("eem^l$\"*", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('*');
      CSVParser cSVParser0 = CSVParser.parse(";N<R7L$p?NX&<", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("bB2\"", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse(".s.K", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("hg}u~Lhdc7");
      CSVParser cSVParser0 = CSVParser.parse("hg}u~Lhdc7", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("filGe");
      CSVParser cSVParser0 = CSVParser.parse("=jxd=5k1l", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("20niW`_B9T", cSVFormat0);
      cSVParser0.getRecords();
      long long0 = cSVParser0.getRecordNumber();
