...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(880);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "Xah\"SuY8~'(IQQ";
      stringArray0[1] = "'-";
      stringArray0[2] = "~z";
      stringArray0[3] = "The escape character cannot be a line break";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("Xah\"SuY8~'(IQQ");
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("rvk3");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("u6{0sfYCDKfU", "kV\u0000M");
      File file0 = MockFile.createTempFile("u6{0sfYCDKfU", "u6{0sfYCDKfU", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(1923);
      CSVParser cSVParser0 = cSVFormat0.parse(pipedReader0);
  ...
  public void test20()  throws Throwable  {
      StringReader stringReader0 = new StringReader("4KL7EIvT|RKl");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("}B(ecI;Lc?qX{#l`6O", cSVFormat1);
      cSVParser0.getRecords();
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("Dy:OjM'^JXU", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(">pLaAI", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("GYPh.}K{=L*S$1N=t");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("<@CE`_");
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("<@CE`_");
      CSVParser cSVParser0 = CSVParser.parse("<@CE`_", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("}B(ecI;Lc?qX{#l`6O", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
