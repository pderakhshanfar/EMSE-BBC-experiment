...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[0] = "pI,Pv";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("pI,Pv", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(".qhL", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("%j<J==uh\"b", cSVFormat0);
      cSVParser0.close();
  ...
  public void test05()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(".qhL", cSVFormat1);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("OZ=LJ:oPN&.q", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("oz=lj:opn&.q", cSVFormat2);
        fail("Expecting exception: IOException");
  ...
  public void test11()  throws Throwable  {
      File file0 = MockFile.createTempFile("@q_a '%*#jk08l", "@q_a '%*#jk08l");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("Oy~GQhK)$nr _Xo");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      PipedReader pipedReader0 = new PipedReader(2259);
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test23()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("OZ=LJ:oPN&.q", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("4x_WqR7.qDs|", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("%j<J==uh\"b");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("OZ=LJ:oPN&.q");
      CSVParser cSVParser0 = CSVParser.parse("OZ=LJ:oPN&.q", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("SEq15xp,10Pq", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[SEq15xp, 10Pq]", cSVRecord0.toString());
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("_scIJ-CpUFV?4;t6fpa", "_scIJ-CpUFV?4;t6fpa");
      Charset charset0 = Charset.defaultCharset();
