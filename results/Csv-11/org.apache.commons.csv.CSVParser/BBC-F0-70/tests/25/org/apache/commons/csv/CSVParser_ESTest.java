...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{y&=hgvd7%");
      stringReader0.close();
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "ukM";
      stringArray0[1] = "YV(1><N%\"3E8(I";
      stringArray0[2] = "";
      stringArray0[3] = "vqz$pO_HVlw^!";
      stringArray0[4] = "CommentStart=<";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("ukM", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[ukM]", cSVRecord0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("hIM<:V2g?M~/t<6U", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      stringArray0[0] = "A'^/Cku0-vIny`n+2^`";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test13()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("Index for header '%s' is %d but CSVRecord only has %d values!", "string");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("'.GJVBMF@NX");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("BiiY]T5`1", "BiiY]T5`1");
      MockFile mockFile0 = new MockFile(file0, "BiiY]T5`1");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("\"OCB\"^", cSVFormat0);
      try { 
  ...
  public void test23()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/url0.tmp");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("sui:DGA5", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse(",X3d.GhN9\"Uh7{T-S=B", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('`');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("kEUJ?312Khi]l");
      CSVParser cSVParser0 = CSVParser.parse("kEUJ?312Khi]l", cSVFormat1);
