...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[0] = "1P";
      stringArray0[1] = "ofb_:O\"2)e67(A&DV+";
      stringArray0[2] = "}&6~}$";
      stringArray0[3] = "dR";
      stringArray0[4] = "+:Brq]=KM~";
      stringArray0[5] = " [";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("!2}Y?uy8'<IpBL*", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("S(:C~|Y", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      stringArray0[0] = "ua";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("ua", cSVFormat1);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"2Cj|~sp,yP NM0P", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test17()  throws Throwable  {
      ...
      stringArray0[0] = "Jj_(Q7s\"z!gOnt";
      stringArray0[1] = "8r(=43";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test22()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("IQWL<piN ]_lcL_K6", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("s;d^", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("!2}Y?uy8'<IpBL*", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      File file0 = MockFile.createTempFile("}[DW+Zb;H^RoN?4J#dm", "}[DW+Zb;H^RoN?4J#dm");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
