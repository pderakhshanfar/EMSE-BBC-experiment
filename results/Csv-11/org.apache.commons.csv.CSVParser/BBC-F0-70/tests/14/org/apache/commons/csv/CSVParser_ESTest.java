...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("The quoteChar character and the delimiter cannot be the same ('", "J~mJaNuuN?7CeR!J");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("^M$AC&VO^J~", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("0lL.-()L2^\u0002pSe%l2", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("^zZZ@o=%+3.-<OJ/<@D", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(")mEjl{=_\"", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("PhiE", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("[2gUurXN&;/", cSVFormat1);
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("^zZZ@o=%+3.-<OJ/<@D", ";uHA.MJ[yyB^");
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("%m*V'K", "%m*V'K");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      stringArray0[3] = "f4D%$@x5xj|_p";
      stringArray0[4] = "";
      stringArray0[5] = "cc]XET:{K8M+e._";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("^M$AC&VO^J~", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("C[2gUurXN&;/");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('0');
      StringReader stringReader0 = new StringReader("[2gurXN&.;/");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ry%GR>7MQ2%0~R>");
      CSVParser cSVParser0 = CSVParser.parse("i;ZX)zC}^", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("[2gUurXN&;/", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('0');
      StringReader stringReader0 = new StringReader("cc]XET:{K8M+e._");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile(")mEjl{=_\"", ")mEjl{=_\"");
      // Undeclared exception!
      try { 
