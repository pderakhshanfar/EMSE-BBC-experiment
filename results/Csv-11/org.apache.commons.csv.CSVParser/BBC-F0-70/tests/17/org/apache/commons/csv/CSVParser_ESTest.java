...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("mljz", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "";
      stringArray0[1] = "2=%HuV\"y";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("2=%HuV\"y", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("%p\"mLJZ");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"#yxg5kp%e&gru", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("9M|s bc([Z_", "No more CSV records available");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("The delimiter cannot be a line break", "=>J{.f=F1");
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("(;.9H K&'X5+ODk", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("EYGY|", cSVFormat0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("2=%HuV\"y", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("%p\"mLJZ", "%p\"mLJZ");
      File file0 = MockFile.createTempFile("%p\"mLJZ", "%p\"mLJZ", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("2=%HuV\"y");
      CSVParser cSVParser0 = CSVParser.parse("2=%HuV\"y", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test32()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("~ZM");
      // Undeclared exception!
      try { 
        CSVParser.parse("rmat", cSVFormat3);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("rmat", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
