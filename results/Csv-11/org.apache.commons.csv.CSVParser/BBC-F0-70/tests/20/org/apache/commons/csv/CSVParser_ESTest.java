...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("V0-z=B> \">&Y>JeS", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      ...
      assertEquals("[org.apache.commo, s.csv.Toke, ]", cSVRecord0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("J?<}Zp'z,H,V4}fVEcg", cSVFormat0);
      cSVParser0.close();
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("`q'J04Fs4^DttL");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("e.\"Zf[82", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(",,kt=Ico4J", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [, , kt=Ico4J]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("W2n_NF`~5F,._<l`P", "W2n_NF`~5F,._<l`P");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(")NutrFU'^Y", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
