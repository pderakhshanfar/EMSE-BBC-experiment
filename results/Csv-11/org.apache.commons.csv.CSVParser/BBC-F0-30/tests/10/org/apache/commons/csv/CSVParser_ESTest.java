...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(2824);
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("z!2N#YA[G5q", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "0<uYcbK/S{w0yS";
      stringArray0[1] = "format";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("mapping for %s not found", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("}(lBZ");
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("fFS9c>#");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("gjNMY#\":,pJ", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("str\ng", cSVFormat1);
  ...
  public void test09()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("W1c~0}b-_-]s e", "format", 180, "[Ex7d]\"L]H7B[9d-Q", uRLStreamHandler0);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("gjNMY#\":,pJ", "[hq");
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("C(rh81dL%dI", "j#5-)LnSZnzwe'?i=;t");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("|.EwLVg'G=Dk+ s", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("$3'qsY+>$wO|");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("SXvKG=fQ\"J;DH=.>nve", "c`");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader("}(lBZ");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(",U0/}wrdPr'~xVA");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<,> QuoteChar=<\"> RecordSeparator=<\r\n> SkipHeaderRecord:false Header:[The header contains a duplicate name: \"]", cSVFormat0);
      cSVParser0.getRecords();
