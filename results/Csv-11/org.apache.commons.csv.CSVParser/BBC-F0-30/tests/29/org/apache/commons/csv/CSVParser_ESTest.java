...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(4233);
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile("N8:D");
      File file0 = MockFile.createTempFile("org.apache.commons.csv.Token", "U", (File) mockFile0);
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("-F=N.@wT6sx]FF<!)(", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("|sw%l", cSVFormat1);
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("lj{o0E5.*d@n", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("EZ&I2j2&1\u0006+Ky", "EZ&I2j2&1\u0006+Ky");
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("[h;XC", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("1sjsOlZ,C)1VpPphS", cSVFormat0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("H2;EM", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("VszS", cSVFormat0);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("VszS");
      CSVParser cSVParser0 = CSVParser.parse("VszS", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test30()  throws Throwable  {
      ...
      stringArray0[0] = "url";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVFormat cSVFormat3 = cSVFormat2.withNullString(",l9S49<-rl8g}(S");
      // Undeclared exception!
      try { 
        CSVParser.parse("=c$L0'ptoxUZxT$", cSVFormat3);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("39L3S}i]v.Tl.e[WkMX");
      Charset charset0 = Charset.defaultCharset();
      try { 
