...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("e$a.(<X<^q5", "e$a.(<X<^q5");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[1] = "c(,EdYMfw+R97";
      stringArray0[2] = "v7U[nqi864oE";
      stringArray0[3] = "org.apache.commons.csv.CSVParser$2";
      stringArray0[4] = "MINIMAL";
      stringArray0[5] = ") invalid parse sequence";
      stringArray0[6] = "pge32?`dq";
      stringArray0[7] = "t3l]*QjX3A<2*Pg&n";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("v7U[nqi864oE", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("q$*~R2~^uI", "$IL*m6gJ+3F");
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"W?t*?@>7l4V&V", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("0$~g+nk w", "Mapping for %s not found, expected one of %s");
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("0$~g+nk w", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("k,XQwPj<BVT!", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("[>~{&Q` W~xF", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("gf8hIV)V{9", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('R');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("0$~g+nk w");
      StringReader stringReader0 = new StringReader("&2jAclw6<");
