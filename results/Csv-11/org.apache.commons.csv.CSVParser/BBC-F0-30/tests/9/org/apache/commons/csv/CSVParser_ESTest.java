...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("cgzB", "9IrTNV!?fd~@z7");
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser", "9IrTNV!?fd~@z7", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "(\"MT9^n*M:5R}i\"8D";
      stringArray0[1] = "U";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("9IrTNV!?fd~@z7", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("srofq>qwwU1", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('o');
      CSVParser cSVParser0 = CSVParser.parse("u\"T7^5l}>K`jeKi", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      stringArray0[0] = "u}w";
      stringArray0[1] = "(\"MT9^n*M:5R}i\"8D";
      stringArray0[2] = "Record separator can only by CR, LF or CRLF";
      stringArray0[3] = ":jK~FD?bv";
      stringArray0[4] = "U";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"n_odKfkwf9k=^YR/.", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$2", "org.apache.commons.csv.CSVParser$2", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("srofq>qwwU1");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("CTsQ<\"d_$Ije", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      MockFile mockFile0 = new MockFile("}-[G`P", "}-[G`P");
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("}-[G`P/}-[G`P/GLrJ;pkoL=J/}-[G`P0}-[G`P");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      MockFile mockFile1 = new MockFile(mockFile0, "GLrJ;pkoL=J");
      File file0 = MockFile.createTempFile("}-[G`P", "}-[G`P", (File) mockFile1);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("u\"T7^5l}>K`jeKi");
  ...
  public void test27()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("}-[G`P", "}-[G`P", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
      cSVParser0.close();
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[5];
      stringArray0[0] = "";
      stringArray0[1] = "Z3q\"--_z>w";
      stringArray0[2] = "_Xe";
      stringArray0[3] = "Z2toVT+M7x;-}/h";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      PipedReader pipedReader0 = new PipedReader(618);
      try { 
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("9IrTNV!?fd~@z7", cSVFormat1);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      MockFile mockFile0 = new MockFile("srfq>qwwU1");
      File file0 = MockFile.createTempFile("}-[G`P", "}-[G`P", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
  ...
  public void test36()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("file", "\"v%TeQtmkF|j>", 5, "rL", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
