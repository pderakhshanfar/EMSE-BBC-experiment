...
public class LookupTranslator_ESTest extends LookupTranslator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      charSequenceArray1[0] = (CharSequence) "FFFFFF26";
      charSequenceArray1[1] = (CharSequence) "FFFFFF26";
      ...
      lookupTranslator0.translate(charSequenceArray1[3], (Writer) stringWriter0);
      assertEquals("FFFFFF26", stringWriter0.toString());
  }
  ...
  public void test3()  throws Throwable  {
      ...
      charSequenceArray1[0] = (CharSequence) "FFFFFF30";
      charSequenceArray1[2] = (CharSequence) "FFFFFF30";
      charSequenceArray0[0] = charSequenceArray1;
      LookupTranslator lookupTranslator0 = new LookupTranslator(charSequenceArray0);
      int int0 = lookupTranslator0.translate(charSequenceArray1[2], 59, (Writer) stringWriter0);
      assertEquals(0, int0);
  }
  ...
  public void test4()  throws Throwable  {
      ...
      CharSequence[] charSequenceArray1 = new CharSequence[5];
      charSequenceArray1[0] = (CharSequence) "FFFFFF30";
      charSequenceArray1[1] = (CharSequence) "FFFFFF30";
      charSequenceArray0[0] = charSequenceArray1;
      LookupTranslator lookupTranslator0 = new LookupTranslator(charSequenceArray0);
      int int0 = lookupTranslator0.translate(charSequenceArray1[1], 0, (Writer) stringWriter0);
      assertEquals("FFFFFF30", stringWriter0.toString());
      assertEquals(8, int0);
  }
  ...
  public void test5()  throws Throwable  {
      ...
      try { 
        lookupTranslator0.translate(charSequenceArray1[2], (-208), (Writer) stringWriter0);
  ...
  public void test7()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        lookupTranslator0.translate((CharSequence) charBuffer0, (-2250), (Writer) stringWriter0);
