...
public class LookupTranslator_ESTest extends LookupTranslator_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      charSequenceArray2[0] = (CharSequence) "FFFFF9C8";
      charSequenceArray0[1] = charSequenceArray2;
      LookupTranslator lookupTranslator0 = new LookupTranslator(charSequenceArray0);
      String string0 = lookupTranslator0.translate(charSequenceArray2[0]);
      assertEquals("FFFFF9C8", string0);
  }

  @Test(timeout = 4000)
  public void test2()  throws Throwable  {
      CharSequence[] charSequenceArray0 = new CharSequence[3];
      charSequenceArray0[0] = (CharSequence) "FFFFF95D";
      ...
      try { 
        lookupTranslator0.translate((CharSequence) "FFFFF95D", (-1699), (Writer) stringWriter0);
  ...
  public void test3()  throws Throwable  {
      ...
      LookupTranslator lookupTranslator0 = new LookupTranslator(charSequenceArray0);
      StringWriter stringWriter0 = new StringWriter(2552);
      // Undeclared exception!
      try { 
        lookupTranslator0.translate((CharSequence) null, (-422), (Writer) stringWriter0);
  ...
  public void test4()  throws Throwable  {
      CharSequence[] charSequenceArray0 = new CharSequence[3];
      charSequenceArray0[0] = (CharSequence) "FFFFF95D";
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "FFFFF95D");
      CharSequence[][] charSequenceArray1 = new CharSequence[2][2];
      charSequenceArray1[0] = charSequenceArray0;
      charSequenceArray1[1] = charSequenceArray0;
      LookupTranslator lookupTranslator0 = new LookupTranslator(charSequenceArray1);
      ...
      // Undeclared exception!
      try { 
        lookupTranslator0.translate((CharSequence) charBuffer0, (-1699), (Writer) stringWriter0);
  ...
  public void test7()  throws Throwable  {
      ...
      charSequenceArray0[0] = (CharSequence) "FFFFFFB7";
      CharSequence[][] charSequenceArray1 = new CharSequence[2][0];
      charSequenceArray1[0] = charSequenceArray0;
      CharSequence[] charSequenceArray2 = new CharSequence[3];
      charSequenceArray2[0] = (CharSequence) "FFFFFFB7";
      charSequenceArray2[1] = (CharSequence) "FFFFFFB7";
      charSequenceArray2[2] = (CharSequence) "FFFFFFB7";
      ...
      assertEquals("FFFFFFB7", stringWriter0.toString());
      assertEquals(8, int0);
  }
