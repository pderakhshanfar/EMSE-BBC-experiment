...
public class LookupTranslator_ESTest extends LookupTranslator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      charSequenceArray1[0] = (CharSequence) "2AE";
      charSequenceArray1[1] = (CharSequence) "2AE";
      charSequenceArray1[2] = (CharSequence) "2AE";
  ...
  public void test2()  throws Throwable  {
      ...
      charSequenceArray0[0] = (CharSequence) "FFFFFFA2";
      ...
      charSequenceArray2[0] = (CharSequence) "87";
  ...
  public void test3()  throws Throwable  {
      ...
      LookupTranslator lookupTranslator0 = new LookupTranslator(charSequenceArray0);
      int int0 = lookupTranslator0.translate(charSequenceArray1[1], 686, (Writer) stringWriter0);
      assertEquals(0, int0);
  }
  ...
  public void test4()  throws Throwable  {
      ...
      charSequenceArray1[0] = (CharSequence) "FFFFF684";
      charSequenceArray0[0] = charSequenceArray1;
      CharSequence[] charSequenceArray2 = new CharSequence[14];
      charSequenceArray2[0] = (CharSequence) "FFFFF684";
      charSequenceArray2[1] = (CharSequence) "FFFFF684";
      charSequenceArray0[1] = charSequenceArray2;
      LookupTranslator lookupTranslator0 = new LookupTranslator(charSequenceArray0);
      StringWriter stringWriter0 = new StringWriter();
      int int0 = lookupTranslator0.translate(charSequenceArray2[0], 0, (Writer) stringWriter0);
      assertEquals("FFFFF684", stringWriter0.toString());
      assertEquals(8, int0);
  }
  ...
  public void test5()  throws Throwable  {
      CharSequence[][] charSequenceArray0 = new CharSequence[2][8];
      CharSequence[] charSequenceArray1 = new CharSequence[2];
      String string0 = CharSequenceTranslator.hex((-2428));
      charSequenceArray1[0] = (CharSequence) "FFFFF684";
      charSequenceArray0[0] = charSequenceArray1;
      charSequenceArray0[1] = charSequenceArray0[0];
      LookupTranslator lookupTranslator0 = new LookupTranslator(charSequenceArray0);
      ...
      try { 
        lookupTranslator0.translate((CharSequence) string0, (-1250), (Writer) stringWriter0);
  ...
  public void test7()  throws Throwable  {
      ...
      charSequenceArray1[0] = (CharSequence) "FFFFF684";
      charSequenceArray0[0] = charSequenceArray1;
      CharBuffer charBuffer0 = CharBuffer.allocate(373);
      ...
      // Undeclared exception!
      try { 
        lookupTranslator0.translate((CharSequence) charBuffer0, (-2428), (Writer) stringWriter0);
