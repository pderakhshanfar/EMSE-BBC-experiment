...
public class LookupTranslator_ESTest extends LookupTranslator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      charSequenceArray1[0] = (CharSequence) "4D3";
      CharBuffer charBuffer0 = CharBuffer.allocate(0);
      CharBuffer charBuffer1 = CharBuffer.wrap((CharSequence) "4D3");
      ...
      charSequenceArray2[1] = (CharSequence) "4D3";
      ...
      assertEquals("4D3", stringWriter0.toString());
      assertEquals(0, int0);
  }
  ...
  public void test3()  throws Throwable  {
      ...
      CharSequence[] charSequenceArray1 = new CharSequence[4];
      charSequenceArray1[0] = (CharSequence) "4D3";
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "4D3");
      charSequenceArray0[0] = charSequenceArray1;
      charSequenceArray0[1] = charSequenceArray0[0];
      charSequenceArray0[2] = charSequenceArray0[0];
  ...
  public void test4()  throws Throwable  {
      ...
      charSequenceArray0[0] = (CharSequence) "4D3";
      CharBuffer charBuffer0 = CharBuffer.allocate(0);
      ...
      try { 
        lookupTranslator0.translate((CharSequence) charBuffer0, (-2611), (Writer) stringWriter0);
  ...
  public void test7()  throws Throwable  {
      CharSequence[][] charSequenceArray0 = new CharSequence[4][3];
      CharSequence[] charSequenceArray1 = new CharSequence[4];
      String string0 = CharSequenceTranslator.hex(1235);
      charSequenceArray1[0] = (CharSequence) "4D3";
      charSequenceArray0[0] = charSequenceArray1;
      charSequenceArray0[1] = charSequenceArray0[0];
      ...
      LookupTranslator lookupTranslator0 = new LookupTranslator(charSequenceArray0);
      StringWriter stringWriter0 = new StringWriter();
      int int0 = lookupTranslator0.translate((CharSequence) string0, 1235, (Writer) stringWriter0);
      assertEquals(0, int0);
  }
  ...
  public void test8()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        lookupTranslator0.translate(charSequenceArray1[0], (-1480), (Writer) stringWriter0);
  ...
  public void test9()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        lookupTranslator0.translate((CharSequence) null, (-2095), (Writer) stringWriter0);
        fail("Expecting exception: NullPointerException");
