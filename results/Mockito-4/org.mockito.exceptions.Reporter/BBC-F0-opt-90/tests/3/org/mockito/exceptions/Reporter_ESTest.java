...
public class Reporter_ESTest extends Reporter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      MockPrintStream mockPrintStream0 = new MockPrintStream("K9uY?n&D&V");
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidArgumentPositionRangeAtInvocationTime((InvocationOnMock) null, true, (-2150));
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("", 4, treeSet0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test09()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLDataException sQLDataException0 = new SQLDataException("    assertEquals(\"John\", argument.getValue().getName());", "}s?}#", (-1119));
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("    assertEquals(\"John\", argument.getValue().getName());", sQLDataException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("odzGQ<lU'IOUD,75", (String) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test13()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy(1, 1175);
      LocationImpl locationImpl0 = new LocationImpl();
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      Matcher<String> matcher0 = StringContains.containsString("1'@1!  %;O1!8\"E-");
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(matcher0);
      vector0.add(localizedMatcher0);
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers((-1324), vector0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.reportNoSubMatchersFound(":d+?&(S,YYp");
        fail("Expecting exception: RuntimeException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfArgumentToReturn((InvocationOnMock) null, "", class0, (-429));
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      ...
      Matcher<SerializableMode> matcher1 = AllOf.allOf((Matcher<? super SerializableMode>) combinableMatcher0, (Matcher<? super SerializableMode>) combinableMatcher0, (Matcher<? super SerializableMode>) combinableMatcher0, (Matcher<? super SerializableMode>) matcher0);
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(matcher1);
      SQLIntegrityConstraintViolationException sQLIntegrityConstraintViolationException0 = new SQLIntegrityConstraintViolationException("$>K6|vIpn0ay", (Throwable) null);
      // Undeclared exception!
      try { 
        reporter0.cannotInjectDependency((Field) null, localizedMatcher0, sQLIntegrityConstraintViolationException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test25()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy((-1724), (-1724));
      // Undeclared exception!
      try { 
  ...
  public void test34()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLException sQLException0 = new SQLException("3eLCpCRSt~5nHU:b");
      // Undeclared exception!
      try { 
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("VAT0b|R(", 0, (Collection<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.moreThanOneAnnotationNotAllowed(" interface.");
        fail("Expecting exception: RuntimeException");
  ...
  public void test64()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocations(2206, 2206, (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test66()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("    verify(mock).someMethod(contains(\"foo\"))", (Exception) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test67()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      Matcher<InvocationMatcher> matcher0 = HasToString.hasToString("{Q}y");
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(matcher0);
      Location location0 = localizedMatcher0.getLocation();
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocationsInOrder((-1085), (-1085), (DescribedInvocation) null, location0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test76()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("eH&2}8ysxw4F^x/bc", (Exception) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test78()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfReturnValue("kO0cs^%UW<+?Qq}", "", "kO0cs^%UW<+?Qq}");
        fail("Expecting exception: RuntimeException");
