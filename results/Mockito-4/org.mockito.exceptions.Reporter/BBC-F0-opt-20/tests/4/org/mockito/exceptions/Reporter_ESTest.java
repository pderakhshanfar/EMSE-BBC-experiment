...
public class Reporter_ESTest extends Reporter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.smartNullPointerException("h*ggM &)^K1Xp", locationImpl0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test07()  throws Throwable  {
      ...
      SQLTransactionRollbackException sQLTransactionRollbackException0 = new SQLTransactionRollbackException("x51,n?v0");
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers(2927, arrayList0);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("hFO=FZmOS-E=", sQLTimeoutException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test12()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLFeatureNotSupportedException sQLFeatureNotSupportedException0 = new SQLFeatureNotSupportedException("    when(mock.isOk()).thenThrow(exception);", (String) null, (-837));
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("    when(mock.isOk()).thenThrow(exception);", sQLFeatureNotSupportedException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("Wanted but not invoked:", "an array with size", locationImpl0);
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("", 3252, hashSet0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.reportNoSubMatchersFound("Make sure you place the parenthesis correctly!");
        fail("Expecting exception: RuntimeException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfArgumentToReturn((InvocationOnMock) null, (String) null, class0, 702);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      Matcher<StubbedInvocationMatcher> matcher0 = HasProperty.hasProperty("Pshjeg*.m{>%Q");
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(matcher0);
      Location location0 = localizedMatcher0.getLocation();
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      ...
      BatchUpdateException batchUpdateException0 = new BatchUpdateException("UT\"0yz0t|_A1RlSI/", intArray0);
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLWarning sQLWarning0 = new SQLWarning("", "", 556);
      BatchUpdateException batchUpdateException0 = new BatchUpdateException((String) null, "wm", (int[]) null, sQLWarning0);
  ...
  public void test35()  throws Throwable  {
      ...
      SQLClientInfoException sQLClientInfoException0 = new SQLClientInfoException("5s{UT +,YbdYH$0", "'KP>", (-718), hashMap0);
      BatchUpdateException batchUpdateException0 = new BatchUpdateException("Kxnb8", "Kxnb8", 1158, (int[]) null, sQLClientInfoException0);
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("DXn=.%]>4`\"29G<o[", "DXn=.%]>4`\"29G<o[", (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.unsupportedCombinationOfAnnotations("w~?tO6k2ho <UAv5pa", "<RJ'?C#");
        fail("Expecting exception: RuntimeException");
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.moreThanOneAnnotationNotAllowed("org.hamcrest.text.StringContainsInOrder");
        fail("Expecting exception: RuntimeException");
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotStubVoidMethodWithAReturnValue("q%{yqmQ.,bShC2");
        fail("Expecting exception: RuntimeException");
  ...
  public void test64()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocations((-2593), (-2593), (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test67()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocationsInOrder(355, 1, (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test77()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("org.hamcrest.CustomTypeSafeMatcher", (Exception) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test79()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfReturnValue("extraInterfaces() does not accept null parameters.", "    verify(mock).doSomething()", "  when(mockOfConcreteClass.nonAbstractMethod()).thenCallRealMethod();");
        fail("Expecting exception: RuntimeException");
