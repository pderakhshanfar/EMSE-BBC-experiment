...
public class Reporter_ESTest extends Reporter_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.smartNullPointerException("i.e. the top-most superclass has to implements Serializable.", locationImpl0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test04()  throws Throwable  {
      ...
      IsEqual<String> isEqual0 = new IsEqual<String>("w");
      HasToString<String> hasToString0 = new HasToString<String>(isEqual0);
  ...
  public void test06()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLFeatureNotSupportedException sQLFeatureNotSupportedException0 = new SQLFeatureNotSupportedException("^3}\"%#B)q'`P'?P5", "^3}\"%#B)q'`P'?P5");
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers((-3104), (List<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidArgumentPositionRangeAtInvocationTime((InvocationOnMock) null, false, 364);
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("\"{O.gyI", 0, stack0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("[/ue%ZC8Pb*v", (Exception) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("D/YSS@;Onoh%q", "D/YSS@;Onoh%q", locationImpl0);
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.reportNoSubMatchersFound("x`}uX>DT5N");
        fail("Expecting exception: RuntimeException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfArgumentToReturn((InvocationOnMock) null, (String) null, class0, 2568);
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      ...
      SQLTransientConnectionException sQLTransientConnectionException0 = new SQLTransientConnectionException("1R(~|;s.*p", (String) null, sQLInvalidAuthorizationSpecException0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy(2145, (-1255));
      StackTraceFilter stackTraceFilter0 = new StackTraceFilter();
      LocationImpl locationImpl0 = new LocationImpl(stackTraceFilter0);
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      SQLWarning sQLWarning0 = new SQLWarning("g)", "g)", 3039);
  ...
  public void test36()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLFeatureNotSupportedException sQLFeatureNotSupportedException0 = new SQLFeatureNotSupportedException("org.hamcrest.core.DescribedAs", "", 2);
      SQLNonTransientConnectionException sQLNonTransientConnectionException0 = new SQLNonTransientConnectionException("You haven't provided the instance at field declaration so I tried to construct the instance.", "You haven't provided the instance at field declaration so I tried to construct the instance.", sQLFeatureNotSupportedException0);
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.smartNullPointerException("threw an exception : ", (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.unsupportedCombinationOfAnnotations("C,tC5*f%!X5 ?", "QC");
        fail("Expecting exception: RuntimeException");
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.moreThanOneAnnotationNotAllowed("d!lP)=K$g}r1p=rpU");
        fail("Expecting exception: RuntimeException");
  ...
  public void test63()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocations((-1993), 1, (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test65()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLIntegrityConstraintViolationException sQLIntegrityConstraintViolationException0 = new SQLIntegrityConstraintViolationException(">hI0, 'Vaq-pW~", ">hI0, 'Vaq-pW~");
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("org.mockito.internal.reporting.Discrepancy", sQLIntegrityConstraintViolationException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test66()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocationsInOrder(1649, 17, (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test74()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy((-1501), (-1501));
      // Undeclared exception!
      try { 
  ...
  public void test77()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfReturnValue("    someMethod(AdditionalMatchers.and(isNotNull(), eq(\"raw String\"));", "    someMethod(AdditionalMatchers.and(isNotNull(), eq(\"raw String\"));", "    someMethod(AdditionalMatchers.and(isNotNull(), eq(\"raw String\"));");
        fail("Expecting exception: RuntimeException");
