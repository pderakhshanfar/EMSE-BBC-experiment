...
public class Reporter_ESTest extends Reporter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.smartNullPointerException("!N{Y6J{C$b", locationImpl0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test06()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      MockPrintStream mockPrintStream0 = new MockPrintStream(".tVJ$%=K4W>");
      VerboseMockInvocationLogger verboseMockInvocationLogger0 = new VerboseMockInvocationLogger(mockPrintStream0);
      SQLSyntaxErrorException sQLSyntaxErrorException0 = new SQLSyntaxErrorException("f+R!", (String) null);
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers(1635, vector0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidArgumentPositionRangeAtInvocationTime((InvocationOnMock) null, false, 31);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("n2\"jYY.I830", 1970, (Collection<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLTransientConnectionException sQLTransientConnectionException0 = new SQLTransientConnectionException("    not: verify(mock.someMethod());", "b7abT=1n%CAwurz!;", 60);
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("    not: verify(mock.someMethod());", sQLTransientConnectionException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test12()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLTransactionRollbackException sQLTransactionRollbackException0 = new SQLTransactionRollbackException("4#tvD=)E'QL\n5|-", "4#tvD=)E'QL\n5|-");
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("a_q,R8", sQLTransactionRollbackException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("    doThrow(new RuntimeException()).when(mock).someVoidMethod(anyObject());", "    doThrow(new RuntimeException()).when(mock).someVoidMethod(anyObject());", locationImpl0);
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("ch\"<!p", (-1189), hashSet0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.reportNoSubMatchersFound(">l=)Fq}WK3$Q");
        fail("Expecting exception: RuntimeException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfArgumentToReturn((InvocationOnMock) null, "-> at <evosuite>.<evosuite>(<evosuite>)", class0, (-394));
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy((-960), (-960));
  ...
  public void test31()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLTimeoutException sQLTimeoutException0 = new SQLTimeoutException("org.mockito.exceptions.verification.VerificationInOrderFailure", "threw an exception : ", 5);
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLException sQLException0 = new SQLException("ch\"<!p", "TZEsrELYP", 2646);
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wantedAtMostX(10, (-2379));
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.moreThanOneAnnotationNotAllowed("org.mockito.internal.invocation.StubInfoImpl");
        fail("Expecting exception: RuntimeException");
  ...
  public void test63()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocations(1082, 1082, (DescribedInvocation) null, (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test65()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("toString", (Exception) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test66()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      Matcher<Object> matcher0 = HasToString.hasToString("has returned: \"");
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(matcher0);
      Location location0 = localizedMatcher0.getLocation();
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocationsInOrder((-767), 3, (DescribedInvocation) null, location0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test75()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy(8, (-1323));
      // Undeclared exception!
      try { 
  ...
  public void test78()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfReturnValue("eWVe#)", "eWVe#)", "oV[Ev");
        fail("Expecting exception: RuntimeException");
