...
public class Reporter_ESTest extends Reporter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      IsIn<Integer> isIn0 = new IsIn<Integer>(hashSet0);
  ...
  public void test05()  throws Throwable  {
      ...
      SQLClientInfoException sQLClientInfoException0 = new SQLClientInfoException("Example of correct verification:", hashMap0, sQLIntegrityConstraintViolationException0);
      SQLRecoverableException sQLRecoverableException0 = new SQLRecoverableException("Example of correct verification:", sQLClientInfoException0);
      SQLDataException sQLDataException0 = new SQLDataException("Example of correct verification:", "Example of correct verification:", sQLRecoverableException0);
      // Undeclared exception!
      try { 
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers(3518, (List<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidArgumentPositionRangeAtInvocationTime((InvocationOnMock) null, true, (-2882));
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("(h@ j=Fig\"Wa", sQLFeatureNotSupportedException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("Argument passed to when() is not a mock!", "Argument passed to when() is not a mock!", (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfArgumentToReturn((InvocationOnMock) null, "MJta", class0, (-1418));
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.reportNoSubMatchersFound("org.mockito.exceptions.verification.VerificationInOrderFailure");
        fail("Expecting exception: RuntimeException");
  ...
  public void test24()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy(3197, 505);
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      Vector<VerificationAwareInvocation> vector0 = new Vector<VerificationAwareInvocation>(897, 897);
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      MockPrintStream mockPrintStream0 = new MockPrintStream("\"3<K6B");
      VerboseMockInvocationLogger verboseMockInvocationLogger0 = new VerboseMockInvocationLogger(mockPrintStream0);
      SQLFeatureNotSupportedException sQLFeatureNotSupportedException0 = new SQLFeatureNotSupportedException("\"3<K6B");
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLException sQLException0 = new SQLException("9D*RDZ@>nPb4n1>X2J", "", (-1103));
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLTransactionRollbackException sQLTransactionRollbackException0 = new SQLTransactionRollbackException("&s;MM=0[s9", "&s;MM=0[s9");
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wantedAtMostX(0, 3442);
  ...
  public void test48()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers(1447, arrayList0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test51()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.unsupportedCombinationOfAnnotations("_E_8v.1%k(wI^3", "qGa[pY");
        fail("Expecting exception: RuntimeException");
  ...
  public void test53()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("X\"b)j", 10, (Collection<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.moreThanOneAnnotationNotAllowed("td2y}#zg6$NN\"~");
        fail("Expecting exception: RuntimeException");
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotStubVoidMethodWithAReturnValue("Wry5]&");
        fail("Expecting exception: RuntimeException");
  ...
  public void test64()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocations((-873), (-873), (DescribedInvocation) null, (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test66()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("VVaTq*<99CP", (Exception) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test77()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("8?jxZ#;z(YZ", (Exception) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test79()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfReturnValue("maj#jS<i", "If you intend to verify invocations on a mock, don't use stubOnly() in its MockSettings.", "If you intend to verify invocations on a mock, don't use stubOnly() in its MockSettings.");
        fail("Expecting exception: RuntimeException");
