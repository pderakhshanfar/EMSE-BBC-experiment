...
public class Reporter_ESTest extends Reporter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.smartNullPointerException("4:_-c,dGSXiQUp", locationImpl0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test06()  throws Throwable  {
      ...
      SQLWarning sQLWarning0 = new SQLWarning("T+|!tTC", "Mx", 1, batchUpdateException0);
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      SQLInvalidAuthorizationSpecException sQLInvalidAuthorizationSpecException0 = new SQLInvalidAuthorizationSpecException("Argument(s) are different! Wanted:", "TR~nO?m.Wgw+</");
      SQLSyntaxErrorException sQLSyntaxErrorException0 = new SQLSyntaxErrorException("    doThrow(new RuntimeException())", "M_[-mo,`rOWdn8H+p", 0, sQLInvalidAuthorizationSpecException0);
      BatchUpdateException batchUpdateException0 = new BatchUpdateException(intArray0, sQLSyntaxErrorException0);
      SQLWarning sQLWarning0 = new SQLWarning((String) null, "org.mockito.internal.invocation.SerializableMethod", batchUpdateException0);
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("1. The wanted argument position is incorrect.", sQLWarning0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test09()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLRecoverableException sQLRecoverableException0 = new SQLRecoverableException("1@K'gTG", (Throwable) null);
      SQLDataException sQLDataException0 = new SQLDataException("1@K'gTG", "", sQLRecoverableException0);
      // Undeclared exception!
      try { 
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("Sm$Y<", (String) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocations((-1934), 1195, (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test13()  throws Throwable  {
      ...
      Matcher<Object> matcher0 = IsIn.isIn((Collection<Object>) arrayList1);
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(matcher0);
      arrayList0.add(localizedMatcher0);
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers((-1899), arrayList0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers((String) null, (-474), linkedHashSet0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.reportNoSubMatchersFound("Also, if you use @Mock annotation don't miss initMocks()");
        fail("Expecting exception: RuntimeException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfArgumentToReturn((InvocationOnMock) null, "    doThrow(exception).when(mock).someVoidMethod();", class0, 2147483645);
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      Integer integer0 = Integer.valueOf((-1007));
  ...
  public void test30()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLTransientConnectionException sQLTransientConnectionException0 = new SQLTransientConnectionException("!Qc>J0Vq2HcUec<}u", "ZZD't&}zN<}::t+G");
  ...
  public void test32()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLNonTransientException sQLNonTransientException0 = new SQLNonTransientException("Bs&ZK+\"rN 6cm", "%=?");
  ...
  public void test34()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLNonTransientConnectionException sQLNonTransientConnectionException0 = new SQLNonTransientConnectionException(" }W=KC2<");
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.smartNullPointerException("I>`kd(^ IW,Q[d RH", (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wantedAtMostX((-1329), (-1150));
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers((-2748), (List<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test50()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.unsupportedCombinationOfAnnotations("^vb", "^vb");
        fail("Expecting exception: RuntimeException");
  ...
  public void test52()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("lo/G", (-1454), (Collection<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.moreThanOneAnnotationNotAllowed("hos{WfUf*M@bVvK");
        fail("Expecting exception: RuntimeException");
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotStubVoidMethodWithAReturnValue("J`tui!|'a.'%bn1>");
        fail("Expecting exception: RuntimeException");
  ...
  public void test74()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("qrlez", (Exception) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test76()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfReturnValue("%uFfEH", "%uFfEH", "|0j {&F*i<RyZA4");
        fail("Expecting exception: RuntimeException");
