...
public class Reporter_ESTest extends Reporter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      BigDecimal bigDecimal0 = new BigDecimal((-2240));
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((String) null).when(invocation0).toString();
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy(146, (-2240));
      LocationImpl locationImpl0 = new LocationImpl();
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      ...
      SQLFeatureNotSupportedException sQLFeatureNotSupportedException0 = new SQLFeatureNotSupportedException("xWNo[1w,&_Z][!$");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers(853, vector0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("K]:ifcxp<i0fE8EP@W", (-2739), stack0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      ...
      SQLNonTransientException sQLNonTransientException0 = new SQLNonTransientException("", ":C");
      BatchUpdateException batchUpdateException0 = new BatchUpdateException("", "", (-263), intArray0, sQLNonTransientException0);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLDataException sQLDataException0 = new SQLDataException("Zfkv8MF>} {{!~)=");
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("Zfkv8MF>} {{!~)=", sQLDataException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("    doThrow(new RuntimeException())", "QErE(3kBH", (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfArgumentToReturn((InvocationOnMock) null, "", class0, (-1969));
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      HasProperty<InvocationMatcher> hasProperty0 = new HasProperty<InvocationMatcher>("\"(JxZ");
  ...
  public void test31()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLNonTransientConnectionException sQLNonTransientConnectionException0 = new SQLNonTransientConnectionException("f'o;,/(YmXt");
      SQLWarning sQLWarning0 = new SQLWarning("f'o;,/(YmXt", "f'o;,/(YmXt", 1, sQLNonTransientConnectionException0);
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("", "7b2", locationImpl0);
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wantedAtMostX(520, 520);
  ...
  public void test50()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.unsupportedCombinationOfAnnotations("", "={p89k-Ug[Z@W#4L~[%");
        fail("Expecting exception: RuntimeException");
  ...
  public void test55()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotStubVoidMethodWithAReturnValue("4;8iA7eR*ALC");
        fail("Expecting exception: RuntimeException");
  ...
  public void test66()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocationsInOrder(2147483645, 2147483645, (DescribedInvocation) null, location0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test77()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfReturnValue("However if you're still unsure why you're getting above error read on.", "", "");
        fail("Expecting exception: RuntimeException");
