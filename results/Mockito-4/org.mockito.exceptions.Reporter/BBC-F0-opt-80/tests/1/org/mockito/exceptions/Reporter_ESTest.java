...
public class Reporter_ESTest extends Reporter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.smartNullPointerException("However it is possible to use the -1 value to indicates that the last argument should be", locationImpl0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers((-2046), (List<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLTransientException sQLTransientException0 = new SQLTransientException("sq7YTdlHF\"AJ=kkQxh");
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("type < ", sQLTransientException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test11()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLWarning sQLWarning0 = new SQLWarning("fbx", "ZY'muXgxmpj");
      SQLRecoverableException sQLRecoverableException0 = new SQLRecoverableException("lrvB<.S@", "|", sQLWarning0);
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("org.hamcrest.TypeSafeDiagnosingMatcher", sQLTransactionRollbackException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("i]0Im%2CX!yjJha-$", "", (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy((-1746), 2);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      ...
      Matcher<InvocationMatcher> matcher0 = HasProperty.hasProperty("t*");
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(matcher0);
      vector0.add(localizedMatcher0);
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("Verification in order failure:", 498, vector0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.reportNoSubMatchersFound("@twmU}63zT\"nGoQcDRV");
        fail("Expecting exception: RuntimeException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfArgumentToReturn((InvocationOnMock) null, "3*TI_7z]/", class0, 942);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      MockFile mockFile0 = new MockFile((String) null, ", but is: ");
      ...
      SQLTransactionRollbackException sQLTransactionRollbackException0 = new SQLTransactionRollbackException("79}wyz|<,=CI");
      SQLIntegrityConstraintViolationException sQLIntegrityConstraintViolationException0 = new SQLIntegrityConstraintViolationException("79}wyz|<,=CI", "fU8RFf>z67", sQLTransactionRollbackException0);
      SQLSyntaxErrorException sQLSyntaxErrorException0 = new SQLSyntaxErrorException("\"ZTUtF(&C/>6^C", sQLIntegrityConstraintViolationException0);
      BatchUpdateException batchUpdateException0 = new BatchUpdateException("79}wyz|<,=CI", "", intArray0, sQLSyntaxErrorException0);
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLException sQLException0 = new SQLException("A2(=<,PN#=]Fh");
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.smartNullPointerException("kkwX;1U", (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test43()  throws Throwable  {
      ...
      HasPropertyWithValue<Integer> hasPropertyWithValue0 = new HasPropertyWithValue<Integer>("", stringContains0);
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(hasPropertyWithValue0);
      Location location0 = localizedMatcher0.getLocation();
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent(", hashCode: ", "  <- Vararg", location0);
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wantedAtMostX(765, 765);
  ...
  public void test49()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers(472, vector0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test52()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.unsupportedCombinationOfAnnotations("", "|+(\"vFWNwrMTyFp!;_");
        fail("Expecting exception: RuntimeException");
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("}]6kqk}<]", (-806), (Collection<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test65()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocations((-654), 3276, (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test68()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocationsInOrder(12, 3, (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test76()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("##sf8@iE8/:U`qEL8bE", (Exception) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test78()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfReturnValue("gcXacS{e*Zb", "gcXacS{e*Zb", "qbCDOAdBx39");
        fail("Expecting exception: RuntimeException");
