...
public class Reporter_ESTest extends Reporter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.smartNullPointerException("tzyINl;ILg_*", locationImpl0);
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidArgumentPositionRangeAtInvocationTime((InvocationOnMock) null, true, (-2375));
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers(";x$N=REpeL", 849, (Collection<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLSyntaxErrorException sQLSyntaxErrorException0 = new SQLSyntaxErrorException("n~;-X)wZZWwXH", "s&994ao2gh:35 ");
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("s&994ao2gh:35 ", sQLSyntaxErrorException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("", "...it does not make much sense - the test would have passed immediately in concurency", location0);
  ...
  public void test17()  throws Throwable  {
      ...
      Matcher<StubbedInvocationMatcher> matcher0 = IsIn.isIn((Collection<StubbedInvocationMatcher>) null);
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(matcher0);
      stack0.add(localizedMatcher0);
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers(3500, stack0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.reportNoSubMatchersFound("org.hamcrest.beans.HasProperty");
        fail("Expecting exception: RuntimeException");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfArgumentToReturn((InvocationOnMock) null, "5jAO0ok8G!nfr", class0, (-803));
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      ...
      SQLInvalidAuthorizationSpecException sQLInvalidAuthorizationSpecException0 = new SQLInvalidAuthorizationSpecException("RETURNS_SMART_NULLS", "RETURNS_SMART_NULLS", sQLTransientConnectionException0);
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLTransientConnectionException sQLTransientConnectionException0 = new SQLTransientConnectionException(".gDX0S/QOh", "m\"jr=K`N@~]Fhk)@2");
      SQLNonTransientConnectionException sQLNonTransientConnectionException0 = new SQLNonTransientConnectionException("", ".gDX0S/QOh", sQLTransientConnectionException0);
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLIntegrityConstraintViolationException sQLIntegrityConstraintViolationException0 = new SQLIntegrityConstraintViolationException("L\"@]Q_4{gx.{%H,=.S", "&]>G1B#C.O<73ML)");
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      IsNot<InvocationMatcher> isNot0 = new IsNot<InvocationMatcher>(isNull0);
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.smartNullPointerException("Check that the instance passed to delegatesTo() is of the correct type or contains compatible methods", (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("toString()", "", (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test53()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("", 1975, priorityQueue0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotStubVoidMethodWithAReturnValue("org.mockito.internal.junit.JUnitDetecter");
        fail("Expecting exception: RuntimeException");
  ...
  public void test64()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocations(0, 1, (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test66()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLTransientConnectionException sQLTransientConnectionException0 = new SQLTransientConnectionException(";x$N=REpeL", "' field.");
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("e}QsJCbrLl!kx", sQLIntegrityConstraintViolationException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test67()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocationsInOrder((-803), 1198, (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test76()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("map was ", (Exception) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test78()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfReturnValue("k!pBp-7$<8PVMr(~", "k!pBp-7$<8PVMr(~", (String) null);
        fail("Expecting exception: RuntimeException");
