...
public class Reporter_ESTest extends Reporter_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("", 10, linkedList0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test09()  throws Throwable  {
      ...
      BatchUpdateException batchUpdateException0 = new BatchUpdateException((String) null, (int[]) null, sQLTransientException0);
  ...
  public void test10()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLDataException sQLDataException0 = new SQLDataException("However it is possible to use the -1 value to indicates that the last argument should be", "5Gw/.g/pLiSs?bKU88");
      SQLInvalidAuthorizationSpecException sQLInvalidAuthorizationSpecException0 = new SQLInvalidAuthorizationSpecException("However it is possible to use the -1 value to indicates that the last argument should be", "", sQLDataException0);
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("Voids are usually stubbed with Throwables:", sQLInvalidAuthorizationSpecException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocationsInOrder(1617, 0, (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy(60, 15);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers((-29), linkedList0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.reportNoSubMatchersFound("#+[l84Gmy");
        fail("Expecting exception: RuntimeException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfArgumentToReturn((InvocationOnMock) null, "&_BP8w:-});!9vgtz3", class0, 1249);
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLDataException sQLDataException0 = new SQLDataException("mF6v Wnfg=[FUo_{", (String) null);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      Matcher<String> matcher0 = StringContains.containsString("41zq'Y]=");
      Object[] objectArray0 = new Object[4];
      DescribedAs<String> describedAs0 = new DescribedAs<String>("41zq'Y]=", matcher0, objectArray0);
  ...
  public void test34()  throws Throwable  {
      ...
      SQLDataException sQLDataException0 = new SQLDataException("However it is possible to use the -1 value to indicates that the last argument should be", "However it is possible to use the -1 value to indicates that the last argument should be");
      BatchUpdateException batchUpdateException0 = new BatchUpdateException(intArray0, sQLDataException0);
      SQLInvalidAuthorizationSpecException sQLInvalidAuthorizationSpecException0 = new SQLInvalidAuthorizationSpecException("However it is possible to use the -1 value to indicates that the last argument should be", "However it is possible to use the -1 value to indicates that the last argument should be", batchUpdateException0);
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLTransientConnectionException sQLTransientConnectionException0 = new SQLTransientConnectionException("Misplaced argument matcher detected here:", "");
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("!&.D4Q", "org.mockito.exceptions.verification.SmartNullPointerException", locationImpl0);
  ...
  public void test52()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.unsupportedCombinationOfAnnotations("CV/r<=", (String) null);
        fail("Expecting exception: RuntimeException");
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("duJ{z[ds:dr0x3Oc]t", (-1266), (Collection<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.moreThanOneAnnotationNotAllowed("\" M+i");
        fail("Expecting exception: RuntimeException");
  ...
  public void test57()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotStubVoidMethodWithAReturnValue("N*><*iC\"l_ReO,_F");
        fail("Expecting exception: RuntimeException");
  ...
  public void test64()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocations(1, 2147483645, (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test68()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      Matcher<Object> matcher0 = HasToString.hasToString("3`9ptzDYky");
      HasToString<Annotation> hasToString0 = new HasToString<Annotation>(matcher0);
      // Undeclared exception!
      try { 
        reporter0.delegatedMethodDoesNotExistOnDelegate((Method) null, hasToString0, hasToString0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test75()  throws Throwable  {
      ...
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy(4, (-3416));
      StackTraceFilter stackTraceFilter0 = new StackTraceFilter();
      LocationImpl locationImpl0 = new LocationImpl(stackTraceFilter0);
      // Undeclared exception!
      try { 
  ...
  public void test78()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfReturnValue("", (String) null, "ending with");
        fail("Expecting exception: RuntimeException");
