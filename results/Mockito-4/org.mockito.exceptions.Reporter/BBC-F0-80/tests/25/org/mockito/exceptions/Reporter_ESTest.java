...
public class Reporter_ESTest extends Reporter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.smartNullPointerException("org.mockito.exceptions.verification.SmartNullPointerException", locationImpl0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test06()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      File file0 = MockFile.createTempFile("  <- Vararg", "D|* Eua", (File) null);
      MockPrintStream mockPrintStream0 = new MockPrintStream(file0);
      VerboseMockInvocationLogger verboseMockInvocationLogger0 = new VerboseMockInvocationLogger(mockPrintStream0);
      SQLTimeoutException sQLTimeoutException0 = new SQLTimeoutException("UX,^gy");
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers(697, (List<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("every item is ", 13, arrayDeque0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test10()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLIntegrityConstraintViolationException sQLIntegrityConstraintViolationException0 = new SQLIntegrityConstraintViolationException("iqPk*", "iqPk*");
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("iqPk*", sQLIntegrityConstraintViolationException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test11()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLInvalidAuthorizationSpecException sQLInvalidAuthorizationSpecException0 = new SQLInvalidAuthorizationSpecException("|Gzxj+zdhLhk.)I%", "|Gzxj+zdhLhk.)I%", (-2575));
      SQLTransientException sQLTransientException0 = new SQLTransientException("", "", (-1895), sQLInvalidAuthorizationSpecException0);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("G(l-Tu", "org.hamcrest.Condition$1", locationImpl0);
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocationsInOrder((-1736), (-1395), (DescribedInvocation) null, (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfArgumentToReturn((InvocationOnMock) null, "The index need to be a positive number that indicates the position of the argument to return.", class0, 7);
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.reportNoSubMatchersFound("org.mockito.internal.invocation.realmethod.CleanTraceRealMethod");
        fail("Expecting exception: RuntimeException");
  ...
  public void test26()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy(4, (-31));
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLRecoverableException sQLRecoverableException0 = new SQLRecoverableException("\t", "", (byte)0);
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.smartNullPointerException("ycoKGNy.gdST", (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("  spy = mock( ->List.class<- , withSettings().delegatedInstance( ->new ArrayList()<- );", "  spy = mock( ->List.class<- , withSettings().delegatedInstance( ->new ArrayList()<- );", (Location) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wantedAtMostX((-134), (-134));
  ...
  public void test49()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers(697, vector0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test52()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.unsupportedCombinationOfAnnotations(" recorded:", " recorded:");
        fail("Expecting exception: RuntimeException");
  ...
  public void test54()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("QfwDwCA^\"$w6uLT2qv^", 32, (Collection<LocalizedMatcher>) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.moreThanOneAnnotationNotAllowed("XaAAAK6!auh.NE+\bjE");
        fail("Expecting exception: RuntimeException");
  ...
  public void test63()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocations((-3439), (-3439), (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test74()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy(399, 1173);
  ...
  public void test75()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("fNqmne1Fo", (Exception) null);
        fail("Expecting exception: NullPointerException");
