...
public class Reporter_ESTest extends Reporter_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      SQLNonTransientConnectionException sQLNonTransientConnectionException0 = new SQLNonTransientConnectionException("", "UpK9zAeUEpG", 1208);
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.invalidUseOfMatchers((-1074), vector0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.incorrectUseOfAdditionalMatchers("    when(mock.getArticles()).thenReturn(articles);", 62, arrayList0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLFeatureNotSupportedException sQLFeatureNotSupportedException0 = new SQLFeatureNotSupportedException("org.mockito.internal.invocation.realmethod.DefaultRealMethod", (String) null, 1024);
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("In future release we will remove timeout(x).atMost(y) from the API.", sQLFeatureNotSupportedException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test12()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      SQLFeatureNotSupportedException sQLFeatureNotSupportedException0 = new SQLFeatureNotSupportedException("'SB*", "'SB*", (-2265));
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("'SB*", sQLFeatureNotSupportedException0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.argumentsAreDifferent("", "{)=J]u,sQ'+`wb8}*L.", locationImpl0);
  ...
  public void test18()  throws Throwable  {
      ...
      IsEqual<Object> isEqual0 = new IsEqual<Object>(isNull0);
      Matcher<String> matcher0 = AllOf.allOf((Matcher<? super String>) isNull0, (Matcher<? super String>) isEqual0);
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.reportNoSubMatchersFound("    doThrow(new RuntimeException()).when(mock).someMethod();");
        fail("Expecting exception: RuntimeException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfArgumentToReturn((InvocationOnMock) null, (String) null, class0, 808);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      SQLTransientConnectionException sQLTransientConnectionException0 = new SQLTransientConnectionException("", "    //incorrect:", 10, batchUpdateException0);
  ...
  public void test27()  throws Throwable  {
      org.mockito.internal.reporting.Discrepancy discrepancy0 = new org.mockito.internal.reporting.Discrepancy(1905, 1905);
      Reporter reporter0 = new Reporter();
      StackTraceFilter stackTraceFilter0 = new StackTraceFilter();
      LocationImpl locationImpl0 = new LocationImpl(stackTraceFilter0);
      // Undeclared exception!
  ...
  public void test34()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      DataTruncation dataTruncation0 = new DataTruncation(383, true, true, 383, 383);
      SQLTimeoutException sQLTimeoutException0 = new SQLTimeoutException("starting with", dataTruncation0);
      // Undeclared exception!
      try { 
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wantedAtMostX((-2747), 1);
  ...
  public void test52()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.unsupportedCombinationOfAnnotations(" 3: you are stubbing the behaviour of another mock inside before 'thenReturn' instruction if completed", "fiIlyu#*");
        fail("Expecting exception: RuntimeException");
  ...
  public void test64()  throws Throwable  {
      Reporter reporter0 = new Reporter();
      Matcher<LocalizedMatcher> matcher0 = HasToString.hasToString(">S#5O4|:O-E/.Y}V.");
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(matcher0);
      Location location0 = localizedMatcher0.getLocation();
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocations(1697, 60, (DescribedInvocation) null, location0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test66()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForInjectMocksAnnotation("#_(/MJN(}/6\"tmF6^9", (Exception) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test67()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.tooManyActualInvocationsInOrder(1911, 0, (DescribedInvocation) null, locationImpl0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test76()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.cannotInitializeForSpyAnnotation("1`H8ZC&u", (Exception) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test78()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        reporter0.wrongTypeOfReturnValue("one of ", "pwlq<-", "one of ");
        fail("Expecting exception: RuntimeException");
