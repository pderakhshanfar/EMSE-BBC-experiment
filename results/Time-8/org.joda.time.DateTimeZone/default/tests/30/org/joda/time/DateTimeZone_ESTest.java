...
public class DateTimeZone_ESTest extends DateTimeZone_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      long long0 = dateTimeZone0.convertLocalToUTC((-25200000L), true);
      assertEquals(0L, long0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      LocalDateTime localDateTime0 = new LocalDateTime(82800051L);
  ...
  public void test03()  throws Throwable  {
      ...
      LocalDateTime localDateTime0 = new LocalDateTime(82800023L);
  ...
  public void test07()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(0, (-1577));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: -1577
         //
  ...
  public void test11()  throws Throwable  {
      ...
      TimeZone timeZone0 = dateTimeZone0.toTimeZone();
      assertEquals("java.util.SimpleTimeZone[id=-00:00:00.462,offset=-462,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", timeZone0.toString());
  ...
  public void test13()  throws Throwable  {
      ...
      dateTimeZone0.UTC.previousTransition(491L);
  ...
  public void test14()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-462));
      dateTimeZone0.previousTransition((-153L));
      assertEquals("-00:00:00.462", dateTimeZone0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      DateTimeZone dateTimeZone0 = buddhistChronology0.getZone();
      dateTimeZone0.nextTransition(4774L);
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      int int0 = dateTimeZone0.getStandardOffset((-3450L));
  ...
  public void test22()  throws Throwable  {
      ...
      int int0 = cachedDateTimeZone0.getOffsetFromLocal((-1455L));
      assertEquals(0, int0);
  }
  ...
  public void test24()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(1);
      DateTimeZone dateTimeZone1 = DateTimeZone.forOffsetMillis((-22583480));
      GJChronology gJChronology0 = GJChronology.getInstance(dateTimeZone0, (long) 1, 1);
      Instant instant0 = gJChronology0.getGregorianCutover();
      int int0 = dateTimeZone1.getOffset((ReadableInstant) instant0);
      assertEquals("+00:00:00.001", dateTimeZone0.toString());
      assertEquals("-06:16:23.480", dateTimeZone1.toString());
  ...
  public void test27()  throws Throwable  {
      ...
      int int0 = dateTimeZone0.getOffset((-5443L));
  ...
  public void test28()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(1);
      dateTimeZone0.getNameKey(1874L);
      assertEquals("+00:00:00.001", dateTimeZone0.toString());
  }
  ...
  public void test29()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      String string0 = dateTimeZone0.UTC.getNameKey(9968400000L);
  ...
  public void test32()  throws Throwable  {
      ...
      assertEquals("+00:00:01.770", string0);
  }
  ...
  public void test36()  throws Throwable  {
      ...
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      CachedDateTimeZone cachedDateTimeZone0 = CachedDateTimeZone.forZone(dateTimeZone0);
      long long0 = cachedDateTimeZone0.convertUTCToLocal((-54L));
  ...
  public void test37()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      long long0 = dateTimeZone0.convertLocalToUTC((-25200000L), true, (long) (-21600000));
      assertEquals(0L, long0);
  }
  ...
  public void test38()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      long long0 = dateTimeZone0.UTC.convertLocalToUTC(1411L, true, 0L);
  ...
  public void test39()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-462));
      dateTimeZone0.UTC.convertLocalToUTC((-153L), true, (long) (-462));
  ...
  public void test43()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      long long0 = fixedDateTimeZone0.convertLocalToUTC(3394L, true);
  ...
  public void test46()  throws Throwable  {
      ...
      int int0 = dateTimeZone0.getOffsetFromLocal((-1228L));
  ...
  public void test48()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      String string0 = dateTimeZone0.getName((-25L), (Locale) null);
  ...
  public void test49()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getShortName(120648320L, (Locale) null);
      assertEquals("-07:00", string0);
  }
  ...
  public void test53()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(2147268921, 2147268921);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Hours out of range: 2147268921
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      // Undeclared exception!
      try { 
        DateTimeZone.forID(",PIItM?f3{ayd'E#");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The datetime zone id ',PIItM?f3{ayd'E#' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      long long0 = fixedDateTimeZone0.adjustOffset((-1410L), false);
  ...
  public void test58()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("SST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      long long0 = dateTimeZone0.convertLocalToUTC(358L, true);
      assertEquals((-39599642L), long0);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      CachedDateTimeZone cachedDateTimeZone0 = CachedDateTimeZone.forZone(dateTimeZone0);
      int int0 = cachedDateTimeZone0.getOffsetFromLocal((-497));
      assertEquals("-00:00:00.497", cachedDateTimeZone0.toString());
  ...
  public void test67()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getShortName(30585600000L, locale0);
      assertNotNull(string0);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
      assertEquals("+00:00", string0);
  }
  ...
  public void test72()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-41));
      DateTimeZone dateTimeZone1 = DateTimeZone.forOffsetMillis((-41));
  ...
  public void test77()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-22583480), "J*a+.4h[1tW7#K9Jm?");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The datetime zone id 'J*a+.4h[1tW7#K9Jm?' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test83()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(0, 152);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: 152
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test85()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("+00:00:03.573");
      assertEquals("+00:00:03.573", dateTimeZone0.toString());
  }
  ...
  public void test98()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-41));
      String string0 = dateTimeZone0.getShortName((long) (-41));
