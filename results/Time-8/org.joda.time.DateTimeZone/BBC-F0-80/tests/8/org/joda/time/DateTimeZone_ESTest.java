...
public class DateTimeZone_ESTest extends DateTimeZone_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(87, "AET");
  ...
  public void test003()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.convertLocalToUTC(25397984L, true);
      assertEquals((-8802016L), long0);
  }
  ...
  public void test007()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(23, 1457);
  ...
  public void test011()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(4874);
      TimeZone timeZone0 = dateTimeZone0.toTimeZone();
      assertEquals(4874, timeZone0.getRawOffset());
      assertEquals("+00:00:04.874", dateTimeZone0.toString());
  }
  ...
  public void test012()  throws Throwable  {
      ...
      TimeZone timeZone0 = dateTimeZone0.toTimeZone();
      assertEquals("-00:00:00.195", dateTimeZone0.getID());
      assertEquals((-195), timeZone0.getRawOffset());
  }

  @Test(timeout = 4000)
  public void test013()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("CQe");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
  ...
  public void test016()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("CQe");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      dateTimeZone0.UTC.nextTransition(2045L);
  ...
  public void test017()  throws Throwable  {
      ...
      dateTimeZone0.nextTransition((-900L));
  ...
  public void test018()  throws Throwable  {
      ...
      assertEquals("-00:00:00.202", dateTimeZone0.toString());
  }
  ...
  public void test020()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("CQe");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      dateTimeZone0.getStandardOffset(43200000L);
      assertEquals("UTC", dateTimeZone0.toString());
  }
  ...
  public void test022()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-202));
      int int0 = dateTimeZone0.getStandardOffset((-194L));
      assertEquals("-00:00:00.202", dateTimeZone0.toString());
  ...
  public void test025()  throws Throwable  {
      ...
      int int0 = fixedDateTimeZone0.getOffset(607L);
      assertEquals(0, int0);
  }
  ...
  public void test026()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHours(12);
      int int0 = dateTimeZone0.getOffset(1055L);
      assertEquals("+12:00", dateTimeZone0.toString());
  ...
  public void test027()  throws Throwable  {
      ...
      int int0 = cachedDateTimeZone0.getOffset((long) (-2403));
      assertEquals((-2403), int0);
      assertEquals("-00:00:02.403", cachedDateTimeZone0.getID());
  }

  @Test(timeout = 4000)
  public void test028()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHours(10);
      dateTimeZone0.getNameKey(21600512L);
  ...
  public void test030()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHours(1);
      dateTimeZone0.getMillisKeepLocal(dateTimeZone0, 884L);
      assertEquals("+01:00", dateTimeZone0.toString());
  }
  ...
  public void test031()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.getMillisKeepLocal(dateTimeZone0, (-376L));
      assertEquals("Etc/UTC", dateTimeZone0.toString());
  ...
  public void test036()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(1);
      long long0 = dateTimeZone0.convertUTCToLocal(3777L);
  ...
  public void test038()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      long long0 = dateTimeZone0.convertLocalToUTC(30962844000000L, false, 9223372036854775807L);
      assertEquals(30962869200000L, long0);
  }

  @Test(timeout = 4000)
  public void test039()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      long long0 = fixedDateTimeZone0.convertLocalToUTC((-2679L), true, (-2679L));
  ...
  public void test040()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      long long0 = dateTimeZone0.convertLocalToUTC(3543L, false);
  ...
  public void test042()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-158), "SST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
      CachedDateTimeZone cachedDateTimeZone0 = CachedDateTimeZone.forZone(dateTimeZone0);
      // Undeclared exception!
      try { 
  ...
  public void test043()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dateTimeZone0.convertLocalToUTC((-9223372036854775775L), true, (-326L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test046()  throws Throwable  {
      ...
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      int int0 = dateTimeZone0.getOffsetFromLocal(4318643L);
  ...
  public void test049()  throws Throwable  {
      ...
      assertEquals("-14:12", dateTimeZone0.getID());
  }

  @Test(timeout = 4000)
  public void test050()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes((-3580), (-3580));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Hours out of range: -3580
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test051()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(1034, 1034);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Hours out of range: 1034
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test053()  throws Throwable  {
      // Undeclared exception!
      try { 
        DateTimeZone.forID("D3.)!lo#_");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The datetime zone id 'D3.)!lo#_' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test055()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("MET");
      long long0 = dateTimeZone0.adjustOffset((-766623599965L), true);
      assertEquals((-766623599965L), long0);
  }
  ...
  public void test062()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Illegal instant due to time zone offset transition (daylight savings time 'gap'): -292275055-05-17T01:47:04.197 (Asia/Tokyo)
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test063()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Illegal instant due to time zone offset transition (daylight savings time 'gap'): -292275055-05-16T16:47:04.215 (MET)
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test064()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dateTimeZone0.convertLocalToUTC((-9223372036854775775L), false, 1L);
        fail("Expecting exception: ArithmeticException");
  ...
  public void test073()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-3501));
      boolean boolean0 = dateTimeZone0.isStandardOffset((-3501));
      assertTrue(boolean0);
      assertEquals("-00:00:03.501", dateTimeZone0.getID());
  }
  ...
  public void test076()  throws Throwable  {
      ...
      DateTimeZone dateTimeZone0 = buddhistChronology0.getZone();
      String string0 = dateTimeZone0.getShortName(3601024L, (Locale) null);
      assertNotNull(string0);
      assertEquals("+00:00", string0);
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  }
  ...
  public void test078()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("-14:12");
  ...
  public void test079()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.UTC.getMillisKeepLocal(dateTimeZone0, 25650000);
      assertEquals(0L, long0);
  ...
  public void test085()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-2082579861), "5+ 12:");
      // Undeclared exception!
      try { 
        DateTimeZone.forTimeZone(simpleTimeZone0);
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The datetime zone id '5+ 12:' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test087()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(21, "CET");
      // Undeclared exception!
      try { 
        DateTimeZone.forTimeZone(simpleTimeZone0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test091()  throws Throwable  {
      // Undeclared exception!
      try { 
        DateTimeZone.forOffsetMillis((-1102850563));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Millis out of range: -1102850563
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test093()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHours(474);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Hours out of range: 474
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test094()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(0, (-2999));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: -2999
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test096()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("+01:12");
  ...
  public void test106()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("CST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      LocalDateTime localDateTime0 = new LocalDateTime((-2506L));
      boolean boolean0 = dateTimeZone0.isLocalDateTimeGap(localDateTime0);
      assertFalse(boolean0);
  }
