...
public class DateTimeZone_ESTest extends DateTimeZone_ESTest_scaffolding {
  ...
  public void test007()  throws Throwable  {
      ...
      TimeZone timeZone0 = dateTimeZone0.toTimeZone();
      assertEquals("-00:00:01.576", dateTimeZone0.toString());
      assertEquals((-1576), timeZone0.getRawOffset());
  }
  ...
  public void test008()  throws Throwable  {
      ...
      TimeZone timeZone0 = dateTimeZone0.toTimeZone();
      assertEquals("java.util.SimpleTimeZone[id=+00:00:02.086,offset=2086,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", timeZone0.toString());
      assertEquals("+00:00:02.086", dateTimeZone0.getID());
  }
  ...
  public void test010()  throws Throwable  {
      ...
      dateTimeZone0.previousTransition(3336L);
  ...
  public void test012()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.nextTransition((-3186L));
  ...
  public void test013()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      dateTimeZone0.nextTransition((-379L));
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  }
  ...
  public void test018()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      int int0 = dateTimeZone0.getStandardOffset((-3762L));
  ...
  public void test019()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      dateTimeZone0.UTC.getOffsetFromLocal(1L);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  }
  ...
  public void test022()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(1);
      int int0 = dateTimeZone0.getOffset(644L);
  ...
  public void test023()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      int int0 = dateTimeZone0.getOffset(335L);
      assertEquals((-25200000), int0);
  }
  ...
  public void test024()  throws Throwable  {
      ...
      dateTimeZone0.getNameKey((-1148L));
  ...
  public void test026()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(1);
      long long0 = dateTimeZone0.getMillisKeepLocal(dateTimeZone0, 824L);
      assertEquals("+00:00:00.001", dateTimeZone0.getID());
  ...
  public void test032()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(1);
      long long0 = dateTimeZone0.convertUTCToLocal((-3186L));
      assertEquals("+00:00:00.001", dateTimeZone0.getID());
  ...
  public void test033()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.convertLocalToUTC(0L, true, 1007L);
  ...
  public void test034()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      long long0 = dateTimeZone0.convertLocalToUTC(3741L, false, 3741L);
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  ...
  public void test035()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      long long0 = dateTimeZone0.convertLocalToUTC((-595L), true, (-595L));
  ...
  public void test038()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3600000, "MST");
  ...
  public void test040()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      long long0 = dateTimeZone0.convertLocalToUTC(100000000000000L, false);
      assertEquals(100000025200000L, long0);
  }
  ...
  public void test041()  throws Throwable  {
      ...
      int int0 = cachedDateTimeZone0.getOffsetFromLocal(280L);
  ...
  public void test045()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes((-902), 4);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Hours out of range: -902
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test061()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHours(23);
      CachedDateTimeZone cachedDateTimeZone0 = CachedDateTimeZone.forZone(dateTimeZone0);
      int int0 = cachedDateTimeZone0.getOffsetFromLocal((-18001088L));
  ...
  public void test065()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHours(23);
      boolean boolean0 = dateTimeZone0.isStandardOffset((-18001088L));
      assertEquals("+23:00", dateTimeZone0.toString());
      assertTrue(boolean0);
  }
  ...
  public void test069()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getName((long) 76, locale0);
      assertNotNull(string0);
  ...
  public void test077()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1622629091), "Zj81*bh7Ck#E.");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The datetime zone id 'Zj81*bh7Ck#E.' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test080()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone((TimeZone) null);
      dateTimeZone0.previousTransition((-1596L));
      assertEquals("Etc/UTC", dateTimeZone0.toString());
  }
  ...
  public void test081()  throws Throwable  {
      // Undeclared exception!
      try { 
        DateTimeZone.forOffsetMillis(2145296801);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Millis out of range: 2145296801
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test082()  throws Throwable  {
      // Undeclared exception!
      try { 
        DateTimeZone.forOffsetMillis((-2054514547));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Millis out of range: -2054514547
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test084()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(0, 3574);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: 3574
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test085()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(0, (-1498));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: -1498
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test091()  throws Throwable  {
      ...
      CachedDateTimeZone cachedDateTimeZone0 = CachedDateTimeZone.forZone(dateTimeZone0);
      int int0 = cachedDateTimeZone0.getOffsetFromLocal(1992L);
      assertEquals(0, int0);
  }
  ...
  public void test092()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.convertLocalToUTC((-3561L), false);
  ...
  public void test098()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getName((long) 913);
      assertEquals("+00:00:00.913", string0);
  }
  ...
  public void test099()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(20, "ZE81*bh7Ck#E.");
      // Undeclared exception!
      try { 
        DateTimeZone.forTimeZone(simpleTimeZone0);
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The datetime zone id 'ZE81*bh7Ck#E.' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test107()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.UTC.getShortName((-1824L));
      assertNotNull(string0);
      assertEquals("+00:00", string0);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
  }
