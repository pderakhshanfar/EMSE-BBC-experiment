...
public class DateTimeZone_ESTest extends DateTimeZone_ESTest_scaffolding {
  ...
  public void test014()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHoursMinutes(1, 1);
      dateTimeZone0.nextTransition((-1141L));
      assertEquals("+01:01", dateTimeZone0.toString());
  }
  ...
  public void test018()  throws Throwable  {
      ...
      int int0 = dateTimeZone0.getStandardOffset(7320000);
  ...
  public void test019()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-4702));
      int int0 = dateTimeZone0.getStandardOffset(100L);
      assertEquals("-00:00:04.702", dateTimeZone0.toString());
  ...
  public void test021()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      dateTimeZone0.getOffset(3664864L);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
  }
  ...
  public void test023()  throws Throwable  {
      ...
      int int0 = dateTimeZone0.getOffset((long) 130);
      assertEquals((-2429), int0);
      assertEquals("-00:00:02.429", dateTimeZone0.getID());
  }
  ...
  public void test024()  throws Throwable  {
      ...
      assertEquals("-00:00:00.163", dateTimeZone0.getID());
  }
  ...
  public void test030()  throws Throwable  {
      ...
      dateTimeZone0.UTC.equals(locale0);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  }
  ...
  public void test033()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHoursMinutes(1, 1);
      long long0 = dateTimeZone0.UTC.convertUTCToLocal((-2992L));
      assertEquals("+01:01", dateTimeZone0.toString());
  ...
  public void test034()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(1);
      long long0 = dateTimeZone0.convertLocalToUTC((long) 1, true, 2147483626L);
      assertEquals("+00:00:00.001", dateTimeZone0.getID());
      assertEquals(0L, long0);
  }
  ...
  public void test035()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHoursMinutes(1, 1);
      long long0 = dateTimeZone0.convertLocalToUTC(10800000L, true, 2147483647L);
      assertEquals("+01:01", dateTimeZone0.toString());
  ...
  public void test036()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      long long0 = dateTimeZone0.convertLocalToUTC((-1555L), true, (-1555L));
  ...
  public void test038()  throws Throwable  {
      ...
      LocalDateTime localDateTime0 = new LocalDateTime((-9223372036854775756L), dateTimeZone0);
      // Undeclared exception!
      try { 
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dateTimeZone0.convertLocalToUTC((-9223372036854775785L), true, 743L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test042()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-4022), "ECT");
  ...
  public void test044()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Denver");
      int int0 = dateTimeZone0.getOffsetFromLocal(9223372036847575816L);
  ...
  public void test045()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getName((long) (-150), (Locale) null);
  ...
  public void test049()  throws Throwable  {
      // Undeclared exception!
      try { 
        DateTimeZone.forID("2Ij=zcXC@cJ9)$b^5");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The datetime zone id '2Ij=zcXC@cJ9)$b^5' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test055()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.convertLocalToUTC((long) (-1346), true);
  ...
  public void test057()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dateTimeZone0.convertLocalToUTC((-9223372036854775808L), false, 743L);
        fail("Expecting exception: ArithmeticException");
  ...
  public void test060()  throws Throwable  {
      ...
      DateMidnight dateMidnight0 = new DateMidnight((long) 60, (Chronology) gJChronology0);
      assertEquals("-09:01", dateTimeZone0.toString());
      assertEquals((-53940000L), dateMidnight0.getMillis());
  }
  ...
  public void test063()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("MET");
      int int0 = dateTimeZone0.getOffsetFromLocal((-744L));
      assertEquals(3600000, int0);
  }
  ...
  public void test064()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      CachedDateTimeZone cachedDateTimeZone0 = CachedDateTimeZone.forZone(dateTimeZone0);
      int int0 = cachedDateTimeZone0.getOffsetFromLocal(6000L);
  ...
  public void test067()  throws Throwable  {
      ...
      assertEquals("-00:00:00.917", dateTimeZone0.getID());
  }
  ...
  public void test072()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.UTC.getShortName(172L, locale0);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
      assertNotNull(string0);
  ...
  public void test081()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The datetime zone id '-00:00:00.163' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test085()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(0, (-3083));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: -3083
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test087()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes((-6380), 0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Hours out of range: -6380
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test092()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID((String) null);
      boolean boolean0 = dateTimeZone0.UTC.isStandardOffset((-2277L));
      assertTrue(boolean0);
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  }
  ...
  public void test096()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        Years.parseYears("LeW}$J+J^$JB PM)");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid format: \"LeW}$J+J^$JB PM)\"
         //
