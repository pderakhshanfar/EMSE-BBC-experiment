...
public class DateTimeZone_ESTest extends DateTimeZone_ESTest_scaffolding {
  ...
  public void test009()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(23, (-3665));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: -3665
         //
  ...
  public void test015()  throws Throwable  {
      ...
      TimeZone timeZone0 = dateTimeZone0.toTimeZone();
      assertEquals(361, timeZone0.getRawOffset());
  ...
  public void test021()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      long long0 = fixedDateTimeZone0.nextTransition((-652L));
  ...
  public void test027()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      CachedDateTimeZone cachedDateTimeZone0 = CachedDateTimeZone.forZone(dateTimeZone0);
      cachedDateTimeZone0.getOffset(2648L);
  ...
  public void test029()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-2036));
      int int0 = dateTimeZone0.getOffset(65878423L);
  ...
  public void test033()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-2036));
      long long0 = dateTimeZone0.getMillisKeepLocal(dateTimeZone0, (-2036));
  ...
  public void test038()  throws Throwable  {
      ...
      assertEquals(30962843997964L, long0);
      assertEquals("-00:00:02.036", dateTimeZone0.getID());
  }
  ...
  public void test039()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-2036));
      long long0 = dateTimeZone0.convertUTCToLocal((-3008L));
      assertEquals((-5044L), long0);
      assertEquals("-00:00:02.036", dateTimeZone0.getID());
  }
  ...
  public void test040()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      long long0 = fixedDateTimeZone0.convertLocalToUTC(0L, false, 31083663600000L);
      assertEquals(0L, long0);
  }
  ...
  public void test041()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.convertLocalToUTC((-4250L), true, 63072000000L);
      assertEquals(17995750L, long0);
  }
  ...
  public void test042()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("VST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      long long0 = dateTimeZone0.convertLocalToUTC((-9223372036829575805L), false, (-2005974380000L));
  ...
  public void test043()  throws Throwable  {
      ...
      assertEquals(2622660000L, long0);
  ...
  public void test047()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dateTimeZone0.convertLocalToUTC((-9223372036829575805L), true, (-2005974380000L));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal instant due to time zone offset transition (daylight savings time 'gap'): -292275055-05-16T23:47:04.195 (Asia/Ho_Chi_Minh)
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test051()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(1635, 58);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Hours out of range: 1635
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test054()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("VST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      long long0 = dateTimeZone0.adjustOffset((-2005974400009L), true);
      assertEquals((-2005974380009L), long0);
  }
  ...
  public void test056()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("VST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      long long0 = dateTimeZone0.adjustOffset((-2005974399980L), true);
      assertEquals((-2005974399980L), long0);
  }
  ...
  public void test060()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      long long0 = fixedDateTimeZone0.getMillisKeepLocal((DateTimeZone) null, 1079L);
  ...
  public void test062()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dateTimeZone0.convertLocalToUTC((-9223372036829575763L), true);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal instant due to time zone offset transition (daylight savings time 'gap'): -292275055-05-16T23:47:04.237 (Asia/Ho_Chi_Minh)
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test067()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-2036));
      DateTime dateTime0 = new DateTime(1589L, dateTimeZone0);
      DateTime dateTime1 = dateTime0.withYearOfEra(183);
      assertEquals((-56360707198411L), dateTime1.getMillis());
      assertEquals("-00:00:02.036", dateTimeZone0.getID());
  }
  ...
  public void test068()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("VST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      DateTimeZone dateTimeZone1 = DateTimeZone.forOffsetMillis((-59432204));
      // Undeclared exception!
      try { 
        dateTimeZone0.getMillisKeepLocal(dateTimeZone1, 9223372036843975807L);
        fail("Expecting exception: ArithmeticException");
  ...
  public void test074()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Chicago");
      int int0 = dateTimeZone0.getOffsetFromLocal((-569L));
  ...
  public void test075()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Chicago");
      boolean boolean0 = dateTimeZone0.isStandardOffset((-2266L));
      assertTrue(boolean0);
  }
  ...
  public void test079()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-2036));
      String string0 = dateTimeZone0.getName((long) (-3665), (Locale) null);
      assertEquals("-00:00:02.036", string0);
  }
  ...
  public void test080()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getName((-1747L), locale0);
  ...
  public void test085()  throws Throwable  {
      ...
      DateTimeZone dateTimeZone1 = DateTimeZone.forOffsetHoursMinutes(0, 23);
      assertEquals("+00:23", dateTimeZone1.toString());
  }
  ...
  public void test093()  throws Throwable  {
      // Undeclared exception!
      try { 
        DateTimeZone.forOffsetMillis((-2142774253));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Millis out of range: -2142774253
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test096()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(0, (-1743));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: -1743
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test097()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes((-292269337), (-292269337));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Hours out of range: -292269337
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test106()  throws Throwable  {
      ...
      assertEquals("+00:00:01.854", string0);
  }
  ...
  public void test107()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("VST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      String string0 = dateTimeZone0.getName(2621L);
  ...
  public void test111()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHours(3968);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Hours out of range: 3968
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test116()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      String string0 = fixedDateTimeZone0.getShortName((-230L));
      assertNotNull(string0);
      assertEquals("+00:00", string0);
  }
}
