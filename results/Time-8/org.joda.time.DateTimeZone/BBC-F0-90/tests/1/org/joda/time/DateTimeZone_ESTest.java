...
public class DateTimeZone_ESTest extends DateTimeZone_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(777, 1, 1, 1, (-93), (-210));
  ...
  public void test006()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(23, (-2370));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: -2370
         //
  ...
  public void test010()  throws Throwable  {
      ...
      assertEquals("java.util.SimpleTimeZone[id=-00:00:00.056,offset=-56,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0]", timeZone0.toString());
  }
  ...
  public void test013()  throws Throwable  {
      ...
      dateTimeZone0.previousTransition((-3804L));
  ...
  public void test016()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHoursMinutes(1, 1);
      dateTimeZone0.nextTransition((-2114L));
      assertEquals("+01:01", dateTimeZone0.toString());
  }
  ...
  public void test019()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      dateTimeZone0.getStandardOffset((-815L));
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  }
  ...
  public void test021()  throws Throwable  {
      ...
      assertEquals("-00:00:00.166", dateTimeZone0.getID());
  }
  ...
  public void test024()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-2505));
      Instant instant0 = new Instant((long) (-2505));
      int int0 = dateTimeZone0.getOffset((ReadableInstant) instant0);
      assertEquals("-00:00:02.505", dateTimeZone0.toString());
  ...
  public void test030()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHoursMinutes(0, 0);
      CachedDateTimeZone cachedDateTimeZone0 = CachedDateTimeZone.forZone(dateTimeZone0);
      long long0 = cachedDateTimeZone0.UTC.getMillisKeepLocal(dateTimeZone0, 0);
      assertEquals(0L, long0);
  }
  ...
  public void test037()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      long long0 = dateTimeZone0.convertLocalToUTC(0L, false, 2966L);
      assertEquals(0L, long0);
  ...
  public void test038()  throws Throwable  {
      ...
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      long long0 = dateTimeZone0.convertLocalToUTC(532L, true, 2592000000L);
      assertEquals(25200532L, long0);
  }

  @Test(timeout = 4000)
  public void test039()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      long long0 = fixedDateTimeZone0.convertLocalToUTC((-3431L), true, 100000L);
  ...
  public void test040()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHoursMinutes(1, 1);
      long long0 = dateTimeZone0.convertLocalToUTC((-2632L), true);
      assertEquals((-3662632L), long0);
      assertEquals("+01:01", dateTimeZone0.getID());
  }
  ...
  public void test043()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("America/Chicago");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      LocalDateTime localDateTime0 = new LocalDateTime(9223372036854772692L, dateTimeZone0);
  ...
  public void test046()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("Asia/Kolkata");
      int int0 = dateTimeZone0.getOffsetFromLocal((-339L));
      assertEquals(19800000, int0);
  }
  ...
  public void test047()  throws Throwable  {
      ...
      assertEquals("-00:00:03.188", cachedDateTimeZone0.toString());
  ...
  public void test048()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      Locale locale0 = Locale.forLanguageTag("T!9`CaN%$&4=");
      String string0 = dateTimeZone0.getName((-1784L), locale0);
  ...
  public void test053()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes((-1620023021), 1660);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Hours out of range: -1620023021
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test058()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-18));
      long long0 = dateTimeZone0.getMillisKeepLocal((DateTimeZone) null, (-18));
  ...
  public void test059()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-3188));
      long long0 = dateTimeZone0.convertLocalToUTC((long) (-3188), true);
      assertEquals(0L, long0);
  ...
  public void test069()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(60, "America/Chicago");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
  ...
  public void test078()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis(0);
      long long0 = dateTimeZone0.convertLocalToUTC(658L, true);
      assertEquals("UTC", dateTimeZone0.getID());
  ...
  public void test084()  throws Throwable  {
      // Undeclared exception!
      try { 
        DateTimeZone.forOffsetMillis((-122520833));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Millis out of range: -122520833
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test088()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(0, (-240060234));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Minutes out of range: -240060234
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test098()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("America/Los_Angeles");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(timeZone0);
      String string0 = dateTimeZone0.getName(3460L);
      assertNotNull(string0);
  ...
  public void test102()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHours((-1572));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Hours out of range: -1572
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
