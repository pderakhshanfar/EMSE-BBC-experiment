...
public class DateTimeZone_ESTest extends DateTimeZone_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(463, "SST");
  ...
  public void test006()  throws Throwable  {
      ...
      assertEquals("-00:00:02.389", dateTimeZone0.toString());
  ...
  public void test007()  throws Throwable  {
      ...
      dateTimeZone0.previousTransition(10000L);
  ...
  public void test009()  throws Throwable  {
      ...
      dateTimeZone0.UTC.nextTransition(86400L);
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  ...
  public void test010()  throws Throwable  {
      ...
      dateTimeZone0.nextTransition((-510L));
      assertEquals("-00:00:04.467", dateTimeZone0.getID());
  }
  ...
  public void test012()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-18000000), "WET");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
  ...
  public void test013()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.getDefault();
      dateTimeZone0.getStandardOffset(2796L);
      assertEquals("Etc/UTC", dateTimeZone0.toString());
  }
  ...
  public void test016()  throws Throwable  {
      ...
      MutableDateTime mutableDateTime0 = new MutableDateTime((long) (-1420));
      int int0 = dateTimeZone0.getOffset((ReadableInstant) mutableDateTime0);
      assertEquals("-00:00:01.420", dateTimeZone0.getID());
  ...
  public void test018()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHours(1);
      int int0 = dateTimeZone0.getOffset(32549L);
      assertEquals(3600000, int0);
      assertEquals("+01:00", dateTimeZone0.getID());
  }
  ...
  public void test019()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-75837680));
      int int0 = dateTimeZone0.getOffset((long) (-75837680));
      assertEquals((-75837680), int0);
      assertEquals("-21:03:57.680", dateTimeZone0.toString());
  }
  ...
  public void test020()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetHours(1);
      dateTimeZone0.getNameKey((-1067L));
  ...
  public void test021()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      String string0 = fixedDateTimeZone0.getNameKey(100000000000000000L);
  ...
  public void test022()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-1420));
      long long0 = fixedDateTimeZone0.getMillisKeepLocal(dateTimeZone0, (-1420));
      assertEquals(0L, long0);
      assertEquals("-00:00:01.420", dateTimeZone0.toString());
  }
  ...
  public void test023()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.getMillisKeepLocal(dateTimeZone0, (-288L));
  ...
  public void test029()  throws Throwable  {
      BuddhistChronology buddhistChronology0 = BuddhistChronology.getInstanceUTC();
      DateTimeZone dateTimeZone0 = buddhistChronology0.getZone();
      long long0 = dateTimeZone0.convertLocalToUTC(0L, true, 2267L);
      assertEquals(0L, long0);
  }
  ...
  public void test031()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-1420));
      long long0 = dateTimeZone0.convertLocalToUTC((long) (-1420), true);
      assertEquals(0L, long0);
      assertEquals("-00:00:01.420", dateTimeZone0.toString());
  }
  ...
  public void test032()  throws Throwable  {
      FixedDateTimeZone fixedDateTimeZone0 = (FixedDateTimeZone)DateTimeZone.UTC;
      long long0 = fixedDateTimeZone0.convertLocalToUTC((long) 4, false);
  ...
  public void test036()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dateTimeZone0.convertLocalToUTC((-9223372036833175820L), true, 1L);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal instant due to time zone offset transition (daylight savings time 'gap'): -292275055-05-16T22:47:04.180 (America/Anchorage)
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test045()  throws Throwable  {
      // Undeclared exception!
      try { 
        DateTimeZone.forID("~\\yV'");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The datetime zone id '~\\yV'' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test047()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-250), "Africa/Cairo");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
  ...
  public void test049()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-797), "America/Indiana/Indianapolis");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
      // Undeclared exception!
      try { 
  ...
  public void test051()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forOffsetMillis((-75837680));
      DateMidnight dateMidnight0 = new DateMidnight((-1378L), dateTimeZone0);
      LocalDate localDate0 = dateMidnight0.toLocalDate();
      DateTime dateTime0 = localDate0.toDateTimeAtStartOfDay(dateTimeZone0);
      assertEquals((-10562320L), dateMidnight0.getMillis());
      assertEquals("-21:03:57.680", dateTimeZone0.getID());
      assertEquals((-10562320L), dateTime0.getMillis());
  }
  ...
  public void test053()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dateTimeZone0.convertLocalToUTC((-9223372036833175810L), true);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal instant due to time zone offset transition (daylight savings time 'gap'): -292275055-05-16T22:47:04.190 (America/Anchorage)
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test054()  throws Throwable  {
      DateTimeZone dateTimeZone0 = DateTimeZone.forID("America/Anchorage");
      long long0 = dateTimeZone0.convertLocalToUTC((-9223372036854775773L), false, (-9223372036854775773L));
      assertEquals((-9223372036825975773L), long0);
  }
  ...
  public void test057()  throws Throwable  {
      ...
      long long0 = dateTimeZone0.convertUTCToLocal(1958L);
      assertEquals((-82798042L), long0);
      assertEquals("-23:00", dateTimeZone0.toString());
  }

  @Test(timeout = 4000)
  public void test058()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1983241729), "SST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
      int int0 = dateTimeZone0.getOffsetFromLocal(9223372036854765828L);
  ...
  public void test059()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-250), "Africa/Cairo");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
      int int0 = dateTimeZone0.getOffsetFromLocal((-250));
  ...
  public void test060()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-18000000), "WET");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
      int int0 = dateTimeZone0.getOffsetFromLocal((-3882L));
      assertEquals(0, int0);
  }
  ...
  public void test065()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1, "America/Indiana/Indianapolis");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
  ...
  public void test067()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "HST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
  ...
  public void test078()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The datetime zone id '-00:00:00.227' is not recognised
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test082()  throws Throwable  {
      // Undeclared exception!
      try { 
        DateTimeZone.forOffsetMillis((-1096148250));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Millis out of range: -1096148250
         //
         verifyException("org.joda.time.DateTimeZone", e);
      }
  }
  ...
  public void test084()  throws Throwable  {
      try { 
        DateTimeZone.forOffsetHoursMinutes(23, 2506);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test092()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        LocalDate.parse("Q<QcTZo%-S");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid format: \"Q<QcTZo%-S\"
         //
         verifyException("org.joda.time.format.DateTimeFormatter", e);
      }
  }
  ...
  public void test096()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-3404), "HST");
      DateTimeZone dateTimeZone0 = DateTimeZone.forTimeZone(simpleTimeZone0);
      TimeZone timeZone0 = dateTimeZone0.toTimeZone();
  ...
  public void test102()  throws Throwable  {
      ...
      String string0 = dateTimeZone0.getShortName(128L);
      assertEquals("+00:00", string0);
      assertNotNull(string0);
      assertEquals("Etc/UTC", dateTimeZone0.getID());
  }
