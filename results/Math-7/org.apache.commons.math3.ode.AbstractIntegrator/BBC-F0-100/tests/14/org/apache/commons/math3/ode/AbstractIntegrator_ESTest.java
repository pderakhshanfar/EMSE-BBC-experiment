...
public class AbstractIntegrator_ESTest extends AbstractIntegrator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      DormandPrince853Integrator dormandPrince853Integrator0 = new DormandPrince853Integrator(110.8372, 1474.125218189, doubleArray0, doubleArray0);
      SecondOrderDifferentialEquations secondOrderDifferentialEquations0 = mock(SecondOrderDifferentialEquations.class, new ViolatedAssumptionAnswer());
      doReturn(0).when(secondOrderDifferentialEquations0).getDimension();
      FirstOrderConverter firstOrderConverter0 = new FirstOrderConverter(secondOrderDifferentialEquations0);
      double[] doubleArray1 = new double[9];
      try { 
        dormandPrince853Integrator0.integrate((FirstOrderDifferentialEquations) firstOrderConverter0, 1474.125218189, doubleArray1, 161.06, doubleArray0);
  ...
  public void test02()  throws Throwable  {
      AdamsMoultonIntegrator adamsMoultonIntegrator0 = new AdamsMoultonIntegrator(5, 1474.125218189, 1.92909364037955E-9, 0.0, 1.92909364037955E-9);
      SecondOrderDifferentialEquations secondOrderDifferentialEquations0 = mock(SecondOrderDifferentialEquations.class, new ViolatedAssumptionAnswer());
      doReturn(0).when(secondOrderDifferentialEquations0).getDimension();
      FirstOrderConverter firstOrderConverter0 = new FirstOrderConverter(secondOrderDifferentialEquations0);
      ...
      try { 
        adamsMoultonIntegrator0.integrate(expandableStatefulODE0, 1.92909364037955E-9);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test06()  throws Throwable  {
      ...
      threeEighthesIntegrator0.addEventHandler(eventHandler0, 1603.956215624767, 1603.956215624767, (-1225), (UnivariateSolver) riddersSolver0);
  ...
  public void test09()  throws Throwable  {
      ...
      GraggBulirschStoerIntegrator graggBulirschStoerIntegrator0 = new GraggBulirschStoerIntegrator((-2.0961068531216087E-7), 5, doubleArray0, doubleArray0);
      // Undeclared exception!
      try { 
        graggBulirschStoerIntegrator0.integrate((FirstOrderDifferentialEquations) null, 4.313978872469646E-84, doubleArray0, (-2.0961068531216087E-7), doubleArray0);
  ...
  public void test10()  throws Throwable  {
      GraggBulirschStoerIntegrator graggBulirschStoerIntegrator0 = new GraggBulirschStoerIntegrator(340.9014, 1474.125218189, 340.9014, 340.9014);
      BrentSolver brentSolver0 = new BrentSolver(110.8372, 1474.125218189);
      EventHandler eventHandler0 = mock(EventHandler.class, new ViolatedAssumptionAnswer());
      doReturn(340.9014, 2612.889802216355, 340.9014, (-87.244)).when(eventHandler0).g(anyDouble() , any(double[].class));
      graggBulirschStoerIntegrator0.addEventHandler(eventHandler0, 1474.125218189, (double) 6624, 0, (UnivariateSolver) brentSolver0);
      SecondOrderDifferentialEquations secondOrderDifferentialEquations0 = mock(SecondOrderDifferentialEquations.class, new ViolatedAssumptionAnswer());
      doReturn(0).when(secondOrderDifferentialEquations0).getDimension();
      FirstOrderConverter firstOrderConverter0 = new FirstOrderConverter(secondOrderDifferentialEquations0);
      ExpandableStatefulODE expandableStatefulODE0 = new ExpandableStatefulODE(firstOrderConverter0);
      try { 
        graggBulirschStoerIntegrator0.integrate(expandableStatefulODE0, 7.667647949477605E-53);
  ...
  public void test12()  throws Throwable  {
      GraggBulirschStoerIntegrator graggBulirschStoerIntegrator0 = new GraggBulirschStoerIntegrator(340.9014, 1474.125218189, 340.9014, 340.9014);
      EventHandler eventHandler0 = mock(EventHandler.class, new ViolatedAssumptionAnswer());
      doReturn(1000.0, 1227.643183, 1227.643183, (-1525.146595294), 1000.0).when(eventHandler0).g(anyDouble() , any(double[].class));
      BrentSolver brentSolver0 = new BrentSolver(1474.125218189, 4.547473508864641E-10);
      graggBulirschStoerIntegrator0.addEventHandler(eventHandler0, (double) 6624, 1474.125218189, 1918, (UnivariateSolver) brentSolver0);
      SecondOrderDifferentialEquations secondOrderDifferentialEquations0 = mock(SecondOrderDifferentialEquations.class, new ViolatedAssumptionAnswer());
      doReturn(0).when(secondOrderDifferentialEquations0).getDimension();
      FirstOrderConverter firstOrderConverter0 = new FirstOrderConverter(secondOrderDifferentialEquations0);
      ExpandableStatefulODE expandableStatefulODE0 = new ExpandableStatefulODE(firstOrderConverter0);
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        gillIntegrator0.integrate((ExpandableStatefulODE) null, 3.323458344853057E-8);
        fail("Expecting exception: NullPointerException");
  ...
  public void test15()  throws Throwable  {
      ...
      doReturn(1).when(secondOrderDifferentialEquations0).getDimension();
      FirstOrderConverter firstOrderConverter0 = new FirstOrderConverter(secondOrderDifferentialEquations0);
      double double0 = graggBulirschStoerIntegrator0.integrate((FirstOrderDifferentialEquations) firstOrderConverter0, 0.0, doubleArray0, 110.8372, doubleArray0);
      assertEquals(110.8372, double0, 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      FirstOrderConverter firstOrderConverter0 = new FirstOrderConverter(secondOrderDifferentialEquations0);
      ExpandableStatefulODE expandableStatefulODE0 = new ExpandableStatefulODE(firstOrderConverter0);
      expandableStatefulODE0.setTime(1.364171028137207);
      // Undeclared exception!
      try { 
        adamsMoultonIntegrator0.integrate(expandableStatefulODE0, (double) 5);
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      ...
      BrentSolver brentSolver0 = new BrentSolver(340.9014, 1474.125218189);
      graggBulirschStoerIntegrator0.addEventHandler(eventHandler0, 340.9014, 1474.125218189, 6624, (UnivariateSolver) brentSolver0);
      SecondOrderDifferentialEquations secondOrderDifferentialEquations0 = mock(SecondOrderDifferentialEquations.class, new ViolatedAssumptionAnswer());
      doReturn(5).when(secondOrderDifferentialEquations0).getDimension();
      FirstOrderConverter firstOrderConverter0 = new FirstOrderConverter(secondOrderDifferentialEquations0);
      ExpandableStatefulODE expandableStatefulODE0 = new ExpandableStatefulODE(firstOrderConverter0);
      // Undeclared exception!
      graggBulirschStoerIntegrator0.integrate(expandableStatefulODE0, 340.9014);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // illegal state: maximal count (307) exceeded
         //
  ...
  public void test22()  throws Throwable  {
      ...
      DormandPrince54Integrator dormandPrince54Integrator0 = new DormandPrince54Integrator((-888.8041568986749), 1.0, doubleArray0, doubleArray0);
  ...
  public void test26()  throws Throwable  {
      EulerIntegrator eulerIntegrator0 = new EulerIntegrator((-1448.3049968115));
