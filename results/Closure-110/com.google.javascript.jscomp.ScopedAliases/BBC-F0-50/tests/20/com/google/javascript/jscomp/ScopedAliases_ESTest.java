...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString(2740, "", 77, 77);
      Node node1 = new Node(0, node0, node0, (-2245), 0);
  ...
  public void test4()  throws Throwable  {
      Node node0 = Node.newString((-1640531527), "^L", 0, 2147483645);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
  ...
  public void test5()  throws Throwable  {
      Logger logger0 = Logger.getLogger("charAt");
      LoggerErrorManager loggerErrorManager0 = new LoggerErrorManager(logger0);
      Compiler compiler0 = new Compiler(loggerErrorManager0);
      SyntheticAst syntheticAst0 = new SyntheticAst("charAt");
  ...
  public void test6()  throws Throwable  {
      ...
      Node node1 = new Node(37, node0, node0, 221, 38);
      scopedAliases0.process(node0, node0);
