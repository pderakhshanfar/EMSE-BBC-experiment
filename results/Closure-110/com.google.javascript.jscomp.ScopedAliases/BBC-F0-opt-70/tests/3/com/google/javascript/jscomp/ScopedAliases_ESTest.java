...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      MockPrintStream mockPrintStream0 = new MockPrintStream(" _0(\"o^Vx~e");
  ...
  public void test3()  throws Throwable  {
      File file0 = MockFile.createTempFile("actual parameter %d of %s does not match formal parameter", "actual parameter %d of %s does not match formal parameter", (File) null);
