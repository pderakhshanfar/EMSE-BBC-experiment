...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString((-1599), "Lr/`%g_-1Q3", 1707, (-1599));
      Node node1 = compiler0.parseSyntheticCode("(new Boolean(true))", "// Input %num%");
  ...
  public void test5()  throws Throwable  {
      ...
      Node node1 = new Node(2147483645, node0, node0, node0, node0, 49, 48);
