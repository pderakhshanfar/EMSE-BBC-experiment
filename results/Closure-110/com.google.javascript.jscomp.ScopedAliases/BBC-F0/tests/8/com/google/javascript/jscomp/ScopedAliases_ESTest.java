...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      Node node0 = new Node((-3151), (-3151), (-3151));
      Node node1 = Node.newString(37, "ImpnPXs8LYoaXw{h[o?", 4095, 2);
  ...
  public void test4()  throws Throwable  {
      ...
      Node node0 = Node.newString("P6Xo,2pDh8", 104, 301);
      nodeArray0[0] = node0;
      Node node1 = new Node(104, nodeArray0, 29, 0);
  ...
  public void test5()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = new Node((-3738), (-3738), (-3738));
