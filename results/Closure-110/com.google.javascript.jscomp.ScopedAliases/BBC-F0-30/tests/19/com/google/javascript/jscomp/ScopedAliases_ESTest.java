...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      MockPrintStream mockPrintStream0 = new MockPrintStream("Missing @extends tag on type {0}");
  ...
  public void test3()  throws Throwable  {
      Node node0 = Node.newString("The {all to googscope must be alone;in a single statement.");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
  ...
  public void test4()  throws Throwable  {
      ...
      Node node1 = new Node(37, node0, 2147483645, 4);
