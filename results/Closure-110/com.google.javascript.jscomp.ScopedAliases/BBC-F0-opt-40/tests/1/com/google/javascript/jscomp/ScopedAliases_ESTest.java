...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString("65'_OpyXN<DA1hA");
      Node node1 = new Node(0, node0, node0, 8232, 42);
  ...
  public void test5()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseTestCode("348<");
      CompilerOptions.AliasTransformationHandler compilerOptions_AliasTransformationHandler0 = CompilerOptions.NULL_ALIAS_TRANSFORMATION_HANDLER;
      Node node1 = new Node(37, node0, node0, node0, node0, 56, 1355);
  ...
  public void test6()  throws Throwable  {
      File file0 = MockFile.createTempFile("zVU=3T0LfR~tAU", "zVU=3T0LfR~tAU");
