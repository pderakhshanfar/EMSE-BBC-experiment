...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(0.0, (-2172), (-1313));
  ...
  public void test5()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("(JE/M");
      Node node1 = new Node(0, node0, node0, node0, node0, 2363, 53);
  ...
  public void test6()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("(JE/M");
      Node node1 = new Node(37, node0, node0, node0, node0, 1918, 38);
