...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString("", (-581), (-3));
      ...
      Node node1 = new Node(57, node0, node0, 55, 51);
  ...
  public void test1()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(2, "<im??!{NJ$u%A<7(3B@", 2, 2);
  ...
  public void test2()  throws Throwable  {
      ...
      Node node0 = Node.newString((-926), "{0} @extends non-object type {1}", (-926), 185);
      // Undeclared exception!
      try { 
  ...
  public void test7()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = new Node(1534, 1534, 1534);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
