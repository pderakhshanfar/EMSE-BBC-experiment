...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString("=psNg*5cWIMVXZ@^");
      Node node1 = Normalize.parseAndNormalizeTestCode(compiler0, "The body of a goog.scope function cannot use 'return'.");
  ...
  public void test5()  throws Throwable  {
      ...
      ScopedAliases scopedAliases0 = new ScopedAliases(compiler0, preprocessorSymbolTable0, compilerOptions_AliasTransformationHandler0);
      Node node1 = new Node(2, node0, node0, node0, 4095, 46);
      scopedAliases0.process(node0, node0);
  ...
  public void test6()  throws Throwable  {
      ...
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      ScopedAliases scopedAliases0 = new ScopedAliases(compiler0, preprocessorSymbolTable0, compilerOptions_AliasTransformationHandler0);
      Node node1 = new Node(37, node0, node0, node0, 1, 38);
