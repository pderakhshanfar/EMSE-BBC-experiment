...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(2875.210234764);
      Node node1 = new Node(1310, node0, 16, 38);
  ...
  public void test4()  throws Throwable  {
      MockPrintStream mockPrintStream0 = new MockPrintStream("identifiers ending in '__' cannot be used in Caja");
      ...
      ScopedAliases scopedAliases0 = new ScopedAliases(compiler0, (PreprocessorSymbolTable) null, compilerOptions_AliasTransformationHandler0);
      Node node0 = Node.newNumber((double) 1310);
      Node node1 = new Node(37, node0, (-2021), 4096);
