...
public class ScopedAliases_ESTest extends ScopedAliases_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      CompilerOptions.AliasTransformationHandler compilerOptions_AliasTransformationHandler0 = CompilerOptions.NULL_ALIAS_TRANSFORMATION_HANDLER;
      Node node0 = Node.newNumber(0.0, (-1179), (-58));
  ...
  public void test4()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseSyntheticCode("uLF?Io;", "JSC_INVALID_NO_SIDE_EFFECT_ANNOTATION");
      Node node1 = new Node(37, 2147483645, 8);
      Node node2 = new Node(1572, node0, node1, node1, node1, 8, (-2147483645));
  ...
  public void test5()  throws Throwable  {
      ...
      Node node1 = new Node(48, node0, 177, 2147483645);
  ...
  public void test7()  throws Throwable  {
      ...
      LoggerErrorManager loggerErrorManager0 = new LoggerErrorManager(logger0);
      Compiler compiler0 = new Compiler(loggerErrorManager0);
      Node node0 = compiler0.parseSyntheticCode(",@/(P", "mO");
      Node node1 = new Node(37, node0, node0, node0, node0, (-1535), 29);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
