...
public class PhoneticEngine_ESTest extends PhoneticEngine_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        phoneticEngine0 = new PhoneticEngine(nameType0, ruleType0, false, 1227);
  ...
  public void test3()  throws Throwable  {
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>(125);
      linkedHashSet0.add("&)T8$%H!g?E=JrlR$");
  ...
  public void test4()  throws Throwable  {
      ...
      CharBuffer charBuffer0 = CharBuffer.allocate(2332);
      Rule.Phoneme rule_Phoneme0 = new Rule.Phoneme(charBuffer0, (Languages.LanguageSet) null);
      // Undeclared exception!
      try { 
        phoneticEngine_PhonemeBuilder0.apply(rule_Phoneme0, 2332);
