...
public class PhoneticEngine_ESTest extends PhoneticEngine_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      PhoneticEngine phoneticEngine0 = null;
      try {
        phoneticEngine0 = new PhoneticEngine(nameType0, ruleType0, true, 4152);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test4()  throws Throwable  {
      ...
      try { 
        phoneticEngine_PhonemeBuilder0.apply(rule_Phoneme0, 1664);
        fail("Expecting exception: NoClassDefFoundError");
