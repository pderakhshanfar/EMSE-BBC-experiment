...
public class PhoneticEngine_ESTest extends PhoneticEngine_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      PhoneticEngine phoneticEngine0 = null;
      try {
        phoneticEngine0 = new PhoneticEngine(nameType0, ruleType0, false, (-645));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test4()  throws Throwable  {
      ...
      linkedHashSet0.add("4+)76Bq]YG[dFcuCs");
      ...
      Rule.Phoneme rule_Phoneme0 = new Rule.Phoneme("4+)76Bq]YG[dFcuCs", languages_LanguageSet0);
      // Undeclared exception!
      try { 
        phoneticEngine_PhonemeBuilder0.apply(rule_Phoneme0, 555);
        fail("Expecting exception: NoClassDefFoundError");
