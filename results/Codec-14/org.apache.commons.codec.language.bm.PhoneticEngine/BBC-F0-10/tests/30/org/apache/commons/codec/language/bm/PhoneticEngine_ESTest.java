...
public class PhoneticEngine_ESTest extends PhoneticEngine_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        phoneticEngine0 = new PhoneticEngine(nameType0, ruleType0, true, 662);
  ...
  public void test2()  throws Throwable  {
      ...
      PhoneticEngine phoneticEngine0 = null;
      try {
        phoneticEngine0 = new PhoneticEngine(nameType0, ruleType0, true, (-1385));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test4()  throws Throwable  {
      ...
      linkedHashSet0.add("<(zhIG{C1oGNO");
      ...
      try { 
        phoneticEngine_PhonemeBuilder0.apply(rule_Phoneme0, 525);
        fail("Expecting exception: NoClassDefFoundError");
