...
public class PhoneticEngine_ESTest extends PhoneticEngine_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        phoneticEngine0 = new PhoneticEngine(nameType0, ruleType0, true, (-575));
  ...
  public void test1()  throws Throwable  {
      ...
      PhoneticEngine phoneticEngine0 = null;
      try {
        phoneticEngine0 = new PhoneticEngine(nameType0, ruleType0, true, (-887));
  ...
  public void test4()  throws Throwable  {
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
      linkedHashSet0.add("b)(bM{Ypz1b*~M>`KL-");
      Languages.LanguageSet languages_LanguageSet0 = Languages.LanguageSet.from(linkedHashSet0);
      PhoneticEngine.PhonemeBuilder phoneticEngine_PhonemeBuilder0 = PhoneticEngine.PhonemeBuilder.empty(languages_LanguageSet0);
      Rule.Phoneme rule_Phoneme0 = new Rule.Phoneme("b)(bM{Ypz1b*~M>`KL-", languages_LanguageSet0);
      // Undeclared exception!
      try { 
        phoneticEngine_PhonemeBuilder0.apply(rule_Phoneme0, 1321);
        fail("Expecting exception: NoClassDefFoundError");
  ...
  public void test6()  throws Throwable  {
      ...
      Languages.LanguageSet languages_LanguageSet0 = Languages.LanguageSet.from(linkedHashSet0);
      PhoneticEngine.PhonemeBuilder phoneticEngine_PhonemeBuilder0 = PhoneticEngine.PhonemeBuilder.empty(languages_LanguageSet0);
      phoneticEngine_PhonemeBuilder0.append(",.9PxP>#$:E");
  }
