...
public class PhoneticEngine_ESTest extends PhoneticEngine_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      PhoneticEngine phoneticEngine0 = null;
      try {
        phoneticEngine0 = new PhoneticEngine(nameType0, ruleType0, false, (-1955));
        fail("Expecting exception: NoClassDefFoundError");
  ...
  public void test4()  throws Throwable  {
      ...
      Rule.Phoneme rule_Phoneme0 = new Rule.Phoneme("`m6cD", languages_LanguageSet0);
      linkedList0.add(rule_Phoneme0);
      // Undeclared exception!
      try { 
        phoneticEngine_PhonemeBuilder0.apply(rule_PhonemeList0, 974);
        fail("Expecting exception: NoClassDefFoundError");
