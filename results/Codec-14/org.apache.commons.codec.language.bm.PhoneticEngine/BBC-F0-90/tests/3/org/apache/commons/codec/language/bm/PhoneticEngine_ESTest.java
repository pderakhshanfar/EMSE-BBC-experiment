...
public class PhoneticEngine_ESTest extends PhoneticEngine_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        phoneticEngine0 = new PhoneticEngine(nameType0, ruleType0, true, 1323);
  ...
  public void test1()  throws Throwable  {
      ...
      PhoneticEngine phoneticEngine0 = null;
      try {
        phoneticEngine0 = new PhoneticEngine(nameType0, ruleType0, true, (-3028));
  ...
  public void test4()  throws Throwable  {
      ...
      linkedHashSet0.add("finalRules can not be null");
      ...
      Rule.Phoneme rule_Phoneme0 = new Rule.Phoneme("-d!+u'Crh", languages_LanguageSet0);
      // Undeclared exception!
      try { 
        phoneticEngine_PhonemeBuilder0.apply(rule_Phoneme0, 742);
        fail("Expecting exception: NoClassDefFoundError");
  ...
  public void test5()  throws Throwable  {
      ...
      phoneticEngine_PhonemeBuilder0.apply(rule_PhonemeList0, 2174);
  }

  @Test(timeout = 4000)
  public void test6()  throws Throwable  {
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
      linkedHashSet0.add(",|U~sr#4Hz");
      Languages.LanguageSet languages_LanguageSet0 = Languages.LanguageSet.from(linkedHashSet0);
      PhoneticEngine.PhonemeBuilder phoneticEngine_PhonemeBuilder0 = PhoneticEngine.PhonemeBuilder.empty(languages_LanguageSet0);
      phoneticEngine_PhonemeBuilder0.append(",|U~sr#4Hz");
  }
