...
public class JsonReader_ESTest extends JsonReader_ESTest_scaffolding {
  ...
  public void test008()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Z\"r#A");
      assertNotNull(stringReader0);
  ...
  public void test011()  throws Throwable  {
      StringReader stringReader0 = new StringReader("'%A'y5;rmSa{e#");
      assertNotNull(stringReader0);
  ...
  public void test057()  throws Throwable  {
      StringReader stringReader0 = new StringReader("!ce9Vhg02,xup^<f$fD");
      assertNotNull(stringReader0);
  ...
  public void test059()  throws Throwable  {
      StringReader stringReader0 = new StringReader("7NGH]?\"");
      assertNotNull(stringReader0);
  ...
  public void test088()  throws Throwable  {
      StringReader stringReader0 = new StringReader("5E]`,0+*e:");
      assertNotNull(stringReader0);
  ...
  public void test089()  throws Throwable  {
      StringReader stringReader0 = new StringReader("eQ=%L8YK!Qx");
      assertNotNull(stringReader0);
  ...
  public void test090()  throws Throwable  {
      StringReader stringReader0 = new StringReader("|?t*vX;kYKDC'= )");
      assertNotNull(stringReader0);
  ...
  public void test096()  throws Throwable  {
      StringReader stringReader0 = new StringReader("\"q5DeK%\"L>0S-qm#u");
      assertNotNull(stringReader0);
  ...
  public void test099()  throws Throwable  {
      StringReader stringReader0 = new StringReader("XX>C=I<OjF2!)-JA");
      assertNotNull(stringReader0);
  ...
  public void test105()  throws Throwable  {
      ...
      int int0 = stringReader0.read(charArray0);
      assertArrayEquals(new char[] {'7', 'N', 'G', 'H', ']', '?'}, charArray0);
  ...
  public void test133()  throws Throwable  {
      StringReader stringReader0 = new StringReader("9;a;A*");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.beginObject();
        fail("Expecting exception: IOException");
  ...
  public void test134()  throws Throwable  {
      StringReader stringReader0 = new StringReader("0:C|?MAej]V!1}o");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      JsonToken jsonToken0 = jsonReader0.peek();
  ...
  public void test136()  throws Throwable  {
      StringReader stringReader0 = new StringReader("25E#-3");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.nextDouble();
        fail("Expecting exception: IOException");
  ...
  public void test140()  throws Throwable  {
      StringReader stringReader0 = new StringReader("6.TRE");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.nextBoolean();
        fail("Expecting exception: IOException");
  ...
  public void test150()  throws Throwable  {
      StringReader stringReader0 = new StringReader(",dff");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.nextString();
        fail("Expecting exception: IOException");
  ...
  public void test155()  throws Throwable  {
      StringReader stringReader0 = new StringReader("WM<Y+{Es:Ht");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      try { 
  ...
  public void test168()  throws Throwable  {
      StringReader stringReader0 = new StringReader("C3JE");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.peeked = 2;
      boolean boolean0 = jsonReader0.hasNext();
      assertFalse(jsonReader0.isLenient());
