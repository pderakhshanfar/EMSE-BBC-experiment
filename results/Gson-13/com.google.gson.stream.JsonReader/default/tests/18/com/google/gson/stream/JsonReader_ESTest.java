...
public class JsonReader_ESTest extends JsonReader_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      StringReader stringReader0 = new StringReader(".p+Q2");
  ...
  public void test056()  throws Throwable  {
      StringReader stringReader0 = new StringReader("0+N`HEjO 3c");
      assertNotNull(stringReader0);
  ...
  public void test063()  throws Throwable  {
      StringReader stringReader0 = new StringReader("#1>c]hN~f4El5");
      assertNotNull(stringReader0);
  ...
  public void test066()  throws Throwable  {
      StringReader stringReader0 = new StringReader("1bC/3dn@E~}/TE");
      assertNotNull(stringReader0);
  ...
  public void test074()  throws Throwable  {
      StringReader stringReader0 = new StringReader(")i3VGhNWZ");
      assertNotNull(stringReader0);
  ...
  public void test082()  throws Throwable  {
      StringReader stringReader0 = new StringReader("4E91");
      assertNotNull(stringReader0);
      ...
      try { 
        ...
        fail("Expecting exception: NumberFormatException");
         ...
         //
         // Expected an int but was 4E91 at line 1 column 5 path $
         //
         verifyException("com.google.gson.stream.JsonReader", e);
      }
  }
  ...
  public void test088()  throws Throwable  {
      StringReader stringReader0 = new StringReader("CdPNr}pVWU/d");
      assertNotNull(stringReader0);
  ...
  public void test089()  throws Throwable  {
      StringReader stringReader0 = new StringReader("J3e^2RT{Jco");
      assertNotNull(stringReader0);
  ...
  public void test102()  throws Throwable  {
      StringReader stringReader0 = new StringReader("~m9#AR>dP8UWmkh");
      assertNotNull(stringReader0);
  ...
  public void test126()  throws Throwable  {
      StringReader stringReader0 = new StringReader("5;+Z$SK0/BN");
      assertNotNull(stringReader0);
  ...
  public void test129()  throws Throwable  {
      StringReader stringReader0 = new StringReader("4#2E1");
      assertNotNull(stringReader0);
  ...
  public void test133()  throws Throwable  {
      StringReader stringReader0 = new StringReader("1e-4NI9;9bbu)4VN~");
      assertNotNull(stringReader0);
  ...
  public void test134()  throws Throwable  {
      StringReader stringReader0 = new StringReader("+}kgN?V%H1/'F$H~,,");
      assertNotNull(stringReader0);
  ...
  public void test145()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{v8@d.Vg0uA;ZZ");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      try { 
        jsonReader0.skipValue();
  ...
  public void test146()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{I4usFg(&");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      try { 
        jsonReader0.skipValue();
  ...
  public void test148()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{t^=Ye");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.skipValue();
        fail("Expecting exception: IOException");
  ...
  public void test149()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[X]~=dsV");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      assertTrue(jsonReader0.isLenient());
  ...
  public void test150()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[X:wT=N( :]f=dsV");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      try { 
        jsonReader0.skipValue();
  ...
  public void test151()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[,=NB]~^dsV");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      try { 
        jsonReader0.skipValue();
  ...
  public void test169()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{}SyI'9");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.beginObject();
      jsonReader0.peeked = 4;
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Expected a double but was END_ARRAY at line 1 column 2 path $.
         //
         verifyException("com.google.gson.stream.JsonReader", e);
      }
  }
