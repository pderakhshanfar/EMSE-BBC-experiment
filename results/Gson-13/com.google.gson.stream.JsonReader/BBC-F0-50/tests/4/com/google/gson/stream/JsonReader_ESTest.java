...
public class JsonReader_ESTest extends JsonReader_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[+Tmrmyw[");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.beginArray();
      jsonReader0.peeked = 14;
      String string0 = jsonReader0.nextName();
      assertEquals("+Tmrmyw", string0);
  }
  ...
  public void test008()  throws Throwable  {
      StringReader stringReader0 = new StringReader(";)RZJ0:s,S!,'5");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test009()  throws Throwable  {
      StringReader stringReader0 = new StringReader("33(dskl7N");
      stringReader0.skip(3004L);
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.peeked = 14;
      String string0 = jsonReader0.nextName();
  ...
  public void test010()  throws Throwable  {
      StringReader stringReader0 = new StringReader("4e-1");
  ...
  public void test027()  throws Throwable  {
      StringReader stringReader0 = new StringReader("3{9CY");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      // Undeclared exception!
  ...
  public void test066()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{|Mmd*^;q_^t");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.beginObject();
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
  ...
  public void test084()  throws Throwable  {
      StringReader stringReader0 = new StringReader("XWl8:1hg_bjjXw");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      assertTrue(jsonReader0.isLenient());
  ...
  public void test085()  throws Throwable  {
      StringReader stringReader0 = new StringReader(".JN&#oLXf5_");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      assertTrue(jsonReader0.isLenient());
  ...
  public void test098()  throws Throwable  {
      StringReader stringReader0 = new StringReader("p13,V");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      // Undeclared exception!
      try { 
  ...
  public void test108()  throws Throwable  {
      StringReader stringReader0 = new StringReader("|33dskl7N");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test113()  throws Throwable  {
      StringReader stringReader0 = new StringReader("M\"v]_`3(");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.peeked = 9;
      // Undeclared exception!
      try { 
  ...
  public void test121()  throws Throwable  {
      StringReader stringReader0 = new StringReader("auVr>}4jT&fpY");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      assertFalse(jsonReader0.isLenient());
      
      jsonReader0.setLenient(true);
      String string0 = jsonReader0.nextString();
      assertEquals("auVr>", string0);
  }
  ...
  public void test128()  throws Throwable  {
      StringReader stringReader0 = new StringReader("+;L  3.1m4;*b/QxL#");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      char[] charArray0 = new char[9];
      stringReader0.read(charArray0);
      try { 
  ...
  public void test132()  throws Throwable  {
      StringReader stringReader0 = new StringReader("06lnh#N#3]Cu=|yy>]>");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.skipValue();
        fail("Expecting exception: IOException");
  ...
  public void test138()  throws Throwable  {
      StringReader stringReader0 = new StringReader("-?4b%$16a_q[b_");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.peek();
        fail("Expecting exception: IOException");
  ...
  public void test144()  throws Throwable  {
      StringReader stringReader0 = new StringReader("]Bh+z'rex0");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test150()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{]V`vfQY");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      try { 
        jsonReader0.skipValue();
  ...
  public void test151()  throws Throwable  {
      StringReader stringReader0 = new StringReader("5i<$*Df]:RtK4");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.peeked = 3;
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
  ...
  public void test153()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[A^p?,a%");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      try { 
        jsonReader0.skipValue();
  ...
  public void test171()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{)_VFu?AhA4P!CV|");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.beginObject();
      jsonReader0.peeked = 3;
      try { 
  ...
  public void test174()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{)VFu?hP!V|q");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.peek();
      // Undeclared exception!
      try { 
