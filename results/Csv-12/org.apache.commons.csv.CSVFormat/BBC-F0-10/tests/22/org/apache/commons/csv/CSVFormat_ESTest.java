...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("gO0S1%CZ;6");
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      ...
      assertEquals("gO0S1%CZ;6", cSVFormat2.getRecordSeparator());
  ...
  public void test005()  throws Throwable  {
      ...
      cSVFormat1.withRecordSeparator("kh*$");
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("r#2H7ilrj<6m=!g^FS>");
      ...
      assertFalse(cSVFormat2.isQuoteCharacterSet());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("r#2H7ilrj<6m=!g^FS>", cSVFormat2.getNullString());
  }
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      cSVFormat1.withNullString("0Fhos~b8Q sE*dv");
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
  }
  ...
  public void test028()  throws Throwable  {
      ...
      stringArray0[0] = "f%V2)|fl_z";
      stringArray0[4] = "\n";
      stringArray0[2] = ".r]}c(i?E5Yu}C>\"";
      stringArray0[3] = "L#{9V@ep ^(3q/r";
      stringArray0[1] = "d";
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("L#{9V@ep ^(3q/r");
  ...
  public void test031()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("*wEYLZ&Y5r");
      Character character0 = new Character(')');
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("*wEYLZ&Y5r", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test052()  throws Throwable  {
      ...
      stringArray0[0] = "_VazU";
      stringArray0[1] = "QuoteChar=<";
      stringArray0[2] = "YLMAm~";
      stringArray0[3] = "o^}+H";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
  ...
  public void test076()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "$qH ,ZhrD>ru+v^yA");
      // Undeclared exception!
      try { 
  ...
  public void test085()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("O3{l4:q,-");
      boolean boolean0 = cSVFormat1.isNullStringSet();
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isQuoteCharacterSet());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("O3{l4:q,-", cSVFormat1.getNullString());
      assertTrue(boolean0);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test117()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("vo8d");
      cSVFormat1.hashCode();
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test129()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker('$');
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("x<,S<%NI)p$f%0Z");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(boolean0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test137()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      boolean boolean0 = cSVFormat0.equals("Nm:Sk'__]");
      assertFalse(boolean0);
  }
  ...
  public void test149()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[5];
      stringArray0[0] = "|mNRX/Y";
      stringArray0[1] = "%|BUw}MDyd4.O<7/";
      stringArray0[2] = "`\"2eI+TUK&";
      stringArray0[3] = "-S51Z7.TQLP^zUSkJ$";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
