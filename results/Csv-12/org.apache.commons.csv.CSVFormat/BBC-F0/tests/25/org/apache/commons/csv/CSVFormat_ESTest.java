...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(".H_#!M=~Hs");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(false);
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertEquals(".H_#!M=~Hs", cSVFormat2.getNullString());
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("&wo&cTf=UF");
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat2.isNullStringSet());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      cSVFormat1.withRecordSeparator("C~-##R*&aP");
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test007()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("0lPu&n-`dY0Y,p=");
      ...
      assertEquals("0lPu&n-`dY0Y,p=", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test012()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("LYV\"![B,Pt,k");
      ...
      assertEquals("LYV\"![B,Pt,k", cSVFormat3.getNullString());
  ...
  public void test024()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker('q');
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("'GhE`4%M-}$#");
      assertEquals("'GhE`4%M-}$#", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('q', (char)cSVFormat2.getCommentMarker());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test026()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      cSVFormat1.withNullString("0lPu&n-`dY0Y,p=");
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
  }
  ...
  public void test027()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(".7;|w~");
      ...
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertEquals(".7;|w~", cSVFormat2.getNullString());
  }
  ...
  public void test041()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Tho comment start mark`C character canGot be a lin' break");
      Character character0 = Character.valueOf('e');
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      assertEquals('e', (char)cSVFormat2.getEscapeCharacter());
      assertEquals("Tho comment start mark`C character canGot be a lin' break", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test046()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("'GhE`4%M-}$#");
  ...
  public void test056()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("uMwJ!BN2Z*9B`8E");
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat2.isNullStringSet());
      assertFalse(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test082()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withDelimiter('3');
  ...
  public void test116()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("org.apache.commons.csv.QuoteMode");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<$> NullString=<org.apache.commons.csv.QuoteMode> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertEquals('$', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getAllowMissingColumnNames());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
  ...
  public void test124()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[4];
      stringArray0[0] = "zt{`'O`;''R";
      stringArray0[1] = "cccko`R5PJ&";
  ...
  public void test128()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Tho comment start mark`C character canGot be a lin' break");
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Tho comment start mark`C character canGot be a lin' break");
  ...
  public void test129()  throws Throwable  {
      ...
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals(".7;|w~", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test143()  throws Throwable  {
      ...
      String[] stringArray0 = new String[2];
      stringArray0[0] = "w*qT{#7K/1rE";
      stringArray0[1] = "w*qT{#7K/1rE";
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The header contains a duplicate entry: 'w*qT{#7K/1rE' in [w*qT{#7K/1rE, w*qT{#7K/1rE]
         //
         verifyException("org.apache.commons.csv.CSVFormat", e);
      }
  }
  ...
  public void test148()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Tho comment start mark`C character canGot be a lin' break");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertEquals("Tho comment start mark`C character canGot be a lin' break", cSVFormat1.getNullString());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
  ...
  public void test158()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockPrintStream mockPrintStream0 = new MockPrintStream("YeYI\"[vZXw&:=8_");
