...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ULa0([S}5p9q+s");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(false);
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals("ULa0([S}5p9q+s", cSVFormat2.getNullString());
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("19jK&?{cNC-l.[U.");
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("19jK&?{cNC-l.[U.", cSVFormat2.getNullString());
  }
  ...
  public void test012()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("1-$F3");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("3\"wOEhH#");
      ...
      assertEquals("1-$F3", cSVFormat4.getNullString());
      ...
      assertEquals("3\"wOEhH#", cSVFormat4.getRecordSeparator());
  }
  ...
  public void test017()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("Unexpected Token type: ");
  ...
  public void test024()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("?}Lchs;RtoZd");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(false);
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertTrue(cSVFormat2.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("?}Lchs;RtoZd", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test028()  throws Throwable  {
      ...
      assertEquals('\t', cSVFormat3.getDelimiter());
      assertEquals("1-$F3", cSVFormat3.getNullString());
      assertEquals("3\"wOEhH#", cSVFormat3.getRecordSeparator());
  ...
  public void test033()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("~34OwT3meT'^]");
      CSVFormat cSVFormat2 = cSVFormat1.withHeader((String[]) null);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("~34OwT3meT'^]", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isEscapeCharacterSet());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isQuoteCharacterSet());
  ...
  public void test046()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("w^Y25rm&T.$&TT]");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('d');
      assertEquals("w^Y25rm&T.$&TT]", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test060()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("4KcxT");
  ...
  public void test067()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals("w^Y25rm&T.$&TT]", string0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test084()  throws Throwable  {
      ...
      stringArray0[0] = "e]Z*R`^,eH/";
      stringArray0[1] = "014kl<C$n!";
      stringArray0[2] = "#RyP*>V&";
  ...
  public void test117()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("w^Y25rm&T.$&TT]");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<w^Y25rm&T.$&TT]> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test119()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('e');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("JmB9:0wO");
  ...
  public void test132()  throws Throwable  {
      ...
      stringArray0[2] = "``uzW>Vk#";
      stringArray0[3] = "/P}~";
      stringArray0[4] = "Gd=b\"`x} SUA5";
      stringArray0[5] = "\r\n";
  ...
  public void test133()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("1nRlCe7wXzEa_$40");
  ...
  public void test152()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("b");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("?Ig$b8b9/S");
