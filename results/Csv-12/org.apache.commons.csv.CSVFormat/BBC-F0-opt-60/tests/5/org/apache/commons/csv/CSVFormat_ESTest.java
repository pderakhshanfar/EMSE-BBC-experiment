...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("h;2v 6=xl");
      assertFalse(cSVFormat2.equals((Object)cSVFormat1));
  ...
  public void test010()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(':');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("R_*Eh");
  ...
  public void test013()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("(>5Dm07");
      CSVFormat cSVFormat2 = cSVFormat1.withQuote(character0);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('[', (char)cSVFormat2.getQuoteCharacter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("(>5Dm07", cSVFormat2.getNullString());
  ...
  public void test023()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(':');
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("R_*Eh");
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.equals((Object)cSVFormat0));
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
  ...
  public void test033()  throws Throwable  {
      ...
      stringArray0[0] = "ZVU=K.757^z0 5:4";
      stringArray0[1] = "$5nb";
      stringArray0[2] = "esNM0";
      stringArray0[3] = "Us%?NUN";
      stringArray0[4] = "charset";
      stringArray0[5] = "'Vr4yC >";
      stringArray0[6] = "9p851f$u\":1lp322+";
      stringArray0[7] = "%";
  ...
  public void test034()  throws Throwable  {
      ...
      assertEquals("(>5Dm07", cSVFormat3.getNullString());
  ...
  public void test058()  throws Throwable  {
      ...
      BufferedOutputStream bufferedOutputStream0 = new BufferedOutputStream(pipedOutputStream0, 92);
  ...
  public void test071()  throws Throwable  {
      ...
      stringArray0[0] = ",xQ'tgl:M|bTlnWw";
      stringArray0[1] = "$";
      stringArray0[2] = "\n";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test089()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.isEscapeCharacterSet());
      assertTrue(boolean0);
      assertEquals("(>5Dm07", cSVFormat1.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isQuoteCharacterSet());
  ...
  public void test092()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withQuote('w');
  ...
  public void test113()  throws Throwable  {
      ...
      stringArray0[0] = "jPc3";
      stringArray0[1] = "8,:9O:ru1~>6E)A\t";
      stringArray0[2] = "\"<.c>3|lVanf-wFu`pF";
      stringArray0[3] = "+U+";
      stringArray0[4] = "The comment start character and the quoteChar cannot be the same ('";
      stringArray0[5] = "";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> RecordSeparator=<\n> SkipHeaderRecord:false Header:[jPc3, 8,:9O:ru1~>6E)A\t, \"<.c>3|lVanf-wFu`pF, +U+, The comment start character and the quoteChar cannot be the same (', , null]", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test116()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("C`BCdJ)t,G");
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<C`BCdJ)t,G> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test119()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("C`BCdJ)t,G", cSVFormat1.getNullString());
  }
  ...
  public void test123()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("vVIy}/p8R{N");
  ...
  public void test126()  throws Throwable  {
      ...
      stringArray0[0] = ";K\"J\"}wq,Jm\"";
      stringArray0[1] = "wgcvI";
      stringArray0[2] = "uBk)Y}`";
  ...
  public void test127()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("vVIy}/p8R{N");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("vVIy}/p8R{N", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.getAllowMissingColumnNames());
  }
