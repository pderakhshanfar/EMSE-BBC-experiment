...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("^6qLFAhGndReF");
      cSVFormat1.hashCode();
  ...
  public void test014()  throws Throwable  {
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("^6qLFAhGndReF", cSVFormat2.getNullString());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
  ...
  public void test022()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Kjauje_+UrEuz");
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("Kjauje_+UrEuz", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test023()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      cSVFormat1.withNullString("rFEnz;OZ4!x%");
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test035()  throws Throwable  {
      ...
      stringArray0[0] = "\n";
      stringArray0[1] = "dC~?i|.ks2',=[#{`]";
      stringArray0[2] = "\r\n";
      stringArray0[3] = " EmptyLines:ignored";
      stringArray0[4] = "Header:";
      stringArray0[5] = "D@>xAg)*m3sP";
      stringArray0[6] = "FWc[eBN";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertFalse(cSVFormat2.isNullStringSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
  ...
  public void test037()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("|~}p\"#6");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      assertEquals("|~}p\"#6", cSVFormat2.getNullString());
  ...
  public void test063()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("org.apache.commons.csv.CSVFormat@0000000002,java.lang.Object@0000000003");
  ...
  public void test115()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString(":e>$J4wS");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> QuoteChar=<\"> NullString=<:e>$J4wS> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test125()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("H,Bg3TP_YQEJ");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
  ...
  public void test126()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(">i6kN\"Q/f");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.isEscapeCharacterSet());
      ...
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(">i6kN\"Q/f", cSVFormat1.getNullString());
  }
  ...
  public void test127()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("H,Bg3TP_YQEJ");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("^6qLFAhGndReF");
      boolean boolean0 = cSVFormat2.equals(cSVFormat1);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("H,Bg3TP_YQEJ", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test141()  throws Throwable  {
      ...
      stringArray0[0] = "%.rSRI,6G-Q";
      stringArray0[1] = "%.rSRI,6G-Q";
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The header contains a duplicate entry: '%.rSRI,6G-Q' in [%.rSRI,6G-Q, %.rSRI,6G-Q]
         //
         verifyException("org.apache.commons.csv.CSVFormat", e);
      }
  }
