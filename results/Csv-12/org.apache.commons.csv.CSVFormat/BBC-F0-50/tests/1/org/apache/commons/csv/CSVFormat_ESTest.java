...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Omw#khia|D@");
      CSVFormat cSVFormat2 = cSVFormat1.withAllowMissingColumnNames(true);
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("Omw#khia|D@");
      assertEquals("Omw#khia|D@", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker('5');
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("\"3>uAb.vM");
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals('5', (char)cSVFormat2.getCommentMarker());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals("\"3>uAb.vM", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test035()  throws Throwable  {
      ...
      stringArray0[0] = "Zjo0vlPmmE";
      stringArray0[1] = "7hkiS'Pb*I(9N+w";
      stringArray0[2] = "The escape character cannot be a line break";
      stringArray0[3] = "yaKr+(R55M#]x='{h";
      stringArray0[4] = "x";
      stringArray0[5] = "oLg'<";
  ...
  public void test037()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("v9JvCyqS't\"#z>7");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape((Character) null);
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("v9JvCyqS't\"#z>7", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
  }
  ...
  public void test055()  throws Throwable  {
      ...
      assertTrue(cSVFormat2.getAllowMissingColumnNames());
      assertEquals("Omw#khia|D@", cSVFormat3.getNullString());
  }
  ...
  public void test066()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ijb_,`\u0003(pw`+0");
      ...
      assertEquals("ijb_,`\u0003(pw`+0", string0);
      assertEquals(',', cSVFormat1.getDelimiter());
  }
  ...
  public void test116()  throws Throwable  {
      ...
      assertFalse(cSVFormat0.getAllowMissingColumnNames());
      assertEquals("Delimiter=<R> NullString=<NON_NUMERIC> SkipHeaderRecord:false", string0);
  }
  ...
  public void test118()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(".$\"meq4J,QFTg@");
      boolean boolean0 = cSVFormat1.isNullStringSet();
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals(".$\"meq4J,QFTg@", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(boolean0);
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test119()  throws Throwable  {
      ...
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat0.getAllowMissingColumnNames());
      assertEquals("Delimiter=<R> CommentStart=<K> SkipHeaderRecord:false", string0);
  }
  ...
  public void test122()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(".%imeq4JDTg@");
      cSVFormat1.hashCode();
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isQuoteCharacterSet());
      assertEquals(".%imeq4JDTg@", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test131()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals(".$\"meq4J,QFTg@", cSVFormat2.getNullString());
