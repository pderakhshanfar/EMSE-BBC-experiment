...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("n(@ek+v$m");
      ...
      assertEquals("n(@ek+v$m", cSVFormat3.getNullString());
  ...
  public void test013()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("_G6zrcQN");
      Character character0 = new Character('M');
      CSVFormat cSVFormat2 = cSVFormat1.withQuote(character0);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals('M', (char)cSVFormat2.getQuoteCharacter());
      assertEquals("_G6zrcQN", cSVFormat2.getNullString());
  ...
  public void test018()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("CgImh=G34YbG!'kM");
      CSVFormat cSVFormat2 = cSVFormat1.withQuote('F');
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals('F', (char)cSVFormat2.getQuoteCharacter());
      assertEquals("CgImh=G34YbG!'kM", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test028()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("xZ[}n");
  ...
  public void test030()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("n(@ek+v$m");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("n(@ek+v$m", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test031()  throws Throwable  {
      ...
      stringArray0[1] = "uE";
      stringArray0[2] = "*+";
      stringArray0[3] = "<WM?h8zw";
      stringArray0[4] = "jDq^St\"1";
  ...
  public void test034()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("C@2>L5");
  ...
  public void test038()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Vdga]");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('g');
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("Vdga]", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test078()  throws Throwable  {
      ...
      stringArray0[1] = "dGp+`BVSD&";
      stringArray0[2] = "";
      stringArray0[3] = "a'T*f\"wnv|]";
      stringArray0[4] = "i2N(@!d/gYQz";
      stringArray0[5] = "DtT@1x$1}I$u";
      stringArray0[6] = " [";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test120()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("_G6zrcQN");
      cSVFormat1.hashCode();
      assertEquals("_G6zrcQN", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isQuoteCharacterSet());
  ...
  public void test129()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      String[] stringArray0 = new String[3];
      stringArray0[0] = "a'K=8!i72z58?_D";
      stringArray0[1] = "=(%D";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test152()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("/B&_ M{64+(Oq}hz1'm");
      String string0 = cSVFormat1.getNullString();
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("/B&_ M{64+(Oq}hz1'm", string0);
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals(',', cSVFormat1.getDelimiter());
  }
