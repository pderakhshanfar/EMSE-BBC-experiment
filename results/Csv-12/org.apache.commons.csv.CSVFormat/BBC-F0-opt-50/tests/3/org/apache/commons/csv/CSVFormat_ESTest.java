...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("2g<t.CN]Ml1{L\"");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(false);
      assertEquals("2g<t.CN]Ml1{L\"", cSVFormat2.getNullString());
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ekx<`B~J_");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("X9is*vYVnn}");
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals("ekx<`B~J_", cSVFormat2.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("X9is*vYVnn}", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test007()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("DO\t<qk_o,h2)h|=;h");
      assertTrue(cSVFormat3.isQuoteCharacterSet());
      assertFalse(cSVFormat3.isNullStringSet());
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator(">}v\"W,fP,0$tq)I WE");
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test014()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("K@k&z_a{vMR%)Lf<*");
      QuoteMode quoteMode0 = QuoteMode.ALL;
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteMode(quoteMode0);
      assertEquals("K@k&z_a{vMR%)Lf<*", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test029()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("HDRr&xR<Y\"gk#Ux");
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test040()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString("D/");
      Character character0 = Character.valueOf('#');
      CSVFormat cSVFormat2 = cSVFormat1.withQuote(character0);
  ...
  public void test054()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("xilC");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentMarker((Character) null);
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("xilC", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
  }
  ...
  public void test069()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("imBIP9&/T");
      String string0 = cSVFormat1.getNullString();
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("imBIP9&/T", string0);
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test121()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("K@k&z_a{vMR%)Lf<*");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<K@k&z_a{vMR%)Lf<*> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test145()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      boolean boolean0 = cSVFormat0.equals("SG]Uga#d+C/");
      assertFalse(boolean0);
  }
