...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("The escape character and the delimiter cannot be the same ('");
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("tL?jaSn1djZ2");
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("w9", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("tL?jaSn1djZ2", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test006()  throws Throwable  {
      ...
      cSVFormat1.withRecordSeparator("X$KJnoQ7");
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
  }
  ...
  public void test026()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("w9");
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test031()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("y?$Yzs3Ki{%0@mt!");
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertEquals("y?$Yzs3Ki{%0@mt!", cSVFormat2.getNullString());
  }
  ...
  public void test043()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("v:f%dM5yYZ3K*");
      ...
      assertEquals("v:f%dM5yYZ3K*", cSVFormat4.getNullString());
  ...
  public void test079()  throws Throwable  {
      ...
      stringArray0[0] = "fOkx&2B]9s-.03t*IcP";
      stringArray0[1] = "x=$K!3(n,";
      stringArray0[2] = "fE1[";
      stringArray0[3] = ">*F=GN^b3l)M\"$";
      stringArray0[4] = "1";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "fOkx&2B]9s-.03t*IcP");
      // Undeclared exception!
      try { 
  ...
  public void test080()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("iY ^6))`FzN_'7(K");
  ...
  public void test083()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('d');
      String[] stringArray0 = new String[3];
      stringArray0[0] = "The eader ontains a duplicate enry: '";
      stringArray0[2] = "J79r\"?wY1";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test089()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('C');
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("]@/1Hn");
      boolean boolean0 = cSVFormat1.isNullStringSet();
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat0.getAllowMissingColumnNames());
      assertEquals("]@/1Hn", cSVFormat1.getNullString());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(boolean0);
  ...
  public void test110()  throws Throwable  {
      ...
      stringArray0[0] = "s4G'#(/7WkrEt}";
      stringArray0[1] = " SkipHeaderRecord:";
      stringArray0[2] = "n)#*";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> RecordSeparator=<\n> SkipHeaderRecord:false Header:[s4G'#(/7WkrEt},  SkipHeaderRecord:, n)#*, null]", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test114()  throws Throwable  {
      ...
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<Delimiter=<,> QuoteChar=<\"> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test118()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("qupj\"mK");
      cSVFormat1.hashCode();
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("qupj\"mK", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test121()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("org.apache.commons.csv.CSVFormat@0000000002,org.apache.commons.csv.CSVFormat@0000000003,java.lang.String@0000000005,");
  ...
  public void test125()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('(');
      String[] stringArray0 = new String[3];
      stringArray0[0] = "c74:3<\"z|ucbwxsK~b";
  ...
  public void test127()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("R(aW:b`");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(boolean0);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isQuoteCharacterSet());
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.isEscapeCharacterSet());
      assertEquals("R(aW:b`", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
