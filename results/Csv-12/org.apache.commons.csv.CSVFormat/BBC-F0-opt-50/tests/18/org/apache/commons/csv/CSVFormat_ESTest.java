...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("+t>A]}1H,*4@]<CG\"&");
      ...
      assertEquals("+t>A]}1H,*4@]<CG\"&", cSVFormat2.getNullString());
  }
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      cSVFormat1.withRecordSeparator("E5");
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
  }
  ...
  public void test025()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withQuote(character0);
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("A9]09_S*cEIZu");
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
  ...
  public void test031()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("9f");
  ...
  public void test034()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("gE0XSrn+f 1^ZF");
      String[] stringArray0 = new String[2];
      stringArray0[0] = "gE0XSrn+f 1^ZF";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("gE0XSrn+f 1^ZF", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
  ...
  public void test040()  throws Throwable  {
      ...
      assertEquals("gE0XSrn+f 1^ZF", cSVFormat3.getNullString());
  ...
  public void test052()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("f?l&yT4E'k");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentMarker('z');
      assertEquals("f?l&yT4E'k", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test059()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("`$8:#6ao7^MwSV");
  ...
  public void test067()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("7u%W>3");
      String string0 = cSVFormat1.getNullString();
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("7u%W>3", string0);
      assertFalse(cSVFormat1.isQuoteCharacterSet());
  ...
  public void test083()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[2];
      stringArray0[0] = "K)v\"T@zF/!r6,,r'eAL";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "java.lang.String@0000000014\tjava.lang.String@0000000015");
      // Undeclared exception!
      try { 
  ...
  public void test084()  throws Throwable  {
      ...
      stringArray0[0] = "";
      stringArray0[1] = "(n:quP_h8#>5OFF-y";
      stringArray0[2] = "bh:_guN7 uw";
      stringArray0[3] = "EOF";
      stringArray0[5] = "u";
      stringArray0[6] = "-M";
  ...
  public void test116()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("+t>A]}1H,*4@]<CG\"&");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<+t>A]}1H,*4@]<CG\"&> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test130()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("f?l&yT4E'k", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test152()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("K)v\"T@zF/!r6,,r'eAL");
      cSVFormat1.hashCode();
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
