...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("5Y1");
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test009()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("c^R[-XfeM|/");
      QuoteMode quoteMode0 = QuoteMode.MINIMAL;
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteMode(quoteMode0);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("c^R[-XfeM|/", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("65Z-Z?(%QnlnP{c-aE");
      ...
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("65Z-Z?(%QnlnP{c-aE", cSVFormat2.getNullString());
  ...
  public void test027()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("myBtz.?n&z");
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals("myBtz.?n&z", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test028()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("5Y1");
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("5Y1", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
  ...
  public void test057()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("FYQ'i~(UefAZ;h%)");
      ...
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("FYQ'i~(UefAZ;h%)", cSVFormat2.getNullString());
  }
  ...
  public void test061()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("0Rmu=0");
  ...
  public void test084()  throws Throwable  {
      ...
      stringArray0[2] = "p";
      stringArray0[3] = "=C?Zt\"rg'8v?(gLa";
      stringArray0[4] = "54Bn";
      stringArray0[5] = "2H9yf #qCMI*L\"";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test086()  throws Throwable  {
      ...
      stringArray0[0] = "SLi}'H@Y";
      stringArray0[1] = "I$$ek%Gb@p)};\"U:";
      stringArray0[2] = "PTm^H|<-AZ`l/R'#~#";
      stringArray0[3] = "__:21Wxm&";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test114()  throws Throwable  {
      ...
      stringArray0[0] = "NONE";
      stringArray0[1] = "+-y\u0001Zm}b1";
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withHeader(stringArray0);
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> QuoteChar=<\"> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false Header:[NONE, +-y\u0001Zm}b1, null]", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test119()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("65Z-Z?(%QnlnP{c-aE");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<65Z-Z?(%QnlnP{c-aE> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
