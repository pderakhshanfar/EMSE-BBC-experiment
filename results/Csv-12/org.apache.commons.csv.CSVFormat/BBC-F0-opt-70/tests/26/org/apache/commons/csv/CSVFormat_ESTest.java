...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("jw[t");
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withRecordSeparator("The comment start character and the delimiter cannot be the same ('");
  ...
  public void test007()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("Ei3B1o(b9Ekp}$&a");
      assertFalse(cSVFormat2.isNullStringSet());
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test011()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('(');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Ei3B1o(b9Ekp}$&a");
  ...
  public void test022()  throws Throwable  {
      ...
      assertEquals("D=}C\\u=:e2", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test027()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("S,wh#U~GAC$$='wb;");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isQuoteCharacterSet());
      assertEquals("S,wh#U~GAC$$='wb;", cSVFormat2.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
  ...
  public void test029()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('(');
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Ei3B1o(b9Ekp}$&a");
      assertFalse(cSVFormat0.getAllowMissingColumnNames());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test030()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("hiGp?zb&j3.");
      ...
      assertEquals("hiGp?zb&j3.", cSVFormat3.getNullString());
  ...
  public void test043()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("FBND0z\"\"d8Z");
      ...
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("FBND0z\"\"d8Z", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test067()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('i');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("t2J~fH.aF+2ZDaB");
  ...
  public void test091()  throws Throwable  {
      ...
      assertEquals("FBND0z\"\"d8Z", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test118()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("es0*o%dsTp}c!9");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<es0*o%dsTp}c!9> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test129()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("J N5|~V");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(boolean0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("J N5|~V", cSVFormat1.getNullString());
  }
  ...
  public void test131()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('{');
      CSVFormat cSVFormat1 = cSVFormat0.withEscape('B');
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("WV*`+2WoX~rI");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(cSVFormat2.getAllowMissingColumnNames());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isNullStringSet());
  ...
  public void test160()  throws Throwable  {
      ...
      stringArray0[0] = "_yB6O&~xrHp?";
      stringArray0[1] = "OgulIH? k/VK|2vT]D";
      stringArray0[2] = " SurroundingSpaces:ignored";
      stringArray0[3] = "TSb6@+IkIKn11=d~;=";
      stringArray0[4] = "WV*`+2WoX~rI";
      stringArray0[5] = "org.apache.commons.csv.CSVPrinter$1";
      stringArray0[6] = "#AT+?C/iF(R7";
      stringArray0[7] = "HfFpo>gNsZ[e,{$ m";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
