...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("j]g68.47xL]");
      assertFalse(cSVFormat1.isNullStringSet());
  ...
  public void test012()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("MDhbB({8gV");
      assertTrue(cSVFormat1.isEscapeCharacterSet());
      
      QuoteMode quoteMode0 = QuoteMode.NONE;
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteMode(quoteMode0);
      assertFalse(cSVFormat2.isQuoteCharacterSet());
      assertEquals("MDhbB({8gV", cSVFormat2.getNullString());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test024()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("LbD.nSRIc?E8U");
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("LbD.nSRIc?E8U", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
  ...
  public void test035()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("LbD.nSRIc?E8U");
  ...
  public void test040()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("AL*k");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('V');
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\"', (char)cSVFormat2.getQuoteCharacter());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("AL*k", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test050()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("S>=ZK");
      Character character0 = Character.valueOf('5');
  ...
  public void test057()  throws Throwable  {
      ...
      stringArray0[0] = "@seg";
      stringArray0[1] = "@xaF~e8Ngim7St";
      stringArray0[2] = "vuAT'\">Ss";
      stringArray0[3] = " 7vYJV:dX1^4";
      stringArray0[4] = "g";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("vuAT'\">Ss");
  ...
  public void test079()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      String[] stringArray0 = new String[3];
      stringArray0[0] = "HY-laoRHx";
      stringArray0[1] = "af:*SW`0y+zS9ccau3";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "java.lang.String@0000000003\tjava.lang.String@0000000004\tjava.lang.String@0000000005");
      // Undeclared exception!
      try { 
  ...
  public void test108()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("z}^;XJW'");
      // Undeclared exception!
      try { 
  ...
  public void test112()  throws Throwable  {
      ...
      stringArray0[3] = "(PR`zlOq";
      stringArray0[4] = "aq Ne&8VN\"~1/**w";
      stringArray0[5] = "org.apache.commons.csv.ExtendedBufferedReader";
      stringArray0[6] = "";
      stringArray0[7] = "The header contains a duplicate entry: '";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false Header:[The comment start marker character cannot be a line break, '), Header:, (PR`zlOq, aq Ne&8VN\"~1/**w, org.apache.commons.csv.ExtendedBufferedReader, , The header contains a duplicate entry: ', null]", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test114()  throws Throwable  {
      ...
      assertEquals("Delimiter=<#> Escape=<3> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat2.getAllowMissingColumnNames());
