...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test017()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("gyRen8b");
      ...
      assertEquals("gyRen8b", cSVFormat2.getNullString());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("WPs0'[?^4LJR8,t");
      CSVFormat cSVFormat2 = cSVFormat1.withQuote('Z');
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("WPs0'[?^4LJR8,t", cSVFormat2.getNullString());
  ...
  public void test028()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("AP~2x,E]Jm");
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      ...
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("AP~2x,E]Jm", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test042()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("? xtD2C#}wdpC");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape((Character) null);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("? xtD2C#}wdpC", cSVFormat2.getNullString());
  ...
  public void test046()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("AP~2x,E]Jm");
  ...
  public void test054()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      Character character0 = new Character('w');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("o=uT?tWZ3QfR[E");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isEscapeCharacterSet());
      assertEquals("o=uT?tWZ3QfR[E", cSVFormat2.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
  ...
  public void test058()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Afxn){hvC}S8H`K/gQY");
      ...
      assertEquals('M', (char)cSVFormat2.getCommentMarker());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("Afxn){hvC}S8H`K/gQY", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isQuoteCharacterSet());
  }
  ...
  public void test122()  throws Throwable  {
      ...
      stringArray0[0] = "ITOPFQ~=V?Z9S";
      stringArray0[1] = "The comment start and the escape character cannot be the same ('";
      stringArray0[2] = "jf";
      stringArray0[3] = "[gtHd9:\"UCw~A-21z]";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      Character character0 = Character.valueOf('\\');
      CSVFormat cSVFormat2 = cSVFormat1.withQuote(character0);
      String string0 = cSVFormat2.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\\> RecordSeparator=<\r\n> SkipHeaderRecord:false Header:[ITOPFQ~=V?Z9S, The comment start and the escape character cannot be the same (', jf, [gtHd9:\"UCw~A-21z], null]", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test124()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("org.apache.comons.csv.Constants");
      boolean boolean0 = cSVFormat1.isNullStringSet();
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("org.apache.comons.csv.Constants", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(boolean0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test128()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("]Hewc");
      cSVFormat1.hashCode();
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals("]Hewc", cSVFormat1.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test138()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      String[] stringArray0 = new String[5];
      stringArray0[0] = "NON_NLME:IC";
      stringArray0[1] = "8Z)po=y2b0]6&c#";
      stringArray0[2] = "}_v^%*zx0l5";
