...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString(".UxJ($%,V");
      ...
      assertEquals(".UxJ($%,V", cSVFormat1.getNullString());
  ...
  public void test001()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString(".x($%,V");
      ...
      assertEquals(".x($%,V", cSVFormat2.getNullString());
  ...
  public void test004()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('6');
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString(".UxJ($%,V");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator(".UxJ($%,V");
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("v7Ddc[M");
      Character character0 = Character.valueOf('d');
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator('P');
      assertEquals(',', cSVFormat3.getDelimiter());
      assertEquals("v7Ddc[M", cSVFormat3.getNullString());
  ...
  public void test011()  throws Throwable  {
      ...
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals(".UxJ($%,V", cSVFormat2.getNullString());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test019()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("4ow |`&v");
  ...
  public void test023()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("/p9Kmy");
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat2.isQuoteCharacterSet());
      assertEquals('N', (char)cSVFormat2.getCommentMarker());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("/p9Kmy", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test024()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("%F0Sil#|-(|CYv");
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertTrue(cSVFormat2.getSkipHeaderRecord());
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("%F0Sil#|-(|CYv", cSVFormat2.getNullString());
  }
  ...
  public void test033()  throws Throwable  {
      ...
      stringArray0[0] = "aA<NWb";
      stringArray0[1] = "bC8lVB$r~~~VW}";
      stringArray0[2] = "org.apache.commons.csv.Token";
      stringArray0[3] = "a}&J6n";
  ...
  public void test035()  throws Throwable  {
      ...
      stringArray0[0] = "Kse|p[Ig.q";
      stringArray0[1] = "mCb";
      stringArray0[2] = "org.apache.commons.csv.Constants";
      stringArray0[3] = "tE5etzy>`";
      stringArray0[4] = " [";
  ...
  public void test040()  throws Throwable  {
      ...
      assertEquals("v7Ddc[M", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test050()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("b&r_dRvy0aZ");
      CSVFormat cSVFormat2 = cSVFormat1.withAllowMissingColumnNames(false);
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("b&r_dRvy0aZ", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.getAllowMissingColumnNames());
  ...
  public void test078()  throws Throwable  {
      ...
      stringArray0[2] = "\r\n";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "3qc%Mw;sN6mJgY");
      // Undeclared exception!
      try { 
  ...
  public void test079()  throws Throwable  {
      ...
      stringArray0[1] = ")8k*; [4@SXpP)_r";
      stringArray0[2] = "4}XhBi82b";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test111()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('6');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(".UxJ($%,V");
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getAllowMissingColumnNames());
      assertEquals('6', cSVFormat0.getDelimiter());
      assertEquals("Delimiter=<6> NullString=<.UxJ($%,V> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
  }
  ...
  public void test118()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("S?z'[");
  ...
  public void test122()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('}');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Xc");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertFalse(boolean0);
      assertEquals('}', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
  ...
  public void test147()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("LF\"I(?8:YIc");
      cSVFormat1.hashCode();
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
