...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("N*TFz");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("java.lang.String@0000000005\tjava.lang.String@0000000006");
      ...
      assertEquals("N*TFz", cSVFormat1.getNullString());
  }

  @Test(timeout = 4000)
  public void test005()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('<');
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withRecordSeparator(") invalid parse sequence");
  ...
  public void test027()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      cSVFormat1.withNullString("_Up|TNGTl0 yaG+");
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test028()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Q}]Kd;/, u&CLXZ 6P;");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(false);
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals("Q}]Kd;/, u&CLXZ 6P;", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test061()  throws Throwable  {
      ...
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertEquals("N*TFz", cSVFormat2.getNullString());
  }
  ...
  public void test088()  throws Throwable  {
      ...
      stringArray0[0] = "U^2`o>.qny";
      stringArray0[1] = "2R91M";
      stringArray0[2] = "The escape character and the delimiter cannot be the same ('";
      stringArray0[3] = "EscaHe=<";
      stringArray0[4] = "(line ";
      stringArray0[5] = "sUgNZ~{w)[";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "sUgNZ~{w)[");
      // Undeclared exception!
      try { 
  ...
  public void test118()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('l');
      String[] stringArray0 = new String[2];
      stringArray0[0] = ".vmeFRzG";
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withHeader(stringArray0);
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals("Delimiter=<\t> QuoteChar=<\"> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false Header:[.vmeFRzG, null]", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals('l', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getAllowMissingColumnNames());
  }
  ...
  public void test119()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Q}]Kd;/, u&CLXZ 6P;");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<Q}]Kd;/, u&CLXZ 6P;> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test125()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertEquals("Q}]Kd;/, u&CLXZ 6P;", cSVFormat1.getNullString());
  }
  ...
  public void test136()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("aZ_/?H?");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertFalse(boolean0);
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("aZ_/?H?", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
