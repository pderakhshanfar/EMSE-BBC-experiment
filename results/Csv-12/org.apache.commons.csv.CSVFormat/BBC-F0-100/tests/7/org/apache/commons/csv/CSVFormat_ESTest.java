...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("8G9s}6-<#$2A");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("8G9s}6-<#$2A");
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      ...
      assertEquals("8G9s}6-<#$2A", cSVFormat1.getNullString());
  }

  @Test(timeout = 4000)
  public void test002()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withRecordSeparator("8G9s}6-<#$2A");
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("iF2fz?N,^Yv2n()'0{");
  ...
  public void test032()  throws Throwable  {
      ...
      assertFalse(cSVFormat2.isQuoteCharacterSet());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("8G9s}6-<#$2A", cSVFormat2.getNullString());
  }
  ...
  public void test054()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("543}+sId?y2+a");
      ...
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("543}+sId?y2+a", cSVFormat2.getNullString());
  }
  ...
  public void test067()  throws Throwable  {
      ...
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("8G9s}6-<#$2A", string0);
      assertFalse(cSVFormat2.isQuoteCharacterSet());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isEscapeCharacterSet());
  ...
  public void test076()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("PE@g);P#wZV1p");
  ...
  public void test084()  throws Throwable  {
      ...
      stringArray0[1] = "eP&4wKTsxke(!sI.lr5";
      stringArray0[2] = "\u2029";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test116()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<8G9s}6-<#$2A> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test120()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("i2");
      cSVFormat1.hashCode();
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test145()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("543}+sId?y2+a");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertEquals("543}+sId?y2+a", cSVFormat1.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
