...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test010()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("8hkp*szp&q?nH;12");
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test011()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("gT.");
  ...
  public void test032()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("KPm E]~8'");
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("KPm E]~8'", cSVFormat2.getNullString());
  ...
  public void test057()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("?$E<P:iF{vL!5zC#");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentMarker((Character) null);
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals("?$E<P:iF{vL!5zC#", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test067()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("!Z{Gr((t");
  ...
  public void test075()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("(8j edL");
      String string0 = cSVFormat1.getNullString();
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("(8j edL", string0);
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test089()  throws Throwable  {
      ...
      stringArray0[0] = "8Ke:aq{v[1PZ88JET";
      stringArray0[1] = "ONEa";
      stringArray0[2] = "4";
      stringArray0[3] = "3C$2u]ETm3?";
      stringArray0[4] = "out";
      stringArray0[5] = "!Z{Gr((t";
      stringArray0[6] = "GCpdTp}F|fl3f%6";
      stringArray0[7] = "3?DSS5zQCL>";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test090()  throws Throwable  {
      ...
      stringArray0[0] = "|<be\"hfP.J\"c}LAB";
      stringArray0[1] = "nAuj2";
      stringArray0[2] = "[5c3=u4j*kMRo2NGR";
      stringArray0[3] = "7qpZlS8cpa0M,|(D";
      stringArray0[4] = "2a bZ|9@5,tk0tX5g#V";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test125()  throws Throwable  {
      ...
      stringArray0[0] = "/kp0";
      stringArray0[1] = "\n";
      stringArray0[2] = "!T8#9}&f1E8QK";
      stringArray0[3] = "4";
      stringArray0[4] = "url";
      stringArray0[5] = "\"lXf~Me[D0V`W^WYv8";
      stringArray0[6] = ") invalid parse sequence";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> QuoteChar=<\"> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false Header:[/kp0, \n, !T8#9}&f1E8QK, 4, url, \"lXf~Me[D0V`W^WYv8, ) invalid parse sequence, null]", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test140()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(":3LK!O-y1YzS+)");
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(boolean0);
      assertEquals(":3LK!O-y1YzS+)", cSVFormat2.getNullString());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isQuoteCharacterSet());
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
  }
  ...
  public void test142()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(":3LK!O-y1YzS+)", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertFalse(boolean0);
