...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Oj1<IU_#){CV]|UgF");
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("@[\"ENI;ks");
  ...
  public void test038()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("T)j");
      Character character0 = Character.valueOf('a');
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      CSVFormat cSVFormat3 = cSVFormat2.withIgnoreSurroundingSpaces(true);
      assertFalse(cSVFormat3.getAllowMissingColumnNames());
      assertEquals("T)j", cSVFormat3.getNullString());
  ...
  public void test043()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("FF$");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('u');
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("FF$", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test047()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("7EmARM%omJP/W^`");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('_');
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isQuoteCharacterSet());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("7EmARM%omJP/W^`", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.isEscapeCharacterSet());
  ...
  public void test067()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("N6!3CCB`OOwgt");
      String string0 = cSVFormat1.getNullString();
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("N6!3CCB`OOwgt", string0);
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
  }
  ...
  public void test119()  throws Throwable  {
      ...
      stringArray0[0] = "`\"oyApdPK{(j+\"_";
      stringArray0[1] = "";
      stringArray0[2] = "g5N";
      stringArray0[3] = "f7Zk$1nlH+";
      stringArray0[4] = " SurroundingSpaces:ignored";
      stringArray0[5] = "~s46YNL=r/c8l:3";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("Delimiter=<,> QuoteChar=<\"> RecordSeparator=<\r\n> SkipHeaderRecord:false Header:[`\"oyApdPK{(j+\"_, , g5N, f7Zk$1nlH+,  SurroundingSpaces:ignored, ~s46YNL=r/c8l:3, null]", string0);
  }
  ...
  public void test125()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("JwT");
      cSVFormat1.hashCode();
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
  ...
  public void test132()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("!8|],/K_$;)An");
      CSVFormat cSVFormat2 = cSVFormat0.withNullString("!8|],/K_$;)An");
      boolean boolean0 = cSVFormat2.equals(cSVFormat1);
  ...
  public void test133()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isQuoteCharacterSet());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("7EmARM%omJP/W^`", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test134()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("!8|],/K_$;)An");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertEquals("!8|],/K_$;)An", cSVFormat1.getNullString());
      assertFalse(boolean0);
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test158()  throws Throwable  {
      ...
      assertEquals("Delimiter=<\t> QuoteChar=<\"> CommentStart=<X> NullString=<<> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", string0);
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
