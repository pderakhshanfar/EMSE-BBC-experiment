...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withRecordSeparator("mwp}K,|[XdDQTA");
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('V');
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("b]HW");
  ...
  public void test026()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ELh@EtW7/!3");
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("ELh@EtW7/!3", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
  }
  ...
  public void test036()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("od1G>}(p|O8");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(true);
      ...
      assertEquals("od1G>}(p|O8", cSVFormat3.getNullString());
  ...
  public void test039()  throws Throwable  {
      ...
      stringArray0[0] = "(T8N0_=37(Y5=9+:1";
      stringArray0[1] = " SkipHeaderRecord:";
      stringArray0[2] = "9*;Tg1*r4X$HH4-";
  ...
  public void test049()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withRecordSeparator("(startline ");
  ...
  public void test057()  throws Throwable  {
      ...
      assertEquals("od1G>}(p|O8", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test061()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("1FU+lM0");
  ...
  public void test072()  throws Throwable  {
      ...
      stringArray0[0] = "=jsayR)uSH";
      stringArray0[1] = "~";
      stringArray0[2] = "\r\n";
      stringArray0[3] = "k8uB4m~HGx";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test082()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) ";VD;z[S");
      // Undeclared exception!
      try { 
  ...
  public void test083()  throws Throwable  {
      ...
      stringArray0[2] = "n]~w^0`y";
      stringArray0[3] = "wl{xo_.=y";
      stringArray0[4] = "Z1+d<K`OX4vRkYG4";
      stringArray0[5] = "`A 9WUbNG+<F,SK";
      stringArray0[6] = "aYcM.],";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test116()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("$U_Cq`0&-8a${j");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<$U_Cq`0&-8a${j> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test119()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('V');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("b]HW");
      cSVFormat1.hashCode();
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('V', cSVFormat1.getDelimiter());
  ...
  public void test129()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("`vZ");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("`vZ");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      ...
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("`vZ", cSVFormat1.getNullString());
  }
