...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("l,y&(TT");
      assertFalse(cSVFormat3.isNullStringSet());
  ...
  public void test005()  throws Throwable  {
      ...
      cSVFormat1.withRecordSeparator("~31K*vdr}x|_!b");
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("6i'0l6");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator(']');
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("6i'0l6", cSVFormat2.getNullString());
  ...
  public void test015()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("/_GRP");
  ...
  public void test018()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("3ABk(W?e");
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("3ABk(W?e", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test024()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("6VF6VUq%8Vqlc,^1_SE");
      assertFalse(cSVFormat2.getAllowMissingColumnNames());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isNullStringSet());
  ...
  public void test033()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('G');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("6VF6VUq%8Vqlc,^1_SE");
  ...
  public void test047()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('W');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("i.]{`95q)tiq");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(true);
  ...
  public void test061()  throws Throwable  {
      ...
      cSVFormat0.RFC4180.print(mockPrintWriter0);
  ...
  public void test062()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("EVM(nEgc>");
  ...
  public void test084()  throws Throwable  {
      ...
      stringArray0[4] = "i90Uj2x'hFRAl=j<o\"5";
      stringArray0[5] = "A.3quR6)eGOkN";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test120()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("6i'0l6");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<6i'0l6> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test133()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("`Za:c");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("`Za:c", cSVFormat1.getNullString());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
  ...
  public void test134()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(";uMjsvv(4");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator(";uMjsvv(4");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals(";uMjsvv(4", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(boolean0);
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test155()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("06%l1D!%}vg");
  ...
  public void test159()  throws Throwable  {
      ...
      String string0 = "&#DA|EL\\uWr)a";
      stringArray0[0] = string0;
      stringArray0[1] = "`v_3!=H";
      stringArray0[2] = "";
      stringArray0[3] = "The comment start and the escape character cannot be the same ('";
      stringArray0[4] = "mqvKM&P &sF";
      stringArray0[5] = ",I3v`K4o5.<W$o";
      stringArray0[6] = "7j';P-T\"G}=";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "Wq -&xIq:R", 1, 1);
      // Undeclared exception!
      try { 
        cSVFormat1.print(charBuffer0);
