...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(" 2&id$");
      ...
      assertEquals(" 2&id$", cSVFormat2.getNullString());
  ...
  public void test008()  throws Throwable  {
      ...
      cSVFormat1.withRecordSeparator("%evqSj3wYA#z2PB:80");
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
  }
  ...
  public void test010()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("tv/di");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('\\');
      ...
      assertEquals("tv/di", cSVFormat3.getNullString());
  ...
  public void test013()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("uHo");
      ...
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("uHo", cSVFormat2.getNullString());
  }
  ...
  public void test016()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("!h&sX;/F,g,zm.\"C[?*");
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("!h&sX;/F,g,zm.\"C[?*", cSVFormat2.getNullString());
  }
  ...
  public void test020()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(" 2&id$");
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(" 2&id$", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("=1n_jkX>");
      ...
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals("=1n_jkX>", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
  }
  ...
  public void test030()  throws Throwable  {
      ...
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("tv/di", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
  }
  ...
  public void test032()  throws Throwable  {
      ...
      stringArray0[0] = "";
      stringArray0[1] = "hm\"y<Zia^1^";
      stringArray0[2] = "s(?}lwgH&h4(@7";
      stringArray0[3] = ";zCQ0/jP7";
  ...
  public void test042()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("R lM+`kF#");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals("R lM+`kF#", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test055()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('O');
      CharArrayWriter charArrayWriter0 = new CharArrayWriter(456);
      BufferedWriter bufferedWriter0 = new BufferedWriter(charArrayWriter0, 456);
  ...
  public void test076()  throws Throwable  {
      ...
      String[] stringArray0 = new String[3];
      stringArray0[0] = "%>jC_JHxbB^:A]Ip>p";
      stringArray0[1] = "gP(9B1iyFe(S3";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "gP(9B1iyFe(S3");
  ...
  public void test078()  throws Throwable  {
      ...
      stringArray0[1] = ")*39xX>]+z#`D!7VI+}Y";
      stringArray0[2] = "y$&X>.3:V/";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test109()  throws Throwable  {
      ...
      assertEquals("Delimiter=<\t> Escape=<\\> RecordSeparator=<\n> SkipHeaderRecord:false Header:[ SurroundingSpaces:ignored, eA-_rut<DA?:, null]", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test112()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("HGl{^&z]");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<HGl{^&z]> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test113()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("=1n_jkX>", cSVFormat1.getNullString());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertTrue(boolean0);
  ...
  public void test122()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("Y");
  ...
  public void test127()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("UUq*5.iyTyb1JL");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertEquals("UUq*5.iyTyb1JL", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(boolean0);
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test128()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("f=cW{Q:Q(9?oA2");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      ...
      assertTrue(cSVFormat1.isEscapeCharacterSet());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("f=cW{Q:Q(9?oA2", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isQuoteCharacterSet());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
  }
