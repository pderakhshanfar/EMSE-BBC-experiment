...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("J\"2:n\"$L'qC");
      ...
      assertEquals("J\"2:n\"$L'qC", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.getAllowMissingColumnNames());
  }
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("(!Q-P0{yBl=L3");
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      ...
      assertEquals("(!Q-P0{yBl=L3", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test021()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("J\"2:n\"$L'qC");
      assertEquals("J\"2:n\"$L'qC", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
  ...
  public void test028()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("reder");
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("reder", cSVFormat2.getNullString());
  }
  ...
  public void test059()  throws Throwable  {
      ...
      stringArray0[3] = "Dbq";
      stringArray0[4] = "";
      stringArray0[5] = "mSff-2ZB'-/$fjs/:";
      CSVFormat cSVFormat3 = cSVFormat2.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("HL?u~H0 +Z:DlC6H");
  ...
  public void test085()  throws Throwable  {
      ...
      stringArray0[0] = "-Vl{r74";
      stringArray0[1] = "";
      stringArray0[2] = "+";
      stringArray0[3] = "oP$),)o}5=q";
      stringArray0[4] = "rKloP_>4%";
      stringArray0[5] = "D4-?C*y%~Xwx?jP54f^";
      stringArray0[6] = "VJxJ69-.N6{+Wbnk";
      stringArray0[7] = "$O";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test087()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      PipedReader pipedReader0 = new PipedReader(2815);
      try { 
  ...
  public void test120()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("+Bua@f/!QLIwhbLFZTb");
      cSVFormat1.toString();
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test134()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("J\"2:n\"$L'qC");
      CSVFormat cSVFormat2 = cSVFormat0.withNullString("J\"2:n\"$L'qC");
  ...
  public void test135()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('s');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(",QCHCHG.V{\"");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(boolean0);
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test136()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("reder", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test146()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      boolean boolean0 = cSVFormat0.equals("J\"2:n\"$L'qC");
      assertFalse(boolean0);
  }
  ...
  public void test150()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      String[] stringArray0 = new String[2];
      stringArray0[0] = "Delimiter=<\t> Escape=<N> QuoteChar=<N> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:true";
      stringArray0[1] = "Delimiter=<\t> Escape=<N> QuoteChar=<N> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:true";
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The header contains a duplicate entry: 'Delimiter=<\t> Escape=<N> QuoteChar=<N> RecordSeparator=<\r
         // > EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:true' in [Delimiter=<\t> Escape=<N> QuoteChar=<N> RecordSeparator=<\r
         // > EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:true, Delimiter=<\t> Escape=<N> QuoteChar=<N> RecordSeparator=<\r
         // > EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:true]
         //
         verifyException("org.apache.commons.csv.CSVFormat", e);
      }
