...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withRecordSeparator("7^i!+6}^o}k7OW5=k");
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.isNullStringSet());
  ...
  public void test017()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("agi^");
      ...
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("agi^", cSVFormat2.getNullString());
  }
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("tP5>7}0[G7[.'$q9Ei0");
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("tP5>7}0[G7[.'$q9Ei0", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
  }
  ...
  public void test026()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("R1AS'|,y<JA#v %Z");
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
  ...
  public void test034()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("R1AS'|,y<JA#v %Z");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("R1AS'|,y<JA#v %Z", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
  }
  ...
  public void test066()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("}`S]j1v2");
      String string0 = cSVFormat1.getNullString();
      assertEquals('w', cSVFormat0.getDelimiter());
      assertTrue(cSVFormat1.isEscapeCharacterSet());
      assertEquals("}`S]j1v2", string0);
  ...
  public void test083()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "H%$SR*t1x");
      // Undeclared exception!
      try { 
  ...
  public void test085()  throws Throwable  {
      ...
      stringArray0[0] = "@YJ^=)|&GmIhW";
      stringArray0[1] = "pTtp2qYm{?B}.";
      stringArray0[2] = "lV/!*4n}%CU2Xx";
      stringArray0[3] = "+:Auy;q7 L";
      stringArray0[4] = "2";
      stringArray0[5] = "' in ";
      stringArray0[6] = "z)8{n]@RP3";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test113()  throws Throwable  {
      ...
      stringArray0[0] = "i";
      stringArray0[1] = "";
      stringArray0[2] = "xE@f[MnpD-@JR)fNrJ";
      stringArray0[3] = "z";
      stringArray0[4] = "A";
  ...
  public void test115()  throws Throwable  {
      ...
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<5E/#}> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test120()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker('}');
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("agi^");
      cSVFormat2.hashCode();
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test134()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker('{');
      CSVFormat cSVFormat2 = cSVFormat1.withQuote('F');
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("agi^");
