...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("){W+Y0");
      cSVFormat1.hashCode();
  ...
  public void test004()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("){W+Y0");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("RWMXMIB4})oPK");
      assertEquals("){W+Y0", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      ...
      assertEquals("RWMXMIB4})oPK", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("]-;!i#B");
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertTrue(cSVFormat2.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
  ...
  public void test024()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('B');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker(';');
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("A+5wpu:tDkH/2%/?");
      assertEquals(';', (char)cSVFormat2.getCommentMarker());
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('D');
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("^we");
      assertTrue(cSVFormat2.isNullStringSet());
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
  ...
  public void test028()  throws Throwable  {
      ...
      CSVFormat cSVFormat4 = cSVFormat3.withNullString("^we");
  ...
  public void test030()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('+');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("*607O");
  ...
  public void test034()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("UMjX,Y/H\u0001%:I^v|");
      ...
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("UMjX,Y/H\u0001%:I^v|", cSVFormat2.getNullString());
  }
  ...
  public void test035()  throws Throwable  {
      ...
      stringArray0[0] = "I#>jG_3qt#}AA;8Z";
      stringArray0[1] = "cx|A#P5JM!=`";
  ...
  public void test056()  throws Throwable  {
      ...
      assertTrue(cSVFormat3.isQuoteCharacterSet());
      assertEquals(";", cSVFormat3.getRecordSeparator());
      assertEquals("){W+Y0", cSVFormat3.getNullString());
  }
  ...
  public void test057()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("UkvP&M rj");
      assertTrue(cSVFormat3.getAllowMissingColumnNames());
      assertEquals('\"', (char)cSVFormat3.getQuoteCharacter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat3.equals((Object)cSVFormat2));
  ...
  public void test084()  throws Throwable  {
      ...
      stringArray0[5] = "pMWs\\&G?T'>5VMuKF";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "YG?");
      // Undeclared exception!
      try { 
  ...
  public void test085()  throws Throwable  {
      ...
      stringArray0[0] = "t9;j6F]kYbE";
      stringArray0[1] = "iwzxWW";
      stringArray0[2] = "\n";
      stringArray0[3] = "=uIvh0~UBj;Srv1-v";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test117()  throws Throwable  {
      ...
      assertEquals("Delimiter=<,> QuoteChar=<\"> RecordSeparator=<\r\n> SkipHeaderRecord:false Header:[{G+3_sn276*), null]", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test119()  throws Throwable  {
      ...
      assertEquals("Delimiter=<\t> Escape=<\\> QuoteChar=<U> NullString=<> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test120()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Delimiter=<\t> Escape=<Z> QuoteChar=<\"> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false");
  ...
  public void test129()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat0.DEFAULT.withRecordSeparator("A+5wpu:tDkH/2%/?");
  ...
  public void test132()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("B^GA|,GFYb8gJ");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(false);
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertEquals("B^GA|,GFYb8gJ", cSVFormat2.getNullString());
      assertTrue(boolean0);
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
  ...
  public void test133()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("zn9\u0006<{]ug 5i]N");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertEquals("zn9\u0006<{]ug 5i]N", cSVFormat1.getNullString());
      assertFalse(boolean0);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test134()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("B^GA|,GFYb8gJ", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(boolean0);
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
  ...
  public void test145()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('B');
      boolean boolean0 = cSVFormat0.equals("0");
      assertEquals('B', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertFalse(boolean0);
  ...
  public void test153()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("{G+3_sn276*)");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("{G+3_sn276*)", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.getAllowMissingColumnNames());
