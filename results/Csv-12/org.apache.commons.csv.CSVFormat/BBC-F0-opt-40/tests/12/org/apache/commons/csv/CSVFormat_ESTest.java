...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("wxC'nq");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("wxC'nq", cSVFormat2.getNullString());
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("F4p");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("F4p");
      ...
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("F4p", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("2k=Hm)PFR`I44qR*0?");
  ...
  public void test009()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("fJ");
      CSVFormat cSVFormat2 = cSVFormat1.withQuote((Character) null);
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("fJ", cSVFormat2.getNullString());
  ...
  public void test020()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("ob");
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals("ob", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals(',', cSVFormat1.getDelimiter());
  }
  ...
  public void test029()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(")gED");
      ...
      assertEquals(")gED", cSVFormat3.getNullString());
  }
  ...
  public void test031()  throws Throwable  {
      ...
      stringArray0[0] = "3TR<w@sb0Ta?e&7s;70";
  ...
  public void test032()  throws Throwable  {
      ...
      String[] stringArray0 = new String[3];
      stringArray0[0] = "w";
      stringArray0[1] = "/bC:K)R0}k97')LSU";
  ...
  public void test038()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(".a'^z:B");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('b');
      assertEquals('b', (char)cSVFormat2.getEscapeCharacter());
      assertEquals(".a'^z:B", cSVFormat2.getNullString());
      assertEquals('\"', (char)cSVFormat2.getQuoteCharacter());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test041()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("1X#mG");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('-');
      assertEquals('-', cSVFormat2.getDelimiter());
      assertEquals("1X#mG", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test046()  throws Throwable  {
      ...
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("F4p", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
  ...
  public void test054()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("qams&8 B/oM");
  ...
  public void test062()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("<qw7x6");
      String string0 = cSVFormat1.getNullString();
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals("<qw7x6", string0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
  ...
  public void test111()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(":$[)b*F`qKbY\"O_I ");
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<:$[)b*F`qKbY\"O_I > RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test113()  throws Throwable  {
      ...
      assertTrue(boolean0);
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals("1X#mG", cSVFormat1.getNullString());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test118()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("mv?4R/KT!;h!Eali~v");
      cSVFormat1.hashCode();
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("mv?4R/KT!;h!Eali~v", cSVFormat1.getNullString());
  }
  ...
  public void test130()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("[TmKPm\"(5");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(boolean0);
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("[TmKPm\"(5", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test139()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      boolean boolean0 = cSVFormat0.equals("Nt+ZDy");
      assertFalse(boolean0);
  }
  ...
  public void test142()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals(".a'^z:B", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(boolean0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test143()  throws Throwable  {
      ...
      stringArray0[0] = "wxC'nq";
      stringArray0[1] = ".Qd?Mr";
      stringArray0[2] = "F%7i4";
      stringArray0[3] = "zZ 2t-=";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) ".Qd?Mr");
      // Undeclared exception!
      try { 
        cSVFormat1.print(charBuffer0);
