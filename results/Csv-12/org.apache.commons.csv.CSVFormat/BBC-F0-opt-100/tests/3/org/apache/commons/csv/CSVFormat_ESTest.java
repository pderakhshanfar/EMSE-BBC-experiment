...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      assertEquals("{@gk!", cSVFormat2.getNullString());
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("xCE`SB;|9JmVC_tXp8");
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      cSVFormat1.withRecordSeparator("Corg.apache.commons.csv.CCSVFormat@0000000002C,Corg.apache.commons.csv.CCSVFormat@0000000001C,java.lang.Object@0000000005");
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Dk,d)>_");
      assertEquals("Dk,d)>_", cSVFormat2.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Dk,d)>_");
  ...
  public void test029()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString(" OiF%qo;CdUty%_44U");
      ...
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals(" OiF%qo;CdUty%_44U", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test056()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("}BQd\"~");
  ...
  public void test064()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("<skTjW,is");
      String string0 = cSVFormat1.getNullString();
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("<skTjW,is", string0);
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test078()  throws Throwable  {
      ...
      stringArray0[1] = "A2}X;O.'";
      stringArray0[2] = "MINIMAL";
      stringArray0[3] = "Y1h2;Rf;Q]urpz-Aubd";
      stringArray0[4] = "}";
      stringArray0[5] = "Index for header '%s' is %d but CSVRecord only has %d values!";
      stringArray0[6] = "yhKQ`SL^mpO";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "The comment start character and the delimiter cannot be the same ('", 35, 35);
  ...
  public void test112()  throws Throwable  {
      ...
      stringArray0[0] = "-*AHtrQ~%q?";
      stringArray0[1] = "Y";
      stringArray0[2] = "P{U'+juYg&R ('";
      stringArray0[3] = "The escape character and the delimiter cannot be the same ('";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> RecordSeparator=<\r\n> SkipHeaderRecord:false Header:[-*AHtrQ~%q?, Y, P{U'+juYg&R (', The escape character and the delimiter cannot be the same (', null]", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test114()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker(character0);
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<|> CommentStart=<C> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getAllowMissingColumnNames());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
  }
  ...
  public void test115()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("BwC=ZfNS$HAjVs.[5");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<BwC=ZfNS$HAjVs.[5> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test141()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      boolean boolean0 = cSVFormat0.equals("YR4*hG@");
      assertFalse(boolean0);
  }
  ...
  public void test144()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The header contains a duplicate entry: '`]#t%j iTz_C,zNG**' in [`]#t%j iTz_C,zNG**, `]#t%j iTz_C,zNG**]
         //
         verifyException("org.apache.commons.csv.CSVFormat", e);
      }
  }
