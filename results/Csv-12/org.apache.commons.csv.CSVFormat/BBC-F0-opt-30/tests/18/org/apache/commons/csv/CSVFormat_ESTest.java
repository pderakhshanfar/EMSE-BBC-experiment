...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("SD");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("SD");
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("SD", cSVFormat1.getNullString());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("e2PGN>");
      assertTrue(cSVFormat2.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isNullStringSet());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
  ...
  public void test014()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("SD", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
  }
  ...
  public void test028()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      cSVFormat1.withNullString("a7({Rq~gPXc5TOqHv");
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
  }
  ...
  public void test029()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("+,Nv;5a-Dbpe0E|aVU");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(false);
      assertEquals("+,Nv;5a-Dbpe0E|aVU", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test038()  throws Throwable  {
      ...
      stringArray0[4] = "UG\u0003FX*pJ`h";
      stringArray0[5] = "LfkK'Zl( i";
      stringArray0[6] = "-xT24zFye[&Imx";
  ...
  public void test039()  throws Throwable  {
      ...
      assertFalse(cSVFormat3.getAllowMissingColumnNames());
      assertEquals("+,Nv;5a-Dbpe0E|aVU", cSVFormat3.getNullString());
  }
  ...
  public void test046()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("0X=#SWlU;I[o");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('O');
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isQuoteCharacterSet());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("0X=#SWlU;I[o", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.isEscapeCharacterSet());
  ...
  public void test051()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("W5~dT.'x5d!rY,[;@");
      ...
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals("W5~dT.'x5d!rY,[;@", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test065()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withQuote('3');
  ...
  public void test067()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("n@{UvFbLq2L1");
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("n@{UvFbLq2L1", string0);
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
  }
  ...
  public void test082()  throws Throwable  {
      ...
      stringArray0[0] = "n@{UvFbLq2L1";
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "n@{UvFbLq2L1");
  ...
  public void test085()  throws Throwable  {
      ...
      stringArray0[0] = "b {s";
      stringArray0[1] = "IF_}(W";
      stringArray0[2] = ")`$>k}5tF)";
      stringArray0[3] = "[";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test115()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("Delimiter=<\t> QuoteChar=<\"> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:true Header:[4\"q, null]", string0);
      assertFalse(cSVFormat2.getAllowMissingColumnNames());
  }
  ...
  public void test118()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<+,Nv;5a-Dbpe0E|aVU> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test122()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("n@{UvFbLq2L1", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
  }
  ...
  public void test133()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("n@{UvFbLq2L1");
      CSVFormat cSVFormat2 = cSVFormat0.withNullString("n@{UvFbLq2L1");
      ...
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("n@{UvFbLq2L1", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals('\t', cSVFormat2.getDelimiter());
  }
  ...
  public void test135()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertEquals("+,Nv;5a-Dbpe0E|aVU", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(boolean0);
  ...
  public void test138()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat0.DEFAULT.withEscape(character0);
      boolean boolean0 = cSVFormat2.equals(cSVFormat1);
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat2.getDelimiter());
      assertFalse(cSVFormat2.getAllowMissingColumnNames());
  ...
  public void test153()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('|');
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      StringReader stringReader0 = new StringReader("/YfGc{Z (pPj@_");
