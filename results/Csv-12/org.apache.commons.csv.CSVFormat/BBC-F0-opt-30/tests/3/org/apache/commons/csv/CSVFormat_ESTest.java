...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("}5-fB");
      assertFalse(cSVFormat2.isNullStringSet());
  ...
  public void test006()  throws Throwable  {
      ...
      cSVFormat1.withRecordSeparator("2<5V");
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
  ...
  public void test007()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Ju0 _E!cx'm-Ce*iJ]");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('v');
      assertEquals("v", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("Ju0 _E!cx'm-Ce*iJ]", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
  ...
  public void test022()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteMode(quoteMode0);
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("P");
  ...
  public void test024()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("XW B");
      ...
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("XW B", cSVFormat2.getNullString());
  ...
  public void test035()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentMarker(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Ju0 _E!cx'm-Ce*iJ]");
      ...
      assertEquals("Ju0 _E!cx'm-Ce*iJ]", cSVFormat3.getNullString());
      assertEquals('\t', cSVFormat3.getDelimiter());
  ...
  public void test057()  throws Throwable  {
      ...
      stringArray0[1] = "ALL";
      stringArray0[2] = "98jS4$`+;";
      stringArray0[3] = "zdx&s\"f*@N+'Ce3u+x";
      stringArray0[4] = "Mapping for %s not found, expected one of %s";
      stringArray0[5] = "d`sU7L7^,rf~{2";
  ...
  public void test079()  throws Throwable  {
      ...
      stringArray0[0] = "";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "1\"&S8Fw*{0rV");
  ...
  public void test082()  throws Throwable  {
      ...
      stringArray0[1] = "gdja@_6JGlh8 6[YLpa";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test089()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Delimiter=<U> QuoteChar=<\"> RecordSeparator=<\r\n> SkipHeaderRecord:false");
  ...
  public void test117()  throws Throwable  {
      ...
      assertFalse(cSVFormat0.getAllowMissingColumnNames());
      assertEquals('4', cSVFormat0.getDelimiter());
      assertEquals("Delimiter=<4> NullString=<Delimiter=<U> QuoteChar=<\"> RecordSeparator=<\r\n> SkipHeaderRecord:false> SkipHeaderRecord:false", string0);
  }
  ...
  public void test118()  throws Throwable  {
      ...
      assertFalse(cSVFormat2.getAllowMissingColumnNames());
      assertEquals("Delimiter=<0> Escape=<'> CommentStart=<r> SkipHeaderRecord:false", string0);
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
  }
  ...
  public void test124()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('-');
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("d`JsU7L7^Trf~{vO");
  ...
  public void test130()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("T3");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(boolean0);
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("T3", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
