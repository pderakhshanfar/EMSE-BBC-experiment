...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/]4sm5p!n");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("/]4sm5p!n");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("x`Y1'yQTn$v");
      byte[] byteArray0 = new byte[9];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("x`Y1'yQTn$v");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".H(A;Ai3ith|[FJU?");
  ...
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/-cd'*~-=zWHmZ<r@%");
      assertTrue(file0.isFile());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[9];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("x`Y1'yQTn$v");
  ...
  public void test21()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("?ijgP)K'HJ,T{^(*", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createObject("MUTe\"Wg%Ftm^ZO");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: MUTe\"Wg%Ftm^ZO
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createNumber("t3uM.gg\"UraR&k");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"t3uM.gg\"UraR&k\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("5V&+vksx9Uadkba", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 5V&+vksx9Uadkba
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("T551r=0B$%Q2F$-q`");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("w} m{h=5'4w/@");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: w} m{h=5'4w/@
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("/]4sm5p!n");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: /]4sm5p!n
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Object object0 = TypeHandler.createValue("/]4sm5p!n", (Object) null);
      assertNull(object0);
  }
}
