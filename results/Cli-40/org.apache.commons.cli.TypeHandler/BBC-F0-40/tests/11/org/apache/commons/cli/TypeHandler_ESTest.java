...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("]m(^^8mw0|", class0);
      assertEquals("]m(^^8mw0|", string0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("}jU^9UC", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: }jU^9UC
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      File file0 = TypeHandler.createFile("/YasUDWqD:?");
      // Undeclared exception!
      try { 
        TypeHandler.createValue(" <h$\"2", (Object) file0);
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("/Uj3)Yh7h~r%(");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: /Uj3)Yh7h~r%(
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
