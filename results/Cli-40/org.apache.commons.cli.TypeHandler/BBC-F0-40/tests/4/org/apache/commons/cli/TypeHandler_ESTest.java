...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("|e9");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("|e9");
  ...
  public void test16()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("_H|aLFK{pC)nY", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: _H|aLFK{pC)nY
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("Not yet implementmd", class0);
      assertEquals("Not yet implementmd", string0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("A@v=gb;{Q|4j',0dt0", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: A@v=gb;{Q|4j',0dt0
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("Not yet implementmd", class0);
      assertNull(integer0);
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".pZ}nL<rfAiCyDzL");
      assertEquals(".pZ}nL<rfAiCyDzL", file0.getName());
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("G3`RLe");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("Not yet implementmd");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: Not yet implementmd
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("Not yet implementmd", (Object) class0);
      assertEquals("Not yet implementmd", object0);
  }
}
