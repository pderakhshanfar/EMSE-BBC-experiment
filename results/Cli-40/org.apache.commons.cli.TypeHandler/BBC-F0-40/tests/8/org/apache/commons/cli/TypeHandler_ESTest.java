...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("oK.EdHNB");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("oK.EdHNB");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("%{{~C2'^%");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "L/;~");
      FileInputStream fileInputStream0 = TypeHandler.openFile("%{{~C2'^%");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("zy", (Object) class0);
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".4@'vLkz4");
      assertEquals(".4@'vLkz4", file0.getName());
  }
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/PrPObg6>Zum0");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("ORC", (Object) "ORC");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createObject("=lrU_|Am;Bg");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: =lrU_|Am;Bg
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("Unale to find the class: ", class0);
      assertNull(integer0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("H8YiZyV");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: H8YiZyV
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.createClass("[ option: ");
        fail("Expecting exception: Exception");
