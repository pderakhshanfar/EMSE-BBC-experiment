...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Number number0 = TypeHandler.createNumber("56");
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Y&tkKy4% ZN(W<RZVX");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, ">:S,[4");
      FileInputStream fileInputStream0 = TypeHandler.openFile("Y&tkKy4% ZN(W<RZVX");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("doKiOU", (Object) class0);
      assertEquals("doKiOU", object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("wAA'?IGWY0%_zi,e8");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "wAA'?IGWY0%_zi,e8");
      File file0 = TypeHandler.createFile("wAA'?IGWY0%_zi,e8");
      assertEquals(18L, file0.length());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("//Og");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(";~3X", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ;~3X
         //
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("uIy89tT~U``FE9E");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: uIy89tT~U``FE9E
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(".\"-8BFxc", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .\"-8BFxc
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("p2wJwJ", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".\"-8BFxc");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("wAA'?IGWY0%_zi,e8");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: wAA'?IGWY0%_zi,e8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("v^T@", (Object) typeHandler0);
