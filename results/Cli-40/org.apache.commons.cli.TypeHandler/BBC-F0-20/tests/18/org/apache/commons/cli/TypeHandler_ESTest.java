...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("[eu` (&gqQ`Wb>:jm");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "MQ#o$SOMl6H[]u8S9");
      FileInputStream fileInputStream0 = TypeHandler.openFile("[eu` (&gqQ`Wb>:jm");
  ...
  public void test04()  throws Throwable  {
      ...
      File file0 = TypeHandler.createFile("[eu` (&gqQ`Wb>:jm");
      assertEquals(0L, file0.getTotalSpace());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".TepPeO9%85IjoJ");
      assertFalse(file0.canExecute());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/@[X7 &ip!5");
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("[eu` (&gqQ`Wb>:jm", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: [eu` (&gqQ`Wb>:jm
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("[eu` (&gqQ`Wb>:jm");
        fail("Expecting exception: Exception");
  ...
  public void test20()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("]nwevdG)3n", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("o2[l*2bT");
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("f&zRLI~:$tl&|t}0(YO");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("[eu` (&gqQ`Wb>:jm");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: [eu` (&gqQ`Wb>:jm
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
