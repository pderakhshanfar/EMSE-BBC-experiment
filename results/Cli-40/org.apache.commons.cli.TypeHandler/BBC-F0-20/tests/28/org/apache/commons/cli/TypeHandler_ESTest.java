...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("g&,ht<", (Object) class0);
      assertEquals("g&,ht<", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".A91\"!H!*} Sc~ioyd");
      assertEquals(".A91\"!H!*} Sc~ioyd", file0.getName());
  }
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/;_!f_L.q4");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "/;_!f_L.q4");
      File file0 = TypeHandler.createFile("/;_!f_L.q4");
  ...
  public void test06()  throws Throwable  {
      try { 
        TypeHandler.openFile("1UP{JY1");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 1UP{JY1
         //
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("w43CTxr+,*\"xM[", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: w43CTxr+,*\"xM[
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("e;A&%_{(\"f2F,6li;w", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: e;A&%_{(\"f2F,6li;w
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("_g6&W|xOTH");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: _g6&W|xOTH
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("'myu5XPc(`R]d{V", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("g&,ht<", class0);
      assertEquals("g&,ht<", string0);
  }
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("/;_!f_L.q4");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL(",!WkShU|hRup+e");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ,!WkShU|hRup+e
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
