...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("V'#-1mT$gDJXI]0");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("V'#-1mT$gDJXI]0");
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("V'#-1mT$gDJXI]0");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "KIf");
      FileInputStream fileInputStream0 = TypeHandler.openFile("V'#-1mT$gDJXI]0");
  ...
  public void test05()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "tMrQwfPIeS");
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("94", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 94
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("qknIWT!5W[", class0);
      assertNull(integer0);
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL("F'dD=)&B+EF<k");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: F'dD=)&B+EF<k
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("RQ.duVG3");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.openFile("V'#-1mT$gDJXI]0");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: V'#-1mT$gDJXI]0
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
