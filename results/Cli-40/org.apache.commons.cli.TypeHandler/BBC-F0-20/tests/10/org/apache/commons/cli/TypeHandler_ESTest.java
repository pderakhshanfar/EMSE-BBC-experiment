...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      FileInputStream fileInputStream0 = TypeHandler.openFile("0");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".14`4Q wjY?P");
      assertFalse(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/*6Qu7@t)l");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("q8", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: q8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createNumber(";$x]CCX^xMd.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \";$x]CCX^xMd.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
