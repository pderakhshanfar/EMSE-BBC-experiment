...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("4+O");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("4+O");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("$IH4htY>");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "k]y=pZQ1CBgG5WVh");
      FileInputStream fileInputStream0 = TypeHandler.openFile("$IH4htY>");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("3_9SMQi2SilXEi", (Object) class0);
      assertEquals("3_9SMQi2SilXEi", object0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "M~'?iOqKZX}FHPW");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".X2d.S,Lu3\"=WN2lh");
      assertNull(file0.getParent());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/H7/-@I]JtJyAm#oedh");
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("(%jTm'I+]gOUb", (Object) "(%jTm'I+]gOUb");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createObject("W|\"n[fRUnWPh8p");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: W|\"n[fRUnWPh8p
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("$IH4htY>", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("GGs%x!7H53", class0);
      assertEquals("GGs%x!7H53", string0);
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("4+O");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 4+O
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.createClass("4+O");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 4+O
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
