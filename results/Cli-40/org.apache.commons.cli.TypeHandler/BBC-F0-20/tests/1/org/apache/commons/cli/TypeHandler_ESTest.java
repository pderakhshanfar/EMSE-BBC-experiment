...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(">2#`,n^QvnJkt^>Qvn");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile(">2#`,n^QvnJkt^>Qvn");
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(">2#`,n^QvnJkt^>Qvn");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ",<Uc*p>M` WP=I;+4T");
      FileInputStream fileInputStream0 = TypeHandler.openFile(">2#`,n^QvnJkt^>Qvn");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("cw");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("cw");
      assertTrue(file0.exists());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("Jl={rm/.y~Eghv=NN");
      assertEquals("Jl={rm", file0.getParent());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/srJ%XRT|z!7eW`");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("cw", (Object) "cw");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL("d|j^BPcq3@5");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: d|j^BPcq3@5
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
