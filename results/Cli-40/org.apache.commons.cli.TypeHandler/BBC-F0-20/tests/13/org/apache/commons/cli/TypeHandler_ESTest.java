...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("~P917K=SN<|sZNlYm");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("~P917K=SN<|sZNlYm");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/c'`e}");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "/c'`e}");
      FileInputStream fileInputStream0 = TypeHandler.openFile("/c'`e}");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/c'`e}");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("ZJP[>M", (Object) "ZJP[>M");
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("./~)DNJ*", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createObject("c,)FI@~9l");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: c,)FI@~9l
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("/n71(M[f,P3zK I.L");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"/n71(M[f,P3zK I.L\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("G0yB|#nET~");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("~P917K=SN<|sZNlYm");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ~P917K=SN<|sZNlYm
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Object object0 = TypeHandler.createValue("Vh", (Object) null);
      assertNull(object0);
  }
}
