...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/Gr?M8wA#1P-4>5");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "' was specified but an option from this group ");
      FileInputStream fileInputStream0 = TypeHandler.openFile("/Gr?M8wA#1P-4>5");
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("L`flRyGb", (Object) class0);
      assertEquals("L`flRyGb", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("*A7:YNMdgcA|@.", class0);
      assertEquals("*A7:YNMdgcA|@.", string0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/Gr?M8wA#1P-4>5");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "' was specified but an option from this group ");
      File file0 = TypeHandler.createFile("/Gr?M8wA#1P-4>5");
      assertEquals("/Gr?M8wA#1P-4>5", file0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("p6;k7g#", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: p6;k7g#
         //
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("=7e^6\"+", class0);
      assertNull(integer0);
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("/Gr?M8wA#1P-4>5");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: /Gr?M8wA#1P-4>5
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
