...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("`r)Ywd=");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("`r)Ywd=");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".gvJ,(%zdQ.(pi(ir<");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/~CdM5h1.]LIJhzsv");
  ...
  public void test08()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Unable to find the class: ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "rhp]3x_L");
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("@/`BQKz2%jtjB0Pe2A!", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: @/`BQKz2%jtjB0Pe2A!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("pX<L zZ!#", (Object) "pX<L zZ!#");
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("PWf");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: PWf
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("5", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber(":: d.Jk`At<to|=\"XTP");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \":: d.Jk`At<to|=\"XTP\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("V'+\"'g");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: V'+\"'g
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("C*0xw*8:]:");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("`r)Ywd=");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: `r)Ywd=
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Object object0 = TypeHandler.createValue("5", (Object) null);
      assertNull(object0);
  }
}
