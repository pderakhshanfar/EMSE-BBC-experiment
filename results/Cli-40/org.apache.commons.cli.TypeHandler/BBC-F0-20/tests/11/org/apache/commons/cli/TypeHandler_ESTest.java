...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      FileInputStream fileInputStream0 = TypeHandler.openFile("K");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("Mui/.s^@le");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/oB,pw");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/oB,pw");
  ...
  public void test09()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("W^m0NY+mE", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: W^m0NY+mE
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("<'gIb4");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: <'gIb4
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("XyXnYuM", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("3]JWtj>:`>_[{26Tn;@");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 3]JWtj>:`>_[{26Tn;@
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("O/%yBq~");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: O/%yBq~
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
