...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("(g7");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("(g7");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("YdfjBJ.", (Object) class0);
      assertEquals("YdfjBJ.", object0);
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".h\"`k_");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("y8K)%?j@iqln/:H?@e#", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: y8K)%?j@iqln/:H?@e#
         //
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("YdfjBJ.", (Object) "YdfjBJ.");
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("W>HW%IiIt", class0);
      assertNull(integer0);
  }
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("IHhyhc1kUec", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: IHhyhc1kUec
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("[YD9Y", class0);
      assertEquals("[YD9Y", string0);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/S3=R}%gTqW-\"'");
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.createClass("5Y]u^");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 5Y]u^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
