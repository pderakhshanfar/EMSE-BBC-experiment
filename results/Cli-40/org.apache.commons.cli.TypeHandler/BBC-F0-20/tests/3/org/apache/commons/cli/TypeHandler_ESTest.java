...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("U?*mUf`=>!!bu)x");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("U?*mUf`=>!!bu)x");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("bWZ]uLr2 )gq)FUx_", (Object) class0);
      assertEquals("bWZ]uLr2 )gq)FUx_", object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".8F<bpRsiBAaQ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Ye[mx|");
      File file0 = TypeHandler.createFile(".8F<bpRsiBAaQ");
      assertEquals(0L, file0.getTotalSpace());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/n;qwkAB;bv13");
      assertEquals(0L, file0.getTotalSpace());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("`h*NuZENI6{", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: `h*NuZENI6{
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue((String) null, (Object) "R");
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("S_fZ\"2\"b`eK", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("bWZ]uLr2 )gq)FUx_", class0);
      assertEquals("bWZ]uLr2 )gq)FUx_", string0);
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("uz%IC");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: uz%IC
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("U?*mUf`=>!!bu)x");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: U?*mUf`=>!!bu)x
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
