...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("IBmfpWm~Y)9r$m16wE");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("IBmfpWm~Y)9r$m16wE");
  ...
  public void test04()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("w=Ii}0cy)d@}", (Object) class0);
      assertEquals("w=Ii}0cy)d@}", object0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".2sA_na%i&'Z");
      assertEquals(".2sA_na%i&'Z", file0.getName());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Y<_:7hVWkM>ae");
      File file0 = TypeHandler.createFile("--");
      assertFalse(file0.isAbsolute());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("org.apache.commons.cli.Option$1", object0);
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createClass("Ube|fxA(<bEZ\"d9>otf");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Ube|fxA(<bEZ\"d9>otf
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("|'{,etU4i41.V(#)B(", class0);
      assertEquals("|'{,etU4i41.V(#)B(", string0);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      File file0 = TypeHandler.createFile("/|ea IT");
  ...
  public void test31()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("wb*t", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: wb*t
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
