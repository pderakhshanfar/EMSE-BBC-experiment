...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      try { 
        TypeHandler.openFile(",_h2Wp3O>/Uw:8KB");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ,_h2Wp3O>/Uw:8KB
         //
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("V3lSQ-Okss9");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("V3lSQ-Okss9");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("8'U66.R5Fl?Fq5~*C)P");
      byte[] byteArray0 = new byte[7];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("8'U66.R5Fl?Fq5~*C)P");
      assertEquals(0L, file0.getUsableSpace());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/.9@QOD16m*B14uD{");
      assertEquals("/.9@QOD16m*B14uD{", file0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("c=/vvQ'v7");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: c=/vvQ'v7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Qm{fCeS", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Qm{fCeS
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
