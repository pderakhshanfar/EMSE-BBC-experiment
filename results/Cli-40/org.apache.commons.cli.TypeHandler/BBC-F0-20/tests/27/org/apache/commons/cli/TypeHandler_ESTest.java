...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".)5)=JKL*9");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile(".)5)=JKL*9");
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".)5)=JKL*9");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Ag");
      FileInputStream fileInputStream0 = TypeHandler.openFile(".)5)=JKL*9");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("mX{g/_Yz~Z6_eFS*", (Object) class0);
      assertEquals("mX{g/_Yz~Z6_eFS*", object0);
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/0$bsng@@+7r");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(")^KBx.#TowlhOn", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: )^KBx.#TowlhOn
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL(".)5)=JKL*9");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: .)5)=JKL*9
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("^ZI8wlWQdy8f^&1_(");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile(".)5)=JKL*9");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: .)5)=JKL*9
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Class<Integer> class0 = Integer.class;
      Object object0 = TypeHandler.createValue("4G?-,=a<UCGM{gUR<]F", (Object) class0);
      assertNull(object0);
  }
}
