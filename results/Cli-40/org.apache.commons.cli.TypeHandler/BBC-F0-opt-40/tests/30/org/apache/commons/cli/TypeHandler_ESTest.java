...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("; 4");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "~vq?");
      FileInputStream fileInputStream0 = TypeHandler.openFile("; 4");
  ...
  public void test04()  throws Throwable  {
      Object object0 = TypeHandler.createValue(";pB-k3z_:@'", (Object) null);
      assertNull(object0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("]4aLO]!m-");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "\"Mlhn@C0={");
      File file0 = TypeHandler.createFile("]4aLO]!m-");
      assertEquals(0L, file0.getTotalSpace());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/#`3J$");
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("ZU{tE", (Object) "ZU{tE");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("a-[Dm");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: a-[Dm
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile(".-kVJJ\"h]>J:");
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("<b&f8Je1,NfK Fy_'3");
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("' was specified but an option from this group ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ' was specified but an option from this group 
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
