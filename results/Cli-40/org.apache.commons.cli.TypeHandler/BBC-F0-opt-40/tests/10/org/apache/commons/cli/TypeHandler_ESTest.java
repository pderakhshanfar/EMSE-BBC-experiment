...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("0Kn@fN;n:+[.5v2va58");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("0Kn@fN;n:+[.5v2va58");
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("0Kn@fN;n:+[.5v2va58");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "FeJ(>65JTpm$");
      FileInputStream fileInputStream0 = TypeHandler.openFile("0Kn@fN;n:+[.5v2va58");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(")!$7~T|NKD", (Object) class0);
      assertEquals(")!$7~T|NKD", object0);
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".JGZ8JXTiXY]{a-Q)O");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/=uV>NCxS6>e_6qF.y");
      assertTrue(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("7v@>ThJk#BL<wGc#tD3");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "kf:]c\b}gU%#9S");
      File file0 = TypeHandler.createFile("7v@>ThJk#BL<wGc#tD3");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.openFile("0Kn@fN;n:+[.5v2va58");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 0Kn@fN;n:+[.5v2va58
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue(",OY56M:dAg|oE", (Object) ",OY56M:dAg|oE");
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("gW*yrrWT;/[p}6dHM^", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: gW*yrrWT;/[p}6dHM^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("=P9xOb',z", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("@`0 D", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: @`0 D
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
