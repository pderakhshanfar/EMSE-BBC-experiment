...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("l`awh;O/pL7");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("l`awh;O/pL7");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".,^w%I9tAar<v");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(")$(`}{bFsRvG(dk", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: )$(`}{bFsRvG(dk
         //
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("XFn?!`Pz3eao&5~e", (Object) "XFn?!`Pz3eao&5~e");
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createObject("Y`5;q5 +^#~Xk");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Y`5;q5 +^#~Xk
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue(")RPU{[L]9Tc=8V;", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createValue("7cKY", (Object) null);
      assertNull(object0);
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("l`awh;O/pL7");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL(" Pp5CVqV>QP");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL:  Pp5CVqV>QP
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("l`awh;O/pL7");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: l`awh;O/pL7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("vFtM;+`..NJmre", (Object) class0);
      assertEquals("vFtM;+`..NJmre", object0);
  }
}
