...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("H{T4/0XS0wGlSRZR");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("H{T4/0XS0wGlSRZR");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("=FZCx:$Z4*", (Object) class0);
      assertEquals("=FZCx:$Z4*", object0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("}!iuawP=|a");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "E?7S)XZ");
      File file0 = TypeHandler.createFile("}!iuawP=|a");
      assertEquals("}!iuawP=|a", file0.getName());
  }
  ...
  public void test11()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(">`TBDYgN/PMR");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "-");
      FileInputStream fileInputStream0 = TypeHandler.openFile(">`TBDYgN/PMR");
      // Undeclared exception!
      try { 
        TypeHandler.createValue(">`TBDYgN/PMR", (Object) fileInputStream0);
  ...
  public void test21()  throws Throwable  {
      Class<Integer> class0 = Integer.class;
      Integer integer0 = TypeHandler.createValue("/vF@.5D", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/vF@.5D");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("~:! ,xxz-0,Ak");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ~:! ,xxz-0,Ak
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("+5ivmC~b");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test30()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("KW^", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: KW^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
