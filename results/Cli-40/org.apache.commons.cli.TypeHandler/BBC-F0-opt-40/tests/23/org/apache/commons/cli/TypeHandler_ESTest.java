...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("G=oOU{Z7g");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("G=oOU{Z7g");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("l8@;u*7)J8aW");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "E{d)Skx7lW.sRB&r");
      FileInputStream fileInputStream0 = TypeHandler.openFile("l8@;u*7)J8aW");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".fx0%");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/{I` )=T`0Rr5d");
      assertEquals("/", file0.getParent());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("cf");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "EG1w#");
      File file0 = TypeHandler.createFile("cf");
  ...
  public void test08()  throws Throwable  {
      try { 
        TypeHandler.openFile("l8@;u*7)J8aW");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: l8@;u*7)J8aW
         //
  ...
  public void test09()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("org.apache.commons.cli.TypeHan-ler", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: org.apache.commons.cli.TypeHan-ler
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".fx0%");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".fx0%\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("wd)KI'RXGCAH", class0);
      assertEquals("wd)KI'RXGCAH", string0);
  }
