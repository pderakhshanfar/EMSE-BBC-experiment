...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("|`RLH8Ce)=#[1={+hCJ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("|`RLH8Ce)=#[1={+hCJ");
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("|`RLH8Ce)=#[1={+hCJ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "#bI3#+J./b`/xFX");
      FileInputStream fileInputStream0 = TypeHandler.openFile("|`RLH8Ce)=#[1={+hCJ");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/VaA&^S(");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Wz");
      File file0 = TypeHandler.createFile("/VaA&^S(");
      assertEquals("VaA&^S(", file0.getName());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".4Iqqm,!~HYBm`\"");
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Hp`A*?ZC3ay(+)", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Hp`A*?ZC3ay(+)
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("&1Y;", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("!!,iCC");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: !!,iCC
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("t7y;#X)^E'1=j'bif3n");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("|`RLH8Ce)=#[1={+hCJ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: |`RLH8Ce)=#[1={+hCJ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
