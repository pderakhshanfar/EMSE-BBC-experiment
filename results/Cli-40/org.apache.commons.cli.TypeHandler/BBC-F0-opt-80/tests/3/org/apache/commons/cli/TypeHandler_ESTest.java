...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".Ks+$R0Wbsv+");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile(".Ks+$R0Wbsv+");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("+;Xt");
      byte[] byteArray0 = new byte[9];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("+;Xt");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("aD;E+>*^", (Object) class0);
      assertEquals("aD;E+>*^", object0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "\"}GL");
  ...
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/P5v*K/}a+7NR[(");
      assertEquals("/P5v*K/}a+7NR[(", file0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".Ks+$R0Wbsv+");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile(".Ks+$R0Wbsv+");
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createClass("GkohVE~]iec");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: GkohVE~]iec
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue(".Ks+$R0Wbsv+", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("~^|qR<L:x%7", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ~^|qR<L:x%7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile(".Ks+$R0Wbsv+");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: .Ks+$R0Wbsv+
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
