...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("ec:X3{|heU|i~R");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("ec:X3{|heU|i~R");
  ...
  public void test05()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("i~_/PnSWhM'H^Y)R", class0);
      assertEquals("i~_/PnSWhM'H^Y)R", string0);
  }
  ...
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/R^YL");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "3Bwp*9Q_@oeo");
      File file0 = TypeHandler.createFile("/R^YL");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("woGbWcOSJX/U>P", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: woGbWcOSJX/U>P
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".sm@Zh1OYUbaQlvg8-n");
