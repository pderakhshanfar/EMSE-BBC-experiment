...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("N:~6V");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("N:~6V");
  ...
  public void test04()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("6u<h&Z_\"bD]V", (Object) class0);
      assertEquals("6u<h&Z_\"bD]V", object0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("}hgO]`8N?Xo69<N@x>a");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "}hgO]`8N?Xo69<N@x>a");
      File file0 = TypeHandler.createFile("}hgO]`8N?Xo69<N@x>a");
      assertEquals(0L, file0.getFreeSpace());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".qQH<n*{2;FBuG0|K");
      assertEquals(0L, file0.getFreeSpace());
  }
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("", (Object) ".qQH<n*{2;FBuG0|K");
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createObject("}hgO]`8N?Xo69<N@x>a");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: }hgO]`8N?Xo69<N@x>a
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/?hfjoN");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("=br  {4{!WtOt");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("nf2sW(e6>)&O_F$d");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: nf2sW(e6>)&O_F$d
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("N:~6V");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: N:~6V
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Object object0 = TypeHandler.createValue("/?hfjoN", (Object) null);
      assertNull(object0);
  }
}
