...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("W^-y/Hz||g:%n");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("W^-y/Hz||g:%n");
      assertFalse(file0.isHidden());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".'[Q8Th%PvDW\"`");
      assertEquals(0L, file0.getUsableSpace());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/pD%-dj8");
      assertEquals("pD%-dj8", file0.getName());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("]aePpc@In.:},3k6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ]aePpc@In.:},3k6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("9(b", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("VR", class0);
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("R/M<Nh}2l~~0}");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("Z]?DfT[egw^vP");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: Z]?DfT[egw^vP
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("W^-y/Hz||g:%n");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("o2J8^j:pe.!pBaH<9Rs");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: o2J8^j:pe.!pBaH<9Rs
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
