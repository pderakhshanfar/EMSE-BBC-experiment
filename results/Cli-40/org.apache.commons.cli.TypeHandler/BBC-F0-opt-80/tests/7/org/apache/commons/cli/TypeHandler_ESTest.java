...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("|s5IU*lx>X 5E+z", (Object) class0);
      assertEquals("|s5IU*lx>X 5E+z", object0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("i}`+W.J8|WlzKM|");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("i}`+W.J8|WlzKM|");
      assertEquals(6L, file0.length());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/%zE");
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("')F", (Object) "`DLF-p?{4J'Rv");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("Tfl\"oBB*");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Tfl\"oBB*
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("/%zE", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("j{>5_S", class0);
      assertEquals("j{>5_S", string0);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile(".HeQD#d2%xg,*tK0_%7");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("qnl=ycH%uZn0!,Z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: qnl=ycH%uZn0!,Z
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
