...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("F|Cx^Xplc(y -");
      byte[] byteArray0 = new byte[7];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("F|Cx^Xplc(y -");
  ...
  public void test04()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[7];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("F|Cx^Xplc(y -");
      assertTrue(file0.canWrite());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/d|H");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile(".pq3}J$IvJA>Sz");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("z0@", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: z0@
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("!Z+%V", class0);
      assertNull(integer0);
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("QN.Y");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"QN.Y\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("B=q/e]", class0);
      assertEquals("B=q/e]", string0);
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("_&;{H");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: _&;{H
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
