...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".VZVY");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ".VZVY");
      FileInputStream fileInputStream0 = TypeHandler.openFile(".VZVY");
  ...
  public void test03()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("NKgvjiA!E:e", class0);
      assertEquals("NKgvjiA!E:e", string0);
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/%.?\"=N`;<\"y");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".VZVY");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ".VZVY");
      File file0 = TypeHandler.createFile(".VZVY");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("B9RjwtI/'Md0GM", (Object) "B9RjwtI/'Md0GM");
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createObject(",W~?yl*");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ,W~?yl*
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("\"vo[\"]FQK(fk*9l0>");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: \"vo[\"]FQK(fk*9l0>
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("!*GG!", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: !*GG!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue(".VZVY", class0);
      assertNull(integer0);
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("a|iaS3wm; ");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL(")tT{\"-)3sc$HKOFLf");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: )tT{\"-)3sc$HKOFLf
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile(".VZVY");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: .VZVY
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
