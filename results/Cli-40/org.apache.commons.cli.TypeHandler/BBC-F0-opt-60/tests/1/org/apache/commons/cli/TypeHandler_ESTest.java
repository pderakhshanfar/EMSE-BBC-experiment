...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("slH0Bo");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "6:U:Az3tKFdUnFt");
      FileInputStream fileInputStream0 = TypeHandler.openFile("slH0Bo");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/``pQAM;#cq7");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "/``pQAM;#cq7");
      File file0 = TypeHandler.createFile("/``pQAM;#cq7");
  ...
  public void test13()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("ro= ec", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ro= ec
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("8s,E3E>~1?Z5ZS,", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("6:U:Az3tKFdUnFt", class0);
      assertEquals("6:U:Az3tKFdUnFt", string0);
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".k)JcndO+y\"");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("\"n|g]ZScki(zDW1A");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: \"n|g]ZScki(zDW1A
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("slH0Bo");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: slH0Bo
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
