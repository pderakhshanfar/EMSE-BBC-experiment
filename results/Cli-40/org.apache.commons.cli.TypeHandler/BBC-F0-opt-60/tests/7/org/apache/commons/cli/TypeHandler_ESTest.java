...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("@+Z=PHe+H%;h_p");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("@+Z=PHe+H%;h_p");
  ...
  public void test03()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "],hEH1\"Q>& %$idl");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/-?s~/P<d,");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.openFile("@+Z=PHe+H%;h_p");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: @+Z=PHe+H%;h_p
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("G]p`^#bqHyTN.w", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: G]p`^#bqHyTN.w
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("7GF\rI]bCfX|K", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 7GF\rI]bCfX|K
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("BXNuqVS34@T*9");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: BXNuqVS34@T*9
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("5kWB.QJa", class0);
      assertNull(integer0);
  }
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("; J[59w1KXY");
        fail("Expecting exception: UnsupportedOperationException");
