...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(">bE1;+n3V$Y");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile(">bE1;+n3V$Y");
  ...
  public void test03()  throws Throwable  {
      Object object0 = TypeHandler.createValue("^<&>c>R8|;A#KT", (Object) null);
      assertNull(object0);
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/^uZC~df;P%waIT@ek");
  ...
  public void test07()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[7];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(">bE1;+n3V$Y");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("m", (Object) "");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("bMBU_ 9{,");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: bMBU_ 9{,
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("lKA.`=fOM");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"lKA.`=fOM\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile(".`%) YmP|wXn");
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles(">bE1;+n3V$Y");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile(">bE1;+n3V$Y");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: >bE1;+n3V$Y
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
