...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("i$q^hQ3.mOwTPZz");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("i$q^hQ3.mOwTPZz");
  ...
  public void test04()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue(".|`p]CgXo", class0);
      assertEquals(".|`p]CgXo", string0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".6V,Rk");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "; Unable to create an instance of: ");
      File file0 = TypeHandler.createFile(".6V,Rk");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/K3ahZe%N)/Y;.o");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.openFile("i$q^hQ3.mOwTPZz");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: i$q^hQ3.mOwTPZz
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("nO n!,o", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: nO n!,o
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("r1SL}j}`qJS,", (Object) ".|`p]CgXo");
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("g;W`Y: |6A", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: g;W`Y: |6A
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("e[:wC/H.,V%*Mn@3^!");
        fail("Expecting exception: UnsupportedOperationException");
