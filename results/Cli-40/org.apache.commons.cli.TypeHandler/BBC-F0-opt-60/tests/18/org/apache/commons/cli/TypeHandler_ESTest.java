...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".f+l(bcr9~`]hh~WRs");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, " ] [ long ");
      FileInputStream fileInputStream0 = TypeHandler.openFile(".f+l(bcr9~`]hh~WRs");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("a<Sv2]Mlgs", (Object) class0);
      assertEquals("a<Sv2]Mlgs", object0);
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/$^2E}vuZ2sFkWt");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".f+l(bcr9~`]hh~WRs");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, " ] [ long ");
      File file0 = TypeHandler.createFile(".f+l(bcr9~`]hh~WRs");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("04A[U43VFV", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 04A[U43VFV
         //
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("]e!/QfhkJ", (Object) "]e!/QfhkJ");
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createObject("hi2;tJD.E;`ge!ok");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: hi2;tJD.E;`ge!ok
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("YQp|[Lu8J:5l3?-");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile(".f+l(bcr9~`]hh~WRs");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: .f+l(bcr9~`]hh~WRs
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
