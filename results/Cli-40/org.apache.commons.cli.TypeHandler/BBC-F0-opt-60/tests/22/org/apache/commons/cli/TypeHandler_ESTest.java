...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("p*z)1f*?s1A@jz");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("p*z)1f*?s1A@jz");
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("p*z)1f*?s1A@jz");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "meC");
      FileInputStream fileInputStream0 = TypeHandler.openFile("p*z)1f*?s1A@jz");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("p*z)1f*?s1A@jz");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "meC");
      File file0 = TypeHandler.createFile("p*z)1f*?s1A@jz");
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("O", class0);
        fail("Expecting exception: Exception");
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue(".csS{#\"p('3kx", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("Y.=Mrzg<N^v77Z[");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"Y.=Mrzg<N^v77Z[\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".csS{#\"p('3kx");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("v");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: v
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
