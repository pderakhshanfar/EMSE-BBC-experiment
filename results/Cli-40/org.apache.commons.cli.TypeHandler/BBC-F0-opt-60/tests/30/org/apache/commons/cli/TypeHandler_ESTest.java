...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("g@^niA(JVU:(9]Tc+H");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("g@^niA(JVU:(9]Tc+H");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("t]D9<NYZcR3NhDmH ?<", (Object) class0);
      assertEquals("t]D9<NYZcR3NhDmH ?<", object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("xGii)_");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "MDVx`LPZ(NBN");
      File file0 = TypeHandler.createFile("xGii)_/");
  ...
  public void test08()  throws Throwable  {
      try { 
        TypeHandler.openFile("g@^niA(JVU:(9]Tc+H");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: g@^niA(JVU:(9]Tc+H
         //
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("t]D9<NYZcR3NhDmH ?<", (Object) "t]D9<NYZcR3NhDmH ?<");
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("t]D9<NYZcR3NhDmH ?<", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("lVu>gCm", class0);
      assertEquals("lVu>gCm", string0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("DOR$s|RML7]", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: DOR$s|RML7]
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/.mb,'");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("IAU -n; 'ys#Lf|4ae");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("I%:(;#@~H(by'");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: I%:(;#@~H(by'
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Object object0 = TypeHandler.createValue("lVu>gCm", (Object) null);
      assertNull(object0);
  }
}
