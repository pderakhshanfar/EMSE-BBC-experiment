...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("R,0M~x-b|U<{/Cwj 8", (Object) class0);
      assertEquals("R,0M~x-b|U<{/Cwj 8", object0);
  }
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("UnablZ to parse the URL: ");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, " ]");
      File file0 = TypeHandler.createFile("UnablZ to parse the URL: ");
      assertEquals(0L, file0.getUsableSpace());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".,IPd$E>");
      assertNull(file0.getParent());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/WMySr?DU^W0nNYT9m");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("[Fu(kp0$P`W-ObZkd", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: [Fu(kp0$P`W-ObZkd
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("R,0M~x-b|U<{/Cwj 8", class0);
      assertEquals("R,0M~x-b|U<{/Cwj 8", string0);
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("ST0Bma7z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ST0Bma7z
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Object object0 = TypeHandler.createValue("UnablZ to parse the URL: ", (Object) null);
      assertNull(object0);
  }
}
