...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Unable to find file: ");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "s[gYufgYqqA8VW");
      FileInputStream fileInputStream0 = TypeHandler.openFile("Unable to find file: ");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/=4pa+<");
      assertEquals("/=4pa+<", file0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Y;*O:$PB.:z", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Y;*O:$PB.:z
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("C|as");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: C|as
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Number number0 = TypeHandler.createNumber("68");
      assertEquals(68L, number0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("3b~Z;p ,e;c", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 3b~Z;p ,e;c
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".i#Jv*");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("aMr2#aL1e80!0J^");
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("b*V0^0J&5Jj8_X}cY");
        fail("Expecting exception: UnsupportedOperationException");
