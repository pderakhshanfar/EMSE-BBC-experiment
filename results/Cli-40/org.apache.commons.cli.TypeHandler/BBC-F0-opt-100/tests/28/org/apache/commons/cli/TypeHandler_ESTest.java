...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("2v$[a45");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("2v$[a45");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("^g7V`?");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("^g7V`?");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Cannt add value, lst full.");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "[ option: ");
      File file0 = TypeHandler.createFile("Cannt add value, lst full.");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/&i68;e7,J7S${g`.e");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("TKxO<F");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: TKxO<F
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("T1\"00:/azKK,", class0);
      assertNull(integer0);
  }
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("2v$[a45");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("2v$[a45");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 2v$[a45
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
