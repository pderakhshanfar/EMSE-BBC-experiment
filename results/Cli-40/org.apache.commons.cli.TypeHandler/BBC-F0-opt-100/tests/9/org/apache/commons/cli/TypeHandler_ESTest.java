...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("U2");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "m+/");
      FileInputStream fileInputStream0 = TypeHandler.openFile("U2");
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("__kyS%?>0OS%EBj#?B", (Object) class0);
      assertEquals("__kyS%?>0OS%EBj#?B", object0);
  }
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("CJQ[J^|IT");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "CJQ[J^|IT");
      File file0 = TypeHandler.createFile("CJQ[J^|IT");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".e\"7',-z#&g.#kU");
      assertTrue(file0.isFile());
  }
  ...
  public void test07()  throws Throwable  {
      try { 
        TypeHandler.openFile("U2");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: U2
         //
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("%P=.`QXaR#XM!'Pw", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: %P=.`QXaR#XM!'Pw
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("3VNB0");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 3VNB0
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("H0nYOS&wjNtl@fH n45", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("w", class0);
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/y2`oV2nw\"|-v_");
