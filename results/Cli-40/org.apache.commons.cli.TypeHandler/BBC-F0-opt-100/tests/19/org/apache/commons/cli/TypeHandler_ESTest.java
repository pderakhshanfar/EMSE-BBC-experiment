...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      try { 
        TypeHandler.openFile("WDyYVkYqccD~-S");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: WDyYVkYqccD~-S
         //
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("72");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("72");
  ...
  public void test05()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("ZFP*t^\"ogK", (Object) class0);
      assertEquals("ZFP*t^\"ogK", object0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("72");
      assertFalse(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/vm");
      assertEquals("vm", file0.getName());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile(".\";d9");
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("j4m],Ls-.Ro-", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: j4m],Ls-.Ro-
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createClass(",yDp&Rfn5+OK%W|");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ,yDp&Rfn5+OK%W|
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("ZFP*t^\"ogK", class0);
      assertEquals("ZFP*t^\"ogK", string0);
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("erAgzcL");
