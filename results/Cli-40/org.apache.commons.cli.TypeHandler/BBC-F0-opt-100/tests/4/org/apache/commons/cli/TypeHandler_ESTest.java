...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("##*T6>eEa`j Yu$RB-");
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("##*T6>eEa`j Yu$RB-");
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("=4~V.Wc)", (Object) class0);
      assertNull(object0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("hw%C~U`vk!SO", (Object) class0);
      assertEquals("hw%C~U`vk!SO", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".<3R!1^82^UQC]v");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/4\"BM(N.{.4M%");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("@E~h>RLk", object0);
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("P8yA1Iv6e0&3");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: P8yA1Iv6e0&3
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<Integer> class0 = Integer.class;
      Integer integer0 = TypeHandler.createValue("=S4~.W$c)", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("hw%C~U`vk!SO", class0);
      assertEquals("hw%C~U`vk!SO", string0);
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("o%cM@B2AKA!9mr");
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("X5;SeX[f");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("##*T6>eEa`j Yu$RB-");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ##*T6>eEa`j Yu$RB-
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
