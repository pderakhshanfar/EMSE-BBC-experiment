...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("y7bM]]$[}7+0A");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("y7bM]]$[}7+0A");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("x|_Y}");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "x|_Y}");
      FileInputStream fileInputStream0 = TypeHandler.openFile("x|_Y}");
      assertEquals(5, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Object object0 = TypeHandler.createValue("YIOswR-r3p7IY}", (Object) null);
      assertNull(object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(",fo9o3+ScL0h*&%");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "n;q/=[S-[");
      File file0 = TypeHandler.createFile(",fo9o3+ScL0h*&%");
      assertEquals(0L, file0.getFreeSpace());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".S@-u8HTHpPSA;z^");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("<qFhS\"`", (Object) "<qFhS\"`");
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("JU@3Qzde.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"JU@3Qzde.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("y7bM]]$[}7+0A");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("YRA!");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: YRA!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("JFChIbrRn/b");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("y7bM]]$[}7+0A");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: y7bM]]$[}7+0A
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
