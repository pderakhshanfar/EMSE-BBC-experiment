...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Unable to findfile: ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Unable to findfile: ");
      FileInputStream fileInputStream0 = TypeHandler.openFile("Unable to findfile: ");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("ZT~OZ|", (Object) class0);
      assertEquals("ZT~OZ|", object0);
  }
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".ousQ3u NP);H4");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, ".ousQ3u NP);H4");
      File file0 = TypeHandler.createFile(".ousQ3u NP);H4");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("/\" HBcRfF_", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /\" HBcRfF_
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Ff3O0bKJe\"0X`", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Ff3O0bKJe\"0X`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("org.apache.commons.cli.$arseException");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"org.apache.commons.cli.$arseException\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("0NvGhrD= ", class0);
      assertEquals("0NvGhrD= ", string0);
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/(a_YL");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("X]EOTmfz_jJdnE(rAa&");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("Unable to findfile: ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: Unable to findfile: 
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
