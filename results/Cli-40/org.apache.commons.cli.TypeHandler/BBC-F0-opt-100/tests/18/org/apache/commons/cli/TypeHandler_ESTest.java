...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("A0A;T@^P;,");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("A0A;T@^P;,");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("=1%=;Hp", (Object) class0);
      assertEquals("=1%=;Hp", object0);
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".<5lk%S#Y=t");
  ...
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("$M@;~Sh5#");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("$M@;~Sh5#");
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("8f*'f:", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 8f*'f:
         //
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("T,n_6[M1h", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("WJ_]A?=Yv_/NWMl|#&", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: WJ_]A?=Yv_/NWMl|#&
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Z>'( Stt;yZdu");
      assertFalse(file0.isDirectory());
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("$M@;~Sh5#");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: $M@;~Sh5#
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("*ue]U}4^erRShPN^v_", (Object) typeHandler0);
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("A0A;T@^P;,");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: A0A;T@^P;,
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
