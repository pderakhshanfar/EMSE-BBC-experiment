...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(";29ReY EWBG");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, " ]");
      File file0 = TypeHandler.createFile(";29ReY EWBG");
      assertEquals(0L, file0.getUsableSpace());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/&'#\"0Zn|Zt}GTu");
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("YDHc[/-,e>To(#ofS.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"YDHc[/-,e>To(#ofS.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".j'1wo6jL{");
      assertEquals(0L, file0.getUsableSpace());
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("./6[wsQtT*r}6Uf");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("Z0[9AMv^${Z}c}*X");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: Z0[9AMv^${Z}c}*X
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.createClass(".j'1wo6jL{");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .j'1wo6jL{
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
