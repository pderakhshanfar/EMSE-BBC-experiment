...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("EnnE~vVS01J)X");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("EnnE~vVS01J)X");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("a%0}@y!-5cta?rcD");
      byte[] byteArray0 = new byte[9];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("a%0}@y!-5cta?rcD");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("sqf@zU?mcI_qVKJ", (Object) class0);
      assertEquals("sqf@zU?mcI_qVKJ", object0);
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/VqsZT$FoEto_M");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("2@Q");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "kp6Iho7;B*Uj");
      File file0 = TypeHandler.createFile("2@Q");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("ew-GWE", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ew-GWE
         //
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("/Pz/oV");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /Pz/oV
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("X#,i?lHbpo,Ic=D*>H", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("sqf@zU?mcI_qVKJ", class0);
      assertEquals("sqf@zU?mcI_qVKJ", string0);
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("EnnE~vVS01J)X");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL("[Bi>T");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: [Bi>T
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("X#,i?lHbpo,Ic=D*>H");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.openFile("EnnE~vVS01J)X");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: EnnE~vVS01J)X
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
