...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Object object0 = TypeHandler.createValue("n:x2*d_^", (Object) null);
      assertNull(object0);
  }
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/!n?^C");
      assertEquals(0L, file0.getTotalSpace());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("B~9j1/~wR[?L'dt Wv");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("B~9j1/~wR[?L'dt Wv");
      assertEquals("B~9j1", file0.getParent());
  }
  ...
  public void test07()  throws Throwable  {
      try { 
        TypeHandler.openFile("|\"$+dzaHo");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: |\"$+dzaHo
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue(":EaOx5b+UC,|!-", class0);
      assertEquals(":EaOx5b+UC,|!-", string0);
  }
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("p", (Object) class0);
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Us");
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("2\"6+pZW\"4");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("B~9j1/~wR[?L'dt Wv");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createClass("<{bKWiVich_'$");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: <{bKWiVich_'$
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue(":EaOx5b+UC,|!-", (Object) class0);
      assertEquals(":EaOx5b+UC,|!-", object0);
  }
}
