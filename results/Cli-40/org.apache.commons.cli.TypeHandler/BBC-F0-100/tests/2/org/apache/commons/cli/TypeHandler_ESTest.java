...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("`N#AQP");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("`N#AQP");
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("V7HejTD0W8m{_NyP");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("V7HejTD0W8m{_NyP");
      assertTrue(file0.canExecute());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Ux,\"");
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue((String) null, (Object) "VyV#");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("}qWleHOb&C0z1");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: }qWleHOb&C0z1
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("VyV#", class0);
      assertEquals("VyV#", string0);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("9,):V=v1(R0..zPt7");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"9,):V=v1(R0..zPt7\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(":q3|)(v5Nd;u7Z)<[W", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: :q3|)(v5Nd;u7Z)<[W
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
