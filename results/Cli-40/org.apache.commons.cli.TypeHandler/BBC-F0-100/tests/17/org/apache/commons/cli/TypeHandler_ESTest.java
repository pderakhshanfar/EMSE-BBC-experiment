...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("W6}qZrTfzttk$");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("W6}qZrTfzttk$");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("P}^|P!+|7;V", (Object) class0);
      assertEquals("P}^|P!+|7;V", object0);
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".f5M&<07");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("7", (Object) class0);
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("*z>dv^#e");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: *z>dv^#e
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createObject(";$|9.Us`f:2 y:+gEBX");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ;$|9.Us`f:2 y:+gEBX
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".PnPC%jXr");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".PnPC%jXr\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("uSj;O^&G<pI?.");
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("xHe4 >i,8 :M3sIl=");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.openFile("2(J~6@edht");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 2(J~6@edht
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
