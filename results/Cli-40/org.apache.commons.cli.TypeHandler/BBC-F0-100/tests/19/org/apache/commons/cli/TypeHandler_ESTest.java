...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("0 *(0]cio*C");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("0 *(0]cio*C");
  ...
  public void test04()  throws Throwable  {
      Object object0 = TypeHandler.createValue("K' c", (Object) null);
      assertNull(object0);
  }
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".>0N8>-gs?:ms3");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(".>0N8>-gs?:ms3");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("0 *(0]cio*C");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 0 *(0]cio*C
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
