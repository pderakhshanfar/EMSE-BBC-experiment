...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("FY!");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("FY!");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Nk{,*{o@r");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("Nk{,*{o@r");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Mr2/0Ao8x|*W$|!1'", (Object) class0);
      assertEquals("Mr2/0Ao8x|*W$|!1'", object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("ObhW&?eD.3c_+aO<");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("ObhW&?eD.3c_+aO<");
  ...
  public void test17()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("_?Bz~K79{L-6*\"", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: _?Bz~K79{L-6*\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("#t{|adAusQfo.x");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"#t{|adAusQfo.x\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("Mr2/0Ao8x|*W$|!1'", class0);
      assertEquals("Mr2/0Ao8x|*W$|!1'", string0);
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".wqb@");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("FY!");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: FY!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
