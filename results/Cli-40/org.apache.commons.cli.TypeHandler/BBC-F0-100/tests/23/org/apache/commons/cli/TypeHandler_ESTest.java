...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".2yj*1h?>aSXahUWUah");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "cWT?@-@k}A8(Fa");
      FileInputStream fileInputStream0 = TypeHandler.openFile(".2yj*1h?>aSXahUWUah");
  ...
  public void test04()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("%`PSN}mi-'&U}iJD KN", class0);
      assertEquals("%`PSN}mi-'&U}iJD KN", string0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".2yj*1h?>aSXahUWUah");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("O<VyLi=^%),7c+m)]Q", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: O<VyLi=^%),7c+m)]Q
         //
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("J:n6`G+CJHY.k-, ?");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"J:n6`G+CJHY.k-, ?\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue((String) null, ((PatternOptionBuilder) object0).STRING_VALUE);
      assertNull(string0);
  }
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("_DJYOX\"x[N/FsO9");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: _DJYOX\"x[N/FsO9
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("Nr?E|7+6o(.");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      Object object0 = TypeHandler.createValue("cWT?@-@k}A8(Fa", (Object) null);
      assertNull(object0);
  }
}
