...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "r wt~5");
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals("F}1`LrUo)", file0.getName());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/pl");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("TRw?d! _", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: TRw?d! _
         //
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createNumber("'E`Ny5}D.3!&7n:'re");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"'E`Ny5}D.3!&7n:'re\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      File file0 = TypeHandler.createFile(".2^0=3Z.>5yu]HzFwEI");
      assertFalse(file0.exists());
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate(".2^0=3Z.>5yu]HzFwEI");
