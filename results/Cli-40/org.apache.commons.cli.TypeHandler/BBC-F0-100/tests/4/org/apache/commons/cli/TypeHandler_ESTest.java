...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Number number0 = TypeHandler.createNumber("00");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("@-G/.U(PX.$JS6S\"H)");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("cSP{)ze7J|V]s", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: cSP{)ze7J|V]s
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("wSco}|2nwJC oUo", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: wSco}|2nwJC oUo
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("wM|H", class0);
      assertNull(integer0);
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".cR'iFn( ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".cR'iFn(\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("{Q_wh");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: {Q_wh
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("STx?%[{qz.+V#B$ai");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createClass("c\bO");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: c\bO
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("!\"iZVZ]PM:y47c", (Object) class0);
      assertEquals("!\"iZVZ]PM:y47c", object0);
  }
}
