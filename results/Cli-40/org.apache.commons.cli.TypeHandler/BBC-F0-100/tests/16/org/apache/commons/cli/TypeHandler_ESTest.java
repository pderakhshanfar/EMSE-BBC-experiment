...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(",2C7Y&'&o}");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile(",2C7Y&'&o}");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("'4>^3RJ>c,", (Object) class0);
      assertEquals("'4>^3RJ>c,", object0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("'4>^3RJ>c,", class0);
      assertEquals("'4>^3RJ>c,", string0);
  }
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/V2K/o");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "8#JL}2qe");
      File file0 = TypeHandler.createFile("/V2K/o");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.openFile(",2C7Y&'&o}");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ,2C7Y&'&o}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("1 Z`~=", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 1 Z`~=
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      File file0 = TypeHandler.createFile(".A+I:");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL("/V2K/o");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: /V2K/o
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
