...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("%k2Z%U");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("%k2Z%U");
  ...
  public void test03()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("V]QZqpQ]pp", class0);
      assertEquals("V]QZqpQ]pp", string0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".sSI;");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("i6Z-d~DHA<");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile("i6Z-d~DHA<");
      assertEquals(0L, file0.getTotalSpace());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("!1 'hgM}Q", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: !1 'hgM}Q
         //
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("S(lb", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: S(lb
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("V]QZqpQ]pp");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: V]QZqpQ]pp
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("@xh'?WmOC1t.9BfX");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"@xh'?WmOC1t.9BfX\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("jId(hl$13PL6GLo", (Object) number0);
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/}s77~s");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("uY:C!1joFlFic4");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("%k2Z%U");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: %k2Z%U
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("T8+wQBIkTG;_t", (Object) class0);
      assertEquals("T8+wQBIkTG;_t", object0);
  }
}
