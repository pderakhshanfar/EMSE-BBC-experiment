...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("GRf9}+");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("GRf9}+");
  ...
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/5A1ENMsKv");
      assertEquals("5A1ENMsKv", file0.getName());
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createClass("#H5;mV");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: #H5;mV
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Xx2.2SR+Z-ID]?/5", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Xx2.2SR+Z-ID]?/5
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("&+B}.%.);-S9Za\"97");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"&+B}.%.);-S9Za\"97\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("y^Q!)4)hJFy[L", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("pWQSMs}0WPZ*r:RKZx");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("{yHXt`C\"wof@B");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: {yHXt`C\"wof@B
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
