...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ":15o491x.kPn*Vf1%xf");
      FileInputStream fileInputStream0 = TypeHandler.openFile("=x");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/0Z20.{g3Ev`JY0|");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("q%vN");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("q%vN");
      assertEquals("q%vN", file0.toString());
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("EXP7", (Object) class0);
      assertEquals("EXP7", object0);
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("wxc),w^V0]S");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("EXP7");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: EXP7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("@$wF3b]x*c`+TD%");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: @$wF3b]x*c`+TD%
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
