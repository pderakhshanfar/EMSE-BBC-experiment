...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("8!b}'J");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "W");
      FileInputStream fileInputStream0 = TypeHandler.openFile("8!b}'J");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("8wR(TR", (Object) class0);
      assertEquals("8wR(TR", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".u!DQ");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/RhyS9d");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("org.apache.com{ons.cli.TypeHandler");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("org.apache.com{ons.cli.TypeHandler");
      assertEquals("org.apache.com{ons.cli.TypeHandler", file0.getName());
  }
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("--", (Object) "8wR(TR");
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Zb6ky<Wwu", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Zb6ky<Wwu
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("XGv?IjhK&onJr,C", class0);
      assertEquals("XGv?IjhK&onJr,C", string0);
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("v$$lKg_");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: v$$lKg_
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("%(&<#nRedqHEi#!");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: %(&<#nRedqHEi#!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
