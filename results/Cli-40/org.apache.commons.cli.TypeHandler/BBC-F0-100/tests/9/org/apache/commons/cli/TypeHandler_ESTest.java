...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/\"+_`A@xl%/p");
      assertEquals(0L, file0.length());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".(Zh1s");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Unable=to parse the URL: ");
      File file0 = TypeHandler.createFile(".(Zh1s");
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("u6gfW:f,)");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: u6gfW:f,)
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
