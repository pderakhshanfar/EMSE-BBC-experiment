...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("eDR$4kSdnC`Fr@0N9;");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("eDR$4kSdnC`Fr@0N9;");
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("fhDV5WszM^o", (Object) class0);
      assertEquals("fhDV5WszM^o", object0);
  }
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(" N0");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "XT\"5Hk|Kc");
      File file0 = TypeHandler.createFile(" N0");
      assertFalse(file0.isHidden());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("b>p>q~-/.5TW");
      assertFalse(file0.canRead());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("//Z4(");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("}[#+e9jrcB`H", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: }[#+e9jrcB`H
         //
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("U8P]^,", (Object) "U8P]^,");
  ...
  public void test17()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("xzY", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: xzY
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("fhDV5WszM^o", class0);
      assertEquals("fhDV5WszM^o", string0);
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("V=T^~P!>dna");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("'<}xmBSE]l3YYe");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: '<}xmBSE]l3YYe
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("6REt|&q");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("eDR$4kSdnC`Fr@0N9;");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: eDR$4kSdnC`Fr@0N9;
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
