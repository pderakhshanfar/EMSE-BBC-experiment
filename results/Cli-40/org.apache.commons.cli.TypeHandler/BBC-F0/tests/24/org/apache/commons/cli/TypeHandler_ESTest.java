...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("JE ?Z");
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("JE ?Z");
  ...
  public void test02()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("JE ?Z");
      assertFalse(file0.isHidden());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".5#k>");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/*+9-]_3O;Y)`");
      assertEquals("/*+9-]_3O;Y)`", file0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("&2", (Object) file0);
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass(":4wMJt'");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: :4wMJt'
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("-V4nC{X0[", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: -V4nC{X0[
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue(":4wMJt'", class0);
      assertEquals(":4wMJt'", string0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("vSRXGVQ/", (Object) class0);
      assertEquals("vSRXGVQ/", object0);
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("w't'pxb~x*zKf");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: w't'pxb~x*zKf
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
