...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      try { 
        TypeHandler.openFile(".{#h%}4\"zap?+:l ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: .{#h%}4\"zap?+:l 
         //
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("dGo1h}Ba)");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("dGo1h}Ba)");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Go$_\"]I}");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("bPPH-k:'[H5b)C~k", (Object) "Not yet implemented");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("H=^yr]?~TD", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: H=^yr]?~TD
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("OjV\"q");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: OjV\"q
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("3", class0);
  ...
  public void test20()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("3", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile("/<F@+H=U");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("q1aCvw;2R");
        fail("Expecting exception: UnsupportedOperationException");
