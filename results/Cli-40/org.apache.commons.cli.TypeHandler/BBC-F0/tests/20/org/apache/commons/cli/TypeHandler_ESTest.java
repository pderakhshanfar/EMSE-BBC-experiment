...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("O(.");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "teBY'<Tp'2:>i&ar\"");
      FileInputStream fileInputStream0 = TypeHandler.openFile("O(.");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("k:GsN9q,!]o??rl", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: k:GsN9q,!]o??rl
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("", (Object) "znC1OI");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("G8c0PC,");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: G8c0PC,
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createObject("nO*cuXxqb3)0z:");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: nO*cuXxqb3)0z:
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("CqV!@+>_d0{");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: CqV!@+>_d0{
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
