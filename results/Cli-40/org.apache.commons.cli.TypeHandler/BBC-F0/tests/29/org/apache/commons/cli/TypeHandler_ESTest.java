...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("'N6EbAC.,0");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("'N6EbAC.,0");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("s3DFF");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "}$4u:oOF");
      FileInputStream fileInputStream0 = TypeHandler.openFile("s3DFF");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("J$=9w", (Object) class0);
      assertEquals("J$=9w", object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Unable to arse the URL: ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "org.apache.commons.cli.PatternOptionBuilder");
      File file0 = TypeHandler.createFile("Unable to arse the URL: ");
      assertTrue(file0.exists());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".#5er#;'KT2T|");
      assertEquals(".#5er#;'KT2T|", file0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/g/%G8e/mbl4&3}tUjG");
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("YBi\"*>E", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: YBi\"*>E
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("xok9r:/DIFi(", (Object) "Unable to parse the URL: ");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("\"Cgsf5a9;S<[#");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: \"Cgsf5a9;S<[#
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue(" uFRv", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("?@X%A%zOy.lwh[FzA5");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"?@X%A%zOy.lwh[FzA5\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile(" ] [ long ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file:  ] [ long 
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
