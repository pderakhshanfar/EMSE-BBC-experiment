...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("oL8XYg@uUcIS");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("oL8XYg@uUcIS");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/T\"g");
  ...
  public void test06()  throws Throwable  {
      try { 
        TypeHandler.openFile("oL8XYg@uUcIS");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: oL8XYg@uUcIS
         //
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("#+G|bq}c");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: #+G|bq}c
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("<x+/.7Y9{c\"K9:L");
      assertEquals("<x+", file0.getParent());
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("QYpGvlgs]0q");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("yg2.DRs>\"d");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: yg2.DRs>\"d
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("{DsE@'t'i}LEICX");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test30()  throws Throwable  {
      Object object0 = TypeHandler.createValue("cw>$*%S]vJj] S`y", (Object) null);
      assertNull(object0);
  }
}
