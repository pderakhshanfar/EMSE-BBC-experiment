...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("dIQ9 6w ?)x {gv-@");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "dIQ9 6w ?)x {gv-@");
      File file0 = TypeHandler.createFile("dIQ9 6w ?)x {gv-@");
      assertEquals(18L, file0.length());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".yVxU_k8q)([!g;");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("7bS>InLmx", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 7bS>InLmx
         //
  ...
  public void test23()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("xi$eo2x_", class0);
      assertEquals("xi$eo2x_", string0);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/#}1A]y0=z:b99M)*");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("eM`");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: eM`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
