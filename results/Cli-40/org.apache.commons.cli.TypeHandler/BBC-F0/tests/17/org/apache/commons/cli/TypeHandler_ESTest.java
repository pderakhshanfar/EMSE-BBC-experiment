...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("ndLmVUcYDP<-7");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "axOf'VZwXm}'cTbp");
      FileInputStream fileInputStream0 = TypeHandler.openFile("ndLmVUcYDP<-7");
  ...
  public void test03()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("Uable to find fil: ", class0);
      assertEquals("Uable to find fil: ", string0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".'V<C kbET.1-!(JuC");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/NG-B");
  ...
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("ndLmVUcYDP<-7");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "axOf'VZwXm}'cTbp");
      File file0 = TypeHandler.createFile("ndLmVUcYDP<-7");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Uable to find fil: ", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Uable to find fil: 
         //
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createObject("a/L2::yl");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: a/L2::yl
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("ndLmVUcYDP<-7");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ndLmVUcYDP<-7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("+pt^VR.O^", (Object) class0);
      assertEquals("+pt^VR.O^", object0);
  }
}
