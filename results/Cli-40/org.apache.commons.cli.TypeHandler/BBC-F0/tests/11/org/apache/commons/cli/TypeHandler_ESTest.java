...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Object object0 = TypeHandler.createValue(",Z#&{0Ioh`p ez$]H)", (Object) null);
      assertNull(object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".;._,^'2{70k");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ".;._,^'2{70k");
      File file0 = TypeHandler.createFile(".;._,^'2{70k");
  ...
  public void test07()  throws Throwable  {
      try { 
        TypeHandler.openFile("kYnK");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: kYnK
         //
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("ov:Za(", (Object) "ov:Za(");
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("A6", class0);
      assertEquals("A6", string0);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile("/V{BGZ!w^U}PH");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles(",Z#&{0Ioh`p ez$]H)");
        fail("Expecting exception: UnsupportedOperationException");
