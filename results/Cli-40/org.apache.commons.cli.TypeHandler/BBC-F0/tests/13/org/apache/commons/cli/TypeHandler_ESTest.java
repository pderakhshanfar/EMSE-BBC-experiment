...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/CQ");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("j _h1h/+f");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: j _h1h/+f
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile(".>&r3VdS7tf?5%j");
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("0Qy<~5g[Sy7[?");
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("=~C`D\"$woR^c0kFr_t");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: =~C`D\"$woR^c0kFr_t
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
