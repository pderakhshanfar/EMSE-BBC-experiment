...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("vz4qkJ!^J,G`d-s?}");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "2EaXu(");
      FileInputStream fileInputStream0 = TypeHandler.openFile("vz4qkJ!^J,G`d-s?}");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("g4^4Sf?,H}B<");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ";AI);A 3>laie0");
      File file0 = TypeHandler.createFile("g4^4Sf?,H}B<");
      assertTrue(file0.canWrite());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile(".zo@p");
      assertEquals(0L, file0.length());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/dLI");
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("x|hw=<VZ)4wsD=FK", (Object) "x|hw=<VZ)4wsD=FK");
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createClass("'j+x64N");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 'j+x64N
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createObject("/dLI");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /dLI
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL("qHfPs1bmg+:?x#");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: qHfPs1bmg+:?x#
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("MNZj.+1");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test32()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("F,^D`#*[gi@", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: F,^D`#*[gi@
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
