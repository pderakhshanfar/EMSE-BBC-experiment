...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("TV=}Q PoJI");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("TV=}Q PoJI");
  ...
  public void test04()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("iAi1]f*{sC3\"R*Na", class0);
      assertEquals("iAi1]f*{sC3\"R*Na", string0);
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".dtvSP\"-q");
      assertEquals(0L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/b^^3");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile("/b^^3");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.openFile("TV=}Q PoJI");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: TV=}Q PoJI
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("}:;{@l+#_=YG\"I.>o");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"}:;{@l+#_=YG\"I.>o\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Number number0 = TypeHandler.createNumber("55");
