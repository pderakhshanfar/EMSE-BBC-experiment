...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      try { 
        TypeHandler.openFile("2%]V*$M\"6@\"=");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 2%]V*$M\"6@\"=
         //
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(":n7X#");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile(":n7X#");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".(pw0l9OM==[PH*|}@");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ">,vrYtE`r|pf");
      File file0 = TypeHandler.createFile(".(pw0l9OM==[PH*|}@");
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Gw@9zPL'r", (Object) "Gw@9zPL'r");
  ...
  public void test22()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("d-1pj;lxe5!#", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue(".(pw0l9OM==[PH*|}@", class0);
      assertEquals(".(pw0l9OM==[PH*|}@", string0);
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("0TW");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 0TW
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("KD:y|oUICJ", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: KD:y|oUICJ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
