...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("+/(D-_YB7w3kJWg37@n");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("+/(D-_YB7w3kJWg37@n");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("E=mX/SD~84qQ>", (Object) class0);
      assertEquals("E=mX/SD~84qQ>", object0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("P\"%\"iUwLoW{Q", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: P\"%\"iUwLoW{Q
         //
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("5OyPF/G'~|0", (Object) "5OyPF/G'~|0");
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createObject("{Xk^<q`YE\u0004/P)");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: {Xk^<q`YE\u0004/P)
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("ET6w;bSH<3uo&rG");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ET6w;bSH<3uo&rG
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile(".@:X~t 9LOXD1x%'m");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("}Sbgz7+FK^");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: }Sbgz7+FK^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("G\"f)kzx");
        fail("Expecting exception: UnsupportedOperationException");
