...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("i1*(Dw~p-");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("i1*(Dw~p-");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("^$~vc?");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("^$~vc?");
  ...
  public void test04()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("q>SZG8z~{J3W-$|q", class0);
      assertEquals("q>SZG8z~{J3W-$|q", string0);
  }
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/`hm9[hH~kqm%4S!x");
      assertFalse(file0.canExecute());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(">LoiQ~VUIoj@(z");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(">LoiQ~VUIoj@(z");
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("8,7suz@", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 8,7suz@
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      File file0 = TypeHandler.createFile(".z.T}zBZSIJ##)hgHWY");
      assertEquals(".z.T}zBZSIJ##)hgHWY", file0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL("V[zYuw");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: V[zYuw
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.openFile("i1*(Dw~p-");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: i1*(Dw~p-
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test32()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("FCP5$1n8*6>zj", (Object) class0);
      assertEquals("FCP5$1n8*6>zj", object0);
  }
}
