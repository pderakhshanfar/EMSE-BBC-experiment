...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("03*@:6HsUSUtlF'{");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("03*@:6HsUSUtlF'{");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("$GX;=");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("$GX;=");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("c~8Zb`iZY!z&0#", (Object) class0);
      assertEquals("c~8Zb`iZY!z&0#", object0);
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".%,hc}wg294");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/n=a}k!Xx");
  ...
  public void test08()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("$GX;=");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Q3m<83s}R[Tcdz<3lv", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Q3m<83s}R[Tcdz<3lv
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue(".25QXiA-><`9WS~", object0);
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createClass(">N!A");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: >N!A
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("c~8Zb`iZY!z&0#", class0);
      assertEquals("c~8Zb`iZY!z&0#", string0);
  }
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.openFile("03*@:6HsUSUtlF'{");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 03*@:6HsUSUtlF'{
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
