...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Unable to findthe class: ");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("Unable to findthe class: ");
  ...
  public void test04()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("N_m0{[j^3KB^", (Object) class0);
      assertEquals("N_m0{[j^3KB^", object0);
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".9rpx1>=l6KZ");
  ...
  public void test08()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("85");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("85");
      assertEquals("85", file0.getName());
  }
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(")?8?`X~_b[q", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: )?8?`X~_b[q
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("", (Object) "Unable to find the class: ");
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createObject("NO_ARGS_ALLOWED");
        fail("Expecting exception: Exception");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("5/GnnVPXb*{;");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 5/GnnVPXb*{;
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("-SA'[", class0);
      assertEquals("-SA'[", string0);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/>:I6\"{");
      assertEquals(0L, file0.getUsableSpace());
  }
