...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".<r@q$+\"!A+ZUprJ");
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/7n{&v/(2B");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("m2K#NJfgMX8DO");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("rW~{-[b.$V3Sjf^");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: rW~{-[b.$V3Sjf^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
