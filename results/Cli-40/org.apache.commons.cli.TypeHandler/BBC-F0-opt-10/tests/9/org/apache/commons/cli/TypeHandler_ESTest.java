...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("$wyI|I`[c[e");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("$wyI|I`[c[e");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/QyI");
      assertFalse(file0.canExecute());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("%L|H1VNP");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "D]=MH}x]{\"5cCSX>");
      File file0 = TypeHandler.createFile("%L|H1VNP");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("t~m8(\"!E mqA5", (Object) "t~m8(\"!E mqA5");
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("kQ~d80XL?^*j>Zp");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: kQ~d80XL?^*j>Zp
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("J,6=^.U--p&A<VEBnf3", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: J,6=^.U--p&A<VEBnf3
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
