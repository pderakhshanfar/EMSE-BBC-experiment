...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(";BoWcY!ogE");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile(";BoWcY!ogE");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".<oD2x)AAp0V@1G");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Oh[F05HTY>~h6cTH8");
      FileInputStream fileInputStream0 = TypeHandler.openFile(".<oD2x)AAp0V@1G");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".<oD2x)AAp0V@1G");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Oh[F05HTY>~h6cTH8");
      File file0 = TypeHandler.createFile(".<oD2x)AAp0V@1G");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(";wvh2).w", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ;wvh2).w
         //
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("7lrcTs=^q!U6", (Object) "7lrcTs=^q!U6");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("o}bMq_SN`TuDJ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: o}bMq_SN`TuDJ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("|.5;c2irUR+");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"|.5;c2irUR+\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("PSv.!y", class0);
      assertEquals("PSv.!y", string0);
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("r2y&m,P;mca+'^XN");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: r2y&m,P;mca+'^XN
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile(".<oD2x)AAp0V@1G");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: .<oD2x)AAp0V@1G
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
