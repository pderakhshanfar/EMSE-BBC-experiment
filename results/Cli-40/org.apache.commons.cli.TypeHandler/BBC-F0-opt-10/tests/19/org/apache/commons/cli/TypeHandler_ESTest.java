...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("(u`|fb7gL7'D7");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "org.apache.commons.cli.PatternOptionBuilder");
      FileInputStream fileInputStream0 = TypeHandler.openFile("(u`|fb7gL7'D7");
      assertEquals(44, fileInputStream0.available());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "(Q2Ar7h");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".nb1(NV7]bmL");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/^Xc8");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("z;/0T269qm", object0);
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("<I4pn<,Fd");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: <I4pn<,Fd
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue(":GDVJz!_", class0);
      assertEquals(":GDVJz!_", string0);
  }
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("oA");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: oA
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles(" Y>}QLMtX!?");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("(u`|fb7gL7'D7");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: (u`|fb7gL7'D7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
