...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Z^#YoP<I;");
      byte[] byteArray0 = new byte[4];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("Z^#YoP<I;");
      assertFalse(file0.isHidden());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".<)e[t?vET_XOA=");
      assertFalse(file0.canWrite());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/0(GKJJ`9s");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.openFile("??2&gdC|< THFXI");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ??2&gdC|< THFXI
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".<)e[t?vET_XOA=");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".<)e[t?vET_XOA=\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("Z^#YoP<I;", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("X=zH]lkAd", class0);
      assertEquals("X=zH]lkAd", string0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("(}-5IS&ZE+yy;S/2-", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: (}-5IS&ZE+yy;S/2-
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("'`1429@-ua} w.QF+", (Object) "'`1429@-ua} w.QF+");
