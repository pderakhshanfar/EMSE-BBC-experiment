...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("PK#r|cmytOn4G?nA");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("PK#r|cmytOn4G?nA");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("YtFe>LN&)bD5");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "RuRe=,9Ey2qQo=9");
      File file0 = TypeHandler.createFile("YtFe>LN&)bD5");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/9P?_\"qyy(Z.lFti");
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("YSt~`93)W9", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: YSt~`93)W9
         //
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("8", (Object) "8");
  ...
  public void test19()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue(">Xc+Uh`m4QA}HF", class0);
      assertEquals(">Xc+Uh`m4QA}HF", string0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue(">Xc+Uh`m4QA}HF", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile(".oYzW");
      assertEquals(".oYzW", file0.getName());
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("--H7");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: --H7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("PK#r|cmytOn4G?nA");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: PK#r|cmytOn4G?nA
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.createClass("6(Iami2cJjR");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 6(Iami2cJjR
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
