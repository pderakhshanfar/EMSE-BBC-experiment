...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(",~H>K'GQ8+1+Gi[$");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile(",~H>K'GQ8+1+Gi[$");
  ...
  public void test01()  throws Throwable  {
      ...
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("5");
  ...
  public void test04()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "y'U|S;IU[USgg");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".#F4*tyK");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("3 dkw@ >.'!n b'$g", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 3 dkw@ >.'!n b'$g
         //
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("/+eaRQ", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /+eaRQ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("c<=nZ", class0);
      assertEquals("c<=nZ", string0);
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("WfXhxIjR<.2*h%M");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"WfXhxIjR<.2*h%M\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/+eaRQ");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("6/86Tat<A\u0007NSX>n+S");
