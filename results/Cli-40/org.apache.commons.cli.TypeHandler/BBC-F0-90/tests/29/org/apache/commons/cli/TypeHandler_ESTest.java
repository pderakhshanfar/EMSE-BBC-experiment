...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("Q(^Y{h", class0);
      assertEquals("Q(^Y{h", string0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/yf");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("op9o'c", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: op9o'c
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("RKn$@yIG&_S(e", (Object) "");
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("gm]^yS_.+ ?yu");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"gm]^yS_.+ ?yu\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".-Gur");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("kQb@Ho`D");
