...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("'s#*w.~x9'4W)/t<d");
      byte[] byteArray0 = new byte[7];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("'s#*w.~x9'4W)/t<d");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("_Y}H _8lL\"1I\"", (Object) class0);
      assertEquals("_Y}H _8lL\"1I\"", object0);
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".N|H}]tH|i4 w=E");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/dXcidMb=0f78");
      assertFalse(file0.canRead());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("5=52B$Uz");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile("5=52B$Uz");
      assertEquals("5=52B$Uz", file0.getName());
  }
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", (Object) "MrRo#pcQ:h.");
  ...
  public void test17()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("I@O<jqnB&|Q'", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: I@O<jqnB&|Q'
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Number number0 = TypeHandler.createNumber("44");
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("eG^E", class0);
      assertEquals("eG^E", string0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("eG^E", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: eG^E
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("'s#*w.~x9'4W)/t<d");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 's#*w.~x9'4W)/t<d
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
