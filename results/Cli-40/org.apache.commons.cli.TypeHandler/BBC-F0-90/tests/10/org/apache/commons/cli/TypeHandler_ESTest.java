...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("vZ(", (Object) class0);
      assertEquals("vZ(", object0);
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/!.}i-}AL!A`(/");
      assertEquals(0L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("_C)`ekjl_xC)#Dc-E");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "?T4{//V}+&Bx[_%F`");
      File file0 = TypeHandler.createFile("_C)`ekjl_xC)#Dc-E");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("", (Object) "Cannot add value, list full.");
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("11:", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 11:
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("gsdZG?5|`r0|D");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: gsdZG?5|`r0|D
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("?T4{//V}+&Bx[_%F`", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("2jb,jM;e5<#f,,W?0p", class0);
      assertEquals("2jb,jM;e5<#f,,W?0p", string0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("<xt}Q)<");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: <xt}Q)<
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
