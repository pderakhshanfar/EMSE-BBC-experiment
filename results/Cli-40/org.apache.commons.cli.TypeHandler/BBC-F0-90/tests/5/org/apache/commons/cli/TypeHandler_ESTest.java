...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("}U>ldtRuz7f]T", (Object) class0);
      assertEquals("}U>ldtRuz7f]T", object0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "PU}r6dY0#.");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("}KogU&D(E/dXcP*#>");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: }KogU&D(E/dXcP*#>
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("mq].`Jm};le^C$");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"mq].`Jm};le^C$\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("(X/ukPQ\u0000~w7eP", class0);
      assertEquals("(X/ukPQ\u0000~w7eP", string0);
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile(".cv#a$f ulWLwM");
