...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(" fl@j");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile(" fl@j");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("`FVPVo6>N-a(DD;d^'", (Object) class0);
      assertEquals("`FVPVo6>N-a(DD;d^'", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("`FVPVo6>N-a(DD;d^'", class0);
      assertEquals("`FVPVo6>N-a(DD;d^'", string0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("i:%m[YGe*!H!?-d");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Cannot add value, list full.");
      File file0 = TypeHandler.createFile("i:%m[YGe*!H!?-d");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".`|b~_5K+ne>~c)1");
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("i:%m[YGe*!H!?-d", (Object) "A@thv\"$Y0yzQG[");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("83p)");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 83p)
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("83p)", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("_}WZCTZ");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile(" fl@j");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file:  fl@j
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
