...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".$OvA:eNz<[mE1S)o;");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile(".$OvA:eNz<[mE1S)o;");
  ...
  public void test05()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("!gA*5,", class0);
      assertEquals("!gA*5,", string0);
  }
  ...
  public void test08()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".$OvA:eNz<[mE1S)o;");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Either opt or longOpt must be specified");
      File file0 = TypeHandler.createFile(".$OvA:eNz<[mE1S)o;");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.openFile(".$OvA:eNz<[mE1S)o;");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: .$OvA:eNz<[mE1S)o;
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("{@tsW09~EC", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: {@tsW09~EC
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("t}*7");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: t}*7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("Q~dJF|[ie58ix{ra{");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: Q~dJF|[ie58ix{ra{
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("z9.?3udVI>s?JKX+V/i");
        fail("Expecting exception: UnsupportedOperationException");
