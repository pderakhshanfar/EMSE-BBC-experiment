...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("org.apache.commoJs.cli.TypeHandler");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("org.apache.commoJs.cli.TypeHandler");
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("org.apache.commoJs.cli.TypeHandler");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "qZUX6~DjCkj");
      FileInputStream fileInputStream0 = TypeHandler.openFile("org.apache.commoJs.cli.TypeHandler");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/'X,12 Zlrpx");
  ...
  public void test06()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "oTPhqrC!b=26j");
      File file0 = TypeHandler.createFile(".");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("PzB", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: PzB
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("org.apache.commoJs.cli.TypeHandler", object0);
  ...
  public void test20()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("org.apache.commoJs.cli.TypeHandler", class0);
      assertNull(integer0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("O#4A}J<sW`!Z%");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: O#4A}J<sW`!Z%
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("org.apache.commoJs.cli.TypeHandler");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: org.apache.commoJs.cli.TypeHandler
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
