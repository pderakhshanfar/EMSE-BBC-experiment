...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("'9*J)B>Q/H");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("'9*J)B>Q/H");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".-r2WDNh|HXO%-72");
      assertEquals(".-r2WDNh|HXO%-72", file0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("/?w+jAEjWT{8h8A", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /?w+jAEjWT{8h8A
         //
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("VdCOFAj\"+k V>", (Object) "");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("l\"8w5");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: l\"8w5
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("5/hFztWEfGI<#OqM~yq", class0);
      assertEquals("5/hFztWEfGI<#OqM~yq", string0);
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/e-5:||V>T*wsV2HL");
      assertEquals("/e-5:||V>T*wsV2HL", file0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("'9*J)B>Q/H");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: '9*J)B>Q/H
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
