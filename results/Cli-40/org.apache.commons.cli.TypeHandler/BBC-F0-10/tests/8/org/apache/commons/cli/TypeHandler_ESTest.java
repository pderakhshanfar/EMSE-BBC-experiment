...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("^T+C!q8Ozy");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("^T+C!q8Ozy");
  ...
  public void test01()  throws Throwable  {
      ...
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("lQ");
      assertEquals(2, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".'R]l*8i)~R6^Zk\"6");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Oa");
      assertEquals("/Oa", file0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("kEwC8wZ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Qi\"q:y/0");
      File file0 = TypeHandler.createFile("kEwC8wZ");
      assertEquals("kEwC8wZ", file0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("8B)-^sCvsG~W\"z9b:)", (Object) integer0);
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("c", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: c
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("`V$%ee", class0);
      assertEquals("`V$%ee", string0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("7B&L|Y}+vQ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 7B&L|Y}+vQ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("_8.t|$1v4");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("^T+C!q8Ozy");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ^T+C!q8Ozy
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
