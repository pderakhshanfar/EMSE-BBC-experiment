...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("pbWM:s?X4#|e1lEMl>");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("pbWM:s?X4#|e1lEMl>");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/%wQ|h");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("pbWM:s?X4#|e1lEMl>");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile("pbWM:s?X4#|e1lEMl>");
      assertEquals("pbWM:s?X4#|e1lEMl>", file0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("<W:3:YI", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: <W:3:YI
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("ow}^,a*%`<K#l\"Le", class0);
      assertEquals("ow}^,a*%`<K#l\"Le", string0);
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile(".nPY8]OO[^tK");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("$vNDr~VB~m");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: $vNDr~VB~m
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("pbWM:s?X4#|e1lEMl>");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: pbWM:s?X4#|e1lEMl>
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.createClass("ow}^,a*%`<K#l\"Le");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ow}^,a*%`<K#l\"Le
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
