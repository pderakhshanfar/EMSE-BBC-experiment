...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(";Bc");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Z#l`%~~r 2RFkf6@'");
      FileInputStream fileInputStream0 = TypeHandler.openFile(";Bc");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".7E 9*(51?sUd6.N~:p");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/cX(oHgu0Whl=");
  ...
  public void test08()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "SU:");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.openFile("nzic>_>J_c{oo!V:");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: nzic>_>J_c{oo!V:
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("org.apache.ckmmons.cli.Op:ions", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: org.apache.ckmmons.cli.Op:ions
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createClass("$g&O");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: $g&O
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("BBgar>PQHAcUlp@9", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: BBgar>PQHAcUlp@9
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("yEQGgjk");
        fail("Expecting exception: UnsupportedOperationException");
