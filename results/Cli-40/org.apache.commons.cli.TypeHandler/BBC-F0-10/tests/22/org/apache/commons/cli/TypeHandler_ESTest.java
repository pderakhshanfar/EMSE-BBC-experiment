...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(":yLRTzl/,");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile(":yLRTzl/,");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("u)oT]yP,=h@Y/+B-=k=", (Object) class0);
      assertEquals("u)oT]yP,=h@Y/+B-=k=", object0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("P}(*^e'h");
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("P}(*^e'h");
      assertEquals(5L, file0.length());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".8Q=Vx2clb<egw4 ^J");
      assertEquals(".8Q=Vx2clb<egw4 ^J", file0.toString());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/@;q+R.");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("P}(*^e'h", (Object) file0);
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("L8+?/1diK", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("K+)\"/FO= c", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: K+)\"/FO= c
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("Y:>_", class0);
      assertEquals("Y:>_", string0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("`A3]}7J<DMp_U_C");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: `A3]}7J<DMp_U_C
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("k4^7=NiAY V2*");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("'DLk3n&,(P%");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 'DLk3n&,(P%
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
