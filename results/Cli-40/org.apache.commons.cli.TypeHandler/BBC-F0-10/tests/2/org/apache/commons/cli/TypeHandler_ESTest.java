...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("^fjNijaZUw");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Q@J*F=}b");
      FileInputStream fileInputStream0 = TypeHandler.openFile("^fjNijaZUw");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("(H", (Object) class0);
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("?JL,Vt^v9wv=$@''Z}");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Unable to find file: ");
      File file0 = TypeHandler.createFile("?JL,Vt^v9wv=$@''Z}");
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("", (Object) "(H");
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Tz5 Y", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Tz5 Y
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("u{>jWK<KQ", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("6", class0);
      assertEquals("6", string0);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile("/.x],KXk'=5b");
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("&&>cyoQ8GY_J");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("^fjNijaZUw");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ^fjNijaZUw
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
