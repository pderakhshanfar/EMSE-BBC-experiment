...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("XoKaaFSP@[]");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("XoKaaFSP@[]");
      assertEquals(0L, file0.getFreeSpace());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/dN(;?wHA66I6ybht");
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("0iX0<grqSy+@2h@<W ", (Object) "0iX0<grqSy+@2h@<W ");
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createObject("tjyXHASE5~kO?");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: tjyXHASE5~kO?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Integer integer0 = TypeHandler.createValue("8", (Class<Integer>) null);
      assertNull(integer0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("g>=Wj;uN;C#/)0B$Q3");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: g>=Wj;uN;C#/)0B$Q3
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("/dN(;?wHA66I6ybht");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: /dN(;?wHA66I6ybht
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.createClass("d5M#.m;ZR");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: d5M#.m;ZR
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
