...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("7p$PB9hLb}oF.m'R");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("7p$PB9hLb}oF.m'R");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("ta'eL(u", (Object) class0);
      assertEquals("ta'eL(u", object0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("1DK+ANFNyp$Kl<");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "RMF-U}3|!");
      File file0 = TypeHandler.createFile("1DK+ANFNyp$Kl<");
      assertEquals("1DK+ANFNyp$Kl<", file0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".l%9I<'");
      assertEquals(".l%9I<'", file0.getName());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("s!JbzGL%\"&bX</n;j", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: s!JbzGL%\"&bX</n;j
         //
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("ufu3d1huH\"Q)", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ufu3d1huH\"Q)
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("CP$EQ@NX");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("7p$PB9hLb}oF.m'R");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 7p$PB9hLb}oF.m'R
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
