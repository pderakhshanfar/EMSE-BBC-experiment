...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("uL[n;(I");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("uL[n;(I");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("P>*|OMw:.rW.*4(");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("P>*|OMw:.rW.*4(");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/%!yVuXh5{UBFRz\"%rI");
  ...
  public void test06()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "b:,NN3");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("c(d{me8?~bu]2", (Object) "c(d{me8?~bu]2");
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("#z#i#6krWtD-A'pHv");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: #z#i#6krWtD-A'pHv
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createObject("sF");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: sF
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("c(d{me8?~bu]2", class0);
      assertEquals("c(d{me8?~bu]2", string0);
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      File file0 = TypeHandler.createFile(".E#M)o+mPqvv34>XOs");
      assertEquals(".E#M)o+mPqvv34>XOs", file0.getName());
  }
