...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(";=((pg_");
      byte[] byteArray0 = new byte[4];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile(";=((pg_");
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".=Y)v4");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/-?w{7}U4OOA");
  ...
  public void test05()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[4];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(";=((pg_");
  ...
  public void test08()  throws Throwable  {
      try { 
        TypeHandler.openFile("H$3WlU");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: H$3WlU
         //
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("|l6^W", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: |l6^W
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue(";=((pg_", class0);
      assertEquals(";=((pg_", string0);
  }
