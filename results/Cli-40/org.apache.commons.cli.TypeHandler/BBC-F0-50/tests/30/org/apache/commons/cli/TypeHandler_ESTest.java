...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      FileInputStream fileInputStream0 = TypeHandler.openFile("vI");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(",wG2gU$VBk6");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile(",wG2gU$VBk6");
  ...
  public void test04()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("YnAK.C ", (Object) class0);
      assertEquals("YnAK.C ", object0);
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".%+B#l;zX");
      assertEquals(".%+B#l;zX", file0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/4j,Ehcb`[-QU+y/t");
  ...
  public void test09()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(",wG2gU$VBk6");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("9tCKQ", object0);
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createClass("t7'");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: t7'
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("vI", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createNumber("@kWU8&>(.91n`<!Tge");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"@kWU8&>(.91n`<!Tge\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("vI", class0);
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL(",wG2gU$VBk6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ,wG2gU$VBk6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("vI");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: vI
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
