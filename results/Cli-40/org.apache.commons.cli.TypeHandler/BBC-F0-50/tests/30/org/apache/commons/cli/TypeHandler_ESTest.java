...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Unable to find file: ");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "%ZREv0j2&3REL");
      FileInputStream fileInputStream0 = TypeHandler.openFile("Unable to find file: ");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/DB0Q0`</BefGCy0A");
      assertEquals(0L, file0.getTotalSpace());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("&`BzY/.");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createObject("7O`&>,GkLH");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 7O`&>,GkLH
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("$xf=101k|gv");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: $xf=101k|gv
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
