...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("@HWPnJ~");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("@HWPnJ~");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createObject(".,8L|%kU");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .,8L|%kU
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("{ w`k/.Lt}9", class0);
      assertEquals("{ w`k/.Lt}9", string0);
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      File file0 = TypeHandler.createFile(".aKUS\"`odDIkD0");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("@HWPnJ~");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: @HWPnJ~
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
