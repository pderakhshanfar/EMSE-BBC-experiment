...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("|mkF~!WOyze&<04X=");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("|mkF~!WOyze&<04X=");
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("|mkF~!WOyze&<04X=");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "'e49o_ymM");
      FileInputStream fileInputStream0 = TypeHandler.openFile("|mkF~!WOyze&<04X=");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".9Keq");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/iU8fgHX");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/iU8fgHX");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Either opt or longOpt must be specified", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Either opt or longOpt must be specified
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Unable to find file: ", (Object) "The addValue method is not intended for client use. Subclasses should use the addValueForProcessing method instead. ");
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("do}^HuHrUt#-x", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("nO6g\"Fg+Y8z,~~A@");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("kKfBsY");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: kKfBsY
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
