...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("JRa");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "JRa");
      FileInputStream fileInputStream0 = TypeHandler.openFile("JRa");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("U-*:ll'bdK>2{", (Object) class0);
      assertEquals("U-*:ll'bdK>2{", object0);
  }
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("JRa");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "JRa");
      File file0 = TypeHandler.createFile("JRa");
      assertEquals("JRa", file0.getName());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".8c:gI)");
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("0lrl6Ql^sC#c", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 0lrl6Ql^sC#c
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("/WK).^MYK\"]\u0005o{2-i3");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"/WK).^MYK\"]\u0005o{2-i3\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("CK.UH= ce>Z![A:]", class0);
      assertEquals("CK.UH= ce>Z![A:]", string0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("8M", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 8M
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/WK).^MYK\"]\u0005o{2-i3");
      assertEquals("WK).^MYK\"]\u0005o{2-i3", file0.getName());
  }
