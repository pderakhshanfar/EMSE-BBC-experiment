...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("f3;>F(y_%[");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("f3;>F(y_%[");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".<gtp=V%h-+)5j2");
      assertEquals(".<gtp=V%h-+)5j2", file0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/toK!qzya;u7q");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("3!]\"!ynM", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 3!]\"!ynM
         //
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("go_Yt)+L{vpFa,3", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: go_Yt)+L{vpFa,3
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("The addValue method is not intended for client use. Subclasses should use the addValueForProcessing method instead. ", class0);
      assertNull(integer0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("zF@,~(AA\bhE", (Object) typeHandler0);
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("f3;>F(y_%[");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("na");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: na
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
