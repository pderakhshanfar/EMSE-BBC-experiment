...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("kXwh;3e>|fpt*t!J~");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("kXwh;3e>|fpt*t!J~");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".+Hf?UVWd'Z}]+ZV");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/21d$^oSnp>4{");
      assertEquals(0L, file0.length());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(" ] [(lon$ ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "org.apache.commons.cli.Option");
      File file0 = TypeHandler.createFile(" ] [(lon$ ");
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("P{9X$z5jcf*v_9", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: P{9X$z5jcf*v_9
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createObject("!wIU*] ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: !wIU*] 
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue(" ] [(lon$ ", class0);
      assertNull(integer0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("kXwh;3e>|fpt*t!J~");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: kXwh;3e>|fpt*t!J~
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("kXwh;3e>|fpt*t!J~");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: kXwh;3e>|fpt*t!J~
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Object object0 = TypeHandler.createValue("kXwh;3e>|fpt*t!J~", (Object) null);
      assertNull(object0);
  }
}
