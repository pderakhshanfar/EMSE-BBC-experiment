...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("I9 A2B+i&jS6");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("I9 A2B+i&jS6");
  ...
  public void test03()  throws Throwable  {
      ...
      FileInputStream fileInputStream0 = TypeHandler.openFile("[I");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/$G7qJP[x");
  ...
  public void test18()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("7P5+2\"OMKE", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 7P5+2\"OMKE
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("{4@r{", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("[I", class0);
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile(".?9]4[1[YPIgv4G ");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("UL16T#VjgWV");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: UL16T#VjgWV
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("[I");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: [I
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
