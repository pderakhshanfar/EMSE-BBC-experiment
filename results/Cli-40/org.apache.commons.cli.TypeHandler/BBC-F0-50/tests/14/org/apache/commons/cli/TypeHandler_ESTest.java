...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("tYQh$ulk+xj");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "V([S@`");
      FileInputStream fileInputStream0 = TypeHandler.openFile("tYQh$ulk+xj");
  ...
  public void test04()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(">!N7", (Object) class0);
  ...
  public void test05()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("s<L3dr9'}5-P^>", class0);
      assertEquals("s<L3dr9'}5-P^>", string0);
  }
  ...
  public void test08()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/ev[OL}b]q'f");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "/ev[OL}b]q'f");
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("Py>s.ehx'K");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"Py>s.ehx'K\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Imem0`6tnz:^ ");
      assertEquals(".Imem0`6tnz:^ ", file0.toString());
  }
