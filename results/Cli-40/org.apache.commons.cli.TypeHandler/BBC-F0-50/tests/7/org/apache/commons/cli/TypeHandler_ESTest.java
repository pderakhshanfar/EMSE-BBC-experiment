...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Unable to parse he URL: ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("Unable to parse he URL: ");
  ...
  public void test04()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("DOt/Vr$nX .{R", (Object) class0);
      assertEquals("DOt/Vr$nX .{R", object0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".wXD5Ej~[");
  ...
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("dc");
      byte[] byteArray0 = new byte[4];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("dc");
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("]a*C2bb4:FF=\"E0B", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("q!.@h", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: q!.@h
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("DOt/Vr$nX .{R", class0);
      assertEquals("DOt/Vr$nX .{R", string0);
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/lQ>A]r<`b6v]+jb");
      assertEquals("lQ>A]r<`b6v]+jb", file0.getName());
  }
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("CQ!0+NF~m>!G$");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("Unable to parse he URL: ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: Unable to parse he URL: 
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
