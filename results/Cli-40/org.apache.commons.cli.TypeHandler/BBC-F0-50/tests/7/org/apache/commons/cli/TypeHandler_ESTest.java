...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(";#8Nv");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile(";#8Nv");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("[X:'h,W{iv$gT3]", (Object) class0);
      assertEquals("[X:'h,W{iv$gT3]", object0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".P 7O{<");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("tlDS>_]6D");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("tlDS>_]6D");
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("M+X01+hK:LYn`~");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: M+X01+hK:LYn`~
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".P 7O{<");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".P 7O{<\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue(";#8Nv", class0);
      assertEquals(";#8Nv", string0);
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      File file0 = TypeHandler.createFile("/=ldcXv-IMFm;eZ");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile(";#8Nv");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ;#8Nv
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
