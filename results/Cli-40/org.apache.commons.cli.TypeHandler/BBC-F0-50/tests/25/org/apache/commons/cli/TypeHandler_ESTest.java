...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      FileInputStream fileInputStream0 = TypeHandler.openFile("org.apache.commons.cli.Options");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Object object0 = TypeHandler.createValue("m/WIaBYoK_~}", (Object) null);
      assertNull(object0);
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/y^h,S~&LrL*]");
  ...
  public void test07()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "has already been selected: '");
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("$djX6oM5gJ]Nb<yRUI`", (Object) "$djX6oM5gJ]Nb<yRUI`");
  ...
  public void test13()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Jt$V%P", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Jt$V%P
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createClass("9jR.ic`1");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 9jR.ic`1
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("org.apache.commons.cli.Options", class0);
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("9");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 9
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("org.apache.commons.cli.Options");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: org.apache.commons.cli.Options
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
