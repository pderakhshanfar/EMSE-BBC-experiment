...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      FileInputStream fileInputStream0 = TypeHandler.openFile("M");
  ...
  public void test02()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ")+N$P}y:Y{d{9b1^,");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("bnWx", (Object) class0);
      assertEquals("bnWx", object0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("mwn!y5:g^", class0);
      assertEquals("mwn!y5:g^", string0);
  }
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/2}hfIBoX");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("[j22mQ,*", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: [j22mQ,*
         //
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Unable to find the class: ", (Object) "");
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("o)C+X772x", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createObject("mwn!y5:g^");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: mwn!y5:g^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("=Y5wcxpc@)`.V}");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("M");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: M
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
