...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("(M.EtM;/7wEy|<");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "MdveG}+ZVcm");
      FileInputStream fileInputStream0 = TypeHandler.openFile("(M.EtM;/7wEy|<");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/J9s");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Unable to parsTpbhe URL: ", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Unable to parsTpbhe URL: 
         //
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("fFtPO", (Object) "fFtPO");
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("cGW9;6GJ \"#Cy<Z", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("8JIwcQ6'K", class0);
      assertEquals("8JIwcQ6'K", string0);
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".De:Cd{&Gh");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("(M.EtM;/7wEy|<");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: (M.EtM;/7wEy|<
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("(M.EtM;/7wEy|<");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: (M.EtM;/7wEy|<
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.createClass("XNqd4}3C)WjY^Y_w");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: XNqd4}3C)WjY^Y_w
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
