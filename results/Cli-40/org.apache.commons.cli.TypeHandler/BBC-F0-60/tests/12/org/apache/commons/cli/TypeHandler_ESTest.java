...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("PdAEJei8*0");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("PdAEJei8*0");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".5Ga+]b+L[;");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("6z");
      FileSystemHandling.createFolder(evoSuiteFile0);
      File file0 = TypeHandler.createFile("6z");
      assertEquals(0L, file0.getUsableSpace());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Sto#u");
      assertEquals("/Sto#u", file0.toString());
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("org.apache.commons.cli.Options");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "\"wnnQfz0UJ4Q#s7");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("N:y,f}hb>3L", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: N:y,f}hb>3L
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue(",'q>V&we&Kl)$+m$qP", (Object) "F");
  ...
  public void test14()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("7eQus]b", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 7eQus]b
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("org.apache.commonscli.PatternOptionBuilder", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("PdAEJei8*0", class0);
      assertEquals("PdAEJei8*0", string0);
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("PdAEJei8*0");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: PdAEJei8*0
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
