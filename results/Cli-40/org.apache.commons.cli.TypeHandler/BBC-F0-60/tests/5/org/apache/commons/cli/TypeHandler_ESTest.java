...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("D)E,W]wQrO[+nK");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("D)E,W]wQrO[+nK");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("ftdGA{^A~P~OR");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "U");
      FileInputStream fileInputStream0 = TypeHandler.openFile("ftdGA{^A~P~OR");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/fV[c=28)vr`");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "'");
      File file0 = TypeHandler.createFile("/fV[c=28)vr`");
      assertEquals("/fV[c=28)vr`", file0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.openFile("wjTPdnlfx?yGeN");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: wjTPdnlfx?yGeN
         //
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("", (Object) "Unable to find file: ");
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("D)E,W]wQrO[+nK", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: D)E,W]wQrO[+nK
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("/fV[c=28)vr`");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /fV[c=28)vr`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("#VSSz.3V2");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"#VSSz.3V2\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile(".DVpX4l&");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("c^{5HZ*Et2i bb$s");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: c^{5HZ*Et2i bb$s
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
