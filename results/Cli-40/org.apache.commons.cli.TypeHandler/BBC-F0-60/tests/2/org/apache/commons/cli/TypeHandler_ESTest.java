...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("GIs");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("GIs");
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.openFile("GIs");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: GIs
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("p#RIlwf{lmPN4\"OBAz", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: p#RIlwf{lmPN4\"OBAz
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("GIs", (Object) "GIs");
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("p#RIlwf{lmPN4\"OBAz", class0);
        fail("Expecting exception: Exception");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("t%KeZa7CX");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: t%KeZa7CX
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("MW:9z", class0);
      assertEquals("MW:9z", string0);
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("c*z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: c*z
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("\n s", (Object) class0);
      assertEquals("\n s", object0);
  }
}
