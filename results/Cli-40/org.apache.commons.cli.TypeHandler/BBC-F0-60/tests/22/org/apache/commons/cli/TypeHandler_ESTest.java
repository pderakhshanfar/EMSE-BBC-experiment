...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".g;|*(KI");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Qgd8&ItUPq\"-06d");
      File file0 = TypeHandler.createFile(".g;|*(KI");
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("X}W@P4LP,moLx", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: X}W@P4LP,moLx
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("C}!X`@L+gz_L0");
        fail("Expecting exception: UnsupportedOperationException");
