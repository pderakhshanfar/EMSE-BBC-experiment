...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/@w\"].o3r{C\">tEw");
      assertEquals(0L, file0.getTotalSpace());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".vIe D");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ".vIe D");
      File file0 = TypeHandler.createFile(".vIe D");
  ...
  public void test09()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("=a6ZA", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: =a6ZA
         //
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("j)tS`P:R+");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: j)tS`P:R+
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
