...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("7m vafWul-kZ]Fq,uc");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("7m vafWul-kZ]Fq,uc");
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("7m vafWul-kZ]Fq,uc");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "?FQ7:f)21$5(f?h");
      FileInputStream fileInputStream0 = TypeHandler.openFile("7m vafWul-kZ]Fq,uc");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".s{c5iiCu )COfq~yo");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/i`>j5");
      assertFalse(file0.canWrite());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("_|!0=!c^j");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "_|!0=!c^j");
      File file0 = TypeHandler.createFile("_|!0=!c^j");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("jeI;qS/iI");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: jeI;qS/iI
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("? ;ryM><ZC)+b?.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"? ;ryM><ZC)+b?.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("<r3y\"|YU;Wc;#_N6#$,", class0);
      assertEquals("<r3y\"|YU;Wc;#_N6#$,", string0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("#y#.HyC/");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: #y#.HyC/
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("7m vafWul-kZ]Fq,uc");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 7m vafWul-kZ]Fq,uc
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
