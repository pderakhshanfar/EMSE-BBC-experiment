...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".%R5m");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile(".%R5m");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("9mEcg7\"T", (Object) class0);
      assertEquals("9mEcg7\"T", object0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals("org.apache.commons.cli.Options", file0.toString());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".CSuuO^A'TcY");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("+ItsP*XO=KSl*+dpQn", (Object) "+ItsP*XO=KSl*+dpQn");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("$ae@3@[%Xf");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: $ae@3@[%Xf
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("z8B", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("9mEcg7\"T", class0);
      assertEquals("9mEcg7\"T", string0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("B,clW_v]M{LE[B", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: B,clW_v]M{LE[B
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile(".%R5m");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: .%R5m
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
