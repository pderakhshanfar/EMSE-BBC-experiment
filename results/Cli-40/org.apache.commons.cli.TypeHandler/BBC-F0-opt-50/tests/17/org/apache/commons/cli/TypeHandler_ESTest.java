...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("{Q)gv");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("{Q)gv");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("?2&E<M1!r}t,;5WY");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "l3{BS{2-dfGph!O");
      File file0 = TypeHandler.createFile("?2&E<M1!r}t,;5WY");
      assertNull(file0.getParent());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".JhvHZAyE\n(MA");
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.openFile("{Q)gv");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: {Q)gv
         //
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("2r", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 2r
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("h<,s6o8rh}pK][", (Object) "");
  ...
  public void test19()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("/R*hs@;BIxH", class0);
      assertEquals("/R*hs@;BIxH", string0);
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("TqMD$LC9MAU.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"TqMD$LC9MAU.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("/R*hs@;BIxH", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/R*hs@;BIxH");
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.createClass("l3{BS{2-dfGph!O");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: l3{BS{2-dfGph!O
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("TqMD$LC9MAU.", (Object) class0);
      assertEquals("TqMD$LC9MAU.", object0);
  }
}
