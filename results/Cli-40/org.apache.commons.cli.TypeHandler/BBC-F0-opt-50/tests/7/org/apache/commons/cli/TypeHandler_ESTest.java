...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("BotJyet implocented");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("BotJyet implocented");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Bot yet implecented");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "[ARG...]");
      FileInputStream fileInputStream0 = TypeHandler.openFile("Bot yet implecented");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".UB43tk82vB=");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/w@c-2.,nfw");
  ...
  public void test13()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("4~n]nu4tWnfoE", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 4~n]nu4tWnfoE
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Unable to parse the URL: ", (Object) ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("{~Ty{z", class0);
      assertEquals("{~Ty{z", string0);
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("[tPuF=S?v-/Sq%3n");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("{~Ty{z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: {~Ty{z
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("BotJyet implocented");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: BotJyet implocented
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
