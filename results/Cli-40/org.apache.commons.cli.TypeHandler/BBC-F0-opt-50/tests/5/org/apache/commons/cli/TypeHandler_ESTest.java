...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("[>j6H~gz^WN-K^n@ez");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("[>j6H~gz^WN-K^n@ez");
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("[>j6H~gz^WN-K^n@ez");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Zk^CibjsRO");
      FileInputStream fileInputStream0 = TypeHandler.openFile("[>j6H~gz^WN-K^n@ez");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("0D>`?F~Q");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Either opt or longOpt must be specified");
      File file0 = TypeHandler.createFile("0D>`?F~Q");
      assertFalse(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("..TEUJ];09nv)0k");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/pl%#?]8");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.openFile("[>j6H~gz^WN-K^n@ez");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: [>j6H~gz^WN-K^n@ez
         //
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("24aLG'Zk/pWDLz", (Object) "0?;(W+_sZ3P");
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createNumber("<gZu|>.r<");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"<gZu|>.r<\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("The addValue method is n intended for clientuse. Subclasses should use the addValueForProcessing method instead. ", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: The addValue method is n intended for clientuse. Subclasses should use the addValueForProcessing method instead. 
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("G.8U0#EeRX4,$");
