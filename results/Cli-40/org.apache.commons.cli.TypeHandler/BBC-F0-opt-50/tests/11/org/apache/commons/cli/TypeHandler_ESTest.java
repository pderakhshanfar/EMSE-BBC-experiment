...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("=D");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "S%xDi`V*R8s5n");
      FileInputStream fileInputStream0 = TypeHandler.openFile("=D");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("/f4c(}", (Object) class0);
      assertEquals("/f4c(}", object0);
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/[=ZJFsgrMrmxok{");
      assertEquals(0L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("5,Lc f1GpeZ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "5,Lc f1GpeZ");
      File file0 = TypeHandler.createFile("5,Lc f1GpeZ");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("=ANV3", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: =ANV3
         //
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createObject("_1>t[K^2q-qy6JuEQQ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: _1>t[K^2q-qy6JuEQQ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createClass("uX?[[");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: uX?[[
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("S%xDi`V*85n", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createNumber("y1.(WtC|");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"y1.(WtC|\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL("S%xDi`V*R8s5n");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: S%xDi`V*R8s5n
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
