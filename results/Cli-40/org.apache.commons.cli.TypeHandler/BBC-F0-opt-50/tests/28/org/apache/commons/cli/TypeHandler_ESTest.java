...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("39B+=b&");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("39B+=b&");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".1gn|95\"h!!)N2y!e!1");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", (Object) "39B+=b&");
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("9", class0);
        fail("Expecting exception: Exception");
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("/h9`%:b73A,<Z", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(",?1rYZhSCX{y+H", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ,?1rYZhSCX{y+H
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/h9`%:b73A,<Z");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL(".1gn|95\"h!!)N2y!e!1");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: .1gn|95\"h!!)N2y!e!1
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("39B+=b&");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 39B+=b&
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Object object0 = TypeHandler.createValue("Nt..Gsc2p^XM", (Object) null);
      assertNull(object0);
  }
}
