...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Kfq6k-3?&h");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("Kfq6k-3?&h");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("M29");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "R4|q: ]s,");
      FileInputStream fileInputStream0 = TypeHandler.openFile("M29");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Qm>6f/sI;ls");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile("Qm>6f/sI;ls");
      assertEquals("sI;ls", file0.getName());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".f`J{ZX]g dl\"O");
      assertEquals(".f`J{ZX]g dl\"O", file0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("Jj|");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Jj|
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("R4|q: ]s,", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: R4|q: ]s,
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("/<U9uU0-n)bI", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/<U9uU0-n)bI");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("M29");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: M29
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
