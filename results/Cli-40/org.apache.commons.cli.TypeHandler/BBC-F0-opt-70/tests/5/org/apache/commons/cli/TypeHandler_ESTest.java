...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("aF", (Object) class0);
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("h)S6+!B8l");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, " ] [ long ");
      File file0 = TypeHandler.createFile("h)S6+!B8l");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".O(<4kyG<7p=jAAd");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("k^\rf;S_0mWS{J+");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: k^\rf;S_0mWS{J+
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("&':s*f.F);F;", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("vcQlW[kk{3", class0);
      assertEquals("vcQlW[kk{3", string0);
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/1;Cs#{<NJC");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("3`B$8%nEx");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("1$Az3GVJ</Wp[C.lr@");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 1$Az3GVJ</Wp[C.lr@
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
