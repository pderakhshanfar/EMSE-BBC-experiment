...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("fQ'eByQPpN68");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("fQ'eByQPpN68");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".O5Tj_XFodjPT){3Eq");
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("}.'KK[<U!Db!", (Object) "}.'KK[<U!Db!");
  ...
  public void test16()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("org.apache.cmmons.cli.PtternOptionBuilder", class0);
      assertNull(integer0);
  }
  ...
  public void test17()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("u", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: u
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("LD~VVo,e&X\".u8iTNxp");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"LD~VVo,e&X\".u8iTNxp\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/F,[URW4|'ye0;vu`Q");
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("64kj_|Y!^rT>I3^Z");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("fQ'eByQPpN68");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: fQ'eByQPpN68
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
