...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/{aOhqUk1n");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("/{aOhqUk1n");
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/{aOhqUk1n");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "/6p");
      FileInputStream fileInputStream0 = TypeHandler.openFile("/{aOhqUk1n");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("E55S(M)a<Ms", (Object) class0);
      assertEquals("E55S(M)a<Ms", object0);
  }
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/{aOhqUk1n");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "/6p");
      File file0 = TypeHandler.createFile("/{aOhqUk1n");
      assertTrue(file0.canRead());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("..Ss:=bR#&m$YvL");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("jjhgNm", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: jjhgNm
         //
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("7c_", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 7c_
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("kYn");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: kYn
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("F6]t|>Lu(]Z", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".uANtfThxB\"}");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".uANtfThxB\"}\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("/{aOhqUk1n");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: /{aOhqUk1n
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
