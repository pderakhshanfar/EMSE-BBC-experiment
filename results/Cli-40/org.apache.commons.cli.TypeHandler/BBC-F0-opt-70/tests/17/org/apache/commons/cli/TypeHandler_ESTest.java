...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("aph!#v3?Q,-^", (Object) class0);
      assertEquals("aph!#v3?Q,-^", object0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".O%A");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/~Nvzkl");
      assertEquals(0L, file0.length());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("@ 05");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("qiVFz_rQ|&RJ", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: qiVFz_rQ|&RJ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("5>'*$", object0);
  ...
  public void test13()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(" 3,012ytxZmN5", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class:  3,012ytxZmN5
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createClass(" wk4d;HhLo^*?aB");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class:  wk4d;HhLo^*?aB
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createNumber(":.v!.+x");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \":.v!.+x\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
