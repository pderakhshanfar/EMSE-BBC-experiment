...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("; Unable to create an instance of: ");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "^O{7");
      FileInputStream fileInputStream0 = TypeHandler.openFile("; Unable to create an instance of: ");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/6DyN[");
  ...
  public void test06()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "(?>0D.Pa9-a");
      File file0 = TypeHandler.createFile(" ");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Fv^$}Wp~ZOD}3-e4w95", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Fv^$}Wp~ZOD}3-e4w95
         //
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("ldBKh'IVrqF^R`.\"70N", object0);
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("QUYMXjV$43%[0z>\"d7");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: QUYMXjV$43%[0z>\"d7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("a4HA[9X[7", class0);
      assertEquals("a4HA[9X[7", string0);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("YwdTC].&\"s]a!gw|4");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"YwdTC].&\"s]a!gw|4\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("O!>I;{TFy=", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("FFeyD~ef/.r~");
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("O!>I;{TFy=");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test30()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("/>A12`P|WhU)_]|", (Object) class0);
      assertEquals("/>A12`P|WhU)_]|", object0);
  }
}
