...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("}");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "_y&?D4ZGW^t!\"]LG;]<");
      FileInputStream fileInputStream0 = TypeHandler.openFile("}");
  ...
  public void test04()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue(" Eyju", class0);
      assertEquals(" Eyju", string0);
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".3|=Ws8");
  ...
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/I[GM7s<MfeM0");
      assertTrue(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("9?W=Tz");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "org.apache.commons.cli.Option$1");
      File file0 = TypeHandler.createFile("9?W=Tz");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.openFile("Eg)ZKVp");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: Eg)ZKVp
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("o=BqA<:", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: o=BqA<:
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("{d[|^JRziUKlAW", (Object) "{d[|^JRziUKlAW");
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createClass("?<`<\"4}<2_d);2uP5dS");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ?<`<\"4}<2_d);2uP5dS
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("!z{hhN(Ke05%]|jn(6", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      Number number0 = TypeHandler.createNumber("30");
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("urZpvv[f_1JA");
        fail("Expecting exception: UnsupportedOperationException");
