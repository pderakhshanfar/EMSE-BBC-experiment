...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(",_96");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile(",_96");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("de:2s");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "; Unable to create an instance of: ");
      FileInputStream fileInputStream0 = TypeHandler.openFile("de:2s");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/;y/>3**x8");
      assertEquals(0L, file0.getTotalSpace());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("]j]toN");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("]j]toN");
  ...
  public void test23()  throws Throwable  {
      Class<Integer> class0 = Integer.class;
      Integer integer0 = TypeHandler.createValue("|9=@0bfyY-/udef0\"/", class0);
      assertNull(integer0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("V_Hdm[Sbl");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: V_Hdm[Sbl
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile(",_96");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ,_96
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("V_Hdm[Sbl", (Object) class0);
      assertEquals("V_Hdm[Sbl", object0);
  }
}
