...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("BFjOMoOtow{");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("BFjOMoOtow{");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".jUo[5JACyZ*3_u(-;");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/(XPp'cEA7Pt`IPG|f,");
  ...
  public void test07()  throws Throwable  {
      ...
      File file0 = TypeHandler.createFile("BFjOMoOtow{");
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("", (Object) "Fl'MLZtN'Dp}gkR*");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createObject("vn/X^MCekA}");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: vn/X^MCekA}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createClass("/(XPp'cEA7Pt`IPG|f,");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /(XPp'cEA7Pt`IPG|f,
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".W?kI`-%s.$u](");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".W?kI`-%s.$u](\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      try { 
        TypeHandler.openFile("BFjOMoOtow{");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: BFjOMoOtow{
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
