...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("RH(");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("RH(");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/(n[>Cn|(p~^/+_x");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("/(n[>Cn|(p~^/+_x");
  ...
  public void test04()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/(n[>Cn|(p~^/+_x");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".dR1r2/");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("#Xm", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: #Xm
         //
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL(".dR1r2/");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: .dR1r2/
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("RH(");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: RH(
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
