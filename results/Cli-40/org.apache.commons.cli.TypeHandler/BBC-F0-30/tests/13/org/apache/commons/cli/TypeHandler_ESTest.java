...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("]jp@q5Xf.d$v5@gQQn");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("]jp@q5Xf.d$v5@gQQn");
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("]jp@q5Xf.d$v5@gQQn");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "6M;?x?(yeQU+uIE");
      FileInputStream fileInputStream0 = TypeHandler.openFile("]jp@q5Xf.d$v5@gQQn");
  ...
  public void test02()  throws Throwable  {
      Object object0 = TypeHandler.createValue("x)af", (Object) null);
      assertNull(object0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "00#Q7]W^");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("a/.%iY{6%#rRx");
      assertFalse(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/j^;tGx+:=@\"@md%");
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("[Z", object0);
  ...
  public void test13()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("X6NrQ", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: X6NrQ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("zF&`O'#`", class0);
      assertNull(integer0);
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("b[SByv}Jn!&");
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("]jp@q5Xf.d$v5@gQQn");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("]jp@q5Xf.d$v5@gQQn");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ]jp@q5Xf.d$v5@gQQn
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.createClass("`n`;-teZb&N`#");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: `n`;-teZb&N`#
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("zF&`O'#`", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: zF&`O'#`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
