...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("N|i}");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("N|i}");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Xf54Vx`");
      byte[] byteArray0 = new byte[9];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("Xf54Vx`");
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("", (Object) "6{[F*z1y");
  ...
  public void test13()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("=Mcy)nmw*~PKh", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: =Mcy)nmw*~PKh
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("usp#!qB}sw'u6", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("dZ@ssZkk/", class0);
      assertEquals("dZ@ssZkk/", string0);
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Q*y]}C^R;F3h};");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("N|i}");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: N|i}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
