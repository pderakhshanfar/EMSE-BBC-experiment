...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("}.+h]v_?b.Emua^X<gG");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "; Unable to create an instance of: ");
      FileInputStream fileInputStream0 = TypeHandler.openFile("}.+h]v_?b.Emua^X<gG");
  ...
  public void test05()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "`?sO5");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("org.apache.coQmon/.cli.PatternOptionBuilder");
      assertEquals(0L, file0.length());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/dUpc]^T#yhLp");
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("v<aY`:GL8u{(y", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: v<aY`:GL8u{(y
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("^u-=^[EdW0h{mEW");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("^u-=^[EdW0h{mEW");
      // Undeclared exception!
      try { 
        TypeHandler.createValue("", (Object) fileInputStream0);
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("hP4e8", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: hP4e8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("org.apache.coQmon/.cli.PatternOptionBuilder");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"org.apache.coQmon/.cli.PatternOptionBuilder\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("V9Xsm84o#xibDs?", class0);
      assertNull(integer0);
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("] @d9G+J+d2ir{H4=T");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("^u-=^[EdW0h{mEW");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ^u-=^[EdW0h{mEW
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
