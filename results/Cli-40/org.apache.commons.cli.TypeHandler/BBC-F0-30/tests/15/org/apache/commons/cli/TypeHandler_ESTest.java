...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("57");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("57");
  ...
  public void test03()  throws Throwable  {
      Object object0 = TypeHandler.createValue("\"MfeqCj5L", (Object) null);
      assertNull(object0);
  }
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("n'k51w=R^+");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "sytCN'xye>ni'YQ");
      File file0 = TypeHandler.createFile("n'k51w=R^+");
      assertEquals("n'k51w=R^+", file0.getName());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile(".$0fc");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/'GMq");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("_CG99 %Rz_ ", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: _CG99 %Rz_ 
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("ct7>ohf1");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ct7>ohf1
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile(".$0fc");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: .$0fc
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
