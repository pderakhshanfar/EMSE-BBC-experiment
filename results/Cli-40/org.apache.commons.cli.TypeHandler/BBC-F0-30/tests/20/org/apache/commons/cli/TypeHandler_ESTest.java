...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(":(~3yPIrz?e(Bc2Z");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile(":(~3yPIrz?e(Bc2Z");
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(":(~3yPIrz?e(Bc2Z");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "gbDTX_2|");
      FileInputStream fileInputStream0 = TypeHandler.openFile(":(~3yPIrz?e(Bc2Z");
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("){oE,H.?@kJ<do");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, " ");
      File file0 = TypeHandler.createFile("){oE,H.?@kJ<do");
      assertEquals(2L, file0.length());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".j;c==");
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("'3BA", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".Xd-Qt%yj{*");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".Xd-Qt%yj{*\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("[)1l43GU@Zpc';:rx", (Object) class0);
      assertEquals("[)1l43GU@Zpc';:rx", object0);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/*oo");
      assertEquals("/*oo", file0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("){oE,H.?@kJ<do");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL(".j;c==");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: .j;c==
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile(":(~3yPIrz?e(Bc2Z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: :(~3yPIrz?e(Bc2Z
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.createClass("'3BA");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: '3BA
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
