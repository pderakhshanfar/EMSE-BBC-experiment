...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".%1V@HkGUTz");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ".%1V@HkGUTz");
      FileInputStream fileInputStream0 = TypeHandler.openFile(".%1V@HkGUTz");
  ...
  public void test03()  throws Throwable  {
      ...
      File file0 = TypeHandler.createFile(".%1V@HkGUTz");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/`Ri");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Zd+i(", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Zd+i(
         //
  ...
  public void test16()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("5kNgXyrW8Ot+a`W", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 5kNgXyrW8Ot+a`W
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".%1V@HkGUTz");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".%1V@HkGUTz\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("!($r`muE1k/");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: !($r`muE1k/
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile(".%1V@HkGUTz");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: .%1V@HkGUTz
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
