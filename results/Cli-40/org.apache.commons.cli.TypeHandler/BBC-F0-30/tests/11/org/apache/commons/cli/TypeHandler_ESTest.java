...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Number number0 = TypeHandler.createNumber("99");
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("xG:|");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "K-Nhs<");
      FileInputStream fileInputStream0 = TypeHandler.openFile("xG:|");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".K34i=4\"!HB`0JK(");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Xs;IW/Vka_");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("O}@ ]Th?TS.");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "O}@ ]Th?TS.");
      File file0 = TypeHandler.createFile("O}@ ]Th?TS.");
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("/Xs;IW/Vka_", (Object) "/Xs;IW/Vka_");
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("B[s$UNVJ~Z(%!");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: B[s$UNVJ~Z(%!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("6^V}Y.M82)~Et?;Jb:F", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("hU2rZHl(>.9kh");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"hU2rZHl(>.9kh\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("R%5su;)Ny`2", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: R%5su;)Ny`2
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      Class<?> class0 = TypeHandler.createClass("org.apache.commons.cli.Option$Builder");
      assertFalse(class0.isPrimitive());
  }
