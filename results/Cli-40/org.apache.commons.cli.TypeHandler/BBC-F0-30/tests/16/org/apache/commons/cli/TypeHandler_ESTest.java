...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("EV;tlc5 vPI'J");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("EV;tlc5 vPI'J");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("?_ F");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("?_ F");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("DX );j,");
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("DX );j,");
      assertEquals("DX );j,", file0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".%`5<a0_u>o-c^\"");
      assertEquals(".%`5<a0_u>o-c^\"", file0.getName());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("RD8g0$V", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: RD8g0$V
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("m]%NzOU:`E");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: m]%NzOU:`E
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("5?.tO`4Y;mAl}X");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"5?.tO`4Y;mAl}X\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/hB*I9");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("EV;tlc5 vPI'J");
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("J\"kp3%#PPUJhp[bl3");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("EV;tlc5 vPI'J");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: EV;tlc5 vPI'J
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
