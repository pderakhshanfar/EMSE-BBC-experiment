...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("5cHztVpw8$/aJv;*JJ8");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("5cHztVpw8$/aJv;*JJ8");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("IY");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "'a 3}Ra");
      FileInputStream fileInputStream0 = TypeHandler.openFile("IY");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".C+PHQ$RGVYV!_`hL<");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("]l8X[!TyR}RST");
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("]l8X[!TyR}RST");
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("jKlC{]2eG16z~).QQ8:", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: jKlC{]2eG16z~).QQ8:
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("RvP)!BSwmR n.tkypZ5");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"RvP)!BSwmR n.tkypZ5\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("oA", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: oA
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("?}2", class0);
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/tyq??0;c0W&");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("5cHztVpw8$/aJv;*JJ8");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 5cHztVpw8$/aJv;*JJ8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
