...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Xl98V");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("Xl98V");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Dr~kMuN}*a");
  ...
  public void test07()  throws Throwable  {
      try { 
        TypeHandler.openFile("Xl98V");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: Xl98V
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("o?c*0<9", (Object) "o?c*0<9");
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("F2\"{lM6Fv", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: F2\"{lM6Fv
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("[GiEP", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("-4K[z\"S", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: -4K[z\"S
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      File file0 = TypeHandler.createFile(".m&aJJ\"(xhihG");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("xp8+786[a g|S+)");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL("{]f]?g4)?z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: {]f]?g4)?z
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("N\"cuHv.O,mE");
        fail("Expecting exception: UnsupportedOperationException");
