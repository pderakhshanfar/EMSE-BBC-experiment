...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("org.apache.commons.cli.TypeHandler");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "MN");
      FileInputStream fileInputStream0 = TypeHandler.openFile("org.apache.commons.cli.TypeHandler");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".}}JtaV[Gv|z|_E8");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "; Unable to create an instance of: ");
      File file0 = TypeHandler.createFile(".}}JtaV[Gv|z|_E8");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createObject("Ot^[tI/@tp}%? ?dF");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Ot^[tI/@tp}%? ?dF
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("LkYRQJSNvkZ+");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: LkYRQJSNvkZ+
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("/wD*;GTx", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/wD*;GTx");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("4jJ]`w");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 4jJ]`w
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("kA9`(i.qPxw");
        fail("Expecting exception: UnsupportedOperationException");
