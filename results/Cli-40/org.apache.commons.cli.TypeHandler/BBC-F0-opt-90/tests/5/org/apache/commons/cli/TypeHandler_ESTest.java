...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("K'K/YR");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("K'K/YR");
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("K'K/YR");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "V&7;\"8");
      FileInputStream fileInputStream0 = TypeHandler.openFile("K'K/YR");
  ...
  public void test03()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("'LsNy$=XN/-#tu<,8", class0);
      assertEquals("'LsNy$=XN/-#tu<,8", string0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("K'K/YR");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "V&7;\"8");
      File file0 = TypeHandler.createFile("K'K/YR");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/d9uCxYY#Fsv");
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.openFile("K'K/YR");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: K'K/YR
         //
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("9", (Object) "9");
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("0kH!Q@V,D\"2l8E", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 0kH!Q@V,D\"2l8E
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass(")bcy?WE(");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: )bcy?WE(
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("; Unable to create an instance of: ", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("XE.Qx,WeJP#_*t?");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"XE.Qx,WeJP#_*t?\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Object object0 = TypeHandler.createValue("XE.Qx,WeJP#_*t?", (Object) null);
      assertNull(object0);
  }
}
