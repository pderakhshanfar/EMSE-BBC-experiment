...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("7r");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("7r");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("t_S Hqg`");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "]u");
      FileInputStream fileInputStream0 = TypeHandler.openFile("t_S Hqg`");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(".`$ euk+[adrI0.", (Object) class0);
      assertEquals(".`$ euk+[adrI0.", object0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(")_?urUo_hTU q");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ")H0,*8duMN");
      File file0 = TypeHandler.createFile(")_?urUo_hTU q");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".2.$t2u,:iR#. ^E8");
      assertTrue(file0.isHidden());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/g8-T9[");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("'\"lnn)2", (Object) "'\"lnn)2");
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createObject(".2.$t2u,:iR#. ^E8");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .2.$t2u,:iR#. ^E8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("D;5.G'HCMY{", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue(",3 f;r`zNk", class0);
      assertEquals(",3 f;r`zNk", string0);
  }
