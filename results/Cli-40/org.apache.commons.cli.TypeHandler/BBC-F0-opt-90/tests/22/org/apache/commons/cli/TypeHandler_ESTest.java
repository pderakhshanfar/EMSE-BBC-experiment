...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("U~WzArio");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "U~WzArio");
      FileInputStream fileInputStream0 = TypeHandler.openFile("U~WzArio");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".L=}?Q|");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/jwJMbWVtE");
  ...
  public void test06()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "ZMw<w7Ck?:e+8x2lOHV");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", (Object) integer0);
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("V?0#)pjX?FM]s}<");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: V?0#)pjX?FM]s}<
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("V?0#)pjX?FM]s}<", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("8~^1pSsFT4kX?", (Object) class0);
      assertEquals("8~^1pSsFT4kX?", object0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("L*u\"?");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: L*u\"?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("KK{U");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: KK{U
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
