...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("El|SDvP");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("El|SDvP");
      assertTrue(file0.exists());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".FB>j");
      assertEquals(".FB>j", file0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/[Yhv3`R84/8zud?");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(">e1ne'MI-[^om~o_8", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: >e1ne'MI-[^om~o_8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("{Z@u~VYQX~iA)2<g", (Object) "{Z@u~VYQX~iA)2<g");
  ...
  public void test19()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("$l03YLI=w", class0);
      assertEquals("$l03YLI=w", string0);
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("Gs2% q.P!P(vThc.a");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"Gs2% q.P!P(vThc.a\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createValue(">e1ne'MI-[^om~o_8", (Object) null);
      assertNull(object0);
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("K6hd?v&[=h", (Object) class0);
      assertEquals("K6hd?v&[=h", object0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("wL@UN");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: wL@UN
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
