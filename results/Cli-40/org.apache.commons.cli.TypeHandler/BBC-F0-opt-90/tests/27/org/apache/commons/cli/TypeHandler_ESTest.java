...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("$Ec.@ty&tz=j+");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("$Ec.@ty&tz=j+");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/WSxMBc1U*.");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("(@-,L$q7A/.KH'DB;");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Wjl%");
      File file0 = TypeHandler.createFile("(@-,L$q7A/.KH'DB;");
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("auf30Nd.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"auf30Nd.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("`o||=p+J.m:E1.i");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("BF#316}pl=ME3K");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: BF#316}pl=ME3K
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("$Ec.@ty&tz=j+");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: $Ec.@ty&tz=j+
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
