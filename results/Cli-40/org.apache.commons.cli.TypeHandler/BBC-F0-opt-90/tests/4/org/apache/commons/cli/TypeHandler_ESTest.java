...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("oILZ\"5ve%", (Object) class0);
      assertEquals("oILZ\"5ve%", object0);
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("//aMOe%XU(");
      assertFalse(file0.canWrite());
  }
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("sb-sf}", (Object) "sb-sf}");
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("_9>l*|e,,eh", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: _9>l*|e,,eh
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("EPqq``R~>=4u^O.VW2");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: EPqq``R~>=4u^O.VW2
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("_9>l*|e,,eh", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("-wO[iyun~m.JT+]");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"-wO[iyun~m.JT+]\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("(xLZ", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: (xLZ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
