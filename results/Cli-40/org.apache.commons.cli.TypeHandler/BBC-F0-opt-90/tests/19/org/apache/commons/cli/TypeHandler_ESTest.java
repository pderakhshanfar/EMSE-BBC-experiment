...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("y=;bWGbZ!");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "y=;bWGbZ!");
      FileInputStream fileInputStream0 = TypeHandler.openFile("y=;bWGbZ!");
      assertEquals(9, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Object object0 = TypeHandler.createValue("|FL,OAbyL8`Ag^xXG", (Object) null);
      assertNull(object0);
  }
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/>('n6q\"[mEwi");
  ...
  public void test13()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("s4zK\"xW", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: s4zK\"xW
         //
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("x)iXg)O8I8Z$.]eL[_");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"x)iXg)O8I8Z$.]eL[_\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("N* 8^t6DT,f");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("y=;bWGbZ!");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: y=;bWGbZ!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.createClass("DQ/{Kn:F)+y");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: DQ/{Kn:F)+y
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("CrHm'Xj=DcisQP&4Hu", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: CrHm'Xj=DcisQP&4Hu
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
