...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("~Z5]3 tz]a5Kx");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("~Z5]3 tz]a5Kx");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("%dr");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "p");
      FileInputStream fileInputStream0 = TypeHandler.openFile("%dr");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/mD`8`");
      assertEquals("/mD`8`", file0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("?ZvvnA", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ?ZvvnA
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("O7d?C");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: O7d?C
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue(")_AxM", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("Dx.I*h[O^#?(uf");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"Dx.I*h[O^#?(uf\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("Kt!dD:8-WWO(O<X^Ex", class0);
      assertEquals("Kt!dD:8-WWO(O<X^Ex", string0);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile(".\"SWo3XM_'!!kW");
