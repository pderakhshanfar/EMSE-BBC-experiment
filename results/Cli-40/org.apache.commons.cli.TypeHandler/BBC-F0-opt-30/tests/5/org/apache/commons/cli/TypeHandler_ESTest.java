...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/u*Do");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "/u*Do");
      FileInputStream fileInputStream0 = TypeHandler.openFile("/u*Do");
      assertEquals(7, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Object object0 = TypeHandler.createValue("MOG+[F,|ZB! A", (Object) null);
      assertNull(object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/u*Do");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "/u*Do");
      File file0 = TypeHandler.createFile("/u*Do");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile(".lZ8zU'");
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.openFile("!K}ooz(4n=2(',!F");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: !K}ooz(4n=2(',!F
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("D^J/");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: D^J/
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("Ut`}2l=", class0);
      assertEquals("Ut`}2l=", string0);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createObject("%h%4S$~T,BQ@");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: %h%4S$~T,BQ@
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".@b<TFK&");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".@b<TFK&\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
