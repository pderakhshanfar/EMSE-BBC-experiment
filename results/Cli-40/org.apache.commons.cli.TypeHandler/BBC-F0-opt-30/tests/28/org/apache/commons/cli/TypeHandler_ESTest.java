...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("yPtHS8, 1u0GruBc");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("yPtHS8, 1u0GruBc");
  ...
  public void test01()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ")N[:%efDVlqUdEgjoX");
      FileInputStream fileInputStream0 = TypeHandler.openFile("r");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/Jq'Y");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/Jq'Y");
      assertTrue(file0.canExecute());
  }
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("*D75RdNL|/QdZe^ut", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: *D75RdNL|/QdZe^ut
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("Mm:m;@lO~");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Mm:m;@lO~
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("`YO^E*L-A", class0);
      assertNull(integer0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("xej_HB;wi4E@U", class0);
      assertEquals("xej_HB;wi4E@U", string0);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("> h*VAX|.Lm");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"> h*VAX|.Lm\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("le", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: le
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("yPtHS8, 1u0GruBc");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: yPtHS8, 1u0GruBc
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
