...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("k?^'uv:gVV ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("k?^'uv:gVV ");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("LL~u2N/y");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("LL~u2N/y");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("D8c*~_: edw=X5UU~S");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "i{osrR");
      File file0 = TypeHandler.createFile("D8c*~_: edw=X5UU~S");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".[W(X>za+4:c");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/hgoZ)aseKFeQG X-");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("[F", object0);
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("}q{X??T^&pE.xC+H");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"}q{X??T^&pE.xC+H\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("yTtGd*Q>[dA{k", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: yTtGd*Q>[dA{k
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("?]7,PV2jQ3@");
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.createClass("g+g]+lm3)NZ6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: g+g]+lm3)NZ6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
