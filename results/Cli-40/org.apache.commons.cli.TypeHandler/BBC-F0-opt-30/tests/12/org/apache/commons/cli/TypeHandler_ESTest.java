...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      try { 
        TypeHandler.openFile("u/#trLOpQX8$<Er");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: u/#trLOpQX8$<Er
         //
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".z|:l");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("PV&EVmGda", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: PV&EVmGda
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("S`-~@n", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: S`-~@n
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("=lR4VhZVPw,L)A");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: =lR4VhZVPw,L)A
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("`>5!vj[;b", class0);
      assertNull(integer0);
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      File file0 = TypeHandler.createFile("/G0cZpQ3K{XU");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("r)R(m}6yT");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL("bIppT.|QfT}qPCW.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: bIppT.|QfT}qPCW.
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
