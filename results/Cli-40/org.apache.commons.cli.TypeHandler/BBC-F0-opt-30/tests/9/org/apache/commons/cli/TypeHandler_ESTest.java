...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("[wYV#>CKHj!:PZt-");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "[wYV#>CKHj!:PZt-");
      FileInputStream fileInputStream0 = TypeHandler.openFile("[wYV#>CKHj!:PZt-");
  ...
  public void test02()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("WYi[V; ?8wL i4d(aZv", class0);
      assertEquals("WYi[V; ?8wL i4d(aZv", string0);
  }
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("[wYV#>CKHj!:PZt-");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "[wYV#>CKHj!:PZt-");
      File file0 = TypeHandler.createFile("[wYV#>CKHj!:PZt-");
      assertEquals(16L, file0.length());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".B]2#z]@\"l,vjx@l ");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/h7y)`_cDI#7@");
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("]N&]+2", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ]N&]+2
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("/h7y)`_cDI#7@");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /h7y)`_cDI#7@
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("O{WN(<SZ>&>Cu", class0);
      assertNull(integer0);
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("[wYV#>CKHj!:PZt-");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: [wYV#>CKHj!:PZt-
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
