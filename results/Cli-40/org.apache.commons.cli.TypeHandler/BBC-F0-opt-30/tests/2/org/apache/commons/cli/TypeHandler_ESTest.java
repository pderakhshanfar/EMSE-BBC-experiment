...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Object object0 = TypeHandler.createValue("7;<j?LRD_^~Xu", (Object) null);
      assertNull(object0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(":+DM,U>=8:/voB{Cjh:", (Object) class0);
      assertEquals(":+DM,U>=8:/voB{Cjh:", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("o@,>8");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("o@,>8");
      assertEquals(6L, file0.length());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".pTs8IKFRbQ$\"");
      assertFalse(file0.canExecute());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/4=HQ*R|feOdp");
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createObject("VT{yZY[H',Di<");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: VT{yZY[H',Di<
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue(":+DM,U>=8:/voB{Cjh:", class0);
      assertEquals(":+DM,U>=8:/voB{Cjh:", string0);
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("}sv2@++(udp w8]N\"t");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: }sv2@++(udp w8]N\"t
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("EedXysle]cA", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: EedXysle]cA
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
