...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Di");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("Di");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("!jO_X^X", (Object) class0);
      assertEquals("!jO_X^X", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".%3;IW!oI-w");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(".%3;IW!oI-w");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("==*RVc.GxQ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ==*RVc.GxQ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("lj&_[EvrqFr+M7", class0);
      assertNull(integer0);
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("orgapache.commns.cli.TypeHandler");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"orgapache.commns.cli.TypeHandler\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("!jO_X^X", class0);
      assertEquals("!jO_X^X", string0);
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("Di");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: Di
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
