...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".IrDx+M");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/aje=l2");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("34pW 'AIGZE", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 34pW 'AIGZE
         //
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("orgGapache.commoVs.Cli.PatternOptionBuilder", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: orgGapache.commoVs.Cli.PatternOptionBuilder
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createNumber("'2|r;Ra&wJ=|qn.=eN");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"'2|r;Ra&wJ=|qn.=eN\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.createURL("74gz1d7d=f");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 74gz1d7d=f
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
