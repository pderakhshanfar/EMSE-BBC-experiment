...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(">%(7-,oP:`1");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(">%(7-,oP:`1");
      assertEquals(1392409281320L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/JC$*mSwz07;E($");
      assertTrue(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".O'h4V2Z=a-POe%->");
      assertEquals(".O'h4V2Z=a-POe%->", file0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject("<7R7");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: <7R7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
