...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("+>%e^H");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("+>%e^H");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("~cp*", (Object) class0);
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("+>%e^H");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "org.apache.commons.cli.Option");
      File file0 = TypeHandler.createFile("+>%e^H");
      assertEquals("+>%e^H", file0.getName());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".eo3g#-sc");
  ...
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/6G0Z1W}QT>");
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue((String) null, (Object) "[B");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createObject(".eo3g#-sc");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .eo3g#-sc
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("|0=7V+", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createNumber("4. !8w\"3<J&BjIY6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"4. !8w\"3<J&BjIY6\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("\"rc5U:V>haQq;}", class0);
      assertEquals("\"rc5U:V>haQq;}", string0);
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.createURL("X`Zv} #qM-[7[(kj");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: X`Zv} #qM-[7[(kj
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("&O_+%?&ZC!d]CT");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test33()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("am@", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: am@
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
