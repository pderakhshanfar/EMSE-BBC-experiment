...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("!,L~1:+/4S9[LZWQ=");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("!,L~1:+/4S9[LZWQ=");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/&iHRbN.]jB");
      byte[] byteArray0 = new byte[9];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/&iHRbN.]jB");
      assertEquals("/&iHRbN.]jB", file0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass(" ,Nr)-7lZOku[M 1x?");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class:  ,Nr)-7lZOku[M 1x?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".+h<E2Ds");
      assertEquals(".+h<E2Ds", file0.getName());
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("U_2sAe6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: U_2sAe6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("=Q>>L.{pQ$PQT# ie5-");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("!,L~1:+/4S9[LZWQ=");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: !,L~1:+/4S9[LZWQ=
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
