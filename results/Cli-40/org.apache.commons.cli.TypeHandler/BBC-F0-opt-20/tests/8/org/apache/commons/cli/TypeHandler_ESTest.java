...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("]-G`>.op3atFhCv_");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("]-G`>.op3atFhCv_");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("<(3^hYO00MZJ", (Object) class0);
      assertEquals("<(3^hYO00MZJ", object0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".Cp[F'i*]");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "lYx%&n");
      File file0 = TypeHandler.createFile(".Cp[F'i*]");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Cp[F'i*]");
      assertEquals(".Cp[F'i*]", file0.toString());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/bOUm.`BTv M");
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.openFile("]-G`>.op3atFhCv_");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ]-G`>.op3atFhCv_
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("gYfl^9", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: gYfl^9
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("ct}X", (Object) "");
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("s3!'v!ik^dAGv}uY>", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("5", class0);
