...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(">TSIf*5LC=^VF'r");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile(">TSIf*5LC=^VF'r");
  ...
  public void test02()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "`?GA9UfeI6l~<A#%@!");
  ...
  public void test03()  throws Throwable  {
      Object object0 = TypeHandler.createValue("=#/\"2@P6_ppuuE", (Object) null);
      assertNull(object0);
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Vs D1Lc'*I9Ri>}{=R");
  ...
  public void test07()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "&5EG#1LM#D1=H\"(");
      File file0 = TypeHandler.createFile("--");
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("`?GA9UfeI6l~<A#%@!", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: `?GA9UfeI6l~<A#%@!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("93Q~/|cH7.y&sECKy*");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"93Q~/|cH7.y&sECKy*\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("]?g,928n>lToFn~T", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Y+)`_I");
      assertFalse(file0.isDirectory());
  }
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("&BcZNM%pie^(jy9}/\"H");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile(">TSIf*5LC=^VF'r");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: >TSIf*5LC=^VF'r
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
