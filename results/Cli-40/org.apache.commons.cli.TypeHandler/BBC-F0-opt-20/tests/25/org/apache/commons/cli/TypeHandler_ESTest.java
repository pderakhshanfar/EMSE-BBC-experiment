...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("~IARG'n*?%}gDjV]");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("~IARG'n*?%}gDjV]");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".y8#{");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/-[jxy7p@R^V$cR+QSI");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("#4If?");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "#4If?");
      File file0 = TypeHandler.createFile("#4If?");
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("x*vv9GsD]Ds7GpxL", (Object) "x*vv9GsD]Ds7GpxL");
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("!X", class0);
        fail("Expecting exception: Exception");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("rN2JTU1^-B1ZGH)'y");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: rN2JTU1^-B1ZGH)'y
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("EAzQC<,7BM!~c,/y", class0);
      assertNull(integer0);
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("`A");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: `A
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("9zb]4h\"7i&");
        fail("Expecting exception: UnsupportedOperationException");
