...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("ALD/k KCU");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "V32FI*^p<pNiE ");
      FileInputStream fileInputStream0 = TypeHandler.openFile("ALD/k KCU");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("PMR{YMT+km#^<W7VG0", (Object) class0);
      assertEquals("PMR{YMT+km#^<W7VG0", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("PMR{YMT+km#^<W7VG0", class0);
      assertEquals("PMR{YMT+km#^<W7VG0", string0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".cP ?7Xw`gbO2");
      byte[] byteArray0 = new byte[9];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(".cP ?7Xw`gbO2");
      assertEquals(9L, file0.length());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/3K1(dv'R");
  ...
  public void test08()  throws Throwable  {
      try { 
        TypeHandler.openFile("ALD/k KCU");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ALD/k KCU
         //
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("9kz'NB");
        fail("Expecting exception: UnsupportedOperationException");
