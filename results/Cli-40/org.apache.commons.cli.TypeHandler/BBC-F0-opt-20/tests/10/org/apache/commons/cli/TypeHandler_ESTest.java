...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Unable to find the class: ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "org.apache.commons.cli.Options");
      FileInputStream fileInputStream0 = TypeHandler.openFile("Unable to find the class: ");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".?0#ZP]uSq,");
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Y7Qm QyIfpY2", (Object) "");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("$Ofs0]$Xiu-c");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: $Ofs0]$Xiu-c
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("$Os0]$Xiu-c", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("dO~;o.%X-jMQ@5");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"dO~;o.%X-jMQ@5\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("}RIE>T6", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: }RIE>T6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("@.)]Ne@S#s\"(");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: @.)]Ne@S#s\"(
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
