...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      FileInputStream fileInputStream0 = TypeHandler.openFile(";Dt");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Dk\"kiE}ca0-", (Object) class0);
      assertEquals("Dk\"kiE}ca0-", object0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "J`<acsC\r//C~ijr2");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".XGVJ");
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Uh{)40`pta`M(k+:(qT", (Object) "Uh{)40`pta`M(k+:(qT");
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("\"1&e B(Gwqv/wyGF", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: \"1&e B(Gwqv/wyGF
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass(":<Q'd>{Yt");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: :<Q'd>{Yt
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("#(oT", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("w)}I)O9@", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: w)}I)O9@
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("#(oT", class0);
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createObject("#(oT");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: #(oT
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/3n)A*9Nw");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("-\"-|.p<xP0|%_W*bJ");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile(";Dt");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ;Dt
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
