...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("P,zyk$Y18!a");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("P,zyk$Y18!a");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("x<(X>R#GaU%$", (Object) class0);
      assertEquals("x<(X>R#GaU%$", object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".i*j,");
      byte[] byteArray0 = new byte[7];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(".i*j,");
      assertEquals(".i*j,", file0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("'~PgZ", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: '~PgZ
         //
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("qLp/e%tf0", (Object) "qLp/e%tf0");
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createClass("{|*U!3os7*vE1uBr6tT");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: {|*U!3os7*vE1uBr6tT
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("o(u", class0);
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createObject("a1");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: a1
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      File file0 = TypeHandler.createFile("/-niQb9");
  ...
  public void test31()  throws Throwable  {
      try { 
        TypeHandler.openFile("P,zyk$Y18!a");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: P,zyk$Y18!a
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
