...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("dLV6jOj`");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "dLV6jOj`");
      FileInputStream fileInputStream0 = TypeHandler.openFile("dLV6jOj`");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(")uLR!D*n", (Object) class0);
      assertEquals(")uLR!D*n", object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("dLV6jOj`");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "dLV6jOj`");
      File file0 = TypeHandler.createFile("dLV6jOj`");
      assertEquals(8L, file0.length());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".J|dbCvKI");
      assertEquals(0L, file0.getUsableSpace());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/kCIxDXd");
      assertEquals(0L, file0.getUsableSpace());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("rmuxo77?%6U]pdfbMp", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: rmuxo77?%6U]pdfbMp
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("2OWnbs", (Object) "2OWnbs");
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("APb_Ach4b{", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("yG #d=dyY(iuzUX$G");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("[fq6Xcg9{Gbpd7}7");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: [fq6Xcg9{Gbpd7}7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("dLV6jOj`");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: dLV6jOj`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
