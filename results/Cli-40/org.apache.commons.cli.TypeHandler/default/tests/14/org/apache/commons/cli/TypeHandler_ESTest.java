...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/;|6s");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("/;|6s");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".uf6D&G");
  ...
  public void test07()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/;|6s");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("B*)5{I@", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: B*)5{I@
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("w,yB<# e*?Bo#V=)", (Object) "w,yB<# e*?Bo#V=)");
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createClass("xqhN");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: xqhN
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("]W5Bru)\".j<lx9Z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"]W5Bru)\".j<lx9Z\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("/;|6s", class0);
      assertNull(integer0);
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("ofkZhKkrys%lqC");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ofkZhKkrys%lqC
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("_VqA*ym@2.Q7m(?");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: _VqA*ym@2.Q7m(?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
