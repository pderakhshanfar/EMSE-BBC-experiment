...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("^6|kDY3y*:^k!");
      byte[] byteArray0 = new byte[4];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("^6|kDY3y*:^k!");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Fn_hyZ!|I[;$?$w", (Object) class0);
      assertEquals("Fn_hyZ!|I[;$?$w", object0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[4];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("^6|kDY3y*:^k!");
      assertEquals("^6|kDY3y*:^k!", file0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("x|h02qhj?E4VFMpV", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: x|h02qhj?E4VFMpV
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("nv&~/*4t", (Object) "nv&~/*4t");
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("y%Ux/@D}~8", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: y%Ux/@D}~8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass(")~C:2>");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: )~C:2>
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("qye41Z`pY)ojUkB$-t", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("Fn_hyZ!|I[;$?$w", class0);
      assertEquals("Fn_hyZ!|I[;$?$w", string0);
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile("/. +Q{vE9");
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("$pb_&K]");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: $pb_&K]
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles(".3BIjk\"a*WA]dLJd");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("3zt");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 3zt
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
