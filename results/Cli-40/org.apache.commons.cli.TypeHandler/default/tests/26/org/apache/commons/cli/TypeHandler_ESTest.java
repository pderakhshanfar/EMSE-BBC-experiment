...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Q7a6d2@VZ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("Q7a6d2@VZ/");
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.openFile("Er~Kl$K)Lmj");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: Er~Kl$K)Lmj
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("bNrtRTUHGuPK+{=fhY", (Object) "bNrtRTUHGuPK+{=fhY");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("/ ,bqrV&B4+:ht");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: / ,bqrV&B4+:ht
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("cYmlkDV2tP<j$ptd)q6", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: cYmlkDV2tP<j$ptd)q6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("6o\".m/SV*C");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"6o\".m/SV*C\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile(".PR52Lz3\"K");
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("+NFeg_`:=clB'ivD!");
        fail("Expecting exception: UnsupportedOperationException");
