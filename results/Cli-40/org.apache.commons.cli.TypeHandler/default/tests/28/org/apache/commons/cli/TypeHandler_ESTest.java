...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("9uFWM#[ZbSp %");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("9uFWM#[ZbSp %");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("I+hWc0u,;VU']");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Unable to find file: ");
      File file0 = TypeHandler.createFile("I+hWc0u,;VU']");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/QN:hp]))");
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("LbqZDYxzcl$6x5#}5[", (Object) "LbqZDYxzcl$6x5#}5[");
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createClass("d!('B8<)l");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: d!('B8<)l
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("jw6", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createObject("jw6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: jw6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("6'K8`/Kr+&S4JW{", class0);
      assertEquals("6'K8`/Kr+&S4JW{", string0);
  }
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("0q+!/z0Q8C!L,?#n");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("9uFWM#[ZbSp %");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: 9uFWM#[ZbSp %
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
