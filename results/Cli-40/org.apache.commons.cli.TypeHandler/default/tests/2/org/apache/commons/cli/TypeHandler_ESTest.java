...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("; Unable to create an instance of: ");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "`@;Hg");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".0'7 i?A@VF*$HJYdD");
      assertEquals(0L, file0.length());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/1.v^m");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("y%GPnHfH2nvi?r3,}A", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: y%GPnHfH2nvi?r3,}A
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("gVP/>{p,", (Object) "gVP/>{p,");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("t_''z,A");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: t_''z,A
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(".V1OW'CXN5", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .V1OW'CXN5
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("6!5z+?.p^vD(F\"o#l");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"6!5z+?.p^vD(F\"o#l\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("Et2\"@ONY_!V8;z;b}");
