...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/E+FI");
      assertEquals(0L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".?c1cS`ju2vqz");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(".?c1cS`ju2vqz");
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("bJ", (Object) "bJ");
  ...
  public void test18()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("KHW#>;B~'arL#/", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: KHW#>;B~'arL#/
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("U5uHD]LQ>H~Zh68Jf0", class0);
      assertEquals("U5uHD]LQ>H~Zh68Jf0", string0);
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("s&v");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: s&v
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
