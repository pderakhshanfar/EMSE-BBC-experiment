...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("kn5}C0j}fcpu");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("kn5}C0j}fcpu");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/_YEv}(2");
      assertEquals(0L, file0.getFreeSpace());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".[v2'N;5R2{(xJ?~");
  ...
  public void test07()  throws Throwable  {
      try { 
        TypeHandler.openFile("jgfmWQPt;J!-d3");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: jgfmWQPt;J!-d3
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
