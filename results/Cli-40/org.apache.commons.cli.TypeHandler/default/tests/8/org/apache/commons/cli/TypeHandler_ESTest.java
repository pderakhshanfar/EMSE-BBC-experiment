...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("MiNW8GxV%`~i>m5");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "6");
      FileInputStream fileInputStream0 = TypeHandler.openFile("MiNW8GxV%`~i>m5");
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("rdgt(xBv5usvETf");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile("rdgt(xBv5usvETf");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".d#\"'G~6JW{H.");
      assertFalse(file0.canWrite());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/]rD^GZTXJ:n");
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("UJ\"cv@,C}_B>q$gn", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: UJ\"cv@,C}_B>q$gn
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("zp)Y.9Rjc,_z>");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: zp)Y.9Rjc,_z>
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("Unble o fid the class: ", class0);
      assertNull(integer0);
  }
  ...
  public void test25()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("<Wv*+e+G*<", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: <Wv*+e+G*<
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test32()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("Unble o fid the class: ", (Object) class0);
      assertEquals("Unble o fid the class: ", object0);
  }
}
