...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("(Z$:N$|K");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("(Z$:N$|K");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("!wB ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "|Jegiw\"r%:r0X9URN");
      FileInputStream fileInputStream0 = TypeHandler.openFile("!wB ");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("8bU", (Object) class0);
      assertEquals("8bU", object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("bMn^MeD}yKbGT(7]");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "4");
      File file0 = TypeHandler.createFile("bMn^MeD}yKbGT(7]");
      assertFalse(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("Xzw00s/. 5z");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/2T|Ujsd");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue(";FG|HDu2J", (Object) "vGmT.eU");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("#UG,,MHj", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: #UG,,MHj
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("vGmT.eU", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("Unable to find fileT ");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("(Z$:N$|K");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: (Z$:N$|K
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Object object0 = TypeHandler.createValue("gzpZe~3P/Y0U", (Object) null);
      assertNull(object0);
  }
}
