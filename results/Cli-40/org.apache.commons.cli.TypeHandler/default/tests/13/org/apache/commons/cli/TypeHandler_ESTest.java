...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("zB23h]Ddm2");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("zB23h]Ddm2");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("t", (Object) class0);
      assertEquals("t", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".kl+]i752");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(",uPFApspBTO[&%a");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "ts<X|!h_");
      File file0 = TypeHandler.createFile(",uPFApspBTO[&%a");
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("S^Q&", (Object) "S^Q&");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Cannot add value, list full.", class0);
        fail("Expecting exception: Exception");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("}AU6l");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: }AU6l
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("R|PO*\u0001d", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("8A_X3k$(}z^%g", class0);
      assertEquals("8A_X3k$(}z^%g", string0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.openFile("R|PO*\u0001d");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: R|PO*\u0001d
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
