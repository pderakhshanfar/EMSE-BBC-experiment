...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".*,61qS4%{(HVwb>");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/NUypH8ai){Y(O");
      assertEquals("/NUypH8ai){Y(O", file0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("!n;<Yv=", (Object) "!n;<Yv=");
  ...
  public void test24()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("}TuDi}", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: }TuDi}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("dBr*G");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: dBr*G
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.createClass("Q],BGPgY|\bQFGQDg");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Q],BGPgY|\bQFGQDg
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
