...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, " 3Hl'{");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(";vWM@2GDi(A0q&;", (Object) class0);
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".04");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/ea_CYba]mCQS#1Pp");
      assertFalse(file0.canRead());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("uf%^([a>vE");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("uf%^([a>vE");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("org.apache.commons.cli.Psexception");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: org.apache.commons.cli.Psexception
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("RPQGG&\"", class0);
      assertNull(integer0);
  }
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("U@77%S", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: U@77%S
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue(";vWM@2GDi(A0q&;", class0);
  ...
  public void test23()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(")h1bsF+:)mVX", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: )h1bsF+:)mVX
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
