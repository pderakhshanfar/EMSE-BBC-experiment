...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("v_m;SXoI&%uPQnh");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("v_m;SXoI&%uPQnh");
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("v_m;SXoI&%uPQnh");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "OFWAL]_.?_sq!#N[");
      FileInputStream fileInputStream0 = TypeHandler.openFile("v_m;SXoI&%uPQnh");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Pt0Po;Ax% 3N^!x", (Object) class0);
      assertEquals("Pt0Po;Ax% 3N^!x", object0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("I,cFu", class0);
      assertEquals("I,cFu", string0);
  }
  ...
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".NE08p");
      byte[] byteArray0 = new byte[7];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(".NE08p");
      assertEquals(".NE08p", file0.getName());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("7E+? mw:wLf1Z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 7E+? mw:wLf1Z
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("v_m;SXoI&%uPQnh", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("Uzl.f1qL`6?Q!<!d");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"Uzl.f1qL`6?Q!<!d\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile("/SpuP`PC");
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("^|OexkQ  #");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ^|OexkQ  #
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("v_m;SXoI&%uPQnh");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: v_m;SXoI&%uPQnh
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
