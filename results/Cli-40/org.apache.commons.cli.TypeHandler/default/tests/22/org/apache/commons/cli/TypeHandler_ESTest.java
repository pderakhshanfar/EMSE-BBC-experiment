...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("qy'p*aGi");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("qy'p*aGi");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("(ikmnC7C[1Yi;#p 3+=", (Object) class0);
      assertEquals("(ikmnC7C[1Yi;#p 3+=", object0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("qy'p*aGi");
      assertFalse(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("=DC/.QZqODe");
      assertEquals("=DC/.QZqODe", file0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("V9GxHo", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: V9GxHo
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("#:M@~xt0!W56!T", (Object) "#:M@~xt0!W56!T");
  ...
  public void test11()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("dNSGZuHcLZd!H", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: dNSGZuHcLZd!H
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("uS;Y.:D;VP4o;c`E+");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"uS;Y.:D;VP4o;c`E+\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("b(A3tLTM");
