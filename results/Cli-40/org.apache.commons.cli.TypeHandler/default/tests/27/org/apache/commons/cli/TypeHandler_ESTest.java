...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      FileInputStream fileInputStream0 = TypeHandler.openFile("BQx");
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals("BQx", file0.getName());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".)yPX,,");
  ...
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/bT^(");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("HuBe`");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: HuBe`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("BQx", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createObject("H>V6HMW0gqc!!");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: H>V6HMW0gqc!!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("\"0hPg+t[>`", class0);
      assertEquals("\"0hPg+t[>`", string0);
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate(")\u0001Xo&L+&[i9");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("`\"DD5:H5uGu?}N");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: `\"DD5:H5uGu?}N
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("BQx");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: BQx
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
