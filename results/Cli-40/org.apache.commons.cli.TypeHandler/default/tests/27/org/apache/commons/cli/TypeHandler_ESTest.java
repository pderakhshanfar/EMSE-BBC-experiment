...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("YZ}d:E(PR(!JOz&");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("YZ}d:E(PR(!JOz&");
  ...
  public void test04()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue(":o", class0);
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".wP4Xr$`7B)p2ANKp7");
  ...
  public void test08()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("]12=OB/ZZ|WZ");
      byte[] byteArray0 = new byte[9];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("]12=OB/ZZ|WZ");
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("+Vfl:f<M'9X'", (Object) "+Vfl:f<M'9X'");
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("/\"H/0 ftHvG?", class0);
      assertNull(integer0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(".wP4Xr$`7B)p2ANKp7", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .wP4Xr$`7B)p2ANKp7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/\"H/0 ftHvG?");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("^<qKx-g");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: ^<qKx-g
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
