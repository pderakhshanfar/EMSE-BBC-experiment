...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("f*r4H9R");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "FAU<31\"C,Afn6'BCy");
      File file0 = TypeHandler.createFile("f*r4H9R");
      assertEquals(0L, file0.getUsableSpace());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".qU5!H4N");
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("d@@]yhe", (Object) "d@@]yhe");
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".qU5!H4N");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".qU5!H4N\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("yE(2jJa'IY[(gUM7Ew&");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: yE(2jJa'IY[(gUM7Ew&
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("o8bJkY8O$VwlaHqA&S");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: o8bJkY8O$VwlaHqA&S
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      Object object0 = TypeHandler.createValue("]sJ/+p9m9*", (Object) null);
      assertNull(object0);
  }
}
