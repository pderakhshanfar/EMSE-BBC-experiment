...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("qhP");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("qhP");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".`zgB8uW=");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, ".`zgB8uW=");
      File file0 = TypeHandler.createFile(".`zgB8uW=");
      assertEquals(".`zgB8uW=", file0.toString());
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.openFile("qhP");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: qhP
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
