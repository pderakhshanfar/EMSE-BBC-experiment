...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("(@C<Xzjy6>j}5 q");
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("(@C<Xzjy6>j}5 q");
  ...
  public void test03()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("(@C<Xzjy6>j}5 q");
      assertFalse(file0.isHidden());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/[~tVok#");
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Unble to find the ,lass:", (Object) "Unble to find the ,lass:");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createObject("F#>g-?");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: F#>g-?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue(".rKn~be?f2)q^OHNJjb", class0);
      assertNull(integer0);
  }
  ...
  public void test17()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("*TjM%'l@@@e12{hM6/", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: *TjM%'l@@@e12{hM6/
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("fa2\"XFC,5Z0P*Y", class0);
      assertEquals("fa2\"XFC,5Z0P*Y", string0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("]W7C',45dz-{Zg", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ]W7C',45dz-{Zg
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile(".rKn~be?f2)q^OHNJjb");
