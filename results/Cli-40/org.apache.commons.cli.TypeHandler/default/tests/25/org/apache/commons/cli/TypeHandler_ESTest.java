...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("I.cF$ {+:8");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("I.cF$ {+:8");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("[5sQ;!}C/.c");
  ...
  public void test08()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("[a}v'05");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "l2G");
      File file0 = TypeHandler.createFile("[a}v'05");
      assertEquals("[a}v'05", file0.getName());
  }
  ...
  public void test21()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("EbrC1qsR\"", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: EbrC1qsR\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL("fMyfDtwLR2H");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: fMyfDtwLR2H
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("NO_ARGS_ALLOWED");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test30()  throws Throwable  {
      try { 
        TypeHandler.openFile("I.cF$ {+:8");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: I.cF$ {+:8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
