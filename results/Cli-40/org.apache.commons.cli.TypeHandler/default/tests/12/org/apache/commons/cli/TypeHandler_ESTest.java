...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".T0t@cg!");
      String string0 = "g-J@@S\\up)L6JFgD";
      FileSystemHandling.appendLineToFile(evoSuiteFile0, string0);
      FileInputStream fileInputStream0 = TypeHandler.openFile(".T0t@cg!");
  ...
  public void test04()  throws Throwable  {
      ...
      String string0 = "g-J@@S\\up)L6JFgD";
      FileSystemHandling.appendLineToFile(evoSuiteFile0, string0);
      File file0 = TypeHandler.createFile(".T0t@cg!");
      assertFalse(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/#GcBb2o6J'pJ160EI@");
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("E4}x\"v");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: E4}x\"v
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
