...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("{%hEzUbH-");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "{%hEzUbH-");
      FileInputStream fileInputStream0 = TypeHandler.openFile("{%hEzUbH-");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".[*@R$EcUf'P%^r\"");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("B+GP 'QoW");
      byte[] byteArray0 = new byte[4];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("B+GP 'QoW");
      assertEquals("B+GP 'QoW", file0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("4i*+sY]pC= RJ1BT(1", (Object) "4i*+sY]pC= RJ1BT(1");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createObject("Vb`az<FK}i*7V):");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Vb`az<FK}i*7V):
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("VrK");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: VrK
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("}!dojzn$]C@sIDA", class0);
      assertNull(integer0);
  }
  ...
  public void test18()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("G2Pb6CLE", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: G2Pb6CLE
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("ey4DPoFWAnb3", class0);
      assertEquals("ey4DPoFWAnb3", string0);
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("QFrsY'aZYa>X_][JJ:{");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: QFrsY'aZYa>X_][JJ:{
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
