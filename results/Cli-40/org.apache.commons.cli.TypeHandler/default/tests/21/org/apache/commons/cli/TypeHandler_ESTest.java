...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, " xJ~gJmG7mWzUl(q");
  ...
  public void test04()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("*+:r>|l0yXr'DL]:uOS", (Object) class0);
      assertEquals("*+:r>|l0yXr'DL]:uOS", object0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("B+GPJ'QoWX");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile("B+GPJ'QoWX");
      assertFalse(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".}XAM(M");
      assertEquals(".}XAM(M", file0.getName());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("<.,J'VPXSg+3>~;", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: <.,J'VPXSg+3>~;
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("vpbn");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: vpbn
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("/jt|^q?9Y<1^", class0);
      assertNull(integer0);
  }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/f>lN(7mDk?It[");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("Tl>9i50");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL(".A\"TYeBsn`");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: .A\"TYeBsn`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
