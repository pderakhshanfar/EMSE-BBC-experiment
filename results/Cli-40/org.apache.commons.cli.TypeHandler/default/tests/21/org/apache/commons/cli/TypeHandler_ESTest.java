...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Number number0 = TypeHandler.createNumber("01");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/z6 ?uz");
  ...
  public void test07()  throws Throwable  {
      try { 
        TypeHandler.openFile("-vviYt.Y`)");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: -vviYt.Y`)
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Z<Y?F\"yYdzUN|z", (Object) "Z<Y?F\"yYdzUN|z");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject("y/5");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: y/5
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("Rf`92YnC", class0);
      assertEquals("Rf`92YnC", string0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("A_a&Ncc9E,cFh5.~I", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: A_a&Ncc9E,cFh5.~I
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile(".2|1]");
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("{yEw:RUV_=Wv*#4|J");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("Rf`92YnC");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: Rf`92YnC
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
