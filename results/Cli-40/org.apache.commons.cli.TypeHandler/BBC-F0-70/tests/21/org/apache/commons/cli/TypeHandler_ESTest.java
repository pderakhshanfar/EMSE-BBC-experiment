...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("`hTD");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("`hTD");
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("`hTD");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "I+9H.%5CPX.?>#UY");
      FileInputStream fileInputStream0 = TypeHandler.openFile("`hTD");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Uhozf+Ue$>^");
  ...
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/xccQM1=bv:s!1Q%");
      assertEquals("/", file0.getParent());
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("org.aache.commons.cli.PatternOptinBuilder");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("org.aache.commons.cli.PatternOptinBuilder");
      assertTrue(file0.isFile());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("dAGvsYUFIp(,|", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: dAGvsYUFIp(,|
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createClass("IB? a)V'm");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: IB? a)V'm
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("(m$mtfy", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("`hTD", class0);
      assertEquals("`hTD", string0);
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("VqjQTg_N7FOc7fH");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("`hTD");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: `hTD
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Class<Integer> class0 = Integer.class;
      Object object0 = TypeHandler.createValue("(m$mtfy", (Object) class0);
      assertNull(object0);
  }
}
