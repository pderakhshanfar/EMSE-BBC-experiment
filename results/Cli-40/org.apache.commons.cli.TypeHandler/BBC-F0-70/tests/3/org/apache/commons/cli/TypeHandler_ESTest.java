...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("org.apache.commons.cliPatternOptionBuilder");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Unable to find the class: ");
      FileInputStream fileInputStream0 = TypeHandler.openFile("org.apache.commons.cliPatternOptionBuilder");
  ...
  public void test04()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("]UZS*^2cUl{JfZq!l-", (Object) class0);
      assertEquals("]UZS*^2cUl{JfZq!l-", object0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(" ] [ lo g<");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "_");
      File file0 = TypeHandler.createFile(" ] [ lo g<");
      assertFalse(file0.isHidden());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".-qPF8T^>s.-:");
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("'c:(mEUav}qe<F!jAq", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 'c:(mEUav}qe<F!jAq
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("UR_|l)PDIA%k0Y", (Object) "UR_|l)PDIA%k0Y");
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("#5u)$):/;h*?", class0);
      assertNull(integer0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("]UZS*^2cUl{JfZq!l-", class0);
      assertEquals("]UZS*^2cUl{JfZq!l-", string0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("\"&/rF");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: \"&/rF
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
