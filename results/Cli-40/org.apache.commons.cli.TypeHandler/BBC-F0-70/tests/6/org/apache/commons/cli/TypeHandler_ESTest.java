...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("d_0n");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("d_0n");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("X6r:E)9>q0b/C2>");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile("X6r:E)9>q0b/C2>");
      assertTrue(file0.canWrite());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".|VD*NAi[LxVA");
      assertEquals(".|VD*NAi[LxVA", file0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.openFile("d_0n");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: d_0n
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("s8a[_MO", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: s8a[_MO
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("} 2n58'r[MnJ&y|H", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: } 2n58'r[MnJ&y|H
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("fRGu4", class0);
      assertEquals("fRGu4", string0);
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/+xzGA");
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.createClass("fRGu4");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: fRGu4
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
