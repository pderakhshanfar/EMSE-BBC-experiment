...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("BjVe~KUSjv%_");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "BjVe~KUSjv%_");
      FileInputStream fileInputStream0 = TypeHandler.openFile("BjVe~KUSjv%_");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(">t+/.h&*)\"");
      assertEquals(">t+", file0.getParent());
  }
  ...
  public void test08()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/?VK4]wZimFd");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "/?VK4]wZimFd");
      File file0 = TypeHandler.createFile("/?VK4]wZimFd");
  ...
  public void test13()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("rz", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: rz
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("L2|K^]5k|g!)|?N#");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: L2|K^]5k|g!)|?N#
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Number number0 = TypeHandler.createNumber("67");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("v4kp7]F^TLixqr&|");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("/?VK4]wZimFd");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: /?VK4]wZimFd
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("BjVe~KUSjv%_");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: BjVe~KUSjv%_
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("68Y=dm?Hr%F (ltX+", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 68Y=dm?Hr%F (ltX+
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
