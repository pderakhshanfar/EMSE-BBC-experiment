...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("k7/", (Object) class0);
      assertEquals("k7/", object0);
  }
  ...
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/|x)g->v-?t<lb");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Dm-4e7bW", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Dm-4e7bW
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("k7/", (Object) "k7/");
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("[|2<YeE9]^i$`", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: [|2<YeE9]^i$`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createNumber("TQs:O;Yp).z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"TQs:O;Yp).z\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("Whf4&?rnO5L7M&[T", class0);
      assertEquals("Whf4&?rnO5L7M&[T", string0);
  }
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("\"KVhX>*)G+n<c%:");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: \"KVhX>*)G+n<c%:
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
