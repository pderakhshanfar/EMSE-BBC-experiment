...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("b{_f}8V");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("b{_f}8V");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".h4 0q+7C8pV");
  ...
  public void test14()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(")_S\"\".", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: )_S\"\".
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createClass(":nDry#s]9s0");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: :nDry#s]9s0
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("'E", class0);
      assertNull(integer0);
  }
  ...
  public void test25()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("A$", class0);
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("b{_f}8V");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: b{_f}8V
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
