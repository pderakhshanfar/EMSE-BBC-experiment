...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("O+qk5|'P");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("O+qk5|'P");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("QF;L.,mUDSMs%kAI63J", (Object) class0);
      assertEquals("QF;L.,mUDSMs%kAI63J", object0);
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".sB]z");
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("2+z]Sp", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 2+z]Sp
         //
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue(".sB]z", (Object) ":H!S&xUc|xM4*%7");
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createNumber("O| 1.TAR");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"O| 1.TAR\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("@cE6whWO#s=XIp{,1Z");
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("D6A>scR:_lkB");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("O+qk5|'P");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: O+qk5|'P
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
