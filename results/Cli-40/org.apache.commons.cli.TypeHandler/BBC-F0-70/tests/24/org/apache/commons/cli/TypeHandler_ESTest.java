...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("bnRMM$(m=%ycGQ4");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("bnRMM$(m=%ycGQ4");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("uD@'1 b", (Object) class0);
      assertEquals("uD@'1 b", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("._EE?i'{<@.MLDO}%J");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "#R/&2");
      File file0 = TypeHandler.createFile("._EE?i'{<@.MLDO}%J");
      assertTrue(file0.canRead());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/[96'bXV4Qg@");
      assertEquals("/[96'bXV4Qg@", file0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("pMz^CX6~ozYa6", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: pMz^CX6~ozYa6
         //
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("_@\"Wv3bo#t%=J@", (Object) "_@\"Wv3bo#t%=J@");
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("_A", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: _A
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("!n.,O bz(h}cUXs8B");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"!n.,O bz(h}cUXs8B\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("wdM6qqaF,~");
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("K,F=</dCmuk?:kZ");
        fail("Expecting exception: UnsupportedOperationException");
