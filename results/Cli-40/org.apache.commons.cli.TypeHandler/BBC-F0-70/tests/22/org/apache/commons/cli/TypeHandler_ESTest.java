...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("jN%X3W");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("jN%X3W");
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("Wm/.C5HMF3eF!||v.");
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("!g1+}8mB$\"Q}u`ds{H6", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: !g1+}8mB$\"Q}u`ds{H6
         //
  ...
  public void test07()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("_pX", (Object) "_pX");
  ...
  public void test08()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("zABP.mn&iz1Lr", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: zABP.mn&iz1Lr
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("2vXC'^Pis2;Q.3bx");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"2vXC'^Pis2;Q.3bx\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("jN%X3W", class0);
      assertEquals("jN%X3W", string0);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile("/>|Y=*6|M%_");
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("f>Mi~ssF");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("nv}\".@{)kM|R*!7y");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("jN%X3W");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: jN%X3W
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
