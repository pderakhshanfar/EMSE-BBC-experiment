...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("LBK8Z");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("LBK8Z");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("CI?_EzU");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "5H* g_0J*|X");
      FileInputStream fileInputStream0 = TypeHandler.openFile("CI?_EzU");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Sm_x{beB", (Object) class0);
      assertEquals("Sm_x{beB", object0);
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/zFVgCpc9qCK/7`P=)]");
      assertEquals("/zFVgCpc9qCK", file0.getParent());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".7j' M(Go%@gT");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(".7j' M(Go%@gT");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("HHS");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: HHS
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("2+Z`'iJK! z)Z^IvP", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createObject("GM*{/");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: GM*{/
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("[c]rQN'", class0);
      assertEquals("[c]rQN'", string0);
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("9kZjC YSC,HnxT4");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("LBK8Z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: LBK8Z
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
