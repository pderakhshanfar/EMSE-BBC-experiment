...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("JGZlDn.rp94G_W");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("JGZlDn.rp94G_W");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("s>y'$}/.'", (Object) class0);
      assertEquals("s>y'$}/.'", object0);
  }
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/JopTUXQPhwSjX");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "_U~[wc");
      File file0 = TypeHandler.createFile("/JopTUXQPhwSjX");
      assertEquals("/", file0.getParent());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".2f9NhIqdMi");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("1SBIlkX2VE!qbI`!,");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 1SBIlkX2VE!qbI`!,
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("wM>y$G7", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: wM>y$G7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("7Lbx+q'9:_2dfft]", class0);
      assertNull(integer0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("JGZlDn.rp94G_W", class0);
      assertEquals("JGZlDn.rp94G_W", string0);
  }
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("| ?(8: t{c@ HL;8C;$");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: | ?(8: t{c@ HL;8C;$
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.openFile("JGZlDn.rp94G_W");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: JGZlDn.rp94G_W
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
