...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("@'t+F&x=]&lS`n6");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("@'t+F&x=]&lS`n6");
  ...
  public void test02()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "n\u0003+~#EjWm");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".#n~'.,v1Z:q*LES");
  ...
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/k\"!vdbn}yY]+");
      assertTrue(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("k+|+,0!]m`C<c,");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("k+|+,0!]m`C<c,");
  ...
  public void test14()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("._;0rAF)/XI'hdIl", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ._;0rAF)/XI'hdIl
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createClass("([lxB`p");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ([lxB`p
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".#n~'.,v1Z:q*LES");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".#n~'.,v1Z:q*LES\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("has already been selected: '", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: has already been selected: '
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("@'t+F&x=]&lS`n6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: @'t+F&x=]&lS`n6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
