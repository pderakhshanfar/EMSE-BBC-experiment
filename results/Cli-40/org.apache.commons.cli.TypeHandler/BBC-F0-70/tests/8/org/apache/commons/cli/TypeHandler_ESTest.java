...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("_1>ZJigELH%e>7|W2,}");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("_1>ZJigELH%e>7|W2,}");
  ...
  public void test04()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("uXV!Wusk~P2}", class0);
      assertEquals("uXV!Wusk~P2}", string0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".OYq4CxC9|7rA-4");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Q\"tk*P>");
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createNumber("Cannot add value, list full.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"Cannot add value, list full.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("_1>ZJigELH%e>7|W2,}");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: _1>ZJigELH%e>7|W2,}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
