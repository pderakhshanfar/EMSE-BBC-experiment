...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("SQ.-~?3g");
      byte[] byteArray0 = new byte[7];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("SQ.-~?3g");
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("u/uu ", (Object) class0);
      assertEquals("u/uu ", object0);
  }
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".?y8@5^nd2%e;um[");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/#g^s]&/tDaM+n1fQ;");
      assertEquals(0L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("k/PgheUZE");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Unable to find file: ");
      File file0 = TypeHandler.createFile("k/PgheUZE");
      assertEquals("k", file0.getParent());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("5;gVnAv>D*!'", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 5;gVnAv>D*!'
         //
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("LJd_FcQY,");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("X,?|");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: X,?|
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("Cannot add value, list fu-l.");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("SQ.-~?3g");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: SQ.-~?3g
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
