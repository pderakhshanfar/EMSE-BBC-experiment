...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, " Rr1Sg9%KTc-.");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("A ConeNotS'portedxeption wa thown: ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "A ConeNotS'portedxeption wa thown: ");
      File file0 = TypeHandler.createFile("A ConeNotS'portedxeption wa thown: ");
      assertEquals("A ConeNotS'portedxeption wa thown: ", file0.toString());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile(".e`}T`Wo8 *");
      assertEquals(0L, file0.length());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/z6xm,pfZ$wS");
      assertEquals("z6xm,pfZ$wS", file0.getName());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("v|>&PQ#{eU.G?LO?", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: v|>&PQ#{eU.G?LO?
         //
  ...
  public void test15()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("1$SAN$h", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 1$SAN$h
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue("A ConeNotS'portedxeption wa thown: ", class0);
      assertNull(integer0);
  }
  ...
  public void test25()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("A ConeNotS'portedxeption wa thown: ", class0);
      assertEquals("A ConeNotS'portedxeption wa thown: ", string0);
  }
