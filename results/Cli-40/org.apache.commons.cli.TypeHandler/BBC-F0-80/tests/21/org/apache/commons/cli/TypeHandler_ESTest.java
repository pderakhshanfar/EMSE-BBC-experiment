...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".T[)mBtM");
  ...
  public void test08()  throws Throwable  {
      File file0 = TypeHandler.createFile("/aA,J()1>TI");
      assertFalse(file0.isHidden());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("qvWWFD{t*CAKtUV$", object0);
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createObject("UvzhbJF;~i.*8c`V");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: UvzhbJF;~i.*8c`V
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
