...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("RR@l N7W", class0);
      assertEquals("RR@l N7W", string0);
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/uY$\"oAY5UH7y");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("P5$N__+8[WBHTLg L");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("P5$N__+8[WBHTLg L");
      assertEquals("P5$N__+8[WBHTLg L", file0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("WS%q-ttG]TB?.", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: WS%q-ttG]TB?.
         //
  ...
  public void test18()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Fz{", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Fz{
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("G$k.V.|7w^/&");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"G$k.V.|7w^/&\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("._\"|c^:rY0");
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("/uY$\"oAY5UH7y");
        fail("Expecting exception: UnsupportedOperationException");
