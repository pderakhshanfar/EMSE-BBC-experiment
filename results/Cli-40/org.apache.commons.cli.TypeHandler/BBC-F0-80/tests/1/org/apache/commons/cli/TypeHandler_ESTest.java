...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("c';P`=P51i@");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("c';P`=P51i@");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("4>1@82}pLyT?RQv'bM");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "=94ZtOB*k;f27");
      FileInputStream fileInputStream0 = TypeHandler.openFile("4>1@82}pLyT?RQv'bM");
  ...
  public void test04()  throws Throwable  {
      ...
      File file0 = TypeHandler.createFile("4>1@82}pLyT?RQv'bM");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("orgapache.commons.cli.TypeHandler", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: orgapache.commons.cli.TypeHandler
         //
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("lDr.z", (Object) "lDr.z");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("?*f^L");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ?*f^L
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("c';P`=P51i@");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: c';P`=P51i@
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
