...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("cL");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "^Mj");
      FileInputStream fileInputStream0 = TypeHandler.openFile("cL");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/j_gGuYbBnJ#=9^t8R9");
  ...
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("cL");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "^Mj");
      File file0 = TypeHandler.createFile("cL");
      assertEquals(0L, file0.getUsableSpace());
  }
  ...
  public void test11()  throws Throwable  {
      File file0 = TypeHandler.createFile("oLOBJ");
      // Undeclared exception!
      try { 
        TypeHandler.createValue("oLOBJ", (Object) file0);
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createClass("!h204/OB2$\"}rkhi1Hy");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: !h204/OB2$\"}rkhi1Hy
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("BpI>YRcnC&:.3L");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"BpI>YRcnC&:.3L\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue(".Ry1KsK4qA[g4", class0);
      assertEquals(".Ry1KsK4qA[g4", string0);
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Ry1KsK4qA[g4");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("Knc#?z4C");
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.openFile("cL");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: cL
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
