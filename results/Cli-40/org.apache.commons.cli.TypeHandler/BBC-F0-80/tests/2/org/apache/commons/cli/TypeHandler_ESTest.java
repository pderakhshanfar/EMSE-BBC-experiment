...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("V`6N)*HN~");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile("V`6N)*HN~");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("]61Q", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ]61Q
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("YSKXdyqq JBsP{xNX_4");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: YSKXdyqq JBsP{xNX_4
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      String string0 = TypeHandler.createValue("R~><76c kNj:-gm,}:", class0);
      assertEquals("R~><76c kNj:-gm,}:", string0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("ai[f370", (Object) class0);
      assertEquals("ai[f370", object0);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/QmnG`O=nYlZvru");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("F $n{g,kc1@STR_M");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("?VV(zybh1A]");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ?VV(zybh1A]
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
