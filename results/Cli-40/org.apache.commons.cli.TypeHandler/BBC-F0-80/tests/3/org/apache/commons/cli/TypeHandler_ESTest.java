...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("~XuEH~rgl+69yw%#=");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("~XuEH~rgl+69yw%#=");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".|{QBeUUx@");
      assertEquals(".|{QBeUUx@", file0.getName());
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/,RO2AWB'-I");
      byte[] byteArray0 = new byte[9];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/,RO2AWB'-I");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("<d+xTRnWfVF>9/-", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: <d+xTRnWfVF>9/-
         //
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("G", (Object) "G");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("Z!2^");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Z!2^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue(".up-~x2l05;m", class0);
      assertNull(integer0);
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("/9N:U]lpMSTJi.d[");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"/9N:U]lpMSTJi.d[\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
