...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("`GP ''T-oX;zXG29_");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("`GP ''T-oX;zXG29_");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".W-8ZWN~4ZUj]t5EqG$");
      assertEquals(0L, file0.getTotalSpace());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/~4pV V+S@(Y6vpI/q");
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue(";", (Object) "Xf1SxUg");
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("`GP ''T-oX;zXG29_", class0);
      assertEquals("`GP ''T-oX;zXG29_", string0);
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("nqZSd={uG>i8m");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: nqZSd={uG>i8m
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("`GP ''T-oX;zXG29_");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: `GP ''T-oX;zXG29_
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
