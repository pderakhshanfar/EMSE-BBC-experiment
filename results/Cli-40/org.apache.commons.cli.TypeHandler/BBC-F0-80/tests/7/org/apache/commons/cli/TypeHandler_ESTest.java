...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("3x");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("3x");
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("3x");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Vp");
      FileInputStream fileInputStream0 = TypeHandler.openFile("3x");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("#1%s*ROC*hwM%~6]./", (Object) class0);
      assertEquals("#1%s*ROC*hwM%~6]./", object0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "!Nw!K{xyP");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".pt8%");
      assertTrue(file0.isHidden());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/HX\"F]1+fe&EVA{}");
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".OZ|k:{oY$oxYlR");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".OZ|k:{oY$oxYlR\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("#1%s*ROC*hwM%~6]./", class0);
      assertEquals("#1%s*ROC*hwM%~6]./", string0);
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL(";wBF,2H;W#-J9^\u0001");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ;wBF,2H;W#-J9^\u0001
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test32()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("'ReomYwNO b2acmR", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 'ReomYwNO b2acmR
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
