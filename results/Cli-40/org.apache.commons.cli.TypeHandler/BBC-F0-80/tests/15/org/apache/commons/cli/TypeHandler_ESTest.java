...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("-VQ#o1b7gE");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("-VQ#o1b7gE");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("f>IK,:CX1", (Object) class0);
      assertEquals("f>IK,:CX1", object0);
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".yhV!");
      assertEquals(0L, file0.getTotalSpace());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/F T]4 (S'4");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("J T,(b3Q", (Object) "J T,(b3Q");
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("f>IK,:CX1", class0);
      assertEquals("f>IK,:CX1", string0);
  }
  ...
  public void test23()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("f0ex=SZaG", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: f0ex=SZaG
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("?K{+MKIr[}=I\"VcvX");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("&@RDKy]$}{>)'xN\"");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: &@RDKy]$}{>)'xN\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.openFile("-VQ#o1b7gE");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: -VQ#o1b7gE
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Object object0 = TypeHandler.createValue("f0ex=SZaG", (Object) null);
      assertNull(object0);
  }
}
