...
public class XmlSerializerProvider_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.annotation.JsonInclude", false, XmlSerializerProvider_ESTest_scaffolding.class.getClassLoader()));
