...
public class MultiKey_ESTest extends MultiKey_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      MultiKey<String> multiKey0 = new MultiKey<String>("$M", "$M", "8gZ-18^\"[;47");
      // Undeclared exception!
      try { 
        multiKey0.getKey(1420);
  ...
  public void test09()  throws Throwable  {
      MultiKey<String> multiKey0 = new MultiKey<String>("X}pBWb5dV=A>Y%P=", "MultiKey", "X}pBWb5dV=A>Y%P=", "l6N2K$b`3[j]xBCS", "The array of keys must not be null");
      MultiKey<Object> multiKey1 = new MultiKey<Object>(multiKey0, "X}pBWb5dV=A>Y%P=");
