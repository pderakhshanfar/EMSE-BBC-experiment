...
public class MultiKey_ESTest extends MultiKey_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      MultiKey<Object> multiKey0 = new MultiKey<Object>(integer0, integer1, integer2, integer0, (Object) null);
      multiKey0.toString();
      multiKey0.toString();
      multiKey0.toString();
      multiKey0.getKeys();
      MultiKey<String> multiKey1 = new MultiKey<String>("MultiKey[0, 2, 2, 0, null]", (String) null, "_$,Agq-,i>gr>dz");
      multiKey1.toString();
      multiKey1.size();
      multiKey1.toString();
  ...
  public void test04()  throws Throwable  {
      ...
      MultiKey<String> multiKey1 = new MultiKey<String>("", "!.w?]Rjcr(\"cv$", "");
      int int1 = 1512;
      // Undeclared exception!
      try { 
        multiKey1.getKey(1512);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test06()  throws Throwable  {
      MultiKey<String> multiKey0 = new MultiKey<String>("ij)&Vv|", (String) null, "ij)&Vv|", "");
      multiKey0.toString();
      multiKey0.toString();
      ...
      multiKey1.hashCode();
      multiKey1.toString();
      MultiKey<Object> multiKey2 = new MultiKey<Object>(multiKey0, "MultiKey[ij)&Vv|, null, ij)&Vv|, ]", integer3);
      multiKey2.toString();
      multiKey2.getKeys();
      // Undeclared exception!
      try { 
        multiKey2.getKey(2200);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test09()  throws Throwable  {
      ...
      multiKey3.toString();
      multiKey3.getKeys();
      multiKey3.equals("The array of keys must not be null");
      multiKey1.size();
      // Undeclared exception!
      try { 
        multiKey1.getKey(5);
  ...
  public void test10()  throws Throwable  {
      MultiKey<String> multiKey0 = new MultiKey<String>("", "J", "", "i#I\"SxNEd");
      multiKey0.toString();
      multiKey0.toString();
      multiKey0.toString();
      multiKey0.toString();
      multiKey0.getKey(0);
      MultiKey<Object> multiKey1 = new MultiKey<Object>("MultiKey", "MultiKey[, J, , i#I\"SxNEd]");
      // Undeclared exception!
      try { 
        multiKey1.getKey((-1260));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test11()  throws Throwable  {
      ...
      stringArray0[0] = "";
      stringArray0[1] = "$#";
      stringArray0[2] = "0lKFg<fWn,Bc+~5V^";
      String string0 = "YZf(,FF=N6%^;";
      stringArray0[3] = "YZf(,FF=N6%^;";
      MultiKey<String> multiKey0 = new MultiKey<String>(stringArray0, false);
      multiKey0.getKey(2);
      objectArray0[0] = (Object) "0lKFg<fWn,Bc+~5V^";
      Object object0 = new Object();
      objectArray0[1] = object0;
      Object object1 = null;
      MultiKey<Object> multiKey1 = new MultiKey<Object>((Object) null, (Object) null, "YZf(,FF=N6%^;");
      MultiKey<Object> multiKey2 = new MultiKey<Object>(multiKey1, "0lKFg<fWn,Bc+~5V^");
      // Undeclared exception!
      try { 
        multiKey2.getKey(2);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
