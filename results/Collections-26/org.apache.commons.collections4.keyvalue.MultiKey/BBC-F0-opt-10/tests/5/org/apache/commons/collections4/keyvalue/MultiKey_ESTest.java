...
public class MultiKey_ESTest extends MultiKey_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      MultiKey<String> multiKey0 = new MultiKey<String>("=%", "", "=%", "RF");
  ...
  public void test07()  throws Throwable  {
      MultiKey<String> multiKey0 = new MultiKey<String>("", "o`>cq", "", "");
      Integer integer0 = new Integer(0);
      MultiKey<Integer> multiKey1 = new MultiKey<Integer>(integer0, integer0, integer0);
      MultiKey<MultiKey<Integer>> multiKey2 = new MultiKey<MultiKey<Integer>>(multiKey1, (MultiKey<Integer>) null, (MultiKey<Integer>) null, (MultiKey<Integer>) null);
