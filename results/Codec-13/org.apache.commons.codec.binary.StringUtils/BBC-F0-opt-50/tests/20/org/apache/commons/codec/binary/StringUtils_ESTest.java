...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("K#c+:HI#Yp dsIcZj/P");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("K#c+:HI#Yp dsIcZj/P", string0);
  }
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("wn)a+4auUkvq/qb~v");
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "\uFEFFISO-8859-1");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // \uFEFFISO-8859-1: java.io.UnsupportedEncodingException: \uFEFFISO-8859-1
         //
  ...
  public void test23()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, ",LG_J(+l!c>|z=c4\"");
      assertNull(string0);
  }
  ...
  public void test27()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("?R*;J$n.");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("\u0000?\u0000R\u0000*\u0000;\u0000J\u0000$\u0000n\u0000.", string0);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("?R*;J$n.");
      assertArrayEquals(new byte[] {(byte)63, (byte)82, (byte)42, (byte)59, (byte)74, (byte)36, (byte)110, (byte)46}, byteArray0);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("Ift<v");
  ...
  public void test37()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("0cACL=|-UVWnO", "Gs}GW#fc<r");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Gs}GW#fc<r: java.io.UnsupportedEncodingException: Gs}GW#fc<r
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
