...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("~E7P0z&y+7kb8h/", "\uFFFD\u0001GB\u0001\u0000\u0000");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // \uFFFD\u0001GB\u0001\u0000\u0000: java.io.UnsupportedEncodingException: \uFFFD\u0001GB\u0001\u0000\u0000
         //
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("bJh7|!-o^");
      String string0 = StringUtils.newString(byteArray0, "UTF-16");
      assertEquals("bJh7|!-o^", string0);
  }
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("Q$VUyz%lA;<ps");
  ...
  public void test36()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("Z^uQ}Cqt(Bu");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "JT!~{X,c&R _`X");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // JT!~{X,c&R _`X: java.io.UnsupportedEncodingException: JT!~{X,c&R _`X
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("OYMEo");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u4F00\u5900\u4D00\u4500\u6F00", string0);
  }
}
