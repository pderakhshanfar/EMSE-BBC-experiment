...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("=!v92$2rl4/UWZU3");
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("Bb|NYfrY-0wHxl$+&F/", "ISO-8859-1");
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("S<C( ;_g#d+{", "]6c2Je/X]n]%S\"y");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // ]6c2Je/X]n]%S\"y: java.io.UnsupportedEncodingException: ]6c2Je/X]n]%S\"y
         //
