...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("Vhm-d6~7nuw`>");
  ...
  public void test11()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("F", "UTF-8");
  ...
  public void test21()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "]hh~E%4>\"]VhHD");
      assertNull(string0);
  }
  ...
  public void test38()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("|XUNAUnwnndo)'LY5S*", "7;V3t<#T:-RVbu((zy");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 7;V3t<#T:-RVbu((zy: java.io.UnsupportedEncodingException: 7;V3t<#T:-RVbu((zy
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
