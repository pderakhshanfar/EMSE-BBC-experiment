...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("o7QI)5*^");
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("H;9Db(i46");
      assertEquals(9, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("<g\"WNQ=Q|P.J", "UTF-16LE");
  ...
  public void test30()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("gy)nUSak~1");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("gy)nUSak~1", string0);
  }
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "2^2/C@50q$@");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 2^2/C@50q$@: java.io.UnsupportedEncodingException: 2^2/C@50q$@
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
