...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("beQnA");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("beQnA", string0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("0~ufAf");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("0~ufAf", string0);
  }
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("UpXaLFpaHq$");
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("=o;b8.");
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("#~qMige].9f");
  ...
  public void test23()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("nnG`PPua9e>+Ak)CM!:");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "nnG`PPua9e>+Ak)CM!:");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // nnG`PPua9e>+Ak)CM!:: java.io.UnsupportedEncodingException: nnG`PPua9e>+Ak)CM!:
         //
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("8i\"%a)lPgJUWBsD&", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("beQnA", "beQnA");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // beQnA: java.io.UnsupportedEncodingException: beQnA
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("0~ufAf");
