...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("c *NIoH");
      String string0 = StringUtils.newString(byteArray0, "UTF-16BE");
      assertEquals("c *NIoH", string0);
  }
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("wW/g");
      assertArrayEquals(new byte[] {(byte)119, (byte)87, (byte)47, (byte)103}, byteArray0);
  }
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "G~RNjO5s(@tS~<,OCh>");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // G~RNjO5s(@tS~<,OCh>: java.io.UnsupportedEncodingException: G~RNjO5s(@tS~<,OCh>
         //
  ...
  public void test24()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "](Zz6Q");
      assertNull(string0);
  }
  ...
  public void test28()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("($[=2:8et");
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("(]_=k0s$]FO?K5$|");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("(]_=k0s$]FO?K5$|", string0);
  }
  ...
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("az1O?))2");
  ...
  public void test37()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("(]_=k0s$]FO?K5$|");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("\u0000(\u0000]\u0000_\u0000=\u0000k\u00000\u0000s\u0000$\u0000]\u0000\u0000F\u0000O\u0000?\u0000\u0000K\u00005\u0000$\u0000|", string0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("n]Qf-V,[y+");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "n]Qf-V,[y+");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // n]Qf-V,[y+: java.io.UnsupportedEncodingException: n]Qf-V,[y+
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
