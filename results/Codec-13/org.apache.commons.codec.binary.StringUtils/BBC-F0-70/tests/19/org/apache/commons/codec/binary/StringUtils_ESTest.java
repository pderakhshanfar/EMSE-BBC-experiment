...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("r H2^^");
      String string0 = StringUtils.newString(byteArray0, "UTF-16");
      assertEquals("\u7220\u4832\u5E5E", string0);
  }
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be(",2yo)Z");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("\u0000*u6\u0000V", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "vu+78iJS^^ZxPJsWj");
      assertNull(string0);
  }
  ...
  public void test36()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("?8`W+n1hyTpK(12>#");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u383F\u5760\u6E2B\u6831\u5479\u4B70\u3128\u3E32\uFFFD", string0);
  }
  ...
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("z?tA*']", "UTF-16BE");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("\u0000z\u0000?\u0000t\u0000A\u0000*\u0000'\u0000]", string0);
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "6_/L5P;L9(A|i^(mK");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 6_/L5P;L9(A|i^(mK: java.io.UnsupportedEncodingException: 6_/L5P;L9(A|i^(mK
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
