...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("\"9Ux\"H");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("\"9Ux\"H", string0);
  }
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked(":f8", "UTF-8");
  ...
  public void test22()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("*wZ9HIuu");
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("wj-h>of");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "\u0000w\u0000j\u0000-\u0000h\u0000>\u0000o\u0000f");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // \u0000w\u0000j\u0000-\u0000h\u0000>\u0000o\u0000f: java.io.UnsupportedEncodingException: \u0000w\u0000j\u0000-\u0000h\u0000>\u0000o\u0000f
         //
  ...
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("WF~");
      String string0 = StringUtils.newStringUtf16(byteArray0);
  ...
  public void test32()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1(":s.`LIF>p,SH>1Wt~m");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u3A73\u2E60\u4C49\u463E\u702C\u5348\u3E31\u5774\u7E6D", string0);
  }
  ...
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("2xQgL}");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("2xQgL}", string0);
  }
  ...
  public void test36()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked(",}G5\",!rP`l+?", "%ly>!]*l!+;<-XbRF_");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // %ly>!]*l!+;<-XbRF_: java.io.UnsupportedEncodingException: %ly>!]*l!+;<-XbRF_
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
