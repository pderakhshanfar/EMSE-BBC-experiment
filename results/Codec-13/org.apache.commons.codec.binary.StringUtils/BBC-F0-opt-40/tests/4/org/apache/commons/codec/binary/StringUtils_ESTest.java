...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("KvaB");
      assertArrayEquals(new byte[] {(byte)75, (byte)0, (byte)118, (byte)0, (byte)97, (byte)0, (byte)66, (byte)0}, byteArray0);
  }
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("~)jEpxX34WUuvW1G{");
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("KvaB");
  ...
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("a f,s*+5uS(iFr&\"t");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "$9[{6t");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // $9[{6t: java.io.UnsupportedEncodingException: $9[{6t
         //
  ...
  public void test41()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("US-ASCII", "%!'>*SP#f6Z kG");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // %!'>*SP#f6Z kG: java.io.UnsupportedEncodingException: %!'>*SP#f6Z kG
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
