...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("||1eT3:Dy3XCOLT{J");
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("\u0000\u9BE3\u1FB5", "UTF-16BE");
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("v/HRFpr', B,.\u0001}M", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("\u4300\uFFFF\u0299\uFFFD");
      assertEquals(4, byteArray0.length);
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "pzfc]++@$3");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // pzfc]++@$3: java.io.UnsupportedEncodingException: pzfc]++@$3
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
