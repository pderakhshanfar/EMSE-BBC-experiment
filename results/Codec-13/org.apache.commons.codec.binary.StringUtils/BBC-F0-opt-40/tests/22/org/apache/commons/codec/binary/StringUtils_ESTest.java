...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("", "1t]#M");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 1t]#M: java.io.UnsupportedEncodingException: 1t]#M
         //
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("]Q\"f{ -{+FeH^");
  ...
  public void test11()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("P:okd)=jk|Ix%");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "'N7C^c{>BES'");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 'N7C^c{>BES': java.io.UnsupportedEncodingException: 'N7C^c{>BES'
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("*iqUPyS[Sa]2W", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("7/g6\"lb(2iB+e");
