...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("`XdduxT$4z0");
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("08.");
      assertArrayEquals(new byte[] {(byte)48, (byte)56, (byte)46}, byteArray0);
  }
  ...
  public void test26()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "GczCau[U77kTn4");
      assertNull(byteArray0);
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("]@&DWS8^q|Za~.{Y1m~", "US-ASCII");
  ...
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("z@D2Y6-{C");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "O]'P>zAfwyvjs|N[");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // O]'P>zAfwyvjs|N[: java.io.UnsupportedEncodingException: O]'P>zAfwyvjs|N[
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
