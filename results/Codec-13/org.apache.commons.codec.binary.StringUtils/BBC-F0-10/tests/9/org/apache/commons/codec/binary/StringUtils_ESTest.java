...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("\uFEFFqXIa0?^+F^P,QaaQ;", "qXIa0?^+F^P,QaaQ;");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // qXIa0?^+F^P,QaaQ;: java.io.UnsupportedEncodingException: qXIa0?^+F^P,QaaQ;
         //
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("6\u00F6");
  ...
  public void test36()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("CyN:t=\">l)'@F)M!");
