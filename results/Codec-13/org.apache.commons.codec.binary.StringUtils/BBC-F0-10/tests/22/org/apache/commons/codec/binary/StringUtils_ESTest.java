...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("", "Dp)r5Sue)NV4F4H");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Dp)r5Sue)NV4F4H: java.io.UnsupportedEncodingException: Dp)r5Sue)NV4F4H
         //
  ...
  public void test06()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("IaQ`l><N.Zmbi+Q,");
      String string0 = StringUtils.newString(byteArray0, "UTF-16BE");
      assertEquals("\u4900\u6100\u5100\u6000\u6C00\u3E00\u3C00\u4E00\u2E00\u5A00\u6D00\u6200\u6900\u2B00\u5100\u2C00", string0);
  }
  ...
  public void test13()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("5+2gVJ=4<");
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("k!h{rk{4|4Au&");
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("gb1#R$2(o1Z\"UL6");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("+[H\"o", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("JZZg(O9fC-");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("J\u0000Z\u0000Z\u0000g\u0000(\u0000O\u00009\u0000f\u0000C\u0000-\u0000", string0);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "7}e");
      assertNull(byteArray0);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("Fk", "ISO-8859-1");
  ...
  public void test36()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("4/@\"gRr5");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u3400\u2F00\u4000\u2200\u6700\u5200\u7200\u3500", string0);
  }
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "\"aG^A;3");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // \"aG^A;3: java.io.UnsupportedEncodingException: \"aG^A;3
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
