...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8(":8FK[8");
      assertArrayEquals(new byte[] {(byte)58, (byte)56, (byte)70, (byte)75, (byte)91, (byte)56}, byteArray0);
  }
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16(":8FK[8");
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("XbJ+.1Hato", "US-ASCII");
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("fl)eaP");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u666C\u2965\u6150", string0);
  }
  ...
  public void test39()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("\u666C\u2965\u6150", "fl)eaP");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // fl)eaP: java.io.UnsupportedEncodingException: fl)eaP
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
