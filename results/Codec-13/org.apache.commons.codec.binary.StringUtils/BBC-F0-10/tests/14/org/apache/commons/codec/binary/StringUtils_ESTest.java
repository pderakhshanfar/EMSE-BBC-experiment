...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("\"_@'o)z]Im5uF-");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\"_@'o)z]Im5uF-", string0);
  }
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("\"_@'o)z]Im5uF-");
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "}NZK1gz,=(hJ1");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // }NZK1gz,=(hJ1: java.io.UnsupportedEncodingException: }NZK1gz,=(hJ1
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
