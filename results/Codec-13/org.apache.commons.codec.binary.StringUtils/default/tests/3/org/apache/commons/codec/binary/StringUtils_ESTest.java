...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("ek\"Q_h0:t2&X(eu]", "g`-S$J,o~aS");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // g`-S$J,o~aS: java.io.UnsupportedEncodingException: g`-S$J,o~aS
         //
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("KwHZ38v,1'");
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("9uiRJ@PrJ?*[xE>");
      assertEquals(15, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("e@", "UTF-16LE");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("q%`Z/0seGyS&A]ip8#", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("-|3*{%.w,agV\"f");
