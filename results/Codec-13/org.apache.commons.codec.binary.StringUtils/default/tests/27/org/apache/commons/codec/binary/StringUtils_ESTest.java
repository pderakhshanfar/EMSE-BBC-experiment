...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("C'G8,K@!1Hz");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u2743\u3847\u4B2C\u2140\u4831\uFFFD", string0);
  }
  ...
  public void test04()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("6$9$S%4F7.uJK;14");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("6$9$S%4F7.uJK;14", string0);
  }
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("}q", "ISO-8859-1");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "4Wv@D<u]g'7");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 4Wv@D<u]g'7: java.io.UnsupportedEncodingException: 4Wv@D<u]g'7
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("f~H.{T^y", (String) null);
  ...
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("dGa16Fix:^U");
