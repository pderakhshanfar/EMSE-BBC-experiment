...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("{WPx-tCC1N;");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u7B00\u5700\u5000\u7800\u2D00\u7400\u4300\u4300\u3100\u4E00\u3B00", string0);
  }
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("G", "UTF-16BE");
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("kb_WPI+");
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("5J;2K}Y7", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test22()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "'J|etA_$");
      assertNull(string0);
  }
  ...
  public void test27()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("{WPx-tCC1N;");
      String string0 = StringUtils.newString(byteArray0, "UTF-16BE");
      assertEquals("\uFEFF{WPx-tCC1N;", string0);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("'J|etA_$");
      assertEquals(8, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("ly<\"K4a:bDY(-\"p^D52");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("ly<\"K4a:bDY(-\"p^D52", string0);
  }
  ...
  public void test37()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("xgy;rAt@veq}xQ", "\u0000\uFFFD");
        fail("Expecting exception: IllegalStateException");
