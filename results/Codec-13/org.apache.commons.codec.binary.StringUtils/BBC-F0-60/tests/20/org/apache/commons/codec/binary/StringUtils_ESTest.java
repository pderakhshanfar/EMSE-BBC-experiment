...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("R\"k;");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\uFFFD\u5200\u2200\u6B00\u3B00", string0);
  }
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("w<v");
  ...
  public void test13()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("do|@!'a#z|@%B! ;");
  ...
  public void test22()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("`vM:y]0");
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("oty1,Q i1({=Ue8");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, " _1(Oc");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         //  _1(Oc: java.io.UnsupportedEncodingException:  _1(Oc
         //
  ...
  public void test38()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "t9;q|7IMAT");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // t9;q|7IMAT: java.io.UnsupportedEncodingException: t9;q|7IMAT
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
