...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("SgZETpGT>zvv");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u5300\u6700\u5A00\u4500\u5400\u7000\u4700\u5400\u3E00\u7A00\u7600\u7600", string0);
  }
  ...
  public void test02()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1(">C.8Rs5");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u3E43\u2E38\u5273\uFFFD", string0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals("SgZETpGT>zvv", string0);
  }
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("SgZETpGT>zvv");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("\u0000\u0000\u0001\uFFFD\uFFFDw\u0000U", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "p|2g-!^q{&LB4Hi");
      assertNull(string0);
  }
  ...
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("SgZETpGT>zvv");
      assertEquals(26, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("@?wN@/|C");
  ...
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le(".p5+U");
      assertArrayEquals(new byte[] {(byte)46, (byte)0, (byte)112, (byte)0, (byte)53, (byte)0, (byte)43, (byte)0, (byte)85, (byte)0}, byteArray0);
  }
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, ">G\"{qr/FTD!Gs{");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // >G\"{qr/FTD!Gs{: java.io.UnsupportedEncodingException: >G\"{qr/FTD!Gs{
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
