...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("tq7fn3G_1kFQ$", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("GE");
      assertArrayEquals(new byte[] {(byte)71, (byte)69}, byteArray0);
  }
  ...
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("oNK5\"!g=w-");
      assertEquals(20, byteArray0.length);
  }
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "mlnu/ k>RCL]h=o~");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // mlnu/ k>RCL]h=o~: java.io.UnsupportedEncodingException: mlnu/ k>RCL]h=o~
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
