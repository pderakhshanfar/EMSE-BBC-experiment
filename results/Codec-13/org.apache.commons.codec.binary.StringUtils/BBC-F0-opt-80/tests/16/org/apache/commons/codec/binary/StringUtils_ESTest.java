...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("L*tGi");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("L*tGi", string0);
  }
  ...
  public void test04()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("E^xsdmo1B7kj-sZ(");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("\uFFFD\uFFFD\u0000E\u0000^\u0000x\u0000s\u0000d\u0000m\u0000o\u00001\u0000B\u00007\u0000k\u0000j\u0000-\u0000s\u0000Z\u0000(", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals("\uFFFD\u4500\u5E00\u7800\u7300\u6400\u6D00\u6F00\u3100\u4200\u3700\u6B00\u6A00\u2D00\u7300\u5A00\u2800", string0);
  }
  ...
  public void test08()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("G(p4/JRd'X<+;/SvS");
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("G(p4/JRd'X<+;/SvS", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("N=O25NZK", "3?Zy*SCLtjw<0");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 3?Zy*SCLtjw<0: java.io.UnsupportedEncodingException: 3?Zy*SCLtjw<0
         //
  ...
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("E^xsdmo1B7kj-sZ(");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("E^xsdmo1B7kj-sZ(", string0);
  }
  ...
  public void test34()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("L*tGi");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u2A4C\u4774\uFFFD", string0);
  }

  @Test(timeout = 4000)
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("jX)H}");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("j\u0000X\u0000)\u0000H\u0000}\u0000", string0);
  }
  ...
  public void test38()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)91, (byte)0, (byte)121}, byteArray0);
  }
}
