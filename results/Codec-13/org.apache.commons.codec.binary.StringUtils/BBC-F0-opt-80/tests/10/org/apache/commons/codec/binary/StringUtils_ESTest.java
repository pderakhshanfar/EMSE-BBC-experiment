...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("lU1/MKenS\"vN('6-v");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("lU1/MKenS\"vN('6-v", string0);
  }
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("SGP");
      assertArrayEquals(new byte[] {(byte)83, (byte)71, (byte)80}, byteArray0);
  }
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("lU1/MKenS\"vN('6-v");
      assertEquals(36, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("r^EzWrNx:ox:gB3s");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("\u0000r\u0000^\u0000E\u0000z\u0000W\u0000r\u0000N\u0000x\u0000:\u0000\u0000o\u0000x\u0000:\u0000g\u0000B\u00003\u0000s", string0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals("\uFFFD\uFFFD\u0000l\u0000U\u00001\u0000/\u0000M\u0000K\u0000e\u0000n\u0000S\u0000\"\u0000v\u0000N\u0000\u0000(\u0000'\u00006\u0000-\u0000v", string0);
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("n`$3}Fg`", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("kbwN`JPBsU=0");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("kbwN`JPBsU=0", string0);
  }
  ...
  public void test37()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("(>&+<ge<0Jb.O1H");
  ...
  public void test40()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "(ht");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // (ht: java.io.UnsupportedEncodingException: (ht
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
