...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("j.U]'FP+dk");
  ...
  public void test36()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("p:emMf,^92");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\uFFFD\u7000\u3A00\u6500\u6D00\u7F00\u4D00\u6600\u2C00\u5E00\u3900\u3200", string0);
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "sC8}Yjr^EO;v");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // sC8}Yjr^EO;v: java.io.UnsupportedEncodingException: sC8}Yjr^EO;v
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
