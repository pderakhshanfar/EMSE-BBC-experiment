...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("UTF-16BE", "$'5*h");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // $'5*h: java.io.UnsupportedEncodingException: $'5*h
         //
  ...
  public void test28()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("5cH-wn-GeMr");
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "'akb#{gG:$ZHyH=\"TA~");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 'akb#{gG:$ZHyH=\"TA~: java.io.UnsupportedEncodingException: 'akb#{gG:$ZHyH=\"TA~
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
