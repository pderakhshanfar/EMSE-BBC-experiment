...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("", "TR)tY");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // TR)tY: java.io.UnsupportedEncodingException: TR)tY
         //
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("b; +j7");
      String string0 = StringUtils.newString(byteArray0, "ISO-8859-1");
      assertEquals("b\u0000;\u0000 \u0000+\u0000j\u00007\u0000", string0);
  }
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("Uyg:");
      assertArrayEquals(new byte[] {(byte) (-2), (byte) (-1), (byte)0, (byte)85, (byte)0, (byte)121, (byte)0, (byte)103, (byte)0, (byte)58}, byteArray0);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("<EsIL_nT`aOQ");
  ...
  public void test30()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "=Ifq");
      assertNull(byteArray0);
  }
  ...
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("g4&$Nv4,>bB<Ew'4{");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("g4&$Nv4,>bB<Ew'4{", string0);
  }
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "<EsIL_nT`aOQ");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // <EsIL_nT`aOQ: java.io.UnsupportedEncodingException: <EsIL_nT`aOQ
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
