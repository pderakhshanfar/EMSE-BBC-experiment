...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("_4Mozif,7aXNs< .\"");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("_4Mozif,7aXNs< .\"", string0);
  }
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("Zk$j<");
      assertArrayEquals(new byte[] {(byte)90, (byte)107, (byte)36, (byte)106, (byte)60}, byteArray0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "7\uFFFD\uFFFD0\uFFFD\uFFFD\uFFFD");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 7\uFFFD\uFFFD0\uFFFD\uFFFD\uFFFD: java.io.UnsupportedEncodingException: 7\uFFFD\uFFFD0\uFFFD\uFFFD\uFFFD
         //
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("NOD7^Iyp3f", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("N!_1YHRo9~bxXh9");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("N!_1YHRo9~bxXh9", string0);
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("'Hr+");
  ...
  public void test34()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("^Y,NJxnbEM>vh<?");
      assertEquals(30, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("'R/A:C'V?N0&");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("'R/A:C'V?N0&", string0);
  }
  ...
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("U(#s{Z1XTGF");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("U(#s{Z1XTGF", string0);
  }
  ...
  public void test40()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("U(#s{Z1XTGF", "U(#s{Z1XTGF");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // U(#s{Z1XTGF: java.io.UnsupportedEncodingException: U(#s{Z1XTGF
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
