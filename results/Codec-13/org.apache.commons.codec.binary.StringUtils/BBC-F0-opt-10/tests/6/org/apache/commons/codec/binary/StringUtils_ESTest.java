...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("=yzVyu?");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("=\u0000y\u0000z\u0000V\u0000y\u0000u\u0000?\u0000", string0);
  }
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("d9i~4o");
      assertArrayEquals(new byte[] {(byte)100, (byte)57, (byte)105, (byte)126, (byte)52, (byte)111}, byteArray0);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "k}Q,!k");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // k}Q,!k: java.io.UnsupportedEncodingException: k}Q,!k
         //
  ...
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("*L!lc");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u2A00\u4C00\u2100\u6C00\u6300", string0);
  }
  ...
  public void test42()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "# a*\\I&hW'");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // # a*\\I&hW': java.io.UnsupportedEncodingException: # a*\\I&hW'
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
