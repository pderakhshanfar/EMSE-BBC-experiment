...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("^jKsn 0rUJM'XT*?{");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("^jKsn 0rUJM'XT*?{", string0);
  }
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("{qtou");
      assertArrayEquals(new byte[] {(byte)123, (byte)113, (byte)116, (byte)111, (byte)117}, byteArray0);
  }
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("^jKsn 0rUJM'XT*?{");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "3*@GIyk0b");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 3*@GIyk0b: java.io.UnsupportedEncodingException: 3*@GIyk0b
         //
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("\uCB4Ef", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("{qtou");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("{qtou", string0);
  }
  ...
  public void test39()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "&BN7!q4k)P&n");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // &BN7!q4k)P&n: java.io.UnsupportedEncodingException: &BN7!q4k)P&n
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
