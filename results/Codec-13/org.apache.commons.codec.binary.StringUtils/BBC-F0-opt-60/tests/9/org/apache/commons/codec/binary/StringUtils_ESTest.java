...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("P6*fBGZ&;D~q,3kF", "US-ASCII");
  ...
  public void test22()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("jZ");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "9aSQY");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 9aSQY: java.io.UnsupportedEncodingException: 9aSQY
         //
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("Kff< }3O?{V1d$SOC", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("iPg+TebV?<>nw!&");
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("iPg+TebV?<>nw!&");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("iPg+TebV?<>nw!&", string0);
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("V(4kW,t*!M0q");
      assertEquals(24, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("6wvGz] 1gh.2+j'[z");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u3677\u7647\u7A5D\u2031\u6768\u2E32\u2B6A\u275B\uFFFD", string0);
  }
  ...
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("a(cJ");
      assertArrayEquals(new byte[] {(byte)97, (byte)40, (byte)99, (byte)74}, byteArray0);
  }
  ...
  public void test37()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("iPg+TebV?<>nw!&");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("\u0000i\u0000P\u0000g\u0000+\u0000T\u0000e\u0000b\u0000V\u0000?\u0000<\u0000>\u0000n\u0000w\u0000!\u0000&", string0);
  }
  ...
  public void test38()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("|T&g?", "");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("% Uz~45Ur|");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("\u0000%\u0000 \u0000U\u0000z\u0000~\u00004\u00005\u0000U\u0000r\u0000|", string0);
  }
}
