...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("R]Tb:SEj>eR6PSy'^Q");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("R]Tb:SEj>eR6PSy'^Q", string0);
  }
  ...
  public void test18()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("z /5=YDjnc-T`ID.Ht", "ISO-8859-1");
      assertEquals(18, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("-BA");
      assertArrayEquals(new byte[] {(byte)45, (byte)66, (byte)65}, byteArray0);
  }
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("%IOfYv:<@^b", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "xCqJ!u}8+'");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // xCqJ!u}8+': java.io.UnsupportedEncodingException: xCqJ!u}8+'
         //
  ...
  public void test27()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, ".XM@VlMS");
      assertNull(byteArray0);
  }
  ...
  public void test30()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("mukZqZ");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("\uFFFD\uFFFD\u0000m\u0000u\u0000k\u0000Z\u0000q\u0000Z", string0);
  }
  ...
  public void test40()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("`XZ['zPUNNv==,");
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("R]Tb:SEj>eR6PSy'^Q");
