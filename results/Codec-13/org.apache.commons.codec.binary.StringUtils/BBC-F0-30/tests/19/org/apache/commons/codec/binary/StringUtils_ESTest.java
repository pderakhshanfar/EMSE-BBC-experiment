...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("btZ");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u7462\uFFFD", string0);
  }
  ...
  public void test25()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("&:qs9ex");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "&:qs9ex");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // &:qs9ex: java.io.UnsupportedEncodingException: &:qs9ex
         //
  ...
  public void test41()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "]~a#?wMj.e&iCU|#");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // ]~a#?wMj.e&iCU|#: java.io.UnsupportedEncodingException: ]~a#?wMj.e&iCU|#
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
