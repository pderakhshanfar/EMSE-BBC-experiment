...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("v{S#@z*!}nUBKja^B");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("\uFFFD\uFFFD\u0000v\u0000{\u0000S\u0000#\u0000@\u0000z\u0000*\u0000!\u0000}\u0000n\u0000U\u0000B\u0000K\u0000j\u0000a\u0000^\u0000B", string0);
  }
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("C1Wo8rD|NYKND");
      String string0 = StringUtils.newString(byteArray0, "US-ASCII");
      assertEquals("\uFFFD\uFFFD\u0000C\u00001\u0000W\u0000o\u00008\u0000r\u0000D\u0000|\u0000N\u0000Y\u0000\u0000K\u0000\u0000N\u0000D", string0);
  }
  ...
  public void test08()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("7!lID,c%x)+yS4");
      assertEquals(14, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("( EutWTov:;XW7t2XC-");
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("EKt9aZjtS_zT(#4rW");
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("EKt9aZjtS_zT(#4rW", "UTF-16BE");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "h0cB[#GY6~");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // h0cB[#GY6~: java.io.UnsupportedEncodingException: h0cB[#GY6~
         //
  ...
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "@c");
      assertNull(byteArray0);
  }
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked(")'R$OpEew:Gn", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("<&]s4Xw.-A");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u3C26\u5D73\u3458\u772E\u2D41", string0);
  }
  ...
  public void test36()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("O!@.Xo23<!");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\uFFFD\u4F00\u2100\u4000\u2E00\u5800\u6F00\u3200\u3300\u3C00\u2100", string0);
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "B8au= es\"");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // B8au= es\": java.io.UnsupportedEncodingException: B8au= es\"
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test41()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("IBdwKI8#^&yc");
