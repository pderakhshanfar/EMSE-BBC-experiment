...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("`vA=hDOo\"P9tgj");
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("zmB>%K*H,6Tk;sC");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("2kcp1lf=\n&?D", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("zmB>%K*H,6Tk;sC", ": ");
  ...
  public void test27()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "{;-7]C");
      assertNull(string0);
  }
  ...
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "L9;nY39=yXf#<6!");
      assertNull(byteArray0);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("e2 SU_VEX*WFYZA9", "UTF-16BE");
  ...
  public void test34()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("e2 SU_VEX*WFYZA9");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u6532\u2053\u555F\u5645\u582A\u5746\u595A\u4139", string0);
  }
  ...
  public void test36()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("`vA=hDOo\"P9tgj");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u6076\u413D\u6844\u4F6F\u2250\u3974\u676A", string0);
  }

  @Test(timeout = 4000)
  public void test37()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("_C");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u435F", string0);
  }
  ...
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("e2 SU_VEX*WFYZA9");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("e2 SU_VEX*WFYZA9", string0);
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "1$EUUv");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 1$EUUv: java.io.UnsupportedEncodingException: 1$EUUv
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
