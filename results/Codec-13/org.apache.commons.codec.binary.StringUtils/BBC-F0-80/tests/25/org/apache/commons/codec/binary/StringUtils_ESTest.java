...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("?u%KP\"");
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("W*PeH'^6W{[*x(");
      assertEquals(14, byteArray0.length);
  }
  ...
  public void test27()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "i5uE#?");
      assertNull(byteArray0);
  }
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "[K @Rt$~cnQ");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // [K @Rt$~cnQ: java.io.UnsupportedEncodingException: [K @Rt$~cnQ
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
