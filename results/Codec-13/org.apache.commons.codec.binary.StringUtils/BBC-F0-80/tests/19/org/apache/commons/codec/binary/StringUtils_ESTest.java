...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("", "2<Q");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 2<Q: java.io.UnsupportedEncodingException: 2<Q
         //
  ...
  public void test01()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("I`ON`]m(9+/p%@{fxi");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("\uFFFD\uFFFD\u0000I\u0000`\u0000O\u0000N\u0000`\u0000]\u0000m\u0000(\u00009\u0000+\u0000/\u0000p\u0000%\u0000@\u0000{\u0000f\u0000x\u0000i", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals("\uFEFFI`ON`]m(9+/p%@{fxi", string0);
  }
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("Sw^!hP+C!5@06b5X5");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "I`ON`]m(9+/p%@{fxi");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // I`ON`]m(9+/p%@{fxi: java.io.UnsupportedEncodingException: I`ON`]m(9+/p%@{fxi
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "/J9Y4=A~al8B:gJL");
      assertNull(byteArray0);
  }
  ...
  public void test33()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("ivrhR2)ao:{9uDXw");
  ...
  public void test37()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("Sw^!hP+C!5@06b5X5");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
  ...
  public void test42()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("M6UQ9e1M&:,zZrJO~");
      assertEquals(34, byteArray0.length);
  }
}
