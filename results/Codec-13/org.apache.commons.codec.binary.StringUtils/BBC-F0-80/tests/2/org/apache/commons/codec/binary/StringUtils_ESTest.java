...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("%p*m lu]~T7");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("%p*m lu]~T7", string0);
  }
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("1*.eu%geN", "US-ASCII");
  ...
  public void test22()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("0x/h");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "\u7830\u682F");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // \u7830\u682F: java.io.UnsupportedEncodingException: \u7830\u682F
         //
  ...
  public void test30()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("_5-;PiDuGR]HJL3yf");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u5F35\u2D3B\u5069\u4475\u4752\u5D48\u4A4C\u3379\uFFFD", string0);
  }
  ...
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("1*.eu%geN");
