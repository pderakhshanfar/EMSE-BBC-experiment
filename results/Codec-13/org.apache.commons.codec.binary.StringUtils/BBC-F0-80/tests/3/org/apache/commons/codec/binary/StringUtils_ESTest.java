...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("2N}?<7|");
  ...
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("[`z1}lmsyIuPoW)XE_U");
  ...
  public void test33()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("3'[Dj+wB^md);kZ\"H/");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u3300\u2700\u5B00\u4400\u6A00\u2B00\u7700\u4200\u5E00\u6D00\u6400\u2900\u3B00\u6B00\u5A00\u2200\u4800\u2F00", string0);
  }
  ...
  public void test37()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("3'[Dj+wB^md);kZ\"H/");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("3\u0000'\u0000[\u0000D\u0000j\u0000+\u0000w\u0000B\u0000^\u0000m\u0000d\u0000)\u0000;\u0000k\u0000Z\u0000\"\u0000H\u0000/\u0000", string0);
  }
  ...
  public void test38()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("UHXK(wb%nEVM#qiW", "org.apache.commons.codec.binary.StringUtils");
        fail("Expecting exception: IllegalStateException");
