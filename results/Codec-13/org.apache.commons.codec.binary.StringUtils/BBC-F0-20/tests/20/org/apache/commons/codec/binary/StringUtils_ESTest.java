...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte) (-2), (byte) (-1), (byte)0, (byte)44}, byteArray0);
  }
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1(" n%/1MyL'&9a-");
  ...
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, " +kQ?3?A;WJUy[>wEA");
      assertNull(byteArray0);
  }
  ...
  public void test40()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("NM", "Uy`i[X}$GEq");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Uy`i[X}$GEq: java.io.UnsupportedEncodingException: Uy`i[X}$GEq
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
