...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("sM5vp#Knfz9ESN");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "/TT`g%j#{>3C|r+");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // /TT`g%j#{>3C|r+: java.io.UnsupportedEncodingException: /TT`g%j#{>3C|r+
         //
  ...
  public void test26()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "s%Q1");
      assertNull(string0);
  }
  ...
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "-:f_M=H Fe )ObU3twS");
      assertNull(byteArray0);
  }
  ...
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("xIe%:~6e-OUvdA*3 c");
  ...
  public void test41()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("ISO-8859-1", "2n?w+K^2");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 2n?w+K^2: java.io.UnsupportedEncodingException: 2n?w+K^2
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
