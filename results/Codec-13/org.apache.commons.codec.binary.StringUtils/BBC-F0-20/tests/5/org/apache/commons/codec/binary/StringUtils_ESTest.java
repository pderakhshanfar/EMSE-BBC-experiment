...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("Q%A\\");
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("n5>QmF$gvOCP$rLj'", "UTF-16BE");
  ...
  public void test40()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "&CoWocQZ=a]");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // &CoWocQZ=a]: java.io.UnsupportedEncodingException: &CoWocQZ=a]
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
