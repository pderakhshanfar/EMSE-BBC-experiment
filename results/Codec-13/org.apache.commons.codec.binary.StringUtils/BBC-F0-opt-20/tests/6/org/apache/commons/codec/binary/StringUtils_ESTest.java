...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("L;JS\u0003iHO\"I");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u4C3B\u4A53\u0369\u484F\u2249", string0);
  }
  ...
  public void test11()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("{Sw6]gf~");
      String string0 = StringUtils.newString(byteArray0, "UTF-16LE");
      assertEquals("\uFFFD\u7B00\u5300\u7700\u3600\u5D00\u6700\u7F00\u6600\u7E00", string0);
  }
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("{5h");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "m`>[ra @\"7$3L^kQx");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // m`>[ra @\"7$3L^kQx: java.io.UnsupportedEncodingException: m`>[ra @\"7$3L^kQx
         //
  ...
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("9:&g>59r_Uj;o,n", "UTF-8");
      assertNotNull(byteArray0);
      
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u393A\u2667\u3E35\u3972\u5F55\u6A7F\u3B6F\u2C6E", string0);
  }
  ...
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("b:8j?_\"^");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "PAI,,13");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // PAI,,13: java.io.UnsupportedEncodingException: PAI,,13
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
