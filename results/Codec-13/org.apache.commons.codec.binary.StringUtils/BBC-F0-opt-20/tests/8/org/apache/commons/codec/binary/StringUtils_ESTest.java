...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("PV>(T\"f<}");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u5650\u283E\u2254\u3C66\uFFFD", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8(" k@>OLe;qt~M)v'");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u206B\u403E\u4F4C\u653B\u7174\u7E4D\u2976\uFFFD", string0);
  }
  ...
  public void test18()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("\u9DA1");
  ...
  public void test23()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("Nd+gd>^BF");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "DY+i@8Ruu\"");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // DY+i@8Ruu\": java.io.UnsupportedEncodingException: DY+i@8Ruu\"
         //
  ...
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8(" k@>OLe;qt~M)v'");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals(" k@>OLe;qt~M)v'", string0);
  }
