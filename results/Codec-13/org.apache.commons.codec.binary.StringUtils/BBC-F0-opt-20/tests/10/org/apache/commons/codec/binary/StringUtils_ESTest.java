...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("g}\fdVE#8vr$,", "UTF-16BE");
  ...
  public void test26()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "g~}0P*q!3");
      assertNull(string0);
  }
  ...
  public void test33()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1(";[X5X&iv,O@#5&4T");
  ...
  public void test40()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "DT%xRypxa) p%vS Q");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // DT%xRypxa) p%vS Q: java.io.UnsupportedEncodingException: DT%xRypxa) p%vS Q
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
