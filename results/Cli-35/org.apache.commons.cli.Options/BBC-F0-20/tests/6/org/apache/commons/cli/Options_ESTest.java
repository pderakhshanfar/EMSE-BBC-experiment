...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      option0.setArgName("D0@5qgCodEi[4:");
      Options options1 = options0.addOption(option0);
      Option option1 = options1.getOption("");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("/:Z48#j85qSXdT6v=", "/:Z48#j85qSXdT6v=", true, "nX/?Es+pkeS");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '/:Z48#j85qSXdT6v=' contains an illegal character : '/'
         //
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("&u*V\"hagwJG5)80NVM:", (String) null);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '&u*V\"hagwJG5)80NVM:' contains an illegal character : '&'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasLongOption("-S-C7),`?+\b");
      assertFalse(boolean0);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("3v|Ek @Byf6yp`", true, "mLWn1Jxow1aDC]");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '3v|Ek @Byf6yp`' contains an illegal character : '|'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
