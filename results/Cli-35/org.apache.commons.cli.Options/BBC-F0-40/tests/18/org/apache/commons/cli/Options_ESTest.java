...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Option option0 = new Option("@", "?E,{R0A$V/]\"*rI", false, "?E,{R0A$V/]\"*rI");
  ...
  public void test05()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("", "IjE>&/WI^P^5,r", true, "IjE>&/WI^P^5,r");
  ...
  public void test07()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("", "", true, "");
      option0.setArgs(4504);
      options0.addOption(option0);
      Option option1 = options0.getOption("");
      assertEquals(4504, option1.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "IjE>&/WI^P^5,r", false, "IjE>&/WI^P^5,r");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      options0.addOptionGroup(optionGroup1);
      option0.setArgName("IjE>&/WI^P^5,r");
      Option option1 = options0.getOption("IjE>&/WI^P^5,r");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("ZZ(INjh%Q:V[M?V", true, "ZZ(INjh%Q:V[M?V");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'ZZ(INjh%Q:V[M?V' contains an illegal character : '('
         //
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("BM;`\"F6iw*$y\"", "@/G'6?GK5pzz4*ao*!", true, " ] [ long ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'BM;`\"F6iw*$y\"' contains an illegal character : ';'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasShortOption("o1!ihkeP8");
  ...
  public void test27()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = options0.getOption("LIjE>&/WI^P^5,r");
      assertNull(option0);
  }
  ...
  public void test29()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "LIjE>&/WI^P^5,r", false, "LIjE>&/WI^P^5,r");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Options options1 = options0.addOptionGroup(optionGroup1);
      List<String> list0 = options1.getMatchingOptions("[]");
      assertFalse(option0.isRequired());
      assertFalse(list0.contains("LIjE>&/WI^P^5,r"));
  }
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("Either opt or longOpt must be specified", ">cC");
        fail("Expecting exception: IllegalArgumentException");
