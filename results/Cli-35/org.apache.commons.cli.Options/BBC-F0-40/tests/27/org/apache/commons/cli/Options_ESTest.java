...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        options0.addOption("Z@z'e#L3", (String) null);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'Z@z'e#L3' contains an illegal character : '@'
         //
  ...
  public void test05()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("is", "is", true, "is");
      option0.setRequired(true);
      options0.addOption(option0);
      Option option1 = options0.getOption("is");
  ...
  public void test08()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("Vv", "Vv", true, "Vv");
      option0.setArgs(769);
      Options options1 = options0.addOption(option0);
      Option option1 = options1.getOption("Vv");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption(",X0RJhb;5wZkw?", false, ",X0RJhb;5wZkw?");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ',X0RJhb;5wZkw?' contains an illegal character : ','
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("'0>&wMI3@0B* N)", "%@%zI", false, "dr7G'R");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ''0>&wMI3@0B* N)' contains an illegal character : '''
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("", " ] [ long [ARG...]", false, "");
      boolean boolean0 = options0.hasOption(" ] [ long [ARG...]");
      assertTrue(boolean0);
  }
  ...
  public void test25()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("", "?N:.v+Kuv", false, (String) null);
      List<String> list0 = options0.getMatchingOptions("");
      assertTrue(list0.contains("?N:.v+Kuv"));
  }
  ...
  public void test27()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = options0.getOption(" . hN(SyAM05hwa");
      assertNull(option0);
  }
