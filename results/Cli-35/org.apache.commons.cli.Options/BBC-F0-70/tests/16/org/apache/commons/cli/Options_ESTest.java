...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("hnw3nnE", "'!PI:GUT5~#*T;", true, "hL\"fl!!ixFK_@37be1");
      Option option0 = options0.getOption("'!PI:GUT5~#*T;");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("xB]I%3at]%W64X361", "e,YLQn");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'xB]I%3at]%W64X361' contains an illegal character : ']'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("hnw3nnE", "hnw3nnE", false, "hnw3nnE");
      Options options1 = options0.addOption(option0);
      boolean boolean0 = options1.hasShortOption("hnw3nnE");
      assertTrue(boolean0);
  }
  ...
  public void test20()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasLongOption("v?D*J");
      assertFalse(boolean0);
  }
  ...
  public void test21()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("hnw3nnE", "'!PI:GUT5~#*T;", true, "hL\"fl!!ixFK_@37be1");
      boolean boolean0 = options0.hasOption("'!PI:GUT5~#*T;");
      assertTrue(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Option option0 = new Option("hnw3nnE", "hnw3nnE", false, "hnw3nnE");
      Options options1 = options0.addOption(option0);
      List<String> list0 = options1.getMatchingOptions("I={+)#q}u2 c82rMgCn");
      assertFalse(list0.contains("hnw3nnE"));
  }
  ...
  public void test27()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("fg", "Uw7_u", true, "Uw7_u");
  ...
  public void test35()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("hnw3nnE", false, "");
