...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("pF.VTB |", "]:P>QF]@o8", false, "has already been selected: '");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'pF.VTB |' contains an illegal character : '.'
         //
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("HKr/(n*0eOUh", "L38c=+]");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'HKr/(n*0eOUh' contains an illegal character : '/'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasShortOption("gSYom]G&|Bf>?pTD");
  ...
  public void test19()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("", "K3''G", false, "M");
      boolean boolean0 = options1.hasLongOption("K3''G");
      assertTrue(boolean0);
  }
  ...
  public void test20()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasLongOption("u RkiZX1<{m");
      assertFalse(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Option option0 = new Option((String) null, "[", false, (String) null);
      Options options1 = options0.addOption(option0);
      List<String> list0 = options1.getMatchingOptions("KK_t] _1xEKWhas already been seleted: '");
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("DVY|dx'", true, "M");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'DVY|dx'' contains an illegal character : '|'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
