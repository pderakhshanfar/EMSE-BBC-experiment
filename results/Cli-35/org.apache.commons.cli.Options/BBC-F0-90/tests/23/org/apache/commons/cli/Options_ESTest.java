...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option((String) null, "]h[`hN?{ptP", false, (String) null);
  ...
  public void test06()  throws Throwable  {
      ...
      option0.setArgName("]h[`hN?{ptP");
      Option option1 = options0.getOption("]h[`hN?{ptP");
  ...
  public void test07()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("Z", true, "4Bsl#}k3?Q{0a<]&gh");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
  ...
  public void test11()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("9E", "V-!#`'M1!8%^4d}-qcT", false, (String) null);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("[ Options: [ short ", " ]", false, "9E");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        options0.addOption("'k9y{NoU", (String) null);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ''k9y{NoU' contains an illegal character : '''
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasShortOption("GL6(CV.N^4");
  ...
  public void test18()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("", "org.apache.commons.cli.Options", true, "org.apache.commons.cli.AlreadySelectedException");
      options0.addOption(option0);
  ...
  public void test22()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasOption("GL6(CV.N^4");
      assertFalse(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Option option0 = new Option("", "org.apache.commons.cli.AlreadySelectedException", true, " ]");
      options0.addOption(option0);
      List<String> list0 = options0.getMatchingOptions("GL6(CV.N^4");
  ...
  public void test25()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = options0.getOption("GL6(CV.N^4");
      assertNull(option0);
  }
  ...
  public void test26()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("", false, "M5CA[Mr_7h");
