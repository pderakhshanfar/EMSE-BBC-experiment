...
public class Base32_ESTest extends Base32_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Base32 base32_0 = new Base32((-380));
  ...
  public void test07()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32(9, byteArray0, false, (byte)107);
      assertEquals(76, BaseNCodec.MIME_CHUNK_SIZE);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      base32_0.encode(byteArray0, 53, 2917, baseNCodec_Context0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode((byte[]) null, 1980, 58, baseNCodec_Context0);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, (-1759), 14, baseNCodec_Context0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test16()  throws Throwable  {
      Base32 base32_0 = new Base32();
      boolean boolean0 = base32_0.isInAlphabet("C[3'2yawCOX~ t*S}");
      assertFalse(boolean0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[6];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      baseNCodec_Context0.modulus = (-2171);
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, (-1696), (-2590), baseNCodec_Context0);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Impossible modulus -2171
         //
         verifyException("org.apache.commons.codec.binary.Base32", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      base32_0.encodeAsString(byteArray0);
      // Undeclared exception!
      base32_0.decode(byteArray0, (int) (byte)12, 2840, baseNCodec_Context0);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[3];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      base32_0.encode(byteArray0, (int) (byte) (-83), (int) (byte) (-83), baseNCodec_Context0);
      base32_0.encode(byteArray0, 475, (int) (byte) (-83), baseNCodec_Context0);
      assertEquals(64, BaseNCodec.PEM_CHUNK_SIZE);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[6];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      baseNCodec_Context0.modulus = 727;
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, (-2388), (-1438), baseNCodec_Context0);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Impossible modulus 727
         //
         verifyException("org.apache.commons.codec.binary.Base32", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      Base32 base32_0 = new Base32(true);
      Object object0 = base32_0.decode((Object) "t\"BworJ5v4WHj@0");
      assertNotNull(object0);
  }
  ...
  public void test27()  throws Throwable  {
      Base32 base32_0 = new Base32();
      byte[] byteArray0 = base32_0.decode("LFB7I6QAAAAAAAAAAAAAAAAAAAAAAAAAAAAA====");
  ...
  public void test31()  throws Throwable  {
      ...
      Base32 base32_0 = null;
      try {
        base32_0 = new Base32((byte)64, byteArray0, false);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test33()  throws Throwable  {
      Base32 base32_0 = new Base32(true);
      byte[] byteArray0 = base32_0.decode("a3V9@dm(");
  ...
  public void test35()  throws Throwable  {
      Base32 base32_0 = new Base32(8);
      byte[] byteArray0 = base32_0.decode("AUCQKBIF\r\n");
      assertArrayEquals(new byte[] {(byte)5, (byte)5, (byte)5, (byte)5, (byte)5}, byteArray0);
