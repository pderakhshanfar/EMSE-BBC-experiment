...
public class Base32_ESTest extends Base32_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)48, (byte)48, (byte) (-105), (byte) (-105), (byte) (-105), (byte) (-105), (byte) (-105), (byte) (-105)}, byteArray1);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32(110, byteArray0);
  ...
  public void test04()  throws Throwable  {
      ...
      baseNCodec_Context0.lbitWorkArea = (long) (byte) (-111);
      baseNCodec_Context0.modulus = (-1745);
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, (int) (byte)0, 1628, baseNCodec_Context0);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, 32, 3069, baseNCodec_Context0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test08()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[2];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      base32_0.decode(byteArray0, (-1779), 0, baseNCodec_Context0);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      base32_0.encode(byteArray0, 4, 3293, baseNCodec_Context0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, 2179, 1477, baseNCodec_Context0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, 84, 19, (BaseNCodec.Context) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      ...
      base32_0.encode(byteArray0, (int) (byte)74, (-1383), baseNCodec_Context0);
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, 4, (-3350), baseNCodec_Context0);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Impossible modulus -1745
         //
         verifyException("org.apache.commons.codec.binary.Base32", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      base32_0.encode(byteArray0, (-344), (int) (byte)0, baseNCodec_Context0);
      assertEquals(76, BaseNCodec.MIME_CHUNK_SIZE);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[3];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      base32_0.encode(byteArray0, (int) (byte)9, (-344), baseNCodec_Context0);
  ...
  public void test28()  throws Throwable  {
      Base32 base32_0 = new Base32((byte)0);
      Object object0 = base32_0.decode((Object) "3{MI@y&=a5P(H(b");
  ...
  public void test29()  throws Throwable  {
      ...
      byte[] byteArray0 = base32_0.decode("0oBSwWy/z43~}tn({");
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      baseNCodec_Context0.modulus = 3113;
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, 56, (int) (byte) (-111), baseNCodec_Context0);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Impossible modulus 3113
         //
         verifyException("org.apache.commons.codec.binary.Base32", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte) (-41), (byte) (-106)}, byteArray1);
  ...
  public void test35()  throws Throwable  {
      ...
      Base32 base32_0 = null;
      try {
        base32_0 = new Base32((byte)27, byteArray0);
        fail("Expecting exception: IllegalArgumentException");
