...
public class Base32_ESTest extends Base32_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      base32_0.encode(byteArray0, (-3147), 0, baseNCodec_Context0);
  ...
  public void test04()  throws Throwable  {
      Base32 base32_0 = new Base32();
      byte[] byteArray0 = base32_0.decode("AACQBMIA");
      assertEquals(5, byteArray0.length);
      assertArrayEquals(new byte[] {(byte)0, (byte)5, (byte)0, (byte) (-79), (byte)0}, byteArray0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Base32 base32_0 = new Base32((-1375));
      byte[] byteArray0 = base32_0.decode("Fw<gBY}6.L[wyg#gB");
      assertArrayEquals(new byte[] {(byte)40, (byte)113, (byte) (-27)}, byteArray0);
      assertEquals(3, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Base32 base32_0 = new Base32(318);
      byte[] byteArray0 = new byte[3];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, 3364, 64, baseNCodec_Context0);
  ...
  public void test07()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[6];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      base32_0.decode(byteArray0, (int) (byte) (-110), 0, baseNCodec_Context0);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, (-3999), 77, (BaseNCodec.Context) null);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, 1, (int) (byte)5, baseNCodec_Context0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, (int) (byte)43, 1722, (BaseNCodec.Context) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, (-781), (-781), baseNCodec_Context0);
  ...
  public void test24()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[4];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      base32_0.decode(byteArray0, 124, (int) (byte) (-79), baseNCodec_Context0);
      base32_0.encode(byteArray0, 4324, (-2085), baseNCodec_Context0);
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals("JFDECVKDKFFUESKGIFKUGUKLIJEFKNSUGJIEUNKIKU6T2PJ5HU6Q====", string0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, 76, (-1564), baseNCodec_Context0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test27()  throws Throwable  {
      byte[] byteArray0 = new byte[6];
      Base32 base32_0 = new Base32((-95), byteArray0, false, (byte)3);
      byte[] byteArray1 = base32_0.decode("612KUHPM\u0003\uFFFD\u0003\u0003\n\u0003617K20TH\u0003\uFFFD\u0003\u0003\n\u00030C1GK0PG\u0003\uFFFD\u0003\u0003\n\u00038CUJQF9T\u0003\uFFFD\u0003\u0003\n\u00037KUG7C83\u0003\uFFFD\u0003\u0003\n\u00030C506===\u0003\uFFFD\u0003\u0003\n\u0003");
      assertEquals(4, byteArray1.length);
      assertArrayEquals(new byte[] {(byte) (-10), (byte) (-107), (byte)67, (byte) (-67)}, byteArray1);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      Base32 base32_0 = new Base32((-1375));
      byte[] byteArray0 = base32_0.decode(")f^7f\"Cn-!81:TJX:");
      assertArrayEquals(new byte[] {(byte) (-8), (byte) (-90), (byte) (-101)}, byteArray0);
      assertEquals(3, byteArray0.length);
  }
  ...
  public void test30()  throws Throwable  {
      Base32 base32_0 = new Base32();
      Object object0 = base32_0.decode((Object) "612KUHPM\u0003\uFFFD\u0003\u0003\n\u0003617K20TH\u0003\uFFFD\u0003\u0003\n\u00030C1GK0PG\u0003\uFFFD\u0003\u0003\n\u00038CUJQF9T\u0003\uFFFD\u0003\u0003\n\u00037KUG7C83\u0003\uFFFD\u0003\u0003\n\u00030C506===\u0003\uFFFD\u0003\u0003\n\u0003");
  ...
  public void test33()  throws Throwable  {
      ...
      Base32 base32_0 = null;
      try {
        base32_0 = new Base32(3710, byteArray0, true, (byte)0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test35()  throws Throwable  {
      ...
      boolean boolean0 = base32_0.isInAlphabet("8c}u");
      assertFalse(boolean0);
  }
  ...
  public void test37()  throws Throwable  {
      ...
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      byte[] byteArray0 = base32_0.ensureBufferSize((byte)26, baseNCodec_Context0);
      base32_0.encodeAsString(byteArray0);
      // Undeclared exception!
      base32_0.encode(byteArray0, 79, 5064, baseNCodec_Context0);
  }
