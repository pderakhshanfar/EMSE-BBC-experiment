...
public class Base32_ESTest extends Base32_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      byteArray0[0] = (byte) (-3);
      String string0 = base32_0.encodeAsString(byteArray0);
      assertEquals("7UAAAAAAAA\uFFFD\uFFFD\uFFFD\uFFFD\uFFFD\uFFFD", string0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = base32_0.decode((Object) "AQAPSAAA\u0004\u0000\uFFFD\u0000\u0000\u0000\u0000\u0000\u0000\u0000AAAAAAAA\u0004\u0000\uFFFD\u0000\u0000\u0000\u0000\u0000\u0000\u0000");
  ...
  public void test04()  throws Throwable  {
      Base32 base32_0 = new Base32((byte)3);
      byte[] byteArray0 = base32_0.decode("#uL([^ 29=un");
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, 126, 126, baseNCodec_Context0);
  ...
  public void test10()  throws Throwable  {
      Base32 base32_0 = new Base32();
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      byte[] byteArray0 = base32_0.ensureBufferSize((-947), baseNCodec_Context0);
      base32_0.encodeAsString(byteArray0);
      // Undeclared exception!
      base32_0.encode(byteArray0, 124, 2273, baseNCodec_Context0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      base32_0.encodeAsString(byteArray0);
      // Undeclared exception!
      base32_0.decode(byteArray0, (int) (byte)0, 3114, baseNCodec_Context0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, 0, (int) (byte)32, baseNCodec_Context0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test18()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[2];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      baseNCodec_Context0.modulus = (-3090);
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, (int) (byte)69, (int) (byte) (-3), baseNCodec_Context0);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Impossible modulus -3090
         //
         verifyException("org.apache.commons.codec.binary.Base32", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      base32_0.encode(byteArray0, (int) (byte)69, (int) (byte) (-3), baseNCodec_Context0);
      base32_0.encode(byteArray0, (int) (byte) (-3), (-244), baseNCodec_Context0);
      assertEquals(76, BaseNCodec.MIME_CHUNK_SIZE);
  }
  ...
  public void test23()  throws Throwable  {
      Base32 base32_0 = new Base32();
      Object object0 = base32_0.decode((Object) "H47QMPY=");
  ...
  public void test24()  throws Throwable  {
      byte[] byteArray0 = new byte[2];
      Base32 base32_0 = new Base32((-2154), byteArray0, true, (byte)1);
      byte[] byteArray1 = base32_0.decode("PZ0z`_1+o4B-C");
      assertEquals(3, byteArray1.length);
      assertArrayEquals(new byte[] {(byte) (-56), (byte)2, (byte)69}, byteArray1);
  }
  ...
  public void test25()  throws Throwable  {
      byte[] byteArray0 = new byte[3];
      Base32 base32_0 = new Base32(13, byteArray0);
      Object object0 = base32_0.decode((Object) "AQAPS===\u0004\u0000\uFFFD");
      assertNotSame(byteArray0, object0);
  }
  ...
  public void test26()  throws Throwable  {
      Base32 base32_0 = new Base32();
      Object object0 = base32_0.decode((Object) "c,HB)sF");
      assertNotNull(object0);
  }
