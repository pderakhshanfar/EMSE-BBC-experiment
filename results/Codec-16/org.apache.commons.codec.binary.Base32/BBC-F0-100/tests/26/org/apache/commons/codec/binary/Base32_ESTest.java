...
public class Base32_ESTest extends Base32_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      base32_0.decode(byteArray1, 6, 66, baseNCodec_Context0);
  ...
  public void test07()  throws Throwable  {
      ...
      base32_0.decode(byteArray0, (-2241), (-862), baseNCodec_Context0);
  ...
  public void test08()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32((-2361), byteArray0, false, (byte) (-121));
      assertEquals(64, BaseNCodec.PEM_CHUNK_SIZE);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.decode((byte[]) null, (int) (byte)8, 554, baseNCodec_Context0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test15()  throws Throwable  {
      Base32 base32_0 = null;
      try {
        base32_0 = new Base32(482, (byte[]) null, false, (byte) (-57));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // lineLength 482 > 0, but lineSeparator is null
         //
         verifyException("org.apache.commons.codec.binary.Base32", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Base32 base32_0 = new Base32(1593);
      byte[] byteArray0 = new byte[6];
  ...
  public void test22()  throws Throwable  {
      Base32 base32_0 = new Base32((-627));
      byte[] byteArray0 = new byte[6];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      baseNCodec_Context0.modulus = (-1795);
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, (-1), (-427), baseNCodec_Context0);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Impossible modulus -1795
         //
         verifyException("org.apache.commons.codec.binary.Base32", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Base32 base32_0 = new Base32();
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      byte[] byteArray0 = base32_0.ensureBufferSize((-816), baseNCodec_Context0);
      base32_0.encodeToString(byteArray0);
      // Undeclared exception!
      base32_0.decode(byteArray0, 2036, 2036, baseNCodec_Context0);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      base32_0.encode(byteArray0, (-1), (-427), baseNCodec_Context0);
      base32_0.encode(byteArray0, (int) (byte)86, (-3125), baseNCodec_Context0);
      assertEquals(76, BaseNCodec.MIME_CHUNK_SIZE);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, 64, (-2744), baseNCodec_Context0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test27()  throws Throwable  {
      ...
      byte[] byteArray0 = base32_0.decode("^AkIz53[2N$");
      assertArrayEquals(new byte[] {(byte)2, (byte)59, (byte) (-67)}, byteArray0);
  ...
  public void test33()  throws Throwable  {
      ...
      boolean boolean0 = base32_0.isInAlphabet("org.apache.commons.codec.binary.BaseNCodec");
      assertFalse(boolean0);
  }
  ...
  public void test35()  throws Throwable  {
      Base32 base32_0 = null;
      try {
        base32_0 = new Base32(2482, (byte[]) null, true);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // lineLength 2482 > 0, but lineSeparator is null
         //
         verifyException("org.apache.commons.codec.binary.Base32", e);
      }
  }
