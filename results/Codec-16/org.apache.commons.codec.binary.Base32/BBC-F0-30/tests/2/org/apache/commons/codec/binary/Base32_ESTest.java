...
public class Base32_ESTest extends Base32_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        base32_0.decode(byteArray0, (int) (byte)0, (int) (byte)32, baseNCodec_Context0);
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, (-1572), 3011, baseNCodec_Context0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test06()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[3];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      base32_0.decode(byteArray0, 177, (int) (byte)0, baseNCodec_Context0);
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = new byte[1];
      Base32 base32_0 = new Base32(48, byteArray0, false, (byte) (-37));
      assertEquals(76, BaseNCodec.MIME_CHUNK_SIZE);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Base32 base32_0 = new Base32(1539);
  ...
  public void test09()  throws Throwable  {
      Base32 base32_0 = new Base32((-2989));
      byte[] byteArray0 = new byte[0];
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, 1316, 63, (BaseNCodec.Context) null);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, 63, (int) (byte)0, (BaseNCodec.Context) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test12()  throws Throwable  {
      ...
      try {
        base32_0 = new Base32(3645, byteArray0);
  ...
  public void test15()  throws Throwable  {
      Base32 base32_0 = new Base32((-1072));
  ...
  public void test21()  throws Throwable  {
      ...
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      byte[] byteArray0 = new byte[7];
      base32_0.encode(byteArray0, 73, (int) (byte) (-71), baseNCodec_Context0);
  ...
  public void test23()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[5];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      base32_0.encode(byteArray0, 76, (-2835), baseNCodec_Context0);
      base32_0.encode(byteArray0, (-2436), (-1072), baseNCodec_Context0);
      assertEquals(64, BaseNCodec.PEM_CHUNK_SIZE);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[3];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      baseNCodec_Context0.modulus = 1539;
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, (-3054), (-2441), baseNCodec_Context0);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Impossible modulus 1539
         //
         verifyException("org.apache.commons.codec.binary.Base32", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      Base32 base32_0 = new Base32((-1072));
      Object object0 = base32_0.decode((Object) "O%u-)|5");
      assertNotNull(object0);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Base32 base32_0 = null;
      try {
        base32_0 = new Base32(88, byteArray0, false, (byte)122);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test34()  throws Throwable  {
      Base32 base32_0 = null;
      try {
        base32_0 = new Base32(67, (byte[]) null, false);
        fail("Expecting exception: IllegalArgumentException");
