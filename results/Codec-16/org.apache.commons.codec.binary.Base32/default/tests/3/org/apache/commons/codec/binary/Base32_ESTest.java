...
public class Base32_ESTest extends Base32_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Base32 base32_0 = new Base32(true, (byte) (-67));
  ...
  public void test03()  throws Throwable  {
      ...
      byte[] byteArray1 = base32_0.decode("zA9xFjO[DG");
      assertArrayEquals(new byte[] {(byte)1, (byte)92, (byte)51}, byteArray1);
  ...
  public void test06()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32((-3553), byteArray0, true, (byte) (-1));
      assertEquals(64, BaseNCodec.PEM_CHUNK_SIZE);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      assertEquals("IYAAAAAAAA======", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      byte[] byteArray1 = base32_0.ensureBufferSize(44, baseNCodec_Context0);
      base32_0.encodeAsString(byteArray1);
      // Undeclared exception!
      base32_0.encode(byteArray1, 124, 1960, baseNCodec_Context0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode((byte[]) null, 54, 54, baseNCodec_Context0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, (-61), 1320, baseNCodec_Context0);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, (-1775), 2801, baseNCodec_Context0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, (-2107), (-2107), baseNCodec_Context0);
  ...
  public void test22()  throws Throwable  {
      Base32 base32_0 = new Base32();
      byte[] byteArray0 = base32_0.decode("RP:{XDT|");
      String string0 = base32_0.encodeToString(byteArray0);
      assertEquals("RPXDS===", string0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[0];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      base32_0.decode(byteArray0, (-386), (-386), baseNCodec_Context0);
      base32_0.encode(byteArray0, (-386), (-386), baseNCodec_Context0);
  ...
  public void test25()  throws Throwable  {
      byte[] byteArray0 = new byte[10];
      Base32 base32_0 = new Base32((-1494));
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      baseNCodec_Context0.modulus = 76;
      // Undeclared exception!
      try { 
        base32_0.decode(byteArray0, 64, (-1494), baseNCodec_Context0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test26()  throws Throwable  {
      Base32 base32_0 = new Base32();
      byte[] byteArray0 = base32_0.decode("RP:{XDTP");
      assertEquals(3, byteArray0.length);
      assertArrayEquals(new byte[] {(byte) (-117), (byte) (-18), (byte)57}, byteArray0);
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      Base32 base32_0 = new Base32();
      byte[] byteArray0 = base32_0.decode("z)`L8sAhvOaR9%");
      assertArrayEquals(new byte[] {(byte)88, (byte)29}, byteArray0);
  ...
  public void test28()  throws Throwable  {
      Base32 base32_0 = new Base32();
      Object object0 = base32_0.decode((Object) ":`9GJ-Rdlc");
  ...
  public void test31()  throws Throwable  {
      Base32 base32_0 = new Base32();
      byte[] byteArray0 = base32_0.decode("AEG4KWCAAM3QCIA=");
      assertArrayEquals(new byte[] {(byte)1, (byte)13, (byte) (-59), (byte)88, (byte)64, (byte)3, (byte)55, (byte)1, (byte)32}, byteArray0);
  ...
  public void test32()  throws Throwable  {
      ...
      Base32 base32_0 = null;
      try {
        base32_0 = new Base32(64, byteArray0, false, (byte)90);
        fail("Expecting exception: IllegalArgumentException");
