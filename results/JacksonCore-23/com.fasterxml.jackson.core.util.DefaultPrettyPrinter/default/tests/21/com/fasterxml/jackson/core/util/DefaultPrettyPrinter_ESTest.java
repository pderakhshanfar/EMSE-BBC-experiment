...
public class DefaultPrettyPrinter_ESTest extends DefaultPrettyPrinter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      DefaultIndenter defaultIndenter0 = new DefaultIndenter("?D?6bT", "?D?6bT");
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, defaultIndenter0, false);
      byte[] byteArray0 = new byte[7];
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 1908, (ObjectCodec) null, pipedOutputStream0, byteArray0, 0, false);
  ...
  public void test04()  throws Throwable  {
      ...
      Separators separators0 = new Separators();
      DefaultPrettyPrinter defaultPrettyPrinter1 = defaultPrettyPrinter0.withSeparators(separators0);
      DefaultPrettyPrinter defaultPrettyPrinter2 = defaultPrettyPrinter1.withRootSeparator("7'^w6DH,vj/");
  ...
  public void test06()  throws Throwable  {
      ...
      defaultPrettyPrinter_NopIndenter0.writeIndentation((JsonGenerator) null, 36);
  ...
  public void test09()  throws Throwable  {
      DefaultPrettyPrinter defaultPrettyPrinter0 = new DefaultPrettyPrinter("m Zp3J.{");
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, "m Zp3J.{", true);
      PipedOutputStream pipedOutputStream0 = new PipedOutputStream();
  ...
  public void test10()  throws Throwable  {
      ...
      BufferRecycler bufferRecycler0 = new BufferRecycler(3198, 3198);
  ...
  public void test16()  throws Throwable  {
      DefaultPrettyPrinter defaultPrettyPrinter0 = new DefaultPrettyPrinter();
      BufferRecycler bufferRecycler0 = new BufferRecycler(0, 2347);
  ...
  public void test18()  throws Throwable  {
      DefaultPrettyPrinter defaultPrettyPrinter0 = new DefaultPrettyPrinter("MIME-NO-LINEFEEDS");
      BufferRecycler bufferRecycler0 = new BufferRecycler();
  ...
  public void test23()  throws Throwable  {
      DefaultPrettyPrinter defaultPrettyPrinter0 = new DefaultPrettyPrinter();
      BufferRecycler bufferRecycler0 = new BufferRecycler(125, 1724);
  ...
  public void test25()  throws Throwable  {
      DefaultPrettyPrinter defaultPrettyPrinter0 = new DefaultPrettyPrinter();
      BufferRecycler bufferRecycler0 = new BufferRecycler(449, 449);
      IOContext iOContext0 = new IOContext(bufferRecycler0, bufferRecycler0, true);
  ...
  public void test27()  throws Throwable  {
      DefaultPrettyPrinter defaultPrettyPrinter0 = new DefaultPrettyPrinter("lg]}H*K0Rq)t PzHi8");
      PipedOutputStream pipedOutputStream0 = new PipedOutputStream();
      BufferRecycler bufferRecycler0 = new BufferRecycler(361, 361);
      IOContext iOContext0 = new IOContext(bufferRecycler0, "lg]}H*K0Rq)t PzHi8", false);
      byte[] byteArray0 = new byte[8];
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 3, (ObjectCodec) null, pipedOutputStream0, byteArray0, (byte)20, true);
      try { 
        defaultPrettyPrinter0.writeObjectEntrySeparator(uTF8JsonGenerator0);
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[7];
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 248, (ObjectCodec) null, byteArrayOutputStream0, byteArray0, 1000000000, false);
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      DefaultPrettyPrinter defaultPrettyPrinter0 = new DefaultPrettyPrinter("\"ioN/>A4NA");
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, defaultPrettyPrinter0, false);
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("\"ioN/>A4NA");
      byte[] byteArray0 = new byte[0];
      ...
      try { 
        defaultPrettyPrinter0.writeEndArray(uTF8JsonGenerator0, 247);
        fail("Expecting exception: IOException");
  ...
  public void test36()  throws Throwable  {
      DefaultPrettyPrinter defaultPrettyPrinter0 = new DefaultPrettyPrinter((String) null);
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, " _[3il;;8.vWT", true);
      PipedInputStream pipedInputStream0 = new PipedInputStream(1419);
      PipedOutputStream pipedOutputStream0 = new PipedOutputStream(pipedInputStream0);
      MockPrintStream mockPrintStream0 = new MockPrintStream(pipedOutputStream0, true);
      byte[] byteArray0 = new byte[9];
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 3, (ObjectCodec) null, mockPrintStream0, byteArray0, 2105, true);
      // Undeclared exception!
      try { 
        defaultPrettyPrinter0.beforeObjectEntries(uTF8JsonGenerator0);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test39()  throws Throwable  {
      DefaultPrettyPrinter defaultPrettyPrinter0 = new DefaultPrettyPrinter("lg]}H*K0Rq)t PzHi8");
      BufferRecycler bufferRecycler0 = new BufferRecycler(3975, 708);
      Object object0 = new Object();
      IOContext iOContext0 = new IOContext(bufferRecycler0, object0, true);
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultPrettyPrinter0.writeEndArray((JsonGenerator) null, (-225));
        fail("Expecting exception: NullPointerException");
  ...
  public void test48()  throws Throwable  {
      ...
      try { 
        defaultPrettyPrinter0.writeEndObject(uTF8JsonGenerator0, 180);
        fail("Expecting exception: IOException");
  ...
  public void test50()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[0];
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 3548, (ObjectCodec) null, mockFileOutputStream0, byteArray0, 9, false);
      try { 
        defaultPrettyPrinter0.writeObjectFieldValueSeparator(uTF8JsonGenerator0);
        fail("Expecting exception: IOException");
  ...
  public void test67()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultPrettyPrinter0.writeEndObject((JsonGenerator) null, (-1924));
        fail("Expecting exception: NullPointerException");
  ...
  public void test72()  throws Throwable  {
      DefaultPrettyPrinter defaultPrettyPrinter0 = new DefaultPrettyPrinter("UeQBp-");
      BufferRecycler bufferRecycler0 = new BufferRecycler();
      IOContext iOContext0 = new IOContext(bufferRecycler0, "UeQBp-", true);
      ByteArrayBuilder byteArrayBuilder0 = new ByteArrayBuilder(bufferRecycler0);
      ObjectOutputStream objectOutputStream0 = new ObjectOutputStream(byteArrayBuilder0);
      UTF8JsonGenerator uTF8JsonGenerator0 = new UTF8JsonGenerator(iOContext0, 1, (ObjectCodec) null, objectOutputStream0, byteArrayBuilder0.NO_BYTES, 2767, true);
      // Undeclared exception!
      try { 
        defaultPrettyPrinter0.writeObjectEntrySeparator(uTF8JsonGenerator0);
        fail("Expecting exception: IndexOutOfBoundsException");
