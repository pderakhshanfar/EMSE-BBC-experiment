...
public class VerificationOverTimeImpl_ESTest extends VerificationOverTimeImpl_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Timer timer0 = new Timer(1797L);
      VerificationOverTimeImpl verificationOverTimeImpl0 = new VerificationOverTimeImpl(1797L, 1797L, noMoreInteractions0, true, timer0);
      long long0 = verificationOverTimeImpl0.getPollingPeriod();
      assertEquals(1797L, long0);
      assertEquals(1797L, verificationOverTimeImpl0.getDuration());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      After after0 = new After(1516L, 1436L, atMost0);
      Timer timer0 = new Timer(0L);
      VerificationOverTimeImpl verificationOverTimeImpl0 = new VerificationOverTimeImpl((-420L), 1436L, after0, true, timer0);
      long long0 = verificationOverTimeImpl0.getDuration();
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(1797L, verificationOverTimeImpl0.getDuration());
      assertEquals(1797L, verificationOverTimeImpl0.getPollingPeriod());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      AtMost atMost0 = new AtMost(0);
      VerificationOverTimeImpl verificationOverTimeImpl0 = new VerificationOverTimeImpl(1277L, 1277L, atMost0, false, (Timer) null);
  ...
  public void test07()  throws Throwable  {
      VerificationOverTimeImpl verificationOverTimeImpl0 = new VerificationOverTimeImpl((-4048L), (-4048L), (VerificationMode) null, false);
      boolean boolean0 = verificationOverTimeImpl0.canRecoverFromFailure((VerificationMode) null);
      assertTrue(boolean0);
      assertEquals((-4048L), verificationOverTimeImpl0.getPollingPeriod());
      assertEquals((-4048L), verificationOverTimeImpl0.getDuration());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      AtMost atMost0 = new AtMost(0);
      VerificationOverTimeImpl verificationOverTimeImpl0 = new VerificationOverTimeImpl((-72L), (-72L), atMost0, false);
      boolean boolean0 = verificationOverTimeImpl0.canRecoverFromFailure(atMost0);
      assertEquals((-72L), verificationOverTimeImpl0.getDuration());
      assertEquals((-72L), verificationOverTimeImpl0.getPollingPeriod());
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      AtMost atMost0 = new AtMost(229);
      Timeout timeout0 = new Timeout((-128L), atMost0);
      Timer timer0 = new Timer(2220L);
      VerificationOverTimeImpl verificationOverTimeImpl0 = new VerificationOverTimeImpl((-2391L), 0L, timeout0, false, timer0);
