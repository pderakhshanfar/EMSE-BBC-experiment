...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver((NamespaceResolver) null);
      QName qName0 = new QName("=3HBRJuT(I9|p^$S\"}", "");
      ...
      namespaceResolver0.registerNamespace("", "=3HBRJuT(I9|p^$S\"}");
      String string0 = namespaceResolver0.getPrefix("=3HBRJuT(I9|p^$S\"}");
  ...
  public void test04()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver((NamespaceResolver) null);
      QName qName0 = new QName("oSUdAB)`[-5Kk`");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        namespaceResolver0.registerNamespace("x:aU }", "");
  ...
  public void test06()  throws Throwable  {
      ...
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      HashMap<List<List<String>>, AbstractMap.SimpleImmutableEntry<Object, Object>> hashMap0 = new HashMap<List<List<String>>, AbstractMap.SimpleImmutableEntry<Object, Object>>();
      LinkedList<List<String>> linkedList0 = new LinkedList<List<String>>();
      AbstractMap.SimpleImmutableEntry<Object, Object> abstractMap_SimpleImmutableEntry0 = new AbstractMap.SimpleImmutableEntry<Object, Object>(hashMap0, namespaceResolver0);
  ...
  public void test10()  throws Throwable  {
      ...
      namespaceResolver0.namespaceMap = hashMap0;
      AbstractMap.SimpleEntry<NamespaceResolver, String> abstractMap_SimpleEntry0 = new AbstractMap.SimpleEntry<NamespaceResolver, String>((NamespaceResolver) null, "=3HBRJuT(I9|p^$S\"}");
      hashMap0.put("=3HBRJuT(I9|p^$S\"}", abstractMap_SimpleEntry0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getNamespaceURI("=3HBRJuT(I9|p^$S\"}");
        fail("Expecting exception: ClassCastException");
  ...
  public void test13()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      QName qName0 = new QName("vpt", "@T+b$X5tl8%S.:8M");
  ...
  public void test14()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver((NamespaceResolver) null);
      namespaceResolver0.registerNamespace("vtW", "");
      QName qName0 = new QName("UlvZ\"xzJq");
  ...
  public void test15()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver((NamespaceResolver) null);
      namespaceResolver0.registerNamespace("V`klA}}y]XS.4Kf", "UlvZ\"xzJq");
      QName qName0 = new QName("UlvZ\"xzJq");
      Locale locale0 = Locale.JAPANESE;
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, namespaceResolver0, locale0);
      namespaceResolver0.setNamespaceContextPointer(nodePointer0);
  ...
  public void test16()  throws Throwable  {
      ...
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      String string0 = namespaceResolver0.getNamespaceURI("=3HBRJuT(I9|p^$S\"}");
      assertNull(string0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("processing-instruction('", (String) null);
  ...
  public void test20()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver((NamespaceResolver) null);
      namespaceResolver0.registerNamespace("V`klA}}y]XS.4Kf", "UlvZ\"xzJq");
      String string0 = namespaceResolver0.getNamespaceURI("V`klA}}y]XS.4Kf");
      assertEquals("UlvZ\"xzJq", string0);
      assertNotNull(string0);
  }
