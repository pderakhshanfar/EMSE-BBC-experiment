...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      namespaceResolver0.registerNamespace(">* P7zbL^09wI4F", "");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      String string0 = namespaceResolver0.getPrefix("");
      assertNotNull(string0);
      assertEquals(">* P7zbL^09wI4F", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("p;{9dnZK n9#XV(viK", "p;{9dnZK n9#XV(viK");
      String string0 = namespaceResolver0.getNamespaceURI("p;{9dnZK n9#XV(viK");
      assertEquals("p;{9dnZK n9#XV(viK", string0);
  }
  ...
  public void test07()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName(".&d9@wP-zjzR", (String) null);
      ...
      namespaceResolver0.namespaceMap = hashMap0;
      hashMap0.put((AbstractMap.SimpleEntry<NamespaceResolver, Integer>) null, (Integer) nodePointer0.WHOLE_COLLECTION);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName(")/,Iv~!0f,lT", (String) null);
      Locale locale0 = Locale.ITALY;
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      ...
      // Undeclared exception!
      try { 
        namespaceResolver1.getPrefix(", operation is not allowed for this type of node");
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("*", "p;{9dnZK n9#XV(viK");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
