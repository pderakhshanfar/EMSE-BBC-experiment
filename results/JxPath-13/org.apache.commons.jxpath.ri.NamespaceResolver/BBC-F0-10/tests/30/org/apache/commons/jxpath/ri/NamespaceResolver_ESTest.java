...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("", "J<H<ZQziUCBYHQ");
      QName qName0 = new QName("processing-instruction");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      String string0 = namespaceResolver0.getPrefix("J<H<ZQziUCBYHQ");
  ...
  public void test03()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("O1/z@?>}V@0NEO[\"", "O1/z@?>}V@0NEO[\"");
      String string0 = namespaceResolver0.getNamespaceURI("O1/z@?>}V@0NEO[\"");
      assertNotNull(string0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("@LA$W^95*3l,xC", "@LA$W^95*3l,xC");
        fail("Expecting exception: NullPointerException");
  ...
  public void test06()  throws Throwable  {
      ...
      hashMap0.put("HJp", integer0);
      namespaceResolver0.reverseMap = hashMap0;
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("HJp");
  ...
  public void test13()  throws Throwable  {
      ...
      Variables variables0 = jXPathContext0.getVariables();
      QName qName0 = new QName("YQ#", "Cannot register namespaces on a sealed NamespaceResolver");
      VariablePointer variablePointer0 = new VariablePointer(variables0, qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("4eJT26Hz!=j`", "qP[7zy(3U}#IKkQM");
  ...
  public void test19()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("P{3", "P{3");
      QName qName0 = new QName("P{3");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      String string0 = namespaceResolver0.getPrefix("P{3");
      assertEquals("P{3", string0);
  }
