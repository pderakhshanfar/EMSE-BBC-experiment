...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      QName qName0 = new QName("kP,^w:W+]8;", "kP,^w:W+]8;");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      String string0 = namespaceResolver0.getNamespaceURI("kP,^w:W+]8;");
      assertNull(string0);
  }
  ...
  public void test02()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("s~01Gd@2EVrj*la");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      namespaceResolver0.registerNamespace("EXQK%)nz6A^&p", (String) null);
      String string0 = namespaceResolver0.getPrefix((String) null);
      assertEquals("EXQK%)nz6A^&p", string0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        namespaceResolver0.registerNamespace("_^RW_MiP", "_^RW_MiP");
  ...
  public void test05()  throws Throwable  {
      ...
      QName qName0 = new QName(" qyELdet-z5x", " qyELdet-z5x");
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // No such variable: ' qyELdet-z5x: qyELdet-z5x'
         //
  ...
  public void test06()  throws Throwable  {
      ...
      AbstractMap.SimpleEntry<String, String> abstractMap_SimpleEntry0 = new AbstractMap.SimpleEntry<String, String>("<<unknown namespace>>", "<<unknown namespace>>");
      hashMap0.put("rc1", abstractMap_SimpleEntry0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("rc1");
  ...
  public void test07()  throws Throwable  {
      ...
      hashMap0.put("1D^9OxmT/", integer0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getNamespaceURI("1D^9OxmT/");
        fail("Expecting exception: ClassCastException");
  ...
  public void test10()  throws Throwable  {
      ...
      String string0 = jXPathContext1.getPrefix(":(-YH#fRuFrn&^Q");
      assertNull(string0);
  }
  ...
  public void test14()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      String string0 = namespaceResolver1.getNamespaceURI("comment");
      assertNull(string0);
  }
