...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        namespaceResolver0.registerNamespace("vYDE", "");
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("P8AxQ'dh9?)059(J");
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("L`D1c)O\">K");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No such variable: '\"self::\":\"self::\"'
         //
  ...
  public void test08()  throws Throwable  {
      ...
      HashMap<String, Object> hashMap0 = new HashMap<String, Object>();
      namespaceResolver0.reverseMap = hashMap0;
      hashMap0.put("Z}tEnHjGaJ=j^}k", namespaceResolver0.namespaceMap);
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("Z}tEnHjGaJ=j^}k");
  ...
  public void test10()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      HashMap<String, AbstractMap.SimpleEntry<Integer, Locale>> hashMap0 = new HashMap<String, AbstractMap.SimpleEntry<Integer, Locale>>(60, 60);
      namespaceResolver0.namespaceMap = hashMap0;
      Locale locale0 = Locale.forLanguageTag("");
      AbstractMap.SimpleImmutableEntry<Integer, Locale> abstractMap_SimpleImmutableEntry0 = new AbstractMap.SimpleImmutableEntry<Integer, Locale>((Integer) null, locale0);
      AbstractMap.SimpleEntry<Integer, Locale> abstractMap_SimpleEntry0 = new AbstractMap.SimpleEntry<Integer, Locale>(abstractMap_SimpleImmutableEntry0);
      hashMap0.put("L_V%{", abstractMap_SimpleEntry0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getNamespaceURI("L_V%{");
        fail("Expecting exception: ClassCastException");
  ...
  public void test13()  throws Throwable  {
      ...
      JXPathContext jXPathContext1 = JXPathContext.newContext(jXPathContext0, (Object) "node");
      String string0 = jXPathContext1.getPrefix("name");
      assertNull(string0);
  }
  ...
  public void test15()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      String string0 = namespaceResolver1.getNamespaceURI("L_V%{");
      assertNull(string0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, locale0, locale0);
      namespaceResolver0.pointer = nodePointer0;
      String string0 = namespaceResolver0.getNamespaceURI("L_V%{");
      assertNull(string0);
  }
  ...
  public void test21()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("b!iJG0oi", "QB");
      QName qName0 = new QName("QB");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      String string0 = namespaceResolver0.getPrefix("QB");
      assertEquals("b!iJG0oi", string0);
      assertNotNull(string0);
  }
