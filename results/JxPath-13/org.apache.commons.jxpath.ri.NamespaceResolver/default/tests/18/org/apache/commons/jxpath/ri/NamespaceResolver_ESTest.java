...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace(" g1r", " g1r");
      String string0 = namespaceResolver0.getNamespaceURI(" g1r");
      assertEquals(" g1r", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      QName qName0 = new QName("48/?Iqb{Fhe{B", "48/?Iqb{Fhe{B");
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
      namespaceResolver0.pointer = (NodePointer) variablePointer0;
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("48/?Iqb{Fhe{B");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No such variable: '48/?Iqb{Fhe{B:48/?Iqb{Fhe{B'
         //
  ...
  public void test11()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("org.apache.commons.jxpath.ri.axes.NodeSetContext", "B^r-gznJ7hcQWyYZt");
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver1.pointer = (NodePointer) variablePointer0;
      // Undeclared exception!
      try { 
        namespaceResolver1.getPrefix("org.apache.commons.jxpath.ri.axes.NodeSetContext");
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("[Element: <", "[Element: <");
