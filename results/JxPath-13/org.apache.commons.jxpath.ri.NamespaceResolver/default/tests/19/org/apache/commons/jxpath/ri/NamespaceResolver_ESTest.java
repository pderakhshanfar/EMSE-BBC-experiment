...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("(A)`umU3Bb;^/'v&z", "");
      String string0 = namespaceResolver0.getNamespaceURI("(A)`umU3Bb;^/'v&z");
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        namespaceResolver0.registerNamespace("h5802!u=rx", "h5802!u=rx");
  ...
  public void test04()  throws Throwable  {
      ...
      QName qName0 = new QName("'(TX5WIO|x", "'(TX5WIO|x");
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("'(TX5WIO|x");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No such variable: ''(TX5WIO|x:'(TX5WIO|x'
         //
  ...
  public void test05()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      HashMap<Locale, List<Locale.LanguageRange>> hashMap0 = new HashMap<Locale, List<Locale.LanguageRange>>();
      namespaceResolver0.reverseMap = hashMap0;
      LinkedList<Locale.LanguageRange> linkedList0 = new LinkedList<Locale.LanguageRange>();
      hashMap0.put((Locale) null, linkedList0);
      // Undeclared exception!
      try { 
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.getNamespaceURI("eNG#nHshyu<N&%o");
        fail("Expecting exception: NullPointerException");
  ...
  public void test12()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("comment", "comment");
      namespaceResolver0.registerNamespace("o=-D+Prpl", "o=-D+Prpl");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
  ...
  public void test13()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      String string0 = namespaceResolver1.getNamespaceURI("y)_(w~.Z2P");
      assertNull(string0);
  }
  ...
  public void test15()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("2_Zgz?eucN1", "I");
      String string0 = namespaceResolver0.getNamespaceURI("2_Zgz?eucN1");
      assertNotNull(string0);
  ...
  public void test18()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      BasicVariables basicVariables0 = new BasicVariables();
      QName qName0 = new QName("2_Zgz?eucN1");
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("=DDI\"bxUd", "=DDI\"bxUd");
