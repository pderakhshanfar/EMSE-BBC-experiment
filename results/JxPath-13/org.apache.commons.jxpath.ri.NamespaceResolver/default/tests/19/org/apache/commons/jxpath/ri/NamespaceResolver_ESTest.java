...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("|Mtl/%; jo|*\"N,qAl.");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.pointer = (NodePointer) variablePointer0;
      namespaceResolver0.registerNamespace("", "|Mtl/%; jo|*\"N,qAl.");
      String string0 = namespaceResolver0.getPrefix("|Mtl/%; jo|*\"N,qAl.");
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.getNamespaceURI("\"last\"");
        fail("Expecting exception: NullPointerException");
  ...
  public void test08()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      HashMap<NamespaceResolver, AbstractMap.SimpleImmutableEntry<String, Locale>> hashMap0 = new HashMap<NamespaceResolver, AbstractMap.SimpleImmutableEntry<String, Locale>>();
      namespaceResolver1.reverseMap = hashMap0;
      // Undeclared exception!
      try { 
        namespaceResolver1.getPrefix("Was expecting one of:");
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      ...
      namespaceResolver0.pointer = (NodePointer) variablePointer0;
      namespaceResolver0.registerNamespace("Cannot register namespaces on a sealed NamespaceResolver", "");
      String string0 = namespaceResolver0.getPrefix("`%:is~G/</cIkxK");
      assertNull(string0);
  }
  ...
  public void test11()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      String string0 = namespaceResolver1.getNamespaceURI("ohDmBC!T,[)g4");
      assertNull(string0);
  }
  ...
  public void test12()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("|Mtl/%; jo|*\"N,qAl.", "|Mtl/%; jo|*\"N,qAl.");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.pointer = (NodePointer) variablePointer0;
