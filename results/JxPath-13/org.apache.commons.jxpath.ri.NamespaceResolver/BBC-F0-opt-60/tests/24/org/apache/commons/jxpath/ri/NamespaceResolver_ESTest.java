...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("k0-(CH|x4E", "jRv");
      QName qName0 = new QName("jRv");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      String string0 = namespaceResolver0.getPrefix("jRv");
      assertEquals("k0-(CH|x4E", string0);
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        namespaceResolver0.registerNamespace("jRv", "jRv");
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("Y&zU\"a'&kc");
  ...
  public void test10()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("Si^s`YqbShLC:\"G");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      namespaceResolver1.setNamespaceContextPointer(variablePointer0);
      // Undeclared exception!
      try { 
        namespaceResolver1.getPrefix("g7#b");
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      ...
      QName qName0 = new QName("Si^s`YqbShLC:\"G");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      NodePointer nodePointer0 = NodePointer.newChildNodePointer(variablePointer0, qName0, "Cannot register namespaces on a sealed NamespaceResolver");
  ...
  public void test15()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("_rF", "_rF");
      String string0 = namespaceResolver0.getNamespaceURI("_rF");
      assertEquals("_rF", string0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("", "R+.3iZ# ");
