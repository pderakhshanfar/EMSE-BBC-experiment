...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        namespaceResolver0.registerNamespace(" could not create an object for path: ", "");
  ...
  public void test04()  throws Throwable  {
      ...
      QName qName0 = new QName("Rq3", "not");
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("[8?Y!e!MO=ZposL");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No such variable: 'Rq3:not'
         //
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("6?/OUGg#=Q@1R7JQS`", (String) null);
  ...
  public void test20()  throws Throwable  {
      ...
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      namespaceResolver0.registerNamespace("qVs}UaMY-CK{<E|By7r", (String) null);
      String string0 = namespaceResolver0.getPrefix((String) null);
      assertEquals("qVs}UaMY-CK{<E|By7r", string0);
  }
