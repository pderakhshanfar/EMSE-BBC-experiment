...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      QName qName0 = new QName("{o>E(]n\"cp`X_&KMC16", "{o>E(]n\"cp`X_&KMC16");
  ...
  public void test02()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("'=x'", "");
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        namespaceResolver0.registerNamespace((String) null, "-K@UY)");
  ...
  public void test05()  throws Throwable  {
      ...
      QName qName0 = new QName("sw]j>jI<R", "sw]j>jI<R");
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // No such variable: 'sw]j>jI<R:sw]j>jI<R'
         //
  ...
  public void test08()  throws Throwable  {
      ...
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      HashMap<AbstractMap.SimpleImmutableEntry<Object, Object>, NamespaceResolver> hashMap0 = new HashMap<AbstractMap.SimpleImmutableEntry<Object, Object>, NamespaceResolver>();
      namespaceResolver1.reverseMap = hashMap0;
      // Undeclared exception!
      try { 
        namespaceResolver1.getPrefix("kfvG.yI");
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      ...
      namespaceResolver0.pointer = (NodePointer) variablePointer0;
      namespaceResolver0.registerNamespace("-K@UY)", ".*");
      String string0 = namespaceResolver0.getPrefix(".*");
      assertNotNull(string0);
      assertEquals("-K@UY)", string0);
  }
  ...
  public void test11()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      String string0 = namespaceResolver1.getNamespaceURI("q.");
      assertNull(string0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
      namespaceResolver0.pointer = (NodePointer) variablePointer0;
      String string0 = namespaceResolver0.getNamespaceURI("p#a8fw");
      assertNull(string0);
  }
  ...
  public void test13()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("<<unknown namespace>>", "/8mAz|qth3f{V97;l$");
      String string0 = namespaceResolver0.getNamespaceURI("<<unknown namespace>>");
      assertEquals("/8mAz|qth3f{V97;l$", string0);
      assertNotNull(string0);
  }
