...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace(".ivh8hyLu8#l_", "&dr!7Au+-o=-O7 ");
      String string0 = namespaceResolver0.getNamespaceURI(".ivh8hyLu8#l_");
      assertEquals("&dr!7Au+-o=-O7 ", string0);
      assertNotNull(string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      hashMap0.put("EaUf~g]3B-G5wC\u0006", namespaceResolver0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("EaUf~g]3B-G5wC\u0006");
  ...
  public void test12()  throws Throwable  {
      ...
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      namespaceResolver0.registerNamespace("t", (String) null);
  ...
  public void test14()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      String string0 = namespaceResolver1.getNamespaceURI(" to_");
      assertNull(string0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("RsD;#c(s9vrfl`<v", "]WNt^gP859PK).vSx");
  ...
  public void test18()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace(".`pOjPy3 XP`J?", "");
      String string0 = namespaceResolver0.getNamespaceURI(".`pOjPy3 XP`J?");
      assertEquals("", string0);
      assertNotNull(string0);
  }
  ...
  public void test19()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("VcQ%FzRS6R'6;g)");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      Pointer pointer0 = namespaceResolver0.getNamespaceContextPointer();
