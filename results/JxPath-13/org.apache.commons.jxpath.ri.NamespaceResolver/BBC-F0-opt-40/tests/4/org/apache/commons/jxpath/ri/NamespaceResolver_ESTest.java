...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("<<unknown namespace>>", "hh,d2_i~h\"7");
      String string0 = namespaceResolver0.getNamespaceURI("<<unknown namespace>>");
      assertEquals("hh,d2_i~h\"7", string0);
  ...
  public void test04()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      HashMap<List<String>, AbstractMap.SimpleImmutableEntry<Object, List<String>>> hashMap0 = new HashMap<List<String>, AbstractMap.SimpleImmutableEntry<Object, List<String>>>();
      ...
      AbstractMap.SimpleImmutableEntry<Object, List<String>> abstractMap_SimpleImmutableEntry0 = new AbstractMap.SimpleImmutableEntry<Object, List<String>>(namespaceResolver0.namespaceMap, list0);
      hashMap0.put(list0, abstractMap_SimpleImmutableEntry0);
  ...
  public void test05()  throws Throwable  {
      ...
      QName qName0 = new QName("hh,d2_i~y", "IlfO]d");
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("IlfO]d");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No such variable: 'hh,d2_i~y:IlfO]d'
         //
  ...
  public void test09()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      BasicVariables basicVariables0 = new BasicVariables();
      QName qName0 = new QName("hh,d2_i~h\"7", "IlfO]d");
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
  ...
  public void test10()  throws Throwable  {
      ...
      NodePointer nodePointer0 = NodePointer.newChildNodePointer(variablePointer0, qName0, "");
      namespaceResolver0.setNamespaceContextPointer(nodePointer0);
      String string0 = namespaceResolver0.getPrefix("g6eY`#5B");
      assertNull(string0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      String string0 = namespaceResolver0.getNamespaceURI("IlfO]d");
      assertNull(string0);
  }
