...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("TUIMUfK(`>", "TUIMUfK(`>");
      String string0 = namespaceResolver0.getNamespaceURI("TUIMUfK(`>");
      assertEquals("TUIMUfK(`>", string0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      QName qName0 = new QName("o`Z5Qi hy5kJrD", "Cannot register namespaces on a sealed NamespaceResolver");
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
      namespaceResolver0.pointer = (NodePointer) variablePointer0;
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("R0cV4WyOmfPqZaR");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No such variable: 'o`Z5Qi hy5kJrD:Cannot register namespaces on a sealed NamespaceResolver'
         //
  ...
  public void test05()  throws Throwable  {
      ...
      hashMap0.put("Cannot register namespaces on a sealed NamespaceResolver", (Integer) nodePointer0.WHOLE_COLLECTION);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver2.getPrefix("Cannot register namespaces on a sealed NamespaceResolver");
        fail("Expecting exception: NullPointerException");
  ...
  public void test12()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("B)a{t*\tP#{GeC");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      namespaceResolver0.getPrefix("^UhZx8PH:t=");
  ...
  public void test14()  throws Throwable  {
      ...
      VariablePointer variablePointer0 = new VariablePointer((QName) null);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      String string0 = namespaceResolver0.getNamespaceURI("Wx|}u=vkDcKwkXs");
      assertNull(string0);
  }
