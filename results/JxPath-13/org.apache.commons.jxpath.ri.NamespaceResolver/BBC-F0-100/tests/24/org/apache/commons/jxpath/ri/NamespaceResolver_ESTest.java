...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("Hn", "Hn");
      String string0 = namespaceResolver0.getNamespaceURI("Hn");
  ...
  public void test04()  throws Throwable  {
      ...
      QName qName0 = new QName("Pav=^}uBH{8k]uz:j", "Pav=^}uBH{8k]uz:j");
      VariablePointer variablePointer0 = new VariablePointer(variables0, qName0);
      namespaceResolver0.pointer = (NodePointer) variablePointer0;
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("Index: ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No such variable: 'Pav=^}uBH{8k]uz:j:Pav=^}uBH{8k]uz:j'
         //
  ...
  public void test05()  throws Throwable  {
      ...
      hashMap0.put("GFR>H/j@gLoL", namespaceResolver0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("GFR>H/j@gLoL");
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.getNamespaceURI("6y$`<nt^di");
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      HashMap<Object, AbstractMap.SimpleEntry<NamespaceResolver, Integer>> hashMap0 = new HashMap<Object, AbstractMap.SimpleEntry<NamespaceResolver, Integer>>();
      AbstractMap.SimpleEntry<NamespaceResolver, Integer> abstractMap_SimpleEntry0 = new AbstractMap.SimpleEntry<NamespaceResolver, Integer>(namespaceResolver0, (Integer) Integer.MIN_VALUE);
  ...
  public void test13()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      String string0 = namespaceResolver1.getNamespaceURI("Hn");
      assertNull(string0);
  }
  ...
  public void test15()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("Hn", "");
      String string0 = namespaceResolver0.getNamespaceURI("Hn");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("WSW", "");
  ...
  public void test20()  throws Throwable  {
      ...
      VariablePointer variablePointer0 = new VariablePointer((QName) null);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      String string0 = namespaceResolver0.getNamespaceURI("org.jdom.Element");
      assertNull(string0);
  }
