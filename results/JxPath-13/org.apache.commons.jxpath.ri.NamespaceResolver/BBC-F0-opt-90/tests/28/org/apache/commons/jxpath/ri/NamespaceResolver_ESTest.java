...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      hashMap0.put("{0mU''kD#C>)", nodePointer0.WHOLE_COLLECTION);
      // Undeclared exception!
      try { 
        namespaceResolver1.getPrefix("{0mU''kD#C>)");
  ...
  public void test10()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      HashMap<AbstractMap.SimpleImmutableEntry<Object, String>, AbstractMap.SimpleImmutableEntry<String, Integer>> hashMap0 = new HashMap<AbstractMap.SimpleImmutableEntry<Object, String>, AbstractMap.SimpleImmutableEntry<String, Integer>>();
      namespaceResolver1.reverseMap = hashMap0;
      // Undeclared exception!
      try { 
        namespaceResolver1.getPrefix("npB^j");
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("Factory is not set on the JXPathContext - cannot create path: ", "");
  ...
  public void test13()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      String string0 = namespaceResolver1.getNamespaceURI(" Vy-S");
      assertNull(string0);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      QName qName0 = new QName("2i/L0b-k+M>,Y5");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      NamespaceResolver namespaceResolver0 = new NamespaceResolver((NamespaceResolver) null);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      String string0 = namespaceResolver0.getNamespaceURI("2i/L0b-k+M>,Y5");
      assertNull(string0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("@][,{<yJEq)Mn-vw", "");
  ...
  public void test19()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("u;]{S-t|0T,P", "Factory is not set on the JXPathContext - cannot create path: ");
      String string0 = namespaceResolver0.getNamespaceURI("u;]{S-t|0T,P");
      assertEquals("Factory is not set on the JXPathContext - cannot create path: ", string0);
      assertNotNull(string0);
  }
