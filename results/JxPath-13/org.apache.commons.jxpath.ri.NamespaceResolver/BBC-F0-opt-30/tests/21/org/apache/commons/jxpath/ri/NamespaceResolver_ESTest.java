...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("/P5UxlJ_J", "/P5UxlJ_J");
      String string0 = namespaceResolver0.getNamespaceURI("/P5UxlJ_J");
      assertEquals("/P5UxlJ_J", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      QName qName0 = new QName("`j+RU,\"`ft+IBP", "");
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("i4wV5A)#.2;rYj5ogUc");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No such variable: '`j+RU,\"`ft+IBP:'
         //
  ...
  public void test10()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("iSjqZy,SVyh>\"");
      ...
      // Undeclared exception!
      try { 
        namespaceResolver1.getPrefix("/}x[i8mY!=oqe'");
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("/}x[i8mY!=oqe'", (String) null);
      QName qName0 = new QName("iSjqZy,SVyh>\"");
      Locale locale0 = Locale.FRANCE;
      ...
      assertEquals("/}x[i8mY!=oqe'", string0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, integer0, locale0);
      namespaceResolver0.setNamespaceContextPointer(nodePointer0);
      String string0 = namespaceResolver0.getPrefix("/}x[i8mY!=oqe'");
      assertNull(string0);
  }
  ...
  public void test14()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      String string0 = namespaceResolver0.getNamespaceURI("iVxEEF");
      assertNull(string0);
  }
  ...
  public void test15()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("I/C#S$", "");
      String string0 = namespaceResolver0.getNamespaceURI("I/C#S$");
      assertEquals("", string0);
  ...
  public void test18()  throws Throwable  {
      ...
      QName qName0 = new QName("qDH", (String) null);
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace((String) null, "Lv:zO4hE?`");
