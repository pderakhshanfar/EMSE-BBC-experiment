...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("1&<RQ&Z2EVPm#gE", "1&<RQ&Z2EVPm#gE");
      String string0 = namespaceResolver0.getNamespaceURI("1&<RQ&Z2EVPm#gE");
      assertEquals("1&<RQ&Z2EVPm#gE", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("|;;YP:+~+jFLHtV");
  ...
  public void test11()  throws Throwable  {
      QName qName0 = new QName("", "N[p\"rtSytCFCK%g");
  ...
  public void test12()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("`g-HZ]MB%![J", "`g-HZ]MB%![J");
      ...
      namespaceResolver0.registerNamespace("`P}!c%} Xx&", ";\"s,MqDtvH*w");
      String string0 = namespaceResolver0.getPrefix(";\"s,MqDtvH*w");
      assertNotNull(string0);
      assertEquals("`P}!c%} Xx&", string0);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("`g-HZ]MB%![J", "z>s`):UP^");
      QName qName0 = new QName("`g-HZ]MB%![J", "`g-HZ]MB%![J");
      Locale locale0 = Locale.US;
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, namespaceResolver0, locale0);
      namespaceResolver0.pointer = nodePointer0;
      String string0 = namespaceResolver0.getPrefix("`P}!c%} Xx&");
      assertNull(string0);
  }
  ...
  public void test14()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      String string0 = namespaceResolver1.getNamespaceURI("J`mM;vOK");
      assertNull(string0);
  }
  ...
  public void test15()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      String string0 = namespaceResolver0.getNamespaceURI("J`mM;vOK");
      assertNull(string0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("wS)og+", "wS)og+");
  ...
  public void test21()  throws Throwable  {
      ...
      QName qName0 = new QName("B|.[yz}pvn", "v@%L w8GiNV1&t,");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver1.pointer = (NodePointer) variablePointer0;
      String string0 = namespaceResolver1.getNamespaceURI(".5(RXPNHhL1V!}%.");
