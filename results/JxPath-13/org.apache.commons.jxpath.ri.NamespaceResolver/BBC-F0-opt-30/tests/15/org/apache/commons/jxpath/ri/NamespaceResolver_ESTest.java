...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        namespaceResolver1.getPrefix("KG3<>^KWR]T4@/O5E");
  ...
  public void test01()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      String string0 = namespaceResolver1.getNamespaceURI("~sQ]bMz4\")bjG!?pQ");
      assertNull(string0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      namespaceResolver0.registerNamespace("!Ei'VJsvMC%7Pj{G", "");
      String string0 = namespaceResolver0.getPrefix("");
      assertNotNull(string0);
      assertEquals("!Ei'VJsvMC%7Pj{G", string0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace((String) null, "teoX)]+CM@ve!yC=");
      String string0 = namespaceResolver0.getNamespaceURI((String) null);
      assertEquals("teoX)]+CM@ve!yC=", string0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver1.registerNamespace("zZ8gf", "Cannot register namespaces on a sealed NamespaceResolver");
        fail("Expecting exception: NullPointerException");
  ...
  public void test06()  throws Throwable  {
      ...
      QName qName0 = new QName("K`]618i87ao@s+j\"q", "K`]618i87ao@s+j\"q");
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix(" U'0I5+a97;`/[(P9b");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No such variable: 'K`]618i87ao@s+j\"q:K`]618i87ao@s+j\"q'
         //
  ...
  public void test07()  throws Throwable  {
      ...
      hashMap0.put("The Element cannot be added to itself", integer0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("The Element cannot be added to itself");
  ...
  public void test09()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      HashMap<Object, AbstractMap.SimpleImmutableEntry<NamespaceResolver, String>> hashMap0 = new HashMap<Object, AbstractMap.SimpleImmutableEntry<NamespaceResolver, String>>();
      namespaceResolver0.namespaceMap = hashMap0;
      AbstractMap.SimpleImmutableEntry<NamespaceResolver, String> abstractMap_SimpleImmutableEntry0 = new AbstractMap.SimpleImmutableEntry<NamespaceResolver, String>(namespaceResolver0, "b}}Zg^Qz_g/uT");
      hashMap0.put("b}}Zg^Qz_g/uT", abstractMap_SimpleImmutableEntry0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getNamespaceURI("b}}Zg^Qz_g/uT");
        fail("Expecting exception: ClassCastException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("O`-lg4fiRT[]}~Q", "");
