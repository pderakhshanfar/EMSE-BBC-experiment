...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("!izMU@xVJE");
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      namespaceResolver0.registerNamespace("!izMU@xVJE", "");
      String string0 = namespaceResolver0.getPrefix("");
      assertNotNull(string0);
      assertEquals("!izMU@xVJE", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("Factory did not assign a collection to variable '", "Cannot register namespaces on a sealed NamespaceResolver");
      String string0 = namespaceResolver0.getNamespaceURI("Factory did not assign a collection to variable '");
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        namespaceResolver0.registerNamespace("03~lhN;", (String) null);
  ...
  public void test04()  throws Throwable  {
      ...
      QName qName0 = new QName("ptCnbtWuZPS\u0006$n", "ptCnbtWuZPS\u0006$n");
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("ptCnbtWuZPS\u0006$n");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No such variable: 'ptCnbtWuZPS\u0006$n:ptCnbtWuZPS\u0006$n'
         //
  ...
  public void test05()  throws Throwable  {
      ...
      QName qName0 = new QName(" -[lhAPB|<Oa", " -[lhAPB|<Oa");
      Locale locale0 = new Locale("R*d`nw#0wf<OLo");
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, " -[lhAPB|<Oa", locale0);
      namespaceResolver0.setNamespaceContextPointer(nodePointer0);
      HashMap<Integer, String> hashMap0 = new HashMap<Integer, String>();
      namespaceResolver0.namespaceMap = hashMap0;
      hashMap0.put(integer0, " -[lhAPB|<Oa");
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix(" -[lhAPB|<Oa");
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.getNamespaceURI("!izMU@xVJE");
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver1.getPrefix("v");
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace("!izMU@xVJE", "");
      String string0 = namespaceResolver0.getNamespaceURI("!izMU@xVJE");
      assertNotNull(string0);
      assertEquals("", string0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, "2[(I", (Locale) null);
      namespaceResolver0.setNamespaceContextPointer(nodePointer0);
