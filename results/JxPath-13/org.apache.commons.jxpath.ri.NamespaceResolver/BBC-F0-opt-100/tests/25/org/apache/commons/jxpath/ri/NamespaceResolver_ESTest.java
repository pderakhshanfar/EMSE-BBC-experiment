...
public class NamespaceResolver_ESTest extends NamespaceResolver_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      QName qName0 = new QName("'aJzB!", (String) null);
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      String string0 = namespaceResolver0.getNamespaceURI("v`?m$k");
      assertNull(string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      QName qName0 = new QName("}2R,D");
      VariablePointer variablePointer0 = new VariablePointer(basicVariables0, qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getPrefix("}2R,D");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No such variable: '}2R,D'
         //
  ...
  public void test09()  throws Throwable  {
      ...
      HashMap<Object, NamespaceResolver> hashMap0 = new HashMap<Object, NamespaceResolver>();
      namespaceResolver0.namespaceMap = hashMap0;
      hashMap0.put("XBeanInfo", namespaceResolver0);
      // Undeclared exception!
      try { 
        namespaceResolver0.getNamespaceURI("XBeanInfo");
        fail("Expecting exception: ClassCastException");
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver1.getPrefix("rSB82bvr_V<eu@AIa-");
        fail("Expecting exception: NullPointerException");
  ...
  public void test13()  throws Throwable  {
      ...
      VariablePointer variablePointer0 = new VariablePointer(qName0);
      namespaceResolver0.setNamespaceContextPointer(variablePointer0);
      namespaceResolver0.registerNamespace(",^chLeRa+wi@x:m'", "");
      String string0 = namespaceResolver0.getPrefix("");
      assertNotNull(string0);
      assertEquals(",^chLeRa+wi@x:m'", string0);
  }
  ...
  public void test15()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      NamespaceResolver namespaceResolver1 = new NamespaceResolver(namespaceResolver0);
      String string0 = namespaceResolver1.getNamespaceURI("{U$r8^d&sx`NL/,'f0");
      assertNull(string0);
  }
  ...
  public void test16()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      namespaceResolver0.registerNamespace((String) null, "MC[yfS");
      String string0 = namespaceResolver0.getNamespaceURI((String) null);
      assertEquals("MC[yfS", string0);
  }
  ...
  public void test19()  throws Throwable  {
      NamespaceResolver namespaceResolver0 = new NamespaceResolver();
      QName qName0 = new QName("VAV4zZ8v");
      Locale locale0 = Locale.UK;
      NodePointer nodePointer0 = NodePointer.newNodePointer(qName0, "VAV4zZ8v", locale0);
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        namespaceResolver0.registerNamespace("{U$r8^d&sx`NL/,'f0", "=+'}yaP$");
