...
public class NumberUtils_ESTest extends NumberUtils_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      boolean boolean0 = NumberUtils.isNumber("0xa<m2(LrqC0d1(5?$k%");
      assertFalse(boolean0);
  }
  ...
  public void test017()  throws Throwable  {
      try { 
        NumberUtils.createNumber("`$h]4E:F");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // `$h]4E:F is not a valid number.
         //
  ...
  public void test094()  throws Throwable  {
      // Undeclared exception!
      try { 
        NumberUtils.createBigDecimal("Pi>B");
        fail("Expecting exception: NumberFormatException");
  ...
  public void test123()  throws Throwable  {
      boolean boolean0 = NumberUtils.isNumber("--}|`U-M=&V!(KqoF<W");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test124()  throws Throwable  {
      boolean boolean0 = NumberUtils.isNumber("47E7EA$2gO67,vi");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test125()  throws Throwable  {
      boolean boolean0 = NumberUtils.isNumber("0E+Ff");
      assertFalse(boolean0);
  }
  ...
  public void test170()  throws Throwable  {
      float[] floatArray0 = new float[8];
      floatArray0[1] = (-720.51F);
      float float0 = NumberUtils.min(floatArray0);
      assertEquals((-720.51F), float0, 0.01F);
  }
  ...
  public void test200()  throws Throwable  {
      try { 
        NumberUtils.createNumber(".qfl");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // .qfl is not a valid number.
         //
         verifyException("org.apache.commons.lang3.math.NumberUtils", e);
      }
  }
  ...
  public void test209()  throws Throwable  {
      try { 
        NumberUtils.createNumber("!T:=ecI+6nEgHbG7");
        fail("Expecting exception: NumberFormatException");
  ...
  public void test211()  throws Throwable  {
      try { 
        NumberUtils.createNumber("{f'B*-#.mH%EweP");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // {f'B*-#.mH%EweP is not a valid number.
         //
         verifyException("org.apache.commons.lang3.math.NumberUtils", e);
      }
  }
  ...
  public void test212()  throws Throwable  {
      try { 
        NumberUtils.createNumber(":t.,X6a,^TT6.<G$:t.");
        fail("Expecting exception: NumberFormatException");
