...
public class CharSequenceTranslator_ESTest extends CharSequenceTranslator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(1972, 1670);
  ...
  public void test01()  throws Throwable  {
      ...
      unicodeEscaper0.translate((CharSequence) charBuffer0, 664, (Writer) stringWriter0);
      assertEquals("\\u0000", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.below(1811);
  ...
  public void test05()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.below(1466);
      StringWriter stringWriter0 = new StringWriter(1466);
      stringWriter0.write(1627);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        unicodeEscaper0.translate((CharSequence) "663", 1670, (Writer) stringWriter0);
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        unicodeEscaper0.translate((CharSequence) null, (-1041), (Writer) stringWriter0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        unicodeEscaper0.translate((CharSequence) charBuffer0, (-2050), (Writer) null);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test10()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(1, 1670);
      CharBuffer charBuffer0 = CharBuffer.allocate(1670);
      StringWriter stringWriter0 = new StringWriter();
      String string0 = unicodeEscaper0.translate((CharSequence) charBuffer0);
      unicodeEscaper0.translate((CharSequence) charBuffer0, (Writer) stringWriter0);
      ...
      String string2 = numericEntityEscaper0.translate((CharSequence) string0);
  ...
  public void test13()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      String string0 = CharSequenceTranslator.hex(1635);
      UnicodeEscaper unicodeEscaper0 = new UnicodeEscaper();
      unicodeEscaper0.translate((CharSequence) string0, (Writer) stringWriter0);
  ...
  public void test16()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(1666, 1634);
