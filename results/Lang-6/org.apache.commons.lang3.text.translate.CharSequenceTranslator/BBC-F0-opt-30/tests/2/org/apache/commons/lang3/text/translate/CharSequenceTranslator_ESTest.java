...
public class CharSequenceTranslator_ESTest extends CharSequenceTranslator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(3092, 3092);
      StringWriter stringWriter0 = new StringWriter(43);
      unicodeEscaper0.translate(3092, (Writer) stringWriter0);
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      octalUnescaper0.translate((CharSequence) stringBuffer0, 0, (Writer) stringWriter0);
      assertEquals("\\u0C14", stringBuffer0.toString());
      assertEquals("\\u0C14", stringWriter0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.below(2628);
  ...
  public void test05()  throws Throwable  {
      ...
      charBuffer0.compact();
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.below(1175);
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        unicodeUnescaper0.translate((CharSequence) "1", 1, (Writer) stringWriter0);
  ...
  public void test10()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = new NumericEntityEscaper();
      CharBuffer charBuffer0 = CharBuffer.allocate(6759);
      // Undeclared exception!
  ...
  public void test12()  throws Throwable  {
      ...
      AggregateTranslator aggregateTranslator0 = new AggregateTranslator(charSequenceTranslatorArray0);
      CharBuffer charBuffer0 = CharBuffer.allocate(4965);
      CharBuffer charBuffer1 = CharBuffer.wrap((CharSequence) charBuffer0);
      charBuffer0.get();
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      StringWriter stringWriter0 = new StringWriter();
      numericEntityEscaper0.translate((-7), (Writer) stringWriter0);
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals("\\u0C14\\u0C14", stringBuffer0.toString());
      assertEquals("\\u0C14\\u0C14", stringWriter0.toString());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        charSequenceTranslator0.translate((CharSequence) "&#70;&#70;&#70;&#70;&#70;&#70;&#70;&#57;", (Writer) stringWriter0);
        fail("Expecting exception: NullPointerException");
