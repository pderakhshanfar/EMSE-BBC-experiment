...
public class CharSequenceTranslator_ESTest extends CharSequenceTranslator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between((-2364), Integer.MAX_VALUE);
  ...
  public void test01()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.below((-2548));
      StringWriter stringWriter0 = new StringWriter();
      int int0 = unicodeEscaper0.translate((CharSequence) "FFFFF60C", 0, (Writer) stringWriter0);
      assertEquals(0, int0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      StringWriter stringWriter0 = new StringWriter();
      unicodeEscaper0.translate((CharSequence) "FFFFF60C", 0, (Writer) stringWriter0);
  ...
  public void test04()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.above(3600);
  ...
  public void test05()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.below(2068);
      StringWriter stringWriter0 = new StringWriter();
      // Undeclared exception!
      try { 
        numericEntityEscaper0.translate((CharSequence) "84A", 2122, (Writer) stringWriter0);
  ...
  public void test06()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.below(3295);
      StringWriter stringWriter0 = new StringWriter();
      // Undeclared exception!
      try { 
        numericEntityEscaper0.translate((CharSequence) null, 3295, (Writer) stringWriter0);
  ...
  public void test07()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.outsideOf((-1881), (-1881));
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "256");
      // Undeclared exception!
      try { 
        numericEntityEscaper0.translate((CharSequence) charBuffer0, 1734, (Writer) stringWriter0);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        aggregateTranslator0.translate((CharSequence) "FFFFFD68");
        fail("Expecting exception: NullPointerException");
  ...
  public void test13()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.above(5068);
      CharBuffer charBuffer0 = CharBuffer.allocate(5068);
      StringWriter stringWriter0 = new StringWriter();
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        numericEntityEscaper0.translate((CharSequence) "z", (Writer) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      String string0 = CharSequenceTranslator.hex((-2548));
      assertEquals("FFFFF60C", string0);
  }
}
