...
public class CharSequenceTranslator_ESTest extends CharSequenceTranslator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CharBuffer charBuffer0 = CharBuffer.allocate(3011);
      StringWriter stringWriter0 = new StringWriter(1661);
      int int0 = octalUnescaper0.translate((CharSequence) charBuffer0, 97, (Writer) stringWriter0);
      assertEquals(0, int0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      unicodeEscaper0.translate((CharSequence) "k", 0, (Writer) stringWriter0);
  ...
  public void test05()  throws Throwable  {
      OctalUnescaper octalUnescaper0 = new OctalUnescaper();
      CharBuffer charBuffer0 = CharBuffer.allocate(3034);
      CharBuffer charBuffer1 = CharBuffer.wrap((CharSequence) charBuffer0);
      charBuffer0.position(3034);
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        unicodeUnescaper0.translate((CharSequence) "467", 1127, (Writer) stringWriter0);
  ...
  public void test07()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.below((-2631));
      StringWriter stringWriter0 = new StringWriter(58);
      // Undeclared exception!
      try { 
        numericEntityEscaper0.translate((CharSequence) null, (-2631), (Writer) stringWriter0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test08()  throws Throwable  {
      ...
      StringWriter stringWriter0 = new StringWriter();
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.above(750);
      // Undeclared exception!
      try { 
        numericEntityEscaper0.translate((CharSequence) charBuffer0, 62, (Writer) stringWriter0);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test11()  throws Throwable  {
      ...
      StringWriter stringWriter0 = new StringWriter();
      numericEntityUnescaper0.translate((CharSequence) "FFFFFA28", (Writer) stringWriter0);
      assertEquals("FFFFFA28", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf(255, 255);
      StringWriter stringWriter0 = new StringWriter();
      unicodeEscaper0.translate((CharSequence) "*Bl~}`0G", (Writer) stringWriter0);
      assertEquals("\\u002A\\u0042\\u006C\\u007E\\u007D\\u0060\\u0030\\u0047", stringWriter0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        aggregateTranslator0.translate((CharSequence) "2D", (Writer) stringWriter0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        octalUnescaper0.translate((CharSequence) "FFFFF6B7", (Writer) null);
  ...
  public void test19()  throws Throwable  {
      String string0 = CharSequenceTranslator.hex(45);
