...
public class CharSequenceTranslator_ESTest extends CharSequenceTranslator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      unicodeEscaper0.translate((CharSequence) "1FC", (Writer) stringWriter0);
      assertEquals("1FC", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between((-184), 4095);
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      stringWriter0.append('|');
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) stringBuffer0);
      unicodeEscaper0.translate((CharSequence) charBuffer0, (Writer) stringWriter0);
      UnicodeEscaper unicodeEscaper1 = UnicodeEscaper.above(4095);
      unicodeEscaper1.translate((CharSequence) stringBuffer0, 2, (Writer) stringWriter0);
  ...
  public void test02()  throws Throwable  {
      ...
      unicodeEscaper0.translate((CharSequence) "FFFFFE74", 1, (Writer) stringWriter0);
      assertEquals("\\u0046", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.below(1019);
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        aggregateTranslator0.translate((CharSequence) "4C", (Writer) stringWriter0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf(54, 54);
  ...
  public void test08()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.above((-44));
      // Undeclared exception!
      try { 
        numericEntityEscaper0.translate((CharSequence) "mm", (-2029), (Writer) stringWriter0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        unicodeEscaper0.translate((CharSequence) charBuffer0, 2892, (Writer) stringWriter0);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        aggregateTranslator0.translate((CharSequence) "19D4");
        fail("Expecting exception: NullPointerException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        numericEntityUnescaper0.translate((CharSequence) string0, (Writer) null);
  ...
  public void test16()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.below((-3828));
