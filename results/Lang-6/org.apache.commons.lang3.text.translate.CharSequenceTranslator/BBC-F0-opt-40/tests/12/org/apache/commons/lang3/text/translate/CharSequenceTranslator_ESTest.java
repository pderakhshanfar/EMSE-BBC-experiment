...
public class CharSequenceTranslator_ESTest extends CharSequenceTranslator_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.below((-2159));
      CharBuffer charBuffer0 = CharBuffer.allocate(1980);
      StringWriter stringWriter0 = new StringWriter(88);
      int int0 = numericEntityEscaper0.translate((CharSequence) charBuffer0, 754, (Writer) stringWriter0);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf(0, (-472));
      StringWriter stringWriter0 = new StringWriter();
      stringWriter0.write("oZa.od)B6?^`q.5HM");
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      unicodeEscaper0.translate((CharSequence) stringBuffer0, 0, (Writer) stringWriter0);
      assertEquals(23, stringBuffer0.length());
      assertEquals("oZa.od)B6?^`q.5HM\\u006F", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        unicodeEscaper0.translate((CharSequence) "X~]G7+CaU", 225, (Writer) stringWriter0);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        octalUnescaper0.translate((CharSequence) null, 2312, (Writer) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        unicodeEscaper0.translate((CharSequence) charBuffer0, 3433, (Writer) stringWriter0);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test12()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.outsideOf(255, 48);
  ...
  public void test13()  throws Throwable  {
      ...
      CharBuffer charBuffer0 = CharBuffer.allocate(1543);
      String string0 = unicodeEscaper0.translate((CharSequence) charBuffer0);
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.below(1543);
      StringWriter stringWriter0 = new StringWriter();
      // Undeclared exception!
  ...
  public void test18()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(255, 16);
      // Undeclared exception!
      try { 
