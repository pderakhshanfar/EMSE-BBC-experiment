...
public class CharSequenceTranslator_ESTest extends CharSequenceTranslator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      stringWriter0.write("GZ^[F'V.");
      int int0 = octalUnescaper0.translate((CharSequence) stringBuffer0, 2, (Writer) stringWriter0);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.below(1835);
      StringWriter stringWriter0 = new StringWriter();
      unicodeEscaper0.translate((CharSequence) "72B", 0, (Writer) stringWriter0);
      assertEquals("\\u0037", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.between(425, 425);
  ...
  public void test06()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(1034, 120);
      // Undeclared exception!
      try { 
        unicodeEscaper0.translate((CharSequence) "FFFF", 309, (Writer) stringWriter0);
  ...
  public void test07()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(8, 4);
  ...
  public void test08()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.above(1034);
      StringWriter stringWriter0 = new StringWriter();
      CharBuffer charBuffer0 = CharBuffer.allocate(1034);
      // Undeclared exception!
      try { 
        numericEntityEscaper0.translate((CharSequence) charBuffer0, 1034, (Writer) stringWriter0);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        aggregateTranslator0.translate((CharSequence) "FFFFFA63");
        fail("Expecting exception: NullPointerException");
  ...
  public void test13()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf(3748, 3748);
      StringWriter stringWriter0 = new StringWriter();
      unicodeEscaper0.translate((CharSequence) "EA4", (Writer) stringWriter0);
      assertEquals("\\u0045\\u0041\\u0034", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        aggregateTranslator0.translate((CharSequence) "FFFFFA63", (Writer) stringWriter0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test16()  throws Throwable  {
      ...
      String string0 = charSequenceTranslatorArray0[0].translate((CharSequence) "FFFFFA63");
      assertEquals("FFFFFA63", string0);
  }
  ...
  public void test18()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.below((-883));
      char[] charArray0 = new char[7];
      CharBuffer charBuffer0 = CharBuffer.wrap(charArray0);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.outsideOf(65, 0);
