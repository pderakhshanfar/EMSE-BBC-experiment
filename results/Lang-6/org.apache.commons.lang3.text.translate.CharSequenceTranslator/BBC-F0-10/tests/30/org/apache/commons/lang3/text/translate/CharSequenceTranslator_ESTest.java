...
public class CharSequenceTranslator_ESTest extends CharSequenceTranslator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf(0, 1720);
      StringWriter stringWriter0 = new StringWriter();
      int int0 = unicodeEscaper0.translate((CharSequence) "FFFFFE6F", 0, (Writer) stringWriter0);
      assertEquals(0, int0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      StringWriter stringWriter0 = new StringWriter();
      unicodeEscaper0.translate((CharSequence) "FFFFFE6F", 0, (Writer) stringWriter0);
      assertEquals("\\u0046", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.outsideOf(193, 193);
  ...
  public void test04()  throws Throwable  {
      ...
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf((-3103), (-394));
  ...
  public void test06()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.above((-1014));
      StringWriter stringWriter0 = new StringWriter();
      ...
      // Undeclared exception!
      try { 
        charSequenceTranslator0.translate((CharSequence) "FFFFFC0A", (-1014), (Writer) stringWriter0);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        numericEntityEscaper0.translate((CharSequence) null, 1624, (Writer) stringWriter0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test08()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.between(4, 1520);
      char[] charArray0 = new char[0];
      CharBuffer charBuffer0 = CharBuffer.wrap(charArray0);
      StringWriter stringWriter0 = new StringWriter();
      // Undeclared exception!
      try { 
        numericEntityEscaper0.translate((CharSequence) charBuffer0, (-1529), (Writer) stringWriter0);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test11()  throws Throwable  {
      ...
      StringWriter stringWriter0 = new StringWriter();
      lookupTranslator0.translate((CharSequence) "FFFFFE6F", (Writer) stringWriter0);
      assertEquals("FFFFFE6F", stringWriter0.toString());
  }
