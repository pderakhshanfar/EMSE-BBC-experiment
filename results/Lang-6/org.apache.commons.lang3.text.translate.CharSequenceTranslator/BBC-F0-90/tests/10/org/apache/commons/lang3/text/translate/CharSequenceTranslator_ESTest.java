...
public class CharSequenceTranslator_ESTest extends CharSequenceTranslator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate(1413);
      OctalUnescaper octalUnescaper0 = new OctalUnescaper();
      StringWriter stringWriter0 = new StringWriter();
      int int0 = octalUnescaper0.translate((CharSequence) charBuffer0, 8, (Writer) stringWriter0);
      assertEquals(0, int0);
  }
  ...
  public void test04()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.below(2522);
      StringWriter stringWriter0 = new StringWriter();
      StringBuffer stringBuffer0 = stringWriter0.getBuffer();
      // Undeclared exception!
      try { 
        numericEntityEscaper0.translate((CharSequence) stringBuffer0, 2522, (Writer) stringWriter0);
  ...
  public void test06()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf(2475, 2475);
      char[] charArray0 = new char[2];
      CharBuffer charBuffer0 = CharBuffer.wrap(charArray0);
      StringWriter stringWriter0 = new StringWriter();
      // Undeclared exception!
      try { 
        unicodeEscaper0.translate((CharSequence) charBuffer0, 1472, (Writer) stringWriter0);
  ...
  public void test07()  throws Throwable  {
      String string0 = "_$3^PQ%xD\\95;|4o";
      OctalUnescaper octalUnescaper0 = new OctalUnescaper();
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        aggregateTranslator0.translate((CharSequence) "FFFFFCF5");
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      OctalUnescaper octalUnescaper0 = new OctalUnescaper();
      StringWriter stringWriter0 = new StringWriter();
      octalUnescaper0.translate((CharSequence) "_$3^PQ%xD95;|4o", (Writer) stringWriter0);
      assertEquals("_$3^PQ%xD95;|4o", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      StringWriter stringWriter0 = new StringWriter();
      aggregateTranslator0.translate((CharSequence) "FFFFFD5E", (Writer) stringWriter0);
      assertEquals("\\u0046\\u0046\\u0046\\u0046\\u0046\\u0044\\u0035\\u0045", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      String string0 = CharSequenceTranslator.hex((-674));
      assertEquals("FFFFFD5E", string0);
  }
