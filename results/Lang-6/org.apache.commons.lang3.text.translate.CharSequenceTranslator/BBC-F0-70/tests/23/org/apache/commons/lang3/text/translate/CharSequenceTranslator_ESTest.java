...
public class CharSequenceTranslator_ESTest extends CharSequenceTranslator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.above(1775);
      CharBuffer charBuffer0 = CharBuffer.allocate(1775);
      StringWriter stringWriter0 = new StringWriter();
      int int0 = unicodeEscaper0.translate((CharSequence) charBuffer0, 721, (Writer) stringWriter0);
      assertEquals(0, int0);
  }
  ...
  public void test02()  throws Throwable  {
      String string0 = CharSequenceTranslator.hex(1978);
      assertEquals("7BA", string0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf(4, 3);
  ...
  public void test06()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate(2009);
      CharBuffer charBuffer1 = CharBuffer.wrap((CharSequence) charBuffer0, 3, 2009);
      StringWriter stringWriter0 = new StringWriter();
      charBuffer0.append('r');
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf(3, 1997);
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        numericEntityUnescaper0.translate((CharSequence) "null", 1259, (Writer) stringWriter0);
  ...
  public void test09()  throws Throwable  {
      ...
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf(1991, 4);
      // Undeclared exception!
      try { 
        unicodeEscaper0.translate((CharSequence) charBuffer0, (-770), (Writer) stringWriter0);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        aggregateTranslator0.translate((CharSequence) "2C6");
        fail("Expecting exception: NullPointerException");
  ...
  public void test13()  throws Throwable  {
      ...
      StringWriter stringWriter0 = new StringWriter();
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf(3, 1997);
      unicodeEscaper0.translate((CharSequence) charBuffer0, 275, (Writer) stringWriter0);
      assertEquals("\\u0000", stringWriter0.toString());
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf(711, 711);
      StringWriter stringWriter0 = new StringWriter();
  ...
  public void test15()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(2826, 1293);
  ...
  public void test16()  throws Throwable  {
      ...
      CharBuffer charBuffer0 = CharBuffer.allocate(2009);
      String string0 = octalUnescaper0.translate((CharSequence) charBuffer0);
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.between(3, (-4839));
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.above(835);
      CharSequenceTranslator[] charSequenceTranslatorArray0 = new CharSequenceTranslator[8];
