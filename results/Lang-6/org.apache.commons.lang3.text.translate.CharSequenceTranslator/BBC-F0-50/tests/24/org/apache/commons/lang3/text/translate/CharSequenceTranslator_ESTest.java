...
public class CharSequenceTranslator_ESTest extends CharSequenceTranslator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = numericEntityEscaper0.translate((CharSequence) charBuffer0, 2122, (Writer) stringWriter0);
      assertEquals(0, int0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        aggregateTranslator0.translate((CharSequence) "1373", (Writer) stringWriter0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test06()  throws Throwable  {
      ...
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.between(59, 864);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        numericEntityEscaper0.translate((CharSequence) "1", 3833, (Writer) stringWriter0);
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        numericEntityUnescaper0.translate((CharSequence) null, 2103, (Writer) stringWriter0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.below((-631));
      CharBuffer charBuffer0 = CharBuffer.allocate(2);
      // Undeclared exception!
      try { 
        unicodeEscaper0.translate((CharSequence) charBuffer0, 648, (Writer) null);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test12()  throws Throwable  {
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.between(2075, 2075);
      char[] charArray0 = new char[5];
      CharBuffer charBuffer0 = CharBuffer.wrap(charArray0);
      CharBuffer charBuffer1 = CharBuffer.wrap((CharSequence) charBuffer0);
      charBuffer0.append((CharSequence) charBuffer1, 0, 2);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      UnicodeEscaper unicodeEscaper0 = UnicodeEscaper.outsideOf((-1075), 3125);
  ...
  public void test16()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate(2122);
      NumericEntityEscaper numericEntityEscaper0 = NumericEntityEscaper.between((-2571), 2122);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      CharBuffer charBuffer0 = CharBuffer.allocate(3792);
      String string0 = unicodeEscaper0.translate((CharSequence) charBuffer0);
      StringWriter stringWriter0 = new StringWriter(1112);
      unicodeEscaper0.translate((CharSequence) string0, 1112, (Writer) stringWriter0);
      assertEquals("\\u0030", stringWriter0.toString());
  }
}
