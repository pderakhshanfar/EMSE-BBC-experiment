...
public class BitInputStream_ESTest extends BitInputStream_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-326), 68);
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-14), (byte) (-85));
      DataInputStream dataInputStream0 = new DataInputStream(byteArrayInputStream0);
      BitInputStream bitInputStream0 = new BitInputStream(dataInputStream0, (ByteOrder) null);
      // Undeclared exception!
      try { 
        bitInputStream0.readBits(68);
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-19), (byte) (-125));
      ByteOrder byteOrder0 = ByteOrder.LITTLE_ENDIAN;
      BitInputStream bitInputStream0 = new BitInputStream(byteArrayInputStream0, byteOrder0);
      // Undeclared exception!
      try { 
        bitInputStream0.readBits((-1110));
        fail("Expecting exception: IllegalArgumentException");
