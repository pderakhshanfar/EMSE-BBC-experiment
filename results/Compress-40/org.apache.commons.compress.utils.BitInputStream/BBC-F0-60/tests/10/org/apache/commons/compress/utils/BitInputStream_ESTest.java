...
public class BitInputStream_ESTest extends BitInputStream_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      ByteOrder byteOrder0 = ByteOrder.nativeOrder();
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-886), 23);
      BitInputStream bitInputStream0 = new BitInputStream(byteArrayInputStream0, byteOrder0);
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile("count must not be negative or greater than 63", "count must not be negative or greater than 63");
      File file0 = MockFile.createTempFile("count must not be negative or greater than 63", "count must not be negative or greater than 63", (File) mockFile0);
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ByteOrder byteOrder0 = ByteOrder.LITTLE_ENDIAN;
      BitInputStream bitInputStream0 = new BitInputStream(mockFileInputStream0, byteOrder0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("count must not be negative or greater than 63/count must not be negative or greater than 63/count must not be negative or greater than 630count must not be negative or greater than 63");
