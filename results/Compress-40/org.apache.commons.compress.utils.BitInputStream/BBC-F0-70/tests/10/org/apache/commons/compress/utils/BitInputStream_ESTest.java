...
public class BitInputStream_ESTest extends BitInputStream_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      assertEquals(4215369251218784256L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = new byte[8];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1229), 2136240278);
      ByteOrder byteOrder0 = ByteOrder.nativeOrder();
      BitInputStream bitInputStream0 = new BitInputStream(byteArrayInputStream0, byteOrder0);
      // Undeclared exception!
      try { 
  ...
  public void test10()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("count must not be negative or greater than 63", (String) null, (File) mockFile0);
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ByteOrder byteOrder0 = ByteOrder.nativeOrder();
      BitInputStream bitInputStream0 = new BitInputStream(mockFileInputStream0, byteOrder0);
      // Undeclared exception!
      try { 
        bitInputStream0.readBits((-5600));
        fail("Expecting exception: IllegalArgumentException");
