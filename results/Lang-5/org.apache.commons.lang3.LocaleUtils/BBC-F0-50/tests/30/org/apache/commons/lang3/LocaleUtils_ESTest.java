...
public class LocaleUtils_ESTest extends LocaleUtils_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      ...
      Locale locale1 = new Locale("", "\u6CD5\u6587 (\u52A0\u62FF\u5927)", "$");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        LocaleUtils.toLocale("mp_RC]");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid locale format: mp_RC]
         //
  ...
  public void test11()  throws Throwable  {
      Locale locale0 = LocaleUtils.toLocale("mp_RC");
      assertEquals("mp_RC", locale0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        LocaleUtils.toLocale("mk_ClP&k8");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid locale format: mk_ClP&k8
         //
         verifyException("org.apache.commons.lang3.LocaleUtils", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        LocaleUtils.toLocale("mk_lP&8");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid locale format: mk_lP&8
         //
         verifyException("org.apache.commons.lang3.LocaleUtils", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      Locale locale0 = LocaleUtils.toLocale("mk__w");
  ...
  public void test15()  throws Throwable  {
      // Undeclared exception!
      try { 
        LocaleUtils.toLocale("mp_RC4%]");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid locale format: mp_RC4%]
         //
         verifyException("org.apache.commons.lang3.LocaleUtils", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      // Undeclared exception!
      try { 
        LocaleUtils.toLocale("dVPA.*v28nK)[l|");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid locale format: dVPA.*v28nK)[l|
         //
         verifyException("org.apache.commons.lang3.LocaleUtils", e);
      }
  }
