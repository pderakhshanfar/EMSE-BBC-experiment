...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.normalName = "nh*PP\"c~Sk(1*>V@";
      String string0 = token_StartTag0.normalName();
      assertEquals("nh*PP\"c~Sk(1*>V@", string0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendTagName("Ui2:(Q2V");
      String string0 = token_EndTag0.name();
      assertEquals("Ui2:(Q2V", string0);
  }
  ...
  public void test07()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData(";]");
      Token.Character token_Character0 = token_CData0.data("O^{DU\"y8)`(q");
  ...
  public void test14()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("$5|*Mkd23-!j!w}X");
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      Attribute attribute0 = new Attribute("frame", "frame");
      attributes0.put(attribute0);
      token_StartTag0.nameAttr("frame", attributes0);
      String string0 = token_StartTag0.toString();
      assertEquals("<frame  frame=\"frame\">", string0);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("7.:ibV_T$BuZbao7", (Attributes) null);
      String string0 = token_StartTag1.toString();
      assertEquals("<7.:ibV_T$BuZbao7>", string0);
  }
  ...
  public void test30()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeName("n`*mzg~");
  ...
  public void test33()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeValue(";<G0jx\"M4");
      token_EndTag0.appendAttributeName(";<G0jx\"M4");
  ...
  public void test34()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeName("Jr_Hpe%j?l1ZD[");
  ...
  public void test56()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Token.Tag token_Tag0 = token_StartTag0.name("n`*mzg~");
      token_StartTag0.appendTagName("n`*mzg~");
