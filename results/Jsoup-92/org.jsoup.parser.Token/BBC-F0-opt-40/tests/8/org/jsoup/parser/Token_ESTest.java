...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Token.EndTag token_EndTag1 = (Token.EndTag)token_EndTag0.name("~f)<,+_4V4jJR");
      String string0 = token_EndTag1.normalName();
      assertEquals("~f)<,+_4v4jjr", string0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      token_StartTag0.appendAttributeName("K%w?L|f\"'ppE+@");
      int[] intArray0 = new int[0];
      token_StartTag0.appendAttributeValue(intArray0);
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("K%w?L|f\"'ppE+@", attributes0);
  ...
  public void test02()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.EndTag token_EndTag1 = (Token.EndTag)token_EndTag0.name("Fav82WFpH3<[(");
      String string0 = token_EndTag1.name();
      assertEquals("Fav82WFpH3<[(", string0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.name("Fav82WFpH3<[(");
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals("<![CDATA[rt]]>", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("%r%H5,nO`");
      String string0 = token_CData0.getData();
      assertEquals("%r%H5,nO`", string0);
  }
  ...
  public void test09()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("UbrE6\"dBR");
  ...
  public void test18()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("Ql9K!");
  ...
  public void test29()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.nameAttr("f+C([%tzc</", (Attributes) null);
      String string0 = token_StartTag0.toString();
      assertEquals("<f+C([%tzc</>", string0);
  }
  ...
  public void test32()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeName("hx6*G$Q0\"[@[Aw");
  ...
  public void test33()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.appendTagName("GI{r24zB2)H?+I");
  ...
  public void test48()  throws Throwable  {
      StringBuilder stringBuilder0 = new StringBuilder("/zmj");
      Token.Character token_Character0 = new Token.Character();
      StringBuilder stringBuilder1 = stringBuilder0.append((Object) token_Character0);
      assertEquals("/zmjnull", stringBuilder1.toString());
  }
