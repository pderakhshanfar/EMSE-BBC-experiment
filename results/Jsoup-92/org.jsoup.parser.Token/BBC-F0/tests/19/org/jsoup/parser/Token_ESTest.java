...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.name("\"wLXHV3O^gSpFn&7%");
      String string0 = token_EndTag0.normalName();
      assertEquals("\"wlxhv3o^gspfn&7%", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.Tag token_Tag0 = token_EndTag0.name("\"wLXHV3O^gSpFn&7%");
  ...
  public void test05()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.appendTagName("V^DZ");
  }
  ...
  public void test07()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("mup(BvcH");
      Token.Character token_Character0 = token_CData0.data("mup(BvcH");
  ...
  public void test13()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("w%6@f:/WlV@cK1$'");
  ...
  public void test22()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("\"wLXHV3O^gSpFn&7%");
  ...
  public void test28()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.nameAttr("+.B*~v9Y<lJp!", (Attributes) null);
      String string0 = token_StartTag0.toString();
      assertEquals("<+.B*~v9Y<lJp!>", string0);
  }
  ...
  public void test32()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("+.B*~v9Y<lJp!", (Attributes) null);
  ...
  public void test48()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("mup(BvcH");
      String string0 = token_CData0.toString();
      assertEquals("<![CDATA[mup(BvcH]]>", string0);
  }
  ...
  public void test57()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.Tag token_Tag0 = token_EndTag0.name("kkQ");
