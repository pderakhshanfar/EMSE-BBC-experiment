...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.name("=dTD1_U5L<F$A3,n^");
      String string0 = token_EndTag0.normalName();
      assertEquals("=dtd1_u5l<f$a3,n^", string0);
  }
  ...
  public void test03()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.Tag token_Tag0 = token_EndTag0.name("wg;D.ScPw");
      String string0 = ((Token.EndTag) token_Tag0).toString();
      assertEquals("</wg;D.ScPw>", string0);
  }
  ...
  public void test06()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("org.jsoup.nodes.LeafNode");
      Token.Character token_Character0 = token_CData0.data("org.jsoup.nodes.LeafNode");
  ...
  public void test12()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("hZN#FH5Vx");
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.Tag token_Tag0 = token_EndTag0.name("=dTD1_U5L<F$A3,n^");
      token_EndTag0.appendTagName('}');
      assertSame(token_EndTag0, token_Tag0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Attributes attributes1 = attributes0.put("^x!H4C77%|1{]ZW5", "^x!H4C77%|1{]ZW5");
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("^x!H4C77%|1{]ZW5", attributes1);
  ...
  public void test27()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.nameAttr("^pu-:`M8!", (Attributes) null);
      String string0 = token_StartTag0.toString();
      assertEquals("<^pu-:`M8!>", string0);
  }
  ...
  public void test30()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.appendAttributeName("lmD`_+,");
  ...
  public void test52()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendTagName('$');
      token_EndTag0.appendTagName("Pattern syntax error: ");
  }
