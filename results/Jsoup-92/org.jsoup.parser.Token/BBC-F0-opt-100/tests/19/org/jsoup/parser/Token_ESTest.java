...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Token.StartTag token_StartTag1 = (Token.StartTag)token_StartTag0.name("J_s:`mU$vCc");
      token_StartTag1.appendAttributeName('Y');
      token_StartTag1.finaliseTag();
      String string0 = token_StartTag0.toString();
      assertEquals("<J_s:`mU$vCc  Y>", string0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      token_EndTag0.name("03_Av");
      String string0 = token_EndTag0.normalName();
      assertEquals("03_av", string0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.Tag token_Tag0 = token_EndTag0.name("2oGtA*");
      String string0 = ((Token.EndTag) token_Tag0).toString();
      assertEquals("</2oGtA*>", string0);
  }
  ...
  public void test06()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("# 9z*'~");
  ...
  public void test12()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("l8vZowic");
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeValue("2oGtA*");
  ...
  public void test29()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeName("nj.cO~^R@");
  ...
  public void test51()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.name("J_s:`mU$vCc");
      String string0 = token_StartTag0.toString();
      assertEquals("<J_s:`mU$vCc>", string0);
  }
