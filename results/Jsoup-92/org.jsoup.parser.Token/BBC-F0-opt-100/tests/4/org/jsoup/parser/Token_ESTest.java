...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals("<StartTag  4>", string0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      token_EndTag0.name("N<ARy{9d8mvv[{7-H");
      String string0 = token_EndTag0.name();
      assertEquals("N<ARy{9d8mvv[{7-H", string0);
  }
  ...
  public void test06()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData(">eUhRu8l]T\"<Xh#RbQ");
  ...
  public void test26()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("AXAq$WV*", (Attributes) null);
      String string0 = token_StartTag1.toString();
      assertEquals("<AXAq$WV*>", string0);
  }
  ...
  public void test29()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.Tag token_Tag0 = token_EndTag0.name("N<ARy{9d8mvv[{7-H");
      token_EndTag0.appendTagName("Q&^|\".YFc5P%aiaB");
