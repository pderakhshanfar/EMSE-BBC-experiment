...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      token_StartTag1.appendTagName(",ZXS$FGG");
      String string0 = token_StartTag1.toString();
      assertEquals("<,ZXS$FGG  =\"\">", string0);
  }
  ...
  public void test02()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Token.StartTag token_StartTag1 = (Token.StartTag)token_StartTag0.name("r?4*T");
      String string0 = token_StartTag1.normalName();
      assertEquals("r?4*t", string0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.EndTag token_EndTag1 = (Token.EndTag)token_EndTag0.name("[k!_\"&Z,1\"J`\"|vO(NJ");
      String string0 = token_EndTag1.name();
      assertEquals("[k!_\"&Z,1\"J`\"|vO(NJ", string0);
  }
  ...
  public void test07()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("[k!_\"&Z,1\"J`\"|vO(NJ");
  ...
  public void test31()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.nameAttr("Doctype", (Attributes) null);
  ...
  public void test34()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeName("acronym");
  ...
  public void test35()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.appendTagName(",ZXS$FGG");
      String string0 = token_StartTag0.toString();
      assertEquals("<,ZXS$FGG>", string0);
  }
  ...
  public void test37()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeName("qW a`lm(yhs^s&");
  ...
  public void test53()  throws Throwable  {
      ...
      token_EndTag0.appendAttributeName("[k!_\"&Z,1\"J`\"|vO(NJ");
      token_EndTag0.newAttribute();
  }
