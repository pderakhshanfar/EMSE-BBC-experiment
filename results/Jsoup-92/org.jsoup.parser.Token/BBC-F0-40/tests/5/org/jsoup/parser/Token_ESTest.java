...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      token_StartTag0.name("6W]A)n");
      String string0 = token_StartTag0.normalName();
      assertEquals("6w]a)n", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendTagName("Dh+bnG+%R@xPE&4xZ2");
      String string0 = token_EndTag0.toString();
      assertEquals("</Dh+bnG+%R@xPE&4xZ2>", string0);
  }
  ...
  public void test04()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("Hz!$]NY|q");
      Token.Character token_Character0 = token_CData0.data("Hz!$]NY|q");
      assertSame(token_Character0, token_CData0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("=2CB20[JI6x?g51><");
      String string0 = token_CData0.toString();
      assertEquals("<![CDATA[=2CB20[JI6x?g51><]]>", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("seamless");
  ...
  public void test24()  throws Throwable  {
      ...
      attributes0.put("=2CB20[JI6x?g51><", "suf,");
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("Tx'|xD", attributes0);
      String string0 = token_StartTag1.toString();
      assertEquals("<Tx'|xD  =2CB20[JI6x?g51><=\"suf,\">", string0);
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("{jGd|^S[\"h)]V", (Attributes) null);
      String string0 = token_StartTag1.toString();
      assertEquals("<{jGd|^S[\"h)]V>", string0);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeValue("YfU?#M");
  ...
  public void test28()  throws Throwable  {
      ...
      token_EndTag0.appendAttributeValue(charArray0);
      token_EndTag0.appendAttributeValue("seamless");
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeName("I&YRnJn<1YVD%");
  ...
  public void test30()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.Tag token_Tag0 = token_EndTag0.name("X4KPIo2wVk}D?'+");
  ...
  public void test33()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeValue("lPE5|0s72A=i9*}R_0s");
      token_EndTag0.appendAttributeName("lPE5|0s72A=i9*}R_0s");
  ...
  public void test56()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.EndTag token_EndTag1 = (Token.EndTag)token_EndTag0.name("lPE5|0s72A=i9*}R_0s");
  ...
  public void test66()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Attributes attributes0 = new Attributes();
      token_StartTag0.nameAttr("Tx'|xD", attributes0);
      String string0 = token_StartTag0.toString();
      assertEquals("<Tx'|xD>", string0);
  }
}
