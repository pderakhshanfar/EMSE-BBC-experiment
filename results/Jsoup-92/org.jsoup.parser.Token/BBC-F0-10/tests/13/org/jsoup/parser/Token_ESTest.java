...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.Tag token_Tag0 = token_EndTag0.name("@1B:,M1P${]7-");
      String string0 = ((Token.EndTag) token_Tag0).toString();
      assertEquals("</@1B:,M1P${]7->", string0);
  }
  ...
  public void test07()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendTagName("K`#4IH}g30x/xnqn!|J");
  }
  ...
  public void test09()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("kaYfBUE3o#LYjJP*");
      String string0 = token_CData0.getData();
      assertEquals("kaYfBUE3o#LYjJP*", string0);
  }
