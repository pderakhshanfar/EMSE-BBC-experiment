...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      token_StartTag0.appendTagName("<3jDeMaxM[");
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals("<3jDeMaxM[", string0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.name("+ B?;dy?@Y@QIR[");
      String string0 = token_EndTag0.toString();
      assertEquals("</+ B?;dy?@Y@QIR[>", string0);
  }
  ...
  public void test07()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("S19VH");
      String string0 = token_CData0.getData();
      assertEquals("S19VH", string0);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Attributes attributes1 = attributes0.put("%[wg`TU7x?k|XN9M", "ZBk~");
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("%[wg`TU7x?k|XN9M", attributes1);
      String string0 = token_StartTag1.toString();
      assertEquals("<%[wg`TU7x?k|XN9M  %[wg`TU7x?k|XN9M=\"ZBk~\">", string0);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("o@s", (Attributes) null);
      String string0 = token_StartTag1.toString();
  ...
  public void test30()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.appendAttributeName("S19VH");
  ...
  public void test32()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeName("<![CDATA[XEkDz#7^k]]>");
  ...
  public void test34()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.appendAttributeValue("S19VH");
      token_StartTag0.appendAttributeName("S19VH");
      token_StartTag0.appendAttributeValue("S19VH");
  ...
  public void test60()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData(":Q?5$3r4LBDdd)bK~gN");
  ...
  public void test65()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Attributes attributes0 = new Attributes();
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("%[wg`TU7x?k|XN9M", attributes0);
      String string0 = token_StartTag1.toString();
      assertEquals("<%[wg`TU7x?k|XN9M>", string0);
  }
}
