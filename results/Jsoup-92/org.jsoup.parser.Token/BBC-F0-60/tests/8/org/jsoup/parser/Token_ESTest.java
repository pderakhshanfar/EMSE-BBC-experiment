...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      token_StartTag0.appendAttributeName("Or");
      token_StartTag0.newAttribute();
      token_StartTag0.name("EOF");
      String string0 = token_StartTag0.toString();
      assertEquals("<EOF  Or>", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.Tag token_Tag0 = token_EndTag0.name("hy1iM%,LU");
  ...
  public void test02()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.appendTagName("%Y4`<R>3VR(K1");
      String string0 = token_StartTag0.normalName();
      assertEquals("%y4`<r>3vr(k1", string0);
  }
  ...
  public void test04()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendTagName("*rK7--*Z(WW?K4^z");
      String string0 = token_EndTag0.toString();
      assertEquals("</*rK7--*Z(WW?K4^z>", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Token.Character token_Character0 = token_CData0.data("[KV[");
  ...
  public void test23()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("F9oX~E'gb;uXZp&C`P");
  ...
  public void test28()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.appendAttributeValue("E$5XM;K~CfF^XW");
  ...
  public void test30()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeName("E$5XM;K~CfF^XW");
  ...
  public void test34()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.appendAttributeName("eV?ah<;R[W");
  ...
  public void test65()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.nameAttr("X-", (Attributes) null);
      String string0 = token_StartTag0.toString();
