...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      token_StartTag0.appendTagName("740_q'{#(V995bHm");
      token_StartTag0.appendAttributeName("740_q'{#(V995bHm");
      token_StartTag0.newAttribute();
      String string0 = token_StartTag0.toString();
      assertEquals("<740_q'{#(V995bHm  740_q'{#(V995bHm>", string0);
  }
  ...
  public void test03()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.Tag token_Tag0 = token_EndTag0.name("i5XEaHj_5H");
      String string0 = ((Token.EndTag) token_Tag0).toString();
      assertEquals("</i5XEaHj_5H>", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Token.Character token_Character0 = token_CData0.data("~N+");
  ...
  public void test28()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeName(";0s^.=xl8u?gN)7]h");
      token_EndTag0.appendAttributeName(";0s^.=xl8u?gN)7]h");
  }
  ...
  public void test29()  throws Throwable  {
      ...
      token_StartTag0.appendTagName("740_q'{#(V995bHm");
      String string0 = token_StartTag0.toString();
      assertEquals("<740_q'{#(V995bHm>", string0);
  }
  ...
  public void test33()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.appendAttributeName("740_q'{#(V995bHm");
      token_StartTag0.appendAttributeValue("740_q'{#(V995bHm");
      token_StartTag0.finaliseTag();
  }
  ...
  public void test60()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("Ll>#[{!i", (Attributes) null);
      token_StartTag0.appendTagName("_mX%$p)V~V 7c");
      assertSame(token_StartTag0, token_StartTag1);
  }
}
