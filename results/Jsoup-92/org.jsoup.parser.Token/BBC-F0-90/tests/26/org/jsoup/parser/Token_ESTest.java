...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Token.EndTag token_EndTag1 = (Token.EndTag)token_EndTag0.name("(V`=_qgG");
      token_EndTag1.appendAttributeName("(V`=_qgG");
  ...
  public void test01()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.tagName = "9E{|x";
      String string0 = token_EndTag0.name();
      assertEquals("9E{|x", string0);
  }
  ...
  public void test06()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("(V`=_qgG");
      String string0 = token_CData0.getData();
      assertEquals("(V`=_qgG", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("(V`=_qgG");
      Token.Character token_Character0 = token_CData0.data("(V`=_qgG");
      assertSame(token_CData0, token_Character0);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("?une1u6E5~-{K-w,u");
  ...
  public void test12()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("tG\"o*iZg");
  ...
  public void test27()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeValue(" 4s");
  ...
  public void test31()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.Tag token_Tag0 = token_EndTag0.name("rlU5");
  ...
  public void test36()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeName("G]2DEdH");
      token_EndTag0.newAttribute();
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Attributes attributes0 = token_EndTag0.getAttributes();
      token_StartTag0.nameAttr("t!<ywqfvjIY~`by@", attributes0);
  ...
  public void test47()  throws Throwable  {
      ...
      assertEquals("<![CDATA[tG\"o*iZg]]>", string0);
  }
  ...
  public void test54()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.name("G]2DEdH");
      String string0 = token_EndTag0.normalName();
      assertEquals("g]2dedh", string0);
  }
  ...
  public void test63()  throws Throwable  {
      ...
      assertEquals("<t!<ywqfvjIY~`by@>", string0);
  }
}
