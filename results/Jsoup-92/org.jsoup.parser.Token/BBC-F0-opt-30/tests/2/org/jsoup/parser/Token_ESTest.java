...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Token.EndTag token_EndTag1 = (Token.EndTag)token_EndTag0.name("dzr{W&4#mq-");
      String string0 = token_EndTag1.normalName();
      assertEquals("dzr{w&4#mq-", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendTagName(".62enB37");
      String string0 = token_EndTag0.name();
      assertEquals(".62enB37", string0);
  }
  ...
  public void test07()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("EOF");
      Token.Character token_Character0 = token_CData0.data("DJlAW9Q7%");
  ...
  public void test28()  throws Throwable  {
      ...
      Attributes attributes1 = attributes0.put("oLXQD3Fi]&FF+wby", "{$");
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("article", attributes1);
      String string0 = token_StartTag1.toString();
      assertEquals("<article  oLXQD3Fi]&FF+wby=\"{$\">", string0);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.appendAttributeValue("LXO23S");
  ...
  public void test47()  throws Throwable  {
      Token.CData token_CData0 = new Token.CData("|1if7nQ[");
  ...
  public void test55()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      Token.EndTag token_EndTag1 = (Token.EndTag)token_EndTag0.name("dzr{W&4#mq-");
      token_EndTag1.appendTagName("org.jsoup.parser.Token$Character");
      assertSame(token_EndTag0, token_EndTag1);
  }
