...
public class XmlTreeBuilder_ESTest extends XmlTreeBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      List<Node> list0 = xmlTreeBuilder0.parseFragment("RawtextEndTagName", (Element) null, "org.jsoup.parser.XmlTreeBuilder", parser0);
  ...
  public void test05()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Token.Doctype token_Doctype0 = new Token.Doctype();
      xmlTreeBuilder0.parse("Z?ozPw5/", "Z?ozPw5/");
  ...
  public void test06()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      StringReader stringReader0 = new StringReader("");
      Document document0 = xmlTreeBuilder0.parse(stringReader0, "cn]#Pf i:K");
  ...
  public void test08()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      xmlTreeBuilder0.parse("mXw", "mXw");
      Token.StartTag token_StartTag0 = new Token.StartTag();
      CDataNode cDataNode0 = new CDataNode("mXw");
  ...
  public void test09()  throws Throwable  {
      ...
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Token.StartTag token_StartTag1 = (Token.StartTag)token_StartTag0.name("-X\"Do!Y!CYVG4EC");
      Element element0 = xmlTreeBuilder0.insert(token_StartTag1);
      assertEquals("-x\"do!y!cyvg4ec", element0.tagName());
  }
  ...
  public void test12()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = Parser.parse("3!y|sS_dbKY2[1pAd ", "");
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parseFragment((String) null, "*fff6W%wze#W6o$[K=", (Parser) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parseFragment("m,oqmNLgbB.mXzW", (String) null, parser0);
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parse("95/3/)n$fCv,j'&", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      StringReader stringReader0 = new StringReader(";=:Q?YRhg^`Aj2HnKt*");
      stringReader0.close();
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parse(stringReader0, "org.jsoup.nodes.TextNode");
  ...
  public void test18()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      xmlTreeBuilder0.parse("3-EX:,th7,S(N.q#", "Md5jAxU&(");
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.name("org.jsoup.select.Evaluator$Tag");
  ...
  public void test21()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      StringReader stringReader0 = new StringReader("igK;CU#Rdp&]N}");
      Parser parser0 = Parser.xmlParser();
      stringReader0.close();
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.initialiseParse(pipedReader0, "~T/*zi", parser0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      xmlTreeBuilder0.parse("mXw", "mXw");
      boolean boolean0 = xmlTreeBuilder0.processEndTag("mXw");
      assertTrue(boolean0);
  }
  ...
  public void test25()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Token.CData token_CData0 = new Token.CData("{%?iLat");
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = xmlTreeBuilder0.parse("G~d*1}_p#iC(W<?mUEe", "V[8%*H~d,)Gn2?U-N3");
      assertEquals("V[8%*H~d,)Gn2?U-N3", document0.location());
  }
  ...
  public void test28()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = xmlTreeBuilder0.parse("ll<h!iLzD<<?`DZU", "Unexpected toPen type:");
      assertEquals("Unexpected toPen type:", document0.baseUri());
  ...
  public void test29()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      xmlTreeBuilder0.parse(";=:Q?YRhg^`Aj2HnKt*", ";=:Q?YRhg^`Aj2HnKt*");
      Token.StartTag token_StartTag0 = new Token.StartTag();
  ...
  public void test30()  throws Throwable  {
      ...
      Token.StartTag token_StartTag0 = new Token.StartTag();
      token_StartTag0.selfClosing = true;
      Token.Tag token_Tag0 = token_StartTag0.name("-X\"Do!Y!CYVG4EC");
