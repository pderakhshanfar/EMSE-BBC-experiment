...
public class XmlTreeBuilder_ESTest extends XmlTreeBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("<8T^6uk p");
      Document document0 = xmlTreeBuilder0.parse(stringReader0, "&u'#$xH?:H");
      Parser parser0 = xmlTreeBuilder0.parser;
      List<Node> list0 = xmlTreeBuilder0.parseFragment("<8T^6uk p", document0, "&u'#$xH?:H", parser0);
  ...
  public void test04()  throws Throwable  {
      Parser parser0 = Parser.htmlParser();
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      List<Node> list0 = xmlTreeBuilder0.parseFragment("<!--", "applet", parser0);
  ...
  public void test06()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      StringReader stringReader0 = new StringReader("");
      Document document0 = xmlTreeBuilder0.parse(stringReader0, "r}gA:iwO[");
      assertEquals("r}gA:iwO[", document0.baseUri());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      xmlTreeBuilder0.parse("", "I%J<XnN?>Gl-kU");
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Attributes attributes0 = new Attributes();
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("I%J<XnN?>Gl-kU", attributes0);
      Element element0 = xmlTreeBuilder0.insert(token_StartTag1);
      assertEquals("I%J<XnN?>Gl-kU", element0.baseUri());
  }
  ...
  public void test11()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = Parser.parseBodyFragment("5RO>7,O", "");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parseFragment("[kTI4T.k0W49Q>(KW", (String) null, parser0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parse((String) null, "o:wARN");
        fail("Expecting exception: NullPointerException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parse("pI0%<X^?>[-k6", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parse(stringReader0, "embed");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.initialiseParse(pipedReader0, "%u?M", (Parser) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = xmlTreeBuilder0.parse("rXgg^32eR&<!?:P", "rXgg^32eR&<!?:P");
  ...
  public void test28()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      xmlTreeBuilder0.parse("#dpaument", "#dpaument");
      Tokeniser tokeniser0 = xmlTreeBuilder0.tokeniser;
  ...
  public void test29()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = xmlTreeBuilder0.parse("OzL7)ZD[R<LQw~y>M~G", "OzL7)ZD[R<LQw~y>M~G");
      assertEquals(2, document0.childNodeSize());
      
      Token.StartTag token_StartTag0 = new Token.StartTag();
      CDataNode cDataNode0 = new CDataNode("org.jsoup.parser.XmlTreeBuilder$1");
      Attributes attributes0 = cDataNode0.attributes();
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("OzL7)ZD[R<LQw~y>M~G", attributes0);
  ...
  public void test31()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = xmlTreeBuilder0.parse("rXgg^32eR&<!?PP", "NS>E~");
      assertEquals("NS>E~", document0.baseUri());
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = xmlTreeBuilder0.parse("I0%1<X^?>-k6", "#document");
      assertEquals(2, document0.childNodeSize());
  ...
  public void test35()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = Parser.parseBodyFragment("eof", "radio");
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parseFragment("W@ni3%v9Y:,", document0, "W@ni3%v9Y:,", (Parser) null);
        fail("Expecting exception: NullPointerException");
