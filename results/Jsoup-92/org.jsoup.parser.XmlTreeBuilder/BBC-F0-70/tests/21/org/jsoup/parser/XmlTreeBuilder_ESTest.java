...
public class XmlTreeBuilder_ESTest extends XmlTreeBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      ParseErrorList parseErrorList0 = new ParseErrorList(880, 2);
  ...
  public void test01()  throws Throwable  {
      ...
      xmlTreeBuilder0.parseFragment(">yx__?NN3, cJ?J1", "c;+p$", parser0);
  ...
  public void test02()  throws Throwable  {
      ...
      xmlTreeBuilder0.parseFragment("O]J%", (Element) null, "O]J%", parser0);
  ...
  public void test04()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = Parser.parse("hyB)Xk`&IG&E*!", "hyB)Xk`&IG&E*!");
      Parser parser0 = Parser.htmlParser();
      xmlTreeBuilder0.parseFragment("hyB)Xk`&IG&E*!", document0, "hyB)Xk`&IG&E*!", parser0);
  ...
  public void test07()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Parser parser0 = new Parser(xmlTreeBuilder0);
      xmlTreeBuilder0.parseFragment("{&uO)=", "tgq;G3ZXr(pH-U", parser0);
      Token.StartTag token_StartTag0 = new Token.StartTag();
      boolean boolean0 = xmlTreeBuilder0.processStartTag("tgq;G3ZXr(pH-U");
      assertTrue(boolean0);
      
      Attributes attributes0 = new Attributes();
      Token.StartTag token_StartTag1 = token_StartTag0.nameAttr("tgq;G3ZXr(pH-U", attributes0);
      Element element0 = xmlTreeBuilder0.insert(token_StartTag1);
      assertEquals("tgq;G3ZXr(pH-U", element0.baseUri());
  ...
  public void test11()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = Parser.parseBodyFragmentRelaxed("s/90}dPU9", "[^%s]");
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parseFragment("Ui$:;##E", document0, "Tag name must not be empty.", (Parser) null);
  ...
  public void test12()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = xmlTreeBuilder0.parse("=(?5:e3hi6C3x`_G,", "(T%E9i");
      Parser parser0 = Parser.htmlParser();
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parseFragment("=(?5:e3hi6C3x`_G,", document0, (String) null, parser0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parse("6U|`TX", (String) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Parser parser0 = Parser.htmlParser();
      StringReader stringReader0 = new StringReader("#docjmon2");
      stringReader0.close();
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      StringReader stringReader0 = new StringReader("iyN{'v&$TJjmF8(");
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Parser parser0 = Parser.xmlParser();
      xmlTreeBuilder0.parseFragment("{&C!uO)=", "{&C!uO)=", parser0);
      xmlTreeBuilder0.processStartTag("6dK(%nt");
  ...
  public void test26()  throws Throwable  {
      ...
      Parser parser0 = Parser.xmlParser();
      xmlTreeBuilder0.parseFragment("{&C!uO)=", "{&C!uO)=", parser0);
      boolean boolean0 = xmlTreeBuilder0.processEndTag("'i`[ywsv\"");
      assertTrue(boolean0);
  }
  ...
  public void test28()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = xmlTreeBuilder0.parse("xC<?r@EkzA<{G|3", "gYp=4X*");
      assertEquals("gYp=4X*", document0.location());
  }
  ...
  public void test34()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      xmlTreeBuilder0.parse("xC<?|XD@EkzA<+{G|3", "xC<?|XD@EkzA<+{G|3");
      boolean boolean0 = xmlTreeBuilder0.processEndTag("#document");
      assertTrue(boolean0);
  }
