...
public class XmlTreeBuilder_ESTest extends XmlTreeBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      xmlTreeBuilder0.parse("H/$rV@DT27,Ai_", "H/$rV@DT27,Ai_");
  ...
  public void test03()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      StringReader stringReader0 = new StringReader("N:7[afqQ");
      Parser parser0 = new Parser(xmlTreeBuilder0);
      xmlTreeBuilder0.initialiseParse(stringReader0, "N:7[afqQ", parser0);
  ...
  public void test04()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Parser parser0 = new Parser(xmlTreeBuilder0);
      Document document0 = xmlTreeBuilder0.parse("fpa&DW(ev|.", "N:7[afqQ");
      List<Node> list0 = xmlTreeBuilder0.parseFragment("", document0, "Sw6K{.s\"m{", parser0);
      assertEquals("N:7[afqQ", document0.location());
  ...
  public void test05()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = xmlTreeBuilder0.parse("", "_sIgj[");
      assertEquals("_sIgj[", document0.baseUri());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      xmlTreeBuilder0.parse(stringReader0, "sT");
      boolean boolean0 = xmlTreeBuilder0.processStartTag("sT");
      assertTrue(boolean0);
  ...
  public void test08()  throws Throwable  {
      ...
      xmlTreeBuilder0.parse(stringReader0, "se");
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parseFragment("1pLW:zxvewQ,Dj", (Element) null, (String) null, parser0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parseFragment("J']+VbpaWt(0721Vf", "J']+VbpaWt(0721Vf", (Parser) null);
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parseFragment("HT", (String) null, parser0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      StringReader stringReader0 = new StringReader("dUwTrUj/`-b:;p");
      stringReader0.close();
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parse(stringReader0, "dUwTrUj/`-b:;p");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.initialiseParse(pipedReader0, "big", (Parser) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.initialiseParse(pipedReader0, ".$4C%B-^Qn@@K>GSd5l", parser0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      StringReader stringReader0 = new StringReader("6pa%%`V/Qy=q");
      xmlTreeBuilder0.parse(stringReader0, "4x~Rr_6hnq,ul_#8");
  ...
  public void test27()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Token.CData token_CData0 = new Token.CData("4UT?/V;m5ftD :8m{");
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = xmlTreeBuilder0.parse("6</?9!_k(^$7 XFuUS", "6</?9!_k(^$7 XFuUS");
  ...
  public void test30()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      xmlTreeBuilder0.parse("G4N:5!<ZM/>#X", "G4N:5!<ZM/>#X");
      Token.Doctype token_Doctype0 = new Token.Doctype();
  ...
  public void test32()  throws Throwable  {
      XmlTreeBuilder xmlTreeBuilder0 = new XmlTreeBuilder();
      Document document0 = xmlTreeBuilder0.parse("6</?s$!0k(^$v FuU", "Unexpected token type: ");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xmlTreeBuilder0.parseFragment("=?Q#~7b\"", document0, "org.jsoup.select.Evaluator$TagEndsWith", (Parser) null);
        fail("Expecting exception: NullPointerException");
