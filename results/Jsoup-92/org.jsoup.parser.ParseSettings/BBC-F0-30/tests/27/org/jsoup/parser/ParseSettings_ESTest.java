...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.normalizeAttribute("8#U8(B K");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("8#U8(B K", string0);
  }
  ...
  public void test11()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      String string0 = parseSettings0.preserveCase.normalizeTag("|0JrY~)");
      assertEquals("|0JrY~)", string0);
      assertFalse(parseSettings0.preserveTagCase());
  }
