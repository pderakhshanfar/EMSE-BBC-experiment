...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      String string0 = parseSettings0.normalizeAttribute("?\"W1wM 7o_MO{");
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("?\"W1wM 7o_MO{", string0);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      String string0 = parseSettings0.htmlDefault.normalizeTag("\".*8$=m_\"R_[bR");
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("\".*8$=m_\"r_[br", string0);
  }
