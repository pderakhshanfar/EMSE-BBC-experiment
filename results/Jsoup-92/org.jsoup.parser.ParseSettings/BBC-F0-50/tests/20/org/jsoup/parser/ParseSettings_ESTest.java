...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.htmlDefault;
      String string0 = parseSettings0.normalizeAttribute("buX7WkB:r^");
      assertEquals("bux7wkb:r^", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.htmlDefault.normalizeTag(">K1YOo 9mGggmncY/");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals(">k1yoo 9mgggmncy/", string0);
  }
