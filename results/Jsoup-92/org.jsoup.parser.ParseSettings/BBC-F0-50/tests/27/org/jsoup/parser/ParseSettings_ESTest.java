...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Attribute attribute0 = Attribute.createFromEncoded("org.jsoup.nodes.Document$QuirksMode", "Y&wE=:4HJ");
  ...
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.preserveCase.normalizeAttribute("cM?J(f(FZTgs/j.^^u");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("cM?J(f(FZTgs/j.^^u", string0);
  }
