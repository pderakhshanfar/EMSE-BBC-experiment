...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, false);
      String string0 = parseSettings0.normalizeAttribute("ZVK#p\"=M!1y-1+n");
      assertEquals("zvk#p\"=m!1y-1+n", string0);
      assertTrue(parseSettings0.preserveTagCase());
  }
  ...
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      String string0 = parseSettings0.htmlDefault.normalizeTag("~/Ade,vT$G#a!");
      assertEquals("~/ade,vt$g#a!", string0);
