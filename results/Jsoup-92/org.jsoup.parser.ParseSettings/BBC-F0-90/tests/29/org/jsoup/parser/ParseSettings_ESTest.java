...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.preserveCase.normalizeAttribute("ND`GPO@K;v<5D");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("ND`GPO@K;v<5D", string0);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.normalizeTag("ND`GPO@K;v<5D");
      assertEquals("ND`GPO@K;v<5D", string0);
  }
