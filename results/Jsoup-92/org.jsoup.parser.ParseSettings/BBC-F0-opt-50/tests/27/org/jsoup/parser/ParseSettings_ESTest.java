...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      parseSettings0.htmlDefault.normalizeAttribute("-(3o");
      assertFalse(parseSettings0.preserveTagCase());
  }
  ...
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      String string0 = parseSettings0.preserveCase.normalizeAttribute("&|%;qj@U");
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("&|%;qj@U", string0);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, false);
      String string0 = parseSettings0.preserveCase.normalizeTag("UH9%G'_@");
      assertEquals("UH9%G'_@", string0);
      assertFalse(parseSettings0.preserveTagCase());
  }
