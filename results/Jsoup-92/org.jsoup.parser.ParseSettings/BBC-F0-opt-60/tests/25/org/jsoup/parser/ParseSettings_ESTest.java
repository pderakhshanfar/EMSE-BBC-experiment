...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      String string0 = parseSettings0.preserveCase.normalizeAttribute("sortable");
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      String string0 = parseSettings0.normalizeTag("K`r0.+M");
      assertEquals("K`r0.+M", string0);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.htmlDefault.normalizeTag(" cYJ2/Wn`:O,po");
      assertEquals("cyj2/wn`:o,po", string0);
      assertTrue(parseSettings0.preserveTagCase());
  }
