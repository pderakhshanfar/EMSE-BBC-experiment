...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Attributes attributes0 = new Attributes();
      Attributes attributes1 = attributes0.put("'Kcy%G+|ks)RK'YKDa!", "'Kcy%G+|ks)RK'YKDa!");
  ...
  public void test08()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      String string0 = parseSettings0.normalizeAttribute("'Kcy%G+|ks)RK'YKDa!");
      assertEquals("'Kcy%G+|ks)RK'YKDa!", string0);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      String string0 = parseSettings0.normalizeTag("'Kcy%G+|ks)RK'YKDa!");
      assertEquals("'Kcy%G+|ks)RK'YKDa!", string0);
  }
