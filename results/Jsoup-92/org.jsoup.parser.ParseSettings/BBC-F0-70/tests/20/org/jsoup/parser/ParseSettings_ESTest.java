...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, false);
      String string0 = parseSettings0.normalizeAttribute("vN mBQH`%Bor iY^qs");
      assertEquals("vn mbqh`%bor iy^qs", string0);
      assertTrue(parseSettings0.preserveTagCase());
  }
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.preserveCase.normalizeTag("C<K%_7fcY");
      assertEquals("C<K%_7fcY", string0);
      assertTrue(parseSettings0.preserveTagCase());
  }
