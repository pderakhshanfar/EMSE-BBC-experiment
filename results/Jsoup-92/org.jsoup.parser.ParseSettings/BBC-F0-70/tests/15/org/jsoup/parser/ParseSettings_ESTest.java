...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Attribute attribute0 = new Attribute("noshade", "CI%w=HU`MTBDO x4w", attributes0);
  ...
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.htmlDefault;
      String string0 = parseSettings0.normalizeAttribute("Ug7j");
      assertEquals("ug7j", string0);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      String string0 = "$$NRS\\uwGE&-Ls`'";
      String string1 = parseSettings0.preserveCase.normalizeAttribute(string0);
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("$$NRS\\uwGE&-Ls`'", string1);
  }
  ...
  public void test12()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.normalizeTag("f&5YIb");
      assertEquals("f&5YIb", string0);
  }
