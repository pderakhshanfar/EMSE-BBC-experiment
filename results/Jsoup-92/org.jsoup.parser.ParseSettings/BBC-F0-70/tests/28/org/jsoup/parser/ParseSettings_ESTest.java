...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Attributes attributes1 = attributes0.put("0GnDsMt3X-aI%p`,b", "0GnDsMt3X-aI%p`,b");
  ...
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      String string0 = parseSettings0.htmlDefault.normalizeAttribute("`.v*cg7t[[q 'UXBS}8");
      assertEquals("`.v*cg7t[[q 'uxbs}8", string0);
      assertFalse(parseSettings0.preserveTagCase());
  }
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      String string0 = parseSettings0.preserveCase.normalizeTag("Mwh:,:Y");
      assertEquals("Mwh:,:Y", string0);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      parseSettings0.normalizeTag("open");
      assertFalse(parseSettings0.preserveTagCase());
  }
