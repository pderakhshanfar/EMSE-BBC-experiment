...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, false);
      String string0 = parseSettings0.preserveCase.normalizeAttribute("%QK-)FzN{;8{e_vW'{");
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("%QK-)FzN{;8{e_vW'{", string0);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, false);
      String string0 = parseSettings0.htmlDefault.normalizeTag("vWs!5/");
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("vws!5/", string0);
  }
