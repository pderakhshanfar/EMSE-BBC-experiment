...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Attribute attribute0 = Attribute.createFromEncoded("Y_):B'6C3:dhp1 ", "");
  ...
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.normalizeAttribute("Kd2X=A/");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("Kd2X=A/", string0);
  }
  ...
  public void test11()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.preserveCase.normalizeTag("p)3CLQYk(C6Sk*ss=4w");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("p)3CLQYk(C6Sk*ss=4w", string0);
  }
