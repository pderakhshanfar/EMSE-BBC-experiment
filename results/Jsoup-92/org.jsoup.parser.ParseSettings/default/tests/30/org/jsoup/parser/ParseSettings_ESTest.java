...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, false);
      String string0 = parseSettings0.htmlDefault.normalizeAttribute("A\"`bVc`Cag7tmY<R'4[");
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("a\"`bvc`cag7tmy<r'4[", string0);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      String string0 = parseSettings0.normalizeAttribute("sf??q}OVnP)&?|");
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("sf??q}OVnP)&?|", string0);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      String string0 = parseSettings0.normalizeTag("autofocus");
