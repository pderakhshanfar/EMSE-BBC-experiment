...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      Attributes attributes0 = new Attributes();
      attributes0.put(":N_8H=u QLn2(Ne", ":N_8H=u QLn2(Ne");
      parseSettings0.normalizeAttributes(attributes0);
  }
  ...
  public void test07()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.htmlDefault.normalizeAttribute(":N_8H=u QLn2(Ne");
      assertEquals(":n_8h=u qln2(ne", string0);
      assertTrue(parseSettings0.preserveTagCase());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      String string0 = parseSettings0.preserveCase.normalizeTag(";p@QU$vq");
      assertEquals(";p@QU$vq", string0);
      assertTrue(parseSettings0.preserveTagCase());
  }
