...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.preserveCase.normalizeAttribute("54WOdW");
      assertEquals("54WOdW", string0);
      assertTrue(parseSettings0.preserveTagCase());
  }
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.htmlDefault.normalizeTag("Zj_8r>Z<^@G");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("zj_8r>z<^@g", string0);
  }
