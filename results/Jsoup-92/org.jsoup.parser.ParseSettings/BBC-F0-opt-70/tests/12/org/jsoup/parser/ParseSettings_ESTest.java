...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      String string0 = parseSettings0.htmlDefault.normalizeAttribute("}XDpDw>6`*+wT'");
      assertEquals("}xdpdw>6`*+wt'", string0);
      assertFalse(parseSettings0.preserveTagCase());
  }
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      String string0 = parseSettings0.htmlDefault.normalizeTag("}XDpDw>6`*+wT'");
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("}xdpdw>6`*+wt'", string0);
  }
