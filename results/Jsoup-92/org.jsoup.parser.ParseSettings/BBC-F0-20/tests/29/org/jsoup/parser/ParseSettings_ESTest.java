...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      String string0 = parseSettings0.htmlDefault.normalizeAttribute("* *.;Cr6e0~CX'zb");
      assertEquals("* *.;cr6e0~cx'zb", string0);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      String string0 = parseSettings0.htmlDefault.normalizeTag("8^d{XguE5j*");
      assertEquals("8^d{xgue5j*", string0);
  }
