...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.preserveCase.normalizeAttribute("Hl%(y5io");
      assertEquals("Hl%(y5io", string0);
      assertTrue(parseSettings0.preserveTagCase());
  }
  ...
  public void test12()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.preserveCase.normalizeTag("Hl%(y5io");
      assertEquals("Hl%(y5io", string0);
      assertTrue(parseSettings0.preserveTagCase());
  }
