...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      Attribute attribute0 = Attribute.createFromEncoded("q4-agsqc!WFX*2", "q4-agsqc!WFX*2");
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      String string0 = parseSettings0.preserveCase.normalizeAttribute("7c_1{h");
      assertEquals("7c_1{h", string0);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      String string0 = parseSettings0.preserveCase.normalizeTag(".zaS?H]=ce~T,(`:");
      assertEquals(".zaS?H]=ce~T,(`:", string0);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, false);
      String string0 = parseSettings0.normalizeAttribute("#Cn[acC@@");
      assertEquals("#cn[acc@@", string0);
      assertFalse(parseSettings0.preserveTagCase());
  }
