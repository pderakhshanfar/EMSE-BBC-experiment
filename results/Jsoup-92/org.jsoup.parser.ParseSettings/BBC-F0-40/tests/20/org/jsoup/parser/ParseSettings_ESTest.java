...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, false);
      String string0 = parseSettings0.preserveCase.normalizeAttribute("PQ(b[Z4A`#=");
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("PQ(b[Z4A`#=", string0);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.htmlDefault;
      String string0 = parseSettings0.normalizeTag("pJ6@=1-F$t");
      assertEquals("pj6@=1-f$t", string0);
  }
