...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, false);
      String string0 = parseSettings0.normalizeAttribute("Os!k*XqaZY");
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("os!k*xqazy", string0);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      String string0 = parseSettings0.normalizeAttribute("wZ@]");
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = ParseSettings.preserveCase;
      String string0 = parseSettings0.preserveCase.normalizeTag("(crz+(/zl']+hR");
      assertEquals("(crz+(/zl']+hR", string0);
  }
