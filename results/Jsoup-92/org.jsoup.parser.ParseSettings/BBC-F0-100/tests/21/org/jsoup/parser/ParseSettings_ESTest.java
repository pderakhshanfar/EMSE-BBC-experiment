...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.preserveCase.normalizeTag("0EtVD*#+I");
      assertEquals("0EtVD*#+I", string0);
      assertTrue(parseSettings0.preserveTagCase());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      String string0 = parseSettings0.normalizeAttribute("@Q&ISTh#<^!#3$%");
      assertEquals("@q&isth#<^!#3$%", string0);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.normalizeAttribute("9(C");
