...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.normalizeAttribute("{]Y *u_y:8%TuY+(R");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("{]Y *u_y:8%TuY+(R", string0);
  }
  ...
  public void test11()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.normalizeTag("/FV_~p<qS'");
      assertEquals("/FV_~p<qS'", string0);
  }
