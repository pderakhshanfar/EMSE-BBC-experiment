...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, false);
      String string0 = parseSettings0.normalizeAttribute("Yp3{[");
      assertEquals("yp3{[", string0);
      assertTrue(parseSettings0.preserveTagCase());
  }
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.htmlDefault.normalizeTag("KmfYCi%e*RnZ`X}4S");
      assertEquals("kmfyci%e*rnz`x}4s", string0);
      assertTrue(parseSettings0.preserveTagCase());
  }
