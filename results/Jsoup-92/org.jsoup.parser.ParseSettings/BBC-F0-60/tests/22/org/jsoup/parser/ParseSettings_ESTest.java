...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, false);
      String string0 = parseSettings0.preserveCase.normalizeAttribute("2%GLWu_b\u0007@P");
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("2%GLWu_b\u0007@P", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      String string0 = parseSettings0.htmlDefault.normalizeTag("}7=R(GU*x\"^)d8#4");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("}7=r(gu*x\"^)d8#4", string0);
  }
