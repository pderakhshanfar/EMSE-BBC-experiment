...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      attributes0.put("~BQh:m$]~s3A[q? z", "!)?H");
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, true);
      String string0 = parseSettings0.htmlDefault.normalizeTag("J~|vD");
      assertFalse(parseSettings0.preserveTagCase());
      assertEquals("j~|vd", string0);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.normalizeTag("k}V8x-|q ST#O`T");
      assertEquals("k}V8x-|q ST#O`T", string0);
  }
