...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      attributes0.put("GZ^>X^=,.xL:?M`", true);
  ...
  public void test07()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(false, false);
      String string0 = parseSettings0.normalizeAttribute("t8~WEOvTsmYU tcSL");
      assertEquals("t8~weovtsmyu tcsl", string0);
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.preserveCase.normalizeTag("GZ^>X^=,.xL:?M`");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("GZ^>X^=,.xL:?M`", string0);
  }
