...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.normalizeAttribute("}d;rn&1WD<(C5[nXy$");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("}d;rn&1WD<(C5[nXy$", string0);
  }
  ...
  public void test12()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.normalizeTag("j|Jhf\"h(k[2~^o1,F");
      assertEquals("j|Jhf\"h(k[2~^o1,F", string0);
  }
