...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      parseSettings0.htmlDefault.normalizeAttribute("9`t\"q{`js*@a.aa");
      assertTrue(parseSettings0.preserveTagCase());
  }
  ...
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.htmlDefault.normalizeTag("9`t\"q{`JS*@A.aA");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("9`t\"q{`js*@a.aa", string0);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      parseSettings0.normalizeTag("9`t\"q{`js*@a.aa");
      assertTrue(parseSettings0.preserveTagCase());
  }
