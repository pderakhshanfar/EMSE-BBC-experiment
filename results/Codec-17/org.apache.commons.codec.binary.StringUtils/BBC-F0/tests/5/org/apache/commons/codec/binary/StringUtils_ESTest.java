...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("|-G;1dRA V:V@$w{");
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("!V", "UTF-16LE");
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("\u11FE\u00D2\uFFFD", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) "u\u0000uu\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000", (CharSequence) charBuffer0);
  ...
  public void test32()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate((byte)117);
      boolean boolean0 = StringUtils.equals((CharSequence) "u\u0000uu", (CharSequence) charBuffer0);
  ...
  public void test33()  throws Throwable  {
      ...
      boolean boolean0 = StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "f;oEOA7OGy]a,");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "f;oEOA7OGy]a,", (CharSequence) null);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test35()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "yV{7wr/)E!#:{=#0D`");
      assertFalse(boolean0);
  }
  ...
  public void test37()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "f;oEOA7OGy]a,", (CharSequence) "f;oEOA7OGy]a,");
      assertTrue(boolean0);
  }
  ...
  public void test45()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("?wH`*4|i.");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "\u3F77\u4860\u2A34\u7C69\uFFFD");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // \u3F77\u4860\u2A34\u7C69\uFFFD: java.io.UnsupportedEncodingException: \u3F77\u4860\u2A34\u7C69\uFFFD
         //
  ...
  public void test48()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "joNxf");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // joNxf: java.io.UnsupportedEncodingException: joNxf
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("|-G;1dRA V:V@$w{");
      assertEquals(32, byteArray0.length);
  }
}
