...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("(h@5d77");
      assertArrayEquals(new byte[] {(byte)40, (byte)104, (byte)64, (byte)53, (byte)100, (byte)55, (byte)55}, byteArray0);
  }
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("Rj4");
      assertArrayEquals(new byte[] {(byte) (-2), (byte) (-1), (byte)0, (byte)82, (byte)0, (byte)106, (byte)0, (byte)52}, byteArray0);
  }
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("JRg=w?ui;K3kC%x*s", "US-ASCII");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("5BtWUqG9", "NB");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // NB: java.io.UnsupportedEncodingException: NB
         //
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) "(h@5d77", (CharSequence) charBuffer0);
  ...
  public void test27()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "v|\"i9#9P;~d)");
      assertNull(string0);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "\uB887\uFFFD");
      assertNull(byteArray0);
  }
  ...
  public void test30()  throws Throwable  {
      char[] charArray0 = new char[2];
      CharBuffer charBuffer0 = CharBuffer.wrap(charArray0);
      boolean boolean0 = StringUtils.equals((CharSequence) "(h@5d77", (CharSequence) charBuffer0);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate(5862);
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "NB", (CharSequence) null);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "^ubz[9F/", (CharSequence) "^ubz[9F/");
      assertTrue(boolean0);
  }
  ...
  public void test38()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("JRg=w?ui;K3kC%x*s");
  ...
  public void test44()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("Oq;;/ljY$xZyw.");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("Oq;;/ljY$xZyw.", string0);
  }
  ...
  public void test47()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("Oq;;/ljY$xZyw.");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("O\u0000q\u0000;\u0000;\u0000/\u0000l\u0000j\u0000Y\u0000$\u0000x\u0000Z\u0000y\u0000w\u0000.\u0000", string0);
  }
  ...
  public void test48()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "Rj4");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Rj4: java.io.UnsupportedEncodingException: Rj4
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test49()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("^ubz[9F/");
