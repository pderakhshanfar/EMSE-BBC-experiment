...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le(" sDV[hQ8_fxicREC");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals(" \u0000s\u0000D\u0000V\u0000[\u0000h\u0000Q\u00008\u0000_\u0000f\u0000x\u0000i\u0000c\u0000R\u0000E\u0000C\u0000", string0);
  }
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("3e4i");
      assertArrayEquals(new byte[] {(byte)51, (byte)101, (byte)52, (byte)127, (byte)105}, byteArray0);
  }
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("WyBH&\"");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u7957\u4842\u2226", string0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "sSg");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // sSg: java.io.UnsupportedEncodingException: sSg
         //
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) "<jnD/({qJ!j%W04C&", (CharSequence) charBuffer0);
  ...
  public void test29()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "*", (CharSequence) "\u6277\u2963\u4C3C\u6C7D\uFFFD");
  ...
  public void test31()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "Q[>|wZ_f$O|X4", (CharSequence) null);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "\u01BB\uFF9F\u9F6E");
      assertFalse(boolean0);
  }
  ...
  public void test40()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("<jnD/({qJ!j%W04C&");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\uFEFF<jnD/({qJ!j%W04C&", string0);
  }
  ...
  public void test45()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("ISO-8859-1", "V([YM+SY");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // V([YM+SY: java.io.UnsupportedEncodingException: V([YM+SY
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
