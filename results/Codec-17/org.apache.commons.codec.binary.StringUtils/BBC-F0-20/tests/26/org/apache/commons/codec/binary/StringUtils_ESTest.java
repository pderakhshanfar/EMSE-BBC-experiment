...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("", "_4O/[GC^W.");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // _4O/[GC^W.: java.io.UnsupportedEncodingException: _4O/[GC^W.
         //
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("Sgml1nH'iOC-");
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("_4O/[GC^W.");
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("mI8pX())7Xy");
  ...
  public void test24()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("=]3Gt=+b<lx");
      assertEquals(11, byteArray0.length);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "+>^IJ;h|/#U!c");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // +>^IJ;h|/#U!c: java.io.UnsupportedEncodingException: +>^IJ;h|/#U!c
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "kS ?}DRD\"nH");
  ...
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "fVQ-HKthH6lz>,k3k");
      assertNull(byteArray0);
  }
  ...
  public void test34()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate(1);
      boolean boolean0 = StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "kS ?}DRD\"nH");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test35()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) ".Ra^);sywC$kL[^dWX{", (CharSequence) null);
      assertFalse(boolean0);
  }
  ...
  public void test37()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "#vi", (CharSequence) "#vi");
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "=]3Gt=+b<lx", (CharSequence) "kS ?}DRD\"nH");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("<),xFcThV!9ml-wf");
      // Undeclared exception!
      try { 
  ...
  public void test45()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be(".Ra^);sywC$kL[^dWX{");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals(".Ra^);sywC$kL[^dWX{", string0);
  }
  ...
  public void test50()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("O[=9<&{a1vl#<");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("\u0000O\u0000[\u0000=\u0000\u00009\u0000<\u0000&\u0000{\u0000a\u00001\u0000v\u0000l\u0000#\u0000<", string0);
  }
}
