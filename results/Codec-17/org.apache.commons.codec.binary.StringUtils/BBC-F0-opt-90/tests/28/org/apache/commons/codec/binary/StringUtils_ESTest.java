...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("QtL8\"H");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u5100\u7400\u4C00\u3800\u2200\u4800", string0);
  }
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("vgdbv^:9,H");
      String string0 = StringUtils.newString(byteArray0, "UTF-16BE");
      assertEquals("\u7600\u6700\u6400\u6200\u7600\u5E00\u3A00\u3900\u2C00\u4800", string0);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("\u6200\u7B00\u4900\u7700\u5A00\u3A00\u3000\u4600\u6100\u2800\u6F00\u7E00\u6400\u7500\u3E00\u5400\u3C00\u5C00");
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("f%+V,v'um*", "UTF-16");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "DOAml:e}>'d");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // DOAml:e}>'d: java.io.UnsupportedEncodingException: DOAml:e}>'d
         //
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("owT}a[oFu['Y{YA,X;y", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, " s.Q^0I");
      assertNull(string0);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "qpJ[3 |z*f(*cH");
      assertNull(byteArray0);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("u(V#Px#TC!");
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) "b\u0000{\u0000I\u0000w\u0000Z\u0000:\u00000\u0000F\u0000a\u0000(\u0000o\u0000~\u0000d\u0000u\u0000>\u0000T\u0000<\u0000\u0000", (CharSequence) charBuffer0);
  ...
  public void test32()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "2h+5)nJA9 GTjM]", (CharSequence) null);
  ...
  public void test37()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("fj`M}9[kV");
  ...
  public void test45()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii(" s.Q^0I");
      assertArrayEquals(new byte[] {(byte)32, (byte)115, (byte)46, (byte)81, (byte)94, (byte)48, (byte)73}, byteArray0);
  }
  ...
  public void test48()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "HL$Ll");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // HL$Ll: java.io.UnsupportedEncodingException: HL$Ll
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
