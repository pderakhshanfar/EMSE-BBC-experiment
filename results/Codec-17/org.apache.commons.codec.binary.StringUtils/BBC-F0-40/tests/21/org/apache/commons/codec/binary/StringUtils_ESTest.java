...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("P,v^7;F;");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("P\u0000,\u0000v\u0000^\u00007\u0000;\u0000F\u0000;\u0000", string0);
  }
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("GR\u0000\u0000\uFFFD");
      assertEquals(5, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("US-ASCII", "UTF-16LE");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "En/cRsK");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // En/cRsK: java.io.UnsupportedEncodingException: En/cRsK
         //
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("M+rlbHpA,lVP_\"V", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "tM$BSb]p*4f");
      assertNull(string0);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) "\u4700\u5200\u0000\u0000\uFFFD", (CharSequence) charBuffer0);
  ...
  public void test33()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "Ub6_%*nh|xe@!0Xh", (CharSequence) null);
  ...
  public void test35()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) ",YKi*B?@x]EE4wJJLCC", (CharSequence) ",YKi*B?@x]EE4wJJLCC");
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test36()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "tM$BSb]p*4f", (CharSequence) "UTF-16LE");
      assertFalse(boolean0);
  }
  ...
  public void test42()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be(",YKi*B?@x]EE4wJJLCC");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals(",YKi*B?@x]EE4wJJLCC", string0);
  }

  @Test(timeout = 4000)
  public void test43()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le(" `jk{A");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u2000\u6000\u6A00\u6B00\u7B00\u4100", string0);
  }

  @Test(timeout = 4000)
  public void test44()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("2TOP");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u5432\u504F", string0);
  }
  ...
  public void test48()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("w,(t%V0&G", "TC`@OdpOD^:JJR");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // TC`@OdpOD^:JJR: java.io.UnsupportedEncodingException: TC`@OdpOD^:JJR
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
