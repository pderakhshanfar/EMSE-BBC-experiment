...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("\u00FF\u0001\u0001n", "\uFF01\u016E");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // \uFF01\u016E: java.io.UnsupportedEncodingException: \uFF01\u016E
         //
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("}Ef<e6/oXK");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("}Ef<e6/oXK", string0);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("4]\"oV");
      String string0 = StringUtils.newString(byteArray0, "UTF-16LE");
      assertEquals("\uFFFD\u3400\u5D00\u2200\u6F00\u5600", string0);
  }
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("}:3^0u/p");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("\u0000}\u0000:\u00003\u0000^\u00000\u0000u\u0000/\u0000p", string0);
  }
  ...
  public void test24()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("JS[pk7<o.9%V");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "Qyj");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Qyj: java.io.UnsupportedEncodingException: Qyj
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate((byte)28);
      charBuffer0.compact();
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "MEoMwX<G`");
  ...
  public void test34()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate((byte)28);
      boolean boolean0 = StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "MEoMwX<G`");
  ...
  public void test36()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "}Ef<e6/oXK", (CharSequence) "}Ef<e6/oXK");
      assertTrue(boolean0);
  }
  ...
  public void test39()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("}Ef<e6/oXK");
  ...
  public void test46()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("tz");
  ...
  public void test48()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("MEoMwX<G`");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("\uFFFD\uFFFD\u0000M\u0000E\u0000o\u0000M\u0000w\u0000X\u0000<\u0000G\u0000`", string0);
  }
