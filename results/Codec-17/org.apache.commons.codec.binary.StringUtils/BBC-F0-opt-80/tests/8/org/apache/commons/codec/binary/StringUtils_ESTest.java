...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("og;0O(y-j");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u676F\u303B\u284F\u2D79\uFFFD", string0);
  }
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8(":;vswc@kxIlsYnB6");
      String string0 = StringUtils.newString(byteArray0, "US-ASCII");
      assertEquals(":;vswc@kxIlsYnB6", string0);
  }
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("w$Mj2(MuBQUcRK-9[V", "UTF-16LE");
  ...
  public void test37()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("BH`x*");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("BH`x*", string0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("V1-fO-g!A*J(");
  ...
  public void test49()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("CVd;*;!WI6");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "k#b%");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // k#b%: java.io.UnsupportedEncodingException: k#b%
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
