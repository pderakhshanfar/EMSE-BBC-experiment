...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("JnxaDpD!^SSm9l;Z");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u4A6E\u787F\u6144\u7044\u215E\u5353\u6D39\u6C3B\uFFFD", string0);
  }
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("WF/xSFa^]F");
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("\u00F5\u00ACn\u00F5\u0001\u0000\u0006X");
      assertArrayEquals(new byte[] {(byte)63, (byte)63, (byte)110, (byte)63, (byte)1, (byte)0, (byte)6, (byte)88}, byteArray0);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("\uE400\uFF9F\u7200\u0B63\uFFFD", "UTF-16");
      assertEquals(12, byteArray0.length);
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked(": ", "<:Exf,,");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // <:Exf,,: java.io.UnsupportedEncodingException: <:Exf,,
         //
  ...
  public void test29()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "[_d");
      assertNull(string0);
  }
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked(";J'l\u0002\"m'2v}", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "\u00B8\u0081\u00DD\u0001\u0001\u0001\u0001");
      boolean boolean0 = StringUtils.equals((CharSequence) "\u00B8\u0081\u00DD\u0001\u0001\u0001\u0001", (CharSequence) charBuffer0);
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "", (CharSequence) "WF/xSFa^]F");
  ...
  public void test36()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "fHi;");
      assertFalse(boolean0);
  }
  ...
  public void test42()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("\u1880");
  ...
  public void test50()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "WF/xSFa^]F");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // WF/xSFa^]F: java.io.UnsupportedEncodingException: WF/xSFa^]F
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
