...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("^O#", "V5foSRmKo`rWT6z5+`>");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // V5foSRmKo`rWT6z5+`>: java.io.UnsupportedEncodingException: V5foSRmKo`rWT6z5+`>
         //
  ...
  public void test04()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16(";Ru,llXVySN?");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\uFEFF;Ru,llXVySN?", string0);
  }
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("uGkn%Z");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("uGkn%Z", string0);
  }
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("\u00AC\u0000P\u0001\u00CB");
      assertArrayEquals(new byte[] {(byte) (-62), (byte) (-84), (byte)0, (byte)80, (byte)1, (byte) (-61), (byte) (-117)}, byteArray0);
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("^v'mMz)\"cjVhN", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16(";Ru,llXVySN?");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("\uFFFD\uFFFD\u0000;\u0000R\u0000u\u0000,\u0000l\u0000l\u0000X\u0000V\u0000y\u0000S\u0000N\u0000?", string0);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      CharBuffer charBuffer0 = CharBuffer.wrap(charArray0);
      boolean boolean0 = StringUtils.equals((CharSequence) "\u01B1\u0000\uFB15", (CharSequence) charBuffer0);
  ...
  public void test36()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "\u00FF\u0001\u00A5\u00FA\u0092\u0000\u009E");
      assertFalse(boolean0);
  }
  ...
  public void test40()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("~M5Kg8S:xa<S\".o");
  ...
  public void test42()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("DI'");
      assertArrayEquals(new byte[] {(byte)68, (byte)73, (byte)39}, byteArray0);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "GCPt{NE} 3?");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // GCPt{NE} 3?: java.io.UnsupportedEncodingException: GCPt{NE} 3?
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
