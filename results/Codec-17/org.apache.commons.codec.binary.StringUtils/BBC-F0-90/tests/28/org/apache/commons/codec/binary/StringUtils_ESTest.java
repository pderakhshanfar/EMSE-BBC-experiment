...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("$R+ _Q|VAN`'lgu");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u2452\u2B20\u5F51\u7C56\u414E\u6027\u6C67\uFFFD", string0);
  }
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("]va-0bCcK00", "UTF-16BE");
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1(",4-ZF{2");
      assertArrayEquals(new byte[] {(byte)44, (byte)52, (byte)45, (byte)90, (byte)70, (byte)123, (byte)50}, byteArray0);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "xY");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // xY: java.io.UnsupportedEncodingException: xY
         //
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("qDRg0*j%Q/}", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      ...
      CharBuffer charBuffer1 = CharBuffer.wrap((CharSequence) "\u0000\uFFFD", (int) (byte)0, (int) (byte)0);
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      boolean boolean0 = StringUtils.equals((CharSequence) "\uFFFD\u00FF\u8052\u0000\uFFFD", (CharSequence) charBuffer0);
  ...
  public void test32()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) ",4-ZF{2", (CharSequence) null);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "UTF-8", (CharSequence) "U\u0000T\u0000F\u0000-\u00008\u0000");
      assertFalse(boolean0);
  }
  ...
  public void test35()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "Lg4j_E~#~6b&4NDSXm");
      assertFalse(boolean0);
  }
  ...
  public void test37()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("U\u0000T\u0000F\u0000-\u00008\u0000");
      assertEquals(22, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("Oat");
      assertEquals("java.nio.HeapByteBuffer[pos=0 lim=3 cap=3]", byteBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("Lg4j_E~#~6b&4NDSXm");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("Lg4j_E~#~6b&4NDSXm", string0);
  }
  ...
  public void test45()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("5en");
      assertArrayEquals(new byte[] {(byte)53, (byte)101, (byte)110}, byteArray0);
  }
  ...
  public void test48()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("(zK3]Coe0~", "Lg4j_E~#~6b&4NDSXm");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Lg4j_E~#~6b&4NDSXm: java.io.UnsupportedEncodingException: Lg4j_E~#~6b&4NDSXm
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
