...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("Wp;m_I(7kun-Yl v9", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "", (CharSequence) "\u00DA");
  ...
  public void test53()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked(",g (pbm/(3O]S", "bk(\"{] :6?h(S24,;r");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // bk(\"{] :6?h(S24,;r: java.io.UnsupportedEncodingException: bk(\"{] :6?h(S24,;r
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
