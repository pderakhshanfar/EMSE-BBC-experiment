...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("PPt5jMK");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("\u0000P\u0000P\u0000t\u00005\u0000j\u0000M\u0000K", string0);
  }
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("!7RlrufJiNtyh");
  ...
  public void test21()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("KCj");
      assertArrayEquals(new byte[] {(byte)75, (byte)67, (byte)106}, byteArray0);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("EN/qBy", "UTF-16LE");
  ...
  public void test29()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) ">RM#@2o5gy]YuC}M");
      charBuffer0.flip();
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) ">RM#@2o5gy]YuC}M", (CharSequence) charBuffer0);
  ...
  public void test30()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "/a1P`.(Ic?lE[Z3");
      assertNull(string0);
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("TCy,;s5J's");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "TCy,;s5J's");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // TCy,;s5J's: java.io.UnsupportedEncodingException: TCy,;s5J's
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test37()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "UF-16jE");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "I{(B_GOhhx'", (CharSequence) "I{(B_GOhhx'");
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "Tb&", (CharSequence) null);
      assertFalse(boolean0);
  }
  ...
  public void test41()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("f%[XGR");
      assertFalse(byteBuffer0.isReadOnly());
  }

  @Test(timeout = 4000)
  public void test42()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("TCy,;s5J's");
