...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("c|", "&7t[j3]z*~K@h]X");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // &7t[j3]z*~K@h]X: java.io.UnsupportedEncodingException: &7t[j3]z*~K@h]X
         //
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("_I1b5 #w}f55oUnq");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("\u0000_\u0000I\u00001\u0000b\u00005\u0000 \u0000#\u0000w\u0000}\u0000f\u00005\u00005\u0000o\u0000U\u0000n\u0000q", string0);
  }
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("#WO-8M{U,`[L", "ISO-8859-1");
  ...
  public void test28()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("BR\"U3y'*");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u4252\u2255\u3379\u272A", string0);
  }
  ...
  public void test34()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "x.9/+_G+", (CharSequence) "x.9/+_G+");
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test35()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "x.9/+_G+", (CharSequence) null);
      assertFalse(boolean0);
  }
  ...
  public void test37()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("B55nQ1Epr)s+JVCB_2&=");
      assertEquals(42, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("1`u/xfNb{49@#");
      assertFalse(byteBuffer0.isDirect());
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("tUM\u0003If");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "tUM\u0003If");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // tUM\u0003If: java.io.UnsupportedEncodingException: tUM\u0003If
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test40()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1(")UM\u0003If");
