...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("bYg1xxwXF2:6|uQ", "_[-/)o ho");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // _[-/)o ho: java.io.UnsupportedEncodingException: _[-/)o ho
         //
  ...
  public void test11()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("}t=n#0WCC ");
      String string0 = StringUtils.newString(byteArray0, "UTF-16BE");
      assertEquals("\u7D74\u3D6E\u2330\u5743\u4320", string0);
  }
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("mc+4W+q`fF/<w#");
  ...
  public void test22()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("\u0000\uCF02\uD600\uFFFD", "ISO-8859-1");
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("}o@'r7{T]kP5qi+B", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "ISO-8859-1", 0, 0);
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "jmN&2$dK+Czg^P~a");
      assertNull(byteArray0);
  }
