...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("~sQr.");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("~sQr.", string0);
  }
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("gT!-", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate((byte)24);
      CharBuffer charBuffer1 = CharBuffer.allocate((byte)24);
  ...
  public void test43()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("~sQr.");
  ...
  public void test49()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "~sQr.");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // ~sQr.: java.io.UnsupportedEncodingException: ~sQr.
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
