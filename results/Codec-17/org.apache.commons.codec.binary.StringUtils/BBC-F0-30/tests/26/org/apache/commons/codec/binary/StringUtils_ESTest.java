...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("|WW==}qx6Dr;{", "UTF-16LE");
  ...
  public void test22()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("^}qfA@wX8O%");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "^}qfA@wX8O%");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // ^}qfA@wX8O%: java.io.UnsupportedEncodingException: ^}qfA@wX8O%
         //
  ...
  public void test24()  throws Throwable  {
      ...
      CharBuffer charBuffer1 = CharBuffer.wrap((CharSequence) charBuffer0, 1181, 1181);
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) "s:Vm'Nin+Y3", (CharSequence) charBuffer1);
  ...
  public void test32()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "\u5C7C\u5757\u3D3D\u717D\u3678\u7244\u7B3B", (int) (byte)0, (int) (byte)1);
      boolean boolean0 = StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "|WW==}qx6Dr;{");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "\uFFFD\u7D00\u2600\u2300\u3300\u2400\u7600", (CharSequence) null);
      assertFalse(boolean0);
  }
  ...
  public void test35()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "|WW==}qx6Dr;{", (CharSequence) "|WW==}qx6Dr;{");
      assertTrue(boolean0);
  }
  ...
  public void test37()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("\u7800:\uFFFD");
      assertEquals("java.nio.HeapByteBuffer[pos=0 lim=7 cap=7]", byteBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("xQ5");
      assertEquals(3, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("^z-@>9K2&&f_k{vdj");
  ...
  public void test47()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("UTF-16BE", "&DESKqrHI jNl");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // &DESKqrHI jNl: java.io.UnsupportedEncodingException: &DESKqrHI jNl
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test48()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("y|ShhVSI#k^FvH");
