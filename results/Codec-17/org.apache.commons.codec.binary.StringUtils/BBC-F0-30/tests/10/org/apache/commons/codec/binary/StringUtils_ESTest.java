...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("fwAoQhv=&j|ms7");
  ...
  public void test18()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("A~,z79 @(<rSV]Q@O", "UTF-16BE");
  ...
  public void test21()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("xi{");
      assertArrayEquals(new byte[] {(byte)120, (byte)105, (byte)123}, byteArray0);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("9h>}");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "#^j)t(bt|=t=_*");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // #^j)t(bt|=t=_*: java.io.UnsupportedEncodingException: #^j)t(bt|=t=_*
         //
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("(}X]-0", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate(4664);
      boolean boolean0 = StringUtils.equals((CharSequence) "3sc ~NQg", (CharSequence) charBuffer0);
  ...
  public void test36()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "!)/0gdwA}>3tG", (CharSequence) "\u2100\u2900\u2F00\u3000\u6700\u6400\u7700\u4100\u7D00\u3E00\u3300\u7400\u4700");
      assertFalse(boolean0);
  }
  ...
  public void test38()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("\"9YwJB p~(u%$");
  ...
  public void test48()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("mo<a4XR}cN'o", "|$OM*Tj'(l7O");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // |$OM*Tj'(l7O: java.io.UnsupportedEncodingException: |$OM*Tj'(l7O
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
