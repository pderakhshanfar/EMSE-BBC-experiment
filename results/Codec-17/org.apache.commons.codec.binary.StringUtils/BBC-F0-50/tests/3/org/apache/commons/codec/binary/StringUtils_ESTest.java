...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("5;IB");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("5;IB", string0);
  }
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("3NV^e");
      assertArrayEquals(new byte[] {(byte)51, (byte)78, (byte)86, (byte)94, (byte)101}, byteArray0);
  }
  ...
  public void test13()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("~:983NHVFI% 7ra");
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("t\u0000\u00FF\u0000");
      assertArrayEquals(new byte[] {(byte) (-2), (byte) (-1), (byte)0, (byte)116, (byte)0, (byte)0, (byte)0, (byte) (-1), (byte)0, (byte)0}, byteArray0);
  }
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("&:!Ep#4tF4o");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("&:!Ep#4tF4o", string0);
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "DTs?_\"[");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // DTs?_\"[: java.io.UnsupportedEncodingException: DTs?_\"[
         //
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "1T)L+g'Z4RHxF.");
  ...
  public void test27()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "\u0000\u0000\uFFFD\u0001\uFFFDw");
      assertNull(string0);
  }
  ...
  public void test32()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate(1);
      boolean boolean0 = StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "1T)L+g'Z4RHxF.");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "\u3A20", (CharSequence) null);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "\u0000T\uFFFD\u0001\uFFFD\u0001\u0000\u0000");
      assertFalse(boolean0);
  }
  ...
  public void test36()  throws Throwable  {
      ...
      boolean boolean0 = StringUtils.equals((CharSequence) "1T)L+g'Z4RH|xF.", (CharSequence) charBuffer0);
      assertFalse(boolean0);
  }
  ...
  public void test50()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("b9B");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "2ZJ20t8#");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 2ZJ20t8#: java.io.UnsupportedEncodingException: 2ZJ20t8#
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
