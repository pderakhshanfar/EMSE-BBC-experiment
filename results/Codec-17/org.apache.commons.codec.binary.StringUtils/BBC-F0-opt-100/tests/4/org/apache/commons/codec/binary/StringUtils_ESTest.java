...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("j[ce-4Q&Ts;qr");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u6A5B\u6365\u2D34\u5126\u5473\u3B71\uFFFD", string0);
  }
  ...
  public void test06()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("w5<BzC??+RKcx&");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("w5<BzC??+RKcx&", string0);
  }
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("pj:2}");
      assertArrayEquals(new byte[] {(byte)0, (byte)112, (byte)0, (byte)106, (byte)0, (byte)58, (byte)0, (byte)50, (byte)0, (byte)125}, byteArray0);
  }
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("Y6<{H/e");
  ...
  public void test27()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "\u7801", (int) (byte)1, 1);
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "\u7801");
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("B", "k&)lA).rCu+Km0`");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // k&)lA).rCu+Km0`: java.io.UnsupportedEncodingException: k&)lA).rCu+Km0`
         //
  ...
  public void test31()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("l8z]HRf$g1g=~1m[~r<");
  ...
  public void test33()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "w5<BzC??+RKcx&", (CharSequence) "");
  ...
  public void test40()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("& rO\"9UXhEeXf`hg-[");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u2600\u2000\u7200\u4F00\u2200\u3900\u5500\u5800\u6800\u4500\u6500\u5800\u6600\u6000\u6800\u6700\u2D00\u5B00", string0);
  }
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "%Y;9}@yIo\"[");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // %Y;9}@yIo\"[: java.io.UnsupportedEncodingException: %Y;9}@yIo\"[
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
