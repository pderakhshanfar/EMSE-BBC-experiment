...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("a 1JdS_7kU", "US-ASCII");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u6120\u314A\u6453\u5F37\u6B55", string0);
  }
  ...
  public void test11()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("a 1JdS_7kU");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "f(1Pr&6L&N-*R0J");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // f(1Pr&6L&N-*R0J: java.io.UnsupportedEncodingException: f(1Pr&6L&N-*R0J
         //
  ...
  public void test25()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "NB>2>bU5x]bv^H)Q2Cg");
      assertNull(string0);
  }
  ...
  public void test31()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "<^g$^CoZ>(z97TG(S", (CharSequence) "<^g$^CoZ>(z97TG(S");
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) ",a |ZTxa<Y_%h", (CharSequence) null);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "/8^7hiBt'RBiK@ZD");
      assertFalse(boolean0);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) charBuffer0, (CharSequence) " !NPxc");
  ...
  public void test36()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("a 1JdS_7kU", "US-ASCII");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("a 1JdS_7kU", string0);
  ...
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("<^g$^CoZ>(z97TG(S");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("<^g$^CoZ>(z97TG(S", string0);
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1(" !NPxc");
      assertArrayEquals(new byte[] {(byte)32, (byte)33, (byte)78, (byte)80, (byte)120, (byte)99}, byteArray0);
  }
  ...
  public void test49()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "v/mc{");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // v/mc{: java.io.UnsupportedEncodingException: v/mc{
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
