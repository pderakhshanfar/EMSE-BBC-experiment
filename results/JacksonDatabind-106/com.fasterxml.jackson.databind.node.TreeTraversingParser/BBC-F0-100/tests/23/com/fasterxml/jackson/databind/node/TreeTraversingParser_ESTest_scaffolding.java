...
public class TreeTraversingParser_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.annotation.JsonAutoDetect", false, TreeTraversingParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, TreeTraversingParser_ESTest_scaffolding.class.getClassLoader()));
  }
