...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      MockDate mockDate0 = new MockDate(1649, 1649, 1649, 1649, 1649);
      ...
      MockFile mockFile0 = new MockFile("_", "sss");
  ...
  public void test01()  throws Throwable  {
      ...
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(",|:'+<O%hSb");
  ...
  public void test05()  throws Throwable  {
      ...
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockFileWriter mockFileWriter0 = new MockFileWriter("=X2a0c}osM^", true);
      JsonWriter jsonWriter0 = new JsonWriter(mockFileWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("=X2a0c}osM^");
      // Undeclared exception!
      try { 
  ...
  public void test06()  throws Throwable  {
      MockDate mockDate0 = new MockDate(1657, 1657, 1657, 1657, 1657);
      Class<Date> class0 = Date.class;
  ...
  public void test07()  throws Throwable  {
      Class<Date> class0 = Date.class;
      StringReader stringReader0 = new StringReader("hF'0+q@@bm]p'O)<");
  ...
  public void test13()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 585, (-716));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -716
         //
  ...
  public void test14()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-1682));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -1682
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      MockDate mockDate0 = new MockDate(40, 1325, 1649, 0, 4388);
  ...
  public void test18()  throws Throwable  {
      ...
      DateFormat dateFormat0 = MockDateFormat.getInstance();
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, dateFormat0, dateFormat0);
      StringReader stringReader0 = new StringReader("{8CP`U%d1&pzk+Tj");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
  ...
  public void test21()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(604, 2360);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockDate mockDate0 = new MockDate(4388, 4388, 1649, 4388, 4388);
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
