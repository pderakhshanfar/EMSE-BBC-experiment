...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = "Mna[ZfS\\u(^]N0\\HI";
      File file0 = MockFile.createTempFile("S$h-5w'{uw6qh~~0Yjn", string0);
      MockFileWriter mockFileWriter0 = new MockFileWriter(file0);
      JsonWriter jsonWriter0 = new JsonWriter(mockFileWriter0);
      MockDate mockDate0 = new MockDate(116, 116, (-142));
      defaultDateTypeAdapter0.write(jsonWriter0, (Date) mockDate0);
      assertEquals("Fri Apr 11 00:00:00 GMT 2025", mockDate0.toString());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      MockDate mockDate0 = new MockDate(2772, (-1473), 45, 0, (-2445), (-2445));
      // Undeclared exception!
      try { 
  ...
  public void test05()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-4292), (-4292), (-4292), (-4292), (-4292));
      try { 
        defaultDateTypeAdapter0.write(jsonWriter0, (Date) mockDate0);
  ...
  public void test07()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("S7J;gc=^OB-");
  ...
  public void test12()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "8F=>+j");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(1389, 1389);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style 1389
         //
  ...
  public void test18()  throws Throwable  {
      MockDate mockDate0 = new MockDate(0, 63, 2007, (-36), 0, 0);
  ...
  public void test21()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockDate mockDate0 = new MockDate((-1667), 76, (-2489), (-3098), (-2489), 0);
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
  ...
  public void test24()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 1749, 116);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      MockDate mockDate0 = new MockDate(194, 194, 194, 194, (-5101), (-254));
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DateFormat dateFormat0 = MockDateFormat.getInstance();
  ...
  public void test28()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 3128);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style 3128
         //
         verifyException("java.text.DateFormat", e);
      }
  }
