...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Instant instant0 = MockInstant.ofEpochSecond((-2536L), (-2536L));
      Date date0 = Date.from(instant0);
      defaultDateTypeAdapter0.write(jsonWriter0, date0);
      assertEquals("Wed Dec 31 23:17:43 GMT 1969", date0.toString());
  }
  ...
  public void test02()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, (-1832), (-1832), 3400, 3704);
      // Undeclared exception!
      try { 
  ...
  public void test03()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "8[[7m+-Z[_+*7GXY3");
      MockPrintStream mockPrintStream0 = new MockPrintStream("8[[7m+-Z[_+*7GXY3");
      ...
      MockDate mockDate0 = new MockDate((-2204), 0, (-2204), 0, 0);
      // Undeclared exception!
      try { 
  ...
  public void test10()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "^cg+MGMJ;v1:I");
  ...
  public void test15()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader(" 5]0p[y");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
  ...
  public void test19()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(1311, 1311);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-512), 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((Class<? extends Date>) null, "8[[7m+-Z[_+*7GXmY3");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 4555);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style 4555
         //
         verifyException("java.text.DateFormat", e);
      }
  }
