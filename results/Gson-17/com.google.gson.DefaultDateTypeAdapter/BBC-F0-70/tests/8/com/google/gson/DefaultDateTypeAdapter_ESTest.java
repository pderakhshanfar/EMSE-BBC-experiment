...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive(",S uP;`Fs}gS-zt");
  ...
  public void test03()  throws Throwable  {
      ...
      Instant instant0 = MockInstant.ofEpochSecond(1L, 1528L);
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("'Ws8");
  ...
  public void test09()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(pipedWriter0, 1666);
      pipedWriter0.close();
      JsonReader jsonReader0 = new JsonReader(pipedReader0);
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
  ...
  public void test17()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("33}q3~<");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
  ...
  public void test19()  throws Throwable  {
      ...
      Timestamp timestamp0 = Timestamp.from(instant0);
      defaultDateTypeAdapter0.write(jsonWriter0, (Date) timestamp0);
      assertEquals("1970-01-01 00:00:01.000001528", timestamp0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(683, (-5716));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -5716
         //
  ...
  public void test22()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 98, 98);
        fail("Expecting exception: IllegalArgumentException");
