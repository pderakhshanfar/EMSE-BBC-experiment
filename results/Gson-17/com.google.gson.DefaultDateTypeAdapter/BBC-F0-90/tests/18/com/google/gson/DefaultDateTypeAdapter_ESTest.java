...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockFileWriter mockFileWriter0 = new MockFileWriter("com.google.gson.internal.bind.TypeAdapters$8");
  ...
  public void test04()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      java.sql.Date date0 = new java.sql.Date((-1994L));
      // Undeclared exception!
      try { 
  ...
  public void test05()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      File file0 = MockFile.createTempFile(")16'dujyZ;", ")16'dujyZ;");
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter(file0);
      JsonWriter jsonWriter0 = new JsonWriter(mockPrintWriter0);
      jsonWriter0.nullValue();
      java.sql.Date date0 = new java.sql.Date((-2792L));
      // Undeclared exception!
      try { 
  ...
  public void test06()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, 702, 702);
      try { 
        defaultDateTypeAdapter0.write(jsonWriter0, (Date) mockDate0);
  ...
  public void test12()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "FWm| eGVa*6x)ns");
  ...
  public void test13()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 128, (-195));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(1466, 1466);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style 1466
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 0, 0);
      StringReader stringReader0 = new StringReader("5]ohuU;7Um4r#[");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
