...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(1313, 1313, 3156, 1313, (-1989));
  ...
  public void test01()  throws Throwable  {
      ...
      MockFileWriter mockFileWriter0 = new MockFileWriter("-Infinity", false);
      JsonWriter jsonWriter0 = new JsonWriter(mockFileWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(436.0810148);
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Z2y(FDBi~");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
  ...
  public void test08()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "u968");
      StringReader stringReader0 = new StringReader("u968");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test11()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "pYhH8av/J]");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((Class<? extends Date>) null, "y");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 1158, (-2794));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-1), 124);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style 124
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-2301));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -2301
         //
         verifyException("java.text.DateFormat", e);
      }
  }
