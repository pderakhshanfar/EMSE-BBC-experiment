...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(1698, 1698, 1698, 1698, 0);
  ...
  public void test01()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-345), 1151, 0, 0, 84);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.write((JsonWriter) null, (Date) mockDate0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("CS[o");
  ...
  public void test10()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "2kJB@&7habw");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(0, 1132);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-954), (-2553), 0, (-2272), (-2306), 992);
      ...
      assertEquals("0732-12-24 17:50:32.0", date0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, dateFormat0, dateFormat0);
      MockDate mockDate0 = new MockDate((-2383), 2591, 1326, (-2383), 98, 2988);
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
      Date date0 = defaultDateTypeAdapter0.fromJsonTree(jsonElement0);
      assertEquals("Thu Apr 09 19:27:48 GMT 265", date0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      StringReader stringReader0 = new StringReader("[B1e.$ty{B(y9T");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
  ...
  public void test20()  throws Throwable  {
      ...
      DateFormat dateFormat0 = MockDateFormat.getDateTimeInstance();
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, dateFormat0, dateFormat0);
      MockDate mockDate0 = new MockDate(2988, 1326, (-2383), (-2306), 0, (-2383));
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
      Date date0 = defaultDateTypeAdapter0.fromJsonTree(jsonElement0);
      assertNotNull(date0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(13, 13, 13, 13, 13, (-2232));
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 0, (-954));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -954
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-2306));
        fail("Expecting exception: IllegalArgumentException");
