...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Timestamp timestamp0 = new Timestamp(2489L);
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      ...
      java.sql.Date date0 = new java.sql.Date(3240L);
      JsonWriter jsonWriter0 = new JsonWriter(mockFileWriter0);
  ...
  public void test15()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-457), (-457));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "G");
      java.sql.Date date0 = new java.sql.Date(1762L);
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(date0);
      Date date1 = defaultDateTypeAdapter0.fromJsonTree(jsonElement0);
  ...
  public void test24()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 7, 7);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 2616);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style 2616
         //
         verifyException("java.text.DateFormat", e);
      }
  }
