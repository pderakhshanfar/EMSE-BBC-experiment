...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      java.sql.Date date0 = new java.sql.Date(1258L);
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(2956);
  ...
  public void test12()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "isBcT00g:`O+}=^");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(184, 40);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("JS7'*,XM-o66E*");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      java.sql.Date date0 = new java.sql.Date(3953L);
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(date0);
      Date date1 = defaultDateTypeAdapter0.fromJsonTree(jsonElement0);
