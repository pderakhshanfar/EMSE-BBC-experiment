...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter(stringWriter0);
      JsonWriter jsonWriter0 = new JsonWriter(mockPrintWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("RbZnj%Z]D");
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      StringReader stringReader0 = new StringReader("?KTA=[B8eC$#-N");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      Class<Timestamp> class0 = Timestamp.class;
  ...
  public void test13()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(0, (-3170));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -3170
         //
  ...
  public void test18()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[lYY-Z0D}kV_E#1)\"");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      // Undeclared exception!
  ...
  public void test22()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 670, 670);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style 670
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-1447));
        fail("Expecting exception: IllegalArgumentException");
