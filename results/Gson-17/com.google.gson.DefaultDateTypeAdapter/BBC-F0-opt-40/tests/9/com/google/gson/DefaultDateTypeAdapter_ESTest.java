...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockDate mockDate0 = new MockDate((-1143L));
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("DefaultDateTypeAdapter");
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter(mockFileOutputStream0);
      JsonWriter jsonWriter0 = new JsonWriter(mockPrintWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("-`rG@0d+-i}[C?~(");
      MockDate mockDate0 = new MockDate(3213, 41, 40, 0, 0, 1);
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "com.google.gson.JsonArray");
  ...
  public void test11()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 524);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style 524
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      Class<Date> class0 = Date.class;
      StringReader stringReader0 = new StringReader("[MM@K;|T>G.,h");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test19()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(690, 690);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, (-1693), 0, 0, (-556), 5);
