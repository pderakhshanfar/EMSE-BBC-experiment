...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      MockFileWriter mockFileWriter0 = new MockFileWriter("kGyM`^8&c+D_/X(", false);
      JsonWriter jsonWriter0 = new JsonWriter(mockFileWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("[UrIz\"m`}O");
      MockDate mockDate0 = new MockDate((-4560), 0, 34, 1167, 34);
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader(":3NUxv~EKUP");
  ...
  public void test08()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      StringReader stringReader0 = new StringReader("!KIX");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test11()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-1), 40);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(825, 825, 825, 825, 825, 648);
