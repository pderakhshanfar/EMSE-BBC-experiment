...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("p\tf<gYP#bG3*BXmY(");
  ...
  public void test11()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "RG?");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 92, 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-1303));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -1303
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      MockDate mockDate0 = new MockDate(942, (-1303), (-2273));
      ...
      assertEquals("2727-03-11 00:00:00.0", date0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, dateFormat0, dateFormat0);
      MockDate mockDate0 = new MockDate((-2564), 0, 0, 0, 0, (-909));
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
      Date date0 = defaultDateTypeAdapter0.fromJsonTree(jsonElement0);
      assertEquals("Fri Dec 30 23:44:51 GMT 666", date0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-2273), 704);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-1530), 0, 1, 0, (-1530), 60);
      defaultDateTypeAdapter0.write(jsonWriter0, (Date) mockDate0);
