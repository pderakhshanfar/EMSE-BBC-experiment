...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.value((-2532.338532937347));
      MockDate mockDate0 = new MockDate(1185, (-15), (-15));
      // Undeclared exception!
      try { 
  ...
  public void test10()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, 0, 0, 47, 0, 0);
  ...
  public void test12()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "\"wnf>I2'Mx*GGAk`jk");
  ...
  public void test15()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-962), 3304);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style 3304
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 1740);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style 1740
         //
         verifyException("java.text.DateFormat", e);
      }
  }
