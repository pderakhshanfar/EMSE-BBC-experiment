...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, dateFormat0, dateFormat0);
      StringReader stringReader0 = new StringReader("\"Mar 22, 2179 12:42:24 AM\"");
  ...
  public void test03()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      MockDate mockDate0 = new MockDate(0, 0, 0, 0, (-1125), 33);
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("l$e8q=)3k|d'w");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "Kb\"N2PN)Sdjqazk~");
  ...
  public void test13()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(1002, 1365);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style 1365
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, dateFormat0, dateFormat0);
      Timestamp timestamp0 = (Timestamp)defaultDateTypeAdapter0.fromJson("\"Dec 30, 4446 12:00:41 AM\"");
  ...
  public void test16()  throws Throwable  {
      ...
      java.util.Date date0 = defaultDateTypeAdapter0.fromJson("\"12\"");
  ...
  public void test19()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("3}UHdVI%");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
  ...
  public void test20()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 955, 955);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      StringReader stringReader0 = new StringReader("\"Mar 13, 1993 12:00:00 AM\"");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
