...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(123, 4035, 123, 121, (-3487), 121);
      // Undeclared exception!
      try { 
  ...
  public void test03()  throws Throwable  {
      ...
      LocalDate localDate0 = MockLocalDate.ofEpochDay((-359L));
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("_(]+8^h#&");
  ...
  public void test10()  throws Throwable  {
      ...
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "IZZgLU yZgmtI.j");
  ...
  public void test16()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("[J#ri");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
  ...
  public void test21()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(1420, 1420);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 1494, (-1651));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -1651
         //
         verifyException("java.text.DateFormat", e);
      }
  }
