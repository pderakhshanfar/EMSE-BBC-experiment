...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockFileWriter mockFileWriter0 = new MockFileWriter("mym^T>k", true);
      JsonWriter jsonWriter0 = new JsonWriter(mockFileWriter0);
      Instant instant0 = MockInstant.ofEpochSecond(230L);
  ...
  public void test03()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((byte) (-60), (byte) (-60), 1144, 0, (byte)38, (byte) (-60));
  ...
  public void test07()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "[}m:DF");
      StringReader stringReader0 = new StringReader("sN}JlUc.Zi<.hD");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.close();
      // Undeclared exception!
      try { 
  ...
  public void test10()  throws Throwable  {
      Class<java.util.Date> class0 = java.util.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("P:I%_,Z8G!RpE5e_*?,");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test15()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 0, 41);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-2953));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -2953
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, 0, (-2688), 0, 0, (-925));
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1483), 0, (-2044), (-1483), 0, 40);
      Class<java.util.Date> class0 = java.util.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
