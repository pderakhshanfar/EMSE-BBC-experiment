...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(4934, 2706, 4934);
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("Date type must be one of ");
      MockDate mockDate0 = new MockDate((-772), 0, 0, (-1), (-772));
      // Undeclared exception!
      try { 
  ...
  public void test05()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 0);
      StringReader stringReader0 = new StringReader("m_b|");
  ...
  public void test12()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-6182), 4102);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style 4102
         //
  ...
  public void test13()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-3185));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -3185
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\"Mar 2, 1902 2:02:02 AM\"");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      java.util.Date date0 = defaultDateTypeAdapter0.read(jsonReader0);
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "com.google.gson.internal.bind.TypeAdapters$EnumTypeAdapter");
        fail("Expecting exception: IllegalArgumentException");
