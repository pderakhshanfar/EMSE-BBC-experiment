...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("Date type must be one of ");
  ...
  public void test03()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, 57, 0, 57, 0, 57);
      // Undeclared exception!
      try { 
  ...
  public void test10()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "=n%~X");
  ...
  public void test11()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 2195, 2195);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style 2195
         //
  ...
  public void test18()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-899), 1);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      ...
      defaultDateTypeAdapter0.write(jsonWriter0, (Date) mockDate0);
      assertEquals("\"Thursday, January 1, 1970 12:00:00 AM GMT\"", charArrayWriter0.toString());
  ...
  public void test23()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((Class<? extends Date>) null, 15);
        fail("Expecting exception: IllegalArgumentException");
