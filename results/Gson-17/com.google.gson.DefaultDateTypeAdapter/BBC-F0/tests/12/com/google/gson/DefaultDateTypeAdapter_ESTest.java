...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter("7h)O");
      JsonWriter jsonWriter0 = new JsonWriter(mockPrintWriter0);
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-920));
  ...
  public void test04()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "~.4h");
  ...
  public void test07()  throws Throwable  {
      ...
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "2\"DbC:{ub%");
  ...
  public void test10()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("2\"DbC:{ub%");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
        fail("Expecting exception: IOException");
  ...
  public void test11()  throws Throwable  {
      MockDate mockDate0 = new MockDate(2121, 531, 41);
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
  ...
  public void test16()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-2547), (-2547));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -2547
         //
  ...
  public void test17()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-884), 0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -884
         //
         verifyException("java.text.DateFormat", e);
      }
  }
