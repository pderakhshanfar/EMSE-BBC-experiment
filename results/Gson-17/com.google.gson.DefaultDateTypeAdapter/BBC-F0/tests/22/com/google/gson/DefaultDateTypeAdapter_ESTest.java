...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      Timestamp timestamp0 = new Timestamp(1991L);
      // Undeclared exception!
      try { 
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("4C` !&^X &Rf;");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
  ...
  public void test10()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 1646);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style 1646
         //
  ...
  public void test17()  throws Throwable  {
      Timestamp timestamp0 = new Timestamp((-2295L));
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      String string0 = defaultDateTypeAdapter0.toJson((java.util.Date) timestamp0);
      assertEquals("\"Dec 31, 1969 11:59:57 PM\"", string0);
  }
  ...
  public void test19()  throws Throwable  {
      Class<java.util.Date> class0 = java.util.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      java.util.Date date0 = defaultDateTypeAdapter0.fromJson("\"Jan 1, 1970 12:00:01 AM\"");
  ...
  public void test20()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(1646, 1646);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 266, 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "Expected a string but was ");
        fail("Expecting exception: IllegalArgumentException");
