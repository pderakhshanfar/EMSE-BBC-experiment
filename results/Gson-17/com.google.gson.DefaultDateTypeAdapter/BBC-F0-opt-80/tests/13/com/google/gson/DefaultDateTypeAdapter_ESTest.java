...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(1875, 1875, 0, 0, 0, 90);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(58, 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-97), 3015);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style 3015
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("", "f$|ww");
  ...
  public void test25()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 36);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style 36
         //
         verifyException("java.text.DateFormat", e);
      }
  }
