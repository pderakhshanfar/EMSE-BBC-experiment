...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      Date date0 = new Date((-19L));
      MockFileWriter mockFileWriter0 = new MockFileWriter("Attempted to deserialize a java.lang.Class. Forgot to register a type adapter?");
  ...
  public void test02()  throws Throwable  {
      ...
      Timestamp timestamp0 = new Timestamp((-2008L));
      try { 
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("v(BfCMA84 ?'Iwu");
  ...
  public void test06()  throws Throwable  {
      Class<java.util.Date> class0 = java.util.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      PipedReader pipedReader0 = new PipedReader(4958);
  ...
  public void test09()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "yyyy-MM-ddThh:mm:ss");
  ...
  public void test10()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 2337, 2337);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style 2337
         //
  ...
  public void test11()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-746));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -746
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-135), (-135));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -135
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      MockFileWriter mockFileWriter0 = new MockFileWriter("yyg<B");
      JsonWriter jsonWriter0 = new JsonWriter(mockFileWriter0);
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
  ...
  public void test19()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, (-2180), 0, (-2180), 1);
      // Undeclared exception!
      try { 
