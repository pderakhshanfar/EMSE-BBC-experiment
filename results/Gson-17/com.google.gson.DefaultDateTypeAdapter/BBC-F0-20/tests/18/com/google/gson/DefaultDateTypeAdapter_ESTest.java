...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockFileWriter mockFileWriter0 = new MockFileWriter(" but was ", true);
      ...
      MockDate mockDate0 = new MockDate(125, (-1977), 125);
  ...
  public void test01()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(3692, 440, 3692);
      // Undeclared exception!
      try { 
  ...
  public void test02()  throws Throwable  {
      ...
      MockFileWriter mockFileWriter0 = new MockFileWriter("Az<XFAT8yX2f{.\u0005|", true);
      JsonWriter jsonWriter0 = new JsonWriter(mockFileWriter0);
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("U^UjJ,De,`}&y4");
  ...
  public void test11()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "Invalid escape sequence");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 718, 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 4488);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style 4488
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-799), (-799));
        fail("Expecting exception: IllegalArgumentException");
