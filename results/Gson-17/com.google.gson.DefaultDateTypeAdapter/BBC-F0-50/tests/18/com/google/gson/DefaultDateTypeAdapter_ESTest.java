...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockFileWriter mockFileWriter0 = new MockFileWriter("~eJI#z'pGMXpvKpd\"", false);
      JsonWriter jsonWriter0 = new JsonWriter(mockFileWriter0);
      MockDate mockDate0 = new MockDate(117, 59, (-3041));
  ...
  public void test04()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(1, 1, 1, (-3394), (-4607));
      // Undeclared exception!
      try { 
  ...
  public void test05()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(1, 1, 84, 2183, (-245), (-245));
      try { 
        defaultDateTypeAdapter0.write(jsonWriter0, (Date) mockDate0);
  ...
  public void test09()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(2469);
  ...
  public void test13()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "t9A+C_\"4sA");
  ...
  public void test15()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-774), (-774));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-223), (-774));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-2514));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -2514
         //
         verifyException("java.text.DateFormat", e);
      }
  }
