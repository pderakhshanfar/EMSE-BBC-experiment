...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("", "Date type must be one of ");
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream(mockFile0, false);
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter(mockFileOutputStream0, false);
      BufferedWriter bufferedWriter0 = new BufferedWriter(mockPrintWriter0);
      JsonWriter jsonWriter0 = new JsonWriter(bufferedWriter0);
      MockDate mockDate0 = new MockDate((-1828), (-1828), (-1242), 41, 41);
      Date date0 = new Date((-4363));
  ...
  public void test02()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-5127), (-5127), 114, 114, 114);
      try { 
        defaultDateTypeAdapter0.write(jsonWriter0, (java.util.Date) mockDate0);
  ...
  public void test12()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "rb`LgNO");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 0, (-1200));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -1200
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 493);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style 493
         //
         verifyException("java.text.DateFormat", e);
      }
  }
