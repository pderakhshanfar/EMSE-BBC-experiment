...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive("+j6`!");
  ...
  public void test10()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "com.google.gson.internal.bind.TypeAdapters$34");
  ...
  public void test15()  throws Throwable  {
      ...
      java.sql.Date date0 = new java.sql.Date((-2019L));
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
  ...
  public void test16()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      StringReader stringReader0 = new StringReader("qj2");
  ...
  public void test20()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter('t', (-3130));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -3130
         //
  ...
  public void test21()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 4081, 1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style 4081
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      java.sql.Date date0 = new java.sql.Date((-2034L));
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(date0);
      Date date1 = defaultDateTypeAdapter0.fromJsonTree(jsonElement0);
  ...
  public void test24()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 710);
        fail("Expecting exception: IllegalArgumentException");
