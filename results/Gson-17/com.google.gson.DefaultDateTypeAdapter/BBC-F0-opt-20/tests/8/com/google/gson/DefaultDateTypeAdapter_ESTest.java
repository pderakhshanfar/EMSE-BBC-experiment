...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(1217, 2772, 442, 0, (-91), 0);
  ...
  public void test04()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(38, 38, 1002, 8232, 2, (-1202));
      // Undeclared exception!
      try { 
  ...
  public void test06()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 0, 0);
      StringReader stringReader0 = new StringReader("vnm#oxf8q0x");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (byte) (-57), 1632);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 1186);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style 1186
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      Timestamp timestamp0 = new Timestamp(4963L);
      Class<Timestamp> class0 = Timestamp.class;
  ...
  public void test23()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-160), (-160));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -160
         //
         verifyException("java.text.DateFormat", e);
      }
  }
