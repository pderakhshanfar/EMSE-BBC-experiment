...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(2497, (byte)43, (byte)43);
  ...
  public void test02()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockDate mockDate0 = new MockDate((-3359), (-3359), (-3359), (-3359), 31, (-3359));
  ...
  public void test16()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-5735), 0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -5735
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\"1/1/70 12:00 AM\"");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test22()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 1065, (-1782));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -1782
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      DateFormat dateFormat0 = MockDateFormat.getInstance();
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, dateFormat0, dateFormat0);
      StringReader stringReader0 = new StringReader("\"12/31/69 11:59 PM\"");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      Date date0 = defaultDateTypeAdapter0.read(jsonReader0);
      assertNotNull(date0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "oY\"M[");
        fail("Expecting exception: IllegalArgumentException");
