...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter("D0!H@WF5.u\"q3[(");
      JsonWriter jsonWriter0 = new JsonWriter(mockPrintWriter0);
      MockDate mockDate0 = new MockDate(0, 0, 6, 15, 0, 0);
  ...
  public void test03()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, 0, 6, 15, 0, (-288));
      // Undeclared exception!
      try { 
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("YbFn");
  ...
  public void test12()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "4<Pr>");
  ...
  public void test13()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-5922));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -5922
         //
  ...
  public void test22()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-22), (-929));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -929
         //
         verifyException("java.text.DateFormat", e);
      }
  }
