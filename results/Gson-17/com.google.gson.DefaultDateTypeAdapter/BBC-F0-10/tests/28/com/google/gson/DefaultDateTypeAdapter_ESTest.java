...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 3, 2);
      CharArrayWriter charArrayWriter0 = new CharArrayWriter(2);
      JsonWriter jsonWriter0 = new JsonWriter(charArrayWriter0);
      MockDate mockDate0 = new MockDate(3, 3, 3, 2, 2, 3);
  ...
  public void test03()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-1521), 40, 0, 31, 0);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 1241, 1241);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style 1241
         //
  ...
  public void test15()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockDate mockDate0 = new MockDate((-833), 1426, 0, 24, 0);
  ...
  public void test16()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      LocalDate localDate0 = MockLocalDate.ofEpochDay((-1924));
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.fromJson("49:");
        fail("Expecting exception: RuntimeException");
  ...
  public void test19()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(2754, (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockDate mockDate0 = new MockDate(1, 1, 62, 24, 0);
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
