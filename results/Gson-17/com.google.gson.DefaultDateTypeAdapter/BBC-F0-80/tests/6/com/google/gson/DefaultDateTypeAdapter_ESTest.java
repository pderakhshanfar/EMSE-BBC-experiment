...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      Instant instant0 = MockInstant.ofEpochSecond((-4239L));
  ...
  public void test06()  throws Throwable  {
      ...
      DateFormat dateFormat0 = MockDateFormat.getDateTimeInstance();
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, dateFormat0, dateFormat0);
      StringReader stringReader0 = new StringReader("[K{rQIL");
  ...
  public void test13()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "\"7pRk=%.+i5#cCf>_q");
  ...
  public void test15()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-1750));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -1750
         //
  ...
  public void test20()  throws Throwable  {
      ...
      DateFormat dateFormat0 = MockDateFormat.getDateTimeInstance();
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, dateFormat0, dateFormat0);
      MockDate mockDate0 = new MockDate((-2579), (-3679), 0, (-3679), 2714, 65279);
      ...
      assertEquals("Wed Dec 31 08:21:59 GMT 988", date0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(0, (-922));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -922
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockDate mockDate0 = new MockDate(0, 0, 0, (-890), (-890), (-890));
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
  ...
  public void test24()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 0, (-760));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -760
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      MockDate mockDate0 = new MockDate(1, (-596), 0, 1, (-3351), 0);
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "}");
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
