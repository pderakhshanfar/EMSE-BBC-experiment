...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Instant instant0 = MockInstant.ofEpochMilli(2782);
      Timestamp timestamp0 = Timestamp.from(instant0);
      StringWriter stringWriter0 = new StringWriter();
      BufferedWriter bufferedWriter0 = new BufferedWriter(stringWriter0, 2782);
      JsonWriter jsonWriter0 = new JsonWriter(bufferedWriter0);
      defaultDateTypeAdapter0.write(jsonWriter0, (java.util.Date) timestamp0);
      assertEquals("1970-01-01 00:00:02.782", timestamp0.toString());
  }
  ...
  public void test03()  throws Throwable  {
      Class<java.util.Date> class0 = java.util.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      Instant instant0 = MockInstant.ofEpochMilli(9223372036854775795L);
      Timestamp timestamp0 = Timestamp.from(instant0);
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      Timestamp timestamp0 = new Timestamp((-1282));
      MockFile mockFile0 = new MockFile("TZ6e[rWV?w8E,}ai");
  ...
  public void test05()  throws Throwable  {
      MockDate mockDate0 = new MockDate(126, 1915, (-1814), (-1814), 17, 0);
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
  ...
  public void test11()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "K=y<[,OnqT-");
  ...
  public void test15()  throws Throwable  {
      Instant instant0 = MockInstant.ofEpochMilli(1355L);
      Timestamp timestamp0 = Timestamp.from(instant0);
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
  ...
  public void test17()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("{8jS=i_@,#Ha^y5");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
  ...
  public void test21()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-2999), 0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -2999
         //
         verifyException("java.text.DateFormat", e);
      }
  }
