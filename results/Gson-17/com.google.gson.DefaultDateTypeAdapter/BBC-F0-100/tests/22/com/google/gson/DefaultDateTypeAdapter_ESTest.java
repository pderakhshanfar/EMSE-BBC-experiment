...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, 0, 0, 1461, 416, 416);
  ...
  public void test03()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(972, 972, 1002);
      // Undeclared exception!
      try { 
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("mDN.Hm");
  ...
  public void test13()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "A/g[?3hi^3c=:/Wob");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 0, 583);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style 583
         //
  ...
  public void test18()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(2, (-3180));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -3180
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("\"Dec 30, 1899 12:57:00 AM\"");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      Date date0 = defaultDateTypeAdapter0.read(jsonReader0);
  ...
  public void test23()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, 0, 0, 0, 416, 416);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.write(jsonWriter0, (Date) mockDate0);
        fail("Expecting exception: IllegalStateException");
