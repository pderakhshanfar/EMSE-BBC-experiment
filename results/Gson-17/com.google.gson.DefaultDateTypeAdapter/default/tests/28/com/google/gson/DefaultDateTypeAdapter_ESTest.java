...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CharArrayWriter charArrayWriter0 = new CharArrayWriter(1711);
      JsonWriter jsonWriter0 = new JsonWriter(charArrayWriter0);
      MockDate mockDate0 = new MockDate(40, 40, 1711, 2327, (-5884));
  ...
  public void test03()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-2266L));
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      ...
      Instant instant0 = MockInstant.ofEpochSecond((-540L), 227L);
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("{9)BD@7");
  ...
  public void test13()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "9 sNi");
  ...
  public void test15()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-880));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -880
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(910, 910);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockDate mockDate0 = new MockDate(0, 0, 93);
  ...
  public void test23()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("\"Mar 25, 0449 5:24:24 PM\"");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test24()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      StringReader stringReader0 = new StringReader("\"Apr 3, 1900 12:00:00 AM\"");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
