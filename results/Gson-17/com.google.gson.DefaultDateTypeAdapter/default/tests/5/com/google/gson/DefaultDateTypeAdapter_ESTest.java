...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      Timestamp timestamp0 = new Timestamp((-2378L));
      // Undeclared exception!
      try { 
  ...
  public void test03()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-3544), (-3544), (-424));
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      ...
      Timestamp timestamp0 = new Timestamp(2386L);
      try { 
  ...
  public void test05()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("5}lu^gm8.]545o");
  ...
  public void test12()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-3400), (-3400));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-3533), (-3533));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -3533
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-2497));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal date style -2497
         //
         verifyException("java.text.DateFormat", e);
      }
  }
