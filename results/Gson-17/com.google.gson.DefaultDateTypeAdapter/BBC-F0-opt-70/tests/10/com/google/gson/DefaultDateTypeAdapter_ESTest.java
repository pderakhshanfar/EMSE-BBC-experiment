...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      MockDate mockDate0 = new MockDate(2348, 13, 2348, 13, 2348, 13);
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(605.0);
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 48, 48);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-1121), (-3461));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal time style -3461
         //
         verifyException("java.text.DateFormat", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-1), (-1), 0, 0, (-1), 13);
      Class<Date> class0 = Date.class;
      ...
      assertEquals("Tue Nov 29 23:59:13 GMT 1898", date0.toString());
  }
  ...
  public void test13()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("[vcJF`DX~R+mK#7#~^");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
  ...
  public void test16()  throws Throwable  {
      ...
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, dateFormat0, dateFormat0);
      MockDate mockDate0 = new MockDate(0, 3975, 0, (-1), 3975, 3975);
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
  ...
  public void test17()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("E9u'|Ku*YnY+qd\"0/Q");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test22()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 13);
        fail("Expecting exception: IllegalArgumentException");
