...
public class StandardToolTipTagFragmentGenerator_ESTest extends StandardToolTipTagFragmentGenerator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      String string0 = standardToolTipTagFragmentGenerator0.generateToolTipFragment("NY~TS3m^~/f4A?2");
      assertEquals(" title=\"NY~TS3m^~/f4A?2\" alt=\"\"", string0);
  }
}
