...
public class StandardToolTipTagFragmentGenerator_ESTest extends StandardToolTipTagFragmentGenerator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      String string0 = standardToolTipTagFragmentGenerator0.generateToolTipFragment("OeYeEkV?1>4@PW]w");
      assertEquals(" title=\"OeYeEkV?1>4@PW]w\" alt=\"\"", string0);
  }
}
