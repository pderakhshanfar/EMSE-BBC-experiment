...
public class StandardToolTipTagFragmentGenerator_ESTest extends StandardToolTipTagFragmentGenerator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      String string0 = standardToolTipTagFragmentGenerator0.generateToolTipFragment("n%U#P:YMCY=|A`m");
      assertEquals(" title=\"n%U#P:YMCY=|A`m\" alt=\"\"", string0);
  }
}
