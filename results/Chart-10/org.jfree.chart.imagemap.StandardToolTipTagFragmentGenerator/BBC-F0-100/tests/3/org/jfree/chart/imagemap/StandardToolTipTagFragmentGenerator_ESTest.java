...
public class StandardToolTipTagFragmentGenerator_ESTest extends StandardToolTipTagFragmentGenerator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      String string0 = standardToolTipTagFragmentGenerator0.generateToolTipFragment("]F~TMNHC{p`>(mHK");
      assertEquals(" title=\"]F~TMNHC{p`>(mHK\" alt=\"\"", string0);
  }
}
