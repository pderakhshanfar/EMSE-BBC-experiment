...
public class StandardToolTipTagFragmentGenerator_ESTest extends StandardToolTipTagFragmentGenerator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      String string0 = standardToolTipTagFragmentGenerator0.generateToolTipFragment("=5@~C`4=y>)b-y0");
      assertEquals(" title=\"=5@~C`4=y>)b-y0\" alt=\"\"", string0);
  }
}
