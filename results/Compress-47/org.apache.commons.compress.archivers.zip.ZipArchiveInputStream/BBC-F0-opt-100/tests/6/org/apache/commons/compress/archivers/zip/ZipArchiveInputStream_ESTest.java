...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(bufferedInputStream0, "ENHANCED_DEFLATED", false, true);
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-21), 50);
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1790), (byte)17);
  ...
  public void test10()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "0}-y3j!8'", false, true);
  ...
  public void test11()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream1 = new ZipArchiveInputStream(zipArchiveInputStream0, "N,?", true);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)117, 512);
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "f:)wXdbw");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test13()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "wp8fG", true);
      byte[] byteArray0 = new byte[5];
      int int0 = zipArchiveInputStream0.read(byteArray0, (int) (byte)4, (int) (byte)12);
      assertEquals((-1), int0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.read((byte[]) null, (-583), 5);
        fail("Expecting exception: IOException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.skip((-2177));
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      long long0 = zipArchiveInputStream0.skip(208L);
      assertEquals(0L, long0);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-21), 50);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      MockFile mockFile0 = new MockFile("\"xK9@nn9ecGfKn>|,", "W|ev8_>kx=6hR*");
      ArArchiveEntry arArchiveEntry0 = new ArArchiveEntry(mockFile0, "vKzKZ~imvO\"gK a");
