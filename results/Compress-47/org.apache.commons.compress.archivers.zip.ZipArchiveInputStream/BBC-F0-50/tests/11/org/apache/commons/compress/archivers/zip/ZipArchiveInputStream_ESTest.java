...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(dataInputStream0, "ISO-8859-1", false, false);
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = new byte[3];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-3612), 4096);
  ...
  public void test13()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(sequenceInputStream0, "This archive contains unclosed entries.", false, false);
  ...
  public void test14()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "\"!g", false);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test16()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      int int0 = zipArchiveInputStream0.read(byteArray0, (-471), 36864);
      assertEquals((-1), int0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        zipArchiveInputStream0.read(byteArray0, 3249, 2038);
        fail("Expecting exception: IOException");
  ...
  public void test21()  throws Throwable  {
      byte[] byteArray0 = new byte[2];
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, (-1875));
      assertFalse(boolean0);
  }
  ...
  public void test23()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)8, (-3529));
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.skip((-1235));
  ...
  public void test25()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.skip(2683L);
        fail("Expecting exception: IOException");
