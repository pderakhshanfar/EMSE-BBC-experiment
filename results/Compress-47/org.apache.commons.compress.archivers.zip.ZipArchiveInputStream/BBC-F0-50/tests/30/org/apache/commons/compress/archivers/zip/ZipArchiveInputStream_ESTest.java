...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        zipArchiveInputStream0.skip(1512);
  ...
  public void test08()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "FvT", true, true);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextZipEntry();
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test24()  throws Throwable  {
      File file0 = MockFile.createTempFile("};^Bo:{HJyZA4+Q1Oo ", "};^Bo:{HJyZA4+Q1Oo ");
  ...
  public void test25()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.read(byteArray0, 1683, (int) (byte) (-47));
        fail("Expecting exception: IOException");
  ...
  public void test27()  throws Throwable  {
      byte[] byteArray0 = new byte[4];
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("FvT");
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 8);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "FvT", true, true);
      boolean boolean0 = zipArchiveInputStream0.canReadEntryData(zipArchiveEntry0);
      assertFalse(boolean0);
  ...
  public void test32()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)0, 26);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      int int0 = zipArchiveInputStream0.read(byteArray0, (int) (byte)0, 26);
      assertEquals((-1), int0);
  }
}
