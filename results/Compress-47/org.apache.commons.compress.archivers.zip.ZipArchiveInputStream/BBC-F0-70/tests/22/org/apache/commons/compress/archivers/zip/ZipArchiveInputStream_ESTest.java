...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, 525);
  ...
  public void test04()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "GMT+0");
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        ZipArchiveInputStream.matches((byte[]) null, 2145220756);
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = new byte[3];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-69), (byte)117);
  ...
  public void test11()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1073741823), (-2073432486));
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextEntry();
  ...
  public void test14()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, ")x[Y:)k|,<j", false);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test15()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(pipedInputStream0, 1703);
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pushbackInputStream0, "5[>");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test16()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, (String) null, false);
      int int0 = zipArchiveInputStream0.read(byteArray0, 97, 1);
      assertEquals((-1), int0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[7];
      try { 
        zipArchiveInputStream0.read(byteArray0, (int) (byte)16, 2244);
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      ...
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, 557);
      assertFalse(boolean0);
  }
  ...
  public void test23()  throws Throwable  {
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)12, (byte)66);
  ...
  public void test30()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, (String) null, false);
      long long0 = zipArchiveInputStream0.skip(1522L);
      assertEquals(0L, long0);
  }
}
