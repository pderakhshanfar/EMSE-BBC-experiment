...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, 76);
  ...
  public void test05()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-25), 1042);
  ...
  public void test09()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1185, (byte) (-56));
  ...
  public void test10()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, ";L@R8ug2@", true);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test11()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.compress.archivers.zip.ZipArchiveInputStream$CurrentEntry", "org.apache.commons.compress.archivers.zip.ZipArchiveInputStream$CurrentEntry");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(mockFileInputStream0, "'s size exceeds the limit of 4GByte.");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)0, 991);
  ...
  public void test18()  throws Throwable  {
      ...
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0);
      long long0 = zipArchiveInputStream0.skip(1111L);
      assertEquals(0L, long0);
  }
  ...
  public void test20()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "N");
      zipArchiveInputStream0.close();
      zipArchiveInputStream0.close();
  ...
  public void test21()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[2];
      try { 
        zipArchiveInputStream0.read(byteArray0, 31, 452);
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream(686);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0);
      int int0 = zipArchiveInputStream0.read((byte[]) null, 686, 686);
      assertEquals((-1), int0);
  }
