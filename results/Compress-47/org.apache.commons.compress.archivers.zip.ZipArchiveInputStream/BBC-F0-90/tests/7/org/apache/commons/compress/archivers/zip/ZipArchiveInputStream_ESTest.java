...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2305), (byte)80);
  ...
  public void test11()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "ZBU@j%Mi|5kT$", true, true);
  ...
  public void test12()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "0?kjI)H?K#rL", false);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test13()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, ",E2k=({0>AOPr?8X");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test14()  throws Throwable  {
      ...
      int int0 = zipArchiveInputStream0.read(byteArray0, (int) (byte)32, (int) (byte)32);
      assertEquals((-1), int0);
  }
  ...
  public void test18()  throws Throwable  {
      byte[] byteArray0 = new byte[2];
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, (-432));
      assertFalse(boolean0);
  }
  ...
  public void test23()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "org.apache.commons.compress.archivers.zip.Zip64ExtendedInformationExtraField");
      zipArchiveInputStream0.close();
      byte[] byteArray0 = new byte[3];
      try { 
        zipArchiveInputStream0.read(byteArray0, 418, 1150);
        fail("Expecting exception: IOException");
  ...
  public void test29()  throws Throwable  {
      byte[] byteArray0 = new byte[9];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2146221905), (-2146221905));
