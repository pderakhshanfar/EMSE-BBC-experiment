...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      long long0 = zipArchiveInputStream0.skip(2144091098);
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        zipArchiveInputStream0.skip(392);
  ...
  public void test07()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-5565), 1024);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextZipEntry();
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-924), 9);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextEntry();
  ...
  public void test11()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(sequenceInputStream0, 2582);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pushbackInputStream0, "org.apache.commons.compress.archivers.arj.ArjArchiveEntry");
      try { 
        zipArchiveInputStream0.getNextEntry();
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream1 = new ZipArchiveInputStream(zipArchiveInputStream0, ":j|^,7w]K@#0@0>oJ", true);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test14()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream1 = null;
      try {
        zipArchiveInputStream1 = new ZipArchiveInputStream(zipArchiveInputStream0, "~(y$#4m_Om0");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-3707), (-3707));
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      zipArchiveInputStream0.getNextZipEntry();
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.skip((-1234567));
  ...
  public void test23()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[2];
      try { 
        zipArchiveInputStream0.read(byteArray0, 30, (int) (byte)77);
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      DataInputStream dataInputStream0 = new DataInputStream((InputStream) null);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(dataInputStream0, "8AqA", true);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextEntry();
        fail("Expecting exception: NullPointerException");
