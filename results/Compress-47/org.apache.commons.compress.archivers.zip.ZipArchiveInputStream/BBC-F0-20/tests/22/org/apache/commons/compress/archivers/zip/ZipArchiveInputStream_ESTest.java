...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test14()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream(2715);
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "hQ0W_d}&L;97oN9", true, true);
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("xE=p_,sVcbU3X", "xE=p_,sVcbU3X");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      String string0 = "\\O";
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(mockFileInputStream0, "O");
      boolean boolean0 = false;
      ZipArchiveInputStream zipArchiveInputStream1 = null;
      try {
        zipArchiveInputStream1 = new ZipArchiveInputStream(zipArchiveInputStream0, string0, boolean0);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test16()  throws Throwable  {
      ...
      int int0 = zipArchiveInputStream0.read((byte[]) null, 659, 0);
      assertEquals((-1), int0);
  }
  ...
  public void test20()  throws Throwable  {
      DataInputStream dataInputStream0 = new DataInputStream((InputStream) null);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(dataInputStream0);
      long long0 = zipArchiveInputStream0.skip(845L);
  ...
  public void test22()  throws Throwable  {
      ...
      Enumeration<PushbackInputStream> enumeration0 = stack0.elements();
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(enumeration0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(sequenceInputStream0, "UTF-16LE", false, true);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.skip((-993));
  ...
  public void test23()  throws Throwable  {
      ...
      Enumeration<PushbackInputStream> enumeration0 = stack0.elements();
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(enumeration0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(sequenceInputStream0, "UTF-16LE", false, false);
      zipArchiveInputStream0.close();
      zipArchiveInputStream0.close();
  ...
  public void test24()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[3];
      try { 
        zipArchiveInputStream0.read(byteArray0, 2116805310, (-1));
        fail("Expecting exception: IOException");
