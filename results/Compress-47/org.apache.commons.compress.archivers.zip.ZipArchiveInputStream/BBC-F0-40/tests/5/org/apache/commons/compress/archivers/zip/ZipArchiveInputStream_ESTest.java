...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.read(byteArray0, 473, 473);
        fail("Expecting exception: IOException");
  ...
  public void test08()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(dataInputStream0, "UTF-16BE", true);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1073741823), 512);
      DataInputStream dataInputStream0 = new DataInputStream(byteArrayInputStream0);
  ...
  public void test13()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "VYS^pOF|Iw~Fs4'T", true, true);
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = new byte[3];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 2438, (-2736));
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
  ...
  public void test16()  throws Throwable  {
      ...
      DataInputStream dataInputStream0 = new DataInputStream(byteArrayInputStream0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(dataInputStream0);
      int int0 = zipArchiveInputStream0.read(byteArray0, 1636, (int) (byte) (-68));
      assertEquals((-1), int0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      long long0 = zipArchiveInputStream0.skip(2923L);
      assertEquals(0L, long0);
  }
  ...
  public void test23()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("<O{[Ie");
