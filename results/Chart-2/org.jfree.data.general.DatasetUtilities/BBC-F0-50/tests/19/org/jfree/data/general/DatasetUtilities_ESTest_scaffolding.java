...
public class DatasetUtilities_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.event.InputMethodListener", false, DatasetUtilities_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("java.sql.ResultSetMetaData", false, DatasetUtilities_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Statement", false, DatasetUtilities_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, DatasetUtilities_ESTest_scaffolding.class.getClassLoader()));
  }
