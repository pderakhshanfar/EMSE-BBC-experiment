...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Node node0 = new Node(2859, 2147483645, 2859);
  ...
  public void test02()  throws Throwable  {
      ...
      Node node0 = new Node(3152, (-309), 2147483645);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test04()  throws Throwable  {
      ...
      Node node0 = Node.newString("ZtVSA`z>hPMe8`M");
      // Undeclared exception!
      try { 
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("7Q4I|7 %4", (Node) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = new Node(1541, (-3552), 1541);
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("Pb+|'#y.|M.^M*", node0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      ...
      Node node0 = new Node(2192, (-830), (-4797));
  ...
  public void test13()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      CompilerOptions compilerOptions0 = new CompilerOptions();
      JSModule jSModule0 = new JSModule("com.google.javascript.jscompFunctionnjector$InliningMode");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      ...
      ImmutableList<FunctionInjector.Reference> immutableList0 = ImmutableList.of(functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference1, functionInjector_Reference0, functionInjector_Reference1, functionInjector_Reference0, functionInjector_Reference1, functionInjector_Reference1);
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
      Node node0 = Node.newNumber((-505.9366373839), (-363), (-363));
      LinkedList<FunctionInjector.Reference> linkedList0 = new LinkedList<FunctionInjector.Reference>();
  ...
  public void test17()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = new Node(126, 126, 592);
      node0.addChildrenToBack(node0);
      CompilerOptions compilerOptions0 = compiler0.newCompilerOptions();
  ...
  public void test18()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = new Node(2147483645, (-7), 2147483645);
      Node node1 = new Node(38, node0, node0, 5558, 370);
  ...
  public void test19()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionToBlockMutator.LabelNameSupplier functionToBlockMutator_LabelNameSupplier0 = new FunctionToBlockMutator.LabelNameSupplier(supplier0);
      Node node0 = new Node((-309), 5, 422);
      Node node1 = new Node((-3836), node0, node0, node0, node0);
      CompilerOptions compilerOptions0 = compiler0.newCompilerOptions();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, false, false, false);
  ...
  public void test21()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = new Node(3152, (-309), 2147483645);
      Node node1 = new Node((-2406), node0, node0, node0, node0);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      Node node3 = Normalize.parseAndNormalizeTestCode(compiler0, "goog.setCssNameMapping only takes an object literal with string values");
  ...
  public void test25()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = new Node((-4), 6, (-4));
      Node node1 = new Node(4, node0, node0, 36, (-1548));
      node0.addChildrenToBack(node1);
