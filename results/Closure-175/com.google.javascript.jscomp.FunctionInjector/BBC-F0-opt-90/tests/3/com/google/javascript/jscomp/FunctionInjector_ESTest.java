...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MakeDeclaredNamesUnique.BoilerplateRenamer makeDeclaredNamesUnique_BoilerplateRenamer0 = new MakeDeclaredNamesUnique.BoilerplateRenamer(jqueryCodingConvention0, supplier0, "e}P<2JF2[[JI");
      JSDocInfo jSDocInfo0 = new JSDocInfo();
      Set<String> set0 = jSDocInfo0.getModifies();
      MakeDeclaredNamesUnique.WhitelistedRenamer makeDeclaredNamesUnique_WhitelistedRenamer0 = new MakeDeclaredNamesUnique.WhitelistedRenamer(makeDeclaredNamesUnique_BoilerplateRenamer0, set0);
      ...
      Node node0 = compiler0.parseTestCode("#+erM,Rt!WeG");
      Node node1 = new Node((-1592), node0, node0, node0);
  ...
  public void test01()  throws Throwable  {
      ...
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      Node node1 = new Node((-4303), node0);
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "S?/`h7vxrT7}}%Q", node1, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test04()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, false);
      Node node0 = compiler0.parseTestCode("@R@]vTM;?");
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newNumber(0.0, 4475, 4475);
  ...
  public void test12()  throws Throwable  {
      ...
      ImmutableList<FunctionInjector.Reference> immutableList0 = ImmutableList.of(functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference1, functionInjector_Reference0, functionInjector_Reference1);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inliningLowersCost((JSModule) null, (Node) null, linkedList0, compilerOptions0.aliasableStrings, true, false);
        fail("Expecting exception: NullPointerException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inliningLowersCost(jSModule0, node0, linkedList0, compilerOptions0.stripTypePrefixes, false, true);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newNumber((-2395.235526075664), (-2261), 7);
      CompilerOptions compilerOptions0 = new CompilerOptions();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, true);
      JqueryCodingConvention jqueryCodingConvention0 = new JqueryCodingConvention();
      MakeDeclaredNamesUnique.BoilerplateRenamer makeDeclaredNamesUnique_BoilerplateRenamer0 = new MakeDeclaredNamesUnique.BoilerplateRenamer(jqueryCodingConvention0, supplier0, "ob#9");
      MakeDeclaredNamesUnique.WhitelistedRenamer makeDeclaredNamesUnique_WhitelistedRenamer0 = new MakeDeclaredNamesUnique.WhitelistedRenamer(makeDeclaredNamesUnique_BoilerplateRenamer0, compilerOptions0.stripNamePrefixes);
      MakeDeclaredNamesUnique makeDeclaredNamesUnique0 = new MakeDeclaredNamesUnique(makeDeclaredNamesUnique_WhitelistedRenamer0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, makeDeclaredNamesUnique0);
  ...
  public void test19()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newNumber((double) (-2261), 7, 7);
      CompilerOptions compilerOptions0 = new CompilerOptions();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, true);
      JqueryCodingConvention jqueryCodingConvention0 = new JqueryCodingConvention();
      MakeDeclaredNamesUnique.BoilerplateRenamer makeDeclaredNamesUnique_BoilerplateRenamer0 = new MakeDeclaredNamesUnique.BoilerplateRenamer(jqueryCodingConvention0, supplier0, "SHA-256");
      MakeDeclaredNamesUnique.WhitelistedRenamer makeDeclaredNamesUnique_WhitelistedRenamer0 = new MakeDeclaredNamesUnique.WhitelistedRenamer(makeDeclaredNamesUnique_BoilerplateRenamer0, compilerOptions0.aliasableStrings);
      MakeDeclaredNamesUnique makeDeclaredNamesUnique0 = new MakeDeclaredNamesUnique(makeDeclaredNamesUnique_WhitelistedRenamer0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, makeDeclaredNamesUnique0);
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "S?/`h7vxrT7}}%Q", node0, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
