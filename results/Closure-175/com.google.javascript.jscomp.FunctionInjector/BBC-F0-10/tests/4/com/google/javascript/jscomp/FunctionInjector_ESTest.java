...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("S]9kih7gA# jT%@XAk");
  ...
  public void test01()  throws Throwable  {
      ...
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      Node node0 = Node.newNumber((-711.218775487));
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "r$XH$qj=B:+E", node0, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test02()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((double) 1007, 1007, 1007);
  ...
  public void test03()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = compiler0.parseTestCode("^UQw?Y}W?(TC\"dZ");
      AbstractCompiler.LifeCycleStage abstractCompiler_LifeCycleStage0 = AbstractCompiler.LifeCycleStage.NORMALIZED_OBFUSCATED;
      compiler0.setLifeCycleStage(abstractCompiler_LifeCycleStage0);
  ...
  public void test07()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(1682.4556007566714, 44, 44);
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      SourceFile sourceFile0 = SourceFile.fromCode(" ;;mkQ>xqq~", "DECOMPOSABLE_EXPRESSION");
      Node node0 = compiler0.parse(sourceFile0);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, " ;;mkQ>xqq~", node0, functionInjector_InliningMode0);
  ...
  public void test09()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = compiler0.parseTestCode("JSC_SHIFT_AMOUNT_OfT_OF_BOUNDS");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("j}*c", node0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = compiler0.parseTestCode("SsHP8");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      InlineProperties inlineProperties0 = new InlineProperties(compiler0);
      InlineProperties.GatherCandidates inlineProperties_GatherCandidates0 = inlineProperties0.new GatherCandidates();
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, inlineProperties_GatherCandidates0);
  ...
  public void test15()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      StringReader stringReader0 = new StringReader(" ;;mkQ>xqq~");
      Set<String> set0 = WhitelistWarningsGuard.loadWhitelistedJsWarnings((Reader) stringReader0);
  ...
  public void test16()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader(" ;;mkQ>xqq~");
      Set<String> set0 = WhitelistWarningsGuard.loadWhitelistedJsWarnings((Reader) stringReader0);
      JSModule jSModule0 = new JSModule(" ;;mkQ>xqq~");
      ArrayList<FunctionInjector.Reference> arrayList0 = new ArrayList<FunctionInjector.Reference>();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference((Node) null, jSModule0, functionInjector_InliningMode0);
      arrayList0.add(functionInjector_Reference0);
  ...
  public void test17()  throws Throwable  {
      ...
      JSModule jSModule1 = new JSModule("com.google.javascript.jscomp.CompilerOptions$NullAliasTransformationHandler$NullAliasTransformation");
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      ArrayDeque<CharSource> arrayDeque0 = new ArrayDeque<CharSource>(linkedHashSet0);
      CharSource charSource0 = CharSource.concat((Iterable<? extends CharSource>) arrayDeque0);
      ...
      JSModule jSModule0 = new JSModule("Vy9umB;#4{-4R}a5");
      ArrayList<FunctionInjector.Reference> arrayList0 = new ArrayList<FunctionInjector.Reference>();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference((Node) null, jSModule0, functionInjector_InliningMode0);
      arrayList0.add(functionInjector_Reference0);
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inliningLowersCost(jSModule0, (Node) null, arrayList0, set0, false, false);
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      ...
      JSModule jSModule0 = new JSModule("");
      ArrayList<FunctionInjector.Reference> arrayList0 = new ArrayList<FunctionInjector.Reference>();
      boolean boolean0 = functionInjector0.inliningLowersCost(jSModule0, node0, arrayList0, set0, false, true);
      assertTrue(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, true);
      CheckSideEffects checkSideEffects0 = new CheckSideEffects(compiler0, compilerOptions0.brokenClosureRequiresLevel, false);
  ...
  public void test25()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = compiler0.parseTestCode("KAfEgl0");
      AbstractCompiler.LifeCycleStage abstractCompiler_LifeCycleStage0 = AbstractCompiler.LifeCycleStage.NORMALIZED;
      compiler0.setLifeCycleStage(abstractCompiler_LifeCycleStage0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "L.jlz=%wAxHZ", (Node) null, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = compiler0.parseTestCode("umRmd,t_Pjb");
      InlineProperties inlineProperties0 = new InlineProperties(compiler0);
      InlineProperties.GatherCandidates inlineProperties_GatherCandidates0 = inlineProperties0.new GatherCandidates();
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, inlineProperties_GatherCandidates0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
