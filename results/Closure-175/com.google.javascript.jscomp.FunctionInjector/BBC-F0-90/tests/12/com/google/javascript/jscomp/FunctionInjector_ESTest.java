...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JSModule jSModule0 = new JSModule("XQI{^HQ{.f");
  ...
  public void test01()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(2576.558);
      Node node1 = new Node(38, node0, 0, 156);
  ...
  public void test02()  throws Throwable  {
      ...
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "vq.T");
  ...
  public void test04()  throws Throwable  {
      ...
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      functionInjector0.canInlineReferenceToFunction(nodeTraversal0, node0, node1, compilerOptions0.stripNamePrefixes, functionInjector_InliningMode0, true, true);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, true, true);
      Node node0 = Node.newNumber((-1552.906308072342));
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline((Node) null, "L0JJA/Hv  uNg\"r!Q", (Node) null, functionInjector_InliningMode0);
  ...
  public void test11()  throws Throwable  {
      MockPrintStream mockPrintStream0 = new MockPrintStream("-8|]8u<o");
      Compiler compiler0 = new Compiler(mockPrintStream0);
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      // Undeclared exception!
  ...
  public void test12()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "vquK");
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("vquK", node0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      ImmutableListMultimap<String, Integer> immutableListMultimap0 = ImmutableListMultimap.of("com.google.javascript.jscomp.FunctionInjector$InliningMode", (Integer) node0.STATIC_SOURCE_FILE, "&UGG@zb]9x]Fd", (Integer) 54, "&UGG@zb]9x]Fd", (Integer) node0.SIDE_EFFECT_FLAGS, "-sTfihP}", (Integer) node0.FLAG_THIS_UNMODIFIED, "-sTfihP}", (Integer) node0.FLAG_THIS_UNMODIFIED);
  ...
  public void test19()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "com.google.javXscri~t.jgcomp.FunctionInjXctor$1");
      JSModule jSModule0 = new JSModule("p)VP4/%wK@{`i~39:");
      TreeSet<String> treeSet0 = new TreeSet<String>();
      ArrayList<FunctionInjector.Reference> arrayList0 = new ArrayList<FunctionInjector.Reference>();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference(node0, jSModule0, functionInjector_InliningMode0);
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inliningLowersCost(jSModule1, node0, arrayList0, treeSet0, true, false);
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, true, true);
      JSModule jSModule0 = new JSModule("l3dCDF");
      Node node0 = Node.newString("y5&3Ek_yGCUB");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference(node0, jSModule0, functionInjector_InliningMode0);
      ...
      ImmutableList<FunctionInjector.Reference> immutableList0 = ImmutableList.of(functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference1, functionInjector_Reference1, functionInjector_Reference0, functionInjector_ReferenceArray0);
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      FunctionToBlockMutator.LabelNameSupplier functionToBlockMutator_LabelNameSupplier0 = new FunctionToBlockMutator.LabelNameSupplier((Supplier<String>) null);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, false, true);
      Node node0 = Node.newString(114, "/)J<(S}V/<18)");
  ...
  public void test22()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Node.newNumber((-33.26133043666401));
      Node node1 = new Node(38, node0, 0, 50);
  ...
  public void test25()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(1454.3302962831);
      Node node1 = new Node(4, node0, (-990), 13);
      node0.addChildToBack(node1);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
