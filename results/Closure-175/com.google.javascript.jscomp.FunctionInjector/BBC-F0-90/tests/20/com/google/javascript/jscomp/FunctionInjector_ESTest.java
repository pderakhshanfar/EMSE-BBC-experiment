...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node1 = new Node(0, node0, 36, 40);
  ...
  public void test03()  throws Throwable  {
      ...
      Node node1 = new Node(42, node0, 56, 29);
      Node node2 = new Node(4, node1, 38, 1);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "g!i>X28+e^n`5-Z$", node0, functionInjector_InliningMode0);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("IanUN~=-r,|", (Node) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test08()  throws Throwable  {
      ...
      Node node0 = new Node(125, 1426, 2);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      linkedHashSet0.add("Bz@!863f,DHvh_@g");
  ...
  public void test13()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newNumber(1.0, 2730, 2730);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      ...
      ImmutableList<FunctionInjector.Reference> immutableList0 = ImmutableList.of(functionInjector_Reference1, functionInjector_Reference1, functionInjector_Reference1, functionInjector_Reference1, functionInjector_Reference1, functionInjector_Reference1, functionInjector_Reference0, functionInjector_Reference1, functionInjector_Reference1, functionInjector_Reference1);
  ...
  public void test16()  throws Throwable  {
      ...
      Stack<FunctionInjector.Reference> stack0 = new Stack<FunctionInjector.Reference>();
      boolean boolean0 = functionInjector0.inliningLowersCost((JSModule) null, nameReferenceGraph_Reference0.parent, stack0, (Set<String>) null, false, true);
      assertTrue(boolean0);
  }
  ...
  public void test18()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newNumber((-28.280324146581982));
      Node node1 = new Node(38, node0, 51, (-3311));
      Node node2 = new Node(3905, node1, (-4549), 4095);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
  ...
  public void test19()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newNumber((-28.280324146581982));
      Node node1 = new Node(38, node0, 51, 42);
      Node node2 = new Node(3905, node1, (-4541), 4095);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, false);
      SourceInformationAnnotator sourceInformationAnnotator0 = new SourceInformationAnnotator("7=#v|I]=Y$|", false);
      ...
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      functionInjector0.canInlineReferenceToFunction(nodeTraversal0, node2, node0, set0, functionInjector_InliningMode0, true, false);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Node node1 = new Node(40, node0, 1, 30);
      CheckGlobalThis checkGlobalThis0 = new CheckGlobalThis(compiler0);
      CompilerOptions compilerOptions0 = new CompilerOptions();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, checkGlobalThis0);
  ...
  public void test21()  throws Throwable  {
      ...
      Node node1 = new Node(51, node0, 2147483645, 57);
      CheckGlobalThis checkGlobalThis0 = new CheckGlobalThis(compiler0);
      CompilerOptions compilerOptions0 = new CompilerOptions();
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, checkGlobalThis0, (ScopeCreator) null);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
  ...
  public void test22()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, true, true);
      Node node0 = Node.newNumber((double) (-9));
      Node node1 = new Node(0, node0, 2147483645, (-470));
      CheckGlobalThis checkGlobalThis0 = new CheckGlobalThis(compiler0);
      CompilerOptions compilerOptions0 = new CompilerOptions();
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, checkGlobalThis0);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
  ...
  public void test23()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Node.newNumber(0.0);
      Node node1 = new Node((-1), node0, 49, 1);
      Node node2 = new Node(112, node1, 15, 49);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test24()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newNumber((-2.1451220007396645));
      Node node1 = new Node(4, node0, (-1), 30);
      Node node2 = new Node(30, node1, (-3059), 48);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
