...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      NavigableSet<String> navigableSet0 = treeMultimap0.get("BO:NdoR1xuD8E#^G");
      ...
      Node node0 = compiler0.parseSyntheticCode("BO:NdoR1xuD8E#^G", "com.google.javascript.jscomp.AliasExtenals$GetGlobals");
      Node node1 = new Node(43, node0, 1900, (-1433));
  ...
  public void test01()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      TreeMultimap<String, String> treeMultimap0 = TreeMultimap.create();
      NavigableSet<String> navigableSet0 = treeMultimap0.get("com.google.javascript.jscomp.SyntacticScopeCreator");
      LineNumberCheck lineNumberCheck0 = new LineNumberCheck(compiler0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, lineNumberCheck0);
      Node node0 = compiler0.parseSyntheticCode("M9+sVy2/CO;Oq", "DECOMPOSABLE_EXPRESSION");
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, false, true);
      Node node1 = Node.newString(3699, "");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      functionInjector0.canInlineReferenceToFunction(nodeTraversal0, node0, node1, navigableSet0, functionInjector_InliningMode0, true, true);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      TreeMultimap<String, String> treeMultimap0 = TreeMultimap.create();
      NavigableSet<String> navigableSet0 = treeMultimap0.get("js/%s}js");
      LineNumberCheck lineNumberCheck0 = new LineNumberCheck(compiler0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, lineNumberCheck0);
      Node node0 = compiler0.parseSyntheticCode("On%mZ66%1]H`4", "com.google.javascript.jscomp.AliasExtenals$GetGlobals");
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline((Node) null, "We can only sort lexical scopes", (Node) null, functionInjector_InliningMode0);
  ...
  public void test08()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Node.newNumber(1379.49626886);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("YG");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
  ...
  public void test13()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      JSModule jSModule0 = new JSModule("NZdLN");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      JSModule jSModule1 = new JSModule("NZdLN");
  ...
  public void test14()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(0.0, (-147), (-3566));
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
  ...
  public void test16()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      TreeMultimap<String, String> treeMultimap0 = TreeMultimap.create();
      NavigableSet<String> navigableSet0 = treeMultimap0.get("vB2O:NdoR1xu8E#l^G");
      LineNumberCheck lineNumberCheck0 = new LineNumberCheck(compiler0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, lineNumberCheck0);
      Node node0 = compiler0.parseSyntheticCode("vB2O:NdoR1xu8E#l^G", "com.google.javascript.jscomp.AliasExtenals$GetGlobals");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      Node node1 = new Node(3334, node0, 4, 8);
      // Undeclared exception!
      try { 
        functionInjector0.canInlineReferenceToFunction(nodeTraversal0, node0, node1, navigableSet0, functionInjector_InliningMode0, false, false);
        fail("Expecting exception: NullPointerException");
  ...
  public void test17()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      TreeMultimap<String, String> treeMultimap0 = TreeMultimap.create();
      NavigableSet<String> navigableSet0 = treeMultimap0.get("arguments");
      LineNumberCheck lineNumberCheck0 = new LineNumberCheck(compiler0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, lineNumberCheck0);
