...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      ImmutableListMultimap<FunctionInjector.Reference, String> immutableListMultimap0 = ImmutableListMultimap.of(functionInjector_Reference0, "null key in entry: null=", functionInjector_Reference0, "static", functionInjector_Reference0, "null key in entry: null=", functionInjector_Reference0, "");
      Set<FunctionInjector.Reference> set0 = immutableListMultimap0.keySet();
      boolean boolean0 = functionInjector0.inliningLowersCost((JSModule) null, (Node) null, set0, linkedHashSet0, true, false);
      assertTrue(boolean0);
  }
  ...
  public void test01()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = new Node((-3929), (-521), 0);
      Node node1 = Node.newNumber((-2433.922876543875));
      Node node2 = new Node((-1242), node0, node0, node1, node1, 10, 53);
  ...
  public void test02()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = new Node(2147483642, 2147483642, 2147483642);
  ...
  public void test03()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = new Node(2147483645, 1287, 2147483645);
  ...
  public void test04()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = new Node(2147483645, 1264, 2147483645);
      Node node1 = new Node(12, node0, node0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, false, false);
      MinimizeExitPoints minimizeExitPoints0 = new MinimizeExitPoints(compiler0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, minimizeExitPoints0);
  ...
  public void test05()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = new Node(105, 0, 2378);
  ...
  public void test07()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = compiler0.parseTestCode("O<$TLEFj:");
      // Undeclared exception!
      try { 
        functionInjector0.isDirectCallNodeReplacementPossible(node0);
  ...
  public void test10()  throws Throwable  {
      ...
      FunctionToBlockMutator.LabelNameSupplier functionToBlockMutator_LabelNameSupplier0 = new FunctionToBlockMutator.LabelNameSupplier(supplier0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, true, true);
      Node node0 = compiler0.parseSyntheticCode("<0sUd4mp|UXz}", "");
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("<0sUd4mp|UXz}", node0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = new Node(4194304, (-2180), 177);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, false, false);
  ...
  public void test15()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
      JSModule jSModule0 = new JSModule("Zby*'/'mJ");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
  ...
  public void test16()  throws Throwable  {
      ...
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("Zby*'/'mgJ");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference((Node) null, (JSModule) null, functionInjector_InliningMode0);
      ImmutableList<FunctionInjector.Reference> immutableList0 = ImmutableList.of(functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0);
      // Undeclared exception!
  ...
  public void test17()  throws Throwable  {
      ...
      ImmutableListMultimap<FunctionInjector.Reference, String> immutableListMultimap0 = ImmutableListMultimap.of(functionInjector_Reference0, "", functionInjector_Reference0, "", functionInjector_Reference0, "", functionInjector_Reference0, "");
      Set<FunctionInjector.Reference> set0 = immutableListMultimap0.keySet();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
      Node node0 = new Node((-1964), (-1964), (-1964));
      Node node1 = new Node(4, node0, node0, node0, node0, 52, 38);
  ...
  public void test24()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      SyntheticAst syntheticAst0 = new SyntheticAst("2L/k!]6=VCm)*");
  ...
  public void test25()  throws Throwable  {
      ...
      Node node1 = new Node(4, node0, node0, node0, node0, 52, (-1549));
      node0.addChildToFront(node1);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, false, true);
      // Undeclared exception!
      try { 
