...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      SourceFile sourceFile0 = SourceFile.fromFile(",~`$DK~-~[");
      Node node0 = compiler0.parse(sourceFile0);
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "xFd4`]_", (Node) null, functionInjector_InliningMode0);
  ...
  public void test01()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((double) (-1528));
      Node node1 = new Node((-1528), node0, node0, node0, node0, 36, (-30));
  ...
  public void test02()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((double) (-1528));
      Node node1 = new Node((-2), node0, node0, node0, node0, (-1), 4095);
  ...
  public void test06()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      Node node0 = Node.newNumber((double) (-227), (-227), (-227));
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("4TDAFb`~W", (Node) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      File file0 = MockFile.createTempFile("SsC]", "SsC]");
  ...
  public void test14()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      JSModule jSModule0 = new JSModule("u{ZPG~iGD]");
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      ImmutableListMultimap<String, FunctionInjector.Reference> immutableListMultimap0 = ImmutableListMultimap.of("RXYAj}rTC=mTyI", functionInjector_Reference0, "u{ZPG~iGD]", functionInjector_Reference0, "u{ZPG~iGD]", functionInjector_Reference0, "u{ZPG~iGD]", functionInjector_Reference0, "u{ZPG~iGD]", functionInjector_Reference0);
  ...
  public void test15()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule1 = new JSModule("u{ZPG~iGD]");
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      arrayList0.add(functionInjector_Reference0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, true, true);
      JSModule jSModule0 = new JSModule("Yaga~N2=sgc/");
      // Undeclared exception!
      try { 
        functionInjector0.inliningLowersCost(jSModule0, (Node) null, arrayList0, set0, true, false);
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("uPG~iGD]");
      ArrayList<FunctionInjector.Reference> arrayList0 = new ArrayList<FunctionInjector.Reference>();
      Locale locale0 = Locale.KOREA;
      Set<String> set0 = locale0.getUnicodeLocaleKeys();
  ...
  public void test20()  throws Throwable  {
      ...
      AnalyzePrototypeProperties.NameInfo analyzePrototypeProperties_NameInfo0 = analyzePrototypeProperties0.new NameInfo("!/k&<=-0U");
  ...
  public void test21()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      Node node2 = new Node(57, node1, 2, 4);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      SourceFile sourceFile0 = SourceFile.fromFile("Kp3}jH.'");
      Node node0 = compiler0.parse(sourceFile0);
      // Undeclared exception!
      try { 
        functionInjector0.inline((Node) null, "-cY=.", node0, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "Kp3}jH.'", node0, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.canInlineReferenceToFunction((NodeTraversal) null, node2, node0, (Set<String>) null, functionInjector_InliningMode0, false, false);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newString("DILRECT");
      Node node1 = new Node((-2), node0, node0);
      Node node2 = new Node(4, node1, (-2), 14);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
