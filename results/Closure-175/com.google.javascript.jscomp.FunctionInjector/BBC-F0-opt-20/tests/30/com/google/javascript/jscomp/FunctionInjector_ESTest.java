...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node0 = Node.newString(1461, "`=tL~>uCO", 1461, 1461);
  ...
  public void test01()  throws Throwable  {
      ...
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "N4;eiRTkg");
      AbstractCompiler.LifeCycleStage abstractCompiler_LifeCycleStage0 = AbstractCompiler.LifeCycleStage.NORMALIZED_OBFUSCATED;
      compiler0.setLifeCycleStage(abstractCompiler_LifeCycleStage0);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "g@cq", (Node) null, functionInjector_InliningMode0);
  ...
  public void test02()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = compiler0.parseTestCode("3n2N(|+F$^");
      AbstractCompiler.LifeCycleStage abstractCompiler_LifeCycleStage0 = AbstractCompiler.LifeCycleStage.NORMALIZED;
      compiler0.setLifeCycleStage(abstractCompiler_LifeCycleStage0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      Node node1 = Node.newString("3n2N(|+F$^");
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "<Xn|u1", node1, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test04()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      Node node0 = Node.newString("5yNty");
  ...
  public void test06()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "getString failed for");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline((Node) null, " jio^dp:33w", (Node) null, functionInjector_InliningMode0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "N4;eiRTkg", node0, functionInjector_InliningMode0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      ...
      Node node0 = Node.newString(153, "", 65, 65);
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("1C(aoGLZ", node0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      CheckMissingGetCssName checkMissingGetCssName0 = new CheckMissingGetCssName(compiler0, checkLevel0, "5yNty");
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, checkMissingGetCssName0);
      TreeMultimap<ErrorFormat, String> treeMultimap0 = TreeMultimap.create();
      ErrorFormat errorFormat0 = ErrorFormat.LEGACY;
      NavigableSet<String> navigableSet0 = treeMultimap0.get(errorFormat0);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      // Undeclared exception!
  ...
  public void test14()  throws Throwable  {
      ...
      FunctionToBlockMutator.LabelNameSupplier functionToBlockMutator_LabelNameSupplier0 = new FunctionToBlockMutator.LabelNameSupplier(supplier0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, true, true);
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "N4;eikg");
      Locale locale0 = new Locale("", "`=tL~>uCO", "");
  ...
  public void test16()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      StringBuffer stringBuffer0 = new StringBuffer("X4");
  ...
  public void test17()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      Node node0 = compiler0.parseTestCode("`=tL~>uCO");
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inliningLowersCost((JSModule) null, node0, linkedHashSet0, compilerOptions0.aliasableStrings, true, false);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("o\":eEN");
      ...
      TreeMap<String, ErrorFormat> treeMap0 = new TreeMap<String, ErrorFormat>();
  ...
  public void test21()  throws Throwable  {
      ...
      JSModule jSModule0 = new JSModule("HS-9nT{U}!");
      Node node0 = new Node((-342));
      TreeMap<String, ErrorFormat> treeMap0 = new TreeMap<String, ErrorFormat>();
      Set<String> set0 = treeMap0.keySet();
      boolean boolean0 = functionInjector0.inliningLowersCost(jSModule0, node0, vector0, set0, true, false);
      assertTrue(boolean0);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "N4;eRkg");
      Node node1 = new Node(4, node0, node0, node0, node0);
      node0.addChildToBack(node1);
      CompilerOptions compilerOptions0 = new CompilerOptions();
      CheckRegExp checkRegExp0 = new CheckRegExp(compiler0);
  ...
  public void test24()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "4;e#qRkg");
      Node node1 = new Node(4, node0, node0, node0, node0);
      node0.addChildToBack(node1);
  ...
  public void test25()  throws Throwable  {
      ...
      Node node2 = new Node(37, node1, 1, (-510));
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test28()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, false);
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "NS;Pkg");
  ...
  public void test30()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "z}`YE3{)Vz=O3BYn<");
      node0.addChildToBack(node0);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
