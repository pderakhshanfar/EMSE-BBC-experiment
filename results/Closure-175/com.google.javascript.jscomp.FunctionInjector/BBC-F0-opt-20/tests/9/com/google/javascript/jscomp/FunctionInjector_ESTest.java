...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node1 = new Node(3477, node0);
      ...
      try { 
        functionInjector0.inline(node0, "UD&Ruqns6amm@0yE", node1, functionInjector_InliningMode0);
  ...
  public void test02()  throws Throwable  {
      MockPrintStream mockPrintStream0 = new MockPrintStream("FPo( [_# CuGL~SbOc:X");
  ...
  public void test06()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      Node node0 = Node.newString("FPo( [_#CuGL~SbOc:X");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("xrd3I;x?1w\";qu}9`", node0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      ...
      stack0.add(functionInjector_Reference0);
      CompilerOptions compilerOptions0 = new CompilerOptions();
      boolean boolean0 = functionInjector0.inliningLowersCost((JSModule) null, (Node) null, stack0, compilerOptions0.stripTypes, true, false);
      assertTrue(boolean0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("WDo");
      Stack<FunctionInjector.Reference> stack0 = new Stack<FunctionInjector.Reference>();
  ...
  public void test16()  throws Throwable  {
      MockPrintStream mockPrintStream0 = new MockPrintStream("Fro( [_#CuGL~SbO:X");
      Compiler compiler0 = new Compiler(mockPrintStream0);
      File file0 = MockFile.createTempFile("Fro( [_#CuGL~SbO:X", "w)^nH7sdl-x");
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      ...
      JSModule jSModule1 = new JSModule("Fro( [_#CuGL~SbO:X");
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      MockPrintStream mockPrintStream0 = new MockPrintStream("Fro( [_#CuGL~SbO:X");
      Compiler compiler0 = new Compiler(mockPrintStream0);
      File file0 = MockFile.createTempFile("Fro( [_#CuGL~SbO:X", "w)^nH7dlx");
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("com.google.javascript]rhino.head.IdScriptableObject");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
  ...
  public void test19()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      JSModule jSModule0 = new JSModule("N.$Qh47&");
      Stack<FunctionInjector.Reference> stack0 = new Stack<FunctionInjector.Reference>();
      Node node0 = Node.newString("FPo( [_#CuGL~SbOc:X");
      CompilerOptions compilerOptions0 = compiler0.newCompilerOptions();
      boolean boolean0 = functionInjector0.inliningLowersCost(jSModule0, node0, stack0, compilerOptions0.stripNamePrefixes, false, false);
      assertTrue(boolean0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "UD&Ruqns6amm@0yE", node0, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      Node node0 = new Node(746, 746, 10);
  ...
  public void test25()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, true);
      Node node2 = new Node(4, node1, 4095, 49);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
        fail("Expecting exception: NullPointerException");
