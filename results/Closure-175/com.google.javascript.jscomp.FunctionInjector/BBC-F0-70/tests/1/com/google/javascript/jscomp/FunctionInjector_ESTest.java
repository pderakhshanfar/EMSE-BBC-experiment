...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        functionInjector0.inline(node0, "Bzhy6u{\"V", node1, functionInjector_InliningMode0);
  ...
  public void test01()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newNumber(341.168);
      Node node1 = new Node(0);
      Node node2 = new Node(38, node0, node1, node0, node0, 43, 0);
  ...
  public void test02()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((double) 21, 1, 1);
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "1lf4(-[On{", node0, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      ...
      Node node0 = Node.newString("3)b{I-fECXD-");
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "$DSOe#XtAXH~(8(o=", node0, functionInjector_InliningMode0);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node1, "1lf4(-[On{", node1, functionInjector_InliningMode0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, false, true);
      Node node0 = Node.newString("8[-_H+VCZ~NG!\b#+");
  ...
  public void test17()  throws Throwable  {
      ...
      InlineSimpleMethods inlineSimpleMethods0 = new InlineSimpleMethods(compiler0);
      Set<String> set0 = inlineSimpleMethods0.externMethodsWithoutSignatures;
      JSModule jSModule0 = new JSModule("64154dbe8");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
  ...
  public void test18()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = new Node((-1012), (-1012), (-1012));
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, true, true);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      ...
      ImmutableMap<String, FunctionInjector.Reference> immutableMap0 = ImmutableMap.of("Z", functionInjector_Reference0);
  ...
  public void test20()  throws Throwable  {
      ...
      InlineSimpleMethods inlineSimpleMethods0 = new InlineSimpleMethods(compiler0);
      Set<String> set0 = inlineSimpleMethods0.externMethodsWithoutSignatures;
      JSModule jSModule0 = new JSModule("2F{zb?E+B^r'^");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference((Node) null, jSModule0, functionInjector_InliningMode0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      ImmutableList<FunctionInjector.Reference> immutableList0 = ImmutableList.of(functionInjector_Reference0);
  ...
  public void test21()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newNumber((-2847.9266283725447));
  ...
  public void test23()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newNumber(341.168);
      Node node1 = new Node(38, node0, node0, node0, node0, 43, 0);
      node0.addChildToFront(node1);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, false, true);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
  ...
  public void test24()  throws Throwable  {
      ...
      Node node0 = new Node((-1), (-1), 246);
      Node node1 = new Node(10, node0, node0, 3, (-1621));
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, checkRegExp0, (ScopeCreator) null);
      Node node0 = new Node((-1024), (-1024), (-1024));
      Node node1 = new Node(4095, node0, node0, node0, 56, 47);
  ...
  public void test27()  throws Throwable  {
      ...
      Node node1 = new Node(3, node0, node0, node0, node0, 53, (-2254));
      SyntheticAst syntheticAst0 = new SyntheticAst("com.google.common.collect.ImmutableMultimap$EntryCollection");
  ...
  public void test28()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, true, true);
      Node node0 = Node.newNumber((-2847.9266283725447));
      Node node1 = new Node(4, node0, node0, node0, node0, 57, (-613));
      node0.addChildToFront(node1);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
