...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      GoogleJsMessageIdGenerator googleJsMessageIdGenerator0 = new GoogleJsMessageIdGenerator("DIRECT");
      ...
      Node node0 = Node.newString(5529, "3zi9O},CRuyM");
      Node node1 = new Node(5529, node0, node0, node0, node0);
  ...
  public void test07()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(984.55);
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements(":i$m", node0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      HashSet<String> hashSet0 = new HashSet<String>();
      JSModule jSModule0 = new JSModule(">?oW}7&$@nU4");
      Node node0 = Node.newString(6, "com.google.common.collect.ImmutableMultimap$2");
      ArrayDeque<FunctionInjector.Reference> arrayDeque0 = new ArrayDeque<FunctionInjector.Reference>();
      JSModule jSModule1 = new JSModule(">?oW}7&$@nU4");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inliningLowersCost(jSModule0, node0, arrayDeque0, hashSet0, true, true);
        fail("Expecting exception: NullPointerException");
  ...
  public void test15()  throws Throwable  {
      ...
      Node node0 = Node.newString(6, "com.google.common.collect.ImmutableMultimap$2");
      ArrayDeque<FunctionInjector.Reference> arrayDeque0 = new ArrayDeque<FunctionInjector.Reference>();
      boolean boolean0 = functionInjector0.inliningLowersCost(jSModule0, node0, arrayDeque0, hashSet0, true, true);
      assertTrue(boolean0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      HashSet<String> hashSet0 = new HashSet<String>();
      JSModule jSModule0 = new JSModule(">?oW}7&$@nU4");
      Node node0 = Node.newString(11, "I7");
      ArrayDeque<FunctionInjector.Reference> arrayDeque0 = new ArrayDeque<FunctionInjector.Reference>();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference(node0, (JSModule) null, functionInjector_InliningMode0);
      arrayDeque0.add(functionInjector_Reference0);
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inliningLowersCost(jSModule0, node0, arrayDeque0, hashSet0, true, false);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      HashSet<String> hashSet0 = new HashSet<String>();
      JsMessage.Style jsMessage_Style0 = JsMessage.Style.LEGACY;
      GoogleJsMessageIdGenerator googleJsMessageIdGenerator0 = new GoogleJsMessageIdGenerator("Q");
      ReplaceMessagesForChrome replaceMessagesForChrome0 = new ReplaceMessagesForChrome(compiler0, googleJsMessageIdGenerator0, true, jsMessage_Style0);
      SyntacticScopeCreator syntacticScopeCreator0 = new SyntacticScopeCreator(compiler0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, replaceMessagesForChrome0, syntacticScopeCreator0);
      Node node0 = new Node((-5), (-5), (-2292));
