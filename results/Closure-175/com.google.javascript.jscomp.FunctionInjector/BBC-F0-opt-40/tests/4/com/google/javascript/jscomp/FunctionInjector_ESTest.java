...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node0 = Node.newString(4758, "x*W^Z;ywE$-;:=", 659, 4758);
      Node node1 = new Node(659, node0);
  ...
  public void test01()  throws Throwable  {
      ...
      Set<String> set0 = gatherRawExports0.getExportedVariableNames();
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, gatherRawExports0, (ScopeCreator) null);
      Node node0 = Node.newString("", 659, 659);
      Node node1 = new Node(16, node0, 57, 43);
  ...
  public void test04()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("", 659, (-872));
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("%78e<Q^|omeA_G^^ ", (Node) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test13()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      JSModule jSModule0 = new JSModule("q%.v{dB_+Fw`qyK(1");
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inliningLowersCost(jSModule1, (Node) null, priorityQueue0, (Set<String>) null, true, false);
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      ...
      CharSource charSource0 = CharSource.wrap(charBuffer0);
      Set<String> set0 = WhitelistWarningsGuard.loadWhitelistedJsWarnings(charSource0);
      JSModule jSModule0 = new JSModule("o+i*.r$= m@OS");
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "yfAlquw");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
  ...
  public void test19()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("visibility", 9, 3029);
  ...
  public void test22()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("", 659, (-863));
      Node node1 = new Node(47, node0);
      Node node2 = new Node(4, node1, 32768, 3);
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionToBlockMutator.LabelNameSupplier functionToBlockMutator_LabelNameSupplier0 = new FunctionToBlockMutator.LabelNameSupplier(supplier0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, true, true);
      // Undeclared exception!
