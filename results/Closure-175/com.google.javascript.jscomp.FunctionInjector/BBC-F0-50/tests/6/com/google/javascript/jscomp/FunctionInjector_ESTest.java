...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node0 = Node.newString("jxPQNn{k!)F@8m");
      Node node1 = new Node(38, node0, node0, node0, node0, 2, 6);
  ...
  public void test02()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      TreeSet<String> treeSet0 = new TreeSet<String>();
      ProcessCommonJSModules processCommonJSModules0 = new ProcessCommonJSModules(compiler0, ";5'K0=Eze~dgTQ?@Q2", true);
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "./");
      Node node1 = new Node(3, node0, node0, 3, 4);
      ...
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      functionInjector0.canInlineReferenceToFunction(nodeTraversal0, node0, node1, treeSet0, functionInjector_InliningMode0, true, false);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = compiler0.parseTestCode("N4,BFT,I");
      Denormalize.StripConstantAnnotations denormalize_StripConstantAnnotations0 = new Denormalize.StripConstantAnnotations(compiler0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, denormalize_StripConstantAnnotations0, (ScopeCreator) null);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      Node node1 = Node.newString(43, "N4,BFT,I", 3, 3);
  ...
  public void test04()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = compiler0.parseTestCode("Unable to delete ");
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "N4,BFT,I", node1, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      ...
      Node node0 = compiler0.parseTestCode(".#J'5");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "e@zHtI!^x@5b:@`g", (Node) null, functionInjector_InliningMode0);
  ...
  public void test08()  throws Throwable  {
      ...
      Node node1 = Node.newString(49, "SIMPLE_ASSIGNMENT");
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node2, "?{CI>b~V!o0gq", node0, functionInjector_InliningMode0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("$_,p.3Ce?5ZFMJh@", (Node) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements(";5'K0=Eze~dgTQ?@Q2", node0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      ...
      Node node1 = new Node(4, node0, node0, node0, node0, 38, 36);
      node0.addChildToFront(node1);
      functionInjector0.setKnownConstants((Set<String>) null);
      HashSet<String> hashSet0 = new HashSet<String>();
  ...
  public void test17()  throws Throwable  {
      ...
      ImmutableList<FunctionInjector.Reference> immutableList0 = ImmutableList.of(functionInjector_Reference1, functionInjector_Reference0, functionInjector_Reference1, functionInjector_Reference0, functionInjector_Reference1, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference1, functionInjector_Reference1, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_ReferenceArray0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Node.newString("MAPHE,");
      Node node1 = new Node(4, node0, node0, node0, node0, 38, 36);
      node0.addChildToFront(node1);
  ...
  public void test23()  throws Throwable  {
      ...
      Node node0 = Node.newString("jxPQNn{k!)F@8m");
      Node node1 = new Node(38, node0, node0, node0, node0, 0, 6);
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "N4,BFT,I", node0, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Node.newString("'HxLZ)Q!hM%(Z}sn");
      Node node1 = new Node(38, node0, node0, node0, node0, 37, 3);
      node0.addChildToFront(node1);
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, (NodeTraversal.Callback) null);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
