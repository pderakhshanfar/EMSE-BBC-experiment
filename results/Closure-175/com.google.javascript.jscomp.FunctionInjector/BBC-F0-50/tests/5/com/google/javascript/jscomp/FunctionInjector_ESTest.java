...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      MockFile mockFile0 = new MockFile("Chinese (Taiwan)");
      ...
      Node node2 = new Node(66, node1, node1, 12, 40);
  ...
  public void test02()  throws Throwable  {
      ...
      Node node1 = new Node(760, node0, node0);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "xZ}", node1, functionInjector_InliningMode0);
  ...
  public void test04()  throws Throwable  {
      ...
      CompilerInput compilerInput0 = new CompilerInput(sourceFile0, false);
      Node node0 = compilerInput0.getAstRoot(compiler0);
      Node node1 = new Node(3, node0, node0, (-964), 15);
  ...
  public void test07()  throws Throwable  {
      ...
      FunctionToBlockMutator.LabelNameSupplier functionToBlockMutator_LabelNameSupplier0 = new FunctionToBlockMutator.LabelNameSupplier(supplier0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, false, false, false);
      Node node0 = Node.newNumber((-1529.9878853), 17, 3876);
      // Undeclared exception!
      try { 
  ...
  public void test10()  throws Throwable  {
      ...
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      Node node1 = new Node(0, node0, node0, node0, node0, 3, 31);
      // Undeclared exception!
      try { 
        functionInjector0.inline(node1, "1O+ywA0.KSGB", node0, functionInjector_InliningMode0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("c(&t'Fo!\"NXA3=lOP", (Node) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test12()  throws Throwable  {
      ...
      FunctionToBlockMutator.LabelNameSupplier functionToBlockMutator_LabelNameSupplier0 = new FunctionToBlockMutator.LabelNameSupplier(supplier0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, false, false, false);
      Node node0 = Node.newString(2886, "c(&t'Fo!\"NXA3=lOP");
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("c(&t'Fo!\"NXA3=lOP", node0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      FunctionToBlockMutator.LabelNameSupplier functionToBlockMutator_LabelNameSupplier0 = new FunctionToBlockMutator.LabelNameSupplier(supplier0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, true, true);
      JSModule jSModule0 = new JSModule("=rWE$g(8dU");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
  ...
  public void test17()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, true, true);
      JSModule jSModule0 = new JSModule("E!XPRESSIO<N");
      ArrayList<FunctionInjector.Reference> arrayList0 = new ArrayList<FunctionInjector.Reference>();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference((Node) null, jSModule0, functionInjector_InliningMode0);
      arrayList0.add(functionInjector_Reference0);
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inliningLowersCost(jSModule1, (Node) null, arrayList0, set0, true, true);
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      ...
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference((Node) null, (JSModule) null, functionInjector_InliningMode0);
      arrayList0.add(functionInjector_Reference0);
      JSModule jSModule0 = new JSModule("02@Ba");
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      Set<String> set0 = locale0.getUnicodeLocaleKeys();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, true, true);
      JSModule jSModule0 = new JSModule("checkType");
      ArrayList<FunctionInjector.Reference> arrayList0 = new ArrayList<FunctionInjector.Reference>();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference((Node) null, jSModule0, functionInjector_InliningMode0);
      arrayList0.add(functionInjector_Reference0);
  ...
  public void test23()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("com.google.common.collect.ImmutableMultimap$Itr");
      SourceFile sourceFile0 = SourceFile.fromFile((File) mockFile0);
      CompilerInput compilerInput0 = new CompilerInput(sourceFile0, true);
      Node node0 = compilerInput0.getAstRoot(compiler0);
      Node node1 = new Node(4, node0, 39, 51);
  ...
  public void test24()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      MockFile mockFile0 = new MockFile("Chinese (Taiwan)", "Chinese (Taiwan)");
      SourceFile sourceFile0 = SourceFile.fromFile((File) mockFile0);
      CompilerInput compilerInput0 = new CompilerInput(sourceFile0, false);
      Node node0 = compilerInput0.getAstRoot(compiler0);
      Node node1 = new Node(38, node0, 36, 54);
      node0.addChildrenToBack(node1);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "xZ}", node0, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      ...
      Set<String> set0 = locale0.getUnicodeLocaleKeys();
      MockFile mockFile0 = new MockFile("d3S r**=W+dACF");
      SourceFile sourceFile0 = SourceFile.fromFile((File) mockFile0);
      CompilerInput compilerInput0 = new CompilerInput(sourceFile0, false);
      Node node0 = compilerInput0.getAstRoot(compiler0);
      Node node1 = new Node(38, 3, 50);
      Node node2 = new Node(1, node1, node0, 1, (-1693));
  ...
  public void test27()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("Chinese (Taiwan)", "Chinese (Taiwan)");
  ...
  public void test29()  throws Throwable  {
      ...
      CompilerInput compilerInput0 = new CompilerInput(sourceFile0, false);
      Node node0 = compilerInput0.getAstRoot(compiler0);
      Node node1 = new Node(4, node0, 120, 51);
      node0.addChildrenToBack(node1);
      functionInjector0.maybePrepareCall(node0);
