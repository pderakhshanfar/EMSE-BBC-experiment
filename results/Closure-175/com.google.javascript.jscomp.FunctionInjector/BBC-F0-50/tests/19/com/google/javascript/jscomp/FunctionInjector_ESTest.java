...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node0 = Node.newString("VM\"I:vDGK]St;b>(,-");
      Node node1 = new Node(48, node0);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      ConstParamCheck constParamCheck0 = new ConstParamCheck(compiler0);
      ImmutableList<NodeTraversal.Callback> immutableList0 = ImmutableList.of((NodeTraversal.Callback) constParamCheck0, (NodeTraversal.Callback) constParamCheck0, (NodeTraversal.Callback) constParamCheck0, (NodeTraversal.Callback) constParamCheck0, (NodeTraversal.Callback) constParamCheck0, (NodeTraversal.Callback) constParamCheck0, (NodeTraversal.Callback) constParamCheck0, (NodeTraversal.Callback) constParamCheck0, (NodeTraversal.Callback) constParamCheck0, (NodeTraversal.Callback) constParamCheck0);
  ...
  public void test03()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("j-%%3XkwyXDzQH2HU");
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
  ...
  public void test06()  throws Throwable  {
      ...
      Node node0 = Node.newString("jKEjhe");
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("jKEjhe", node0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      ...
      JSModule jSModule0 = new JSModule("^p6tzA!U=nu");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      ...
      JSModule jSModule1 = new JSModule("^p6tzA!U=nu");
  ...
  public void test10()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("IVT_{r");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference((Node) null, jSModule0, functionInjector_InliningMode0);
      ImmutableList<FunctionInjector.Reference> immutableList0 = ImmutableList.of(functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0);
  ...
  public void test12()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, false, false);
      JSModule jSModule0 = new JSModule("^h9");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
  ...
  public void test15()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, false, false);
      Node node0 = Node.newString("L ");
      Node node1 = new Node(2851, node0);
      Node node2 = new Node(1, node1, node1, 15, 30);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test19()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Node.newString("VM\"I:vDGK]St;b>(,-");
      Node node1 = new Node(50, node0, node0, node0, 32, 32);
