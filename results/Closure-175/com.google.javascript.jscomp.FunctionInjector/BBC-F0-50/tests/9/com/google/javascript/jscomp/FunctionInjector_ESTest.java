...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node1 = new Node(1583, node0, node0);
  ...
  public void test01()  throws Throwable  {
      ...
      Node node1 = new Node(4, node0, node0, node0, 46, (-921210296));
      CompilerOptions compilerOptions0 = compiler0.newCompilerOptions();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
  ...
  public void test13()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newString(3760, "Unexpected call site type.");
      JSDocInfo jSDocInfo0 = new JSDocInfo();
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inliningLowersCost(jSModule1, nameReferenceGraph_Reference0.parent, immutableList0, set0, true, false);
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      Locale locale0 = Locale.forLanguageTag("^sN$!,nBP_C(6P@|%");
      ...
      JSModule jSModule0 = new JSModule("^sN$!,nBP_C(6P@|%");
      Node node0 = Node.newString((-942), " TE+ZmhVAh\"5S}H{X");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
  ...
  public void test15()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, false, true);
      Locale locale0 = Locale.forLanguageTag("^sN$!,nBP_C(6P@|%");
      Node node0 = Node.newString(92, "PI.{");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
  ...
  public void test16()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newString(3760, "UnexpCcted call site type.");
      JSDocInfo jSDocInfo0 = new JSDocInfo();
      NameReferenceGraph.Reference nameReferenceGraph_Reference0 = new NameReferenceGraph.Reference(node0, node0);
      Set<String> set0 = jSDocInfo0.getSuppressions();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      ...
      ImmutableList<FunctionInjector.Reference> immutableList0 = ImmutableList.of(functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, true);
      JSModule jSModule0 = new JSModule("UnexpCcted call site type.");
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      Node node0 = Node.newString(1497, "VAR_DECL_SIMPLE_ASSIGNMENT");
      NameReferenceGraph.Reference nameReferenceGraph_Reference0 = new NameReferenceGraph.Reference(node0, node0);
      Stack<FunctionInjector.Reference> stack0 = new Stack<FunctionInjector.Reference>();
      JSDocInfo jSDocInfo0 = new JSDocInfo();
      Set<String> set0 = jSDocInfo0.getModifies();
      boolean boolean0 = functionInjector0.inliningLowersCost((JSModule) null, nameReferenceGraph_Reference0.site, stack0, set0, false, true);
      assertTrue(boolean0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      SyntacticScopeCreator syntacticScopeCreator0 = new SyntacticScopeCreator(compiler0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, checkMissingGetCssName0, syntacticScopeCreator0);
      Node node0 = Node.newString("Movable expressions must be moved before inlining.", 4, (int) (byte)15);
      Node node1 = new Node((byte)15, node0, node0);
      CompilerOptions compilerOptions0 = compiler0.newCompilerOptions();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = compiler0.parseTestCode("Sanity Check failed");
      JSDocInfo jSDocInfo0 = new JSDocInfo();
      NameReferenceGraph.Reference nameReferenceGraph_Reference0 = new NameReferenceGraph.Reference(node0, node0);
      Set<String> set0 = jSDocInfo0.getModifies();
      ...
      // Undeclared exception!
      functionInjector0.canInlineReferenceToFunction(nodeTraversal0, nameReferenceGraph_Reference0.site, nameReferenceGraph_Reference0.parent, set0, functionInjector_InliningMode0, true, true);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      node0.addChildToFront(nameReferenceGraph_Reference0.parent);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, true);
      functionInjector0.canInlineReferenceToFunction(nodeTraversal0, nameReferenceGraph_Reference0.site, nameReferenceGraph_Reference0.parent, set0, functionInjector_InliningMode0, false, false);
  }
