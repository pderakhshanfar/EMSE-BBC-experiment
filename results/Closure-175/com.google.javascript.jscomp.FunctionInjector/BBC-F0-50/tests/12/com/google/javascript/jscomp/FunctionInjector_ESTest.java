...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      SyntheticAst syntheticAst0 = new SyntheticAst("+k>wh//Et");
  ...
  public void test03()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newString("rguents");
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
  ...
  public void test07()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      SyntheticAst syntheticAst0 = new SyntheticAst("a5rguments");
      Node node0 = syntheticAst0.getAstRoot(compiler0);
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node1, "\"k6-0>UTUc{t,a0", node0, functionInjector_InliningMode0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements(":[)p>/|!ViM", (Node) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("anchor", node0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, true, false);
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
      linkedHashSet0.add("1Ul,s7tI`zv");
  ...
  public void test14()  throws Throwable  {
      ...
      CompilerOptions compilerOptions0 = new CompilerOptions();
      JSModule jSModule0 = new JSModule(".push");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      ...
      ImmutableBiMap<FunctionInjector.Reference, Object> immutableBiMap0 = ImmutableBiMap.of(functionInjector_Reference0, (Object) compiler0);
      ImmutableSet<FunctionInjector.Reference> immutableSet0 = immutableBiMap0.keySet();
      boolean boolean0 = functionInjector0.inliningLowersCost(jSModule0, (Node) null, immutableSet0, compilerOptions0.stripNamePrefixes, true, false);
      assertTrue(boolean0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Node.newNumber(390.1463481169614);
  ...
  public void test16()  throws Throwable  {
      ...
      JSModule jSModule1 = new JSModule("-3:v)4*IrS,vC32 ");
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      ImmutableList<FunctionInjector.Reference> immutableList0 = ImmutableList.of(functionInjector_Reference0, functionInjector_Reference1, functionInjector_Reference1, functionInjector_Reference1, functionInjector_Reference1, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference1, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference1);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      CompilerOptions compilerOptions0 = new CompilerOptions();
      JSModule jSModule0 = new JSModule("JSCompiler_alias_THROW");
      HashSet<FunctionInjector.Reference> hashSet0 = new HashSet<FunctionInjector.Reference>();
      boolean boolean0 = functionInjector0.inliningLowersCost(jSModule0, (Node) null, hashSet0, compilerOptions0.stripTypes, false, false);
      assertTrue(boolean0);
  }
  ...
  public void test22()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      SyntheticAst syntheticAst0 = new SyntheticAst("abz-Qu +nts");
      Node node0 = syntheticAst0.getAstRoot(compiler0);
      Node node1 = new Node(48, node0, node0);
      AbstractCompiler.LifeCycleStage abstractCompiler_LifeCycleStage0 = AbstractCompiler.LifeCycleStage.NORMALIZED;
      compiler0.setLifeCycleStage(abstractCompiler_LifeCycleStage0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, true);
      Node node2 = new Node(4, node1, (-2634), 451);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "abz-Qu +nts", node1, functionInjector_InliningMode0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test23()  throws Throwable  {
      ...
      AbstractCompiler.LifeCycleStage abstractCompiler_LifeCycleStage0 = AbstractCompiler.LifeCycleStage.NORMALIZED_OBFUSCATED;
      compiler0.setLifeCycleStage(abstractCompiler_LifeCycleStage0);
      Node node0 = Node.newString((-3126), "mK=H5J(!nM:)zU{");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "mK=H5J(!nM:)zU{", node0, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "abz-Qu +nts", node0, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.canInlineReferenceToFunction((NodeTraversal) null, node1, node1, linkedHashSet0, functionInjector_InliningMode0, false, true);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      ...
      nodeArray0[0] = node0;
      Node node1 = new Node(4, nodeArray0, 1172, 54);
      node0.addChildToBack(node1);
      functionInjector0.maybePrepareCall(node0);
