...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node1 = compiler0.parseTestCode("SIMPLE_ASSIGN5MENT");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "Nested loops are forbidden", node1, functionInjector_InliningMode0);
  ...
  public void test01()  throws Throwable  {
      ...
      Node node0 = compiler0.parseSyntheticCode("a\"6yDW|wSc&ZFJ(!U=", "DIRECT");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      Node node1 = Node.newString(2833, "BLOCK", (-3328), 37);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("z4Nm<\"", (Node) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test08()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, false, false);
      Node node0 = compiler0.parseTestCode("[hOyiR]");
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "v]zjdgHuP+WPr9");
  ...
  public void test11()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      ImmutableSortedMap<String, String> immutableSortedMap0 = ImmutableSortedMap.of("A~<obv!j", "A~<obv!j", "VAR_DECL_SIMPLE_ASSIGNMENT", "arguments");
  ...
  public void test15()  throws Throwable  {
      ...
      Node node0 = Node.newString((-50), "", (-50), (-50));
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("8SvRXI]A-&\"/csz,<Fp");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      JSModule jSModule1 = new JSModule("8SvRXI]A-&\"/csz,<Fp");
  ...
  public void test20()  throws Throwable  {
      ...
      GatherRawExports gatherRawExports0 = new GatherRawExports(compiler0);
      TreeSet<String> treeSet0 = new TreeSet<String>();
      Node node0 = Node.newString("", 7, (-1749));
      Node node1 = new Node(38, node0, node0, 336, 8);
      Node node2 = new Node(12, node1, node1, 2147483645, 42);
  ...
  public void test21()  throws Throwable  {
      ...
      TreeSet<String> treeSet0 = new TreeSet<String>();
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, gatherRawExports0);
      Node node0 = Node.newString(1, "|#^P", 2147483645, 1);
      Node node1 = new Node(50, node0, node0, 42, 54);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      Node node0 = compiler0.parseTestCode("SIMPLE_ASSIGN5MENT");
      Node node1 = new Node(112, node0, node0, node0);
      Node node2 = new Node(43, node1, (-2015), (-4793));
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test23()  throws Throwable  {
      ...
      Node node2 = new Node(4, node1, 55, 36);
      // Undeclared exception!
      try { 
        functionInjector0.maybePrepareCall(node0);
        fail("Expecting exception: NullPointerException");
