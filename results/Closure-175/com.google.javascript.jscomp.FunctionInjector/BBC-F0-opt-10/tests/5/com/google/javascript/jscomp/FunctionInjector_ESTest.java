...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      MockFile mockFile0 = new MockFile("com.google.common.base.CharMatcher$3");
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("6`,", (Node) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test05()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "l}{0(]X%>tV]yA#+IC|");
  ...
  public void test06()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "com.google.javascript.rhino.jstype.anionType");
      Node node1 = new Node(55, node0, node0, node0, 50, 15);
  ...
  public void test07()  throws Throwable  {
      ...
      Node node1 = new Node(54, node0, 51, 52);
  ...
  public void test12()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("d>ek3Fw$");
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "b&e!E(o");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      ...
      ImmutableList<FunctionInjector.Reference> immutableList0 = ImmutableList.of(functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0);
      ImmutableListMultimap<String, Integer> immutableListMultimap0 = ImmutableListMultimap.of("", (Integer) node0.DIRECTIVES, "", (Integer) node0.LENGTH, "d>ek3Fw$", (Integer) node0.NO_SIDE_EFFECTS, "", (Integer) 57);
  ...
  public void test15()  throws Throwable  {
      ...
      FunctionToBlockMutator.LabelNameSupplier functionToBlockMutator_LabelNameSupplier0 = new FunctionToBlockMutator.LabelNameSupplier(supplier0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, true, true);
      ImmutableListMultimap<String, Integer> immutableListMultimap0 = ImmutableListMultimap.of("Symbol not found in table ", (Integer) 53, "com.google.javascript.jscomp.RemoveTryCatch$RemoveTryCatchCode", (Integer) node0.DECR_FLAG, "", (Integer) 48, "com.google.javascript.jscomp.FunctionInjector$2", (Integer) node0.SIDE_EFFECT_FLAGS);
      ImmutableSet<String> immutableSet0 = immutableListMultimap0.keySet();
      Vector<FunctionInjector.Reference> vector0 = new Vector<FunctionInjector.Reference>();
      boolean boolean0 = functionInjector0.inliningLowersCost((JSModule) null, (Node) null, vector0, immutableSet0, false, true);
      assertTrue(boolean0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Node node1 = new Node((-29), node0, 16, 36);
      Node node2 = new Node(4, node1, node1);
  ...
  public void test19()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "PK[a/b?6sN`+UtSP");
      Node node1 = new Node(38, node0, node0, node0, (-616), (-143));
  ...
  public void test20()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "xx'`-O5syY)DOG%");
      Node node1 = new Node(53, node0, (-651), 36);
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      SourceInformationAnnotator sourceInformationAnnotator0 = new SourceInformationAnnotator("xx'`-O5syY)DOG%", false);
  ...
  public void test21()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "xx'`-O5syY)DOG%");
      Node node1 = new Node(0, node0, 15, 0);
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, true, true);
      SourceInformationAnnotator sourceInformationAnnotator0 = new SourceInformationAnnotator("xx'`-O5syY)DOG%", true);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, sourceInformationAnnotator0);
      CompilerOptions compilerOptions0 = new CompilerOptions();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      // Undeclared exception!
  ...
  public void test23()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = compiler0.parseTestCode("4NkUPPORTEQ");
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
  ...
  public void test24()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "com.google.javascript.rhino.jstype.UnionType");
      Node node1 = new Node((-14), node0, 16, 36);
      Node node2 = new Node(4, node1, node1);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      // Undeclared exception!
      try { 
