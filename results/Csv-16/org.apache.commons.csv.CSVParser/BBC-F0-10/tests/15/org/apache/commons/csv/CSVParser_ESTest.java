...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("<H~{o8}1^iJ%U ", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 2706L, 0L);
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      File file0 = MockFile.createTempFile("Oracle", (String) null);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test07()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.newFormat('G');
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2662L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-4329L), (-507L));
      cSVParser0.nextRecord();
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = CSVParser.parse("4A=p-p", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('G');
      MockFile mockFile0 = new MockFile("org.apache.commons.csv.CSVParser", "'G?XLhm*6");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("rX!P>");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader("28$J #)Mv]EwNd;/u");
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      MockFile mockFile0 = new MockFile("iOS", ">q/({v`tGl7c");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 94L, (-1192L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test39()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("vljg%1z +_t^$NHEW", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("vljg%1z +_t^$NHEW", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
      assertNotNull(map0);
  ...
  public void test48()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      File file0 = MockFile.createTempFile("7PFPP`F", "7PFPP`F");
      // Undeclared exception!
      try { 
