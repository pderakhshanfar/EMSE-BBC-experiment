...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      File file0 = MockFile.createTempFile("NullString=<", (String) null);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("?9zJ^=}-*=zT");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1L), (-1957L));
      cSVParser0.nextRecord();
      assertEquals((-1957L), cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("?(~2-B", cSVFormat0);
      cSVParser0.close();
  ...
  public void test10()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("QwndzK#vW6b;(cQd");
  ...
  public void test23()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("d4<ij[N", "The comment start character and the delimiter cannot be the same ('");
      File file0 = MockFile.createTempFile(":c;tkt", "|", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      StringReader stringReader0 = new StringReader("bCLB");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1612L, 0L);
      cSVParser0.close();
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 0L, 4641L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-5L), (-5L));
        fail("Expecting exception: IOException");
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat3, (-1L), (-1L));
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("09CK[6RQAEb", cSVFormat3);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test43()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse(",&H@m4ZB3H`", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("Y`[1?)nsRe Nj", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
