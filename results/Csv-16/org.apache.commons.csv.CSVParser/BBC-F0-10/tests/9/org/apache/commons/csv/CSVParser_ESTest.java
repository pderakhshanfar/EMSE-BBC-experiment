...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("^]UaKCjSx%3");
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      StringReader stringReader0 = new StringReader(")Q0lC~wTRJh7Ql");
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("`JDLi1{[L'1G8~E]]");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1776L, 0L);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("N%t4A5uPIQ\u0004<),i&'");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      try { 
        CSVParser.parse("\"D4zU=bg3JBavM6 ", cSVFormat1);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("file", "om=Ebe~iq", (File) null);
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 1776L, (-71L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test35()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader();
      CSVFormat cSVFormat0 = CSVFormat.newFormat(')');
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-1858L), (-1858L));
      cSVParser0.isClosed();
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("+~2-mkYxFA'}", cSVFormat0);
      cSVParser0.close();
  ...
  public void test37()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVParser cSVParser0 = CSVParser.parse("=@>u6l?R}(F3d%,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      StringReader stringReader0 = new StringReader("XApbF6E9O");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test40()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 1776L, (-1L));
      cSVParser0.getHeaderMap();
  ...
  public void test43()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 2177L, 2177L);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("`;)4P>,", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
