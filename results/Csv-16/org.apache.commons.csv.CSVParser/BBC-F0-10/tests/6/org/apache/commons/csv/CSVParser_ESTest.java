...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("?%XXK/)0rJos=_z");
      File file0 = MockFile.createTempFile("?%XXK/)0rJos=_z", "?%XXK/)0rJos=_z", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test04()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1L), 2783L);
      cSVParser0.nextRecord();
      assertEquals(2782L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-450L), (-450L));
      cSVParser0.nextRecord();
      assertEquals((-450L), cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      StringReader stringReader0 = new StringReader("-@K4L=");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
  ...
  public void test09()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-109L), 0L);
      long long0 = cSVParser0.getRecordNumber();
      assertEquals((-1L), long0);
  }
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("file", "dx.");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test18()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("\"a Q{`z!fdRJ+*iei>m", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test23()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-24), 2331);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-38), 5);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("{-lntU^Bjr", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 1046L, 1046L);
        fail("Expecting exception: IOException");
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      StringReader stringReader0 = new StringReader("f%TK`}@nX^\"qLoBBK");
  ...
  public void test40()  throws Throwable  {
      ...
      stringArray0[0] = "EC";
      stringArray0[1] = "d##4i-})Fk)Zr";
      stringArray0[2] = "org.apache.commons.csv.Constants";
      stringArray0[3] = "q";
      stringArray0[4] = "fMdC?%,>V=#TDO";
      stringArray0[5] = ">9*1sJ~jnU.";
      stringArray0[6] = "";
      stringArray0[7] = "(line ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      CSVParser cSVParser0 = CSVParser.parse("EC", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      StringReader stringReader0 = new StringReader("M^8{Y1");
  ...
  public void test44()  throws Throwable  {
      ...
      stringArray0[7] = "(line ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("EC", cSVFormat1);
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("HJ(U{-os-Rixc2Q a;,", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
