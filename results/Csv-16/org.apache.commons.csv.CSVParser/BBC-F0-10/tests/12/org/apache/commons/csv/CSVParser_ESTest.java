...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 675L, (-1439L));
      cSVParser0.nextRecord();
      assertEquals((-1439L), cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1402L), (-846L));
      cSVParser0.nextRecord();
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      StringReader stringReader0 = new StringReader("R7T35o7[D!mjH[ >7mz");
      CSVParser cSVParser0 = CSVParser.parse((Reader) stringReader0, cSVFormat1);
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("`\"Uq.nYS*F3fU", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test25()  throws Throwable  {
      MockFile mockFile0 = new MockFile("KX(C#<OHLT[ >@G", ";#0|Bs:;'");
      File file0 = MockFile.createTempFile(";#0|Bs:;'", ";#0|Bs:;'", (File) mockFile0);
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile(" 0ogD3!>$+Z@$.", " 0ogD3!>$+Z@$.");
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(stringReader0, (CSVFormat) null, 1376L, 1376L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 0L, (byte)0);
        fail("Expecting exception: IOException");
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("R7T35o7[D!mjH[ >7mz");
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Q!J#gaQ]^,F~X9", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("5uKD");
      CSVParser cSVParser0 = CSVParser.parse("5uKD", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      File file0 = MockFile.createTempFile("R7T35o7[D!mjH[ >7mz", "l@t>Sow@");
