...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("EE;pUTkRp!mS]:P8NO-");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      StringReader stringReader0 = new StringReader("MiyL");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 541L, 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3509L, (-499L));
      cSVParser0.nextRecord();
      assertEquals((-499L), cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      StringReader stringReader0 = new StringReader("MiyL");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-499L), (-802L));
      cSVParser0.nextRecord();
      assertEquals((-802L), cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("EE;pUTkRp!mS]:P8NO-", cSVFormat0);
      cSVParser0.close();
  ...
  public void test10()  throws Throwable  {
      StringReader stringReader0 = new StringReader("The escape character cannot be a line break");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3509L, 3509L);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test11()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$1", "_J%7YUXK9o");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test13()  throws Throwable  {
      ...
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile1 = new MockFile(mockFile0, "-ANR''u!X@q|zd6miJ");
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("LO,Xr");
      Path path0 = mockFile0.toPath();
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"3yh2T.%RM0*;-0,", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test25()  throws Throwable  {
      ...
      URI uRI0 = MockURI.aFileURI;
      MockFile mockFile0 = new MockFile(uRI0);
      File file0 = MockFile.createTempFile("dU,$Ag^zwsw?bRRl", "charset", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, (CSVFormat) null, 0L, 3479L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 2662L, 1073L);
        fail("Expecting exception: IOException");
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("i60] U;+}&*kFC&&T'~", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("REJECT_EXTENDED_RANGES");
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("dU,$Ag^zwsw?bRRl", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("w3u5_haGyfa", "w3u5_haGyfa");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
        CSVParser.parse(path0, charset0, cSVFormat0);
