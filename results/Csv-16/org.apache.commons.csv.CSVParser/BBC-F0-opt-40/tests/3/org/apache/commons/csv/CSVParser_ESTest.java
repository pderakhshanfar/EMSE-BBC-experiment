...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "YJ\"[c_[hi|ywT~h");
      File file0 = MockFile.createTempFile("i[~a", "i[~a", (File) mockFile0);
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("4uY~L>5kBM^S['`");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("DZiw");
  ...
  public void test12()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, 3376L, 0L);
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("i[~a", "YJ\"[c_[hi|ywT~h");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test27()  throws Throwable  {
      MockFile mockFile0 = new MockFile("e]-D+`mGn5~/|", "e]-D+`mGn5~/|");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      Charset charset0 = Charset.defaultCharset();
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-490), 1325);
  ...
  public void test33()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-97L), (-97L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-374L), 62);
        fail("Expecting exception: IOException");
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("aiS1^;\"XRL+\"iY.M8j", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("Je%*,#gh,^0^N,", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Je*,:ghs^^,", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("-u*");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3376L, 0L);
      long long0 = cSVParser0.getRecordNumber();
      assertEquals((-1L), long0);
  }
