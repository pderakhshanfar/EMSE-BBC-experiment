...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1040L, 1040L);
      cSVParser0.nextRecord();
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader(", mapping=");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-4603L), (-4603L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test09()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      File file0 = MockFile.createTempFile("4=T0B!Tw-Pfl&", "Y_6QPW(");
  ...
  public void test10()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, "expected one of %s");
  ...
  public void test21()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2105), (byte)4);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("uK!b@qA tx[+?Sy", "");
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("@CR/Gs.0=-cp8hhel{]", "@CR/Gs.0=-cp8hhel{]");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("MZ.lAB,{xjz");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-320), (byte)112);
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse((InputStream) byteArrayInputStream0, charset0, cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      StringReader stringReader0 = new StringReader("nFAw??~'");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse((Reader) stringReader0, cSVFormat0);
      cSVParser0.isClosed();
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test40()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("nFAw??~'", "w_mLJugEtxt+=Tu/&", (File) null);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test48()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("],bC", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
