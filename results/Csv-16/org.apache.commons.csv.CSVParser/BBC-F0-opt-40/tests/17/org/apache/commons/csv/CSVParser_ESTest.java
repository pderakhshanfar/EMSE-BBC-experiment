...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 0L, 2347L);
  ...
  public void test03()  throws Throwable  {
      MockFile mockFile0 = new MockFile("\" in ", "org.apache.commons.csv.CSVParser$1");
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1308L, 1308L);
      cSVParser0.nextRecord();
      assertEquals(1307L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("f~02PUZJ2", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("4(=fV3>DR$");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1437L, 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-363L), (-363L));
      cSVParser0.nextRecord();
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("j7", cSVFormat0);
      cSVParser0.close();
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("@%'CFO");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 6L, (-1L));
      cSVParser0.nextRecord();
      cSVParser0.getRecords();
      assertEquals((-1L), cSVParser0.getRecordNumber());
  }
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("XvRAy\r>Sq(VAi|5E");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("pOa?vl%G#3Cj&", "Oracle");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("35uDk", "35uDk");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("LYdja(/ShY", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("Uj6FPLj5i", "Uj6FPLj5i");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test29()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2197), (byte)3);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test30()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-1404L), (-1404L));
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test34()  throws Throwable  {
      ...
      try {
        cSVParser1 = new CSVParser(stringReader0, cSVFormat1, 0L, (-1471L));
        fail("Expecting exception: IOException");
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("^gAH~*k*W");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.isClosed();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("6E+ES't!8],MyIYoj", cSVFormat0);
  ...
  public void test40()  throws Throwable  {
      ...
      stringArray0[0] = "bLy4{GVr[pdey/";
      stringArray0[2] = "";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("-mX5[,q#g_LK|", cSVFormat0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("!/Ds6-+mjw0B%", "I");
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("InformixUnload", "Ufb)e-jf_V,R4CO}");
      // Undeclared exception!
      try { 
