...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      File file0 = MockFile.createTempFile("I6-6=H:Kv4}TW<r", "I6-6=H:Kv4}TW<r");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("5Sf", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(':');
      CSVParser cSVParser0 = CSVParser.parse("5Sf", cSVFormat0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader(",$D.|wS(};1");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 946L, 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("/j6}Az\"J{rtKR]F*;UQ");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-3533L), (-1226L));
      cSVParser0.nextRecord();
      assertEquals((-1226L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("K\r\n", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("^Y.*E4`;Go0Zl`mRT&F", "^Y.*E4`;Go0Zl`mRT&F");
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("da/;H-{");
      Path path0 = mockFile0.toPath();
  ...
  public void test21()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("Olw3K7.Viz<w,", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("m(,BuUJq%GxL@dY\"g4", (String) null, (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(pipedWriter0, 1894);
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 1894, 1894);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 46L, 3529);
        fail("Expecting exception: IOException");
  ...
  public void test39()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("0e'g-^$EOdTb^R3h", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("db", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("K$5gwNz;O302/", cSVFormat3);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("{wH)[e:kiUi%A!}j1");
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("{wH)[e:kiUi%A!}j1", cSVFormat4);
        fail("Expecting exception: NullPointerException");
