...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-1363L), (-1363L));
  ...
  public void test01()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("&mGQ m7n");
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1L, (-4907L));
      cSVParser0.nextRecord();
      assertEquals((-4907L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("<nputStream", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("z~Xazc#ah%cgY1|=|", cSVFormat1);
  ...
  public void test08()  throws Throwable  {
      StringReader stringReader0 = new StringReader("~Y,Jsp+hK4H|]xG)r");
      CSVFormat cSVFormat0 = CSVFormat.newFormat('D');
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, (-916L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("U~gIjm\rt@", cSVFormat1);
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("\" in ", "MINIMAL");
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      File file0 = MockFile.createTempFile("wbhwy]Va@%", "wbhwy]Va@%");
      Path path0 = file0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      PipedInputStream pipedInputStream0 = new PipedInputStream(1847);
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      MockFile mockFile0 = new MockFile("6p*y}=W");
      File file0 = MockFile.createTempFile("O(#`gr9g:\n,~", "/LtzhoUE", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-3697), 3657);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = CSVParser.parse("z~Xazc#ah%cgY1|=|", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 0L, (-256L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(555);
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 1L, (-1458L));
        fail("Expecting exception: IOException");
  ...
  public void test37()  throws Throwable  {
      ...
      stringArray0[0] = "aXUr&gQmmB46";
      stringArray0[1] = "org.apache.commons.csv.Token";
      stringArray0[2] = ";cG/9^}?Y";
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(",r})2FJ_4Nv9>-");
      CSVParser cSVParser0 = CSVParser.parse(",r})2FJ_4Nv9>-", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("z~Xazc#ah%cgY1|=|", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("OsvqqLMJ4[J4'p1", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("xjC:YKS=d");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("U~gIjm\rt@", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
