...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("yKsl6] ", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("BwUa", " IgnoreHeaderCase:ignored");
      File file0 = MockFile.createTempFile("L76sL[Uw8cXi", "L76sL[Uw8cXi", (File) mockFile0);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("iF1`GGP4`G", cSVFormat0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("4]V6N~n");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1613L), 1023L);
      cSVParser0.nextRecord();
      assertEquals(1023L, cSVParser0.getRecordNumber());
  }
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("z^G}Tw$t7y+-%!n#$", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test10()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader();
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-673L), (-5156L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test13()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, "qkU:;f\"zhY");
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("Parameter '", "The header contains a duplicate name: \"");
      Path path0 = mockFile0.toPath();
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-364), 713);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      File file0 = MockFile.createTempFile("|8mX@]e", "Hx");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      MockFile mockFile0 = new MockFile("reader", "abv0'`SA2Ow!%$r");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      try { 
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-47), 1253);
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 0L, (-260L));
        fail("Expecting exception: IOException");
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("mw2|$v4&eixp1ZkVBu", cSVFormat0);
      cSVParser0.close();
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(" fp!7'", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      Class<QuoteMode> class0 = QuoteMode.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVParser cSVParser0 = CSVParser.parse(" fp!7'", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test43()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("{@dh{wOZ.yc,", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("{@dh{wOZ.yc,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("V!DzOJu6W#?gbc", "V!DzOJu6W#?gbc");
      // Undeclared exception!
      try { 
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("1FZ$RIFzy/j", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
