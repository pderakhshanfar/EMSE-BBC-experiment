...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("iXr5d}~CM+\"?o=fg}t", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Rpd3~]1g(LsGp", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(",X3L,", cSVFormat0);
      cSVParser0.iterator();
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 2906L, 2906L);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("line.separator");
  ...
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile("qt!g\"kd", "format");
      File file0 = MockFile.createTempFile(":|RTF|)>dZ$71|", "format", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile(" wf#(RLE5i", "org.apache.commons.csv.CSVParser");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("#lv0tARb&36");
      // Undeclared exception!
      try { 
        CSVParser.parse("#lv0tARb&36", cSVFormat3);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-421), (byte)7);
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      File file0 = MockFile.createTempFile("'&@Ry].D0", "org.apache.commons.csv.CSVParser$1");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-390L), (-390L));
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test30()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 0L, 1249L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test32()  throws Throwable  {
      StringReader stringReader0 = new StringReader("q,n/B-1WMb");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test34()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("line.separator");
      CSVParser.parse("line.separator", cSVFormat2);
      StringReader stringReader0 = new StringReader("b?go4fsr$7`t:#M");
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Kh", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(",X3L,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"null\" in [null, X3L, null]
         //
  ...
  public void test43()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse(",X3L,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("gk8=");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 387L, (-121L));
      long long0 = cSVParser0.getRecordNumber();
