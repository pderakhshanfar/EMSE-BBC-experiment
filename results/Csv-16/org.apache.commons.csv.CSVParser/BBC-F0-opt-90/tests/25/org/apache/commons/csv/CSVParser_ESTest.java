...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("S9;`I'/=v8h7");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-3161L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("i}Zjw ~=S629[,~UX");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("hqab>EQmLII&Int");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 2250L, 219L);
      cSVParser0.nextRecord();
      assertEquals(219L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1944L), (-1944L));
      cSVParser0.nextRecord();
      assertEquals((-1944L), cSVParser0.getRecordNumber());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("", "p<nozwR~|z~n|T-}B");
  ...
  public void test26()  throws Throwable  {
      File file0 = MockFile.createTempFile("jN*F~1h]uIw", "jN*F~1h]uIw");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-4118L), 0L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat2, 3117L, (-795L));
        fail("Expecting exception: IOException");
  ...
  public void test40()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(3279);
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      String[] stringArray0 = new String[4];
      stringArray0[0] = "N";
      stringArray0[1] = "m@aF7>fLV*qQA";
      stringArray0[2] = "M9nwmB";
  ...
  public void test42()  throws Throwable  {
      ...
      CSVParser cSVParser1 = new CSVParser(stringReader0, cSVFormat1, 0L, 734L);
      assertEquals(733L, cSVParser1.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("T;Z,", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVParser cSVParser0 = CSVParser.parse(",jlu/h)NPa~fEPHGd", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("6d-_pF^", "X'<!t#}$Y6JbXvR_");
      // Undeclared exception!
      try { 
  ...
  public void test53()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(",jlu/h)NPa~fEPHGd", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test54()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("|ND+`+", cSVFormat0);
