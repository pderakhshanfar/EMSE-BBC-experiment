...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1L), (-937L));
      cSVParser0.nextRecord();
  ...
  public void test10()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)1, 579);
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("v&_PU5$!iYGqz3gyz_", "v&_PU5$!iYGqz3gyz_");
  ...
  public void test12()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, "REJECT_EXTENDED_RANGES");
  ...
  public void test13()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile((File) null, "CSVParser has been closed");
      Path path0 = mockFile0.toPath();
  ...
  public void test22()  throws Throwable  {
      ...
      Charset charset0 = Charset.defaultCharset();
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-3056), (byte)20);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2147483645), (byte) (-5));
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse((InputStream) byteArrayInputStream0, charset0, cSVFormat1);
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("r55||qeLg7");
      File file0 = MockFile.createTempFile("(|]|><}U}mhN", "sY@g]w$]%hA", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      MockFile mockFile0 = new MockFile("ewzeMSkCF|aqz: YPN");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 497L, 0L);
        fail("Expecting exception: IOException");
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("(|]|><}UcmhL,,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("(]><}Uh,,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"null\" in [(]><}Uh, null, null]
         //
  ...
  public void test45()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("(|]|><}cmhL,|,", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
