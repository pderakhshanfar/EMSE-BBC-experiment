...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("-TBW06%m", "-TBW06%m");
  ...
  public void test01()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("9$tXk7VDirO{Kn>xV.");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2572L), (-2572L));
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("~ =a|mR\rfUUtU7", cSVFormat2);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("jv4HxZRl~XK#f");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-526L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("Vs/V", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("~ =a|mR\rfUUtU7", cSVFormat1);
  ...
  public void test11()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("FfElV");
  ...
  public void test12()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, "?'*Nn_");
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("~c^N~E");
      Path path0 = mockFile0.toPath();
  ...
  public void test16()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("inputStream", "org.apache.commons.csv.Token", 12, "inputStream", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)10, (byte) (-11));
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-114), 31);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("line.separator", "The header contains a duplicate name: \"", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-957L), 1939L);
        fail("Expecting exception: IOException");
  ...
  public void test31()  throws Throwable  {
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The header contains a duplicate name: \"\" in [, , _W]
         //
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      StringReader stringReader0 = new StringReader("o'&g-@ a\"eXzxiGYo");
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("u=9", cSVFormat0);
      cSVParser0.getRecords();
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("~B\"5e^IUS@;':jkhdu", cSVFormat0);
      cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      StringReader stringReader0 = new StringReader("-TBW06%m,f");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
  ...
  public void test43()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("u=9");
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-585L), 0L);
      long long0 = cSVParser0.getRecordNumber();
      assertEquals((-1L), long0);
  }
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("K#K;i", "QAg)0327qN");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("~ =a|mR\rfUUtU7", cSVFormat0);
