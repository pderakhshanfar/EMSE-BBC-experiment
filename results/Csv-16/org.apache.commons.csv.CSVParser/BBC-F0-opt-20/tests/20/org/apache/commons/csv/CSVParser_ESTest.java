...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("4trx)2,FtsSHv^b", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("cKzOM<Tzj7uNu7[0Vj");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1311L, (-1L));
      cSVParser0.nextRecord();
      assertEquals((-1L), cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("l%t5fM-wbT");
  ...
  public void test19()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("%e4c7)d\"", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1952952032), 2217);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("8@ypp'GoDkt3", "8@ypp'GoDkt3", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 802L, 802L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 12, 12);
        fail("Expecting exception: IOException");
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("d?n(8\u0005Q2-$c", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test37()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(";Z1UmE`&PmI(", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("x|z5E;[l45;|GYM0c", cSVFormat0);
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(";9HgD");
      CSVFormat cSVFormat2 = cSVFormat1.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse(";9HgD", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("No quotes mode set but no escape character is set", "V");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
