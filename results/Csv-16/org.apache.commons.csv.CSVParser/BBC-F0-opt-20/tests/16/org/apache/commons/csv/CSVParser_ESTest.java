...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      File file0 = MockFile.createTempFile("Parameter '", "FI~PB{P&O");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1212L, 1212L);
      cSVParser0.nextRecord();
      assertEquals(1212L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("?C7aX?*ZHe|");
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("(line ", "inputStream");
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("K^quOUAOI9PR7J^vq\"", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1461), 2);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      MockFile mockFile0 = new MockFile("}xxdvg*6kZh-y5+(ug", "}xxdvg*6kZh-y5+(ug");
      File file0 = MockFile.createTempFile(",\r3", "L%g(]za#!w%k|", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1473), 1904);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("K8i=,", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-46), 2166);
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse((InputStream) byteArrayInputStream0, charset0, cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 1304L, (-253L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test40()  throws Throwable  {
      ...
      Class<Locale.Category> class0 = Locale.Category.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVParser cSVParser0 = CSVParser.parse("BZM:cOt.Q", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      StringReader stringReader0 = new StringReader(")v\".cB");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test43()  throws Throwable  {
      ...
      doReturn(rowSetMetaDataImpl0).when(resultSet0).getMetaData();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(resultSet0);
      CSVParser cSVParser0 = CSVParser.parse("K8i=,", cSVFormat1);
  ...
  public void test47()  throws Throwable  {
      StringReader stringReader0 = new StringReader("8E(~ZxYXX)t");
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("BZM:cOt.Q", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
