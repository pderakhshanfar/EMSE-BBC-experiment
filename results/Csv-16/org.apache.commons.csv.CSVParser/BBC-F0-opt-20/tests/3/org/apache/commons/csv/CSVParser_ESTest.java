...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("The header contains a duplicate entry: '", "z");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\rz|i", cSVFormat0);
      cSVParser0.nextRecord();
      cSVParser0.nextRecord();
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-72L), (-72L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test11()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Tz*ZL'", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("R3,s<~J;WYU<");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      URI uRI0 = MockURI.aFileURI;
      MockFile mockFile0 = new MockFile(uRI0);
      MockFile mockFile1 = new MockFile(mockFile0, "#Q=Tls'");
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("The escape character and the delimiter cannot be the same ('", "MO");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("s^%Ezo!Kq-? drh", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("ggU83x\" FDWp}\"", cSVFormat1);
  ...
  public void test22()  throws Throwable  {
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream((InputStream) null, 3510);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
  ...
  public void test23()  throws Throwable  {
      MockFile mockFile0 = new MockFile("|Rcp:Z4S");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test24()  throws Throwable  {
      MockFile mockFile0 = new MockFile("8sTlMZ-gV+j", "8sTlMZ-gV+j");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-11), 591);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test27()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 804L, 804L);
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(stringReader0, (CSVFormat) null, 1556L, 1556L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      StringReader stringReader0 = new StringReader("7Rcp:Z4S");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test32()  throws Throwable  {
      StringReader stringReader0 = new StringReader("7Rcp:Z4S");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, 3025L);
      cSVParser0.isClosed();
      assertEquals(3024L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Tz*ZL'");
      CSVParser cSVParser0 = CSVParser.parse((Reader) stringReader0, cSVFormat2);
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\rz|i", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("Tz*ZL'", cSVFormat0);
      cSVParser0.getCurrentLineNumber();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test50()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("IGNORE_ETENDED_wANGES");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
