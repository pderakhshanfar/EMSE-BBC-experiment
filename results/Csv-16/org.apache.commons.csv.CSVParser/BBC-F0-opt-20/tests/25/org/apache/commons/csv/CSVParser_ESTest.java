...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(2840);
  ...
  public void test02()  throws Throwable  {
      StringReader stringReader0 = new StringReader("}(gD(-=i0d X@");
  ...
  public void test03()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("LCs");
  ...
  public void test05()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-488L), (-488L));
      cSVParser0.nextRecord();
      assertEquals((-488L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("}8a(gD(C=i0C X@", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("NWg^7>A!0o4", cSVFormat1);
  ...
  public void test09()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-1L), (-972L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test18()  throws Throwable  {
      ...
      stringArray0[0] = "cAgYP4M";
      stringArray0[1] = "9_wNz93tu";
      stringArray0[2] = "SOCKS";
      stringArray0[3] = ",";
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      File file0 = MockFile.createTempFile("}(gD(-=i0d X@", "}(gD(-=i0d X@");
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      MockFile mockFile0 = new MockFile("5<ieM#u");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      try { 
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("ARn$lqC", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[0] = "CgO>Dc;";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord();
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat2, (-180L), (-2222L));
        fail("Expecting exception: IOException");
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("k l", cSVFormat0);
      cSVParser0.isClosed();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      MockFile mockFile0 = new MockFile("5<ieM#u");
      File file0 = MockFile.createTempFile("5<ieM#u", "5<ieM#u", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("5<ieM#u/5<ieM#u05<ieM#u");
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("rD)e],s+_Wrf;::", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
