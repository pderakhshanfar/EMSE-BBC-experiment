...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StringReader stringReader0 = new StringReader("1=D/\"P -=S`|?YCcL");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 995L, 995L);
      cSVParser0.nextRecord();
      assertEquals(995L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("o[Bs!", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 816, (-2674L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"SPT'Y7", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test18()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1724268369), 3163);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("V0W$x$VyA+", "V0W$x$VyA+");
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\"');
      MockFile mockFile0 = new MockFile("java.lang.Object@0000000005\"F-s\"java.lang.Character@0000000006\"org.apache.commons.csv.QuoteMode@0000000007");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("rl>h!7iX6\"~}v>DxlQ,", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test23()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 114, 114);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 3250L, 3250L);
        fail("Expecting exception: IOException");
  ...
  public void test27()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("\" in ", "MY%{LLukk}v:");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("org.apache.commons.csv.CSVFormat@0000000002,9>{p#0%h@j_b3B:Q|,9>{p#0%h@j_b3B:Q|,9>{p#0%h@j_b3B:Q|,java.io.StringReader@0000000004,org.apache.commons.csv.CSVFormat@0000000005,9>{p#0%h@j_b3B:Q|", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"9>{p#0%h@j_b3B:Q|\" in [org.apache.commons.csv.CSVFormat@0000000002, 9>{p#0%h@j_b3B:Q|, 9>{p#0%h@j_b3B:Q|, 9>{p#0%h@j_b3B:Q|, java.io.StringReader@0000000004, org.apache.commons.csv.CSVFormat@0000000005, 9>{p#0%h@j_b3B:Q|]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("rl>h!7iX6\"~}v>DxlQ,", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      StringReader stringReader0 = new StringReader("9>{p#0%h@j_b3B:Q|");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("VDYTs\"u7tn-xnS;=", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Uzvcf-&~X411<BT.");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile(",.-}[8Koj+");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("VDYTs\"u7tn-xnS;=", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
}
