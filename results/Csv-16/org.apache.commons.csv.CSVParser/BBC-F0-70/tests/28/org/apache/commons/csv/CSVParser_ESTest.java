...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("B:K1O`.+", "(line ");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("c]}DST#&6GYf*a9", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      StringReader stringReader0 = new StringReader("*ut _&;*<}[)");
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      StringReader stringReader0 = new StringReader("*ut _&;*<}[)");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 'P', 'P');
      cSVParser0.nextRecord();
      assertEquals(80L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("c]}DST#&6GYf*a9", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test09()  throws Throwable  {
      File file0 = MockFile.createTempFile("bgo?R2", "bgo?R2");
  ...
  public void test10()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile(":K1O`.+");
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("\":'4iOb>5j", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      File file0 = MockFile.createTempFile("No quotes mode set but no escape character is set", "O+X}ZQ2W$^1zY9M|'");
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      MockFile mockFile0 = new MockFile("od/g2m+QX:", "U2y|lt78PYzkj}`kkv");
  ...
  public void test25()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-123), (byte)39);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test26()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-5141L), 2038L);
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-3468L), (-1L));
        fail("Expecting exception: IOException");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("B:K1O`.+", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("-Jh3APKn&", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      StringReader stringReader0 = new StringReader("B:K1O`.+");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("8.5y[kE%8", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [, .5y[kE%, ]
         //
  ...
  public void test43()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("8.5y[kE%8", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test46()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("org.apache.commons.csv.ExtendedBufferedReader", "org.apache.commons.csv.ExtendedBufferedReader", 3, "org.apache.commons.csv.ExtendedBufferedReader", uRLStreamHandler0);
      // Undeclared exception!
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("-Jh3APKn&", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
}
