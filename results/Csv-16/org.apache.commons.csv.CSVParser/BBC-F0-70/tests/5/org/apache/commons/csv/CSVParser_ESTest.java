...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1112, (byte)77);
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("z^xC] xdyC`5xZ!=", cSVFormat0);
      cSVParser0.close();
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-1695L), 0L);
      long long0 = cSVParser0.getRecordNumber();
      assertEquals((-1L), long0);
  }
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      MockFile mockFile0 = new MockFile("^:02HlP3e%?Ga", "_.[M8,(-");
      File file0 = MockFile.createTempFile("^:02HlP3e%?Ga", "^:02HlP3e%?Ga", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("$zJ>}u(Gg\ryE", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("JeJictdXx$hCKF", "");
  ...
  public void test13()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile(":", "?RKO]!");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("\"Nx7z|k@SjV0y?rDEX", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test21()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-106), (byte)59);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("ok8C>X;)o@:", "]J_)1GW*>7h");
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      MockFile mockFile0 = new MockFile(" reading next record: ", "]~pb!r.$t8XXP");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(pipedWriter0, 1493);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(".HKQxw/uS]oACao?");
      CSVFormat cSVFormat2 = cSVFormat1.withFirstRecordAsHeader();
      StringReader stringReader0 = new StringReader(".HKQxw/uS]oACao?");
  ...
  public void test35()  throws Throwable  {
      StringReader stringReader0 = new StringReader("o+0W");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      Class<Locale.FilteringMode> class0 = Locale.FilteringMode.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
  ...
  public void test36()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("$zJ>}u(Gg\ryE", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("$zJ>}u(Gg\ryE", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
