...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-624L), 1L);
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("MH-|Zat?WG/.q4", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test08()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("yK!f*9BAq>A5Za-");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, (-1271L));
      cSVParser0.nextRecord();
      assertEquals((-1271L), cSVParser0.getRecordNumber());
  }
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("0&BC~b~apcs_3D~m", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('l');
      MockFile mockFile0 = new MockFile("2'&.Xb_dQ");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('l');
      MockFile mockFile0 = new MockFile(".d=fA;", ".d=fA;");
  ...
  public void test22()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-624L), (-2L));
      cSVParser0.close();
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-40), (byte)3);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$1", "(t~36W8~fl/A:N#");
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 0L, 251L);
        fail("Expecting exception: IOException");
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse(",z2S3(waIj_!e7b:,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("m @{+^rxqa+1gayZM/M", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("EM,N9Lv[\"bIkj_nKS", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      stringArray0[3] = "[Rz(lI>t";
      stringArray0[4] = "$S|Z{ihK1";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("]O]\"O4a.a", cSVFormat1);
  ...
  public void test44()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(",z2S3(haIj_!te7b:,", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(",z2S3(haIj_!te7b:,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [, z2S3(haIj_!te7b:, ]
         //
