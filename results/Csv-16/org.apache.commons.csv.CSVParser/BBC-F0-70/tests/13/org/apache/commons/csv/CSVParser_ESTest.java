...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("f#.C#r-h.;('G67");
      File file0 = MockFile.createTempFile("z@O9t8(Qc5;T!Y>", "ShpK}wVnFZo&I%o5}", (File) mockFile0);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("aI");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1034L), (-1034L));
      cSVParser0.nextRecord();
      assertEquals((-1034L), cSVParser0.getRecordNumber());
  }
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("WCyKnAC\\=egX#)", "WCyKnAC\\=egX#)");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-3), (-1840700268));
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      Charset charset0 = Charset.defaultCharset();
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-77), 2798);
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile(":Y2hcfV?+");
      File file0 = MockFile.createTempFile(" IgnoreHeaderCase:ignored", " IgnoreHeaderCase:ignored", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("-}LDl=k~'", ") invalid parse sequence");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 3035L, 3035L);
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader("3=|3}odx$<<");
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, (CSVFormat) null, 95L, 0L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-214L), (-214L));
        fail("Expecting exception: IOException");
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("TOEN", cSVFormat0);
      cSVParser0.isClosed();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(",,Bco3U|gtt'IB\rW", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [, , Bco3U|gtt'IB]
         //
  ...
  public void test40()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("NMgi0bp2&+Bd1<F", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVParser cSVParser0 = CSVParser.parse("q(Ao>iUe!n4%5pwa", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test44()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\rP", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse(",,Bco3U|gtt'IB\rW", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("aI", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("q(Ao>iUe!n4%5pwa", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
