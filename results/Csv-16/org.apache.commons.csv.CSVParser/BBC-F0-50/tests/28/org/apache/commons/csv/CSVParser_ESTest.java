...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("wD&ds:e%Sa8X{Y", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("fuHq\"Qc");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("fuHq\"Qc");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 4648L, 4648L);
      cSVParser0.nextRecord();
      assertEquals(4648L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-3462L), (-3462L));
      cSVParser0.nextRecord();
      assertEquals((-3462L), cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("_HU", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("arMvu4Jx&L{[");
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("|&*DYy#}~iN", "|&*DYy#}~iN");
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("@(Qbj", "@(Qbj");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1255), 2);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      MockFile mockFile0 = new MockFile("~\"d&v@*vHz", "1");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-76), (byte)103);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test29()  throws Throwable  {
      StringReader stringReader0 = new StringReader("r@-$Ope]ijB:)OhFP");
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, (CSVFormat) null, 646L, 658L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 0L, 1);
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("S_i-fR5\"v 5IB4g'VM", cSVFormat0);
  ...
  public void test39()  throws Throwable  {
      ...
      Class<Proxy.Type> class0 = Proxy.Type.class;
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(class0);
      CSVParser cSVParser0 = CSVParser.parse("wD&ds:e%Sa8X{Y", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      File file0 = MockFile.createTempFile("B('LM\"?v{4C$", "");
      // Undeclared exception!
      try { 
