...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-18L), 0L);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
  ...
  public void test04()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("eyd1v~SY", "y", (File) null);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("G_rWJXK)yX<NDF=y", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      StringReader stringReader0 = new StringReader("u7|,,/_az1vx,mA");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 117, (-1480L));
      cSVParser0.nextRecord();
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("%K\"<gf[;;]jRPW!`;5", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("pR` -5ld.rmF", "pR` -5ld.rmF");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(">B],I(", cSVFormat3);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-23), 5);
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("YK)AJ3\"`; b", "");
      File file0 = MockFile.createTempFile("*yDthLF@nBq,fH", (String) null, (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      File file0 = MockFile.createTempFile("nDhAth=B#iK~cy(\"$>0", "CSVParser has been closed");
      MockFile mockFile0 = new MockFile(file0, "!%;qzqoRA");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      try { 
  ...
  public void test31()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-18L), (-18L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 36, 36);
        fail("Expecting exception: IOException");
  ...
  public void test39()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The header contains a duplicate name: \"null\" in [null, null, /_az1vx, mA]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test47()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "l;CK");
      URL uRL0 = MockURL.getHttpExample();
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
  ...
  public void test48()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("}Rmew~/", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile("'l\"_WJUA,*8v){(u}");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test51()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("u7|,,/_az1vx,mA", "u7|,,/_az1vx,mA", 117, "1lI~@y!jnkgYs", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
