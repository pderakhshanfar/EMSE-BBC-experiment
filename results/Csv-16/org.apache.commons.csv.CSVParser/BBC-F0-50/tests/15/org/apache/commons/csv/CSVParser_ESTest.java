...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("|dY|`H", cSVFormat2);
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("XyrIi]?rTH_o0J");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1L, (-1745L));
      cSVParser0.nextRecord();
      assertEquals((-1745L), cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("|dYQdH", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(";Z$W%XsEA\"tF2]:1Wd", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test09()  throws Throwable  {
      StringReader stringReader0 = new StringReader("=yCS4r#E");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-959L), (-959L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("(hbRe$MP9sPj", "");
      Path path0 = mockFile0.toPath();
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      MockFile mockFile0 = new MockFile((File) null, "r*}ci[$");
      File file0 = MockFile.createTempFile("No header mapping was specified, the record values can't be accessed by name", "r*}ci[$", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      MockFile mockFile0 = new MockFile("4^[he", "");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (byte)64, (byte)64);
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-1127L), (byte) (-40));
        fail("Expecting exception: IOException");
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("jY &A4$LS-V/w", cSVFormat0);
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("|dY|`H", cSVFormat0);
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("|dY|`H", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
      assertNotNull(map0);
  ...
  public void test43()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("L:b,", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
