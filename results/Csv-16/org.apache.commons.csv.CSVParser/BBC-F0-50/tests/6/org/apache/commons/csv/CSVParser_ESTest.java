...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(" W5?Xy", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      File file0 = MockFile.createTempFile("`CgEs=k", "`CgEs=k");
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("FNuC>7l3ET$nV");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-4285L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("OMENT", cSVFormat1);
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      MockFile mockFile0 = new MockFile("RJx,\"XZJf8p=0Lg)");
  ...
  public void test21()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      byte[] byteArray0 = new byte[0];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1842468469), (-1842468469));
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      MockFile mockFile0 = new MockFile("OMENT");
      File file0 = MockFile.createTempFile("Z]*wo+", "OMENT", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1403964790), 4);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
  ...
  public void test26()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 2149L, (-1L));
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("OMENT", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, (-2021L), (-67L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test37()  throws Throwable  {
      StringReader stringReader0 = new StringReader("IQ2&uaq+ky`<e");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('=');
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("8v~xKZS:", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
      assertNotNull(map0);
  ...
  public void test40()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("O;UM7eT", cSVFormat0);
      cSVParser0.close();
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('=');
      CSVParser cSVParser0 = CSVParser.parse("8v~xKZS:", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
