...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("V%**^2N", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("<u&&Ud?3l0&");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 415L, 0L);
      cSVParser0.nextRecord();
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 154L, 154L);
  ...
  public void test09()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("VtH?p+y_L~L!7sW^63");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 154L, 0L);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile("nK_ ,/Jg", "The comment start marker character cannot be a line break");
      File file0 = MockFile.createTempFile("GhBS9m)?}Y", "&c7M@}MW{r@r_o", (File) mockFile0);
  ...
  public void test13()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("<u&&Ud?3l0&", "Escape=<");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("|u'4~?*tjQ$EreA");
      File file0 = MockFile.createTempFile("|u'4~?*tjQ$EreA", "|u'4~?*tjQ$EreA", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      MockFile mockFile0 = new MockFile("3GR'W<V*`^", "3GR'W<V*`^");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("tv]hJ8f%/EO.Al5+=", cSVFormat0);
  ...
  public void test37()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVParser cSVParser0 = CSVParser.parse("6w27zq", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("V%**^2N", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
