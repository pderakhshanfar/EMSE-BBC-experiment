...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("uzZvDGB;%!I", "~-[J.8c");
      File file0 = MockFile.createTempFile("CSVParser has been closed", "org.apache.commons.csv.CSVParser$1", (File) mockFile0);
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1L), (-2268L));
      cSVParser0.nextRecord();
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("<xF?GO<DFO{^w", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test09()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Buis^|~YJ|:pQlp/Uq");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 415L, 415L);
      cSVParser0.close();
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("]vIunmSw-tKV)@", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test11()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-586L), 0L);
      long long0 = cSVParser0.getRecordNumber();
      assertEquals((-1L), long0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Class<Proxy.Type> class0 = Proxy.Type.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVParser cSVParser0 = CSVParser.parse("cxW ChF-&rU#3'?", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      ...
      URI uRI0 = MockURI.aFileURI;
      MockFile mockFile0 = new MockFile(uRI0);
      MockFile mockFile1 = new MockFile(mockFile0, "WX");
  ...
  public void test20()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"L(DE7n.!j|/'P", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test25()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-47), (byte)107);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      File file0 = MockFile.createTempFile("I7Nw;o:xLul(P", "`T;8.J5");
  ...
  public void test28()  throws Throwable  {
      MockFile mockFile0 = new MockFile("\"W'k8:h", "\"W'k8:h");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(dataInputStream0, 488);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test31()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-8), (byte)3);
  ...
  public void test32()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(3403);
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
  ...
  public void test34()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 1L, 1585L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test42()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("7<m{ xIzZ]d_:f9G-", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat2, 1993L, 1L);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)87, (byte)5);
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse((InputStream) byteArrayInputStream0, charset0, cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      StringReader stringReader0 = new StringReader("a>|7!_!xA6c8");
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile((File) null, ".NJ5gPsL+iA");
  ...
  public void test56()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("*T:LW+x K|q,I4", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
