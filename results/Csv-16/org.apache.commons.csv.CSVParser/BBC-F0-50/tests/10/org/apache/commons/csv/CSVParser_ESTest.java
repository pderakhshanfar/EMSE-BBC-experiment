...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("O7sdSt oS3{\"Ib`7D", "a2 9X&a");
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("j4@`>s-?");
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("j$6.3", cSVFormat0);
      cSVParser0.nextRecord();
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("6Et)%\"JRUKG'7M", "6Et)%\"JRUKG'7M");
      Path path0 = mockFile0.toPath();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("+Q4K9pD9ARlz");
      File file0 = MockFile.createTempFile(") invalid parse sequence", "Delimiter=<,> Escape=<\"> QuoteChar=<\"> NullString=<> RecordSeparator=<\n> SkipHeaderRecord:false", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 253L, 429L);
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("g9)ERbT(!");
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("aMaMCRan^c", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("Xw+\"[xY`m,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test42()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Xw+\"[xY`m,");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
  ...
  public void test44()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 55L, (-1L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test48()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("7&A-4M@W^");
      Charset charset0 = Charset.defaultCharset();
      try { 
