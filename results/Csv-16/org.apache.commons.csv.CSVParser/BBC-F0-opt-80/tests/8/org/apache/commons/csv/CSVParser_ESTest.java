...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "|UCl}%o._=aD%mCUG@E");
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      File file0 = MockFile.createTempFile("@z+N@+)a&NX;-", (String) null);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("an!", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("F^!~`2~Uc.84UE");
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\rY", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("C!b.-chH9? ^W4lX=J");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-206L), (-206L));
      cSVParser0.nextRecord();
      assertEquals((-206L), cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("an!", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test17()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, ".:\"|lC8=RKGbnb%:R");
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("Z^", "org.apache.commons.csv.QuoteMode");
      Path path0 = mockFile0.toPath();
  ...
  public void test21()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("", "1Dn?mBcE", 124, "", uRLStreamHandler0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("Uk[sW'=-+P>y6H", "No header mapping was specified");
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      MockFile mockFile0 = new MockFile("reader", "(nG/m-W^:&O");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      try { 
  ...
  public void test29()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2091019230), (-2091019230));
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(byteArrayInputStream0, 766);
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1709L), 69L);
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test32()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 766L, (-1L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 44, (-305L));
        fail("Expecting exception: IOException");
  ...
  public void test40()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("#1XT67", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("ad-dF#= ^", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVParser cSVParser0 = CSVParser.parse("`hV{[q1m|uCb)'", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
      assertNotNull(map0);
  ...
  public void test48()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("o[3Egh ", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
