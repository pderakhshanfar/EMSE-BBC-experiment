...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "taa$c~aE");
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("fo,", cSVFormat2);
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 836L, 836L);
      cSVParser0.nextRecord();
      assertEquals(836L, cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2278L), (-2278L));
      cSVParser0.nextRecord();
      assertEquals((-2278L), cSVParser0.getRecordNumber());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2278L), (-2278L));
      cSVParser0.iterator();
      assertEquals((-2279L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("ooG_", cSVFormat0);
      cSVParser0.close();
  ...
  public void test11()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("W.)ED$ sd", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("IbDaUhJ%`A~dAvh8J", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("+BUR");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, 0L);
      long long0 = cSVParser0.getRecordNumber();
      assertEquals((-1L), long0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("g\"u 3tDQQd(z");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, "s{T3lh|+");
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("2YT(_W[{TXWA~", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("format", "QJjo*!7'x");
      // Undeclared exception!
      try { 
  ...
  public void test34()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 207, 207);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test35()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (byte)10, (-560L));
        fail("Expecting exception: IOException");
  ...
  public void test37()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(3798);
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("g\"u 3tD#Qd(z");
      StringReader stringReader0 = new StringReader("g\"u 3tD#Qd(z");
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("!ew(SQ3$ZF|`#q;", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      MockFile mockFile0 = new MockFile((File) null, "W.)ED$ sd");
      File file0 = MockFile.createTempFile("W.)ED$ sd", "5A\"P<>^\"Q", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test43()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2812), 3025);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test48()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      MockFile mockFile0 = new MockFile("charset", "Ra:v_QlcedLKKMCv");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
