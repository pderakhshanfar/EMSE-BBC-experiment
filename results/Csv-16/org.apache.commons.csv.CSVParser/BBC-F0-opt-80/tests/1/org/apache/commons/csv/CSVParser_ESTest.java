...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-757L), (-757L));
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("=fek%%G3fbPd'K|x<<L", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("L0");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 2783L, (-1448L));
      cSVParser0.nextRecord();
      assertEquals((-1448L), cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("(LC/@&\"\nNy.|r", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("!N\"2g<}(zP$r?");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile(", mapping=", "L/rectHL?!OdS/;");
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, "w3=}*Ao:bTK=96RGW^");
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("*}ccs_$fo%P[=+n", "k");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("PostgreSQLText", "=fek%%G3fbPd'K|x<<L");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("InformixUnloadCsv", cSVFormat2);
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      File file0 = MockFile.createTempFile("\" in ", "\" in ", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      MockFile mockFile0 = new MockFile((String) null, "'l,Tb$ Pec#6\"W");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("):,LJpV8 >nFSK|", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 1771L, 1771L);
        fail("Expecting exception: IOException");
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("):,LJpV8 >nFSK|", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      assertEquals((-1449L), cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("(*LC/j@&\"\nNy.|r", cSVFormat1);
