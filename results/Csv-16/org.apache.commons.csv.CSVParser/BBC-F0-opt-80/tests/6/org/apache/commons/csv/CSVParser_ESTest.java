...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile((File) null, "string");
      File file0 = MockFile.createTempFile("aW?'`", "string", (File) mockFile0);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, (-3425L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3822L, (-2458L));
      cSVParser0.nextRecord();
  ...
  public void test09()  throws Throwable  {
      StringReader stringReader0 = new StringReader("No quotes mode set but no escape character is set");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2487L), 0L);
      cSVParser0.close();
  ...
  public void test12()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Hj`bNn~RZ+");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
  ...
  public void test16()  throws Throwable  {
      File file0 = MockFile.createTempFile("|z]+Gnm_#z\"T", "]/&0?.");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
  ...
  public void test17()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, ")+-7Ovjz1`-G[");
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile("o{]R.[)MM0515s^`qts", "aj-Tw6zfsp");
  ...
  public void test27()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)3, 124);
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(1504);
      CSVParser cSVParser0 = cSVFormat0.parse(pipedReader0);
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 0L, (-2081L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test36()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1, 1310L, 0L);
        fail("Expecting exception: IOException");
  ...
  public void test42()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("I~Gb?@!r1", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("I~Gb?@!r1", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("S_", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      File file0 = MockFile.createTempFile("url", "de=@^Qm)h|X0Z5'J)g");
      // Undeclared exception!
      try { 
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("I~Gb?@!r1", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
}
