...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("c%{L!`o[-Rqi_xA~<5");
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(".6%GB!apLK8~wGq(", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("c%{L!`o[-Rqi_xA~<5");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, (-76L));
      cSVParser0.nextRecord();
      assertEquals((-76L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("U\"i>NUR@_s[Lb");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1305L, 2524L);
      cSVParser0.nextRecord();
      assertEquals(2524L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("c%{L!`o[-Rqi_xA~<5");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-30L), (-76L));
      cSVParser0.nextRecord();
      assertEquals((-76L), cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(" ueP]R`70&8'(A|k", cSVFormat0);
      cSVParser0.close();
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("b1", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test12()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 1L, (-2832L));
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("F4B|;y{kc^vE%O^-N");
  ...
  public void test16()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("]M] Vi>+iV(n");
      Path path0 = mockFile0.toPath();
  ...
  public void test27()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      File file0 = MockFile.createTempFile("a%$B%xd'W", "*?2j2rb6ZaE&6yj");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 1L, (-2832L));
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test31()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(dataInputStream0, 1359);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test32()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 960L, 1358L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 1305L, 0L);
        fail("Expecting exception: IOException");
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(".6%GB!apLK8~wGq(");
      Class<QuoteMode> class0 = QuoteMode.class;
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(class0);
      CSVFormat cSVFormat3 = cSVFormat2.withSkipHeaderRecord();
      CSVParser cSVParser0 = CSVParser.parse(".6%GB!apLK8~wGq(", cSVFormat3);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("M/N_#dKr4_hTMiU.6", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
