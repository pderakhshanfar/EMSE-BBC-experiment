...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("*|0p*oT@!h");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 755, 755);
      cSVParser0.nextRecord();
      assertEquals(754L, cSVParser0.getRecordNumber());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("'YSXRI{)", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("ZeD)4+'5Ew1~");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1L, (-941L));
      cSVParser0.nextRecord();
      assertEquals((-941L), cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("K-Fc]", cSVFormat0);
      cSVParser0.close();
      cSVParser0.isClosed();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      pipedWriter0.close();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 2337L, 755);
  ...
  public void test11()  throws Throwable  {
      PipedWriter pipedWriter0 = new PipedWriter();
      PipedReader pipedReader0 = new PipedReader(pipedWriter0, 736);
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("j$=H6$K8~\r|rW&=d}", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("vnVGVPKz Zh}9K");
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("M%?<y", "M%?<y");
      Path path0 = mockFile0.toPath();
  ...
  public void test21()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("$KuKN(`EVq#t", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-28707612), (byte)10);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("EEE\uFFFD");
      File file0 = MockFile.createTempFile("EEE\uFFFD", "EEE\uFFFD", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 124, 124);
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test34()  throws Throwable  {
      StringReader stringReader0 = new StringReader("AWqzLlu+@425HQw");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test37()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("M%?<y/M%?<y");
  ...
  public void test40()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(">a!9nWM/E", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse(":oema,", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse(":oema,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse(")KZQ)\"yeVbiPtg3l/L?", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
