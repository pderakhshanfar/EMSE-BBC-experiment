...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StringReader stringReader0 = new StringReader("8V4qYB{+c2-%lRUpBkm");
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("mHs%BrrR1PvtOyL");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2654L), (-2654L));
      cSVParser0.nextRecord();
      assertEquals((-2654L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("!VB~5#L", cSVFormat0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = CSVParser.parse("y6", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-1485L), (-1485L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test11()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-552), (-2114962035));
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, "VG");
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("gHSen*;]F$^");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(",uUWxj", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 98, (-117063355));
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("[dOSENF", "[dOSENF", (File) null);
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile((File) null, "qg6&a");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test33()  throws Throwable  {
      File file0 = MockFile.createTempFile("rxYRk\n|e< =s", "rxYRk\n|e< =s");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
  ...
  public void test34()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 1L, 4158L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test35()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 0L, (-691L));
        fail("Expecting exception: IOException");
  ...
  public void test40()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("VG", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("S^z1.~", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test44()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("GEcLaTp~Dd9$", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      assertEquals((-2655L), cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      Class<Proxy.Type> class0 = Proxy.Type.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("VsziZ%Vb");
  ...
  public void test47()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("G'#S`NUH?!,", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
