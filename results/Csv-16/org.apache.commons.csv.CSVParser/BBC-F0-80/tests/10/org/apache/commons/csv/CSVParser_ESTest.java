...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("EtS7Cc7 ");
  ...
  public void test03()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("MwT=pQbrkGX>Nm>", "' must not be null!", (File) null);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("(S7CP^C");
  ...
  public void test07()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("e`ooPvpy>rzR+'c");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("H-yI1\"2jz");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1425L), (-4170L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("nu\"W@r\r", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("W\"2t#-5D)>5XX", "path");
      Path path0 = mockFile0.toPath();
      try { 
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("f=Nr,@&Gga}fy", "f=Nr,@&Gga}fy");
      Path path0 = mockFile0.toPath();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(mockFileInputStream0, 709);
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("zhr+jF WxlSv}<", "(S7CP^C");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("g[k=", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 0L, 499L);
        fail("Expecting exception: IOException");
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("{`]-}.4b}E\"!\"[^", cSVFormat0);
  ...
  public void test43()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("iIgTQZ`$");
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("iIgTQZ`$");
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      File file0 = MockFile.createTempFile("E(S7CP^C", "E(R9CP^C");
      // Undeclared exception!
      try { 
