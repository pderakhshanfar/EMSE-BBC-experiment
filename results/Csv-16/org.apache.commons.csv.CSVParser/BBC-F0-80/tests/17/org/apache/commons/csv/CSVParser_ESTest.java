...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("?{'/3BGTRlD# ", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(">#6B-@2aX,t}Vr", "w");
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("ffM.ZpB&Iw!V*");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3968L, (-2026L));
      cSVParser0.nextRecord();
      assertEquals((-2026L), cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("T6Oi^a$Wx!0`]ec^ZV!", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 0L, (-2271L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("L8BU0j;n[ZWr\r$h:", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("ffM.ZpB&Iw!V*");
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("?IbQFN{w;ktT[P\"'Ut\"", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("PostgreSQLText", "The delimiter cannot be a line break");
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-829L), 0L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-1036L), (-1004L));
        fail("Expecting exception: IOException");
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("*8i1`", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("/!G']#B[-#!8", cSVFormat0);
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("?{'/3BGTRlD# ", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test42()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1232, 1232);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test45()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("Gtz:$doAzhg");
      try { 
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("N-^B*V#7FL%5\"im");
      CSVParser cSVParser0 = CSVParser.parse((Reader) stringReader0, cSVFormat0);
      cSVParser0.isClosed();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
