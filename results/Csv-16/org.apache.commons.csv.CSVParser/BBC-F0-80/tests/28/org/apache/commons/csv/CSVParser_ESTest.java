...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "MySQL");
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("~S&:Y", cSVFormat1);
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader(">,Sr,j}");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1355L), (-89L));
      cSVParser0.nextRecord();
  ...
  public void test09()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("|q4nMviQ ~S~{j#(", cSVFormat0);
      cSVParser0.close();
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile(" the record values can't be accessed by name", " the record values can't be accessed by name");
      Path path0 = mockFile0.toPath();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      PipedReader pipedReader0 = new PipedReader(1475);
      try { 
  ...
  public void test22()  throws Throwable  {
      File file0 = MockFile.createTempFile("Z@gEON7`1c", "Z@gEON7`1c");
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1407), 65534);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile((File) null, "Delimiter=<,> Escape=<\"> QuoteChar=<\"> NullString=<> RecordSeparator=<\n> SkipHeaderRecord:false");
      File file0 = MockFile.createTempFile("Delimiter=<,> Escape=<\"> QuoteChar=<\"> NullString=<> RecordSeparator=<\n> SkipHeaderRecord:false", "ALL_NON_NULL", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      MockFile mockFile0 = new MockFile("|r{=HF", "|r{=HF");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-1L), 221);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-65L), 2160);
        fail("Expecting exception: IOException");
  ...
  public void test40()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("}h+J1p,x(Gx5.", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("ybz&A3NaD#>T,", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      StringReader stringReader0 = new StringReader("S/bPz'Iv9z#zRV<Y");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test48()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("Don", "Mapping for %s not found, expected one of %s");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test49()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Delimiter=<", "HeaderComments:", 2, "S/bPz'Iv9z#zRV<Y", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      File file0 = MockFile.createTempFile("nZc|[", "Mapping for %s not found, expected one of %s");
      Charset charset0 = Charset.defaultCharset();
