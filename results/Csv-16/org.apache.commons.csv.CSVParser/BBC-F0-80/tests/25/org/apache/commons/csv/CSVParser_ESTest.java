...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("I_^P47+.", "I_^P47+.");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("x+3O{]y~,", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("($une");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1186L, 1186L);
      cSVParser0.nextRecord();
      assertEquals(1186L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('7');
      CSVParser cSVParser0 = CSVParser.parse("Fh?G;i<FU}[4@7^rc", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      StringReader stringReader0 = new StringReader("pH6OD6{yw");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1444L), (-1643L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("pZ%0,j:s;z,--c|qav");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("Kff*7dg-", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-852), 10);
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("pH6OD6{yw", "\u2029");
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-311L), (-1815L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-228L), (-311L));
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      ...
      stringArray0[2] = "t";
      stringArray0[3] = "Fthgh";
      stringArray0[4] = "a[R0<z";
      stringArray0[5] = "NM^oQVLt=|u2c+?g";
      stringArray0[6] = "REJECT_EXTENDED_RANGES";
  ...
  public void test37()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("!h)NwhzO?cA<>sKx8", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("$WFjl/WdP4LO.g)?,", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = CSVParser.parse("!h)NwhzO?cA<>sKx8", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
}
