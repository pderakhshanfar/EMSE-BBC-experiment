...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("f#]MC}Pv{K?rL6Y");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 2676L, 1173L);
      cSVParser0.getRecords();
      assertEquals(1173L, cSVParser0.getRecordNumber());
  }
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      PipedReader pipedReader0 = new PipedReader(4182);
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      File file0 = MockFile.createTempFile("qD>l4Z=", "Unexpected Token type: ");
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("_MD");
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("#]MC}Pv{K?rL6Y", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("f#]MC}Pv{K?rL6Y", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("r2Cli_SkNz@B{", cSVFormat0);
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("4P_:", "\"(");
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("f#]MC}Pv{K?rL6Y");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(mockFileInputStream0, 152);
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-84), 1057);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile("The comment start character and the quoteChar cannot be the same ('", "v");
      File file0 = MockFile.createTempFile("CT;Trm(oIe39X", "#]MC}Pv{K?rL6Y", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      MockFile mockFile0 = new MockFile("F[", "f#]MC}Pv{K?rL6Y");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("s;d7F", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test34()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-2698L), 1L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test35()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      PipedReader pipedReader0 = new PipedReader(1162);
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-1L), (-94L));
        fail("Expecting exception: IOException");
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("\rR", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      stringArray0[0] = "Y5+-y^";
      stringArray0[1] = "file";
      stringArray0[2] = "}F{zXsnelE|[9jEGf7";
      stringArray0[3] = "y";
      stringArray0[5] = "q601";
      stringArray0[6] = "mBI{)T";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord();
      CSVParser cSVParser0 = CSVParser.parse("}F{zXsnelE|[9jEGf7", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("gR66[^CvEEW8Z~.FK,", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-187L), (-187L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("4({0h+-*Exc.k2]A|", cSVFormat0);
      cSVParser0.getCurrentLineNumber();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
