...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("|LX`", "'t8^?q2C*2;");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 99, 0L);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("harset", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("charset");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3561L, 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1L), 60);
      cSVParser0.nextRecord();
      assertEquals(60L, cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      StringReader stringReader0 = new StringReader("charset");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 99, 99);
      cSVParser0.nextRecord();
      cSVParser0.getRecords();
      assertEquals(99L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("1U$~9z=", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test14()  throws Throwable  {
      ...
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile1 = new MockFile(mockFile0, ".`XMuFaD-J!Iz&gLA[X");
  ...
  public void test22()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("<d1");
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, 60);
      cSVParser0.close();
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1561), 98);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("ZS(2{%<xL-MpStzct");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test29()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-26), 4);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test31()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-2726L), (-2726L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, (-2032L));
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
      assertEquals((-2033L), cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      stringArray0[0] = "P(.!LQJ71";
      stringArray0[1] = "charset";
      stringArray0[2] = ") invalid parse sequence";
      stringArray0[3] = "5";
      stringArray0[4] = "H?p'l3f|V";
      stringArray0[5] = "1U$~9z=";
  ...
  public void test43()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("1U$~9z=");
      CSVParser cSVParser0 = CSVParser.parse("1U$~9z=", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("+KGD4F-~=!J%KC3CA,");
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, 3502L, 0L);
      assertEquals((-1L), cSVParser0.getRecordNumber());
  }
  ...
  public void test48()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("Cy*1XF'%a}Dn$0Fx", "Cy*1XF'%a}Dn$0Fx");
      Path path0 = mockFile0.toPath();
      try { 
        CSVParser.parse(path0, charset0, cSVFormat0);
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("1U$~9z=", "1U$~9z=");
      // Undeclared exception!
      try { 
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("harset", cSVFormat0);
      cSVParser0.getCurrentLineNumber();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
