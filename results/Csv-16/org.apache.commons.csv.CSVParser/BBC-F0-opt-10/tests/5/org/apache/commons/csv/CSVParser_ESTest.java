...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Rv{H.");
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\'');
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("dHg!c({s+%`TiH]");
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("dHg!c({s+%`TiH]");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-15L), (-15L));
      cSVParser0.nextRecord();
      assertEquals((-15L), cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      StringReader stringReader0 = new StringReader("fU=S");
  ...
  public void test10()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Rvw{");
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\'');
      CSVParser cSVParser0 = CSVParser.parse((Reader) stringReader0, cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test11()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-255L), (-255L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("S'11Cm&8yOj[:", "S'11Cm&8yOj[:");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"7'eMiN{G-{\")t", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(pipedInputStream0, 1507);
  ...
  public void test23()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("l/r<XOK5C@Z", "l/r<XOK5C@Z", (File) mockFile0);
  ...
  public void test24()  throws Throwable  {
      MockFile mockFile0 = new MockFile("&mfC>9");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      File file0 = MockFile.createTempFile("*rP~;}RMkNuw*Y$xOJ", "*rP~;}RMkNuw*Y$xOJ");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 799L, 0L);
        fail("Expecting exception: IOException");
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      PipedReader pipedReader0 = new PipedReader(2199);
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test34()  throws Throwable  {
      StringReader stringReader0 = new StringReader(" EmptyLines:iRnored");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
  ...
  public void test37()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("P|", cSVFormat3);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("9M", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("gF,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1097254417), (-1097254417));
  ...
  public void test48()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\'');
      File file0 = MockFile.createTempFile(";7&LD", "Vm$Eggsd/T:4N");
      Charset charset0 = Charset.defaultCharset();
