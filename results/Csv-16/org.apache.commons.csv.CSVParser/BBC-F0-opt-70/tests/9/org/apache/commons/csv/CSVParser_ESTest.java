...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = ".mw1]wL8Vnz[]OXj!";
      stringArray0[1] = "1";
      stringArray0[2] = "CommentStart=<";
      stringArray0[3] = "-jl^u}BiaWi}(";
      stringArray0[4] = "org.apache.commons.csv.CSVPrinter";
      stringArray0[5] = "CKEBwyEk+BRD";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("U65$k?v");
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("bXtjR|bL(_w,Quu");
      CSVFormat cSVFormat0 = CSVFormat.newFormat(',');
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-989L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("[rIj@ZA)DBt|", cSVFormat0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("bXtjR|bL(_w,Quu");
      CSVFormat cSVFormat0 = CSVFormat.newFormat(',');
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1753L), (-1753L));
      cSVParser0.nextRecord();
      assertEquals((-1753L), cSVParser0.getRecordNumber());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("bXtjR|bL(_w,Quu");
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile("ph!xW+DP7LjM:E", "3{AB*");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("B,GDyPq[_");
  ...
  public void test28()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1043, 1600);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("vFpjLSY-cY<+q.*ef,+", "");
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("oWfImI^URwhv", "oWfImI^URwhv");
      MockFile mockFile0 = new MockFile(file0, "oWfImI^URwhv");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test33()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-1656L), (-1656L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-1737L), (-1737L));
        fail("Expecting exception: IOException");
  ...
  public void test39()  throws Throwable  {
      File file0 = MockFile.createTempFile("K#J+[m;dx", "K#J+[m;dx");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
  ...
  public void test42()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("z%tiD.W)?Wz]~it", cSVFormat1);
  ...
  public void test44()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("hU(v|", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("f;)U(zv|", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("005F[");
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse(")6J?M", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
}
