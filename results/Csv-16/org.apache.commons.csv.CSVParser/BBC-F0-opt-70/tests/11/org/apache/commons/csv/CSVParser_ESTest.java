...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(pipedWriter0, 3543);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("YZ`-,G!O=mx4i>", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      StringReader stringReader0 = new StringReader(",RGth");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-325L), (-325L));
      cSVParser0.nextRecord();
      assertEquals((-325L), cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-3646L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      StringReader stringReader0 = new StringReader("60P=I;\\e6=eD[(-F");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-5469L), (-1496L));
  ...
  public void test12()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("JK16Kbk:|", "");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("The comment start character and the quoteChar cannot be the same ('", "The comment start character and the quoteChar cannot be the same ('", 991, "The comment start character and the quoteChar cannot be the same ('", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("z5(HX1z41,3#=S190", "(line ", 10, "(line ", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("6K", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      stringArray0[3] = "60P=I;e6=eD[(-F";
      stringArray0[4] = "1s(@6PTJT[8yMe[B";
  ...
  public void test22()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-793), (byte)80);
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-1695L), 0L);
        fail("Expecting exception: IOException");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 2390L, 0L);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals((-1L), cSVParser0.getRecordNumber());
  ...
  public void test35()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, 3399L, (-1695L));
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals((-1696L), cSVParser0.getRecordNumber());
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("_gdzm4@Y`xN:.U8y*?");
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("YZ`-,G!O=mx4i>", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("l*lF", "l*lF");
      Path path0 = mockFile0.toPath();
      try { 
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      File file0 = MockFile.createTempFile("o{LkO:fywD2gLKr", "MINIMAL");
      Charset charset0 = Charset.defaultCharset();
