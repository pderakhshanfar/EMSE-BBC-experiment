...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(1578);
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 1578, 0L);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("reader", "ALL_NON_NULL", (File) mockFile0);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\u0007'Nc\"O;s{(*", cSVFormat1);
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("wIM9~Kl?D8,[3U'V'u");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3366L, 3366L);
      cSVParser0.nextRecord();
      assertEquals(3366L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("tK{{~%kj0{", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("J{<v|ui");
  ...
  public void test11()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, "{`6D5y0TO+D^w42/");
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile((File) null, "K^k3zKyAf?Eg%^");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("<y", "Fe2I~");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(":*6XOL0C9<noFu!", ":*6XOL0C9<noFu!", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 1504L, 683L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      StringReader stringReader0 = new StringReader("r0]22/llE@g$w%0wERL");
  ...
  public void test37()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)108, (byte)52);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\u0007'Nc\"O;s{(*", cSVFormat3);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVParser cSVParser0 = CSVParser.parse("b^cyKShD}=w*", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test42()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\rRz", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      StringReader stringReader0 = new StringReader("b^cyKShD}=w*");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("\u0007'Nc\"O;s{(*", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
}
