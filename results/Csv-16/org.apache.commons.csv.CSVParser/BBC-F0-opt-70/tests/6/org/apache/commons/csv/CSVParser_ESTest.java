...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("<$uB W;`");
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-3076L), (-3076L));
      cSVParser0.nextRecord();
      assertEquals((-3076L), cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      CharBuffer charBuffer0 = CharBuffer.allocate(4119);
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, "|RGVA*D");
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("IA", "(nsn<g^V&DJ3+");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("HaZu", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("HIJcbf~-7j^!LNu,T");
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("The escape character and the delimiter cannot be the same ('", "No more CSV records available");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(mockFileInputStream0, 4276);
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      File file0 = MockFile.createTempFile("The quoteChar character and the delimiter cannot be the same ('", "Unexpected Token type: ");
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser", "lEpD+8BnZ!u<?", (File) null);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      StringReader stringReader0 = new StringReader("s2.(9");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
  ...
  public void test35()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      PipedReader pipedReader0 = new PipedReader(357);
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 357, 357);
        fail("Expecting exception: IOException");
  ...
  public void test40()  throws Throwable  {
      ...
      stringArray0[0] = "2c'f~X";
      stringArray0[1] = ") invalid parse sequence";
      stringArray0[2] = "_b) JB]m}e";
      stringArray0[3] = " reading next record: ";
      stringArray0[4] = "s";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      CSVParser cSVParser0 = CSVParser.parse("k9kEXrl5`bcG", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test41()  throws Throwable  {
      StringReader stringReader0 = new StringReader("7Xb/aC");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse((Reader) stringReader0, cSVFormat0);
  ...
  public void test48()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("EXTENDED_FILTERING", "EXTENDED_FILTERING");
