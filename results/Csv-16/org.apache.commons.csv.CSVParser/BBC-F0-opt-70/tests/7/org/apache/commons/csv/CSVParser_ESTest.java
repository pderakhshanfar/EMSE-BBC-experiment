...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("U@9v*cKS ", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("N1C@kr");
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 455L, 493L);
      cSVParser0.nextRecord();
      assertEquals(493L, cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1L, (-5081L));
      cSVParser0.nextRecord();
      assertEquals((-5081L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      StringReader stringReader0 = new StringReader("NDJ|%bO");
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("RW", cSVFormat0);
      cSVParser0.close();
  ...
  public void test13()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-522L), 0L);
      long long0 = cSVParser0.getRecordNumber();
      assertEquals((-1L), long0);
  }
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("(6yl/", "(line ");
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("wu1!W_Gn6kt#l");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("RW", "N1C@kr");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("8p4r-");
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat2 = cSVFormat1.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVFormat cSVFormat3 = cSVFormat2.withIgnoreHeaderCase();
      // Undeclared exception!
      try { 
        CSVParser.parse("8p4r-", cSVFormat3);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("\"*gB2FZ\"4GXTvNfbXo", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test26()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(pipedInputStream0, 4619);
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 1526, (-1L));
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 0L, 2553L);
        fail("Expecting exception: IOException");
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = CSVParser.parse("racle", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test49()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("Unexpected Token type: ", "@1V<xA");
      Charset charset0 = Charset.defaultCharset();
