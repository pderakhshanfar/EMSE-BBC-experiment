...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(" G'CuLU-!*Ck:", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("_%z", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("f}Ryx+1--@%uhl?U ");
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("J?5#@jqJ");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1L, (-1789L));
      cSVParser0.nextRecord();
      assertEquals((-1789L), cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2478L), (-2478L));
      cSVParser0.nextRecord();
      assertEquals((-2478L), cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile((String) null, "FY[>20~m[");
      File file0 = MockFile.createTempFile("FY[>20~m[", "FY[>20~m[", (File) mockFile0);
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = CSVParser.parse("29sf];Q", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("l3{jWB<{\"ku;U-S*|", cSVFormat3);
      cSVParser0.nextRecord();
  ...
  public void test17()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse(">aN,L4!$M4:yf6w&ce", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 192, (-2110458065));
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 1438);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream((InputStream) null, 1680);
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-23), 760);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test29()  throws Throwable  {
      StringReader stringReader0 = new StringReader("\"pgH\"0yM:;'");
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, (CSVFormat) null, 506L, 506L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat2, (-3250L), (-3250L));
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("*[-4o/RJost&Xog:Ur.", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("l3{jWB<{\"ku;U-S*|", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("l3jWB<{\"ku;U-S*|", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Mu={+m.Jl|:J|n X", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("M)V/| G'CuLU-!*Ck:", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader(":;J^taD)~a&BfgI8'VW");
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("'7Hz{X3F}mEsxcA?9");
      CSVFormat cSVFormat2 = cSVFormat1.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("'7Hz{X3F}mEsxcA?9", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test46()  throws Throwable  {
      String string0 = "l3{jW<{\"\\u;U-*|";
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
