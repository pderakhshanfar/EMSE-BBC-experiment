...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-4379L), (-1L));
  ...
  public void test03()  throws Throwable  {
      File file0 = MockFile.createTempFile("path", "C.c3TGoy5_eKX");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("O$dI^x-G!", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("f?D/g~y6=");
  ...
  public void test08()  throws Throwable  {
      StringReader stringReader0 = new StringReader("}sF4niQe}");
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-1651L), 750);
      cSVParser0.iterator();
      assertEquals(749L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("O$dI^x-G!", cSVFormat0);
      cSVParser0.close();
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("H|pUcg{`3@l)Zc^");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("I~_B ;-$\"", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile(",,oY,')7<", ",,oY,')7<");
  ...
  public void test28()  throws Throwable  {
      MockFile mockFile0 = new MockFile("u778Nk+3Rz");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-1651L), 750);
        fail("Expecting exception: IOException");
  ...
  public void test37()  throws Throwable  {
      ...
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
      assertEquals((-849L), cSVParser0.getRecordNumber());
  }
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      File file0 = MockFile.createTempFile("HnV%Q9kQsNSvbL83", ") EOF reached before encapsulated token finished", (File) null);
      // Undeclared exception!
      try { 
