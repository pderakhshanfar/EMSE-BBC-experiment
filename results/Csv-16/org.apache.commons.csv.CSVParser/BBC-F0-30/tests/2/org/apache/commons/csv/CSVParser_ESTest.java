...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      File file0 = MockFile.createTempFile("Index for header '%s' is %d but CSVRecord only has %d values!", "Index for header '%s' is %d but CSVRecord only has %d values!", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("{x&lhXy,uKi", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("#x*4f7_\"$3{y,y");
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("e+I0%^ncKI^\r4O", cSVFormat0);
      cSVParser0.nextRecord();
      cSVParser0.nextRecord();
  ...
  public void test06()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2155L), (-3888L));
      cSVParser0.nextRecord();
      assertEquals((-3888L), cSVParser0.getRecordNumber());
  }
  ...
  public void test09()  throws Throwable  {
      StringReader stringReader0 = new StringReader("n$`E,4Z");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 3359L, (-1L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("CLvg", "[VZ];M8Oa");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(sequenceInputStream0, 151);
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 692L, 692L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-1L), 5);
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("e+IT0%^ncKI^\r4O", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test37()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(")ydF~", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("_J\tN\tjavax.sql.rowset.RowSetMetaDataImpl@0000000003\tN\torg.apache.commons.csv.CSVFormat@0000000004\tN\tN\tN\tN\tN", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"N\" in [_J, N, javax.sql.rowset.RowSetMetaDataImpl@0000000003, N, org.apache.commons.csv.CSVFormat@0000000004, N, N, N, N, N]
         //
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      File file0 = MockFile.createTempFile("qU/K~;SIO2V8+=&?", "qU/K~;SIO2V8+=&?");
      // Undeclared exception!
      try { 
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse(")ydF~", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
}
