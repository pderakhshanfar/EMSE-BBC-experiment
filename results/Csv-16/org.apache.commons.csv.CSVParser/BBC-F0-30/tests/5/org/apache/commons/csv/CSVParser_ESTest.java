...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(335);
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("^auQp~aY<sh!x]", "^auQp~aY<sh!x]");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, 2298L);
      cSVParser0.nextRecord();
      assertEquals(2297L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2844L), (-2844L));
      cSVParser0.nextRecord();
      assertEquals((-2844L), cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(" S>8VoG(d`g[c", cSVFormat0);
      cSVParser0.close();
  ...
  public void test09()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, (-1166L));
      cSVParser0.nextRecord();
      cSVParser0.getRecords();
      assertEquals((-1166L), cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("file");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 2298L, 2298L);
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      PipedReader pipedReader0 = new PipedReader(170);
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 539L, 0L);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("Hf^u#j");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("t3PZ6,!AUG^@c");
      File file0 = MockFile.createTempFile(">1.+-&k%Y!vuo*", "The comment start character and the delimiter cannot be the same ('", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-53L), (-522L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("NN", cSVFormat0);
      cSVParser0.isClosed();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      StringReader stringReader0 = new StringReader(" 2|=R6R'~H}^");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("}RstPP`?}", cSVFormat3);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("org.apah.cmmons.csv.Token$TZpe", cSVFormat0);
      cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVFormat cSVFormat2 = cSVFormat1.withTrim();
      CSVParser cSVParser0 = CSVParser.parse(" S>8VoG(d`g[c", cSVFormat2);
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("#A'oK>?_(@!", cSVFormat0);
      cSVParser0.close();
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("}RstPP`?}");
      CSVFormat cSVFormat2 = cSVFormat1.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("}RstPP`?}", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("AMKx,", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = CSVParser.parse("lpkm|MP25'", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
