...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 1406L, (-137L));
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("j\ra", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("5\n", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("IGR#gH.A", "IGR#gH.A");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("\"cl3*Le@f}xa", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test25()  throws Throwable  {
      MockFile mockFile0 = new MockFile("g|KS&u9phI[I");
      File file0 = MockFile.createTempFile("g|KS&u9phI[I", "g|KS&u9phI[I", (File) mockFile0);
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("-'Na\u0001Tr6Z#./eA~Hd", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 3, 238L);
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      StringReader stringReader0 = new StringReader(",{sLWRG?cH5yr,_9Hm,");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The header contains a duplicate name: \"\" in [, {sLWRG?cH5yr, _9Hm, ]
         //
  ...
  public void test36()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("DIJL#,4B?i[7@{", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(",{sLWRG?cH5yr,_9H,", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("pa,", cSVFormat1);
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse(",{sLWRG?cH5yr,_9H,", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
