...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(",x/<oqIe7YR[a=&\"", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1L, (-1081L));
      cSVParser0.nextRecord();
      assertEquals((-1081L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      StringReader stringReader0 = new StringReader("cR*4g<j(");
  ...
  public void test09()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("i\r[K} K*PDP]xi6j", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("X@rl?m;a.", cSVFormat2);
  ...
  public void test33()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, (CSVFormat) null, (-1313L), (-1313L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-3343), (-3343));
        fail("Expecting exception: IOException");
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("FbyW}rUE,", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("0j", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\rJO\n", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("G;1jM{$Exg^rRY4", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("uXes+", "xH{krHJ)zI9H1)xQ");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("' must not be null!", "k7Y1v");
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("|I", "RecordSeparator=<");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("i\r[K} K*PDP]xi6j", cSVFormat0);
      cSVParser0.getCurrentLineNumber();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("i\r[K} K*DP]xi6", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
