...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("<Ke comment start marker cha;acter cannot be a line break");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test05()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1202L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Uz", cSVFormat0);
      cSVParser0.close();
  ...
  public void test08()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(pipedWriter0, 1272);
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 1560L, 0L);
      long long0 = cSVParser0.getRecordNumber();
      assertEquals((-1L), long0);
  }
  ...
  public void test11()  throws Throwable  {
      File file0 = MockFile.createTempFile(">tWe^<Z", ">tWe^<Z");
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\" i]n ", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-2), 1416);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      MockFile mockFile0 = new MockFile("z? A_ Z|", "z? A_ Z|");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      try { 
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat2, 3, (-307L));
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      ...
      stringArray0[0] = "3]^H^Bbf#Bs/";
      stringArray0[1] = "G@r:K";
      stringArray0[2] = "";
      stringArray0[3] = "string";
      stringArray0[4] = "CSVParser has been closed";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("G@r:K", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("bS", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("IK:{xzzpq_d", cSVFormat1);
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\rE5", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("!hX5t}b++b4~O");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      File file0 = MockFile.createTempFile("jNEV3ZI3A", "QkuiK+\"4?+C+61?3");
      // Undeclared exception!
      try { 
