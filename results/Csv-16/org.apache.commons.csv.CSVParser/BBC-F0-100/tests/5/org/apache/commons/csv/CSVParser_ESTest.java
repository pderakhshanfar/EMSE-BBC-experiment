...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(".$WVVbc5Vip@p=gJjU", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 2088L, 2088L);
      cSVParser0.nextRecord();
      assertEquals(2088L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(647);
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 585L, 647);
      cSVParser0.close();
      cSVParser0.isClosed();
      assertEquals(646L, cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("p(OI]51T%0?]", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1771L), (-1771L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("X\r\n", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("$|r_+", "");
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("$1", "FLtiAx@CPLCmO,VI{");
      Path path0 = mockFile0.toPath();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(666);
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 581L, 666);
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test27()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-37), (byte)4);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat2, 0L, 103L);
        fail("Expecting exception: IOException");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      PipedReader pipedReader0 = new PipedReader(3391);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test37()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("xhn~", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = CSVParser.parse("t&SkC^#g(ZDwx8t2twh", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("org.apache.commons.cs1.CSVParser$1");
      CSVParser cSVParser0 = CSVParser.parse("org.apache.commons.cs1.CSVParser$1", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("<%<Ni0fNi<qz,hDf|", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("nhk2oI)Vhvf2w", "nhk2oI)Vhvf2w");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test54()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("MNs=1o", cSVFormat0);
