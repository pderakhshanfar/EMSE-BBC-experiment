...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Ks$,?OO");
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("F^`2${K,tch8R");
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader(",l=TQYq@m,S7& =O");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 19L, (-4494L));
      cSVParser0.nextRecord();
      assertEquals((-4494L), cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader(",l=TQYq@m,S7& =O");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1L), (-4494L));
      cSVParser0.nextRecord();
      assertEquals((-4494L), cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 6L, 4);
  ...
  public void test11()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-1849L), (-1849L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test13()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("?e1xIO_t", "CSVRecord [comment=", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("uI/?e1xIO_t0CSVRecord [comment=");
  ...
  public void test16()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("2yqSwrE", "uI", (File) mockFile0);
  ...
  public void test26()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-1), 1842);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("#PS)!aKM6", "line.separator");
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1082936567), 1134);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test34()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("BEvlL", "org.apache.commons.csv.CSVRecord", (File) mockFile0);
      FileSystemHandling.shouldAllThrowIOExceptions();
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
      try { 
  ...
  public void test36()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat2, (-941L), 0L);
        fail("Expecting exception: IOException");
  ...
  public void test40()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("org.apache3commons.csv.CSVFormat$Predefined", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
