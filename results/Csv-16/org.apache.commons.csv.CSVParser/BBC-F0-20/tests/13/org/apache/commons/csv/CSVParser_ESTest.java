...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      Charset charset0 = Charset.defaultCharset();
      File file0 = MockFile.createTempFile("Xvc", "da#;=Td]a");
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1192L, 0L);
      cSVParser0.getRecords();
      cSVParser0.getRecords();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      StringReader stringReader0 = new StringReader("YfC;- ");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3472L, 368L);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("RO]x|<v2U;d,", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test17()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("/xff!Q.TC}S/?", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("RO]x|<v2U;d,");
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("lA", "W1DXukj;RJ;N>hxHN%6");
      File file0 = MockFile.createTempFile("W1DXukj;RJ;N>hxHN%6", "W1DXukj;RJ;N>hxHN%6", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 895L, 50);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test35()  throws Throwable  {
      StringReader stringReader0 = new StringReader("`*2DE-z&eQ&Tl{xD=sJ");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test37()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat4, (-2345L), (-2345L));
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("Xvc");
      CSVParser cSVParser0 = CSVParser.parse((Reader) stringReader0, cSVFormat0);
  ...
  public void test40()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("RO]x|<v2U;d,", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-257L), 0L);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile("po`z!g+9yCV8_8dzn");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
