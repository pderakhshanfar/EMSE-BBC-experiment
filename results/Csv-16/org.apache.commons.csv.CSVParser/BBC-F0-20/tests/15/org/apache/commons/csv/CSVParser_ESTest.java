...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("L^73wm#=5i");
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("s6/M,}2`4Z I2<*s=`");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 858L, 858L);
      cSVParser0.nextRecord();
      assertEquals(858L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-3139L), (-3139L));
      cSVParser0.nextRecord();
      assertEquals((-3139L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Q1Wkhl}&!Gt,");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
  ...
  public void test11()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("_a*|{9MG>J)iS", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test12()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-954L), (-954L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test16()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("VHmkWOo2|a");
      Path path0 = mockFile0.toPath();
      try { 
  ...
  public void test20()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("path", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"L$.`{4V%u8! E}r)M", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test26()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-682), 1081);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("6~L}J/q}^jD*B`^X", "v7olsw)ZAN5'|%D");
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      File file0 = MockFile.createTempFile("REJECT_EXTENDED_RANGES", "\"S~*-`@~y^5(7");
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-32), (byte)47);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-836L), 1L);
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-29), 9);
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse((InputStream) byteArrayInputStream0, charset0, cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      File file0 = MockFile.createTempFile("charset", "=:X$MSRCMpD1y", (File) null);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test44()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("fW?#ANVC=AzWtaA%=-r", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      Class<Locale.FilteringMode> class0 = Locale.FilteringMode.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVParser cSVParser0 = CSVParser.parse("_a*|{9MG>J)iS", cSVFormat1);
  ...
  public void test49()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("HiF.t+bEMK0b#QRs,", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("Q1Wkh]}&Gt,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile(" SurroundingSpaces:ignored", "ALL");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
