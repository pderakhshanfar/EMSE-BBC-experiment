...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("?Ks,=l", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Gy?.8AC\"Ic", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("s<\r?\n", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-122), 143);
  ...
  public void test09()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\r\n");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1L), (-1001L));
      cSVParser0.getRecords();
      cSVParser0.getFirstEndOfLine();
      assertEquals((-1001L), cSVParser0.getRecordNumber());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("\"a]LD", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-77), 1466);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      MockFile mockFile0 = new MockFile("o@R#Jd", "o@R#Jd");
      File file0 = MockFile.createTempFile("o@R#Jd", "o@R#Jd", (File) mockFile0);
  ...
  public void test25()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 557L, 557L);
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test26()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 927L, (-1156L));
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 1532L, 0L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      StringReader stringReader0 = new StringReader("f|Bf:+H>|l%3>");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test35()  throws Throwable  {
      ...
      CSVParser cSVParser1 = new CSVParser(stringReader0, cSVFormat2, 0L, 0L);
  ...
  public void test36()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Gy?.8AC\"Ic", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(1507);
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-2844L), (-30L));
  ...
  public void test39()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, (-1102L), (-926L));
  ...
  public void test42()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(10);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 0L, 10);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("uSmC~/(", "N", (File) null);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test47()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1L), (-1001L));
      cSVParser0.getFirstEndOfLine();
      assertEquals((-1002L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test48()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("+S,-7G+CK67H}", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
