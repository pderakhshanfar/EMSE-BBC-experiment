...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, ">Xp$nnJn]2[N[+ZA?\"");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      StringReader stringReader0 = new StringReader("#HRP_s*");
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1425L, 1425L);
      cSVParser0.nextRecord();
      assertEquals(1425L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(" qLk.*=_#MaSEu[^", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile((File) null, "UkceV'+d1");
      Path path0 = mockFile0.toPath();
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile(" qLk.*=_#MaSEu[^");
  ...
  public void test19()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(pipedWriter0, 1182);
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      File file0 = MockFile.createTempFile("cDs?oy/+t7Dcs:%f ", ",?~UJs7O2AM");
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      File file0 = MockFile.createTempFile(",?~UJs7O2AM", ",?~UJs7O2AM");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("bC*5TMEafkp5ob02>Fw", "bC*5TMEafkp5ob02>Fw");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
  ...
  public void test27()  throws Throwable  {
      MockFile mockFile0 = new MockFile("tp?k83+m-sDVKF1O");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-4780L), (-4780L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1, 0L, 120L);
        fail("Expecting exception: IOException");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("q#F[zn", cSVFormat0);
      cSVParser0.isClosed();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      ...
      Class<Locale.Category> class0 = Locale.Category.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVParser cSVParser0 = CSVParser.parse("nU", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(".!A#A-\"ukguqS", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      File file0 = MockFile.createTempFile("Unexpected Quote value: ", " reading next record: ");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("cDs?oy/+t7Dcs:%f ");
      CSVFormat cSVFormat2 = cSVFormat1.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("cDs?oy/+t7Dcs:%f ", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(".!A#A-\"ukguqS", cSVFormat0);
      cSVParser0.getCurrentLineNumber();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
