...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "C04-\"-(h1bto)RP";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("BK)?ON-", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("uEGq;)`7");
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-5300L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      File file0 = MockFile.createTempFile("The header contains a duplicate name: \"", "org.apache.commons.csv.CSVParser");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 3651L, (-653L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("IhLAZ0G\"** 1JE", " reading next record: ");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      MockFile mockFile0 = new MockFile("org.apache.commons.csv.CSVParser$1", "jTM4HUn+@0.eF~RIV");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("Ng.", (String) null);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      MockFile mockFile0 = new MockFile("", "The escape character an( the delimiter cannot be the same ('");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      cSVFormat0.print((Object) stringReader0, (Appendable) mockPrintStream0, true);
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-1144L), 387L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test35()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("ux", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      stringArray0[0] = ")Q(ogg{1Nc(#8>";
      stringArray0[1] = "url";
      stringArray0[2] = "MU5Ow~W|+E8eu";
      stringArray0[4] = "";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("");
  ...
  public void test39()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("tgC_:I9S/`Q===", cSVFormat3);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      StringReader stringReader0 = new StringReader("k.|oW8X/sm");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 563L, 0L);
  ...
  public void test44()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, 649L, 649L);
      cSVParser0.getRecords();
      assertEquals(649L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse(",dy%$Hp(*BM", cSVFormat0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
