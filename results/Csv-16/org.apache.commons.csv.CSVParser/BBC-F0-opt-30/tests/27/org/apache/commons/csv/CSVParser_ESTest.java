...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile("Ui-:%523p20daOrm");
      File file0 = MockFile.createTempFile("<x%SN", "<x%SN", (File) mockFile0);
  ...
  public void test02()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("+}axh9Rm23tD");
  ...
  public void test04()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("K\r45)7SsVv~%=?^{", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("Doe:L");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-3090L), 435L);
      cSVParser0.nextRecord();
      assertEquals(435L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("mqqutOMnIEX,", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 915L, (-1308L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test11()  throws Throwable  {
      ...
      Class<Locale.Category> class0 = Locale.Category.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 2861L, 2861L);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(2, map0.size());
      assertEquals(2860L, cSVParser0.getRecordNumber());
  }
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("{G&ws9NuR7W5 $Rg");
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("+}axh9Rm23tD", "|nyc4A_.w0BZKR#P");
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 1L, 240L);
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test31()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 542L, 542L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 0L, 591L);
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(pipedWriter0);
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 2861L, 2861L);
      cSVParser0.isClosed();
      assertEquals(2860L, cSVParser0.getRecordNumber());
  }
  ...
  public void test40()  throws Throwable  {
      ...
      stringArray0[0] = "/!NE@Dzzz^@";
      stringArray0[1] = "Eb|=6@B9EygU2|@";
      stringArray0[2] = "wt'd;Hlz";
      stringArray0[3] = "y$4p!";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      Character character0 = Character.valueOf('N');
      CSVFormat cSVFormat3 = cSVFormat2.withCommentMarker(character0);
      StringReader stringReader0 = new StringReader("Eb|=6@B9EygU2|@");
  ...
  public void test43()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("r]\"Mf9PA6n|Pf.8/", cSVFormat0);
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("K\r45)7SsVv~%=?^{", cSVFormat0);
      cSVParser0.getCurrentLineNumber();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
