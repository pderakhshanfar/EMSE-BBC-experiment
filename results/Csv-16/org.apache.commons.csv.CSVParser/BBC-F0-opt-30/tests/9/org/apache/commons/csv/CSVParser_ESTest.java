...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StringReader stringReader0 = new StringReader("F4~5b= ) G`rzX");
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("5(9OS'OQ");
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("55(T>|{i9_");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("l]zHT7[I(&XXFnm.$Z");
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, (-1584L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test12()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("XhdHZSq");
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("(fmqW", "");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"P>sW", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test25()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2026), 62);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("IKhzdz[`g", "file");
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      StringReader stringReader0 = new StringReader("\"P>sW");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test32()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-399L), (-399L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test33()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(2388);
      CSVFormat cSVFormat0 = CSVFormat.newFormat('R');
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 0L, 5382L);
        fail("Expecting exception: IOException");
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("XhdHZSq", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test40()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("F4~5b= ) G`rzX", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test48()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-15), (byte)110);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("f#]u4z#]Ad+VWVWBQ\"");
      Charset charset0 = Charset.defaultCharset();
      try { 
