...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 1448L, 1448L);
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("^.XtAH", (String) null);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2856L), (-2856L));
      cSVParser0.nextRecord();
      assertEquals((-2856L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("PT=0HzraW{>E ");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1922L, 1922L);
      cSVParser0.nextRecord();
      assertEquals(1922L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-12L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("=;grM", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("=;grM", cSVFormat1);
  ...
  public void test11()  throws Throwable  {
      StringReader stringReader0 = new StringReader("PT=0H|zraW{E ");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("k@K\r'tV|XVg:4?wnx", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("ck@K\r'tV|XVg:4?wnx", cSVFormat1);
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("O3f@.y3", "O3f@.y3");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test19()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("ikW9nF68`.6mO,\"l#", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test21()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)16, (-16));
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1452), (byte)50);
  ...
  public void test25()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("charset", "@T55w", (File) mockFile0);
  ...
  public void test28()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-91), (byte)114);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      PipedReader pipedReader0 = new PipedReader(2790);
  ...
  public void test31()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-4443L), (-4443L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-1464L), 32);
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(pipedWriter0, 2814);
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-1L), 2814);
      cSVParser0.isClosed();
      assertEquals(2813L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("ZO", cSVFormat0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test41()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat3, 1922L, 1922L);
      assertEquals(1921L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\rO", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("k@K2't8V|XVg:4?wnx");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("=;grM", "14}fd");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("ck@K\r'tV|XVg:4?wnx", cSVFormat0);
