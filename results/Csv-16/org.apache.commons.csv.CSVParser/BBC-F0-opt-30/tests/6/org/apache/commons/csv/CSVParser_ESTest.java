...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 437L, (-316L));
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("(line ", "H0gmeXO0");
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 1095L, 0L);
      cSVParser0.close();
  ...
  public void test10()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 446L, (-316L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, "'goq>/C");
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("\"X|GYQC7^y@(507", "");
      Path path0 = mockFile0.toPath();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-20), 1285);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("8-<x:^|J0&6`", "8-<x:^|J0&6`");
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 0, 0L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-2718L), (-471L));
        fail("Expecting exception: IOException");
  ...
  public void test39()  throws Throwable  {
      StringReader stringReader0 = new StringReader("The quoteChar character and the delimiter cannot be the same ('");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0, (-1L));
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals((-2L), cSVParser0.getRecordNumber());
