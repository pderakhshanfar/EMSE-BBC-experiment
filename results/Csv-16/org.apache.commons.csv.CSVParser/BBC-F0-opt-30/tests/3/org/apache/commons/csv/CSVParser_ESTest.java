...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\u001F');
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 27L, 27L);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("YoRICl8y,I!", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('%');
      StringReader stringReader0 = new StringReader("2e2hH_B`F;");
  ...
  public void test07()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader();
      CSVFormat cSVFormat0 = CSVFormat.newFormat('%');
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-2212L), (-1L));
      cSVParser0.iterator();
  ...
  public void test09()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 895L, 0L);
      cSVParser0.nextRecord();
      cSVParser0.getRecords();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(">ND$\"\r@w vG7n", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("b1Er.");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      try { 
        CSVParser.parse(" \"/N~P>Fg^rN[y", cSVFormat2);
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1994697287), (-1908874352));
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('-');
      MockFile mockFile0 = new MockFile("Ejt2q/5!'R");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("GeE", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 2136L, 0L);
        fail("Expecting exception: IOException");
  ...
  public void test34()  throws Throwable  {
      ...
      stringArray0[0] = "3`F$";
      stringArray0[1] = "";
      stringArray0[2] = "3S^zE_:`\"4";
      stringArray0[3] = "X1$~>*\"Q[fH8}E";
      stringArray0[4] = "=UnyF^k9CuA";
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("j}oex6T,", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("3>Mj'mmIChDq", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      CSVParser cSVParser0 = CSVParser.parse(">ND$\"\r@w vG7n", cSVFormat1);
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      File file0 = MockFile.createTempFile(" M8*E@5X9+~.Nmm9HIK", "YoRICl8y,I!");
      Charset charset0 = Charset.defaultCharset();
