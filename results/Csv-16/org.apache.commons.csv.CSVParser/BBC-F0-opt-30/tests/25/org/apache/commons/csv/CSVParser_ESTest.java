...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("sUoD{AxX4J");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-3079L), (-3079L));
      cSVParser0.nextRecord();
      assertEquals((-3079L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("\r//nm", cSVFormat0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("be/\"ZJ#mU2u<zy8");
      CSVFormat cSVFormat0 = CSVFormat.newFormat('|');
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3276L, 3276L);
      cSVParser0.nextRecord();
      assertEquals(3276L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("{%zVF7(4yZs", cSVFormat0);
      cSVParser0.close();
  ...
  public void test10()  throws Throwable  {
      StringReader stringReader0 = new StringReader("|3vf?hpewHnyM6");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test11()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-4381L), 0);
      long long0 = cSVParser0.getRecordNumber();
      assertEquals((-1L), long0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile(mockFile0, "1,j1d1$2~mmR&l");
  ...
  public void test23()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1953197286), 5);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      File file0 = MockFile.createTempFile("8 r1p/", "No header mapping was specified, the record values can't be accessed by name");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      PipedReader pipedReader0 = new PipedReader(2079);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("dD#lR%}]:j", cSVFormat0);
      cSVParser0.close();
  ...
  public void test38()  throws Throwable  {
      ...
      Class<Locale.FilteringMode> class0 = Locale.FilteringMode.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVParser cSVParser0 = CSVParser.parse("}`J=Zs~~$v/", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("#W$v)0Sl[@oAJQSI,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("m1,", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("N07*[:`8nd&ceF", "gWMj,");
      Path path0 = mockFile0.toPath();
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.valueOf("InformixUnload");
      CSVParser cSVParser0 = CSVParser.parse("InformixUnload", cSVFormat0);
