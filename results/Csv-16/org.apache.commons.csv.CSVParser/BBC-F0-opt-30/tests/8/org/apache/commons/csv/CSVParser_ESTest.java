...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("xHJ0U?c", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("n46|7eB\"ktUksn(%!O#");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, (-1160L));
      cSVParser0.nextRecord();
      assertEquals((-1160L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("5j0z+*KrFJO'Csk>0");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 928L, 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      MockFile mockFile0 = new MockFile((String) null, "&8&[7sNkZeinXc3tN");
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('~');
      CSVParser cSVParser0 = CSVParser.parse("Kmg{", cSVFormat0);
      cSVParser0.close();
  ...
  public void test09()  throws Throwable  {
      StringReader stringReader0 = new StringReader("strin/g");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile("=e", "P]B");
      File file0 = MockFile.createTempFile("DrEz8%k<2b(I2dn0", "=e", (File) mockFile0);
  ...
  public void test21()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-13), (byte)2);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile((String) null, "No quotes mode set but no escape character is set");
      File file0 = MockFile.createTempFile("No quotes mode set but no escape character is set", ") invalid parse sequence", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1198), 4);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test29()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 1231, 1231);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("1V:q", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("3l9mvQ^J*Y*");
  ...
  public void test41()  throws Throwable  {
      ...
      Class<QuoteMode> class0 = QuoteMode.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVParser cSVParser0 = CSVParser.parse("Kmg{", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile(":%VOW9S#m", ":%VOW9S#m");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
        CSVParser.parse(path0, charset0, cSVFormat0);
