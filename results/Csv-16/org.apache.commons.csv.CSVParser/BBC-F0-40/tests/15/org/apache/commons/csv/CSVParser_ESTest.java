...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("==w&0`u?dQ+=0X6^z");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 419L, (-418L));
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals((-418L), cSVParser0.getRecordNumber());
  }
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("\"6P'D(", cSVFormat0);
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("rIHGb1o:7UEN64P[", cSVFormat0);
      cSVParser0.close();
  ...
  public void test10()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$2", "'9p,Fhxu@_?NCZ5");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<h> QuoteChar=<\"> RecordSeparator=<\n> EmptyLines:ignored SkipHeaderRecord:false", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test23()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1431655764), 9);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("rIHGb1o:7UEN64P[", "`4,Dex\"}94)6cm");
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Z_p{W&w&8)FF,@5]");
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, (CSVFormat) null, 0L, (-866L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 100, 577L);
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("<`T#7nf@'7", cSVFormat0);
      cSVParser0.isClosed();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("HTTx1P", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("h\" C,", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("rIHGb1o:7UEN64P[", cSVFormat1);
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("TOKEN", "#2G(OJ=[ij");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
