...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("GtrNQy6");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-847L), (-847L));
      cSVParser0.nextRecord();
      assertEquals((-847L), cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("TlBoiKRsrgSR");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 2064L, 2064L);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("HeaderComments:", "KZjWAkg4+J[46");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("(qfgGPdo%$", "qCo4BCp");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"6!COi0GX|2jN*I!x", cSVFormat1);
  ...
  public void test20()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(pipedInputStream0, 2165);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      File file0 = MockFile.createTempFile("o0ozY`1aVWBo^?X", "o0ozY`1aVWBo^?X");
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("fW*c", "naqI");
      FileSystemHandling.shouldAllThrowIOExceptions();
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat2, (byte) (-71), 0L);
        fail("Expecting exception: IOException");
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("@9v", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(" W.,", cSVFormat3);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      StringReader stringReader0 = new StringReader("~D#U?<7^a>");
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("ALL", "TlBoiKRsrgSR");
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(0L, cSVParser0.getRecordNumber());
