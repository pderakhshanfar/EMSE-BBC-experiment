...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(" 0<\r", cSVFormat2);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("-u7y.Z\"~{FEl+u^;Sa", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("k\rGR\n", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-433L), (-433L));
      cSVParser0.nextRecord();
      assertEquals((-433L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("ZU30f/b+t;=k8*NmFzQ", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test11()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader();
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 0L, (-614L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test16()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("PKfY{$QYVVzaJFJ8", "No more CSV records available");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      stringArray0[0] = "FF.f4Bu>(+0@\"NJS";
      stringArray0[2] = "k,PKfY{$QYVVzaJFJ8";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("FF.f4Bu>(+0@\"NJS", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test22()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
      try { 
        CSVParser.parse("\"vbfG['ENV~4N}", cSVFormat1);
  ...
  public void test27()  throws Throwable  {
      File file0 = MockFile.createTempFile("T4y", "T4y");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      File file0 = MockFile.createTempFile("y^;D", "url");
  ...
  public void test30()  throws Throwable  {
      MockFile mockFile0 = new MockFile("T4y");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      try { 
  ...
  public void test34()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-769L), (-769L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("*e 3R{n+/}y?3n,^", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test44()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("ZU30f/b+t;=k8*NmFzQ", cSVFormat2);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("FIFf_jOhl{Mi", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
