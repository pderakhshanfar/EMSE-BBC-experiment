...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("ZR=upA", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("O=s48Wwi`xma&1xee");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1836L, 675L);
      cSVParser0.nextRecord();
      assertEquals(675L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1381L), (-1381L));
      cSVParser0.nextRecord();
      assertEquals((-1381L), cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      StringReader stringReader0 = new StringReader("e`M=v-(P");
      CSVFormat cSVFormat0 = CSVFormat.newFormat('2');
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1082L), 0L);
      long long0 = cSVParser0.getRecordNumber();
      assertEquals((-1L), long0);
  }
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("EKFL',");
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".xXcM~_dZ", "!3qixf; g|bI");
      Path path0 = mockFile0.toPath();
  ...
  public void test18()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("", "", 116, "org.apache.commons.csv.CSVParser", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("CT]*Nl=^7", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test28()  throws Throwable  {
      MockFile mockFile0 = new MockFile("d(/<-$3%EcA4sNY{");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      try { 
  ...
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader("tdg2M4S@2m9#bA@");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 3545, 0L);
        fail("Expecting exception: IOException");
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("M(#7", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("REJECT_EXTENDED_RANGES", cSVFormat1);
  ...
  public void test43()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("ZR=upA");
      CSVParser cSVParser0 = CSVParser.parse("ZR=upA", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("EKFL',", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser", "EXTENDED_FILTERING");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("M(#7", cSVFormat0);
