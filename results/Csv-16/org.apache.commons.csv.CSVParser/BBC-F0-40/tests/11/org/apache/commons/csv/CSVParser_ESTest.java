...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("E0iQq|=^6YF3.", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("euH");
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1879L), (-1879L));
      cSVParser0.nextRecord();
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("5KnT!dH9@fX?E&AX", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(']');
      StringReader stringReader0 = new StringReader("");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-4528L), (-1L));
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("daA+P}D ", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test12()  throws Throwable  {
      StringReader stringReader0 = new StringReader("^{h&:U$Zh0d5CVa+ ");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2688L), (-2688L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      File file0 = MockFile.createTempFile("5^I!A3KjZG0U", "5^I!A3KjZG0U");
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      MockFile mockFile0 = new MockFile("TGe%||C*!");
      try { 
  ...
  public void test31()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-9), 3786);
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse((InputStream) byteArrayInputStream0, charset0, cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2116), (byte)107);
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(byteArrayInputStream0);
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse((InputStream) bufferedInputStream0, charset0, cSVFormat0);
      // Undeclared exception!
  ...
  public void test35()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(reader0, cSVFormat0, long0, long0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test36()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 647L, 0L);
        fail("Expecting exception: IOException");
  ...
  public void test39()  throws Throwable  {
      StringReader stringReader0 = new StringReader("^{h&:U$Zh0d5CVa+ ");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1L, 1207L);
      cSVParser0.isClosed();
      assertEquals(1206L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("3ai{(@'M:R6LdVVdE,", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("3ai{(@'M:R6LdVVdE,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = CSVParser.parse("|lzxcOt?-BE", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("daA+P}D \torg.apache.commons.csv.CSVFormat@0000000001", "org.apache.commons.csv.Assertions");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test52()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse(")W$GbZbfsq", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
}
