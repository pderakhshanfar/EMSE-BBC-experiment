...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("p)wSet)dFTY", "p)wSet)dFTY");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("4(y584&`ij!xcAN^b>", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("SnNA", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("F<s6>\ns`2\"Y");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("#i!<; $ngq2xbWKfYr9L");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (byte)10, (byte)10);
      cSVParser0.nextRecord();
  ...
  public void test10()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(2216);
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (byte)24, (byte) (-17));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile((String) null, "8mtGK~");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("SOCKS");
      // Undeclared exception!
      try { 
        CSVParser.parse("SOCKS", cSVFormat3);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile((File) null, "Z2qv5.^PZ1~cEF2[4.j");
      File file0 = MockFile.createTempFile("XaEvXfK~", "XaEvXfK~", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-995L), 1L);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 4689L, (-3415L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("cbQ$+5PXY6s1oQB;Coq", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test36()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("t\u0004 1/n)", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      Class<Proxy.Type> class0 = Proxy.Type.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVParser cSVParser0 = CSVParser.parse("t\u0004 1/n)", cSVFormat1);
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile(")", "1?<^).|%_Di!");
      try { 
