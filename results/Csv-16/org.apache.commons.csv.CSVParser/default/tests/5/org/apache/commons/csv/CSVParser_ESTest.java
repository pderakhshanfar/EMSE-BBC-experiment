...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 65534, 65534);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
  ...
  public void test04()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(", mapping=", ", mapping=", (File) mockFile0);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("|tCirtvd");
  ...
  public void test08()  throws Throwable  {
      StringReader stringReader0 = new StringReader("&9_ulx:'L>");
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      StringReader stringReader0 = new StringReader("?tR2 u's|tCirtvd");
  ...
  public void test11()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 0L, (-1361L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("u9=7Z");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("\"HZJZ_Z+", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-13), 242);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("EOF whilst processing escape sequence", "s.pI_L(U=#*");
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("\"'w2`G4o", cSVFormat0);
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test29()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, (CSVFormat) null, (-768L), 2661L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 1900L, 1900L);
        fail("Expecting exception: IOException");
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("u*l", cSVFormat0);
      cSVParser0.isClosed();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("p6vo<Dj8'$", cSVFormat0);
      cSVParser0.close();
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(" ,&;'*nIVn,i{lLK,", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [, &;'*nIVn, i{lLK, ]
         //
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("z ,&;'*nIVn,|i{lLK,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test43()  throws Throwable  {
      StringReader stringReader0 = new StringReader(",-q[g}fhh($);Q-T,");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withTrailingDelimiter();
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, 887L, (-3074L));
      cSVParser0.nextRecord();
      assertEquals((-3074L), cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse(",-q[g}fhh($);DQ-T,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
