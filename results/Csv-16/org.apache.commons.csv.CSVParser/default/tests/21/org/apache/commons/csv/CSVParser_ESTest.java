...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(5437);
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-143L), 5437);
      try { 
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile(",=C|PhObv");
      File file0 = MockFile.createTempFile("a.:k$T1T\"(YWbc@VjZ", "a.:k$T1T\"(YWbc@VjZ", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("*0gb|%.Nh0u%", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test06()  throws Throwable  {
      ...
      stringArray0[0] = "{,";
      stringArray0[1] = "s5(,G67_;>[NNB\"6|bx";
      stringArray0[2] = "PostgreSQLCsv";
      stringArray0[3] = ">GOJko{A[(f";
      stringArray0[4] = "PphM<h['7+&a$lFu9";
      stringArray0[5] = "B(f";
      stringArray0[6] = "p!eZ2j4msLb{";
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("0f1RY 8Mv;:_a)C", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      StringReader stringReader0 = new StringReader("*0gb|%.Nh0u%");
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 1367L, (-1L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test20()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("\";W(.EY_o+myf$lu?", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test25()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-2), (byte)5);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      File file0 = MockFile.createTempFile("PphM<h['7+&a$lFu9", "En!");
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-769L), (-1L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      PipedReader pipedReader0 = new PipedReader(6461);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("h&|8sy<5m^f6W", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("charsvet", cSVFormat0);
      cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test43()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("I:,UNg;7Qsb_,", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
