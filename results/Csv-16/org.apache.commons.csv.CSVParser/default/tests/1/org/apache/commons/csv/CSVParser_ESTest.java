...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("NONE", "<e/=Uk$z836eViM_J", (File) mockFile0);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("<e/=Uk$z836eViM_J", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("}z4h5{gwf#GYlC");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1423L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("$UpSF0LnEU#~a?P");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3458L, 3458L);
      cSVParser0.nextRecord();
      assertEquals(3458L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("D&G|pl(M}aO-#");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-196L), (-1031L));
      cSVParser0.nextRecord();
      assertEquals((-1031L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("{pD+TbP:@kQGVXP", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("<e/=Uk$z836eViM_J", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test16()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("ZE Z2s1^ej^", "ZE Z2s1^ej^");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      MockFile mockFile0 = new MockFile("*:54~=xI)M?GM.3/o", "*:54~=xI)M?GM.3/o");
      try { 
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse("I;/aBDxf(zgxD! I\"", cSVFormat0);
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 3404L, 3404L);
        fail("Expecting exception: IOException");
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("mVaniE^!gs/IA!z8Iu", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("^9_XgE},");
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("s=3fe8C.\"2`p?k,", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
