...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = MockFile.createTempFile("lJc+gIY^*", "HTTP");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("TDF");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1L, (-180L));
      cSVParser0.nextRecord();
      assertEquals((-180L), cSVParser0.getRecordNumber());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, '5', (-338L));
      cSVParser0.close();
      boolean boolean0 = cSVParser0.isClosed();
      assertTrue(boolean0);
      assertEquals((-339L), cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      StringReader stringReader0 = new StringReader("");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-523L), (-893L));
      cSVParser0.getRecords();
      assertEquals((-894L), cSVParser0.getRecordNumber());
  }
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("X0*EUitN+(PPOT\rw;.", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      MockFile mockFile0 = new MockFile("sg", "sg");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("RFC4180", cSVFormat2);
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("x]$E@=YMLr", "x]$E@=YMLr");
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 752L, 752L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 512, 512);
        fail("Expecting exception: IOException");
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("`)MsD@@k=T");
      StringReader stringReader0 = new StringReader("`)MsD@@k=T");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("\rzX\n", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      StringReader stringReader0 = new StringReader(",,,org.apache.commons.csv.CSVFormat@0000000001,,org.apache.commons.csv.CSVFormat@0000000005,,");
      CSVParser cSVParser0 = CSVParser.parse((Reader) stringReader0, cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      StringReader stringReader0 = new StringReader("org.evosuite.runtime.testdata.FileSystemHandling@0000000008,org.apache.commons.csv.CSVFormat@0000000009,org.apache.commons.csv.CSVFormat@0000000005,org.apache.commons.csv.CSVFormat@0000000009,org.apache.commons.csv.CSVFormat@0000000009,org.apache.commons.csv.CSVFormat@0000000009,");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // The header contains a duplicate name: \"org.apache.commons.csv.CSVFormat@0000000009\" in [org.evosuite.runtime.testdata.FileSystemHandling@0000000008, org.apache.commons.csv.CSVFormat@0000000009, org.apache.commons.csv.CSVFormat@0000000005, org.apache.commons.csv.CSVFormat@0000000009, org.apache.commons.csv.CSVFormat@0000000009, org.apache.commons.csv.CSVFormat@0000000009, ]
         //
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      StringReader stringReader0 = new StringReader("DX)Nz1x");
      CSVParser cSVParser0 = CSVParser.parse((Reader) stringReader0, cSVFormat1);
  ...
  public void test49()  throws Throwable  {
      StringReader stringReader0 = new StringReader("HNd`_5Y7EMFt553`: d");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, 0L);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test54()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("{#hJ-m", cSVFormat0);
