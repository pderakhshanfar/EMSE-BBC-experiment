...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("a2{", cSVFormat1);
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"vp#]YpEbhD#s", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("#Ab", "E");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3590L, 3590L);
      cSVParser0.nextRecord();
      assertEquals(3590L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      StringReader stringReader0 = new StringReader("Q7.XPl=fQF3@");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-3483L), (-3483L));
      cSVParser0.nextRecord();
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("OW(f}UA%t7DY(2", cSVFormat0);
      cSVParser0.close();
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      StringReader stringReader0 = new StringReader("_a,nF^i^IChU[");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-3483L), (-3483L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test21()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"Q6J9-", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("'eR", "Escape=<");
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 34, 34);
        fail("Expecting exception: IOException");
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("K$_w6)v4fj#DmULioO", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test48()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("a2{", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("&GNwKnvX", "&GNwKnvX");
      Charset charset0 = Charset.defaultCharset();
      try { 
