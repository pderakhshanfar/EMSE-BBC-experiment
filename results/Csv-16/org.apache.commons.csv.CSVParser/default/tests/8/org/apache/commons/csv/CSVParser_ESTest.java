...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("P-Jb|f)[|", "P-Jb|f)[|");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1307L, 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("w");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3888L, (-712L));
      cSVParser0.nextRecord();
      assertEquals((-712L), cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2641L), (-1L));
      cSVParser0.nextRecord();
      assertEquals((-1L), cSVParser0.getRecordNumber());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 0L, (-633L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("/uG$G", "/uG$G");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test22()  throws Throwable  {
      MockFile mockFile0 = new MockFile(" [");
      File file0 = MockFile.createTempFile("#A#oX", "#A#oX", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-1972L), (-1972L));
        fail("Expecting exception: IOException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("w&['{Ds", cSVFormat0);
      cSVParser0.close();
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("u(Ue~t7h", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("/uG-G,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile("Az]!Eq&:z~f?6g");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      MockFile mockFile0 = new MockFile("iue]w");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test43()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      MockFile mockFile0 = new MockFile("r>f@c;FcS=i*");
      Charset charset0 = Charset.defaultCharset();
      try { 
