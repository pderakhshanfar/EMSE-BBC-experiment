...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("path", ";0{>3dr%_>!yZ)t+T1?");
      File file0 = MockFile.createTempFile("h=CWi2$=;;", "path", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("kBRd?A$BK@&r", cSVFormat2);
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("Cn@%'{q1", cSVFormat0);
      cSVParser0.getRecords();
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test17()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("QCz8i9ae2");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("WExQ*9o_B(", "H_SZbj.ytmhzFm]Qh");
      // Undeclared exception!
      try { 
  ...
  public void test35()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-3139L), (-3139L));
        fail("Expecting exception: IOException");
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("CR%No<K8E9I=x*E,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
