...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("inputStream", "N", (File) mockFile0);
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader(">vfL^/>");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1075L, 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("2");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1L, 3385L);
      cSVParser0.nextRecord();
      assertEquals(3385L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("2");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2283L), 3385L);
      cSVParser0.nextRecord();
      assertEquals(3385L, cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("[U1=CJ?%", cSVFormat0);
      cSVParser0.close();
  ...
  public void test10()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("MnL");
  ...
  public void test11()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Kts; Z5;KVW`Vo");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test12()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("!T!P8", "!T!P8");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("Unexpected Token type: ", cSVFormat3);
        fail("Expecting exception: NullPointerException");
  ...
  public void test21()  throws Throwable  {
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream((InputStream) null, 529);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1648), 2592);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 1631L, (-892L));
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("}9!j!;$", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test36()  throws Throwable  {
      ...
      stringArray0[0] = "Oracle";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Oracle", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("s ", "(line ");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("D}htYi)Kt3", "D}htYi)Kt3");
      // Undeclared exception!
      try { 
