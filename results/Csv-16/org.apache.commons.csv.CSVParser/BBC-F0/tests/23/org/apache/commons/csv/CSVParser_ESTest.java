...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-3080L), 0L);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-4308L), 1L);
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("X9=4q,I76irbRglTHC|");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1317L, (-1L));
      cSVParser0.nextRecord();
      assertEquals((-1L), cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("w+hd6`Wi");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-4308L), 1L);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  ...
  public void test08()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(pipedWriter0, 2696);
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 1L, (-533L));
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile("I76irbRglTHC|");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("R+`t#f;e+", "R+`t#f;e+");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("o-^hxp,C", "o-^hxp,C");
  ...
  public void test21()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-113), 3349);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("BQe)[ 19YRG^=PF", "BQe)[ 19YRG^=PF", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      MockFile mockFile0 = new MockFile("|@iHe,", "VRCi<[CLvKc>jY+Yo");
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("}z`f~BO", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test41()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1478L, 1478L);
      cSVParser0.getHeaderMap();
      assertEquals(1477L, cSVParser0.getRecordNumber());
  }
  ...
  public void test43()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("X+(d(&hG;,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("X+(dC(&hG;,", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test49()  throws Throwable  {
      File file0 = MockFile.createTempFile("X9=4q,I76irbRglTHC|", "X9=4q,I76irbRglTHC|");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("naVP$}A<q=", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
