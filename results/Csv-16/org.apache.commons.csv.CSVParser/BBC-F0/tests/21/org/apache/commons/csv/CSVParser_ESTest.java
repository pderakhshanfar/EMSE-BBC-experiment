...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      File file0 = MockFile.createTempFile("=kynN/*y/S93", "=kynN/*y/S93");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("S*]]n,rtYo{d;H\"%#!", cSVFormat1);
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("')");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 228L, (-1L));
      cSVParser0.nextRecord();
      assertEquals((-1L), cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("')");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-31L), (-31L));
      cSVParser0.nextRecord();
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("c{.$02':yB:Ch7#G%*,", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test11()  throws Throwable  {
      StringReader stringReader0 = new StringReader("')");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, (-899L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test13()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("5d;(~KXn|", "5d;(~KXn|");
  ...
  public void test21()  throws Throwable  {
      File file0 = MockFile.createTempFile("y~{", "UWrHoX>T5!?");
  ...
  public void test24()  throws Throwable  {
      MockFile mockFile0 = new MockFile("NMh!{2", "NMh!{2");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test27()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 0L, (-1552L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, (-899L));
      cSVParser0.isClosed();
      assertEquals((-900L), cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("i4^,", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("gN", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("y+~{", cSVFormat4);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("'S+Mm}nYcOQ}Os", cSVFormat0);
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("i4^,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("&[RZx{E8t;{i]");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
