...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, (-1167L));
      cSVParser0.getRecords();
      assertEquals((-1167L), cSVParser0.getRecordNumber());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("~Q^=nc7e$#ea08a%)d", "XSg-I$Rv65>vi8J1");
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("['b~B2^T+6x~42m]d");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      String[] stringArray0 = new String[2];
      stringArray0[0] = "|2Tg8nR~QPUxY:fat";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, (-1894L), (-428L));
      cSVParser0.nextRecord();
      assertEquals((-428L), cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-88L), (-88L));
      cSVParser0.iterator();
  ...
  public void test11()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("m8p]eACVy0%SQ", cSVFormat2);
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("XSg-I$Rv65>vi8J1");
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("RaWl7vWR", "RaWl7vWR");
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      File file0 = MockFile.createTempFile("?vS l9D~b^a", (String) null);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      StringReader stringReader0 = new StringReader("_{d:')a");
  ...
  public void test28()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, '=', 189L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 1748L, (-2267L));
        fail("Expecting exception: IOException");
  ...
  public void test34()  throws Throwable  {
      ...
      doReturn(rowSetMetaDataImpl0).when(resultSet0).getMetaData();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(resultSet0);
      CSVParser cSVParser0 = CSVParser.parse("+FMVcS{|_z_w3O:V,r~", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      String[] stringArray0 = new String[2];
      stringArray0[0] = "?WeoqrXZ:V";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Ah\"p`9z", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("m8p]eACVy0%SQ", cSVFormat1);
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('~');
      CSVParser cSVParser0 = CSVParser.parse("+FMVcS{|_z_w3O:V,r~", cSVFormat0);
      cSVParser0.close();
  ...
  public void test46()  throws Throwable  {
      StringReader stringReader0 = new StringReader("['b~B2^T+6x~42m]d");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1894L), (-428L));
      cSVParser0.getCurrentLineNumber();
      assertEquals((-429L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test47()  throws Throwable  {
      StringReader stringReader0 = new StringReader("]TZM8w");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVParser cSVParser0 = CSVParser.parse((Reader) stringReader0, cSVFormat0);
