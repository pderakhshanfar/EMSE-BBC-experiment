...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("4/}g@2>$J]lv'-iP,G]", "4/}g@2>$J]lv'-iP,G]", (File) mockFile0);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("_?)oL+R LqxCU", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("x@fj(1u+lA~pE^*");
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("_a9;Ob3G#IeRWeu ", cSVFormat0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("ZoA|P')--)|^f7C,Q");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 815L, 815L);
      cSVParser0.nextRecord();
      assertEquals(815L, cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = CSVParser.parse("_?)oL+R LqxCU", cSVFormat0);
      cSVParser0.close();
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("4/}g@2>$J]lv'-iP,G]", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-3465L), (-3473L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test13()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("d\r93", cSVFormat1);
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      MockFile mockFile0 = new MockFile("8A@~o@", "4/}g@2>$J]lv'iP");
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("nF:NG");
      Path path0 = mockFile0.toPath();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("_?)oL+R LqxCU");
      File file0 = MockFile.createTempFile("Oracle", "PmN=", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      MockFile mockFile0 = new MockFile("QuoteChar=<", "^B@/<");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-1828L), (-51L));
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-1910L), 2476L);
        fail("Expecting exception: IOException");
  ...
  public void test37()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("d\r93", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("4/}g@2>$J]lv'-iP,G]", "qq,eK`xT");
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("Zo|P')--)s^x7,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      MockFile mockFile0 = new MockFile("oT@y5cdQuCGan");
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("ViW`[v@32a", ";Z#7Q=E\"Ak");
      try { 
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("d\r93", cSVFormat0);
      cSVParser0.getCurrentLineNumber();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
