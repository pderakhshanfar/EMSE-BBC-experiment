...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("6mns4QfPJ`O16");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 393L, 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("g?3yP]X_ZYz4We", cSVFormat0);
      cSVParser0.close();
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("PY:T_W~-^Vi", "PY:T_W~-^Vi");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-574), 576);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("):\"I;^z", "):\"I;^z", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile("3-/C19xqf-ep[{", "h3DW&O(dgb!aojtYh:.");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test29()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, (CSVFormat) null, (-93L), 0L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      PipedReader pipedReader0 = new PipedReader(2315);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test35()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 5, 576);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("PY:T_W~-^Vi", cSVFormat0);
      cSVParser0.getRecords();
      long long0 = cSVParser0.getRecordNumber();
      assertEquals(1L, long0);
  }
  ...
  public void test44()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(pipedWriter0);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-1720L), (-1720L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      MockFile mockFile0 = new MockFile("\" in ", "YZ j+C!@jyEL)=O");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("D5Nk[", "PY:T_W~-^Vi");
      Charset charset0 = Charset.defaultCharset();
