...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Al7A')lksAV", cSVFormat1);
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("l~a}gk(/-?CRq");
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 335L, 335L);
      cSVParser0.nextRecord();
      assertEquals(335L, cSVParser0.getRecordNumber());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"$=Y>*SO?", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      PipedInputStream pipedInputStream0 = new PipedInputStream(5881);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("file", "MAP_EXTENDED_RANGES");
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-85), (byte)56);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 3465L, 3465L);
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      PipedReader pipedReader0 = new PipedReader(3293);
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 3293, 0L);
        fail("Expecting exception: IOException");
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("f zL~IY~? <6qrk", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      Class<Locale.FilteringMode> class0 = Locale.FilteringMode.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVParser cSVParser0 = CSVParser.parse("ANag", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
      assertNotNull(map0);
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Al7A')lksAV");
      CSVParser cSVParser0 = CSVParser.parse("Al7A')lksAV", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(",,Pc", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"\" in [, , Pc]
         //
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("java.io.PipedReader@0000000002\tjava.io.PipedReader@0000000002\tjava.io.PipedReader@0000000002\tjava.io.PipedReader@0000000002\tjava.io.PipedReader@0000000002", "q,wywl#i~");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test50()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("ANag", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
