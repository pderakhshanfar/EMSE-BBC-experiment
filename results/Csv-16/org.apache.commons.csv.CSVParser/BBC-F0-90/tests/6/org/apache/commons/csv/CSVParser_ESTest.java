...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("Fbks~u=9kA", "U1", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("YM", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test09()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 1714L, 1714L);
      cSVParser0.nextRecord();
      assertEquals(1714L, cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1L), (-768L));
      cSVParser0.nextRecord();
      assertEquals((-768L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("YM", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test18()  throws Throwable  {
      MockFile mockFile0 = new MockFile("^g6N%Rt~?'E", "@GDwrMh_hBV/W(ck3");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.newFormat('E');
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      File file0 = MockFile.createTempFile("?S+V+1Oy:bS,<p", "?S+V+1Oy:bS,<p");
  ...
  public void test28()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(", values=", "inputStream", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      File file0 = MockFile.createTempFile("s`@nY=.E_BMHvs", "");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 943L, 943L);
        fail("Expecting exception: IOException");
  ...
  public void test45()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(276);
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test52()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1L), (-768L));
      cSVParser0.getFirstEndOfLine();
      assertEquals((-769L), cSVParser0.getRecordNumber());
  }
}
