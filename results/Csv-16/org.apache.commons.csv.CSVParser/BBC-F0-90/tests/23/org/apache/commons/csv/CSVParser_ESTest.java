...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("o?B}2kk*\"", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("sX+8cj)FR}E*mR{");
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 4543L, 4543L);
      cSVParser0.close();
      boolean boolean0 = cSVParser0.isClosed();
      assertEquals(4542L, cSVParser0.getRecordNumber());
      assertTrue(boolean0);
  }
  ...
  public void test10()  throws Throwable  {
      StringReader stringReader0 = new StringReader("]AI{Sv)FcVb2P:\"R");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1382L), (-596L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, 0L, 1309L);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(1308L, cSVParser0.getRecordNumber());
  ...
  public void test14()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("MAP_EXTENDED_RANGES", "MAP_EXTENDED_RANGES");
      Path path0 = mockFile0.toPath();
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      MockFile mockFile0 = new MockFile("EXTENDED_FILTERING", "G");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("$JTQ7E85`dqmGp", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("/_t'Gi^M)k5QZ");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-36L), (-36L));
      cSVParser0.close();
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 781, (-121));
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      File file0 = MockFile.createTempFile("*.?jq=}pspW%;b=RnJ", "[&(");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 0L, 1309L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 1309L, (byte)116);
        fail("Expecting exception: IOException");
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("XG:C,", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1080430200), (byte) (-8));
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse((InputStream) byteArrayInputStream0, charset0, cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test43()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Rw3FaF;r5>");
      CSVParser cSVParser0 = CSVParser.parse("Rw3FaF;r5>", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
