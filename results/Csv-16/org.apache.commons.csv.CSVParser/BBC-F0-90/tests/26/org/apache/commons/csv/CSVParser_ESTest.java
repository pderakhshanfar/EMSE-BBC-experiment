...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("url", "charset");
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("w5zhOy");
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("XqooKO|2oC");
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("*  :N~:*1UUs");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("w5zhOy", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      PipedReader pipedReader0 = new PipedReader();
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 639L, 639L);
  ...
  public void test10()  throws Throwable  {
      StringReader stringReader0 = new StringReader("*  :N~:*1UUs");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-435L), (-434L));
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("w5zhOy", "w5zhOy");
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Unexpected Token type: ", "file");
      Path path0 = mockFile0.toPath();
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"L!.ap", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      File file0 = MockFile.createTempFile("YaY", "YaY");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-434L), (-3280L));
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test25()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(dataInputStream0, 5246);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test26()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-193L), (-193L));
      stringReader0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test27()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(stringReader0, (CSVFormat) null, (-1L), 0L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("g\n", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("", "B}M7`|nv6h!q6RV");
      Charset charset0 = Charset.defaultCharset();
      try { 
