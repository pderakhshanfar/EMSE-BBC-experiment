...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-3780L), (-3780L));
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("KNv(X!4K", "~UU#g%dq<\"\"S6p!W");
      File file0 = MockFile.createTempFile("0]G3#u]K?@KMpq&h", "Oq%hc,Y", (File) mockFile0);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1200L), (-1200L));
      cSVParser0.nextRecord();
      cSVParser0.nextRecord();
      assertEquals((-1200L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse(")!B'^l9F]V ", cSVFormat0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("KNv(X!4K");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(" IgnoreHeaderCa&e:ig!orI\"", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test12()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("reader", "Xcf{Xl!Ai 7YvCl?2LW");
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("'9U`Q,>Hc<AX}Ys ", "'9U`Q,>Hc<AX}Ys ");
      Path path0 = mockFile0.toPath();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"?mMTIF1'2A>", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2), 421);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("3:AQL</!xBD");
      File file0 = MockFile.createTempFile("3:AQL</!xBD", "3:AQL</!xBD", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 575L, (-1L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 4063L, 13);
        fail("Expecting exception: IOException");
  ...
  public void test41()  throws Throwable  {
      StringReader stringReader0 = new StringReader(")>RD?vHNHle6oek");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      Class<QuoteMode> class0 = QuoteMode.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, 1719L, 1719L);
      cSVParser0.nextRecord();
      assertEquals(1719L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("org.apache.commons.csv.CSVFormat@0000000002,org.apache.commons.csv.CSVFormat@0000000002,org.apache.commons.csv.CSVFormat@0000000004,N,N", cSVFormat1);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The header contains a duplicate name: \"org.apache.commons.csv.CSVFormat@0000000002\" in [org.apache.commons.csv.CSVFormat@0000000002, org.apache.commons.csv.CSVFormat@0000000002, org.apache.commons.csv.CSVFormat@0000000004, N, N]
         //
         verifyException("org.apache.commons.csv.CSVParser", e);
      }
  }
  ...
  public void test48()  throws Throwable  {
      StringReader stringReader0 = new StringReader(">0l/,/+nPi%tX0-");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-708L), (-591L));
      long long0 = cSVParser0.getRecordNumber();
