...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, 992L);
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 0L, (-495L));
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, 271L, 271L);
      cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("tsp4");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("o1d~vYoM}=_");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 3023L, (-4439L));
      cSVParser0.nextRecord();
      assertEquals((-4439L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("`,O7qsD");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1863L), 1343L);
      cSVParser0.nextRecord();
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("./-|#hNHPHaw`{JN", cSVFormat0);
      cSVParser0.getRecords();
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("file", "url");
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      MockFile mockFile0 = new MockFile("`3p~Cf}C");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"ax5aY!I", cSVFormat1);
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      File file0 = MockFile.createTempFile("7kx8u~UUhrN_H(%", "7kx8u~UUhrN_H(%", (File) null);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile("4Pw`0e");
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test28()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, (-4439L), 1190L);
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader("u-tv]iucc*");
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, (CSVFormat) null, (-374L), (-374L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test36()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, (-1L), (-958L));
      cSVParser0.getRecords();
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      StringReader stringReader0 = new StringReader("`kAM5+KvFTd");
  ...
  public void test43()  throws Throwable  {
      ...
      stringArray0[4] = "juoR]Ji>*";
      stringArray0[5] = "n";
      stringArray0[6] = "hG++{{~fXs~ne7K";
      stringArray0[7] = "org.apache.commons.csv.Lexer";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("T{zc1eZkmh^AIWx-", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(")}gvx</Y\"E`", cSVFormat0);
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("4+V{mZ,", "4+V{mZ,");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test52()  throws Throwable  {
      StringReader stringReader0 = new StringReader("/#<%;U%j");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, 'X');
      cSVParser0.getCurrentLineNumber();
      assertEquals(87L, cSVParser0.getRecordNumber());
  }
