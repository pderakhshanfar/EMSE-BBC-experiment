...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("A |K<vupDsn");
      stringReader0.read();
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"java.io.StringReader@0000000010\",\"java.lang.Object@0000000011\"", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("(line", "A |K<vupDsn", (File) mockFile0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader(")]{{#8t,Q8A;w6u3`_");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("The escape character and the delimiter cannot be the same ('");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-2002L), (-334L));
      cSVParser0.nextRecord();
      assertEquals((-334L), cSVParser0.getRecordNumber());
  }
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      StringReader stringReader0 = new StringReader("A |K<vupDsn");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 0L, 4186L);
  ...
  public void test18()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      try { 
        CSVParser.parse("\"C60ZHE87taP3Ls1", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test26()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$1", "-i4v{Kc?_");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = CSVParser.parse("g^0-KC0?9iOVM", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, (-1056L), (-1056L));
        fail("Expecting exception: IOException");
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("_J", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test49()  throws Throwable  {
      StringReader stringReader0 = new StringReader("DEEr4hT-@AOZuxns;");
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
