...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("pw-.N'", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Q;HM5pxL$Wd&F");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 4218L, 4218L);
      cSVParser0.nextRecord();
      assertEquals(4218L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      StringReader stringReader0 = new StringReader("eo\"7^");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1L), (-2770L));
      cSVParser0.nextRecord();
      assertEquals((-2770L), cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\rZc\n", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile("\rZc\n", ":CN@j\"8K3I");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      try { 
  ...
  public void test17()  throws Throwable  {
      URL uRL0 = MockURL.URL("HTTP", "]", 1535, "Unexpected Token type: ");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      try { 
  ...
  public void test18()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("_UD4gmh_:~u", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      StringReader stringReader0 = new StringReader("_U4D4gmh_:~u");
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      PipedReader pipedReader0 = new PipedReader(1173);
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-234), 693);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile("_UD4gmh_:~u");
      File file0 = MockFile.createTempFile("w/@W:&CI_i:fZHq6t", "_UD4gmh_:~u", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat2, 317, 317);
        fail("Expecting exception: IOException");
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("JI", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test41()  throws Throwable  {
      ...
      Class<Proxy.Type> class0 = Proxy.Type.class;
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(class0);
      CSVParser cSVParser0 = CSVParser.parse("_UD4gmh_:~u", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test42()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVParser cSVParser0 = CSVParser.parse("_UD4gmh_:~u", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("hT9Vx@-}|", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("hT9Vx@-}|", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
