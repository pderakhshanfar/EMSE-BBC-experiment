...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(" SAg.|MssU8<I'?i", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(") invalid parse sequence", "The comment start character and the delimiter cannot be the same ('");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVParser cSVParser0 = CSVParser.parse("[m;I=s6]3g", cSVFormat0);
      cSVParser0.nextRecord();
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, (-2413L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("x}B)&XZ~Q$~TR)Q,i");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 4230L, (-1976L));
      cSVParser0.nextRecord();
      assertEquals((-1976L), cSVParser0.getRecordNumber());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 2313L, 0L);
      long long0 = cSVParser0.getRecordNumber();
      assertEquals((-1L), long0);
  }
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("hXx&_O7l|z4].^#1");
      Path path0 = mockFile0.toPath();
  ...
  public void test17()  throws Throwable  {
      ...
      stringArray0[0] = "<q(yT";
      stringArray0[2] = "x}B)&XZ~$~TR)Q,i";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreHeaderCase();
      // Undeclared exception!
      try { 
        CSVParser.parse("lW1M&:IOV", cSVFormat2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("eg6B'IRHyUo/FoQl", "<", (File) null);
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, 842L, 842L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 1L, (-2608L));
        fail("Expecting exception: IOException");
  ...
  public void test36()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("lW1M&:IOV", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      StringReader stringReader0 = new StringReader("x}B)&XZ~$~TR)Q,i");
      CSVFormat cSVFormat0 = CSVFormat.newFormat(']');
      RowSetMetaDataImpl rowSetMetaDataImpl0 = new RowSetMetaDataImpl();
      CSVFormat cSVFormat1 = cSVFormat0.withHeader((ResultSetMetaData) rowSetMetaDataImpl0);
  ...
  public void test45()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      File file0 = MockFile.createTempFile("x}B)&XZ~$~TR)Q,i", "x}B)&XZ~$~TR)Q,i");
