...
public class NameAnalyzer_ESTest extends NameAnalyzer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Node node0 = Node.newString((-569), "OVERALL STATS<ul>", (-569), (-569));
  ...
  public void test04()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("tb<7");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node[] nodeArray0 = new Node[1];
      nodeArray0[0] = node0;
  ...
  public void test05()  throws Throwable  {
      ...
      Node[] nodeArray0 = new Node[1];
      nodeArray0[0] = node0;
      Node node1 = new Node(119, nodeArray0);
      nameAnalyzer0.process(node0, node1);
  ...
  public void test07()  throws Throwable  {
      ...
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node1 = new Node(49, node0, node0, node0, 38, 118);
      nameAnalyzer0.process(node0, node1);
  ...
  public void test09()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("Haqpshing");
  ...
  public void test10()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseTestCode("com.gogle.javascript.jscomp.NameAnalzer$RemoveListener");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node[] nodeArray0 = new Node[1];
      nodeArray0[0] = node0;
      Node node1 = new Node(118, nodeArray0);
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         // com.gogle.javascript.jscomp.NameAnalzer$RemoveListener
  ...
  public void test12()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseTestCode("$FpyVIl=h");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      nameAnalyzer0.process(node0, node0);
      nameAnalyzer0.process(node0, node0);
