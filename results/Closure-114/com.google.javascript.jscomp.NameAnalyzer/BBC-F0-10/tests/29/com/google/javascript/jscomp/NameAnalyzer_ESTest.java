...
public class NameAnalyzer_ESTest extends NameAnalyzer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = new Node(119, 119, 2334);
      Node node1 = new Node(115, node0, node0, node0);
      Node node2 = new Node(115, node1, (-1807), 64);
  ...
  public void test03()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("Total CNames: ", 119, 119);
  ...
  public void test04()  throws Throwable  {
      Node node0 = new Node(114, 114, 248);
      Compiler compiler0 = new Compiler();
      // Undeclared exception!
      try { 
  ...
  public void test05()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(1315, "Total Names: ");
  ...
  public void test08()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = Node.newString(";Hg:t>]_()<Zf'", (-193), 1512);
  ...
  public void test09()  throws Throwable  {
      Node node0 = new Node(281, (-3549), 281);
      Compiler compiler0 = new Compiler();
  ...
  public void test10()  throws Throwable  {
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("oF_q>W:l(sE(NlBN");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFileOutputStream0, true);
      Compiler compiler0 = new Compiler(mockPrintStream0);
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = new Node((-3549), (-27), (-3549));
  ...
  public void test12()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseTestCode("windiw");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("xb^JUea7p");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test15()  throws Throwable  {
      Node node0 = new Node(281, (-3549), (-3505));
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      nameAnalyzer0.process(node0, node0);
