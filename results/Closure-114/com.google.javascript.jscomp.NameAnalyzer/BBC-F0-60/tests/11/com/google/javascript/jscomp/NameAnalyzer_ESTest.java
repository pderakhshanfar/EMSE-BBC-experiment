...
public class NameAnalyzer_ESTest extends NameAnalyzer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Node node0 = Node.newString(98, "m{[`cjG^)lXjv");
  ...
  public void test02()  throws Throwable  {
      ...
      Node node0 = Node.newString(0, "Sw05/4", 2716, (-1466));
      nameAnalyzer0.process(node0, node0);
      nameAnalyzer0.process(node0, node0);
  ...
  public void test03()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("4z+Du");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node1 = Node.newNumber((double) 0, 55, 55);
      Node node2 = new Node(114, node1, node0, node1, node0);
  ...
  public void test04()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "_oog");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
  ...
  public void test05()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "-?vg");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
  ...
  public void test09()  throws Throwable  {
      ...
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = Node.newString(0, "Sw05/4", 2716, (-1466));
      Node node1 = new Node(49, node0, 48, 4095);
  ...
  public void test10()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = compiler0.parseSyntheticCode("FALSE", "msg.got.syntax.errors");
  ...
  public void test12()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseTestCode("4+u");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node1 = new Node(118, node0, node0, node0, node0);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("}tDw)i~d1I{8Anu5=QB");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node1 = new Node(86, node0, node0, node0, node0);
      nameAnalyzer0.process(node0, node1);
