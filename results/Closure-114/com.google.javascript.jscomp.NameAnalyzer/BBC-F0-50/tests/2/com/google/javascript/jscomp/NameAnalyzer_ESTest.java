...
public class NameAnalyzer_ESTest extends NameAnalyzer_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      SyntheticAst syntheticAst0 = new SyntheticAst("l>8");
  ...
  public void test03()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseSyntheticCode("j.w=dw", "j.w=dw");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      nameAnalyzer0.process(node0, node0);
  ...
  public void test05()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      SyntheticAst syntheticAst0 = new SyntheticAst("?XcspLD*=}Gdn");
      Node node0 = syntheticAst0.getAstRoot(compiler0);
  ...
  public void test06()  throws Throwable  {
      ...
      LightweightMessageFormatter lightweightMessageFormatter0 = new LightweightMessageFormatter(compiler0);
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node1 = compiler0.parseSyntheticCode("window", "com.google.javascript.jscomp.NameAnalyzer$PrototypeSetNode");
      nameAnalyzer0.process(node0, node1);
      assertFalse(node1.isBreak());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((-195.31494823795205));
  ...
  public void test08()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = Node.newNumber((-14.75753870802625));
  ...
  public void test10()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      SyntheticAst syntheticAst0 = new SyntheticAst("javaException");
      Node node0 = syntheticAst0.getAstRoot(compiler0);
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
  ...
  public void test13()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node0 = Node.newNumber((-2644.9597));
  ...
  public void test14()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      SyntheticAst syntheticAst0 = new SyntheticAst("^Gv<S;-Yg{");
      Node node0 = syntheticAst0.getAstRoot(compiler0);
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
  ...
  public void test15()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = compiler0.parseTestCode("Expected ");
      Node node1 = new Node(118, node0);
      // Undeclared exception!
      try { 
        nameAnalyzer0.process(node0, node1);
  ...
  public void test16()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      SourceFile sourceFile0 = SourceFile.fromCode("$_", "$_");
  ...
  public void test18()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseSyntheticCode("n,w=ndw", "n,w=ndw");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      nameAnalyzer0.process(node0, node0);
  ...
  public void test19()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = Node.newNumber(4457.707440731926);
