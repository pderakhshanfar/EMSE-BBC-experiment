...
public class NameAnalyzer_ESTest extends NameAnalyzer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Node node0 = new Node(115, 154, 154);
  ...
  public void test02()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = Node.newString(154, "I", 154, 154);
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("K6Wg9zucN");
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("X^<<^s^NbK");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("winQow");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test08()  throws Throwable  {
      ...
      Node node1 = new Node(110, node0, node0, node0, node0, 30, 0);
      nameAnalyzer0.process(node0, node1);
  ...
  public void test12()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = new Node((-1791584229), 1448, 130);
      Node node1 = new Node(118, node0, node0, node0, node0, (-1459813984), (-2557));
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
  ...
  public void test13()  throws Throwable  {
      ...
      Node node1 = new Node(118, node0, node0, node0, node0, 439, (-1529));
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      // Undeclared exception!
      try { 
        nameAnalyzer0.process(node0, node1);
  ...
  public void test16()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseTestCode("w=inQow");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      nameAnalyzer0.process(node0, node0);
      String string0 = nameAnalyzer0.getHtmlReport();
