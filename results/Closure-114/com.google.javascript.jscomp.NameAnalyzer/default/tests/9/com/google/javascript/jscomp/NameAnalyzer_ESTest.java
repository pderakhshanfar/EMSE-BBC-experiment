...
public class NameAnalyzer_ESTest extends NameAnalyzer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node0 = compiler0.parseSyntheticCode(":Awv^_HdR=r7", "WS^Lw[Jl*g0lsq]");
  ...
  public void test02()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("com.google.javascript.jscomp.NameAnalyzer$FindReferences$NodeAccumulator");
  ...
  public void test04()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node0 = new Node(2625, 2625, 2625);
  ...
  public void test05()  throws Throwable  {
      ...
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node1 = new Node(108, node0, node0, node0, node0, 46, 48);
      nameAnalyzer0.process(node0, node1);
  ...
  public void test07()  throws Throwable  {
      ...
      Node node1 = new Node(118, node0, node0, node0, node0, 53, 4);
      // Undeclared exception!
      try { 
        nameAnalyzer0.process(node1, node1);
  ...
  public void test08()  throws Throwable  {
      ...
      Node node0 = Node.newString("");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node1 = new Node(118, node0, node0, node0, node0, 113, 56);
      nameAnalyzer0.process(node1, node1);
  ...
  public void test09()  throws Throwable  {
      ...
      Node node0 = Node.newString("com.google.javascript.jscomp.NameAnalyzer$FindReferences$NodeAccumulator");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node1 = new Node(147, node0, node0, node0, node0, 46, 48);
      // Undeclared exception!
      try { 
        nameAnalyzer0.process(node0, node1);
  ...
  public void test10()  throws Throwable  {
      ...
      Node node0 = Node.newString("com.google.javascript.jscomp.NameAnalyzer$FindReferences$NodeAccumulator");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node1 = new Node(86, node0, node0, node0, node0, 57, (-1967));
      nameAnalyzer0.process(node0, node1);
  ...
  public void test13()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node0 = compiler0.parseSyntheticCode("+9:u.M@g#n?zS?", "window");
      nameAnalyzer0.process(node0, node0);
      String string0 = nameAnalyzer0.getHtmlReport();
