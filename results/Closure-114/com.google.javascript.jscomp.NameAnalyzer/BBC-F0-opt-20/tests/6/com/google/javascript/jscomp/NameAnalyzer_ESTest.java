...
public class NameAnalyzer_ESTest extends NameAnalyzer_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseTestCode("com.google.javascript.jscomp.SyntacticScopeCreator");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      nameAnalyzer0.process(node0, node0);
      nameAnalyzer0.process(node0, node0);
  ...
  public void test03()  throws Throwable  {
      ...
      Node node1 = new Node(114, node0, 4095, (-2566));
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseSyntheticCode("yzLnnl-AQ", "yzLnnl-AQ");
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("yzLjnl-AQ");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test06()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = new Node(1530);
      Node node1 = new Node(49, node0, 29, 256);
  ...
  public void test07()  throws Throwable  {
      ...
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node1 = new Node(4, node0, 53, 30);
      nameAnalyzer0.process(node0, node1);
  ...
  public void test08()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = Node.newString((-1779), "Total Static Functions: ", (-4359), (-1720445328));
      Node node1 = new Node(118, node0, 16, 1513);
      nameAnalyzer0.process(node0, node1);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("goog.isObject");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
