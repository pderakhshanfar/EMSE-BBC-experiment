...
public class NameAnalyzer_ESTest extends NameAnalyzer_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Node node0 = compiler1.parseTestCode("[].join()");
  ...
  public void test04()  throws Throwable  {
      ...
      Node node0 = compiler0.parseTestCode("com.google.javascript.jscomp.DefaultPassConfig$56");
      nameAnalyzer0.process(node0, node0);
  ...
  public void test05()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString((-1269), "?");
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      nameAnalyzer0.process(node0, node0);
      nameAnalyzer0.process(node0, node0);
  ...
  public void test06()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Compiler compiler1 = new Compiler();
      Node node0 = compiler0.parseTestCode("com.google.java=cript.jscomp.NameAnalyzer$RemoveListener");
  ...
  public void test07()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node.newString("a", (-883), 18);
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("(new Boolean(true))");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("ZB");
      Node node1 = Node.newString("ZB");
  ...
  public void test09()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("k*{|8}<Du_-J");
  ...
  public void test11()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      SyntheticAst syntheticAst0 = new SyntheticAst("W)6");
      Node node0 = compiler0.parseTestCode("x3Qt3w;wE91T");
  ...
  public void test13()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(108, "", (-1281), 126);
  ...
  public void test14()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      SyntheticAst syntheticAst0 = new SyntheticAst("com");
  ...
  public void test15()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString((-1281), "q");
  ...
  public void test19()  throws Throwable  {
      ...
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      SyntheticAst syntheticAst0 = new SyntheticAst("B");
      Node node0 = compiler0.parseTestCode("Bi:vOy=R0Py6");
      nameAnalyzer0.process(node0, node0);
      String string0 = nameAnalyzer0.getHtmlReport();
