...
public class NameAnalyzer_ESTest extends NameAnalyzer_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      SourceFile sourceFile0 = SourceFile.fromGenerator("zjAZ[}{JWUfMg>", sourceFile_Generator0);
  ...
  public void test03()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = new Node((-1094492313));
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
  ...
  public void test06()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = new Node(1999, 1999, (-1488));
  ...
  public void test07()  throws Throwable  {
      ...
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node1 = new Node(110, node0, node0, 32, 43);
      nameAnalyzer0.process(node1, node1);
  ...
  public void test09()  throws Throwable  {
      ...
      Node node0 = new Node(108);
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      SyntheticAst syntheticAst0 = new SyntheticAst("0ZO?w%A");
  ...
  public void test11()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "phz~");
  ...
  public void test12()  throws Throwable  {
      ...
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node1 = new Node(27591, node0, node0, node0, node0);
      // Undeclared exception!
      try { 
        nameAnalyzer0.process(node1, node1);
        fail("Expecting exception: RuntimeException");
  ...
  public void test16()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "Og=g");
      nameAnalyzer0.process(node0, node0);
