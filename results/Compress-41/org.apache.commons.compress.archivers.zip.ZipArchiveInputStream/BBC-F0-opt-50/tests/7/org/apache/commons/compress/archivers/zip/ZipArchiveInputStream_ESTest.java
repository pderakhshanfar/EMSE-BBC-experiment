...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(dataInputStream0, "F4sMG");
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        ZipArchiveInputStream.matches((byte[]) null, 1855);
  ...
  public void test05()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-35), (byte)123);
  ...
  public void test06()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "ir", true, true);
      try { 
        zipArchiveInputStream0.getNextZipEntry();
  ...
  public void test07()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1805), (byte)33);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "ZD]O&=v*z04y2VSxc", false, false);
  ...
  public void test11()  throws Throwable  {
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)51, 4);
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "(JheX%@)%10Je}");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test12()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(sequenceInputStream0, "SETUID");
      byte[] byteArray0 = new byte[5];
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.read(byteArray0, (int) (byte)2, (int) (byte)86);
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      ...
      long long0 = zipArchiveInputStream0.skip(1476);
      assertEquals(0L, long0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(sequenceInputStream0, "bx:bm", false);
      zipArchiveInputStream0.close();
      zipArchiveInputStream0.close();
      assertEquals(0, zipArchiveInputStream0.getCount());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, (String) null, true);
      MockFile mockFile0 = new MockFile("org.apache.commons.compress.archivers.zip.ZipArchiveInputStream$CurrentEntry", "UTF8");
  ...
  public void test26()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(mockFileInputStream0);
      byte[] byteArray0 = new byte[5];
      int int0 = zipArchiveInputStream0.read(byteArray0, (int) (byte)80, 1476);
      assertEquals((-1), int0);
  }
}
