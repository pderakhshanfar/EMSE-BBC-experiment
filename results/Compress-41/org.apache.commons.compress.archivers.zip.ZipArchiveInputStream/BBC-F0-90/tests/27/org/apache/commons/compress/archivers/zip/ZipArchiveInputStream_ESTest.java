...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        ZipArchiveInputStream.matches((byte[]) null, 1559);
  ...
  public void test08()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-143), 30);
  ...
  public void test12()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, ", fileType=");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test13()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.read(byteArray0, 2572, 2145382391);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      ...
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(enumeration0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(sequenceInputStream0);
      int int0 = zipArchiveInputStream0.read(byteArray0, 16, 1275);
      assertEquals((-1), int0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.skip((-1948L));
  ...
  public void test21()  throws Throwable  {
      PipedInputStream pipedInputStream0 = new PipedInputStream(1275);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "CRC32", true);
      zipArchiveInputStream0.close();
      zipArchiveInputStream0.close();
  ...
  public void test22()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.skip(1275);
        fail("Expecting exception: IOException");
  ...
  public void test23()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      long long0 = zipArchiveInputStream0.skip(212L);
      assertEquals(0L, long0);
  }
  ...
  public void test24()  throws Throwable  {
      byte[] byteArray0 = new byte[42];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("8jU5kY>CGs|Q");
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
