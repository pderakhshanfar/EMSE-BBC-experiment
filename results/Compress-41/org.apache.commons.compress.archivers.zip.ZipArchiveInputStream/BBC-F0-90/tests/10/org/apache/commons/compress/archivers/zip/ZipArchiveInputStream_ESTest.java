...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      int int0 = zipArchiveInputStream0.read(byteArray0, (int) (byte)0, (int) (byte)1);
      assertEquals((-1), int0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        ZipArchiveInputStream.matches((byte[]) null, 1127);
  ...
  public void test08()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1656), (byte)80);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextZipEntry();
  ...
  public void test10()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-303), (byte)80);
  ...
  public void test13()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(mockFileInputStream0, "RC2pre52", false);
      try { 
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = new byte[8];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)92, (byte)62);
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "not encodeable", true, true);
  ...
  public void test16()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "zM\b-U.rm3nH.kR", false);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test17()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "9Lf>K/=a`Ve!D]");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test20()  throws Throwable  {
      ...
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, 4148);
      assertFalse(boolean0);
  }
  ...
  public void test21()  throws Throwable  {
      byte[] byteArray0 = new byte[8];
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, (-4929));
      assertFalse(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 140, 16);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      zipArchiveInputStream0.close();
      zipArchiveInputStream0.close();
  ...
  public void test25()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.skip(4108L);
        fail("Expecting exception: IOException");
  ...
  public void test27()  throws Throwable  {
      ArArchiveEntry arArchiveEntry0 = new ArArchiveEntry("", (byte)113, 26, (byte)123, (byte)123, (byte)35);
      PipedOutputStream pipedOutputStream0 = new PipedOutputStream();
