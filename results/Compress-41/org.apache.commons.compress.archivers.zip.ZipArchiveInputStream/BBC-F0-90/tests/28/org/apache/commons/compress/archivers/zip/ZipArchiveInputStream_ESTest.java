...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        ZipArchiveInputStream.matches((byte[]) null, 5419);
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ZipArchiveInputStream.matches(byteArray0, 5419);
  ...
  public void test07()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-36), 237);
  ...
  public void test12()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "1@q.34");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        zipArchiveInputStream0.read(byteArray0, 30, 508);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = new byte[7];
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, (-688));
      assertFalse(boolean0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)25, 2346);
  ...
  public void test18()  throws Throwable  {
      PipedOutputStream pipedOutputStream0 = new PipedOutputStream();
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0, 1898);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.skip((-2183L));
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 2078209981, (byte)2);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      zipArchiveInputStream0.close();
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 2078209981, (byte)2);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      int int0 = zipArchiveInputStream0.read(byteArray0, 30, (-1976));
      assertEquals((-1), int0);
  }
  ...
  public void test24()  throws Throwable  {
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)96, 383);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      TarArchiveEntry tarArchiveEntry0 = new TarArchiveEntry("Stream is not in the BZip2 format", (byte)2);
