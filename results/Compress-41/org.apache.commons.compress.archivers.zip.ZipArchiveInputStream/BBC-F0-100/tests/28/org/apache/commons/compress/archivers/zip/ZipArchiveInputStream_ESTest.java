...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 3064, (byte) (-128));
  ...
  public void test03()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 3064, (byte) (-128));
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, (String) null, true);
      int int0 = zipArchiveInputStream0.read(byteArray0, (-2147483647), 170);
      assertEquals((-1), int0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        ZipArchiveInputStream.matches((byte[]) null, (byte)53);
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ZipArchiveInputStream.matches(byteArray0, 1412);
  ...
  public void test08()  throws Throwable  {
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-128), 31);
  ...
  public void test11()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-917), 1544);
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = new byte[6];
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, (-2145543734));
      assertFalse(boolean0);
  }
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = new byte[8];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)119, 92);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, (String) null, true);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.skip((-4288L));
  ...
  public void test21()  throws Throwable  {
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 170, 31);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, (String) null, true);
      zipArchiveInputStream0.close();
      zipArchiveInputStream0.close();
      assertEquals(0, zipArchiveInputStream0.getCount());
  ...
  public void test22()  throws Throwable  {
      ...
      try { 
        zipArchiveInputStream0.read(byteArray0, 119, 0);
        fail("Expecting exception: IOException");
