...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        ZipArchiveInputStream.matches((byte[]) null, 209);
  ...
  public void test05()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-62), 6);
  ...
  public void test11()  throws Throwable  {
      ...
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("L%[V7");
  ...
  public void test13()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "/&T(jesK", true);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test14()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream1 = new ZipArchiveInputStream(zipArchiveInputStream0, "`{1|GrSBHsaba`");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test15()  throws Throwable  {
      ...
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(mockFileInputStream0);
      int int0 = zipArchiveInputStream0.read((byte[]) null, 0, (-2662));
      assertEquals((-1), int0);
  }
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = new byte[7];
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, (-853));
      assertFalse(boolean0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(enumeration0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(sequenceInputStream0, (String) null, false, true);
      long long0 = zipArchiveInputStream0.skip(990L);
  ...
  public void test22()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.read(byteArray0, 3, 4);
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      ...
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(mockFileInputStream0);
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("`75tL+");
