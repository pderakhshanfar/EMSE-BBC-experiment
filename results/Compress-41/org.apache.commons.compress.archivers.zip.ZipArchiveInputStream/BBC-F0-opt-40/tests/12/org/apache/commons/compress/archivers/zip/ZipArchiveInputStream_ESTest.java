...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, 4610);
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)6, (-429));
      ...
      int int0 = zipArchiveInputStream0.read(byteArray0, 8, (int) (byte)70);
      assertEquals((-1), int0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        zipArchiveInputStream0.read(byteArray0, (int) (byte)46, (int) (byte)113);
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        ZipArchiveInputStream.matches(byteArray0, 2145367900);
  ...
  public void test11()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "g9n`", false, false);
  ...
  public void test12()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pushbackInputStream0, "iDDyyCA{*`Jx'*U", false);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test13()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pushbackInputStream0, "WCv2]-G0+3vT-yL");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test18()  throws Throwable  {
      // Undeclared exception!
      try { 
        ZipArchiveInputStream.matches((byte[]) null, 3755);
        fail("Expecting exception: NullPointerException");
  ...
  public void test22()  throws Throwable  {
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)6, 25461);
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(byteArrayInputStream0, byteArrayInputStream0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(sequenceInputStream0, (String) null, false);
      zipArchiveInputStream0.close();
      zipArchiveInputStream0.close();
  ...
  public void test24()  throws Throwable  {
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)0, 979);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
