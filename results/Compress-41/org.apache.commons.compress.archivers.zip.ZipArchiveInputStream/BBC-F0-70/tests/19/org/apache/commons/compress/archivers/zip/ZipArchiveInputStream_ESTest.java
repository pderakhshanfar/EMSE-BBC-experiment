...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ZipArchiveInputStream.matches(byteArray0, 397);
  ...
  public void test06()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1456), 177);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextZipEntry();
  ...
  public void test08()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-73), (byte)3);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextEntry();
  ...
  public void test09()  throws Throwable  {
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream((InputStream) null, 1412);
  ...
  public void test10()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "org.apache.commons.compress.archivers.dump.DumpArchiveEntry$TapeSegmentHeader", true, false);
  ...
  public void test11()  throws Throwable  {
      File file0 = MockFile.createTempFile("2oui]", "l*R");
  ...
  public void test12()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "T#(wc.SQ!}Mk");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test13()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[4];
      try { 
        zipArchiveInputStream0.read(byteArray0, (int) (byte) (-69), 2529);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[6];
      int int0 = zipArchiveInputStream0.read(byteArray0, 1950, (int) (byte) (-63));
      assertEquals((-1), int0);
  }
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = new byte[4];
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, (-2901));
      assertFalse(boolean0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.skip((-1457L));
  ...
  public void test20()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-102), 1455);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "org.apache.commons.compress.archivers.zip.UnsupportedZipFeatureException", false);
      zipArchiveInputStream0.close();
      zipArchiveInputStream0.close();
  ...
  public void test21()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.skip(1366L);
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("zhbp >");
