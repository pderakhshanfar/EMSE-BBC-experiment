...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0, 1502);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "Xd2XIt", true, false);
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.skip(1502L);
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        ZipArchiveInputStream.matches((byte[]) null, 9484);
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-797), 2129437566);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "gd", false);
      try { 
        zipArchiveInputStream0.getNextEntry();
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, ",^2~D3e2`YhYep9D1[", false, true);
  ...
  public void test13()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "lqs", true, true);
  ...
  public void test14()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "eZU^(B_EyfA U5x/");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test15()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "lqs", true, true);
      byte[] byteArray0 = new byte[4];
      int int0 = zipArchiveInputStream0.read(byteArray0, (-2145824076), 52);
      assertEquals((-1), int0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, 1854);
      assertFalse(boolean0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "org.apache.commons.compress.archivers.zip.ZipArchiveInputStream");
      long long0 = zipArchiveInputStream0.skip(320);
      assertEquals(0L, long0);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(bufferedInputStream0, "DES", false, false);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "Xd2XIt", false, false);
      zipArchiveInputStream0.close();
      zipArchiveInputStream0.close();
  ...
  public void test23()  throws Throwable  {
      ...
      try { 
        zipArchiveInputStream0.read(byteArray0, 0, 3865);
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1993), (byte)48);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextEntry();
