...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        ZipArchiveInputStream.matches((byte[]) null, 800);
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = new byte[41];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2146801906), 874);
  ...
  public void test08()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2882), 3076);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "org.apache.commons.compress.archivers.zip.ExplodingInputStream", true, true);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "KR\u0000*~k5|o&5REK29", true);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test15()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.read(byteArray0, (int) (byte)16, (int) (byte)0);
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2882), 3076);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "org.apache.commons.compress.archivers.zip.ExplodingInputStream", true, true);
      int int0 = zipArchiveInputStream0.read(byteArray0, 3076, 20);
      assertEquals((-1), int0);
  }
  ...
  public void test18()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, (-1232));
      assertFalse(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      ArArchiveEntry arArchiveEntry0 = new ArArchiveEntry((String) null, (byte) (-81), (byte) (-81), (byte)17, (-3381), 1190L);
  ...
  public void test28()  throws Throwable  {
      DataInputStream dataInputStream0 = new DataInputStream((InputStream) null);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(dataInputStream0);
      long long0 = zipArchiveInputStream0.skip(2451L);
      assertEquals(0L, long0);
  }
}
