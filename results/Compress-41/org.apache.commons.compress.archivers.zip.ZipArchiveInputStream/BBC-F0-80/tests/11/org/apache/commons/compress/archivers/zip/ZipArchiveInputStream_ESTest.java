...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "EXPANDING_LEVEL_1", false);
  ...
  public void test04()  throws Throwable  {
      ...
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0, 912);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0);
      byte[] byteArray0 = new byte[8];
      int int0 = zipArchiveInputStream0.read(byteArray0, (int) (byte)82, (int) (byte)0);
      assertEquals((-1), int0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        ZipArchiveInputStream.matches((byte[]) null, 1201);
  ...
  public void test08()  throws Throwable  {
      byte[] byteArray0 = new byte[15];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1), 392);
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = new byte[15];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-18), 392);
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(byteArrayInputStream0, byteArrayInputStream0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(sequenceInputStream0);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "1CMYQm", false, false);
      try { 
        zipArchiveInputStream0.getNextEntry();
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("h ERWEt", "h ERWEt");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      DataInputStream dataInputStream0 = new DataInputStream(mockFileInputStream0);
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(dataInputStream0, "Y?1Pj9(uGAPz", false, false);
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = new byte[8];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 3, 1812);
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        zipArchiveInputStream0.read(byteArray0, 999, 3);
        fail("Expecting exception: IOException");
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(byteArrayInputStream0, 800);
  ...
  public void test22()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "EXPANDING_LEVEL_1");
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.skip((-1723L));
  ...
  public void test24()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.skip(2028L);
        fail("Expecting exception: IOException");
