...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2126834765), (-2126834765));
  ...
  public void test09()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2576), 2145355319);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "YB", true);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextEntry();
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test14()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "UA:3 PLXt1\"Ru^#");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test16()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pushbackInputStream0, "V");
      zipArchiveInputStream0.close();
  ...
  public void test18()  throws Throwable  {
      byte[] byteArray0 = new byte[6];
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, (-2589));
      assertFalse(boolean0);
  }
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-107), (-904));
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
  ...
  public void test23()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.read(byteArray0, 176, 3);
        fail("Expecting exception: IOException");
  ...
  public void test26()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(byteArrayInputStream0, (byte)99);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pushbackInputStream0, "V");
      MockFile mockFile0 = new MockFile("", "This archive needs a preset dictionary which is not supported by Commons Compress.");
      ArArchiveEntry arArchiveEntry0 = new ArArchiveEntry(mockFile0, "@Ov\"6mVN1bKl `Q");
