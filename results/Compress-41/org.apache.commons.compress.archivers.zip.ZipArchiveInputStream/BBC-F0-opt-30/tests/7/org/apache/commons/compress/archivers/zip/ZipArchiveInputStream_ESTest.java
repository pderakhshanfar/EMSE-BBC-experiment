...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-3473), (-2691));
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ZipArchiveInputStream.matches(byteArray0, 764);
  ...
  public void test08()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1983), 26);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextZipEntry();
  ...
  public void test11()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-3473), 2296);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextEntry();
  ...
  public void test13()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "Truncated ZIP entry: ", true);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test14()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(dataInputStream0, "%3");
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test15()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[9];
      try { 
        zipArchiveInputStream0.read(byteArray0, (-2135812540), (-631));
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = new byte[8];
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null);
      int int0 = zipArchiveInputStream0.read(byteArray0, (-40), (-40));
      assertEquals((-1), int0);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.skip((-2691));
  ...
  public void test23()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "UNKNOWN", true, true);
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.skip(2393);
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      ...
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("@lMH_XxOOc");
  ...
  public void test25()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "PKWARE_IMPLODING", true, true);
      ArArchiveEntry arArchiveEntry0 = new ArArchiveEntry("PKWARE_IMPLODING", (byte)40);
