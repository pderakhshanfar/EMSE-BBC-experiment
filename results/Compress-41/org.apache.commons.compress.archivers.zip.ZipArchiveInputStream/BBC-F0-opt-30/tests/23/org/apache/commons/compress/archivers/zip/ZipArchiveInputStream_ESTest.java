...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      int int0 = zipArchiveInputStream0.read(byteArray0, (int) (byte) (-91), (-1570));
      assertEquals((-1), int0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "rl");
      zipArchiveInputStream0.close();
      try { 
        zipArchiveInputStream0.skip(652L);
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ZipArchiveInputStream.matches(byteArray0, 2146037531);
  ...
  public void test07()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "ut", true, true);
      try { 
        zipArchiveInputStream0.getNextZipEntry();
        fail("Expecting exception: IOException");
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2787), 198);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        zipArchiveInputStream0.getNextEntry();
  ...
  public void test10()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(mockFileInputStream0, "6", false);
      try { 
        zipArchiveInputStream0.getNextEntry();
        fail("Expecting exception: IOException");
  ...
  public void test11()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(sequenceInputStream0, "org.apache.commons.compress.archivers.zip.ZipArchiveInputStream$CurrentEntry", true, true);
  ...
  public void test12()  throws Throwable  {
      ...
      try {
        zipArchiveInputStream1 = new ZipArchiveInputStream(zipArchiveInputStream0, "6Ju#ih.1[BBH,F", true);
        fail("Expecting exception: IllegalCharsetNameException");
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2120971503), (byte)20);
