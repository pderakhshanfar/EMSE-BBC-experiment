...
public class AbstractCategoryItemRenderer_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.Connection", false, AbstractCategoryItemRenderer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, AbstractCategoryItemRenderer_ESTest_scaffolding.class.getClassLoader()));
  }
