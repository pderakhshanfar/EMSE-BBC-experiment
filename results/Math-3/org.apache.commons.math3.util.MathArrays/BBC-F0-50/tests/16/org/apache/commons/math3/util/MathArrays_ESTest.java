...
public class MathArrays_ESTest extends MathArrays_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      doubleArray0[0] = 1434.5896681;
      doubleArray0[1] = 3.834E-20;
      doubleArray0[2] = 0.167;
      doubleArray0[3] = 4182.0;
      doubleArray0[4] = 3.834E-20;
      doubleArray0[5] = (-3706.15);
  ...
  public void test002()  throws Throwable  {
      ...
      assertFalse(doubleArray3.equals((Object)doubleArray0));
      assertFalse(doubleArray3.equals((Object)doubleArray1));
      assertArrayEquals(new double[] {1.34217729E8, 1.34217729E8, 1.34217729E8, 1.34217729E8, 1.34217729E8, 1.34217729E8}, doubleArray3, 0.01);
      assertNotSame(doubleArray3, doubleArray0);
      assertNotSame(doubleArray3, doubleArray1);
      
      // Undeclared exception!
      try { 
        MathArrays.buildArray(field0, (-397));
  ...
  public void test003()  throws Throwable  {
      ...
      doubleArray0[1] = 1160.075010119589;
      doubleArray0[2] = 3340.7;
      doubleArray0[3] = 2029.0;
  ...
  public void test004()  throws Throwable  {
      ...
      intArray0[0] = 2146916880;
      intArray0[1] = (-2731);
      intArray0[2] = 114;
      intArray0[3] = 2105;
      intArray0[4] = (-2145711795);
      ...
      assertEquals((-2331883), int0);
      assertFalse(intArray0.equals((Object)intArray1));
      assertFalse(intArray1.equals((Object)intArray0));
      assertArrayEquals(new int[] {2146916880, (-2731), 114, 2105, (-2145711795)}, intArray0);
      assertArrayEquals(new int[] {114, 2105, 2105, (-651), (-2731)}, intArray1);
  ...
  public void test005()  throws Throwable  {
      ...
      assertFalse(boolean0);
      assertArrayEquals(new float[] {0.0F, 1.4E-45F, 1.0F, 1332.109F, Float.NEGATIVE_INFINITY, (-777.0F), Float.NaN}, floatArray0, 0.01F);
      
      double[] doubleArray0 = new double[9];
      doubleArray0[0] = (double) 1.0F;
      doubleArray0[1] = (double) Float.NaN;
      doubleArray0[2] = 4203.6367671487;
      doubleArray0[3] = (double) (-777.0F);
  ...
  public void test006()  throws Throwable  {
      Double[] doubleArray0 = new Double[8];
      Double double0 = new Double((-1324.0));
      ...
      assertEquals(8, doubleArray0.length);
      assertEquals((-1324.0), (double)double1, 0.01);
      assertEquals((double)double1, (double)double0, 0.01);
      assertNotNull(double1);
      
      doubleArray0[1] = double1;
      Double double2 = new Double(1.86285714285714278E18);
      assertEquals(1.86285714285714278E18, (double)double2, 0.01);
      ...
      assertEquals(8, doubleArray0.length);
      assertEquals((-1324.0), (double)double3, 0.01);
      ...
      Double double4 = new Double((-247.1));
      assertEquals((-247.1), (double)double4, 0.01);
      ...
      assertEquals(8, doubleArray0.length);
      assertEquals((-1324.0), (double)double5, 0.01);
      ...
      Double double7 = new Double((-2630.393413));
      assertEquals((-2630.393413), (double)double7, 0.01);
      ...
      assertEquals(1.86285714285714278E18, double8, 0.01);
      assertArrayEquals(new double[] {(-2630.393413), (-1324.0), (-1324.0), (-1324.0), (-1324.0), 1.86285714285714278E18, (-1324.0)}, doubleArray1, 0.01);
  }
  ...
  public void test007()  throws Throwable  {
      ...
      double[] doubleArray3 = MathArrays.copyOf(doubleArray1, 1702);
      assertEquals(8, doubleArray0.length);
      assertEquals(8, doubleArray1.length);
      assertEquals(1702, doubleArray3.length);
      assertFalse(doubleArray0.equals((Object)doubleArray1));
      assertFalse(doubleArray1.equals((Object)doubleArray0));
      assertFalse(doubleArray3.equals((Object)doubleArray0));
      assertFalse(doubleArray3.equals((Object)doubleArray1));
  ...
  public void test010()  throws Throwable  {
      double[] doubleArray0 = new double[8];
      Class<FieldElement> class0 = FieldElement.class;
      Integer integer0 = Integer.valueOf(2147483632);
      assertEquals(2147483632, (int)integer0);
      assertNotNull(integer0);
      
      Double double0 = new Double(1685.0);
      assertEquals(1685.0, (double)double0, 0.01);
      assertNotNull(double0);
      
      Field<Object> field0 = (Field<Object>) mock(Field.class, new ViolatedAssumptionAnswer());
      doReturn(class0).when(field0).getRuntimeClass();
      // Undeclared exception!
      MathArrays.buildArray(field0, 2146661801, 2146661801);
  }
  ...
  public void test128()  throws Throwable  {
      ...
      MathArrays.linearCombination(1300.3266732021, 3302.091306, (-2076.86445665705), Double.NEGATIVE_INFINITY);
      MathArrays.linearCombination(Double.NEGATIVE_INFINITY, 335.0, (-2076.86445665705), (double) 1.4E-45F, (-2076.86445665705), 2018.2203645145523);
  ...
  public void test142()  throws Throwable  {
      ...
      doubleArray0[2] = 406.834061809943;
      doubleArray0[3] = 49.9649739272;
      MathArrays.scale(49.9649739272, doubleArray0);
  ...
  public void test146()  throws Throwable  {
      ...
      MathArrays.distance1(doubleArray0, doubleArray0);
      float[] floatArray0 = new float[8];
      double double0 = MathArrays.linearCombination((-457.2927), 0.0, 0.0, (-3.9986783938944604E-8), 0.0, 1.34217729E8, (-166.3722837569), 0.01756829337984201);
      assertEquals((-2.922877091315543), double0, 0.01);
  ...
  public void test149()  throws Throwable  {
      MathArrays.linearCombination(769.5995474033691, 769.5995474033691, 0.0, 1455.5556371, Double.NaN, 159.785891, 769.5995474033691, (-1.0));
      double[] doubleArray0 = new double[2];
      doubleArray0[0] = 0.0;
      doubleArray0[1] = Double.NaN;
      MathArrays.checkOrder(doubleArray0);
  ...
  public void test152()  throws Throwable  {
      ...
      doubleArray0[0] = 0.0;
      doubleArray0[1] = Double.NEGATIVE_INFINITY;
      MathArrays.linearCombination(0.0, 970.822134865, 2012.7102038, 89.59);
      MathArrays.equals(doubleArray0, doubleArray0);
  ...
  public void test155()  throws Throwable  {
      MathArrays.linearCombination(3.834E-20, 3.834E-20, 3.834E-20, (-256.049331805719));
      int[] intArray0 = new int[4];
      intArray0[0] = 0;
      intArray0[1] = 0;
      int int0 = 1374;
  ...
  public void test157()  throws Throwable  {
      MathArrays.OrderDirection.values();
      MathArrays.linearCombination(2571.6, 2571.6, 2571.6, (-804.1513988), 0.0, 657.7576996, (-1239.36987135871), (-1177.968663698));
      // Undeclared exception!
      try { 
        MathArrays.distanceInf((int[]) null, (int[]) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test170()  throws Throwable  {
      ...
      double double0 = MathArrays.linearCombination((double) 1782.8147F, (-1232.9899704), Double.NaN, 2290.8);
      assertEquals(Double.NaN, double0, 0.01);
  }
  ...
  public void test191()  throws Throwable  {
      double[] doubleArray0 = new double[0];
      double double0 = 1953.046277;
      double double1 = 2942.256556723755;
      MathArrays.OrderDirection mathArrays_OrderDirection0 = MathArrays.OrderDirection.INCREASING;
      // Undeclared exception!
      try { 
        MathArrays.isMonotonic(doubleArray0, mathArrays_OrderDirection0, true);
