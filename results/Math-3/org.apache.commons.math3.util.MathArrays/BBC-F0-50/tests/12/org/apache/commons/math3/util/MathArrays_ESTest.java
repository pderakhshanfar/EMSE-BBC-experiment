...
public class MathArrays_ESTest extends MathArrays_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      Integer integer0 = new Integer(2142646973);
      assertEquals(2142646973, (int)integer0);
      ...
      MathArrays.buildArray(field0, 2142646973, 51);
  }
  ...
  public void test001()  throws Throwable  {
      ...
      floatArray0[4] = 0.0F;
      floatArray0[5] = 1.0F;
      floatArray0[6] = 654.2F;
      boolean boolean1 = MathArrays.equalsIncludingNaN(floatArray0, floatArray0);
      assertTrue(boolean1);
      assertEquals(7, floatArray0.length);
      assertTrue(boolean1 == boolean0);
      assertArrayEquals(new float[] {0.0F, 0.0F, -0.0F, 0.0F, 0.0F, 1.0F, 654.2F}, floatArray0, 0.01F);
      
      double[] doubleArray1 = MathArrays.copyOf(doubleArray0, 5855);
      assertEquals(0, doubleArray0.length);
      assertEquals(5855, doubleArray1.length);
      ...
      doubleArray2[0] = (double) 654.2F;
      doubleArray2[1] = (double) 0.0F;
      doubleArray2[2] = (double) 0.0F;
      doubleArray2[3] = 5825.638;
  ...
  public void test003()  throws Throwable  {
      ...
      assertArrayEquals(new float[] {0.0F, 1.0F, 1.0F, 1.0F, 0.0F, 1.4E-45F, 0.0F, (-1.0F)}, floatArray0, 0.01F);
      ...
      assertArrayEquals(new double[] {0.0, 1.401298464324817E-45, 0.0, 1.401298464324817E-45}, doubleArray0, 0.01);
  }
  ...
  public void test005()  throws Throwable  {
      ...
      doubleArray2[0] = 3.351531544241447E-16;
      doubleArray2[1] = 1137.962786576855;
      ...
      assertFalse(doubleArray2.equals((Object)doubleArray1));
      assertFalse(doubleArray2.equals((Object)doubleArray0));
      assertArrayEquals(new double[] {3.351531544241447E-16, 1137.962786576855}, doubleArray2, 0.01);
      
      try { 
        MathArrays.normalizeArray(doubleArray1, 3.351531544241447E-16);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test007()  throws Throwable  {
      ...
      assertFalse(intArray1.equals((Object)intArray0));
      assertArrayEquals(new int[] {0, 110, 134217729, (-1982292597), (-5493)}, intArray0);
      assertArrayEquals(new int[] {134217729, 0, 110, 110, (-5493), 0, 134217729, 0}, intArray1);
      
      Integer[] integerArray0 = new Integer[6];
      integerArray0[0] = (Integer) 134217729;
      integerArray0[1] = (Integer) 134217729;
      integerArray0[2] = (Integer) 134217729;
      Integer integer0 = new Integer((-1982292597));
      assertEquals((-1982292597), (int)integer0);
      assertNotNull(integer0);
      assertFalse(integer0.equals((Object)int0));
      
      integerArray0[3] = integer0;
      integerArray0[4] = (Integer) (-5493);
      integerArray0[5] = (Integer) (-1982292597);
      MathArrays.OrderDirection mathArrays_OrderDirection0 = MathArrays.OrderDirection.INCREASING;
  ...
  public void test008()  throws Throwable  {
      ...
      doubleArray0[0] = (-2062.6550482);
      doubleArray0[1] = 3.834E-20;
      double[] doubleArray1 = new double[2];
      assertFalse(doubleArray1.equals((Object)doubleArray0));
      
      doubleArray1[0] = (-2062.6550482);
      ...
      assertFalse(doubleArray2.equals((Object)doubleArray0));
      assertFalse(doubleArray2.equals((Object)doubleArray1));
      assertArrayEquals(new double[] {(-2062.6550482), 3.834E-20}, doubleArray0, 0.01);
      assertArrayEquals(new double[] {(-2062.6550482), 3.834E-20}, doubleArray1, 0.01);
      assertArrayEquals(new double[] {4254545.847864944, (-1.5816438909597597E-16), 1.4699556E-39}, doubleArray2, 0.01);
      ...
      assertArrayEquals(new double[] {(-2062.6550482), 3.834E-20}, doubleArray1, 0.01);
      assertArrayEquals(new double[] {(-4125.3100964), 7.668E-20}, doubleArray3, 0.01);
      
      double double0 = MathArrays.safeNorm(doubleArray2);
      assertEquals(4254545.847864944, double0, 0.01);
      assertEquals(2, doubleArray0.length);
      assertEquals(2, doubleArray1.length);
      assertEquals(3, doubleArray2.length);
      assertNotSame(doubleArray0, doubleArray2);
  ...
  public void test009()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        MathArrays.buildArray(field0, 2, 10);
  ...
  public void test019()  throws Throwable  {
      ...
      floatArray0[1] = (-2140.7136F);
      floatArray0[2] = 0.0F;
      floatArray0[3] = Float.NaN;
      boolean boolean0 = MathArrays.equals(floatArray0, floatArray0);
      assertFalse(boolean0);
      assertEquals(4, floatArray0.length);
      assertArrayEquals(new float[] {3.4028235E38F, (-2140.7136F), 0.0F, Float.NaN}, floatArray0, 0.01F);
      
      double[] doubleArray0 = new double[6];
      doubleArray0[0] = (double) (-2140.7136F);
      doubleArray0[1] = (double) (-2140.7136F);
      ...
      assertNotSame(doubleArray1, doubleArray0);
      assertFalse(doubleArray1.equals((Object)doubleArray0));
      assertArrayEquals(new double[] {(-2140.713623046875), (-2140.713623046875), Double.NaN, 3.4028234663852886E38, Double.NaN, 0.0}, doubleArray0, 0.01);
      assertArrayEquals(new double[] {(-2140.713623046875), (-2140.713623046875), Double.NaN, 3.4028234663852886E38, Double.NaN, 0.0}, doubleArray1, 0.01);
      
      double[] doubleArray2 = MathArrays.normalizeArray(doubleArray1, (-2140.713623046875));
      assertEquals(6, doubleArray0.length);
      assertEquals(6, doubleArray1.length);
      assertEquals(6, doubleArray2.length);
      assertNotNull(doubleArray2);
      ...
      assertArrayEquals(new double[] {(-2140.713623046875), (-2140.713623046875), Double.NaN, 3.4028234663852886E38, Double.NaN, 0.0}, doubleArray0, 0.01);
      assertArrayEquals(new double[] {(-2140.713623046875), (-2140.713623046875), Double.NaN, 3.4028234663852886E38, Double.NaN, 0.0}, doubleArray1, 0.01);
      assertArrayEquals(new double[] {1.346721292235147E-32, 1.346721292235147E-32, Double.NaN, (-2140.713623046875), Double.NaN, -0.0}, doubleArray2, 0.01);
  }
  ...
  public void test131()  throws Throwable  {
      ...
      doubleArray0[3] = double3;
      double double4 = MathArrays.linearCombination(1089.9249271698632, (double) doubleArray0[1], 2011.0, 160.0, (-38.13201065), (double) doubleArray0[3]);
      assertEquals(1.411695783935826E11, double4, 0.01);
      assertEquals(9, doubleArray0.length);
  ...
  public void test132()  throws Throwable  {
      ...
      assertEquals(88.1908, (double)double2, 0.01);
      assertNotNull(double2);
      assertNotEquals((double)double2, (double)double0, 0.01);
      assertNotEquals((double)double2, (double)double1, 0.01);
      ...
      assertEquals((-1975.4278039), (double)double4, 0.01);
      assertNotNull(double4);
      assertNotEquals((double)double4, (double)double2, 0.01);
      assertNotEquals((double)double4, (double)double3, 0.01);
      assertNotEquals((double)double4, (double)double0, 0.01);
  ...
  public void test133()  throws Throwable  {
      ...
      doubleArray0[1] = 6.283185307179586;
      double double1 = 0.0;
      double double2 = MathArrays.linearCombination((-38.13201065), 730.2916870117188, (-38.13201065), 0.0, 0.375, 1.0);
      assertEquals((-27847.115386737325), double2, 0.01);
      assertNotEquals(double2, double0, 0.01);
      assertNotEquals(double2, double1, 0.01);
  ...
  public void test134()  throws Throwable  {
      ...
      assertEquals(0.0, double0, 0.01);
      assertEquals(8, doubleArray0.length);
      assertArrayEquals(new double[] {1106.0, 1106.0, 1806.0, 0.0, 1806.0, 1106.0, 1106.0, 0.0}, doubleArray0, 0.01);
  ...
  public void test136()  throws Throwable  {
      ...
      assertNotSame(doubleArray1, doubleArray0);
      assertFalse(doubleArray1.equals((Object)doubleArray0));
      assertArrayEquals(new double[] {0.0, 1089.9249271698632, 91.934374658311, 1810.210489, 0.0, 0.0, Double.NaN}, doubleArray0, 0.01);
      assertArrayEquals(new double[] {Double.NaN, 1.0, 1.0, 1.0, Double.NaN, Double.NaN, Double.NaN}, doubleArray1, 0.01);
      ...
      double double2 = MathArrays.linearCombination(1089.9249271698632, 2011.0, 0.097, (-2816.0), (-3041.222955352), 0.01745329052209854, 0.0, (-3041.222955352));
      assertEquals(2191512.7971908124, double2, 0.01);
      assertNotEquals(double2, double1, 0.01);
      assertNotEquals(double2, double0, 0.01);
      ...
      assertFalse(doubleArray2.equals((Object)doubleArray0));
      assertArrayEquals(new double[] {0.0, 1089.9249271698632, 91.934374658311, 1810.210489, 0.0, 0.0, Double.NaN}, doubleArray0, 0.01);
      assertArrayEquals(new double[] {0.0, 1089.9249271698632, 91.934374658311, 1810.210489, 0.0, 0.0, Double.NaN}, doubleArray2, 0.01);
      ...
      assertArrayEquals(new double[] {0.0, 1089.9249271698632, 91.934374658311, 1810.210489, 0.0, 0.0, Double.NaN}, doubleArray0, 0.01);
      assertArrayEquals(new double[] {Double.NaN, 1.0, 1.0, 1.0, Double.NaN, Double.NaN, Double.NaN}, doubleArray1, 0.01);
      assertArrayEquals(new double[] {Double.NaN, (-1088.9249271698632), (-90.934374658311), (-1809.210489), Double.NaN, Double.NaN, Double.NaN}, doubleArray3, 0.01);
  ...
  public void test138()  throws Throwable  {
      ...
      assertEquals(1810.210489, double0, 0.01);
      ...
      assertArrayEquals(new float[] {(-694.22F), 0.0F, 0.0F}, floatArray0, 0.01F);
  ...
  public void test139()  throws Throwable  {
      ...
      assertEquals(8, doubleArray1.length);
      assertFalse(boolean1 == boolean0);
      assertArrayEquals(new double[] {1695.0, 903.0, 0.0, 1.304E19, (-1975.0), 3129.71, 903.0, (-1.0)}, doubleArray1, 0.01);
  }
  ...
  public void test143()  throws Throwable  {
      ...
      assertNotSame(doubleArray1, doubleArray0);
      assertFalse(doubleArray1.equals((Object)doubleArray0));
      assertArrayEquals(new double[] {(-1830.78255618484)}, doubleArray0, 0.01);
      assertArrayEquals(new double[] {(-1830.78255618484)}, doubleArray1, 0.01);
