...
public class Caverphone_ESTest extends Caverphone_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      boolean boolean0 = caverphone0.isCaverphoneEqual("~!)~L/<3w{%", "~T");
  ...
  public void test2()  throws Throwable  {
      Caverphone caverphone0 = new Caverphone();
      String string0 = caverphone0.caverphone("%igp'@`");
  ...
  public void test7()  throws Throwable  {
      Caverphone caverphone0 = new Caverphone();
      String string0 = caverphone0.encode("cE%%gD!x)>pea");
      assertEquals("SKTKPA1111", string0);
  }
}
