...
public class Caverphone_ESTest extends Caverphone_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      Caverphone caverphone0 = new Caverphone();
      String string0 = caverphone0.caverphone("peYv{<?>^BX:#x^P=");
      assertEquals("PFPKP11111", string0);
  }
  ...
  public void test5()  throws Throwable  {
      Caverphone caverphone0 = new Caverphone();
      boolean boolean0 = caverphone0.isCaverphoneEqual("VtF<q s`zj\"{;'a>", "");
