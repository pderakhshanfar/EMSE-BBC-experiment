...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "a_|*/'lBS\"u@$4l~");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader(".kx~`smbk");
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("b8F}1");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      stringArray0[0] = "kiwx)`phw";
      stringArray0[1] = "5x<?L<";
      stringArray0[2] = "${c,IZP^^G`mk5L0<";
      stringArray0[3] = "yP_9+Cnce@YPA";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(true);
      StringReader stringReader0 = new StringReader("yP_9+Cnce@YPA");
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("wJpth(|7s})~");
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"e^2G3Rem>h^5N", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("+Y{_y(zko9.At9OM", ".kx~`smbk");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      // Undeclared exception!
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("yqcjbww+h");
      File file0 = MockFile.createTempFile("T5Xce'RLS)8{>6E9*", "yqcjbww+h", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("sbir");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("U\u0007W{Jcs@H(f{R7 E", "U\u0007W{Jcs@H(f{R7 E");
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("2uD}3C JjEg");
      Character character0 = new Character('<');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('<', character0, quote0, character0, character0, true, true, ")S|_rlOD", "org.apache.commons.csv.CSVParser$1", stringArray0, true);
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("nP*j.}y=");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test26()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Un-GJc@of{?R7 E", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("b8f}1", cSVFormat2);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("D.m/'IZ~Wk\"gkZ5/yk", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test32()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{R1sC-[2#1y;k`JfSfi");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("{R1sC-[2#1y;k`JfSfi");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("348\bOGR[<<c^:M:U");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  ...
  public void test34()  throws Throwable  {
      StringReader stringReader0 = new StringReader(".kx~`smbk");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("=u~q&3D5");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[.kx~`smbk]", cSVRecord0.toString());
  }
