...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[$Z9t,S[[@a$X'1");
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "<i:82");
  ...
  public void test02()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/org.apache.commons.csv.CSVParser$206,kC>");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "The quoteChar cannot be a line break");
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$2", "6,kC>");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[2] = "[0~GG}\bk9!)w7qK";
      stringArray0[3] = "ivtFE)pJKu7\u0002Ar}.";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("|b;82", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("(o{ECv|", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\";&gLk.$5Nc", cSVFormat1);
  ...
  public void test16()  throws Throwable  {
      File file0 = MockFile.createTempFile("p,Rq3T6%PU-l$ryXD", "The quoteChar cannot be a line break");
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[6];
      CSVFormat cSVFormat0 = new CSVFormat('.', (Character) null, quote0, (Character) null, (Character) null, true, false, "", "d%;n?G}&TFDj", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("NONE", "Mapping for %s not found, expected one of %s");
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      StringReader stringReader0 = new StringReader("xVS,rqQ<]y?");
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("ZwD-;e^iJHi`jzx", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Tw`Xt");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test24()  throws Throwable  {
      File file0 = MockFile.createTempFile(",zbL$;ae06xi#C}", "PL$/(yrQPjW^0");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("6,kC>", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test32()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("hq?o.", "CSVParser has been closed", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("o mV");
      CSVParser cSVParser0 = CSVParser.parse("o mV", cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("|b282");
      CSVParser cSVParser0 = CSVParser.parse("|b;82", cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("|b282", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
