...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("rde5", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("4la)ls", cSVFormat0);
      cSVParser0.close();
  ...
  public void test02()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("ADC~cQ1=]S 0c+Z");
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Lf0jZ)yL\"V[Cw@ja<ij");
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("4la)ls", cSVFormat2);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"~+c.']bEle", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("`{MgTYkFP,aeaB", "{VLA24n_");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("ADC~cQ1=]S 0c+Z", "e<G61");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("pQLa..RD=2LFs|do~", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("[AFthQ0s{2ST$", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("I4la)lsb");
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("Lf0jZ)y[\"V[Cw@ja<ij", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("ar cannot be a line break", "ar cannot be a line break");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test26()  throws Throwable  {
      ...
      stringArray0[0] = "HyIGo!E";
      stringArray0[1] = "C@|RWF";
      stringArray0[2] = "format";
      stringArray0[3] = "4|keyo.";
      stringArray0[4] = "1)hl5d(g$e.";
      stringArray0[5] = "92U$ // %";
      stringArray0[6] = ".&v#+n|Xg{S8?WSj!";
      stringArray0[7] = "K>&tPA]D?7:*^IAhF6";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Y,LN}{.c0Hro_", cSVFormat2);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test27()  throws Throwable  {
      ...
      stringArray0[0] = "Lf0jZ)y[\"V[Cw@ja<ij";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("4|keYO.");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("UNexpectd TokH type: ");
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("zWjC.K_8");
      CSVParser cSVParser0 = CSVParser.parse("zWjC.K_8", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("zWjC.K_8", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
