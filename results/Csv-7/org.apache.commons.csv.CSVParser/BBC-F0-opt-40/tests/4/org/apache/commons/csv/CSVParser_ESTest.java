...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"ti]sqgvh]-l/t'eu", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, ":*iv");
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Header:/u@ u}6wr(&]m7s");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("Header:", "u@ u}6wr(&]m7s");
  ...
  public void test04()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(",@.2YYU\"V5+XTxCtq", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[, @.2YYU\"V5+XTxCtq]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(",@.2YYU\"V5+XTxCtq", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[, @.2YYU\"V5+XTxCtq]", cSVRecord0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("0h1o,2=163R/jJ]t", cSVFormat0);
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"R=[W\"UdPz8<", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("gvk[y", "gvk[y");
      Character character0 = Character.valueOf('k');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('k', character0, quote0, character0, character0, true, true, "eader:", "v", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      File file0 = MockFile.createTempFile("k:*iv", "org.apache.commons.csv.ExtendedBufferedReader", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(":*iv", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      String[] stringArray0 = new String[0];
      StringReader stringReader0 = new StringReader(">7;O\"_l6Ctb");
      Character character0 = new Character('*');
      Quote quote0 = Quote.NON_NUMERIC;
      Character character1 = Character.valueOf('j');
      CSVFormat cSVFormat0 = new CSVFormat('4', character0, quote0, character1, character0, true, true, "CSVParser has been closed", "`J&wt2\"|Ifpx7%*.)G", stringArray0, true);
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("X$Ll^QzDDw<E");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test29()  throws Throwable  {
      StringReader stringReader0 = new StringReader(",@.2YYU\"V5+XTxCtq");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test31()  throws Throwable  {
      ...
      stringArray0[0] = "=wg>mzu";
      stringArray0[1] = "TOKEN";
      stringArray0[2] = "{JE_i*|z;5DcX#,HA|";
      stringArray0[3] = "@y$L'[Pb7{:Yz";
      stringArray0[4] = "')";
      Character character0 = new Character('6');
      Quote quote0 = Quote.NONE;
      Character character1 = Character.valueOf('L');
      CSVFormat cSVFormat0 = new CSVFormat('x', character0, quote0, character1, character0, true, true, "{JE_i*|z;5DcX#,HA|", "')", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("=wg>mzu", cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      File file0 = MockFile.createTempFile(" emptylines:ignored", "z!*iY(0TKz>");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test35()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(":*iv");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
      assertEquals(1L, cSVParser0.getRecordNumber());
