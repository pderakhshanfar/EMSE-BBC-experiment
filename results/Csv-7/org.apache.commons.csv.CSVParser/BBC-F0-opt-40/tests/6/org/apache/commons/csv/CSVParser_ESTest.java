...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/]vi");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "r4d,1g");
      URL uRL0 = MockURL.getHttpExample();
      URL uRL1 = MockURL.URL(uRL0, "]vi");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("kW?W^v.~-", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "pn;icc=6r3FU";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("pn;icc=6r3FU", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[pn;icc=6r3FU]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("pn;icc=6r3FU", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[pn;icc=6r3FU]", cSVRecord0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("Vw@M{T!S;c|kuU>Cux", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("T@r3}B|yschM&", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      try { 
        CSVParser.parse("*U\"dI@:vRN+$iI", cSVFormat2);
  ...
  public void test15()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("charset", " [", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test17()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/CSVParser has been closed0CSVParser has been closed");
  ...
  public void test18()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('&', character0, quote0, character0, character0, false, false, "a", "", stringArray0, false);
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("P?y$o?bl", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("MINUMIMAL", cSVFormat0);
      cSVParser0.close();
  ...
  public void test22()  throws Throwable  {
      File file0 = MockFile.createTempFile("xr)=eq", "xr)=eq");
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("ABxi_`D");
      Character character0 = new Character('_');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[5];
      CSVFormat cSVFormat0 = new CSVFormat('Z', character0, quote0, character0, character0, false, false, "", "ABxi_`D", stringArray0, false);
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("n 0zirmappingwsspf`4th -ecorh values ca\"'tlbe a^cested bybna(e");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Vw@M{T!S;c|kuU>Cux");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("cze('*bV>GnG/", cSVFormat0);
  ...
  public void test29()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/CSVParser has been closed0CSVParser has been closed");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "%hV=");
      File file0 = MockFile.createTempFile("CSVParser has been closed", "CSVParser has been closed");
  ...
  public void test30()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('*');
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      StringReader stringReader0 = new StringReader("SG.-U|b,m5&'=uWj$Ej");
  ...
  public void test32()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader(":;GF4:z_=Fln");
  ...
  public void test35()  throws Throwable  {
      ...
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('d', character0, quote0, character0, character0, true, true, "Delimiter=<", "76HxiQ;IL;G=kcJtAp", stringArray0, false);
  ...
  public void test38()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("!&Ojn]lbKL8");
