...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("_@b%:l");
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "K<}Si@n](");
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('h', character0, quote0, character0, character0, true, true, "O9", "pl#K&", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("O9", cSVFormat0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test16()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("ypP+,A@+9wi,\"h", cSVFormat1);
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("hYz 6Ny3%}kd&", "yPuXz>{LprMX7V");
      File file0 = MockFile.createTempFile("hYz 6Ny3%}kd&", "hYz 6Ny3%}kd&", (File) mockFile0);
      Character character0 = new Character('J');
      Quote quote0 = Quote.NON_NUMERIC;
      CSVFormat cSVFormat0 = new CSVFormat('J', character0, quote0, character0, (Character) null, true, false, "X", "hYz 6Ny3%}kd&", (String[]) null, false);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      MockFile mockFile0 = new MockFile("|}v\"P#X,W,w-MZ5\"");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("-rug7whip\r", cSVFormat0);
  ...
  public void test22()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("KSao", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.csv.constants", "(line ");
  ...
  public void test26()  throws Throwable  {
      StringReader stringReader0 = new StringReader("=4`?lPlXB~1>wV,");
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("dTlQ3F|wuGt$1");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("D\")'lR7W\"4Oat", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("@zM)14r", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('7', character0, quote0, character0, (Character) null, false, false, (String) null, (String) null, stringArray0, true);
  ...
  public void test36()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("_mVM#r");
      StringReader stringReader0 = new StringReader("_mVM#r");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("/F CbJ/I='{B");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
