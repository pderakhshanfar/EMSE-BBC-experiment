...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("y1q6a{^9l (14b2", cSVFormat1);
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("LE;ziP]nE^TSW");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(">,rLYFB,1/r q!sc#", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("formwFat", (String) null);
  ...
  public void test16()  throws Throwable  {
      StringReader stringReader0 = new StringReader("kVt67u;2z{i>");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test18()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"I8F>tf+E[qy$");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("P\"XSw$J13t,}BCg0/%Y", cSVFormat0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('y');
      CSVParser cSVParser0 = CSVParser.parse("y1q6a{^9l (4b2", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("?<yR,ePkz(k.W6)Xys", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[?<yR, ePkz(k.W6)Xys]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("s1/}dM)(", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("?<yR,ePkz(k.W6)Xys", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("l-LCf1tA0WCyQ- v", "org.apache.commons.csv.CSVParser$2");
      File file0 = MockFile.createTempFile("~4O.t 3j", "The comment start character and the quoteChar cannot be the same ('", (File) mockFile0);
  ...
  public void test28()  throws Throwable  {
      StringReader stringReader0 = new StringReader("K:=s#-;j");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Uy~=\"V-]#};.", cSVFormat0);
      cSVParser0.close();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("K:=s#-;j");
      String[] stringArray0 = new String[2];
      stringArray0[0] = "%du";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVFormat cSVFormat3 = cSVFormat2.withSkipHeaderRecord(true);
      CSVParser cSVParser0 = CSVParser.parse("%du", cSVFormat3);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
