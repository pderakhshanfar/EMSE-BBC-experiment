...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"tHTpw*C~PUOoX", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{p+'ib{!:E-Ow'Q");
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(")nn>a[x", cSVFormat1);
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("f&<CLOi;@", (CSVFormat) null);
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"gb,9?SbECn3Rv|UR", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test10()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("ORhTU1%s6B{G5J6 ", "ORhTU1%s6B{G5J6 ");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("roM':V-*!&1U;");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("\"ybG?JjZ|", cSVFormat0);
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader(")nn>a[x");
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("LC[\"I02Z~A#@`gN", cSVFormat0);
  ...
  public void test21()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("B,a807a", cSVFormat1);
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("q|iz03jy_n[,", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[q|iz03jy_n[, ]", cSVRecord0.toString());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('>', character0, quote0, (Character) null, character0, true, true, "@xa?mfa-yb", "H'@:qV", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("CSVParse] has beenBcposed", cSVFormat0);
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("file", "The header contains duplicate names: ");
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("PzrNRx LV1)0MM;h", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("(lie");
      CSVParser cSVParser0 = CSVParser.parse("(lie", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ceaYer");
      StringReader stringReader0 = new StringReader("charsem");
      String[] stringArray0 = new String[2];
      stringArray0[0] = "ceaYer";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = cSVFormat2.parse(stringReader0);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[charsem]", cSVRecord0.toString());
  }
