...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("non_num", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('e', character0, quote0, (Character) null, character0, true, false, "Pnf", "", stringArray0, true);
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("non_num");
      String[] stringArray0 = new String[4];
      stringArray0[1] = "-l";
      stringArray0[2] = "non_num";
      stringArray0[3] = "  KMX";
      ...
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[non_num]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("$valu", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("P$?7AmV&");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test08()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('e', character0, quote0, character0, character0, true, true, "org.apache.commons.csv.CSVParser$1", "$valu", stringArray0, true);
  ...
  public void test09()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("lk,x~vf", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\" \"S9)mgKA[w&,}h_", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("\"SScJB*cZ6PF6=}.0", cSVFormat0);
  ...
  public void test19()  throws Throwable  {
      MockFile mockFile0 = new MockFile("d", "F@VNHiuAoqZ{+%");
      File file0 = MockFile.createTempFile("'L~h]8xalN", "'L~h]8xalN", (File) mockFile0);
  ...
  public void test20()  throws Throwable  {
      StringReader stringReader0 = new StringReader("s%v?T=+|WH*U@");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test22()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("3Ik4:zE)6+zS7}!,MC");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("Q^iT>NlTE", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("UwPZ", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("lntHUe0F%`$/", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("<<37HrJu>t^)2`P%", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test31()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("&l4OU");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
