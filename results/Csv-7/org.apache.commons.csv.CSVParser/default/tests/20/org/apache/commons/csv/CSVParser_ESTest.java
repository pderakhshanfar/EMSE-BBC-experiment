...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "'^vjtmres/>";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("'^vjtmres/>", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("'^vjtmres/>", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("vf", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test14()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("v*;{", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse(";pGG ,\"VY)", cSVFormat1);
  ...
  public void test16()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("-7Oj'x", "-7Oj'x");
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      File file0 = MockFile.createTempFile("yqe", "eig1AG<O;*D=7|g*b$6");
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile("#gy.N`$#Rh v%DC:Ay");
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("\"E23c", cSVFormat0);
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("\"^vrZuDT'jK&Yb9", cSVFormat0);
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("%dIbfj");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Dr-E4~\"i,E/yOtx}:[", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('I', character0, quote0, character0, character0, true, true, "6v%XY", "6v%XY", stringArray0, true);
  ...
  public void test35()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('I', character0, quote0, character0, character0, true, true, "6v%XY", "6v%XY", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('`');
      StringReader stringReader0 = new StringReader("QUnVe~(HF");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("vf", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
