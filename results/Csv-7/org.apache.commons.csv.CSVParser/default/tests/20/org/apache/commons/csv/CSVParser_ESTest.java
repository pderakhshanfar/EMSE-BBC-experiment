...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "->/x!l[^v3c>&lzdfd");
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/string0G");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("string", "G");
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("6v%XY");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("iU(eare5skds ))?g", cSVFormat1);
  ...
  public void test10()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("~o*6hlVW%k{", "~o*6hlVW%k{");
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat1);
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("!yip", cSVFormat1);
  ...
  public void test16()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"tW!cEH,", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test17()  throws Throwable  {
      File file0 = MockFile.createTempFile("kQ])^5^O9v", "kQ])^5^O9v");
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile(",}G?cj.=\"i~");
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("\"7B}@a \"g/y", cSVFormat0);
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("ujjwh4{wb4", cSVFormat0);
      cSVParser0.close();
  ...
  public void test25()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/$VALUES0$VALUES");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
  ...
  public void test26()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("hC.yuZfnU8q)zk5 HG");
  ...
  public void test32()  throws Throwable  {
      StringReader stringReader0 = new StringReader("VBh&");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test34()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("t93.iE4J<q`Oht", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("lip");
      CSVParser cSVParser0 = CSVParser.parse("lip", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("TT]y,xhu<yYn>_c,e");
      CSVParser cSVParser0 = CSVParser.parse("TT]y,xhu<yYn>_c,e", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[TT]y, xhu<yYn>_c, e]", cSVRecord0.toString());
  }
