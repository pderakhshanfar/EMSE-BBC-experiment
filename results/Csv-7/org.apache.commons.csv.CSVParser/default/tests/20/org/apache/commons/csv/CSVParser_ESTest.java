...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("\"FCjIo3B$^Z;<:\"-");
  ...
  public void test05()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('2', character0, quote0, character1, character0, true, false, "", "", stringArray0, false);
      CSVParser cSVParser0 = CSVParser.parse("", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("&_uSH/&eg|4L(F", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<\t> Escape=<> NullString=<w> RecordSeparator=<\n> SkipHeaderRecord:false", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("mapping for %s not found", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"?M$/SFWk}-0b'4", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("WC?$(5=xE{a6um@G;", "WC?$(5=xE{a6um@G;");
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("\"~:2(lsA];k%'{L3N1", cSVFormat0);
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("p_[C;c?8UK+");
  ...
  public void test22()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("&A8oG)@4VdIp*KN");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
  ...
  public void test25()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("<@Xn", cSVFormat1);
  ...
  public void test27()  throws Throwable  {
      ...
      Character character1 = new Character('O');
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('2', character0, quote0, character1, character0, true, true, "", "", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("", cSVFormat0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      StringReader stringReader0 = new StringReader("&2/j%zvy509hn<");
      Character character1 = Character.valueOf('b');
      CSVFormat cSVFormat0 = new CSVFormat('a', character1, quote0, character0, (Character) null, true, true, "", "", stringArray0, false);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("&_uSH/&eg|4L(F");
      CSVParser cSVParser0 = CSVParser.parse("&_uSH/&eg|4L(F", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
