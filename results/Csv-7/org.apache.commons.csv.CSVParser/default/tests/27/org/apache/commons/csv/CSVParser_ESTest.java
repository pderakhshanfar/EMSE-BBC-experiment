...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("hq<dk^x", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("nn_numeri", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("2S@+ HM=u4r,\"[", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("0PA8Gl!Tc'J!h", "0PA8Gl!Tc'J!h");
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("i}P!`>.");
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("\"@z&%,Oa,BC&) ~=", cSVFormat0);
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("\"x(l#zJ+Zt{q", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("Do7+");
  ...
  public void test23()  throws Throwable  {
      File file0 = MockFile.createTempFile("OnjU(<n*<;", "OnjU(<n*<;");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
  ...
  public void test25()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("pVNn", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test27()  throws Throwable  {
      ...
      stringArray0[0] = "hq<dk^x";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("hq<dk^x", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("C&>>oX^+!Od&nepU):", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("OnjU(<n*<;");
