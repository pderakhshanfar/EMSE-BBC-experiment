...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "SuV9[p|@BJ8@8");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("%GY![2", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"p}fptxz", cSVFormat1);
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("?|jdn.", "?|jdn.");
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("ra~gU,\"+o", cSVFormat0);
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("zk,\"in}a|.h4", cSVFormat0);
      try { 
  ...
  public void test20()  throws Throwable  {
      MockFile mockFile0 = new MockFile("`mouELg@{", "`mouELg@{");
      File file0 = MockFile.createTempFile("@J>3C$~z/ Q>{[jQ9ei", "@J>3C$~z/ Q>{[jQ9ei", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"eQrRkm.p]aJ");
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader(")6y@l\"^j~;27{`a");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("}\"-HRZF[G", cSVFormat0);
      cSVParser0.close();
  ...
  public void test27()  throws Throwable  {
      ...
      stringArray0[2] = "EOF";
      stringArray0[3] = ",L0R3%ft0j";
      stringArray0[4] = "#ni5d>.k]";
      stringArray0[5] = "b'AJ&)p'#*";
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("TDA", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('w');
      CSVParser cSVParser0 = CSVParser.parse("xVA@z\"dd6m+tC+>", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(")6Y@l\"^j~;27{`A");
      ...
      CSVParser cSVParser0 = CSVParser.parse("' must not be null!", cSVFormat4);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
