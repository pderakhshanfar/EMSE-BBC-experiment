...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{V%A\"r/,%oe1oa");
  ...
  public void test05()  throws Throwable  {
      File file0 = MockFile.createTempFile("}/8_}{v_#QW/B}", "9w%+s2$^]}xf_}j@`2q", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"&Gk-3<", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("[PzTF!6f#@", "[PzTF!6f#@");
  ...
  public void test17()  throws Throwable  {
      File file0 = MockFile.createTempFile("[PzTF!6f#@", "[PzTF!6f#@");
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/[PzTF!6f#@0[PzTF!6f#@");
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("t/JHL^z3fZoXaD9C", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("CKXN8PXuv(rCc", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("GLi*H4\"n#''rd", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
      assertNotNull(map0);
  ...
  public void test29()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('%', character0, quote0, character1, character0, true, false, "ibimbphnt", "e", stringArray0, true);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("9w%+s2$^]lxf_}j@`2q");
      CSVParser cSVParser0 = CSVParser.parse("CKXN8PXuv(rCc", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("Y`A(H1PU\"");
      try { 
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("GLi*H4\"n#''rd", cSVFormat0);
