...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "WVZ");
  ...
  public void test02()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("-c.}7FJ4@&Cl");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "r6{[cc_$";
      stringArray0[1] = "org.apache.commons.csv.Assertions";
      stringArray0[2] = "^fN:3)V(.w|Nn";
      stringArray0[3] = "?";
      stringArray0[4] = "";
      stringArray0[5] = "-";
      stringArray0[6] = "The header contains duplicate names: ";
      stringArray0[7] = "!XY@W{-";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("r6{[cc_$", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[r6{[cc_$]", cSVRecord0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("ei%4-~+v2AQ@G'1s9", (CSVFormat) null);
  ...
  public void test13()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("'fDugV?} {F5@k1`", ") invalid char between encapsulated token and delimiter");
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('-', (Character) null, quote0, (Character) null, (Character) null, true, true, "Delimiter=<", "Delimiter=<", stringArray0, true);
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("\"(:/p;[}Qr", cSVFormat0);
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile(" Q`6Lmg>]Rm[j-<", " Q`6Lmg>]Rm[j-<");
  ...
  public void test20()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("w@q(zaIIk~*");
  ...
  public void test22()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("7.en[)7k _d!6wws");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("JfYF2D5DMN9XgH>");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test26()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("M1M!Kb,\"a", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("w8;qkp9(xz^jora[ye*", cSVFormat2);
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("f&J+OvEDwhQ", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("=i9KYyX.", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
