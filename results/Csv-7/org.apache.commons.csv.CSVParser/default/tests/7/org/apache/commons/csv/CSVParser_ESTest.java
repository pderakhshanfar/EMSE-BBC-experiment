...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("record9separator=<");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "%7O%C0\"s-$mB";
      stringArray0[1] = "OR;JRYO8xSC,?>NQ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("%7O%C0\"s-$mB", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[%7O%C0\"s-$mB]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("I5Fje#ci", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[I5Fje#ci]", cSVRecord0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = MockFile.createTempFile("OR;JRYO8xSC,?>NQ", "%7O%C0\"s-$mB");
      CSVFormat cSVFormat0 = CSVFormat.newFormat('}');
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"XD&8ttx", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("|ct", "G$5TP6}LQ_'qx8w&_3");
      File file0 = MockFile.createTempFile("|ct", "|ct", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("\"[tp+J=", cSVFormat0);
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("8qm@2%>~w`1ub", cSVFormat0);
      cSVParser0.close();
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("aF", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("<jy$;j6% ; !,/=zBQ");
      CSVParser cSVParser0 = CSVParser.parse("<jy$;j6% ; !,/=zBQ", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
      assertEquals(1, list0.size());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("iL> xIoxk5&", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("iL> xIoxk5&");
      try { 
  ...
  public void test38()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("recordseparator=<", (String) null, (-2002), "recordseparator=<", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
