...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("9Foz");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("9Foz");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "dwb0#u3%$6^rp*<ol->";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("dy:ra#ej>HKN|vS", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test04()  throws Throwable  {
      File file0 = MockFile.createTempFile("uU+ZN#5#d,L-", (String) null);
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("(PMD*T/b0");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('(', character0, quote0, character0, character0, true, true, "", "aCWuYX---M^", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"~3kq2WJW'Q]=+", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile(",fj))o:}m9%", ") invalid parse sequence");
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("Parameter '", "qevs]+$~");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test17()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("(5C)CQ*^r?@rBj<%G", cSVFormat0);
      cSVParser0.close();
  ...
  public void test20()  throws Throwable  {
      ...
      String[] stringArray0 = new String[2];
      CSVFormat cSVFormat0 = new CSVFormat('l', character0, quote0, character0, character0, false, false, (String) null, "file", stringArray0, true);
  ...
  public void test22()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"Zwb^F!uKCI&BHbN{O");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("~riI <3+r", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("Delimiter=<,> QuoteChar=<\"> CommentStart=<f> RecordSeparator=<\r\n> SkipHeaderRecord:false");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("9Foz", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("9Foz", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
