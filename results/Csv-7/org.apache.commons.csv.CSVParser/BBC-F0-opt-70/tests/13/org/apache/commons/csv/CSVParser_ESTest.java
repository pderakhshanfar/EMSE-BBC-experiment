...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"B;a@uS6SC", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "u}jqT\"K(GoBJ@QV<,&a");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("B/G:z>&hO", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("|DfetajNb", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("GaT", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      stringArray0[0] = "<z/m";
      stringArray0[1] = "IqPV.K6}6>/PG";
      stringArray0[2] = "$s@1";
      stringArray0[3] = "";
      stringArray0[4] = "=E:6*Ow2zedKt";
      stringArray0[5] = "$VALUES";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("X?gtsG_[z4w(*8((DN");
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("`3%Le<5L", "D^f1(OZg\"Jjbs B@d^Q");
      Character character0 = Character.valueOf('}');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[5];
      CSVFormat cSVFormat0 = new CSVFormat('5', character0, quote0, character0, character0, true, true, "z?HFNoT", "e#%$1En) `$qdfJeRr", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      String[] stringArray0 = new String[7];
      CSVFormat cSVFormat0 = new CSVFormat('z', character0, quote0, character0, character0, true, true, (String) null, "Escape=<", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/foo.bar/org.apache.commons.csv.CSVParser$10mz<gxo");
      ...
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$1", "mz<gxo", (File) mockFile0);
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader(" mqhe4+(EHMYh6xmq2");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test19()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(",wmYfp8ct^PgmFW", "mwh*z>J@G/hegs,s", (File) null);
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("~|BiPs", cSVFormat2);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertNull(cSVRecord0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("<jq,m", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[<jq, m]", cSVRecord0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      stringArray0[0] = "yBg#_>=R_f`aV3";
      stringArray0[1] = "XBNm7&=/";
      CSVFormat cSVFormat0 = new CSVFormat('M', (Character) null, quote0, character0, character0, true, true, "Unexpected Token type: ", "yBg#_>=R_f`aV3", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withEscape('X');
      try { 
        CSVParser.parse("N{A\"H^M]}GoT{/[TCX", cSVFormat1);
        fail("Expecting exception: IOException");
