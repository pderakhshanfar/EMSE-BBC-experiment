...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("^}6,CDKUS<}%:");
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "CKcT`c");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test07()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("^oM3,?^Jsq;OO`L", cSVFormat1);
  ...
  public void test08()  throws Throwable  {
      ...
      stringArray0[0] = "ogp>b";
      stringArray0[1] = "=0Sfrr9-z'QmE4`";
      stringArray0[2] = "_M< zuJv2";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      StringReader stringReader0 = new StringReader("ogp>b");
  ...
  public void test09()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('G', character0, quote0, character0, character0, true, true, (String) null, "!q:1#", stringArray0, false);
  ...
  public void test12()  throws Throwable  {
      ...
      Charset charset0 = Charset.defaultCharset();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "CKcT`R`Y");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test16()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"4?;r6yaf s", cSVFormat1);
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/The delimiter cannot be a line brak0The delimiter cannot be a line brak");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("The delimiter cannot be a line brak", "The delimiter cannot be a line brak");
      try { 
        CSVParser.parse(file0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("", "CKcT`c");
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("0.x", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader("g:ZrBQMisw9`hUntT");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test25()  throws Throwable  {
      File file0 = MockFile.createTempFile("t8o)VXG", "vjvnvmt?7");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test26()  throws Throwable  {
      StringReader stringReader0 = new StringReader("D;Rn5}");
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("}3l-6Gl");
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("^oM3,?^Jsq;OO`L", cSVFormat0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("CKcT`R`Y", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test34()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Delimiter=<H> SkipHeaderRecord:false");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test36()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("}3l-6Gl");
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      CSVParser cSVParser0 = CSVParser.parse("}3l-6Gl", cSVFormat1);
