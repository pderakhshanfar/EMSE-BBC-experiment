...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"sb >", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "b^Ry.JYubw5;}!'");
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile((String) null, "-EK[Espl8!");
      File file0 = MockFile.createTempFile("-EK[Espl8!", "2: 2h", (File) mockFile0);
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("[z22bo}]`4h0cc<5wXm", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test08()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('7', character0, quote0, (Character) null, character0, true, true, "_odDy{Nt", "The comment start character and the delimiter cannot be the same ('", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('+', character0, quote0, character0, character0, true, false, "", "W)''y*W(\"9hs", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"9gpx65y>%btat/vk", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("[z22bo}]`4h0cc<5w[m", "K<*?m0CwnEi@ud||N~D");
      File file0 = MockFile.createTempFile("K<*?m0CwnEi@ud||N~D", "url", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("$F9,#+M+!+|q", "$F9,#+M+!+|q");
  ...
  public void test20()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('4', character0, quote0, character0, character0, true, true, "*ebv@TXkvVe", "*ebv@TXkvVe", stringArray0, true);
  ...
  public void test24()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("@ZEg#XzCzP`-I%pE");
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("AI#c", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test30()  throws Throwable  {
      StringReader stringReader0 = new StringReader("SOm=A%2#m4;~W:]AS");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('1');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("[z22bO}]`4h0Cc<5w[M");
      CSVParser cSVParser0 = CSVParser.parse("[z22bO}]`4h0Cc<5w[M", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test34()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile((String) null, "mL9KddwstwcV}");
      try { 
  ...
  public void test37()  throws Throwable  {
      ...
      String[] stringArray0 = new String[3];
      stringArray0[0] = "SOm=A%2#m4;~W:]AS";
      stringArray0[1] = "G<t|y";
      CSVFormat cSVFormat0 = new CSVFormat('\'', character0, quote0, character1, character0, false, false, "qpxz d%gxspyfvj)", "N96~0", stringArray0, true);
