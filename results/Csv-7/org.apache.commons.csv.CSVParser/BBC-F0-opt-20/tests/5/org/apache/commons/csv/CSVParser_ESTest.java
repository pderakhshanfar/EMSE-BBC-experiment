...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("9->f^lDu,2");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("d^pq3<J");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test09()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("MINIMAL", "Delimiter=<\t> Escape=<> RecordSeparator=<\n> SkipHeaderRecord:false", 0, "]ZQD)\"$NQtfi4]r.IH1", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('1', character1, quote0, character0, character1, true, true, "Unexpected Token type: ", "Unexpected Token type: ", stringArray0, true);
      try { 
        CSVParser.parse("org.cpa2he.commons.csv.csvparser$", cSVFormat0);
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("h;{*~D", "d<W/%");
      CSVFormat cSVFormat0 = CSVFormat.newFormat(';');
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("h;{*~D");
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      File file0 = MockFile.createTempFile("csvparser has been closed", "org.apache.commonssv.csvparser$2");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('d');
      CSVParser cSVParser0 = CSVParser.parse("d^pq3<J", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test18()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("EQYK1+!:D!')N{|HC", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      File file0 = MockFile.createTempFile("8C*d@+9g{8iT*q !", "8C*d@+9g{8iT*q !");
      FileSystemHandling.shouldAllThrowIOExceptions();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test24()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat(']', (Character) null, quote0, (Character) null, character0, true, true, "r'c=wxoiOr", "org.apache.commons.csv.CSVParser$2", stringArray0, true);
      StringReader stringReader0 = new StringReader("X6N~0<Y.");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test27()  throws Throwable  {
      ...
      Character character1 = new Character('o');
      CSVFormat cSVFormat0 = new CSVFormat('w', character0, quote0, character1, character0, true, true, "W#$^", "W#$^", stringArray0, true);
  ...
  public void test28()  throws Throwable  {
      String[] stringArray0 = new String[0];
      Character character0 = new Character('F');
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("org.pachecommons.csv.csvpaser$2");
      ...
      Character character1 = new Character('o');
      CSVFormat cSVFormat0 = new CSVFormat('w', character0, quote0, character1, character0, true, true, "W#$^", "W#$^", stringArray0, true);
      MockFile mockFile0 = new MockFile("org.pachecommons.csv.csvpaser$2");
  ...
  public void test29()  throws Throwable  {
      ...
      Character character1 = new Character('o');
      CSVFormat cSVFormat0 = new CSVFormat('w', character0, quote0, character1, character0, true, true, "W#$^", "W#$^", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse(" Ubw|", cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("UvQ4P nT/^u");
      StringReader stringReader0 = new StringReader("UvQ4P nT/^u");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
