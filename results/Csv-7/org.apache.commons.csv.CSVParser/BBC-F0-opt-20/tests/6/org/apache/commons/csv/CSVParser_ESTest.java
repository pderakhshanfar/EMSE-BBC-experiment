...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"1x", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("N}c/o[");
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[+$0$EfN#KM$Ad;B");
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("T!1)R");
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("I^!3,q");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat(';', character0, quote0, character0, character0, true, true, "", "Tbf,rT", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      try { 
        CSVParser.parse("07#izkVUfR n", cSVFormat2);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("p>64'}Gp)0%>yo*", "p>64'}Gp)0%>yo*");
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("k_a", ") EOF reached before encapsulated token finished");
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile(",$kmc", "m");
      FileSystemHandling.shouldAllThrowIOExceptions();
  ...
  public void test21()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('=', character0, quote0, character1, character0, true, true, "]", "Op.>,", stringArray0, true);
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("l?`z|", cSVFormat0);
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('=', character0, quote0, character1, character0, true, true, "]", "Op.>,", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("62feCB}@-X]&c", cSVFormat0);
      cSVParser0.isClosed();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("K+,Ui][ko~IU|O-D", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[K+, Ui][ko~IU|O-D]", cSVRecord0.toString());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("K+,Ui][ko~IU|O-D", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test30()  throws Throwable  {
      StringReader stringReader0 = new StringReader("ahV%%T");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
