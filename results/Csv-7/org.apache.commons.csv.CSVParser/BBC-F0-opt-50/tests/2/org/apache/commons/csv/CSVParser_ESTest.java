...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "c-'jT JL,czo_;'uh");
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("n#H(J#o@Bf}aql", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("l}K5[L8cm<^\"*/:ZJ;", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("carset", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("Tv>6|XfsK>I", cSVFormat1);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"wbpm]#hf|bmd*!.", cSVFormat1);
  ...
  public void test16()  throws Throwable  {
      File file0 = MockFile.createTempFile("#lR<*5]O|fb:RdO@}ox", "reader");
      Character character0 = new Character('v');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[4];
      CSVFormat cSVFormat0 = new CSVFormat('I', character0, quote0, character0, (Character) null, false, false, "WcZ<htxTcuuU", "reader", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      MockFile mockFile0 = new MockFile("B3u{p8cX}@@]* *]JH<");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("ozhbAH4>%T!2MND`VB", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("!d0r", "Cd&QJ");
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[4];
      CSVFormat cSVFormat0 = new CSVFormat('K', character0, quote0, character0, character0, true, true, ">E)Q!vfntW&;5K]", "M?X_wU", stringArray0, true);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test28()  throws Throwable  {
      StringReader stringReader0 = new StringReader("gGyr1&AE{\":u5{,.");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test30()  throws Throwable  {
      ...
      stringArray0[0] = "carset";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("PC6#", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('(', character0, quote0, character1, character1, false, false, "pwP;3KAVr-U;mo\"/JV", "pwP;3KAVr-U;mo\"/JV", stringArray0, false);
      CSVFormat cSVFormat1 = cSVFormat0.withEscape('_');
      CSVParser cSVParser0 = CSVParser.parse("pwP;3KAVr-U;mo\"/JV", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(" t(C|[_6");
  ...
  public void test34()  throws Throwable  {
      ...
      stringArray0[0] = "The delimiter cannoppbe a line break";
      stringArray0[1] = "z*ju/y7bs5";
      CSVFormat cSVFormat0 = new CSVFormat('', character0, quote0, (Character) null, character0, false, true, "The delimiter cannoppbe a line break", "The delimiter cannoppbe a line break", stringArray0, true);
      StringReader stringReader0 = new StringReader("The delimiter cannoppbe a line break");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
