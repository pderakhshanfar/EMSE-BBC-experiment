...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"II/n$7L&QHN", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "file";
      stringArray0[1] = "formgt";
      stringArray0[2] = "%\"kdM](^n~qy";
      CSVFormat cSVFormat0 = new CSVFormat('0', character0, quote0, character1, character0, true, true, "gj#vvlU-/Ji>ZO", "nf", stringArray0, false);
      CSVParser cSVParser0 = CSVParser.parse("%\"kdM](^n~qy", cSVFormat0);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[%\"kdM](^n~qy]", cSVRecord0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("4l7Ab_Ts4JtW'{&Pb", cSVFormat2);
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"!K)gtDq", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("RU%w$1JX[KZm?7f", "Q2MmHkeqM");
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("Bup@NV<8+#", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.csv.Token", ",iN;YO");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("b0F8~4&CvimsAb", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test22()  throws Throwable  {
      StringReader stringReader0 = new StringReader("4As/CIb~0Ut");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("(=K1%Fs()");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("L@;ObHM|\";hh{Qw5@Z}", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[4];
      stringArray0[0] = "17>/\" TzeQ";
      stringArray0[1] = "The delimiter cannot be a line break";
      stringArray0[2] = ";ushc{dq\"ka6cs";
      CSVFormat cSVFormat3 = cSVFormat2.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("$s)MHgxm y0ASg>T3", cSVFormat3);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      StringReader stringReader0 = new StringReader("5y(Ry)%Nj1V3RTWr{");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("9BN)m~iTbcjs}JFHG");
      CSVParser cSVParser0 = CSVParser.parse("9BN)m~iTbcjs}JFHG", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("9BN)Nm~iTbcjs}JFHG");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(",20p:f--MBC", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("q{r6aq do6b?[v.d4", "?jo3ks}xv59");
      try { 
