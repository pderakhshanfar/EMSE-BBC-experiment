...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("L~MawA]");
  ...
  public void test02()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "fxormat");
  ...
  public void test03()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("qF<DLrw");
      String[] stringArray0 = new String[2];
      stringArray0[0] = "}OfiR.,oHL:";
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("74]q)-poxmf+a<q!..");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test05()  throws Throwable  {
      MockFile mockFile0 = new MockFile("\u00C0$k3aa");
      File file0 = MockFile.createTempFile("\u00C0$k3aa", "tdEx.w!><", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("|6 5YLt2l2wSuhyw^", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('o', character0, quote0, character0, character0, true, true, "No more CSV records available", "Delimiter=<", stringArray0, false);
      // Undeclared exception!
      try { 
        CSVParser.parse("h!;Qw`.", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("_'U!pwfyJj]", "org.apache.commons.csv.CSVParser$2");
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('b', character0, quote0, (Character) null, character0, true, true, "The header contains duplicate names: ", "dKn", stringArray0, true);
  ...
  public void test22()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"8;@7X uzrm[5");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("74]q)-poxmf+a<q!..");
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("74]q)-poxmf+a<q!..");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('3', character0, quote0, character1, character0, false, false, "cQ>E$fWtDRk0EW", "cQ>E$fWtDRk0EW", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("[e8;^:", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
      assertEquals(1L, long0);
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("fxgrmas", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
