...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("pB4Xp1uIx/n\"M~hYbKE");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[2] = "`2X[({XH=B!~EDGaF";
      stringArray0[3] = "url";
      stringArray0[4] = "file";
      stringArray0[5] = "Fx.fh`bY";
      stringArray0[6] = ".idOP4of3r&5EFgPm";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(true);
      StringReader stringReader0 = new StringReader("%9/P\"U#H,QY=x(");
      CSVParser cSVParser0 = cSVFormat2.parse(stringReader0);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[%9/P\"U#H,QY=x(]", cSVRecord0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      String[] stringArray0 = new String[8];
      CSVFormat cSVFormat0 = new CSVFormat('`', character0, quote0, character0, character0, false, false, "(line ", "[3\"7", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse(" \"~v}`]q`ct|v2n", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("3PyN?vRRf.q", "3PyN?vRRf.q");
      Quote quote0 = Quote.NONE;
      Character character0 = Character.valueOf('p');
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('p', (Character) null, quote0, character0, character0, false, false, "A4", "B;{V+.z/r+k@/Zle|!_", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("x,ZT't/Uv@{e");
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("Unexpected Token type: ", "th");
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("`3=2Tw& w<Aafbp,");
      Character character0 = new Character('.');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[4];
      CSVFormat cSVFormat0 = new CSVFormat(',', character0, quote0, character0, character0, false, false, "`3=2Tw& w<Aafbp,", "org.apache.commons.csv.Lexer", stringArray0, false);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("th", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test32()  throws Throwable  {
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat(',', (Character) null, quote0, (Character) null, (Character) null, true, false, "the quotechar character and the delimiter cannot be the same ('", "CX{X%g", stringArray0, true);
