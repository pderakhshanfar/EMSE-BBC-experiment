...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/EORECORD0EORECORD");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "*3@=+=+gNDU");
  ...
  public void test02()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("N}(I2^");
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"0W^DnME,}G4'fJ@.,", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("reader", " SurroundingSpaces:ignored");
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "AuEY=.");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      try { 
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("svAuIY");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      StringReader stringReader0 = new StringReader("-RC,u@M,!");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader(".!l%;XW$ew']G!");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
  ...
  public void test22()  throws Throwable  {
      MockFile mockFile0 = new MockFile("kucjhlw*ioyvr", "CSVParser has been closed");
      File file0 = MockFile.createTempFile("kucjhlw*ioyvr", "kucjhlw*ioyvr", (File) mockFile0);
      FileSystemHandling.shouldAllThrowIOExceptions();
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader(")6vTw");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test24()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('/', character0, quote0, character0, character0, true, true, "(startline ", "(startline ", stringArray0, true);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader(",O;fL4Cg8iam+zmS");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Wf@[laBt|2HB[g", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      ...
      stringArray0[0] = ";/";
      stringArray0[1] = "2fKP=Z";
      stringArray0[2] = ";.{?i\"7w&<hv1l#ha{";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("j5xPEVC(3");
      CSVParser cSVParser0 = CSVParser.parse("j5xPEVC(3", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
