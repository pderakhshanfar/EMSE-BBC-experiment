...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('\"', character0, quote0, (Character) null, character0, true, false, "", "file", stringArray0, true);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[org.apache.commons.csv.csvprinter$]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse(";.C)4v'O", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(".&_2 w]*M`|I;gT-b(", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"*7a[qk_", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      ...
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('\"', character0, quote0, character0, character0, true, false, "", (String) null, stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('\"', character0, quote0, (Character) null, character0, true, false, "", (String) null, stringArray0, true);
      try { 
        CSVParser.parse(file0, cSVFormat0);
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("The comment start and the escape characber cannot be the same ('", "reader");
      FileSystemHandling.shouldAllThrowIOExceptions();
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader(")}7Y21C;:-");
      Character character0 = Character.valueOf('/');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('2', character0, quote0, character0, character0, false, false, ")}7Y21C;:-", "", stringArray0, false);
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("chrset");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords((Collection<CSVRecord>) linkedList0);
  ...
  public void test26()  throws Throwable  {
      StringReader stringReader0 = new StringReader("F|t9?<&$SIj]>VTg^S");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("jLL", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "18");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('\"', character0, quote0, (Character) null, character0, true, false, "", "file", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Cc-^rWU", cSVFormat1);
  ...
  public void test32()  throws Throwable  {
      ...
      stringArray0[3] = "'UH*QC06";
      stringArray0[4] = "t)Sjtz39A";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("org.apache.commons.csv.csvprinter$");
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("jLL", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
