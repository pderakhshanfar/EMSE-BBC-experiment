...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("ZJY^TpRN}i~)stGQ");
  ...
  public void test03()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/c|[unqj7?j30Sq3en");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Sq3en");
      File file0 = MockFile.createTempFile("c|[unqj7?j3", "Sq3en");
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("1|YP", cSVFormat2);
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("w!<A&D/0jjDvdpoJ", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('R', character0, quote0, character0, character0, false, true, "jVa*K+ZyU@J&e0&R", "0DZ74-oy/@SYY]].^", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("jVa*K+ZyU@J&e0&R", cSVFormat0);
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"Oy{L;]", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile(") invalid parse sequence", "2lW8-z[H");
      File file0 = MockFile.createTempFile("'b?b?ZF$T+h{#", "2lW8-z[H", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("eeK\"fSILD");
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("%I?[i%K\"8&");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("The quoteChar character and the delimiter cannot be the same ('", "x+vl[");
  ...
  public void test23()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('}', character0, quote0, character0, character0, false, false, "4", "4", stringArray0, false);
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader("v<12{$i8k^\"6(Oc");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("cPGkF^U(3!:QTS", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("!3~kKrtU,VQxA@K|rjX", cSVFormat0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("c|[unqj7?j3", cSVFormat2);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Hd#GRKH=JcqxP");
      CSVParser cSVParser0 = CSVParser.parse("Hd#GRKH=JcqxP", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("C|[unQJ7?j3", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
