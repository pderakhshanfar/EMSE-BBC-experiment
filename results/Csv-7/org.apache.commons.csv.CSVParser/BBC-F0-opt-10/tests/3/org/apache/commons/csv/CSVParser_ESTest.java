...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("m^MHU", cSVFormat1);
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("m^MHU");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('[');
      File file0 = MockFile.createTempFile("ON,QVBwDSC-vJ<:(H}J", "[ps#vHk&zMp", (File) null);
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"wV!3}/", cSVFormat1);
  ...
  public void test16()  throws Throwable  {
      File file0 = MockFile.createTempFile("W$;V[rwr3qg#|Jc;N.", "W$;V[rwr3qg#|Jc;N.");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test18()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("^@!@/r2p(e `5f5/r2p(e `5f50org.apache.commons.csv.CSVParser$1");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      MockFile mockFile0 = new MockFile("^@!@", "r2p(e `5f5");
      File file0 = MockFile.createTempFile("r2p(e `5f5", "org.apache.commons.csv.CSVParser$1", (File) mockFile0);
      try { 
        CSVParser.parse(file0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test19()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('i', (Character) null, quote0, (Character) null, (Character) null, false, true, "wvo1)7#B&^ZzfuB", "<OS[R^$]D_ZhNXj", stringArray0, false);
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      String[] stringArray0 = new String[6];
      CSVFormat cSVFormat0 = new CSVFormat('v', character0, quote0, character0, character0, false, false, "EORECORD", "", stringArray0, true);
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("u}NhlA");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("_do#xj(\"iq:[iCeAT0W", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('[');
      StringReader stringReader0 = new StringReader(")YT^`s3([y/gT}`jLm}");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[)YT^`s3(, y/gT}`jLm}]", cSVRecord0.toString());
  }
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("RO+\u0007w`(5!e95BOA", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('[');
      String[] stringArray0 = new String[6];
      stringArray0[0] = "u}NhlA";
      stringArray0[1] = "y?dfiyVU;>G\"c!";
      stringArray0[2] = "org.apache.commons.csv.Lexer";
      stringArray0[3] = "uzvbByIo_f{x<$^";
      stringArray0[5] = "ON,QVBwDSC-vJ<:(H}J";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader(")YT^`s3([y/gT}`jLm}");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("m^MHU", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("m^MHU");
      CSVParser cSVParser0 = CSVParser.parse("m^MHU", cSVFormat1);
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("56/!M:^WB{");
      String[] stringArray0 = new String[1];
