...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Wl?RX20wO/.");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('\\', character0, quote0, character1, character0, true, true, "uhvxm6a#jw", "&Uw}:Ag@S%80", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse(uRL0, charset0, cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "OT6Hxy^;$KvKH6=|3#l";
      stringArray0[1] = "L!Y+^=";
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("OT6Hxy^;$KvKH6=|3#l", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[OT6Hxy^;$KvKH6=|3#l]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader(" E6gF");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test08()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("e_9=)[:r'z|big#$o?", cSVFormat1);
  ...
  public void test10()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "no more csv records available");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('8', character0, quote0, character0, character0, true, true, "#\"}?<m<WqgW~i(", "org.apache.commons.csv.CSVParser$1", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("?4IL}jUS]5j", cSVFormat1);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("9<<OYu27P;]*W", "c2*6g%D}-");
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("wNo;Y;N~iXwanS", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("wno;y;n~ixwans");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
  ...
  public void test22()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/!Y+^=0!Y+^=");
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader(",J\"OBi_6^cdo");
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader("X4fC5N>w3b{NE\u0001]'cP");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("e_9=)[:r'z|big#$o?", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("m}h.59^", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("e\r", cSVFormat0);
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("xz$S~bv_SUUpK", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("h~A};HuqeHs");
      CSVParser cSVParser0 = CSVParser.parse("VZO#S,]v(iB", cSVFormat1);
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Wl?RX20wO/.");
      CSVParser cSVParser0 = CSVParser.parse("Wl?RX20wO/.", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("No more CSV records available", "vh70Vhfho,fD>+t", 12, ":?3", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
