...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("ojV%bqkiZri# \"6@=@", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("`S.,qFDhc1");
      ...
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[`S., qFDhc1]", cSVRecord0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      try { 
        CSVParser.parse(")+Qi #&B`iCCm", cSVFormat2);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character0);
      File file0 = MockFile.createTempFile("Parameter '", "");
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      File file0 = MockFile.createTempFile("No more CSV records available", ")tsO@V K", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("`DXS!.D_O");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("foYmOt");
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(".;*g0VXOI_H2N", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('=', character0, quote0, character1, character0, false, false, "7ioc", "Index for header '%s' is %d but CSVRecord only has %d values!", stringArray0, false);
  ...
  public void test34()  throws Throwable  {
      StringReader stringReader0 = new StringReader("`S.,qFDhc1");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("`S.,qFDhc1");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile("Header:", "org.apache.commons.csv.CSVParser");
      try { 
