...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "sl%n%-=H,6");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("?D.|Lzs6p)`<W4TsV<XJ", cSVFormat1);
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("5r6:k1Zcq");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("catESM\"B>4K$L", cSVFormat2);
  ...
  public void test14()  throws Throwable  {
      ...
      String[] stringArray0 = new String[8];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("vG9cN", "'Q D@B6-9y`E&");
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      File file0 = MockFile.createTempFile("~bqnT", "~bqnT");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("?O.|LzsLp)`<W4TV<XJ");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('?');
      CSVParser cSVParser0 = CSVParser.parse("?D.|Lz16p)`<W4sV<X0", cSVFormat1);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("qxcB", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test27()  throws Throwable  {
      ...
      stringArray0[5] = ";Z*)p5";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("]r~mT;OB;M<=IG&", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test28()  throws Throwable  {
      StringReader stringReader0 = new StringReader("kE'6+`Sd8*");
      Character character0 = Character.valueOf('E');
      Quote quote0 = Quote.NON_NUMERIC;
      Character character1 = new Character(',');
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('\"', character0, quote0, character1, character1, false, false, "kE'6+`Sd8*", "x", stringArray0, true);
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("?D.|Lz16p)`<W4sV<X0", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("?D.|Lzs6p)`<W4TV<XJ", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
