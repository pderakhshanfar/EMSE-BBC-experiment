...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("k/0r7=A) 8]y");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      MockFile mockFile0 = new MockFile("k/0r7=A) 8]y");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("RyrnAtL;f<3-rj8", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[2] = "1c<2_4!c;}yb-r";
      stringArray0[3] = "I9uV|+?=Aej.ovB";
      stringArray0[4] = "}LjV~(f, 6";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("1c<2_4!c;}yb-r");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[1c<2_4!c;}yb-r]", cSVRecord0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"^h_u4b7 n;utthg", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("cD2K8&8bkA^[oSXfK|e");
      File file0 = MockFile.createTempFile(") invalid char between encapsulated token and delimiter", "cD2K8&8bkA^[oSXfK|e", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test17()  throws Throwable  {
      File file0 = MockFile.createTempFile("csvparser has been closed", "No more CSV records available");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      String[] stringArray0 = new String[0];
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("wvc_2a9PHF");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test22()  throws Throwable  {
      File file0 = MockFile.createTempFile("a*'M/@hz>", "a*'M/@hz>");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      FileSystemHandling.shouldAllThrowIOExceptions();
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"drX>$zN");
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test26()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Og\"t=QXHmwkYp-o");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("O`@5#`?Dyq'", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test32()  throws Throwable  {
      ...
      stringArray0[0] = "| u&cbu 9&k)k'sbw{";
      stringArray0[1] = "{qt480hS-^iKt[<Ji";
      stringArray0[2] = "{&n";
      stringArray0[3] = "PcMjM64l?`";
      stringArray0[4] = "\nz2(+";
      stringArray0[5] = "9d TZAZ[lir!%Nu";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("9d TZAZ[lir!%Nu", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("O`@5#`?Dyq'");
      CSVParser cSVParser0 = CSVParser.parse("k/0r7=A) 8]y", cSVFormat1);
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("EzY]U|Y0Stf^JS;rh", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("O`@5#`?Dyq'", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
