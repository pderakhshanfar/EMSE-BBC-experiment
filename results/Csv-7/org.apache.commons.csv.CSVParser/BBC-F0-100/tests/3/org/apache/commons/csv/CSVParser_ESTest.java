...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Xe>*#RR8$hl\u0005QglMyq");
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "}3Cu_XW!");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[4] = "yat1=63a~l'$si'm(nr";
      stringArray0[5] = "-qc5Ooo.";
  ...
  public void test06()  throws Throwable  {
      MockFile mockFile0 = new MockFile("VJD&s7UtD.", "VJD&s7UtD.");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test07()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(") invalid parse sequence", ".:", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("%hUntTk$J<\"`", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test17()  throws Throwable  {
      File file0 = MockFile.createTempFile("T,7d{/596", "T,7d{/596");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withDelimiter('x');
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('x');
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("T,7d{/596");
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("}YIz _", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("J_8zx9e)M1x@X3#hsO", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("The comment start character cannot be a line break", "T>,-{2SF_Yv3JARND");
      File file0 = MockFile.createTempFile("Qlv-'SNk9o:tD", "T>,-{2SF_Yv3JARND", (File) mockFile0);
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<\t> Escape=<> CommentStart=<J> RecordSeparator=<\n> SkipHeaderRecord:false", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<\t> Escape=<> NullString=<'{must not be null!> RecordSeparator=<\n> SkipHeaderRecord:false Header:[]", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("EOKYe]Cdo{$(|l", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("{F_PA8Cab>qRQ.o81");
      CSVParser cSVParser0 = CSVParser.parse("{F_PA8Cab>qRQ.o81", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("'Wmust [ot &e null!", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("'Wmust [ot &e null!", "Delimiter=<\t> Escape=<> NullString=<'{must not be null!> RecordSeparator=<\n> SkipHeaderRecord:false Header:[]");
      try { 
