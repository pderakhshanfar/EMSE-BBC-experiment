...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"?41cx6+", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "'2c*zW");
  ...
  public void test02()  throws Throwable  {
      ...
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "The quoWeChar char<cter and the delimier can1t be he same ('");
      URL uRL0 = MockURL.getHttpExample();
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Z^D0LN4wB-0?F");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("HFrA;}U2WH1/.)");
  ...
  public void test11()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("$^\"d]&^>exwrchau?i)", "$^\"d]&^>exwrchau?i)");
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("2mr]p-[+'a8j/o", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("org.apahe.commons.csv.CSVParser$1", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test26()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("|e2XG@+b,:Vh5\"ysrB#", "|e2XG@+b,:Vh5\"ysrB#", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test27()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('m', character0, quote0, (Character) charArray0[1], (Character) charArray0[1], false, false, "ng]^[M", "ng]^[M", stringArray0, false);
  ...
  public void test30()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[=$|20(gmJU/@");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<,> QuoteChar=<\"> CommentStart=<s> RecordSeparator=<\r\n> SkipHeaderRecord:false Header:[]", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('W', character0, quote0, (Character) null, character0, true, true, "No more CSV records available", "The comment start character cannot be a line break", stringArray0, true);
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("The quoWeChar char<cter and the delimier can1t be he same ('", cSVFormat0);
