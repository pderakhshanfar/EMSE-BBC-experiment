...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("'mdDFlE(7f{byr}fFI|");
  ...
  public void test08()  throws Throwable  {
      StringReader stringReader0 = new StringReader("AxJg@d&eZ8k#");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("org.ap#che.commons.csvTCSVParser$1", "org.ap#che.commons.csvTCSVParser$1");
      File file0 = MockFile.createTempFile("org.ap#che.commons.csvTCSVParser$1", "org.ap#che.commons.csvTCSVParser$1", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("N)bDq:", "N)bDq:");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('q');
      CSVParser cSVParser0 = CSVParser.parse(",6&z|%]", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("AxJ@d&+\\8k", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("&-$,SX9|>(^", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[&-$, SX9|>(^]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("L{tA\"E@a8/s>NhM", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("L{tA\"E@a8/s>NhM", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("L{tA\"E@a8/s>NhM");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("AxJ@d&+\\8k", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("AxJ@d&+\\8k", "&-$,SX9|>(^");
      try { 
