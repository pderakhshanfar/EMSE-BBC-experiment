...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("LD~;PVGmzR<dT?");
      stringReader0.close();
  ...
  public void test01()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("CommentStart=</-L57A2K");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "g\"[il,]");
      Character character1 = Character.valueOf('B');
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('@', character1, quote0, character0, character1, true, true, " g\",]B", "T", stringArray0, true);
      MockFile mockFile0 = new MockFile("CommentStart=<", "-L57A2K");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[1] = "The quoteChar cha=acter and the delimiter cannot be the same ('";
      stringArray0[2] = "pFwe*";
      stringArray0[3] = "\"_-e}5I@q}<63";
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("rnZg");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('r');
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("rnZg");
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("9x]J2)h7lf6u^2mn8)", "9x]J2)h7lf6u^2mn8)");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("9x]J2)h7lf6u^2mn8)");
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      ...
      stringArray0[1] = "TIv!BC;ORlIxtI";
      CSVFormat cSVFormat0 = new CSVFormat('@', character1, quote0, character0, character1, false, true, "V(", "o", stringArray0, true);
      StringReader stringReader0 = new StringReader("TIv!BC;ORlIxtI");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("lc `DN}OZpla+C");
      Character character0 = Character.valueOf('F');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('F', character0, quote0, character0, character0, true, true, "lc `DN}OZpla+C", "lc `DN}OZpla+C", stringArray0, true);
  ...
  public void test20()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[2];
      CSVFormat cSVFormat0 = new CSVFormat('@', character0, quote0, character0, character0, true, true, "TIv!BC;ORlIxtI", "V(", stringArray0, true);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("ede:", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(";\ruisw", cSVFormat0);
  ...
  public void test24()  throws Throwable  {
      ...
      stringArray0[1] = "TIv!BC;ORlIxtI";
      CSVFormat cSVFormat0 = new CSVFormat('@', character1, quote0, character0, character1, false, true, "V(", "o", stringArray0, true);
      StringReader stringReader0 = new StringReader("Ynoc4v_F%@;/rUiSW@u");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('V', character0, quote0, character0, character0, false, true, "string", "string", stringArray0, true);
  ...
  public void test35()  throws Throwable  {
      ...
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('@', character0, quote0, character0, character0, true, true, " g\",]B", "T", stringArray0, true);
      MockFile mockFile0 = new MockFile("CommentStart=<", "-L57A2K");
      try { 
  ...
  public void test36()  throws Throwable  {
      ...
      Quote quote0 = Quote.MINIMAL;
      CSVFormat cSVFormat0 = new CSVFormat('f', character1, quote0, character0, character1, true, true, "AJl", "5|YD", stringArray0, true);
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  ...
  public void test37()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('c', character0, quote0, character0, character0, true, false, (String) null, (String) null, stringArray0, false);
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
        fail("Expecting exception: IOException");
