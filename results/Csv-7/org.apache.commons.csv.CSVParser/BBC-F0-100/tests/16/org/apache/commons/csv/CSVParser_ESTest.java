...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      stringArray0[0] = "V(";
      CSVFormat cSVFormat0 = new CSVFormat('@', character0, quote0, character1, character0, true, true, "TIv!BC;ORlIxtI", "V(", stringArray0, true);
  ...
  public void test03()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("i=v:4bnnt\"@w+i6z8");
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("`e-P0hOmb[", cSVFormat2);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('?', character0, quote0, character0, character0, true, true, ";e", ";e", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("X&+gF&G`&[15VZ", "tt|-gmDE?}Im");
      MockFile mockFile0 = new MockFile(file0, "The comment start character cannot be a line break");
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("\"Xnx<Y]6", cSVFormat0);
      try { 
  ...
  public void test20()  throws Throwable  {
      MockFile mockFile0 = new MockFile("b:omd+Ktknznv0_");
      File file0 = MockFile.createTempFile("QmX_^h]=", "b:omd+Ktknznv0_", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("zY%dq q~:BAi/51yh");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[2];
      stringArray0[0] = "V(";
      CSVFormat cSVFormat0 = new CSVFormat('@', character0, quote0, character1, character0, true, false, "TIv!BC;ORlIxtI", "V(", stringArray0, true);
      StringReader stringReader0 = new StringReader("G%<QZfpE.?|`=t\u0002@*V");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('@', character0, quote0, character1, character0, true, true, "TIv!BC;ORlIxtI", "V(", stringArray0, true);
      try { 
        CSVParser.parse("G%<QZfpE.?|`=t\u0002@*V", cSVFormat0);
        fail("Expecting exception: IOException");
  ...
  public void test36()  throws Throwable  {
      File file0 = MockFile.createTempFile("G%<QZfpE.?|`=t\u0002@*V", "G%<QZfpE.?|`=t\u0002@*V", (File) null);
      Character character0 = new Character('*');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[2];
      CSVFormat cSVFormat0 = new CSVFormat('@', character0, quote0, character0, character0, true, true, "TIv!BC;ORlIxtI", "V(", stringArray0, true);
  ...
  public void test38()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("5N*", "V(", 2499, "TIv!BC;ORlIxtI", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
