...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\"y_SP'%tMmMGI");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("wC!X", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("u9bbh]_{f");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[u9bbh]_{f]", cSVRecord0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("OxS0c Mb`Dc", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"4a9?", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("oxs0cmb`dc", "oxs0cmb`dc");
      Character character0 = Character.valueOf('k');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[2];
      CSVFormat cSVFormat0 = new CSVFormat('k', character0, quote0, character0, character0, true, true, "%r*-9,OgogCyJ%6-", "oxs0cmb`dc", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("wC!X", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("e3iq_{f");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("UJBETIq_{F");
      String[] stringArray0 = new String[2];
      stringArray0[0] = "\u2028";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<\t> Escape=<> CommentStart=<D> RecordSeparator=<\n> SurroundingSpaces:ignored SkipHeaderRecord:false Header:[]", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test38()  throws Throwable  {
      File file0 = MockFile.createTempFile("~1y;e{iBVSeC1)H", (String) null);
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("vN1e-)kI3}7O+l", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
