...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\"2#(qV~qt;b");
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("jDjxY2#v9", cSVFormat0);
      cSVParser0.close();
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('%', character0, quote0, character0, character0, false, true, "e)14)?M*-wWlesCz7", "org.apache.commons.csv.Lexer", stringArray0, true);
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("%C:(n0u", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("5_q&=L6O!&R\"RKlH'*", (String) null);
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/iter=<0quotech,ar=<");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      File file0 = MockFile.createTempFile("iter=<", "quotech,ar=<");
      try { 
        CSVParser.parse(file0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("I(BGy/GAMhs&=hiu 6", "s+~M}N=99~Z)n57v_");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(".=\"?~y,Og", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse(">,M+P'8u", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Q%=7YtF5y#$Tujwp-gg");
      Character character0 = new Character('i');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[5];
      CSVFormat cSVFormat0 = new CSVFormat('c', character0, quote0, character0, character0, false, false, "Q%=7YtF5y#$Tujwp-gg", "Q%=7YtF5y#$Tujwp-gg", stringArray0, false);
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("s/4&s|y");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/gZm6+:vTDWF2'<he0format");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "d~k;no1u");
      File file0 = MockFile.createTempFile("gZm6+:vTDWF2'<he", "format");
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('+');
      StringReader stringReader0 = new StringReader("Yuv}!OG~T/u1+ta(");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[0] = "1bbfq%t;0e)d}[uzn<0";
      stringArray0[1] = "O.,OYj+zOYx";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("1bbfq%t;0e)d}[uzn<0", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertNotNull(cSVRecord0);
      assertEquals("[1bbfq%t;0e)d}[uzn<0]", cSVRecord0.toString());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("s/4&s|y", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('K', (Character) null, quote0, character0, character1, false, false, "(startline ", "(startline ", stringArray0, true);
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
