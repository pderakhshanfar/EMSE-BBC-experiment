...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"YEA", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      File file0 = MockFile.createTempFile("j(egn_on{X8}!?6#@", "");
      Character character0 = Character.valueOf('$');
      Quote quote0 = Quote.NON_NUMERIC;
      Character character1 = new Character('r');
      CSVFormat cSVFormat0 = new CSVFormat('y', character0, quote0, character1, character1, false, false, "", (String) null, (String[]) null, false);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('d', (Character) null, quote0, character0, character0, false, false, ".QR", ".QR", stringArray0, false);
      // Undeclared exception!
      try { 
        CSVParser.parse(".QR", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"Do.5uSE2}Lw&w!", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("2ph,&b#&Nd>VjIo9k", "file", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test16()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/=uzg!y<&GpNJP}A^;0=uzg!y<&GpNJP}A^;");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      File file0 = MockFile.createTempFile("=uzg!y<&GpNJP}A^;", "=uzg!y<&GpNJP}A^;");
      try { 
        CSVParser.parse(file0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<\t> QuoteChar=<\"> NullString=<re/oer> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader(" 6zs&UIH@:@y");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(" Q28\tS|(", cSVFormat2);
  ...
  public void test30()  throws Throwable  {
      ...
      stringArray0[0] = "";
      stringArray0[1] = "9H|kZAyNC8=2[#-w7hb";
      stringArray0[2] = "charset";
      stringArray0[3] = "w}aw?y]ON(Dt?WXBp$";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("C.!e8?_]B566pL%T");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('q', character0, quote0, character0, character1, true, true, "0]0", "0]0", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character1);
      CSVParser cSVParser0 = CSVParser.parse("@!zy;2H{}`", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(" Q28\tS|(", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("{M-:NgU6gB0");
      Quote quote0 = Quote.NON_NUMERIC;
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      CSVParser cSVParser0 = CSVParser.parse("{M-:NgU6gB0", cSVFormat2);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
