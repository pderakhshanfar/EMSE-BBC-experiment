...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"sR\"Ek\n", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "GR#c8 Cn&12";
      stringArray0[1] = "No more CSV records available";
      stringArray0[2] = "\u2029";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("GR#c8 Cn&12");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[GR#c8 Cn&12]", cSVRecord0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("4%B)Z(>Po y{CCIzh");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("b$+F8JXI@}#5Z", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("[&ja-:\"o'Pp3C]WKUc");
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("=.GAxtX:9`");
  ...
  public void test09()  throws Throwable  {
      ...
      String[] stringArray0 = new String[4];
      CSVFormat cSVFormat0 = new CSVFormat('e', character0, quote0, character0, character0, false, false, "Gk/]v Sl", "_$Z\"&w.?_0*$jZC", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("_$Z\"&w.?_0*$jZC", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"88|)l@B-3", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      ...
      Quote quote0 = Quote.NON_NUMERIC;
      CSVFormat cSVFormat0 = new CSVFormat('z', character0, quote0, character0, character0, true, true, "string", "ehdycw", (String[]) null, true);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("D2Q14$+v`4E", ") invalid parse sequence");
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("YOMH@eMQxL,/Zdad");
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("cpu;]n{6:5\"Ep%o1v", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("cu;]n{6:5\"Ep%o1v", cSVFormat0);
      cSVParser0.close();
  ...
  public void test25()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("&_@?8i{8@", cSVFormat1);
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("[&ja-:\"o'pp3c]wkuc", cSVFormat1);
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[1] = "i-pL(P90(O%P^Q<";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      CSVParser cSVParser0 = CSVParser.parse("i-pL(P90(O%P^Q<", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("[&ja-:\"o'Pp3C]WKUc");
      StringReader stringReader0 = new StringReader("[&ja-:\"o'Pp3C]WKUc");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("[&ja-:\"o'Pp3C]WKUc");
      CSVParser cSVParser0 = CSVParser.parse("cu;]n{6:5\"Ep%o1v", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("_j\r\n", cSVFormat0);
      cSVParser0.getRecords();
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(1L, long0);
  }
