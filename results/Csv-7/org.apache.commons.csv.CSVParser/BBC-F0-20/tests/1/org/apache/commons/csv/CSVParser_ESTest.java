...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "4lEj?s'*bW");
  ...
  public void test02()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/l;:tBqbMT0format");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "~~kr");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("l;:tBqbMT", "format");
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = ".b]l?]j|qLO";
      stringArray0[1] = "0bRMpJW}SGBMbkQ";
      stringArray0[2] = "7:b>w ";
      stringArray0[3] = "_VibmV1Ym}!~,kZej";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(".b]l?]j|qLO", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[.b]l?]j|qLO]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('E');
      CSVParser cSVParser0 = CSVParser.parse("E5+2 z05iX", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[, 5+2 z05iX]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("surrundi@gspaces:ignored", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("lrtI(h97WgV\"");
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("3]Ata", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('.', character0, quote0, character0, character0, false, false, "0 d", (String) null, stringArray0, false);
      // Undeclared exception!
      try { 
        CSVParser.parse("0 d", cSVFormat0);
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('t', character0, quote0, character0, character0, true, false, (String) null, (String) null, (String[]) null, true);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("(line ", "org.apache.commons.csv.CSVParser");
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("0-P.+", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("P=|^6`@'#c-6ict", "UbP0xc^<zF5J'S");
  ...
  public void test24()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('m', character0, quote0, character0, character0, true, true, "org.apache.commons.csv.CSVParser$2", "RecordSeparator=<", stringArray0, true);
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("=ffi");
      CSVParser cSVParser0 = CSVParser.parse("=ffi", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Q+N", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("3]Ata", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
