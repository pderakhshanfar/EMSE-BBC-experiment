...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("}55F>1~@?)&S&v<");
      stringReader0.close();
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "zXi3";
      stringArray0[1] = "&NPzjT(";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("&NPzjT(", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test04()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("caB=X", "");
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("Hl5$!-cH<2L#ms <3)@", "P8 wue#p_:.>u_9m#,");
      File file0 = MockFile.createTempFile("]bNB", "COMMENT", (File) mockFile0);
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("AR^BMA", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("q{Tiw)O.[I", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"F+4mO", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('-', character0, quote0, character0, character0, true, true, "", "Escape=<", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/~R@tda}v:Oev0");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("~R@tda}v:Oev", "");
      try { 
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("e<.Dk", "org.apache.commons.csv.CSVParser$1");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      try { 
  ...
  public void test18()  throws Throwable  {
      StringReader stringReader0 = new StringReader("m\"4lUZ8`x(QtC38N=");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test22()  throws Throwable  {
      File file0 = MockFile.createTempFile("fSe9", "fSe9");
  ...
  public void test25()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("the quotechar character*and the delimiter cannot be1the same ('");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("X-cJE{6O\"8_[*J", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("&NPzjT(", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
