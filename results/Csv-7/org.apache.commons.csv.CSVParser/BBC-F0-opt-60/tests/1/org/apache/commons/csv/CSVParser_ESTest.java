...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "@ uf5-)]ef##(|z*d4");
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Q?[/HW\"lTFb x");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("hab&s D9", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("ywxr2");
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('n', character0, quote0, (Character) null, character0, false, true, "T#S4udrj.)5lT&yI%pJ", (String) null, stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"I1'E", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(") invalid parse sequence", "yq<!],tVsOe", (File) mockFile0);
      MockFile mockFile1 = new MockFile(file0, "");
      Character character0 = Character.valueOf('.');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('W', character0, quote0, character0, character0, true, true, "", ") invalid parse sequence", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("TOKEN/T!G");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Mapping for %s not found, expected one of %s");
      MockFile mockFile0 = new MockFile("TOKEN", "T!G");
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("2kk,RB3u3/6E?`", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test23()  throws Throwable  {
      File file0 = MockFile.createTempFile("/\"V0A_", "EOF whilst processing escape sequence", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      FileSystemHandling.shouldAllThrowIOExceptions();
  ...
  public void test32()  throws Throwable  {
      ...
      stringArray0[0] = "";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("twl(}vqyaaofo]nd", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("}TyMI\"yJ &!}");
      StringReader stringReader0 = new StringReader("HaB&9");
