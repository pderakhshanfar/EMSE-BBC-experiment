...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("o+f{8E)!;&4 V<", cSVFormat1);
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("o+f{8E)!;&4 V<");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('3', character0, quote0, character0, character0, true, true, "CSVParser has been closed", "reader", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("@cnl*yqff+mw", "@cnl*yqff+mw");
      Character character0 = Character.valueOf('f');
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('f', character0, quote0, character0, character0, true, false, "The escape character cannot be a line break", "@cnl*yqff+mw", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("n<6dis@ !$n[m]moo", "@G^pe^n\">6~|A}E]|{");
  ...
  public void test16()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('e', (Character) null, quote0, (Character) null, character0, false, false, "Y#vwF}\"`=^.CGIM<KI", "comment", stringArray0, true);
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("ek'gg/", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("o+f{8E)!;&4 V<", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("*mx0qW", cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
        cSVParser0.getRecords(linkedList0);
  ...
  public void test22()  throws Throwable  {
      StringReader stringReader0 = new StringReader("tJ:wco+IFjOAr");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      StringReader stringReader0 = new StringReader("-H,X5l+'BUOr");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("B+YO", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Y#vwF}\"`=^.CGIM<KI", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("(5ineS", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
