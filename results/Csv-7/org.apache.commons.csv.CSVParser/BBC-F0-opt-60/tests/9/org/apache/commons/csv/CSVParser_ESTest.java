...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      File file0 = MockFile.createTempFile("Zlvj i6P", "Zlvj i6P");
  ...
  public void test01()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/Unexpected Quote value: 0Unexpected Quote value: ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Unexpected Quote value: ");
  ...
  public void test02()  throws Throwable  {
      StringReader stringReader0 = new StringReader("r 53");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "lo";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("N,64W}_o8sd^khQ}l", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("N,64W}_o8sd^khQ}l", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[N,64W}_o8sd^khQ}l]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(",VII~f>*/(Pc5gY>j", cSVFormat0);
  ...
  public void test09()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("Header:", (String) null);
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("o9}$!oJ76ZGl`!qg", cSVFormat2);
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("QDPx) ,\"", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("eoB(uyl\"TirH", "w[`snqkx*u%^d4gjv$`");
      File file0 = MockFile.createTempFile("w[`snqkx*u%^d4gjv$`", "w[`snqkx*u%^d4gjv$`", (File) mockFile0);
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Ooxre<_SjGi}sUr+w");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(" M!y0(ve\"", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      File file0 = MockFile.createTempFile("xektlycpo 0", "xektlycpo 0");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
      FileSystemHandling.shouldAllThrowIOExceptions();
      try { 
  ...
  public void test28()  throws Throwable  {
      StringReader stringReader0 = new StringReader("xektlycpo 0");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("pgvxy@ULC}f]?", cSVFormat2);
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("LO", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Y#&&K&[O7.~mHQ");
      CSVParser cSVParser0 = CSVParser.parse("q$|@]4B\"3Q", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
      assertEquals(1, linkedList0.size());
  }
