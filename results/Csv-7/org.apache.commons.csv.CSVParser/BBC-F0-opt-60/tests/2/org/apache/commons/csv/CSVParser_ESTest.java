...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("tQka", cSVFormat1);
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "tp,d$5flq3,wbvmmk@ ");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "{k3ko`k";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("TP,D$5flQ3,wBVmMK@ ", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[TP, D$5flQ3, wBVmMK@ ]", cSVRecord0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Gc{@=K%hW");
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(",veb", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("Index for header '%s' is %d but CSVRecord only has %d values!");
      StringReader stringReader0 = new StringReader("@SnbnB%Vy<}3xe");
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("qxtT56", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test16()  throws Throwable  {
      File file0 = MockFile.createTempFile("3C0:%\"r>ip^6PFo", "AWgyg`R4~v)vkzK~{4");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("k PI", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      File file0 = MockFile.createTempFile("}d;&%OE[hrE", "]");
      FileSystemHandling.shouldAllThrowIOExceptions();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test22()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[p{2`a>*Qy-Af");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("{k3ko`k");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
  ...
  public void test34()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("Gc{@=K%hW");
      CSVParser cSVParser0 = CSVParser.parse(",veb", cSVFormat2);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("TP,D$5flQ3,wBVmMK@ ", "ek8sbo");
      try { 
