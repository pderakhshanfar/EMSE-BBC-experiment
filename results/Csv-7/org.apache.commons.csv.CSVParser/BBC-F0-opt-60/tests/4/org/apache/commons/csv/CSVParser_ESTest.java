...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("G{'e'B'|OvA", cSVFormat1);
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "u4{rq<r]w");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("G{'e'B'LOvA");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "Qs6s?''A2|@_{>v:");
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"s]aL@F{I?<", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("}D|:FSdIdM ", "80yAen0M[Ba");
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat0 = new CSVFormat('e', character0, quote0, character0, character0, false, false, "charset", "g}", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("_F@d", "_F@d");
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("%cJR$4");
  ...
  public void test21()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("vm*dJYZ9", "vm*dJYZ9", (File) mockFile0);
  ...
  public void test22()  throws Throwable  {
      ...
      String[] stringArray0 = new String[3];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("G{'e'B'|OvA");
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('3');
      CSVParser cSVParser0 = CSVParser.parse("$`[ Fr~+[|U:gq-C", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("nr", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("l0-x?,i,r");
      byte[] byteArray0 = new byte[4];
      byteArray0[3] = (byte)10;
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      MockFile mockFile0 = new MockFile((File) null, "l0-x?,i,r");
  ...
  public void test30()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Oz)(^ITdeZb<+c`");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test34()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('t', character0, quote0, character0, character1, true, true, (String) null, "url", stringArray0, true);
  ...
  public void test36()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("${1aP(&bb`oM2", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("${1aP(&bb`oM2", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
