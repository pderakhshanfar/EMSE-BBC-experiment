...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"a{t#\"(", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("}>aLZW`mJX1");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = new MockFile("&cXP-");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("EOF", cSVFormat2);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"ksrym:!scw4x:zy", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("k9s1a|tjR", "tt^# %[=\"4");
      File file0 = MockFile.createTempFile("k9s1a|tjR", "gbva~45#umtu", (File) mockFile0);
      Character character0 = new Character('!');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('!', character0, quote0, character0, character0, false, false, "hsE:*<I061=)o8R@4F", "hsE:*<I061=)o8R@4F", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("L7N", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      File file0 = MockFile.createTempFile("`h^yM/ZL|-mI-", "`h^yM/ZL|-mI-", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("8iqVFAq2.|");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      stringReader0.close();
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("tt^# %[=\"4", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test25()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("' must not be null!", cSVFormat3);
      cSVParser0.getRecords();
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("}>aLZW`mJX1", cSVFormat0);
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[6] = ")i&+f(5";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("tt^# %[=\"4", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("D[P");
  ...
  public void test37()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("The comment start character and the delimiter cannot be the same ('", "", 1093, "", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
  ...
  public void test38()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('-', character0, quote0, (Character) null, character0, true, false, "?[p", "I", stringArray0, true);
