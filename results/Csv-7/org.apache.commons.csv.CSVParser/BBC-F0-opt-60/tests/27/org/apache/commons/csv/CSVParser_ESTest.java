...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"*>SS_mv~.dQ", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "ND\u0005qqpkzD&O");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[1] = "vunf[hz=rgx";
      stringArray0[2] = "\u0001(Hr.`j^=en6;k";
      stringArray0[3] = "f&U:Lu>>D$";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("vunf[hz=rgx", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[vunf[hz=rgx]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("vunf[hz=rgx", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[vunf[hz=rgx]", cSVRecord0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('s');
      CSVParser cSVParser0 = CSVParser.parse("ND\u0005qqpkzD&O", cSVFormat0);
      cSVParser0.close();
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("Q2n/", cSVFormat2);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"=g}iy:{<`&=)>jt<4", cSVFormat1);
  ...
  public void test16()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("`|en", "XYA[8.&PdmkG&");
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile(",tx!jV3EwWn$Rta%N", "CommentStart=<");
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("N[|u--s{8!89%H0/H");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      StringReader stringReader0 = new StringReader("ni\"nacf<'*c}mae1<");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      stringReader0.close();
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("Delimiter=<,> QuoteChar=<\"> NullString=<Parameter '> RecordSeparator=<\r\n> SkipHeaderRecord:false");
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<,> QuoteChar=<\"> NullString=<org.apache.commons.csv.CSVFormat> RecordSeparator=<\r\n> SkipHeaderRecord:false", cSVFormat0);
      cSVParser0.getRecords();
