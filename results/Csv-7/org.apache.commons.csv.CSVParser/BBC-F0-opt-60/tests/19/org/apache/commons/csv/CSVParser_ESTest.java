...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\";q@eyb", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, ":M-O&qdjl|(9ZK");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[1] = "m}8h(~^xq^aSi!_F!;l";
      stringArray0[2] = "";
  ...
  public void test08()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('#', (Character) charArray0[3], quote0, (Character) charArray0[2], (Character) charArray0[3], true, false, ":M-O&qdjl|(9ZK", ",7Ofm+Y\"q", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat(']', character0, quote0, character0, character0, false, false, "", "3ynnj-", stringArray0, false);
      // Undeclared exception!
      try { 
        CSVParser.parse("~){9I`--F6(F`b", cSVFormat0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"m30pt", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("!i{2~{YcS1n^}", "org.apache.commons.csv.CSVParser$2");
      Character character0 = Character.valueOf('-');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('D', character0, quote0, character0, character0, false, false, "R(?2eh*", "R(?2eh*", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("l94Fx+.ce7XK({", "l94Fx+.ce7XK({");
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$2", "h20g.92g");
      MockFile mockFile0 = new MockFile(file0, ")- &A^tO$");
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("h20g.92g");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      File file0 = MockFile.createTempFile("fi0t_o6 nh~", "~-/gN");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test24()  throws Throwable  {
      ...
      Quote quote0 = Quote.MINIMAL;
      CSVFormat cSVFormat0 = new CSVFormat('a', character0, quote0, character0, character0, true, true, "{BEp&\")jFzr(", "{BEp&\")jFzr(", (String[]) null, false);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("m,}8h(~^5q^aSi!_F!;l");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("s:z", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("reader");
      StringReader stringReader0 = new StringReader("d;Q@0yb");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
      assertFalse(list0.isEmpty());
  }
