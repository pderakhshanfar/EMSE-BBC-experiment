...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\"SI~r|i*$=)-");
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "IJk'sL*s`r|K>&Q\"Tq$");
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("^<_fCUd.");
      String[] stringArray0 = new String[2];
      stringArray0[0] = "^<_fCUd.";
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("/3ju2AQil]5R11``");
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('3', character0, quote0, character0, character0, false, false, "string", "string", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"si\"r|i*$=)-", cSVFormat1);
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("%G74CqO", "INVALID");
      Character character0 = Character.valueOf('$');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[6];
      CSVFormat cSVFormat0 = new CSVFormat('3', character0, quote0, character0, character0, true, true, "%G74CqO", "%G74CqO", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"-SzYK,oE0`-", cSVFormat1);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("ve)\"qaj2r(342?|RUy_");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test20()  throws Throwable  {
      MockFile mockFile0 = new MockFile("lb7d", "lb7d");
      File file0 = MockFile.createTempFile("6C$1@$$aA", "6C$1@$$aA", (File) mockFile0);
  ...
  public void test27()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<\t> Escape=<> QuoteChar=<f> RecordSeparator=<\n> SkipHeaderRecord:false", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("|52pxn", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("erV9@'", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader("nG^l^|3");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  ...
  public void test33()  throws Throwable  {
      StringReader stringReader0 = new StringReader("nG^l{|3");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("nG^l{|3");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      String[] stringArray0 = new String[2];
      stringArray0[0] = "@f +oywk";
      CSVFormat cSVFormat0 = new CSVFormat('5', character0, quote0, (Character) null, character0, false, false, "w$iX6PzG0L]nj:)L", "@f +oywk", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("w$iX6PzG0L]nj:)L", cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
