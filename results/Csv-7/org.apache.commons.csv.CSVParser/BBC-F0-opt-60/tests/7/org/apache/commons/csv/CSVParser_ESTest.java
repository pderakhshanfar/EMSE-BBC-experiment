...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/@8An60$jp(N3S 0(line ");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "3j|ar50jg9+f>%");
      File file0 = MockFile.createTempFile("@8An60$jp(N3S ", "(line ");
  ...
  public void test03()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("@8An60$jp(N3S ", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("gcC5A", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("]>|~dnt+$", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("<ljiC[yGd[Lvn$OIP");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('O', character0, quote0, character0, character0, true, true, "MQ4,=&uy&xC')z]", "MQ4,=&uy&xC')z]", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("MQ4,=&uy&xC')z]", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("'= eFuwF[i0xuR", "");
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("gcC5A", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test21()  throws Throwable  {
      MockFile mockFile0 = new MockFile("=t&.sduns9", "=t&.sduns9");
      File file0 = MockFile.createTempFile("jz7xJ=", "jz7xJ=", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"Y;udN]kxgQi$%6M");
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test25()  throws Throwable  {
      StringReader stringReader0 = new StringReader("OfkPx$+H@19M{");
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(">,m1$j(CAs", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("vDG@Qlbd(y+&Gh9<yG", cSVFormat1);
  ...
  public void test30()  throws Throwable  {
      ...
      stringArray0[3] = ">,m1$j(cas";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("vc4");
  ...
  public void test35()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("reader");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('f');
      CSVParser cSVParser0 = CSVParser.parse(">,m1$j(CAs", cSVFormat2);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
