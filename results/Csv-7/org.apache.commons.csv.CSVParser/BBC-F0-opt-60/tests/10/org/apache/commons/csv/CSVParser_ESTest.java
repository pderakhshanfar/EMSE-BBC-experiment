...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"ZHZ7bj", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('2', character0, quote0, (Character) null, character0, true, true, "(line ", "The comment start and the escape character cannot be the same ('", stringArray0, true);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("1Yc1))NmL`%", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[1Yc1))NmL`%]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(",OT)j_[V", cSVFormat0);
  ...
  public void test18()  throws Throwable  {
      StringReader stringReader0 = new StringReader("M'pZ)?@b,9@C|&p?");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      stringReader0.close();
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[1] = "1Yc1))NmL`%";
      stringArray0[2] = "Ae]KZe\"mTH8N@J";
      stringArray0[3] = "The comment start and the escape character cannot be the same ('";
      stringArray0[4] = "&4nQkXW=rJ%i";
      stringArray0[5] = "')";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("1Yc1))NmL`%", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("Unexpected Token type: ", "0{~|/T|k!@F.");
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("[t;5C))R'krD{^d~", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("[t;5C))R'krD{^d~", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
