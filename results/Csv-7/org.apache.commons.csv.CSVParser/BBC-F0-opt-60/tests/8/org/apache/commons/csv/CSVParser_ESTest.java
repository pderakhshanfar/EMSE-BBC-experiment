...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader(",=C[*LNM(vevXr#}2'");
  ...
  public void test02()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("}2/file");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "(line ");
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("}2", "file");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("j.4+", cSVFormat1);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("%]Q2e3()f1U>6)I8", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("{RtUnkvUKouK_'_e", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile(";^Wt%z?Y5t.@,+", ";^Wt%z?Y5t.@,+");
      File file0 = MockFile.createTempFile("&V9F", "&V9F", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("Y{K{n[/c;", "Y{K{n[/c;");
      File file0 = MockFile.createTempFile("Y{K{n[/c;", "Y{K{n[/c;", (File) mockFile0);
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('j');
      StringReader stringReader0 = new StringReader("suu,wN");
      stringReader0.close();
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("n6f/QC", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      File file0 = MockFile.createTempFile("The comment start character and the delimiter cannot be the same ('", "^ml", (File) null);
      FileSystemHandling.shouldAllThrowIOExceptions();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test22()  throws Throwable  {
      StringReader stringReader0 = new StringReader("4+`ej");
      Character character0 = new Character('v');
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[3];
      CSVFormat cSVFormat0 = new CSVFormat('G', character0, quote0, character0, (Character) null, true, false, "4+`ej", ") invalid parse sequence", stringArray0, false);
  ...
  public void test26()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<,> QuoteChar=<\"> NullString=<X5_J&NAz4f> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
  ...
  public void test28()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat0 = new CSVFormat('2', character1, quote0, character0, character1, false, false, " SurroundingSpaces:ignored", "8=qEMK=tDmPQ", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("&", cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("QuoteChar=<", (String) null, (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test30()  throws Throwable  {
      ...
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[, =C[*LNM(vevXr#}2']", cSVRecord0.toString());
  }
