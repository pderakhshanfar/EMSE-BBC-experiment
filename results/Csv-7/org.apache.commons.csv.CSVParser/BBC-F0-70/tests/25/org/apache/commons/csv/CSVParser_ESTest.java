...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\"e:rf`$QG7[");
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "yz!nx");
  ...
  public void test02()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "x&f!jFgu2e,s.%3");
      String[] stringArray0 = new String[0];
      Quote quote0 = Quote.MINIMAL;
      CSVFormat cSVFormat0 = new CSVFormat('G', character0, quote0, (Character) '\'', character0, false, false, "'J", "]", stringArray0, false);
  ...
  public void test03()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      Quote quote0 = Quote.MINIMAL;
      CSVFormat cSVFormat0 = new CSVFormat('G', character0, quote0, (Character) '\'', character0, true, true, "'J", "'J", stringArray0, true);
  ...
  public void test05()  throws Throwable  {
      ...
      stringArray0[0] = "mwF$CLMs?Zc :#";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("W+Z+,Euvq'Q-&", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("1'!1Oeux[^");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[1'!1Oeux[^]", cSVRecord0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("9G<;JWybk;z!");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test11()  throws Throwable  {
      ...
      stringArray0[0] = "";
      stringArray0[1] = "|Fg:K+u,`4Vij..xk3";
      stringArray0[2] = "W+Z+,Euvq'Q-&";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test12()  throws Throwable  {
      ...
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('$', character0, quote0, (Character) 'v', character0, false, false, "yZ!Nx", "yZ!Nx", stringArray0, false);
      CSVParser cSVParser0 = CSVParser.parse("vxqrct].t;cxk+cj]>", cSVFormat0);
  ...
  public void test17()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('>', character0, quote0, character0, character0, false, false, (String) null, (String) null, (String[]) null, false);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('7');
      Quote quote0 = Quote.MINIMAL;
      CSVFormat cSVFormat0 = new CSVFormat('H', character0, quote0, (Character) '\u0000', character0, false, false, "')", "]", stringArray0, true);
      try { 
        CSVParser.parse("[.T4KKe>hh&^,*9y37", cSVFormat0);
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("Fv%up?K*rkSG", "Fv%up?K*rkSG");
      Character character0 = new Character('(');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[8];
      CSVFormat cSVFormat0 = new CSVFormat('6', character0, quote0, (Character) null, character0, false, false, "OC", "Fv%up?K*rkSG", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("#DVe<#s", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test25()  throws Throwable  {
      File file0 = MockFile.createTempFile("-meHutiH0?5mbJ", "-meHutiH0?5mbJ");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      FileSystemHandling.shouldAllThrowIOExceptions();
  ...
  public void test28()  throws Throwable  {
      ...
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = new CSVFormat('$', character0, quote0, (Character) '\'', character0, true, true, "yZ!Nx", "yZ!Nx", stringArray0, true);
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
  ...
  public void test36()  throws Throwable  {
      ...
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('$', character0, quote0, (Character) '\'', character0, true, true, "yZ!Nx", "yZ!Nx", stringArray0, true);
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test37()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("1'!1Oeux[^");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
  ...
  public void test39()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('Y', (Character) null, quote0, (Character) null, (Character) null, false, false, "{DT\"iP1Vrz!$Wk{-g", "url", stringArray0, true);
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("W+Z+,Euvq'Q-&", cSVFormat0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
