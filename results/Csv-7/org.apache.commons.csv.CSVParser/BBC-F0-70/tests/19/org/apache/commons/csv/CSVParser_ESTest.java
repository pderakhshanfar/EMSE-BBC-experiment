...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"=d1}?>k}vm", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("[@k Jh$l,D");
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("Delimiter=<\t> QuoteChar=<\"> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("(line ", "the quotechar cannot be a line break");
  ...
  public void test16()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("5RJlI2eFqj", "", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\'');
      String[] stringArray0 = new String[3];
      stringArray0[0] = "";
      stringArray0[1] = "1a~gAC;$0wAQPx-*vG";
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Bft*q`UvvW");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("o%/mU}8{v", "o%/mU}8{v");
      FileSystemHandling.shouldAllThrowIOExceptions();
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\":S[gI_^O");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("m2|lSpwC}J0oKe", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("K^INXi[$T][Bg@", cSVFormat1);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("*vmr!l7H4R}e", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test33()  throws Throwable  {
      ...
      stringArray0[0] = "RdL(5seo[{6";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("m%2|lSpwC}J0oKe", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("o%/mU}8{v", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(":Vk_/hE 9$4^L)");
      CSVParser cSVParser0 = CSVParser.parse(":Vk_/hE 9$4^L)", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("je$AyG");
      CSVParser cSVParser0 = CSVParser.parse("m%2|lSpwC}J0oKe", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[m%2|lSpwC}J0oKe]", cSVRecord0.toString());
  }
