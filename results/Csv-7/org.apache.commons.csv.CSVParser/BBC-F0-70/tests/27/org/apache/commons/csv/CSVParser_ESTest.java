...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("! :y#S$mSg0!qcqd");
      stringReader0.close();
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("! :y#S$mSg0!qcqd", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[! :y#S$mSg0!qcqd]", cSVRecord0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("'K-gZX5j@(", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("W2wdmDq@`@y~|IcH", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("v]u.PG4(9x0-@", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("}vvy]vq]_es", "enFNqNg]BhOQHb?;?");
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("H@,Z\"k1", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("z1nf");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords((LinkedList<CSVRecord>) null);
  ...
  public void test22()  throws Throwable  {
      File file0 = MockFile.createTempFile("K_HftdM)J!UpT", "2k*[");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test23()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('S', character0, quote0, character0, character0, true, true, "org.apache.commons.csv.CSVParser$2", "No more CSV records available", (String[]) null, true);
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader("3GuvL(YUe");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("XwE(9{Td4;NF");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("enFNqNg]BhOQHb?;?", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("H@,Zv\"*k1", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test35()  throws Throwable  {
      StringReader stringReader0 = new StringReader("! :y#S$mSg0!qcqd");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("! :y#S$mSg0!qcqd");
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("H@,Zv\"*k1");
      CSVParser cSVParser0 = CSVParser.parse("H@,Zv\"*k1", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
      assertFalse(list0.isEmpty());
  }
