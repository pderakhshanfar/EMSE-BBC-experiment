...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "dc:Pcc";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("dc:Pcc", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("lA$MwYz0E)mh_8", cSVFormat0);
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("u\r&yx");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"ay&:r9W&M`", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("vCS/LiBPd[", "vCS/LiBPd[");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test18()  throws Throwable  {
      StringReader stringReader0 = new StringReader("3/:c`'vSn9j)!7{0`");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("!!nsd7m<_0;>w", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("N*}d!'ES{y%GtY&\"");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
  ...
  public void test22()  throws Throwable  {
      MockFile mockFile0 = new MockFile("((D(F7:X{< gv");
      File file0 = MockFile.createTempFile("Unexpected Token type: ", "file", (File) mockFile0);
  ...
  public void test24()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('H', character0, quote0, character0, character0, false, false, ":<d@.E{nos", "+sn!v<!Zh9^Yr>", stringArray0, false);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("2x2E,*aso~L", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("hE LgvS\"Y*c9N^", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("=Bi|", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("lU\r&YHX");
      CSVParser cSVParser0 = CSVParser.parse("lA$MFd wYz0E)mh_8", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("N*}d!'ES{y%GtY&\"");
      StringReader stringReader0 = new StringReader("N*}d!'ES{y%GtY&\"");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<,> QuoteChar=<\"> NullString=<Ho> lB> RecordSeparator=<\r\n> SkipHeaderRecord:false", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
