...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("hxl`i{%tj");
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "%\"|8o>s%h[@}r8|4Hfy");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "rA0mKowM*>Wd\"cBiu2";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("rA0mKowM*>Wd\"cBiu2", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test03()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("7},7zNTa{^5nj3,");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("5=#]3fv}sZS:]", cSVFormat2);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("The comment start character and the quoteChar cannot be the same ('", (CSVFormat) null);
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('v', character0, quote0, character0, character0, true, true, "QuoteChar=<", "No more CSV records available", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", ">?:ci-GAU");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      try { 
  ...
  public void test21()  throws Throwable  {
      File file0 = MockFile.createTempFile("/npvPy//3F", "Kvt(nQ");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test22()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('P', character0, quote0, character0, character0, false, true, "", "*@F,", stringArray0, false);
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader("h]~x.e!I8i}77oT");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      stringReader0.close();
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("_cx|E0]zb|");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("+N>+<we-Rx^*xq", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("+N>+<we-Rx^*xq", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("+N>+<we-Rx^*xq", "+N>+<we-Rx^*xq");
