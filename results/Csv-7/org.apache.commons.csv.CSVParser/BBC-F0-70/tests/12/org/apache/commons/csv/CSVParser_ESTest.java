...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("/7J<,", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("F' N#2 g~", cSVFormat0);
      cSVParser0.close();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("4+Nq8qe3vRr*", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("_P&Q7?tb", cSVFormat1);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(")l\"r?F|\">Y0f<J", cSVFormat2);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("%BL0", "%BL0");
      Character character0 = Character.valueOf(']');
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[8];
      CSVFormat cSVFormat0 = new CSVFormat(']', character0, quote0, character0, character0, true, false, "jxo+jf.(", "%BL0", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      StringReader stringReader0 = new StringReader("W[, Cy?/fkk16'");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      stringReader0.close();
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      try { 
  ...
  public void test18()  throws Throwable  {
      File file0 = MockFile.createTempFile("ej/D^>@", "ej/D^>@");
      FileSystemHandling.shouldAllThrowIOExceptions();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test23()  throws Throwable  {
      File file0 = MockFile.createTempFile("format", "SC`pQ9w");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("jxo+jf.(", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("=T}UxC,vsAXI|n", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[0] = "s)e$E@";
      stringArray0[1] = "VE.VL,c`9q";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("=T}UxC,vsAXI|n", cSVFormat1);
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(";SQnPJ+i/#<.]I8`\u0004", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("4+Nq8qe3vRr*");
  ...
  public void test35()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("4+Nq8qe3vRr*");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('s');
      CSVParser cSVParser0 = CSVParser.parse("4+Nq8qe3vRr*", cSVFormat2);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("jxo+jf.(", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
