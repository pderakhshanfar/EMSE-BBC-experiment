...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("`>.ux:eleaalphjmdfn");
      stringReader0.close();
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/no more csv records available0TM]tC");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("no more csv records available", "TM]tC");
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"ymo<2", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("'!W<BMMD^Oss[f[", "No more CSV records available", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test21()  throws Throwable  {
      File file0 = MockFile.createTempFile("7mr32", "7mr32");
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("qqe+!kmhc-78`\u0004");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("*C5~Ci{t", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[CSVParser , as been closed]", cSVRecord0.toString());
  }
  ...
  public void test32()  throws Throwable  {
      ...
      stringArray0[0] = "#+'";
      stringArray0[1] = "_c]#sO2[ng~hri";
      stringArray0[2] = "OVVSC9Gt fD";
      stringArray0[3] = "jK uU[~d>Up";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("#+'", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test33()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('l', (Character) null, quote0, (Character) null, character0, true, false, "yzz\"sevzbb.-", "}h[/O`", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("|#uE(46\"", cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("LolA$wJWV*X");
