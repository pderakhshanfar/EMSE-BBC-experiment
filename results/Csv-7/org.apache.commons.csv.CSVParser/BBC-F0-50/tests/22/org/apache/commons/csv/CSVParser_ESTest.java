...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"TBD`q`iQywR", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("reader", "_~?", (File) mockFile0);
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("g-v=t{<}0d}-", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("G_x_S'L*fGW8h3*_e;$", cSVFormat1);
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("G_x_S'L*fGW8h3*_e;$", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("q</fp8,x!yzf");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[q</fp8, x!yzf]", cSVRecord0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('3', character0, quote0, character0, character0, true, true, "No more CSV records available", "No more CSV records available", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart((Character) null);
      CSVParser cSVParser0 = CSVParser.parse("8cba&P^T'oZ9)ZwL`\"", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      stringArray0[0] = "-:$<OXPq^=";
      stringArray0[1] = "l3nM}z._'M(b'sm2Z";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("8cba&P^T'oZ9)ZwL`\"", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test33()  throws Throwable  {
      StringReader stringReader0 = new StringReader("8cba&P^T'oZ9)ZwL`\"");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("8cba&P^T'oZ9)ZwL`\"");
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("8cba&P^T'oZ9)ZwL`\"", cSVFormat0);
