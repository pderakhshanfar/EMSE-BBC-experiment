...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"w%_\"!Qukf]M4i3t&z", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile(".mgW", "reader");
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".mgW/reader/+5V(V}@n+x1)B/.mgW0No quotes mode set but no escape character is set");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "]");
      MockFile mockFile1 = new MockFile(mockFile0, "+5V(V}@n+x1)B");
      File file0 = MockFile.createTempFile(".mgW", "No quotes mode set but no escape character is set", (File) mockFile1);
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("F*QfYbH|397b&", cSVFormat0);
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("ryzsb`l;{l&~i&z", "/RA");
      File file0 = MockFile.createTempFile("/RA", "/RA", (File) mockFile0);
  ...
  public void test18()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("s!I&jR#ld 2U7I", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("@\"BX*M&5L)]%Oiqc}");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("fqfybh|9pr");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("#_}{xs%J\u0000F!7#v");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("F*QfYH|97b&", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test31()  throws Throwable  {
      ...
      stringArray0[0] = "Bdi\"LmN(0O*|[";
      stringArray0[1] = "E2ejTxf jZ`Vzsr*";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("B^V[/[5W8s2;:hPa(", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[B^V[/[5W8s2;:hPa(]", cSVRecord0.toString());
  }
  ...
  public void test32()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat(';', character0, quote0, character0, character1, false, false, "-?H8;\"k", "T8UN|*@>PO:TKb>", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character1);
      CSVParser cSVParser0 = CSVParser.parse("-?H8;\"k", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile(".mgW", "reader");
      File file0 = MockFile.createTempFile(".mgW", "No quotes mode set but no escape character is set", (File) mockFile0);
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("F*QfYbH|397b&");
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("F*QfYbH|397b&", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
