...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"%x (%rR6|`aML", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('|', (Character) null, quote0, character0, character0, false, false, "Xo*/(;oq. ", "E? ", stringArray0, false);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("5(fM", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[5(fM]", cSVRecord0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("{APJ", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('|', (Character) null, quote0, (Character) null, character0, true, true, ") invalid parse sequence", ") invalid parse sequence", stringArray0, true);
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("+J}|l7/CB;");
      CSVFormat cSVFormat4 = cSVFormat3.withSkipHeaderRecord(true);
      // Undeclared exception!
      try { 
        CSVParser.parse(file0, cSVFormat4);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test19()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("^otoxGJ1O");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
  ...
  public void test20()  throws Throwable  {
      File file0 = MockFile.createTempFile(" l_mfd`W P#}h3LYO", " l_mfd`W P#}h3LYO");
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('<');
      StringReader stringReader0 = new StringReader("pqliD9]*[[\"N} 5ha");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader(") invalAd parse Wequence");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test29()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("xsyqafs0b", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[xsyqafs0b]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("V=F(G+la'LS*?q$,O", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("=0|t-#@w8o~l30*", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("=0|t-#@w8o~l30*", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
