...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/The comment start character and the quoteChar c?nnot be t2<svme (j0The comment start character and the quoteChar c?nnot be t2<svme (j");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "The comment start character and the quoteChar c?nnot be t2<svme (j");
      File file0 = MockFile.createTempFile("The comment start character and the quoteChar c?nnot be t2<svme (j", "The comment start character and the quoteChar c?nnot be t2<svme (j");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "sgorv.L,W ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("sgorv.L,W ");
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("#6*1(c)N~J})t?VB<F");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[#6*1(c)N~J})t?VB<F]", cSVRecord0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, ":qe&=([d2Z<h<>");
      URL uRL0 = MockURL.getHttpExample();
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("^x3m!Da1]|W!");
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(",04|wv|", cSVFormat0);
      cSVParser0.close();
  ...
  public void test25()  throws Throwable  {
      StringReader stringReader0 = new StringReader(" xbONf");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      stringReader0.close();
  ...
  public void test28()  throws Throwable  {
      StringReader stringReader0 = new StringReader("^x3m!Da1]|W!");
      CSVFormat cSVFormat0 = CSVFormat.newFormat('*');
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("The comment start character and the quoteChar c?nnot be t2<svme (j", cSVFormat1);
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("#6*1(c);~Jw)t?VB<F");
      CSVParser cSVParser0 = CSVParser.parse(":xj", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("#6*1(c);~Jw)t?VB<F");
      CSVParser cSVParser0 = CSVParser.parse("#6*1(c);~Jw)t?VB<F", cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("The comment start character and the quoteChar c?nnot be t2<svme (j", cSVFormat0);
