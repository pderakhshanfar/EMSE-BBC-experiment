...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "(nN# %/qc?}2E,Ro4e-");
      String[] stringArray0 = new String[1];
      Quote quote0 = Quote.ALL;
      Character character0 = Character.valueOf('\"');
      CSVFormat cSVFormat0 = new CSVFormat('x', character0, quote0, (Character) null, character0, true, true, stringArray0[0], "I9", stringArray0, true);
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("3}|{;kTO%25',");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[2];
      stringArray0[0] = "3}|{;kTO%25',";
  ...
  public void test09()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("?8/b3DD|-zCc:", "The quoteChar cannot be a line break", (File) mockFile0);
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse(" s\rro\ndingspaces:ignored", cSVFormat0);
  ...
  public void test16()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('x', character0, quote0, (Character) null, character0, true, true, "EOF", "$3|", stringArray0, true);
      try { 
        CSVParser.parse("mX1hk3)mSim^3", cSVFormat0);
  ...
  public void test17()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("$)XA]-EN?185K]+", "");
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      File file0 = MockFile.createTempFile("f\"km|J~t*Vv%K`K@", "f\"km|J~t*Vv%K`K@");
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('S', character0, quote0, character1, character2, true, false, "q(R)Ty](", "The comment start character and the delimiter cannot be the same ('", stringArray0, true);
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
        fail("Expecting exception: IOException");
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<,> QuoteChar=<\"> NullString=<3t3> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", cSVFormat1);
  ...
  public void test32()  throws Throwable  {
      ...
      Character character1 = new Character('h');
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('S', character0, quote0, character1, character0, true, false, "q(R)Ty](", "The comment start character and the delimiter cannot be the same ('", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("q(R)Ty](", cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      StringReader stringReader0 = new StringReader("$)XA]-EN?185K]+");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  ...
  public void test35()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('\"');
      CSVFormat cSVFormat0 = new CSVFormat('x', character0, quote0, (Character) null, character0, true, true, stringArray0[0], "I9", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("ha,{oilK=rlp3*wxU1", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
      assertEquals(1L, cSVParser0.getRecordNumber());
