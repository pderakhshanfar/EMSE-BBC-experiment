...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"6$QkK16X.+", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("3NullStrin=<", cSVFormat1);
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("9s[]Yv48i91#OIo");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat(' ', character0, quote0, (Character) null, character0, false, false, "M#", "M#", stringArray0, false);
      try { 
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("Omch", "No quotes mode set but no escape character is set");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test14()  throws Throwable  {
      ...
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[0];
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/TOKEN0Pg");
      CSVFormat cSVFormat0 = new CSVFormat('p', character0, quote0, (Character) null, character0, false, false, "ig", "ig", stringArray0, false);
      File file0 = MockFile.createTempFile("TOKEN", "Pg");
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"[vV0i");
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/TOKEN0Pg");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "org.apache.commons.csv.Quote");
      CSVFormat cSVFormat0 = new CSVFormat('p', character0, quote0, (Character) null, character0, false, false, "ig", "ig", stringArray0, false);
      File file0 = MockFile.createTempFile("TOKEN", "Pg");
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
  ...
  public void test30()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('2', character0, quote0, character1, character0, true, true, "M#", "M#", stringArray0, true);
      StringReader stringReader0 = new StringReader("?^85ZF(MGeB?PrTL");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader("9s[]Yv48i91#OIo");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("9s[]Yv48i91#OIo");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('0', character0, quote0, character1, character0, false, true, "index for header '%s' is %d but csvrecord only has %d values!", "empty", stringArray0, true);
