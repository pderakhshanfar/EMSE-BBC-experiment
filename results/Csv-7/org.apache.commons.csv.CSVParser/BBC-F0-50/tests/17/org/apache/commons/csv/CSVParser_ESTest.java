...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      File file0 = MockFile.createTempFile("{Q`3KF", (String) null);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('=', character0, quote0, character1, character0, true, true, "aIDnY", "*<", stringArray0, true);
  ...
  public void test03()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/7Va*0PEDa");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "F< >P7{27@E)X-|h~G");
      File file0 = MockFile.createTempFile("7Va*", "PEDa");
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("2|+>Wsq0);h", cSVFormat0);
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("{Qbb;xF", (String) null);
      Character character0 = new Character('d');
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('d', character0, quote0, character0, character0, true, false, ">/>W=@^B&|FXJG.1p", "Mapping for %s not found, expected one of %s", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("H=Q1I~U(4", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("\"IfOT'i=GR0xxD'w/", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
        cSVParser0.getRecords(linkedList0);
        fail("Expecting exception: IOException");
  ...
  public void test23()  throws Throwable  {
      File file0 = MockFile.createTempFile("8zCSK_tKo!", "8zCSK_tKo!");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("7Va*", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("PEDa", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/{Qbb;xF0.tmp");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "{Qbb;xF");
      File file0 = MockFile.createTempFile("{Qbb;xF", (String) null);
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test30()  throws Throwable  {
      StringReader stringReader0 = new StringReader("#a,r#v2qC|vSG");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
      assertEquals(1, list0.size());
  ...
  public void test32()  throws Throwable  {
      ...
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat(',', character0, quote0, (Character) null, (Character) null, false, false, (String) null, "%)", stringArray0, true);
