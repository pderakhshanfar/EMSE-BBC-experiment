...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\"k=6J!<JhA$2tDIwDQ");
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "ykdqqmzxh~i^d");
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<y> SkipHeaderRecord:false", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile("3Gpv`w#qFXasH{\u0002kKJ", "]");
      File file0 = MockFile.createTempFile("tHfHt,W5^~mC)", "", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"\"TSx,`a-\"Wz", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("guR>kl|+'{tRLkQ`<k", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("i[z[qlgnk'g", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test21()  throws Throwable  {
      File file0 = MockFile.createTempFile("_ :j&vB^)g`FO:$u{", "_ :j&vB^)g`FO:$u{");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader("M| e+s/r$li)uz;t");
      Character character0 = Character.valueOf('M');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('X', character0, quote0, character0, character0, false, false, "M| e+s/r$li)uz;t", "M| e+s/r$li)uz;t", stringArray0, true);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("/ka*ej/x(bfq", cSVFormat0);
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('y');
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<y> SkipHeaderRecord:false", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[Delimiter=<, > SkipHeaderRecord:false]", cSVRecord0.toString());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('a', character0, quote0, character1, (Character) null, true, true, (String) null, "r&I7:/SOa).}=;.z", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("r&I7:/SOa).}=;.z", cSVFormat0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("gur>kl|+'{trlkq`<k", "/ka*ej/x(bfq");
  ...
  public void test32()  throws Throwable  {
      StringReader stringReader0 = new StringReader("k/KA*Ej/X(Bfq");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test34()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("k/KA*Ej/X(Bfq", "");
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test36()  throws Throwable  {
      StringReader stringReader0 = new StringReader("k/KA*Ej/X(Bfq");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("k/KA*Ej/X(Bfq");
