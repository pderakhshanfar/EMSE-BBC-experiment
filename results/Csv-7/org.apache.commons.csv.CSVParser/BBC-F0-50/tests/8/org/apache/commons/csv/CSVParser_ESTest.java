...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "9<J@-q^7gW(O");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('\'', (Character) null, quote0, (Character) null, character0, false, false, "L935Phx=~}w", "charset", stringArray0, true);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('\'', character1, quote0, character0, character2, true, true, "4", "4", stringArray0, true);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("5");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, ">peW^0o^z;sb'e,5t!<");
      MockFile mockFile0 = new MockFile((File) null, "5");
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('d', character0, quote0, (Character) null, (Character) null, true, true, "L935Phx=~}w", "L935Phx=~}w", stringArray0, true);
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("8h", cSVFormat1);
  ...
  public void test17()  throws Throwable  {
      ...
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('\'', (Character) null, quote0, (Character) null, character0, false, false, "L9h5Ph=~}w", "charset", stringArray0, true);
      try { 
        CSVParser.parse("L9h5Ph=~}w", cSVFormat0);
  ...
  public void test18()  throws Throwable  {
      MockFile mockFile0 = new MockFile("*]uz`~fwx89pft}.*");
      File file0 = MockFile.createTempFile(">d[yz<ro!roz", "~@qrCc", (File) mockFile0);
      Character character0 = Character.valueOf('O');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[4];
      CSVFormat cSVFormat0 = new CSVFormat('`', character0, quote0, character0, character0, true, true, "*]uz`~fwx89pft}.*", "H<Xgoe@%!-nUm", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      File file0 = MockFile.createTempFile("p~K3%?sp-i0= ubTpc", "p~K3%?sp-i0= ubTpc", (File) null);
  ...
  public void test23()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('?', character0, quote0, character0, character0, true, true, "0E", "<G", stringArray0, true);
  ...
  public void test25()  throws Throwable  {
      StringReader stringReader0 = new StringReader("L9h5Ph=~}w");
      Character character0 = new Character('w');
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('\'', (Character) null, quote0, (Character) null, character0, false, false, "L9h5Ph=~}w", "charset", stringArray0, true);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("HS-.S|8\"$@j~s-7,a_N", cSVFormat0);
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("8*G4v4H");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test29()  throws Throwable  {
      ...
      Character character1 = Character.valueOf('@');
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat0 = new CSVFormat('\'', character1, quote0, character0, character1, true, true, "4", "4", stringArray0, true);
      StringReader stringReader0 = new StringReader("8*G4v4H");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      stringArray0[0] = "3";
      CSVFormat cSVFormat0 = new CSVFormat('Y', (Character) null, quote0, (Character) null, character0, true, true, "3", "5", stringArray0, false);
      CSVParser cSVParser0 = CSVParser.parse("ab[", cSVFormat0);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertNotNull(cSVRecord0);
      assertEquals("[ab[]", cSVRecord0.toString());
  }
