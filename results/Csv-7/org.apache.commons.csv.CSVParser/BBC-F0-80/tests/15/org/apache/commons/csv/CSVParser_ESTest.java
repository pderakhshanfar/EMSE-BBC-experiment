...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("p$N.pv(<;$o-RU");
      stringReader0.close();
  ...
  public void test01()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("mapping for %s not found, expected oneof %s");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[mapping for %s not found,  expected oneof %s]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("p$N.pv(<;$o-RU", cSVFormat0);
      cSVParser0.close();
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("_%H\"?Bi, q", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("H8o+23bnMH(l$gOMZ", "H8o+23bnMH(l$gOMZ");
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$1", "gwXMItSO/L__=__~%Bc", (File) mockFile0);
  ...
  public void test09()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "]p\"1F9z5s]^;!cwt");
  ...
  public void test11()  throws Throwable  {
      ...
      stringArray0[0] = "9D:T'5@?MLfhTX,}";
      stringArray0[1] = "9D:T'5@?MLfhTX,}";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        CSVParser.parse("9D:T'5@?MLfhTX,}", cSVFormat1);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // The header contains duplicate names: [9D:T'5@?MLfhTX,}, 9D:T'5@?MLfhTX,}]
         //
         verifyException("org.apache.commons.csv.CSVFormat", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("__n/]", "format");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('/', character0, quote0, character0, character0, false, true, "-t[78^pB{AM", "-t[78^pB{AM", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("T/&,*B");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "A{?ueihrI#P");
      MockFile mockFile0 = new MockFile("T", "&,*B");
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("tadMxv}yE5.E)dPcTCH", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test20()  throws Throwable  {
      File file0 = MockFile.createTempFile(".JdC~`y-];", "(line ");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      FileSystemHandling.shouldAllThrowIOExceptions();
  ...
  public void test21()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('x', character0, quote0, (Character) null, character0, true, true, (String) null, "", stringArray0, true);
  ...
  public void test28()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('$', character0, quote0, character1, character1, true, true, "", "d", stringArray0, true);
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("]p\"1F9z5s]^;!cwt");
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "]p\"1F9z5s]^;!cwt");
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      URL uRL0 = MockURL.getHttpExample();
