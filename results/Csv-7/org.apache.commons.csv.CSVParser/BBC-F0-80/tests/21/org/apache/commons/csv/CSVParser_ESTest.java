...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Ti:T");
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"5KNKfe]M$", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/|__0Ja}9M*[*YNy;");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "t7~vH(Z");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("|__", "Ja}9M*[*YNy;", (File) null);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(",|OgrGa~_a", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("S-{r9");
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("QHA$3e\"exD", cSVFormat1);
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader(",|ogrga~_a");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("S-{r9", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("S-{r9", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"rRY0&a%xv,E_gT", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      File file0 = MockFile.createTempFile("*9Tw&*S:Ex#NZ[q*4a", "*9Tw&*S:Ex#NZ[q*4a");
      Character character0 = new Character('*');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[4];
      CSVFormat cSVFormat0 = new CSVFormat('*', character0, quote0, character0, character0, false, false, "[de[f^", "the quotechar character and the delimiter cannot be the same ('", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      MockFile mockFile0 = new MockFile("T%;8 8?2PtcV1diIG");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      try { 
  ...
  public void test22()  throws Throwable  {
      File file0 = MockFile.createTempFile("FL&+Dz.}", "");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test24()  throws Throwable  {
      File file0 = MockFile.createTempFile("2wgTq;aG0hUu", "2wgTq;aG0hUu", (File) null);
  ...
  public void test25()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('|', character0, quote0, character0, character0, false, false, "org.apache.commons.csv.CSVRecord", "CommentStart=<", stringArray0, false);
  ...
  public void test27()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("QHA{e\"e>D");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("]vz=CeLZzk;B7t,`lwC", cSVFormat0);
      cSVParser0.close();
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("9k%?2BVN'`%J_", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      stringArray0[2] = "xt=$Z2";
      CSVFormat cSVFormat3 = cSVFormat2.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("!((~|'w4NWpxhvc.?K{", cSVFormat3);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("QHA$3e\"exD", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("Ja}9M*[*YNy;");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      long long0 = cSVParser0.getRecordNumber();
