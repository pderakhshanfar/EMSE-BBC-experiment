...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("~' '-znhYe[(!is+/~' '-znhYe[(!is+");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "org.apache.commons.csv.csvparser");
      MockFile mockFile0 = new MockFile("~' '-znhYe[(!is+", "~' '-znhYe[(!is+");
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("zbtncv>d'2", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test08()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("~' '-znhYe[(!is+", cSVFormat1);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('p', character0, quote0, character0, character0, true, true, "Jx", "\";li", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("l-!6I^qQ-`RjMO>");
      URL uRL0 = mockFile0.toURL();
      Quote quote0 = Quote.ALL;
      Character character0 = Character.valueOf('6');
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('6', (Character) null, quote0, (Character) null, character0, false, false, "l-!6I^qQ-`RjMO>", "", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('Z', character0, quote0, character0, character0, false, false, "", "", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      File file0 = MockFile.createTempFile("!7|%:MFlS->Wm!'?'", "!7|%:MFlS->Wm!'?'");
  ...
  public void test25()  throws Throwable  {
      File file0 = MockFile.createTempFile("VNbit", "VNbit");
      FileSystemHandling.shouldAllThrowIOExceptions();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test26()  throws Throwable  {
      StringReader stringReader0 = new StringReader("i;i|9~;s!|$j?");
      Quote quote0 = Quote.NONE;
      Character character0 = new Character('e');
      String[] stringArray0 = new String[4];
      CSVFormat cSVFormat0 = new CSVFormat('x', (Character) null, quote0, character0, character0, true, true, "i;i|9~;s!|$j?", "i;i|9~;s!|$j?", stringArray0, true);
  ...
  public void test31()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVParser cSVParser0 = CSVParser.parse("techas haract\r and tie delimit\r-cannt be the same ('", cSVFormat1);
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("(_p%e6)`_t6h8mwdd,b", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("techas haract\r and tie delimit\r-cannt be the same ('", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test38()  throws Throwable  {
      ...
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('o', (Character) null, quote0, (Character) null, character0, false, false, "e the same ('", "techas haract\r and tie delimit\r-cannt be the same ('", stringArray0, false);
      CSVParser cSVParser0 = CSVParser.parse("techas haract\r and tie delimit\r-cannt be the same ('", cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("~' '-znhYe[(!is+", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test42()  throws Throwable  {
      MockFile mockFile0 = new MockFile("@c\"?O4+", "");
      URL uRL0 = mockFile0.toURL();
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      // Undeclared exception!
