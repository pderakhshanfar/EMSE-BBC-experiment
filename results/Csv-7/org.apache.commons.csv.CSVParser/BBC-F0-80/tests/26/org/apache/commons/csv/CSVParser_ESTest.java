...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[2]", cSVRecord0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(".OI~kjIhphPhE", cSVFormat1);
  ...
  public void test10()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("fH", "S`y86-@]|a2q_BOn");
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('/', character0, quote0, character0, character0, false, false, "v6YEta/Xi", "org.apache.commons.csv.CSVParser$2", stringArray0, false);
      // Undeclared exception!
      try { 
        CSVParser.parse("v6YEta/Xi", cSVFormat0);
  ...
  public void test15()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("FSBNpy@=Y6", "FSBNpy@=Y6", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("reader", " SurroundingSpaces:ignored");
      Character character0 = Character.valueOf('j');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('=', character0, quote0, character0, character0, false, false, " EmptyLines:ignored", "url", stringArray0, false);
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("~e!v4e/ $v", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "UG> ((E+$<?xXU");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test22()  throws Throwable  {
      File file0 = MockFile.createTempFile(",b4{%m|%.[<CD{P", ",b4{%m|%.[<CD{P");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("0tsLF;4N6xmUJ.$");
      Character character0 = new Character('R');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[3];
      CSVFormat cSVFormat0 = new CSVFormat('R', character0, quote0, character0, character0, true, true, "", "0tsLF;4N6xmUJ.$", stringArray0, false);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(".OI~kjIhphPhE", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse(";C{gDGw&m", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("&]K7`Pt&Ya", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("yv 0&+u%=jj*&yo");
      CSVParser cSVParser0 = CSVParser.parse("vo-b/_6.bot1Xe", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('?', character0, quote0, character0, character0, true, true, "", "file", (String[]) null, true);
      // Undeclared exception!
      try { 
