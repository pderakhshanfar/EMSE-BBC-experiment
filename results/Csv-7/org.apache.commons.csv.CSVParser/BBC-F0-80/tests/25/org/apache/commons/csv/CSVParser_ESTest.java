...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "zjRry\"h|&s{-6m");
  ...
  public void test03()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("L1>vUp");
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("zjy;ry\"h|w&sb-6m", cSVFormat1);
  ...
  public void test09()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("INVALID", "", 392, "QuoteChar=<", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test10()  throws Throwable  {
      ...
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "\"I>Xl");
      URL uRL0 = MockURL.getHttpExample();
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('%', character0, quote0, character0, character0, true, true, "The comment start and the escape character cannot be the same ('", "&U#T&4=", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"}cMuv{q ;y", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("HH,E]Bql", "HH,E]Bql", (File) mockFile0);
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Rhk8wmVC3A~Im", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test18()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Rhk8wmVC3A~Im");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test20()  throws Throwable  {
      MockFile mockFile0 = new MockFile("org.apache.commons.csv.CSVParser$2", "9hy?h6/9vd}da&");
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$2", "9hy?h6/9vd}da&", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("lT{>/OCsk\"K;ITe'e");
      Character character0 = Character.valueOf('A');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[7];
      CSVFormat cSVFormat0 = new CSVFormat('A', character0, quote0, character0, character0, true, true, "", "lT{>/OCsk\"K;ITe'e", stringArray0, true);
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("INV`2LI?", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("reqd]r", cSVFormat0);
      cSVParser0.close();
  ...
  public void test31()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('J', character0, quote0, character0, character1, true, true, "g^m0fW*w ]", "", stringArray0, true);
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("zjRry\"h|&s{-6m", cSVFormat0);
