...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("cxi'<|;bxqww:sl[n");
      stringReader0.close();
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "cXi'<|;bXqwW:sL[n");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("cXi'<|;bXqwW:sL[n", cSVFormat1);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("sH$J/+hp\"@", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile(" SurroundingSpaces:ignored", "(<Tf4lUpq3.tMkv");
      Character character0 = Character.valueOf('\"');
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat0 = new CSVFormat('\"', character0, quote0, character0, character0, false, true, ") invalid parse sequence", "", (String[]) null, false);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse(") invalidparse sequence", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("'2>:sp");
      File file0 = MockFile.createTempFile("$wmind", "The comment start character and the quoteChar cannot be the same ('", (File) mockFile0);
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("-QvwY", cSVFormat2);
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[3] = "LhEP(3J$dw`<IKU@Sa";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("QsT?", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("`6&D(Q\"sP");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("cXi'<|;bXqwW:sL[n");
