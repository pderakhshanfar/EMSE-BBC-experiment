...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("f<7s{1p7[]7m:sbej}", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("M];dljv4*,V^S^)vt");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[M];dljv4*, V^S^)vt]", cSVRecord0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      StringReader stringReader0 = new StringReader("NTgp ");
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("DK<z", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("s$$o@}8(", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"KG5vc)9LiiO*0Py0cW", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("ze/R~<#R9\"", "\n{");
      Character character0 = Character.valueOf('b');
      Quote quote0 = Quote.ALL;
      CSVFormat cSVFormat0 = new CSVFormat('N', character0, quote0, character0, character0, true, false, "Mapping for %s not found, expected one of %s", "", (String[]) null, true);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("x<WJv;VO", cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader(">n>UTq>iy");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("url", "The header contains duplicate names: ", (File) null);
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("k')+w>n!KYlW&h)n ^6");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test26()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("GdrhC*", cSVFormat0);
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('T', character0, quote0, character1, character0, true, true, "*BN)fA", "*BN)fA", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("*BN)fA", cSVFormat0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      StringReader stringReader0 = new StringReader("k')+w>n!KYlW&h)n ^6");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("k')+w>n!KYlW&h)n ^6");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      StringReader stringReader0 = new StringReader("*BJe).A");
      Character character0 = Character.valueOf('*');
      Quote quote0 = Quote.ALL;
      Character character1 = new Character('g');
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('*', character0, quote0, character1, (Character) null, false, false, "`j$e?e!jh[N|u&B[q", "*BJe).A", stringArray0, true);
  ...
  public void test38()  throws Throwable  {
      ...
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('T', character0, quote0, character0, character0, true, true, "*BN)fA", "*BN)fA", stringArray0, true);
      MockFile mockFile0 = new MockFile("*BN)fA", ") invalid parse sequence");
      try { 
