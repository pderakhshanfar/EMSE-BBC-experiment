...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("=%YdXzj");
  ...
  public void test01()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("The quoteChar cannot be a line break");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "Q[#2:@;7NzYomjR'";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Q[#2:@;7NzYomjR'", cSVFormat1);
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Q[#2:@;7NzYomjR'", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("d@(,G]>q!I(Xt-fW=r", "d@(,G]>q!I(Xt-fW=r");
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("VKwzQ9*WO]2E)ROA+E", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("2*#nITi(", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("[u=O>5");
      File file0 = MockFile.createTempFile("wNDz", "wNDz", (File) mockFile0);
      Character character0 = Character.valueOf('V');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[8];
      CSVFormat cSVFormat0 = new CSVFormat('$', character0, quote0, character0, character0, true, true, "wNDz", (String) null, stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("]chaf~y>|=zyw{j", "the delimitr cannot be a line brea");
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("D5 U(&Uc%&Kl/", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("fr}~mat", "fr}~mat", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
      FileSystemHandling.shouldAllThrowIOExceptions();
      try { 
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("B[YU&kvp3%,");
      Character character0 = Character.valueOf('9');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[8];
      CSVFormat cSVFormat0 = new CSVFormat('9', character0, quote0, character0, character0, false, false, "B[YU&kvp3%,", "_t", stringArray0, false);
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("<p2yfr;");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("{~OmzOo19iL", cSVFormat0);
  ...
  public void test27()  throws Throwable  {
      StringReader stringReader0 = new StringReader("D5 U(&Uc%&Kl/");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test32()  throws Throwable  {
      ...
      stringArray0[0] = "Q[#2:@;7NzYomjR'";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("Q[#2:@;7NzYomjR'");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("Delimiter=<\t> Escape=<> CommentStart=<D> RecordSeparator=<\n> SkipHeaderRecord:false");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("D5 U(&Uc%&Kl/");
      CSVParser cSVParser0 = CSVParser.parse("D5 U(&Uc%&Kl/", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("ydy!");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
