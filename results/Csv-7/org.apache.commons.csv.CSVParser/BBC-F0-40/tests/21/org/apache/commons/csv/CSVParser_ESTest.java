...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("gie,4i*o_c`mb}i^=", cSVFormat1);
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("fN[]@hl3ML,;}[2", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("D6T@l.8[1nFfRU", "Index for header '%s' is %d but CSVRecord only has %d values!");
      File file0 = MockFile.createTempFile("y}abok:d", (String) null, (File) mockFile0);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("${,[D$ryp=;oTu");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[${, [D$ryp=;oTu]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("=C*P$x+mHv#p");
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("zN^,B");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("yRj5 G");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test11()  throws Throwable  {
      MockFile mockFile0 = new MockFile("IXd", "IXd");
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"}[w5u?2~kQ", cSVFormat1);
  ...
  public void test16()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("Gie,4i*o_C`MB}I^=", ")> (.", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("f@Fl2/cOb", "f@Fl2/cOb");
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("vi-|c'S[d388)0WL");
      Character character0 = Character.valueOf('E');
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[7];
      CSVFormat cSVFormat0 = new CSVFormat('E', character0, quote0, character0, character0, true, true, "vi-|c'S[d388)0WL", "vi-|c'S[d388)0WL", stringArray0, true);
  ...
  public void test26()  throws Throwable  {
      StringReader stringReader0 = new StringReader("G[?;Q]2OEGIM4|;");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("Gie,4i*o_C`MB}I^=");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Gie,4i*o_C`MB}I^=");
      String[] stringArray0 = new String[0];
