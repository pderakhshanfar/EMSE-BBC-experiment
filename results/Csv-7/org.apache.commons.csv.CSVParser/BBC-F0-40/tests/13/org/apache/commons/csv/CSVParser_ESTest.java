...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"y[-m", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[2] = "yBY|UJ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("yBY|UJ", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[yBY|UJ]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("bmSIsM6(oppO-Ef,E6");
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('j', character0, quote0, (Character) null, character0, false, false, "nb|m;km08J", "nb|m;km08J", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("kSja0$", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("format", "=w(r3I5j#:FC0n");
      Character character0 = Character.valueOf('Y');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[2];
      CSVFormat cSVFormat0 = new CSVFormat('?', character0, quote0, character0, character0, false, true, "d>rPq4Xjh%O1ss4T", "=w(r3I5j#:FC0n", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("ln[sL(_BW", "ln[sL(_BW");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      try { 
  ...
  public void test16()  throws Throwable  {
      StringReader stringReader0 = new StringReader(")EaF\"tC");
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("a]/h&Qap4#|");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("_j WB[Y/", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords((LinkedList<CSVRecord>) null);
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      File file0 = MockFile.createTempFile("(nexg-", "org.apache.commons.csv.Token");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("78)Oc<+");
      Character character0 = new Character('y');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[7];
      CSVFormat cSVFormat0 = new CSVFormat('y', character0, quote0, character0, character0, false, false, (String) null, "M:^n; [Fo#U=;V,U", stringArray0, false);
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(") invalid p\rKe sequence", cSVFormat0);
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      String[] stringArray0 = new String[0];
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/) invalid parse sequence0) invalid parse pequence");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "-0QrMFoi,,");
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile(") invalid parse sequence", ") invalid parse pequence");
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("L\u0005h\"Bzt@msy4{+", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("~+QZ.x8i~DBr", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("sM7j2 +yUBgrL.h<;", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(") invalid parse sequence", cSVFormat3);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
