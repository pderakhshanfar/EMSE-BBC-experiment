...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("LD2");
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("^;f\"@ak pF");
  ...
  public void test07()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Vg_>q#zfa3");
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('l', character0, quote0, character0, character0, true, true, (String) null, (String) null, stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Qc0[2P|mIl7#Oc\"2l", "INVALID");
      File file0 = MockFile.createTempFile("Ro!Ku}tkABVc8na=gE", "escape=<", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test15()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("fil5e");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "fil5e");
      MockFile mockFile0 = new MockFile("fil5e");
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("'=OrNRlC]");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("s>;m", cSVFormat0);
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Qs8b@");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("fil5e", cSVFormat0);
      cSVParser0.getRecords(linkedList0);
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("#f=zL^I{XA vyR1J", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[1] = "J]r";
      stringArray0[2] = "29<}%FB#(Ie{";
      stringArray0[3] = "307WZ}]u;t;a!TKLc?";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("sZ.q&c\"G", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("fil5e", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("f8v2[Z3");
      StringReader stringReader0 = new StringReader("f8v2[Z3");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("7A5W,");
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("G8?}WX\"", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
