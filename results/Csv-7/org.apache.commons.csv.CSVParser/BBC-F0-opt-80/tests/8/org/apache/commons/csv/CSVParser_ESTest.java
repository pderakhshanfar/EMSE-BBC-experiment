...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("]gAD]?!A#26");
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "(Ld`3`b\"&YIY~MBO'<.");
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("cQ$ca]cYXn5bcGK", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("50m-|st.Nus");
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("^W9)s8)X/;", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("(qJ", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("7|^2'_C;~", "org.apache.commons.csv.CSVRecord");
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVRecord", (String) null, (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/(D$*-G7'!v(Ro'0(D$*-G7'!v(Ro'");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("(D$*-G7'!v(Ro'", "(D$*-G7'!v(Ro'");
      try { 
  ...
  public void test21()  throws Throwable  {
      MockFile mockFile0 = new MockFile("~9XKzTH", "");
      File file0 = MockFile.createTempFile("~9XKzTH", "", (File) mockFile0);
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("S3}v+hN");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("^W9)s8)X/;");
      CSVParser cSVParser0 = CSVParser.parse("^W9)s8)X/;", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test26()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('P', (Character) null, quote0, (Character) null, character0, false, false, ":VRr", "bv8Hx\nZfh", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("bv8Hx\nZfh", cSVFormat0);
      cSVParser0.isClosed();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("%M1[,n=L[V");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[%M1[, n=L[V]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("G!,8dm", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test33()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("(D$*-G7'!v(Ro'", "(D$*-G7'!v(Ro'");
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/(D$*-G7'!v(Ro'0(D$*-G7'!v(Ro'");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "(D$*-G7'!v(Ro'");
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test37()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('P', (Character) null, quote0, (Character) null, character0, false, false, ":VRr", "bv8Hx\nZfh", stringArray0, true);
      MockFile mockFile0 = new MockFile("XZ3q<r ");
