...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "[(-}a)}42Qj-/r");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('t', character0, quote0, character0, character1, false, false, "org.apache.commons.csv.CSVFormat", "jLdBa@)", stringArray0, false);
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar('V');
      CSVParser cSVParser0 = CSVParser.parse("jLdBa@)", cSVFormat1);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("vc$[.:eA]", cSVFormat0);
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('H', character0, quote0, character0, character0, true, true, "", "", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("SAn\"?:$#[4z`]ksl", cSVFormat0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test15()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("Lsq@v1P&Olj! egJ$", (CSVFormat) null);
  ...
  public void test16()  throws Throwable  {
      ...
      Character character1 = new Character('V');
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('t', character0, quote0, character0, character1, false, false, "org.apache.commons.csv.CSVFormat", "*ml", stringArray0, false);
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar('V');
      try { 
        CSVParser.parse("#0eD0.,qV", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test17()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('t', character0, quote0, character0, character0, false, false, "org.apache.commons.csv.CSVFormat", "*ml", stringArray0, false);
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVFormat", "WH4Ox");
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      MockFile mockFile0 = new MockFile("p@pvTD3[8Tfjlxi3~", "");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      try { 
  ...
  public void test20()  throws Throwable  {
      File file0 = MockFile.createTempFile("VI\"XIYtr~?]!onccM5W", "VI\"XIYtr~?]!onccM5W");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('m', character0, quote0, character0, character0, false, true, "p,MK(:BjL+O", "VI\"XIYtr~?]!onccM5W", stringArray0, true);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[3];
      stringArray0[0] = "*ml";
      stringArray0[1] = "mP{M)>72`!R**P[=";
      CSVFormat cSVFormat0 = new CSVFormat('E', character0, quote0, (Character) null, character0, false, false, "org.apache.commons.csv.CSVFormat", "mL]ZU**c", stringArray0, true);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("52Rw 3DQP- qQ+Ppu", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("[E5VD=o_1Gwv", cSVFormat0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test33()  throws Throwable  {
      ...
      stringArray0[0] = "Lsq@v1P&Olj! egJ$";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test35()  throws Throwable  {
      StringReader stringReader0 = new StringReader("VI\"XIYtr~?]!onccM5W");
      Character character0 = new Character('');
      Quote quote0 = Quote.NONE;
      Character character1 = Character.valueOf('Y');
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('3', character0, quote0, character1, character0, true, false, "^nE'YkP'{`+D|", "VI\"XIYtr~?]!onccM5W", stringArray0, true);
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Lsq@v1P&Olj! egJ$", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
