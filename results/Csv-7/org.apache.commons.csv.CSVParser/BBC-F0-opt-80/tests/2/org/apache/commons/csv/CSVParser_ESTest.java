...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('j', character0, quote0, character0, character0, false, true, "Header:", "", stringArray0, true);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('j', character0, quote0, character0, character0, false, true, "Header:", "org.apache.commons.csv.Constants", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('P');
      URI uRI0 = MockURI.aHttpURI;
      URL uRL0 = MockURI.toURL(uRI0);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "Header:";
      stringArray0[1] = "";
      CSVFormat cSVFormat0 = new CSVFormat('j', character0, quote0, character0, character0, true, false, "Header:", "", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('P');
  ...
  public void test08()  throws Throwable  {
      ...
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('d', character0, quote0, character0, character0, true, true, "/io-47fB;l~Zi94", "reader", stringArray0, false);
  ...
  public void test09()  throws Throwable  {
      StringReader stringReader0 = new StringReader(".\"FMWc:Hm/,");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(";[c4Vp*aWa", cSVFormat1);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test16()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse(",\"chHm/", cSVFormat1);
  ...
  public void test17()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('d', character0, quote0, character0, character0, true, true, "/io-47fB;l~Zi94", "reader", stringArray0, false);
      File file0 = MockFile.createTempFile("dqy]N^, DE[[", "Q,pN");
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      File file0 = MockFile.createTempFile("Header:", "j]!f&");
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[Ivuo)JZ)");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test23()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$1", "( 9p^", (File) mockFile0);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("u@,}rr3!");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test27()  throws Throwable  {
      ...
      stringArray0[0] = "Header:";
      stringArray0[1] = "";
      CSVFormat cSVFormat0 = new CSVFormat('j', character0, quote0, character0, character0, false, false, "Header:", "", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('P');
      StringReader stringReader0 = new StringReader("??,");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      cSVParser0.isClosed();
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('s');
      CSVParser cSVParser0 = CSVParser.parse("s%|G", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("m(^btb", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[m(^b, b]", cSVRecord0.toString());
  }
  ...
  public void test32()  throws Throwable  {
      ...
      stringArray0[0] = "(Cj";
      stringArray0[1] = "etd:";
      stringArray0[2] = "@R*u8& BF1uq*`ZWK6;";
      stringArray0[3] = "(li,ne ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("m(^btb", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("[=-b[?[Sj");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      stringArray0[0] = "Header:";
      stringArray0[1] = "";
      CSVFormat cSVFormat0 = new CSVFormat('j', character0, quote0, character1, character0, false, false, "Header:", "", stringArray0, true);
      StringReader stringReader0 = new StringReader("??,");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("s%|G", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
