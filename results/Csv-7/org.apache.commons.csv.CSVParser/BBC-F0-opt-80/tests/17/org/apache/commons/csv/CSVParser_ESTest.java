...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"~sn%ami", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "The comment start and the escape character cannot be the same ('");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "6)Bk.:laj?2$-%B<`)9";
      stringArray0[1] = "78tI*4&Cfa(zbSQ(Y";
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Y-$fZ]F3LK", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("Xf}7,zerQat");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "xp'QICGfCI/!Cx1|D");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("P^V", cSVFormat2);
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("No quotes mode set but no escape character is set", "QuoteChar=<");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      String[] stringArray0 = new String[3];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      // Undeclared exception!
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("(A*sBqY}en>>L%,%Q,", "(A*sBqY}en>>L%,%Q,");
      Character character0 = Character.valueOf('X');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[3];
      CSVFormat cSVFormat0 = new CSVFormat('X', character0, quote0, character0, character0, false, true, "(A*sBqY}en>>L%,%Q,", "", stringArray0, true);
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("ot H&H;po", cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("The escape character cannot be a line break", "}k.$5Ua=$ZkF<J", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test20()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('7', character0, quote0, character0, character0, false, false, "", "", stringArray0, false);
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{g@_%i=.+qO{");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("VTnd{jj@(NBQW'^)on", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("m,9d", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[m, 9d]", cSVRecord0.toString());
  }
  ...
  public void test34()  throws Throwable  {
      String[] stringArray0 = new String[1];
      Quote quote0 = Quote.ALL;
      CSVFormat cSVFormat0 = new CSVFormat('E', (Character) null, quote0, (Character) null, (Character) null, true, true, "", "org.apache.commons.csv.Constants", stringArray0, true);
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("grk5NuN8<\"2'");
