...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("/o_", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      StringReader stringReader0 = new StringReader("g8RP;:@");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[g8RP;:@]", cSVRecord0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = MockFile.createTempFile("5Qe*)[&", "]w;rM<1I_S%#dv*");
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("`,+6dQo]b1,T8!J7", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('k', character0, quote0, character0, character0, true, false, "}", "}", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      MockFile mockFile0 = new MockFile("5^7", "5^7");
      File file0 = MockFile.createTempFile("5^7", "5^7", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
  ...
  public void test21()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('V', character0, quote0, character0, character0, false, false, "", "", stringArray0, false);
  ...
  public void test22()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('t', character0, quote0, character0, character0, false, false, (String) null, "", stringArray0, false);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"qR=Cm");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[2];
      stringArray0[0] = "6tnPn#&3(~.)\"<+";
      CSVFormat cSVFormat0 = new CSVFormat('c', character0, quote0, character1, (Character) null, true, true, ":j!j{b[<\"i{", "6tnPn#&3(~.)\"<+", stringArray0, true);
  ...
  public void test33()  throws Throwable  {
      StringReader stringReader0 = new StringReader("g8RP;:@");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("g8RP;:@");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
