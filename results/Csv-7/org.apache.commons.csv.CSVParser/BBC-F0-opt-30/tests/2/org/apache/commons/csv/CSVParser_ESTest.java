...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("DjU@*XS1|");
  ...
  public void test02()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("the quotechar character and the delimiter cannot be the same (/=Q@vE2v`20]");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('V', character0, quote0, (Character) null, character0, true, false, (String) null, "The quoteChar character and the delimiter cannot be the same ('", stringArray0, false);
      MockFile mockFile0 = new MockFile("the quotechar character and the delimiter cannot be the same (");
      File file0 = MockFile.createTempFile("=Q@vE2v`2", "]", (File) mockFile0);
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "q~t]&yQ5*80B";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("q~t]&yQ5*80B");
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("kZW(!ax)I", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('e', character0, quote0, character0, character0, false, false, "NullString=<", "NullString=<", stringArray0, false);
      // Undeclared exception!
      try { 
        CSVParser.parse("NullString=<", cSVFormat0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("?jKe.h(v", "");
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(" pO", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("'p5FG9");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      File file0 = MockFile.createTempFile("[y(:cjo>}", "H6TSz*");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("`FTr/hx.$5sF#w ");
      Character character0 = Character.valueOf('(');
      Quote quote0 = Quote.MINIMAL;
      CSVFormat cSVFormat0 = new CSVFormat('D', character0, quote0, character0, character0, true, true, "y#LUIq[", "xA6~2kUjVlo|=tHg", (String[]) null, true);
  ...
  public void test25()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("/grhtlne$'", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse(":|6,dx%j\"tTk'Nr", cSVFormat0);
  ...
  public void test35()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat(' ', character0, quote0, character0, character0, false, true, "\r\n", "!dgXS5G2[xEp72[U{", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(']');
