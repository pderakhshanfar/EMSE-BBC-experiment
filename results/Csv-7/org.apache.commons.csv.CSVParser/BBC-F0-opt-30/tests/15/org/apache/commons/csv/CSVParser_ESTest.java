...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("6=Rkwzk$4^nxU:/:q1&nkbp9h{Bov$z>0OG^foK,za/CM[|CjR");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "format");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("6=Rkwzk$4^nxU:");
      File file0 = MockFile.createTempFile(":q1&nkbp9h{Bov$z>", "OG^foK,za/CM[|CjR", (File) mockFile0);
  ...
  public void test03()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("c7{arset");
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("H9rGUniawf%;@3~", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("`9\"2D7SY$-[:_kc5", "nnf+hrs.l+");
  ...
  public void test10()  throws Throwable  {
      ...
      stringArray0[0] = "`9\"2d7sy$-[:_kc5";
      stringArray0[1] = "org.apache.commons.csv.CSVParser$1";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("rdU]I]SU]Z", cSVFormat1);
  ...
  public void test16()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"zj@KKu[-k1q8T cR&@", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test17()  throws Throwable  {
      File file0 = MockFile.createTempFile("W. WI:&g<", "g;7", (File) null);
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("$5M\"'5Z|#:%k", cSVFormat0);
      cSVParser0.close();
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Huzf1O,}#J Xgqp'", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("5W{c7DPg`/charset/BXwG'rHq#0vc$cV");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      MockFile mockFile0 = new MockFile("5W{c7DPg`");
      MockFile mockFile1 = new MockFile(mockFile0, "charset");
      File file0 = MockFile.createTempFile("BXwG'rHq#", "vc$cV", (File) mockFile1);
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
      try { 
        cSVParser0.close();
        fail("Expecting exception: IOException");
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("`|frset", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile(",% a8wzz", "nvi");
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test37()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('{', (Character) null, quote0, (Character) null, character0, true, false, "Unexpected Token type: ", ",% a8wzZ", stringArray0, true);
