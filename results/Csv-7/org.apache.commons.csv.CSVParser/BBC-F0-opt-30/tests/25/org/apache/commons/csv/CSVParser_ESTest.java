...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("b:xs");
      stringReader0.close();
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "5sS");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("`-LsN*", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("m!%lzp<RQ-<?*");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test07()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("5sS");
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('\\', character0, quote0, character0, character0, true, false, "lo", "lo", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("lo", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("fc3^ol{?dsX");
  ...
  public void test13()  throws Throwable  {
      ...
      Quote quote0 = Quote.ALL;
      CSVFormat cSVFormat0 = new CSVFormat('a', character0, quote0, character0, character0, true, true, (String) null, "", (String[]) null, true);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("rB5=l>]K", "rB5=l>]K");
      FileSystemHandling.shouldAllThrowIOExceptions();
      Quote quote0 = Quote.ALL;
      Character character0 = Character.valueOf('K');
      Character character1 = new Character('r');
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('>', (Character) null, quote0, character0, character1, false, false, (String) null, "out", stringArray0, true);
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("l*`N@<kxl=E>", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test18()  throws Throwable  {
      StringReader stringReader0 = new StringReader("p3R3P'.tP:g");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("x33$A,(oWEfN(F+I", "CSVParser has been closed");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("=7WQ6vZ", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      StringReader stringReader0 = new StringReader("]uZq+");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("]uZq+");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      StringReader stringReader0 = new StringReader("]uZq+");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("rO/}'@-vY=.UEx|`");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
