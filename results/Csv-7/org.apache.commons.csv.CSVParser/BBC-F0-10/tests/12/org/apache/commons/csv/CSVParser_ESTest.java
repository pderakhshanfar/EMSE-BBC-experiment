...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("<M)jX;", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Z(q6#}W");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "r";
      stringArray0[1] = "K l{2E1%$Mkf";
      stringArray0[2] = "reader";
      stringArray0[3] = "(line ";
      stringArray0[4] = " [";
      stringArray0[5] = "";
      stringArray0[6] = "V`$uLMS S1&h&>eU>K";
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("%as'~", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[%as'~]", cSVRecord0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("g5TuOU", cSVFormat1);
  ...
  public void test08()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("d||k6:0#lz2kvo");
      CSVParser cSVParser0 = CSVParser.parse("g5TuOU", cSVFormat2);
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("OOfU\u0004X*7?1Ox:VT", "OOfU\u0004X*7?1Ox:VT");
      URL uRL0 = file0.toURL();
      Character character0 = Character.valueOf('I');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[9];
      CSVFormat cSVFormat0 = new CSVFormat('a', character0, quote0, (Character) null, character0, false, true, "OOfU\u0004X*7?1Ox:VT", "OOfU\u0004X*7?1Ox:VT", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("h633?E4DM_!L;U <_", cSVFormat2);
  ...
  public void test14()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("Nw|^_60uNw", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("/l*c", "/l*c");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test22()  throws Throwable  {
      StringReader stringReader0 = new StringReader("0.%i-bUb");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("G1y;", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("&gw:P36f0?Y,7");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("n[Ujk", cSVFormat0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("Parameter '", "}8N'5~");
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("zbb`", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
