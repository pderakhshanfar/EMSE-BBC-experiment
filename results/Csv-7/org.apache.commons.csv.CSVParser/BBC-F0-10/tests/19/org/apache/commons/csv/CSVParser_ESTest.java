...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      StringReader stringReader0 = new StringReader("aRLvI;G9r@Ybu-+ar");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("OnriBg", cSVFormat1);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('{');
      StringReader stringReader0 = new StringReader("b,iTSZq");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test11()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('V', character0, quote0, character0, (Character) null, true, false, "charset", "url", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("{<Fb Vhz2T%A_`^gtuB", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("{7QrUF=k,\"'d  Ly", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("^`17yD", "CSVParser has been closed", (File) mockFile0);
      Character character0 = Character.valueOf('4');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[7];
      CSVFormat cSVFormat0 = new CSVFormat('J', character0, quote0, character0, character0, true, true, "3vYq", "(startline ", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Ht9U+:l L<C");
      Character character0 = Character.valueOf('d');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[8];
      CSVFormat cSVFormat0 = new CSVFormat('0', character0, quote0, character0, character0, false, false, "Ht9U+:l L<C", "Ht9U+:l L<C", stringArray0, false);
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader("&X;rr");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("W#$k 8", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("DKjBL%>|", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("b,iTSZq", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('X');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("]P9\"jYaQ5tv");
      CSVParser cSVParser0 = CSVParser.parse("]P9\"jYaQ5tv", cSVFormat1);
      // Undeclared exception!
      try { 
        cSVParser0.getRecords((LinkedList<CSVRecord>) null);
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('{');
      CSVParser cSVParser0 = CSVParser.parse("b,iTSZq", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("q<fwG1;5ZS");
      try { 
