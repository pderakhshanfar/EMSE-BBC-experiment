...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("37~R7YNeF;a[-", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, ".KCsZGJ-#IYE?de&");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "p7toyuge(vq)bpv/v";
      stringArray0[1] = "m 8_bm7";
      stringArray0[2] = "No more CSV records available";
      stringArray0[3] = "[-H1@# ~t:!4/,[Y;`";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("p7toyuge(vq)bpv/v", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[p7toyuge(vq)bpv/v]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("m 8_bm7", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[m 8_bm7]", cSVRecord0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("%[\rryi~.4", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('b', character0, quote0, character0, character0, false, false, "format", "^mI0rl", stringArray0, true);
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, ".KCsZGJ-#IYE?de&");
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("OPG\"~Z", "");
  ...
  public void test13()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('b', character0, quote0, character0, character0, false, false, "format", "^mk0rl", stringArray0, true);
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('a', character0, quote0, character0, character0, false, false, "MFq\"\">f/;)'I1", "c(?-,thV[HK>x*EP2)D", stringArray0, false);
      // Undeclared exception!
      try { 
        CSVParser.parse("MFq\"\">f/;)'I1", cSVFormat0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test19()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("4Uq");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "La-1oZ58]l=T");
      Quote quote0 = Quote.MINIMAL;
      Character character1 = Character.valueOf('M');
      FileSystemHandling.shouldAllThrowIOExceptions();
      CSVFormat cSVFormat0 = new CSVFormat('-', character0, quote0, character1, character1, true, true, "url", "<mp", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      MockFile mockFile0 = new MockFile("4Uq");
      try { 
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("CS", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test25()  throws Throwable  {
      StringReader stringReader0 = new StringReader("HUQ6km@q[PU7vtlz]*");
  ...
  public void test27()  throws Throwable  {
      ...
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('h', (Character) null, quote0, character0, (Character) null, true, false, "?f)qW;)mb*&5@", "?f)qW;)mb*&5@", stringArray0, false);
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test29()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("r??ar|-p6Vs<~[OLa'");
  ...
  public void test32()  throws Throwable  {
      ...
      stringArray0[0] = "D8jIM$g\"SRt8-U5O";
      stringArray0[1] = "D\"1Ub6[W7i8{.=M<:{";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      StringReader stringReader0 = new StringReader("D8jIM$g\"SRt8-U5O");
  ...
  public void test34()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("UibM4qa#JRQPTL", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
      assertNotNull(map0);
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("UibM4qa#JRQPTL", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("fFF", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
