...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("wxm 5$d2AZkQ4<bfx", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("(xyxLh&MhGH*", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("KXTVT}Y'`L+$jR&Voi");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[KXTVT}Y'`L+$jR&Voi]", cSVRecord0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile((File) null, "1n?,VRrR0'hsy");
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"?[vV Pq3vQy_]\"W+z\"", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("org.apache.commons.csv.ExtendedBufferedReader", " tf/p^-iW*n!<v~vTPg", (File) null);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("VzsPhY|bq|x$WP", cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
        cSVParser0.getRecords(linkedList0);
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("wvb");
      Character character0 = Character.valueOf('S');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[7];
      CSVFormat cSVFormat0 = new CSVFormat('S', character0, quote0, character0, character0, false, true, "wvb", (String) null, stringArray0, false);
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('`');
      CSVParser cSVParser0 = CSVParser.parse(" tf/p^-iW*n!<v~vTPg", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("x{:Oe[w=3b");
      CSVParser cSVParser0 = CSVParser.parse("x{:Oe[w=3b", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      stringArray0[2] = "q,i&s^";
      stringArray0[3] = "cy:04sqT*:x68";
      CSVFormat cSVFormat0 = new CSVFormat('6', character0, quote0, (Character) null, (Character) null, true, true, "q,i&s^", "q,i&s^", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("PKp7qb=YJA6RFFm)", cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
