...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"JEg MgsU6R57", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("lmdekk1ou\"ny9xnt?p", cSVFormat0);
      cSVParser0.close();
  ...
  public void test05()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("|*PUI!", cSVFormat1);
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("OS9.[DPn$CNXWN]^`U");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("^J^q;A[;FJ8B", "^J^q;A[;FJ8B");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test15()  throws Throwable  {
      StringReader stringReader0 = new StringReader("cPrQ");
      CSVFormat cSVFormat0 = CSVFormat.newFormat(')');
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(" w=t1f@7mv*", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("lMDMKKwoUiNy9XNt?P", cSVFormat0);
      cSVParser0.close();
  ...
  public void test20()  throws Throwable  {
      StringReader stringReader0 = new StringReader("n%@.%>ZT.@");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[4];
      stringArray0[0] = "lmdmakwouiny9xnt?p";
      stringArray0[1] = "(#+C\"0u`DT";
      stringArray0[2] = "org.apache.commons.csv.CSVPrinter$1";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("(#+C\"0u`DT", cSVFormat2);
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("6W^/?74e7qzcc;", cSVFormat1);
  ...
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader("cPrQ");
      CSVFormat cSVFormat0 = CSVFormat.newFormat(')');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("cPrQ");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("5TNE/J-iyug");
      CSVParser cSVParser0 = CSVParser.parse(" w=T1F@7mv*", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("6W^/?74e7qzcc;", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(' ');
      File file0 = MockFile.createTempFile("9SA5^s:(tO", "Delimiter=< > NullString=<3Hrc.cacdil;pB0}o;&> SkipHeaderRecord:false Header:[M5, W``3OH]w83CD <4e0]");
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('}');
      CSVParser cSVParser0 = CSVParser.parse("&g!8pfyf<;e!5x)", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
