...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile((String) null, "`Xk`%=?omD, o_C4}`1");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[P]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("c#%f>)Y 'aH/N^u.");
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"rt|pBkYA<W|wp6", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("yC{Ngm2MS1h={X;", "dM+(giFN<");
      Quote quote0 = Quote.NON_NUMERIC;
      Character character0 = Character.valueOf('T');
      String[] stringArray0 = new String[9];
      CSVFormat cSVFormat0 = new CSVFormat('T', (Character) null, quote0, character0, (Character) null, true, true, "dM+(giFN<", "dM+(giFN<", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("J,;T\"KlS");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('a', character0, quote0, character0, character0, false, false, "s=y?,4I7LSJ,f", "s=y?,4I7LSJ,f", stringArray0, true);
  ...
  public void test23()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("UM6");
      stringReader0.read();
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("FEuoGW`M_.or", cSVFormat0);
      cSVParser0.close();
  ...
  public void test28()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("3_S^,?[R'Y%vy{", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("J,;T\"KlS");
      CSVParser cSVParser0 = CSVParser.parse("3_S^,?[R'Y%vy{", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
