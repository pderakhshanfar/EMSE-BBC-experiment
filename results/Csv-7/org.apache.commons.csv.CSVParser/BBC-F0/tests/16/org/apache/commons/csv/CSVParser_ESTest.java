...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[0] = ";=wh";
      stringArray0[1] = "UOWrvI>ElmjS8";
      stringArray0[2] = "$tufmex2><1`";
      stringArray0[3] = "org.apache.commons.csv.CSVRecord";
      stringArray0[4] = "9";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      CSVParser cSVParser0 = CSVParser.parse("dY{_^{ac:%", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("dhUFjWI~:!*,", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("dhUFjWI~:!*,");
      CSVParser cSVParser0 = cSVFormat2.parse(stringReader0);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[dhUFjWI~:!*, ]", cSVRecord0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("Q\"^CN1wnKSF:L;SB$4a");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("e^phxlik=la~");
      File file0 = MockFile.createTempFile("e^phxlik=la~", "d|e>3o<-sasvr", (File) mockFile0);
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("73", cSVFormat0);
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("+`A`?pF#}=g%V:v+");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      stringReader0.close();
      try { 
        cSVParser0.getRecords();
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("73", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("73");
      CSVParser cSVParser0 = CSVParser.parse("73", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test35()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("Delimiter=<,> QuoteChar=<\"> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false Header:[null]", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
