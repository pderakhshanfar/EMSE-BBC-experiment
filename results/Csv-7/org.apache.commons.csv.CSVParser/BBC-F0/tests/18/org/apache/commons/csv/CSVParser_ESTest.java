...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"1+/Jn~'h1Z", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("V)H'i6,e7Z.~", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("2|(1@WlNm{?;K'", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Rv3/1$|,AZk(");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[Rv3/1$|, AZk(]", cSVRecord0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse(stringArray0[0], cSVFormat1);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // The header contains duplicate names: [@|yX, null, null, null, null, null, null, null, null]
         //
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"~\"Y2GrM]<'FxZ$~", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      ...
      String[] stringArray0 = new String[9];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("M~pzu", "a(");
      File file0 = MockFile.createTempFile("su#9`v6PZ(#)$h", "M~pzu", (File) mockFile0);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('E', (Character) null, quote0, character0, character0, true, true, "", "", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("gdVP{");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
  ...
  public void test20()  throws Throwable  {
      StringReader stringReader0 = new StringReader(";o$Q_ ~yM1v*N;X\"hFV");
      Character character0 = Character.valueOf('0');
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[7];
      CSVFormat cSVFormat0 = new CSVFormat('S', character0, quote0, character0, character0, false, false, ";o$Q_ ~yM1v*N;X\"hFV", (String) null, stringArray0, false);
  ...
  public void test21()  throws Throwable  {
      ...
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[2];
      CSVFormat cSVFormat0 = new CSVFormat(';', character0, quote0, (Character) null, character0, true, false, "", "", stringArray0, false);
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test22()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("L2>pT%+zSES `-268h`");
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("9dphb");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[1] = "q?7c57";
      stringArray0[2] = "A`TJd@@2RC-;Fw.";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("+[v77_(j2IAkHV68)4w", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[+[v77_(j2IAkHV68)4w]", cSVRecord0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("e<d.7}[Y ,z$?P");
      CSVParser cSVParser0 = CSVParser.parse("e<d.7}[Y ,z$?P", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
