...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("SU/h-#kc");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "op9QKdPmx.uD3Z-$/Fc";
      ...
      CSVParser cSVParser0 = CSVParser.parse("KU-;a", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[KU-;a]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("sr@0`YOYVdcMwFU*p0");
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("SU3h-#kc");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("Qf<c[9O3kKa 33MF", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("A<}qp\"h4", "A<}qp\"h4");
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("<!1-A,", "b");
      try { 
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("gig^b\"9");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("Ol\"ne,", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("]#.yD_,Y$U1<Ad?[->");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse(")j%u=>JM|aZ)['MW", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test22()  throws Throwable  {
      StringReader stringReader0 = new StringReader("\tNeP\"}?,Y=");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
