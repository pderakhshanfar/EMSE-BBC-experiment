...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"|8Jt", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "yHVv%g\"CY";
      stringArray0[1] = "@.[{.Aa";
      stringArray0[2] = "N6~P'J 0+H";
      ...
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[@.[{.Aa]", cSVRecord0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("uY-f}FW~+?N$NzaL8");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test10()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("3", "3", 364, "3", uRLStreamHandler0);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('\"', character0, quote0, character0, character0, true, true, "", "X8b", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("X8b", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('0', (Character) null, quote0, (Character) null, character0, false, false, "<+ O(E", "<+ O(E", stringArray0, false);
      try { 
        CSVParser.parse("<+ O(E", cSVFormat0);
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("g2\"cOp*i", "^B");
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("wD", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("wD", cSVFormat1);
  ...
  public void test26()  throws Throwable  {
      ...
      stringArray0[0] = "xc/z(mr9!";
      stringArray0[1] = "The comment start and the escape character cannot be the same ('";
      stringArray0[2] = "s;X,1(DIE";
      stringArray0[3] = "r$S";
      stringArray0[4] = "%c=c5";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("s;X,1(DIE", cSVFormat2);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("S");
      CSVParser cSVParser0 = CSVParser.parse("\":pV'~c", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
