...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\"pDRm2V");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\u0002l#*m]*pu57|7:'", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("8JF#q,(k3TQ<M!4", cSVFormat0);
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("A:|m%5Wfs", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('1', (Character) null, quote0, character0, character0, true, true, "!q2;Dj6<B4", "!q2;Dj6<B4", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("!q2;Dj6<B4", cSVFormat0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"c;+p", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('+', character0, quote0, character0, character0, false, true, "", "Unexpected Token type: ", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      File file0 = MockFile.createTempFile("_J%Gv}'mp}a", "_J%Gv}'mp}a");
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/_J%Gv}'mp}a0_J%Gv}'mp}a");
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("(line ", "org.evosuite.runtime.testdata.FileSystemHandling@0000000007\torg.apache.commons.csv.CSVFormat@0000000004\torg.apache.commons.csv.CSVFormat@0000000004");
      try { 
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader("3\"HZ*6o");
      Character character0 = Character.valueOf('5');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[4];
      CSVFormat cSVFormat0 = new CSVFormat('5', character0, quote0, character0, character0, true, true, "", "3\"HZ*6o", stringArray0, true);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("k4@Q!5LBt_Ngw/C{,*:", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Yb\"JJ<RO3%0kaG", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('|', character0, quote0, character0, character0, false, false, ":abH;]/", "#KQ*rXc9", stringArray0, true);
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Jz#A6,H@", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[Jz#A6, H@]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("FtU");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test36()  throws Throwable  {
      StringReader stringReader0 = new StringReader("(b\"B4m.f>EDi");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("(b\"B4m.f>EDi");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
