...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"\"[E!_dYXy%U\f,GL]", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "XhA");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = " O@>z/l";
      stringArray0[1] = "+?B<R|JL0D4Q";
      stringArray0[2] = "b1qaf'l6x[}p";
      stringArray0[4] = "g#;4=iz%9\"(3m`| ";
      stringArray0[5] = "token";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("+?B<R|JL0D4Q", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[+?B<R|JL0D4Q]", cSVRecord0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(">jPq", cSVFormat0);
      cSVParser0.close();
  ...
  public void test08()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("N7!7L94#Ok6d:jJnE-");
  ...
  public void test14()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("|_WlZctc~]rex7@", (CSVFormat) null);
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"5.WWb )8j1U", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("gV<@C~x");
      File file0 = MockFile.createTempFile("gV<@C~x", "org.apache.commons.csv.CSVParser$2", (File) mockFile0);
      String[] stringArray0 = new String[6];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("G#;4=iZ%9\"(3m`| ", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test20()  throws Throwable  {
      File file0 = MockFile.createTempFile("]NwB='5i5dgnM", "]NwB='5i5dgnM");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test22()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("Ul6Q0;<;\u0000F=73lY", "Ul6Q0;<;\u0000F=73lY", (File) mockFile0);
  ...
  public void test25()  throws Throwable  {
      StringReader stringReader0 = new StringReader("|[`4t4~&]zqd\"");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      stringReader0.close();
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("fkrmae", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("B1Qaf'L6X[}p", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[B1, af'L6X[}p]", cSVRecord0.toString());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("B1Qaf'L6X[}p");
      CSVParser cSVParser0 = CSVParser.parse("B1Qaf'L6X[}p", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("40.Mq", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
