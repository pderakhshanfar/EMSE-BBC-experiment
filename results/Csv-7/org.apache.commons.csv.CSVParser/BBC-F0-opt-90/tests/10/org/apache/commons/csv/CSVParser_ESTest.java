...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\"\">rsd\"nO[Cs+`ipI~");
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, ") EOF reached before encapsulated token finished");
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("'lC9");
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("'lC9/S#@Lo0S#@Lo");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "/MQ");
      File file0 = MockFile.createTempFile("S#@Lo", "S#@Lo", (File) mockFile0);
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("m{gE'N&9");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("fs:Mn");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test08()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("&CbbCt3");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("@p-D", cSVFormat1);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"=mO?:\";KlTHX=z", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("@p-D");
      File file0 = MockFile.createTempFile("!`AicJ~66r\"(2gqk", (String) null, (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[2];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      // Undeclared exception!
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("VU%pKUWlk", "VU%pKUWlk");
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile(">e^V+");
      try { 
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("KDNDGx>{|Q7.kr1&", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test23()  throws Throwable  {
      MockFile mockFile0 = new MockFile((File) null, "HE[E%S?([Jsz");
      File file0 = MockFile.createTempFile("HE[E%S?([Jsz", "HE[E%S?([Jsz", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("'lC9", cSVFormat0);
  ...
  public void test33()  throws Throwable  {
      File file0 = MockFile.createTempFile("auc>&#:+", "LY('T!T!Xc>Dg", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      String[] stringArray0 = new String[2];
      stringArray0[0] = "LY('T!T!Xc>Dg";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("nw");
      CSVParser cSVParser0 = CSVParser.parse("nw", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("`DgeQU]\"{");
      CSVParser cSVParser0 = CSVParser.parse("NW", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("S4ovjH<1s%e", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
