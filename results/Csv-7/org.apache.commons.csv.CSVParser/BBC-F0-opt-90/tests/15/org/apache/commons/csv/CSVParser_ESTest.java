...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "oxqHTL=~Z[L");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("`ky0 ]", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "^lF.sET";
      stringArray0[1] = "5CQ=/'Wr@Q";
      stringArray0[2] = "";
      stringArray0[3] = "9iQmPO#*Y,";
      stringArray0[4] = " i(`M";
      stringArray0[5] = "3,Sp";
      ...
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[org.apache.commons.csv.CSVFormat]", cSVRecord0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[{TU]", cSVRecord0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile("|)E~[;K>dD6.1%_");
      File file0 = MockFile.createTempFile("|)E~[;K>dD6.1%_", "|)E~[;K>dD6.1%_", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("vQD\"u2dpu,6 W8Y-~", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('6', character0, quote0, character0, character0, false, false, "y^;t#Xh??xG{\"-m6m", "y^;t#Xh??xG{\"-m6m", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('X', character0, quote0, character0, character0, true, true, "", "F7|FotM0w>}n}", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("3,Sp", cSVFormat0);
  ...
  public void test17()  throws Throwable  {
      String[] stringArray0 = new String[0];
      File file0 = MockFile.createTempFile("E+'Yat8kucP-^{&[", "E+'Yat8kucP-^{&[");
      Character character0 = Character.valueOf('h');
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat0 = new CSVFormat('h', character0, quote0, character0, character0, true, true, "WD;x+|aBFL7:N9X", "WD;x+|aBFL7:N9X", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('e', character0, quote0, character0, character0, true, true, "TtA", "TtA", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("*z{Q", "*z{Q");
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("+]]srD8RP1.9t|T,");
  ...
  public void test23()  throws Throwable  {
      File file0 = MockFile.createTempFile("h0jbx#viin$>v?;os", "d^");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      FileSystemHandling.shouldAllThrowIOExceptions();
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
      try { 
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("vQD\"2pu,6 W8Y7-~", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\"');
      CSVParser cSVParser0 = CSVParser.parse("hB::[>=Wl9N yW7jj", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("d", cSVFormat3);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("NV2A");
      CSVParser cSVParser0 = CSVParser.parse("CS]b_'b>7$#&f", cSVFormat1);
      // Undeclared exception!
      try { 
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("&JDv[mq_.?T/", "&JDv[mq_.?T/");
      try { 
