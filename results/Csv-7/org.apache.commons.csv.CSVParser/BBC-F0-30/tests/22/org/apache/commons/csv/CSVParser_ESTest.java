...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"z~`-\";zt.BT]w4>wb", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "+jbqj}p2zfo");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("8fO}", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "J:zKSF{hW");
      Charset charset0 = Charset.defaultCharset();
      Character character0 = new Character('M');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('T', character0, quote0, character0, character0, false, false, "", "", stringArray0, false);
      // Undeclared exception!
      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("Y%+S3_Sk\"4{", cSVFormat2);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test16()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.csv.csvparser", "file");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("MG*+w%<&(d\"?%~y?M>:");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("txk-p?)d9!g&b(mc");
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("dv;z#RZj~qqg&K>D");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords((LinkedList<CSVRecord>) null);
  ...
  public void test22()  throws Throwable  {
      StringReader stringReader0 = new StringReader("f.rvs:j7\".[7nF:");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("v5@l`P8|i");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("n.gpnPd,LXBS5o\"uN", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("poh&oi{kd5:gy0cnn+", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      stringArray0[0] = "uO[xDuKGkD\"Y*\"^da";
      stringArray0[1] = ") eof reached before encapsulated token finished";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("AZ}8<]}hK+Hi@", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("8fO}", cSVFormat2);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("The header contains duplicate names: ", cSVFormat2);
  ...
  public void test35()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("^VP#", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      StringReader stringReader0 = new StringReader("The header containsduplicate names: ");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  ...
  public void test38()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.csv.Token$Type", "bgM#I5m+se^DN0");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('>');
      File file0 = MockFile.createTempFile("rn\"\"ibV(", "rn\"\"ibV(");
