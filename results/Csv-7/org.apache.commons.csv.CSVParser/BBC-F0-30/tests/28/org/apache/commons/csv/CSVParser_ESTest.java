...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("file/uIl");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "uIl");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("file", "uIl");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("^MR-dAt%z[8g!<G&");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "js@b8pt1wR";
      stringArray0[1] = "v`ds*^0~l+au*E^W";
  ...
  public void test06()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("7w5R^{z");
  ...
  public void test11()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('\'', character0, quote0, character0, character0, true, false, "9c~na", "9c~na", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("9c~na", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("jv`/q$`pzlgp", "");
      File file0 = MockFile.createTempFile("No header mapping was specified, the record values can't be accessed by name", "!", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("y~wq5", "B", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("XY+[6oc/H)kV:Q]");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      Quote quote0 = Quote.NON_NUMERIC;
      stringReader0.close();
      CSVFormat cSVFormat0 = new CSVFormat('!', character0, quote0, character0, character0, false, true, (String) null, (String) null, (String[]) null, true);
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("J;HJB#p6qD*1E=9*#");
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("7w% ^{z");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
  ...
  public void test26()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("9H|I~sUx.iq!z");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ujl");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("ujl", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ujl");
      CSVParser cSVParser0 = CSVParser.parse("uIl", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("h dN");
