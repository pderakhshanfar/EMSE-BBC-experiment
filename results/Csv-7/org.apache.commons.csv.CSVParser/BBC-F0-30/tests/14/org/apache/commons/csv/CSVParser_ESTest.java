...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"3kjZ", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("6n=rx", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("wO! pN\"?/F$^", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"=sK]WY{4o^gF", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("6n=rx", "");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile((String) null, "h_b{");
      File file0 = MockFile.createTempFile("h_b{", "h_b{", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("AA i3atik447Vh\"r");
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("pQ(tO", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test21()  throws Throwable  {
      File file0 = MockFile.createTempFile("f^yw6czjia&ko", "NullString=<");
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("9g]u_tj}\"[8", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVParser cSVParser0 = CSVParser.parse("wO!eN(O8F$8", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("A76C=Ek!'L", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("l~`{b9# fc", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(">OxL]r", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("F^yW6CzjiA&KO");
      CSVParser cSVParser0 = CSVParser.parse("l~`{b9# fc", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("l~`{b9C0 fo", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
