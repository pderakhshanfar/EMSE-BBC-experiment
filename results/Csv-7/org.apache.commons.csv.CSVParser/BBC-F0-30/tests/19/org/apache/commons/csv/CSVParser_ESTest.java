...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "`y\"zv6)auk-");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "6cs6G%y[C[.?";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("!5Z85ie/!j}UlA", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test08()  throws Throwable  {
      ...
      stringArray0[0] = "agR{B)$XQX(x3";
      stringArray0[1] = "";
      stringArray0[2] = "9}e<zpu<,eAOCuklr?0";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("");
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("'`+T>8 eGQ7$\"mD1", "Fb^YJ 6]F#Cu| K");
      File file0 = MockFile.createTempFile("Fb^YJ 6]F#Cu| K", "(line ", (File) mockFile0);
      Character character0 = new Character('\"');
      Quote quote0 = Quote.ALL;
      CSVFormat cSVFormat0 = new CSVFormat('\"', character0, quote0, character0, character0, false, true, "`U8eP@M$;78p!WX", "(line ", (String[]) null, true);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/The comment start and the escape character cannot be the same ('0The comment start and the escape character cannot be the same ('");
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("-_HYKV@", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test21()  throws Throwable  {
      MockFile mockFile0 = new MockFile(":8R$F");
      File file0 = MockFile.createTempFile(":8R$F", ":8R$F", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test22()  throws Throwable  {
      StringReader stringReader0 = new StringReader("K+hFWOCi*");
      Character character0 = Character.valueOf('4');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('4', character0, quote0, character0, character0, true, true, "", "K+hFWOCi*", stringArray0, true);
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("9H:O/hg!MS'p%^X)'<");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("-_3yykvo@", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("]/kYU", "", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("p1@v?ne:EGf_d.M@~Md");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("T$4` ", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("7S-!J8u");
      StringReader stringReader0 = new StringReader("7S-!J8u");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test38()  throws Throwable  {
      StringReader stringReader0 = new StringReader("e&uY<p~Iio't;1");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
