...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("p_zmni#o", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("J>VaA|", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("J)fbWNPfDTlg");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("'vnt", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("p_zmni#o", cSVFormat2);
  ...
  public void test07()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("klaQy):1");
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("+QLT[6", (CSVFormat) null);
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("~ mzX<&)]*}%j-OH#wQ");
      File file0 = MockFile.createTempFile("~ mzX<&)]*}%j-OH#wQ", "~ mzX<&)]*}%j-OH#wQ", (File) mockFile0);
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Rn2t)9252byIEXX6%lo", "Rn2t)9252byIEXX6%lo");
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/n8uv0.tmp");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      File file0 = MockFile.createTempFile("n8uv", (String) null);
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("2{]DdA]Q'd1", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test20()  throws Throwable  {
      File file0 = MockFile.createTempFile("@zQuP1p0Z'", "> quotechar=<\"> recordseparator=<");
  ...
  public void test23()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/n8uv0.tmp");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Index for header '%s' is %d bt CSVRecod only has %d values!");
      File file0 = MockFile.createTempFile("n8uv", (String) null);
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("2{]DdA]Q'd1");
  ...
  public void test25()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("K7\"[5U}MC/");
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("@zQuP1p0Z'");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("p_zni#o", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
