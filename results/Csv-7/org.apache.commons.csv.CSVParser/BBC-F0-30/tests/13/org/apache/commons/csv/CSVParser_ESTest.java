...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[p`.06hWAd74");
  ...
  public void test09()  throws Throwable  {
      MockFile mockFile0 = new MockFile("~qq%uoHF]whB~`iW");
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('s', character0, quote0, (Character) null, character0, false, true, "", "9iKw%wm'1B{=V_&", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      String[] stringArray0 = new String[2];
      CSVFormat cSVFormat0 = new CSVFormat('Y', character0, quote0, character0, character0, false, true, "org.apache.commons.csv.Quote", "format", stringArray0, false);
      // Undeclared exception!
      try { 
        CSVParser.parse("SJ8", cSVFormat0);
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("jlIpw{]*1Lj|elqMj/b", cSVFormat2);
  ...
  public void test14()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("8sq5L$C8iGy@", "8sq5L$C8iGy@", (File) mockFile0);
      Character character0 = Character.valueOf('}');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[9];
      CSVFormat cSVFormat0 = new CSVFormat('?', character0, quote0, character0, (Character) null, true, false, "Ax4BToE}2", "CSVParser has been closed", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("[p`.06hWAd74", cSVFormat2);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
        cSVParser0.getRecords(linkedList0);
        fail("Expecting exception: IOException");
  ...
  public void test22()  throws Throwable  {
      StringReader stringReader0 = new StringReader("0`&jy+/[=`!");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test24()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('b');
      StringReader stringReader0 = new StringReader("jlIpw{]*1Lj|elqMj/b");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("QC<y,>", cSVFormat1);
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("F5vzV6d", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(" tHGmp-\"c", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      stringArray0[0] = "g";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("F5vzV6d", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(" tHG7mp-\"c0");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(" tHGmp-\"c");
      CSVParser cSVParser0 = CSVParser.parse(" tHGmp-\"c", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("*f", "s&g'ew");
      try { 
