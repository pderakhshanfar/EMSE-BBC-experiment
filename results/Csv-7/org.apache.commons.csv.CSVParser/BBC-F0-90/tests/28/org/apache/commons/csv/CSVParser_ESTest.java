...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "o8PXMWPFQ/>");
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "8PXMWPFQ/>");
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"O47JW+rp", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("E}QW", "E}QW");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("The comment start character and the delimiter cannot be the same ('");
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("vm7/ec(h!");
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("zhq+t4abj\">`fs", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(".v(@aq>=bo#^vt7x(r*", "format", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      FileSystemHandling.shouldAllThrowIOExceptions();
  ...
  public void test21()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('S', character0, quote0, character0, character0, true, true, "B53^Tu9o", "FV+Oe", stringArray0, true);
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"-Usm");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test25()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("s*rsng");
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(" the record values c\n't be accessed by name", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Bw,SJ.=\"OQN!a@4*)", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test28()  throws Throwable  {
      File file0 = MockFile.createTempFile("OT[79", "j+o`}e2#[>g");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[0] = "";
      stringArray0[1] = "VM7/ec(h!";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("VM7/ec(h!", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("q-RV}X2D!{x>U*");
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("s*rsng", cSVFormat0);
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("VM7/ec(h!");
      CSVParser cSVParser0 = CSVParser.parse("VM7/ec(h!", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('0', (Character) null, quote0, (Character) null, character0, true, false, "file", ".", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("PH2", cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
