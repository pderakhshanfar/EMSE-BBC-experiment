...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"U]_:US&13o5N8r1V", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "j-R[3E,1}/+t^:T+");
  ...
  public void test02()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("=XwyYdvH");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "^UIH]bf%/0j2,w9rk";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("hBL*N.f{ fPgm%i");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse(":+:a[P`}o-c61$*", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("=XwyYdvH", cSVFormat2);
        fail("Expecting exception: IOException");
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("hnc:sJ3mf", "`G9-KK$G9h");
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("X:}AmYnt H< q/h", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test22()  throws Throwable  {
      MockFile mockFile0 = new MockFile("('}lY\"DIu6GQKf", "H^W#Y:oag");
      File file0 = MockFile.createTempFile("H^W#Y:oag", "H^W#Y:oag", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[6];
      CSVFormat cSVFormat0 = new CSVFormat('|', character0, quote0, character0, character0, true, true, ",w$3", " EmptyLines:ignored", stringArray0, true);
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("')");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "]z?Ly@X&e$!Mwi");
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(']');
      StringReader stringReader0 = new StringReader("]z?Ly@X&e$!Mwi");
  ...
  public void test34()  throws Throwable  {
      StringReader stringReader0 = new StringReader("P&kiQZERgabML");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("]z?Ly@X&e$!Mwi");
      CSVParser cSVParser0 = CSVParser.parse("^V!'+vII$~Pz0I_MS", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("]z?ly@x&e$!mwi");
      CSVParser cSVParser0 = CSVParser.parse("]z?Ly@X&e$!Mwi", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
