...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"#_I{Ji==f8Y<'K", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("UFuk<G3");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      MockFile mockFile0 = new MockFile("UFuk<G3");
  ...
  public void test03()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("v7u2pjb#8l5", cSVFormat1);
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("e4#<RXbL+:{>j6mx", cSVFormat0);
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('5', character0, quote0, character0, (Character) null, false, true, (String) null, "k%\"!VSo$8.Rrf!vmGv", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("k%\"!VSo$8.Rrf!vmGv", cSVFormat0);
  ...
  public void test16()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$1", "D-TpR`,Q( @57S");
      Character character0 = new Character('l');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('m', character0, quote0, character0, character0, true, true, "org.apache.commons.csv.CSVParser$1", "URd%Kxbdq", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('U', character0, quote0, character0, character0, true, true, "eorecord", "eorecord", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("d~T@is.J}b", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test22()  throws Throwable  {
      MockFile mockFile0 = new MockFile("tq", "tq");
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("B\t;@[1!|ClM;)wq");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader(".h(%_{&<;2z!:Kv");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      StringReader stringReader0 = new StringReader("p{<1Lr[z");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      stringReader0.skip(1222L);
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("UFuk<G3");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader(" ,(jz*dy%'xav");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
  ...
  public void test32()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('7', character0, quote0, character0, character0, false, false, "HxC&", "The comment start and the escape character cannot be the same ('", stringArray0, false);
      Character character1 = new Character(',');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character1);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      CSVParser cSVParser0 = CSVParser.parse("HxC&", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
