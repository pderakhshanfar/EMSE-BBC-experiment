...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"D`8", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/|gt0|cMg?B");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "%");
      File file0 = MockFile.createTempFile("|gt", "|cMg?B");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "carset";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("l/?+(`*koemkiv2x2?", cSVFormat1);
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("s%ya.a", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("ReGMi");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test08()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("&va>x ndx");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      cSVParser0.nextRecord();
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("<gQg0A", cSVFormat2);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"Q'yZQwES$", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("tve'?svir", "qxW d~de-l ");
      Character character0 = new Character('K');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[7];
      CSVFormat cSVFormat0 = new CSVFormat('K', character0, quote0, character0, character0, false, false, "qxW d~de-l ", "qxW d~de-l ", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("<HV", "The comment start character and the quoteChar cannot be the same ('");
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("}59tCIkB@$dJ1", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[hw$[E9jdS%T");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("&vab>xndx");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test30()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Xsxk{?U%L4.a_", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[Xsxk{, U%L4.a_]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("E8b)EL~.R0", cSVFormat0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("!64;F#L)+Ug:WzE");
  ...
  public void test36()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('i', character0, quote0, (Character) null, character0, false, true, "m<?3{%+", "m<?3{%+", (String[]) null, true);
      CSVParser cSVParser0 = CSVParser.parse("m<?3{%+", cSVFormat0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("{]}i8yf&uzv@", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
