...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"%V6d3QS98Z^", cSVFormat0);
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "n]|8ndg|*~");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("bAl9D4-aI:", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("l`gwdbi{#6iWg", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(":tQ(k", cSVFormat0);
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('K', character0, quote0, character0, (Character) null, true, true, "n]|8ndg|*~", "\"::Q*%=_kH_%.h%z2", stringArray0, true);
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "n]|8ndg|*~");
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"Y@qJ'iUf#=_S(", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("M(Wg5!", "}");
      Character character0 = Character.valueOf('.');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[7];
      CSVFormat cSVFormat0 = new CSVFormat('_', character0, quote0, character0, character0, true, true, "The header contains duplicate names: ", "CSVParser has been closed", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/Unexpected Token type: 0e!|xzB!zbSv7pqdy#hW");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      File file0 = MockFile.createTempFile("Unexpected Token type: ", "e!|xzB!zbSv7pqdy#hW", (File) null);
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile("c\"EzG?R~Rn)cOP", "c\"EzG?R~Rn)cOP");
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("dR$^,", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(":w^$F>G", cSVFormat0);
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("N]|8ndG|*~");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("VJz0cVtwpUPWjcMb");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("464<[W`NH1ge", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("E9$rGW", cSVFormat1);
      cSVParser0.getRecords();
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("bAl9D4-aI:");
      CSVParser cSVParser0 = CSVParser.parse("l`gwdbi{#6iWg", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("bAl9D4-aI:");
      CSVParser cSVParser0 = CSVParser.parse("bAl9D4-aI:", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("E9$rGW", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
