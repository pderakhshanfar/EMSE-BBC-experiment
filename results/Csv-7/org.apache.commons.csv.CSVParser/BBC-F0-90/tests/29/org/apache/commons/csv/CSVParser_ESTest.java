...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      File file0 = MockFile.createTempFile("Ux|6u|kBX;YS3$j=&", "Ux|6u|kBX;YS3$j=&");
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "F{1 {{ecBR}XOOGain");
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("F{1 {{ecBR}XOOGain", "F{1 {{ecBR}XOOGain");
      CSVFormat cSVFormat0 = CSVFormat.newFormat('A');
      String[] stringArray0 = new String[0];
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("F{1 {{ecBR}XOOGain/F{1 {{ecBR}XOOGain");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "@cvhzcj&{-qu(>?co");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("Y)zRl8 .gK4#bM,^R_", cSVFormat0);
      cSVParser0.close();
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("p5a", cSVFormat1);
      cSVParser0.getRecords();
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"h`qqj5b=a:", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("n+Sd?Xg\"S^,", "n+Sd?Xg\"S^,", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("AX>v,afHOM#U{");
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[SSzR");
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("MmnaEmF^(T6j");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader("wj`9TJJ,");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("n!QOIn%8u[t");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
  ...
  public void test27()  throws Throwable  {
      ...
      stringArray0[0] = "}?]O!$5F";
      CSVFormat cSVFormat0 = new CSVFormat('w', character0, quote0, character1, character1, false, false, (String) null, "<(MI3@{iAU>IW", stringArray0, true);
  ...
  public void test28()  throws Throwable  {
      ...
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[wj`9TJJ, ]", cSVRecord0.toString());
  }
