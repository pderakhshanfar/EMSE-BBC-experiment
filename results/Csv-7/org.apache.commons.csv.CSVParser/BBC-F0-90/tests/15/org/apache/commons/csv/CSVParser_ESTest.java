...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Jw\"J5.4BS)");
  ...
  public void test01()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("-:\"JR.4BS)", (String) null);
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("-:\"JR.4BS)");
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("vz'R%p8-0%Qie");
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("-:\"JR.4BS)", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = new MockFile("\"0g[i[`");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("I)u!F=u", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"wry{yKAzRB+!.}x>", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      ...
      String[] stringArray0 = new String[6];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("<^t>?`xkz", "-:\"JR.4BS)");
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("#1m;mUa<~)V#5C ", "#1m;mUa<~)V#5C ");
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("OZ_87CZ");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test21()  throws Throwable  {
      URI uRI0 = MockURI.aHttpURI;
      URL uRL0 = MockURI.toURL(uRI0);
      URL uRL1 = MockURL.URL(uRL0, "!b#aL/[(c,");
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://foo.bar/!b#aL/[(c,");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "!b#aL/[(c,");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("4-[^N^_+\"*,YI<@f", cSVFormat1);
      cSVParser0.getRecords();
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("ex", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("4(J8,?@]@v9gK80k");
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('e');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("!46k/");
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('e');
      MockFile mockFile0 = new MockFile("0Ccd;a}j.:+Y");
      try { 
