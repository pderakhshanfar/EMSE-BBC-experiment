...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("'H9uh9N");
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("sgHQ#1d%&3{>Z");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("[ amPL");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("[ amPL", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"-b-s@TXtD", cSVFormat1);
  ...
  public void test14()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("G[js}mN'T\"$ba2", "j!'PuzpS&J[w");
      File file0 = MockFile.createTempFile("j!'PuzpS&J[w", "G[js}mN'T\"$ba2", (File) mockFile0);
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("&-ho)lyo", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("~86HA;");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
  ...
  public void test20()  throws Throwable  {
      File file0 = MockFile.createTempFile("pf?ue2|tqsfm%y23 ", "pf?ue2|tqsfm%y23 ");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      FileSystemHandling.shouldAllThrowIOExceptions();
  ...
  public void test21()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('>', character0, quote0, character0, character0, true, true, "owGV%vq-.;", "owGV%vq-.;", stringArray0, true);
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"AkNF1{J:\u0002Fre?MXv$");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("(=#CujliAB6", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("x0,[1^0.cmp']aY/:\"");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("sgHQ#1d%&3{>Z", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test30()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("(=#CujliAB6", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test34()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat(')', character0, quote0, character1, character0, false, true, "sgHQ#1d%&3{>Z", "]1eP|@tu,Onf4IH8P", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("]1eP|@tu,Onf4IH8P", cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("WtE#@e");
      CSVParser cSVParser0 = CSVParser.parse("h8?", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
