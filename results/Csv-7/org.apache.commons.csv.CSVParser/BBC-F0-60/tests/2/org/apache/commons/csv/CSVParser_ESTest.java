...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = MockFile.createTempFile("4t3cv6-", "4t3cv6-");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("abiu", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('>', character0, quote0, character1, character0, false, false, "*W", "amQK{{[X", stringArray0, false);
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('=', character0, quote0, character0, character0, true, true, "", "]nIStw`B^4mWk.^3:~7", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse(".yl", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      ...
      stringArray0[0] = "d";
      CSVFormat cSVFormat0 = new CSVFormat('0', character0, quote0, character0, character1, true, true, "$|", "$|", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar('\'');
      try { 
        CSVParser.parse("'1'DCu\"i/?czIS\"wgr", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("}IWH-uyV*tl>", "}IWH-uyV*tl>");
      Character character0 = Character.valueOf('1');
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[6];
      CSVFormat cSVFormat0 = new CSVFormat('1', character0, quote0, character0, character0, false, false, "Lyb}a8Ik9Iiz{&", "file", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('V', character0, quote0, character1, character0, true, true, "$|", "$|", stringArray0, true);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("$|/$|");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "~0*YCmRpolVor,99yp");
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("c|9m$l@4uD;eu", cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
        cSVParser0.getRecords(linkedList0);
  ...
  public void test21()  throws Throwable  {
      ...
      String[] stringArray0 = new String[2];
      stringArray0[1] = "$|";
      CSVFormat cSVFormat0 = new CSVFormat('d', character0, quote0, character0, character1, true, true, "$|", "$|", stringArray0, true);
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("|MvASXGQkOW25\"qU%G%", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("1e >jcS4UYO'-*B");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("]6@OOB(-;`Z", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test25()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('0', character0, quote0, character0, character1, true, true, "$|", "$|", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar('\'');
      CSVParser cSVParser0 = CSVParser.parse("ol=B@<gi]'R5:mSsHB{", cSVFormat1);
  ...
  public void test34()  throws Throwable  {
      ...
      Character character1 = new Character('r');
      CSVFormat cSVFormat0 = new CSVFormat('V', character0, quote0, character1, character0, true, true, "$|", "$|", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("UMi6ED*wLzJ0szMJ5%#", cSVFormat0);
  ...
  public void test35()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('0');
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat0 = new CSVFormat('V', character0, quote0, character0, character0, true, true, "$|", "$|", stringArray0, true);
      MockFile mockFile0 = new MockFile("$|", "$|");
      try { 
        CSVParser.parse((File) mockFile0, cSVFormat0);
