...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("xqJrb", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Index for header ]%s' is %d but CSVRecprd only has %d values!");
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile((File) null, "B!\"&2s?fD");
  ...
  public void test09()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('y', (Character) null, quote0, character0, character0, false, false, "Q", "Q", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("(DIX}{R~6GY", cSVFormat0);
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"1%=EfM_yLCTobIv", cSVFormat1);
  ...
  public void test12()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("Delimiter=<\t> QuoteChar=<\"> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", "XajU@Xz/TJ%=6r", (File) mockFile0);
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('T', character0, quote0, character0, character0, true, false, "&&NI,*@\"'", "out", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("sz3!j_hni;m");
  ...
  public void test19()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('~', character0, quote0, character0, character0, false, true, "$VALUES", "$VALUES", stringArray0, false);
  ...
  public void test20()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[|L-!vZ;&NR!");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test21()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("ewRhFSFrE [6h)ir");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("sz3!j_hni;m", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test27()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('g', (Character) null, quote0, (Character) null, (Character) null, true, true, "NullString=<", "taS5~ jcD7?MW;Uy+", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("taS5~ jcD7?MW;Uy+", cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[0] = "org.aach!.commons.csv.CSVParsnr$2";
      stringArray0[1] = "sz3!j_hni;m";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("sz3!j_hni;m", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[sz3!j_hni;m]", cSVRecord0.toString());
  }
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("/@-sz3!j_hNI;m", cSVFormat2);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[/@, sz3!j_hNI;m]", cSVRecord0.toString());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("hvR", cSVFormat0);
      cSVParser0.getRecords();
