...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader(" .{O58=nY\"@");
      stringReader0.close();
  ...
  public void test01()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "0q");
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("0ZRQ^D Oy(0");
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("tmY+`", cSVFormat1);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('E', character0, quote0, character0, character0, true, false, "{C/^(", "{C/^(", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      File file0 = MockFile.createTempFile("PFDL9)SSJ", "PFDL9)SSJ");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("=!_vf-Y!5`9_");
      Character character0 = new Character('y');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[6];
      CSVFormat cSVFormat0 = new CSVFormat('%', character0, quote0, character0, character0, true, true, "+~(_mR[%pZ=!V))", "+~(_mR[%pZ=!V))", stringArray0, false);
  ...
  public void test21()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("%Ftntji(L!(");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("e@Vdx\">[");
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("?K:gE*", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("A2=JNh`~y6I24iXBG2");
      File file0 = MockFile.createTempFile("^gcr73%#", "^gcr73%#", (File) mockFile0);
  ...
  public void test29()  throws Throwable  {
      StringReader stringReader0 = new StringReader("5L)y?@4$taI8:74Z");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("f3/`\"2ZD!");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("3Qk<kr");
      String[] stringArray0 = new String[2];
      stringArray0[0] = "3Qk<kr";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVFormat cSVFormat3 = cSVFormat2.withSkipHeaderRecord(true);
      CSVParser cSVParser0 = CSVParser.parse("3Qk<kr", cSVFormat3);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
