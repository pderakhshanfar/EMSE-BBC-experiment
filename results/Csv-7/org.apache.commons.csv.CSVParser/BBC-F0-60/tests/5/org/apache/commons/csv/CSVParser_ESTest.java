...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"vQp>X6598p/_-Ba&!", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("y1", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('^', character0, quote0, character0, character0, false, true, "^ErAQ)yxNZ", "huYzD2TEN3dDvfs?i", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("huYzD2TEN3dDvfs?i", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"fU7EH%E^\"Ks", cSVFormat1);
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("P|5#tf7x", "f", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("?S\bZq<V{MS", (String) null, (File) null);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile(">)1icge(2>*ihpzx2m~", "}6~A.!Hqe");
  ...
  public void test17()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("AyJYVp~2yG4$\"X", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('<');
      StringReader stringReader0 = new StringReader("F`j!)QWNO");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test26()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("y1", cSVFormat2);
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("8JGOt1X;xTC,GSbYx");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("ROFUq/r3rF'L'K ", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("o.g.apache.commons.csv.CSBRecord", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile("org.apache.commons.csv.CSVRecord", "VG");
      try { 
  ...
  public void test40()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      CSVParser cSVParser0 = CSVParser.parse("o.g.apache.commons.csv.CSBRecord", cSVFormat0);
      cSVParser0.forEach(consumer0);
