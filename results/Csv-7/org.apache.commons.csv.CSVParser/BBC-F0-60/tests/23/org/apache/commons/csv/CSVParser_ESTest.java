...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"Ud\"*H8F\f0za1", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile(":Hp@FCNuP[^&HR.", "3mSDR>3Y|MyK]");
      File file0 = MockFile.createTempFile(":Hp@FCNuP[^&HR.", ":Hp@FCNuP[^&HR.", (File) mockFile0);
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(";yzs\"", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("&4ZFgN.(", "reader", (File) mockFile0);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("w$PAduZ/HOQ?5YOG,");
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('-', character0, quote0, character0, character0, true, true, "vn#HR&", "nAia", (String[]) null, true);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("dY78R[ivLi", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"Y)Dqd8>", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("ZRecordSeparator=<", cSVFormat0);
      cSVParser0.close();
  ...
  public void test17()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("XgfTvIz[hM&\".D*@", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.getRecords();
        fail("Expecting exception: IOException");
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("fhrmat", "fhrmat");
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
  ...
  public void test21()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("fomt");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("%[8c9c=", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[2] = "N@#M`w1nn@V2K\"";
      stringArray0[3] = "aX5/x-";
      stringArray0[4] = "}l@Mm!1[";
      stringArray0[5] = "Z-c`%/obn(T0DDG";
      stringArray0[6] = "@Q";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      StringReader stringReader0 = new StringReader("}l@Mm!1[");
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("format", "-XJC\"V,wde&");
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[4];
      stringArray0[0] = "mlmh{4";
      stringArray0[1] = "j=N$|rAm\"(rpNUC34";
      stringArray0[2] = "\u2029";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test33()  throws Throwable  {
      StringReader stringReader0 = new StringReader("UfYph#d)9[AnI$W )");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("UfYph#d)9[AnI$W )");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("KBqa9f~2_ChuW$n(7");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(false);
      CSVParser cSVParser0 = CSVParser.parse(";yzs\"", cSVFormat2);
