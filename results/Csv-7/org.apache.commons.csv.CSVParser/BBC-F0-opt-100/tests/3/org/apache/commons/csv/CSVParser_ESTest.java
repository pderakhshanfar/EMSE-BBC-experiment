...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("f?#60.1*");
  ...
  public void test01()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/org.apache.commons.csv.Quote0");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Z_'<[\"j5iP3PS-]!j");
      File file0 = MockFile.createTempFile("org.apache.commons.csv.Quote", "", (File) null);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[1] = "qo)$dm=`[";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("qo)$dm=`[", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[qo)$dm=`[]", cSVRecord0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("0@VAVn,Iy", "org.apache.commons.csv.Quote");
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("*4*Q2}q{KlL<Waz>j.", cSVFormat0);
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("nY{_V3dM_or", cSVFormat1);
      cSVParser0.nextRecord();
  ...
  public void test11()  throws Throwable  {
      ...
      String[] stringArray0 = new String[3];
      CSVFormat cSVFormat0 = new CSVFormat('S', character0, quote0, character0, character0, true, true, "hz-u u`jL!a", "hz-u u`jL!a", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("hz-u u`jL!a", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("Hf?*I^Zi}wC2G", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile(")v7", "oLS5]*UYb!");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("[U.):dg");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      try { 
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("fQ:LP");
      stringReader0.close();
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"42fNa>1jsr");
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("0j@6<ZNW.$('", cSVFormat0);
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      StringReader stringReader0 = new StringReader("UeA(3,qo)$Dm=`[");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("|P7h6T ", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("|p7h6t ", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('*', (Character) null, quote0, (Character) null, (Character) null, true, true, "[U.):dg", "", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("[U.):dg", cSVFormat0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("nY{_V3dM_or", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
  ...
  public void test39()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("0j@6<ZNW.$('", "0j@6<ZNW.$('");
