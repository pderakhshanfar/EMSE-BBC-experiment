...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("v+'hp#n:>3");
  ...
  public void test08()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("No header mapping was specified, the record values can't be accessed by name", "No header mapping was specified, the record values can't be accessed by name", 5, "No header mapping was specified, the record values can't be accessed by name", uRLStreamHandler0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("J~^9tlT85nhAo;6-_", cSVFormat2);
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("}{*G%jN]+<9AF\"kU", "}{*G%jN]+<9AF\"kU");
      File file0 = MockFile.createTempFile("reader", "Unexpected Quote value: ", (File) mockFile0);
      Character character0 = Character.valueOf('6');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('n', character0, quote0, character0, character0, false, false, "Unexpected Quote value: ", "reader", stringArray0, true);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("Mapping for %s not found, expected one of %s", "R");
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("jz!{F1", "jz!{F1");
      MockFile mockFile0 = new MockFile(file0, "wq={LexHJ*CSUIf>");
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("hNe(/%Nk~:{)s\"z", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("<*itLrR8@:_JgIhx");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test20()  throws Throwable  {
      File file0 = MockFile.createTempFile("+QR'n{.Z??{!E$", "+QR'n{.Z??{!E$");
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("1-,9(", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("xu", cSVFormat2);
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("F3kz*[s+ruzzGO");
      StringReader stringReader0 = new StringReader("F3kz*[s+ruzzGO");
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("cO4EWknN", cSVFormat1);
