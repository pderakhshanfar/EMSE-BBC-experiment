...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "+;mf]z.xrx1[7");
  ...
  public void test02()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Unexpected Token type: 0vfgi8*=[k3c^.}h @su");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "org.apache.commons.csv.CSVRecord");
      MockFile mockFile0 = new MockFile("");
      File file0 = MockFile.createTempFile("Unexpected Token type: ", "vfgi8*=[k3c^.}h @su", (File) mockFile0);
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("0]y|F*!");
  ...
  public void test14()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("IOd\"hI1a@Sc@sI", (CSVFormat) null);
  ...
  public void test16()  throws Throwable  {
      File file0 = MockFile.createTempFile("P(huo@%{E~]", "P(huo@%{E~]");
      Character character0 = Character.valueOf('}');
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[5];
      CSVFormat cSVFormat0 = new CSVFormat('g', character0, quote0, character0, character0, false, false, (String) null, "non_numeric", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      File file0 = MockFile.createTempFile("%87p]#mxrc", "format");
      Character character0 = Character.valueOf('|');
      Quote quote0 = Quote.MINIMAL;
      Character character1 = new Character('.');
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('|', character0, quote0, character0, character1, true, true, "ulXqsC/~pZ.a347t*", ">>U`hLew?9wq,D", stringArray0, true);
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("v4X>");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("$$j0? ?FS)si_5&");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      try { 
  ...
  public void test24()  throws Throwable  {
      StringReader stringReader0 = new StringReader(">dN@^N'!");
  ...
  public void test25()  throws Throwable  {
      StringReader stringReader0 = new StringReader("`bJK1");
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"[('0oG");
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("K8<4HLJ36qjPZ\"/xPb", cSVFormat0);
      HashMap<CSVRecord, String> hashMap0 = new HashMap<CSVRecord, String>(5);
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Pf}U>$bX>YKU4(CB", cSVFormat1);
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("1bm", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
