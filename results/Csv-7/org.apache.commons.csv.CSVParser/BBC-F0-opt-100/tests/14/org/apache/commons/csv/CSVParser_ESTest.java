...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("NullStrinY=<", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "]";
      stringArray0[1] = "3Bln#}S[J!U";
      stringArray0[2] = "ivu8p2H@0[7sZ";
      stringArray0[3] = "~5tR{ePgODxiuR) )Fb";
      stringArray0[4] = "iL`?]s?pE.Uc#\"@";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("iL`?]s?pE.Uc#\"@");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[iL`?]s?pE.Uc#\"@]", cSVRecord0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("sS('@?", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        CSVParser.parse("7NVAf!", cSVFormat2);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        CSVParser.parse("w8LN!I&Y_wQ66~npUTO", (CSVFormat) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"MWq'Ws_HeXz&", cSVFormat1);
  ...
  public void test15()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('Y', character0, quote0, character0, character0, false, false, (String) null, "string", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("=q:KDZ't7JtF~((p", "");
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("V2[vht{a/", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("]k}wj");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("V2fvht{a", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("rtp*vo", cSVFormat2);
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/) eof reached before encapsulated token finished0format");
