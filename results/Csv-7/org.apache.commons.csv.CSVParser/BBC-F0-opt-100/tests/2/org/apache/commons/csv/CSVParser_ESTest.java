...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"EudZ; No){f", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("hQ/G7eH1c;W~K", cSVFormat0);
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('_', character0, quote0, character0, character0, false, false, "The quoteChar cannot be a line break", "", stringArray0, false);
      // Undeclared exception!
      try { 
        CSVParser.parse("[`UksKBL", cSVFormat0);
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("BwL60]]E_mGLb", "q]zEoKp.YwWq#1!\u0003");
      Character character0 = Character.valueOf('%');
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat0 = new CSVFormat('*', character0, quote0, character0, character0, true, true, "q]zEoKp.YwWq#1!\u0003", "", (String[]) null, true);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("-6<EiXH", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
        fail("Expecting exception: IOException");
  ...
  public void test16()  throws Throwable  {
      File file0 = MockFile.createTempFile("U6?{PO48bl", "");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("81^OL", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("zsP-Nx^dGGm", "nlmh", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test19()  throws Throwable  {
      ...
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('\'', character0, quote0, character0, character0, false, true, (String) null, (String) null, stringArray0, false);
  ...
  public void test21()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("2ixp;{Hh9EGzL{m^x");
      stringReader0.close();
      CSVParser cSVParser0 = null;
      try {
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("`-.:xD1");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(".jX.,c=x", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[.jX., c=x]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("k<YvxWl\"~b};,;Al9?", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test27()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(".jX.,c=x", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("2ixp;{Hh9EGzL{m^x", cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("gq7z,z3", cSVFormat0);
  ...
  public void test32()  throws Throwable  {
      ...
      Character character0 = Character.valueOf(';');
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat(';', (Character) null, quote0, (Character) null, character0, true, true, "+\rUl30;Htxk_U6", (String) null, stringArray0, true);
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Vj", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("2ixp;{Hh9EGzL{m^x", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
