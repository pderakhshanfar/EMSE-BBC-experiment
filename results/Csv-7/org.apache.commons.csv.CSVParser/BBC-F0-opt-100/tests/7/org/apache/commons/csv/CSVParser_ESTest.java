...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "DO#u1");
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("!9X'^7c$z~N|{y", cSVFormat1);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('/', character0, quote0, character0, character0, true, true, "9$_b.>/~CB&4.", "N+X`/j", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('-', character0, quote0, (Character) null, character0, true, true, "{'Z(^K^", "The escape character cannot be a line break", stringArray0, true);
      // Undeclared exception!
      try { 
        CSVParser.parse("{'Z(^K^", cSVFormat0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        CSVParser.parse("\"$)6ccxtf>@)r", cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("|s}w>lc_.", ">NaA");
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("sw%", "3@F0;hY!^?W");
      try { 
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("6;o(.KH6gW]Nt", cSVFormat0);
      cSVParser0.close();
      try { 
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("--x_PE(.?zEl-", "mZ5f5~`M G1&MWc<Ni&");
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("R)?ldPrLV OrTx");
  ...
  public void test21()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"$)6ccxtf>@)r");
      CSVParser cSVParser0 = null;
      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
        fail("Expecting exception: IOException");
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("@<_*r k");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test28()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('!', character0, quote0, character0, character0, false, true, "^f", "@MZM]_YR|8+7", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(']');
      StringReader stringReader0 = new StringReader("B95=x=");
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("aXauJ|IE?", cSVFormat1);
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile("AOIF");
