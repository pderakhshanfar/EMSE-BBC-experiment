...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('R', character0, quote0, character0, character0, false, false, "(line ", "(line ", stringArray0, false);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        CSVParser.parse("\"xg'h", cSVFormat1);
  ...
  public void test10()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("M/-Ivyg#");
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/!O9sNvp]^(YRZBNsd0/Z");
      FileSystemHandling.shouldThrowIOException(evoSuiteFile0);
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("!O9sNvp]^(YRZBNsd", "/Z");
      try { 
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("EOF", ") invalid parse sequence");
      try { 
  ...
  public void test18()  throws Throwable  {
      File file0 = MockFile.createTempFile("XAVDn%}#sd'Up7HCNV", "XAVDn%}#sd'Up7HCNV");
  ...
  public void test21()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("Sw\"z;GBG3ij");
  ...
  public void test22()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("vc0Z[Nl=", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("L]uS7!7Z", cSVFormat1);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader(",&okh");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[, &okh]", cSVRecord0.toString());
  }
  ...
  public void test30()  throws Throwable  {
      File file0 = MockFile.createTempFile("l_kL'HzgclE,l'VfCG", (String) null, (File) null);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  ...
  public void test33()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('F', character0, quote0, character1, character0, true, true, "pb;##4PRWbsoTd9", "nullstring=<", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withDelimiter('q');
      StringReader stringReader0 = new StringReader(":;>p:4>O|&V(5$`");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
