...
public class ZipArchiveOutputStream_ESTest extends ZipArchiveOutputStream_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          MockFile mockFile0 = new MockFile("~,!BnzwH%kezY");
  ...
  public void test001()  throws Throwable  {
      MockFile mockFile0 = new MockFile("28hZN=wS}v");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("28hZN=wS}v");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
  ...
  public void test002()  throws Throwable  {
      File file0 = MockFile.createTempFile("bad size for entry ", "W }~8z&9iZb,n");
  ...
  public void test003()  throws Throwable  {
      MockFile mockFile0 = new MockFile("b2?h\tN=wS}Wyv");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveEntry0.setSize(4294967295L);
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
  ...
  public void test004()  throws Throwable  {
      MockFile mockFile0 = new MockFile("mJ=&ElY3caGz-qVIv", "mJ=&ElY3caGz-qVIv");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
  ...
  public void test007()  throws Throwable  {
      File file0 = MockFile.createTempFile("zVfxnRW:r", "zVfxnRW:r");
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("zVfxnRW:r");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
  ...
  public void test008()  throws Throwable  {
      File file0 = MockFile.createTempFile(" btes exceeds remainig", " btes exceeds remainig");
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("~/0]hT!)K\"");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
  ...
  public void test009()  throws Throwable  {
      MockFile mockFile0 = new MockFile("m`<lE4?\"m@@ ");
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("m`<lE4?\"m@@ ");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      zipArchiveOutputStream0.putArchiveEntry(jarArchiveEntry0);
      zipArchiveOutputStream0.putArchiveEntry(jarArchiveEntry0);
      jarArchiveEntry0.setCompressedSize((-785L));
  ...
  public void test010()  throws Throwable  {
      File file0 = MockFile.createTempFile("K|48D3", "", (File) null);
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
  ...
  public void test011()  throws Throwable  {
      MockFile mockFile0 = new MockFile("mJ=&ElY3caGz-qrIv", "mJ=&ElY3caGz-qrIv");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      ZipArchiveEntry zipArchiveEntry0 = (ZipArchiveEntry)zipArchiveOutputStream0.createArchiveEntry(mockFile0, "mJ=&ElY3caGz-qrIv");
      zipArchiveOutputStream0.writeDataDescriptor(zipArchiveEntry0);
      assertEquals("UTF8", zipArchiveOutputStream0.getEncoding());
      assertEquals(0L, mockFile0.length());
      assertEquals("mJ=&ElY3caGz-qrIv", zipArchiveEntry0.getName());
  }

  @Test(timeout = 4000)
  public void test012()  throws Throwable  {
      File file0 = MockFile.createTempFile("= @GKLQ]#RQZ@v=7", "= @GKLQ]#RQZ@v=7");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "= @GKLQ]#RQZ@v=7");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
      assertEquals(8, zipArchiveEntry0.getMethod());
  ...
  public void test013()  throws Throwable  {
      ...
      zipArchiveOutputStream0.writeOut(byteArray0, 1, (byte)77);
  ...
  public void test015()  throws Throwable  {
      MockFile mockFile0 = new MockFile("YX^s+L2!4J(f%7", "");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
  ...
  public void test016()  throws Throwable  {
      MockFile mockFile0 = new MockFile("mJ=:El3a|z-qVIv", "mJ=:El3a|z-qVIv");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
      zipArchiveOutputStream0.createArchiveEntry(mockFile0, "2vp%sJ;_<oo ;po");
      assertEquals(30L, mockFile0.length());
  }

  @Test(timeout = 4000)
  public void test017()  throws Throwable  {
      MockFile mockFile0 = new MockFile("mJ=&ElY3caGz-qrIv", "");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
  ...
  public void test018()  throws Throwable  {
      File file0 = MockFile.createTempFile("mqGLK@*gt)Bg%] }", "mqGLK@*gt)Bg%] }");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      // Undeclared exception!
      try { 
        zipArchiveOutputStream0.writeOut((byte[]) null, (-1236), (-1236));
        fail("Expecting exception: NullPointerException");
  ...
  public void test019()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveOutputStream0.writeOut(byteArray0, (byte)91, 10);
  ...
  public void test020()  throws Throwable  {
      MockFile mockFile0 = new MockFile(" @<_PdVa;%D-0", " @<_PdVa;%D-0");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      ZipArchiveOutputStream zipArchiveOutputStream1 = new ZipArchiveOutputStream(zipArchiveOutputStream0);
      byte[] byteArray0 = new byte[5];
      // Undeclared exception!
      try { 
        zipArchiveOutputStream1.writeOut(byteArray0, 33, 32);
  ...
  public void test021()  throws Throwable  {
      MockFile mockFile0 = new MockFile("m|Es%{Y@$#2D1g=[-", "");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockPrintStream0);
      byte[] byteArray0 = new byte[7];
      // Undeclared exception!
      try { 
        zipArchiveOutputStream0.writeOut(byteArray0, (byte) (-64), 1059);
  ...
  public void test023()  throws Throwable  {
      File file0 = MockFile.createTempFile("M1SHF=0wj{;xaPE$%L", "M1SHF=0wj{;xaPE$%L");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
  ...
  public void test024()  throws Throwable  {
      File file0 = MockFile.createTempFile("bytes eced remaining", "bytes eced remaining");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      ZipArchiveOutputStream zipArchiveOutputStream1 = new ZipArchiveOutputStream(zipArchiveOutputStream0);
  ...
  public void test025()  throws Throwable  {
      MockFile mockFile0 = new MockFile("2=U/oIbaBgLBo;");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
  ...
  public void test026()  throws Throwable  {
      ...
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      ZipArchiveEntry zipArchiveEntry0 = (ZipArchiveEntry)zipArchiveOutputStream0.createArchiveEntry(mockFile0, "mJ=&ElY3caGz-qrIv");
      zipArchiveOutputStream0.setEncoding("yBy");
      try { 
        zipArchiveOutputStream0.writeLocalFileHeader(zipArchiveEntry0);
  ...
  public void test028()  throws Throwable  {
      File file0 = MockFile.createTempFile("bad size for entry ", "Z=iOX}Ql>s0.5:6_mTl");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
      byte[] byteArray0 = new byte[0];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-213), 0);
  ...
  public void test030()  throws Throwable  {
      File file0 = MockFile.createTempFile("= @GKLQ]#RQZ@v=7", "= @GKLQ]#RQZ@v=7");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("= @GKLQ]#RQZ@v=7");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
  ...
  public void test031()  throws Throwable  {
      MockFile mockFile0 = new MockFile("= @GKLQ]#RQZ@v=7", "= @GKLQ]#RQZ@v=7");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "= @GKLQ]#RQZ@v=7");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("= @GKLQ]#RQZ@v=7/= @GKLQ]#RQZ@v=7");
  ...
  public void test038()  throws Throwable  {
      MockFile mockFile0 = new MockFile("= @GKLQ]#RQZ@v=7", "= @GKLQ]#RQZ@v=7");
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("= @GKLQ]#RQZ@v=7");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      ...
      try { 
        ...
        fail("Expecting exception: UnsupportedZipFeatureException");
         ...
         //
         // unsupported feature compression method used in entry = @GKLQ]#RQZ@v=7
         //
  ...
  public void test039()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveOutputStream0.write(byteArray0, 186, (int) (byte) (-108));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test040()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveOutputStream0.setEncoding("=>@GKLQ]#RQZ@v=7");
  ...
  public void test042()  throws Throwable  {
      MockFile mockFile0 = new MockFile("mJ=&ElY3caGz-qVIv", "mJ=&ElY3caGz-qVIv");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      zipArchiveOutputStream0.setMethod(369);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "A&f]viq0MH&&q_'{@Mg");
      zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
      try { 
        zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
        fail("Expecting exception: UnsupportedZipFeatureException");
         ...
         //
         // unsupported feature compression method used in entry A&f]viq0MH&&q_'{@Mg
         //
         verifyException("org.apache.commons.compress.archivers.zip.ZipUtil", e);
      }
  }
  ...
  public void test043()  throws Throwable  {
      File file0 = MockFile.createTempFile("= @GKLQ]#RQZ@v=7", "= @GKLQ]#RQZ@v=7");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      ArchiveEntry archiveEntry0 = zipArchiveOutputStream0.createArchiveEntry(file0, "= @GKLQ]#RQZ@v=7");
  ...
  public void test044()  throws Throwable  {
      ...
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      zipArchiveOutputStream0.destroy();
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "#$LT!{(l");
      try { 
        zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
        fail("Expecting exception: ClosedChannelException");
  ...
  public void test048()  throws Throwable  {
      File file0 = MockFile.createTempFile("bad size for entry ", "");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
  ...
  public void test049()  throws Throwable  {
      MockFile mockFile0 = new MockFile("mJ=&ElY3caGz-qVIv", "mJ=&ElY3caGz-qVIv");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      TarArchiveEntry tarArchiveEntry0 = new TarArchiveEntry("mJ=&ElY3caGz-qVIv", (byte)36);
      // Undeclared exception!
      try { 
  ...
  public void test050()  throws Throwable  {
      File file0 = MockFile.createTempFile("Always", "org.apache.commons.compress.archivers.zip.ZipArchiveOutputStream$UnicodeExtraFieldPolicy");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("BpVq@iw8");
  ...
  public void test059()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.compress.archivers.zip.ZipArchiveOutputStream$EntryMetaData", (String) null);
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      // Undeclared exception!
      try { 
  ...
  public void test060()  throws Throwable  {
      File file0 = MockFile.createTempFile("= @GKLQ]#RQZ@v=7", (String) null);
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "");
  ...
  public void test061()  throws Throwable  {
      File file0 = MockFile.createTempFile("No current entry to cose", "No current entry to cose");
  ...
  public void test063()  throws Throwable  {
      File file0 = MockFile.createTempFile("K7<U(e).ME", "K7<U(e).ME");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      zipArchiveOutputStream0.destroy();
      try { 
        zipArchiveOutputStream0.close();
  ...
  public void test067()  throws Throwable  {
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(" bytes exceds remaining");
  ...
  public void test068()  throws Throwable  {
      ...
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("= @GKLQ]#RQZ@v=7");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      zipArchiveOutputStream0.setMethod(681);
      zipArchiveOutputStream0.putArchiveEntry(jarArchiveEntry0);
  ...
  public void test069()  throws Throwable  {
      File file0 = MockFile.createTempFile(" btes exceeds remainig", " btes exceeds remainig");
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry(" btes exceeds remainig");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
  ...
  public void test072()  throws Throwable  {
      ...
      zipArchiveEntry0.addAsFirstExtraField(resourceAlignmentExtraField0);
      byte[] byteArray0 = new byte[0];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 2463, (byte)108);
  ...
  public void test073()  throws Throwable  {
      MockFile mockFile0 = new MockFile("mJ=&ElY3caGz-qVIv");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry();
      zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
      byte[] byteArray0 = new byte[8];
  ...
  public void test074()  throws Throwable  {
      File file0 = MockFile.createTempFile("No urrent entr: to dlose", "No urrent entr: to dlose");
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("No urrent entr: to dlose");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      zipArchiveOutputStream0.putArchiveEntry(jarArchiveEntry0);
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
  ...
  public void test076()  throws Throwable  {
      MockFile mockFile0 = new MockFile("mJ=&ElY3caGz-qVIv");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("mJ=&ElY3caGz-qVIv");
      zipArchiveOutputStream0.putArchiveEntry(jarArchiveEntry0);
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-51), 2048);
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(byteArrayInputStream0);
      // Undeclared exception!
      try { 
  ...
  public void test077()  throws Throwable  {
      ...
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      zipArchiveOutputStream0.putArchiveEntry(jarArchiveEntry0);
      zipArchiveOutputStream0.setEncoding("zVfxnRW:r");
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      try { 
        zipArchiveOutputStream0.addRawArchiveEntry(jarArchiveEntry0, pipedInputStream0);
        fail("Expecting exception: UnsupportedEncodingException");
  ...
  public void test083()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveOutputStream0.write((byte[]) null, 65535, 2109135725);
        fail("Expecting exception: NullPointerException");
  ...
  public void test084()  throws Throwable  {
      MockFile mockFile0 = new MockFile("mJ=:El3a|z-qVIv", "mJ=:El3a|z-qVIv");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry("mJ=:El3a|z-qVIv");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
  ...
  public void test085()  throws Throwable  {
      ...
      FileChannel fileChannel0 = mockFileOutputStream0.getChannel();
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(fileChannel0);
      zipArchiveEntry0.setCompressedSize(4294967340L);
      zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
  ...
  public void test086()  throws Throwable  {
      MockFile mockFile0 = new MockFile("= @GKLQ]#RQZ@v=7", "= @GKLQ]#RQZ@v=7");
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "!:$LYhH<");
      ...
      assertEquals(58, zipArchiveOutputStream1.getCount());
  }
  ...
  public void test089()  throws Throwable  {
      MockFile mockFile0 = new MockFile("mJ=:El3a|z-qVIv", "mJ=:El3a|z-qVIv");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("mJ=:El3a|z-qVIv");
      zipArchiveOutputStream0.setEncoding((String) null);
      // Undeclared exception!
      try { 
  ...
  public void test092()  throws Throwable  {
      File file0 = MockFile.createTempFile("p#aBU=L_9c%W}rLsx", "p#aBU=L_9c%W}rLsx");
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("p#aBU=L_9c%W}rLsx");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
  ...
  public void test101()  throws Throwable  {
      ...
      ResourceAlignmentExtraField resourceAlignmentExtraField0 = new ResourceAlignmentExtraField(0, true, 221);
  ...
  public void test106()  throws Throwable  {
      File file0 = MockFile.createTempFile("YDR\t~(=bg81h", "YDR\t~(=bg81h");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      zipArchiveOutputStream0.flush();
      assertEquals("UTF8", zipArchiveOutputStream0.getEncoding());
  }
  ...
  public void test107()  throws Throwable  {
      File file0 = MockFile.createTempFile("}1G|n#DH1){7eq!u", "mJ=&ElY3caGz-qVIv");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      zipArchiveOutputStream0.finish();
      zipArchiveOutputStream0.close();
  ...
  public void test108()  throws Throwable  {
      MockFile mockFile0 = new MockFile("5,-&4`K");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      byte[] byteArray0 = new byte[4];
      // Undeclared exception!
      try { 
        zipArchiveOutputStream0.write(byteArray0, (int) (byte) (-48), 1700);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test110()  throws Throwable  {
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("This archive has already been finished");
      MockFile mockFile0 = new MockFile("zxnRW:r", "zxnRW:r");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      zipArchiveOutputStream0.setMethod(1);
      zipArchiveOutputStream0.putArchiveEntry(jarArchiveEntry0);
  ...
  public void test111()  throws Throwable  {
      MockFile mockFile0 = new MockFile("bytes eced rmaining", "bytes eced rmaining");
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("bytes eced rmaining");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
  ...
  public void test114()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        zipArchiveOutputStream0.setLevel((-4282));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid compression level: -4282
         //
         verifyException("org.apache.commons.compress.archivers.zip.ZipArchiveOutputStream", e);
      }
  }
  ...
  public void test117()  throws Throwable  {
      ...
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(mockFile0, "#$LT!{(l");
  ...
  public void test118()  throws Throwable  {
      MockFile mockFile0 = new MockFile("= @GKLQ]#RQZ@v=7");
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("= @GKLQ]#RQZ@v=7");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      zipArchiveOutputStream0.setMethod(0);
      try { 
  ...
  public void test119()  throws Throwable  {
      File file0 = MockFile.createTempFile("= @GKLQ]#RQZ@v=7", "= @GKLQ]#RQZ@v=7");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      ZipArchiveEntry zipArchiveEntry0 = new ZipArchiveEntry(file0, "88)");
  ...
  public void test123()  throws Throwable  {
      ...
      zipArchiveOutputStream0.writeCentralFileHeader(zipArchiveEntry0);
      zipArchiveOutputStream0.putArchiveEntry(zipArchiveEntry0);
      assertEquals(71L, zipArchiveEntry0.getCompressedSize());
  ...
  public void test125()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ZipException");
         ...
         //
         // bad size for entry zVfxnRW:r: 0 instead of 22
         //
         verifyException("org.apache.commons.compress.archivers.zip.ZipArchiveOutputStream", e);
      }
  }
  ...
  public void test126()  throws Throwable  {
      ...
      zipArchiveOutputStream1.putArchiveEntry(jarArchiveEntry0);
      assertEquals(0, jarArchiveEntry0.getMethod());
      assertEquals(104, zipArchiveOutputStream0.getCount());
  }

  @Test(timeout = 4000)
  public void test127()  throws Throwable  {
      MockFile mockFile0 = new MockFile("JRyzR B+3z");
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("JRyzR B+3z");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(mockFile0);
      zipArchiveOutputStream0.putArchiveEntry(jarArchiveEntry0);
      zipArchiveOutputStream0.putArchiveEntry(jarArchiveEntry0);
      ...
      zipArchiveOutputStream0.addRawArchiveEntry(jarArchiveEntry0, mockFileInputStream0);
      assertEquals(2L, jarArchiveEntry0.getCompressedSize());
      assertEquals(12418L, mockFile0.length());
  }

  @Test(timeout = 4000)
  public void test128()  throws Throwable  {
      File file0 = MockFile.createTempFile("4'f9P7sQlW", "4'f9P7sQlW");
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("4'f9P7sQlW");
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
      zipArchiveOutputStream0.putArchiveEntry(jarArchiveEntry0);
      jarArchiveEntry0.setCrc(1719L);
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      zipArchiveOutputStream0.addRawArchiveEntry(jarArchiveEntry0, mockFileInputStream0);
      assertEquals(2L, jarArchiveEntry0.getCompressedSize());
      assertEquals(0L, jarArchiveEntry0.getCrc());
  ...
  public void test129()  throws Throwable  {
      File file0 = MockFile.createTempFile("<+{v9FZ", "org.apache.commons.compress.archivers.zip.ZipArchiveOutputStream", (File) null);
      ZipArchiveOutputStream zipArchiveOutputStream0 = new ZipArchiveOutputStream(file0);
