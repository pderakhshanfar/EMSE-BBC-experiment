...
public class SubLine_ESTest extends SubLine_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-693.6850358133964), (-693.6850358134));
      Vector3D vector3D1 = new Vector3D((-693.6850358133964), vector3D0, (-693.6850358133964), vector3D0, 1.0E-10, vector3D0);
      SubLine subLine0 = new SubLine(vector3D0, vector3D1);
      Vector3D vector3D2 = subLine0.intersection(subLine0, true);
      assertEquals(2.526454841405536E-32, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-693.6850358133964), (-693.6850358133964));
      Vector3D vector3D1 = new Vector3D((-693.6850358133964), vector3D0, (-693.6850358133964), vector3D0, 1.0E-10, vector3D0);
      SubLine subLine0 = new SubLine(vector3D0, vector3D1);
      Line line0 = new Line(vector3D1, vector3D0);
      IntervalsSet intervalsSet0 = new IntervalsSet((-693.6850358133964), 1224.3222013849);
      SubLine subLine1 = new SubLine(line0, intervalsSet0);
      Vector3D vector3D2 = subLine1.intersection(subLine0, true);
      assertEquals(2.1222862107979688E-27, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      SubLine subLine0 = new SubLine(vector3D0, vector3D1);
      Line line0 = new Line(vector3D1, vector3D0);
      IntervalsSet intervalsSet0 = new IntervalsSet(0.0, 3378.0);
      SubLine subLine1 = new SubLine(line0, intervalsSet0);
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-693.6850358133964), (-693.6850358133964));
      Vector3D vector3D1 = new Vector3D(1.0E-10, vector3D0, 0.0, vector3D0, (-1529.8189787809872), vector3D0);
  ...
  public void test10()  throws Throwable  {
      ...
      SubLine subLine0 = new SubLine(vector3D0, vector3D1);
      Line line0 = new Line(vector3D1, vector3D0);
      IntervalsSet intervalsSet0 = new IntervalsSet(1.5830993332061267E-10, (-693.6850358133964));
      SubLine subLine1 = new SubLine(line0, intervalsSet0);
  ...
  public void test11()  throws Throwable  {
      ...
      SubLine subLine0 = new SubLine(vector3D0, vector3D1);
      Line line0 = new Line(vector3D1, vector3D0);
      IntervalsSet intervalsSet0 = new IntervalsSet(4401.5666870907, 1.0E-10);
      SubLine subLine1 = new SubLine(line0, intervalsSet0);
      Vector3D vector3D2 = subLine1.intersection(subLine0, true);
      assertNull(vector3D2);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      SubLine subLine0 = new SubLine(vector3D0, vector3D1);
      Vector3D vector3D2 = subLine0.intersection(subLine0, true);
      assertEquals(1.0413339342097416E-16, vector3D2.getZ(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals(2.3662076781444345E-17, vector3D2.getY(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.041666666666621166, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
