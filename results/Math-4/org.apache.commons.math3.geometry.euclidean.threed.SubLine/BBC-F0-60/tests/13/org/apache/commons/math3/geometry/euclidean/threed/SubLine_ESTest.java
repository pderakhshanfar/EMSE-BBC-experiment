...
public class SubLine_ESTest extends SubLine_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1733.125099338), (-1733.125099338));
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-1733.125099338), vector3D0);
      ...
      assertEquals(5.165423725074834E-26, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-1733.125099338), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      SubLine subLine0 = line0.wholeLine();
      Vector3D vector3D2 = subLine0.intersection(subLine0, false);
      assertEquals(1.4951726301005155E-13, vector3D2.getX(), 0.01);
  }
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.0);
      Vector3D vector3D1 = new Vector3D(0.0, (-1879.6604499945333), (-1879.6604499945333));
      Line line0 = new Line(vector3D1, vector3D0);
      Segment segment0 = new Segment(vector3D1, vector3D0, line0);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1448.844), vector3D0);
      SubLine subLine0 = new SubLine(vector3D1, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2267.5), vector3D0, (-2267.5), vector3D0, (-2267.5), vector3D0, (-3372.1047671918), vector3D0);
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-93.8841617), vector3D0, (-1448.844), vector3D0);
      Vector3D vector3D2 = new Vector3D((-1448.844), vector3D1);
  ...
  public void test12()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      SubLine subLine0 = line0.wholeLine();
      IntervalsSet intervalsSet0 = new IntervalsSet(9.313225746154785E-10, (-1733.125099338));
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(28.88095067289143, 28.88095067289143);
      Vector3D vector3D1 = new Vector3D(28.88095067289143, vector3D0, 0.0, vector3D0);
      SubLine subLine0 = new SubLine(vector3D1, vector3D0);
      Vector3D vector3D2 = subLine0.intersection(subLine0, true);
      assertNull(vector3D2);
  }
