...
public class SubLine_ESTest extends SubLine_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3526.914434223507), vector3D0, 1.0, vector3D0, 1.0, vector3D0);
      ...
      assertEquals(3524.914433875077, vector3D3.getZ(), 0.01);
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3526.914434223507), vector3D0, 1.0, vector3D0, (-259.1), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      SubLine subLine0 = line0.wholeLine();
      Vector3D vector3D2 = new Vector3D(1341.21275482, 0.0, (-3526.914434223507));
      ...
      assertNotNull(vector3D3);
      assertEquals((-3.1311760130713945E-18), vector3D3.getX(), 0.01);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1087.9551762567003), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D((-3526.914434223507), vector3D0, 1.0, vector3D1, (-3526.914434223507), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      SubLine subLine0 = line0.wholeLine();
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-3526.914434223507), vector3D0, (-1343.0), vector3D0, (-3526.914434223507), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = Vector3D.PLUS_I;
      Vector3D vector3D3 = vector3D1.crossProduct((Vector<Euclidean3D>) vector3D2);
      SubLine subLine0 = line0.wholeLine();
      RotationOrder rotationOrder0 = RotationOrder.YXY;
      Vector3D vector3D4 = rotationOrder0.getA1();
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-3526.914434223507), vector3D0, 1.0, vector3D0, (-259.1), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      IntervalsSet intervalsSet0 = new IntervalsSet((-259.1), (-3526.914434223507));
      SubLine subLine0 = line0.wholeLine();
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-1343.0), (-1343.0));
      Line line0 = new Line(vector3D1, vector3D0);
      SubLine subLine0 = line0.wholeLine();
