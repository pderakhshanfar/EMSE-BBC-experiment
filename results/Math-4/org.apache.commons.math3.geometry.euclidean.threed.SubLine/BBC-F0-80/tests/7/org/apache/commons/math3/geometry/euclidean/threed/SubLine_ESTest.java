...
public class SubLine_ESTest extends SubLine_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-0.1666666567325592), (-1318.46923), 439.57484);
      Vector3D vector3D1 = new Vector3D(1424.44, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      IntervalsSet intervalsSet0 = new IntervalsSet();
      SubLine subLine0 = new SubLine(line0, intervalsSet0);
      Vector3D vector3D2 = subLine0.intersection(subLine0, true);
      assertEquals((-1.3968291548301658E-18), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4331.134635879261, 4331.134635879261, 1423.152687330144);
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4331.134635879261, 4331.134635879261, 1423.152687330144);
      Vector3D vector3D1 = new Vector3D(2522.510421645914, vector3D0, 246.57371, vector3D0);
      SubLine subLine0 = new SubLine(vector3D1, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      IntervalsSet intervalsSet0 = new IntervalsSet();
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 1423.152687330144, 1423.152687330144);
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4331.134635879261, 4331.134635879261, 2839.082436978415);
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4331.134635879261, 4331.134635879261, 1423.152687330144);
      Vector3D vector3D1 = new Vector3D(2522.510421645914, vector3D0, 4331.134635879261, vector3D0);
      SubLine subLine0 = new SubLine(vector3D1, vector3D0);
  ...
  public void test12()  throws Throwable  {
      ...
      SubLine subLine0 = new SubLine(line0, intervalsSet0);
      Vector3D vector3D2 = subLine0.intersection(subLine0, true);
      assertEquals(0.10017156668267373, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1787.3229), 4331.134635879261, (-638.92));
      Vector3D vector3D1 = Vector3D.PLUS_I;
      SubLine subLine0 = new SubLine(vector3D0, vector3D1);
      Vector3D vector3D2 = subLine0.intersection(subLine0, false);
