...
public class SubLine_ESTest extends SubLine_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-2095.57705805), vector3D0, (-83.6342499221), vector3D0, (-0.19), vector3D0);
  ...
  public void test01()  throws Throwable  {
      RotationOrder rotationOrder0 = RotationOrder.YXY;
      Vector3D vector3D0 = rotationOrder0.getA1();
      Vector3D vector3D1 = new Vector3D((-14.559733129450033), vector3D0, (-2095.57705805), vector3D0, (-83.6342499221), vector3D0, (-0.19), vector3D0);
      SubLine subLine0 = new SubLine(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-14.559733129450033), vector3D1, (-14.559733129450033), vector3D0);
      Line line0 = new Line(vector3D0, vector3D2);
      SubLine subLine1 = line0.wholeLine();
      Vector3D vector3D3 = subLine0.intersection(subLine1, false);
      assertNotNull(vector3D3);
      assertEquals((-4.86178411565097E-15), vector3D3.getY(), 0.01);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D0 = rotationOrder0.getA1();
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-2095.57705805), vector3D0, (-0.19), vector3D0, (-0.19), vector3D0);
      SubLine subLine0 = new SubLine(vector3D1, vector3D0);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(961.89059, 0.0, 0.0);
      Vector3D vector3D1 = new Vector3D(961.89059, vector3D0);
  ...
  public void test04()  throws Throwable  {
      ...
      SubOrientedPoint subOrientedPoint0 = new SubOrientedPoint(orientedPoint0, intervalsSet1);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(494.40516169793466, vector3D0, 0.0, vector3D0, 0.0, vector3D0);
  ...
  public void test12()  throws Throwable  {
      RotationOrder rotationOrder0 = RotationOrder.YXY;
      Vector3D vector3D0 = rotationOrder0.getA1();
      Vector3D vector3D1 = new Vector3D(989.17483606, vector3D0, 40.19140625, vector3D0, (-83.6342499221), vector3D0, (-0.19), vector3D0);
      SubLine subLine0 = new SubLine(vector3D1, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      SubLine subLine1 = line0.wholeLine();
  ...
  public void test14()  throws Throwable  {
      ...
      SubLine subLine0 = line0.wholeLine();
      Vector3D vector3D2 = subLine0.intersection(subLine0, true);
      assertEquals((-1.5862811160215254E-11), vector3D2.getX(), 0.01);
  }
