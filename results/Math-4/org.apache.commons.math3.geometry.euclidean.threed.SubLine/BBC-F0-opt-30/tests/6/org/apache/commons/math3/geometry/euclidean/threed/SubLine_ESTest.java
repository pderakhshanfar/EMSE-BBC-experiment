...
public class SubLine_ESTest extends SubLine_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3.9986783938944604E-8), 1287.0, 3986.6878899341);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-3.9986783938944604E-8), vector3D0);
      Vector3D vector3D2 = vector3D1.add(1287.0, (Vector<Euclidean3D>) vector3D0);
      ...
      assertEquals(8.85980397579416E-25, vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3.9986783938944604E-8), 1287.0, 3986.6878899341);
      Vector3D vector3D1 = vector3D0.add(1287.0, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      SubLine subLine0 = line0.wholeLine();
      Vector3D vector3D2 = subLine0.intersection(subLine0, true);
      assertEquals(4.435535931690139E-25, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1445.431773), (-1445.431773), 0.0);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-55.0963), (-1595.3), (-2680.6));
      Vector3D vector3D1 = new Vector3D(464.67554, vector3D0, (-55.0963), vector3D0);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      IntervalsSet intervalsSet0 = new IntervalsSet((-657.291729), (-657.291729));
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1445.431773), (-1445.431773), 0.0);
      Vector3D vector3D1 = vector3D0.add((-2349.39694299296), (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      SubLine subLine0 = line0.wholeLine();
      IntervalsSet intervalsSet0 = new IntervalsSet(784.61795922, (-1445.431773));
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1445.431773), 0.0, 0.0);
      Vector3D vector3D1 = vector3D0.add((-2349.39694299296), (Vector<Euclidean3D>) vector3D0);
      Vector3D vector3D2 = vector3D0.subtract(667.5181222, (Vector<Euclidean3D>) vector3D0);
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1445.431773), (-1445.431773), 0.0);
      Vector3D vector3D1 = vector3D0.subtract(667.5181222, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      SubLine subLine0 = line0.wholeLine();
      IntervalsSet intervalsSet0 = new IntervalsSet(573.3468198196, 0.0);
      SubLine subLine1 = new SubLine(line0, intervalsSet0);
