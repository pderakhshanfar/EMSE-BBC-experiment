...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Double double0 = new Double(1869.61975968);
  ...
  public void test01()  throws Throwable  {
      Well19937c well19937c0 = new Well19937c((-1615));
  ...
  public void test02()  throws Throwable  {
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(42.08318);
      Pair<Double, Double> pair0 = new Pair<Double, Double>((Double) null, double0);
      linkedList0.add(pair0);
      DiscreteDistribution<Double> discreteDistribution0 = new DiscreteDistribution<Double>(linkedList0);
      discreteDistribution0.reseedRandomGenerator(1551L);
  }
  ...
  public void test06()  throws Throwable  {
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(2241.6);
  ...
  public void test08()  throws Throwable  {
      ...
      Pair<String, Double> pair0 = new Pair<String, Double>("PM(%$I,3q.6OI(_@/&7", double0);
  ...
  public void test10()  throws Throwable  {
      Double double0 = new Double(2.4611679969129262E-8);
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      linkedList0.add(pair0);
      DiscreteDistribution<Double> discreteDistribution0 = new DiscreteDistribution<Double>(linkedList0);
  ...
  public void test11()  throws Throwable  {
      ...
      Double double1 = new Double(3696);
      ...
      // Undeclared exception!
      discreteDistribution1.sample(3877);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<Short> discreteDistribution0 = new DiscreteDistribution<Short>(linkedList0);
      Short short1 = new Short((short)1342);
  ...
  public void test15()  throws Throwable  {
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(41.87120210298231);
      Pair<Double, Double> pair0 = new Pair<Double, Double>((Double) null, double0);
      linkedList0.add(pair0);
      DiscreteDistribution<Double> discreteDistribution0 = new DiscreteDistribution<Double>(linkedList0);
  ...
  public void test16()  throws Throwable  {
      Short short0 = new Short((short) (-17989));
      Double double0 = new Double(1368.6522);
      Pair<Short, Double> pair0 = new Pair<Short, Double>(short0, double0);
      LinkedList<Pair<Short, Double>> linkedList0 = new LinkedList<Pair<Short, Double>>();
      linkedList0.add(pair0);
      DiscreteDistribution<Short> discreteDistribution0 = new DiscreteDistribution<Short>(linkedList0);
  ...
  public void test19()  throws Throwable  {
      ...
      Double double0 = new Double(1.6567914485931396);
      ...
      // Undeclared exception!
      try { 
        discreteDistribution0.reseedRandomGenerator((-342L));
        fail("Expecting exception: NullPointerException");
