...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        discreteDistribution0.sample((-469));
  ...
  public void test02()  throws Throwable  {
      ...
      discreteDistribution0.sample(54886988);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        discreteDistribution0.sample(2145384445);
  ...
  public void test04()  throws Throwable  {
      Double double0 = new Double((short)1022);
      Pair<String, Double> pair0 = new Pair<String, Double>("OLX;f@n_`tA", double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
  ...
  public void test05()  throws Throwable  {
      ...
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Pair<String, Double> pair0 = new Pair<String, Double>("ZKk$l2.}", (Double) null);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = null;
      try {
  ...
  public void test08()  throws Throwable  {
      Double double0 = new Double((short)1022);
      Pair<String, Double> pair0 = new Pair<String, Double>("Lokw[88iHLm]f.", double0);
      Well1024a well1024a0 = new Well1024a(410);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
  ...
  public void test09()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well1024a0, linkedList0);
      String[] stringArray0 = discreteDistribution0.sample(301);
      assertEquals(301, stringArray0.length);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Pair<String, Double> pair0 = new Pair<String, Double>((String) null, double0);
      linkedList0.add(pair0);
      Well1024a well1024a0 = new Well1024a(3964);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well1024a0, linkedList0);
  ...
  public void test13()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well1024a0, linkedList0);
      double double1 = discreteDistribution0.probability("w:iB;bX");
  ...
  public void test15()  throws Throwable  {
      ...
      Pair<String, Double> pair0 = new Pair<String, Double>((String) null, double0);
      linkedList0.add(pair0);
      Well1024a well1024a0 = new Well1024a(74);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well1024a0, linkedList0);
      double double1 = discreteDistribution0.probability("the fraction to divide by must not be zero: {0}/{1}");
  ...
  public void test17()  throws Throwable  {
      Well1024a well1024a0 = new Well1024a(1L);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double((-3331.0664));
      Pair<String, Double> pair0 = new Pair<String, Double>("w:iB;bX", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = null;
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -3,331.066 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
