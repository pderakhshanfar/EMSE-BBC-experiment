...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      LinkedList<Pair<Object, Double>> linkedList0 = new LinkedList<Pair<Object, Double>>();
      Double double0 = new Double((short)3274);
  ...
  public void test05()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(100.448);
      Pair<String, Double> pair0 = new Pair<String, Double>(">B!E6y", double0);
      linkedList0.add(pair0);
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        discreteDistribution0.reseedRandomGenerator((-2877L));
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      ...
      DiscreteDistribution<Pair<Integer, Long>> discreteDistribution0 = null;
      try {
        discreteDistribution0 = new DiscreteDistribution<Pair<Integer, Long>>(well44497b0, linkedList0);
        fail("Expecting exception: ArithmeticException");
  ...
  public void test12()  throws Throwable  {
      ...
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
      Well44497a well44497a0 = new Well44497a((-2720L));
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well44497a0, linkedList0);
      discreteDistribution0.sample(2328);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well44497a0, linkedList0);
      try { 
        discreteDistribution0.sample((-312407500));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // number of samples (-312,407,500)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      Well44497a well44497a0 = new Well44497a((long) 419);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well44497a0, linkedList0);
      double double1 = discreteDistribution0.probability("non square ({0}x{1}) matrix");
  ...
  public void test18()  throws Throwable  {
      ...
      Well44497a well44497a0 = new Well44497a((-2720L));
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well44497a0, linkedList0);
      double double1 = discreteDistribution0.probability("\"*MAIT<");
      assertEquals(0.0, double1, 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Double double0 = new Double(876);
      Pair<String, Double> pair0 = new Pair<String, Double>((String) null, double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
