...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Double double0 = new Double(131.4782617);
      Double double1 = new Double(2273.384384);
      ...
      DiscreteDistribution<Pair<Byte, Object>> discreteDistribution2 = null;
      try {
        discreteDistribution2 = new DiscreteDistribution<Pair<Byte, Object>>(well44497b0, (List<Pair<Pair<Byte, Object>, Double>>) null);
  ...
  public void test03()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(118.41);
      ...
      discreteDistribution0.reseedRandomGenerator(3427L);
      Well19937a well19937a0 = new Well19937a(6L);
      DiscreteDistribution<String> discreteDistribution1 = new DiscreteDistribution<String>(well19937a0, linkedList0);
      discreteDistribution0.sample();
      int int0 = 1277;
      int int1 = 219217239;
      // Undeclared exception!
      discreteDistribution1.sample(219217239);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      discreteDistribution0.sample(1660);
  ...
  public void test06()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = Double.valueOf(0.5623256774530596);
      Pair<String, Double> pair0 = new Pair<String, Double>((String) null, double0);
      linkedList0.addLast(pair0);
      Double double1 = new Double(706.30922);
      Pair<String, Double> pair1 = new Pair<String, Double>("overflow, )um'rator too large afer multiply: {0}", double1);
      ...
      // Undeclared exception!
      try { 
        discreteDistribution0.sample(1087);
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(131.478261707835);
      Pair<String, Double> pair0 = new Pair<String, Double>("overflow, numerator too large after multiply: {0}", double0);
      Pair<String, Double> pair1 = new Pair<String, Double>(pair0);
      ...
      // Undeclared exception!
      try { 
        discreteDistribution1.reseedRandomGenerator((-65L));
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(1690.58572637);
      Double double1 = new Double(0.35362341089525584);
      Pair<String, Double> pair0 = new Pair<String, Double>("overflow, )um'rator too large afer multiply: {0}", double1);
      Pair<String, Double> pair1 = new Pair<String, Double>(pair0);
      Double double2 = new Double(1.0);
      Pair<String, Double> pair2 = new Pair<String, Double>((String) null, double2);
      linkedList0.add(pair2);
      Double double3 = new Double(1.0);
      Pair<String, Double> pair3 = new Pair<String, Double>((String) null, double3);
      linkedList0.add(pair2);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      int int0 = 0;
      try { 
  ...
  public void test10()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(131.478261707835);
      Double double1 = new Double(1480.404099);
      Pair<String, Double> pair0 = new Pair<String, Double>("overflow, numerator too large after multiply: {0}", double1);
      Pair<String, Double> pair1 = new Pair<String, Double>(pair0);
      linkedList0.add(pair0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      ...
      discreteDistribution0.getSamples();
      Well44497a well44497a0 = new Well44497a((-20372660));
  ...
  public void test12()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(131.478261707835);
      Pair<String, Double> pair0 = new Pair<String, Double>("overflow, )um'rator too large afer multiply: {0}", double0);
      Pair<String, Double> pair1 = new Pair<String, Double>(pair0);
      linkedList0.add(pair1);
      Pair<String, Double> pair2 = new Pair<String, Double>(pair1);
      linkedList0.add(pair0);
  ...
  public void test13()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(6.734172833429278E268);
      Double double1 = new Double(0.5);
      Double double2 = new Double(6.734172833429278E268);
  ...
  public void test15()  throws Throwable  {
      ...
      linkedList0.add(pair1);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      discreteDistribution0.reseedRandomGenerator(303L);
      discreteDistribution0.sample();
      Well512a well512a0 = new Well512a();
  ...
  public void test19()  throws Throwable  {
      ...
      Double double0 = new Double(648.5691099);
  ...
  public void test22()  throws Throwable  {
      ...
      try {
        discreteDistribution0 = new DiscreteDistribution<Pair<Byte, Float>>(well44497b0, linkedList0);
        fail("Expecting exception: ArithmeticException");
  ...
  public void test24()  throws Throwable  {
      ...
      try {
        discreteDistribution0 = new DiscreteDistribution<Pair<Long, Double>>(well19937a0, (List<Pair<Pair<Long, Double>, Double>>) null);
        fail("Expecting exception: NullPointerException");
