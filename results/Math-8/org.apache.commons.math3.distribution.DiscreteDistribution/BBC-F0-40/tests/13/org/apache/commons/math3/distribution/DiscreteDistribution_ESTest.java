...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Double double0 = new Double(2.484237749027735E-8);
      ...
      try { 
        discreteDistribution0.sample((-2901));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // number of samples (-2,901)
         //
  ...
  public void test01()  throws Throwable  {
      Double double0 = new Double(1.078094720840454);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Pair<String, Double> pair0 = new Pair<String, Double>("", double0);
      linkedList0.add(pair0);
      linkedList0.add(pair0);
      ...
      String[] stringArray0 = discreteDistribution0.sample(536);
      assertEquals(536, stringArray0.length);
  }
  ...
  public void test04()  throws Throwable  {
      Well19937a well19937a0 = new Well19937a();
      Double double0 = new Double(2290.12143277824);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Pair<String, Double> pair0 = new Pair<String, Double>((String) null, double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well19937a0, linkedList0);
      // Undeclared exception!
      try { 
        discreteDistribution0.sample(3391);
  ...
  public void test05()  throws Throwable  {
      ...
      Double double0 = new Double(1337.4971314525);
      ...
      // Undeclared exception!
      try { 
        discreteDistribution0.sample(25);
  ...
  public void test06()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(3.230089643550739E-275);
      Pair<String, Double> pair0 = new Pair<String, Double>("p3~$^!U| ,*@_s", double0);
      linkedList0.add(pair0);
  ...
  public void test07()  throws Throwable  {
      Well512a well512a0 = new Well512a();
      LinkedList<Pair<Object, Double>> linkedList0 = new LinkedList<Pair<Object, Double>>();
      Double double0 = new Double((-832.973914662));
      Pair<String, Double> pair0 = new Pair<String, Double>("", double0);
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -832.974 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      Double double0 = new Double(0.681609076637443);
      Pair<String, Double> pair0 = new Pair<String, Double>("^ ", double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
  ...
  public void test12()  throws Throwable  {
      LinkedList<Pair<Object, Double>> linkedList0 = new LinkedList<Pair<Object, Double>>();
      Double double0 = new Double(0.6064367740377754);
  ...
  public void test14()  throws Throwable  {
      ...
      double double1 = discreteDistribution0.probability("x#< z %XDj:zI)EgU");
  ...
  public void test15()  throws Throwable  {
      LinkedList<Pair<Object, Double>> linkedList0 = new LinkedList<Pair<Object, Double>>();
      Double double0 = new Double(2980.836415302025);
  ...
  public void test18()  throws Throwable  {
      ...
      Double double0 = new Double((-473.8736313));
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -473.874 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
