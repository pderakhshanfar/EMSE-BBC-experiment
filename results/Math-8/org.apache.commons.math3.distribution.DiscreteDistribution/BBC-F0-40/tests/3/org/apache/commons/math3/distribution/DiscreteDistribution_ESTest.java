...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Double double0 = Double.valueOf(807.1695891);
      Pair<String, Double> pair0 = new Pair<String, Double>(".v^7T,aif](p1$Dab1_t", double0);
  ...
  public void test01()  throws Throwable  {
      Double double0 = new Double(1380.323702605001);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Pair<String, Double> pair0 = new Pair<String, Double>("1VBGl!o+-8", double0);
      ...
      String[] stringArray0 = discreteDistribution0.sample(3716);
      assertEquals(3716, stringArray0.length);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      discreteDistribution0.sample(5922);
  }
  ...
  public void test05()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(0.4913362338641789);
  ...
  public void test06()  throws Throwable  {
      ...
      Double double0 = new Double((-1615.921988));
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -1,615.922 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Pair<String, Double> pair0 = new Pair<String, Double>("org.apache.commons.math3.d.stribution.DiscreteDistribution", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      String string0 = discreteDistribution0.sample();
      assertEquals("org.apache.commons.math3.d.stribution.DiscreteDistribution", string0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.push(pair0);
      Well44497b well44497b0 = new Well44497b(2356);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well44497b0, linkedList0);
      double double1 = discreteDistribution0.probability(".v^7T,aif](p1$Dab1_t");
  ...
  public void test14()  throws Throwable  {
      ...
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.push(pair0);
      Well44497b well44497b0 = new Well44497b((-1016));
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well44497b0, linkedList0);
  ...
  public void test15()  throws Throwable  {
      ...
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.push(pair0);
      Well44497b well44497b0 = new Well44497b(64);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well44497b0, linkedList0);
      double double1 = discreteDistribution0.probability((String) null);
      assertEquals(1.0, double1, 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Double double0 = new Double((-1416L));
      ...
      try {
        discreteDistribution0 = new DiscreteDistribution<Pair<String, Integer>>(linkedList0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // -1,416 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      Double double0 = Double.valueOf(807.1695891);
      Pair<String, Double> pair0 = new Pair<String, Double>("x|}@z", double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.push(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      discreteDistribution0.reseedRandomGenerator((-1011L));
  }
