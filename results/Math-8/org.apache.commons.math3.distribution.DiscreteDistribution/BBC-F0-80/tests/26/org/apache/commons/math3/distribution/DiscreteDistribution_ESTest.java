...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Double double0 = new Double(4516.895130892355);
  ...
  public void test01()  throws Throwable  {
      Double double0 = new Double(1213.6345068391);
      Pair<String, Double> pair0 = new Pair<String, Double>("fj xL#xh", double0);
      ...
      discreteDistribution0.sample(2326);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Well1024a well1024a0 = new Well1024a(1198);
  ...
  public void test04()  throws Throwable  {
      ...
      Double double0 = new Double(1567.8690732109646);
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      linkedList0.add(pair0);
      DiscreteDistribution<Double> discreteDistribution0 = new DiscreteDistribution<Double>(linkedList0);
      // Undeclared exception!
      discreteDistribution0.sample(204612363);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Double double0 = new Double(0.5282016222042418);
      Pair<String, Double> pair0 = new Pair<String, Double>((String) null, double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
  ...
  public void test06()  throws Throwable  {
      ...
      Double double0 = new Double((-764.50558798));
      Double double1 = new Double(841.3109149811);
  ...
  public void test07()  throws Throwable  {
      Double double0 = new Double(4371.4126661162);
      Pair<String, Double> pair0 = new Pair<String, Double>("*Y/,qRPD", double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
  ...
  public void test08()  throws Throwable  {
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(0.32243007305880766);
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      linkedList0.add(pair0);
  ...
  public void test09()  throws Throwable  {
      Well44497a well44497a0 = new Well44497a(3280L);
  ...
  public void test12()  throws Throwable  {
      Double double0 = new Double(0.34318972658664015);
  ...
  public void test13()  throws Throwable  {
      ...
      Double double0 = new Double(268.933571837);
      Pair<Long, Double> pair0 = new Pair<Long, Double>(long0, double0);
      linkedList0.addFirst(pair0);
      DiscreteDistribution<Long> discreteDistribution0 = new DiscreteDistribution<Long>(linkedList0);
      try { 
  ...
  public void test14()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(0.3059950166156453);
      Pair<String, Double> pair0 = new Pair<String, Double>("", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
  ...
  public void test15()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<Double> discreteDistribution0 = new DiscreteDistribution<Double>(linkedList0);
      Double double1 = new Double((-929.1822547802178));
  ...
  public void test19()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double((-4190.12786085609));
      Pair<String, Double> pair0 = new Pair<String, Double>("&T5=]", double0);
      linkedList0.add(pair0);
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -4,190.128 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JDKRandomGenerator jDKRandomGenerator0 = new JDKRandomGenerator();
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(jDKRandomGenerator0, linkedList0);
      discreteDistribution0.reseedRandomGenerator(1200L);
  }
