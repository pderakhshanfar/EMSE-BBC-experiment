...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Double double0 = new Double(2940.3251157);
  ...
  public void test01()  throws Throwable  {
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(2473.36);
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      ...
      Double[] doubleArray0 = discreteDistribution0.sample(476);
      assertEquals(476, doubleArray0.length);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Short short0 = new Short((short)5060);
  ...
  public void test03()  throws Throwable  {
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(0.9839287483472594);
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      linkedList0.offer(pair0);
      DiscreteDistribution<Double> discreteDistribution0 = new DiscreteDistribution<Double>(linkedList0);
  ...
  public void test04()  throws Throwable  {
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(0.8092528651211288);
  ...
  public void test06()  throws Throwable  {
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(0.29506467639005973);
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      linkedList0.offer(pair0);
      DiscreteDistribution<Double> discreteDistribution0 = new DiscreteDistribution<Double>(linkedList0);
      // Undeclared exception!
      discreteDistribution0.sample(5143947);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Double double0 = new Double(1514);
  ...
  public void test09()  throws Throwable  {
      Well44497a well44497a0 = new Well44497a((-2650L));
      LinkedList<Pair<Short, Double>> linkedList0 = new LinkedList<Pair<Short, Double>>();
      Short short0 = new Short((short) (-734));
      Double double0 = new Double((short) (-734));
      Pair<Short, Double> pair0 = new Pair<Short, Double>(short0, double0);
      linkedList0.add(pair0);
  ...
  public void test12()  throws Throwable  {
      ...
      Double double1 = discreteDistribution0.sample();
      assertEquals(0.8092528651211288, (double)double1, 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      DiscreteDistribution<Double> discreteDistribution0 = new DiscreteDistribution<Double>(linkedList0);
      try { 
        discreteDistribution0.sample((-2246));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(2919.727041878452);
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      linkedList0.offer(pair0);
      DiscreteDistribution<Double> discreteDistribution0 = new DiscreteDistribution<Double>(linkedList0);
      Double double1 = new Double(0.7640569538964308);
  ...
  public void test19()  throws Throwable  {
      ...
      Double double0 = new Double((-505.13818));
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -505.138 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
