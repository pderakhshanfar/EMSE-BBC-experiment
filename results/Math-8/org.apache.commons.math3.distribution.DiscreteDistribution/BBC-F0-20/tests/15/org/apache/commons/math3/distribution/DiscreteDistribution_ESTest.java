...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Double double0 = new Double(418.26F);
      Well1024a well1024a0 = new Well1024a();
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Pair<String, Double> pair0 = new Pair<String, Double>("'1Zi4", double0);
  ...
  public void test01()  throws Throwable  {
      ...
      Pair<String, Double> pair0 = new Pair<String, Double>("$<B5`7@vT{-aLcFKz", double0);
      linkedList0.add(pair0);
  ...
  public void test02()  throws Throwable  {
      Double double0 = new Double(0.7825498183139779);
  ...
  public void test03()  throws Throwable  {
      ...
      Float float0 = new Float(418.26F);
      Double double0 = new Double(418.26F);
      ...
      try { 
        discreteDistribution0.sample(2845);
  ...
  public void test08()  throws Throwable  {
      Double double0 = new Double((-2276.48191360155));
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -2,276.482 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      linkedList0.push((Pair<Object, Double>) null);
  ...
  public void test13()  throws Throwable  {
      ...
      DiscreteDistribution<Integer> discreteDistribution0 = new DiscreteDistribution<Integer>(linkedList0);
      // Undeclared exception!
      discreteDistribution0.sample(52834117);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<Float> discreteDistribution0 = new DiscreteDistribution<Float>((RandomGenerator) null, linkedList0);
      Float float1 = new Float(952.7523F);
  ...
  public void test16()  throws Throwable  {
      LinkedList<Pair<Integer, Double>> linkedList0 = new LinkedList<Pair<Integer, Double>>();
      Double double0 = new Double(1897);
  ...
  public void test19()  throws Throwable  {
      LinkedList<Pair<Float, Double>> linkedList0 = new LinkedList<Pair<Float, Double>>();
      Float float0 = new Float(418.26F);
      Double double0 = new Double((-2320.85158214));
      Pair<Float, Double> pair0 = new Pair<Float, Double>(float0, double0);
      linkedList0.add(pair0);
      DiscreteDistribution<Float> discreteDistribution0 = null;
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -2,320.852 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<Float> discreteDistribution0 = new DiscreteDistribution<Float>(linkedList0);
      discreteDistribution0.reseedRandomGenerator((-2800L));
  }
}
