...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Double double0 = new Double(2510.976);
  ...
  public void test01()  throws Throwable  {
      ...
      Pair<String, Double> pair0 = new Pair<String, Double>("/)-s:S(+2:j", double0);
      linkedList0.add(pair0);
  ...
  public void test02()  throws Throwable  {
      ...
      discreteDistribution0.reseedRandomGenerator((-1942652723));
  }
  ...
  public void test04()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      MersenneTwister mersenneTwister0 = new MersenneTwister((int) (short) (-1472));
  ...
  public void test05()  throws Throwable  {
      ...
      discreteDistribution0.sample(358625024);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        discreteDistribution0.sample((int) (short)1221);
  ...
  public void test11()  throws Throwable  {
      Well44497b well44497b0 = new Well44497b(736);
      well44497b0.nextInt(849);
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(736);
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      linkedList0.add(pair0);
      ...
      assertEquals(736.0, (double)double1, 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      DiscreteDistribution<Long> discreteDistribution0 = new DiscreteDistribution<Long>(well44497b0, linkedList0);
      try { 
        discreteDistribution0.sample((-1678));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // number of samples (-1,678)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(1710.831295363723);
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      linkedList0.add(pair0);
      linkedList0.add(pair0);
      ...
      Double[] doubleArray0 = discreteDistribution0.sample(2812);
      assertEquals(2812, doubleArray0.length);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(0.27930412537691374);
      Double double1 = new Double(0.41323419810547257);
  ...
  public void test20()  throws Throwable  {
      Double double0 = new Double((-3400.895506));
      Pair<String, Double> pair0 = new Pair<String, Double>("%*wg_ bZIq) g=FZZHf", double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -3,400.896 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
