...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        discreteDistribution0.sample((-922509710));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // number of samples (-922,509,710)
         //
  ...
  public void test01()  throws Throwable  {
      ...
      discreteDistribution0.sample(202);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      discreteDistribution0.sample(174465013);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        discreteDistribution0.reseedRandomGenerator(2172L);
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      ...
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double((-125.31764));
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -125.318 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Double double0 = new Double(1269);
      Pair<Integer, Double> pair0 = new Pair<Integer, Double>(integer0, double0);
      linkedList0.add(pair0);
      linkedList0.add(pair0);
      DiscreteDistribution<Integer> discreteDistribution0 = new DiscreteDistribution<Integer>(linkedList0);
      Integer integer1 = discreteDistribution0.sample();
      assertEquals(1269, (int)integer1);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Integer integer0 = new Integer(202);
      Double double0 = new Double(2517.3589800659);
      Pair<Integer, Double> pair0 = new Pair<Integer, Double>(integer0, double0);
      LinkedList<Pair<Integer, Double>> linkedList0 = new LinkedList<Pair<Integer, Double>>();
      linkedList0.add(pair0);
      DiscreteDistribution<Integer> discreteDistribution0 = new DiscreteDistribution<Integer>(linkedList0);
  ...
  public void test16()  throws Throwable  {
      ...
      Short short1 = new Short((short) (-2418));
  ...
  public void test17()  throws Throwable  {
      Double double0 = new Double(2971.193566045);
      LinkedList<Pair<Integer, Double>> linkedList0 = new LinkedList<Pair<Integer, Double>>();
      Pair<Integer, Double> pair0 = new Pair<Integer, Double>((Integer) null, double0);
      linkedList0.add(pair0);
      DiscreteDistribution<Integer> discreteDistribution0 = new DiscreteDistribution<Integer>(linkedList0);
  ...
  public void test20()  throws Throwable  {
      ...
      Double double0 = new Double((-742.015532696229));
      Pair<String, Double> pair0 = new Pair<String, Double>("Ju4P` &\"}R!2", double0);
      linkedList0.offerFirst(pair0);
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -742.016 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
