...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Double double0 = new Double(2569.1722218108293);
  ...
  public void test01()  throws Throwable  {
      ...
      Pair<String, Double> pair0 = new Pair<String, Double>("F/4`+B+X2)25g", double0);
      linkedList0.add(pair0);
      linkedList0.add(pair0);
      ...
      String[] stringArray0 = discreteDistribution0.sample(49);
  ...
  public void test03()  throws Throwable  {
      Double double0 = new Double(0.2275481716591632);
  ...
  public void test04()  throws Throwable  {
      ...
      discreteDistribution0.sample(251886711);
  }
  ...
  public void test06()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(2569.9478736987508);
  ...
  public void test07()  throws Throwable  {
      ...
      Double double0 = new Double(2408);
  ...
  public void test09()  throws Throwable  {
      Well44497b well44497b0 = new Well44497b(1467L);
  ...
  public void test10()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double((-997.72855740515));
      Pair<String, Double> pair0 = new Pair<String, Double>("O*#Vy_Y[3~j0!om", double0);
      linkedList0.add(pair0);
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -997.729 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      ...
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      try { 
        discreteDistribution0.sample((-2976));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // number of samples (-2,976)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      String string0 = discreteDistribution0.sample();
      assertEquals("F/4`+B+X2)25g", string0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      double double1 = discreteDistribution0.probability("F/4`+B+X2)25g");
      assertEquals(1.0, double1, 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      MersenneTwister mersenneTwister0 = new MersenneTwister((-624));
      LinkedList<Pair<Float, Double>> linkedList0 = new LinkedList<Pair<Float, Double>>();
      Double double0 = new Double((-3148.62922927));
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -3,148.629 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
