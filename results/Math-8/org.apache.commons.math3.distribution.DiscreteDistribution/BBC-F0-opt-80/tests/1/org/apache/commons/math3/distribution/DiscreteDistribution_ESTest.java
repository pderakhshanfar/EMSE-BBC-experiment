...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Double double0 = new Double(543.571486);
      Pair<String, Double> pair0 = new Pair<String, Double>("quLe", double0);
  ...
  public void test01()  throws Throwable  {
      ...
      Double double0 = new Double(0.5839820271367144);
      ...
      Double[] doubleArray0 = discreteDistribution0.sample(2102);
      assertEquals(2102, doubleArray0.length);
  }
  ...
  public void test03()  throws Throwable  {
      Double double0 = new Double(527.6381856362406);
  ...
  public void test04()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(613.2623);
      Pair<String, Double> pair0 = new Pair<String, Double>("", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
  ...
  public void test06()  throws Throwable  {
      Double double0 = new Double(481.4582597369641);
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
  ...
  public void test07()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(527.6381856362406);
      Pair<String, Double> pair0 = new Pair<String, Double>("qQuK", double0);
      linkedList0.add(pair0);
  ...
  public void test09()  throws Throwable  {
      ...
      Double double0 = new Double((-3410.7777109333733));
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -3,410.778 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      Double double0 = new Double(543.571486);
      Pair<String, Double> pair0 = new Pair<String, Double>("DT;uSp", double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
      linkedList0.addFirst(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      String string0 = discreteDistribution0.sample();
      assertEquals("DT;uSp", string0);
  }
  ...
  public void test13()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(543.571486);
      Pair<String, Double> pair0 = new Pair<String, Double>("que", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
  ...
  public void test14()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      double double1 = discreteDistribution0.probability("DT;uSp");
  ...
  public void test16()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(481.4582597369641);
      Pair<String, Double> pair0 = new Pair<String, Double>("_5FUKVT('(l#~u&_ ", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      double double1 = discreteDistribution0.probability("window size must be positive ({0})");
  ...
  public void test18()  throws Throwable  {
      ...
      Double double0 = new Double((-1212.616148));
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -1,212.616 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      discreteDistribution0.reseedRandomGenerator(2159);
  }
