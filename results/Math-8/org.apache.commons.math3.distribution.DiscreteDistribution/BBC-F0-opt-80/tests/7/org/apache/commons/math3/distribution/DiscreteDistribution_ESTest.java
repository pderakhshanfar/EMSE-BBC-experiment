...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        discreteDistribution0.sample((-2161));
  ...
  public void test03()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(0.7933845936378539);
      Pair<String, Double> pair0 = new Pair<String, Double>((String) null, double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      // Undeclared exception!
      try { 
        discreteDistribution0.sample(697);
  ...
  public void test04()  throws Throwable  {
      ...
      Pair<String, Double> pair0 = new Pair<String, Double>("nHT[<.v7F", double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
  ...
  public void test05()  throws Throwable  {
      ...
      Double double0 = new Double(0.9850894028518558);
      ...
      // Undeclared exception!
      try { 
        discreteDistribution0.reseedRandomGenerator(976L);
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      ...
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      String string0 = discreteDistribution0.sample();
      assertEquals("must have n >= k for binomial coefficient (n, k), got k = {0}, n = {1}", string0);
  }
  ...
  public void test12()  throws Throwable  {
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double(0.9306710619095984);
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      ...
      Double[] doubleArray0 = discreteDistribution0.sample(664);
      assertEquals(664, doubleArray0.length);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Well44497b well44497b0 = new Well44497b(3952090531849364496L);
      Double double0 = new Double(1388.08);
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      linkedList0.add(pair0);
      ...
      discreteDistribution0.sample(3680);
      // Undeclared exception!
      discreteDistribution0.sample(1274);
  }
  ...
  public void test14()  throws Throwable  {
      Double double0 = new Double(0.5929316043150812);
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double0);
      linkedList0.add(pair0);
  ...
  public void test18()  throws Throwable  {
      Double double0 = new Double(9.223372036854776E18);
      Well44497b well44497b0 = new Well44497b((-222L));
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
  ...
  public void test19()  throws Throwable  {
      ...
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double((-3281.73119448));
      Pair<String, Double> pair0 = new Pair<String, Double>("Frd:^", double0);
      linkedList0.add(pair0);
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -3,281.731 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
