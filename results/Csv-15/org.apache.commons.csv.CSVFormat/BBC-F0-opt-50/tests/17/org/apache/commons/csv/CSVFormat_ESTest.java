...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      objectArray0[0] = (Object) "#r+HierO_";
      String string0 = cSVFormat0.format(objectArray0);
      assertEquals("\"#r+HierO_\"", string0);
  }

  @Test(timeout = 4000)
  public void test003()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("!*(![W-G");
      PipedReader pipedReader0 = new PipedReader();
      PipedWriter pipedWriter0 = new PipedWriter(pipedReader0);
      Object[] objectArray0 = new Object[8];
      objectArray0[0] = (Object) "!*(![W-G";
  ...
  public void test034()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withTrailingDelimiter();
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("g)\"'xm:{BT5O$3?=");
      assertTrue(cSVFormat2.getTrailingDelimiter());
      assertFalse(cSVFormat1.getAutoFlush());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getTrim());
  ...
  public void test035()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord();
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("Eafa4/jqGFC9Ee'/$");
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreHeaderCase());
  ...
  public void test060()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("l kZ+r>CaG-");
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("l kZ+r>CaG-", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreHeaderCase());
      assertFalse(cSVFormat1.getTrailingDelimiter());
      assertFalse(cSVFormat1.getTrim());
  ...
  public void test062()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withAutoFlush(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("G'hs}Lylp");
      assertFalse(cSVFormat2.getTrailingDelimiter());
      assertFalse(cSVFormat1.getTrim());
      assertTrue(cSVFormat1.getAutoFlush());
      assertFalse(cSVFormat1.getIgnoreHeaderCase());
  ...
  public void test100()  throws Throwable  {
      ...
      stringArray0[0] = "Ny(e$n\"4fj6r\"5G-";
      stringArray0[1] = "Ha$rzB";
      stringArray0[2] = "*?h>_##uc>X08]";
      stringArray0[3] = "HeaderComments:";
      stringArray0[4] = ">";
      stringArray0[5] = "EOF whilst processing escape sequence";
      stringArray0[6] = "";
      stringArray0[7] = "7]DRJ)!KWHB'";
  ...
  public void test102()  throws Throwable  {
      ...
      stringArray0[2] = "x>~=rxo<+!.5";
      stringArray0[3] = "F7e0{-pKB";
      stringArray0[4] = "W?4~'lH<U)j>\"h";
      stringArray0[5] = "lpg<T)$t7W{s$E";
      stringArray0[6] = "file";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertFalse(cSVFormat1.getTrim());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test106()  throws Throwable  {
      ...
      stringArray0[0] = "6@Aw0]e";
      stringArray0[1] = "HV9#%L^2";
      stringArray0[2] = "No quotes mode set but no escape character is set";
      stringArray0[3] = "Upf}y>";
      stringArray0[4] = "o*KLZ'w_?Ik0qf;";
      stringArray0[5] = "s)W+Ns>Iw";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat2.getTrailingDelimiter());
      assertTrue(cSVFormat1.getAutoFlush());
  ...
  public void test149()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('{');
      CSVFormat cSVFormat2 = cSVFormat1.withCommentMarker(character0);
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("l kZ+r>CaG-");
      assertFalse(cSVFormat3.getAllowMissingColumnNames());
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
      assertFalse(cSVFormat3.getTrailingDelimiter());
      assertFalse(cSVFormat3.getAutoFlush());
  ...
  public void test210()  throws Throwable  {
      ...
      ByteBuffer byteBuffer0 = ByteBuffer.allocateDirect(2456);
  ...
  public void test218()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("reader", "Delimiter=<,> QuoteChar=<\"> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false");
  ...
  public void test220()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("]V6_{ZE[#L", "y.}=-$");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test267()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getTrailingDelimiter());
      assertFalse(cSVFormat1.getTrim());
      assertEquals("Delimiter=<k> SkipHeaderRecord:true Header:[]", string0);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
  }
  ...
  public void test270()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getTrailingDelimiter());
      assertFalse(cSVFormat1.getAutoFlush());
      assertEquals("Delimiter=<|> Escape=<\\> QuoteChar=<\"> CommentStart=<G> RecordSeparator=<\n> EmptyLines:ignored SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getTrim());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  }
  ...
  public void test271()  throws Throwable  {
      ...
      Object[] objectArray0 = new Object[2];
      String[] stringArray0 = new String[9];
      stringArray0[0] = "zIPpVYqoN czxUjR0Jy";
      stringArray0[1] = "(startline ";
      stringArray0[2] = "\n";
      stringArray0[3] = "C6w=XQ|FN[";
      stringArray0[4] = "T>GCr(Lcg8p^4UvLY2";
      stringArray0[6] = "Reco%rdSeparator=<";
      stringArray0[7] = "TgGbs7,uEk";
      stringArray0[8] = "org.apache.commons.csv.Constants";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      String string0 = cSVFormat1.format(objectArray0);
      assertFalse(cSVFormat1.getIgnoreHeaderCase());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("zIPpVYqoN czxUjR0Jy,\"(startline \",\"\n\",C6w=XQ|FN[,T>GCr(Lcg8p^4UvLY2,,Reco%rdSeparator=<,\"TgGbs7,uEk\",org.apache.commons.csv.Constants\r\n,", string0);
  }
  ...
  public void test322()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      PipedWriter pipedWriter0 = new PipedWriter();
      PipedReader pipedReader0 = new PipedReader(pipedWriter0, 1693);
  ...
  public void test323()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("0/=hj@%#$nKU:Sz");
      Charset charset0 = Charset.defaultCharset();
