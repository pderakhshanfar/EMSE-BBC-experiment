...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("*!a+6_~&yhqS%\"r*9");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("\u2028");
      assertEquals("*!a+6_~&yhqS%\"r*9", cSVFormat2.getNullString());
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("zHC_zGCwj@mmCkf+");
      assertTrue(cSVFormat2.isCommentingEnabled());
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test007()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("@K0Xfgu6");
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.isNullHandling());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isCommentingEnabled());
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("P(je.b=&{|-cb]/_");
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.isNullHandling());
  ...
  public void test020()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(' ');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("I+n,eE0");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator(' ');
      assertEquals(' ', cSVFormat2.getDelimiter());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertEquals(" ", cSVFormat2.getRecordSeparator());
      assertEquals("I+n,eE0", cSVFormat2.getNullString());
  }
  ...
  public void test040()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("CmA6aIh<,$!\"I'M\">h");
      ...
      assertEquals("CmA6aIh<,$!\"I'M\">h", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test059()  throws Throwable  {
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("*!a+6_~&yhqS%\"r*9", string0);
  }
  ...
  public void test096()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      StringReader stringReader0 = new StringReader("#%)UR&g M?&9|!$hW*|");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test106()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("*!a+6_~&yhqS%\"r*9");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<*!a+6_~&yhqS%\"r*9> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test107()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("*!a+6_~&yhqS%\"r*9", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test122()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ze|oSSnc~{2");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isEscaping());
      ...
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(boolean0);
      assertEquals("ze|oSSnc~{2", cSVFormat1.getNullString());
  }
  ...
  public void test123()  throws Throwable  {
      ...
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("CmA6aIh<,$!\"I'M\">h", cSVFormat1.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
  }
  ...
  public void test145()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("@bn!K#h^vBv3j!");
