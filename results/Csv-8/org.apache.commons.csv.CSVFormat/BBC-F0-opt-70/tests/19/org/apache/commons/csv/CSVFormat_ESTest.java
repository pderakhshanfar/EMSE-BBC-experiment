...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withQuoteChar('F');
  ...
  public void test001()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("[gr5'FPb");
  ...
  public void test010()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator(":647>");
      assertFalse(cSVFormat2.isEscaping());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test027()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString(":647>");
      assertEquals(',', cSVFormat3.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat3.isQuoting());
      ...
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertEquals(":647>", cSVFormat3.getNullString());
      assertFalse(cSVFormat3.isEscaping());
  }
  ...
  public void test028()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(":647>");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(":647>", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isQuoting());
  }
  ...
  public void test030()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withCommentStart('p');
  ...
  public void test052()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("UD lQx/");
  ...
  public void test063()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('V');
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withQuoteChar('z');
  ...
  public void test096()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"$g[/wA*V7-xK");
      try { 
        cSVFormat1.parse(stringReader0);
  ...
  public void test121()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("XrR>D5Tx6OF");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("XrR>D5Tx6OF");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("XrR>D5Tx6OF", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isQuoting());
      assertTrue(cSVFormat2.isEscaping());
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test122()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("O1Ya}v]7arz1gsYGcN");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(boolean0);
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      ...
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("O1Ya}v]7arz1gsYGcN", cSVFormat1.getNullString());
  }

  @Test(timeout = 4000)
  public void test123()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("CP);QMCuyP9T>UOr ");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("CP);QMCuyP9T>UOr ", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test132()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      boolean boolean0 = cSVFormat0.equals("Mapping for %s not found, expected one of %s");
      assertFalse(boolean0);
  }
