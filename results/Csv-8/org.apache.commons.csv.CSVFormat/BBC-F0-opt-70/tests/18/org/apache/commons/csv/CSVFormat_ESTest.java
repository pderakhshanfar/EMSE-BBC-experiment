...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("VuJ}4Wi\"N");
      cSVFormat1.hashCode();
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isEscaping());
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("uO@{^R@GBFH7OrRHV");
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("string", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("uO@{^R@GBFH7OrRHV", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isEscaping());
  ...
  public void test018()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("%3GzN0vwf]P:4");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('}');
      assertEquals('}', (char)cSVFormat2.getQuoteChar());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("%3GzN0vwf]P:4", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.isEscaping());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test033()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("S]$.yruPEA5X _Q4");
  ...
  public void test034()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("1+MK|9Q");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals("1+MK|9Q", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.isQuoting());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test037()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("qPJ");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(':');
      String[] stringArray0 = new String[8];
      CSVFormat cSVFormat3 = cSVFormat2.withHeader(stringArray0);
      assertEquals('\t', cSVFormat3.getDelimiter());
      assertEquals("\n", cSVFormat3.getRecordSeparator());
      assertEquals("qPJ", cSVFormat3.getNullString());
      assertFalse(cSVFormat3.getSkipHeaderRecord());
  ...
  public void test105()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("1+MK|9Q");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<1+MK|9Q> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", string0);
  }
  ...
  public void test106()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<A> CommentStart=<a> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertEquals('A', cSVFormat0.getDelimiter());
  ...
  public void test117()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("rNdz<~&r,1+i>\"ebWP");
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("rNdz<~&r,1+i>\"ebWP");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("rNdz<~&r,1+i>\"ebWP", cSVFormat2.getNullString());
      assertTrue(boolean0);
      assertFalse(cSVFormat2.equals((Object)cSVFormat0));
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test133()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"1]a(08}U8");
      try { 
        cSVFormat1.parse(stringReader0);
  ...
  public void test136()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("1+MK|9Q", cSVFormat1.getNullString());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isCommentingEnabled());
