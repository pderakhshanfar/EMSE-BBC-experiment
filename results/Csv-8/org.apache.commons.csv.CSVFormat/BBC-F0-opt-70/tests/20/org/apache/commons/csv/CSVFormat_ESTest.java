...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test007()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("4CSn&,1}wB2UDM");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('q');
      assertEquals("4CSn&,1}wB2UDM", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
  ...
  public void test036()  throws Throwable  {
      ...
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertEquals(',', cSVFormat3.getDelimiter());
      assertEquals('I', (char)cSVFormat4.getEscape());
  ...
  public void test041()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("^`n(S}CQ!m\"5mNV!2BV");
      ...
      assertEquals("^`n(S}CQ!m\"5mNV!2BV", cSVFormat3.getNullString());
  }
  ...
  public void test091()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // The header contains duplicate names: [T, T]
         //
         verifyException("org.apache.commons.csv.CSVFormat", e);
      }
  }
  ...
  public void test095()  throws Throwable  {
      ...
      Character character0 = new Character('}');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      StringReader stringReader0 = new StringReader("ExpWK");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test100()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("}'7FBVqO@=C (J");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<}'7FBVqO@=C (J> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test113()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("4CSn&,1}wB2UDM");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("-{F7i\"");
  ...
  public void test114()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("}'7FBVqO@=C (J", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test126()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      boolean boolean0 = cSVFormat0.equals("LKomA9,V{/Oo");
      assertFalse(boolean0);
  }
  ...
  public void test134()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\". 1 %Nd>)xe:cTF'");
      try { 
        cSVFormat2.parse(stringReader0);
