...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test007()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("jH6x45");
  ...
  public void test010()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("FXYCL&4<J,VGZ3j");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('k');
      assertTrue(cSVFormat2.isEscaping());
      assertEquals("FXYCL&4<J,VGZ3j", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test012()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("FiFR7+");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      ...
      assertFalse(cSVFormat3.getIgnoreEmptyLines());
      assertEquals("FiFR7+", cSVFormat3.getNullString());
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
  }
  ...
  public void test027()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("JX`<wA{q{&");
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("JX`<wA{q{&", cSVFormat2.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoting());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test030()  throws Throwable  {
      ...
      CSVFormat cSVFormat4 = cSVFormat3.withRecordSeparator("o(XR33C)sdfL1eQ3r");
      assertEquals('\"', (char)cSVFormat4.getQuoteChar());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("", cSVFormat4.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("o(XR33C)sdfL1eQ3r", cSVFormat4.getRecordSeparator());
      assertEquals(',', cSVFormat3.getDelimiter());
  ...
  public void test035()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(">@8V");
      String[] stringArray0 = new String[1];
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals(">@8V", cSVFormat2.getNullString());
  }
  ...
  public void test046()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("u`D-@i~");
      Character character0 = Character.valueOf('M');
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("u`D-@i~", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test072()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("Q@8V");
      stringReader0.close();
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
  ...
  public void test077()  throws Throwable  {
      ...
      assertEquals("FiFR7+", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isEscaping());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
  ...
  public void test122()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("JX`<wA{q{&");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(boolean0);
      assertEquals("JX`<wA{q{&", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals('\t', cSVFormat1.getDelimiter());
