...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withRecordSeparator("QuoteChar=<");
  ...
  public void test013()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("S=7a8c#J<?^{{&{|>1");
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('!');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("9Y\u0002jfUW");
  ...
  public void test027()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("v:5Zs_kDJ C_d");
      CSVFormat cSVFormat2 = cSVFormat1.withHeader((String[]) null);
      assertEquals("v:5Zs_kDJ C_d", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat2.isEscaping());
  ...
  public void test042()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("V[]}bB0L");
      Character character0 = new Character('*');
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("V[]}bB0L", cSVFormat2.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
  ...
  public void test053()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("(?K(&<@pm5+g f5N");
      String string0 = cSVFormat1.getNullString();
      assertEquals("(?K(&<@pm5+g f5N", string0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test093()  throws Throwable  {
      ...
      String[] stringArray0 = new String[4];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("<_3pZ");
      // Undeclared exception!
      try { 
  ...
  public void test094()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      StringReader stringReader0 = new StringReader("u_-NjLD'.");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test102()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("(Jp<t`<4JAQP3");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<(Jp<t`<4JAQP3> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test110()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("3'Cw0VOr8M?3H|)9e+(");
      cSVFormat1.parse(stringReader0);
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test115()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("v:5Zs_kDJ C_d");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("j~>E#M_v4*LVvy");
  ...
  public void test116()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(boolean0);
      assertEquals("(?K(&<@pm5+g f5N", cSVFormat1.getNullString());
  }
  ...
  public void test117()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("v:5Zs_kDJ C_d", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(boolean0);
  }
