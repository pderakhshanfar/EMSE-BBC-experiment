...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("LB~x6.{I?x");
  ...
  public void test005()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("I&c2^RAq.zC");
      ...
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("I&c2^RAq.zC", cSVFormat2.getNullString());
  }
  ...
  public void test009()  throws Throwable  {
      ...
      assertEquals("I&c2^RAq.zC", cSVFormat4.getNullString());
  ...
  public void test014()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("\"@{[D/.(C& 5w.r");
      Character character0 = cSVFormat0.getEscape();
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\"@{[D/.(C& 5w.r", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test021()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("unN>]");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isEscaping());
      ...
      assertFalse(cSVFormat2.isQuoting());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("unN>]", cSVFormat2.getNullString());
  }
  ...
  public void test023()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('-');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("hS<~mb2=7E");
  ...
  public void test033()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("CV)n<o/p\"%");
      ...
      assertEquals("CV)n<o/p\"%", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test037()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("I&c2^RAq.zC");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter(')');
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("%a.&J^+qbyYGGR");
      ...
      assertFalse(cSVFormat3.getIgnoreEmptyLines());
      assertEquals('\"', (char)cSVFormat4.getQuoteChar());
      assertEquals("%a.&J^+qbyYGGR", cSVFormat4.getRecordSeparator());
  }
  ...
  public void test042()  throws Throwable  {
      ...
      assertFalse(cSVFormat3.isEscaping());
      assertTrue(cSVFormat3.isQuoting());
      assertEquals("CV)n<o/p\"%", cSVFormat3.getNullString());
  }
  ...
  public void test047()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader(";H%t\"oDPBZ=I=WWp");
      cSVFormat1.parse(stringReader0);
      assertFalse(cSVFormat1.isNullHandling());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
  ...
  public void test070()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("5*JH5&wy4G)v&O?c2[E");
      stringReader0.close();
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
  ...
  public void test087()  throws Throwable  {
      ...
      String[] stringArray0 = new String[7];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader(">~#LO{<r/");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
  ...
  public void test115()  throws Throwable  {
      ...
      assertFalse(cSVFormat3.equals((Object)cSVFormat1));
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertEquals("\"@{[D/.(C& 5w.r", cSVFormat3.getNullString());
  ...
  public void test116()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("\"@{[D/.(C& 5w.r");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('\t');
      CSVFormat cSVFormat3 = cSVFormat0.TDF.withIgnoreSurroundingSpaces(false);
      boolean boolean0 = cSVFormat2.equals(cSVFormat3);
      assertTrue(cSVFormat3.isQuoting());
      assertFalse(cSVFormat1.equals((Object)cSVFormat2));
      assertFalse(cSVFormat3.isEscaping());
