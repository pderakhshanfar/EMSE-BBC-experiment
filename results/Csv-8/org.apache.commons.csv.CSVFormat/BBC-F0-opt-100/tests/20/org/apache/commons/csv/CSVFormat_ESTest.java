...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("rv<");
      ...
      assertEquals("rv<", cSVFormat2.getNullString());
  ...
  public void test019()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(';');
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("7yIF_-=;5~}M");
  ...
  public void test020()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("]_;vYJe]<!");
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("]_;vYJe]<!", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test039()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("c<Py)");
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("c<Py)", cSVFormat2.getNullString());
  ...
  public void test051()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("XQLa~cnwN^eB\"ak;ngy");
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("XQLa~cnwN^eB\"ak;ngy", string0);
      assertFalse(cSVFormat1.isEscaping());
  }
  ...
  public void test052()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator(";Xy");
      String string0 = cSVFormat2.getNullString();
      assertEquals(";Xy", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test091()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("?_d]@D3>");
      // Undeclared exception!
      try { 
  ...
  public void test094()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(';');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(';');
      StringReader stringReader0 = new StringReader("7yIF_-=;5~}M");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test095()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("c<Py)");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test099()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("XQLa~cnwN^eB\"ak;ngy");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> QuoteChar=<\"> NullString=<XQLa~cnwN^eB\"ak;ngy> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", string0);
  }
  ...
  public void test103()  throws Throwable  {
      ...
      cSVFormat1.hashCode();
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("XQLa~cnwN^eB\"ak;ngy", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.isEscaping());
  }
  ...
  public void test106()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("@CEv(");
      cSVFormat1.parse(stringReader0);
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test112()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("XQLa~cnwN^eB\"ak;ngy", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(boolean0);
      assertFalse(cSVFormat2.isCommentingEnabled());
  ...
  public void test114()  throws Throwable  {
      ...
      assertEquals(',', cSVFormat2.getDelimiter());
      assertFalse(boolean0);
      assertEquals("a7", cSVFormat2.getNullString());
  }
