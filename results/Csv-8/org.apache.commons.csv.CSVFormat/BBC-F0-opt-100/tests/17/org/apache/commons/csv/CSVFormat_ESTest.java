...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("P9*(j3#^iwB~M3PFg");
      ...
      assertEquals("P9*(j3#^iwB~M3PFg", cSVFormat2.getNullString());
  ...
  public void test006()  throws Throwable  {
      ...
      Character character0 = new Character('N');
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("c<'.Se\"");
  ...
  public void test009()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("h6");
  ...
  public void test023()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("GmqL_c|h$#};yD0|z0");
  ...
  public void test041()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("u-TdDlR{ib]\"s7uQ");
      Character character0 = Character.valueOf('%');
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      assertEquals("u-TdDlR{ib]\"s7uQ", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test046()  throws Throwable  {
      ...
      stringArray0[0] = "7~Nn";
      stringArray0[1] = "S:f";
      stringArray0[2] = "RXF_\"{o)36";
      stringArray0[3] = "!CU^=i.4";
      stringArray0[4] = "28fmh'Pw_9rq";
      stringArray0[5] = "sKcU";
  ...
  public void test053()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("/XJr|G");
      String string0 = cSVFormat1.getNullString();
      assertEquals("/XJr|G", string0);
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test092()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("H;,Q6l10.&{[/>-Niv$");
      // Undeclared exception!
      try { 
  ...
  public void test102()  throws Throwable  {
      ...
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=</XJr|G> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test119()  throws Throwable  {
      ...
      Character character0 = new Character('{');
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("HNv");
      ...
      assertEquals('\"', (char)cSVFormat3.getQuoteChar());
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertEquals("HNv", cSVFormat3.getNullString());
      assertEquals("\r\n", cSVFormat3.getRecordSeparator());
      assertFalse(cSVFormat1.equals((Object)cSVFormat0));
  }
  ...
  public void test137()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("/XJr|G");
      cSVFormat1.hashCode();
      assertEquals("/XJr|G", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test138()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar('}');
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('}');
      StringReader stringReader0 = new StringReader("OK-8h");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
