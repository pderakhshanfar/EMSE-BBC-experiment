...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test019()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('^');
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("R3D_9.CzSmNk?`");
      Character character0 = Character.valueOf('^');
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals("R3D_9.CzSmNk?`", cSVFormat2.getNullString());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
  ...
  public void test023()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("K6+`lh_*[3W:R2YR3");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('c');
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("K6+`lh_*[3W:R2YR3", cSVFormat2.getNullString());
      assertEquals('\\', (char)cSVFormat2.getEscape());
  ...
  public void test024()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\u000B');
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withQuoteChar('0');
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test035()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("V6,5k;*`;`Wv1U4$");
      ...
      assertEquals("V6,5k;*`;`Wv1U4$", cSVFormat3.getNullString());
  }
  ...
  public void test039()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('@');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("05&N1v+zP$@");
  ...
  public void test043()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("=U8Fw[Fv");
      ...
      assertEquals("=U8Fw[Fv", cSVFormat4.getNullString());
  }
  ...
  public void test047()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("(|'Ld[n");
  ...
  public void test072()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"\",org.apache.commons.csv.CSVFormat@0000000003,,,,,org.apache.commons.csv.CSVFormat@0000000001,,");
      try { 
        cSVFormat1.parse(stringReader0);
  ...
  public void test102()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("7 xtl<D4xJ7");
      cSVFormat1.parse(stringReader0);
  ...
  public void test105()  throws Throwable  {
      ...
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals('Z', cSVFormat0.getDelimiter());
      assertEquals("Delimiter=<Z> SkipHeaderRecord:false Header:[null, null, null, null, null, null, null]", string0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
  }
  ...
  public void test107()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("(|'Ld[n");
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(boolean0);
      assertEquals("(|'Ld[n", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isEscaping());
  }
  ...
  public void test112()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("3m>Or]5V-g?5$</T@");
      cSVFormat1.hashCode();
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isQuoting());
  ...
  public void test121()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("#=b%s$<]t/H");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(false);
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      ...
      assertTrue(boolean0);
      assertFalse(cSVFormat2.equals((Object)cSVFormat0));
      assertEquals("#=b%s$<]t/H", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isEscaping());
  ...
  public void test131()  throws Throwable  {
      ...
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.isQuoting());
      assertEquals("R3D_9.CzSmNk?`", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isEscaping());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
  }
