...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("/.fpl");
      ...
      assertEquals("/.fpl", cSVFormat3.getNullString());
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("6RfL0s,IC");
      assertEquals("\r\n", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("6RfL0s,IC", cSVFormat2.getRecordSeparator());
  ...
  public void test018()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('y');
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("n1&f-}");
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('%');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("`cj KN~Xv%<");
  ...
  public void test040()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("QuoteChar=<");
  ...
  public void test049()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("/.fpl");
  ...
  public void test061()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withCommentStart('y');
      Character character0 = cSVFormat1.getCommentStart();
      assertFalse(cSVFormat1.isEscaping());
  ...
  public void test091()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("QF9'~xrxs/^7~");
      // Undeclared exception!
      try { 
  ...
  public void test093()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("^\" I<@6&M|C~");
      cSVFormat1.parse(stringReader0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals('q', (char)cSVFormat1.getCommentStart());
      assertFalse(cSVFormat1.isNullHandling());
  ...
  public void test100()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("(wJ");
  ...
  public void test109()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('9');
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("y&M");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.isNullHandling());
  ...
  public void test115()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("TTipw5?Gu(Zy%6V");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("TTipw5?Gu(Zy%6V", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertTrue(cSVFormat1.isEscaping());
