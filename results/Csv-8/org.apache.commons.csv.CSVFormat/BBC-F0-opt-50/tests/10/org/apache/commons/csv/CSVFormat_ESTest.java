...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test015()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("zg(xK");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('k');
      assertTrue(cSVFormat2.isQuoting());
      assertEquals('k', (char)cSVFormat2.getQuoteChar());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("zg(xK", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test020()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(">GKb=0 kh<vm}VR?E");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(true);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(">GKb=0 kh<vm}VR?E", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isQuoting());
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test026()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("'K`qc");
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("'K`qc", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test050()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(">GKb=0 kh<vm}VR?E", string0);
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test066()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader(" -Jnq4xwf9b}EA");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      stringReader0.close();
      try { 
  ...
  public void test086()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // The header contains duplicate names: [The header contains duplicate names: , The header contains duplicate names: ]
         //
         verifyException("org.apache.commons.csv.CSVFormat", e);
      }
  }
  ...
  public void test095()  throws Throwable  {
      ...
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertEquals("Delimiter=<> NullString=<The delimiter cannot be a line break> SkipHeaderRecord:false", string0);
      assertEquals('', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
  }
  ...
  public void test111()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("The delimiter cannot be a line break");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(false);
      CSVFormat cSVFormat3 = cSVFormat1.withRecordSeparator("The delimiter cannot be a line break");
      boolean boolean0 = cSVFormat2.equals(cSVFormat3);
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertEquals('', cSVFormat3.getDelimiter());
      assertFalse(cSVFormat3.getIgnoreEmptyLines());
  ...
  public void test119()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("/!=1&M7VaK-2NZHp.1");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(boolean0);
      assertEquals("/!=1&M7VaK-2NZHp.1", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
