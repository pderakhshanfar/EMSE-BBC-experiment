...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withRecordSeparator("&p3]pH}.R");
  ...
  public void test007()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withRecordSeparator("The comment start character and the quoteChar cannot be the same ('");
      assertTrue(cSVFormat1.isQuoting());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test008()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("KSH}*^d2~3W]");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('0');
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("KSH}*^d2~3W]", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test014()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("!{<Rs_=0%vVl#f-,");
      ...
      assertEquals("!{<Rs_=0%vVl#f-,", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test018()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(">fMWi^puef@d'#4 $");
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(";`aHRS;J#S");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(true);
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.getIgnoreSurroundingSpaces());
      assertEquals(";`aHRS;J#S", cSVFormat2.getNullString());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
  ...
  public void test040()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(".7pl;{2'FSpR*HIa5+");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals(".7pl;{2'FSpR*HIa5+", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test050()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("G&#{o w");
  ...
  public void test096()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("!{<Rs_=0%vVl#f-,");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<!{<Rs_=0%vVl#f-,> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test114()  throws Throwable  {
      ...
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertEquals("oS", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test117()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('T');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(".7pl;{2'FSpR*HIa5+");
      boolean boolean0 = cSVFormat2.equals(cSVFormat1);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals(',', cSVFormat2.getDelimiter());
  ...
  public void test131()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("D@ku<hTg_#|7O`");
      cSVFormat1.parse(stringReader0);
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
  ...
  public void test132()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ucg8BAv,X/-s7tB@E");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("ucg8BAv,X/-s7tB@E", cSVFormat2.getNullString());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isCommentingEnabled());
