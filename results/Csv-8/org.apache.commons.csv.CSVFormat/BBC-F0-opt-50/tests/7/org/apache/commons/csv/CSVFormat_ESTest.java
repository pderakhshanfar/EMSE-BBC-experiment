...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("AB=,7n%9");
      cSVFormat1.hashCode();
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withRecordSeparator("The header contains duplicate names: ");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test023()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("a`'F*s");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("a`'F*s", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test025()  throws Throwable  {
      ...
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("AB=,7n%9", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
  ...
  public void test057()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("|94");
      String string0 = cSVFormat2.getNullString();
      assertEquals("CommentStart=<", string0);
      assertEquals("|94", cSVFormat2.getRecordSeparator());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test073()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      StringReader stringReader0 = new StringReader("W1XTe_}1Q ");
      try { 
  ...
  public void test104()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter(' ');
      StringReader stringReader0 = new StringReader("BOWzq'5H7*RC$ql");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test107()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Wa6r3_r5");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<Wa6r3_r5> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }

  @Test(timeout = 4000)
  public void test108()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('s');
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("vmylj-1kB%");
      boolean boolean0 = cSVFormat1.isNullHandling();
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertTrue(boolean0);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(cSVFormat1.isQuoting());
      assertEquals("vmylj-1kB%", cSVFormat1.getNullString());
