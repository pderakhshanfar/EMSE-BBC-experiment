...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("\":*9O[<F+-uM;");
      ...
      assertEquals("\":*9O[<F+-uM;", cSVFormat2.getNullString());
  ...
  public void test014()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(stringArray0[4]);
      assertTrue(cSVFormat1.equals((Object)cSVFormat0));
  }
  ...
  public void test018()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("wSF`k&1");
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("wSF`k&1", cSVFormat2.getNullString());
  }
  ...
  public void test084()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      StringReader stringReader0 = new StringReader("</'7AEVT");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test085()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('d');
      StringReader stringReader0 = new StringReader("zr'RDlLj]aVXHQAjME.");
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('d');
      // Undeclared exception!
      try { 
  ...
  public void test091()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("\":*9O[<F+-uM;");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<\":*9O[<F+-uM;> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", string0);
  }
  ...
  public void test093()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<x> Escape=<#> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
  ...
  public void test094()  throws Throwable  {
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\":*9O[<F+-uM;", cSVFormat1.getNullString());
  }
  ...
  public void test106()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("9!]0!o");
      ...
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(boolean0);
      assertEquals("9!]0!o", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
  }
  ...
  public void test108()  throws Throwable  {
      ...
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("9!]0!o", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test119()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('x');
      StringReader stringReader0 = new StringReader("DaifCT&");
