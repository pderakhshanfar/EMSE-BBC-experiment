...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("si4FD~&X$!;JFFS");
      ...
      assertEquals("GGGsi4FD~&X$!;JFFS", string0);
  ...
  public void test001()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("%hc Oq(4.Vj<?pK:");
  ...
  public void test002()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('r');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("org.apache.commons.csv.CSVFormat@0000000003rorg.apache.commons.csv.CSVFormat@0000000001rjava.lang.Object@0000000006");
      cSVFormat1.hashCode();
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("5zkB$0M+9nN~qu/47Ld");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isNullHandling());
  ...
  public void test009()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("V8");
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("V8");
      assertFalse(cSVFormat3.isQuoting());
      assertEquals('\t', cSVFormat3.getDelimiter());
      assertEquals("V8", cSVFormat2.getNullString());
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
  ...
  public void test013()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("V8");
  ...
  public void test032()  throws Throwable  {
      ...
      assertFalse(cSVFormat3.isQuoting());
      assertFalse(cSVFormat3.getIgnoreEmptyLines());
      assertEquals("V8", cSVFormat3.getNullString());
      assertTrue(cSVFormat3.isEscaping());
      assertEquals('\t', cSVFormat3.getDelimiter());
  }
  ...
  public void test039()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("V8");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("V8");
      CSVFormat cSVFormat3 = cSVFormat2.withDelimiter('S');
      assertFalse(cSVFormat3.isQuoting());
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertTrue(cSVFormat3.isEscaping());
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
      assertEquals("V8", cSVFormat1.getNullString());
  ...
  public void test043()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('r');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("6!D$@}Wm(ANI");
  ...
  public void test051()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("3A=");
  ...
  public void test097()  throws Throwable  {
      ...
      Character character0 = new Character('r');
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character0);
      StringReader stringReader0 = new StringReader("]NTL-7y\"53");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
