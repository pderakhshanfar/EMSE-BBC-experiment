...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("_+7m31+\"[o4''<;kl");
      ...
      assertEquals("_+7m31+\"[o4''<;kl", cSVFormat2.getNullString());
  }
  ...
  public void test009()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("IW");
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test023()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("rm2-OfR'\"b`G.H}g_ ");
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("rm2-OfR'\"b`G.H}g_ ", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
  }
  ...
  public void test024()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withIgnoreSurroundingSpaces(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("_+7m31+\"[o4''<;kl");
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isQuoting());
      assertTrue(cSVFormat2.isEscaping());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("rm2-OfR'\"b`G.H}g_ ");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('!');
      CSVFormat cSVFormat3 = cSVFormat2.withIgnoreSurroundingSpaces(false);
      assertEquals("\r\n", cSVFormat3.getRecordSeparator());
      assertEquals("rm2-OfR'\"b`G.H}g_ ", cSVFormat3.getNullString());
  ...
  public void test051()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("*Qmt;Jh_,4H{O`V");
  ...
  public void test058()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withQuoteChar('k');
  ...
  public void test059()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("or-Pu");
  ...
  public void test074()  throws Throwable  {
      ...
      CSVFormat cSVFormat5 = cSVFormat4.withNullString("org.apache.commons.csv.Constants");
  ...
  public void test105()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("rm2-OfR'\"b`G.H}g_ ");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<rm2-OfR'\"b`G.H}g_ > RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test106()  throws Throwable  {
      ...
      assertTrue(boolean0);
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("rm2-OfR'\"b`G.H}g_ ", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test117()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\'');
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("J#/`w%LlY-");
  ...
  public void test129()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("*Qmt;Jh_,4H{O`V");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(boolean0);
  ...
  public void test132()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('n');
      boolean boolean0 = cSVFormat0.equals("zU:_aCzm?d#,W?yp|H");
      assertFalse(boolean0);
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertEquals('n', cSVFormat0.getDelimiter());
