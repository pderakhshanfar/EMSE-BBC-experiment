...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("@K^r4}|1wq30");
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("nJw<k6,xe)j");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("nJw<k6,xe)j");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("nJw<k6,xe)j", cSVFormat1.getNullString());
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("MOb?G%2(BK1E");
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test015()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("uWbp");
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("uWbp", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test020()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("O;s");
      assertEquals('$', (char)cSVFormat2.getCommentStart());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("O;s", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
  ...
  public void test024()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("O;s");
  ...
  public void test041()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      String[] stringArray0 = new String[5];
      stringArray0[0] = "'<tkWT1:Ua<q|y";
      stringArray0[1] = "2s-x5GLXGQ+lnFi";
      stringArray0[2] = "";
      stringArray0[3] = "rpjNP]m ";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertFalse(cSVFormat2.isCommentingEnabled());
  ...
  public void test069()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("r9+nh,c'K#]F8");
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(boolean0);
      assertEquals("r9+nh,c'K#]F8", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test092()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("a)]hN?K6");
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('!');
      Character character0 = new Character('!');
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      // Undeclared exception!
  ...
  public void test099()  throws Throwable  {
      ...
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<PV> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test112()  throws Throwable  {
      ...
      assertEquals("PV", cSVFormat2.getNullString());
      assertTrue(boolean0);
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.isCommentingEnabled());
  ...
  public void test113()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("O;s");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertEquals("O;s", cSVFormat1.getNullString());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
