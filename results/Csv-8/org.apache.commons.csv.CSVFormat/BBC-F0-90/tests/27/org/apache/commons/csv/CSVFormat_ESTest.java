...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("0z)o]W(kN4");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("0z)o]W(kN4", cSVFormat2.getNullString());
  ...
  public void test009()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("iCUJ~");
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("iCUJ~", cSVFormat2.getNullString());
  }
  ...
  public void test018()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Rv&5#nhk9z(82P");
      assertEquals("Rv&5#nhk9z(82P", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isEscaping());
  ...
  public void test025()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("vJI[`");
  ...
  public void test043()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("N8W|o@D+D~dHf");
  ...
  public void test092()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      StringReader stringReader0 = new StringReader("G3/gwt%&jG>-S(I0pK");
      // Undeclared exception!
      try { 
  ...
  public void test100()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("0z)o]W(kN4");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("\u2028");
      String string0 = cSVFormat2.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<0z)o]W(kN4> RecordSeparator=<\u2028> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test108()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("Delimiter=<B> SkipHeaderRecord:false");
      cSVFormat1.hashCode();
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals('B', cSVFormat0.getDelimiter());
      assertEquals("Delimiter=<B> SkipHeaderRecord:false", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isCommentingEnabled());
  }
  ...
  public void test119()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      CSVFormat cSVFormat3 = cSVFormat0.EXCEL.withQuoteChar(character0);
  ...
  public void test134()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"Z(#Hy!3}v");
      try { 
        cSVFormat1.parse(stringReader0);
