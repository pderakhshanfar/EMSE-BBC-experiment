...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator(")zj;(ltE#R\"P$3?'g");
  ...
  public void test016()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("y?>Zj@m.WG)%m");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("y?>Zj@m.WG)%m", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test024()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("(aZ#KWCA9");
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertEquals("(aZ#KWCA9", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test027()  throws Throwable  {
      ...
      assertEquals(',', cSVFormat3.getDelimiter());
      assertEquals(" SurroundingSpaces:ignored", cSVFormat3.getRecordSeparator());
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertEquals("y?>Zj@m.WG)%m", cSVFormat3.getNullString());
  ...
  public void test064()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("y?>Zj@m.WG)%m");
  ...
  public void test094()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("M(Z['EkIY");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test104()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(",wK1W#/");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<,wK1W#/> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test112()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("So$]p");
