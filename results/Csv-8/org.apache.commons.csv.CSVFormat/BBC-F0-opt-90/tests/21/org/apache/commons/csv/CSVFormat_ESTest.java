...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test007()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("xexL([3'MM");
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test008()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withRecordSeparator("_qy,JCy^ |BbG?++u");
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test034()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("xexL([3'MM");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("xexL([3'MM", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
  }
  ...
  public void test056()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("beTrk");
      String string0 = cSVFormat1.getNullString();
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("beTrk", string0);
  ...
  public void test093()  throws Throwable  {
      ...
      stringArray0[0] = "R>!vB-K?|";
      stringArray0[1] = "8qoMr({E;x8?5}<+4";
      stringArray0[2] = "";
      stringArray0[3] = "ZW@s:Xw|*Yy!H`";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      assertFalse(cSVFormat1.isCommentingEnabled());
  ...
  public void test097()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('d');
      StringReader stringReader0 = new StringReader(">g9{)y@&g");
      // Undeclared exception!
      try { 
  ...
  public void test098()  throws Throwable  {
      ...
      Character character0 = Character.valueOf(',');
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withCommentStart(character0);
      StringReader stringReader0 = new StringReader("`Y+gIfh)kwIn6~`2[k");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test099()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("R`_OA=:|iV[G[3lM");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test119()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("5CQY[:O(JXvxifg");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("5CQY[:O(JXvxifg", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
