...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("org.apache.commons.csv.CSVFormat");
      cSVFormat1.hashCode();
  ...
  public void test013()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("+\"O/i?");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("+\"O/i?", cSVFormat2.getNullString());
  ...
  public void test021()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("+\"O/i?");
      assertEquals('\t', cSVFormat3.getDelimiter());
      assertEquals("+\"O/i?", cSVFormat3.getNullString());
  ...
  public void test032()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("fya3r6D|^mzuIg/");
      Character character0 = Character.valueOf('9');
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
      assertEquals("fya3r6D|^mzuIg/", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test041()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("G5i`RV r?ly");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("G5i`RV r?ly", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test092()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("eLX7QFLblq`g");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
  ...
  public void test093()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      StringReader stringReader0 = new StringReader("gZ`dR~");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test099()  throws Throwable  {
      ...
      Character character0 = new Character('>');
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character0);
      StringReader stringReader0 = new StringReader("%#77IEB[.B'$L");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test101()  throws Throwable  {
      ...
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertEquals('U', cSVFormat0.getDelimiter());
      assertEquals("Delimiter=<U> NullString=<No header mapping was specified, the record values can't be accessed by name> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
  }
  ...
  public void test137()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[4];
      stringArray0[0] = "4K@)D0S1)[H(=z";
      stringArray0[1] = "q#";
      stringArray0[2] = "={uDeWm.4*@";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      assertFalse(cSVFormat1.isCommentingEnabled());
      
      StringReader stringReader0 = new StringReader("i0fbi1jFp!<ck:!T;U:");
