...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString(" 1z^7&,8+nu)");
      Object[] objectArray0 = new Object[2];
      String string0 = cSVFormat3.format(objectArray0);
      assertEquals("\" 1z^7&,8+nu)\"W\" 1z^7&,8+nu)\"", string0);
  ...
  public void test002()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(" 1z^7&,8+nu)");
      cSVFormat1.hashCode();
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test004()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("!_EEb#");
      ...
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("!_EEb#", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("v,$b03Sh");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("}Mo#");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("}Mo#", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("v,$b03Sh", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
  }
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("YCeG]zh");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test010()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("o918HodxP/=x^cJry");
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("o918HodxP/=x^cJry", cSVFormat2.getNullString());
  ...
  public void test023()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("B{r=I%8 QMkr");
      assertTrue(cSVFormat2.isCommentingEnabled());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isQuoting());
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("B{r=I%8 QMkr", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
  }
  ...
  public void test024()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("$X#91AYD5X3MJ");
      assertEquals("$X#91AYD5X3MJ", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test056()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("+;nm8l}2H");
  ...
  public void test077()  throws Throwable  {
      ...
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertTrue(boolean0);
      assertEquals("+;nm8l}2H", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test098()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("9;YGxqvt.}+WIgs'|");
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      assertEquals('\"', (char)cSVFormat1.getQuoteChar());
  ...
  public void test104()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("Delimiter=<\t> Escape=<\\> CommentStart=<N> RecordSeparator=<U> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test109()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withCommentStart('r');
      cSVFormat1.hashCode();
      assertFalse(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test116()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString("B{r=I%8 QMkr");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(boolean0);
      assertEquals("B{r=I%8 QMkr", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertTrue(cSVFormat1.isQuoting());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test136()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("o918HodxP/=x^cJry");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertEquals("o918HodxP/=x^cJry", cSVFormat1.getNullString());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
