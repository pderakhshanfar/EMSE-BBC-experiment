...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("~%X509{O9*1+ZX:");
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("~%X509{O9*1+ZX:", cSVFormat2.getNullString());
  }

  @Test(timeout = 4000)
  public void test007()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withCommentStart('9');
  ...
  public void test018()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("J;n_d%");
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isCommentingEnabled());
      ...
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("J;n_d%", cSVFormat2.getNullString());
  }
  ...
  public void test019()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator(".N{Iv#XGo^8|20");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(".N{Iv#XGo^8|20", cSVFormat2.getRecordSeparator());
      assertEquals("", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test020()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("#I\"hHmg NmkI:");
      ...
      assertEquals("#I\"hHmg NmkI:", cSVFormat2.getNullString());
  }
  ...
  public void test042()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("H_J9_ e~]o:J&");
  ...
  public void test065()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\"wMLcI),A/3+X?L.3e");
      try { 
        cSVFormat1.parse(stringReader0);
  ...
  public void test098()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("~%X509{O9*1+ZX:");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<~%X509{O9*1+ZX:> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test111()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.DEFAULT.withEscape(')');
  ...
  public void test134()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("#I\"hHmg NmkI:", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isCommentingEnabled());
  }
