...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("}lrHDA");
      ...
      assertEquals("}lrHDA", cSVFormat2.getNullString());
  }
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("Y.Fr:NZVqv");
  ...
  public void test007()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString("GEr/#");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("'qpGF6G[7*vZ8H2;%");
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("'qpGF6G[7*vZ8H2;%", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("GEr/#", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
  ...
  public void test009()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("7e4MF}6n,%");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('!');
      ...
      assertEquals("7e4MF}6n,%", cSVFormat3.getNullString());
  ...
  public void test012()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("$lf,`<wg#0OD");
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("$lf,`<wg#0OD", cSVFormat2.getNullString());
  }
  ...
  public void test020()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("W{q2:`Be6!QS");
      assertEquals(',', cSVFormat3.getDelimiter());
      assertEquals("\r\n", cSVFormat3.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat3.isQuoting());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("W{q2:`Be6!QS", cSVFormat3.getNullString());
      assertFalse(cSVFormat3.isEscaping());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("(,:bip7}]0'%");
      ...
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertEquals("(,:bip7}]0'%", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isQuoting());
  }
  ...
  public void test036()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("org.apache.commons.csv.CSVParser");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('o');
  ...
  public void test044()  throws Throwable  {
      ...
      stringArray0[1] = ")$R3_k_P';F<fA+]";
      stringArray0[2] = ";'7%G\"saxxYdzCEVO.X";
      stringArray0[3] = "7";
      stringArray0[4] = "0";
  ...
  public void test051()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withQuoteChar('S');
  ...
  public void test059()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withEscape('a');
      Character character0 = cSVFormat1.getEscape();
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\"', (char)cSVFormat1.getQuoteChar());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test096()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(',');
      StringReader stringReader0 = new StringReader("}2xR8[b.F@");
      // Undeclared exception!
      try { 
  ...
  public void test131()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("}lrHDA");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertEquals("}lrHDA", cSVFormat1.getNullString());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(boolean0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
