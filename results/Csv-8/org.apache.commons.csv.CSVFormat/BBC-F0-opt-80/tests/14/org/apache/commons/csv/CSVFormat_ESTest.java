...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("rq#XU:Beq,E/G");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(false);
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("rq#XU:Beq,E/G", cSVFormat2.getNullString());
  ...
  public void test004()  throws Throwable  {
      ...
      assertEquals('x', (char)cSVFormat5.getQuoteChar());
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("wqgP`XcK");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("wqgP`XcK");
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("ks;\"5Svq5r");
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("ks;\"5Svq5r", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
  }
  ...
  public void test031()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("__t#r89<Up=o");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar((Character) null);
      ...
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertEquals("__t#r89<Up=o", cSVFormat3.getNullString());
  ...
  public void test034()  throws Throwable  {
      ...
      assertEquals("__t#r89<Up=o", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test071()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("-d~Mp4hZ~YV");
      stringReader0.close();
      try { 
  ...
  public void test096()  throws Throwable  {
      ...
      Character character0 = new Character(':');
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character0);
      StringReader stringReader0 = new StringReader("~-76lZ");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test102()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withQuoteChar('J');
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> QuoteChar=<J> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test105()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("1I`Zbjs_tRJh!lg");
      cSVFormat1.hashCode();
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertEquals("1I`Zbjs_tRJh!lg", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
