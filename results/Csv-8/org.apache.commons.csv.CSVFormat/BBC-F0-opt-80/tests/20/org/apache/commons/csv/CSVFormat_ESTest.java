...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("v~GD'Mh$wPHN.T<$j");
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withRecordSeparator(") invalid parse sequence");
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isNullHandling());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test013()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("2;uh`qm6!qIV+W@SP");
      Character character0 = Character.valueOf('>');
      ...
      assertEquals("2;uh`qm6!qIV+W@SP", cSVFormat3.getNullString());
  }
  ...
  public void test021()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('.');
      CSVFormat cSVFormat3 = cSVFormat2.withSkipHeaderRecord(false);
      CSVFormat cSVFormat4 = cSVFormat3.withNullString("2;uh`qm6!qIV+W@SP");
      ...
      assertTrue(cSVFormat3.equals((Object)cSVFormat2));
      assertTrue(cSVFormat4.getIgnoreEmptyLines());
      assertEquals("2;uh`qm6!qIV+W@SP", cSVFormat4.getNullString());
      assertTrue(cSVFormat4.isQuoting());
  }
  ...
  public void test029()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(")@,XO&-ZpkRcqN3");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart('#');
  ...
  public void test045()  throws Throwable  {
      ...
      stringArray0[1] = "voOF6`@Mi!0\"_Y=MUO%";
  ...
  public void test069()  throws Throwable  {
      ...
      stringArray0[0] = "O7B#1V`m'%";
      stringArray0[1] = "@c/.J6= snS*{6VZ)";
      stringArray0[2] = "MoKP2#Q`[i}+o{1zu";
      stringArray0[3] = ".";
      stringArray0[4] = "H";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"vQG,:&QilzEx+");
      try { 
        cSVFormat2.parse(stringReader0);
  ...
  public void test094()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      StringReader stringReader0 = new StringReader(".!a7nJ*J|p!t^B6Eg8");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
  ...
  public void test097()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('j');
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withEscape(character0);
      StringReader stringReader0 = new StringReader("rader");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(',');
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
  ...
  public void test098()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('[');
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("E]drM");
      try { 
        cSVFormat3.validate();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test118()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('f');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("%IG(sLC_k");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertEquals('f', cSVFormat0.getDelimiter());
      assertFalse(boolean0);
  ...
  public void test129()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('f');
      boolean boolean0 = cSVFormat0.equals("%IG(sLC_k");
      assertEquals('f', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(boolean0);
