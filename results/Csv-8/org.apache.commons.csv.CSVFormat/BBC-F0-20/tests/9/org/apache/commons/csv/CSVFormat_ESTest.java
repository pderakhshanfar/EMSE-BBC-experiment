...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("E2~ SN9:u~'8sDx\"p!#");
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("Zvq");
      assertFalse(cSVFormat2.isNullHandling());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test018()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("-}`W{!}V`b$u");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('\'');
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("-}`W{!}V`b$u", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("xCF=0j");
      assertTrue(cSVFormat2.isEscaping());
      assertEquals("xCF=0j", cSVFormat2.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isQuoting());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test031()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("lR^ xA(;OS*[s7&/");
      CSVFormat cSVFormat2 = cSVFormat1.withHeader((String[]) null);
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertEquals("lR^ xA(;OS*[s7&/", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isCommentingEnabled());
  ...
  public void test037()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("m3c");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('&');
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("m3c", cSVFormat2.getNullString());
  ...
  public void test043()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("4Ln{LSON");
      Character character0 = Character.valueOf('&');
      ...
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("4Ln{LSON", cSVFormat2.getNullString());
  }
  ...
  public void test048()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Iu[<7NNiDA");
  ...
  public void test055()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("EV*\th3eZFPa/rN?&k");
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("EV*\th3eZFPa/rN?&k", string0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test103()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('A');
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("Delimiter=<A> SkipHeaderRecord:false");
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<Delimiter=<A> SkipHeaderRecord:false> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", string0);
      assertEquals('A', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
  }
  ...
  public void test119()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("m3c");
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("m3c");
  ...
  public void test120()  throws Throwable  {
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isQuoting());
      assertEquals("m3c", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isEscaping());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test124()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('!');
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("FXxjF326V");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(cSVFormat2.isEscaping());
  ...
  public void test130()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      boolean boolean0 = cSVFormat0.equals("6+lXj,T!UFHZLMLY2");
      assertFalse(boolean0);
  }
  ...
  public void test141()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("cO~~euS$%3");
