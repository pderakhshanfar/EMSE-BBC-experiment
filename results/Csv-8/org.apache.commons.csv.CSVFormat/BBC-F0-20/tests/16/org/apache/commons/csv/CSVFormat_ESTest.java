...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test016()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("I-|k[*s/UfKmB\"");
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("I-|k[*s/UfKmB\"", cSVFormat2.getNullString());
  ...
  public void test020()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('|');
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("I-|k[*s/UfKmB\"");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
      assertEquals("I-|k[*s/UfKmB\"", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test052()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("|f1'(<@");
  ...
  public void test075()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("I-|k[*s/UfKmB\"", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(boolean0);
  }
  ...
  public void test100()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("h>a7BP{O7lGLL");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test114()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("NO>UaxB");
  ...
  public void test118()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withRecordSeparator(" SurroundingSpaces:ignored");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isNullHandling());
