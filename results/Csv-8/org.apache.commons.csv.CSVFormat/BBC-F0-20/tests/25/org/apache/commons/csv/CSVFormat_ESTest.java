...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test017()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("{fG]+}\" kCiC?@vLO%");
      Character character0 = Character.valueOf('^');
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      ...
      assertEquals("\n", cSVFormat3.getRecordSeparator());
      assertEquals("{fG]+}\" kCiC?@vLO%", cSVFormat3.getNullString());
  }
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("MMhZ");
      String[] stringArray0 = new String[6];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("MMhZ", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test034()  throws Throwable  {
      ...
      assertFalse(cSVFormat2.isQuoting());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("{fG]+}\" kCiC?@vLO%", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test038()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(")pL,@yU'");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(")pL,@yU'", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test089()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('}');
      StringReader stringReader0 = new StringReader("fLc{gk.a");
      // Undeclared exception!
      try { 
