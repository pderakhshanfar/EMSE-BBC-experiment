...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test010()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Xi-xMLnQdZh@@'2ctT");
      ...
      assertEquals("Xi-xMLnQdZh@@'2ctT", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test018()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("m}p%A4@oVgs4X");
  ...
  public void test021()  throws Throwable  {
      ...
      Character character0 = new Character(':');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("!aB=]K#_Kh Df1xZH");
      assertTrue(cSVFormat2.isEscaping());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("!aB=]K#_Kh Df1xZH", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isQuoting());
  }
  ...
  public void test031()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString(":_0X)5Z-%");
      Character character0 = Character.valueOf('z');
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      assertEquals(":_0X)5Z-%", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test035()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("!aB=]K#_Kh Df5O21xZH");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('N');
      assertEquals('N', (char)cSVFormat2.getEscape());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
      assertEquals("!aB=]K#_Kh Df5O21xZH", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test053()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("anmRh7g? ,=N%Nw0Q");
      String string0 = cSVFormat1.getNullString();
      assertEquals("anmRh7g? ,=N%Nw0Q", string0);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
  ...
  public void test093()  throws Throwable  {
      ...
      Character character0 = new Character('8');
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      StringReader stringReader0 = new StringReader(":w/T6{ArV)-}?;&S>");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test102()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("anmRh7g? ,=N%Nw0Q");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<anmRh7g? ,=N%Nw0Q> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test115()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Oe?.Pi'M?NyRvf_#");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(true);
      boolean boolean0 = cSVFormat2.equals(cSVFormat1);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoting());
      ...
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(boolean0);
      assertEquals("Oe?.Pi'M?NyRvf_#", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
  }
  ...
  public void test116()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("Oe?.Pi'M?NyRvf_#", cSVFormat1.getNullString());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.isEscaping());
  }
