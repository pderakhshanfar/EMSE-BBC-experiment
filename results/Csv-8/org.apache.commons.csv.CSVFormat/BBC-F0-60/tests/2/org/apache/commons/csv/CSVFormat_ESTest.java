...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("2/-+Sf!i/A@8y>QH>");
  ...
  public void test018()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("lgm8tre#)TwD2t>");
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isQuoting());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("lgm8tre#)TwD2t>", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isCommentingEnabled());
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
  ...
  public void test086()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("z31PsS");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test112()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.TDF.withEscape('S');
