...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test012()  throws Throwable  {
      ...
      CSVFormat cSVFormat4 = cSVFormat3.withQuoteChar('3');
      Quote quote0 = Quote.NON_NUMERIC;
      CSVFormat cSVFormat5 = cSVFormat4.withQuotePolicy(quote0);
      assertEquals('3', (char)cSVFormat5.getCommentStart());
  ...
  public void test014()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("\r\n");
      cSVFormat1.withQuoteChar((Character) null);
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.isQuoting());
  ...
  public void test019()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("PgDpMymMp");
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("PgDpMymMp", cSVFormat2.getNullString());
  ...
  public void test030()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(":%Z{uc*O#n");
  ...
  public void test042()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("!YJ@$Dopq7");
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("!YJ@$Dopq7", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isCommentingEnabled());
  }
  ...
  public void test055()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString(">6;\"I");
  ...
  public void test070()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      StringReader stringReader0 = new StringReader("p3.&*?};GIFK4*-)/");
      stringReader0.close();
      try { 
  ...
  public void test076()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("PgDpMymMp");
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("PgDpMymMp", cSVFormat1.getNullString());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
  }
  ...
  public void test101()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('@');
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      StringReader stringReader0 = new StringReader("I4zI<j+H");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test103()  throws Throwable  {
      ...
      assertEquals("Delimiter=<N> SkipHeaderRecord:false Header:[null, null, null, null]", string0);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
  ...
  public void test122()  throws Throwable  {
      ...
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals(">6;\"I", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(boolean0);
  }
  ...
  public void test123()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(boolean0);
      assertEquals(">6;\"I", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
  ...
  public void test124()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withRecordSeparator('S');
      CSVFormat cSVFormat2 = cSVFormat1.TDF.withNullString(">6;\"I");
      boolean boolean0 = cSVFormat2.equals(cSVFormat1);
      assertEquals('\t', cSVFormat2.getDelimiter());
      assertEquals(">6;\"I", cSVFormat2.getNullString());
      assertFalse(boolean0);
  ...
  public void test134()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      boolean boolean0 = cSVFormat0.equals("d<;Y");
      assertFalse(boolean0);
  }
