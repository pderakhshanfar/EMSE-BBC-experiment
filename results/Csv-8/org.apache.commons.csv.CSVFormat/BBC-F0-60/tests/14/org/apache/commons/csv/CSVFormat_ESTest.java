...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Dt81Aa)c-|Me>BHF");
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("@WN|kkxGVi[");
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("@WN|kkxGVi[", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test009()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withRecordSeparator("mz(d3yk){r2*");
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertTrue(cSVFormat1.isEscaping());
  ...
  public void test010()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("?Ua");
      assertTrue(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test015()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("xyL<\"~e%sb;LZ|@");
  ...
  public void test079()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Qq_%7N7/!_a\"Fl.Z]");
      ...
      assertTrue(boolean0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("Qq_%7N7/!_a\"Fl.Z]", cSVFormat2.getNullString());
  ...
  public void test110()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Qq_%7N7/!_a\"Fl.Z]");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<Qq_%7N7/!_a\"Fl.Z]> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test121()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("(+?WMM|s\"x");
      CSVFormat cSVFormat2 = cSVFormat1.withHeader((String[]) null);
      boolean boolean0 = cSVFormat0.equals(cSVFormat2);
      assertTrue(cSVFormat2.isEscaping());
      assertEquals("(+?WMM|s\"x", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isQuoting());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals('\t', cSVFormat1.getDelimiter());
