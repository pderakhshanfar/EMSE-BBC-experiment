...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test007()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("J@&-9;9#Sj*G!z+I");
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("J@&-9;9#Sj*G!z+I", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test014()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("H 5M9T J;.D");
  ...
  public void test018()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("D-wJQ6u%hZ($W :");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("D-wJQ6u%hZ($W :", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test023()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Gh7JmF|Ra\".J9fbG(");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(false);
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("Gh7JmF|Ra\".J9fbG(", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
  }
  ...
  public void test042()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('Q');
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withRecordSeparator("H 5M9T J;.D");
  ...
  public void test063()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("g!b-s#(5`iHFNaB");
      stringReader0.close();
      try { 
  ...
  public void test088()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('f');
      StringReader stringReader0 = new StringReader("B0MDS");
  ...
  public void test093()  throws Throwable  {
      ...
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertEquals("Delimiter=<Y> SkipHeaderRecord:false Header:[null, null, null, null, null, null, null, null, null]", string0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
  }
  ...
  public void test096()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("vfPK+!yj=:6Mn9H3NR)");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<vfPK+!yj=:6Mn9H3NR)> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test098()  throws Throwable  {
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("Delimiter=<\t> QuoteChar=<\"> CommentStart=<f> RecordSeparator=<3> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", string0);
  }
  ...
  public void test102()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("g!b-s#(5`iHFNaB");
      cSVFormat1.hashCode();
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("g!b-s#(5`iHFNaB", cSVFormat1.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test109()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("g!b-s#(5`iHFNaB");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("g!b-s#(5`iHFNaB");
  ...
  public void test111()  throws Throwable  {
      ...
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.isEscaping());
      assertEquals("eH?", cSVFormat1.getNullString());
  }
  ...
  public void test135()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("1t[N^wGvw+WHtSg*)9");
