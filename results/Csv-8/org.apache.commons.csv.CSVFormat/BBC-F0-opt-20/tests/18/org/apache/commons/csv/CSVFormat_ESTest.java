...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("~q#/gQU8<BL,%5qmEr");
  ...
  public void test010()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("%Us<7ON;60i=nTQ5YDV");
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("%Us<7ON;60i=nTQ5YDV", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isEscaping());
  ...
  public void test020()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("MNQR2?\"");
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("{kBz|\"`Zb.ysFws");
      assertEquals("{kBz|\"`Zb.ysFws", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isEscaping());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
  ...
  public void test024()  throws Throwable  {
      ...
      assertEquals('i', (char)cSVFormat4.getCommentStart());
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("4n/!PZ8.");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(true);
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertTrue(cSVFormat2.isQuoting());
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("4n/!PZ8.", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test028()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('k');
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withRecordSeparator("NON_NUMERIC");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(true);
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test046()  throws Throwable  {
      ...
      stringArray0[0] = "YmAlI3Vb83X*~NjR";
      stringArray0[1] = "'";
      stringArray0[2] = "NullString=<";
      stringArray0[3] = "wGZ_\"=Vxb(d";
      stringArray0[4] = "No header mapping was specified, the record values can't be accessed by name";
      stringArray0[5] = "q";
      stringArray0[6] = "^T3*c~E";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      assertFalse(cSVFormat2.isCommentingEnabled());
      
      StringReader stringReader0 = new StringReader(":Yz:uosh9KUe");
  ...
  public void test104()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("kD");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<kD> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test116()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("\"@$O?HQ')^y5TL");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(boolean0);
      assertEquals(',', cSVFormat1.getDelimiter());
      ...
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\"@$O?HQ')^y5TL", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isQuoting());
  }
