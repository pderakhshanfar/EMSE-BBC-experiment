...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test007()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("W8$W3=z]");
      ...
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat3.getIgnoreEmptyLines());
      assertEquals("W8$W3=z]", cSVFormat3.getNullString());
  ...
  public void test012()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("c^C(S\bDYx9xH2k");
  ...
  public void test014()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("lXKS5DU");
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("lXKS5DU", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test021()  throws Throwable  {
      ...
      Quote quote0 = Quote.ALL;
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      assertEquals("W8$W3=z]", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isEscaping());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("6NAE,E9aI~@&DUh[");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(false);
      assertFalse(cSVFormat2.isQuoting());
      assertEquals("6NAE,E9aI~@&DUh[", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isEscaping());
  ...
  public void test032()  throws Throwable  {
      ...
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
      assertEquals('`', (char)cSVFormat2.getEscape());
      assertEquals("lXKS5DU", cSVFormat3.getNullString());
      assertEquals(',', cSVFormat3.getDelimiter());
  ...
  public void test034()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('y');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("57I;03");
  ...
  public void test067()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("BNYkZu|ax-");
      try { 
  ...
  public void test094()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      StringReader stringReader0 = new StringReader("qDk}A8zS?89.z7'Uq6n");
      // Undeclared exception!
      try { 
  ...
  public void test098()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("7Zl=ze=1Kwi[&X");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test102()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("lXKS5DU");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<lXKS5DU> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", string0);
  }
  ...
  public void test128()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator(")VO?v&$3u_E*ko0AS");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(boolean0);
      assertTrue(cSVFormat1.isEscaping());
