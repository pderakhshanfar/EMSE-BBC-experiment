...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("<XQJYu:nOV]'HK:DI");
      ...
      assertEquals("<XQJYu:nOV]'HK:DI", cSVFormat2.getNullString());
  }
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Gb?[Chg~,/&Htg");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("string");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("Gb?[Chg~,/&Htg", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test014()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("aQlMc80#O%O");
      ...
      assertEquals("aQlMc80#O%O", cSVFormat2.getNullString());
  }
  ...
  public void test018()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('l');
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Delimiter=<\t> Escape=<> CommentStart=<l> RecordSeparator=<8> SkipHeaderRecord:false");
      assertEquals('l', (char)cSVFormat2.getCommentStart());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("Delimiter=<\t> Escape=<> CommentStart=<l> RecordSeparator=<8> SkipHeaderRecord:false", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isQuoting());
      assertEquals('\\', (char)cSVFormat2.getEscape());
      assertTrue(cSVFormat2.isEscaping());
  ...
  public void test019()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("v)hoL:EAC_t;IhQ8");
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      ...
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isEscaping());
      assertEquals("v)hoL:EAC_t;IhQ8", cSVFormat2.getNullString());
  }
  ...
  public void test028()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("v)hoL:EAC_t;IhQ8");
      ...
      assertEquals("\n", cSVFormat4.getRecordSeparator());
      assertEquals("v)hoL:EAC_t;IhQ8", cSVFormat4.getNullString());
  ...
  public void test031()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("iK|w");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('<');
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("iK|w", cSVFormat2.getNullString());
      assertEquals('<', (char)cSVFormat2.getEscape());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.isCommentingEnabled());
  ...
  public void test036()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      Character character0 = new Character('q');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("^&90o`]}bl");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("^&90o`]}bl", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isCommentingEnabled());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test040()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("U%pgYGENof>4X");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart('W');
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("U%pgYGENof>4X", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test048()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("O=>MF/g!(OM@]qA");
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("O=>MF/g!(OM@]qA", string0);
  }
  ...
  public void test083()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("`1~frKsW2A-$y[<");
  ...
  public void test093()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("U%pgYGENof>4X");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<U%pgYGENof>4X> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test105()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("`i0sXf Ctkk8");
      String[] stringArray0 = new String[4];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("`i0sXf Ctkk8", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test106()  throws Throwable  {
      ...
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertEquals("v)hoL:EAC_t;IhQ8", cSVFormat1.getNullString());
  }
  ...
  public void test114()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withEscape(',');
      CSVFormat cSVFormat2 = cSVFormat0.MYSQL.withDelimiter(',');
      boolean boolean0 = cSVFormat2.equals(cSVFormat1);
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertEquals(',', cSVFormat2.getDelimiter());
