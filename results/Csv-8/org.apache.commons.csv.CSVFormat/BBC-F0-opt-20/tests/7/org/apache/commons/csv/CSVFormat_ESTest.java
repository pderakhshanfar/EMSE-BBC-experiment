...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("VRP'");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("VRP'");
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("A7P;\"d*");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('}');
      assertEquals("}", cSVFormat2.getRecordSeparator());
      assertEquals("A7P;\"d*", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
  ...
  public void test018()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('C');
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("A7P;\"d*");
      assertEquals('C', (char)cSVFormat3.getCommentStart());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.equals((Object)cSVFormat1));
      assertEquals('C', cSVFormat2.getDelimiter());
  ...
  public void test028()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('(');
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withCommentStart('B');
  ...
  public void test038()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("/(r[M<bD~BNC");
  ...
  public void test093()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('4');
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      StringReader stringReader0 = new StringReader("~rw641Pk");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test104()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("cG|nD0|3b-");
      cSVFormat1.hashCode();
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
  ...
  public void test110()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("w3^OI@Z7h6!");
      ...
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("w3^OI@Z7h6!", cSVFormat2.getNullString());
      assertTrue(boolean0);
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test111()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("9Z]`$6?");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("9Z]`$6?", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
  ...
  public void test112()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("w3^OI@Z7h6!", cSVFormat1.getNullString());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
  ...
  public void test134()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("b2z:mqryZ m9j*'O");
