...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("wh$n");
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("wh$n", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
  }
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withRecordSeparator("HDuM]mprT(Ev%jTo");
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isNullHandling());
      assertTrue(cSVFormat1.isEscaping());
  ...
  public void test013()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("zw{dJ#");
      Character character0 = Character.valueOf('g');
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("zw{dJ#", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test019()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withNullString(",4CP5/<)IY+=?YOD");
      assertFalse(cSVFormat3.isEscaping());
      assertTrue(cSVFormat3.isQuoting());
      ...
      assertEquals(",4CP5/<)IY+=?YOD", cSVFormat3.getNullString());
  }
  ...
  public void test020()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("@,zD?L925GtC");
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("@,zD?L925GtC", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isEscaping());
  }
  ...
  public void test026()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("0V|DozMisdf");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(true);
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("0V|DozMisdf", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
  ...
  public void test030()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString("W#2=\\]s:LwPtj");
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("W#2=\\]s:LwPtj", cSVFormat2.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test042()  throws Throwable  {
      ...
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
      assertEquals('!', (char)cSVFormat3.getCommentStart());
      assertEquals("zw{dJ#", cSVFormat3.getNullString());
      assertEquals(',', cSVFormat3.getDelimiter());
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertTrue(cSVFormat3.isQuoting());
  }
  ...
  public void test045()  throws Throwable  {
      ...
      stringArray0[0] = "X";
      stringArray0[1] = "t";
      stringArray0[2] = "c'wINt|j5";
      stringArray0[3] = "v6=";
      stringArray0[4] = "u|(XBZ gY@mDJ%";
      stringArray0[5] = ")`qiyi2zdyS'v,&hPJ";
      stringArray0[6] = "~<w";
  ...
  public void test074()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("UIUR6<d{FX");
      Character character0 = Character.valueOf('d');
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("UIUR6<d{FX", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test109()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("wh$n");
      cSVFormat1.hashCode();
      assertEquals("wh$n", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test113()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('');
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("YRj^urHKA");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(boolean0);
      assertEquals('', cSVFormat0.getDelimiter());
  ...
  public void test116()  throws Throwable  {
      ...
      Character character0 = new Character(',');
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character0);
      CSVFormat cSVFormat2 = cSVFormat1.DEFAULT.withQuoteChar(character0);
  ...
  public void test120()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("wh$n");
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("wh$n");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("wh$n", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isCommentingEnabled());
