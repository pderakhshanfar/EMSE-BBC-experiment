...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("J+:{wc");
      cSVFormat1.parse(stringReader0);
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("D5i4`cr~Nz2(q");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("D5i4`cr~Nz2(q", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("org.apache.commons.csv.CSVFormat@0000000001\tjava.lang.Character@0000000008");
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isNullHandling());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.equals((Object)cSVFormat1));
  ...
  public void test033()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(":)yiV?Q7;c");
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals(":)yiV?Q7;c", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test100()  throws Throwable  {
      ...
      String[] stringArray0 = new String[9];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader(":)yiV?Q7;c");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
  ...
  public void test105()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("]UnAvMgw4*%5");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test109()  throws Throwable  {
      ...
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<No quotes mode set but no escape character is set> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test114()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("s4P2LgVs");
      cSVFormat1.hashCode();
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("s4P2LgVs", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isQuoting());
  }
