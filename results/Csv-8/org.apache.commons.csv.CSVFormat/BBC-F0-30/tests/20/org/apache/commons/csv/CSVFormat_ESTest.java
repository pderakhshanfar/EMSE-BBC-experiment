...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString(" 'hHyp");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(false);
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertEquals(" 'hHyp", cSVFormat2.getNullString());
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withRecordSeparator("format");
      assertTrue(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.isNullHandling());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("Tn");
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("3H#ZTM-hgHE8CCYf");
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.isNullHandling());
  ...
  public void test011()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("VLj{}1IR<-*?D ");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("VLj{}1IR<-*?D ", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test019()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("<)RCbrZ=; Ww*&>");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('\"');
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("<)RCbrZ=; Ww*&>", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertTrue(cSVFormat2.isQuoting());
  }
  ...
  public void test028()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("^/1v0?Nec(l5m'y");
  ...
  public void test058()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("l>{K??HKZ=*");
      char char0 = cSVFormat2.getDelimiter();
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("l>{K??HKZ=*", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isEscaping());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test064()  throws Throwable  {
      ...
      Character character0 = Character.valueOf(',');
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("VLj{}1IR<-*?D ");
      StringReader stringReader0 = new StringReader("VLj{}1IR<-*?D ");
      // Undeclared exception!
      try { 
  ...
  public void test069()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("=AkeF,k.Ws<vF");
      boolean boolean0 = cSVFormat1.isNullHandling();
      assertEquals("=AkeF,k.Ws<vF", cSVFormat1.getNullString());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.isQuoting());
  ...
  public void test089()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // The header contains duplicate names: [org.apache.commons.csv.CSVFormat, org.apache.commons.csv.CSVFormat]
         //
         verifyException("org.apache.commons.csv.CSVFormat", e);
      }
  }
  ...
  public void test104()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Tn");
      cSVFormat2.hashCode();
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat2.getDelimiter());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test113()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat0.withNullString("EOF whilst processing escape sequence");
  ...
  public void test121()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(']');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("M[[J|64~ITV2>^/TR}a");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertEquals(']', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(boolean0);
