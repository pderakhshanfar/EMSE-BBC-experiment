...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("pmyc^ :scs3!8sTp");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("*~");
      assertEquals("pmyc^ :scs3!8sTp", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isEscaping());
  ...
  public void test014()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("([%T0sae9,");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("([%T0sae9,", cSVFormat2.getNullString());
  }
  ...
  public void test018()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("Y#9qjd%28YZ");
      ...
      assertEquals("Y#9qjd%28YZ", cSVFormat2.getNullString());
  }
  ...
  public void test032()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("-t.TS9fn");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape((Character) null);
      assertTrue(cSVFormat1.isEscaping());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("-t.TS9fn", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.isQuoting());
  ...
  public void test039()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(" SbYm_fr7");
      ...
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(" SbYm_fr7", cSVFormat2.getNullString());
      assertEquals(' ', cSVFormat2.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test046()  throws Throwable  {
      ...
      stringArray0[0] = ",HvTZ.SJ3";
      stringArray0[1] = "w!@>6f|GQC";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("Mw7s-~=a`KiVR6");
  ...
  public void test053()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withQuoteChar('g');
      Character character0 = cSVFormat1.getQuoteChar();
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test087()  throws Throwable  {
      ...
      Character character0 = cSVFormat0.getQuoteChar();
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      StringReader stringReader0 = new StringReader("Delimiter=<\t> Escape=<> NullString=<GQnaap<2l rly 8X> RecordSeparator=<\n> SkipHeaderRecord:false Header:[, GQnaap<2l rly 8X]");
      // Undeclared exception!
      try { 
  ...
  public void test101()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("([%T0sae9,", cSVFormat1.getNullString());
  }
  ...
  public void test108()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("a2j!xAjM`03e");
  ...
  public void test133()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("0bFkKK//m9d?wfWoH ");
      assertFalse(cSVFormat1.isNullHandling());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test135()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("Delimiter=<_> QuoteChar=<\"> RecordSeparator=<0bFkKK//m9d?wfWoH > EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false Header:[]");
