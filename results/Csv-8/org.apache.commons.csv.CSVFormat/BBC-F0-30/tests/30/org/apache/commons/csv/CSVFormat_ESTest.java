...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("+^+XEFoud");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("%:H%Pa3#B%+");
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("+^+XEFoud", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("%:H%Pa3#B%+", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("^S=Vui");
  ...
  public void test008()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(",|g*X{4H<H'=");
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals(",|g*X{4H<H'=", cSVFormat2.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test017()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("GT(T:L2;ycqY31(&L5q");
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("GT(T:L2;ycqY31(&L5q", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
  }
  ...
  public void test019()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("\"sAp#K'%QD7XXOW\"");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(false);
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("\"sAp#K'%QD7XXOW\"", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
  }
  ...
  public void test027()  throws Throwable  {
      ...
      assertEquals("+^+XEFoud", cSVFormat3.getNullString());
  ...
  public void test031()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      Character character0 = new Character('.');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("GT(T:L2;ycqY31(&L5q");
  ...
  public void test034()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("QhcFW");
  ...
  public void test041()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("pppSLB");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart((Character) null);
      assertTrue(cSVFormat2.isQuoting());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("pppSLB", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
  }
  ...
  public void test054()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString("DdSCd#N^.o>n#g#");
      ...
      assertTrue(cSVFormat1.isQuoting());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("DdSCd#N^.o>n#g#", string0);
  }
  ...
  public void test115()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("\"sAp#K'%QD7XXOW\"");
      CSVFormat cSVFormat2 = cSVFormat0.withNullString("\"sAp#K'%QD7XXOW\"");
  ...
  public void test117()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('v');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("b\"lH");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertFalse(boolean0);
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
  ...
  public void test135()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("Lo+|cj|\"/:,zYn0");
