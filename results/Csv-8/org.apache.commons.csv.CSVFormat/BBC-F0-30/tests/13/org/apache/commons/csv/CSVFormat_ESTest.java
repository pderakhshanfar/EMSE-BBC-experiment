...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("TXH#- a:`?dyVQn");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('W');
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("TXH#- a:`?dyVQn");
      assertFalse(cSVFormat3.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("TXH#- a:`?dyVQn", cSVFormat2.getNullString());
  ...
  public void test007()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("5==-Yo$:,Tb{ZL");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('{');
      assertEquals("5==-Yo$:,Tb{ZL", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test009()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("x%N}Ehuq_o+6~>O ");
      Quote quote0 = Quote.ALL;
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      assertEquals("x%N}Ehuq_o+6~>O ", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
  ...
  public void test020()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("H8G6%XknSc|o>yAN~");
      ...
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertTrue(cSVFormat2.isEscaping());
      assertEquals("H8G6%XknSc|o>yAN~", cSVFormat2.getNullString());
  }
  ...
  public void test038()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("t)|:m!R$RX");
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("t)|:m!R$RX", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isCommentingEnabled());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test084()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // The header contains duplicate names: [D:~N, D:~N]
         //
         verifyException("org.apache.commons.csv.CSVFormat", e);
      }
  }
  ...
  public void test089()  throws Throwable  {
      ...
      Character character0 = new Character('u');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      StringReader stringReader0 = new StringReader("_dx(vm(f%-y??BX");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test096()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("Delimiter=<2> Escape=<\\> NullString=<RecordSeparator=<> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test097()  throws Throwable  {
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(boolean0);
      assertEquals("5==-Yo$:,Tb{ZL", cSVFormat1.getNullString());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
  ...
  public void test110()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("k_R\"c+2;_]");
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("k_R\"c+2;_]");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(boolean0);
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("k_R\"c+2;_]", cSVFormat2.getNullString());
  ...
  public void test129()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(".K#{6}p1RD");
      CSVFormat cSVFormat3 = cSVFormat2.withSkipHeaderRecord(false);
      CSVFormat cSVFormat4 = cSVFormat3.withDelimiter('H');
      StringReader stringReader0 = new StringReader(".K#{6}p1RD");
