...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("+o@1`>6tdk");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("Ci-g^&47QWWKqjfeVM");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("w9H'O-k|==");
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isNullHandling());
  ...
  public void test011()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("y5u_Y@-j@qqb%{S_{:");
  ...
  public void test014()  throws Throwable  {
      ...
      CSVFormat cSVFormat4 = cSVFormat3.withQuoteChar('b');
      assertEquals('`', (char)cSVFormat4.getCommentStart());
  ...
  public void test017()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("org.apache.commons.csv.CSVFrmat");
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("org.apache.commons.csv.CSVFrmat", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Z#x ");
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("Z#x ", cSVFormat2.getNullString());
  }
  ...
  public void test097()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(',');
      StringReader stringReader0 = new StringReader("w9H'O-k|==");
      // Undeclared exception!
      try { 
  ...
  public void test099()  throws Throwable  {
      ...
      Character character0 = Character.valueOf(',');
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      StringReader stringReader0 = new StringReader("B]Fm_?!n3\"7>,Rxv");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test103()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("B=bUrtCr#S%#");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> QuoteChar=<\"> NullString=<B=bUrtCr#S%#> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", string0);
  }
  ...
  public void test108()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("B=bUrtCr#S%#", cSVFormat1.getNullString());
  }
  ...
  public void test113()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("B=bUrtCr#S%#");
      cSVFormat1.parse(stringReader0);
      assertFalse(cSVFormat1.isNullHandling());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test124()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('&');
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("#NYePWEs78r=A");
      boolean boolean0 = cSVFormat2.equals(cSVFormat1);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals('&', (char)cSVFormat2.getCommentStart());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
