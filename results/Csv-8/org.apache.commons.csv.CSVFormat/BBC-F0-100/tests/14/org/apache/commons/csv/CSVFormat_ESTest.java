...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("^ If)cy@YpLZ,X");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("\"D-5,wZs Br+$");
      CSVFormat cSVFormat3 = cSVFormat2.withSkipHeaderRecord(true);
      assertTrue(cSVFormat3.getSkipHeaderRecord());
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat3.getIgnoreEmptyLines());
      assertTrue(cSVFormat3.isQuoting());
      assertEquals("\"D-5,wZs Br+$", cSVFormat3.getRecordSeparator());
      assertFalse(cSVFormat3.isEscaping());
      assertEquals("^ If)cy@YpLZ,X", cSVFormat3.getNullString());
  ...
  public void test011()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("9.+=WiXQesL6nK|Pk@");
      ...
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("9.+=WiXQesL6nK|Pk@", cSVFormat2.getNullString());
  }
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(" ORU'#PL");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('6');
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals(" ORU'#PL", cSVFormat2.getNullString());
  ...
  public void test027()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(" ORU'#PL");
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test031()  throws Throwable  {
      ...
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("^ If)cy@YpLZ,X", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test046()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('`');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("D\"<V9=:E");
  ...
  public void test074()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"D-5,wZs Br+$");
      try { 
  ...
  public void test122()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("D\"<V9=:E", cSVFormat1.getNullString());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test130()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.TDF.withCommentStart('{');
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertEquals('{', (char)cSVFormat2.getCommentStart());
      assertEquals('L', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
  ...
  public void test137()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("#py>myut*G*Zfp^P{");
      cSVFormat1.parse(stringReader0);
      assertFalse(cSVFormat1.isNullHandling());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
