...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("T '^N97x9<`\n");
  ...
  public void test007()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("+9WcvIaY");
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.isNullHandling());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test014()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('k');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("} UWH4,yM`_I");
  ...
  public void test037()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("._j5");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('J');
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals("._j5", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isEscaping());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test040()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("The header contains duplicate names: ");
  ...
  public void test043()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      Character character0 = Character.valueOf(':');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("4NK_=%vu|^Yd;i");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("4NK_=%vu|^Yd;i", cSVFormat2.getNullString());
      assertEquals(':', (char)cSVFormat2.getCommentStart());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
  ...
  public void test054()  throws Throwable  {
      ...
      CSVFormat cSVFormat4 = cSVFormat3.withNullString("CR}yG<q@pMu-uNVur");
      CSVFormat cSVFormat5 = cSVFormat4.withIgnoreEmptyLines(false);
      Character character1 = cSVFormat5.getQuoteChar();
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("\r\n", cSVFormat5.getRecordSeparator());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertEquals('K', (char)character1);
      assertEquals("CR}yG<q@pMu-uNVur", cSVFormat5.getNullString());
  ...
  public void test074()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(">WU;i", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
  }
  ...
  public void test093()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      StringReader stringReader0 = new StringReader("3NmOSL");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      // Undeclared exception!
      try { 
  ...
  public void test116()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("T '^N97x9<`\n");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(boolean0);
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertEquals("T '^N97x9<`\n", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
