...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test007()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withRecordSeparator("/&=k3&k%PKwfO'ReM");
      assertFalse(cSVFormat1.isNullHandling());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test015()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("`<fP8dwm-dQ#4Dh3mR");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("`<fP8dwm-dQ#4Dh3mR", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test023()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("10Xn^)ZH");
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("10Xn^)ZH", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoting());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test027()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ag>?RU@|\"H|C~tdW]");
      ...
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isQuoting());
      assertEquals("ag>?RU@|\"H|C~tdW]", cSVFormat2.getNullString());
  }
  ...
  public void test056()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("form{at");
  ...
  public void test061()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("mA");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
      assertEquals("mA", cSVFormat2.getNullString());
  }
  ...
  public void test096()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("10Xn^)ZH");
  ...
  public void test097()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("t,f.MjFZTyV]P");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test102()  throws Throwable  {
      ...
      assertEquals('i', (char)cSVFormat1.getEscape());
      assertEquals('\"', (char)cSVFormat1.getQuoteChar());
      assertEquals("Delimiter=<,> Escape=<i> QuoteChar=<i> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", string0);
  }
  ...
  public void test107()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("h@Xe$H,M;");
      cSVFormat1.hashCode();
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("h@Xe$H,M;", cSVFormat1.getNullString());
  ...
  public void test126()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      boolean boolean0 = cSVFormat0.equals(" jc ");
      assertFalse(boolean0);
  }
  ...
  public void test140()  throws Throwable  {
      ...
      String[] stringArray0 = new String[8];
      stringArray0[0] = "\u2029";
      stringArray0[1] = "]?$i?>o)iX";
      stringArray0[2] = "y";
      stringArray0[3] = "6";
      stringArray0[4] = "dCwj$r |]P--,Rm";
      stringArray0[5] = "Y;RF5YxXd\u0000C_}";
      stringArray0[6] = "Delimiter=<";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertFalse(cSVFormat2.isCommentingEnabled());
      
      StringReader stringReader0 = new StringReader("7B$M$5Q|(9\"k!^");
