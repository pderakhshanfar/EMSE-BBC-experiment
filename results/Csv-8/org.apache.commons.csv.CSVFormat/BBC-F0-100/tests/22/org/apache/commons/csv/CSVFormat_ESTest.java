...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("oWW\"2}uU{");
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("<ztd}(/0>[q^Z4^");
  ...
  public void test010()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("`ALt%rWL@o:");
      Quote quote0 = Quote.ALL;
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("`ALt%rWL@o:", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Q1@`82KBP4Q$Y:");
      assertEquals("Q1@`82KBP4Q$Y:", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isQuoting());
  ...
  public void test023()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("oWW\"2}uU{");
      assertFalse(cSVFormat2.getSkipHeaderRecord());
  ...
  public void test038()  throws Throwable  {
      ...
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertEquals("`ALt%rWL@o:", cSVFormat3.getNullString());
  ...
  public void test055()  throws Throwable  {
      ...
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("`ALt%rWL@o:", string0);
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertTrue(cSVFormat1.isQuoting());
  }
  ...
  public void test075()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('T');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("oWW\"2}uU{");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(true);
  ...
  public void test096()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('\"');
      StringReader stringReader0 = new StringReader("The comment statcharacter and the quoteChar cannot be the same ('");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test097()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("u6Ts_Jh;{=hhc(LU");
      cSVFormat1.parse(stringReader0);
      assertTrue(cSVFormat1.isCommentingEnabled());
  ...
  public void test099()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("^@Fxps!t{#");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test103()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("Delimiter=<,> QuoteChar=<\"> CommentStart=<n> RecordSeparator=<x> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  }
  ...
  public void test110()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("#TcXZ'zv]");
  ...
  public void test127()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      boolean boolean0 = cSVFormat0.equals("y|dI");
      assertFalse(boolean0);
  }
  ...
  public void test137()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<> RecordSeparator=<G> EmptyLines:ignored SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
