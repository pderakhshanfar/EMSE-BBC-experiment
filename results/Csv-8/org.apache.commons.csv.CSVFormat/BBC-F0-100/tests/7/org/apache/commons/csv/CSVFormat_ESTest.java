...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("X30tJj");
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("4(' {0ewTmFAH\"");
      ...
      assertEquals("4(' {0ewTmFAH\"", cSVFormat2.getNullString());
  }
  ...
  public void test015()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("G)to\"u");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('`');
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("G)to\"u", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals('`', (char)cSVFormat2.getQuoteChar());
  ...
  public void test020()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("rF");
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("8q:crL@fe4y#x1>;");
      ...
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("8q:crL@fe4y#x1>;", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
  }
  ...
  public void test041()  throws Throwable  {
      ...
      assertEquals("G)to\"u", cSVFormat3.getNullString());
      assertFalse(cSVFormat3.getIgnoreEmptyLines());
  ...
  public void test052()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withQuoteChar('x');
      Character character0 = cSVFormat1.getQuoteChar();
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertNotNull(character0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test072()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withRecordSeparator("Dcg");
  ...
  public void test090()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("b|1rqT&oe[N2");
  ...
  public void test091()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('0');
      StringReader stringReader0 = new StringReader("#b^;K.>~K]");
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      // Undeclared exception!
      try { 
  ...
  public void test092()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('+');
      StringReader stringReader0 = new StringReader("[fd4 ] Wt");
      // Undeclared exception!
      try { 
  ...
  public void test093()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("O5BT#x[");
  ...
  public void test109()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('J');
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("X30tJj");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertEquals('J', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(boolean0);
  ...
  public void test126()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('U');
      boolean boolean0 = cSVFormat0.equals("eyvR({0x?g}1`0k3^");
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertFalse(boolean0);
      assertEquals('U', cSVFormat0.getDelimiter());
