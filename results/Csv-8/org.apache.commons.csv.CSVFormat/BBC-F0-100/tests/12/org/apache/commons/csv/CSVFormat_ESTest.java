...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("-SgtbK");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("-SgtbK");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("-SgtbK", cSVFormat1.getNullString());
  }
  ...
  public void test008()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("p/g E~R\"oipe");
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("p/g E~R\"oipe", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
  }
  ...
  public void test012()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("-SgtbK", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test021()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("4S");
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("4S", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test023()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("$7;^-5V");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(true);
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("$7;^-5V", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test030()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      Character character0 = cSVFormat0.getQuoteChar();
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("nWM2[E");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("nWM2[E", cSVFormat2.getNullString());
  }
  ...
  public void test062()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withCommentStart('8');
      Character character0 = cSVFormat1.getCommentStart();
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test088()  throws Throwable  {
      ...
      stringArray0[0] = "$>%Fn,3Z1[0wG:";
      stringArray0[1] = "$>%Fn,3Z1[0wG:";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // The header contains duplicate names: [$>%Fn,3Z1[0wG:, $>%Fn,3Z1[0wG:]
         //
         verifyException("org.apache.commons.csv.CSVFormat", e);
      }
  }
  ...
  public void test091()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('&');
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('&');
      StringReader stringReader0 = new StringReader("Delimiter=<,> QuoteChar=<\"> CommentStart=<&> RecordSeparator=<x=0o}JXB2k)$9XT> SkipHeaderRecord:false");
      // Undeclared exception!
      try { 
  ...
  public void test117()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('\\');
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(true);
      CSVFormat cSVFormat3 = cSVFormat1.withRecordSeparator("!]C|iY(2k");
  ...
  public void test124()  throws Throwable  {
      ...
      objectArray0[6] = (Object) "Index for header '%s' is %d but CSVRecord only has %d values!";
