...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("-LDxqKup(G=");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(false);
      assertEquals("-LDxqKup(G=", cSVFormat2.getNullString());
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("E!>T<y!hs ^TgZxazT0");
  ...
  public void test004()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("<9JxoF\"Rw^\"NoWs-h6F");
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test017()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("xfqI\"O2+OXQke::DC");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isEscaping());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isQuoting());
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('6', (char)cSVFormat2.getCommentStart());
      assertEquals("xfqI\"O2+OXQke::DC", cSVFormat2.getNullString());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test023()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(true);
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("E!>T<y!hs ^TgZxazT0");
  ...
  public void test026()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('?');
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("a:Ak@%X[KC*<!@Asj");
      String[] stringArray0 = new String[2];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertEquals('?', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("a:Ak@%X[KC*<!@Asj", cSVFormat2.getNullString());
  ...
  public void test051()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("i_FC<t?IgO;");
      String string0 = cSVFormat1.getNullString();
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("i_FC<t?IgO;", string0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
  }
  ...
  public void test101()  throws Throwable  {
      ...
      assertEquals("Delimiter=<b> NullString=<> EmptyLines:ignored SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test115()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("xfqI\"O2+OXQke::DC");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("xfqI\"O2+OXQke::DC", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.isQuoting());
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test124()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withCommentStart(character0);
      Quote quote0 = Quote.NON_NUMERIC;
      CSVFormat cSVFormat2 = cSVFormat0.MYSQL.withQuotePolicy(quote0);
  ...
  public void test126()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      boolean boolean0 = cSVFormat0.equals("E!>T<y!hs ^TgZxazT0");
      assertFalse(boolean0);
  }
