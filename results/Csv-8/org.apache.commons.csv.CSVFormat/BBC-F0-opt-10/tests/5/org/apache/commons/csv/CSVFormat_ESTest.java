...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("c6jVOnCLUUT:NuY");
  ...
  public void test001()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("PU}uJorw]0\u0006");
      cSVFormat1.parse(stringReader0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
  ...
  public void test013()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withCommentStart('M');
  ...
  public void test026()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("]lXU");
      String[] stringArray0 = new String[3];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals("]lXU", cSVFormat2.getNullString());
  ...
  public void test036()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("t\rdT\u0007#^f3?f");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('v');
      assertEquals("t\rdT\u0007#^f3?f", cSVFormat2.getNullString());
  ...
  public void test040()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("Ld|");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      assertEquals("Ld|", cSVFormat2.getNullString());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test046()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("]I6{r:)c]/vV`y._^");
  ...
  public void test053()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("t\rdT\u0007#^f3?f", string0);
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test089()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("mwl5'xs");
      String[] stringArray0 = new String[3];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      // Undeclared exception!
      try { 
  ...
  public void test096()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('(');
      StringReader stringReader0 = new StringReader("Qs1~.32O");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test121()  throws Throwable  {
      ...
      boolean boolean0 = cSVFormat0.equals("[ygz=T");
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(boolean0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
