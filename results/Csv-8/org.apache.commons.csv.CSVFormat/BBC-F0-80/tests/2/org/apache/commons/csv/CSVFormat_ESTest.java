...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(" b,M4.O<(Io7");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('&');
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      ...
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertEquals(" b,M4.O<(Io7", cSVFormat2.getNullString());
  }
  ...
  public void test010()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("*d-)RFb*%");
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("*d-)RFb*%", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test020()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("-?)[49y$/cENVvA");
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      ...
      assertTrue(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("-?)[49y$/cENVvA", cSVFormat2.getNullString());
  }
  ...
  public void test033()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("!Bju.-vST?OC=N+-");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(';');
      assertEquals("!Bju.-vST?OC=N+-", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals(';', (char)cSVFormat2.getEscape());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test037()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("MT6@*,:");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(true);
      CSVFormat cSVFormat3 = cSVFormat2.withDelimiter('M');
      assertEquals("MT6@*,:", cSVFormat3.getNullString());
      assertEquals("\r\n", cSVFormat3.getRecordSeparator());
  ...
  public void test043()  throws Throwable  {
      ...
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertTrue(cSVFormat3.isCommentingEnabled());
      assertEquals("*d-)RFb*%", cSVFormat3.getNullString());
  }
  ...
  public void test045()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      StringReader stringReader0 = new StringReader("_u-+^2;XX/:+");
  ...
  public void test053()  throws Throwable  {
      ...
      assertFalse(cSVFormat3.isCommentingEnabled());
      assertTrue(cSVFormat3.isEscaping());
      assertEquals("1}_CHP(2K)", string0);
      assertEquals("\n", cSVFormat3.getRecordSeparator());
      assertTrue(cSVFormat3.equals((Object)cSVFormat2));
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat3.isQuoting());
  ...
  public void test100()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("BQL!*n");
  ...
  public void test103()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("MT6@*,:");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<MT6@*,:> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test107()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("x-t");
      cSVFormat1.hashCode();
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("x-t", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test114()  throws Throwable  {
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("MT6@*,:", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test116()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("MT6@*,:");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("MT6@*,:");
