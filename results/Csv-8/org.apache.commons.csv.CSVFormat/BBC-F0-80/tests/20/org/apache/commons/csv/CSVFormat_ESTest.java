...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("])A%|yws5oni");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("q_4P");
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("q_4P", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("])A%|yws5oni", cSVFormat2.getNullString());
  ...
  public void test008()  throws Throwable  {
      ...
      Character character0 = new Character('H');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("c-$}<rYV~!<}Q/_,5s/");
      ...
      assertEquals(',', cSVFormat3.getDelimiter());
      assertEquals("c-$}<rYV~!<}Q/_,5s/", cSVFormat3.getNullString());
  }
  ...
  public void test019()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("])A%|yws5oni");
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test035()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("L_Q)`\"-rPtvV");
  ...
  public void test050()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("N@A");
  ...
  public void test089()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("_)pVsJiED");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
  ...
  public void test091()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("cBfAV");
      CSVFormat cSVFormat3 = cSVFormat2.withQuoteChar('k');
      StringReader stringReader0 = new StringReader("cBfAV");
      // Undeclared exception!
      try { 
  ...
  public void test107()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("#K|\"BA");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
  ...
  public void test111()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("])A%|yws5oni");
      CSVFormat cSVFormat2 = cSVFormat0.withNullString("])A%|yws5oni");
  ...
  public void test112()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("j->l=p");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(boolean0);
      assertEquals("j->l=p", cSVFormat1.getNullString());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.isQuoting());
  }
  ...
  public void test113()  throws Throwable  {
      ...
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("])A%|yws5oni", cSVFormat1.getNullString());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test134()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("u2>BO(z");
      String[] stringArray0 = new String[3];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isCommentingEnabled());
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("u2>BO(z", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isQuoting());
  }
