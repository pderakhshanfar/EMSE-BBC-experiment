...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("w!Q7qnN_Ak^b/y_z7;");
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test015()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('(');
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString("Mr");
  ...
  public void test019()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('~');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("w!Q7qnN_Ak^b/y_z7;");
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat1.getDelimiter());
      ...
      assertEquals('\\', (char)cSVFormat2.getEscape());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("w!Q7qnN_Ak^b/y_z7;", cSVFormat2.getNullString());
  }
  ...
  public void test042()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('/');
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withRecordSeparator("{f_jJLS$q\u0002F ");
  ...
  public void test049()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      StringReader stringReader0 = new StringReader("zg>d`");
      String[] stringArray0 = new String[2];
      stringArray0[0] = "Delimiter=<\t> Escape=<U> RecordSeparator=<\n> SkipHeaderRecord:false";
  ...
  public void test057()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("wa");
  ...
  public void test078()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("w!Q7qnN_Ak^b/y_z7;");
      ...
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("w!Q7qnN_Ak^b/y_z7;", cSVFormat1.getNullString());
  }
  ...
  public void test106()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("wa");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<wa> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
