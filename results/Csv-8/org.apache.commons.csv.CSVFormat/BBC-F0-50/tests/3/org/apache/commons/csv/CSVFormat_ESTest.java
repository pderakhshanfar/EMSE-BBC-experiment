...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("Luh");
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("`',X?mPK0R+Sn}lA<\"");
      Quote quote0 = Quote.NON_NUMERIC;
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("`',X?mPK0R+Sn}lA<\"", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test015()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("nCHUct|'Fpw0\"");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('5');
      assertEquals("nCHUct|'Fpw0\"", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test019()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('i');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("nCHUct|'Fpw0\"");
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('i', (char)cSVFormat2.getCommentStart());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test021()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("tKu");
  ...
  public void test028()  throws Throwable  {
      ...
      assertEquals("[ma/", cSVFormat3.getNullString());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
  }
  ...
  public void test036()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("EL/t");
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals("EL/t", cSVFormat2.getNullString());
      assertEquals('l', cSVFormat2.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test089()  throws Throwable  {
      ...
      stringArray0[0] = "`',X?mPK0R+Sn}lA<\"";
      stringArray0[1] = "`',X?mPK0R+Sn}lA<\"";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      try { 
        cSVFormat1.validate();
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // The header contains duplicate names: [`',X?mPK0R+Sn}lA<\", `',X?mPK0R+Sn}lA<\"]
         //
         verifyException("org.apache.commons.csv.CSVFormat", e);
      }
  }
  ...
  public void test098()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("nCHUct|'Fpw0\"");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> QuoteChar=<\"> NullString=<nCHUct|'Fpw0\"> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", string0);
  }

  @Test(timeout = 4000)
  public void test099()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("qQX.!/GS");
      boolean boolean0 = cSVFormat1.isNullHandling();
      assertTrue(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("qQX.!/GS", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.isQuoting());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
  ...
  public void test118()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat0.withCommentStart('l');
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertTrue(boolean0);
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.isQuoting());
  ...
  public void test136()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('o');
      StringReader stringReader0 = new StringReader("Iw>BI");
