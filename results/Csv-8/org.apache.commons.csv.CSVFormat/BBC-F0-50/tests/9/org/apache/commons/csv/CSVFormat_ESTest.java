...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withNullString("CDD4");
      ...
      assertEquals("CDD4", cSVFormat2.getNullString());
  ...
  public void test012()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("{X3vyFtH");
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("{X3vyFtH", cSVFormat2.getNullString());
  }
  ...
  public void test022()  throws Throwable  {
      ...
      CSVFormat cSVFormat4 = cSVFormat3.withQuoteChar('5');
  ...
  public void test024()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(">Dq1/huvC >-3,r");
  ...
  public void test045()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("lmvfdfV$kW}fhxmH");
      ...
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
      assertEquals("lmvfdfV$kW}fhxmH", cSVFormat4.getNullString());
      assertFalse(cSVFormat3.getIgnoreEmptyLines());
      assertTrue(cSVFormat4.isQuoting());
  }
  ...
  public void test072()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("]p@2v_i;qb}FAF");
      stringReader0.close();
      try { 
        cSVFormat1.parse(stringReader0);
  ...
  public void test102()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('/');
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character0);
      StringReader stringReader0 = new StringReader("Delimiter=</> NullString=<> SkipHeaderRecord:false");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test106()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("!SiRy'g*z9N~5W;>^13");
      boolean boolean0 = cSVFormat1.isNullHandling();
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("!SiRy'g*z9N~5W;>^13", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test107()  throws Throwable  {
      ...
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=</> Escape=<k> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertEquals('/', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
  ...
  public void test121()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.isEscaping());
      assertFalse(boolean0);
      assertEquals(";l,M6XS?y91W27Eg6Og", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.isQuoting());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test122()  throws Throwable  {
      ...
      Character character0 = Character.valueOf(']');
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(";l,M6XS?y91W27Eg6Og");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test126()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withQuoteChar('w');
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertFalse(boolean0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.isQuoting());
