...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("s@RnO[$");
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("s@RnO[$", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
  }
  ...
  public void test010()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withRecordSeparator('X');
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isNullHandling());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
  ...
  public void test034()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("+xI\"3mv;xfPh]]&h");
  ...
  public void test048()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("$3/Z%fw:D$:vt199^Z");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart('2');
      assertFalse(cSVFormat2.isQuoting());
      assertEquals('2', (char)cSVFormat2.getCommentStart());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("$3/Z%fw:D$:vt199^Z", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
  ...
  public void test050()  throws Throwable  {
      ...
      stringArray0[0] = "JOU`J8(I";
      stringArray0[1] = "The header contains duplicate names: ";
      stringArray0[2] = "OCBzk5MeG6BSjR4\"p";
      stringArray0[3] = "org.apache.commons.csv.Constants";
      stringArray0[4] = "0\"t_KTo%/IMB?";
      stringArray0[5] = "TS'{kE8 T95~]wE&";
      stringArray0[6] = "#6 ^~Y`PH` Go@p";
  ...
  public void test057()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("h`iRfjb9XD8");
      String string0 = cSVFormat1.getNullString();
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("h`iRfjb9XD8", string0);
      assertFalse(cSVFormat1.isEscaping());
  ...
  public void test094()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("Delimiter=<\t> Escape=<> QuoteChar=<#> RecordSeparator=<\n> SkipHeaderRecord:false Header:[null, null, null, null]");
      // Undeclared exception!
      try { 
  ...
  public void test104()  throws Throwable  {
      ...
      assertEquals("Delimiter=<e> NullString=<\r\n> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test105()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('e');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("8sd4XBftX:C6.6r';Fg");
  ...
  public void test108()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("|{OuJr,'u+)`hgm9", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  }
