...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("T!T6)wd8v^");
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("W8C=Ig:<");
  ...
  public void test043()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.RFC4180.withQuoteChar('e');
      Character character0 = cSVFormat1.getQuoteChar();
      assertFalse(cSVFormat1.isNullHandling());
  ...
  public void test044()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("b^}>3]|dLsxJ?LAf");
      String string0 = cSVFormat1.getNullString();
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("b^}>3]|dLsxJ?LAf", string0);
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.isQuoting());
  ...
  public void test062()  throws Throwable  {
      ...
      stringArray0[0] = "C7<;GiL alV_03";
      stringArray0[1] = "_;l9#!";
      stringArray0[2] = "file";
      stringArray0[3] = "The escape character and the delimiter cannot be the same ('";
      stringArray0[4] = "`Re8`D6Au";
      stringArray0[5] = "\r\n";
      stringArray0[6] = "EOF whilst prvcessing escap3 sequelce";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test082()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("V3lizMG9;");
  ...
  public void test085()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("4YiszB@");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test088()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("R8f'7`~Y86{l_");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test097()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("I,_*^{DAxk+");
      cSVFormat1.hashCode();
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("I,_*^{DAxk+", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test107()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat0.RFC4180.withRecordSeparator('\"');
  ...
  public void test120()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      boolean boolean0 = cSVFormat0.equals("8|f{TblB,.8Y_Sief");
      assertFalse(boolean0);
  }
