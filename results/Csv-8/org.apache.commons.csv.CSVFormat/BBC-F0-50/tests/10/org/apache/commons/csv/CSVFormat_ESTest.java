...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("V}3],NPl?IKO5KU4|ES");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("V}3],NPl?IKO5KU4|ES", cSVFormat2.getNullString());
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("qLZ%^");
  ...
  public void test036()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("?4.W+PS]mOwjJwgat+");
  ...
  public void test039()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("S@y*[/3");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('1');
      assertEquals('1', cSVFormat2.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("S@y*[/3", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
  ...
  public void test072()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("eb/?$3+U");
      try { 
  ...
  public void test102()  throws Throwable  {
      ...
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<#n3> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test108()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("The quoteChar chaZacter and the delimiter cannot be the same ('");
      cSVFormat1.hashCode();
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("The quoteChar chaZacter and the delimiter cannot be the same ('", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test116()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertEquals("S@y*[/3", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
  }
  ...
  public void test118()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("7c+/q;_24:>f1~d:3");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(false);
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertEquals("7c+/q;_24:>f1~d:3", cSVFormat2.getNullString());
      assertTrue(boolean0);
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test123()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withQuoteChar('_');
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isEscaping());
  ...
  public void test136()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      StringReader stringReader0 = new StringReader("V}3],NPl?IKO5KU4|ES");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
