...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("4V5-?Tql");
      assertTrue(cSVFormat3.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertEquals("4V5-?Tql", cSVFormat2.getNullString());
  ...
  public void test027()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("OOS[!wQ{wbi}`w");
      ...
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals("OOS[!wQ{wbi}`w", cSVFormat2.getNullString());
  }
  ...
  public void test030()  throws Throwable  {
      ...
      assertTrue(cSVFormat3.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("4V5-?Tql", cSVFormat3.getNullString());
      assertEquals("\r\n", cSVFormat3.getRecordSeparator());
      assertFalse(cSVFormat3.isCommentingEnabled());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertFalse(cSVFormat3.equals((Object)cSVFormat2));
  ...
  public void test044()  throws Throwable  {
      ...
      stringArray0[0] = "5GA2k<J{uB";
      stringArray0[1] = "F-$5E*4GW10";
      stringArray0[2] = ") invalid parse sequence";
      stringArray0[3] = "p/`>]3d{S\"1t<J%U";
      stringArray0[4] = "XP|-1?/xb";
      stringArray0[5] = "{cg5H?BuU,o[. P(X";
      stringArray0[6] = "No quotes mode set but no escape character is set";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      assertFalse(cSVFormat2.isCommentingEnabled());
      
      StringReader stringReader0 = new StringReader("mmWCgm1e");
  ...
  public void test091()  throws Throwable  {
      ...
      stringArray0[1] = ")&By[]W";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader(")&By[]W");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // The header contains duplicate names: [)&By[]W, )&By[]W]
         //
         verifyException("org.apache.commons.csv.CSVFormat", e);
      }
  }
  ...
  public void test094()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('\"');
      StringReader stringReader0 = new StringReader("[lkxrQP ii=~HS");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test101()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("OOS[!wQ{wbi}`w");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> QuoteChar=<\"> NullString=<OOS[!wQ{wbi}`w> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", string0);
  }
  ...
  public void test104()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("OOS[!wQ{wbi}`w", cSVFormat1.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
