...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("h__.ymX:vV'r");
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test009()  throws Throwable  {
      ...
      assertEquals("_N", cSVFormat3.getNullString());
  ...
  public void test013()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("'L)xhaNk*/");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      Character character0 = new Character('d');
      CSVFormat cSVFormat3 = cSVFormat2.withQuoteChar(character0);
      assertEquals("'L)xhaNk*/", cSVFormat3.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat3.getDelimiter());
      assertTrue(cSVFormat3.isQuoting());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test016()  throws Throwable  {
      ...
      assertEquals('<', (char)cSVFormat2.getQuoteChar());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("'L)xhaNk*/", cSVFormat2.getNullString());
  }
  ...
  public void test019()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("vce_DLQ'A8q{");
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals("vce_DLQ'A8q{", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isEscaping());
  }
  ...
  public void test073()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("sK+_[EQokw1=H:]");
      ...
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("sK+_[EQokw1=H:]", cSVFormat1.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test096()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('*');
      StringReader stringReader0 = new StringReader("Delimiter=<,> QuoteChar=<\"> CommentStart=<*> RecordSeparator=<\r\n> SkipHeaderRecord:false");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test097()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("Delimiter=<,> QuoteChar=<\"> RecordSeparator=<> SkipHeaderRecord:false Header:[]", string0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  }
  ...
  public void test098()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('7');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("^{muEPpcUu");
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals("Delimiter=<7> NullString=<^{muEPpcUu> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertEquals('7', cSVFormat0.getDelimiter());
  }
  ...
  public void test109()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('-');
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("#E,n ]FJ/@yeR2kd{n");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertEquals('-', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
  ...
  public void test114()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('-');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("vce_DLQ'A8q{");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertEquals('-', cSVFormat0.getDelimiter());
      assertFalse(boolean0);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
  ...
  public void test134()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("d9?k'F{!k'q@");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.isCommentingEnabled());
