...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("lbLX;/[myUp>'`R]b|");
      cSVFormat1.hashCode();
  ...
  public void test003()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("\"j)bs");
      ...
      assertEquals("\"j)bs", cSVFormat2.getNullString());
  }
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("lbLX;/[myUp>'`R]b|");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("lbLX;/[myUp>'`R]b|");
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("lbLX;/[myUp>'`R]b|", cSVFormat1.getNullString());
  }
  ...
  public void test007()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("QB.]C!QH");
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat2.equals((Object)cSVFormat1));
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("f!SR+xo (d_,}ou");
  ...
  public void test047()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('b');
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withCommentStart('b');
      assertEquals('b', cSVFormat0.getDelimiter());
  ...
  public void test048()  throws Throwable  {
      ...
      stringArray0[0] = "pR+";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("Xxa#w S8");
  ...
  public void test093()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('*');
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('*');
      StringReader stringReader0 = new StringReader("W:>zCxGS");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test095()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      StringReader stringReader0 = new StringReader("@2HarKm7X b#U");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test097()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Rnc[{");
      // Undeclared exception!
      try { 
  ...
  public void test100()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Oc7qAhZ");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> QuoteChar=<\"> NullString=<Oc7qAhZ> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", string0);
  }
  ...
  public void test101()  throws Throwable  {
      ...
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertEquals("bVyJ7B#&V}*", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertTrue(boolean0);
