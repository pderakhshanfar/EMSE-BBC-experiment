...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withDelimiter('_');
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("xd#m<X9X$B1q");
  ...
  public void test007()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Z*^5");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('`');
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("Z*^5", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test018()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("b@1<i@<~j=[mg$WS");
      assertTrue(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.isCommentingEnabled());
  ...
  public void test020()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("H;)il5@ rdX>.rH4D;p");
      assertEquals("H;)il5@ rdX>.rH4D;p", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Pj}da<~W/71:oTAiN");
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("Pj}da<~W/71:oTAiN", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test031()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("&orxjnhbd?1");
  ...
  public void test033()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("5qd} 6};l^&&B9f(");
      ...
      assertEquals("5qd} 6};l^&&B9f(", cSVFormat3.getRecordSeparator());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
  }
  ...
  public void test036()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('G');
      CSVFormat cSVFormat3 = cSVFormat2.withQuoteChar((Character) null);
      CSVFormat cSVFormat4 = cSVFormat3.withQuoteChar('G');
      assertEquals('G', cSVFormat4.getDelimiter());
      assertFalse(cSVFormat1.equals((Object)cSVFormat0));
      assertEquals('G', (char)cSVFormat4.getQuoteChar());
  ...
  public void test037()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("c|!>J*3fmZ-Fq'zy&=f");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isCommentingEnabled());
      assertEquals("c|!>J*3fmZ-Fq'zy&=f", cSVFormat2.getNullString());
  }
  ...
  public void test041()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("`20Air>{%J");
      Quote quote0 = Quote.NON_NUMERIC;
      CSVFormat cSVFormat3 = cSVFormat2.withQuotePolicy(quote0);
      CSVFormat cSVFormat4 = cSVFormat3.withCommentStart('X');
      assertFalse(cSVFormat4.isNullHandling());
      ...
      assertEquals('X', (char)cSVFormat4.getEscape());
  }
  ...
  public void test051()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("c|!>J*3fmZ-Fq'zy&=f", string0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test093()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("sKVh!9]\"pk<");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test110()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("oqKt94mhe_G`\"H");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(false);
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("oqKt94mhe_G`\"H", cSVFormat2.getNullString());
  ...
  public void test112()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("oqKt94mhe_G`\"H");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertEquals("oqKt94mhe_G`\"H", cSVFormat1.getNullString());
      assertFalse(boolean0);
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
