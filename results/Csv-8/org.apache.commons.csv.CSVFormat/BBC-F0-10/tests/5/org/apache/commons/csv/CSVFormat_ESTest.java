...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("?KaBcC{n>");
      cSVFormat1.hashCode();
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("jdCG");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(false);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("jdCG", cSVFormat2.getNullString());
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("[wK,BjATn>");
      Character character0 = Character.valueOf(';');
      ...
      assertEquals("[wK,BjATn>", cSVFormat3.getNullString());
  ...
  public void test012()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(";*4Yb?{");
      Quote quote0 = Quote.ALL;
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(";*4Yb?{", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isQuoting());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test019()  throws Throwable  {
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals("?KaBcC{n>", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test030()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("6hMh)EtVw");
      String[] stringArray0 = new String[4];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("6hMh)EtVw", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isEscaping());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
  ...
  public void test039()  throws Throwable  {
      ...
      assertEquals("?KaBcC{n>", cSVFormat3.getNullString());
      assertFalse(cSVFormat3.isCommentingEnabled());
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat3.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.equals((Object)cSVFormat1));
  ...
  public void test042()  throws Throwable  {
      ...
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat3.getRecordSeparator());
      assertEquals("jdCG", cSVFormat3.getNullString());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test046()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader(":</9 :F{<R7Xdr1DJ ");
  ...
  public void test093()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader(">Vac4hYqF`8C");
      // Undeclared exception!
      try { 
  ...
  public void test101()  throws Throwable  {
      ...
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertEquals("Delimiter=<2> NullString=<> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals('2', cSVFormat0.getDelimiter());
  }
  ...
  public void test109()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('+');
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("pu4=/1HEN{");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat1.isNullHandling());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
  ...
  public void test113()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("6hMh)EtVw");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("fvDAt!gS/yt/a");
  ...
  public void test114()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("6hMh)EtVw", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isQuoting());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test132()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('j');
      StringReader stringReader0 = new StringReader("Delimiter=<j> SkipHeaderRecord:false");
