...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("xz5");
      ...
      assertEquals("xz5", cSVFormat2.getNullString());
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("OYp$B^9u");
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test015()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("'O?%nx");
      Character character0 = Character.valueOf(' ');
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("'O?%nx", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isCommentingEnabled());
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('3');
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("q#0e5MAS<tzW7-|");
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertEquals('3', cSVFormat2.getDelimiter());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("xz5");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("r&adeCjLr");
      CSVFormat cSVFormat3 = cSVFormat2.withIgnoreSurroundingSpaces(false);
      assertEquals("xz5", cSVFormat3.getNullString());
      assertFalse(cSVFormat3.isQuoting());
      assertFalse(cSVFormat3.isCommentingEnabled());
      assertTrue(cSVFormat3.isEscaping());
      assertEquals("r&adeCjLr", cSVFormat3.getRecordSeparator());
  ...
  public void test033()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("|R-v(ZJi9MM]");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('^');
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("|R-v(ZJi9MM]", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
  ...
  public void test036()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("$/bHi<88 =Ux");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('.');
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("$/bHi<88 =Ux", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test052()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Uo@u]:c");
  ...
  public void test072()  throws Throwable  {
      ...
      assertEquals("$/bHi<88 =Ux", cSVFormat1.getNullString());
      assertTrue(boolean0);
      assertFalse(cSVFormat1.isEscaping());
  }
  ...
  public void test091()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader(",sGS+|b]5");
      cSVFormat1.parse(stringReader0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test096()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("3'cep#{:Bj]]i~!SJ**");
      cSVFormat1.parse(stringReader0);
      assertTrue(cSVFormat1.isCommentingEnabled());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test103()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("xz5");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<xz5> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test116()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("xz5");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertEquals("xz5", cSVFormat1.getNullString());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(boolean0);
