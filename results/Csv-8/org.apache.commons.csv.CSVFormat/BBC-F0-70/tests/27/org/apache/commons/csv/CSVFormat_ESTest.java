...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test008()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withIgnoreSurroundingSpaces(true);
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("w2W0\"|Lz%|%");
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.isNullHandling());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test015()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("@4HM+|Te]");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("@4HM+|Te]", cSVFormat3.getNullString());
  }
  ...
  public void test025()  throws Throwable  {
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("@4HM+|Te]", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
  ...
  public void test028()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("=z\"vRqR[l.-BK|R=");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("=z\"vRqR[l.-BK|R=");
      Character character0 = Character.valueOf('t');
      CSVFormat cSVFormat3 = cSVFormat2.withEscape(character0);
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertEquals('t', (char)cSVFormat3.getEscape());
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
      assertEquals("=z\"vRqR[l.-BK|R=", cSVFormat1.getNullString());
  ...
  public void test039()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("EOF whilst processing escape seuence");
      CSVFormat cSVFormat3 = cSVFormat2.withIgnoreSurroundingSpaces(true);
      CSVFormat cSVFormat4 = cSVFormat3.withCommentStart(' ');
      assertFalse(cSVFormat3.equals((Object)cSVFormat2));
      assertFalse(cSVFormat3.getIgnoreEmptyLines());
      assertTrue(cSVFormat4.isQuoting());
      assertEquals("EOF whilst processing escape seuence", cSVFormat4.getNullString());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test047()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("S-DEi<\"*5JMq");
      ...
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("S-DEi<\"*5JMq", string0);
  ...
  public void test064()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"+armm1$");
      try { 
  ...
  public void test098()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("EOF whilst processing escape seuence");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<EOF whilst processing escape seuence> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test112()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("gHv,;RNC;}OVz5i/IK)");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(true);
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(boolean0);
      assertEquals("gHv,;RNC;}OVz5i/IK)", cSVFormat2.getNullString());
  ...
  public void test114()  throws Throwable  {
      ...
      assertEquals("EOF whilst processing escape seuence", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(boolean0);
  ...
  public void test129()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("eyx;R0`k{>R2RFs)*{");
      cSVFormat1.parse(stringReader0);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isQuoting());
