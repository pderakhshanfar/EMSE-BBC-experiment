...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("IiWQP");
      assertFalse(cSVFormat2.isNullHandling());
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("org.apache.commons.csv.CSVFormat@0000000002,org.apache.commons.csv.CSVFormat@0000000001");
      assertFalse(cSVFormat2.isNullHandling());
  ...
  public void test005()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("org.apache.commons.csv.CSVFormat@0000000002,org.apache.commons.csv.CSVFormat@0000000004,,,,,,,,,,,,,");
  ...
  public void test017()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("aA@}AH&L8xlU0b");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('$');
      assertEquals("aA@}AH&L8xlU0b", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test035()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("WtP0");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('v');
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isQuoting());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("WtP0", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test051()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("rO;xeCEc");
      String string0 = cSVFormat1.getNullString();
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("rO;xeCEc", string0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test091()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("IiWQP");
      try { 
        cSVFormat3.validate();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test095()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('u');
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      StringReader stringReader0 = new StringReader("`];.OOR)6");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test100()  throws Throwable  {
      ...
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertEquals("Delimiter=<5> CommentStart=<5> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertEquals('5', cSVFormat0.getDelimiter());
  }
  ...
  public void test101()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("aA@}AH&L8xlU0b");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<aA@}AH&L8xlU0b> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", string0);
  }
  ...
  public void test105()  throws Throwable  {
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertEquals("WtP0", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.isEscaping());
  ...
  public void test116()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("\n");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("wSU0ze)");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
