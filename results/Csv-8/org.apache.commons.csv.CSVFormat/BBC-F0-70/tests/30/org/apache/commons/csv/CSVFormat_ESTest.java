...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("68}AVb?Qmjq1");
      ...
      assertEquals("68}AVb?Qmjq1", cSVFormat2.getNullString());
  ...
  public void test005()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("E4/=nd");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("MLaEFN]*");
      assertEquals("E4/=nd", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("MLaEFN]*", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isEscaping());
  }
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("MLaEFN]*");
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test016()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('7');
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(")U?fZM");
  ...
  public void test035()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("69\"|VTbyp3=+Ds?B");
  ...
  public void test043()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("cACO1N&$Jt");
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertTrue(cSVFormat3.isCommentingEnabled());
      assertFalse(cSVFormat3.isQuoting());
      assertEquals('3', cSVFormat2.getDelimiter());
  ...
  public void test044()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("vVo_+P1?_,T'W~yFt");
  ...
  public void test046()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      String[] stringArray0 = new String[4];
      stringArray0[0] = "pHn5PEy";
      stringArray0[1] = "d OzmXpZN*W&v<[y";
  ...
  public void test069()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      String[] stringArray0 = new String[4];
      stringArray0[0] = "pMHn5PEy";
      stringArray0[1] = "d OzmXpZN*W&v<[y";
      stringArray0[2] = "Header:";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader(" %7d!uZf{+,\"Av");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      try { 
  ...
  public void test074()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withRecordSeparator(";(Qpp#");
  ...
  public void test110()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Sbe35 8 ");
      cSVFormat1.hashCode();
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("Sbe35 8 ", cSVFormat1.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test114()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("~)5h>f[=tz");
  ...
  public void test117()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('7');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(")U?fZM");
  ...
  public void test118()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(boolean0);
      assertEquals(")U?fZM", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isCommentingEnabled());
