...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(">kfu/zDA,4z#D!YS");
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertEquals(">kfu/zDA,4z#D!YS", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test016()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("wIc7DB7)|(PIR_]1w(3");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('=');
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("wIc7DB7)|(PIR_]1w(3", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test020()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("`~}vsvn[GP^/aV");
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
      assertEquals("`~}vsvn[GP^/aV", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("*\"6m vZM#/\"$wx[AN!");
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.isQuoting());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals("*\"6m vZM#/\"$wx[AN!", cSVFormat2.getNullString());
  }

  @Test(timeout = 4000)
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("e--D,V,A_");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(false);
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("e--D,V,A_", cSVFormat2.getNullString());
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("*\"6m vZM#/\"$wx[AN!");
      Character character0 = new Character('H');
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      ...
      assertEquals("*\"6m vZM#/\"$wx[AN!", cSVFormat3.getNullString());
  }
  ...
  public void test038()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("^+qsSOV|&vp;");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart('8');
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("^+qsSOV|&vp;", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isCommentingEnabled());
  ...
  public void test047()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("wIc7DB7)|(PIR_]1w(3", string0);
  }
  ...
  public void test068()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("[j[qpD\"bp'");
      boolean boolean0 = cSVFormat1.isNullHandling();
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("[j[qpD\"bp'", cSVFormat1.getNullString());
      assertTrue(boolean0);
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test087()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("dlr?jn;Ey~{6SZ;,uV");
      Character character0 = new Character('F');
      CSVFormat cSVFormat1 = cSVFormat0.withEscape(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      // Undeclared exception!
  ...
  public void test094()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("[j[qpD\"bp'");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<[j[qpD\"bp'> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test095()  throws Throwable  {
      ...
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals("Delimiter=<s> Escape=<s> SkipHeaderRecord:false", string0);
      assertEquals('s', cSVFormat0.getDelimiter());
  }
  ...
  public void test099()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("e--D,V,A_", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
  }
  ...
  public void test108()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(":7w+oaRYtYf");
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(":7w+oaRYtYf");
      ...
      assertTrue(boolean0);
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals(":7w+oaRYtYf", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test115()  throws Throwable  {
      ...
      Character character0 = new Character('Y');
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat0.RFC4180.withCommentStart(character0);
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertTrue(boolean0);
      assertFalse(cSVFormat2.isNullHandling());
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
