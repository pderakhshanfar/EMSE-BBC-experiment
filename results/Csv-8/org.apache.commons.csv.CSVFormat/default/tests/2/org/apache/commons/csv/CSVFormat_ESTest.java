...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("hcZ");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(false);
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("hcZ", cSVFormat2.getNullString());
  ...
  public void test004()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("hcZ");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("hcZ");
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      ...
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("hcZ", cSVFormat1.getNullString());
  }
  ...
  public void test021()  throws Throwable  {
      ...
      Character character0 = new Character('\u0087');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("&MLL+_cG;");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("&MLL+_cG;", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isCommentingEnabled());
  ...
  public void test033()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(";<TT;M~a6cm`");
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(";<TT;M~a6cm`", cSVFormat2.getNullString());
  }
  ...
  public void test045()  throws Throwable  {
      ...
      stringArray0[0] = "T";
      stringArray0[1] = "4h&H~nU%BZ";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("=q2opq$M-b_o7a");
  ...
  public void test070()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString("url");
  ...
  public void test095()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      StringReader stringReader0 = new StringReader("Delimiter=<8> QuoteChar=<8> SkipHeaderRecord:false");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test105()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(";9CY`_#E{z\"@jdjZ!");
      cSVFormat1.hashCode();
      assertEquals(";9CY`_#E{z\"@jdjZ!", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test114()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals(";<TT;M~a6cm`", cSVFormat1.getNullString());
  }
  ...
  public void test130()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cSVFormat0.withQuoteChar((Character) '\r');
        fail("Expecting exception: IllegalArgumentException");
