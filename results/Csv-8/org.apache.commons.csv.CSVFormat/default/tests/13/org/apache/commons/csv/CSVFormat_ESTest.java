...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("|:*:?Wn,MKEh.*u,|/i");
  ...
  public void test007()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("CTJ");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar((Character) null);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("CTJ", cSVFormat2.getNullString());
  ...
  public void test016()  throws Throwable  {
      ...
      assertEquals('Y', (char)cSVFormat5.getQuoteChar());
  }
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("%dv;f*GNFMI8|S0");
      ...
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.isQuoting());
      assertEquals("%dv;f*GNFMI8|S0", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("! !%pA'q|rFTmgI");
      ...
      assertEquals("! !%pA'q|rFTmgI", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
  ...
  public void test035()  throws Throwable  {
      ...
      Character character0 = new Character('Q');
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("! !%pA'q|rFTmgI");
      assertTrue(cSVFormat3.isQuoting());
  ...
  public void test037()  throws Throwable  {
      ...
      CSVFormat cSVFormat4 = cSVFormat3.withRecordSeparator("DnM[[");
  ...
  public void test085()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\u0090');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart('\u0090');
      StringReader stringReader0 = new StringReader("4I|>al??<2q&T");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test089()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader(",);=9Vmia1");
  ...
  public void test092()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("B*&5NA%&3lySs9uzT");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<B*&5NA%&3lySs9uzT> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test095()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("#P<&S(D");
      cSVFormat1.hashCode();
      assertEquals("#P<&S(D", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.isQuoting());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
  ...
  public void test116()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('E');
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withRecordSeparator("~SM]~'4");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test125()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter(':');
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("D-F|PN0m6kF>59Dd]");
