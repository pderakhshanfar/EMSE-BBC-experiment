...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader(">#raRXMw<XO!t:");
  ...
  public void test008()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("1xwCRk[o");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('L');
      assertEquals("1xwCRk[o", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test012()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("!C|%U#K*;u5");
      ...
      assertEquals("!C|%U#K*;u5", cSVFormat3.getNullString());
  }
  ...
  public void test016()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Ga^PM:B*P+tg^94ssH");
      ...
      assertEquals("\r\n", cSVFormat3.getRecordSeparator());
      assertEquals("Ga^PM:B*P+tg^94ssH", cSVFormat3.getNullString());
      assertFalse(cSVFormat3.getSkipHeaderRecord());
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("1xwCRk[o");
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test032()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("O*(aP1G^k(9`zyW?:Re");
  ...
  public void test035()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("E!V&2Md.:&F.;BqP\"C");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('');
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("E!V&2Md.:&F.;BqP\"C", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals('', (char)cSVFormat2.getEscape());
  ...
  public void test049()  throws Throwable  {
      ...
      stringArray0[0] = "Delimiter=<,> QuoteChar=<\"> RecordSeparator=<U> EmptyLines:ignored SkipHeaderRecord:false";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
  ...
  public void test056()  throws Throwable  {
      ...
      assertEquals("Ga^PM:B*P+tg^94ssH", string0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test073()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.equals((Object)cSVFormat1));
      assertEquals("!C|%U#K*;u5", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test097()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("5V7");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test101()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Ga^PM:B*P+tg^94ssH");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<Ga^PM:B*P+tg^94ssH> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test102()  throws Throwable  {
      ...
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertEquals("Delimiter=<N> CommentStart=<F> SkipHeaderRecord:false", string0);
      assertEquals('N', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
  }
  ...
  public void test117()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("=NtYC}kr}4k+1d");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("=NtYC}kr}4k+1d", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertFalse(cSVFormat1.isQuoting());
      assertFalse(boolean0);
