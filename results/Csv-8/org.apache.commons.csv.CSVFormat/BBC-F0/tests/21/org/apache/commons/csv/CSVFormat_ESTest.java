...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("H9");
  ...
  public void test007()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator(")Djo{?\"(K<vF(");
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isNullHandling());
      assertFalse(cSVFormat2.equals((Object)cSVFormat1));
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test026()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(" nG/;LRJ(OXP~;@TZ:y");
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals(" nG/;LRJ(OXP~;@TZ:y", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test035()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("^N}E>oc5q");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('s');
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
      assertEquals("^N}E>oc5q", cSVFormat2.getNullString());
  ...
  public void test041()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("L&up6moSqa");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart((Character) null);
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("L&up6moSqa", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test045()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("`V'0'6");
  ...
  public void test055()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withIgnoreSurroundingSpaces(true);
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart((Character) null);
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("^N}E>oc5q");
      ...
      assertEquals("\r\n", cSVFormat3.getRecordSeparator());
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertEquals("^N}E>oc5q", cSVFormat3.getNullString());
      assertTrue(boolean0);
  }
  ...
  public void test096()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Delimiter=<2> Escape=<2> CommentStart=<2> SkipHeaderRecord:false");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test101()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<2> CommentStart=<2> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
