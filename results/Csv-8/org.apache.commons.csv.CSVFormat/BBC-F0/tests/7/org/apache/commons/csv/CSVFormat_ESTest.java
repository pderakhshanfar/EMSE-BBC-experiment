...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("?AE#j]Y?>");
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat0.withRecordSeparator(" 9.[Tw:");
  ...
  public void test020()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("46P{Xtaxic");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('p');
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals("46P{Xtaxic", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\\', (char)cSVFormat2.getEscape());
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('2');
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Delimiter=<2> SkipHeaderRecord:false");
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertEquals('2', cSVFormat2.getDelimiter());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
  ...
  public void test032()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("l5,hf_(F1IcT:Ba^|^5");
      Character character0 = new Character('+');
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("l5,hf_(F1IcT:Ba^|^5", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
  ...
  public void test034()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("9V`Cw+FLt_*");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape('f');
      assertEquals("9V`Cw+FLt_*", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test036()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("*%*'Vd/<`fCK");
  ...
  public void test089()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("*%*'Vd/<`fCK");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<e> NullString=<*%*'Vd/<`fCK> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
  ...
  public void test095()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("B9TsX)");
      cSVFormat1.hashCode();
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("B9TsX)", cSVFormat1.getNullString());
  }
  ...
  public void test103()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("9V`Cw+FLt_*", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(boolean0);
