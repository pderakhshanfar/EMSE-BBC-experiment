...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("YUiF");
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("v4B(mc^>c:Z");
      ...
      assertEquals("v4B(mc^>c:Z", cSVFormat2.getNullString());
  }
  ...
  public void test005()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("T0mrC$W|Jq1v");
  ...
  public void test008()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("mHLT&6");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('`');
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("`", cSVFormat2.getRecordSeparator());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("mHLT&6", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isEscaping());
  }
  ...
  public void test013()  throws Throwable  {
      ...
      assertEquals("T0mrC$W|Jq1v", cSVFormat3.getNullString());
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("jeU`BD>c^<ax");
      ...
      assertTrue(cSVFormat2.isQuoting());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("jeU`BD>c^<ax", cSVFormat2.getNullString());
  ...
  public void test026()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("T0mrC$W|Jq1v");
      assertEquals("T0mrC$W|Jq1v", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test053()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("jeU`BD>c^<ax", string0);
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
  ...
  public void test089()  throws Throwable  {
      StringReader stringReader0 = new StringReader("XFhUYK'y^sgUMV6SV_");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      Character character0 = new Character('R');
  ...
  public void test090()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withDelimiter('Q');
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart('Q');
      StringReader stringReader0 = new StringReader("\"St{tgdYW<eIb`g;M'");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test095()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString("6l");
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals("Delimiter=<\t> QuoteChar=<\"> NullString=<6l> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", string0);
  ...
  public void test111()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(':');
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString(" SkipHeaderRcord:");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(false);
      ...
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(" SkipHeaderRcord:", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test121()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(':');
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString(" SkipHeaderRcord:");
      CSVFormat cSVFormat2 = cSVFormat0.DEFAULT.withIgnoreEmptyLines(false);
      boolean boolean0 = cSVFormat2.equals(cSVFormat1);
      assertFalse(boolean0);
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test125()  throws Throwable  {
      ...
      assertFalse(boolean0);
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals(" SkipHeaderRcord:", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.isQuoting());
  }
