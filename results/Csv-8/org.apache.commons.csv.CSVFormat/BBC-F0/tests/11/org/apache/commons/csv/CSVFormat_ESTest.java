...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("^2q3:1}GoS");
  ...
  public void test002()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat0.withRecordSeparator(") EOF reached before encapsulated token finished");
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("cV#.+G\"");
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("org.apache.commons.csv.CSVFormat@0000000002\torg.apache.commons.csv.CSVFormat@0000000002");
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("R$2_:@[tZ_%");
  ...
  public void test016()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("-{;Bh$GcNi'+#");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('F');
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isEscaping());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("-{;Bh$GcNi'+#", cSVFormat2.getNullString());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
  ...
  public void test021()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("\"!7Epkl");
      assertEquals("\"!7Epkl", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
  ...
  public void test030()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("cV#.+G\"");
      Character character0 = Character.valueOf('{');
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("cV#.+G\"");
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      ...
      assertEquals("cV#.+G\"", cSVFormat2.getNullString());
  }
  ...
  public void test039()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("mQ`&;3v%!");
      Character character0 = new Character('}');
      ...
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("mQ`&;3v%!", cSVFormat2.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test085()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("R+$7(*#V");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test093()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("Delimiter=<f> Escape=<D> QuoteChar=<\"> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }

  @Test(timeout = 4000)
  public void test094()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("O.c,S@@SWR$ikHDr1cP");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<O.c,S@@SWR$ikHDr1cP> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test108()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Ec&G`4");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("Ec&G`4", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
