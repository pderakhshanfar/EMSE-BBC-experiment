...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("HMvXRg_2{");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      CSVFormat cSVFormat3 = cSVFormat2.withRecordSeparator("-9KAb");
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat3.getIgnoreEmptyLines());
      assertEquals("-9KAb", cSVFormat3.getRecordSeparator());
      assertFalse(cSVFormat3.isQuoting());
      assertEquals('\t', cSVFormat3.getDelimiter());
      assertEquals("HMvXRg_2{", cSVFormat3.getNullString());
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertTrue(cSVFormat3.isEscaping());
  }
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Bi9Z");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreSurroundingSpaces(true);
      ...
      assertEquals("Bi9Z", cSVFormat3.getNullString());
      assertEquals('\t', cSVFormat3.getDelimiter());
      assertFalse(cSVFormat3.isCommentingEnabled());
  ...
  public void test023()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("2EG.Cnm");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(false);
      assertEquals("2EG.Cnm", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isCommentingEnabled());
  ...
  public void test046()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("-9KAb");
  ...
  public void test094()  throws Throwable  {
      ...
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      StringReader stringReader0 = new StringReader("<[z 5u");
      // Undeclared exception!
      try { 
        cSVFormat1.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test099()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withDelimiter('S');
      StringReader stringReader0 = new StringReader("<[z 5u");
  ...
  public void test105()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ZuI//g/");
      ...
      assertEquals("ZuI//g/", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isCommentingEnabled());
  ...
  public void test111()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("P1");
  ...
  public void test127()  throws Throwable  {
      ...
      CSVFormat cSVFormat3 = cSVFormat2.DEFAULT.withQuotePolicy(quote0);
