...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test008()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("$jNN9q|\"!8Tt'");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('\\');
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals("$jNN9q|\"!8Tt'", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\\", cSVFormat2.getRecordSeparator());
  ...
  public void test015()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("{Q3SV>UX>k1W2QX-l1");
  ...
  public void test044()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("uzAe9hJO");
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("uzAe9hJO", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test052()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("8gQ&Qm^+%xGF");
      String string0 = cSVFormat1.getNullString();
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("8gQ&Qm^+%xGF", string0);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.isQuoting());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test097()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Delimiter=<W> Escape=<W> QuoteChar=<\"> NullString=<The escape character and the delimiter cannot be the same ('> RecordSeparator=<W> EmptyLines:ignored SkipHeaderRecord:false");
      // Undeclared exception!
      try { 
        cSVFormat2.parse(stringReader0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test098()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader(",y,<.r6H]b;");
      // Undeclared exception!
      try { 
  ...
  public void test110()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("q><p6=v8,${j29'");
      cSVFormat1.parse(stringReader0);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.isNullHandling());
  ...
  public void test136()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("E3_ZO*eZ#,{1");
