...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("U{Y)1SPK");
      cSVFormat1.parse(stringReader0);
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("7uS%$c'7_UG.`");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("7uS%$c'7_UG.`");
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("aetfJq");
  ...
  public void test009()  throws Throwable  {
      ...
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("7uS%$c'7_UG.`", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
  }
  ...
  public void test012()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("aetfJq");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("aetfJq", cSVFormat2.getNullString());
  }
  ...
  public void test025()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(".a<zYhaP`haD");
  ...
  public void test026()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("])GdJq4`#qZDR_WDD");
      CSVFormat cSVFormat2 = cSVFormat1.withIgnoreEmptyLines(true);
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat2.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("])GdJq4`#qZDR_WDD", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
  ...
  public void test038()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("~]l\"~kP+aAXE.Ctt");
  ...
  public void test044()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(".a<zYhaP`haD");
      CSVFormat cSVFormat3 = cSVFormat2.withCommentStart('6');
      assertFalse(cSVFormat0.getSkipHeaderRecord());
  ...
  public void test092()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withEscape(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart(character0);
      StringReader stringReader0 = new StringReader("DmY$m{#i");
      // Undeclared exception!
      try { 
  ...
  public void test102()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("aetfJq");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<aetfJq> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test105()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("aetfJq", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals(',', cSVFormat1.getDelimiter());
  }
  ...
  public void test110()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('#');
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("7uS%$c'7_UG.`");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(boolean0);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
  ...
  public void test114()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("b.c,|r<b5a9L/~LWJgq");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(boolean0);
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      ...
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("b.c,|r<b5a9L/~LWJgq", cSVFormat1.getNullString());
  }
