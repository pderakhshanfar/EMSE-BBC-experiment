...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("fcN7R#RkNcjH9G");
      cSVFormat1.hashCode();
      assertEquals("fcN7R#RkNcjH9G", cSVFormat1.getNullString());
  ...
  public void test003()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("'JZ'76H");
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("'JZ'76H", cSVFormat2.getNullString());
  ...
  public void test005()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("0Nh&Iks\"Mz");
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("0Nh&Iks\"Mz", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test019()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("jr");
      assertTrue(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test020()  throws Throwable  {
      ...
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertEquals("'JZ'76H", cSVFormat3.getNullString());
  ...
  public void test032()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("gM3dvo5");
      ...
      assertFalse(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("gM3dvo5", cSVFormat2.getNullString());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
  ...
  public void test114()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("@-q5(S\u0002%ZNKc59");
      CSVFormat cSVFormat2 = cSVFormat0.withNullString("@-q5(S\u0002%ZNKc59");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertTrue(boolean0);
      assertFalse(cSVFormat2.equals((Object)cSVFormat0));
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("@-q5(S\u0002%ZNKc59", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat2.getDelimiter());
      assertFalse(cSVFormat2.getSkipHeaderRecord());
  ...
  public void test115()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("@-q5(S\u0002%ZNKc59");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertEquals("@-q5(S\u0002%ZNKc59", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(boolean0);
  ...
  public void test119()  throws Throwable  {
      ...
      Character character0 = Character.valueOf('W');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat0.withCommentStart('W');
  ...
  public void test125()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      boolean boolean0 = cSVFormat0.equals("'JZ'76H");
      assertFalse(boolean0);
  }
  ...
  public void test136()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('k');
      StringReader stringReader0 = new StringReader("jY}SJ6*2");
