...
public class AtomicReferenceDeserializer_ESTest extends AtomicReferenceDeserializer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      AsExternalTypeDeserializer asExternalTypeDeserializer0 = new AsExternalTypeDeserializer((JavaType) null, classNameIdResolver0, " not a super-type of (declared) class ", true, javaTypeArray0[0]);
      PropertyName propertyName0 = PropertyName.construct(" not a super-type of (declared) class ");
      Boolean boolean0 = Boolean.valueOf(true);
      Integer integer0 = new Integer(0);
      PropertyMetadata propertyMetadata0 = PropertyMetadata.construct(boolean0, (String) null, integer0, "gB{NVJ{");
  ...
  public void test3()  throws Throwable  {
      ...
      assertEquals("-939", object0.toString());
  }
