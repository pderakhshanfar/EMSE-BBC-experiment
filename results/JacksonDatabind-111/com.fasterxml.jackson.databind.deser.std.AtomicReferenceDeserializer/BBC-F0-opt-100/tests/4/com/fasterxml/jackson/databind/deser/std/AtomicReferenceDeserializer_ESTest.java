...
public class AtomicReferenceDeserializer_ESTest extends AtomicReferenceDeserializer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      AsPropertyTypeDeserializer asPropertyTypeDeserializer0 = new AsPropertyTypeDeserializer((JavaType) null, (TypeIdResolver) null, "need JSON String that contains type id (for subtype of %s)", true, (JavaType) null);
      PropertyName propertyName0 = PropertyName.construct("need JSON String that contains type id (for subtype of %s)");
