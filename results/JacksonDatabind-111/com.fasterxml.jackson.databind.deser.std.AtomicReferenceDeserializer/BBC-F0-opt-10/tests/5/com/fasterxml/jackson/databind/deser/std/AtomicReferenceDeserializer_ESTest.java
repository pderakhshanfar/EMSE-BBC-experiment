...
public class AtomicReferenceDeserializer_ESTest extends AtomicReferenceDeserializer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ReferenceType referenceType0 = ReferenceType.construct(class0, typeBindings0, javaTypeArray0[3], javaTypeArray0, javaTypeArray0[0]);
      ClassNameIdResolver classNameIdResolver0 = new ClassNameIdResolver(javaTypeArray0[3], typeFactory0);
      AsArrayTypeDeserializer asArrayTypeDeserializer0 = new AsArrayTypeDeserializer(referenceType0, classNameIdResolver0, "Z", true, javaTypeArray0[1]);
      ...
      AsWrapperTypeDeserializer asWrapperTypeDeserializer0 = new AsWrapperTypeDeserializer(referenceType0, classNameIdResolver0, "4$,%N]]__T", true, javaTypeArray0[4]);
