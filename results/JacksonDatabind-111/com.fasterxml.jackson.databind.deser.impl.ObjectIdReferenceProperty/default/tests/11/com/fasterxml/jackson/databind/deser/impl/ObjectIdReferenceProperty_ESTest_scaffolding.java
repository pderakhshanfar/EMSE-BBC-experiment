...
public class ObjectIdReferenceProperty_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.annotation.ObjectIdGenerator", false, ObjectIdReferenceProperty_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("com.fasterxml.jackson.databind.introspect.POJOPropertiesCollector", false, ObjectIdReferenceProperty_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, ObjectIdReferenceProperty_ESTest_scaffolding.class.getClassLoader()));
  }
