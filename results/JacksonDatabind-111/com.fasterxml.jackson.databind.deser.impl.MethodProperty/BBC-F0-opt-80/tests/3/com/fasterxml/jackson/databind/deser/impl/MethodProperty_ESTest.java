...
public class MethodProperty_ESTest extends MethodProperty_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      AsWrapperTypeDeserializer asWrapperTypeDeserializer0 = new AsWrapperTypeDeserializer(simpleType0, classNameIdResolver0, "Cannot coerce a floating-point value ('%s') into %s (enable `DeserializationFeature.ACCEPT_FLOAT_AS_INT` to allow)", true, simpleType0);
      AnnotationMap annotationMap0 = new AnnotationMap();
      MethodProperty methodProperty0 = null;
      try {
        methodProperty0 = new MethodProperty((BeanPropertyDefinition) null, simpleType0, asWrapperTypeDeserializer0, annotationMap0, (AnnotatedMethod) null);
