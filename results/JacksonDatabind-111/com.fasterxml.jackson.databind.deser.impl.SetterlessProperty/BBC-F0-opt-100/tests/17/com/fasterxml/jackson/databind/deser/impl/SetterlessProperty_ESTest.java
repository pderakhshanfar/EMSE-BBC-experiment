...
public class SetterlessProperty_ESTest extends SetterlessProperty_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      AsPropertyTypeDeserializer asPropertyTypeDeserializer0 = new AsPropertyTypeDeserializer(javaTypeArray0[0], classNameIdResolver0, (String) null, true, javaTypeArray0[4], jsonTypeInfo_As0);
      ...
      try {
        setterlessProperty0 = new SetterlessProperty(pOJOPropertyBuilder0, javaTypeArray0[3], asPropertyTypeDeserializer0, annotationCollector_TwoAnnotations0, (AnnotatedMethod) null);
