...
public class SetterlessProperty_ESTest extends SetterlessProperty_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      AsWrapperTypeDeserializer asWrapperTypeDeserializer0 = new AsWrapperTypeDeserializer(javaType0, (TypeIdResolver) null, "Problem deserializing 'setterless' property (\"%s\"): no way to handle typed deser with setterless yet", false, javaTypeArray0[0]);
      AnnotationMap annotationMap0 = new AnnotationMap();
      SetterlessProperty setterlessProperty0 = null;
      try {
        setterlessProperty0 = new SetterlessProperty(pOJOPropertyBuilder0, javaType0, asWrapperTypeDeserializer0, annotationMap0, (AnnotatedMethod) null);
