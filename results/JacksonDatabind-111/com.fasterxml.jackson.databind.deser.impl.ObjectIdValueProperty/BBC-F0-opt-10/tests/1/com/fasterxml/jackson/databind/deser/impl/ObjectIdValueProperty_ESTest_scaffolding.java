...
public class ObjectIdValueProperty_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("com.fasterxml.jackson.annotation.ObjectIdGenerators$StringIdGenerator", false, ObjectIdValueProperty_ESTest_scaffolding.class.getClassLoader()));
