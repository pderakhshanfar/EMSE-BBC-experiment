...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      InvocationImpl invocationImpl0 = new InvocationImpl(cleanTraceRealMethod0, mockitoMethod0, objectArray0, 2475, defaultRealMethod0);
  ...
  public void test04()  throws Throwable  {
      ...
      doReturn(false).when(mockitoMethod0).isVarArgs();
      Object[] objectArray0 = new Object[0];
      InvocationImpl invocationImpl0 = new InvocationImpl(cleanTraceRealMethod0, mockitoMethod0, objectArray0, 2479, cleanTraceRealMethod0);
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocationImpl0);
  ...
  public void test16()  throws Throwable  {
      ...
      StringStartsWith stringStartsWith0 = new StringStartsWith("Mshp{OBG");
      MockitoMethod mockitoMethod0 = mock(MockitoMethod.class, new ViolatedAssumptionAnswer());
      doReturn(false).when(mockitoMethod0).isVarArgs();
      MockitoMethodProxy mockitoMethodProxy0 = mock(MockitoMethodProxy.class, new ViolatedAssumptionAnswer());
      DefaultRealMethod defaultRealMethod0 = new DefaultRealMethod(mockitoMethodProxy0);
      InvocationImpl invocationImpl0 = new InvocationImpl(stringStartsWith0, mockitoMethod0, (Object[]) null, 6615, defaultRealMethod0);
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocationImpl0);
  ...
  public void test18()  throws Throwable  {
      ...
      MockitoMethod mockitoMethod0 = mock(MockitoMethod.class, new ViolatedAssumptionAnswer());
      doReturn(true).when(mockitoMethod0).isVarArgs();
      IsIn<StringStartsWith> isIn0 = new IsIn<StringStartsWith>((Collection<StringStartsWith>) null);
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(isIn0);
      Object[] objectArray0 = new Object[8];
      InvocationImpl invocationImpl0 = new InvocationImpl(localizedMatcher0, mockitoMethod0, objectArray0, 37, cleanTraceRealMethod0);
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocationImpl0);
      Location location0 = invocationMatcher0.getLocation();
