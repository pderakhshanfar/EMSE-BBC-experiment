...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Matcher<StringContains> matcher0 = HasProperty.hasProperty("");
  ...
  public void test12()  throws Throwable  {
      Object[] objectArray0 = new Object[9];
      IsEqualIgnoringCase isEqualIgnoringCase0 = new IsEqualIgnoringCase("#ggHDMxh4UNCbvfs");
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("#ggHDMxh4UNCbvfs").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(isEqualIgnoringCase0, "#ggHDMxh4UNCbvfs", (Object) null, (Object) null).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
