...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      IsSame<String> isSame0 = new IsSame<String>("|3w{!`A8I`Xu(`je1~f");
      Object[] objectArray0 = new Object[8];
      DescribedAs<String> describedAs0 = new DescribedAs<String>("|3w{!`A8I`Xu(`je1~f", isSame0, objectArray0);
  ...
  public void test08()  throws Throwable  {
      Object[] objectArray0 = new Object[4];
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(" is a ").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
  ...
  public void test14()  throws Throwable  {
      StringStartsWith stringStartsWith0 = new StringStartsWith("Mf~]xe(");
      Object[] objectArray0 = new Object[4];
      objectArray0[3] = (Object) stringStartsWith0;
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("Mf~]xe(").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn((Method) null, (Method) null).when(invocation0).getMethod();
      doReturn(objectArray0[3], stringStartsWith0).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
      Invocation invocation1 = invocationMatcher0.getInvocation();
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      doReturn("Mf~]xe(").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(stack0, isEmptyString0).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
      Invocation invocation1 = invocationMatcher0.getInvocation();
