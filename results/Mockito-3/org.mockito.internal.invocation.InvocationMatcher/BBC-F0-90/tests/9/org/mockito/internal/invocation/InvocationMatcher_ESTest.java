...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      ArrayDeque<String> arrayDeque0 = new ArrayDeque<String>((-12));
      StringContainsInOrder stringContainsInOrder0 = new StringContainsInOrder(arrayDeque0);
      SamePropertyValuesAs<StringContainsInOrder> samePropertyValuesAs0 = new SamePropertyValuesAs<StringContainsInOrder>(stringContainsInOrder0);
  ...
  public void test11()  throws Throwable  {
      Object[] objectArray0 = new Object[16];
      IsCloseTo isCloseTo0 = new IsCloseTo((-715.0886), 0.0);
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(objectArray0).when(invocation0).getArguments();
  ...
  public void test12()  throws Throwable  {
      ...
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(isCloseTo0, isCloseTo1).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
