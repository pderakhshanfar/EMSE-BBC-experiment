...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      IsEmptyString[] isEmptyStringArray0 = new IsEmptyString[0];
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(isEmptyStringArray0).when(invocation0).getArguments();
  ...
  public void test01()  throws Throwable  {
      IsEmptyString[] isEmptyStringArray0 = new IsEmptyString[1];
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
  ...
  public void test08()  throws Throwable  {
      IsEmptyString[] isEmptyStringArray0 = new IsEmptyString[6];
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(isEmptyStringArray0).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
      List<Matcher> list0 = (List<Matcher>)invocationMatcher0.getMatchers();
  ...
  public void test12()  throws Throwable  {
      IsEmptyString[] isEmptyStringArray0 = new IsEmptyString[0];
      IsEqualIgnoringWhiteSpace isEqualIgnoringWhiteSpace0 = new IsEqualIgnoringWhiteSpace("LDM9sa53s0}hX,s");
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("LDM9sa53s0}hX,s").when(invocation0).toString();
      doReturn(isEmptyStringArray0).when(invocation0).getArguments();
      doReturn("F&2p:5.biJge", isEqualIgnoringWhiteSpace0, (Object) null, (Object) null).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
  ...
  public void test13()  throws Throwable  {
      IsEmptyString[] isEmptyStringArray0 = new IsEmptyString[1];
      CapturingMatcher<Integer> capturingMatcher0 = new CapturingMatcher<Integer>();
