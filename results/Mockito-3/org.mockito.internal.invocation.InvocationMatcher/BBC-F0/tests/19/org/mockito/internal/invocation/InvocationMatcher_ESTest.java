...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      doReturn((String) null).when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(stringContainsInOrder0, arrayList0).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
      Answer<StringEndsWith> answer0 = (Answer<StringEndsWith>) mock(Answer.class, new ViolatedAssumptionAnswer());
      StubbedInvocationMatcher stubbedInvocationMatcher0 = new StubbedInvocationMatcher(invocationMatcher0, answer0);
  ...
  public void test10()  throws Throwable  {
      ...
      AnyOf<StringContainsInOrder> anyOf0 = AnyOf.anyOf((Matcher<StringContainsInOrder>) isAnything0, (Matcher<? super StringContainsInOrder>) isAnything0, (Matcher<? super StringContainsInOrder>) isAnything0, (Matcher<? super StringContainsInOrder>) isAnything0, (Matcher<? super StringContainsInOrder>) isAnything0);
      DescribedAs<StringContainsInOrder> describedAs0 = new DescribedAs<StringContainsInOrder>("' cannot be returned because the following ", anyOf0, objectArray0);
