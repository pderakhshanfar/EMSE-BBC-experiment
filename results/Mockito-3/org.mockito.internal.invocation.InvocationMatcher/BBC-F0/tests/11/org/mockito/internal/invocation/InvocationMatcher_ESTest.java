...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringContainsInOrder[] stringContainsInOrderArray0 = new StringContainsInOrder[4];
      Matcher<StringContainsInOrder> matcher0 = IsIn.isIn(stringContainsInOrderArray0);
  ...
  public void test09()  throws Throwable  {
      ...
      IsEqualIgnoringWhiteSpace isEqualIgnoringWhiteSpace0 = new IsEqualIgnoringWhiteSpace("p");
      Object[] objectArray0 = new Object[1];
      objectArray0[0] = object0;
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      Invocation invocation1 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(objectArray0).when(invocation1).getArguments();
      doReturn(list0, (Object) null).when(invocation1).getMock();
