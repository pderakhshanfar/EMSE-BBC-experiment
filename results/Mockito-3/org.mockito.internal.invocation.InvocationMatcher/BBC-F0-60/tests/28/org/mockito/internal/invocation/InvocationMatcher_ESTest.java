...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      DescribedAs<InvocationImpl> describedAs0 = new DescribedAs<InvocationImpl>("", isSame0, objectArray0);
      AnyOf<InvocationImpl> anyOf0 = AnyOf.anyOf((Matcher<InvocationImpl>) isSame0, (Matcher<? super InvocationImpl>) describedAs0);
  ...
  public void test11()  throws Throwable  {
      Object[] objectArray0 = new Object[5];
      StringStartsWith stringStartsWith0 = new StringStartsWith("3Qf%9#^a'}_");
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("3Qf%9#^a'}_").when(invocation0).toString();
  ...
  public void test12()  throws Throwable  {
      ...
      doReturn("3Qf%9#^a'}_").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn("3Qf%9#^a'}_", stringStartsWith0).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
      Invocation invocation1 = invocationMatcher0.getInvocation();
