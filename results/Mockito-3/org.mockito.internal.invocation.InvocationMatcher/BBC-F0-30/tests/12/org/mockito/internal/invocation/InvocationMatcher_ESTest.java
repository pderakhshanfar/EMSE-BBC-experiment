...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("nKC'%#t#1!").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
  ...
  public void test11()  throws Throwable  {
      ...
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(objectArray0[1], isEqualIgnoringCase0).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
      Invocation invocation1 = invocationMatcher0.getInvocation();
  ...
  public void test12()  throws Throwable  {
      Object[] objectArray0 = new Object[3];
      IsEqualIgnoringCase isEqualIgnoringCase0 = new IsEqualIgnoringCase("org.mockito.internal.invocation.InvocationMatcher");
      IsSame<Object> isSame0 = new IsSame<Object>(isEqualIgnoringCase0);
      HasToString<IsCloseTo> hasToString0 = new HasToString<IsCloseTo>(isSame0);
