...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      TreeSet<IsEmptyString> treeSet0 = new TreeSet<IsEmptyString>();
      Matcher<IsEmptyString> matcher0 = IsIn.isIn((Collection<IsEmptyString>) treeSet0);
  ...
  public void test11()  throws Throwable  {
      Object[] objectArray0 = new Object[1];
      IsEqualIgnoringCase isEqualIgnoringCase0 = new IsEqualIgnoringCase("type < ");
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("C").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
