...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      HasPropertyWithValue<Annotation> hasPropertyWithValue0 = new HasPropertyWithValue<Annotation>("}(q\"n\"8", matcher0);
  ...
  public void test13()  throws Throwable  {
      Object[] objectArray0 = new Object[1];
      IsEqualIgnoringCase isEqualIgnoringCase0 = new IsEqualIgnoringCase("%roGNG@y");
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("%roGNG@y").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(isEqualIgnoringCase0, "%roGNG@y").when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
