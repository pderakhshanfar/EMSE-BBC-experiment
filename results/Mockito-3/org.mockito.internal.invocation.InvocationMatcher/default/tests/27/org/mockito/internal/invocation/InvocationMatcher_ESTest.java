...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringEndsWith stringEndsWith0 = new StringEndsWith("DXR`ZXPs_X");
      ...
      doReturn("DXR`ZXPs_X").when(invocation0).toString();
  ...
  public void test12()  throws Throwable  {
      ...
      doReturn(answers0, answers0).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
      // Undeclared exception!
      try { 
