...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn("", "|gUPkj)AO").when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
  ...
  public void test11()  throws Throwable  {
      Object[] objectArray0 = new Object[1];
      IsCloseTo isCloseTo0 = new IsCloseTo(0.0, 980.41248);
      IsEqualIgnoringCase isEqualIgnoringCase0 = new IsEqualIgnoringCase("when() requires an argument which has to be 'a method call on a mock'.");
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((String) null).when(invocation0).toString();
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(isCloseTo0, isEqualIgnoringCase0, (Object) null, (Object) null).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
  ...
  public void test13()  throws Throwable  {
      ...
      AnyOf<IsEqualIgnoringCase> anyOf0 = AnyOf.anyOf((Matcher<IsEqualIgnoringCase>) isAnything0, (Matcher<? super IsEqualIgnoringCase>) isAnything0, (Matcher<? super IsEqualIgnoringCase>) isAnything0, (Matcher<? super IsEqualIgnoringCase>) isAnything0, (Matcher<? super IsEqualIgnoringCase>) isAnything0, (Matcher<? super IsEqualIgnoringCase>) isAnything0);
