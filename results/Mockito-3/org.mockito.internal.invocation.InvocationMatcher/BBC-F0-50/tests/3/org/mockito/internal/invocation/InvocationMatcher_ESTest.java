...
public class InvocationMatcher_ESTest extends InvocationMatcher_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      IsEmptyCollection<String>[] isEmptyCollectionArray0 = (IsEmptyCollection<String>[]) Array.newInstance(IsEmptyCollection.class, 8);
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((Object[]) null).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = null;
      try {
  ...
  public void test12()  throws Throwable  {
      Object[] objectArray0 = new Object[5];
      StringEndsWith stringEndsWith0 = new StringEndsWith("eFAzT#_[d]-wys");
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn((Object[]) null).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = null;
      try {
  ...
  public void test14()  throws Throwable  {
      IsEmptyCollection<String>[] isEmptyCollectionArray0 = (IsEmptyCollection<String>[]) Array.newInstance(IsEmptyCollection.class, 8);
      IsEmptyCollection<String> isEmptyCollection0 = new IsEmptyCollection<String>();
      LocalizedMatcher localizedMatcher0 = new LocalizedMatcher(isEmptyCollection0);
      ...
      doReturn(isEmptyCollectionArray0).when(invocation0).getArguments();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
