...
public class AbstractPatriciaTrie_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.Comparable", false, AbstractPatriciaTrie_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.AbstractMap$SimpleEntry", false, AbstractPatriciaTrie_ESTest_scaffolding.class.getClassLoader()));
