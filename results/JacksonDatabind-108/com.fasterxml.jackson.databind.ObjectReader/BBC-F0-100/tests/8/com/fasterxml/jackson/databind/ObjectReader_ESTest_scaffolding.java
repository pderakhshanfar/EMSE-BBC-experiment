...
public class ObjectReader_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.util.Comparator", false, ObjectReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, ObjectReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.DoubleBinaryOperator", false, ObjectReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToDoubleFunction", false, ObjectReader_ESTest_scaffolding.class.getClassLoader()));
  }
