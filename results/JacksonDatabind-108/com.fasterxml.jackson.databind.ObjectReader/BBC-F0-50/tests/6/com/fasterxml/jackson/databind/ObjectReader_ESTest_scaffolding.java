...
public class ObjectReader_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.util.function.LongBinaryOperator", false, ObjectReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToLongFunction", false, ObjectReader_ESTest_scaffolding.class.getClassLoader()));
  }
