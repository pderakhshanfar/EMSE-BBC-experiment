...
public class ObjectReader_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.util.function.IntBinaryOperator", false, ObjectReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToIntBiFunction", false, ObjectReader_ESTest_scaffolding.class.getClassLoader()));
  }
