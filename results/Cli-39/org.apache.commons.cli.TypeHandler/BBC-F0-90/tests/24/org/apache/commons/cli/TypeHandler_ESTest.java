...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".*]mKa");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/r {@3{qJD<kfZ");
  ...
  public void test08()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("HJ+qEtX<", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: HJ+qEtX<
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("org.apache.commons.cli.TypeHandler", (Object) "org.apache.commons.cli.PatternOptionBuilder");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createObject("[*)'QO");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: [*)'QO
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber("1nqz)].dedINuX8* ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"1nqz)].dedINuX8*\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("rH5Vy$@^^7`o`", class0);
      assertEquals("rH5Vy$@^^7`o`", object0);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createURL("C-jJ?p=\"9K8I");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: C-jJ?p=\"9K8I
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("G%()#%", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("p/e.gDi|");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test32()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("N,ZNHP/LE'gwL", (Object) class0);
      assertEquals("N,ZNHP/LE'gwL", object0);
  }
}
