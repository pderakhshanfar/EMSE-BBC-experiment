...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("M+lm,|v`FTueHpOo", (Object) class0);
      assertEquals("M+lm,|v`FTueHpOo", object0);
  }
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".g yjYAEny");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("/$k5!,CTr/3}yyc;!", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /$k5!,CTr/3}yyc;!
         //
  ...
  public void test15()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(">oY7:[|[c5k2AGAUVn", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: >oY7:[|[c5k2AGAUVn
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("M2&&/&>[kuoiHx}I;");
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber(":=0md7-.WR2mu]");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \":=0md7-.WR2mu]\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("h", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
  ...
  public void test20()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("j?I\"oT+S,Rz5+2", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("M+lm,|v`FTueHpOo", class0);
      assertEquals("M+lm,|v`FTueHpOo", object0);
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/$k5!,CTr/3}yyc;!");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("h", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
