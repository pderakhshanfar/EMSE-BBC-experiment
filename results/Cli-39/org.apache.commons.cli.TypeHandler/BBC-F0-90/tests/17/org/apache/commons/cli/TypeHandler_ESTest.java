...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("vr&MdjZ{eSEY");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("vr&MdjZ{eSEY");
      assertEquals(0L, file0.getFreeSpace());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".ySF.mO 2\"&>x<");
      assertEquals(".ySF.mO 2\"&>x<", file0.getName());
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createObject("Sx&f'iN{]");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Sx&f'iN{]
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("B;n:|O_e%t", class0);
      assertNull(object0);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile("/S7N_}6}Enct}b\"y<<");
  ...
  public void test27()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Z/oTA(-hFknO%", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Z/oTA(-hFknO%
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
