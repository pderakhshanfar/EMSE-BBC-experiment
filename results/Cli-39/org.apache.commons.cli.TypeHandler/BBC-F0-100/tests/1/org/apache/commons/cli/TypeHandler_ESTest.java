...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("}(NIPU|HC+Q7V*A");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("}(NIPU|HC+Q7V*A");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/.c|P_VpcE");
  ...
  public void test18()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("!^9j_pd!Ho6MzK&(h_", class0);
      assertEquals("!^9j_pd!Ho6MzK&(h_", object0);
  }
  ...
  public void test20()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("y~v^FW[9Fo9a~Yr5;");
