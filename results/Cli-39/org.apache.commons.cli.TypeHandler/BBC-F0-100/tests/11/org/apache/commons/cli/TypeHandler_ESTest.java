...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("d5kl$%A$TjWK*o&rFX", (Object) class0);
      assertEquals("d5kl$%A$TjWK*o&rFX", object0);
  }
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".\".31)Eo>xzKA*af");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/=}`Ek7gB/C|'xGmom");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/=}`Ek7gB/C|'xGmom");
      assertEquals("C|'xGmom", file0.getName());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Dz^^*j.jl", (Object) "Dz^^*j.jl");
  ...
  public void test09()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("i7wvjr{P0dp", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: i7wvjr{P0dp
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber("&i.{>AbfSs$H 0b]j");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"&i.{>AbfSs$H 0b]j\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("d5kl$%A$TjWK*o&rFX", class0);
      assertEquals("d5kl$%A$TjWK*o&rFX", object0);
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createURL("bM");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: bM
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createClass("$vP=*1sr7(h2o");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: $vP=*1sr7(h2o
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
