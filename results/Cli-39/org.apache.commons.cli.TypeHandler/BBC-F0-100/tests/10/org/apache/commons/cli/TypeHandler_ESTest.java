...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/^^HYLHP,n");
      assertFalse(file0.canRead());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("xT4Yf2BY3?aV(^x");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "wC*Ln");
      File file0 = TypeHandler.createFile("xT4Yf2BY3?aV(^x");
      assertEquals("xT4Yf2BY3?aV(^x", file0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(";2ikSg!kjM", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ;2ikSg!kjM
         //
  ...
  public void test28()  throws Throwable  {
      Object object0 = TypeHandler.createValue("7a&0S:^V?\"0@R*", (Object) null);
      assertNull(object0);
  }
}
