...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("<]`moePnx");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "|}#o3'/UzG");
      File file0 = TypeHandler.createFile("<]`moePnx");
      assertEquals(11L, file0.length());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/.7VX3pz4;\"v");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Ef9%6", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Ef9%6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("W=9*", (Object) "W=9*");
  ...
  public void test09()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("P2iwrU.Lj", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: P2iwrU.Lj
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass(">dgsB[sCmBI");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: >dgsB[sCmBI
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("ovUlEP-y1}t4EL,A{c", class0);
      assertNull(object0);
  }
  ...
  public void test21()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("ovUlEP-y1}t4EL,A{c");
