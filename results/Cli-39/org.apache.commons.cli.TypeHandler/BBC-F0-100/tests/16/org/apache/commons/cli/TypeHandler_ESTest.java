...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("ZM;DW/.FhQR]9uWX$n");
      byte[] byteArray0 = new byte[4];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("ZM;DW/.FhQR]9uWX$n");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Sn)_gIP%>5acct");
      assertEquals("Sn)_gIP%>5acct", file0.getName());
  }
  ...
  public void test06()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("e2}!/gmG o!|Pgs!ca", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: e2}!/gmG o!|Pgs!ca
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject("NCHVY");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: NCHVY
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("#u*gV=Iyr,$ei6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: #u*gV=Iyr,$ei6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("/Sn)_gIP%>5acct", class0);
      assertNull(object0);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      try { 
        TypeHandler.createValue("*;!VE%xUThn_5L?", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: *;!VE%xUThn_5L?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("=9fDU):%D,urhS[Fs", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test34()  throws Throwable  {
      Class<Object> class0 = Object.class;
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      Object object1 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", (Object) ((PatternOptionBuilder) object0).STRING_VALUE);
      assertEquals("org.apache.commons.cli.PatternOptionBuilder", object1);
  }
}
