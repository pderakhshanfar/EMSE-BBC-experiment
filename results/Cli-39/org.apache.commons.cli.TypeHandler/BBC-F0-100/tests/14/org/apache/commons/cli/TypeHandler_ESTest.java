...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Zm,^(");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "org.apache.commons.cli.Option$1");
      File file0 = TypeHandler.createFile("Zm,^(");
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("'cr");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 'cr
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("._[J=+{W.M15");
