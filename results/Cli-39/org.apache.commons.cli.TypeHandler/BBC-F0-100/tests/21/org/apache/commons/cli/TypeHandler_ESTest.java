...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("._O7[nc1.T");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Rhx H");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("4hPk#{C.E^oS!c'/V5", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 4hPk#{C.E^oS!c'/V5
         //
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("0Y+");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 0Y+
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("'{7gPry=<=U<{", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test28()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("{R&'J=vA\"l-mi\"r", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: {R&'J=vA\"l-mi\"r
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("'{7gPry=<=U<{", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
