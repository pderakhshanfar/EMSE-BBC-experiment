...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".+[_`Ek(iOqXC07dxu");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/E4OanL!Dp?H)D");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile("/E4OanL!Dp?H)D");
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("2qE${J,jkseY>~r8=", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 2qE${J,jkseY>~r8=
         //
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("+>+<=|AlSU%$L5sri;");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: +>+<=|AlSU%$L5sri;
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("P)Us:X2@Q}Dlc");
