...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("V!!zk,cuc3", (Object) class0);
      assertEquals("V!!zk,cuc3", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/iS3");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "'");
      File file0 = TypeHandler.createFile("/iS3");
      assertEquals("iS3", file0.getName());
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".>_$zYoQXNu%tkDi");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("NTRFSX#]@0P", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: NTRFSX#]@0P
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("(\"Tui4m");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: (\"Tui4m
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("<Gs13L&dcSL(pUWDj/", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test21()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue(" &{_s#Ln<d]eyy+", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test25()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("}U>^ciLxb", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("!9<0TJQcQIy", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test27()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("F", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("V!!zk,cuc3");
        fail("Expecting exception: UnsupportedOperationException");
