...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      try { 
        TypeHandler.createObject("[D");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // java.lang.InstantiationException; Unable to create an instance of: [D
         //
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(":b%<~t.(");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, ":b%<~t.(");
      File file0 = TypeHandler.createFile(":b%<~t.(");
      assertFalse(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Jr");
      assertFalse(file0.canWrite());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/~ku\"?)aMDFK");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("(1", (Object) class0);
        fail("Expecting exception: Exception");
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("CnAY<y~#nm.U9");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"CnAY<y~#nm.U9\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("Either opt or longOpt must be specified");
