...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("p{'HgYL9*", (Object) class0);
      assertEquals("p{'HgYL9*", object0);
  }
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Ir]v`0B(}h`");
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("i*:7ij", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: i*:7ij
         //
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("", (Object) "R=)/M]pDTC&");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("x|tkw");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: x|tkw
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("p{'HgYL9*", class0);
      assertEquals("p{'HgYL9*", object0);
  }
  ...
  public void test21()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("p{'HgYL9*");
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createURL("EfjS]Y");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: EfjS]Y
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
