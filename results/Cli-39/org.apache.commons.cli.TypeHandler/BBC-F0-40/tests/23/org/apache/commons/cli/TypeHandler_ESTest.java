...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".75=>3z=");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("wMv,_h", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: wMv,_h
         //
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createNumber("42u.Ex_G-})VqUh");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"42u.Ex_G-})VqUh\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(" Zw`2*7?In$`c !", class0);
      assertNull(object0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(")2win&rDpwNQ\"5<l.a", class0);
      assertEquals(")2win&rDpwNQ\"5<l.a", object0);
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber("^zkt");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"^zkt\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("NrDp15/Yb {1RWW.44", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: NrDp15/Yb {1RWW.44
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("NrDp15/Yb {1|WW.44", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"NrDp15/Yb {1|WW.44\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue(")2win&rDpwNQ\"5<l.a", (Object) class0);
      assertEquals(")2win&rDpwNQ\"5<l.a", object0);
  }
  ...
  public void test27()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("NrDp15/Yb {1RWW.44", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: NrDp15/Yb {1RWW.44
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles(")2win&rDpwNQ\"5<l.a");
        fail("Expecting exception: UnsupportedOperationException");
