...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/w@(q ");
      assertEquals("w@(q ", file0.getName());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("p/jc)^t");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("p/jc)^t");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject("ds`EW");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ds`EW
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("8sW]#R:;x.]um03Yrs");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 8sW]#R:;x.]um03Yrs
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("17F=#OI52");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createURL("kRr!a']3,>^$0z%");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: kRr!a']3,>^$0z%
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("[</j!S<$LQdYy6h", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"[</j!S<$LQdYy6h\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("mbD$wtEl1Y", class0);
      assertEquals("mbD$wtEl1Y", object0);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      File file0 = TypeHandler.createFile(".=spwA;HJj~YiR>8-");
  ...
  public void test34()  throws Throwable  {
      Object object0 = TypeHandler.createValue("37}.b", (Object) null);
      assertNull(object0);
  }
}
