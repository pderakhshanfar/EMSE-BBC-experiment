...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("IM91k:fX40 =");
      byte[] byteArray0 = new byte[4];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("IM91k:fX40 =");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/P{G<6>{A6?vY");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("*8C[", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: *8C[
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(")5`}E-", (Object) ")5`}E-");
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("WU!=0ky3{pva-?", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: WU!=0ky3{pva-?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("u;)qh*", class0);
      assertNull(object0);
  }
  ...
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile(".1q}@ULK:;9BdT&vV");
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("ZYwu:uu[#353hR");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ZYwu:uu[#353hR
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("Jr1$*df\"03^/mF+Z<");
        fail("Expecting exception: UnsupportedOperationException");
