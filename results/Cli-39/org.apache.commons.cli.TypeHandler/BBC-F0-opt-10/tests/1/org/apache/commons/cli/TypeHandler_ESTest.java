...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("MzMk~i", (Object) class0);
      assertNull(object0);
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/eJ.F:'\"5IFfJH(bb");
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("-8d$z!*", (Object) "-8d$z!*");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject("6#$+6U4");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 6#$+6U4
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("q|8A/*W");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: q|8A/*W
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("]?4kQR`/");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"]?4kQR`/\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("6#$+6U4", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 6#$+6U4
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("6#$+6U4", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("+9", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("9", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test24()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("9", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
  ...
  public void test25()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("]?4kQR`/", class0);
      assertNull(object0);
  }
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("6#$+6U4", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"6#$+6U4\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      File file0 = TypeHandler.createFile(".j[v");
  ...
  public void test32()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("/eJ.F:'\"5IFfJH(bb");
        fail("Expecting exception: UnsupportedOperationException");
