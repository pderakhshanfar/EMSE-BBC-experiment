...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Object object0 = TypeHandler.createValue("Yf=", (Object) null);
      assertNull(object0);
  }
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/$2{-@(J5o.EZGfO");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(")Y]4fd8T[");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Unable to find the class: ");
      File file0 = TypeHandler.createFile(")Y]4fd8T[");
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("a>k} wNm#e]];|", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: a>k} wNm#e]];|
         //
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("; Unable to create an instance of: ", (Object) "org.apache.commons.cli.TypeHandler");
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("tv<zn{jI/n", class0);
      assertEquals("tv<zn{jI/n", object0);
  }
  ...
  public void test20()  throws Throwable  {
      File file0 = TypeHandler.createFile(".7:w;B0)@7s=;\"mO@q");
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createURL("gDX%%");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: gDX%%
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("DXWa}", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: DXWa}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("A@:.5gg", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("D`~j7`c=wdI#");
        fail("Expecting exception: UnsupportedOperationException");
