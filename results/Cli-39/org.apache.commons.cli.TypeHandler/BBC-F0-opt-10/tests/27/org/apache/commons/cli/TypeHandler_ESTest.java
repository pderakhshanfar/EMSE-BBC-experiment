...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(":*3=V)", (Object) class0);
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/axVF8");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createClass(".VR>-}");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .VR>-}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("]eb,YLvoT4}>*=QZ?", ((PatternOptionBuilder) object0).FILES_VALUE);
  ...
  public void test20()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("]eb,YLvoT4}>*=QZ?", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test21()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("]eb,YLvoT4}>*=QZ?", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ]eb,YLvoT4}>*=QZ?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("]eb,YLvoT4}>*=QZ?", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test25()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Z7lyB0T%5", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Z7lyB0T%5
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("\"eW=S'9-L+r");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test32()  throws Throwable  {
      Object object0 = TypeHandler.createValue("IEZk1N|]ArUM;WE", (Object) null);
      assertNull(object0);
  }
}
