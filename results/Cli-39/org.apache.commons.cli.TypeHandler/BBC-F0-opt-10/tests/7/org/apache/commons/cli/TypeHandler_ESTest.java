...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("J<slN9d0J Fsb^~yM", (Object) class0);
      assertEquals("J<slN9d0J Fsb^~yM", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("j{8n?nPC<!PQ-qfu");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("j{8n?nPC<!PQ-qfu");
      assertEquals(6L, file0.length());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/4lWbq");
      assertEquals("/4lWbq", file0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("b", (Object) class0);
        fail("Expecting exception: Exception");
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("\"e9H;# T*k!HHLkK", (Object) "\"e9H;# T*k!HHLkK");
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.createObject("j{8n?nPC<!PQ-qfu");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: j{8n?nPC<!PQ-qfu
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("n`_I#VL'C%xq8BHk?");
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("MwG6JGM_H5Q", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: MwG6JGM_H5Q
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("cnE@>{?hu)U0j}<.D", class0);
      assertEquals("cnE@>{?hu)U0j}<.D", object0);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      File file0 = TypeHandler.createFile(".7rB");
      assertEquals(0L, file0.length());
  }
