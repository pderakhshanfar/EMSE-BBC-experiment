...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("{RZzx};Ta457q,I5KX");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("{RZzx};Ta457q,I5KX");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/a.w_SS]1R7|d\"C");
      assertEquals("a.w_SS]1R7|d\"C", file0.getName());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("The option '", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: The option '
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("org.apache.commons.cli.TypeHandler", (Object) "I Fn.~hr,JpUS{i,<");
  ...
  public void test09()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("*BuMkw", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: *BuMkw
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Tw~\"Rq7X\"bw;'0qco", class0);
      assertNull(object0);
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("!_7|81`S5!e-*XGB`");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: !_7|81`S5!e-*XGB`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
