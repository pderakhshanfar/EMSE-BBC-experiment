...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".?oS<_zz~@f_$%,k");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/*LKm@vLYzg:N.dCki");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Z/!?*[y!_{j ");
      File file0 = TypeHandler.createFile("/*LKm@vLYzg:N.dCki");
      assertTrue(file0.canExecute());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("<!clT\"", object0);
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.createObject("tAFX=+~6muOx?g!");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: tAFX=+~6muOx?g!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("T@ qO.P6':A");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: T@ qO.P6':A
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(" ] [ long ", class0);
      assertNull(object0);
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("xtE|3Q3h!.A6yj%~Q");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"xtE|3Q3h!.A6yj%~Q\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("j7`", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: j7`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("+b4JfY");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: +b4JfY
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
