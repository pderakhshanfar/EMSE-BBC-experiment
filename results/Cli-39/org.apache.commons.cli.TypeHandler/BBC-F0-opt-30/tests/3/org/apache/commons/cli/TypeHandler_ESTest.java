...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".$sHs1 m3(aZb");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("qw<}`85");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("qw<}`85");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Nj(-^o4=%7", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Nj(-^o4=%7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      String string0 = "4WuTN\\uZ]F1r#|cK";
      // Undeclared exception!
      try { 
        TypeHandler.createValue(string0, (Object) string0);
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("gMn>/.0mh9", class0);
      assertEquals("gMn>/.0mh9", object0);
  }
  ...
  public void test17()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("K%(OEHt4Fl(");
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createURL("7q.?cg:");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 7q.?cg:
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("fgT=", class0);
      assertNull(object0);
  }
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("]'2:*Ec^*\"", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test27()  throws Throwable  {
      File file0 = TypeHandler.createFile("/>skax");
  ...
  public void test29()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("<(j+NY=u.[ye?", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: <(j+NY=u.[ye?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
