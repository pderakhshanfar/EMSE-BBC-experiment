...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".wH?-Ern-[");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("v OR&Y[%~nr8W");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Unable to parse the URL: ");
      File file0 = TypeHandler.createFile("v OR&Y[%~nr8W");
      assertEquals(0L, file0.getUsableSpace());
  }
  ...
  public void test06()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("QEG>EPw%'qEF", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: QEG>EPw%'qEF
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("&_~CNZd%m");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: &_~CNZd%m
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createNumber("[5TjZsy23L/.~n");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"[5TjZsy23L/.~n\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("cw:G,mHq]nu", class0);
      assertEquals("cw:G,mHq]nu", object0);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createObject("org.ahache.commons.cli.Option$1");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: org.ahache.commons.cli.Option$1
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile("/ea];\"");
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL(".wH?-Ern-[");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: .wH?-Ern-[
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("$TtGaGp;&Ej@+@g4\"gh");
        fail("Expecting exception: UnsupportedOperationException");
