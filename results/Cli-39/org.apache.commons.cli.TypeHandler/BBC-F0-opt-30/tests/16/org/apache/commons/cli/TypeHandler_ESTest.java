...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals("org.apache.commons.cli.PatternOptionBuilder", file0.getName());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("c@Tx2-29.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: c@Tx2-29.
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("Z.sN!@R|'Bf(yD8)");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"Z.sN!@R|'Bf(yD8)\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
