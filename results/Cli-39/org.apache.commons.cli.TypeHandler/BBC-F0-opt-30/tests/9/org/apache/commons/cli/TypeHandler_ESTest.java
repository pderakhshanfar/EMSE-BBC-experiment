...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Hjr(n=h&4oBl:5:09,");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "[UXMmpfuFohXP|j");
      File file0 = TypeHandler.createFile("Hjr(n=h&4oBl:5:09,");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".*Dk-P");
      assertFalse(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/bd<v5T/wnG");
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("=&IF[CMW!r[z", (Object) "=&IF[CMW!r[z");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject("9p~}_ Q|U-z|p0R6;[");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 9p~}_ Q|U-z|p0R6;[
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("B QA<AEjpX+k3");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: B QA<AEjpX+k3
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("7'UZf~w=Tq(t9KI%}K", class0);
      assertEquals("7'UZf~w=Tq(t9KI%}K", object0);
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.createURL("cWd^k:igVM6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: cWd^k:igVM6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("AXbysn");
        fail("Expecting exception: UnsupportedOperationException");
