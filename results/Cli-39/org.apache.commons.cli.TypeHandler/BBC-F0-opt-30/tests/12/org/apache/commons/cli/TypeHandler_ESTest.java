...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/)CESm;;P3`\"pH;7[ol");
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Unable to are the URL:", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Unable to are the URL:
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("t]|@aU5SN", class0);
      assertEquals("t]|@aU5SN", object0);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber("U4l}{.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"U4l}{.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("t]|@aU5SN", (Object) class0);
      assertEquals("t]|@aU5SN", object0);
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL("CrCO<`qOw");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: CrCO<`qOw
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
