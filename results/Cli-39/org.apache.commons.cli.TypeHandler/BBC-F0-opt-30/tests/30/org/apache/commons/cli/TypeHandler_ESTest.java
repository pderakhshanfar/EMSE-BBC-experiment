...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("O!u", (Object) class0);
      assertNull(object0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "tpP");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".|,WDfZ4K-d*&u");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject("IcK[jm?%P]+QFHstC5c");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: IcK[jm?%P]+QFHstC5c
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("2DVuQrp>8~\"g");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 2DVuQrp>8~\"g
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("f`8f1O,c,#G%qUb TA", ((PatternOptionBuilder) object0).FILES_VALUE);
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("e_C:", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: e_C:
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Unable to parse the URL: ", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test25()  throws Throwable  {
      Class<Integer> class0 = Integer.class;
      Object object0 = TypeHandler.createValue("has already been selected: '", class0);
      assertNull(object0);
  }
  ...
  public void test29()  throws Throwable  {
      try { 
        TypeHandler.createURL("wL$46pU=ieL~T*T");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: wL$46pU=ieL~T*T
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
