...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("4My", (Object) class0);
      assertEquals("4My", object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("A^7aR='twtH'");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, " :: ");
      File file0 = TypeHandler.createFile("A^7aR='twtH'");
      assertTrue(file0.canRead());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/.h:|=i!U");
  ...
  public void test08()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("i|<.1D7Kohx'[?x}>C^", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: i|<.1D7Kohx'[?x}>C^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("Kt>");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Kt>
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("A=/61b5j+Z/#3rV\".");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"A=/61b5j+Z/#3rV\".\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("Qmi*b}+QtnLJm}I");
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createValue("4a&yiN0-nx6&jYsk", (Object) null);
      assertNull(object0);
  }
}
