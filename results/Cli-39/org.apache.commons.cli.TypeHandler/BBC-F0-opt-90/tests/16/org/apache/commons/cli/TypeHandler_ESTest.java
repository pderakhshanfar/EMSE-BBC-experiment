...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("JUrG,|22");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "%F|qt*m'h3s?'rO");
      File file0 = TypeHandler.createFile("JUrG,|22");
      assertTrue(file0.exists());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/X\"Co");
      assertEquals("X\"Co", file0.getName());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("o=dgs.0D!B)k8x", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: o=dgs.0D!B)k8x
         //
  ...
  public void test08()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("#FXuL()_", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: #FXuL()_
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Y6@m$C");
  ...
  public void test21()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("JUrG,|22");
