...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".T5BwAoK[dy2");
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("s.+1h~K2jn-Dx4bB.)i", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: s.+1h~K2jn-Dx4bB.)i
         //
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Unable to parse the URL: ", (Object) "org.apache.commons.cli.PatternOptionBuilder");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject(".T5BwAoK[dy2");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .T5BwAoK[dy2
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("X(;lV[");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: X(;lV[
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createURL("kFU&}");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: kFU&}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Object object1 = TypeHandler.createValue("Unable to parse the URL: ", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
      assertEquals("Unable to parse the URL: ", object1.toString());
  }
  ...
  public void test27()  throws Throwable  {
      File file0 = TypeHandler.createFile("/D:!?`1PorB;$*FFiq");
      assertEquals(0L, file0.length());
  }
