...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("LT>LG=wh{4d[1ji:");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "The option '");
      File file0 = TypeHandler.createFile("LT>LG=wh{4d[1ji:");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".$GVln(; \"F3GEe 4");
  ...
  public void test16()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("LT>LG=wh{4d[1ji:");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test20()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("yIJxd'O=zqLVq", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: yIJxd'O=zqLVq
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Vgv^jq`{,", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
