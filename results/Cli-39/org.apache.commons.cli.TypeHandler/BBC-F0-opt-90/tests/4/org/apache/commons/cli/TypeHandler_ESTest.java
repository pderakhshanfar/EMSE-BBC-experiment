...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("..SUmnh|Z ");
      assertEquals(0L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Y5}\"!1#tpa$\"4op");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("A&b]aS^k>>'m053", object0);
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("4ZaDZ3mT+T4,");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 4ZaDZ3mT+T4,
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("7qA(q+");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 7qA(q+
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
