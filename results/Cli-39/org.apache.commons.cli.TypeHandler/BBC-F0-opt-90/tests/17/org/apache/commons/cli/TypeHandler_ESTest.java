...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("FrX%bka!f'/Za");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "FrX%bka!f'/Za");
      File file0 = TypeHandler.createFile("FrX%bka!f'/Za");
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("La~H(i]P9", (Object) "La~H(i]P9");
  ...
  public void test18()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("$H4Nn}s$7t7ikJ", class0);
      assertEquals("$H4Nn}s$7t7ikJ", object0);
  }
  ...
  public void test20()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Gme9%runwd");
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createURL("r9PCuKcYYJg-");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: r9PCuKcYYJg-
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
