...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("S:{R#wR+.Y", (Object) class0);
      assertEquals("S:{R#wR+.Y", object0);
  }
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/sdG>7p8B");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("xQ^v*{s].d)]RT/9");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Unable to parse the URL: ");
      File file0 = TypeHandler.createFile("xQ^v*{s].d)]RT/9");
  ...
  public void test07()  throws Throwable  {
      try { 
        TypeHandler.createObject("Gm*]*eb*%\u0007{[jC?");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Gm*]*eb*%\u0007{[jC?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("6TM.L*/.<^", class0);
      assertNull(object0);
  }
  ...
  public void test18()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("S:{R#wR+.Y", class0);
      assertEquals("S:{R#wR+.Y", object0);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      File file0 = TypeHandler.createFile("6TM.L*/.<^");
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("LD{B_c</_~Y]VtMYU0");
        fail("Expecting exception: UnsupportedOperationException");
