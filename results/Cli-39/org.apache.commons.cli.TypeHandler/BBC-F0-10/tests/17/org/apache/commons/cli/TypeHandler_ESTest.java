...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Object object0 = TypeHandler.createValue(",^$nd^M5F7@", (Object) null);
      assertNull(object0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "3h>2LdHS6@-Pw{LdQus");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/LX2<Nte1Iq+F16U8");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject("80");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 80
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("f2J]}pDU5>$CuwwL");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: f2J]}pDU5>$CuwwL
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("7/pH5]zo%E^72VT(V");
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createNumber("Z.1Z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"Z.1Z\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("3h>2LdHS6@-Pw{LdQus", class0);
      assertNull(object0);
  }
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("5>/Z}3_M4*.z", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 5>/Z}3_M4*.z
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("QC&5&\"C", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"QC&5&\"C\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("yEnvI}rn*N~b6JJ+", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: yEnvI}rn*N~b6JJ+
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test34()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("?M7tG|0U", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ?M7tG|0U
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
