...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Pt53i", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Pt53i
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("Pt53i", class0);
      assertEquals("Pt53i", object0);
  }
  ...
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile(".q7U=w\"L{9%");
      assertFalse(file0.isAbsolute());
  }
