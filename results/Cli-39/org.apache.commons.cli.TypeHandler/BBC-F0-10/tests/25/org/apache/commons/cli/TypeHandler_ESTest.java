...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".6v=*XV;");
      assertEquals(".6v=*XV;", file0.getName());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("{0GY@nuuh UF.", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: {0GY@nuuh UF.
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createClass(" .#)dlLOaU#;g");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class:  .#)dlLOaU#;g
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("(xJ:Y*xFy%A]\"", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: (xJ:Y*xFy%A]\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("`Kp)?", class0);
      assertEquals("`Kp)?", object0);
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      File file0 = TypeHandler.createFile("/KjfK_97i3.Ai`_/");
