...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("%d;tD+KExHodD<Cy]J+");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "BU");
      File file0 = TypeHandler.createFile("%d;tD+KExHodD<Cy]J+");
      assertTrue(file0.canExecute());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".IiK");
      assertEquals(0L, file0.getUsableSpace());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/:v9");
  ...
  public void test08()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("org.apache.coImons.cli.TypeHandler", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: org.apache.coImons.cli.TypeHandler
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("\"fB}Mt%Y(U@ui", (Object) "\"fB}Mt%Y(U@ui");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("m[tP})7Fr&Af=?+");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: m[tP})7Fr&Af=?+
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("!gb<4#X@oSny1rcLOR", class0);
      assertEquals("!gb<4#X@oSny1rcLOR", object0);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createObject("!^xC+-X/jd;8JtX:<m");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: !^xC+-X/jd;8JtX:<m
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("Gv6J]BTJ<%-0_", (Object) class0);
      assertEquals("Gv6J]BTJ<%-0_", object0);
  }
