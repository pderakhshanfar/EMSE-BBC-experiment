...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("/mH~6qES");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".wQwO<V=X>T)");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "NO_ARGS_ALLOWED");
      File file0 = TypeHandler.createFile(".wQwO<V=X>T)");
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.createObject("UpI:PY1bFO)nOZ:j< ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: UpI:PY1bFO)nOZ:j< 
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("EB~#cm", class0);
      assertNull(object0);
  }
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("1YHEn@(k{b8[V", class0);
      assertEquals("1YHEn@(k{b8[V", object0);
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("a<5VM^4&n");
        fail("Expecting exception: UnsupportedOperationException");
