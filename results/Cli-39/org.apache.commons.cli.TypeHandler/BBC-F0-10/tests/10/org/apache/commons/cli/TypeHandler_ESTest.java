...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("<9!pDV9PI", (Object) class0);
      assertEquals("<9!pDV9PI", object0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/`u)aP^1,/PCL{");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "q=w8#D");
      File file0 = TypeHandler.createFile("/`u)aP^1,/PCL{");
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("e*7mUlEgD?Y");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: e*7mUlEgD?Y
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createObject("oG|xi,&");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: oG|xi,&
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile(".8Y>J");
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("S*Xm&PcmiJf{Is2");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: S*Xm&PcmiJf{Is2
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
