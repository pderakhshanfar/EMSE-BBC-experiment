...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ";;&FuBgD;");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/.(,c,[,Da-'oBT> B");
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createURL("n^ug-.>rM(S|");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: n^ug-.>rM(S|
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
