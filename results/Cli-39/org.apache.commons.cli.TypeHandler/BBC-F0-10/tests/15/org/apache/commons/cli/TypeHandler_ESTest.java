...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".OV5:E$:g-PpB`c");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/3>g<a!:Sb!CAZ");
      assertEquals("3>g<a!:Sb!CAZ", file0.getName());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("$cqmEh~}m!,; ");
      byte[] byteArray0 = new byte[4];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("$cqmEh~}m!,; ");
      assertEquals("$cqmEh~}m!,; ", file0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("D$O>9/Vmo\"j", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: D$O>9/Vmo\"j
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Uevz}#Y{#<", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Uevz}#Y{#<
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("E'gU_o98Y=b");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: E'gU_o98Y=b
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("0bI}!:lJ Ol48ik-;S]", class0);
      assertEquals("0bI}!:lJ Ol48ik-;S]", object0);
  }
