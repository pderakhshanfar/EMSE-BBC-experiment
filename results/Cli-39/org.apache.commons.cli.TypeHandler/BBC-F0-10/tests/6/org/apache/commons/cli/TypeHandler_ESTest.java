...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("}02=", (Object) class0);
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Mg~n,");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("&fkU,8Zue':c/h");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("&fkU,8Zue':c/h");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("CCVl<D9Vk", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: CCVl<D9Vk
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createClass("8}QbOd;jUJt@TgM");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 8}QbOd;jUJt@TgM
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("g.d)rlc%0G)>");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"g.d)rlc%0G)>\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("CCVl<D9Vk", class0);
      assertEquals("CCVl<D9Vk", object0);
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile(".S:F\u0005a}ByjJ5}][I");
      assertFalse(file0.isDirectory());
  }
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("aAXIHd&?Xpi6&");
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("XutXA[J[b}:6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: XutXA[J[b}:6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
