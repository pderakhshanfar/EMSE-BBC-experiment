...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      File file0 = TypeHandler.createFile(".,(=L}Cb'66w2");
  ...
  public void test03()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "J.[`qB|8/");
      File file0 = TypeHandler.createFile("");
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber("y/).?qpdz:jqY");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"y/).?qpdz:jqY\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("DSoEL}julX", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"DSoEL}julX\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("|RMY'aenMW^@s*P&fS5", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: |RMY'aenMW^@s*P&fS5
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile("/}AnPI?LPw4=`)X");
