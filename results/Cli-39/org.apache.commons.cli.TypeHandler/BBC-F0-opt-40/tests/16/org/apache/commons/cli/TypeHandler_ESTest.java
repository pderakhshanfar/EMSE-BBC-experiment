...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("&Zt1lWJUT8y");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ">");
      File file0 = TypeHandler.createFile("&Zt1lWJUT8y");
      assertEquals(2L, file0.length());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".eB}U}>;,");
      assertEquals(".eB}U}>;,", file0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/ht4Fw$FuAj$e4Zs~;");
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("4}1oUXhvOm!# $l");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 4}1oUXhvOm!# $l
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("s>VR7w0P)f}", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("7:xBHPT", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test25()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("s>VR7w0P)f}", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"s>VR7w0P)f}\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("wy5KNDBIf]E :h", class0);
      assertEquals("wy5KNDBIf]E :h", object0);
  }
  ...
  public void test28()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("s>VR7w0P)f}", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: s>VR7w0P)f}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("s>VR7w0P)f}", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: s>VR7w0P)f}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
