...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object1 = TypeHandler.createValue("% 0wfr$=", (Object) ((PatternOptionBuilder) object0).STRING_VALUE);
      assertEquals("% 0wfr$=", object1);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals("org.apache.commons.cli.ParseException", file0.getName());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".x|Y+5");
  ...
  public void test06()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("w3YjVTT8?PFL/i&Gw1", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: w3YjVTT8?PFL/i&Gw1
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("FZ>T1", (Object) "FZ>T1");
  ...
  public void test14()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("va2v{L./>u'J9o{", class0);
      assertNull(object0);
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createURL("(,Q]3z)R");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: (,Q]3z)R
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      try { 
        TypeHandler.createValue("% 0wfr$=", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: % 0wfr$=
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<Object> class0 = Object.class;
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("The option '", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test25()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      try { 
        TypeHandler.createValue("V$N%m", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: V$N%m
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
