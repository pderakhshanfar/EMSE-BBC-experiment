...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".]a)HS7P");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/lg+5:W8lNMBs<s6:");
      assertFalse(file0.canRead());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(">]|;(O'>5uz");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "yA1qbkP~~ZL?&dh_iR");
      File file0 = TypeHandler.createFile(">]|;(O'>5uz");
      assertEquals(">]|;(O'>5uz", file0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(")S'5Z", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: )S'5Z
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Not yet implemented", object0);
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("j2S.f)Z;l", class0);
      assertNull(object0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("b F3c0yU~zSAF$", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: b F3c0yU~zSAF$
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("F75,", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("{G)wI<$wG^E`-Z(r/", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: {G)wI<$wG^E`-Z(r/
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.createURL("0R+ d}h?[6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 0R+ d}h?[6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("%%y{(b9mISn+`kU");
        fail("Expecting exception: UnsupportedOperationException");
