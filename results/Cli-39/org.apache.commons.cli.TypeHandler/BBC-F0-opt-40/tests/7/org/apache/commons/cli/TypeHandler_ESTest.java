...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("&/h}>%>?4n'0<G^", (Object) class0);
      assertEquals("&/h}>%>?4n'0<G^", object0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("j/.z^J@6kL8ID1l=QS");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "gx)d");
      File file0 = TypeHandler.createFile("j/.z^J@6kL8ID1l=QS");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("/N@q=");
      assertFalse(file0.isDirectory());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Mv=C-TM/)=GHK1<i", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Mv=C-TM/)=GHK1<i
         //
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createNumber("=J.[\"z(4$fV:1[9ZN2,");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"=J.[\"z(4$fV:1[9ZN2,\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createURL("Qz7N");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: Qz7N
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      Object object1 = TypeHandler.createValue("' was specified but an option from this group ", ((PatternOptionBuilder) object0).STRING_VALUE);
      assertEquals("' was specified but an option from this group ", object1);
  }
