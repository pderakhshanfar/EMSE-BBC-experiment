...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      File file0 = TypeHandler.createFile(".4M*7$@eq");
      assertEquals(".4M*7$@eq", file0.getName());
  }
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/%7D }B$%WqR#=MxG>a");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/%7D }B$%WqR#=MxG>a");
  ...
  public void test07()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("org.apache.commons.cli.ParseException", (Object) "-z");
  ...
  public void test08()  throws Throwable  {
      try { 
        TypeHandler.createObject("go/D3)Kne#bKF'");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: go/D3)Kne#bKF'
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createClass("hGP?i8");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: hGP?i8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("2-+WYGSdD#FQrb2iD", class0);
      assertEquals("2-+WYGSdD#FQrb2iD", object0);
  }
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("[_XoJXdC", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"[_XoJXdC\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createURL("E <b6o`d'_4ikmo'g");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: E <b6o`d'_4ikmo'g
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
