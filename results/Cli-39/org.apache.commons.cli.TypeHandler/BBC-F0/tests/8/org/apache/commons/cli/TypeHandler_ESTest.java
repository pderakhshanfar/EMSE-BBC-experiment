...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("}[`ZrR3~<QpW\"3RoMV_", (Object) class0);
      assertEquals("}[`ZrR3~<QpW\"3RoMV_", object0);
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".\"pVau");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("uB{8");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("uB{8");
      assertEquals("uB{8", file0.getName());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("/E)r'OTq");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("i`V&:PtiGA\"cm+G7/", object0);
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("yy5$>}!");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: yy5$>}!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("E}cFWOZz&&Oq4", class0);
      assertNull(object0);
  }
  ...
  public void test19()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("JavS_", class0);
      assertEquals("JavS_", object0);
  }
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("!rZ-lT", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: !rZ-lT
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
