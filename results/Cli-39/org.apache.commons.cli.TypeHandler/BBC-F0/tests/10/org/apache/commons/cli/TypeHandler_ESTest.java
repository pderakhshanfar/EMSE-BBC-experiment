...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("dm:M9g8>:", (Object) class0);
      assertEquals("dm:M9g8>:", object0);
  }
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/J8O>c<?O^k9Wu.W>");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/J8O>c<?O^k9Wu.W>");
      assertEquals("/J8O>c<?O^k9Wu.W>", file0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("0bf]b6X,#", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 0bf]b6X,#
         //
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("KVa>X*");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: KVa>X*
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("xdN+n\"4^$4FiR8");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createURL(")/^|yzBEUx6C");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: )/^|yzBEUx6C
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("QL8NVLTO?O5", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test23()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      try { 
        TypeHandler.createValue("/Vt`", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /Vt`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      Class<Object> class0 = Object.class;
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      Object object1 = TypeHandler.createValue("C;_+0oP<0", ((PatternOptionBuilder) object0).STRING_VALUE);
      assertEquals("C;_+0oP<0", object1);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      File file0 = TypeHandler.createFile(".TTV(#=yt}");
  ...
  public void test30()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("cTk)t", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
