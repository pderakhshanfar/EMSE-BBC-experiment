...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(".qd*Ad]?JzRvd", (Object) class0);
      assertEquals(".qd*Ad]?JzRvd", object0);
  }
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("9,bv(S");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("9,bv(S");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("qd*Ad]?JzRvd", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: qd*Ad]?JzRvd
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("O8yu3{J]-\"+_ZGd4", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: O8yu3{J]-\"+_ZGd4
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("(&8[N 5ff'");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: (&8[N 5ff'
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("qd*Ad]zRvd", class0);
      assertNull(object0);
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile(".qd*Ad]?JzRvd");
