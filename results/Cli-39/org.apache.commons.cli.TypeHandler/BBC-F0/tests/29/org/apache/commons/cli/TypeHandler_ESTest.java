...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".~(*cbDA");
      byte[] byteArray0 = new byte[4];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(".~(*cbDA");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("rEp#eLb%^&2A", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: rEp#eLb%^&2A
         //
  ...
  public void test07()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("//AvR}pO1e=", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: //AvR}pO1e=
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("'`%N6\"L~M[&@5#");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: '`%N6\"L~M[&@5#
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("rEp#eLb%^&2A", class0);
      assertNull(object0);
  }
  ...
  public void test20()  throws Throwable  {
      File file0 = TypeHandler.createFile("//AvR}pO1e=");
