...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(")ot0yet implemented");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(")ot0yet implemented");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/,YLpGm9!KOi$=");
      assertTrue(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".IU,|");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("U9db5:TG.fg^Bm", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: U9db5:TG.fg^Bm
         //
  ...
  public void test08()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("%I`O-G4&Wt", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: %I`O-G4&Wt
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("1x6;oMdW*");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 1x6;oMdW*
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber("\u0002zj.j#4");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"zj.j#4\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("8n;-p", class0);
      assertEquals("8n;-p", object0);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("P>Ah,V) Y}", (Object) typeHandler0);
