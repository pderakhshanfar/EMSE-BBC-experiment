...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(">P,89}%x9'BV");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(">P,89}%x9'BV");
      assertTrue(file0.canExecute());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".{[n8adIeymde");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/E5g ");
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("_O fJ&D+g?b", (Object) "_O fJ&D+g?b");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject("e-2YUh6AFP!\"ocC]k[h");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: e-2YUh6AFP!\"ocC]k[h
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("KaX7v2vWx];");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: KaX7v2vWx];
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("ML.2w|4H*AoM7; SmT");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"ML.2w|4H*AoM7; SmT\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("KaX7v2vWx];", class0);
      assertEquals("KaX7v2vWx];", object0);
  }
  ...
  public void test18()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("/DZWm/auh!kuP8");
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createURL("JXA`p\"dksw?=}yO@#D");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: JXA`p\"dksw?=}yO@#D
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("uuE", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test31()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("u]MM", (Object) class0);
      assertEquals("u]MM", object0);
  }
}
