...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("y4BM;Hut!");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "; Unable to create an instance of: ");
      File file0 = TypeHandler.createFile("y4BM;Hut!");
      assertEquals(1392409281320L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/FL eq;bsh8e");
      assertEquals("FL eq;bsh8e", file0.getName());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("BM%H;QV=eZqu]4W^", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: BM%H;QV=eZqu]4W^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("y4BM;Hut!", (Object) file0);
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("rhD:S");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"rhD:S\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("+3mW:B84p", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"+3mW:B84p\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile(".8[b1t=j3hqJooj,6~");
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("rR>aiD]~,,-UB$c!n");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: rR>aiD]~,,-UB$c!n
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
