...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("C,Uf5T%O%nT^+x", (Object) class0);
      assertEquals("C,Uf5T%O%nT^+x", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("7gU:[P2K9");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "LTi7SB)7;3mE!1oR]/d");
      File file0 = TypeHandler.createFile("7gU:[P2K9");
      assertEquals(0L, file0.getFreeSpace());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("._[HzgjB%y^");
      assertEquals(0L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/&[$Um3'|@");
  ...
  public void test07()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("z3CVk({CU$D", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: z3CVk({CU$D
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createNumber("._[HzgjB%y^");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"._[HzgjB%y^\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("BVjC-Z:IYDRME-^7", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: BVjC-Z:IYDRME-^7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
