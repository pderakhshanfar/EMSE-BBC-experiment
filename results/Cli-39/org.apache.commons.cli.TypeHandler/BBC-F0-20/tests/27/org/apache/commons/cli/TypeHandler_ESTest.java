...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("_DZ6)NCYr1", (Object) class0);
      assertEquals("_DZ6)NCYr1", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("org.apache.commons.cli.ParseException");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "t5Gg");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("&sYI{4qp|CR/.87*+");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("9aG 6u7[?", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 9aG 6u7[?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("", (Object) "-H^rwH{QRA");
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("JmN2U3?.XdX", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: JmN2U3?.XdX
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Y&uv", class0);
      assertNull(object0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("_DZ6)NCYr1", class0);
      assertEquals("_DZ6)NCYr1", object0);
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("|!%GBf]Xt0=I=2");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: |!%GBf]Xt0=I=2
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("_DZ6)NCYr1");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createClass("<DC0/\"*9nG a6%LVbp");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: <DC0/\"*9nG a6%LVbp
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
