...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Vz,kMHpppFBjJgPk'4", (Object) class0);
      assertEquals("Vz,kMHpppFBjJgPk'4", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".C_Ys");
      assertEquals(0L, file0.getUsableSpace());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/<o dA|9wj2");
  ...
  public void test05()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("1_", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 1_
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("g\"DAn8\u0006S3wDF+n*", (Object) "g\"DAn8\u0006S3wDF+n*");
  ...
  public void test07()  throws Throwable  {
      try { 
        TypeHandler.createObject("/<o dA|9wj2");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /<o dA|9wj2
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("eXiHy50(`$X");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createURL("Vz,kMHpppFBjJgPk'4");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: Vz,kMHpppFBjJgPk'4
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue(".:!uA,J<q>aw\"hO) ", class0);
      assertEquals(".:!uA,J<q>aw\"hO) ", object0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("6`=v\"8qH7FfZRXZ", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("P(4(", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
