...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("=$@!qinjCFV<W,zC`H`", (Object) "K;K+Gc0i>9SuMnZ9!Av");
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("!COl.%4yJJ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: !COl.%4yJJ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createNumber("ve(.*[|U;T#b{9 @#G");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"ve(.*[|U;T#b{9 @#G\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("jvSO^qC}-,HL");
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createURL("IX`ugf@bi4l!");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: IX`ugf@bi4l!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue(")Z7t1Q3?p,Bq", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue(")Z7t1Q3?p,Bq", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test25()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("%Ns$]'N", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: %Ns$]'N
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      File file0 = TypeHandler.createFile("/ATi*s");
      assertEquals("ATi*s", file0.getName());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("xU", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
