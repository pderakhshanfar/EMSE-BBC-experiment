...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("&H%]3$", (Object) class0);
      assertEquals("&H%]3$", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".p>YR@,");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/d^>4o87.yq");
      assertEquals(0L, file0.getUsableSpace());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "\"zg+Juo2Vrqtk?qk80");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("H 0Dh [p(fy#fq'wKf{", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: H 0Dh [p(fy#fq'wKf{
         //
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("8+Wz%5KV8#K$E&r");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 8+Wz%5KV8#K$E&r
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createNumber("JiS.LD#}r_2ALe1G{");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"JiS.LD#}r_2ALe1G{\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("VaC-C>WLicVVx", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("i", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
  ...
  public void test25()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("&H%]3$", class0);
      assertEquals("&H%]3$", object0);
  }
