...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("6'f2Y?QTRu0|r,1", (Object) class0);
      assertEquals("6'f2Y?QTRu0|r,1", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".^A:_qg~g?{Yjc^NC");
  ...
  public void test06()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(";|yx-1Gf\"OV)E%Y_)r!", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ;|yx-1Gf\"OV)E%Y_)r!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue(".^A:_qg~g?{Yjc^NC", (Object) ".^A:_qg~g?{Yjc^NC");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject("/hsa.eGDk/Su");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /hsa.eGDk/Su
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("I+!Ox1G.~");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"I+!Ox1G.~\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("V>Dobo2V5Ctn`)FLr4B");
  ...
  public void test21()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("q(s+dzN*@I7dotr", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test25()  throws Throwable  {
      File file0 = TypeHandler.createFile("/hsa.eGDk/Su");
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("V>Dobo2V5Ctn`)FLr4B", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test31()  throws Throwable  {
      Object object0 = TypeHandler.createValue("/hsa.eGDk/Su", (Object) null);
      assertNull(object0);
  }
}
