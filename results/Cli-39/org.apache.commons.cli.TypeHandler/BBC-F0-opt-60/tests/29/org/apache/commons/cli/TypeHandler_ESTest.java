...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/BO*U");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("9ngj8_k", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 9ngj8_k
         //
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("#lMI'ovu?ms~");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: #lMI'ovu?ms~
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("9ngj8_k", class0);
      assertEquals("9ngj8_k", object0);
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("8CfdB\"]R px5~%");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 8CfdB\"]R px5~%
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("ywBOAsXa(+T}");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test27()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("fe*3mW+*", (Object) class0);
      assertEquals("fe*3mW+*", object0);
  }
}
