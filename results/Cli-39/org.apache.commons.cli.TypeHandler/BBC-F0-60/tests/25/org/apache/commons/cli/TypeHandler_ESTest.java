...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("L0NRGma~= icMDwaB", (Object) class0);
      assertEquals("L0NRGma~= icMDwaB", object0);
  }
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("vS");
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("vS");
      assertEquals("vS", file0.toString());
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/FA}mCMP`");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Hb", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Hb
         //
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.createObject("Ck\"H&9jevm&");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Ck\"H&9jevm&
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("vpSp7aO}", class0);
      assertNull(object0);
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("~R.>S5>g`Z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"~R.>S5>g`Z\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createURL(",o=Z}W");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ,o=Z}W
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
