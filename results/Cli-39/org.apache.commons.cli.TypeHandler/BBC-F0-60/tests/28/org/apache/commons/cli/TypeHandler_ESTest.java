...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("$+NYPz@IWXPTXE");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("$+NYPz@IWXPTXE");
      assertEquals("$+NYPz@IWXPTXE", file0.getName());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/8Vte#M7X`c~'");
  ...
  public void test09()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("{)C`w*+nz&S", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: {)C`w*+nz&S
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("7", class0);
      assertNull(object0);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("SF\"5*Vv", class0);
      assertEquals("SF\"5*Vv", object0);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile(".2&mR,qW41x>7H~+)");
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL(";?g/kx[HTol8");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ;?g/kx[HTol8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("*,]iN'pgZvS`h5o+h");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createClass("8D7@69{$.?!`CxR");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 8D7@69{$.?!`CxR
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
