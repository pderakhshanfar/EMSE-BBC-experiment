...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("gs.isk^p^", class0);
      assertEquals("gs.isk^p^", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("3ZPp/.Sik*d");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "(V1T4kUd3?_]Jvu_/e");
      File file0 = TypeHandler.createFile("3ZPp/.Sik*d");
      assertEquals(".Sik*d", file0.getName());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("gs.isk^p^", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: gs.isk^p^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("PPZ.E8HBY!", (Object) "PPZ.E8HBY!");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("VmS%k;|");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: VmS%k;|
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile("/S{[WRe");
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("/S{[WRe");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: /S{[WRe
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
