...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/|_%5s%tkoKCXe Zs");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "D4");
      File file0 = TypeHandler.createFile("/|_%5s%tkoKCXe Zs");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Dn):\"X\"xnk");
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("mK%T2q", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: mK%T2q
         //
  ...
  public void test19()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("=Nf'r;bz[+bAKO|^]:", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("jA/Lmp,jyb&", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: jA/Lmp,jyb&
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("m\"", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("c*l/R", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("g^ex)E.V4");
        fail("Expecting exception: UnsupportedOperationException");
