...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("}t{Ag)rLcrnZI{kp%&6");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "q?3Lassm,ZdohraT");
      File file0 = TypeHandler.createFile("}t{Ag)rLcrnZI{kp%&6");
      assertEquals("}t{Ag)rLcrnZI{kp%&6", file0.getName());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".u3_`2dl9o#UqmcIMO");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("D2zgI$MhE.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"D2zgI$MhE.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(",w%1al^Bs0:{\"Kg", class0);
      assertEquals(",w%1al^Bs0:{\"Kg", object0);
  }
