...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Zb9LmG");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Zb9LmG");
      File file0 = TypeHandler.createFile("Zb9LmG");
      assertEquals("Zb9LmG", file0.getName());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".x%E");
      assertEquals(".x%E", file0.getName());
  }
  ...
  public void test08()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("D.^_KzTef", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: D.^_KzTef
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("DyCfljHpQIQ=C;");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: DyCfljHpQIQ=C;
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("6jp.Y_@'R'Pjmi3u7_");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"6jp.Y_@'R'Pjmi3u7_\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      Number number0 = TypeHandler.createNumber("46");
  ...
  public void test18()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("l<K<~G|#b<g?^c4", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: l<K<~G|#b<g?^c4
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile("/[D,N(Zid;s!e$<BP");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("vz{G?!6tQ0");
        fail("Expecting exception: UnsupportedOperationException");
