...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Object object0 = TypeHandler.createValue("T@@c(_]6err(", (Object) null);
      assertNull(object0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = TypeHandler.createFile(".vr/");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("QD3D#bL.?,%thcwR>tU", (Object) "QD3D#bL.?,%thcwR>tU");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("e1dvl&}\"[");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: e1dvl&}\"[
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber("+T\"ZaK,.~");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"+T\"ZaK,.~\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("C+#1*=", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("6is");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 6is
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("{quEnE:}Gf");
        fail("Expecting exception: UnsupportedOperationException");
