...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/JzYZUASo-gB8f");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("V)x");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "46a)c.lBX?A:l4)o");
      File file0 = TypeHandler.createFile("V)x");
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createURL("P+n[jz5>N@A'");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: P+n[jz5>N@A'
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("$Hw/,Fc@&I*>Mh", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
