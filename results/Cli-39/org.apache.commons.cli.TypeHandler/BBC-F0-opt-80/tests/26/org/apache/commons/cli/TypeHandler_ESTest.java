...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/ZI8P{`");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "/ZI8P{`");
      File file0 = TypeHandler.createFile("/ZI8P{`");
      assertEquals("ZI8P{`", file0.getName());
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("wjz*7S&.U2V*;ej_._");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"wjz*7S&.U2V*;ej_._\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      File file0 = TypeHandler.createFile("r:/.kG@7q[,\"jA4");
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createURL("~-]RZm[k,q0fctM");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ~-]RZm[k,q0fctM
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
