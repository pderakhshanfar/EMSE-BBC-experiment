...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Object object0 = TypeHandler.createValue("Not yet implem)nted", (Object) null);
      assertNull(object0);
  }
  ...
  public void test03()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue(".vwW", class0);
      assertEquals(".vwW", object0);
  }
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createObject("dM_Uy^*");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: dM_Uy^*
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("[ Options: [ short ", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"[ Options: [ short \"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile(".vwW");
      assertEquals(".vwW", file0.getName());
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.createClass("9M}E^g");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 9M}E^g
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("GO4bls{4dUmWZKh", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: GO4bls{4dUmWZKh
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
