...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      File file0 = TypeHandler.createFile(".6r>0B");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/*p\"vS LcZ;");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("'yl D*u x@|u^IwTY");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, " ]");
      File file0 = TypeHandler.createFile("'yl D*u x@|u^IwTY");
      assertEquals(0L, file0.getFreeSpace());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("uvts~o'$5fZ", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: uvts~o'$5fZ
         //
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Unable to parse the URL: ", (Object) "h`w&Vn");
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("`_3");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: `_3
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("uvts~o'$5fZ", class0);
      assertNull(object0);
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("a2fw87O=UGGL'umt.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"a2fw87O=UGGL'umt.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("(hs<~deg", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: (hs<~deg
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("G,1$\"P}p,", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("lqkw9t)`[b", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"lqkw9t)`[b\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
