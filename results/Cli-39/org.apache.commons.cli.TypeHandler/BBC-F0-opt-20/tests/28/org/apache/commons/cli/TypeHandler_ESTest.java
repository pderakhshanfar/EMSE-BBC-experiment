...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("fGBMuJ)TD%_`p");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Mq|/7I~mhkY");
      File file0 = TypeHandler.createFile("fGBMuJ)TD%_`p");
      assertEquals("fGBMuJ)TD%_`p", file0.getName());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".BxqS");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("yrD", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: yrD
         //
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("rR'xFG%7/", (Object) "rR'xFG%7/");
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("ieI-O\"cJ", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ieI-O\"cJ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("A[B\" 17p");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: A[B\" 17p
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("rR'xFG%7/", class0);
      assertEquals("rR'xFG%7/", object0);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Dv~NlachU8KyI");
      assertEquals(0L, file0.length());
  }
