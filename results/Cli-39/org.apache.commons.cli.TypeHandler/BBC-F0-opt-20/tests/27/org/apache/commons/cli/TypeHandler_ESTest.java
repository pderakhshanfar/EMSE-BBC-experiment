...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("nbJ", (Object) class0);
      assertEquals("nbJ", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue(".$()a|)X;{V>?iRax\"", class0);
      assertEquals(".$()a|)X;{V>?iRax\"", object0);
  }
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/oJBc0+d;B/!cO");
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/oJBc0+d;B/!cO");
      assertEquals(5L, file0.length());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".$()a|)X;{V>?iRax\"");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("1v%#P|RJGgW=Su,d\"", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 1v%#P|RJGgW=Su,d\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("0tQ.d_0nJ JVX++cB]X", (Object) "0tQ.d_0nJ JVX++cB]X");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass(".W=2'#B3nh");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .W=2'#B3nh
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("z~H)5hR5z<<eVl!#s=m", class0);
      assertNull(object0);
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("(vI13.PZ,<dbA6(o");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"(vI13.PZ,<dbA6(o\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
