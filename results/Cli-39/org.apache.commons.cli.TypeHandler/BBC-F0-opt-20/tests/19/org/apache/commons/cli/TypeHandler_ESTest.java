...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Object object0 = TypeHandler.createValue("59j<", (Object) null);
      assertNull(object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".<J6Mu");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/2DN<I7/=UJjEUd0Rw");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("~@;rXhn,DS/{~z;");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "; Unable to create an instance of: ");
      File file0 = TypeHandler.createFile("~@;rXhn,DS/{~z;");
      assertEquals("~@;rXhn,DS/{~z;", file0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("FB$Tq2r[1h!oK`_\"6E");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: FB$Tq2r[1h!oK`_\"6E
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("vNYhy4?X");
  ...
  public void test17()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("L%q<dK}rwd]o{(");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createURL("W8zI@x%a7N");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: W8zI@x%a7N
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("/1.6`cOq4");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"/1.6`cOq4\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("]Ptl&+C,/NK8T2lmF", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"]Ptl&+C,/NK8T2lmF\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue(",ItVBT=*oEnc^", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("m&", (Object) "1t1zRvt-#lP{#i^s`");
