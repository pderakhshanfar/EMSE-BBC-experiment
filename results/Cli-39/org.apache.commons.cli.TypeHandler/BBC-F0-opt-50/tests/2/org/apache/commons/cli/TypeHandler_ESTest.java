...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      File file0 = TypeHandler.createFile(".b>4YyhJXTq");
      assertEquals(0L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("/=(i|*d:b\"G^uQ</");
  ...
  public void test05()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("${dmias7", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ${dmias7
         //
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("AX$j na+hH7:H^gl");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: AX$j na+hH7:H^gl
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("&F>]}VEaq4s')-Kg", class0);
      assertNull(object0);
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createURL("}R(");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: }R(
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("FF]NPz646/@xWd$D{\"D", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("&[Tto5Ow/VR", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test27()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      try { 
        TypeHandler.createValue("FF]NPz646/@xWd$D{\"D", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: FF]NPz646/@xWd$D{\"D
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
