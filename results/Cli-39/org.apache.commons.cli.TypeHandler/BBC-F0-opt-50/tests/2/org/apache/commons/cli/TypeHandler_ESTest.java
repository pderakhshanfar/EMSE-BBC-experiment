...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Object object0 = TypeHandler.createValue(";%ni)\"AL", (Object) null);
      assertNull(object0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("0M ux+!m';8SmQ8d'");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Not yet implemented");
      File file0 = TypeHandler.createFile("0M ux+!m';8SmQ8d'");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("P@mU;|\"O", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: P@mU;|\"O
         //
  ...
  public void test07()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("", (Object) "=VkE");
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber(">b,:*.-\"~jw-br");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \">b,:*.-\"~jw-br\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(">b,:*.-\"~jw-br", class0);
      assertNull(object0);
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createURL("oY?N:'`-X !P}VS%'D0");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: oY?N:'`-X !P}VS%'D0
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("<@u.Ea)R{ZtwDflu9", (Object) class0);
      assertEquals("<@u.Ea)R{ZtwDflu9", object0);
  }
}
