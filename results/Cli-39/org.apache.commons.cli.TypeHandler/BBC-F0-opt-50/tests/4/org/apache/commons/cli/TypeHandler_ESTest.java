...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".*3rB");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Unable to find the class: ");
      File file0 = TypeHandler.createFile(".*3rB");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".*3rB");
      assertEquals(".*3rB", file0.getName());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("/XbF3", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: /XbF3
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("/XbF3", class0);
      assertNull(object0);
  }
  ...
  public void test17()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("[u6?imV2toRw");
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createURL("g\"lPD%3");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: g\"lPD%3
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("9w:HBTjXCEquF", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("/XbF3", (Object) class0);
      assertEquals("/XbF3", object0);
  }
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("Tx_$xLdAs)EXi5!S", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: Tx_$xLdAs)EXi5!S
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Object object0 = TypeHandler.createValue("@x=4cMA&", (Object) null);
      assertNull(object0);
  }
}
