...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/!zj9");
      assertEquals("/!zj9", file0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("FA$on`");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Unable to parse the URL: ");
      File file0 = TypeHandler.createFile("FA$on`");
      assertEquals(0L, file0.getFreeSpace());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".e<M\"%9!");
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("4hk%i|erg^y<L5uo");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 4hk%i|erg^y<L5uo
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("aloiIKiHK+V8.Wa", class0);
      assertNull(object0);
  }
  ...
  public void test19()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("2", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 2
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Object object0 = TypeHandler.createValue("Kw$7i33U", (Object) null);
      assertNull(object0);
  }
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("b2", ((PatternOptionBuilder) object0).FILE_VALUE);
      assertEquals("b2", mockFile0.getName());
  }
  ...
  public void test28()  throws Throwable  {
      try { 
        TypeHandler.createURL("b2");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: b2
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test32()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("= W<9", (Object) class0);
      assertEquals("= W<9", object0);
  }
}
