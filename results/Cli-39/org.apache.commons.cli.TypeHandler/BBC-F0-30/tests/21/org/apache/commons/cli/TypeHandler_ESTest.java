...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Unable tqCfind the classM ", (Object) class0);
      assertEquals("Unable tqCfind the classM ", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".wVbw0HIl");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/y*%g[_DnU&vQXKX+");
      assertEquals(0L, file0.getUsableSpace());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      File file0 = TypeHandler.createFile("sy");
      assertEquals("sy", file0.getName());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("H(+@$c", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: H(+@$c
         //
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber("/GQHYyI");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"/GQHYyI\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("2?25o]r:&", class0);
      assertNull(object0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("2?25o]r:&", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"2?25o]r:&\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("Unable tqCfind the classM ", class0);
      assertEquals("Unable tqCfind the classM ", object0);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("p{Cfl{xNIuh", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      try { 
        TypeHandler.createValue("EP$w%Vb[yq{eTIq]l", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: EP$w%Vb[yq{eTIq]l
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("H(+@$c", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
