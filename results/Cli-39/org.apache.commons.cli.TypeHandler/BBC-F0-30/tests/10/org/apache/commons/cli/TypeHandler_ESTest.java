...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("D+~nsEP0t9E4~P", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: D+~nsEP0t9E4~P
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createURL(";NO2p-u");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ;NO2p-u
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
