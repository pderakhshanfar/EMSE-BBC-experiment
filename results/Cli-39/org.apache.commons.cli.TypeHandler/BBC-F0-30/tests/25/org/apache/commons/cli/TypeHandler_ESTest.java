...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/tx!gNT$q ");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("]sq#Rnk");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("]sq#Rnk");
      assertEquals("]sq#Rnk", file0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createObject("c=O {PFV$6T");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: c=O {PFV$6T
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber("R:n(*8-n5h=!yg~W");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"R:n(*8-n5h=!yg~W\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("]sq#Rnk", class0);
      assertNull(object0);
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile(".aH7cZ\"-5_");
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("IO:Xw91+=m\"-Y`");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: IO:Xw91+=m\"-Y`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("6", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("; Unable to create an instance of: ", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
  ...
  public void test27()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("2BPi,:mo`we", class0);
      assertEquals("2BPi,:mo`we", object0);
  }
