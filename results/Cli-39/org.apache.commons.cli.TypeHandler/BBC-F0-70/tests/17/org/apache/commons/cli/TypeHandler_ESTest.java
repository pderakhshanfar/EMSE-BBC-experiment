...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("Q%)W9]} r/.\"");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/;[vLG~,'q/wi=)H1^_");
      assertEquals(0L, file0.length());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Zi+i");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "hi(+e");
      File file0 = TypeHandler.createFile("Zi+i");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("b;fr", (Object) file0);
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createObject("4xAJF}}");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 4xAJF}}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("itGvc0-P!W9#N-O");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: itGvc0-P!W9#N-O
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("\n/SMJyF\"Hw<]", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue(":j]NcG|R]m", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test25()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue(":j]NcG|R]m", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test28()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Vs", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Vs
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test33()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles(":j]NcG|R]m");
        fail("Expecting exception: UnsupportedOperationException");
