...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("5Wq&7us_D");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "@E=$^%b}tTEx-Is");
      File file0 = TypeHandler.createFile("5Wq&7us_D");
      assertEquals(15L, file0.length());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".M-4P`eqUz[{;T2\"8?r");
      assertTrue(file0.isHidden());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/'AY$'h__+-nJnNU#g");
  ...
  public void test08()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(".h^e?Ds", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .h^e?Ds
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("_@$ni/ADC'ySTA`wii", (Object) "_@$ni/ADC'ySTA`wii");
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("\"}6 ^vN6''cy Lbo", class0);
      assertNull(object0);
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createURL("Mo");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: Mo
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createNumber("wWqZx>`OB.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"wWqZx>`OB.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("9", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test24()  throws Throwable  {
      Class<Object> class0 = Object.class;
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("9X-S7\"H", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("4%y*eMkr<", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test32()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      try { 
        TypeHandler.createValue("4%y*eMkr<", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 4%y*eMkr<
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test33()  throws Throwable  {
      Object object0 = TypeHandler.createValue("o<g.apache.commons.c/i.TypeHandler", (Object) null);
      assertNull(object0);
  }
}
