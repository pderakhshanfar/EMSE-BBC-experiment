...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("{.nYfNE?", (Object) class0);
      assertEquals("{.nYfNE?", object0);
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Nw}f*Iij|pk");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("wpp}^$\"WG.DbG", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: wpp}^$\"WG.DbG
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass(",>jA8`Ov#");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ,>jA8`Ov#
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("/Nw}f*Iij|pk");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"/Nw}f*Iij|pk\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("];`G2LZf\";'$", class0);
      assertNull(object0);
  }
  ...
  public void test18()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("K<6S 7\"BnMvF69Tz");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("d@'dh8<>Qt", (Object) typeHandler0);
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("$\"_?irNHN<te:", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test23()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      try { 
        TypeHandler.createValue("$\"_?irNHN<te:", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"$\"_?irNHN<te:\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("{.nYfNE?", class0);
      assertEquals("{.nYfNE?", object0);
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      File file0 = TypeHandler.createFile(".nF;>GIs");
      assertEquals(0L, file0.getFreeSpace());
  }
