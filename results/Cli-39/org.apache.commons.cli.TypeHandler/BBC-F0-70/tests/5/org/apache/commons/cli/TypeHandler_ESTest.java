...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("p$^5C%s@%p?cpeI8m", (Object) class0);
      assertEquals("p$^5C%s@%p?cpeI8m", object0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("8a7QA[61Ctu|zv");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("8a7QA[61Ctu|zv");
      assertEquals(1392409281320L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Y0zA|l^XHN}1");
      assertFalse(file0.canWrite());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/UY'O5h");
      assertEquals("/UY'O5h", file0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("2n]3<O", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 2n]3<O
         //
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createURL("P*r}cE");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: P*r}cE
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
