...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      File file0 = TypeHandler.createFile(".m]l\"kO<2");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/uB^&c'");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("bwa");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "2^cLR/(");
      File file0 = TypeHandler.createFile("bwa");
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.createObject("<daCg7y");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: <daCg7y
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("The addValue method is not intended for client use. Subclasses should use the addValueForProcessing method instead. ");
        fail("Expecting exception: Exception");
  ...
  public void test20()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("Pu;!c['ZP69FIsaz");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createURL(";J98hH%d6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ;J98hH%d6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("sXNUbUr`_0", class0);
      assertNull(object0);
  }
  ...
  public void test30()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("7kOM_<DG|", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 7kOM_<DG|
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
