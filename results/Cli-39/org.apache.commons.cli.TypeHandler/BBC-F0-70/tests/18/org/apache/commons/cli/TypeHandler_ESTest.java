...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "0{j6xE! ^<F]a");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".bx_Ii)");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("oh", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: oh
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("xk");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: xk
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("bMr K8T#", class0);
      assertNull(object0);
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("IJ]]O[H/.?7Kd=y3");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"IJ]]O[H/.?7Kd=y3\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("NO_ARGS_ALLOWED", class0);
      assertEquals("NO_ARGS_ALLOWED", object0);
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createURL("],cq=d<");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ],cq=d<
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createValue(">G]G=N$axMMZ01tJu", (Object) null);
      assertNull(object0);
  }
}
