...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("n>=<P|O-~rq)U", (Object) class0);
      assertEquals("n>=<P|O-~rq)U", object0);
  }
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".(+Y0l9(2?Dbxf0#");
  ...
  public void test06()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "E8sKn0uuO~E=");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("hiQk@", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: hiQk@
         //
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("iFDvP9y-zv");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: iFDvP9y-zv
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("L2o/;@H:-", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: L2o/;@H:-
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("F5Ew4A9e0J", class0);
      assertNull(object0);
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".(+Y0l9(2?Dbxf0#");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".(+Y0l9(2?Dbxf0#\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("n>=<P|O-~rq)U", class0);
      assertEquals("n>=<P|O-~rq)U", object0);
  }
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("C4$Hl9OWKC){");
