...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("C#`?V/.k");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("0)Y~-`L(");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "0)Y~-`L(");
      File file0 = TypeHandler.createFile("0)Y~-`L(");
      assertEquals("0)Y~-`L(", file0.getName());
  }
  ...
  public void test07()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("-{`OTra", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: -{`OTra
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("0)Y~`L(", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 0)Y~`L(
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("xmnug4pY");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: xmnug4pY
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("~WeI-I(", class0);
      assertNull(object0);
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createNumber("=.o^7aOo{d59s_>B");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"=.o^7aOo{d59s_>B\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("8=2x", ((PatternOptionBuilder) object0).FILE_VALUE);
