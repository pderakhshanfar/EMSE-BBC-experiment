...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("$ui_j)AahMtHU)HS", (Object) class0);
      assertEquals("$ui_j)AahMtHU)HS", object0);
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/(Yc#EokWNI%Yz@`");
      assertFalse(file0.canWrite());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("4o%|@H0BJgeQ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "4o%|@H0BJgeQ");
      File file0 = TypeHandler.createFile("4o%|@H0BJgeQ");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("Fc");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Fc
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("$ui_j)AahMtHU)HS", class0);
      assertEquals("$ui_j)AahMtHU)HS", object0);
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createURL("6@[Sm+7AELL$XZ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 6@[Sm+7AELL$XZ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
