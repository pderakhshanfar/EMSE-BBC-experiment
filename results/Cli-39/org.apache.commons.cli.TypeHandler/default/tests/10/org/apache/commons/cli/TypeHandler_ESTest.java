...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("0,_k4/vI%Hi!of;-1", (Object) class0);
      assertEquals("0,_k4/vI%Hi!of;-1", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".svwutn4hl?(LF");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "!?");
      File file0 = TypeHandler.createFile(".svwutn4hl?(LF");
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("mJ12", (Object) "mJ12");
  ...
  public void test08()  throws Throwable  {
      try { 
        TypeHandler.createObject("#mXe}sK%]\"r08S");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: #mXe}sK%]\"r08S
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber("B/Xn@cJxU13.N#l");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"B/Xn@cJxU13.N#l\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("0,_k4/vI%Hi!of;-1", class0);
      assertEquals("0,_k4/vI%Hi!of;-1", object0);
  }
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("lcFJ6@KsNk_(o8B", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: lcFJ6@KsNk_(o8B
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile("/DLgdY9.G");
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("2V`>'W}qXS1KCmG0Gu");
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("/DLgdY9.G");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: /DLgdY9.G
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      Object object0 = TypeHandler.createValue("0,_k4/vI%Hi!of;-1", (Object) null);
      assertNull(object0);
  }
}
