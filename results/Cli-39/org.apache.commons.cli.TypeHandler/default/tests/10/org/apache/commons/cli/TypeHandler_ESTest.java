...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".c?Ur");
      assertTrue(file0.isHidden());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/tPc\fsB5l@");
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("yg(]", (Object) "yg(]");
  ...
  public void test08()  throws Throwable  {
      try { 
        TypeHandler.createObject("<Oy/MqkuuSb~");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: <Oy/MqkuuSb~
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("XO|", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: XO|
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("J?](n=uf.l|nL`q");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"J?](n=uf.l|nL`q\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("F2A%}>y?{5}J");
