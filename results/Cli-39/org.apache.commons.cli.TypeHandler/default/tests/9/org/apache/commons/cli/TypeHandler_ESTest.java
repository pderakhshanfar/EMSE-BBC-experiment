...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("M,@(Qu", (Object) class0);
      assertEquals("M,@(Qu", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("org.apache.commons.cli.PatternOptionBuilder");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "1$J4^Scc@8:bw!EIL");
  ...
  public void test07()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("ZI#};", (Object) "ZI#};");
  ...
  public void test09()  throws Throwable  {
      try { 
        TypeHandler.createObject("4I#}(");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 4I#}(
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("=qw! d>Y");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: =qw! d>Y
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("qUwSpw;qWJl).");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"qUwSpw;qWJl).\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("7#qx@_3Ld:;BlArC'", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 7#qx@_3Ld:;BlArC'
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("&d^o/?bKKBJ");
  ...
  public void test26()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("AweOuhcP;/", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: AweOuhcP;/
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      File file0 = TypeHandler.createFile(".A{J!");
