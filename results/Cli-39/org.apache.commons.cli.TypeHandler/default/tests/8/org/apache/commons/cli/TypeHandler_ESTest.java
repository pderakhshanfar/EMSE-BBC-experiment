...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(",d_<=y9Hl2;|zx<");
      byte[] byteArray0 = new byte[6];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(",d_<=y9Hl2;|zx<");
      assertEquals(1392409281320L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Nn yk??>(!rd%EOf");
      assertEquals("Nn yk??>(!rd%EOf", file0.getName());
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass(":H]Lu'");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: :H]Lu'
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".DQ*qqL|]/");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".DQ*qqL|]/\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("jP7E", class0);
      assertEquals("jP7E", object0);
  }
  ...
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile(".DQ*qqL|]/");
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL(",B7N^5xF");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ,B7N^5xF
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
