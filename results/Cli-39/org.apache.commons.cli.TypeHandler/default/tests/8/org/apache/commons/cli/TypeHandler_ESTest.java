...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/8h(z$>!97");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "{4 .");
      File file0 = TypeHandler.createFile("/8h(z$>!97");
  ...
  public void test07()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue(" &j7XB!t1~", (Object) " &j7XB!t1~");
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("R6)6G'-");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: R6)6G'-
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("R|5$gt0L9", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: R|5$gt0L9
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("&C~JKejACV,4", class0);
      assertEquals("&C~JKejACV,4", object0);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile(".UGFMU5|'");
