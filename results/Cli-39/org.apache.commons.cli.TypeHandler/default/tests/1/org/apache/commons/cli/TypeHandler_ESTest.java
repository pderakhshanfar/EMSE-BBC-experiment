...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("\"(a=,;dK{/#", (Object) class0);
      assertEquals("\"(a=,;dK{/#", object0);
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/\"kOGUFdN;Mc");
      assertEquals(0L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("jkzp[V]<lx");
      byte[] byteArray0 = new byte[4];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("jkzp[V]<lx");
      assertEquals("jkzp[V]<lx", file0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("{pLD4P%r[`s", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: {pLD4P%r[`s
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("5wS(}aH$G6>:$<1@%&", (Object) "5wS(}aH$G6>:$<1@%&");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("reeM;}BqM");
        fail("Expecting exception: UnsupportedOperationException");
