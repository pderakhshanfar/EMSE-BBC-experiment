...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("hnK3*s", (Object) class0);
      assertEquals("hnK3*s", object0);
  }
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".q]Rz4");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile(".q]Rz4");
  ...
  public void test07()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("0#[4W`j@2 TLaGdF8", (Object) "0#[4W`j@2 TLaGdF8");
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("W.pVH-H`u?>9r$");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"W.pVH-H`u?>9r$\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue(".q]Rz4", class0);
      assertEquals(".q]Rz4", object0);
  }
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("N#dG4l\"_.aiM+*LTE`", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: N#dG4l\"_.aiM+*LTE`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createClass("K9S/@O3KHl#lus.izxl");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: K9S/@O3KHl#lus.izxl
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
