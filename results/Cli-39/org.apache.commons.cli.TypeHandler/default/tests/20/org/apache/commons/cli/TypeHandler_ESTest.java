...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("akQm'%[|[e[q81{", (Object) class0);
      assertEquals("akQm'%[|[e[q81{", object0);
  }
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".OiZE{'S:J?Y.0OAT!G");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/(dHT");
  ...
  public void test08()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("J'dX3u&ie#@ kX'k#", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: J'dX3u&ie#@ kX'k#
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("<-5>_%$q", (Object) "<-5>_%$q");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("+!>Rb($j/AHp");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: +!>Rb($j/AHp
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("<-5>_%$q", class0);
      assertNull(object0);
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createObject("BJ?xu#`'PjZq15bcjO");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: BJ?xu#`'PjZq15bcjO
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("^A{?oVt{FEA\"P+}t|Y");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ^A{?oVt{FEA\"P+}t|Y
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
