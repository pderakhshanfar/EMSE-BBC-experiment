...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("has alrebdy beenselected: '");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "s\".Ui%]g#B]I1S[Wx");
      File file0 = TypeHandler.createFile("has alrebdy beenselected: '");
      assertFalse(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("|/.S=Z(xs5.&HXCt{-");
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("8oqS(kdLitT(", class0);
      assertNull(object0);
  }
  ...
  public void test16()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("`0H,\"st", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: `0H,\"st
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".sP`#89|(|i=");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".sP`#89|(|i=\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
