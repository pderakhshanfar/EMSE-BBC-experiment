...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("kXh");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "NO_ARGS_ALLOWED");
      File file0 = TypeHandler.createFile("kXh");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/_bVFhk@)FRgPBWq");
  ...
  public void test07()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("rg.apache.omon.cli.TypeHandler", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: rg.apache.omon.cli.TypeHandler
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("MO(\"dl");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: MO(\"dl
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createObject("i!;BT{L%2J*v@SnG");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: i!;BT{L%2J*v@SnG
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("ka#,/U:0.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"ka#,/U:0.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile(".telXfxbU");
      assertFalse(file0.isDirectory());
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("sBL#<=R$4(");
        fail("Expecting exception: UnsupportedOperationException");
