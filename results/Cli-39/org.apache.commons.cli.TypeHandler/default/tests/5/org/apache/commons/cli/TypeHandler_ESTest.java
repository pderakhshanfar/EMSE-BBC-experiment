...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("08$}m?v{<", (Object) class0);
      assertEquals("08$}m?v{<", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".wl\"HZ4m*,9r5^|");
      assertNull(file0.getParent());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/TFpN~w?UG:zOX4ya0o");
      assertEquals("TFpN~w?UG:zOX4ya0o", file0.getName());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("{Uk1", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: {Uk1
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber(".BO-Pk~m/");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \".BO-Pk~m/\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("08$}m?v{<", class0);
      assertEquals("08$}m?v{<", object0);
  }
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("08$}m?v{<", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 08$}m?v{<
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
