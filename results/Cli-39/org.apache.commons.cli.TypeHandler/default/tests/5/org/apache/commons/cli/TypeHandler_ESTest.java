...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("[Mf;9`.k7]yML*%a@#4", (Object) class0);
      assertEquals("[Mf;9`.k7]yML*%a@#4", object0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "+JB+A{W6nJ");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/l@?itv2^af ImZUH");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".7U=*v1]'.5qs1|\"");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(".}+,zc(1V7x", (Object) ".}+,zc(1V7x");
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("|)C^$&Os");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: |)C^$&Os
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("bojt>|:rs!,tadBcs,wz", class0);
      assertNull(object0);
  }
  ...
  public void test18()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("[Mf;9`.k7]yML*%a@#4", class0);
      assertEquals("[Mf;9`.k7]yML*%a@#4", object0);
  }
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("[On)?1y\"Stym/lb", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: [On)?1y\"Stym/lb
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createValue("VV!#G<zGuPoi>P@", (Object) null);
      assertNull(object0);
  }
}
