...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Object object0 = TypeHandler.createValue(".#)Y", (Object) null);
      assertNull(object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("e)j.u?%B5");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "; Unable to create an instance of: ");
      File file0 = TypeHandler.createFile("e)j.u?%B5");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".B=7OO");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("\"cN=APF3GNG9", (Object) "\"cN=APF3GNG9");
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("4S@I`{mR[", class0);
      assertEquals("4S@I`{mR[", object0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("^k>A|Xn(3.2{2.5TB", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ^k>A|Xn(3.2{2.5TB
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile("/`#2ry%\"_t,GvO.");
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("/`#2ry%\"_t,GvO.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: /`#2ry%\"_t,GvO.
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createClass("J6)");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: J6)
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
