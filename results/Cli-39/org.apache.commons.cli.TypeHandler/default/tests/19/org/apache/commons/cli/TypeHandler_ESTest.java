...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".d9MA1[v6GR6*{PA");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "~:CV$eD sJur6C0|f");
      File file0 = TypeHandler.createFile(".d9MA1[v6GR6*{PA");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("rsB7XX(^n:~8mO*S", (Object) "rsB7XX(^n:~8mO*S");
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("VWZCK@?^sa?.3rFf8U");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"VWZCK@?^sa?.3rFf8U\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile("/$n,c[-2\"");
