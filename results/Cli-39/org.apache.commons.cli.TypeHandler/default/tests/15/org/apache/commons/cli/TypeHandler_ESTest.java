...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".s[Td1");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/nable to parse the cR9: ");
      assertTrue(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("4G");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("crR<8*yo6u^", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: crR<8*yo6u^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("ymX&:gI2Q");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ymX&:gI2Q
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("crR8*poBu;", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: crR8*poBu;
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("5|t et ipementTd", class0);
      assertEquals("5|t et ipementTd", object0);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("; Unable to create a2 instance of: ", class0);
      assertNull(object0);
  }
