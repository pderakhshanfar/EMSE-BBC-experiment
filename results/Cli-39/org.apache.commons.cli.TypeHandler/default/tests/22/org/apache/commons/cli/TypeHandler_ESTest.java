...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("j*SMWJE", (Object) class0);
      assertEquals("j*SMWJE", object0);
  }
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/O9AzW-Z>Z");
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createObject("(5Vhu{[");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: (5Vhu{[
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("55BkUgdk]'_", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 55BkUgdk]'_
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("$Ph%{;+h.Q|C0~UJ,");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: $Ph%{;+h.Q|C0~UJ,
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      try { 
        TypeHandler.createClass(".oO");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .oO
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
