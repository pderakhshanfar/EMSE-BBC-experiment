...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("2&_k", (Object) class0);
      assertEquals("2&_k", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("{T/u-5Lj7q,,ImXn+");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "{T/u-5Lj7q,,ImXn+");
      File file0 = TypeHandler.createFile("{T/u-5Lj7q,,ImXn+");
      assertEquals("{T/u-5Lj7q,,ImXn+", file0.toString());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/aO$Nq@p1p;/^^");
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("&b7#s3.;W~E");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: &b7#s3.;W~E
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("Hf9(AG)C,tDv&%&}/>o", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Hf9(AG)C,tDv&%&}/>o
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("[ Options: [ short ", ((PatternOptionBuilder) object0).FILES_VALUE);
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("_FVpG", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test25()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("ek", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ek
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
