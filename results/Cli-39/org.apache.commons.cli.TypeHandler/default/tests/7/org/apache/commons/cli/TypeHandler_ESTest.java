...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(":zQ3sXOIE>+Q|syYA$");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(":zQ3sXOIE>+Q|syYA$");
      assertNull(file0.getParent());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".`vlg<>hy$MD~KU\"");
      assertEquals(0L, file0.length());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Gyeg!z*");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("{u3>45d=[t$d2");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: {u3>45d=[t$d2
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      Object object0 = TypeHandler.createValue("D", (Class<?>) null);
      assertNull(object0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("$Wv<Cp{U;iIc.Nxb", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: $Wv<Cp{U;iIc.Nxb
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
