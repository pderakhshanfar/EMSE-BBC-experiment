...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Tz3!HeG(P8T");
  ...
  public void test06()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("plrDJa=g3a", (Object) "plrDJa=g3a");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createClass(" x^4");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class:  x^4
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("~;K|;ypL", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ~;K|;ypL
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("R2H4b", class0);
      assertEquals("R2H4b", object0);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("%T~?.(XLTpC");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"%T~?.(XLTpC\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("R2H4b", (Object) class0);
      assertEquals("R2H4b", object0);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      File file0 = TypeHandler.createFile(".Ev<xA+K&Mx&pFXLns#");
  ...
  public void test21()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("B+B}Q2i#R]&nE");
