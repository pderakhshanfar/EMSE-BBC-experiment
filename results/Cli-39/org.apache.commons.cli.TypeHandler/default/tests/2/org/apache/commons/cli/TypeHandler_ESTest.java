...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".tSN4]oP !:");
      assertFalse(file0.canWrite());
  }
  ...
  public void test08()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("[ Options:S[ short ", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: [ Options:S[ short 
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("qN%I8[e}.h/");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: qN%I8[e}.h/
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(",1G<|Si*8z%J,h", class0);
      assertEquals(",1G<|Si*8z%J,h", object0);
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("T<^.;~=x`7/VdHG*");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"T<^.;~=x`7/VdHG*\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("{8l8urX6|P'6[\"");
        fail("Expecting exception: UnsupportedOperationException");
