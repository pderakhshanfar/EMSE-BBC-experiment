...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/64AY<Z;vb;_");
      assertEquals(0L, file0.lastModified());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("'jWai:vUQ^");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "'jWai:vUQ^");
      File file0 = TypeHandler.createFile("'jWai:vUQ^");
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("a5+{$G)_We|$PW", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: a5+{$G)_We|$PW
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("3oiKee?[SezndlHKms", (Object) "3oiKee?[SezndlHKms");
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Bv7Xpm6u.xe=PAC4", class0);
      assertNull(object0);
  }
  ...
  public void test20()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("fX~jrB]j3h8Q37hv", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: fX~jrB]j3h8Q37hv
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createURL("/64AY<Z;vb;_");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: /64AY<Z;vb;_
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
