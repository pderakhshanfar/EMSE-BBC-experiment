...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("taP0j_8p");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "J8=!Oq(v4");
      File file0 = TypeHandler.createFile("taP0j_8p");
      assertEquals("taP0j_8p", file0.getName());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("=Y?w1pYh!9Tz+#:%", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: =Y?w1pYh!9Tz+#:%
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      File file0 = TypeHandler.createFile(".R)e>vZh7WW");
