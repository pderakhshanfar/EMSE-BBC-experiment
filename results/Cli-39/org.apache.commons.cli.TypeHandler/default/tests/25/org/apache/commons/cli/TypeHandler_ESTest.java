...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("VR2^mF2$n+ l", (Object) class0);
      assertEquals("VR2^mF2$n+ l", object0);
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/w|)Mk");
  ...
  public void test05()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "z^ |]teYNhJi$Wq?!Q!");
      File file0 = TypeHandler.createFile("#");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createObject("S&>vTqP`");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: S&>vTqP`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("c[dvfZSx]dQUmw7", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: c[dvfZSx]dQUmw7
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("S&>vTqP`");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createURL("S&>vTqP`");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: S&>vTqP`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("nFM`", class0);
      assertNull(object0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("[P", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test26()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("VR2^mF2$n+ l", class0);
      assertEquals("VR2^mF2$n+ l", object0);
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      File file0 = TypeHandler.createFile(".9Wlat}k7M>");
