...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("gN16z<{H*4=[7Cu~J");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("gN16z<{H*4=[7Cu~J");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(". P4a}Jj}}Gp");
      assertTrue(file0.isHidden());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/+{fK");
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("A", (Object) "; Unable to create an instance of: ");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("*7viXM");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: *7viXM
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Rbutgq(mU>5!", class0);
      assertNull(object0);
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber(". P4a}Jj}}Gp");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \". P4a}Jj}}Gp\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("7[&n'NUb_RZ\"m_&Z");
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL(".;Fb ]Z-Nk$*eJ+9V");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: .;Fb ]Z-Nk$*eJ+9V
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
