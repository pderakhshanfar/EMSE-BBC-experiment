...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("b^fUeD0;<#:J");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "b^fUeD0;<#:J");
      File file0 = TypeHandler.createFile("b^fUeD0;<#:J");
      assertTrue(file0.canExecute());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("/?:PRU:9,T");
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("b^fUeD0;<#:J", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: b^fUeD0;<#:J
         //
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject(")Ig{($V@Yxm*5PPmOf:");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: )Ig{($V@Yxm*5PPmOf:
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("L?8Ml@", class0);
      assertEquals("L?8Ml@", object0);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile(".X8T\"4fOcgeQ%5");
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("bx%\"I5cWsDGN!E");
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("r?8");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: r?8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("XOvd341BN)sSd9q;");
        fail("Expecting exception: UnsupportedOperationException");
