...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("/px{g");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("-;MxeJZK");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "ZOCaj");
      File file0 = TypeHandler.createFile("-;MxeJZK");
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile(".]klnA;5");
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("vVnjg;0&q/_D0");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: vVnjg;0&q/_D0
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("J6KLg^/)BG#G=Xc[_;", class0);
      assertEquals("J6KLg^/)BG#G=Xc[_;", object0);
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createURL("*1mcfpJ");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: *1mcfpJ
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("*1mcfpJ", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("nSp_>)b{7aF`xlfDq", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: nSp_>)b{7aF`xlfDq
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue(" Lzm3Tn{Sjvh_=Z{", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test31()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("MP~TtR", (Object) class0);
      assertEquals("MP~TtR", object0);
  }
}
