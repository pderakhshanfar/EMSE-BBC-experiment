...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("nP`ThwG7cMj6");
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("nP`ThwG7cMj6");
      assertEquals("nP`ThwG7cMj6", file0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/\rTAPa@yAr2");
  ...
  public void test07()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue(".5: ", (Object) "org.apache.commons.cli.TypeHandler");
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createURL("Q(:xbeN:stD");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: Q(:xbeN:stD
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("kC*t^{+S", class0);
      assertEquals("kC*t^{+S", object0);
  }
