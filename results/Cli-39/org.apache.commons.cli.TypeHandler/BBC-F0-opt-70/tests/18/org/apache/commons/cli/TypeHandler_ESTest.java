...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("{?*k+-)EQs{4", (Object) class0);
      assertEquals("{?*k+-)EQs{4", object0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("@K1~3yg=Mrb4<");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Iv");
      File file0 = TypeHandler.createFile("@K1~3yg=Mrb4<");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createClass("2MB`");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 2MB`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("P", class0);
      assertNull(object0);
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createURL("aNF`r\",ajSaGcp*af");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: aNF`r\",ajSaGcp*af
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("t&}L{ x?r", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"t&}L{ x?r\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("_nIf~R`=", class0);
      assertEquals("_nIf~R`=", object0);
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      File file0 = TypeHandler.createFile("/4hKWk;s3s+^");
      assertEquals("/4hKWk;s3s+^", file0.toString());
  }
