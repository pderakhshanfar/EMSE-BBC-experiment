...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("3H", (Object) class0);
      assertEquals("3H", object0);
  }
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/[YsNr_QNT");
      assertFalse(file0.canWrite());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("Jzo", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Jzo
         //
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue((String) null, (Object) "g3Q<-");
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass(" Ot|:wdKfG$7kr.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class:  Ot|:wdKfG$7kr.
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        TypeHandler.createNumber("7=o)5?FWjb>xz");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"7=o)5?FWjb>xz\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("HzV31/Alp=7ae}", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test22()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("Jzo", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("g3Q<-", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"g3Q<-\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Jzo", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
