...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("vt@'l9<g$i*^~'");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "org.apache.commons.cli.TypeHandler");
      File file0 = TypeHandler.createFile("vt@'l9<g$i*^~'");
  ...
  public void test08()  throws Throwable  {
      try { 
        TypeHandler.createObject("C&l");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: C&l
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("~mYoZIB");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ~mYoZIB
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("?kNLzS?B;*_o[+tZ", class0);
      assertNull(object0);
  }
  ...
  public void test19()  throws Throwable  {
      File file0 = TypeHandler.createFile(".;{_0o");
      assertEquals(".;{_0o", file0.getName());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)TypeHandler.createValue(" [ARG]", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test25()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("^FOK[>`uU=>", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ^FOK[>`uU=>
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("px].P=F06~", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
