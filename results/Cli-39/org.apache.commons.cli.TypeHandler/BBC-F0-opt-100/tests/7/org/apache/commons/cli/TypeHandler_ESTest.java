...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("4M&:-,&C<#>");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "1SL)");
      File file0 = TypeHandler.createFile("4M&:-,&C<#>");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".0Vs_jo\"N\"M");
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createClass("pk!,#`s0_+d13+0TYc");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: pk!,#`s0_+d13+0TYc
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("&%Vb%pg|k_R *D-", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: &%Vb%pg|k_R *D-
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("2I", class0);
      assertNull(object0);
  }
  ...
  public void test19()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("D\"n(3zdd^mDMCQ%x", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: D\"n(3zdd^mDMCQ%x
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("5Kc)j*?9O-]", (Object) typeHandler0);
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("0 h|iT3GP");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test26()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("#Uc79FuJ*DAw/I", (Object) class0);
      assertEquals("#Uc79FuJ*DAw/I", object0);
  }
}
