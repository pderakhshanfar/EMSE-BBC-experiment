...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("=-Y-", (Object) class0);
      assertEquals("=-Y-", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Gf");
      assertEquals("Gf", file0.getName());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Y", object0);
  ...
  public void test08()  throws Throwable  {
      try { 
        TypeHandler.createObject("I*f@34fspiEX_J<");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: I*f@34fspiEX_J<
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass("KsFH]:M:0zV");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: KsFH]:M:0zV
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("SOYqy?Y#8Ib<XDu7+", class0);
      assertNull(object0);
  }
  ...
  public void test16()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("8'_5h!bF#wQh,X;8", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 8'_5h!bF#wQh,X;8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("n1M`<Fts~@7OP%H<Q");
  ...
  public void test24()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("Y", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
  ...
  public void test26()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("=-Y-", class0);
      assertEquals("=-Y-", object0);
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      File file0 = TypeHandler.createFile(".fJC@|>]Sqro");
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Y", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
