...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("v/.d_II8r_p<");
      assertFalse(file0.canWrite());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/]DyvqfT 0R]q");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("nHY$yT-[", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: nHY$yT-[
         //
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("/]DyvqfT 0R]q", (Object) "/]DyvqfT 0R]q");
  ...
  public void test09()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("d@", class0);
        fail("Expecting exception: Exception");
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber("s>r.h)he+w,E]<,_5!");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"s>r.h)he+w,E]<,_5!\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("#AphxD1A");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: #AphxD1A
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
