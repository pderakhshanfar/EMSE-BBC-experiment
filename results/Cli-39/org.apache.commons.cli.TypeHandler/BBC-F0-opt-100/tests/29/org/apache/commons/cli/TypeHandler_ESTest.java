...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("V`e 'Dx4\"G28>", (Object) class0);
      assertEquals("V`e 'Dx4\"G28>", object0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/<f$?f qnP}  ");
      byte[] byteArray0 = new byte[7];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/<f$?f qnP}  ");
      assertEquals("/", file0.getParent());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".n^M4I");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("fU%Dv!y1.1Xs&qw", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: fU%Dv!y1.1Xs&qw
         //
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("3rR~sivZ", (Object) "V`e 'Dx4\"G28>");
  ...
  public void test08()  throws Throwable  {
      try { 
        TypeHandler.createObject("N_hV#");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: N_hV#
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createURL("iX_+{");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: iX_+{
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("org.apache.commons.cli.ParseException", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test24()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("|?~'%~}:Y/JNM", class0);
      assertEquals("|?~'%~}:Y/JNM", object0);
  }
