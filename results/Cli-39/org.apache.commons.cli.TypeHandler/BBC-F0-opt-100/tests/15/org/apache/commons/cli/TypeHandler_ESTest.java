...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".d#dMj[s<q");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/)r%{xcDUV#4~Q@9H ");
      assertEquals(0L, file0.getFreeSpace());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Bxf3Sk");
      byte[] byteArray0 = new byte[7];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("Bxf3Sk");
      assertEquals(0L, file0.getFreeSpace());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(";L|_kz", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ;L|_kz
         //
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("h9ht|2e\";8Eq", (Object) typeHandler0);
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createURL("3m|cH#MlO.j");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 3m|cH#MlO.j
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
