...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "^){pdN@'^p@8gh");
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("wx-yP~(./.js.~");
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createURL("w}");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: w}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("xkhVEK6nZkE0u1", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test20()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("xkhVEK6nZkE0u1", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test21()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue(";R^@I}&u5F%q4|", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ;R^@I}&u5F%q4|
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("xkhVEK6nZkE0u1", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"xkhVEK6nZkE0u1\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("x*z9&K#g($(", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("x*z9&K#g($(", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: x*z9&K#g($(
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
