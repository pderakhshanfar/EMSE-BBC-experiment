...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("k]fO", (Object) class0);
      assertEquals("k]fO", object0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals("1?CvnVH\\ub1F(SgQ`", file0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/=8@[j|(O4Q)Uolz'");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject("\"%pR^|{41XX|/+M");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: \"%pR^|{41XX|/+M
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("c2RD#.mza", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"c2RD#.mza\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
