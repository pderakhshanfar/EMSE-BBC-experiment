...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("m.cZ>mai^_Dtl{gC&", (Object) class0);
      assertEquals("m.cZ>mai^_Dtl{gC&", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".SF~jy(3%RX50-*");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile(".SF~jy(3%RX50-*");
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".SF~jy(3%RX50-*");
      assertEquals(".SF~jy(3%RX50-*", file0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/>S6Pjw67 o`aA>]");
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("Either opt or longOpt must be specified", (Object) "m.cZ>mai^_Dtl{gC&");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject(".SF~jy(3%RX50-*");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .SF~jy(3%RX50-*
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("y;vqw8]ck");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: y;vqw8]ck
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(" Qh6()/Sf#a", class0);
      assertNull(object0);
  }
  ...
  public void test23()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("Unable to find the class: ", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("; Unable to create an instance of: ", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test29()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("B33M_0nQKiW~PPL#]nU", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: B33M_0nQKiW~PPL#]nU
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test33()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue(" Qh6()/Sf#a", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class:  Qh6()/Sf#a
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
