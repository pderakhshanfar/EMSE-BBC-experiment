...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue(">0NVlPs/N{", (Object) class0);
      assertEquals(">0NVlPs/N{", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("u(f<[O^7uz0]!");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "aynW08^4I\"5m\"ACgN");
      File file0 = TypeHandler.createFile("u(f<[O^7uz0]!");
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Wj5(\"Ewwn");
  ...
  public void test07()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("5Ew)\"hx]e$*1j", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 5Ew)\"hx]e$*1j
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(">0NVlPs/N{", (Object) ">0NVlPs/N{");
  ...
  public void test20()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("gr8d%d`JnNbp^", ((PatternOptionBuilder) object0).FILE_VALUE);
  ...
  public void test21()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("gr8d%d`JnNbp^", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: gr8d%d`JnNbp^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("gpr8d%d`JnNbp^", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("gr8d%d`JnNbp^", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: gr8d%d`JnNbp^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
