...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("/;J(H:WWgoirM,", (Object) class0);
      assertEquals("/;J(H:WWgoirM,", object0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".~t7-h-nSOW?\"(7");
      assertEquals(".~t7-h-nSOW?\"(7", file0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/P_#ZFYHr");
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("$", (Object) "/;J(H:WWgoirM,");
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createNumber("6cjj ubl|.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"6cjj ubl|.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("I2T|buS{$ge6", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: I2T|buS{$ge6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("8c=2S'c%vH#z0{", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createURL("l.30gW+`n(R+`");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: l.30gW+`n(R+`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("m4!", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: m4!
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
