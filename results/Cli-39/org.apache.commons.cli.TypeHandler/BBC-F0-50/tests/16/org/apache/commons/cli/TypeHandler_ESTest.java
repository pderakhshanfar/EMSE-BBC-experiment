...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/T&nWI1*::");
      assertFalse(file0.canRead());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("CSb");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "The option '");
      File file0 = TypeHandler.createFile("CSb");
  ...
  public void test09()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("vA_XHW^A,[>M^X%{3", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: vA_XHW^A,[>M^X%{3
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      try { 
        TypeHandler.createURL("I==wP4|");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: I==wP4|
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
