...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("ER={3HKxeH", (Object) class0);
      assertEquals("ER={3HKxeH", object0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "wDjpf");
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("ER={3HKxeH", (Object) "ER={3HKxeH");
  ...
  public void test09()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("KM`Pc[q ", class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: KM`Pc[q 
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("[KRZ`h$5]'B]emyP3:");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: [KRZ`h$5]'B]emyP3:
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("5Gkh?8Gz2'%hrJxQjF.");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"5Gkh?8Gz2'%hrJxQjF.\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("g8{@O#!1", class0);
      assertNull(object0);
  }
  ...
  public void test20()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("ER={3HKxeH", class0);
      assertEquals("ER={3HKxeH", object0);
  }
  ...
  public void test27()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("g8{@O#!1", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: g8{@O#!1
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
