...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "Yl3k/28q,{");
  ...
  public void test21()  throws Throwable  {
      File file0 = TypeHandler.createFile(".; YAO7c?`'?O");
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createURL("0kc#w{0-+*sjgZ+J");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 0kc#w{0-+*sjgZ+J
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("W?E]ob;#od!k7", ((PatternOptionBuilder) object0).FILES_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
