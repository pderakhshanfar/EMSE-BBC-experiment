...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("org.apache.cmmons.cli.Option");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "org.apache.commons.cli.PatternOptionBuilder");
      File file0 = TypeHandler.createFile("org.apache.cmmons.cli.Option");
  ...
  public void test07()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("bB@G@}DB%", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: bB@G@}DB%
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("op/B", (Object) "op/B");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createObject("8onVXOL");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 8onVXOL
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("#;U:c|Vu%r");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: #;U:c|Vu%r
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("ltEWc5hy.E9]C#D8", class0);
      assertNull(object0);
  }
  ...
  public void test20()  throws Throwable  {
      File file0 = TypeHandler.createFile("/dZNco3=}fwGP(zudd");
      assertEquals(0L, file0.getUsableSpace());
  }
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createURL("b8}opDsFv!Z");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: b8}opDsFv!Z
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      try { 
        TypeHandler.createNumber("/TBM`g.-ka/I{=89t");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"/TBM`g.-ka/I{=89t\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("t%k]'MCC%", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"t%k]'MCC%\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
