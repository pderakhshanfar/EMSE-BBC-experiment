...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".{aUu");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/8>ysP(~+H~-");
  ...
  public void test07()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "`^%-n1A+l)?RHC");
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("xEtNAU1)|", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: xEtNAU1)|
         //
  ...
  public void test19()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("v;LD8]U9", class0);
      assertNull(object0);
  }
  ...
  public void test20()  throws Throwable  {
      try { 
        TypeHandler.createObject("v;LD8]U9");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: v;LD8]U9
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.createURL("({TA!L%n%W:-\"9;,]O");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: ({TA!L%n%W:-\"9;,]O
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("xzQ-yN'm`yS3A:1Ab");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test27()  throws Throwable  {
      Object object0 = TypeHandler.createValue("SyYJ]W%", (Object) null);
      assertNull(object0);
  }
}
