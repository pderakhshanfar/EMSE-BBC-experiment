...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("y'qIkl", (Object) class0);
      assertEquals("y'qIkl", object0);
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/-oeCJ|;+1x");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("5z|Wl7!'^Ih~=v^JnZ");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile("5z|Wl7!'^Ih~=v^JnZ");
  ...
  public void test07()  throws Throwable  {
      Class<Object> class0 = Object.class;
      try { 
        TypeHandler.createValue("m)Uq[j$@m", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: m)Uq[j$@m
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      File file0 = TypeHandler.createFile(".kzSqyN24en1");
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createNumber("_`M_i w}N.HtP");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"_`M_i w}N.HtP\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Class<Integer> class0 = Integer.class;
      Object object0 = TypeHandler.createValue("/-oeCJ|;+1x", class0);
      assertNull(object0);
  }
  ...
  public void test24()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("'dxr", ((PatternOptionBuilder) object0).NUMBER_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"'dxr\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      Object object1 = TypeHandler.createValue("y", ((PatternOptionBuilder) object0).STRING_VALUE);
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("4", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test28()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("'dxr", ((PatternOptionBuilder) object0).URL_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: 'dxr
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue((String) null, object1);
