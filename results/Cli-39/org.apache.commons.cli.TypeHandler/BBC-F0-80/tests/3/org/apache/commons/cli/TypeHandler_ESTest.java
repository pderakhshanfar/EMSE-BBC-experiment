...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("g+3v%;($:eg4v=", (Object) class0);
      assertNull(object0);
  }
  ...
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".KXaw^Wf");
  ...
  public void test06()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("?q*4>>");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "'vkryOf5lS:'6)@");
      File file0 = TypeHandler.createFile("?q*4>>");
      assertEquals("?q*4>>", file0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("lY$y~", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: lY$y~
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("0vUN!8}T[US\"wC+M}>^");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 0vUN!8}T[US\"wC+M}>^
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createNumber("o$I<6r8z.PC&");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"o$I<6r8z.PC&\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      File file0 = TypeHandler.createFile("/q{:Ml~~");
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createURL("$!nFG|hI");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: $!nFG|hI
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      try { 
        TypeHandler.createValue("!wwrX)x.?", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: !wwrX)x.?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("u^qDRTgwcz<}{kk", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
