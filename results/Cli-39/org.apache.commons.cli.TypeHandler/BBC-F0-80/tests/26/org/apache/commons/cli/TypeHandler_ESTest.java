...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("mYU~f");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("mYU~f");
      assertTrue(file0.canRead());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".-(;6$!F");
      assertNull(file0.getParent());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/iA\"N-A{o#tr7c.");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(":bbCA^=}K", (Object) class0);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: :bbCA^=}K
         //
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("g", object0);
  ...
  public void test12()  throws Throwable  {
      try { 
        TypeHandler.createClass(">DV5#M?=I");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: >DV5#M?=I
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("org.8pache.commons.cli.TypeHandler");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"org.8pache.commons.cli.TypeHandler\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("org.apache.commons.cli.PatternOptionBuilder", class0);
      try { 
        TypeHandler.createValue("R", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
  ...
  public void test25()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("/XGou|$|{p6sBR-", class0);
      assertEquals("/XGou|$|{p6sBR-", object0);
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("[ Optons: [ short ");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("-&<JF?6B`=\"RRFIxr");
        fail("Expecting exception: UnsupportedOperationException");
