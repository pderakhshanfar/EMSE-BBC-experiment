...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("T1z`-HfErxxW%^\u0000b3", (Object) class0);
      assertEquals("T1z`-HfErxxW%^\u0000b3", object0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      File file0 = TypeHandler.createFile(".\"?6?pI@LW(.<|:xf");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile("/-[j/9<_5qaC^5]t`(");
      assertTrue(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("`.V(]z}o*]~8b%*J$");
      byte[] byteArray0 = new byte[1];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("`.V(]z}o*]~8b%*J$");
      assertFalse(file0.isDirectory());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        TypeHandler.createClass("lcNd14T||=-`");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: lcNd14T||=-`
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("u:b.l96&.rxGa>Z");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test27()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      MockFile mockFile0 = (MockFile)TypeHandler.createValue("yFx=<Oag.", ((PatternOptionBuilder) object0).EXISTING_FILE_VALUE);
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TypeHandler.createValue("yFx=<Oag.", ((PatternOptionBuilder) object0).DATE_VALUE);
        fail("Expecting exception: UnsupportedOperationException");
