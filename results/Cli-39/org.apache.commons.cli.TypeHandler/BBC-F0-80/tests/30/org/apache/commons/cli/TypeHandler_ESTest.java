...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("OU", (Object) "OU");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createClass("{cf'");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: {cf'
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        TypeHandler.createNumber("_i%Q.I");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"_i%Q.I\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      File file0 = TypeHandler.createFile("/m;!`h<{B");
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createURL("has already been selected: '");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: has already been selected: '
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
      try { 
        TypeHandler.createValue("Y4", ((PatternOptionBuilder) object0).CLASS_VALUE);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: Y4
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
