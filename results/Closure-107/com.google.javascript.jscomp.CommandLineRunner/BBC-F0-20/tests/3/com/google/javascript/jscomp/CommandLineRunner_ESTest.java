...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test4()  throws Throwable  {
      ...
      stringArray0[0] = "B)5z=`Eg";
      stringArray0[1] = "com.google.javascript.jscomp.CrossModuleMethodMotion";
      stringArray0[2] = "|-{R\"s [@-*@?^";
      stringArray0[3] = "-ph2T";
      stringArray0[4] = "Reading XTB file";
      stringArray0[5] = "es3.js";
      stringArray0[6] = "^EvDX`[4'PHwg|-,";
      stringArray0[7] = "enum key {0} must be a syntactic constant";
