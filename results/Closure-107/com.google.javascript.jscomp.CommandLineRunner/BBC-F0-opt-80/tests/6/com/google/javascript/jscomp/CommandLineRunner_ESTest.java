...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("nMt&PeW=", "msh,3m(`");
  ...
  public void test1()  throws Throwable  {
      ...
      stringArray0[0] = ".v~Z1U=G0mx";
      stringArray0[1] = "";
      stringArray0[2] = "$E";
      stringArray0[3] = "6";
      stringArray0[4] = "SHA-1";
      stringArray0[5] = "";
      stringArray0[6] = "screen-bce";
      stringArray0[7] = "Unknown formatting option: ";
      CommandLineRunner commandLineRunner0 = null;
      try {
  ...
  public void test4()  throws Throwable  {
      String[] stringArray0 = new String[4];
      stringArray0[0] = "A^ei^X\"vf+{L";
      stringArray0[1] = "GeJcP7\"";
      stringArray0[2] = "msh,3m(`";
      stringArray0[3] = "";
      File file0 = MockFile.createTempFile("nMt&PeW=", "msh,3m(`");
      MockPrintStream mockPrintStream0 = new MockPrintStream(file0);
      CommandLineRunner commandLineRunner0 = null;
