...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MockPrintStream mockPrintStream0 = new MockPrintStream("(?:[^ \t\fx0B'\"]|(?:'[^']*'|\"[^\"](\"))+");
      MockPrintStream mockPrintStream1 = new MockPrintStream("x|@`n.y-");
  ...
  public void test1()  throws Throwable  {
      ...
      stringArray0[0] = "Zm0QsMt}B.+]kCLHpn";
      MockPrintStream mockPrintStream0 = new MockPrintStream("Zm0QsMt}B.+]kCLHpn");
      CommandLineRunner commandLineRunner0 = null;
      try {
