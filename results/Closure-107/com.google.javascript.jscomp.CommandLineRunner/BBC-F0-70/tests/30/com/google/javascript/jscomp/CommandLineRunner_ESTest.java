...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("BINDNAME", "~nV'5:L^g\"Hvz%");
  ...
  public void test1()  throws Throwable  {
      ...
      stringArray0[0] = "";
      stringArray0[1] = "";
      stringArray0[2] = "a[G=*m";
      stringArray0[3] = "; Fy6";
      stringArray0[4] = "ERROR - Arguments in the file cannot contain --flagfile option.";
      stringArray0[5] = "#v{$Y,CZJ|c_2Q$j";
      stringArray0[6] = "com.google.common.base.Functions$FunctionComposition";
      stringArray0[7] = "";
      stringArray0[8] = "m.c);`O3?Zi'#G";
      CommandLineRunner commandLineRunner0 = null;
      try {
