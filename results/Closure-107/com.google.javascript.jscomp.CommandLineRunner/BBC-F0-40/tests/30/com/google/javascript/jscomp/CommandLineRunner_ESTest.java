...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("{yb4}]$oJ;", "--A=");
  ...
  public void test2()  throws Throwable  {
      String[] stringArray0 = new String[3];
      stringArray0[0] = "";
      stringArray0[1] = "2DLr~b'<Bnt5?cSjP";
      stringArray0[2] = "Tcignrc|?qV.{H*p";
      MockPrintStream mockPrintStream0 = new MockPrintStream("Tcignrc|?qV.{H*p");
      CommandLineRunner commandLineRunner0 = null;
      try {
  ...
  public void test5()  throws Throwable  {
      ...
      stringArray0[4] = "^['\"](.*)['\"]$";
      stringArray0[5] = "\"^Qq[O";
      stringArray0[6] = "E&0|`U&'P;TqheIPsC";
      stringArray0[7] = "(:W:(g}fgY@Ba";
      stringArray0[8] = "-CD8";
      CommandLineRunner commandLineRunner0 = null;
      try {
