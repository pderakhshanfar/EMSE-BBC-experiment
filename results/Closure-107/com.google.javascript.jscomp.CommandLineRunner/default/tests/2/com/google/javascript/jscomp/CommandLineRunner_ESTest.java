...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MockPrintStream mockPrintStream0 = new MockPrintStream("idX=Nu B*qT('ahP");
      MockPrintStream mockPrintStream1 = new MockPrintStream("idX=Nu B*qT('ahP");
  ...
  public void test3()  throws Throwable  {
      String[] stringArray0 = new String[1];
      stringArray0[0] = "-ZFS=";
      MockPrintStream mockPrintStream0 = new MockPrintStream("-ZFS=");
      CommandLineRunner commandLineRunner0 = null;
      try {
        commandLineRunner0 = new CommandLineRunner(stringArray0, mockPrintStream0, mockPrintStream0);
       //  fail("Expecting exception: NoSuchElementException");
