...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      stringArray0[1] = "";
      stringArray0[2] = "TT";
      stringArray0[3] = "MX0*P(Vm.G7\";Ul";
      stringArray0[4] = "udYh|L4fz=";
      stringArray0[5] = "{zX-";
      stringArray0[6] = "";
      stringArray0[7] = "u'ED@-pjozdllHD";
      CommandLineRunner commandLineRunner0 = null;
      try {
  ...
  public void test6()  throws Throwable  {
      ...
      MockPrintStream mockPrintStream0 = new MockPrintStream("JSC_NAME_REF_GRAPH_FILE_ERROR");
      CommandLineRunner commandLineRunner0 = null;
      try {
        commandLineRunner0 = new CommandLineRunner(stringArray0, mockPrintStream0, mockPrintStream0);
       //  fail("Expecting exception: NoSuchElementException");
