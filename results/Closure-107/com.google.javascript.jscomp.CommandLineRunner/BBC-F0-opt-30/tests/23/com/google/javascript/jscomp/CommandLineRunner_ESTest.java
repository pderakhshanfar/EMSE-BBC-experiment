...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MockPrintStream mockPrintStream0 = new MockPrintStream(")^?eL1]-mfR4P}?");
  ...
  public void test1()  throws Throwable  {
      ...
      stringArray0[0] = "";
      stringArray0[1] = "]g]X{Z";
      stringArray0[2] = "com.google.javascript.jscomp.CommandLineRunner$Flags$WarningGuardOffOptionHandler";
      stringArray0[3] = "";
      stringArray0[4] = "Hku*;<7Ar";
      stringArray0[5] = "";
      stringArray0[6] = "";
      stringArray0[7] = "ERROR - ";
      stringArray0[8] = "off";
      MockFile mockFile0 = new MockFile("]g]X{Z", "Attempt to record skipped property: %s");
