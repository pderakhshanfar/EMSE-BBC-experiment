...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      String[] stringArray0 = new String[3];
      stringArray0[0] = "I,r6@iL@#nce|1z-q";
      stringArray0[1] = "L%B#E*!mi";
      stringArray0[2] = "";
      ByteString.Output byteString_Output0 = ByteString.newOutput(0);
      MockPrintStream mockPrintStream0 = new MockPrintStream(byteString_Output0);
      CommandLineRunner commandLineRunner0 = null;
  ...
  public void test4()  throws Throwable  {
      ...
      stringArray0[0] = "`5Z4+(_Cq;r{1wC";
      stringArray0[1] = "";
      stringArray0[2] = "-";
      stringArray0[3] = "com.google.javascript.jscomp.TypeInferencePass$SecondScopeBuildingCallback";
      CommandLineRunner commandLineRunner0 = null;
      try {
