...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("=tWrGwP+|.\" v", "=tWrGwP+|.\" v");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      BufferedOutputStream bufferedOutputStream0 = new BufferedOutputStream(mockPrintStream0, 2402);
  ...
  public void test1()  throws Throwable  {
      String[] stringArray0 = new String[3];
      stringArray0[0] = "on";
      stringArray0[1] = "com.google.protobuf.ExtensionRegistryLite";
      stringArray0[2] = "=tWrGwP+|.\" v";
      MockFile mockFile0 = new MockFile("=tWrGwP+|.\" v", "=tWrGwP+|.\" v");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      CommandLineRunner commandLineRunner0 = null;
      try {
  ...
  public void test2()  throws Throwable  {
      ...
      stringArray0[0] = "toUpperCase";
      stringArray0[1] = "Ayd";
      stringArray0[2] = "~-]X.\"~/ m^PU1^YQn1";
      stringArray0[3] = "";
      stringArray0[4] = "aK3S|`";
      stringArray0[5] = "ie_vml.js";
      stringArray0[6] = "The body of a goog.scope function cannot reference 'this'.";
      stringArray0[7] = "n@5`";
      stringArray0[8] = ":";
      CommandLineRunner commandLineRunner0 = null;
      try {
