...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      stringArray0[0] = "\"";
      MockPrintStream mockPrintStream0 = new MockPrintStream("SuzwvaD8J>f6");
      CommandLineRunner commandLineRunner0 = null;
      try {
  ...
  public void test2()  throws Throwable  {
      ...
      stringArray0[1] = "";
      stringArray0[2] = "";
      stringArray0[3] = "'6/WGCy)g1w:_{";
      stringArray0[4] = "At least one module must be provided";
      stringArray0[5] = "ECMASCRIPT3";
      stringArray0[6] = "Exports can only be generated if export symbol/property functions are set.";
