...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      stringArray0[0] = "X+`Z+";
      stringArray0[1] = "";
      stringArray0[2] = "N''z8wgN1Sz7HOTR";
      stringArray0[3] = ">>;9HTPm`V6&38.G";
      stringArray0[4] = "Unknown formatting option: ";
      stringArray0[5] = ";|Q&^Q";
      stringArray0[6] = "";
      MockPrintStream mockPrintStream0 = new MockPrintStream(":d@q}Kkp\"$");
      CommandLineRunner commandLineRunner0 = null;
      try {
  ...
  public void test4()  throws Throwable  {
      ...
      stringArray0[0] = "VWUkq]6/#PC";
      stringArray0[1] = "GZ{x=(@Bz>.BwxX";
      stringArray0[2] = "t:x6-HiEUzQ~xEZe0K(";
      stringArray0[3] = "";
      stringArray0[4] = "";
      stringArray0[5] = "";
      stringArray0[6] = ":PlZD\"Fd=~IU?6Z;&";
      stringArray0[7] = "PRETTY_PRINT";
      stringArray0[8] = "-_LzJDuRT*y}3gJfrr";
      CommandLineRunner commandLineRunner0 = null;
      try {
