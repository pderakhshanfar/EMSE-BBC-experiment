...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MockPrintStream mockPrintStream0 = new MockPrintStream("GG'@w#=42");
      MockFile mockFile0 = new MockFile("x`*BiY", "#cL!BLB{~PP>%U}i@");
  ...
  public void test4()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = "x`*BiY";
      stringArray0[1] = "w3c_css3d.js";
      stringArray0[2] = "";
      stringArray0[3] = "GG'@w#=42";
      stringArray0[4] = "3B9h,";
