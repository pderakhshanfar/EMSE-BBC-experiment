...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test4()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "xtt9L0^gs";
      stringArray0[1] = "K>(R)LbsyWP\"MD.";
      stringArray0[2] = "\"pt(X]2%X]0$p>4}5";
      stringArray0[3] = "`=bL-F";
      stringArray0[4] = "false";
      stringArray0[5] = "DTXf";
      stringArray0[6] = "2hB?S,Z.jq=|V^^)fNd";
      stringArray0[7] = "7L.X8er^RV1qt`";
      MockFile mockFile0 = new MockFile(")E", ";|1hdy");
