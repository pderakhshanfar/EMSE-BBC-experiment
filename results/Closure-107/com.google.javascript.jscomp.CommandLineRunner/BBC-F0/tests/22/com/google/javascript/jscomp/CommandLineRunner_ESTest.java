...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test6()  throws Throwable  {
      ...
      stringArray0[0] = "a1Q;a,]c(mZ= io:{V";
      stringArray0[1] = "com.google.javascript.jscomp.ExtractPrototypeMemberDeclarations";
      stringArray0[2] = "-R`z-,h#";
      stringArray0[3] = "-R`z-,h#";
      stringArray0[4] = "-R`z-,h#";
      stringArray0[5] = "-R`z-,h#";
      CommandLineRunner commandLineRunner0 = null;
      try {
        commandLineRunner0 = new CommandLineRunner(stringArray0);
       //  fail("Expecting exception: NoSuchElementException");
