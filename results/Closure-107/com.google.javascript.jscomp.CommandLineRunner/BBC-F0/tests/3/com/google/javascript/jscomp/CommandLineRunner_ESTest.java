...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("M+`Z'B], @q1", "\"(aPY!\"`f\"M_v<Vs|f");
  ...
  public void test1()  throws Throwable  {
      MockPrintStream mockPrintStream0 = new MockPrintStream("\"^UIDFFg+b?R@9Xul@");
      CommandLineRunner commandLineRunner0 = null;
      try {
  ...
  public void test2()  throws Throwable  {
      ...
      stringArray0[0] = "5O8O5ikh3)rv?lIuw";
      stringArray0[1] = "B4EnIIXB!/,";
      stringArray0[2] = "uZlwkYtQH.Z,}^;R";
      stringArray0[3] = "";
      CommandLineRunner commandLineRunner0 = null;
      try {
