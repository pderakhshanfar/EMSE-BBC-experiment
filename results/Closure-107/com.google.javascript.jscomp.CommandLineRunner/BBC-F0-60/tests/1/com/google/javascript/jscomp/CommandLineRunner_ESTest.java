...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test3()  throws Throwable  {
      String[] stringArray0 = new String[7];
      stringArray0[0] = "-z>!/Z.8yxC1`D/([";
      stringArray0[1] = "9m@{WD&>#-])mGf";
      stringArray0[2] = "9L?qe;y =X";
      stringArray0[3] = "M%|Si|sw5ri^/c";
      stringArray0[4] = "AkAIvmFC=4-";
      stringArray0[5] = "%V#ne/n Iz;M`dX";
  ...
  public void test4()  throws Throwable  {
      ...
      stringArray0[4] = "tightenTypes";
      stringArray0[5] = "Built on: ";
      stringArray0[6] = "$#_";
      PipedOutputStream pipedOutputStream0 = new PipedOutputStream();
      MockPrintStream mockPrintStream0 = new MockPrintStream(pipedOutputStream0);
      CommandLineRunner commandLineRunner0 = null;
