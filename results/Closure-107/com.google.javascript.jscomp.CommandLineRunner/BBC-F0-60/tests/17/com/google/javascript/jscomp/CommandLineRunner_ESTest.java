...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("^lu|p==+|h", "com.google.javascript.jscomp.CollapseProperties");
  ...
  public void test1()  throws Throwable  {
      ...
      stringArray0[0] = "YO@O";
      stringArray0[1] = "4Y;|&zQk<C";
      stringArray0[2] = "uk`XDYIx^]?\"R#v";
      stringArray0[3] = "#G{*1E:.>,ywR1z_c";
      stringArray0[4] = "C_h2p~ZV-P";
      stringArray0[5] = "P;>K$g8-bjjB'Nka|9E";
      MockFile mockFile0 = new MockFile((String) null, "LET");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      CommandLineRunner commandLineRunner0 = null;
      try {
