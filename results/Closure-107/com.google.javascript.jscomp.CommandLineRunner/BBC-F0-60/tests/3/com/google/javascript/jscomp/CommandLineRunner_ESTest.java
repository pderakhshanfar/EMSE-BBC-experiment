...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("HXZ9VH+:>M+eK[cq|", "p/9bYNK4wtn6>2.xN(");
  ...
  public void test2()  throws Throwable  {
      String[] stringArray0 = new String[7];
      stringArray0[0] = "";
      stringArray0[1] = "h1N< R";
      stringArray0[2] = "";
      stringArray0[3] = "5N._*F8}H(nsx{SO";
      stringArray0[4] = "qK&SlUND8^p^PPEG";
      stringArray0[5] = "no";
      stringArray0[6] = "com.google.javascript.jscomp.CommandLineRunner$Flags$WarningGuardOffOptionHandler";
      File file0 = MockFile.createTempFile("5N._*F8}H(nsx{SO", "");
      MockPrintStream mockPrintStream0 = new MockPrintStream(file0);
      CommandLineRunner commandLineRunner0 = null;
      try {
  ...
  public void test5()  throws Throwable  {
      ...
      stringArray0[0] = "ERROR - Arguments in the file cannot contain --f+agfile option.";
      stringArray0[1] = "--A_";
      CommandLineRunner commandLineRunner0 = null;
      try {
