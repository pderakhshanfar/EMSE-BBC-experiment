...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      stringArray0[0] = "|q!i=NG$~{rl-I+td;";
      stringArray0[1] = "com.google.javascript.jscomp.JSModule";
      stringArray0[2] = "";
      stringArray0[3] = "-";
      stringArray0[4] = "D,Jutv_";
      CommandLineRunner commandLineRunner0 = null;
      try {
  ...
  public void test4()  throws Throwable  {
      ...
      stringArray0[0] = "A x!MCCv7>3m|$BDl@";
      stringArray0[1] = "-^/@WJ5B^$";
      stringArray0[2] = "\"v|'!U<2d\"5";
      stringArray0[3] = "w3c_css3d.js";
      File file0 = MockFile.createTempFile("UXusKfpH", "w3c_css3d.js");
