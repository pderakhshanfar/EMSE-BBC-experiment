...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      String[] stringArray0 = new String[9];
      stringArray0[0] = "8F'$!_%Y$z*>r!7U";
      stringArray0[1] = "=sCC~^D";
      stringArray0[2] = "com.google.javascript.jscomp.type.ChainableReverseAbstractInterpreter$RestrictByTrueTypeOfResultVisitor";
      stringArray0[3] = "ENUM_NEXT";
      stringArray0[4] = ";g0f";
      stringArray0[5] = "CharMatcher.anyOf(\"";
      stringArray0[6] = "99";
      stringArray0[7] = "=Dwo";
      stringArray0[8] = "b  +elrpp8'w#mW";
      ByteString.Output byteString_Output0 = ByteString.newOutput();
      MockPrintStream mockPrintStream0 = new MockPrintStream(byteString_Output0, true);
      CommandLineRunner commandLineRunner0 = null;
      try {
