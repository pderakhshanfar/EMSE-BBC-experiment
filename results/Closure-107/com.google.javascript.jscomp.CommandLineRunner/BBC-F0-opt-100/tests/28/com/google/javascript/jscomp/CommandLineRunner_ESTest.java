...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("q>aKd^) >Xn$vlw");
  ...
  public void test5()  throws Throwable  {
      String[] stringArray0 = new String[5];
      stringArray0[0] = ">d]+a7IxtQDY8X";
      stringArray0[1] = "G-pVsV+";
      stringArray0[2] = "goog.disposable.IDisposable";
      stringArray0[3] = "-Ey FMA:`n.N X";
      stringArray0[4] = "O>0QWH";
      MockFile mockFile0 = new MockFile("q>aKd^) >Xn$vlw");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      CommandLineRunner commandLineRunner0 = null;
      try {
