...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MockPrintStream mockPrintStream1 = new MockPrintStream("-OA=");
  ...
  public void test2()  throws Throwable  {
      ...
      stringArray0[0] = "N1}mB%[@#";
      stringArray0[1] = "w3c_css3d.js";
      stringArray0[2] = "QJ`";
      stringArray0[3] = "";
      MockFile mockFile0 = new MockFile("gOe`,JkYkOXK", "w3c_css3d.js");
  ...
  public void test3()  throws Throwable  {
      MockPrintStream mockPrintStream0 = new MockPrintStream("-2-GV");
      String[] stringArray0 = new String[7];
      stringArray0[0] = ")/4Lko3E";
      stringArray0[1] = "QaWp";
      stringArray0[2] = "-2-GV";
      stringArray0[3] = "-2-GV";
      stringArray0[4] = "-2-GV";
  ...
  public void test6()  throws Throwable  {
      String[] stringArray0 = new String[7];
      stringArray0[0] = "tg";
      stringArray0[1] = "-lnRpfGI";
      stringArray0[2] = "";
      stringArray0[3] = "XI/[i";
      stringArray0[4] = "com.google.javascript.jscomp.SourceFile$Preloaded";
      stringArray0[5] = "Fhp[*LPHzg?1";
      stringArray0[6] = "$-$";
      CommandLineRunner commandLineRunner0 = null;
      try {
        commandLineRunner0 = new CommandLineRunner(stringArray0);
