...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("w3c_css3d.js", "+H5,Sv p~,wbKoc");
  ...
  public void test3()  throws Throwable  {
      ...
      stringArray0[0] = "";
      stringArray0[1] = "";
      stringArray0[2] = "ImM.VV";
      stringArray0[3] = "-a6QulJ#^z)^";
      stringArray0[4] = "q$-JJ8Ysxz^*";
      stringArray0[5] = "";
  ...
  public void test4()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "w3c_css3d.js";
      stringArray0[1] = "^H!:h(SDj@";
      stringArray0[2] = "";
      stringArray0[3] = "@5J9QIep>t3";
      stringArray0[4] = "";
      stringArray0[5] = "+H5,Sv p~,wbKoc";
      stringArray0[6] = "";
      stringArray0[7] = "![^ aF|tmS%(CGY5";
      ByteString.Output byteString_Output0 = ByteString.newOutput();
      MockPrintStream mockPrintStream0 = new MockPrintStream(byteString_Output0);
      CommandLineRunner commandLineRunner0 = null;
      try {
