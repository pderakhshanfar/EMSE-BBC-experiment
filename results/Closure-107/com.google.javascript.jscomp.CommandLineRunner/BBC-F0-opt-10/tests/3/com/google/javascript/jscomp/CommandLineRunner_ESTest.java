...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test4()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = "Qgj Tj-";
      stringArray0[1] = "O]mT)=AO\"!_31a=tcPX";
      stringArray0[2] = "4N,$!8s~2qjaQ";
      stringArray0[3] = "com.google.common.collect.LinkedListMultimap$DistinctKeyIterator";
      stringArray0[4] = "";
      stringArray0[5] = "^x";
      MockFile mockFile0 = new MockFile("^x");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
