...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("k%R [CnUx]@]*n&:");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("sNqhqxYGkXhahp");
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("b,oj");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'b,oj' contains an illegal character : ','
         //
