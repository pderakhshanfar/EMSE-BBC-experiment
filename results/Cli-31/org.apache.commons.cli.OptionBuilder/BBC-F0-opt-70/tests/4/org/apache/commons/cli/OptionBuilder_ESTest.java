...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      OptionBuilder.withLongOpt(">zXWei");
      Option option0 = OptionBuilder.create("HO");
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("e8m)GyL<G2(");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'e8m)GyL<G2(' contains an illegal character : ')'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.hasArg(true);
      OptionBuilder.withLongOpt("r=@[g@'}k@`Y*|6Z(");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
