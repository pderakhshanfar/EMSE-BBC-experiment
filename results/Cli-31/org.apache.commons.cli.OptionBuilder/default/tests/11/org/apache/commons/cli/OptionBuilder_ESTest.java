...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1149);
      Option option0 = OptionBuilder.create("");
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("+S|?X3lv|f");
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("1T6-DYw3pb");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '1T6-DYw3pb' contains an illegal character : '-'
         //
  ...
  public void test19()  throws Throwable  {
      OptionBuilder.hasArg(true);
      OptionBuilder.withLongOpt("M?<@2}v|M/B+mQAd");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
