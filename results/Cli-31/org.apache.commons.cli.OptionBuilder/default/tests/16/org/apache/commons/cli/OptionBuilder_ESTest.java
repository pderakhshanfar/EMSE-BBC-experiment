...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("P)[@[Q!|");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'P)[@[Q!|' contains an illegal character : ')'
         //
  ...
  public void test20()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("]xWB+B1");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test23()  throws Throwable  {
      OptionBuilder.hasArgs();
      OptionBuilder.withLongOpt("P|PYvP*[~<");
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("=C#BS346:@JD{f");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
