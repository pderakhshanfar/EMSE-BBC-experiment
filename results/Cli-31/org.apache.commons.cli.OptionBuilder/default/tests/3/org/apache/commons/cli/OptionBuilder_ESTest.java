...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.withLongOpt("WXEBE");
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2571);
      Option option0 = OptionBuilder.create('H');
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("3;GUfUUJWjP87^tI");
      OptionBuilder.hasOptionalArgs(0);
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("b$8,X]c)^,=hwC");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'b$8,X]c)^,=hwC' contains an illegal character : ','
         //
