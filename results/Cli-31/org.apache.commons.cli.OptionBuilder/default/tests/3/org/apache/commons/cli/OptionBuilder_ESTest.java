...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("G^,kq_4&+91");
  ...
  public void test10()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("*Zl->J[X5Oz&D=NAv");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("d!8&NdvO`K");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'd!8&NdvO`K' contains an illegal character : '!'
         //
