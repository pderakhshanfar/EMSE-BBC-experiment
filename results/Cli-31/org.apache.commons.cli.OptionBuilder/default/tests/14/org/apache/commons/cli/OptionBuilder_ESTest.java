...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("|^.(I_*W;");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("_/S.ww]uml/w{");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("XMMycE;QJ5mo_");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'XMMycE;QJ5mo_' contains an illegal character : ';'
         //
