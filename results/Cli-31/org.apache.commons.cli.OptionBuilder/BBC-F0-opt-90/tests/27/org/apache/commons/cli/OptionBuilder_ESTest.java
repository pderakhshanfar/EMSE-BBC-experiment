...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("Qg1RN,8h");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'Qg1RN,8h' contains an illegal character : ','
         //
  ...
  public void test22()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("IZPyOtwWtTyjvY}6");
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
  }
  ...
  public void test25()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withValueSeparator('H');
      assertNotNull(optionBuilder0);
  }
