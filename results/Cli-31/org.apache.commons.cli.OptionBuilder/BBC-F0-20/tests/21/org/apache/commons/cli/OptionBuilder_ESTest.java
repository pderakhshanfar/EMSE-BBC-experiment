...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("C$R.(*! iA05_");
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("hq~@l<lq[GI+)r<");
      OptionBuilder.hasArgs(3441);
      Option option0 = OptionBuilder.create();
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("}su%-f@Eq$ndoS%{\"p");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '}su%-f@Eq$ndoS%{\"p' contains an illegal character : '}'
         //
