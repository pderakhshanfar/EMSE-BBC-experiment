...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1002);
      Option option0 = OptionBuilder.create('6');
      assertEquals(1002, option0.getArgs());
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("de#l)[We25taBi#");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'de#l)[We25taBi#' contains an illegal character : '#'
         //
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.isRequired();
      OptionBuilder.withLongOpt("z~G.?Y9J@KlZ(");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test28()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("}]K805u");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
}
