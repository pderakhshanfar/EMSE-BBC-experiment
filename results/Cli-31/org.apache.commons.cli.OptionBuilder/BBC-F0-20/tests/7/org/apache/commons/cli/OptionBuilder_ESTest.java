...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.hasArgs(1490);
      Option option0 = OptionBuilder.create('l');
      assertEquals(1490, option0.getArgs());
      assertEquals("l", option0.getOpt());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("fP^#3(s5C|N3a");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'fP^#3(s5C|N3a' contains an illegal character : '^'
         //
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.hasArg();
      OptionBuilder.withLongOpt("0#W`zehm]");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
