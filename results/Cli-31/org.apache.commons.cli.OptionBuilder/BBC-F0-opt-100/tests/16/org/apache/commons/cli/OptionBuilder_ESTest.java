...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Option option0 = OptionBuilder.create("Ya");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("I(a0z%l[VGHd@f<j");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'I(a0z%l[VGHd@f<j' contains an illegal character : '('
         //
  ...
  public void test31()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("@_3cA1-2Vzb6ua");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
}
