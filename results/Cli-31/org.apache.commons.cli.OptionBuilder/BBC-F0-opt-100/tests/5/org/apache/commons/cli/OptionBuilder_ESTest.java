...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("J_.k%YP+Q;|");
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.hasArgs(2521);
      Option option0 = OptionBuilder.create("");
      assertEquals(2521, option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("zn_,~t8Co&(S0.");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'zn_,~t8Co&(S0.' contains an illegal character : ','
         //
