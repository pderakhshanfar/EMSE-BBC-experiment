...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.hasOptionalArgs((-294));
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt(">a8ri=ba,Rq-");
  ...
  public void test17()  throws Throwable  {
      try { 
        OptionBuilder.create("Z@yCPGa[:!rE#4");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'Z@yCPGa[:!rE#4' contains an illegal character : '@'
         //
