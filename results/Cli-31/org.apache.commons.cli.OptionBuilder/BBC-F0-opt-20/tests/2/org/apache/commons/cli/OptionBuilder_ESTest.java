...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("d$VdDmcdV");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.hasArgs(3728);
      Option option0 = OptionBuilder.create('n');
      assertEquals(3728, option0.getArgs());
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create(";Yeh");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ';Yeh' contains an illegal character : ';'
         //
  ...
  public void test19()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("Uld+>eDC}]J+'w7(v");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test24()  throws Throwable  {
      OptionBuilder.withArgName("");
      OptionBuilder.withLongOpt("mwfhRp_P1>-@kvw=@");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
