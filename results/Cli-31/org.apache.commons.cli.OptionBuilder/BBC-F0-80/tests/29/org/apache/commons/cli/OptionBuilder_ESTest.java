...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.hasArgs(1557);
      Option option0 = OptionBuilder.create("");
      assertEquals(1557, option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.isRequired(true);
      OptionBuilder.withLongOpt("MmG)P+Zd1DP5zoG`#");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withArgName("");
      OptionBuilder.withLongOpt("x&p,#UV@]-AM*d");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("7u6!;vR+-mCB8o#&V");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '7u6!;vR+-mCB8o#&V' contains an illegal character : '!'
         //
