...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withLongOpt("8=;zN.X>");
      Option option0 = OptionBuilder.create('4');
      assertEquals((-1), option0.getArgs());
      assertEquals(52, option0.getId());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withArgName((String) null);
      OptionBuilder.withLongOpt("w>ukQ>g7I$,");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("vz=RP~!8Pv!F|K<");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'vz=RP~!8Pv!F|K<' contains an illegal character : '='
         //
  ...
  public void test25()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("W)e(565");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
