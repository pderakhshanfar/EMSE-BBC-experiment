...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1430);
      Option option0 = OptionBuilder.create("7X5S");
      assertEquals(1430, option0.getArgs());
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("ZpksBFP=Zy@65{j_s!^");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'ZpksBFP=Zy@65{j_s!^' contains an illegal character : '='
         //
  ...
  public void test30()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withType("\" Fnd");
      assertNotNull(optionBuilder0);
  }
}
