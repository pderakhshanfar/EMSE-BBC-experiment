...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(462);
      Option option0 = OptionBuilder.create("");
      assertEquals(462, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      OptionBuilder.withLongOpt("=sT");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test05()  throws Throwable  {
      Option option0 = OptionBuilder.create("Va8t5gq");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt(" Uy;K/bV|mGIW2BA");
      Option option0 = OptionBuilder.create('c');
      assertEquals("c", option0.getOpt());
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withLongOpt("");
      OptionBuilder.hasOptionalArgs((-725));
      Option option0 = OptionBuilder.create();
      assertEquals((-725), option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
  ...
  public void test16()  throws Throwable  {
      OptionBuilder.withLongOpt("Uuj6Tq>!4}s}");
      OptionBuilder.hasArgs(347);
      Option option0 = OptionBuilder.create();
  ...
  public void test17()  throws Throwable  {
      try { 
        OptionBuilder.create("=sT");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '=sT' contains an illegal character : '='
         //
  ...
  public void test22()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("}gfR3yueilV9v7");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test27()  throws Throwable  {
      OptionBuilder.withLongOpt("YnyNXJW^ )x`q\u0003d~+");
      OptionBuilder.hasArgs(0);
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test30()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withType(" Uy;K/bV|mGIW2BA");
      assertNotNull(optionBuilder0);
  }
}
