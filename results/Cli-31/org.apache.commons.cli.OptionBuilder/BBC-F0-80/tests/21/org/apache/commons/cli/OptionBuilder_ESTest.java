...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withLongOpt("jUnrvYTs9J&.j>{Q");
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("ygoSZEDiG{");
      OptionBuilder.hasArgs(0);
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("jUnrvYTs9J&.j>{Q");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'jUnrvYTs9J&.j>{Q' contains an illegal character : '&'
         //
