...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("]~p`h(HPJg&1lNQl");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("Jfls)dYaa");
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("jgVn:/@.+rI");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'jgVn:/@.+rI' contains an illegal character : ':'
         //
