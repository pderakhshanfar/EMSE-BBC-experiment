...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("2gQ/|s");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '2gQ/|s' contains an illegal character : '/'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("f4+p;6)KHE(o~a");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test22()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(699);
      Option option0 = OptionBuilder.create('U');
      assertTrue(option0.hasOptionalArg());
