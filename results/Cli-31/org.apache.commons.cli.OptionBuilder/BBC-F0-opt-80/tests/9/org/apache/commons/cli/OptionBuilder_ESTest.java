...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1339);
      Option option0 = OptionBuilder.create("5Y3W");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("{3nx$oLTY^e+");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '{3nx$oLTY^e+' contains an illegal character : '{'
         //
  ...
  public void test21()  throws Throwable  {
      OptionBuilder.hasArgs();
      OptionBuilder.withLongOpt("E/&,!|rFW6c;3!3W7%V");
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
  }
