...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(21);
      Option option0 = OptionBuilder.create("");
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("qHVoNX.%");
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("E*h&J9GT}_0oj");
      OptionBuilder.withArgName("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.hasArgs(3608);
      OptionBuilder.withLongOpt("qHVoNX.%");
      Option option0 = OptionBuilder.create();
      assertEquals(3608, option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("qHVoNX.%");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'qHVoNX.%' contains an illegal character : '.'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription(",Gj4\"EW2Qj=Q`2*TPp4");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test21()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(0);
      OptionBuilder.withLongOpt(",Gj4\"EW2Qj=Q`2*TPp4");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.isRequired();
      OptionBuilder.withLongOpt("G+$s6");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("4muc");
      assertEquals(0, option0.getArgs());
  }
}
