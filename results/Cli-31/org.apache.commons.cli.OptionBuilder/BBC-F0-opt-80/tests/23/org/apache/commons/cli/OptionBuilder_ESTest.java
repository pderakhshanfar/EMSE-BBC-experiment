...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("WS");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("bM9\"%TW");
      Option option0 = OptionBuilder.create('$');
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("ps{%lT/Dozd");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'ps{%lT/Dozd' contains an illegal character : '{'
         //
