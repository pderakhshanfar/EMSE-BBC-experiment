...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1359);
      OptionBuilder.withLongOpt("");
      Option option0 = OptionBuilder.create();
  ...
  public void test10()  throws Throwable  {
      try { 
        OptionBuilder.create("~k[@2Uid+J-#aEU}`$B");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '~k[@2Uid+J-#aEU}`$B' contains an illegal character : '~'
         //
