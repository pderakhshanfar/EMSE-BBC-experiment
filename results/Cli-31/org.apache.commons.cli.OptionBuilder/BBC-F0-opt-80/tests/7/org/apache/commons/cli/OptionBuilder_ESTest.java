...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("sf8");
      assertEquals(1, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("'k8Rdw[jb~T17D");
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("PO3<2V9,");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      try { 
        OptionBuilder.create("x^Nfq:ZBF6m");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'x^Nfq:ZBF6m' contains an illegal character : '^'
         //
  ...
  public void test23()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("&!llHYiRv!c4");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
