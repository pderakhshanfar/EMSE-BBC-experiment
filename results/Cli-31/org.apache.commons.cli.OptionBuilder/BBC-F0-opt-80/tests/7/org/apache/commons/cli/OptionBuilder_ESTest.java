...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("_'qh|occR/\"R");
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("_'qh|occR/\"R");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '_'qh|occR/\"R' contains an illegal character : '''
         //
  ...
  public void test21()  throws Throwable  {
      OptionBuilder.hasOptionalArgs();
      OptionBuilder.withLongOpt("%Q0d&,25O,{4h");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals((-2), option0.getArgs());
  }
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.withLongOpt("zrO.~BQQ.%BOs");
      OptionBuilder.withArgName("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
