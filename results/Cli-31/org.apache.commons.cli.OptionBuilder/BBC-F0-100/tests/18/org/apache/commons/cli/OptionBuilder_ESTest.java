...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1537);
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("/yxUwFbJRMF");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '/yxUwFbJRMF' contains an illegal character : '/'
         //
  ...
  public void test18()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("dh.42}Zzx=co]");
      assertNotNull(optionBuilder0);
  }
