...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("D>O,ZH>csJO03rLbHy");
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("_YF^\b3W,wG'&Vro");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '_YF^\b3W,wG'&Vro' contains an illegal character : '^'
         //
  ...
  public void test19()  throws Throwable  {
      OptionBuilder.hasArgs();
      OptionBuilder.withLongOpt("035]AHD#");
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
  }
