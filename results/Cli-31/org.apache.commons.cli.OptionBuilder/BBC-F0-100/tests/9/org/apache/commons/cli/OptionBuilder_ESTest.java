...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("f_ [6(?y4{)+F1!c");
  ...
  public void test11()  throws Throwable  {
      try { 
        OptionBuilder.create(":1TD:L]_c|z9}");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ':1TD:L]_c|z9}' contains an illegal character : ':'
         //
  ...
  public void test16()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("|5lAhG");
      assertNotNull(optionBuilder0);
  }
