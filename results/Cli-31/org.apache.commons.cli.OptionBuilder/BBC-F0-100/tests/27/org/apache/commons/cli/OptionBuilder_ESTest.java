...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("bG");
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.withLongOpt("_<zh");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("DIl{Kk");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1717);
      Option option0 = OptionBuilder.create('8');
  ...
  public void test17()  throws Throwable  {
      try { 
        OptionBuilder.create("MyP52TpH(e");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'MyP52TpH(e' contains an illegal character : '('
         //
