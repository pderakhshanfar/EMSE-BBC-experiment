...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt(" 6>DdwUZ}XO}<j");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(633);
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("ZyHfbO@|f[(ym9j");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'ZyHfbO@|f[(ym9j' contains an illegal character : '@'
         //
