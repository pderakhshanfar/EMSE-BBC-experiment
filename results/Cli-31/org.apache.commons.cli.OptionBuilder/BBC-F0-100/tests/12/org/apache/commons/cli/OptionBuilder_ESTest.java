...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("0PcmkG2");
      assertEquals((-1), option0.getArgs());
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(316);
  ...
  public void test09()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("S+oI<]PA`G=(~Nr");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("tAZ:");
      OptionBuilder.hasOptionalArgs(1187);
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("<v&& ^ 7'Nj.2sH");
      OptionBuilder.withArgName("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("O=J<");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'O=J<' contains an illegal character : '='
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
