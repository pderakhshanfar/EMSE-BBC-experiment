...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt(").XPSjk8PB3BC");
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("70h<Ri'yPYsw");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("o29y+RUO");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'o29y+RUO' contains an illegal character : '+'
         //
