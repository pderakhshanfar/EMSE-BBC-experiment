...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1381);
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("kff<f#}-]j0O|^k=I");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("#2u'");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '#2u'' contains an illegal character : '#'
         //
