...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(483);
      Option option0 = OptionBuilder.create("");
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("{4yk([Lt>yrU`ki>M0");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '{4yk([Lt>yrU`ki>M0' contains an illegal character : '{'
         //
