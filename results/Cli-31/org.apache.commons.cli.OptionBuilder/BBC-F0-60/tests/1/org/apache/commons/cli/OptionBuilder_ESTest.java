...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionBuilder.withLongOpt("o*P0:HQh3{");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2182);
      Option option0 = OptionBuilder.create("arg");
      assertTrue(option0.hasOptionalArg());
      assertEquals(2182, option0.getArgs());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("9Ub<}pa4NiL6IsQ;<");
      Option option0 = OptionBuilder.create('Y');
      assertEquals(89, option0.getId());
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("nL^gnK[/hY$EB u\"dcg");
      OptionBuilder.withArgName("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(114);
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("o*P0:HQh3{");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'o*P0:HQh3{' contains an illegal character : '*'
         //
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.isRequired();
      OptionBuilder.withLongOpt("5?{.'0d8p^j-(");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test26()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.hasOptionalArgs(2182);
  ...
  public void test27()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("u<Ty:>m?Kdzr");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
}
