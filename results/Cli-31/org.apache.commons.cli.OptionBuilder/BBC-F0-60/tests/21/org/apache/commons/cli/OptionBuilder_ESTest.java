...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("%ZFtnaqUB{OC*Csw3");
      Option option0 = OptionBuilder.create('o');
      assertEquals((-1), option0.getArgs());
      assertEquals("o", option0.getOpt());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("`5|B&@C");
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("`5|B&@C");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '`5|B&@C' contains an illegal character : '`'
         //
  ...
  public void test29()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withType("-N% MC$9>");
      assertNotNull(optionBuilder0);
  }
}
