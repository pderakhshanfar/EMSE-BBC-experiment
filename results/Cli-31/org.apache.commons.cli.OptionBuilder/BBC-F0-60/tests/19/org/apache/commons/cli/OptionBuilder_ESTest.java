...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("! ~Fp~u|gMnaZ*W");
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("=?X$(^0-4W>y1H`a");
      OptionBuilder.hasOptionalArgs();
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("![9D3U8P@J");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '![9D3U8P@J' contains an illegal character : '!'
         //
