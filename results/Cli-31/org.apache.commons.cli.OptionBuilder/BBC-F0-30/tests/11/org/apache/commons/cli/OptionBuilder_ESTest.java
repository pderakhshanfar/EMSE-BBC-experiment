...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("g{_ac[#^4~el2A-");
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("mx&Opl");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'mx&Opl' contains an illegal character : '&'
         //
  ...
  public void test18()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1410);
      OptionBuilder.withLongOpt(" ]");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
