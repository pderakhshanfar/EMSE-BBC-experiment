...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("Ug#\"rY@V");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'Ug#\"rY@V' contains an illegal character : '#'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(159);
      Option option0 = OptionBuilder.create('s');
