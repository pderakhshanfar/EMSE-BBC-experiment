...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt(" ");
      OptionBuilder.hasArgs(1700);
      Option option0 = OptionBuilder.create();
      assertEquals(1700, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("p'0<y3Jgvc&D[XU+q`");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'p'0<y3Jgvc&D[XU+q`' contains an illegal character : '''
         //
  ...
  public void test29()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withType("aU&");
      assertNotNull(optionBuilder0);
  }
