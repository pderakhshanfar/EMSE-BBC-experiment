...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("2el.6rX");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test04()  throws Throwable  {
      Option option0 = OptionBuilder.create("z4");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("itk*7avcR ");
      Option option0 = OptionBuilder.create('l');
      assertEquals(108, option0.getId());
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("JM?5R:/@");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("ZR5\"wN2B[.");
      OptionBuilder.hasOptionalArg();
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("L%UsUFzX");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'L%UsUFzX' contains an illegal character : '%'
         //
  ...
  public void test18()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("+b7v)J(OU}");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.withLongOpt("pHT=ub.");
      OptionBuilder.hasOptionalArgs(0);
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(0, option0.getArgs());
