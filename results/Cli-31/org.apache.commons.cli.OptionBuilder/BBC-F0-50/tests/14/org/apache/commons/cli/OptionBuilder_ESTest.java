...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("QOm#xvD,H'q$=@1_5");
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("y`03n5tfKmj@PC");
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("!8&;VgE,x3X");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '!8&;VgE,x3X' contains an illegal character : '!'
         //
