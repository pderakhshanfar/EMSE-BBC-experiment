...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("r;{0%|@5:M");
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("n|5lz+q$Yb]AX=v.");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'n|5lz+q$Yb]AX=v.' contains an illegal character : '|'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("(v:z7K'-N([");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test22()  throws Throwable  {
      OptionBuilder.isRequired(true);
      OptionBuilder.withLongOpt("uXaI&Q:H|");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
