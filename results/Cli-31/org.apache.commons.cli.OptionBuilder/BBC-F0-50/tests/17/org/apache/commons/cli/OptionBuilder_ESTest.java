...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      OptionBuilder.withLongOpt("~Tvof8:");
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(4334);
      Option option0 = OptionBuilder.create('G');
      assertEquals("G", option0.getOpt());
      assertTrue(option0.hasOptionalArg());
      assertEquals(4334, option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      try { 
        OptionBuilder.create("A9m>?]6HFv8|*=");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'A9m>?]6HFv8|*=' contains an illegal character : '>'
         //
  ...
  public void test16()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("6hFe7(-");
      assertNotNull(optionBuilder0);
  }
