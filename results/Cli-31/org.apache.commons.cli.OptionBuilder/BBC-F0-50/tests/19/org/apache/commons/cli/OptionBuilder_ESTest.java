...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withLongOpt("G,I24}1@-<}Za8skixm");
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("F+#A5NC");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'F+#A5NC' contains an illegal character : '+'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      OptionBuilder.isRequired();
      OptionBuilder.withLongOpt("DS9Ka");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  }
