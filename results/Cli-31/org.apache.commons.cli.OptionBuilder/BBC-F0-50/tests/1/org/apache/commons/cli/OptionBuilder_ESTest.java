...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2009);
      Option option0 = OptionBuilder.create((String) null);
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("dsUsuh#_h?_o|Ab@");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'dsUsuh#_h?_o|Ab@' contains an illegal character : '#'
         //
  ...
  public void test21()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2009);
      OptionBuilder.withLongOpt("&T'x/z!_un");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(2009, option0.getArgs());
  }
