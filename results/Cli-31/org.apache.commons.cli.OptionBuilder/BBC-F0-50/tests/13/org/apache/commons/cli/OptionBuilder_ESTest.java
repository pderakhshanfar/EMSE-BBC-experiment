...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("M.%3al5oX/I");
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("@t75kZ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '@t75kZ' contains an illegal character : '@'
         //
  ...
  public void test15()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("_t&QL^$");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
  ...
  public void test18()  throws Throwable  {
      OptionBuilder.hasOptionalArgs();
      OptionBuilder.withLongOpt("W/$_*x");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals((-2), option0.getArgs());
  }
