...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("W_;AV^zjd3(6L[#=");
      Option option0 = OptionBuilder.create('s');
      assertEquals((-1), option0.getArgs());
      assertEquals(115, option0.getId());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("{G#v]Z,}Mmsu4Om{7w");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1661);
      OptionBuilder.withLongOpt("");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("Ni]_[T");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'Ni]_[T' contains an illegal character : ']'
         //
