...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt(":Y^+Df'j<");
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("``u~Emib2(");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '``u~Emib2(' contains an illegal character : '`'
         //
  ...
  public void test28()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.hasArgs((-2527));
      assertNotNull(optionBuilder0);
  }
}
