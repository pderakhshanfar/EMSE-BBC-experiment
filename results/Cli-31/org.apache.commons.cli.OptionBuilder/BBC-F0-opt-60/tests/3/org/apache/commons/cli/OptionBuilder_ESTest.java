...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("b|_!qZDnH?P");
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("rE'NqnUqJAi5Uluf};W");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'rE'NqnUqJAi5Uluf};W' contains an illegal character : '''
         //
  ...
  public void test19()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("{W;'J");
      assertNotNull(optionBuilder0);
  }
