...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      try { 
        OptionBuilder.create("1K,;iCXpTOas ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '1K,;iCXpTOas ' contains an illegal character : ','
         //
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withLongOpt("O!*^++h0");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test17()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("O!*^++h0");
      assertNotNull(optionBuilder0);
  }
