...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1015);
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("a2#,\"p/}6{K^@&;g");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("8yv%M}G=");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '8yv%M}G=' contains an illegal character : '%'
         //
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.isRequired();
      OptionBuilder.withLongOpt("T 'W:*?3|5-#IlQ6");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertTrue(option0.isRequired());
  }
