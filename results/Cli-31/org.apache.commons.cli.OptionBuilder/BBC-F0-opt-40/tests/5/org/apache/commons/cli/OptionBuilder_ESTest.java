...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("kA");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("[)-zC_On*!k<O:X!QS");
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("~a0Q0P,!bv$qe!");
      OptionBuilder.isRequired();
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("ze1u@");
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("9NovQB(r");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '9NovQB(r' contains an illegal character : '('
         //
