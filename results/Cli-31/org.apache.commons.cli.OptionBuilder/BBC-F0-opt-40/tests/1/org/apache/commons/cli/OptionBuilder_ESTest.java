...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      OptionBuilder.withLongOpt("=JZZpY,");
  ...
  public void test03()  throws Throwable  {
      Option option0 = OptionBuilder.create("pQ7");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("$D^W@.2i{eS");
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("/BR4ZegxwP;4;Z");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '/BR4ZegxwP;4;Z' contains an illegal character : '/'
         //
  ...
  public void test22()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("mDDxQ");
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
  }
