...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.hasArgs(367);
      Option option0 = OptionBuilder.create("");
      assertEquals(367, option0.getArgs());
  }
  ...
  public void test16()  throws Throwable  {
      OptionBuilder.withLongOpt("PP'NWIH7[e&Xg~EB");
      OptionBuilder.hasArgs(0);
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test18()  throws Throwable  {
      try { 
        OptionBuilder.create("}*=Z}_5a");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '}*=Z}_5a' contains an illegal character : '}'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      OptionBuilder.hasArg(true);
      OptionBuilder.withLongOpt("rBtFHLF/Pt6E*HAJ");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
  ...
  public void test22()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("wH,hx~q5=>5X0");
      assertNotNull(optionBuilder0);
  }
