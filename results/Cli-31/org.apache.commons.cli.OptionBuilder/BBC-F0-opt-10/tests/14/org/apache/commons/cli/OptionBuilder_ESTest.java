...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("SR&Q]APo");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.hasArgs(3028);
      OptionBuilder.withLongOpt("\"ra'<h83Qsp;zc$");
      Option option0 = OptionBuilder.create();
      assertEquals(3028, option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("I%^sRg");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'I%^sRg' contains an illegal character : '%'
         //
