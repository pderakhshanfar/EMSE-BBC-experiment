...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("GiSBt=9/");
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("`[#ai?q");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("73CN!*:i|");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('=', option0.getValueSeparator());
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("A0nYnn");
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("73CN!*:i|");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '73CN!*:i|' contains an illegal character : '!'
         //
