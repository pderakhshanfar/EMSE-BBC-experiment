...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Option option0 = OptionBuilder.create("n0_");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      OptionBuilder.withLongOpt("$zah-r[mV");
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("$zah-r[mV");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '$zah-r[mV' contains an illegal character : '-'
         //
