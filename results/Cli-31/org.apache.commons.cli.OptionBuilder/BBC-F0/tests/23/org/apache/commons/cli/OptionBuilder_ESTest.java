...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("]]6,xe<xOU`n[Qe");
      OptionBuilder.withArgName("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("E|Q4)!\"8* dU>W}");
      OptionBuilder.hasArg();
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("Y}j;z");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'Y}j;z' contains an illegal character : '}'
         //
  ...
  public void test21()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(0);
      OptionBuilder.withLongOpt("(Io||*.l. +4Bj");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test30()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withType("kLk]51S>n7Mfp,,Tm");
      assertNotNull(optionBuilder0);
  }
}
