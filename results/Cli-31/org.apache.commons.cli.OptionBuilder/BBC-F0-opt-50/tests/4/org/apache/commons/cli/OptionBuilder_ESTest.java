...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("_U}~o zFGvdeM-Y!<");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '_U}~o zFGvdeM-Y!<' contains an illegal character : '}'
         //
  ...
  public void test16()  throws Throwable  {
      OptionBuilder.withLongOpt("B5wc~");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.withLongOpt("!=R4kY$");
      OptionBuilder.hasArgs(0);
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
