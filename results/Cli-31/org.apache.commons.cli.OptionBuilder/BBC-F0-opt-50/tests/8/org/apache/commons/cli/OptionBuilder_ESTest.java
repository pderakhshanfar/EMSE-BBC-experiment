...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1558);
      Option option0 = OptionBuilder.create((String) null);
  ...
  public void test06()  throws Throwable  {
      Option option0 = OptionBuilder.create("ky9X");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(0);
      OptionBuilder.withLongOpt("fzDm");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("[2NvM]'");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '[2NvM]'' contains an illegal character : '['
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withValueSeparator('3');
      assertNotNull(optionBuilder0);
  }
