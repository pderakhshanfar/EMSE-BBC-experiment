...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("C.=MGZ");
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withLongOpt("L'4HB^b-C`+g");
  ...
  public void test17()  throws Throwable  {
      try { 
        OptionBuilder.create("I}To@l");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'I}To@l' contains an illegal character : '}'
         //
