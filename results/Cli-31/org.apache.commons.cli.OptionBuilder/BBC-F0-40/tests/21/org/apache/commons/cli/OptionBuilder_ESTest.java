...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("}jT~A Wx");
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("Zgz8'pW:2`k$,R*");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'Zgz8'pW:2`k$,R*' contains an illegal character : '''
         //
  ...
  public void test21()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.hasOptionalArgs(641);
      assertNotNull(optionBuilder0);
  }
  ...
  public void test24()  throws Throwable  {
      OptionBuilder.withLongOpt(".)i<PK'S'");
      OptionBuilder.withArgName("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
