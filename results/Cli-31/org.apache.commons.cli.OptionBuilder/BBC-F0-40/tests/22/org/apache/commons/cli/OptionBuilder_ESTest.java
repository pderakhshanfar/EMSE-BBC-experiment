...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("Gp+pplZwQT");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1636);
      Option option0 = OptionBuilder.create("");
      assertEquals(1636, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt(")SySCFc<r");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("g%wyNI2j9&FUr");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  ...
  public void test11()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("rO*tbeOmlUQ");
      Option option0 = OptionBuilder.create();
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("IBDI)~q");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'IBDI)~q' contains an illegal character : ')'
         //
  ...
  public void test19()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription(".9)?F3?O|^?Vk/7.");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt(",c$t-e^BjTv_1+Hu");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
