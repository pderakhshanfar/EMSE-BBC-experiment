...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withValueSeparator('8');
      OptionBuilder.withLongOpt("}$y5qKsd'L:w");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('8', option0.getValueSeparator());
  }
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withArgName((String) null);
      OptionBuilder.withLongOpt("2rQZ9c?>E");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("8NM[)u>VLe`b&");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '8NM[)u>VLe`b&' contains an illegal character : '['
         //
