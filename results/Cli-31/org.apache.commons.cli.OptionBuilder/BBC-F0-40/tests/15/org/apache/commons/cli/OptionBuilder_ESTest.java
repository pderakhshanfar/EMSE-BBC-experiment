...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("5WvWl5leXKul9W.{+");
  ...
  public void test12()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("*`,8| v`MP^L]f60");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("Po>*[P02qt)M");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'Po>*[P02qt)M' contains an illegal character : '>'
         //
  ...
  public void test16()  throws Throwable  {
      OptionBuilder.withLongOpt("y0ya^{]0wC0~H<KRk4V");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test19()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription(",d}<ma,9C%rDUvw;Kp");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test21()  throws Throwable  {
      OptionBuilder.hasArgs();
      OptionBuilder.withLongOpt("4B:)<k3a");
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
  }
  ...
  public void test22()  throws Throwable  {
      OptionBuilder.hasOptionalArg();
      OptionBuilder.withLongOpt("GZ[7W`'FP-=^");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(1, option0.getArgs());
  }
  ...
  public void test28()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withType("GyUZUx");
      assertNotNull(optionBuilder0);
  }
}
