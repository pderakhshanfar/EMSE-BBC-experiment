...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("|SMoHR-|vCl");
      Option option0 = OptionBuilder.create('m');
      assertEquals((-1), option0.getArgs());
  ...
  public void test11()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("XI&oH$(C(h4H");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("-%7P=");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '-%7P=' contains an illegal character : '-'
         //
  ...
  public void test15()  throws Throwable  {
      OptionBuilder.withLongOpt("P1%*r=a");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
