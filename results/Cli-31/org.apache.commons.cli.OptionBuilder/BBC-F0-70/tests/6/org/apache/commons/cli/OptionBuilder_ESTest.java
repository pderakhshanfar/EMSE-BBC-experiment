...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("aP3}JWi*>fd%D1P");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("MW;i>UAZ");
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("UW|/!D=@]WC4C");
      OptionBuilder.hasOptionalArg();
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("?DWM}t");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '?DWM}t' contains an illegal character : '?'
         //
