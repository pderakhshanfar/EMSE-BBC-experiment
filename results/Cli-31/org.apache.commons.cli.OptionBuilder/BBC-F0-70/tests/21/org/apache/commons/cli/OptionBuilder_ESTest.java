...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("K5+P");
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.hasArgs(560);
      OptionBuilder.withLongOpt("G;+<p!%{K/Z");
      Option option0 = OptionBuilder.create();
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("O0(^>S}!xl+[M");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'O0(^>S}!xl+[M' contains an illegal character : '('
         //
