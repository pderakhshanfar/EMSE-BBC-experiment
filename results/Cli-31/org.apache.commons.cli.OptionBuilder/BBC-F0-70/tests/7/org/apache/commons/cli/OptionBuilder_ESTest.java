...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Option option0 = OptionBuilder.create("sAoN");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(104);
      Option option0 = OptionBuilder.create("");
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1250);
      Option option0 = OptionBuilder.create('J');
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("arg");
      OptionBuilder.hasArgs(457);
      Option option0 = OptionBuilder.create();
      assertEquals(457, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      OptionBuilder.withLongOpt("$XtU");
      OptionBuilder.hasOptionalArgs(0);
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  ...
  public void test17()  throws Throwable  {
      try { 
        OptionBuilder.create("#9roR7Th6QFh");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '#9roR7Th6QFh' contains an illegal character : '#'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
