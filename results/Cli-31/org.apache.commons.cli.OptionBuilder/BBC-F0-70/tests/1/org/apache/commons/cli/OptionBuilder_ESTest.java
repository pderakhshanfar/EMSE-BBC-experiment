...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("iu&&s`^hG |@pg");
      Option option0 = OptionBuilder.create('T');
      assertEquals((-1), option0.getArgs());
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withArgName((String) null);
      OptionBuilder.withLongOpt("I?J)>'mD");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create(" <FTBG'Wc]+0{86o");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ' <FTBG'Wc]+0{86o' contains an illegal character : ' '
         //
