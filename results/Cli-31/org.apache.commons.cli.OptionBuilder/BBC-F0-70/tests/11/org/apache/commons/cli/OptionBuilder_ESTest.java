...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("P%aC`hlcLn@R%");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(611);
      Option option0 = OptionBuilder.create('$');
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("Eo(p#cf");
      OptionBuilder.hasOptionalArgs(0);
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("l.jn)l");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'l.jn)l' contains an illegal character : '.'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      OptionBuilder.withArgName((String) null);
      OptionBuilder.withLongOpt("g[9IFJT-]c{!");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("s#68\"");
      Option option0 = OptionBuilder.create();
  ...
  public void test29()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.hasArgs((-1870));
      assertNotNull(optionBuilder0);
  }
}
