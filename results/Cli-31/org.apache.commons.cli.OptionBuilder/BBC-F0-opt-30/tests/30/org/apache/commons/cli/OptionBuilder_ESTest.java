...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("ane0<Du");
      OptionBuilder.isRequired(true);
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("AZG%C0bJ;_\"");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals('=', option0.getValueSeparator());
      assertEquals((-1), option0.getArgs());
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("}N]wB.,L;Dg4X");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '}N]wB.,L;Dg4X' contains an illegal character : '}'
         //
