...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt(" a\"LK;>f");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("imCja[lc0[jiSdx");
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withArgName((String) null);
      OptionBuilder.withLongOpt("q{}P~y;}qQl");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("imCja[lc0[jiSdx");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'imCja[lc0[jiSdx' contains an illegal character : '['
         //
