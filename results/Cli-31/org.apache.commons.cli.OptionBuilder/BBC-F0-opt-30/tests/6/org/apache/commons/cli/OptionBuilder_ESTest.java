...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.withLongOpt("/esV&0l5t&");
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("-C9=[t2~voz!lkr:R.&");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '-C9=[t2~voz!lkr:R.&' contains an illegal character : '-'
         //
