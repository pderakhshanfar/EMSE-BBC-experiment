...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withLongOpt("sZ`w]U");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("S F L1^V");
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("ar<\"P");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'ar<\"P' contains an illegal character : '<'
         //
  ...
  public void test19()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("AMr9`P&W#-");
      assertNotNull(optionBuilder0);
  }
