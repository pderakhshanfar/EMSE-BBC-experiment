...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("-p#PE{]28e,e");
  ...
  public void test13()  throws Throwable  {
      try { 
        OptionBuilder.create("29u[9G>{TP-");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '29u[9G>{TP-' contains an illegal character : '['
         //
  ...
  public void test18()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("]Ydx6|w_MGRs");
      assertNotNull(optionBuilder0);
  }
