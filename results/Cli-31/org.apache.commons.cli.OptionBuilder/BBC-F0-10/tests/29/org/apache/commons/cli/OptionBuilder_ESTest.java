...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("yXwY9TPwXbcbt-+TXY");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test05()  throws Throwable  {
      Option option0 = OptionBuilder.create("zjV");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withLongOpt("gkUHi");
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create(":T=v89+o=NKb`plN]7)");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ':T=v89+o=NKb`plN]7)' contains an illegal character : ':'
         //
