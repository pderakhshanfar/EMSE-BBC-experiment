...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("@=D;Zbs]`");
      Option option0 = OptionBuilder.create('f');
      assertEquals((-1), option0.getArgs());
      assertEquals(102, option0.getId());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.hasArgs(331);
      Option option0 = OptionBuilder.create('O');
      assertEquals(331, option0.getArgs());
      assertEquals("O", option0.getOpt());
  }
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withLongOpt(">]a2eM!YaRA");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test17()  throws Throwable  {
      try { 
        OptionBuilder.create("a=T!@zMsczc\"eE");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'a=T!@zMsczc\"eE' contains an illegal character : '='
         //
