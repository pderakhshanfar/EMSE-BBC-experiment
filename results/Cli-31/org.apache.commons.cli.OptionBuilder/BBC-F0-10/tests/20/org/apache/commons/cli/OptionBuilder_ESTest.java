...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("m;WaiP$Mq");
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("mr*J]AV*-M");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'mr*J]AV*-M' contains an illegal character : '*'
         //
  ...
  public void test21()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt(".Dn:8u3MHlg");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
