...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test14()  throws Throwable  {
      try { 
        OptionBuilder.create("73O<");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '73O<' contains an illegal character : '<'
         //
  ...
  public void test19()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("sUHt9( -");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("G~P/RWM\"/uSrLwcdl ");
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
  }
