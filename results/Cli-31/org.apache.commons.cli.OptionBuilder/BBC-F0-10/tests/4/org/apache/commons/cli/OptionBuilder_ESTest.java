...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionBuilder.withLongOpt("tB)t3k?!#uJv");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.hasArgs(1758);
      Option option0 = OptionBuilder.create('C');
      assertEquals("C", option0.getOpt());
      assertEquals(1758, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      OptionBuilder.isRequired();
      OptionBuilder.withLongOpt("Ty>oFK4Qp<Z0@~");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("CM#@>VJxA>PYx12Q");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'CM#@>VJxA>PYx12Q' contains an illegal character : '#'
         //
