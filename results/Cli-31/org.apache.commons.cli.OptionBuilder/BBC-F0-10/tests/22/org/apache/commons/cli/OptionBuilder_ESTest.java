...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.hasArgs(1810);
      Option option0 = OptionBuilder.create((String) null);
      assertEquals(1810, option0.getArgs());
  }
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("DWgni=");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'DWgni=' contains an illegal character : '='
         //
  ...
  public void test21()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("\"-rq1yxC");
      assertNotNull(optionBuilder0);
  }
