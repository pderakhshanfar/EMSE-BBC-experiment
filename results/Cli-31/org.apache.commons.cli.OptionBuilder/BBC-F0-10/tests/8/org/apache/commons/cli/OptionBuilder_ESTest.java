...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.hasArgs(3356);
      Option option0 = OptionBuilder.create('I');
      assertEquals(3356, option0.getArgs());
      assertEquals("I", option0.getOpt());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("e,2sa/N1RN6");
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("f3 ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'f3 ' contains an illegal character : ' '
         //
  ...
  public void test17()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("9t lYO36ty*xV");
      assertNotNull(optionBuilder0);
  }
