...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2212);
      Option option0 = OptionBuilder.create("");
      assertEquals(2212, option0.getArgs());
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("(]' yM]Wk+p$");
  ...
  public void test10()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("Tlod[o7 N.{Ll9nqm");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("D~KQXJL\"Ls~q");
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("Tlod[o7 N.{Ll9nqm");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'Tlod[o7 N.{Ll9nqm' contains an illegal character : '['
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
