...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt(".b'.BM6ow lvlsYTZ");
  ...
  public void test12()  throws Throwable  {
      try { 
        OptionBuilder.create("hI[AM1S7C[{K|03");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'hI[AM1S7C[{K|03' contains an illegal character : '['
         //
  ...
  public void test17()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription(".b'.BM6ow lvlsYTZ");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test27()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.hasArgs((-2010));
