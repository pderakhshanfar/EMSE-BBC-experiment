...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2064);
  ...
  public void test15()  throws Throwable  {
      try { 
        OptionBuilder.create("iz~Dggw@.cF<L3I ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'iz~Dggw@.cF<L3I ' contains an illegal character : '~'
         //
  ...
  public void test27()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("B+NG~e;8Qf0+SZH|s");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
}
