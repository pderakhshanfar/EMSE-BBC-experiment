...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(681);
      OptionBuilder.withLongOpt("i)+g624}]U'c*");
      Option option0 = OptionBuilder.create();
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("<b3b]9lc1H9m&L_[Vw");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '<b3b]9lc1H9m&L_[Vw' contains an illegal character : '<'
         //
