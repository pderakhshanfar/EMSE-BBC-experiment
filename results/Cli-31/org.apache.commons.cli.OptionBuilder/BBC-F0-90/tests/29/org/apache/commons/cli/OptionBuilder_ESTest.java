...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("tkLz?XQwN?a");
  ...
  public void test16()  throws Throwable  {
      try { 
        OptionBuilder.create("^WGXZ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '^WGXZ' contains an illegal character : '^'
         //
  ...
  public void test21()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("QJu");
      assertNotNull(optionBuilder0);
  }
