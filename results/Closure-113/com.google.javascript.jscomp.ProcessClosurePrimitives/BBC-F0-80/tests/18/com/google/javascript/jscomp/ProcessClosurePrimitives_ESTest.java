...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("X-<\"p6", true);
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("jQuery.expandegEach");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("com.goo=ge");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test06()  throws Throwable  {
      ...
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      Node node0 = Node.newString("y_4E(j\"L#/c/<w,");
  ...
  public void test07()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((double) 38, 38, 130);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
  ...
  public void test08()  throws Throwable  {
      ...
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      Node node0 = new Node(105, (-2044), (-2156));
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("jQuery.expandegdEach");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test11()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(3720.73470271406, (-2015), (-2015));
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      CheckLevel checkLevel0 = CheckLevel.WARNING;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      processClosurePrimitives0.process(node0, node0);
