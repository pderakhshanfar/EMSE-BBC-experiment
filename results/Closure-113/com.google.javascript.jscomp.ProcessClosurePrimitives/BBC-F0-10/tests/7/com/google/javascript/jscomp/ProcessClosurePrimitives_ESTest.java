...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try { 
        compiler0.parseTestCode("rH=yBC/b");
  ...
  public void test3()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(160, "hy.@`a|Ppv", 1189, (-3537));
  ...
  public void test4()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("rH=yBC/bE");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test5()  throws Throwable  {
      ...
      Node node1 = new Node(132, node0, node0, node0, (-3276), (-58));
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      // Undeclared exception!
  ...
  public void test6()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(105, "com.google.javascript.jscomp.parsing.JsDocTokenStream", 105, 105);
      Node node1 = new Node(2769, node0);
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
  ...
  public void test8()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("com.SooAlG=e");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
