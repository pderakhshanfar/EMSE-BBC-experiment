...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString((-951), "O]y+n$baR<");
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("goog.bFase");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test04()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(86, "(8bC@/Cb?[9Kfs(");
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("com.google.javascript.jscomp.NodeUtil");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test06()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(105, "disambiguatePrivateProperties");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      CheckLevel checkLevel0 = CheckLevel.ERROR;
  ...
  public void test07()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(2700, "disambiguatePrivateProperties");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
  ...
  public void test10()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((-1806.451268596), 2173, 1837);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("disambiguatePrivateProperties");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
