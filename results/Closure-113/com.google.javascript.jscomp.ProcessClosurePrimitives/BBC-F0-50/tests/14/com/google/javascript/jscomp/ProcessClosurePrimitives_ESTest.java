...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Node node0 = Node.newString(105, "c=m.go", 105, 105);
      Compiler compiler0 = new Compiler();
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      Node node1 = new Node(43, node0, 4, 16);
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("c=m.go");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test06()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString((int) (byte)86, "", 38, 38);
      CheckLevel checkLevel0 = CheckLevel.OFF;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("msg.not.class.not.pkg");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test09()  throws Throwable  {
      ...
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      Compiler compiler1 = new Compiler();
      Node node0 = compiler1.parseTestCode("Hashing.sha512()");
  ...
  public void test11()  throws Throwable  {
      ...
      Node node1 = new Node(37, node0, 36, (-3511));
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
