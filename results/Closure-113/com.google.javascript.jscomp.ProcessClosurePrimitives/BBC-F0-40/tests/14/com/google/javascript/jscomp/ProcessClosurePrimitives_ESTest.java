...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        Normalize.parseAndNormalizeTestCode(compiler0, "oog.base");
  ...
  public void test01()  throws Throwable  {
      ...
      Node node1 = new Node(132, node0, node0, 10, 2369);
  ...
  public void test03()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(86, ")-map(", 2859, 1066);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      CheckLevel checkLevel0 = CheckLevel.OFF;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      // Undeclared exception!
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseSyntheticCode("cm.gooa|igle", "msg.return.inconsistent");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test09()  throws Throwable  {
      ...
      nodeArray0[0] = node0;
      Node node1 = new Node(2066, nodeArray0);
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, compilerOptions0.checkGlobalNamesLevel);
      processClosurePrimitives0.visit(nodeTraversal0, node0, node0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("W.YV=fWqacKbF");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("WhYV=fWqacKbq");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
