...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("com.gogle.javscript.jscom.type.SemanticReverseAbstractIterpreter$RestrictByTrueInstanceOfResultVisitor");
  ...
  public void test3()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("May only be called directly.");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test5()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("K=WI6&h");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test6()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("com.google.javascript.jscomp.type.SemanticReverseAbstractInterpreter$RestrictByTrueInstanceOfResultVisitor");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test9()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("com.google.javascript.jscomp.TightenTypes$NativeCallFunctionCall");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
