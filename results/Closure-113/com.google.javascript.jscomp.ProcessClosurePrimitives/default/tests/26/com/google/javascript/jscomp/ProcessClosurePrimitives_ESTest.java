...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(1328.2462608);
      // Undeclared exception!
      try { 
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("com.google.javascript.jscomp.CodingConvention$DelegateRelationship");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("ChXSource.empty()");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test07()  throws Throwable  {
      ...
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      Node node0 = Node.newString("Enclosing method does not match ", 87, 87);
      Node node1 = new Node(37, node0, 2701, 1);
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("hpXor=e.e3ty");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("com.goole.javascript.jscomp.ProcessClos,rePrimitives");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("CharSorceempty()");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test12()  throws Throwable  {
      ...
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      Node node0 = Node.newString(86, "xBg!j");
      processClosurePrimitives0.visit(nodeTraversal0, node0, node0);
