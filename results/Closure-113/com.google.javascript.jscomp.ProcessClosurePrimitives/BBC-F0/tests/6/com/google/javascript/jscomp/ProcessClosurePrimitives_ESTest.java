...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        Normalize.parseAndNormalizeTestCode(compiler0, "JSC_LATE_PROVIDE_ERROR");
  ...
  public void test03()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(242.659395);
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        Normalize.parseAndNormalizeTestCode(compiler0, "%Yl+qORJO+");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      ...
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      Node node1 = new Node(130, 130, 38);
      // Undeclared exception!
      try { 
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        Normalize.parseAndNormalizeTestCode(compiler0, "com.google.javascript.rhino.JSDocInfo$NamePosition");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test07()  throws Throwable  {
      ...
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "Invalid CSS name map style {0}");
      Node node1 = new Node(33, node0, Integer.MIN_VALUE, 50);
  ...
  public void test08()  throws Throwable  {
      ...
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      Node node1 = new Node(105, 105, 50);
      Node node2 = new Node(51, node1, 39, 2);
  ...
  public void test09()  throws Throwable  {
      ...
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "Invalid CSS name map style {0}");
      Node node1 = new Node(105, node0, 55, 52);
      // Undeclared exception!
      try { 
        processClosurePrimitives0.visit(nodeTraversal0, node1, node0);
  ...
  public void test10()  throws Throwable  {
      ...
      Node node1 = new Node(86, node0, node0, node0, (-2278), (-1));
      processClosurePrimitives0.visit(nodeTraversal0, node1, node1);
  ...
  public void test14()  throws Throwable  {
      ...
      CompilerOptions compilerOptions0 = new CompilerOptions();
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, compilerOptions0.checkGlobalThisLevel);
      Node node0 = Node.newNumber(2.147483647E9, 0, 40);
      // Undeclared exception!
      try { 
