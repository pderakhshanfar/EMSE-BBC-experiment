...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      String string0 = ".x=qAkcuue,xu!\\uld";
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        Normalize.parseAndNormalizeTestCode(compiler0, "Am.gKogle");
  ...
  public void test06()  throws Throwable  {
      ...
      SyntacticScopeCreator syntacticScopeCreator0 = new SyntacticScopeCreator(compiler0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0, syntacticScopeCreator0);
      String string0 = "Vx=qAkcuue,xu!\\uld";
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, string0);
  ...
  public void test07()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      Node.newNumber(39.108204419409006);
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      // Undeclared exception!
      try { 
        Normalize.parseAndNormalizeTestCode(compiler0, "com.google.common.collect.ImmutableSortedMap");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test08()  throws Throwable  {
      ...
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      SyntacticScopeCreator syntacticScopeCreator0 = new SyntacticScopeCreator(compiler0);
      Node node0 = Node.newString(105, "goog.dispose", (-2157), 30);
      Node node1 = new Node(2161, node0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0, syntacticScopeCreator0);
  ...
  public void test09()  throws Throwable  {
      ...
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      Node node0 = Node.newString(105, "goog.dispose", 105, 105);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0, syntacticScopeCreator0);
      // Undeclared exception!
      try { 
        processClosurePrimitives0.visit(nodeTraversal0, node0, node0);
  ...
  public void test11()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(378.10831548573);
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      processClosurePrimitives0.process(node0, node0);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("frVL=fq");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseSyntheticCode("co.goole", "goog.base");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
