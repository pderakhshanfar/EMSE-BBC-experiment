...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Node node0 = Node.newString(587, "goog.base", 105, 488);
      ...
      SourceFile sourceFile0 = SourceFile.fromCode("JSC_TOO_MANY_ARGUMENTS_ERROR", "JSC_TOO_MANY_ARGUMENTS_ERROR", "goog.base");
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      SourceFile sourceFile0 = SourceFile.fromCode("msg.equal.as.assign", "msg.equal.as.assign", "msg.equal.as.assign");
      // Undeclared exception!
      try { 
        compiler0.parse(sourceFile0);
       //  fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      ...
      Node node0 = Node.newString((-2281), "b");
      CheckLevel checkLevel0 = CheckLevel.WARNING;
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
  ...
  public void test06()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(105, "t{jpe");
      CheckLevel checkLevel0 = CheckLevel.WARNING;
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
  ...
  public void test07()  throws Throwable  {
      Node node0 = Node.newString(130, "b");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      Compiler compiler0 = new Compiler();
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      Node node1 = new Node(37, node0, 55, 55);
      processClosurePrimitives0.visit(nodeTraversal0, node1, node1);
      assertEquals(4, Node.FLAG_ARGUMENTS_UNMODIFIED);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseSyntheticCode("O9YvD(XFMa@2L?f\"", "goog.base");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
