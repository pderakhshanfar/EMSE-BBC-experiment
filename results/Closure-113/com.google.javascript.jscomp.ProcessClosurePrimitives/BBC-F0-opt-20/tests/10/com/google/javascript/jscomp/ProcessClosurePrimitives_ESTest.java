...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseSyntheticCode("com.google.javascript.jscomp.graph.LinkedDirectedGraph$AnnotatedLinkedDirectedGraphEdge", "");
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseSyntheticCode("com.google.jaIascriptjjscomp.graph.LinkedDirectedGrap.$AnnotatedLinkedDirectedGraphEdge", "com.google.jaIascriptjjscomp.graph.LinkedDirectedGrap.$AnnotatedLinkedDirectedGraphEdge");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test04()  throws Throwable  {
      ...
      Node node1 = new Node((-1151292537), node0, node0, node0, 4095, 30);
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseSyntheticCode("co.google.jaIascriptjjscomp.graph.LinkedDirectedGrap.$AnnotatedLinkedDirectedGraphEdge", "co.google.jaIascriptjjscomp.graph.LinkedDirectedGrap.$AnnotatedLinkedDirectedGraphEdge");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseSyntheticCode("co.google.jaIascriptjscomp.graph.LinkedDirectedGrap.$AnnotatedLinkedDirectedGraphEge", "O=H");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseSyntheticCode("msg.jsdoc", "goog.base");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Vr0O-OETE<AiH%k");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      Compiler compiler0 = new Compiler(mockPrintStream0);
      Node node0 = Node.newString("F~M$\"P8_6Khb");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
