...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("{,#jV1xzX1");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      Node node1 = new Node(86, node0, node0, 945, 86);
      // Undeclared exception!
      try { 
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("gog.nherits");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test07()  throws Throwable  {
      ...
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      CheckLevel checkLevel0 = CheckLevel.WARNING;
      Node node1 = new Node(105, node0, node0, 39, 12);
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      Node node2 = new Node(40, node1, node1, 132, 93);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        Normalize.parseAndNormalizeTestCode(compiler0, "Wo,");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("Zr=$6> XtPP");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
