...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node0 = Node.newNumber(642.4911363, (-1185), (-2697));
  ...
  public void test01()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(862, "ll)*-q.W6(aI-6");
  ...
  public void test03()  throws Throwable  {
      ...
      Node node0 = Node.newNumber((-2854.35399554), 43, 0);
  ...
  public void test04()  throws Throwable  {
      ...
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      Node node0 = Node.newString(38, "ez;mj.rXVk(n");
      processClosurePrimitives0.visit(nodeTraversal0, node0, node0);
  ...
  public void test05()  throws Throwable  {
      ...
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      Node node0 = Node.newString(130, "method \"{0}\" called with invalid argument");
      // Undeclared exception!
      try { 
        processClosurePrimitives0.visit(nodeTraversal0, node0, node0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test06()  throws Throwable  {
      ...
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      Node node1 = new Node(33, node0, node0, 3842, (-2952));
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
  ...
  public void test07()  throws Throwable  {
      ...
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      Node node0 = Node.newString(105, "com.google.javascript.jscomp.SourceMap$1");
      Node node1 = new Node(36, node0, node0, 4095, 37);
      processClosurePrimitives0.visit(nodeTraversal0, node0, node0);
  ...
  public void test11()  throws Throwable  {
      ...
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      Node node0 = Node.newString(86, "c^'o}jJ*h7\"uWi6");
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      processClosurePrimitives0.visit(nodeTraversal0, node0, node0);
  ...
  public void test12()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      Node node0 = Node.newString(1113, "");
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
  ...
  public void test13()  throws Throwable  {
      ...
      CheckLevel checkLevel0 = CheckLevel.OFF;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      Node node0 = Node.newNumber((double) 53, 43, 48);
