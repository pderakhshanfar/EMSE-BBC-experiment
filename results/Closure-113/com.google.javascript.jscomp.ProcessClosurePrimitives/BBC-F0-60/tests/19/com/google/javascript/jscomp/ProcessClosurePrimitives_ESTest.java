...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node0 = new Node(105, 1012, 4095);
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseSyntheticCode(" 4pw", "goog.base");
       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
      } catch(IllegalArgumentException e) {
         //
  ...
  public void test06()  throws Throwable  {
      File file0 = MockFile.createTempFile("method \"{0}\" expected an object string argument", "method \"{0}\" called without an argument");
      MockPrintStream mockPrintStream0 = new MockPrintStream(file0);
      Compiler compiler0 = new Compiler(mockPrintStream0);
      CheckLevel checkLevel0 = CheckLevel.WARNING;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0, (ScopeCreator) null);
      Node node0 = Node.newString(86, "method \"{0}\" called without an argument", 86, 39);
      processClosurePrimitives0.visit(nodeTraversal0, node0, node0);
  ...
  public void test08()  throws Throwable  {
      ...
      Node node1 = new Node(33, 3072, 10);
  ...
  public void test09()  throws Throwable  {
      ...
      CheckLevel checkLevel0 = CheckLevel.WARNING;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      Node node1 = new Node(105, 0, 4095);
  ...
  public void test10()  throws Throwable  {
      ...
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, (PreprocessorSymbolTable) null, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0, (ScopeCreator) null);
      Node node1 = new Node(37, 40, 1909);
      node1.addChildrenToFront(node0);
      processClosurePrimitives0.visit(nodeTraversal0, node1, node0);
