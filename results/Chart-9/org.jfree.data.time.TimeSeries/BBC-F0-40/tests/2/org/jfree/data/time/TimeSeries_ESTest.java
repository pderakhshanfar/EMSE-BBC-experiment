...
public class TimeSeries_ESTest extends TimeSeries_ESTest_scaffolding {
  ...
  public void test001()  throws Throwable  {
      ...
      timeSeries1.setMaximumItemCount(3506);
      boolean boolean0 = timeSeries1.equals(timeSeries0);
      assertEquals(3506, timeSeries1.getMaximumItemCount());
      assertFalse(boolean0);
  }
  ...
  public void test005()  throws Throwable  {
      ...
      TimeSeries timeSeries0 = new TimeSeries("r%#xsa", class0);
  ...
  public void test014()  throws Throwable  {
      ...
      TimeSeries timeSeries0 = new TimeSeries(second0, "dpK>*rtAl~1", "dpK>*rtAl~1", class0);
      timeSeries0.setRangeDescription("x<(x");
      assertEquals("x<(x", timeSeries0.getRangeDescription());
  }
  ...
  public void test015()  throws Throwable  {
      ...
      TimeSeries timeSeries0 = new TimeSeries(hour0, "6:}3tlK^N gmM:@pB7", "uU$n$", class0);
      timeSeries0.setDomainDescription("6:}3tlK^N gmM:@pB7");
      assertEquals(9223372036854775807L, timeSeries0.getMaximumItemAge());
      assertEquals(Integer.MAX_VALUE, timeSeries0.getMaximumItemCount());
      assertEquals("6:}3tlK^N gmM:@pB7", timeSeries0.getDomainDescription());
      assertEquals("uU$n$", timeSeries0.getRangeDescription());
  }
  ...
  public void test021()  throws Throwable  {
      ...
      TimeSeries timeSeries0 = new TimeSeries(minute0, "<{ ,#%sd^<#*v", "<{ ,#%sd^<#*v", class0);
      BigInteger bigInteger0 = BigInteger.ZERO;
      timeSeries0.addOrUpdate((RegularTimePeriod) minute0, (Number) bigInteger0);
      Number number0 = timeSeries0.getValue((RegularTimePeriod) minute0);
      assertNotNull(number0);
      assertEquals("<{ ,#%sd^<#*v", timeSeries0.getRangeDescription());
      assertEquals(Integer.MAX_VALUE, timeSeries0.getMaximumItemCount());
      assertEquals("<{ ,#%sd^<#*v", timeSeries0.getDomainDescription());
      assertEquals(9223372036854775807L, timeSeries0.getMaximumItemAge());
  }
  ...
  public void test023()  throws Throwable  {
      ...
      TimeSeries timeSeries1 = new TimeSeries(minute0, "Null 'start' argument.", "WycYvo-S 1.>9s(]%", class0);
      ...
      assertEquals("WycYvo-S 1.>9s(]%", timeSeries1.getRangeDescription());
  }
  ...
  public void test026()  throws Throwable  {
      Minute minute0 = new Minute();
      TimeSeries timeSeries0 = new TimeSeries(minute0);
      timeSeries0.addOrUpdate((RegularTimePeriod) minute0, 3561.0);
  ...
  public void test029()  throws Throwable  {
      Minute minute0 = new Minute();
      Class<Quarter> class0 = Quarter.class;
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(0, 59, 59, 1, 59, 1);
  ...
  public void test031()  throws Throwable  {
      Minute minute0 = new Minute();
      TimeSeries timeSeries0 = new TimeSeries("r%#xsa");
      timeSeries0.addOrUpdate((RegularTimePeriod) minute0, (Number) 59);
  ...
  public void test034()  throws Throwable  {
      Minute minute0 = new Minute();
      MockDate mockDate0 = new MockDate(0, 4418, 4418, (-115), 237, (-1550));
      Month month0 = new Month(mockDate0, minute0.DEFAULT_TIME_ZONE);
      Class<Minute> class0 = Minute.class;
      TimeSeries timeSeries0 = new TimeSeries(month0, (String) null, "y8ckg75S#C", class0);
      String string0 = timeSeries0.getDomainDescription();
      assertEquals("y8ckg75S#C", timeSeries0.getRangeDescription());
      assertEquals(Integer.MAX_VALUE, timeSeries0.getMaximumItemCount());
      assertNull(string0);
      assertEquals(9223372036854775807L, timeSeries0.getMaximumItemAge());
  }
  ...
  public void test036()  throws Throwable  {
      ...
      Class<Quarter> class0 = Quarter.class;
      TimeSeries timeSeries0 = new TimeSeries(minute0, class0);
      timeSeries0.addOrUpdate((RegularTimePeriod) minute0, (-2.147483658888064E9));
      assertEquals(1, timeSeries0.getItemCount());
  ...
  public void test045()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeSeries0.update((-2076), (Number) minute0.FIRST_MINUTE_IN_HOUR);
  ...
  public void test047()  throws Throwable  {
      Minute minute0 = new Minute();
      Class<XYDatasetTableModel> class0 = XYDatasetTableModel.class;
      TimeSeries timeSeries0 = new TimeSeries(minute0, "r%#xsa", "*v=y", class0);
      // Undeclared exception!
      try { 
  ...
  public void test076()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(0, (-3578), 17);
  ...
  public void test082()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeSeries0.addOrUpdate((RegularTimePeriod) minute0, (-1731.0));
        fail("Expecting exception: NullPointerException");
  ...
  public void test085()  throws Throwable  {
      TimeSeries timeSeries0 = new TimeSeries("*v=y");
      Integer integer0 = JLayeredPane.DRAG_LAYER;
      Class<Week> class0 = Week.class;
  ...
  public void test095()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeSeries0.add((RegularTimePeriod) null, (double) 2214);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test096()  throws Throwable  {
      ...
      try {
        timeSeries0 = new TimeSeries((Comparable) null, "$+c_8)frG6=<", ")VS\"V]cZ/yrr", class0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test109()  throws Throwable  {
      Class<Integer> class0 = Integer.class;
      TimeSeries timeSeries0 = new TimeSeries(")K5lrPLj", class0);
      // Undeclared exception!
      try { 
  ...
  public void test115()  throws Throwable  {
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(0, 0, 0, 0, 29);
      Class<ScrollPane> class0 = ScrollPane.class;
      TimeSeries timeSeries0 = new TimeSeries(mockGregorianCalendar0, class0);
      // Undeclared exception!
      try { 
        timeSeries0.getTimePeriod((-2224));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test122()  throws Throwable  {
      ...
      TimeSeries timeSeries0 = new TimeSeries(minute0, "u2ND=3^:/", (String) null, class0);
      timeSeries0.hashCode();
      assertEquals(9223372036854775807L, timeSeries0.getMaximumItemAge());
      assertEquals("u2ND=3^:/", timeSeries0.getDomainDescription());
      assertEquals(Integer.MAX_VALUE, timeSeries0.getMaximumItemCount());
  }
  ...
  public void test123()  throws Throwable  {
      Class<Minute> class0 = Minute.class;
      TimeSeries timeSeries0 = new TimeSeries("createInstance", (String) null, "Null 'start' argument.", class0);
      timeSeries0.hashCode();
      assertEquals(9223372036854775807L, timeSeries0.getMaximumItemAge());
      assertEquals(Integer.MAX_VALUE, timeSeries0.getMaximumItemCount());
  ...
  public void test128()  throws Throwable  {
      ...
      TimeSeries timeSeries0 = new TimeSeries(minute0, "createInstance", "", class1);
      TimeSeries timeSeries1 = new TimeSeries(minute0, "createInstance", "?nKGWqF>", class0);
      boolean boolean0 = timeSeries1.equals(timeSeries0);
      assertEquals(9223372036854775807L, timeSeries1.getMaximumItemAge());
      assertFalse(boolean0);
  ...
  public void test129()  throws Throwable  {
      ...
      TimeSeries timeSeries0 = new TimeSeries(minute0);
      TimeSeries timeSeries1 = (TimeSeries)timeSeries0.clone();
      timeSeries1.setDomainDescription("tOr_");
      boolean boolean0 = timeSeries0.equals(timeSeries1);
      assertEquals("tOr_", timeSeries1.getDomainDescription());
      assertFalse(boolean0);
  }
  ...
  public void test131()  throws Throwable  {
      Minute minute0 = new Minute();
      MockDate mockDate0 = new MockDate(501, 501, (-4559), 268, 0, 0);
  ...
  public void test138()  throws Throwable  {
      FixedMillisecond fixedMillisecond0 = new FixedMillisecond();
      Class<Object> class0 = Object.class;
      TimeSeries timeSeries0 = new TimeSeries(fixedMillisecond0, "Null 'categoryKeys' argument.", "Null 'categoryKeys' argument.", class0);
      // Undeclared exception!
      try { 
        timeSeries0.createCopy(3, (-729));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test139()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeSeries0.createCopy((-4559), 2517);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test144()  throws Throwable  {
      ...
      timeSeries0.removeAgedItems((long) (-571), false);
  ...
  public void test158()  throws Throwable  {
      ...
      assertEquals(9223372036854775807L, timeSeries0.getMaximumItemAge());
      assertEquals(Integer.MAX_VALUE, timeSeries0.getMaximumItemCount());
      assertEquals("*v=y", timeSeries0.getRangeDescription());
      assertEquals("r%#xsa", timeSeries0.getDomainDescription());
  }
  ...
  public void test167()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeSeries0.setMaximumItemCount((-1676));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test173()  throws Throwable  {
      ...
      TimeSeries timeSeries0 = new TimeSeries(second0, "dpK>*rtAl~1", "dpK>*rtAl~1", class0);
      timeSeries0.getItems();
      assertEquals("dpK>*rtAl~1", timeSeries0.getRangeDescription());
      assertEquals(Integer.MAX_VALUE, timeSeries0.getMaximumItemCount());
      assertEquals(9223372036854775807L, timeSeries0.getMaximumItemAge());
      assertEquals("dpK>*rtAl~1", timeSeries0.getDomainDescription());
  }
