...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be(":-(E7@k|t\"_+e");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u3A00\u2D00\u2800\u4500\u3700\u4000\u6B00\u7C00\u7400\u2200\u5F00\u2B00\u6500", string0);
  }
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("*|y_biq9L[1");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("\u00FE\u00FF\u0000*\u0000|\u0000y\u0000_\u0000b\u0000i\u0000q\u00009\u0000L\u0000[\u00001", string0);
  }
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii(" <4T3O");
      assertArrayEquals(new byte[] {(byte)32, (byte)60, (byte)52, (byte)84, (byte)51, (byte)79}, byteArray0);
  }
  ...
  public void test21()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("xr", "UTF-16BE");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("bxlAtq$EN1NOjtf>k", "1bE");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 1bE: java.io.UnsupportedEncodingException: 1bE
         //
  ...
  public void test27()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "p7_");
      assertNull(string0);
  }
  ...
  public void test30()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "ow$0");
      boolean boolean0 = StringUtils.equals((CharSequence) "ow$0", (CharSequence) charBuffer0);
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "O|m-kR-9yc7pZ", (CharSequence) "");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "\u726A\u5241\u6E5A\u3024\u6C42\uFFFD", (CharSequence) null);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "O|m-kR-9yc7pZ");
      assertFalse(boolean0);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      CharBuffer charBuffer1 = CharBuffer.wrap((CharSequence) charBuffer0, 1708, 1708);
      // Undeclared exception!
      try { 
  ...
  public void test40()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("d@rF2:@r+[I4 XMe");
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "$CNh`-Und");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // $CNh`-Und: java.io.UnsupportedEncodingException: $CNh`-Und
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
