...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("1*3d", "\u312A\u3364");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // \u312A\u3364: java.io.UnsupportedEncodingException: \u312A\u3364
         //
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("?<.it]kTS,h ", "UTF-16");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "% t/P3;&");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // % t/P3;&: java.io.UnsupportedEncodingException: % t/P3;&
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("-VYQ#3rY@/f1/$3", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "%95)5`(T}");
      assertNull(string0);
  }
  ...
  public void test32()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "\uAF00\u0000\u0000\u0000", 1, 1);
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) "\uAF00\u0000\u0000\u0000", (CharSequence) charBuffer0);
  ...
  public void test33()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "%95)5`(T}", (CharSequence) null);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "QbzC[]}X}yMGZ");
      assertFalse(boolean0);
  }
  ...
  public void test37()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8(":N!I");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals(":N!I", string0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("zl]M/T@zY(");
  ...
  public void test43()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("YUTF-16LE");
  ...
  public void test49()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("YUTF-16LE");
      assertEquals(18, byteArray0.length);
  }
}
