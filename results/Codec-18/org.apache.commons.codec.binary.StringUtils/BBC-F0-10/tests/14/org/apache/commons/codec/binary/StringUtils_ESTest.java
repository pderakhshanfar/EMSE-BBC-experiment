...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test23()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("M^mn`LA", (String) null);
  ...
  public void test25()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("1c6J&#T~BB ON)IEr");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "1|jyj0hi.HF");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 1|jyj0hi.HF: java.io.UnsupportedEncodingException: 1|jyj0hi.HF
         //
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) "\u406B\u283B\u3D2B", (CharSequence) charBuffer0);
  ...
  public void test30()  throws Throwable  {
      ...
      CharBuffer charBuffer0 = CharBuffer.wrap(charArray0, 0, (int) (byte)1);
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "yPEjGb");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "zNtvrzEN4^70Kl<\"gAZ", (CharSequence) "zNtvrzEN4^70Kl<\"gAZ");
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "zNtvrzEN4^70Kl<\"gAZ", (CharSequence) "\u4E7A\u7674\u7A72\u4E45\u5E34\u3037\u6C4B\u223C\u4167\uFFFD");
      assertFalse(boolean0);
  }
  ...
  public void test36()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("zNtvrzEN4^70Kl<\"gAZ");
      // Undeclared exception!
      try { 
  ...
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("VIRU$-];q");
      assertArrayEquals(new byte[] {(byte)86, (byte)73, (byte)82, (byte)85, (byte)36, (byte)45, (byte)93, (byte)59, (byte)113}, byteArray0);
  }
  ...
  public void test44()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("1|jyj0hi.HF", "US-ASCII");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertNotNull(string0);
      assertEquals("\u7C31\u6A7F\u6A79\u6830\u2E69\u4648", string0);
  }

  @Test(timeout = 4000)
  public void test45()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("zNtvrzEN4^70Kl<\"gAZ");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("zNtvrzEN4^70Kl<\"gAZ", string0);
  }
  ...
  public void test46()  throws Throwable  {
      ...
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertNotNull(string0);
      assertEquals("1|jyj0hi.HF", string0);
  }
  ...
  public void test47()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "xl!<s");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // xl!<s: java.io.UnsupportedEncodingException: xl!<s
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test48()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("x1!~x+M?o`c/qaGV");
