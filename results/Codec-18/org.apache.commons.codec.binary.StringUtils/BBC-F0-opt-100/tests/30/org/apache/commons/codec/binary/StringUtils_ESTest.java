...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test23()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("NZ1~[V");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "NZ1~[V");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // NZ1~[V: java.io.UnsupportedEncodingException: NZ1~[V
         //
  ...
  public void test29()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "", (CharSequence) "\uB2FF");
  ...
  public void test37()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("jBvI+QC6Q 'VZ42HM)H");
      assertEquals("java.nio.HeapByteBuffer[pos=0 lim=19 cap=19]", byteBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("!0Yhek?^?4V]mM{VIe/");
