...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("2?8b|.");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u323F\u3862\u7C2E", string0);
  }
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("1')uB4_9\\R");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("1')uB4_9\\R", string0);
  }
  ...
  public void test10()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("jCs]ovqd>b57P [");
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("\u0000\u0000\u00CF\u0000\u0001");
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte) (-49), (byte)0, (byte)0, (byte)0, (byte)1}, byteArray0);
  }
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("<>s^tz", "2?8b|.");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 2?8b|.: java.io.UnsupportedEncodingException: 2?8b|.
         //
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "*Py].p#p5fL'8Fz(Jk");
  ...
  public void test26()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("2R86", "US-ASCII");
  ...
  public void test28()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "\u7200\u00FF\u0000\uFFFD", (CharSequence) "\uFFFD\uFFFDr\u0000\u0000\u0000\u0000");
  ...
  public void test29()  throws Throwable  {
      ...
      boolean boolean0 = StringUtils.equals((CharSequence) "\u0001\u0000l\u0000\u0000", (CharSequence) charBuffer0);
      assertFalse(boolean0);
  }
  ...
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16(" 7P");
      // Undeclared exception!
      try { 
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, ";##ug");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // ;##ug: java.io.UnsupportedEncodingException: ;##ug
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
