...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("2zdEjv]2%'O$");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("2zdEjv]2%'O$", string0);
  }
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("0f&)c(");
  ...
  public void test13()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("2zdEjv]2%'O$");
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("[vC_|mk");
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("rTmS.-59($5/[-k", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("US-ASCII", "fd2=.R$o&kg_s1");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // fd2=.R$o&kg_s1: java.io.UnsupportedEncodingException: fd2=.R$o&kg_s1
         //
  ...
  public void test25()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate(425);
      CharBuffer charBuffer1 = CharBuffer.wrap((CharSequence) charBuffer0, 1, 425);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "7cNb4NF/E");
      assertNull(byteArray0);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("&Y%AjgsZZnTS|iZwj8", "UTF-8");
  ...
  public void test31()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "UTF-16BE", (CharSequence) "h8T$)t]^gU7x");
  ...
  public void test34()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "2zdEjv]2%'O$", (CharSequence) "2zdEjv]2%'O$");
      assertTrue(boolean0);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "8n>Yn~(U{@5fxk");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 8n>Yn~(U{@5fxk: java.io.UnsupportedEncodingException: 8n>Yn~(U{@5fxk
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
