...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("4H]/ 6V\"ZB6tr");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("4H]/ 6V\"ZB6tr", string0);
  }
  ...
  public void test04()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("=zo9gOs`w{'DA*");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u3D7A\u6F39\u674F\u7360\u777B\u2744\u412A", string0);
  }
  ...
  public void test06()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("w@j74a8(oEHMnF@%| X");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u7700\u4000\u6A00\u3700\u3400\u6100\u3800\u2800\u6F00\u4500\u4800\u4D00\u6E00\u4600\u4000\u2500\u7C00\u2000\u5800", string0);
  }
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("UU;");
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("!7,alrUy");
      assertEquals(16, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("AB^L5z?");
      assertEquals(16, byteArray0.length);
  }
  ...
  public void test21()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("nKocRH)/knC8@@W$(\"/", "US-ASCII");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("y`Vk6l)ph{8V^", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "0d^xki");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 0d^xki: java.io.UnsupportedEncodingException: 0d^xki
         //
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "\u3D7A\u6F39\u674F\u7360\u777B\u2744\u412A");
  ...
  public void test33()  throws Throwable  {
      char[] charArray0 = new char[5];
      CharBuffer charBuffer0 = CharBuffer.wrap(charArray0);
      boolean boolean0 = StringUtils.equals((CharSequence) "=zo9gOs`w{'DA*", (CharSequence) charBuffer0);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "", (CharSequence) "4H]/ 6V\"ZB6tr");
      assertFalse(boolean0);
  }
  ...
  public void test40()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("$w\"7fZ4h^");
      assertArrayEquals(new byte[] {(byte)36, (byte)119, (byte)34, (byte)55, (byte)127, (byte)102, (byte)90, (byte)52, (byte)104, (byte)94}, byteArray0);
  }
  ...
  public void test48()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "+~t=L#;)V");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // +~t=L#;)V: java.io.UnsupportedEncodingException: +~t=L#;)V
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
