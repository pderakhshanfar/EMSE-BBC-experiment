...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("3Hj7c%-6vXa%? [.<#C");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("\u00003\u0000H\u0000j\u00007\u0000c\u0000%\u0000-\u00006\u0000v\u0000X\u0000a\u0000%\u0000?\u0000 \u0000[\u0000.\u0000<\u0000#\u0000C", string0);
  }
  ...
  public void test02()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("}TD^i");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("}TD^i", string0);
  }
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("W_7`", "UTF-16LE");
      String string0 = StringUtils.newString(byteArray0, "UTF-16LE");
      assertEquals("W_7`", string0);
  }
  ...
  public void test21()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("YC91rR3TJ");
      assertEquals(9, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("[aSTR&2<[\";C>jFMW:");
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("xyA45J56!,<?F4w&:", "\"{wfL13OX9(7}g");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // \"{wfL13OX9(7}g: java.io.UnsupportedEncodingException: \"{wfL13OX9(7}g
         //
  ...
  public void test25()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "$Wu80>O0=u@\"!AuBo");
      assertNull(string0);
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("%3/} U*}r", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8(":&_~PH+lid)o");
      assertFalse(byteBuffer0.isReadOnly());
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "$iQg~O,Rjj5w$aw>zC&", (CharSequence) "");
  ...
  public void test30()  throws Throwable  {
      ...
      boolean boolean0 = StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "\u019A\u0001\u01C8\u2B01");
      assertFalse(boolean0);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "m-z)!w^e,\"RvN2<b{!_");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // m-z)!w^e,\"RvN2<b{!_: java.io.UnsupportedEncodingException: m-z)!w^e,\"RvN2<b{!_
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test48()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("3Hj7c%-6vXa%? [.<#C");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("3Hj7c%-6vXa%? [.<#C", string0);
  }
}
