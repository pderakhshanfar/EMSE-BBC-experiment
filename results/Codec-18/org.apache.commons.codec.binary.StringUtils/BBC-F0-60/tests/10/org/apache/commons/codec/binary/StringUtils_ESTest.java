...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("k\"\"h7b$*V?;N{eHm");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u6B22\u2268\u3762\u242A\u563F\u3B4E\u7B65\u486D", string0);
  }
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("B%ppU*Me");
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("/q:g<df][");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "s.LnfQftI7,,E");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // s.LnfQftI7,,E: java.io.UnsupportedEncodingException: s.LnfQftI7,,E
         //
  ...
  public void test33()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "", (CharSequence) "i\u00F6\u001A}");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test34()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "k\"\"h7b$*V?;N{eHm");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test35()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "\u00DA\u00FF\r", (CharSequence) "\u00DA\u00FF\r");
      assertTrue(boolean0);
  }
  ...
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("N,`']0uRn.TeW");
      assertEquals(28, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("I(Q!CKeUH{YH#11yn");
  ...
  public void test42()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("bIkc/2%SzlM)~");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u6249\u6B63\u2F32\u2553\u7A6C\u4D29\uFFFD", string0);
  }
  ...
  public void test45()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("{FVq0*D&rM/ex#}");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u467B\u7156\u2A30\u2644\u4D72\u652F\u2378\uFFFD", string0);
  }
  ...
  public void test49()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "39x+T8[)C}#H");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 39x+T8[)C}#H: java.io.UnsupportedEncodingException: 39x+T8[)C}#H
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
