...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("==JqJ`C&,_&`");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("\u0000=\u0000=\u0000J\u0000q\u0000J\u0000`\u0000C\u0000&\u0000,\u0000_\u0000&\u0000`", string0);
  }
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("6B4TQ^{pqprw'yR<@");
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("HY9n>x WM>m|&xZ+");
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1(":+UG]aSwU#p");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals(":+UG]aSwU#p", string0);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "==JqJ`C&,_&`");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // ==JqJ`C&,_&`: java.io.UnsupportedEncodingException: ==JqJ`C&,_&`
         //
  ...
  public void test25()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "YnM?z,y:ZOV<@li");
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("`Hx|U&C.a*4");
  ...
  public void test29()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "YnM?z,y:ZOV<@li");
      boolean boolean0 = StringUtils.equals((CharSequence) "YnM?z,y:ZOV<@li", (CharSequence) charBuffer0);
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "YnM?z,y:ZOV<@li", 1, 1);
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "YnM?z,y:ZOV<@li");
  ...
  public void test31()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "YnM?z,y:ZOV<@li", (CharSequence) "UTF-8");
  ...
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("'`Y*pTu");
      assertArrayEquals(new byte[] {(byte)39, (byte)96, (byte)89, (byte)42, (byte)112, (byte)84, (byte)117}, byteArray0);
  }
  ...
  public void test48()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("org.apache.commons.codec.Charsets", "vKEP~$I9U6=");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // vKEP~$I9U6=: java.io.UnsupportedEncodingException: vKEP~$I9U6=
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
