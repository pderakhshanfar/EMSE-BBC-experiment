...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("S!L[xx6!uN");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("S!L[xx6!uN", string0);
  }
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("\u3C3E\u5049\u5F23\u3D2E\u2751\uFFFD");
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("\uFFFD\uFFFD\u0000/\u0000y\u0000V\u0000Y\u0000z\u0000\u0000<\u00007\u0000@\u0000V\u0000~\u0000.", "UTF-16");
  ...
  public void test24()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("/yVYz<7@V~.");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "\u0000%\u0000;\u0000\"\u0000\"\u0000p\u0000{\u0000n\u0000?\u0000T\u0000<\u0000F\u0000^\u0000*\u0000?\u0000O\u0000x\u0000q\u0000m");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // \u0000%\u0000;\u0000\"\u0000\"\u0000p\u0000{\u0000n\u0000?\u0000T\u0000<\u0000F\u0000^\u0000*\u0000?\u0000O\u0000x\u0000q\u0000m: java.io.UnsupportedEncodingException: \u0000%\u0000;\u0000\"\u0000\"\u0000p\u0000{\u0000n\u0000?\u0000T\u0000<\u0000F\u0000^\u0000*\u0000?\u0000O\u0000x\u0000q\u0000m
         //
  ...
  public void test30()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "o|Q,yxit?iH");
      assertNull(byteArray0);
  }
  ...
  public void test35()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "\u0000\u00D9\u00FF\u0001\u0092\u0000\u0001\u009A\u0001", (CharSequence) "\u0000\u00D9\u00FF\u0001\u0092\u0000\u0001\u009A\u0001");
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test36()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "\uFFFD\uFFFD\u0000/\u0000y\u0000V\u0000Y\u0000z\u0000\u0000<\u00007\u0000@\u0000V\u0000~\u0000.", (CharSequence) "\uFFFD\uFFFD\u0000/\u0000y\u0000V\u0000Y\u0000z\u0000\u0000<\u00007\u0000@\u0000V\u0000~\u0000.");
      assertTrue(boolean0);
  }
  ...
  public void test40()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("<>PI_#=.'Q-");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u3C3E\u5049\u5F23\u3D2E\u2751\uFFFD", string0);
  }
  ...
  public void test41()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("S!L[xx6!uN");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("S\u0000!\u0000L\u0000[\u0000x\u0000x\u00006\u0000!\u0000u\u0000N\u0000", string0);
  }

  @Test(timeout = 4000)
  public void test42()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("/O-Vi4}cc6={o~wH");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u2F4F\u2D56\u6934\u7D63\u6336\u3D7B\u6F7E\u7748", string0);
  }
  ...
  public void test47()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("a/K:1P-[CH|G#", ": ");
        fail("Expecting exception: IllegalStateException");
