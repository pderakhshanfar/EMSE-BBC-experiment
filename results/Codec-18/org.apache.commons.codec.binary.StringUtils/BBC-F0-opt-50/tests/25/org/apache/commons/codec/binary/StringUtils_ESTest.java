...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("[tams,*CI^!si");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u5B00\u7400\u6100\u6D00\u7300\u2C00\u2A00\u4300\u4900\u5E00\u2100\u7300\u6900", string0);
  }
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("1dW");
      assertArrayEquals(new byte[] {(byte)0, (byte)49, (byte)0, (byte)100, (byte)0, (byte)87}, byteArray0);
  }
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("a6[{`sf]~", "UTF-8");
      String string0 = StringUtils.newString(byteArray0, "US-ASCII");
      assertEquals("a6[{`sf]~", string0);
  }
  ...
  public void test21()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1(")~gQV}~[|^?\"GJv");
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("K RH..<^*hA", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test25()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "S;T)rbd<bNU=G");
      assertNull(string0);
  }
  ...
  public void test30()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "a6[{`sf]~");
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "\u7E29\u5167\u7D56\u5B7E\u5E7C\u223F\u4A47\uFFFD");
  ...
  public void test32()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "[tams,*CI^!si", (CharSequence) null);
  ...
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("-_gC61eLj]g!C");
  ...
  public void test43()  throws Throwable  {
      ...
      assertEquals("[tams,*CI^!si", string0);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "[tams,*CI^!si");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // [tams,*CI^!si: java.io.UnsupportedEncodingException: [tams,*CI^!si
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
