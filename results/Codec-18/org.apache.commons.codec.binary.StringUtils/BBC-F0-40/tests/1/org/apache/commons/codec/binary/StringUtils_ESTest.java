...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("\uFFFD\uFFFD\u0000D\u0000{\u0000B\u0000s\u0000V\u0000$\u0000V\u0000|\u0000E\u0000`\u0000\"");
  ...
  public void test20()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("D{BsV$V|E`\"");
      assertEquals(11, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("\uFFFD\uFFFD\u0000D\u0000{\u0000B\u0000s\u0000V\u0000$\u0000V\u0000|\u0000E\u0000`\u0000\"", "UTF-8");
  ...
  public void test24()  throws Throwable  {
      ...
      try { 
        StringUtils.newString(byteArray0, "H(wM*QRYg1Amh.=");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // H(wM*QRYg1Amh.=: java.io.UnsupportedEncodingException: H(wM*QRYg1Amh.=
         //
  ...
  public void test33()  throws Throwable  {
      ...
      CharBuffer charBuffer0 = CharBuffer.wrap(charArray0);
      boolean boolean0 = StringUtils.equals((CharSequence) "\u5CB1\uFFFD", (CharSequence) charBuffer0);
  ...
  public void test40()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("D{BsV$V|E`\"");
      assertFalse(byteBuffer0.isReadOnly());
  }

  @Test(timeout = 4000)
  public void test41()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("Xao7qDNj*LpL_0D");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("Xao7qDNj*LpL_0D", string0);
  }
  ...
  public void test45()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("D{BsV$V|E`\"");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\uFEFFD{BsV$V|E`\"", string0);
  }
  ...
  public void test49()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "i\"r6I0'lvA");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // i\"r6I0'lvA: java.io.UnsupportedEncodingException: i\"r6I0'lvA
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
