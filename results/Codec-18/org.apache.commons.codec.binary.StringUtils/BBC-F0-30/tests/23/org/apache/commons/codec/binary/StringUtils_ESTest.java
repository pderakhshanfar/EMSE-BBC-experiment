...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("", "$rNAmtOB. 81Y");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // $rNAmtOB. 81Y: java.io.UnsupportedEncodingException: $rNAmtOB. 81Y
         //
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("rk`^w`'h>");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u6B72\u5E60\u6077\u6827\uFFFD", string0);
  }
  ...
  public void test11()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("rk`^w`'h>");
  ...
  public void test24()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("yKL|");
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("t4aw6mgIBs6 ;");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "t4aw6mgIBs6 ;");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // t4aw6mgIBs6 ;: java.io.UnsupportedEncodingException: t4aw6mgIBs6 ;
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) "\u0000\u0000\u00F3\u0000\u0000\u0000\u0000\u00F3", (CharSequence) charBuffer0);
  ...
  public void test30()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "`-d6?cV");
      assertNull(byteArray0);
  }
  ...
  public void test33()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "\uA66A");
      boolean boolean0 = StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "\uA66A");
      assertTrue(boolean0);
  }
  ...
  public void test35()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "\u00FF\u0004\u0000d\u0001\u0000");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test36()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "\u00FF\u0004\u0000d\u0001\u0000", (CharSequence) "\u00FF\u0004\u0000d\u0001\u0000");
      assertTrue(boolean0);
  }
