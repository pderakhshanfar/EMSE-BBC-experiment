...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("men_``=}p0r'");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("men_``=}p0r'", string0);
  }
  ...
  public void test23()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("/dA(y9@v/");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u2F64\u4128\u7939\u4076\uFFFD", string0);
  }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "RoFHw<@C&+DtbV");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // RoFHw<@C&+DtbV: java.io.UnsupportedEncodingException: RoFHw<@C&+DtbV
         //
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "Z");
  ...
  public void test35()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "men_``=}p0r'", (CharSequence) null);
      assertFalse(boolean0);
  }
  ...
  public void test38()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) ";O,`M!c}BJ2ugwRC&", (CharSequence) "Z");
      assertFalse(boolean0);
  }
  ...
  public void test40()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("J(Gw0HEOJmhHGV");
      assertEquals(30, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test41()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("%vptf-]\nF^4NHHS::T");
  ...
  public void test50()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("xd_Pi{<?aA2-");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "xd_Pi{<?aA2-");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // xd_Pi{<?aA2-: java.io.UnsupportedEncodingException: xd_Pi{<?aA2-
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
