...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("s)M1_{L4/gB");
      assertEquals(12, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("S( [7JmW");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u5300\u2800\u2000\u5B00\u3700\u4A00\u6D00\u5700", string0);
  }
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("o5URW8YJ");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "gyw>`#<&BG#I)!I9_M0");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // gyw>`#<&BG#I)!I9_M0: java.io.UnsupportedEncodingException: gyw>`#<&BG#I)!I9_M0
         //
  ...
  public void test25()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "U69Qlp5");
      assertNull(string0);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.equals((CharSequence) "\u5500\u5400\u4600\u2D00\u3100\u3600\u4C00\u4500", (CharSequence) charBuffer0);
  ...
  public void test29()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "", (CharSequence) "\u5300\u2800\u2000\u5B00\u3700\u4A00\u6D00\u5700");
  ...
  public void test31()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "\u8D01");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "\u00B1\u00FF\u00FF\u00B3\u00C3\u0000\u00E6\u0000", (CharSequence) "\u00B1\u00FF\u00FF\u00B3\u00C3\u0000\u00E6\u0000");
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "'im#8y*@).BW>5Tef");
      boolean boolean0 = StringUtils.equals((CharSequence) charBuffer0, (CharSequence) "'im#8y*@).BW>5Tef");
      assertTrue(boolean0);
  }
  ...
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("'im#8y*@).BW>5Tef");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("'im#8y*@).BW>5Tef", string0);
  }
  ...
  public void test47()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("UTF-16BE", "g._m9%tp[U+jft}C");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // g._m9%tp[U+jft}C: java.io.UnsupportedEncodingException: g._m9%tp[U+jft}C
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
