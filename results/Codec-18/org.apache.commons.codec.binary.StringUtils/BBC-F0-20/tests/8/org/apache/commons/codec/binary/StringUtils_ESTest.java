...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("[T9i=#0", "4~zGrFLIN");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // 4~zGrFLIN: java.io.UnsupportedEncodingException: 4~zGrFLIN
         //
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("[Z|Py");
      String string0 = StringUtils.newString(byteArray0, "UTF-16");
      assertEquals("\u5B5A\u7C50\uFFFD", string0);
  }
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("/\"F5b-YV$-lT/C");
  ...
  public void test24()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("x+vI");
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("S\u0000\u00FF\u0000D", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "&js");
      assertNull(byteArray0);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("fR", "US-ASCII");
  ...
  public void test35()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "@Z|l");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test36()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "\u00FF\u00C1\u0000\u000E\u0000", (CharSequence) "\u00FF\u00C1\u0000\u000E\u0000");
      assertTrue(boolean0);
  }
  ...
  public void test39()  throws Throwable  {
      ByteBuffer byteBuffer0 = StringUtils.getByteBufferUtf8("}F2");
  ...
  public void test43()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("Tv@4xa@r[*/h_");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "ETQuIIUE7U/3U%8&");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // ETQuIIUE7U/3U%8&: java.io.UnsupportedEncodingException: ETQuIIUE7U/3U%8&
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
