...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("XwpuE:PAQ,7n{");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u5877\u7075\u453A\u5041\u512C\u376E\uFFFD", string0);
  }
  ...
  public void test18()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("bnMON AkesD@");
  ...
  public void test21()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("\u00F9\u00DF\u009E", "ISO-8859-1");
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, ".[&M3");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // .[&M3: java.io.UnsupportedEncodingException: .[&M3
         //
  ...
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "XwpuE:PAQ,7n{");
      assertNull(byteArray0);
  }
  ...
  public void test36()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "}])hdC{lzWT");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test37()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "\u00003\uFFFD\uFFFD\uFFFD\u0000\uFFFD\u0000p", (CharSequence) "\u00003\uFFFD\uFFFD\uFFFD\u0000\uFFFD\u0000p");
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "UTF-16LE", (CharSequence) "\uC1C1");
      assertFalse(boolean0);
  }
  ...
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("XwpuE:PAQ,7n{");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("XwpuE:PAQ,7n{", string0);
  }
  ...
  public void test42()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("TOs]37");
      assertArrayEquals(new byte[] {(byte)84, (byte)79, (byte)115, (byte)93, (byte)51, (byte)55}, byteArray0);
  }
  ...
  public void test48()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("BdiP|4a4");
      String string0 = StringUtils.newStringIso8859_1(byteArray0);
      assertEquals("\u0000B\u0000d\u0000i\u0000P\u0000|\u00004\u0000a\u00004", string0);
  }
  ...
  public void test49()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("", "D\f,PCD:S%>hRyIM~u");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // D\f,PCD:S%>hRyIM~u: java.io.UnsupportedEncodingException: D\f,PCD:S%>hRyIM~u
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
