...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("7;$n", "-,%q3s");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // -,%q3s: java.io.UnsupportedEncodingException: -,%q3s
         //
  ...
  public void test06()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("7;$n");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u373B\u246E", string0);
  }
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("OyW/nRo4EQq;");
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("L|w'Sm*L$Fs(b*FFH_1", "ISO-8859-1");
  ...
  public void test25()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le(">8yTp{UZ");
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, ">8yTp{UZ");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // >8yTp{UZ: java.io.UnsupportedEncodingException: >8yTp{UZ
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate(3188);
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.allocate(3290);
  ...
  public void test32()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) null, (CharSequence) "r>@(F@lAJv}nih");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) ">,yTp{UZ", (CharSequence) ">,yTp{UZ");
      assertTrue(boolean0);
  }
  ...
  public void test38()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("#l\"~4Qh[cOdP.");
  ...
  public void test46()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be(">,yTp{UZ");
      String string0 = StringUtils.newStringUsAscii(byteArray0);
      assertEquals("\u0000>\u0000,\u0000y\u0000T\u0000p\u0000{\u0000U\u0000Z", string0);
  }
}
