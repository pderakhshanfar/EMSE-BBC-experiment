...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        StringUtils.getBytesUnchecked("?<y)2v6P&VFjoL~Z7", "/k^iGve(*l*UY");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // /k^iGve(*l*UY: java.io.UnsupportedEncodingException: /k^iGve(*l*UY
         //
  ...
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("Xe(");
      assertArrayEquals(new byte[] {(byte)88, (byte)0, (byte)101, (byte)0, (byte)40, (byte)0}, byteArray0);
  }
  ...
  public void test23()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("q lC4-h(?+\"s1uWM;");
  ...
  public void test26()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "^E7u");
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      String string0 = StringUtils.newString((byte[]) null, "\u4843\u5E41\u2A4A");
      assertNull(string0);
  }
  ...
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked((String) null, "o`73tCk");
      assertNull(byteArray0);
  }
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        StringUtils.getBytesUnchecked("e`&6:v", (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("^E7u");
  ...
  public void test51()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        StringUtils.newString(byteArray0, "(2%Pn");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // (2%Pn: java.io.UnsupportedEncodingException: (2%Pn
         //
         verifyException("org.apache.commons.codec.binary.StringUtils", e);
      }
  }
