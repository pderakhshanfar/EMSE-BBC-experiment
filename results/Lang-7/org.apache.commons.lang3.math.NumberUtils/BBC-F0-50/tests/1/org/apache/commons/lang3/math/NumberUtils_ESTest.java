...
public class NumberUtils_ESTest extends NumberUtils_ESTest_scaffolding {
  ...
  public void test008()  throws Throwable  {
      ...
      floatArray0[0] = 629.082F;
      float float0 = NumberUtils.max(floatArray0);
      assertEquals(629.082F, float0, 0.01F);
  }
  ...
  public void test121()  throws Throwable  {
      boolean boolean0 = NumberUtils.isNumber("0Ee,-+K]b");
      assertFalse(boolean0);
  }
  ...
  public void test176()  throws Throwable  {
      double[] doubleArray0 = new double[8];
      doubleArray0[6] = (-278.2838);
      double double0 = NumberUtils.min(doubleArray0);
      assertEquals((-278.2838), double0, 0.01);
  }
  ...
  public void test204()  throws Throwable  {
      try { 
        NumberUtils.createNumber("-|-/wc~l");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // -|-/wc~l is not a valid number.
         //
         verifyException("org.apache.commons.lang3.math.NumberUtils", e);
      }
  }
  ...
  public void test215()  throws Throwable  {
      try { 
        NumberUtils.createNumber("b;{@we$*T(E~bB`1");
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"b;{@we$*\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test235()  throws Throwable  {
      int int0 = NumberUtils.toInt("24D");
      assertEquals(0, int0);
  }
