...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.8850660818128273, 0.8850660818128273);
      Vector3D vector3D2 = new Vector3D(841951.3932356868, vector3D1);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-916.579093722), 0.5039018405998233);
      Vector3D vector3D1 = new Vector3D((-916.579093722), vector3D0);
      ...
      assertEquals((-1.2627577146532202E-13), vector1D0.getX(), 0.01);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals(8.570521012652944E-14, vector3D2.getX(), 0.01);
      assertEquals(0.8145636477476377, vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1434.54351659), (-1434.54351659));
  ...
  public void test08()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(0.0, vector3D0, 0.0, vector3D1, 1774.2748395197027, vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D3 = line0.toSpace(vector1D0);
      assertEquals(2.817525182579991E-13, vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, 1774.2748395197027, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-2.817525182579991E-13), vector3D2.getZ(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-916.579093722), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D((-916.579093722));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-442.5666111548193), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.885066, 0.885066);
      Vector3D vector3D1 = new Vector3D(841951.3932356868, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-894.47), vector3D0, (-894.47), vector3D0, (-894.47), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-894.47));
      assertEquals((-894.4699999999999), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(981.7153129, 0.5039018405998233);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-916.579093722), 0.5039018);
      Vector3D vector3D1 = new Vector3D((-916.579093722), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.pointAt(0.5039018);
      assertEquals(0.5039018, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-696.6728), vector3D0, 1859.257132117093, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(6.365530825383405E-14, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-2.1845553024095605E-17), vector3D2.getZ(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(6.365530825383405E-14, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      assertEquals((-2.279464804362624E-14), vector3D3.getY(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.5085046372863781), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(922.66, vector3D0, 1.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test25()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2392.31), (-4018.1011), 1.9987994582857286E-8);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.8592380707604217), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1053.2305679206877), 1.986821492305628E-8);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D(1079.4, vector3D1, 1079.4, vector3D1, (-1053.2305679206877), vector3D1);
  ...
  public void test27()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-696.6728), vector3D0, 1859.257132117093, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D0.subtract(248.511553087714, (Vector<Euclidean3D>) vector3D1);
      double double0 = line0.getAbscissa(vector3D2);
      assertEquals(288914.6379698615, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-6.032174644509064E-23), 0.0, (-6.032174644509064E-23));
      Vector3D vector3D1 = vector3D0.negate();
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-8.530783192867821E-23), double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(3.002389718708615E-14, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      assertEquals(2.1949352865390734E-67, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-6.032174644509064E-23), (-6.032174644509064E-23));
      Vector3D vector3D1 = new Vector3D(1.3567386664610137E-30, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test33()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(4.051998268890633E-27, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      assertEquals(2.942091015256665E-14, vector3D3.getNormInf(), 0.01);
  }
...
//      }
  ...
  public void test52()  throws Throwable  {
      ...
      doubleArray0[0] = (-2594.2189);
      doubleArray0[1] = 2145.6;
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D((-2594.2189), vector3D0, 0.0, vector3D0);
      Vector3D vector3D2 = new Vector3D((-2594.2189), vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
...
//      }
  ...
  public void test59()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(205.00871173145);
