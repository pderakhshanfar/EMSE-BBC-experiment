...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(5514.06183965517, vector3D0, 0.0, vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(446.5557246, vector3D0, 1.0E-10, vector3D1);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2.482533099729323E-9, 2.482533099729323E-9, 1925.0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(5514.06183965517, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(1545.8158734944464);
      Vector1D vector1D1 = new Vector1D((-1.0), vector1D0);
      Vector3D vector3D2 = line0.toSpace(vector1D1);
      assertEquals(2389546.714747399, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1439.6), (-1.0), 3.141592653489793);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test09()  throws Throwable  {
      ...
      Vector1D vector1D0 = new Vector1D(1545.8158734944464);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(2389546.714747397, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-2133.838864), (-0.0013888888689039883));
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Vector3D vector3D2 = new Vector3D(3153.53547834877, vector3D0, 0.0, vector3D0, 680.17022135835, vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D3 = line0.toSpace(vector1D0);
      assertEquals((-0.9999999896813306), vector3D3.getZ(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-3072.120286116988), 3585.768897210217, 3.0393850847862046E7);
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, (-2133.838864), (-0.0013888888689039883));
      Vector3D vector3D1 = new Vector3D(3153.53547834877, vector3D0, 0.0, vector3D0, 680.17022135835, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-0.1428571423679182));
      assertEquals(0.020408162824848503, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(5514.06183965517, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1771.08277028626);
      assertEquals(1771.0827702862598, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0E-10, 517.649134634, 0.0);
      Vector3D vector3D1 = new Vector3D(2185.9515228774, vector3D0, 1.0, vector3D0, 1.0, vector3D0, 753.31691784866, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1.0E-10);
      assertEquals(2.1276893231780518E-10, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1056.0), 414.92501888144, (-456.05));
      Vector3D vector3D1 = new Vector3D(31.311203, vector3D0, 31.311203, vector3D0, 31.311203, vector3D0, (-1056.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(4.364668871991289E-11, vector3D2.getZ(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(1.7677837533018628E-13, vector3D2.getNormInf(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals(0.9999999896813306, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-8.0E298), vector3D0, 0.0, vector3D0, (-8.0E298), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test23()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.2902978688821848E-12, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-158.19059291888496), vector3D0, (-454.815), vector3D0);
      Vector3D vector3D2 = vector3D1.scalarMultiply((-1843.231));
      Line line0 = new Line(vector3D2, vector3D1);
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1439.6), (-1.0), 3.141592653489793);
      Vector3D vector3D1 = new Vector3D((-782.2258255329659), 3.141592653489793);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(0.9995467651704049, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals(6.4097366786687545E-9, double0, 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = new Vector3D(0.0, 5514.06183965517, (-3305.63942084796));
      line0.reset(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.closestPoint(line1);
      assertEquals((-3.588402798864393E-21), vector3D3.getY(), 0.01);
  }
...
//      }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.1007608020989448E77, 2388.4, 0.999999060934881);
      Vector3D vector3D1 = new Vector3D((-708.781241), vector3D0, (-708.781241), vector3D0, 2.1007608020989448E77, vector3D0);
...
//      }
  ...
  public void test47()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1056.0), 414.92501888144, (-456.05));
      Vector3D vector3D1 = new Vector3D((-1056.0), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test48()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-4155.04217114), (-2719.2304306), 3585.768897210217);
      Vector3D vector3D1 = new Vector3D((-2719.2304306), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
//      try { 
...
//      }
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, (-4155.04217114), (-1.0));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D((-4155.04217114), vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
      Line line1 = new Line(vector3D2, vector3D1);
      double double0 = line1.distance(line0);
      assertEquals(1.7570355210225194E-13, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test55()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.141592653489793, (-4155.04217114), (-1.0));
      Vector3D vector3D1 = new Vector3D((-1.0), vector3D0, (-4155.04217114), vector3D0, (-2719.2304306), vector3D0, 3.141592653489793, vector3D0);
      Vector3D vector3D2 = new Vector3D((-4155.04217114), vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
  ...
  public void test57()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(2.482533099729323E-9, 2.482533099729323E-9, 1925.0);
      Line line1 = new Line(vector3D0, vector3D2);
      boolean boolean0 = line1.isSimilarTo(line0);
      assertTrue(boolean0);
  }
