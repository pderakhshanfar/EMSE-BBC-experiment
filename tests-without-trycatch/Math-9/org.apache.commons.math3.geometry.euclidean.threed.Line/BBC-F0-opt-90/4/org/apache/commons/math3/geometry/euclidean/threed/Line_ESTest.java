...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.316632856843034E-9, 1.316632856843034E-9);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.893485277253286E-8, 2.893485277253286E-8, 2968.815862669692);
      Vector3D vector3D1 = new Vector3D(2968.815862669692, vector3D0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, 2968.815862669692);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
  ...
  public void test08()  throws Throwable  {
      ...
      doubleArray0[2] = 6.902532920683853E-31;
      Vector3D vector3D0 = new Vector3D(doubleArray0);
      Vector3D vector3D1 = new Vector3D(6.902532920683853E-31, vector3D0, 6.902532920683853E-31, vector3D0, 522.96605039, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line1.pointAt(522.96605039);
      line0.reset(vector3D2, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D3 = line1.toSpace(vector1D0);
      assertEquals(6.902532920683853E-31, vector1D0.getX(), 0.01);
      assertEquals((-6.90253292068307E-31), vector3D3.getZ(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(496.68285, vector3D0, 2.220446049250313E-16, vector3D0, 2.220446049250313E-16, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.9999999999999848, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt((-1885.5883));
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2968.815862669692, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(987.2);
      assertEquals(987.2000000000004, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D(0.0, 2968.815862669692);
      Vector3D vector3D2 = new Vector3D(2968.815862669692, vector3D0);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.pointAt(1.625);
      assertEquals((-0.017557827776259003), vector3D3.getZ(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1228.1825032175993, vector3D0, 3.141592653489793, vector3D0, 0.75, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(9.740370795293624E-17, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, 1.883511811213715E-8);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(1.1788861827309068E-8, vector3D2.getDelta(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.0), Double.NEGATIVE_INFINITY);
      Line line0 = new Line(vector3D0, vector3D0);
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, 1.0E-10, 1.7976931348623157E308);
  ...
  public void test26()  throws Throwable  {
      ...
      assertEquals(7.046256284828085E-9, double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-1.1788861827309066E-8), double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D1);
      assertEquals(2.795496072086923E-17, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      double double0 = line0.distance(line1);
      assertEquals(6.088021351246066E-25, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.19454771280288696, vector3D0, 1.2252023265836421E11, vector3D0, 0.19454771280288696, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(2.0324559808237611E-7, vector3D2.getNormInf(), 0.01);
  }
...
//      }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.13683241131024E30, 701.267320578878, 1.13683241131024E30);
      Vector3D vector3D1 = new Vector3D((-568.624400696), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
//      try { 
        line0.revert();
...
//      }
  ...
  public void test37()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.7976931348623157E308), (-1096.5516595004858));
...
//      }
  ...
  public void test47()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.893485277253286E-8, 2.893485277253286E-8, 2968.815862669692);
      Vector3D vector3D1 = new Vector3D(0.0, 2968.815862669692);
      Vector3D vector3D2 = new Vector3D(2.893485277253286E-8, vector3D0, 987.2, vector3D1, (-3257.131684744), vector3D0);
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3250.53, 0.0, 0.0);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 1.0, vector3D0, (-4056.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
//      try { 
...
//      }
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-240.35736789), 438.73525805, 0.5403022766113281);
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.999995259906745, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1.1723985142638293), 1.2252023265836421E11, 1.2252023265836421E11);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
...
//      }
  ...
  public void test57()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.8770099200837155), vector3D2.getY(), 0.01);
  }
  ...
  public void test61()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.0041701601513955, vector3D2.getNorm1(), 0.01);
  }
}
