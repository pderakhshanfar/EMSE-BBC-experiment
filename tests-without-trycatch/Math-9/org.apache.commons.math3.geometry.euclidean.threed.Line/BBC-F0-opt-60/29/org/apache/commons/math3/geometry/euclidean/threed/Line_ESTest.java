...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1167.425), (-5221.807584), (-503.223218191));
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.2770138083746616E7, 1.2770138083746616E7);
      Vector3D vector3D1 = new Vector3D(1363.55750770398, vector3D0, 1363.55750770398, vector3D0, 0.0, vector3D0, 1363.55750770398, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1167.425), (-5221.807584), (-503.223218191));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D((-5239.9714570336));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(6720.170078597846, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.ZERO;
      Vector3D vector3D1 = new Vector3D(1661.0, 1661.0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1.915617824643883);
      assertEquals((-1.915617824643883), vector3D2.getZ(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1167.425), (-5221.807584), (-503.223218191));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-5221.807584));
      assertEquals(5073.614199750812, vector3D2.getNormInf(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(3184.45206983281, 4.440892098500626E-16, 2883.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.9478055512371406, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-309.98639075045), (-309.98639075045));
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(0.7203749025816163, vector3D2.getNormInf(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1548.87046, vector3D0, 1548.87046, vector3D0, 1548.87046, vector3D0, 1548.87046, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(2.2290054375060196E-26, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(3408.06451, vector3D0, 1.8458793889202133E7, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(1293.9024865304, (-1167.425), 3408.06451);
      line0.reset(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(2461.0376361884278, vector3D3.getNorm1(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(0.902267575263977, 1.7976931348623157E308, 1.0E-10);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals((-0.9716376786918844), vector3D2.getY(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-1.0000000034181198), double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(380.83687210762, 380.83687210762, 0.99);
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = line0.revert();
      double double0 = line1.distance(line0);
      assertEquals(2.9224700857848234E-20, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.closestPoint(line0);
      line0.toSubSpace(vector3D2);
      assertEquals(0.9956239544780116, vector3D2.getNorm(), 0.01);
      assertEquals(0.9912670587304336, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = Vector3D.MINUS_K;
      Vector3D vector3D2 = new Vector3D(3408.06451, vector3D1, 1.8458793889202133E7, vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = new Vector3D(1293.9024865304, (-1167.425), 3408.06451);
      Line line1 = new Line(vector3D3, vector3D0);
      Vector3D vector3D4 = line1.closestPoint(line0);
      assertEquals(2.397540930839921, vector3D4.getNorm1(), 0.01);
  }
...
//      }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(0.902267575263977, 1.7976931348623157E308, 0.5600347255632354);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
//      try { 
        line0.revert();
...
//      }
  ...
  public void test49()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D((-2.6033824355191673E-8), vector3D0, (-2.6033824355191673E-8), vector3D1);
...
//      }
  ...
  public void test50()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(622.24037);
      assertEquals(0.7842617754179833, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(3408.06451, vector3D1, 1.8458793889202133E7, vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = new Vector3D(1.8020262536739122, vector3D2, 1.8458793889202133E7, vector3D2);
      Line line1 = new Line(vector3D3, vector3D0);
