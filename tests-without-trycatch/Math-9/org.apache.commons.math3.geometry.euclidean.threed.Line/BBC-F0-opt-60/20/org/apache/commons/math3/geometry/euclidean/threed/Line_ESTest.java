...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1964.11463666569), vector3D0, 0.0, vector3D0);
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(1.0E-10, vector3D0, 0.0, vector3D0, 1.0E-10, vector3D0, (-1964.11463666569), vector3D0);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1506343.8382240003, 1506343.8382240003, 1506343.8382240003);
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-0.16624879837036133), 4.9E-324, 1.0E-10);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(974.58, vector3D0, 974.58, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(7.560057121134267E-17, vector3D2.getX(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-0.16624879837036133), (-0.16624879837036133), 1.0E-10);
      Vector3D vector3D1 = new Vector3D((-0.16624879837036133), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.633123935319537E16, vector3D0, 1.633123935319537E16, vector3D0, 1.633123935319537E16, vector3D0, 215.5409490595127, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(974.58, vector3D0, 974.58, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(56.61);
      assertEquals((-56.61), vector3D2.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      assertEquals(0.11755565269179756, vector3D2.getY(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.4895252506784152E13, 835.03705360073, (-417.990333));
      Vector3D vector3D1 = new Vector3D(0.11113807559013367, vector3D0, 1.4895252506784152E13, vector3D0, (-1173.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1.4895252506784152E13);
      assertEquals(418.87740939138394, vector3D2.getZ(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(1.8525801564202366E-33, vector3D2.getNormSq(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.5081864081662722E10, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-83.9806), vector3D0, 816.0292745312026, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-5.3057111498068044E-14), vector3D2.getX(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(2866.8, vector3D0, 0.24740394949913025, vector3D0, 957.763501260059, vector3D0, (-282.41), vector3D1);
      Line line0 = new Line(vector3D2, vector3D1);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(0.9945394996566996, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-8.0E298), vector3D0, 4289.47498, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(184.6399601312041, vector3D0, 184.6399601312041, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D((-86.36), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals(0.9999999999999963, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(184.6399601312041, vector3D0, 184.6399601312041, vector3D0);
      Line line0 = new Line(vector3D1, vector3D2);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals((-0.002707962926202653), double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Vector3D vector3D1 = vector3D0.orthogonal();
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(2.6670937881135714E32, (-950.796265468388), (-1319.9));
      Line line1 = new Line(vector3D1, vector3D2);
      double double0 = line0.distance(line1);
      assertEquals(4.826035566189395E-60, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(2.463382697439627E-13, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-1.5081864079947128E10), vector3D2.getX(), 0.01);
  }
...
//      }
  ...
  public void test37()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.633123935319537E16, 1.633123935319537E16, 1.633123935319537E16);
      Vector3D vector3D1 = new Vector3D(1.633123935319537E16, vector3D0, 1.633123935319537E16, vector3D0, 1.633123935319537E16, vector3D0, 215.5409490595127, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test38()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(2951.175, vector3D0, 2951.175, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test39()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1.7976931348623157E308), vector3D0, 3.145056261522308, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      // Undeclared exception!
//      try { 
