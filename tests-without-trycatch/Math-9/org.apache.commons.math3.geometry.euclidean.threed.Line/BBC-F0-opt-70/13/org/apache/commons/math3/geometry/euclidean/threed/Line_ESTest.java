...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-18.430862426757812), 0.0, (-18.430862426757812));
  ...
  public void test03()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D3);
      Line line1 = new Line(line0);
      Vector3D vector3D4 = new Vector3D(1.0E-10, vector3D2, 0.0, vector3D2);
  ...
  public void test06()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(1.0, 609.7591823910725);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2420.4131, 1.0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      assertEquals((-0.6712389165555388), vector1D0.getX(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(1377.293219035);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-1377.293219035), vector3D2.getY(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0036, 0.0036, (-2852.47943));
      Vector3D vector3D1 = new Vector3D((-211.85996064950655), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0, 609.7591823910725);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(0.7571338736908748);
      assertEquals((-0.5353744963528565), vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.0);
      Vector3D vector3D1 = new Vector3D(441.394567722037, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(0.0);
      assertEquals(7.772603426668139E-14, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-18.430862426757812), 0.0, (-18.430862426757812));
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-1428.821), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(2.509699118662708E-12, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(7.772603426668139E-14, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = new Vector3D(2.2250738585072014E-308, 0.0);
  ...
  public void test22()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.9992648607887924, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(441.394567722037, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = vector3D0.add((-3095.1724069), (Vector<Euclidean3D>) vector3D1);
      line0.reset(vector3D2, vector3D1);
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals((-26.06517561015359), double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-18.430862426757812), 0.0, (-18.430862426757812));
      Vector3D vector3D1 = new Vector3D(0.0, 4.6691377832099756E11, (-18.430862426757812));
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(line1);
      assertEquals(2.871862168026206E-20, double0, 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(6.04133640282533E-27, vector3D2.getNormSq(), 0.01);
  }
...
//      }
  ...
  public void test54()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(0.9503379527068908, vector3D2.getNorm(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test57()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-18.430862426757812), 0.0, (-18.430862426757812));
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D(0.0, 4.6691377832099756E11, (-18.430862426757812));
      Line line0 = new Line(vector3D0, vector3D2);
...
//      }
  ...
  public void test61()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-584.513), vector3D0, (-584.513), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test62()  throws Throwable  {
      ...
      Vector1D vector1D0 = line0.toSubSpace(vector3D0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(26.06517561015359, vector1D0.getX(), 0.01);
      assertEquals((-18.43086242675781), vector3D2.getZ(), 0.01);
  }
