...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(524.13367800835, vector3D0, 0.0, vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = new Vector3D(2.1394237036204812E14, 1.0E-10, 1.0E-10);
  ...
  public void test04()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(0.7390826817654208);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.7390826817654208), vector3D2.getX(), 0.01);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D2 = new Vector3D(0.0, vector3D1, (-1013.618297593237), vector3D0, (-1753.03720786135), vector3D1, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D2);
      Vector1D vector1D0 = Vector1D.ZERO;
      Vector3D vector3D3 = line0.toSpace(vector1D0);
      assertEquals((-5.278155055584733E-17), vector3D3.getZ(), 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(2.220446049250313E-16, (-1.0));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Vector3D vector3D1 = new Vector3D(1.0E-10, 0.9945001303150296);
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D2 = Vector3D.PLUS_I;
      line0.reset(vector3D1, vector3D2);
      Vector3D vector3D3 = line0.pointAt(2.1394237036204812E14);
      assertEquals((-12220.060152438788), vector3D3.getY(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(726.287892227);
      assertEquals(726.287892227, vector3D2.getX(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Vector3D vector3D2 = vector3D0.subtract(726.287892227, (Vector<Euclidean3D>) vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.pointAt(0.0);
      assertEquals((-1.5187841984459782E-13), vector3D3.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4291.7, 4291.7);
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.14030769303371748, vector3D2.getZ(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals(2.7858920790794675E-33, vector3D3.getNormSq(), 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      assertNotNull(vector3D3);
      assertEquals((-5.942668044905608E-17), vector3D3.getX(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      assertEquals(5.278155055584733E-17, vector3D3.getNorm1(), 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(5.840520683973061E-14, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-1317.63982), vector3D0, (-1738.61093476507), vector3D1, 0.0, vector3D1, 8.0E298, vector3D1);
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(1.0, 2.1405426502498366E14);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.014493870562335389, vector3D2.getX(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-467.808), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D0);
      assertEquals(3.330669073875505E-16, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-3356.68790995), vector3D0, (-467.808), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(2.5052876155442207E-29, vector3D2.getNormSq(), 0.01);
  }
...
//      }
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.85040095144011776E17, 1.0E-10);
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Vector3D vector3D2 = new Vector3D(2.85040095144011776E17, vector3D0, 1.0E-10, vector3D0, 1.0E-10, vector3D0, 2.790167807157592E11, vector3D1);
      Vector3D vector3D3 = new Vector3D(2.85040095144011776E17, vector3D2);
...
//      }
  ...
  public void test35()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-1317.63982), vector3D0, (-1738.61093476507), vector3D0, 0.0, vector3D1, 8.0E298, vector3D0);
...
//      }
  ...
  public void test52()  throws Throwable  {
      ...
      Line line1 = new Line(vector3D0, vector3D2);
      double double0 = line0.distance(line1);
      assertEquals(1.193254062912395E-18, double0, 0.01);
  }
  ...
  public void test54()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(1.0, 2.1405426502498366E14);
