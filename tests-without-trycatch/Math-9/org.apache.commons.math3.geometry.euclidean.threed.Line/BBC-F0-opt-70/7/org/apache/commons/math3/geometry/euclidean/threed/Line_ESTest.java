...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NEGATIVE_INFINITY;
      Vector3D vector3D1 = new Vector3D(3.0000000000000006E-40, 3.0000000000000006E-40, 1.47775661056E7);
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0000000000000004, vector3D0, 621.4, vector3D0);
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(4579.3342678, 1993.0850346, 1993.0850346);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-1921.58), vector3D0, (-230.6895932798), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D(0.0);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-5.120262387401963E-18), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(2.0, vector3D0, 3.764748775502684E11, vector3D0, 3.764748775502684E11, vector3D0, 2.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-0.9999540052150765), vector3D2.getZ(), 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = line0.pointAt(1099.377);
      assertEquals(Double.NaN, vector3D1.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0000000000000004, 1.0000000000000004, 3959.791109568148);
      Vector3D vector3D1 = new Vector3D(1.0000000000000004, vector3D0, 1.0000000000000004, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals((-7.888609052210118E-31), vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals(5.298766110646065E-14, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1.9999999999999991);
      line0.reset(vector3D2, vector3D1);
      assertEquals((-1.154700538379251), vector3D2.getX(), 0.01);
  ...
  public void test16()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.2325951644078307E-32, vector3D2.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-487.37), (-487.37), (-487.37));
      Vector3D vector3D1 = new Vector3D(1058.04926866945, vector3D0, (-487.37), vector3D0, (-487.37), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(8.677088351025787E-15, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-2175.860218394455), (-2175.860218394455));
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.6739802472960073, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D((-2175.860218394455), 4.440892098500626E-16);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals((-0.476576003248793), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2714.78786303094, 2714.78786303094, 2570.05732700062);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.5874617300876803), vector3D2.getY(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2570.05732700062, vector3D0, (-177.1382), vector3D0, (-177.1382), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(3959.7913621067146, double0, 0.01);
  }
  ...
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(3.0000000000000006E-40, 3.0000000000000006E-40, 1.47775661056E7);
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D1);
      assertEquals(1.1245265857827034E-23, double0, 0.01);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      assertEquals(7.309231254111639E-29, double0, 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      assertEquals(7.888609052210118E-31, vector3D2.getNorm(), 0.01);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(4377.122518645977, 4377.122518645977, 948.2);
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
...
//      }
  ...
  public void test36()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, (-4571.3330419), 1.0);
      Vector3D vector3D1 = new Vector3D(4.02906363314801E82, vector3D0, 16.000000000000014, vector3D0, 0.0, vector3D0, 4.02906363314801E82, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
//      try { 
        line0.revert();
...
//      }
  ...
  public void test38()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(1.3569192739401997E173, vector3D0, 1.3569192739401997E173, vector3D0, 1.3569192739401997E173, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test52()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.0000000672662115, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test53()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(3.1427566227306745E-25, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test55()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2.85040095144011776E17, 2.85040095144011776E17);
      Vector3D vector3D1 = new Vector3D(3846.7893733762694, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(2.85040095144011776E17, vector3D0);
