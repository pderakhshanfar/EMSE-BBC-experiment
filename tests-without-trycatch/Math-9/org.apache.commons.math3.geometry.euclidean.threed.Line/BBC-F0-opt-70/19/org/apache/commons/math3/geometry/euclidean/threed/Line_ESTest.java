...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.06666666666666667, 0.0);
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Line line0 = new Line(vector3D0, vector3D1);
      Line line1 = new Line(line0);
      Vector3D vector3D2 = line0.intersection(line1);
      assertNotNull(vector3D2);
      assertEquals(0.06637168141592921, vector3D2.getNormInf(), 0.01);
  }
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.06666666666666667, 0.0);
      Vector3D vector3D1 = new Vector3D(0.06666666666666667, vector3D0, 258.172532347, vector3D0, 0.0, vector3D0);
      Vector3D vector3D2 = vector3D1.orthogonal();
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D3 = new Vector3D(1.0E-10, vector3D2, 0.6409968137741089, vector3D0, 1.1584698355231362, vector3D1);
  ...
  public void test07()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.06666666666666667, 0.0);
      Vector3D vector3D1 = new Vector3D(0.06666666666666667, vector3D0, 258.36298035106455, vector3D0, 0.0, vector3D0);
  ...
  public void test09()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-1291.26319), (-1291.26319));
      Vector3D vector3D1 = new Vector3D((-1291.26319), vector3D0, 5.206150291559893E-8, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test11()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1363.4);
      assertEquals((-1363.4), vector3D2.getX(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt((-1439.818931));
      assertEquals(0.785889271486885, vector3D2.getAlpha(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-2.356194490192345), (-2.356194490192345), (-3210.74988));
      Vector3D vector3D1 = new Vector3D(3.906485727280598E14, vector3D0, (-2.356194490192345), vector3D0, 3.906485727280598E14, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.5689185632502325, vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1.0, (-3608.703261));
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-0.41710481816479744), vector3D2.getZ(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(298.7447, vector3D0, 0.0, vector3D0, (-3020.8), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.0461529242403793E-26, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(0.855577881648459, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test23()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.06666666666666667, 1068.0);
      Vector3D vector3D1 = vector3D0.add((Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.14103047943200392), vector3D2.getZ(), 0.01);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.06666666666666667, 0.0);
      Vector3D vector3D1 = vector3D0.add(0.06666666666666667, (Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test25()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals((-0.5176741141238717), vector3D2.getY(), 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(0.0044346007015849355, double0, 0.01);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D0);
      assertEquals(2.1279274638648832E-17, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(21.58451134801912, 0.06666666666666667, 0.0);
      Vector3D vector3D1 = Vector3D.PLUS_K;
      Vector3D vector3D2 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D1, vector3D2);
      line0.reset(vector3D1, vector3D0);
      ...
      assertEquals(2.2533068455235884E-20, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.06666666666666667, 0.0);
      Vector3D vector3D1 = new Vector3D(0.06666666666666667, 1068.0);
      Vector3D vector3D2 = vector3D1.add(0.06666666666666667, (Vector<Euclidean3D>) vector3D0);
      Vector3D vector3D3 = Vector3D.ZERO;
      Vector1D vector1D0 = new Vector1D(7.133205343806634E13);
      ...
      assertEquals((-2.895433935742937E-4), vector3D5.getX(), 0.01);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      assertEquals(5.707078735906193E-19, vector3D3.getY(), 0.01);
  }
...
//      }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(5674.898453, 0.06666666666666667, 0.0);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 258.172532347, vector3D0, 6.292828455469293E36, vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
//      try { 
        line0.revert();
...
//      }
  ...
  public void test37()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(576.3, vector3D0, 576.3, vector3D0, (-8.0E298), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test49()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D((-1599.5709918), vector3D0, 0.0, vector3D0, (-1077.0379392700584), vector3D0, (-3.5997360512765566E-9), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
//      try { 
...
//      }
  ...
  public void test50()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals((-1.1897081903605754E-15), vector3D2.getY(), 0.01);
  }
  ...
  public void test52()  throws Throwable  {
      ...
      assertEquals((-1.005999369523982E13), vector3D3.getZ(), 0.01);
...
//      }
  ...
  public void test57()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-0.06666666666666786), double0, 0.01);
  }
  ...
  public void test60()  throws Throwable  {
      ...
      assertEquals(4.820460743575089E-18, vector3D2.getY(), 0.01);
  }
