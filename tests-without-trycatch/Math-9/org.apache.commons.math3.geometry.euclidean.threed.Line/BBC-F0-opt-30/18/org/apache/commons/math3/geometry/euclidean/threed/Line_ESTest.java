...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(107.394, 4.0, 1.0E-10);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(0.4342944622039795);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(0.4342944622039795, vector3D2.getX(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.MINUS_I;
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1268868.0431009596);
      assertEquals(1268868.0431009596, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(891.8089019804121, 891.8089019804121, 891.8089019804121);
      Vector3D vector3D1 = new Vector3D(891.8089019804121, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1.852664599882474E14);
      assertEquals((-1.0696364054602369E14), vector3D2.getZ(), 0.01);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.893363312964463E12, (-0.0013888888689039883), 1.893363312964463E12);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.5000000000002641, vector3D2.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.0, 0.0, 5392858.108170678);
      Vector3D vector3D1 = new Vector3D(0.0, 1.5574076175689697);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals(0.013388311707388434, vector3D2.getNormInf(), 0.01);
      assertNotNull(vector3D2);
  }
  ...
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D((-1.0), vector3D0, (-1.7168146928204135), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals((-5.306984707449111E-17), vector3D2.getX(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = Vector3D.PLUS_I;
      Vector3D vector3D2 = new Vector3D(565.91671, vector3D1, (-2667.3652222), vector3D0, 565.91671, vector3D1, (-2667.3652222), vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(0.6810715917196087, vector3D3.getNorm1(), 0.01);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = new Vector3D(1419.0, 1419.0, (-1.0));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test19()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 3664.0418, vector3D0, 3.141592653489793, vector3D0, 3.141592653489793, vector3D0);
      Vector3D vector3D2 = new Vector3D(3.141592653489793, vector3D1, 3664.0418, vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(2.910545678129211E-25, vector3D3.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(310.52751822802, vector3D0, 694.1, vector3D0, 4.0, vector3D0, 1.7976931348623157E308, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test22()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.ZERO;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1126.4404303384);
      line0.reset(vector3D2, vector3D1);
      assertEquals(1126.4404303384, vector3D2.getZ(), 0.01);
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(3.900045418230444E-13, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Vector3D vector3D3 = new Vector3D(565.91671, vector3D2, (-2667.3652222), vector3D0, 565.91671, vector3D1, (-2667.3652222), vector3D1);
      ...
      double double0 = line1.distance(line2);
      assertEquals(6.06114263546611E-18, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(6.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertEquals(2.220446049250313E-16, vector3D2.getNorm(), 0.01);
  }
...
//      }
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-0.1428571423679182), (-78.6707496), (-0.1428571423679182));
      Vector3D vector3D1 = new Vector3D((-78.6707496), vector3D0, (-0.1428571423679182), vector3D0, 5.879851140289795E29, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
//      try { 
        line0.revert();
...
//      }
  ...
  public void test35()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(310.52751822802, vector3D0, 694.1, vector3D0, (-1.0), vector3D0, 1.7976931348623157E308, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(750.85954309, 750.85954309);
      Vector3D vector3D1 = new Vector3D(750.85954309, vector3D0, 750.85954309, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.distance(vector3D0);
      assertEquals(0.0, double0, 0.01);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D1);
      assertEquals(1501.71908618, double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(8014562.0, vector3D0, 0.0, vector3D0, 565.91671, vector3D0, 7.668018740379506E14, vector3D0);
  ...
  public void test53()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_K;
      Vector3D vector3D1 = Vector3D.MINUS_J;
      Vector3D vector3D2 = new Vector3D(565.91671, vector3D1, (-2667.3652222), vector3D0, 565.91671, vector3D0, (-2667.3652222), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
...
//      }
  ...
  public void test60()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt((-657.4492602199234));
  ...
  public void test61()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(0.022105413883473916, vector3D2.getNormSq(), 0.01);
  }
