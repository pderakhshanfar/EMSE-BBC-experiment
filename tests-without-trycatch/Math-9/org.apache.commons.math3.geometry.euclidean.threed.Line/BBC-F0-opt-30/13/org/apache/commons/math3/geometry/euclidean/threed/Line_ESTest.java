...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1352.32098, 0.0, 0.0);
  ...
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(1352.32098, 0.0, (-1844.7534460303607));
  ...
  public void test04()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.7249995199969751, vector3D0, 0.7249995199969751, vector3D0, (-2527.35), vector3D0, (-2527.35), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test05()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.5707963266948965, (-3410.719));
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D((-4818.0), 510.03095213, 3878.481875011);
      Vector3D vector3D1 = new Vector3D(732.0757345125736, vector3D0, (-4818.0), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = Vector1D.ONE;
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(3.036125969120219, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, 22.2, vector3D0, 842.45947645, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals((-864.6594764499998), vector1D0.getX(), 0.01);
      assertEquals(747636.0102147878, vector3D2.getNormSq(), 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-3885.6469679092), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.pointAt(1967.165171271);
      assertEquals(1967.165171271, vector3D2.getY(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(2880.750384739007);
      assertEquals((-9.996528681230859E-11), vector3D2.getDelta(), 0.01);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D(1.0E-10, 1.0E-10, (-1.0));
      Vector3D vector3D2 = new Vector3D(0.0, vector3D0, 0.0, vector3D1, 22.2, vector3D1, 842.45947645, vector3D0);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.intersection(line0);
      assertNotNull(vector3D3);
      assertEquals(0.026373555130297984, vector3D3.getNorm(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals(1.5705378500981515, vector3D2.getAlpha(), 0.01);
  ...
  public void test15()  throws Throwable  {
      ...
      Vector3D vector3D2 = line0.intersection(line0);
      assertNotNull(vector3D2);
      assertEquals(1.2265006155029565E-16, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1.0E-10, 1.0E-10, 1.0E-10);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D((-1.0E-10), vector3D0, 30.579515027, vector3D0, 1.0E-10, vector3D1);
      line0.reset(vector3D2, vector3D0);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(3.2976970037416845E-16, vector3D3.getNorm1(), 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Vector3D vector3D2 = new Vector3D(0.7249995199969751, vector3D0, 0.7249995199969751, vector3D1, (-2527.35), vector3D1, (-2527.35), vector3D0);
  ...
  public void test19()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = vector3D0.scalarMultiply(3.12579759521807E19);
      Vector3D vector3D2 = vector3D1.add((Vector<Euclidean3D>) vector3D0);
      Line line0 = new Line(vector3D0, vector3D2);
      Vector3D vector3D3 = line0.getOrigin();
      assertEquals(7.80961802491963E-17, vector3D3.getNormInf(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(1390.3349742, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals(4.3719055198887535E-4, vector3D2.getY(), 0.01);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      double double0 = line0.getAbscissa(vector3D0);
      assertEquals((-2287.3317008228696), double0, 0.01);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(1.137434488153644E-19, double0, 0.01);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = new Vector3D(1.0, 14.101419448852539, (-1758.034136349545));
      Line line1 = new Line(vector3D2, vector3D0);
      double double0 = line0.distance(line1);
      assertEquals(6.950853609990127E-22, double0, 0.01);
  }
...
//      }
  ...
  public void test47()  throws Throwable  {
      ...
      assertEquals(1.5700568575176188, vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test50()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.POSITIVE_INFINITY;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = new Vector3D((-604.7506734), (-604.7506734), 0.0);
//      try { 
...
//      }
  ...
  public void test59()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.PLUS_J;
      Line line0 = new Line(vector3D0, vector3D1);
      Vector1D vector1D0 = new Vector1D((-370.7));
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(298.97315636292564, vector3D2.getNormInf(), 0.01);
  }
}
