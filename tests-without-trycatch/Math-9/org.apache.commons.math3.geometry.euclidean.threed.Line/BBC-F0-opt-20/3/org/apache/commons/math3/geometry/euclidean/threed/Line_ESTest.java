...
public class Line_ESTest extends Line_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Vector3D vector3D1 = Vector3D.crossProduct(vector3D0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = new Vector3D(1.0E-10, (-4.9E-324), 0.14285714285714285);
  ...
  public void test04()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = vector3D0.orthogonal();
      Vector3D vector3D2 = new Vector3D((-6.032174644509064E-23), vector3D0, 1.0E-10, vector3D0, 1.0E-10, vector3D1);
      Line line0 = new Line(vector3D2, vector3D0);
      Vector3D vector3D3 = new Vector3D(49342.45718136662, vector3D0);
  ...
  public void test06()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(5.012043557870449E14, 150.26668878803028, 150.26668878803028);
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 5.012043557870449E14, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test07()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.19999954104423523, 0.19999954104423523, (-150.9524668243961));
  ...
  public void test08()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector1D vector1D0 = new Vector1D((-1555.1906258286));
  ...
  public void test10()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_J;
      Vector3D vector3D1 = new Vector3D((-0.3058015757857271), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
  ...
  public void test12()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Line line1 = line0.revert();
      Vector3D vector3D2 = line1.pointAt(0.0036);
      assertEquals(0.0036, vector3D2.getX(), 0.01);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-0.3058015757857271), vector3D0, 0.0, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.pointAt(1.8686937342560265E7);
      assertEquals((-1.8686937342560265E7), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(0.16666666666666666, 0.16666666666666666);
      Vector3D vector3D1 = new Vector3D((-1186.72659), (-2532.9727440095544), 3.141592653589793);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.intersection(line0);
      assertEquals((-0.4382125340351002), vector3D2.getAlpha(), 0.01);
  }
  ...
  public void test22()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(74.3772071, vector3D0, 74.3772071, vector3D0);
      Vector3D vector3D2 = new Vector3D(74.3772071, vector3D0, 74.3772071, vector3D0, 74.3772071, vector3D1);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test23()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getOrigin();
      assertEquals(1.0078963439812245, vector3D2.getNorm1(), 0.01);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3886.33810153, vector3D0, 3886.33810153, vector3D0, 8.0E298, vector3D0, 3.141592653589793, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
  ...
  public void test26()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D((-2.957007209750105E-8), vector3D0, (-2517.9415), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test27()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D((-2860.04516), vector3D0, (-2860.04516), vector3D0, 0.5000000000042687, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
  ...
  public void test28()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(853.7607, (-227.2590323816182));
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.getDirection();
      assertEquals(0.822826462598495, vector3D2.getX(), 0.01);
  }
  ...
  public void test33()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.MINUS_I;
      Vector3D vector3D1 = new Vector3D(658.708, vector3D0, 0.16666666666666666, vector3D0, 853.7607, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertFalse(vector3D2.isNaN());
  }
  ...
  public void test34()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_K;
      Vector3D vector3D1 = new Vector3D(0.5000000000042687, vector3D0, (-2860.04516), vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      Vector3D vector3D2 = line0.closestPoint(line0);
      assertFalse(vector3D2.isNaN());
  }
...
//      }
  ...
  public void test37()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_I;
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, (-4730.553), vector3D0, 0.0875862700108075, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test38()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.7853981633974483, vector3D0, 1.6386292726011386E29, vector3D0, 0.7853981633974483, vector3D0);
      Vector3D vector3D2 = new Vector3D(2.23867649613231E7, vector3D1, (-1.0), vector3D0, (-165.0), vector3D0);
...
//      }
  ...
  public void test44()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(923.06, (-1693.0131561563833));
...
//      }
  ...
  public void test52()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.NaN;
      Line line0 = new Line(vector3D0, vector3D0);
      Vector3D vector3D1 = new Vector3D((-1871.0554965), 1497.0);
//      try { 
...
//      }
  ...
  public void test60()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = line0.toSubSpace(vector3D1);
      assertEquals((-2.5120580625990824E29), vector1D0.getX(), 0.01);
  }
  ...
  public void test62()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(3.141592653489793, vector3D0, 5.012043557870449E14, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      Vector1D vector1D0 = new Vector1D(808.513638);
      Vector3D vector3D2 = line0.toSpace(vector1D0);
      assertEquals(9.42883680985706E12, vector3D2.getNorm(), 0.01);
  }
  ...
  public void test64()  throws Throwable  {
      ...
      Line line0 = new Line(vector3D1, vector3D0);
      double double0 = line0.distance(vector3D1);
      assertEquals(7.365109703135629, double0, 0.01);
  }
