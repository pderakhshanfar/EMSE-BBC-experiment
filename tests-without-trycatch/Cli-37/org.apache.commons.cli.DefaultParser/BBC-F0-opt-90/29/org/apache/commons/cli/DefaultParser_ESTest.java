...
public class DefaultParser_ESTest extends DefaultParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      options1.addRequiredOption("f", "f", true, "f");
      String[] stringArray0 = new String[7];
      stringArray0[0] = "f";
      stringArray0[1] = "--=1O0NH4h1+";
//      try { 
...
//      }
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "1";
      stringArray0[1] = "--=1O0NH}h1+";
      options1.addOption("1", ",", false, "1");
      Properties properties0 = new Properties();
//      try { 
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      Options options1 = options0.addRequiredOption("a", "-t;+^q;hhg{T.;[5p", true, "--=O0NH4h1+");
      String[] stringArray0 = new String[1];
      stringArray0[0] = "--=O0NH4h1+";
//      try { 
...
//      } catch(Exception e) {
//         //
//         // Ambiguous option: '--'  (could be: 'a', '-t;+^q;hhg{T.;[5p')
//         //
//         verifyException("org.apache.commons.cli.DefaultParser", e);
//      }
  }
...
//      }
  ...
  public void test16()  throws Throwable  {
      DefaultParser defaultParser0 = new DefaultParser();
      Options options0 = new Options();
      Options options1 = options0.addOption("", true, "|`v' X\".d*~Pc$8");
      String[] stringArray0 = new String[1];
      stringArray0[0] = "|`v' X\".d*~Pc$8";
...
//      } catch(Exception e) {
//         //
//         // Unrecognized option: -a~r`MsL=[%ibA
//         //
//         verifyException("org.apache.commons.cli.DefaultParser", e);
//      }
  }
  ...
  public void test22()  throws Throwable  {
      DefaultParser defaultParser0 = new DefaultParser();
      Options options0 = new Options();
      Options options1 = options0.addOption("yes", "yes");
      Properties properties0 = new Properties();
      String[] stringArray0 = new String[1];
      stringArray0[0] = "-yes";
...
//      }
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      stringArray0[0] = "--=O0NH4h1+";
      options0.addOption("1", "--=O0NH4h1+", true, "--=O0NH4h1+");
      Properties properties0 = new Properties();
//      try { 
...
//      } catch(Exception e) {
//         //
//         // Ambiguous option: '--'  (could be: '1', '--=O0NH4h1+')
//         //
//         verifyException("org.apache.commons.cli.DefaultParser", e);
//      }
  }
...
//      }
  ...
  public void test38()  throws Throwable  {
      ...
      String[] stringArray0 = new String[3];
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("1", "-yes");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
