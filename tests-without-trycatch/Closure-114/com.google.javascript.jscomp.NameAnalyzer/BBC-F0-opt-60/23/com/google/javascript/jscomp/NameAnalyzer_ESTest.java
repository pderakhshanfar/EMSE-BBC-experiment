...
public class NameAnalyzer_ESTest extends NameAnalyzer_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node1 = new Node(50, node0, 51, 15);
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node2 = new Node(42, 1, 1);
...
//      }
  ...
  public void test05()  throws Throwable  {
      ...
      Node node0 = new Node((-2385));
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node1 = compiler0.parseSyntheticCode("com.google.common.collect.ObjectArrays", "com.google.common.collect.ObjectArrays");
      nameAnalyzer0.process(node0, node1);
  ...
  public void test07()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = new Node((-1130009145));
      Node node1 = new Node(108, node0, node0, node0);
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node2 = new Node(4, 93, 36);
  ...
  public void test09()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node0 = compiler0.parseTestCode("JO+EWg(8");
...
//         // [source unknown]
//         //   Parent(STRING <html><body><style type=\"text/css\">body, td, p {font-family: Arial; font-size: 83%} ul {margin-top:2px; margin-left:0px; padding-left:1em;} li {margin-top:3px; margin-left:24px; padding-left:0px;padding-bottom: 4px}</style>OVERALL STATS<ul><li>Total Names: 0</li>
//         // <li>Total Classes: 0</li>
//         // <li>Total Static Functions: 0</li>
//         // <li>Referenced Names: 0</li>
//         // <li>Referenced Classes: 0</li>
...
//      }
  ...
  public void test16()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = new Node(86);
      Node node1 = new Node(49, node0, 0, (-835));
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node2 = new Node(43, 118, 30);
      node0.addChildrenToBack(node2);
      nameAnalyzer0.process(node2, node1);
...
//      }
  ...
  public void test19()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = new Node(86, 86, 86);
      Node node1 = new Node(98, node0, 37, 98);
      Node node2 = new Node(57, 54, 47);
      node0.addChildrenToBack(node2);
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      nameAnalyzer0.process(node1, node1);
...
//      }
  ...
  public void test21()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = new Node(86);
      Node node1 = new Node(85, node0, 113, 130);
      Node node2 = node0.useSourceInfoFrom(node1);
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, true);
      Node node3 = new Node((-1432), 64, (-2350));
...
//      }
  ...
  public void test23()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      NameAnalyzer nameAnalyzer0 = new NameAnalyzer(compiler0, false);
      Node node0 = compiler0.parseTestCode("gE=s2");
      nameAnalyzer0.process(node0, node0);
