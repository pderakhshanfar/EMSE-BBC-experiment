...
//      }
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("*V!vq1hj.v", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "%k!@8p.";
      stringArray0[1] = "X<Ix3";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("r;hWd", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[r;hWd]", cSVRecord0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("iu|W;XMH*O/0c!h", cSVFormat0);
...
//      }
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("ecE%x]e,e", "ecE%x]e,e");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Ml+l]Dho", cSVFormat0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test22()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("D(rRv2CbGj%j!", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse(",PsK|R_*]!$Du4N ,", cSVFormat1);
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The header contains a duplicate name: \"\" in [, PsK|R_*]!$Du4N , ]
//         //
//         verifyException("org.apache.commons.csv.CSVParser", e);
//      }
  }
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("/6#P]p.V}!`:sC");
      CSVParser cSVParser0 = CSVParser.parse("Ml+l]Dho", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
