...
//      }
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "uK`?ZL(/N";
      stringArray0[1] = "|IDG>. .d%O-XJ6)*";
      stringArray0[2] = "Z^e-;5-b=JVm";
      stringArray0[3] = "U,#+";
      stringArray0[4] = "";
      stringArray0[5] = "nd2\"b?3p|kg6t";
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("-,o5dT~iW~mrV[2ky");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[-, o5dT~iW~mrV[2ky]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("CT'ifDC9g?lhig?l8Y", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("3Qb6", cSVFormat0);
...
//      }
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"cKn-&", cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("The delimiter cannot be a line break", "\u2029", (File) null);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Record separator can only by CR, LF or CRLF");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
//      try { 
...
//      }
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      PipedReader pipedReader0 = new PipedReader(1244);
      CSVParser cSVParser0 = cSVFormat0.parse(pipedReader0);
//      try { 
...
//      }
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("$leK<ixQC9d^p", cSVFormat0);
      // Undeclared exception!
//      try { 
        cSVParser0.getRecords((LinkedList<CSVRecord>) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/koj[*N$SV:*0'1");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "koj[*N$SV:*");
      File file0 = MockFile.createTempFile("koj[*N$SV:*", "'1");
      Charset charset0 = Charset.defaultCharset();
...
//      }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("r]oy|9HW[b,?7Fm", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Ypwni,|0gs%~U", cSVFormat1);
      List<CSVRecord> list0 = cSVParser0.getRecords();
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Ypwni,|0gs%~U", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
