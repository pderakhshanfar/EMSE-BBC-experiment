...
//      }
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Ikri8{s')'f,_poh!=*");
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Gkp>!4V=7w", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test09()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("}9Q<]qwe&M", "G^\"'<WWo+!j", 0, "", uRLStreamHandler0);
...
//      }
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("F^=G9}\":n>U", "F^=G9}\":n>U");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test16()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("jtC9i.K,acyI8D", cSVFormat0);
      cSVParser0.close();
//      try { 
...
//      }
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse(";CmN&So+puR-)_8Mt !", cSVFormat0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("B,?OEH(~XmKPQ", "B,?OEH(~XmKPQ");
      Charset charset0 = Charset.defaultCharset();
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/B,?OEH(~XmKPQ0B,?OEH(~XmKPQ");
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('p');
      StringReader stringReader0 = new StringReader(";CmN&So+puR-)_8Mt !");
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse(";xZ]^~.mi", cSVFormat2);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("rg%C", "rg%C");
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat1);
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("rg%C", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("U{ln");
      CSVParser cSVParser0 = CSVParser.parse(";CmN&So+puR-)_8Mt !", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("U{ln");
      CSVParser cSVParser0 = CSVParser.parse("U{ln", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      LinkedList<CSVRecord> linkedList1 = cSVParser0.getRecords(linkedList0);
      assertSame(linkedList1, linkedList0);
  }
