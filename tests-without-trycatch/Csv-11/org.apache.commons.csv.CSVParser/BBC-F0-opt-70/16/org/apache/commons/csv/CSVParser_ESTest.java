...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "}.r?Mg<Oc|Zn`QU<");
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[1] = "MFyL\"Bm|-(";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("MFyL\"Bm|-(");
  ...
  public void test10()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<,> Escape=<5> QuoteChar=<\"> RecordSeparator=<\r\n> SkipHeaderRecord:false", cSVFormat0);
...
//      }
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("org.apache.commons.csv.Constants", ")vky");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("DoU|j&lB1`,J89nL<a", cSVFormat0);
      cSVParser0.close();
//      try { 
        cSVParser0.nextRecord();
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("2dENZp");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test20()  throws Throwable  {
      StringReader stringReader0 = new StringReader(";~ft^XlxV>h@6");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
//      try { 
...
//      }
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('$');
      CSVParser cSVParser0 = CSVParser.parse("MFyL\"Bm|-(", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse("6paib", cSVFormat2);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("/My3[0r'Ct0[B2&\"xr");
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<,> Escape=<5> QuoteChar=<\"> RecordSeparator=<\r\n> SkipHeaderRecord:false", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[Delimiter=<, > Escape=<5> QuoteChar=<\"> RecordSeparator=<]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader(";~ft^Xl#K>h@6");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
...
//      }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("@s^onI");
      Charset charset0 = Charset.defaultCharset();
//      try { 
