...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(2519);
...
//      }
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "?2^M,N2n(lGcT'O";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("?2^M,N2n(lGcT'O", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(pipedWriter0, 963);
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0);
      cSVParser0.close();
...
//      }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse("Gl9G4YHz1V>Jd", cSVFormat1);
...
//      try { 
        CSVParser.parse("qFW>Vs%{_&@b]A", cSVFormat2);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test11()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("Y]q@14KB%Xi;tFl", "unexpected quote value: ");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("u#zFIRX^`a", cSVFormat0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test17()  throws Throwable  {
      File file0 = MockFile.createTempFile("Parameter '", (String) null);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
...
//      }
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('A');
      CSVParser cSVParser0 = CSVParser.parse("tK@>\"TFPi}Uss`v}Ej", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
...
//      }
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[0] = "?2^M,N2n(lGcT'O";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("u#zFIRX^`a", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
      assertNotNull(map0);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('}');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("tK@>\"TFPi}Uss`v}Ej");
