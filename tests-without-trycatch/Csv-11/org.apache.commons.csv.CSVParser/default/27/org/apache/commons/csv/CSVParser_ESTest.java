...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "v%G3DrJ?nj@ui=S");
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("zB;", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[1] = "(line ";
      stringArray0[2] = "1Cw8aZao6N|&`lm";
      stringArray0[3] = "the comment start character and the quotechar cannot be the same ('";
      stringArray0[4] = "[h7x}}g+Vz]~@";
      stringArray0[5] = ">";
      stringArray0[6] = "qM!v4I|noasqlJE";
      stringArray0[7] = "{";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("[h7x}}g+Vz]~@", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("M;$wnk`0pDE,'", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("|_%'c6e~ZI", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("]'(7e=Ns;BUL}&[&.", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"YbOwjX$FJH*ObDw", cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("J??*d", "J??*d");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("8'rm8|", cSVFormat0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("zE#l$FR", "zE#l$FR");
      Charset charset0 = Charset.defaultCharset();
...
//      }
  ...
  public void test23()  throws Throwable  {
      StringReader stringReader0 = new StringReader("8orm8|");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("ziD4Y", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("b2,3m", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
...
//      }
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("ziD4Y", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("K(*b|8", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("8'rm8|");
      CSVParser cSVParser0 = CSVParser.parse("8'rm8|", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("3& Xy`P");
      String[] stringArray0 = new String[0];
