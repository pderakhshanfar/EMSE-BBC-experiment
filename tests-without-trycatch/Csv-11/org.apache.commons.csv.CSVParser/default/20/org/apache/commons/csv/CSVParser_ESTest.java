...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "prSv>YXjc&PW<>=qjmJ");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "j7TdK6QYTwzGzT";
      stringArray0[1] = " 2s{i#IoR4zt|l3)${";
      stringArray0[2] = "org.apache.commons.csv.Lexer";
      stringArray0[3] = "EORECORD";
      stringArray0[4] = "\u2028";
      stringArray0[5] = "O";
      stringArray0[6] = "AMT#=4fiOs+z]";
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("qai", cSVFormat0);
      cSVParser0.close();
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"0*b__7MkJy", cSVFormat1);
...
//      }
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("39]@+rE9v", "39]@+rE9v");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("JLdi", cSVFormat1);
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("2[s/2,*", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[2[s/2, *]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("u*T@K~m9ptg_", cSVFormat0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse(":e.&?> Xt+t%|Rf-%M", cSVFormat2);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("P<9yXG.");
      CSVParser cSVParser0 = CSVParser.parse("1=FBn:h", cSVFormat1);
      cSVParser0.getRecords();
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("P<JyXGB");
      CSVParser cSVParser0 = CSVParser.parse("P<JyXGB", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
...
//      }
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      File file0 = MockFile.createTempFile("G5{7{-", "QBd");
      Charset charset0 = Charset.defaultCharset();
