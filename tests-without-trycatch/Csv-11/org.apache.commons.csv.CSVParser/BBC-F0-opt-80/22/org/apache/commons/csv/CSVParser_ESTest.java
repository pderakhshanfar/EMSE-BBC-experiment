...
//      }
  ...
  public void test01()  throws Throwable  {
      File file0 = MockFile.createTempFile("8RPhC", "");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "*dt$\"~\"Dm.&8";
      stringArray0[1] = "The comment start character and the delimiter cannot be the same ('";
      stringArray0[2] = "' in ";
      stringArray0[3] = "!jf\"C`";
      stringArray0[4] = "C5^a(IQ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("*dt$\"~\"Dm.&8", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[*dt$\"~\"Dm.&8]", cSVRecord0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      stringArray0[0] = "vv9g;@ffq'FH";
      stringArray0[1] = "t|e1m)";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
  ...
  public void test09()  throws Throwable  {
      ...
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/8RPhC0");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "2xvX3V}8__U");
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
...
//      }
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("hu#G1:", "hu#G1:");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('l');
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("L/[E7UUv5+Jqu\";v", "L/[E7UUv5+Jqu\";v");
//      try { 
...
//      }
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("?tXFee o3`i_*", cSVFormat0);
      cSVParser0.close();
//      try { 
        cSVParser0.nextRecord();
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("x:pRCRf}nNEXB^i>", cSVFormat0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("IsD={sJQ,_", cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
//      try { 
        cSVParser0.getRecords(linkedList0);
...
//      }
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("f}jg", " SkipHeaderRecord:");
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
...
//      }
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("qVrAG", cSVFormat1);
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse("*dt$\"~\"Dm.&8", cSVFormat1);
//        fail("Expecting exception: NullPointerException");
