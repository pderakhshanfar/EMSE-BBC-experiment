...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/.Wr#R~ 3+*>3k7+ z0.Wr#R~ 3+*>3k7+ z");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, ".Wr#R~ 3+*>3k7+ z");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile(".Wr#R~ 3+*>3k7+ z", ".Wr#R~ 3+*>3k7+ z");
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(">Mb(F}b.tpl<9RfW", cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("&KW4gq^uy/u@$`NZ", cSVFormat1);
  ...
  public void test07()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Bc$B", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("A[6N:fc8|K", cSVFormat0);
  ...
  public void test10()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("`5jIm+D57Gs/_V85", "}g7l", 0, "}g7l", uRLStreamHandler0);
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"nf9Eg!<ZX", cSVFormat1);
...
//      }
  ...
  public void test14()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("L9Y1");
      File file0 = MockFile.createTempFile("L9Y1", "[x6%W'<x", (File) mockFile0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("PX2w", cSVFormat0);
      cSVParser0.close();
//      try { 
        cSVParser0.nextRecord();
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("A*Pco.+w$=C06#7", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse("WjdSjqA,8", cSVFormat2);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test31()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(".Wr#R~ 3+*>3k7+ z");
      // Undeclared exception!
//      try { 
        CSVParser.parse(".Wr#R~ 3+*>3k7+ z", cSVFormat2);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test32()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString(".Wr#R~ 3+*>3k7+ z");
      CSVParser cSVParser0 = CSVParser.parse("ZK2f3Um(pC", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse(";[GPoURA+QME1i", cSVFormat0);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
