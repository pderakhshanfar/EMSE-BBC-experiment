...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("bb\"i*CV", cSVFormat0);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "&'J-MeK/WGx0";
      stringArray0[1] = "c*6fbwir;'4";
      stringArray0[2] = "@=@:NgoA#)XWSTC+t@P";
      stringArray0[3] = "at$og?";
      stringArray0[4] = "<L<.\"^M3;*r|M-6";
      stringArray0[5] = "33nAm";
      stringArray0[6] = "{fq. c\"tZ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("T6[mOm%mPV", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[T6[mOm%mPV]", cSVRecord0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("@]d&CTHS8Q^", cSVFormat0);
      cSVParser0.close();
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("V#?z2(lX`ht+$xthl", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("SG_'h8zO,", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"a%wa", cSVFormat1);
...
//      }
  ...
  public void test18()  throws Throwable  {
      File file0 = MockFile.createTempFile("Pe,%x@onjU&[`d:VB", "Pe,%x@onjU&[`d:VB");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
...
//      }
  ...
  public void test26()  throws Throwable  {
      ...
      stringArray0[0] = "";
      stringArray0[1] = "jkn{<dh6*\"r6y";
      stringArray0[2] = "UDAx=H jQo~f";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
//      try { 
        CSVParser.parse(") invalid parse sequence", cSVFormat2);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("Np}WO'.MSXv<", (String) null);
      Charset charset0 = Charset.defaultCharset();
...
//      }
  ...
  public void test32()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("P,7@PMDX8CQ$~5>{ ");
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("bb\"i*cv", ".|:E&(V}n:\"}Z^T=m");
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
