...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("the header contains a dulicate entry: '", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[2] = "l6Kg*b1<S;/UeaG";
      stringArray0[3] = "%TiTY<8b;nj_1";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("kzXOp.11-/|8(.", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("}AWmtL4iC}eh", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      ...
      stringArray0[0] = "fk2idm;xh87#rj$/u1";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("fk2idm;xh87#rj$/u1", cSVFormat1);
...
//      }
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("G]~E(X", "$");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test17()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      PipedReader pipedReader0 = new PipedReader(747);
...
//      }
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("pwrar^lxv", cSVFormat0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("e!p*5Bs9%$", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("L(uYuzYSb>,0:{V[$", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("h b=ckrp<oax>l~l:dk", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.close();
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
...
//      }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse("kzXOp.11-/|8(.", cSVFormat1);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("mwRaR^lxJ");
      CSVParser cSVParser0 = CSVParser.parse("pwrar^lxv", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
...
//      }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("mwRaR^lxJ");
...
//      }
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("the header contains a dulicate entry: '", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
