...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("V@isw)zo");
...
//      }
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("stco9lgftoe#hj%\"u", cSVFormat0);
      cSVParser0.close();
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("%I'60");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
...
//      }
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      File file0 = MockFile.createTempFile("@yf`|>#lDn1Ish0hWFo", "");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("j0F>X&cuEUW[;kC:s(", "j0F>X&cuEUW[;kC:s(");
      Charset charset0 = Charset.defaultCharset();
...
//      }
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse("dold(b$ruU:u }w2 )", cSVFormat2);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("v_vROE:c;BP5J?", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader("V@isw)zo");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("V@isw)zo");
  ...
  public void test32()  throws Throwable  {
      StringReader stringReader0 = new StringReader("V@isw)zo");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("@yf`|>#lDn1Ish0hWFo");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
