...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      PipedReader pipedReader0 = new PipedReader(435);
...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("VQL}%", cSVFormat1);
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("^gTbiL<J5L)!#_", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("p1n6b+D#e;Qc.iPjy", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("l3&%h|8pk:f)Sl[!t5", cSVFormat1);
...
//      }
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("file", "}k )n2<?ue*2");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("FH8.ikH^M'");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("$I+1WnI?>aJ=dk7l");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
//      try { 
...
//      }
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("l3&%h|8pk:f)Sl[!t5", cSVFormat2);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("p1n6b+D#e;QciPjy", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test27()  throws Throwable  {
      ...
      stringArray0[0] = "4r$FQ*x8";
      stringArray0[1] = "1sk0m &W%U";
      stringArray0[2] = "=f2rdhh?u!]_>~6";
      stringArray0[3] = ",g!WMWVhs";
      stringArray0[4] = ",hpgv^sT13po%b";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(";Hrg\u0007g", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertNotNull(cSVRecord0);
      assertEquals("[;Hrg\u0007g]", cSVRecord0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse("yC{e&{vg9#d?OY", cSVFormat2);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("/J!n$BAis,,");
      // Undeclared exception!
//      try { 
...
//      } catch(IllegalArgumentException e) {
//         //
//         // The header contains a duplicate name: \"\" in [/J!n$BAis, , ]
//         //
//         verifyException("org.apache.commons.csv.CSVParser", e);
//      }
  }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("0C#-*.i4[$v[jar", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("6<o/\"tnQ]M", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
...
//      }
  ...
  public void test37()  throws Throwable  {
      File file0 = MockFile.createTempFile("`&xi2'<xKNM`a", "`&xi2'<xKNM`a");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.TDF;
