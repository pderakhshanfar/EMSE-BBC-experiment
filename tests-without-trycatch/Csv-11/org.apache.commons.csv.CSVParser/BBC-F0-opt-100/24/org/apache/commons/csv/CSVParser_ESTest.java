...
//      }
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "<'E>1d+Gj^<rqGk&";
      stringArray0[1] = "";
      stringArray0[2] = "8e1";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("v0G0?*Zn|wFy\"m");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("KhE=: CpO", cSVFormat0);
...
//      }
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile(" tbx");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
//      try { 
...
//      }
  ...
  public void test22()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("AaL", cSVFormat0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test31()  throws Throwable  {
      ...
      stringArray0[0] = "all";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("FmVN!GBb", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("KhE=: CpO");
      CSVParser cSVParser0 = CSVParser.parse("KhE=: CpO", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("<'E>1d+Gj^<rqGk&");
      StringReader stringReader0 = new StringReader("v0G0?*Zn|wFy\"m");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
...
//      }
  ...
  public void test37()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("o=lb]", "");
