...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[0] = "ALL";
      stringArray0[1] = "2)/X({Zsl`?gR";
      stringArray0[2] = "@]";
      stringArray0[3] = "D'^[AY>A5t}$P/";
      stringArray0[4] = "charset";
      stringArray0[5] = "DMq.VNF";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      Character character0 = Character.valueOf('$');
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      CSVParser cSVParser0 = CSVParser.parse("DMq.VNF", cSVFormat2);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("dAQl/NPfj", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("C7r]OPwAcM,tH'S", cSVFormat0);
      cSVParser0.close();
...
//      }
  ...
  public void test13()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("org.apache.commons.csv.csvparser$1", "[A", (File) mockFile0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("The escape character and the delimiter cannot be the same ('", "The escape character and the delimiter cannot be the same ('", (File) null);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("P(e9KI)(xm`::441lbj", "Mwz&t\"Qr");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
//      try { 
...
//      }
  ...
  public void test16()  throws Throwable  {
      PipedReader pipedReader0 = new PipedReader(2684);
...
//      }
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("9Bg", cSVFormat0);
      cSVParser0.close();
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
//      try { 
...
//      }
  ...
  public void test18()  throws Throwable  {
      StringReader stringReader0 = new StringReader("9Bg");
...
//      }
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("Q@c]BC>", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[2];
      stringArray0[0] = "4(E`Owcg";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      // Undeclared exception!
//      try { 
        CSVParser.parse("`A@0n2kH;=T3", cSVFormat2);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("+eOPYz/8/zddp", cSVFormat1);
  ...
  public void test31()  throws Throwable  {
      ...
      stringArray0[1] = "9Bg";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("z4(wRYTp:iy7kU", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
...
//      }
  ...
  public void test37()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      File file0 = MockFile.createTempFile("9qBg", "0vn')w{<.=0jM;< 3");
      Charset charset0 = Charset.defaultCharset();
