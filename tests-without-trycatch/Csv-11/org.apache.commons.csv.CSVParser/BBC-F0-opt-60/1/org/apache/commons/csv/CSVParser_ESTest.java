...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("sf*y:ycE!");
...
//      }
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "hmmWp-@XcZgJ'(m{}.";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("hmmWp-@XcZgJ'(m{}.", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("3#YS\"1s-a");
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("|O 8Uh|T1SjySnSc.", cSVFormat0);
...
//      }
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
//      try { 
        CSVParser.parse("`T0Cxe/\"qg%`!{~", (CSVFormat) null);
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"V<n%S*Y", cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test15()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("q2M)N'f$g`", cSVFormat0);
      cSVParser0.close();
//      try { 
...
//      }
  ...
  public void test25()  throws Throwable  {
      StringReader stringReader0 = new StringReader(" *jy:E!");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("sf*y:ycE!", cSVFormat0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("sf*y:ycE!");
      CSVParser cSVParser0 = CSVParser.parse("sf*y:ycE!", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('{');
      CSVParser cSVParser0 = CSVParser.parse("hmmWp-@XcZgJ'(m{}.", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
...
//      }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("EORECORD", "uPs>_%+w:gz,Pa2C,75");
      // Undeclared exception!
//      try { 
