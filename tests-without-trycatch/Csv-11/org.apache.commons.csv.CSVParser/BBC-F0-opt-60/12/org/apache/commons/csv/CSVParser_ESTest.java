...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("OmWg>airzV=D~yW7|?x", cSVFormat1);
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("OmWg>airzV=D~yW7|?x", cSVFormat0);
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"$[DKEZ", cSVFormat1);
...
//      }
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("org.apache.commons.csv.CSVParser$1", "Header:");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      MockFile mockFile0 = new MockFile("s~E2e");
      Charset charset0 = Charset.defaultCharset();
//      try { 
...
//      }
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("fZ@wAi.D", cSVFormat0);
      cSVParser0.close();
//      try { 
        cSVParser0.getRecords((LinkedList<CSVRecord>) null);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("8ep^@&:'", cSVFormat0);
      cSVParser0.close();
//      try { 
        cSVParser0.getRecords();
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("T5?,@[^", cSVFormat0);
  ...
  public void test26()  throws Throwable  {
      ...
      stringArray0[0] = "AC?U5U:{enV{ej";
      stringArray0[1] = "')";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      // Undeclared exception!
//      try { 
        CSVParser.parse("8ep^@&:'", cSVFormat2);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[0] = "Ua0LEOH:<&,clFe";
      stringArray0[1] = "P{#~#hdPed`ncE3 ^";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("Ua0LEOH:<&,clFe", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
      assertNotNull(map0);
...
//      }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("Ua0LEOH:<&,clFe", cSVFormat0);
      long long0 = cSVParser0.getRecordNumber();
