...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "ZMYnbH#A[ykrUL_9";
      stringArray0[1] = "wHwc.w,v38 )jU/3 _";
      stringArray0[2] = "9[";
      stringArray0[3] = "(line ";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("9[", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[9[]", cSVRecord0.toString());
  }
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("n3('}+,~CCauHy<B", cSVFormat0);
      cSVParser0.close();
  ...
  public void test08()  throws Throwable  {
      ...
      stringArray0[0] = "V@<>:<<09~X~";
      stringArray0[1] = "pHd95vJ5<m91$1|nq}}";
      stringArray0[2] = "pbo`\"m_ba|nmel=n`/";
      stringArray0[3] = "QM$h{'?by";
      stringArray0[4] = "}Z(tdj_0'%ytjfc6N`";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("-=Rw2", cSVFormat1);
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"ccOii1lM/", cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      MockFile mockFile0 = new MockFile("", "g~'1U(WX(C~v");
//      try { 
...
//      }
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("WZR^h", cSVFormat0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("v!qn3('}+,~CCauHy<B", cSVFormat0);
      cSVParser0.close();
//      try { 
...
//      }
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("h%u z-5!b`^lg@", cSVFormat0);
      cSVParser0.close();
  ...
  public void test26()  throws Throwable  {
      ...
      stringArray0[0] = "cq^'>EpkO";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      // Undeclared exception!
//      try { 
        CSVParser.parse("4njdc", cSVFormat2);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("\"ccOii1lM/", cSVFormat1);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("WZR^h");
      CSVParser cSVParser0 = CSVParser.parse("H%u Z-5!B`^lg@", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("WZR^h");
      CSVParser cSVParser0 = CSVParser.parse("WZR^h", cSVFormat1);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
...
//      }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("7WG_=", "");
      Charset charset0 = Charset.defaultCharset();
      CSVParser cSVParser0 = CSVParser.parse(file0, charset0, cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
