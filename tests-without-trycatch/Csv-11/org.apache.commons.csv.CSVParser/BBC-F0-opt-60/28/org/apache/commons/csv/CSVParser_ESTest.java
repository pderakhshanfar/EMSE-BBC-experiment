...
//      }
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[0] = "4QHwQTiFWTT'WnH!g";
      stringArray0[1] = ") invalid parse sequence";
      stringArray0[2] = "?x>aEup\t<( }VE}7";
      stringArray0[3] = "5p*1|~};B1v";
      stringArray0[4] = "The quoteChar character and the delimiter cannot be the same ('";
      stringArray0[5] = "5DU=[_fyL";
      stringArray0[6] = ";Kh<fpz(";
      stringArray0[7] = "~cUSVHv7ig>Sj*";
      stringArray0[8] = "r";
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("_ixlf*i/elb;}fu", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("ZW\"A*-Uev{ufpX~", cSVFormat0);
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"]7U?e=H[iyYx;A", cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test12()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("'iU.d*", "')");
...
//      }
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile((String) null, "W\"@iQUG4OB\">(@");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test14()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("5x}Ao6~ L+", "");
      Charset charset0 = Charset.defaultCharset();
//      try { 
...
//      }
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("\"yDhMG", cSVFormat0);
//      try { 
        cSVParser0.nextRecord();
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("1Oa_>3ira[", cSVFormat0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("l9m-TiL5%zF7PF(L");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
...
//      }
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("%*.Kw1#", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test23()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("K?sGj0w7[`cJ", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test25()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("ZW\"A*-Uev{ufpX~", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("jqji(fdqi", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse("x>?F}NMsn>4&", cSVFormat2);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test28()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("The header contains a duplicate name: \"", "org.apache.commons.csv.Assertions");
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("+E[f;89S-1TNTY6u~[", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
...
//      }
  ...
  public void test32()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("org.apache.commons.csv.Assertions", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
