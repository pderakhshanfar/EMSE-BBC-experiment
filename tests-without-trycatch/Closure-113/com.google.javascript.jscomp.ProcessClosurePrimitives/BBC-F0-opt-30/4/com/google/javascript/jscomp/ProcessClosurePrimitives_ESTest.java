...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node0 = Node.newString(105, "iVQ{&D w");
...
//      }
  ...
  public void test02()  throws Throwable  {
      ...
      Node node0 = compiler1.parseSyntheticCode("namespace \"{0}\" cannot be provided twice", "goog.base");
      // Undeclared exception!
//      try { 
        processClosurePrimitives0.process(node0, node0);
...
//      }
  ...
  public void test04()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = new Node(575, (-862048943), 46);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      Node node1 = new Node(33, node0, node0, node0, node0, 38, 46);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
  ...
  public void test05()  throws Throwable  {
      ...
      CheckLevel checkLevel0 = CheckLevel.WARNING;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      Node node1 = new Node(37, node0, node0, node0, node0, 105, 1);
  ...
  public void test06()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(33, "goog.asserts.assertElement");
...
//      }
  ...
  public void test07()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(86, "4s%Jy");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      CheckLevel checkLevel0 = CheckLevel.OFF;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
  ...
  public void test08()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseTestCode("function JSCompiler_idenAityFn() {  return function(JSCompiler_identityFn_value) {return2JSCompiler_identityFn_value}}");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      CheckLevel checkLevel0 = CheckLevel.OFF;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      processClosurePrimitives0.process(node0, node0);
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      Node node1 = new Node(37, node0, node0, node0, node0, 8, (-1967));
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, processClosurePrimitives0);
      // Undeclared exception!
//      try { 
        processClosurePrimitives0.visit(nodeTraversal0, node1, node1);
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        compiler0.parseSyntheticCode("yaS._dE=DQERROR", "yaS._dE=DQERROR");
//       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
//      } catch(IllegalArgumentException e) {
//         //
...
//      }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        compiler0.parseSyntheticCode("namespace \"{0}\" cannot be provided twice", "goog.base");
//       //  fail("Expecting exception: IllegalArgumentException");
       // Unstable assertion
//      } catch(IllegalArgumentException e) {
//         //
