...
public class ProcessClosurePrimitives_ESTest extends ProcessClosurePrimitives_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node1 = new Node(105, node0, node0, node0, 15, (-1810));
...
//         //
//         // SCRIPT [source_file: com.google.javascript.rhino.Node$ObjectPropListItem@0000000602] [input_id: com.google.javascript.rhino.Node$ObjectPropListItem@0000000603] is not a string node
//         //
...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      Node node1 = new Node(105, node0, node0, node0, (-2600), 712);
...
//      }
  ...
  public void test03()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseTestCode("<I~S");
      Node node1 = new Node(106, node0, node0, node0, 15, 38);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node1);
      CheckLevel checkLevel0 = CheckLevel.WARNING;
      node0.addChildrenToFront(node1);
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
...
//      }
  ...
  public void test05()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString((-1865), "goog.base");
      Node node1 = new Node(33, node0, node0, node0, 8, 12);
      CompilerOptions compilerOptions0 = compiler0.newCompilerOptions();
  ...
  public void test06()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseTestCode("goog.basje");
      Node node1 = new Node(57, node0, node0, node0, 15, 38);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node1);
      CheckLevel checkLevel0 = CheckLevel.WARNING;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
  ...
  public void test07()  throws Throwable  {
      ...
      Node node1 = new Node(56, node0, node0, node0, 0, 39);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node1);
      CheckLevel checkLevel0 = CheckLevel.WARNING;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
...
//      }
  ...
  public void test09()  throws Throwable  {
      ...
      Node node1 = new Node(37, node0, node0, node0, 1, 36);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node1);
  ...
  public void test10()  throws Throwable  {
      ...
      Node.newString("&pVkc,U6ELx}W2o");
      CheckLevel checkLevel0 = CheckLevel.WARNING;
      LoggerErrorManager loggerErrorManager0 = new LoggerErrorManager(logger0);
      Compiler compiler0 = new Compiler(loggerErrorManager0);
      Node node0 = compiler0.parseSyntheticCode("&pVkc,U6ELx}W2o", "com.google.javascript.jscomp.TypeValidator");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      processClosurePrimitives0.process(node0, node0);
  ...
  public void test11()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("<I~S@");
      Node node1 = new Node(105, node0, node0, node0, 15, (-1844));
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node1);
      CheckLevel checkLevel0 = CheckLevel.WARNING;
      node0.addChildrenToFront(node1);
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
  ...
  public void test13()  throws Throwable  {
      Node node0 = Node.newString(33, "org.jso", 33, (-1150628719));
      Node node1 = new Node(37, node0, node0, node0, 1, 16);
      Compiler compiler0 = new Compiler();
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node1);
      CheckLevel checkLevel0 = CheckLevel.ERROR;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
...
//      }
  ...
  public void test14()  throws Throwable  {
      Node node0 = Node.newString("&pVkc,U6ELx}W2o");
      Node node1 = new Node(37, node0, node0, node0, 23, 105);
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node1);
      MockFile mockFile0 = new MockFile("&pVkc,U6ELx}W2o", "<non-file>");
...
//      }
  ...
  public void test16()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "googcb=Jase");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      CheckLevel checkLevel0 = CheckLevel.OFF;
      ProcessClosurePrimitives processClosurePrimitives0 = new ProcessClosurePrimitives(compiler0, preprocessorSymbolTable0, checkLevel0);
      processClosurePrimitives0.process(node0, node0);
