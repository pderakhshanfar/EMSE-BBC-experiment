...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)80, (byte)104, (byte)0, (byte)0, (byte)0}, byteArray0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 116, (-1284));
      assertNotNull(byteArrayInputStream0);
      assertEquals((-1284), byteArrayInputStream0.available());
  ...
  public void test02()  throws Throwable  {
      File file0 = MockFile.createTempFile("s0NAD{", "s0NAD{");
      assertNotNull(file0);
      assertEquals(0L, file0.length());
      assertEquals(0L, file0.getFreeSpace());
      assertTrue(file0.exists());
      assertEquals("/tmp/s0NAD{0s0NAD{", file0.toString());
      ...
      assertEquals("s0NAD{0s0NAD{", file0.getName());
  ...
  public void test03()  throws Throwable  {
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-22), (-84));
      assertNotNull(byteArrayInputStream0);
...
//      }
  ...
  public void test06()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(dataInputStream0, "GNU.sparse.size", false, false);
      assertNotNull(zipArchiveInputStream0);
      assertEquals(0L, zipArchiveInputStream0.getBytesRead());
      assertEquals(0, zipArchiveInputStream0.getCount());
...
//      }
  ...
  public void test07()  throws Throwable  {
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-15), (byte)54);
      assertNotNull(byteArrayInputStream0);
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(sequenceInputStream0, "AES192", true, true);
      assertNotNull(zipArchiveInputStream0);
      assertEquals(0, zipArchiveInputStream0.getCount());
      assertEquals(0L, zipArchiveInputStream0.getBytesRead());
...
//      }
  ...
  public void test13()  throws Throwable  {
      ZipArchiveInputStream zipArchiveInputStream0 = null;
//      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream((InputStream) null, "0x000A Zip Extra Field:", true);
//        fail("Expecting exception: IllegalCharsetNameException");
...
//      }
  ...
  public void test15()  throws Throwable  {
      ...
      int int0 = zipArchiveInputStream0.read(byteArray0, (int) (byte) (-38), (-119));
      assertEquals((-1), int0);
  }
...
//      }
  ...
  public void test22()  throws Throwable  {
      ...
      zipArchiveInputStream0.close();
//      try { 
        zipArchiveInputStream0.read(byteArray0, (int) (byte)54, 2108438490);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test26()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/s0NAD{0s0NAD{");
      byte[] byteArray0 = new byte[7];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "s0NAD{");
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = MockFile.createTempFile("s0NAD{", "s0NAD{");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "s0NAD{");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "s0NAD{");
