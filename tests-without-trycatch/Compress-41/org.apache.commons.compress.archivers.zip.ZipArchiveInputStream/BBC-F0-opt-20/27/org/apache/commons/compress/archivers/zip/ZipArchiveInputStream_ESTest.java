...
public class ZipArchiveInputStream_ESTest extends ZipArchiveInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      boolean boolean0 = ZipArchiveInputStream.matches(byteArray0, 1755);
...
//      try { 
        ZipArchiveInputStream.matches((byte[]) null, 1073741795);
...
//      }
  ...
  public void test06()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2017), 178);
...
//      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0, "org.apache.commons.compress.archivers.zip.ZipArchiveInputStream$BoundedInputStream", false, true);
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
//      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(sequenceInputStream0, "M[NRTry<X,Y[w`CR", true);
//        fail("Expecting exception: IllegalCharsetNameException");
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      ZipArchiveInputStream zipArchiveInputStream0 = null;
//      try {
        zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, "tTI`eiz\"f:BDOx");
//        fail("Expecting exception: IllegalCharsetNameException");
...
//      try { 
        zipArchiveInputStream0.read(byteArray0, (-529), 3);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test15()  throws Throwable  {
      ...
      long long0 = zipArchiveInputStream0.skip(1880L);
      assertEquals(0L, long0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        zipArchiveInputStream0.skip((-334L));
...
//      }
  ...
  public void test19()  throws Throwable  {
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 82, 608);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      zipArchiveInputStream0.close();
//      try { 
        zipArchiveInputStream0.skip(82);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test20()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 82, 608);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(byteArrayInputStream0);
      int int0 = zipArchiveInputStream0.read(byteArray0, 82, 82);
      assertEquals((-1), int0);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0, 8801);
      ZipArchiveInputStream zipArchiveInputStream0 = new ZipArchiveInputStream(pipedInputStream0, (String) null, true, false);
      JarArchiveEntry jarArchiveEntry0 = new JarArchiveEntry("D\"h=b],\"@N");
