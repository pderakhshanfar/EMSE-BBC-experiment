...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("[ optin, ", (Object) class0);
      assertEquals("[ optin, ", object0);
  }
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("/{k3*Fr/R-U<<?");
      assertFalse(file0.exists());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".N~}1KG)[!v3!doT.+2");
...
//      try { 
        TypeHandler.createValue("", (Object) "6i}$bT7\"4yfR_");
...
//      try { 
        TypeHandler.createObject("qCk");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: qCk
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createClass("qC@=U<b3nVl8A'4:=;");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: qC@=U<b3nVl8A'4:=;
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test14()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Yq'\";SPc", class0);
      assertNull(object0);
  }
...
//      }
  ...
  public void test17()  throws Throwable  {
      Class<Object> class0 = Object.class;
//      try { 
        TypeHandler.createValue("8F\"am", (Object) class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: 8F\"am
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
  ...
  public void test18()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("[ optin, ", class0);
      assertEquals("[ optin, ", object0);
  }
...
//      try { 
        TypeHandler.createURL("8");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to parse the URL: 8
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
