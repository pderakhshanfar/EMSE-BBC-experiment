...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Z%>{dd/.y d8");
...
//      try { 
        TypeHandler.createValue("B_.6]u", (Object) class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: B_.6]u
//         //
...
//      try { 
        TypeHandler.createValue("bT+2'59_SZ", (Object) "bT+2'59_SZ");
...
//      }
  ...
  public void test14()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("tueA{o_okkhFP=", class0);
      assertNull(object0);
  }
...
//      try { 
        TypeHandler.createNumber("9t6o)[.<y:L>@");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // For input string: \"9t6o)[.<y:L>@\"
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test20()  throws Throwable  {
      // Undeclared exception!
//      try { 
        TypeHandler.createDate("!~%{N@l9$2l");
...
//      try { 
        TypeHandler.createURL("uT");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to parse the URL: uT
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createClass("MYp");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: MYp
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
