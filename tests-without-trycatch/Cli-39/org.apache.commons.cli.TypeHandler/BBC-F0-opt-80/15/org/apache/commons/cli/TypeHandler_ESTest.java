...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile("/p{sK2U;Pq4+");
...
//      try { 
        TypeHandler.createClass("cvfUAu [o!q?$N");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: cvfUAu [o!q?$N
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test14()  throws Throwable  {
      Class<Object> class0 = Object.class;
//      try { 
        TypeHandler.createValue("el'", class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: el'
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createNumber("[ X.hn5bB>s-TReeye");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // For input string: \"[ X.hn5bB>s-TReeye\"
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
  ...
  public void test17()  throws Throwable  {
      Class<Object> class0 = Object.class;
//      try { 
        TypeHandler.createValue("Xu3qFs5 _}/h<%bXH3", (Object) class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: Xu3qFs5 _}/h<%bXH3
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test19()  throws Throwable  {
      File file0 = TypeHandler.createFile("my9rT=9~f/.Nbv");
...
//      try { 
        TypeHandler.createURL("XS;G[3Ht84U");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to parse the URL: XS;G[3Ht84U
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
