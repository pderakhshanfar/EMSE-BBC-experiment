...
//      }
  ...
  public void test02()  throws Throwable  {
      File file0 = TypeHandler.createFile(".iy%{N~sw5<>");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("`4o");
      byte[] byteArray0 = new byte[5];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("`4o");
  ...
  public void test07()  throws Throwable  {
      Class<Object> class0 = Object.class;
//      try { 
        TypeHandler.createValue(":0jk[UC;_uJ8y", (Object) class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: :0jk[UC;_uJ8y
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createObject("n_");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: n_
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createClass("q??HU{(\".T;5");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: q??HU{(\".T;5
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createNumber("Eu=w@$V;.");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // For input string: \"Eu=w@$V;.\"
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Eu=@$V;.", class0);
      assertNull(object0);
  }
...
//      }
  ...
  public void test25()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
//      try { 
        TypeHandler.createValue("Eu=@$V;.", ((PatternOptionBuilder) object0).NUMBER_VALUE);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // For input string: \"Eu=@$V;.\"
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
  ...
  public void test26()  throws Throwable  {
      Class<String> class0 = String.class;
      Object object0 = TypeHandler.createValue("fZP", class0);
      assertEquals("fZP", object0);
  }
...
//      try { 
        TypeHandler.createURL("UD:P`z]DRJB5Fo-=");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to parse the URL: UD:P`z]DRJB5Fo-=
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test32()  throws Throwable  {
      Class<Integer> class0 = Integer.class;
      Object object0 = TypeHandler.createValue("dq8('x@C@\"sgy70", (Object) class0);
      assertNull(object0);
  }
}
