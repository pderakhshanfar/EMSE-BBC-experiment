...
//      }
  ...
  public void test02()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "inU(1i>>9$&k]XuW?");
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".x<JSK;lBsBFW/");
  ...
  public void test06()  throws Throwable  {
      Class<Object> class0 = Object.class;
//      try { 
        TypeHandler.createValue("9qDa", (Object) class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: 9qDa
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test08()  throws Throwable  {
      // Undeclared exception!
//      try { 
        TypeHandler.createValue("L9msh)t!", (Object) "L9msh)t!");
...
//      try { 
        TypeHandler.createObject("06ITMXv");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: 06ITMXv
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createClass(".x<JSK;lBsBFW/");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: .x<JSK;lBsBFW/
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createNumber("A%J.*{YT/owy9;Ncrs");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // For input string: \"A%J.*{YT/owy9;Ncrs\"
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("Wh*SN|$o", class0);
      assertNull(object0);
  }
...
//      }
  ...
  public void test23()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("/{`/=gY>$", class0);
      assertEquals("/{`/=gY>$", object0);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/{`/=gY>$");
...
//      }
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
//      try { 
        TypeHandler.createValue("9qDa", ((PatternOptionBuilder) object0).URL_VALUE);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to parse the URL: 9qDa
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test29()  throws Throwable  {
      Object object0 = TypeHandler.createObject("org.apache.commons.cli.PatternOptionBuilder");
//      try { 
        TypeHandler.createValue("\"%.Ro)", ((PatternOptionBuilder) object0).CLASS_VALUE);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: \"%.Ro)
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
