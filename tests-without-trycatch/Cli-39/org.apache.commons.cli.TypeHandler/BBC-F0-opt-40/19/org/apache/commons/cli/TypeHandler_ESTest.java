...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      File file0 = TypeHandler.createFile(".=O|T^]P{(%UZ");
      assertEquals(".=O|T^]P{(%UZ", file0.toString());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/n$)<+HT?#!gtoK");
...
//      try { 
        TypeHandler.createValue("?}BK|zQ%@6YC9Rm(i", (Object) class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: ?}BK|zQ%@6YC9Rm(i
//         //
...
//      try { 
        TypeHandler.createValue("; Unable to create an instance of: ", (Object) "W\"gDFRbxgD");
...
//      }
  ...
  public void test09()  throws Throwable  {
      Class<Object> class0 = Object.class;
//      try { 
        TypeHandler.createValue("h4Y<HzHhQ*s", class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: h4Y<HzHhQ*s
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createClass("=+Muj~%h1{RIW5");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: =+Muj~%h1{RIW5
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createNumber(".=O|T^]P{(%UZ");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // For input string: \".=O|T^]P{(%UZ\"
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
//      try { 
        TypeHandler.createFiles("P3cM~Z5'2-$N]\"v&BY");
//        fail("Expecting exception: UnsupportedOperationException");
...
//      }
  ...
  public void test26()  throws Throwable  {
      Object object0 = TypeHandler.createValue("P3cM~Z5'2-$N]\"v&BY", (Object) null);
      assertNull(object0);
  }
}
