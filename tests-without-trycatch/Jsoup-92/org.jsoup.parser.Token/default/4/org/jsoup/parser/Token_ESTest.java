...
public class Token_ESTest extends Token_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Attributes attributes1 = attributes0.put("", "rC#(ozGiHO");
      token_StartTag0.attributes = attributes1;
      token_StartTag0.name("2wR'ak");
      String string0 = token_StartTag0.toString();
      assertEquals("<2wR'ak  =\"rC#(ozGiHO\">", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Token.EndTag token_EndTag0 = new Token.EndTag();
      token_EndTag0.normalName = " O`7]N-iZG";
      String string0 = token_EndTag0.normalName();
      assertEquals(" O`7]N-iZG", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Token.StartTag token_StartTag0 = new Token.StartTag();
      Token.StartTag token_StartTag1 = (Token.StartTag)token_StartTag0.name("2wR'ak");
      String string0 = token_StartTag1.name();
      assertEquals("2wR'ak", string0);
  }
