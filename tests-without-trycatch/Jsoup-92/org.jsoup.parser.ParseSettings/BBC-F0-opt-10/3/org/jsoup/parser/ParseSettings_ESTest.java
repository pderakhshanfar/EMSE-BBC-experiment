...
public class ParseSettings_ESTest extends ParseSettings_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Attribute attribute0 = new Attribute("#Z_NEg&H`8G|s>]", "Vy7!3g*&@t", attributes0);
...
//      }
  ...
  public void test09()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.normalizeAttribute("O:wYsx+3-]a3F1Z");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("O:wYsx+3-]a3F1Z", string0);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      ParseSettings parseSettings0 = new ParseSettings(true, true);
      String string0 = parseSettings0.preserveCase.normalizeTag("O:wYsx+3-]a3F1Z");
      assertTrue(parseSettings0.preserveTagCase());
      assertEquals("O:wYsx+3-]a3F1Z", string0);
  }
