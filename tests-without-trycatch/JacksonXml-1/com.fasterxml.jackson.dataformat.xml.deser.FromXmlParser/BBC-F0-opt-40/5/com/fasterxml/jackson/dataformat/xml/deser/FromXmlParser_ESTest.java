...
//      try {
        fromXmlParser0 = new FromXmlParser(iOContext0, 32, 32, objectMapper0, streamReaderDelegate0);
...
//      }
  ...
  public void test2()  throws Throwable  {
      IOContext iOContext0 = new IOContext((BufferRecycler) null, "P/N ", false);
      JsonFactory jsonFactory0 = new JsonFactory();
      ObjectMapper objectMapper0 = new ObjectMapper(jsonFactory0);
      StreamReaderDelegate streamReaderDelegate0 = new StreamReaderDelegate();
      FromXmlParser fromXmlParser0 = null;
//      try {
        fromXmlParser0 = new FromXmlParser(iOContext0, 0, (-1280), objectMapper0, streamReaderDelegate0);
