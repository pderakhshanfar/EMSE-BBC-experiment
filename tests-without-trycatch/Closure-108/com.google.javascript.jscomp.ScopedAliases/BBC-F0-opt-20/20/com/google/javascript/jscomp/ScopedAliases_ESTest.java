...
//      }
  ...
  public void test1()  throws Throwable  {
      Node node0 = Node.newString(5515, "%s: Added by %s");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      Compiler compiler0 = new Compiler();
...
//      }
  ...
  public void test4()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(3328, "%s: Added by %s");
      Node node1 = new Node(1, node0, node0, node0, 48, 46);
  ...
  public void test5()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(105, "%s: Aded b %s");
      Node node1 = new Node(37, node0, node0, node0, 47, (-88));
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      ScopedAliases scopedAliases0 = new ScopedAliases(compiler0, preprocessorSymbolTable0, (CompilerOptions.AliasTransformationHandler) null);
  ...
  public void test6()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString(105, "%s: Added by %s");
      PreprocessorSymbolTable preprocessorSymbolTable0 = new PreprocessorSymbolTable(node0);
      ScopedAliases scopedAliases0 = new ScopedAliases(compiler0, preprocessorSymbolTable0, (CompilerOptions.AliasTransformationHandler) null);
      scopedAliases0.process((Node) null, node0);
      assertEquals(49, Node.DIRECT_EVAL);
