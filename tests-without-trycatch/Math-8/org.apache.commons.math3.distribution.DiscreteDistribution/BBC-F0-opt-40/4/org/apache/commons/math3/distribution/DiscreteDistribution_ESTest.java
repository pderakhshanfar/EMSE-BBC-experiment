...
//      }
  ...
  public void test02()  throws Throwable  {
      ...
      discreteDistribution0.reseedRandomGenerator(1073741824);
  }
  ...
  public void test04()  throws Throwable  {
      Double double0 = new Double(2638);
...
//      }
  ...
  public void test05()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(6.283185307179586);
      Pair<String, Double> pair0 = new Pair<String, Double>("}%r]Q$&<~TqO~<#S", double0);
      linkedList0.add(pair0);
...
//      }
  ...
  public void test06()  throws Throwable  {
      Well512a well512a0 = new Well512a(1116L);
      LinkedList<Pair<Object, Double>> linkedList0 = new LinkedList<Pair<Object, Double>>();
      DiscreteDistribution<Object> discreteDistribution0 = null;
//      try {
...
//      }
  ...
  public void test07()  throws Throwable  {
      Well1024a well1024a0 = new Well1024a((-3391L));
...
//      }
  ...
  public void test08()  throws Throwable  {
      LinkedList<Pair<Float, Double>> linkedList0 = new LinkedList<Pair<Float, Double>>();
      Float float0 = new Float((-2438.0F));
      Double double0 = new Double((-2438.0F));
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      assertEquals("(%g[\\E!$l@{ (\"xC8]", string0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Double double0 = new Double(0.4591867192896957);
      Pair<String, Double> pair0 = new Pair<String, Double>("", double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well19937a0, linkedList0);
...
//      }
  ...
  public void test13()  throws Throwable  {
      Double double0 = new Double(0.7411975080770221);
      Pair<String, Double> pair0 = new Pair<String, Double>("", double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>((RandomGenerator) null, linkedList0);
  ...
  public void test16()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(mersenneTwister0, linkedList0);
      double double1 = discreteDistribution0.probability("(%g[\\E!$l@{ (\"xC8]");
  ...
  public void test17()  throws Throwable  {
      ...
      Pair<String, Double> pair0 = new Pair<String, Double>((String) null, double0);
      linkedList0.add(pair0);
      Well19937a well19937a0 = new Well19937a(523);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well19937a0, linkedList0);
      double double1 = discreteDistribution0.probability((String) null);
      assertEquals(1.0, double1, 0.01);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      Double double0 = new Double((-2535.461));
...
//      } catch(IllegalArgumentException e) {
//         //
//         // -2,535.461 is smaller than the minimum (0)
//         //
//         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
//      }
  }
