...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Double double0 = new Double(3762.37428524796);
      Pair<String, Double> pair0 = new Pair<String, Double>("oIz\"yq=|R", double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
//      try { 
        discreteDistribution0.sample((-773));
...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      Pair<String, Double> pair0 = new Pair<String, Double>("`ylz]2X|\"`|3S%aH9", double0);
      linkedList0.add(pair0);
...
//      }
  ...
  public void test03()  throws Throwable  {
      Double double0 = new Double(389.094438);
  ...
  public void test04()  throws Throwable  {
      ...
      discreteDistribution0.sample(191628299);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(0.5805651413240223);
      Pair<String, Double> pair0 = new Pair<String, Double>((String) null, double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      // Undeclared exception!
//      try { 
        discreteDistribution0.sample(1661);
...
//      }
  ...
  public void test06()  throws Throwable  {
      ...
      Double double0 = new Double(1960.64932);
...
//      }
  ...
  public void test07()  throws Throwable  {
      Double double0 = new Double(731.7951321739216);
...
//      }
  ...
  public void test10()  throws Throwable  {
      Well512a well512a0 = new Well512a(4945L);
...
//      }
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals("oIz\"yq=|R", string0);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Double double0 = new Double(0.8044218689123899);
      Pair<String, Double> pair0 = new Pair<String, Double>("oIz\"yq=|R", double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
...
//      }
  ...
  public void test15()  throws Throwable  {
      ...
      linkedList0.push(pair0);
      DiscreteDistribution<Object> discreteDistribution0 = new DiscreteDistribution<Object>(linkedList0);
      Object[] objectArray0 = discreteDistribution0.sample(175);
      assertEquals(175, objectArray0.length);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      double double1 = discreteDistribution0.probability("Cardan angles singularity");
      assertEquals(0.0, double1, 0.01);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      Double double0 = new Double(0.34588626253444454);
      Pair<String, Double> pair0 = new Pair<String, Double>((String) null, double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
  ...
  public void test20()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      double double1 = discreteDistribution0.probability("oIz\"yq=|R");
      assertEquals(1.0, double1, 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double((-0.1597270864359133));
      Pair<String, Double> pair0 = new Pair<String, Double>("`ylz]2X|\"`|3S%aH9", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = null;
//      try {
...
//      } catch(IllegalArgumentException e) {
//         //
//         // -0.16 is smaller than the minimum (0)
//         //
//         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
//      }
  }
  ...
  public void test22()  throws Throwable  {
      Double double0 = new Double(375.5534627518015);
      Pair<String, Double> pair0 = new Pair<String, Double>("`WH>|cDb<#F|8ZK'ie", double0);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      linkedList0.add(pair0);
