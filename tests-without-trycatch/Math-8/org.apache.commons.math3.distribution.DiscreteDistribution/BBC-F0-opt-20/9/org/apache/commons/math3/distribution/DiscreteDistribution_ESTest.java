...
public class DiscreteDistribution_ESTest extends DiscreteDistribution_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Double double0 = new Double(1187.10582709);
...
//      }
  ...
  public void test03()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(676.08134109);
      Pair<String, Double> pair0 = new Pair<String, Double>((String) null, double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
  ...
  public void test04()  throws Throwable  {
      Double double0 = new Double(0.045828206587810616);
...
//      try { 
        discreteDistribution0.sample(4550);
...
//      }
  ...
  public void test05()  throws Throwable  {
      Double double0 = new Double((short)1667);
...
//      }
  ...
  public void test06()  throws Throwable  {
      Well512a well512a0 = new Well512a(1063);
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
...
//      } catch(IllegalArgumentException e) {
//         //
//         // -2,382 is smaller than the minimum (0)
//         //
//         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
//      }
  }
...
//      }
  ...
  public void test09()  throws Throwable  {
      ...
      well44497a1.setSeed((long) 78);
      Well44497a well44497a2 = new Well44497a(78);
      Well44497a well44497a3 = new Well44497a();
      well44497a3.setSeed(1L);
      DiscreteDistribution<Integer> discreteDistribution2 = new DiscreteDistribution<Integer>((List<Pair<Integer, Double>>) null);
  }
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      DiscreteDistribution<Short> discreteDistribution0 = new DiscreteDistribution<Short>(linkedList0);
//      try { 
        discreteDistribution0.sample((-2493));
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // number of samples (-2,493)
//         //
//         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
//      }
  }
  ...
  public void test12()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<Short> discreteDistribution0 = new DiscreteDistribution<Short>(linkedList0);
      Short[] shortArray0 = discreteDistribution0.sample((int) (short)228);
      assertEquals(228, shortArray0.length);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      Double double0 = new Double(0.7427058688039572);
  ...
  public void test15()  throws Throwable  {
      Double double0 = new Double(1187.10582709);
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Pair<String, Double> pair0 = new Pair<String, Double>("h*dU3nCo*Vr5kh}WDw", double0);
      linkedList0.offerLast(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      double double1 = discreteDistribution0.probability("h*dU3nCo*Vr5kh}WDw");
  ...
  public void test17()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(0.6461865605150799);
      Pair<String, Double> pair0 = new Pair<String, Double>("", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      double double1 = discreteDistribution0.probability("l4fe\u0002i");
  ...
  public void test19()  throws Throwable  {
      ...
      Double double0 = new Double((-2066.147663));
...
//      } catch(IllegalArgumentException e) {
//         //
//         // -2,066.148 is smaller than the minimum (0)
//         //
//         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
//      }
  }
