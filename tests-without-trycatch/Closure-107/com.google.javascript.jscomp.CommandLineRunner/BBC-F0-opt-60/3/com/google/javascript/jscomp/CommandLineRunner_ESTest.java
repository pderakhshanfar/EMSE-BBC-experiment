...
public class CommandLineRunner_ESTest extends CommandLineRunner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MockPrintStream mockPrintStream0 = new MockPrintStream("4owz~[?zClm");
...
//      }
  ...
  public void test1()  throws Throwable  {
      ...
      stringArray0[0] = "fX9)dO#S4+^$";
      stringArray0[1] = "=#aQP:.F@lF)l";
      stringArray0[2] = "@r/(se:&IH^zcj";
      stringArray0[3] = "end-char: ";
      stringArray0[4] = "BK|w%!Oe=";
      stringArray0[5] = ":!pD5!rji_'^{;.";
      stringArray0[6] = "Expected children to be strings";
      stringArray0[7] = "";
      stringArray0[8] = "Ehz\"`DFSkS";
