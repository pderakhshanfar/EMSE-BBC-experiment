...
//      }
  ...
  public void test4()  throws Throwable  {
      MockFile mockFile0 = new MockFile((File) null, "^DL<CqV<PDiMn");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      String[] stringArray0 = new String[6];
      stringArray0[0] = "l,}u7sZ:eaX^uEMLs(W";
      stringArray0[1] = "^DL<CqV<PDiMn";
      stringArray0[2] = "l,}u7sZ:eaX^uEMLs(W";
      stringArray0[3] = "^CnL6|H";
      stringArray0[4] = "^DL<CqV<PDiMn";
      stringArray0[5] = "^CnL6|H";
      CommandLineRunner commandLineRunner0 = null;
//      try {
