...
public class UnsupportedDurationField_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.joda.time.field.UnsupportedDurationField"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(UnsupportedDurationField_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.format.DateTimeParser", false, UnsupportedDurationField_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.DateTimePrinter", false, UnsupportedDurationField_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(UnsupportedDurationField_ESTest_scaffolding.class.getClassLoader()); 
