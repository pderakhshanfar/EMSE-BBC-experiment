...
public class SubLine_ESTest extends SubLine_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(2492.8, 2492.8, 2038.0265449307153);
  ...
  public void test01()  throws Throwable  {
      Vector3D vector3D0 = new Vector3D(2493.1598414401865, 2493.1598414401865, 2038.0265449307153);
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, 2038.0265449307153, vector3D0);
  ...
  public void test02()  throws Throwable  {
      ...
      Vector3D vector3D1 = new Vector3D(0.0, vector3D0, 0.0, vector3D0, 2038.6130168571, vector3D0);
      Line line0 = new Line(vector3D0, vector3D1);
      SubLine subLine0 = line0.wholeLine();
      Vector3D vector3D2 = subLine0.intersection(subLine0, false);
      assertEquals(1.0198139647741102E-32, vector3D2.getNormSq(), 0.01);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2492.8, vector3D0, 2038.0265449307153, vector3D0, (-698.3759150016715), vector3D0, 2038.0265449307153, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      SubLine subLine0 = line0.wholeLine();
...
//      }
  ...
  public void test05()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2493.1598414401865, 2493.1598414401865, 2038.0265449307153);
      Line line0 = new Line(vector3D1, vector3D0);
      SubLine subLine0 = line0.wholeLine();
...
//      }
  ...
  public void test12()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2492.8, vector3D0, 2038.0265449307153, vector3D0, (-698.3759150016715), vector3D0, 326.86841, vector3D0);
      Vector3D vector3D2 = new Vector3D(2492.8, vector3D1, 2038.0265449307153, vector3D0, (-2937.58820644477), vector3D1);
  ...
  public void test13()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2492.8, vector3D0, 2038.0, vector3D0, 2038.0, vector3D0, 326.86841, vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      SubLine subLine0 = line0.wholeLine();
      SubLine subLine1 = new SubLine(vector3D1, vector3D0);
  ...
  public void test14()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2492.8, vector3D0, 2038.0265449307153, vector3D0, (-2937.73176673464), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      SubLine subLine0 = line0.wholeLine();
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals((-1.820152495646814E-14), vector3D2.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Vector3D vector3D0 = Vector3D.PLUS_J;
      Vector3D vector3D1 = new Vector3D(2492.8, vector3D0, 2038.0265449307153, vector3D0, (-2937.58820644477), vector3D0);
      Line line0 = new Line(vector3D1, vector3D0);
      SubLine subLine0 = line0.wholeLine();
