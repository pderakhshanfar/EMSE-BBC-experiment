...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("WOixEG<Ac?kreO");
  ...
  public void test022()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\"');
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("A=Nj%2<D~r~f[-!");
      assertFalse(cSVFormat1.equals((Object)cSVFormat0));
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertEquals('\"', cSVFormat2.getDelimiter());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
  ...
  public void test023()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Epw.j");
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar('y');
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("Epw.j", cSVFormat2.getNullString());
  ...
  public void test030()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("KPY+2X!b~");
      ...
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("KPY+2X!b~", cSVFormat2.getNullString());
  }
  ...
  public void test037()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(">'PcJ*6nAW#");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter(';');
      assertEquals(';', cSVFormat2.getDelimiter());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals(">'PcJ*6nAW#", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test062()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withDelimiter('8');
...
//      }
  ...
  public void test074()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("A=Nj%2<D~r~f[-!");
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertEquals("A=Nj%2<D~r~f[-!", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(boolean0);
  }
...
//      }
  ...
  public void test094()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      StringReader stringReader0 = new StringReader("UF|1G=;Y;");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test102()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isQuoting());
      assertEquals("Delimiter=<1> QuoteChar=<1> CommentStart=<1> SkipHeaderRecord:false", string0);
  }

  @Test(timeout = 4000)
  public void test103()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("NV#`+QCh`Z");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('c');
      String string0 = cSVFormat2.toString();
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<NV#`+QCh`Z> RecordSeparator=<c> SkipHeaderRecord:false", string0);
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test114()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("NV#`+QCh`Z");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('c');
      CSVFormat cSVFormat3 = cSVFormat0.withNullString("NV#`+QCh`Z");
      ...
      assertEquals("NV#`+QCh`Z", cSVFormat3.getNullString());
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
      assertEquals(',', cSVFormat3.getDelimiter());
      assertFalse(boolean0);
      assertFalse(cSVFormat3.getSkipHeaderRecord());
  ...
  public void test115()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("NV#`+QCh`Z", cSVFormat2.getNullString());
      assertEquals("c", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(boolean0);
  ...
  public void test124()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(boolean0);
      assertEquals("NV#`+QCh`Z", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.isQuoting());
...
//      }
  ...
  public void test136()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("OGh~2");
      Character character0 = new Character('O');
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isCommentingEnabled());
      ...
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isQuoting());
      assertEquals("OGh~2", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
