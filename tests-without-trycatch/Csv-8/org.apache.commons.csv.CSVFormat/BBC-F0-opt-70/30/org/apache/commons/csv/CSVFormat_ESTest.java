...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withRecordSeparator("8=2");
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isQuoting());
      assertTrue(cSVFormat1.isEscaping());
  ...
  public void test022()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("XIxn.T");
  ...
  public void test026()  throws Throwable  {
      ...
      assertEquals("Unexpected Token type: ", cSVFormat5.getNullString());
  ...
  public void test035()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("2DE?(");
      ...
      assertEquals("2DE?(", cSVFormat2.getNullString());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test036()  throws Throwable  {
      ...
      assertEquals('_', (char)cSVFormat4.getEscape());
      assertFalse(cSVFormat3.getIgnoreEmptyLines());
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
  }
  ...
  public void test050()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("]Lm&P,");
...
//      }
  ...
  public void test070()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("3IfCUK#!");
      boolean boolean0 = cSVFormat1.isNullHandling();
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(boolean0);
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("3IfCUK#!", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.isQuoting());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
...
//      }
  ...
  public void test089()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      StringReader stringReader0 = new StringReader("w%Mf%5Fq_}<q)&n@");
      // Undeclared exception!
//      try { 
        cSVFormat1.parse(stringReader0);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test092()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("#+`En&ST~rSc'2");
      // Undeclared exception!
//      try { 
        cSVFormat1.parse(stringReader0);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test098()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('\"');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Q5<\"+d=WEqkn7{");
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertEquals("Delimiter=<\"> NullString=<Q5<\"+d=WEqkn7{> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals('\"', cSVFormat0.getDelimiter());
  }
