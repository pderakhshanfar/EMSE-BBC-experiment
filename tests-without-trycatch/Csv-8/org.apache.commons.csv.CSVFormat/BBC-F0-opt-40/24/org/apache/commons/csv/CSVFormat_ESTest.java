...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test008()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("u~]zn$8_z-Yl<6Y");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('\\');
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("u~]zn$8_z-Yl<6Y", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("],]R,?'G");
      assertEquals("],]R,?'G", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test030()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("L.CP$<GmN8lT=$e@");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("L.CP$<GmN8lT=$e@");
      ...
      assertFalse(cSVFormat3.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertEquals("L.CP$<GmN8lT=$e@", cSVFormat1.getNullString());
  }
  ...
  public void test033()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("$sI)IZ7y11>M");
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isEscaping());
      assertEquals("$sI)IZ7y11>M", cSVFormat2.getNullString());
      assertEquals('*', (char)cSVFormat2.getEscape());
  }
  ...
  public void test040()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('}');
      Character character0 = new Character('}');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("4Jig-ITkS N__'DW");
  ...
  public void test049()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("z+LBaC2>jkTjJ");
      ...
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("z+LBaC2>jkTjJ", string0);
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
  }
...
//      }
  ...
  public void test094()  throws Throwable  {
      ...
      Character character0 = new Character('}');
      CSVFormat cSVFormat1 = cSVFormat0.withQuoteChar(character0);
      StringReader stringReader0 = new StringReader("4Jig-ITkS N__'DW");
      // Undeclared exception!
//      try { 
        cSVFormat1.parse(stringReader0);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test097()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Delimiter=<,> Escape=<q> QuoteChar=<\"> RecordSeparator=<\r\n> SkipHeaderRecord:false");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<Delimiter=<,> Escape=<q> QuoteChar=<\"> RecordSeparator=<\r\n> SkipHeaderRecord:false> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test113()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("1ZMBI>S>Ak@k");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\\', (char)cSVFormat2.getEscape());
  ...
  public void test120()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      boolean boolean0 = cSVFormat0.equals("$sI)IZ7y11>M");
      assertFalse(boolean0);
  }
...
//      }
  ...
  public void test128()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Pttr c/");
      cSVFormat1.parse(stringReader0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals('\t', cSVFormat1.getDelimiter());
