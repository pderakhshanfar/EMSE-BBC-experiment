...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("aXV");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("v}YX%");
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("v}YX%", cSVFormat2.getRecordSeparator());
      assertEquals("aXV", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
  }
  ...
  public void test019()  throws Throwable  {
      ...
      assertEquals("The quoteChar cannot be a line break", cSVFormat4.getNullString());
  ...
  public void test036()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("&28U(;");
  ...
  public void test037()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("BE1cPbiN");
      cSVFormat1.parse(stringReader0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
  ...
  public void test047()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withQuoteChar('a');
...
//      }
  ...
  public void test059()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        cSVFormat0.EXCEL.withCommentStart('\r');
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test061()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("e@nmt");
      stringReader0.close();
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
...
//      }
  ...
  public void test087()  throws Throwable  {
      ...
      String[] stringArray0 = new String[7];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("*c#+=^qW?E=^7/");
      // Undeclared exception!
//      try { 
        cSVFormat1.parse(stringReader0);
...
//      }
  ...
  public void test091()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("h8 vl;%");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test094()  throws Throwable  {
      ...
      assertEquals('q', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals("Delimiter=<q> SkipHeaderRecord:false Header:[null]", string0);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
  }
  ...
  public void test110()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("]\"Q<H%X~9HE");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      ...
      assertTrue(cSVFormat1.isEscaping());
      assertFalse(boolean0);
      assertEquals("]\"Q<H%X~9HE", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
  ...
  public void test111()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("$*Z$DF[BJEv+bE#P)${");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertTrue(cSVFormat1.isEscaping());
      assertFalse(boolean0);
      assertEquals("$*Z$DF[BJEv+bE#P)${", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
  ...
  public void test121()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      boolean boolean0 = cSVFormat0.equals("Bu?Qq5;");
      assertFalse(boolean0);
  }
