...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Y 2:L:#");
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      assertEquals("Y 2:L:#", cSVFormat2.getNullString());
  ...
  public void test011()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      CSVFormat cSVFormat3 = cSVFormat2.withNullString("DrMz&/3=");
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertEquals(',', cSVFormat3.getDelimiter());
      assertEquals("\r\n", cSVFormat3.getRecordSeparator());
      assertEquals("DrMz&/3=", cSVFormat3.getNullString());
  ...
  public void test012()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("Y 2:L:#");
      ...
      assertEquals("Y 2:L:#", cSVFormat3.getNullString());
  }
  ...
  public void test021()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Y 2:L:#");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("Y 2:L:#");
      ...
      assertEquals('\"', (char)cSVFormat3.getQuoteChar());
      assertEquals('\t', cSVFormat3.getDelimiter());
      assertEquals("Y 2:L:#", cSVFormat1.getNullString());
      assertTrue(cSVFormat3.getIgnoreSurroundingSpaces());
  }
  ...
  public void test045()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Gak20q/-");
      String string0 = cSVFormat1.getNullString();
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("Gak20q/-", string0);
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
...
//      }
  ...
  public void test065()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(';');
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString(" xqy7");
      boolean boolean0 = cSVFormat1.isNullHandling();
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals(" xqy7", cSVFormat1.getNullString());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertTrue(boolean0);
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
...
//      }
  ...
  public void test083()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"ia:t2");
//      try { 
        cSVFormat1.parse(stringReader0);
...
//      }
  ...
  public void test087()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("$fmsMs,v(@@!od");
...
//      }
  ...
  public void test093()  throws Throwable  {
      ...
      assertEquals("Delimiter=<\t> Escape=<l> QuoteChar=<\"> CommentStart=<1> RecordSeparator=<1> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false", string0);
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
  ...
  public void test098()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(".<UN)O@#Df{tqv_<T");
      cSVFormat1.hashCode();
      assertEquals(".<UN)O@#Df{tqv_<T", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isEscaping());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
