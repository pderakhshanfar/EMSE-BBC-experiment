...
//      }
  ...
  public void test004()  throws Throwable  {
      ...
      assertEquals("H5", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test019()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("-!5hO2m](6&VM:b.j");
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isEscaping());
      assertEquals("-!5hO2m](6&VM:b.j", cSVFormat2.getNullString());
      assertEquals("\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test029()  throws Throwable  {
      ...
      assertEquals("org.apache.commons.csv.Constants", cSVFormat4.getNullString());
  ...
  public void test031()  throws Throwable  {
      ...
      assertEquals(',', cSVFormat3.getDelimiter());
      assertFalse(cSVFormat3.getSkipHeaderRecord());
      assertEquals("H5", cSVFormat3.getNullString());
      assertEquals("\r\n", cSVFormat3.getRecordSeparator());
  ...
  public void test034()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("\"A%4R&3E");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('D');
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals('D', cSVFormat2.getDelimiter());
      assertEquals("\"A%4R&3E", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  ...
  public void test038()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Q~[ rKX@q-l.>R'MSgg");
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("Q~[ rKX@q-l.>R'MSgg", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isCommentingEnabled());
  }
  ...
  public void test060()  throws Throwable  {
      ...
      Character character0 = new Character('\"');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("\"A%4R&3E");
...
//      }
  ...
  public void test094()  throws Throwable  {
      ...
      Character character0 = new Character('\"');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      StringReader stringReader0 = new StringReader("a`+uO*r;+` *");
      // Undeclared exception!
//      try { 
        cSVFormat1.parse(stringReader0);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test096()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("gIPk");
      cSVFormat1.parse(stringReader0);
  ...
  public void test097()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withEscape('&');
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart('{');
      StringReader stringReader0 = new StringReader("v0C.FG,>l.w\"'d'");
      // Undeclared exception!
//      try { 
        cSVFormat2.parse(stringReader0);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test117()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("QI{,BW1e=F=qFv>");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.isQuoting());
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test128()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      boolean boolean0 = cSVFormat0.equals("?l7oy");
      assertFalse(boolean0);
  }
