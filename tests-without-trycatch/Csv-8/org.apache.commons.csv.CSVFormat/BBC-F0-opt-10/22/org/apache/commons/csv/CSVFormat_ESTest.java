...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("UMQ");
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(';');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator(">XkI(hH#uR%#S,%,*p ");
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertEquals(">XkI(hH#uR%#S,%,*p ", cSVFormat2.getRecordSeparator());
      assertEquals("", cSVFormat2.getNullString());
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("`@nTIiRI_");
      assertFalse(cSVFormat2.isNullHandling());
  ...
  public void test038()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("C!'M2vQ3jaQ^GV8");
      Character character0 = new Character('g');
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      CSVFormat cSVFormat3 = cSVFormat2.withEscape(character0);
      assertFalse(cSVFormat3.equals((Object)cSVFormat2));
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("C!'M2vQ3jaQ^GV8", cSVFormat3.getNullString());
  ...
  public void test043()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("5HCf4f");
      CSVFormat cSVFormat2 = cSVFormat1.withDelimiter('t');
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("5HCf4f", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isQuoting());
  ...
  public void test054()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("92L'?r5");
      cSVFormat1.parse(stringReader0);
      assertFalse(cSVFormat1.isNullHandling());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.isEscaping());
...
//      }
  ...
  public void test075()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("Z+bm\"c,v[zwI&");
      stringReader0.close();
//      try { 
        cSVFormat1.parse(stringReader0);
...
//      }
  ...
  public void test081()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('^');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("_/hQj");
...
//      }
  ...
  public void test108()  throws Throwable  {
      ...
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertEquals("Delimiter=<C> CommentStart=<r> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertEquals('C', cSVFormat0.getDelimiter());
  }
  ...
  public void test109()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("b^+<D!<A=Vq~nD");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<b^+<D!<A=Vq~nD> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test116()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("5Cf4f");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertFalse(cSVFormat1.isCommentingEnabled());
      assertTrue(cSVFormat1.isQuoting());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test132()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      boolean boolean0 = cSVFormat0.equals("The header contains duplicate names: ");
      assertFalse(boolean0);
  }
