...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test008()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("qH+{ewdA\"");
      assertFalse(cSVFormat2.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
  ...
  public void test009()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("gi#!Ni");
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isNullHandling());
      assertFalse(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test016()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withNullString("Si1 5=1t2?^");
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy((Quote) null);
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("Si1 5=1t2?^", cSVFormat2.getNullString());
  }
  ...
  public void test041()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("G^\"/h");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentStart('-');
      assertEquals('-', (char)cSVFormat2.getCommentStart());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("G^\"/h", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test042()  throws Throwable  {
      ...
      stringArray0[1] = "J$].O]7F=";
      stringArray0[2] = "\r\n";
      stringArray0[3] = "pBa-S0W6O";
      ...
      StringReader stringReader0 = new StringReader("4U'vShuEFh:tQ");
  ...
  public void test049()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isEscaping());
      assertTrue(cSVFormat1.isQuoting());
      assertEquals("Si1 5=1t2?^", string0);
...
//      }
  ...
  public void test066()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("^@-^pn;dn<)tGWsr");
//      try { 
...
//      }
  ...
  public void test096()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("G,f/uCX/[78lSA");
      // Undeclared exception!
//      try { 
        cSVFormat2.parse(stringReader0);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test100()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("yTEQAw*~Z.2S,}_-");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<,> QuoteChar=<\"> NullString=<yTEQAw*~Z.2S,}_-> RecordSeparator=<\r\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test102()  throws Throwable  {
      ...
      String string0 = cSVFormat1.toString();
      assertFalse(cSVFormat0.getSkipHeaderRecord());
      assertEquals("Delimiter=<T> CommentStart=<T> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertEquals('T', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
  }
  ...
  public void test107()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('T');
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("qH+{ewdA\"");
