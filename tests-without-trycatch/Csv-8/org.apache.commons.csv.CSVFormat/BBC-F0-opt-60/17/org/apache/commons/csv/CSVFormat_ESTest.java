...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("~Je+(bUJ");
  ...
  public void test009()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Z~JVga6*Mv')RQj");
      Quote quote0 = Quote.NONE;
      CSVFormat cSVFormat2 = cSVFormat1.withQuotePolicy(quote0);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertEquals("Z~JVga6*Mv')RQj", cSVFormat2.getNullString());
  ...
  public void test025()  throws Throwable  {
      ...
      assertEquals("Z~JVga6*Mv')RQj", cSVFormat3.getNullString());
      assertTrue(cSVFormat3.getIgnoreEmptyLines());
      assertFalse(cSVFormat3.getSkipHeaderRecord());
  }
  ...
  public void test028()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("mh");
      String[] stringArray0 = new String[4];
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("mh", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscaping());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  ...
  public void test029()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("aLr=:aBeiC");
  ...
  public void test033()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("FKKK~|yEe;7BBi@J");
      ...
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("FKKK~|yEe;7BBi@J", cSVFormat2.getNullString());
  }
  ...
  public void test046()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Delimiter=<m> SkipHeaderRecord:false");
      cSVFormat1.parse(stringReader0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
  ...
  public void test054()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString("Gw");
...
//      }
  ...
  public void test070()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("KC\" :94}M&EC$I");
      stringReader0.close();
//      try { 
        cSVFormat1.parse(stringReader0);
...
//      }
  ...
  public void test075()  throws Throwable  {
      ...
      assertTrue(boolean0);
      assertEquals("mh", cSVFormat1.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.isQuoting());
...
//      }
  ...
  public void test095()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withQuotePolicy(quote0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      StringReader stringReader0 = new StringReader("+Aki_6");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test100()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withQuoteChar(character0);
      StringReader stringReader0 = new StringReader("!T(=L3@Wpdh8o~oK~XO");
      // Undeclared exception!
//      try { 
        cSVFormat2.parse(stringReader0);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test103()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("EV");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<f> NullString=<EV> SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertEquals('f', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getSkipHeaderRecord());
  ...
  public void test115()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("Gs!x(NdAV)");
      boolean boolean0 = cSVFormat0.equals(cSVFormat1);
      assertEquals("Gs!x(NdAV)", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
      assertFalse(boolean0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
