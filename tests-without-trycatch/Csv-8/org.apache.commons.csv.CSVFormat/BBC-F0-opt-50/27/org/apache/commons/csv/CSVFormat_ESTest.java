...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test003()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("tV^RtPpgSalcxb6cx6G");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("[Z9yM");
      assertEquals("[Z9yM", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      ...
      assertEquals("tV^RtPpgSalcxb6cx6G", cSVFormat2.getNullString());
  }
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("ie+o'u+mc:");
      assertFalse(cSVFormat2.isQuoting());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.equals((Object)cSVFormat1));
  ...
  public void test007()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("NR*\r|j");
      ...
      assertEquals("NR*\r|j", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isQuoting());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test011()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("l.pbIbrr(o*Ta:g");
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("l.pbIbrr(o*Ta:g", cSVFormat2.getNullString());
  }
  ...
  public void test019()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withSkipHeaderRecord(true);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("l.pbIbrr(o*Ta:g");
      assertEquals("l.pbIbrr(o*Ta:g", cSVFormat2.getNullString());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat2.isQuoting());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test025()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("d%y!");
      String[] stringArray0 = new String[4];
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isEscaping());
      assertEquals("d%y!", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
  }
  ...
  public void test040()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("zg`7C5s(");
      StringReader stringReader0 = new StringReader("zg`7C5s(");
      cSVFormat2.parse(stringReader0);
      assertTrue(cSVFormat2.isQuoting());
      assertEquals("zg`7C5s(", cSVFormat2.getNullString());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat2.isEscaping());
  ...
  public void test045()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withQuoteChar('8');
...
//      }
  ...
  public void test068()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.isEscaping());
      assertEquals("l.pbIbrr(o*Ta:g", cSVFormat1.getNullString());
      assertTrue(cSVFormat1.isQuoting());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertEquals(',', cSVFormat1.getDelimiter());
  ...
  public void test073()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withCommentStart('Z');
...
//      }
  ...
  public void test095()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("Meq)d>");
  ...
  public void test099()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("h]sHgK3#`XYN&`czFI");
      String string0 = cSVFormat1.toString();
      assertEquals("Delimiter=<\t> Escape=<\\> NullString=<h]sHgK3#`XYN&`czFI> RecordSeparator=<\n> SkipHeaderRecord:false", string0);
  }
  ...
  public void test102()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.TDF.withNullString("8nF:h=eHMArd");
      cSVFormat1.hashCode();
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("8nF:h=eHMArd", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscaping());
  }
  ...
  public void test126()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      boolean boolean0 = cSVFormat0.equals("h+!4_x5r'%3");
      assertFalse(boolean0);
  }
