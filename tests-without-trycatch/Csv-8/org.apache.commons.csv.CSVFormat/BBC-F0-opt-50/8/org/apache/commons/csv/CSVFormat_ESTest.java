...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("UE[hUKW\"9({");
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("b=m\">6@1_np-iz,-9");
  ...
  public void test006()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("s{/gh]h%K?Vi");
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat2.isNullHandling());
  ...
  public void test034()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      Character character0 = new Character('<');
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("4~(>?4B=*F2<m!:m@E");
      CSVFormat cSVFormat2 = cSVFormat1.withEscape(character0);
      assertEquals('<', (char)cSVFormat2.getEscape());
      assertFalse(cSVFormat2.isCommentingEnabled());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals('\"', (char)cSVFormat2.getQuoteChar());
      assertEquals("4~(>?4B=*F2<m!:m@E", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
...
//      }
  ...
  public void test095()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("s{N&~1\"PKg*Vi");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      assertFalse(cSVFormat1.isCommentingEnabled());
...
//      }
  ...
  public void test097()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Pk\"<5vVq");
      // Undeclared exception!
//      try { 
        cSVFormat2.parse(stringReader0);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test098()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("Xx!N\">:-hab,?e");
      // Undeclared exception!
//      try { 
        cSVFormat2.parse(stringReader0);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test099()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("zK{m>#N0(%M");
      // Undeclared exception!
//      try { 
        cSVFormat1.parse(stringReader0);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test100()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("A,O}d;\" u8rdauD7!");
      cSVFormat1.parse(stringReader0);
...
//      }
  ...
  public void test102()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("mgP29TGw<");
      // Undeclared exception!
//      try { 
        cSVFormat1.parse(stringReader0);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test103()  throws Throwable  {
      ...
      assertEquals("Delimiter=<9> Escape=<9> SkipHeaderRecord:false Header:[]", string0);
  }
  ...
  public void test105()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getSkipHeaderRecord());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("Delimiter=<,> QuoteChar=<M> NullString=<> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", string0);
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
  }
  ...
  public void test112()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat(',');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("-s!j'uIOcg(");
      cSVFormat1.hashCode();
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
