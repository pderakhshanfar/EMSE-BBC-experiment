...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test002()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("TdAB");
      ...
      assertEquals("TdAB", cSVFormat2.getNullString());
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("C!VivKU");
      ...
      assertEquals("C!VivKU", cSVFormat3.getNullString());
  ...
  public void test035()  throws Throwable  {
      ...
      stringArray0[0] = "zz?'[v@=h.iPe";
      stringArray0[1] = "Escape=<";
      stringArray0[2] = "'A:{>g{r,.wGj7r9";
      stringArray0[3] = "&+1j-\"@RAq]4'x1";
  ...
  public void test036()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withAllowMissingColumnNames(true);
      String[] stringArray0 = new String[5];
      stringArray0[0] = "w91wnLO(8ROe1!Z}Ev";
      stringArray0[1] = "u";
      stringArray0[2] = "B";
      stringArray0[3] = "&2o9&";
  ...
  public void test037()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("TdAB", cSVFormat3.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals(',', cSVFormat3.getDelimiter());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test055()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("]_fPFCZLh[?Z");
      CSVFormat cSVFormat2 = cSVFormat1.withAllowMissingColumnNames(true);
      assertTrue(cSVFormat2.equals((Object)cSVFormat1));
      assertFalse(cSVFormat2.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      ...
      assertTrue(cSVFormat2.getIgnoreEmptyLines());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals("]_fPFCZLh[?Z", cSVFormat2.getNullString());
  }
  ...
  public void test058()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("_g}RH~0-|e");
  ...
  public void test059()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("1vRDNjyM2sy");
...
//      }
  ...
  public void test082()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[4];
      stringArray0[0] = "jXJuq,#CU:.&Q1e";
      stringArray0[1] = "ALL";
      stringArray0[2] = "XXi&R--I@:oW95}8M'";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
...
//      }
  ...
  public void test084()  throws Throwable  {
      ...
      stringArray0[0] = "The comment start and the escapecharacter cannot be the same ('";
      stringArray0[1] = "o";
      stringArray0[2] = "g5ZtW2rG}X%z7";
      stringArray0[3] = "ef`OQ,";
...
//      }
  ...
  public void test085()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      String[] stringArray0 = new String[4];
      stringArray0[0] = "tA&K& 37@3fL`SJV";
      stringArray0[1] = "9-P?XRCf9l";
      stringArray0[2] = "";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
...
//      }
  ...
  public void test128()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("The comment start and the escapecharacter cannot be the same ('");
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("The comment start and the escapecharacter cannot be the same ('");
      boolean boolean0 = cSVFormat1.equals(cSVFormat2);
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("The comment start and the escapecharacter cannot be the same ('", cSVFormat2.getNullString());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertTrue(boolean0);
  ...
  public void test129()  throws Throwable  {
      ...
      assertEquals("The comment start and the escapecharacter cannot be the same ('", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
