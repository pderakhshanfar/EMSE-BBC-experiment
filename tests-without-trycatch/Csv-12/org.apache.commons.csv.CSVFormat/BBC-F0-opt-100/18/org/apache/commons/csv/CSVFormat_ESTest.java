...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("J'( pQ|.iM");
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat2.isNullStringSet());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test006()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("_Q|((dG7n!");
  ...
  public void test018()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("_Q|((dG7n!");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator('!');
      ...
      assertEquals("_Q|((dG7n!", cSVFormat4.getNullString());
  ...
  public void test031()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("o:rmhl@AD>WU;O47");
      String[] stringArray0 = new String[2];
      stringArray0[0] = "org.apache.commons.csv.CSVFormat@0000000001,java.lang.Object@0000000004,org.apache.commons.csv.CSVFormat@0000000005,org.apache.commons.csv.CSVFormat@0000000002";
      ...
      assertEquals(',', cSVFormat1.getDelimiter());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertEquals("o:rmhl@AD>WU;O47", cSVFormat2.getNullString());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
  }
  ...
  public void test041()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("zyW=Uqs?;* fy");
      ...
      assertEquals("zyW=Uqs?;* fy", cSVFormat2.getNullString());
      assertTrue(cSVFormat2.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  }
  ...
  public void test050()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals("_Q|((dG7n!", cSVFormat2.getNullString());
      assertFalse(cSVFormat2.isEscapeCharacterSet());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("\r\n", cSVFormat2.getRecordSeparator());
      assertEquals('\t', cSVFormat1.getDelimiter());
  ...
  public void test061()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('l');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("WGeMGKQ?");
...
//      }
  ...
  public void test076()  throws Throwable  {
      ...
      stringArray0[0] = "ub=Q#,:pZtb<BO6";
      stringArray0[1] = "#pZwB'?$kMwTf;!";
      stringArray0[2] = "6a*M";
      stringArray0[3] = "]~,!kvx+<CpXW8W7=";
      stringArray0[4] = "\r\n";
...
//      }
  ...
  public void test077()  throws Throwable  {
      ...
      stringArray0[1] = "(line ";
      stringArray0[2] = "~.xRi6%(Y";
      stringArray0[3] = "w";
      stringArray0[4] = "F2?D>i[@<SF=-_";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
...
//      }
  ...
  public void test084()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.DEFAULT.withNullString("~3`p]{\b8w");
      boolean boolean0 = cSVFormat1.isNullStringSet();
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertEquals("~3`p]{\b8w", cSVFormat1.getNullString());
      assertTrue(boolean0);
...
//      }
  ...
  public void test109()  throws Throwable  {
      ...
      stringArray0[0] = "Q&-[~aH fi6wq$%LA;~";
      stringArray0[1] = " DY1E{";
      stringArray0[2] = "x4Ui4WGh6{c6QDEN&)";
      stringArray0[3] = "9QG-p''.Ac{/VG.";
      ...
      assertEquals("Delimiter=<\t> Escape=<\\> RecordSeparator=<2> SkipHeaderRecord:false Header:[Q&-[~aH fi6wq$%LA;~,  DY1E{, x4Ui4WGh6{c6QDEN&), 9QG-p''.Ac{/VG., The delimiter cannot be a line break, , null]", string0);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test113()  throws Throwable  {
      ...
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("Delimiter=<z> QuoteChar=<\"> CommentStart=<O> RecordSeparator=<\r\n> EmptyLines:ignored SkipHeaderRecord:false", string0);
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  }
  ...
  public void test116()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("_Q|((dG7n!");
      cSVFormat1.hashCode();
      assertEquals("_Q|((dG7n!", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("\r\n", cSVFormat1.getRecordSeparator());
      assertTrue(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
  ...
  public void test131()  throws Throwable  {
      ...
      CSVFormat cSVFormat2 = cSVFormat0.RFC4180.withCommentMarker('2');
      boolean boolean0 = cSVFormat2.equals(cSVFormat1);
      assertEquals('2', cSVFormat0.getDelimiter());
      assertFalse(cSVFormat0.getIgnoreEmptyLines());
      assertFalse(cSVFormat2.isNullStringSet());
  ...
  public void test136()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('2');
      CSVFormat cSVFormat1 = cSVFormat0.EXCEL.withEscape(':');
      CSVFormat cSVFormat2 = cSVFormat0.RFC4180.withIgnoreEmptyLines(false);
      boolean boolean0 = cSVFormat2.equals(cSVFormat1);
      assertFalse(cSVFormat0.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat2.isQuoteCharacterSet());
      assertFalse(cSVFormat2.isNullStringSet());
