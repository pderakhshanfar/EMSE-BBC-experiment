...
public class CSVFormat_ESTest extends CSVFormat_ESTest_scaffolding {
  ...
  public void test005()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("ikH:TBQ*31irYB;*=");
      CSVFormat cSVFormat2 = cSVFormat1.withRecordSeparator("ikH:TBQ*31irYB;*=");
  ...
  public void test008()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVFormat cSVFormat1 = cSVFormat0.withRecordSeparator("bnme%TS\"jS/$xy");
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.isNullStringSet());
      assertTrue(cSVFormat1.isQuoteCharacterSet());
  ...
  public void test010()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.MYSQL.withNullString("fcUK'I`8)q_U<#");
      ...
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
      assertEquals("fcUK'I`8)q_U<#", cSVFormat2.getNullString());
      assertEquals('\t', cSVFormat1.getDelimiter());
  }
  ...
  public void test040()  throws Throwable  {
      ...
      stringArray0[0] = "+=j$Y";
      stringArray0[1] = "2k3s=Tw!SC`0ZY3/d";
      stringArray0[2] = "";
      CSVFormat cSVFormat2 = cSVFormat1.withHeader(stringArray0);
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
  ...
  public void test057()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("r}T*!4!wTUlY3:8");
      CSVFormat cSVFormat2 = cSVFormat1.withCommentMarker('L');
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertEquals(',', cSVFormat1.getDelimiter());
      assertEquals("r}T*!4!wTUlY3:8", cSVFormat2.getNullString());
  ...
  public void test065()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("!)!>VtdUv|aYXUv#7");
  ...
  public void test073()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("kb^YuRZP{TCs1P");
      String string0 = cSVFormat1.getNullString();
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.isEscapeCharacterSet());
      assertEquals("kb^YuRZP{TCs1P", string0);
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertFalse(cSVFormat1.getAllowMissingColumnNames());
  ...
  public void test086()  throws Throwable  {
      ...
      stringArray0[5] = "s>R#9D&,%'nSw+w0z";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "The comment start character and the quoteChar cannot be the same ('", 32, 32);
...
//      }
  ...
  public void test137()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("r}T*!4!wTUlY3:8");
      boolean boolean0 = cSVFormat1.equals(cSVFormat0);
      assertEquals("r}T*!4!wTUlY3:8", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isEscapeCharacterSet());
      assertFalse(cSVFormat1.getIgnoreSurroundingSpaces());
      assertTrue(cSVFormat1.getIgnoreEmptyLines());
      assertFalse(boolean0);
  ...
  public void test146()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      boolean boolean0 = cSVFormat0.equals("K4Y-;}9wP)=+Q");
      assertFalse(boolean0);
  }
...
//      }
  ...
  public void test157()  throws Throwable  {
      ...
      assertFalse(cSVFormat1.getIgnoreEmptyLines());
      assertTrue(cSVFormat1.isEscapeCharacterSet());
      assertEquals("fcUK'I`8)q_U<#", cSVFormat1.getNullString());
      assertFalse(cSVFormat1.isQuoteCharacterSet());
      assertEquals("\n", cSVFormat1.getRecordSeparator());
      assertEquals('\t', cSVFormat1.getDelimiter());
      assertTrue(boolean0);
