...
//      }
  ...
  public void test08()  throws Throwable  {
      ...
      jsonWriter0.value((-2104L));
      assertEquals("-2104", stringWriter0.toString());
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((double) 89);
      assertEquals("89.0", stringWriter0.toString());
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-1989.0));
      assertEquals("-1989.0", stringWriter0.toString());
  }
...
//      }
  ...
  public void test36()  throws Throwable  {
      ...
      jsonWriter1.setIndent("%SSNS4gv");
      jsonWriter3.value(0.0);
      assertEquals("[{},\n%SSNS4gv0.0", stringWriter0.toString());
  }
...
//      }
  ...
  public void test41()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("jQ#5D\u0007c=Ll\"}uulK");
      // Undeclared exception!
//      try { 
        jsonWriter1.beginObject();
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test52()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        jsonWriter0.name("O6x?xO/F[8h|6_");
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test55()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("+M0~sHK1cA};");
      jsonWriter1.close();
...
//      }
  ...
  public void test60()  throws Throwable  {
      ...
      jsonWriter0.name("<");
      jsonWriter0.value("<");
      JsonWriter jsonWriter2 = jsonWriter1.name("N+c\t,.3V/Tfkne!h8");
      jsonWriter2.beginObject();
      assertEquals("{\"<\":\"<\",\"N+c\\t,.3V/Tfkne!h8\":{", stringWriter0.toString());
  }
