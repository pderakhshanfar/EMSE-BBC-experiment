...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("$Pxt", (String) null);
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "Sz.TAw]h^KF@X;Jcv");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
...
//      }
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "bmm*fb]WvXw,A1bJ-S");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option((String) null, "qD0hnoJb|MmrS=4QS", true, "qD0hnoJb|MmrS=4QS");
      OptionGroup optionGroup2 = optionGroup1.addOption(option1);
      String string0 = optionGroup2.toString();
      assertEquals("[- bmm*fb]WvXw,A1bJ-S, --qD0hnoJb|MmrS=4QS qD0hnoJb|MmrS=4QS]", string0);
  }
...
//      } catch(Exception e) {
//         //
//         // The option '' was specified but an option from this group has already been selected: '$Pxt'
//         //
//         verifyException("org.apache.commons.cli.OptionGroup", e);
//      }
  }
