...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "-r|1Od) [h>@?u");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("", string0);
  }
...
//      }
  ...
  public void test05()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "llvzHoI$Buec{", true, "llvzHoI$Buec{");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option("", "", false, "");
      optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[- , --llvzHoI$Buec{ llvzHoI$Buec{]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "llvzHoI$Buec{", true, "llvzHoI$Buec{");
      Option option1 = new Option("", "", false, "h");
...
//      } catch(Exception e) {
//         //
//         // The option 'llvzHoI$Buec{' was specified but an option from this group has already been selected: ''
//         //
//         verifyException("org.apache.commons.cli.OptionGroup", e);
//      }
  }
