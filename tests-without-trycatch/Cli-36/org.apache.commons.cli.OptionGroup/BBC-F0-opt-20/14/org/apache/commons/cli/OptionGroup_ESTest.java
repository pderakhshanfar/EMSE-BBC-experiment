...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("z", "tcvi7^|QE/k\"TPO");
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "Either opt or longOpt must be specified", false, ".,Us7J59tb'{ [{F8");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
...
//      }
  ...
  public void test06()  throws Throwable  {
      ...
      Option option1 = new Option((String) null, true, ",K%-H.=#dFaAF");
      OptionGroup optionGroup2 = optionGroup1.addOption(option1);
      String string0 = optionGroup2.toString();
      assertEquals("[- , --null ,K%-H.=#dFaAF]", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "^;gsx O", true, (String) null);
      optionGroup0.addOption(option0);
