...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("", "Fawvo\"]`UM;?PxAr}_?", true, (String) null);
      option0.setRequired(true);
      options0.addOption(option0);
      Option option1 = options0.getOption("Fawvo\"]`UM;?PxAr}_?");
  ...
  public void test07()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option((String) null, ">$fI", false, ">$fI");
      option0.setArgs((-2));
      Options options1 = options0.addOption(option0);
      Option option1 = options1.getOption(">$fI");
...
//      }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        options0.addOption(" ] [ long ", "_|eZy,=L+X$%Jx 1^n}", true, " ] [ long ");
...
//      }
  ...
  public void test16()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("", "[6", false, (String) null);
  ...
  public void test18()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasShortOption("(lN4+D>,xl");
  ...
  public void test21()  throws Throwable  {
      ...
      Option option0 = new Option("", "Fawvo\"]`UM;?PxAr}_?", true, (String) null);
      options0.addOption(option0);
      boolean boolean0 = options0.hasOption("Fawvo\"]`UM;?PxAr}_?");
      assertTrue(boolean0);
  }
  ...
  public void test24()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option((String) null, ",8tT15Fuw&NDdo", false, ",8tT15Fuw&NDdo");
      Options options1 = options0.addOption(option0);
      List<String> list0 = options1.getMatchingOptions("");
      assertTrue(list0.contains(",8tT15Fuw&NDdo"));
  }
  ...
  public void test25()  throws Throwable  {
      ...
      Option option0 = new Option((String) null, ">$fI", false, ">$fI");
      Options options1 = options0.addOption(option0);
      List<String> list0 = options1.getMatchingOptions(">$fI");
      assertTrue(list0.contains(">$fI"));
  }
...
//      }
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        options0.addOption("/]l&SR8Ry", true, "[ Options: [ short ");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option '/]l&SR8Ry' contains an illegal character : '/'
//         //
//         verifyException("org.apache.commons.cli.OptionValidator", e);
//      }
  }
