...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option((String) null, "gmra");
      options0.addOption(option0);
  ...
  public void test08()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("wQ", "wQ", true, "wQ");
      Option option0 = options1.getOption("wQ");
...
//      }
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        options0.addOption("pVA`6Yf&", "' was specified but an option from this group ", true, "' was specified but an option from this group ");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'pVA`6Yf&' contains an illegal character : '`'
//         //
...
//      }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        options0.addOption("[ Options: [ short java.util.LinkedHashMap@0000000002 ] [ long {} ]", (String) null);
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test19()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasLongOption("0G");
      assertFalse(boolean0);
  }
  ...
  public void test22()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("", "]YUHmur`SEY?:FT", true, "");
  ...
  public void test23()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("", "", false, "");
      List<String> list0 = options1.getMatchingOptions("\"'`KVSd");
      assertEquals(0, list0.size());
  }
  ...
  public void test24()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("VFR", "VFR", false, "VFR");
      List<String> list0 = options0.getMatchingOptions("VFR");
      assertTrue(list0.contains("VFR"));
  }

  @Test(timeout = 4000)
  public void test25()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = options0.getOption("8/=N.fD@IW)m?! ,=.");
      assertNull(option0);
  }
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        options0.addOption("org.apache.commons.cli.Options", false, "GG");
//        fail("Expecting exception: IllegalArgumentException");
