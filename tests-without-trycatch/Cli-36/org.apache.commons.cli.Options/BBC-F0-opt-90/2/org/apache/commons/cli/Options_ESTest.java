...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, (String) null, false, "f}>j.");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      options0.addOptionGroup(optionGroup1);
      OptionGroup optionGroup2 = options0.getOptionGroup(option0);
      assertFalse(option0.isRequired());
  ...
  public void test10()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption((String) null, "/", false, "|- xR3iPFAJG3<mz");
      Option option0 = options1.getOption("/");
      assertNotNull(option0);
      assertEquals("|- xR3iPFAJG3<mz", option0.getDescription());
...
//      }
  ...
  public void test14()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("v_", "N-uLBX. @(", true, "e/7 t]VP6o4F");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        options0.addOption("|U[7OU%k@a (DZaM", "S9gkuW6NWuXknUnxn!p", true, "");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option '|U[7OU%k@a (DZaM' contains an illegal character : '|'
//         //
//         verifyException("org.apache.commons.cli.OptionValidator", e);
//      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        options0.addOption("x0w=9-l,NTy`#g^*Gy", "x0w=9-l,NTy`#g^*Gy");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'x0w=9-l,NTy`#g^*Gy' contains an illegal character : '='
//         //
//         verifyException("org.apache.commons.cli.OptionValidator", e);
//      }
  }
  ...
  public void test25()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("V", "[ Options: [ short ", false, "V");
  ...
  public void test27()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasOption("Wo+yS\"0-[dw\"!IU<");
      assertFalse(boolean0);
  }
  ...
  public void test28()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("", "N-uLBX. @(", true, "#O_%n{jxH");
  ...
  public void test29()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("B", "B", true, "M Rxi 9.o");
      List<String> list0 = options0.getMatchingOptions("He,,j.hT&4yl$6U");
      assertEquals(0, list0.size());
  }
  ...
  public void test32()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("V", "[ Options: [ short ", false, "V");
