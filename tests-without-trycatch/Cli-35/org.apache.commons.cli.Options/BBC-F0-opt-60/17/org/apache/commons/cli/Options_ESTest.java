...
public class Options_ESTest extends Options_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("", "SbP91)30KZ");
  ...
  public void test03()  throws Throwable  {
      Options options0 = new Options();
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("NO_ARGS_ANLLOWED", "NO_ARGS_ANLLOWED");
  ...
  public void test04()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("2d", "'");
      option0.setRequired(true);
      options0.addOption(option0);
      Option option1 = options0.getOption("2d");
  ...
  public void test09()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("", false, "J)k-f!2!F");
...
//      }
  ...
  public void test11()  throws Throwable  {
      Options options0 = new Options();
      Options options1 = options0.addOption("", "C}qk", true, (String) null);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        options0.addOption("`t3pg$#", " ]", false, "`t3pg$#");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option '`t3pg$#' contains an illegal character : '`'
//         //
...
//      }
  ...
  public void test16()  throws Throwable  {
      Options options0 = new Options();
      Option option0 = new Option("Xh", "$?j^[Ec&&:##?", false, " (0X_'b&H~_PmH(Ll");
      Options options1 = options0.addOption(option0);
      assertSame(options1, options0);
  }
  ...
  public void test20()  throws Throwable  {
      Options options0 = new Options();
      boolean boolean0 = options0.hasLongOption("!E] -zd%Tm");
      assertFalse(boolean0);
  }
  ...
  public void test21()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("", "[ Options: [ short java.util.LinkedHashMap@0000000003 ] [ long {} ]", true, "fT@ExBl,5,f901J*");
  ...
  public void test24()  throws Throwable  {
      Options options0 = new Options();
      options0.addOption("h", "y", true, "buMD#G^|uUqL@MV!");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        options0.addOption("HdI[LQ%!C", false, "h");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'HdI[LQ%!C' contains an illegal character : '['
//         //
//         verifyException("org.apache.commons.cli.OptionValidator", e);
//      }
  }
