...
public class JavaUtilCollectionsDeserializers_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.fasterxml.jackson.databind.deser.impl.JavaUtilCollectionsDeserializers"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(JavaUtilCollectionsDeserializers_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(JavaUtilCollectionsDeserializers_ESTest_scaffolding.class.getClassLoader()); 
