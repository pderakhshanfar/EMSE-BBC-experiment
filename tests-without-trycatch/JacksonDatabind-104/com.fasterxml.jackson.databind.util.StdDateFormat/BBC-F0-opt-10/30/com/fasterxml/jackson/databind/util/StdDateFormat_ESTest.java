...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parse("0504-00-00");
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("", "uw", "Qaa[/Tof7BfxVO");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition((-3976));
//      try { 
        stdDateFormat0.parseAsISO8601("uw", parsePosition0);
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"uw\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? false)
//         //
...
//      }
  ...
  public void test04()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
//      try { 
        stdDateFormat0.parse("0000 f0");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"0000 f0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test05()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "+0000", 0, 0, (-784), 0, (-784), 0, (-173), 758);
...
//      }
  ...
  public void test06()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
//      try { 
        stdDateFormat0.parse("3%TP9");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"3%TP9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test07()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("t{/uhW+v:");
  ...
  public void test16()  throws Throwable  {
      ...
      Locale locale0 = new Locale("QT*n+LU,FwRN6@dB", "", "CVs7aln6m3W#");
  ...
  public void test17()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "`$%q~ik");
  ...
  public void test18()  throws Throwable  {
      Locale locale0 = new Locale("", "uw", "uw");
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "uw", 3, 3, 3, 3, 3, 3, 3, 3, 3);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertNotNull(timeZone0);
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test24()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("", "l=");
...
//      }
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        stdDateFormat0.parseAsRFC1123("jY-", (ParsePosition) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test29()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("", "", "Qaa[/Tof7BfxVO");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition((-3976));
      // Undeclared exception!
...
//      }
  ...
  public void test37()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1895), "0000-00-00T00:00");
...
//      }
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        stdDateFormat0._parseDate("Cannot parse date \"%s\": not compatible with any of standard forms (%s)", parsePosition0);
//        fail("Expecting exception: StringIndexOutOfBoundsException");
...
//      }
  ...
  public void test44()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(1850);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test47()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(1, 9, (-2288), 1, (-2288));
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition(1100);
      fieldPosition0.setEndIndex((-1179));
...
//      }
  ...
  public void test51()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("Qaa[/Tof7BfxVO", "uw");
      Boolean boolean0 = Boolean.FALSE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
  ...
  public void test52()  throws Throwable  {
      ...
      TimeZone timeZone0 = TimeZone.getTimeZone("Jy");
  ...
  public void test55()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition(1850);
      stdDateFormat0.parse("uw", parsePosition0);
      assertEquals(1850, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=1850,errorIndex=1850]", parsePosition0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(56);
      Date date0 = stdDateFormat1._parseDate("*7CN(-MI'[XTb&xEk@", parsePosition0);
      assertNull(date0);
  }
  ...
  public void test57()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition(2221);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
//      try { 
        stdDateFormat0.parse("0000-W0");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"0000-W0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test60()  throws Throwable  {
      ...
      stdDateFormat0.parse("1`Cxpm_gPSnO`\"h", parsePosition0);
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1886), (-461), (-1886), (-461), (-913), (-1886));
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition((-1667));
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("0031-05-12T03:15:34.000+0000", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer("cSTV[YcUcwqM");
      stdDateFormat0.format(date0, stringBuffer0, fieldPosition0);
      assertEquals("cSTV[YcUcwqM2014-02-14T20:21:21.320+00:00", stringBuffer0.toString());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ2014-02-14T20:21:21.363+00:00", stringBuffer0.toString());
  }
  ...
  public void test68()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1060), "");
      Locale locale0 = Locale.ITALIAN;
      MockDate mockDate0 = new MockDate(2, (-1060), 0, 108, (-1060), 446);
      StringBuffer stringBuffer0 = new StringBuffer("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0._format(simpleTimeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1813-09-03T18:27:24.940-0000", stringBuffer0.toString());
  }
  ...
  public void test71()  throws Throwable  {
      ...
      assertEquals(177, parsePosition0.getErrorIndex());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }

  @Test(timeout = 4000)
  public void test72()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2221, "dddd[-]dd[-]dd[T]dd[:]dd(?:[:]dd)?(.d+)?(Z|[+-]dd(?:[:]?dd)?)?");
      Locale locale0 = Locale.ENGLISH;
      StringBuffer stringBuffer0 = new StringBuffer();
      MockDate mockDate0 = new MockDate(2221, 1187, 1187, 2221, 2221, 2221);
      FieldPosition fieldPosition0 = new FieldPosition(2221);
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      stdDateFormat1.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      locale0.getDisplayVariant();
      StdDateFormat stdDateFormat2 = stdDateFormat0.withTimeZone(simpleTimeZone0);
      stdDateFormat0.instance.setLenient(true);
      StringBuffer stringBuffer1 = new StringBuffer();
      FieldPosition fieldPosition1 = new FieldPosition((-4297));
      ParsePosition parsePosition0 = new ParsePosition(2221);
  ...
  public void test73()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("", "9", "Qaa[/Tof7BfxVO");
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2221, "dddd[-]dd[-]dd[T]dd[:]dd(?:[:]dd)?(.d+)?(Z|[+-]dd(?:[:]?dd)?)?");
...
//      }
  ...
  public void test88()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(945);
      stdDateFormat0.instance.parse("0000-00-00T00h00", parsePosition0);
  }
}
