...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Locale locale0 = Locale.forLanguageTag("]@g84TG9{#");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
//      try { 
        stdDateFormat0.parseAsISO8601("e-IbCBe", (ParsePosition) null);
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"e-IbCBe\": while it seems to fit format 'yyyy-MM-dd', parsing fails (leniency? null)
//         //
...
//      }
  ...
  public void test05()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
//      try { 
        stdDateFormat0.parse("UqJE[  hh9");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"UqJE[  hh9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      MockDate mockDate0 = new MockDate((-274), 60000, (-274), 60000, 60000);
      ...
      assertEquals("0000-00-00T00:006632-03-16T16:00:00.000+0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      ZoneInfo zoneInfo0 = (ZoneInfo)StdDateFormat.DEFAULT_TIMEZONE;
      Locale locale0 = new Locale("!~VR3pnRbV/1Q", "!~VR3pnRbV/1Q", "");
  ...
  public void test08()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1614), "{cs0GLGIarB");
  ...
  public void test09()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = new Locale("1~8nEiX\"", "l# ");
  ...
  public void test17()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1768, "com.fasterxml.jackson.databind.util.StdDateFormat");
  ...
  public void test18()  throws Throwable  {
      Locale locale0 = Locale.CHINESE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1614), "{cs0GLGIarB");
      Boolean boolean0 = Boolean.valueOf("{cs0GLGIarB");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertFalse(stdDateFormat0.isLenient());
  ...
  public void test20()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("\"^XDuz(^NL)jZDg6");
      Locale locale0 = Locale.JAPANESE;
  ...
  public void test21()  throws Throwable  {
      ...
      StringBuffer stringBuffer0 = new StringBuffer("2014-02-14T20:21:21.320+0000");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, 753);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("2014-02-14T20:21:21.320+00002014-02-14T20:21:21.320+0000", stringBuffer0.toString());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("|9o;>$");
  ...
  public void test28()  throws Throwable  {
      Locale locale0 = Locale.ROOT;
      boolean boolean0 = StdDateFormat._equals((Object) "[one of: 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', 'EEE, dd MMM yyyy HH:mm:ss zzz' (lenient)]", (Object) locale0);
      assertFalse(boolean0);
  }
...
//      }
  ...
  public void test41()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition((-1957));
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test49()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ZoneOffset zoneOffset0 = ZoneOffset.ofTotalSeconds((-1912));
      TimeZone timeZone0 = TimeZone.getTimeZone((ZoneId) zoneOffset0);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withTimeZone(timeZone0);
      ParsePosition parsePosition0 = new ParsePosition((-2148));
      // Undeclared exception!
//      try { 
        stdDateFormat1.parse("Greenwich Mean Time", parsePosition0);
//        fail("Expecting exception: StringIndexOutOfBoundsException");
...
//      }
  ...
  public void test52()  throws Throwable  {
      Locale locale0 = Locale.CHINESE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(801, "{cs0GLGIarB");
      Boolean boolean0 = Boolean.valueOf("{cs0GLGIarB");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
  ...
  public void test53()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        stdDateFormat0.parse("1600-05-00");
//       //  fail("Expecting exception: NullPointerException");
       // Unstable assertion
//      } catch(NullPointerException e) {
//         //
...
//      }
  ...
  public void test54()  throws Throwable  {
      ...
      MockSimpleDateFormat mockSimpleDateFormat0 = (MockSimpleDateFormat)StdDateFormat.DATE_FORMAT_ISO8601;
      ParsePosition parsePosition0 = new ParsePosition((-3999));
      StdDateFormat stdDateFormat1 = StdDateFormat.instance;
      Boolean boolean0 = Boolean.FALSE;
      // Undeclared exception!
//      try { 
        stdDateFormat1._parseDate("y >FN;W+k_d~I_L\".l", (ParsePosition) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test58()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
//      try { 
        stdDateFormat0.parse("0000-rc00");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"0000-rc00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
//      try { 
        stdDateFormat0.parse("9k,0+G+N0Jv&(j");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"9k,0+G+N0Jv&(j\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition((-2418));
      // Undeclared exception!
//      try { 
        stdDateFormat0.instance.parse("00\u0000-0000T00:00", parsePosition0);
//        fail("Expecting exception: StringIndexOutOfBoundsException");
...
//      }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-2136), 2074, (-285));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0065-01-20T00:00:00.000+0000", string0);
  }

  @Test(timeout = 4000)
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(89, (-1614), (-1548));
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      String string0 = stdDateFormat1.format((Date) mockDate0);
      assertEquals("1850-04-04T00:00:00.000+00:00", string0);
      assertTrue(stdDateFormat1.isLenient());
  }
  ...
  public void test67()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf("{cs0GLGIarB");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate((-1614), (-1614), (-1614));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0147-01-27T23:59:58.386-0000", string0);
  }
...
//      }
  ...
  public void test70()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(10, "N4z#49^Zvy");
      Boolean boolean0 = Boolean.valueOf("");
      Locale locale0 = Locale.JAPANESE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
//      try { 
        stdDateFormat0.parse("i\"#8~N0");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"i\"#8~N0\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test71()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-285), 60, 1443);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(2074, "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Locale locale0 = Locale.forLanguageTag("");
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("1623-12-13T00:00:02.074+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test72()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      stdDateFormat0.parse("1090-00-00");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test77()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.FALSE;
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(626, "[V]tRTO");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withLocale(locale0);
      assertTrue(stdDateFormat1.isColonIncludedInTimeZone());
  ...
  public void test78()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getDefault();
      Locale locale0 = new Locale("yyyy-MM-dd'T'HH:mm:ss.SSSZ", "@[X(+9", "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      TimeZone timeZone1 = TimeZone.getTimeZone("@[X(+9");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
