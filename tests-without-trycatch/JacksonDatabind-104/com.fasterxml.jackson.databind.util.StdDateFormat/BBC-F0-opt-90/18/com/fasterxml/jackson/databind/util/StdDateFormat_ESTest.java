...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
//      try { 
        stdDateFormat0.parse("7,[4K1F1_Zx2fH-3");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"7,[4K1F1_Zx2fH-3\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
...
//      }
  ...
  public void test06()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parse("qlvh9", parsePosition0);
  ...
  public void test07()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate(2161, (-2682), (-6), (-6), 2161, 2);
      StringBuffer stringBuffer0 = new StringBuffer("aPL=p.sBhN*9vbX-*9H");
      stdDateFormat0._format(timeZone0, locale0, mockDate0, stringBuffer0);
      assertEquals("aPL=p.sBhN*9vbX-*9H3837-06-25T06:01:02.000+0000", stringBuffer0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(3750);
  ...
  public void test13()  throws Throwable  {
      ...
      stdDateFormat0.looksLikeISO8601("%W^lY&lx");
  ...
  public void test15()  throws Throwable  {
      Locale locale0 = Locale.KOREA;
      Boolean boolean0 = Boolean.valueOf(true);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(75, "QHIRS)");
  ...
  public void test16()  throws Throwable  {
      Locale locale0 = Locale.KOREA;
      Boolean boolean0 = Boolean.valueOf(true);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-48), "QHIRS)");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      TimeZone timeZone0 = stdDateFormat0.getTimeZone();
      assertNotNull(timeZone0);
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test19()  throws Throwable  {
      ...
      Locale locale0 = new Locale("2.2250738585072012e-308", "OhSZK8_pv_]w^8`");
      Boolean boolean0 = Boolean.valueOf("tkjdlc8w6<9rhE");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
  ...
  public void test22()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=1392409281320,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=java.util.SimpleTimeZone[id=0000-00-00,offset=0,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2014,MONTH=1,WEEK_OF_YEAR=7,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=45,DAY_OF_WEEK=6,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=8,HOUR_OF_DAY=20,MINUTE=21,SECOND=21,MILLISECOND=320,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      boolean boolean0 = StdDateFormat._equals("xok=o}cWpBH}SE/", "0000-00-00");
...
//      }
  ...
  public void test40()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate(753, 0, 2, 0, 2435, 2435);
...
//      }
  ...
  public void test41()  throws Throwable  {
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.JAPANESE;
      Boolean boolean0 = new Boolean("~0{M8k7J9JV<");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition((-20));
//      try { 
        stdDateFormat0._parseDate("0000-00-00z+qT00:00", parsePosition0);
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"0000-00-00z+qT00:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? false)
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
...
//      try { 
        stdDateFormat1.parse("4YhrU^=l%P]QC9h&K");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"4YhrU^=l%P]QC9h&K\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test54()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(3750);
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      stdDateFormat0.parse("zh-CN", parsePosition0);
      assertEquals("java.text.ParsePosition[index=3750,errorIndex=3750]", parsePosition0.toString());
      assertEquals(3750, parsePosition0.getErrorIndex());
  }
  ...
  public void test55()  throws Throwable  {
      ...
      stdDateFormat1.parseAsRFC1123("zh-CN", parsePosition0);
...
//      }
  ...
  public void test59()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
//      try { 
        stdDateFormat0.parse("90E5%y5+cMX7{");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"90E5%y5+cMX7{\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      parsePosition0.setIndex(6102);
      parsePosition0.setIndex((-3694));
//      try { 
        stdDateFormat0.instance._parseAsISO8601("strict", parsePosition0);
//        fail("Expecting exception: ParseException");
...
//      }
  ...
  public void test64()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.valueOf(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      MockDate mockDate0 = new MockDate(753, 0, 0, 0, 2435, 2435);
      StdDateFormat stdDateFormat1 = stdDateFormat0.withColonInTimeZone(true);
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition(5227);
      stdDateFormat1.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("2653-01-01T17:15:35.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(75, 75, 5215, 75, 5215);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals(29, stringBuffer0.length());
      assertEquals("1995-07-17T17:55:00.075+00:00", stringBuffer0.toString());
  }
  ...
  public void test66()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-48), "QHIRS)");
      StringBuffer stringBuffer0 = new StringBuffer();
      FieldPosition fieldPosition0 = new FieldPosition(415);
      MockDate mockDate0 = new MockDate((-1991), 1796, 64, 5215, 64);
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals(28, stringBuffer0.length());
      assertEquals("0059-06-08T08:03:59.952-0000", stringBuffer0.toString());
  }

  @Test(timeout = 4000)
  public void test67()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      FieldPosition fieldPosition0 = new FieldPosition(3750);
      MockDate mockDate0 = new MockDate((-1), 43, 44, (-1), (-1));
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals(54, stringBuffer0.length());
      assertEquals("yyyy-MM-dd'T'HH:mm:ss.SSSZ1902-09-12T22:59:00.000+0000", stringBuffer0.toString());
  }
...
//      }
  ...
  public void test70()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        stdDateFormat0.parse("K8:\"?wc-<8p.-o;7z", (ParsePosition) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test71()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
//      try { 
        stdDateFormat0.parse("0030-O00-00");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"0030-O00-00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
...
//      }
  ...
  public void test91()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, true);
      ParsePosition parsePosition0 = new ParsePosition((-20));
      stdDateFormat0.parse("0000-00-00z+qT00:00", parsePosition0);
      assertFalse(stdDateFormat0.isLenient());
      assertTrue(stdDateFormat0.isColonIncludedInTimeZone());
  }
