...
//         //
//         // Cannot parse date \"[one of: 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', 'EEE, dd MMM yyyy HH:mm:ss zzz' (strict)]\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
//         //
...
//      }
  ...
  public void test08()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
//      try { 
        stdDateFormat0.parse("\"`,+WIkYhf2l/S.{Q9");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"\"`,+WIkYhf2l/S.{Q9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test10()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(1000);
      stdDateFormat0.parse("0193-12-31T00:00:00.000+0000", parsePosition0);
      assertTrue(stdDateFormat0.isLenient());
  ...
  public void test11()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("FidjFfg LS&q9");
  ...
  public void test16()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(45, "0000-0-00");
  ...
  public void test17()  throws Throwable  {
      ...
      boolean boolean0 = stdDateFormat0.looksLikeISO8601("q2kTGqfHwq[");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  ...
  public void test20()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-138), "dddd[-]dd[-]dd[T]dd[:]dd(?:[:]dd)?(.d+)?(Z|[+-]dd(?:[:]?dd)?)?");
      Locale locale0 = new Locale("^1$I2-u~wmxq@t<%");
  ...
  public void test21()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(0, "%Z=~O4]8>", 0, 0, 2, 1, 0, 4, 0, 0, (-776), 4, 1);
  ...
  public void test24()  throws Throwable  {
      ...
      Locale locale0 = Locale.ITALY;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, (Boolean) null, true);
      MockDate mockDate0 = new MockDate(3124, 4, 3124, 1796, 3124);
      StringBuffer stringBuffer0 = new StringBuffer("!mdhwFIX). hHibj");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0);
      stdDateFormat0.format((Date) mockDate0, stringBuffer0, fieldPosition0);
      assertEquals("!mdhwFIX). hHibj5033-02-03T00:04:00.000+00:00", stringBuffer0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("Sat Oct 20 22:00:00 GMT 193", date0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("org.evosuite.runtime.mock.java.util.MockGregorianCalendar[time=-56051402400000,areFieldsSet=false,areAllFieldsSet=false,lenient=false,zone=sun.util.calendar.ZoneInfo[id=\"GMT\",offset=0,dstSavings=0,useDaylight=false,transitions=0,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=193,MONTH=9,WEEK_OF_YEAR=42,WEEK_OF_MONTH=3,DAY_OF_MONTH=20,DAY_OF_YEAR=293,DAY_OF_WEEK=7,DAY_OF_WEEK_IN_MONTH=3,AM_PM=1,HOUR=10,HOUR_OF_DAY=22,MINUTE=0,SECOND=0,MILLISECOND=0,ZONE_OFFSET=0,DST_OFFSET=0]", calendar0.toString());
  ...
  public void test30()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1706), 0, 0, (-1706), 0, 0);
...
//      }
  ...
  public void test33()  throws Throwable  {
      ...
      TimeZone timeZone0 = StdDateFormat.getDefaultTimeZone();
      Locale locale0 = Locale.TAIWAN;
      Boolean boolean0 = new Boolean("F(2j=r*zj++%");
...
//      }
  ...
  public void test43()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
//      try { 
        stdDateFormat0._parseDate("0193-10-20T22:00:00.000+0000", (ParsePosition) null);
//       //  fail("Expecting exception: ParseException");
       // Unstable assertion
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"0193-10-20T22:00:00.000+0000\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
...
//      try { 
        stdDateFormat0._parseAsISO8601("7gqOJS=&Ukx#taHvJW", parsePosition0);
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"7gqOJS=&Ukx#taHvJW\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? true)
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
...
//      try { 
        stdDateFormat1.parse("G(.\"s(z");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"G(.\"s(z\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test55()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition(1000);
      stdDateFormat0.setTimeZone(zoneInfo0);
      Date date0 = stdDateFormat0._parseDate("Ck", parsePosition0);
      assertNull(date0);
  }
...
//      }
  ...
  public void test60()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
//      try { 
        stdDateFormat0.parse("0030(000");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"0030(000\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test61()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        stdDateFormat0._parseDate("5Wp,UO<@gtNHkJY", (ParsePosition) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test66()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      MockDate mockDate0 = new MockDate((-1706), (-1706), 100, 19, (-620), 51);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0052-02-08T08:40:51.000+0000", string0);
  }
  ...
  public void test67()  throws Throwable  {
      ...
      assertEquals("1969-12-31T23:59:56.446+00:00", string0);
  }

  @Test(timeout = 4000)
  public void test68()  throws Throwable  {
      MockDate mockDate0 = new MockDate();
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3674, "");
      Locale locale0 = Locale.US;
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0, boolean0, true);
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("2014-02-14T20:21:24.994+00:00", string0);
  }
...
//      }
  ...
  public void test72()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean("CTF/UDJ9?d[%");
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test86()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3, "T]xfq%RoMC|", 3, 3, 3, 3, 3, 3, 3, 3, 3);
