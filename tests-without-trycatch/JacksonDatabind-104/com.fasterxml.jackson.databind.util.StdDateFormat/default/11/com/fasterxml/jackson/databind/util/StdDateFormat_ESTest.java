...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1378), "@xd'Oxd[ivMgALq");
      Locale locale0 = Locale.FRENCH;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(492);
//      try { 
        stdDateFormat0._parseAsISO8601("@xd'Oxd[ivMgALq", parsePosition0);
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"@xd'Oxd[ivMgALq\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
//         //
...
//      try { 
        stdDateFormat0.parse(")^YhERm", parsePosition0);
...
//      try { 
        stdDateFormat0.parse("^4~hA9");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"^4~hA9\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test10()  throws Throwable  {
      ...
      stdDateFormat0.parse("2689-01-21T10:31:10.000+0000", parsePosition0);
      assertTrue(stdDateFormat0.isLenient());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      assertEquals(1414, parsePosition0.getErrorIndex());
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      stdDateFormat0.looksLikeISO8601("$*<vhpKwvK");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
  }
  ...
  public void test18()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(10, "Qgm4=MO]>Q}^-P");
  ...
  public void test19()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-4861), "");
  ...
  public void test21()  throws Throwable  {
      ...
      stdDateFormat0._parseDate("o T3l!&i_9(/2g", parsePosition0);
      assertEquals("java.text.ParsePosition[index=1553,errorIndex=1553]", parsePosition0.toString());
      assertEquals(1553, parsePosition0.getErrorIndex());
  }
...
//      }
  ...
  public void test30()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-1625));
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test54()  throws Throwable  {
      ...
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0, (-2240));
      NumberFormat numberFormat0 = NumberFormat.getPercentInstance(locale0);
      numberFormat0.format((double) (-2240));
      stdDateFormat0.instance.setNumberFormat(numberFormat0);
      StringBuffer stringBuffer0 = new StringBuffer((CharSequence) "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      stdDateFormat0.instance.setLenient(false);
      DecimalFormat decimalFormat0 = new DecimalFormat("QBHbI.}y>#3)+hpXaV");
      Boolean boolean1 = new Boolean("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
      Boolean.valueOf("+00:00");
//      try { 
...
//      }
  ...
  public void test61()  throws Throwable  {
      ...
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1298), "d^}SOAP`\"hPi");
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
...
//      }
  ...
  public void test64()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
//      try { 
        stdDateFormat0.parse("7v?5*fva{TfJz@Q=");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"7v?5*fva{TfJz@Q=\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test65()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
//      try { 
        stdDateFormat0.parse("4gp}K8&jI#1j7U$u");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"4gp}K8&jI#1j7U$u\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test72()  throws Throwable  {
      ...
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      Date date0 = stdDateFormat0.parseAsISO8601("0000-00-00", parsePosition0);
      StringBuffer stringBuffer0 = new StringBuffer(")^YhERm");
      Format.Field format_Field0 = mock(Format.Field.class, new ViolatedAssumptionAnswer());
      FieldPosition fieldPosition0 = new FieldPosition(format_Field0);
      stdDateFormat0.format(date0, stringBuffer0, fieldPosition0);
      assertEquals(")^YhERm2014-02-14T20:21:21.320+0000", stringBuffer0.toString());
  }
  ...
  public void test73()  throws Throwable  {
      ...
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("\u75DD055-12-02T16:47:02.894-0000", string0);
  }
