...
public class StdDateFormat_ESTest extends StdDateFormat_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(43, "p.4\"w;JM2<z=*?Q&Sy");
      Locale locale0 = Locale.CANADA;
      StdDateFormat stdDateFormat0 = new StdDateFormat(simpleTimeZone0, locale0);
      ParsePosition parsePosition0 = new ParsePosition(43);
//      try { 
        stdDateFormat0._parseAsISO8601("p.4\"w;JM2<z=*?Q&Sy", parsePosition0);
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"p.4\"w;JM2<z=*?Q&Sy\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
//         //
...
//      }
  ...
  public void test08()  throws Throwable  {
      TimeZone timeZone0 = TimeZone.getTimeZone("qBQ");
  ...
  public void test12()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(3907, "Cannot parse date \"%s\": not compatible with any of standard forms (%s)");
      Locale locale0 = new Locale("", "Cannot parse date \"%s\": not compatible with any of standard forms (%s)", "M|1Kgb.88");
      ...
      stdDateFormat0.parseAsRFC1123("YK#c~R;!C*\u0003J$p~!", parsePosition0);
      assertEquals(3907, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=3907,errorIndex=3907]", parsePosition0.toString());
  }
...
//      try { 
        stdDateFormat0.parse("YaWP\"`/CR/M)", (ParsePosition) null);
...
//      }
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        stdDateFormat0.parse("|UU|>|i(jZF,RLh0");
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test42()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(4699, "", 0, 0, 0, 0, 0, 0, 4699, 5);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test43()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      MockDate mockDate0 = new MockDate(2181, (-4325), 2181, 2181, (-1032), (-4325));
      FieldPosition fieldPosition0 = new FieldPosition((-4325));
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test44()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
//      try { 
        stdDateFormat0._parseDate("0000-00-00T00l:00", (ParsePosition) null);
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"0000-00-00T00l:00\": while it seems to fit format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ', parsing fails (leniency? null)
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test45()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      ParsePosition parsePosition0 = new ParsePosition((-951));
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test47()  throws Throwable  {
      ...
      ParsePosition parsePosition0 = new ParsePosition((-2562));
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test57()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        stdDateFormat0.parseAsRFC1123("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=yyyy-MM-dd'T'HH:mm:ss.SSSZ,offset=0,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0], locale: yyyy-mm-dd't'hh:mm:ss.sssz, lenient: false)", (ParsePosition) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test62()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
      ParsePosition parsePosition0 = new ParsePosition(2121);
      stdDateFormat0.parseObject("97_`kCK5\"eJ", parsePosition0);
      assertEquals(2121, parsePosition0.getErrorIndex());
      assertEquals("java.text.ParsePosition[index=2121,errorIndex=2121]", parsePosition0.toString());
  }
  ...
  public void test64()  throws Throwable  {
      ...
      Locale locale0 = Locale.GERMANY;
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0);
      boolean boolean0 = stdDateFormat0.equals("l");
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertFalse(boolean0);
  }
  ...
  public void test69()  throws Throwable  {
      ...
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0);
      MockGregorianCalendar mockGregorianCalendar0 = new MockGregorianCalendar(3600, 51, 57, 9, 3600);
      Date date0 = mockGregorianCalendar0.getGregorianChange();
      String string0 = stdDateFormat0.format(date0);
      assertEquals("1582-10-15T18:00:00.000+1800", string0);
  }
  ...
  public void test70()  throws Throwable  {
      ...
      Date date0 = stdDateFormat0.parse("90000", parsePosition0);
      assertNotNull(date0);
      assertEquals((-1), parsePosition0.getErrorIndex());
  }
  ...
  public void test71()  throws Throwable  {
      StdDateFormat stdDateFormat0 = new StdDateFormat();
//      try { 
        stdDateFormat0.parse("0000 -00-00T00l:00");
//        fail("Expecting exception: ParseException");
      
//      } catch(ParseException e) {
//         //
//         // Cannot parse date \"0000 -00-00T00l:00\": not compatible with any of standard forms (\"yyyy-MM-dd'T'HH:mm:ss.SSSZ\", \"yyyy-MM-dd'T'HH:mm:ss.SSS\", \"EEE, dd MMM yyyy HH:mm:ss zzz\", \"yyyy-MM-dd\")
//         //
//         verifyException("com.fasterxml.jackson.databind.util.StdDateFormat", e);
//      }
  }
  ...
  public void test72()  throws Throwable  {
      ...
      Boolean boolean0 = Boolean.TRUE;
      StdDateFormat stdDateFormat0 = new StdDateFormat(zoneInfo0, locale0, boolean0);
      MockDate mockDate0 = new MockDate((-1812), (-1812), 915, 915, 915, (-1812));
      String string0 = stdDateFormat0.format((Date) mockDate0);
      assertEquals("0062-08-11T17:44:48.000+0000", string0);
  }
  ...
  public void test75()  throws Throwable  {
      StdDateFormat stdDateFormat0 = StdDateFormat.instance;
      int int0 = (-4026);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-4026), "0000-00-00T00:00");
      simpleTimeZone0.getOffset((long) (-4026));
  ...
  public void test78()  throws Throwable  {
      Locale locale0 = Locale.ROOT;
      TimeZone timeZone0 = TimeZone.getTimeZone("u{[}5_;JG(5Ox.");
      Boolean boolean0 = new Boolean(true);
      StdDateFormat stdDateFormat0 = new StdDateFormat(timeZone0, locale0, boolean0, false);
...
//      }
  ...
  public void test83()  throws Throwable  {
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone(1, "", 1, 1, 1, 1, 1, 1, 1, 26, 26);
  ...
  public void test84()  throws Throwable  {
      ...
      assertFalse(stdDateFormat0.isColonIncludedInTimeZone());
      assertEquals("DateFormat com.fasterxml.jackson.databind.util.StdDateFormat: (timezone: java.util.SimpleTimeZone[id=yyyy-MM-dd'T'HH:mm:ss.SSSZ,offset=0,dstSavings=3600000,useDaylight=false,startYear=0,startMode=0,startMonth=0,startDay=0,startDayOfWeek=0,startTime=0,startTimeMode=0,endMode=0,endMonth=0,endDay=0,endDayOfWeek=0,endTime=0,endTimeMode=0], locale: yyyy-mm-dd't'hh:mm:ss.sssz, lenient: false)", string0);
  }
