...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("BUJaY,");
      String string0 = StringUtils.newStringUtf8(byteArray0);
      assertEquals("BUJaY,", string0);
  }
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("0|p#C'VQ:V=JIK");
      assertEquals(28, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("0|p#C'VQ:V=JIK");
...
//      }
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
//      try { 
        StringUtils.getBytesUnchecked("\u7B00", (String) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
//      try { 
        StringUtils.getBytesUnchecked("\u5D67\u5473\u3E23\uFFFD", "g]sT#>4");
//        fail("Expecting exception: IllegalStateException");
      
//      } catch(IllegalStateException e) {
//         //
//         // g]sT#>4: java.io.UnsupportedEncodingException: g]sT#>4
//         //
...
//      }
  ...
  public void test24()  throws Throwable  {
      CharBuffer charBuffer0 = CharBuffer.wrap((CharSequence) "0|p#C'VQ:V=JIK");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test29()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "", (CharSequence) "J^gZK4D?wh");
  ...
  public void test31()  throws Throwable  {
      boolean boolean0 = StringUtils.equals((CharSequence) "pj$:", (CharSequence) null);
      assertFalse(boolean0);
  }
  ...
  public void test42()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("g]sT#>4");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u5D67\u5473\u3E23\uFFFD", string0);
  }

  @Test(timeout = 4000)
  public void test43()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("?-&L~#,v</");
      assertEquals(10, byteArray0.length);
  }
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        StringUtils.newString(byteArray0, "mFSr(h:");
//        fail("Expecting exception: IllegalStateException");
      
//      } catch(IllegalStateException e) {
//         //
//         // mFSr(h:: java.io.UnsupportedEncodingException: mFSr(h:
//         //
//         verifyException("org.apache.commons.codec.binary.StringUtils", e);
//      }
  }
