...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("B^DcLQ~E(2$3'f");
      Option option0 = OptionBuilder.create("NO_ARGS_ALLOWED");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("Nu5[DSA_E[dlw)BC");
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.hasOptionalArgs((-182));
      OptionBuilder.withLongOpt("A.|Hj;Ed.+&");
      Option option0 = OptionBuilder.create();
...
//      try { 
        OptionBuilder.create("A.|Hj;Ed.+&");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'A.|Hj;Ed.+&' contains an illegal character : '.'
//         //
