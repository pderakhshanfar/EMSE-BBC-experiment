...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(940);
      Option option0 = OptionBuilder.create("");
  ...
  public void test05()  throws Throwable  {
      Option option0 = OptionBuilder.create("rO");
      assertEquals((-1), option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      OptionBuilder.hasArgs(651);
      Option option0 = OptionBuilder.create("");
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(0);
      OptionBuilder.withLongOpt("Gl?j[Tk91[A.FE");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
...
//      try { 
        OptionBuilder.create("`dC}6i{,+lVep]H");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option '`dC}6i{,+lVep]H' contains an illegal character : '`'
//         //
//         verifyException("org.apache.commons.cli.OptionValidator", e);
//      }
  }
