...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt(".6_s!Q@)G");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('=', option0.getValueSeparator());
...
//      try { 
        OptionBuilder.create("~Cf>3HgzjfTju");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option '~Cf>3HgzjfTju' contains an illegal character : '~'
//         //
...
//      }
  ...
  public void test23()  throws Throwable  {
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create("nx");
      assertEquals('=', option0.getValueSeparator());
      assertEquals((-1), option0.getArgs());
  }
