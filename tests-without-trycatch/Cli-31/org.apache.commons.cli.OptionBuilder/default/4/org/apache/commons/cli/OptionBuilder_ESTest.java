...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Option option0 = OptionBuilder.create("An0cw");
      assertEquals((-1), option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      OptionBuilder.hasArgs(108);
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1076);
      Option option0 = OptionBuilder.create('7');
      assertEquals("7", option0.getOpt());
      assertEquals(1076, option0.getArgs());
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("|I> S0|,T");
      OptionBuilder.hasArgs(0);
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
...
//      try { 
        OptionBuilder.create("B+qm]oBc%WzU9c4");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'B+qm]oBc%WzU9c4' contains an illegal character : '+'
//         //
//         verifyException("org.apache.commons.cli.OptionValidator", e);
//      }
  }
...
//      }
  ...
  public void test20()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("2RJ}f<<uT6");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
  ...
  public void test29()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withType("[<:]qf*DRC");
      assertNotNull(optionBuilder0);
  }
}
