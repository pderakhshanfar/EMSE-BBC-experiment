...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.isRequired(true);
      OptionBuilder.withLongOpt("{I1/5rNZ[*@/4");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
...
//      try { 
        OptionBuilder.create("c!2}if");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'c!2}if' contains an illegal character : '!'
//         //
...
//      }
  ...
  public void test20()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("z\"GqMmF6q$7E}");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(1, option0.getArgs());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("c!2}if");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
