...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2661);
      OptionBuilder.withLongOpt("arg");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
...
//      try { 
        OptionBuilder.create("|WkYTBigG");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option '|WkYTBigG' contains an illegal character : '|'
//         //
...
//      }
  ...
  public void test19()  throws Throwable  {
      OptionBuilder.hasOptionalArgs((-556));
  ...
  public void test21()  throws Throwable  {
      OptionBuilder.withValueSeparator();
      OptionBuilder.withLongOpt("l&e6@");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('=', option0.getValueSeparator());
  }
