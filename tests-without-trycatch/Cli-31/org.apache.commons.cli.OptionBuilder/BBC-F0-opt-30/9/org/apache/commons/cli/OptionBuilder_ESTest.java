...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withLongOpt("+TZdZf|Vrgt7y#I");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1179);
      Option option0 = OptionBuilder.create('h');
      assertTrue(option0.hasOptionalArg());
      assertEquals(1179, option0.getArgs());
...
//      try { 
        OptionBuilder.create("scS-");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'scS-' contains an illegal character : '-'
//         //
