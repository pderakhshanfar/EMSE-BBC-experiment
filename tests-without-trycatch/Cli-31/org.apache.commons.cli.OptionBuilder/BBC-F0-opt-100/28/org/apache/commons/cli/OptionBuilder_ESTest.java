...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("NV/D'");
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withValueSeparator('\\');
      OptionBuilder.withLongOpt("f0bm[LYNDFM#");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('\\', option0.getValueSeparator());
  }
...
//      try { 
        OptionBuilder.create("f0bm[LYNDFM#");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'f0bm[LYNDFM#' contains an illegal character : '['
//         //
...
//      }
  ...
  public void test27()  throws Throwable  {
      OptionBuilder.isRequired();
      OptionBuilder.withLongOpt("cjzE<^h][!,6,mh");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  }
