...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      OptionBuilder.withLongOpt("ifVN");
      Option option0 = OptionBuilder.create("ifVN");
      assertEquals((-1), option0.getArgs());
  }
...
//      try { 
        OptionBuilder.create("wQeHo7Yi;(Y8)");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'wQeHo7Yi;(Y8)' contains an illegal character : ';'
//         //
