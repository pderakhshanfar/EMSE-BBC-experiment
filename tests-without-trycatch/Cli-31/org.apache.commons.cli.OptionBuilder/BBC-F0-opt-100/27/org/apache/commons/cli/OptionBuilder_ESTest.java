...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withValueSeparator('#');
      OptionBuilder.withLongOpt("Y@=]0nK<R\u0000UB");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('#', option0.getValueSeparator());
  }
...
//      try { 
        OptionBuilder.create("gYVk6s^nwr2I3O");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'gYVk6s^nwr2I3O' contains an illegal character : '^'
//         //
...
//      }
  ...
  public void test18()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("_D3irl0");
      assertNotNull(optionBuilder0);
  }
