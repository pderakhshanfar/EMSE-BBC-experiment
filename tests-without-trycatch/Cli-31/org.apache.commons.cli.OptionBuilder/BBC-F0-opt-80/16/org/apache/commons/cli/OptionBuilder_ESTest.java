...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("jJEMH)I J(,O@H");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('=', option0.getValueSeparator());
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("0yVy{*pEJ)5");
...
//      try { 
        OptionBuilder.create("t V=y9!1b#Hcu");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 't V=y9!1b#Hcu' contains an illegal character : ' '
//         //
...
//      }
  ...
  public void test20()  throws Throwable  {
      OptionBuilder.hasOptionalArgs();
      OptionBuilder.withLongOpt(">XJY}&uV=dK:!pV^n0Y");
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("B|[0,QF-;5I*)Z~rC=");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
