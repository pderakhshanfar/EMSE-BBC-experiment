...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(802);
      Option option0 = OptionBuilder.create('v');
      assertEquals(802, option0.getArgs());
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.hasArgs(891);
      Option option0 = OptionBuilder.create('c');
      assertEquals(891, option0.getArgs());
...
//      try { 
        OptionBuilder.create("W%SB`y>");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'W%SB`y>' contains an illegal character : '%'
//         //
...
//      }
  ...
  public void test28()  throws Throwable  {
      OptionBuilder.hasArgs(0);
      OptionBuilder.withLongOpt("3{LUG");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
}
