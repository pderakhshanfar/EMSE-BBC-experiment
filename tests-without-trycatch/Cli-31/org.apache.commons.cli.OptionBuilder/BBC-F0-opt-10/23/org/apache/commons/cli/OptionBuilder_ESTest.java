...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("a6");
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withLongOpt("T!3~Jw!<8-UuxC");
      Option option0 = OptionBuilder.create('?');
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt(")>$$ T+zd,");
      OptionBuilder.hasArgs();
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
  }
...
//      try { 
        OptionBuilder.create(")>$$ T+zd,");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option ')>$$ T+zd,' contains an illegal character : ')'
//         //
