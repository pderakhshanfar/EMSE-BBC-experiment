...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      OptionBuilder.hasArgs(2453);
      Option option0 = OptionBuilder.create();
      assertEquals(2453, option0.getArgs());
  }
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(0);
      OptionBuilder.withLongOpt("iW._*3q76_! ");
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
...
//      try { 
        OptionBuilder.create("g]enpV`Q$YXr!W8G7?=");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'g]enpV`Q$YXr!W8G7?=' contains an illegal character : ']'
//         //
