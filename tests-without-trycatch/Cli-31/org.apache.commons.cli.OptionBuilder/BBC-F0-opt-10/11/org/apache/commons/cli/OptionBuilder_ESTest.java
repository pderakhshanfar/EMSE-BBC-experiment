...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1372);
      Option option0 = OptionBuilder.create("");
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withLongOpt("SL/^*M=gf;Fd");
...
//      try { 
        OptionBuilder.create("v`p+T]N`6");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'v`p+T]N`6' contains an illegal character : '`'
//         //
