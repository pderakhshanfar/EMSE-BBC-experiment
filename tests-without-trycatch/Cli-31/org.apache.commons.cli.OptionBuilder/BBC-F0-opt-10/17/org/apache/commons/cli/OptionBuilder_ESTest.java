...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("0v`fb]BMXzB4D");
      OptionBuilder.withArgName("");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
...
//      try { 
        OptionBuilder.create(")^$fN");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option ')^$fN' contains an illegal character : ')'
//         //
//         verifyException("org.apache.commons.cli.OptionValidator", e);
//      }
  }
...
//      }
  ...
  public void test15()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription(")^$fN");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test23()  throws Throwable  {
      OptionBuilder.withLongOpt("kJE*+_oH");
      Option option0 = OptionBuilder.create('f');
      assertEquals((-1), option0.getArgs());
      assertEquals("f", option0.getOpt());
  }
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.isRequired();
      OptionBuilder.withLongOpt("+AD58q~O}3#_4 @");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
  }
