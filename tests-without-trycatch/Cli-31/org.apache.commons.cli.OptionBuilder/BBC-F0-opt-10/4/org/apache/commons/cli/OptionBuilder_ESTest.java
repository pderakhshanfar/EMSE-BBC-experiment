...
//      try { 
        OptionBuilder.create("im{lKX");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'im{lKX' contains an illegal character : '{'
//         //
//         verifyException("org.apache.commons.cli.OptionValidator", e);
//      }
  }
...
//      }
  ...
  public void test19()  throws Throwable  {
      OptionBuilder.hasArgs();
      OptionBuilder.withLongOpt("6A}$X*/!/");
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("im{lKX");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(1, option0.getArgs());
  }
  ...
  public void test25()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.hasArgs(2795);
