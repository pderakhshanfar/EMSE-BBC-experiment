...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionBuilder.withLongOpt("U %?Aia5@)S|_'");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("EP=}$=4PIJqZ");
...
//      try { 
        OptionBuilder.create(" ?ZaF4/0jU4wBf)?7[9");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option ' ?ZaF4/0jU4wBf)?7[9' contains an illegal character : ' '
//         //
//         verifyException("org.apache.commons.cli.OptionValidator", e);
//      }
  }
...
//      }
  ...
  public void test22()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("11V");
      assertTrue(option0.hasOptionalArg());
      assertEquals((-2), option0.getArgs());
  }
  ...
  public void test27()  throws Throwable  {
      OptionBuilder.withValueSeparator('&');
      OptionBuilder.withLongOpt("4C&AmU}Ah-)8xc#@m6");
      Option option0 = OptionBuilder.create();
      assertEquals('&', option0.getValueSeparator());
      assertEquals((-1), option0.getArgs());
  }
