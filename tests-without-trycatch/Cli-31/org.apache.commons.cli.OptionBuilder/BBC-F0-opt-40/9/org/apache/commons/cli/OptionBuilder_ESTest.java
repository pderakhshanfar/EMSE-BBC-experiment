...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1781);
      Option option0 = OptionBuilder.create("");
      assertEquals(1781, option0.getArgs());
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2270);
      Option option0 = OptionBuilder.create('8');
      assertTrue(option0.hasOptionalArg());
      assertEquals(2270, option0.getArgs());
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withLongOpt("");
      OptionBuilder.hasOptionalArgs(2776);
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(2776, option0.getArgs());
  }
...
//      try { 
        OptionBuilder.create("w$PN{G1We~U)KQ");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'w$PN{G1We~U)KQ' contains an illegal character : '{'
//         //
//         verifyException("org.apache.commons.cli.OptionValidator", e);
//      }
  }
