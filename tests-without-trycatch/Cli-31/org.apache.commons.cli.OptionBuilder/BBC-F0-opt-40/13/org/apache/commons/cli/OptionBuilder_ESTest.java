...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("Nh+RG%DR(DN3*");
      Option option0 = OptionBuilder.create();
...
//      try { 
        OptionBuilder.create("Nh+RG%DR(DN3*");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'Nh+RG%DR(DN3*' contains an illegal character : '+'
//         //
...
//      }
  ...
  public void test21()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("dl");
      assertNotNull(optionBuilder0);
  }
