...
public class DeserializerCache_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.annotation.JsonAutoDetect", false, DeserializerCache_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.type.TypeReference", false, DeserializerCache_ESTest_scaffolding.class.getClassLoader()));
