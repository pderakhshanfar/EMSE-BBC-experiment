...
public class ClassUtil_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.fasterxml.jackson.databind.util.ClassUtil"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.core.FormatFeature", false, ClassUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.io.InputDecorator", false, ClassUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.io.OutputDecorator", false, ClassUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.annotation.NoClass", false, ClassUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.deser.BeanDeserializerModifier", false, ClassUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.deser.DeserializationProblemHandler", false, ClassUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.introspect.POJOPropertiesCollector", false, ClassUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.type.TypeModifier", false, ClassUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.lang.Enum", false, ClassUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, ClassUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, ClassUtil_ESTest_scaffolding.class.getClassLoader()));
  }
