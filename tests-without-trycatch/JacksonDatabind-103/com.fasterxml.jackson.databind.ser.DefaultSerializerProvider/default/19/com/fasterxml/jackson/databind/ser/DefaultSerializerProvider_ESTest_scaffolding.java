...
public class DefaultSerializerProvider_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("com.fasterxml.jackson.databind.JsonDeserializer", false, DefaultSerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("java.util.function.BiFunction", false, DefaultSerializerProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, DefaultSerializerProvider_ESTest_scaffolding.class.getClassLoader()));
  }
