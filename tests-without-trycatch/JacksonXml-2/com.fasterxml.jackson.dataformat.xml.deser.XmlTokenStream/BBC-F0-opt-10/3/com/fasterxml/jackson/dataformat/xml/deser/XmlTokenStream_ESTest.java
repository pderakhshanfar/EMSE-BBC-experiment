...
//      }
  ...
  public void test2()  throws Throwable  {
      ...
      SystemId systemId0 = SystemId.construct("%{l 4", (URL) null);
      StringReader stringReader0 = new StringReader("%{l 4");
      BranchingReaderSource branchingReaderSource0 = new BranchingReaderSource(readerConfig0, "%{l 4", systemId0, stringReader0, false);
      WstxInputFactory wstxInputFactory0 = new WstxInputFactory();
      StreamBootstrapper streamBootstrapper0 = StreamBootstrapper.getInstance("#Ry&7Ei", systemId0, (InputStream) null);
