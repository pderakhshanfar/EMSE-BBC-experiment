...
//      }
  ...
  public void test1()  throws Throwable  {
      ...
      ReaderBootstrapper readerBootstrapper0 = ReaderBootstrapper.getInstance(" in public identifier", systemId0, stringReader0, "Internal error on SymbolTable.rehash(): had ");
      XMLStreamReader2 xMLStreamReader2_0 = wstxInputFactory0.createSR(readerConfig0, "W*whmldw5psj3P+ 6.", (InputBootstrapper) readerBootstrapper0, false, false);
      XmlTokenStream xmlTokenStream0 = null;
//      try {
        xmlTokenStream0 = new XmlTokenStream(xMLStreamReader2_0, uRL0);
