...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Logger logger0 = Logger.getLogger("DECOMPOSABLEEXPRESSION");
      ...
      Node node0 = Node.newString(0, "&9I[-]s8");
      Node node1 = new Node(40, node0, node0, node0, node0, 51, 30);
      AbstractCompiler.LifeCycleStage abstractCompiler_LifeCycleStage0 = AbstractCompiler.LifeCycleStage.NORMALIZED_OBFUSCATED;
      compiler0.setLifeCycleStage(abstractCompiler_LifeCycleStage0);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      // Undeclared exception!
//      try { 
        functionInjector0.inline(node0, "Side effects: ", node1, functionInjector_InliningMode0);
...
//      }
  ...
  public void test03()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, false, true);
      Node node0 = Node.newString(0, "&9I[-]s8");
      Node node1 = new Node(2, node0, node0, node0, node0, (-609), 300);
      AbstractCompiler.LifeCycleStage abstractCompiler_LifeCycleStage0 = AbstractCompiler.LifeCycleStage.NORMALIZED;
      compiler0.setLifeCycleStage(abstractCompiler_LifeCycleStage0);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      // Undeclared exception!
//      try { 
        functionInjector0.inline(node1, "Side effects: ", node0, functionInjector_InliningMode0);
...
//      }
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("&/@XY`yQoB4Fh7", node0);
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test06()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newString(141, "89Y", 141, 141);
...
//      }
  ...
  public void test08()  throws Throwable  {
      Logger logger0 = Logger.getLogger("DECOMPOSABLE_EXPRESSION");
      LoggerErrorManager loggerErrorManager0 = new LoggerErrorManager(logger0);
      Compiler compiler0 = new Compiler(loggerErrorManager0);
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionToBlockMutator.LabelNameSupplier functionToBlockMutator_LabelNameSupplier0 = new FunctionToBlockMutator.LabelNameSupplier(supplier0);
...
//      }
  ...
  public void test10()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = Node.newString("&9I[-]s8", 0, (-2443));
      JSModule jSModule0 = new JSModule("&9I[-]s8");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      Node node0 = Node.newString("&9I[-]s8", (-3457), (-1662));
      JSModule jSModule0 = new JSModule("&9I[-]s8");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference((Node) null, (JSModule) null, functionInjector_InliningMode0);
      ImmutableList<FunctionInjector.Reference> immutableList0 = ImmutableList.of(functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0, functionInjector_Reference0);
...
//      }
  ...
  public void test13()  throws Throwable  {
      ...
      HashSet<FunctionInjector.Reference> hashSet0 = new HashSet<FunctionInjector.Reference>();
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
      boolean boolean0 = functionInjector0.inliningLowersCost((JSModule) null, (Node) null, hashSet0, linkedHashSet0, true, true);
      assertTrue(boolean0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        functionInjector0.inline(node0, "Side effects: ", node0, functionInjector_InliningMode0);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test16()  throws Throwable  {
      ...
      Node node0 = compiler0.parseSyntheticCode("DECOMPOSABLE_EXPRESSION", "arguments");
  ...
  public void test17()  throws Throwable  {
      ...
      FunctionToBlockMutator.LabelNameSupplier functionToBlockMutator_LabelNameSupplier0 = new FunctionToBlockMutator.LabelNameSupplier(supplier0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, functionToBlockMutator_LabelNameSupplier0, true, true, true);
      Node node0 = Node.newString("&9I[-]s8", 0, (-2417));
      Node node1 = new Node((-2417), node0, node0, node0, node0, 54, 43);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      CompilerOptions compilerOptions0 = new CompilerOptions();
      FunctionNames functionNames0 = new FunctionNames(compiler0);
      RecordFunctionInformation recordFunctionInformation0 = new RecordFunctionInformation(compiler0, functionNames0);
...
//      }
  ...
  public void test19()  throws Throwable  {
      ...
      Node node1 = new Node(4, node0, node0, 0, 55);
