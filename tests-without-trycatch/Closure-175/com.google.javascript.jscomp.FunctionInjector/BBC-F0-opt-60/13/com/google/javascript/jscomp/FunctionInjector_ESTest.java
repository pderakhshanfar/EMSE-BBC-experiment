...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node0 = Node.newString((-1), "b[\"F_<");
      Node node1 = new Node(0);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      // Undeclared exception!
//      try { 
        functionInjector0.inline(node0, "collection is empty; use the other version of this method", node1, functionInjector_InliningMode0);
...
//      }
  ...
  public void test02()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newString("com.google.javascript.jscomp.FunctionInjector$2", 1153, (-2491));
...
//      }
  ...
  public void test03()  throws Throwable  {
      ...
      NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, coalesceVariableNames0);
      Node node0 = Node.newString("~>R", 1, 1);
  ...
  public void test04()  throws Throwable  {
      ...
      AbstractCompiler.LifeCycleStage abstractCompiler_LifeCycleStage0 = AbstractCompiler.LifeCycleStage.NORMALIZED;
      compiler0.setLifeCycleStage(abstractCompiler_LifeCycleStage0);
      Node node0 = Node.newString(33, "class");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test08()  throws Throwable  {
      ...
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "2XafyiR.!g0t\"RF1,+");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test09()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "pizIsi<k\"e~_");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      PrintStreamErrorManager printStreamErrorManager0 = new PrintStreamErrorManager(mockPrintStream0);
      Compiler compiler0 = new Compiler(printStreamErrorManager0);
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      Node node0 = Node.newString("pizIsi<k\"e~_");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      // Undeclared exception!
//      try { 
        functionInjector0.inline(node0, "BT75>!9~C|y8[Iu", node0, functionInjector_InliningMode0);
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        functionInjector0.inline(node0, "SCRIPT 1 [synthetic: com.google.javascript.rhino.Node$IntPropListItem@0000000611] [source_file: com.google.javascript.rhino.Node$ObjectPropListItem@0000000612] [input_id: com.google.javascript.rhino.Node$ObjectPropListItem@0000000613]", node0, functionInjector_InliningMode0);
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      Node node0 = Normalize.parseAndNormalizeTestCode(compiler0, "Z9?azdI%)");
      // Undeclared exception!
//      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("2XafyiR.!g0t\"RF1,+", node0);
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test16()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("z$,YnA\"hGn_(");
...
//      }
  ...
  public void test17()  throws Throwable  {
      ...
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
      JSModule jSModule1 = new JSModule("6");
      // Undeclared exception!
//      try { 
        functionInjector0.inliningLowersCost(jSModule1, (Node) null, priorityQueue0, linkedHashSet0, true, true);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test18()  throws Throwable  {
      ...
      LinkedHashSet<String> linkedHashSet0 = new LinkedHashSet<String>();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, false, false);
      boolean boolean0 = functionInjector0.inliningLowersCost(jSModule0, (Node) null, priorityQueue0, linkedHashSet0, true, true);
      assertTrue(boolean0);
  }
...
//      }
  ...
  public void test20()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("rR3h\u0006f!Immqi/_I[2");
      PriorityQueue<FunctionInjector.Reference> priorityQueue0 = new PriorityQueue<FunctionInjector.Reference>();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference((Node) null, jSModule0, functionInjector_InliningMode0);
      priorityQueue0.add(functionInjector_Reference0);
...
//      }
  ...
  public void test21()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("rR3h\u0006f!Immqi_I[2");
      PriorityQueue<FunctionInjector.Reference> priorityQueue0 = new PriorityQueue<FunctionInjector.Reference>();
      boolean boolean0 = functionInjector0.inliningLowersCost(jSModule0, (Node) null, priorityQueue0, (Set<String>) null, false, true);
      assertTrue(boolean0);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        functionInjector0.inline((Node) null, "M5kYA", node0, functionInjector_InliningMode0);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test25()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = compiler0.parseTestCode("|mQngM$o.~zW_i");
      Node node1 = new Node(7, node0);
      Node node2 = new Node(125, node1, node1, node1, 0, 15);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test26()  throws Throwable  {
      ...
      Node node2 = new Node(39, node1, node1, node1, 16, 15);
      // Undeclared exception!
//      try { 
        functionInjector0.maybePrepareCall(node0);
//        fail("Expecting exception: IllegalStateException");
