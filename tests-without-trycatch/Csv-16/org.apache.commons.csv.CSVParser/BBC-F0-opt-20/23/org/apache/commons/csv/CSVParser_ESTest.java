...
//      }
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "ix!mU-U3hiu";
      stringArray0[1] = "p03f$,Ie?>@^5$cd";
      stringArray0[2] = "[N~dW2aWti26";
      stringArray0[3] = "org.apache.commons.csv.CSVParser$1";
      stringArray0[4] = "bKl88z";
      stringArray0[5] = "(p*ImkWI%`l@tz>z)(+";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("xxmx<\"}H|TKgFli");
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("%G");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-7223L), (-7223L));
      cSVParser0.nextRecord();
      assertEquals((-7223L), cSVParser0.getRecordNumber());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("(p*ImkWI%`l@tz>z)(+", cSVFormat0);
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test10()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 4088L, (-1499L));
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "f&'=B{$IvpoH/S");
      Path path0 = mockFile0.toPath();
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
//      try { 
...
//      }
  ...
  public void test15()  throws Throwable  {
      ...
      URI uRI0 = MockURI.aFileURI;
      MockFile mockFile0 = new MockFile(uRI0);
      MockFile mockFile1 = new MockFile(mockFile0, "PKXS;OmvMC^J7U<JU`");
...
//      }
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("\"5Yu&");
      Path path0 = mockFile0.toPath();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test21()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
//      try { 
        CSVParser.parse("\".ttDvxJkmZ'q($m", cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test26()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-859), (byte)30);
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      MockFile mockFile0 = new MockFile("Af2acLe", "RFC4180");
      File file0 = MockFile.createTempFile("RFC4180", "F!=)o[p*6pvJPS", (File) mockFile0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test29()  throws Throwable  {
      MockFile mockFile0 = new MockFile(",DrT");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
//      try { 
...
//      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-1499L), (-1L));
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
//      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 867, 0L);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test39()  throws Throwable  {
      File file0 = MockFile.createTempFile("l#843lfWTR7N\"F-Ha", "l#843lfWTR7N\"F-Ha");
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
  ...
  public void test40()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat2, 1L, (-1499L));
      assertEquals((-1500L), cSVParser0.getRecordNumber());
  }
  ...
  public void test43()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("a*J{1pB.7h$%~xrCh)", cSVFormat1);
  ...
  public void test44()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("O6f_e-");
      CSVFormat cSVFormat2 = cSVFormat1.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("O6f_e-", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("{r1,", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
...
//      }
  ...
  public void test51()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("a*J{1pB.7h$%~xrCh)", cSVFormat0);
      cSVParser0.isClosed();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
