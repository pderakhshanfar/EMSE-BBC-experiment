...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("R\fd*");
      stringReader0.read();
...
//      }
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse(" ILkO`1yI", cSVFormat0);
      cSVParser0.nextRecord();
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("R\fd*");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 1, (-1750L));
      cSVParser0.nextRecord();
      assertEquals((-1750L), cSVParser0.getRecordNumber());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader(".D2x^nYAi");
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1118L), 1L);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("kg&j)YbB:(mTy|", cSVFormat0);
      cSVParser0.iterator();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test09()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("n7{e9", cSVFormat0);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test11()  throws Throwable  {
      StringReader stringReader0 = new StringReader("`J$P?}*voyNf%EFvFg");
...
//      }
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      File file0 = MockFile.createTempFile("' must not be null!", "R\fd*");
...
//      }
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("fzt56");
      Charset charset0 = Charset.defaultCharset();
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test19()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
//      try { 
        CSVParser.parse("\"RBSed K/d9 UkN]n*a", cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      MockFile mockFile0 = new MockFile("!VQ[t)'SYT/4E}3");
      File file0 = MockFile.createTempFile("!VQ[t)'SYT/4E}3", "!VQ[t)'SYT/4E}3", (File) mockFile0);
      // Undeclared exception!
//      try { 
...
//      try {
        cSVParser0 = new CSVParser((Reader) null, cSVFormat0, (-850L), 0L);
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("rR8&b{|$MOvlqM");
      CSVParser cSVParser0 = CSVParser.parse("rR8&b{|$MOvlqM", cSVFormat1);
      cSVParser0.getRecords();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      StringReader stringReader0 = new StringReader("rR8&b{|$MOvlqM");
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
...
//      }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("ne34Y");
...
//      }
  ...
  public void test38()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      Charset charset0 = Charset.defaultCharset();
      File file0 = MockFile.createTempFile("bNoY", "bNoY");
  ...
  public void test39()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(" ILkO`1yI", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test46()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD;
      File file0 = MockFile.createTempFile("k/&j)YbB:(mTy|", "The header contains a duplicate name: \"");
      Path path0 = file0.toPath();
      Charset charset0 = Charset.defaultCharset();
//      try { 
        CSVParser.parse(path0, charset0, cSVFormat0);
