...
//      }
  ...
  public void test03()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("FK19WqC}/}b:sL|osq");
      Class<Locale.FilteringMode> class0 = Locale.FilteringMode.class;
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(class0);
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1, (-1666L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("FK19WqC}/}b:sL|osq");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-1666L), 0L);
      cSVParser0.nextRecord();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("kw'J.", cSVFormat0);
      cSVParser0.close();
  ...
  public void test11()  throws Throwable  {
      MockFile mockFile0 = new MockFile("$VALUES", "]!8_");
...
//      }
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("T8pgr+T`z[Z", "T8pgr+T`z[Z");
      Path path0 = mockFile0.toPath();
...
//      }
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream((InputStream) null, 4367);
...
//      }
  ...
  public void test26()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      MockFile mockFile0 = new MockFile(":6{M|SAvn0S^5Q", "EOF whilst processing escape sequence");
//      try { 
...
//      }
  ...
  public void test28()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-1), (byte)58);
      Charset charset0 = Charset.defaultCharset();
...
//      }
  ...
  public void test29()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(pipedReader0, cSVFormat0, 852L, 1231);
//      try { 
        cSVParser0.getRecords();
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = null;
//      try {
        cSVParser0 = new CSVParser(pipedReader0, cSVFormat1, 459L, 327L);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test38()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("Y.,.\"F", cSVFormat2);
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test41()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_TEXT;
      CSVFormat cSVFormat1 = cSVFormat0.withFirstRecordAsHeader();
      CSVParser cSVParser0 = CSVParser.parse("kw'J.", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
...
//      }
  ...
  public void test47()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.POSTGRESQL_CSV;
      File file0 = MockFile.createTempFile("'3k\"$*Z", "\u2029", (File) null);
      Charset charset0 = Charset.defaultCharset();
  ...
  public void test49()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("rEH6Y?</iqT3}`<K8", cSVFormat0);
      cSVParser0.getFirstEndOfLine();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
