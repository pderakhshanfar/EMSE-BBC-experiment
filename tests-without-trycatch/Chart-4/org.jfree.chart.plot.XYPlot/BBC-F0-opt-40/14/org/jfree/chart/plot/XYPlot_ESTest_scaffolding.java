...
public class XYPlot_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.image.TileObserver", false, XYPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Connection", false, XYPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, XYPlot_ESTest_scaffolding.class.getClassLoader()));
  }
