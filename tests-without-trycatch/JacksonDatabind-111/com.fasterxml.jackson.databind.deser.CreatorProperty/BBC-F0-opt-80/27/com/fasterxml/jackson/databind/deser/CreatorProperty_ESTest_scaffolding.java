...
public class CreatorProperty_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.annotation.ObjectIdGenerator", false, CreatorProperty_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.io.InputDecorator", false, CreatorProperty_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("java.util.function.BiFunction", false, CreatorProperty_ESTest_scaffolding.class.getClassLoader()));
  }
