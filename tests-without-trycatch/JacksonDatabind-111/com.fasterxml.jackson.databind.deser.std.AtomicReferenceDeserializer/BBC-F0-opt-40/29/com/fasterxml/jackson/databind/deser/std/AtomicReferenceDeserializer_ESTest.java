...
public class AtomicReferenceDeserializer_ESTest extends AtomicReferenceDeserializer_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      AsWrapperTypeDeserializer asWrapperTypeDeserializer0 = new AsWrapperTypeDeserializer(collectionLikeType0, classNameIdResolver0, "kH@]ZBq|^Dl|H]35`", false, collectionLikeType0);
      AtomicReferenceDeserializer atomicReferenceDeserializer0 = new AtomicReferenceDeserializer(collectionLikeType0, (ValueInstantiator) null, asWrapperTypeDeserializer0, (JsonDeserializer<?>) null);
      AsWrapperTypeDeserializer asWrapperTypeDeserializer1 = new AsWrapperTypeDeserializer(collectionLikeType0, classNameIdResolver0, ">!GbbwqlG![B`tB0?", true, collectionLikeType0);
      AtomicReferenceDeserializer atomicReferenceDeserializer1 = atomicReferenceDeserializer0.withResolved(asWrapperTypeDeserializer1, (JsonDeserializer<?>) null);
  ...
  public void test3()  throws Throwable  {
      ...
      JsonDeserializer<Integer> jsonDeserializer0 = (JsonDeserializer<Integer>) mock(JsonDeserializer.class, new ViolatedAssumptionAnswer());
      AtomicReferenceDeserializer atomicReferenceDeserializer0 = new AtomicReferenceDeserializer(collectionLikeType0, (ValueInstantiator) null, (TypeDeserializer) null, jsonDeserializer0);
      AtomicReference<Object> atomicReference0 = atomicReferenceDeserializer0.referenceValue("~*YEDyLr2{v");
      assertEquals("~*YEDyLr2{v", atomicReference0.toString());
  }
  ...
  public void test5()  throws Throwable  {
      ...
      CollectionType collectionType0 = CollectionType.construct(class1, typeBindings0, javaTypeArray0[7], javaTypeArray0, javaTypeArray0[3]);
      TypeFactory typeFactory0 = TypeFactory.defaultInstance();
      ClassNameIdResolver classNameIdResolver0 = new ClassNameIdResolver(collectionType0, typeFactory0);
      AsWrapperTypeDeserializer asWrapperTypeDeserializer0 = new AsWrapperTypeDeserializer(referenceType0, classNameIdResolver0, "kH@]ZBq|^Dl|H]35`", false, javaTypeArray0[8]);
      AtomicReferenceDeserializer atomicReferenceDeserializer0 = new AtomicReferenceDeserializer(javaTypeArray0[2], (ValueInstantiator) null, asWrapperTypeDeserializer0, (JsonDeserializer<?>) null);
