...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("dmd8g");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("dmd8g");
  ...
  public void test02()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("H\"r_^", (Object) class0);
      assertEquals("H\"r_^", object0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/f^v]P");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      File file0 = TypeHandler.createFile("/f^v]P");
      assertFalse(file0.isDirectory());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".rR=");
...
//      }
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
//      try { 
        TypeHandler.createValue("H\"r_^", (Object) "H\"r_^");
...
//      try { 
        TypeHandler.createObject("sW3gz6XY[x:Q3G");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: sW3gz6XY[x:Q3G
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createClass("QvX9#Ck$zR[Dh#7RG");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: QvX9#Ck$zR[Dh#7RG
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createNumber("12~Y|PC.N_");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // For input string: \"12~Y|PC.N_\"
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("H\"r_^", class0);
      assertEquals("H\"r_^", string0);
  }
  ...
  public void test22()  throws Throwable  {
      Class<Object> class0 = Object.class;
//      try { 
        TypeHandler.createValue("qwfnx|w4q", (Object) class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: qwfnx|w4q
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
//      try { 
        TypeHandler.createDate("kLe8'.A6e~VMPRn");
...
//      try { 
        TypeHandler.openFile("jrDw\"Gc.f0qQ\"klk%u");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find file: jrDw\"Gc.f0qQ\"klk%u
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
  ...
  public void test30()  throws Throwable  {
      Object object0 = TypeHandler.createValue("vL@mNS", (Object) null);
      assertNull(object0);
  }
}
