...
//      }
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("2!~%#xiy=I:)3>i(");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("2!~%#xiy=I:)3>i(");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("6h0A@=q^qJ");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "/+");
      FileInputStream fileInputStream0 = TypeHandler.openFile("6h0A@=q^qJ");
  ...
  public void test04()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("{0I7b}D*:qBR.", (Object) class0);
      assertEquals("{0I7b}D*:qBR.", object0);
  }
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/p~Xb{gxEXirpgig5");
      assertEquals(0L, file0.length());
  }
...
//      try { 
        TypeHandler.createObject("/p~Xb{gxEXirpgig5");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: /p~Xb{gxEXirpgig5
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createNumber("aDZ.e+Yd?:N$G5z-Sp;");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // For input string: \"aDZ.e+Yd?:N$G5z-Sp;\"
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
  ...
  public void test23()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("has already been selected: '", class0);
      assertEquals("has already been selected: '", string0);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("x!/.4uUS6lfUs9K");
...
//      try { 
        TypeHandler.createURL("/ND%Y%~7NxBT");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to parse the URL: /ND%Y%~7NxBT
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.openFile("2!~%#xiy=I:)3>i(");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find file: 2!~%#xiy=I:)3>i(
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test31()  throws Throwable  {
      Class<Object> class0 = Object.class;
//      try { 
        TypeHandler.createValue("ydBq4%N>y", (Object) class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: ydBq4%N>y
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
