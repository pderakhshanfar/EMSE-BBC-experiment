...
//      }
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("YbsFc(X&G>A~g8`)L");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("YbsFc(X&G>A~g8`)L");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("GKU]rof0[*0?p");
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("GKU]rof0[*0?p");
  ...
  public void test05()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[8];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("GKU]rof0[*0?p");
      assertEquals(8L, file0.length());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".?>c_BL:$");
      assertEquals(".?>c_BL:$", file0.getName());
  }
...
//      try { 
        TypeHandler.createValue("[%4`q", (Object) class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: [%4`q
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test12()  throws Throwable  {
      // Undeclared exception!
//      try { 
        TypeHandler.createValue("y5p/b0 _", (Object) "y5p/b0 _");
...
//      }
  ...
  public void test13()  throws Throwable  {
      Class<Object> class0 = Object.class;
//      try { 
        TypeHandler.createValue("~SG", class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: ~SG
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createClass("GKU]rof0[*0?p");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: GKU]rof0[*0?p
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test19()  throws Throwable  {
      ...
      Integer integer0 = TypeHandler.createValue(".?>c_BL:$", class0);
      assertNull(integer0);
  }
...
//      }
  ...
  public void test22()  throws Throwable  {
      Class<String> class0 = String.class;
      String string0 = TypeHandler.createValue("VP:xI*g.%T#25", class0);
      assertEquals("VP:xI*g.%T#25", string0);
  }
...
//      }
  ...
  public void test24()  throws Throwable  {
      File file0 = TypeHandler.createFile("/(4.~'i{&;P");
...
//      try { 
        TypeHandler.createURL("Axe;U`67s!uADep=");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to parse the URL: Axe;U`67s!uADep=
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.openFile("YbsFc(X&G>A~g8`)L");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find file: YbsFc(X&G>A~g8`)L
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
