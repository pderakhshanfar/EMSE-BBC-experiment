...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("!c8");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FileInputStream fileInputStream0 = TypeHandler.openFile("!c8");
  ...
  public void test02()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "$2<T87 JY~D_}>}");
      FileInputStream fileInputStream0 = TypeHandler.openFile("GA");
      assertEquals(16, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(";S><UJEgg4*T|>");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, ";S><UJEgg4*T|>");
      File file0 = TypeHandler.createFile(";S><UJEgg4*T|>");
      assertEquals(14L, file0.length());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile("/3bu5Rtr-cYz");
...
//      try { 
        TypeHandler.createValue("^{:$FR(f+!2{l", (Object) class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: ^{:$FR(f+!2{l
//         //
...
//      }
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
//      try { 
        TypeHandler.createValue("Yvi3=QfD~w{vK", class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: Yvi3=QfD~w{vK
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createNumber("{;~U4-`.r9XFr");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // For input string: \"{;~U4-`.r9XFr\"
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
  ...
  public void test26()  throws Throwable  {
      File file0 = TypeHandler.createFile(".JWopaEYB");
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
//      try { 
        TypeHandler.createDate(";S><UJEgg4*T|>");
...
//      try { 
        TypeHandler.createURL("ziVLm^a_");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to parse the URL: ziVLm^a_
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
//      try { 
        TypeHandler.createFiles("b5W!2yICX");
//        fail("Expecting exception: UnsupportedOperationException");
...
//      try { 
        TypeHandler.openFile("GA");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find file: GA
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
