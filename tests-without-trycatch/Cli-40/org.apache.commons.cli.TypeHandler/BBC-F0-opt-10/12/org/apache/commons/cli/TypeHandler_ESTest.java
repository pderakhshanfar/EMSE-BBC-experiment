...
//      }
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Etther opt or longOpt must Ue specified");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("Etther opt or longOpt must Ue specified");
      assertEquals(0, fileInputStream0.available());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("p/GRIG_o^M*0yA");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "org.apache.commons.cli.PatternOptionBuilder");
      FileInputStream fileInputStream0 = TypeHandler.openFile("p/GRIG_o^M*0yA");
  ...
  public void test03()  throws Throwable  {
      ...
      Object object0 = TypeHandler.createValue("wY", (Object) class0);
      assertEquals("wY", object0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      File file0 = TypeHandler.createFile(".vt@");
  ...
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/=BvQL=JMgr?5&n=i");
...
//      try { 
        TypeHandler.createValue("iAt>YH>ru>M", (Object) class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: iAt>YH>ru>M
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      }
  ...
  public void test12()  throws Throwable  {
      Class<Object> class0 = Object.class;
//      try { 
        TypeHandler.createValue("6}eKgo>F,9g*G;X/", class0);
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: 6}eKgo>F,9g*G;X/
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.createClass("U8cx{D?i.Mx!X`kO");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find the class: U8cx{D?i.Mx!X`kO
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
...
//      try { 
        TypeHandler.openFile("Etther opt or longOpt must Ue specified");
//        fail("Expecting exception: Exception");
      
//      } catch(Exception e) {
//         //
//         // Unable to find file: Etther opt or longOpt must Ue specified
//         //
//         verifyException("org.apache.commons.cli.TypeHandler", e);
//      }
  }
