...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)14, (byte)0, (byte)0, (byte)0}, byteArray2);
...
//      }
  ...
  public void test06()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("3XiO(05m");
      byte[] byteArray0 = new byte[0];
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      assertFalse(byteArray1.equals((Object)byteArray0));
  }
  ...
  public void test12()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("s:fFE{U^kTDhn$V");
...
//      }
  ...
  public void test18()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec((String) null);
//      try { 
        quotedPrintableCodec0.encode("", "bu?");
...
//      try { 
        quotedPrintableCodec0.encode("E)`w:o");
//        fail("Expecting exception: Exception");
...
//      }
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        quotedPrintableCodec0.encode("\bX#@");
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        quotedPrintableCodec0.encode((Object) "k4&hdD:c\"/~4*`l");
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("nOQV9+iF");
...
//      }
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.decode("v]a|=#P6AST", "v]a|=#P6AST");
//        fail("Expecting exception: Exception");
...
//      }
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("(V>T");
//      try { 
        quotedPrintableCodec0.decode("(V>T", "");
//        fail("Expecting exception: UnsupportedEncodingException");
...
//      }
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
//      try { 
        quotedPrintableCodec0.decode("/wAR>v^f`,;f{ Q_~?=");
//        fail("Expecting exception: Exception");
...
//      }
  ...
  public void test29()  throws Throwable  {
      ...
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertArrayEquals(new byte[] {(byte)11, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
...
//      }
  ...
  public void test39()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("kJ5:cp-");
  ...
  public void test40()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("4ww[mR{GEzFS/UH`y,K");
      String string0 = quotedPrintableCodec0.decode((String) null, "ONB");
      assertNull(string0);
  }
...
//      }
  ...
  public void test45()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte) (-86), (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
      assertEquals(5, byteArray2.length);
  ...
  public void test48()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("org.apache.commons.codec.Enco\u0005rException");
      assertNotNull(string0);
      assertEquals("org.apache.commons.codec.Enco=05rException", string0);
  }
