...
//      }
  ...
  public void test14()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
//      try { 
        quotedPrintableCodec0.encode("i{0UY#1X[sw=", " cannot be quoted-printable encoded");
...
//      }
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.decode("", "\"P]%gh");
//        fail("Expecting exception: UnsupportedEncodingException");
...
//      }
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
//      try { 
        quotedPrintableCodec0.decode("*OUe[PAu;;=");
//        fail("Expecting exception: Exception");
...
//      }
  ...
  public void test29()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)56, (byte)55}, byteArray1);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode((String) null, "W6=E\"vdz*?dP");
      assertNull(string0);
  }
...
//      }
  ...
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode((String) null, "gr.9ekUjnt^j.w:");
      assertNull(string0);
  }
  ...
  public void test40()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.decode("9VVkek=%8S[G@1Tf4;+", "Invalid URL encoding: not a valid digit (radix 16): ");
//        fail("Expecting exception: Exception");
...
//      }
  ...
  public void test42()  throws Throwable  {
      ...
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      byte[] byteArray2 = quotedPrintableCodec0.decode(byteArray1);
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte) (-1), (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
      assertEquals(27, byteArray1.length);
      assertEquals(9, byteArray2.length);
  }
