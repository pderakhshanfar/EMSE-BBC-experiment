...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)61, (byte)69, (byte)52, (byte)61, (byte)48, (byte)48}, byteArray1);
      assertArrayEquals(new byte[] {(byte) (-28), (byte)0}, byteArray2);
  }
  ...
  public void test03()  throws Throwable  {
      ByteBuffer byteBuffer0 = ByteBuffer.allocateDirect(529);
  ...
  public void test09()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode(" {8)h8fypp", "UTF-16");
      assertEquals("\u207B\u3829\u6838\u6679\u7070", string0);
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("0yM");
      assertNotNull(string0);
      assertEquals("0yM", string0);
  }
...
//      try { 
        quotedPrintableCodec0.encode("0yM", (String) null);
...
//      }
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
//      try { 
        quotedPrintableCodec0.encode("E`fe8?s4{v-2", "?$O|&r?b");
...
//      }
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        quotedPrintableCodec0.encode("TC)@}aX-F<8");
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      QuotedPrintableCodec quotedPrintableCodec1 = new QuotedPrintableCodec("UTF-16");
      Object object0 = quotedPrintableCodec1.encode((Object) "=FE=FF=00=3D=00F=00E=00=3D=00F=00F=00=3D=000=000=00=3D=003=00D=00=3D=000=000=00F=00=3D=000=000=00E=00=3D=000=000=00=3D=003=00D=00=3D=000=000=00F=00=3D=000=000=00F=00=3D=000=000=00=3D=003=00D=00=3D=000=000=000=00=3D=000=000=000=00=3D=000=000=00<=00=3D=000=000=00=3D=003=00D=00=3D=000=000=000=00=3D=000=000=000=00=3D=000=000=00r=00=3D=000=000=00=3D=003=00D=00=3D=000=000=000=00=3D=000=000=000=00=3D=000=000=00]=00=3D=000=000=00=3D=003=00D=00=3D=000=000=000=00=3D=000=000=000=00=3D=000=000=00r=00=3D=000=000=00=3D=003=00D=00=3D=000=000=000=00=3D=000=000=000=00=3D=000=000=00)");
      Object object1 = quotedPrintableCodec1.encode(object0);
      // Undeclared exception!
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        quotedPrintableCodec0.encode((Object) "[XVuj");
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("6=TVap");
//      try { 
        quotedPrintableCodec0.decode("6=TVap", "6=TVap");
//        fail("Expecting exception: Exception");
...
//      }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        quotedPrintableCodec0.decode("C5[", (String) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.decode("0yM", "0yM");
//        fail("Expecting exception: UnsupportedEncodingException");
...
//      }
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        quotedPrintableCodec0.decode("`Pf5]Q_@w");
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        quotedPrintableCodec0.decode((Object) ":ppvLk");
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test26()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("YDKtKps");
      assertEquals("YDKtKps", string0);
      assertNotNull(string0);
  }
...
//      }
  ...
  public void test38()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode((String) null, "R2");
      assertNull(string0);
  }
  ...
  public void test41()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "[XVuj");
      assertNotNull(object0);
      assertEquals("[XVuj", object0);
  }
