...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)5, (byte)0, (byte)0}, byteArray2);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)53, (byte)61, (byte)48, (byte)48, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
...
//      }
  ...
  public void test04()  throws Throwable  {
      ...
      LongBuffer longBuffer0 = LongBuffer.allocate(1193);
  ...
  public void test15()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.decode((Object) "*Yk&/?csQRo??D");
      assertNotNull(object0);
      assertEquals("*Yk&/?csQRo??D", object0);
  }
  ...
  public void test16()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.encode("ENH-", "?{UJeHiOtEu@U1");
...
//      }
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("~!:U&5M7z0");
//      try { 
...
//      }
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.decode("F=?@p3Ja~2", "F=?@p3Ja~2");
//        fail("Expecting exception: Exception");
...
//      }
  ...
  public void test22()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.decode("UTF-8", "aecaAZXaU.UTHQ");
//        fail("Expecting exception: UnsupportedEncodingException");
...
//      }
  ...
  public void test23()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("bXUs");
//      try { 
        quotedPrintableCodec0.decode("n2,(yCF6/,\rJ");
//        fail("Expecting exception: Exception");
...
//      }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        quotedPrintableCodec0.encode("Enez`wa;d4m]", (String) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test27()  throws Throwable  {
      ...
      BitSet bitSet0 = BitSet.valueOf(longArray0);
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)66, (byte)55, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
...
//      }
  ...
  public void test34()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("AO2TB?fa[<");
      Object object0 = new Object();
//      try { 
...
//      }
  ...
  public void test39()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode((String) null, "z'5Rf<:d%:");
      assertNull(string0);
  }
  ...
  public void test42()  throws Throwable  {
      ...
      byte[] byteArray1 = quotedPrintableCodec0.encode(byteArray0);
      byte[] byteArray2 = QuotedPrintableCodec.decodeQuotedPrintable(byteArray1);
      assertArrayEquals(new byte[] {(byte)0, (byte) (-73), (byte)0}, byteArray2);
      assertArrayEquals(new byte[] {(byte)61, (byte)48, (byte)48, (byte)61, (byte)66, (byte)55, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
  ...
  public void test44()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("cu1xZ3Y!aM;>");
      assertEquals("cu=7F1xZ3Y!aM;>", string0);
      assertNotNull(string0);
  }
