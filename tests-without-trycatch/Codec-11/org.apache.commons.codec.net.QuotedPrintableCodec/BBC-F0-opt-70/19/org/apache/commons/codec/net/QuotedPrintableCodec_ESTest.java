...
//      }
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.encode("_dswy.XVPFY$|/rp;If", "");
...
//      }
  ...
  public void test17()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Tmq|0uRp*YYOIs}TNc\"");
      byte[] byteArray0 = new byte[9];
...
//      }
  ...
  public void test18()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.decode("~2b|R[*1;S6Y=&$}2V", "Y%");
//        fail("Expecting exception: Exception");
...
//      }
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("E#2zj2R{5i#4FS");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test21()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("_EdGQ7KDg.' 49J4");
//      try { 
        quotedPrintableCodec0.decode("'C");
//        fail("Expecting exception: Exception");
...
//      }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        quotedPrintableCodec0.decode("^$L");
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test24()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("!Jv)a5Q}");
      assertNotNull(string0);
      assertEquals("!Jv)a5Q}", string0);
  }
...
//      }
  ...
  public void test28()  throws Throwable  {
      ...
      BitSet bitSet0 = BitSet.valueOf(byteBuffer0);
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)50, (byte)51, (byte)0, (byte)0}, byteArray1);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)69, (byte)70}, byteArray1);
  }
  ...
  public void test32()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode((String) null, "myb_aY^9^L(+KSNG]");
      assertNull(string0);
  }
...
//      }
  ...
  public void test37()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "_Bcn{<NjeZT=7FvLW");
      assertEquals("_Bcn{<NjeZT=3D7FvLW", object0);
      assertNotNull(object0);
  }
  ...
  public void test39()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec(" #H}sN`WR");
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        quotedPrintableCodec0.decode((Object) "Tmq|0uRp*YYOIs}TNc\"");
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test43()  throws Throwable  {
      ...
      byte[] byteArray2 = QuotedPrintableCodec.decodeQuotedPrintable(byteArray1);
      assertEquals(9, byteArray2.length);
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte) (-8), (byte)0, (byte)0}, byteArray2);
      assertEquals(27, byteArray1.length);
  }
  ...
  public void test46()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("_Bcn{<NjeZTvLW");
      assertEquals("_Bcn{<NjeZT=7FvLW", string0);
      assertNotNull(string0);
  }
  ...
  public void test47()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.decode((Object) "?Hhl4~RyY8n7A=");
//        fail("Expecting exception: Exception");
