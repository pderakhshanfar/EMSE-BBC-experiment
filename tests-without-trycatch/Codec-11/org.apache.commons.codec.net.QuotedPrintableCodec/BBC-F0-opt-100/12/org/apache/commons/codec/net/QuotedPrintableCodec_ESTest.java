...
public class QuotedPrintableCodec_ESTest extends QuotedPrintableCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)61, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      assertEquals(27, byteArray1.length);
      assertEquals(9, byteArray2.length);
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte) (-112), (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray2);
  }
  ...
  public void test02()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.decode("0JGUgiFRj|=");
...
//      }
  ...
  public void test10()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.encode("xRq-%BD8MF");
      assertNotNull(string0);
      assertEquals("xRq-%BD8MF", string0);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      Object object0 = quotedPrintableCodec0.encode((Object) "bRh/^O|Ku.rp:nm_");
      assertEquals("bRh/^O|Ku.rp:nm_", object0);
  ...
  public void test13()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("eX\"X");
  ...
  public void test19()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.encode("[&dK&:", "");
...
//      }
  ...
  public void test20()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("Y!BB");
//      try { 
...
//      try { 
        quotedPrintableCodec0.encode("0ozn");
...
//      }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        quotedPrintableCodec0.encode((Object) ">#WH)");
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test25()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
//      try { 
        quotedPrintableCodec0.decode("=nA", (String) null);
//        fail("Expecting exception: Exception");
...
//      }
  ...
  public void test27()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec("");
//      try { 
        quotedPrintableCodec0.decode("+'>c3}E");
//        fail("Expecting exception: Exception");
...
//      }
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        quotedPrintableCodec0.encode("9zHMB8e0Vvuu,8Q%", (String) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test30()  throws Throwable  {
      QuotedPrintableCodec quotedPrintableCodec0 = new QuotedPrintableCodec();
      String string0 = quotedPrintableCodec0.decode("rn(MA&");
      assertEquals("rn(MA&", string0);
      assertNotNull(string0);
  }
...
//      }
  ...
  public void test45()  throws Throwable  {
      BitSet bitSet0 = new BitSet(2699);
      byte[] byteArray0 = new byte[2];
      byteArray0[0] = (byte) (-93);
      byte[] byteArray1 = QuotedPrintableCodec.encodeQuotedPrintable(bitSet0, byteArray0);
      assertArrayEquals(new byte[] {(byte)61, (byte)65, (byte)51, (byte)61, (byte)48, (byte)48}, byteArray1);
  }
