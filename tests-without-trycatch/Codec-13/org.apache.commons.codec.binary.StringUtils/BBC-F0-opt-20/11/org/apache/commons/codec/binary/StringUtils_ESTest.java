...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("8O![<.b_A");
      String string0 = StringUtils.newString(byteArray0, "UTF-8");
      assertEquals("8O![<.b_A", string0);
  }
  ...
  public void test09()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("\uFFFD\uFFFD");
      assertArrayEquals(new byte[] {(byte) (-3), (byte) (-1), (byte) (-3), (byte) (-1)}, byteArray0);
  }
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("aOYsJu");
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("B", "ISO-8859-1");
...
//      }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        StringUtils.newString(byteArray0, "({MeG)15}Z]A");
//        fail("Expecting exception: IllegalStateException");
      
//      } catch(IllegalStateException e) {
//         //
//         // ({MeG)15}Z]A: java.io.UnsupportedEncodingException: ({MeG)15}Z]A
//         //
...
//      }
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
//      try { 
        StringUtils.getBytesUnchecked("]we@", (String) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test31()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("8O!.b_A");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test33()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("~Db07nLd74qX?1[T");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u7E44\u6230\u376E\u4C64\u3734\u7158\u3F31\u5B54", string0);
  }
  ...
  public void test35()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("8O![<.b_A");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u384F\u215B\u3C2E\u625F\uFFFD", string0);
  }

  @Test(timeout = 4000)
  public void test36()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("]we@");
      String string0 = StringUtils.newStringUtf16Le(byteArray0);
      assertEquals("\u775D\u4065", string0);
  }
...
//      }
  ...
  public void test39()  throws Throwable  {
      // Undeclared exception!
//      try { 
        StringUtils.getBytesUnchecked("", "XIWcY<FX-n E,=BpG|");
//        fail("Expecting exception: IllegalStateException");
      
//      } catch(IllegalStateException e) {
//         //
//         // XIWcY<FX-n E,=BpG|: java.io.UnsupportedEncodingException: XIWcY<FX-n E,=BpG|
//         //
//         verifyException("org.apache.commons.codec.binary.StringUtils", e);
//      }
  }
  ...
  public void test40()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("\u775D\u4065");
