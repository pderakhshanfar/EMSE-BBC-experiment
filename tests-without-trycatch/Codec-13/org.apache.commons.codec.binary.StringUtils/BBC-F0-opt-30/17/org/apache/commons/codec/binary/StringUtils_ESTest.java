...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("HOzW]{,08(xF^", "UTF-16LE");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\u4800\u4F00\u7A00\u5700\u5D00\u7B00\u2C00\u3000\u3800\u2800\u7800\u4600\u5E00", string0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii("?#+l+Ly$B3&_?85Zl8N");
      String string0 = StringUtils.newStringUtf16(byteArray0);
      assertEquals("\u3F23\u2B6C\u2B4C\u7924\u4233\u265F\u3F38\u355A\u6C38\uFFFD", string0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals("H\u0000O\u0000z\u0000W\u0000]\u0000{\u0000,\u00000\u00008\u0000(\u0000x\u0000F\u0000^\u0000", string0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals("HOzW]{,08(xF^", string0);
  }
...
//      }
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        StringUtils.newString(byteArray0, "H\u0000O\u0000z\u0000W\u0000]\u0000{\u0000,\u00000\u00008\u0000(\u0000x\u0000F\u0000^\u0000");
//        fail("Expecting exception: IllegalStateException");
      
//      } catch(IllegalStateException e) {
//         //
//         // H\u0000O\u0000z\u0000W\u0000]\u0000{\u0000,\u00000\u00008\u0000(\u0000x\u0000F\u0000^\u0000: java.io.UnsupportedEncodingException: H\u0000O\u0000z\u0000W\u0000]\u0000{\u0000,\u00000\u00008\u0000(\u0000x\u0000F\u0000^\u0000
//         //
...
//      }
  ...
  public void test28()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("|bEd?N1te'NA)e7:");
      assertEquals(34, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test29()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf8("W'B!0`m=go4D:");
      assertEquals(13, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test30()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1("Ldb.");
      assertArrayEquals(new byte[] {(byte)76, (byte)100, (byte)98, (byte)46}, byteArray0);
  }
...
//      }
  ...
  public void test33()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("W'B!0`m=go4D:");
...
//      }
  ...
  public void test38()  throws Throwable  {
      // Undeclared exception!
//      try { 
        StringUtils.getBytesUnchecked("18)OiUV", "");
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("W'B!0`m=go4D:");
      assertEquals(26, byteArray0.length);
  }
}
