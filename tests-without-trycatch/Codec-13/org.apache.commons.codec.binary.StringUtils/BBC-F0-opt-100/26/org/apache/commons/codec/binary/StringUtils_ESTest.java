...
public class StringUtils_ESTest extends StringUtils_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16("!V.C p");
      String string0 = StringUtils.newStringUtf16Be(byteArray0);
      assertEquals("\uFEFF!V.C p", string0);
  }
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Be("C~I\"\"#jV(lj@mUnMJr");
      String string0 = StringUtils.newString(byteArray0, "UTF-16");
      assertEquals("C~I\"\"#jV(lj@mUnMJr", string0);
  }
  ...
  public void test17()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUnchecked("f/MVp", "UTF-16LE");
      assertEquals(10, byteArray0.length);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesIso8859_1(";e!fq]Nk");
      assertArrayEquals(new byte[] {(byte)59, (byte)101, (byte)33, (byte)102, (byte)113, (byte)93, (byte)78, (byte)107}, byteArray0);
  }
...
//      }
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
//      try { 
        StringUtils.getBytesUnchecked("zb]NG]\u0000ZkWYV-D", (String) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
//      try { 
        StringUtils.getBytesUnchecked("", ";zF^I`P^&;S}");
//        fail("Expecting exception: IllegalStateException");
      
//      } catch(IllegalStateException e) {
//         //
//         // ;zF^I`P^&;S}: java.io.UnsupportedEncodingException: ;zF^I`P^&;S}
//         //
...
//      }
  ...
  public void test36()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUtf16Le("dT#k$U+_ (F");
  ...
  public void test39()  throws Throwable  {
      byte[] byteArray0 = StringUtils.getBytesUsAscii(";e!fq]Nk");
      assertArrayEquals(new byte[] {(byte)59, (byte)101, (byte)33, (byte)102, (byte)113, (byte)93, (byte)78, (byte)107}, byteArray0);
  }
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        StringUtils.newString(byteArray0, "\uFFFD\uFFFD\u0000!\u0000V\u0000.\u0000C\u0000 \u0000p");
//        fail("Expecting exception: IllegalStateException");
      
//      } catch(IllegalStateException e) {
//         //
//         // \uFFFD\uFFFD\u0000!\u0000V\u0000.\u0000C\u0000 \u0000p: java.io.UnsupportedEncodingException: \uFFFD\uFFFD\u0000!\u0000V\u0000.\u0000C\u0000 \u0000p
//         //
//         verifyException("org.apache.commons.codec.binary.StringUtils", e);
//      }
  }
