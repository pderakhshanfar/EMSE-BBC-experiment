...
//      }
  ...
  public void test02()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("Tc.dF]d:;+!H{.5xI");
      MockDate mockDate0 = new MockDate(32, 32, 32, 0, 32, 1366);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("2kgT?lyG6]\u0002$\":uQ,i");
...
//      }
  ...
  public void test06()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, dateFormat0, dateFormat0);
      PipedReader pipedReader0 = new PipedReader(3667);
...
//      }
  ...
  public void test08()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "+hh:mm");
      StringReader stringReader0 = new StringReader("+hh:mm");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "!kr5y_x}T");
...
//      }
  ...
  public void test11()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((Class<? extends Date>) null, "Z");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 0, 1529);
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test13()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 1006);
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test20()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-857), 2347);
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // Illegal time style 2347
//         //
//         verifyException("java.text.DateFormat", e);
//      }
  }
  ...
  public void test21()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("[5[;L07");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
//      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
...
//      }
  ...
  public void test23()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      MockDate mockDate0 = new MockDate((-1106), (-690), 2347);
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "+hh:mm");
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
