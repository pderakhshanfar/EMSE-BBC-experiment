...
//      }
  ...
  public void test03()  throws Throwable  {
      MockDate mockDate0 = new MockDate(2218, 2218, (-1970), 1, (-1970), 41);
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test04()  throws Throwable  {
      ...
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("gaL(Ex&y^_nsr");
      Timestamp timestamp0 = new Timestamp(2957L);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "ly<GVhcdb");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-2589), (-2339));
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // Illegal time style -2339
//         //
...
//      }
  ...
  public void test15()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockDate mockDate0 = new MockDate((-2010), (-2010), (-2010), 0, (-2010), (-2010));
  ...
  public void test16()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockDate mockDate0 = new MockDate(116, 0, (-2010), (-678), (-2010), 0);
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
      Date date0 = defaultDateTypeAdapter0.fromJsonTree(jsonElement0);
...
//      }
  ...
  public void test19()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((-1653), (-1653));
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // Illegal time style -1653
//         //
//         verifyException("java.text.DateFormat", e);
//      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockDate mockDate0 = new MockDate(0, (-2010), 0, 0, 0, (-1));
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
      Date date0 = defaultDateTypeAdapter0.fromJsonTree(jsonElement0);
      assertNotNull(date0);
  }
  ...
  public void test21()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "56");
