...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(1881, (-590), (-590), (-1707), 40, 1881);
...
//      }
  ...
  public void test02()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("\"Jan 9, 4736 12:32:22 AM\"");
  ...
  public void test03()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate((-985), 60000, 0);
...
//      }
  ...
  public void test05()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("OFKK,T=JH");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
//      try { 
...
//      }
  ...
  public void test07()  throws Throwable  {
      Class<java.sql.Date> class0 = java.sql.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "");
      PipedReader pipedReader0 = new PipedReader(1881);
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(2338, 0, 2);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test12()  throws Throwable  {
      MockDate mockDate0 = new MockDate((-33), (-33), 65, (-33), 65, 1515);
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
  ...
  public void test13()  throws Throwable  {
      MockDate mockDate0 = new MockDate(0, 0, (-1589), 0, (-1589), (-2674));
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      JsonElement jsonElement0 = defaultDateTypeAdapter0.toJsonTree(mockDate0);
...
//      }
  ...
  public void test18()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(15, 123);
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test19()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-2497), 2205);
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // Illegal time style 2205
//         //
//         verifyException("java.text.DateFormat", e);
//      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "Og50#zdeR^m");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test22()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-866));
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // Illegal date style -866
//         //
//         verifyException("java.text.DateFormat", e);
//      }
  }
