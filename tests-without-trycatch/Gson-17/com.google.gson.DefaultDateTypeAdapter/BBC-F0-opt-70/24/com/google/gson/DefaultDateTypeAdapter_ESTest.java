...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "Zu2{6]");
      MockFileWriter mockFileWriter0 = new MockFileWriter("Zu2{6]", true);
  ...
  public void test01()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(60, 243, 243, 60, 1341, 372);
      String string0 = defaultDateTypeAdapter0.toJson((java.util.Date) mockDate0);
      assertEquals("\"Dec 2, 1980 10:27:12 AM\"", string0);
  }
  ...
  public void test03()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "Zu2{6]");
      JsonPrimitive jsonPrimitive0 = new JsonPrimitive((Object) "v[W)!_\"X/ 5w_M=");
...
//      }
  ...
  public void test06()  throws Throwable  {
      ...
      MockPrintStream mockPrintStream0 = new MockPrintStream("DefaultDateTypeAdapter(SimpleDateFormat)");
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter(mockPrintStream0);
      MockDate mockDate0 = new MockDate(1, 3221, 10, 3221, 0, 0);
      JsonWriter jsonWriter0 = new JsonWriter(mockPrintWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("*QiU-%o5ZF:4b3Jmv");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test08()  throws Throwable  {
      Class<java.util.Date> class0 = java.util.Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "\"");
      StringReader stringReader0 = new StringReader("jI=1m9`=lr?)yx%Ni?=");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
//      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "v Kgv_UM!'m1");
...
//      }
  ...
  public void test14()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(3221, 0);
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // Illegal date style 3221
//         //
...
//      }
  ...
  public void test20()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter((Class<? extends java.util.Date>) null, "Zu2{6]");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test23()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 4089, 4089);
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test26()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, (-3083));
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // Illegal date style -3083
//         //
//         verifyException("java.text.DateFormat", e);
//      }
  }
