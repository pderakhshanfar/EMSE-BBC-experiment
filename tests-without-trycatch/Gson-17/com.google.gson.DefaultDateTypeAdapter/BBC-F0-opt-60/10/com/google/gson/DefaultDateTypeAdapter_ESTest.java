...
public class DefaultDateTypeAdapter_ESTest extends DefaultDateTypeAdapter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockDate mockDate0 = new MockDate(2286, (-3563), (-3563), 0, 2286);
      MockFileWriter mockFileWriter0 = new MockFileWriter("BTH+btZr&$NG35$aT=");
      JsonWriter jsonWriter0 = new JsonWriter(mockFileWriter0);
      defaultDateTypeAdapter0.write(jsonWriter0, (java.util.Date) mockDate0);
      assertEquals("Fri May 02 14:06:00 GMT 3879", mockDate0.toString());
  }
...
//      }
  ...
  public void test04()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("\"Aug 31, 1365 12:00:00 AM\"");
  ...
  public void test05()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockDate mockDate0 = new MockDate(236, 0, 236);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test06()  throws Throwable  {
      Class<Timestamp> class0 = Timestamp.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      MockFileWriter mockFileWriter0 = new MockFileWriter("x@f", true);
      JsonWriter jsonWriter0 = new JsonWriter(mockFileWriter0);
...
//      }
  ...
  public void test17()  throws Throwable  {
      Class<Date> class0 = Date.class;
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0);
      StringReader stringReader0 = new StringReader("68{JB1*uLq<<LIGpj");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
//      try { 
        defaultDateTypeAdapter0.read(jsonReader0);
...
//      }
  ...
  public void test21()  throws Throwable  {
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(1599, 1599);
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // Illegal time style 1599
//         //
...
//      }
  ...
  public void test22()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, 2826, 2826);
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // Illegal time style 2826
//         //
//         verifyException("java.text.DateFormat", e);
//      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      DefaultDateTypeAdapter defaultDateTypeAdapter0 = null;
//      try {
        defaultDateTypeAdapter0 = new DefaultDateTypeAdapter(class0, "\"Aug 31, 1365 12:00:00 AM\"");
//        fail("Expecting exception: IllegalArgumentException");
