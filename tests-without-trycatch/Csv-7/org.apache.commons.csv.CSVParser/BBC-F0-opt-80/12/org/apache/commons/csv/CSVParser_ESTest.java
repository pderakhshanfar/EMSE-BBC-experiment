...
//      }
  ...
  public void test02()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("(Cinz", cSVFormat1);
  ...
  public void test06()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("8GlQ.H_|ingx", cSVFormat0);
  ...
  public void test07()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("L\"?^_wX[6qkd=");
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse("t%iiAPi-oI9$_hr6", cSVFormat1);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"0,~Rqe.DV`;", cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("Qf[oC.ziW|`]e,|v!tY", "", (File) null);
      Character character0 = Character.valueOf('A');
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[8];
      CSVFormat cSVFormat0 = new CSVFormat('A', character0, quote0, character0, character0, true, false, "Qf[oC.ziW|`]e,|v!tY", "", stringArray0, false);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("COMMENT", "%!H");
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test16()  throws Throwable  {
      StringReader stringReader0 = new StringReader("%a!#^A4|0kek<#URt");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      cSVParser0.close();
//      try { 
...
//      }
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("f7.;", cSVFormat0);
      cSVParser0.close();
...
//      }
  ...
  public void test19()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("gEG.3AYgk ", cSVFormat0);
      cSVParser0.close();
//      try { 
        cSVParser0.getRecords();
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test20()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(":dy%jj%", ":dy%jj%", (File) null);
...
//      }
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("q:J3");
      Character character0 = Character.valueOf('f');
      Quote quote0 = Quote.NONE;
      String[] stringArray0 = new String[3];
      CSVFormat cSVFormat0 = new CSVFormat('f', character0, quote0, character0, character0, true, true, "q:J3", "q:J3", stringArray0, true);
...
//      }
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("rU>;Io5kDC>F", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
  ...
  public void test25()  throws Throwable  {
      StringReader stringReader0 = new StringReader("KV:v^%FM^K");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader("gEG.3AYgk ");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
      Consumer<CSVRecord> consumer0 = (Consumer<CSVRecord>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
  ...
  public void test30()  throws Throwable  {
      StringReader stringReader0 = new StringReader("ldken");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test35()  throws Throwable  {
      StringReader stringReader0 = new StringReader("KV:v^%FM^K");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("KV:v^%FM^K");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile(" M'cEjg(rto~");
//      try { 
