...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "(B9h[/H>X/");
  ...
  public void test03()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("a*X[SZCQO\"mqiFY'");
  ...
  public void test04()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("zW.!pd1uTs:]");
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"#uB-hss1", cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("=wS`~o", "Header:");
      CSVFormat cSVFormat0 = CSVFormat.newFormat('=');
//      try { 
...
//      }
  ...
  public void test16()  throws Throwable  {
      StringReader stringReader0 = new StringReader("W<Y$8:x5F,2]R");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test19()  throws Throwable  {
      File file0 = MockFile.createTempFile("TAh", "TAh");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      FileSystemHandling.shouldAllThrowIOExceptions();
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
//      try { 
...
//      }
  ...
  public void test22()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("fcle");
      stringReader0.close();
      CSVParser cSVParser0 = null;
//      try {
...
//      }
  ...
  public void test23()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("&S:=#CU/");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test27()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('!', character0, quote0, character1, character0, true, true, "", " 6%S.h?vpT\"", stringArray0, true);
      CSVParser cSVParser0 = CSVParser.parse("", cSVFormat0);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('%');
      CSVFormat cSVFormat1 = cSVFormat0.withNullString(":?4G@,tx&G");
      StringReader stringReader0 = new StringReader(":?4G@,tx&G");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Character character0 = new Character('<');
      String[] stringArray0 = new String[2];
      stringArray0[0] = "B?6mi`c";
      CSVFormat cSVFormat0 = new CSVFormat('<', (Character) null, quote0, character0, character0, true, false, "tf:94/<l^@j7", "B?6mi`c", stringArray0, true);
      CSVFormat cSVFormat1 = cSVFormat0.withEscape('(');
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse("The comment start character and the quoteChar cannot be the same ('", cSVFormat0);
//        fail("Expecting exception: IllegalStateException");
