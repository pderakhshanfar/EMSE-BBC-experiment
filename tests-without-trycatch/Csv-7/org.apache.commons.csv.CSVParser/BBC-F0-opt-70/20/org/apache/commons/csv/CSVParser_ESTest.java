...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("$Xc)apu,\"Z&z6/", cSVFormat0);
...
//      }
  ...
  public void test02()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "S!3j]j#$!IVJN7g?");
  ...
  public void test03()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("COMMENT/c^$h");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "no quotes mode set but no escape character is set");
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      MockFile mockFile0 = new MockFile("COMMENT");
      MockFile mockFile1 = new MockFile(mockFile0, "c^$h");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("`{b>jxEDBo/", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[`{b>jxEDBo/]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("g/6l~@0A;).4[d", cSVFormat0);
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      URL uRL0 = MockURL.URL("Index for header '%s' is %d but CSVRecord only has %d values!", "Index for header '%s' is %d but CSVRecord only has %d values!", 671, "Index for header '%s' is %d but CSVRecord only has %d values!", uRLStreamHandler0);
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test13()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"IX7", cSVFormat1);
...
//      }
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("(x1", "(x1");
      Character character0 = Character.valueOf('e');
      Quote quote0 = Quote.NON_NUMERIC;
      CSVFormat cSVFormat0 = new CSVFormat('S', character0, quote0, character0, character0, false, false, "n`Qe", "n`Qe", (String[]) null, false);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test21()  throws Throwable  {
      File file0 = MockFile.createTempFile(") invalid parse sequence", (String) null);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
...
//      }
  ...
  public void test22()  throws Throwable  {
      StringReader stringReader0 = new StringReader("ETm9c1XpQnG1o@J");
      Character character0 = new Character('T');
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[8];
      CSVFormat cSVFormat0 = new CSVFormat('T', character0, quote0, character0, character0, false, false, "org.apache.commons.csv.Lexer", "ETm9c1XpQnG1o@J", stringArray0, false);
...
//      }
  ...
  public void test24()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader(".FJ\".:aO?@!");
      stringReader0.close();
      CSVParser cSVParser0 = null;
//      try {
...
//      }
  ...
  public void test25()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("PgN~Ba8f1!9J", cSVFormat0);
      // Undeclared exception!
//      try { 
        cSVParser0.getRecords((LinkedList<CSVRecord>) null);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test28()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("wXbn?0Y}hIYTr).Rs", cSVFormat2);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("6-m9@!WB.o|", cSVFormat0);
      cSVParser0.close();
  ...
  public void test31()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("?<{x0dGJ EEb)b", cSVFormat2);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      stringArray0[0] = "org.apache.commons.csv.CSVParser";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("?<{x0dGJ EEb)b", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("z7t|tru#n.sumz0/", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test36()  throws Throwable  {
      ...
      Quote quote0 = Quote.ALL;
      CSVFormat cSVFormat0 = new CSVFormat('\\', character0, quote0, character0, character0, false, false, "k0xj4", "i", (String[]) null, false);
