...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("x0hf<Q^.Ket_");
      stringReader0.close();
...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "ft");
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "fzDDpNx7~V3:D";
      stringArray0[1] = "g";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("fzDDpNx7~V3:D", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("UO(atS{Eztd}z\"mO]$p", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('e', character0, quote0, character0, character0, true, false, "TL-AR&9|)}Kp", "TL-AR&9|)}Kp", stringArray0, false);
  ...
  public void test06()  throws Throwable  {
      File file0 = MockFile.createTempFile("qDZ+IZKFX7]gJD|rG\"e", "string");
  ...
  public void test08()  throws Throwable  {
      ...
      Quote quote0 = Quote.NON_NUMERIC;
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('e', character0, quote0, character0, character0, false, false, "TL-AR&9|)}Kp", "TL-AR&9|)}Kp", stringArray0, false);
      Character character1 = new Character('_');
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character1);
      StringReader stringReader0 = new StringReader("Pnf");
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
...
//      }
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
//      try { 
        CSVParser.parse("#M~lH:xcN", (CSVFormat) null);
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test14()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("hSC`f,\"{(<i>)<Uc", cSVFormat1);
...
//      }
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("gOO'dL%q3|B ov>", "gOO'dL%q3|B ov>");
...
//      }
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("\"aN#BhL|", cSVFormat0);
//      try { 
        cSVParser0.nextRecord();
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("\"h-ZY9?S`3Yc<", cSVFormat0);
//      try { 
...
//      }
  ...
  public void test22()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      File file0 = MockFile.createTempFile("url", "tPN", (File) null);
...
//      }
  ...
  public void test25()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"s)v8)yqa;f}b");
      CSVParser cSVParser0 = null;
//      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      StringReader stringReader0 = new StringReader(" 355&+1<F`");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test29()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("hj", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("<f\n5 :`j", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
