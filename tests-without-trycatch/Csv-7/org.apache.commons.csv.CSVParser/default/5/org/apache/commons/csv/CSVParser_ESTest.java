...
//      }
  ...
  public void test01()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("'eNpgM?tPJ/UP", cSVFormat0);
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("wnH/B^~@|Q$");
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse("q(rl", cSVFormat1);
...
//      }
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("rTk{M/", "rTk{M/");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
...
//      }
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile("IN`.VI", "IN`.VI");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
//      try { 
...
//      }
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("\"xxd/,atmze", cSVFormat0);
//      try { 
        cSVParser0.nextRecord();
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("\"Eok`ht", cSVFormat0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
//      try { 
...
//      }
  ...
  public void test17()  throws Throwable  {
      File file0 = MockFile.createTempFile("oRb7DS&g(b8]v<_8Fxx", "oRb7DS&g(b8]v<_8Fxx");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
...
//      }
  ...
  public void test18()  throws Throwable  {
      StringReader stringReader0 = new StringReader("=yEm7WWMu");
...
//      }
  ...
  public void test20()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"LBh");
      CSVParser cSVParser0 = null;
//      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test21()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(",9<Z/W3+-2?/X", cSVFormat0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("fizh", cSVFormat1);
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("7dde3i\"ujgrla_4p", cSVFormat0);
      cSVParser0.close();
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test26()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("]yjg@", cSVFormat2);
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("rlbrtjo?nar0", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test30()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("s*42$:e:5,{)'n1dFb");
      CSVParser cSVParser0 = CSVParser.parse("s*42$:e:5,{)'n1dFb", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[s*42$:e:5, {)'n1dFb]", cSVRecord0.toString());
  }
