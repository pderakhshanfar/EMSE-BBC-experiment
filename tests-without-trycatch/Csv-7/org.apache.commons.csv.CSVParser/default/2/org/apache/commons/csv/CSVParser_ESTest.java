...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      StringReader stringReader0 = new StringReader("v`Z_tbI,IiF0{{");
...
//      }
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "LkPwrOTlMJ";
      stringArray0[1] = "csvparser has been closed";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("ta3xcezi;9|qr_|m+", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("b55aG-&A(QON", cSVFormat0);
  ...
  public void test05()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.newFormat('d');
      CSVParser cSVParser0 = CSVParser.parse("OK;`^aHo! d", cSVFormat0);
      cSVParser0.close();
  ...
  public void test06()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("v`Z_tb`I,IiFjo{{", cSVFormat1);
...
//      }
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("fo:7Y~EG2{vu9@,Zn(", "fo:7Y~EG2{vu9@,Zn(");
...
//      }
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      MockFile mockFile0 = new MockFile("iif0{{");
//      try { 
...
//      }
  ...
  public void test16()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"<Zpg/|b", cSVFormat0);
//      try { 
...
//      }
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("\"<_'y`X3?RS8:(jd", cSVFormat0);
...
//      }
  ...
  public void test19()  throws Throwable  {
      StringReader stringReader0 = new StringReader("o>vNYF");
...
//      }
  ...
  public void test24()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("PL6uM", cSVFormat1);
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("no hader mapping was specified, the rekord values can't be accessed by name", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[no hader mapping was specified,  the rekord values can't be accessed by name]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      CSVParser cSVParser0 = CSVParser.parse("j>0eu-OxCtu", cSVFormat0);
      cSVParser0.close();
  ...
  public void test31()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("OK;`^aHo! d", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("BR8y$`~n>Q8y");
      CSVParser cSVParser0 = CSVParser.parse("BR8y$`~n>Q8y", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("v`z_tbi");
      CSVParser cSVParser0 = CSVParser.parse("ta3xcezi;9|qr_|m+", cSVFormat1);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("ta3xcezi;9|qr_|m+", cSVFormat0);
