...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      MockFile mockFile0 = new MockFile((File) null, "[tJ0QN7@.^s");
      File file0 = MockFile.createTempFile("[tJ0QN7@.^s", "[tJ0QN7@.^s", (File) mockFile0);
...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("org.2pache.commons]csv.CSVParser$1", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[org.2pache.commons]csv.CSVParser$1]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      StringReader stringReader0 = new StringReader("prbsXrs1");
  ...
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader(".J8jQ*{1]");
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("&A+qjMM`( fh3\"l0A$");
...
//      }
  ...
  public void test11()  throws Throwable  {
      File file0 = MockFile.createTempFile("<c6?*3pr@", "<c6?*3pr@");
      Character character0 = Character.valueOf('i');
      Quote quote0 = Quote.ALL;
      String[] stringArray0 = new String[8];
      CSVFormat cSVFormat0 = new CSVFormat('i', character0, quote0, character0, character0, false, false, "<c6?*3pr@", "<c6?*3pr@", stringArray0, false);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test13()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      MockFile mockFile0 = new MockFile("prbsXrs1");
//      try { 
...
//      }
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("mrUd[sDwd\"85FWy");
...
//      }
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("[c6?}pr@", cSVFormat0);
      cSVParser0.close();
//      try { 
        cSVParser0.getRecords();
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test17()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[c6?}pr@");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
...
//      }
  ...
  public void test19()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"j;\"wzd8z7");
      CSVParser cSVParser0 = null;
//      try {
...
//      }
  ...
  public void test20()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader("#S#}3)/0&?EG<");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      LinkedList<CSVRecord> linkedList0 = new LinkedList<CSVRecord>();
      cSVParser0.getRecords(linkedList0);
  ...
  public void test22()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("!eu`(~", cSVFormat1);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
  ...
  public void test25()  throws Throwable  {
      ...
      stringArray0[0] = "%;dot}";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("org.2pache.commons]csv.CSVParser$1", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test26()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("=:^`@Kc/C^F Zs94Q");
  ...
  public void test27()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "UBe7");
      CSVFormat cSVFormat0 = CSVFormat.TDF;
  ...
  public void test29()  throws Throwable  {
      StringReader stringReader0 = new StringReader("P.a!jW#W;]g+_rIwL");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("P.a!jW#W;]g+_rIwL");
...
//      }
  ...
  public void test30()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('D', character0, quote0, character1, character0, false, false, "<line", "", stringArray0, true);
  ...
  public void test32()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringReader stringReader0 = new StringReader("=:^`@Kc/C^F Ze94Q");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
  ...
  public void test33()  throws Throwable  {
      File file0 = MockFile.createTempFile("O)8^}QsJ]@FIIpr", "format");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
      FileSystemHandling.shouldAllThrowIOExceptions();
//      try { 
