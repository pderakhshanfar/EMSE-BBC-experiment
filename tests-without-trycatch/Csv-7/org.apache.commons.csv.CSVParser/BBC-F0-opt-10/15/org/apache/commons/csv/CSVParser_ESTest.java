...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("2?u/<ic");
      stringReader0.close();
...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "The quoteChar character and the delimiter cannot be the same ('");
  ...
  public void test03()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(">=DI4]3-", cSVFormat0);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('I', (Character) null, quote0, (Character) null, (Character) null, true, false, "RecordSeparator=<", "/{B}0*`L]9", (String[]) null, false);
...
//      }
  ...
  public void test07()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "Delimiter=<\t> QuoteChar=<\"> RecordSeparator=<\r\n> EmptyLines:ignored SurroundingSpaces:ignored SkipHeaderRecord:false");
      Charset charset0 = Charset.defaultCharset();
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test09()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('!', character0, quote0, character0, character0, false, true, "iqkk'ZNi(c@h(:Yi=V", "(line ", stringArray0, true);
      // Undeclared exception!
//      try { 
        CSVParser.parse("iqkk'ZNi(c@h(:Yi=V", cSVFormat0);
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"=gA|fXpQZ", cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("H5-T|+", "H5-T|+", (File) mockFile0);
      Quote quote0 = Quote.MINIMAL;
...
//      }
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("W\"@/lCYQ0l", "W\"@/lCYQ0l", (File) null);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
...
//      }
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("WV01{", cSVFormat0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test18()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("\",fmt7G/q~", cSVFormat0);
...
//      }
  ...
  public void test20()  throws Throwable  {
      MockFile mockFile0 = new MockFile("z matha\"pvpz");
      File file0 = MockFile.createTempFile("m>45d", "m>45d", (File) mockFile0);
      FileSystemHandling.shouldAllThrowIOExceptions();
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse(file0, cSVFormat0);
//      try { 
...
//      }
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("/g0i'>qwCk(p");
...
//      }
  ...
  public void test23()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("\"=gA|fXpQZ");
      CSVParser cSVParser0 = null;
//      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test28()  throws Throwable  {
      StringReader stringReader0 = new StringReader("y2-]x}O,;FIB:8>UO");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("xby'u5zeuzjt}3");
      CSVFormat cSVFormat3 = cSVFormat2.withSkipHeaderRecord(true);
      CSVParser cSVParser0 = CSVParser.parse("pqt#%<u&-3a6-&", cSVFormat3);
  ...
  public void test32()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("xby'u5zeuzjt}3");
      StringReader stringReader0 = new StringReader("FW&L6kUhII5FYs&N");
  ...
  public void test34()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("?R#vQL$_E2AkNeN5o", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertEquals(0L, cSVParser0.getRecordNumber());
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("RTX");
      CSVParser cSVParser0 = CSVParser.parse("RTX", cSVFormat1);
      Consumer<Object> consumer0 = (Consumer<Object>) mock(Consumer.class, new ViolatedAssumptionAnswer());
      cSVParser0.forEach(consumer0);
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
