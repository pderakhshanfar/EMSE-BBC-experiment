...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("()S<G5l,#PaUvLUl", cSVFormat1);
  ...
  public void test04()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse(")0f9:F&\"OE,m@I4=uW", cSVFormat0);
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"WId2`H:", cSVFormat1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("+I@X+t9{", "+I@X+t9{");
      File file0 = MockFile.createTempFile("+I@X+t9{", "+I@X+t9{", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
...
//      }
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("-s28", "-s28");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
...
//      }
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("PTv", "nLp>O]}oTlJM");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
//      try { 
...
//      }
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      CSVParser cSVParser0 = CSVParser.parse("eD=V4+6j*M1", cSVFormat0);
      cSVParser0.close();
//      try { 
        cSVParser0.nextRecord();
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test21()  throws Throwable  {
      File file0 = MockFile.createTempFile(" }vl^70+f.lo_l", " }vl^70+f.lo_l");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
...
//      }
  ...
  public void test26()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withCommentStart(character0);
      CSVParser cSVParser0 = CSVParser.parse("()S<G5l,#Pa}vLUl", cSVFormat1);
  ...
  public void test30()  throws Throwable  {
      ...
      stringArray0[0] = "].HI5TP";
      stringArray0[2] = "zZ7.>0f";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("WDvk*K9Q^=7vCRyEVA;");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[WDvk*K9Q^=7vCRyEVA;]", cSVRecord0.toString());
  }

  @Test(timeout = 4000)
  public void test31()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("()S<G5l,#Pa}vLUl", cSVFormat0);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNull(map0);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse(",{f+?3_,=-/[vU", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
      assertNotNull(map0);
  ...
  public void test34()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/()S<G5l,#Pa}vLUl0!m(");
      byte[] byteArray0 = new byte[2];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = MockFile.createTempFile("()S<G5l,#Pa}vLUl", "!m(");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withNullString("QSWv[0P_u9");
