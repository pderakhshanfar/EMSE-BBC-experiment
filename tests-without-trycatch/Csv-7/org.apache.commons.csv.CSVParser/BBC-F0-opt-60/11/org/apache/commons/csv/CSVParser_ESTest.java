...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "m>vq>?s{{X&9 ");
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[3] = "D";
      stringArray0[4] = "i@Nmf}[J`mjh*p5:hx";
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        CSVParser.parse("b9/'8]", cSVFormat1);
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
//      try { 
        CSVParser.parse("\"6zsBkA+|S:WL#d", cSVFormat1);
...
//      }
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("<(RM~lOdS;d )XD/)", (String) null);
      Character character0 = Character.valueOf('&');
      Quote quote0 = Quote.MINIMAL;
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat0 = new CSVFormat('-', character0, quote0, character0, character0, true, true, "<(RM~lOdS;d )XD/)", "<(RM~lOdS;d )XD/)", stringArray0, true);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader(":Y@Rh65T");
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.close();
//      try { 
...
//      }
  ...
  public void test16()  throws Throwable  {
      StringReader stringReader0 = new StringReader("do30N0+]Ce/k<");
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      stringReader0.close();
...
//      }
  ...
  public void test17()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("aA#Ulm$,5W~", cSVFormat0);
      cSVParser0.close();
//      try { 
        cSVParser0.getRecords();
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test18()  throws Throwable  {
      File file0 = MockFile.createTempFile("format", "us<");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
...
//      }
  ...
  public void test19()  throws Throwable  {
      ...
      CSVFormat cSVFormat0 = new CSVFormat('G', character0, quote0, character0, character0, false, true, "", "", stringArray0, false);
...
//      }
  ...
  public void test21()  throws Throwable  {
      ...
      stringArray0[0] = "L]EV^K";
      stringArray0[1] = "The delimiter cannot be a line break";
      stringArray0[2] = "iE>";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVFormat cSVFormat2 = cSVFormat1.withSkipHeaderRecord(true);
      StringReader stringReader0 = new StringReader("q+@x>CNT]MvB");
      stringReader0.close();
      CSVParser cSVParser0 = null;
//      try {
...
//      }
  ...
  public void test23()  throws Throwable  {
      File file0 = MockFile.createTempFile("v12", "");
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("rec\rdseparat\r=<", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[rec]", cSVRecord0.toString());
  }
  ...
  public void test27()  throws Throwable  {
      ...
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[org.apache.co, , ons.csv.CSVParser$2]", cSVRecord0.toString());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("f!AT@:N*ZUY(`aA", cSVFormat1);
  ...
  public void test33()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      StringReader stringReader0 = new StringReader("5ki`]-0]$'OX");
      CSVFormat cSVFormat1 = cSVFormat0.withNullString("5ki`]-0]$'OX");
      CSVParser cSVParser0 = cSVFormat1.parse(stringReader0);
      cSVParser0.nextRecord();
      assertEquals(1L, cSVParser0.getRecordNumber());
  }
  ...
  public void test35()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = CSVParser.parse("f!AT@:N*ZUY(`aA", cSVFormat0);
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(0L, long0);
  }
  ...
  public void test36()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      MockFile mockFile0 = new MockFile("ons.csv.csvparser$2", "w=~@t^>");
//      try { 
