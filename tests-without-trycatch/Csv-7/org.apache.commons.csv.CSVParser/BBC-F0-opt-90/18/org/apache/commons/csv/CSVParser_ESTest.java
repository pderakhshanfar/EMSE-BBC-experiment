...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("\"=qLyP", cSVFormat0);
...
//      }
  ...
  public void test05()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Of5\"YmhNP");
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0);
  ...
  public void test06()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.TDF;
      CSVParser cSVParser0 = CSVParser.parse("7cr;fgc(", cSVFormat0);
...
//      }
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile("3/#z`@[MpZov\"", "7cr;fgc(,upx!\"d");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
...
//      }
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile(",,5gn", "Uo'+qHcT-O");
      Character character0 = Character.valueOf('P');
      Quote quote0 = Quote.MINIMAL;
      Character character1 = new Character('\"');
      FileSystemHandling.shouldAllThrowIOExceptions();
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('&', character0, quote0, character1, character0, true, true, "LmNcL><<&p!;", "csvparser has been clsed", stringArray0, true);
//      try { 
...
//      }
  ...
  public void test20()  throws Throwable  {
      MockFile mockFile0 = new MockFile("|jNQxCfEkv,f}");
      File file0 = MockFile.createTempFile("h6\":U{Kqa3e8</T", "h6\":U{Kqa3e8</T", (File) mockFile0);
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
...
//      }
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("=EOsjF*#j");
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      String[] stringArray0 = new String[2];
      stringArray0[0] = "=EOsjF*#j";
      stringArray0[1] = "=EOsjF*#j";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
...
//      } catch(IllegalStateException e) {
//         //
//         // The header contains duplicate names: [=EOsjF*#j, =EOsjF*#j]
//         //
//         verifyException("org.apache.commons.csv.CSVFormat", e);
//      }
  }
...
//      }
  ...
  public void test23()  throws Throwable  {
      ...
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      StringReader stringReader0 = new StringReader("+`.d{cqq_y,");
      stringReader0.close();
      CSVParser cSVParser0 = null;
//      try {
        cSVParser0 = new CSVParser(stringReader0, cSVFormat1);
...
//      }
  ...
  public void test24()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("gXpKX", cSVFormat0);
      boolean boolean0 = cSVParser0.isClosed();
  ...
  public void test26()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/o/Yc5HI5?chG/YkTg{)#0");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "$cV:sl");
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      File file0 = MockFile.createTempFile("o/Yc5HI5?chG/YkTg{)#", "", (File) null);
  ...
  public void test27()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      CSVParser cSVParser0 = CSVParser.parse("NPRUgL7,4b\"yhz^i_$", cSVFormat0);
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[NPRUgL7, 4b\"yhz^i_$]", cSVRecord0.toString());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[0] = " W>oK?3zol-R*bQ";
      stringArray0[1] = "$W/L\"[FZp_>ZjV";
      stringArray0[2] = "upx!\"d";
      stringArray0[3] = "hU}K)M,O={Ea";
      stringArray0[4] = "";
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("lYo/z", cSVFormat1);
      assertEquals(0L, cSVParser0.getRecordNumber());
      
      CSVRecord cSVRecord0 = cSVParser0.nextRecord();
      assertEquals("[lYo/z]", cSVRecord0.toString());
  }
  ...
  public void test33()  throws Throwable  {
      ...
      String[] stringArray0 = new String[0];
      CSVFormat cSVFormat1 = cSVFormat0.withHeader(stringArray0);
      CSVParser cSVParser0 = CSVParser.parse("gXpKX", cSVFormat1);
      Map<String, Integer> map0 = cSVParser0.getHeaderMap();
  ...
  public void test35()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      CSVFormat cSVFormat0 = new CSVFormat('A', (Character) null, quote0, character0, character1, false, false, "IDkS7(J]UqH_[~", "IDkS7(J]UqH_[~", stringArray0, true);
  ...
  public void test38()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      Charset charset0 = Charset.defaultCharset();
      MockFile mockFile0 = new MockFile("r 70c]s_C", "");
      URL uRL0 = mockFile0.toURL();
      // Undeclared exception!
//      try { 
        CSVParser.parse(uRL0, charset0, cSVFormat0);
