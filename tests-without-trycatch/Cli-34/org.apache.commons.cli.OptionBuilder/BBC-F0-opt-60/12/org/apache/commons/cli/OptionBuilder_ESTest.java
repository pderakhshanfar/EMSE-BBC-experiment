...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Option option0 = OptionBuilder.create("o_");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1541);
      Option option0 = OptionBuilder.create('6');
      assertTrue(option0.hasOptionalArg());
      assertEquals(54, option0.getId());
      assertEquals(1541, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      OptionBuilder.withLongOpt("#[SrGU[>'z;vzam");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
...
//      try { 
        OptionBuilder.create("&1OF,&Wqi>ntNO%RC");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option '&1OF,&Wqi>ntNO%RC' contains an illegal character : '&'
//         //
