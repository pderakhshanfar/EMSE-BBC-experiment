...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Option option0 = OptionBuilder.create("h8");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.withLongOpt("S.do<bA~/LZ%z_WH");
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withArgName("S.do<bA~/LZ%z_WH");
      Option option0 = OptionBuilder.create('P');
      assertEquals((-1), option0.getArgs());
      assertEquals("P", option0.getOpt());
  }
...
//      try { 
        OptionBuilder.create("S.do<bA~/LZ%z_WH");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'S.do<bA~/LZ%z_WH' contains an illegal character : '.'
//         //
...
//      }
  ...
  public void test20()  throws Throwable  {
      OptionBuilder.hasOptionalArgs((-2012));
      Option option0 = OptionBuilder.create("");
      assertTrue(option0.hasOptionalArg());
