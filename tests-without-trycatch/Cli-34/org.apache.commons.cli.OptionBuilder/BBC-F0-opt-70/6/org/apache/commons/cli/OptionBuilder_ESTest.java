...
//      try { 
        OptionBuilder.create("Cn|'S2uah!!<nu!\"\"s");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'Cn|'S2uah!!<nu!\"\"s' contains an illegal character : '|'
//         //
...
//      }
  ...
  public void test19()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(0);
      OptionBuilder.withLongOpt("T]O~:Y");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(0, option0.getArgs());
  }
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.hasArg();
      OptionBuilder.withLongOpt("-cz|cAh^t%<{9=O");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
  }
