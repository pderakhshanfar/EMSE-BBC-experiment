...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withLongOpt("O8Jf?l");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withArgName("'F@:yU<!Iu\"~1LSH)+\"");
...
//      try { 
        OptionBuilder.create("'F@:yU<!Iu\"~1LSH)+\"");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option ''F@:yU<!Iu\"~1LSH)+\"' contains an illegal character : '''
//         //
...
//      }
  ...
  public void test26()  throws Throwable  {
      OptionBuilder.withArgName("OrolPypKq6z");
      Option option0 = OptionBuilder.create("OrolPypKq6z");
      assertEquals((-1), option0.getArgs());
  }
