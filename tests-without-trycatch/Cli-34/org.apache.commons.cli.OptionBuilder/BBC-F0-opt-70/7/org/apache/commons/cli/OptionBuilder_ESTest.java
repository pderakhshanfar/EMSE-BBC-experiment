...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("hzY~|l%Cs~");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("9DjbG}}qure7{v/I:");
      OptionBuilder.withValueSeparator();
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('=', option0.getValueSeparator());
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("");
      OptionBuilder.withArgName("CYQZirPtQ");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
...
//      try { 
        OptionBuilder.create("XDHtgwsA4& \",!n@");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'XDHtgwsA4& \",!n@' contains an illegal character : '&'
//         //
