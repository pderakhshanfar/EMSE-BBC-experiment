...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionBuilder.withLongOpt("Q@Hw6FwWG93Ojm0%S");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("FnHYfF6_o4zd");
  ...
  public void test12()  throws Throwable  {
      OptionBuilder.withLongOpt("o5hDHUsD:r5'0/:M!7");
      OptionBuilder.hasArgs();
      Option option0 = OptionBuilder.create();
      assertEquals((-2), option0.getArgs());
  }
...
//      try { 
        OptionBuilder.create("Z];kY");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'Z];kY' contains an illegal character : ']'
//         //
...
//      }
  ...
  public void test22()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.hasOptionalArgs(1184);
      assertNotNull(optionBuilder0);
  }
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.hasOptionalArg();
      OptionBuilder.withLongOpt("8OrgQ>z{)H+_ 9?-_");
      Option option0 = OptionBuilder.create();
      assertEquals(1, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
  ...
  public void test30()  throws Throwable  {
      OptionBuilder.isRequired();
      OptionBuilder.withLongOpt("/xR<z;+uv,");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertTrue(option0.isRequired());
  }
