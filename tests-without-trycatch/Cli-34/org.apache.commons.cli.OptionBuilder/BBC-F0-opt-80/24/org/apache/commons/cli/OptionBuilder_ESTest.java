...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("kA|]vI]:Eq");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test05()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1414);
      Option option0 = OptionBuilder.create("");
      assertTrue(option0.hasOptionalArg());
      assertEquals(1414, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      OptionBuilder.hasOptionalArgs((-12));
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("[jm!'j");
      Option option0 = OptionBuilder.create('K');
      assertEquals("K", option0.getOpt());
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test11()  throws Throwable  {
      OptionBuilder.withArgName(")Y3pK[Sk,");
  ...
  public void test13()  throws Throwable  {
      OptionBuilder.withLongOpt("NO_ARGS_ALLOWED");
      OptionBuilder.hasOptionalArgs(1199);
      Option option0 = OptionBuilder.create();
      assertEquals(1199, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }
...
//      try { 
        OptionBuilder.create("XC'_[_(YC{4}Cl4D");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'XC'_[_(YC{4}Cl4D' contains an illegal character : '''
//         //
...
//      }
  ...
  public void test20()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("bmy,Z[Se4rl7jkd%");
      assertNotNull(optionBuilder0);
  }
