...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withArgName(":gXJy{'k_# 3");
  ...
  public void test14()  throws Throwable  {
      OptionBuilder.withLongOpt("");
      OptionBuilder.hasArgs(1056);
      Option option0 = OptionBuilder.create();
      assertEquals(1056, option0.getArgs());
  }
...
//      try { 
        OptionBuilder.create("3!^-LeOtorVC");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option '3!^-LeOtorVC' contains an illegal character : '!'
//         //
