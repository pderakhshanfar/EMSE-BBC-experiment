...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Option option0 = OptionBuilder.create("YY8aqt");
      assertEquals((-1), option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      OptionBuilder.hasArgs(1496);
      Option option0 = OptionBuilder.create("");
  ...
  public void test06()  throws Throwable  {
      OptionBuilder.withLongOpt("'PyL\u0004%7");
  ...
  public void test07()  throws Throwable  {
      OptionBuilder.withArgName("%HbvR");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(702);
      Option option0 = OptionBuilder.create('n');
      assertTrue(option0.hasOptionalArg());
      assertEquals(702, option0.getArgs());
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("'PyL\u0004%7");
      OptionBuilder.withArgName("'PyL\u0004%7");
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
  }
...
//      try { 
        OptionBuilder.create("N}iB{f");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'N}iB{f' contains an illegal character : '}'
//         //
...
//      }
  ...
  public void test18()  throws Throwable  {
      OptionBuilder optionBuilder0 = OptionBuilder.withDescription("VI~>");
      assertNotNull(optionBuilder0);
  }
  ...
  public void test25()  throws Throwable  {
      OptionBuilder.withLongOpt("YY8aqt");
      OptionBuilder.withValueSeparator('');
      Option option0 = OptionBuilder.create();
      assertEquals('', option0.getValueSeparator());
      assertEquals((-1), option0.getArgs());
