...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      OptionBuilder.withArgName("dfTN,|");
      Option option0 = OptionBuilder.create("");
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withArgName("m Sg");
...
//      try { 
        OptionBuilder.create("/.EjUa/C@Ne");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option '/.EjUa/C@Ne' contains an illegal character : '/'
//         //
...
//      }
  ...
  public void test21()  throws Throwable  {
      OptionBuilder.hasOptionalArgs();
      OptionBuilder.withLongOpt(".($#*;}YJOg^");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals((-2), option0.getArgs());
  }
