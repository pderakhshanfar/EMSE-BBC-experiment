...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = OptionBuilder.create("6a");
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withArgName("5[_Q-rh^~DBngEyq");
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(1600);
      Option option0 = OptionBuilder.create('D');
      assertEquals("D", option0.getOpt());
      assertTrue(option0.hasOptionalArg());
      assertEquals(1600, option0.getArgs());
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("%TlzVW`+pBS[");
      OptionBuilder.isRequired();
      Option option0 = OptionBuilder.create();
      assertTrue(option0.isRequired());
      assertEquals((-1), option0.getArgs());
...
//      try { 
        OptionBuilder.create("bfS>H");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'bfS>H' contains an illegal character : '>'
//         //
