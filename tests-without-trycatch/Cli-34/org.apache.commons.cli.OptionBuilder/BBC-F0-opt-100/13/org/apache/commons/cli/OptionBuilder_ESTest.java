...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withArgName("_R");
      Option option0 = OptionBuilder.create("_R");
      assertEquals((-1), option0.getArgs());
  }
...
//      try { 
        OptionBuilder.create("vV_\"Lm{Zb");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option 'vV_\"Lm{Zb' contains an illegal character : '\"'
//         //
...
//      }
  ...
  public void test21()  throws Throwable  {
      ...
      OptionBuilder.withLongOpt("0aSe6AuS33JtEa[");
      Option option0 = OptionBuilder.create();
      assertTrue(option0.hasOptionalArg());
      assertEquals(1, option0.getArgs());
  }
