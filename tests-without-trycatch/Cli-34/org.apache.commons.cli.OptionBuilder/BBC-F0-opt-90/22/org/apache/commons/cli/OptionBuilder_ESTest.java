...
public class OptionBuilder_ESTest extends OptionBuilder_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionBuilder.hasOptionalArgs(2924);
      Option option0 = OptionBuilder.create("NO_ARGS_ALLOWED");
      assertEquals(2924, option0.getArgs());
      assertTrue(option0.hasOptionalArg());
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      OptionBuilder.withArgName("K{gzZ<3o;ay[wB,");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test03()  throws Throwable  {
      OptionBuilder.withLongOpt(" <tk*(jd#AE;?+)F'");
      Option option0 = OptionBuilder.create((String) null);
      assertEquals((-1), option0.getArgs());
  }
  ...
  public void test08()  throws Throwable  {
      OptionBuilder.withLongOpt("v<nztG#WD$-");
      OptionBuilder.withValueSeparator('s');
      Option option0 = OptionBuilder.create();
      assertEquals((-1), option0.getArgs());
      assertEquals('s', option0.getValueSeparator());
  ...
  public void test09()  throws Throwable  {
      OptionBuilder.withArgName("\"U46k5(sHz");
  ...
  public void test10()  throws Throwable  {
      OptionBuilder.withLongOpt("9>S!D[C<p'-2H>AK9");
      OptionBuilder.hasArgs(0);
      Option option0 = OptionBuilder.create();
      assertEquals(0, option0.getArgs());
  }
...
//      try { 
        OptionBuilder.create("}M7bk");
//        fail("Expecting exception: IllegalArgumentException");
      
//      } catch(IllegalArgumentException e) {
//         //
//         // The option '}M7bk' contains an illegal character : '}'
//         //
//         verifyException("org.apache.commons.cli.OptionValidator", e);
//      }
  }
