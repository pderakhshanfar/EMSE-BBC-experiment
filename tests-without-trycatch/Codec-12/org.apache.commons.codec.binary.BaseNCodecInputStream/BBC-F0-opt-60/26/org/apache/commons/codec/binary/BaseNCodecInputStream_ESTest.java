...
//      }
  ...
  public void test06()  throws Throwable  {
      byte[] byteArray0 = new byte[3];
      Base32 base32_0 = new Base32((-64));
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-4439), 86);
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(byteArrayInputStream0, base32_0, false);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test07()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32((-1891));
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        baseNCodecInputStream0.read(byteArray0, 634, (int) (byte)0);
//        fail("Expecting exception: IndexOutOfBoundsException");
...
//      }
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = new byte[3];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      Base32 base32_0 = new Base32((-3290), byteArray0);
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(byteArrayInputStream0, base32_0, false);
      // Undeclared exception!
//      try { 
        baseNCodecInputStream0.read(byteArray0, 2815, (-2186));
//        fail("Expecting exception: IndexOutOfBoundsException");
...
//      }
  ...
  public void test13()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      Base32 base32_0 = new Base32((-175));
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(byteArrayInputStream0, base32_0, true);
      // Undeclared exception!
//      try { 
        baseNCodecInputStream0.read(byteArray0, (int) (byte) (-36), (int) (byte) (-36));
//        fail("Expecting exception: IndexOutOfBoundsException");
...
//      }
  ...
  public void test14()  throws Throwable  {
      FileDescriptor fileDescriptor0 = new FileDescriptor();
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      Base32 base32_0 = new Base32((-780));
      BaseNCodecInputStream baseNCodecInputStream0 = new BaseNCodecInputStream(mockFileInputStream0, base32_0, true);
      // Undeclared exception!
//      try { 
        baseNCodecInputStream0.read((byte[]) null, 2216, (-3626));
//        fail("Expecting exception: NullPointerException");
