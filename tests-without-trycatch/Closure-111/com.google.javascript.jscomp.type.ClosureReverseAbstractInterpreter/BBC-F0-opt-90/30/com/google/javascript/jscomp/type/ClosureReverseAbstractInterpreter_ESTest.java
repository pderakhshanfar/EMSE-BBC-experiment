...
public class ClosureReverseAbstractInterpreter_ESTest extends ClosureReverseAbstractInterpreter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Node node0 = Node.newString("{C'zL3P4VBqH~/I");
      Node node1 = Node.newString("Object#Key");
      Node node2 = Node.newString(1, "{C'zL3P4VBqH~/I");
...
//      }
  ...
  public void test4()  throws Throwable  {
      ...
      JSTypeRegistry jSTypeRegistry0 = new JSTypeRegistry(simpleErrorReporter0);
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(googleCodingConvention0, jSTypeRegistry0);
      Node node0 = Node.newNumber((-1568.472521991));
      ImmutableList<JSType> immutableList0 = ImmutableList.of();
      Node node1 = jSTypeRegistry0.createParameters((List<JSType>) immutableList0);
      Node node2 = new Node(37, node0, node1, 57, 16);
  ...
  public void test5()  throws Throwable  {
      ...
      ClosureReverseAbstractInterpreter closureReverseAbstractInterpreter0 = new ClosureReverseAbstractInterpreter(googleCodingConvention0, jSTypeRegistry0);
      Node node0 = Node.newNumber((-1568.472521991));
      Node node1 = new Node(37, node0, node0, 57, 16);
