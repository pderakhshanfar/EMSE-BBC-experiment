...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      checksumCalculatingInputStream0.skip((-2753L));
      long long0 = checksumCalculatingInputStream0.skip((-1));
      assertEquals(1785546861L, checksumCalculatingInputStream0.getValue());
  ...
  public void test04()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      checksumCalculatingInputStream0.skip(0L);
      checksumCalculatingInputStream0.skip(961L);
      int int0 = checksumCalculatingInputStream0.read();
      assertEquals(2431758067L, checksumCalculatingInputStream0.getValue());
...
//      try { 
        checksumCalculatingInputStream0.skip(1393L);
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, 6, (-1));
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)38, 0);
//        fail("Expecting exception: ArrayIndexOutOfBoundsException");
...
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, 0, (int) (byte) (-125));
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test15()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-56), 3817);
...
//      }
  ...
  public void test22()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, sequenceInputStream0);
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (-448), (int) (byte) (-70));
      assertEquals((-1), int0);
  }
...
//      }
  ...
  public void test26()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-304), (byte)30);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read();
