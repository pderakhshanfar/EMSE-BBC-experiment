...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      long long0 = checksumCalculatingInputStream0.skip((-875L));
      assertEquals(266178987L, checksumCalculatingInputStream0.getValue());
  ...
  public void test01()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("bV\"Yd:N\"L}!aN^!;6h", "bV\"Yd:N\"L}!aN^!;6h");
...
//      try { 
        checksumCalculatingInputStream0.skip((-2498L));
...
//      }
  ...
  public void test05()  throws Throwable  {
      byte[] byteArray0 = new byte[9];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-117), 2127);
...
//      }
  ...
  public void test07()  throws Throwable  {
      ...
      FileDescriptor fileDescriptor0 = new FileDescriptor();
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(fileDescriptor0);
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(mockFileInputStream0, 1438);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, pushbackInputStream0);
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read((byte[]) null, 1438, 1438);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)5, (int) (byte)0);
...
//      }
  ...
  public void test09()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      File file0 = MockFile.createTempFile("^zys,`sMB*K+p&W`~", "");
      MockFileInputStream mockFileInputStream0 = new MockFileInputStream(file0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[1];
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-2904), (int) (byte)0);
//        fail("Expecting exception: ArrayIndexOutOfBoundsException");
...
//      }
  ...
  public void test20()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-746), (byte) (-102));
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      long long0 = checksumCalculatingInputStream0.skip((-746));
  ...
  public void test22()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      checksumCalculatingInputStream0.skip((-356L));
      checksumCalculatingInputStream0.skip((-875L));
      int int0 = checksumCalculatingInputStream0.read(byteArray0);
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2038), 2077);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      long long0 = checksumCalculatingInputStream0.getValue();
      assertEquals(0L, long0);
  }
...
//      }
  ...
  public void test26()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)1, 1395);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
