...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals(7798903L, checksumCalculatingInputStream0.getValue());
  ...
  public void test01()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1412), 1761);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals(4194326291L, checksumCalculatingInputStream0.getValue());
...
//      try { 
        checksumCalculatingInputStream0.skip(1554L);
...
//      }
  ...
  public void test06()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-77), (byte)1);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
//      try { 
...
//      try { 
        checksumCalculatingInputStream0.skip(560);
...
//      }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-109), (int) (byte) (-109));
//        fail("Expecting exception: ArrayIndexOutOfBoundsException");
...
//      try { 
        checksumCalculatingInputStream0.read((byte[]) null, (-1471), 101);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test12()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-1), 1449);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0);
...
//      }
  ...
  public void test17()  throws Throwable  {
      ...
      PipedInputStream pipedInputStream0 = new PipedInputStream(pipedOutputStream0, 949);
...
//      }
  ...
  public void test19()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 654, (-1));
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
  ...
  public void test20()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      long long0 = checksumCalculatingInputStream0.skip(1993L);
  ...
  public void test21()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 654, (-1));
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      long long0 = checksumCalculatingInputStream0.skip((-742L));
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, 1, (int) (byte)32);
