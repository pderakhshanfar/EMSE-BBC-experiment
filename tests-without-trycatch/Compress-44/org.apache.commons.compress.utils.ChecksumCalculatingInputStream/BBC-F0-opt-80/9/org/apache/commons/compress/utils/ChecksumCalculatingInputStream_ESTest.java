...
//      try { 
        checksumCalculatingInputStream0.skip(1129L);
...
//      }
  ...
  public void test06()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-374), 1);
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(byteArrayInputStream0, byteArrayInputStream0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, sequenceInputStream0);
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.skip((byte) (-106));
...
//      }
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read((byte[]) null, (int) (byte) (-1), (-1064));
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, 0, (int) (byte)94);
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-100), (-1));
//        fail("Expecting exception: ArrayIndexOutOfBoundsException");
...
//      }
  ...
  public void test11()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream((InputStream) null, 1300);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, pushbackInputStream0);
      byte[] byteArray0 = new byte[5];
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-1), 255);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test16()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[9];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-69), 118);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read();
