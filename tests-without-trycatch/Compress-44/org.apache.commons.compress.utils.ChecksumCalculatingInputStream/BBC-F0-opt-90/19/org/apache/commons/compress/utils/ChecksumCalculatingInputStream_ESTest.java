...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals(3407924L, checksumCalculatingInputStream0.getValue());
  ...
  public void test02()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1237), 431);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
  ...
  public void test05()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1321), (-290));
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
...
//      try { 
        checksumCalculatingInputStream0.skip((-1392L));
...
//      }
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.skip((-2059L));
...
//      }
  ...
  public void test08()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      PipedInputStream pipedInputStream0 = new PipedInputStream(1956);
...
//      try { 
        checksumCalculatingInputStream0.skip(1956);
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, 0, (int) (byte) (-66));
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-1), (int) (byte) (-103));
//        fail("Expecting exception: ArrayIndexOutOfBoundsException");
...
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)84, (int) (byte) (-45));
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = new byte[3];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-752), (byte)2);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream((Checksum) null, byteArrayInputStream0);
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read();
...
//      }
  ...
  public void test18()  throws Throwable  {
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)65, (-752));
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream((Checksum) null, byteArrayInputStream0);
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test19()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[1];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, (int) (byte) (-66), (int) (byte) (-66));
      assertEquals((-1), int0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      checksumCalculatingInputStream0.skip((byte)51);
      int int0 = checksumCalculatingInputStream0.read();
  ...
  public void test25()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-22), 2782);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0);
