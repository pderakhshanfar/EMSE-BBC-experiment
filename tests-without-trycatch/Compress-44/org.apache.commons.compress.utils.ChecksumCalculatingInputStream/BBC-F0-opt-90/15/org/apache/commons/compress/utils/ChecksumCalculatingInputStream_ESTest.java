...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      long long0 = checksumCalculatingInputStream0.skip((-1446L));
      assertEquals(936857984L, checksumCalculatingInputStream0.getValue());
  ...
  public void test02()  throws Throwable  {
      ...
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(pipedInputStream0, 2484);
  ...
  public void test04()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 421, 0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      int int0 = checksumCalculatingInputStream0.read(byteArray0);
      assertEquals((-1), int0);
  }
...
//      }
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.skip((-729L));
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-1), (int) (byte) (-121));
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)52, (-2604));
//        fail("Expecting exception: ArrayIndexOutOfBoundsException");
...
//      }
  ...
  public void test13()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[8];
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)9, (int) (byte)1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test17()  throws Throwable  {
      Adler32 adler32_0 = new Adler32();
      byte[] byteArray0 = new byte[9];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-649), (byte)35);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(adler32_0, byteArrayInputStream0);
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read();
...
//      }
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      checksumCalculatingInputStream0.skip((-1446L));
      long long0 = checksumCalculatingInputStream0.skip((-337L));
      assertEquals(3523407757L, checksumCalculatingInputStream0.getValue());
  ...
  public void test26()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[7];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1413), (byte)9);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0);
