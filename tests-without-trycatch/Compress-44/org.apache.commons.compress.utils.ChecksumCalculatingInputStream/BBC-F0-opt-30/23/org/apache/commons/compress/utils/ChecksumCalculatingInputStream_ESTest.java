...
public class ChecksumCalculatingInputStream_ESTest extends ChecksumCalculatingInputStream_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      long long0 = checksumCalculatingInputStream0.skip((-224));
  ...
  public void test01()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)0, 1813);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
  ...
  public void test02()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)0, 1823);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals(16580860L, checksumCalculatingInputStream0.getValue());
  ...
  public void test04()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      MockFile mockFile0 = new MockFile("3D.+m_");
      File file0 = MockFile.createTempFile("3D.+m_", "3D.+m_", (File) mockFile0);
...
//      }
  ...
  public void test07()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-3), 1813);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
//      try { 
...
//      try { 
        checksumCalculatingInputStream0.skip((-389L));
...
//      }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, 1079, 1079);
//        fail("Expecting exception: NullPointerException");
...
//      }
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (int) (byte)1, (-3819));
...
//      }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, (-1), (int) (byte) (-8));
//        fail("Expecting exception: ArrayIndexOutOfBoundsException");
...
//      }
  ...
  public void test12()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[8];
//      try { 
        checksumCalculatingInputStream0.read(byteArray0, 1101, (int) (byte)1);
//        fail("Expecting exception: IOException");
...
//      }
  ...
  public void test18()  throws Throwable  {
      ...
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, mockFileInputStream0);
      byte[] byteArray0 = new byte[2];
      int int0 = checksumCalculatingInputStream0.read(byteArray0, 1, (int) (byte)93);
      assertEquals((-1), int0);
  }
  ...
  public void test21()  throws Throwable  {
      byte[] byteArray0 = new byte[1];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 4, 179);
      ...
      long long0 = checksumCalculatingInputStream0.skip(171L);
      assertEquals(0L, long0);
  }
...
//      }
  ...
  public void test23()  throws Throwable  {
      CRC32 cRC32_0 = new CRC32();
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-571), 1);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read(byteArray0);
...
//      }
  ...
  public void test24()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-177), 10);
      ChecksumCalculatingInputStream checksumCalculatingInputStream0 = new ChecksumCalculatingInputStream(cRC32_0, byteArrayInputStream0);
      // Undeclared exception!
//      try { 
        checksumCalculatingInputStream0.read();
