...
//      }
  ...
  public void test09()  throws Throwable  {
      ...
      IsCloseTo isCloseTo0 = new IsCloseTo((-879.0860773021822), (-879.0860773021822));
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn((Method) null, (Method) null).when(invocation0).getMethod();
...
//      }
  ...
  public void test10()  throws Throwable  {
      Object[] objectArray0 = new Object[4];
      IsEqualIgnoringCase isEqualIgnoringCase0 = new IsEqualIgnoringCase("valueOf");
      Class<StringStartsWith> class0 = StringStartsWith.class;
      IsInstanceOf isInstanceOf0 = new IsInstanceOf(class0);
      Invocation invocation0 = mock(Invocation.class, new ViolatedAssumptionAnswer());
      doReturn(objectArray0).when(invocation0).getArguments();
      doReturn(isEqualIgnoringCase0, isInstanceOf0).when(invocation0).getMock();
      InvocationMatcher invocationMatcher0 = new InvocationMatcher(invocation0);
