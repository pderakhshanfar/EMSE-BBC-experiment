...
//      try { 
        soundex0.difference((String) null, "a#");
...
//      }
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.encode("CzH_;d2oLe'~\nCX");
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex(".Vkl=@}c");
      // Undeclared exception!
//      try { 
        soundex0.soundex(".Vkl=@}c");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.EncoderException");
      String string0 = soundex0.soundex("-'5:0BdIiIX");
      assertEquals("B.hc", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.EncoderException");
      String string0 = soundex0.soundex("3");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("", string0);
  }
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex("69yn?^");
      // Undeclared exception!
//      try { 
        soundex0.encode("69yn?^");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference("J625", "l?*X%lWh;%PW2i");
      assertEquals(1, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("fn[<}Hwj");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("F500", string0);
  }

  @Test(timeout = 4000)
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("GK=7", ";Jb7h-VJr");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.EncoderException");
      String string0 = soundex0.encode("GVwg>NJp!~)UaeJ");
      assertEquals("Gdea", string0);
...
//      }
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.EncoderException");
      Object object0 = soundex0.encode((Object) "}<PoKCL");
      assertEquals("Pm.g", object0);
...
//      }
  ...
  public void test22()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("a'?HzcagO]tJPz7\u0006", "");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
