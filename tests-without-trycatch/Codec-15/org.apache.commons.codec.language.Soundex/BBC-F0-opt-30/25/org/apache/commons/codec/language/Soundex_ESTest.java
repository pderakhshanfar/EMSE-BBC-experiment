...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("PCW|vBrs1ErSWI");
      assertEquals("P216", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      String string0 = soundex0.encode(";bfSZ@b%nV@{@sS");
      assertEquals("Bp.l", string0);
  }
  ...
  public void test04()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.encode("Wzf!PQP^TL3/LPma");
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.US_ENGLISH.difference("O621", "O621");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
...
//      }
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex("-Vgt'-z\"%T\"gOb");
      // Undeclared exception!
//      try { 
        soundex0.difference("IY`oW|>", ";TdG+[pOJ|=9t@o\bV");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex("*#?*cww(MD@:TCO`");
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.US_ENGLISH.encode((Object) "1[dUeK{HW4$,*@!@Z|");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.soundex(",ypiCW|Ca0$");
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("{x61w-47Ma0");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("X500", string0);
  }
...
//      }
  ...
  public void test20()  throws Throwable  {
      Soundex soundex0 = new Soundex("lnq|[W\"d'7#]S&G");
      // Undeclared exception!
//      try { 
        soundex0.soundex("lnq|[W\"d'7#]S&G");
//        fail("Expecting exception: IllegalArgumentException");
