...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.soundex("bU>Tw\"btpPp?RP~");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("B ta", string0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex("y(h9BL'~=WPOL+~?%Lw");
      // Undeclared exception!
//      try { 
        soundex0.soundex("HT(l)6y)(c2qF^q}4k");
...
//      }
  ...
  public void test02()  throws Throwable  {
      ...
      int int0 = soundex0.difference(":^!_l%7,Qq4nnyHTJ", "The character is not mapped: ");
      assertEquals(1, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test03()  throws Throwable  {
      Soundex soundex0 = new Soundex("The character is not mapped: ");
      String string0 = soundex0.soundex(".b?'}ho)^&(VfTKSPH");
      assertEquals("Brim", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test04()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference((String) null, "f(jC:]zLhv");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      String string0 = soundex0.US_ENGLISH.encode("P653");
      assertEquals(4, soundex0.getMaxLength());
...
//      }
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex("Mwl-^%3=LD9Fs#lg");
      // Undeclared exception!
//      try { 
        soundex0.encode((Object) "Mwl-^%3=LD9Fs#lg");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex("#8BeX");
      // Undeclared exception!
//      try { 
        soundex0.difference("HXwK-}P|v]G* Z<", "#8BeX");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex("Parameter supplied to Soundex encode is not of type java.lang.String");
      String string0 = soundex0.US_ENGLISH.soundex("#jCH}I-0<m-Z3%");
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.US_ENGLISH.difference("XHoHHZbLU<m,{xC(", "ak>xB");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex("The character is not mapped: ");
      String string0 = soundex0.soundex("DhD<");
      assertEquals("Dr00", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex("Parameter supplied to Soundex encode is not of type java.lang.String");
      soundex0.US_ENGLISH.difference("1?`%_", "YowG!1$>k54E'I");
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      int int0 = soundex0.difference("zfKt\"EDtg].QD*kBH", "YZg=wH`!b?PifUdK");
      assertEquals(0, int0);
  }
