...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.US_ENGLISH.soundex("4\u0000a^Q-gSlA");
      assertEquals("A240", string0);
  ...
  public void test01()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("m/|7+.wBjyw(MiK", "E232");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
...
//      }
  ...
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("#~ Y)Dk@:([&CAR(w`");
      // Undeclared exception!
//      try { 
        soundex0.encode("#~ Y)Dk@:([&CAR(w`");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        soundex0.difference("#DlfnsQP-", "rC+>V?");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test09()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("J/#XM-3DZ1bPIaf");
      assertEquals("J532", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        soundex0.encode((Object) " Ecz=?+t1Sg1");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("Qx9 vV7w~*H3&Gg#");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("@chX*k>lv6~6|2@\"", "J532");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("sR", "s6IhX$kY7BWKHrH{");
      assertEquals(1, int0);
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.encode(">Y>hWF]31SR%C=0");
