...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.US_ENGLISH.encode("Mx,-2a&{w|=.llj");
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.encode("@V.?8mHstK'@");
      assertEquals(4, soundex0.getMaxLength());
...
//      }
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = new Soundex("BlrG$,H]JWH");
      // Undeclared exception!
//      try { 
        soundex0.difference("BlrG$,H]JWH", "BlrG$,H]JWH");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test08()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("+Q7Fy4HMlOk8_WM");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("Q154", string0);
  }
  ...
  public void test11()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("U}0#|eZqO9@");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test12()  throws Throwable  {
      Soundex soundex0 = new Soundex("r=l");
      // Undeclared exception!
//      try { 
        soundex0.encode((Object) "r=l");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test13()  throws Throwable  {
      ...
      String string0 = soundex0.encode("{jLW+}H<lw W z");
      assertNotNull(string0);
      assertEquals("J400", string0);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      int int0 = soundex0.difference(",/^dbO6*hwji", ",/^dbO6*hwji");
      assertEquals(4, int0);
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("Vwzh]QQ37");
      assertEquals(4, soundex0.getMaxLength());
...
//      }
  ...
  public void test18()  throws Throwable  {
      ...
      String string0 = soundex0.encode("^$~ti~tSU");
      assertEquals("Thc.", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("+Q7Fy4HMlOk8_WM", (String) null);
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        soundex0.soundex("V1oFT'JJhFr6lQ");
//        fail("Expecting exception: IllegalArgumentException");
