...
//      }
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("$)I'", "{I`kWn/=}kO#9}.54=");
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Soundex soundex0 = new Soundex("dXpr$d");
      // Undeclared exception!
//      try { 
        soundex0.encode("dXpr$d");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex("WbiAyw!')");
      // Undeclared exception!
//      try { 
        soundex0.encode((Object) "WbiAyw!')");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        soundex0.difference("!zGdB<G\"D", "!zGdB<G\"D");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test10()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("Kj^{R1z@p5g>-G");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("K621", string0);
  }
  ...
  public void test13()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("\"\"[~ Az~ma*z}>", (String) null);
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.US_ENGLISH.difference("", "hwC$7k#-d86J;`xCL:-");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(0, int0);
  }
  ...
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex(",y(4HNHNj52L7#");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("FDW$)1^Fn:X");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("F315", string0);
  }
...
//      }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.encode((Object) "K152");
  ...
  public void test19()  throws Throwable  {
      ...
      int int0 = soundex0.difference("<i/O2-o&S$+:3", "vSM@}]E9S*");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
...
//      }
  ...
  public void test21()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("w-h-cEuc3H&-");
      assertEquals(4, soundex0.getMaxLength());
