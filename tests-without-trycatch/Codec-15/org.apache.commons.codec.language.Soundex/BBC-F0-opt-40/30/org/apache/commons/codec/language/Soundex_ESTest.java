...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = soundex0.encode("eh]KG0|8");
      assertEquals("Ec.a", string0);
  ...
  public void test05()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("xA/?", "xA/?");
      assertEquals(4, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
...
//      try { 
        soundex0.soundex("drWaEhQRG:Q`L9j(|");
...
//      }
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        soundex0.encode("io:7K~wN0\"Mx[w!3^");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test11()  throws Throwable  {
      char[] charArray0 = new char[3];
      Soundex soundex0 = new Soundex(charArray0);
      String string0 = soundex0.US_ENGLISH.soundex("!VAZ0ZP%:tQl$]9vDaI");
      assertEquals("V213", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
...
//      }
  ...
  public void test14()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.encode("s:3u.V]VMMmhH lZ");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("S152", string0);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.US_ENGLISH.soundex("I+h&eI`,2gA8\"gwc@\r");
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("AeSEzWmht", "");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
...
//      }
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      Object object0 = soundex0.encode((Object) "G515");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("G000", object0);
  }
  ...
  public void test20()  throws Throwable  {
      char[] charArray0 = new char[0];
      Soundex soundex0 = new Soundex(charArray0);
      Object object0 = soundex0.US_ENGLISH.encode((Object) "PN5wH}/r{0");
      assertEquals(4, soundex0.getMaxLength());
      assertNotNull(object0);
      assertEquals("P500", object0);
  }
