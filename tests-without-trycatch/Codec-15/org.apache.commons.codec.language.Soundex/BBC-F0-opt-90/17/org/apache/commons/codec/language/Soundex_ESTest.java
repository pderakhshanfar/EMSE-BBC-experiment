...
public class Soundex_ESTest extends Soundex_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = soundex0.encode("#RW_-VyWVdfG");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals("R113", string0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      Soundex soundex0 = new Soundex("org.apache.commons.codec.language.Soundex");
      String string0 = soundex0.encode("-I)MD1-iO}b:9d");
      assertEquals("Io.h", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test07()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("^Evhc", "e0}bXB':w");
      assertEquals(4, soundex0.getMaxLength());
      assertEquals(3, int0);
  }
...
//      }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        soundex0.encode("e;*6%gb*wI^xuu5%Ob");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test13()  throws Throwable  {
      char[] charArray0 = new char[0];
      Soundex soundex0 = new Soundex(charArray0);
      String string0 = soundex0.US_ENGLISH.soundex("3;49Rc:J");
      assertEquals(4, soundex0.getMaxLength());
  ...
  public void test16()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      soundex0.difference((String) null, "1/v$}&ECl%6 ");
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test17()  throws Throwable  {
      Soundex soundex0 = Soundex.US_ENGLISH;
      String string0 = soundex0.US_ENGLISH.encode("R?{Zwhf\"");
  ...
  public void test18()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      String string0 = soundex0.soundex("oK7wCQfSUnym7qI*L");
      assertEquals("O221", string0);
      assertEquals(4, soundex0.getMaxLength());
  }
  ...
  public void test19()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.difference("GHHhc^k", "e>t2l93Z-KfRI|,U");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
...
//      }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
//      try { 
        soundex0.difference("_u@dAU&5[-$4A\">MA", "_u@dAU&5[-$4A\">MA");
//        fail("Expecting exception: IllegalArgumentException");
...
//      }
  ...
  public void test23()  throws Throwable  {
      Soundex soundex0 = new Soundex();
      int int0 = soundex0.US_ENGLISH.difference("ew+%!v%8{FoxSi/qj", "01230120022455012623010202");
      assertEquals(0, int0);
      assertEquals(4, soundex0.getMaxLength());
  }
