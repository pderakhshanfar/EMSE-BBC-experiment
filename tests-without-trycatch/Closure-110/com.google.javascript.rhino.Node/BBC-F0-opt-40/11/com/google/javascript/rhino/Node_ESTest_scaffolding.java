...
public class Node_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.javascript.rhino.jstype.StringType", false, Node_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.javascript.rhino.jstype.UnionType", false, Node_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, Node_ESTest_scaffolding.class.getClassLoader()));
