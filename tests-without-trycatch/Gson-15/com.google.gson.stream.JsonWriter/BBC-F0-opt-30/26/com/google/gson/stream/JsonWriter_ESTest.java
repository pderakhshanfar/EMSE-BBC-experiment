...
//      }
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Double double0 = new Double((-2355.126605542961));
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("L+^UJ*^");
      jsonWriter2.setSerializeNulls(false);
      Boolean boolean0 = new Boolean(false);
      jsonWriter0.value(boolean0);
      assertEquals("{\"L+^UJ*^\":false", stringWriter0.toString());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("L+^UJ*^");
      jsonWriter2.setSerializeNulls(false);
      jsonWriter0.value(355.013769729);
      assertEquals("{\"L+^UJ*^\":355.013769729", stringWriter0.toString());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("f6Me=w,@D;Rb@(");
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("L+^UJ*^");
      jsonWriter2.setSerializeNulls(false);
      jsonWriter0.jsonValue("L+^UJ*^");
      assertEquals("{\"L+^UJ*^\":L+^UJ*^", stringWriter0.toString());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      assertEquals("{\"L+^UJ*^\":[]", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
...
//      }
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("L+^UJ*^");
      JsonWriter jsonWriter2 = jsonWriter1.value((-1354.321998048418));
      // Undeclared exception!
//      try { 
...
//      }
  ...
  public void test43()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.value("d5Aav[C}(kq|-");
      jsonWriter2.beginArray();
      assertEquals("[\"d5Aav[C}(kq|-\",[", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("H[Eu'Luxxh8!ZMII");
      JsonWriter jsonWriter3 = jsonWriter2.value(3371L);
      jsonWriter3.name("H[Eu'Luxxh8!ZMII");
      jsonWriter1.value(false);
      assertEquals("{\"H[Eu'Luxxh8!ZMII\":3371,\"H[Eu'Luxxh8!ZMII\":false", stringWriter0.toString());
  }
  ...
  public void test46()  throws Throwable  {
      ...
      assertEquals("\"a##]\"-1.0", stringWriter0.toString());
  }
...
//      }
  ...
  public void test50()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter0.name("ND})~*T8Oq=q&wBy{7\"");
      jsonWriter2.setHtmlSafe(true);
      jsonWriter1.nullValue();
      assertEquals("{\"ND})~*T8Oq\\u003dq\\u0026wBy{7\\\"\":null", stringWriter0.toString());
  }
...
//      }
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("SkGrSL=<Bz l");
      jsonWriter1.close();
      // Undeclared exception!
//      try { 
        jsonWriter0.name("java.lang.Short@0000000002");
...
//      }
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("L+^UJ*^");
      // Undeclared exception!
//      try { 
        jsonWriter1.name("L+^UJ*^");
//        fail("Expecting exception: IllegalStateException");
