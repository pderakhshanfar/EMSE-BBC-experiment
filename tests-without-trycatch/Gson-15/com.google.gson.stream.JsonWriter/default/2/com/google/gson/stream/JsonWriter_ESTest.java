...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("W^=z");
...
//      }
  ...
  public void test01()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("R\u00058[A{gKl9@a/E1gH");
...
//      }
  ...
  public void test04()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(2844);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test09()  throws Throwable  {
      ...
      jsonWriter0.setSerializeNulls(false);
      Float float0 = new Float((-3629.2883F));
      jsonWriter0.value((Number) float0);
      assertFalse(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.jsonValue("X.gDAQx4\"Ern~");
      assertEquals("X.gDAQx4\"Ern~", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
...
//      }
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("X.gDAQx4\"Ern~");
      jsonWriter1.close();
      // Undeclared exception!
//      try { 
        jsonWriter0.name("X.gDAQx4\"Ern~");
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test62()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("O/bOUG\"x");
      // Undeclared exception!
//      try { 
        jsonWriter1.name("O/bOUG\"x");
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test65()  throws Throwable  {
      ...
      jsonWriter1.beginObject();
      JsonWriter jsonWriter11 = jsonWriter9.name("|:IugmjS>`$&");
      jsonWriter3.beginArray();
      ...
      assertEquals("[[[[[[[[[[[[[{\"|:IugmjS>`$&\":[[[[[[[[[[[[[[[[[[", stringWriter0.toString());
  }
