...
//      }
  ...
  public void test02()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(5336);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((double) 5336);
      assertEquals("5336.0", stringWriter0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.jsonValue("epy3wAmUt'p.cLb]c}F");
      assertEquals("epy3wAmUt'p.cLb]c}F", stringWriter0.toString());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter1.name("9~~P} h$$A_xVh\"s{E_");
...
//      }
  ...
  public void test38()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(5336);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      Float float0 = new Float((float) 5336);
...
//      }
  ...
  public void test43()  throws Throwable  {
      ...
      assertEquals("5336.0null", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }

  @Test(timeout = 4000)
  public void test44()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter(5331);
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("-Infinity");
      Float float0 = new Float((float) 5331);
...
//      }
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      jsonWriter0.setIndent("YREi:");
      jsonWriter0.beginArray();
      assertEquals("[\nYREi:[", stringWriter0.toString());
  }
...
//      }
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("mq.<Ae-M*a)ML4l%");
      // Undeclared exception!
//      try { 
        jsonWriter0.name("jr");
//        fail("Expecting exception: IllegalStateException");
...
//      }
  ...
  public void test63()  throws Throwable  {
      ...
      jsonWriter0.value((long) 5336);
      jsonWriter0.name("\t");
      jsonWriter1.value((long) 5336);
      assertEquals("{\"\\t\":5336,\"\\t\":5336", stringWriter0.toString());
  }
